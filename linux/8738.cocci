...
position p;
@@
 struct qed_drv_tlv_hdr * cocci_id@p ;
...
position p;
@@
 struct qed_tlv_parsed_buf * cocci_id@p ;
...
position p;
@@
 struct qed_mfw_tlv_time * cocci_id@p ;
...
typedef u8;
@@
 struct qed_tlv_parsed_buf {  void * p_val ;  u8 data [ QED_TLV_DATA_MAX ] ; } cocci_id@p ;
