...
typedef bool,u32;
@@
 struct emc_timing {  unsigned long rate ;  u32 data [ ARRAY_SIZE ( emc_timing_registers ) ] ;  u32 emc_auto_cal_interval ;  u32 emc_mode_1 ;  u32 emc_mode_2 ;  u32 emc_mode_reset ;  u32 emc_zcal_cnt_long ;  bool emc_cfg_periodic_qrst ;  bool emc_cfg_dyn_self_ref ; } cocci_id@p ;
...
position p;
@@
 const struct emc_timing * cocci_id@p ;
...
typedef bool,u32;
@@
 struct tegra_emc {  struct device * dev ;  struct tegra_mc * mc ;  struct completion clk_handshake_complete ;  struct notifier_block clk_nb ;  struct clk * clk ;  void __iomem * regs ;  unsigned int irq ;  struct emc_timing * timings ;  unsigned int num_timings ;  u32 mc_override ;  u32 emc_cfg ;  u32 emc_mode_1 ;  u32 emc_mode_2 ;  u32 emc_mode_reset ;  bool vref_cal_toggle : 1 ;  bool zcal_long : 1 ;  bool dll_on : 1 ;  bool prepared : 1 ;  bool bad_state : 1 ; } cocci_id@p ;
...
position p;
@@
 enum emc_dll_change cocci_id@p ;
...
position p;
@@
 enum emc_dram_type { DRAM_TYPE_DDR3 , DRAM_TYPE_DDR1 , DRAM_TYPE_LPDDR2 , DRAM_TYPE_DDR2 , } cocci_id@p ;
...
position p;
@@
 enum emc_dll_change { DLL_CHANGE_NONE , DLL_CHANGE_ON , DLL_CHANGE_OFF , } cocci_id@p ;
