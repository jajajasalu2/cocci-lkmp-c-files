...
position p;
@@
 const unsigned int cocci_id@p [ SPI_CLK_MASK ] [ 2 ] ;
...
typedef u8;
@@
 struct bcm63xx_spi {  struct completion done ;  void __iomem * regs ;  int irq ;  const unsigned long * reg_offsets ;  unsigned int fifo_size ;  unsigned int msg_type_shift ;  unsigned int msg_ctl_width ;  u8 __iomem * tx_io ;  const u8 __iomem * rx_io ;  struct clk * clk ;  struct platform_device * pdev ; } cocci_id@p ;
...
position p;
@@
 enum bcm63xx_regs_spi { SPI_CMD , SPI_INT_STATUS , SPI_INT_MASK_ST , SPI_INT_MASK , SPI_ST , SPI_CLK_CFG , SPI_FILL_BYTE , SPI_MSG_TAIL , SPI_RX_TAIL , SPI_MSG_CTL , SPI_MSG_DATA , SPI_RX_DATA , SPI_MSG_TYPE_SHIFT , SPI_MSG_CTL_WIDTH , SPI_MSG_DATA_SIZE , } cocci_id@p ;
