...
position p;
@@
 int cocci_id@p ( unsigned int index ) ;
...
position p;
@@
 struct da850_opp {  unsigned int freq ;  unsigned int prediv ;  unsigned int mult ;  unsigned int postdiv ;  unsigned int cvdd_min ;  unsigned int cvdd_max ; } cocci_id@p ;
...
position p;
@@
 const struct da850_opp cocci_id@p ;
...
position p;
@@
 struct davinci_cpufreq_config cocci_id@p ;
...
position p;
@@
 const struct davinci_soc_info cocci_id@p ;
...
position p;
@@
 const struct davinci_timer_cfg cocci_id@p ;
...
position p;
@@
 const struct davinci_cp_intc_config cocci_id@p ;
