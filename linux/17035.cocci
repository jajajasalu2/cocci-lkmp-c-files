...
position p;
@@
 struct adi {  struct input_dev * dev ;  int length ;  int ret ;  int idx ;  unsigned char id ;  char buttons ;  char axes10 ;  char axes8 ;  signed char pad ;  char hats ;  char * abs ;  short * key ;  char name [ ADI_MAX_NAME_LENGTH ] ;  char cname [ ADI_MAX_CNAME_LENGTH ] ;  char phys [ ADI_MAX_PHYS_LENGTH ] ;  unsigned char data [ ADI_MAX_LENGTH ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ADI_MAX_NAME_LENGTH ] ;
...
position p;
@@
 struct adi_port {  struct gameport * gameport ;  struct adi adi [ 2 ] ;  int bad ;  int reads ; } cocci_id@p ;
