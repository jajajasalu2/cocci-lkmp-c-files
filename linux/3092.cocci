...
position p;
@@
 enum { D_PRT , D_PRO , D_UNI , D_MOD , D_SLV , D_DLY , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * cdi , int purpose ) ;
...
position p;
@@
 struct cdrom_tochdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cdrom_device_info * cdi ) ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * cdi , struct packet_command * cgc ) ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * cdi , int lock ) ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * cdi , struct cdrom_mcn * mcn ) ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * cdi ) ;
...
position p;
@@
 struct pcd_unit cocci_id@p [ PCD_UNITS ] ;
...
position p;
@@
 struct pcd_unit {  struct pi_adapter pia ;  struct pi_adapter * pi ;  int drive ;  int last_sense ;  int changed ;  int present ;  char * name ;  struct cdrom_device_info info ;  struct gendisk * disk ;  struct blk_mq_tag_set tag_set ;  struct list_head rq_list ; } cocci_id@p ;
...
typedef blk_status_t;
@@
 blk_status_t cocci_id@p ( struct blk_mq_hw_ctx * hctx , const struct blk_mq_queue_data * bd ) ;
...
position p;
@@
 struct packet_command * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct cdrom_device_info * cdi , unsigned int clearing , int slot_nr ) ;
...
position p;
@@
 struct cdrom_device_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * cdi , unsigned int cmd , void * arg ) ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * cdi , int position ) ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * cdi , int slot_nr ) ;
...
position p;
@@
 const struct cdrom_device_ops cocci_id@p ;
