...
position p;
@@
 unsigned char cocci_id@p [ EDID_SIZE ] ;
...
position p;
@@
 struct vbva_cmd_hdr cocci_id@p ;
...
position p;
@@
 struct vbox_private cocci_id@p ;
...
position p;
@@
 struct vbva_infoview * cocci_id@p ;
...
position p;
@@
 struct vbox_encoder * cocci_id@p ;
...
position p;
@@
 struct vbox_connector * cocci_id@p ;
