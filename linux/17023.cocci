...
position p;
@@
 struct hanwang_features {  unsigned short pid ;  char * name ;  enum hanwang_tablet_type type ;  int pkg_len ;  int max_x ;  int max_y ;  int max_tilt_x ;  int max_tilt_y ;  int max_pressure ; } cocci_id@p ;
...
position p;
@@
 enum hanwang_tablet_type cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct hanwang {  unsigned char * data ;  dma_addr_t data_dma ;  struct input_dev * dev ;  struct usb_device * usbdev ;  struct urb * irq ;  const struct hanwang_features * features ;  unsigned int current_tool ;  unsigned int current_id ;  char name [ 64 ] ;  char phys [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 enum hanwang_tablet_type { HANWANG_ART_MASTER_III , HANWANG_ART_MASTER_HD , HANWANG_ART_MASTER_II , } cocci_id@p ;
...
position p;
@@
 const struct hanwang_features cocci_id@p [ ] ;
