...
position p;
@@
 struct egalax_ts {  struct i2c_client * client ;  struct input_dev * input_dev ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_I2C_DATA_LEN ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ MAX_I2C_DATA_LEN ] ;
