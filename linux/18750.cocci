...
typedef u32;
@@
 int ( * cocci_id@p ) ( unsigned long addr , u32 instr , struct pt_regs * regs ) ;
...
position p;
@@
 union offset_union {  unsigned long un ;  signed long sn ; } cocci_id@p ;
