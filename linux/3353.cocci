...
position p;
@@
 const struct fsl_pwm_periodcfg * cocci_id@p ;
...
position p;
@@
 struct fsl_pwm_chip * cocci_id@p ;
...
position p;
@@
 struct fsl_pwm_periodcfg * cocci_id@p ;
...
typedef bool;
@@
 struct fsl_ftm_soc {  bool has_enable_bits ; } cocci_id@p ;
...
position p;
@@
 struct fsl_pwm_periodcfg {  enum fsl_pwm_clk clk_select ;  unsigned int clk_ps ;  unsigned int mod_period ; } cocci_id@p ;
...
position p;
@@
 struct fsl_pwm_chip {  struct pwm_chip chip ;  struct mutex lock ;  struct regmap * regmap ;  struct fsl_pwm_periodcfg period ;  struct clk * ipg_clk ;  struct clk * clk [ FSL_PWM_CLK_MAX ] ;  const struct fsl_ftm_soc * soc ; } cocci_id@p ;
...
position p;
@@
 const struct fsl_ftm_soc cocci_id@p ;
...
position p;
@@
 enum fsl_pwm_clk { FSL_PWM_CLK_SYS , FSL_PWM_CLK_FIX , FSL_PWM_CLK_EXT , FSL_PWM_CLK_CNTEN , FSL_PWM_CLK_MAX , } cocci_id@p ;
