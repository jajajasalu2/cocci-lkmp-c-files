...
position p;
@@
 const struct snd_timer_hardware cocci_id@p ;
...
typedef bool;
@@
 struct snd_hrtimer {  struct snd_timer * timer ;  struct hrtimer hrt ;  bool in_callback ; } cocci_id@p ;
