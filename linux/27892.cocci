...
symbol cocci_id;
position p;
typedef fscache_operation_release_t;
@@
 fscache_operation_release_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fscache_operation_cancel_t;
@@
 fscache_operation_cancel_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fscache_operation_processor_t;
@@
 fscache_operation_processor_t cocci_id@p ;
