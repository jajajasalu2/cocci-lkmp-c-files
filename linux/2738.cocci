...
typedef u8;
@@
 struct mlxcpld_i2c_curr_xfer {  u8 cmd ;  u8 addr_width ;  u8 data_len ;  u8 msg_num ;  struct i2c_msg * msg ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct mlxcpld_i2c_priv {  struct i2c_adapter adap ;  u32 base_addr ;  struct mutex lock ;  struct mlxcpld_i2c_curr_xfer xfer ;  struct device * dev ;  bool smbus_block ; } cocci_id@p ;
...
position p;
@@
 struct mlxcpld_i2c_priv * cocci_id@p ;
