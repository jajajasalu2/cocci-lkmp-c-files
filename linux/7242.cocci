...
position p;
@@
 struct bcm_data {  struct sk_buff * rx_skb ;  struct sk_buff_head txq ;  struct bcm_device * dev ; } cocci_id@p ;
...
position p;
@@
 struct bcm_update_uart_baud_rate cocci_id@p ;
...
position p;
@@
 struct bcm_write_uart_clock_setting cocci_id@p ;
...
position p;
@@
 struct bcm_set_sleep_mode cocci_id@p ;
...
position p;
@@
 const struct bcm_set_sleep_mode cocci_id@p ;
