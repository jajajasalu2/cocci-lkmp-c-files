...
position p;
@@
 struct clk_creg_data {  struct clk_hw hw ;  const char * name ;  struct regmap * reg ;  unsigned int en_mask ;  const struct clk_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct clk * cocci_id@p [ CREG_CLK_MAX ] ;
...
position p;
@@
 enum { CREG_CLK_1KHZ , CREG_CLK_32KHZ , CREG_CLK_MAX , } cocci_id@p ;
...
position p;
@@
 struct clk_creg_data cocci_id@p [ ] ;
