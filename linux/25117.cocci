...
position p;
@@
 struct libusb_device_descriptor cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ BUF_LEN ] ;
...
position p;
@@
 struct test_state {  libusb_device * found ;  libusb_context * ctx ;  libusb_device_handle * handle ;  int attached ; } cocci_id@p ;
...
position p;
@@
 struct libusb_config_descriptor * cocci_id@p ;
...
position p;
@@
 const struct libusb_interface_descriptor * cocci_id@p ;
