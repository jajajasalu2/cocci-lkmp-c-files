...
position p;
@@
 struct hci_cp_accept_phy_link * cocci_id@p ;
...
position p;
@@
 struct hci_rp_write_remote_amp_assoc * cocci_id@p ;
...
position p;
@@
 struct hci_cp_read_local_amp_assoc cocci_id@p ;
...
position p;
@@
 struct hci_cp_write_remote_amp_assoc * cocci_id@p ;
...
position p;
@@
 struct hci_cp_create_phy_link * cocci_id@p ;
...
position p;
@@
 struct hci_cp_create_accept_logical_link cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HCI_AMP_LINK_KEY_SIZE ] ;
...
position p;
@@
 struct hci_rp_read_local_amp_assoc * cocci_id@p ;
...
position p;
@@
 struct hci_cp_disconn_logical_link cocci_id@p ;
