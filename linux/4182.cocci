...
position p;
@@
 const struct tegra_xusb_port_ops cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_hsic_pad * cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_lane_ops cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_padctl_ops cocci_id@p ;
...
position p;
@@
 struct tegra124_xusb_padctl {  struct tegra_xusb_padctl base ;  struct tegra124_xusb_fuse_calibration fuse ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_pcie_pad * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_usb2_lane * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_port * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_ulpi_pad * cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_pad_soc * cocci_id@p ;
...
position p;
@@
 struct tegra124_xusb_padctl * cocci_id@p ;
...
position p;
@@
 struct tegra124_xusb_fuse_calibration * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_usb2_port * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_sata_pad * cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_pad_ops cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_lane_map cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_xusb_lane * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_pcie_lane * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_usb2_pad * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_ulpi_lane * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_hsic_lane * cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_lane_soc cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_xusb_sata_lane * cocci_id@p ;
...
typedef u32;
@@
 struct tegra124_xusb_fuse_calibration {  u32 hs_curr_level [ 3 ] ;  u32 hs_iref_cap ;  u32 hs_term_range_adj ;  u32 hs_squelch_level ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_pad * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_usb3_port * cocci_id@p ;
