...
position p;
@@
 struct uwire_state {  unsigned div1_idx ; } cocci_id@p ;
...
position p;
@@
 struct uwire_spi {  struct spi_bitbang bitbang ;  struct clk * ck ; } cocci_id@p ;
