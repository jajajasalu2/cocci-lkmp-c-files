...
position p;
@@
 const struct ov2685_mode * cocci_id@p ;
...
typedef u8,u16;
@@
 struct regval {  u16 addr ;  u8 val ; } cocci_id@p ;
...
typedef u32;
@@
 struct ov2685_mode {  u32 width ;  u32 height ;  u32 exp_def ;  u32 hts_def ;  u32 vts_def ;  const struct regval * reg_list ; } cocci_id@p ;
...
position p;
@@
 const struct regval * cocci_id@p ;
