...
position p;
@@
 struct x86_cpuinit_ops cocci_id@p ;
...
position p;
@@
 struct x86_apic_ops cocci_id@p ;
...
position p;
@@
 struct x86_init_ops cocci_id@p ;
...
position p;
@@
 struct x86_platform_ops cocci_id@p ;
