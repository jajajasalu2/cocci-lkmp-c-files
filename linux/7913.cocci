...
position p;
@@
 struct sja1105_ptp_data * cocci_id@p ;
...
position p;
@@
 struct sja1105_ptp_cmd * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SJA1105_SIZE_PTP_CMD ] ;
...
position p;
@@
 enum sja1105_ptp_clk_mode { PTP_ADD_MODE = 1 , PTP_SET_MODE = 0 , } cocci_id@p ;
...
position p;
@@
 enum sja1105_ptp_clk_mode cocci_id@p ;
