...
position p;
@@
 struct bmic_identify_controller cocci_id@p ;
...
position p;
@@
 struct pqi_device_registers cocci_id@p ;
...
position p;
@@
 struct pqi_general_admin_request cocci_id@p ;
...
position p;
@@
 struct bmic_sense_subsystem_info * cocci_id@p ;
...
position p;
@@
 struct report_lun_header * cocci_id@p ;
...
position p;
@@
 struct pqi_io_response * cocci_id@p ;
...
position p;
@@
 struct pqi_task_management_response * cocci_id@p ;
...
position p;
@@
 struct pqi_vendor_general_response * cocci_id@p ;
...
position p;
@@
 struct pqi_event_acknowledge_request * cocci_id@p ;
...
position p;
@@
 struct pqi_event_response * cocci_id@p ;
...
position p;
@@
 struct pqi_io_request cocci_id@p ;
...
position p;
@@
 struct pqi_firmware_feature cocci_id@p [ ] ;
...
position p;
@@
 struct pqi_raid_error_info cocci_id@p ;
...
position p;
@@
 struct pqi_general_admin_response * cocci_id@p ;
...
position p;
@@
 struct pqi_ctrl_info cocci_id@p ;
...
position p;
@@
 struct bmic_identify_physical_device * cocci_id@p ;
...
position p;
@@
 struct ciss_error_info cocci_id@p ;
...
position p;
@@
 struct pqi_general_management_request cocci_id@p ;
...
position p;
@@
 struct pqi_config_table * cocci_id@p ;
...
position p;
@@
 struct pqi_ctrl_registers cocci_id@p ;
...
position p;
@@
 struct bmic_host_wellness_driver_version * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pqi_ctrl_info * ctrl_info , struct pqi_iu_header * request , unsigned int flags , struct pqi_raid_error_info * error_info , unsigned long timeout_msecs ) ;
...
position p;
@@
 struct pqi_aio_error_info cocci_id@p ;
...
typedef u32;
@@
 struct pqi_config_table_section_info {  struct pqi_ctrl_info * ctrl_info ;  void * section ;  u32 section_offset ;  void __iomem * section_iomem_addr ; } cocci_id@p ;
...
position p;
@@
 struct pqi_aio_path_request cocci_id@p ;
...
position p;
@@
 struct pqi_device_capability * cocci_id@p ;
...
position p;
@@
 struct pqi_iu_layer_descriptor * cocci_id@p ;
...
position p;
@@
 enum pqi_lockup_action cocci_id@p ;
...
position p;
@@
 struct pqi_raid_path_request * cocci_id@p ;
...
position p;
@@
 struct report_phys_lun_extended * * cocci_id@p ;
...
position p;
@@
 struct {  enum pqi_lockup_action action ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct pqi_ofa_memory * cocci_id@p ;
...
position p;
@@
 struct pqi_event_descriptor cocci_id@p ;
...
position p;
@@
 struct bmic_flush_cache * cocci_id@p ;
...
position p;
@@
 struct pqi_config_table_section_header * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pqi_ctrl_info * ctrl_info , struct pqi_queue_group * queue_group , enum pqi_io_path path , struct pqi_io_request * io_request ) ;
...
position p;
@@
 struct pqi_scsi_dev * * cocci_id@p ;
...
position p;
@@
 struct pqi_config_table_firmware_features cocci_id@p ;
...
typedef u8,bool,u32;
@@
 int cocci_id@p ( struct pqi_ctrl_info * ctrl_info , struct scsi_cmnd * scmd , u32 aio_handle , u8 * cdb , unsigned int cdb_length , struct pqi_queue_group * queue_group , struct pqi_encryption_info * encryption_info , bool raid_bypass ) ;
...
typedef u8;
@@
 struct ciss_error_info {  u8 scsi_status ;  int command_status ;  size_t sense_data_length ; } cocci_id@p ;
...
position p;
@@
 struct pqi_admin_queues_aligned cocci_id@p ;
...
position p;
@@
 struct report_log_lun_extended_entry cocci_id@p ;
...
position p;
@@
 struct pqi_config_table_soft_reset cocci_id@p ;
...
position p;
@@
 enum bmic_flush_cache_shutdown_event cocci_id@p ;
...
position p;
@@
 struct pqi_encryption_info * cocci_id@p ;
...
position p;
@@
 struct bmic_diag_options * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct pqi_ctrl_info * ctrl_info , u32 bytes_requested ) ;
...
position p;
@@
 char cocci_id@p [ PQI_DEV_INFO_BUFFER_LENGTH ] ;
...
position p;
@@
 IOCTL_Command_struct cocci_id@p ;
...
position p;
@@
 struct pqi_sg_descriptor * cocci_id@p ;
...
position p;
@@
 enum pqi_soft_reset_status cocci_id@p ;
...
position p;
@@
 struct pqi_iu_header cocci_id@p ;
...
position p;
@@
 struct pqi_vendor_general_request cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct Scsi_Host * shost ) ;
...
position p;
@@
 struct report_log_lun_extended * cocci_id@p ;
...
typedef u8;
@@
 struct bmic_host_wellness_driver_version {  u8 start_tag [ 4 ] ;  u8 driver_version_tag [ 2 ] ;  __le16 driver_version_length ;  char driver_version [ 32 ] ;  u8 dont_write_tag [ 2 ] ;  u8 end_tag [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct ciss_vpd_logical_volume_status cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pqi_ctrl_info * ctrl_info ) ;
...
position p;
@@
 struct pqi_task_management_request cocci_id@p ;
...
position p;
@@
 struct pqi_config_table_section_info cocci_id@p ;
...
typedef u8;
@@
 struct bmic_host_wellness_time {  u8 start_tag [ 4 ] ;  u8 time_tag [ 2 ] ;  __le16 time_length ;  u8 time [ 8 ] ;  u8 dont_write_tag [ 2 ] ;  u8 end_tag [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum pqi_lockup_action { NONE , REBOOT , PANIC , } cocci_id@p ;
...
position p;
@@
 struct bmic_csmi_smp_passthru_buffer * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( unknown_state_str ) + 10 ] ;
...
position p;
@@
 void cocci_id@p ( struct pqi_ctrl_info * ctrl_info ) ;
...
position p;
@@
 int cocci_id@p ( struct pqi_ctrl_info * ctrl_info , struct pqi_scsi_dev * device , unsigned long timeout_secs ) ;
...
position p;
@@
 struct pqi_event_queue * cocci_id@p ;
...
position p;
@@
 struct report_phys_lun_extended_entry * cocci_id@p ;
...
position p;
@@
 enum pqi_find_result cocci_id@p ;
...
position p;
@@
 union pqi_reset_register cocci_id@p ;
...
position p;
@@
 cciss_pci_info_struct cocci_id@p ;
...
position p;
@@
 struct pqi_admin_queues * cocci_id@p ;
...
position p;
@@
 enum pqi_find_result { DEVICE_NOT_FOUND , DEVICE_CHANGED , DEVICE_SAME , } cocci_id@p ;
...
position p;
@@
 struct pqi_event_config cocci_id@p ;
...
position p;
@@
 struct pqi_queue_group * cocci_id@p ;
...
position p;
@@
 struct bmic_host_wellness_time * cocci_id@p ;
...
position p;
@@
 struct scsi_sense_hdr cocci_id@p ;
...
position p;
@@
 struct pqi_config_table_heartbeat cocci_id@p ;
