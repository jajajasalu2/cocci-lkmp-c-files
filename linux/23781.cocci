...
position p;
@@
 enum rfkill_input_master_mode cocci_id@p ;
...
position p;
@@
 enum rfkill_sched_op { RFKILL_GLOBAL_OP_EPO = 0 , RFKILL_GLOBAL_OP_RESTORE , RFKILL_GLOBAL_OP_UNLOCK , RFKILL_GLOBAL_OP_UNBLOCK , } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ BITS_TO_LONGS ( NUM_RFKILL_TYPES ) ] ;
...
position p;
@@
 enum rfkill_input_master_mode { RFKILL_INPUT_MASTER_UNLOCK = 0 , RFKILL_INPUT_MASTER_RESTORE = 1 , RFKILL_INPUT_MASTER_UNBLOCKALL = 2 , NUM_RFKILL_INPUT_MASTER_MODES , } cocci_id@p ;
...
position p;
@@
 enum rfkill_sched_op cocci_id@p ;
