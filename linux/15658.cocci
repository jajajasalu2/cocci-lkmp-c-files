...
position p;
@@
 struct gb_usb_device cocci_id@p ;
...
position p;
@@
 struct gb_usb_hub_control_request {  __le16 typeReq ;  __le16 wValue ;  __le16 wIndex ;  __le16 wLength ; } cocci_id@p ;
...
typedef u8;
@@
 struct gb_usb_hub_control_response {  u8 buf [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct gb_usb_hub_control_request * cocci_id@p ;
...
position p;
@@
 struct gb_usb_device {  struct gb_connection * connection ;  struct gbphy_device * gbphy_dev ; } cocci_id@p ;
...
position p;
@@
 struct gb_usb_hub_control_response * cocci_id@p ;
