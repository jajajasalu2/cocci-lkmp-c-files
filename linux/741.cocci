...
position p;
@@
 struct dra7xx_pcie_of_data * cocci_id@p ;
...
position p;
@@
 const struct dra7xx_pcie_of_data cocci_id@p ;
...
typedef u32;
@@
 struct dra7xx_pcie_of_data {  enum dw_pcie_device_mode mode ;  u32 b1co_mode_sel_mask ; } cocci_id@p ;
...
position p;
@@
 struct dra7xx_pcie {  struct dw_pcie * pci ;  void __iomem * base ;  int phy_count ;  struct phy * * phy ;  int link_gen ;  struct irq_domain * irq_domain ;  enum dw_pcie_device_mode mode ; } cocci_id@p ;
