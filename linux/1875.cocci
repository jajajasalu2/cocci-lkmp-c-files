...
typedef u8;
@@
 struct adc0832 {  struct spi_device * spi ;  struct regulator * reg ;  struct mutex lock ;  u8 mux_bits ;  u8 tx_buf [ 2 ] ____cacheline_aligned ;  u8 rx_buf [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum { adc0831 , adc0832 , adc0834 , adc0838 , } cocci_id@p ;
