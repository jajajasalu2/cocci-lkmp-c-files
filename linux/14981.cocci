...
position p;
@@
 struct bcm_policy_ctl * cocci_id@p ;
...
position p;
@@
 struct bcm_clk_gate * cocci_id@p ;
...
position p;
@@
 struct bcm_clk_hyst * cocci_id@p ;
...
position p;
@@
 struct bcm_clk_policy * cocci_id@p ;
...
position p;
@@
 struct peri_clk_data * cocci_id@p ;
...
position p;
@@
 struct bcm_clk_trig * cocci_id@p ;
