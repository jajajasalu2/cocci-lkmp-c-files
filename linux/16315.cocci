...
position p;
@@
 const struct ipu3_uapi_awb_fr_config_s cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_yuvp2_tcc_r_sqr_lut_static_config cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ IMGU_SCALER_DOWNSCALE_4TAPS_LEN ] ;
...
position p;
@@
 const struct ipu3_uapi_ae_grid_config cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_ccm_mat_config cocci_id@p ;
...
position p;
@@
 const struct imgu_css_bds_config cocci_id@p [ IMGU_BDS_CONFIG_LEN ] ;
...
position p;
@@
 const struct ipu3_uapi_shd_config_static cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_af_config_s cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_yuvp2_tcc_gain_pcwl_lut_static_config cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_yuvp1_iefd_config cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_yuvp1_yds_config cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_ae_ccm cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_dm_config cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_awb_config_s cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_yuvp1_chnr_config cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_bnr_static_config cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_cds_params cocci_id@p ;
...
position p;
@@
 const struct imgu_abi_anr_config cocci_id@p ;
...
position p;
@@
 const struct imgu_css_xnr3_vmem_defaults cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_csc_mat_config cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_gamma_corr_lut cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_yuvp1_y_ee_nr_config cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ IMGU_SCALER_DOWNSCALE_2TAPS_LEN ] ;
