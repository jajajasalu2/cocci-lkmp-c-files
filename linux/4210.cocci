...
position p;
@@
 struct usb_charge_response * cocci_id@p ;
...
position p;
@@
 struct boot_on_ac_request cocci_id@p ;
...
position p;
@@
 struct get_ec_info_resp cocci_id@p ;
...
position p;
@@
 struct wilco_ec_device * cocci_id@p ;
...
position p;
@@
 struct usb_charge_request * cocci_id@p ;
...
position p;
@@
 enum usb_charge_op { USB_CHARGE_GET = 0 , USB_CHARGE_SET = 1 , } cocci_id@p ;
...
position p;
@@
 enum get_ec_info_op cocci_id@p ;
...
position p;
@@
 struct get_ec_info_req cocci_id@p ;
...
position p;
@@
 struct wilco_ec_message cocci_id@p ;
...
position p;
@@
 enum get_ec_info_op { CMD_GET_EC_LABEL = 0 , CMD_GET_EC_REV = 1 , CMD_GET_EC_MODEL = 2 , CMD_GET_EC_BUILD_DATE = 3 , } cocci_id@p ;
