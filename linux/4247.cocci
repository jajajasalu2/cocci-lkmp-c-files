...
position p;
@@
 struct thermal_device_info cocci_id@p ;
...
position p;
@@
 struct platform_info {  struct platform_device * pdev ;  struct thermal_zone_device * tzd [ MSIC_THERMAL_SENSORS ] ; } cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ MSIC_THERMAL_SENSORS ] ;
...
position p;
@@
 struct thermal_device_info {  unsigned int chnl_addr ;  int direct ;  long curr_temp ; } cocci_id@p ;
