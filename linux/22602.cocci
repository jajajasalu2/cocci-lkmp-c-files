...
position p;
@@
 struct board_parameters cocci_id@p [ ] ;
...
position p;
@@
 struct pcxhr_stream * cocci_id@p ;
...
position p;
@@
 struct pcxhr_hostport cocci_id@p ;
...
position p;
@@
 enum pcxhr_clock_type cocci_id@p ;
...
position p;
@@
 struct board_parameters {  char * board_name ;  short playback_chips ;  short capture_chips ;  short fw_file_set ;  short firmware_num ; } cocci_id@p ;
