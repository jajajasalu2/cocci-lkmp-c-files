...
position p;
@@
 struct adau7118_data * cocci_id@p ;
...
position p;
@@
 const struct snd_kcontrol_new cocci_id@p [ 4 ] ;
...
position p;
@@
 const struct adau7118_data * cocci_id@p ;
...
typedef bool,u32;
@@
 struct adau7118_data {  struct regmap * map ;  struct device * dev ;  struct regulator * iovdd ;  struct regulator * dvdd ;  u32 slot_width ;  u32 slots ;  bool hw_mode ;  bool right_j ; } cocci_id@p ;
