...
position p;
@@
 struct rtl8187b_rx_hdr * cocci_id@p ;
...
position p;
@@
 struct rtl8187_priv * cocci_id@p ;
...
typedef u8;
@@
 struct rtl8187_async_write_data {  u8 data [ 4 ] ;  struct usb_ctrlrequest dr ; } * cocci_id@p ;
...
position p;
@@
 struct rtl8187_tx_hdr * cocci_id@p ;
...
position p;
@@
 struct rtl8187b_tx_hdr * cocci_id@p ;
...
position p;
@@
 struct rtl8187_rx_hdr * cocci_id@p ;
...
position p;
@@
 struct rtl8187_rx_info * cocci_id@p ;
