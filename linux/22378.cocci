...
position p;
@@
 struct keyring_read_iterator_context cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct key * keyring , struct seq_file * m ) ;
...
position p;
@@
 struct key_preparsed_payload * cocci_id@p ;
...
position p;
@@
 struct key_restriction cocci_id@p ;
...
position p;
@@
 struct keyring_index_key * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct key * keyring ) ;
...
position p;
@@
 struct assoc_array_edit * * cocci_id@p ;
...
position p;
@@
 struct {  struct key * keyring ;  struct assoc_array_node * node ;  int slot ; } cocci_id@p [ KEYRING_SEARCH_MAX_DEPTH ] ;
...
position p;
@@
 struct keyring_search_context * cocci_id@p ;
...
position p;
@@
 const struct key_match_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct key_preparsed_payload * prep ) ;
...
symbol cocci_id;
position p;
typedef key_restrict_link_func_t;
@@
 key_restrict_link_func_t cocci_id@p ;
...
position p;
@@
 struct assoc_array_shortcut * cocci_id@p ;
...
position p;
@@
 const union key_payload * cocci_id@p ;
...
position p;
@@
 const struct assoc_array_ops cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct key * keyring , struct key_preparsed_payload * prep ) ;
...
position p;
@@
 struct assoc_array_node * cocci_id@p ;
...
@@
 struct keyring_read_iterator_context {  size_t buflen ;  size_t count ;  key_serial_t __user * buffer ; } cocci_id@p ;
...
position p;
@@
 struct assoc_array_ptr * cocci_id@p ;
...
position p;
@@
 const struct assoc_array_ptr * cocci_id@p ;
...
position p;
@@
 const struct key_type * cocci_id@p ;
...
position p;
@@
 const struct keyring_index_key * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct key_preparsed_payload * prep ) ;
