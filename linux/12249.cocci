...
position p;
@@
 enum mcde_extsrc { MCDE_EXTSRC_0 = 0 , MCDE_EXTSRC_1 , MCDE_EXTSRC_2 , MCDE_EXTSRC_3 , MCDE_EXTSRC_4 , MCDE_EXTSRC_5 , MCDE_EXTSRC_6 , MCDE_EXTSRC_7 , MCDE_EXTSRC_8 , MCDE_EXTSRC_9 , } cocci_id@p ;
...
position p;
@@
 enum mcde_dsi_formatter { MCDE_DSI_FORMATTER_0 = 0 , MCDE_DSI_FORMATTER_1 , MCDE_DSI_FORMATTER_2 , } cocci_id@p ;
...
position p;
@@
 enum mcde_dsi_formatter cocci_id@p ;
...
position p;
@@
 enum mcde_channel { MCDE_CHANNEL_0 = 0 , MCDE_CHANNEL_1 , MCDE_CHANNEL_2 , MCDE_CHANNEL_3 , } cocci_id@p ;
...
position p;
@@
 enum mcde_overlay { MCDE_OVERLAY_0 = 0 , MCDE_OVERLAY_1 , MCDE_OVERLAY_2 , MCDE_OVERLAY_3 , MCDE_OVERLAY_4 , MCDE_OVERLAY_5 , } cocci_id@p ;
...
position p;
@@
 struct drm_simple_display_pipe_funcs cocci_id@p ;
...
position p;
@@
 enum mcde_fifo { MCDE_FIFO_A , MCDE_FIFO_B , } cocci_id@p ;
