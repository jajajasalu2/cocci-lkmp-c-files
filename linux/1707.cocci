...
position p;
@@
 struct mcp4131_data * cocci_id@p ;
...
typedef u8;
@@
 struct mcp4131_data {  struct spi_device * spi ;  const struct mcp4131_cfg * cfg ;  struct mutex lock ;  u8 buf [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 const struct mcp4131_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct mcp4131_cfg {  int wipers ;  int max_pos ;  int kohms ; } cocci_id@p ;
