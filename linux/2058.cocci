...
position p;
@@
 struct adis16260_chip_info {  unsigned int gyro_max_val ;  unsigned int gyro_max_scale ;  const struct iio_chan_spec * channels ;  unsigned int num_channels ; } cocci_id@p ;
...
position p;
@@
 struct adis16260 {  const struct adis16260_chip_info * info ;  struct adis adis ; } cocci_id@p ;
...
position p;
@@
 const struct adis16260_chip_info cocci_id@p [ ] ;
...
position p;
@@
 enum adis16260_type { ADIS16251 , ADIS16260 , ADIS16266 , } cocci_id@p ;
