...
position p;
@@
 struct cmp_connection * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ SND_BEBOB_STRM_FMT_ENTRIES ] ;
...
position p;
@@
 enum avc_bridgeco_plug_dir cocci_id@p ;
...
position p;
@@
 enum avc_bridgeco_plug_type cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ AVC_BRIDGECO_ADDR_BYTES ] ;
