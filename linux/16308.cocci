...
position p;
@@
 enum { FIM_CL_ENABLE = 0 , FIM_CL_NUM , FIM_CL_TOLERANCE_MIN , FIM_CL_TOLERANCE_MAX , FIM_CL_NUM_SKIP , FIM_NUM_CONTROLS , } cocci_id@p ;
...
position p;
@@
 enum { FIM_CL_ICAP_EDGE = 0 , FIM_CL_ICAP_CHANNEL , FIM_NUM_ICAP_CONTROLS , } cocci_id@p ;
...
position p;
@@
 struct imx_media_fim * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,ktime_t,spinlock_t;
@@
 struct imx_media_fim {  struct v4l2_subdev * sd ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_ctrl * ctrl [ FIM_NUM_CONTROLS ] ;  struct v4l2_ctrl * icap_ctrl [ FIM_NUM_ICAP_CONTROLS ] ;  spinlock_t lock ;  bool enabled ;  int num_avg ;  int num_skip ;  unsigned long tolerance_min ;  unsigned long tolerance_max ;  int icap_channel ;  int icap_flags ;  int counter ;  ktime_t last_ts ;  unsigned long sum ;  unsigned long nominal ;  struct completion icap_first_event ;  bool stream_on ; } cocci_id@p ;
