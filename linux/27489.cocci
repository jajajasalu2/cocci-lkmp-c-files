...
position p;
@@
 struct qnx6_sb_info * cocci_id@p ;
...
position p;
@@
 struct inode * cocci_id@p ( struct super_block * s , struct qnx6_root_node * p ) ;
...
position p;
@@
 struct qnx6_inode_entry * cocci_id@p ;
...
position p;
@@
 struct qnx6_root_node * cocci_id@p ;
...
position p;
@@
 unsigned cocci_id@p ( struct inode * inode , unsigned iblock ) ;
...
position p;
@@
 enum { Opt_mmifs , Opt_err , } cocci_id@p ;
...
position p;
@@
 struct qnx6_inode_info * cocci_id@p ;
...
position p;
@@
 struct qnx6_dir_entry * cocci_id@p ;
...
position p;
@@
 struct qnx6_super_block * cocci_id@p ;
