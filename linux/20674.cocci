...
position p;
@@
 const enum reason_type cocci_id@p ;
...
position p;
@@
 struct trap_reason {  unsigned long addr ;  unsigned long ip ;  enum reason_type type ;  int active_traces ; } cocci_id@p ;
...
position p;
@@
 const struct trap_reason * cocci_id@p ;
...
@@
 struct remap_trace {  struct list_head list ;  struct kmmio_probe probe ;  resource_size_t phys ;  unsigned long id ; } cocci_id@p ;
