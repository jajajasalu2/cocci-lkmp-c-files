...
position p;
@@
 struct usb_cdc_call_mgmt_descriptor * cocci_id@p ;
...
position p;
@@
 struct usb_cdc_dmm_desc cocci_id@p ;
...
position p;
@@
 struct usb_cdc_mdlm_detail_desc * cocci_id@p ;
...
position p;
@@
 struct set_config_request * cocci_id@p ;
...
position p;
@@
 struct usb_cdc_mbim_extended_desc * cocci_id@p ;
...
position p;
@@
 struct usb_cdc_parsed_header cocci_id@p ;
...
position p;
@@
 struct usb_cdc_mdlm_desc cocci_id@p ;
...
position p;
@@
 struct set_config_request {  struct usb_device * udev ;  int config ;  struct work_struct work ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct usb_cdc_mbim_desc cocci_id@p ;
...
position p;
@@
 struct usb_cdc_country_functional_desc cocci_id@p ;
...
position p;
@@
 struct usb_cdc_acm_descriptor * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usb_device * udev ) ;
...
position p;
@@
 struct usb_interface_cache * cocci_id@p ;
...
position p;
@@
 struct api_context {  struct completion done ;  int status ; } cocci_id@p ;
