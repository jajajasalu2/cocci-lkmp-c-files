...
position p;
@@
 struct rt2x00debug_intf cocci_id@p ;
...
position p;
@@
 struct rt2x00debug_crypto {  unsigned long success ;  unsigned long icv_error ;  unsigned long mic_error ;  unsigned long key_error ; } cocci_id@p ;
...
position p;
@@
 enum rt2x00_dump_type cocci_id@p ;
...
position p;
@@
 struct rt2x00dump_hdr * cocci_id@p ;
