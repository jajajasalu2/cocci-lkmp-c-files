...
position p;
@@
 struct hda_pipe_params * cocci_id@p ;
...
position p;
@@
 struct sof_intel_hda_stream * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,snd_pcm_format_t;
@@
 struct hda_pipe_params {  u8 host_dma_id ;  u8 link_dma_id ;  u32 ch ;  u32 s_freq ;  u32 s_fmt ;  u8 linktype ;  snd_pcm_format_t format ;  int link_index ;  int stream ;  unsigned int host_bps ;  unsigned int link_bps ; } cocci_id@p ;
