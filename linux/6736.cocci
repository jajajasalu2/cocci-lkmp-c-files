...
position p;
@@
 void ( * cocci_id@p ) ( struct csio_hw * , struct csio_mb * ) ;
...
position p;
@@
 struct fw_fcoe_vnp_cmd * cocci_id@p ;
...
position p;
@@
 enum fw_fcoe_link_status cocci_id@p ;
...
position p;
@@
 struct csio_fcf_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef csio_sm_state_t;
@@
 csio_sm_state_t cocci_id@p ;
...
position p;
@@
 struct fw_fcoe_els_ct_wr * cocci_id@p ;
...
position p;
@@
 struct fw_fcoe_fcf_cmd * cocci_id@p ;
...
position p;
@@
 struct fw_fcoe_port_cmd_params cocci_id@p ;
...
position p;
@@
 struct csio_wr_pair cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct csio_lnode * , enum csio_ln_ev ) ;
...
position p;
@@
 struct fc_fdmi_port_name * cocci_id@p ;
...
position p;
@@
 struct fw_fcoe_port_stats * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct csio_hw * , struct csio_ioreq * ) ;
...
position p;
@@
 struct fw_fcoe_link_cmd * cocci_id@p ;
...
position p;
@@
 struct csio_dma_buf * cocci_id@p ;
...
position p;
@@
 enum csio_ln_notify cocci_id@p ;
...
position p;
@@
 struct fs_fdmi_attrs * cocci_id@p ;
...
position p;
@@
 struct fc_fdmi_hba_identifier * cocci_id@p ;
