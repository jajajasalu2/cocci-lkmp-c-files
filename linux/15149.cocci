...
symbol cocci_id;
position p;
typedef mm_iommu_table_group_mem_t;
@@
 struct tce_iommu_prereg {  struct list_head next ;  struct mm_iommu_table_group_mem_t * mem ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * iommu_data , struct iommu_group * iommu_group ) ;
...
position p;
@@
 struct vfio_iommu_spapr_tce_remove cocci_id@p ;
...
typedef mm_iommu_table_group_mem_t;
@@
 struct mm_iommu_table_group_mem_t * cocci_id@p ;
...
position p;
@@
 struct tce_iommu_prereg * cocci_id@p ;
...
position p;
@@
 struct tce_iommu_group {  struct list_head next ;  struct iommu_group * grp ; } cocci_id@p ;
...
position p;
@@
 struct iommu_table_group * cocci_id@p ;
...
position p;
@@
 struct tce_iommu_group * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tce_container * container , struct iommu_table * tbl ) ;
...
typedef bool;
@@
 struct tce_container {  struct mutex lock ;  bool enabled ;  bool v2 ;  bool def_window_pending ;  unsigned long locked_pages ;  struct mm_struct * mm ;  struct iommu_table * tables [ IOMMU_TABLE_GROUP_MAX_TABLES ] ;  struct list_head group_list ;  struct list_head prereg_list ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tce_container * container , struct iommu_table * tbl , unsigned long entry , unsigned long pages ) ;
...
position p;
@@
 struct tce_container * cocci_id@p ;
...
position p;
@@
 struct vfio_iommu_spapr_register_memory cocci_id@p ;
...
position p;
@@
 struct vfio_iommu_spapr_tce_info cocci_id@p ;
...
position p;
@@
 struct vfio_iommu_spapr_tce_create cocci_id@p ;
