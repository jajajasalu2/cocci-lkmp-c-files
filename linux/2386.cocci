...
position p;
@@
 struct zynqmp_dma_desc_sw * cocci_id@p ;
...
position p;
@@
 struct zynqmp_dma_chan cocci_id@p ;
...
position p;
@@
 struct zynqmp_dma_device {  struct device * dev ;  struct dma_device common ;  struct zynqmp_dma_chan * chan ;  struct clk * clk_main ;  struct clk * clk_apb ; } cocci_id@p ;
...
position p;
@@
 struct zynqmp_dma_desc_ll * cocci_id@p ;
...
typedef u64,u32;
@@
 struct zynqmp_dma_desc_ll {  u64 addr ;  u32 size ;  u32 ctrl ;  u64 nxtdscraddr ;  u64 rsvd ; } cocci_id@p ;
...
position p;
@@
 struct zynqmp_dma_device * cocci_id@p ;
...
@@
 struct zynqmp_dma_desc_sw {  u64 src ;  u64 dst ;  u32 len ;  struct list_head node ;  struct list_head tx_list ;  struct dma_async_tx_descriptor async_tx ;  struct zynqmp_dma_desc_ll * src_v ;  dma_addr_t src_p ;  struct zynqmp_dma_desc_ll * dst_v ;  dma_addr_t dst_p ; } cocci_id@p ;
