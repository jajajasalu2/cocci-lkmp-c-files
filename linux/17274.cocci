...
typedef u64;
@@
 struct ps3_bmp {  struct {  u64 status ;  u64 unused_1 [ 3 ] ;  unsigned long mask ;  u64 unused_2 [ 3 ] ; } ; } cocci_id@p ;
...
position p;
@@
 enum ps3_cpu_binding cocci_id@p ;
...
position p;
@@
 const struct ps3_private * cocci_id@p ;
