...
typedef FILE;
@@
 int cocci_id@p ( FILE * stream , int value ) ;
...
typedef FILE;
@@
 void cocci_id@p ( FILE * stream , int value ) ;
...
position p;
@@
 void cocci_id@p ( struct mq_attr * attr ) ;
...
typedef FILE;
@@
 void cocci_id@p ( FILE * stream , int value , char * err_msg ) ;
...
position p;
@@
 void cocci_id@p ( int type , struct rlimit * rlim ) ;
...
position p;
@@
 void cocci_id@p ( int exit_val , char * err_cause , int line_no ) ;
...
position p;
@@
 struct test {  char * desc ;  void ( * func ) ( int * ) ; } cocci_id@p ;
