...
position p;
@@
 enum { RF_INIT_ST , RF_DSYNC_ST , } cocci_id@p ;
...
position p;
@@
 struct nilfs_recovery_info * cocci_id@p ;
...
position p;
@@
 struct nilfs_segment_entry cocci_id@p ;
...
position p;
@@
 struct nilfs_recovery_block * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u64,sector_t,ino_t;
@@
 struct nilfs_recovery_block {  ino_t ino ;  sector_t blocknr ;  __u64 vblocknr ;  unsigned long blkoff ;  struct list_head list ; } cocci_id@p ;
...
typedef __u64;
@@
 struct nilfs_segment_entry {  struct list_head list ;  __u64 segnum ; } cocci_id@p ;
...
position p;
@@
 enum { NILFS_SEG_VALID , NILFS_SEG_NO_SUPER_ROOT , NILFS_SEG_FAIL_IO , NILFS_SEG_FAIL_MAGIC , NILFS_SEG_FAIL_SEQ , NILFS_SEG_FAIL_CHECKSUM_SUPER_ROOT , NILFS_SEG_FAIL_CHECKSUM_FULL , NILFS_SEG_FAIL_CONSISTENCY , } cocci_id@p ;
