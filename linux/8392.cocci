...
typedef u8,u32;
@@
 struct nfp_mask_id_table {  struct hlist_node link ;  u32 hash_key ;  u32 ref_cnt ;  u8 mask_id ; } cocci_id@p ;
...
position p;
@@
 struct nfp_fl_stats cocci_id@p ;
...
position p;
@@
 const struct nfp_fl_payload * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_stats_frame * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_stats_ctx_to_flow * cocci_id@p ;
...
typedef u32;
@@
 struct nfp_fl_stats_ctx_to_flow {  struct rhash_head ht_node ;  u32 stats_cxt ;  struct nfp_fl_payload * flow ; } cocci_id@p ;
...
position p;
@@
 struct nfp_fl_flow_table_cmp_arg cocci_id@p ;
...
position p;
@@
 const struct nfp_fl_flow_table_cmp_arg * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_flow_table_cmp_arg {  struct net_device * netdev ;  unsigned long cookie ; } cocci_id@p ;
...
position p;
@@
 struct nfp_mask_id_table * cocci_id@p ;
