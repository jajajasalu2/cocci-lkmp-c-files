...
position p;
@@
 struct dsp_symbol_entry * cocci_id@p ;
...
position p;
@@
 struct dsp_segment_desc * cocci_id@p ;
...
position p;
@@
 struct cs_card_type cocci_id@p [ ] ;
...
position p;
@@
 struct snd_info_entry_ops cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ CS46XX_DSP_MODULES ] ;
...
position p;
@@
 struct snd_cs46xx_region * cocci_id@p ;
...
typedef u16;
@@
 struct cs_card_type {  u16 vendor ;  u16 id ;  char * name ;  void ( * init ) ( struct snd_cs46xx * ) ;  void ( * amp ) ( struct snd_cs46xx * , int ) ;  void ( * active ) ( struct snd_cs46xx * , int ) ;  void ( * mixer_init ) ( struct snd_cs46xx * ) ; } cocci_id@p ;
...
position p;
@@
 struct dsp_module_desc * * cocci_id@p ;
...
typedef u32;
@@
 struct ba1_struct {  struct {  u32 offset ;  u32 size ; } memory [ BA1_MEMORY_COUNT ] ;  u32 map [ BA1_DWORD_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct snd_cs46xx_pcm * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_indirect * cocci_id@p ;
...
position p;
@@
 struct dsp_spos_instance * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_cs46xx * chip , int change ) ;
