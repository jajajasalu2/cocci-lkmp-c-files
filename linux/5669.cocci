...
position p;
@@
 const struct pcf85063_config cocci_id@p ;
...
position p;
@@
 struct pcf85063 {  struct rtc_device * rtc ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct pcf85063_config {  struct regmap_config regmap ;  unsigned has_alarms : 1 ;  unsigned force_cap_7000 : 1 ; } cocci_id@p ;
