...
position p;
@@
 const enum hw_event_mc_err_type cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ EDAC_MAX_LAYERS ] ;
...
position p;
@@
 const int cocci_id@p [ EDAC_MAX_LAYERS ] ;
...
position p;
@@
 unsigned int cocci_id@p [ EDAC_MAX_LAYERS ] ;
