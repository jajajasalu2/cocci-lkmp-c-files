...
position p;
@@
 struct ice_hw_port_stats * cocci_id@p ;
...
position p;
@@
 struct ice_rq_event_info * cocci_id@p ;
...
position p;
@@
 struct ice_eth_stats * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ice_vsi * vsi ) ;
...
position p;
@@
 void cocci_id@p ( struct ice_pf * pf ) ;
...
position p;
@@
 struct ice_ctl_q_info * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_vsi_props * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ICE_INT_NAME_STR_LEN ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ ICE_MAX_TRAFFIC_CLASS ] ;
...
position p;
@@
 void cocci_id@p ( struct ice_pf * pf , enum ice_reset_req reset_type ) ;
