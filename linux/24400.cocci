...
position p;
@@
 struct bnep_control_rsp cocci_id@p ;
...
position p;
@@
 struct bnep_connadd_req * cocci_id@p ;
...
position p;
@@
 struct bnep_session * cocci_id@p ;
...
position p;
@@
 struct bnep_conninfo * cocci_id@p ;
...
position p;
@@
 struct bnep_connlist_req * cocci_id@p ;
...
position p;
@@
 struct bnep_conndel_req * cocci_id@p ;
...
position p;
@@
 struct bnep_proto_filter * cocci_id@p ;
...
position p;
@@
 struct bnep_ext_hdr * cocci_id@p ;
