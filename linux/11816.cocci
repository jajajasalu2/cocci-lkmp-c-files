...
position p;
@@
 union {  struct nvif_mem_ram_vn vn ;  struct nvif_mem_ram_v0 v0 ; } * cocci_id@p ;
...
@@
 struct nvkm_mem {  struct nvkm_memory memory ;  enum nvkm_memory_target target ;  struct nvkm_mmu * mmu ;  u64 pages ;  struct page * * mem ;  union {  struct scatterlist * sgl ;  dma_addr_t * dma ; } ; } cocci_id@p ;
