...
position p;
@@
 const struct fib_rules_ops * cocci_id@p ;
...
position p;
@@
 struct fib_kuid_range * cocci_id@p ;
...
position p;
@@
 struct fib_rule_port_range cocci_id@p ;
...
position p;
@@
 const struct fib_rule_port_range * cocci_id@p ;
...
position p;
@@
 const struct fib_kuid_range cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( int event , struct fib_rule * rule , struct fib_rules_ops * ops , struct nlmsghdr * nlh , u32 pid ) ;
...
position p;
@@
 struct nlattr * cocci_id@p [ FRA_MAX + 1 ] ;
...
position p;
@@
 struct fib_rule_uid_range cocci_id@p ;
