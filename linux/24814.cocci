...
position p;
@@
 struct xt_tee_priv {  struct list_head list ;  struct xt_tee_tginfo * tginfo ;  int oif ; } cocci_id@p ;
...
position p;
@@
 struct tee_net {  struct list_head priv_list ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 const struct xt_tee_tginfo * cocci_id@p ;
...
position p;
@@
 struct xt_tee_tginfo * cocci_id@p ;
