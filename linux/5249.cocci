...
position p;
@@
 struct mtk_ahci_plat {  struct regmap * mode ;  struct reset_control * axi_rst ;  struct reset_control * sw_rst ;  struct reset_control * reg_rst ; } cocci_id@p ;
...
position p;
@@
 struct mtk_ahci_plat * cocci_id@p ;
