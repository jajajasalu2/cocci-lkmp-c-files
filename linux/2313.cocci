...
position p;
@@
 const int cocci_id@p [ TSC_MAX_NUM ] [ 3 ] ;
...
position p;
@@
 struct equation_coefs {  int a1 ;  int b1 ;  int a2 ;  int b2 ; } cocci_id@p ;
...
position p;
@@
 struct rcar_gen3_thermal_tsc * cocci_id@p ;
...
typedef tj_t;
@@
 struct rcar_gen3_thermal_tsc {  void __iomem * base ;  struct thermal_zone_device * zone ;  struct equation_coefs coef ;  int low ;  int high ;  int tj_t ;  int id ; } cocci_id@p ;
...
position p;
@@
 struct rcar_gen3_thermal_priv {  struct rcar_gen3_thermal_tsc * tscs [ TSC_MAX_NUM ] ;  unsigned int num_tscs ;  void ( * thermal_init ) ( struct rcar_gen3_thermal_tsc * tsc ) ; } cocci_id@p ;
...
position p;
@@
 struct rcar_gen3_thermal_priv * cocci_id@p ;
