...
position p;
@@
 struct pmap {  unsigned int mode ;  unsigned int p1 ;  unsigned int p2 ;  unsigned int state ; } cocci_id@p ;
...
position p;
@@
 struct private_data {  void __iomem * base ;  void __iomem * avs_intr_base ;  struct device * dev ;  struct completion done ;  struct semaphore sem ;  struct pmap pmap ; } cocci_id@p ;
...
position p;
@@
 struct private_data * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ AVS_MAX_CMD_ARGS ] ;
