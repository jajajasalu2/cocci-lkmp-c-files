...
position p;
@@
 const struct ske_keypad_platform_data * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct ske_keypad {  int irq ;  void __iomem * reg_base ;  struct input_dev * input ;  const struct ske_keypad_platform_data * board ;  unsigned short keymap [ SKE_KPD_NUM_ROWS * SKE_KPD_NUM_COLS ] ;  struct clk * clk ;  struct clk * pclk ;  spinlock_t ske_keypad_lock ; } cocci_id@p ;
