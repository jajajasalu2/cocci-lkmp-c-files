...
position p;
@@
 struct iwl_mvm_mac_ap_iterator_data cocci_id@p ;
...
typedef bool;
@@
 struct iwl_mvm_mac_iface_iterator_data {  struct iwl_mvm * mvm ;  struct ieee80211_vif * vif ;  unsigned long available_mac_ids [ BITS_TO_LONGS ( NUM_MAC_INDEX_DRIVER ) ] ;  unsigned long available_tsf_ids [ BITS_TO_LONGS ( NUM_TSF_IDS ) ] ;  enum iwl_tsf_id preferred_tsf ;  bool found_vif ; } cocci_id@p ;
...
position p;
@@
 struct iwl_missed_beacons_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_mac_data_sta * cocci_id@p ;
...
position p;
@@
 struct iwl_channel_switch_noa_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_probe_resp_data_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_mac_ctx_cmd cocci_id@p ;
...
typedef bool;
@@
 struct iwl_mvm_go_iterator_data {  bool go_active ; } cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_tx_resp * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_go_iterator_data * cocci_id@p ;
...
position p;
@@
 struct iwl_missed_vap_notif * cocci_id@p ;
...
typedef u32,u16;
@@
 struct iwl_mvm_mac_ap_iterator_data {  struct iwl_mvm * mvm ;  struct ieee80211_vif * vif ;  u32 beacon_device_ts ;  u16 beacon_int ; } cocci_id@p ;
...
position p;
@@
 struct iwl_extended_beacon_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_mac_beacon_cmd_v7 cocci_id@p ;
...
position p;
@@
 struct iwl_stored_beacon_notif * cocci_id@p ;
...
position p;
@@
 struct ieee80211_p2p_noa_desc cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_mac_iface_iterator_data cocci_id@p ;
...
position p;
@@
 struct iwl_mac_data_ap * cocci_id@p ;
...
position p;
@@
 struct iwl_mac_beacon_cmd_v6 cocci_id@p ;
...
position p;
@@
 struct iwl_extended_beacon_notif_v5 * cocci_id@p ;
