...
position p;
@@
 const struct bpf_sock_ops_kern * cocci_id@p ;
...
typedef u8,u32;
@@
 struct bpf_htab_elem {  struct rcu_head rcu ;  u32 hash ;  struct sock * sk ;  struct hlist_node node ;  u8 key [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct bpf_htab_bucket cocci_id@p ;
...
position p;
@@
 struct bpf_htab_elem * cocci_id@p ;
...
position p;
@@
 struct sk_psock_progs * cocci_id@p ;
...
@@
 struct bpf_htab {  struct bpf_map map ;  struct bpf_htab_bucket * buckets ;  u32 buckets_num ;  u32 elem_size ;  struct sk_psock_progs progs ;  atomic_t count ; } cocci_id@p ;
...
@@
 struct bpf_htab_bucket {  struct hlist_head head ;  raw_spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct sk_psock_link * cocci_id@p ;
...
typedef raw_spinlock_t;
@@
 struct bpf_stab {  struct bpf_map map ;  struct sock * * sks ;  struct sk_psock_progs progs ;  raw_spinlock_t lock ; } cocci_id@p ;
