...
typedef u32;
@@
 struct ioc_iommu {  u32 func_id ;  char * name ;  initfunc * init ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct device * dev , struct scatterlist * sglist , int nents , enum dma_data_direction dir , unsigned long attrs ) ;
