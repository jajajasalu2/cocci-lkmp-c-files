...
position p;
@@
 struct drm_radeon_gem_get_tiling * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_set_tiling * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_op * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_set_domain * cocci_id@p ;
...
position p;
@@
 struct radeon_bo_va * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_userptr * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_wait_idle * cocci_id@p ;
...
position p;
@@
 struct radeon_fpriv * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_info * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_create * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_mmap * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_busy * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_gem_va * cocci_id@p ;
