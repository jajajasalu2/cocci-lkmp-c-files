...
typedef u8,u32;
@@
 struct bpf_jit {  u32 seen ;  u32 seen_reg [ 16 ] ;  u32 * addrs ;  u8 * prg_buf ;  int size ;  int size_prg ;  int prg ;  int lit32_start ;  int lit32 ;  int lit64_start ;  int lit64 ;  int base_ip ;  int exit_ip ;  int r1_thunk_ip ;  int r14_thunk_ip ;  int tail_call_start ;  int labels [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct s390_jit_data {  struct bpf_binary_header * header ;  struct bpf_jit ctx ;  int pass ; } cocci_id@p ;
...
position p;
@@
 struct s390_jit_data * cocci_id@p ;
