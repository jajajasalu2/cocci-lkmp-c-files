...
position p;
@@
 struct atmel_pmecc_caps cocci_id@p ;
...
position p;
@@
 const struct atmel_pmecc_gf_tables * * cocci_id@p ;
...
typedef u16;
@@
 struct atmel_pmecc_gf_tables {  u16 * alpha_to ;  u16 * index_of ; } cocci_id@p ;
...
typedef u32,s16,s32;
@@
 struct atmel_pmecc_user {  struct atmel_pmecc_user_conf_cache cache ;  struct atmel_pmecc * pmecc ;  const struct atmel_pmecc_gf_tables * gf_tables ;  int eccbytes ;  s16 * partial_syn ;  s16 * si ;  s16 * lmu ;  s16 * smu ;  s32 * mu ;  s32 * dmu ;  s32 * delta ;  u32 isr ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_pmecc_user_req * cocci_id@p ;
...
typedef u32;
@@
 struct atmel_pmecc_user_conf_cache {  u32 cfg ;  u32 sarea ;  u32 saddr ;  u32 eaddr ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_pmecc_caps * cocci_id@p ;
...
typedef bool;
@@
 struct atmel_pmecc_caps {  const int * strengths ;  int nstrengths ;  int el_offset ;  bool correct_erased_chunks ; } cocci_id@p ;
...
position p;
@@
 struct atmel_pmecc_user * cocci_id@p ;
...
position p;
@@
 struct atmel_pmecc {  struct device * dev ;  const struct atmel_pmecc_caps * caps ;  struct {  void __iomem * base ;  void __iomem * errloc ; } regs ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct atmel_pmecc_gf_tables * cocci_id@p ;
