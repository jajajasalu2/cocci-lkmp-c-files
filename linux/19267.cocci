...
position p;
@@
 struct plat_smp_ops cocci_id@p ;
...
position p;
@@
 struct mcip_idu_bcr cocci_id@p ;
...
position p;
@@
 union {  unsigned int word ;  struct {  unsigned int distr : 2 , pad : 2 , lvl : 1 , pad2 : 27 ; } ; } cocci_id@p ;
