...
position p;
@@
 struct copy_subpage_arg * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned long addr , int idx , void * arg ) ;
...
position p;
@@
 struct copy_subpage_arg {  struct page * dst ;  struct page * src ;  struct vm_area_struct * vma ; } cocci_id@p ;
