...
typedef u8;
@@
 struct regdata {  u8 reg ;  u8 data ; } cocci_id@p ;
...
position p;
@@
 const struct linear_segments * cocci_id@p ;
...
typedef bool,u32;
@@
 struct mb86a20s_state {  struct i2c_adapter * i2c ;  const struct mb86a20s_config * config ;  u32 last_frequency ;  struct dvb_frontend frontend ;  u32 if_freq ;  enum mb86a20s_bandwidth bw ;  bool inversion ;  u32 subchannel ;  u32 estimated_rate [ NUM_LAYERS ] ;  unsigned long get_strength_time ;  bool need_init ; } cocci_id@p ;
...
position p;
@@
 enum mb86a20s_bandwidth { MB86A20S_13SEG = 0 , MB86A20S_13SEG_PARTIAL = 1 , MB86A20S_1SEG = 2 , MB86A20S_3SEG = 3 , } cocci_id@p ;
...
position p;
@@
 struct mb86a20s_state * cocci_id@p ;
