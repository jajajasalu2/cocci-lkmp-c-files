...
position p;
@@
 enum promote_result cocci_id@p ;
...
position p;
@@
 struct smq_hash_table * cocci_id@p ;
...
position p;
@@
 enum performance { Q_POOR , Q_FAIR , Q_WELL , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,dm_oblock_t;
@@
 struct entry {  unsigned hash_next : 28 ;  unsigned prev : 28 ;  unsigned next : 28 ;  unsigned level : 6 ;  bool dirty : 1 ;  bool allocated : 1 ;  bool sentinel : 1 ;  bool pending_work : 1 ;  dm_oblock_t oblock ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,dm_cblock_t,sector_t,spinlock_t;
@@
 struct smq_policy {  struct dm_cache_policy policy ;  spinlock_t lock ;  dm_cblock_t cache_size ;  sector_t cache_block_size ;  sector_t hotspot_block_size ;  unsigned nr_hotspot_blocks ;  unsigned cache_blocks_per_hotspot_block ;  unsigned hotspot_level_jump ;  struct entry_space es ;  struct entry_alloc writeback_sentinel_alloc ;  struct entry_alloc demote_sentinel_alloc ;  struct entry_alloc hotspot_alloc ;  struct entry_alloc cache_alloc ;  unsigned long * hotspot_hit_bits ;  unsigned long * cache_hit_bits ;  struct queue hotspot ;  struct queue clean ;  struct queue dirty ;  struct stats hotspot_stats ;  struct stats cache_stats ;  unsigned tick ;  struct smq_hash_table table ;  struct smq_hash_table hotspot_table ;  bool current_writeback_sentinels ;  unsigned long next_writeback_period ;  bool current_demote_sentinels ;  unsigned long next_demote_period ;  unsigned write_promote_level ;  unsigned read_promote_level ;  unsigned long next_hotspot_period ;  unsigned long next_cache_period ;  struct background_tracker * bg_work ;  bool migrations_allowed ; } cocci_id@p ;
...
position p;
@@
 struct smq_hash_table {  struct entry_space * es ;  unsigned long long hash_bits ;  unsigned * buckets ; } cocci_id@p ;
...
position p;
@@
 struct entry_space {  struct entry * begin ;  struct entry * end ; } cocci_id@p ;
...
position p;
@@
 struct dm_cache_policy_type cocci_id@p ;
...
position p;
@@
 struct queue {  struct entry_space * es ;  unsigned nr_elts ;  unsigned nr_levels ;  struct ilist qs [ MAX_LEVELS ] ;  unsigned last_target_nr_elts ;  unsigned nr_top_levels ;  unsigned nr_in_top_levels ;  unsigned target_count [ MAX_LEVELS ] ; } cocci_id@p ;
...
position p;
@@
 enum promote_result { PROMOTE_NOT , PROMOTE_TEMPORARY , PROMOTE_PERMANENT , } cocci_id@p ;
...
position p;
@@
 struct stats {  unsigned hit_threshold ;  unsigned hits ;  unsigned misses ; } cocci_id@p ;
...
position p;
@@
 struct entry_alloc {  struct entry_space * es ;  unsigned begin ;  unsigned nr_allocated ;  struct ilist free ; } cocci_id@p ;
