...
position p;
@@
 struct cros_ec_extcon_info cocci_id@p ;
...
position p;
@@
 struct ec_params_usb_pd_mux_info cocci_id@p ;
...
position p;
@@
 struct ec_response_usb_pd_mux_info cocci_id@p ;
...
position p;
@@
 enum usb_data_roles { DR_NONE , DR_HOST , DR_DEVICE , } cocci_id@p ;
...
typedef bool;
@@
 struct cros_ec_extcon_info {  struct device * dev ;  struct extcon_dev * edev ;  int port_id ;  struct cros_ec_device * ec ;  struct notifier_block notifier ;  unsigned int dr ;  bool pr ;  bool dp ;  bool mux ;  unsigned int power_type ; } cocci_id@p ;
