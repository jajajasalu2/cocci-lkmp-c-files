...
typedef ino_t;
@@
 struct check_orphan {  struct rb_node rb ;  ino_t inum ; } cocci_id@p ;
...
position p;
@@
 struct check_orphan cocci_id@p ;
...
position p;
@@
 struct ubifs_orph_node * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ubifs_info * c ) ;
...
position p;
@@
 struct check_info {  unsigned long last_ino ;  unsigned long tot_inos ;  unsigned long missing ;  unsigned long long leaf_cnt ;  struct ubifs_ino_node * node ;  struct rb_root root ; } cocci_id@p ;
