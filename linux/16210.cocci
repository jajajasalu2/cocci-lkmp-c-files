...
position p;
@@
 const struct core_table_entry cocci_id@p ;
...
position p;
@@
 struct core_table_entry cocci_id@p ;
...
position p;
@@
 struct kpc_uio_device * cocci_id@p ;
...
@@
 struct core_table_entry {  u16 type ;  u32 offset ;  u32 length ;  bool s2c_dma_present ;  u8 s2c_dma_channel_num ;  bool c2s_dma_present ;  u8 c2s_dma_channel_num ;  u8 irq_count ;  u8 irq_base_num ; } cocci_id@p ;
...
position p;
@@
 struct kp2000_device * cocci_id@p ;
...
typedef u16;
@@
 struct kpc_uio_device {  struct list_head list ;  struct kp2000_device * pcard ;  struct device * dev ;  struct uio_info uioinfo ;  struct core_table_entry cte ;  u16 core_num ; } cocci_id@p ;
