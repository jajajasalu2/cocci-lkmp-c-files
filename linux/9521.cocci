...
position p;
@@
 struct btc_stack_info * cocci_id@p ;
...
position p;
@@
 struct coex_sta_8821a_1ant * cocci_id@p ;
...
position p;
@@
 struct btc_board_info * cocci_id@p ;
...
position p;
@@
 struct btc_bt_link_info * cocci_id@p ;
...
position p;
@@
 struct coex_dm_8821a_1ant cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct btc_coexist * btcoexist , u8 wifi_status ) ;
