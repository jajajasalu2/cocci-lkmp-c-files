...
position p;
@@
 struct mlx5_ib_gsi_qp * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_gsi_wr * cocci_id@p ;
...
typedef bool;
@@
 struct mlx5_ib_gsi_wr {  struct ib_cqe cqe ;  struct ib_wc wc ;  int send_flags ;  bool completed : 1 ; } cocci_id@p ;
