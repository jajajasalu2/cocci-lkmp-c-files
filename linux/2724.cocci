...
position p;
@@
 struct uniphier_i2c_priv {  struct completion comp ;  struct i2c_adapter adap ;  void __iomem * membase ;  struct clk * clk ;  unsigned int busy_cnt ;  unsigned int clk_cycle ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_i2c_priv * cocci_id@p ;
