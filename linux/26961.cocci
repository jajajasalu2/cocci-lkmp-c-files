...
position p;
@@
 struct nfs_referral_count {  struct list_head list ;  const struct task_struct * task ;  unsigned int referral_count ; } cocci_id@p ;
...
position p;
@@
 struct nfs_referral_count * cocci_id@p ;
