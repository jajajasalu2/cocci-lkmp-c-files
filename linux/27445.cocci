...
symbol cocci_id;
position p;
typedef pagemap_entry_t;
@@
 pagemap_entry_t * cocci_id@p ;
...
position p;
@@
 struct clear_refs_private * cocci_id@p ;
...
position p;
@@
 struct mem_size_stats cocci_id@p ;
...
position p;
@@
 enum clear_refs_types cocci_id@p ;
...
position p;
@@
 struct proc_maps_private * cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ BITS_PER_LONG ] [ 2 ] ;
...
position p;
@@
 struct numa_maps {  unsigned long pages ;  unsigned long anon ;  unsigned long active ;  unsigned long writeback ;  unsigned long mapcount_max ;  unsigned long dirty ;  unsigned long swapcache ;  unsigned long node [ MAX_NUMNODES ] ; } cocci_id@p ;
...
position p;
@@
 struct numa_maps_private {  struct proc_maps_private proc_maps ;  struct numa_maps md ; } cocci_id@p ;
...
position p;
@@
 struct numa_maps_private * cocci_id@p ;
...
position p;
@@
 struct clear_refs_private {  enum clear_refs_types type ; } cocci_id@p ;
...
position p;
@@
 const struct mem_size_stats * cocci_id@p ;
...
position p;
@@
 enum clear_refs_types { CLEAR_REFS_ALL = 1 , CLEAR_REFS_ANON , CLEAR_REFS_MAPPED , CLEAR_REFS_SOFT_DIRTY , CLEAR_REFS_MM_HIWATER_RSS , CLEAR_REFS_LAST , } cocci_id@p ;
