...
position p;
@@
 struct imx_sc_msg_req_cpu_start cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_req_misc_get_ctrl cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_resp_misc_get_ctrl * cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_req_misc_set_ctrl cocci_id@p ;
