...
position p;
@@
 struct gelic_eurus_scan_info cocci_id@p ;
...
position p;
@@
 const struct eurus_cmd_arg_info cocci_id@p [ GELIC_EURUS_CMD_MAX_INDEX ] ;
...
position p;
@@
 struct gelic_eurus_rssi_info * cocci_id@p ;
...
position p;
@@
 struct eurus_cmd_arg_info {  int pre_arg ;  int post_arg ; } cocci_id@p ;
...
position p;
@@
 struct gelic_wl_scan_info cocci_id@p ;
...
position p;
@@
 enum gelic_eurus_command cocci_id@p ;
...
position p;
@@
 struct gelic_wl_info * cocci_id@p ;
...
typedef u8;
@@
 struct ie_item {  u8 * data ;  u8 len ; } cocci_id@p ;
...
position p;
@@
 struct gelic_eurus_cmd * cocci_id@p ;
...
position p;
@@
 enum gelic_eurus_wpa_security cocci_id@p ;
...
position p;
@@
 struct gelic_eurus_wpa_cfg * cocci_id@p ;
...
position p;
@@
 struct ie_info {  struct ie_item wpa ;  struct ie_item rsn ; } cocci_id@p ;
...
position p;
@@
 enum gelic_lv1_wl_event cocci_id@p ;
...
position p;
@@
 struct gelic_eurus_wep_cfg * cocci_id@p ;
...
position p;
@@
 struct gelic_eurus_common_cfg * cocci_id@p ;
