...
position p;
@@
 struct generic_gcmaes_ctx * cocci_id@p ;
...
position p;
@@
 const struct aesni_gcm_tfm_s cocci_id@p ;
...
position p;
@@
 struct gcm_context_data cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( void * ctx , struct gcm_context_data * gdata , u8 * auth_tag , unsigned long auth_tag_len ) ;
...
typedef u8;
@@
 void cocci_id@p ( void * ctx , struct gcm_context_data * gdata , u8 * out , const u8 * in , unsigned long ciphertext_len , u8 * iv , u8 * hash_subkey , const u8 * aad , unsigned long aad_len , u8 * auth_tag , unsigned long auth_tag_len ) ;
...
position p;
@@
 struct aesni_xts_ctx cocci_id@p ;
...
position p;
@@
 struct simd_skcipher_alg * cocci_id@p [ ARRAY_SIZE ( aesni_skciphers ) ] ;
...
position p;
@@
 struct scatter_walk cocci_id@p ;
...
position p;
@@
 struct aesni_rfc4106_gcm_ctx cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct crypto_aes_ctx * ctx , u8 * out , const u8 * in ) ;
...
typedef u64,u8;
@@
 struct gcm_context_data {  u8 aad_hash [ GCM_BLOCK_LEN ] ;  u64 aad_length ;  u64 in_length ;  u8 partial_block_enc_key [ GCM_BLOCK_LEN ] ;  u8 orig_IV [ GCM_BLOCK_LEN ] ;  u8 current_counter [ GCM_BLOCK_LEN ] ;  u64 partial_block_len ;  u64 unused ;  u8 hash_keys [ GCM_BLOCK_LEN * 16 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct generic_gcmaes_ctx {  u8 hash_subkey [ 16 ] ;  struct crypto_aes_ctx aes_key_expanded ; } cocci_id@p ;
...
position p;
@@
 const struct common_glue_ctx cocci_id@p ;
...
typedef u8;
@@
 struct aesni_rfc4106_gcm_ctx {  u8 hash_subkey [ 16 ] ;  struct crypto_aes_ctx aes_key_expanded ;  u8 nonce [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct crypto_aes_ctx * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( const u8 * in , u8 * iv , void * keys , u8 * out , unsigned int num_bytes ) ;
...
typedef u8,bool;
@@
 void cocci_id@p ( struct crypto_aes_ctx * ctx , u8 * out , const u8 * in , bool enc , u8 * iv ) ;
...
typedef u8;
@@
 void cocci_id@p ( void * my_ctx_data , struct gcm_context_data * gdata , u8 * iv , u8 * hash_subkey , const u8 * aad , unsigned long aad_len ) ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( struct crypto_aes_ctx * ctx , u8 * out , const u8 * in , unsigned int len , u8 * iv ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct crypto_aes_ctx * ctx , const u8 * in_key , unsigned int key_len ) ;
...
typedef u8;
@@
 void cocci_id@p ( void * ctx , struct gcm_context_data * gdata , u8 * out , const u8 * in , unsigned long ciphertext_len , u8 * iv , const u8 * aad , unsigned long aad_len , u8 * auth_tag , unsigned long auth_tag_len ) ;
...
typedef u8;
@@
 void cocci_id@p ( void * ctx , struct gcm_context_data * gdata , u8 * out , const u8 * in , unsigned long plaintext_len , u8 * iv , const u8 * aad , unsigned long aad_len , u8 * auth_tag , unsigned long auth_tag_len ) ;
...
typedef u8;
@@
 void cocci_id@p ( void * ctx , struct gcm_context_data * gdata , u8 * out , const u8 * in , unsigned long ciphertext_len ) ;
...
typedef u8;
@@
 void cocci_id@p ( void * ctx , struct gcm_context_data * gdata , u8 * out , const u8 * in , unsigned long plaintext_len ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct crypto_aes_ctx * ctx , u8 * out , const u8 * in , unsigned int len ) ;
...
typedef u8;
@@
 void cocci_id@p ( void * ctx , struct gcm_context_data * gdata , u8 * out , const u8 * in , unsigned long plaintext_len , u8 * iv , u8 * hash_subkey , const u8 * aad , unsigned long aad_len , u8 * auth_tag , unsigned long auth_tag_len ) ;
...
typedef u8;
@@
 void cocci_id@p ( void * ctx , struct gcm_context_data * gdata , u8 * iv , u8 * hash_subkey , const u8 * aad , unsigned long aad_len ) ;
...
position p;
@@
 struct simd_aead_alg * cocci_id@p [ ARRAY_SIZE ( aesni_aeads ) ] ;
...
typedef u8;
@@
 struct aesni_xts_ctx {  u8 raw_tweak_ctx [ sizeof ( struct crypto_aes_ctx ) ] ;  u8 raw_crypt_ctx [ sizeof ( struct crypto_aes_ctx ) ] ; } cocci_id@p ;
