...
position p;
@@
 struct pcan_usb_fd_if * cocci_id@p ;
...
position p;
@@
 struct pcan_ufd_clock * cocci_id@p ;
...
position p;
@@
 struct pucan_rx_msg * cocci_id@p ;
...
position p;
@@
 struct pcan_ufd_options * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct __packed pcan_ufd_ovr_msg {  __le16 size ;  __le16 type ;  __le32 ts_low ;  __le32 ts_high ;  u8 channel ;  u8 unused [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct pcan_usb_fd_device cocci_id@p ;
...
position p;
@@
 struct pucan_wr_err_cnt cocci_id@p ;
...
position p;
@@
 const struct peak_usb_adapter cocci_id@p ;
...
position p;
@@
 struct pcan_usb_fd_if {  struct peak_usb_device * dev [ PCAN_USB_MAX_CHANNEL ] ;  struct pcan_ufd_fw_info fw_info ;  struct peak_time_ref time_ref ;  int cm_ignore_count ;  int dev_opened_count ; } cocci_id@p ;
...
position p;
@@
 struct can_berr_counter * cocci_id@p ;
...
position p;
@@
 struct pucan_status_msg * cocci_id@p ;
...
position p;
@@
 struct pucan_tx_msg * cocci_id@p ;
...
position p;
@@
 struct can_bittiming * cocci_id@p ;
...
position p;
@@
 struct pcan_ufd_led * cocci_id@p ;
...
position p;
@@
 struct pucan_options * cocci_id@p ;
...
typedef u16;
@@
 struct __packed pcan_ufd_options {  __le16 opcode_channel ;  __le16 ucan_mask ;  u16 unused ;  __le16 usb_mask ; } cocci_id@p ;
...
position p;
@@
 struct pucan_error_msg * cocci_id@p ;
...
position p;
@@
 const struct can_bittiming_const cocci_id@p ;
...
position p;
@@
 struct pcan_ufd_ts_msg * cocci_id@p ;
...
position p;
@@
 struct pcan_ufd_ovr_msg * cocci_id@p ;
...
typedef u8;
@@
 struct pcan_usb_fd_device {  struct peak_usb_device dev ;  struct can_berr_counter bec ;  struct pcan_usb_fd_if * usb_if ;  u8 * cmd_buffer_addr ; } cocci_id@p ;
...
position p;
@@
 struct pucan_timing_fast * cocci_id@p ;
...
typedef u8;
@@
 struct __packed pcan_ufd_led {  __le16 opcode_channel ;  u8 mode ;  u8 unused [ 5 ] ; } cocci_id@p ;
...
position p;
@@
 struct pucan_timing_slow * cocci_id@p ;
...
typedef u8;
@@
 struct __packed pcan_ufd_clock {  __le16 opcode_channel ;  u8 mode ;  u8 unused [ 5 ] ; } cocci_id@p ;
...
typedef __le32,u16;
@@
 struct __packed pcan_ufd_ts_msg {  __le16 size ;  __le16 type ;  __le32 ts_low ;  __le32 ts_high ;  __le16 usb_frame_index ;  u16 unused ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct __packed pcan_ufd_fw_info {  __le16 size_of ;  __le16 type ;  u8 hw_type ;  u8 bl_version [ 3 ] ;  u8 hw_version ;  u8 fw_version [ 3 ] ;  __le32 dev_id [ 2 ] ;  __le32 ser_no ;  __le32 flags ; } cocci_id@p ;
...
position p;
@@
 struct pucan_command cocci_id@p ;
...
position p;
@@
 struct peak_usb_device * cocci_id@p ;
...
position p;
@@
 struct pucan_filter_std * cocci_id@p ;
