...
position p;
@@
 struct edmacc_param cocci_id@p ;
...
typedef u16;
@@
 struct edma_tc {  struct device_node * node ;  u16 id ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct edma_desc {  struct virt_dma_desc vdesc ;  struct list_head node ;  enum dma_transfer_direction direction ;  int cyclic ;  bool polled ;  int absync ;  int pset_nr ;  struct edma_chan * echan ;  int processed ;  int processed_stat ;  u32 sg_len ;  u32 residue ;  u32 residue_stat ;  struct edma_pset pset [ 0 ] ; } cocci_id@p ;
...
@@
 struct edma_pset {  u32 len ;  dma_addr_t addr ;  struct edmacc_param param ; } cocci_id@p ;
...
position p;
@@
 const struct edmacc_param * cocci_id@p ;
...
typedef bool;
@@
 struct edma_chan {  struct virt_dma_chan vchan ;  struct list_head node ;  struct edma_desc * edesc ;  struct edma_cc * ecc ;  struct edma_tc * tc ;  int ch_num ;  bool alloced ;  bool hw_triggered ;  int slot [ EDMA_MAX_SLOTS ] ;  int missed ;  struct dma_slave_config cfg ; } cocci_id@p ;
...
position p;
@@
 struct edma_soc_info * cocci_id@p ;
...
typedef bool;
@@
 struct edma_cc {  struct device * dev ;  struct edma_soc_info * info ;  void __iomem * base ;  int id ;  bool legacy_mode ;  unsigned num_channels ;  unsigned num_qchannels ;  unsigned num_region ;  unsigned num_slots ;  unsigned num_tc ;  bool chmap_exist ;  enum dma_event_q default_queue ;  unsigned int ccint ;  unsigned int ccerrint ;  unsigned long * slot_inuse ;  unsigned long * channels_mask ;  struct dma_device dma_slave ;  struct dma_device * dma_memcpy ;  struct edma_chan * slave_chans ;  struct edma_tc * tc_list ;  int dummy_slot ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct dma_chan * chan , 
						       void * param ) ;
