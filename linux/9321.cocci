...
position p;
@@
 struct wl1251_acx_arp_filter * cocci_id@p ;
...
position p;
@@
 struct wl1251_acx_config_memory * cocci_id@p ;
...
position p;
@@
 struct acx_packet_detection * cocci_id@p ;
...
position p;
@@
 enum wl1251_acx_channel_type cocci_id@p ;
...
position p;
@@
 enum wl1251_acx_ack_policy cocci_id@p ;
...
position p;
@@
 struct acx_data_path_params_resp * cocci_id@p ;
...
position p;
@@
 struct wl1251_acx_bet_enable * cocci_id@p ;
...
position p;
@@
 struct wl1251_acx_wr_tbtt_and_dtim * cocci_id@p ;
...
position p;
@@
 struct acx_low_rssi * cocci_id@p ;
...
position p;
@@
 struct wl1251_acx_ac_cfg * cocci_id@p ;
...
position p;
@@
 struct acx_rx_config * cocci_id@p ;
...
position p;
@@
 struct acx_dot11_station_id * cocci_id@p ;
...
position p;
@@
 enum wl1251_acx_bet_mode cocci_id@p ;
...
position p;
@@
 struct acx_statistics * cocci_id@p ;
...
position p;
@@
 struct acx_fw_gen_frame_rates * cocci_id@p ;
...
position p;
@@
 struct acx_tsf_info * cocci_id@p ;
...
position p;
@@
 struct acx_dot11_default_key * cocci_id@p ;
...
position p;
@@
 struct wl1251_acx_tid_cfg * cocci_id@p ;
...
position p;
@@
 struct acx_revision * cocci_id@p ;
...
position p;
@@
 enum wl1251_acx_ps_scheme cocci_id@p ;
...
position p;
@@
 struct acx_data_path_params * cocci_id@p ;
...
position p;
@@
 enum wl1251_acx_low_rssi_type cocci_id@p ;
