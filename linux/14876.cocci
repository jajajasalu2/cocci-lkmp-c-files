...
position p;
@@
 const struct dfll_fcpu_data cocci_id@p ;
...
position p;
@@
 struct rail_alignment * cocci_id@p ;
...
position p;
@@
 const struct cvb_table cocci_id@p [ ] ;
...
position p;
@@
 struct dfll_fcpu_data {  const unsigned long * cpu_max_freq_table ;  unsigned int cpu_max_freq_table_size ;  const struct cvb_table * cpu_cvb_tables ;  unsigned int cpu_cvb_tables_size ; } cocci_id@p ;
