...
position p;
@@
 struct fimc_pinctrl * cocci_id@p ;
...
position p;
@@
 struct fimc_sensor_info * cocci_id@p ;
...
position p;
@@
 enum fimc_subdev_index cocci_id@p ;
...
position p;
@@
 const struct exynos_media_pipeline_ops cocci_id@p ;
...
position p;
@@
 struct cam_clk_provider * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ 2 ] [ IDX_MAX - 1 ] ;
...
position p;
@@
 struct exynos_media_pipeline * cocci_id@p ;
