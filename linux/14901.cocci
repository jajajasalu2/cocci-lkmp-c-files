...
typedef bool;
@@
 struct wm831x_clk {  struct wm831x * wm831x ;  struct clk_hw xtal_hw ;  struct clk_hw fll_hw ;  struct clk_hw clkout_hw ;  bool xtal_ena ; } cocci_id@p ;
