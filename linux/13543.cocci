...
position p;
@@
 unsigned char cocci_id@p [ USBVISION_STRIP_LEN_MAX ] ;
...
position p;
@@
 int cocci_id@p ( struct usb_usbvision * usbvision ) ;
...
position p;
@@
 struct usbvision_frame_header * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ USBVISION_STRIP_HEADER_LEN ] ;
...
position p;
@@
 volatile struct usbvision_frame * cocci_id@p ;
