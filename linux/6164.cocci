...
position p;
@@
 struct tps6586x_platform_data * cocci_id@p ;
...
position p;
@@
 struct tps6586x_subdev_info * cocci_id@p ;
...
position p;
@@
 const struct tps6586x_irq_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct tps6586x {  struct device * dev ;  struct i2c_client * client ;  struct regmap * regmap ;  int version ;  int irq ;  struct irq_chip irq_chip ;  struct mutex irq_lock ;  int irq_base ;  u32 irq_en ;  u8 mask_reg [ 5 ] ;  struct irq_domain * irq_domain ; } cocci_id@p ;
...
typedef u8;
@@
 struct tps6586x_irq_data {  u8 mask_reg ;  u8 mask_mask ; } cocci_id@p ;
