...
position p;
@@
 enum { qs_state_mmio , qs_state_pkt , } cocci_id@p ;
...
position p;
@@
 struct qs_port_priv * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,qs_state_t,dma_addr_t;
@@
 struct qs_port_priv {  u8 * pkt ;  dma_addr_t pkt_dma ;  qs_state_t state ; } cocci_id@p ;
...
position p;
@@
 enum { QS_DMA_BOUNDARY = ~ 0UL , } cocci_id@p ;
