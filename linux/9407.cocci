...
position p;
@@
 struct mt7603_rate_set * cocci_id@p ;
...
position p;
@@
 enum mt7603_cipher_type cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct mt7603_dev * dev ) ;
...
position p;
@@
 enum mt7603_reset_cause cocci_id@p ;
