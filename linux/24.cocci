...
position p;
@@
 const struct reserve_info * cocci_id@p ;
...
position p;
@@
 const struct node * const * cocci_id@p ;
...
position p;
@@
 const struct reserve_info * const * cocci_id@p ;
...
position p;
@@
 const struct property * const * cocci_id@p ;
...
position p;
@@
 struct reserve_info * cocci_id@p ;
