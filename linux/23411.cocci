...
typedef u32;
@@
 struct wm8900_priv {  struct regmap * regmap ;  u32 fll_in ;  u32 fll_out ; } cocci_id@p ;
...
typedef u16;
@@
 struct _fll_div {  u16 fll_ratio ;  u16 fllclk_div ;  u16 fll_slow_lock_ref ;  u16 n ;  u16 k ; } cocci_id@p ;
