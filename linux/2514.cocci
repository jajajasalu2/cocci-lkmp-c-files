...
typedef bool;
@@
 struct dm_block_manager {  struct dm_bufio_client * bufio ;  bool read_only : 1 ; } cocci_id@p ;
...
position p;
@@
 struct stack_store {  unsigned int nr_entries ;  unsigned long entries [ MAX_STACK ] ; } cocci_id@p ;
...
position p;
@@
 struct waiter {  struct list_head list ;  struct task_struct * task ;  int wants_write ; } cocci_id@p ;
