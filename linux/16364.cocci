...
typedef u32;
@@
 struct hid_sensor_hub_callbacks_list {  struct list_head list ;  u32 usage_id ;  struct hid_sensor_hub_device * hsdev ;  struct hid_sensor_hub_callbacks * usage_callback ;  void * priv ; } cocci_id@p ;
...
position p;
@@
 enum sensor_hub_read_flags cocci_id@p ;
...
position p;
@@
 struct hid_sensor_hub_device * cocci_id@p ;
...
position p;
@@
 struct hid_sensor_hub_callbacks * cocci_id@p ;
...
position p;
@@
 struct sensor_hub_data * cocci_id@p ;
...
position p;
@@
 struct hid_collection * cocci_id@p ;
...
position p;
@@
 struct hid_sensor_hub_callbacks_list * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sensor_hub_data {  struct mutex mutex ;  spinlock_t lock ;  struct list_head dyn_callback_list ;  spinlock_t dyn_callback_lock ;  struct mfd_cell * hid_sensor_hub_client_devs ;  int hid_sensor_client_cnt ;  unsigned long quirks ;  int ref_cnt ; } cocci_id@p ;
...
position p;
@@
 struct hid_sensor_hub_attribute_info * cocci_id@p ;
