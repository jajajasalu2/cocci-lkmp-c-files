...
position p;
@@
 struct meson_pmx_group * cocci_id@p ;
...
position p;
@@
 struct meson_pinctrl_data * cocci_id@p ;
...
position p;
@@
 struct meson_pinctrl * cocci_id@p ;
...
position p;
@@
 struct meson_reg_desc * cocci_id@p ;
...
position p;
@@
 enum meson_reg_type cocci_id@p ;
