...
typedef u8,u32;
@@
 struct k8temp_data {  struct mutex update_lock ;  u8 sensorsp ;  u8 swap_core_select ;  u32 temp_offset ; } cocci_id@p ;
...
position p;
@@
 const struct k8temp_data * cocci_id@p ;
