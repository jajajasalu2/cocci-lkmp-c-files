...
position p;
@@
 enum pci_dio_boardid { TYPE_PCI1730 , TYPE_PCI1733 , TYPE_PCI1734 , TYPE_PCI1735 , TYPE_PCI1736 , TYPE_PCI1739 , TYPE_PCI1750 , TYPE_PCI1751 , TYPE_PCI1752 , TYPE_PCI1753 , TYPE_PCI1753E , TYPE_PCI1754 , TYPE_PCI1756 , TYPE_PCI1761 , TYPE_PCI1762 , } cocci_id@p ;
...
position p;
@@
 const struct dio_boardtype cocci_id@p [ ] ;
...
position p;
@@
 struct dio_boardtype {  const char * name ;  int nsubdevs ;  struct diosubd_data sdi [ PCI_DIO_MAX_DI_SUBDEVS ] ;  struct diosubd_data sdo [ PCI_DIO_MAX_DO_SUBDEVS ] ;  struct diosubd_data sdio [ PCI_DIO_MAX_DIO_SUBDEVG ] ;  unsigned long id_reg ;  unsigned long timer_regbase ;  unsigned int is_16bit : 1 ; } cocci_id@p ;
...
position p;
@@
 struct diosubd_data {  int chans ;  unsigned long addr ; } cocci_id@p ;
...
position p;
@@
 const struct diosubd_data * cocci_id@p ;
