...
position p;
@@
 struct ethtool_rx_flow_match cocci_id@p ;
...
position p;
@@
 struct ethtool_rx_flow_match {  struct flow_dissector dissector ;  struct ethtool_rx_flow_key key ;  struct ethtool_rx_flow_key mask ; } cocci_id@p ;
...
position p;
@@
 struct ethtool_sfeatures cocci_id@p ;
...
position p;
@@
 const struct ethtool_tcpip6_spec * cocci_id@p ;
...
position p;
@@
 const struct ethtool_rx_flow_spec * cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct net_device * , u32 ) ;
...
position p;
@@
 int noinline_for_stack cocci_id@p ;
...
position p;
@@
 struct ethtool_gstrings cocci_id@p ;
...
position p;
@@
 const struct ethtool_rx_flow_spec_input * cocci_id@p ;
...
position p;
@@
 struct ethtool_perm_addr cocci_id@p ;
...
position p;
@@
 struct ethtool_sset_info cocci_id@p ;
...
position p;
@@
 const struct ethtool_cmd * cocci_id@p ;
...
position p;
@@
 struct ethtool_value cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ __ETHTOOL_PHY_TUNABLE_COUNT ] [ ETH_GSTRING_LEN ] ;
...
typedef u8;
@@
 int ( * cocci_id@p ) ( struct net_device * , struct ethtool_eeprom * , u8 * ) ;
...
position p;
@@
 struct ethtool_link_usettings cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct net_device * , u32 ) ;
...
position p;
@@
 struct ethtool_rx_flow_key cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ NETDEV_FEATURE_COUNT ] [ ETH_GSTRING_LEN ] ;
...
position p;
@@
 struct ethtool_set_features_block cocci_id@p [ ETHTOOL_DEV_FEATURE_WORDS ] ;
...
position p;
@@
 struct ethtool_get_features_block cocci_id@p [ ETHTOOL_DEV_FEATURE_WORDS ] ;
...
position p;
@@
 const struct ethtool_tcpip4_spec * cocci_id@p ;
...
position p;
@@
 struct ethtool_rxfh_indir cocci_id@p ;
...
typedef u32;
@@
 u32 ( * cocci_id@p ) ( struct net_device * ) ;
...
position p;
@@
 struct ethtool_gfeatures cocci_id@p ;
...
position p;
@@
 struct ethtool_per_queue_op cocci_id@p ;
...
position p;
@@
 struct ethtool_tunable cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ ETH_RSS_HASH_FUNCS_COUNT ] [ ETH_GSTRING_LEN ] ;
...
position p;
@@
 struct ethtool_fecparam cocci_id@p ;
...
position p;
@@
 const struct ethtool_flow_ext * cocci_id@p ;
...
position p;
@@
 struct ethtool_rx_flow_rule cocci_id@p ;
...
position p;
@@
 struct ethtool_rxfh cocci_id@p ;
...
typedef __u32;
@@
 struct ethtool_link_usettings {  struct ethtool_link_settings base ;  struct {  __u32 supported [ __ETHTOOL_LINK_MODE_MASK_NU32 ] ;  __u32 advertising [ __ETHTOOL_LINK_MODE_MASK_NU32 ] ;  __u32 lp_advertising [ __ETHTOOL_LINK_MODE_MASK_NU32 ] ; } link_modes ; } cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ __ETHTOOL_TUNABLE_COUNT ] [ ETH_GSTRING_LEN ] ;
