...
position p;
@@
 struct input_dev_poller cocci_id@p ;
...
position p;
@@
 struct input_dev_poller {  void ( * poll ) ( struct input_dev * dev ) ;  unsigned int poll_interval ;  unsigned int poll_interval_max ;  unsigned int poll_interval_min ;  struct input_dev * input ;  struct delayed_work work ; } cocci_id@p ;
