...
position p;
@@
 struct f2fs_flush_device cocci_id@p ;
...
position p;
@@
 struct f2fs_defragment * cocci_id@p ;
...
typedef u32;
@@
 const struct {  u32 iflag ;  u32 fsflag ; } cocci_id@p [ ] ;
...
position p;
@@
 struct f2fs_gc_range cocci_id@p ;
...
position p;
@@
 enum cp_reason_type cocci_id@p ;
...
position p;
@@
 struct f2fs_move_range cocci_id@p ;
...
typedef u32;
@@
 const struct {  u32 iflag ;  u32 xflag ; } cocci_id@p [ ] ;
