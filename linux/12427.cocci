...
position p;
@@
 struct refill_engine * cocci_id@p ;
...
position p;
@@
 struct tcm * cocci_id@p [ TILFMT_NFORMATS ] ;
...
position p;
@@
 const struct dmm_platform_data cocci_id@p ;
...
typedef u32;
@@
 const struct {  u32 x_shft ;  u32 y_shft ;  u32 cpp ;  u32 slot_w ;  u32 slot_h ; } cocci_id@p [ TILFMT_NFORMATS ] ;
