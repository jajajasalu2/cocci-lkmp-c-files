...
position p;
@@
 struct dpmng_rsp_get_version * cocci_id@p ;
...
position p;
@@
 struct dprc_endpoint cocci_id@p ;
...
position p;
@@
 struct dprc_attributes cocci_id@p ;
...
position p;
@@
 struct fsl_mc_addr_translation_range cocci_id@p ;
...
@@
 struct fsl_mc_addr_translation_range {  enum dprc_region_type mc_region_type ;  u64 start_mc_offset ;  u64 end_mc_offset ;  phys_addr_t start_phys_addr ; } cocci_id@p ;
...
position p;
@@
 struct fsl_mc_obj_desc cocci_id@p ;
...
position p;
@@
 struct dprc_region_desc cocci_id@p ;
...
typedef u8;
@@
 struct fsl_mc {  struct fsl_mc_device * root_mc_bus_dev ;  u8 num_translation_ranges ;  struct fsl_mc_addr_translation_range * translation_ranges ; } cocci_id@p ;
...
position p;
@@
 enum dprc_region_type cocci_id@p ;
...
typedef u32;
@@
 struct mc_version {  u32 major ;  u32 minor ;  u32 revision ; } cocci_id@p ;
...
position p;
@@
 const struct {  struct device_type * dev_type ;  const char * type ; } cocci_id@p [ ] ;
