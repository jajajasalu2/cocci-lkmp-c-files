...
position p;
@@
 const struct cxgbit_np * cocci_id@p ;
...
position p;
@@
 struct cxgbit_device * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cxgbit_sock * csk ) ;
...
position p;
@@
 const struct cxgbit_sock * cocci_id@p ;
...
position p;
@@
 cxgbit_cplhandler_func cocci_id@p [ NUM_CPL_CMDS ] ;
...
position p;
@@
 struct cxgbit_wr_wait * cocci_id@p ;
