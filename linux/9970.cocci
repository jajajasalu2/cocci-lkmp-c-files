...
position p;
@@
 const struct wsm_beacon_transmit * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct wsm_buf * buf ) ;
...
position p;
@@
 struct wsm_join_cnf * cocci_id@p ;
...
position p;
@@
 const struct wsm_set_bss_params * cocci_id@p ;
...
position p;
@@
 struct wsm_edca_queue_params * cocci_id@p ;
...
position p;
@@
 struct wsm_scan_complete cocci_id@p ;
...
position p;
@@
 const struct wsm_add_key * cocci_id@p ;
...
position p;
@@
 const struct wsm_remove_key * cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct cw1200_common * priv , struct wsm_buf * buf , void * arg , u16 cmd , long tmo ) ;
...
position p;
@@
 const struct wsm_start * cocci_id@p ;
...
position p;
@@
 const struct wsm_scan * cocci_id@p ;
...
position p;
@@
 const struct wsm_update_ie * cocci_id@p ;
...
position p;
@@
 const struct wsm_switch_channel * cocci_id@p ;
...
position p;
@@
 const struct wsm_map_link * cocci_id@p ;
...
typedef u16;
@@
 struct wsm_mib {  u16 mib_id ;  void * buf ;  size_t buf_size ; } cocci_id@p ;
...
position p;
@@
 const struct wsm_reset * cocci_id@p ;
...
position p;
@@
 const struct wsm_set_tx_queue_params * cocci_id@p ;
