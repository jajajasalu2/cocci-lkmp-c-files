...
position p;
@@
 struct sdhci_s3c_drv_data * cocci_id@p ;
...
typedef bool;
@@
 struct sdhci_s3c {  struct sdhci_host * host ;  struct platform_device * pdev ;  struct resource * ioarea ;  struct s3c_sdhci_platdata * pdata ;  int cur_clk ;  int ext_cd_irq ;  int ext_cd_gpio ;  struct clk * clk_io ;  struct clk * clk_bus [ MAX_BUS_CLK ] ;  unsigned long clk_rates [ MAX_BUS_CLK ] ;  bool no_divider ; } cocci_id@p ;
...
typedef bool;
@@
 struct sdhci_s3c_drv_data {  unsigned int sdhci_quirks ;  bool no_divider ; } cocci_id@p ;
