...
position p;
@@
 struct ovl_inode_params cocci_id@p ;
...
typedef bool;
@@
 struct ovl_lookup_data {  struct super_block * sb ;  struct qstr name ;  bool is_dir ;  bool opaque ;  bool stop ;  bool last ;  char * redirect ;  bool metacopy ; } cocci_id@p ;
...
position p;
@@
 struct ovl_lookup_data * cocci_id@p ;
