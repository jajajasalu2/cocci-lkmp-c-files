...
position p;
@@
 const struct regmap_bus cocci_id@p ;
...
typedef u8;
@@
 struct mrf24j40 {  struct spi_device * spi ;  struct ieee802154_hw * hw ;  struct regmap * regmap_short ;  struct regmap * regmap_long ;  struct spi_message tx_msg ;  u8 tx_hdr_buf [ 2 ] ;  struct spi_transfer tx_hdr_trx ;  u8 tx_len_buf [ 2 ] ;  struct spi_transfer tx_len_trx ;  struct spi_transfer tx_buf_trx ;  struct sk_buff * tx_skb ;  struct spi_message tx_post_msg ;  u8 tx_post_buf [ 2 ] ;  struct spi_transfer tx_post_trx ;  struct spi_message rx_msg ;  u8 rx_buf [ 3 ] ;  struct spi_transfer rx_trx ;  struct spi_message rx_buf_msg ;  u8 rx_addr_buf [ 2 ] ;  struct spi_transfer rx_addr_trx ;  u8 rx_lqi_buf [ 2 ] ;  struct spi_transfer rx_lqi_trx ;  u8 rx_fifo_buf [ RX_FIFO_SIZE ] ;  struct spi_transfer rx_fifo_buf_trx ;  struct spi_message irq_msg ;  u8 irq_buf [ 2 ] ;  struct spi_transfer irq_trx ; } cocci_id@p ;
...
position p;
@@
 enum mrf24j40_modules { MRF24J40 , MRF24J40MA , MRF24J40MC , } cocci_id@p ;
