...
position p;
@@
 struct winbond_gpio_params cocci_id@p ;
...
position p;
@@
 const struct winbond_gpio_port_conflict * cocci_id@p ;
...
position p;
@@
 const struct winbond_gpio_info * * cocci_id@p ;
...
typedef u8;
@@
 struct winbond_gpio_info {  u8 dev ;  u8 enablereg ;  u8 enablebit ;  u8 outputreg ;  u8 outputppbit ;  u8 ioreg ;  u8 invreg ;  u8 datareg ;  struct winbond_gpio_port_conflict conflict ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct winbond_gpio_port_conflict {  const char * name ;  u8 dev ;  u8 testreg ;  u8 testbit ;  bool warnonly ; } cocci_id@p ;
...
typedef bool;
@@
 struct winbond_gpio_params {  unsigned long base ;  unsigned long gpios ;  unsigned long ppgpios ;  unsigned long odgpios ;  bool pledgpio ;  bool beepgpio ;  bool i2cgpio ; } cocci_id@p ;
...
position p;
@@
 const struct winbond_gpio_info cocci_id@p [ 6 ] ;
