...
typedef bool;
@@
 int ( * cocci_id@p ) ( bool * negp , unsigned long * lvalp , int * valp , int write , void * data ) ;
...
position p;
@@
 struct do_proc_dointvec_minmax_conv_param {  int * min ;  int * max ; } cocci_id@p ;
...
position p;
@@
 struct do_proc_dointvec_minmax_conv_param cocci_id@p ;
...
position p;
@@
 struct do_proc_douintvec_minmax_conv_param {  unsigned int * min ;  unsigned int * max ; } cocci_id@p ;
...
position p;
@@
 struct do_proc_douintvec_minmax_conv_param cocci_id@p ;
...
position p;
@@
 enum sysctl_writes_mode cocci_id@p ;
...
position p;
@@
 enum sysctl_writes_mode { SYSCTL_WRITES_LEGACY = - 1 , SYSCTL_WRITES_WARN = 0 , SYSCTL_WRITES_STRICT = 1 , } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long * lvalp , unsigned int * valp , int write , void * data ) ;
