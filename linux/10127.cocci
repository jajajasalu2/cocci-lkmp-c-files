...
position p;
@@
 struct UPT1_TxStats * cocci_id@p ;
...
position p;
@@
 struct vmxnet3_tq_driver_stats cocci_id@p ;
...
position p;
@@
 struct vmxnet3_rq_driver_stats * cocci_id@p ;
...
position p;
@@
 struct UPT1_RxStats * cocci_id@p ;
...
position p;
@@
 const struct vmxnet3_stat_desc cocci_id@p [ ] ;
...
position p;
@@
 struct vmxnet3_stat_desc {  char desc [ ETH_GSTRING_LEN ] ;  int offset ; } cocci_id@p ;
