...
position p;
@@
 unsigned long cocci_id@p [ PM_LASTUNIT + 1 ] [ 2 ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ ] [ MAX_ALT ] ;
...
position p;
@@
 int cocci_id@p [ C ( MAX ) ] [ C ( OP_MAX ) ] [ C ( RESULT_MAX ) ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ 4 ] [ 4 ] ;
