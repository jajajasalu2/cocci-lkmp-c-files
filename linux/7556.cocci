...
position p;
@@
 void cocci_id@p ( struct fb_info * fb_info ) ;
...
position p;
@@
 struct fb_cmap_user cocci_id@p ;
...
position p;
@@
 struct logo_data_extra {  const struct linux_logo * logo ;  unsigned int n ; } cocci_id@p [ FB_LOGO_EX_NUM_MAX ] ;
...
position p;
@@
 const struct linux_logo * cocci_id@p ;
...
@@
 struct fb_cmap32 {  u32 start ;  u32 len ;  compat_caddr_t red ;  compat_caddr_t green ;  compat_caddr_t blue ;  compat_caddr_t transp ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,u16,compat_caddr_t;
@@
 struct fb_fix_screeninfo32 {  char id [ 16 ] ;  compat_caddr_t smem_start ;  u32 smem_len ;  u32 type ;  u32 type_aux ;  u32 visual ;  u16 xpanstep ;  u16 ypanstep ;  u16 ywrapstep ;  u32 line_length ;  compat_caddr_t mmio_start ;  u32 mmio_len ;  u32 accel ;  u16 reserved [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct fb_info * const cocci_id@p ;
...
position p;
@@
 struct apertures_struct * cocci_id@p ;
...
position p;
@@
 struct logo_data {  int depth ;  int needs_directpalette ;  int needs_truepalette ;  int needs_cmapreset ;  const struct linux_logo * logo ; } cocci_id@p ;
