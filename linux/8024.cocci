...
position p;
@@
 struct mdio_mux_child_bus {  struct mii_bus * mii_bus ;  struct mdio_mux_parent_bus * parent ;  struct mdio_mux_child_bus * next ;  int bus_number ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( int cur , int desired , void * data ) ;
...
position p;
@@
 struct mdio_mux_parent_bus * cocci_id@p ;
...
position p;
@@
 struct mdio_mux_child_bus cocci_id@p ;
...
position p;
@@
 struct mdio_mux_parent_bus {  struct mii_bus * mii_bus ;  int current_child ;  int parent_id ;  void * switch_data ;  int ( * switch_fn ) ( int current_child , int desired_child , void * data ) ;  struct mdio_mux_child_bus * children ; } cocci_id@p ;
