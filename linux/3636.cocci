...
position p;
@@
 struct esre_entry {  union {  struct efi_system_resource_entry_v1 * esre1 ; } esre ;  struct kobject kobj ;  struct list_head list ; } cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct efi_system_resource_table {  u32 fw_resource_count ;  u32 fw_resource_count_max ;  u64 fw_resource_version ;  u8 entries [ ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,efi_guid_t;
@@
 struct efi_system_resource_entry_v1 {  efi_guid_t fw_class ;  u32 fw_type ;  u32 fw_version ;  u32 lowest_supported_fw_version ;  u32 capsule_flags ;  u32 last_attempt_version ;  u32 last_attempt_status ; } cocci_id@p ;
...
position p;
@@
 struct esre_attribute * cocci_id@p ;
...
position p;
@@
 struct efi_system_resource_table cocci_id@p ;
...
position p;
@@
 struct efi_system_resource_entry_v1 * cocci_id@p ;
