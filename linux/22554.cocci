...
position p;
@@
 void cocci_id@p ( struct snd_emu10k1 * emu ) ;
...
position p;
@@
 const char * const cocci_id@p [ 5 ] [ 2 ] ;
...
position p;
@@
 const struct snd_emu_chip_details * cocci_id@p ;
...
position p;
@@
 struct snd_emu_chip_details cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct snd_emu10k1 * emu ) ;
...
position p;
@@
 struct snd_util_memblk cocci_id@p ;
