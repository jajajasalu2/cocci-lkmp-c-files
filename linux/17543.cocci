...
position p;
@@
 struct hv_24x7_request * cocci_id@p ;
...
position p;
@@
 struct hv_24x7_result * cocci_id@p ;
...
position p;
@@
 struct hv_24x7_request_buffer cocci_id@p ;
...
position p;
@@
 struct hv_perf_caps cocci_id@p ;
...
position p;
@@
 struct event_uniq {  struct rb_node node ;  const char * name ;  int nl ;  unsigned ct ;  unsigned domain ; } cocci_id@p ;
...
position p;
@@
 struct hv_24x7_data_result_buffer * cocci_id@p ;
...
position p;
@@
 struct hv_24x7_result_element_v2 cocci_id@p ;
...
position p;
@@
 struct hv_24x7_event_data * cocci_id@p ;
...
position p;
@@
 struct hv_24x7_hw {  struct perf_event * events [ 255 ] ; } cocci_id@p ;
...
position p;
@@
 struct hv_24x7_result_element_v1 cocci_id@p ;
...
position p;
@@
 struct hv_24x7_catalog_page_0 * cocci_id@p ;
