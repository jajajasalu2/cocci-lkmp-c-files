...
typedef u8,u32;
@@
 struct rcar_can_mbox_regs {  u32 id ;  u8 stub ;  u8 dlc ;  u8 data [ 8 ] ;  u8 tsh ;  u8 tsl ; } cocci_id@p ;
...
position p;
@@
 struct rcar_can_priv cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct rcar_can_regs {  struct rcar_can_mbox_regs mb [ RCAR_CAN_N_MBX ] ;  u32 mkr_2_9 [ 8 ] ;  u32 fidcr [ 2 ] ;  u32 mkivlr1 ;  u32 mier1 ;  u32 mkr_0_1 [ 2 ] ;  u32 mkivlr0 ;  u32 mier0 ;  u8 pad_440 [ 0x3c0 ] ;  u8 mctl [ 64 ] ;  u16 ctlr ;  u16 str ;  u8 bcr [ 3 ] ;  u8 clkr ;  u8 rfcr ;  u8 rfpcr ;  u8 tfcr ;  u8 tfpcr ;  u8 eier ;  u8 eifr ;  u8 recr ;  u8 tecr ;  u8 ecsr ;  u8 cssr ;  u8 mssr ;  u8 msmr ;  u16 tsr ;  u8 afsr ;  u8 pad_857 ;  u8 tcr ;  u8 pad_859 [ 7 ] ;  u8 ier ;  u8 isr ;  u8 pad_862 ;  u8 mbsmr ; } cocci_id@p ;
...
position p;
@@
 enum CLKR { CLKR_CLKP1 = 0 , CLKR_CLKP2 = 1 , CLKR_CLKEXT = 3 , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct rcar_can_priv {  struct can_priv can ;  struct net_device * ndev ;  struct napi_struct napi ;  struct rcar_can_regs __iomem * regs ;  struct clk * clk ;  struct clk * can_clk ;  u8 tx_dlc [ RCAR_CAN_FIFO_DEPTH ] ;  u32 tx_head ;  u32 tx_tail ;  u8 clock_select ;  u8 ier ; } cocci_id@p ;
