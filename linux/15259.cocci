...
position p;
@@
 struct an30259a_led cocci_id@p ;
...
typedef bool,u32;
@@
 struct an30259a_led {  struct an30259a * chip ;  struct fwnode_handle * fwnode ;  struct led_classdev cdev ;  u32 num ;  u32 default_state ;  bool sloping ; } cocci_id@p ;
...
position p;
@@
 struct an30259a {  struct mutex mutex ;  struct i2c_client * client ;  struct an30259a_led leds [ AN30259A_MAX_LEDS ] ;  struct regmap * regmap ;  int num_leds ; } cocci_id@p ;
