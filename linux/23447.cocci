...
position p;
@@
 void cocci_id@p ( struct snd_pcm_substream * substream , struct snd_soc_dai * dai ) ;
...
position p;
@@
 struct hda_pcm * cocci_id@p ( struct hdac_hda_priv * hda_pvt , struct snd_soc_dai * dai ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_pcm_substream * substream , struct snd_pcm_hw_params * params , struct snd_soc_dai * dai ) ;
...
position p;
@@
 struct hdac_hda_pcm * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_pcm_substream * substream , struct snd_soc_dai * dai ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_soc_dai * dai , unsigned int tx_mask , unsigned int rx_mask , int slots , int slot_width ) ;
...
position p;
@@
 struct hdac_hda_priv * cocci_id@p ;
...
position p;
@@
 struct hdac_ext_bus_ops cocci_id@p ;
...
symbol cocci_id;
position p;
typedef hda_codec_patch_t;
@@
 hda_codec_patch_t cocci_id@p ;
