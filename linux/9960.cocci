...
position p;
@@
 struct cw1200_wsm_event * cocci_id@p ;
...
position p;
@@
 struct wsm_override_internal_txrate cocci_id@p ;
...
position p;
@@
 struct wsm_beacon_filter_control cocci_id@p ;
...
position p;
@@
 struct wsm_remove_key cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cw1200_common * priv ) ;
...
position p;
@@
 struct wsm_join_complete * cocci_id@p ;
...
position p;
@@
 const struct wsm_edca_params * cocci_id@p ;
...
position p;
@@
 struct wsm_template_frame cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ieee80211_hw * dev , struct ieee80211_vif * vif , enum sta_notify_cmd notify_cmd , int link_id ) ;
...
position p;
@@
 struct wsm_switch_channel cocci_id@p ;
...
position p;
@@
 struct wsm_operational_mode cocci_id@p ;
...
position p;
@@
 struct cw1200_sta_priv * cocci_id@p ;
...
position p;
@@
 struct wsm_configuration cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct cw1200_common * priv , bool enable ) ;
...
position p;
@@
 struct cw1200_common cocci_id@p ;
...
position p;
@@
 struct wsm_rcpi_rssi_threshold cocci_id@p ;
...
position p;
@@
 struct cw1200_queue * cocci_id@p ;
...
position p;
@@
 struct wsm_suspend_resume * cocci_id@p ;
...
position p;
@@
 const struct wsm_set_pm * cocci_id@p ;
...
position p;
@@
 struct wsm_protected_mgmt_policy cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cw1200_common * priv ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct cw1200_common * priv , bool drop ) ;
...
position p;
@@
 struct wsm_mib_beacon_filter_table cocci_id@p ;
...
position p;
@@
 struct wsm_beacon_transmit cocci_id@p ;
...
position p;
@@
 struct wsm_mib_arp_ipv4_filter cocci_id@p ;
...
position p;
@@
 struct wsm_update_ie cocci_id@p ;
...
position p;
@@
 struct cw1200_link_entry * cocci_id@p ;
