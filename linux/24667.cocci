...
position p;
@@
 struct hash_ipportip4_elem * cocci_id@p ;
...
position p;
@@
 struct hash_ipportip6_elem cocci_id@p ;
...
position p;
@@
 const struct hash_ipportip4_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_ipportip6 * cocci_id@p ;
...
typedef u8;
@@
 struct hash_ipportip6_elem {  union nf_inet_addr ip ;  union nf_inet_addr ip2 ;  __be16 port ;  u8 proto ;  u8 padding ; } cocci_id@p ;
...
position p;
@@
 const struct hash_ipportip4 * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct hash_ipportip4_elem {  __be32 ip ;  __be32 ip2 ;  __be16 port ;  u8 proto ;  u8 padding ; } cocci_id@p ;
...
position p;
@@
 const struct hash_ipportip6_elem * cocci_id@p ;
