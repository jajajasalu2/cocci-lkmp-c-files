...
position p;
@@
 struct irq_swizzle_struct {  char irq_to_mask [ 64 ] ;  char mask_to_irq [ 64 ] ;  unsigned long shadow_mask ;  void ( * update_irq_hw ) ( unsigned long bit , unsigned long mask ) ;  void ( * ack_irq_hw ) ( unsigned long bit ) ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef irq_swizzle_t;
@@
 irq_swizzle_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int nr_of_irqs ) ;
