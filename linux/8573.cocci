...
typedef u32;
@@
 int cocci_id@p ( struct bnx2 * , u32 , int , int ) ;
...
position p;
@@
 const struct flash_spec cocci_id@p ;
...
position p;
@@
 const struct bnx2_rv2p_fw_file_entry * cocci_id@p ;
...
position p;
@@
 struct {  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ BNX2_NUM_TESTS ] ;
...
position p;
@@
 const struct bnx2_rv2p_fw_file * cocci_id@p ;
...
position p;
@@
 const struct bnx2_mips_fw_file * cocci_id@p ;
...
position p;
@@
 struct msix_entry cocci_id@p [ BNX2_MAX_MSIX_VEC ] ;
...
position p;
@@
 struct bnx2_tx_ring_info * cocci_id@p ;
...
position p;
@@
 struct statistics_block cocci_id@p ;
...
position p;
@@
 const struct bnx2_mips_fw_file_entry * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bnx2 * bp ) ;
...
position p;
@@
 const struct bnx2_fw_file_section * cocci_id@p ;
...
position p;
@@
 const struct cpu_reg * cocci_id@p ;
...
position p;
@@
 const unsigned long cocci_id@p [ BNX2_NUM_STATS ] ;
...
position p;
@@
 struct bnx2_rx_ring_info * cocci_id@p ;
...
position p;
@@
 struct bnx2_sw_tx_bd * cocci_id@p ;
...
position p;
@@
 enum { BCM5706 = 0 , NC370T , NC370I , BCM5706S , NC370F , BCM5708 , BCM5708S , BCM5709 , BCM5709S , BCM5716 , BCM5716S , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ NUM_MC_HASH_REGISTERS ] ;
...
typedef u32;
@@
 const struct ftq_reg {  char * name ;  u32 off ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
