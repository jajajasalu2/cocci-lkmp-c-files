...
position p;
@@
 struct mspro_attribute * cocci_id@p ;
...
position p;
@@
 struct mspro_sys_attr {  size_t size ;  void * data ;  unsigned char id ;  char name [ 32 ] ;  struct device_attribute dev_attr ; } cocci_id@p ;
...
position p;
@@
 struct mspro_register cocci_id@p ;
...
position p;
@@
 struct mspro_sys_info * cocci_id@p ;
...
position p;
@@
 struct mspro_devinfo * cocci_id@p ;
...
position p;
@@
 struct mspro_sys_attr cocci_id@p ;
...
position p;
@@
 struct mspro_block_data * cocci_id@p ;
...
position p;
@@
 struct memstick_host * cocci_id@p ;
...
position p;
@@
 struct memstick_device_id cocci_id@p [ ] ;
...
position p;
@@
 ssize_t ( * cocci_id@p ) ( struct device * dev , struct device_attribute * attr , char * buffer ) ;
...
position p;
@@
 enum { MSPRO_BLOCK_ID_SYSINFO = 0x10 , MSPRO_BLOCK_ID_MODELNAME = 0x15 , MSPRO_BLOCK_ID_MBR = 0x20 , MSPRO_BLOCK_ID_PBR16 = 0x21 , MSPRO_BLOCK_ID_PBR32 = 0x22 , MSPRO_BLOCK_ID_SPECFILEVALUES1 = 0x25 , MSPRO_BLOCK_ID_SPECFILEVALUES2 = 0x26 , MSPRO_BLOCK_ID_DEVINFO = 0x30 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sysfs_show_t;
@@
 sysfs_show_t cocci_id@p ;
...
position p;
@@
 struct mspro_specfile * cocci_id@p ;
...
position p;
@@
 struct ms_status_register cocci_id@p ;
...
position p;
@@
 struct memstick_dev * cocci_id@p ;
...
position p;
@@
 struct memstick_driver cocci_id@p ;
...
position p;
@@
 struct memstick_request * * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct memstick_dev * card , int error ) ;
...
position p;
@@
 struct mspro_param_register cocci_id@p ;
