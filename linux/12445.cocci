...
position p;
@@
 struct panfrost_job cocci_id@p ;
...
position p;
@@
 struct panfrost_job_slot * cocci_id@p ;
...
typedef u64;
@@
 struct panfrost_queue_state {  struct drm_gpu_scheduler sched ;  u64 fence_context ;  u64 emit_seqno ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct panfrost_job_slot {  struct panfrost_queue_state queue [ NUM_JOB_SLOTS ] ;  spinlock_t job_lock ; } cocci_id@p ;
...
position p;
@@
 struct panfrost_file_priv * cocci_id@p ;
...
typedef u64;
@@
 struct panfrost_fence {  struct dma_fence base ;  struct drm_device * dev ;  u64 seqno ;  int queue ; } cocci_id@p ;
...
position p;
@@
 const struct drm_sched_backend_ops cocci_id@p ;
...
position p;
@@
 struct panfrost_device * cocci_id@p ;
...
position p;
@@
 struct panfrost_fence * cocci_id@p ;
...
position p;
@@
 struct drm_sched_job * cocci_id@p ;
