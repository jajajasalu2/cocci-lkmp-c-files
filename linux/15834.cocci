...
position p;
@@
 struct HT_info_element * cocci_id@p ;
...
position p;
@@
 enum HT_CAP_AMPDU_FACTOR cocci_id@p ;
...
position p;
@@
 struct surveydone_event cocci_id@p ;
...
position p;
@@
 struct C2HEvent_Header cocci_id@p ;
...
position p;
@@
 struct recv_reorder_ctrl * cocci_id@p ;
...
position p;
@@
 struct survey_event cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ NumRates ] ;
...
position p;
@@
 RT_CHANNEL_PLAN_MAP cocci_id@p [ RT_CHANNEL_DOMAIN_MAX ] ;
...
position p;
@@
 struct disconnect_parm * cocci_id@p ;
...
position p;
@@
 const struct p2p_oper_class_map cocci_id@p [ ] ;
...
position p;
@@
 struct Tx_Beacon_param cocci_id@p ;
...
position p;
@@
 struct registry_priv * cocci_id@p ;
...
position p;
@@
 struct stadel_event cocci_id@p ;
...
position p;
@@
 struct stassoc_event * cocci_id@p ;
...
position p;
@@
 struct mlme_handler cocci_id@p [ ] ;
...
position p;
@@
 struct joinbss_parm * cocci_id@p ;
...
position p;
@@
 struct rtw_ieee80211_ht_cap cocci_id@p ;
...
position p;
@@
 struct LedBlink_param * cocci_id@p ;
...
position p;
@@
 struct HT_caps_element * cocci_id@p ;
...
position p;
@@
 struct action_handler cocci_id@p [ ] ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( struct adapter * dev , u8 * pbuf ) ;
...
position p;
@@
 RT_CHANNEL_PLAN_MAP cocci_id@p ;
...
position p;
@@
 struct p2p_reg_class * cocci_id@p ;
...
position p;
@@
 struct addBaReq_parm * cocci_id@p ;
...
position p;
@@
 struct ndis_802_11_fix_ie cocci_id@p ;
...
position p;
@@
 struct stainfo_stats cocci_id@p ;
...
position p;
@@
 struct mlme_ext_info * cocci_id@p ;
...
position p;
@@
 RT_CHANNEL_PLAN_2G cocci_id@p [ RT_CHANNEL_DOMAIN_2G_MAX ] ;
...
position p;
@@
 struct set_stakey_parm * cocci_id@p ;
...
position p;
@@
 struct p2p_channels * cocci_id@p ;
...
position p;
@@
 struct wlan_network cocci_id@p ;
...
position p;
@@
 struct rtw_ieee802_11_elems cocci_id@p ;
...
position p;
@@
 struct wlan_bssid_ex cocci_id@p ;
...
position p;
@@
 struct security_priv * cocci_id@p ;
...
position p;
@@
 struct SetChannelPlan_param * cocci_id@p ;
...
position p;
@@
 RT_CHANNEL_PLAN_5G cocci_id@p [ RT_CHANNEL_DOMAIN_5G_MAX ] ;
...
position p;
@@
 RT_CHANNEL_INFO cocci_id@p [ MAX_CHANNEL_NUM ] ;
...
position p;
@@
 struct joinbss_event * cocci_id@p ;
...
position p;
@@
 struct setauth_parm * cocci_id@p ;
...
position p;
@@
 struct RunInThread_param * cocci_id@p ;
...
position p;
@@
 struct setopmode_parm * cocci_id@p ;
...
position p;
@@
 struct ndis_802_11_ssid * cocci_id@p ;
...
position p;
@@
 struct mlme_ext_priv * cocci_id@p ;
...
position p;
@@
 struct rx_pkt_attrib * cocci_id@p ;
...
position p;
@@
 struct ndis_80211_var_ie * cocci_id@p ;
...
position p;
@@
 struct rtw_ieee80211_channel * cocci_id@p ;
...
position p;
@@
 struct ADDBA_request cocci_id@p ;
...
position p;
@@
 struct sitesurvey_parm * cocci_id@p ;
