...
typedef u8,u32;
@@
 struct cxd2841er_priv {  struct dvb_frontend frontend ;  struct i2c_adapter * i2c ;  u8 i2c_addr_slvx ;  u8 i2c_addr_slvt ;  const struct cxd2841er_config * config ;  enum cxd2841er_state state ;  u8 system ;  enum cxd2841er_xtal xtal ;  enum fe_caps caps ;  u32 flags ;  unsigned long stats_time ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct cxd2841er_priv * priv , u32 bandwidth ) ;
...
position p;
@@
 const struct cxd2841er_cnr_data cocci_id@p [ ] ;
...
position p;
@@
 enum cxd2841er_state { STATE_SHUTDOWN = 0 , STATE_SLEEP_S , STATE_ACTIVE_S , STATE_SLEEP_TC , STATE_ACTIVE_TC , } cocci_id@p ;
...
position p;
@@
 enum cxd2841er_xtal cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct cxd2841er_priv * priv , u8 system ) ;
...
position p;
@@
 int cocci_id@p ( struct cxd2841er_priv * priv ) ;
...
position p;
@@
 struct cxd2841er_config * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cxd2841er_dvbt2_profile_t;
@@
 enum cxd2841er_dvbt2_profile_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sony_dvbc_constellation_t;
@@
 enum sony_dvbc_constellation_t { SONY_DVBC_CONSTELLATION_16QAM , SONY_DVBC_CONSTELLATION_32QAM , SONY_DVBC_CONSTELLATION_64QAM , SONY_DVBC_CONSTELLATION_128QAM , SONY_DVBC_CONSTELLATION_256QAM , } cocci_id@p ;
...
typedef sony_dvbc_constellation_t;
@@
 enum sony_dvbc_constellation_t cocci_id@p ;
...
position p;
@@
 struct cxd2841er_priv * cocci_id@p ;
