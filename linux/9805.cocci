...
position p;
@@
 struct ath10k_sta_tid_stats * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ ATH10K_STATS_TYPE_MAX ] ;
...
position p;
@@
 enum ath10k_ampdu_subfrm_num cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ ATH10K_COUNTER_TYPE_MAX ] ;
...
position p;
@@
 struct ath10k_htt_data_stats * cocci_id@p ;
...
position p;
@@
 enum ath10k_amsdu_subfrm_num cocci_id@p ;
