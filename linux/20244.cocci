...
position p;
@@
 struct IOD_subpacket * cocci_id@p ;
...
position p;
@@
 struct el_common_EV5_uncorrectable_mcheck * cocci_id@p ;
...
position p;
@@
 struct el_MCPCIA_uncorrected_frame_mcheck * cocci_id@p ;
