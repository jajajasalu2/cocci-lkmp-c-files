...
typedef u32;
@@
 u32 cocci_id@p ( struct tid_user_buf * tidbuf , unsigned int npages ) ;
...
position p;
@@
 void cocci_id@p ( struct hfi1_ctxtdata * uctxt , struct exp_tid_set * set , struct hfi1_filedata * fd ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct mmu_interval_notifier * mni , const struct mmu_notifier_range * range , unsigned long cur_seq ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct hfi1_filedata * fd , u32 tidinfo , struct tid_group * * grp ) ;
...
position p;
@@
 void cocci_id@p ( struct hfi1_filedata * fd , struct tid_rb_node * node ) ;
...
position p;
@@
 void cocci_id@p ( struct hfi1_filedata * fdata , struct tid_rb_node * tnode ) ;
...
typedef u32,u16;
@@
 int cocci_id@p ( struct hfi1_filedata * fd , struct tid_user_buf * tbuf , u32 rcventry , struct tid_group * grp , u16 pageidx , unsigned int npages ) ;
...
typedef u32,u16;
@@
 int cocci_id@p ( struct hfi1_filedata * fd , struct tid_user_buf * , struct tid_group * grp , unsigned int start , u16 count , u32 * tidlist , unsigned int * tididx , unsigned int * pmapped ) ;
...
position p;
@@
 struct tid_user_buf * cocci_id@p ;
