...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ ISL12022_REG_DW + 1 ] ;
...
typedef bool;
@@
 struct isl12022 {  struct rtc_device * rtc ;  bool write_enabled ; } cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ ISL12022_REG_INT + 1 ] ;
