...
position p;
@@
 struct rctx {  be128 t ;  struct skcipher_request subreq ; } cocci_id@p ;
...
position p;
@@
 struct priv {  struct crypto_skcipher * child ;  struct gf128mul_64k * table ;  be128 mulinc [ 128 ] ; } cocci_id@p ;
