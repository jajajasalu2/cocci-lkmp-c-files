...
position p;
@@
 struct tracer_event cocci_id@p ;
...
position p;
@@
 struct tracer_timestamp_event cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mtrc_ctrl ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( core_dump_reg ) ] ;
...
position p;
@@
 struct mlx5_fw_trace_data * cocci_id@p ;
...
position p;
@@
 struct tracer_string_format * cocci_id@p ;
...
position p;
@@
 struct mlx5_fw_tracer * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mtrc_conf ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mtrc_cap ) ] ;
