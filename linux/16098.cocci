...
position p;
@@
 struct apci1564_private {  unsigned long eeprom ;  unsigned long timer ;  unsigned long counters ;  unsigned int mode1 ;  unsigned int mode2 ;  unsigned int ctrl ; } cocci_id@p ;
...
position p;
@@
 struct apci1564_private * cocci_id@p ;
