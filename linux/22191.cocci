...
position p;
@@
 struct memory_failure_cpu * cocci_id@p ;
...
position p;
@@
 struct to_kill {  struct list_head nd ;  struct task_struct * tsk ;  unsigned long addr ;  short size_shift ; } cocci_id@p ;
...
position p;
@@
 enum mf_action_page_type cocci_id@p ;
...
position p;
@@
 struct memory_failure_entry {  unsigned long pfn ;  int flags ; } cocci_id@p ;
...
position p;
@@
 struct memory_failure_entry cocci_id@p ;
