...
position p;
@@
 struct hpi_msg_cobranet_hmiread cocci_id@p ;
...
typedef u32;
@@
 union handle_word {  struct hpi_handle h ;  u32 w ; } cocci_id@p ;
...
position p;
@@
 struct hpi_anc_frame * cocci_id@p ;
...
position p;
@@
 struct hpi_handle {  unsigned int obj_index : 12 ;  unsigned int obj_type : 4 ;  unsigned int adapter_index : 14 ;  unsigned int spare : 1 ;  unsigned int read_only : 1 ; } cocci_id@p ;
...
position p;
@@
 struct hpi_message_header * cocci_id@p ;
...
position p;
@@
 enum HPI_MIXER_STORE_COMMAND cocci_id@p ;
...
position p;
@@
 struct hpi_msg_format cocci_id@p ;
...
position p;
@@
 struct hpi_stream_res * cocci_id@p ;
...
position p;
@@
 struct hpi_res_cobranet_hmiread cocci_id@p ;
...
position p;
@@
 const struct hpi_format * cocci_id@p ;
...
position p;
@@
 const struct hpi_anc_frame * cocci_id@p ;
...
position p;
@@
 struct hpi_msg_cobranet_hmiwrite cocci_id@p ;
