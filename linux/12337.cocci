...
typedef u32;
@@
 const struct hvs_format {  u32 drm ;  u32 hvs ;  u32 pixel_order ; } cocci_id@p [ ] ;
...
position p;
@@
 enum vc4_scaling_mode cocci_id@p ;
...
position p;
@@
 const struct vc4_plane_state * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( hvs_formats ) ] ;
...
position p;
@@
 const struct hvs_format * cocci_id@p ;
