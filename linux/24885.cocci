...
position p;
@@
 const struct atm_dev * cocci_id@p ;
...
position p;
@@
 struct vcc_state {  int bucket ;  struct sock * sk ; } cocci_id@p ;
...
position p;
@@
 const struct k_atm_aal_stats * cocci_id@p ;
