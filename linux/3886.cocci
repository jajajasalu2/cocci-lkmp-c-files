...
position p;
@@
 struct stm32_cryp_ctx * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct stm32_cryp * cryp ) ;
...
position p;
@@
 const struct stm32_cryp_caps cocci_id@p ;
...
position p;
@@
 struct stm32_cryp_reqctx * cocci_id@p ;
...
typedef u32;
@@
 struct stm32_cryp_ctx {  struct crypto_engine_ctx enginectx ;  struct stm32_cryp * cryp ;  int keylen ;  u32 key [ AES_KEYSIZE_256 / sizeof ( u32 ) ] ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 struct stm32_cryp_list cocci_id@p ;
...
typedef spinlock_t;
@@
 struct stm32_cryp_list {  struct list_head dev_list ;  spinlock_t lock ; } cocci_id@p ;
...
typedef bool;
@@
 struct stm32_cryp_caps {  bool swap_final ;  bool padding_wa ; } cocci_id@p ;
...
position p;
@@
 struct stm32_cryp_reqctx {  unsigned long mode ; } cocci_id@p ;
