...
position p;
@@
 void cocci_id@p ( unsigned long start , unsigned long sp ) ;
...
position p;
@@
 void cocci_id@p ( struct thread_struct * thread ) ;
...
position p;
@@
 struct regbit {  unsigned long bit ;  const char * name ; } cocci_id@p ;
