...
position p;
@@
 const struct venc_config cocci_id@p ;
...
typedef bool;
@@
 struct venc_device {  struct platform_device * pdev ;  void __iomem * base ;  struct mutex venc_lock ;  struct regulator * vdda_dac_reg ;  struct dss_device * dss ;  struct dss_debugfs_entry * debugfs ;  struct clk * tv_dac_clk ;  const struct venc_config * config ;  enum omap_dss_venc_type type ;  bool invert_polarity ;  bool requires_tv_dac_clk ;  struct omap_dss_device output ; } cocci_id@p ;
...
position p;
@@
 enum venc_videomode { VENC_MODE_UNKNOWN , VENC_MODE_PAL , VENC_MODE_NTSC , } cocci_id@p ;
...
position p;
@@
 enum venc_videomode cocci_id@p ;
