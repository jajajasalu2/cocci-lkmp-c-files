...
position p;
@@
 enum r600_hdmi_color_format { RGB = 0 , YCC_422 = 1 , YCC_444 = 2 , } cocci_id@p ;
...
position p;
@@
 enum r600_hdmi_iec_status_bits { AUDIO_STATUS_DIG_ENABLE = 0x01 , AUDIO_STATUS_V = 0x02 , AUDIO_STATUS_VCFG = 0x04 , AUDIO_STATUS_EMPHASIS = 0x08 , AUDIO_STATUS_COPYRIGHT = 0x10 , AUDIO_STATUS_NONAUDIO = 0x20 , AUDIO_STATUS_PROFESSIONAL = 0x40 , AUDIO_STATUS_LEVEL = 0x80 , } cocci_id@p ;
