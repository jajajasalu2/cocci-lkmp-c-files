...
typedef bool,u32;
@@
 struct vmw_cotable {  struct vmw_resource res ;  struct vmw_resource * ctx ;  size_t size_read_back ;  int seen_entries ;  u32 type ;  bool scrubbed ;  struct list_head resource_list ; } cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXReadbackCOTable body ; } * cocci_id@p ;
...
position p;
@@
 const struct vmw_cotable_info cocci_id@p [ ] ;
...
typedef bool,u32;
@@
 struct vmw_cotable_info {  u32 min_initial_entries ;  u32 size ;  void ( * unbind_func ) ( struct vmw_private * , struct list_head * , bool ) ; } cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetCOTable body ; } * cocci_id@p ;
...
position p;
@@
 const SVGACOTableType cocci_id@p [ ] ;
