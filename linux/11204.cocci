...
position p;
@@
 struct ext_hdmi_settings cocci_id@p ;
...
position p;
@@
 struct gpio_service * cocci_id@p ;
...
position p;
@@
 const struct link_init_data * cocci_id@p ;
...
position p;
@@
 struct link_mst_stream_allocation cocci_id@p [ MAX_CONTROLLER_NUM ] ;
...
position p;
@@
 enum { PEAK_FACTOR_X1000 = 1006 , LINK_TRAINING_MAX_VERIFY_RETRY = 2 , } cocci_id@p ;
...
position p;
@@
 enum display_dongle_type cocci_id@p ;
...
position p;
@@
 const struct dpcd_caps * cocci_id@p ;
...
position p;
@@
 enum ddc_transaction_type cocci_id@p ;
...
position p;
@@
 struct dp_mst_stream_allocation_table cocci_id@p ;
...
position p;
@@
 struct encoder_init_data cocci_id@p ;
...
position p;
@@
 struct gpio_hpd_config cocci_id@p ;
...
position p;
@@
 struct audio_support * cocci_id@p ;
...
position p;
@@
 enum act_return_status cocci_id@p ;
...
position p;
@@
 struct cp_psp_stream_config cocci_id@p ;
...
position p;
@@
 enum dc_detect_reason cocci_id@p ;
...
position p;
@@
 struct ddc_service_init_data cocci_id@p ;
...
position p;
@@
 const struct dc_dongle_caps * cocci_id@p ;
...
position p;
@@
 const struct dp_mst_stream_allocation_table * cocci_id@p ;
...
position p;
@@
 struct link_mst_stream_allocation * cocci_id@p ;
...
position p;
@@
 union max_down_spread cocci_id@p ;
...
position p;
@@
 enum physical_phy_id cocci_id@p ;
...
position p;
@@
 struct external_display_path * cocci_id@p ;
