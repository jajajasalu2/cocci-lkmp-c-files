...
position p;
@@
 struct ccp_sha_exp_ctx cocci_id@p ;
...
position p;
@@
 struct ccp_sha_req_ctx * cocci_id@p ;
...
position p;
@@
 const struct ccp_sha_def * cocci_id@p ;
...
typedef u32;
@@
 struct ccp_sha_def {  unsigned int version ;  const char * name ;  const char * drv_name ;  enum ccp_sha_type type ;  u32 digest_size ;  u32 block_size ; } cocci_id@p ;
...
position p;
@@
 const struct ccp_crypto_ahash_alg * cocci_id@p ;
