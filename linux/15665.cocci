...
position p;
@@
 struct gb_audio_jack_event_request * cocci_id@p ;
...
position p;
@@
 struct gb_audio_button_event_request * cocci_id@p ;
...
position p;
@@
 struct gb_audio_manager_module_descriptor cocci_id@p ;
...
position p;
@@
 struct gb_audio_streaming_event_request * cocci_id@p ;
