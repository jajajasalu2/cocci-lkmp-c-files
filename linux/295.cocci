...
position p;
@@
 struct tick_device * cocci_id@p ( struct device * dev ) ;
...
position p;
@@
 struct ce_unbind {  struct clock_event_device * ce ;  int res ; } cocci_id@p ;
...
position p;
@@
 enum clock_event_state cocci_id@p ;
