...
position p;
@@
 struct tcf_block_owner_item * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef tcf_chain_head_change_t;
@@
 struct tcf_filter_chain_list_item {  struct list_head list ;  tcf_chain_head_change_t * chain_head_change ;  void * chain_head_change_priv ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_MAX + 1 ] ;
...
typedef bool,u32;
@@
 struct tcf_proto * cocci_id@p ( struct tcf_chain * chain , struct tcf_chain_info * chain_info , u32 protocol , u32 prio , bool prio_allocate ) ;
...
position p;
@@
 struct tcf_dump_args cocci_id@p ;
...
position p;
@@
 struct tcf_block_owner_item {  struct list_head list ;  struct Qdisc * q ;  enum flow_block_binder_type binder_type ; } cocci_id@p ;
...
position p;
@@
 const struct Qdisc_ops * cocci_id@p ;
...
position p;
@@
 struct flow_indr_block_entry cocci_id@p ;
...
position p;
@@
 const struct tcf_proto * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct tcf_net {  spinlock_t idr_lock ;  struct idr idr ; } cocci_id@p ;
...
position p;
@@
 enum flow_block_binder_type cocci_id@p ;
...
position p;
@@
 struct tcf_block_ext_info * cocci_id@p ;
...
position p;
@@
 struct tcf_filter_chain_list_item * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tcf_block * block , struct flow_block_offload * bo ) ;
...
position p;
@@
 const struct tcf_proto_ops * cocci_id@p ;
...
position p;
@@
 struct tcf_proto_ops * cocci_id@p ;
...
@@
 int cocci_id@p ( struct tcf_chain * chain , struct sk_buff * oskb , u32 seq , u16 flags , int event , bool unicast ) ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_MAX + 1 ] ;
...
@@
 flow_indr_block_bind_cb_t * cocci_id@p ;
...
typedef bool,u32,u16;
@@
 int cocci_id@p ( const struct tcf_proto_ops * tmplt_ops , void * tmplt_priv , u32 chain_index , struct tcf_block * block , struct sk_buff * oskb , u32 seq , u16 flags , bool unicast ) ;
...
position p;
@@
 struct tcf_chain_info {  struct tcf_proto __rcu * * pprev ;  struct tcf_proto __rcu * next ; } cocci_id@p ;
...
position p;
@@
 struct tcf_chain_info * cocci_id@p ;
...
position p;
@@
 enum flow_block_command cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct tcf_proto_ops * tmplt_ops , void * tmplt_priv ) ;
...
position p;
@@
 const struct tc_action * cocci_id@p ;
...
typedef u32;
@@
 struct tcf_dump_args {  struct tcf_walker w ;  struct sk_buff * skb ;  struct netlink_callback * cb ;  struct tcf_block * block ;  struct Qdisc * q ;  u32 parent ; } cocci_id@p ;
...
position p;
@@
 const struct tcf_exts * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tcf_chain * chain ) ;
