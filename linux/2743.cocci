...
position p;
@@
 struct ec_params_i2c_passthru cocci_id@p ;
...
position p;
@@
 struct ec_response_i2c_passthru cocci_id@p ;
...
position p;
@@
 struct ec_params_i2c_passthru_msg * cocci_id@p ;
...
position p;
@@
 const struct ec_response_i2c_passthru * cocci_id@p ;
...
typedef u8,u16;
@@
 struct ec_i2c_device {  struct device * dev ;  struct i2c_adapter adap ;  struct cros_ec_device * ec ;  u16 remote_bus ;  u8 request_buf [ 256 ] ;  u8 response_buf [ 256 ] ; } cocci_id@p ;
...
position p;
@@
 struct ec_i2c_device * cocci_id@p ;
