...
position p;
@@
 const struct mips_perf_event * cocci_id@p ;
...
position p;
@@
 struct mips_perf_event cocci_id@p ;
...
position p;
@@
 const struct mips_perf_event cocci_id@p [ PERF_COUNT_HW_MAX ] ;
...
position p;
@@
 struct cpu_hw_events {  struct perf_event * events [ MIPS_MAX_HWEVENTS ] ;  unsigned long used_mask [ BITS_TO_LONGS ( MIPS_MAX_HWEVENTS ) ] ;  unsigned int saved_ctrl [ MIPS_MAX_HWEVENTS ] ; } cocci_id@p ;
...
position p;
@@
 const struct mips_perf_event cocci_id@p [ PERF_COUNT_HW_CACHE_MAX ] [ PERF_COUNT_HW_CACHE_OP_MAX ] [ PERF_COUNT_HW_CACHE_RESULT_MAX ] ;
