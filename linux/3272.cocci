...
position p;
@@
 struct ads7828_data * cocci_id@p ;
...
typedef u8;
@@
 struct ads7828_data {  struct regmap * regmap ;  u8 cmd_byte ;  unsigned int lsb_resol ; } cocci_id@p ;
...
position p;
@@
 enum ads7828_chips { ads7828 , ads7830 , } cocci_id@p ;
...
position p;
@@
 struct ads7828_platform_data * cocci_id@p ;
