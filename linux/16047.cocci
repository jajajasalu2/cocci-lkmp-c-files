...
typedef spinlock_t;
@@
 struct pci224_private {  unsigned long iobase1 ;  unsigned long state ;  spinlock_t ao_spinlock ;  unsigned short * ao_scan_vals ;  unsigned char * ao_scan_order ;  int intr_cpuid ;  short intr_running ;  unsigned short daccon ;  unsigned short ao_enab ;  unsigned char intsce ; } cocci_id@p ;
...
position p;
@@
 struct pci224_private * cocci_id@p ;
...
position p;
@@
 struct pci224_board {  const char * name ;  unsigned int ao_chans ;  unsigned int ao_bits ;  const struct comedi_lrange * ao_range ;  const unsigned short * ao_hwrange ;  const unsigned char * ao_range_check ; } cocci_id@p ;
...
position p;
@@
 enum pci224_model { pci224_model , pci234_model , } cocci_id@p ;
...
position p;
@@
 const struct pci224_board * cocci_id@p ;
...
position p;
@@
 const unsigned short cocci_id@p [ 10 ] ;
...
position p;
@@
 struct pci224_board cocci_id@p ;
