...
position p;
@@
 const struct aspeed_sig_expr * * * cocci_id@p ;
...
position p;
@@
 const struct aspeed_pin_config_map * cocci_id@p ;
...
position p;
@@
 enum aspeed_pin_config_map_type cocci_id@p ;
...
typedef s32,u32;
@@
 struct aspeed_pin_config_map {  enum pin_config_param param ;  s32 arg ;  u32 val ; } cocci_id@p ;
...
position p;
@@
 const char * ( * cocci_id@p ) ( const struct aspeed_sig_expr * ) ;
...
position p;
@@
 const struct aspeed_pin_desc * cocci_id@p ;
...
position p;
@@
 const enum pin_config_param cocci_id@p ;
...
position p;
@@
 const struct aspeed_pin_group * cocci_id@p ;
...
position p;
@@
 enum aspeed_pin_config_map_type { MAP_TYPE_ARG , MAP_TYPE_VAL , } cocci_id@p ;
...
position p;
@@
 const struct aspeed_pin_config * cocci_id@p ;
...
position p;
@@
 struct aspeed_pinctrl_data * cocci_id@p ;
...
position p;
@@
 const struct aspeed_pin_function * cocci_id@p ;
...
position p;
@@
 const struct aspeed_pinctrl_data * cocci_id@p ;
...
position p;
@@
 struct aspeed_pinmux_data * cocci_id@p ;
