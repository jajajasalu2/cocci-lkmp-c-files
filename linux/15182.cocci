...
position p;
@@
 struct parport_device_sysctl_table * cocci_id@p ;
...
position p;
@@
 const struct parport_sysctl_table cocci_id@p ;
...
position p;
@@
 const struct parport_device_sysctl_table cocci_id@p ;
...
position p;
@@
 struct parport_default_sysctl_table cocci_id@p ;
...
position p;
@@
 struct parport_device_sysctl_table {  struct ctl_table_header * sysctl_header ;  struct ctl_table vars [ 2 ] ;  struct ctl_table device_dir [ 2 ] ;  struct ctl_table devices_root_dir [ 2 ] ;  struct ctl_table port_dir [ 2 ] ;  struct ctl_table parport_dir [ 2 ] ;  struct ctl_table dev_dir [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct parport_sysctl_table {  struct ctl_table_header * sysctl_header ;  struct ctl_table vars [ 12 ] ;  struct ctl_table device_dir [ 2 ] ;  struct ctl_table port_dir [ 2 ] ;  struct ctl_table parport_dir [ 2 ] ;  struct ctl_table dev_dir [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct parport_sysctl_table * cocci_id@p ;
...
position p;
@@
 struct parport_default_sysctl_table {  struct ctl_table_header * sysctl_header ;  struct ctl_table vars [ 3 ] ;  struct ctl_table default_dir [ 2 ] ;  struct ctl_table parport_dir [ 2 ] ;  struct ctl_table dev_dir [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct parport_device_info * cocci_id@p ;
