...
position p;
@@
 struct mthca_reg_mr cocci_id@p ;
...
position p;
@@
 struct mthca_alloc_ucontext_resp cocci_id@p ;
...
position p;
@@
 struct mthca_create_cq cocci_id@p ;
...
position p;
@@
 struct mthca_create_srq cocci_id@p ;
...
position p;
@@
 struct mthca_resize_cq cocci_id@p ;
...
position p;
@@
 struct mthca_set_ib_param cocci_id@p ;
...
position p;
@@
 struct mthca_create_qp cocci_id@p ;
