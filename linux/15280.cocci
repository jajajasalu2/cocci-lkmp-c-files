...
position p;
@@
 struct ns2_led_priv * cocci_id@p ;
...
position p;
@@
 struct ns2_led_modval cocci_id@p ;
...
position p;
@@
 const struct ns2_led * cocci_id@p ;
...
position p;
@@
 struct ns2_led_data * cocci_id@p ;
...
position p;
@@
 struct ns2_led_priv {  int num_leds ;  struct ns2_led_data leds_data [ ] ; } cocci_id@p ;
...
@@
 struct ns2_led_data {  struct led_classdev cdev ;  unsigned int cmd ;  unsigned int slow ;  bool can_sleep ;  unsigned char sata ;  rwlock_t rw_lock ;  int num_modes ;  struct ns2_led_modval * modval ; } cocci_id@p ;
...
position p;
@@
 struct ns2_led_platform_data * cocci_id@p ;
