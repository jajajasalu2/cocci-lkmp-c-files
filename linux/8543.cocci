...
position p;
@@
 unsigned int cocci_id@p [ ] __used __initdata ;
...
typedef spinlock_t;
@@
 struct net_local {  int chip_type ;  char chip_revision ;  int send_cmd ;  int auto_neg_cnf ;  int adapter_cnf ;  int isa_config ;  int irq_map ;  int rx_mode ;  int curr_rx_cfg ;  int linectl ;  int send_underrun ;  int force ;  spinlock_t lock ;  void __iomem * virt_addr ; #if ALLOW_DMA  int use_dma ;  int dma ;  int dmasize ;  unsigned char * dma_buff ;  unsigned char * end_dma_buff ;  unsigned char * rx_dma_ptr ; #endif } cocci_id@p ;
