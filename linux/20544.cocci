...
position p;
@@
 struct blake2s_state * cocci_id@p ;
...
position p;
@@
 struct blake2s_tfm_ctx * cocci_id@p ;
...
typedef u8,u32;
@@
 void cocci_id@p ( struct blake2s_state * state , const u8 * block , const size_t nblocks , const u32 inc ) ;
