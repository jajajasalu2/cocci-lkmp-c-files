...
position p;
@@
 struct typec_switch * cocci_id@p ;
...
typedef u8;
@@
 struct pi3usb30532 {  struct i2c_client * client ;  struct mutex lock ;  struct typec_switch * sw ;  struct typec_mux * mux ;  u8 conf ; } cocci_id@p ;
...
position p;
@@
 struct typec_mux_desc cocci_id@p ;
...
position p;
@@
 struct typec_switch_desc cocci_id@p ;
