...
position p;
@@
 struct onfi_ext_ecc_info * cocci_id@p ;
...
position p;
@@
 struct onfi_ext_section * cocci_id@p ;
...
position p;
@@
 struct onfi_ext_param_page * cocci_id@p ;
