...
position p;
@@
 const struct rpc_filelist cocci_id@p [ ] ;
...
position p;
@@
 enum { RPCAUTH_lockd , RPCAUTH_mount , RPCAUTH_nfs , RPCAUTH_portmap , RPCAUTH_statd , RPCAUTH_nfsd4_cb , RPCAUTH_cache , RPCAUTH_nfsd , RPCAUTH_gssd , RPCAUTH_RootEOF , } cocci_id@p ;
...
position p;
@@
 const struct rpc_filelist cocci_id@p [ 3 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct dentry * , void * ) ;
...
typedef umode_t;
@@
 struct rpc_filelist {  const char * name ;  const struct file_operations * i_fop ;  umode_t mode ; } cocci_id@p ;
...
position p;
@@
 enum { RPCAUTH_info , RPCAUTH_EOF , } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rpc_pipe_dir_object * , void * ) ;
...
position p;
@@
 struct rpc_pipe_dir_head * cocci_id@p ;
...
position p;
@@
 struct rpc_pipe_dir_object * ( * cocci_id@p ) ( void * ) ;
