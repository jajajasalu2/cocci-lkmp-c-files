...
typedef bool;
@@
 bool cocci_id@p ( struct arch_timer_context * timer_ctx ) ;
...
position p;
@@
 struct arch_timer_cpu cocci_id@p ;
...
position p;
@@
 enum kvm_arch_timer_regs cocci_id@p ;
...
position p;
@@
 enum kvm_arch_timers cocci_id@p ;
...
position p;
@@
 struct arch_timer_context * cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct kvm_vcpu * vcpu , struct arch_timer_context * timer , enum kvm_arch_timer_regs treg , u64 val ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct kvm_vcpu * vcpu , bool new_level , struct arch_timer_context * timer_ctx ) ;
...
position p;
@@
 const struct kvm_irq_level cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct kvm_vcpu * vcpu , struct arch_timer_context * timer , enum kvm_arch_timer_regs treg ) ;
