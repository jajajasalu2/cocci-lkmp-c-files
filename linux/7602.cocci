...
position p;
@@
 const unsigned short cocci_id@p [ 2 ] ;
...
position p;
@@
 struct matroxfb_dh_maven_info {  struct i2c_bit_adapter maven ;  struct i2c_bit_adapter ddc1 ;  struct i2c_bit_adapter ddc2 ; } cocci_id@p ;
...
position p;
@@
 struct matroxfb_dh_maven_info * cocci_id@p ;
