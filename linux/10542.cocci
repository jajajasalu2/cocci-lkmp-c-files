...
position p;
@@
 struct drm_mode_cursor * cocci_id@p ;
...
position p;
@@
 struct drm_mode_get_plane_res * cocci_id@p ;
...
position p;
@@
 struct drm_mode_cursor2 * cocci_id@p ;
...
position p;
@@
 struct drm_format_modifier * cocci_id@p ;
...
position p;
@@
 struct drm_mode_crtc_page_flip_target * cocci_id@p ;
...
position p;
@@
 struct drm_mode_get_plane * cocci_id@p ;
...
position p;
@@
 struct drm_mode_set_plane * cocci_id@p ;
...
position p;
@@
 struct drm_format_modifier_blob cocci_id@p ;
