...
@@
 struct gb_sdio_host {  struct gb_connection * connection ;  struct gbphy_device * gbphy_dev ;  struct mmc_host * mmc ;  struct mmc_request * mrq ;  struct mutex lock ;  size_t data_max ;  spinlock_t xfer ;  bool xfer_stop ;  struct workqueue_struct * mrq_workqueue ;  struct work_struct mrqwork ;  u8 queued_events ;  bool removed ;  bool card_present ;  bool read_only ; } cocci_id@p ;
...
position p;
@@
 struct gb_sdio_command_response cocci_id@p ;
...
position p;
@@
 struct gb_sdio_transfer_response * cocci_id@p ;
...
position p;
@@
 struct gb_sdio_set_ios_request * cocci_id@p ;
...
position p;
@@
 struct gb_sdio_get_caps_response cocci_id@p ;
...
position p;
@@
 struct gb_sdio_transfer_request * cocci_id@p ;
...
position p;
@@
 struct gb_sdio_event_request * cocci_id@p ;
...
position p;
@@
 struct gb_sdio_host cocci_id@p ;
...
position p;
@@
 struct gb_sdio_command_request cocci_id@p ;
