...
position p;
@@
 struct fd_drive_type {  unsigned long code ;  char * name ;  unsigned int tracks ;  unsigned int heads ;  unsigned int read_size ;  unsigned int write_size ;  unsigned int sect_mult ;  unsigned int precomp1 ;  unsigned int precomp2 ;  unsigned int step_delay ;  unsigned int settle_time ;  unsigned int side_time ; } cocci_id@p ;
...
position p;
@@
 struct header {  unsigned char magic ;  unsigned char track ;  unsigned char sect ;  unsigned char ord ;  unsigned char labels [ 16 ] ;  unsigned long hdrchk ;  unsigned long datachk ; } cocci_id@p ;
...
position p;
@@
 struct fd_data_type cocci_id@p [ ] ;
...
position p;
@@
 struct fd_data_type {  char * name ;  int sects ;  int ( * read_fkt ) ( int ) ;  void ( * write_fkt ) ( int ) ; } cocci_id@p ;
...
position p;
@@
 struct amiga_floppy_struct cocci_id@p [ FD_MAX_UNITS ] ;
...
position p;
@@
 struct amiga_floppy_struct * cocci_id@p ;
...
position p;
@@
 struct fd_drive_type cocci_id@p [ ] ;
...
position p;
@@
 struct timer_list cocci_id@p [ FD_MAX_UNITS ] ;
...
position p;
@@
 struct amiga_floppy_struct {  struct fd_drive_type * type ;  struct fd_data_type * dtype ;  int track ;  unsigned char * trackbuf ;  int blocks ;  int changed ;  int disk ;  int motor ;  int busy ;  int dirty ;  int status ;  struct gendisk * gendisk ;  struct blk_mq_tag_set tag_set ; } cocci_id@p ;
