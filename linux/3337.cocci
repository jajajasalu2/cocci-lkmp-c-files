...
position p;
@@
 enum chips { fscpos , fscher , fscscy , fschrc , fschmd , fschds , fscsyl , } cocci_id@p ;
...
position p;
@@
 struct fschmd_data * cocci_id@p ( struct device * dev ) ;
...
typedef u8;
@@
 struct fschmd_data {  struct i2c_client * client ;  struct device * hwmon_dev ;  struct mutex update_lock ;  struct mutex watchdog_lock ;  struct list_head list ;  struct kref kref ;  struct miscdevice watchdog_miscdev ;  enum chips kind ;  unsigned long watchdog_is_open ;  char watchdog_expect_close ;  char watchdog_name [ 10 ] ;  char valid ;  unsigned long last_updated ;  u8 revision ;  u8 global_control ;  u8 watchdog_control ;  u8 watchdog_state ;  u8 watchdog_preset ;  u8 volt [ 6 ] ;  u8 temp_act [ 11 ] ;  u8 temp_status [ 11 ] ;  u8 temp_max [ 11 ] ;  u8 fan_act [ 7 ] ;  u8 fan_status [ 7 ] ;  u8 fan_min [ 7 ] ;  u8 fan_ripple [ 7 ] ; } cocci_id@p ;
