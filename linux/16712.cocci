...
position p;
@@
 enum { REG_READ = 0x00 , REG_SET_PAGE = 0x00 , REG_LEN = 0x04 , REG_DATA = 0x08 , PAGE_NAME = 0x00000 , PAGE_EVBITS = 0x10000 , PAGE_ABSDATA = 0x20000 | EV_ABS , } cocci_id@p ;
...
position p;
@@
 struct event_dev {  struct input_dev * input ;  int irq ;  void __iomem * addr ;  char name [ 0 ] ; } cocci_id@p ;
