...
typedef bool;
@@
 struct max8997_led {  struct max8997_dev * iodev ;  struct led_classdev cdev ;  bool enabled ;  int id ;  enum max8997_led_mode led_mode ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 enum max8997_led_mode cocci_id@p ;
