...
typedef u8;
@@
 struct gl518_data {  struct i2c_client * client ;  const struct attribute_group * groups [ 3 ] ;  enum chips type ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u8 voltage_in [ 4 ] ;  u8 voltage_min [ 4 ] ;  u8 voltage_max [ 4 ] ;  u8 fan_in [ 2 ] ;  u8 fan_min [ 2 ] ;  u8 fan_div [ 2 ] ;  u8 fan_auto1 ;  u8 temp_in ;  u8 temp_max ;  u8 temp_hyst ;  u8 alarms ;  u8 alarm_mask ;  u8 beep_mask ;  u8 beep_enable ; } cocci_id@p ;
...
position p;
@@
 enum chips { gl518sm_r00 , gl518sm_r80 , } cocci_id@p ;
