...
position p;
@@
 enum chips { mcp3021 , mcp3221 , } cocci_id@p ;
...
position p;
@@
 struct mcp3021_data * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct mcp3021_data {  struct device * hwmon_dev ;  u32 vdd ;  u16 sar_shift ;  u16 sar_mask ;  u8 output_res ; } cocci_id@p ;
