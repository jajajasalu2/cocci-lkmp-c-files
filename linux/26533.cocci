...
typedef __u32,__u8;
@@
 int cocci_id@p ( const struct btf_dumper * d , __u32 type_id , __u8 bit_offset , const void * data ) ;
...
position p;
@@
 int cocci_id@p ( const struct btf * btf , char * func_sig , const struct btf_type * func_proto , const struct btf_type * func , int pos , int size ) ;
...
position p;
@@
 const struct btf_dumper * cocci_id@p ;
