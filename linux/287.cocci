...
position p;
@@
 struct old_itimerval32 cocci_id@p ;
...
position p;
@@
 struct itimerspec64 * const cocci_id@p ;
...
position p;
@@
 struct old_itimerval32 {  struct old_timeval32 it_interval ;  struct old_timeval32 it_value ; } cocci_id@p ;
...
position p;
@@
 const struct itimerspec64 * const cocci_id@p ;
