...
position p;
@@
 struct sci_port_properties cocci_id@p ;
...
position p;
@@
 enum sci_port_states cocci_id@p ;
...
position p;
@@
 struct sci_user_parameters * cocci_id@p ;
...
position p;
@@
 union scu_remote_node_context cocci_id@p ;
