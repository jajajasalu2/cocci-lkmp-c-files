...
position p;
@@
 struct omap_cf_socket cocci_id@p ;
...
@@
 struct socket_state_t * cocci_id@p ;
...
typedef u_int;
@@
 struct omap_cf_socket {  struct pcmcia_socket socket ;  struct timer_list timer ;  unsigned present : 1 ;  unsigned active : 1 ;  struct platform_device * pdev ;  unsigned long phys_cf ;  u_int irq ;  struct resource iomem ; } cocci_id@p ;
