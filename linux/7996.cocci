...
@@
 struct evc_init {  u_char code ;  u_char index ;  u_char n ;  u_short para ; } cocci_id@p ;
...
position p;
@@
 struct s_srf_evc * cocci_id@p ( struct s_smc * smc , int code , int index ) ;
...
position p;
@@
 const struct evc_init * cocci_id@p ;
