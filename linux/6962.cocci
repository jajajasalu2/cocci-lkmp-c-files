...
position p;
@@
 const size_t cocci_id@p [ IPACK_SPACE_COUNT ] ;
...
position p;
@@
 struct tpci200_board * cocci_id@p ;
...
position p;
@@
 struct tpci200_infos cocci_id@p ;
...
position p;
@@
 struct tpci200_slot cocci_id@p ;
