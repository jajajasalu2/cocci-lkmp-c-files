...
position p;
@@
 const struct s3c_rtc_data cocci_id@p ;
...
@@
 struct s3c_rtc {  struct device * dev ;  struct rtc_device * rtc ;  void __iomem * base ;  struct clk * rtc_clk ;  struct clk * rtc_src_clk ;  bool alarm_enabled ;  const struct s3c_rtc_data * data ;  int irq_alarm ;  int irq_tick ;  spinlock_t pie_lock ;  spinlock_t alarm_lock ;  int ticnt_save ;  int ticnt_en_save ;  bool wake_en ; } cocci_id@p ;
