...
position p;
@@
 union igp_info {  struct _ATOM_INTEGRATED_SYSTEM_INFO info ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V2 info_2 ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V5 info_5 ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V6 info_6 ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V1_7 info_7 ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V1_8 info_8 ; } cocci_id@p ;
...
position p;
@@
 struct kv_power_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct amdgpu_device * adev , struct amdgpu_ps * new_rps , struct amdgpu_ps * old_rps ) ;
...
position p;
@@
 struct amdgpu_uvd_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct amdgpu_vce_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 union pplib_clock_info {  struct _ATOM_PPLIB_R600_CLOCK_INFO r600 ;  struct _ATOM_PPLIB_RS780_CLOCK_INFO rs780 ;  struct _ATOM_PPLIB_EVERGREEN_CLOCK_INFO evergreen ;  struct _ATOM_PPLIB_SUMO_CLOCK_INFO sumo ; } cocci_id@p ;
...
position p;
@@
 const struct kv_pt_config_reg * cocci_id@p ;
...
position p;
@@
 const struct amd_pm_funcs cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct amdgpu_device * adev , u32 level ) ;
...
position p;
@@
 struct amdgpu_clock_and_voltage_limits * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct amdgpu_device * adev , int min_temp , int max_temp ) ;
...
position p;
@@
 struct sumo_sclk_voltage_mapping_table * cocci_id@p ;
...
position p;
@@
 struct sumo_vid_mapping_table * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct amdgpu_device * adev , struct amdgpu_ps * new_rps ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct amdgpu_device * adev , bool enable ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct amdgpu_device * adev , bool gate ) ;
...
position p;
@@
 ATOM_AVAILABLE_SCLK_LIST * cocci_id@p ;
