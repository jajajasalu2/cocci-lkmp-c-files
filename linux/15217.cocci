...
typedef u32;
@@
 struct el15203000_led {  struct el15203000 * priv ;  struct led_classdev ldev ;  u32 reg ; } cocci_id@p ;
...
position p;
@@
 enum el15203000_command { EL_OFF = '0' , EL_ON = '1' , EL_SCREEN_BREATHING = '2' , EL_PIPE_CASCADE = '2' , EL_PIPE_INV_CASCADE = '3' , EL_PIPE_BOUNCE = '4' , EL_PIPE_INV_BOUNCE = '5' , } cocci_id@p ;
...
position p;
@@
 struct el15203000_led * cocci_id@p ;
...
position p;
@@
 struct el15203000 {  struct device * dev ;  struct mutex lock ;  struct spi_device * spi ;  unsigned long delay ;  size_t count ;  struct el15203000_led leds [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct led_pattern * cocci_id@p ;
