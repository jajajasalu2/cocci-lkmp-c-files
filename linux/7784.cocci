...
position p;
@@
 struct timbuart_port * cocci_id@p ;
...
typedef u32;
@@
 struct timbuart_port {  struct uart_port port ;  struct tasklet_struct tasklet ;  int usedma ;  u32 last_ier ;  struct platform_device * dev ; } cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct uart_port * port , u32 isr , u32 * ier ) ;
