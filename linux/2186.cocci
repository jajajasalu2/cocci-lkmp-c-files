...
typedef bool;
@@
 struct collie_bat {  int status ;  struct power_supply * psy ;  int full_chrg ;  struct mutex work_lock ;  bool ( * is_present ) ( struct collie_bat * bat ) ;  int gpio_full ;  int gpio_charge_on ;  int technology ;  int gpio_bat ;  int adc_bat ;  int adc_bat_divider ;  int bat_max ;  int bat_min ;  int gpio_temp ;  int adc_temp ;  int adc_temp_divider ; } cocci_id@p ;
...
position p;
@@
 struct ucb1x00_driver cocci_id@p ;
