...
position p;
@@
 struct can_rx_offload_cb cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sk_buff * a , struct sk_buff * b ) ;
...
position p;
@@
 const struct can_rx_offload_cb * cocci_id@p ;
...
typedef u32;
@@
 struct can_rx_offload_cb {  u32 timestamp ; } cocci_id@p ;
