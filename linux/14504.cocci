...
position p;
@@
 struct pistachio_clk_pll * cocci_id@p ;
...
position p;
@@
 struct pistachio_clk_provider * cocci_id@p ;
...
position p;
@@
 struct pistachio_pll * cocci_id@p ;
...
position p;
@@
 struct pistachio_clk_pll {  struct clk_hw hw ;  void __iomem * base ;  struct pistachio_pll_rate_table * rates ;  unsigned int nr_rates ; } cocci_id@p ;
...
position p;
@@
 struct pistachio_pll_rate_table * cocci_id@p ;
...
position p;
@@
 enum pistachio_pll_type cocci_id@p ;
...
position p;
@@
 enum pll_mode { PLL_MODE_FRAC , PLL_MODE_INT , } cocci_id@p ;
