...
position p;
@@
 const int cocci_id@p [ PERF_SAMPLE_BRANCH_MAX_SHIFT ] ;
...
position p;
@@
 enum { LBR_FORMAT_32 = 0x00 , LBR_FORMAT_LIP = 0x01 , LBR_FORMAT_EIP = 0x02 , LBR_FORMAT_EIP_FLAGS = 0x03 , LBR_FORMAT_EIP_FLAGS2 = 0x04 , LBR_FORMAT_INFO = 0x05 , LBR_FORMAT_TIME = 0x06 , LBR_FORMAT_MAX_KNOWN = LBR_FORMAT_TIME , } cocci_id@p ;
...
position p;
@@
 const enum { LBR_EIP_FLAGS = 1 , LBR_TSX = 2 , } cocci_id@p [ LBR_FORMAT_MAX_KNOWN + 1 ] ;
...
typedef u64,u32;
@@
 union {  struct {  u32 from ;  u32 to ; } ;  u64 lbr ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cpu_hw_events * cpuc ) ;
...
position p;
@@
 enum { X86_BR_NONE = 0 , X86_BR_USER = 1 << 0 , X86_BR_KERNEL = 1 << 1 , X86_BR_CALL = 1 << 2 , X86_BR_RET = 1 << 3 , X86_BR_SYSCALL = 1 << 4 , X86_BR_SYSRET = 1 << 5 , X86_BR_INT = 1 << 6 , X86_BR_IRET = 1 << 7 , X86_BR_JCC = 1 << 8 , X86_BR_JMP = 1 << 9 , X86_BR_IRQ = 1 << 10 , X86_BR_IND_CALL = 1 << 11 , X86_BR_ABORT = 1 << 12 , X86_BR_IN_TX = 1 << 13 , X86_BR_NO_TX = 1 << 14 , X86_BR_ZERO_CALL = 1 << 15 , X86_BR_CALL_STACK = 1 << 16 , X86_BR_IND_JMP = 1 << 17 , X86_BR_TYPE_SAVE = 1 << 18 , } cocci_id@p ;
...
position p;
@@
 enum { LBR_NONE , LBR_VALID , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ X86_BR_TYPE_MAP_MAX ] ;
