...
position p;
@@
 const struct imx_pll14xx_clk * cocci_id@p ;
...
position p;
@@
 const struct imx_pll14xx_rate_table cocci_id@p [ ] ;
...
position p;
@@
 struct imx_pll14xx_clk cocci_id@p ;
...
position p;
@@
 struct clk_pll14xx {  struct clk_hw hw ;  void __iomem * base ;  enum imx_pll14xx_type type ;  const struct imx_pll14xx_rate_table * rate_table ;  int rate_count ; } cocci_id@p ;
