...
position p;
@@
 const struct st_lsm6dsx_odr_table_entry * cocci_id@p ;
...
position p;
@@
 const struct st_lsm6dsx_shub_settings * cocci_id@p ;
...
position p;
@@
 const struct st_lsm6dsx_event_settings * cocci_id@p ;
...
position p;
@@
 struct st_sensors_platform_data * cocci_id@p ;
...
position p;
@@
 const struct st_lsm6dsx_hw_ts_settings * cocci_id@p ;
...
position p;
@@
 const struct st_lsm6dsx_settings cocci_id@p [ ] ;
...
position p;
@@
 const struct st_lsm6dsx_reg * * cocci_id@p ;
...
position p;
@@
 struct st_lsm6dsx_hw * cocci_id@p ;
...
position p;
@@
 struct st_lsm6dsx_sensor * cocci_id@p ;
...
position p;
@@
 enum st_lsm6dsx_sensor_id cocci_id@p ;
...
position p;
@@
 const struct st_lsm6dsx_fs_table_entry * cocci_id@p ;
