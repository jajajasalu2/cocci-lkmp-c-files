...
position p;
@@
 enum WMAX_CONTROL_STATES { WMAX_RUNNING = 0xFF , WMAX_BOOTING = 0 , WMAX_SUSPEND = 3 , } cocci_id@p ;
...
typedef u8;
@@
 struct quirk_entry {  u8 num_zones ;  u8 hdmi_mux ;  u8 amplifier ;  u8 deepslp ; } cocci_id@p ;
...
typedef u8;
@@
 struct wmax_basic_args {  u8 arg ; } cocci_id@p ;
...
position p;
@@
 struct wmax_basic_args cocci_id@p ;
...
typedef u32;
@@
 struct wmax_brightness_args {  u32 led_mask ;  u32 percentage ; } cocci_id@p ;
...
position p;
@@
 struct wmax_led_args cocci_id@p ;
...
position p;
@@
 union color_union {  struct color_platform cp ;  int package ; } cocci_id@p ;
...
position p;
@@
 enum LEGACY_CONTROL_STATES { LEGACY_RUNNING = 1 , LEGACY_BOOTING = 0 , LEGACY_SUSPEND = 3 , } cocci_id@p ;
...
position p;
@@
 struct legacy_led_args cocci_id@p ;
...
typedef u8;
@@
 struct platform_zone {  u8 location ;  struct device_attribute * attr ;  struct color_platform colors ; } cocci_id@p ;
...
position p;
@@
 struct platform_zone cocci_id@p ;
...
position p;
@@
 struct wmax_brightness_args cocci_id@p ;
...
position p;
@@
 enum INTERFACE_FLAGS { LEGACY , WMAX , } cocci_id@p ;
