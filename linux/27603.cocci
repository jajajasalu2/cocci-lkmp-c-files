...
position p;
@@
 long cocci_id@p ( struct file * filp , unsigned int ioctl , unsigned long arg ) ;
...
position p;
@@
 struct ns_get_path_task_args {  const struct proc_ns_operations * ns_ops ;  struct task_struct * task ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ns_get_path_helper_t;
@@
 ns_get_path_helper_t * cocci_id@p ;
...
position p;
@@
 struct ns_get_path_task_args cocci_id@p ;
...
position p;
@@
 struct ns_common * ( * cocci_id@p ) ( struct ns_common * ns ) ;
