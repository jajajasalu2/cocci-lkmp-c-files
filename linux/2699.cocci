...
symbol cocci_id;
position p;
typedef u16,u_char,uint,wait_queue_head_t,cbd_t,dma_addr_t;
@@
 struct cpm_i2c {  char * base ;  struct platform_device * ofdev ;  struct i2c_adapter adap ;  uint dp_addr ;  int version ;  int irq ;  int cp_command ;  int freq ;  struct i2c_reg __iomem * i2c_reg ;  struct i2c_ram __iomem * i2c_ram ;  u16 i2c_addr ;  wait_queue_head_t i2c_wait ;  cbd_t __iomem * tbase ;  cbd_t __iomem * rbase ;  u_char * txbuf [ CPM_MAXBD ] ;  u_char * rxbuf [ CPM_MAXBD ] ;  dma_addr_t txdma [ CPM_MAXBD ] ;  dma_addr_t rxdma [ CPM_MAXBD ] ; } cocci_id@p ;
...
typedef u_char,uint;
@@
 struct i2c_ram {  ushort rbase ;  ushort tbase ;  u_char rfcr ;  u_char tfcr ;  ushort mrblr ;  uint rstate ;  uint rdp ;  ushort rbptr ;  ushort rbc ;  uint rxtmp ;  uint tstate ;  uint tdp ;  ushort tbptr ;  ushort tbc ;  uint txtmp ;  char res1 [ 4 ] ;  ushort rpbase ;  char res2 [ 2 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct i2c_reg {  u8 i2mod ;  u8 res1 [ 3 ] ;  u8 i2add ;  u8 res2 [ 3 ] ;  u8 i2brg ;  u8 res3 [ 3 ] ;  u8 i2com ;  u8 res4 [ 3 ] ;  u8 i2cer ;  u8 res5 [ 3 ] ;  u8 i2cmr ; } cocci_id@p ;
