...
position p;
@@
 struct pxad_phy {  int idx ;  void __iomem * base ;  struct pxad_chan * vchan ; } cocci_id@p ;
...
position p;
@@
 struct pxad_desc_hw cocci_id@p ;
...
position p;
@@
 struct pxad_desc_sw cocci_id@p ;
...
@@
 struct pxad_desc_sw {  struct virt_dma_desc vd ;  int nb_desc ;  size_t len ;  dma_addr_t first ;  bool misaligned ;  bool cyclic ;  struct dma_pool * desc_pool ;  struct pxad_desc_hw * hw_desc [ ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,wait_queue_head_t,dma_cookie_t;
@@
 struct pxad_chan {  struct virt_dma_chan vc ;  u32 drcmr ;  enum pxad_chan_prio prio ;  bool misaligned ;  struct dma_slave_config cfg ;  struct pxad_phy * phy ;  struct dma_pool * desc_pool ;  dma_cookie_t bus_error ;  wait_queue_head_t wq_state ; } cocci_id@p ;
