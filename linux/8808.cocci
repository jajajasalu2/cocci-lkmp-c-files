...
position p;
@@
 struct ftgmac100_rxdes cocci_id@p ;
...
position p;
@@
 struct ftgmac100_txdes * cocci_id@p ;
...
@@
 struct ftgmac100 {  struct resource * res ;  void __iomem * base ;  unsigned int rx_q_entries ;  struct ftgmac100_rxdes * rxdes ;  dma_addr_t rxdes_dma ;  struct sk_buff * * rx_skbs ;  unsigned int rx_pointer ;  u32 rxdes0_edorr_mask ;  unsigned int tx_q_entries ;  struct ftgmac100_txdes * txdes ;  dma_addr_t txdes_dma ;  struct sk_buff * * tx_skbs ;  unsigned int tx_clean_pointer ;  unsigned int tx_pointer ;  u32 txdes0_edotr_mask ;  unsigned int new_rx_q_entries ;  unsigned int new_tx_q_entries ;  void * rx_scratch ;  dma_addr_t rx_scratch_dma ;  struct net_device * netdev ;  struct device * dev ;  struct ncsi_dev * ndev ;  struct napi_struct napi ;  struct work_struct reset_task ;  struct mii_bus * mii_bus ;  struct clk * clk ;  struct clk * rclk ;  int cur_speed ;  int cur_duplex ;  bool use_ncsi ;  u32 maht0 ;  u32 maht1 ;  bool tx_pause ;  bool rx_pause ;  bool aneg_pause ;  bool need_mac_restart ;  bool is_aspeed ; } cocci_id@p ;
