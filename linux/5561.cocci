...
position p;
@@
 struct mc13xxx_rtc {  struct rtc_device * rtc ;  struct mc13xxx * mc13xxx ;  int valid ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct mc13xxx * mc13xxx , int irq ) ;
