...
position p;
@@
 void cocci_id@p ( struct scc_channel * ) ;
...
position p;
@@
 int cocci_id@p ( const char * name , struct scc_channel * scc ) ;
...
position p;
@@
 void cocci_id@p ( struct scc_channel * , void ( * ) ( struct timer_list * ) , unsigned long ) ;
...
position p;
@@
 struct scc_channel cocci_id@p [ 2 * SCC_MAXCHIPS ] ;
...
position p;
@@
 void cocci_id@p ( struct scc_channel * scc , struct sk_buff * skb ) ;
...
position p;
@@
 struct scc_hw_config cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scc_channel * scc , char tx ) ;
...
position p;
@@
 const struct scc_kiss * cocci_id@p ;
...
position p;
@@
 struct scc_kiss_cmd cocci_id@p ;
...
position p;
@@
 struct scc_mem_config cocci_id@p ;
...
position p;
@@
 struct scc_calibrate cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scc_channel * scc ) ;
...
position p;
@@
 struct irqflags {  unsigned char used : 1 ; } cocci_id@p [ NR_IRQS ] ;
...
position p;
@@
 const struct scc_channel * cocci_id@p ;
...
position p;
@@
 const struct scc_stat * cocci_id@p ;
...
position p;
@@
 struct scc_ctrl {  io_port chan_A ;  io_port chan_B ;  int irq ; } cocci_id@p [ SCC_MAXCHIPS + 1 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ IFNAMSIZ ] ;
