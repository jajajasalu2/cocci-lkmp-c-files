...
symbol cocci_id;
position p;
typedef cvmx_pko_status_t;
@@
 cvmx_pko_status_t cocci_id@p ;
...
@@
 cvmx_cmd_queue_result_t cocci_id@p ;
...
position p;
@@
 union cvmx_pko_reg_cmd_buf cocci_id@p ;
...
position p;
@@
 union cvmx_pko_mem_port_rate0 cocci_id@p ;
...
position p;
@@
 union cvmx_pko_mem_port_rate1 cocci_id@p ;
...
position p;
@@
 union cvmx_pko_mem_iport_ptrs cocci_id@p ;
...
position p;
@@
 union cvmx_pko_reg_flags cocci_id@p ;
...
position p;
@@
 union cvmx_pko_reg_queue_ptrs1 cocci_id@p ;
...
position p;
@@
 union cvmx_pko_mem_queue_ptrs cocci_id@p ;
...
position p;
@@
 union cvmx_pko_mem_iqueue_ptrs cocci_id@p ;
