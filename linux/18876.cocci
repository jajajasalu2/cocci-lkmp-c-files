...
position p;
@@
 void ( * cocci_id@p ) ( unsigned long r0 , unsigned long r1 ) ;
...
position p;
@@
 unsigned int cocci_id@p [ ARM_SLEEP_SAVE_SIZE ] ;
...
position p;
@@
 unsigned int cocci_id@p [ MPUI7XX_SLEEP_SAVE_SIZE ] ;
...
position p;
@@
 unsigned short cocci_id@p [ DSP_SLEEP_SAVE_SIZE ] ;
...
position p;
@@
 unsigned int cocci_id@p [ MPUI1610_SLEEP_SAVE_SIZE ] ;
...
position p;
@@
 unsigned int cocci_id@p [ MPUI1510_SLEEP_SAVE_SIZE ] ;
...
position p;
@@
 unsigned short cocci_id@p [ ULPD_SLEEP_SAVE_SIZE ] ;
