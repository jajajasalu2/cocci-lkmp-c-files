...
position p;
@@
 struct kvm_event_hw_type_mapping cocci_id@p [ ] ;
...
position p;
@@
 enum index { INDEX_ZERO = 0 , INDEX_ONE , INDEX_TWO , INDEX_THREE , INDEX_FOUR , INDEX_FIVE , INDEX_ERROR , } cocci_id@p ;
...
position p;
@@
 enum pmu_type { PMU_TYPE_COUNTER = 0 , PMU_TYPE_EVNTSEL , } cocci_id@p ;
