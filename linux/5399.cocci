...
typedef u8,u16;
@@
 struct spi_st {  void __iomem * base ;  struct clk * clk ;  struct device * dev ;  const u8 * tx_ptr ;  u8 * rx_ptr ;  u16 bytes_per_word ;  unsigned int words_remaining ;  unsigned int baud ;  struct completion done ; } cocci_id@p ;
