...
typedef __le32;
@@
 struct acard_sg {  __le32 addr ;  __le32 addr_hi ;  __le32 reserved ;  __le32 size ; } cocci_id@p ;
...
position p;
@@
 enum board_ids { board_acard_ahci , } cocci_id@p ;
...
position p;
@@
 enum { AHCI_PCI_BAR = 5 , } cocci_id@p ;
