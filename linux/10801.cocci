...
position p;
@@
 struct intel_wm_level * cocci_id@p ;
...
position p;
@@
 struct skl_wm_level * cocci_id@p ;
...
position p;
@@
 const struct intel_watermark_params cocci_id@p ;
...
typedef u16;
@@
 struct ilk_wm_maximums {  u16 pri ;  u16 spr ;  u16 cur ;  u16 fbc ; } cocci_id@p ;
...
position p;
@@
 const struct ilk_wm_maximums * cocci_id@p ;
...
position p;
@@
 const struct intel_wm_level * cocci_id@p ;
...
position p;
@@
 const struct cxsr_latency * cocci_id@p ;
...
position p;
@@
 struct vlv_wm_state * cocci_id@p ;
...
position p;
@@
 const struct g4x_wm_state * cocci_id@p ;
...
position p;
@@
 struct vlv_wm_values cocci_id@p ;
...
position p;
@@
 const struct skl_pipe_wm * cocci_id@p ;
...
position p;
@@
 struct intel_wm_config * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ I915_MAX_PLANES ] ;
...
position p;
@@
 struct ilk_wm_maximums cocci_id@p ;
...
position p;
@@
 struct skl_wm_params cocci_id@p ;
...
position p;
@@
 const struct intel_wm_config cocci_id@p ;
...
position p;
@@
 struct ilk_wm_values * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct intel_crtc_state * crtc_state , int level , const struct skl_wm_params * wp , const struct skl_wm_level * result_prev , struct skl_wm_level * result ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( const struct intel_crtc_state * crtc_state , const struct intel_plane_state * plane_state , u32 pri_val ) ;
...
position p;
@@
 struct g4x_wm_state * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint_fixed_16_16_t;
@@
 uint_fixed_16_16_t cocci_id@p ;
...
position p;
@@
 const struct g4x_pipe_wm * cocci_id@p ;
...
position p;
@@
 const struct vlv_fifo_state * cocci_id@p ;
...
position p;
@@
 const struct skl_plane_wm * cocci_id@p ;
...
position p;
@@
 struct vlv_fifo_state * cocci_id@p ;
...
position p;
@@
 enum intel_ddb_partitioning cocci_id@p ;
...
position p;
@@
 const enum plane_id cocci_id@p ;
...
position p;
@@
 const struct skl_wm_params * cocci_id@p ;
...
position p;
@@
 const struct vlv_wm_values * cocci_id@p ;
...
position p;
@@
 struct intel_pipe_wm cocci_id@p ;
...
position p;
@@
 struct g4x_wm_values * cocci_id@p ;
...
position p;
@@
 const struct skl_ddb_entry * cocci_id@p ;
...
position p;
@@
 const struct vlv_wm_state * cocci_id@p ;
...
position p;
@@
 const struct g4x_wm_values * cocci_id@p ;
...
position p;
@@
 const struct ilk_wm_values * cocci_id@p ;
...
position p;
@@
 const struct skl_wm_level * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ I915_MAX_PLANES ] ;
...
position p;
@@
 const struct intel_pipe_wm * cocci_id@p ;
...
position p;
@@
 struct skl_ddb_values * cocci_id@p ;
...
typedef u64,u32;
@@
 int cocci_id@p ( const struct intel_crtc_state * crtc_state , int width , const struct drm_format_info * format , u64 modifier , unsigned int rotation , u32 plane_pixel_rate , struct skl_wm_params * wp , int color_plane ) ;
