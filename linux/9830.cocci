...
position p;
@@
 struct wmi_set_rf_sector_params_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_get_rf_sector_params_cmd cocci_id@p ;
...
position p;
@@
 enum qca_wlan_vendor_attr_dmg_rf_sector_type { QCA_ATTR_DMG_RF_SECTOR_TYPE_RX , QCA_ATTR_DMG_RF_SECTOR_TYPE_TX , QCA_ATTR_DMG_RF_SECTOR_TYPE_MAX , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct wiphy * wiphy , struct wireless_dev * wdev , const void * data , int data_len ) ;
...
position p;
@@
 struct wmi_ft_reassoc_cmd cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ QCA_ATTR_DMG_RF_SECTOR_CFG_MAX + 1 ] ;
...
position p;
@@
 struct wil_probe_client_req cocci_id@p ;
...
position p;
@@
 struct wmi_set_selected_rf_sector_index_cmd cocci_id@p ;
...
position p;
@@
 const struct cfg80211_ops cocci_id@p ;
...
position p;
@@
 struct ieee80211_vendor_ie * cocci_id@p ;
...
position p;
@@
 enum ieee80211_bss_type cocci_id@p ;
...
position p;
@@
 struct wmi_notify_req_cmd cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ QCA_ATTR_DMG_RF_SECTOR_MAX + 1 ] ;
...
position p;
@@
 struct wmi_ft_auth_cmd cocci_id@p ;
...
position p;
@@
 enum qca_nl80211_vendor_subcmds { QCA_NL80211_VENDOR_SUBCMD_DMG_RF_GET_SECTOR_CFG = 139 , QCA_NL80211_VENDOR_SUBCMD_DMG_RF_SET_SECTOR_CFG = 140 , QCA_NL80211_VENDOR_SUBCMD_DMG_RF_GET_SELECTED_SECTOR = 141 , QCA_NL80211_VENDOR_SUBCMD_DMG_RF_SET_SELECTED_SECTOR = 142 , } cocci_id@p ;
...
position p;
@@
 const struct wil_fw_concurrency_combo * cocci_id@p ;
...
position p;
@@
 enum qca_wlan_vendor_attr_rf_sector { QCA_ATTR_MAC_ADDR = 6 , QCA_ATTR_PAD = 13 , QCA_ATTR_TSF = 29 , QCA_ATTR_DMG_RF_SECTOR_INDEX = 30 , QCA_ATTR_DMG_RF_SECTOR_TYPE = 31 , QCA_ATTR_DMG_RF_MODULE_MASK = 32 , QCA_ATTR_DMG_RF_SECTOR_CFG = 33 , QCA_ATTR_DMG_RF_SECTOR_MAX , } cocci_id@p ;
...
position p;
@@
 struct wil_tid_crypto_rx_single * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ QCA_ATTR_DMG_RF_SECTOR_CFG_MAX + 1 ] ;
...
position p;
@@
 struct wil_fw_concurrency_combo * cocci_id@p ;
...
position p;
@@
 struct wmi_get_selected_rf_sector_index_cmd cocci_id@p ;
...
position p;
@@
 const struct wil_fw_record_concurrency * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ QCA_ATTR_DMG_RF_SECTOR_MAX + 1 ] ;
...
position p;
@@
 const struct wil_fw_concurrency_limit * cocci_id@p ;
...
position p;
@@
 enum wil_rx_cb_mode { WIL_RX_CB_MODE_DMG , WIL_RX_CB_MODE_EDMG , WIL_RX_CB_MODE_WIDE , } cocci_id@p ;
...
position p;
@@
 struct wmi_rf_sector_info * cocci_id@p ;
...
position p;
@@
 const struct {  enum nl80211_iftype nl ;  enum wmi_network_type wmi ; } cocci_id@p [ ] ;
