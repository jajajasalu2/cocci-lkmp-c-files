...
position p;
@@
 struct ucc_hdlc_param cocci_id@p ;
...
position p;
@@
 struct ucc_hdlc_private * cocci_id@p ;
...
position p;
@@
 struct ucc_tdm_info * cocci_id@p ;
...
position p;
@@
 struct ucc_tdm_info cocci_id@p [ MAX_HDLC_NUM ] ;
