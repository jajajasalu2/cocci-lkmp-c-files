...
position p;
@@
 struct sdei_registered_event * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned long function_id , unsigned long arg0 , unsigned long arg1 , unsigned long arg2 , unsigned long arg3 , unsigned long arg4 , struct arm_smccc_res * res ) ;
...
position p;
@@
 struct sdei_crosscall_args * cocci_id@p ;
...
typedef atomic_t;
@@
 struct sdei_crosscall_args {  struct sdei_event * event ;  atomic_t errors ;  int first_error ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct sdei_event {  struct list_head list ;  bool reregister ;  bool reenable ;  u32 event_num ;  u8 type ;  u8 priority ;  union {  struct sdei_registered_event * registered ;  struct sdei_registered_event __percpu * private_registered ; } ; } cocci_id@p ;
...
position p;
@@
 sdei_event_callback * cocci_id@p ;
