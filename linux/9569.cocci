...
position p;
@@
 struct rtw_watch_dog_iter_data {  struct rtw_dev * rtwdev ;  struct rtw_vif * rtwvif ; } cocci_id@p ;
...
position p;
@@
 struct rtw_channel_params * cocci_id@p ;
...
position p;
@@
 struct rtw_watch_dog_iter_data cocci_id@p ;
...
position p;
@@
 struct rtw_rsvd_page * cocci_id@p ;
...
position p;
@@
 struct rtw_fw_state * cocci_id@p ;
...
position p;
@@
 const struct rtw_fw_hdr * cocci_id@p ;
...
position p;
@@
 struct rtw_txq_ba_iter_data { } cocci_id@p ;
...
position p;
@@
 struct rtw_traffic_stats * cocci_id@p ;
