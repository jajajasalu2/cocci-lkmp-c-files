...
position p;
@@
 enum OpalLPCAddressType cocci_id@p ;
...
position p;
@@
 const struct ppc_pci_io cocci_id@p ;
...
position p;
@@
 struct lpc_debugfs_entry {  enum OpalLPCAddressType lpc_type ; } cocci_id@p ;
...
position p;
@@
 struct lpc_debugfs_entry * cocci_id@p ;
