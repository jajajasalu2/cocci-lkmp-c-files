...
position p;
@@
 union set_pixel_clock {  SET_PIXEL_CLOCK_PS_ALLOCATION base ;  PIXEL_CLOCK_PARAMETERS v1 ;  PIXEL_CLOCK_PARAMETERS_V2 v2 ;  PIXEL_CLOCK_PARAMETERS_V3 v3 ;  PIXEL_CLOCK_PARAMETERS_V5 v5 ;  PIXEL_CLOCK_PARAMETERS_V6 v6 ;  PIXEL_CLOCK_PARAMETERS_V7 v7 ; } cocci_id@p ;
...
position p;
@@
 union set_dce_clock {  SET_DCE_CLOCK_PS_ALLOCATION_V1_1 v1_1 ;  SET_DCE_CLOCK_PS_ALLOCATION_V2_1 v2_1 ; } cocci_id@p ;
...
position p;
@@
 union set_dce_clock cocci_id@p ;
...
position p;
@@
 union atom_enable_ss {  ENABLE_SPREAD_SPECTRUM_ON_PPLL_PS_ALLOCATION v1 ;  ENABLE_SPREAD_SPECTRUM_ON_PPLL_V2 v2 ;  ENABLE_SPREAD_SPECTRUM_ON_PPLL_V3 v3 ; } cocci_id@p ;
