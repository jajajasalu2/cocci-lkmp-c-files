...
position p;
@@
 struct xvip_graph_entity cocci_id@p ;
...
position p;
@@
 struct xvip_graph_entity {  struct v4l2_async_subdev asd ;  struct media_entity * entity ;  struct v4l2_subdev * subdev ; } cocci_id@p ;
