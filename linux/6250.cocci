...
position p;
@@
 const int cocci_id@p [ AB8500_NUM_IRQ_REGS ] ;
...
position p;
@@
 const int cocci_id@p [ AB8540_NUM_IRQ_REGS ] ;
...
position p;
@@
 enum ab8500_version cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ AB9540_NUM_IRQ_REGS ] ;
