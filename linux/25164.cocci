...
position p;
@@
 enum cpufreq_write { WRITE_SCALING_MIN_FREQ , WRITE_SCALING_MAX_FREQ , WRITE_SCALING_GOVERNOR , WRITE_SCALING_SET_SPEED , MAX_CPUFREQ_WRITE_FILES , } cocci_id@p ;
...
position p;
@@
 struct cpufreq_frequencies * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ MAX_CPUFREQ_STRING_FILES ] ;
...
position p;
@@
 char cocci_id@p [ SYSFS_PATH_MAX ] ;
...
position p;
@@
 enum cpufreq_string { SCALING_DRIVER , SCALING_GOVERNOR , MAX_CPUFREQ_STRING_FILES , } cocci_id@p ;
...
position p;
@@
 struct cpufreq_available_governors * cocci_id@p ;
...
position p;
@@
 enum cpufreq_string cocci_id@p ;
...
position p;
@@
 struct cpufreq_affected_cpus * cocci_id@p ;
...
position p;
@@
 enum cpufreq_value { CPUINFO_CUR_FREQ , CPUINFO_MIN_FREQ , CPUINFO_MAX_FREQ , CPUINFO_LATENCY , SCALING_CUR_FREQ , SCALING_MIN_FREQ , SCALING_MAX_FREQ , STATS_NUM_TRANSITIONS , MAX_CPUFREQ_VALUE_READ_FILES , } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ MAX_CPUFREQ_VALUE_READ_FILES ] ;
...
position p;
@@
 struct cpufreq_stats * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ MAX_CPUFREQ_WRITE_FILES ] ;
