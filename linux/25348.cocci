...
position p;
@@
 struct test_data_offset cocci_id@p [ ] ;
...
typedef u8,off_t;
@@
 struct test_data_offset {  off_t offset ;  u8 data [ 10 ] ;  int size ; } cocci_id@p ;
