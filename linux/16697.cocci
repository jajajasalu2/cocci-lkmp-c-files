...
typedef bool;
@@
 struct mtk_pmic_keys_info {  struct mtk_pmic_keys * keys ;  const struct mtk_pmic_keys_regs * regs ;  unsigned int keycode ;  int irq ;  bool wakeup : 1 ; } cocci_id@p ;
...
position p;
@@
 struct mtk_pmic_keys * cocci_id@p ;
...
typedef u32;
@@
 struct mtk_pmic_regs {  const struct mtk_pmic_keys_regs keys_regs [ MTK_PMIC_MAX_KEY_COUNT ] ;  u32 pmic_rst_reg ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_pmic_regs cocci_id@p ;
...
position p;
@@
 struct mtk_pmic_keys_info * cocci_id@p ;
...
typedef u32;
@@
 struct mtk_pmic_keys_regs {  u32 deb_reg ;  u32 deb_mask ;  u32 intsel_reg ;  u32 intsel_mask ; } cocci_id@p ;
...
position p;
@@
 enum mtk_pmic_keys_lp_mode { LP_DISABLE , LP_ONEKEY , LP_TWOKEY , } cocci_id@p ;
...
position p;
@@
 struct mtk_pmic_keys {  struct input_dev * input_dev ;  struct device * dev ;  struct regmap * regmap ;  struct mtk_pmic_keys_info keys [ MTK_PMIC_MAX_KEY_COUNT ] ; } cocci_id@p ;
