...
position p;
@@
 void cocci_id@p ( struct amdgpu_sa_bo * sa_bo ) ;
...
position p;
@@
 void cocci_id@p ( struct amdgpu_sa_manager * sa_manager ) ;
...
position p;
@@
 struct amdgpu_sa_manager * cocci_id@p ;
...
position p;
@@
 struct amdgpu_sa_bo * cocci_id@p ;
...
position p;
@@
 struct dma_fence * cocci_id@p [ AMDGPU_SA_NUM_FENCE_LISTS ] ;
...
position p;
@@
 unsigned cocci_id@p [ AMDGPU_SA_NUM_FENCE_LISTS ] ;
