...
position p;
@@
 struct clk_sccg_pll cocci_id@p ;
...
position p;
@@
 struct clk_sccg_pll_setup cocci_id@p ;
...
typedef u8;
@@
 struct clk_sccg_pll {  struct clk_hw hw ;  const struct clk_ops ops ;  void __iomem * base ;  struct clk_sccg_pll_setup setup ;  u8 parent ;  u8 bypass1 ;  u8 bypass2 ; } cocci_id@p ;
