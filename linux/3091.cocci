...
position p;
@@
 void cocci_id@p ( struct pf_unit * pf ) ;
...
position p;
@@
 struct pf_unit {  struct pi_adapter pia ;  struct pi_adapter * pi ;  int removable ;  int media_status ;  int drive ;  int lun ;  int access ;  int present ;  char name [ PF_NAMELEN ] ;  struct gendisk * disk ;  struct blk_mq_tag_set tag_set ;  struct list_head rq_list ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pf_unit * pf ) ;
...
position p;
@@
 void cocci_id@p ( struct pf_unit * pf , int func ) ;
...
position p;
@@
 enum { D_PRT , D_PRO , D_UNI , D_MOD , D_SLV , D_LUN , D_DLY , } cocci_id@p ;
...
position p;
@@
 struct pf_unit cocci_id@p [ PF_UNITS ] ;
