...
position p;
@@
 struct vi_dpm_table * cocci_id@p ;
...
position p;
@@
 struct phm_clock_voltage_dependency_record cocci_id@p ;
...
position p;
@@
 const struct phm_ppt_v1_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct pp_atomctrl_voltage_table * cocci_id@p ;
