...
typedef u32;
@@
 struct qcom_rpm_reg {  struct device * dev ;  struct qcom_smd_rpm * rpm ;  u32 type ;  u32 id ;  struct regulator_desc desc ;  int is_enabled ;  int uV ;  u32 load ;  unsigned int enabled_updated : 1 ;  unsigned int uv_updated : 1 ;  unsigned int load_updated : 1 ; } cocci_id@p ;
...
typedef __le32;
@@
 struct rpm_regulator_req {  __le32 key ;  __le32 nbytes ;  __le32 value ; } cocci_id@p ;
...
typedef u32;
@@
 struct rpm_regulator_data {  const char * name ;  u32 type ;  u32 id ;  const struct regulator_desc * desc ;  const char * supply ; } cocci_id@p ;
...
position p;
@@
 struct regulator_linear_range cocci_id@p [ ] ;
...
position p;
@@
 struct rpm_regulator_req cocci_id@p [ 3 ] ;
