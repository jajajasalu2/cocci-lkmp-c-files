...
position p;
@@
 const struct imxmmc_platform_data cocci_id@p ;
...
position p;
@@
 const struct spi_imx_master cocci_id@p ;
...
position p;
@@
 struct mx3_camera_pdata cocci_id@p ;
...
position p;
@@
 const struct imxi2c_platform_data cocci_id@p ;
...
position p;
@@
 struct imx_ssi_platform_data cocci_id@p ;
...
position p;
@@
 struct mc13xxx_buttons_platform_data cocci_id@p ;
...
position p;
@@
 struct mxc_usbh_platform_data cocci_id@p ;
...
position p;
@@
 struct mc13xxx_platform_data cocci_id@p ;
...
position p;
@@
 struct mc13xxx_codec_platform_data cocci_id@p ;
...
position p;
@@
 struct mc13xxx_leds_platform_data cocci_id@p ;
...
position p;
@@
 struct mc13xxx_regulator_init_data cocci_id@p [ ] ;
...
position p;
@@
 const struct imxuart_platform_data cocci_id@p ;
...
position p;
@@
 struct mc13xxx_led_platform_data cocci_id@p [ ] ;
