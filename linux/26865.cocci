...
position p;
@@
 struct unicode_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tree * , const char * ) ;
...
position p;
@@
 struct unicode_data {  unsigned int code ;  int ccc ;  int gen ;  int correction ;  unsigned int * utf32nfdi ;  unsigned int * utf32nfdicf ;  char * utf8nfdi ;  char * utf8nfdicf ; } cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct tree * , const char * ) ;
...
typedef utf8leaf_t;
@@
 utf8leaf_t * cocci_id@p ( struct tree * , unsigned char * , const char * ) ;
...
position p;
@@
 int cocci_id@p ( struct utf8cursor * , struct tree * , const char * ) ;
...
position p;
@@
 unsigned char cocci_id@p [ UTF8HANGULLEAF ] ;
...
position p;
@@
 struct utf8cursor {  struct tree * tree ;  const char * s ;  const char * p ;  const char * ss ;  const char * sp ;  unsigned int len ;  unsigned int slen ;  short int ccc ;  short int nccc ;  unsigned int unichar ;  unsigned char hangul [ UTF8HANGULLEAF ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct utf8cursor * ) ;
...
position p;
@@
 struct tree {  void * root ;  int childnode ;  const char * type ;  unsigned int maxage ;  struct tree * next ;  int ( * leaf_equal ) ( void * , void * ) ;  void ( * leaf_print ) ( void * , int ) ;  int ( * leaf_mark ) ( void * ) ;  int ( * leaf_size ) ( void * ) ;  int * ( * leaf_index ) ( struct tree * , void * ) ;  unsigned char * ( * leaf_emit ) ( void * , unsigned char * ) ;  int leafindex [ 0x110000 ] ;  int index ; } cocci_id@p ;
...
position p;
@@
 struct unicode_data cocci_id@p [ 0x110000 ] ;
...
position p;
@@
 struct node {  int index ;  int offset ;  int mark ;  int size ;  struct node * parent ;  void * left ;  void * right ;  unsigned char bitnum ;  unsigned char nextbyte ;  unsigned char leftnode ;  unsigned char rightnode ;  unsigned int keybits ;  unsigned int keymask ; } cocci_id@p ;
