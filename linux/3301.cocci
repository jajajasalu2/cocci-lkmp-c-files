...
position p;
@@
 struct max6621_data * cocci_id@p ;
...
position p;
@@
 struct max6621_data {  struct i2c_client * client ;  struct regmap * regmap ;  int input_chan2reg [ MAX6621_TEMP_INPUT_REG_NUM + 1 ] ; } cocci_id@p ;
