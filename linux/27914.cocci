...
position p;
@@
 struct sit_entry_set * cocci_id@p ;
...
position p;
@@
 const struct segment_allocation cocci_id@p ;
...
position p;
@@
 struct discard_cmd_control cocci_id@p ;
...
position p;
@@
 struct dirty_seglist_info * cocci_id@p ;
...
position p;
@@
 struct f2fs_sit_block * cocci_id@p ;
...
position p;
@@
 struct free_segmap_info * cocci_id@p ;
...
position p;
@@
 struct discard_entry cocci_id@p ;
...
position p;
@@
 const struct victim_selection * cocci_id@p ;
...
position p;
@@
 struct f2fs_sit_entry cocci_id@p ;
...
position p;
@@
 struct summary_footer * cocci_id@p ;
...
position p;
@@
 struct discard_policy cocci_id@p ;
...
position p;
@@
 struct flush_cmd_control cocci_id@p ;
...
position p;
@@
 struct discard_info cocci_id@p ;
