...
position p;
@@
 enum lcn_sense_type { B43_SENSE_TEMP , B43_SENSE_VBAT , } cocci_id@p ;
...
position p;
@@
 struct lcn_tx_gains cocci_id@p ;
...
typedef u8,u16;
@@
 struct lcn_tx_iir_filter {  u8 type ;  u16 values [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 enum lcn_sense_type cocci_id@p ;
...
position p;
@@
 struct lcn_tx_iir_filter cocci_id@p [ ] ;
...
typedef u16;
@@
 struct lcn_tx_gains {  u16 gm_gain ;  u16 pga_gain ;  u16 pad_gain ;  u16 dac_gain ; } cocci_id@p ;
