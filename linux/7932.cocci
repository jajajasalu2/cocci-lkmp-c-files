...
position p;
@@
 enum cx82310_cmd { CMD_START = 0x84 , CMD_STOP = 0x85 , CMD_GET_STATUS = 0x90 , CMD_GET_MAC_ADDR = 0x91 , CMD_GET_LINK_STATUS = 0x92 , CMD_ETHERNET_MODE = 0x99 , } cocci_id@p ;
...
position p;
@@
 enum cx82310_status { STATUS_UNDEFINED , STATUS_SUCCESS , STATUS_ERROR , STATUS_UNSUPPORTED , STATUS_UNIMPLEMENTED , STATUS_PARAMETER_ERROR , STATUS_DBG_LOOPBACK , } cocci_id@p ;
