...
typedef u8;
@@
 struct wilc_p2p_mgmt_data {  int size ;  u8 * buff ; } cocci_id@p ;
...
position p;
@@
 struct wilc_p2p_mgmt_data * cocci_id@p ;
...
position p;
@@
 struct wilc_wfi_key * cocci_id@p ;
...
position p;
@@
 struct wilc_wfi_p2p_listen_params * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ WILC_MAX_NUM_SCANNED_CH ] ;
...
position p;
@@
 const struct wilc_hif_func * cocci_id@p ;
