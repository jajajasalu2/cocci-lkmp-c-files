...
position p;
@@
 const union fscrypt_policy * cocci_id@p ;
...
position p;
@@
 union fscrypt_policy * cocci_id@p ;
...
position p;
@@
 union fscrypt_context cocci_id@p ;
...
position p;
@@
 struct fscrypt_context_v2 * cocci_id@p ;
...
position p;
@@
 const struct fscrypt_context_v1 * cocci_id@p ;
...
position p;
@@
 const union fscrypt_context * cocci_id@p ;
...
position p;
@@
 const struct fscrypt_policy_v1 * cocci_id@p ;
...
position p;
@@
 struct fscrypt_policy_v1 * cocci_id@p ;
...
position p;
@@
 struct fscrypt_context_v1 * cocci_id@p ;
...
position p;
@@
 struct fscrypt_get_policy_ex_arg cocci_id@p ;
...
position p;
@@
 const struct fscrypt_policy_v2 * cocci_id@p ;
...
position p;
@@
 const struct fscrypt_context_v2 * cocci_id@p ;
...
position p;
@@
 struct fscrypt_policy_v2 * cocci_id@p ;
