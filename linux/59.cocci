...
position p;
@@
 struct subtitle_part * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const char * title , const char * text , int r , int c ) ;
...
position p;
@@
 struct search_data {  struct list_head * head ;  struct menu * * targets ;  int * keys ; } cocci_id@p ;
...
position p;
@@
 struct subtitle_list * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct menu * menu , struct menu * active_menu ) ;
...
position p;
@@
 struct menu * cocci_id@p [ JUMP_NB ] ;
...
position p;
@@
 void cocci_id@p ( const char * title , const char * text ) ;
...
position p;
@@
 struct subtitle_part {  struct list_head entries ;  const char * text ; } cocci_id@p ;
