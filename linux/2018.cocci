...
position p;
@@
 const struct sca3000_chip_info cocci_id@p [ ] ;
...
position p;
@@
 struct sca3000_state * cocci_id@p ;
...
typedef bool;
@@
 struct sca3000_chip_info {  unsigned int scale ;  bool temp_output ;  int measurement_mode_freq ;  int measurement_mode_3db_freq ;  int option_mode_1 ;  int option_mode_1_freq ;  int option_mode_1_3db_freq ;  int option_mode_2 ;  int option_mode_2_freq ;  int option_mode_2_3db_freq ;  int mot_det_mult_xz [ 6 ] ;  int mot_det_mult_y [ 7 ] ; } cocci_id@p ;
...
position p;
@@
 enum sca3000_variant { d01 , e02 , e04 , e05 , } cocci_id@p ;
...
position p;
@@
 struct spi_transfer cocci_id@p [ 3 ] ;
...
typedef u8,s64;
@@
 struct sca3000_state {  struct spi_device * us ;  const struct sca3000_chip_info * info ;  s64 last_timestamp ;  int mo_det_use_count ;  struct mutex lock ;  u8 rx [ 384 ] ____cacheline_aligned ;  u8 tx [ 6 ] ____cacheline_aligned ; } cocci_id@p ;
