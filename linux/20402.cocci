...
position p;
@@
 union ftrace_op_code_union cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long ip , const unsigned char * old_code , const unsigned char * new_code ) ;
...
position p;
@@
 void cocci_id@p ( unsigned long self_addr , unsigned long * parent , unsigned long frame_pointer ) ;
...
position p;
@@
 unsigned char cocci_id@p [ MCOUNT_INSN_SIZE ] ;
...
position p;
@@
 union ftrace_code_union cocci_id@p ;
