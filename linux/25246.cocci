...
position p;
@@
 struct func_list {  struct func_list * next ;  unsigned long long addr ;  char * func ;  char * mod ; } cocci_id@p ;
...
position p;
@@
 struct func_params {  struct func_params * next ;  enum tep_func_arg_type type ; } cocci_id@p ;
...
position p;
@@
 enum tep_event_type cocci_id@p ;
...
position p;
@@
 struct cmdline_list {  struct cmdline_list * next ;  char * comm ;  int pid ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef tep_func_resolver_t;
@@
 tep_func_resolver_t * cocci_id@p ;
...
position p;
@@
 struct func_map {  unsigned long long addr ;  char * func ;  char * mod ; } cocci_id@p ;
...
position p;
@@
 enum tep_func_arg_type cocci_id@p ;
...
position p;
@@
 enum tep_event_sort_type cocci_id@p ;
...
position p;
@@
 struct tep_print_flag_sym * cocci_id@p ;
...
position p;
@@
 struct printk_list {  struct printk_list * next ;  unsigned long long addr ;  char * printk ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const void * a , const void * b ) ;
...
position p;
@@
 struct cmdline_list * cocci_id@p ;
...
position p;
@@
 struct flag {  const char * name ;  unsigned long long value ; } cocci_id@p ;
...
position p;
@@
 struct print_event_type * cocci_id@p ;
...
typedef tep_func_resolver_t;
@@
 struct func_resolver {  tep_func_resolver_t * func ;  void * priv ;  struct func_map map ; } cocci_id@p ;
...
position p;
@@
 struct printk_map {  unsigned long long addr ;  char * printk ; } cocci_id@p ;
...
position p;
@@
 struct {  const char * type ;  unsigned int size ; } cocci_id@p [ ] ;
...
position p;
@@
 enum tep_event_type cocci_id@p ( struct tep_event * event , struct tep_print_arg * arg , char * * tok , enum tep_event_type type ) ;
...
position p;
@@
 tep_event_handler_func cocci_id@p ;
...
position p;
@@
 struct tep_print_arg cocci_id@p ;
...
position p;
@@
 struct tep_function_handler * * cocci_id@p ;
...
position p;
@@
 struct event_handler * * cocci_id@p ;
...
position p;
@@
 struct tep_event * const * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tep_function_handler * func ) ;
...
position p;
@@
 const struct printk_map * cocci_id@p ;
...
position p;
@@
 struct tep_cmdline {  char * comm ;  int pid ; } cocci_id@p ;
...
position p;
@@
 const struct tep_cmdline * cocci_id@p ;
...
position p;
@@
 struct save_str {  struct save_str * next ;  char * str ; } * cocci_id@p ;
...
position p;
@@
 struct tep_function_handler {  struct tep_function_handler * next ;  enum tep_func_arg_type ret_type ;  char * name ;  tep_func_handler func ;  struct func_params * params ;  int nr_args ; } cocci_id@p ;
...
position p;
@@
 struct tep_format_field * * cocci_id@p ;
...
position p;
@@
 enum tep_event_type cocci_id@p ( struct tep_event * event , struct tep_print_arg * arg , char * * tok ) ;
...
position p;
@@
 struct tep_print_fmt * cocci_id@p ;
...
position p;
@@
 enum tep_event_type cocci_id@p ( const char * str , char * * tok ) ;
...
position p;
@@
 struct event_handler {  struct event_handler * next ;  int id ;  const char * sys_name ;  const char * event_name ;  tep_event_handler_func func ;  void * context ; } cocci_id@p ;
...
position p;
@@
 char * cocci_id@p ( struct tep_print_arg * arg ) ;
...
position p;
@@
 unsigned long long cocci_id@p ( struct trace_seq * s , void * data , int size , struct tep_event * event , struct tep_print_arg * arg ) ;
...
position p;
@@
 struct print_event_type {  enum { EVENT_TYPE_INT = 1 , EVENT_TYPE_STRING , EVENT_TYPE_UNKNOWN , } type ;  char format [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct func_resolver * cocci_id@p ;
...
position p;
@@
 const struct func_map * cocci_id@p ;
...
position p;
@@
 enum tep_print_arg_type cocci_id@p ;
