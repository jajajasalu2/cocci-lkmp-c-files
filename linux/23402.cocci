...
position p;
@@
 struct wm8524_priv {  struct gpio_desc * mute ;  unsigned int sysclk ;  unsigned int rate_constraint_list [ WM8524_NUM_RATES ] ;  struct snd_pcm_hw_constraint_list rate_constraint ; } cocci_id@p ;
...
position p;
@@
 const struct {  int value ;  int ratio ; } cocci_id@p [ WM8524_NUM_RATES ] ;
