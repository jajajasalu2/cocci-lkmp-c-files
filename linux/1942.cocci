...
position p;
@@
 struct abp_config {  int min ;  int max ; } cocci_id@p ;
...
position p;
@@
 struct abp_state {  struct i2c_client * client ;  struct mutex lock ;  int mreq_len ;  int scale ;  int offset ; } cocci_id@p ;
