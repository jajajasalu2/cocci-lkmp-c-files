...
position p;
@@
 struct mvebu_pcie {  struct platform_device * pdev ;  struct mvebu_pcie_port * ports ;  struct msi_controller * msi ;  struct list_head resources ;  struct resource io ;  struct resource realio ;  struct resource mem ;  struct resource busn ;  int nports ; } cocci_id@p ;
...
position p;
@@
 const struct mvebu_pcie_window * cocci_id@p ;
...
position p;
@@
 struct pci_sys_data * cocci_id@p ;
...
position p;
@@
 struct mvebu_pcie_port cocci_id@p ;
...
position p;
@@
 struct mvebu_pcie_window * cocci_id@p ;
...
position p;
@@
 struct pci_bridge_emul_ops cocci_id@p ;
...
position p;
@@
 struct pci_bridge_emul_conf * cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct mvebu_pcie_window {  phys_addr_t base ;  phys_addr_t remap ;  size_t size ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pci_bridge_emul_read_status_t;
@@
 pci_bridge_emul_read_status_t cocci_id@p ;
...
typedef u32;
@@
 struct mvebu_pcie_port {  char * name ;  void __iomem * base ;  u32 port ;  u32 lane ;  int devfn ;  unsigned int mem_target ;  unsigned int mem_attr ;  unsigned int io_target ;  unsigned int io_attr ;  struct clk * clk ;  struct gpio_desc * reset_gpio ;  char * reset_name ;  struct pci_bridge_emul bridge ;  struct device_node * dn ;  struct mvebu_pcie * pcie ;  struct mvebu_pcie_window memwin ;  struct mvebu_pcie_window iowin ;  u32 saved_pcie_stat ; } cocci_id@p ;
...
position p;
@@
 struct pci_bridge_emul * cocci_id@p ;
