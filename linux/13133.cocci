...
position p;
@@
 const struct cvp_priv cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pdev , const struct pci_device_id * dev_id ) ;
...
position p;
@@
 struct altera_cvp_conf * cocci_id@p ;
