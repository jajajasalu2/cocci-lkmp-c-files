...
typedef u8;
@@
 struct brcmf_proto_bcdc_header {  u8 flags ;  u8 priority ;  u8 flags2 ;  u8 data_offset ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_proto_bcdc_dcmd * cocci_id@p ;
...
position p;
@@
 struct brcmf_proto_bcdc_header * cocci_id@p ;
...
typedef u8,u16;
@@
 struct brcmf_bcdc {  u16 reqid ;  u8 bus_header [ BUS_HEADER_LEN ] ;  struct brcmf_proto_bcdc_dcmd msg ;  unsigned char buf [ BRCMF_DCMD_MAXLEN ] ;  struct brcmf_fws_info * fws ; } cocci_id@p ;
...
typedef __le32;
@@
 struct brcmf_proto_bcdc_dcmd {  __le32 cmd ;  __le32 len ;  __le32 flags ;  __le32 status ; } cocci_id@p ;
