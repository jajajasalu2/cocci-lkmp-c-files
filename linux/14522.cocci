...
@@
 struct m10v_clk_divider {  struct clk_hw hw ;  void __iomem * reg ;  u8 shift ;  u8 width ;  u8 flags ;  const struct clk_div_table * table ;  spinlock_t * lock ;  void __iomem * write_valid_reg ; } cocci_id@p ;
...
position p;
@@
 const struct m10v_clk_mux_factors cocci_id@p [ ] ;
...
position p;
@@
 const struct m10v_clk_div_factors * cocci_id@p ;
...
position p;
@@
 const struct m10v_clk_div_fixed_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct m10v_clk_div_factors {  const char * name ;  const char * parent_name ;  u32 offset ;  u8 shift ;  u8 width ;  const struct clk_div_table * table ;  unsigned long div_flags ;  int onecell_idx ; } cocci_id@p ;
...
position p;
@@
 struct m10v_clk_divider * cocci_id@p ;
...
typedef u8;
@@
 struct m10v_clk_div_fixed_data {  const char * name ;  const char * parent_name ;  u8 div ;  u8 mult ;  int onecell_idx ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct m10v_clk_mux_factors {  const char * name ;  const char * const * parent_names ;  u8 num_parents ;  u32 offset ;  u8 shift ;  u8 mask ;  u32 * table ;  unsigned long mux_flags ;  int onecell_idx ; } cocci_id@p ;
