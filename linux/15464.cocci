...
position p;
@@
 struct omap_wdt_dev cocci_id@p ;
...
typedef bool;
@@
 struct omap_wdt_dev {  struct watchdog_device wdog ;  void __iomem * base ;  struct device * dev ;  bool omap_wdt_users ;  int wdt_trgr_pattern ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct omap_wd_timer_platform_data * cocci_id@p ;
