...
position p;
@@
 struct aat2870_regulator * cocci_id@p ;
...
typedef u8;
@@
 struct aat2870_regulator {  struct aat2870_data * aat2870 ;  struct regulator_desc desc ;  u8 enable_addr ;  u8 enable_shift ;  u8 enable_mask ;  u8 voltage_addr ;  u8 voltage_shift ;  u8 voltage_mask ; } cocci_id@p ;
