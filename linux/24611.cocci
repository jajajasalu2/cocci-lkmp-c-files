...
position p;
@@
 struct net_fill_args * cocci_id@p ;
...
position p;
@@
 struct rtnl_net_dump_cb cocci_id@p ;
...
position p;
@@
 struct rtnl_net_dump_cb {  struct net * tgt_net ;  struct net * ref_net ;  struct sk_buff * skb ;  struct net_fill_args fillargs ;  int idx ;  int s_idx ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NETNSA_MAX + 1 ] ;
...
typedef bool,u32;
@@
 struct net_fill_args {  u32 portid ;  u32 seq ;  int flags ;  int cmd ;  int nsid ;  bool add_ref ;  int ref_nsid ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NETNSA_MAX + 1 ] ;
...
position p;
@@
 const struct pernet_operations * cocci_id@p ;
