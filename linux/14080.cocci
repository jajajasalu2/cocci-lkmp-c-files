...
position p;
@@
 struct chain_config * cocci_id@p ;
...
position p;
@@
 struct global_param * cocci_id@p ;
...
position p;
@@
 struct is_param_region * cocci_id@p ;
...
position p;
@@
 struct param_sensor_framerate * cocci_id@p ;
...
position p;
@@
 struct param_global_shotmode * cocci_id@p ;
...
position p;
@@
 struct sensor_param * cocci_id@p ;
