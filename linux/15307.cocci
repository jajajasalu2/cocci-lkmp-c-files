...
position p;
@@
 struct a21_wdt_drv {  struct watchdog_device wdt ;  struct gpio_desc * gpios [ NUM_GPIOS ] ; } cocci_id@p ;
...
position p;
@@
 enum a21_wdt_gpios { GPIO_WD_ENAB , GPIO_WD_FAST , GPIO_WD_TRIG , GPIO_WD_RST0 , GPIO_WD_RST1 , GPIO_WD_RST2 , } cocci_id@p ;
