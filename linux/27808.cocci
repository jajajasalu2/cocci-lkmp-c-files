...
position p;
@@
 struct ocfs2_info_label cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_free_chunk_list * cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_freeinode * cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_uuid cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_journal_size cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_request * cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_freefrag * cocci_id@p ;
...
position p;
@@
 struct ocfs2_new_group_input cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_blocksize cocci_id@p ;
...
position p;
@@
 struct reflink_arguments cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_freefrag_stats * cocci_id@p ;
...
position p;
@@
 struct ocfs2_chain_rec * cocci_id@p ;
...
position p;
@@
 struct ocfs2_space_resv cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_maxslots cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_fs_features cocci_id@p ;
...
position p;
@@
 struct ocfs2_info_clustersize cocci_id@p ;
