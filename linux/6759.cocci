...
position p;
@@
 struct phy_error_log_request * cocci_id@p ;
...
position p;
@@
 struct phy_control_reply cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SmpPassthroughReply_t;
@@
 Mpi2SmpPassthroughReply_t * cocci_id@p ;
...
position p;
@@
 struct phy_error_log_reply * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SasPhyPage1_t;
@@
 Mpi2SasPhyPage1_t cocci_id@p ;
...
typedef u8;
@@
 struct phy_control_reply {  u8 smp_frame_type ;  u8 function ;  u8 function_result ;  u8 response_length ; } cocci_id@p ;
...
typedef u8;
@@
 struct phy_error_log_request {  u8 smp_frame_type ;  u8 function ;  u8 allocated_response_length ;  u8 request_length ;  u8 reserved_1 [ 5 ] ;  u8 phy_identifier ;  u8 reserved_2 [ 2 ] ; } cocci_id@p ;
...
typedef u8,__be32;
@@
 struct phy_error_log_reply {  u8 smp_frame_type ;  u8 function ;  u8 function_result ;  u8 response_length ;  __be16 expander_change_count ;  u8 reserved_1 [ 3 ] ;  u8 phy_identifier ;  u8 reserved_2 [ 2 ] ;  __be32 invalid_dword ;  __be32 running_disparity_error ;  __be32 loss_of_dword_sync ;  __be32 phy_reset_problem ; } cocci_id@p ;
...
position p;
@@
 struct phy_control_request * cocci_id@p ;
...
position p;
@@
 enum sas_device_type cocci_id@p ;
