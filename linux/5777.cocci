...
position p;
@@
 struct arch_timer_mem * cocci_id@p ;
...
position p;
@@
 struct cyclecounter cocci_id@p ;
...
position p;
@@
 struct arch_timer_mem_frame * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ate_match_fn_t;
@@
 ate_match_fn_t cocci_id@p ;
...
position p;
@@
 struct clock_event_device cocci_id@p ;
...
position p;
@@
 struct arch_timer_kvm_info cocci_id@p ;
...
typedef u32;
@@
 struct ate_acpi_oem_info {  char oem_id [ ACPI_OEM_ID_SIZE + 1 ] ;  char oem_table_id [ ACPI_OEM_TABLE_ID_SIZE + 1 ] ;  u32 oem_revision ; } cocci_id@p ;
...
position p;
@@
 struct arch_timer {  void __iomem * base ;  struct clock_event_device evt ; } cocci_id@p ;
...
position p;
@@
 const struct ate_acpi_oem_info cocci_id@p ;
...
position p;
@@
 const struct arch_timer_erratum_workaround * cocci_id@p ;
...
position p;
@@
 enum arch_timer_erratum_match_type cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct arch_timer_erratum_workaround * , const void * ) ;
...
position p;
@@
 enum arch_timer_ppi_nr cocci_id@p ;
...
position p;
@@
 const struct acpi_table_header * cocci_id@p ;
...
position p;
@@
 enum arch_timer_reg cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ ARCH_TIMER_MAX_TIMER_PPI ] ;
...
position p;
@@
 typeof ( clk -> set_next_event ) cocci_id@p ;
...
position p;
@@
 struct ate_acpi_oem_info cocci_id@p [ ] ;
