...
position p;
@@
 struct bo_vm_reservation_context * cocci_id@p ;
...
position p;
@@
 struct kfd_vm_fault_info * cocci_id@p ;
...
position p;
@@
 struct amdgpu_fpriv * cocci_id@p ;
...
position p;
@@
 struct amdgpu_amdkfd_fence * cocci_id@p ;
...
position p;
@@
 struct amdkfd_process_info * cocci_id@p ;
...
position p;
@@
 struct kfd_bo_va_list * * cocci_id@p ;
...
position p;
@@
 struct amdgpu_bo_list_entry cocci_id@p ;
...
@@
 struct amdgpu_vm_parser {  uint32_t domain ;  bool wait ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint64_t,spinlock_t,int64_t;
@@
 struct {  uint64_t max_system_mem_limit ;  uint64_t max_ttm_mem_limit ;  int64_t system_mem_used ;  int64_t ttm_mem_used ;  spinlock_t mem_limit_lock ; } cocci_id@p ;
...
position p;
@@
 struct amdgpu_bo_va * cocci_id@p ;
...
position p;
@@
 struct amdgpu_vm_parser cocci_id@p ;
...
position p;
@@
 struct amdgpu_bo_param cocci_id@p ;
...
position p;
@@
 enum bo_vm_match { BO_VM_NOT_MAPPED = 0 , BO_VM_MAPPED , BO_VM_ALL , } cocci_id@p ;
