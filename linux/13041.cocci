...
typedef bool,u32;
@@
 struct rpi_power_domain {  u32 domain ;  bool enabled ;  bool old_interface ;  struct generic_pm_domain base ;  struct rpi_firmware * fw ; } cocci_id@p ;
...
typedef u32;
@@
 struct rpi_power_domain_packet {  u32 domain ;  u32 on ; } cocci_id@p ;
...
position p;
@@
 struct rpi_power_domain * cocci_id@p ;
...
typedef bool;
@@
 struct rpi_power_domains {  bool has_new_interface ;  struct genpd_onecell_data xlate ;  struct rpi_firmware * fw ;  struct rpi_power_domain domains [ RPI_POWER_DOMAIN_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct rpi_power_domain_packet cocci_id@p ;
...
position p;
@@
 struct rpi_power_domains * cocci_id@p ;
