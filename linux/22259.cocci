...
position p;
@@
 struct percpu_cluster * cocci_id@p ;
...
position p;
@@
 struct swap_cluster_info cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct block_device * , unsigned long ) ;
...
position p;
@@
 struct swap_info_struct * cocci_id@p [ MAX_SWAPFILES ] ;
...
position p;
@@
 struct swap_cluster_list * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct swap_info_struct * ) ;
...
symbol cocci_id;
position p;
typedef swp_entry_t,sector_t;
@@
 sector_t cocci_id@p ( swp_entry_t , struct block_device * * ) ;
