...
position p;
@@
 struct iproc_ts_priv {  struct platform_device * pdev ;  struct input_dev * idev ;  struct regmap * regmap ;  struct clk * tsc_clk ;  int pen_status ;  struct tsc_param cfg_params ; } cocci_id@p ;
...
position p;
@@
 struct iproc_ts_priv * cocci_id@p ;
...
position p;
@@
 const struct tsc_param cocci_id@p ;
...
typedef bool,u32;
@@
 struct tsc_param {  u32 scanning_period ;  u32 debounce_timeout ;  u32 settling_timeout ;  u32 touch_timeout ;  u32 average_data ;  u32 fifo_threshold ;  u32 max_x ;  u32 max_y ;  u32 fuzz_x ;  u32 fuzz_y ;  bool invert_x ;  bool invert_y ; } cocci_id@p ;
