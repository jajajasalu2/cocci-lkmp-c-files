...
position p;
@@
 struct si2165_state * cocci_id@p ;
...
typedef u8,u16;
@@
 struct si2165_reg_value_pair {  u16 reg ;  u8 val ; } cocci_id@p ;
...
@@
 struct si2165_state {  struct i2c_client * client ;  struct regmap * regmap ;  struct dvb_frontend fe ;  struct si2165_config config ;  u8 chip_revcode ;  u8 chip_type ;  u32 fvco_hz ;  u32 sys_clk ;  u32 adc_clk ;  u64 ber_prev ;  bool has_dvbc ;  bool has_dvbt ;  bool firmware_loaded ; } cocci_id@p ;
...
position p;
@@
 const struct si2165_reg_value_pair cocci_id@p [ ] ;
