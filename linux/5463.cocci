...
@@
 struct at91_usart_spi {  struct platform_device * mpdev ;  struct spi_transfer * current_transfer ;  void __iomem * regs ;  struct device * dev ;  struct clk * clk ;  struct completion xfer_completion ;  spinlock_t lock ;  phys_addr_t phybase ;  int irq ;  unsigned int current_tx_remaining_bytes ;  unsigned int current_rx_remaining_bytes ;  u32 spi_clk ;  u32 status ;  bool xfer_failed ;  bool use_dma ; } cocci_id@p ;
...
position p;
@@
 struct at91_usart_spi * cocci_id@p ;
...
position p;
@@
 struct at91_usart_spi_device * cocci_id@p ;
