...
position p;
@@
 enum rdma_class_port_info_type { RDMA_CLASS_PORT_INFO_IB , RDMA_CLASS_PORT_INFO_OPA , } cocci_id@p ;
...
position p;
@@
 struct ib_sa_path_query * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ LS_NLA_TYPE_MAX ] ;
...
position p;
@@
 struct ib_classport_info_context * cocci_id@p ;
...
position p;
@@
 struct ib_sa_classport_cache * cocci_id@p ;
...
position p;
@@
 struct rdma_nla_ls_gid cocci_id@p ;
...
@@
 struct ib_sa_port {  struct ib_mad_agent * agent ;  struct ib_sa_sm_ah * sm_ah ;  struct work_struct update_task ;  struct ib_sa_classport_cache classport_info ;  struct delayed_work ib_cpi_work ;  spinlock_t classport_lock ;  spinlock_t ah_lock ;  u8 port_num ; } cocci_id@p ;
...
position p;
@@
 struct ib_sa_service_query cocci_id@p ;
...
position p;
@@
 enum opa_pr_supported cocci_id@p ;
...
position p;
@@
 struct ib_sa_guidinfo_rec * cocci_id@p ;
...
position p;
@@
 enum opa_pr_supported { PR_NOT_SUPPORTED , PR_OPA_SUPPORTED , PR_IB_SUPPORTED , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( int status , struct ib_sa_mcmember_rec * resp , void * context ) ;
...
position p;
@@
 struct ib_sa_service_rec cocci_id@p ;
...
position p;
@@
 struct ib_classport_info_context {  struct completion done ;  struct ib_sa_query * sa_query ; } cocci_id@p ;
...
position p;
@@
 struct rdma_ls_resolve_header cocci_id@p ;
...
position p;
@@
 const struct ib_field cocci_id@p [ ] ;
...
position p;
@@
 struct ib_sa_mcmember_query * cocci_id@p ;
...
position p;
@@
 struct ib_path_rec_data cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( int status , struct ib_sa_service_rec * resp , void * context ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( int status , struct ib_sa_guidinfo_rec * resp , void * context ) ;
...
position p;
@@
 struct rdma_class_port_info {  enum rdma_class_port_info_type type ;  union {  struct ib_class_port_info ib ;  struct opa_class_port_info opa ; } ; } cocci_id@p ;
...
position p;
@@
 struct ib_sa_device * cocci_id@p ;
...
typedef u8,u16;
@@
 struct ib_sa_sm_ah {  struct ib_ah * ah ;  struct kref ref ;  u16 pkey_index ;  u8 src_path_mask ; } cocci_id@p ;
...
position p;
@@
 struct ib_sa_classport_info_query * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ib_mad_agent * agent , struct ib_mad_send_wc * mad_send_wc ) ;
...
position p;
@@
 struct ib_event_handler * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( int status , struct sa_path_rec * resp , void * context ) ;
...
position p;
@@
 struct ib_sa_guidinfo_query cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ LS_NLA_TYPE_MAX ] ;
...
typedef bool;
@@
 struct ib_sa_classport_cache {  bool valid ;  int retry_cnt ;  struct rdma_class_port_info data ; } cocci_id@p ;
...
position p;
@@
 struct ib_sa_classport_info_query {  void ( * callback ) ( void * ) ;  void * context ;  struct ib_sa_query sa_query ; } cocci_id@p ;
