...
position p;
@@
 struct usb_8dev_rx_msg * cocci_id@p ;
...
position p;
@@
 struct usb_8dev_tx_msg * cocci_id@p ;
...
position p;
@@
 struct usb_8dev_cmd_msg cocci_id@p ;
...
position p;
@@
 struct usb_8dev_priv * cocci_id@p ;
...
position p;
@@
 enum usb_8dev_cmd { USB_8DEV_RESET = 1 , USB_8DEV_OPEN , USB_8DEV_CLOSE , USB_8DEV_SET_SPEED , USB_8DEV_SET_MASK_FILTER , USB_8DEV_GET_STATUS , USB_8DEV_GET_STATISTICS , USB_8DEV_GET_SERIAL , USB_8DEV_GET_SOFTW_VER , USB_8DEV_GET_HARDW_VER , USB_8DEV_RESET_TIMESTAMP , USB_8DEV_GET_SOFTW_HARDW_VER , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct usb_8dev_tx_urb_context {  struct usb_8dev_priv * priv ;  u32 echo_index ;  u8 dlc ; } cocci_id@p ;
...
position p;
@@
 struct usb_8dev_tx_urb_context * cocci_id@p ;
...
typedef u8;
@@
 struct __packed usb_8dev_cmd_msg {  u8 begin ;  u8 channel ;  u8 command ;  u8 opt1 ;  u8 opt2 ;  u8 data [ 10 ] ;  u8 end ; } cocci_id@p ;
...
position p;
@@
 enum usb_8dev_endpoint { USB_8DEV_ENDP_DATA_RX = 1 , USB_8DEV_ENDP_DATA_TX , USB_8DEV_ENDP_CMD_RX , USB_8DEV_ENDP_CMD_TX , } cocci_id@p ;
...
typedef u8,__be32;
@@
 struct __packed usb_8dev_rx_msg {  u8 begin ;  u8 type ;  u8 flags ;  __be32 id ;  u8 dlc ;  u8 data [ 8 ] ;  __be32 timestamp ;  u8 end ; } cocci_id@p ;
...
typedef u8,__be32;
@@
 struct __packed usb_8dev_tx_msg {  u8 begin ;  u8 flags ;  __be32 id ;  u8 dlc ;  u8 data [ 8 ] ;  u8 end ; } cocci_id@p ;
