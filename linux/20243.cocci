...
position p;
@@
 struct el_CIA_sysdata_mcheck * cocci_id@p ;
...
position p;
@@
 struct pci_iommu_arena * cocci_id@p ;
...
position p;
@@
 struct {  unsigned int hae_mem ;  unsigned int hae_io ;  unsigned int pci_dac_offset ;  unsigned int err_mask ;  unsigned int cia_ctrl ;  unsigned int cia_cnfg ;  struct {  unsigned int w_base ;  unsigned int w_mask ;  unsigned int t_base ; } window [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 64 ] ;
