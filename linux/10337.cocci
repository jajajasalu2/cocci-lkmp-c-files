...
symbol cocci_id;
position p;
typedef drm_mga_getparam32_t;
@@
 drm_mga_getparam32_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_mga_dma_bootstrap32_t;
@@
 drm_mga_dma_bootstrap32_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_mga_init32_t;
@@
 drm_mga_init32_t cocci_id@p ;
...
typedef u32;
@@
 struct drm_mga_getparam32 {  int param ;  u32 value ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct drm_mga_drm_bootstrap32 {  u32 texture_handle ;  u32 texture_size ;  u32 primary_size ;  u32 secondary_bin_count ;  u32 secondary_bin_size ;  u32 agp_mode ;  u8 agp_size ; } cocci_id@p ;
