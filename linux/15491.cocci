...
position p;
@@
 struct microread_info cocci_id@p ;
...
@@
 struct microread_info {  struct nfc_phy_ops * phy_ops ;  void * phy_id ;  struct nfc_hci_dev * hdev ;  int async_cb_type ;  data_exchange_cb_t async_cb ;  void * async_cb_context ; } cocci_id@p ;
