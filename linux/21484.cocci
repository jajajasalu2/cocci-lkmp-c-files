...
typedef u8,u32;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , u32 cbytes , const u32 rk [ ] , u32 rounds , u8 mac [ ] , u8 ctr [ ] ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 mac [ ] , const u8 in [ ] , u32 abytes , u32 * macp , const u32 rk [ ] , u32 rounds ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 mac [ ] , const u8 ctr [ ] , const u32 rk [ ] , u32 rounds ) ;
...
typedef u16,__be32;
@@
 struct __packed {  __be16 l ;  __be32 h ;  u16 len ; } cocci_id@p ;
