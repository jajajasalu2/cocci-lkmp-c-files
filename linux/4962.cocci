...
position p;
@@
 struct qib_user_sdma_pkt * cocci_id@p ;
...
position p;
@@
 const struct qib_user_sdma_queue * cocci_id@p ;
...
position p;
@@
 struct qib_user_sdma_queue * cocci_id@p ;
...
position p;
@@
 struct qib_user_sdma_rb_node * cocci_id@p ;
...
position p;
@@
 struct qib_tid_session_member cocci_id@p ;
...
@@
 struct qib_user_sdma_queue {  struct list_head sent ;  spinlock_t sent_lock ____cacheline_aligned_in_smp ;  char header_cache_name [ 64 ] ;  struct dma_pool * header_cache ;  char pkt_slab_name [ 64 ] ;  struct kmem_cache * pkt_slab ;  u32 counter ;  u32 sent_counter ;  u32 num_pending ;  u32 num_sending ;  u64 added ;  struct rb_root dma_pages_root ;  struct qib_user_sdma_rb_node * sdma_rb_node ;  struct mutex lock ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,u32,u16,dma_addr_t;
@@
 struct qib_user_sdma_pkt {  struct list_head list ;  u8 tiddma ;  u8 largepkt ;  u16 frag_size ;  u16 index ;  u16 naddr ;  u16 addrlimit ;  u16 tidsmidx ;  u16 tidsmcount ;  u16 payload_size ;  u32 bytes_togo ;  u32 counter ;  struct qib_tid_session_member * tidsm ;  struct qib_user_sdma_queue * pq ;  u64 added ;  struct {  u16 offset ;  u16 length ;  u16 first_desc ;  u16 last_desc ;  u16 put_page ;  u16 dma_mapped ;  u16 dma_length ;  u16 padding ;  struct page * page ;  void * kvaddr ;  dma_addr_t addr ; } addr [ 4 ] ; } cocci_id@p ;
...
typedef pid_t;
@@
 struct qib_user_sdma_rb_node {  struct rb_node node ;  int refcount ;  pid_t pid ; } cocci_id@p ;
