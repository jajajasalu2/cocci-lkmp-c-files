...
position p;
@@
 enum chips { smm465 , smm665 , smm665c , smm764 , smm766 , } cocci_id@p ;
...
typedef bool,u16;
@@
 struct smm665_data {  enum chips type ;  int conversion_time ;  struct i2c_client * client ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  u16 adc [ SMM665_NUM_ADC ] ;  u16 faults ;  int critical_min_limit [ SMM665_NUM_ADC ] ;  int alarm_min_limit [ SMM665_NUM_ADC ] ;  int critical_max_limit [ SMM665_NUM_ADC ] ;  int alarm_max_limit [ SMM665_NUM_ADC ] ;  struct i2c_client * cmdreg ; } cocci_id@p ;
