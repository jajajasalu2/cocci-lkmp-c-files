...
position p;
@@
 struct mep {  struct rb_node nd ;  const char * name ;  struct strlist * metrics ; } cocci_id@p ;
...
position p;
@@
 struct egroup {  struct list_head nd ;  int idnum ;  const char * * ids ;  const char * metric_name ;  const char * metric_expr ;  const char * metric_unit ; } cocci_id@p ;
...
position p;
@@
 const struct metric_event * cocci_id@p ;
