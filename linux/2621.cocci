...
position p;
@@
 struct idtcm_channel * cocci_id@p ;
...
position p;
@@
 enum hw_tod_write_trig_sel cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ TOD_BYTE_COUNT ] ;
