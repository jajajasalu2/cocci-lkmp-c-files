...
position p;
@@
 struct carl9170fw_desc_head * cocci_id@p ;
...
position p;
@@
 const struct carl9170fw_otus_desc * cocci_id@p ;
...
position p;
@@
 const struct carl9170fw_motd_desc * cocci_id@p ;
...
position p;
@@
 const struct carl9170fw_txsq_desc * cocci_id@p ;
...
position p;
@@
 const struct carl9170fw_last_desc * cocci_id@p ;
...
position p;
@@
 const struct carl9170fw_chk_desc * cocci_id@p ;
...
position p;
@@
 const struct carl9170fw_desc_head * cocci_id@p ;
