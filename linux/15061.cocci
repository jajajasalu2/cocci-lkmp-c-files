...
position p;
@@
 const struct frac_entry cocci_id@p [ ] ;
...
position p;
@@
 struct frac_entry {  int num ;  int den ; } cocci_id@p ;
...
position p;
@@
 enum freq_policy { FLOOR , CEIL , } cocci_id@p ;
