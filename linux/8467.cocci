...
position p;
@@
 unsigned short ( * cocci_id@p ) ( void * ) ;
...
position p;
@@
 void cocci_id@p ( struct lance_private * lp , unsigned short value ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * , unsigned short ) ;
...
position p;
@@
 struct m147lance_private * cocci_id@p ;
...
position p;
@@
 unsigned short cocci_id@p ( struct lance_private * lp ) ;
...
position p;
@@
 struct m147lance_private {  struct lance_private lance ;  unsigned long ram ; } cocci_id@p ;
