...
typedef bool;
@@
 struct kingdisplay_panel {  struct drm_panel base ;  struct mipi_dsi_device * link ;  struct backlight_device * backlight ;  struct regulator * supply ;  struct gpio_desc * enable_gpio ;  bool prepared ;  bool enabled ; } cocci_id@p ;
...
position p;
@@
 struct kingdisplay_panel * cocci_id@p ;
...
position p;
@@
 struct kingdisplay_panel_cmd {  char cmd ;  char data ; } cocci_id@p ;
...
position p;
@@
 struct kingdisplay_panel_cmd cocci_id@p ;
...
position p;
@@
 const struct kingdisplay_panel_cmd cocci_id@p [ ] ;
