...
position p;
@@
 const struct ti_temp_sensor * cocci_id@p ;
...
typedef bool;
@@
 struct ti_thermal_data {  struct cpufreq_policy * policy ;  struct thermal_zone_device * ti_thermal ;  struct thermal_zone_device * pcb_tz ;  struct thermal_cooling_device * cool_dev ;  struct ti_bandgap * bgp ;  enum thermal_device_mode mode ;  struct work_struct thermal_wq ;  int sensor_id ;  bool our_zone ; } cocci_id@p ;
...
position p;
@@
 struct ti_thermal_data cocci_id@p ;
