...
position p;
@@
 struct {  struct nvif_ioctl_v0 ioctl ;  struct nvif_ioctl_ntfy_put_v0 ntfy ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nvif_ioctl_v0 ioctl ;  struct nvif_ioctl_ntfy_new_v0 ntfy ;  struct nvif_notify_req_v0 req ; } * cocci_id@p ;
...
position p;
@@
 struct {  struct nvif_ioctl_v0 ioctl ;  struct nvif_ioctl_ntfy_del_v0 ntfy ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct nvif_notify * ) ;
...
position p;
@@
 struct {  struct nvif_ioctl_v0 ioctl ;  struct nvif_ioctl_ntfy_get_v0 ntfy ; } cocci_id@p ;
