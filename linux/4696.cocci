...
position p;
@@
 struct idt_89hpesx_dev cocci_id@p ;
...
@@
 struct idt_89hpesx_dev {  u32 eesize ;  bool eero ;  u8 eeaddr ;  u8 inieecmd ;  u8 inicsrcmd ;  u8 iniccode ;  u16 csr ;  int ( * smb_write ) ( struct idt_89hpesx_dev * , const struct idt_smb_seq * ) ;  int ( * smb_read ) ( struct idt_89hpesx_dev * , struct idt_smb_seq * ) ;  struct mutex smb_mtx ;  struct i2c_client * client ;  struct bin_attribute * ee_file ;  struct dentry * csr_dir ; } cocci_id@p ;
...
typedef u8;
@@
 struct idt_smb_seq {  u8 ccode ;  u8 bytecnt ;  u8 * data ; } cocci_id@p ;
...
position p;
@@
 struct idt_eeprom_seq cocci_id@p ;
...
position p;
@@
 const struct idt_smb_seq * cocci_id@p ;
