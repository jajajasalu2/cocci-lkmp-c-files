...
position p;
@@
 struct gnttab_query_size cocci_id@p ;
...
position p;
@@
 struct deferred_entry cocci_id@p ;
...
position p;
@@
 struct gnttab_set_version cocci_id@p ;
...
position p;
@@
 struct gnttab_free_callback * * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xen_grant_fn_t;
@@
 xen_grant_fn_t cocci_id@p ;
...
position p;
@@
 struct xen_add_to_physmap cocci_id@p ;
...
position p;
@@
 union {  struct grant_entry_v1 * v1 ;  union grant_entry_v2 * v2 ;  void * addr ; } cocci_id@p ;
...
position p;
@@
 const struct gnttab_ops * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,uint16_t,grant_ref_t;
@@
 struct deferred_entry {  struct list_head list ;  grant_ref_t ref ;  bool ro ;  uint16_t warn_delay ;  struct page * page ; } cocci_id@p ;
...
position p;
@@
 struct grant_frames cocci_id@p ;
...
position p;
@@
 struct unmap_refs_callback_data {  struct completion completion ;  int result ; } cocci_id@p ;
...
position p;
@@
 struct gnttab_dma_alloc_args * cocci_id@p ;
...
position p;
@@
 struct grant_entry_v1 cocci_id@p ;
...
position p;
@@
 struct gnttab_setup_table cocci_id@p ;
...
position p;
@@
 struct unmap_refs_callback_data cocci_id@p ;
...
position p;
@@
 struct gnttab_get_status_frames cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned int req_entries ) ;
...
position p;
@@
 union grant_entry_v2 cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gntab_unmap_queue_data * item ) ;
...
position p;
@@
 struct xen_page_foreign * cocci_id@p ;
