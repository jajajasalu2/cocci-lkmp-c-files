...
position p;
@@
 void cocci_id@p ( void * dst , void * src ) ;
...
typedef u8;
@@
 struct aes_block {  u8 b [ AES_BLOCK_SIZE ] ; } cocci_id@p ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u32 rk1 [ ] , int rounds , int bytes , u8 iv [ ] , const u32 rk2 [ ] , int first ) ;
