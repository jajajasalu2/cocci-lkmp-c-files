...
position p;
@@
 struct hi3660_stub_clk cocci_id@p [ HI3660_CLK_STUB_NUM ] ;
...
position p;
@@
 struct hi3660_stub_clk {  unsigned int id ;  struct clk_hw hw ;  unsigned int cmd ;  unsigned int msg [ 8 ] ;  unsigned int rate ; } cocci_id@p ;
...
position p;
@@
 struct hi3660_stub_clk * cocci_id@p ;
...
position p;
@@
 struct hi3660_stub_clk_chan {  struct mbox_client cl ;  struct mbox_chan * mbox ; } cocci_id@p ;
...
position p;
@@
 struct hi3660_stub_clk_chan cocci_id@p ;
