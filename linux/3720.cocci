...
typedef dma_addr_t;
@@
 struct adf_admin_comms {  dma_addr_t phy_addr ;  dma_addr_t const_tbl_addr ;  void * virt_addr ;  void * virt_tbl_addr ;  void __iomem * mailbox_addr ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct adf_admin_comms * cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_init_admin_req cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_init_admin_resp cocci_id@p ;
