...
position p;
@@
 struct palmas_gpio {  struct gpio_chip gpio_chip ;  struct palmas * palmas ; } cocci_id@p ;
...
position p;
@@
 struct palmas_device_data {  int ngpio ; } cocci_id@p ;
...
position p;
@@
 const struct palmas_device_data cocci_id@p ;
