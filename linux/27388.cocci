...
position p;
@@
 struct squashfs_page_actor * cocci_id@p ;
...
position p;
@@
 struct squashfs_xz {  struct xz_dec * state ;  struct xz_buf buf ; } cocci_id@p ;
...
position p;
@@
 const struct squashfs_decompressor cocci_id@p ;
...
position p;
@@
 struct disk_comp_opts * cocci_id@p ;
...
typedef __le32;
@@
 struct disk_comp_opts {  __le32 dictionary_size ;  __le32 flags ; } cocci_id@p ;
...
position p;
@@
 struct comp_opts {  int dict_size ; } cocci_id@p ;
