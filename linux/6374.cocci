...
position p;
@@
 struct bd718xx_pmic_inits {  const struct bd718xx_regulator_data * r_datas ;  unsigned int r_amount ; } cocci_id@p ;
...
position p;
@@
 struct of_dvs_setting {  const char * prop ;  unsigned int reg ; } cocci_id@p ;
...
position p;
@@
 const struct bd718xx_regulator_data cocci_id@p [ ] ;
...
position p;
@@
 struct reg_init {  unsigned int reg ;  unsigned int mask ;  unsigned int val ; } cocci_id@p ;
...
position p;
@@
 struct bd718xx_regulator_data {  struct regulator_desc desc ;  const struct reg_init init ;  const struct reg_init * additional_inits ;  int additional_init_amnt ; } cocci_id@p ;
...
position p;
@@
 const struct of_dvs_setting cocci_id@p [ ] ;
...
position p;
@@
 struct bd718xx_pmic_inits cocci_id@p [ ROHM_CHIP_TYPE_AMOUNT ] ;
...
position p;
@@
 const struct reg_init cocci_id@p [ ] ;
