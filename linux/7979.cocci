...
position p;
@@
 struct xen_netif_rx_back_ring * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct backend_info * be ) ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "io_ring_q" ) + 4 ] ;
...
position p;
@@
 struct xen_netif_tx_back_ring * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct backend_info * be , enum xenbus_state state ) ;
...
position p;
@@
 int cocci_id@p ( struct backend_info * be , struct xenvif_queue * queue ) ;
...
position p;
@@
 void cocci_id@p ( struct backend_info * be ) ;
...
position p;
@@
 void cocci_id@p ( struct xenvif * vif ) ;
