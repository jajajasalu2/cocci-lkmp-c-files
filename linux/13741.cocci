...
position p;
@@
 struct saa6752hs_state cocci_id@p ;
...
typedef __u16,__u32;
@@
 struct saa6752hs_mpeg_params {  __u16 ts_pid_pmt ;  __u16 ts_pid_audio ;  __u16 ts_pid_video ;  __u16 ts_pid_pcr ;  enum v4l2_mpeg_audio_encoding au_encoding ;  enum v4l2_mpeg_audio_l2_bitrate au_l2_bitrate ;  enum v4l2_mpeg_audio_ac3_bitrate au_ac3_bitrate ;  enum v4l2_mpeg_video_aspect vi_aspect ;  enum v4l2_mpeg_video_bitrate_mode vi_bitrate_mode ;  __u32 vi_bitrate ;  __u32 vi_bitrate_peak ; } cocci_id@p ;
...
position p;
@@
 const struct saa6752hs_mpeg_params cocci_id@p ;
...
typedef u32;
@@
 struct saa6752hs_state {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  struct {  struct v4l2_ctrl * video_bitrate_mode ;  struct v4l2_ctrl * video_bitrate ;  struct v4l2_ctrl * video_bitrate_peak ; } ;  u32 revision ;  int has_ac3 ;  struct saa6752hs_mpeg_params params ;  enum saa6752hs_videoformat video_format ;  v4l2_std_id standard ; } cocci_id@p ;
...
position p;
@@
 enum saa6752hs_videoformat { SAA6752HS_VF_D1 = 0 , SAA6752HS_VF_2_3_D1 = 1 , SAA6752HS_VF_1_2_D1 = 2 , SAA6752HS_VF_SIF = 3 , SAA6752HS_VF_UNKNOWN , } cocci_id@p ;
...
position p;
@@
 enum saa6752hs_command cocci_id@p ;
...
position p;
@@
 enum saa6752hs_command { SAA6752HS_COMMAND_RESET = 0 , SAA6752HS_COMMAND_STOP = 1 , SAA6752HS_COMMAND_START = 2 , SAA6752HS_COMMAND_PAUSE = 3 , SAA6752HS_COMMAND_RECONFIGURE = 4 , SAA6752HS_COMMAND_SLEEP = 5 , SAA6752HS_COMMAND_RECONFIGURE_FORCE = 6 , SAA6752HS_COMMAND_MAX , } cocci_id@p ;
...
position p;
@@
 struct saa6752hs_mpeg_params * cocci_id@p ;
