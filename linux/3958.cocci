...
position p;
@@
 struct lantiq_rcu_reset_priv * cocci_id@p ;
...
typedef u32;
@@
 struct lantiq_rcu_reset_priv {  struct reset_controller_dev rcdev ;  struct device * dev ;  struct regmap * regmap ;  u32 reset_offset ;  u32 status_offset ; } cocci_id@p ;
