...
position p;
@@
 struct nx842_crypto_ctx cocci_id@p ;
...
position p;
@@
 struct nx842_scatterlist {  int entry_nr ;  struct nx842_slentry * entries ; } cocci_id@p ;
...
position p;
@@
 const struct nx842_devdata * cocci_id@p ;
...
typedef atomic64_t;
@@
 struct ibm_nx842_counters {  atomic64_t comp_complete ;  atomic64_t comp_failed ;  atomic64_t decomp_complete ;  atomic64_t decomp_failed ;  atomic64_t swdecomp ;  atomic64_t comp_times [ 32 ] ;  atomic64_t decomp_times [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct nx842_scatterlist cocci_id@p ;
...
position p;
@@
 struct nx842_devdata * cocci_id@p ;
...
position p;
@@
 struct nx842_workmem * cocci_id@p ;
...
position p;
@@
 struct nx842_slentry cocci_id@p ;
...
position p;
@@
 struct cop_status_block * cocci_id@p ;
...
position p;
@@
 struct nx842_constraints cocci_id@p ;
...
typedef __be64;
@@
 struct nx842_slentry {  __be64 ptr ;  __be64 len ; } cocci_id@p ;
...
position p;
@@
 struct nx842_driver cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __be32,maxsynccop_t;
@@
 const struct maxsynccop_t {  __be32 comp_elements ;  __be32 comp_data_limit ;  __be32 comp_sg_limit ;  __be32 decomp_elements ;  __be32 decomp_data_limit ;  __be32 decomp_sg_limit ; } * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef maxsynccop_t;
@@
 const struct maxsynccop_t * cocci_id@p ;
