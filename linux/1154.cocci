...
position p;
@@
 struct cpufreq_acpi_io * cocci_id@p ;
...
position p;
@@
 struct cpufreq_acpi_req * cocci_id@p ;
...
position p;
@@
 struct cpufreq_acpi_io {  struct acpi_processor_performance acpi_data ;  unsigned int resume ; } cocci_id@p ;
...
position p;
@@
 struct cpufreq_acpi_req {  unsigned int cpu ;  unsigned int state ; } cocci_id@p ;
...
position p;
@@
 struct cpufreq_acpi_io * cocci_id@p [ NR_CPUS ] ;
