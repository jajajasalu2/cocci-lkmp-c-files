...
position p;
@@
 struct sh_keysc_priv {  void __iomem * iomem_base ; 
	 DECLARE_BITMAP ( last_keys , SH_KEYSC_MAXKEYS ) 
		 ;  struct input_dev * input ;  struct sh_keysc_info pdata ; } cocci_id@p ;
...
position p;
@@
 struct sh_keysc_priv * cocci_id@p ;
...
position p;
@@
 const struct {  unsigned char kymd , keyout , keyin ; } cocci_id@p [ ] ;
