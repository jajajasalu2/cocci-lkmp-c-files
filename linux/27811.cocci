...
position p;
@@
 union ocfs2_control_message {  char tag [ OCFS2_CONTROL_MESSAGE_OP_LEN ] ;  struct ocfs2_control_message_setn u_setn ;  struct ocfs2_control_message_setv u_setv ;  struct ocfs2_control_message_down u_down ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_control_message_down * cocci_id@p ;
...
position p;
@@
 struct ocfs2_control_message_setv {  char tag [ OCFS2_CONTROL_MESSAGE_OP_LEN ] ;  char space1 ;  char major [ OCFS2_CONTROL_MESSAGE_VERNUM_LEN ] ;  char space2 ;  char minor [ OCFS2_CONTROL_MESSAGE_VERNUM_LEN ] ;  char newline ; } cocci_id@p ;
...
@@
 struct ocfs2_live_connection {  struct list_head oc_list ;  struct ocfs2_cluster_connection * oc_conn ;  enum ocfs2_connection_type oc_type ;  atomic_t oc_this_node ;  int oc_our_slot ;  struct dlm_lksb oc_version_lksb ;  char oc_lvb [ DLM_LVB_LEN ] ;  struct completion oc_sync_wait ;  wait_queue_head_t oc_wait ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dlm_lockspace_t;
@@
 dlm_lockspace_t * cocci_id@p ;
...
position p;
@@
 struct ocfs2_control_private {  struct list_head op_list ;  int op_state ;  int op_this_node ;  struct ocfs2_protocol_version op_proto ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_stack_plugin cocci_id@p ;
...
position p;
@@
 struct ocfs2_stack_operations cocci_id@p ;
...
position p;
@@
 struct ocfs2_control_private * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ OCFS2_CONTROL_PROTO_LEN ] ;
...
position p;
@@
 enum ocfs2_connection_type { WITH_CONTROLD , NO_CONTROLD , } cocci_id@p ;
...
position p;
@@
 struct ocfs2_control_message_setv * cocci_id@p ;
...
position p;
@@
 union ocfs2_control_message cocci_id@p ;
...
position p;
@@
 const struct dlm_lockspace_ops cocci_id@p ;
...
position p;
@@
 struct ocfs2_live_connection cocci_id@p ;
...
position p;
@@
 struct ocfs2_protocol_version * cocci_id@p ;
...
position p;
@@
 struct ocfs2_control_message_setn {  char tag [ OCFS2_CONTROL_MESSAGE_OP_LEN ] ;  char space ;  char nodestr [ OCFS2_CONTROL_MESSAGE_NODENUM_LEN ] ;  char newline ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_control_message_setn * cocci_id@p ;
...
position p;
@@
 struct ocfs2_control_message_down {  char tag [ OCFS2_CONTROL_MESSAGE_OP_LEN ] ;  char space1 ;  char uuid [ OCFS2_TEXT_UUID_LEN ] ;  char space2 ;  char nodestr [ OCFS2_CONTROL_MESSAGE_NODENUM_LEN ] ;  char newline ; } cocci_id@p ;
