...
position p;
@@
 struct sensor_device_attribute_2 cocci_id@p [ ] [ 4 ] ;
...
typedef u8,u16;
@@
 struct vt1211_data {  unsigned short addr ;  const char * name ;  struct device * hwmon_dev ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u8 in [ 6 ] ;  u8 in_max [ 6 ] ;  u8 in_min [ 6 ] ;  u8 temp [ 7 ] ;  u8 temp_max [ 7 ] ;  u8 temp_hyst [ 7 ] ;  u8 fan [ 2 ] ;  u8 fan_min [ 2 ] ;  u8 fan_div [ 2 ] ;  u8 fan_ctl ;  u8 pwm [ 2 ] ;  u8 pwm_ctl [ 2 ] ;  u8 pwm_clk ;  u8 pwm_auto_temp [ 4 ] ;  u8 pwm_auto_pwm [ 2 ] [ 4 ] ;  u8 vid ;  u8 vrm ;  u8 uch_config ;  u16 alarms ; } cocci_id@p ;
