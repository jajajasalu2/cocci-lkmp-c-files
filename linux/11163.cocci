...
position p;
@@
 struct atom_get_smu_clock_info_parameters_v3_1 cocci_id@p ;
...
position p;
@@
 struct dig_encoder_stream_setup_parameters_v1_5 cocci_id@p ;
...
position p;
@@
 struct set_pixel_clock_parameter_v1_7 cocci_id@p ;
...
position p;
@@
 struct set_dce_clock_ps_allocation_v2_1 cocci_id@p ;
...
position p;
@@
 struct enable_disp_power_gating_ps_allocation cocci_id@p ;
...
position p;
@@
 struct set_crtc_using_dtd_timing_parameters cocci_id@p ;
...
position p;
@@
 struct dig_transmitter_control_ps_allocation_v1_6 cocci_id@p ;
...
position p;
@@
 struct atom_get_smu_clock_info_output_parameters_v3_1 cocci_id@p ;
...
position p;
@@
 struct enable_crtc_parameters cocci_id@p ;
