...
position p;
@@
 struct lpddr_private * cocci_id@p ( struct map_info * map ) ;
...
position p;
@@
 int cocci_id@p ( struct map_info * map , struct lpddr_private * lpddr ) ;
...
position p;
@@
 struct qinfo_query_info cocci_id@p [ ] ;
