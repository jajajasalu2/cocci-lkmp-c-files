...
position p;
@@
 struct tangox_wdt_device {  struct watchdog_device wdt ;  void __iomem * base ;  unsigned long clk_rate ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 struct tangox_wdt_device * cocci_id@p ;
