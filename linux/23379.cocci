...
position p;
@@
 struct pm8916_wcd_analog_priv * cocci_id@p ;
...
@@
 struct pm8916_wcd_analog_priv {  u16 pmic_rev ;  u16 codec_version ;  bool mbhc_btn_enabled ;  int mbhc_btn0_released ;  bool detect_accessory_type ;  struct clk * mclk ;  struct snd_soc_component * component ;  struct regulator_bulk_data supplies [ ARRAY_SIZE ( supply_names ) ] ;  struct snd_soc_jack * jack ;  bool hphl_jack_type_normally_open ;  bool gnd_jack_type_normally_open ;  u32 vref_btn_cs [ MBHC_MAX_BUTTONS ] ;  u32 vref_btn_micb [ MBHC_MAX_BUTTONS ] ;  unsigned int micbias1_cap_mode ;  unsigned int micbias2_cap_mode ;  unsigned int micbias_mv ; } cocci_id@p ;
