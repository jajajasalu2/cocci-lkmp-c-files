...
typedef u8,u32;
@@
 struct cs4265_private {  struct regmap * regmap ;  struct gpio_desc * reset_gpio ;  u8 format ;  u32 sysclk ; } cocci_id@p ;
...
position p;
@@
 const struct cs4265_clk_para cocci_id@p [ ] ;
...
position p;
@@
 struct cs4265_private * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cs4265_clk_para {  u32 mclk ;  u32 rate ;  u8 fm_mode ;  u8 mclkdiv ; } cocci_id@p ;
