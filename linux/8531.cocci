...
position p;
@@
 struct atl1c_recv_ret_status cocci_id@p ;
...
position p;
@@
 struct atl1c_tpd_desc * * cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct atl1c_hw * hw , u16 link_speed ) ;
...
position p;
@@
 const struct atl1c_platform_patch cocci_id@p [ ] ;
...
position p;
@@
 struct atl1c_hw_stats * cocci_id@p ;
...
position p;
@@
 struct atl1c_buffer * cocci_id@p ;
...
position p;
@@
 enum atl1c_trans_queue cocci_id@p ;
...
position p;
@@
 struct atl1c_adapter cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct atl1c_hw * hw ) ;
...
position p;
@@
 struct atl1c_rx_free_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct atl1c_hw * hw ) ;
...
position p;
@@
 struct atl1c_tpd_ext_desc cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct atl1c_adapter * adapter , int * work_done , int work_to_do ) ;
...
position p;
@@
 void cocci_id@p ( struct atl1c_adapter * adapter ) ;
...
position p;
@@
 struct atl1c_tpd_ring * cocci_id@p ;
...
position p;
@@
 struct atl1c_rfd_ring * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct atl1c_adapter * adapter ) ;
...
position p;
@@
 struct atl1c_ring_header * cocci_id@p ;
...
position p;
@@
 struct atl1c_rrd_ring * cocci_id@p ;
