...
typedef u32;
@@
 struct s921_state {  struct i2c_adapter * i2c ;  const struct s921_config * config ;  struct dvb_frontend frontend ;  u32 currentfreq ; } cocci_id@p ;
...
position p;
@@
 const struct s921_config * cocci_id@p ;
...
typedef u8,u32;
@@
 struct s921_bandselect_val {  u32 freq_low ;  u8 band_reg ; } cocci_id@p [ ] ;
