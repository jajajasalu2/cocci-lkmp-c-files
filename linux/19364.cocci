...
position p;
@@
 int ( * cocci_id@p ) ( struct stackframe * frame , void * data ) ;
...
position p;
@@
 struct return_addr_data * cocci_id@p ;
...
position p;
@@
 struct return_addr_data {  unsigned long addr ;  unsigned skip ; } cocci_id@p ;
...
position p;
@@
 struct stack_trace_data {  struct stack_trace * trace ;  unsigned skip ; } cocci_id@p ;
...
position p;
@@
 struct stack_trace_data cocci_id@p ;
