...
position p;
@@
 struct catu_drvdata cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct catu_etr_buf {  struct tmc_sg_table * catu_table ;  dma_addr_t sladdr ; } cocci_id@p ;
...
position p;
@@
 const struct coresight_ops_helper cocci_id@p ;
...
position p;
@@
 struct catu_etr_buf * cocci_id@p ;
