...
position p;
@@
 struct ieee_param_ex * cocci_id@p ;
...
position p;
@@
 struct iw_handler_def cocci_id@p ;
...
position p;
@@
 struct rt_pmkid_list cocci_id@p ;
...
position p;
@@
 enum ndis_802_11_network_infra cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ NDIS_802_11_LENGTH_RATES_EX ] ;
...
position p;
@@
 NDIS_802_11_RATES_EX * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_CUSTOM_LEN ] ;
...
position p;
@@
 struct ndis_802_11_wep cocci_id@p ;
...
position p;
@@
 enum ndis_802_11_auth_mode cocci_id@p ;
...
position p;
@@
 struct ndis_802_11_ssid cocci_id@p [ RTW_SSID_SCAN_AMOUNT ] ;
