...
position p;
@@
 struct cgx_evq_entry * cocci_id@p ;
...
position p;
@@
 struct cgx_stats_rsp * cocci_id@p ;
...
position p;
@@
 struct cgx_evq_entry {  struct list_head evq_node ;  struct cgx_link_event link_event ; } cocci_id@p ;
...
position p;
@@
 struct cgx_link_info_msg * cocci_id@p ;
...
position p;
@@
 struct cgx_mac_addr_set_or_get * cocci_id@p ;
