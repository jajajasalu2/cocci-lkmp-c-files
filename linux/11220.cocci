...
position p;
@@
 unsigned int cocci_id@p ( enum cursor_bpp ebpp ) ;
...
position p;
@@
 void cocci_id@p ( struct display_mode_lib * mode_lib , const display_e2e_pipe_params_st * pipes , unsigned int num_pipes ) ;
...
position p;
@@
 display_clocks_and_cfg_st * cocci_id@p ;
...
position p;
@@
 enum self_refresh_affinity cocci_id@p ;
...
position p;
@@
 scaler_ratio_depth_st * cocci_id@p ;
...
position p;
@@
 soc_bounding_box_st * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ DC__NUM_DPP__MAX ] ;
...
position p;
@@
 display_output_params_st * cocci_id@p ;
