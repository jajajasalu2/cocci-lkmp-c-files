...
position p;
@@
 struct opal_prd_msg_queue_item cocci_id@p ;
...
position p;
@@
 struct opal_prd_msg_queue_item {  struct list_head list ;  struct opal_prd_msg_header msg ; } cocci_id@p ;
...
position p;
@@
 struct opal_prd_scom cocci_id@p ;
...
position p;
@@
 struct opal_prd_info cocci_id@p ;
...
position p;
@@
 struct opal_prd_msg_header * cocci_id@p ;
...
position p;
@@
 struct opal_prd_msg * cocci_id@p ;
