...
position p;
@@
 const struct hibvt_pwm_soc cocci_id@p ;
...
position p;
@@
 struct hibvt_pwm_chip * cocci_id@p ;
...
position p;
@@
 struct hibvt_pwm_chip {  struct pwm_chip chip ;  struct clk * clk ;  void __iomem * base ;  struct reset_control * rstc ;  const struct hibvt_pwm_soc * soc ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct hibvt_pwm_soc {  u32 num_pwms ;  bool quirk_force_enable ; } cocci_id@p ;
