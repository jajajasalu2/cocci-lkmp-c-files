...
position p;
@@
 const struct sockaddr_pppol2tpin6 * cocci_id@p ;
...
position p;
@@
 struct l2tp_session * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ppp_channel * chan , struct sk_buff * skb ) ;
...
position p;
@@
 struct sockaddr_pppol2tpv3in6 cocci_id@p ;
...
position p;
@@
 const struct l2tp_nl_cmd_ops cocci_id@p ;
...
typedef u8,u32;
@@
 struct l2tp_connect_info {  u8 version ;  int fd ;  u32 tunnel_id ;  u32 peer_tunnel_id ;  u32 session_id ;  u32 peer_session_id ; } cocci_id@p ;
...
position p;
@@
 struct l2tp_tunnel_cfg cocci_id@p ;
...
position p;
@@
 struct l2tp_session_cfg cocci_id@p ;
...
position p;
@@
 struct pppol2tp_session cocci_id@p ;
...
position p;
@@
 struct pppol2tp_session {  int owner ;  struct mutex sk_lock ;  struct sock __rcu * sk ;  struct sock * __sk ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct l2tp_connect_info * cocci_id@p ;
...
position p;
@@
 const struct sockaddr_pppol2tpv3in6 * cocci_id@p ;
...
position p;
@@
 const struct sockaddr_pppol2tp * cocci_id@p ;
...
position p;
@@
 const struct sockaddr_pppol2tpv3 * cocci_id@p ;
...
position p;
@@
 struct pppol2tp_ioc_stats * cocci_id@p ;
...
position p;
@@
 struct sockaddr_pppol2tpin6 cocci_id@p ;
...
position p;
@@
 struct pppol2tp_seq_data * cocci_id@p ;
...
position p;
@@
 const struct l2tp_stats * cocci_id@p ;
...
position p;
@@
 struct pppol2tp_seq_data {  struct seq_net_private p ;  int tunnel_idx ;  int session_idx ;  struct l2tp_tunnel * tunnel ;  struct l2tp_session * session ; } cocci_id@p ;
...
position p;
@@
 struct sockaddr_pppol2tpv3 cocci_id@p ;
...
position p;
@@
 struct sockaddr_pppol2tp cocci_id@p ;
...
position p;
@@
 const struct l2tp_tunnel * cocci_id@p ;
...
position p;
@@
 const struct ppp_channel_ops cocci_id@p ;
...
position p;
@@
 const struct pppox_proto cocci_id@p ;
