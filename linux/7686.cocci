...
position p;
@@
 struct sunhv_ops {  void ( * transmit_chars ) ( struct uart_port * port , struct circ_buf * xmit ) ;  int ( * receive_chars ) ( struct uart_port * port ) ; } cocci_id@p ;
...
position p;
@@
 const struct sunhv_ops * cocci_id@p ;
