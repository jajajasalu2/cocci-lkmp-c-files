...
position p;
@@
 struct sctp_authkey_event * cocci_id@p ;
...
position p;
@@
 struct sctp_remote_error * cocci_id@p ;
...
position p;
@@
 struct sctp_paddr_change * cocci_id@p ;
...
position p;
@@
 struct sctp_assoc_change cocci_id@p ;
...
position p;
@@
 struct sctp_send_failed cocci_id@p ;
...
position p;
@@
 union sctp_notification * cocci_id@p ;
...
position p;
@@
 struct sctp_pdapi_event * cocci_id@p ;
...
position p;
@@
 struct sctp_stream_change_event cocci_id@p ;
...
position p;
@@
 struct sctp_nxtinfo cocci_id@p ;
...
position p;
@@
 struct sctp_shutdown_event cocci_id@p ;
...
position p;
@@
 const struct sctp_ulpevent * cocci_id@p ;
...
position p;
@@
 struct sctp_sender_dry_event cocci_id@p ;
...
position p;
@@
 struct sctp_rcvinfo cocci_id@p ;
...
position p;
@@
 struct sctp_stream_reset_event * cocci_id@p ;
...
position p;
@@
 struct sctp_adaptation_event cocci_id@p ;
...
position p;
@@
 struct sctp_assoc_reset_event * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sctp_ulpevent * event ) ;
...
position p;
@@
 struct sctp_send_failed_event * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sctp_ulpevent * event , struct sctp_association * asoc ) ;
