...
position p;
@@
 struct lpfc_nvmet_ctx_info * cocci_id@p ;
...
position p;
@@
 struct lpfc_nvmet_ctxbuf cocci_id@p ;
...
position p;
@@
 struct lpfc_iocbq * cocci_id@p ( struct lpfc_hba * , struct lpfc_nvmet_rcv_ctx * ) ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_nvmet_ctxbuf * ctx_buf ) ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_hba * , struct lpfc_queue * , struct lpfc_nvmet_rcv_ctx * ) ;
