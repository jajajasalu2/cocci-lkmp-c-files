...
position p;
@@
 struct dwc2_qh_print_data {  struct dwc2_hsotg * hsotg ;  struct dwc2_qh * qh ; } cocci_id@p ;
...
position p;
@@
 struct dwc2_hs_transfer_time * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( const char * str , void * data ) ;
...
position p;
@@
 struct dwc2_qh_print_data * cocci_id@p ;
