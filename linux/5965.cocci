...
position p;
@@
 struct gpio_irq_type cocci_id@p ;
...
position p;
@@
 struct eqbr_pinctrl_drv_data * cocci_id@p ;
...
position p;
@@
 struct eqbr_pin_bank * cocci_id@p ;
...
position p;
@@
 struct eqbr_pmx_func * cocci_id@p ;
...
position p;
@@
 struct eqbr_gpio_ctrl * cocci_id@p ;
