...
typedef u8;
@@
 struct tc3589x_gpio {  struct gpio_chip chip ;  struct tc3589x * tc3589x ;  struct device * dev ;  struct mutex irq_lock ;  u8 regs [ CACHE_NR_REGS ] [ CACHE_NR_BANKS ] ;  u8 oldregs [ CACHE_NR_REGS ] [ CACHE_NR_BANKS ] ; } cocci_id@p ;
...
position p;
@@
 struct tc3589x_gpio * cocci_id@p ;
...
position p;
@@
 enum { REG_IBE , REG_IEV , REG_IS , REG_IE , } cocci_id@p ;
