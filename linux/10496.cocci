...
typedef u32;
@@
 struct radeon_dpm_quirk {  u32 chip_vendor ;  u32 chip_device ;  u32 subsys_vendor ;  u32 subsys_device ; } cocci_id@p ;
...
position p;
@@
 struct radeon_dpm_quirk cocci_id@p [ ] ;
...
typedef bool;
@@
 bool cocci_id@p ( struct radeon_device * rdev , bool finish ) ;
...
position p;
@@
 enum radeon_pm_state_type cocci_id@p ;
