...
position p;
@@
 struct alias_server * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct alias_lcu * , struct dasd_device * ) ;
...
position p;
@@
 struct summary_unit_check_work_data cocci_id@p ;
...
position p;
@@
 struct read_uac_work_data * cocci_id@p ;
