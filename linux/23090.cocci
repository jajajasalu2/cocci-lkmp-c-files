...
typedef u32;
@@
 struct s3c24xx_i2s_info {  void __iomem * regs ;  struct clk * iis_clk ;  u32 iiscon ;  u32 iismod ;  u32 iisfcon ;  u32 iispsr ; } cocci_id@p ;
...
position p;
@@
 struct s3c24xx_i2s_info cocci_id@p ;
