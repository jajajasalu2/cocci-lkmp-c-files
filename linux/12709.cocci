...
position p;
@@
 struct config_rom_attribute * cocci_id@p ;
...
position p;
@@
 enum { BC_UNKNOWN = 0 , BC_UNIMPLEMENTED , BC_IMPLEMENTED , } cocci_id@p ;
...
position p;
@@
 struct fw_attribute_group * cocci_id@p ;
...
typedef u32;
@@
 struct config_rom_attribute {  struct device_attribute attr ;  u32 key ; } cocci_id@p ;
