...
typedef u8;
@@
 struct ti_dac_spec {  u8 num_channels ;  u8 resolution ; } cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct ti_dac_chip {  struct mutex lock ;  struct regulator * vref ;  struct spi_message mesg ;  struct spi_transfer xfer ;  u16 val [ 4 ] ;  bool powerdown ;  u8 powerdown_mode ;  u8 resolution ;  u8 buf [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum { dual_8bit , dual_10bit , dual_12bit , quad_8bit , quad_10bit , quad_12bit , } cocci_id@p ;
...
position p;
@@
 const struct ti_dac_spec * cocci_id@p ;
