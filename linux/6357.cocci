...
position p;
@@
 const struct pv88060_regulator cocci_id@p [ ] ;
...
position p;
@@
 struct pv88060 {  struct device * dev ;  struct regmap * regmap ;  struct regulator_dev * rdev [ PV88060_MAX_REGULATORS ] ; } cocci_id@p ;
...
position p;
@@
 enum { PV88060_ID_BUCK1 , PV88060_ID_LDO1 , PV88060_ID_LDO2 , PV88060_ID_LDO3 , PV88060_ID_LDO4 , PV88060_ID_LDO5 , PV88060_ID_LDO6 , PV88060_ID_LDO7 , PV88060_ID_SW1 , PV88060_ID_SW2 , PV88060_ID_SW3 , PV88060_ID_SW4 , PV88060_ID_SW5 , PV88060_ID_SW6 , } cocci_id@p ;
...
position p;
@@
 struct pv88060_regulator {  struct regulator_desc desc ;  unsigned int conf ; } cocci_id@p ;
...
position p;
@@
 struct pv88060_regulator * cocci_id@p ;
