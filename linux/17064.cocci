...
position p;
@@
 struct legacy_serial_info * cocci_id@p ;
...
position p;
@@
 struct plat_serial8250_port cocci_id@p [ MAX_LEGACY_SERIAL_PORTS + 1 ] ;
...
typedef phys_addr_t;
@@
 struct legacy_serial_info {  struct device_node * np ;  unsigned int speed ;  unsigned int clock ;  int irq_check_parent ;  phys_addr_t taddr ; } cocci_id@p [ MAX_LEGACY_SERIAL_PORTS ] ;
