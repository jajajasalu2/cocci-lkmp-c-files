...
symbol cocci_id;
position p;
typedef u64,u8,u32,spinlock_t,dma_addr_t;
@@
 struct qib_chip_specific {  u64 __iomem * cregbase ;  u64 * cntrs ;  u64 * portcntrs ;  void * dummy_hdrq ;  dma_addr_t dummy_hdrq_phys ;  spinlock_t kernel_tid_lock ;  spinlock_t user_tid_lock ;  spinlock_t rcvmod_lock ;  spinlock_t gpio_lock ;  u64 hwerrmask ;  u64 errormask ;  u64 gpio_out ;  u64 gpio_mask ;  u64 extctrl ;  u64 ibdeltainprog ;  u64 ibsymdelta ;  u64 ibsymsnap ;  u64 iblnkerrdelta ;  u64 iblnkerrsnap ;  u64 ibcctrl ;  u32 lastlinkrecov ;  u32 cntrnamelen ;  u32 portcntrnamelen ;  u32 ncntrs ;  u32 nportcntrs ;  u32 rxfc_unsupvl_errs ;  u32 overrun_thresh_errs ;  u32 lli_errs ;  u32 lli_counter ;  u64 lli_thresh ;  u64 sword ;  u64 rword ;  u64 spkts ;  u64 rpkts ;  u64 xmit_wait ;  struct timer_list pma_timer ;  struct qib_pportdata * ppd ;  char emsgbuf [ 128 ] ;  char bitsmsgbuf [ 64 ] ;  u8 pma_sample_status ; } cocci_id@p ;
...
typedef u64,u32;
@@
 void cocci_id@p ( struct qib_devdata * , u64 __iomem * , u32 , unsigned long ) ;
