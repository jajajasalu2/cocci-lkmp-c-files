...
position p;
@@
 struct fuse_poll_in cocci_id@p ;
...
position p;
@@
 struct fuse_ioctl_in cocci_id@p ;
...
position p;
@@
 struct fuse_fill_wb_data {  struct fuse_writepage_args * wpa ;  struct fuse_file * ff ;  struct inode * inode ;  struct page * * orig_pages ;  unsigned int max_pages ; } cocci_id@p ;
...
position p;
@@
 struct fuse_release_args * cocci_id@p ;
...
position p;
@@
 const struct fuse_file_lock * cocci_id@p ;
...
position p;
@@
 struct fuse_page_desc * * cocci_id@p ;
...
position p;
@@
 struct fuse_writepage_args cocci_id@p ;
...
position p;
@@
 struct fuse_ioctl_out cocci_id@p ;
...
position p;
@@
 struct fuse_lseek_out cocci_id@p ;
...
position p;
@@
 struct fuse_fill_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_size_t;
@@
 compat_size_t cocci_id@p ;
...
position p;
@@
 struct fuse_fill_wb_data cocci_id@p ;
...
position p;
@@
 struct fuse_open_in cocci_id@p ;
...
position p;
@@
 struct fuse_io_priv * cocci_id@p ;
...
position p;
@@
 struct fuse_io_args cocci_id@p ;
...
position p;
@@
 struct fuse_args_pages * cocci_id@p ;
...
position p;
@@
 struct fuse_ioctl_iovec * cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct kiocb * iocb , struct iov_iter * iter ) ;
...
position p;
@@
 struct fuse_fill_data {  struct fuse_io_args * ia ;  struct file * file ;  struct inode * inode ;  unsigned int nr_pages ;  unsigned int max_pages ; } cocci_id@p ;
...
position p;
@@
 struct fuse_bmap_in cocci_id@p ;
...
position p;
@@
 struct fuse_lseek_in cocci_id@p ;
...
position p;
@@
 const struct file_lock * cocci_id@p ;
...
position p;
@@
 struct fuse_writepage_args {  struct fuse_io_args ia ;  struct list_head writepages_entry ;  struct list_head queue_entry ;  struct fuse_writepage_args * next ;  struct inode * inode ; } cocci_id@p ;
...
position p;
@@
 struct fuse_fsync_in cocci_id@p ;
...
position p;
@@
 struct fuse_write_in * cocci_id@p ;
...
position p;
@@
 struct fuse_open_out * cocci_id@p ;
...
position p;
@@
 struct fuse_bmap_out cocci_id@p ;
...
position p;
@@
 struct fuse_notify_poll_wakeup_out * cocci_id@p ;
...
position p;
@@
 struct fuse_release_in cocci_id@p ;
...
position p;
@@
 struct fuse_poll_out cocci_id@p ;
...
position p;
@@
 struct fuse_copy_file_range_in cocci_id@p ;
...
position p;
@@
 struct fuse_write_out cocci_id@p ;
...
position p;
@@
 struct fuse_release_args {  struct fuse_args args ;  struct fuse_release_in inarg ;  struct inode * inode ; } cocci_id@p ;
...
position p;
@@
 struct fuse_fallocate_in cocci_id@p ;
...
position p;
@@
 struct fuse_flush_in cocci_id@p ;
