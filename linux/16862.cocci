...
position p;
@@
 struct pm8941_pwrkey * cocci_id@p ;
...
typedef u32;
@@
 struct pm8941_pwrkey {  struct device * dev ;  int irq ;  u32 baseaddr ;  struct regmap * regmap ;  struct input_dev * input ;  unsigned int revision ;  struct notifier_block reboot_notifier ;  u32 code ;  const struct pm8941_data * data ; } cocci_id@p ;
...
position p;
@@
 const struct pm8941_data cocci_id@p ;
...
position p;
@@
 struct pm8941_data {  unsigned int pull_up_bit ;  unsigned int status_bit ; } cocci_id@p ;
