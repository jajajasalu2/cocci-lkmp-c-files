...
position p;
@@
 struct peak_pci_chan cocci_id@p ;
...
position p;
@@
 const struct sja1000_priv * cocci_id@p ;
...
position p;
@@
 struct sja1000_priv * cocci_id@p ;
...
position p;
@@
 struct peak_pciec_card cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ PEAK_PCI_CHAN_MAX ] ;
...
position p;
@@
 struct peak_pciec_chan {  struct net_device * netdev ;  unsigned long prev_rx_bytes ;  unsigned long prev_tx_bytes ; } cocci_id@p ;
...
typedef u16;
@@
 struct peak_pci_chan {  void __iomem * cfg_base ;  struct net_device * prev_dev ;  u16 icr_mask ;  struct peak_pciec_card * pciec_card ; } cocci_id@p ;
...
position p;
@@
 enum { PCA9553_LOW , PCA9553_HIGHZ , PCA9553_PWM0 , PCA9553_PWM1 , } cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( const struct sja1000_priv * priv , int port , u8 val ) ;
...
typedef u8;
@@
 struct peak_pciec_card {  void __iomem * cfg_base ;  void __iomem * reg_base ;  u8 led_cache ;  struct i2c_algo_bit_data i2c_bit ;  struct i2c_adapter led_chip ;  struct delayed_work led_work ;  int chan_count ;  struct peak_pciec_chan channel [ PEAK_PCI_CHAN_MAX ] ; } cocci_id@p ;
