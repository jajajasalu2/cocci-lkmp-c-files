...
@@
 struct timb_dma_chan {  struct dma_chan chan ;  void __iomem * membase ;  spinlock_t lock ;  bool ongoing ;  struct list_head active_list ;  struct list_head queue ;  struct list_head free_list ;  unsigned int bytes_per_line ;  enum dma_transfer_direction direction ;  unsigned int descs ;  unsigned int desc_elems ; } cocci_id@p ;
...
position p;
@@
 struct timb_dma_desc cocci_id@p ;
...
position p;
@@
 struct timb_dma {  struct dma_device dma ;  void __iomem * membase ;  struct tasklet_struct tasklet ;  struct timb_dma_chan channels [ 0 ] ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct timb_dma_desc {  struct list_head desc_node ;  struct dma_async_tx_descriptor txd ;  u8 * desc_list ;  unsigned int desc_list_len ;  bool interrupt ; } cocci_id@p ;
...
position p;
@@
 struct timb_dma_chan cocci_id@p ;
...
position p;
@@
 struct timb_dma_platform_data_channel * cocci_id@p ;
...
position p;
@@
 struct timb_dma_platform_data * cocci_id@p ;
