...
position p;
@@
 const struct iw_ioctl_description cocci_id@p [ ] ;
...
position p;
@@
 struct iw_pmkid_cand cocci_id@p ;
...
position p;
@@
 struct compat_iw_point * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net_device * , struct iwreq * , unsigned int , struct iw_request_info * , iw_handler ) ;
