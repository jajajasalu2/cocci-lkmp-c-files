...
typedef u32;
@@
 int cocci_id@p ( struct hptiop_hba * hba , u32 msg , u32 millisec ) ;
...
position p;
@@
 struct hpt_iop_request_scsi_command * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct hptiop_hba * hba , u32 tag ) ;
...
position p;
@@
 struct mvfrey_inlist_entry * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct hptiop_hba * hba , u32 tag , struct hpt_iop_request_scsi_command * req ) ;
...
position p;
@@
 struct hpt_iop_request_header * cocci_id@p ;
...
position p;
@@
 struct hptiop_adapter_ops * cocci_id@p ;
...
position p;
@@
 struct hpt_iop_request_get_config cocci_id@p ;
...
position p;
@@
 struct mvfrey_outlist_entry cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct hptiop_hba * hba , u32 msg ) ;
...
position p;
@@
 struct hpt_iop_request_set_config cocci_id@p ;
...
position p;
@@
 struct hptiop_request * cocci_id@p ;
