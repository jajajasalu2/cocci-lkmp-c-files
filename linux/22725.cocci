...
position p;
@@
 const struct ad1843_gain * cocci_id@p ;
...
position p;
@@
 const struct ad1843_gain * cocci_id@p [ AD1843_GAIN_SIZE ] ;
...
position p;
@@
 const struct ad1843_bitfield cocci_id@p ;
...
position p;
@@
 struct ad1843_bitfield {  char reg ;  char lo_bit ;  char nbits ; } cocci_id@p ;
...
position p;
@@
 struct ad1843_gain {  int negative ;  const struct ad1843_bitfield * lfield ;  const struct ad1843_bitfield * rfield ;  const struct ad1843_bitfield * lmute ;  const struct ad1843_bitfield * rmute ; } cocci_id@p ;
