...
position p;
@@
 struct ei_entry {  struct list_head list ;  unsigned long start_addr ;  unsigned long end_addr ;  int etype ;  void * priv ; } cocci_id@p ;
...
position p;
@@
 struct error_injection_entry * cocci_id@p ;
