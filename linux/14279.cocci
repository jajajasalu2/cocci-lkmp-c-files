...
typedef u8,u32;
@@
 struct ves1x93_state {  struct i2c_adapter * i2c ;  const struct ves1x93_config * config ;  struct dvb_frontend frontend ;  enum fe_spectral_inversion inversion ;  u8 * init_1x93_tab ;  u8 * init_1x93_wtab ;  u8 tab_size ;  u8 demod_type ;  u32 frequency ; } cocci_id@p ;
...
position p;
@@
 struct ves1x93_state cocci_id@p ;
...
position p;
@@
 const struct ves1x93_config * cocci_id@p ;
