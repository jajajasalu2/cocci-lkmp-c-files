...
position p;
@@
 struct v4l2_subdev_ir_parameters * cocci_id@p ;
...
typedef u32;
@@
 union cx23888_ir_fifo_rec {  u32 hw_fifo_data ;  struct ir_raw_event ir_core_data ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_subdev_ir_ops cocci_id@p ;
...
position p;
@@
 union cx23888_ir_fifo_rec * cocci_id@p ;
...
position p;
@@
 struct cx23888_ir_state cocci_id@p ;
...
position p;
@@
 enum rx_fifo_watermark { RX_FIFO_HALF_FULL = 0 , RX_FIFO_NOT_EMPTY = CNTRL_RIC , } cocci_id@p ;
...
position p;
@@
 enum tx_fifo_watermark cocci_id@p ;
...
position p;
@@
 enum tx_fifo_watermark { TX_FIFO_HALF_EMPTY = 0 , TX_FIFO_EMPTY = CNTRL_TIC , } cocci_id@p ;
...
position p;
@@
 union cx23888_ir_fifo_rec cocci_id@p [ FIFO_RX_DEPTH ] ;
...
position p;
@@
 enum rx_fifo_watermark cocci_id@p ;
...
position p;
@@
 const struct v4l2_subdev_ir_parameters cocci_id@p ;
