...
position p;
@@
 struct mxs_lradc_ts * cocci_id@p ;
...
position p;
@@
 enum mxs_lradc_ts_plate { LRADC_TOUCH = 0 , LRADC_SAMPLE_X , LRADC_SAMPLE_Y , LRADC_SAMPLE_PRESSURE , LRADC_SAMPLE_VALID , } cocci_id@p ;
...
typedef u32;
@@
 struct state_info {  u32 mask ;  u32 bit ;  u32 x_plate ;  u32 y_plate ;  u32 pressure ; } cocci_id@p ;
