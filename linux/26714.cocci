...
position p;
@@
 struct amt_version_type cocci_id@p ;
...
position p;
@@
 struct mei_connect_client_data cocci_id@p ;
...
position p;
@@
 const struct amt_host_if_resp_header * cocci_id@p ;
...
position p;
@@
 const struct amt_host_if_msg_header * cocci_id@p ;
...
position p;
@@
 struct amt_code_versions * cocci_id@p ;
...
typedef bool;
@@
 struct amt_host_if {  struct mei mei_cl ;  unsigned long send_timeout ;  bool initialized ; } cocci_id@p ;
...
position p;
@@
 struct amt_host_if_msg_header cocci_id@p ;
...
position p;
@@
 struct amt_host_if_resp_header * cocci_id@p ;
...
typedef bool;
@@
 struct mei {  uuid_le guid ;  bool initialized ;  bool verbose ;  unsigned int buf_size ;  unsigned char prot_ver ;  int fd ; } cocci_id@p ;
