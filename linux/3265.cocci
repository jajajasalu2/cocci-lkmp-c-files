...
position p;
@@
 struct ina3221_data * cocci_id@p ;
...
position p;
@@
 enum ina3221_channels { INA3221_CHANNEL1 , INA3221_CHANNEL2 , INA3221_CHANNEL3 , INA3221_NUM_CHANNELS , } cocci_id@p ;
...
typedef bool,u32;
@@
 struct ina3221_data {  struct device * pm_dev ;  struct regmap * regmap ;  struct regmap_field * fields [ F_MAX_FIELDS ] ;  struct ina3221_input inputs [ INA3221_NUM_CHANNELS ] ;  struct mutex lock ;  u32 reg_config ;  int summation_shunt_resistor ;  bool single_shot ; } cocci_id@p ;
...
typedef bool;
@@
 struct ina3221_input {  const char * label ;  int shunt_resistor ;  bool disconnected ; } cocci_id@p ;
...
position p;
@@
 enum ina3221_fields { F_RST , F_CVRF , F_WF3 , F_WF2 , F_WF1 , F_SF , F_CF3 , F_CF2 , F_CF1 , F_MAX_FIELDS , } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ ] [ INA3221_NUM_CHANNELS + 1 ] ;
...
position p;
@@
 const struct ina3221_data * cocci_id@p ;
...
position p;
@@
 const struct ina3221_input * cocci_id@p ;
...
position p;
@@
 struct ina3221_input * cocci_id@p ;
