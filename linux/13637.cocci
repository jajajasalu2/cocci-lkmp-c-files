...
typedef u8,atomic_t;
@@
 struct sd {  struct gspca_dev gspca_dev ;  struct v4l2_ctrl * brightness ;  u8 mode ;  u8 sof_read ;  u8 header_read ;  u8 autogain_ignore_frames ;  atomic_t avg_lum ; } cocci_id@p ;
