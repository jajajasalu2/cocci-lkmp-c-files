...
position p;
@@
 struct snd_es1968_tea575x_gpio cocci_id@p [ ] ;
...
position p;
@@
 struct ess_device_list cocci_id@p [ ] ;
...
position p;
@@
 const struct snd_tea575x_ops cocci_id@p ;
...
position p;
@@
 struct ess_device_list {  unsigned short type ;  unsigned short vendor ; } cocci_id@p ;
...
position p;
@@
 enum snd_enum_apu_type { ESM_APU_PCM_PLAY , ESM_APU_PCM_CAPTURE , ESM_APU_PCM_RATECONV , ESM_APU_FREE , } cocci_id@p ;
...
position p;
@@
 enum { TYPE_MAESTRO , TYPE_MAESTRO2 , TYPE_MAESTRO2E , } cocci_id@p ;
...
position p;
@@
 struct esm_memory {  struct snd_dma_buffer buf ;  int empty ;  struct list_head list ; } cocci_id@p ;
