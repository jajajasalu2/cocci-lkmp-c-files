...
typedef u8;
@@
 struct pti_dev {  struct tty_port port [ PTITTY_MINOR_NUM ] ;  unsigned long pti_addr ;  unsigned long aperture_base ;  void __iomem * pti_ioaddr ;  u8 ia_app [ MAX_APP_IDS ] ;  u8 ia_os [ MAX_OS_IDS ] ;  u8 ia_modem [ MAX_MODEM_IDS ] ; } cocci_id@p ;
...
position p;
@@
 struct pti_tty {  struct pti_masterchannel * mc ; } cocci_id@p ;
...
position p;
@@
 struct pti_masterchannel * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CONTROL_FRAME_LEN ] ;
