...
position p;
@@
 void cocci_id@p ( struct smi_info * smi_info ) ;
...
position p;
@@
 void cocci_id@p ( void * send_info ) ;
...
position p;
@@
 const struct smi_info * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ IPMI_MAX_INTFS ] ;
...
position p;
@@
 enum si_intf_state { SI_NORMAL , SI_GETTING_FLAGS , SI_GETTING_EVENTS , SI_CLEARING_FLAGS , SI_GETTING_MESSAGES , SI_CHECKING_ENABLES , SI_SETTING_ENABLES , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct smi_info * smi ) ;
