...
position p;
@@
 const struct nfp_nsp_command_arg * cocci_id@p ;
...
position p;
@@
 struct nfp_nsp_command_buf_arg * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct {  dma_addr_t dma_addr ;  unsigned long len ;  void * chunk ; } * cocci_id@p ;
...
position p;
@@
 enum nfp_nsp_versions cocci_id@p ;
...
typedef bool,u16;
@@
 struct nfp_nsp {  struct nfp_cpp * cpp ;  struct nfp_resource * res ;  struct {  u16 major ;  u16 minor ; } ver ;  bool modified ;  unsigned int idx ;  void * entries ; } cocci_id@p ;
...
@@
 struct nfp_nsp_dma_buf {  __le32 chunk_cnt ;  __le32 reserved [ 3 ] ;  struct {  __le32 size ;  __le32 reserved ;  __le64 addr ; } descs [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct {  int code ;  const char * msg ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nfp_nsp_command_buf_arg {  struct nfp_nsp_command_arg arg ;  const void * in_buf ;  unsigned int in_size ;  void * out_buf ;  unsigned int out_size ; } cocci_id@p ;
...
position p;
@@
 struct nfp_resource * cocci_id@p ;
...
position p;
@@
 struct nfp_nsp_dma_buf * cocci_id@p ;
