...
position p;
@@
 struct var_mtrr_state {  unsigned long range_startk ;  unsigned long range_sizek ;  unsigned long chunk_sizek ;  unsigned long gran_sizek ;  unsigned int reg ; } cocci_id@p ;
...
position p;
@@
 struct var_mtrr_state * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MTRR_NUM_TYPES + 1 ] ;
...
position p;
@@
 struct var_mtrr_range_state {  unsigned long base_pfn ;  unsigned long size_pfn ;  mtrr_type type ; } cocci_id@p ;
...
position p;
@@
 struct mtrr_cleanup_result {  unsigned long gran_sizek ;  unsigned long chunk_sizek ;  unsigned long lose_cover_sizek ;  unsigned int num_reg ;  int bad ; } cocci_id@p ;
