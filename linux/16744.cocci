...
position p;
@@
 struct ps2mult_port * cocci_id@p ;
...
@@
 struct ps2mult {  struct serio * mx_serio ;  struct ps2mult_port ports [ PS2MULT_NUM_PORTS ] ;  spinlock_t lock ;  struct ps2mult_port * in_port ;  struct ps2mult_port * out_port ;  bool escape ; } cocci_id@p ;
...
typedef bool;
@@
 struct ps2mult_port {  struct serio * serio ;  unsigned char sel ;  bool registered ; } cocci_id@p ;
