...
position p;
@@
 struct pdc_pat_pd_addr_map_entry cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pdc_pat_cell_mod_maddr_block_t;
@@
 pdc_pat_cell_mod_maddr_block_t cocci_id@p ;
...
position p;
@@
 struct pdc_memory_table cocci_id@p [ MAX_PHYSMEM_RANGES ] ;
...
symbol cocci_id;
position p;
typedef physmem_range_t;
@@
 physmem_range_t * cocci_id@p ;
...
position p;
@@
 struct pdc_pat_pd_addr_map_entry cocci_id@p [ PAT_MAX_RANGES + 1 ] ;
