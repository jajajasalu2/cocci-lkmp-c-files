...
position p;
@@
 int cocci_id@p ( struct usb_hcd * hcd ) ;
...
position p;
@@
 struct fotg210_iso_sched * cocci_id@p ;
...
position p;
@@
 struct fotg210_iso_stream * cocci_id@p ;
...
position p;
@@
 union fotg210_shadow cocci_id@p ;
...
position p;
@@
 struct debug_buffer cocci_id@p ;
...
position p;
@@
 struct debug_buffer {  ssize_t ( * fill_func ) ( struct debug_buffer * ) ;  struct usb_bus * bus ;  struct mutex mutex ;  size_t count ;  char * output_buf ;  size_t alloc_size ; } cocci_id@p ;
...
position p;
@@
 struct fotg210_qh_hw cocci_id@p ;
...
position p;
@@
 struct fotg210_iso_packet cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fotg210_hcd * fotg210 , struct fotg210_qh * qh ) ;
...
position p;
@@
 int cocci_id@p ( struct fotg210_hcd * fotg210 , struct fotg210_qh * qh ) ;
...
position p;
@@
 void ( * cocci_id@p [ ] ) ( struct fotg210_hcd * ) ;
...
position p;
@@
 void cocci_id@p ( struct fotg210_hcd * fotg210 ) ;
...
position p;
@@
 const struct fotg210_qh * cocci_id@p ;
...
position p;
@@
 ssize_t ( * cocci_id@p ) ( struct debug_buffer * ) ;
