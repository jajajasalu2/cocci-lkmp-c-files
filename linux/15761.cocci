...
typedef u_char;
@@
 int cocci_id@p ( struct net_device * dev , int ioaddr , u_char bus , struct pci_dev * pci_dev ) ;
...
symbol cocci_id;
position p;
typedef u_short,u_int,u_char,u_long,hp100_ring_t,spinlock_t;
@@
 struct hp100_private {  spinlock_t lock ;  char id [ HP100_SIG_LEN ] ;  u_short chip ;  u_short soft_model ;  u_int memory_size ;  u_int virt_memory_size ;  u_short rx_ratio ;  u_short priority_tx ;  u_short mode ;  u_char bus ;  struct pci_dev * pci_dev ;  short mem_mapped ;  void __iomem * mem_ptr_virt ;  unsigned long mem_ptr_phys ;  short lan_type ;  int hub_status ;  u_char mac1_mode ;  u_char mac2_mode ;  u_char hash_bytes [ 8 ] ;  hp100_ring_t * rxrhead ;  hp100_ring_t * rxrtail ;  hp100_ring_t * txrhead ;  hp100_ring_t * txrtail ;  hp100_ring_t rxring [ MAX_RX_PDL ] ;  hp100_ring_t txring [ MAX_TX_PDL ] ;  u_int * page_vaddr_algn ;  u_long whatever_offset ;  int rxrcommit ;  int txrcommit ; } cocci_id@p ;
...
typedef u_short;
@@
 int cocci_id@p ( struct net_device * dev , u_short force_relogin ) ;
...
symbol cocci_id;
position p;
typedef hp100_ring_t;
@@
 hp100_ring_t * cocci_id@p ;
...
position p;
@@
 struct hp100_private * cocci_id@p ;
...
position p;
@@
 struct net_device * cocci_id@p [ HP100_DEVICES ] ;
...
typedef u_short;
@@
 void cocci_id@p ( struct net_device * dev , u_short enable ) ;
...
symbol cocci_id;
position p;
typedef u_int,hp100_ring_t;
@@
 int cocci_id@p ( struct net_device * dev , register hp100_ring_t * ringptr , register u_int * pdlptr ) ;
...
position p;
@@
 void cocci_id@p ( struct hp100_private * lp , int ioaddr ) ;
...
typedef u_short;
@@
 void cocci_id@p ( struct net_device * dev , u_short ioaddr ) ;
...
position p;
@@
 const struct eisa_device_id cocci_id@p [ ] ;
