...
position p;
@@
 enum buddy { FIRST , LAST , } cocci_id@p ;
...
typedef bool;
@@
 struct zbud_header {  struct list_head buddy ;  struct list_head lru ;  unsigned int first_chunks ;  unsigned int last_chunks ;  bool under_reclaim ; } cocci_id@p ;
...
position p;
@@
 const struct zbud_ops cocci_id@p ;
