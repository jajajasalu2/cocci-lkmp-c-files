...
typedef bool;
@@
 void cocci_id@p ( struct atp_unit * dev , unsigned char c , bool wide_chip , unsigned char lvdmode ) ;
...
position p;
@@
 void cocci_id@p ( struct atp_unit * dev , unsigned char c ) ;
