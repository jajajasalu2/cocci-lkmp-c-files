...
position p;
@@
 struct serial_card_info {  unsigned int num_ports ;  int ports [ MAX_PORTS ] ;  void __iomem * vaddr ; } cocci_id@p ;
...
position p;
@@
 struct serial_card_info cocci_id@p ;
...
position p;
@@
 struct serial_card_type cocci_id@p ;
...
position p;
@@
 struct serial_card_type {  unsigned int num_ports ;  unsigned int uartclk ;  unsigned int type ;  unsigned int offset [ MAX_PORTS ] ; } cocci_id@p ;
