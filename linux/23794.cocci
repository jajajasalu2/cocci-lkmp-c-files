...
position p;
@@
 struct skbprio_sched_data * cocci_id@p ;
...
position p;
@@
 struct tc_skbprio_qopt cocci_id@p ;
...
position p;
@@
 const struct skbprio_sched_data * cocci_id@p ;
...
typedef u16;
@@
 struct skbprio_sched_data {  struct sk_buff_head qdiscs [ SKBPRIO_MAX_PRIORITY ] ;  struct gnet_stats_queue qstats [ SKBPRIO_MAX_PRIORITY ] ;  u16 highest_prio ;  u16 lowest_prio ; } cocci_id@p ;
