...
position p;
@@
 enum packet_data_state cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct seq_file * m , void * p ) ;
...
position p;
@@
 struct pkt_ctrl_command cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ PACKET_NUM_STATES ] ;
...
position p;
@@
 struct pktcdvd_device * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PACKET_MAX_SIZE ] ;
...
position p;
@@
 struct pktcdvd_kobj * cocci_id@p ;
...
position p;
@@
 struct packet_stacked_data * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ 256 + 18 ] ;
...
position p;
@@
 struct pktcdvd_device * cocci_id@p [ MAX_WRITERS ] ;
