...
position p;
@@
 void cocci_id@p ( struct vmw_mob * mob , struct vmw_piter data_iter , unsigned long num_data_pages ) ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDefineGBMob64 body ; } * cocci_id@p ;
...
@@
 struct vmw_mob {  struct ttm_buffer_object * pt_bo ;  unsigned long num_pages ;  unsigned pt_level ;  dma_addr_t pt_root_page ;  uint32_t id ; } cocci_id@p ;
...
position p;
@@
 struct vmw_otable_batch * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdSetOTableBase64 body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdSetOTableBase body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDestroyGBMob body ; } * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vmw_private * dev_priv , struct vmw_mob * mob ) ;
