...
position p;
@@
 struct keyspan_pda_private * cocci_id@p ;
...
position p;
@@
 struct keyspan_pda_private {  int tx_room ;  int tx_throttled ;  struct work_struct wakeup_work ;  struct work_struct unthrottle_work ;  struct usb_serial * serial ;  struct usb_serial_port * port ; } cocci_id@p ;
