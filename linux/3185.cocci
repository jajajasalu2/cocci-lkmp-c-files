...
position p;
@@
 struct nsa320_hwmon {  struct mutex update_lock ;  unsigned long last_updated ;  unsigned long mcu_data ;  struct gpio_desc * act ;  struct gpio_desc * clk ;  struct gpio_desc * data ; } cocci_id@p ;
...
position p;
@@
 enum nsa320_inputs { NSA320_TEMP = 0 , NSA320_FAN = 1 , } cocci_id@p ;
...
position p;
@@
 struct nsa320_hwmon * cocci_id@p ;
