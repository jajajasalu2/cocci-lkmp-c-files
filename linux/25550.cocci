...
position p;
@@
 struct s390_cpumsf_queue cocci_id@p ;
...
position p;
@@
 struct hws_diag_entry cocci_id@p ;
...
typedef FILE;
@@
 struct s390_cpumsf_queue {  struct s390_cpumsf * sf ;  unsigned int queue_nr ;  struct auxtrace_buffer * buffer ;  int cpu ;  FILE * logfile ;  FILE * logfile_ctr ; } cocci_id@p ;
...
@@
 struct s390_cpumsf {  struct auxtrace auxtrace ;  struct auxtrace_queues queues ;  struct auxtrace_heap heap ;  struct perf_session * session ;  struct machine * machine ;  u32 auxtrace_type ;  u32 pmu_type ;  u16 machine_type ;  bool data_queued ;  bool use_logfile ;  char * logdir ; } cocci_id@p ;
...
position p;
@@
 struct s390_cpumsf_synth {  struct perf_tool cpumsf_tool ;  struct perf_session * session ; } cocci_id@p ;
