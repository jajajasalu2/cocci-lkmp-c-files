...
position p;
@@
 struct meson_ee_pwrc_top_domain cocci_id@p ;
...
position p;
@@
 struct meson_ee_pwrc * cocci_id@p ;
...
typedef bool;
@@
 struct meson_ee_pwrc_domain {  struct generic_pm_domain base ;  bool enabled ;  struct meson_ee_pwrc * pwrc ;  struct meson_ee_pwrc_domain_desc desc ;  struct clk_bulk_data * clks ;  int num_clks ;  struct reset_control * rstc ;  int num_rstc ; } cocci_id@p ;
...
typedef bool;
@@
 struct meson_ee_pwrc_domain_desc {  char * name ;  unsigned int reset_names_count ;  unsigned int clk_names_count ;  struct meson_ee_pwrc_top_domain * top_pd ;  unsigned int mem_pd_count ;  struct meson_ee_pwrc_mem_domain * mem_pd ;  bool ( * get_power ) ( struct meson_ee_pwrc_domain * pwrc_domain ) ; } cocci_id@p ;
...
position p;
@@
 struct meson_ee_pwrc {  struct regmap * regmap_ao ;  struct regmap * regmap_hhi ;  struct meson_ee_pwrc_domain * domains ;  struct genpd_onecell_data xlate ; } cocci_id@p ;
...
position p;
@@
 struct meson_ee_pwrc_mem_domain cocci_id@p [ ] ;
...
position p;
@@
 struct meson_ee_pwrc_top_domain {  unsigned int sleep_reg ;  unsigned int sleep_mask ;  unsigned int iso_reg ;  unsigned int iso_mask ; } cocci_id@p ;
...
position p;
@@
 struct meson_ee_pwrc_mem_domain {  unsigned int reg ;  unsigned int mask ; } cocci_id@p ;
...
position p;
@@
 struct meson_ee_pwrc_domain * cocci_id@p ;
...
position p;
@@
 const struct meson_ee_pwrc_domain_data * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct meson_ee_pwrc_domain * pwrc_domain ) ;
...
position p;
@@
 struct meson_ee_pwrc_domain_data {  unsigned int count ;  struct meson_ee_pwrc_domain_desc * domains ; } cocci_id@p ;
...
position p;
@@
 struct meson_ee_pwrc_domain_desc cocci_id@p [ ] ;
...
position p;
@@
 struct meson_ee_pwrc_domain_data cocci_id@p ;
