...
position p;
@@
 const struct retu_data * cocci_id@p ;
...
position p;
@@
 struct retu_dev {  struct regmap * regmap ;  struct device * dev ;  struct mutex mutex ;  struct regmap_irq_chip_data * irq_data ; } cocci_id@p ;
...
position p;
@@
 const struct retu_data {  char * chip_name ;  char * companion_name ;  struct regmap_irq_chip * irq_chip ;  const struct mfd_cell * children ;  int nchildren ; } cocci_id@p [ ] ;
