...
position p;
@@
 struct cns3xxx_pcie * cocci_id@p ;
...
typedef bool;
@@
 struct cns3xxx_pcie {  void __iomem * host_regs ;  void __iomem * cfg0_regs ;  void __iomem * cfg1_regs ;  unsigned int irqs [ 2 ] ;  struct resource res_io ;  struct resource res_mem ;  int port ;  bool linked ; } cocci_id@p ;
