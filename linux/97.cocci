...
position p;
@@
 struct mem_zone_bm_rtree {  struct list_head list ;  struct list_head nodes ;  struct list_head leaves ;  unsigned long start_pfn ;  unsigned long end_pfn ;  struct rtree_node * rtree ;  int levels ;  unsigned int blocks ; } cocci_id@p ;
...
typedef gfp_t;
@@
 struct chain_allocator {  struct linked_page * chain ;  unsigned int used_space ;  gfp_t gfp_mask ;  int safe_needed ; } cocci_id@p ;
...
position p;
@@
 struct chain_allocator * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct memory_bitmap * bm , int clear_nosave_free ) ;
...
position p;
@@
 struct mem_zone_bm_rtree cocci_id@p ;
...
position p;
@@
 struct rtree_node {  struct list_head list ;  unsigned long * data ; } cocci_id@p ;
...
position p;
@@
 struct memory_bitmap cocci_id@p ;
...
position p;
@@
 struct mem_extent {  struct list_head hook ;  unsigned long start ;  unsigned long end ; } cocci_id@p ;
...
position p;
@@
 struct highmem_pbe {  struct page * copy_page ;  struct page * orig_page ;  struct highmem_pbe * next ; } cocci_id@p ;
...
position p;
@@
 struct nosave_region {  struct list_head list ;  unsigned long start_pfn ;  unsigned long end_pfn ; } cocci_id@p ;
...
position p;
@@
 struct memory_bitmap {  struct list_head zones ;  struct linked_page * p_list ;  struct bm_position cur ; } cocci_id@p ;
...
position p;
@@
 struct bm_position {  struct mem_zone_bm_rtree * zone ;  struct rtree_node * node ;  unsigned long node_pfn ;  int node_bit ; } cocci_id@p ;
...
position p;
@@
 struct nosave_region * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mem_zone_bm_rtree * zone , int clear_nosave_free ) ;
