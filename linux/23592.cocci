...
position p;
@@
 struct tegra_rt5640 {  struct tegra_asoc_utils_data util_data ;  int gpio_hp_det ;  enum of_gpio_flags gpio_hp_det_flags ; } cocci_id@p ;
...
position p;
@@
 struct tegra_rt5640 * cocci_id@p ;
