...
position p;
@@
 struct ts_common_info * * cocci_id@p ;
...
position p;
@@
 struct ieee_ibss_seq cocci_id@p ;
...
position p;
@@
 struct rtllib_qos_parameter_info * cocci_id@p ;
...
position p;
@@
 struct rtllib_tim_parameters cocci_id@p ;
...
position p;
@@
 struct rtllib_qos_data * cocci_id@p ;
...
position p;
@@
 struct rtllib_frag_entry * cocci_id@p ;
...
position p;
@@
 enum ht_channel_width cocci_id@p ;
...
position p;
@@
 struct rtllib_qos_information_element * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rtllib_device * ieee , struct sk_buff * skb , struct rtllib_rx_stats * stats ) ;
...
position p;
@@
 struct rtllib_hdr_4addrqos * cocci_id@p ;
...
position p;
@@
 struct ht_capab_ele * cocci_id@p ;
...
position p;
@@
 struct rtllib_hdr_4addr * cocci_id@p ;
...
position p;
@@
 struct rtllib_hdr_3addr * cocci_id@p ;
...
position p;
@@
 struct rx_reorder_entry cocci_id@p ;
...
position p;
@@
 struct rtllib_info_element * cocci_id@p ;
...
position p;
@@
 struct rx_ts_record * cocci_id@p ;
...
position p;
@@
 struct rtllib_qos_ac_parameter * cocci_id@p ;
...
position p;
@@
 struct rtllib_hdr_3addrqos * cocci_id@p ;
...
position p;
@@
 struct rtllib_probe_response * cocci_id@p ;
...
position p;
@@
 struct rt_hi_throughput * cocci_id@p ;
