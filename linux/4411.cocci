...
typedef u32;
@@
 struct console {  struct list_head list ;  struct hvc_struct * hvc ;  struct winsize ws ;  u32 vtermno ; } cocci_id@p ;
...
position p;
@@
 struct virtio_console_config cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( u32 , const char * , int ) ;
...
position p;
@@
 struct virtio_console_control * cocci_id@p ;
...
position p;
@@
 struct sg_list {  unsigned int n ;  unsigned int size ;  size_t len ;  struct scatterlist * sg ; } cocci_id@p ;
...
typedef __u16;
@@
 struct {  __u16 rows ;  __u16 cols ; } cocci_id@p ;
...
position p;
@@
 struct ports_driver_data cocci_id@p ;
...
position p;
@@
 struct ports_device cocci_id@p ;
...
position p;
@@
 const struct virtio_device * cocci_id@p ;
...
position p;
@@
 const struct hv_ops cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct port_buffer {  char * buf ;  size_t size ;  size_t len ;  size_t offset ;  dma_addr_t dma ;  struct device * dev ;  struct list_head list ;  unsigned int sgpages ;  struct scatterlist sg [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct ports_driver_data {  struct class * class ;  struct dentry * debugfs_dir ;  struct list_head portdevs ;  unsigned int next_vtermno ;  struct list_head consoles ; } cocci_id@p ;
