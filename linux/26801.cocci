...
position p;
@@
 struct debugfs_devm_entry * cocci_id@p ;
...
position p;
@@
 struct debugfs_fsdata * cocci_id@p ;
...
position p;
@@
 struct debugfs_devm_entry {  int ( * read ) ( struct seq_file * seq , void * data ) ;  struct device * dev ; } cocci_id@p ;
...
typedef u32;
@@
 struct array_data {  void * array ;  u32 elements ; } cocci_id@p ;
