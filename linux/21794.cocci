...
position p;
@@
 char cocci_id@p ( early_command_line ) ;
...
position p;
@@
 unsigned long cocci_id@p ( vmalloc_size ) ;
...
position p;
@@
 int cocci_id@p ( noexec_disabled ) ;
...
position p;
@@
 unsigned long cocci_id@p ( memory_end ) ;
...
position p;
@@
 const struct ipl_parameter_block * cocci_id@p ;
