...
position p;
@@
 enum rapl_primitives cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct rapl_domain * rd , enum unit_type type , u64 value , int to_raw ) ;
...
position p;
@@
 void cocci_id@p ( struct rapl_package * rp ) ;
...
typedef u64,bool;
@@
 int cocci_id@p ( struct rapl_domain * rd , enum rapl_primitives prim , bool xlate , u64 * data ) ;
...
position p;
@@
 enum unit_type { ARBITRARY_UNIT , POWER_UNIT , ENERGY_UNIT , TIME_UNIT , } cocci_id@p ;
...
position p;
@@
 struct rapl_package * cocci_id@p ;
...
position p;
@@
 struct powercap_zone * cocci_id@p ;
...
position p;
@@
 struct rapl_defaults * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct rapl_domain * rd , enum rapl_primitives prim , unsigned long long value ) ;
...
typedef u8,u64,bool;
@@
 struct rapl_defaults {  u8 floor_freq_reg_addr ;  int ( * check_unit ) ( struct rapl_package * rp , int cpu ) ;  void ( * set_floor_freq ) ( struct rapl_domain * rd , bool mode ) ;  u64 ( * compute_time_window ) ( struct rapl_package * rp , u64 val , bool to_raw ) ;  unsigned int dram_domain_energy_unit ; } cocci_id@p ;
...
position p;
@@
 struct rapl_if_priv * cocci_id@p ;
...
position p;
@@
 const struct powercap_zone_ops cocci_id@p [ ] ;
...
position p;
@@
 struct rapl_primitive_info cocci_id@p [ ] ;
...
position p;
@@
 enum rapl_domain_type cocci_id@p ;
...
position p;
@@
 const struct powercap_zone_constraint_ops cocci_id@p ;
...
typedef u64,u32;
@@
 struct rapl_primitive_info {  const char * name ;  u64 mask ;  int shift ;  enum rapl_domain_reg_id id ;  enum unit_type unit ;  u32 flag ; } cocci_id@p ;
...
position p;
@@
 const struct rapl_defaults cocci_id@p ;
...
position p;
@@
 enum rapl_domain_reg_id cocci_id@p ;
