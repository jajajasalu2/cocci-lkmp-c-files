...
position p;
@@
 struct xsphy_instance * cocci_id@p ;
...
typedef u32;
@@
 struct xsphy_instance {  struct phy * phy ;  void __iomem * port_base ;  struct clk * ref_clk ;  u32 index ;  u32 type ;  int efuse_intr ;  int efuse_tx_imp ;  int efuse_rx_imp ;  int eye_src ;  int eye_vrt ;  int eye_term ; } cocci_id@p ;
...
position p;
@@
 struct mtk_xsphy {  struct device * dev ;  void __iomem * glb_base ;  struct xsphy_instance * * phys ;  int nphys ;  int src_ref_clk ;  int src_coef ; } cocci_id@p ;
