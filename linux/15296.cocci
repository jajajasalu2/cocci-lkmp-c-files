...
position p;
@@
 struct occ {  struct device * dev ;  struct device * sbefifo ;  char name [ 32 ] ;  int idx ;  struct miscdevice mdev ;  struct mutex occ_lock ; } cocci_id@p ;
...
typedef u8;
@@
 struct occ_client {  struct occ * occ ;  struct mutex lock ;  size_t data_size ;  size_t read_offset ;  u8 * buffer ; } cocci_id@p ;
