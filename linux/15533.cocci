...
position p;
@@
 const struct goldfish_audio * cocci_id@p ;
...
position p;
@@
 struct goldfish_audio * cocci_id@p ;
...
@@
 struct goldfish_audio {  char __iomem * reg_base ;  int irq ;  spinlock_t lock ;  wait_queue_head_t wait ;  char * buffer_virt ;  unsigned long buffer_phys ;  char * write_buffer1 ;  char * write_buffer2 ;  char * read_buffer ;  int buffer_status ;  int read_supported ; } cocci_id@p ;
