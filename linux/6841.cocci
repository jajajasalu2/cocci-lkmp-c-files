...
position p;
@@
 struct esas2r_boot_image * cocci_id@p ;
...
position p;
@@
 struct esas2r_ioctlfs_command * cocci_id@p ;
...
position p;
@@
 struct esas2r_boot_header cocci_id@p ;
...
position p;
@@
 struct esas2r_efi_image * cocci_id@p ;
...
position p;
@@
 struct esas2r_component_header * cocci_id@p ;
...
position p;
@@
 struct esas2r_pc_image * cocci_id@p ;
...
position p;
@@
 struct esas2r_flash_context * cocci_id@p ;
