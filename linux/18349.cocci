...
position p;
@@
 const struct imx5_pm_data cocci_id@p ;
...
position p;
@@
 enum mxc_cpu_pwr_mode cocci_id@p ;
...
position p;
@@
 struct imx5_cpu_suspend_info * cocci_id@p ;
...
typedef u32;
@@
 struct imx5_suspend_io_state {  u32 offset ;  u32 clear ;  u32 set ;  u32 saved_value ; } cocci_id@p ;
...
@@
 struct imx5_pm_data {  phys_addr_t ccm_addr ;  phys_addr_t cortex_addr ;  phys_addr_t gpc_addr ;  phys_addr_t m4if_addr ;  phys_addr_t iomuxc_addr ;  void ( * suspend_asm ) ( void __iomem * ocram_vbase ) ;  const u32 * suspend_asm_sz ;  const struct imx5_suspend_io_state * suspend_io_config ;  int suspend_io_count ; } cocci_id@p ;
...
position p;
@@
 const struct imx5_suspend_io_state cocci_id@p [ ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( void __iomem * ocram_vbase ) ;
