...
typedef u8,bool,u32;
@@
 struct virt_wifi_netdev_priv {  struct delayed_work connect ;  struct net_device * lowerdev ;  struct net_device * upperdev ;  u32 tx_packets ;  u32 tx_failed ;  u8 connect_requested_bss [ ETH_ALEN ] ;  bool is_up ;  bool is_connected ;  bool being_deleted ; } cocci_id@p ;
...
position p;
@@
 struct virt_wifi_netdev_priv * cocci_id@p ;
...
typedef bool;
@@
 struct virt_wifi_wiphy_priv {  struct delayed_work scan_result ;  struct cfg80211_scan_request * scan_request ;  bool being_deleted ; } cocci_id@p ;
...
position p;
@@
 struct virt_wifi_wiphy_priv cocci_id@p ;
