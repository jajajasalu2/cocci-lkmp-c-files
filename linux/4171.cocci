...
position p;
@@
 enum pll_ctrl_bits { PLL_RESETB , SSPLL_SUSPEND_EN , PLL_SEQ_START , PLL_LOCK , PLL_PDIV , } cocci_id@p ;
...
position p;
@@
 struct bcm_usb_phy_cfg cocci_id@p ;
...
position p;
@@
 enum bcm_usb_phy_ctrl_bits { CORERDY , AFE_LDO_PWRDWNB , AFE_PLL_PWRDWNB , AFE_BG_PWRDWNB , PHY_ISO , PHY_RESETB , PHY_PCTL , } cocci_id@p ;
...
typedef u8,uint32_t;
@@
 struct bcm_usb_phy_cfg {  uint32_t type ;  uint32_t version ;  void __iomem * regs ;  struct phy * phy ;  const u8 * offset ; } cocci_id@p ;
...
position p;
@@
 enum bcm_usb_phy_reg { PLL_NDIV_FRAC , PLL_NDIV_INT , PLL_CTRL , PHY_CTRL , PHY_PLL_CTRL , } cocci_id@p ;
...
position p;
@@
 enum bcm_usb_phy_type { USB_HS_PHY , USB_SS_PHY , } cocci_id@p ;
...
position p;
@@
 enum bcm_usb_phy_version cocci_id@p ;
...
position p;
@@
 enum bcm_usb_phy_version { BCM_SR_USB_COMBO_PHY , BCM_SR_USB_HS_PHY , } cocci_id@p ;
