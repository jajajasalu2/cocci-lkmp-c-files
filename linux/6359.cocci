...
position p;
@@
 struct wm831x_isink {  char name [ WM831X_ISINK_MAX_NAME ] ;  struct regulator_desc desc ;  int reg ;  struct wm831x * wm831x ;  struct regulator_dev * regulator ; } cocci_id@p ;
...
position p;
@@
 struct wm831x_isink * cocci_id@p ;
