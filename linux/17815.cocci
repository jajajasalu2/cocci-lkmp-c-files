...
position p;
@@
 struct regset_getset * cocci_id@p ;
...
position p;
@@
 struct unw_frame_info cocci_id@p ;
...
position p;
@@
 long ( * cocci_id@p ) ( struct task_struct * , struct switch_stack * , unsigned long , unsigned long ) ;
...
position p;
@@
 struct syscall_get_set_args cocci_id@p ;
...
position p;
@@
 struct pt_all_user_regs cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct task_struct * child , unsigned long addr , unsigned long * data , int write_access ) ;
...
position p;
@@
 struct regset_set {  const void * kbuf ;  const void __user * ubuf ; } cocci_id@p ;
...
position p;
@@
 struct regset_get {  void * kbuf ;  void __user * ubuf ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct unw_frame_info * , void * ) ;
...
position p;
@@
 struct syscall_get_set_args {  unsigned int i ;  unsigned int n ;  unsigned long * args ;  struct pt_regs * regs ;  int rw ; } cocci_id@p ;
...
position p;
@@
 struct regset_getset {  struct task_struct * target ;  const struct user_regset * regset ;  union {  struct regset_get get ;  struct regset_set set ; } u ;  unsigned int pos ;  unsigned int count ;  int ret ; } cocci_id@p ;
