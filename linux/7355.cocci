...
position p;
@@
 struct cyberpro_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_int,u_char;
@@
 struct par_info {  u_char clock_mult ;  u_char clock_div ;  u_char extseqmisc ;  u_char co_pixfmt ;  u_char crtc_ofl ;  u_char crtc [ 19 ] ;  u_int width ;  u_int pitch ;  u_int fetch ;  u_char ramdac ; } cocci_id@p ;
