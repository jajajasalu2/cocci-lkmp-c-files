...
position p;
@@
 struct ieee80211_wmm_param_ie * cocci_id@p ;
...
position p;
@@
 struct wilc_gtk_key * cocci_id@p ;
...
typedef u8,u32;
@@
 struct wilc_set_multicast {  u32 enabled ;  u32 cnt ;  u8 * mc_list ; } cocci_id@p ;
...
typedef __le32;
@@
 struct wilc_op_mode {  __le32 mode ; } cocci_id@p ;
...
position p;
@@
 struct wilc_reg_frame cocci_id@p ;
...
position p;
@@
 struct wilc_set_multicast * cocci_id@p ;
...
position p;
@@
 struct wilc_rcvd_net_info * cocci_id@p ;
...
position p;
@@
 struct wilc_drv_handler cocci_id@p ;
...
position p;
@@
 struct cfg_param_attr * cocci_id@p ;
...
position p;
@@
 union wilc_message_body {  struct wilc_rcvd_net_info net_info ;  struct wilc_rcvd_mac_info mac_info ;  struct wilc_set_multicast mc_info ;  struct wilc_remain_ch remain_on_ch ;  char * data ; } cocci_id@p ;
...
typedef u8;
@@
 struct wilc_rcvd_mac_info {  u8 status ; } cocci_id@p ;
...
position p;
@@
 struct wilc_ap_wpa_ptk * cocci_id@p ;
...
position p;
@@
 struct wilc_user_scan_req * cocci_id@p ;
...
position p;
@@
 struct wilc_remain_ch * cocci_id@p ;
...
position p;
@@
 struct wilc_rcvd_mac_info * cocci_id@p ;
...
position p;
@@
 struct wilc_sta_wpa_ptk * cocci_id@p ;
...
position p;
@@
 struct wilc_wep_key * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( enum scan_event , struct wilc_rcvd_net_info * , void * ) ;
...
position p;
@@
 struct wilc_del_all_sta cocci_id@p ;
...
typedef u8;
@@
 struct wilc_del_all_sta {  u8 assoc_sta ;  u8 mac [ WILC_MAX_NUM_STA ] [ ETH_ALEN ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct host_if_msg {  union wilc_message_body body ;  struct wilc_vif * vif ;  struct work_struct work ;  void ( * fn ) ( struct work_struct * ws ) ;  struct completion work_comp ;  bool is_sync ; } cocci_id@p ;
...
position p;
@@
 struct wilc_join_bss_param * cocci_id@p ;
...
position p;
@@
 struct wilc_conn_info * cocci_id@p ;
...
position p;
@@
 struct wilc_pmkid_attr * cocci_id@p ;
