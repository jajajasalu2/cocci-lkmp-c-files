...
@@
 struct etnaviv_iommuv2_context {  struct etnaviv_iommu_context base ;  unsigned short id ;  u32 * mtlb_cpu ;  dma_addr_t mtlb_dma ;  u32 * stlb_cpu [ MMUv2_MAX_STLB_ENTRIES ] ;  dma_addr_t stlb_dma [ MMUv2_MAX_STLB_ENTRIES ] ; } cocci_id@p ;
...
position p;
@@
 struct etnaviv_iommuv2_context cocci_id@p ;
...
position p;
@@
 const struct etnaviv_iommu_ops cocci_id@p ;
