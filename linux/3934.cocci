...
position p;
@@
 const struct uniphier_glue_reset_soc_data cocci_id@p ;
...
position p;
@@
 struct uniphier_glue_reset_priv * cocci_id@p ;
...
position p;
@@
 struct uniphier_glue_reset_priv {  struct clk_bulk_data clk [ MAX_CLKS ] ;  struct reset_control * rst [ MAX_RSTS ] ;  struct reset_simple_data rdata ;  const struct uniphier_glue_reset_soc_data * data ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_glue_reset_soc_data {  int nclks ;  const char * const * clock_names ;  int nrsts ;  const char * const * reset_names ; } cocci_id@p ;
