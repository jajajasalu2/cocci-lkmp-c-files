...
position p;
@@
 const struct xgene_mac_ops * cocci_id@p ;
...
position p;
@@
 struct xgene_enet_raw_desc cocci_id@p ;
...
position p;
@@
 struct xgene_enet_desc_ring * cocci_id@p ;
...
position p;
@@
 typeof ( pdata -> tx_level [ index ] ) cocci_id@p ;
...
position p;
@@
 struct xgene_enet_pdata cocci_id@p ;
...
position p;
@@
 struct xgene_enet_raw_desc16 * cocci_id@p ;
...
position p;
@@
 enum xgene_enet_ring_cfgsize cocci_id@p ;
...
position p;
@@
 struct xgene_enet_cle * cocci_id@p ;
...
position p;
@@
 enum xgene_ring_owner cocci_id@p ;
