...
position p;
@@
 struct megamod_cascade_data * cocci_id@p ;
...
position p;
@@
 struct megamod_cascade_data {  struct megamod_pic * pic ;  int index ; } cocci_id@p ;
...
typedef u32;
@@
 struct megamod_regs {  u32 evtflag [ 8 ] ;  u32 evtset [ 8 ] ;  u32 evtclr [ 8 ] ;  u32 reserved0 [ 8 ] ;  u32 evtmask [ 8 ] ;  u32 mevtflag [ 8 ] ;  u32 expmask [ 8 ] ;  u32 mexpflag [ 8 ] ;  u32 intmux_unused ;  u32 intmux [ 7 ] ;  u32 reserved1 [ 8 ] ;  u32 aegmux [ 2 ] ;  u32 reserved2 [ 14 ] ;  u32 intxstat ;  u32 intxclr ;  u32 intdmask ;  u32 reserved3 [ 13 ] ;  u32 evtasrt ; } cocci_id@p ;
...
position p;
@@
 struct megamod_cascade_data cocci_id@p [ NR_COMBINERS ] ;
...
@@
 struct megamod_pic {  struct irq_domain * irqhost ;  struct megamod_regs __iomem * regs ;  raw_spinlock_t lock ;  unsigned int output_to_irq [ NR_MUX_OUTPUTS ] ; } cocci_id@p ;
