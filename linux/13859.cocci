...
position p;
@@
 enum rc6_mode { RC6_MODE_0 , RC6_MODE_6A , RC6_MODE_UNKNOWN , } cocci_id@p ;
...
position p;
@@
 const struct ir_raw_timings_manchester cocci_id@p [ 4 ] ;
...
position p;
@@
 enum rc6_state { STATE_INACTIVE , STATE_PREFIX_SPACE , STATE_HEADER_BIT_START , STATE_HEADER_BIT_END , STATE_TOGGLE_START , STATE_TOGGLE_END , STATE_BODY_BIT_START , STATE_BODY_BIT_END , STATE_FINISHED , } cocci_id@p ;
