...
position p;
@@
 enum bmc150_magn_power_modes cocci_id@p ;
...
typedef u8;
@@
 const struct {  int freq ;  u8 reg_val ; } cocci_id@p [ ] ;
...
typedef s32,bool;
@@
 struct bmc150_magn_data {  struct device * dev ;  struct mutex mutex ;  struct regmap * regmap ;  struct iio_mount_matrix orientation ;  s32 buffer [ 6 ] ;  struct iio_trigger * dready_trig ;  bool dready_trigger_on ;  int max_odr ;  int irq ; } cocci_id@p ;
...
position p;
@@
 enum bmc150_magn_axis { AXIS_X , AXIS_Y , AXIS_Z , RHALL , AXIS_XYZ_MAX = RHALL , AXIS_XYZR_MAX , } cocci_id@p ;
...
position p;
@@
 struct bmc150_magn_data * cocci_id@p ;
...
position p;
@@
 enum bmc150_magn_presets { LOW_POWER_PRESET , REGULAR_PRESET , ENHANCED_REGULAR_PRESET , HIGH_ACCURACY_PRESET , } cocci_id@p ;
...
position p;
@@
 enum bmc150_magn_power_modes { BMC150_MAGN_POWER_MODE_SUSPEND , BMC150_MAGN_POWER_MODE_SLEEP , BMC150_MAGN_POWER_MODE_NORMAL , } cocci_id@p ;
...
position p;
@@
 struct bmc150_magn_preset cocci_id@p ;
...
position p;
@@
 struct bmc150_magn_trim_regs * cocci_id@p ;
...
typedef u8;
@@
 const struct bmc150_magn_preset {  u8 rep_xy ;  u8 rep_z ;  u8 odr ; } cocci_id@p [ ] ;
