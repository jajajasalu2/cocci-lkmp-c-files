...
position p;
@@
 struct armada8k_pcie {  struct dw_pcie * pci ;  struct clk * clk ;  struct clk * clk_reg ;  struct phy * phy [ ARMADA8K_PCIE_MAX_LANES ] ;  unsigned int phy_count ; } cocci_id@p ;
...
position p;
@@
 struct armada8k_pcie * cocci_id@p ;
