...
typedef u32;
@@
 struct xsk_socket_info {  struct xsk_ring_cons rx ;  struct xsk_ring_prod tx ;  struct xsk_umem_info * umem ;  struct xsk_socket * xsk ;  unsigned long rx_npkts ;  unsigned long tx_npkts ;  unsigned long prev_rx_npkts ;  unsigned long prev_tx_npkts ;  u32 outstanding_tx ; } cocci_id@p ;
...
position p;
@@
 struct xsk_socket_info * cocci_id@p [ MAX_SOCKS ] ;
...
position p;
@@
 struct pollfd cocci_id@p [ MAX_SOCKS ] ;
...
position p;
@@
 struct ether_header * cocci_id@p ;
...
position p;
@@
 enum benchmark_type cocci_id@p ;
...
position p;
@@
 struct xsk_umem_info {  struct xsk_ring_prod fq ;  struct xsk_ring_cons cq ;  struct xsk_umem * umem ;  void * buffer ; } cocci_id@p ;
...
position p;
@@
 struct xsk_umem_info * cocci_id@p ;
...
position p;
@@
 struct xsk_socket_info * cocci_id@p ;
...
position p;
@@
 enum benchmark_type { BENCH_RXDROP = 0 , BENCH_TXONLY = 1 , BENCH_L2FWD = 2 , } cocci_id@p ;
