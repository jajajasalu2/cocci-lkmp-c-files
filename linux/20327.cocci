...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct device * dev , u32 gsi , int trigger , int polarity ) ;
...
position p;
@@
 enum acpi_irq_model_id cocci_id@p ;
...
position p;
@@
 struct acpi_table_boot * cocci_id@p ;
...
position p;
@@
 struct acpi_table_hpet * cocci_id@p ;
...
position p;
@@
 struct acpi_subtable_proc cocci_id@p [ 2 ] ;
...
symbol cocci_id;
position p;
typedef phys_cpuid_t;
@@
 phys_cpuid_t cocci_id@p ;
