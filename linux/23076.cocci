...
position p;
@@
 enum PINCTRL_PIN_STATE { PIN_STATE_DEFAULT = 0 , PIN_TDM_OUT_ON , PIN_TDM_OUT_OFF , PIN_WOV , PIN_STATE_MAX , } cocci_id@p ;
...
position p;
@@
 struct mt8183_mt6358_ts3a227_max98357_priv {  struct pinctrl * pinctrl ;  struct pinctrl_state * pin_states [ PIN_STATE_MAX ] ;  struct snd_soc_jack headset_jack ; } cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ PIN_STATE_MAX ] ;
...
position p;
@@
 struct mt8183_mt6358_ts3a227_max98357_priv * cocci_id@p ;
