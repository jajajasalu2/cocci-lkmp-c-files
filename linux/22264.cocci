...
position p;
@@
 struct selinux_mnt_opts cocci_id@p ;
...
position p;
@@
 const struct inode_security_struct * cocci_id@p ;
...
position p;
@@
 struct task_security_struct cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct file * file , u32 sid ) ;
...
position p;
@@
 const struct superblock_security_struct * cocci_id@p ;
...
position p;
@@
 struct superblock_security_struct * cocci_id@p ;
...
position p;
@@
 struct file_security_struct cocci_id@p ;
...
position p;
@@
 struct bpf_security_struct * cocci_id@p ;
...
position p;
@@
 struct key_security_struct cocci_id@p ;
...
position p;
@@
 struct msg_security_struct cocci_id@p ;
...
position p;
@@
 struct selinux_state cocci_id@p ;
...
position p;
@@
 struct lsm_ibendport_audit cocci_id@p ;
...
position p;
@@
 struct sk_security_struct * cocci_id@p ;
...
position p;
@@
 const struct linux_binprm * cocci_id@p ;
...
position p;
@@
 enum kernel_read_file_id cocci_id@p ;
...
position p;
@@
 struct inode_security_struct cocci_id@p ;
...
position p;
@@
 struct ib_security_struct * cocci_id@p ;
...
position p;
@@
 struct lsm_blob_sizes cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kernel_cap_t;
@@
 kernel_cap_t * cocci_id@p ;
...
position p;
@@
 struct lsm_ioctlop_audit cocci_id@p ;
...
position p;
@@
 struct common_audit_data cocci_id@p ;
...
position p;
@@
 struct linux_binprm * cocci_id@p ;
...
position p;
@@
 const struct selinux_mnt_opts * cocci_id@p ;
...
typedef bool;
@@
 struct {  const char * name ;  int len ;  int opt ;  bool has_arg ; } cocci_id@p [ ] ;
...
position p;
@@
 struct kern_ipc_perm * cocci_id@p ;
...
position p;
@@
 struct tty_file_private cocci_id@p ;
...
position p;
@@
 enum { Opt_error = - 1 , Opt_context = 0 , Opt_defcontext = 1 , Opt_fscontext = 2 , Opt_rootcontext = 3 , Opt_seclabel = 4 , } cocci_id@p ;
...
position p;
@@
 const struct request_sock * cocci_id@p ;
...
position p;
@@
 struct tun_security_struct * cocci_id@p ;
...
position p;
@@
 struct request_sock * cocci_id@p ;
...
position p;
@@
 struct perf_event_security_struct * cocci_id@p ;
...
position p;
@@
 struct lsm_ibpkey_audit cocci_id@p ;
...
position p;
@@
 struct ipc_security_struct cocci_id@p ;
...
position p;
@@
 enum kernel_load_data_id cocci_id@p ;
...
position p;
@@
 const struct super_block * cocci_id@p ;
...
position p;
@@
 struct kernel_siginfo * cocci_id@p ;
...
position p;
@@
 const struct nf_hook_state * cocci_id@p ;
...
position p;
@@
 struct security_hook_list cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct dentry * opt_dentry ) ;
...
position p;
@@
 struct lsm_network_audit cocci_id@p ;
...
position p;
@@
 const struct task_security_struct * cocci_id@p ;
