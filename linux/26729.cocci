...
position p;
@@
 struct component_name * cocci_id@p ;
...
position p;
@@
 struct dir_table_slot * cocci_id@p ;
...
typedef s16,s32;
@@
 struct dtoffset {  s16 pn ;  s16 index ;  s32 unused ; } * cocci_id@p ;
...
typedef dtpage_t;
@@
 void cocci_id@p ( dtpage_t * p , int m , struct dt_lock * * dtlock ) ;
...
typedef tid_t;
@@
 int cocci_id@p ( tid_t tid , struct inode * ip , struct dtsplit * split , struct btstack * btstack ) ;
...
position p;
@@
 struct dir_table_slot cocci_id@p [ 12 ] ;
...
typedef dtpage_t;
@@
 void cocci_id@p ( dtpage_t * p , int ti , struct dt_lock * * dtlock ) ;
...
typedef dtpage_t;
@@
 void cocci_id@p ( dtpage_t * p , int fi , struct dt_lock * * dtlock ) ;
...
typedef u16,loff_t;
@@
 struct jfs_dirent {  loff_t position ;  int ino ;  u16 name_len ;  char name [ 0 ] ; } cocci_id@p ;
...
typedef s16,ddata_t;
@@
 struct dtsplit {  struct metapage * mp ;  s16 index ;  s16 nslot ;  struct component_name * key ;  ddata_t * data ;  struct pxdlist * pxdlist ; } cocci_id@p ;
...
position p;
@@
 struct jfs_inode_info * cocci_id@p ;
...
typedef dtpage_t;
@@
 void cocci_id@p ( dtpage_t * p , int i , struct component_name * key , int flag ) ;
...
typedef tid_t;
@@
 int cocci_id@p ( tid_t tid , struct inode * ip , struct dtsplit * split , struct metapage * * rmpp ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * ip , struct btstack * btstack ) ;
