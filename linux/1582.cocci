...
@@
 struct moschip_port {  int port_num ;  struct urb * read_urb ;  __u8 shadowLCR ;  __u8 shadowMCR ;  struct usb_serial_port * port ;  __u8 SpRegOffset ;  __u8 ControlRegOffset ;  __u8 DcrRegOffset ;  spinlock_t pool_lock ;  struct urb * write_urb_pool [ NUM_URBS ] ;  char busy [ NUM_URBS ] ;  bool read_urb_busy ;  bool has_led ;  struct timer_list led_timer1 ;  struct timer_list led_timer2 ;  struct urb * led_urb ;  struct usb_ctrlrequest * led_dr ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 enum mos7840_flag { MOS7840_FLAG_LED_BUSY , } cocci_id@p ;
