...
position p;
@@
 struct ixp4xx_gpio {  struct device * dev ;  struct fwnode_handle * fwnode ;  struct gpio_chip gc ;  void __iomem * base ;  unsigned long long irq_edge ; } cocci_id@p ;
