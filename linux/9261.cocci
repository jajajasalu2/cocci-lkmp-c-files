...
position p;
@@
 struct host_cmd_ds_txbuf_cfg cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_amsdu_aggr_ctrl * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_tx_ba_stream_tbl * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_11n_delba cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_11n_cfg cocci_id@p ;
...
position p;
@@
 enum mwifiex_ba_status cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_2040bssco * cocci_id@p ;
...
position p;
@@
 struct mwifiex_tx_ba_stream_tbl * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_rx_reorder_tbl * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_11n_addba_req cocci_id@p ;
...
position p;
@@
 struct mwifiex_rx_reorder_tbl * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_11n_addba_rsp * cocci_id@p ;
