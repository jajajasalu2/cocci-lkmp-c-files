...
position p;
@@
 struct dpu_reg_dma_cfg cocci_id@p ;
...
position p;
@@
 struct dpu_mdss_hw_cfg_handler cocci_id@p [ ] ;
...
position p;
@@
 struct dpu_pingpong_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct dpu_sspp_cfg cocci_id@p [ ] ;
...
position p;
@@
 const struct dpu_sspp_blks_common cocci_id@p ;
...
position p;
@@
 struct dpu_perf_cfg cocci_id@p ;
...
position p;
@@
 const struct dpu_pingpong_sub_blks cocci_id@p ;
...
position p;
@@
 struct dpu_qos_lut_entry cocci_id@p [ ] ;
...
position p;
@@
 struct dpu_intf_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct dpu_vbif_cfg cocci_id@p [ ] ;
...
position p;
@@
 const struct dpu_lm_sub_blks cocci_id@p ;
...
position p;
@@
 const struct dpu_caps cocci_id@p ;
