...
position p;
@@
 struct insn_emulation {  struct list_head node ;  struct insn_emulation_ops * ops ;  int current_mode ;  int min ;  int max ; } cocci_id@p ;
...
position p;
@@
 struct insn_emulation_ops cocci_id@p ;
...
position p;
@@
 enum insn_emulation_mode { INSN_UNDEF , INSN_EMULATE , INSN_HW , } cocci_id@p ;
...
position p;
@@
 enum legacy_insn_status { INSN_DEPRECATED , INSN_OBSOLETE , } cocci_id@p ;
...
position p;
@@
 struct insn_emulation * cocci_id@p ;
...
position p;
@@
 enum insn_emulation_mode cocci_id@p ;
...
typedef bool;
@@
 struct insn_emulation_ops {  const char * name ;  enum legacy_insn_status status ;  struct undef_hook * hooks ;  int ( * set_hw_mode ) ( bool enable ) ; } cocci_id@p ;
