...
position p;
@@
 struct s3c_hwmon_chcfg * cocci_id@p ;
...
position p;
@@
 struct s3c_hwmon_attr * cocci_id@p ;
...
position p;
@@
 struct s3c_hwmon {  struct mutex lock ;  struct s3c_adc_client * client ;  struct device * hwmon_dev ;  struct s3c_hwmon_attr attrs [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct s3c_hwmon_attr {  struct sensor_device_attribute in ;  struct sensor_device_attribute label ;  char in_name [ 12 ] ;  char label_name [ 12 ] ; } cocci_id@p ;
