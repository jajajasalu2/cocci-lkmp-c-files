...
position p;
@@
 void cocci_id@p ( struct platform_device * pdev , int use_thermistors ) ;
...
position p;
@@
 struct attribute * cocci_id@p [ ] [ 10 ] ;
...
position p;
@@
 struct pc87360_data * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct pc87360_data * data , u8 ldi , u8 bank , u8 reg , u8 value ) ;
...
position p;
@@
 struct pc87360_data * cocci_id@p ( struct device * dev ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct pc87360_data * data , u8 ldi , u8 bank , u8 reg ) ;
