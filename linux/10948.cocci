...
position p;
@@
 struct amdgpu_ctx_entity cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ AMDGPU_HW_IP_NUM ] ;
...
position p;
@@
 struct amdgpu_ring * cocci_id@p [ AMDGPU_MAX_RINGS ] ;
...
position p;
@@
 struct drm_sched_rq * cocci_id@p [ AMDGPU_MAX_RINGS ] ;
...
position p;
@@
 union drm_amdgpu_ctx * cocci_id@p ;
...
position p;
@@
 union drm_amdgpu_ctx_out * cocci_id@p ;
...
position p;
@@
 struct amdgpu_ctx_mgr * cocci_id@p ;
