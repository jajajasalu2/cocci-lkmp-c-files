...
position p;
@@
 void cocci_id@p ( gdth_evt_data * dvr , char * buffer ) ;
...
typedef u16;
@@
 int cocci_id@p ( gdth_ha_str * ha , u16 hdrive ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( gdth_ha_str * ha , int gdth_from_wait , int * pIndex ) ;
...
typedef u8;
@@
 int cocci_id@p ( gdth_ha_str * ha , int service , u8 index , struct scsi_cmnd * scp ) ;
...
typedef u8;
@@
 void cocci_id@p ( gdth_ha_str * ha , struct scsi_cmnd * scp , u8 priority ) ;
...
typedef u16;
@@
 gdth_evt_str * cocci_id@p ( gdth_ha_str * ha , u16 source , u16 idx , gdth_evt_data * evt ) ;
...
position p;
@@
 struct gdth_cmndinfo cocci_id@p ;
...
position p;
@@
 gdth_evt_str cocci_id@p [ MAX_EVENTS ] ;
...
typedef u16;
@@
 int cocci_id@p ( gdth_ha_str * ha , struct scsi_cmnd * scp , u16 hdrive ) ;
...
position p;
@@
 const char * cocci_id@p ( gdth_ha_str * ha ) ;
...
typedef u8;
@@
 void cocci_id@p ( gdth_ha_str * ha , u8 application , gdth_evt_str * estr ) ;
...
position p;
@@
 gdth_raw_iochan_str * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_COMMAND_SIZE ] ;
...
typedef u16;
@@
 void cocci_id@p ( gdth_ha_str * ha , struct scsi_cmnd * scp , char * buffer , u16 count ) ;
...
position p;
@@
 int cocci_id@p ( gdth_ha_str * ha , int handle , gdth_evt_str * estr ) ;
...
position p;
@@
 int cocci_id@p ( gdth_pci_str * pcistr , gdth_ha_str * * ha_out ) ;
...
position p;
@@
 void cocci_id@p ( gdth_ha_str * ha ) ;
...
position p;
@@
 void cocci_id@p ( int milliseconds ) ;
...
@@
 int cocci_id@p ( gdth_ha_str * ha , u8 service , u16 opcode , u32 p1 , u64 p2 , u64 p3 ) ;
...
typedef u32;
@@
 int cocci_id@p ( gdth_ha_str * ha , int index , u32 time ) ;
...
position p;
@@
 int cocci_id@p ( gdth_ha_str * ha , struct scsi_cmnd * scp , struct gdth_cmndinfo * cmndinfo ) ;
...
position p;
@@
 long cocci_id@p ( struct file * filep , unsigned int cmd , unsigned long arg ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * scp ) ;
...
typedef u32;
@@
 void cocci_id@p ( u32 size , u32 * cyls , int * heads , int * secs ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct file * filep ) ;
...
position p;
@@
 int cocci_id@p ( gdth_ha_str * ha , struct scsi_cmnd * scp ) ;
...
typedef u8;
@@
 int cocci_id@p ( gdth_ha_str * ha , struct scsi_cmnd * scp , u8 b ) ;
