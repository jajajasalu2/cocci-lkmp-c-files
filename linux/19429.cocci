...
position p;
@@
 const struct trap_handler_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct task_struct * task , unsigned long pc , unsigned long fp , unsigned long leaf_return , struct stack_trace * trace ) ;
...
position p;
@@
 const struct cpu_context * cocci_id@p ;
