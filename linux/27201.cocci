...
position p;
@@
 struct backing_dev_info * cocci_id@p ;
...
position p;
@@
 struct ext4_lazy_init * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , int * flags , char * data ) ;
...
typedef __u16;
@@
 const struct ext4_sb_encodings {  __u16 magic ;  char * name ;  char * version ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ext4_group_desc * cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ EXT4_MAXQUOTAS ] ;
...
position p;
@@
 const struct fscrypt_operations cocci_id@p ;
...
position p;
@@
 struct ext4_super_block * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ EXT4_MAXQUOTAS ] ;
...
symbol cocci_id;
position p;
typedef ext4_fsblk_t;
@@
 ext4_fsblk_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , int type , int format_id , unsigned int flags ) ;
...
position p;
@@
 int cocci_id@p ( struct dentry * dentry , struct kstatfs * buf ) ;
...
position p;
@@
 const struct dquot_operations cocci_id@p ;
...
position p;
@@
 const struct mount_opts {  int token ;  int mount_opt ;  int flags ; } cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef ext4_group_t;
@@
 ext4_group_t cocci_id@p ;
...
position p;
@@
 struct ext4_journal_cb_entry * cocci_id@p ;
...
position p;
@@
 struct inode * cocci_id@p ( struct super_block * sb , unsigned int journal_inum ) ;
...
position p;
@@
 const struct match_token * cocci_id@p ;
...
position p;
@@
 struct ext4_li_request cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ EXT4_MAXQUOTAS ] ;
...
position p;
@@
 const struct ext4_sb_encodings * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dquot * dquot ) ;
...
position p;
@@
 struct dentry * cocci_id@p ( struct file_system_type * fs_type , int flags , const char * dev_name , void * data ) ;
...
position p;
@@
 struct ext4_group_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , int wait ) ;
...
position p;
@@
 struct ext4_mount_options cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , int type , int format_id , const struct path * path ) ;
...
position p;
@@
 void cocci_id@p ( struct super_block * sb ) ;
...
position p;
@@
 const struct export_operations cocci_id@p ;
...
position p;
@@
 const struct ext4_super_block * cocci_id@p ;
...
position p;
@@
 struct blockgroup_lock cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct seq_file * seq , struct dentry * root ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , int sync ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , int readonly ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , int type ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * , struct ext4_super_block * , unsigned long journal_devnum ) ;
...
@@
 wait_queue_head_t cocci_id@p [ EXT4_WQ_HASH_SZ ] ;
...
position p;
@@
 const struct mount_opts * cocci_id@p ;
...
position p;
@@
 const struct quotactl_ops cocci_id@p ;
...
position p;
@@
 struct ratelimit_state cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct super_block * sb , struct ext4_super_block * es ) ;
