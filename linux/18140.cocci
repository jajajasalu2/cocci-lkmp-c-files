...
position p;
@@
 union {  char c [ 4 ] ;  unsigned long l ; } cocci_id@p ;
...
position p;
@@
 struct proc_info_list * cocci_id@p ( unsigned int ) ;
...
position p;
@@
 struct cpu_cache_fns cocci_id@p ;
...
position p;
@@
 struct proc_info_list * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct machine_desc * ) ;
...
position p;
@@
 void cocci_id@p ( const struct machine_desc * desc ) ;
...
position p;
@@
 struct cpu_user_fns cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ELF_PLATFORM_SIZE ] ;
...
position p;
@@
 struct processor * cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct stack cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct outer_cache_fns cocci_id@p ;
