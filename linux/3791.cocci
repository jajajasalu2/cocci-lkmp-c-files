...
position p;
@@
 struct rsa_priv_f2_pdb * cocci_id@p ;
...
position p;
@@
 struct caam_rsa_ctx cocci_id@p ;
...
position p;
@@
 struct rsa_priv_f3_pdb * cocci_id@p ;
...
position p;
@@
 struct caam_rsa_key * cocci_id@p ;
...
position p;
@@
 struct caam_rsa_req_ctx * cocci_id@p ;
...
position p;
@@
 struct rsa_priv_f1_pdb * cocci_id@p ;
...
typedef bool;
@@
 struct caam_akcipher_alg {  struct akcipher_alg akcipher ;  bool registered ; } cocci_id@p ;
...
position p;
@@
 struct caam_akcipher_alg cocci_id@p ;
