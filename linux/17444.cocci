...
position p;
@@
 struct spu_dma_info cocci_id@p ;
...
position p;
@@
 const struct spufs_tree_descr cocci_id@p [ ] ;
...
position p;
@@
 enum spu_utilization_state cocci_id@p ;
...
position p;
@@
 const struct spufs_coredump_reader cocci_id@p [ ] ;
...
position p;
@@
 struct spu_reg128 cocci_id@p [ 128 ] ;
...
typedef u64;
@@
 struct spufs_attr {  int ( * get ) ( void * , u64 * ) ;  int ( * set ) ( void * , u64 ) ;  char get_buf [ 24 ] ;  char set_buf [ 24 ] ;  void * data ;  const char * fmt ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 struct switch_log_entry * cocci_id@p ;
...
position p;
@@
 struct spufs_inode_info * cocci_id@p ;
...
position p;
@@
 struct mfc_dma_command * cocci_id@p ;
...
position p;
@@
 struct spu_proxydma_info cocci_id@p ;
