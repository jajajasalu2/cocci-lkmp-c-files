...
position p;
@@
 struct tipc_service * cocci_id@p ;
...
@@
 struct tipc_service {  u32 type ;  u32 publ_cnt ;  struct rb_root ranges ;  struct hlist_node service_list ;  struct list_head subscriptions ;  spinlock_t lock ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct service_range cocci_id@p ;
...
typedef u32;
@@
 struct service_range {  u32 lower ;  u32 upper ;  struct rb_node tree_node ;  u32 max ;  struct list_head local_publ ;  struct list_head all_publ ; } cocci_id@p ;
