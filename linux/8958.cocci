...
@@
 struct l2t_data {  unsigned int l2t_start ;  unsigned int l2t_size ;  rwlock_t lock ;  atomic_t nfree ;  struct l2t_entry * rover ;  struct l2t_entry l2tab [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct l2t_skb_cb * cocci_id@p ;
...
position p;
@@
 enum { L2T_MIN_HASH_BUCKETS = 2 , } cocci_id@p ;
