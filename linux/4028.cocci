...
@@
 struct mtk_sysirq_chip_data {  spinlock_t lock ;  u32 nr_intpol_bases ;  void __iomem * * intpol_bases ;  u32 * intpol_words ;  u8 * intpol_idx ;  u16 * which_word ; } cocci_id@p ;
...
position p;
@@
 struct mtk_sysirq_chip_data * cocci_id@p ;
