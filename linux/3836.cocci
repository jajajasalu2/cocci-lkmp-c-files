...
position p;
@@
 struct atmel_tdes_dev cocci_id@p ;
...
typedef spinlock_t;
@@
 struct atmel_tdes_drv {  struct list_head dev_list ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u8;
@@
 struct atmel_tdes_reqctx {  unsigned long mode ;  u8 lastc [ DES_BLOCK_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct atmel_tdes_ctx cocci_id@p ;
...
position p;
@@
 struct atmel_tdes_reqctx * cocci_id@p ;
...
typedef bool,u32;
@@
 struct atmel_tdes_caps {  bool has_dma ;  u32 has_cfb_3keys ; } cocci_id@p ;
...
position p;
@@
 struct atmel_tdes_dma {  struct dma_chan * chan ;  struct dma_slave_config dma_conf ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct atmel_tdes_ctx {  struct atmel_tdes_dev * dd ;  int keylen ;  u32 key [ DES3_EDE_KEY_SIZE / sizeof ( u32 ) ] ;  unsigned long flags ;  u16 block_size ; } cocci_id@p ;
...
position p;
@@
 struct atmel_tdes_drv cocci_id@p ;
