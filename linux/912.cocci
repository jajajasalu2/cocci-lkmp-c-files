...
position p;
@@
 enum { MICRON_ON_DIE_UNSUPPORTED , MICRON_ON_DIE_SUPPORTED , MICRON_ON_DIE_MANDATORY , } cocci_id@p ;
...
position p;
@@
 struct nand_onfi_params * cocci_id@p ;
...
position p;
@@
 struct nand_onfi_vendor_micron * cocci_id@p ;
...
position p;
@@
 struct nand_parameters * cocci_id@p ;
...
position p;
@@
 struct micron_nand {  struct micron_on_die_ecc ecc ; } cocci_id@p ;
...
typedef bool;
@@
 struct micron_on_die_ecc {  bool forced ;  bool enabled ;  void * rawbuf ; } cocci_id@p ;
