...
position p;
@@
 struct gbe_timing_info * cocci_id@p ;
...
position p;
@@
 struct gbe_pll_info {  int clock_rate ;  int fvco_min ;  int fvco_max ; } cocci_id@p ;
...
position p;
@@
 struct gbe_pll_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint16_t,dma_addr_t;
@@
 struct {  uint16_t * cpu ;  dma_addr_t dma ; } cocci_id@p ;
...
position p;
@@
 struct gbe_pll_info cocci_id@p [ 2 ] ;
...
position p;
@@
 struct gbefb_par {  struct fb_var_screeninfo var ;  struct gbe_timing_info timing ;  int wc_cookie ;  int valid ; } cocci_id@p ;
