...
position p;
@@
 struct fujitsu_config {  unsigned short keymap [ KEYMAP_LEN ] ;  unsigned int quirks ; } cocci_id@p ;
...
position p;
@@
 struct {  struct input_dev * idev ;  struct fujitsu_config config ;  unsigned long prev_keymask ;  char phys [ 21 ] ;  int irq ;  int io_base ;  int io_length ; } cocci_id@p ;
