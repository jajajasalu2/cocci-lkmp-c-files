...
position p;
@@
 struct qe_init_block cocci_id@p ;
...
position p;
@@
 struct sunqe_buffers cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sunqe * qep ) ;
