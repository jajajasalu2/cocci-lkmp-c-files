...
position p;
@@
 const char * cocci_id@p [ __PARSE_EVENTS__TERM_TYPE_NR ] ;
...
position p;
@@
 struct event_symbol cocci_id@p [ PERF_COUNT_HW_MAX ] ;
...
position p;
@@
 struct parse_events_term * cocci_id@p ;
...
position p;
@@
 struct __add_bpf_event_param {  struct parse_events_state * parse_state ;  struct list_head * list ;  struct list_head * head_config ; } cocci_id@p ;
...
position p;
@@
 struct tracepoint_path * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ ] [ PERF_EVSEL__MAX_ALIASES ] ;
...
position p;
@@
 struct parse_events_state cocci_id@p ;
...
position p;
@@
 struct event_modifier cocci_id@p ;
...
position p;
@@
 struct perf_pmu_event_symbol * cocci_id@p ;
...
position p;
@@
 struct perf_evsel_config_term * cocci_id@p ;
...
position p;
@@
 struct event_symbol cocci_id@p [ PERF_COUNT_SW_MAX ] ;
...
position p;
@@
 struct parse_events_array * cocci_id@p ;
...
position p;
@@
 struct event_modifier {  int eu ;  int ek ;  int eh ;  int eH ;  int eG ;  int eI ;  int precise ;  int precise_max ;  int exclude_GH ;  int sample_read ;  int pinned ;  int weak ; } cocci_id@p ;
...
position p;
@@
 enum perf_pmu_event_symbol_type cocci_id@p ;
...
position p;
@@
 struct parse_events_error cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct perf_event_attr * attr , struct parse_events_term * term , struct parse_events_error * err ) ;
...
position p;
@@
 struct strlist_config cocci_id@p ;
...
position p;
@@
 struct event_symbol * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct list_head * head_config , struct list_head * head_terms __maybe_unused ) ;
...
position p;
@@
 struct perf_pmu_alias * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * parse_state , void * scanner ) ;
...
position p;
@@
 struct probe_cache_entry * cocci_id@p ;
...
position p;
@@
 struct perf_pmu_info cocci_id@p ;
...
position p;
@@
 enum perf_tool_event cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ __PARSE_EVENTS__TERM_TYPE_NR * ( sizeof ( "no-overwrite" ) - 1 ) ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct evsel * evsel , const void * arg ) ;
...
symbol cocci_id;
position p;
typedef config_term_func_t;
@@
 config_term_func_t cocci_id@p ;
