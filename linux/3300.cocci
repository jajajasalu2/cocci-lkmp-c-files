...
typedef s8,u8;
@@
 struct adm1029_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  s8 temp [ ARRAY_SIZE ( ADM1029_REG_TEMP ) ] ;  u8 fan [ ARRAY_SIZE ( ADM1029_REG_FAN ) ] ;  u8 fan_div [ ARRAY_SIZE ( ADM1029_REG_FAN_DIV ) ] ; } cocci_id@p ;
...
position p;
@@
 struct adm1029_data * cocci_id@p ;
