...
position p;
@@
 struct ixgbe_mbx_operations cocci_id@p ;
...
position p;
@@
 struct ixgbe_adv_tx_context_desc * cocci_id@p ;
...
position p;
@@
 struct ixgbevf_ipsec_tx_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ixgbevf_ring * rx_ring , struct ixgbevf_rx_buffer * old_buff ) ;
...
position p;
@@
 const struct ixgbevf_info * cocci_id@p [ ] ;
...
position p;
@@
 struct ixgbevf_rx_buffer * cocci_id@p ;
...
position p;
@@
 struct ixgbevf_q_vector * cocci_id@p ;
...
position p;
@@
 struct ixgbevf_adapter * cocci_id@p ;
...
position p;
@@
 union {  struct tcphdr * tcp ;  unsigned char * hdr ; } cocci_id@p ;
...
position p;
@@
 struct ixgbevf_tx_buffer * cocci_id@p ;
...
position p;
@@
 struct ixgbevf_ring * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ixgbevf_q_vector * q_vector ) ;
...
position p;
@@
 void cocci_id@p ( struct ixgbevf_adapter * adapter ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ixgbevf_rx_buffer * rx_buffer ) ;
...
position p;
@@
 struct ixgbevf_ring_container * cocci_id@p ;
...
position p;
@@
 const struct ixgbevf_ring * cocci_id@p ;
