...
position p;
@@
 struct da9052_led {  struct led_classdev cdev ;  struct da9052 * da9052 ;  unsigned char led_index ;  unsigned char id ; } cocci_id@p ;
...
position p;
@@
 struct led_platform_data * cocci_id@p ;
