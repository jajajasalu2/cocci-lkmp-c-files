...
position p;
@@
 struct ac100_rtc_dev {  struct rtc_device * rtc ;  struct device * dev ;  struct regmap * regmap ;  int irq ;  unsigned long alarm ;  struct clk_hw * rtc_32k_clk ;  struct ac100_clkout clks [ AC100_CLKOUT_NUM ] ;  struct clk_hw_onecell_data * clk_data ; } cocci_id@p ;
...
position p;
@@
 struct ac100_rtc_dev * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ AC100_CLKOUT_NUM ] ;
...
typedef u8;
@@
 struct ac100_clkout {  struct clk_hw hw ;  struct regmap * regmap ;  u8 offset ; } cocci_id@p ;
...
position p;
@@
 struct ac100_clkout cocci_id@p ;
