...
position p;
@@
 struct iscsi_text_request_hdr cocci_id@p ;
...
position p;
@@
 struct iscsi_task_params cocci_id@p ;
...
position p;
@@
 struct iscsi_scsi_rsp * cocci_id@p ;
...
position p;
@@
 struct qedi_work_map * cocci_id@p ;
...
position p;
@@
 struct iscsi_async_msg_hdr * cocci_id@p ;
...
position p;
@@
 struct iscsi_tmf_response_hdr * cocci_id@p ;
...
position p;
@@
 struct iscsi_login_rsp * cocci_id@p ;
...
position p;
@@
 struct e4_iscsi_task_context cocci_id@p ;
...
position p;
@@
 struct iscsi_nopout * cocci_id@p ;
...
position p;
@@
 enum iscsi_task_type cocci_id@p ;
...
position p;
@@
 struct iscsi_conn_params cocci_id@p ;
...
position p;
@@
 struct iscsi_db_data cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qedi_conn * qedi_conn , struct iscsi_task * mtask ) ;
...
position p;
@@
 struct iscsi_nop_in_hdr * cocci_id@p ;
...
position p;
@@
 struct scsi_initiator_cmd_params cocci_id@p ;
...
position p;
@@
 struct iscsi_login_req * cocci_id@p ;
...
position p;
@@
 struct iscsi_cqe_solicited * cocci_id@p ;
...
position p;
@@
 struct iscsi_login_response_hdr * cocci_id@p ;
...
position p;
@@
 struct iscsi_login_req_hdr cocci_id@p ;
...
position p;
@@
 struct iscsi_logout * cocci_id@p ;
...
position p;
@@
 struct iscsi_text_response_hdr * cocci_id@p ;
...
position p;
@@
 struct iscsi_cqe_unsolicited * cocci_id@p ;
...
position p;
@@
 struct iscsi_reject_hdr * cocci_id@p ;
...
position p;
@@
 struct iscsi_cmd_hdr cocci_id@p ;
...
position p;
@@
 struct iscsi_scsi_req * cocci_id@p ;
...
position p;
@@
 struct iscsi_logout_response_hdr * cocci_id@p ;
...
position p;
@@
 struct iscsi_reject * cocci_id@p ;
...
position p;
@@
 struct iscsi_logout_req_hdr cocci_id@p ;
...
position p;
@@
 struct iscsi_text_rsp * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ QEDI_BDQ_BUF_SIZE ] ;
...
position p;
@@
 struct qedi_endpoint * cocci_id@p ;
...
position p;
@@
 struct scsi_sgl_task_params cocci_id@p ;
...
position p;
@@
 struct iscsi_tmf_request_hdr cocci_id@p ;
...
position p;
@@
 struct iscsi_nop_out_hdr cocci_id@p ;
...
position p;
@@
 struct iscsi_data_in_hdr * cocci_id@p ;
