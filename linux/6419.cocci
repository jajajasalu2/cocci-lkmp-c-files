...
position p;
@@
 struct max8649_regulator_info * cocci_id@p ;
...
position p;
@@
 struct max8649_platform_data * cocci_id@p ;
...
position p;
@@
 struct max8649_regulator_info {  struct device * dev ;  struct regmap * regmap ;  unsigned mode : 2 ;  unsigned extclk_freq : 2 ;  unsigned extclk : 1 ;  unsigned ramp_timing : 3 ;  unsigned ramp_down : 1 ; } cocci_id@p ;
