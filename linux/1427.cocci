...
position p;
@@
 struct pch_udc_request cocci_id@p ;
...
typedef u16;
@@
 struct pch_udc_cfg_data {  u16 cur_cfg ;  u16 cur_intf ;  u16 cur_alt ; } cocci_id@p ;
...
position p;
@@
 struct pch_vbus_gpio_data cocci_id@p ;
...
typedef u32;
@@
 struct pch_udc_data_dma_desc {  u32 status ;  u32 reserved ;  u32 dataptr ;  u32 next ; } cocci_id@p ;
...
position p;
@@
 struct pch_vbus_gpio_data {  int port ;  int intr ;  struct work_struct irq_work_fall ;  struct work_struct irq_work_rise ; } cocci_id@p ;
...
position p;
@@
 struct pch_udc_stp_dma_desc * cocci_id@p ;
...
position p;
@@
 struct pch_udc_data_dma_desc cocci_id@p ;
...
position p;
@@
 struct pch_udc_cfg_data * cocci_id@p ;
...
typedef u32;
@@
 struct pch_udc_stp_dma_desc {  u32 status ;  u32 reserved ;  struct usb_ctrlrequest request ; } __attribute ( ( packed ) ) cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pch_udc_dev * dev ) ;
