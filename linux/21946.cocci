...
typedef gfp_t;
@@
 struct string_stream_fragment_alloc_context {  struct kunit * test ;  int len ;  gfp_t gfp ; } cocci_id@p ;
...
position p;
@@
 struct string_stream_alloc_context * cocci_id@p ;
...
typedef gfp_t;
@@
 struct string_stream_alloc_context {  struct kunit * test ;  gfp_t gfp ; } cocci_id@p ;
...
position p;
@@
 struct string_stream_fragment_alloc_context * cocci_id@p ;
