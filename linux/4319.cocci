...
position p;
@@
 struct telemetry_debugfs_conf cocci_id@p ;
...
typedef u32;
@@
 struct telem_ioss_d0ix_stateinfo {  const char * name ;  u32 bit_pos ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ TELEM_PSS_IDLE_BLOCKED_EVTS ] ;
...
position p;
@@
 struct telem_ioss_d0ix_stateinfo cocci_id@p [ ] ;
...
position p;
@@
 struct telemetry_evtlog cocci_id@p [ TELEM_MAX_OS_ALLOCATED_EVENTS ] ;
...
position p;
@@
 struct telem_pss_ltr_info cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct telemetry_debugfs_conf {  struct telemetry_susp_stats suspend_stats ;  struct dentry * telemetry_dbg_dir ;  struct telem_ioss_d0ix_stateinfo * ioss_d0ix_data ;  struct telem_pss_idle_stateinfo * pss_idle_data ;  struct telem_pcs_blkd_info * pcs_idle_blkd_data ;  struct telem_pcs_blkd_info * pcs_s0ix_blkd_data ;  struct telem_pss_wakeup_info * pss_wakeup ;  struct telem_pss_ltr_info * pss_ltr_data ;  struct telem_ioss_pg_info * ioss_pg_data ;  u8 pcs_idle_blkd_evts ;  u8 pcs_s0ix_blkd_evts ;  u8 pss_wakeup_evts ;  u8 pss_idle_evts ;  u8 pss_ltr_evts ;  u8 ioss_d0ix_evts ;  u8 ioss_pg_evts ;  u16 pss_ltr_blocking_id ;  u16 pcs_idle_blkd_id ;  u16 pcs_s0ix_blkd_id ;  u16 s0ix_total_occ_id ;  u16 s0ix_shlw_occ_id ;  u16 s0ix_deep_occ_id ;  u16 s0ix_total_res_id ;  u16 s0ix_shlw_res_id ;  u16 s0ix_deep_res_id ;  u16 pss_wakeup_id ;  u16 ioss_d0ix_id ;  u16 pstates_id ;  u16 pss_idle_id ;  u16 ioss_d3_id ;  u16 ioss_pg_id ; } cocci_id@p ;
...
typedef u32;
@@
 struct telem_pcs_blkd_info {  const char * name ;  u32 bit_pos ; } cocci_id@p ;
...
typedef u32;
@@
 struct telem_pss_ltr_info {  const char * name ;  u32 bit_pos ; } cocci_id@p ;
...
position p;
@@
 struct telem_ioss_pg_info cocci_id@p [ ] ;
...
typedef u32;
@@
 struct telem_pss_idle_stateinfo {  const char * name ;  u32 bit_pos ; } cocci_id@p ;
...
position p;
@@
 struct telem_pcs_blkd_info cocci_id@p [ ] ;
...
typedef u64,u32;
@@
 struct telemetry_susp_stats {  u32 shlw_ctr ;  u32 deep_ctr ;  u64 shlw_res ;  u64 deep_res ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ TELEM_IOSS_DX_D0IX_EVTS ] ;
...
typedef u32;
@@
 struct telem_ioss_pg_info {  const char * name ;  u32 bit_pos ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ TELEM_IOSS_PG_EVTS ] ;
...
position p;
@@
 const char * cocci_id@p [ TELEM_MAX_OS_ALLOCATED_EVENTS ] ;
...
typedef u32;
@@
 struct telem_pss_wakeup_info {  const char * name ;  u32 bit_pos ; } cocci_id@p ;
...
position p;
@@
 struct telem_pss_wakeup_info cocci_id@p [ ] ;
...
position p;
@@
 struct telem_pss_idle_stateinfo cocci_id@p [ ] ;
