...
position p;
@@
 struct ccdc_config {  int vpfe_probed ;  char name [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct vpfe_config_params cocci_id@p ;
...
position p;
@@
 const struct vpfe_pixel_format * cocci_id@p ;
...
position p;
@@
 const struct ccdc_hw_device * cocci_id@p ;
