...
position p;
@@
 struct malidp_plane * cocci_id@p ;
...
typedef s16;
@@
 const s16 cocci_id@p [ ] [ DRM_COLOR_RANGE_MAX ] [ MALIDP_COLORADJ_NUM_COEFFS ] ;
...
position p;
@@
 struct malidp_crtc_state * cocci_id@p ;
...
position p;
@@
 enum mmu_prefetch_mode cocci_id@p ;
...
position p;
@@
 enum drm_color_encoding cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ MODIFIERS_COUNT_MAX ] ;
...
position p;
@@
 const struct malidp_hw_regmap * cocci_id@p ;
...
position p;
@@
 struct malidp_plane_state * cocci_id@p ;
...
position p;
@@
 enum drm_color_range cocci_id@p ;
