...
position p;
@@
 const struct batadv_gw_node * cocci_id@p ;
...
position p;
@@
 const struct batadv_forw_packet * cocci_id@p ;
...
position p;
@@
 enum batadv_dup_status cocci_id@p ;
...
position p;
@@
 struct batadv_hardif_neigh_node * cocci_id@p ;
...
position p;
@@
 const struct batadv_priv * cocci_id@p ;
...
position p;
@@
 enum batadv_dup_status { BATADV_NO_DUP = 0 , BATADV_ORIG_DUP , BATADV_NEIGH_DUP , BATADV_PROTECTED , } cocci_id@p ;
...
position p;
@@
 const struct batadv_ogm_packet * cocci_id@p ;
...
position p;
@@
 struct batadv_gw_node * cocci_id@p ;
