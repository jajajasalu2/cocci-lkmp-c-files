...
typedef u32,u16;
@@
 union {  u32 u32 ;  u16 u16 ; } * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_BYTEORDER_MAX + 1 ] ;
...
position p;
@@
 struct nft_byteorder cocci_id@p ;
...
typedef u8;
@@
 struct nft_byteorder {  enum nft_registers sreg : 8 ;  enum nft_registers dreg : 8 ;  enum nft_byteorder_ops op : 8 ;  u8 len ;  u8 size ; } cocci_id@p ;
...
position p;
@@
 const struct nft_byteorder * cocci_id@p ;
