...
position p;
@@
 struct rds_rdma_args * cocci_id@p ;
...
position p;
@@
 struct rds_iov_vector cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct list_head * messages , int status ) ;
...
position p;
@@
 struct rds_iov_vector_arr * cocci_id@p ;
...
position p;
@@
 struct rm_atomic_op * cocci_id@p ;
