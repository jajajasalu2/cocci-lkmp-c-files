...
typedef u8;
@@
 struct w83l786ng_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  unsigned long last_nonvolatile ;  u8 in [ 3 ] ;  u8 in_max [ 3 ] ;  u8 in_min [ 3 ] ;  u8 fan [ 2 ] ;  u8 fan_div [ 2 ] ;  u8 fan_min [ 2 ] ;  u8 temp_type [ 2 ] ;  u8 temp [ 2 ] [ 3 ] ;  u8 pwm [ 2 ] ;  u8 pwm_mode [ 2 ] ;  u8 pwm_enable [ 2 ] ;  u8 tolerance [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct w83l786ng_data cocci_id@p ;
