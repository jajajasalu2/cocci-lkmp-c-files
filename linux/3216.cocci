...
typedef ktime_t;
@@
 struct zl6100_data {  int id ;  ktime_t access ;  int delay ;  struct pmbus_driver_info info ; } cocci_id@p ;
...
position p;
@@
 const struct zl6100_data * cocci_id@p ;
...
position p;
@@
 enum chips { zl2004 , zl2005 , zl2006 , zl2008 , zl2105 , zl2106 , zl6100 , zl6105 , zl9101 , zl9117 , } cocci_id@p ;
