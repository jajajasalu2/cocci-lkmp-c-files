...
position p;
@@
 union drm_amdgpu_gem_mmap * cocci_id@p ;
...
position p;
@@
 union drm_amdgpu_gem_wait_idle * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_gem_op * cocci_id@p ;
...
position p;
@@
 union drm_amdgpu_gem_create * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_gem_create_in cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_gem_va * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_gem_metadata * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_gem_userptr * cocci_id@p ;
