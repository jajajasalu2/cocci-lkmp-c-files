...
position p;
@@
 enum uniphier_pin_drv_type cocci_id@p ;
...
position p;
@@
 const struct uniphier_pinctrl_group * cocci_id@p ;
...
position p;
@@
 struct uniphier_pinctrl_priv * cocci_id@p ;
...
position p;
@@
 const struct uniphier_pinctrl_socdata * cocci_id@p ;
...
typedef u32;
@@
 struct uniphier_pinctrl_reg_region {  struct list_head node ;  unsigned int base ;  unsigned int nregs ;  u32 vals [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_pinctrl_priv {  struct pinctrl_desc pctldesc ;  struct pinctrl_dev * pctldev ;  struct regmap * regmap ;  const struct uniphier_pinctrl_socdata * socdata ;  struct list_head reg_regions ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_pinctrl_reg_region * cocci_id@p ;
...
position p;
@@
 enum uniphier_pin_pull_dir cocci_id@p ;
