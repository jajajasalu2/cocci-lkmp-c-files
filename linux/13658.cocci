...
position p;
@@
 struct jlj_command {  unsigned char instruction [ 2 ] ;  unsigned char ack_wanted ;  unsigned char delay ; } cocci_id@p ;
...
position p;
@@
 const struct sd_desc * cocci_id@p [ 2 ] ;
...
position p;
@@
 enum { SAKAR_57379 , SPORTSCAM_DV15 , } cocci_id@p ;
