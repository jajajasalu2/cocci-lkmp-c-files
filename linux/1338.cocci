...
typedef __u8;
@@
 struct usb_lcd {  struct usb_device * udev ;  struct usb_interface * interface ;  unsigned char * bulk_in_buffer ;  size_t bulk_in_size ;  __u8 bulk_in_endpointAddr ;  __u8 bulk_out_endpointAddr ;  struct kref kref ;  struct semaphore limit_sem ;  struct usb_anchor submitted ;  struct rw_semaphore io_rwsem ;  unsigned long disconnected : 1 ; } cocci_id@p ;
