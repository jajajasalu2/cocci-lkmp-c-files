...
position p;
@@
 struct iwl_mvm_add_sta_cmd_v7 cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_mgmt_mcast_key_cmd_v1 cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_eosp_notification * cocci_id@p ;
...
position p;
@@
 enum iwl_mvm_agg_state cocci_id@p ;
...
position p;
@@
 const struct iwl_trans_txq_scd_cfg * cocci_id@p ;
...
position p;
@@
 enum iwl_mvm_queue_status cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_rm_sta_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_add_sta_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_int_sta * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_mgmt_mcast_key_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_trans_txq_scd_cfg cocci_id@p ;
...
position p;
@@
 union {  struct iwl_mvm_add_sta_key_cmd_v1 cmd_v1 ;  struct iwl_mvm_add_sta_key_cmd cmd ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IEEE80211_NUM_ACS ] ;
