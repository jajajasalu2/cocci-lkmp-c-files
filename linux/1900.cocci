...
position p;
@@
 enum conversion_mode_sel { VF610_ADC_CONV_NORMAL , VF610_ADC_CONV_HIGH_SPEED , VF610_ADC_CONV_LOW_POWER , } cocci_id@p ;
...
position p;
@@
 struct vf610_adc_feature * cocci_id@p ;
...
position p;
@@
 enum average_sel { VF610_ADC_SAMPLE_1 , VF610_ADC_SAMPLE_4 , VF610_ADC_SAMPLE_8 , VF610_ADC_SAMPLE_16 , VF610_ADC_SAMPLE_32 , } cocci_id@p ;
...
typedef u32,u16;
@@
 struct vf610_adc {  struct device * dev ;  void __iomem * regs ;  struct clk * clk ;  u32 vref_uv ;  u32 value ;  struct regulator * vref ;  u32 max_adck_rate [ 3 ] ;  struct vf610_adc_feature adc_feature ;  u32 sample_freq_avail [ 5 ] ;  struct completion completion ;  u16 buffer [ 8 ] ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct vf610_adc_feature {  enum clk_sel clk_sel ;  enum vol_ref vol_ref ;  enum conversion_mode_sel conv_mode ;  int clk_div ;  int sample_rate ;  int res_mode ;  u32 lst_adder_index ;  u32 default_sample_time ;  bool calibration ;  bool ovwren ; } cocci_id@p ;
...
position p;
@@
 enum clk_sel { VF610_ADCIOC_BUSCLK_SET , VF610_ADCIOC_ALTCLK_SET , VF610_ADCIOC_ADACK_SET , } cocci_id@p ;
...
position p;
@@
 enum vol_ref { VF610_ADCIOC_VR_VREF_SET , VF610_ADCIOC_VR_VALT_SET , VF610_ADCIOC_VR_VBG_SET , } cocci_id@p ;
...
position p;
@@
 enum lst_adder_sel { VF610_ADCK_CYCLES_3 , VF610_ADCK_CYCLES_5 , VF610_ADCK_CYCLES_7 , VF610_ADCK_CYCLES_9 , VF610_ADCK_CYCLES_13 , VF610_ADCK_CYCLES_17 , VF610_ADCK_CYCLES_21 , VF610_ADCK_CYCLES_25 , } cocci_id@p ;
