...
position p;
@@
 struct codegen_context cocci_id@p ;
...
position p;
@@
 struct powerpc64_jit_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct powerpc64_jit_data {  struct bpf_binary_header * header ;  u32 * addrs ;  u8 * image ;  u32 proglen ;  struct codegen_context ctx ; } cocci_id@p ;
