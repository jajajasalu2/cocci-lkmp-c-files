...
typedef bool;
@@
 struct sun8i_codec_analog_quirks {  bool has_headphone ;  bool has_hmic ;  bool has_linein ;  bool has_lineout ;  bool has_mbias ;  bool has_mic2 ; } cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( sun8i_codec_lineout_vol_scale , 
								       0 , 1 , 
...
position p;
@@
 const struct sun8i_codec_analog_quirks cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( sun8i_codec_out_mixer_pregain_scale , 
								       - 450 , 
								       150 , 0 ) ;
...
position p;
@@
 const  cocci_id@p ( sun8i_codec_mic_gain_scale , 
								       0 , 0 , 
