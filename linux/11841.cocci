...
position p;
@@
 const struct gm20b_clk_dvfs_params cocci_id@p ;
...
position p;
@@
 const struct gm20b_pll * cocci_id@p ;
...
position p;
@@
 const struct nvkm_clk_func cocci_id@p ;
...
typedef s32,u32;
@@
 struct gm20b_clk_dvfs_params {  s32 coeff_slope ;  s32 coeff_offs ;  u32 vco_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct gm20b_clk_dvfs * cocci_id@p ;
...
position p;
@@
 struct gk20a_clk_pllg_params * cocci_id@p ;
...
typedef s32,u32;
@@
 struct gm20b_clk {  struct gk20a_clk base ;  struct gm20b_clk_dvfs dvfs ;  u32 uv ;  struct gk20a_pll new_pll ;  struct gm20b_clk_dvfs new_dvfs ;  u32 new_uv ;  const struct gm20b_clk_dvfs_params * dvfs_params ;  s32 uvdet_slope ;  s32 uvdet_offs ;  u32 safe_fmax_vmin ; } cocci_id@p ;
...
position p;
@@
 const struct gk20a_clk_pllg_params * cocci_id@p ;
...
position p;
@@
 const struct gk20a_pll * cocci_id@p ;
...
typedef s32,u32;
@@
 struct gm20b_clk_dvfs {  u32 dfs_coeff ;  s32 dfs_det_max ;  s32 dfs_ext_cal ; } cocci_id@p ;
...
typedef u32;
@@
 struct gm20b_pll {  struct gk20a_pll base ;  u32 sdm_din ; } cocci_id@p ;
