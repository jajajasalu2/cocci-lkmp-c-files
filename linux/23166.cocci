...
position p;
@@
 struct au1xpsc_audio_dmadata cocci_id@p ;
...
@@
 struct au1xpsc_audio_dmadata {  unsigned int ddma_id ;  u32 ddma_chan ;  struct snd_pcm_substream * substream ;  unsigned long curr_period ;  unsigned long q_period ;  dma_addr_t dma_area ;  dma_addr_t dma_area_s ;  unsigned long pos ;  unsigned long periods ;  unsigned long period_bytes ;  int msbits ; } cocci_id@p ;
