...
position p;
@@
 enum mxc4005_axis { AXIS_X , AXIS_Y , AXIS_Z , } cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 range ;  int scale ; } cocci_id@p [ ] ;
...
typedef bool;
@@
 struct mxc4005_data {  struct device * dev ;  struct mutex mutex ;  struct regmap * regmap ;  struct iio_trigger * dready_trig ;  __be16 buffer [ 8 ] ;  bool trigger_enabled ; } cocci_id@p ;
...
position p;
@@
 struct mxc4005_data * cocci_id@p ;
...
position p;
@@
 enum mxc4005_range { MXC4005_RANGE_2G , MXC4005_RANGE_4G , MXC4005_RANGE_8G , } cocci_id@p ;
