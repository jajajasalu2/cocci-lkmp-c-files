...
position p;
@@
 const struct pptp_gre_header * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ GRE_CT_MAX ] ;
...
position p;
@@
 const struct nf_ct_gre_keymap * cocci_id@p ;
...
position p;
@@
 struct nf_ct_gre_keymap * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_TIMEOUT_GRE_MAX + 1 ] ;
