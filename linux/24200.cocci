...
position p;
@@
 struct seg6_action_desc * cocci_id@p ;
...
position p;
@@
 struct seg6_local_lwt {  int action ;  struct ipv6_sr_hdr * srh ;  int table ;  struct in_addr nh4 ;  struct in6_addr nh6 ;  int iif ;  int oif ;  struct bpf_lwt_prog bpf ;  int headroom ;  struct seg6_action_desc * desc ; } cocci_id@p ;
...
position p;
@@
 struct seg6_action_desc {  int action ;  unsigned long attrs ;  int ( * input ) ( struct sk_buff * skb , struct seg6_local_lwt * slwt ) ;  int static_headroom ; } cocci_id@p ;
...
position p;
@@
 struct seg6_local_lwt cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ SEG6_LOCAL_MAX + 1 ] ;
...
position p;
@@
 struct lwtunnel_state * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ SEG6_LOCAL_BPF_PROG_MAX + 1 ] ;
...
position p;
@@
 const struct lwtunnel_encap_ops cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ SEG6_LOCAL_MAX + 1 ] ;
...
position p;
@@
 struct seg6_action_param cocci_id@p [ SEG6_LOCAL_MAX + 1 ] ;
...
position p;
@@
 struct bpf_lwt_prog {  struct bpf_prog * prog ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct seg6_action_param * cocci_id@p ;
...
position p;
@@
 struct seg6_action_param {  int ( * parse ) ( struct nlattr * * attrs , struct seg6_local_lwt * slwt ) ;  int ( * put ) ( struct sk_buff * skb , struct seg6_local_lwt * slwt ) ;  int ( * cmp ) ( struct seg6_local_lwt * a , struct seg6_local_lwt * b ) ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ SEG6_LOCAL_BPF_PROG_MAX + 1 ] ;
