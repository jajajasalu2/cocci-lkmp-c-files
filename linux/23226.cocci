...
position p;
@@
 const struct {  int div ;  int ratio ; } cocci_id@p [ ] ;
...
position p;
@@
 enum wm8985_type { WM8985 , WM8758 , } cocci_id@p ;
...
typedef u32;
@@
 struct pll_div {  u32 div2 : 1 ;  u32 n : 4 ;  u32 k : 24 ; } cocci_id@p ;
...
position p;
@@
 struct wm8985_priv {  struct regmap * regmap ;  struct regulator_bulk_data supplies [ WM8985_NUM_SUPPLIES ] ;  enum wm8985_type dev_type ;  unsigned int sysclk ;  unsigned int bclk ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8985_NUM_SUPPLIES ] ;
