...
position p;
@@
 struct rds_info_iterator {  struct page * * pages ;  void * addr ;  unsigned long offset ; } cocci_id@p ;
...
position p;
@@
 rds_info_func cocci_id@p [ RDS_INFO_LAST - RDS_INFO_FIRST + 1 ] ;
