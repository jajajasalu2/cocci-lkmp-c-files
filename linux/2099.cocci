...
position p;
@@
 struct ocelot_reset_context * cocci_id@p ;
...
position p;
@@
 struct ocelot_reset_context {  void __iomem * base ;  struct regmap * cpu_ctrl ;  struct notifier_block restart_handler ; } cocci_id@p ;
