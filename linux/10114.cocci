...
position p;
@@
 const struct multi_recv_comp * cocci_id@p ;
...
position p;
@@
 const struct vmtransfer_page_packet_header * cocci_id@p ;
...
position p;
@@
 struct nvsp_1_message_send_rndis_packet * cocci_id@p ;
...
position p;
@@
 struct recv_comp_data cocci_id@p ;
...
position p;
@@
 const struct recv_comp_data * cocci_id@p ;
...
position p;
@@
 const struct nvsp_message * cocci_id@p ;
...
position p;
@@
 struct netvsc_channel * const cocci_id@p ;
...
position p;
@@
 union nvsp_6_message_uber cocci_id@p ;
...
position p;
@@
 const struct netvsc_device_info * cocci_id@p ;
...
position p;
@@
 struct multi_recv_comp * cocci_id@p ;
...
position p;
@@
 struct multi_send_data * cocci_id@p ;
...
position p;
@@
 struct recv_comp_msg cocci_id@p ;
...
position p;
@@
 struct nvsp_message_header cocci_id@p ;
...
position p;
@@
 const struct hv_netvsc_packet * cocci_id@p ;
...
position p;
@@
 struct nvsp_1_message_send_receive_buffer_complete * cocci_id@p ;
