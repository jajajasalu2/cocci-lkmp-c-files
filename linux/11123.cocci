...
position p;
@@
 struct aux_reply_transaction_data cocci_id@p ;
...
position p;
@@
 const struct dce_aux * cocci_id@p ;
...
position p;
@@
 enum i2caux_transaction_action cocci_id@p ;
...
position p;
@@
 enum { AUX_INVALID_REPLY_RETRY_COUNTER = 1 , AUX_TIMED_OUT_RETRY_COUNTER = 2 , AUX_DEFER_RETRY_COUNTER = 6 , } cocci_id@p ;
...
position p;
@@
 enum i2caux_engine_type cocci_id@p ;
...
position p;
@@
 struct aux_request_transaction_data * cocci_id@p ;
...
position p;
@@
 struct dce_aux_funcs cocci_id@p ;
