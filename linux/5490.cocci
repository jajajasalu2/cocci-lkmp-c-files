...
position p;
@@
 struct ath79_spi_platform_data * cocci_id@p ;
...
typedef u32;
@@
 struct ath79_spi {  struct spi_bitbang bitbang ;  u32 ioc_base ;  u32 reg_ctrl ;  void __iomem * base ;  struct clk * clk ;  unsigned int rrw_delay ; } cocci_id@p ;
