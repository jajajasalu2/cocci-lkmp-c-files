...
position p;
@@
 const struct imx_media_pixfmt * cocci_id@p ;
...
position p;
@@
 struct imx_media_buffer * cocci_id@p ;
...
position p;
@@
 struct imx_media_video_dev * cocci_id@p ;
...
position p;
@@
 struct media_entity * cocci_id@p ;
...
@@
 struct csi_priv {  struct device * dev ;  struct ipu_soc * ipu ;  struct v4l2_subdev sd ;  struct media_pad pad [ CSI_NUM_PADS ] ;  struct imx_media_video_dev * vdev ;  struct imx_media_fim * fim ;  int csi_id ;  int smfc_id ;  struct mutex lock ;  int active_output_pad ;  struct ipuv3_channel * idmac_ch ;  struct ipu_smfc * smfc ;  struct ipu_csi * csi ;  struct v4l2_mbus_framefmt format_mbus [ CSI_NUM_PADS ] ;  const struct imx_media_pixfmt * cc [ CSI_NUM_PADS ] ;  struct v4l2_fract frame_interval [ CSI_NUM_PADS ] ;  struct v4l2_rect crop ;  struct v4l2_rect compose ;  const struct csi_skip_desc * skip ;  struct imx_media_buffer * active_vb2_buf [ 2 ] ;  struct imx_media_dma_buf underrun_buf ;  int ipu_buf_num ;  struct media_entity * sink ;  enum ipu_csi_dest dest ;  struct v4l2_subdev * src_sd ;  int vc_num ;  struct v4l2_fwnode_endpoint upstream_ep ;  spinlock_t irqlock ;  struct timer_list eof_timeout_timer ;  int eof_irq ;  int nfb4eof_irq ;  struct v4l2_ctrl_handler ctrl_hdlr ;  int stream_count ;  u32 frame_sequence ;  bool last_eof ;  bool nfb4eof ;  bool interweave_swap ;  struct completion last_eof_comp ; } cocci_id@p ;
...
position p;
@@
 struct ipu_client_platformdata * cocci_id@p ;
...
position p;
@@
 const struct csi_skip_desc cocci_id@p [ 12 ] ;
...
position p;
@@
 const struct media_pad * cocci_id@p ;
...
position p;
@@
 const struct csi_skip_desc * cocci_id@p ;
...
typedef u8;
@@
 struct csi_skip_desc {  u8 keep ;  u8 max_ratio ;  u8 skip_smfc ; } cocci_id@p ;
