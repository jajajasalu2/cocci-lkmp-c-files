...
position p;
@@
 struct filter_entry {  struct list_head list ;  char name [ ] ; } cocci_id@p ;
...
position p;
@@
 struct perf_ftrace {  struct evlist * evlist ;  struct target target ;  const char * tracer ;  struct list_head filters ;  struct list_head notrace ;  struct list_head graph_funcs ;  struct list_head nograph_funcs ;  int graph_depth ; } cocci_id@p ;
