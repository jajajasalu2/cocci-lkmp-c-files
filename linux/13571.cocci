...
typedef u32;
@@
 const struct {  u32 freq ; } cocci_id@p [ ] ;
...
position p;
@@
 enum { CMD_SET_TRANSCEIVER_MODE = 0x01 , CMD_SAMPLE_RATE_SET = 0x06 , CMD_BASEBAND_FILTER_BANDWIDTH_SET = 0x07 , CMD_BOARD_ID_READ = 0x0e , CMD_VERSION_STRING_READ = 0x0f , CMD_SET_FREQ = 0x10 , CMD_AMP_ENABLE = 0x11 , CMD_SET_LNA_GAIN = 0x13 , CMD_SET_VGA_GAIN = 0x14 , CMD_SET_TXVGA_GAIN = 0x15 , } cocci_id@p ;
...
typedef u32;
@@
 struct hackrf_format {  u32 pixelformat ;  u32 buffersize ; } cocci_id@p ;
...
position p;
@@
 struct hackrf_buffer cocci_id@p ;
...
position p;
@@
 struct hackrf_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct hackrf_format cocci_id@p [ ] ;
