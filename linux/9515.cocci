...
position p;
@@
 struct wifi_only_haldata * cocci_id@p ;
...
position p;
@@
 enum rt_media_status cocci_id@p ;
...
position p;
@@
 struct wifi_only_cfg * cocci_id@p ;
