...
position p;
@@
 struct cx25840_state * cocci_id@p ;
...
position p;
@@
 enum cx25840_video_input cocci_id@p ;
...
position p;
@@
 struct v4l2_subdev_io_pin_config * cocci_id@p ;
...
position p;
@@
 enum cx25840_audio_input cocci_id@p ;
...
position p;
@@
 struct cx25840_platform_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct i2c_client * client , enum cx25840_video_input vid_input , enum cx25840_audio_input aud_input ) ;
