...
position p;
@@
 struct s2250 {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  v4l2_std_id std ;  int input ;  int brightness ;  int contrast ;  int saturation ;  int hue ;  int reg12b_val ;  int audio_input ;  struct i2c_client * audio ; } cocci_id@p ;
...
position p;
@@
 struct go7007_usb_board {  unsigned int flags ;  struct go7007_board_info main_info ; } cocci_id@p ;
...
position p;
@@
 struct go7007_usb {  struct go7007_usb_board * board ;  struct mutex i2c_lock ;  struct usb_device * usbdev ;  struct urb * video_urbs [ 8 ] ;  struct urb * audio_urbs [ 8 ] ;  struct urb * intr_urb ; } cocci_id@p ;
