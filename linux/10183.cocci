...
position p;
@@
 enum { ST_L1_DEACT , ST_L1_DEACT_PENDING , ST_L1_ACTIV , } cocci_id@p ;
...
position p;
@@
 enum { EV_IDREQ , EV_ASSIGN , EV_ASSIGN_REQ , EV_DENIED , EV_CHKREQ , EV_CHKRESP , EV_REMOVE , EV_VERIFY , EV_TIMER , } cocci_id@p ;
...
position p;
@@
 enum { EV_ACTIVATE , EV_ACTIVATE_IND , EV_DEACTIVATE , EV_DEACTIVATE_IND , EV_UI , EV_DATIMER , } cocci_id@p ;
...
position p;
@@
 enum { ST_TEI_NOP , ST_TEI_IDREQ , ST_TEI_IDVERIFY , } cocci_id@p ;
