...
position p;
@@
 struct omap2_mcspi_dma {  struct dma_chan * dma_tx ;  struct dma_chan * dma_rx ;  struct completion dma_tx_completion ;  struct completion dma_rx_completion ;  char dma_rx_ch_name [ 14 ] ;  char dma_tx_ch_name [ 14 ] ; } cocci_id@p ;
...
position p;
@@
 struct omap2_mcspi_dma cocci_id@p ;
...
typedef bool;
@@
 struct omap2_mcspi {  struct completion txdone ;  struct spi_master * master ;  void __iomem * base ;  unsigned long phys ;  struct omap2_mcspi_dma * dma_channels ;  struct device * dev ;  struct omap2_mcspi_regs ctx ;  int fifo_depth ;  bool slave_aborted ;  unsigned int pin_dir : 1 ; } cocci_id@p ;
...
typedef u32;
@@
 struct omap2_mcspi_regs {  u32 modulctrl ;  u32 wakeupenable ;  struct list_head cs ; } cocci_id@p ;
...
position p;
@@
 struct omap2_mcspi_device_config * cocci_id@p ;
...
position p;
@@
 struct omap2_mcspi_cs * cocci_id@p ;
...
position p;
@@
 struct omap2_mcspi_regs * cocci_id@p ;
...
position p;
@@
 const struct omap2_mcspi_platform_config * cocci_id@p ;
...
position p;
@@
 struct omap2_mcspi_platform_config cocci_id@p ;
