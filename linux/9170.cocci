...
position p;
@@
 enum mlxsw_reg_rtar_key_type cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_mr_tcam * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_mr_tcam_route {  struct parman_item parman_item ;  struct parman_prio * parman_prio ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_mr_tcam_route * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_RRCR_LEN ] ;
...
position p;
@@
 struct mlxsw_sp1_mr_tcam_region * cocci_id@p ;
...
position p;
@@
 const struct parman_ops cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_mr_tcam_region {  struct mlxsw_sp * mlxsw_sp ;  enum mlxsw_reg_rtar_key_type rtar_key_type ;  struct parman * parman ;  struct parman_prio * parman_prios ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_mr_tcam {  struct mlxsw_sp1_mr_tcam_region tcam_regions [ MLXSW_SP_L3_PROTO_MAX ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_RMFT2_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_RTAR_LEN ] ;
