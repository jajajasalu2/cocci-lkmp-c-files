...
position p;
@@
 struct serdev_controller * cocci_id@p ;
...
position p;
@@
 const struct serdev_device_driver * cocci_id@p ;
...
typedef acpi_handle;
@@
 struct acpi_serdev_lookup {  acpi_handle device_handle ;  acpi_handle controller_handle ;  int n ;  int index ; } cocci_id@p ;
...
position p;
@@
 struct acpi_serdev_lookup * cocci_id@p ;
