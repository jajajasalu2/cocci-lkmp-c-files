...
position p;
@@
 const struct sunxi_ir_quirks cocci_id@p ;
...
typedef bool;
@@
 struct sunxi_ir_quirks {  bool has_reset ;  int fifo_size ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sunxi_ir {  spinlock_t ir_lock ;  struct rc_dev * rc ;  void __iomem * base ;  int irq ;  int fifo_size ;  struct clk * clk ;  struct clk * apb_clk ;  struct reset_control * rst ;  const char * map_name ; } cocci_id@p ;
