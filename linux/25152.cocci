...
typedef cpu_set_t;
@@
 struct cpu_topology {  int physical_package_id ;  int die_id ;  int logical_cpu_id ;  int physical_node_id ;  int logical_node_id ;  int physical_core_id ;  int thread_id ;  cpu_set_t * put_ids ; } * cocci_id@p ;
...
position p;
@@
 enum counter_scope { SCOPE_CPU , SCOPE_CORE , SCOPE_PACKAGE , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct thread_data * , struct core_data * , struct pkg_data * ) ;
...
position p;
@@
 enum counter_format { FORMAT_RAW , FORMAT_DELTA , FORMAT_PERCENT , } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ buckets_no ] ;
...
position p;
@@
 struct system_summary {  struct thread_data threads ;  struct core_data cores ;  struct pkg_data packages ; } cocci_id@p ;
...
position p;
@@
 enum show_hide_mode cocci_id@p ;
...
position p;
@@
 struct cpu_topology * cocci_id@p ;
...
position p;
@@
 struct topo_params {  int num_packages ;  int num_die ;  int num_cpus ;  int num_cores ;  int max_cpu_num ;  int max_node_num ;  int nodes_per_pkg ;  int cores_per_node ;  int threads_per_core ; } cocci_id@p ;
...
position p;
@@
 struct core_data {  unsigned long long c3 ;  unsigned long long c6 ;  unsigned long long c7 ;  unsigned long long mc6_us ;  unsigned int core_temp_c ;  unsigned int core_energy ;  unsigned int core_id ;  unsigned long long counter [ MAX_ADDED_COUNTERS ] ; } * cocci_id@p ;
...
position p;
@@
 struct sys_counters {  unsigned int added_thread_counters ;  unsigned int added_core_counters ;  unsigned int added_package_counters ;  struct msr_counter * tp ;  struct msr_counter * cp ;  struct msr_counter * pp ; } cocci_id@p ;
...
position p;
@@
 double cocci_id@p [ SLM_BCLK_FREQS ] ;
...
position p;
@@
 char cocci_id@p [ 128 + PATH_BYTES ] ;
...
position p;
@@
 enum counter_type { COUNTER_ITEMS , COUNTER_CYCLES , COUNTER_SECONDS , COUNTER_USEC , } cocci_id@p ;
...
position p;
@@
 const struct dirent * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct thread_data * , struct core_data * , struct pkg_data * , struct thread_data * , struct core_data * , struct pkg_data * ) ;
...
position p;
@@
 enum counter_format cocci_id@p ;
...
position p;
@@
 enum show_hide_mode { SHOW_LIST , HIDE_LIST , } cocci_id@p ;
...
position p;
@@
 struct pkg_data {  unsigned long long pc2 ;  unsigned long long pc3 ;  unsigned long long pc6 ;  unsigned long long pc7 ;  unsigned long long pc8 ;  unsigned long long pc9 ;  unsigned long long pc10 ;  unsigned long long cpu_lpi ;  unsigned long long sys_lpi ;  unsigned long long pkg_wtd_core_c0 ;  unsigned long long pkg_any_core_c0 ;  unsigned long long pkg_any_gfxe_c0 ;  unsigned long long pkg_both_core_gfxe_c0 ;  long long gfx_rc6_ms ;  unsigned int gfx_mhz ;  unsigned int package_id ;  unsigned int energy_pkg ;  unsigned int energy_dram ;  unsigned int energy_cores ;  unsigned int energy_gfx ;  unsigned int rapl_pkg_perf_status ;  unsigned int rapl_dram_perf_status ;  unsigned int pkg_temp_c ;  unsigned long long counter [ MAX_ADDED_COUNTERS ] ; } * cocci_id@p ;
...
position p;
@@
 double cocci_id@p ( unsigned int family , unsigned int model ) ;
