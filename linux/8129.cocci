...
position p;
@@
 struct rcar_canfd_global cocci_id@p ;
...
position p;
@@
 enum rcar_canfd_fcanclk { RCANFD_CANFDCLK = 0 , RCANFD_EXTCLK , } cocci_id@p ;
...
typedef bool;
@@
 struct rcar_canfd_global {  struct rcar_canfd_channel * ch [ RCANFD_NUM_CHANNELS ] ;  void __iomem * base ;  struct platform_device * pdev ;  struct clk * clkp ;  struct clk * can_clk ;  enum rcar_canfd_fcanclk fcan ;  unsigned long channels_mask ;  bool fdmode ; } cocci_id@p ;
...
position p;
@@
 struct rcar_canfd_channel * cocci_id@p ;
...
@@
 struct rcar_canfd_channel {  struct can_priv can ;  struct net_device * ndev ;  struct rcar_canfd_global * gpriv ;  void __iomem * base ;  struct napi_struct napi ;  u8 tx_len [ RCANFD_FIFO_DEPTH ] ;  u32 tx_head ;  u32 tx_tail ;  u32 channel ;  spinlock_t tx_lock ; } cocci_id@p ;
