...
position p;
@@
 struct node_mem_mask * const cocci_id@p ;
...
position p;
@@
 struct hv_tsb_descr cocci_id@p [ NUM_KTSB_DESCR ] ;
...
position p;
@@
 struct node_mem_mask {  unsigned long mask ;  unsigned long match ; } cocci_id@p ;
...
position p;
@@
 struct tsb cocci_id@p [ KERNEL_TSB4M_NENTRIES ] ;
...
position p;
@@
 struct pud_huge_patch_entry * cocci_id@p ;
...
typedef u64;
@@
 struct mdesc_mblock {  u64 base ;  u64 size ;  u64 offset ; } cocci_id@p ;
...
position p;
@@
 struct linux_prom_translation cocci_id@p ;
...
position p;
@@
 struct mdesc_mblock * cocci_id@p ;
...
position p;
@@
 const struct linux_prom64_registers * cocci_id@p ;
...
position p;
@@
 const struct linux_prom_translation * cocci_id@p ;
...
position p;
@@
 struct pglist_data * cocci_id@p [ MAX_NUMNODES ] ;
...
typedef cpumask_t;
@@
 cpumask_t cocci_id@p [ MAX_NUMNODES ] ;
...
position p;
@@
 struct mdesc_mlgroup cocci_id@p ;
...
typedef u64;
@@
 struct mdesc_mlgroup {  u64 node ;  u64 latency ;  u64 match ;  u64 mask ; } cocci_id@p ;
...
position p;
@@
 struct tsb_phys_patch_entry * cocci_id@p ;
...
position p;
@@
 struct linux_prom64_registers cocci_id@p [ MAX_BANKS ] ;
...
position p;
@@
 struct linux_prom64_registers * cocci_id@p ;
...
position p;
@@
 struct mdesc_mlgroup * const cocci_id@p ;
...
position p;
@@
 struct node_mem_mask * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( unsigned long paddr ) ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_NR_ZONES ] ;
...
typedef u64;
@@
 u64 cocci_id@p [ MAX_NUMNODES ] [ MAX_NUMNODES ] ;
...
position p;
@@
 struct tsb_ldquad_phys_patch_entry * cocci_id@p ;
...
position p;
@@
 struct tsb cocci_id@p [ KERNEL_TSB_NENTRIES ] ;
...
position p;
@@
 struct node_mem_mask cocci_id@p [ MAX_NUMNODES ] ;
