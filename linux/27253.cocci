...
position p;
@@
 struct dcookie_struct {  struct path path ;  struct list_head hash_list ; } cocci_id@p ;
...
position p;
@@
 struct dcookie_user {  struct list_head next ; } cocci_id@p ;
...
position p;
@@
 struct dcookie_struct cocci_id@p ;
...
position p;
@@
 struct dcookie_user * cocci_id@p ;
