...
position p;
@@
 struct flow_dissector_key_enc_opts * cocci_id@p ;
...
position p;
@@
 const struct flow_dissector_key * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_ipv4_addrs * cocci_id@p ;
...
position p;
@@
 struct gre_base_hdr * cocci_id@p ;
...
position p;
@@
 enum flow_dissect_ret cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_ports * cocci_id@p ;
...
typedef siphash_key_t;
@@
 const siphash_key_t * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_addrs * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct _flow_keys_digest_data {  __be16 n_proto ;  u8 ip_proto ;  u8 padding ;  __be32 ports ;  __be32 src ;  __be32 dst ; } cocci_id@p ;
...
position p;
@@
 enum flow_dissector_key_id cocci_id@p ;
...
position p;
@@
 struct _flow_keys_digest_data * cocci_id@p ;
...
position p;
@@
 struct bpf_flow_dissector * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_basic * cocci_id@p ;
...
position p;
@@
 struct {  struct pppoe_hdr hdr ;  __be16 proto ; } * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_keyid * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_ipv6_addrs * cocci_id@p ;
...
position p;
@@
 const struct flow_keys_basic * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_tags * cocci_id@p ;
...
position p;
@@
 const struct vlan_hdr * cocci_id@p ;
...
position p;
@@
 const struct bpf_flow_keys * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_eth_addrs * cocci_id@p ;
...
position p;
@@
 struct {  unsigned char ar_sha [ ETH_ALEN ] ;  unsigned char ar_sip [ 4 ] ;  unsigned char ar_tha [ ETH_ALEN ] ;  unsigned char ar_tip [ 4 ] ; } * cocci_id@p ;
...
position p;
@@
 struct pptp_gre_header cocci_id@p ;
...
position p;
@@
 struct gre_full_hdr cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_mpls * cocci_id@p ;
...
position p;
@@
 struct tipc_basic_hdr * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_arp * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_icmp * cocci_id@p ;
...
position p;
@@
 struct flow_keys_basic cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_ct * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_ip * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_control * cocci_id@p ;
...
position p;
@@
 const struct arphdr * cocci_id@p ;
...
position p;
@@
 struct ip_tunnel_key * cocci_id@p ;
...
position p;
@@
 struct flow_keys_digest * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_meta * cocci_id@p ;
...
position p;
@@
 struct {  struct batadv_unicast_packet batadv_unicast ;  struct ethhdr eth ; } * cocci_id@p ;
...
position p;
@@
 const struct dsa_device_ops * cocci_id@p ;
...
position p;
@@
 struct flow_dissector_key_tcp * cocci_id@p ;
