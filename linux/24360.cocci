...
position p;
@@
 const struct ceph_entity_addr * cocci_id@p ;
...
position p;
@@
 struct ceph_messenger * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ceph_connection * con , int * skip ) ;
...
position p;
@@
 struct ceph_msg_data_cursor * cocci_id@p ;
...
position p;
@@
 struct ceph_msg_footer_old cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ceph_connection * con ) ;
...
position p;
@@
 struct ceph_msg_footer cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ADDR_STR_COUNT ] [ MAX_ADDR_STR_LEN ] ;
