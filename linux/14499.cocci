...
position p;
@@
 struct rockchip_clk_frac cocci_id@p ;
...
position p;
@@
 struct clk_div_table * cocci_id@p ;
...
typedef bool;
@@
 struct rockchip_clk_frac {  struct notifier_block clk_nb ;  struct clk_fractional_divider div ;  struct clk_gate gate ;  struct clk_mux mux ;  const struct clk_ops * mux_ops ;  int mux_frac_idx ;  bool rate_change_remuxed ;  int rate_change_idx ; } cocci_id@p ;
...
position p;
@@
 const struct rockchip_cpuclk_reg_data * cocci_id@p ;
...
position p;
@@
 struct rockchip_clk_provider * cocci_id@p ;
...
position p;
@@
 struct rockchip_clk_branch * cocci_id@p ;
...
position p;
@@
 const struct rockchip_cpuclk_rate_table * cocci_id@p ;
...
position p;
@@
 struct clk_fractional_divider * cocci_id@p ;
...
position p;
@@
 struct rockchip_pll_clock * cocci_id@p ;
