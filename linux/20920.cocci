...
position p;
@@
 struct uml_net_private * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned char * , unsigned char * , void * ) ;
...
position p;
@@
 struct eth_init {  struct list_head list ;  char * init ;  int index ; } cocci_id@p ;
