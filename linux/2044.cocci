...
position p;
@@
 enum kx_chipset { KXCJK1013 , KXCJ91008 , KXTJ21009 , KXTF9 , KX_MAX_CHIPS , } cocci_id@p ;
...
position p;
@@
 enum kxcjk1013_mode * cocci_id@p ;
...
typedef u8,u16;
@@
 const struct {  u16 scale ;  u8 gsel_0 ;  u8 gsel_1 ; } cocci_id@p [ ] ;
...
position p;
@@
 enum kxcjk1013_axis { AXIS_X , AXIS_Y , AXIS_Z , AXIS_MAX , } cocci_id@p ;
...
position p;
@@
 const struct kx_odr_map cocci_id@p [ ] ;
...
position p;
@@
 enum kxcjk1013_mode { STANDBY , OPERATION , } cocci_id@p ;
...
position p;
@@
 struct kxcjk1013_data * cocci_id@p ;
...
position p;
@@
 const struct {  int odr_bits ;  int usec ; } cocci_id@p [ KX_MAX_CHIPS ] [ 12 ] ;
...
position p;
@@
 struct kxcjk_1013_platform_data * cocci_id@p ;
...
position p;
@@
 enum kxcjk1013_range { KXCJK1013_RANGE_2G , KXCJK1013_RANGE_4G , KXCJK1013_RANGE_8G , } cocci_id@p ;
...
position p;
@@
 struct kx_odr_map {  int val ;  int val2 ;  int odr_bits ;  int wuf_bits ; } cocci_id@p ;
