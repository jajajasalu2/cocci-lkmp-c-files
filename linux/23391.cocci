...
typedef u8,u32,u16;
@@
 struct _coeff_div {  u32 mclk ;  u32 rate ;  u16 fs ;  u8 sr : 4 ;  u8 bosr : 1 ;  u8 usb : 1 ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8731_NUM_SUPPLIES ] ;
...
typedef bool;
@@
 struct wm8731_priv {  struct regmap * regmap ;  struct clk * mclk ;  struct regulator_bulk_data supplies [ WM8731_NUM_SUPPLIES ] ;  const struct snd_pcm_hw_constraint_list * constraints ;  unsigned int sysclk ;  int sysclk_type ;  int playback_fs ;  bool deemph ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 const struct _coeff_div cocci_id@p [ ] ;
