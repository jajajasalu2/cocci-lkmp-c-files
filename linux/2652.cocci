...
position p;
@@
 const struct stu300_clkset cocci_id@p [ ] ;
...
position p;
@@
 enum stu300_error { STU300_ERROR_NONE = 0 , STU300_ERROR_ACKNOWLEDGE_FAILURE , STU300_ERROR_BUS_ERROR , STU300_ERROR_ARBITRATION_LOST , STU300_ERROR_UNKNOWN , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct stu300_dev {  struct platform_device * pdev ;  struct i2c_adapter adapter ;  void __iomem * virtbase ;  struct clk * clk ;  int irq ;  spinlock_t cmd_issue_lock ;  struct completion cmd_complete ;  enum stu300_event cmd_event ;  enum stu300_error cmd_err ;  unsigned int speed ;  int msg_index ;  int msg_len ; } cocci_id@p ;
...
position p;
@@
 enum stu300_event { STU300_EVENT_NONE = 0 , STU300_EVENT_1 , STU300_EVENT_2 , STU300_EVENT_3 , STU300_EVENT_4 , STU300_EVENT_5 , STU300_EVENT_6 , STU300_EVENT_7 , STU300_EVENT_8 , STU300_EVENT_9 , } cocci_id@p ;
...
typedef u32;
@@
 struct stu300_clkset {  unsigned long rate ;  u32 setting ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct stu300_dev * dev ) ;
