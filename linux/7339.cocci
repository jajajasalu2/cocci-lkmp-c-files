...
position p;
@@
 const struct lcd_panel cocci_id@p ;
...
typedef u16;
@@
 const struct {  int cmd ;  int wlen ;  u16 wbuf [ 3 ] ; } * cocci_id@p ;
...
position p;
@@
 struct mipid_device * cocci_id@p ;
...
position p;
@@
 struct mipid_platform_data * cocci_id@p ;
...
position p;
@@
 struct mipid_device {  int enabled ;  int revision ;  unsigned int saved_bklight_level ;  unsigned long hw_guard_end ;  unsigned long hw_guard_wait ;  struct omapfb_device * fbdev ;  struct spi_device * spi ;  struct mutex mutex ;  struct lcd_panel panel ;  struct delayed_work esd_work ;  void ( * esd_check ) ( struct mipid_device * m ) ; } cocci_id@p ;
