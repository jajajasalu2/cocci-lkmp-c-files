...
position p;
@@
 struct cs42l51_ratios * cocci_id@p ;
...
position p;
@@
 struct cs42l51_private * cocci_id@p ;
...
position p;
@@
 struct cs42l51_ratios {  unsigned int ratio ;  unsigned char speed_mode ;  unsigned char mclk ; } cocci_id@p ;
...
position p;
@@
 struct cs42l51_private {  unsigned int mclk ;  struct clk * mclk_handle ;  unsigned int audio_mode ;  enum master_slave_mode func ;  struct regulator_bulk_data supplies [ ARRAY_SIZE ( cs42l51_supply_names ) ] ;  struct gpio_desc * reset_gpio ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 enum master_slave_mode { MODE_SLAVE , MODE_SLAVE_AUTO , MODE_MASTER , } cocci_id@p ;
