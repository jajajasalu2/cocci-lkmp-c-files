...
position p;
@@
 const struct cpl_pass_accept_req * cocci_id@p ;
...
position p;
@@
 struct tlsrx_cmp_hdr * cocci_id@p ;
...
position p;
@@
 const struct chtls_sock * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef defer_handler_t;
@@
 defer_handler_t cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sock * sk , struct sk_buff * skb ) ;
...
position p;
@@
 const struct chtls_dev * cocci_id@p ;
...
position p;
@@
 const struct cpl_abort_req_rss * cocci_id@p ;
...
position p;
@@
 chtls_handler_func cocci_id@p [ NUM_CPL_CMDS ] ;
...
position p;
@@
 struct cpl_tls_data * cocci_id@p ;
...
position p;
@@
 struct cpl_rx_tls_cmp * cocci_id@p ;
