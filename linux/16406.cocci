...
position p;
@@
 const struct arvo_device * cocci_id@p ;
...
position p;
@@
 struct arvo_key_mask cocci_id@p ;
...
position p;
@@
 struct arvo_mode_key cocci_id@p ;
...
position p;
@@
 const struct arvo_special_report * cocci_id@p ;
...
position p;
@@
 struct arvo_roccat_report cocci_id@p ;
...
position p;
@@
 struct arvo_actual_profile cocci_id@p ;
