...
position p;
@@
 struct silead_fw_data * cocci_id@p ;
...
typedef u32;
@@
 struct silead_fw_data {  u32 offset ;  u32 val ; } cocci_id@p ;
...
position p;
@@
 struct silead_ts_data * cocci_id@p ;
...
position p;
@@
 enum silead_ts_power cocci_id@p ;
...
position p;
@@
 enum silead_ts_power { SILEAD_POWER_ON = 1 , SILEAD_POWER_OFF = 0 , } cocci_id@p ;
...
typedef u32;
@@
 struct silead_ts_data {  struct i2c_client * client ;  struct gpio_desc * gpio_power ;  struct input_dev * input ;  struct regulator_bulk_data regulators [ 2 ] ;  char fw_name [ 64 ] ;  struct touchscreen_properties prop ;  u32 max_fingers ;  u32 chip_id ;  struct input_mt_pos pos [ SILEAD_MAX_FINGERS ] ;  int slots [ SILEAD_MAX_FINGERS ] ;  int id [ SILEAD_MAX_FINGERS ] ; } cocci_id@p ;
