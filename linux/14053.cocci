...
position p;
@@
 struct vdec_vpu_ipi_ack * cocci_id@p ;
...
position p;
@@
 struct vdec_ap_ipi_cmd cocci_id@p ;
...
position p;
@@
 struct vdec_ap_ipi_dec_start cocci_id@p ;
...
position p;
@@
 struct vdec_vpu_ipi_init_ack * cocci_id@p ;
...
position p;
@@
 struct vdec_ap_ipi_init cocci_id@p ;
