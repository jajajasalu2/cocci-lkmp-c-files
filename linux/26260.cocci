...
position p;
@@
 struct bpf_xfrm_state cocci_id@p ;
...
typedef __u32;
@@
 struct vxlan_metadata {  __u32 gbp ; } cocci_id@p ;
...
typedef __u8;
@@
 struct geneve_opt {  __be16 opt_class ;  __u8 type ;  __u8 length : 5 ;  __u8 r3 : 1 ;  __u8 r2 : 1 ;  __u8 r1 : 1 ;  __u8 opt_data [ 8 ] ; } cocci_id@p ;
