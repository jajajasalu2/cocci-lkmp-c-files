...
position p;
@@
 struct ct_expect_iter_state * cocci_id@p ;
...
position p;
@@
 struct ct_expect_iter_state {  struct seq_net_private p ;  unsigned int bucket ; } cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct nf_conntrack_expect * e , void * data ) ;
