...
position p;
@@
 struct stm32_dac_priv {  struct clk * pclk ;  struct reset_control * rst ;  struct regulator * vref ;  struct stm32_dac_common common ; } cocci_id@p ;
...
position p;
@@
 struct stm32_dac_priv cocci_id@p ;
...
position p;
@@
 const struct stm32_dac_cfg cocci_id@p ;
...
position p;
@@
 struct stm32_dac_common * cocci_id@p ;
...
typedef bool;
@@
 struct stm32_dac_cfg {  bool has_hfsel ; } cocci_id@p ;
