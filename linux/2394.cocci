...
position p;
@@
 struct st_fdma_chan * cocci_id@p ;
...
position p;
@@
 struct st_fdma_hw_node * cocci_id@p ;
...
position p;
@@
 const struct st_fdma_driverdata * cocci_id@p ;
...
position p;
@@
 struct st_fdma_desc cocci_id@p ;
