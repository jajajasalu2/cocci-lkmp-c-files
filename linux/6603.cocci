...
position p;
@@
 struct fcgs_gidpn_resp_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcs_rpf_s * rpf , enum rpf_event event ) ;
...
symbol cocci_id;
position p;
typedef bfa_port_speed_t;
@@
 bfa_port_speed_t cocci_id@p ;
...
position p;
@@
 struct bfa_rport_aen_data_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * rport_cbarg ) ;
...
position p;
@@
 struct bfad_rport_s * cocci_id@p ;
...
position p;
@@
 struct fc_rpsc2_acc_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcs_rport_s * rport ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct bfa_fcs_rport_s * rport , struct fchs_s * rx_fchs , u16 len ) ;
...
position p;
@@
 struct fc_els_cmd_s * cocci_id@p ;
...
position p;
@@
 struct bfa_rport_attr_s cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcs_rport_s * rport , enum rport_event event ) ;
...
position p;
@@
 struct bfa_rport_qos_attr_s cocci_id@p ;
...
position p;
@@
 struct bfa_fcs_rpf_s * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct bfa_fcs_rport_s * rport , struct fchs_s * rx_fchs , u8 reason_code , u8 reason_code_expl ) ;
...
position p;
@@
 void cocci_id@p ( void * rport_cbarg , struct bfa_fcxp_s * fcxp_alloced ) ;
...
position p;
@@
 enum rpf_event { RPFSM_EVENT_RPORT_OFFLINE = 1 , RPFSM_EVENT_RPORT_ONLINE = 2 , RPFSM_EVENT_FCXP_SENT = 3 , RPFSM_EVENT_TIMEOUT = 4 , RPFSM_EVENT_RPSC_COMP = 5 , RPFSM_EVENT_RPSC_FAIL = 6 , RPFSM_EVENT_RPSC_ERROR = 7 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcs_rport_s * rport , struct fc_logi_s * plogi ) ;
...
symbol cocci_id;
position p;
typedef bfa_fcs_lport_t;
@@
 bfa_fcs_lport_t * cocci_id@p ;
...
position p;
@@
 struct fc_rpsc_speed_info_s cocci_id@p ;
...
position p;
@@
 enum bfa_rport_aen_event cocci_id@p ;
