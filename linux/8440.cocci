...
position p;
@@
 enum el3_cardtype { EL3_ISA , EL3_PNP , EL3_EISA , } cocci_id@p ;
...
position p;
@@
 struct net_device * cocci_id@p [ EL3_MAX_CARDS ] ;
...
position p;
@@
 ushort cocci_id@p ( int ioaddr , int index ) ;
