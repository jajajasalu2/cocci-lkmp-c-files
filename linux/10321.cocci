...
position p;
@@
 struct block_header * cocci_id@p ;
...
position p;
@@
 const struct komeda_pipeline_funcs cocci_id@p ;
...
position p;
@@
 const struct komeda_component_funcs cocci_id@p ;
...
position p;
@@
 struct d71_pipeline * cocci_id@p ;
