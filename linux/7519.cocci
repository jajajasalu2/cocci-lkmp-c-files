...
position p;
@@
 void cocci_id@p ( struct w100fb_par * ) ;
...
position p;
@@
 union disp_db_buf_cntl_wr_u cocci_id@p ;
...
position p;
@@
 union cpu_defaults_u cocci_id@p ;
...
position p;
@@
 struct power_state {  union clk_pin_cntl_u clk_pin_cntl ;  union pll_ref_fb_div_u pll_ref_fb_div ;  union pll_cntl_u pll_cntl ;  union sclk_cntl_u sclk_cntl ;  union pclk_cntl_u pclk_cntl ;  union pwrmgt_cntl_u pwrmgt_cntl ;  int auto_mode ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct w100fb_par * par ) ;
...
position p;
@@
 union mc_ext_mem_location_u cocci_id@p ;
...
position p;
@@
 union mc_fb_location_u cocci_id@p ;
...
position p;
@@
 struct w100fb_mach_info * cocci_id@p ;
...
position p;
@@
 union graphic_v_disp_u cocci_id@p ;
...
position p;
@@
 struct w100_pll_info cocci_id@p [ ] ;
...
position p;
@@
 union cif_read_dbg_u cocci_id@p ;
...
position p;
@@
 struct w100_gpio_regs * cocci_id@p ;
...
position p;
@@
 struct w100_pll_info * cocci_id@p ( unsigned int freq ) ;
...
position p;
@@
 union cfgreg_base_u cocci_id@p ;
...
position p;
@@
 union active_v_disp_u cocci_id@p ;
...
position p;
@@
 struct w100_mem_info * cocci_id@p ;
...
position p;
@@
 struct w100_bm_mem_info * cocci_id@p ;
...
position p;
@@
 union active_h_disp_u cocci_id@p ;
...
position p;
@@
 struct w100_gen_regs * cocci_id@p ;
...
position p;
@@
 union dp_datatype_u cocci_id@p ;
...
position p;
@@
 union graphic_ctrl_u cocci_id@p ;
...
position p;
@@
 struct pll_entries {  int xtal_freq ;  struct w100_pll_info * pll_table ; } cocci_id@p [ ] ;
...
position p;
@@
 union rbbm_status_u cocci_id@p ;
...
position p;
@@
 union wrap_top_dir_u cocci_id@p ;
...
position p;
@@
 struct w100_tg_info * cocci_id@p ;
...
position p;
@@
 union wrap_start_dir_u cocci_id@p ;
...
position p;
@@
 union clk_test_cntl_u cocci_id@p ;
...
position p;
@@
 union dp_gui_master_cntl_u cocci_id@p ;
...
position p;
@@
 union graphic_h_disp_u cocci_id@p ;
...
position p;
@@
 union cif_write_dbg_u cocci_id@p ;
