...
position p;
@@
 struct ufs_cg_private_info cocci_id@p ;
...
position p;
@@
 struct ufs_super_block_first * cocci_id@p ;
...
position p;
@@
 struct ufs_cylinder_group cocci_id@p ;
...
position p;
@@
 struct ufs_super_block_second * cocci_id@p ;
...
position p;
@@
 struct ufs_inode_info cocci_id@p ;
...
position p;
@@
 struct ufs_buffer_head * cocci_id@p ;
...
position p;
@@
 struct ufs_sb_private_info cocci_id@p ;
...
position p;
@@
 struct ufs_super_block_third * cocci_id@p ;
