...
position p;
@@
 const struct imx_fb_videomode * cocci_id@p ;
...
position p;
@@
 struct imx_fb_videomode cocci_id@p ;
...
position p;
@@
 struct imxfb_rgb {  struct fb_bitfield red ;  struct fb_bitfield green ;  struct fb_bitfield blue ;  struct fb_bitfield transp ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u_int,dma_addr_t;
@@
 struct imxfb_info {  struct platform_device * pdev ;  void __iomem * regs ;  struct clk * clk_ipg ;  struct clk * clk_ahb ;  struct clk * clk_per ;  enum imxfb_type devtype ;  bool enabled ;  dma_addr_t map_dma ;  u_int map_size ;  u_int palette_size ;  dma_addr_t dbar1 ;  dma_addr_t dbar2 ;  u_int pcr ;  u_int lauscr ;  u_int pwmr ;  u_int lscr1 ;  u_int dmacr ;  bool cmap_inverse ;  bool cmap_static ;  struct imx_fb_videomode * mode ;  int num_modes ;  struct regulator * lcd_pwr ; } cocci_id@p ;
...
position p;
@@
 enum imxfb_type { IMX1_FB , IMX21_FB , } cocci_id@p ;
...
position p;
@@
 struct imx_fb_platform_data * cocci_id@p ;
