...
position p;
@@
 struct simple_child cocci_id@p ;
...
position p;
@@
 struct simple_children {  struct config_group group ; } cocci_id@p ;
...
position p;
@@
 struct simple_child {  struct config_item item ;  int storeme ; } cocci_id@p ;
...
position p;
@@
 struct simple_children cocci_id@p ;
...
position p;
@@
 struct childless {  struct configfs_subsystem subsys ;  int showme ;  int storeme ; } cocci_id@p ;
