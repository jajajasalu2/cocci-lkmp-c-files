...
position p;
@@
 struct popc_6insn_patch_entry * cocci_id@p ;
...
position p;
@@
 struct pause_patch_entry * cocci_id@p ;
...
position p;
@@
 struct sun4v_1insn_patch_entry * cocci_id@p ;
...
position p;
@@
 struct sun4v_2insn_patch_entry * cocci_id@p ;
...
position p;
@@
 struct popc_3insn_patch_entry * cocci_id@p ;
