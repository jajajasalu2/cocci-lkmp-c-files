...
position p;
@@
 struct locks_iterator * cocci_id@p ;
...
position p;
@@
 struct file_lock_list_struct * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct file_lock_list_struct {  spinlock_t lock ;  struct hlist_head hlist ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct file_lock * , struct file_lock * ) ;
...
position p;
@@
 struct srcu_notifier_head cocci_id@p ;
...
typedef loff_t;
@@
 struct locks_iterator {  int li_cpu ;  loff_t li_pos ; } cocci_id@p ;
