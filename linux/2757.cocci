...
position p;
@@
 struct omap_i2c_bus_platform_data cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct omap_i2c_dev * omap ) ;
...
position p;
@@
 const struct omap_i2c_bus_platform_data * cocci_id@p ;
...
position p;
@@
 struct omap_i2c_dev * cocci_id@p ;
