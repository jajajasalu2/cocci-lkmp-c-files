...
position p;
@@
 struct ti_sci_reset_control * cocci_id@p ;
...
position p;
@@
 const struct ti_sci_dev_ops * cocci_id@p ;
...
typedef u32;
@@
 struct ti_sci_reset_control {  u32 dev_id ;  u32 reset_mask ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct ti_sci_reset_data {  struct reset_controller_dev rcdev ;  struct device * dev ;  const struct ti_sci_handle * sci ;  struct idr idr ; } cocci_id@p ;
...
position p;
@@
 struct ti_sci_reset_data cocci_id@p ;
