...
typedef pmd_t;
@@
 pmd_t cocci_id@p [ PTRS_PER_PMD ] __page_aligned_bss __maybe_unused ;
...
typedef pud_t;
@@
 pud_t cocci_id@p [ PTRS_PER_PUD ] __page_aligned_bss __maybe_unused ;
