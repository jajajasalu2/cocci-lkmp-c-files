...
position p;
@@
 struct nfcmrvl_private * cocci_id@p ;
...
position p;
@@
 struct nfcmrvl_fw_dnld cocci_id@p ;
...
position p;
@@
 const struct nfcmrvl_fw * cocci_id@p ;
...
position p;
@@
 enum { STATE_RESET = 0 , STATE_INIT , STATE_SET_REF_CLOCK , STATE_SET_HI_CONFIG , STATE_OPEN_LC , STATE_FW_DNLD , STATE_CLOSE_LC , STATE_BOOT , } cocci_id@p ;
...
position p;
@@
 enum { SUBSTATE_WAIT_COMMAND = 0 , SUBSTATE_WAIT_ACK_CREDIT , SUBSTATE_WAIT_NACK_CREDIT , SUBSTATE_WAIT_DATA_CREDIT , } cocci_id@p ;
...
position p;
@@
 struct nci_data_hdr * cocci_id@p ;
