...
typedef u32;
@@
 const struct {  u32 intf ;  enum p54u_hw_type type ;  const char * fw ;  char hw [ 20 ] ; } cocci_id@p [ __NUM_P54U_HWTYPES ] ;
...
position p;
@@
 struct net2280_tx_hdr cocci_id@p ;
...
position p;
@@
 enum net2280_op_type cocci_id@p ;
...
position p;
@@
 struct net2280_reg_write * cocci_id@p ;
...
position p;
@@
 struct net2280_reg_read * cocci_id@p ;
...
position p;
@@
 struct p54u_rx_info * cocci_id@p ;
...
position p;
@@
 const struct p54p_csr * cocci_id@p ;
