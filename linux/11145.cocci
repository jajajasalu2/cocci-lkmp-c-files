...
typedef bool;
@@
 bool cocci_id@p ( struct display_stream_compressor * dsc , const struct dsc_config * dsc_cfg ) ;
...
position p;
@@
 void cocci_id@p ( struct display_stream_compressor * dsc , const struct dsc_reg_values * reg_vals ) ;
...
position p;
@@
 void cocci_id@p ( struct display_stream_compressor * dsc , int opp_pipe ) ;
...
position p;
@@
 struct drm_dsc_config * cocci_id@p ;
...
position p;
@@
 const struct dsc_reg_values * cocci_id@p ;
...
position p;
@@
 enum dsc_bits_per_comp { DSC_BPC_8 = 8 , DSC_BPC_10 = 10 , DSC_BPC_12 = 12 , DSC_BPC_UNKNOWN , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dsc_enc_caps * dsc_enc_caps , int pixel_clock_100Hz ) ;
...
position p;
@@
 struct dsc_optc_config * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct display_stream_compressor * dsc , struct drm_dsc_config * pps ) ;
...
position p;
@@
 const struct dsc_parameters * cocci_id@p ;
...
typedef bool;
@@
 enum dsc_pixel_format cocci_id@p ( enum dc_pixel_encoding dc_pix_enc , bool is_ycbcr422_simple ) ;
...
position p;
@@
 struct dsc_reg_values cocci_id@p ;
...
position p;
@@
 enum dsc_bits_per_comp cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct display_stream_compressor * dsc , const struct dsc_config * dsc_cfg , struct dsc_optc_config * dsc_optc_cfg ) ;
...
position p;
@@
 enum dc_pixel_encoding cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dsc_reg_values * reg_vals ) ;
...
position p;
@@
 void cocci_id@p ( struct display_stream_compressor * dsc , struct dcn_dsc_state * s ) ;
...
position p;
@@
 const struct dsc_config * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct display_stream_compressor * dsc ) ;
...
position p;
@@
 enum dsc_bits_per_comp cocci_id@p ( enum dc_color_depth ) ;
...
position p;
@@
 enum dsc_pixel_format cocci_id@p ;
...
position p;
@@
 struct dsc_enc_caps * cocci_id@p ;
...
position p;
@@
 const struct dsc_funcs cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( const struct dsc_config * dsc_cfg , struct dsc_reg_values * dsc_reg_vals , struct dsc_optc_config * dsc_optc_cfg ) ;
...
position p;
@@
 struct dsc_parameters cocci_id@p ;
...
position p;
@@
 struct drm_dsc_picture_parameter_set * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dsc_reg_values * reg_vals , const struct dsc_parameters * dsc_params ) ;
