...
position p;
@@
 struct mtk_spi_slave * cocci_id@p ;
...
typedef bool;
@@
 struct mtk_spi_slave {  struct device * dev ;  void __iomem * base ;  struct clk * spi_clk ;  struct completion xfer_done ;  struct spi_transfer * cur_transfer ;  bool slave_aborted ; } cocci_id@p ;
