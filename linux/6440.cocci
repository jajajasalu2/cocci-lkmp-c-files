...
position p;
@@
 struct uniphier_regulator_soc_data {  int nclks ;  const char * const * clock_names ;  int nrsts ;  const char * const * reset_names ;  const struct regulator_desc * desc ;  const struct regmap_config * regconf ; } cocci_id@p ;
...
position p;
@@
 const struct uniphier_regulator_soc_data cocci_id@p ;
...
position p;
@@
 struct uniphier_regulator_priv {  struct clk_bulk_data clk [ MAX_CLKS ] ;  struct reset_control * rst [ MAX_RSTS ] ;  const struct uniphier_regulator_soc_data * data ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_regulator_priv * cocci_id@p ;
