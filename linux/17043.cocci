...
position p;
@@
 struct twidjoy_button_spec {  int bitshift ;  int bitmask ;  int buttons [ 3 ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct twidjoy {  struct input_dev * dev ;  int idx ;  unsigned char data [ TWIDJOY_MAX_LENGTH ] ;  char phys [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct twidjoy_button_spec * cocci_id@p ;
