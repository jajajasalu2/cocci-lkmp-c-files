...
typedef u8,bool,u32;
@@
 struct mt9v111_dev {  struct device * dev ;  struct i2c_client * client ;  u8 addr_space ;  struct v4l2_subdev sd ; #if IS_ENABLED(CONFIG_MEDIA_CONTROLLER)  struct media_pad pad ; #endif  struct v4l2_ctrl * auto_awb ;  struct v4l2_ctrl * auto_exp ;  struct v4l2_ctrl * hblank ;  struct v4l2_ctrl * vblank ;  struct v4l2_ctrl_handler ctrls ;  struct v4l2_mbus_framefmt fmt ;  unsigned int fps ;  struct mutex pwr_mutex ;  int pwr_count ;  struct mutex stream_mutex ;  bool streaming ;  bool pending ;  struct clk * clk ;  u32 sysclk ;  struct gpio_desc * oe ;  struct gpio_desc * standby ;  struct gpio_desc * reset ; } cocci_id@p ;
...
typedef u32;
@@
 struct mt9v111_mbus_fmt {  u32 code ; } cocci_id@p [ ] ;
