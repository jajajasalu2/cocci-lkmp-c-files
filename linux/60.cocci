...
position p;
@@
 struct match_state {  int in_search ;  match_f match_direction ;  char pattern [ 256 ] ; } cocci_id@p ;
...
position p;
@@
 enum { MATCH_TINKER_PATTERN_UP , MATCH_TINKER_PATTERN_DOWN , FIND_NEXT_MATCH_DOWN , FIND_NEXT_MATCH_UP , } cocci_id@p ;
...
position p;
@@
 struct mitem {  char str [ 256 ] ;  char tag ;  void * usrptr ;  int is_visible ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( int * key , struct menu * menu ) ;
...
position p;
@@
 struct function_keys cocci_id@p [ ] ;
...
position p;
@@
 ITEM * cocci_id@p [ MAX_MENU_ITEMS ] ;
...
position p;
@@
 void cocci_id@p ( int * key , struct menu * current_item ) ;
...
symbol cocci_id;
position p;
typedef function_key_handler_t;
@@
 struct function_keys {  const char * key_str ;  const char * func ;  function_key key ;  function_key_handler_t handler ; } cocci_id@p ;
...
position p;
@@
 struct mitem cocci_id@p [ MAX_MENU_ITEMS ] ;
