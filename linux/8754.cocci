...
position p;
@@
 const struct qlcnic_sriov_fw_cmd_handler cocci_id@p [ ] ;
...
position p;
@@
 const struct qlcnic_sriov_cmd_handler cocci_id@p [ ] ;
...
position p;
@@
 struct qlcnic_resources * cocci_id@p ;
...
typedef u32;
@@
 struct qlcnic_sriov_fw_cmd_handler {  u32 cmd ;  int ( * fn ) ( struct qlcnic_bc_trans * , struct qlcnic_cmd_args * ) ; } cocci_id@p ;
...
position p;
@@
 struct qlcnic_sriov_cmd_handler {  int ( * fn ) ( struct qlcnic_bc_trans * , struct qlcnic_cmd_args * ) ; } cocci_id@p ;
