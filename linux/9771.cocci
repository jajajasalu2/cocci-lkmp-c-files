...
position p;
@@
 const struct il_debugfs_ops cocci_id@p ;
...
position p;
@@
 struct stats_rx_ht_phy * cocci_id@p ;
...
position p;
@@
 struct stats_general cocci_id@p ;
