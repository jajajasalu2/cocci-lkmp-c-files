...
position p;
@@
 struct bpf_sk_storage * cocci_id@p ;
...
typedef u32,u16;
@@
 struct bpf_sk_storage_map {  struct bpf_map map ;  struct bucket * buckets ;  u32 bucket_log ;  u16 elem_size ;  u16 cache_idx ; } cocci_id@p ;
...
position p;
@@
 struct bpf_sk_storage_elem cocci_id@p ;
...
position p;
@@
 struct bpf_sk_storage_data * cocci_id@p ;
...
position p;
@@
 const struct bpf_sk_storage_data * cocci_id@p ;
...
position p;
@@
 const struct bpf_sk_storage_elem * cocci_id@p ;
...
position p;
@@
 struct bpf_sk_storage_map * cocci_id@p ;
...
@@
 struct bucket {  struct hlist_head list ;  raw_spinlock_t lock ; } cocci_id@p ;
...
typedef raw_spinlock_t;
@@
 struct bpf_sk_storage {  struct bpf_sk_storage_data __rcu * cache [ BPF_SK_STORAGE_CACHE_SIZE ] ;  struct hlist_head list ;  struct sock * sk ;  struct rcu_head rcu ;  raw_spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct bpf_sk_storage_elem {  struct hlist_node map_node ;  struct hlist_node snode ;  struct bpf_sk_storage __rcu * sk_storage ;  struct rcu_head rcu ;  struct bpf_sk_storage_data sdata ____cacheline_aligned ; } cocci_id@p ;
