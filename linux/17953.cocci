...
typedef u32;
@@
 const struct pci_slot_names {  u32 slot_mask ;  char names [ 0 ] ; } * cocci_id@p ;
...
position p;
@@
 struct dev_archdata * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pci_pbm_info * pbm , struct device_node * node , struct pci_bus * bus ) ;
