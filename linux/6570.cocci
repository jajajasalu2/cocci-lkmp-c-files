...
position p;
@@
 void cocci_id@p ( struct scsi_cd * ) ;
...
position p;
@@
 unsigned int cocci_id@p ( struct cdrom_device_info * cdi , unsigned int clearing , int slot ) ;
...
position p;
@@
 unsigned long cocci_id@p [ SR_DISKS / BITS_PER_LONG ] ;
...
position p;
@@
 void cocci_id@p ( struct cdrom_device_info * ) ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * , struct packet_command * ) ;
...
position p;
@@
 int cocci_id@p ( struct cdrom_device_info * , int ) ;
