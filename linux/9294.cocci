...
position p;
@@
 struct rx_radiotap_hdr * cocci_id@p ;
...
position p;
@@
 struct rx80211packethdr * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lbs_private * priv , struct sk_buff * skb ) ;
