...
typedef u8;
@@
 struct pn533_usb_phy {  struct usb_device * udev ;  struct usb_interface * interface ;  struct urb * out_urb ;  struct urb * in_urb ;  struct urb * ack_urb ;  u8 * ack_buffer ;  struct pn533 * priv ; } cocci_id@p ;
...
position p;
@@
 struct pn533_acr122_poweron_rdr_arg {  int rc ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 struct pn533_acr122_rx_frame cocci_id@p ;
...
position p;
@@
 struct pn533_acr122_tx_frame * cocci_id@p ;
...
position p;
@@
 struct pn533_acr122_poweron_rdr_arg cocci_id@p ;
...
position p;
@@
 struct pn533_usb_phy * cocci_id@p ;
