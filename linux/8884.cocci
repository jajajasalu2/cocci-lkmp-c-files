...
position p;
@@
 struct pch_gbe_option {  enum { enable_option , range_option , list_option , } type ;  char * name ;  char * err ;  int def ;  union {  struct {  int min ;  int max ; } r ;  struct {  int nr ;  const struct pch_gbe_opt_list {  int i ;  char * str ; } * p ; } l ; } arg ; } cocci_id@p ;
...
position p;
@@
 const struct pch_gbe_opt_list * cocci_id@p ;
...
position p;
@@
 const struct pch_gbe_option * cocci_id@p ;
