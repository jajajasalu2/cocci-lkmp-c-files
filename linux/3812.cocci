...
position p;
@@
 struct vas_rx_win_attr cocci_id@p ;
...
position p;
@@
 struct nx842_coproc {  unsigned int chip_id ;  unsigned int ct ;  unsigned int ci ;  struct {  struct vas_window * rxwin ;  int id ; } vas ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct coprocessor_status_block * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const unsigned char * in , unsigned int inlen , unsigned char * out , unsigned int * outlenp , void * workmem , int fc ) ;
...
position p;
@@
 struct vas_tx_win_attr cocci_id@p ;
...
position p;
@@
 struct data_descriptor_entry * cocci_id@p ;
...
position p;
@@
 struct nx842_coproc * cocci_id@p ;
...
position p;
@@
 struct coprocessor_request_block * cocci_id@p ;
