...
position p;
@@
 struct debugfs_radix_state * cocci_id@p ;
...
typedef u8;
@@
 struct debugfs_radix_state {  struct kvm * kvm ;  struct mutex mutex ;  unsigned long gpa ;  int lpid ;  int chars_left ;  int buf_index ;  char buf [ 128 ] ;  u8 hdr ; } cocci_id@p ;
