...
position p;
@@
 struct ion_system_heap * cocci_id@p ;
...
position p;
@@
 struct ion_page_pool * * cocci_id@p ;
...
position p;
@@
 struct ion_system_heap {  struct ion_heap heap ;  struct ion_page_pool * pools [ NUM_ORDERS ] ; } cocci_id@p ;
...
position p;
@@
 struct ion_heap_ops cocci_id@p ;
