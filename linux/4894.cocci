...
position p;
@@
 struct mlx5_ib_create_flow * cocci_id@p ;
...
position p;
@@
 struct mlx5_read_counters_attr cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_multiport_info * cocci_id@p ;
...
position p;
@@
 struct mlx5_hca_vport_context * cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_ctrl_seg cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_alloc_ucontext_req cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_flow_counters_desc * cocci_id@p ;
...
position p;
@@
 enum { MAX_UMR_WR = 128 , } cocci_id@p ;
...
position p;
@@
 const struct mlx5_flow_act * cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_data_seg cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_flow_prio * cocci_id@p ;
...
position p;
@@
 const struct mlx5_ib_profile * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_event_work cocci_id@p ;
...
position p;
@@
 enum valid_spec { VALID_SPEC_INVALID , VALID_SPEC_VALID , VALID_SPEC_NA , } cocci_id@p ;
...
position p;
@@
 struct ib_device_modify * cocci_id@p ;
...
position p;
@@
 const struct mlx5_flow_spec * cocci_id@p ;
...
position p;
@@
 struct mlx5_core_cq * cocci_id@p ;
...
position p;
@@
 enum mlx5_vl_hw_cap { MLX5_VL_HW_0 = 1 , MLX5_VL_HW_0_1 = 2 , MLX5_VL_HW_0_2 = 3 , MLX5_VL_HW_0_3 = 4 , MLX5_VL_HW_0_4 = 5 , MLX5_VL_HW_0_5 = 6 , MLX5_VL_HW_0_6 = 7 , MLX5_VL_HW_0_7 = 8 , MLX5_VL_HW_0_14 = 15 , } cocci_id@p ;
...
position p;
@@
 struct ib_dm_alloc_attr * cocci_id@p ;
...
position p;
@@
 enum ib_max_vl_num { __IB_MAX_VL_0 = 1 , __IB_MAX_VL_0_1 = 2 , __IB_MAX_VL_0_3 = 3 , __IB_MAX_VL_0_7 = 4 , __IB_MAX_VL_0_14 = 5 , } cocci_id@p ;
...
position p;
@@
 struct ib_port_immutable * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_resources * cocci_id@p ;
...
position p;
@@
 struct ib_port_modify * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_port_resources cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_counters * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( alloc_pd_in ) ] ;
...
position p;
@@
 struct {  struct ib_flow_attr flow_attr ;  struct ib_flow_spec_eth eth_flow ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 struct mlx5_reg_node_desc {  u8 desc [ IB_DEVICE_NODE_DESC_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_flow_counters_data cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( alloc_pd_out ) ] ;
...
position p;
@@
 struct mlx5_ib_flow_action * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_counter {  const char * name ;  size_t offset ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_table * cocci_id@p ;
...
position p;
@@
 enum rdma_link_layer cocci_id@p ;
...
position p;
@@
 struct mlx5_bfreg_info * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_delay_drop cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_query_device_resp cocci_id@p ;
...
position p;
@@
 const struct mlx5_ib_counters * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_alloc_ucontext_req_v2 cocci_id@p ;
...
position p;
@@
 enum { MLX5_ATOMIC_SIZE_QP_8BYTES = 1 << 3 , } cocci_id@p ;
...
position p;
@@
 enum mlx5_ib_width { MLX5_IB_WIDTH_1X = 1 << 0 , MLX5_IB_WIDTH_2X = 1 << 1 , MLX5_IB_WIDTH_4X = 1 << 2 , MLX5_IB_WIDTH_8X = 1 << 3 , MLX5_IB_WIDTH_12X = 1 << 4 , } cocci_id@p ;
...
position p;
@@
 const struct ib_flow_attr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rdma_netdev_t;
@@
 enum rdma_netdev_t cocci_id@p ;
...
position p;
@@
 const struct ib_flow_action_attrs_esp * cocci_id@p ;
...
position p;
@@
 const union ib_flow_spec * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( ptys_reg ) ] ;
...
position p;
@@
 enum { MATCH_CRITERIA_ENABLE_OUTER_BIT , MATCH_CRITERIA_ENABLE_MISC_BIT , MATCH_CRITERIA_ENABLE_INNER_BIT , MATCH_CRITERIA_ENABLE_MISC2_BIT , } cocci_id@p ;
...
position p;
@@
 struct mlx5_user_mmap_entry * cocci_id@p ;
...
position p;
@@
 struct mlx5_accel_esp_xfrm_attrs cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_alloc_ucontext_resp cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_mcounters * cocci_id@p ;
...
position p;
@@
 enum { LEFTOVERS_MC , LEFTOVERS_UC , } cocci_id@p ;
...
position p;
@@
 struct rdma_netdev_alloc_params * cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_destination * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_ucontext cocci_id@p ;
...
position p;
@@
 struct ib_counters_read_attr * cocci_id@p ;
...
position p;
@@
 struct rdma_hw_stats * cocci_id@p ;
...
position p;
@@
 enum mlx5_flow_namespace_type cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_port * cocci_id@p ;
...
position p;
@@
 struct rdma_counter * cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_flow_action_esp_keymat_aes_gcm * cocci_id@p ;
...
position p;
@@
 enum mlx5_ib_mmap_cmd cocci_id@p ;
...
position p;
@@
 enum mlx5_ib_uapi_dm_type cocci_id@p ;
...
position p;
@@
 enum { MLX5_VPORT_ACCESS_METHOD_MAD , MLX5_VPORT_ACCESS_METHOD_HCA , MLX5_VPORT_ACCESS_METHOD_NIC , } cocci_id@p ;
...
position p;
@@
 const struct mlx5_ib_counter cocci_id@p [ ] ;
...
position p;
@@
 struct mlx5_ib_alloc_pd_resp cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_raddr_seg cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_namespace * cocci_id@p ;
...
position p;
@@
 enum mlx5_ib_uapi_flow_action_flags cocci_id@p ;
...
position p;
@@
 enum flow_table_type cocci_id@p ;
...
position p;
@@
 struct rdma_user_mmap_entry * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_flow_matcher * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_flow_handler * cocci_id@p ;
...
position p;
@@
 const struct mlx5_core_dev * cocci_id@p ;
...
position p;
@@
 const struct ib_device_ops cocci_id@p ;
...
position p;
@@
 const struct ib_gid_attr * cocci_id@p ;
...
position p;
@@
 enum mlx5_ib_counters_type cocci_id@p ;
...
position p;
@@
 struct mlx5_init_seg cocci_id@p ;
...
position p;
@@
 struct mlx5_reg_node_desc cocci_id@p ;
...
typedef bool;
@@
 struct mlx5_ib_event_work {  struct work_struct work ;  union {  struct mlx5_ib_dev * dev ;  struct mlx5_ib_multiport_info * mpi ; } ;  bool is_slave ;  unsigned int event ;  void * param ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_interface cocci_id@p ;
...
position p;
@@
 enum flow_table_type { MLX5_IB_FT_RX , MLX5_IB_FT_TX , } cocci_id@p ;
