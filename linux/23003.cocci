...
position p;
@@
 enum bit_depth { BIT_DEPTH_8 , BIT_DEPTH_16 , BIT_DEPTH_20 , BIT_DEPTH_24 , BIT_DEPTH_32 , } cocci_id@p ;
...
typedef bool;
@@
 struct xlnx_pcm_drv_data {  void __iomem * mmio ;  bool s2mm_presence ;  bool mm2s_presence ;  int s2mm_irq ;  int mm2s_irq ;  struct snd_pcm_substream * play_stream ;  struct snd_pcm_substream * capture_stream ;  struct clk * axi_clk ; } cocci_id@p ;
...
position p;
@@
 struct xlnx_pcm_drv_data * cocci_id@p ;
...
@@
 struct xlnx_pcm_stream_param {  void __iomem * mmio ;  bool interleaved ;  u32 xfer_mode ;  u32 ch_limit ;  u64 buffer_size ; } cocci_id@p ;
...
position p;
@@
 enum { AES_TO_AES , AES_TO_PCM , PCM_TO_PCM , PCM_TO_AES , } cocci_id@p ;
...
position p;
@@
 struct xlnx_pcm_stream_param * cocci_id@p ;
