...
position p;
@@
 struct sctp_fwdtsn_skip cocci_id@p [ 10 ] ;
...
position p;
@@
 const struct sctp_outq * cocci_id@p ;
...
typedef __u32;
@@
 void cocci_id@p ( struct sctp_outq * q , struct list_head * transmitted_queue , struct sctp_transport * transport , __u32 highest_new_tsn , int count_of_newacks ) ;
...
position p;
@@
 union sctp_sack_variable * cocci_id@p ;
...
typedef __u32;
@@
 void cocci_id@p ( struct sctp_outq * q , struct list_head * transmitted_queue , struct sctp_transport * transport , union sctp_addr * saddr , struct sctp_sackhdr * sack , __u32 * highest_new_tsn ) ;
...
position p;
@@
 struct sctp_flush_ctx cocci_id@p ;
...
typedef gfp_t;
@@
 struct sctp_flush_ctx {  struct sctp_outq * q ;  struct sctp_transport * transport ;  struct list_head transport_list ;  struct sctp_association * asoc ;  struct sctp_packet * packet ;  gfp_t gfp ; } cocci_id@p ;
...
typedef __u32;
@@
 int cocci_id@p ( struct sctp_sackhdr * sack , __u32 tsn ) ;
...
position p;
@@
 enum sctp_retransmit_reason cocci_id@p ;
...
position p;
@@
 struct sctp_stream_out * cocci_id@p ;
