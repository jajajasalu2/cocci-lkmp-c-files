...
position p;
@@
 const struct sfp_quirk cocci_id@p [ ] ;
...
position p;
@@
 struct sfp_quirk {  const char * vendor ;  const char * part ;  void ( * modes ) ( const struct sfp_eeprom_id * id , unsigned long * modes ) ; } cocci_id@p ;
