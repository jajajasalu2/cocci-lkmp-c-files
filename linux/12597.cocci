...
position p;
@@
 struct dpu_hw_intr_ops * cocci_id@p ;
...
position p;
@@
 const struct dpu_irq_type * cocci_id@p ;
...
position p;
@@
 const struct dpu_intr_reg cocci_id@p [ ] ;
...
typedef u32;
@@
 struct dpu_intr_reg {  u32 clr_off ;  u32 en_off ;  u32 status_off ; } cocci_id@p ;
...
typedef u32;
@@
 struct dpu_irq_type {  u32 intr_type ;  u32 instance_idx ;  u32 irq_mask ;  u32 reg_idx ; } cocci_id@p ;
