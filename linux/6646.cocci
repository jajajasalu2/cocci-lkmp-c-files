...
position p;
@@
 struct ata_task_resp * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hisi_hba * hisi_hba , struct domain_device * device , int abort_flag , int tag ) ;
...
position p;
@@
 struct hisi_sas_rst cocci_id@p ;
...
position p;
@@
 struct hisi_sas_debugfs_itct_cache * cocci_id@p ;
...
position p;
@@
 struct hisi_sas_breakpoint * cocci_id@p ;
...
position p;
@@
 struct hisi_sas_iost_itct_cache * cocci_id@p ;
...
position p;
@@
 struct hisi_sas_debugfs_iost_cache * cocci_id@p ;
...
position p;
@@
 struct hisi_sas_slot_dif_buf_table cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct domain_device * device ) ;
...
position p;
@@
 struct hisi_sas_debugfs_cq * cocci_id@p ;
...
position p;
@@
 struct sas_domain_function_template cocci_id@p ;
...
position p;
@@
 struct sas_task_slow * cocci_id@p ;
...
position p;
@@
 const struct hisi_sas_debugfs_reg_lu * cocci_id@p ;
...
position p;
@@
 const struct {  int value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct hisi_sas_debugfs_dq * cocci_id@p ;
...
position p;
@@
 struct hisi_sas_sata_breakpoint cocci_id@p ;
...
position p;
@@
 struct hisi_sas_debugfs_regs * cocci_id@p ;
...
position p;
@@
 enum { HISI_SAS_BIST_LOOPBACK_MODE_DIGITAL = 0 , HISI_SAS_BIST_LOOPBACK_MODE_SERDES , HISI_SAS_BIST_LOOPBACK_MODE_REMOTE , } cocci_id@p ;
...
position p;
@@
 struct hisi_sas_iost * cocci_id@p ;
...
position p;
@@
 struct hisi_sas_slot_buf_table cocci_id@p ;
...
position p;
@@
 enum hisi_sas_phy_event cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct domain_device * device ) ;
...
position p;
@@
 int cocci_id@p ( struct asd_sas_phy * sas_phy , enum phy_func func , void * funcdata ) ;
...
position p;
@@
 struct hisi_sas_debugfs_itct * cocci_id@p ;
...
position p;
@@
 struct hisi_sas_debugfs_port * cocci_id@p ;
...
typedef work_func_t;
@@
 const work_func_t cocci_id@p [ HISI_PHYES_NUM ] ;
...
position p;
@@
 struct hisi_sas_debugfs_iost * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hisi_hba * hisi_hba , struct domain_device * device ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct domain_device * device , u8 * lun , struct hisi_sas_tmf_task * tmf ) ;
...
position p;
@@
 const struct hisi_sas_debugfs_reg * cocci_id@p ;
