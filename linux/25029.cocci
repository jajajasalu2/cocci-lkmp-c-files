...
position p;
@@
 struct digital_sensf_res cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct nfc_digital_dev * ddev , struct nfc_target * target ) ;
...
position p;
@@
 struct digital_sensf_req * cocci_id@p ;
...
position p;
@@
 struct digital_sel_req * cocci_id@p ;
...
position p;
@@
 struct digital_sdd_res * cocci_id@p ;
...
position p;
@@
 struct digital_sensb_req * cocci_id@p ;
...
position p;
@@
 struct digital_iso15693_inv_res * cocci_id@p ;
...
position p;
@@
 struct digital_sensb_res * cocci_id@p ;
...
position p;
@@
 struct digital_iso15693_inv_req * cocci_id@p ;
...
position p;
@@
 struct digital_attrib_req * cocci_id@p ;
...
position p;
@@
 struct digital_attrib_res * cocci_id@p ;
