...
position p;
@@
 struct drm_tegra_open_channel * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_syncpt_read * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_gem_set_tiling * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_submit * cocci_id@p ;
...
position p;
@@
 const struct drm_ioctl_desc cocci_id@p [ ] ;
...
position p;
@@
 struct host1x_syncpt * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_syncpt cocci_id@p ;
...
position p;
@@
 enum tegra_bo_tiling_mode cocci_id@p ;
...
position p;
@@
 struct tegra_drm_file {  struct idr contexts ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct drm_tegra_get_syncpt * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_cmdbuf cocci_id@p ;
...
position p;
@@
 struct drm_tegra_gem_set_flags * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_gem_create * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_close_channel * cocci_id@p ;
...
position p;
@@
 struct host1x_syncpt_base * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_syncpt_incr * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_gem_get_flags * cocci_id@p ;
...
position p;
@@
 struct tegra_drm_file * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_syncpt_wait * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_gem_get_tiling * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_gem_mmap * cocci_id@p ;
...
position p;
@@
 struct host1x_reloc * cocci_id@p ;
...
position p;
@@
 struct host1x_device * cocci_id@p ;
...
position p;
@@
 const struct drm_mode_config_helper_funcs cocci_id@p ;
...
position p;
@@
 struct tegra_drm_client * cocci_id@p ;
...
position p;
@@
 struct drm_info_list cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_drm_context * cocci_id@p ;
...
position p;
@@
 struct drm_tegra_get_syncpt_base * cocci_id@p ;
...
position p;
@@
 struct host1x_driver cocci_id@p ;
