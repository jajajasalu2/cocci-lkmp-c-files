...
position p;
@@
 void ( * cocci_id@p ) ( struct softirq_action * ) ;
...
position p;
@@
 const char * const cocci_id@p [ NR_SOFTIRQS ] ;
...
position p;
@@
 struct tasklet_head {  struct tasklet_struct * head ;  struct tasklet_struct * * tail ; } cocci_id@p ;
...
position p;
@@
 struct tasklet_head * cocci_id@p ;
