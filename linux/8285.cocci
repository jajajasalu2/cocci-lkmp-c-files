...
position p;
@@
 struct efx_mcdi_mon_attribute * cocci_id@p ;
...
position p;
@@
 const struct {  const char * label ;  enum efx_hwmon_type hwmon_type ;  int port ; } cocci_id@p [ ] ;
...
position p;
@@
 enum efx_hwmon_type { EFX_HWMON_UNKNOWN , EFX_HWMON_TEMP , EFX_HWMON_COOL , EFX_HWMON_IN , EFX_HWMON_CURR , EFX_HWMON_POWER , EFX_HWMON_TYPES_COUNT , } cocci_id@p ;
...
position p;
@@
 enum efx_hwmon_type cocci_id@p ;
...
position p;
@@
 struct efx_mcdi_mon * cocci_id@p ;
...
position p;
@@
 struct efx_mcdi_mon_attribute {  struct device_attribute dev_attr ;  unsigned int index ;  unsigned int type ;  enum efx_hwmon_type hwmon_type ;  unsigned int limit_value ;  char name [ 12 ] ; } cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ EFX_HWMON_TYPES_COUNT ] ;
