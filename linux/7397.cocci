...
position p;
@@
 struct omap_overlay_manager * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct platform_device * dsidev , struct omap_overlay_manager * mgr ) ;
...
position p;
@@
 struct dsi_packet_sent_handler_data {  struct platform_device * dsidev ;  struct completion * completion ; } cocci_id@p ;
...
position p;
@@
 const struct omapdss_dsi_ops cocci_id@p ;
...
position p;
@@
 struct dsi_irq_stats {  unsigned long last_reset ;  unsigned irq_count ;  unsigned dsi_irqs [ 32 ] ;  unsigned vc_irqs [ 4 ] [ 32 ] ;  unsigned cio_irqs [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct omap_dss_device * dssdev , int channel ) ;
...
position p;
@@
 enum omap_dss_output_id cocci_id@p ;
...
position p;
@@
 struct omap_video_timings * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct platform_device * dsidev , struct omap_overlay_manager * mgr ) ;
...
position p;
@@
 const struct omap_video_timings * cocci_id@p ;
