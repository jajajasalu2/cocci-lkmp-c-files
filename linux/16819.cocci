...
position p;
@@
 struct max8997_haptic * cocci_id@p ;
...
position p;
@@
 const struct max8997_haptic_platform_data * cocci_id@p ;
...
position p;
@@
 const struct max8997_platform_data * cocci_id@p ;
