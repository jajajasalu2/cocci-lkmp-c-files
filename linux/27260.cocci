...
position p;
@@
 struct nfsd_file_mark cocci_id@p ;
...
position p;
@@
 enum nfsd_file_laundrette_ctl { NFSD_FILE_LAUNDRETTE_NOFLUSH = 0 , NFSD_FILE_LAUNDRETTE_MAY_FLUSH , } cocci_id@p ;
...
position p;
@@
 enum nfsd_file_laundrette_ctl cocci_id@p ;
...
typedef spinlock_t;
@@
 struct nfsd_fcache_bucket {  struct hlist_head nfb_head ;  spinlock_t nfb_lock ;  unsigned int nfb_count ;  unsigned int nfb_maxcount ; } cocci_id@p ;
...
position p;
@@
 struct nfsd_fcache_bucket * cocci_id@p ;
