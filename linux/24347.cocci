...
position p;
@@
 struct phonet_routes {  struct mutex lock ;  struct net_device __rcu * table [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 struct phonet_device_list * cocci_id@p ;
...
position p;
@@
 struct phonet_net {  struct phonet_device_list pndevs ;  struct phonet_routes routes ; } cocci_id@p ;
...
position p;
@@
 struct phonet_routes * cocci_id@p ;
...
position p;
@@
 struct phonet_device * cocci_id@p ;
...
position p;
@@
 struct if_phonet_req cocci_id@p ;
