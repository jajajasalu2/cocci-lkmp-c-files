...
position p;
@@
 const struct socfpga_dwmac_ops * cocci_id@p ;
...
position p;
@@
 struct socfpga_dwmac_ops {  int ( * set_phy_mode ) ( struct socfpga_dwmac * dwmac_priv ) ; } cocci_id@p ;
...
position p;
@@
 struct socfpga_dwmac * cocci_id@p ;
...
typedef bool,u32;
@@
 struct socfpga_dwmac {  u32 reg_offset ;  u32 reg_shift ;  struct device * dev ;  struct regmap * sys_mgr_base_addr ;  struct reset_control * stmmac_rst ;  struct reset_control * stmmac_ocp_rst ;  void __iomem * splitter_base ;  bool f2h_ptp_ref_clk ;  struct tse_pcs pcs ;  const struct socfpga_dwmac_ops * ops ; } cocci_id@p ;
