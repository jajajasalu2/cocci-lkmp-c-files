...
position p;
@@
 struct cap11xx_priv * cocci_id@p ;
...
typedef u32;
@@
 struct cap11xx_led {  struct cap11xx_priv * priv ;  struct led_classdev cdev ;  u32 reg ; } cocci_id@p ;
...
position p;
@@
 const struct cap11xx_hw_model * cocci_id@p ;
...
typedef u32;
@@
 struct cap11xx_priv {  struct regmap * regmap ;  struct input_dev * idev ;  struct cap11xx_led * leds ;  int num_leds ;  u32 keycodes [ ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct cap11xx_hw_model {  u8 product_id ;  unsigned int num_channels ;  unsigned int num_leds ; } cocci_id@p ;
...
position p;
@@
 enum { CAP1106 , CAP1126 , CAP1188 , } cocci_id@p ;
