...
typedef s16,u32,u16;
@@
 struct armada_overlay_state {  struct armada_plane_state base ;  u32 colorkey_yr ;  u32 colorkey_ug ;  u32 colorkey_vb ;  u32 colorkey_mode ;  u32 colorkey_enable ;  s16 brightness ;  u16 contrast ;  u16 saturation ; } cocci_id@p ;
...
position p;
@@
 struct armada_overlay_state cocci_id@p ;
...
position p;
@@
 struct armada_private * cocci_id@p ;
