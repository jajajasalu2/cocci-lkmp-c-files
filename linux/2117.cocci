...
position p;
@@
 enum bq25890_table_ids cocci_id@p ;
...
position p;
@@
 enum bq25890_chrg_fault { CHRG_FAULT_NORMAL , CHRG_FAULT_INPUT , CHRG_FAULT_THERMAL_SHUTDOWN , CHRG_FAULT_TIMER_EXPIRED , } cocci_id@p ;
...
typedef u32;
@@
 struct bq25890_lookup {  const u32 * tbl ;  u32 size ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  enum bq25890_fields id ;  u8 * data ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 struct bq25890_state {  u8 online ;  u8 chrg_status ;  u8 chrg_fault ;  u8 vsys_status ;  u8 boost_fault ;  u8 bat_fault ; } cocci_id@p ;
...
position p;
@@
 enum bq25890_fields cocci_id@p ;
...
position p;
@@
 struct bq25890_init_data * cocci_id@p ;
...
position p;
@@
 const union {  struct bq25890_range rt ;  struct bq25890_lookup lt ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct bq25890_range {  u32 min ;  u32 max ;  u32 step ; } cocci_id@p ;
...
position p;
@@
 struct bq25890_device * cocci_id@p ;
...
position p;
@@
 enum bq25890_table_ids { TBL_ICHG , TBL_ITERM , TBL_VREG , TBL_BOOSTV , TBL_SYSVMIN , TBL_TREG , TBL_BOOSTI , } cocci_id@p ;
...
typedef u32;
@@
 const struct {  enum bq25890_fields id ;  u32 value ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 struct bq25890_init_data {  u8 ichg ;  u8 vreg ;  u8 iterm ;  u8 iprechg ;  u8 sysvmin ;  u8 boostv ;  u8 boosti ;  u8 boostf ;  u8 ilim_en ;  u8 treg ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct {  char * name ;  bool optional ;  enum bq25890_table_ids tbl_id ;  u8 * conv_data ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct bq25890_range * cocci_id@p ;
...
position p;
@@
 enum bq25890_status { STATUS_NOT_CHARGING , STATUS_PRE_CHARGING , STATUS_FAST_CHARGING , STATUS_TERMINATION_DONE , } cocci_id@p ;
...
position p;
@@
 struct bq25890_state cocci_id@p ;
