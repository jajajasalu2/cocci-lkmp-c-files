...
position p;
@@
 struct nvme_get_log_page_command cocci_id@p ;
...
position p;
@@
 struct streams_directive_params * cocci_id@p ;
...
typedef u16;
@@
 struct nvme_core_quirk_entry {  u16 vid ;  const char * mn ;  const char * fr ;  unsigned long quirks ; } cocci_id@p ;
...
position p;
@@
 struct nvme_directive_cmd cocci_id@p ;
...
position p;
@@
 const struct pr_ops cocci_id@p ;
...
position p;
@@
 struct nvme_rw_command cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gendisk * disk ) ;
...
position p;
@@
 struct nvme_passthru_cmd cocci_id@p ;
...
position p;
@@
 struct nvme_ns_head * cocci_id@p ;
...
position p;
@@
 struct nvme_fw_slot_info_log * cocci_id@p ;
...
position p;
@@
 struct nvme_smart_log cocci_id@p ;
...
position p;
@@
 struct nvme_format_cmd cocci_id@p ;
...
position p;
@@
 const struct nvme_core_quirk_entry * cocci_id@p ;
...
position p;
@@
 struct nvme_ns_id_desc * cocci_id@p ;
...
position p;
@@
 struct nvme_user_io cocci_id@p ;
...
position p;
@@
 struct nvme_dsm_range cocci_id@p ;
...
position p;
@@
 struct nvme_write_zeroes_cmd cocci_id@p ;
...
position p;
@@
 struct nvme_subsystem * cocci_id@p ;
...
position p;
@@
 struct nvme_id_ctrl * cocci_id@p ;
...
position p;
@@
 struct nvme_dsm_cmd cocci_id@p ;
...
position p;
@@
 struct nvme_feat_host_behavior * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvme_ctrl * ctrl , unsigned nsid ) ;
...
position p;
@@
 struct nvme_lba_range_type cocci_id@p ;
...
position p;
@@
 struct nvme_features cocci_id@p ;
...
position p;
@@
 struct nvme_passthru_cmd64 cocci_id@p ;
...
position p;
@@
 struct nvme_identify cocci_id@p ;
...
position p;
@@
 struct nvme_feat_auto_pst * cocci_id@p ;
...
position p;
@@
 volatile union nvme_result * cocci_id@p ;
...
position p;
@@
 struct nvme_abort_cmd cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvme_subsystem * subsys ) ;
...
position p;
@@
 enum nvme_ctrl_state cocci_id@p ;
...
position p;
@@
 const struct nvme_id_ctrl * cocci_id@p ;
...
position p;
@@
 struct nvme_download_firmware cocci_id@p ;
