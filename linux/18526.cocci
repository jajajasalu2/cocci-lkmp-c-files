...
typedef u16;
@@
 struct h2p2_dbg_fpga {  u16 smc91x [ 8 ] ;  u16 fpga_rev ;  u16 board_rev ;  u16 gpio_outputs ;  u16 leds ;  u16 misc_inputs ;  u16 lan_status ;  u16 lan_reset ;  u16 reserved0 ;  u16 ps2_data ;  u16 ps2_ctrl ; } cocci_id@p ;
...
typedef u16;
@@
 struct dbg_led {  struct led_classdev cdev ;  u16 mask ; } cocci_id@p ;
