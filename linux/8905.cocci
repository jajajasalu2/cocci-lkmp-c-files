...
position p;
@@
 struct ocelot_dump_ctx cocci_id@p ;
...
typedef u8,u16;
@@
 struct ocelot_mact_entry {  u8 mac [ ETH_ALEN ] ;  u16 vid ;  enum macaccess_entry_type type ; } cocci_id@p ;
...
position p;
@@
 struct ocelot_mact_entry cocci_id@p ;
...
position p;
@@
 enum macaccess_entry_type { ENTRYTYPE_NORMAL = 0 , ENTRYTYPE_LOCKED , ENTRYTYPE_MACv4 , ENTRYTYPE_MACv6 , } cocci_id@p ;
...
position p;
@@
 struct ocelot_port_private * cocci_id@p ;
...
position p;
@@
 enum macaccess_entry_type cocci_id@p ;
...
position p;
@@
 enum ocelot_tag_prefix cocci_id@p ;
...
position p;
@@
 struct ocelot_dump_ctx {  struct net_device * dev ;  struct sk_buff * skb ;  struct netlink_callback * cb ;  int idx ; } cocci_id@p ;
...
position p;
@@
 struct ocelot_multicast * cocci_id@p ;
