...
position p;
@@
 struct drm_plane_funcs cocci_id@p ;
...
position p;
@@
 struct kirin_drm_data cocci_id@p ;
...
position p;
@@
 const struct kirin_format cocci_id@p [ ] ;
...
typedef bool;
@@
 struct ade_hw_ctx {  void __iomem * base ;  struct regmap * noc_regmap ;  struct clk * ade_core_clk ;  struct clk * media_noc_clk ;  struct clk * ade_pix_clk ;  struct reset_control * reset ;  struct work_struct display_reset_wq ;  bool power_on ;  int irq ;  struct drm_crtc * crtc ; } cocci_id@p ;
