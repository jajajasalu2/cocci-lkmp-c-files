...
position p;
@@
 const struct cpcap_led_info cocci_id@p ;
...
typedef u16;
@@
 struct cpcap_led_info {  u16 reg ;  u16 mask ;  u16 limit ;  u16 init_mask ;  u16 init_val ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct cpcap_led {  struct led_classdev led ;  const struct cpcap_led_info * info ;  struct device * dev ;  struct regmap * regmap ;  struct mutex update_lock ;  struct regulator * vdd ;  bool powered ;  u32 current_limit ; } cocci_id@p ;
