...
position p;
@@
 struct mpr121_touchkey * cocci_id@p ;
...
position p;
@@
 const struct mpr121_init_register * cocci_id@p ;
...
typedef u8;
@@
 struct mpr121_init_register {  int addr ;  u8 val ; } cocci_id@p ;
...
typedef u32;
@@
 struct mpr121_touchkey {  struct i2c_client * client ;  struct input_dev * input_dev ;  unsigned int statusbits ;  unsigned int keycount ;  u32 keycodes [ MPR121_MAX_KEY_COUNT ] ; } cocci_id@p ;
