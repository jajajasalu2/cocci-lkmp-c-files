...
position p;
@@
 struct fcoe_transport cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fc_lport * ) ;
...
position p;
@@
 struct fcoe_interface * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct fc_lport * ) ;
...
position p;
@@
 struct fcoe_interface * cocci_id@p ( const struct net_device * ) ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct fc_vport * , bool disabled ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * netdev , enum fip_mode fip_mode ) ;
...
position p;
@@
 int cocci_id@p ( struct fcoe_ctlr_device * cdev ) ;
...
position p;
@@
 struct fcoe_sysfs_function_template cocci_id@p ;
...
position p;
@@
 const struct fc_lport * cocci_id@p ;
...
position p;
@@
 struct fcoe_fcf_device * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct fc_lport * , u32 , struct fc_frame * ) ;
...
position p;
@@
 struct fc_rport_libfc_priv cocci_id@p ;
...
position p;
@@
 struct dcb_app_type * cocci_id@p ;
...
position p;
@@
 struct fcoe_rcv_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fc_lport * , struct fc_frame * ) ;
...
position p;
@@
 struct netdev_fcoe_hbainfo * cocci_id@p ;
...
position p;
@@
 enum fcoe_create_link_state { FCOE_CREATE_LINK_DOWN , FCOE_CREATE_LINK_UP , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_lport * ) ;
...
position p;
@@
 void cocci_id@p ( struct fcoe_fcf_device * ) ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * , ulong , void * ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct fc_lport * , u16 ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct fc_lport * , u16 , struct scatterlist * , unsigned int ) ;
...
position p;
@@
 void cocci_id@p ( struct fcoe_ctlr * , struct sk_buff * ) ;
...
position p;
@@
 int cocci_id@p ( const struct fc_lport * ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct fc_seq * , struct fc_frame * , void * ) ;
...
position p;
@@
 int cocci_id@p ( struct sk_buff * , struct net_device * , struct packet_type * , struct net_device * ) ;
...
position p;
@@
 struct libfc_function_template cocci_id@p ;
...
position p;
@@
 struct fcoe_percpu_s cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct fc_lport * , u8 * ) ;
...
typedef u32;
@@
 struct fc_seq * cocci_id@p ( struct fc_lport * , u32 did , struct fc_frame * , unsigned int op , void ( * resp ) ( struct fc_seq * , struct fc_frame * , void * ) , void * , u32 timeout ) ;
...
position p;
@@
 enum fcoe_create_link_state cocci_id@p ;
...
position p;
@@
 struct fc_host_attrs * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct fc_vport * , bool disable ) ;
...
position p;
@@
 struct fcoe_ctlr_device * cocci_id@p ;
...
position p;
@@
 struct fcoe_crc_eof cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * notifier , ulong event , void * ptr ) ;
...
position p;
@@
 void cocci_id@p ( struct fcoe_ctlr_device * ctlr_dev ) ;
...
position p;
@@
 void cocci_id@p ( struct fc_vport * ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct net_device * netdev ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * netdev ) ;
...
position p;
@@
 int cocci_id@p ( struct fc_vport * ) ;
...
position p;
@@
 struct fc_lport * cocci_id@p ( const struct net_device * ) ;
