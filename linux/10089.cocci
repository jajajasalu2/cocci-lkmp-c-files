...
position p;
@@
 struct sockaddr_pppox cocci_id@p ;
...
typedef rwlock_t;
@@
 struct pppoe_net {  struct pppox_sock * hash_table [ PPPOE_HASH_SIZE ] ;  rwlock_t hash_lock ; } cocci_id@p ;
