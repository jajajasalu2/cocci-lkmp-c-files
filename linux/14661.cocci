...
typedef u8,u32,u16;
@@
 struct sci_clk {  struct clk_hw hw ;  u16 dev_id ;  u32 clk_id ;  u32 num_parents ;  struct sci_clk_provider * provider ;  u8 flags ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 const struct sci_clk * cocci_id@p ;
...
position p;
@@
 struct sci_clk_provider {  const struct ti_sci_handle * sci ;  const struct ti_sci_clk_ops * ops ;  struct device * dev ;  struct sci_clk * * clocks ;  int num_clocks ; } cocci_id@p ;
...
position p;
@@
 struct sci_clk_provider * cocci_id@p ;
