...
position p;
@@
 const struct csid_format cocci_id@p [ ] ;
...
position p;
@@
 struct csid_testgen_config * cocci_id@p ;
...
typedef u8,u32;
@@
 struct csid_format {  u32 code ;  u8 data_type ;  u8 decode_format ;  u8 bpp ;  u8 spp ; } cocci_id@p ;
...
position p;
@@
 struct csiphy_device * cocci_id@p ;
...
position p;
@@
 struct csid_phy_config * cocci_id@p ;
...
position p;
@@
 struct csiphy_lanes_cfg * cocci_id@p ;
