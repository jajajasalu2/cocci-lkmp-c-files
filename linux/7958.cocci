...
typedef atomic_t;
@@
 struct huawei_cdc_ncm_state {  struct cdc_ncm_ctx * ctx ;  atomic_t pmcount ;  struct usb_driver * subdriver ;  struct usb_interface * control ;  struct usb_interface * data ; } cocci_id@p ;
...
position p;
@@
 struct huawei_cdc_ncm_state * cocci_id@p ;
