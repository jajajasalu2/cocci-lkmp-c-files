...
position p;
@@
 const struct ftdi_sio_quirk cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ftdi_private * priv ) ;
...
position p;
@@
 struct ftdi_private cocci_id@p ;
...
position p;
@@
 unsigned short int cocci_id@p ( int baud ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * port , unsigned char status [ 2 ] ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial * serial , const struct usb_device_id * id ) ;
...
position p;
@@
 struct ftdi_sio_quirk * cocci_id@p ;
...
position p;
@@
 unsigned short int cocci_id@p ( int baud , int base ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( int baud , int base ) ;
...
position p;
@@
 struct ftdi_sio_quirk {  int ( * probe ) ( struct usb_serial * ) ;  void ( * port_probe ) ( struct ftdi_private * ) ; } cocci_id@p ;
