...
position p;
@@
 struct klist_waiter * cocci_id@p ;
...
position p;
@@
 struct klist_waiter {  struct list_head list ;  struct klist_node * node ;  struct task_struct * process ;  int woken ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct klist_node * ) ;
