...
position p;
@@
 struct fcoe_kwqe_conn_destroy * cocci_id@p ;
...
position p;
@@
 struct iscsi_kwqe_conn_offload3 * cocci_id@p ;
...
position p;
@@
 struct cnic_ulp_ops cocci_id@p ;
...
position p;
@@
 struct l4_kwq_reset_req * cocci_id@p ;
...
position p;
@@
 struct iscsi_kwqe_conn_offload2 * cocci_id@p ;
...
position p;
@@
 struct cnic_uio_dev cocci_id@p ;
...
position p;
@@
 union l5cm_specific_data cocci_id@p ;
...
position p;
@@
 struct cnic_context cocci_id@p ;
...
position p;
@@
 struct l4_kwq_upload * cocci_id@p ;
...
position p;
@@
 struct l4_kwq_connect_req1 * cocci_id@p ;
...
position p;
@@
 struct status_block * cocci_id@p ;
...
position p;
@@
 struct fcoe_kwqe_conn_enable_disable * cocci_id@p ;
...
position p;
@@
 struct l4_kwq_connect_req2 * cocci_id@p ;
...
position p;
@@
 struct iscsi_kwqe_conn_destroy * cocci_id@p ;
...
position p;
@@
 struct fcoe_kwqe_conn_offload1 * cocci_id@p ;
...
position p;
@@
 struct eth_tx_start_bd * cocci_id@p ;
...
position p;
@@
 struct igu_ack_register cocci_id@p ;
...
position p;
@@
 struct iscsi_kwqe_conn_update * cocci_id@p ;
...
position p;
@@
 struct l5cm_xstorm_conn_buffer * cocci_id@p ;
...
position p;
@@
 struct fcoe_kwqe_stat * cocci_id@p ;
...
position p;
@@
 struct hc_status_block_e2 cocci_id@p ;
...
position p;
@@
 struct hc_status_block_e1x cocci_id@p ;
...
position p;
@@
 struct fcoe_kwqe_init2 * cocci_id@p ;
...
position p;
@@
 struct l4_kwq_connect_req3 * cocci_id@p ;
...
position p;
@@
 struct fcoe_context * cocci_id@p ;
...
position p;
@@
 struct l5cm_tstorm_conn_buffer * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cnic_dev * ) ;
...
position p;
@@
 struct l4_kwq_offload_pg * cocci_id@p ;
...
position p;
@@
 struct fcoe_init_ramrod_params * cocci_id@p ;
...
position p;
@@
 struct l5cm_active_conn_buffer * cocci_id@p ;
...
position p;
@@
 struct fcoe_kwqe_init3 * cocci_id@p ;
...
position p;
@@
 struct bnx2x_bd_chain_next * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cnic_sock * ) ;
...
position p;
@@
 struct cnic_ctl_completion * cocci_id@p ;
...
position p;
@@
 struct fcoe_kwqe_conn_offload3 * cocci_id@p ;
...
position p;
@@
 struct fcoe_kwqe_conn_offload4 * cocci_id@p ;
...
position p;
@@
 struct ustorm_eth_rx_producers cocci_id@p ;
...
position p;
@@
 struct eth_rx_cqe_next_page * cocci_id@p ;
...
position p;
@@
 struct fcoe_conn_enable_disable_ramrod_params * cocci_id@p ;
...
position p;
@@
 struct drv_ctl_l2_ring * cocci_id@p ;
...
position p;
@@
 struct status_block_msix * cocci_id@p ;
...
position p;
@@
 struct l5cm_conn_addr_params * cocci_id@p ;
...
position p;
@@
 struct fcoe_conn_offload_ramrod_params * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cnic_dev * ) ;
...
position p;
@@
 struct iscsi_kwqe_conn_offload1 * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * , struct cnic_ctl_info * ) ;
...
position p;
@@
 struct fcoe_kwqe_conn_offload2 * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct cnic_local * , struct cnic_sock * , u8 ) ;
...
position p;
@@
 union eth_tx_bd_types * cocci_id@p ;
...
position p;
@@
 struct fcoe_stat_ramrod_params * cocci_id@p ;
...
position p;
@@
 struct iscsi_kwqe_init1 * cocci_id@p ;
...
position p;
@@
 struct cnic_sockaddr * cocci_id@p ;
...
position p;
@@
 struct iscsi_kwqe_init2 * cocci_id@p ;
...
position p;
@@
 struct l4_kwq_update_pg * cocci_id@p ;
...
position p;
@@
 struct iscsi_context * cocci_id@p ;
...
position p;
@@
 struct l4_kwq_close_req * cocci_id@p ;
...
position p;
@@
 struct fcoe_kwqe_init1 * cocci_id@p ;
...
position p;
@@
 struct eth_tx_parse_bd_e1x * cocci_id@p ;
...
position p;
@@
 struct eth_tx_parse_bd_e2 * cocci_id@p ;
