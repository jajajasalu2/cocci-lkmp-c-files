...
position p;
@@
 struct tegra_vde_cache_entry * cocci_id@p ;
...
position p;
@@
 struct tegra_vde_cache_entry {  enum dma_data_direction dma_dir ;  struct dma_buf_attachment * a ;  struct delayed_work dwork ;  struct tegra_vde * vde ;  struct list_head list ;  struct sg_table * sgt ;  struct iova * iova ;  unsigned int refcnt ; } cocci_id@p ;
