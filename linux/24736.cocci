...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_LOOKUP_MAX + 1 ] ;
...
typedef bool;
@@
 struct nft_lookup {  struct nft_set * set ;  enum nft_registers sreg : 8 ;  enum nft_registers dreg : 8 ;  bool invert ;  struct nft_set_binding binding ; } cocci_id@p ;
...
position p;
@@
 const struct nft_lookup * cocci_id@p ;
