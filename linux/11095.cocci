...
position p;
@@
 const struct generic_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct generic_sh_mask cocci_id@p [ ] ;
...
position p;
@@
 const struct ddc_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct ddc_sh_mask cocci_id@p ;
...
position p;
@@
 const struct hw_factory_funcs cocci_id@p ;
...
position p;
@@
 const struct hpd_sh_mask cocci_id@p ;
...
position p;
@@
 const struct hpd_registers cocci_id@p [ ] ;
