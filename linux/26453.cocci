...
position p;
@@
 struct msgtemplate {  struct nlmsghdr n ;  struct genlmsghdr g ;  char buf [ MAX_MSG_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ 100 + 6 * MAX_CPUS ] ;
...
position p;
@@
 struct {  struct nlmsghdr n ;  struct genlmsghdr g ;  char buf [ 256 ] ; } cocci_id@p ;
