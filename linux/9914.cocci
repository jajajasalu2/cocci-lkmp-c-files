...
position p;
@@
 void ( * cocci_id@p ) ( void * cookie , struct key_params * ) ;
...
position p;
@@
 struct ath6kl_cfg80211_match_probe_ssid cocci_id@p [ MAX_PROBED_SSIDS ] ;
...
position p;
@@
 enum ath6kl_cfg_suspend_mode cocci_id@p ;
...
position p;
@@
 struct ath6kl_mgmt_buff cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ WOW_PATTERN_SIZE ] ;
...
position p;
@@
 struct ath6kl_mc_filter * cocci_id@p ;
...
typedef u8;
@@
 struct ath6kl_cfg80211_match_probe_ssid {  struct cfg80211_ssid ssid ;  u8 flag ; } cocci_id@p ;
...
position p;
@@
 enum nl80211_wpa_versions cocci_id@p ;
...
position p;
@@
 struct target_stats * cocci_id@p ;
