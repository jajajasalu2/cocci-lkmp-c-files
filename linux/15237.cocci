...
position p;
@@
 struct bl_trig_notifier {  struct led_classdev * led ;  int brightness ;  int old_status ;  struct notifier_block notifier ;  unsigned invert ; } cocci_id@p ;
...
position p;
@@
 struct bl_trig_notifier * cocci_id@p ;
