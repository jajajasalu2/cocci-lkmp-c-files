...
position p;
@@
 struct asix_rx_fixup_info * cocci_id@p ;
...
typedef u16;
@@
 struct ax88172a_private {  struct mii_bus * mdio ;  struct phy_device * phydev ;  char phy_name [ 20 ] ;  u16 phy_addr ;  u16 oldmode ;  int use_embdphy ;  struct asix_rx_fixup_info rx_fixup_info ; } cocci_id@p ;
...
position p;
@@
 struct ax88172a_private * cocci_id@p ;
