...
position p;
@@
 struct fw_iso_resources * cocci_id@p ;
...
position p;
@@
 struct reg_params {  unsigned int count ;  unsigned int size ; } cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ SND_DICE_RATES_COUNT ] ;
...
position p;
@@
 const enum snd_dice_rate_mode cocci_id@p [ ] ;
