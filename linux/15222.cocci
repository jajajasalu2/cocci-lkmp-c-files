...
position p;
@@
 struct led_type_map {  const int type ;  const char * desc ; } cocci_id@p ;
...
position p;
@@
 struct powernv_led_data cocci_id@p ;
...
position p;
@@
 struct powernv_led_common * cocci_id@p ;
...
position p;
@@
 struct powernv_led_data {  struct led_classdev cdev ;  char * loc_code ;  int led_type ;  struct powernv_led_common * common ; } cocci_id@p ;
...
typedef bool,__be64;
@@
 struct powernv_led_common {  bool led_disabled ;  __be64 max_led_type ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 const struct led_type_map cocci_id@p [ ] ;
