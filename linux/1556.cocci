...
typedef __u16;
@@
 struct kobil_private {  unsigned char buf [ KOBIL_BUF_LENGTH ] ;  int filled ;  int cur_pos ;  __u16 device_type ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * probe ) ;
...
position p;
@@
 struct kobil_private cocci_id@p ;
