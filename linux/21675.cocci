...
position p;
@@
 struct cpu_irq_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef call_single_data_t,atomic_t;
@@
 struct cpu_irq_data {  call_single_data_t csd ;  atomic_t scheduled ; } cocci_id@p ;
...
position p;
@@
 enum { FLOATING , DIRECTED , } cocci_id@p ;
