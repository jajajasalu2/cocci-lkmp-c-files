...
typedef u32,u16;
@@
 struct fw_cfg_sysfs_entry {  struct kobject kobj ;  u32 size ;  u16 select ;  char name [ FW_CFG_MAX_FILE_PATH ] ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct fw_cfg_sysfs_attribute * cocci_id@p ;
...
position p;
@@
 struct fw_cfg_dma_access cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ FW_CFG_SIG_SIZE ] ;
...
position p;
@@
 struct fw_cfg_vmcoreinfo cocci_id@p ;
...
position p;
@@
 struct fw_cfg_sysfs_entry cocci_id@p ;
...
position p;
@@
 struct fw_cfg_sysfs_attribute {  struct attribute attr ;  ssize_t ( * show ) ( struct fw_cfg_sysfs_entry * entry , char * buf ) ; } cocci_id@p ;
...
position p;
@@
 const struct {  struct attribute attr ;  ssize_t ( * show ) ( struct kobject * k , struct attribute * a , char * buf ) ; } cocci_id@p ;
...
position p;
@@
 const struct fw_cfg_file * cocci_id@p ;
