...
position p;
@@
 struct meson_cipher_req_ctx * cocci_id@p ;
...
position p;
@@
 struct meson_alg_template cocci_id@p ;
...
position p;
@@
 struct meson_cipher_tfm_ctx cocci_id@p ;
