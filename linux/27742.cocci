...
position p;
@@
 struct wait_glock_queue cocci_id@p ;
...
position p;
@@
 struct gfs2_holder * cocci_id@p [ 4 ] ;
...
typedef loff_t;
@@
 struct gfs2_glock_iter {  struct gfs2_sbd * sdp ;  struct rhashtable_iter hti ;  struct gfs2_glock * gl ;  loff_t last_pos ; } cocci_id@p ;
...
position p;
@@
 const struct lm_lockname * cocci_id@p ;
...
position p;
@@
 const struct gfs2_glock_operations * cocci_id@p ;
...
position p;
@@
 struct gfs2_glock_iter * cocci_id@p ;
...
position p;
@@
 const struct gfs2_pcpu_lkstats * cocci_id@p ;
...
position p;
@@
 const struct gfs2_holder cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct gfs2_glock * gl ) ;
...
position p;
@@
 void cocci_id@p ( struct gfs2_glock * gl , struct gfs2_holder * gh , unsigned int target ) ;
...
typedef wait_queue_entry_t;
@@
 struct wait_glock_queue {  struct lm_lockname * name ;  wait_queue_entry_t wait ; } cocci_id@p ;
