...
typedef bool,u16;
@@
 struct qed_mcp_cmd_elem {  struct list_head list ;  struct qed_mcp_mb_params * p_mb_params ;  u16 expected_seq_num ;  bool b_is_completed ; } cocci_id@p ;
...
position p;
@@
 struct drv_version_stc cocci_id@p ;
...
position p;
@@
 struct qed_mcp_cmd_elem cocci_id@p ;
...
position p;
@@
 struct qed_mcp_drv_version * cocci_id@p ;
...
position p;
@@
 struct resource_info cocci_id@p ;
...
position p;
@@
 enum nvm_image_type cocci_id@p ;
...
position p;
@@
 struct qed_resc_alloc_in_params cocci_id@p ;
...
position p;
@@
 enum resource_id_enum cocci_id@p ;
...
position p;
@@
 struct qed_load_req_out_params cocci_id@p ;
...
position p;
@@
 enum qed_load_req_force { QED_LOAD_REQ_FORCE_NONE , QED_LOAD_REQ_FORCE_PF , QED_LOAD_REQ_FORCE_ALL , } cocci_id@p ;
...
position p;
@@
 struct public_mfw_mb cocci_id@p ;
...
position p;
@@
 struct qed_resc_alloc_out_params cocci_id@p ;
...
position p;
@@
 union qed_mcp_protocol_stats cocci_id@p ;
...
position p;
@@
 struct qed_mcp_info * cocci_id@p ;
...
position p;
@@
 enum MFW_DRV_MSG_TYPE cocci_id@p ;
...
position p;
@@
 union drv_union_data cocci_id@p ;
...
position p;
@@
 struct load_rsp_stc cocci_id@p ;
...
position p;
@@
 enum qed_mcp_protocol_type cocci_id@p ;
...
position p;
@@
 enum qed_ov_driver_state cocci_id@p ;
...
typedef u32;
@@
 struct qed_resc_alloc_out_params {  u32 mcp_resp ;  u32 mcp_param ;  u32 resc_num ;  u32 resc_start ;  u32 vf_resc_num ;  u32 vf_resc_start ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 enum qed_ov_eswitch cocci_id@p ;
...
position p;
@@
 struct qed_mcp_mb_params * cocci_id@p ;
...
position p;
@@
 struct qed_load_req_in_params cocci_id@p ;
...
position p;
@@
 struct load_req_stc cocci_id@p ;
...
position p;
@@
 struct public_drv_mb cocci_id@p ;
...
position p;
@@
 struct qed_nvm_image_info cocci_id@p ;
...
typedef u32;
@@
 struct qed_resc_alloc_in_params {  u32 cmd ;  enum qed_resources res_id ;  u32 resc_max_val ; } cocci_id@p ;
...
position p;
@@
 enum qed_load_req_force cocci_id@p ;
...
position p;
@@
 struct bist_nvm_image_att * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MCP_DRV_NVM_BUF_LEN ] ;
...
typedef u8,bool,u32;
@@
 struct qed_load_req_out_params {  u32 load_code ;  u32 exist_drv_ver_0 ;  u32 exist_drv_ver_1 ;  u32 exist_fw_ver ;  u8 exist_drv_role ;  u8 mfw_hsi_ver ;  bool drv_exists ; } cocci_id@p ;
...
position p;
@@
 enum qed_override_force_load cocci_id@p ;
