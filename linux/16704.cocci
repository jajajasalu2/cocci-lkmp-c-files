...
typedef u32;
@@
 struct bcm_kp {  void __iomem * base ;  int irq ;  struct clk * clk ;  struct input_dev * input_dev ;  unsigned long last_state [ 2 ] ;  unsigned int n_rows ;  unsigned int n_cols ;  u32 kpcr ;  u32 kpior ;  u32 kpemr ;  u32 imr0_val ;  u32 imr1_val ; } cocci_id@p ;
...
position p;
@@
 const struct bcm_kp * cocci_id@p ;
