...
position p;
@@
 enum ni_common_subdevices { NI_AI_SUBDEV , NI_AO_SUBDEV , NI_DIO_SUBDEV , NI_8255_DIO_SUBDEV , NI_UNUSED_SUBDEV , NI_CALIBRATION_SUBDEV , NI_EEPROM_SUBDEV , NI_PFI_DIO_SUBDEV , NI_CS5529_CALIBRATION_SUBDEV , NI_SERIAL_SUBDEV , NI_RTSI_SUBDEV , NI_GPCT0_SUBDEV , NI_GPCT1_SUBDEV , NI_FREQ_OUT_SUBDEV , NI_NUM_SUBDEVICES , } cocci_id@p ;
...
position p;
@@
 const struct ni_board_struct * cocci_id@p ;
...
position p;
@@
 const struct mio_regmap * cocci_id@p ;
...
position p;
@@
 struct caldac_struct {  int n_chans ;  int n_bits ;  int ( * packbits ) ( int address , int value , int * bitstring ) ; } cocci_id@p ;
...
position p;
@@
 enum ni_gpct_register cocci_id@p ;
...
position p;
@@
 struct mio_regmap {  unsigned int mio_reg ;  int size ; } cocci_id@p ;
...
position p;
@@
 struct mite_channel * cocci_id@p ;
...
position p;
@@
 enum timebase_nanoseconds { TIMEBASE_1_NS = 50 , TIMEBASE_2_NS = 10000 , } cocci_id@p ;
...
position p;
@@
 const struct comedi_lrange * const cocci_id@p [ ] ;
...
position p;
@@
 enum comedi_io_direction cocci_id@p ;
...
position p;
@@
 enum ni_pfi_filter_select cocci_id@p ;
...
position p;
@@
 enum aimodes { AIMODE_NONE = 0 , AIMODE_HALF_FULL = 1 , AIMODE_SCAN = 2 , AIMODE_SAMPLE = 3 , } cocci_id@p ;
...
position p;
@@
 const struct comedi_krange * cocci_id@p ;
...
position p;
@@
 struct caldac_struct cocci_id@p [ ] ;
