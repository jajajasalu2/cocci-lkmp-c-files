...
typedef u16;
@@
 struct au0828_rc {  struct au0828_dev * dev ;  struct rc_dev * rc ;  char name [ 32 ] ;  char phys [ 32 ] ;  int polling ;  struct delayed_work work ;  u16 i2c_dev_addr ;  int ( * get_key_i2c ) ( struct au0828_rc * ir ) ; } cocci_id@p ;
