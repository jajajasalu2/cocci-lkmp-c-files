...
position p;
@@
 struct gk20a_instobj * * cocci_id@p ;
...
position p;
@@
 const struct nvkm_memory_func cocci_id@p ;
...
position p;
@@
 struct nvkm_mm_node * cocci_id@p ;
...
position p;
@@
 struct nvkm_instmem * cocci_id@p ;
...
position p;
@@
 struct gk20a_instobj_iommu * cocci_id@p ;
...
@@
 struct gk20a_instobj_iommu {  struct gk20a_instobj base ;  struct list_head vaddr_node ;  u32 use_cpt ;  dma_addr_t * dma_addrs ;  struct page * pages [ ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct gk20a_instobj {  struct nvkm_memory memory ;  struct nvkm_mm_node * mn ;  struct gk20a_instmem * imem ;  u32 * vaddr ; } cocci_id@p ;
...
position p;
@@
 enum nvkm_memory_target cocci_id@p ;
...
position p;
@@
 struct nvkm_device_tegra * cocci_id@p ;
...
position p;
@@
 struct nvkm_vmm_map cocci_id@p ;
...
position p;
@@
 struct gk20a_instmem cocci_id@p ;
...
position p;
@@
 struct gk20a_instobj_dma * cocci_id@p ;
...
typedef u16;
@@
 struct gk20a_instmem {  struct nvkm_instmem base ;  struct mutex lock ;  unsigned int vaddr_use ;  unsigned int vaddr_max ;  struct list_head vaddr_lru ;  struct mutex * mm_mutex ;  struct nvkm_mm * mm ;  struct iommu_domain * domain ;  unsigned long iommu_pgshift ;  u16 iommu_bit ;  unsigned long attrs ; } cocci_id@p ;
...
position p;
@@
 const struct nvkm_memory_ptrs cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct gk20a_instobj_dma {  struct gk20a_instobj base ;  dma_addr_t handle ;  struct nvkm_mm_node r ; } cocci_id@p ;
...
position p;
@@
 const struct nvkm_instmem_func cocci_id@p ;
