...
position p;
@@
 struct pattern_trig_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,delta_t;
@@
 struct pattern_trig_data {  struct led_classdev * led_cdev ;  struct led_pattern patterns [ MAX_PATTERNS ] ;  struct led_pattern * curr ;  struct led_pattern * next ;  struct mutex lock ;  u32 npatterns ;  int repeat ;  int last_repeat ;  int delta_t ;  bool is_indefinite ;  bool is_hw_pattern ;  struct timer_list timer ; } cocci_id@p ;
