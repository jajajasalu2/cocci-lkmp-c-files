...
typedef u8,bool;
@@
 struct rm3100_data {  struct regmap * regmap ;  struct completion measuring_done ;  bool use_interrupt ;  int conversion_time ;  int scale ;  u8 buffer [ RM3100_SCAN_BYTES ] ;  struct iio_trigger * drdy_trig ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ RM3100_SAMP_NUM ] [ 3 ] ;
