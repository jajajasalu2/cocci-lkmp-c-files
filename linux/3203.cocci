...
position p;
@@
 struct scpi_sensors {  struct scpi_ops * scpi_ops ;  struct sensor_data * data ;  struct list_head thermal_zones ;  struct attribute * * attrs ;  struct attribute_group group ;  const struct attribute_group * groups [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct scpi_sensors * cocci_id@p ;
...
position p;
@@
 struct sensor_data {  unsigned int scale ;  struct scpi_sensor_info info ;  struct device_attribute dev_attr_input ;  struct device_attribute dev_attr_label ;  char input [ 20 ] ;  char label [ 20 ] ; } cocci_id@p ;
...
position p;
@@
 struct scpi_thermal_zone {  int sensor_id ;  struct scpi_sensors * scpi_sensors ; } cocci_id@p ;
...
position p;
@@
 struct scpi_thermal_zone * cocci_id@p ;
