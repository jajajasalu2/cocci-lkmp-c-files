...
typedef u8,u32;
@@
 struct cxacru_data {  struct usbatm_data * usbatm ;  const struct cxacru_modem_type * modem_type ;  int line_status ;  struct mutex adsl_state_serialize ;  int adsl_status ;  struct delayed_work poll_work ;  u32 card_info [ CXINF_MAX ] ;  struct mutex poll_state_serialize ;  enum cxacru_poll_state poll_state ;  struct mutex cm_serialize ;  u8 * rcv_buf ;  u8 * snd_buf ;  struct urb * rcv_urb ;  struct urb * snd_urb ;  struct completion rcv_done ;  struct completion snd_done ; } cocci_id@p ;
...
position p;
@@
 enum cxacru_cm_request cocci_id@p ;
...
position p;
@@
 enum cxacru_cm_flash { CM_FLASH_READ = 0xa1 , CM_FLASH_WRITE = 0xa2 , } cocci_id@p ;
...
position p;
@@
 enum cxacru_fw_request cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct cxacru_data * instance , enum cxacru_cm_request cm , u8 * wdata , int wsize , u8 * rdata , int rsize ) ;
...
position p;
@@
 struct cxacru_timer {  struct timer_list timer ;  struct urb * urb ; } cocci_id@p ;
...
position p;
@@
 struct cxacru_timer cocci_id@p ;
...
position p;
@@
 struct cxacru_modem_type * cocci_id@p ;
...
position p;
@@
 const struct cxacru_modem_type cocci_id@p ;
...
position p;
@@
 enum cxacru_fw_request { FW_CMD_ERR , FW_GET_VER , FW_READ_MEM , FW_WRITE_MEM , FW_RMW_MEM , FW_CHECKSUM_MEM , FW_GOTO_MEM , } cocci_id@p ;
...
position p;
@@
 enum cxacru_cm_status { CM_STATUS_UNDEFINED , CM_STATUS_SUCCESS , CM_STATUS_ERROR , CM_STATUS_UNSUPPORTED , CM_STATUS_UNIMPLEMENTED , CM_STATUS_PARAMETER_ERROR , CM_STATUS_DBG_LOOPBACK , CM_STATUS_MAX , } cocci_id@p ;
...
position p;
@@
 struct usbatm_driver cocci_id@p ;
...
typedef u32;
@@
 struct cxacru_modem_type {  u32 pll_f_clk ;  u32 pll_b_clk ;  int boot_rom_patch ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CMD_MAX_CONFIG * 12 + 1 ] ;
...
position p;
@@
 enum cxacru_poll_state { CXPOLL_STOPPING , CXPOLL_STOPPED , CXPOLL_POLLING , CXPOLL_SHUTDOWN , } cocci_id@p ;
