...
position p;
@@
 struct microread_i2c_phy {  struct i2c_client * i2c_dev ;  struct nfc_hci_dev * hdev ;  int hard_fault ; } cocci_id@p ;
...
position p;
@@
 struct microread_i2c_phy cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MICROREAD_I2C_LLC_MAX_SIZE - 1 ] ;
