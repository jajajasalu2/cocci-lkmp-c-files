...
position p;
@@
 struct pd_req {  enum action ( * func ) ( struct pd_unit * disk ) ; } cocci_id@p ;
...
position p;
@@
 enum action { Fail = 0 , Ok = 1 , Hold , Wait , } cocci_id@p ;
...
position p;
@@
 enum action ( * cocci_id@p ) ( struct pd_unit * disk ) ;
...
position p;
@@
 struct pd_unit cocci_id@p [ PD_UNITS ] ;
...
position p;
@@
 struct pd_unit {  struct pi_adapter pia ;  struct pi_adapter * pi ;  int access ;  int capacity ;  int heads ;  int sectors ;  int cylinders ;  int can_lba ;  int drive ;  int changed ;  int removable ;  int standby ;  int alt_geom ;  char name [ PD_NAMELEN ] ;  struct gendisk * gd ;  struct blk_mq_tag_set tag_set ;  struct list_head rq_list ; } cocci_id@p ;
...
position p;
@@
 enum { D_PRT , D_PRO , D_UNI , D_MOD , D_GEO , D_SBY , D_DLY , D_SLV , } cocci_id@p ;
