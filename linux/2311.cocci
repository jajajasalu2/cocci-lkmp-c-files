...
position p;
@@
 enum st_thermal_power_state cocci_id@p ;
...
position p;
@@
 const struct st_thermal_sensor_ops cocci_id@p ;
...
position p;
@@
 const struct st_thermal_compat_data cocci_id@p ;
...
position p;
@@
 struct st_thermal_sensor * cocci_id@p ;
