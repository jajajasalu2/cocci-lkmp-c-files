...
position p;
@@
 struct bcm2835_power_domain * cocci_id@p ;
...
position p;
@@
 struct bcm2835_power * cocci_id@p ;
...
position p;
@@
 struct bcm2835_power {  struct device * dev ;  void __iomem * base ;  void __iomem * asb ;  struct genpd_onecell_data pd_xlate ;  struct bcm2835_power_domain domains [ BCM2835_POWER_DOMAIN_COUNT ] ;  struct reset_controller_dev reset ; } cocci_id@p ;
...
position p;
@@
 const struct {  int parent , child ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct bcm2835_power_domain {  struct generic_pm_domain base ;  struct bcm2835_power * power ;  u32 domain ;  struct clk * clk ; } cocci_id@p ;
