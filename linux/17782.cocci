...
position p;
@@
 int cocci_id@p ( unsigned int hw_irq , int server_cpu ) ;
...
position p;
@@
 union kvmppc_rm_state cocci_id@p ;
...
typedef bool,u32;
@@
 void cocci_id@p ( struct kvmppc_xics * xics , struct kvmppc_icp * icp , u32 new_irq , bool check_resend ) ;
...
position p;
@@
 struct ics_irq_state * cocci_id@p ;
...
position p;
@@
 union kvmppc_icp_state cocci_id@p ;
