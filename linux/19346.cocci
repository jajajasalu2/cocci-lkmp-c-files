...
position p;
@@
 enum ARGTYPE { S1S = 1 , S2S , S1D , CS , D1D , D2D , D1S , CD , } cocci_id@p ;
...
typedef func_t;
@@
 union func_t {  void ( * t ) ( void * ft , void * fa , void * fb ) ;  void ( * b ) ( void * ft , void * fa ) ; } cocci_id@p ;
