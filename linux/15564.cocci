...
position p;
@@
 enum visorinput_dev_type { visorinput_keyboard , visorinput_mouse , } cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ KEYCODE_TABLE_BYTES ] ;
...
position p;
@@
 struct visor_input_channel_data cocci_id@p ;
...
typedef bool;
@@
 struct visorinput_devdata {  struct visor_device * dev ;  struct mutex lock_visor_dev ;  struct input_dev * visorinput_dev ;  bool paused ;  bool interrupts_enabled ;  unsigned int keycode_table_bytes ;  unsigned char keycode_table [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 enum visorinput_dev_type cocci_id@p ;
...
position p;
@@
 struct visorinput_devdata * cocci_id@p ;
...
position p;
@@
 struct visor_inputreport cocci_id@p ;
