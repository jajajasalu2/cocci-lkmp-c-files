...
position p;
@@
 const struct mt312_config * cocci_id@p ;
...
position p;
@@
 const enum fe_sec_mini_cmd cocci_id@p ;
...
position p;
@@
 const enum fe_sec_voltage cocci_id@p ;
...
position p;
@@
 const enum fe_code_rate cocci_id@p [ 8 ] ;
...
position p;
@@
 const enum mt312_reg_addr cocci_id@p ;
...
position p;
@@
 const enum fe_sec_tone_mode cocci_id@p ;
...
typedef u8;
@@
 struct mt312_state {  struct i2c_adapter * i2c ;  const struct mt312_config * config ;  struct dvb_frontend frontend ;  u8 id ;  unsigned long xtal ;  u8 freq_mult ; } cocci_id@p ;
