...
position p;
@@
 struct coresight_connection * cocci_id@p ;
...
position p;
@@
 struct coresight_node * cocci_id@p ;
...
position p;
@@
 struct coresight_node {  struct coresight_device * csdev ;  struct list_head link ; } cocci_id@p ;
...
position p;
@@
 struct coresight_dev_list * cocci_id@p ;
...
position p;
@@
 enum coresight_dev_subtype_source cocci_id@p ;
