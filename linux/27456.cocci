...
position p;
@@
 struct pstore_ftrace_record * cocci_id@p ;
...
position p;
@@
 enum { Opt_kmsg_bytes , Opt_err , } cocci_id@p ;
...
position p;
@@
 struct pstore_ftrace_seq_data * cocci_id@p ;
...
position p;
@@
 struct pstore_ftrace_seq_data {  const void * ptr ;  size_t off ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 struct pstore_private * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PSTORE_NAMELEN ] ;
...
position p;
@@
 struct pstore_private {  struct list_head list ;  struct pstore_record * record ;  size_t total_size ; } cocci_id@p ;
