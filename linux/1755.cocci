...
position p;
@@
 struct iio_sysfs_trig {  struct iio_trigger * trig ;  struct irq_work work ;  int id ;  struct list_head l ; } cocci_id@p ;
...
position p;
@@
 struct iio_sysfs_trig * cocci_id@p ;
