...
position p;
@@
 struct orion_watchdog cocci_id@p ;
...
position p;
@@
 struct orion_watchdog {  struct watchdog_device wdt ;  void __iomem * reg ;  void __iomem * rstout ;  void __iomem * rstout_mask ;  unsigned long clk_rate ;  struct clk * clk ;  const struct orion_watchdog_data * data ; } cocci_id@p ;
...
position p;
@@
 const struct orion_watchdog_data cocci_id@p ;
