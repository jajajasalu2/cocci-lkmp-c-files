...
position p;
@@
 enum ipi_message_type cocci_id@p ;
...
position p;
@@
 struct cpuinfo_alpha cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct flush_tlb_page_struct cocci_id@p ;
...
position p;
@@
 struct flush_tlb_page_struct {  struct vm_area_struct * vma ;  struct mm_struct * mm ;  unsigned long addr ; } cocci_id@p ;
...
position p;
@@
 enum ipi_message_type { IPI_RESCHEDULE , IPI_CALL_FUNC , IPI_CPU_STOP , } cocci_id@p ;
