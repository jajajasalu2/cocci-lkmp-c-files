...
position p;
@@
 struct tracefs_fs_info cocci_id@p ;
...
@@
 struct tracefs_mount_opts {  kuid_t uid ;  kgid_t gid ;  umode_t mode ; } cocci_id@p ;
...
position p;
@@
 struct tracefs_fs_info {  struct tracefs_mount_opts mount_opts ; } cocci_id@p ;
...
position p;
@@
 struct tracefs_mount_opts * cocci_id@p ;
