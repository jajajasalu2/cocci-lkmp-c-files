...
typedef s8,u8;
@@
 struct hexium_data {  s8 adr ;  u8 byte ; } cocci_id@p ;
...
position p;
@@
 struct hexium {  int type ;  struct video_device video_dev ;  struct i2c_adapter i2c_adapter ;  int cur_input ; } cocci_id@p ;
...
position p;
@@
 struct {  struct hexium_data data [ 8 ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct v4l2_input cocci_id@p [ HEXIUM_INPUTS ] ;
