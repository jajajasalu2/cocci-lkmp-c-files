...
position p;
@@
 struct drm_ctx_list * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_context_t;
@@
 struct drm_ctx_list {  struct list_head head ;  drm_context_t handle ;  struct drm_file * tag ; } cocci_id@p ;
