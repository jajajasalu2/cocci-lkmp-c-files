...
position p;
@@
 struct mlx4_ib_create_cq cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_cq_buf * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_resize_cq cocci_id@p ;
