...
position p;
@@
 struct pcf50633_mbc {  struct pcf50633 * pcf ;  int adapter_online ;  int usb_online ;  struct power_supply * usb ;  struct power_supply * adapter ;  struct power_supply * ac ; } cocci_id@p ;
...
position p;
@@
 struct pcf50633_mbc * cocci_id@p ;
