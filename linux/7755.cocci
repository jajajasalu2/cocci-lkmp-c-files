...
position p;
@@
 struct ar933x_uart_port cocci_id@p ;
...
position p;
@@
 struct ar933x_uart_port * cocci_id@p [ CONFIG_SERIAL_AR933X_NR_UARTS ] ;
...
position p;
@@
 struct ar933x_uart_port {  struct uart_port port ;  unsigned int ier ;  unsigned int min_baud ;  unsigned int max_baud ;  struct clk * clk ; } cocci_id@p ;
