...
position p;
@@
 struct reuseport_array * cocci_id@p ;
...
position p;
@@
 struct reuseport_array {  struct bpf_map map ;  struct sock __rcu * ptrs [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct sock_reuseport * cocci_id@p ;
...
position p;
@@
 const struct reuseport_array * cocci_id@p ;
