...
position p;
@@
 struct op_devlist_request cocci_id@p ;
...
position p;
@@
 struct op_devlist_reply cocci_id@p ;
...
position p;
@@
 struct request_info cocci_id@p ;
...
position p;
@@
 struct usbip_host_driver * cocci_id@p ;
...
position p;
@@
 struct usbip_usb_interface cocci_id@p ;
...
position p;
@@
 struct usbip_exported_device cocci_id@p ;
...
position p;
@@
 struct op_import_request cocci_id@p ;
...
position p;
@@
 struct usbip_usb_device cocci_id@p ;
...
position p;
@@
 enum { cmd_standalone_mode = 1 , cmd_help , cmd_version , } cocci_id@p ;
