...
position p;
@@
 struct ena_admin_aenq_common_desc * cocci_id@p ;
...
position p;
@@
 struct ena_com_stats_ctx cocci_id@p ;
...
position p;
@@
 enum ena_admin_hash_functions * cocci_id@p ;
...
position p;
@@
 struct ena_admin_aq_create_cq_cmd cocci_id@p ;
...
position p;
@@
 struct ena_admin_acq_destroy_cq_resp_desc cocci_id@p ;
...
position p;
@@
 struct ena_admin_feature_rss_flow_hash_control * cocci_id@p ;
...
position p;
@@
 struct ena_host_attribute * cocci_id@p ;
...
position p;
@@
 enum ena_regs_reset_reason_types cocci_id@p ;
...
position p;
@@
 struct ena_com_admin_sq * cocci_id@p ;
...
position p;
@@
 struct ena_admin_acq_get_stats_resp * cocci_id@p ;
...
position p;
@@
 struct ena_admin_aq_create_sq_cmd cocci_id@p ;
...
position p;
@@
 struct ena_admin_aq_destroy_cq_cmd cocci_id@p ;
...
position p;
@@
 struct ena_comp_ctx * cocci_id@p ;
...
position p;
@@
 struct ena_com_llq_info * cocci_id@p ;
...
position p;
@@
 struct ena_admin_aq_get_stats_cmd * cocci_id@p ;
...
position p;
@@
 struct ena_com_admin_cq * cocci_id@p ;
...
position p;
@@
 struct ena_admin_get_feat_resp cocci_id@p ;
...
position p;
@@
 struct ena_com_io_sq * * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ ENA_TOTAL_NUM_QUEUES ] ;
...
position p;
@@
 enum ena_admin_get_stats_type cocci_id@p ;
...
position p;
@@
 enum ena_cmd_status { ENA_CMD_SUBMITTED , ENA_CMD_COMPLETED , ENA_CMD_ABORTED , } cocci_id@p ;
...
position p;
@@
 struct ena_admin_aq_entry * cocci_id@p ;
...
position p;
@@
 struct ena_admin_feature_offload_desc * cocci_id@p ;
...
position p;
@@
 enum ena_admin_flow_hash_proto cocci_id@p ;
...
position p;
@@
 volatile struct ena_admin_ena_mmio_req_read_less_resp * cocci_id@p ;
...
position p;
@@
 struct ena_admin_aenq_entry cocci_id@p ;
...
position p;
@@
 struct ena_com_aenq * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct ena_comp_ctx {  struct completion wait_event ;  struct ena_admin_acq_entry * user_cqe ;  u32 comp_size ;  enum ena_cmd_status status ;  u8 comp_status ;  u8 cmd_opcode ;  bool occupied ; } cocci_id@p ;
...
position p;
@@
 struct ena_com_io_cq * * cocci_id@p ;
...
position p;
@@
 struct ena_admin_rss_ind_table_entry cocci_id@p ;
...
position p;
@@
 struct ena_eth_io_rx_cdesc_base cocci_id@p ;
...
position p;
@@
 struct ena_admin_set_feat_resp cocci_id@p ;
...
position p;
@@
 struct ena_admin_set_feat_cmd cocci_id@p ;
...
position p;
@@
 struct ena_admin_acq_entry * cocci_id@p ;
...
position p;
@@
 struct ena_aenq_handlers * cocci_id@p ;
...
position p;
@@
 struct ena_llq_configurations * cocci_id@p ;
...
position p;
@@
 struct ena_common_mem_addr * cocci_id@p ;
...
position p;
@@
 struct ena_admin_basic_stats * cocci_id@p ;
...
position p;
@@
 struct ena_com_mmio_read * cocci_id@p ;
...
position p;
@@
 struct ena_admin_acq_destroy_sq_resp_desc cocci_id@p ;
...
position p;
@@
 enum ena_admin_aq_feature_id cocci_id@p ;
...
position p;
@@
 struct ena_com_stats_ctx {  struct ena_admin_aq_get_stats_cmd get_cmd ;  struct ena_admin_acq_get_stats_resp get_resp ; } cocci_id@p ;
...
position p;
@@
 struct ena_com_admin_queue * cocci_id@p ;
...
position p;
@@
 struct ena_admin_acq_create_sq_resp_desc cocci_id@p ;
...
position p;
@@
 struct ena_com_dev_get_features_ctx * cocci_id@p ;
...
position p;
@@
 struct ena_com_create_io_ctx * cocci_id@p ;
...
position p;
@@
 struct ena_eth_io_tx_desc cocci_id@p ;
...
position p;
@@
 struct ena_admin_get_feat_cmd cocci_id@p ;
...
position p;
@@
 struct ena_admin_acq_create_cq_resp_desc cocci_id@p ;
...
position p;
@@
 struct ena_eth_io_rx_desc cocci_id@p ;
...
position p;
@@
 struct ena_admin_feature_llq_desc * cocci_id@p ;
...
position p;
@@
 struct ena_admin_feature_rss_hash_control * cocci_id@p ;
...
position p;
@@
 struct ena_eth_io_tx_cdesc cocci_id@p ;
...
position p;
@@
 struct ena_admin_aq_destroy_sq_cmd cocci_id@p ;
