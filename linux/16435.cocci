...
position p;
@@
 enum gt683r_led_mode { GT683R_LED_OFF = 0 , GT683R_LED_AUDIO = 2 , GT683R_LED_BREATHING = 3 , GT683R_LED_NORMAL = 5 , } cocci_id@p ;
...
position p;
@@
 struct gt683r_led {  struct hid_device * hdev ;  struct led_classdev led_devs [ GT683R_LED_COUNT ] ;  struct mutex lock ;  struct work_struct work ;  enum led_brightness brightnesses [ GT683R_LED_COUNT ] ;  enum gt683r_led_mode mode ; } cocci_id@p ;
...
position p;
@@
 enum gt683r_panels { GT683R_LED_BACK = 0 , GT683R_LED_SIDE = 1 , GT683R_LED_FRONT = 2 , GT683R_LED_COUNT , } cocci_id@p ;
