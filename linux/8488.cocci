...
typedef u8,u16,s16;
@@
 struct lance_rx_desc {  u16 rmd0 ;  u8 rmd1_bits ;  u8 rmd1_hadr ;  s16 length ;  u16 mblength ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct lance_init_block {  u16 mode ;  u8 phys_addr [ 6 ] ;  u32 filter [ 2 ] ;  u16 rx_ptr ;  u16 rx_len ;  u16 tx_ptr ;  u16 tx_len ;  struct lance_rx_desc brx_ring [ RX_RING_SIZE ] ;  struct lance_tx_desc btx_ring [ TX_RING_SIZE ] ;  u8 tx_buf [ TX_RING_SIZE ] [ TX_BUFF_SIZE ] ;  u8 pad [ 2 ] ;  u8 rx_buf [ RX_RING_SIZE ] [ RX_BUFF_SIZE ] ; } cocci_id@p ;
...
typedef u8,u16,s16;
@@
 struct lance_tx_desc {  u16 tmd0 ;  u8 tmd1_bits ;  u8 tmd1_hadr ;  s16 length ;  u16 misc ; } cocci_id@p ;
