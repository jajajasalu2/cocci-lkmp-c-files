...
position p;
@@
 const struct kexec_file_ops * constcocci_id [ ] ;
...
position p;
@@
 unsigned long cocci_id@p [ PAGES_NR ] ;
...
position p;
@@
 struct init_pgtable_data * cocci_id@p ;
...
typedef pgd_t;
@@
 struct init_pgtable_data {  struct x86_mapping_info * info ;  pgd_t * level4p ; } cocci_id@p ;
...
position p;
@@
 struct x86_mapping_info * cocci_id@p ;
