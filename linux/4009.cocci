...
position p;
@@
 struct ls_scfg_msir {  struct ls_scfg_msi * msi_data ;  unsigned int index ;  unsigned int gic_irq ;  unsigned int bit_start ;  unsigned int bit_end ;  unsigned int srs ;  void __iomem * reg ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,phys_addr_t,spinlock_t;
@@
 struct ls_scfg_msi {  spinlock_t lock ;  struct platform_device * pdev ;  struct irq_domain * parent ;  struct irq_domain * msi_domain ;  void __iomem * regs ;  phys_addr_t msiir_addr ;  struct ls_scfg_msi_cfg * cfg ;  u32 msir_num ;  struct ls_scfg_msir * msir ;  u32 irqs_num ;  unsigned long * used ; } cocci_id@p ;
...
typedef u32;
@@
 struct ls_scfg_msi_cfg {  u32 ibs_shift ;  u32 msir_irqs ;  u32 msir_base ; } cocci_id@p ;
...
position p;
@@
 struct ls_scfg_msir * cocci_id@p ;
...
position p;
@@
 struct ls_scfg_msi_cfg * cocci_id@p ;
