...
@@
 struct caam_hash_state {  struct caam_request caam_req ;  dma_addr_t buf_dma ;  dma_addr_t ctx_dma ;  int ctx_dma_len ;  u8 buf_0 [ CAAM_MAX_HASH_BLOCK_SIZE ] ____cacheline_aligned ;  int buflen_0 ;  u8 buf_1 [ CAAM_MAX_HASH_BLOCK_SIZE ] ____cacheline_aligned ;  int buflen_1 ;  u8 caam_ctx [ MAX_CTX_LEN ] ____cacheline_aligned ;  int ( * update ) ( struct ahash_request * req ) ;  int ( * final ) ( struct ahash_request * req ) ;  int ( * finup ) ( struct ahash_request * req ) ;  int current_buf ; } cocci_id@p ;
...
position p;
@@
 struct caam_aead_alg cocci_id@p [ ] ;
...
typedef u8,dma_addr_t;
@@
 struct caam_ctx {  struct caam_flc flc [ NUM_OP ] ;  u8 key [ CAAM_MAX_KEY_SIZE ] ;  dma_addr_t flc_dma [ NUM_OP ] ;  dma_addr_t key_dma ;  enum dma_data_direction dir ;  struct device * dev ;  struct alginfo adata ;  struct alginfo cdata ;  unsigned int authsize ; } cocci_id@p ;
...
position p;
@@
 struct caam_skcipher_alg cocci_id@p [ ] ;
...
position p;
@@
 struct caam_hash_ctx cocci_id@p ;
...
typedef u8;
@@
 struct caam_export_state {  u8 buf [ CAAM_MAX_HASH_BLOCK_SIZE ] ;  u8 caam_ctx [ MAX_CTX_LEN ] ;  int buflen ;  int ( * update ) ( struct ahash_request * req ) ;  int ( * final ) ( struct ahash_request * req ) ;  int ( * finup ) ( struct ahash_request * req ) ; } cocci_id@p ;
...
position p;
@@
 enum hash_optype { UPDATE = 0 , UPDATE_FIRST , FINALIZE , DIGEST , HASH_NUM_OP , } cocci_id@p ;
...
position p;
@@
 const struct dpaa2_fd * cocci_id@p ;
...
position p;
@@
 struct dpaa2_fl_entry * cocci_id@p ;
...
position p;
@@
 struct caam_request * cocci_id@p ;
...
position p;
@@
 struct skcipher_edesc cocci_id@p ;
...
position p;
@@
 struct dpaa2_io_notification_ctx * cocci_id@p ;
...
position p;
@@
 struct dpaa2_sg_entry cocci_id@p ;
...
typedef bool;
@@
 struct caam_aead_alg {  struct aead_alg aead ;  struct caam_alg_entry caam ;  bool registered ; } cocci_id@p ;
...
position p;
@@
 struct caam_hash_alg * cocci_id@p ;
...
position p;
@@
 struct caam_export_state * cocci_id@p ;
...
position p;
@@
 struct caam_hash_template * cocci_id@p ;
...
position p;
@@
 struct dpseci_congestion_notification_cfg cocci_id@p ;
...
typedef bool;
@@
 struct caam_alg_entry {  struct device * dev ;  int class1_alg_type ;  int class2_alg_type ;  bool rfc3686 ;  bool geniv ;  bool nodkp ; } cocci_id@p ;
...
position p;
@@
 struct split_key_sh_result cocci_id@p ;
...
position p;
@@
 struct caam_hash_alg {  struct list_head entry ;  struct device * dev ;  int alg_type ;  struct ahash_alg ahash_alg ; } cocci_id@p ;
...
position p;
@@
 struct caam_hash_state cocci_id@p ;
...
position p;
@@
 struct dpaa2_caam_priv_per_cpu cocci_id@p ;
...
position p;
@@
 struct split_key_sh_result {  struct completion completion ;  int err ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct dpseci_rx_queue_cfg cocci_id@p ;
...
typedef u8,dma_addr_t;
@@
 struct caam_hash_ctx {  struct caam_flc flc [ HASH_NUM_OP ] ;  u8 key [ CAAM_MAX_HASH_BLOCK_SIZE ] ____cacheline_aligned ;  dma_addr_t flc_dma [ HASH_NUM_OP ] ;  struct device * dev ;  int ctx_len ;  struct alginfo adata ; } cocci_id@p ;
...
typedef bool;
@@
 struct caam_skcipher_alg {  struct skcipher_alg skcipher ;  struct caam_alg_entry caam ;  bool registered ; } cocci_id@p ;
...
position p;
@@
 const struct caam_export_state * cocci_id@p ;
...
position p;
@@
 struct fsl_mc_device * cocci_id@p ;
...
position p;
@@
 struct dpaa2_caam_priv * cocci_id@p ;
...
typedef u32;
@@
 struct caam_hash_template {  char name [ CRYPTO_MAX_ALG_NAME ] ;  char driver_name [ CRYPTO_MAX_ALG_NAME ] ;  char hmac_name [ CRYPTO_MAX_ALG_NAME ] ;  char hmac_driver_name [ CRYPTO_MAX_ALG_NAME ] ;  unsigned int blocksize ;  struct ahash_alg template_ahash ;  u32 alg_type ; } cocci_id@p ;
...
position p;
@@
 const struct fsl_mc_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct fsl_mc_driver cocci_id@p ;
...
position p;
@@
 struct caam_alg_entry * cocci_id@p ;
