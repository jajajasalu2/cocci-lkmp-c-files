...
position p;
@@
 struct hva_streaminfo * cocci_id@p ;
...
position p;
@@
 enum v4l2_mpeg_video_h264_sei_fp_arrangement_type cocci_id@p ;
...
position p;
@@
 const struct hva_enc * cocci_id@p ;
...
position p;
@@
 struct hva_frameinfo * cocci_id@p ;
