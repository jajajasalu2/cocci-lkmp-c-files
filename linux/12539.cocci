...
position p;
@@
 struct sti_hdmi_connector * cocci_id@p ;
...
position p;
@@
 struct sti_hdmi_connector {  struct drm_connector drm_connector ;  struct drm_encoder * encoder ;  struct sti_hdmi * hdmi ;  struct drm_property * colorspace_property ; } cocci_id@p ;
...
position p;
@@
 struct hdmi_phy_ops * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HDMI_INFOFRAME_HEADER_SIZE + HDMI_VENDOR_INFOFRAME_MAX_SIZE ] ;
...
position p;
@@
 struct hdmi_audio_params * cocci_id@p ;
