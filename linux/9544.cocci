...
position p;
@@
 struct rtl8180_tx_desc * cocci_id@p ;
...
position p;
@@
 struct rtl8180_rx_desc cocci_id@p ;
...
position p;
@@
 struct rtl8187se_rx_desc * cocci_id@p ;
...
position p;
@@
 struct rtl8180_priv * cocci_id@p ;
...
position p;
@@
 struct rtl818x_rx_cmd_desc * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ RTL8180_NR_TX_QUEUES ] ;
...
position p;
@@
 const int cocci_id@p [ RTL8187SE_NR_TX_QUEUES ] ;
...
position p;
@@
 struct rtl8180_tx_ring * cocci_id@p ;
