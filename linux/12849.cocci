...
position p;
@@
 enum mtk_smi_gen { MTK_SMI_GEN1 , MTK_SMI_GEN2 , } cocci_id@p ;
...
position p;
@@
 const struct mtk_smi_common_plat cocci_id@p ;
...
position p;
@@
 struct mtk_smi_larb * cocci_id@p ;
...
position p;
@@
 struct mtk_smi_larb_iommu * cocci_id@p ;
...
typedef bool;
@@
 struct mtk_smi_larb_gen {  int port_in_larb [ MTK_LARB_NR_MAX + 1 ] ;  void ( * config_port ) ( struct device * ) ;  unsigned int larb_direct_to_common_mask ;  bool has_gals ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_smi_larb_gen * cocci_id@p ;
...
position p;
@@
 const struct mtk_smi * cocci_id@p ;
...
typedef u32;
@@
 struct mtk_smi_larb {  struct mtk_smi smi ;  void __iomem * base ;  struct device * smi_common_dev ;  const struct mtk_smi_larb_gen * larb_gen ;  int larbid ;  u32 * mmu ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct mtk_smi_common_plat {  enum mtk_smi_gen gen ;  bool has_gals ;  u32 bus_sel ; } cocci_id@p ;
