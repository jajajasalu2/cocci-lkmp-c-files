...
position p;
@@
 struct evergreen_wm_params * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct radeon_device * rdev , int ring , u32 cp_int_cntl ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct radeon_device * rdev , u32 status , u32 addr ) ;
...
typedef bool,u32;
@@
 struct evergreen_wm_params {  u32 dram_channels ;  u32 yclk ;  u32 sclk ;  u32 disp_clk ;  u32 src_width ;  u32 active_time ;  u32 blank_time ;  bool interlaced ;  fixed20_12 vsc ;  u32 num_heads ;  u32 bytes_per_pixel ;  u32 lb_size ;  u32 vtaps ; } cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct radeon_device * rdev , volatile u32 * buffer ) ;
...
position p;
@@
 struct radeon_voltage * cocci_id@p ;
