...
position p;
@@
 struct _vlan_hdr {  __be16 h_vlan_TCI ;  __be16 h_vlan_encapsulated_proto ; } cocci_id@p ;
...
typedef __u16,__u8;
@@
 struct parse_pkt {  __u16 l3_proto ;  __u16 l3_offset ;  __u16 vlan_outer ;  __u16 vlan_inner ;  __u8 vlan_outer_offset ;  __u8 vlan_inner_offset ; } cocci_id@p ;
