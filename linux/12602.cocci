...
position p;
@@
 enum dpu_clk_ctrl_type cocci_id@p ;
...
position p;
@@
 const struct dpu_mdp_cfg * cocci_id@p ;
...
position p;
@@
 struct dpu_hw_mdp_ops * cocci_id@p ;
...
position p;
@@
 const struct dpu_mdss_cfg * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ PINGPONG_MAX ] ;
