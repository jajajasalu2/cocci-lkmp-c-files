...
position p;
@@
 struct pci_epf_driver cocci_id@p ;
...
position p;
@@
 struct pci_epf_header * cocci_id@p ;
...
position p;
@@
 struct pci_epf_test_reg * cocci_id@p ;
...
position p;
@@
 struct pci_epf_test cocci_id@p ;
...
position p;
@@
 const struct pci_epf_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct pci_epf_test {  void * reg [ PCI_STD_NUM_BARS ] ;  struct pci_epf * epf ;  enum pci_barno test_reg_bar ;  struct delayed_work cmd_handler ;  const struct pci_epc_features * epc_features ; } cocci_id@p ;
