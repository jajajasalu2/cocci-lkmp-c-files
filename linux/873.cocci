...
position p;
@@
 struct sh_flctl_platform_data * cocci_id@p ;
...
position p;
@@
 struct flctl_soc_config {  unsigned long flcmncr_val ;  unsigned has_hwecc : 1 ;  unsigned use_holden : 1 ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef flctl_ecc_res_t;
@@
 enum flctl_ecc_res_t cocci_id@p ;
...
position p;
@@
 const struct flctl_soc_config * cocci_id@p ;
...
position p;
@@
 struct flctl_soc_config cocci_id@p ;
