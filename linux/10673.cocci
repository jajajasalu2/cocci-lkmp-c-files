...
position p;
@@
 struct intel_tv_connector_state * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ ARRAY_SIZE ( tv_modes ) ] ;
...
position p;
@@
 const struct color_conversion cocci_id@p ;
...
position p;
@@
 const struct input_res * cocci_id@p ;
...
position p;
@@
 enum tv_margin { TV_MARGIN_LEFT , TV_MARGIN_TOP , TV_MARGIN_RIGHT , TV_MARGIN_BOTTOM , } cocci_id@p ;
...
position p;
@@
 const struct intel_tv_connector_state * cocci_id@p ;
...
position p;
@@
 struct intel_tv {  struct intel_encoder base ;  int type ; } cocci_id@p ;
