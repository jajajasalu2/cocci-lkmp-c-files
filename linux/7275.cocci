...
position p;
@@
 enum { DA9052_TYPE_WLED1 , DA9052_TYPE_WLED2 , DA9052_TYPE_WLED3 , } cocci_id@p ;
...
position p;
@@
 struct da9052_bl {  struct da9052 * da9052 ;  uint brightness ;  uint state ;  uint led_reg ; } cocci_id@p ;
...
position p;
@@
 enum { DA9052_WLEDS_OFF , DA9052_WLEDS_ON , } cocci_id@p ;
