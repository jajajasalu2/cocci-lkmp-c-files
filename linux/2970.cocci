...
position p;
@@
 struct ghes_estatus_cache cocci_id@p ;
...
position p;
@@
 struct cper_sec_mem_err * cocci_id@p ;
...
position p;
@@
 struct acpi_hest_generic_data * cocci_id@p ;
...
position p;
@@
 struct cper_sec_proc_arm * cocci_id@p ;
...
position p;
@@
 const struct acpi_hest_generic_status * cocci_id@p ;
...
position p;
@@
 struct acpi_hest_generic * * cocci_id@p ;
...
position p;
@@
 struct ghes_estatus_cache * cocci_id@p [ GHES_ESTATUS_CACHES_SIZE ] ;
...
position p;
@@
 struct acpi_hest_generic_v2 * cocci_id@p ;
...
position p;
@@
 struct ghes_estatus_node cocci_id@p ;
...
position p;
@@
 enum fixed_addresses cocci_id@p ;
...
position p;
@@
 struct cper_sec_pcie * cocci_id@p ;
...
position p;
@@
 const struct acpi_hest_generic * cocci_id@p ;
