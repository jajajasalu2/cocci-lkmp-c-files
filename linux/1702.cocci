...
position p;
@@
 struct mcp4018_data {  struct i2c_client * client ;  const struct mcp4018_cfg * cfg ; } cocci_id@p ;
...
position p;
@@
 struct mcp4018_cfg {  int kohms ; } cocci_id@p ;
...
position p;
@@
 struct mcp4018_data * cocci_id@p ;
...
position p;
@@
 const struct mcp4018_cfg cocci_id@p [ ] ;
...
position p;
@@
 enum mcp4018_type { MCP4018_502 , MCP4018_103 , MCP4018_503 , MCP4018_104 , } cocci_id@p ;
