...
position p;
@@
 int cocci_id@p ( struct slot * p_slot ) ;
...
position p;
@@
 struct pushbutton_work_info * cocci_id@p ;
...
position p;
@@
 struct pushbutton_work_info {  struct slot * p_slot ;  struct work_struct work ; } cocci_id@p ;
