...
typedef u64,s32;
@@
 struct cdg_minmax {  union {  struct {  s32 min ;  s32 max ; } ;  u64 v64 ; } ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,s32,bool,u32,u16;
@@
 struct cdg {  struct cdg_minmax rtt ;  struct cdg_minmax rtt_prev ;  struct cdg_minmax * gradients ;  struct cdg_minmax gsum ;  bool gfilled ;  u8 tail ;  u8 state ;  u8 delack ;  u32 rtt_seq ;  u32 shadow_wnd ;  u16 backoff_cnt ;  u16 sample_cnt ;  s32 delay_min ;  u32 last_ack ;  u32 round_start ; } cocci_id@p ;
...
position p;
@@
 const struct ack_sample * cocci_id@p ;
...
position p;
@@
 const enum tcp_ca_event cocci_id@p ;
...
position p;
@@
 enum cdg_state { CDG_UNKNOWN = 0 , CDG_NONFULL = 1 , CDG_FULL = 2 , CDG_BACKOFF = 3 , } cocci_id@p ;
