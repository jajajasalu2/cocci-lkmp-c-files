...
position p;
@@
 enum ds278x_num_id { DS2782 = 0 , DS2786 , } cocci_id@p ;
...
position p;
@@
 struct ds278x_platform_data * cocci_id@p ;
...
position p;
@@
 struct ds278x_battery_ops {  int ( * get_battery_current ) ( struct ds278x_info * info , int * current_uA ) ;  int ( * get_battery_voltage ) ( struct ds278x_info * info , int * voltage_uV ) ;  int ( * get_battery_capacity ) ( struct ds278x_info * info , int * capacity ) ; } cocci_id@p ;
...
position p;
@@
 struct ds278x_info {  struct i2c_client * client ;  struct power_supply * battery ;  struct power_supply_desc battery_desc ;  const struct ds278x_battery_ops * ops ;  struct delayed_work bat_work ;  int id ;  int rsns ;  int capacity ;  int status ; } cocci_id@p ;
...
position p;
@@
 const struct ds278x_battery_ops cocci_id@p [ ] ;
