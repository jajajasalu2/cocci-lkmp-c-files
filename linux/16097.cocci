...
position p;
@@
 struct mf6x4_board {  const char * name ;  unsigned int bar_nums [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 const struct mf6x4_board cocci_id@p [ ] ;
...
position p;
@@
 struct mf6x4_private {  void __iomem * bar0_mem ;  void __iomem * bar2_mem ;  void __iomem * gpioc_reg ; } cocci_id@p ;
...
position p;
@@
 struct mf6x4_private * cocci_id@p ;
...
position p;
@@
 enum mf6x4_boardid { BOARD_MF634 , BOARD_MF624 , } cocci_id@p ;
