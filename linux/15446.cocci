...
position p;
@@
 struct rn5t618_wdt {  struct watchdog_device wdt_dev ;  struct rn5t618 * rn5t618 ; } cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 reg_val ;  unsigned int time ; } cocci_id@p [ ] ;
