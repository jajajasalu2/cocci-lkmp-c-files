...
position p;
@@
 struct pvrdma_sq_wqe_hdr cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_query_qp * cocci_id@p ;
...
position p;
@@
 struct pvrdma_rq_wqe_hdr cocci_id@p ;
...
position p;
@@
 struct pvrdma_user_mr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pvrdma_dev * dev , struct pvrdma_qp * qp ) ;
...
position p;
@@
 struct pvrdma_cmd_modify_qp * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_create_qp * cocci_id@p ;
...
position p;
@@
 struct pvrdma_create_qp cocci_id@p ;
...
position p;
@@
 union pvrdma_cmd_resp cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_destroy_qp * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_create_qp_resp * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_query_qp_resp * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_create_qp_resp_v2 * cocci_id@p ;
...
position p;
@@
 struct pvrdma_create_qp_resp cocci_id@p ;
...
position p;
@@
 union pvrdma_cmd_req cocci_id@p ;
