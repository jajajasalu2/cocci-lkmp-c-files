...
position p;
@@
 struct drm_fb_helper * cocci_id@p ( struct fb_info * fbi ) ;
...
typedef bool;
@@
 struct omap_fbdev {  struct drm_fb_helper base ;  struct drm_framebuffer * fb ;  struct drm_gem_object * bo ;  bool ywrap_enabled ;  struct work_struct work ; } cocci_id@p ;
