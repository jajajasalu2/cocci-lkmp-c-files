...
position p;
@@
 struct sdhci_sprd_host * cocci_id@p ;
...
typedef u8;
@@
 struct sdhci_sprd_phy_cfg {  const char * property ;  u8 timing ; } cocci_id@p ;
...
position p;
@@
 const struct sdhci_sprd_phy_cfg cocci_id@p [ ] ;
...
typedef u32;
@@
 struct sdhci_sprd_host {  u32 version ;  struct clk * clk_sdio ;  struct clk * clk_enable ;  struct clk * clk_2x_enable ;  struct pinctrl * pinctrl ;  struct pinctrl_state * pins_uhs ;  struct pinctrl_state * pins_default ;  u32 base_rate ;  int flags ;  u32 phy_delay [ MMC_TIMING_MMC_HS400 + 2 ] ; } cocci_id@p ;
