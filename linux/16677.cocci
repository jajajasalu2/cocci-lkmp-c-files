...
typedef bool;
@@
 struct tc_keypad {  struct tc3589x * tc3589x ;  struct input_dev * input ;  const struct tc3589x_keypad_platform_data * board ;  unsigned int krow ;  unsigned int kcol ;  unsigned short * keymap ;  bool keypad_stopped ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct tc3589x_keypad_platform_data {  const struct matrix_keymap_data * keymap_data ;  u8 krow ;  u8 kcol ;  u8 debounce_period ;  u8 settle_time ;  unsigned long irqtype ;  bool enable_wakeup ;  bool no_autorepeat ; } cocci_id@p ;
...
position p;
@@
 const struct tc3589x_keypad_platform_data * cocci_id@p ;
...
position p;
@@
 struct tc3589x_keypad_platform_data * cocci_id@p ;
