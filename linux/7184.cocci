...
position p;
@@
 struct adc_jack_pdata * cocci_id@p ;
...
position p;
@@
 struct adc_jack_data * cocci_id@p ;
...
position p;
@@
 struct adc_jack_cond * cocci_id@p ;
...
typedef bool;
@@
 struct adc_jack_data {  struct device * dev ;  struct extcon_dev * edev ;  const unsigned int * * cable_names ;  struct adc_jack_cond * adc_conditions ;  int num_conditions ;  int irq ;  unsigned long handling_delay ;  struct delayed_work handler ;  struct iio_channel * chan ;  bool wakeup_source ; } cocci_id@p ;
