...
position p;
@@
 struct rockchip_gem_object * cocci_id@p ;
...
position p;
@@
 struct rockchip_crtc_state * cocci_id@p ;
...
position p;
@@
 const struct vop_win * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,spinlock_t,uint32_t;
@@
 struct vop {  struct drm_crtc crtc ;  struct device * dev ;  struct drm_device * drm_dev ;  bool is_enabled ;  struct completion dsp_hold_completion ;  unsigned int win_enabled ;  struct drm_pending_vblank_event * event ;  struct drm_flip_work fb_unref_work ;  unsigned long pending ;  struct completion line_flag_completion ;  const struct vop_data * data ;  uint32_t * regsbak ;  void __iomem * regs ;  void __iomem * lut_regs ;  uint32_t len ;  spinlock_t reg_lock ;  spinlock_t irq_lock ;  struct mutex vop_lock ;  unsigned int irq ;  struct clk * hclk ;  struct clk * dclk ;  struct clk * aclk ;  struct reset_control * dclk_rst ;  struct rockchip_rgb * rgb ;  struct vop_win win [ ] ; } cocci_id@p ;
...
position p;
@@
 struct drm_color_lut * cocci_id@p ;
...
position p;
@@
 const struct vop_win_data * cocci_id@p ;
...
position p;
@@
 const struct vop_reg * cocci_id@p ;
...
position p;
@@
 const struct vop_data * cocci_id@p ;
...
position p;
@@
 struct vop_win {  struct drm_plane base ;  const struct vop_win_data * data ;  const struct vop_win_yuv2yuv_data * yuv2yuv_data ;  struct vop * vop ; } cocci_id@p ;
...
position p;
@@
 enum vop_pending { VOP_PENDING_FB_UNREF , } cocci_id@p ;
...
position p;
@@
 struct rockchip_rgb cocci_id@p ;
...
position p;
@@
 struct drm_flip_work * cocci_id@p ;
...
position p;
@@
 const struct vop_win_yuv2yuv_data * cocci_id@p ;
...
position p;
@@
 enum vop_data_format cocci_id@p ;
...
position p;
@@
 struct reset_control * cocci_id@p ;
