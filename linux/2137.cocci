...
typedef u32;
@@
 const int cocci_id@p [ BITS_PER_TYPE ( u32 ) ] ;
...
position p;
@@
 struct ucs1002_info * cocci_id@p ;
...
typedef u8;
@@
 const int cocci_id@p [ BITS_PER_TYPE ( u8 ) ] ;
...
typedef bool;
@@
 struct ucs1002_info {  struct power_supply * charger ;  struct i2c_client * client ;  struct regmap * regmap ;  struct regulator_desc * regulator_descriptor ;  bool present ; } cocci_id@p ;
