...
position p;
@@
 GtkCellRendererText * cocci_id@p ;
...
position p;
@@
 enum { OPT_NORMAL , OPT_ALL , OPT_PROMPT , } cocci_id@p ;
...
position p;
@@
 gchar * * cocci_id@p ( struct menu * menu ) ;
...
position p;
@@
 enum { SINGLE_VIEW , SPLIT_VIEW , FULL_VIEW , } cocci_id@p ;
...
position p;
@@
 enum { COL_OPTION , COL_NAME , COL_NO , COL_MOD , COL_YES , COL_VALUE , COL_MENU , COL_COLOR , COL_EDIT , COL_PIXBUF , COL_PIXVIS , COL_BTNVIS , COL_BTNACT , COL_BTNINC , COL_BTNRAD , COL_NUMBER , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( GtkMenuItem * menuitem , gpointer user_data ) ;
...
position p;
@@
 void cocci_id@p ( struct menu * menu ) ;
...
position p;
@@
 void cocci_id@p ( struct menu * src , GtkTreeIter * dst ) ;
...
position p;
@@
 void cocci_id@p ( GtkTreeIter * node , struct menu * menu , gchar * * row ) ;
...
position p;
@@
 void cocci_id@p ( GtkCellRendererText * cell , const gchar * path_string , const gchar * new_text , gpointer user_data ) ;
