...
typedef u32;
@@
 struct pll_info {  unsigned long diff ;  unsigned int pll_m ;  unsigned int pll_n ;  unsigned int pll_e ;  unsigned int div ;  u32 clksel ; } cocci_id@p ;
...
position p;
@@
 enum rcar_lvds_mode cocci_id@p ;
...
position p;
@@
 const struct rcar_lvds_device_info cocci_id@p ;
...
typedef bool;
@@
 struct rcar_lvds {  struct device * dev ;  const struct rcar_lvds_device_info * info ;  struct drm_bridge bridge ;  struct drm_bridge * next_bridge ;  struct drm_connector connector ;  struct drm_panel * panel ;  void __iomem * mmio ;  struct {  struct clk * mod ;  struct clk * extal ;  struct clk * dotclkin [ 2 ] ; } clocks ;  struct drm_display_mode display_mode ;  enum rcar_lvds_mode mode ;  struct drm_bridge * companion ;  bool dual_link ; } cocci_id@p ;
...
position p;
@@
 enum rcar_lvds_mode { RCAR_LVDS_MODE_JEIDA = 0 , RCAR_LVDS_MODE_MIRROR = 1 , RCAR_LVDS_MODE_VESA = 4 , } cocci_id@p ;
