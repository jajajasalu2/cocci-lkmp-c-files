...
typedef u16;
@@
 struct vsp1_extended_command_info {  u16 opcode ;  size_t body_size ; } cocci_id@p ;
...
@@
 struct vsp1_dl_body_pool {  dma_addr_t dma ;  size_t size ;  void * mem ;  struct vsp1_dl_body * bodies ;  struct list_head free ;  spinlock_t lock ;  struct vsp1_device * vsp1 ; } cocci_id@p ;
...
position p;
@@
 const struct vsp1_extended_command_info cocci_id@p [ ] ;
...
typedef spinlock_t,dma_addr_t;
@@
 struct vsp1_dl_cmd_pool {  dma_addr_t dma ;  size_t size ;  void * mem ;  struct vsp1_dl_ext_cmd * cmds ;  struct list_head free ;  spinlock_t lock ;  struct vsp1_device * vsp1 ; } cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_list * cocci_id@p ;
...
position p;
@@
 enum vsp1_extcmd_type cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_entry cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_body * cocci_id@p ;
...
position p;
@@
 struct vsp1_pre_ext_dl_body cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_manager * cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_body_pool * cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_ext_cmd * cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_cmd_pool * cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_header_extended cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dma_addr_t,refcount_t;
@@
 struct vsp1_dl_body {  struct list_head list ;  struct list_head free ;  refcount_t refcnt ;  struct vsp1_dl_body_pool * pool ;  struct vsp1_dl_entry * entries ;  dma_addr_t dma ;  size_t size ;  unsigned int num_entries ;  unsigned int max_entries ; } cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_header_list * cocci_id@p ;
...
position p;
@@
 struct vsp1_dl_header cocci_id@p ;
...
@@
 struct vsp1_dl_manager {  unsigned int index ;  bool singleshot ;  struct vsp1_device * vsp1 ;  spinlock_t lock ;  struct list_head free ;  struct vsp1_dl_list * active ;  struct vsp1_dl_list * queued ;  struct vsp1_dl_list * pending ;  struct vsp1_dl_body_pool * pool ;  struct vsp1_dl_cmd_pool * cmdpool ; } cocci_id@p ;
...
position p;
@@
 enum vsp1_extcmd_type { VSP1_EXTCMD_AUTODISP , VSP1_EXTCMD_AUTOFLD , } cocci_id@p ;
