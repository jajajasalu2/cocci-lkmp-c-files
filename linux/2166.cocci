...
position p;
@@
 struct power_supply * cocci_id@p [ TEST_POWER_NUM ] ;
...
position p;
@@
 enum test_power_id { TEST_AC , TEST_BATTERY , TEST_USB , TEST_POWER_NUM , } cocci_id@p ;
...
position p;
@@
 struct battery_property_map cocci_id@p [ ] ;
...
position p;
@@
 struct battery_property_map {  int value ;  const char * key ; } cocci_id@p ;
