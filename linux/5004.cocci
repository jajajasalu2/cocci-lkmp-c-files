...
typedef u64,bool;
@@
 struct hfi1_opfn_type {  bool ( * request ) ( struct rvt_qp * qp , u64 * data ) ;  bool ( * response ) ( struct rvt_qp * qp , u64 * data ) ;  bool ( * reply ) ( struct rvt_qp * qp , u64 data ) ;  void ( * error ) ( struct rvt_qp * qp ) ; } cocci_id@p ;
...
position p;
@@
 struct hfi1_opfn_data * cocci_id@p ;
...
position p;
@@
 struct hfi1_opfn_type cocci_id@p [ STL_VERBS_EXTD_MAX ] ;
...
position p;
@@
 struct hfi1_opfn_type * cocci_id@p ;
