...
@@
 struct tusb_omap_dma_ch {  struct musb * musb ;  void __iomem * tbase ;  unsigned long phys_offset ;  int epnum ;  u8 tx ;  struct musb_hw_ep * hw_ep ;  struct tusb_dma_data * dma_data ;  struct tusb_omap_dma * tusb_dma ;  dma_addr_t dma_addr ;  u32 len ;  u16 packet_sz ;  u16 transfer_packet_sz ;  u32 transfer_len ;  u32 completed_len ; } cocci_id@p ;
...
position p;
@@
 struct tusb_dma_data * cocci_id@p ;
...
typedef s8;
@@
 struct tusb_dma_data {  s8 dmareq ;  struct dma_chan * chan ; } cocci_id@p ;
...
position p;
@@
 struct tusb_omap_dma {  struct dma_controller controller ;  void __iomem * tbase ;  struct tusb_dma_data dma_pool [ MAX_DMAREQ ] ;  unsigned multichannel : 1 ; } cocci_id@p ;
...
position p;
@@
 struct dma_channel * cocci_id@p [ MAX_DMAREQ ] ;
...
position p;
@@
 struct tusb_omap_dma_ch cocci_id@p ;
...
position p;
@@
 struct tusb_omap_dma * cocci_id@p ;
