...
position p;
@@
 const struct {  int reg_domain ;  int min , max , deflt ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wl3501_tx_hdr cocci_id@p ;
...
position p;
@@
 struct wl3501_md_ind cocci_id@p ;
...
position p;
@@
 struct wl3501_assoc_req cocci_id@p ;
...
position p;
@@
 struct wl3501_80211_tx_hdr cocci_id@p ;
...
position p;
@@
 struct wl3501_md_req cocci_id@p ;
...
position p;
@@
 struct wl3501_auth_req cocci_id@p ;
...
position p;
@@
 struct wl3501_get_req cocci_id@p ;
...
position p;
@@
 struct wl3501_join_req cocci_id@p ;
...
position p;
@@
 struct wl3501_rx_hdr cocci_id@p ;
...
position p;
@@
 struct wl3501_md_confirm cocci_id@p ;
...
position p;
@@
 struct wl3501_scan_req cocci_id@p ;
...
position p;
@@
 struct wl3501_join_confirm cocci_id@p ;
...
position p;
@@
 struct iw_mgmt_info_element * cocci_id@p ;
...
position p;
@@
 struct wl3501_scan_confirm cocci_id@p ;
...
position p;
@@
 struct wl3501_assoc_confirm cocci_id@p ;
...
position p;
@@
 struct wl3501_auth_confirm cocci_id@p ;
...
position p;
@@
 struct wl3501_start_confirm cocci_id@p ;
...
position p;
@@
 enum iw_mgmt_info_element_ids cocci_id@p ;
...
position p;
@@
 struct wl3501_start_req cocci_id@p ;
...
position p;
@@
 struct wl3501_pwr_mgmt_req cocci_id@p ;
...
position p;
@@
 struct wl3501_resync_req cocci_id@p ;
