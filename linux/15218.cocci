...
position p;
@@
 enum lp8788_isink_number cocci_id@p ;
...
position p;
@@
 struct lp8788_led_config {  enum lp8788_isink_scale scale ;  enum lp8788_isink_number num ;  int iout ; } cocci_id@p ;
...
position p;
@@
 struct lp8788_led_config * cocci_id@p ;
...
position p;
@@
 struct lp8788_led_platform_data * cocci_id@p ;
...
position p;
@@
 struct lp8788_led {  struct lp8788 * lp ;  struct mutex lock ;  struct led_classdev led_dev ;  enum lp8788_isink_number isink_num ;  int on ; } cocci_id@p ;
