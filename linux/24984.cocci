...
position p;
@@
 struct batadv_neigh_node * cocci_id@p ;
...
position p;
@@
 struct batadv_softif_vlan * cocci_id@p ;
...
position p;
@@
 struct batadv_tt_req_node cocci_id@p ;
...
position p;
@@
 struct batadv_tt_common_entry cocci_id@p ;
...
position p;
@@
 struct batadv_tvlv_hdr cocci_id@p ;
...
position p;
@@
 struct batadv_algo_ops * cocci_id@p ;
...
position p;
@@
 struct batadv_hard_iface * cocci_id@p ;
...
position p;
@@
 struct batadv_tvlv_tt_data * cocci_id@p ;
...
position p;
@@
 struct batadv_tt_roam_node cocci_id@p ;
...
position p;
@@
 struct batadv_orig_node_vlan * cocci_id@p ;
...
position p;
@@
 struct batadv_tvlv_roam_adv cocci_id@p ;
...
position p;
@@
 struct batadv_tt_local_entry * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct batadv_priv * bat_priv , struct batadv_orig_node * orig_node , const unsigned char * addr , unsigned short vid , const char * message , bool roaming ) ;
...
position p;
@@
 const struct hlist_node * cocci_id@p ;
...
position p;
@@
 struct batadv_tt_global_entry cocci_id@p ;
...
position p;
@@
 const struct batadv_tt_common_entry * cocci_id@p ;
...
position p;
@@
 struct batadv_tvlv_tt_change cocci_id@p ;
...
position p;
@@
 struct batadv_orig_node * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct batadv_priv * bat_priv , u8 * client , unsigned short vid , struct batadv_orig_node * orig_node ) ;
...
position p;
@@
 struct batadv_tvlv_tt_vlan_data * cocci_id@p ;
...
position p;
@@
 struct batadv_tt_orig_list_entry cocci_id@p ;
...
typedef u8,bool;
@@
 bool ( * cocci_id@p ) ( const void * , const void * , u8 * flags ) ;
...
position p;
@@
 const struct batadv_orig_node * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct batadv_tt_global_entry * tt_global_entry ) ;
...
position p;
@@
 struct batadv_hashtable * cocci_id@p ;
...
position p;
@@
 struct batadv_priv_tt * cocci_id@p ;
...
position p;
@@
 const struct hlist_head * cocci_id@p ;
...
position p;
@@
 struct batadv_unicast_tvlv_packet cocci_id@p ;
...
position p;
@@
 struct batadv_tt_change_node cocci_id@p ;
...
position p;
@@
 const struct batadv_tt_global_entry * cocci_id@p ;
