...
position p;
@@
 struct qlcnic_pex_dma_descriptor * cocci_id@p ;
...
position p;
@@
 struct qlcnic_dump_entry * cocci_id@p ;
...
position p;
@@
 const struct qlcnic_dump_operations cocci_id@p [ ] ;
...
position p;
@@
 struct qlcnic_82xx_dump_template_hdr * cocci_id@p ;
...
position p;
@@
 struct qlcnic_83xx_dump_template_hdr cocci_id@p ;
