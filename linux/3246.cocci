...
position p;
@@
 struct xgene_hwmon_dev * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,phys_addr_t,spinlock_t;
@@
 struct xgene_hwmon_dev {  struct device * dev ;  struct mbox_chan * mbox_chan ;  struct mbox_client mbox_client ;  int mbox_idx ;  spinlock_t kfifo_lock ;  struct mutex rd_mutex ;  struct completion rd_complete ;  int resp_pending ;  struct slimpro_resp_msg sync_msg ;  struct work_struct workq ;  struct kfifo_rec_ptr_1 async_msg_fifo ;  struct device * hwmon_dev ;  bool temp_critical_alarm ;  phys_addr_t comm_base_addr ;  void * pcc_comm_addr ;  u64 usecs_lat ; } cocci_id@p ;
...
position p;
@@
 struct slimpro_resp_msg cocci_id@p ;
...
position p;
@@
 enum xgene_hwmon_version { XGENE_HWMON_V1 = 0 , XGENE_HWMON_V2 = 1 , } cocci_id@p ;
