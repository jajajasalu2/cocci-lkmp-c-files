...
position p;
@@
 struct viu_buf {  struct videobuf_buffer vb ;  struct viu_fmt * fmt ; } cocci_id@p ;
...
position p;
@@
 struct viu_dmaqueue * cocci_id@p ;
...
position p;
@@
 struct videobuf_buffer * cocci_id@p ;
...
position p;
@@
 struct viu_dmaqueue {  struct viu_dev * dev ;  struct list_head active ;  struct list_head queued ;  struct timer_list timeout ; } cocci_id@p ;
...
typedef u32;
@@
 struct viu_fmt {  u32 fourcc ;  u32 pixelformat ;  int depth ; } cocci_id@p ;
...
typedef u32;
@@
 struct viu_status {  u32 field_irq ;  u32 vsync_irq ;  u32 hsync_irq ;  u32 vstart_irq ;  u32 dma_end_irq ;  u32 error_irq ; } cocci_id@p ;
...
position p;
@@
 const struct videobuf_queue_ops cocci_id@p ;
...
position p;
@@
 struct videobuf_queue * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct viu_dev {  struct v4l2_device v4l2_dev ;  struct v4l2_ctrl_handler hdl ;  struct mutex lock ;  spinlock_t slock ;  int users ;  struct device * dev ;  struct video_device * vdev ;  struct viu_dmaqueue vidq ;  enum v4l2_field capfield ;  int field ;  int first ;  int dma_done ;  struct viu_reg __iomem * vr ;  int irq ;  struct viu_status irqs ;  struct v4l2_framebuffer ovbuf ;  struct viu_fmt * ovfmt ;  unsigned int ovenable ;  enum v4l2_field ovfield ;  struct v4l2_rect crop_current ;  struct clk * clk ;  struct v4l2_subdev * decoder ;  v4l2_std_id std ; } cocci_id@p ;
