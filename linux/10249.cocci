...
typedef bool;
@@
 void ( * cocci_id@p ) ( void * cookie , bool state ) ;
...
typedef bool;
@@
 unsigned int ( * cocci_id@p ) ( void * cookie , bool decode ) ;
...
typedef spinlock_t;
@@
 struct vga_arb_private {  struct list_head list ;  struct pci_dev * target ;  struct vga_arb_user_card cards [ MAX_USER_CARDS ] ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct vga_arb_private * cocci_id@p ;
...
position p;
@@
 struct vga_arb_user_card {  struct pci_dev * pdev ;  unsigned int mem_cnt ;  unsigned int io_cnt ; } cocci_id@p ;
...
position p;
@@
 struct vga_arb_user_card * cocci_id@p ;
...
typedef bool;
@@
 struct vga_device {  struct list_head list ;  struct pci_dev * pdev ;  unsigned int decodes ;  unsigned int owns ;  unsigned int locks ;  unsigned int io_lock_cnt ;  unsigned int mem_lock_cnt ;  unsigned int io_norm_cnt ;  unsigned int mem_norm_cnt ;  bool bridge_has_one_vga ;  void * cookie ;  void ( * irq_set_state ) ( void * cookie , bool enable ) ;  unsigned int ( * set_vga_decode ) ( void * cookie , bool decode ) ; } cocci_id@p ;
