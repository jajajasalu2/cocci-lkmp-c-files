...
position p;
@@
 struct edt_ft5x06_attribute cocci_id@p ;
...
typedef u8;
@@
 struct edt_ft5x06_attribute {  struct device_attribute dattr ;  size_t field_offset ;  u8 limit_low ;  u8 limit_high ;  u8 addr_m06 ;  u8 addr_m09 ;  u8 addr_ev ; } cocci_id@p ;
...
position p;
@@
 enum edt_ver { EDT_M06 , EDT_M09 , EDT_M12 , EV_FT , GENERIC_FT , } cocci_id@p ;
...
position p;
@@
 struct edt_reg_addr * cocci_id@p ;
...
position p;
@@
 struct edt_ft5x06_ts_data * cocci_id@p ;
...
position p;
@@
 struct edt_i2c_chip_data {  int max_support_points ; } cocci_id@p ;
...
position p;
@@
 struct edt_reg_addr {  int reg_threshold ;  int reg_report_rate ;  int reg_gain ;  int reg_offset ;  int reg_offset_x ;  int reg_offset_y ;  int reg_num_x ;  int reg_num_y ; } cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct edt_ft5x06_ts_data {  struct i2c_client * client ;  struct input_dev * input ;  struct touchscreen_properties prop ;  u16 num_x ;  u16 num_y ;  struct regulator * vcc ;  struct gpio_desc * reset_gpio ;  struct gpio_desc * wake_gpio ; #if defined(CONFIG_DEBUG_FS)  struct dentry * debug_dir ;  u8 * raw_buffer ;  size_t raw_bufsize ; #endif  struct mutex mutex ;  bool factory_mode ;  int threshold ;  int gain ;  int offset ;  int offset_x ;  int offset_y ;  int report_rate ;  int max_support_points ;  char name [ EDT_NAME_LEN ] ;  struct edt_reg_addr reg_addr ;  enum edt_ver version ; } cocci_id@p ;
...
position p;
@@
 const struct edt_i2c_chip_data cocci_id@p ;
