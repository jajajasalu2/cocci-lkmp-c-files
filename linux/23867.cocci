...
position p;
@@
 struct tcf_police_params * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_POLICE_MAX + 1 ] ;
...
position p;
@@
 struct gnet_stats_rate_est64 cocci_id@p ;
...
position p;
@@
 struct tc_police_compat cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_POLICE_MAX + 1 ] ;
