...
position p;
@@
 struct ecap_pwm_chip cocci_id@p ;
...
typedef u32,u16;
@@
 struct ecap_context {  u32 cap3 ;  u32 cap4 ;  u16 ecctl2 ; } cocci_id@p ;
...
position p;
@@
 struct ecap_pwm_chip {  struct pwm_chip chip ;  unsigned int clk_rate ;  void __iomem * mmio_base ;  struct ecap_context ctx ; } cocci_id@p ;
