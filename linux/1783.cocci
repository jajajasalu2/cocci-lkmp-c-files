...
position p;
@@
 struct tsl2563_chip * cocci_id@p ;
...
position p;
@@
 const struct tsl2563_lux_coeff * cocci_id@p ;
...
position p;
@@
 struct tsl2563_lux_coeff {  unsigned long ch_ratio ;  unsigned long ch0_coeff ;  unsigned long ch1_coeff ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct tsl2563_gainlevel_coeff {  u8 gaintime ;  u16 min ;  u16 max ; } cocci_id@p ;
...
@@
 struct tsl2563_chip {  struct mutex lock ;  struct i2c_client * client ;  struct delayed_work poweroff_work ;  bool suspended ;  const struct tsl2563_gainlevel_coeff * gainlevel ;  u16 low_thres ;  u16 high_thres ;  u8 intr ;  bool int_enabled ;  u32 calib0 ;  u32 calib1 ;  int cover_comp_gain ;  u32 data0 ;  u32 data1 ; } cocci_id@p ;
...
position p;
@@
 const struct tsl2563_gainlevel_coeff cocci_id@p [ ] ;
...
position p;
@@
 struct tsl2563_platform_data * cocci_id@p ;
