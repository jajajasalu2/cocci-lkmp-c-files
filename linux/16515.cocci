...
position p;
@@
 struct cpuidle_attr cocci_id@p ;
...
position p;
@@
 struct cpuidle_state_kobj {  struct cpuidle_state * state ;  struct cpuidle_state_usage * state_usage ;  struct completion kobj_unregister ;  struct kobject kobj ;  struct cpuidle_device * device ; } cocci_id@p ;
...
position p;
@@
 struct cpuidle_device_kobj cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CPUIDLE_NAME_LEN ] ;
...
position p;
@@
 struct cpuidle_state_attr cocci_id@p ;
...
position p;
@@
 struct cpuidle_driver_attr cocci_id@p ;
...
position p;
@@
 struct cpuidle_state_usage * cocci_id@p ;
...
position p;
@@
 struct cpuidle_driver * cocci_id@p ;
...
position p;
@@
 struct cpuidle_governor * cocci_id@p ;
...
position p;
@@
 struct cpuidle_device_kobj {  struct cpuidle_device * dev ;  struct completion kobj_unregister ;  struct kobject kobj ; } cocci_id@p ;
...
position p;
@@
 struct cpuidle_state_kobj * cocci_id@p ;
...
position p;
@@
 struct cpuidle_device * cocci_id@p ;
...
position p;
@@
 struct cpuidle_driver_kobj {  struct cpuidle_driver * drv ;  struct completion kobj_unregister ;  struct kobject kobj ; } cocci_id@p ;
...
position p;
@@
 struct cpuidle_driver_kobj * cocci_id@p ;
