...
position p;
@@
 const struct nxt6000_config * cocci_id@p ;
...
position p;
@@
 struct nxt6000_state * cocci_id@p ;
...
position p;
@@
 struct nxt6000_state {  struct i2c_adapter * i2c ;  const struct nxt6000_config * config ;  struct dvb_frontend frontend ; } cocci_id@p ;
