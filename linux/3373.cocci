...
position p;
@@
 const struct pwm_device * cocci_id@p ;
...
position p;
@@
 const struct pwm_chip * cocci_id@p ;
...
position p;
@@
 struct pwm_export {  struct device child ;  struct pwm_device * pwm ;  struct mutex lock ;  struct pwm_state suspend ; } cocci_id@p ;
