...
position p;
@@
 struct uart_pxa_port * cocci_id@p [ 4 ] ;
...
position p;
@@
 struct uart_pxa_port cocci_id@p ;
...
position p;
@@
 struct uart_pxa_port {  struct uart_port port ;  unsigned char ier ;  unsigned char lcr ;  unsigned char mcr ;  unsigned int lsr_break_flag ;  struct clk * clk ;  char name [ PXA_NAME_LEN ] ; } cocci_id@p ;
