...
typedef s64;
@@
 int cocci_id@p ( struct inode * ip , s64 xoff , s64 * next , int * cmpp , struct btstack * btstack , int flag ) ;
...
typedef s64,tid_t;
@@
 int cocci_id@p ( tid_t tid , struct inode * ip , struct xtsplit * split , struct metapage * * rmpp , s64 * rbnp ) ;
...
typedef tid_t;
@@
 int cocci_id@p ( tid_t tid , struct inode * ip , struct xtsplit * split , struct btstack * btstack ) ;
...
position p;
@@
 struct {  uint search ;  uint fastSearch ;  uint split ; } cocci_id@p ;
...
typedef u8,s16,s64;
@@
 struct xtsplit {  struct metapage * mp ;  s16 index ;  u8 flag ;  s64 off ;  s64 addr ;  int len ;  struct pxdlist * pxdlist ; } cocci_id@p ;
...
typedef tid_t;
@@
 int cocci_id@p ( tid_t tid , struct inode * ip , struct xtsplit * split , struct metapage * * rmpp ) ;
