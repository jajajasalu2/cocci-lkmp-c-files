...
position p;
@@
 struct vchiq_service_quota * cocci_id@p ;
...
position p;
@@
 struct vchiq_slot_info cocci_id@p ;
...
position p;
@@
 struct vchiq_openack_payload cocci_id@p ;
...
position p;
@@
 vchiq_userdata_term cocci_id@p ;
...
position p;
@@
 struct vchiq_open_payload * cocci_id@p ;
...
position p;
@@
 const struct vchiq_open_payload * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vchiq_state * state , struct vchiq_header * header ) ;
...
position p;
@@
 enum vchiq_service_option cocci_id@p ;
...
position p;
@@
 struct vchiq_bulk_queue * cocci_id@p ;
...
position p;
@@
 struct vchiq_openack_payload {  short version ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_slot_zero cocci_id@p ;
...
position p;
@@
 struct vchiq_shared_state * cocci_id@p ;
...
position p;
@@
 const struct vchiq_openack_payload * cocci_id@p ;
...
position p;
@@
 enum { QMFLAGS_IS_BLOCKING = ( 1 << 0 ) , QMFLAGS_NO_MUTEX_LOCK = ( 1 << 1 ) , QMFLAGS_NO_MUTEX_UNLOCK = ( 1 << 2 ) , } cocci_id@p ;
...
position p;
@@
 struct vchiq_open_payload {  int fourcc ;  int client_id ;  short version ;  short version_min ; } cocci_id@p ;
...
position p;
@@
 struct remote_event * cocci_id@p ;
...
position p;
@@
 struct vchiq_state * cocci_id@p [ VCHIQ_MAX_STATES ] ;
