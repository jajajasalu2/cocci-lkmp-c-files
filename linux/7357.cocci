...
position p;
@@
 const struct sa1100fb_rgb cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct sa1100fb_info * fbi , u_int state ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , struct sa1100fb_info * ) ;
...
position p;
@@
 struct sa1100fb_info * cocci_id@p ;
...
position p;
@@
 struct sa1100fb_lcd_reg cocci_id@p ;
