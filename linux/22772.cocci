...
position p;
@@
 int cocci_id@p ( struct snd_sb * chip , int * version ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_hwdep * hw , struct file * file , unsigned int cmd , unsigned long arg ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb * chip ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb * chip , unsigned char reg , unsigned char val ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb_csp * p , int sample_width , int channels ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb_csp * p , int device ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb * chip , unsigned char reg ) ;
...
position p;
@@
 struct desc_header {  struct riff_header info ;  __le16 func_nr ;  __le16 VOC_type ;  __le16 flags_play_rec ;  __le16 flags_16bit_8bit ;  __le16 flags_stereo_mono ;  __le16 flags_rates ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb_csp * p , struct snd_sb_csp_microcode __user * code ) ;
...
position p;
@@
 struct snd_sb_csp_mc_header cocci_id@p ;
...
position p;
@@
 struct snd_sb_csp_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb * chip , unsigned char mode ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_info_entry * entry , struct snd_info_buffer * buffer ) ;
...
position p;
@@
 struct snd_sb_csp_start cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb * chip , unsigned char par , unsigned char val ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_hwdep * hw ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_hwdep * hw , struct file * file ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_sb_csp * p ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb_csp * p ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sb_csp * p , const unsigned char __user * buf , int size , int load_flags ) ;
...
position p;
@@
 struct riff_header {  __le32 name ;  __le32 len ; } cocci_id@p ;
