...
position p;
@@
 struct memelfnote {  const char * name ;  int type ;  unsigned int datasz ;  void * data ; } cocci_id@p ;
...
position p;
@@
 const struct user_regset * cocci_id@p ;
...
position p;
@@
 const struct elfhdr * cocci_id@p ;
...
position p;
@@
 struct elf_thread_status cocci_id@p ;
...
typedef u32;
@@
 union {  u32 cmp ;  char elfmag [ SELFMAG ] ; } cocci_id@p ;
...
position p;
@@
 struct elf_note_info * cocci_id@p ;
...
position p;
@@
 struct linux_binfmt cocci_id@p ;
...
position p;
@@
 struct elf_thread_core_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef user_siginfo_t;
@@
 struct elf_note_info {  struct elf_thread_core_info * thread ;  struct memelfnote psinfo ;  struct memelfnote signote ;  struct memelfnote auxv ;  struct memelfnote files ;  user_siginfo_t csigdata ;  size_t size ;  int thread_notes ; } cocci_id@p ;
...
position p;
@@
 struct elf_prpsinfo cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kernel_siginfo_t;
@@
 const kernel_siginfo_t * cocci_id@p ;
...
position p;
@@
 struct elf_thread_core_info {  struct elf_thread_core_info * next ;  struct task_struct * task ;  struct elf_prstatus prstatus ;  struct memelfnote notes [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct elf_prstatus * cocci_id@p ;
...
position p;
@@
 struct task_cputime cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct linux_binprm * bprm ) ;
...
position p;
@@
 int cocci_id@p ( struct coredump_params * cprm ) ;
...
position p;
@@
 const struct user_regset_view * cocci_id@p ;
...
position p;
@@
 struct arch_elf_state { } cocci_id@p ;
...
position p;
@@
 const struct elf_phdr * cocci_id@p ;
...
position p;
@@
 struct coredump_params * cocci_id@p ;
...
position p;
@@
 struct {  struct elfhdr elf_ex ;  struct elfhdr interp_elf_ex ; } * cocci_id@p ;
