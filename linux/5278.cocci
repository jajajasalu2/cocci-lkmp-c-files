...
position p;
@@
 const struct sil_drivelist {  const char * product ;  unsigned int quirk ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct {  unsigned long tf ;  unsigned long ctl ;  unsigned long bmdma ;  unsigned long bmdma2 ;  unsigned long fifo_cfg ;  unsigned long scr ;  unsigned long sien ;  unsigned long xfer_mode ;  unsigned long sfis_cfg ; } cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct ata_link * link , struct ata_device * * r_failed ) ;
