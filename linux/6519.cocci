...
position p;
@@
 struct ufs_qcom_host * cocci_id@p ;
...
position p;
@@
 struct msm_bus_scale_pdata * cocci_id@p ;
...
position p;
@@
 struct ufs_qcom_host * cocci_id@p [ MAX_UFS_QCOM_HOSTS ] ;
...
position p;
@@
 char cocci_id@p [ BUS_VECTOR_NAME_LEN ] ;
...
position p;
@@
 char cocci_id@p [ ANDROID_BOOT_DEV_MAX ] ;
...
position p;
@@
 void cocci_id@p ( struct ufs_qcom_host * host ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct ufs_hba * hba , u32 clk_cycles ) ;
...
position p;
@@
 enum ufs_notify_change_status cocci_id@p ;
...
position p;
@@
 struct ufs_dev_params cocci_id@p ;
...
position p;
@@
 enum { TSTBUS_UAWM , TSTBUS_UARM , TSTBUS_TXUC , TSTBUS_RXUC , TSTBUS_DFC , TSTBUS_TRLUT , TSTBUS_TMRLUT , TSTBUS_OCSC , TSTBUS_UTP_HCI , TSTBUS_COMBINED , TSTBUS_WRAPPER , TSTBUS_UNIPRO , TSTBUS_MAX , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ufs_qcom_host * host , int vote ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ufs_hba * hba , int offset , int num_regs , const char * str , void * priv ) ;
...
position p;
@@
 const struct ufs_hba_variant_ops cocci_id@p ;
