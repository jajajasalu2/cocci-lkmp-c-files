...
position p;
@@
 struct xen_gem_object * cocci_id@p ;
...
typedef bool;
@@
 struct xen_gem_object {  struct drm_gem_object base ;  size_t num_pages ;  struct page * * pages ;  bool be_alloc ;  struct sg_table * sgt_imported ; } cocci_id@p ;
