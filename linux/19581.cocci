...
typedef u32;
@@
 void cocci_id@p ( int cpu , u32 val ) ;
...
position p;
@@
 struct reset_vec_info * cocci_id@p ;
...
typedef u32;
@@
 struct reset_vec_info {  int cpu ;  u32 val ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int cpu , unsigned int action ) ;
