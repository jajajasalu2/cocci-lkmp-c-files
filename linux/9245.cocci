...
typedef bool,u32;
@@
 int cocci_id@p ( struct gve_priv * priv , struct gve_tx_ring * tx , u32 to_do , bool try_to_wake ) ;
...
position p;
@@
 struct gve_tx_iovec cocci_id@p [ 2 ] ;
...
position p;
@@
 struct gve_queue_resources * cocci_id@p ;
...
position p;
@@
 struct gve_tx_buffer_state * cocci_id@p ;
...
position p;
@@
 struct gve_notify_block * cocci_id@p ;
