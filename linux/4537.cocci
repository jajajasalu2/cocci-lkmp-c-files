...
position p;
@@
 struct packet_msg_short cocci_id@p ;
...
position p;
@@
 struct armcp_unmask_irq_arr_packet * cocci_id@p ;
...
position p;
@@
 struct packet_wreg32 cocci_id@p ;
...
position p;
@@
 struct packet_msg_prot cocci_id@p ;
...
position p;
@@
 struct packet_lin_dma cocci_id@p ;
...
position p;
@@
 struct armcp_packet cocci_id@p ;
...
position p;
@@
 struct packet_wreg_bulk cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hl_device * hdev ) ;
...
position p;
@@
 const struct hl_asic_funcs cocci_id@p ;
...
position p;
@@
 enum goya_dma_direction cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ GOYA_MMU_REGS_NUM ] ;
...
position p;
@@
 struct packet_cp_dma cocci_id@p ;
...
position p;
@@
 enum goya_fw_component cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ GOYA_MSIX_ENTRIES ] [ GOYA_MAX_STRING_LEN ] ;
...
typedef u32;
@@
 void cocci_id@p ( struct hl_device * hdev , u32 asid ) ;
...
position p;
@@
 struct packet_msg_long cocci_id@p ;
...
position p;
@@
 struct asic_fixed_properties * cocci_id@p ;
...
position p;
@@
 struct hl_cs_parser * cocci_id@p ;
...
position p;
@@
 struct packet_fence cocci_id@p ;
...
position p;
@@
 enum hl_device_hw_state cocci_id@p ;
