...
position p;
@@
 struct intel_timeline_cacheline * cocci_id@p ;
...
typedef u64;
@@
 struct intel_timeline_hwsp {  struct intel_gt * gt ;  struct intel_gt_timelines * gt_timelines ;  struct list_head free_link ;  struct i915_vma * vma ;  u64 free_bitmap ; } cocci_id@p ;
...
position p;
@@
 struct intel_timeline_hwsp * cocci_id@p ;
