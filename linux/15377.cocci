...
position p;
@@
 struct asm9260_wdt_priv * cocci_id@p ;
...
position p;
@@
 enum asm9260_wdt_mode { HW_RESET , SW_RESET , DEBUG , } cocci_id@p ;
...
position p;
@@
 struct asm9260_wdt_priv {  struct device * dev ;  struct watchdog_device wdd ;  struct clk * clk ;  struct clk * clk_ahb ;  struct reset_control * rst ;  void __iomem * iobase ;  int irq ;  unsigned long wdt_freq ;  enum asm9260_wdt_mode mode ; } cocci_id@p ;
