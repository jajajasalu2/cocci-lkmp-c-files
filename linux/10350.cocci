...
position p;
@@
 const char cocci_id@p [ CMD_SIZE ] ;
...
position p;
@@
 struct gm12u320_device * cocci_id@p ;
...
@@
 struct gm12u320_device {  struct drm_device dev ;  struct drm_simple_display_pipe pipe ;  struct drm_connector conn ;  struct usb_device * udev ;  unsigned char * cmd_buf ;  unsigned char * data_buf [ GM12U320_BLOCK_COUNT ] ;  bool pipe_enabled ;  struct {  bool run ;  struct workqueue_struct * workq ;  struct work_struct work ;  wait_queue_head_t waitq ;  struct mutex lock ;  struct drm_framebuffer * fb ;  struct drm_rect rect ; } fb_update ; } cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ DATA_BLOCK_FOOTER_SIZE ] ;
...
position p;
@@
 const char cocci_id@p [ DATA_BLOCK_HEADER_SIZE ] ;
