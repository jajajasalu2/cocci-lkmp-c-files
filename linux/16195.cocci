...
position p;
@@
 struct pci1710_private * cocci_id@p ;
...
position p;
@@
 struct pci1710_private {  unsigned int max_samples ;  unsigned int ctrl ;  unsigned int ctrl_ext ;  unsigned int mux_scan ;  unsigned char ai_et ;  unsigned int act_chanlist [ 32 ] ;  unsigned char saved_seglen ;  unsigned char da_ranges ;  unsigned char unipolar_gain ; } cocci_id@p ;
...
position p;
@@
 enum pci1710_boardid { BOARD_PCI1710 , BOARD_PCI1710HG , BOARD_PCI1711 , BOARD_PCI1713 , BOARD_PCI1731 , } cocci_id@p ;
...
position p;
@@
 struct boardtype {  const char * name ;  const struct comedi_lrange * ai_range ;  unsigned int is_pci1711 : 1 ;  unsigned int is_pci1713 : 1 ;  unsigned int has_ao : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct boardtype cocci_id@p [ ] ;
