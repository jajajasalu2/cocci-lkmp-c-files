...
position p;
@@
 void cocci_id@p ( struct if_usb_card * cardp ) ;
...
position p;
@@
 struct cmd_ds_set_boot2_ver cocci_id@p ;
...
position p;
@@
 enum { MODEL_UNKNOWN = 0x0 , MODEL_8388 = 0x1 , MODEL_8682 = 0x2 , } cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_fw_wake_method cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct if_usb_card * cardp ) ;
...
position p;
@@
 void cocci_id@p ( struct lbs_private * priv , int ret , const struct firmware * fw , const struct firmware * unused ) ;
...
position p;
@@
 struct fwsyncheader cocci_id@p ;
