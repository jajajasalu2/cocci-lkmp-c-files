...
position p;
@@
 unsigned int cocci_id@p ( struct pci_bus * bus , unsigned int available_buses ) ;
...
position p;
@@
 struct pci_domain_busn_res * cocci_id@p ;
...
position p;
@@
 struct pci_domain_busn_res {  struct list_head list ;  struct resource res ;  int domain_nr ; } cocci_id@p ;
