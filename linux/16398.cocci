...
position p;
@@
 enum led_brightness cocci_id@p [ LG_G15_BRIGHTNESS_MAX ] ;
...
position p;
@@
 enum lg_g15_model { LG_G15 , LG_G15_V2 , LG_G510 , LG_G510_USB_AUDIO , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct lg_g15_data {  u8 transfer_buf [ LG_G15_TRANSFER_BUF_SIZE ] ;  struct mutex mutex ;  struct work_struct work ;  struct input_dev * input ;  struct hid_device * hdev ;  enum lg_g15_model model ;  struct lg_g15_led leds [ LG_G15_LED_MAX ] ;  bool game_mode_enabled ; } cocci_id@p ;
...
position p;
@@
 enum lg_g15_led_type { LG_G15_KBD_BRIGHTNESS , LG_G15_LCD_BRIGHTNESS , LG_G15_BRIGHTNESS_MAX , LG_G15_MACRO_PRESET1 = 2 , LG_G15_MACRO_PRESET2 , LG_G15_MACRO_PRESET3 , LG_G15_MACRO_RECORD , LG_G15_LED_MAX , } cocci_id@p ;
