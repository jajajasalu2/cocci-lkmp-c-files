...
position p;
@@
 struct ad7791_state * cocci_id@p ;
...
position p;
@@
 enum ad7791_chip_info_flags { AD7791_FLAG_HAS_FILTER = ( 1 << 0 ) , AD7791_FLAG_HAS_BUFFER = ( 1 << 1 ) , AD7791_FLAG_HAS_UNIPOLAR = ( 1 << 2 ) , AD7791_FLAG_HAS_BURNOUT = ( 1 << 3 ) , } cocci_id@p ;
...
position p;
@@
 struct ad7791_platform_data * cocci_id@p ;
...
position p;
@@
 enum { AD7787 , AD7788 , AD7789 , AD7790 , AD7791 , } cocci_id@p ;
...
typedef uint8_t;
@@
 struct ad7791_state {  struct ad_sigma_delta sd ;  uint8_t mode ;  uint8_t filter ;  struct regulator * reg ;  const struct ad7791_chip_info * info ; } cocci_id@p ;
...
position p;
@@
 const struct ad7791_chip_info cocci_id@p [ ] ;
...
position p;
@@
 struct ad7791_chip_info {  const struct iio_chan_spec * channels ;  unsigned int num_channels ;  enum ad7791_chip_info_flags flags ; } cocci_id@p ;
