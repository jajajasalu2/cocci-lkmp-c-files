...
typedef spinlock_t;
@@
 struct pcmuio_asic {  spinlock_t pagelock ;  spinlock_t spinlock ;  unsigned int enabled_mask ;  unsigned int active : 1 ; } cocci_id@p ;
...
position p;
@@
 struct pcmuio_private {  struct pcmuio_asic asics [ PCMUIO_MAX_ASICS ] ;  unsigned int irq2 ; } cocci_id@p ;
...
position p;
@@
 const struct pcmuio_board cocci_id@p [ ] ;
...
position p;
@@
 struct pcmuio_board cocci_id@p ;
...
position p;
@@
 struct pcmuio_board {  const char * name ;  const int num_asics ; } cocci_id@p ;
...
position p;
@@
 struct pcmuio_private * cocci_id@p ;
