...
symbol cocci_id;
position p;
typedef siphash_key_t;
@@
 siphash_key_t cocci_id@p ;
...
position p;
@@
 const struct ip_conntrack_stat * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_EXPECT_MAX + 1 ] ;
...
position p;
@@
 const struct nf_conntrack_expect * cocci_id@p ;
...
position p;
@@
 struct nf_conntrack_tuple_hash * cocci_id@p ;
...
position p;
@@
 struct nf_conn_labels * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_PROTO_MAX + 1 ] ;
...
position p;
@@
 struct nf_conn_help * cocci_id@p ;
...
position p;
@@
 const struct nf_conn_tstamp * cocci_id@p ;
...
position p;
@@
 const struct nfnl_callback cocci_id@p [ IPCTNL_MSG_EXP_MAX ] ;
...
position p;
@@
 const union nf_inet_addr cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_TUPLE_MAX + 1 ] ;
...
position p;
@@
 const struct nf_ct_seqadj * cocci_id@p ;
...
position p;
@@
 struct hlist_nulls_node * cocci_id@p ;
...
position p;
@@
 const struct nf_conntrack_zone * cocci_id@p ;
...
position p;
@@
 struct nf_conn_acct * cocci_id@p ;
...
position p;
@@
 struct hlist_nulls_head * cocci_id@p ;
...
position p;
@@
 struct nf_conn_counter * cocci_id@p ;
...
position p;
@@
 enum ip_conntrack_info * cocci_id@p ;
...
position p;
@@
 struct nf_conntrack_helper * cocci_id@p ;
...
position p;
@@
 struct nf_conn_tstamp * cocci_id@p ;
...
position p;
@@
 struct nf_conn_seqadj * cocci_id@p ;
...
position p;
@@
 enum ip_conntrack_dir cocci_id@p ;
...
position p;
@@
 const struct nf_conntrack_l4proto * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_HELP_MAX + 1 ] ;
...
position p;
@@
 struct nf_ct_event_notifier cocci_id@p ;
...
position p;
@@
 const struct nf_conn * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_EXPECT_NAT_MAX + 1 ] ;
...
position p;
@@
 enum ip_conntrack_events cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_SEQADJ_MAX + 1 ] ;
...
position p;
@@
 struct nf_conn_synproxy * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_MAX + 1 ] ;
...
position p;
@@
 struct nfnl_ct_hook cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_IP_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_HELP_MAX + 1 ] ;
...
position p;
@@
 const struct nf_conntrack_tuple * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_SEQADJ_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_SYNPROXY_MAX + 1 ] ;
...
position p;
@@
 struct nf_exp_event_notifier cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_PROTO_MAX + 1 ] ;
...
position p;
@@
 struct nf_conntrack_expect * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_SYNPROXY_MAX + 1 ] ;
...
position p;
@@
 const struct nf_conntrack_tuple_mask * cocci_id@p ;
...
position p;
@@
 struct nf_conntrack_zone * cocci_id@p ;
...
position p;
@@
 struct ctnetlink_filter * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_PROTOINFO_MAX + 1 ] ;
...
position p;
@@
 struct nf_ct_helper_expectfn * cocci_id@p ;
...
position p;
@@
 struct nf_conntrack_expect * cocci_id@p ( const struct nlattr * const cda [ ] , struct nf_conn * ct , struct nf_conntrack_helper * helper , struct nf_conntrack_tuple * tuple , struct nf_conntrack_tuple * mask ) ;
...
position p;
@@
 struct nf_ct_seqadj * cocci_id@p ;
...
position p;
@@
 const struct nf_conn_help * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_IP_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_EXPECT_NAT_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_PROTOINFO_MAX + 1 ] ;
...
position p;
@@
 enum nf_nat_manip_type cocci_id@p ;
...
position p;
@@
 const struct nfnl_callback cocci_id@p [ IPCTNL_MSG_MAX ] ;
...
symbol cocci_id;
position p;
typedef u8,u_int32_t;
@@
 struct ctnetlink_filter {  u8 family ;  struct {  u_int32_t val ;  u_int32_t mask ; } mark ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_TUPLE_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_EXPECT_MAX + 1 ] ;
...
position p;
@@
 struct nf_exp_event * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_MAX + 1 ] ;
