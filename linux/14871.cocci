...
typedef u32;
@@
 struct tegra210_domain_mbist_war {  void ( * handle_lvl2_ovr ) ( struct tegra210_domain_mbist_war * mbist ) ;  const u32 lvl2_offset ;  const u32 lvl2_mask ;  const unsigned int num_clks ;  const unsigned int * clk_init_data ;  struct clk_bulk_data * clks ; } cocci_id@p ;
...
position p;
@@
 struct tegra210_domain_mbist_war * cocci_id@p ;
...
position p;
@@
 struct tegra_clk_pll_freq_table cocci_id@p [ ] ;
...
position p;
@@
 const struct utmi_clk_param cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_audio_clk_info cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_periph_init_data * cocci_id@p ;
...
position p;
@@
 struct tegra_clk_pll_params * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct utmi_clk_param {  u32 osc_frequency ;  u8 enable_delay_count ;  u16 stable_count ;  u8 active_delay_count ;  u16 xtal_freq_count ; } cocci_id@p ;
...
position p;
@@
 struct tegra_clk_pll cocci_id@p ;
...
position p;
@@
 struct tegra_clk_periph cocci_id@p ;
...
position p;
@@
 struct tegra_cpu_car_ops cocci_id@p ;
...
typedef u32;
@@
 struct cpu_clk_suspend_context {  u32 clk_csite_src ; } cocci_id@p ;
...
position p;
@@
 const struct pdiv_map cocci_id@p [ ] ;
