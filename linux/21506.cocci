...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long , unsigned int , struct pt_regs * ) ;
...
position p;
@@
 struct fault_info {  int ( * fn ) ( unsigned long addr , unsigned int esr , struct pt_regs * regs ) ;  int sig ;  int code ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 const struct fault_info cocci_id@p [ ] ;
