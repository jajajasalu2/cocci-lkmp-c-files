...
position p;
@@
 struct smt_sba_alc_req cocci_id@p ;
...
position p;
@@
 struct smt_sba_rep_res cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct s_smc * smc , SMbuf * mb , struct smt_header * sm , int fs ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_header * sm , int sba_cmd ) ;
...
position p;
@@
 int cocci_id@p ( struct s_smc * smc , long int payload , long int overhead ) ;
