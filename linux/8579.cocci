...
position p;
@@
 struct sis900_private cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct net_device * net_dev , u8 revision ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( void __iomem * ioaddr , int location ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * net_dev ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * net_dev , int * speed , int * duplex ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * net_dev , int phy_addr ) ;
...
position p;
@@
 void cocci_id@p ( struct sis900_private * , int speed , int duplex ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * net_dev , int phy_id , int location , int val ) ;
...
typedef u8,u16;
@@
 u16 cocci_id@p ( u8 * addr , u8 revision ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * net_dev , struct ifreq * rq , int cmd ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * net_dev , struct mii_phy * phy ) ;
...
typedef u32;
@@
 struct _BufferDesc {  u32 link ;  u32 cmdsts ;  u32 bufptr ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * net_dev , struct mii_phy * mii_phy ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * net_dev ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct net_device * net_dev , int phy_addr ) ;
...
position p;
@@
 enum { SIS_900 = 0 , SIS_7016 , } cocci_id@p ;
...
typedef netdev_tx_t;
@@
 netdev_tx_t cocci_id@p ( struct sk_buff * skb , struct net_device * net_dev ) ;
...
typedef u8,u16;
@@
 struct mii_phy {  struct mii_phy * next ;  int phy_addr ;  u16 phy_id0 ;  u16 phy_id1 ;  u16 status ;  u8 phy_types ; } cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct net_device * net_dev ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * net_dev , int phy_id , int location ) ;
