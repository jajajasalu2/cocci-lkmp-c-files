...
position p;
@@
 struct tc_action_net cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_TUNNEL_KEY_ENC_OPTS_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_TUNNEL_KEY_ENC_OPT_VXLAN_MAX + 1 ] ;
...
position p;
@@
 struct tc_action_ops cocci_id@p ;
...
position p;
@@
 struct tcf_tunnel_key_params * cocci_id@p ;
...
position p;
@@
 struct tc_tunnel_key * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_TUNNEL_KEY_MAX + 1 ] ;
...
position p;
@@
 const struct tc_action_ops * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_TUNNEL_KEY_MAX + 1 ] ;
...
position p;
@@
 struct tcf_tunnel_key cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_TUNNEL_KEY_ENC_OPT_GENEVE_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_TUNNEL_KEY_ENC_OPT_ERSPAN_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_TUNNEL_KEY_ENC_OPT_VXLAN_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_TUNNEL_KEY_ENC_OPT_ERSPAN_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_TUNNEL_KEY_ENC_OPT_GENEVE_MAX + 1 ] ;
