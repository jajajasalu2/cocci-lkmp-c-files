...
position p;
@@
 struct sitesurvey_ctrl * cocci_id@p ;
...
position p;
@@
 struct smooth_rssi_data * cocci_id@p ;
...
position p;
@@
 struct NDIS_802_11_FIXED_IEs cocci_id@p ;
...
position p;
@@
 struct NDIS_802_11_CONFIGURATION cocci_id@p ;
...
position p;
@@
 struct ADDBA_Req_Report_parm * cocci_id@p ;
...
typedef u8,uint;
@@
 void cocci_id@p ( struct _adapter * padapter , u8 * pie , uint ie_len ) ;
