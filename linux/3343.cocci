...
position p;
@@
 const char cocci_id@p [ ] [ SHT3X_CMD_LENGTH ] ;
...
position p;
@@
 struct sht3x_limit_commands {  const char read_command [ SHT3X_CMD_LENGTH ] ;  const char write_command [ SHT3X_CMD_LENGTH ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SHT3X_RESPONSE_LENGTH ] ;
...
position p;
@@
 const struct sht3x_limit_commands * cocci_id@p ;
...
typedef u8,u32;
@@
 struct sht3x_data {  struct i2c_client * client ;  struct mutex i2c_lock ;  struct mutex data_lock ;  u8 mode ;  const unsigned char * command ;  u32 wait_time ;  unsigned long last_update ;  struct sht3x_platform_data setup ;  int temperature ;  int temperature_limits [ SHT3X_NUM_LIMIT_CMD ] ;  u32 humidity ;  u32 humidity_limits [ SHT3X_NUM_LIMIT_CMD ] ; } cocci_id@p ;
...
position p;
@@
 enum sht3x_chips { sht3x , sts3x , } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ SHT3X_RESPONSE_LENGTH ] ;
...
position p;
@@
 enum sht3x_limits { limit_max = 0 , limit_max_hyst , limit_min , limit_min_hyst , } cocci_id@p ;
...
position p;
@@
 struct sht3x_platform_data * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SHT3X_CMD_LENGTH + SHT3X_WORD_LEN + SHT3X_CRC8_LEN ] ;
...
position p;
@@
 char cocci_id@p [ SHT3X_WORD_LEN + SHT3X_CRC8_LEN ] ;
