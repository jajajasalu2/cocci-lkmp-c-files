...
position p;
@@
 struct cxl_event_afu_error cocci_id@p ;
...
position p;
@@
 struct cxl_event_afu_driver_reserved * cocci_id@p ;
...
position p;
@@
 struct cxl_ioctl_start_work cocci_id@p ;
