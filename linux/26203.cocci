...
position p;
@@
 struct btf_raw_test * cocci_id@p ;
...
position p;
@@
 const struct btf_get_info_test cocci_id@p [ ] ;
...
position p;
@@
 struct btf_file_test cocci_id@p [ ] ;
...
position p;
@@
 const struct prog_info_raw_test * cocci_id@p ;
...
position p;
@@
 struct bpf_btf_info * cocci_id@p ;
...
position p;
@@
 const struct btf_dedup_test cocci_id@p [ ] ;
...
typedef __u32;
@@
 struct btf_get_info_test {  const char * descr ;  const char * str_sec ;  __u32 raw_types [ MAX_NR_RAW_U32 ] ;  __u32 str_sec_size ;  int btf_size_delta ;  int ( * special_test ) ( unsigned int test_num ) ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pprint_mapv_kind_t;
@@
 enum pprint_mapv_kind_t { PPRINT_MAPV_KIND_BASIC = 0 , PPRINT_MAPV_KIND_INT128 , } cocci_id@p ;
...
position p;
@@
 struct btf_dedup_test {  const char * descr ;  struct btf_raw_data input ;  struct btf_raw_data expect ;  struct btf_dedup_opts opts ; } cocci_id@p ;
...
position p;
@@
 const struct btf_raw_test * cocci_id@p ;
...
position p;
@@
 struct bpf_btf_info cocci_id@p [ 2 ] ;
...
position p;
@@
 int cocci_id@p ( unsigned int test_num ) ;
...
symbol cocci_id;
position p;
typedef bool,__u32,pprint_mapv_kind_t;
@@
 struct btf_raw_test {  const char * descr ;  const char * str_sec ;  const char * map_name ;  const char * err_str ;  __u32 raw_types [ MAX_NR_RAW_U32 ] ;  __u32 str_sec_size ;  enum bpf_map_type map_type ;  __u32 key_size ;  __u32 value_size ;  __u32 key_type_id ;  __u32 value_type_id ;  __u32 max_entries ;  bool btf_load_err ;  bool map_create_err ;  bool ordered_map ;  bool lossless_map ;  bool percpu_map ;  int hdr_len_delta ;  int type_off_delta ;  int str_off_delta ;  int str_len_delta ;  enum pprint_mapv_kind_t mapv_kind ; } cocci_id@p ;
...
position p;
@@
 const struct btf_file_test * cocci_id@p ;
...
typedef bool;
@@
 struct args {  unsigned int raw_test_num ;  unsigned int file_test_num ;  unsigned int get_info_test_num ;  unsigned int info_raw_test_num ;  unsigned int dedup_test_num ;  bool raw_test ;  bool file_test ;  bool get_info_test ;  bool pprint_test ;  bool always_log ;  bool info_raw_test ;  bool dedup_test ; } cocci_id@p ;
...
position p;
@@
 struct btf_var_secinfo cocci_id@p ;
...
typedef pprint_mapv_kind_t;
@@
 enum pprint_mapv_kind_t cocci_id@p ;
...
typedef bool;
@@
 struct btf_pprint_test_meta {  const char * descr ;  enum bpf_map_type map_type ;  const char * map_name ;  bool ordered_map ;  bool lossless_map ;  bool percpu_map ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ BTF_LOG_BUF_SIZE ] ;
...
typedef bool;
@@
 struct btf_file_test {  const char * file ;  bool btf_kv_notfound ; } cocci_id@p ;
...
typedef uint64_t;
@@
 struct {  struct bpf_btf_info info ;  uint64_t garbage ; } cocci_id@p ;
...
position p;
@@
 struct pprint_mapv_int128 * cocci_id@p ;
...
position p;
@@
 const struct btf_header * cocci_id@p ;
...
typedef __u32;
@@
 struct btf_raw_data {  __u32 raw_types [ MAX_NR_RAW_U32 ] ;  const char * str_sec ;  __u32 str_sec_size ; } cocci_id@p ;
