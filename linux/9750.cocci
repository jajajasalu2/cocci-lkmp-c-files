...
position p;
@@
 struct iwl_bss_iter_data * cocci_id@p ;
...
position p;
@@
 struct iwl_mac_low_latency_cmd cocci_id@p ;
...
position p;
@@
 enum iwl_mvm_low_latency_cause cocci_id@p ;
...
typedef bool;
@@
 struct iwl_mvm_tcm_iter_data {  struct iwl_mvm * mvm ;  bool any_sent ; } cocci_id@p ;
...
position p;
@@
 struct iwl_sta_iter_data * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ IWL_RATE_COUNT ] ;
...
position p;
@@
 enum iwl_mvm_smps_type_request cocci_id@p ;
...
typedef u8;
@@
 const struct {  const char * name ;  u8 num ; } cocci_id@p [ ] ;
...
typedef bool;
@@
 struct iwl_sta_iter_data {  bool assoc ; } cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_tcm_iter_data * cocci_id@p ;
...
position p;
@@
 struct iwl_scd_txq_cfg_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_error_resp * cocci_id@p ;
...
position p;
@@
 struct iwl_cmd_response * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ NUM_MAC_INDEX_DRIVER ] ;
...
typedef bool;
@@
 struct iwl_bss_iter_data {  struct ieee80211_vif * vif ;  bool error ; } cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_low_latency_iter * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_sta * cocci_id@p ;
...
position p;
@@
 struct iwl_umac_error_event_table cocci_id@p ;
...
position p;
@@
 struct iwl_statistics_cmd cocci_id@p ;
...
typedef bool;
@@
 struct iwl_mvm_low_latency_iter {  bool result ;  bool result_per_band [ NUM_NL80211_BANDS ] ; } cocci_id@p ;
...
position p;
@@
 enum ieee80211_ac_numbers cocci_id@p ;
...
position p;
@@
 struct iwl_error_event_table cocci_id@p ;
