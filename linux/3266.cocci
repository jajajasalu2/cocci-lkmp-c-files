...
position p;
@@
 struct mlxreg_core_platform_data * cocci_id@p ;
...
position p;
@@
 struct mlxreg_core_data * cocci_id@p ;
...
typedef bool,u32;
@@
 struct mlxreg_fan_tacho {  bool connected ;  u32 reg ;  u32 mask ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct mlxreg_fan_pwm {  bool connected ;  u32 reg ; } cocci_id@p ;
...
typedef u8;
@@
 struct mlxreg_fan {  struct device * dev ;  void * regmap ;  struct mlxreg_core_platform_data * pdata ;  struct mlxreg_fan_tacho tacho [ MLXREG_FAN_MAX_TACHO ] ;  struct mlxreg_fan_pwm pwm ;  int samples ;  int divider ;  u8 cooling_levels [ MLXREG_FAN_MAX_STATE + 1 ] ;  struct thermal_cooling_device * cdev ; } cocci_id@p ;
...
position p;
@@
 struct mlxreg_fan_tacho * cocci_id@p ;
