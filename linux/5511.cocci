...
position p;
@@
 const struct chip_desc * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u32,u16,irq_handler_t;
@@
 struct chip_desc {  unsigned alarm : 1 ;  u16 nvram_offset ;  u16 nvram_size ;  u8 offset ;  u8 century_reg ;  u8 century_enable_bit ;  u8 century_bit ;  u8 bbsqi_bit ;  irq_handler_t irq_handler ;  const struct rtc_class_ops * rtc_ops ;  u16 trickle_charger_reg ;  u8 ( * do_trickle_setup ) ( struct ds1307 * , u32 , bool ) ; } cocci_id@p ;
...
position p;
@@
 struct ds1307_platform_data * cocci_id@p ;
...
position p;
@@
 enum { DS3231_CLK_SQW = 0 , DS3231_CLK_32KHZ , } cocci_id@p ;
...
position p;
@@
 const struct chip_desc cocci_id@p [ last_ds_type ] ;
