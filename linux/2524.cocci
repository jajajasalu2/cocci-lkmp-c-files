...
typedef sector_t;
@@
 struct badblock {  struct rb_node node ;  sector_t bb ;  unsigned char wr_fail_cnt ; } cocci_id@p ;
...
@@
 struct dust_device {  struct dm_dev * dev ;  struct rb_root badblocklist ;  unsigned long long badblock_count ;  spinlock_t dust_lock ;  unsigned int blksz ;  int sect_per_block_shift ;  unsigned int sect_per_block ;  sector_t start ;  bool fail_read_on_bb : 1 ;  bool quiet_mode : 1 ; } cocci_id@p ;
