...
position p;
@@
 struct romfs_inode_info * cocci_id@p ;
...
position p;
@@
 struct romfs_super_block * cocci_id@p ;
...
position p;
@@
 struct inode * cocci_id@p ( struct super_block * sb , unsigned long pos ) ;
