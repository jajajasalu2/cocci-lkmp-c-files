...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDefineGBShader body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_user_shader {  struct ttm_base_object base ;  struct vmw_shader shader ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vmw_resource * res , enum vmw_cmdbuf_res_state state ) ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdBindGBShader body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_user_shader * cocci_id@p ;
...
typedef bool,u32;
@@
 bool cocci_id@p ( u32 user_key , SVGA3dShaderType shader_type ) ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDestroyGBShader body ; } * cocci_id@p ;
...
position p;
@@
 enum vmw_cmdbuf_res_state cocci_id@p ;
...
position p;
@@
 struct vmw_dx_shader * cocci_id@p ;
...
typedef bool,u32;
@@
 struct vmw_dx_shader {  struct vmw_resource res ;  struct vmw_resource * ctx ;  struct vmw_resource * cotable ;  u32 id ;  bool committed ;  struct list_head cotable_head ; } cocci_id@p ;
...
@@
 struct vmw_shader {  struct vmw_resource res ;  SVGA3dShaderType type ;  uint32_t size ;  uint8_t num_input_sig ;  uint8_t num_output_sig ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( u32 user_key , SVGA3dShaderType shader_type ) ;
...
position p;
@@
 struct drm_vmw_shader_arg * cocci_id@p ;
...
position p;
@@
 struct vmw_cmdbuf_res_manager * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXBindShader body ; } * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_shader_create_arg * cocci_id@p ;
...
position p;
@@
 enum drm_vmw_shader_type cocci_id@p ;
