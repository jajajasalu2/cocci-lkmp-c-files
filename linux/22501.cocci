...
symbol cocci_id;
position p;
typedef xtalk_coefs_t;
@@
 const xtalk_coefs_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xtalk_dline_t;
@@
 const xtalk_dline_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xtalk_instate_t;
@@
 const xtalk_instate_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xtalk_gains_t;
@@
 const xtalk_gains_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xtalk_state_t;
@@
 const xtalk_state_t cocci_id@p ;
