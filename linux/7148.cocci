...
position p;
@@
 struct mcinfo_logical_cpu * cocci_id@p ;
...
position p;
@@
 struct mcinfo_common * cocci_id@p ;
...
position p;
@@
 struct mcinfo_global * cocci_id@p ;
