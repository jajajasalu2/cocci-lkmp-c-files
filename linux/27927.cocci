...
typedef __u64;
@@
 void ( * cocci_id@p ) ( struct inode * , __u64 , struct buffer_head * , struct buffer_head * ) ;
...
position p;
@@
 struct nilfs_sufile_header cocci_id@p ;
...
position p;
@@
 struct nilfs_suinfo_update * cocci_id@p ;
...
position p;
@@
 struct nilfs_sustat * cocci_id@p ;
...
position p;
@@
 struct nilfs_suinfo * cocci_id@p ;
...
position p;
@@
 struct nilfs_sufile_info * cocci_id@p ;
...
position p;
@@
 struct nilfs_segment_usage * cocci_id@p ;
...
typedef __u64;
@@
 struct nilfs_sufile_info {  struct nilfs_mdt_info mi ;  unsigned long ncleansegs ;  __u64 allocmin ;  __u64 allocmax ; } cocci_id@p ;
