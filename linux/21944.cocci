...
position p;
@@
 const struct gf_poly * cocci_id@p ;
...
position p;
@@
 struct gf_poly_deg1 * cocci_id@p ;
...
position p;
@@
 struct gf_poly {  unsigned int deg ;  unsigned int c [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct gf_poly_deg1 {  struct gf_poly poly ;  unsigned int c [ 2 ] ; } cocci_id@p ;
...
typedef uint32_t;
@@
 const uint32_t * const cocci_id@p ;
