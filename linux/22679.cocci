...
position p;
@@
 struct sound_unit {  int unit_minor ;  const struct file_operations * unit_fops ;  struct sound_unit * next ;  char name [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct sound_unit * cocci_id@p [ SOUND_STEP ] ;
