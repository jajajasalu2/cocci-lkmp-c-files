...
position p;
@@
 const struct nft_cmp_expr * cocci_id@p ;
...
position p;
@@
 const struct nft_cmp_fast_expr * cocci_id@p ;
...
typedef u8;
@@
 struct nft_cmp_expr {  struct nft_data data ;  enum nft_registers sreg : 8 ;  u8 len ;  enum nft_cmp_ops op : 8 ; } cocci_id@p ;
...
position p;
@@
 struct nft_cmp_fast_expr * cocci_id@p ;
...
position p;
@@
 struct nft_cmp_expr cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_CMP_MAX + 1 ] ;
...
position p;
@@
 struct nft_flow_key cocci_id@p ;
