...
position p;
@@
 const struct ss_variant cocci_id@p ;
...
position p;
@@
 struct sun8i_ss_flow cocci_id@p ;
...
position p;
@@
 struct sun8i_cipher_tfm_ctx cocci_id@p ;
...
position p;
@@
 struct sun8i_ss_dev * cocci_id@p ;
...
position p;
@@
 struct sun8i_ss_alg_template cocci_id@p [ ] ;
...
position p;
@@
 struct sun8i_cipher_req_ctx * cocci_id@p ;
