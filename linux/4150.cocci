...
position p;
@@
 struct ufs_qcom_phy_vreg * cocci_id@p ;
...
position p;
@@
 struct ufs_qcom_phy * cocci_id@p ;
...
position p;
@@
 struct ufs_qcom_phy_specific_ops * cocci_id@p ;
...
position p;
@@
 struct ufs_qcom_phy_calibration * cocci_id@p ;
