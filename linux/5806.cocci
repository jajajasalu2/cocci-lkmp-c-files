...
position p;
@@
 enum nmk_gpio_irq_type { NORMAL , WAKE , } cocci_id@p ;
...
position p;
@@
 enum nmk_gpio_irq_type cocci_id@p ;
...
position p;
@@
 const struct prcm_gpiocr_altcx_pin_desc * cocci_id@p ;
...
@@
 struct nmk_gpio_chip {  struct gpio_chip chip ;  struct irq_chip irqchip ;  void __iomem * addr ;  struct clk * clk ;  unsigned int bank ;  void ( * set_ioforce ) ( bool enable ) ;  spinlock_t lock ;  bool sleepmode ;  u32 edge_rising ;  u32 edge_falling ;  u32 real_wake ;  u32 rwimsc ;  u32 fwimsc ;  u32 rimsc ;  u32 fimsc ;  u32 pull_up ;  u32 lowemi ; } cocci_id@p ;
...
position p;
@@
 const struct nmk_cfg_param cocci_id@p [ ] ;
...
position p;
@@
 struct nmk_gpio_chip * cocci_id@p [ NMK_MAX_BANKS ] ;
...
position p;
@@
 unsigned int cocci_id@p [ NUM_BANKS ] ;
...
position p;
@@
 enum nmk_gpio_slpm { NMK_GPIO_SLPM_INPUT , NMK_GPIO_SLPM_WAKEUP_ENABLE = NMK_GPIO_SLPM_INPUT , NMK_GPIO_SLPM_NOCHANGE , NMK_GPIO_SLPM_WAKEUP_DISABLE = NMK_GPIO_SLPM_NOCHANGE , } cocci_id@p ;
...
position p;
@@
 const struct nmk_pingroup * cocci_id@p ;
...
position p;
@@
 struct nmk_gpio_chip * cocci_id@p ;
...
position p;
@@
 struct nmk_pinctrl {  struct device * dev ;  struct pinctrl_dev * pctl ;  const struct nmk_pinctrl_soc_data * soc ;  void __iomem * prcm_base ; } cocci_id@p ;
...
position p;
@@
 enum nmk_gpio_pull { NMK_GPIO_PULL_NONE , NMK_GPIO_PULL_UP , NMK_GPIO_PULL_DOWN , } cocci_id@p ;
...
position p;
@@
 struct nmk_cfg_param {  const char * property ;  unsigned long config ;  const unsigned long * choice ;  int size ; } cocci_id@p ;
