...
position p;
@@
 struct link_init_data cocci_id@p ;
...
position p;
@@
 struct bw_calcs_dceip * cocci_id@p ;
...
position p;
@@
 enum dc_dynamic_expansion cocci_id@p ;
...
position p;
@@
 struct dc_perf_trace cocci_id@p ;
...
position p;
@@
 struct gpio_generic_mux_config * cocci_id@p ;
...
position p;
@@
 struct dc_dsc_config cocci_id@p ;
...
position p;
@@
 enum dc_acpi_cm_power_state cocci_id@p ;
...
position p;
@@
 const enum surface_update_type cocci_id@p ;
...
position p;
@@
 const struct dc_state * cocci_id@p ;
...
position p;
@@
 struct dc_stream_state * cocci_id@p [ MAX_STREAMS ] ;
...
position p;
@@
 struct dc_gamma_entries cocci_id@p ;
...
position p;
@@
 const struct dc_stream_update * cocci_id@p ;
...
position p;
@@
 struct bw_calcs_vbios * cocci_id@p ;
...
position p;
@@
 struct dc_transfer_func_distributed_points cocci_id@p ;
...
position p;
@@
 struct dc_crtc_timing_adjust * cocci_id@p ;
...
position p;
@@
 enum dc_dither_option cocci_id@p ;
...
position p;
@@
 const struct dc_callback_init * cocci_id@p ;
...
position p;
@@
 union surface_update_flags * cocci_id@p ;
...
position p;
@@
 const struct dc_surface_update * cocci_id@p ;
...
position p;
@@
 union stream_update_flags * cocci_id@p ;
...
position p;
@@
 struct pipe_ctx * cocci_id@p [ MAX_PIPES ] ;
