...
@@
 struct hpdi_private {  void __iomem * plx9080_mmio ;  u32 * dio_buffer [ NUM_DMA_BUFFERS ] ;  dma_addr_t dio_buffer_phys_addr [ NUM_DMA_BUFFERS ] ;  struct plx_dma_desc * dma_desc ;  dma_addr_t dma_desc_phys_addr ;  unsigned int num_dma_descriptors ;  u32 * desc_dio_buffer [ NUM_DMA_DESCRIPTORS ] ;  unsigned int dma_desc_index ;  unsigned int tx_fifo_size ;  unsigned int rx_fifo_size ;  unsigned long dio_count ;  unsigned int block_size ; } cocci_id@p ;
...
position p;
@@
 struct hpdi_private * cocci_id@p ;
