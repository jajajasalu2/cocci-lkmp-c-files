...
position p;
@@
 struct ltc2632_chip_info {  const struct iio_chan_spec * channels ;  const int vref_mv ; } cocci_id@p ;
...
position p;
@@
 enum ltc2632_supported_device_ids { ID_LTC2632L12 , ID_LTC2632L10 , ID_LTC2632L8 , ID_LTC2632H12 , ID_LTC2632H10 , ID_LTC2632H8 , } cocci_id@p ;
...
position p;
@@
 struct ltc2632_state * cocci_id@p ;
...
position p;
@@
 const struct ltc2632_chip_info cocci_id@p [ ] ;
...
position p;
@@
 struct ltc2632_state {  struct spi_device * spi_dev ;  unsigned int powerdown_cache_mask ;  int vref_mv ;  struct regulator * vref_reg ; } cocci_id@p ;
...
position p;
@@
 const struct ltc2632_state * cocci_id@p ;
...
position p;
@@
 struct ltc2632_chip_info * cocci_id@p ;
