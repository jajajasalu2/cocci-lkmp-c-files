...
position p;
@@
 enum mspec_page_type { MSPEC_CACHED = 2 , MSPEC_UNCACHED , } cocci_id@p ;
...
@@
 struct vma_data {  refcount_t refcnt ;  spinlock_t lock ;  int count ;  enum mspec_page_type type ;  unsigned long vm_start ;  unsigned long vm_end ;  unsigned long maddr [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 enum mspec_page_type cocci_id@p ;
