...
position p;
@@
 struct bcma_hcd_device cocci_id@p ;
...
position p;
@@
 struct bcma_hcd_device {  struct bcma_device * core ;  struct platform_device * ehci_dev ;  struct platform_device * ohci_dev ;  struct gpio_desc * gpio_desc ; } cocci_id@p ;
...
position p;
@@
 const struct usb_ohci_pdata cocci_id@p ;
...
position p;
@@
 const struct usb_ehci_pdata cocci_id@p ;
