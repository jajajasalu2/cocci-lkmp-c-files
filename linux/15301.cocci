...
position p;
@@
 const struct fsi_device_id * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,uint32_t;
@@
 struct fsi_slave {  struct device dev ;  struct fsi_master * master ;  struct cdev cdev ;  int cdev_idx ;  int id ;  int link ;  u32 cfam_id ;  int chip_id ;  uint32_t size ;  u8 t_send_delay ;  u8 t_echo_delay ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fsi_master * master , int link ) ;
