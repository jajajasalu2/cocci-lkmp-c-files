...
position p;
@@
 struct uwb_rc_cmd_done_params cocci_id@p ;
...
position p;
@@
 struct uwb_rc_cmd_done_params {  struct completion completion ;  struct uwb_rceb * reply ;  ssize_t reply_size ; } cocci_id@p ;
