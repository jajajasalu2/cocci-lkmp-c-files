...
position p;
@@
 struct iwl_per_chain_offset_group * cocci_id@p ;
...
position p;
@@
 struct iwl_sar_profile * cocci_id@p ;
...
position p;
@@
 struct iwl_geo_tx_power_profiles_resp * cocci_id@p ;
...
position p;
@@
 struct iwl_per_chain_offset * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ ACPI_SAR_NUM_CHAIN_LIMITS ] ;
