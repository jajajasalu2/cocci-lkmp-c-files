...
typedef u8,u32,u16;
@@
 struct _coeff_div {  u32 mclk ;  u32 rate ;  u16 fs ;  u8 sr : 5 ;  u8 usb : 1 ; } cocci_id@p ;
...
position p;
@@
 struct wm8988_priv {  struct regmap * regmap ;  unsigned int sysclk ;  const struct snd_pcm_hw_constraint_list * sysclk_constraints ; } cocci_id@p ;
