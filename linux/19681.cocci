...
position p;
@@
 struct plat_cpmac_data cocci_id@p ;
...
position p;
@@
 struct plat_vlynq_data * cocci_id@p ;
...
position p;
@@
 struct plat_vlynq_data {  struct plat_vlynq_ops ops ;  int gpio_bit ;  int reset_bit ; } cocci_id@p ;
