...
position p;
@@
 const struct ich_laptop * cocci_id@p ;
...
position p;
@@
 enum piix_controller_ids { piix_pata_mwdma , piix_pata_33 , ich_pata_33 , ich_pata_66 , ich_pata_100 , ich_pata_100_nomwdma1 , ich5_sata , ich6_sata , ich6m_sata , ich8_sata , ich8_2port_sata , ich8m_apple_sata , tolapai_sata , piix_pata_vmw , ich8_sata_snb , ich8_2port_sata_snb , ich8_2port_sata_byt , } cocci_id@p ;
...
position p;
@@
 const struct piix_map_db * cocci_id@p [ ] ;
...
typedef u16;
@@
 struct ich_laptop {  u16 device ;  u16 subvendor ;  u16 subdevice ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct piix_map_db {  const u32 mask ;  const u16 port_enable ;  const int map [ ] [ 4 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct piix_host_priv {  const int * map ;  u32 saved_iocfg ;  void __iomem * sidpr ; } cocci_id@p ;
...
position p;
@@
 struct ata_port_info cocci_id@p [ 2 ] ;
...
position p;
@@
 struct piix_host_priv * cocci_id@p ;
