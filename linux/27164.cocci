...
position p;
@@
 const struct fscrypt_digested_name * cocci_id@p ;
...
position p;
@@
 const struct fscrypt_str * cocci_id@p ;
...
position p;
@@
 struct fscrypt_digested_name cocci_id@p ;
