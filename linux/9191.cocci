...
position p;
@@
 struct mlxfw_mfa2_file * cocci_id@p ;
...
position p;
@@
 const struct mlxfw_mfa2_tlv_component_descriptor * cocci_id@p ;
...
position p;
@@
 const struct mlxfw_mfa2_file * cocci_id@p ;
...
position p;
@@
 const struct mlxfw_mfa2_tlv_component_ptr * cocci_id@p ;
...
position p;
@@
 struct mlxfw_mfa2_comp_data cocci_id@p ;
...
position p;
@@
 struct mlxfw_mfa2_component * cocci_id@p ;
...
position p;
@@
 const struct mlxfw_mfa2_tlv_package_descriptor * cocci_id@p ;
...
position p;
@@
 const struct mlxfw_mfa2_tlv_psid * cocci_id@p ;
...
position p;
@@
 const struct mlxfw_mfa2_comp_data * cocci_id@p ;
...
position p;
@@
 const struct mlxfw_mfa2_tlv_multi * cocci_id@p ;
...
typedef u8;
@@
 struct mlxfw_mfa2_comp_data {  struct mlxfw_mfa2_component comp ;  u8 buff [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct mlxfw_mfa2_tlv * cocci_id@p ;
