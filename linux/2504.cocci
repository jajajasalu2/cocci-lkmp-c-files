...
@@
 struct dm_integrity_range {  sector_t logical_sector ;  sector_t n_sectors ;  bool waiting ;  union {  struct rb_node node ;  struct {  struct task_struct * task ;  struct list_head wait_entry ; } ; } ; } cocci_id@p ;
...
position p;
@@
 struct journal_sector * cocci_id@p ;
...
typedef atomic_t;
@@
 struct journal_completion {  struct dm_integrity_c * ic ;  atomic_t in_flight ;  struct completion comp ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u8,commit_id_t;
@@
 struct journal_sector {  __u8 entries [ JOURNAL_SECTOR_DATA - JOURNAL_MAC_PER_SECTOR ] ;  __u8 mac [ JOURNAL_MAC_PER_SECTOR ] ;  commit_id_t commit_id ; } cocci_id@p ;
...
position p;
@@
 struct journal_entry * cocci_id@p ;
...
position p;
@@
 struct async_submit_ctl cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dm_target * ti ) ;
...
position p;
@@
 struct dm_integrity_io cocci_id@p ;
...
position p;
@@
 struct journal_io {  struct dm_integrity_range range ;  struct journal_completion * comp ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u32,__u16,__u8,__u64;
@@
 struct superblock {  __u8 magic [ 8 ] ;  __u8 version ;  __u8 log2_interleave_sectors ;  __u16 integrity_tag_size ;  __u32 journal_sections ;  __u64 provided_data_sectors ;  __u32 flags ;  __u8 log2_sectors_per_block ;  __u8 log2_blocks_per_bitmap_bit ;  __u8 pad [ 2 ] ;  __u64 recalc_sector ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ HASH_MAX_DIGESTSIZE ] ;
...
position p;
@@
 struct blk_integrity cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ max ( HASH_MAX_DIGESTSIZE , MAX_TAG_SIZE ) ] ;
...
position p;
@@
 struct journal_completion cocci_id@p ;
...
position p;
@@
 struct dm_integrity_range * cocci_id@p ;
...
position p;
@@
 unsigned cocci_id@p [ N_COMMIT_IDS ] ;
...
typedef sector_t;
@@
 struct journal_node {  struct rb_node node ;  sector_t sector ; } cocci_id@p ;
...
position p;
@@
 struct bitmap_block_status * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u32,__u64,commit_id_t;
@@
 struct journal_entry {  union {  struct {  __u32 sector_lo ;  __u32 sector_hi ; } s ;  __u64 sector ; } u ;  commit_id_t last_bytes [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct dm_integrity_c cocci_id@p ;
...
typedef __u8;
@@
 struct alg_spec {  char * alg_string ;  char * key_string ;  __u8 * key ;  unsigned key_size ; } cocci_id@p ;
...
position p;
@@
 struct journal_node cocci_id@p ;
...
position p;
@@
 struct bio_integrity_payload * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct bitmap_block_status {  struct work_struct work ;  struct dm_integrity_c * ic ;  unsigned idx ;  unsigned long * bitmap ;  struct bio_list bio_queue ;  spinlock_t bio_queue_lock ; } cocci_id@p ;
...
position p;
@@
 const struct blk_integrity_profile cocci_id@p ;
...
position p;
@@
 struct dm_io_request cocci_id@p ;
...
typedef max_t;
@@
 char cocci_id@p [ max_t ( size_t , HASH_MAX_DIGESTSIZE , MAX_TAG_SIZE ) ] ;
...
symbol cocci_id;
position p;
typedef u8,bool,bio_end_io_t,sector_t,atomic_t,blk_status_t;
@@
 struct dm_integrity_io {  struct work_struct work ;  struct dm_integrity_c * ic ;  bool write ;  bool fua ;  struct dm_integrity_range range ;  sector_t metadata_block ;  unsigned metadata_offset ;  atomic_t in_flight ;  blk_status_t bi_status ;  struct completion * completion ;  struct gendisk * orig_bi_disk ;  u8 orig_bi_partno ;  bio_end_io_t * orig_bi_end_io ;  struct bio_integrity_payload * orig_bi_integrity ;  struct bvec_iter orig_bi_iter ; } cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct dm_integrity_io * dio , bool from_map ) ;
