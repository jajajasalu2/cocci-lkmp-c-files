...
position p;
@@
 const struct apple_thermal_info * cocci_id@p ;
...
typedef u8;
@@
 struct apple_thermal_info {  u8 id ;  u8 fan_count ;  u8 thermostat_count ;  u8 unused ; } cocci_id@p ;
...
position p;
@@
 enum chip { ds1775 , adm1030 , } cocci_id@p ;
...
position p;
@@
 struct {  int fan_down_setting ;  int temp ;  int fan_up_setting ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  volatile int running ;  struct task_struct * poll_task ;  struct mutex lock ;  struct platform_device * of_dev ;  struct i2c_client * thermostat ;  struct i2c_client * fan ;  int overheat_temp ;  int overheat_hyst ;  int temp ;  int casetemp ;  int fan_level ;  int downind ;  int upind ;  int r0 , r1 , r20 , r23 , r25 ; } cocci_id@p ;
