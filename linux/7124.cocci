...
typedef u16;
@@
 struct pci_cmd_info {  u16 val ; } cocci_id@p ;
...
typedef u32;
@@
 struct pci_bar_info {  u32 val ;  u32 len_val ;  int which ; } cocci_id@p ;
...
position p;
@@
 struct pci_bar_info * cocci_id@p ;
...
position p;
@@
 const struct pci_cmd_info * cocci_id@p ;
...
position p;
@@
 struct pci_cmd_info * cocci_id@p ;
