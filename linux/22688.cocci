...
position p;
@@
 void cocci_id@p ( struct snd_emux * emu , struct snd_emux_port * port , int cmd , unsigned char * event , int atomic , int hop ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_seq_event * ev , int direct , void * private , int atomic , int hop ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux * emu , struct snd_emux_port * port , int ch , int param , int val , int atomic , int hop ) ;
...
position p;
@@
 struct snd_seq_oss_callback cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_seq_oss_arg * arg , void * closure ) ;
...
position p;
@@
 struct snd_seq_oss_arg * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_seq_oss_arg * arg , int format , const char __user * buf , int offs , int count ) ;
...
position p;
@@
 struct snd_seq_oss_reg cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_seq_oss_arg * arg ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux_port * port , int midi_mode ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_seq_oss_arg * arg , unsigned int cmd , unsigned long ioarg ) ;
