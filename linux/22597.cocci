...
typedef u32;
@@
 u32 cocci_id@p [ MAX_STREAM_BUFFER ] ;
...
typedef u32,u16;
@@
 struct dsp_cmd_info {  u32 dcCodeOp ;  u16 dcCmdLength ;  u16 dcStatusType ;  u16 dcStatusLength ;  char * dcOpName ; } cocci_id@p ;
...
position p;
@@
 enum cmd_mb_opcodes cocci_id@p ;
...
position p;
@@
 struct dsp_cmd_info cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef stream_state_t;
@@
 enum stream_state_t cocci_id@p ;
