...
position p;
@@
 struct neponset_drvdata {  void __iomem * base ;  struct platform_device * sa1111 ;  struct platform_device * smc91x ;  unsigned irq_base ;  struct gpio_chip * gpio [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct neponset_gpio_chip cocci_id@p ;
...
position p;
@@
 struct neponset_drvdata * cocci_id@p ;
