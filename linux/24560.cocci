...
position p;
@@
 struct aarp_entry * cocci_id@p [ AARP_HASH_SIZE ] ;
...
position p;
@@
 struct aarp_entry {  unsigned long last_sent ;  struct sk_buff_head packet_queue ;  int status ;  unsigned long expires_at ;  struct atalk_addr target_addr ;  struct net_device * dev ;  char hwaddr [ ETH_ALEN ] ;  unsigned short xmit_count ;  struct aarp_entry * next ; } cocci_id@p ;
...
position p;
@@
 struct aarp_iter_state * cocci_id@p ;
