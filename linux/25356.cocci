...
position p;
@@
 enum { TEST_CODE_READING_OK , TEST_CODE_READING_NO_VMLINUX , TEST_CODE_READING_NO_KCORE , TEST_CODE_READING_NO_ACCESS , TEST_CODE_READING_NO_KERNEL_OBJ , } cocci_id@p ;
...
typedef u64;
@@
 struct state {  u64 done [ 1024 ] ;  size_t done_cnt ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ BUFSZ ] ;
