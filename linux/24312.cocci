...
typedef __be32;
@@
 struct rxrpc_abort_buffer {  struct rxrpc_wire_header whdr ;  __be32 abort_code ; } cocci_id@p ;
...
position p;
@@
 struct rxrpc_abort_buffer cocci_id@p ;
...
typedef u8;
@@
 struct rxrpc_ack_buffer {  struct rxrpc_wire_header whdr ;  struct rxrpc_ackpacket ack ;  u8 acks [ 255 ] ;  u8 pad [ 3 ] ;  struct rxrpc_ackinfo ackinfo ; } cocci_id@p ;
...
position p;
@@
 struct rxrpc_ack_buffer * cocci_id@p ;
