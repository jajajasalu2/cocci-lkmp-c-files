...
position p;
@@
 struct rfcomm_dev_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rfcomm_dlc * dlc , struct sk_buff * skb ) ;
...
position p;
@@
 struct rfcomm_dev_req cocci_id@p ;
...
position p;
@@
 struct rfcomm_dev_list_req * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct rfcomm_dlc * dlc , u8 v24_sig ) ;
...
position p;
@@
 void cocci_id@p ( struct rfcomm_dlc * dlc , int err ) ;
...
symbol cocci_id;
position p;
typedef u8,bdaddr_t,atomic_t;
@@
 struct rfcomm_dev {  struct tty_port port ;  struct list_head list ;  char name [ 12 ] ;  int id ;  unsigned long flags ;  int err ;  unsigned long status ;  bdaddr_t src ;  bdaddr_t dst ;  u8 channel ;  uint modem_status ;  struct rfcomm_dlc * dlc ;  struct device * tty_dev ;  atomic_t wmem_alloc ;  struct sk_buff_head pending ; } cocci_id@p ;
