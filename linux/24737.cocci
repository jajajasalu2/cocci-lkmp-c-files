...
typedef u64,bool;
@@
 struct nft_dynset {  struct nft_set * set ;  struct nft_set_ext_tmpl tmpl ;  enum nft_dynset_ops op : 8 ;  enum nft_registers sreg_key : 8 ;  enum nft_registers sreg_data : 8 ;  bool invert ;  u64 timeout ;  struct nft_expr * expr ;  struct nft_set_binding binding ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_DYNSET_MAX + 1 ] ;
...
position p;
@@
 const struct nft_dynset * cocci_id@p ;
