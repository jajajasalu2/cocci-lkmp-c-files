...
position p;
@@
 struct mlx5_cmd_prot_block cocci_id@p ;
...
typedef u64,bool;
@@
 void cocci_id@p ( struct mlx5_core_dev * dev , u64 vec , bool forced ) ;
...
position p;
@@
 struct mlx5_cmd_stats * cocci_id@p ;
...
position p;
@@
 struct mlx5_cmd_work_ent cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mlx5_async_cbk_t;
@@
 mlx5_async_cbk_t cocci_id@p ;
...
position p;
@@
 struct cmd_msg_cache * cocci_id@p ;
...
position p;
@@
 struct mlx5_cmd_layout * cocci_id@p ;
...
position p;
@@
 struct mlx5_cmd_debug * cocci_id@p ;
...
position p;
@@
 struct mlx5_cmd_msg * cocci_id@p ;
...
position p;
@@
 struct mlx5_cmd_mailbox * cocci_id@p ;
...
typedef u8;
@@
 struct mlx5_ifc_mbox_out_bits {  u8 status [ 0x8 ] ;  u8 reserved_at_8 [ 0x18 ] ;  u8 syndrome [ 0x20 ] ;  u8 reserved_at_40 [ 0x40 ] ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_async_ctx * cocci_id@p ;
...
position p;
@@
 unsigned cocci_id@p [ MLX5_NUM_COMMAND_CACHES ] ;
...
position p;
@@
 void cocci_id@p ( struct mlx5_core_dev * dev , struct mlx5_cmd_msg * msg ) ;
...
typedef u8;
@@
 struct mlx5_ifc_mbox_in_bits {  u8 opcode [ 0x10 ] ;  u8 uid [ 0x10 ] ;  u8 reserved_at_20 [ 0x10 ] ;  u8 op_mod [ 0x10 ] ;  u8 reserved_at_40 [ 0x40 ] ; } cocci_id@p ;
...
position p;
@@
 enum { CMD_MODE_POLLING , CMD_MODE_EVENTS , } cocci_id@p ;
