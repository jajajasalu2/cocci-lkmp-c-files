...
position p;
@@
 struct mcp23s08_driver_data * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct mcp23s08 {  u8 addr ;  bool irq_active_high ;  bool reg_shift ;  u16 irq_rise ;  u16 irq_fall ;  int irq ;  bool irq_controller ;  int cached_gpio ;  struct mutex lock ;  struct gpio_chip chip ;  struct irq_chip irq_chip ;  struct regmap * regmap ;  struct device * dev ;  struct pinctrl_dev * pctldev ;  struct pinctrl_desc pinctrl_desc ; } cocci_id@p ;
...
position p;
@@
 struct mcp23s08_platform_data * cocci_id@p ;
...
position p;
@@
 struct mcp23s08_driver_data {  unsigned ngpio ;  struct mcp23s08 * mcp [ 8 ] ;  struct mcp23s08 chip [ ] ; } cocci_id@p ;
