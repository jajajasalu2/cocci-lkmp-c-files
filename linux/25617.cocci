...
position p;
@@
 const struct hist_iter_ops cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct perf_hpp_fmt * fmt ) ;
...
position p;
@@
 const struct symbol * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hists * hists , struct hist_entry * he , enum hist_filter type ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct hists * hists , struct hist_entry * he ) ;
...
position p;
@@
 struct callchain_root cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hists * hists , struct hist_entry * he ) ;
...
position p;
@@
 struct events_stats * cocci_id@p ;
...
position p;
@@
 enum hierarchy_move_dir cocci_id@p ;
