...
position p;
@@
 struct mox_kobject {  struct kobject kobj ;  struct mox_rwtm * rwtm ; } cocci_id@p ;
...
position p;
@@
 struct armada_37xx_rwtm_tx_msg cocci_id@p ;
...
position p;
@@
 struct armada_37xx_rwtm_rx_msg * cocci_id@p ;
...
position p;
@@
 enum mbox_cmd { MBOX_CMD_GET_RANDOM = 1 , MBOX_CMD_BOARD_INFO = 2 , MBOX_CMD_ECDSA_PUB_KEY = 3 , MBOX_CMD_HASH = 4 , MBOX_CMD_SIGN = 5 , MBOX_CMD_VERIFY = 6 , MBOX_CMD_OTP_READ = 7 , MBOX_CMD_OTP_WRITE = 8 , } cocci_id@p ;
