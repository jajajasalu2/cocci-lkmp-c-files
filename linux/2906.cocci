...
position p;
@@
 struct acpi_thread_state cocci_id@p ;
...
position p;
@@
 struct acpi_object_device cocci_id@p ;
...
position p;
@@
 struct acpi_update_state cocci_id@p ;
...
position p;
@@
 struct acpi_object_buffer_field cocci_id@p ;
...
position p;
@@
 struct acpi_object_thermal_zone cocci_id@p ;
...
position p;
@@
 struct acpi_object_method cocci_id@p ;
...
position p;
@@
 struct acpi_notify_info cocci_id@p ;
...
position p;
@@
 struct acpi_parse_obj_named cocci_id@p ;
...
position p;
@@
 struct acpi_object_reference cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( union acpi_operand_object * obj_desc ) ;
...
position p;
@@
 union acpi_operand_object * cocci_id@p ;
...
position p;
@@
 union acpi_parse_object cocci_id@p ;
...
position p;
@@
 struct acpi_object_notify_handler cocci_id@p ;
...
position p;
@@
 struct acpi_object_data cocci_id@p ;
...
position p;
@@
 struct acpi_common_state cocci_id@p ;
...
position p;
@@
 struct acpi_parse_obj_asl cocci_id@p ;
...
position p;
@@
 struct acpi_object_string cocci_id@p ;
...
position p;
@@
 struct acpi_parse_obj_common cocci_id@p ;
...
position p;
@@
 struct acpi_memory_list * cocci_id@p ;
...
position p;
@@
 struct acpi_object_processor cocci_id@p ;
...
position p;
@@
 struct acpi_object_package cocci_id@p ;
...
position p;
@@
 struct acpi_object_buffer cocci_id@p ;
...
position p;
@@
 struct acpi_namespace_node cocci_id@p ;
...
position p;
@@
 struct acpi_db_argument_info cocci_id@p [ ] ;
...
position p;
@@
 struct acpi_scope_state cocci_id@p ;
...
symbol cocci_id;
position p;
typedef acpi_status,u32,acpi_handle;
@@
 acpi_status cocci_id@p ( acpi_handle obj_handle , u32 nesting_level , void * context , void * * return_value ) ;
...
position p;
@@
 struct acpi_object_power_resource cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct acpi_memory_list * list ) ;
...
position p;
@@
 struct acpi_pkg_state cocci_id@p ;
...
position p;
@@
 struct acpi_object_index_field cocci_id@p ;
...
position p;
@@
 struct acpi_object_region cocci_id@p ;
...
position p;
@@
 struct acpi_object_region_field cocci_id@p ;
...
position p;
@@
 struct acpi_object_event cocci_id@p ;
...
position p;
@@
 struct acpi_control_state cocci_id@p ;
...
position p;
@@
 struct acpi_object_addr_handler cocci_id@p ;
...
position p;
@@
 struct acpi_object_integer cocci_id@p ;
...
position p;
@@
 struct acpi_object_common cocci_id@p ;
...
position p;
@@
 struct acpi_object_mutex cocci_id@p ;
...
position p;
@@
 struct acpi_object_extra cocci_id@p ;
...
position p;
@@
 struct acpi_result_values cocci_id@p ;
...
position p;
@@
 struct acpi_pscope_state cocci_id@p ;
...
position p;
@@
 union acpi_generic_state cocci_id@p ;
...
position p;
@@
 struct acpi_object_bank_field cocci_id@p ;
