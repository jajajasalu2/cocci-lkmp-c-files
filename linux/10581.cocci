...
position p;
@@
 struct ct_incoming_request cocci_id@p ;
...
position p;
@@
 struct intel_guc_ct_buffer * cocci_id@p ;
...
typedef u32;
@@
 struct ct_request {  struct list_head link ;  u32 fence ;  u32 status ;  u32 response_len ;  u32 * response_buf ; } cocci_id@p ;
...
position p;
@@
 struct intel_guc_ct * cocci_id@p ;
...
position p;
@@
 struct guc_ct_buffer_desc cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ GUC_CT_MSG_LEN_MASK + 1 ] ;
...
position p;
@@
 enum { CTB_SEND = 0 , CTB_RECV = 1 , } cocci_id@p ;
...
typedef u32;
@@
 struct ct_incoming_request {  struct list_head link ;  u32 msg [ ] ; } cocci_id@p ;
...
position p;
@@
 struct intel_guc_ct_channel * cocci_id@p ;
...
position p;
@@
 enum { CTB_OWNER_HOST = 0 , } cocci_id@p ;
