...
typedef bool;
@@
 struct moxart_chan {  struct virt_dma_chan vc ;  void __iomem * base ;  struct moxart_desc * desc ;  struct dma_slave_config cfg ;  bool allocated ;  bool error ;  int ch_num ;  unsigned int line_reqno ;  unsigned int sgidx ; } cocci_id@p ;
...
@@
 struct moxart_sg {  dma_addr_t addr ;  uint32_t len ; } cocci_id@p ;
...
position p;
@@
 struct moxart_dmadev {  struct dma_device dma_slave ;  struct moxart_chan slave_chans [ APB_DMA_MAX_CHANNEL ] ;  unsigned int irq ; } cocci_id@p ;
...
position p;
@@
 struct moxart_dmadev * cocci_id@p ;
...
@@
 struct moxart_desc {  enum dma_transfer_direction dma_dir ;  dma_addr_t dev_addr ;  unsigned int sglen ;  unsigned int dma_cycles ;  struct virt_dma_desc vd ;  uint8_t es ;  struct moxart_sg sg [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct moxart_filter_data {  struct moxart_dmadev * mdc ;  struct of_phandle_args * dma_spec ; } cocci_id@p ;
