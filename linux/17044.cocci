...
position p;
@@
 struct a3d {  struct gameport * gameport ;  struct gameport * adc ;  struct input_dev * dev ;  int axes [ 4 ] ;  int buttons ;  int mode ;  int length ;  int reads ;  int bads ;  char phys [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ A3D_MAX_LENGTH ] ;
