...
position p;
@@
 const struct samsung_keypad_platdata * cocci_id@p ;
...
position p;
@@
 enum samsung_keypad_type { KEYPAD_TYPE_SAMSUNG , KEYPAD_TYPE_S5PV210 , } cocci_id@p ;
...
position p;
@@
 struct samsung_keypad * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ SAMSUNG_MAX_COLS ] ;
...
@@
 struct samsung_keypad {  struct input_dev * input_dev ;  struct platform_device * pdev ;  struct clk * clk ;  void __iomem * base ;  wait_queue_head_t wait ;  bool stopped ;  bool wake_enabled ;  int irq ;  enum samsung_keypad_type type ;  unsigned int row_shift ;  unsigned int rows ;  unsigned int cols ;  unsigned int row_state [ SAMSUNG_MAX_COLS ] ;  unsigned short keycodes [ ] ; } cocci_id@p ;
