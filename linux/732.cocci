...
typedef u8;
@@
 struct ev_hrt_ctrl {  u8 bus ;  u8 device ;  u8 function ;  u8 mem_avail ;  u8 p_mem_avail ;  u8 io_avail ;  u8 bus_avail ;  u8 next ; } cocci_id@p ;
...
typedef u8;
@@
 struct ev_hrt_header {  u8 Version ;  u8 num_of_ctrl ;  u8 next ; } cocci_id@p ;
...
position p;
@@
 struct ev_hrt_header * cocci_id@p ;
