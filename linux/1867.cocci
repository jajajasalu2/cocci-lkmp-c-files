...
position p;
@@
 enum ad7768_pwrmode { AD7768_ECO_MODE = 0 , AD7768_MED_MODE = 2 , AD7768_FAST_MODE = 3 , } cocci_id@p ;
...
position p;
@@
 enum ad7768_conv_mode cocci_id@p ;
...
position p;
@@
 enum ad7768_conv_mode { AD7768_CONTINUOUS , AD7768_ONE_SHOT , AD7768_SINGLE , AD7768_PERIODIC , AD7768_STANDBY , } cocci_id@p ;
...
typedef u8,__be32;
@@
 struct ad7768_state {  struct spi_device * spi ;  struct regulator * vref ;  struct mutex lock ;  struct clk * mclk ;  unsigned int mclk_freq ;  unsigned int samp_freq ;  struct completion completion ;  struct iio_trigger * trig ;  struct gpio_desc * gpio_sync_in ;  union {  __be32 d32 ;  u8 d8 [ 2 ] ; } data ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ad7768_clk_configuration {  enum ad7768_mclk_div mclk_div ;  enum ad7768_dec_rate dec_rate ;  unsigned int clk_div ;  enum ad7768_pwrmode pwrmode ; } cocci_id@p ;
...
position p;
@@
 struct ad7768_state * cocci_id@p ;
...
position p;
@@
 enum ad7768_dec_rate { AD7768_DEC_RATE_32 = 0 , AD7768_DEC_RATE_64 = 1 , AD7768_DEC_RATE_128 = 2 , AD7768_DEC_RATE_256 = 3 , AD7768_DEC_RATE_512 = 4 , AD7768_DEC_RATE_1024 = 5 , AD7768_DEC_RATE_8 = 9 , AD7768_DEC_RATE_16 = 10 , } cocci_id@p ;
...
position p;
@@
 enum ad7768_dec_rate cocci_id@p ;
...
position p;
@@
 enum ad7768_mclk_div { AD7768_MCLK_DIV_16 , AD7768_MCLK_DIV_8 , AD7768_MCLK_DIV_4 , AD7768_MCLK_DIV_2 , } cocci_id@p ;
...
position p;
@@
 const struct ad7768_clk_configuration cocci_id@p [ ] ;
