...
position p;
@@
 struct sst_ipc_message cocci_id@p ;
...
position p;
@@
 struct sst_generic_ipc * cocci_id@p ;
...
position p;
@@
 struct sst_byt_tstamp cocci_id@p ;
...
@@
 struct sst_byt {  struct device * dev ;  struct sst_dsp * dsp ;  struct list_head stream_list ;  wait_queue_head_t boot_wait ;  bool boot_complete ;  struct sst_fw * fw ;  struct sst_generic_ipc ipc ; } cocci_id@p ;
...
position p;
@@
 struct sst_byt_start_stream_params cocci_id@p ;
...
typedef u32;
@@
 u32 ( * cocci_id@p ) ( struct sst_byt_stream * stream , void * data ) ;
...
position p;
@@
 struct sst_byt_stream * cocci_id@p ;
...
typedef bool,u32;
@@
 struct sst_byt_stream {  struct list_head node ;  struct sst_byt_alloc_params request ;  struct sst_byt_alloc_response reply ;  struct sst_byt * byt ;  int str_id ;  bool commited ;  bool running ;  u32 ( * notify_position ) ( struct sst_byt_stream * stream , void * data ) ;  void * pdata ; } cocci_id@p ;
...
position p;
@@
 struct sst_dsp_device cocci_id@p ;
...
position p;
@@
 struct sst_byt_fw_init cocci_id@p ;
