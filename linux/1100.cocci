...
position p;
@@
 const struct cpu_id * cocci_id@p ;
...
typedef __u8;
@@
 struct cpu_id {  __u8 x86 ;  __u8 x86_model ;  __u8 x86_stepping ; } cocci_id@p ;
...
position p;
@@
 struct cpu_model {  const struct cpu_id * cpu_id ;  const char * model_name ;  unsigned max_freq ;  struct cpufreq_frequency_table * op_points ; } cocci_id@p ;
...
position p;
@@
 const struct cpuinfo_x86 * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct cpuinfo_x86 * c , const struct cpu_id * x ) ;
...
position p;
@@
 enum { CPU_BANIAS , CPU_DOTHAN_A1 , CPU_DOTHAN_A2 , CPU_DOTHAN_B0 , CPU_MP4HT_D0 , CPU_MP4HT_E0 , } cocci_id@p ;
