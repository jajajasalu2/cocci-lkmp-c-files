...
position p;
@@
 enum { MLX5_EVENT_MODE_DISABLE = 0x0 , MLX5_EVENT_MODE_REPETETIVE = 0x1 , MLX5_EVENT_MODE_ONCE_TILL_ARM = 0x2 , } cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_clock_info * cocci_id@p ;
...
position p;
@@
 enum { MLX5_CYCLES_SHIFT = 23 , } cocci_id@p ;
...
position p;
@@
 enum { MLX5_PIN_MODE_IN = 0x0 , MLX5_PIN_MODE_OUT = 0x1 , } cocci_id@p ;
...
position p;
@@
 enum { MLX5_MTPPS_FS_ENABLE = BIT ( 0x0 ) , MLX5_MTPPS_FS_PATTERN = BIT ( 0x2 ) , MLX5_MTPPS_FS_PIN_MODE = BIT ( 0x3 ) , MLX5_MTPPS_FS_TIME_STAMP = BIT ( 0x4 ) , MLX5_MTPPS_FS_OUT_PULSE_DURATION = BIT ( 0x5 ) , MLX5_MTPPS_FS_ENH_OUT_PER_ADJ = BIT ( 0x7 ) , } cocci_id@p ;
...
position p;
@@
 enum { MLX5_OUT_PATTERN_PULSE = 0x0 , MLX5_OUT_PATTERN_PERIODIC = 0x1 , } cocci_id@p ;
