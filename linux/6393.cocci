...
position p;
@@
 struct tps65086_regulator cocci_id@p [ ] ;
...
position p;
@@
 enum tps65086_regulators { BUCK1 , BUCK2 , BUCK3 , BUCK4 , BUCK5 , BUCK6 , LDOA1 , LDOA2 , LDOA3 , SWA1 , SWB1 , SWB2 , VTT , } cocci_id@p ;
...
position p;
@@
 struct tps65086_regulator {  struct regulator_desc desc ;  unsigned int decay_reg ;  unsigned int decay_mask ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct device_node * dev , const struct regulator_desc * desc , struct regulator_config * config ) ;
