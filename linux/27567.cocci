...
position p;
@@
 struct btrfs_async_commit {  struct btrfs_trans_handle * newtrans ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 enum btrfs_reserve_flush_enum cocci_id@p ;
...
position p;
@@
 struct btrfs_async_commit cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ TRANS_STATE_MAX ] ;
