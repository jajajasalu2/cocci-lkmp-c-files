...
position p;
@@
 struct sts_entry_fx00 * cocci_id@p ;
...
position p;
@@
 struct qlafx00_tgt_node_info * cocci_id@p ;
...
position p;
@@
 struct ioctl_iocb_entry_fx00 * cocci_id@p ;
...
position p;
@@
 struct multi_sts_entry_fx00 * cocci_id@p ;
...
position p;
@@
 struct qla_mt_iocb_rqst_fx00 * cocci_id@p ;
...
position p;
@@
 struct tsk_mgmt_entry_fx00 * cocci_id@p ;
...
position p;
@@
 struct config_info_data * cocci_id@p ;
...
position p;
@@
 struct abort_iocb_entry_fx00 * cocci_id@p ;
...
position p;
@@
 struct register_host_info * cocci_id@p ;
...
position p;
@@
 struct host_system_info * cocci_id@p ;
...
position p;
@@
 struct qla_mt_iocb_rsp_fx00 cocci_id@p ;
...
position p;
@@
 struct port_info_data * cocci_id@p ;
