...
position p;
@@
 struct init_table cocci_id@p [ 4 ] [ 22 ] ;
...
typedef u32;
@@
 struct init_table {  u32 addr ;  u32 data ; } cocci_id@p ;
...
position p;
@@
 struct cmac_statistics cocci_id@p ;
...
position p;
@@
 const struct cmac_ops cocci_id@p ;
...
typedef u32;
@@
 struct _cmac_instance {  u32 index ;  u32 ticks ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned int reg ;  unsigned int offset ; } cocci_id@p [ ] ;
