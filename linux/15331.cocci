...
position p;
@@
 struct armada_37xx_watchdog cocci_id@p ;
...
typedef u64;
@@
 struct armada_37xx_watchdog {  struct watchdog_device wdt ;  struct regmap * cpu_misc ;  void __iomem * reg ;  u64 timeout ;  unsigned long clk_rate ;  struct clk * clk ; } cocci_id@p ;
