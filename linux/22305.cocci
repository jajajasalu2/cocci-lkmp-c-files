...
position p;
@@
 const struct tomoyo_transition_control * cocci_id@p ;
...
position p;
@@
 const enum tomoyo_transition_type cocci_id@p ;
...
position p;
@@
 struct tomoyo_page_dump cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct tomoyo_acl_info * , const struct tomoyo_acl_info * ) ;
...
position p;
@@
 const struct list_head * const cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct tomoyo_acl_head * , const struct tomoyo_acl_head * ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct tomoyo_acl_info * , struct tomoyo_acl_info * , const bool ) ;
...
position p;
@@
 const struct tomoyo_aggregator * cocci_id@p ;
...
position p;
@@
 struct tomoyo_execve * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct tomoyo_request_info * , const struct tomoyo_acl_info * ) ;
...
position p;
@@
 const struct tomoyo_domain_info * cocci_id@p ;
...
position p;
@@
 enum tomoyo_transition_type cocci_id@p ;
