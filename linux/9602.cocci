...
position p;
@@
 struct brcmf_p2p_scan_le * cocci_id@p ;
...
typedef u8;
@@
 struct brcmf_p2psd_gas_pub_act_frame {  u8 category ;  u8 action ;  u8 dialog_token ;  u8 query_data [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_p2p_pub_act_frame cocci_id@p ;
...
typedef u8;
@@
 struct brcmf_p2p_pub_act_frame {  u8 category ;  u8 action ;  u8 oui [ 3 ] ;  u8 oui_type ;  u8 subtype ;  u8 dialog_token ;  u8 elts [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_p2p_action_frame cocci_id@p ;
...
position p;
@@
 struct brcmf_fil_p2p_if_le cocci_id@p ;
...
position p;
@@
 struct brcmf_p2p_info cocci_id@p ;
...
position p;
@@
 enum brcmf_fil_p2p_if_types cocci_id@p ;
...
position p;
@@
 struct brcmf_config_af_params * cocci_id@p ;
...
position p;
@@
 struct brcmf_p2psd_gas_pub_act_frame cocci_id@p ;
...
position p;
@@
 enum brcmf_p2p_disc_state { WL_P2P_DISC_ST_SCAN , WL_P2P_DISC_ST_LISTEN , WL_P2P_DISC_ST_SEARCH , } cocci_id@p ;
...
typedef u8;
@@
 struct brcmf_p2p_action_frame {  u8 category ;  u8 oui [ 3 ] ;  u8 type ;  u8 subtype ;  u8 dialog_token ;  u8 elts [ 1 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct brcmf_p2p_scan_le {  u8 type ;  u8 reserved [ 3 ] ;  union {  struct brcmf_escan_params_le eparams ;  struct brcmf_scan_params_le sparams ; } ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_rx_mgmt_data cocci_id@p ;
...
typedef u8;
@@
 struct brcmf_p2p_disc_st_le {  u8 state ;  __le16 chspec ;  __le16 dwell ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_p2p_disc_st_le cocci_id@p ;
...
typedef bool,s32;
@@
 struct brcmf_config_af_params {  s32 mpc_onoff ;  bool search_channel ;  bool extra_listen ; } cocci_id@p ;
