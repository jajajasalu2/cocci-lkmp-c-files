...
position p;
@@
 struct hcall_stats {  unsigned long num_calls ;  unsigned long tb_total ;  unsigned long purr_total ;  unsigned long tb_start ;  unsigned long purr_start ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CPU_NAME_BUF_SIZE ] ;
