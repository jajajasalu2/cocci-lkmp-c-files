...
position p;
@@
 struct matrox_fb_info * cocci_id@p ;
...
position p;
@@
 const struct maven_data * cocci_id@p ;
...
position p;
@@
 const struct matrox_pll_features2 cocci_id@p ;
...
position p;
@@
 struct mctl {  struct v4l2_queryctrl desc ;  size_t control ; } cocci_id@p ;
...
position p;
@@
 struct matrox_pll_features2 {  unsigned int vco_freq_min ;  unsigned int vco_freq_max ;  unsigned int feed_div_min ;  unsigned int feed_div_max ;  unsigned int in_div_min ;  unsigned int in_div_max ;  unsigned int post_shift_max ; } cocci_id@p ;
...
position p;
@@
 struct matrox_pll_ctl {  unsigned int ref_freq ;  unsigned int den ; } cocci_id@p ;
...
position p;
@@
 const struct maven_gamma * cocci_id@p ;
...
position p;
@@
 const struct matrox_pll_features cocci_id@p ;
...
position p;
@@
 const struct matrox_pll_ctl * cocci_id@p ;
...
position p;
@@
 struct maven_data {  struct matrox_fb_info * primary_head ;  struct i2c_client * client ;  int version ; } cocci_id@p ;
...
position p;
@@
 struct matrox_altout cocci_id@p ;
...
position p;
@@
 struct i2c_bit_adapter cocci_id@p ;
...
position p;
@@
 const struct mavenregs * cocci_id@p ;
...
position p;
@@
 const struct maven_gamma {  unsigned char reg83 ;  unsigned char reg84 ;  unsigned char reg85 ;  unsigned char reg86 ;  unsigned char reg87 ;  unsigned char reg88 ;  unsigned char reg89 ;  unsigned char reg8a ;  unsigned char reg8b ; } cocci_id@p [ ] ;
