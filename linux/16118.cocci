...
position p;
@@
 struct comedi_krange * cocci_id@p ;
...
position p;
@@
 struct comedi_lrange * cocci_id@p ;
...
position p;
@@
 struct das16_private_struct * cocci_id@p ;
...
position p;
@@
 struct das16_private_struct {  struct comedi_isadma * dma ;  struct comedi_device * dev ;  unsigned int clockbase ;  unsigned int ctrl_reg ;  unsigned int divisor1 ;  unsigned int divisor2 ;  struct timer_list timer ;  unsigned long extra_iobase ;  unsigned int can_burst : 1 ;  unsigned int timer_running : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct das16_board cocci_id@p [ ] ;
...
position p;
@@
 enum { das16_pg_none = 0 , das16_pg_16jr , das16_pg_16jr_16 , das16_pg_1601 , das16_pg_1602 , } cocci_id@p ;
...
position p;
@@
 struct das16_board {  const char * name ;  unsigned int ai_maxdata ;  unsigned int ai_speed ;  unsigned int ai_pg ;  unsigned int has_ao : 1 ;  unsigned int has_8255 : 1 ;  unsigned int i8255_offset ;  unsigned int size ;  unsigned int id ; } cocci_id@p ;
