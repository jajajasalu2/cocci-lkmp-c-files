...
position p;
@@
 struct section_perm cocci_id@p [ ] ;
...
typedef pmdval_t;
@@
 struct section_perm {  const char * name ;  unsigned long start ;  unsigned long end ;  pmdval_t mask ;  pmdval_t prot ;  pmdval_t clear ; } cocci_id@p ;
