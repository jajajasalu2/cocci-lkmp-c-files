...
position p;
@@
 const struct hiface_vendor_quirk * cocci_id@p ;
...
position p;
@@
 struct hiface_vendor_quirk * cocci_id@p ;
...
typedef u8;
@@
 struct hiface_vendor_quirk {  const char * device_name ;  u8 extra_freq ; } cocci_id@p ;
