...
position p;
@@
 struct pch_gbe_adapter cocci_id@p ;
...
position p;
@@
 struct pch_gbe_hw_stats * cocci_id@p ;
...
position p;
@@
 struct pch_gbe_tx_ring * cocci_id@p ;
...
position p;
@@
 struct pch_gbe_privdata * cocci_id@p ;
...
position p;
@@
 struct pch_gbe_buffer cocci_id@p ;
...
position p;
@@
 struct pch_gbe_rx_desc * cocci_id@p ;
...
position p;
@@
 struct pch_gbe_rx_ring * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * netdev , int addr , int reg , int data ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * netdev , int addr , int reg ) ;
...
position p;
@@
 struct pch_gbe_tx_desc cocci_id@p ;
...
position p;
@@
 struct pch_gbe_mac_info * cocci_id@p ;
