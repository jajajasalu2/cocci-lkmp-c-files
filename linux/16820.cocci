...
position p;
@@
 struct gp2a_data {  struct input_dev * input ;  const struct gp2a_platform_data * pdata ;  struct i2c_client * i2c_client ; } cocci_id@p ;
...
position p;
@@
 enum gp2a_controls { GP2A_CTRL_SSD = 0x01 , } cocci_id@p ;
...
position p;
@@
 const struct gp2a_platform_data * cocci_id@p ;
...
position p;
@@
 enum gp2a_addr { GP2A_ADDR_PROX = 0x0 , GP2A_ADDR_GAIN = 0x1 , GP2A_ADDR_HYS = 0x2 , GP2A_ADDR_CYCLE = 0x3 , GP2A_ADDR_OPMOD = 0x4 , GP2A_ADDR_CON = 0x6 , } cocci_id@p ;
