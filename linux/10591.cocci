...
position p;
@@
 struct intel_rps_ei cocci_id@p ;
...
typedef u16;
@@
 const struct cparams {  u16 i ;  u16 t ;  u16 m ;  u16 c ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct intel_rps_ei * cocci_id@p ;
