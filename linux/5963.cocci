...
position p;
@@
 struct pcs_conf_vals cocci_id@p ;
...
position p;
@@
 struct pcs_conf_vals {  enum pin_config_param param ;  unsigned val ;  unsigned enable ;  unsigned disable ;  unsigned mask ; } cocci_id@p ;
...
position p;
@@
 const struct pcs_soc_data cocci_id@p ;
...
position p;
@@
 const struct pinctrl_setting_mux * cocci_id@p ;
...
position p;
@@
 struct pcs_func_vals {  void __iomem * reg ;  unsigned val ;  unsigned mask ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pinctrl_dev * pctldev , struct device_node * np_config , struct pinctrl_map * * map , unsigned * num_maps ) ;
...
position p;
@@
 struct pcs_gpiofunc_range cocci_id@p ;
...
position p;
@@
 struct pcs_data {  struct pinctrl_pin_desc * pa ;  int cur ; } cocci_id@p ;
...
position p;
@@
 struct function_desc * cocci_id@p ;
...
position p;
@@
 struct pcs_func_vals * cocci_id@p ;
...
position p;
@@
 struct pcs_conf_type {  const char * name ;  enum pin_config_param param ; } cocci_id@p ;
...
position p;
@@
 struct pcs_function * cocci_id@p ;
...
position p;
@@
 struct pcs_gpiofunc_range {  unsigned offset ;  unsigned npins ;  unsigned gpiofunc ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 const struct pcs_conf_type cocci_id@p [ ] ;
...
position p;
@@
 struct pcs_function {  const char * name ;  struct pcs_func_vals * vals ;  unsigned nvals ;  const char * * pgnames ;  int npgnames ;  struct pcs_conf_vals * conf ;  int nconfs ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct pcs_interrupt * cocci_id@p ;
...
position p;
@@
 struct pcs_soc_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pinctrl_dev * pctldev , unsigned pin , unsigned long * configs , unsigned num_configs ) ;
...
typedef irq_hw_number_t;
@@
 struct pcs_interrupt {  void __iomem * reg ;  irq_hw_number_t hwirq ;  unsigned int irq ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pinctrl_dev * pctldev , unsigned pin , unsigned long * config ) ;
...
position p;
@@
 struct pcs_soc_data {  unsigned flags ;  int irq ;  unsigned irq_enable_mask ;  unsigned irq_status_mask ;  void ( * rearm ) ( void ) ; } cocci_id@p ;
