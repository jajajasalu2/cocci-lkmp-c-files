...
position p;
@@
 const struct ag71xx_dcfg * cocci_id@p ;
...
position p;
@@
 void * ( * cocci_id@p ) ( unsigned int size ) ;
...
symbol cocci_id;
position p;
typedef u8,u32,u16,phy_interface_t,dma_addr_t;
@@
 struct ag71xx {  struct ag71xx_ring rx_ring ____cacheline_aligned ;  struct ag71xx_ring tx_ring ____cacheline_aligned ;  u16 rx_buf_size ;  u8 rx_buf_offset ;  struct net_device * ndev ;  struct platform_device * pdev ;  struct napi_struct napi ;  u32 msg_enable ;  const struct ag71xx_dcfg * dcfg ;  void __iomem * mac_base ;  struct ag71xx_desc * stop_desc ;  dma_addr_t stop_desc_dma ;  phy_interface_t phy_if_mode ;  struct delayed_work restart_work ;  struct timer_list oom_timer ;  struct reset_control * mac_reset ;  u32 fifodata [ 3 ] ;  int mac_idx ;  struct reset_control * mdio_reset ;  struct mii_bus * mii_bus ;  struct clk * clk_mdio ;  struct clk * clk_eth ; } cocci_id@p ;
...
@@
 struct ag71xx_dcfg {  u32 max_frame_len ;  const u32 * fifodata ;  u16 desc_pktlen_mask ;  bool tx_hang_workaround ;  enum ag71xx_type type ; } cocci_id@p ;
...
position p;
@@
 enum ag71xx_type { AR7100 , AR7240 , AR9130 , AR9330 , AR9340 , QCA9530 , QCA9550 , } cocci_id@p ;
...
@@
 struct ag71xx_ring {  unsigned int curr ;  unsigned int dirty ;  struct ag71xx_buf * buf ;  u16 order ;  u16 desc_split ;  dma_addr_t descs_dma ;  u8 * descs_cpu ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct ag71xx_buf {  union {  struct {  struct sk_buff * skb ;  unsigned int len ; } tx ;  struct {  dma_addr_t dma_addr ;  void * rx_buf ; } rx ; } ; } cocci_id@p ;
