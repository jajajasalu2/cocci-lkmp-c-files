...
position p;
@@
 enum { MCQI_INFO_TYPE_CAPABILITIES = 0x0 , MCQI_INFO_TYPE_VERSION = 0x1 , MCQI_INFO_TYPE_ACTIVATION_METHOD = 0x5 , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mcqi_cap ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mcda_reg ) ] ;
...
position p;
@@
 struct mlx5_mlxfw_dev cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( init_hca_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( teardown_hca_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mcc_reg ) ] ;
...
position p;
@@
 enum { MCQI_FW_RUNNING_VERSION = 0 , MCQI_FW_STORED_VERSION = 1 , } cocci_id@p ;
...
position p;
@@
 enum { MCQS_IDENTIFIER_BOOT_IMG = 0x1 , MCQS_IDENTIFIER_OEM_NVCONFIG = 0x4 , MCQS_IDENTIFIER_MLNX_NVCONFIG = 0x5 , MCQS_IDENTIFIER_CS_TOKEN = 0x6 , MCQS_IDENTIFIER_DBG_TOKEN = 0x7 , MCQS_IDENTIFIER_GEARBOX = 0xA , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_adapter_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mcqi_version ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( init_hca_in ) ] ;
...
position p;
@@
 struct mlx5_mlxfw_dev {  struct mlxfw_dev mlxfw_dev ;  struct mlx5_core_dev * mlx5_core_dev ; } cocci_id@p ;
...
position p;
@@
 enum { MCQS_UPDATE_STATE_IDLE , MCQS_UPDATE_STATE_IN_PROGRESS , MCQS_UPDATE_STATE_APPLIED , MCQS_UPDATE_STATE_ACTIVE , MCQS_UPDATE_STATE_ACTIVE_PENDING_RESET , MCQS_UPDATE_STATE_FAILED , MCQS_UPDATE_STATE_CANCELED , MCQS_UPDATE_STATE_BUSY , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( teardown_hca_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mcqi_reg ) ] ;
...
position p;
@@
 enum mlxsw_reg_mcc_instruction cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mcqs_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mcqi_reg ) + MLX5_UN_SZ_DW ( mcqi_reg_data ) ] ;
...
position p;
@@
 enum mlxsw_reg_mcc_instruction { MLX5_REG_MCC_INSTRUCTION_LOCK_UPDATE_HANDLE = 0x01 , MLX5_REG_MCC_INSTRUCTION_RELEASE_UPDATE_HANDLE = 0x02 , MLX5_REG_MCC_INSTRUCTION_UPDATE_COMPONENT = 0x03 , MLX5_REG_MCC_INSTRUCTION_VERIFY_COMPONENT = 0x04 , MLX5_REG_MCC_INSTRUCTION_ACTIVATE = 0x06 , MLX5_REG_MCC_INSTRUCTION_CANCEL = 0x08 , } cocci_id@p ;
