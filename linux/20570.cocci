...
position p;
@@
 struct bau_operations cocci_id@p ;
...
position p;
@@
 struct atomic_short * cocci_id@p ;
...
position p;
@@
 struct uv2_3_bau_msg_header * cocci_id@p ;
...
position p;
@@
 struct hub_and_pnode cocci_id@p ;
...
position p;
@@
 struct bau_pq_entry cocci_id@p ;
...
position p;
@@
 struct uv1_bau_msg_header * cocci_id@p ;
...
position p;
@@
 const struct bau_operations cocci_id@p ;
