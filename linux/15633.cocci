...
position p;
@@
 struct hwa_notif_dn * cocci_id@p ;
...
typedef u8;
@@
 struct wa_notif_work {  struct work_struct work ;  struct wahc * wa ;  size_t size ;  u8 data [ ] ; } cocci_id@p ;
...
position p;
@@
 struct wa_notif_work cocci_id@p ;
