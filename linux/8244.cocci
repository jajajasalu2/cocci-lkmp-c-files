...
position p;
@@
 enum cpsw_devlink_param_id { CPSW_DEVLINK_PARAM_ID_BASE = DEVLINK_PARAM_GENERIC_ID_MAX , CPSW_DL_PARAM_SWITCH_MODE , CPSW_DL_PARAM_ALE_BYPASS , } cocci_id@p ;
...
position p;
@@
 struct addr_sync_ctx cocci_id@p ;
...
position p;
@@
 struct cpsw_meta_xdp * cocci_id@p ;
...
position p;
@@
 struct cpsw_devlink {  struct cpsw_common * cpsw ; } cocci_id@p ;
...
position p;
@@
 struct cpsw_platform_data * cocci_id@p ;
...
position p;
@@
 struct cpsw_devlink * cocci_id@p ;
...
position p;
@@
 struct cpsw_slave_data * cocci_id@p ;
