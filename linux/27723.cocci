...
position p;
@@
 int cocci_id@p ( struct inode * dir , const struct qstr * child , int ino ) ;
...
position p;
@@
 struct buffer_head * cocci_id@p ( struct inode * dir , const struct qstr * child , struct bfs_dirent * * res_dir ) ;
