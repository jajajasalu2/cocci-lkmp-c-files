...
position p;
@@
 struct freq_constraints * cocci_id@p ;
...
position p;
@@
 struct pm_qos_flags_request * cocci_id@p ;
...
position p;
@@
 struct pm_qos_flags * cocci_id@p ;
...
position p;
@@
 struct pm_qos_constraints cocci_id@p ;
...
position p;
@@
 enum pm_qos_req_action cocci_id@p ;
...
position p;
@@
 struct pm_qos_object * cocci_id@p ;
...
position p;
@@
 struct pm_qos_object {  struct pm_qos_constraints * constraints ;  struct miscdevice pm_qos_power_miscdev ;  char * name ; } cocci_id@p ;
