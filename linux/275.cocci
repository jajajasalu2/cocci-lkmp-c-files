...
position p;
@@
 struct clock_read_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,seqcount_t,ktime_t;
@@
 struct clock_data {  seqcount_t seq ;  struct clock_read_data read_data [ 2 ] ;  ktime_t wrap_kt ;  unsigned long rate ;  u64 ( * actual_read_sched_clock ) ( void ) ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct clock_read_data {  u64 epoch_ns ;  u64 epoch_cyc ;  u64 sched_clock_mask ;  u64 ( * read_sched_clock ) ( void ) ;  u32 mult ;  u32 shift ; } cocci_id@p ;
