...
position p;
@@
 struct imx_es8328_data {  struct device * dev ;  struct snd_soc_dai_link dai ;  struct snd_soc_card card ;  char codec_dai_name [ DAI_NAME_SIZE ] ;  char platform_name [ DAI_NAME_SIZE ] ;  int jack_gpio ; } cocci_id@p ;
...
position p;
@@
 struct imx_es8328_data cocci_id@p ;
