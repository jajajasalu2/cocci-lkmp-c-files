...
position p;
@@
 enum { RES_Z2CT0 = BIT ( 0 ) , RES_Z2CT1 = BIT ( 1 ) , RES_Z2CT2 = BIT ( 2 ) , } cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 7 ] ;
...
typedef spinlock_t;
@@
 struct pci230_private {  spinlock_t isr_spinlock ;  spinlock_t res_spinlock ;  spinlock_t ai_stop_spinlock ;  spinlock_t ao_stop_spinlock ;  unsigned long daqio ;  int intr_cpuid ;  unsigned short hwver ;  unsigned short adccon ;  unsigned short daccon ;  unsigned short adcfifothresh ;  unsigned short adcg ;  unsigned char ier ;  unsigned char res_owned [ NUM_OWNERS ] ;  unsigned int intr_running : 1 ;  unsigned int ai_bipolar : 1 ;  unsigned int ao_bipolar : 1 ;  unsigned int ai_cmd_started : 1 ;  unsigned int ao_cmd_started : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct pci230_board cocci_id@p [ ] ;
...
position p;
@@
 struct pci230_board {  const char * name ;  unsigned short id ;  unsigned char ai_bits ;  unsigned char ao_bits ;  unsigned char min_hwver ;  unsigned int have_dio : 1 ; } cocci_id@p ;
...
position p;
@@
 enum { OWNER_AICMD , OWNER_AOCMD , NUM_OWNERS , } cocci_id@p ;
...
position p;
@@
 struct pci230_private * cocci_id@p ;
