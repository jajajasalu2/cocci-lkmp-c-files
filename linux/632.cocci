...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ AEGIS_BLOCK_SIZE ] ;
...
typedef uint8x16_t;
@@
 struct aegis128_state {  uint8x16_t v [ 5 ] ; } cocci_id@p ;
...
position p;
@@
 struct aegis128_state cocci_id@p ;
