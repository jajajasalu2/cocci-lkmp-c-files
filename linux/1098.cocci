...
position p;
@@
 struct tegra186_cpufreq_cluster {  const struct tegra186_cpufreq_cluster_info * info ;  struct cpufreq_frequency_table * table ; } cocci_id@p ;
...
position p;
@@
 const struct tegra186_cpufreq_cluster_info cocci_id@p [ ] ;
...
position p;
@@
 struct tegra186_cpufreq_data * cocci_id@p ;
...
position p;
@@
 struct tegra186_cpufreq_data {  void __iomem * regs ;  size_t num_clusters ;  struct tegra186_cpufreq_cluster * clusters ; } cocci_id@p ;
...
position p;
@@
 struct mrq_cpu_vhint_request cocci_id@p ;
...
position p;
@@
 struct tegra186_cpufreq_cluster * cocci_id@p ;
...
position p;
@@
 struct cpu_vhint_data * cocci_id@p ;
...
position p;
@@
 struct tegra186_cpufreq_cluster_info {  unsigned long offset ;  int cpus [ 4 ] ;  unsigned int bpmp_cluster_id ; } cocci_id@p ;
