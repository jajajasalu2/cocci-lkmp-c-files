...
position p;
@@
 struct usb_line6_toneport * cocci_id@p ;
...
typedef u8,u32;
@@
 struct usb_line6_toneport {  struct usb_line6 line6 ;  int source ;  u32 serial_number ;  u8 firmware_version ;  enum line6_device_type type ;  struct toneport_led leds [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct line6_pcm_properties cocci_id@p ;
...
position p;
@@
 const struct {  const char * name ;  int code ; } cocci_id@p [ ] ;
...
position p;
@@
 struct snd_line6_pcm * cocci_id@p ;
...
position p;
@@
 struct toneport_led * cocci_id@p ;
...
typedef bool;
@@
 struct toneport_led {  struct led_classdev dev ;  char name [ 64 ] ;  struct usb_line6_toneport * toneport ;  bool registered ; } cocci_id@p ;
...
position p;
@@
 enum line6_device_type { LINE6_GUITARPORT , LINE6_PODSTUDIO_GX , LINE6_PODSTUDIO_UX1 , LINE6_PODSTUDIO_UX2 , LINE6_TONEPORT_GX , LINE6_TONEPORT_UX1 , LINE6_TONEPORT_UX2 , } cocci_id@p ;
...
position p;
@@
 const struct line6_properties cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct usb_device * usbdev , int cmd1 , int cmd2 ) ;
