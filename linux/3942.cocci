...
position p;
@@
 const struct qcom_aoss_desc cocci_id@p ;
...
position p;
@@
 const struct qcom_aoss_reset_map cocci_id@p [ ] ;
...
position p;
@@
 struct qcom_aoss_desc {  const struct qcom_aoss_reset_map * resets ;  size_t num_resets ; } cocci_id@p ;
...
position p;
@@
 struct qcom_aoss_reset_data * cocci_id@p ;
...
position p;
@@
 struct qcom_aoss_reset_data {  struct reset_controller_dev rcdev ;  void __iomem * base ;  const struct qcom_aoss_desc * desc ; } cocci_id@p ;
...
position p;
@@
 struct qcom_aoss_reset_map {  unsigned int reg ; } cocci_id@p ;
