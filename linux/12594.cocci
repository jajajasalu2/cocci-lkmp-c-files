...
position p;
@@
 struct dpu_crtc_smmu_state_data * cocci_id@p ;
...
position p;
@@
 const struct drm_plane_state * cocci_id@p [ SSPP_MAX ] ;
...
position p;
@@
 int cocci_id@p [ DPU_STAGE_MAX + 1 ] ;
...
position p;
@@
 struct dpu_hw_mixer_cfg cocci_id@p ;
...
position p;
@@
 const struct drm_rect * cocci_id@p ;
...
position p;
@@
 struct dpu_crtc_mixer * cocci_id@p ;
...
typedef u32;
@@
 struct plane_state {  struct dpu_plane_state * dpu_pstate ;  const struct drm_plane_state * drm_pstate ;  int stage ;  u32 pipe_id ; } cocci_id@p ;
...
position p;
@@
 struct dpu_crtc_frame_event cocci_id@p ;
...
position p;
@@
 struct dpu_multirect_plane_states cocci_id@p [ DPU_STAGE_MAX * 2 ] ;
...
position p;
@@
 struct dpu_hw_stage_cfg cocci_id@p ;
