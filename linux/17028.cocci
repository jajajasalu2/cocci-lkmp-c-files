...
position p;
@@
 struct as5011_device {  struct input_dev * input_dev ;  struct i2c_client * i2c_client ;  unsigned int button_gpio ;  unsigned int button_irq ;  unsigned int axis_irq ; } cocci_id@p ;
...
position p;
@@
 struct as5011_device * cocci_id@p ;
...
position p;
@@
 const struct as5011_platform_data * cocci_id@p ;
