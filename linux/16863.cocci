...
position p;
@@
 struct ims_pcu_gamepad * cocci_id@p ;
...
position p;
@@
 const struct ims_pcu_device_info * cocci_id@p ;
...
position p;
@@
 struct ims_pcu_ofn_bit_attribute * cocci_id@p ;
...
position p;
@@
 struct ims_pcu_buttons * cocci_id@p ;
...
position p;
@@
 struct ims_pcu_attribute {  struct device_attribute dattr ;  size_t field_offset ;  int field_length ; } cocci_id@p ;
...
position p;
@@
 struct ims_pcu_flash_fmt * cocci_id@p ;
...
typedef u8;
@@
 struct ims_pcu_ofn_bit_attribute {  struct device_attribute dattr ;  u8 addr ;  u8 nr ; } cocci_id@p ;
...
position p;
@@
 struct ims_pcu_backlight * cocci_id@p ;
...
position p;
@@
 struct ims_pcu_attribute cocci_id@p ;
...
position p;
@@
 struct usb_cdc_union_desc * cocci_id@p ;
...
position p;
@@
 struct ims_pcu_backlight {  struct led_classdev cdev ;  char name [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct ims_pcu_gamepad {  struct input_dev * input ;  char name [ 32 ] ;  char phys [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 const struct usb_cdc_union_desc * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct ims_pcu_flash_fmt {  __le32 addr ;  u8 len ;  u8 data [ ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct ims_pcu_device_info {  const unsigned short * keymap ;  size_t keymap_len ;  bool has_gamepad ; } cocci_id@p ;
...
position p;
@@
 struct usb_cdc_line_coding * cocci_id@p ;
...
position p;
@@
 struct ims_pcu_buttons {  struct input_dev * input ;  char name [ 32 ] ;  char phys [ 32 ] ;  unsigned short keymap [ IMS_PCU_KEYMAP_LEN ] ; } cocci_id@p ;
