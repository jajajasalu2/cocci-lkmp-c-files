...
position p;
@@
 const struct hisi_phase_clock * cocci_id@p ;
...
@@
 struct clk_hisi_phase {  struct clk_hw hw ;  void __iomem * reg ;  u32 * phase_degrees ;  u32 * phase_regvals ;  u8 phase_num ;  u32 mask ;  u8 shift ;  u8 flags ;  spinlock_t * lock ; } cocci_id@p ;
...
position p;
@@
 struct clk_hisi_phase * cocci_id@p ;
