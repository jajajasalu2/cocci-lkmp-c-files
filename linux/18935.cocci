...
position p;
@@
 const struct exynos_pm_data * cocci_id@p ;
...
position p;
@@
 const struct exynos_wkup_irq * cocci_id@p ;
...
position p;
@@
 struct exynos_pm_data {  const struct exynos_wkup_irq * wkup_irq ;  unsigned int wake_disable_mask ;  void ( * pm_prepare ) ( void ) ;  void ( * pm_resume_prepare ) ( void ) ;  void ( * pm_resume ) ( void ) ;  int ( * pm_suspend ) ( void ) ;  int ( * cpu_suspend ) ( unsigned long ) ; } cocci_id@p ;
...
typedef u32;
@@
 struct exynos_wkup_irq {  unsigned int hwirq ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 struct exynos_pm_state cocci_id@p ;
...
@@
 struct exynos_pm_state {  int cpu_state ;  unsigned int pmu_spare3 ;  void __iomem * sysram_base ;  phys_addr_t sysram_phys ;  bool secure_firmware ; } cocci_id@p ;
