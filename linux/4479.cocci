...
typedef u64,dev_t;
@@
 struct bsr_dev {  u64 bsr_addr ;  u64 bsr_len ;  unsigned bsr_bytes ;  unsigned bsr_stride ;  unsigned bsr_type ;  unsigned bsr_num ;  int bsr_minor ;  struct list_head bsr_list ;  dev_t bsr_dev ;  struct cdev bsr_cdev ;  struct device * bsr_device ;  char bsr_name [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 enum { BSR_8 = 0 , BSR_16 = 1 , BSR_64 = 2 , BSR_128 = 3 , BSR_4096 = 4 , BSR_UNKNOWN = 5 , BSR_MAX = 6 , } cocci_id@p ;
