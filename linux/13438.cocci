...
position p;
@@
 const struct dvb_diseqc_master_cmd * cocci_id@p ;
...
position p;
@@
 struct cx22700_config cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct ttusb_channel * channel , const u8 * data , int len ) ;
