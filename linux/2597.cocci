...
position p;
@@
 struct iim_priv {  void __iomem * base ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 const struct imx_iim_drvdata * cocci_id@p ;
...
position p;
@@
 struct imx_iim_drvdata {  unsigned int nregs ; } cocci_id@p ;
...
position p;
@@
 struct imx_iim_drvdata cocci_id@p ;
