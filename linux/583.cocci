...
position p;
@@
 struct crypto_stat_akcipher cocci_id@p ;
...
position p;
@@
 struct crypto_stat_kpp cocci_id@p ;
...
position p;
@@
 struct crypto_stat_compress cocci_id@p ;
...
position p;
@@
 struct crypto_stat_aead cocci_id@p ;
...
position p;
@@
 struct crypto_stat_cipher cocci_id@p ;
...
position p;
@@
 struct crypto_stat_larval cocci_id@p ;
...
position p;
@@
 struct crypto_stat_rng cocci_id@p ;
...
position p;
@@
 struct crypto_stat_hash cocci_id@p ;
