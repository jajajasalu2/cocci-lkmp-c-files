...
position p;
@@
 struct list_test_struct cocci_id@p [ 5 ] ;
...
position p;
@@
 struct list_test_struct cocci_id@p ;
...
position p;
@@
 struct list_test_struct {  int data ;  struct list_head list ; } cocci_id@p ;
