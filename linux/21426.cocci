...
position p;
@@
 enum arch_vdso_type cocci_id@p ;
...
position p;
@@
 struct vm_special_mapping cocci_id@p [ A_PAGES ] ;
...
position p;
@@
 struct page * cocci_id@p [ C_PAGES ] ;
...
position p;
@@
 struct __vdso_abi {  const char * name ;  const char * vdso_code_start ;  const char * vdso_code_end ;  unsigned long vdso_pages ;  struct vm_special_mapping * dm ;  struct vm_special_mapping * cm ; } cocci_id@p ;
...
typedef u8;
@@
 union {  struct vdso_data data [ CS_BASES ] ;  u8 page [ PAGE_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct vm_special_mapping cocci_id@p [ C_PAGES ] ;
