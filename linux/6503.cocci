...
position p;
@@
 int cocci_id@p ( struct cxgbi_sock * csk , int req_completion ) ;
...
position p;
@@
 struct cpl_iscsi_hdr_norss cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct t3cdev * , u32 , u32 ) ;
...
position p;
@@
 const struct l2t_entry * cocci_id@p ;
...
position p;
@@
 struct cpl_rx_data_ddp_norss cocci_id@p ;
...
position p;
@@
 cxgb3_cpl_handler_func cocci_id@p [ NUM_CPL_CMDS ] ;
