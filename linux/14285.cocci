...
position p;
@@
 struct stv090x_internal * cocci_id@p ;
...
position p;
@@
 struct stv090x_long_frame_crloop cocci_id@p [ ] ;
...
position p;
@@
 enum stv090x_delsys cocci_id@p ;
...
position p;
@@
 const struct stv090x_reg * cocci_id@p ;
...
position p;
@@
 enum stv090x_demodulator cocci_id@p ;
...
position p;
@@
 enum stv090x_rolloff cocci_id@p ;
...
position p;
@@
 struct stv090x_short_frame_crloop * cocci_id@p ;
...
position p;
@@
 struct stv090x_state * cocci_id@p ;
...
position p;
@@
 const struct stv090x_tab * cocci_id@p ;
...
position p;
@@
 enum stv090x_modcod cocci_id@p ;
...
position p;
@@
 enum stv090x_signal_state cocci_id@p ;
...
position p;
@@
 struct stv090x_dev {  struct stv090x_internal * internal ;  struct stv090x_dev * next_dev ; } cocci_id@p ;
...
position p;
@@
 const struct stv090x_config * cocci_id@p ;
