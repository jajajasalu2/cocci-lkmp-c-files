...
position p;
@@
 struct cpuinfo_mips * cocci_id@p ;
...
position p;
@@
 struct flush_icache_range_args * cocci_id@p ;
...
position p;
@@
 struct flush_cache_page_args * cocci_id@p ;
...
position p;
@@
 struct flush_kernel_vmap_range_args {  unsigned long vaddr ;  int size ; } cocci_id@p ;
...
typedef bool;
@@
 struct flush_icache_range_args {  unsigned long start ;  unsigned long end ;  unsigned int type ;  bool user ; } cocci_id@p ;
...
position p;
@@
 struct flush_kernel_vmap_range_args * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned long addr ) ;
...
position p;
@@
 struct flush_cache_page_args {  struct vm_area_struct * vma ;  unsigned long addr ;  unsigned long pfn ; } cocci_id@p ;
