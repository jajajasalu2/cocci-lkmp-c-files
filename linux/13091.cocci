...
position p;
@@
 void cocci_id@p ( struct qman_portal * , struct qman_fq * , const union qm_mr_entry * ) ;
...
position p;
@@
 enum qman_cb_dqrr_result cocci_id@p ( struct qman_portal * , struct qman_fq * , const struct qm_dqrr_entry * ) ;
