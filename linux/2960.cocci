...
position p;
@@
 struct acpi_device_power_state * cocci_id@p ;
...
position p;
@@
 struct acpi_hotplug_profile * cocci_id@p ;
...
position p;
@@
 struct acpi_hardware_id * cocci_id@p ;
...
position p;
@@
 struct acpi_device_wakeup * cocci_id@p ;
...
position p;
@@
 struct acpi_device_bus_id cocci_id@p ;
...
typedef u32;
@@
 struct acpi_table_events_work {  struct work_struct work ;  void * table ;  u32 event ; } cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct acpi_device * , u32 ) ;
...
typedef acpi_handle;
@@
 struct acpi_dep_data {  struct list_head node ;  acpi_handle master ;  acpi_handle slave ; } cocci_id@p ;
...
position p;
@@
 struct acpi_table_events_work cocci_id@p ;
...
position p;
@@
 struct acpi_dep_data cocci_id@p ;
...
position p;
@@
 struct acpi_scan_handler cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct acpi_device * , u32 ) ;
...
position p;
@@
 struct acpi_table_stao cocci_id@p ;
...
position p;
@@
 struct acpi_table_spcr * cocci_id@p ;
...
position p;
@@
 struct acpi_pnp_device_id_list * cocci_id@p ;
...
position p;
@@
 struct acpi_device_pnp * cocci_id@p ;
...
position p;
@@
 const struct acpi_device * cocci_id@p ;
...
position p;
@@
 struct acpi_hotplug_context * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ACPI_PATH_SEGMENT_LENGTH ] ;
