...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( dealloc_uar_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( dealloc_uar_in ) ] ;
...
position p;
@@
 struct mlx5_bfreg_data * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( alloc_uar_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( alloc_uar_in ) ] ;
...
position p;
@@
 struct mlx5_sq_bfreg * cocci_id@p ;
