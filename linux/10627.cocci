...
position p;
@@
 struct intel_vgpu_pci_bar * cocci_id@p ;
...
position p;
@@
 enum { INTEL_GVT_PCI_BAR_GTTMMIO = 0 , INTEL_GVT_PCI_BAR_APERTURE , INTEL_GVT_PCI_BAR_PIO , INTEL_GVT_PCI_BAR_MAX , } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ PCI_INTERRUPT_LINE + 4 ] ;
