...
position p;
@@
 struct insn {  struct insn_type * type ;  char opcode [ STRING_SIZE_MAX ] ;  char name [ STRING_SIZE_MAX ] ;  char upper [ STRING_SIZE_MAX ] ;  char format [ STRING_SIZE_MAX ] ;  unsigned int name_len ; } cocci_id@p ;
...
position p;
@@
 struct insn_format {  char * format ;  int type ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ STRING_SIZE_MAX ] ;
...
position p;
@@
 struct insn_group {  struct insn_type * type ;  int offset ;  int count ;  char opcode [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct insn_type {  unsigned char byte ;  unsigned char mask ;  char * * format ; } cocci_id@p ;
...
position p;
@@
 struct gen_opcode {  struct insn * insn ;  int nr ;  struct insn_group * group ;  int nr_groups ; } cocci_id@p ;
