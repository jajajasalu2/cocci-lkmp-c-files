...
position p;
@@
 int ( * cocci_id@p ) ( void * data , char * name , char * event , char * desc , char * long_desc , char * pmu , char * unit , char * perpkg , char * metric_expr , char * metric_name , char * metric_group , char * deprecated ) ;
...
position p;
@@
 struct event_struct {  struct list_head list ;  char * name ;  char * event ;  char * desc ;  char * long_desc ;  char * pmu ;  char * unit ;  char * perpkg ;  char * metric_expr ;  char * metric_name ;  char * metric_group ;  char * deprecated ; } cocci_id@p ;
...
position p;
@@
 struct perf_entry_data cocci_id@p ;
...
position p;
@@
 struct field {  const char * field ;  const char * kernel ; } cocci_id@p [ ] ;
...
position p;
@@
 struct msrmap {  const char * num ;  const char * pname ; } cocci_id@p [ ] ;
...
position p;
@@
 struct event_struct * cocci_id@p ;
...
position p;
@@
 struct map {  const char * json ;  const char * perf ; } cocci_id@p [ ] ;
...
typedef FILE;
@@
 struct perf_entry_data {  FILE * outfp ;  char * topic ; } cocci_id@p ;
...
position p;
@@
 struct fixed {  const char * name ;  const char * event ; } cocci_id@p [ ] ;
