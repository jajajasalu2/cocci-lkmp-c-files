...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , struct fbcon_display * p , int line , int count , int dy ) ;
...
position p;
@@
 enum { FBCON_LOGO_CANSHOW = - 1 , FBCON_LOGO_DRAW = - 2 , FBCON_LOGO_DONTSHOW = - 3 , } cocci_id@p ;
...
position p;
@@
 struct fb_con2fbmap cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct vc_data * vc , bool set ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , const unsigned char * table ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , int count ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , const unsigned short * s , int count , int ypos , int xpos ) ;
...
position p;
@@
 struct fb_blit_caps * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , int mode ) ;
...
position p;
@@
 struct fbcon_display cocci_id@p [ MAX_NR_CONSOLES ] ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , int sy , int sx , int height , int width ) ;
...
position p;
@@
 int cocci_id@p ( struct vc_data * vc , int blank , int mode_switch ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct vc_data * vc , struct fbcon_display * p , int sy , int sx , int dy , int dx , int height , int width , u_int y_break ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , int c , int ypos , int xpos ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , int init ) ;
...
position p;
@@
 signed char cocci_id@p [ MAX_NR_CONSOLES ] ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * info , struct fb_var_screeninfo * var , int unit ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , int bottom_only ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , int sy , int sx , int dy , int dx , int height , int width ) ;
...
position p;
@@
 struct fbcon_display * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vc_data * vc ) ;
...
position p;
@@
 const struct font_desc * cocci_id@p ;
