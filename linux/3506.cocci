...
typedef u32;
@@
 struct sd_emmc_desc {  u32 cmd_cfg ;  u32 cmd_arg ;  u32 cmd_data ;  u32 cmd_resp ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ MUX_CLK_NUM_PARENTS ] ;
...
position p;
@@
 struct meson_mmc_data * cocci_id@p ;
...
position p;
@@
 const struct meson_mmc_data cocci_id@p ;
...
position p;
@@
 const struct mmc_data * cocci_id@p ;
...
position p;
@@
 struct meson_mmc_data {  unsigned int tx_delay_mask ;  unsigned int rx_delay_mask ;  unsigned int always_on ;  unsigned int adjust ; } cocci_id@p ;
...
position p;
@@
 struct sd_emmc_desc * cocci_id@p ;
...
@@
 struct meson_host {  struct device * dev ;  struct meson_mmc_data * data ;  struct mmc_host * mmc ;  struct mmc_command * cmd ;  void __iomem * regs ;  struct clk * core_clk ;  struct clk * mux_clk ;  struct clk * mmc_clk ;  unsigned long req_rate ;  bool ddr ;  bool dram_access_quirk ;  struct pinctrl * pinctrl ;  struct pinctrl_state * pins_default ;  struct pinctrl_state * pins_clk_gate ;  unsigned int bounce_buf_size ;  void * bounce_buf ;  dma_addr_t bounce_dma_addr ;  struct sd_emmc_desc * descs ;  dma_addr_t descs_dma_addr ;  int irq ;  bool vqmmc_enabled ; } cocci_id@p ;
