...
position p;
@@
 struct ena_com_stats_admin cocci_id@p ;
...
position p;
@@
 const struct ena_stats cocci_id@p [ ] ;
...
position p;
@@
 struct ena_stats {  char name [ ETH_GSTRING_LEN ] ;  int stat_offset ; } cocci_id@p ;
...
position p;
@@
 struct ena_admin_get_feature_link_desc * cocci_id@p ;
