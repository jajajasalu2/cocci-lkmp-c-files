...
position p;
@@
 enum hi6220_reset_ctrl_type cocci_id@p ;
...
position p;
@@
 struct hi6220_reset_data {  struct reset_controller_dev rc_dev ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct hi6220_reset_data * cocci_id@p ;
...
position p;
@@
 enum hi6220_reset_ctrl_type { PERIPHERAL , MEDIA , } cocci_id@p ;
