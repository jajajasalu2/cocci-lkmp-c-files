...
position p;
@@
 enum packet_format { packet_format_1 , packet_format_2 , } cocci_id@p ;
...
position p;
@@
 struct cypress_private * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u8,spinlock_t;
@@
 struct cypress_private {  spinlock_t lock ;  int chiptype ;  int bytes_in ;  int bytes_out ;  int cmd_count ;  int cmd_ctrl ;  struct kfifo write_fifo ;  int write_urb_in_use ;  int write_urb_interval ;  int read_urb_interval ;  int comm_is_ok ;  __u8 line_control ;  __u8 current_status ;  __u8 current_config ;  __u8 rx_flags ;  enum packet_format pkt_fmt ;  int get_cfg_unsafe ;  int baud_rate ;  char prev_status ; } cocci_id@p ;
