...
position p;
@@
 void cocci_id@p ( struct hv_kvp_msg * msg , int error ) ;
...
position p;
@@
 struct hv_kvp_msg_enumerate * cocci_id@p ;
...
position p;
@@
 struct hv_kvp_exchg_msg_value * cocci_id@p ;
...
position p;
@@
 enum { NEGO_NOT_STARTED , NEGO_IN_PROGRESS , NEGO_FINISHED , } cocci_id@p ;
...
position p;
@@
 struct hv_kvp_ip_msg * cocci_id@p ;
...
typedef u64;
@@
 struct {  int state ;  int recv_len ;  struct hv_kvp_msg * kvp_msg ;  struct vmbus_channel * recv_channel ;  u64 recv_req_id ; } cocci_id@p ;
...
position p;
@@
 struct hvutil_transport * cocci_id@p ;
