...
position p;
@@
 struct pcf50633_adc_request {  int mux ;  int avg ;  void ( * callback ) ( struct pcf50633 * , void * , int ) ;  void * callback_param ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct pcf50633 * , void * , int ) ;
...
position p;
@@
 struct pcf50633_adc_sync_request * cocci_id@p ;
...
position p;
@@
 struct pcf50633_adc_request * cocci_id@p ;
...
position p;
@@
 struct pcf50633_adc {  struct pcf50633 * pcf ;  struct pcf50633_adc_request * queue [ PCF50633_MAX_ADC_FIFO_DEPTH ] ;  int queue_head ;  int queue_tail ;  struct mutex queue_mutex ; } cocci_id@p ;
...
position p;
@@
 struct pcf50633_adc_sync_request {  int result ;  struct completion completion ; } cocci_id@p ;
...
position p;
@@
 struct pcf50633_adc * cocci_id@p ;
