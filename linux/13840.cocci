...
position p;
@@
 const struct ir_raw_timings_manchester cocci_id@p ;
...
position p;
@@
 enum mce_kbd_mode { MCIR2_MODE_KEYBOARD , MCIR2_MODE_MOUSE , MCIR2_MODE_UNKNOWN , } cocci_id@p ;
...
position p;
@@
 enum mce_kbd_state { STATE_INACTIVE , STATE_HEADER_BIT_START , STATE_HEADER_BIT_END , STATE_BODY_BIT_START , STATE_BODY_BIT_END , STATE_FINISHED , } cocci_id@p ;
...
position p;
@@
 struct ir_raw_handler cocci_id@p ;
...
position p;
@@
 struct ir_raw_event_ctrl * cocci_id@p ;
