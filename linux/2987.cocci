...
position p;
@@
 struct acpi_ac {  struct power_supply * charger ;  struct power_supply_desc charger_desc ;  struct acpi_device * device ;  unsigned long long state ;  struct notifier_block battery_nb ; } cocci_id@p ;
...
position p;
@@
 const struct acpi_ac_bl cocci_id@p [ ] ;
...
position p;
@@
 void * cocci_id@p ( struct proc_dir_entry * acpi_ac_dir ) ;
...
position p;
@@
 struct acpi_ac_bl {  const char * hid ;  int hrv ; } cocci_id@p ;
