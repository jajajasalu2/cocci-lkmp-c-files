...
typedef u8;
@@
 struct sp8870_state {  struct i2c_adapter * i2c ;  const struct sp8870_config * config ;  struct dvb_frontend frontend ;  u8 initialised : 1 ; } cocci_id@p ;
...
position p;
@@
 struct sp8870_state * cocci_id@p ;
