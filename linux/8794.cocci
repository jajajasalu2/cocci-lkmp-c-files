...
typedef u_char;
@@
 void cocci_id@p ( struct net_device * dev , int count , const u_char * buf , const int start_page ) ;
...
position p;
@@
 int cocci_id@p ( unsigned int addr , int phy_id , int loc ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int startp ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , unsigned int length , int start_page ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * , struct e8390_pkt_hdr * , int ) ;
...
typedef u_char;
@@
 struct {  u_char value , offset ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( unsigned int addr , int phy_id , int loc , int value ) ;
