...
position p;
@@
 struct device_dma_parameters cocci_id@p ;
...
position p;
@@
 struct rxe_recv_wqe * cocci_id@p ;
...
position p;
@@
 struct rxe_phys_buf * cocci_id@p ;
...
position p;
@@
 struct rxe_modify_srq_cmd cocci_id@p ;
...
position p;
@@
 struct rxe_send_wqe * cocci_id@p ;
...
position p;
@@
 struct rxe_ucontext * cocci_id@p ;
