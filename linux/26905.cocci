...
position p;
@@
 const struct afs_vlserver * cocci_id@p ;
...
position p;
@@
 struct afs_addr_list * cocci_id@p ;
...
position p;
@@
 struct afs_vl_seq_net_private {  struct seq_net_private seq ;  struct afs_vlserver_list * vllist ; } cocci_id@p ;
...
position p;
@@
 struct afs_vl_seq_net_private * cocci_id@p ;
...
position p;
@@
 const struct afs_vlserver_entry * cocci_id@p ;
...
position p;
@@
 struct afs_vlserver_list * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ NR__dns_lookup_status + 1 ] ;
...
position p;
@@
 const struct afs_vl_seq_net_private * cocci_id@p ;
...
position p;
@@
 const struct afs_addr_list * cocci_id@p ;
...
position p;
@@
 const struct afs_vlserver_list * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ NR__dns_record_source + 1 ] ;
