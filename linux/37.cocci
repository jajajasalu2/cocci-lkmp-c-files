...
position p;
@@
 union mips_r_info {  Elf64_Xword r_info ;  struct {  Elf64_Word r_sym ;  myElf64_Byte r_ssym ;  myElf64_Byte r_type3 ;  myElf64_Byte r_type2 ;  myElf64_Byte r_type ; } r_mips ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * map , const size_t offset ) ;
...
position p;
@@
 char cocci_id@p [ strlen ( fname ) + 4 ] ;
