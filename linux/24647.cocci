...
position p;
@@
 struct xt_limit_priv * cocci_id@p ;
...
position p;
@@
 const struct compat_xt_rateinfo * cocci_id@p ;
...
position p;
@@
 struct compat_xt_rateinfo cocci_id@p ;
...
position p;
@@
 const struct xt_rateinfo * cocci_id@p ;
...
@@
 struct xt_limit_priv {  spinlock_t lock ;  unsigned long prev ;  uint32_t credit ; } cocci_id@p ;
