...
position p;
@@
 struct mode_parameter cocci_id@p ;
...
position p;
@@
 struct lynxfb_output * cocci_id@p ;
...
position p;
@@
 struct initchip_param * cocci_id@p ;
