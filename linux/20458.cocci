...
position p;
@@
 struct residency_counts cocci_id@p ;
...
position p;
@@
 struct pseudo_lock_pm_req * cocci_id@p ;
...
position p;
@@
 struct pseudo_lock_pm_req {  struct list_head list ;  struct dev_pm_qos_request req ; } cocci_id@p ;
...
position p;
@@
 struct pseudo_lock_region * cocci_id@p ;
