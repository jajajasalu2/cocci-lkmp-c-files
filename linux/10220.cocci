...
position p;
@@
 struct xxs1500_pcmcia_sock cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct xxs1500_pcmcia_sock {  struct pcmcia_socket socket ;  void * virt_io ;  phys_addr_t phys_io ;  phys_addr_t phys_attr ;  phys_addr_t phys_mem ;  unsigned int old_flags ; } cocci_id@p ;
