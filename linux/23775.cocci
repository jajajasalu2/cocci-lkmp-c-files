...
position p;
@@
 const struct dsa_port * cocci_id@p ;
...
position p;
@@
 struct dsa_slave_dump_ctx * cocci_id@p ;
...
position p;
@@
 struct dsa_switchdev_event_work cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( const struct net_device * dev ) ;
...
position p;
@@
 struct dsa_notifier_register_info cocci_id@p ;
...
position p;
@@
 struct bridge_vlan_info cocci_id@p ;
...
position p;
@@
 struct dsa_switchdev_event_work {  struct work_struct work ;  struct switchdev_notifier_fdb_info fdb_info ;  struct net_device * dev ;  unsigned long event ; } cocci_id@p ;
...
position p;
@@
 struct dsa_slave_dump_ctx {  struct net_device * dev ;  struct sk_buff * skb ;  struct netlink_callback * cb ;  int idx ; } cocci_id@p ;
...
position p;
@@
 struct dsa_mall_tc_entry * cocci_id@p ;
...
position p;
@@
 const struct switchdev_notifier_fdb_info * cocci_id@p ;
...
position p;
@@
 struct dsa_slave_priv * cocci_id@p ;
