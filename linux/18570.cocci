...
position p;
@@
 struct impd1_device cocci_id@p [ ] ;
...
position p;
@@
 struct impd1_device {  unsigned long offset ;  unsigned int irq [ 2 ] ;  unsigned int id ;  void * platform_data ; } cocci_id@p ;
...
position p;
@@
 struct impd1_module cocci_id@p ;
...
position p;
@@
 struct impd1_module {  void __iomem * base ;  void __iomem * vic_base ; } cocci_id@p ;
