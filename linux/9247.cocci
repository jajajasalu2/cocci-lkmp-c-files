...
position p;
@@
 struct gve_adminq_set_driver_parameter cocci_id@p ;
...
position p;
@@
 struct gve_adminq_configure_device_resources cocci_id@p ;
...
position p;
@@
 struct gve_adminq_destroy_tx_queue cocci_id@p ;
...
position p;
@@
 union gve_adminq_command * cocci_id@p ;
...
position p;
@@
 struct gve_adminq_register_page_list cocci_id@p ;
...
position p;
@@
 struct gve_adminq_create_rx_queue cocci_id@p ;
...
position p;
@@
 struct gve_adminq_destroy_rx_queue cocci_id@p ;
...
position p;
@@
 struct gve_queue_page_list * cocci_id@p ;
...
position p;
@@
 struct gve_device_descriptor * cocci_id@p ;
...
position p;
@@
 struct gve_adminq_unregister_page_list cocci_id@p ;
...
position p;
@@
 struct gve_adminq_create_tx_queue cocci_id@p ;
