...
position p;
@@
 struct cmac_tfm_ctx * cocci_id@p ;
...
typedef u8;
@@
 struct cmac_desc_ctx {  unsigned int len ;  u8 ctx [ ] ; } cocci_id@p ;
...
position p;
@@
 struct cmac_desc_ctx cocci_id@p ;
...
typedef u8;
@@
 struct cmac_tfm_ctx {  struct crypto_cipher * child ;  u8 ctx [ ] ; } cocci_id@p ;
