...
position p;
@@
 enum i2c_type_exynos { I2C_TYPE_EXYNOS5 , I2C_TYPE_EXYNOS7 , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct exynos5_i2c {  struct i2c_adapter adap ;  struct i2c_msg * msg ;  struct completion msg_complete ;  unsigned int msg_ptr ;  unsigned int irq ;  void __iomem * regs ;  struct clk * clk ;  struct device * dev ;  int state ;  spinlock_t lock ;  int trans_done ;  unsigned int op_clock ;  const struct exynos_hsi2c_variant * variant ; } cocci_id@p ;
...
position p;
@@
 const struct exynos_hsi2c_variant cocci_id@p ;
...
position p;
@@
 struct exynos_hsi2c_variant {  unsigned int fifo_depth ;  enum i2c_type_exynos hw ; } cocci_id@p ;
