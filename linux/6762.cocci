...
symbol cocci_id;
position p;
typedef Mpi2DiagBufferPostRequest_t;
@@
 Mpi2DiagBufferPostRequest_t cocci_id@p ;
...
position p;
@@
 struct DIAG_BUFFER_START * cocci_id@p ;
...
position p;
@@
 enum block_state { NON_BLOCKING , BLOCKING , } cocci_id@p ;
...
position p;
@@
 struct MPT3_IOCTL_EVENTS cocci_id@p ;
...
position p;
@@
 struct mpt3_ioctl_btdh_mapping cocci_id@p ;
...
position p;
@@
 struct SL_WH_EVENT_TRIGGERS_T cocci_id@p ;
...
position p;
@@
 struct mpt3_ioctl_eventquery cocci_id@p ;
...
position p;
@@
 struct mpt3_ioctl_command cocci_id@p ;
...
position p;
@@
 struct mpt3_diag_query cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2DiagReleaseRequest_t;
@@
 Mpi2DiagReleaseRequest_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi26NVMeEncapsulatedErrorReply_t;
@@
 Mpi26NVMeEncapsulatedErrorReply_t * cocci_id@p ;
...
position p;
@@
 struct mpt3_diag_register * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SmpPassthroughRequest_t;
@@
 Mpi2SmpPassthroughRequest_t * cocci_id@p ;
...
position p;
@@
 struct mpt3_diag_unregister cocci_id@p ;
...
position p;
@@
 struct mpt3_ioctl_eventenable cocci_id@p ;
...
position p;
@@
 struct mpt3_ioctl_iocinfo cocci_id@p ;
...
position p;
@@
 struct SL_WH_MASTER_TRIGGER_T cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2DiagBufferPostReply_t;
@@
 Mpi2DiagBufferPostReply_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2ToolboxCleanRequest_t;
@@
 Mpi2ToolboxCleanRequest_t * cocci_id@p ;
...
position p;
@@
 struct mpt3_diag_read_buffer cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOUnitPage3_t;
@@
 Mpi2IOUnitPage3_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2ToolboxMemMoveRequest_t;
@@
 Mpi2ToolboxMemMoveRequest_t * cocci_id@p ;
...
position p;
@@
 struct mpt3_ioctl_command32 cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2DiagReleaseReply_t;
@@
 Mpi2DiagReleaseReply_t * cocci_id@p ;
...
position p;
@@
 struct SL_WH_MPI_TRIGGERS_T cocci_id@p ;
...
position p;
@@
 struct mpt3_diag_release cocci_id@p ;
...
position p;
@@
 struct SL_WH_SCSI_TRIGGERS_T cocci_id@p ;
...
typedef __le32,u8;
@@
 struct DIAG_BUFFER_START {  __le32 Size ;  __le32 DiagVersion ;  u8 BufferType ;  u8 Reserved [ 3 ] ;  __le32 Reserved1 ;  __le32 Reserved2 ;  __le32 Reserved3 ; } cocci_id@p ;
...
position p;
@@
 struct mpt3_ioctl_diag_reset cocci_id@p ;
...
position p;
@@
 struct mpt3_ioctl_eventreport cocci_id@p ;
...
position p;
@@
 struct mpt3_ioctl_header cocci_id@p ;
