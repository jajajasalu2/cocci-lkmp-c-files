...
position p;
@@
 const struct fw_port_app_priority * cocci_id@p ;
...
position p;
@@
 const union fw_port_dcb * cocci_id@p ;
...
position p;
@@
 enum cxgb4_dcb_state cocci_id@p ;
...
position p;
@@
 enum cxgb4_dcb_state_input cocci_id@p ;
...
position p;
@@
 enum cxgb4_dcb_fw_msgs cocci_id@p ;
