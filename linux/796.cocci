...
position p;
@@
 struct pci_pme_device cocci_id@p ;
...
position p;
@@
 enum pcie_bus_config_types cocci_id@p ;
...
position p;
@@
 enum pcie_link_width * cocci_id@p ;
...
typedef u32;
@@
 struct pci_saved_state {  u32 config_space [ 16 ] ;  struct pci_cap_saved_data cap [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct pci_bus * cocci_id@p ;
...
position p;
@@
 enum pcie_reset_state cocci_id@p ;
...
typedef u32;
@@
 struct pci_devres {  unsigned int enabled : 1 ;  unsigned int pinned : 1 ;  unsigned int orig_intx : 1 ;  unsigned int restore_intx : 1 ;  unsigned int mwi : 1 ;  u32 region_mask ; } cocci_id@p ;
...
position p;
@@
 struct pci_saved_state * cocci_id@p ;
...
position p;
@@
 struct pci_cap_saved_data cocci_id@p ;
...
position p;
@@
 struct pci_pme_device {  struct list_head list ;  struct pci_dev * dev ; } cocci_id@p ;
...
position p;
@@
 struct logic_pio_hwaddr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef arch_set_vga_state_t;
@@
 arch_set_vga_state_t cocci_id@p ;
