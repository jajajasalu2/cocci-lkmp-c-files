...
position p;
@@
 const struct codel_sched_data * cocci_id@p ;
...
typedef u32;
@@
 struct codel_sched_data {  struct codel_params params ;  struct codel_vars vars ;  struct codel_stats stats ;  u32 drop_overlimit ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_CODEL_MAX + 1 ] ;
...
position p;
@@
 struct codel_sched_data cocci_id@p ;
...
position p;
@@
 struct tc_codel_xstats cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_CODEL_MAX + 1 ] ;
