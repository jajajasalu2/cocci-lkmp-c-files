...
position p;
@@
 enum nl80211_reg_initiator cocci_id@p ;
...
position p;
@@
 struct reg_beacon {  struct list_head list ;  struct ieee80211_channel chan ; } cocci_id@p ;
...
position p;
@@
 const struct fwdb_country * cocci_id@p ;
...
position p;
@@
 struct fwdb_wmm_rule cocci_id@p ;
...
position p;
@@
 struct fwdb_collection cocci_id@p ;
...
position p;
@@
 enum reg_request_treatment cocci_id@p ;
...
position p;
@@
 enum fwdb_flags { FWDB_FLAG_NO_OFDM = BIT ( 0 ) , FWDB_FLAG_NO_OUTDOOR = BIT ( 1 ) , FWDB_FLAG_DFS = BIT ( 2 ) , FWDB_FLAG_NO_IR = BIT ( 3 ) , FWDB_FLAG_AUTO_BW = BIT ( 4 ) , } cocci_id@p ;
...
position p;
@@
 const struct fwdb_rule * cocci_id@p ;
...
position p;
@@
 struct reg_regdb_apply_request * cocci_id@p ;
...
position p;
@@
 enum ieee80211_regd_source cocci_id@p ;
...
position p;
@@
 enum environment_cap cocci_id@p ;
...
position p;
@@
 struct reg_regdb_apply_request {  struct list_head list ;  const struct ieee80211_regdomain * regdom ; } cocci_id@p ;
...
position p;
@@
 const struct ieee80211_wmm_rule * cocci_id@p ;
...
position p;
@@
 struct ieee80211_wmm_ac * cocci_id@p ;
...
position p;
@@
 enum reg_request_treatment { REG_REQ_OK , REG_REQ_IGNORE , REG_REQ_INTERSECT , REG_REQ_ALREADY_SET , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct ieee80211_regdomain * rd ) ;
...
position p;
@@
 struct ieee80211_wmm_rule * cocci_id@p ;
...
position p;
@@
 const enum nl80211_dfs_regions cocci_id@p ;
...
position p;
@@
 const struct fwdb_header * cocci_id@p ;
...
position p;
@@
 enum ieee80211_regulatory_flags cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( bool reset_user , bool cached ) ;
...
position p;
@@
 enum nl80211_dfs_state cocci_id@p ;
