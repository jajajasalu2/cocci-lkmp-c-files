...
typedef bool,u16;
@@
 struct ina209_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  u16 regs [ INA209_REGISTERS ] ;  u16 config_orig ;  u16 calibration_orig ;  u16 update_interval ; } cocci_id@p ;
