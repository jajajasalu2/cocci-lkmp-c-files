...
position p;
@@
 struct hci_ev_si_device cocci_id@p ;
...
position p;
@@
 struct sockaddr_hci * cocci_id@p ;
...
position p;
@@
 struct hci_ev_stack_internal * cocci_id@p ;
...
typedef __u32;
@@
 struct hci_pinfo {  struct bt_sock bt ;  struct hci_dev * hdev ;  struct hci_filter filter ;  __u32 cmsg_mask ;  unsigned short channel ;  unsigned long flags ;  __u32 cookie ;  char comm [ TASK_COMM_LEN ] ; } cocci_id@p ;
...
position p;
@@
 const struct hci_sec_filter cocci_id@p ;
...
position p;
@@
 struct hci_mon_new_index * cocci_id@p ;
...
typedef __u32;
@@
 struct hci_sec_filter {  __u32 type_mask ;  __u32 event_mask [ 2 ] ;  __u32 ocf_mask [ HCI_SFLT_MAX_OGF + 1 ] [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct bt_sock_list cocci_id@p ;
...
position p;
@@
 struct hci_mon_index_info * cocci_id@p ;
