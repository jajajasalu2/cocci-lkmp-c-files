...
position p;
@@
 struct ni_670x_private * cocci_id@p ;
...
position p;
@@
 struct ni_670x_private {  int boardtype ;  int dio ; } cocci_id@p ;
...
position p;
@@
 struct ni_670x_board {  const char * name ;  unsigned short ao_chans ; } cocci_id@p ;
...
position p;
@@
 const struct ni_670x_board * cocci_id@p ;
...
position p;
@@
 enum ni_670x_boardid { BOARD_PCI6703 , BOARD_PXI6704 , BOARD_PCI6704 , } cocci_id@p ;
