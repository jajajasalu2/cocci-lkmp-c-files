...
position p;
@@
 struct axp20x_pctl {  struct gpio_chip chip ;  struct regmap * regmap ;  struct pinctrl_dev * pctl_dev ;  struct device * dev ;  const struct axp20x_pctrl_desc * desc ;  struct axp20x_pinctrl_function funcs [ AXP20X_FUNCS_NB ] ; } cocci_id@p ;
...
position p;
@@
 struct axp20x_pinctrl_function * cocci_id@p ;
...
position p;
@@
 struct axp20x_pinctrl_function {  const char * name ;  unsigned int muxval ;  const char * * groups ;  unsigned int ngroups ; } cocci_id@p ;
...
position p;
@@
 const struct axp20x_pctrl_desc cocci_id@p ;
...
typedef u8;
@@
 struct axp20x_pctrl_desc {  const struct pinctrl_pin_desc * pins ;  unsigned int npins ;  u8 ldo_mask ;  u8 adc_mask ;  u8 gpio_status_offset ;  u8 adc_mux ; } cocci_id@p ;
