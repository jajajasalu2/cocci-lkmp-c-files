...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_GACT_MAX + 1 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct tcf_gact * gact ) ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_GACT_MAX + 1 ] ;
