...
typedef u32;
@@
 struct vin_coeff {  unsigned short xs_value ;  u32 coeff_set [ 24 ] ; } cocci_id@p ;
...
position p;
@@
 struct rvin_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 const struct vin_coeff cocci_id@p [ ] ;
