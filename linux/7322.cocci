...
position p;
@@
 struct ams369fg06 {  struct device * dev ;  struct spi_device * spi ;  unsigned int power ;  struct lcd_device * ld ;  struct backlight_device * bd ;  struct lcd_platform_data * lcd_pd ; } cocci_id@p ;
...
position p;
@@
 struct ams369fg06_gamma {  unsigned int * gamma_22_table [ MAX_GAMMA_LEVEL ] ; } cocci_id@p ;
...
position p;
@@
 struct ams369fg06_gamma cocci_id@p ;
...
position p;
@@
 struct lcd_platform_data * cocci_id@p ;
