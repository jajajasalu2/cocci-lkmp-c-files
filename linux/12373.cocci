...
position p;
@@
 enum mixer_version_id { MXR_VER_0_0_0_16 , MXR_VER_16_0_33_0 , MXR_VER_128_0_0_184 , } cocci_id@p ;
...
position p;
@@
 struct mixer_context * cocci_id@p ;
...
position p;
@@
 const struct {  int hdisplay , vdisplay , htotal , vtotal , scan_val ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct mixer_drv_data cocci_id@p ;
...
position p;
@@
 const struct exynos_drm_plane_config cocci_id@p [ MIXER_WIN_NR ] ;
...
typedef bool;
@@
 struct mixer_drv_data {  enum mixer_version_id version ;  bool is_vp_enabled ;  bool has_sclk ; } cocci_id@p ;
...
position p;
@@
 enum mixer_flag_bits { MXR_BIT_POWERED , MXR_BIT_VSYNC , MXR_BIT_INTERLACE , MXR_BIT_VP_ENABLED , MXR_BIT_HAS_SCLK , } cocci_id@p ;
