...
position p;
@@
 struct i915_ext_attribute cocci_id@p ;
...
position p;
@@
 struct i915_str_attribute {  struct device_attribute attr ;  const char * str ; } cocci_id@p ;
...
position p;
@@
 const struct {  enum drm_i915_pmu_engine_sample sample ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct i915_ext_attribute {  struct device_attribute attr ;  unsigned long val ; } cocci_id@p ;
...
position p;
@@
 enum drm_i915_pmu_engine_sample cocci_id@p ;
...
position p;
@@
 struct intel_engine_pmu * cocci_id@p ;
...
position p;
@@
 struct i915_str_attribute cocci_id@p ;
...
position p;
@@
 struct i915_pmu_sample * cocci_id@p ;
...
typedef u64;
@@
 const struct {  u64 config ;  const char * name ;  const char * unit ; } cocci_id@p [ ] ;
