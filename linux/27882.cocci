...
position p;
@@
 struct ovl_cu_creds * cocci_id@p ;
...
position p;
@@
 struct ovl_cu_creds {  const struct cred * old ;  struct cred * new ; } cocci_id@p ;
...
position p;
@@
 struct ovl_copy_up_ctx cocci_id@p ;
...
typedef bool;
@@
 struct ovl_copy_up_ctx {  struct dentry * parent ;  struct dentry * dentry ;  struct path lowerpath ;  struct kstat stat ;  struct kstat pstat ;  const char * link ;  struct dentry * destdir ;  struct qstr destname ;  struct dentry * workdir ;  bool origin ;  bool indexed ;  bool metacopy ; } cocci_id@p ;
...
position p;
@@
 const struct ovl_fh * cocci_id@p ;
