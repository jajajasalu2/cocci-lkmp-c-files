...
position p;
@@
 struct svc_xprt_class cocci_id@p ;
...
position p;
@@
 struct svc_sock * cocci_id@p ( struct svc_serv * , struct socket * , int flags ) ;
...
position p;
@@
 int cocci_id@p ( struct svc_rqst * ) ;
...
position p;
@@
 union svc_pktinfo_u {  struct in_pktinfo pkti ;  struct in6_pktinfo pkti6 ; } cocci_id@p ;
...
position p;
@@
 const struct svc_xprt_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct svc_xprt * ) ;
...
position p;
@@
 struct svc_xprt * cocci_id@p ( struct svc_serv * , int , struct net * , struct sockaddr * , int , int ) ;
...
position p;
@@
 union svc_pktinfo_u cocci_id@p ;
...
position p;
@@
 union {  struct cmsghdr hdr ;  long all [ SVC_PKTINFO_SPACE / sizeof ( long ) ] ; } cocci_id@p ;
