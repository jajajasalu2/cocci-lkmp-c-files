...
position p;
@@
 struct ieee80211_local * cocci_id@p ;
...
position p;
@@
 struct ieee80211_tx_queue_params * cocci_id@p ;
...
position p;
@@
 struct ieee80211_ch_switch_timing cocci_id@p ;
...
position p;
@@
 const struct ieee80211_tim_ie * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_vht_operation * cocci_id@p ;
...
position p;
@@
 struct ieee80211_if_managed * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ NUM_NL80211_BANDS ] ;
...
position p;
@@
 struct ieee80211_noa_data * cocci_id@p ;
...
position p;
@@
 struct ieee80211_if_mesh * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_cipher_scheme * cocci_id@p ;
...
position p;
@@
 struct ieee80211_bssid_index cocci_id@p ;
...
position p;
@@
 struct ieee80211_channel_sw_ie cocci_id@p ;
...
position p;
@@
 struct ieee80211_vht_operation * cocci_id@p ;
...
position p;
@@
 enum queue_stop_reason cocci_id@p ;
...
position p;
@@
 const struct ieee80211_wmm_ac * cocci_id@p ;
...
position p;
@@
 struct ieee80211_timeout_interval_ie cocci_id@p ;
...
position p;
@@
 struct ieee802_11_elems * cocci_id@p ;
...
position p;
@@
 struct ieee80211_sub_if_data * cocci_id@p ;
...
position p;
@@
 struct ieee80211_ext_chansw_ie cocci_id@p ;
...
position p;
@@
 enum ieee80211_smps_mode cocci_id@p ;
...
@@
 ...
 __acquires ( & local -> queue_stop_reason_lock ) cocci_id@p ;
...
position p;
@@
 enum ieee80211_chanctx_mode cocci_id@p ;
...
position p;
@@
 struct ieee80211_chanctx cocci_id@p ;
...
position p;
@@
 struct ieee80211_addba_ext_ie cocci_id@p ;
...
position p;
@@
 struct ieee80211_key * cocci_id@p ;
...
position p;
@@
 struct ieee80211_he_operation * cocci_id@p ;
...
position p;
@@
 struct ieee80211_tdls_lnkie cocci_id@p ;
...
position p;
@@
 struct ieee80211_meshconf_ie cocci_id@p ;
...
position p;
@@
 struct ieee80211_sec_chan_offs_ie cocci_id@p ;
...
position p;
@@
 struct ieee80211_tx_data * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_ht_operation * cocci_id@p ;
...
position p;
@@
 struct ieee80211_if_ibss * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_p2p_noa_desc * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ IEEE80211_NUM_ACS ] ;
...
position p;
@@
 const struct ieee80211_p2p_noa_attr * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * data , struct ieee80211_sta * sta ) ;
...
position p;
@@
 const struct ieee80211_mcs_info * cocci_id@p ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( void * data , u8 * mac , struct ieee80211_vif * vif ) ;
...
position p;
@@
 struct ieee80211_rann_ie cocci_id@p ;
