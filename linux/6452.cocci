...
typedef u8,u32;
@@
 struct as3722_register_mapping {  u8 regulator_id ;  const char * name ;  const char * sname ;  u8 vsel_reg ;  u8 vsel_mask ;  int n_voltages ;  u32 enable_reg ;  u8 enable_mask ;  u32 control_reg ;  u8 mode_mask ;  u32 sleep_ctrl_reg ;  u8 sleep_ctrl_mask ; } cocci_id@p ;
...
position p;
@@
 struct as3722_regulators {  struct device * dev ;  struct as3722 * as3722 ;  struct regulator_desc desc [ AS3722_REGULATOR_ID_MAX ] ;  struct as3722_regulator_config_data reg_config_data [ AS3722_REGULATOR_ID_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct as3722_regulator_config_data * cocci_id@p ;
...
position p;
@@
 const struct as3722_register_mapping cocci_id@p [ ] ;
...
position p;
@@
 const struct regulator_linear_range cocci_id@p [ ] ;
...
position p;
@@
 struct of_regulator_match cocci_id@p [ ] ;
...
position p;
@@
 struct as3722_regulators * cocci_id@p ;
...
typedef bool;
@@
 struct as3722_regulator_config_data {  struct regulator_init_data * reg_init ;  bool enable_tracking ;  int ext_control ; } cocci_id@p ;
