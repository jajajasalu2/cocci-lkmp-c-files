...
symbol cocci_id;
position p;
typedef bpf_convert_ctx_access_t;
@@
 bpf_convert_ctx_access_t cocci_id@p ;
...
position p;
@@
 const struct bpf_func_state * cocci_id@p ;
...
position p;
@@
 const struct bpf_insn * cocci_id@p ;
...
position p;
@@
 const struct bpf_verifier_env * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,s64;
@@
 struct bpf_call_arg_meta {  struct bpf_map * map_ptr ;  bool raw_mode ;  bool pkt_access ;  int regno ;  int access_size ;  s64 msize_smax_value ;  u64 msize_umax_value ;  int ref_obj_id ;  int func_id ;  u32 btf_id ; } cocci_id@p ;
...
position p;
@@
 void * ( * cocci_id@p ) ( struct bpf_map * map , void * key ) ;
...
position p;
@@
 struct bpf_func_state * cocci_id@p ;
...
position p;
@@
 struct bpf_jit_poke_descriptor cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct bpf_map * map , void * key ) ;
...
position p;
@@
 struct bpf_stack_state cocci_id@p ;
...
position p;
@@
 struct bpf_insn_access_aux cocci_id@p ;
...
position p;
@@
 struct bpf_reg_state cocci_id@p ;
...
position p;
@@
 const struct bpf_verifier_ops * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bpf_reg_state * reg ) ;
...
position p;
@@
 struct bpf_trampoline * cocci_id@p ;
...
position p;
@@
 struct bpf_verifier_state_list cocci_id@p ;
...
position p;
@@
 struct bpf_verifier_stack_elem cocci_id@p ;
...
position p;
@@
 struct bpf_func_info_aux * cocci_id@p ;
...
position p;
@@
 struct bpf_insn_aux_data cocci_id@p ;
...
position p;
@@
 const struct bpf_reg_state * cocci_id@p ;
...
position p;
@@
 enum bpf_reg_liveness cocci_id@p ;
...
position p;
@@
 struct bpf_prog_aux * cocci_id@p ;
...
position p;
@@
 const struct bpf_map_ops * cocci_id@p ;
...
position p;
@@
 struct bpf_verifier_stack_elem {  struct bpf_verifier_state st ;  int insn_idx ;  int prev_insn_idx ;  struct bpf_verifier_stack_elem * next ; } cocci_id@p ;
...
position p;
@@
 const struct bpf_verifier_state * cocci_id@p ;
...
position p;
@@
 struct bpf_call_arg_meta * cocci_id@p ;
...
position p;
@@
 const struct bpf_func_proto * cocci_id@p ;
...
position p;
@@
 const struct bpf_verifier_ops * const cocci_id@p [ ] ;
...
position p;
@@
 struct bpf_verifier_env cocci_id@p ;
...
position p;
@@
 struct bpf_idx_pair * cocci_id@p ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct bpf_map * map , void * value , u64 flags ) ;
...
position p;
@@
 enum reg_arg_type { SRC_OP , DST_OP , DST_OP_NO_MARK , } cocci_id@p ;
...
position p;
@@
 const struct bpf_call_arg_meta * cocci_id@p ;
...
position p;
@@
 struct bpf_func_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MAX_CALL_FRAMES ] ;
...
position p;
@@
 const union bpf_attr * cocci_id@p ;
...
position p;
@@
 const struct bpf_prog * cocci_id@p ;
...
position p;
@@
 struct bpf_line_info * cocci_id@p ;
...
position p;
@@
 const struct bpf_insn_cbs cocci_id@p ;
...
typedef u32;
@@
 struct idpair {  u32 old ;  u32 cur ; } cocci_id@p ;
...
position p;
@@
 struct bpf_verifier_log * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ CALLER_SAVED_REGS ] ;
...
position p;
@@
 struct bpf_verifier_state cocci_id@p ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct bpf_map * map , void * key , void * value , u64 flags ) ;
...
position p;
@@
 struct bpf_subprog_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BPF_REG_SIZE + 1 ] ;
...
position p;
@@
 enum { DISCOVERED = 0x10 , EXPLORED = 0x20 , FALLTHROUGH = 1 , BRANCH = 2 , } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct bpf_map * map , void * value ) ;
...
position p;
@@
 const struct bpf_line_info * cocci_id@p ;
...
position p;
@@
 struct bpf_flow_keys cocci_id@p ;
...
position p;
@@
 struct bpf_spin_lock cocci_id@p ;
...
position p;
@@
 const struct bpf_insn_aux_data * cocci_id@p ;
...
position p;
@@
 enum bpf_access_type cocci_id@p ;
