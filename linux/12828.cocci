...
typedef u32;
@@
 struct dpfe_firmware_header {  u32 magic ;  u32 sequence ;  u32 version ;  u32 imem_size ;  u32 dmem_size ; } cocci_id@p ;
...
typedef bool;
@@
 struct init_data {  unsigned int dmem_len ;  unsigned int imem_len ;  unsigned int chksum ;  bool is_big_endian ; } cocci_id@p ;
...
position p;
@@
 struct brcmstb_dpfe_priv {  void __iomem * regs ;  void __iomem * dmem ;  void __iomem * imem ;  struct device * dev ;  const struct dpfe_api * dpfe_api ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 const struct dpfe_firmware_header * cocci_id@p ;
...
position p;
@@
 enum dpfe_commands { DPFE_CMD_GET_INFO , DPFE_CMD_GET_REFRESH , DPFE_CMD_GET_VENDOR , DPFE_CMD_MAX , } cocci_id@p ;
...
position p;
@@
 const struct dpfe_api cocci_id@p ;
...
position p;
@@
 enum dpfe_msg_fields { MSG_HEADER , MSG_COMMAND , MSG_ARG_COUNT , MSG_ARG0 , MSG_FIELD_MAX = 16 , } cocci_id@p ;
...
position p;
@@
 struct dpfe_firmware_header * cocci_id@p ;
...
position p;
@@
 struct brcmstb_dpfe_priv * cocci_id@p ;
...
typedef u32;
@@
 struct dpfe_api {  int version ;  const char * fw_name ;  const struct attribute_group * * sysfs_attrs ;  u32 command [ DPFE_CMD_MAX ] [ MSG_FIELD_MAX ] ; } cocci_id@p ;
