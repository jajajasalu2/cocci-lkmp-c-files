...
position p;
@@
 union TCP_WATCH_ADDR_H_BITS * cocci_id@p ;
...
position p;
@@
 struct HsaDbgWaveMsgAMDGen2 * cocci_id@p ;
...
position p;
@@
 union TCP_WATCH_ADDR_L_BITS * cocci_id@p ;
...
position p;
@@
 union ULARGE_INTEGER cocci_id@p ;
...
position p;
@@
 const struct dbg_address_watch_info * cocci_id@p ;
...
position p;
@@
 union GRBM_GFX_INDEX_BITS * cocci_id@p ;
