...
position p;
@@
 struct brcm_usb_phy_data * cocci_id@p ;
...
typedef bool;
@@
 struct brcm_usb_phy_data {  struct brcm_usb_init_params ini ;  bool has_eohci ;  bool has_xhci ;  struct clk * usb_20_clk ;  struct clk * usb_30_clk ;  struct mutex mutex ;  int init_count ;  struct brcm_usb_phy phys [ BRCM_USB_PHY_ID_MAX ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct brcm_usb_phy {  struct phy * phy ;  unsigned int id ;  bool inited ; } cocci_id@p ;
...
position p;
@@
 struct brcm_usb_phy * cocci_id@p ;
...
position p;
@@
 struct value_to_name_map * cocci_id@p ;
...
position p;
@@
 struct value_to_name_map {  int value ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 enum brcm_usb_phy_id { BRCM_USB_PHY_2_0 = 0 , BRCM_USB_PHY_3_0 , BRCM_USB_PHY_ID_MAX , } cocci_id@p ;
