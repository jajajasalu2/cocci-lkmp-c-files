...
position p;
@@
 struct MessageUnit_B * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct AdapterControlBlock * acb ) ;
...
position p;
@@
 struct MessageUnit_D cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct AdapterControlBlock * acb ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct AdapterControlBlock * acb , u32 intmask_org ) ;
...
position p;
@@
 int cocci_id@p ( struct AdapterControlBlock * acb , struct scsi_cmnd * cmd ) ;
...
position p;
@@
 struct CMD_MESSAGE_FIELD * cocci_id@p ;
...
position p;
@@
 struct AdapterControlBlock * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct AdapterControlBlock * acb ) ;
...
position p;
@@
 void cocci_id@p ( struct pci_dev * , struct AdapterControlBlock * ) ;
...
position p;
@@
 struct CommandControlBlock cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint16_t,uint32_t,uint8_t;
@@
 union {  struct {  uint16_t signature ;  uint8_t year ;  uint8_t month ;  uint8_t date ;  uint8_t hour ;  uint8_t minute ;  uint8_t second ; } a ;  struct {  uint32_t msg_time [ 2 ] ; } b ; } cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( struct AdapterControlBlock * acb ) ;
...
position p;
@@
 void cocci_id@p ( struct AdapterControlBlock * pACB ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct AdapterControlBlock * acb ) ;
...
position p;
@@
 struct deliver_completeQ cocci_id@p ;
