...
typedef u8,bool;
@@
 struct max197_data {  struct max197_platform_data * pdata ;  struct device * hwmon_dev ;  struct mutex lock ;  int limit ;  bool scale ;  u8 ctrl_bytes [ MAX197_NUM_CH ] ; } cocci_id@p ;
...
position p;
@@
 struct max197_platform_data * cocci_id@p ;
...
position p;
@@
 enum max197_chips { max197 , max199 , } cocci_id@p ;
