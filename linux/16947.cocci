...
typedef u8;
@@
 u8 cocci_id@p [ ZET6223_CMD_INFO_LENGTH ] ;
...
typedef u8,u16;
@@
 struct zet6223_ts {  struct i2c_client * client ;  struct input_dev * input ;  struct regulator * vcc ;  struct regulator * vio ;  struct touchscreen_properties prop ;  struct regulator_bulk_data supplies [ 2 ] ;  u16 max_x ;  u16 max_y ;  u8 fingernum ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ZET6223_MAX_PKT_SIZE ] ;
