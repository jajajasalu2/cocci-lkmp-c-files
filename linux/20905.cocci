...
position p;
@@
 struct {  char zero ;  int pid ;  int usecs ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct request_v3 {  uint32_t magic ;  uint32_t version ;  enum request_type type ;  struct sockaddr_un sock ; } cocci_id@p ;
...
position p;
@@
 enum request_type { REQ_NEW_CONTROL , } cocci_id@p ;
