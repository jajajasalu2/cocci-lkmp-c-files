...
position p;
@@
 const struct dwmac5_error_desc * cocci_id@p ;
...
position p;
@@
 const struct dwmac5_error_desc cocci_id@p [ 32 ] ;
...
position p;
@@
 const struct dwmac5_error {  const struct dwmac5_error_desc * desc ; } cocci_id@p [ ] ;
...
typedef bool;
@@
 struct dwmac5_error_desc {  bool valid ;  const char * desc ;  const char * detailed_desc ; } cocci_id@p ;
