...
position p;
@@
 struct uclogic_params_pen * cocci_id@p ;
...
position p;
@@
 struct uclogic_params_frame * cocci_id@p ;
...
position p;
@@
 const struct uclogic_params * cocci_id@p ;
...
typedef s32;
@@
 s32 cocci_id@p [ UCLOGIC_RDESC_PEN_PH_ID_NUM ] ;
...
position p;
@@
 enum uclogic_params_pen_inrange cocci_id@p ;
