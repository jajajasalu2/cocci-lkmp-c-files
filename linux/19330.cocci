...
typedef pte_t;
@@
 pte_t cocci_id@p ( unsigned long addr ) ;
...
position p;
@@
 int cocci_id@p ( struct pt_regs * regs , unsigned long addr ) ;
...
typedef pte_t;
@@
 pte_t cocci_id@p ( struct mm_struct * mm , unsigned long addr ) ;
