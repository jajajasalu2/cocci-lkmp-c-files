...
@@
 struct rfkill_data {  struct list_head list ;  struct list_head events ;  struct mutex mtx ;  wait_queue_head_t read_wait ;  bool input_handler ; } cocci_id@p ;
...
position p;
@@
 struct rfkill_int_event * cocci_id@p ;
...
position p;
@@
 struct rfkill_event * cocci_id@p ;
...
position p;
@@
 enum rfkill_operation cocci_id@p ;
...
position p;
@@
 struct rfkill_int_event {  struct list_head list ;  struct rfkill_event ev ; } cocci_id@p ;
...
typedef bool;
@@
 struct {  bool cur , sav ; } cocci_id@p [ NUM_RFKILL_TYPES ] ;
