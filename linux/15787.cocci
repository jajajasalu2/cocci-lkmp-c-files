...
position p;
@@
 int cocci_id@p ( struct usb_interface * pusb_intf , const struct usb_device_id * pdid ) ;
...
position p;
@@
 void cocci_id@p ( struct usb_interface * pusb_intf ) ;
...
position p;
@@
 struct drv_priv {  struct usb_driver r871xu_drv ;  int drv_registered ; } cocci_id@p ;
...
position p;
@@
 struct specific_device_id cocci_id@p [ ] ;
