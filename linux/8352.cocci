...
position p;
@@
 struct nfp_crypto_reply_simple * cocci_id@p ;
...
position p;
@@
 struct nfp_crypto_req_add_front * cocci_id@p ;
...
position p;
@@
 struct nfp_crypto_req_update * cocci_id@p ;
...
position p;
@@
 struct nfp_crypto_req_del * cocci_id@p ;
...
position p;
@@
 struct nfp_crypto_req_add_back * cocci_id@p ;
...
position p;
@@
 const struct tlsdev_ops cocci_id@p ;
...
position p;
@@
 struct nfp_crypto_req_add_v6 * cocci_id@p ;
...
position p;
@@
 struct nfp_crypto_req_add_v4 * cocci_id@p ;
...
position p;
@@
 enum tls_offload_ctx_dir cocci_id@p ;
...
position p;
@@
 struct nfp_crypto_req_reset * cocci_id@p ;
...
position p;
@@
 struct nfp_crypto_reply_add * cocci_id@p ;
