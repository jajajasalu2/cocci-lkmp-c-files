...
position p;
@@
 const struct dvb_tuner_ops cocci_id@p ;
...
typedef u8,u16;
@@
 u16 cocci_id@p ( struct dvb_frontend * fe , u8 * RegNum , u8 * RegVal , int * count ) ;
...
typedef u32,u16;
@@
 u16 cocci_id@p ( struct dvb_frontend * fe , u16 controlNum , u32 * value ) ;
...
typedef u8,u32,u16;
@@
 struct mxl5005s_state {  u8 Mode ;  u8 IF_Mode ;  u32 Chan_Bandwidth ;  u32 IF_OUT ;  u16 IF_OUT_LOAD ;  u32 RF_IN ;  u32 Fxtal ;  u8 AGC_Mode ;  u16 TOP ;  u8 CLOCK_OUT ;  u8 DIV_OUT ;  u8 CAPSELECT ;  u8 EN_RSSI ;  u8 Mod_Type ;  u8 TF_Type ;  u32 RF_LO ;  u32 IF_LO ;  u32 TG_LO ;  u16 Init_Ctrl_Num ;  struct TunerControl Init_Ctrl [ INITCTRL_NUM ] ;  u16 CH_Ctrl_Num ;  struct TunerControl CH_Ctrl [ CHCTRL_NUM ] ;  u16 MXL_Ctrl_Num ;  struct TunerControl MXL_Ctrl [ MXLCTRL_NUM ] ;  u16 TunerRegs_Num ;  struct TunerReg TunerRegs [ TUNER_REGS_NUM ] ;  struct mxl5005s_config * config ;  struct dvb_frontend * frontend ;  struct i2c_adapter * i2c ;  u32 current_mode ; } cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct dvb_frontend * fe ) ;
...
position p;
@@
 enum master_control_state { MC_LOAD_START = 1 , MC_POWER_DOWN , MC_SYNTH_RESET , MC_SEQ_OFF , } cocci_id@p ;
...
position p;
@@
 struct mxl5005s_state cocci_id@p ;
...
typedef u8,u16;
@@
 u16 cocci_id@p ( struct dvb_frontend * fe , u8 RegNum , u8 * RegVal ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ MXL5005S_REG_WRITING_TABLE_LEN_MAX ] ;
...
typedef u32;
@@
 int cocci_id@p ( struct dvb_frontend * fe , u32 mod_type , u32 bandwidth ) ;
...
position p;
@@
 enum { MXL5005S_BANDWIDTH_6MHZ = 6000000 , MXL5005S_BANDWIDTH_7MHZ = 7000000 , MXL5005S_BANDWIDTH_8MHZ = 8000000 , } cocci_id@p ;
...
typedef u16;
@@
 struct TunerReg {  u16 Reg_Num ;  u16 Reg_Val ; } cocci_id@p ;
...
position p;
@@
 enum { MXL5005S_STANDARD_DVBT , MXL5005S_STANDARD_ATSC , } cocci_id@p ;
...
typedef u32,u16;
@@
 u16 cocci_id@p ( struct dvb_frontend * fe , u32 RF_Freq ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct dvb_frontend * fe , u8 address , u8 bit , u8 bitVal ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( u32 value , u32 resolution ) ;
...
position p;
@@
 unsigned char cocci_id@p [ MXL5005S_REG_WRITING_TABLE_LEN_MAX ] ;
...
typedef u8,u16;
@@
 u16 cocci_id@p ( u8 * MasterReg , int state ) ;
...
position p;
@@
 enum { MXL_DEFAULT_MODULATION = 0 , MXL_DVBT , MXL_ATSC , MXL_QAM , MXL_ANALOG_CABLE , MXL_ANALOG_OTA , } cocci_id@p ;
...
typedef u8,u16;
@@
 u16 cocci_id@p ( struct dvb_frontend * fe , u8 GPIO_Num , u8 GPIO_Val ) ;
...
position p;
@@
 struct mxl5005s_config * cocci_id@p ;
...
position p;
@@
 struct dvb_tuner_ops cocci_id@p ;
...
typedef u16;
@@
 struct TunerControl {  u16 Ctrl_Num ;  u16 size ;  u16 addr [ 25 ] ;  u16 bit [ 25 ] ;  u16 val [ 25 ] ; } cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct dvb_frontend * fe , u8 * addrtable , u8 * datatable , u8 len ) ;
...
typedef u32,u16;
@@
 u16 cocci_id@p ( struct dvb_frontend * fe , u16 controlNum , u32 value , u16 controlGroup ) ;
