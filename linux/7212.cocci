...
position p;
@@
 struct {  enum nvme_ana_state state ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nvmet_ana_group * cocci_id@p ;
...
typedef u8;
@@
 const struct nvmet_transport_name {  u8 type ;  const char * name ; } cocci_id@p [ ] ;
