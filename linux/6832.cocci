...
position p;
@@
 struct aac_read_reply * cocci_id@p ;
...
position p;
@@
 struct aac_supplement_adapter_info * cocci_id@p ;
...
position p;
@@
 struct sge_ieee1212 * cocci_id@p ;
...
position p;
@@
 struct aac_hba_cmd_req * cocci_id@p ;
...
position p;
@@
 struct aac_power_management * cocci_id@p ;
...
position p;
@@
 struct aac_get_container_count * cocci_id@p ;
...
position p;
@@
 struct aac_synchronize * cocci_id@p ;
...
position p;
@@
 struct aac_bus_info_response * cocci_id@p ;
...
position p;
@@
 struct aac_get_name * cocci_id@p ;
...
position p;
@@
 struct aac_get_config_status cocci_id@p ;
...
position p;
@@
 struct fsa_dev_info * cocci_id@p ;
...
position p;
@@
 struct scsi_inq {  char vid [ 8 ] ;  char pid [ 16 ] ;  char prl [ 4 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct tvpd_id_descriptor_type_1 {  u8 codeset : 4 ;  u8 reserved : 4 ;  u8 identifiertype : 4 ;  u8 reserved2 : 4 ;  u8 reserved3 ;  u8 identifierlength ;  u8 venid [ 8 ] ;  u8 productid [ 16 ] ;  u8 serialnumber [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct aac_driver_ident * cocci_id@p ;
...
position p;
@@
 struct aac_srb_unit cocci_id@p ;
...
position p;
@@
 struct aac_synchronize_reply * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct aac_raw_io2 * rio2 , int pages , int nseg , int nseg_new ) ;
...
position p;
@@
 struct aac_ciss_identify_pd * * cocci_id@p ;
...
position p;
@@
 struct aac_commit_config cocci_id@p ;
...
position p;
@@
 struct aac_hba_resp * cocci_id@p ;
...
position p;
@@
 struct aac_get_serial_resp * cocci_id@p ;
...
position p;
@@
 struct aac_query_mount cocci_id@p ;
...
typedef u8;
@@
 struct tvpd_id_descriptor_type_3 {  u8 codeset : 4 ;  u8 reserved : 4 ;  u8 identifiertype : 4 ;  u8 reserved2 : 4 ;  u8 reserved3 ;  u8 identifierlength ;  u8 Identifier [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( struct scsi_cmnd * scsicmd , struct sgmap64 * psg ) ;
...
position p;
@@
 struct aac_query_disk cocci_id@p ;
...
position p;
@@
 struct aac_srb_status_info cocci_id@p [ ] ;
...
position p;
@@
 struct aac_get_config_status_resp * cocci_id@p ;
...
position p;
@@
 struct aac_ciss_phys_luns_resp cocci_id@p ;
...
position p;
@@
 struct aac_srb_reply * cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( struct scsi_cmnd * scsicmd , struct sgmap * sgmap ) ;
...
position p;
@@
 struct aac_adapter_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( ( ( struct inquiry_data * ) NULL ) -> inqd_pid ) ] ;
...
position p;
@@
 struct aac_bus_info * cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( struct scsi_cmnd * scsicmd , struct sgmapraw * psg ) ;
...
position p;
@@
 void cocci_id@p ( void * context , struct fib * fibptr ) ;
...
typedef u8;
@@
 struct inquiry_data {  u8 inqd_pdt ;  u8 inqd_dtq ;  u8 inqd_ver ;  u8 inqd_rdf ;  u8 inqd_len ;  u8 inqd_pad1 [ 2 ] ;  u8 inqd_pad2 ;  u8 inqd_vid [ 8 ] ;  u8 inqd_pid [ 16 ] ;  u8 inqd_prl [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct aac_delete_disk cocci_id@p ;
...
position p;
@@
 struct aac_get_name_resp cocci_id@p ;
...
typedef u32;
@@
 struct aac_srb_status_info {  u32 status ;  char * str ; } cocci_id@p ;
...
typedef u8;
@@
 struct tvpd_page83 {  u8 DeviceType : 5 ;  u8 DeviceTypeQualifier : 3 ;  u8 PageCode ;  u8 reserved ;  u8 PageLength ;  struct tvpd_id_descriptor_type_1 type1 ;  struct tvpd_id_descriptor_type_2 type2 ;  struct tvpd_id_descriptor_type_3 type3 ; } cocci_id@p ;
...
position p;
@@
 struct aac_get_serial * cocci_id@p ;
...
typedef u64;
@@
 long cocci_id@p ( struct scsi_cmnd * scsicmd , struct aac_hba_cmd_req * hbacmd , int sg_max , u64 sg_address ) ;
...
typedef u8,u32;
@@
 struct tvpd_id_descriptor_type_2 {  u8 codeset : 4 ;  u8 reserved : 4 ;  u8 identifiertype : 4 ;  u8 reserved2 : 4 ;  u8 reserved3 ;  u8 identifierlength ;  struct teu64id {  u32 Serial ;  u8 reserved ;  u8 venid [ 3 ] ; } eu64id ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct scsi_cmnd * ) ;
...
position p;
@@
 struct aac_native_hba * cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( struct scsi_cmnd * scsicmd , struct aac_raw_io2 * rio2 , int sg_max ) ;
...
position p;
@@
 struct aac_get_container_count_resp * cocci_id@p ;
