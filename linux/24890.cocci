...
position p;
@@
 void ( * cocci_id@p ) ( struct atm_vcc * vcc , struct sk_buff * skb ) ;
...
position p;
@@
 void cocci_id@p ( struct lec_priv * priv , struct atm_vcc * vcc , struct sk_buff * skb ) ;
...
typedef u8,u32;
@@
 int cocci_id@p ( struct net_device * dev , const u8 * lan_dst , const u8 * tlvs , u32 sizeoftlvs ) ;
...
typedef u8,u32;
@@
 int cocci_id@p ( struct net_device * dev , const u8 * dst_mac , int force , u8 * * tlvs , u32 * sizeoftlvs ) ;
...
position p;
@@
 void cocci_id@p ( struct lec_priv * priv , const unsigned char * mac_addr , const unsigned char * atm_addr , unsigned long remoteflag , unsigned int targetless_le_arp ) ;
...
position p;
@@
 void cocci_id@p ( struct lec_priv * priv ) ;
...
position p;
@@
 int cocci_id@p ( struct lec_priv * priv , struct lec_arp_table * to_remove ) ;
...
position p;
@@
 struct lec_state {  unsigned long flags ;  struct lec_priv * locked ;  struct hlist_node * node ;  struct net_device * dev ;  int itf ;  int arp_table ;  int misc_table ; } cocci_id@p ;
...
position p;
@@
 struct lecdatahdr_8023 * cocci_id@p ;
...
position p;
@@
 struct net_device * cocci_id@p [ MAX_LEC_ITF ] ;
...
typedef u8,u32;
@@
 void cocci_id@p ( struct net_device * dev , const u8 * mac_address , const u8 * tlvs , u32 sizeoftlvs ) ;
...
position p;
@@
 struct atm_skb_data cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lec_priv * priv , struct atm_vcc * vcc ) ;
...
position p;
@@
 void cocci_id@p ( struct lec_priv * priv , unsigned long tran_id ) ;
...
position p;
@@
 const struct atmlec_ioc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lec_priv * priv , const struct atmlec_ioc * ioc_data , struct atm_vcc * vcc , void ( * old_push ) ( struct atm_vcc * vcc , struct sk_buff * skb ) ) ;
...
position p;
@@
 struct lec_vcc_priv cocci_id@p ;
...
position p;
@@
 struct lec_arp_table cocci_id@p ;
...
position p;
@@
 struct atm_vcc * cocci_id@p ( struct lec_priv * priv , const unsigned char * mac_to_find , int is_rdesc , struct lec_arp_table * * ret_entry ) ;
...
position p;
@@
 int cocci_id@p ( struct lec_priv * priv , const unsigned char * atm_addr , unsigned long permanent ) ;
...
position p;
@@
 void cocci_id@p ( struct lec_priv * priv , struct atm_vcc * vcc ) ;
...
position p;
@@
 struct lec_arp_table * cocci_id@p ( struct lec_priv * priv , const unsigned char * mac_addr ) ;
...
position p;
@@
 const struct atmdev_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lec_priv * priv , const unsigned char * atm_addr , unsigned long tran_id ) ;
