...
position p;
@@
 struct kvec cocci_id@p [ CIFS_MAX_IOV_SIZE ] ;
...
position p;
@@
 const struct smb_hdr * cocci_id@p ;
...
position p;
@@
 struct cifs_credits cocci_id@p [ MAX_COMPOUND ] ;
...
symbol cocci_id;
position p;
typedef mid_callback_t;
@@
 mid_callback_t * cocci_id@p ;
...
position p;
@@
 struct smb_rqst cocci_id@p [ MAX_COMPOUND ] ;
...
symbol cocci_id;
position p;
typedef mid_handle_t;
@@
 mid_handle_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mid_receive_t;
@@
 mid_receive_t * cocci_id@p ;
