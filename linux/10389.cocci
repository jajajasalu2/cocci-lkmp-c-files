...
position p;
@@
 struct mtk_disp_rdma cocci_id@p ;
...
position p;
@@
 struct mtk_disp_rdma {  struct mtk_ddp_comp ddp_comp ;  struct drm_crtc * crtc ;  const struct mtk_disp_rdma_data * data ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_disp_rdma_data cocci_id@p ;
...
position p;
@@
 struct mtk_disp_rdma_data {  unsigned int fifo_size ; } cocci_id@p ;
