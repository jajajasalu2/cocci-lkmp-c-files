...
position p;
@@
 const struct pll_ctl cocci_id@p [ ] ;
...
position p;
@@
 struct coeff_ram_ctl * cocci_id@p ;
...
position p;
@@
 const struct regmap_range_cfg cocci_id@p ;
...
position p;
@@
 struct reg_setting {  unsigned int addr ;  unsigned int val ; } cocci_id@p ;
...
position p;
@@
 struct pll_ctl {  int freq_in ;  struct reg_setting settings [ PLL_REG_SETTINGS_COUNT ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct aifs_status {  u8 streams ; } cocci_id@p ;
...
position p;
@@
 struct pll {  int id ;  unsigned int users ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct coeff_ram_ctl {  unsigned int addr ;  struct soc_bytes_ext bytes_ext ; } cocci_id@p ;
...
position p;
@@
 struct internal_rate {  struct pll * pll ; } cocci_id@p ;
...
position p;
@@
 enum { TSCS454_DAI1_ID , TSCS454_DAI2_ID , TSCS454_DAI3_ID , TSCS454_DAI_COUNT , } cocci_id@p ;
...
position p;
@@
 struct tscs454 {  struct regmap * regmap ;  struct aif aifs [ TSCS454_DAI_COUNT ] ;  struct aifs_status aifs_status ;  struct mutex aifs_status_lock ;  struct pll pll1 ;  struct pll pll2 ;  struct internal_rate internal_rate ;  struct coeff_ram dac_ram ;  struct coeff_ram spk_ram ;  struct coeff_ram sub_ram ;  struct clk * sysclk ;  int sysclk_src_id ;  unsigned int bclk_freq ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct coeff_ram {  u8 cache [ COEFF_RAM_SIZE ] ;  bool synced ;  struct mutex lock ; } cocci_id@p ;
...
typedef bool;
@@
 struct aif {  unsigned int id ;  bool master ;  struct pll * pll ; } cocci_id@p ;
...
position p;
@@
 enum { PLL_INPUT_XTAL = 0 , PLL_INPUT_MCLK1 , PLL_INPUT_MCLK2 , PLL_INPUT_BCLK , } cocci_id@p ;
