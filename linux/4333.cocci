...
position p;
@@
 struct intel_hid_priv * cocci_id@p ;
...
position p;
@@
 enum intel_hid_dsm_fn_codes cocci_id@p ;
...
typedef bool;
@@
 struct intel_hid_priv {  struct input_dev * input_dev ;  struct input_dev * array ;  bool wakeup_mode ; } cocci_id@p ;
...
position p;
@@
 enum intel_hid_dsm_fn_codes { INTEL_HID_DSM_FN_INVALID , INTEL_HID_DSM_BTNL_FN , INTEL_HID_DSM_HDMM_FN , INTEL_HID_DSM_HDSM_FN , INTEL_HID_DSM_HDEM_FN , INTEL_HID_DSM_BTNS_FN , INTEL_HID_DSM_BTNE_FN , INTEL_HID_DSM_HEBC_V1_FN , INTEL_HID_DSM_VGBS_FN , INTEL_HID_DSM_HEBC_V2_FN , INTEL_HID_DSM_FN_MAX , } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ INTEL_HID_DSM_FN_MAX ] ;
