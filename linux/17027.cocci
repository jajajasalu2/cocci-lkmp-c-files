...
position p;
@@
 struct grip {  struct gameport * gameport ;  struct input_dev * dev [ 2 ] ;  unsigned char mode [ 2 ] ;  int reads ;  int bads ;  char phys [ 2 ] [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ GRIP_LENGTH_XT ] ;
