...
position p;
@@
 struct da9055_regulator {  struct da9055 * da9055 ;  struct da9055_regulator_info * info ;  struct regulator_dev * rdev ;  enum gpio_select reg_rselect ; } cocci_id@p ;
...
position p;
@@
 struct da9055_pdata * cocci_id@p ;
...
position p;
@@
 struct da9055_regulator_info * cocci_id@p ;
...
position p;
@@
 struct da9055_volt_reg {  int reg_a ;  int reg_b ;  int sl_shift ;  int v_mask ; } cocci_id@p ;
...
position p;
@@
 struct da9055_volt_reg cocci_id@p ;
...
position p;
@@
 struct da9055_regulator_info {  struct regulator_desc reg_desc ;  struct da9055_conf_reg conf ;  struct da9055_volt_reg volt ;  struct da9055_mode_reg mode ; } cocci_id@p ;
...
position p;
@@
 struct da9055_regulator cocci_id@p ;
...
position p;
@@
 struct da9055_mode_reg {  int reg ;  int mask ;  int shift ; } cocci_id@p ;
...
position p;
@@
 struct da9055_conf_reg {  int reg ;  int sel_mask ;  int en_mask ; } cocci_id@p ;
