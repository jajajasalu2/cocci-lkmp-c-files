...
position p;
@@
 struct ad7303_state * cocci_id@p ;
...
position p;
@@
 struct ad7303_platform_data * cocci_id@p ;
...
@@
 struct ad7303_state {  struct spi_device * spi ;  uint16_t config ;  uint8_t dac_cache [ 2 ] ;  struct regulator * vdd_reg ;  struct regulator * vref_reg ;  struct mutex lock ;  __be16 data ____cacheline_aligned ; } cocci_id@p ;
