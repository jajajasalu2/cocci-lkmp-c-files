...
position p;
@@
 struct blk_revalidate_zone_args * cocci_id@p ;
...
position p;
@@
 struct zone_report_args cocci_id@p ;
...
position p;
@@
 struct blk_zone_report cocci_id@p ;
...
typedef sector_t;
@@
 struct blk_revalidate_zone_args {  struct gendisk * disk ;  unsigned long * conv_zones_bitmap ;  unsigned long * seq_zones_wlock ;  unsigned int nr_zones ;  sector_t zone_sectors ;  sector_t sector ; } cocci_id@p ;
...
position p;
@@
 struct blk_zone_range cocci_id@p ;
...
position p;
@@
 struct zone_report_args {  struct blk_zone __user * zones ; } cocci_id@p ;
