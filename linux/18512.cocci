...
position p;
@@
 struct s3c64xx_spi_csinfo cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 id ;  u8 rev ;  const char * name ;  const struct i2c_board_info * i2c_devs ;  int num_i2c_devs ;  const struct spi_board_info * spi_devs ;  int num_spi_devs ;  struct gpiod_lookup_table * gpiod_table ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wm8996_retune_mobile_config cocci_id@p [ ] ;
...
position p;
@@
 struct wm0010_pdata cocci_id@p ;
