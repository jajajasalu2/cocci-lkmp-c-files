...
position p;
@@
 void cocci_id@p ( struct intel_encoder * intel_encoder , const struct intel_crtc_state * pipe_config ) ;
...
position p;
@@
 void cocci_id@p ( struct intel_encoder * encoder ) ;
...
position p;
@@
 struct intel_dsi_host * cocci_id@p ;
...
position p;
@@
 enum drm_panel_orientation cocci_id@p ;
