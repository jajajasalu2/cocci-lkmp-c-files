...
position p;
@@
 struct nfsacl_decode_desc * cocci_id@p ;
...
position p;
@@
 struct nfsacl_decode_desc {  struct xdr_array2_desc desc ;  unsigned int count ;  struct posix_acl * acl ; } cocci_id@p ;
...
position p;
@@
 struct nfsacl_simple_acl cocci_id@p ;
...
position p;
@@
 struct nfsacl_simple_acl {  struct posix_acl acl ;  struct posix_acl_entry ace [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct nfsacl_encode_desc * cocci_id@p ;
...
@@
 struct nfsacl_encode_desc {  struct xdr_array2_desc desc ;  unsigned int count ;  struct posix_acl * acl ;  int typeflag ;  kuid_t uid ;  kgid_t gid ; } cocci_id@p ;
...
position p;
@@
 const struct posix_acl_entry * cocci_id@p ;
...
position p;
@@
 struct xdr_array2_desc * cocci_id@p ;
