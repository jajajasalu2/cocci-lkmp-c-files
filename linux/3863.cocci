...
position p;
@@
 char cocci_id@p [ SEC_DBGFS_VAL_MAX_LEN ] ;
...
typedef u32;
@@
 struct sec_hw_error {  u32 int_msk ;  const char * msg ; } cocci_id@p ;
...
position p;
@@
 struct sec_debug_file * cocci_id@p ;
...
position p;
@@
 const struct sec_hw_error cocci_id@p [ ] ;
