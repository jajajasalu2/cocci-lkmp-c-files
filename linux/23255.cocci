...
position p;
@@
 struct rk3328_codec_priv * cocci_id@p ;
...
position p;
@@
 const struct rk3328_reg_msk_val cocci_id@p [ ] ;
...
position p;
@@
 struct rk3328_codec_priv {  struct regmap * regmap ;  struct regmap * grf ;  struct clk * mclk ;  struct clk * pclk ;  unsigned int sclk ;  int spk_depop_time ; } cocci_id@p ;
