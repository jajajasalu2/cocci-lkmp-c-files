...
position p;
@@
 union audio_sample_rates cocci_id@p ;
...
position p;
@@
 struct azalia_clock_info * cocci_id@p ;
...
position p;
@@
 const struct audio_funcs cocci_id@p ;
...
position p;
@@
 const struct audio_info * cocci_id@p ;
...
position p;
@@
 const struct audio_pll_info * cocci_id@p ;
...
position p;
@@
 const struct audio_mode * cocci_id@p ;
