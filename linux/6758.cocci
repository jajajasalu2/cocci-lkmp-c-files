...
symbol cocci_id;
position p;
typedef Mpi2PortFactsReply_t;
@@
 Mpi2PortFactsReply_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOCInitRequest_t;
@@
 Mpi2IOCInitRequest_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SGESimple32_t;
@@
 Mpi2SGESimple32_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2ReplyDescriptorsUnion_t;
@@
 Mpi2ReplyDescriptorsUnion_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi25IeeeSgeChain64_t;
@@
 Mpi25IeeeSgeChain64_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef MPI2RequestHeader_t;
@@
 MPI2RequestHeader_t * cocci_id@p ;
...
position p;
@@
 struct mpt3sas_facts cocci_id@p ;
...
position p;
@@
 struct chain_tracker cocci_id@p ;
...
position p;
@@
 struct mpt3sas_nvme_cmd * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SCSIIORequest_t;
@@
 Mpi2SCSIIORequest_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2ConfigRequest_t;
@@
 Mpi2ConfigRequest_t * cocci_id@p ;
...
position p;
@@
 enum mpt3sas_perf_mode { MPT_PERF_MODE_DEFAULT = - 1 , MPT_PERF_MODE_BALANCED = 0 , MPT_PERF_MODE_IOPS = 1 , MPT_PERF_MODE_LATENCY = 2 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2PortEnableReply_t;
@@
 Mpi2PortEnableReply_t * cocci_id@p ;
...
position p;
@@
 struct adapter_reply_queue cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2FWImageHeader_t;
@@
 Mpi2FWImageHeader_t cocci_id@p ;
...
position p;
@@
 struct irq_affinity * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SGESimple64_t;
@@
 Mpi2SGESimple64_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi26NVMeEncapsulatedRequest_t;
@@
 Mpi26NVMeEncapsulatedRequest_t cocci_id@p ;
...
position p;
@@
 struct request_tracker cocci_id@p ;
...
position p;
@@
 void * cocci_id@p [ MCPU_MAX_CHAINS_PER_IO ] ;
...
symbol cocci_id;
position p;
typedef Mpi25FWUploadRequest_t;
@@
 Mpi25FWUploadRequest_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2FWUploadReply_t;
@@
 Mpi2FWUploadReply_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2RequestDescriptorUnion_t;
@@
 Mpi2RequestDescriptorUnion_t cocci_id@p ;
...
position p;
@@
 MPT_CALLBACK cocci_id@p [ MPT_MAX_CALLBACKS ] ;
...
symbol cocci_id;
position p;
typedef Mpi26AtomicRequestDescriptor_t;
@@
 Mpi26AtomicRequestDescriptor_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOCInitReply_t;
@@
 Mpi2IOCInitReply_t cocci_id@p ;
...
position p;
@@
 struct mpt3sas_port_facts * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOCPage1_t;
@@
 Mpi2IOCPage1_t cocci_id@p ;
...
typedef u64,u32;
@@
 union reply_descriptor {  u64 word ;  struct {  u32 low ;  u32 high ; } u ; } cocci_id@p ;
...
position p;
@@
 struct chain_lookup cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOCFactsReply_t;
@@
 Mpi2IOCFactsReply_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2PortEnableRequest_t;
@@
 Mpi2PortEnableRequest_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2PortFactsRequest_t;
@@
 Mpi2PortFactsRequest_t cocci_id@p ;
...
position p;
@@
 union reply_descriptor cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOCFactsRequest_t;
@@
 Mpi2IOCFactsRequest_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct MPT3SAS_ADAPTER * ioc ) ;
...
symbol cocci_id;
position p;
typedef Mpi2EventNotificationRequest_t;
@@
 Mpi2EventNotificationRequest_t * cocci_id@p ;
...
position p;
@@
 struct reply_post_struct * cocci_id@p ;
...
position p;
@@
 struct pcie_sg_list cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi26ComponentImageHeader_t;
@@
 Mpi26ComponentImageHeader_t * cocci_id@p ;
