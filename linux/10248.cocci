...
typedef bool;
@@
 struct vga_switcheroo_client {  struct pci_dev * pdev ;  struct fb_info * fb_info ;  enum vga_switcheroo_state pwr_state ;  const struct vga_switcheroo_client_ops * ops ;  enum vga_switcheroo_client_id id ;  bool active ;  bool driver_power_control ;  struct list_head list ;  struct pci_dev * vga_dev ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vgasr_priv * priv ) ;
...
position p;
@@
 struct vga_switcheroo_client * cocci_id@p ;
