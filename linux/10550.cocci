...
position p;
@@
 enum hrtimer_restart cocci_id@p ( struct hrtimer * hrtimer ) ;
...
position p;
@@
 const struct i915_perf_stream_ops cocci_id@p ;
...
position p;
@@
 struct drm_i915_perf_open_param * cocci_id@p ;
...
position p;
@@
 struct i915_oa_config * cocci_id@p ;
...
position p;
@@
 struct i915_oa_config_bo {  struct llist_node node ;  struct i915_oa_config * oa_config ;  struct i915_vma * vma ; } cocci_id@p ;
...
position p;
@@
 const struct i915_oa_reg * cocci_id@p ;
...
position p;
@@
 const struct i915_oa_config * cocci_id@p ;
...
position p;
@@
 struct drm_i915_perf_record_header cocci_id@p ;
...
@@
 struct flex {  i915_reg_t reg ;  u32 offset ;  u32 value ; } cocci_id@p ;
...
position p;
@@
 enum drm_i915_perf_record_type cocci_id@p ;
...
position p;
@@
 struct i915_perf_stream * cocci_id@p ;
...
position p;
@@
 struct perf_open_properties cocci_id@p ;
...
@@
 struct perf_open_properties {  u32 sample_flags ;  u64 single_context : 1 ;  u64 hold_preemption : 1 ;  u64 ctx_handle ;  int metrics_set ;  int oa_format ;  bool oa_periodic ;  int oa_period_exponent ;  struct intel_engine_cs * engine ; } cocci_id@p ;
...
position p;
@@
 enum drm_i915_perf_property_id cocci_id@p ;
...
position p;
@@
 struct drm_i915_perf_oa_config * cocci_id@p ;
...
typedef bool,u32;
@@
 bool ( * cocci_id@p ) ( struct i915_perf * perf , u32 addr ) ;
...
position p;
@@
 struct i915_oa_config_bo * cocci_id@p ;
...
position p;
@@
 const struct i915_oa_format cocci_id@p [ I915_OA_FORMAT_MAX ] ;
...
position p;
@@
 enum { START_TS , NOW_TS , DELTA_TS , JUMP_PREDICATE , DELTA_TARGET , N_CS_GPR , } cocci_id@p ;
...
position p;
@@
 const struct i915_perf_stream * cocci_id@p ;
