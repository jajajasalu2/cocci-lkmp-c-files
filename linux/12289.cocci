...
typedef u32;
@@
 struct tpg110 {  struct device * dev ;  struct spi_device * spi ;  struct drm_panel panel ;  struct backlight_device * backlight ;  const struct tpg110_panel_mode * panel_mode ;  u32 width ;  u32 height ;  struct gpio_desc * grestb ; } cocci_id@p ;
...
typedef u32;
@@
 struct tpg110_panel_mode {  const char * name ;  u32 magic ;  struct drm_display_mode mode ;  u32 bus_flags ; } cocci_id@p ;
...
position p;
@@
 const struct tpg110_panel_mode cocci_id@p [ ] ;
