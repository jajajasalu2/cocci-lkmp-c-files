...
position p;
@@
 struct hinic_api_cmd_cell * cocci_id@p ;
...
position p;
@@
 struct hinic_api_cmd_cell_ctxt * cocci_id@p ;
...
position p;
@@
 enum api_cmd_data_format { SGE_DATA = 1 , } cocci_id@p ;
...
position p;
@@
 struct hinic_api_cmd_status * cocci_id@p ;
...
position p;
@@
 struct hinic_api_cmd_chain_attr * cocci_id@p ;
...
position p;
@@
 enum hinic_api_cmd_chain_type cocci_id@p ;
...
position p;
@@
 enum api_cmd_type { API_CMD_WRITE = 0 , } cocci_id@p ;
...
position p;
@@
 enum api_cmd_bypass { NO_BYPASS = 0 , BYPASS = 1 , } cocci_id@p ;
...
position p;
@@
 enum api_cmd_xor_chk_level { XOR_CHK_DIS = 0 , XOR_CHK_ALL = 3 , } cocci_id@p ;
