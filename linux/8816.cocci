...
position p;
@@
 struct stmmac_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
...
position p;
@@
 const struct stmmac_stats cocci_id@p [ ] ;
