...
position p;
@@
 struct nf_nat_range cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_NAT_MAX + 1 ] ;
...
position p;
@@
 const struct nft_nat * cocci_id@p ;
...
typedef u8,u16;
@@
 struct nft_nat {  enum nft_registers sreg_addr_min : 8 ;  enum nft_registers sreg_addr_max : 8 ;  enum nft_registers sreg_proto_min : 8 ;  enum nft_registers sreg_proto_max : 8 ;  enum nf_nat_manip_type type : 8 ;  u8 family ;  u16 flags ; } cocci_id@p ;
