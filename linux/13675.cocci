...
position p;
@@
 struct sms_isdbt_stats * cocci_id@p ;
...
position p;
@@
 struct RECEPTION_STATISTICS_PER_SLICES_S * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smsdvb_client_t;
@@
 struct smsdvb_client_t cocci_id@p ;
...
typedef u32;
@@
 struct {  struct sms_msg_hdr msg ;  u32 Data [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 enum SMS_DVB3_EVENTS cocci_id@p ;
...
position p;
@@
 struct sms_tx_stats * cocci_id@p ;
...
position p;
@@
 struct sms_isdbt_stats_ex * cocci_id@p ;
...
position p;
@@
 struct sms_isdbt_layer_stats * cocci_id@p ;
...
typedef u32;
@@
 struct {  struct sms_msg_hdr msg ;  u32 Data [ 4 ] ; } cocci_id@p ;
