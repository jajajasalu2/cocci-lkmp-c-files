...
position p;
@@
 struct atm_backend_ppp cocci_id@p ;
...
position p;
@@
 const struct atm_vcc * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef atm_backend_t;
@@
 atm_backend_t cocci_id@p ;
...
typedef atomic_t;
@@
 struct pppoatm_vcc {  struct atm_vcc * atmvcc ;  void ( * old_push ) ( struct atm_vcc * , struct sk_buff * ) ;  void ( * old_pop ) ( struct atm_vcc * , struct sk_buff * ) ;  void ( * old_release_cb ) ( struct atm_vcc * ) ;  struct module * old_owner ;  enum pppoatm_encaps encaps ;  atomic_t inflight ;  unsigned long blocked ;  int flags ;  struct ppp_channel chan ;  struct tasklet_struct wakeup_tasklet ; } cocci_id@p ;
...
position p;
@@
 const struct ppp_channel * cocci_id@p ;
...
position p;
@@
 enum pppoatm_encaps cocci_id@p ;
...
position p;
@@
 enum pppoatm_encaps { e_autodetect = PPPOATM_ENCAPS_AUTODETECT , e_vc = PPPOATM_ENCAPS_VC , e_llc = PPPOATM_ENCAPS_LLC , } cocci_id@p ;
