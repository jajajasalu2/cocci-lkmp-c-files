...
position p;
@@
 struct idmap {  struct rpc_pipe_dir_object idmap_pdo ;  struct rpc_pipe * idmap_pipe ;  struct idmap_legacy_upcalldata * idmap_upcall_data ;  struct mutex idmap_mutex ;  const struct cred * cred ; } cocci_id@p ;
...
position p;
@@
 struct idmap_legacy_upcalldata cocci_id@p ;
...
position p;
@@
 enum { Opt_find_uid , Opt_find_gid , Opt_find_user , Opt_find_group , Opt_find_err , } cocci_id@p ;
...
position p;
@@
 struct request_key_auth * cocci_id@p ;
...
position p;
@@
 struct idmap_legacy_upcalldata {  struct rpc_pipe_msg pipe_msg ;  struct idmap_msg idmap_msg ;  struct key * authkey ;  struct idmap * idmap ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rpc_pipe_msg * ) ;
...
position p;
@@
 char cocci_id@p [ NFS_UINT_MAXLEN ] ;
...
position p;
@@
 int cocci_id@p ( struct key * , void * ) ;
