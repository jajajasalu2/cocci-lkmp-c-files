...
position p;
@@
 const struct db2k_boardtype * cocci_id@p ;
...
position p;
@@
 struct db2k_boardtype {  const char * name ;  unsigned int has_2_ao : 1 ; } cocci_id@p ;
...
position p;
@@
 struct db2k_private * cocci_id@p ;
...
position p;
@@
 enum db2k_boardid { BOARD_DAQBOARD2000 , BOARD_DAQBOARD2001 , } cocci_id@p ;
...
position p;
@@
 struct db2k_private {  void __iomem * plx ; } cocci_id@p ;
