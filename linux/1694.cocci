...
position p;
@@
 struct afe4404_data * cocci_id@p ;
...
position p;
@@
 struct afe4404_data {  struct device * dev ;  struct regmap * regmap ;  struct regmap_field * fields [ F_MAX_FIELDS ] ;  struct regulator * regulator ;  struct iio_trigger * trig ;  int irq ; } cocci_id@p ;
...
position p;
@@
 enum afe4404_fields { F_TIA_GAIN_SEP , F_TIA_CF_SEP , F_TIA_GAIN , TIA_CF , F_ILED1 , F_ILED2 , F_ILED3 , F_OFFDAC_AMB2 , F_OFFDAC_LED1 , F_OFFDAC_AMB1 , F_OFFDAC_LED2 , F_MAX_FIELDS , } cocci_id@p ;
...
position p;
@@
 struct afe440x_attr * cocci_id@p ;
...
position p;
@@
 enum afe4404_chan_id { LED2 = 1 , ALED2 , LED1 , ALED1 , LED2_ALED2 , LED1_ALED1 , } cocci_id@p ;
...
position p;
@@
 const struct afe440x_val_table cocci_id@p [ ] ;
