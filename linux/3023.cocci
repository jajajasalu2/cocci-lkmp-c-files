...
position p;
@@
 struct dock_dependent_device {  struct list_head list ;  struct acpi_device * adev ; } cocci_id@p ;
...
@@
 struct dock_station {  acpi_handle handle ;  unsigned long last_dock_time ;  u32 flags ;  struct list_head dependent_devices ;  struct list_head sibling ;  struct platform_device * dock_device ; } cocci_id@p ;
...
position p;
@@
 enum dock_callback_type cocci_id@p ;
...
position p;
@@
 struct dock_dependent_device * cocci_id@p ;
...
position p;
@@
 enum dock_callback_type { DOCK_CALL_HANDLER , DOCK_CALL_FIXUP , DOCK_CALL_UEVENT , } cocci_id@p ;
...
position p;
@@
 struct dock_station * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct acpi_device * ) ;
