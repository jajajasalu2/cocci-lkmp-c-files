...
position p;
@@
 struct rds6_info_tcp_socket cocci_id@p ;
...
position p;
@@
 struct rds_tcp_connection * cocci_id@p ;
...
position p;
@@
 struct rds_info_tcp_socket cocci_id@p ;
...
position p;
@@
 struct rds_tcp_net {  struct socket * rds_tcp_listen_sock ;  struct work_struct rds_tcp_accept_w ;  struct ctl_table_header * rds_tcp_sysctl ;  struct ctl_table * ctl_table ;  int sndbuf_size ;  int rcvbuf_size ; } cocci_id@p ;
