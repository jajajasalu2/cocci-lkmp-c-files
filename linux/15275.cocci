...
typedef u8;
@@
 struct pca955x_chipdef {  int bits ;  u8 slv_addr ;  int slv_addr_shift ; } cocci_id@p ;
...
position p;
@@
 struct pca955x_platform_data {  struct pca955x_led * leds ;  int num_leds ; } cocci_id@p ;
...
position p;
@@
 struct pca955x_chipdef * cocci_id@p ;
...
position p;
@@
 enum pca955x_type { pca9550 , pca9551 , pca9552 , pca9553 , } cocci_id@p ;
...
typedef u32;
@@
 struct pca955x_led {  struct pca955x * pca955x ;  struct led_classdev led_cdev ;  int led_num ;  char name [ 32 ] ;  u32 type ;  const char * default_trigger ; } cocci_id@p ;
...
position p;
@@
 struct pca955x_platform_data * cocci_id@p ;
