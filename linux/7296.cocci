...
position p;
@@
 struct l4f00242t03_priv cocci_id@p ;
...
position p;
@@
 struct l4f00242t03_priv {  struct spi_device * spi ;  struct lcd_device * ld ;  int lcd_state ;  struct regulator * io_reg ;  struct regulator * core_reg ; } cocci_id@p ;
