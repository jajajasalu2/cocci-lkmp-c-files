...
position p;
@@
 int cocci_id@p ( struct dlm_protocol_version * existing , struct dlm_protocol_version * request ) ;
...
position p;
@@
 struct dlm_cancel_join * cocci_id@p ;
...
position p;
@@
 struct dlm_query_join_request * cocci_id@p ;
...
position p;
@@
 struct dlm_query_region * cocci_id@p ;
...
position p;
@@
 struct dlm_assert_joined cocci_id@p ;
...
position p;
@@
 enum dlm_query_join_response_code cocci_id@p ;
...
position p;
@@
 struct domain_join_ctxt {  unsigned long live_map [ BITS_TO_LONGS ( O2NM_MAX_NODES ) ] ;  unsigned long yes_resp_map [ BITS_TO_LONGS ( O2NM_MAX_NODES ) ] ; } cocci_id@p ;
...
position p;
@@
 struct dlm_create_lock cocci_id@p ;
...
position p;
@@
 struct dlm_exit_domain * cocci_id@p ;
...
position p;
@@
 struct dlm_node_info * cocci_id@p ;
...
position p;
@@
 union dlm_query_join_response cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ O2NM_MAX_NAME_LEN ] ;
...
position p;
@@
 struct dlm_query_nodeinfo cocci_id@p ;
...
position p;
@@
 const struct dlm_protocol_version cocci_id@p ;
...
position p;
@@
 struct dlm_query_join_packet cocci_id@p ;
...
position p;
@@
 struct dlm_protocol_version cocci_id@p ;
...
position p;
@@
 struct dlm_eviction_cb * cocci_id@p ;
...
position p;
@@
 struct domain_join_ctxt * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct o2net_msg * msg , u32 len , void * data , void * * ret_data ) ;
