...
position p;
@@
 const struct ef4_hw_stat_desc cocci_id@p [ FALCON_STAT_COUNT ] ;
...
position p;
@@
 struct falcon_mtd_partition * cocci_id@p ;
...
position p;
@@
 struct falcon_spi_device * cocci_id@p ;
...
position p;
@@
 const struct ef4_nic_type cocci_id@p ;
...
position p;
@@
 struct ef4_mtd_partition * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ FALCON_SPI_MAX_LEN ] ;
...
position p;
@@
 struct ef4_link_state cocci_id@p ;
...
position p;
@@
 struct falcon_mtd_partition {  struct ef4_mtd_partition common ;  const struct falcon_spi_device * spi ;  size_t offset ; } cocci_id@p ;
...
position p;
@@
 enum { FALCON_RESET_INVISIBLE = ( ETH_RESET_DMA | ETH_RESET_FILTER | ETH_RESET_OFFLOAD | ETH_RESET_MAC ) , FALCON_RESET_ALL = FALCON_RESET_INVISIBLE | ETH_RESET_PHY , FALCON_RESET_WORLD = FALCON_RESET_ALL | ETH_RESET_IRQ , } cocci_id@p ;
...
position p;
@@
 struct falcon_nvconfig * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ef4_nic * efx , enum reset_type method ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ FALCON_SPI_VERIFY_BUF_LEN ] ;
...
position p;
@@
 struct falcon_board * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ef4_nic * efx ) ;
...
position p;
@@
 const struct falcon_spi_device * cocci_id@p ;
