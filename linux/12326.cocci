...
position p;
@@
 int cocci_id@p ( struct drm_crtc * crtc , int x , int y ) ;
...
position p;
@@
 struct ast_i2c_chan * cocci_id@p ;
...
position p;
@@
 const struct ast_vbios_enhtable * cocci_id@p ;
...
position p;
@@
 struct ast_vbios_mode_info * cocci_id@p ;
...
position p;
@@
 const struct ast_vbios_stdtable * cocci_id@p ;
...
position p;
@@
 struct ast_connector * cocci_id@p ;
...
typedef u8,u32;
@@
 union {  u32 ul ;  u8 b [ 4 ] ; } cocci_id@p [ 2 ] ;
...
position p;
@@
 void cocci_id@p ( struct ast_i2c_chan * i2c ) ;
...
position p;
@@
 const struct ast_vbios_dclk_info * cocci_id@p ;
...
typedef u8,u16;
@@
 union {  u16 us ;  u8 b [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct ast_i2c_chan * cocci_id@p ( struct drm_device * dev ) ;
...
position p;
@@
 struct drm_gem_vram_object * cocci_id@p ;
