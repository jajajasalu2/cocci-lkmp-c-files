...
position p;
@@
 const struct xlnx_pr_decoupler_data * cocci_id@p ;
...
position p;
@@
 struct xlnx_pr_decoupler_data {  void __iomem * io_base ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 struct xlnx_pr_decoupler_data * cocci_id@p ;
