...
position p;
@@
 struct phy_devm {  struct usb_phy * phy ;  struct notifier_block * nb ; } cocci_id@p ;
...
position p;
@@
 enum usb_charger_state cocci_id@p ;
