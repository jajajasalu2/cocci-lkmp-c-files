...
position p;
@@
 struct qmp_cooling_device * cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ QMP_MSG_LEN ] ;
...
position p;
@@
 struct qmp_pd {  struct qmp * qmp ;  struct generic_pm_domain pd ; } cocci_id@p ;
...
typedef bool;
@@
 struct qmp_cooling_device {  struct thermal_cooling_device * cdev ;  struct qmp * qmp ;  char * name ;  bool state ; } cocci_id@p ;
...
@@
 struct qmp {  void __iomem * msgram ;  struct device * dev ;  struct mbox_client mbox_client ;  struct mbox_chan * mbox_chan ;  size_t offset ;  size_t size ;  wait_queue_head_t event ;  struct mutex tx_lock ;  struct clk_hw qdss_clk ;  struct genpd_onecell_data pd_data ;  struct qmp_cooling_device * cooling_devs ; } cocci_id@p ;
