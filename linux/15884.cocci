...
position p;
@@
 struct conf_writedata {  hysdn_card * card ;  int buf_size ;  int needed_size ;  int state ;  unsigned char conf_line [ CONF_LINE_LEN ] ;  unsigned short channel ;  unsigned char * pof_buffer ; } cocci_id@p ;
...
position p;
@@
 struct conf_writedata cocci_id@p ;
