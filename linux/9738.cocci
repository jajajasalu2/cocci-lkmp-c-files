...
position p;
@@
 struct iwl_bt_coex_cmd cocci_id@p ;
...
typedef u8,bool;
@@
 struct iwl_bt_iterator_data {  struct iwl_bt_coex_profile_notif * notif ;  struct iwl_mvm * mvm ;  struct ieee80211_chanctx_conf * primary ;  struct ieee80211_chanctx_conf * secondary ;  bool primary_ll ;  u8 primary_load ;  u8 secondary_load ; } cocci_id@p ;
...
position p;
@@
 struct iwl_bt_iterator_data cocci_id@p ;
...
position p;
@@
 struct iwl_bt_coex_reduced_txp_update_cmd cocci_id@p ;
...
position p;
@@
 enum ieee80211_rssi_event_data cocci_id@p ;
...
position p;
@@
 const struct ieee80211_vif * cocci_id@p ;
...
position p;
@@
 enum iwl_bt_coex_lut_type cocci_id@p ;
