...
typedef spinlock_t;
@@
 struct sirfsoc_gpio_bank {  int id ;  int parent_irq ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct sirfsoc_gpio_bank * cocci_id@p ;
...
position p;
@@
 const struct sirfsoc_muxmask * cocci_id@p ;
...
position p;
@@
 struct sirfsoc_pin_group * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ SIRFSOC_GPIO_NO_OF_BANKS ] ;
...
position p;
@@
 struct sirfsoc_pmx_func * cocci_id@p ;
...
position p;
@@
 const struct sirfsoc_pinctrl_data * cocci_id@p ;
...
position p;
@@
 const struct sirfsoc_padmux * cocci_id@p ;
...
position p;
@@
 struct sirfsoc_gpio_chip * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sirfsoc_gpio_chip {  struct of_mm_gpio_chip chip ;  struct sirfsoc_gpio_bank sgpio_bank [ SIRFSOC_GPIO_NO_OF_BANKS ] ;  spinlock_t lock ; } cocci_id@p ;
