...
typedef u8;
@@
 u8 cocci_id@p [ N_CLASSES ] [ N_COUNTER ] ;
...
position p;
@@
 const int cocci_id@p [ N_COUNTER ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ N_COUNTER ] ;
