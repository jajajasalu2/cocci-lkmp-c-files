...
position p;
@@
 struct perf_aggr_thread_value cocci_id@p ;
...
typedef bool;
@@
 void ( * cocci_id@p ) ( struct perf_stat_config * config , struct evsel * counter , void * data , bool first ) ;
