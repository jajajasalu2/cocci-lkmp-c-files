...
position p;
@@
 struct max310x_port * cocci_id@p ;
...
typedef u8;
@@
 struct max310x_one {  struct uart_port port ;  struct work_struct tx_work ;  struct work_struct md_work ;  struct work_struct rs_work ;  u8 wr_header ;  u8 rd_header ;  u8 rx_buf [ MAX310X_FIFO_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 const struct max310x_devtype cocci_id@p ;
...
position p;
@@
 struct max310x_devtype * cocci_id@p ;
...
typedef u8;
@@
 struct max310x_devtype {  char name [ 9 ] ;  int nr ;  u8 mode1 ;  int ( * detect ) ( struct device * ) ;  void ( * power ) ( struct uart_port * , int ) ; } cocci_id@p ;
