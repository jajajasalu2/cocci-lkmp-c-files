...
position p;
@@
 struct pm860x_priv {  unsigned int sysclk ;  unsigned int pcmclk ;  unsigned int dir ;  unsigned int filter ;  struct snd_soc_component * component ;  struct i2c_client * i2c ;  struct regmap * regmap ;  struct pm860x_chip * chip ;  struct pm860x_det det ;  int irq [ 4 ] ;  unsigned char name [ 4 ] [ MAX_NAME_LEN + 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct pm860x_det {  struct snd_soc_jack * hp_jack ;  struct snd_soc_jack * mic_jack ;  int hp_det ;  int mic_det ;  int hook_det ;  int hs_shrt ;  int lo_shrt ; } cocci_id@p ;
...
position p;
@@
 struct st_gain {  unsigned int db ;  unsigned int m ;  unsigned int n ; } cocci_id@p ;
