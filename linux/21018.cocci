...
position p;
@@
 struct resource cocci_id@p [ MAX_PHYSMEM_RANGES ] ;
...
position p;
@@
 unsigned long cocci_id@p [ SID_ARRAY_SIZE ] ;
...
position p;
@@
 struct compat_ipc64_perm cocci_id@p ;
...
typedef physmem_range_t;
@@
 physmem_range_t cocci_id@p [ MAX_PHYSMEM_RANGES - 1 ] ;
