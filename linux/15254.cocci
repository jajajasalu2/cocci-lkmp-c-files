...
position p;
@@
 struct tlc591xx_priv {  struct tlc591xx_led leds [ TLC591XX_MAX_LEDS ] ;  struct regmap * regmap ;  unsigned int reg_ledout_offset ; } cocci_id@p ;
...
typedef bool;
@@
 struct tlc591xx_led {  bool active ;  unsigned int led_no ;  struct led_classdev ldev ;  struct tlc591xx_priv * priv ; } cocci_id@p ;
...
position p;
@@
 const struct tlc591xx * cocci_id@p ;
...
position p;
@@
 struct tlc591xx_led * cocci_id@p ;
...
position p;
@@
 struct tlc591xx {  unsigned int max_leds ;  unsigned int reg_ledout_offset ; } cocci_id@p ;
...
position p;
@@
 struct tlc591xx_priv * cocci_id@p ;
