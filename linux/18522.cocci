...
position p;
@@
 struct sunxi_mc_smp_nodes * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef phys_reset_t;
@@
 phys_reset_t cocci_id@p ;
...
position p;
@@
 struct sunxi_mc_smp_nodes {  struct device_node * prcm_node ;  struct device_node * cpucfg_node ;  struct device_node * sram_node ;  struct device_node * r_cpucfg_node ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ SUNXI_NR_CLUSTERS ] [ SUNXI_CPUS_PER_CLUSTER ] ;
...
typedef bool;
@@
 struct sunxi_mc_smp_data {  const char * enable_method ;  int ( * get_smp_nodes ) ( struct sunxi_mc_smp_nodes * nodes ) ;  bool is_a83t ; } cocci_id@p ;
