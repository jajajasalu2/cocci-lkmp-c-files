...
position p;
@@
 struct kvm_ppc_smmu_info * cocci_id@p ;
...
position p;
@@
 struct hv_guest_state cocci_id@p ;
...
position p;
@@
 union kvmppc_one_reg * cocci_id@p ;
...
position p;
@@
 struct preempted_vcore_list * cocci_id@p ;
...
position p;
@@
 struct kvmppc_vcore cocci_id@p ;
...
position p;
@@
 struct kvm_ppc_one_seg_page_size * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct preempted_vcore_list {  struct list_head list ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct kvmppc_irq_map * cocci_id@p ;
...
position p;
@@
 struct kvmhv_tb_accumulator cocci_id@p ;
...
typedef u32,__be32;
@@
 struct reg_vpa {  u32 dummy ;  union {  __be16 hword ;  __be32 word ; } length ; } cocci_id@p ;
...
position p;
@@
 struct kvmppc_passthru_irqmap cocci_id@p ;
...
position p;
@@
 struct kvm_ppc_resize_hpt cocci_id@p ;
...
position p;
@@
 struct sibling_subcore_state cocci_id@p ;
...
position p;
@@
 struct kvm_ppc_mmuv3_cfg * cocci_id@p ;
...
position p;
@@
 struct kvm_get_htab_fd cocci_id@p ;
...
position p;
@@
 struct kvmppc_host_rm_core cocci_id@p ;
...
position p;
@@
 struct kvm_nested_guest * cocci_id@p ;
...
position p;
@@
 struct kvmppc_host_rm_ops * cocci_id@p ;
...
position p;
@@
 struct kvm_hpt_info cocci_id@p ;
...
position p;
@@
 struct debugfs_timings_element {  const char * name ;  size_t offset ; } cocci_id@p [ ] ;
...
position p;
@@
 struct kvm_split_mode cocci_id@p ;
...
position p;
@@
 struct core_info {  int n_subcores ;  int max_subcore_threads ;  int total_threads ;  int subcore_threads [ MAX_SUBCORES ] ;  struct kvmppc_vcore * vc [ MAX_SUBCORES ] ; } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_SMT_THREADS + 1 ] ;
...
position p;
@@
 struct debugfs_timings_state {  struct kvm_vcpu * vcpu ;  unsigned int buflen ;  char buf [ N_TIMINGS * 100 ] ; } cocci_id@p ;
...
position p;
@@
 struct debugfs_timings_state * cocci_id@p ;
