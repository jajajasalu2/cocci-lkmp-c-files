...
position p;
@@
 struct vio_dring_data cocci_id@p ;
...
position p;
@@
 struct vdc_req_entry {  struct request * req ; } cocci_id@p ;
...
position p;
@@
 struct vio_disk_vtoc cocci_id@p ;
...
position p;
@@
 struct vdc_check_port_data cocci_id@p ;
...
position p;
@@
 struct vio_driver_ops cocci_id@p ;
...
position p;
@@
 struct ldc_trans_cookie cocci_id@p ;
...
position p;
@@
 struct vio_disk_geom cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vdc_port * port ) ;
...
position p;
@@
 struct vio_disk_attr_info cocci_id@p ;
...
position p;
@@
 struct vio_driver_state * cocci_id@p ;
...
position p;
@@
 struct vio_dring_state * cocci_id@p ;
...
typedef u64;
@@
 union {  struct vio_msg_tag tag ;  u64 raw [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct vio_disk_desc cocci_id@p ;
...
position p;
@@
 struct vio_disk_devid cocci_id@p ;
...
position p;
@@
 struct vio_completion cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct vdc_port {  struct vio_driver_state vio ;  struct gendisk * disk ;  struct vdc_completion * cmp ;  u64 req_id ;  u64 seq ;  struct vdc_req_entry rq_arr [ VDC_TX_RING_SIZE ] ;  unsigned long ring_cookies ;  u64 max_xfer_size ;  u32 vdisk_block_size ;  u32 drain ;  u64 ldc_timeout ;  struct delayed_work ldc_reset_timer_work ;  struct work_struct ldc_reset_work ;  u64 operations ;  u32 vdisk_size ;  u8 vdisk_type ;  u8 vdisk_mtype ;  u32 vdisk_phys_blksz ;  struct blk_mq_tag_set tag_set ;  char disk_name [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct vdc_req_entry * cocci_id@p ;
...
position p;
@@
 struct vdc_check_port_data {  int dev_no ;  char * type ; } cocci_id@p ;
...
position p;
@@
 struct scatterlist cocci_id@p [ MAX_RING_COOKIES ] ;
