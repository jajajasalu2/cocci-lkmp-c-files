...
typedef bool,u32;
@@
 struct sdhci_am654_data {  struct regmap * base ;  int otap_del_sel ;  int trm_icp ;  int drv_strength ;  bool dll_on ;  int strb_sel ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 const struct sdhci_am654_driver_data cocci_id@p ;
...
position p;
@@
 struct sdhci_am654_data * cocci_id@p ;
