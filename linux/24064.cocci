...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_PG_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_TC_ATTR_PARAM_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_ATTR_IEEE_MAX + 1 ] ;
...
position p;
@@
 struct dcb_ieee_app_dscp_map * cocci_id@p ;
...
position p;
@@
 struct dcbnl_buffer cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_ATTR_IEEE_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_FEATCFG_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_PG_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_NUMTCS_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_PFC_UP_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ieee_qcn_stats cocci_id@p ;
...
position p;
@@
 struct ieee_maxrate cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_APP_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_FEATCFG_ATTR_MAX + 1 ] ;
...
typedef u32;
@@
 struct reply_func {  int type ;  int ( * cb ) ( struct net_device * , struct nlmsghdr * , u32 , struct nlattr * * , struct sk_buff * ) ; } cocci_id@p ;
...
position p;
@@
 const struct reply_func * cocci_id@p ;
...
position p;
@@
 const struct reply_func cocci_id@p [ DCB_CMD_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_NUMTCS_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_PFC_UP_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct dcb_ieee_app_prio_map * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_CAP_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_TC_ATTR_PARAM_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_BCN_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_APP_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ DCB_BCN_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct dcb_app * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DCB_CAP_ATTR_MAX + 1 ] ;
