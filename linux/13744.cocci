...
position p;
@@
 struct tvp5150_vbi_type {  unsigned int vbi_type ;  unsigned int ini_line ;  unsigned int end_line ;  unsigned int by_field : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct i2c_reg_value cocci_id@p [ ] ;
...
position p;
@@
 struct i2c_vbi_ram_value cocci_id@p [ ] ;
...
position p;
@@
 struct v4l2_sliced_vbi_format * cocci_id@p ;
...
position p;
@@
 struct v4l2_vbi_format * cocci_id@p ;
...
position p;
@@
 const struct v4l2_subdev_vbi_ops cocci_id@p ;
...
position p;
@@
 const struct v4l2_subdev_tuner_ops cocci_id@p ;
...
position p;
@@
 const struct i2c_vbi_ram_value * cocci_id@p ;
...
typedef u16;
@@
 struct i2c_vbi_ram_value {  u16 reg ;  struct tvp5150_vbi_type type ;  unsigned char values [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 enum tvp5150_pads { TVP5150_PAD_IF_INPUT , TVP5150_PAD_VID_OUT , TVP5150_NUM_PADS , } cocci_id@p ;
