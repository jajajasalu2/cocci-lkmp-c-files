...
position p;
@@
 const struct akcipher_testvec * cocci_id@p ;
...
position p;
@@
 const struct cprng_testvec * cocci_id@p ;
...
position p;
@@
 const struct comp_testvec * cocci_id@p ;
...
position p;
@@
 const struct test_sg_division * cocci_id@p [ XBUFSIZE ] ;
...
position p;
@@
 const struct drbg_testvec * cocci_id@p ;
...
position p;
@@
 struct aead_testvec cocci_id@p ;
...
position p;
@@
 const struct hash_testvec * cocci_id@p ;
...
position p;
@@
 struct hash_testvec cocci_id@p ;
...
position p;
@@
 struct cipher_test_suite {  const struct cipher_testvec * vecs ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ TESTVEC_CONFIG_NAMELEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ 3 * ( MAX_ALGAPI_ALIGNMASK + 1 ) + MAX_IVLEN ] ;
...
position p;
@@
 struct crypto_acomp * cocci_id@p ;
...
position p;
@@
 struct crypto_cipher * cocci_id@p ;
...
position p;
@@
 struct aead_test_suite {  const struct aead_testvec * vecs ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 enum finalization_type { FINALIZATION_TYPE_FINAL , FINALIZATION_TYPE_FINUP , FINALIZATION_TYPE_DIGEST , } cocci_id@p ;
...
position p;
@@
 const struct testvec_config * cocci_id@p ;
...
position p;
@@
 const struct test_sglist * cocci_id@p ;
...
typedef bool,u32;
@@
 struct testvec_config {  const char * name ;  bool inplace ;  u32 req_flags ;  struct test_sg_division src_divs [ XBUFSIZE ] ;  struct test_sg_division dst_divs [ XBUFSIZE ] ;  unsigned int iv_offset ;  bool iv_offset_relative_to_alignmask ;  enum finalization_type finalization_type ;  bool nosimd ; } cocci_id@p ;
...
position p;
@@
 struct testvec_config * cocci_id@p ;
...
position p;
@@
 struct drbg_test_data cocci_id@p ;
...
position p;
@@
 struct {  const struct test_sg_division * div ;  size_t length ; } cocci_id@p [ XBUFSIZE ] ;
...
position p;
@@
 struct scatterlist cocci_id@p [ 2 ] ;
...
position p;
@@
 struct cipher_testvec cocci_id@p ;
...
position p;
@@
 struct crypto_akcipher * cocci_id@p ;
...
position p;
@@
 const struct cipher_test_suite * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ahash_request * req ) ;
...
position p;
@@
 struct cipher_test_sglists * cocci_id@p ;
...
position p;
@@
 const struct test_sg_division * cocci_id@p ;
...
position p;
@@
 const struct aead_test_suite * cocci_id@p ;
...
position p;
@@
 const struct alg_test_desc * cocci_id@p ;
...
position p;
@@
 enum flush_type { FLUSH_TYPE_NONE = 0 , FLUSH_TYPE_FLUSH , FLUSH_TYPE_REIMPORT , } cocci_id@p ;
...
position p;
@@
 struct kpp_test_suite {  const struct kpp_testvec * vecs ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 struct test_sglist {  char * bufs [ XBUFSIZE ] ;  struct scatterlist sgl [ XBUFSIZE ] ;  struct scatterlist sgl_saved [ XBUFSIZE ] ;  struct scatterlist * sgl_ptr ;  unsigned int nents ; } cocci_id@p ;
...
position p;
@@
 struct test_sg_division * cocci_id@p ;
...
position p;
@@
 struct cipher_test_sglists {  struct test_sglist src ;  struct test_sglist dst ; } cocci_id@p ;
...
position p;
@@
 const struct aead_testvec * cocci_id@p ;
...
typedef bool;
@@
 struct test_sg_division {  unsigned int proportion_of_total ;  unsigned int offset ;  bool offset_relative_to_alignmask ;  enum flush_type flush_type ;  bool nosimd ; } cocci_id@p ;
...
position p;
@@
 struct akcipher_test_suite {  const struct akcipher_testvec * vecs ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CRYPTO_MAX_ALG_NAME ] ;
...
position p;
@@
 const struct kpp_testvec * cocci_id@p ;
...
position p;
@@
 struct hash_test_suite {  const struct hash_testvec * vecs ;  unsigned int count ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HASH_MAX_DIGESTSIZE + TESTMGR_POISON_LEN ] ;
...
position p;
@@
 struct akcipher_request * cocci_id@p ;
...
position p;
@@
 struct drbg_test_suite {  const struct drbg_testvec * vecs ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 struct cprng_test_suite {  const struct cprng_testvec * vecs ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 const struct cipher_testvec * cocci_id@p ;
