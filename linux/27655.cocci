...
position p;
@@
 struct kioctx_table * cocci_id@p ;
...
typedef sigset_t;
@@
 struct __aio_sigset {  const sigset_t __user * sigmask ;  size_t sigsetsize ; } cocci_id@p ;
...
position p;
@@
 struct aio_poll_table {  struct poll_table_struct pt ;  struct aio_kiocb * iocb ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct aio_poll_table cocci_id@p ;
...
typedef atomic_t;
@@
 struct ctx_rq_wait {  struct completion comp ;  atomic_t count ; } cocci_id@p ;
...
position p;
@@
 struct kioctx_table {  struct rcu_head rcu ;  unsigned nr ;  struct kioctx __rcu * table [ ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,spinlock_t,atomic_t;
@@
 struct kioctx {  struct percpu_ref users ;  atomic_t dead ;  struct percpu_ref reqs ;  unsigned long user_id ;  struct __percpu kioctx_cpu * cpu ;  unsigned req_batch ;  unsigned max_reqs ;  unsigned nr_events ;  unsigned long mmap_base ;  unsigned long mmap_size ;  struct page * * ring_pages ;  long nr_pages ;  struct rcu_work free_rwork ;  struct ctx_rq_wait * rq_wait ;  struct {  atomic_t reqs_available ; } ____cacheline_aligned_in_smp ;  struct {  spinlock_t ctx_lock ;  struct list_head active_reqs ; } ____cacheline_aligned_in_smp ;  struct {  struct mutex ring_lock ;  wait_queue_head_t wait ; } ____cacheline_aligned_in_smp ;  struct {  unsigned tail ;  unsigned completed_events ;  spinlock_t completion_lock ; } ____cacheline_aligned_in_smp ;  struct page * internal_pages [ AIO_RING_PAGES ] ;  struct file * aio_ring_file ;  unsigned id ; } cocci_id@p ;
...
position p;
@@
 struct kioctx_cpu {  unsigned reqs_available ; } cocci_id@p ;
...
position p;
@@
 struct old_timespec32 * cocci_id@p ;
...
position p;
@@
 struct aio_ring {  unsigned id ;  unsigned nr ;  unsigned head ;  unsigned tail ;  unsigned magic ;  unsigned compat_features ;  unsigned incompat_features ;  unsigned header_length ;  struct io_event io_events [ 0 ] ; } cocci_id@p ;
...
typedef refcount_t;
@@
 struct aio_kiocb {  union {  struct file * ki_filp ;  struct kiocb rw ;  struct fsync_iocb fsync ;  struct poll_iocb poll ; } ;  struct kioctx * ki_ctx ;  kiocb_cancel_fn * ki_cancel ;  struct io_event ki_res ;  struct list_head ki_list ;  refcount_t ki_refcnt ;  struct eventfd_ctx * ki_eventfd ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,__poll_t;
@@
 struct poll_iocb {  struct file * file ;  struct wait_queue_head * head ;  __poll_t events ;  bool done ;  bool cancelled ;  struct wait_queue_entry wait ;  struct work_struct work ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_size_t,compat_uptr_t;
@@
 struct __compat_aio_sigset {  compat_uptr_t sigmask ;  compat_size_t sigsetsize ; } cocci_id@p ;
...
typedef bool;
@@
 struct fsync_iocb {  struct file * file ;  struct work_struct work ;  bool datasync ; } cocci_id@p ;
