...
position p;
@@
 struct hi3660_chan_info {  unsigned int dst_irq ;  unsigned int ack_irq ; } cocci_id@p ;
...
position p;
@@
 struct hi3660_chan_info * cocci_id@p ;
...
position p;
@@
 struct hi3660_mbox {  struct device * dev ;  void __iomem * base ;  struct mbox_chan chan [ MBOX_CHAN_MAX ] ;  struct hi3660_chan_info mchan [ MBOX_CHAN_MAX ] ;  struct mbox_controller controller ; } cocci_id@p ;
