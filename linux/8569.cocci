...
position p;
@@
 struct bnx2x_fw_file_hdr cocci_id@p ;
...
position p;
@@
 struct bnx2x_vlan_entry * cocci_id@p ;
...
position p;
@@
 struct cnic_ctl_info * cocci_id@p ;
...
position p;
@@
 struct bnx2x_queue_state_params cocci_id@p ;
...
position p;
@@
 struct shmem2_region cocci_id@p ;
...
position p;
@@
 struct dmae_command cocci_id@p ;
...
position p;
@@
 struct cnic_eth_dev * cocci_id@p ;
...
position p;
@@
 struct hc_status_block_sm * cocci_id@p ;
...
position p;
@@
 struct bnx2x_txq_setup_params * cocci_id@p ;
...
position p;
@@
 struct drv_ctl_info * cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_switch_update_params * cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_list_elem_group {  struct list_head mcast_group_link ;  struct bnx2x_mcast_list_elem mcast_elems [ ] ; } cocci_id@p ;
...
position p;
@@
 struct hc_status_block_data_e2 cocci_id@p ;
...
position p;
@@
 struct fcoe_capabilities cocci_id@p ;
...
position p;
@@
 struct bnx2x_raw_obj * cocci_id@p ;
...
position p;
@@
 struct cmng_init_input * cocci_id@p ;
...
position p;
@@
 struct shmem_region cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_list_elem cocci_id@p ;
...
position p;
@@
 enum drv_info_opcode cocci_id@p ;
...
position p;
@@
 typeof ( bp -> strm -> next_in ) cocci_id@p ;
...
position p;
@@
 struct host_hc_status_block_e1x cocci_id@p ;
...
position p;
@@
 struct host_hc_status_block_e2 cocci_id@p ;
...
position p;
@@
 struct host_sp_status_block cocci_id@p ;
...
position p;
@@
 struct tstorm_per_queue_stats * cocci_id@p ;
...
typedef u32;
@@
 struct bnx2x_mac_vals {  u32 xmac_addr ;  u32 xmac_val ;  u32 emac_addr ;  u32 emac_val ;  u32 umac_addr [ 2 ] ;  u32 umac_val [ 2 ] ;  u32 bmac_addr ;  u32 bmac_val [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct bnx2x * bp ) ;
...
position p;
@@
 struct ilt_client_info cocci_id@p ;
...
position p;
@@
 struct bnx2x_slowpath cocci_id@p ;
...
position p;
@@
 struct bnx2x_udp_tunnel * cocci_id@p ;
...
position p;
@@
 enum storms { XSTORM , TSTORM , CSTORM , USTORM , MAX_STORMS , } cocci_id@p ;
...
position p;
@@
 struct ptp_clock_request * cocci_id@p ;
...
position p;
@@
 const struct cyclecounter * cocci_id@p ;
...
position p;
@@
 struct eth_tx_next_bd * cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_afex_viflists_params * cocci_id@p ;
...
position p;
@@
 struct cmng_struct_per_port cocci_id@p ;
...
typedef u32;
@@
 struct pbf_pN_buf_regs {  int pN ;  u32 init_crd ;  u32 crd ;  u32 crd_freed ; } cocci_id@p ;
...
position p;
@@
 struct hc_sp_status_block_data * cocci_id@p ;
...
position p;
@@
 struct fcoe_statistics_params * cocci_id@p ;
...
position p;
@@
 struct bnx2x_prev_path_list * cocci_id@p ;
...
position p;
@@
 union drv_info_to_mcp cocci_id@p ;
...
position p;
@@
 struct bnx2x_queue_setup_tx_only_params * cocci_id@p ;
...
typedef u32;
@@
 struct pbf_pN_cmd_regs {  int pN ;  u32 lines_occup ;  u32 lines_freed ; } cocci_id@p ;
...
position p;
@@
 struct bnx2x_queue_sp_obj * cocci_id@p ;
...
position p;
@@
 struct bnx2x_vlan_mac_obj * cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_ramrod_params * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BNX2X_VPD_LEN + 1 ] ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct bnx2x_fastpath * fp ) ;
...
position p;
@@
 struct event_ring_data cocci_id@p ;
...
position p;
@@
 struct pbf_pN_buf_regs cocci_id@p [ ] ;
...
position p;
@@
 struct pbf_pN_cmd_regs cocci_id@p [ ] ;
...
position p;
@@
 struct hc_status_block_data_e1x cocci_id@p ;
...
position p;
@@
 struct cnic_eth_dev * cocci_id@p ( struct net_device * dev ) ;
...
position p;
@@
 struct tstorm_eth_function_common_config * cocci_id@p ;
...
position p;
@@
 struct bnx2x_fp_txdata * cocci_id@p ;
...
position p;
@@
 struct bnx2x_rxq_setup_params * cocci_id@p ;
...
position p;
@@
 struct bnx2x_queue_setup_params * cocci_id@p ;
...
position p;
@@
 union event_ring_elem * cocci_id@p ;
...
position p;
@@
 enum bnx2x_board_type { BCM57710 = 0 , BCM57711 , BCM57711E , BCM57712 , BCM57712_MF , BCM57712_VF , BCM57800 , BCM57800_MF , BCM57800_VF , BCM57810 , BCM57810_MF , BCM57810_VF , BCM57840_4_10 , BCM57840_2_20 , BCM57840_MF , BCM57840_VF , BCM57811 , BCM57811_MF , BCM57840_O , BCM57840_MFO , BCM57811_VF , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ BNX2X_MULTI_TX_COS ] ;
...
position p;
@@
 struct bnx2x_mac_vals cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_init_params * cocci_id@p ;
...
position p;
@@
 struct fcoe_stats_info * cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_set_timesync_params * cocci_id@p ;
...
position p;
@@
 struct rxq_pause_params * cocci_id@p ;
...
position p;
@@
 struct skb_shared_hwtstamps cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_sp_obj * cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_sp_drv_ops cocci_id@p ;
...
position p;
@@
 struct bnx2x_queue_update_params * cocci_id@p ;
...
position p;
@@
 struct bnx2x_vlan_mac_ramrod_params cocci_id@p ;
...
position p;
@@
 struct bnx2x_fw_file_section * cocci_id@p ;
...
position p;
@@
 struct fairness_vars_per_vn cocci_id@p ;
...
position p;
@@
 struct ptp_clock_info * cocci_id@p ;
...
position p;
@@
 struct bnx2x_rx_mode_ramrod_params cocci_id@p ;
...
position p;
@@
 struct cnic_fc_npiv_tbl * cocci_id@p ;
...
position p;
@@
 struct rate_shaping_vars_per_vn cocci_id@p ;
...
position p;
@@
 struct bdn_fc_npiv_tbl * cocci_id@p ;
...
position p;
@@
 struct bnx2x_dcbx_app_params * cocci_id@p ;
...
position p;
@@
 struct xstorm_per_queue_stats * cocci_id@p ;
...
position p;
@@
 struct bnx2x_general_setup_params * cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_state_params cocci_id@p ;
...
position p;
@@
 struct iscsi_stats_info * cocci_id@p ;
...
position p;
@@
 struct eth_stats_info * cocci_id@p ;
...
position p;
@@
 struct bnx2x_queue_init_params * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct bnx2x * bp , bool start ) ;
...
position p;
@@
 struct glob_ncsi_oem_data cocci_id@p ;
...
position p;
@@
 enum bnx2x_udp_port_type cocci_id@p ;
...
position p;
@@
 struct host_port_stats * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ VENDOR_ID_LEN + 1 ] ;
...
position p;
@@
 int cocci_id@p ( struct bnx2x * bp , struct ifreq * ifr ) ;
...
position p;
@@
 enum bnx2x_queue_cmd cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct bnx2x * bp , int cid , u8 err ) ;
...
position p;
@@
 struct bnx2x_fastpath * cocci_id@p ;
...
position p;
@@
 struct hc_index_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_list_elem_group cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_afex_update_params * cocci_id@p ;
