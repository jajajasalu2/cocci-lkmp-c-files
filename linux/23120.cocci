...
symbol cocci_id;
position p;
typedef acp_dma_dscr_transfer_t;
@@
 acp_dma_dscr_transfer_t * cocci_id@p ;
...
position p;
@@
 struct audio_drv_data * cocci_id@p ;
...
position p;
@@
 union acp_dma_count cocci_id@p ;
...
position p;
@@
 enum acp_dma_priority_level cocci_id@p ;
...
typedef acp_dma_dscr_transfer_t;
@@
 acp_dma_dscr_transfer_t cocci_id@p [ NUM_DSCRS_PER_CHANNEL ] ;
...
position p;
@@
 struct audio_substream_data * cocci_id@p ;
