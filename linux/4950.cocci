...
position p;
@@
 struct ib_cc_congestion_entry_shadow * cocci_id@p ;
...
position p;
@@
 struct qib_pma_counters * cocci_id@p ;
...
position p;
@@
 struct ib_mad_notice_attr cocci_id@p ;
...
position p;
@@
 struct ib_cc_congestion_entry cocci_id@p ;
...
position p;
@@
 struct ib_pma_portsamplesresult * cocci_id@p ;
...
position p;
@@
 struct ib_pma_portcounters_cong * cocci_id@p ;
...
position p;
@@
 struct ib_cc_info_attr * cocci_id@p ;
...
position p;
@@
 struct ib_pma_portsamplesresult_ext * cocci_id@p ;
...
position p;
@@
 struct ib_cc_congestion_setting_attr * cocci_id@p ;
...
position p;
@@
 struct ib_pma_portsamplescontrol * cocci_id@p ;
...
position p;
@@
 struct ib_cc_classportinfo_attr * cocci_id@p ;
