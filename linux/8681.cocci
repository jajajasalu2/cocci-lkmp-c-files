...
position p;
@@
 enum { FM10K_PRV_FLAG_LEN , } cocci_id@p ;
...
position p;
@@
 const struct fm10k_stats cocci_id@p [ ] ;
...
position p;
@@
 enum fm10k_self_test_types { FM10K_TEST_MBX , FM10K_TEST_MAX = FM10K_TEST_LEN , } cocci_id@p ;
...
position p;
@@
 struct fm10k_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ FM10K_PRV_FLAG_LEN ] [ ETH_GSTRING_LEN ] ;
