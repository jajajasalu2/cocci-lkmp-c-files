...
position p;
@@
 struct mxl111sf_demod_state {  struct mxl111sf_state * mxl_state ;  const struct mxl111sf_demod_config * cfg ;  struct dvb_frontend fe ; } cocci_id@p ;
...
position p;
@@
 const struct mxl111sf_demod_config * cocci_id@p ;
...
position p;
@@
 struct mxl111sf_reg_ctrl_info cocci_id@p [ ] ;
...
position p;
@@
 enum fe_transmit_mode * cocci_id@p ;
...
position p;
@@
 struct mxl111sf_demod_state * cocci_id@p ;
...
position p;
@@
 enum fe_guard_interval * cocci_id@p ;
...
position p;
@@
 struct mxl111sf_state * cocci_id@p ;
