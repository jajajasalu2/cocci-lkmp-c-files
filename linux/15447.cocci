...
position p;
@@
 const struct max63xx_timeout cocci_id@p [ ] ;
...
position p;
@@
 struct max63xx_timeout * cocci_id@p ;
...
typedef u8;
@@
 struct max63xx_timeout {  const u8 wdset ;  const u8 tdelay ;  const u8 twd ; } cocci_id@p ;
