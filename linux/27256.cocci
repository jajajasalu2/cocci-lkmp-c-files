...
position p;
@@
 struct nfsd_writeargs cocci_id@p ;
...
position p;
@@
 struct nfsd_sattrargs * cocci_id@p ;
...
position p;
@@
 struct nfsd_diropargs * cocci_id@p ;
...
position p;
@@
 struct nfsd_readlinkargs cocci_id@p ;
...
position p;
@@
 struct nfsd_symlinkargs * cocci_id@p ;
...
position p;
@@
 struct nfsd_readres cocci_id@p ;
...
position p;
@@
 struct nfsd_readdirres * cocci_id@p ;
...
position p;
@@
 struct nfsd_readdirargs cocci_id@p ;
...
position p;
@@
 struct nfsd_void {  int dummy ; } cocci_id@p ;
...
position p;
@@
 struct nfsd_renameargs * cocci_id@p ;
...
position p;
@@
 struct nfsd_statfsres * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( nfsd_procedures2 ) ] ;
...
position p;
@@
 struct nfsd_readlinkres cocci_id@p ;
...
position p;
@@
 struct nfsd_linkargs cocci_id@p ;
...
position p;
@@
 struct nfsd_attrstat cocci_id@p ;
...
position p;
@@
 struct nfsd_readargs cocci_id@p ;
...
position p;
@@
 struct nfsd_createargs cocci_id@p ;
...
position p;
@@
 const struct svc_procedure cocci_id@p [ 18 ] ;
...
position p;
@@
 struct nfsd_diropres * cocci_id@p ;
...
typedef __be32;
@@
 struct {  __be32 nfserr ;  int syserr ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ RPC_MAX_ADDRBUFLEN ] ;
