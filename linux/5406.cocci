...
symbol cocci_id;
position p;
typedef bool,u32,tx_t,spinlock_t,rx_t;
@@
 struct fsl_espi {  struct device * dev ;  void __iomem * reg_base ;  struct list_head * m_transfers ;  struct spi_transfer * tx_t ;  unsigned int tx_pos ;  bool tx_done ;  struct spi_transfer * rx_t ;  unsigned int rx_pos ;  bool rx_done ;  bool swab ;  unsigned int rxskip ;  spinlock_t lock ;  u32 spibrg ;  struct completion done ; } cocci_id@p ;
...
typedef u32;
@@
 struct fsl_espi_cs {  u32 hw_mode ; } cocci_id@p ;
