...
position p;
@@
 struct vmci_event_ctx cocci_id@p ;
...
position p;
@@
 struct dbell_cpt_state * cocci_id@p ;
...
position p;
@@
 struct vmci_datagram_queue_entry * cocci_id@p ;
...
position p;
@@
 struct vmci_handle_list cocci_id@p ;
...
typedef spinlock_t;
@@
 struct {  struct list_head head ;  spinlock_t lock ; } cocci_id@p ;
