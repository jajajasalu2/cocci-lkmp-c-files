...
position p;
@@
 struct i7300_dimm_info {  int megabytes ; } cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ MAX_SLOTS ] ;
...
typedef u16;
@@
 struct i7300_dev_info {  const char * ctl_name ;  u16 fsb_mapping_errors ; } cocci_id@p ;
...
typedef u64,u32,u16;
@@
 struct i7300_pvt {  struct pci_dev * pci_dev_16_0_fsb_ctlr ;  struct pci_dev * pci_dev_16_1_fsb_addr_map ;  struct pci_dev * pci_dev_16_2_fsb_err_regs ;  struct pci_dev * pci_dev_2x_0_fbd_branch [ MAX_BRANCHES ] ;  u16 tolm ;  u64 ambase ;  u32 mc_settings ;  u32 mc_settings_a ;  u16 mir [ MAX_MIR ] ;  u16 mtr [ MAX_SLOTS ] [ MAX_BRANCHES ] ;  u16 ambpresent [ MAX_CHANNELS ] ;  struct i7300_dimm_info dimm_info [ MAX_SLOTS ] [ MAX_CHANNELS ] ;  char * tmp_prt_buffer ; } cocci_id@p ;
...
position p;
@@
 struct edac_mc_layer cocci_id@p [ 3 ] ;
...
position p;
@@
 struct i7300_dimm_info * cocci_id@p ;
...
position p;
@@
 const struct i7300_dev_info cocci_id@p [ ] ;
