...
position p;
@@
 const struct adt7411_data * cocci_id@p ;
...
position p;
@@
 struct adt7411_data * cocci_id@p ;
...
typedef bool;
@@
 struct adt7411_data {  struct mutex device_lock ;  struct mutex update_lock ;  unsigned long next_update ;  long vref_cached ;  struct i2c_client * client ;  bool use_ext_temp ; } cocci_id@p ;
