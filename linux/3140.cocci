...
position p;
@@
 const struct tb_xdomain_lookup * cocci_id@p ;
...
position p;
@@
 const struct tb_xdomain_header * cocci_id@p ;
...
position p;
@@
 struct tb_xdp_properties_response * cocci_id@p ;
...
position p;
@@
 const struct tb_property * cocci_id@p ;
...
position p;
@@
 struct tb_protocol_handler * cocci_id@p ;
...
position p;
@@
 struct tb_xdp_uuid_response cocci_id@p ;
...
position p;
@@
 struct xdomain_request_work * cocci_id@p ;
...
position p;
@@
 struct tb_xdp_properties cocci_id@p ;
...
position p;
@@
 struct tb_xdp_error_response cocci_id@p ;
...
position p;
@@
 struct tb_xdp_header * cocci_id@p ;
...
position p;
@@
 const struct tb_xdp_error_response * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u64,uuid_t;
@@
 struct tb_xdomain_lookup {  const uuid_t * uuid ;  u8 link ;  u8 depth ;  u64 route ; } cocci_id@p ;
...
position p;
@@
 const struct tb_xdp_header * cocci_id@p ;
...
position p;
@@
 struct tb_xdp_properties_changed cocci_id@p ;
...
position p;
@@
 const struct tb_property_dir * cocci_id@p ;
...
position p;
@@
 struct xdomain_request_work {  struct work_struct work ;  struct tb_xdp_header * pkg ;  struct tb * tb ; } cocci_id@p ;
...
position p;
@@
 struct tb_xdomain_lookup cocci_id@p ;
...
position p;
@@
 const struct tb_protocol_handler * cocci_id@p ;
...
position p;
@@
 const struct tb_xdp_properties_changed * cocci_id@p ;
...
position p;
@@
 struct tb_xdp_properties_changed_response cocci_id@p ;
...
position p;
@@
 const struct tb_xdp_properties * cocci_id@p ;
