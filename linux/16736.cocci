...
typedef u8;
@@
 u8 cocci_id@p [ LM8323_FIFO_LEN + 1 ] ;
...
typedef bool;
@@
 struct lm8323_pwm {  int id ;  int fade_time ;  int brightness ;  int desired_brightness ;  bool enabled ;  bool running ;  struct mutex lock ;  struct work_struct work ;  struct led_classdev cdev ;  struct lm8323_chip * chip ; } cocci_id@p ;
...
typedef bool;
@@
 struct lm8323_chip {  struct mutex lock ;  struct i2c_client * client ;  struct input_dev * idev ;  bool kp_enabled ;  bool pm_suspend ;  unsigned keys_down ;  char phys [ 32 ] ;  unsigned short keymap [ LM8323_KEYMAP_SIZE ] ;  int size_x ;  int size_y ;  int debounce_time ;  int active_time ;  struct lm8323_pwm pwm [ LM8323_NUM_PWMS ] ; } cocci_id@p ;
...
position p;
@@
 struct lm8323_platform_data * cocci_id@p ;
