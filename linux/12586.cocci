...
position p;
@@
 struct plane_state cocci_id@p [ STAGE_MAX + 1 ] ;
...
position p;
@@
 enum mdp_mixer_stage_id cocci_id@p ;
...
position p;
@@
 const struct mdp5_cfg_hw * cocci_id@p ;
...
position p;
@@
 enum mdp5_pipe cocci_id@p [ STAGE_MAX + 1 ] [ MAX_PIPE_STAGE ] ;
...
position p;
@@
 struct mdp5_crtc_state * cocci_id@p ;
...
position p;
@@
 struct mdp5_interface * cocci_id@p ;
...
position p;
@@
 struct plane_state {  struct drm_plane * plane ;  struct mdp5_plane_state * state ; } cocci_id@p ;
...
position p;
@@
 struct mdp5_hw_mixer * cocci_id@p ;
...
position p;
@@
 const enum mdp5_cursor_alpha cocci_id@p ;
