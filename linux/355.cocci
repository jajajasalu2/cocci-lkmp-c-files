...
position p;
@@
 struct bpf_raw_tracepoint * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( prog -> tag ) * 2 + 1 ] ;
...
position p;
@@
 struct bpf_raw_event_map * cocci_id@p ;
...
position p;
@@
 const struct bpf_prog_ops * const cocci_id@p [ ] ;
...
position p;
@@
 const struct bpf_prog_stats * cocci_id@p ;
...
position p;
@@
 struct bpf_map_memory cocci_id@p ;
...
position p;
@@
 const struct bpf_map_ops * const cocci_id@p [ ] ;
...
position p;
@@
 struct bpf_raw_tracepoint {  struct bpf_raw_event_map * btp ;  struct bpf_prog * prog ; } cocci_id@p ;
...
position p;
@@
 const struct bpf_array * cocci_id@p ;
