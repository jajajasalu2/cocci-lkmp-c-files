...
position p;
@@
 struct sdv_gpio_chip_data * cocci_id@p ;
...
position p;
@@
 struct sdv_gpio_chip_data {  int irq_base ;  void __iomem * gpio_pub_base ;  struct irq_domain * id ;  struct irq_chip_generic * gc ;  struct gpio_chip chip ; } cocci_id@p ;
