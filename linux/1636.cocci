...
position p;
@@
 const char * cocci_id@p [ PHY_COUNT ] ;
...
position p;
@@
 struct dwc3_meson_g12a * cocci_id@p ;
...
position p;
@@
 enum { USB2_HOST_PHY = 0 , USB2_OTG_PHY , USB3_HOST_PHY , PHY_COUNT , } cocci_id@p ;
...
position p;
@@
 struct dwc3_meson_g12a {  struct device * dev ;  struct regmap * regmap ;  struct clk * clk ;  struct reset_control * reset ;  struct phy * phys [ PHY_COUNT ] ;  enum usb_dr_mode otg_mode ;  enum phy_mode otg_phy_mode ;  unsigned int usb2_ports ;  unsigned int usb3_ports ;  struct regulator * vbus ;  struct usb_role_switch_desc switch_desc ;  struct usb_role_switch * role_switch ; } cocci_id@p ;
