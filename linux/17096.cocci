...
typedef u32;
@@
 struct pci_address {  u32 a_hi ;  u32 a_mid ;  u32 a_lo ; } cocci_id@p ;
...
typedef u32;
@@
 struct isa_address {  u32 a_hi ;  u32 a_lo ; } cocci_id@p ;
...
position p;
@@
 const struct isa_range * cocci_id@p ;
...
position p;
@@
 struct isa_range {  struct isa_address isa_addr ;  struct pci_address pci_addr ;  unsigned int size ; } cocci_id@p ;
