...
@@
 struct blk_queue_stats {  struct list_head callbacks ;  spinlock_t lock ;  bool enable_accounting ; } cocci_id@p ;
...
position p;
@@
 struct blk_queue_stats * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const struct request * ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct blk_stat_callback * ) ;
