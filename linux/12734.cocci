...
typedef spinlock_t;
@@
 struct qcom_iommu_domain {  struct io_pgtable_ops * pgtbl_ops ;  spinlock_t pgtbl_lock ;  struct mutex init_mutex ;  struct iommu_domain domain ;  struct qcom_iommu_dev * iommu ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct qcom_iommu_ctx {  struct device * dev ;  void __iomem * base ;  bool secure_init ;  u8 asid ;  struct iommu_domain * domain ; } cocci_id@p ;
...
position p;
@@
 struct qcom_iommu_ctx cocci_id@p ;
...
position p;
@@
 struct qcom_iommu_dev * cocci_id@p ;
...
typedef u8,u32;
@@
 struct qcom_iommu_dev {  struct iommu_device iommu ;  struct device * dev ;  struct clk * iface_clk ;  struct clk * bus_clk ;  void __iomem * local_base ;  u32 sec_id ;  u8 num_ctxs ;  struct qcom_iommu_ctx * ctxs [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct qcom_iommu_domain cocci_id@p ;
