...
position p;
@@
 struct ieee80211_sta_he_cap * cocci_id@p ;
...
typedef s64;
@@
 s64 cocci_id@p [ IEEE80211_NUM_ACS ] ;
...
position p;
@@
 char cocci_id@p [ 71 + IEEE80211_NUM_TIDS * 40 ] ;
...
position p;
@@
 char cocci_id@p [ 15 * IEEE80211_NUM_TIDS ] ;
...
position p;
@@
 char cocci_id@p [ 16 * NUM_WLAN_STA_FLAGS ] ;
...
position p;
@@
 char cocci_id@p [ 17 * IEEE80211_NUM_ACS ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ IEEE80211_NUM_ACS ] ;
