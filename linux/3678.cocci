...
typedef bool;
@@
 struct vpd_section {  bool enabled ;  const char * name ;  char * raw_name ;  struct kobject * kobj ;  char * baseaddr ;  struct bin_attribute bin_attr ;  struct list_head attribs ; } cocci_id@p ;
...
position p;
@@
 struct vpd_attrib_info {  char * key ;  const char * value ;  struct bin_attribute bin_attr ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct coreboot_driver cocci_id@p ;
...
typedef u8,u32;
@@
 struct vpd_cbmem {  u32 magic ;  u32 version ;  u32 ro_size ;  u32 rw_size ;  u8 blob [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct vpd_attrib_info * cocci_id@p ;
...
position p;
@@
 struct coreboot_device * cocci_id@p ;
