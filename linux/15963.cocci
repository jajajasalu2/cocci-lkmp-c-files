...
position p;
@@
 struct tx_config_cmd cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ OFDM_Table_Length ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ CCK_Table_length ] [ 8 ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ HT_IOT_PEER_MAX ] ;
...
position p;
@@
 struct dynamic_rx_path_sel cocci_id@p ;
