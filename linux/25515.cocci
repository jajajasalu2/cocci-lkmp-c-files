...
position p;
@@
 jvmtiLineNumberEntry * cocci_id@p ;
...
position p;
@@
 jvmtiEventCallbacks cocci_id@p ;
...
position p;
@@
 const jvmtiAddrLocationMap * cocci_id@p ;
...
typedef jvmti_line_info_t;
@@
 const jvmti_line_info_t * cocci_id@p ;
...
position p;
@@
 const jvmtiCompiledMethodLoadRecordHeader * cocci_id@p ;
...
position p;
@@
 jvmtiCompiledMethodLoadInlineRecord * cocci_id@p ;
...
position p;
@@
 jvmtiJlocationFormat cocci_id@p ;
