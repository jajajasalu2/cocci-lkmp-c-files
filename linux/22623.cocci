...
position p;
@@
 int ( * cocci_id@p ) ( struct usb_line6 * , const struct usb_device_id * id ) ;
...
position p;
@@
 struct message {  struct usb_line6 * line6 ;  const char * buffer ;  int size ;  int done ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct message * msg , struct urb * urb ) ;
...
position p;
@@
 const struct snd_hwdep_ops cocci_id@p ;
