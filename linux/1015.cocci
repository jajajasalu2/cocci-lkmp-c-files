...
position p;
@@
 struct image_info_v1 cocci_id@p ;
...
typedef u32;
@@
 struct image_info_v1 {  u32 bootFlags ;  u32 imageNumber ;  u32 loadAddress ;  u32 length ;  u32 address ;  char name [ 16 ] ;  u32 headerBase ;  u32 header_length ;  u32 headerType ;  u32 checksum ; } cocci_id@p ;
...
typedef u32;
@@
 struct footer_v1 {  u32 image_info_base ;  u32 image_start ;  u32 signature ;  u32 type ;  u32 checksum ; } cocci_id@p ;
