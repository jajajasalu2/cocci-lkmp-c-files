...
position p;
@@
 struct ti_cpufreq_data * cocci_id@p ;
...
typedef bool;
@@
 struct ti_cpufreq_soc_data {  const char * const * reg_names ;  unsigned long ( * efuse_xlate ) ( struct ti_cpufreq_data * opp_data , unsigned long efuse ) ;  unsigned long efuse_fallback ;  unsigned long efuse_offset ;  unsigned long efuse_mask ;  unsigned long efuse_shift ;  unsigned long rev_offset ;  bool multi_regulator ; } cocci_id@p ;
...
position p;
@@
 struct ti_cpufreq_data {  struct device * cpu_dev ;  struct device_node * opp_node ;  struct regmap * syscon ;  const struct ti_cpufreq_soc_data * soc_data ;  struct opp_table * opp_table ; } cocci_id@p ;
...
position p;
@@
 struct ti_cpufreq_soc_data cocci_id@p ;
