...
position p;
@@
 struct rmi_f30_ctrl_data * cocci_id@p ;
...
position p;
@@
 const struct rmi_device_platform_data * cocci_id@p ;
...
@@
 struct f30_data {  bool has_extended_pattern ;  bool has_mappable_buttons ;  bool has_led ;  bool has_gpio ;  bool has_haptic ;  bool has_gpio_driver_control ;  bool has_mech_mouse_btns ;  u8 gpioled_count ;  u8 register_count ;  struct rmi_f30_ctrl_data ctrl [ RMI_F30_CTRL_MAX_REG_BLOCKS ] ;  u8 ctrl_regs [ RMI_F30_CTRL_REGS_MAX_SIZE ] ;  u32 ctrl_regs_size ;  u8 data_regs [ RMI_F30_CTRL_MAX_BYTES ] ;  u16 * gpioled_key_map ;  struct input_dev * input ;  struct rmi_function * f03 ;  bool trackstick_buttons ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RMI_F30_QUERY_SIZE ] ;
...
typedef u8;
@@
 struct rmi_f30_ctrl_data {  int address ;  int length ;  u8 * regs ; } cocci_id@p ;
