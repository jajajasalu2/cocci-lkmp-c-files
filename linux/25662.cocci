...
symbol cocci_id;
position p;
typedef ocsd_mem_space_acc_t;
@@
 const ocsd_mem_space_acc_t cocci_id@p ;
...
position p;
@@
 enum cs_etm_sample_type cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ocsd_dcd_tree_src_t;
@@
 ocsd_dcd_tree_src_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ocsd_datapath_resp_t;
@@
 ocsd_datapath_resp_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dcd_tree_handle_t,ocsd_datapath_resp_t;
@@
 struct cs_etm_decoder {  void * data ;  void ( * packet_printer ) ( const char * msg ) ;  dcd_tree_handle_t dcd_tree ;  cs_etm_mem_cb_type mem_access ;  ocsd_datapath_resp_t prev_return ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ocsd_trc_index_t;
@@
 const ocsd_trc_index_t cocci_id@p ;
...
position p;
@@
 const ocsd_generic_trace_elem * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ocsd_vaddr_t;
@@
 const ocsd_vaddr_t cocci_id@p ;
