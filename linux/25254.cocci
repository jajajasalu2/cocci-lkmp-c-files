...
position p;
@@
 struct isa_exit_reasons {  unsigned isa ;  struct str_values * strings ; } cocci_id@p [ ] ;
...
position p;
@@
 struct str_values {  const char * str ;  int val ; } cocci_id@p ;
...
position p;
@@
 union kvm_mmu_page_role {  unsigned word ;  struct {  unsigned level : 4 ;  unsigned cr4_pae : 1 ;  unsigned quadrant : 2 ;  unsigned direct : 1 ;  unsigned access : 3 ;  unsigned invalid : 1 ;  unsigned nxe : 1 ;  unsigned cr0_wp : 1 ;  unsigned smep_and_not_wp : 1 ;  unsigned smap_and_not_wp : 1 ;  unsigned pad_for_nice_hex_output : 8 ;  unsigned smm : 8 ; } ; } cocci_id@p ;
