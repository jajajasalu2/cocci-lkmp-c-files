...
position p;
@@
 void cocci_id@p ( char * count_arg ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_namespace_node * node , union acpi_object * value ) ;
...
@@
 acpi_status cocci_id@p ( struct acpi_namespace_node * node , u32 bit_length ) ;
...
position p;
@@
 struct acpi_db_execute_walk cocci_id@p ;
...
position p;
@@
 const union acpi_predefined_info * cocci_id@p ;
...
position p;
@@
 union acpi_object cocci_id@p [ ACPI_METHOD_NUM_ARGS ] ;
...
typedef acpi_status,u32;
@@
 acpi_status cocci_id@p ( struct acpi_namespace_node * node , u32 byte_length ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_namespace_node * node ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( union acpi_operand_object * obj_desc ) ;
