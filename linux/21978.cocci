...
typedef u8,bool;
@@
 struct test_config {  char * name ;  bool into_buf ;  bool sync_direct ;  bool send_uevent ;  u8 num_requests ;  u8 read_fw_idx ;  struct test_batched_req * reqs ;  int test_result ;  int ( * req_firmware ) ( const struct firmware * * fw , const char * name , struct device * device ) ; } cocci_id@p ;
...
position p;
@@
 struct test_batched_req * cocci_id@p ;
...
typedef u8,bool;
@@
 struct test_batched_req {  u8 idx ;  int rc ;  bool sent ;  const struct firmware * fw ;  const char * name ;  struct completion completion ;  struct task_struct * task ;  struct device * dev ; } cocci_id@p ;
