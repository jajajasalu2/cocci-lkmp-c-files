...
typedef u32,u16;
@@
 struct cpsw_sl_dev_id {  const char * device_id ;  const u16 * regs ;  const u32 control_features ;  const u32 regs_offset ;  const u32 idle_mask ; } cocci_id@p ;
...
position p;
@@
 const struct cpsw_sl_dev_id cocci_id@p [ ] ;
...
typedef u32,u16;
@@
 struct cpsw_sl {  struct device * dev ;  void __iomem * sl_base ;  const u16 * regs ;  u32 control_features ;  u32 idle_mask ; } cocci_id@p ;
