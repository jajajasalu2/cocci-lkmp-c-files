...
position p;
@@
 struct vprbrd_gpiob_msg * cocci_id@p ;
...
position p;
@@
 struct vprbrd_gpioa_msg cocci_id@p ;
...
typedef u32;
@@
 struct vprbrd_gpio {  struct gpio_chip gpioa ;  u32 gpioa_out ;  u32 gpioa_val ;  struct gpio_chip gpiob ;  u32 gpiob_out ;  u32 gpiob_val ;  struct vprbrd * vb ; } cocci_id@p ;
