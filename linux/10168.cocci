...
position p;
@@
 struct sockaddr_mISDN * cocci_id@p ;
...
position p;
@@
 struct mISDN_devinfo cocci_id@p ;
...
position p;
@@
 struct mISDN_sock_list * cocci_id@p ;
...
position p;
@@
 struct mISDN_devrename cocci_id@p ;
...
position p;
@@
 struct mISDNversion cocci_id@p ;
