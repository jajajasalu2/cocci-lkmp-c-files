...
position p;
@@
 struct mmc_test_multiple_rw * cocci_id@p ;
...
typedef bool;
@@
 struct mmc_test_multiple_rw {  unsigned int * sg_len ;  unsigned int * bs ;  unsigned int len ;  unsigned int size ;  bool do_write ;  bool do_nonblock_req ;  enum mmc_test_prep_media prepare ; } cocci_id@p ;
...
position p;
@@
 struct mmc_test_pages {  struct page * page ;  unsigned int order ; } cocci_id@p ;
...
position p;
@@
 const struct mmc_test_case cocci_id@p [ ] ;
...
position p;
@@
 struct mmc_test_mem {  struct mmc_test_pages * arr ;  unsigned int cnt ; } cocci_id@p ;
...
position p;
@@
 struct mmc_test_dbgfs_file {  struct list_head link ;  struct mmc_card * card ;  struct dentry * file ; } cocci_id@p ;
...
position p;
@@
 struct mmc_test_general_result * cocci_id@p ;
...
position p;
@@
 struct mmc_test_card * cocci_id@p ;
...
position p;
@@
 struct mmc_test_mem * cocci_id@p ;
...
position p;
@@
 struct mmc_test_transfer_result {  struct list_head link ;  unsigned int count ;  unsigned int sectors ;  struct timespec64 ts ;  unsigned int rate ;  unsigned int iops ; } cocci_id@p ;
...
position p;
@@
 enum mmc_test_prep_media { MMC_TEST_PREP_NONE = 0 , MMC_TEST_PREP_WRITE_FULL = 1 << 0 , MMC_TEST_PREP_ERASE = 1 << 1 , } cocci_id@p ;
...
position p;
@@
 struct mmc_test_req {  struct mmc_request mrq ;  struct mmc_command sbc ;  struct mmc_command cmd ;  struct mmc_command stop ;  struct mmc_command status ;  struct mmc_data data ; } cocci_id@p ;
...
position p;
@@
 struct mmc_test_transfer_result * cocci_id@p ;
...
position p;
@@
 struct mmc_test_case {  const char * name ;  int ( * prepare ) ( struct mmc_test_card * ) ;  int ( * run ) ( struct mmc_test_card * ) ;  int ( * cleanup ) ( struct mmc_test_card * ) ; } cocci_id@p ;
...
position p;
@@
 struct mmc_test_area {  unsigned long max_sz ;  unsigned int dev_addr ;  unsigned int max_tfr ;  unsigned int max_segs ;  unsigned int max_seg_sz ;  unsigned int blocks ;  unsigned int sg_len ;  struct mmc_test_mem * mem ;  struct scatterlist * sg ; } cocci_id@p ;
...
position p;
@@
 struct mmc_test_req cocci_id@p ;
...
position p;
@@
 struct mmc_test_dbgfs_file * cocci_id@p ;
...
position p;
@@
 struct mmc_test_general_result {  struct list_head link ;  struct mmc_card * card ;  int testcase ;  int result ;  struct list_head tr_lst ; } cocci_id@p ;
...
position p;
@@
 struct mmc_test_area * cocci_id@p ;
