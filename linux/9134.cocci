...
position p;
@@
 struct mlx5_event_nb * cocci_id@p ;
...
position p;
@@
 struct mlx5_events {  struct mlx5_core_dev * dev ;  struct workqueue_struct * wq ;  struct mlx5_event_nb notifiers [ ARRAY_SIZE ( events_nbs_ref ) ] ;  struct atomic_notifier_head nh ;  struct mlx5_pme_stats pme_stats ;  struct work_struct pcie_core_work ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_pme_stats * cocci_id@p ;
...
position p;
@@
 struct mlx5_event_nb {  struct mlx5_nb nb ;  void * ctx ; } cocci_id@p ;
...
position p;
@@
 enum port_module_event_status_type cocci_id@p ;
...
position p;
@@
 enum { MLX5_PCI_POWER_COULD_NOT_BE_READ = 0x0 , MLX5_PCI_POWER_SUFFICIENT_REPORTED = 0x1 , MLX5_PCI_POWER_INSUFFICIENT_REPORTED = 0x2 , } cocci_id@p ;
...
position p;
@@
 struct mlx5_eqe_port_module * cocci_id@p ;
...
position p;
@@
 enum port_module_event_error_type cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mpein_reg ) ] ;
