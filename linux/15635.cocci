...
position p;
@@
 struct mt7621_pci_phy * cocci_id@p ;
...
position p;
@@
 struct mt7621_pci_phy_instance * cocci_id@p ;
...
typedef bool;
@@
 struct mt7621_pci_phy {  struct device * dev ;  struct regmap * regmap ;  struct mt7621_pci_phy_instance * * phys ;  int nphys ;  bool bypass_pipe_rst ; } cocci_id@p ;
...
typedef u32;
@@
 struct mt7621_pci_phy_instance {  struct phy * phy ;  void __iomem * port_base ;  u32 index ; } cocci_id@p ;
