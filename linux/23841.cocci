...
position p;
@@
 const struct em_ipt_match * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_EM_IPT_MAX + 1 ] ;
...
position p;
@@
 union {  struct ipt_entry e4 ;  struct ip6t_entry e6 ; } cocci_id@p ;
...
position p;
@@
 struct em_ipt_match * cocci_id@p ;
...
position p;
@@
 const struct em_ipt_xt_match cocci_id@p [ ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_EM_IPT_MAX + 1 ] ;
