...
position p;
@@
 struct iscsi_ipv4addr * cocci_id@p ;
...
position p;
@@
 struct cpl_smt_write_rpl * cocci_id@p ;
...
position p;
@@
 struct rdma_cq_setup * cocci_id@p ;
...
position p;
@@
 union active_open_entry * cocci_id@p ;
...
position p;
@@
 struct ch_mem_range * cocci_id@p ;
...
position p;
@@
 struct cpl_l2t_write_rpl * cocci_id@p ;
...
position p;
@@
 cpl_handler_func cocci_id@p [ NUM_CPL_CMDS ] ;
...
position p;
@@
 struct cxgb3_client * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dst_entry * old , struct dst_entry * new , struct neighbour * neigh , const void * daddr ) ;
...
position p;
@@
 struct ofld_page_info * cocci_id@p ;
...
position p;
@@
 struct t3c_tid_entry * cocci_id@p ;
...
position p;
@@
 struct ch_embedded_info * cocci_id@p ;
...
position p;
@@
 struct rdma_ctrlqp_setup * cocci_id@p ;
...
position p;
@@
 struct tp_mib_stats * cocci_id@p ;
...
position p;
@@
 struct cpl_rte_write_rpl * cocci_id@p ;
...
position p;
@@
 struct ulp_iscsi_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct neighbour * neigh ) ;
