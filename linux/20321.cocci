...
typedef u32;
@@
 struct pci_hostbridge_probe {  u32 bus ;  u32 slot ;  u32 vendor ;  u32 device ; } cocci_id@p ;
...
position p;
@@
 struct pci_hostbridge_probe cocci_id@p [ ] ;
