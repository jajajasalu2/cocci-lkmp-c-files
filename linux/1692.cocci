...
position p;
@@
 struct afe4403_data * cocci_id@p ;
...
position p;
@@
 struct afe4403_data {  struct device * dev ;  struct spi_device * spi ;  struct regmap * regmap ;  struct regmap_field * fields [ F_MAX_FIELDS ] ;  struct regulator * regulator ;  struct iio_trigger * trig ;  int irq ; } cocci_id@p ;
...
position p;
@@
 enum afe4403_chan_id { LED2 = 1 , ALED2 , LED1 , ALED1 , LED2_ALED2 , LED1_ALED1 , } cocci_id@p ;
...
position p;
@@
 enum afe4403_fields { F_RF_LED1 , F_CF_LED1 , F_RF_LED , F_CF_LED , F_ILED1 , F_ILED2 , F_MAX_FIELDS , } cocci_id@p ;
