...
position p;
@@
 struct max8952_data cocci_id@p ;
...
position p;
@@
 enum { MAX8952_REG_MODE0 , MAX8952_REG_MODE1 , MAX8952_REG_MODE2 , MAX8952_REG_MODE3 , MAX8952_REG_CONTROL , MAX8952_REG_SYNC , MAX8952_REG_RAMP , MAX8952_REG_CHIP_ID1 , MAX8952_REG_CHIP_ID2 , } cocci_id@p ;
...
typedef bool;
@@
 struct max8952_data {  struct i2c_client * client ;  struct max8952_platform_data * pdata ;  struct gpio_desc * vid0_gpiod ;  struct gpio_desc * vid1_gpiod ;  bool vid0 ;  bool vid1 ; } cocci_id@p ;
...
position p;
@@
 struct max8952_platform_data * cocci_id@p ;
