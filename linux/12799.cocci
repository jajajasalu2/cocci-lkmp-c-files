...
position p;
@@
 struct msc_iter {  struct list_head entry ;  struct msc * msc ;  struct msc_window * start_win ;  struct msc_window * win ;  unsigned long offset ;  struct scatterlist * start_block ;  struct scatterlist * block ;  unsigned int block_off ;  unsigned int wrap_count ;  unsigned int eof ; } cocci_id@p ;
...
position p;
@@
 struct intel_th_device * cocci_id@p ;
...
position p;
@@
 struct msc_block_desc * cocci_id@p ;
...
position p;
@@
 struct msc_win_to_user_struct cocci_id@p ;
...
position p;
@@
 struct msc_win_to_user_struct {  char __user * buf ;  unsigned long offset ; } cocci_id@p ;
...
position p;
@@
 struct msu_buffer_entry {  struct list_head entry ;  const struct msu_buffer * mbuf ;  struct module * owner ; } cocci_id@p ;
...
position p;
@@
 struct msu_buffer_entry * cocci_id@p ;
...
position p;
@@
 struct intel_th_driver cocci_id@p ;
...
position p;
@@
 enum lockout_state { WIN_READY = 0 , WIN_INUSE , WIN_LOCKED , } cocci_id@p ;
...
position p;
@@
 const struct msu_buffer * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct msc_window {  struct list_head entry ;  unsigned long pgoff ;  enum lockout_state lockout ;  spinlock_t lo_lock ;  unsigned int nr_blocks ;  unsigned int nr_segs ;  struct msc * msc ;  struct sg_table _sgt ;  struct sg_table * sgt ; } cocci_id@p ;
