...
position p;
@@
 const int cocci_id@p [ IP_VS_SCTP_S_LAST + 1 ] ;
...
symbol cocci_id;
position p;
typedef ipvs_sctp_event_t;
@@
 enum ipvs_sctp_event_t { IP_VS_SCTP_DATA = 0 , IP_VS_SCTP_INIT , IP_VS_SCTP_INIT_ACK , IP_VS_SCTP_COOKIE_ECHO , IP_VS_SCTP_COOKIE_ACK , IP_VS_SCTP_SHUTDOWN , IP_VS_SCTP_SHUTDOWN_ACK , IP_VS_SCTP_SHUTDOWN_COMPLETE , IP_VS_SCTP_ERROR , IP_VS_SCTP_ABORT , IP_VS_SCTP_EVENT_LAST , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int af , struct sk_buff * skb , struct ip_vs_protocol * pp ) ;
...
position p;
@@
 const char * cocci_id@p [ IP_VS_SCTP_S_LAST + 1 ] ;
