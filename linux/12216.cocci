...
position p;
@@
 int ( * cocci_id@p ) ( struct etnaviv_gpu * gpu , struct seq_file * m ) ;
...
position p;
@@
 struct etnaviv_drm_private * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_pm_signal * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_gem_userptr * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_gem_info * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_param * cocci_id@p ;
...
position p;
@@
 struct etnaviv_file_private * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_pm_domain * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_wait_fence * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct drm_device * dev , struct seq_file * m ) ;
...
position p;
@@
 struct drm_etnaviv_gem_cpu_fini * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_gem_wait * cocci_id@p ;
...
position p;
@@
 struct etnaviv_cmdbuf * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_gem_cpu_prep * cocci_id@p ;
...
position p;
@@
 struct etnaviv_iommu_context * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_gem_new * cocci_id@p ;
