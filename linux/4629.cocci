...
symbol cocci_id;
position p;
typedef spinlock_t,resource_size_t;
@@
 struct cs5535_mfgpt_chip { 
	 DECLARE_BITMAP ( avail , MFGPT_MAX_TIMERS ) 
		 ;  resource_size_t base ;  struct platform_device * pdev ;  spinlock_t lock ;  int initialized ; } cocci_id@p ;
...
position p;
@@
 struct cs5535_mfgpt_timer * cocci_id@p ;
...
position p;
@@
 struct cs5535_mfgpt_chip * cocci_id@p ;
...
position p;
@@
 struct cs5535_mfgpt_timer {  struct cs5535_mfgpt_chip * chip ;  int nr ; } cocci_id@p ;
