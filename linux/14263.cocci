...
position p;
@@
 struct ccdc_oper_config {  struct device * dev ;  enum vpfe_hw_if_type if_type ;  struct ccdc_params_raw bayer ;  struct ccdc_params_ycbcr ycbcr ;  void __iomem * base_addr ; } cocci_id@p ;
...
position p;
@@
 struct ccdc_vertical_dft * cocci_id@p ;
...
position p;
@@
 struct ccdc_black_compensation * cocci_id@p ;
...
position p;
@@
 struct ccdc_col_pat * cocci_id@p ;
...
position p;
@@
 struct ccdc_config_params_raw * cocci_id@p ;
...
position p;
@@
 struct ccdc_black_clamp * cocci_id@p ;
