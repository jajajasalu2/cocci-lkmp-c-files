...
position p;
@@
 const struct encoder_set_dp_phy_pattern_param * cocci_id@p ;
...
position p;
@@
 const struct link_encoder_funcs cocci_id@p ;
...
position p;
@@
 const struct link_mst_stream_allocation_table * cocci_id@p ;
...
position p;
@@
 union dpcd_training_lane_set cocci_id@p ;
...
position p;
@@
 const struct dce110_link_encoder * cocci_id@p ;
...
position p;
@@
 const struct stream_encoder * cocci_id@p ;
...
position p;
@@
 const struct link_mst_stream_allocation * cocci_id@p ;
...
position p;
@@
 enum { DP_MST_UPDATE_MAX_RETRY = 50 , } cocci_id@p ;
