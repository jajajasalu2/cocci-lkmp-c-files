...
position p;
@@
 struct iommu_dev_data cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct protection_domain * domain ) ;
...
position p;
@@
 struct protection_domain cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct irq_data * irqd , struct amd_iommu * iommu , struct amd_ir_data * ir_data , struct irq_2_irte * irte_info , struct irq_cfg * cfg ) ;
...
position p;
@@
 struct irq_remap_table * cocci_id@p ;
...
position p;
@@
 struct amd_iommu_device_info * cocci_id@p ;
...
position p;
@@
 struct acpihid_map_entry * cocci_id@p ;
...
position p;
@@
 struct unity_map_entry * cocci_id@p ;
...
typedef u32;
@@
 struct iommu_cmd {  u32 data [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct amd_iommu_fault cocci_id@p ;
...
position p;
@@
 struct amd_irte_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct protection_domain * domain ) ;
...
position p;
@@
 struct dev_table_entry cocci_id@p ;
