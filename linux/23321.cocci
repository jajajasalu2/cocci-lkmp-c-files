...
@@
 struct tlv320dac33_priv {  struct mutex mutex ;  struct work_struct work ;  struct snd_soc_component * component ;  struct regulator_bulk_data supplies [ DAC33_NUM_SUPPLIES ] ;  struct snd_pcm_substream * substream ;  int power_gpio ;  int chip_power ;  int irq ;  unsigned int refclk ;  unsigned int alarm_threshold ;  enum dac33_fifo_modes fifo_mode ;  unsigned int fifo_size ;  unsigned int nsample ;  int mode1_latency ;  u8 burst_bclkdiv ;  u8 * reg_cache ;  unsigned int burst_rate ;  int keep_bclk ;  spinlock_t lock ;  unsigned long long t_stamp1 ;  unsigned long long t_stamp2 ;  unsigned int mode1_us_burst ;  unsigned int mode7_us_to_lthr ;  unsigned int uthr ;  enum dac33_state state ;  struct i2c_client * i2c ; } cocci_id@p ;
...
position p;
@@
 struct tlv320dac33_platform_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_pcm_substream * substream , struct snd_soc_component * component ) ;
...
typedef u8;
@@
 const u8 cocci_id@p [ DAC33_CACHEREGNUM ] ;
...
position p;
@@
 enum dac33_fifo_modes { DAC33_FIFO_BYPASS = 0 , DAC33_FIFO_MODE1 , DAC33_FIFO_MODE7 , DAC33_FIFO_LAST_MODE , } cocci_id@p ;
...
position p;
@@
 struct tlv320dac33_priv cocci_id@p ;
...
position p;
@@
 enum dac33_state { DAC33_IDLE = 0 , DAC33_PREFILL , DAC33_PLAYBACK , DAC33_FLUSH , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_pcm_substream * substream , struct snd_soc_component * component ) ;
...
position p;
@@
 const char * cocci_id@p [ DAC33_NUM_SUPPLIES ] ;
