...
typedef bool;
@@
 struct tcpci {  struct device * dev ;  struct tcpm_port * port ;  struct regmap * regmap ;  bool controls_vbus ;  struct tcpc_dev tcpc ;  struct tcpci_data * data ; } cocci_id@p ;
...
position p;
@@
 struct tcpci_chip {  struct tcpci * tcpci ;  struct tcpci_data data ; } cocci_id@p ;
