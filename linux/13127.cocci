...
position p;
@@
 struct s10_svc_buf {  char * buf ;  unsigned long lock ; } cocci_id@p ;
...
position p;
@@
 struct fpga_image_info * cocci_id@p ;
...
position p;
@@
 struct fpga_manager * cocci_id@p ;
...
position p;
@@
 struct s10_priv {  struct stratix10_svc_chan * chan ;  struct stratix10_svc_client client ;  struct completion status_return_completion ;  struct s10_svc_buf svc_bufs [ NUM_SVC_BUFS ] ;  unsigned long status ; } cocci_id@p ;
...
position p;
@@
 enum stratix10_svc_command_code cocci_id@p ;
...
position p;
@@
 enum fpga_mgr_states cocci_id@p ;
...
position p;
@@
 const struct fpga_manager_ops cocci_id@p ;
