...
position p;
@@
 struct mmu_rb_handler cocci_id@p ;
...
typedef spinlock_t;
@@
 struct mmu_rb_handler {  struct mmu_notifier mn ;  struct rb_root_cached root ;  void * ops_arg ;  spinlock_t lock ;  struct mmu_rb_ops * ops ;  struct mm_struct * mm ;  struct list_head lru_list ;  struct work_struct del_work ;  struct list_head del_list ;  struct workqueue_struct * wq ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mmu_rb_handler * handler , 
...
position p;
@@
 unsigned long cocci_id@p ( struct mmu_rb_node * ) ;
...
position p;
@@
 struct mmu_rb_node * cocci_id@p ( struct mmu_rb_handler * , 
										  unsigned long , 
										  unsigned long ) ;
...
position p;
@@
 int cocci_id@p ( struct mmu_notifier * , 
