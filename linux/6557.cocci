...
position p;
@@
 struct fcoe_netdev_mapping * cocci_id@p ;
...
position p;
@@
 struct fcoe_transport * cocci_id@p ( struct net_device * device ) ;
...
position p;
@@
 struct fcoe_fc_els_lesb * cocci_id@p ;
