...
position p;
@@
 const struct sfp_eeprom_id * cocci_id@p ;
...
position p;
@@
 const struct sfp_socket_ops cocci_id@p ;
...
position p;
@@
 const struct sff_data cocci_id@p ;
...
typedef bool;
@@
 struct sff_data {  unsigned int gpios ;  bool ( * module_supported ) ( const struct sfp_eeprom_id * id ) ; } cocci_id@p ;
...
position p;
@@
 struct sfp_eeprom_id cocci_id@p ;
