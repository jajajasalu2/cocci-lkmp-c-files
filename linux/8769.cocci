...
position p;
@@
 struct uni_table_desc * cocci_id@p ;
...
position p;
@@
 struct uni_data_desc * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ NETXEN_MAX_CRB_XFORM ] ;
...
position p;
@@
 void cocci_id@p ( struct netxen_adapter * adapter , struct nx_host_rds_ring * rds_ring ) ;
...
typedef u32;
@@
 struct crb_addr_pair {  u32 addr ;  u32 data ; } cocci_id@p ;
...
position p;
@@
 struct netxen_rx_buffer * cocci_id@p ;
