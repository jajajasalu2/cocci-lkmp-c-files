...
position p;
@@
 struct thread_arg {  long id ;  struct timespec * timeout ;  int lock ;  int ret ; } cocci_id@p ;
...
typedef pthread_t;
@@
 pthread_t cocci_id@p [ THREAD_MAX ] ;
...
position p;
@@
 struct thread_arg cocci_id@p [ THREAD_MAX ] ;
