...
position p;
@@
 union {  struct nvif_perfmon_query_signal_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_device_oclass * * cocci_id@p ;
...
position p;
@@
 struct nvkm_perfctr * * cocci_id@p ;
...
position p;
@@
 const struct nvkm_object_func cocci_id@p ;
...
position p;
@@
 struct nvkm_perfdom * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_perfdom_read_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_perfdom_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_specmux * cocci_id@p ;
...
position p;
@@
 const struct nvkm_specdom * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_perfdom_init none ; } * cocci_id@p ;
...
position p;
@@
 struct nvkm_perfsig * cocci_id@p [ 4 ] ;
...
position p;
@@
 union {  struct nvif_perfmon_query_source_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_specsig * cocci_id@p ;
...
position p;
@@
 struct nvkm_perfsrc * cocci_id@p ;
...
position p;
@@
 const struct nvkm_specsrc * cocci_id@p ;
...
position p;
@@
 const struct nvkm_engine_func cocci_id@p ;
...
position p;
@@
 struct nvkm_perfmon * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_perfmon_query_domain_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 struct nvkm_perfsig * cocci_id@p ;
...
position p;
@@
 const struct nvkm_oclass * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_perfdom_sample none ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_pm_func * cocci_id@p ;
...
position p;
@@
 struct nvkm_perfctr * cocci_id@p [ 4 ] ;
