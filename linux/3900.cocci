...
typedef u32;
@@
 void cocci_id@p ( struct ssb_pcicore * pc , u32 address , u32 data ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct ssb_pcicore * pc , u32 address ) ;
...
typedef u8,u16;
@@
 u16 cocci_id@p ( struct ssb_pcicore * pc , u8 device , u8 address ) ;
...
typedef u8,u16;
@@
 void cocci_id@p ( struct ssb_pcicore * pc , u8 device , u8 address , u16 data ) ;
