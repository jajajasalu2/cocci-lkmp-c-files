...
position p;
@@
 struct dwapb_port_property * cocci_id@p ;
...
position p;
@@
 struct dwapb_gpio_port * cocci_id@p ;
...
position p;
@@
 struct dwapb_platform_data * cocci_id@p ;
...
typedef u32;
@@
 struct dwapb_context {  u32 data ;  u32 dir ;  u32 ext ;  u32 int_en ;  u32 int_mask ;  u32 int_type ;  u32 int_pol ;  u32 int_deb ;  u32 wake_en ; } cocci_id@p ;
...
position p;
@@
 struct dwapb_context * cocci_id@p ;
...
position p;
@@
 struct dwapb_gpio {  struct device * dev ;  void __iomem * regs ;  struct dwapb_gpio_port * ports ;  unsigned int nr_ports ;  struct irq_domain * domain ;  unsigned int flags ;  struct reset_control * rst ;  struct clk * clk ; } cocci_id@p ;
