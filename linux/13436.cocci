...
position p;
@@
 const struct go7007_usb_board * cocci_id@p ;
...
position p;
@@
 struct go7007_usb {  const struct go7007_usb_board * board ;  struct mutex i2c_lock ;  struct usb_device * usbdev ;  struct urb * video_urbs [ 8 ] ;  struct urb * audio_urbs [ 8 ] ;  struct urb * intr_urb ; } cocci_id@p ;
