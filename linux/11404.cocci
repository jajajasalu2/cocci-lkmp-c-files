...
position p;
@@
 struct vmw_kms_sou_surface_dirty cocci_id@p ;
...
position p;
@@
 struct vmw_screen_object_unit cocci_id@p ;
...
position p;
@@
 struct vmw_kms_sou_dirty_cmd * cocci_id@p ;
...
position p;
@@
 struct vmw_kms_sou_readback_blit {  uint32 header ;  SVGAFifoCmdBlitScreenToGMRFB body ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct {  struct {  uint32_t cmdType ; } header ;  SVGAScreenObject obj ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_kms_sou_define_gmrfb * cocci_id@p ;
...
position p;
@@
 struct vmw_du_update_plane_surface * cocci_id@p ;
...
typedef uint32_t;
@@
 struct {  struct {  uint32_t cmdType ; } header ;  SVGAFifoCmdDestroyScreen body ; } * cocci_id@p ;
...
typedef bool;
@@
 struct vmw_screen_object_unit {  struct vmw_display_unit base ;  unsigned long buffer_size ;  struct vmw_buffer_object * buffer ;  bool defined ; } cocci_id@p ;
...
position p;
@@
 struct vmw_kms_sou_readback_blit * cocci_id@p ;
...
typedef uint32_t;
@@
 struct vmw_kms_sou_define_gmrfb {  uint32_t header ;  SVGAFifoCmdDefineGMRFB body ; } cocci_id@p ;
...
position p;
@@
 struct vmw_kms_sou_bo_blit {  uint32 header ;  SVGAFifoCmdBlitGMRFBToScreen body ; } cocci_id@p ;
...
position p;
@@
 struct vmw_kms_sou_dirty_cmd {  SVGA3dCmdHeader header ;  SVGA3dCmdBlitSurfaceToScreen body ; } cocci_id@p ;
...
position p;
@@
 struct vmw_kms_sou_bo_blit cocci_id@p ;
