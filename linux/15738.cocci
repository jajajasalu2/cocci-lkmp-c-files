...
position p;
@@
 struct wfx_spi_priv * cocci_id@p ;
...
typedef bool;
@@
 struct wfx_spi_priv {  struct spi_device * func ;  struct wfx_dev * core ;  struct gpio_desc * gpio_reset ;  struct work_struct request_rx ;  bool need_swab ; } cocci_id@p ;
