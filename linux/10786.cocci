...
position p;
@@
 struct i915_selftest cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( int err , void * data ) ;
...
typedef bool;
@@
 struct selftest {  bool enabled ;  const char * name ;  union {  int ( * mock ) ( void ) ;  int ( * live ) ( struct drm_i915_private * ) ; } ; } cocci_id@p ;
