...
position p;
@@
 struct qdisc_size_table * cocci_id@p ;
...
position p;
@@
 struct Qdisc_class_common * cocci_id@p ;
...
position p;
@@
 struct qdisc_rate_table * cocci_id@p ;
...
position p;
@@
 struct tcf_bind_args * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_STAB_MAX + 1 ] ;
...
position p;
@@
 struct tc_root_qopt_offload cocci_id@p ;
...
position p;
@@
 struct check_loop_arg cocci_id@p ;
...
position p;
@@
 struct qdisc_watchdog * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_STAB_MAX + 1 ] ;
...
typedef u32;
@@
 struct tcf_bind_args {  struct tcf_walker w ;  u32 classid ;  unsigned long cl ; } cocci_id@p ;
...
position p;
@@
 const struct qdisc_size_table * cocci_id@p ;
...
position p;
@@
 struct qdisc_dump_args {  struct qdisc_walker w ;  struct sk_buff * skb ;  struct netlink_callback * cb ; } cocci_id@p ;
...
position p;
@@
 struct check_loop_arg {  struct qdisc_walker w ;  struct Qdisc * p ;  int depth ; } cocci_id@p ;
...
position p;
@@
 struct qdisc_dump_args * cocci_id@p ;
...
position p;
@@
 struct tc_estimator cocci_id@p ;
...
position p;
@@
 struct Qdisc_class_hash * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct Qdisc * q , unsigned long cl , struct qdisc_walker * w ) ;
