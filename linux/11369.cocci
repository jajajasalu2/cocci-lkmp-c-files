...
typedef u8,bool,u16;
@@
 struct anx78xx {  struct drm_dp_aux aux ;  struct drm_bridge bridge ;  struct i2c_client * client ;  struct edid * edid ;  struct drm_connector connector ;  struct anx78xx_platform_data pdata ;  struct mutex lock ;  struct i2c_client * i2c_dummy [ I2C_NUM_ADDRESSES ] ;  struct regmap * map [ I2C_NUM_ADDRESSES ] ;  u16 chipid ;  u8 dpcd [ DP_RECEIVER_CAP_SIZE ] ;  bool powered ; } cocci_id@p ;
...
position p;
@@
 struct anx78xx_platform_data * cocci_id@p ;
...
position p;
@@
 struct anx78xx_platform_data {  struct regulator * dvdd10 ;  struct gpio_desc * gpiod_hpd ;  struct gpio_desc * gpiod_pd ;  struct gpio_desc * gpiod_reset ;  int hpd_irq ;  int intp_irq ; } cocci_id@p ;
