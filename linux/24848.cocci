...
position p;
@@
 enum ip_conntrack_expect_events cocci_id@p ;
...
position p;
@@
 enum retry_state { STATE_CONGESTED , STATE_RESTART , STATE_DONE , } cocci_id@p ;
...
position p;
@@
 struct nf_conn * cocci_id@p [ ECACHE_STACK_ALLOC ] ;
