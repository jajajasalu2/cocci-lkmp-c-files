...
typedef s8,u32,s16;
@@
 struct bm1880_composite_clock {  unsigned int id ;  const char * name ;  const char * parent ;  const char * const * parents ;  unsigned int num_parents ;  unsigned long flags ;  u32 gate_reg ;  u32 mux_reg ;  u32 div_reg ;  s8 gate_shift ;  s8 mux_shift ;  s8 div_shift ;  s8 div_width ;  s16 div_initval ;  const struct clk_div_table * table ; } cocci_id@p ;
...
position p;
@@
 struct bm1880_div_hw_clock * cocci_id@p ;
...
position p;
@@
 struct bm1880_composite_clock * cocci_id@p ;
...
position p;
@@
 struct bm1880_pll_hw_clock * cocci_id@p ;
...
position p;
@@
 const struct bm1880_gate_clock * cocci_id@p ;
...
typedef u32;
@@
 struct bm1880_pll_clock {  unsigned int id ;  const char * name ;  u32 reg ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 struct bm1880_clock_data * cocci_id@p ;
...
position p;
@@
 struct bm1880_clock_data {  void __iomem * pll_base ;  void __iomem * sys_base ;  struct clk_hw_onecell_data hw_data ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct bm1880_div_clock {  unsigned int id ;  const char * name ;  u32 reg ;  u8 shift ;  u8 width ;  u32 initval ;  const struct clk_div_table * table ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 struct bm1880_div_clock * cocci_id@p ;
...
typedef s8,u32;
@@
 struct bm1880_gate_clock {  unsigned int id ;  const char * name ;  const char * parent ;  u32 gate_reg ;  s8 gate_shift ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 const struct bm1880_mux_clock * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct bm1880_div_hw_clock {  struct bm1880_div_clock div ;  void __iomem * base ;  spinlock_t * lock ;  struct clk_hw hw ;  struct clk_init_data init ; } cocci_id@p ;
...
position p;
@@
 struct bm1880_pll_hw_clock {  struct bm1880_pll_clock pll ;  void __iomem * base ;  struct clk_hw hw ;  struct clk_init_data init ; } cocci_id@p ;
...
position p;
@@
 struct clk_parent_data cocci_id@p [ ] ;
...
typedef s8,u32;
@@
 struct bm1880_mux_clock {  unsigned int id ;  const char * name ;  const char * const * parents ;  s8 num_parents ;  u32 reg ;  s8 shift ;  unsigned long flags ; } cocci_id@p ;
