...
position p;
@@
 BLANK_CRTC_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 ENABLE_DISP_POWER_GATING_PARAMETERS_V2_1 cocci_id@p ;
...
position p;
@@
 ENABLE_SCALER_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 union adjust_pixel_clock cocci_id@p ;
...
position p;
@@
 union atom_enable_ss cocci_id@p ;
...
position p;
@@
 ENABLE_CRTC_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 struct radeon_encoder_mst * cocci_id@p ;
...
position p;
@@
 union atom_enable_ss {  ENABLE_LVDS_SS_PARAMETERS lvds_ss ;  ENABLE_LVDS_SS_PARAMETERS_V2 lvds_ss_2 ;  ENABLE_SPREAD_SPECTRUM_ON_PPLL_PS_ALLOCATION v1 ;  ENABLE_SPREAD_SPECTRUM_ON_PPLL_V2 v2 ;  ENABLE_SPREAD_SPECTRUM_ON_PPLL_V3 v3 ; } cocci_id@p ;
...
position p;
@@
 SET_CRTC_OVERSCAN_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 union set_pixel_clock {  SET_PIXEL_CLOCK_PS_ALLOCATION base ;  PIXEL_CLOCK_PARAMETERS v1 ;  PIXEL_CLOCK_PARAMETERS_V2 v2 ;  PIXEL_CLOCK_PARAMETERS_V3 v3 ;  PIXEL_CLOCK_PARAMETERS_V5 v5 ;  PIXEL_CLOCK_PARAMETERS_V6 v6 ; } cocci_id@p ;
...
position p;
@@
 union adjust_pixel_clock {  ADJUST_DISPLAY_PLL_PS_ALLOCATION v1 ;  ADJUST_DISPLAY_PLL_PS_ALLOCATION_V3 v3 ; } cocci_id@p ;
...
position p;
@@
 union set_pixel_clock cocci_id@p ;
