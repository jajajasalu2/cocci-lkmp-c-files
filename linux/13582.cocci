...
position p;
@@
 const struct rtl28xxu_reg_val cocci_id@p [ ] ;
...
position p;
@@
 const struct rtl2832_platform_data cocci_id@p ;
...
position p;
@@
 struct e4000_config cocci_id@p ;
...
position p;
@@
 struct rtl28xxu_dev * cocci_id@p ;
...
position p;
@@
 const struct dvb_usb_device_properties cocci_id@p ;
...
position p;
@@
 const struct rtl28xxu_reg_val_mask cocci_id@p [ ] ;
...
position p;
@@
 struct ir_raw_event cocci_id@p ;
...
position p;
@@
 struct mn88473_config cocci_id@p ;
...
position p;
@@
 struct rtl28xxu_req * cocci_id@p ;
...
position p;
@@
 const struct rtl2830_platform_data cocci_id@p ;
...
position p;
@@
 struct rtl2832_sdr_platform_data cocci_id@p ;
...
position p;
@@
 struct rtl2832_platform_data * cocci_id@p ;
...
position p;
@@
 struct fc2580_platform_data cocci_id@p ;
...
position p;
@@
 struct rtl2830_platform_data * cocci_id@p ;
...
position p;
@@
 struct tua9001_platform_data cocci_id@p ;
...
position p;
@@
 const struct r820t_config cocci_id@p ;
...
position p;
@@
 const struct fc0012_config cocci_id@p ;
