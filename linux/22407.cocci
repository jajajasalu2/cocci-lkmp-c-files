...
typedef u32;
@@
 const u32 cocci_id@p [ OXYGEN_IO_SIZE / 32 ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ 2 ] [ 0x40 / 32 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct oxygen * chip , const struct pci_device_id * id ) ;
...
position p;
@@
 enum { PEX811X , PI7C9X110 , XIO2001 , } cocci_id@p ;
