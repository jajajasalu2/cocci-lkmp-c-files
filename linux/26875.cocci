...
position p;
@@
 struct fs_quota_stat cocci_id@p ;
...
position p;
@@
 struct fs_quota_statv cocci_id@p ;
...
position p;
@@
 struct fs_disk_quota * cocci_id@p ;
...
position p;
@@
 struct if_nextdqblk cocci_id@p ;
