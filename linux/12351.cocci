...
position p;
@@
 void cocci_id@p ( struct exynos_drm_ipp * ipp ) ;
...
position p;
@@
 struct exynos_drm_ipp_buffer * cocci_id@p ;
...
position p;
@@
 enum drm_ipp_size_id cocci_id@p ;
...
position p;
@@
 const struct exynos_drm_ipp_funcs * cocci_id@p ;
...
position p;
@@
 struct drm_exynos_ipp_limit_val * cocci_id@p ;
...
position p;
@@
 struct exynos_drm_ipp_task cocci_id@p ;
...
position p;
@@
 const struct exynos_drm_param_map {  unsigned int id ;  unsigned int size ;  unsigned int offset ; } cocci_id@p [ ] ;
...
position p;
@@
 struct drm_exynos_ioctl_ipp_get_limits * cocci_id@p ;
...
position p;
@@
 const struct exynos_drm_ipp_formats * cocci_id@p ;
...
position p;
@@
 struct drm_exynos_ioctl_ipp_get_caps * cocci_id@p ;
...
position p;
@@
 const struct exynos_drm_param_map * cocci_id@p ;
...
position p;
@@
 struct drm_exynos_ioctl_ipp_get_res * cocci_id@p ;
...
position p;
@@
 struct drm_exynos_ioctl_ipp_commit * cocci_id@p ;
...
position p;
@@
 const enum drm_exynos_ipp_limit_type cocci_id@p [ IPP_LIMIT_MAX ] [ 4 ] ;
...
position p;
@@
 struct drm_exynos_ipp_format cocci_id@p ;
...
position p;
@@
 struct drm_exynos_ipp_task_transform cocci_id@p ;
...
position p;
@@
 struct drm_exynos_ipp_task_rect * cocci_id@p ;
...
position p;
@@
 const struct drm_exynos_ipp_limit_val * cocci_id@p ;
...
position p;
@@
 enum drm_ipp_size_id { IPP_LIMIT_BUFFER , IPP_LIMIT_AREA , IPP_LIMIT_ROTATED , IPP_LIMIT_MAX , } cocci_id@p ;
...
position p;
@@
 struct drm_ipp_limit {  struct drm_exynos_ipp_limit_val h ;  struct drm_exynos_ipp_limit_val v ; } cocci_id@p ;
...
position p;
@@
 struct drm_exynos_ipp_task_buffer cocci_id@p ;
...
position p;
@@
 struct drm_ipp_limit * cocci_id@p ;
...
position p;
@@
 struct drm_pending_exynos_ipp_event * cocci_id@p ;
...
position p;
@@
 struct drm_exynos_ipp_task_alpha cocci_id@p ;
...
position p;
@@
 struct drm_pending_exynos_ipp_event {  struct drm_pending_event base ;  struct drm_exynos_ipp_event event ; } cocci_id@p ;
...
position p;
@@
 const struct drm_exynos_ipp_limit * cocci_id@p ;
...
position p;
@@
 struct exynos_drm_ipp * cocci_id@p ;
