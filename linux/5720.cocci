...
position p;
@@
 struct tc_clkevt_device {  struct clock_event_device clkevt ;  struct clk * clk ;  void __iomem * regs ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct {  u32 cmr ;  u32 imr ;  u32 rc ;  bool clken ; } cocci_id@p [ 3 ] ;
...
position p;
@@
 struct tc_clkevt_device cocci_id@p ;
