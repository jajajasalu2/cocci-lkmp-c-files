...
typedef u32;
@@
 const u32 cocci_id@p [ BONAIRE_IO_MC_REGS_SIZE ] [ 2 ] ;
...
position p;
@@
 enum radeon_connector_dither cocci_id@p ;
...
position p;
@@
 struct kv_reset_save_regs cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct radeon_device * rdev ) ;
...
position p;
@@
 struct dce8_wm_params cocci_id@p ;
...
typedef u32;
@@
 struct kv_reset_save_regs {  u32 gmcon_reng_execute ;  u32 gmcon_misc ;  u32 gmcon_misc3 ; } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ HAWAII_IO_MC_REGS_SIZE ] [ 2 ] ;
...
typedef u32;
@@
 struct bonaire_mqd {  u32 header ;  u32 dispatch_initiator ;  u32 dimensions [ 3 ] ;  u32 start_idx [ 3 ] ;  u32 num_threads [ 3 ] ;  u32 pipeline_stat_enable ;  u32 perf_counter_enable ;  u32 pgm [ 2 ] ;  u32 tba [ 2 ] ;  u32 tma [ 2 ] ;  u32 pgm_rsrc [ 2 ] ;  u32 vmid ;  u32 resource_limits ;  u32 static_thread_mgmt01 [ 2 ] ;  u32 tmp_ring_size ;  u32 static_thread_mgmt23 [ 2 ] ;  u32 restart [ 3 ] ;  u32 thread_trace_enable ;  u32 reserved1 ;  u32 user_data [ 16 ] ;  u32 vgtcs_invoke_count [ 2 ] ;  struct hqd_registers queue_state ;  u32 dequeue_cntr ;  u32 interrupt_queue [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 struct radeon_semaphore * cocci_id@p ;
...
position p;
@@
 const struct rlc_firmware_header_v1_0 * cocci_id@p ;
...
typedef bool,u32;
@@
 struct dce8_wm_params {  u32 dram_channels ;  u32 yclk ;  u32 sclk ;  u32 disp_clk ;  u32 src_width ;  u32 active_time ;  u32 blank_time ;  bool interlaced ;  fixed20_12 vsc ;  u32 num_heads ;  u32 bytes_per_pixel ;  u32 lb_size ;  u32 vtaps ; } cocci_id@p ;
...
position p;
@@
 struct evergreen_mc_save cocci_id@p ;
...
position p;
@@
 struct radeon_fence * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct radeon_device * rdev , struct radeon_mc * mc ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct radeon_device * rdev , u32 se , u32 sh ) ;
...
position p;
@@
 void cocci_id@p ( struct radeon_device * rdev , struct evergreen_mc_save * save ) ;
...
position p;
@@
 const struct mc_firmware_header_v1_0 * cocci_id@p ;
