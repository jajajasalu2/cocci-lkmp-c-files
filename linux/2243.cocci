...
position p;
@@
 struct cxgbit_iso_info * cocci_id@p ;
...
position p;
@@
 struct cxgbit_lro_cb * cocci_id@p ;
...
position p;
@@
 struct sge_opaque_hdr cocci_id@p ;
...
position p;
@@
 struct cpl_tx_data_iso cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct cxgbit_sock * , struct sk_buff * ) ;
...
typedef dma_addr_t;
@@
 struct sge_opaque_hdr {  void * dev ;  dma_addr_t addr [ MAX_SKB_FRAGS + 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct iscsi_conn_ops * cocci_id@p ;
...
position p;
@@
 struct cxgbit_lro_pdu_cb * cocci_id@p ;
