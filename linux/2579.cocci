...
position p;
@@
 struct btree_iter_set cocci_id@p ;
...
position p;
@@
 struct journal_replay * cocci_id@p ;
...
position p;
@@
 struct uuid_entry_v0 * cocci_id@p ;
...
position p;
@@
 struct pdev {  struct list_head list ;  struct cached_dev * dc ; } cocci_id@p ;
