...
position p;
@@
 struct ix2505v_state cocci_id@p ;
...
position p;
@@
 const struct ix2505v_config * cocci_id@p ;
...
typedef u32;
@@
 struct ix2505v_state {  struct i2c_adapter * i2c ;  const struct ix2505v_config * config ;  u32 frequency ; } cocci_id@p ;
