...
position p;
@@
 struct snd_soc_dapm_update * cocci_id@p ;
...
position p;
@@
 const struct snd_kcontrol * cocci_id@p ;
...
position p;
@@
 enum snd_soc_dapm_direction cocci_id@p ;
...
position p;
@@
 struct snd_soc_dapm_widget * cocci_id@p ( struct snd_soc_dapm_context * dapm , const struct snd_soc_dapm_widget * widget ) ;
...
position p;
@@
 const struct snd_soc_pcm_stream * cocci_id@p ;
...
position p;
@@
 struct dapm_kcontrol_data {  unsigned int value ;  struct snd_soc_dapm_widget * widget ;  struct list_head paths ;  struct snd_soc_dapm_widget_list * wlist ; } cocci_id@p ;
...
position p;
@@
 enum snd_soc_bias_level cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct snd_soc_dapm_widget * , enum snd_soc_dapm_direction ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct snd_soc_dapm_widget * i , enum snd_soc_dapm_direction ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_soc_dapm_context * dapm , struct snd_soc_dapm_widget * wsource , struct snd_soc_dapm_widget * wsink , const char * control , int ( * connected ) ( struct snd_soc_dapm_widget * source , struct snd_soc_dapm_widget * sink ) ) ;
...
position p;
@@
 struct snd_soc_dapm_widget_list * * cocci_id@p ;
...
position p;
@@
 struct dapm_kcontrol_data * cocci_id@p ;
...
position p;
@@
 struct snd_soc_dapm_pinctrl_priv * cocci_id@p ;
...
position p;
@@
 struct snd_soc_dapm_widget * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct snd_soc_dapm_wcache * cocci_id@p ;
...
position p;
@@
 struct pinctrl_state * cocci_id@p ;
...
typedef bool;
@@
 int ( * cocci_id@p ) ( struct snd_soc_dapm_widget * , struct list_head * , bool ( * custom_stop_condition ) ( struct snd_soc_dapm_widget * , enum snd_soc_dapm_direction ) ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_soc_dapm_widget * source , struct snd_soc_dapm_widget * sink ) ;
