...
position p;
@@
 struct contig_page_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ NR_VM_ZONE_STAT_ITEMS ] ;
...
position p;
@@
 unsigned long cocci_id@p [ MIGRATE_TYPES ] ;
...
position p;
@@
 struct contig_page_info {  unsigned long free_pages ;  unsigned long free_blocks_total ;  unsigned long free_blocks_suitable ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ NR_VM_NODE_STAT_ITEMS ] ;
...
position p;
@@
 int cocci_id@p [ NR_VM_NUMA_STAT_ITEMS ] ;
...
position p;
@@
 struct vm_event_state * cocci_id@p ;
...
position p;
@@
 enum zone_stat_item cocci_id@p ;
