...
position p;
@@
 enum { MWL8K_ALG_WEP , MWL8K_ALG_TKIP , MWL8K_ALG_CCMP , } cocci_id@p ;
...
position p;
@@
 enum { FW_STATE_INIT = 0 , FW_STATE_LOADING_PREF , FW_STATE_LOADING_ALT , FW_STATE_ERROR , } cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_bastream * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_ops cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_hw_spec * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct firmware * fw , void * context ) ;
...
typedef dma_addr_t;
@@
 struct mwl8k_rx_queue {  int rxd_count ;  int head ;  int tail ;  void * rxd ;  dma_addr_t rxd_dma ;  struct {  struct sk_buff * skb ;  DEFINE_DMA_UNMAP_ADDR ( dma ) ; } * buf ; } cocci_id@p ;
...
position p;
@@
 enum { MWL8K_ENCR_ENABLE , MWL8K_ENCR_SET_KEY , MWL8K_ENCR_REMOVE_KEY , MWL8K_ENCR_SET_GROUP_KEY , } cocci_id@p ;
...
typedef u8;
@@
 struct mwl8k_sta {  u8 peer_id ;  u8 is_ampdu_allowed ;  struct tx_traffic_info tx_stats [ MWL8K_MAX_TID ] ; } cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_rf_channel * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_get_hw_spec_sta * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_enable_sniffer * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ieee80211_hw * hw , char * fw_image ) ;
...
position p;
@@
 struct mwl8k_cmd_get_stat * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_get_watchdog_bitmap * cocci_id@p ;
...
position p;
@@
 struct ieee80211_conf * cocci_id@p ;
...
position p;
@@
 struct mwl8k_tx_queue * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_rts_threshold * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_pkt * cocci_id@p ;
...
typedef u32;
@@
 struct tx_traffic_info {  u32 start_time ;  u32 pkts ; } cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_finalize_join * cocci_id@p ;
...
position p;
@@
 enum { AMPDU_NO_STREAM , AMPDU_STREAM_NEW , AMPDU_STREAM_IN_PROGRESS , AMPDU_STREAM_ACTIVE , } cocci_id@p ;
...
position p;
@@
 struct mwl8k_ampdu_stream * cocci_id@p ;
...
typedef bool,u32;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , bool enable , u32 bitmap ) ;
...
position p;
@@
 struct mwl8k_cmd_set_beacon * cocci_id@p ;
...
typedef __u8;
@@
 struct mwl8k_cmd_mac_multicast_adr {  struct mwl8k_cmd_pkt header ;  __le16 action ;  __le16 numaddr ;  __u8 addr [ 0 ] [ ETH_ALEN ] ; } cocci_id@p ;
...
position p;
@@
 enum { MWL8363 = 0 , MWL8687 , MWL8366 , MWL8764 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s8,u8,bool,u32,u16,atomic_t,spinlock_t,dma_addr_t;
@@
 struct mwl8k_priv {  struct ieee80211_hw * hw ;  struct pci_dev * pdev ;  int irq ;  struct mwl8k_device_info * device_info ;  void __iomem * sram ;  void __iomem * regs ;  const struct firmware * fw_helper ;  const struct firmware * fw_ucode ;  bool ap_fw ;  struct rxd_ops * rxd_ops ;  struct ieee80211_supported_band band_24 ;  struct ieee80211_channel channels_24 [ 14 ] ;  struct ieee80211_rate rates_24 [ 13 ] ;  struct ieee80211_supported_band band_50 ;  struct ieee80211_channel channels_50 [ 9 ] ;  struct ieee80211_rate rates_50 [ 8 ] ;  u32 ap_macids_supported ;  u32 sta_macids_supported ;  u8 num_ampdu_queues ;  spinlock_t stream_lock ;  struct mwl8k_ampdu_stream ampdu [ MWL8K_MAX_AMPDU_QUEUES ] ;  struct work_struct watchdog_ba_handle ;  struct mutex fw_mutex ;  struct task_struct * fw_mutex_owner ;  struct task_struct * hw_restart_owner ;  int fw_mutex_depth ;  struct completion * hostcmd_wait ;  atomic_t watchdog_event_pending ;  spinlock_t tx_lock ;  struct completion * tx_wait ;  u32 macids_used ;  struct list_head vif_list ;  u32 * cookie ;  dma_addr_t cookie_dma ;  u16 num_mcaddrs ;  u8 hw_rev ;  u32 fw_rev ;  u32 caps ;  int pending_tx_pkts ;  struct mwl8k_rx_queue rxq [ MWL8K_RX_QUEUES ] ;  struct mwl8k_tx_queue txq [ MWL8K_MAX_TX_QUEUES ] ;  u32 txq_offset [ MWL8K_MAX_TX_QUEUES ] ;  bool radio_on ;  bool radio_short_preamble ;  bool sniffer_enabled ;  bool wmm_enabled ;  bool capture_beacon ;  u8 capture_bssid [ ETH_ALEN ] ;  struct sk_buff * beacon_skb ;  struct work_struct finalize_join_worker ;  struct tasklet_struct poll_tx_task ;  struct tasklet_struct poll_rx_task ;  s8 noise ;  struct ieee80211_tx_queue_params wmm_params [ MWL8K_TX_WMM_QUEUES ] ;  struct work_struct fw_reload ;  bool hw_restart_in_progress ;  unsigned fw_state ;  char * fw_pref ;  char * fw_alt ;  bool is_8764 ;  struct completion firmware_loading_complete ;  u32 running_bsses ;  bool sw_scan_start ;  struct ieee80211_channel * acs_chan ;  unsigned long channel_time ;  struct survey_info survey [ MWL8K_NUM_CHANS ] ; } cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_update_encryption * cocci_id@p ;
...
position p;
@@
 struct mwl8k_dma_data cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_use_fixed_rate_ap * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_get_hw_spec_ap * cocci_id@p ;
...
typedef u32;
@@
 struct mwl8k_device_info {  char * part_name ;  char * helper_image ;  char * fw_image_sta ;  char * fw_image_ap ;  struct rxd_ops * ap_rxd_ops ;  u32 fw_api_ap ; } cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_slot * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_rf_tx_power * cocci_id@p ;
...
position p;
@@
 struct ieee80211_cts cocci_id@p ;
...
position p;
@@
 struct mwl8k_rxd_sta * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_update_set_aid * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_channel cocci_id@p [ ] ;
...
position p;
@@
 struct mwl8k_cmd_set_key cocci_id@p ;
...
position p;
@@
 struct mwl8k_tx_desc * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_iface_limit cocci_id@p [ ] ;
...
position p;
@@
 struct mwl8k_cmd_rf_antenna * cocci_id@p ;
...
position p;
@@
 struct ieee80211_bss_conf * cocci_id@p ;
...
position p;
@@
 struct ieee80211_low_level_stats * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_pre_scan * cocci_id@p ;
...
position p;
@@
 struct mwl8k_rxd_ap cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_use_fixed_rate_sta * cocci_id@p ;
...
position p;
@@
 struct ieee80211_hw * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_post_scan * cocci_id@p ;
...
position p;
@@
 struct ieee80211_key_conf * cocci_id@p ;
...
position p;
@@
 struct peer_capability_info * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct mwl8k_vif {  struct list_head list ;  struct ieee80211_vif * vif ;  int macid ;  u16 seqno ;  struct {  u8 enabled ;  u8 key [ sizeof ( struct ieee80211_key_conf ) + MAX_WEP_KEY_LEN ] ; } wep_key_conf [ NUM_WEP_KEYS ] ;  u8 bssid [ ETH_ALEN ] ;  bool is_hw_crypto_enabled ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mwl8k_priv * priv ) ;
...
position p;
@@
 struct mwl8k_rx_queue * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_update_stadb * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_rate_adapt_mode * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_tx_power * cocci_id@p ;
...
position p;
@@
 struct mwl8k_device_info * cocci_id@p ;
...
position p;
@@
 struct tx_traffic_info * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct mwl8k_tx_queue {  int head ;  int tail ;  unsigned int len ;  struct mwl8k_tx_desc * txd ;  dma_addr_t txd_dma ;  struct sk_buff * * skb ; } cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_rate * cocci_id@p ;
...
position p;
@@
 struct ieee80211_tx_control * cocci_id@p ;
...
position p;
@@
 enum ba_stream_action_type { MWL8K_BA_CREATE , MWL8K_BA_UPDATE , MWL8K_BA_DESTROY , MWL8K_BA_FLUSH , MWL8K_BA_CHECK , } cocci_id@p ;
...
typedef __u8;
@@
 struct mwl8k_cmd_set_beacon {  struct mwl8k_cmd_pkt header ;  __le16 beacon_len ;  __u8 beacon [ 0 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct mwl8k_ampdu_stream {  struct ieee80211_sta * sta ;  u8 tid ;  u8 state ;  u8 idx ; } cocci_id@p ;
...
position p;
@@
 struct ieee80211_ampdu_params * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_bbp_reg_access * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , u8 idx ) ;
...
position p;
@@
 struct netdev_hw_addr_list * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_mimo_config * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_radio_control * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_bss_start * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_wmm_mode * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_edca_params * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_update_mac_addr * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_tx_queue_params * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_mac_multicast_adr * cocci_id@p ;
...
position p;
@@
 struct mwl8k_cmd_set_new_stn * cocci_id@p ;
...
position p;
@@
 enum ieee80211_ampdu_mlme_action cocci_id@p ;
