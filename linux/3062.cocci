...
position p;
@@
 struct atari_disk_type * cocci_id@p ;
...
position p;
@@
 struct atari_floppy_struct * cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * dummy ) ;
...
position p;
@@
 struct atari_floppy_struct {  int connected ;  int autoprobe ;  struct atari_disk_type * disktype ;  int track ;  unsigned int steprate ;  unsigned int wpstat ;  int flags ;  struct gendisk * disk ;  int ref ;  int type ;  struct blk_mq_tag_set tag_set ; } cocci_id@p [ FD_MAX_UNITS ] ;
...
position p;
@@
 struct atari_format_descr cocci_id@p ;
...
position p;
@@
 struct atari_disk_type {  const char * name ;  unsigned spt ;  unsigned blocks ;  unsigned fdc_speed ;  unsigned stretch ; } cocci_id@p [ ] ;
...
position p;
@@
 struct atari_disk_type cocci_id@p [ FD_MAX_UNITS ] ;
...
position p;
@@
 struct {  int index ;  unsigned drive_types ; } cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( int drive , int type , struct atari_format_descr * desc ) ;
...
position p;
@@
 struct atari_format_descr {  int track ;  int head ;  int sect_offset ; } cocci_id@p ;
