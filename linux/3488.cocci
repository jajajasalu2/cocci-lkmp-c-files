...
position p;
@@
 struct goldfish_mmc_host cocci_id@p ;
...
position p;
@@
 struct goldfish_mmc_host {  struct mmc_request * mrq ;  struct mmc_command * cmd ;  struct mmc_data * data ;  struct device * dev ;  unsigned char id ;  void * virt_base ;  unsigned int phys_base ;  int irq ;  unsigned char bus_mode ;  unsigned char hw_bus_mode ;  unsigned int sg_len ;  unsigned dma_done : 1 ;  unsigned dma_in_use : 1 ;  void __iomem * reg_base ; } cocci_id@p ;
