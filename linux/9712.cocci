...
position p;
@@
 struct iwl_bt_notif_statistics cocci_id@p ;
...
position p;
@@
 struct statistics_rx_phy * cocci_id@p ;
...
position p;
@@
 struct iwl_rx_phy_res cocci_id@p ;
...
position p;
@@
 struct iwlagn_non_cfg_phy * cocci_id@p ;
...
position p;
@@
 struct statistics_bt_activity * cocci_id@p ;
...
position p;
@@
 struct iwl_rxon_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_sleep_notification * cocci_id@p ;
...
position p;
@@
 struct statistics_rx_non_phy * cocci_id@p ;
...
position p;
@@
 struct iwl_notif_statistics * cocci_id@p ;
...
position p;
@@
 struct iwl_spectrum_notification * cocci_id@p ;
...
position p;
@@
 struct iwl_csa_notification * cocci_id@p ;
...
position p;
@@
 struct statistics_general_common * cocci_id@p ;
...
position p;
@@
 struct iwl_wipan_noa_notification * cocci_id@p ;
...
position p;
@@
 struct statistics_tx * cocci_id@p ;
...
position p;
@@
 struct iwl_missed_beacon_notif * cocci_id@p ;
...
position p;
@@
 struct iwlagn_beacon_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_wipan_noa_data * cocci_id@p ;
...
position p;
@@
 struct statistics_rx_ht_phy * cocci_id@p ;
...
position p;
@@
 void * * cocci_id@p ( struct iwl_priv * priv , struct iwl_rx_cmd_buffer * rxb ) ;
...
position p;
@@
 struct iwl_rf_reset * cocci_id@p ;
