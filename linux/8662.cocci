...
typedef u8,s32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , u8 byte_offset , u8 dev_addr , u8 data ) ;
...
typedef bool,s32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , bool autoneg_wait_to_complete ) ;
...
position p;
@@
 void cocci_id@p ( struct ixgbe_hw * , ixgbe_link_speed ) ;
...
typedef bool,s32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , ixgbe_link_speed speed , bool autoneg_wait_to_complete ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ixgbe_hw * hw ) ;
