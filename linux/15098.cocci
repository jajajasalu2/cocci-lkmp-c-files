...
position p;
@@
 struct axxia_pllclk cocci_id@p ;
...
typedef u32;
@@
 struct axxia_divclk {  struct axxia_clk aclk ;  u32 reg ;  u32 shift ;  u32 width ; } cocci_id@p ;
...
position p;
@@
 struct axxia_divclk cocci_id@p ;
...
position p;
@@
 struct axxia_clkmux cocci_id@p ;
...
position p;
@@
 struct axxia_clk {  struct clk_hw hw ;  struct regmap * regmap ; } cocci_id@p ;
...
typedef u32;
@@
 struct axxia_pllclk {  struct axxia_clk aclk ;  u32 reg ; } cocci_id@p ;
...
typedef u32;
@@
 struct axxia_clkmux {  struct axxia_clk aclk ;  u32 reg ;  u32 shift ;  u32 width ; } cocci_id@p ;
