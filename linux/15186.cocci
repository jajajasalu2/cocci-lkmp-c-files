...
typedef u32;
@@
 struct lm3532_data {  struct gpio_desc * enable_gpio ;  struct regulator * regulator ;  struct i2c_client * client ;  struct regmap * regmap ;  struct device * dev ;  struct mutex lock ;  struct lm3532_als_data * als_data ;  u32 runtime_ramp_up ;  u32 runtime_ramp_down ;  struct lm3532_led leds [ ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct lm3532_led {  struct led_classdev led_dev ;  struct lm3532_data * priv ;  int control_bank ;  int mode ;  int ctrl_brt_pointer ;  int num_leds ;  int full_scale_current ;  int enabled : 1 ;  u32 led_strings [ LM3532_MAX_CONTROL_BANKS ] ;  char label [ LED_MAX_NAME_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ LM3532_NUM_IMP_VALS ] ;
...
typedef u8,u32;
@@
 struct lm3532_als_data {  u8 config ;  u8 als1_imp_sel ;  u8 als2_imp_sel ;  u8 als_avrg_time ;  u8 als_input_mode ;  u32 als_vmin ;  u32 als_vmax ;  u8 zones_lo [ LM3532_ALS_ZB_MAX ] ;  u8 zones_hi [ LM3532_ALS_ZB_MAX ] ; } cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ LM3532_NUM_AVG_VALS ] ;
...
position p;
@@
 struct lm3532_als_data * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ LM3532_NUM_RAMP_VALS ] ;
