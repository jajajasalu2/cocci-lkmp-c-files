...
position p;
@@
 struct max7359_keypad {  unsigned short keycodes [ MAX7359_MAX_KEY_NUM ] ;  struct input_dev * input_dev ;  struct i2c_client * client ; } cocci_id@p ;
...
position p;
@@
 struct max7359_keypad cocci_id@p ;
