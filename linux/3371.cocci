...
position p;
@@
 struct cros_ec_pwm_device * cocci_id@p ;
...
position p;
@@
 struct ec_response_pwm_get_duty * cocci_id@p ;
...
position p;
@@
 struct ec_params_pwm_get_duty * cocci_id@p ;
...
position p;
@@
 struct cros_ec_pwm_device {  struct device * dev ;  struct cros_ec_device * ec ;  struct pwm_chip chip ; } cocci_id@p ;
...
position p;
@@
 struct ec_params_pwm_set_duty * cocci_id@p ;
