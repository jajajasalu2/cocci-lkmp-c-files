...
position p;
@@
 enum bmips_type { BMIPS5000 , BMIPS5200 , } cocci_id@p ;
...
position p;
@@
 struct cpufreq_compat {  const char * compatible ;  unsigned int bmips_type ;  unsigned int clk_mult ;  unsigned int max_freqs ; } cocci_id@p ;
...
position p;
@@
 const struct cpufreq_policy * cocci_id@p ;
...
position p;
@@
 struct cpufreq_compat * cocci_id@p ;
