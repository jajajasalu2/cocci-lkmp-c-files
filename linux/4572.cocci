...
position p;
@@
 struct scif_vma_info cocci_id@p ;
...
typedef bool,s64;
@@
 struct vma_pvt {  struct scif_endpt * ep ;  s64 offset ;  bool valid_offset ;  struct kref ref ; } cocci_id@p ;
...
position p;
@@
 struct scif_vma_info {  struct vm_area_struct * vma ;  struct list_head list ; } cocci_id@p ;
