...
position p;
@@
 struct lpfc_fast_path_event * cocci_id@p ;
...
typedef __be32;
@@
 struct scsi_dif_tuple {  __be16 guard_tag ;  __be16 app_tag ;  __be32 ref_tag ; } cocci_id@p ;
...
position p;
@@
 struct sli4_sge_diseed * cocci_id@p ;
...
position p;
@@
 const struct lpfc_hba * cocci_id@p ;
...
position p;
@@
 struct scsi_dif_tuple cocci_id@p ;
...
position p;
@@
 struct lpfc_scsi_event_header cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_hba * phba , struct lpfc_io_buf * psb ) ;
...
position p;
@@
 struct sli3_bg_fields * cocci_id@p ;
...
position p;
@@
 struct lpfc_device_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lpfc_hba * phba , struct scsi_cmnd * sc ) ;
...
position p;
@@
 struct lpfc_device_id * cocci_id@p ;
