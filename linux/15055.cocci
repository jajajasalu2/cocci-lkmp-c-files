...
position p;
@@
 enum { P_BI_TCXO , P_CORE_BI_PLL_TEST_SE , P_GPLL0_OUT_EVEN , P_GPLL0_OUT_MAIN , P_GPLL1_OUT_MAIN , P_GPLL4_OUT_MAIN , P_GPLL6_OUT_MAIN , P_GPLL7_OUT_MAIN , P_SLEEP_CLK , } cocci_id@p ;
...
position p;
@@
 struct clk_rcg_dfs_data cocci_id@p [ ] ;
