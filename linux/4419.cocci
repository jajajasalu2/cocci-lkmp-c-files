...
typedef u32;
@@
 struct isoch_data {  u32 maxbw ;  u32 n ;  u32 y ;  u32 l ;  u32 rq ;  struct agp_3_5_dev * dev ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct agp_3_5_dev {  struct list_head list ;  u8 capndx ;  u32 maxbw ;  struct pci_dev * dev ; } cocci_id@p ;
