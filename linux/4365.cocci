...
position p;
@@
 enum kcs_states { KCS_IDLE , KCS_START_OP , KCS_WAIT_WRITE_START , KCS_WAIT_WRITE , KCS_WAIT_WRITE_END , KCS_WAIT_READ , KCS_ERROR0 , KCS_ERROR1 , KCS_ERROR2 , KCS_ERROR3 , KCS_HOSED , } cocci_id@p ;
