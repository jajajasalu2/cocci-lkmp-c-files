...
position p;
@@
 struct ds2760_device_info * cocci_id@p ;
...
position p;
@@
 struct ds2760_device_info {  struct device * dev ;  unsigned long update_time ;  char raw [ DS2760_DATA_SIZE ] ;  int voltage_raw ;  int voltage_uV ;  int current_raw ;  int current_uA ;  int accum_current_raw ;  int accum_current_uAh ;  int temp_raw ;  int temp_C ;  int rated_capacity ;  int rem_capacity ;  int full_active_uAh ;  int empty_uAh ;  int life_sec ;  int charge_status ;  int full_counter ;  struct power_supply * bat ;  struct power_supply_desc bat_desc ;  struct workqueue_struct * monitor_wqueue ;  struct delayed_work monitor_work ;  struct delayed_work set_charged_work ;  struct notifier_block pm_notifier ; } cocci_id@p ;
