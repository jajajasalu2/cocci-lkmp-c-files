...
position p;
@@
 struct nvkm_mmu_ptc * cocci_id@p ;
...
position p;
@@
 const struct nvkm_mmu_func * cocci_id@p ;
...
typedef u8,u16;
@@
 struct nvkm_mmu_ptp {  struct nvkm_mmu_pt * pt ;  struct list_head head ;  u8 shift ;  u16 mask ;  u16 free ; } cocci_id@p ;
...
typedef u32;
@@
 struct nvkm_mmu_ptc {  struct list_head head ;  struct list_head item ;  u32 size ;  u32 refs ; } cocci_id@p ;
...
position p;
@@
 struct nvkm_mmu_ptp * cocci_id@p ;
