...
typedef u32;
@@
 struct meson_dw_hdmi {  struct drm_encoder encoder ;  struct dw_hdmi_plat_data dw_plat_data ;  struct meson_drm * priv ;  struct device * dev ;  void __iomem * hdmitx ;  const struct meson_dw_hdmi_data * data ;  struct reset_control * hdmitx_apb ;  struct reset_control * hdmitx_ctrl ;  struct reset_control * hdmitx_phy ;  struct clk * hdmi_pclk ;  struct clk * venci_clk ;  struct regulator * hdmi_supply ;  u32 irq_stat ;  struct dw_hdmi * hdmi ; } cocci_id@p ;
...
position p;
@@
 struct meson_dw_hdmi * cocci_id@p ;
...
position p;
@@
 enum meson_venc_source { MESON_VENC_SOURCE_NONE = 0 , MESON_VENC_SOURCE_ENCI = 1 , MESON_VENC_SOURCE_ENCP = 2 , } cocci_id@p ;
...
position p;
@@
 const struct meson_dw_hdmi_data * cocci_id@p ;
