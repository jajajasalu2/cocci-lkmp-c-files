...
position p;
@@
 const struct dpu_vbif_qos_tbl * cocci_id@p ;
...
position p;
@@
 const struct dpu_vbif_dynamic_ot_tbl * cocci_id@p ;
...
position p;
@@
 struct dpu_vbif_dynamic_ot_cfg * cocci_id@p ;
