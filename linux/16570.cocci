...
position p;
@@
 void cocci_id@p ( struct ccw_device * cdev ) ;
...
position p;
@@
 int cocci_id@p ( struct ccw_device * cdev ) ;
...
position p;
@@
 struct file_control_block * cocci_id@p ;
