...
position p;
@@
 struct tca6416_keypad_chip cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u16,uint16_t;
@@
 struct tca6416_keypad_chip {  uint16_t reg_output ;  uint16_t reg_direction ;  uint16_t reg_input ;  struct i2c_client * client ;  struct input_dev * input ;  struct delayed_work dwork ;  int io_size ;  int irqnum ;  u16 pinmask ;  bool use_polling ;  struct tca6416_button buttons [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct tca6416_button * cocci_id@p ;
...
position p;
@@
 struct tca6416_drv_data {  struct input_dev * input ;  struct tca6416_button data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct tca6416_keys_platform_data * cocci_id@p ;
