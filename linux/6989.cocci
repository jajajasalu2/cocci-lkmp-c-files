...
position p;
@@
 struct powercap_control_type * cocci_id@p ;
...
position p;
@@
 const struct powercap_control_type_ops * cocci_id@p ;
...
position p;
@@
 struct powercap_constraint_attr cocci_id@p [ MAX_CONSTRAINTS_PER_ZONE ] ;
...
position p;
@@
 struct powercap_zone_constraint * cocci_id@p ;
