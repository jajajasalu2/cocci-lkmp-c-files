...
position p;
@@
 const struct intel_early_ops cocci_id@p ;
...
typedef u32;
@@
 struct chipset {  u32 vendor ;  u32 device ;  u32 class ;  u32 class_mask ;  u32 flags ;  void ( * f ) ( int num , int slot , int func ) ; } cocci_id@p ;
