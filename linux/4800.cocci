...
position p;
@@
 const struct rdma_bind_list * cocci_id@p ;
...
position p;
@@
 struct rdma_id_private * cocci_id@p ;
...
position p;
@@
 const struct cma_hdr * cocci_id@p ;
...
position p;
@@
 const struct rdma_cm_id * cocci_id@p ;
...
position p;
@@
 const struct ib_cm_sidr_rep_event_param * cocci_id@p ;
...
position p;
@@
 const struct ib_cm_sidr_req_event_param * cocci_id@p ;
...
position p;
@@
 struct rdma_bind_list * cocci_id@p ;
...
position p;
@@
 struct rdma_dev_addr * cocci_id@p ;
...
position p;
@@
 struct ib_sa_client cocci_id@p ;
...
typedef u8;
@@
 struct cma_multicast {  struct rdma_id_private * id_priv ;  union {  struct ib_sa_multicast * ib ; } multicast ;  struct list_head list ;  void * context ;  struct sockaddr_storage addr ;  struct kref mcref ;  u8 join_state ; } cocci_id@p ;
...
position p;
@@
 enum rdma_cm_event_type cocci_id@p ;
...
position p;
@@
 struct cma_ndev_work cocci_id@p ;
...
position p;
@@
 struct cma_multicast * cocci_id@p ;
...
position p;
@@
 struct iboe_mcast_work cocci_id@p ;
...
position p;
@@
 enum rdma_ucm_port_space cocci_id@p ;
...
position p;
@@
 const struct rdma_addr * cocci_id@p ;
...
position p;
@@
 const struct sa_path_rec * cocci_id@p ;
...
position p;
@@
 const struct rdma_id_private * cocci_id@p ;
...
position p;
@@
 const struct sockaddr * cocci_id@p ;
...
position p;
@@
 struct cma_pernet {  struct xarray tcp_ps ;  struct xarray udp_ps ;  struct xarray ipoib_ps ;  struct xarray ib_ps ; } cocci_id@p ;
...
position p;
@@
 struct rdma_bind_list {  enum rdma_ucm_port_space ps ;  struct hlist_head owners ;  unsigned short port ; } cocci_id@p ;
...
position p;
@@
 struct iboe_prio_tc_map * cocci_id@p ;
...
position p;
@@
 const struct ib_cm_rep_event_param * cocci_id@p ;
...
position p;
@@
 struct rdma_cm_event * cocci_id@p ;
...
position p;
@@
 struct ib_sa_multicast cocci_id@p ;
...
position p;
@@
 struct ib_sa_mcmember_rec cocci_id@p ;
...
position p;
@@
 struct cma_ndev_work {  struct work_struct work ;  struct rdma_id_private * id ;  struct rdma_cm_event event ; } cocci_id@p ;
...
position p;
@@
 enum rdma_network_type cocci_id@p ;
...
position p;
@@
 const struct sockaddr_in6 * cocci_id@p ;
...
typedef bool;
@@
 struct iboe_prio_tc_map {  int input_prio ;  int output_tc ;  bool found ; } cocci_id@p ;
...
position p;
@@
 struct cma_req_info cocci_id@p ;
...
position p;
@@
 struct rdma_conn_param * cocci_id@p ;
...
typedef __be32;
@@
 union cma_ip_addr {  struct in6_addr ip6 ;  struct {  __be32 pad [ 3 ] ;  __be32 addr ; } ip4 ; } cocci_id@p ;
...
position p;
@@
 const struct ib_cm_event * cocci_id@p ;
...
position p;
@@
 enum { CMA_OPTION_AFONLY , } cocci_id@p ;
...
position p;
@@
 struct iboe_mcast_work {  struct work_struct work ;  struct rdma_id_private * id ;  struct cma_multicast * mc ; } cocci_id@p ;
...
position p;
@@
 struct cma_work {  struct work_struct work ;  struct rdma_id_private * id ;  enum rdma_cm_state old_state ;  enum rdma_cm_state new_state ;  struct rdma_cm_event event ; } cocci_id@p ;
...
typedef u8,atomic_t;
@@
 struct cma_device {  struct list_head list ;  struct ib_device * device ;  struct completion comp ;  atomic_t refcount ;  struct list_head id_list ;  enum ib_gid_type * default_gid_type ;  u8 * default_roce_tos ; } cocci_id@p ;
...
position p;
@@
 struct rdma_restrack_entry * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_ADDR_LEN ] ;
...
position p;
@@
 const struct sockaddr_in * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u16,__be64;
@@
 struct cma_req_info {  struct sockaddr_storage listen_addr_storage ;  struct sockaddr_storage src_addr_storage ;  struct ib_device * device ;  union ib_gid local_gid ;  __be64 service_id ;  int port ;  bool has_gid ;  u16 pkey ; } cocci_id@p ;
...
typedef u8;
@@
 struct cma_hdr {  u8 cma_version ;  u8 ip_version ;  __be16 port ;  union cma_ip_addr src_addr ;  union cma_ip_addr dst_addr ; } cocci_id@p ;
...
position p;
@@
 rdma_cm_event_handler cocci_id@p ;
...
typedef u8;
@@
 struct class_port_info_context {  struct ib_class_port_info * class_port_info ;  struct ib_device * device ;  struct completion done ;  struct ib_sa_query * sa_query ;  u8 port_num ; } cocci_id@p ;
...
position p;
@@
 const struct ib_cm_id * cocci_id@p ;
...
position p;
@@
 const struct cma_req_info * cocci_id@p ;
...
position p;
@@
 struct iw_cm_conn_param cocci_id@p ;
...
position p;
@@
 const struct ib_cm_req_event_param * cocci_id@p ;
