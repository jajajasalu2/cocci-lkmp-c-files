...
position p;
@@
 struct tcon_ch1_clk * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ TCON_CH1_SCLK2_PARENTS ] ;
...
typedef spinlock_t;
@@
 struct tcon_ch1_clk {  struct clk_hw hw ;  spinlock_t lock ;  void __iomem * reg ; } cocci_id@p ;
