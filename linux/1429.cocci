...
position p;
@@
 struct r8a66597_request * cocci_id@p ;
...
position p;
@@
 struct r8a66597_dma * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct r8a66597_ep * ep , struct r8a66597_request * req , int status ) ;
...
position p;
@@
 struct r8a66597_pipe_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct r8a66597 * r8a66597 ) ;
...
position p;
@@
 void cocci_id@p ( struct r8a66597_ep * ep , struct r8a66597_request * req ) ;
