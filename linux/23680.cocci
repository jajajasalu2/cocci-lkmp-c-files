...
typedef u32;
@@
 struct spdif_out_params {  u32 rate ;  u32 core_freq ;  u32 mute ; } cocci_id@p ;
...
position p;
@@
 struct spdif_out_dev * cocci_id@p ;
...
typedef u32;
@@
 struct spdif_out_dev {  struct clk * clk ;  struct spear_dma_data dma_params ;  struct spdif_out_params saved_params ;  u32 running ;  void __iomem * io_base ;  struct snd_dmaengine_dai_dma_data dma_params_tx ;  struct snd_dmaengine_pcm_config config ; } cocci_id@p ;
