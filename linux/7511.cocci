...
position p;
@@
 struct via_device_mapping cocci_id@p [ ] ;
...
position p;
@@
 struct via_pll_config cocci_id@p ;
...
position p;
@@
 struct fifo_threshold_select cocci_id@p ;
...
position p;
@@
 struct GFX_DPA_SETTING * cocci_id@p ;
...
position p;
@@
 struct fifo_depth_select cocci_id@p ;
...
position p;
@@
 struct display_queue_expire_num cocci_id@p ;
...
position p;
@@
 struct fifo_high_threshold_select cocci_id@p ;
