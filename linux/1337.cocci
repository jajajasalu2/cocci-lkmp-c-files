...
typedef u32;
@@
 struct isp1301 {  struct usb_phy phy ;  struct i2c_client * client ;  void ( * i2c_release ) ( struct device * dev ) ;  int irq_type ;  u32 last_otg_ctrl ;  unsigned working : 1 ;  struct timer_list timer ;  struct work_struct work ;  unsigned long todo ; #		define WORK_UPDATE_ISP 0  #		define WORK_UPDATE_OTG 1  #		define WORK_HOST_RESUME 4  #		define WORK_TIMER 6  #		define WORK_STOP 7  } cocci_id@p ;
