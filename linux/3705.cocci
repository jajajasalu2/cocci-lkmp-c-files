...
position p;
@@
 struct icp_qat_uof_image cocci_id@p ;
...
position p;
@@
 struct icp_qat_uclo_aeslice * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_memvar_attr cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_uword_block * cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_loader_handle * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_objtable cocci_id@p ;
...
position p;
@@
 struct icp_qat_suof_img_hdr * cocci_id@p ;
...
position p;
@@
 struct icp_qat_suof_handle * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_chunkhdr * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uclo_aedata * cocci_id@p ;
...
position p;
@@
 struct icp_qat_suof_strtable * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_filehdr cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_code_area * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_batch_init * * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_filechunkhdr * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_initmem * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_ae_reg * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uclo_encap_uwblock * cocci_id@p ;
...
position p;
@@
 struct icp_qat_css_hdr * cocci_id@p ;
...
position p;
@@
 struct icp_qat_suof_objhdr * cocci_id@p ;
...
position p;
@@
 struct icp_qat_suof_chunk_hdr * cocci_id@p ;
...
position p;
@@
 struct icp_qat_auth_chunk * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uclo_page * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_init_regsym * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uclo_encapme * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_objhdr * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_encap_obj * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uclo_init_mem_table * cocci_id@p ;
...
position p;
@@
 struct icp_qat_suof_filehdr cocci_id@p ;
...
position p;
@@
 struct icp_qat_uclo_encap_page cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_sbreak * cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_auth_desc * cocci_id@p ;
...
position p;
@@
 struct icp_qat_simg_ae_mode * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_code_page * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uclo_objhandle * cocci_id@p ;
...
position p;
@@
 struct icp_qat_uclo_objhdr * cocci_id@p ;
...
position p;
@@
 struct icp_firml_dram_desc * cocci_id@p ;
...
position p;
@@
 enum icp_qat_uof_regtype cocci_id@p ;
...
position p;
@@
 struct icp_qat_uof_strtable * cocci_id@p ;
