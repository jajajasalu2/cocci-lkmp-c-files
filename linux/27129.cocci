...
position p;
@@
 struct ubifs_sb_node * cocci_id@p ;
...
position p;
@@
 struct ubifs_unclean_leb cocci_id@p ;
...
position p;
@@
 struct ubifs_orphan * cocci_id@p ;
...
position p;
@@
 union ubifs_dev_desc * cocci_id@p ;
...
position p;
@@
 enum { Opt_fast_unmount , Opt_norm_unmount , Opt_bulk_read , Opt_no_bulk_read , Opt_chk_data_crc , Opt_no_chk_data_crc , Opt_override_compr , Opt_assert , Opt_auth_key , Opt_auth_hash_name , Opt_ignore , Opt_err , } cocci_id@p ;
