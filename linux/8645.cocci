...
position p;
@@
 struct i40e_aqc_clear_pxe * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_remove_udp_tunnel * cocci_id@p ;
...
position p;
@@
 enum i40e_status_code cocci_id@p ;
...
position p;
@@
 struct i40e_profile_info * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_request_resource * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_cloud_filters_element_bb * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_set_vsi_promiscuous_modes * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_tx_sched_ind * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_switch_seid * cocci_id@p ;
...
position p;
@@
 enum i40e_aq_resources_ids cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_remove_control_packet_filter_completion * cocci_id@p ;
...
position p;
@@
 struct i40e_profile_section_header * cocci_id@p ;
...
position p;
@@
 struct i40e_aq_set_phy_config cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_del_udp_tunnel_completion * cocci_id@p ;
...
position p;
@@
 struct i40e_driver_version * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_configure_partition_bw_data * cocci_id@p ;
...
position p;
@@
 enum i40e_aq_phy_type cocci_id@p ;
...
position p;
@@
 struct i40e_aq_desc * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_debug_reg_read_write * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_lldp_stop * cocci_id@p ;
...
position p;
@@
 struct i40e_package_header * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_get_update_vsi_completion * cocci_id@p ;
...
position p;
@@
 enum i40e_debug_mask cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_macvlan * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_alternate_write * cocci_id@p ;
...
position p;
@@
 struct i40e_section_table * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_configure_vsi_bw_limit * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_delete_mirror_rule * cocci_id@p ;
...
position p;
@@
 struct i40e_rx_ptype_decoded cocci_id@p [ ] ;
...
position p;
@@
 struct i40e_aqc_add_udp_tunnel * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_configure_vsi_tc_bw_data * cocci_id@p ;
...
position p;
@@
 enum i40e_admin_queue_err cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_mac_address_read_data cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_version * cocci_id@p ;
...
position p;
@@
 struct i40e_profile_segment * cocci_id@p ;
...
position p;
@@
 struct i40e_profile_aq_section * cocci_id@p ;
...
position p;
@@
 struct i40e_aq_get_phy_abilities_resp cocci_id@p ;
...
position p;
@@
 struct i40e_generic_seg_header * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_set_link_restart_an * cocci_id@p ;
...
position p;
@@
 struct i40e_hw_capabilities * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_list_capabilites * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_phy_register_access * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_configure_switching_comp_ets_data * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_write_personalization_profile * cocci_id@p ;
...
position p;
@@
 struct i40e_link_status * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_mac_address_read * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_query_switching_comp_bw_config_resp * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_mac_address_write * cocci_id@p ;
...
position p;
@@
 enum i40e_aq_resource_access_type cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_query_vsi_bw_config_resp * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_lldp_update_mib * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_queue_shutdown * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_lldp_start * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_set_dcb_parameters * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_rx_ctl_reg_read_write * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_set_rss_lut * cocci_id@p ;
...
position p;
@@
 enum i40e_media_type cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_cloud_filters_element_data * cocci_id@p ;
...
position p;
@@
 enum i40e_admin_queue_opc cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_write_ddp_resp * cocci_id@p ;
...
position p;
@@
 struct i40e_filter_control_settings * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_lldp_restore * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_delete_mirror_rule_completion * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_get_update_vsi * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_set_phy_int_mask * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_remove_cloud_filters * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_set_rss_key_data cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_veb_parameters_completion * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_pf_vf_message * cocci_id@p ;
...
position p;
@@
 struct i40e_vsi_context * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_lldp_get_mib * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_driver_version * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_query_switching_comp_ets_config_resp * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_query_port_ets_config_resp * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_set_switch_config * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_veb * cocci_id@p ;
...
position p;
@@
 struct i40e_asq_cmd_details * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_link_status * cocci_id@p ;
...
position p;
@@
 struct i40e_control_filter_stats * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_remove_macvlan_element_data * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_switch_config_resp * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_macvlan_element_data * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_debug_dump_internals * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_applied_profiles * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_configure_switching_comp_bw_config_data * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_list_capabilities_element_resp * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_set_phy_debug * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_query_vsi_ets_sla_config_resp * cocci_id@p ;
...
position p;
@@
 enum i40e_aq_link_speed cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_remove_control_packet_filter * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_nvm_update * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_add_veb_completion * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_set_rss_key * cocci_id@p ;
