...
position p;
@@
 const struct pcl726_board * cocci_id@p ;
...
position p;
@@
 struct pcl726_board cocci_id@p ;
...
position p;
@@
 struct pcl726_board {  const char * name ;  unsigned long io_len ;  unsigned int irq_mask ;  const struct comedi_lrange * const * ao_ranges ;  int ao_num_ranges ;  int ao_nchan ;  unsigned int have_dio : 1 ;  unsigned int is_pcl727 : 1 ; } cocci_id@p ;
...
position p;
@@
 struct pcl726_private {  const struct comedi_lrange * rangelist [ 12 ] ;  unsigned int cmd_running : 1 ; } cocci_id@p ;
...
position p;
@@
 struct pcl726_private * cocci_id@p ;
