...
position p;
@@
 struct guest {  unsigned short avail_idx ;  unsigned short last_used_idx ;  unsigned short num_free ;  unsigned short kicked_avail_idx ; #ifndef INORDER  unsigned short free_head ; #else  unsigned short reserved_free_head ; #endif  unsigned char reserved [ HOST_GUEST_PADDING - 10 ] ; } cocci_id@p ;
...
position p;
@@
 struct data {  void * data ; } * cocci_id@p ;
...
position p;
@@
 struct host {  unsigned short used_idx ;  unsigned short called_used_idx ;  unsigned char reserved [ HOST_GUEST_PADDING - 4 ] ; } cocci_id@p ;
