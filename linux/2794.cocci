...
position p;
@@
 struct aml_resource_vendor_large cocci_id@p ;
...
position p;
@@
 struct acpi_walk_state * cocci_id@p ;
...
position p;
@@
 acpi_walk_aml_callback cocci_id@p ;
...
position p;
@@
 struct aml_resource_small_header cocci_id@p ;
...
position p;
@@
 struct aml_resource_large_header cocci_id@p ;
