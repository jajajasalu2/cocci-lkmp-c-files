...
position p;
@@
 struct netvsc_ethtool_stats cocci_id@p ;
...
position p;
@@
 const struct netvsc_stats * cocci_id@p ;
...
position p;
@@
 struct netvsc_vf_pcpu_stats cocci_id@p ;
...
position p;
@@
 const struct netvsc_vf_pcpu_stats * cocci_id@p ;
...
position p;
@@
 struct netvsc_ethtool_pcpu_stats * cocci_id@p ;
...
position p;
@@
 struct ndis_pkt_8021q_info * cocci_id@p ;
...
typedef u16;
@@
 const struct {  char name [ ETH_GSTRING_LEN ] ;  u16 offset ; } cocci_id@p [ ] ;
...
position p;
@@
 struct netvsc_reconfig cocci_id@p ;
...
position p;
@@
 struct ndis_tcp_ip_checksum_info * cocci_id@p ;
...
position p;
@@
 struct ndis_tcp_lso_info * cocci_id@p ;
...
position p;
@@
 struct rndis_indicate_status * cocci_id@p ;
...
position p;
@@
 const struct net_device_context * cocci_id@p ;
...
position p;
@@
 struct hv_page_buffer cocci_id@p [ MAX_PAGE_BUFFER_COUNT ] ;
...
position p;
@@
 struct netvsc_stats * cocci_id@p ;
