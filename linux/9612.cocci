...
position p;
@@
 struct brcmf_feat_fwcap {  enum brcmf_feat_id feature ;  const char * const fwcap_id ; } cocci_id@p ;
...
position p;
@@
 enum brcmf_feat_quirk cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_CAPS_BUFFER_SIZE + 1 ] ;
...
position p;
@@
 const struct brcmf_feat_fwfeat cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ MAX_CAPS_BUFFER_SIZE ] ;
...
position p;
@@
 const struct brcmf_feat_fwcap cocci_id@p [ ] ;
...
typedef u32;
@@
 struct brcmf_feat_fwfeat {  const char * const fwid ;  u32 feat_flags ; } cocci_id@p ;
