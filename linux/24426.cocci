...
position p;
@@
 struct sockaddr_x25 cocci_id@p ;
...
position p;
@@
 const struct x25_address cocci_id@p ;
...
position p;
@@
 struct x25_facilities cocci_id@p ;
...
position p;
@@
 struct x25_dte_facilities cocci_id@p ;
...
position p;
@@
 struct x25_calluserdata cocci_id@p ;
...
position p;
@@
 struct compat_x25_subscrip_struct cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uint_t,compat_ulong_t;
@@
 struct compat_x25_subscrip_struct {  char device [ 200 - sizeof ( compat_ulong_t ) ] ;  compat_ulong_t global_facil_mask ;  compat_uint_t extended ; } cocci_id@p ;
...
position p;
@@
 struct x25_causediag cocci_id@p ;
