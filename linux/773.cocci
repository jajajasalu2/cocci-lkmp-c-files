...
typedef bool;
@@
 struct faraday_pci_variant {  bool cascaded_irq ; } cocci_id@p ;
...
position p;
@@
 const struct faraday_pci_variant cocci_id@p ;
...
position p;
@@
 struct faraday_pci {  struct device * dev ;  void __iomem * base ;  struct irq_domain * irqdomain ;  struct pci_bus * bus ;  struct clk * bus_clk ; } cocci_id@p ;
