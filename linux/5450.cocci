...
@@
 struct spi_qup {  void __iomem * base ;  struct device * dev ;  struct clk * cclk ;  struct clk * iclk ;  int irq ;  spinlock_t lock ;  int in_fifo_sz ;  int out_fifo_sz ;  int in_blk_sz ;  int out_blk_sz ;  struct spi_transfer * xfer ;  struct completion done ;  int error ;  int w_size ;  int n_words ;  int tx_bytes ;  int rx_bytes ;  const u8 * tx_buf ;  u8 * rx_buf ;  int qup_v1 ;  int mode ;  struct dma_slave_config rx_conf ;  struct dma_slave_config tx_conf ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct spi_device * spi , struct spi_transfer * xfer ) ;
