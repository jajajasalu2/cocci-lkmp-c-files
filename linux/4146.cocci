...
position p;
@@
 struct phy_meson_gxl_usb2_priv {  struct regmap * regmap ;  enum phy_mode mode ;  int is_enabled ;  struct clk * clk ;  struct reset_control * reset ; } cocci_id@p ;
...
position p;
@@
 struct phy_meson_gxl_usb2_priv * cocci_id@p ;
