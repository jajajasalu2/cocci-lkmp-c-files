...
typedef u8;
@@
 struct inittab {  u8 cmd ;  u8 reg ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 const struct m88rs2000_config * cocci_id@p ;
...
position p;
@@
 struct m88rs2000_state * cocci_id@p ;
...
typedef u8,u32;
@@
 struct m88rs2000_state {  struct i2c_adapter * i2c ;  const struct m88rs2000_config * config ;  struct dvb_frontend frontend ;  u8 no_lock_count ;  u32 tuner_frequency ;  u32 symbol_rate ;  enum fe_code_rate fec_inner ;  u8 tuner_level ;  int errmode ; } cocci_id@p ;
