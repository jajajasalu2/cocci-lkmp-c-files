...
position p;
@@
 struct hostap_interface cocci_id@p ;
...
position p;
@@
 struct hostap_cmd_queue * cocci_id@p ;
...
typedef u16;
@@
 void ( * cocci_id@p ) ( struct net_device * dev , long context , u16 resp0 , u16 status ) ;
...
position p;
@@
 struct set_tim_data * cocci_id@p ;
...
position p;
@@
 struct hostap_skb_tx_data * cocci_id@p ;
...
position p;
@@
 struct hfa384x_info_frame cocci_id@p ;
...
symbol cocci_id;
position p;
typedef local_info_t;
@@
 int cocci_id@p ( local_info_t * local ) ;
...
typedef local_info_t;
@@
 int cocci_id@p ( local_info_t * local , struct prism2_download_param * param ) ;
...
position p;
@@
 struct set_tim_data {  struct list_head list ;  int aid ;  int set ; } cocci_id@p ;
...
position p;
@@
 struct hfa384x_comp_ident cocci_id@p ;
...
position p;
@@
 struct hostap_tx_callback_info * cocci_id@p ;
...
typedef local_info_t;
@@
 void cocci_id@p ( local_info_t * local ) ;
...
position p;
@@
 void cocci_id@p ( struct prism2_download_data * dl ) ;
...
typedef local_info_t;
@@
 int cocci_id@p ( local_info_t * local , struct prism2_download_data * param ) ;
...
position p;
@@
 struct hfa384x_regs * cocci_id@p ;
...
position p;
@@
 struct hostap_bss_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MAX_PARM_DEVICES ] ;
...
position p;
@@
 struct hostap_80211_rx_status cocci_id@p ;
...
position p;
@@
 struct prism2_helper_functions * cocci_id@p ;
...
position p;
@@
 struct hfa384x_rid_hdr cocci_id@p ;
