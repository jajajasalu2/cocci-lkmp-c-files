...
position p;
@@
 struct fib6_nh_pcpu_arg cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net * net , struct fib6_walker * w ) ;
...
position p;
@@
 struct lookup_args {  int offset ;  const struct in6_addr * addr ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct fib6_info * , void * arg ) ;
...
position p;
@@
 struct fib6_dump_arg * cocci_id@p ;
...
position p;
@@
 struct fib6_cleaner * cocci_id@p ;
...
position p;
@@
 struct fib6_dump_arg {  struct net * net ;  struct notifier_block * nb ;  struct netlink_ext_ack * extack ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fib6_walker * w ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct fib6_info * , void * ) ;
...
position p;
@@
 enum { FIB6_NO_SERNUM_CHANGE = 0 , } cocci_id@p ;
...
position p;
@@
 struct fib6_info * cocci_id@p ( struct net * net , struct fib6_table * table , struct fib6_node * fn ) ;
...
position p;
@@
 struct fib6_node * cocci_id@p ( struct net * net , struct fib6_table * table , struct fib6_node * fn ) ;
...
position p;
@@
 const struct fib6_table * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pol_lookup_t;
@@
 pol_lookup_t cocci_id@p ;
...
position p;
@@
 struct fib6_nh_pcpu_arg {  struct fib6_info * from ;  const struct fib6_table * table ; } cocci_id@p ;
