...
position p;
@@
 struct adv7511_monitor_detect cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct v4l2_subdev * sd ) ;
...
position p;
@@
 const struct adv7511_cfg_read_infoframe cocci_id@p [ ] ;
...
position p;
@@
 struct adv7511_state * cocci_id@p ;
...
position p;
@@
 struct adv7511_edid_detect cocci_id@p ;
...
position p;
@@
 struct i2c_reg_value {  unsigned char reg ;  unsigned char value ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_subdev_audio_ops cocci_id@p ;
...
position p;
@@
 struct adv7511_platform_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct v4l2_subdev * sd ) ;
...
typedef u8,u16;
@@
 struct adv7511_cfg_read_infoframe {  const char * desc ;  u8 present_reg ;  u8 present_mask ;  u8 header [ 3 ] ;  u16 payload_addr ; } cocci_id@p ;
...
position p;
@@
 struct adv7511_state_edid * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct adv7511_state {  struct adv7511_platform_data pdata ;  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler hdl ;  int chip_revision ;  u8 i2c_edid_addr ;  u8 i2c_pktmem_addr ;  u8 i2c_cec_addr ;  struct i2c_client * i2c_cec ;  struct cec_adapter * cec_adap ;  u8 cec_addr [ ADV7511_MAX_ADDRS ] ;  u8 cec_valid_addrs ;  bool cec_enabled_adap ;  bool power_on ;  bool have_monitor ;  bool enabled_irq ;  struct v4l2_dv_timings dv_timings ;  u32 fmt_code ;  u32 colorspace ;  u32 ycbcr_enc ;  u32 quantization ;  u32 xfer_func ;  u32 content_type ;  struct v4l2_ctrl * hdmi_mode_ctrl ;  struct v4l2_ctrl * hotplug_ctrl ;  struct v4l2_ctrl * rx_sense_ctrl ;  struct v4l2_ctrl * have_edid0_ctrl ;  struct v4l2_ctrl * rgb_quantization_range_ctrl ;  struct v4l2_ctrl * content_type_ctrl ;  struct i2c_client * i2c_edid ;  struct i2c_client * i2c_pktmem ;  struct adv7511_state_edid edid ;  unsigned edid_detect_counter ;  struct workqueue_struct * work_queue ;  struct delayed_work edid_handler ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct adv7511_state_edid {  u32 blocks ;  u32 segments ;  u8 data [ EDID_MAX_SEGM * 256 ] ;  unsigned read_retries ;  bool complete ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct v4l2_subdev * sd , u32 freq ) ;
