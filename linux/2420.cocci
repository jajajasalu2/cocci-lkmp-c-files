...
position p;
@@
 struct sa11x0_dma_desc cocci_id@p ;
...
typedef bool,u32;
@@
 struct sa11x0_dma_desc {  struct virt_dma_desc vd ;  u32 ddar ;  size_t size ;  unsigned period ;  bool cyclic ;  unsigned sglen ;  struct sa11x0_dma_sg sg [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct dma_slave_map cocci_id@p [ ] ;
...
position p;
@@
 struct sa11x0_dma_phy cocci_id@p ;
...
position p;
@@
 struct sa11x0_dma_chan * cocci_id@p ;
...
position p;
@@
 struct sa11x0_dma_dev cocci_id@p ;
...
position p;
@@
 const struct sa11x0_dma_channel_desc cocci_id@p [ ] ;
...
typedef u32;
@@
 struct sa11x0_dma_chan {  struct virt_dma_chan vc ;  struct sa11x0_dma_phy * phy ;  enum dma_status status ;  struct list_head node ;  u32 ddar ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct sa11x0_dma_sg * cocci_id@p ;
...
typedef u32;
@@
 struct sa11x0_dma_sg {  u32 addr ;  u32 len ; } cocci_id@p ;
...
typedef u32;
@@
 struct sa11x0_dma_phy {  void __iomem * base ;  struct sa11x0_dma_dev * dev ;  unsigned num ;  struct sa11x0_dma_chan * vchan ;  unsigned sg_load ;  struct sa11x0_dma_desc * txd_load ;  unsigned sg_done ;  struct sa11x0_dma_desc * txd_done ;  u32 dbs [ 2 ] ;  u32 dbt [ 2 ] ;  u32 dcsr ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sa11x0_dma_dev {  struct dma_device slave ;  void __iomem * base ;  spinlock_t lock ;  struct tasklet_struct task ;  struct list_head chan_pending ;  struct sa11x0_dma_phy phy [ NR_PHY_CHAN ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct sa11x0_dma_channel_desc {  u32 ddar ;  const char * name ; } cocci_id@p ;
