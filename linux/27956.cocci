...
position p;
@@
 struct dotl_iattr_map cocci_id@p [ ] ;
...
position p;
@@
 struct dotl_openflag_map {  int open_flag ;  int dotl_flag ; } cocci_id@p ;
...
position p;
@@
 struct p9_stat_dotl * cocci_id@p ;
...
position p;
@@
 struct dotl_iattr_map {  int iattr_valid ;  int p9_iattr_valid ; } cocci_id@p ;
...
position p;
@@
 struct p9_iattr_dotl cocci_id@p ;
...
position p;
@@
 struct v9fs_session_info * cocci_id@p ;
...
position p;
@@
 struct dotl_openflag_map cocci_id@p [ ] ;
