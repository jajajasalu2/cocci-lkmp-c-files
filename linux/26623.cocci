...
position p;
@@
 struct sched_switch_args {  unsigned long long pad ;  char prev_comm [ 16 ] ;  int prev_pid ;  int prev_prio ;  long long prev_state ;  char next_comm [ 16 ] ;  int next_pid ;  int next_prio ; } cocci_id@p ;
...
position p;
@@
 struct sched_switch_args * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,wokeby_t;
@@
 struct wokeby_t {  char name [ TASK_COMM_LEN ] ;  u32 ret ; } cocci_id@p ;
...
typedef u32,key_t;
@@
 struct key_t {  char waker [ TASK_COMM_LEN ] ;  char target [ TASK_COMM_LEN ] ;  u32 wret ;  u32 tret ; } cocci_id@p ;
