...
symbol cocci_id;
position p;
typedef ahc_dev_softc_t;
@@
 ahc_dev_softc_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , int * internal50_present , int * internal68_present , int * externalcable_present , int * eeprom_present ) ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , int * internal50_present , int * externalcable_present , int * eeprom_present ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , u_int * sxfrctl1 ) ;
...
position p;
@@
 struct seeprom_descriptor * cocci_id@p ;
...
position p;
@@
 const struct ahc_pci_identity cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , int enable , int pcheck , int fast , int large ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct seeprom_descriptor * sd , u_int adapter_control , u_int * sxfrctl1 ) ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , int * enableSEC_low , int * enableSEC_high , int * enablePRI_low , int * enablePRI_high , int * eeprom_present ) ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct seeprom_config * sc ) ;
...
symbol cocci_id;
position p;
typedef ahc_device_setup_t;
@@
 ahc_device_setup_t cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p ( struct ahc_softc * ahc ) ;
