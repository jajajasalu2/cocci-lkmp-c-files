...
position p;
@@
 struct usb_sevsegdev cocci_id@p ;
...
typedef u8,u16;
@@
 struct usb_sevsegdev {  struct usb_device * udev ;  struct usb_interface * intf ;  u8 powered ;  u8 mode_msb ;  u8 mode_lsb ;  u8 decimals [ MAXLEN ] ;  u8 textmode ;  u8 text [ MAXLEN ] ;  u16 textlength ;  u8 shadow_power ;  u8 has_interface_pm ; } cocci_id@p ;
