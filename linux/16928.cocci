...
position p;
@@
 struct vf50_touch_device * cocci_id@p ;
...
typedef bool;
@@
 struct vf50_touch_device {  struct platform_device * pdev ;  struct input_dev * ts_input ;  struct iio_channel * channels ;  struct gpio_desc * gpio_xp ;  struct gpio_desc * gpio_xm ;  struct gpio_desc * gpio_yp ;  struct gpio_desc * gpio_ym ;  int pen_irq ;  int min_pressure ;  bool stop_touchscreen ; } cocci_id@p ;
