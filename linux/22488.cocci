...
position p;
@@
 struct mixart_set_in_audio_level_req cocci_id@p ;
...
position p;
@@
 struct mixart_set_out_stream_level_req cocci_id@p ;
...
position p;
@@
 struct mixart_io_level cocci_id@p ;
...
position p;
@@
 struct mixart_set_out_audio_level cocci_id@p ;
