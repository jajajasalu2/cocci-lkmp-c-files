...
position p;
@@
 struct pages_devres {  unsigned long addr ;  unsigned int order ; } cocci_id@p ;
...
position p;
@@
 struct devres_group {  struct devres_node node [ 2 ] ;  void * id ;  int color ; } cocci_id@p ;
...
position p;
@@
 struct devres_group cocci_id@p ;
...
position p;
@@
 struct action_devres * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dr_release_t;
@@
 dr_release_t cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct device * , void * , void * ) ;
...
position p;
@@
 struct pages_devres * cocci_id@p ;
...
position p;
@@
 struct action_devres {  void * data ;  void ( * action ) ( void * ) ; } cocci_id@p ;
