...
position p;
@@
 const struct ath5k_ini cocci_id@p [ ] ;
...
position p;
@@
 const struct ath5k_ini_mode * cocci_id@p ;
...
typedef u32,u16;
@@
 struct ath5k_ini {  u16 ini_register ;  u32 ini_value ;  enum { AR5K_INI_WRITE = 0 , AR5K_INI_READ = 1 , } ini_mode ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct ath5k_ini_mode {  u16 mode_register ;  u32 mode_value [ 3 ] ; } cocci_id@p ;
