...
position p;
@@
 const struct media_device_ops cocci_id@p ;
...
position p;
@@
 const struct v4l2_fwht_pixfmt_info cocci_id@p ;
...
position p;
@@
 struct v4l2_decoder_cmd * cocci_id@p ;
...
position p;
@@
 struct vicodec_q_data * cocci_id@p ;
...
position p;
@@
 const struct vb2_v4l2_buffer * cocci_id@p ;
...
position p;
@@
 struct fwht_cframe_hdr cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_fwht_params * cocci_id@p ;
...
position p;
@@
 const struct fwht_cframe_hdr * cocci_id@p ;
...
position p;
@@
 struct v4l2_fwht_state * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct vicodec_dev_instance {  struct video_device vfd ;  struct mutex mutex ;  spinlock_t lock ;  struct v4l2_m2m_dev * m2m_dev ; } cocci_id@p ;
...
@@
 struct vicodec_ctx {  struct v4l2_fh fh ;  struct vicodec_dev * dev ;  bool is_enc ;  bool is_stateless ;  bool is_draining ;  bool next_is_last ;  bool has_stopped ;  spinlock_t * lock ;  struct v4l2_ctrl_handler hdl ;  struct vb2_v4l2_buffer * last_src_buf ;  struct vicodec_q_data q_data [ 2 ] ;  struct v4l2_fwht_state state ;  u32 cur_buf_offset ;  u32 comp_max_size ;  u32 comp_size ;  u32 header_size ;  u32 comp_magic_cnt ;  bool comp_has_frame ;  bool comp_has_next_frame ;  bool first_source_change_sent ;  bool source_changed ; } cocci_id@p ;
...
typedef u32;
@@
 struct pixfmt_info {  u32 id ;  unsigned int bytesperline_mult ;  unsigned int sizeimage_mult ;  unsigned int sizeimage_div ;  unsigned int luma_step ;  unsigned int chroma_step ;  unsigned int width_div ;  unsigned int height_div ; } cocci_id@p ;
...
position p;
@@
 enum { V4L2_M2M_SRC = 0 , V4L2_M2M_DST = 1 , } cocci_id@p ;
...
position p;
@@
 struct vicodec_q_data {  unsigned int coded_width ;  unsigned int coded_height ;  unsigned int visible_width ;  unsigned int visible_height ;  unsigned int sizeimage ;  unsigned int vb2_sizeimage ;  unsigned int sequence ;  const struct v4l2_fwht_pixfmt_info * info ; } cocci_id@p ;
...
position p;
@@
 struct vicodec_dev_instance * cocci_id@p ;
