...
position p;
@@
 const struct dma_fence * cocci_id@p ;
...
position p;
@@
 const struct i915_sched_attr * cocci_id@p ;
...
position p;
@@
 struct execute_cb {  struct list_head link ;  struct irq_work work ;  struct i915_sw_fence * fence ;  void ( * hook ) ( struct i915_request * rq , struct dma_fence * signal ) ;  struct i915_request * signal ; } cocci_id@p ;
...
position p;
@@
 struct i915_global_request {  struct i915_global base ;  struct kmem_cache * slab_requests ;  struct kmem_cache * slab_dependencies ;  struct kmem_cache * slab_execute_cbs ; } cocci_id@p ;
...
position p;
@@
 struct i915_global_request cocci_id@p ;
...
position p;
@@
 struct request_wait cocci_id@p ;
...
position p;
@@
 const struct i915_request * const cocci_id@p ;
...
position p;
@@
 struct intel_timeline * const cocci_id@p ;
...
position p;
@@
 struct request_wait {  struct dma_fence_cb cb ;  struct task_struct * tsk ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct i915_request * rq , struct dma_fence * signal ) ;
