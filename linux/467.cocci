...
position p;
@@
 struct bsd_disklabel * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ 1 + BDEVNAME_SIZE + 10 + 11 + 1 ] ;
...
position p;
@@
 struct solaris_x86_vtoc * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ 1 + BDEVNAME_SIZE + 10 + 9 + 1 ] ;
...
position p;
@@
 struct unixware_slice * cocci_id@p ;
...
position p;
@@
 struct solaris_x86_slice * cocci_id@p ;
...
position p;
@@
 struct bsd_partition * cocci_id@p ;
...
position p;
@@
 struct unixware_disklabel * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ 1 + BDEVNAME_SIZE + 10 + 12 + 1 ] ;
...
position p;
@@
 struct partition_meta_info * cocci_id@p ;
