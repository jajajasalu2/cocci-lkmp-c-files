...
position p;
@@
 const struct smb2_sync_hdr * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ SMB2_HMACSHA256_SIZE ] ;
...
position p;
@@
 struct derivation {  struct kvec label ;  struct kvec context ; } cocci_id@p ;
...
position p;
@@
 const struct derivation_triplet * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ SMB2_CMACAES_SIZE ] ;
...
position p;
@@
 struct derivation_triplet cocci_id@p ;
...
position p;
@@
 struct cifs_secmech * cocci_id@p ;
...
position p;
@@
 struct derivation_triplet {  struct derivation signing ;  struct derivation encryption ;  struct derivation decryption ; } cocci_id@p ;
