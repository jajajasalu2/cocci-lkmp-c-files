...
position p;
@@
 struct ibt_rp_reg_access * cocci_id@p ;
...
position p;
@@
 struct ibt_cp_reg_access cocci_id@p ;
...
position p;
@@
 struct regmap_ibt_context * cocci_id@p ;
...
typedef __u16;
@@
 struct regmap_ibt_context {  struct hci_dev * hdev ;  __u16 op_write ;  __u16 op_read ; } cocci_id@p ;
