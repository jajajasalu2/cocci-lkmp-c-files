...
position p;
@@
 struct gpio_charger_platform_data cocci_id@p ;
...
position p;
@@
 struct tosa_bt_data cocci_id@p ;
...
position p;
@@
 struct tc6393xb_platform_data cocci_id@p ;
...
position p;
@@
 struct tmio_nand_data cocci_id@p ;
...
position p;
@@
 struct tmio_fb_data cocci_id@p ;
