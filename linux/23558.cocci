...
position p;
@@
 struct skl_clk_parent * cocci_id@p ;
...
position p;
@@
 struct skl_clk_rate_cfg_table * cocci_id@p ;
...
position p;
@@
 struct skl_clk_parent_src * cocci_id@p ;
...
typedef u32;
@@
 struct skl_clk {  struct clk_hw hw ;  struct clk_lookup * lookup ;  unsigned long rate ;  struct skl_clk_pdata * pdata ;  u32 id ; } cocci_id@p ;
...
typedef u8;
@@
 struct skl_clk_data {  struct skl_clk_parent parent [ SKL_MAX_CLK_SRC ] ;  struct skl_clk * clk [ SKL_MAX_CLK_CNT ] ;  u8 avail_clk_cnt ; } cocci_id@p ;
...
position p;
@@
 struct nhlt_fmt_cfg * cocci_id@p ;
...
position p;
@@
 struct skl_dmactrl_sclkfs_cfg cocci_id@p ;
...
position p;
@@
 struct skl_clk_parent {  struct clk_hw * hw ;  struct clk_lookup * lookup ; } cocci_id@p ;
...
position p;
@@
 struct skl_clk_data * cocci_id@p ;
...
position p;
@@
 union skl_clk_ctrl_ipc * cocci_id@p ;
...
position p;
@@
 struct skl_dmactrl_mclk_cfg cocci_id@p ;
...
position p;
@@
 struct skl_clk_pdata * cocci_id@p ;
