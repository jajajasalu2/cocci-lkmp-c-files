...
position p;
@@
 struct odm_rate_adapt * cocci_id@p ;
...
position p;
@@
 enum odm_common_info_def cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ OFDM_TABLE_SIZE_92D ] ;
...
position p;
@@
 struct false_alarm_stats * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ HT_IOT_PEER_MAX ] [ 3 ] ;
