...
typedef s8,u8,u16;
@@
 struct lm87_data {  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u8 channel ;  u8 config ;  u8 in [ 8 ] ;  u8 in_max [ 8 ] ;  u8 in_min [ 8 ] ;  u16 in_scale [ 8 ] ;  s8 temp [ 3 ] ;  s8 temp_high [ 3 ] ;  s8 temp_low [ 3 ] ;  s8 temp_crit_int ;  s8 temp_crit_ext ;  u8 fan [ 2 ] ;  u8 fan_min [ 2 ] ;  u8 fan_div [ 2 ] ;  u8 aout ;  u16 alarms ;  u8 vid ;  u8 vrm ;  const struct attribute_group * attr_groups [ 6 ] ; } cocci_id@p ;
