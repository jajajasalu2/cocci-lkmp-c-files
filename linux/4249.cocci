...
position p;
@@
 struct smo8800_device * cocci_id@p ;
...
@@
 struct smo8800_device {  u32 irq ;  atomic_t counter ;  struct miscdevice miscdev ;  unsigned long misc_opened ;  wait_queue_head_t misc_wait ;  struct device * dev ; } cocci_id@p ;
