...
position p;
@@
 unsigned char cocci_id@p [ MAXDEV ] ;
...
position p;
@@
 unsigned long cocci_id@p [ MAXDEV ] ;
...
position p;
@@
 struct platform_device * cocci_id@p [ MAXDEV ] ;
