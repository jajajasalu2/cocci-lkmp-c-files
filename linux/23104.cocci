...
position p;
@@
 struct s3c24xx_uda134x * cocci_id@p ;
...
position p;
@@
 struct s3c24xx_uda134x {  struct clk * xtal ;  struct clk * pclk ;  struct mutex clk_lock ;  int clk_users ; } cocci_id@p ;
