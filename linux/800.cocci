...
position p;
@@
 struct acpi_pci_root * cocci_id@p ;
...
position p;
@@
 enum hpx_type3_fn_type { HPX_FN_NORMAL = BIT ( 0 ) , HPX_FN_SRIOV_PHYS = BIT ( 1 ) , HPX_FN_SRIOV_VIRT = BIT ( 2 ) , } cocci_id@p ;
...
position p;
@@
 struct pci_host_bridge * cocci_id@p ;
...
position p;
@@
 enum hpx_type3_cfg_loc { HPX_CFG_PCICFG = 0 , HPX_CFG_PCIE_CAP = 1 , HPX_CFG_PCIE_CAP_EXT = 2 , HPX_CFG_VEND_CAP = 3 , HPX_CFG_DVSEC = 4 , HPX_CFG_MAX , } cocci_id@p ;
...
position p;
@@
 struct fwnode_handle * ( * cocci_id@p ) ( struct device * ) ;
...
position p;
@@
 struct acpi_device_wakeup_context * cocci_id@p ;
...
position p;
@@
 enum hpx_type3_dev_type { HPX_TYPE_ENDPOINT = BIT ( 0 ) , HPX_TYPE_LEG_END = BIT ( 1 ) , HPX_TYPE_RC_END = BIT ( 2 ) , HPX_TYPE_RC_EC = BIT ( 3 ) , HPX_TYPE_ROOT_PORT = BIT ( 4 ) , HPX_TYPE_UPSTREAM = BIT ( 5 ) , HPX_TYPE_DOWNSTREAM = BIT ( 6 ) , HPX_TYPE_PCI_BRIDGE = BIT ( 7 ) , HPX_TYPE_PCIE_BRIDGE = BIT ( 8 ) , } cocci_id@p ;
...
position p;
@@
 struct acpi_device * cocci_id@p ( struct device * dev ) ;
...
position p;
@@
 const struct fwnode_handle * cocci_id@p ;
...
position p;
@@
 const struct pci_host_bridge * cocci_id@p ;
...
typedef u8,u32;
@@
 struct hpx_type0 {  u32 revision ;  u8 cache_line_size ;  u8 latency_timer ;  u8 enable_serr ;  u8 enable_perr ; } cocci_id@p ;
...
position p;
@@
 struct resource_entry cocci_id@p ;
...
position p;
@@
 struct acpi_bus_type cocci_id@p ;
...
position p;
@@
 struct fwnode_handle * ( * cocci_id@p ) ( struct device * dev ) ;
...
position p;
@@
 const struct pci_platform_pm_ops cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct hpx_type1 {  u32 revision ;  u8 max_mem_read ;  u8 avg_max_split ;  u16 tot_max_split ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct hpx_type3 {  u16 device_type ;  u16 function_type ;  u16 config_space_location ;  u16 pci_exp_cap_id ;  u16 pci_exp_cap_ver ;  u16 pci_exp_vendor_id ;  u16 dvsec_id ;  u16 dvsec_rev ;  u16 match_offset ;  u32 match_mask_and ;  u32 match_value ;  u16 reg_offset ;  u32 reg_mask_and ;  u32 reg_mask_or ; } cocci_id@p ;
...
position p;
@@
 const struct hpx_type3 * cocci_id@p ;
...
typedef u32,u16;
@@
 struct hpx_type2 {  u32 revision ;  u32 unc_err_mask_and ;  u32 unc_err_mask_or ;  u32 unc_err_sever_and ;  u32 unc_err_sever_or ;  u32 cor_err_mask_and ;  u32 cor_err_mask_or ;  u32 adv_err_cap_and ;  u32 adv_err_cap_or ;  u16 pci_exp_devctl_and ;  u16 pci_exp_devctl_or ;  u16 pci_exp_lnkctl_and ;  u16 pci_exp_lnkctl_or ;  u32 sec_unc_err_sever_and ;  u32 sec_unc_err_sever_or ;  u32 sec_unc_err_mask_and ;  u32 sec_unc_err_mask_or ; } cocci_id@p ;
