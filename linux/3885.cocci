...
position p;
@@
 struct stm32_hash_request_ctx cocci_id@p ;
...
typedef u8;
@@
 struct stm32_hash_ctx {  struct crypto_engine_ctx enginectx ;  struct stm32_hash_dev * hdev ;  unsigned long flags ;  u8 key [ HASH_MAX_KEY_SIZE ] ;  int keylen ; } cocci_id@p ;
...
position p;
@@
 struct stm32_hash_algs_info cocci_id@p [ ] ;
...
position p;
@@
 const struct stm32_hash_pdata cocci_id@p ;
...
position p;
@@
 struct stm32_hash_algs_info {  struct ahash_alg * algs_list ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 struct stm32_hash_dev * cocci_id@p ;
...
position p;
@@
 struct stm32_hash_pdata {  struct stm32_hash_algs_info * algs_info ;  size_t algs_info_size ; } cocci_id@p ;
...
position p;
@@
 struct stm32_hash_drv cocci_id@p ;
...
position p;
@@
 struct stm32_hash_ctx cocci_id@p ;
...
typedef spinlock_t;
@@
 struct stm32_hash_drv {  struct list_head dev_list ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 enum stm32_hash_data_format { HASH_DATA_32_BITS = 0x0 , HASH_DATA_16_BITS = 0x1 , HASH_DATA_8_BITS = 0x2 , HASH_DATA_1_BIT = 0x3 , } cocci_id@p ;
