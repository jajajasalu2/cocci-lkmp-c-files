...
typedef u8;
@@
 u8 cocci_id@p [ LENGTH_OF_BUFFER ] ;
...
position p;
@@
 struct input_mt_pos cocci_id@p [ MAX_FINGERS ] ;
...
typedef bool,u32;
@@
 struct bu21013_ts {  struct i2c_client * client ;  struct input_dev * in_dev ;  struct touchscreen_properties props ;  struct regulator * regulator ;  struct gpio_desc * cs_gpiod ;  struct gpio_desc * int_gpiod ;  u32 touch_x_max ;  u32 touch_y_max ;  bool x_flip ;  bool y_flip ;  bool touch_stopped ; } cocci_id@p ;
