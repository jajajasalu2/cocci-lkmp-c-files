...
position p;
@@
 struct sccnxp_pdata cocci_id@p ;
...
position p;
@@
 const struct sccnxp_chip cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 csr ;  u8 acr ;  u8 mr0 ;  int baud ; } cocci_id@p [ ] ;
...
position p;
@@
 struct sccnxp_chip {  const char * name ;  unsigned int nr ;  unsigned long freq_min ;  unsigned long freq_std ;  unsigned long freq_max ;  unsigned int flags ;  unsigned int fifosize ;  unsigned int trwd ; } cocci_id@p ;
