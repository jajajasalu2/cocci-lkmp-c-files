...
position p;
@@
 enum { reg_mode = 0 , reg_control , reg_status , reg_isr , reg_ier , reg_addr , reg_subaddr , reg_data , } cocci_id@p ;
...
position p;
@@
 struct pmf_handlers cocci_id@p ;
...
position p;
@@
 enum { state_idle , state_addr , state_read , state_write , state_stop , state_dead , } cocci_id@p ;
...
typedef u8;
@@
 struct pmu_i2c_hdr {  u8 bus ;  u8 mode ;  u8 bus2 ;  u8 address ;  u8 sub_addr ;  u8 comb_addr ;  u8 count ;  u8 data [ ] ; } cocci_id@p ;
...
@@
 struct pmac_i2c_host_kw {  struct mutex mutex ;  void __iomem * base ;  int bsteps ;  int speed ;  int irq ;  u8 * data ;  unsigned len ;  int state ;  int rw ;  int polled ;  int result ;  struct completion complete ;  spinlock_t lock ;  struct timer_list timeout_timer ; } cocci_id@p ;
...
position p;
@@
 struct pmac_i2c_bus cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct device_node * dev , int quirks ) ;
...
position p;
@@
 struct pmac_i2c_pf_inst * cocci_id@p ;
...
typedef u8;
@@
 struct pmac_i2c_pf_inst {  struct pmac_i2c_bus * bus ;  u8 addr ;  u8 buffer [ MAX_I2C_DATA ] ;  u8 scratch [ MAX_I2C_DATA ] ;  int bytes ;  int quirks ; } cocci_id@p ;
...
position p;
@@
 struct whitelist_ent {  char * name ;  char * compatible ;  int quirks ; } cocci_id@p [ ] ;
...
position p;
@@
 struct whitelist_ent * cocci_id@p ;
...
position p;
@@
 struct pmf_function * cocci_id@p ;
...
position p;
@@
 enum { pmac_i2c_quirk_invmask = 0x00000001u , pmac_i2c_quirk_skip = 0x00000002u , } cocci_id@p ;
...
position p;
@@
 struct pmac_i2c_host_kw * cocci_id@p ;
