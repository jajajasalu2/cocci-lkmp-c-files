...
position p;
@@
 enum head { LOWER_HEAD = 0 , UPPER_HEAD = 1 , } cocci_id@p ;
...
position p;
@@
 enum media_type { DD_MEDIA , HD_MEDIA , } cocci_id@p ;
...
position p;
@@
 enum drive_location { INTERNAL_DRIVE = 0x02 , EXTERNAL_DRIVE = 0x04 , } cocci_id@p ;
...
position p;
@@
 enum drive_location cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct swim __iomem * base , unsigned char * data ) ;
...
position p;
@@
 struct floppy_state {  enum drive_location location ;  int head_number ;  int disk_in ;  int ejected ;  enum media_type type ;  int write_protected ;  int total_secs ;  int secpercyl ;  int secpertrack ;  int track ;  int ref_count ;  struct gendisk * disk ;  struct blk_mq_tag_set tag_set ;  struct swim_priv * swd ; } cocci_id@p ;
...
position p;
@@
 enum motor_action { OFF , ON , } cocci_id@p ;
...
position p;
@@
 struct sector_header cocci_id@p ;
...
position p;
@@
 struct floppy_struct cocci_id@p [ 4 ] ;
...
typedef spinlock_t;
@@
 struct swim_priv {  struct swim __iomem * base ;  spinlock_t lock ;  int floppy_count ;  struct floppy_state unit [ FD_MAX_UNIT ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct swim __iomem * base , struct sector_header * header ) ;
