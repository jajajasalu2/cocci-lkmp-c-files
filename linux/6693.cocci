...
position p;
@@
 struct mbx_24xx_entry * cocci_id@p ;
...
@@
 void cocci_id@p ( scsi_qla_host_t * , struct rsp_que * , void * ) ;
...
position p;
@@
 struct logio_entry_24xx * cocci_id@p ;
...
typedef __be32;
@@
 struct scsi_dif_tuple {  __be16 guard ;  __be16 app_tag ;  __be32 ref_tag ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sts21_entry_t;
@@
 sts21_entry_t * cocci_id@p ;
...
position p;
@@
 const struct qla_init_msix_entry cocci_id@p [ ] ;
...
position p;
@@
 struct els_sts_entry_24xx * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ms_iocb_entry_t;
@@
 ms_iocb_entry_t * cocci_id@p ;
...
position p;
@@
 struct vp_ctrl_entry_24xx * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sts22_entry_t;
@@
 sts22_entry_t * cocci_id@p ;
...
position p;
@@
 struct abort_entry_24xx * cocci_id@p ;
...
position p;
@@
 struct sts_entry_24xx * cocci_id@p ;
...
@@
 struct qla_init_msix_entry {  const char * name ;  irq_handler_t handler ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sts_cont_entry_t;
@@
 sts_cont_entry_t * cocci_id@p ;
