...
position p;
@@
 struct clk_busy_divider * cocci_id@p ;
...
position p;
@@
 struct clk_busy_mux * cocci_id@p ;
...
typedef u8;
@@
 struct clk_busy_divider {  struct clk_divider div ;  const struct clk_ops * div_ops ;  void __iomem * reg ;  u8 shift ; } cocci_id@p ;
...
typedef u8;
@@
 struct clk_busy_mux {  struct clk_mux mux ;  const struct clk_ops * mux_ops ;  void __iomem * reg ;  u8 shift ; } cocci_id@p ;
