...
position p;
@@
 const struct nvdimm_key_data * cocci_id@p ;
...
position p;
@@
 struct {  struct nd_cmd_pkg pkg ;  struct nd_intel_disable_passphrase cmd ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nd_cmd_pkg pkg ;  struct nd_intel_set_passphrase cmd ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nd_cmd_pkg pkg ;  struct nd_intel_get_security_state cmd ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nd_cmd_pkg pkg ;  struct nd_intel_overwrite cmd ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nd_cmd_pkg pkg ;  struct nd_intel_freeze_lock cmd ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nd_cmd_pkg pkg ;  struct nd_intel_query_overwrite cmd ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nd_cmd_pkg pkg ;  struct nd_intel_secure_erase cmd ; } cocci_id@p ;
...
position p;
@@
 enum nvdimm_passphrase_type cocci_id@p ;
...
position p;
@@
 struct {  struct nd_cmd_pkg pkg ;  struct nd_intel_unlock_unit cmd ; } cocci_id@p ;
