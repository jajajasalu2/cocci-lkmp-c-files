...
position p;
@@
 struct nfs_cache_array * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dentry * , unsigned int ) ;
...
typedef u64;
@@
 struct nfs_cache_array_entry {  u64 cookie ;  u64 ino ;  struct qstr string ;  unsigned char d_type ; } cocci_id@p ;
...
position p;
@@
 struct nfs_open_dir_context * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nfs_readdir_descriptor_t;
@@
 nfs_readdir_descriptor_t cocci_id@p ;
...
typedef u64;
@@
 struct nfs_cache_array {  int size ;  int eof_index ;  u64 last_cookie ;  struct nfs_cache_array_entry array [ 0 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,loff_t,decode_dirent_t;
@@
 struct {  struct file * file ;  struct page * page ;  struct dir_context * ctx ;  unsigned long page_index ;  u64 * dir_cookie ;  u64 last_cookie ;  loff_t current_index ;  decode_dirent_t decode ;  unsigned long timestamp ;  unsigned long gencount ;  unsigned int cache_entry_index ;  bool plus ;  bool eof ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct inode * , struct dentry * , unsigned int ) ;
...
position p;
@@
 struct page * cocci_id@p [ NFS_MAX_READDIR_PAGES ] ;
...
typedef bool;
@@
 int ( * cocci_id@p ) ( struct xdr_stream * , struct nfs_entry * , bool ) ;
...
position p;
@@
 struct nfs_cache_array_entry * cocci_id@p ;
