...
position p;
@@
 struct sr030pc30_info * cocci_id@p ;
...
typedef u8;
@@
 struct sr030pc30_info {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  const struct sr030pc30_platform_data * pdata ;  const struct sr030pc30_format * curr_fmt ;  const struct sr030pc30_frmsize * curr_win ;  unsigned int hflip : 1 ;  unsigned int vflip : 1 ;  unsigned int sleep : 1 ;  struct {  struct v4l2_ctrl * awb ;  struct v4l2_ctrl * red ;  struct v4l2_ctrl * blue ; } ;  struct {  struct v4l2_ctrl * autoexp ;  struct v4l2_ctrl * exp ; } ;  u8 i2c_reg_page ; } cocci_id@p ;
...
typedef u16;
@@
 struct sr030pc30_frmsize {  u16 width ;  u16 height ;  int vid_ctl1 ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct sr030pc30_format {  u32 code ;  enum v4l2_colorspace colorspace ;  u16 ispctl1_reg ; } cocci_id@p ;
...
position p;
@@
 const struct sr030pc30_frmsize cocci_id@p [ ] ;
...
position p;
@@
 const struct sr030pc30_platform_data * cocci_id@p ;
...
position p;
@@
 const struct sr030pc30_format * cocci_id@p ;
