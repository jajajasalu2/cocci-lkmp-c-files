...
typedef u16;
@@
 struct lm25066_data {  int id ;  u16 rlimit ;  struct pmbus_driver_info info ; } cocci_id@p ;
...
position p;
@@
 struct lm25066_data cocci_id@p ;
...
position p;
@@
 const struct lm25066_data * cocci_id@p ;
...
position p;
@@
 enum chips { lm25056 , lm25066 , lm5064 , lm5066 , lm5066i , } cocci_id@p ;
