...
typedef u32;
@@
 u32 cocci_id@p [ CPU_TEMP_HIST_SIZE ] ;
...
position p;
@@
 struct wf_cpu_pid_state * cocci_id@p ;
...
position p;
@@
 struct wf_cpu_pid_state cocci_id@p [ NR_CORES ] ;
...
position p;
@@
 struct wf_pid_state cocci_id@p ;
...
position p;
@@
 struct wf_control * cocci_id@p [ NR_CPU_FANS ] ;
...
position p;
@@
 struct wf_sensor * cocci_id@p [ NR_CORES ] ;
