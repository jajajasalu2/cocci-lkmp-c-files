...
typedef u64;
@@
 struct ses_component {  u64 addr ; } cocci_id@p ;
...
position p;
@@
 struct ses_host_edev {  struct Scsi_Host * shost ;  struct enclosure_device * edev ; } cocci_id@p ;
...
position p;
@@
 struct enclosure_device * cocci_id@p ;
...
position p;
@@
 struct ses_device {  unsigned char * page1 ;  unsigned char * page1_types ;  unsigned char * page2 ;  unsigned char * page10 ;  short page1_len ;  short page1_num_types ;  short page2_len ;  short page10_len ; } cocci_id@p ;
...
position p;
@@
 struct ses_component cocci_id@p ;
...
position p;
@@
 struct enclosure_component * cocci_id@p ;
...
position p;
@@
 enum enclosure_component_setting cocci_id@p ;
...
typedef u64;
@@
 struct efd {  u64 addr ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct enclosure_component_callbacks cocci_id@p ;
