...
position p;
@@
 struct altera_uart {  struct uart_port port ;  struct timer_list tmr ;  unsigned int sigs ;  unsigned short imr ; } cocci_id@p ;
...
position p;
@@
 struct altera_uart cocci_id@p [ CONFIG_SERIAL_ALTERA_UART_MAXPORTS ] ;
...
position p;
@@
 struct altera_uart_platform_uart * cocci_id@p ;
