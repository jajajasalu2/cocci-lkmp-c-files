...
typedef u16;
@@
 struct mt9t031 {  struct v4l2_subdev subdev ;  struct v4l2_ctrl_handler hdl ;  struct {  struct v4l2_ctrl * autoexposure ;  struct v4l2_ctrl * exposure ; } ;  struct v4l2_rect rect ;  struct v4l2_clk * clk ;  u16 xskip ;  u16 yskip ;  unsigned int total_h ;  unsigned short y_skip_top ; } cocci_id@p ;
