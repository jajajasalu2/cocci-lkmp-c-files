...
typedef u64;
@@
 u64 cocci_id@p [ 256 * 1024 / dah_align ] ;
...
position p;
@@
 struct debug_alloc_header * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ KSYM_NAME_LEN + 1 ] ;
...
typedef u32;
@@
 struct debug_alloc_header {  u32 next ;  u32 size ;  void * caller ; } cocci_id@p ;
