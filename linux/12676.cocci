...
position p;
@@
 struct hisi_lpc_dev * cocci_id@p ;
...
position p;
@@
 struct lpc_cycle_para cocci_id@p ;
...
position p;
@@
 struct hisi_lpc_acpi_cell {  const char * hid ;  const char * name ;  void * pdata ;  size_t pdata_size ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct hisi_lpc_dev {  spinlock_t cycle_lock ;  void __iomem * membase ;  struct logic_pio_hwaddr * io_host ; } cocci_id@p ;
...
position p;
@@
 const struct hisi_lpc_acpi_cell * cocci_id@p ;
...
position p;
@@
 const struct logic_pio_host_ops cocci_id@p ;
...
position p;
@@
 struct hisi_lpc_acpi_cell cocci_id@p [ ] ;
...
position p;
@@
 struct lpc_cycle_para {  unsigned int opflags ;  unsigned int csize ; } cocci_id@p ;
