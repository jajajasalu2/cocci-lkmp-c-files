...
position p;
@@
 struct fuse_in_header cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fuse_conn * fc , struct fuse_req * req ) ;
...
position p;
@@
 struct fuse_notify_retrieve_out cocci_id@p ;
...
position p;
@@
 struct fuse_forget_one cocci_id@p ;
...
position p;
@@
 struct fuse_forget_link * * cocci_id@p ;
...
position p;
@@
 struct fuse_out_header cocci_id@p ;
...
position p;
@@
 struct fuse_batch_forget_in cocci_id@p ;
...
position p;
@@
 struct fuse_copy_state * cocci_id@p ;
...
position p;
@@
 struct fuse_notify_inval_entry_out cocci_id@p ;
...
position p;
@@
 struct fuse_notify_inval_inode_out cocci_id@p ;
...
position p;
@@
 const struct fuse_iqueue_ops cocci_id@p ;
...
position p;
@@
 struct fuse_retrieve_args {  struct fuse_args_pages ap ;  struct fuse_notify_retrieve_in inarg ; } cocci_id@p ;
...
position p;
@@
 enum fuse_notify_code cocci_id@p ;
...
position p;
@@
 struct fuse_retrieve_args * cocci_id@p ;
...
position p;
@@
 struct fuse_interrupt_in cocci_id@p ;
...
position p;
@@
 struct fuse_forget_in cocci_id@p ;
...
position p;
@@
 struct fuse_copy_state {  int write ;  struct fuse_req * req ;  struct iov_iter * iter ;  struct pipe_buffer * pipebufs ;  struct pipe_buffer * currbuf ;  struct pipe_inode_info * pipe ;  unsigned long nr_segs ;  struct page * pg ;  unsigned len ;  unsigned offset ;  unsigned move_pages : 1 ; } cocci_id@p ;
...
position p;
@@
 struct fuse_notify_store_out cocci_id@p ;
...
position p;
@@
 struct fuse_notify_delete_out cocci_id@p ;
