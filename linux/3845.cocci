...
typedef u32;
@@
 const u32 cocci_id@p [ CC_CPP_NUM_ALGS ] [ CC_CPP_NUM_SLOTS ] ;
...
position p;
@@
 void cocci_id@p ( unsigned long devarg ) ;
...
typedef bool;
@@
 struct cc_bl_item {  struct cc_crypto_req creq ;  struct cc_hw_desc desc [ CC_MAX_DESC_SEQ_LEN ] ;  unsigned int len ;  struct list_head list ;  bool notif ; } cocci_id@p ;
...
position p;
@@
 struct cc_req_mgr_handle * cocci_id@p ;
