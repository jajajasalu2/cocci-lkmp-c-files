...
position p;
@@
 struct clk * cocci_id@p [ ( PRCC_NUM_PERIPH_CLUSTERS + 1 ) * PRCC_PERIPHS_PER_CLUSTER ] ;
...
position p;
@@
 enum clkrst_index { CLKRST1_INDEX = 0 , CLKRST2_INDEX , CLKRST3_INDEX , CLKRST5_INDEX , CLKRST6_INDEX , CLKRST_MAX , } cocci_id@p ;
...
position p;
@@
 struct clk * cocci_id@p [ PRCMU_NUM_CLKS ] ;
