...
position p;
@@
 void cocci_id@p ( struct viosrp_crq * crq , struct ibmvscsi_host_data * hostdata ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct srp_event_struct * ) ;
...
position p;
@@
 struct ibmvscsi_host_data * cocci_id@p ;
...
position p;
@@
 struct viosrp_fast_fail * cocci_id@p ;
...
position p;
@@
 struct srp_event_struct * cocci_id@p ;
