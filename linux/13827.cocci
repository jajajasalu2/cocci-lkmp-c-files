...
position p;
@@
 const struct regval_list * cocci_id@p ;
...
typedef u8;
@@
 struct regval_list {  u8 reg_num ;  u8 value ; } cocci_id@p ;
...
position p;
@@
 const struct ov2640_win_size * cocci_id@p ;
...
typedef bool,u32;
@@
 struct ov2640_priv {  struct v4l2_subdev subdev ; #if defined(CONFIG_MEDIA_CONTROLLER)  struct media_pad pad ; #endif  struct v4l2_ctrl_handler hdl ;  u32 cfmt_code ;  struct clk * clk ;  const struct ov2640_win_size * win ;  struct gpio_desc * resetb_gpio ;  struct gpio_desc * pwdn_gpio ;  struct mutex lock ;  bool streaming ;  int power_count ; } cocci_id@p ;
...
typedef u32;
@@
 struct ov2640_win_size {  char * name ;  u32 width ;  u32 height ;  const struct regval_list * regs ; } cocci_id@p ;
