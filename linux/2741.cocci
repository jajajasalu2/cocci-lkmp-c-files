...
position p;
@@
 struct img_i2c_timings cocci_id@p [ ] ;
...
position p;
@@
 enum img_i2c_mode { MODE_INACTIVE , MODE_RAW , MODE_ATOMIC , MODE_AUTOMATIC , MODE_SEQUENCE , MODE_FATAL , MODE_WAITSTOP , MODE_SUSPEND , } cocci_id@p ;
