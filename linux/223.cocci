...
position p;
@@
 struct send_signal_irq_work cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p ( u64 r1 , u64 r2 , u64 r3 , u64 r4 , u64 r5 ) ;
...
position p;
@@
 struct bpf_perf_event_data cocci_id@p ;
...
position p;
@@
 struct bpf_event_entry * cocci_id@p ;
...
position p;
@@
 struct bpf_trace_module {  struct module * module ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct bpf_raw_tp_regs {  struct pt_regs regs [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct bpf_trace_sample_data {  struct perf_sample_data sds [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct bpf_trace_module * cocci_id@p ;
...
typedef u32;
@@
 struct send_signal_irq_work {  struct irq_work irq_work ;  struct task_struct * task ;  u32 sig ; } cocci_id@p ;
...
position p;
@@
 struct bpf_nested_pt_regs {  struct pt_regs regs [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct bpf_raw_tp_regs * cocci_id@p ;
...
position p;
@@
 struct perf_event_query_bpf cocci_id@p ;
...
position p;
@@
 bpf_get_current_task cocci_id@p ;
