...
position p;
@@
 struct usb_iso_packet_descriptor * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ COMMAND_PACKET_SIZE ] ;
...
position p;
@@
 enum ttusb_dec_packet_type { TTUSB_DEC_PACKET_PVA , TTUSB_DEC_PACKET_SECTION , TTUSB_DEC_PACKET_EMPTY , } cocci_id@p ;
...
typedef u8;
@@
 struct filter_info {  u8 stream_id ;  struct dvb_demux_filter * filter ;  struct list_head filter_info_list ; } cocci_id@p ;
...
position p;
@@
 struct dvb_demux_feed * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dvb_filter_pes2ts_cb_t;
@@
 dvb_filter_pes2ts_cb_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * , unsigned char * ) ;
...
typedef u8;
@@
 struct urb_frame {  u8 data [ ISO_FRAME_SIZE ] ;  int length ;  struct list_head urb_frame_list ; } cocci_id@p ;
...
position p;
@@
 struct dvb_filter_pes2ts * cocci_id@p ;
...
typedef dvb_filter_pes2ts_cb_t;
@@
 struct dvb_filter_pes2ts {  unsigned char buf [ 188 ] ;  unsigned char cc ;  dvb_filter_pes2ts_cb_t * cb ;  void * priv ; } cocci_id@p ;
...
position p;
@@
 enum ttusb_dec_model { TTUSB_DEC2000T , TTUSB_DEC2540T , TTUSB_DEC3000S , } cocci_id@p ;
...
position p;
@@
 const struct ttusbdecfe_config cocci_id@p ;
...
position p;
@@
 struct dvb_demux_filter * cocci_id@p ;
...
position p;
@@
 enum ttusb_dec_interface cocci_id@p ;
...
position p;
@@
 enum ttusb_dec_interface { TTUSB_DEC_INTERFACE_INITIAL , TTUSB_DEC_INTERFACE_IN , TTUSB_DEC_INTERFACE_OUT , } cocci_id@p ;
...
position p;
@@
 enum ttusb_dec_model cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ttusb_dec * dec , enum ttusb_dec_model model ) ;
