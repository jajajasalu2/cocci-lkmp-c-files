...
position p;
@@
 struct omap3isp_h3a_af_config * cocci_id@p ;
...
position p;
@@
 const struct ispstat_ops cocci_id@p ;
...
position p;
@@
 struct omap3isp_h3a_af_iir * cocci_id@p ;
...
position p;
@@
 struct omap3isp_h3a_af_paxel * cocci_id@p ;
