...
position p;
@@
 const struct cec_log_addrs * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cec_adapter * adap , struct cec_msg * msg , unsigned int la_idx ) ;
...
position p;
@@
 const struct cec_adapter * cocci_id@p ;
...
position p;
@@
 struct cec_event_entry cocci_id@p ;
...
position p;
@@
 const struct cec_event * cocci_id@p ;
...
position p;
@@
 const struct cec_msg * cocci_id@p ;
...
position p;
@@
 struct cec_msg_entry * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct cec_adapter * adap , struct cec_msg * msg , bool is_reply ) ;
...
typedef u16;
@@
 const u16 cocci_id@p [ CEC_NUM_EVENTS ] ;
...
position p;
@@
 const struct cec_connector_info * cocci_id@p ;
