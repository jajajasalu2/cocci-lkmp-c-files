...
position p;
@@
 const struct rtd_boardinfo * cocci_id@p ;
...
position p;
@@
 enum rtd_boardid { BOARD_DM7520 , BOARD_PCI4520 , } cocci_id@p ;
...
position p;
@@
 struct rtd_private {  void __iomem * las1 ;  void __iomem * lcfg ;  long ai_count ;  int xfer_count ;  int flags ;  unsigned int fifosz ;  unsigned char timer_gate_src [ 3 ] ;  unsigned char timer_clk_src [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct rtd_boardinfo {  const char * name ;  int range_bip10 ;  int range_uni10 ;  const struct comedi_lrange * ai_range ; } cocci_id@p ;
