...
position p;
@@
 void cocci_id@p ( struct initio_host * host ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long base ) ;
...
position p;
@@
 int cocci_id@p ( struct initio_host * host ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * pHcb , u8 * pScb ) ;
...
position p;
@@
 void cocci_id@p ( unsigned long base ) ;
...
position p;
@@
 struct scsi_ctrl_blk * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct initio_host * host , struct scsi_ctrl_blk * scb ) ;
...
position p;
@@
 struct scsi_ctrl_blk * cocci_id@p ( struct initio_host * host ) ;
...
typedef u16;
@@
 struct scsi_ctrl_blk * cocci_id@p ( struct initio_host * host , u16 tarlun ) ;
...
position p;
@@
 struct target_control * cocci_id@p ;
