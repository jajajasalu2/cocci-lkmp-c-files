...
typedef __le32;
@@
 struct gl_header {  __le32 packet_count ;  struct gl_packet packets ; } cocci_id@p ;
...
typedef __le32;
@@
 struct gl_packet {  __le32 packet_length ;  char packet_data [ 1 ] ; } cocci_id@p ;
