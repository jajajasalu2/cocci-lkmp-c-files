...
position p;
@@
 struct abeoz9_rtc_data * cocci_id@p ;
...
position p;
@@
 struct abeoz9_rtc_data {  struct rtc_device * rtc ;  struct regmap * regmap ;  struct device * hwmon_dev ; } cocci_id@p ;
