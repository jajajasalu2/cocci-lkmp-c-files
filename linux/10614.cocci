...
typedef u32;
@@
 struct measure_breadcrumb {  struct i915_request rq ;  struct intel_timeline timeline ;  struct intel_ring ring ;  u32 cs [ 1024 ] ; } cocci_id@p ;
...
position p;
@@
 struct measure_breadcrumb * cocci_id@p ;
...
position p;
@@
 struct i915_gpu_error * const cocci_id@p ;
...
typedef u8,u32;
@@
 struct engine_info {  unsigned int hw_id ;  u8 class ;  u8 instance ;  struct engine_mmio_base {  u32 gen : 8 ;  u32 base : 24 ; } mmio_bases [ MAX_MMIO_BASES ] ; } cocci_id@p ;
...
position p;
@@
 const struct engine_info * cocci_id@p ;
...
position p;
@@
 const struct engine_mmio_base * cocci_id@p ;
...
position p;
@@
 struct intel_instdone * cocci_id@p ;
...
position p;
@@
 typeof ( engine -> destroy ) cocci_id@p ;
...
position p;
@@
 struct intel_device_info * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct intel_engine_cs * engine ) ;
...
position p;
@@
 enum forcewake_domains cocci_id@p ;
