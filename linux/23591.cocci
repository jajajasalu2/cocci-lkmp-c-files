...
position p;
@@
 struct tegra_rt5677 cocci_id@p ;
...
position p;
@@
 struct tegra_rt5677 {  struct tegra_asoc_utils_data util_data ;  int gpio_hp_det ;  int gpio_hp_en ;  int gpio_mic_present ;  int gpio_dmic_clk_en ; } cocci_id@p ;
