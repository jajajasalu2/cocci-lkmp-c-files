...
position p;
@@
 struct nd_cmd_vendor_hdr * cocci_id@p ;
...
position p;
@@
 struct nd_device_driver cocci_id@p ;
...
position p;
@@
 struct clear_badblocks_context * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct device * dev , struct device_driver * drv ) ;
...
position p;
@@
 enum nd_ioctl_mode { BUS_IOCTL , DIMM_IOCTL , } cocci_id@p ;
