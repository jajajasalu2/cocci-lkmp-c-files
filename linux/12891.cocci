...
position p;
@@
 struct amd64_family_type * cocci_id@p ;
...
position p;
@@
 struct ecc_settings cocci_id@p ;
...
typedef u32;
@@
 const struct scrubrate {  u32 scrubval ;  u32 bandwidth ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 void cocci_id@p ( struct amd64_pvt * , u8 ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct mem_ctl_info * , u16 ) ;
