...
typedef bool;
@@
 struct csi2_dev {  struct device * dev ;  struct v4l2_subdev sd ;  struct media_pad pad [ CSI2_NUM_PADS ] ;  struct clk * dphy_clk ;  struct clk * pllref_clk ;  struct clk * pix_clk ;  void __iomem * base ;  struct v4l2_fwnode_bus_mipi_csi2 bus ;  struct mutex lock ;  struct v4l2_mbus_framefmt format_mbus ;  int stream_count ;  struct v4l2_subdev * src_sd ;  bool sink_linked [ CSI2_NUM_SRC_PADS ] ; } cocci_id@p ;
...
typedef u32;
@@
 const struct {  u32 max_mbps ;  u32 hsfreqrange_sel ; } cocci_id@p [ ] ;
