...
typedef u8,u32;
@@
 struct _arg_GO {  u8 chan ;  u32 addr ;  unsigned ns ; } cocci_id@p ;
...
position p;
@@
 const struct amba_id cocci_id@p [ ] ;
...
position p;
@@
 struct dma_pl330_desc * cocci_id@p ;
...
position p;
@@
 const struct pl330_reqcfg * cocci_id@p ;
...
typedef u8,bool;
@@
 struct _arg_LPEND {  enum pl330_cond cond ;  bool forever ;  unsigned loop ;  u8 bjump ; } cocci_id@p ;
...
position p;
@@
 struct pl330_thread * cocci_id@p ;
...
position p;
@@
 enum pl330_cachectrl { CCTRL0 , CCTRL1 , CCTRL2 , CCTRL3 , INVALID1 , INVALID2 , CCTRL6 , CCTRL7 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,phys_addr_t,spinlock_t,dma_addr_t;
@@
 struct dma_pl330_chan {  struct tasklet_struct task ;  struct dma_chan chan ;  struct list_head submitted_list ;  struct list_head work_list ;  struct list_head completed_list ;  struct pl330_dmac * dmac ;  spinlock_t lock ;  struct pl330_thread * thread ;  int burst_sz ;  int burst_len ;  phys_addr_t fifo_addr ;  dma_addr_t fifo_dma ;  enum dma_data_direction dir ;  struct dma_slave_config slave_config ;  bool cyclic ;  bool active ; } cocci_id@p ;
...
typedef u32;
@@
 struct pl330_xfer {  u32 src_addr ;  u32 dst_addr ;  u32 bytes ; } cocci_id@p ;
...
position p;
@@
 enum pl330_cond { SINGLE , BURST , ALWAYS , } cocci_id@p ;
...
position p;
@@
 struct dma_pl330_chan cocci_id@p ;
...
position p;
@@
 enum pl330_op_err { PL330_ERR_NONE , PL330_ERR_ABORT , PL330_ERR_FAIL , } cocci_id@p ;
...
position p;
@@
 enum pl330_dmac_state { UNINIT , INIT , DYING , } cocci_id@p ;
...
position p;
@@
 const struct pl330_dmac * cocci_id@p ;
...
position p;
@@
 enum dmamov_dst { SAR = 0 , CCR , DAR , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct pl330_thread {  u8 id ;  int ev ;  bool free ;  struct pl330_dmac * dmac ;  struct _pl330_req req [ 2 ] ;  unsigned lstenq ;  int req_running ; } cocci_id@p ;
...
position p;
@@
 enum desc_status { FREE , PREP , BUSY , DONE , } cocci_id@p ;
...
typedef u32;
@@
 struct _xfer_spec {  u32 ccr ;  struct dma_pl330_desc * desc ; } cocci_id@p ;
...
position p;
@@
 struct pl330_config * cocci_id@p ;
...
position p;
@@
 struct pl330_of_quirks {  char * quirk ;  int id ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct _pl330_req {  u32 mc_bus ;  void * mc_cpu ;  struct dma_pl330_desc * desc ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dma_chan * chan , struct dma_slave_config * slave_config , enum dma_transfer_direction direction ) ;
...
position p;
@@
 enum dma_transfer_direction cocci_id@p ;
...
position p;
@@
 struct dmaengine_desc_callback cocci_id@p ;
...
position p;
@@
 enum pl330_byteswap { SWAP_NO , SWAP_2 , SWAP_4 , SWAP_8 , SWAP_16 , } cocci_id@p ;
...
position p;
@@
 struct dma_tx_state * cocci_id@p ;
...
typedef bool;
@@
 struct dma_pl330_desc {  struct list_head node ;  struct dma_async_tx_descriptor txd ;  struct pl330_xfer px ;  struct pl330_reqcfg rqcfg ;  enum desc_status status ;  int bytes_requested ;  bool last ;  struct dma_pl330_chan * pchan ;  enum dma_transfer_direction rqtype ;  unsigned peri : 5 ;  struct list_head rqd ; } cocci_id@p ;
...
position p;
@@
 enum pl330_dst { SRC = 0 , DST , } cocci_id@p ;
...
position p;
@@
 const struct _arg_GO * cocci_id@p ;
...
position p;
@@
 const struct _xfer_spec * cocci_id@p ;
...
typedef bool;
@@
 struct pl330_reqcfg {  unsigned dst_inc : 1 ;  unsigned src_inc : 1 ;  bool nonsecure ;  bool privileged ;  bool insnaccess ;  unsigned brst_len : 5 ;  unsigned brst_size : 3 ;  enum pl330_cachectrl dcctl ;  enum pl330_cachectrl scctl ;  enum pl330_byteswap swap ;  struct pl330_config * pcfg ; } cocci_id@p ;
...
position p;
@@
 const struct _arg_LPEND * cocci_id@p ;
...
typedef u8,bool;
@@
 struct _pl330_tbd {  bool reset_dmac ;  bool reset_mngr ;  u8 reset_chan ; } cocci_id@p ;
