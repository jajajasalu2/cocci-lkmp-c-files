...
typedef u8,bool;
@@
 struct alb_walk_data {  struct bonding * bond ;  struct slave * slave ;  u8 * mac_addr ;  bool strict_match ; } cocci_id@p ;
...
position p;
@@
 struct alb_walk_data * cocci_id@p ;
...
position p;
@@
 struct tlb_client_info * cocci_id@p ;
...
position p;
@@
 struct rlb_client_info cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct bonding * bond , u32 ip_src_hash , u32 ip_dst_hash ) ;
...
position p;
@@
 struct learning_pkt cocci_id@p ;
...
typedef u8,__be32;
@@
 struct arp_pkt {  __be16 hw_addr_space ;  __be16 prot_addr_space ;  u8 hw_addr_len ;  u8 prot_addr_len ;  __be16 op_code ;  u8 mac_src [ ETH_ALEN ] ;  __be32 ip_src ;  u8 mac_dst [ ETH_ALEN ] ;  __be32 ip_dst ; } cocci_id@p ;
...
position p;
@@
 struct tlb_slave_info * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct bonding * bond , u32 index ) ;
...
typedef u8;
@@
 struct learning_pkt {  u8 mac_dst [ ETH_ALEN ] ;  u8 mac_src [ ETH_ALEN ] ;  __be16 type ;  u8 padding [ ETH_ZLEN - ETH_HLEN ] ; } cocci_id@p ;
...
typedef u8,bool;
@@
 void cocci_id@p ( struct slave * slave , u8 mac_addr [ ] , bool strict_match ) ;
...
position p;
@@
 void cocci_id@p ( struct bonding * bond , struct arp_pkt * arp ) ;
