...
position p;
@@
 struct hifn_crypto_alg {  struct list_head entry ;  struct skcipher_alg alg ;  struct hifn_device * dev ; } cocci_id@p ;
...
position p;
@@
 struct hifn_request_context * cocci_id@p ;
...
position p;
@@
 struct hifn_base_command cocci_id@p ;
...
position p;
@@
 struct hifn_crypt_command {  volatile __le16 masks ;  volatile __le16 header_skip ;  volatile __le16 source_count ;  volatile __le16 reserved ; } cocci_id@p ;
...
position p;
@@
 struct hifn_context * cocci_id@p ;
...
position p;
@@
 struct hifn_crypt_result {  volatile __le16 flags ;  volatile __le16 reserved ; } cocci_id@p ;
...
typedef u32;
@@
 struct hifn_cipher_walk {  struct scatterlist cache [ ASYNC_SCATTERLIST_CACHE ] ;  u32 flags ;  int num ; } cocci_id@p ;
...
typedef u_short;
@@
 struct pci2id {  u_short pci_vendor ;  u_short pci_prod ;  char card_id [ 13 ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct hifn_alg_template {  char name [ CRYPTO_MAX_ALG_NAME ] ;  char drv_name [ CRYPTO_MAX_ALG_NAME ] ;  unsigned int bsize ;  struct skcipher_alg skcipher ; } cocci_id@p ;
...
position p;
@@
 struct hifn_crypt_command * cocci_id@p ;
...
position p;
@@
 struct hifn_comp_result {  volatile __le16 flags ;  volatile __le16 crc ; } cocci_id@p ;
...
position p;
@@
 struct hifn_cipher_walk * cocci_id@p ;
...
position p;
@@
 struct hifn_crypto_alg * cocci_id@p ;
...
position p;
@@
 const struct hifn_alg_template * cocci_id@p ;
...
position p;
@@
 struct hifn_comp_command {  volatile __le16 masks ;  volatile __le16 header_skip ;  volatile __le16 source_count ;  volatile __le16 reserved ; } cocci_id@p ;
...
position p;
@@
 struct hifn_base_result {  volatile __le16 flags ;  volatile __le16 session ;  volatile __le16 src_cnt ;  volatile __le16 dst_cnt ; } cocci_id@p ;
...
position p;
@@
 struct hifn_base_command {  volatile __le16 masks ;  volatile __le16 session_num ;  volatile __le16 total_source_count ;  volatile __le16 total_dest_count ; } cocci_id@p ;
...
position p;
@@
 struct hifn_mac_command {  volatile __le16 masks ;  volatile __le16 header_skip ;  volatile __le16 source_count ;  volatile __le16 reserved ; } cocci_id@p ;
...
typedef u8;
@@
 struct hifn_context {  u8 key [ HIFN_MAX_CRYPT_KEY_LENGTH ] ;  struct hifn_device * dev ;  unsigned int keysize ; } cocci_id@p ;
...
position p;
@@
 struct hifn_mac_result {  volatile __le16 flags ;  volatile __le16 reserved ; } cocci_id@p ;
...
typedef __le32;
@@
 struct hifn_desc {  volatile __le32 l ;  volatile __le32 p ; } cocci_id@p ;
