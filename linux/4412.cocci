...
position p;
@@
 struct xilly_endpoint * cocci_id@p ;
...
position p;
@@
 struct xilly_alloc_state * cocci_id@p ;
...
position p;
@@
 struct xilly_buffer cocci_id@p ;
...
typedef u32;
@@
 struct xilly_alloc_state {  void * salami ;  int left_of_salami ;  int nbuffer ;  enum dma_data_direction direction ;  u32 regdirection ; } cocci_id@p ;
...
position p;
@@
 struct xilly_channel * cocci_id@p ;
...
position p;
@@
 struct xilly_endpoint_hardware * cocci_id@p ;
...
position p;
@@
 struct xilly_idt_handle * cocci_id@p ;
