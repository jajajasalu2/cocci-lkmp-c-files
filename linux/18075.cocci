...
position p;
@@
 struct spi_board_info cocci_id@p [ ] ;
...
position p;
@@
 const struct vpif_output cocci_id@p [ ] ;
...
position p;
@@
 struct nvmem_cell_info cocci_id@p [ ] ;
...
position p;
@@
 struct snd_platform_data cocci_id@p ;
...
position p;
@@
 struct gpio_keys_button cocci_id@p [ ] ;
...
position p;
@@
 struct mtd_partition cocci_id@p [ ] ;
...
position p;
@@
 struct pca953x_platform_data cocci_id@p ;
...
position p;
@@
 struct aemif_abus_data cocci_id@p [ ] ;
...
position p;
@@
 struct edma_rsv_info * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct vpif_subdev_info cocci_id@p [ ] ;
...
position p;
@@
 struct vpif_display_config cocci_id@p ;
...
position p;
@@
 struct davinci_soc_info * cocci_id@p ;
...
position p;
@@
 struct tps6507x_reg_platform_data cocci_id@p ;
...
position p;
@@
 enum da850_evm_ui_exp_pins { DA850_EVM_UI_EXP_SEL_C = 5 , DA850_EVM_UI_EXP_SEL_B , DA850_EVM_UI_EXP_SEL_A , DA850_EVM_UI_EXP_PB8 , DA850_EVM_UI_EXP_PB7 , DA850_EVM_UI_EXP_PB6 , DA850_EVM_UI_EXP_PB5 , DA850_EVM_UI_EXP_PB4 , DA850_EVM_UI_EXP_PB3 , DA850_EVM_UI_EXP_PB2 , DA850_EVM_UI_EXP_PB1 , } cocci_id@p ;
...
position p;
@@
 struct adv7343_platform_data cocci_id@p ;
...
position p;
@@
 struct davinci_mmc_config cocci_id@p ;
...
position p;
@@
 struct physmap_flash_data cocci_id@p ;
...
position p;
@@
 struct gpio_keys_platform_data cocci_id@p ;
...
position p;
@@
 struct nvmem_cell_table cocci_id@p ;
...
position p;
@@
 struct fixed_voltage_config cocci_id@p ;
...
position p;
@@
 struct vpif_capture_config cocci_id@p ;
...
position p;
@@
 struct nvmem_cell_lookup cocci_id@p ;
...
position p;
@@
 struct davinci_nand_pdata cocci_id@p ;
...
position p;
@@
 struct gpiod_lookup_table * cocci_id@p [ ] ;
...
position p;
@@
 struct touchscreen_init_data cocci_id@p ;
...
position p;
@@
 const struct machine_desc cocci_id@p ;
...
position p;
@@
 struct aemif_platform_data cocci_id@p ;
...
position p;
@@
 struct tvp514x_platform_data cocci_id@p ;
...
position p;
@@
 struct tps6507x_board cocci_id@p ;
...
position p;
@@
 struct davinci_aemif_timing cocci_id@p ;
...
position p;
@@
 struct davinci_spi_config cocci_id@p ;
...
position p;
@@
 struct davinci_i2c_platform_data cocci_id@p ;
...
position p;
@@
 struct property_entry cocci_id@p [ ] ;
...
position p;
@@
 struct edma_rsv_info cocci_id@p ;
...
position p;
@@
 const struct platform_device_info cocci_id@p ;
...
position p;
@@
 struct gpio_led_platform_data cocci_id@p ;
