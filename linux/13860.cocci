...
position p;
@@
 struct redrat3_irdata cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u32,u16,atomic_t,dma_addr_t;
@@
 struct redrat3_dev {  struct rc_dev * rc ;  struct device * dev ;  struct led_classdev led ;  atomic_t flash ;  struct usb_ctrlrequest flash_control ;  struct urb * flash_urb ;  u8 flash_in_buf ;  bool wideband ;  struct usb_ctrlrequest learn_control ;  struct urb * learn_urb ;  u8 learn_buf ;  struct usb_device * udev ;  struct usb_endpoint_descriptor * ep_narrow ;  void * bulk_in_buf ;  struct urb * narrow_urb ;  struct urb * wide_urb ;  struct usb_endpoint_descriptor * ep_out ;  dma_addr_t dma_in ;  bool transmitting ;  struct redrat3_irdata irdata ;  u16 bytes_read ;  u32 carrier ;  char name [ 64 ] ;  char phys [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 struct redrat3_error * cocci_id@p ;
...
position p;
@@
 struct redrat3_header cocci_id@p ;
