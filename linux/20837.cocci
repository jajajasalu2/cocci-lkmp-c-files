...
position p;
@@
 struct kvm_ioapic_state cocci_id@p ;
...
position p;
@@
 union kvm_ioapic_redirect_entry * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct kvm_ioapic * vioapic , int irq , bool line_status ) ;
...
position p;
@@
 void cocci_id@p ( struct kvm_ioapic * ioapic ) ;
