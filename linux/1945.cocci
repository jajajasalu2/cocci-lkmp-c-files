...
typedef s32;
@@
 struct hp03_priv {  struct i2c_client * client ;  struct mutex lock ;  struct gpio_desc * xclr_gpio ;  struct i2c_client * eeprom_client ;  struct regmap * eeprom_regmap ;  s32 pressure ;  s32 temp ; } cocci_id@p ;
