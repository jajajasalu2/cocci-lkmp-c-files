...
typedef u32;
@@
 struct etherh_priv {  void __iomem * ioc_fast ;  void __iomem * memc ;  void __iomem * dma_base ;  unsigned int id ;  void __iomem * ctrl_port ;  unsigned char ctrl ;  u32 supported ; } cocci_id@p ;
...
typedef u32;
@@
 struct etherh_data {  unsigned long ns8390_offset ;  unsigned long dataport_offset ;  unsigned long ctrlport_offset ;  int ctrl_ioc ;  const char name [ 16 ] ;  u32 supported ;  unsigned char tx_start_page ;  unsigned char stop_page ; } cocci_id@p ;
...
position p;
@@
 const struct etherh_data * cocci_id@p ;
