...
position p;
@@
 enum zfcp_erp_act_result { ZFCP_ERP_SUCCEEDED = 0 , ZFCP_ERP_FAILED = 1 , ZFCP_ERP_CONTINUES = 2 , ZFCP_ERP_EXIT = 3 , ZFCP_ERP_DISMISSED = 4 , ZFCP_ERP_NOMEM = 5 , } cocci_id@p ;
...
position p;
@@
 enum zfcp_erp_act_result cocci_id@p ;
...
position p;
@@
 enum zfcp_erp_act_flags { ZFCP_STATUS_ERP_TIMEDOUT = 0x10000000 , ZFCP_STATUS_ERP_CLOSE_ONLY = 0x01000000 , ZFCP_STATUS_ERP_DISMISSED = 0x00200000 , ZFCP_STATUS_ERP_LOWMEM = 0x00400000 , ZFCP_STATUS_ERP_NO_REF = 0x00800000 , } cocci_id@p ;
...
position p;
@@
 enum zfcp_erp_act_type cocci_id@p ;
