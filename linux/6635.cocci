...
position p;
@@
 struct changer_get_element cocci_id@p ;
...
@@
 struct changer_element_status32 {  int ces_type ;  compat_uptr_t ces_data ; } cocci_id@p ;
...
position p;
@@
 struct changer_params cocci_id@p ;
...
position p;
@@
 struct changer_vendor_params cocci_id@p ;
...
position p;
@@
 struct changer_set_voltag cocci_id@p ;
...
position p;
@@
 struct changer_element_status32 cocci_id@p ;
...
position p;
@@
 struct changer_element_status cocci_id@p ;
...
typedef u_int;
@@
 struct {  struct kref ref ;  struct list_head list ;  int minor ;  char name [ 8 ] ;  struct scsi_device * device ;  struct scsi_device * * dt ;  u_int firsts [ CH_TYPES ] ;  u_int counts [ CH_TYPES ] ;  u_int unit_attention ;  u_int voltags ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct changer_position cocci_id@p ;
...
position p;
@@
 struct changer_exchange cocci_id@p ;
...
position p;
@@
 const struct {  unsigned char sense ;  unsigned char asc ;  unsigned char ascq ;  int errno ; } cocci_id@p [ ] ;
...
position p;
@@
 struct changer_move cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ CH_TYPES - 4 ] ;
