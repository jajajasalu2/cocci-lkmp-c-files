...
typedef u32;
@@
 struct sifive_spi {  void __iomem * regs ;  struct clk * clk ;  unsigned int fifo_depth ;  u32 cs_inactive ;  struct completion done ; } cocci_id@p ;
