...
position p;
@@
 struct s5p_mfc_mpeg4_enc_params * cocci_id@p ;
...
position p;
@@
 struct s5p_mfc_h264_enc_params * cocci_id@p ;
...
position p;
@@
 struct s5p_mfc_hw_ops * cocci_id@p ;
...
position p;
@@
 struct s5p_mfc_hevc_enc_params * cocci_id@p ;
...
position p;
@@
 const struct s5p_mfc_regs * cocci_id@p ;
...
position p;
@@
 struct s5p_mfc_buf_size_v6 * cocci_id@p ;
...
position p;
@@
 enum s5p_mfc_decode_arg cocci_id@p ;
...
position p;
@@
 struct s5p_mfc_vp8_enc_params * cocci_id@p ;
...
position p;
@@
 struct s5p_mfc_regs cocci_id@p ;
