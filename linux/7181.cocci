...
position p;
@@
 struct ptn5150_info {  struct device * dev ;  struct extcon_dev * edev ;  struct i2c_client * i2c ;  struct regmap * regmap ;  struct gpio_desc * int_gpiod ;  struct gpio_desc * vbus_gpiod ;  int irq ;  struct work_struct irq_work ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 enum ptn5150_reg { PTN5150_REG_DEVICE_ID = 0x01 , PTN5150_REG_CONTROL , PTN5150_REG_INT_STATUS , PTN5150_REG_CC_STATUS , PTN5150_REG_CON_DET = 0x09 , PTN5150_REG_VCONN_STATUS , PTN5150_REG_RESET , PTN5150_REG_INT_MASK = 0x18 , PTN5150_REG_INT_REG_STATUS , PTN5150_REG_END , } cocci_id@p ;
...
position p;
@@
 struct ptn5150_info cocci_id@p ;
