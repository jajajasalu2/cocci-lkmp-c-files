...
position p;
@@
 void cocci_id@p ( struct ipw_priv * priv ) ;
...
position p;
@@
 struct ipw_supported_rates * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ipw_priv * ) ;
...
position p;
@@
 struct libipw_qos_parameters * cocci_id@p ;
...
position p;
@@
 struct ipw_associate * cocci_id@p ;
...
position p;
@@
 struct libipw_rx_stats * cocci_id@p ;
...
position p;
@@
 struct ipw_rx_packet * cocci_id@p ;
...
position p;
@@
 const struct libipw_geo * cocci_id@p ;
...
position p;
@@
 struct libipw_assoc_response cocci_id@p ;
...
typedef u16;
@@
 struct ipw_status_code {  u16 status ;  const char * reason ; } cocci_id@p ;
...
position p;
@@
 struct command_block cocci_id@p ;
...
position p;
@@
 struct notif_channel_result * cocci_id@p ;
...
position p;
@@
 struct ipw_ibss_seq cocci_id@p ;
...
position p;
@@
 struct libipw_security * cocci_id@p ;
...
position p;
@@
 struct ipw_tx_power cocci_id@p ;
...
position p;
@@
 struct notif_tgi_tx_key * cocci_id@p ;
...
position p;
@@
 struct notif_calibration * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct ipw_fw {  __le32 ver ;  __le32 boot_size ;  __le32 ucode_size ;  __le32 fw_size ;  u8 data [ 0 ] ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ LIBIPW_24GHZ_CHANNELS ] ;
...
typedef u32,u16;
@@
 void cocci_id@p ( struct ipw_priv * priv , u32 reg , u16 value ) ;
...
position p;
@@
 int cocci_id@p ( struct ipw_priv * priv ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct ipw_priv * priv ) ;
...
position p;
@@
 struct ipw_network_match cocci_id@p ;
...
position p;
@@
 struct ipw_rx_queue * cocci_id@p ;
...
position p;
@@
 struct ipw_sys_config * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ipw_priv * ) ;
...
position p;
@@
 int cocci_id@p ( struct ipw_priv * priv , struct libipw_qos_parameters * qos_param ) ;
...
position p;
@@
 const struct ipw_rx_queue * cocci_id@p ;
...
typedef u8,u32;
@@
 void cocci_id@p ( struct ipw_priv * priv , u32 addr , u8 * data , int num ) ;
...
position p;
@@
 struct ipw_frag_threshold cocci_id@p ;
...
typedef u8,u32;
@@
 void cocci_id@p ( struct ipw_priv * priv , u32 reg , u8 value ) ;
...
position p;
@@
 struct libipw_hdr_3addrqos * cocci_id@p ;
...
position p;
@@
 struct ipw_error_elem * cocci_id@p ;
...
position p;
@@
 struct ipw_sensitivity_calib cocci_id@p ;
...
position p;
@@
 struct ipw_fw_error * cocci_id@p ;
...
position p;
@@
 struct libipw_qos_information_element cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ipw_priv * , struct ipw_rx_queue * ) ;
...
position p;
@@
 struct lib80211_crypt_data * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct ipw_priv * priv , u32 reg ) ;
...
position p;
@@
 struct notif_association * cocci_id@p ;
...
position p;
@@
 struct libipw_network cocci_id@p ;
...
position p;
@@
 struct ipw_rts_threshold cocci_id@p ;
...
position p;
@@
 struct libipw_hdr_4addr * cocci_id@p ;
...
position p;
@@
 const struct ipw_status_code cocci_id@p [ ] ;
...
position p;
@@
 struct ipw_rx_notification * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ipw_priv * priv , struct clx2_tx_queue * txq , int qindex ) ;
...
position p;
@@
 int cocci_id@p ( struct ipw_priv * priv , struct libipw_qos_information_element * qos_param ) ;
...
position p;
@@
 struct libipw_device * cocci_id@p ;
...
position p;
@@
 struct notif_link_deterioration * cocci_id@p ;
...
position p;
@@
 struct ipw_rx_mem_buffer cocci_id@p ;
...
position p;
@@
 struct libipw_qos_data * cocci_id@p ;
...
position p;
@@
 struct clx2_tx_queue * cocci_id@p ;
...
position p;
@@
 struct ipw_rx_frame * cocci_id@p ;
...
position p;
@@
 struct ipw_tgi_tx_key cocci_id@p ;
...
position p;
@@
 struct ieee80211_radiotap_header * cocci_id@p ;
...
position p;
@@
 struct ipw_prom_priv cocci_id@p ;
...
position p;
@@
 const struct ipw_supported_rates * cocci_id@p ;
...
position p;
@@
 struct libipw_beacon * cocci_id@p ;
...
position p;
@@
 struct notif_beacon_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ipw_priv * , int ) ;
...
position p;
@@
 const struct libipw_network * cocci_id@p ;
...
position p;
@@
 struct ipw_scan_request_ext * cocci_id@p ;
...
position p;
@@
 struct libipw_probe_response * cocci_id@p ;
...
typedef __le32;
@@
 struct fw_chunk {  __le32 address ;  __le32 length ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ipw_priv * priv , struct ipw_supported_rates * prates ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( struct ipw_priv * , u32 , u8 * , int ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct ipw_priv * priv , u32 reg , u32 value ) ;
...
position p;
@@
 int cocci_id@p ( struct ipw_priv * priv , int hcmd , void * buf , int len , int sync ) ;
...
position p;
@@
 struct notif_authenticate * cocci_id@p ;
...
position p;
@@
 struct libipw_qos_parameters cocci_id@p [ QOS_QOS_SETS ] ;
...
position p;
@@
 const struct clx2_queue * cocci_id@p ;
...
position p;
@@
 struct ipw_network_match {  struct libipw_network * network ;  struct ipw_supported_rates rates ; } cocci_id@p ;
...
position p;
@@
 struct ipw_retry_limit cocci_id@p ;
...
position p;
@@
 struct notif_scan_complete * cocci_id@p ;
...
typedef u8,u32;
@@
 u8 cocci_id@p ( struct ipw_priv * ipw , u32 reg ) ;
...
position p;
@@
 struct ipw_rx_queue * cocci_id@p ( struct ipw_priv * ) ;
...
position p;
@@
 struct ipw_fixed_rate cocci_id@p ;
...
position p;
@@
 struct ipw_station_entry cocci_id@p ;
...
position p;
@@
 struct notif_frag_length * cocci_id@p ;
