...
position p;
@@
 struct xt_cgroup_info_v1 * cocci_id@p ;
...
position p;
@@
 const struct xt_cgroup_info_v1 * cocci_id@p ;
...
position p;
@@
 struct xt_cgroup_info_v0 * cocci_id@p ;
...
position p;
@@
 struct xt_cgroup_info_v2 cocci_id@p ;
...
position p;
@@
 const struct xt_cgroup_info_v0 * cocci_id@p ;
...
position p;
@@
 const struct xt_cgroup_info_v2 * cocci_id@p ;
