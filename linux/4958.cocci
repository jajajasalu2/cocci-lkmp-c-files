...
position p;
@@
 struct qib_diag_client * cocci_id@p ;
...
position p;
@@
 struct qib_diag_xpkt cocci_id@p ;
...
position p;
@@
 struct diag_observer_list_elt * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * in , struct file * fp ) ;
...
position p;
@@
 struct diag_observer_list_elt {  struct diag_observer_list_elt * next ;  const struct diag_observer * op ; } cocci_id@p ;
...
position p;
@@
 enum diag_state { UNUSED = 0 , OPENED , INIT , READY , } cocci_id@p ;
...
typedef pid_t;
@@
 struct qib_diag_client {  struct qib_diag_client * next ;  struct qib_devdata * dd ;  pid_t pid ;  enum diag_state state ; } * cocci_id@p ;
