...
typedef bool,u32;
@@
 struct if_cs_card {  struct pcmcia_device * p_dev ;  struct lbs_private * priv ;  void __iomem * iobase ;  bool align_regs ;  u32 model ; } cocci_id@p ;
...
position p;
@@
 enum { MODEL_UNKNOWN = 0x00 , MODEL_8305 = 0x01 , MODEL_8381 = 0x02 , MODEL_8385 = 0x03 , } cocci_id@p ;
