...
position p;
@@
 struct mon_reader_text cocci_id@p ;
...
position p;
@@
 const struct mon_event_text * cocci_id@p ;
...
position p;
@@
 struct mon_iso_desc {  int status ;  unsigned int offset ;  unsigned int length ; } cocci_id@p ;
...
position p;
@@
 struct mon_event_text * cocci_id@p ( struct mon_reader_text * rp , struct file * file ) ;
...
position p;
@@
 struct mon_text_ptr cocci_id@p ;
...
position p;
@@
 struct mon_event_text * cocci_id@p ;
...
@@
 struct mon_reader_text {  struct kmem_cache * e_slab ;  int nevents ;  struct list_head e_list ;  struct mon_reader r ;  wait_queue_head_t wait ;  int printf_size ;  size_t printf_offset ;  size_t printf_togo ;  char * printf_buf ;  struct mutex printf_lock ;  char slab_name [ SLAB_NAME_SZ ] ; } cocci_id@p ;
...
position p;
@@
 const struct mon_iso_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mon_reader_text * rp , struct mon_text_ptr * p , const struct mon_event_text * ep ) ;
...
position p;
@@
 struct mon_iso_desc * cocci_id@p ;
