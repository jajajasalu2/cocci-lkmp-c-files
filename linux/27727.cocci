...
position p;
@@
 const struct fs_parameter_enum cocci_id@p [ ] ;
...
position p;
@@
 struct lm_lockstruct * cocci_id@p ;
...
position p;
@@
 struct gfs2_sb_host * cocci_id@p ;
...
position p;
@@
 struct gfs2_quota_change cocci_id@p ;
...
position p;
@@
 enum opt_data { Opt_data_writeback = GFS2_DATA_WRITEBACK , Opt_data_ordered = GFS2_DATA_ORDERED , } cocci_id@p ;
...
position p;
@@
 const struct gfs2_sb * cocci_id@p ;
...
position p;
@@
 const struct lm_lockops * cocci_id@p ;
...
position p;
@@
 struct gfs2_pcpu_lkstats cocci_id@p ;
...
position p;
@@
 enum gfs2_param { Opt_lockproto , Opt_locktable , Opt_hostdata , Opt_spectator , Opt_ignore_local_fs , Opt_localflocks , Opt_localcaching , Opt_debug , Opt_upgrade , Opt_acl , Opt_quota , Opt_suiddir , Opt_data , Opt_meta , Opt_discard , Opt_commit , Opt_errors , Opt_statfs_quantum , Opt_statfs_percent , Opt_quota_quantum , Opt_barrier , Opt_rgrplvb , Opt_loccookie , } cocci_id@p ;
...
position p;
@@
 enum opt_quota { Opt_quota_unset = 0 , Opt_quota_off , Opt_quota_account , Opt_quota_on , } cocci_id@p ;
...
position p;
@@
 struct gfs2_meta_header cocci_id@p ;
...
position p;
@@
 enum opt_errors { Opt_errors_withdraw = GFS2_ERRORS_WITHDRAW , Opt_errors_panic = GFS2_ERRORS_PANIC , } cocci_id@p ;
...
position p;
@@
 struct gfs2_log_header_host cocci_id@p ;
