...
position p;
@@
 struct jet_cmap_regs * cocci_id@p ;
...
position p;
@@
 struct mdc_cmap_regs * cocci_id@p ;
...
position p;
@@
 struct mdc_cmap_regs {  char pad1 [ 0x200200 ] ;  unsigned char addr ;  char pad2 [ 6 ] ;  unsigned char lut ; } cocci_id@p ;
...
position p;
@@
 struct toby_cmap_regs {  char pad1 [ 0x90018 ] ;  unsigned char lut ;  char pad2 [ 3 ] ;  unsigned char addr ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned int regno , unsigned int red , unsigned int green , unsigned int blue , struct fb_info * info ) ;
...
position p;
@@
 struct jet_cmap_regs {  char pad1 [ 0xe0e000 ] ;  unsigned char addr ;  unsigned char lut ; } cocci_id@p ;
...
position p;
@@
 struct toby_cmap_regs * cocci_id@p ;
