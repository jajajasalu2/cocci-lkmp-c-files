...
typedef bool,u32;
@@
 struct dp83867_private {  u32 rx_id_delay ;  u32 tx_id_delay ;  u32 fifo_depth ;  int io_impedance ;  int port_mirroring ;  bool rxctrl_strap_quirk ;  bool set_clk_output ;  u32 clk_output_sel ;  bool sgmii_ref_clk_en ; } cocci_id@p ;
...
position p;
@@
 enum { DP83867_PORT_MIRROING_KEEP , DP83867_PORT_MIRROING_EN , DP83867_PORT_MIRROING_DIS , } cocci_id@p ;
...
position p;
@@
 struct dp83867_private * cocci_id@p ;
