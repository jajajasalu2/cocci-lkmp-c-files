...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_VTI_MAX + 1 ] ;
...
position p;
@@
 struct vti6_net {  struct net_device * fb_tnl_dev ;  struct ip6_tnl __rcu * tnls_r_l [ IP6_VTI_HASH_SIZE ] ;  struct ip6_tnl __rcu * tnls_wc [ 1 ] ;  struct ip6_tnl __rcu * * tnls [ 2 ] ; } cocci_id@p ;
