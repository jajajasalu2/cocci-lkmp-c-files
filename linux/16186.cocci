...
position p;
@@
 enum FPGA_Control_Bits { FPGA_Enable_Bit = 0x8000 , } cocci_id@p ;
...
position p;
@@
 struct nidio_board {  const char * name ;  unsigned int uses_firmware : 1 ;  unsigned int dio_speed ; } cocci_id@p ;
...
position p;
@@
 const struct nidio_board cocci_id@p [ ] ;
...
position p;
@@
 enum pci_6534_firmware_registers { Firmware_Control_Register = 0x100 , Firmware_Status_Register = 0x104 , Firmware_Data_Register = 0x108 , Firmware_Mask_Register = 0x10c , Firmware_Debug_Register = 0x110 , } cocci_id@p ;
...
position p;
@@
 enum nidio_boardid { BOARD_PCIDIO_32HS , BOARD_PXI6533 , BOARD_PCI6534 , } cocci_id@p ;
...
position p;
@@
 struct nidio96_private * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct nidio96_private {  struct mite * mite ;  int boardtype ;  int dio ;  unsigned short OP_MODEBits ;  struct mite_channel * di_mite_chan ;  struct mite_ring * di_mite_ring ;  spinlock_t mite_channel_lock ; } cocci_id@p ;
