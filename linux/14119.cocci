...
position p;
@@
 struct deinterlace_q_data * cocci_id@p ;
...
position p;
@@
 struct deinterlace_ctx * cocci_id@p ;
...
position p;
@@
 struct vb2_dc_conf {  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 enum { YUV420_DMA_Y_ODD , YUV420_DMA_Y_EVEN , YUV420_DMA_U_ODD , YUV420_DMA_U_EVEN , YUV420_DMA_V_ODD , YUV420_DMA_V_EVEN , YUV420_DMA_Y_ODD_DOUBLING , YUV420_DMA_U_ODD_DOUBLING , YUV420_DMA_V_ODD_DOUBLING , YUYV_DMA_ODD , YUYV_DMA_EVEN , YUYV_DMA_EVEN_DOUBLING , } cocci_id@p ;
...
@@
 struct deinterlace_ctx {  struct v4l2_fh fh ;  struct deinterlace_dev * dev ;  int aborting ;  enum v4l2_colorspace colorspace ;  dma_cookie_t cookie ;  struct dma_interleaved_template * xt ; } cocci_id@p ;
...
position p;
@@
 struct deinterlace_q_data {  unsigned int width ;  unsigned int height ;  unsigned int sizeimage ;  struct deinterlace_fmt * fmt ;  enum v4l2_field field ; } cocci_id@p ;
...
position p;
@@
 struct deinterlace_fmt * cocci_id@p ;
...
position p;
@@
 struct deinterlace_dev * cocci_id@p ;
...
position p;
@@
 struct deinterlace_q_data cocci_id@p [ 2 ] ;
...
@@
 struct deinterlace_dev {  struct v4l2_device v4l2_dev ;  struct video_device vfd ;  atomic_t busy ;  struct mutex dev_mutex ;  spinlock_t irqlock ;  struct dma_chan * dma_chan ;  struct v4l2_m2m_dev * m2m_dev ; } cocci_id@p ;
...
typedef u32;
@@
 struct deinterlace_fmt {  u32 fourcc ;  u32 types ; } cocci_id@p ;
