...
position p;
@@
 const struct pmc_clk_data * cocci_id@p ;
...
position p;
@@
 struct clk_plt_fixed {  struct clk_hw * clk ;  struct clk_lookup * lookup ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct clk_plt {  struct clk_hw hw ;  void __iomem * reg ;  struct clk_lookup * lookup ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u8;
@@
 struct clk_plt_data {  struct clk_plt_fixed * * parents ;  u8 nparents ;  struct clk_plt * clks [ PMC_CLK_NUM ] ;  struct clk_lookup * mclk_lookup ;  struct clk_lookup * ether_clk_lookup ; } cocci_id@p ;
...
position p;
@@
 struct clk_plt_fixed * cocci_id@p ;
...
position p;
@@
 struct clk_plt_data * cocci_id@p ;
...
position p;
@@
 const struct pmc_clk * cocci_id@p ;
