...
position p;
@@
 struct fdtv_ir_context {  struct fw_iso_context * context ;  struct fw_iso_buffer buffer ;  int interrupt_packet ;  int current_packet ;  char * pages [ N_PAGES ] ; } cocci_id@p ;
...
position p;
@@
 struct fdtv_ir_context * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_MODEL_NAME_LEN ] ;
