...
position p;
@@
 union dw_i2s_snd_dma_data * cocci_id@p ;
...
position p;
@@
 struct i2s_clk_config_data * cocci_id@p ;
...
position p;
@@
 const struct i2s_platform_data * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ COMP_MAX_WORDSIZE ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ COMP_MAX_DATA_WIDTH ] ;
