...
symbol cocci_id;
position p;
typedef bool,u32,atomic_t,spinlock_t;
@@
 struct virtio_vsock {  struct virtio_device * vdev ;  struct virtqueue * vqs [ VSOCK_VQ_MAX ] ;  struct work_struct tx_work ;  struct work_struct rx_work ;  struct work_struct event_work ;  struct mutex tx_lock ;  bool tx_run ;  struct work_struct send_pkt_work ;  spinlock_t send_pkt_list_lock ;  struct list_head send_pkt_list ;  struct work_struct loopback_work ;  spinlock_t loopback_list_lock ;  struct list_head loopback_list ;  atomic_t queued_replies ;  struct mutex rx_lock ;  bool rx_run ;  int rx_buf_nr ;  int rx_buf_max_nr ;  struct mutex event_lock ;  bool event_run ;  struct virtio_vsock_event event_list [ 8 ] ;  u32 guest_cid ; } cocci_id@p ;
...
position p;
@@
 struct virtio_vsock_event * cocci_id@p ;
...
position p;
@@
 struct virtio_vsock_config cocci_id@p ;
...
position p;
@@
 struct virtio_transport cocci_id@p ;
...
position p;
@@
 struct virtio_vsock cocci_id@p ;
...
position p;
@@
 struct virtio_vsock_pkt cocci_id@p ;
