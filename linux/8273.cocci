...
position p;
@@
 struct tenxpress_phy_data {  enum ef4_loopback_mode loopback_mode ;  enum ef4_phy_mode phy_mode ;  int bad_lp_tries ; } cocci_id@p ;
...
position p;
@@
 struct tenxpress_phy_data * cocci_id@p ;
