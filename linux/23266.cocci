...
position p;
@@
 struct max98373_priv * cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( max98373_dht_spkgain_min_tlv , 
							      0 , 9 , 
...
position p;
@@
 const  cocci_id@p ( max98373_dht_step_size_tlv , 
							      0 , 1 , 
							      TLV_DB_SCALE_ITEM ( 25 , 25 , 0 ) , 
							      2 , 4 , 
...
position p;
@@
 const  cocci_id@p ( max98373_spk_tlv , 
							      0 , 8 , 
...
position p;
@@
 const  cocci_id@p ( max98373_dht_rotation_point_tlv , 
							      0 , 1 , 
							      TLV_DB_SCALE_ITEM ( - 3000 , 500 , 0 ) , 
							      2 , 4 , 
							      TLV_DB_SCALE_ITEM ( - 2200 , 200 , 0 ) , 
							      5 , 6 , 
							      TLV_DB_SCALE_ITEM ( - 1500 , 300 , 0 ) , 
							      7 , 9 , 
							      TLV_DB_SCALE_ITEM ( - 1000 , 200 , 0 ) , 
							      10 , 13 , 
							      TLV_DB_SCALE_ITEM ( - 500 , 100 , 0 ) , 
							      14 , 15 , 
							      TLV_DB_SCALE_ITEM ( - 100 , 50 , 0 ) ) ;
...
position p;
@@
 const  cocci_id@p ( max98373_bde_gain_tlv , 
							      0 , 60 , 
							      TLV_DB_SCALE_ITEM ( - 1500 , 25 , 0 ) ) ;
...
position p;
@@
 const  cocci_id@p ( max98373_spkgain_max_tlv , 
							      0 , 9 , 
							      TLV_DB_SCALE_ITEM ( 800 , 100 , 0 ) ) ;
...
position p;
@@
 const  cocci_id@p ( max98373_limiter_thresh_tlv , 
							      0 , 15 , 
							      TLV_DB_SCALE_ITEM ( - 1500 , 100 , 0 ) ) ;
