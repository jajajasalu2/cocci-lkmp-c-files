...
position p;
@@
 struct xpc_activate_mq_msg_chctl_openrequest_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_notify_mq_msg_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_send_msg_slot_uv cocci_id@p ;
...
position p;
@@
 struct xpc_activate_mq_msg_chctl_opencomplete_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_gru_mq_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_activate_mq_msghdr_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_partition_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_channel_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_activate_mq_msg_chctl_closereply_uv cocci_id@p ;
...
position p;
@@
 struct xpc_partition * cocci_id@p ;
...
position p;
@@
 struct xpc_activate_mq_msg_chctl_closerequest_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_heartbeat_uv * cocci_id@p ;
...
position p;
@@
 struct uv_IO_APIC_route_entry * cocci_id@p ;
...
position p;
@@
 struct xpc_notify_mq_msghdr_uv cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ XPC_NOTIFY_MSG_SIZE_UV ] ;
...
position p;
@@
 struct xpc_activate_mq_msg_deactivate_req_uv cocci_id@p ;
...
position p;
@@
 struct xpc_openclose_args * cocci_id@p ;
...
position p;
@@
 struct xpc_rsvd_page * cocci_id@p ;
...
position p;
@@
 union xpc_channel_ctl_flags cocci_id@p ;
...
position p;
@@
 struct xpc_fifo_entry_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_activate_mq_msg_uv cocci_id@p ;
...
position p;
@@
 struct xpc_fifo_head_uv * cocci_id@p ;
...
position p;
@@
 struct xpc_activate_mq_msg_chctl_openreply_uv * cocci_id@p ;
...
position p;
@@
 struct gru_message_queue_desc cocci_id@p ;
...
position p;
@@
 struct xpc_activate_mq_msg_activate_req_uv * cocci_id@p ;
...
position p;
@@
 const struct xpc_arch_operations cocci_id@p ;
