...
position p;
@@
 const struct tps6521x_data cocci_id@p ;
...
position p;
@@
 struct tps6521x_data {  unsigned int reg_status ;  unsigned int pb_mask ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct tps6521x_pwrbutton * cocci_id@p ;
...
position p;
@@
 struct tps6521x_pwrbutton {  struct device * dev ;  struct regmap * regmap ;  struct input_dev * idev ;  const struct tps6521x_data * data ;  char phys [ 32 ] ; } cocci_id@p ;
