...
position p;
@@
 struct pic32_sdhci_priv * cocci_id@p ;
...
position p;
@@
 struct pic32_sdhci_priv {  struct platform_device * pdev ;  struct clk * sys_clk ;  struct clk * base_clk ; } cocci_id@p ;
...
position p;
@@
 struct pic32_sdhci_platform_data * cocci_id@p ;
