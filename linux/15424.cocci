...
position p;
@@
 const struct s3c2410_wdt_variant cocci_id@p ;
...
typedef u32;
@@
 struct s3c2410_wdt_variant {  int disable_reg ;  int mask_reset_reg ;  int mask_bit ;  int rst_stat_reg ;  int rst_stat_bit ;  u32 quirks ; } cocci_id@p ;
...
position p;
@@
 const struct watchdog_device cocci_id@p ;
...
position p;
@@
 struct s3c2410_wdt_variant * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct s3c2410_wdt {  struct device * dev ;  struct clk * clock ;  void __iomem * reg_base ;  unsigned int count ;  spinlock_t lock ;  unsigned long wtcon_save ;  unsigned long wtdat_save ;  struct watchdog_device wdt_device ;  struct notifier_block freq_transition ;  const struct s3c2410_wdt_variant * drv_data ;  struct regmap * pmureg ; } cocci_id@p ;
