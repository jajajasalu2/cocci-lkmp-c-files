...
typedef u16;
@@
 struct ssp_msg {  u16 length ;  u16 options ;  struct list_head list ;  struct completion * done ;  struct ssp_msg_header * h ;  char * buffer ; } cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ SSP_SENSOR_MAX ] ;
...
position p;
@@
 struct ssp_sensor_data * cocci_id@p ;
...
position p;
@@
 struct ssp_msg_header cocci_id@p ;
