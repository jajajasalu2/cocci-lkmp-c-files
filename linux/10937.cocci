...
position p;
@@
 struct amdgpu_backlight_privdata cocci_id@p ;
...
position p;
@@
 union dig_encoder_control {  DIG_ENCODER_CONTROL_PS_ALLOCATION v1 ;  DIG_ENCODER_CONTROL_PARAMETERS_V2 v2 ;  DIG_ENCODER_CONTROL_PARAMETERS_V3 v3 ;  DIG_ENCODER_CONTROL_PARAMETERS_V4 v4 ;  DIG_ENCODER_CONTROL_PARAMETERS_V5 v5 ; } cocci_id@p ;
...
position p;
@@
 union crtc_source_param {  SELECT_CRTC_SOURCE_PS_ALLOCATION v1 ;  SELECT_CRTC_SOURCE_PARAMETERS_V2 v2 ;  SELECT_CRTC_SOURCE_PARAMETERS_V3 v3 ; } cocci_id@p ;
...
position p;
@@
 union dig_transmitter_control {  DIG_TRANSMITTER_CONTROL_PS_ALLOCATION v1 ;  DIG_TRANSMITTER_CONTROL_PARAMETERS_V2 v2 ;  DIG_TRANSMITTER_CONTROL_PARAMETERS_V3 v3 ;  DIG_TRANSMITTER_CONTROL_PARAMETERS_V4 v4 ;  DIG_TRANSMITTER_CONTROL_PARAMETERS_V1_5 v5 ;  DIG_TRANSMITTER_CONTROL_PARAMETERS_V1_6 v6 ; } cocci_id@p ;
...
position p;
@@
 struct amdgpu_connector_atom_dig * cocci_id@p ;
...
position p;
@@
 struct amdgpu_legacy_backlight_privdata * cocci_id@p ;
