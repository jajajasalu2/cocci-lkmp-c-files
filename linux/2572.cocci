...
position p;
@@
 struct sync_io {  unsigned long error_bits ;  struct completion wait ; } cocci_id@p ;
...
position p;
@@
 struct dm_io_client * cocci_id@p ;
...
position p;
@@
 struct dpages {  void ( * get_page ) ( struct dpages * dp , struct page * * p , unsigned long * len , unsigned * offset ) ;  void ( * next_page ) ( struct dpages * dp ) ;  union {  unsigned context_u ;  struct bvec_iter context_bi ; } ;  void * context_ptr ;  void * vma_invalidate_address ;  unsigned long vma_invalidate_size ; } cocci_id@p ;
...
typedef mempool_t;
@@
 struct dm_io_client {  mempool_t pool ;  struct bio_set bios ; } cocci_id@p ;
