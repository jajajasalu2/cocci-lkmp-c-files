...
typedef spinlock_t;
@@
 struct f81601_pci_card {  void __iomem * addr ;  spinlock_t lock ;  struct pci_dev * dev ;  struct net_device * net_dev [ F81601_PCI_MAX_CHAN ] ; } cocci_id@p ;
...
position p;
@@
 struct f81601_pci_card * cocci_id@p ;
