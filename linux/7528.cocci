...
position p;
@@
 struct atmel_lcdfb_power_ctrl_gpio {  struct gpio_desc * gpiod ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct atmel_lcdfb_info * cocci_id@p ;
...
typedef bool;
@@
 struct atmel_lcdfb_config {  bool have_alt_pixclock ;  bool have_hozval ;  bool have_intensity_bit ; } cocci_id@p ;
...
position p;
@@
 struct atmel_lcdfb_config * cocci_id@p ;
...
position p;
@@
 struct atmel_lcdfb_power_ctrl_gpio * cocci_id@p ;
...
position p;
@@
 struct atmel_lcdfb_pdata * cocci_id@p ;
