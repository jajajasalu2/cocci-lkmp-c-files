...
typedef u8,u64,u32;
@@
 struct prno_ws_s {  u32 res ;  u32 reseed_counter ;  u64 stream_bytes ;  u8 V [ 112 ] ;  u8 C [ 112 ] ; } cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct prng_ws_s {  u8 parm_block [ 32 ] ;  u32 reseed_counter ;  u64 byte_counter ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct prng_data_s {  struct mutex mutex ;  union {  struct prng_ws_s prngws ;  struct prno_ws_s prnows ; } ;  u8 * buf ;  u32 rest ;  u8 * prev ; } cocci_id@p ;
