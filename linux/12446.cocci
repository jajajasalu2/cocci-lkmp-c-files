...
position p;
@@
 struct drm_panfrost_mmap_bo * cocci_id@p ;
...
position p;
@@
 struct drm_panfrost_madvise * cocci_id@p ;
...
position p;
@@
 struct panfrost_gem_object * cocci_id@p ;
...
position p;
@@
 struct drm_panfrost_wait_bo * cocci_id@p ;
...
position p;
@@
 struct drm_panfrost_create_bo * cocci_id@p ;
...
position p;
@@
 struct drm_panfrost_get_param * cocci_id@p ;
...
position p;
@@
 struct drm_panfrost_get_bo_offset * cocci_id@p ;
...
position p;
@@
 struct drm_panfrost_submit * cocci_id@p ;
