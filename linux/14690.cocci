...
position p;
@@
 struct uniphier_clk_cpugear cocci_id@p ;
...
position p;
@@
 struct uniphier_clk_cpugear {  struct clk_hw hw ;  struct regmap * regmap ;  unsigned int regbase ;  unsigned int mask ; } cocci_id@p ;
...
position p;
@@
 const struct uniphier_clk_cpugear_data * cocci_id@p ;
