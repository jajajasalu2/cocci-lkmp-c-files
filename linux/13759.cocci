...
typedef u32;
@@
 const struct vs6624_format {  u32 mbus_code ;  enum v4l2_colorspace colorspace ; } cocci_id@p [ ] ;
...
position p;
@@
 struct vs6624 {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  struct v4l2_fract frame_rate ;  struct v4l2_mbus_framefmt fmt ;  unsigned ce_pin ; } cocci_id@p ;
