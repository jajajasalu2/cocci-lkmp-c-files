...
position p;
@@
 struct maceps2_data * cocci_id@p ;
...
position p;
@@
 struct maceps2_data {  struct mace_ps2port * port ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct mace_ps2port * cocci_id@p ;
...
position p;
@@
 struct maceps2_data cocci_id@p [ 2 ] ;
