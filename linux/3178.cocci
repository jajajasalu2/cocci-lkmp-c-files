...
position p;
@@
 struct smsc47m192_data cocci_id@p ;
...
typedef s8,u8,u16;
@@
 struct smsc47m192_data {  struct i2c_client * client ;  const struct attribute_group * groups [ 3 ] ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u8 in [ 8 ] ;  u8 in_max [ 8 ] ;  u8 in_min [ 8 ] ;  s8 temp [ 3 ] ;  s8 temp_max [ 3 ] ;  s8 temp_min [ 3 ] ;  s8 temp_offset [ 3 ] ;  u16 alarms ;  u8 vid ;  u8 vrm ; } cocci_id@p ;
