...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct rvt_qp * qp , struct ib_other_headers * ohdr , u32 bth0 , u32 bth1 , u32 bth2 , int middle , struct hfi1_pkt_state * ps ) ;
...
position p;
@@
 const hfi1_make_ruc_hdr cocci_id@p [ 2 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rvt_qp * qp , struct hfi1_pkt_state * ps ) ;
