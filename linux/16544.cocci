...
position p;
@@
 struct dasd_eer_header cocci_id@p ;
...
position p;
@@
 struct eerbuffer {  struct list_head list ;  char * * buffer ;  int buffersize ;  int buffer_page_count ;  int head ;  int tail ;  int residual ; } cocci_id@p ;
