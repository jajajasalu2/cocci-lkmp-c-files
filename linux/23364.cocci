...
position p;
@@
 const struct sti_sas_dev_data cocci_id@p ;
...
position p;
@@
 struct sti_sas_data * cocci_id@p ;
...
position p;
@@
 struct sti_sas_data {  struct device * dev ;  const struct sti_sas_dev_data * dev_data ;  struct sti_dac_audio dac ;  struct sti_spdif_audio spdif ; } cocci_id@p ;
...
position p;
@@
 struct sti_spdif_audio {  struct regmap * regmap ;  struct regmap_field * * field ;  int mclk ; } cocci_id@p ;
...
position p;
@@
 struct sti_dac_audio {  struct regmap * regmap ;  struct regmap * virt_regmap ;  struct regmap_field * * field ;  struct reset_control * rst ;  int mclk ; } cocci_id@p ;
...
position p;
@@
 enum { STI_SAS_DAI_SPDIF_OUT , STI_SAS_DAI_ANALOG_OUT , } cocci_id@p ;
...
position p;
@@
 struct sti_sas_dev_data {  const struct regmap_config * regmap ;  const struct snd_soc_dai_ops * dac_ops ;  const struct snd_soc_dapm_widget * dapm_widgets ;  const int num_dapm_widgets ;  const struct snd_soc_dapm_route * dapm_routes ;  const int num_dapm_routes ; } cocci_id@p ;
...
position p;
@@
 struct sti_sas_dev_data * cocci_id@p ;
