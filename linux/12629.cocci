...
typedef bool;
@@
 bool cocci_id@p ( struct msm_gpu * gpu ) ;
...
position p;
@@
 const struct msm_gpu_perfcntr cocci_id@p [ ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ REG_ADRENO_REGISTER_MAX ] ;
