...
position p;
@@
 struct ice_sw_rule_lg_act * cocci_id@p ;
...
position p;
@@
 struct ice_fltr_list_entry * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_sw_rules_elem cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_sw_cfg_resp_elem * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_sw_cfg_resp * cocci_id@p ;
...
position p;
@@
 struct ice_sw_rule_vsi_list * cocci_id@p ;
...
position p;
@@
 struct ice_fltr_info cocci_id@p ;
...
position p;
@@
 struct ice_aqc_alloc_free_res_cmd * cocci_id@p ;
...
position p;
@@
 enum ice_sw_lkup_type cocci_id@p ;
...
position p;
@@
 struct ice_aqc_add_update_free_vsi_resp * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_alloc_free_res_elem * cocci_id@p ;
...
position p;
@@
 struct ice_sw_rule_lkup_rx_tx cocci_id@p ;
...
position p;
@@
 enum { UCAST_FLTR = 1 , MCAST_FLTR , BCAST_FLTR , } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ DUMMY_ETH_HDR_LEN ] ;
...
position p;
@@
 struct ice_aqc_res_elem * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_add_get_update_free_vsi * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_sw_cfg * cocci_id@p ;
