...
position p;
@@
 struct sdram_params cocci_id@p ;
...
typedef u_int;
@@
 struct sdram_info {  u_int mdcnfg ;  u_int mdrefr ;  u_int mdcas [ 3 ] ; } cocci_id@p ;
...
@@
 struct sdram_params {  const char name [ 20 ] ;  u_char rows ;  u_char cas_latency ;  u_char tck ;  u_char trcd ;  u_char trp ;  u_char twr ;  u_short refresh ; } cocci_id@p ;
