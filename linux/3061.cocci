...
position p;
@@
 enum nullb_device_flags { NULLB_DEV_FL_CONFIGURED = 0 , NULLB_DEV_FL_UP = 1 , NULLB_DEV_FL_THROTTLED = 2 , NULLB_DEV_FL_CACHE = 3 , } cocci_id@p ;
...
position p;
@@
 struct nullb_device cocci_id@p ;
...
position p;
@@
 struct radix_tree_root * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nullb * nullb ) ;
...
position p;
@@
 enum { NULL_Q_BIO = 0 , NULL_Q_RQ = 1 , NULL_Q_MQ = 2 , } cocci_id@p ;
...
position p;
@@
 struct nullb_page * cocci_id@p [ FREE_BATCH ] ;
...
position p;
@@
 struct nullb_page {  struct page * page ; 
...
typedef bool;
@@
 void cocci_id@p ( struct nullb_device * dev , bool is_cache ) ;
...
position p;
@@
 struct nullb_device * cocci_id@p ( void ) ;
...
position p;
@@
 void cocci_id@p ( struct nullb_device * dev ) ;
...
position p;
@@
 enum hrtimer_restart cocci_id@p ( struct hrtimer * timer ) ;
...
position p;
@@
 int cocci_id@p ( struct nullb_device * dev ) ;
...
position p;
@@
 enum { NULL_IRQ_NONE = 0 , NULL_IRQ_SOFTIRQ = 1 , NULL_IRQ_TIMER = 2 , } cocci_id@p ;
