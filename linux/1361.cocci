...
typedef u8;
@@
 struct appledisplay {  struct usb_device * udev ;  struct urb * urb ;  struct backlight_device * bd ;  u8 * urbdata ;  u8 * msgdata ;  struct delayed_work work ;  int button_pressed ;  struct mutex sysfslock ; } cocci_id@p ;
...
position p;
@@
 struct appledisplay * cocci_id@p ;
