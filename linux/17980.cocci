...
position p;
@@
 struct leon_1insn_patch_entry {  unsigned int addr ;  unsigned int insn ; } cocci_id@p ;
...
position p;
@@
 struct linux_romvec * cocci_id@p ;
...
position p;
@@
 struct cpuid_patch_entry cocci_id@p ;
...
position p;
@@
 struct leon_1insn_patch_entry * cocci_id@p ;
...
position p;
@@
 struct cpuid_patch_entry {  unsigned int addr ;  unsigned int sun4d [ 3 ] ;  unsigned int leon [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ COMMAND_LINE_SIZE ] ;
