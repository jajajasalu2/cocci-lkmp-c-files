...
position p;
@@
 struct imx_port_ucrs cocci_id@p ;
...
position p;
@@
 struct imx_port * cocci_id@p [ UART_NR ] ;
...
position p;
@@
 enum imx_uart_type { IMX1_UART , IMX21_UART , IMX53_UART , IMX6Q_UART , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct imx_port * sport ) ;
...
position p;
@@
 struct imxuart_platform_data * cocci_id@p ;
...
position p;
@@
 struct imx_uart_data * cocci_id@p ;
...
position p;
@@
 struct imx_port_ucrs {  unsigned int ucr1 ;  unsigned int ucr2 ;  unsigned int ucr3 ; } cocci_id@p ;
...
position p;
@@
 struct imx_uart_data {  unsigned uts_reg ;  enum imx_uart_type devtype ; } cocci_id@p ;
