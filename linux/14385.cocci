...
position p;
@@
 enum cxd2880_dvbt_hierarchy cocci_id@p ;
...
position p;
@@
 enum cxd2880_dvbt_constellation cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cxd2880_tnrdmd * tnr_dmd ) ;
...
position p;
@@
 enum cxd2880_dvbt_coderate cocci_id@p ;
