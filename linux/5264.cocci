...
position p;
@@
 enum { CFR = 0x50 , CNTRL = 0x51 , CMDTIM = 0x52 , ARTIM0 = 0x53 , DRWTIM0 = 0x54 , ARTIM23 = 0x57 , DRWTIM23 = 0x58 , BRST = 0x59 , } cocci_id@p ;
...
typedef u8;
@@
 struct cmd640_reg {  int last ;  u8 reg58 [ ATA_MAX_DEVICES ] ; } cocci_id@p ;
