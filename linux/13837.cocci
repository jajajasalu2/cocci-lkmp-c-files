...
position p;
@@
 struct smssdio_device cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smscore_buffer_t,smscore_device_t;
@@
 struct smssdio_device {  struct sdio_func * func ;  struct smscore_device_t * coredev ;  struct smscore_buffer_t * split_cb ; } cocci_id@p ;
