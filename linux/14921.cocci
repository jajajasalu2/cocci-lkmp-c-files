...
position p;
@@
 struct sun9i_a80_cpus_clk {  struct clk_hw hw ;  void __iomem * reg ; } cocci_id@p ;
...
position p;
@@
 struct sun9i_a80_cpus_clk cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ SUN9I_CPUS_MAX_PARENTS ] ;
