...
position p;
@@
 enum ieee80211_vht_chanwidth cocci_id@p ;
...
position p;
@@
 enum ieee80211_rate_flags cocci_id@p ;
...
position p;
@@
 struct cfg80211_event cocci_id@p ;
...
position p;
@@
 struct iapp_layer2_update * cocci_id@p ;
...
position p;
@@
 enum ieee80211_p2p_attr_id cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( const struct ieee80211_iface_combination * c , void * data ) ;
