...
position p;
@@
 enum hw_breakpoint_ops cocci_id@p ;
...
position p;
@@
 enum hw_breakpoint_ops { HW_BREAKPOINT_INSTALL , HW_BREAKPOINT_UNINSTALL , HW_BREAKPOINT_RESTORE , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int ( * hw_bp_restore ) ( unsigned int ) ) ;
