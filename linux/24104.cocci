...
position p;
@@
 struct svc_rdma_recv_ctxt * cocci_id@p ;
...
position p;
@@
 struct svc_rdma_rw_ctxt * cocci_id@p ;
...
position p;
@@
 struct svc_rdma_write_info cocci_id@p ;
...
position p;
@@
 struct svcxprt_rdma * cocci_id@p ;
...
position p;
@@
 struct svc_rdma_read_info {  struct svc_rdma_recv_ctxt * ri_readctxt ;  unsigned int ri_position ;  unsigned int ri_pageno ;  unsigned int ri_pageoff ;  unsigned int ri_chunklen ;  struct svc_rdma_chunk_ctxt ri_cc ; } cocci_id@p ;
...
position p;
@@
 struct svc_rdma_chunk_ctxt cocci_id@p ;
...
position p;
@@
 struct svc_rdma_write_info {  unsigned int wi_seg_off ;  unsigned int wi_seg_no ;  unsigned int wi_nsegs ;  __be32 * wi_segs ;  struct xdr_buf * wi_xdr ;  unsigned char * wi_base ;  unsigned int wi_next_off ;  struct svc_rdma_chunk_ctxt wi_cc ; } cocci_id@p ;
...
position p;
@@
 struct svc_rdma_read_info cocci_id@p ;
...
position p;
@@
 struct svc_rdma_chunk_ctxt {  struct ib_cqe cc_cqe ;  struct svcxprt_rdma * cc_rdma ;  struct list_head cc_rwctxts ;  int cc_sqecount ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct svc_rdma_write_info * info , unsigned int len , struct svc_rdma_rw_ctxt * ctxt ) ;
...
position p;
@@
 struct svc_rdma_rw_ctxt {  struct list_head rw_list ;  struct rdma_rw_ctx rw_ctx ;  int rw_nents ;  struct sg_table rw_sg_table ;  struct scatterlist rw_first_sgl [ 0 ] ; } cocci_id@p ;
