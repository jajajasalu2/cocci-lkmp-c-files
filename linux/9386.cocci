...
position p;
@@
 const struct mt76x0_bbp_switch_item * cocci_id@p ;
...
position p;
@@
 const struct mt76x0_freq_item * cocci_id@p ;
...
position p;
@@
 const struct mt76x0_rf_switch_item * cocci_id@p ;
...
position p;
@@
 enum { BW_20 = 0 , BW_40 = 1 , BW_80 = 2 , BW_10 = 4 , } cocci_id@p ;
