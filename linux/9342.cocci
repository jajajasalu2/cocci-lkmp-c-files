...
position p;
@@
 struct wl18xx_static_data_priv * cocci_id@p ;
...
position p;
@@
 struct wl18xx_mac_and_phy_params * cocci_id@p ;
...
position p;
@@
 struct wl1271_rx_descriptor * cocci_id@p ;
...
position p;
@@
 struct wl18xx_fw_status_priv cocci_id@p ;
...
position p;
@@
 struct wl18xx_fw_status * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct wl1271 * wl ) ;
...
position p;
@@
 struct wlcore_conf_file * cocci_id@p ;
...
position p;
@@
 const struct wlcore_partition_set cocci_id@p [ PART_TABLE_LEN ] ;
...
position p;
@@
 const int cocci_id@p [ REG_TABLE_LEN ] ;
...
position p;
@@
 struct wl18xx_acx_statistics cocci_id@p ;
...
position p;
@@
 const struct wl18xx_clk_cfg cocci_id@p [ NUM_CLOCK_CONFIGS ] ;
...
position p;
@@
 struct wl18xx_priv_conf * cocci_id@p ;
...
position p;
@@
 enum wl_rx_buf_align cocci_id@p ;
...
position p;
@@
 struct wl18xx_event_mailbox cocci_id@p ;
...
position p;
@@
 struct wl1271_static_data * cocci_id@p ;
...
position p;
@@
 enum wl18xx_rdl_num cocci_id@p ;
