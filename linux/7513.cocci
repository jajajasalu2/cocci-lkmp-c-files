...
position p;
@@
 struct viafb_vx855_dma_descr * cocci_id@p ;
...
typedef u32;
@@
 struct viafb_vx855_dma_descr {  u32 addr_low ;  u32 addr_high ;  u32 fb_offset ;  u32 seg_size ;  u32 tile_mode ;  u32 next_desc_low ;  u32 next_desc_high ;  u32 pad ; } cocci_id@p ;
...
position p;
@@
 struct viafb_subdev_info {  char * name ;  struct platform_device * platdev ; } cocci_id@p [ ] ;
...
position p;
@@
 struct viafb_subdev_info * cocci_id@p ;
