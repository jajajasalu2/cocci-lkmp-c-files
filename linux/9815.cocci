...
position p;
@@
 struct ath5k_hw_tx_status * cocci_id@p ;
...
position p;
@@
 struct ath5k_hw_rx_status * cocci_id@p ;
...
position p;
@@
 struct ath5k_hw_5210_tx_desc cocci_id@p ;
...
position p;
@@
 struct ath5k_hw_4w_tx_ctl * cocci_id@p ;
...
position p;
@@
 struct ath5k_hw_2w_tx_ctl * cocci_id@p ;
...
position p;
@@
 struct ath5k_hw_rx_ctl * cocci_id@p ;
