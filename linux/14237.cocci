...
typedef u32;
@@
 struct stih_cec {  struct cec_adapter * adap ;  struct device * dev ;  struct clk * clk ;  void __iomem * regs ;  int irq ;  u32 irq_status ;  struct cec_notifier * notifier ; } cocci_id@p ;
