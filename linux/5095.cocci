...
position p;
@@
 const struct mrfld_gpio_pinrange * cocci_id@p ;
...
position p;
@@
 struct mrfld_gpio_pinrange {  unsigned int gpio_base ;  unsigned int pin_base ;  unsigned int npins ; } cocci_id@p ;
...
@@
 struct mrfld_gpio {  struct gpio_chip chip ;  void __iomem * reg_base ;  raw_spinlock_t lock ;  struct device * dev ; } cocci_id@p ;
