...
position p;
@@
 struct asc7621_data * cocci_id@p ;
...
position p;
@@
 struct asc7621_data * cocci_id@p ( struct device * dev ) ;
...
typedef u8;
@@
 struct asc7621_data {  struct i2c_client client ;  struct device * class_dev ;  struct mutex update_lock ;  int valid ;  unsigned long last_high_reading ;  unsigned long last_low_reading ;  u8 reg [ LAST_REGISTER + 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct asc7621_param cocci_id@p ;
...
typedef u8;
@@
 struct asc7621_chip {  char * name ;  enum asc7621_type chip_type ;  u8 company_reg ;  u8 company_id ;  u8 verstep_reg ;  u8 verstep_id ;  const unsigned short * addresses ; } cocci_id@p ;
...
typedef u8;
@@
 struct asc7621_param {  struct sensor_device_attribute sda ;  u8 priority ;  u8 msb [ 3 ] ;  u8 lsb [ 3 ] ;  u8 mask [ 3 ] ;  u8 shift [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct asc7621_chip cocci_id@p [ ] ;
...
position p;
@@
 enum asc7621_type { asc7621 , asc7621a , } cocci_id@p ;
