...
position p;
@@
 const struct ef4_channel * cocci_id@p ;
...
position p;
@@
 struct ef4_rx_page_state cocci_id@p ;
...
position p;
@@
 const struct ef4_phy_operations cocci_id@p ;
...
position p;
@@
 const struct ef4_channel_type cocci_id@p ;
...
position p;
@@
 struct ef4_channel * cocci_id@p [ EF4_MAX_CHANNELS ] ;
...
position p;
@@
 struct msix_entry cocci_id@p [ EF4_MAX_CHANNELS ] ;
...
position p;
@@
 int cocci_id@p ( struct ef4_nic * efx ) ;
...
position p;
@@
 void cocci_id@p ( struct ef4_channel * channel ) ;
