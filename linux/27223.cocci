...
position p;
@@
 struct dx_countlimit * cocci_id@p ;
...
position p;
@@
 const struct unicode_map * cocci_id@p ;
...
position p;
@@
 struct ext4_dir_entry_2 * cocci_id@p ;
...
position p;
@@
 struct dx_root_info cocci_id@p ;
...
position p;
@@
 struct dx_node {  struct fake_dirent fake ;  struct dx_entry entries [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct ext4_dir_entry_2 * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct fake_dirent {  __le32 inode ;  __le16 rec_len ;  u8 name_len ;  u8 file_type ; } cocci_id@p ;
...
position p;
@@
 unsigned cocci_id@p ( struct dx_entry * entry ) ;
...
position p;
@@
 struct ext4_dir_entry_tail cocci_id@p ;
...
typedef __u32;
@@
 int cocci_id@p ( struct inode * dir , __u32 hash , struct dx_frame * frame , struct dx_frame * frames , __u32 * start_hash ) ;
...
position p;
@@
 const struct ext4_sb_info * cocci_id@p ;
...
position p;
@@
 struct ext4_filename * cocci_id@p ;
...
position p;
@@
 struct dx_frame * cocci_id@p ( struct ext4_filename * fname , struct inode * dir , struct dx_hash_info * hinfo , struct dx_frame * frame ) ;
...
position p;
@@
 struct dx_frame {  struct buffer_head * bh ;  struct dx_entry * entries ;  struct dx_entry * at ; } cocci_id@p ;
...
position p;
@@
 struct ext4_dir_entry * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct ext4_dir_entry * dirent ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * dir , struct ext4_dir_entry_2 * de , unsigned blocksize , struct dx_hash_info * hinfo , struct dx_map_entry map [ ] ) ;
...
typedef handle_t;
@@
 int cocci_id@p ( handle_t * handle , struct ext4_filename * fname , struct inode * dir , struct inode * inode ) ;
...
position p;
@@
 struct dx_frame cocci_id@p [ EXT4_HTREE_LEVEL ] ;
...
position p;
@@
 const struct ext4_filename * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dx_frame * frames ) ;
...
position p;
@@
 unsigned cocci_id@p ( struct inode * dir , unsigned infosize ) ;
...
position p;
@@
 struct buffer_head * cocci_id@p ( struct inode * dir , struct ext4_filename * fname , struct ext4_dir_entry_2 * * res_dir ) ;
...
typedef ext4_lblk_t;
@@
 ext4_lblk_t cocci_id@p ( struct dx_entry * entry ) ;
...
typedef __le32,u32;
@@
 struct dx_tail {  u32 dt_reserved ;  __le32 dt_checksum ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dx_entry * entries , unsigned value ) ;
...
position p;
@@
 struct dx_map_entry * cocci_id@p ;
...
position p;
@@
 struct ext4_inode_info * cocci_id@p ;
...
position p;
@@
 struct dx_hash_info cocci_id@p ;
...
position p;
@@
 struct buffer_head * cocci_id@p [ NAMEI_RA_SIZE ] ;
...
position p;
@@
 struct ext4_dir_entry_2 * cocci_id@p ( char * base , unsigned blocksize ) ;
...
typedef __le32,u8;
@@
 struct dx_root {  struct fake_dirent dot ;  char dot_name [ 4 ] ;  struct fake_dirent dotdot ;  char dotdot_name [ 4 ] ;  struct dx_root_info {  __le32 reserved_zero ;  u8 hash_version ;  u8 info_length ;  u8 indirect_levels ;  u8 unused_flags ; } info ;  struct dx_entry entries [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 unsigned cocci_id@p ( struct inode * dir ) ;
...
position p;
@@
 struct fscrypt_name cocci_id@p ;
...
typedef bool;
@@
 struct ext4_renament {  struct inode * dir ;  struct dentry * dentry ;  struct inode * inode ;  bool is_dir ;  int dir_nlink_delta ;  struct buffer_head * bh ;  struct ext4_dir_entry_2 * de ;  int inlined ;  struct buffer_head * dir_bh ;  struct ext4_dir_entry_2 * parent_de ;  int dir_inlined ; } cocci_id@p ;
...
position p;
@@
 struct ext4_sb_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dx_entry * entry , unsigned value ) ;
...
position p;
@@
 struct ext4_renament cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dirblock_type_t;
@@
 dirblock_type_t cocci_id@p ;
...
typedef __le32;
@@
 struct dx_entry {  __le32 hash ;  __le32 block ; } cocci_id@p ;
...
position p;
@@
 struct ext4_dir_entry_2 * cocci_id@p ( char * from , char * to , struct dx_map_entry * offsets , int count , unsigned blocksize ) ;
...
position p;
@@
 enum { EITHER , INDEX , DIRENT , DIRENT_HTREE , } cocci_id@p ;
...
position p;
@@
 struct stats {  unsigned names ;  unsigned space ;  unsigned bcount ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dx_map_entry * map , unsigned count ) ;
...
position p;
@@
 unsigned cocci_id@p ( struct dx_entry * entries ) ;
...
position p;
@@
 struct dx_countlimit {  __le16 limit ;  __le16 count ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct dx_map_entry {  u32 hash ;  u16 offs ;  u16 size ; } cocci_id@p ;
