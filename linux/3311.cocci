...
position p;
@@
 void cocci_id@p ( struct lm78_data * data ) ;
...
position p;
@@
 struct lm78_data * cocci_id@p ( struct device * dev ) ;
...
typedef s8,u8,u16;
@@
 struct lm78_data {  struct i2c_client * client ;  struct mutex lock ;  enum chips type ;  const char * name ;  int isa_addr ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u8 in [ 7 ] ;  u8 in_max [ 7 ] ;  u8 in_min [ 7 ] ;  u8 fan [ 3 ] ;  u8 fan_min [ 3 ] ;  s8 temp ;  s8 temp_over ;  s8 temp_hyst ;  u8 fan_div [ 3 ] ;  u8 vid ;  u16 alarms ; } cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct lm78_data * data , u8 reg ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct lm78_data * data , u8 reg , u8 value ) ;
...
position p;
@@
 enum chips { lm78 , lm79 , } cocci_id@p ;
