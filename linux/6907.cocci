...
position p;
@@
 struct asd_bios_chim_struct * cocci_id@p ;
...
position p;
@@
 struct asd_flash_dir * cocci_id@p ;
...
position p;
@@
 struct asd_manuf_phy_desc * cocci_id@p ;
...
position p;
@@
 struct asd_manuf_phy_param cocci_id@p ;
...
position p;
@@
 struct asd_ctrla_phy_settings cocci_id@p ;
...
position p;
@@
 struct asd_ctrla_phy_entry * cocci_id@p ;
...
position p;
@@
 struct asd_flash_de * cocci_id@p ;
...
position p;
@@
 struct asd_manuf_sec * cocci_id@p ;
...
position p;
@@
 struct asd_ocm_dir_ent cocci_id@p [ OCM_INIT_DIR_ENTRIES ] ;
...
position p;
@@
 struct asd_ms_conn_map * cocci_id@p ;
...
position p;
@@
 struct asd_ocm_dir_ent * cocci_id@p ;
