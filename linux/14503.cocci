...
position p;
@@
 const struct axs10x_pll_cfg * cocci_id@p ;
...
position p;
@@
 struct axs10x_pll_clk * cocci_id@p ;
...
position p;
@@
 struct axs10x_pll_clk {  struct clk_hw hw ;  void __iomem * base ;  void __iomem * lock ;  const struct axs10x_pll_cfg * pll_cfg ;  struct device * dev ; } cocci_id@p ;
...
typedef u32;
@@
 struct axs10x_pll_cfg {  u32 rate ;  u32 idiv ;  u32 fbdiv ;  u32 odiv ; } cocci_id@p ;
