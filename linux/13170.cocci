...
position p;
@@
 struct dmx_frontend * cocci_id@p ;
...
position p;
@@
 const struct smi_cfg_info cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct dvb_demux_feed * ) ;
...
position p;
@@
 struct smi_cfg_info * cocci_id@p ;
