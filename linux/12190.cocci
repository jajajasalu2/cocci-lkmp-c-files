...
position p;
@@
 enum tegra_dpaux_functions { DPAUX_PADCTL_FUNC_AUX , DPAUX_PADCTL_FUNC_I2C , DPAUX_PADCTL_FUNC_OFF , } cocci_id@p ;
...
position p;
@@
 const struct tegra_dpaux_soc cocci_id@p ;
...
position p;
@@
 struct tegra_dpaux_soc {  unsigned int cmh ;  unsigned int drvz ;  unsigned int drvi ; } cocci_id@p ;
