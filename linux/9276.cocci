...
typedef u8;
@@
 u8 cocci_id@p [ B_SUPPORTED_RATES ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ MWIFIEX_SUPPORTED_RATES_EXT ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ BG_SUPPORTED_RATES ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ G_SUPPORTED_RATES ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ MWIFIEX_MAX_REGION_CODE ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ N_SUPPORTED_RATES ] ;
...
typedef u8;
@@
 struct region_code_mapping {  u8 code ;  u8 region [ IEEE80211_COUNTRY_STRING_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct region_code_mapping cocci_id@p [ ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ A_SUPPORTED_RATES ] ;
