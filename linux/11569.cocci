...
position p;
@@
 const struct nvkm_i2c_pad_func cocci_id@p ;
...
typedef u8;
@@
 struct anx9805_pad {  struct nvkm_i2c_pad base ;  struct nvkm_i2c_bus * bus ;  u8 addr ; } cocci_id@p ;
...
position p;
@@
 const struct nvkm_i2c_bus_func cocci_id@p ;
...
typedef u8;
@@
 struct anx9805_bus {  struct nvkm_i2c_bus base ;  struct anx9805_pad * pad ;  u8 addr ; } cocci_id@p ;
...
typedef u8;
@@
 struct anx9805_aux {  struct nvkm_i2c_aux base ;  struct anx9805_pad * pad ;  u8 addr ; } cocci_id@p ;
...
position p;
@@
 const struct nvkm_i2c_aux_func cocci_id@p ;
