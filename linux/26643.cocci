...
typedef __be64;
@@
 struct direct_map {  struct arp_entry arp ;  int ifindex ;  __be64 mac ; } cocci_id@p ;
...
typedef u8,u32;
@@
 union key_4 {  u32 b32 [ 2 ] ;  u8 b8 [ 8 ] ; } cocci_id@p ;
...
@@
 struct arp_entry {  __be64 mac ;  __be32 dst ; } cocci_id@p ;
