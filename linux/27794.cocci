...
position p;
@@
 int cocci_id@p ( struct inode * inode , int name_index , const char * name , struct ocfs2_xattr_search * xs ) ;
...
position p;
@@
 xattr_tree_rec_func * cocci_id@p ;
...
position p;
@@
 struct ocfs2_post_refcount * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_search {  struct buffer_head * inode_bh ;  struct buffer_head * xattr_bh ;  struct ocfs2_xattr_header * header ;  struct ocfs2_xattr_bucket * bucket ;  void * base ;  void * end ;  struct ocfs2_xattr_entry * here ;  int not_found ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_def_value_root {  struct ocfs2_xattr_value_root xv ;  struct ocfs2_extent_rec er ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , struct buffer_head * bh , struct ocfs2_xattr_header * xh , int offset , struct ocfs2_xattr_value_root * * xv , struct buffer_head * * ret_bh , void * para ) ;
...
position p;
@@
 struct ocfs2_xa_loc {  struct inode * xl_inode ;  struct ocfs2_xattr_header * xl_header ;  int xl_size ;  struct ocfs2_xattr_entry * xl_entry ;  void * xl_storage ;  const struct ocfs2_xa_loc_operations * xl_ops ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_tree_root * cocci_id@p ;
...
position p;
@@
 struct ocfs2_refcount_tree * * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_entry * cocci_id@p ;
...
position p;
@@
 const struct xattr_handler * cocci_id@p [ OCFS2_XATTR_MAX ] ;
...
position p;
@@
 struct ocfs2_extent_tree cocci_id@p ;
...
position p;
@@
 struct ocfs2_caching_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct ocfs2_dinode * di , struct ocfs2_xattr_info * xi , struct ocfs2_xattr_search * xis , struct ocfs2_xattr_search * xbs , struct ocfs2_refcount_tree * * ref_tree , int * meta_need , int * credits ) ;
...
position p;
@@
 struct ocfs2_xattr_tree_list * cocci_id@p ;
...
position p;
@@
 struct ocfs2_lock_holder cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_set_ctxt * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_info {  int xi_name_index ;  const char * xi_name ;  int xi_name_len ;  const void * xi_value ;  size_t xi_value_len ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_bucket * cocci_id@p ;
...
position p;
@@
 const struct ocfs2_xattr_entry * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct buffer_head * root_bh , int name_index , const char * name , struct ocfs2_xattr_search * xs ) ;
...
position p;
@@
 struct ocfs2_xattr_reflink * cocci_id@p ;
...
position p;
@@
 struct ocfs2_alloc_context * * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_xattr_entry * xe ) ;
...
position p;
@@
 struct ocfs2_reflink_xattr_tree_args * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_block * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_header cocci_id@p ;
...
position p;
@@
 const struct ocfs2_xa_loc_operations cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , struct ocfs2_xattr_bucket * bucket , int offset , struct ocfs2_xattr_value_root * * xv , struct buffer_head * * bh ) ;
...
position p;
@@
 struct ocfs2_refcount_block * cocci_id@p ;
...
position p;
@@
 struct ocfs2_cached_dealloc_ctxt cocci_id@p ;
...
position p;
@@
 struct ocfs2_rm_xattr_bucket_para {  struct ocfs2_caching_info * ref_ci ;  struct buffer_head * ref_root_bh ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_tree_value_refcount_para cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_info cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_tree_value_refcount_para {  struct ocfs2_caching_info * ref_ci ;  struct buffer_head * ref_root_bh ;  struct ocfs2_cached_dealloc_ctxt * dealloc ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_rm_xattr_bucket_para * cocci_id@p ;
...
position p;
@@
 struct ocfs2_extent_block * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct ocfs2_xattr_search * xs , struct ocfs2_xattr_set_ctxt * ctxt ) ;
...
position p;
@@
 struct ocfs2_xattr_def_value_root cocci_id@p ;
...
typedef handle_t;
@@
 struct ocfs2_xattr_set_ctxt {  handle_t * handle ;  struct ocfs2_alloc_context * meta_ac ;  struct ocfs2_alloc_context * data_ac ;  struct ocfs2_cached_dealloc_ctxt dealloc ;  int set_abort ; } cocci_id@p ;
...
@@
 struct ocfs2_xa_loc_operations {  int ( * xlo_journal_access ) ( handle_t * handle , struct ocfs2_xa_loc * loc , int type ) ;  void ( * xlo_journal_dirty ) ( handle_t * handle , struct ocfs2_xa_loc * loc ) ;  void * ( * xlo_offset_pointer ) ( struct ocfs2_xa_loc * loc , int offset ) ;  int ( * xlo_can_reuse ) ( struct ocfs2_xa_loc * loc , struct ocfs2_xattr_info * xi ) ;  int ( * xlo_check_space ) ( struct ocfs2_xa_loc * loc , struct ocfs2_xattr_info * xi ) ;  int ( * xlo_get_free_start ) ( struct ocfs2_xa_loc * loc ) ;  void ( * xlo_wipe_namevalue ) ( struct ocfs2_xa_loc * loc ) ;  void ( * xlo_add_entry ) ( struct ocfs2_xa_loc * loc , u32 name_hash ) ;  void ( * xlo_add_namevalue ) ( struct ocfs2_xa_loc * loc , int size ) ;  void ( * xlo_fill_value_buf ) ( struct ocfs2_xa_loc * loc , struct ocfs2_xattr_value_buf * vb ) ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_value_tree_metas {  int num_metas ;  int credits ;  int num_recs ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_extent_list * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_reflink {  struct inode * old_inode ;  struct inode * new_inode ;  struct buffer_head * old_bh ;  struct buffer_head * new_bh ;  struct ocfs2_caching_info * ref_ci ;  struct buffer_head * ref_root_bh ;  struct ocfs2_cached_dealloc_ctxt * dealloc ;  should_xattr_reflinked * xattr_reflinked ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_bucket {  struct inode * bu_inode ;  struct buffer_head * bu_bhs [ OCFS2_XATTR_MAX_BLOCKS_PER_BUCKET ] ;  int bu_blocks ; } cocci_id@p ;
...
position p;
@@
 ocfs2_journal_access_func cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct ocfs2_xattr_info * xi , struct ocfs2_xattr_search * xs , struct ocfs2_xattr_set_ctxt * ctxt ) ;
...
position p;
@@
 struct ocfs2_value_tree_metas * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_search * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_value_root * * cocci_id@p ;
...
position p;
@@
 struct ocfs2_inode_info * cocci_id@p ;
...
position p;
@@
 struct ocfs2_inline_data * cocci_id@p ;
...
position p;
@@
 enum ocfs2_alloc_restarted cocci_id@p ;
...
position p;
@@
 struct ocfs2_security_xattr_info * cocci_id@p ;
...
position p;
@@
 struct ocfs2_reflink_xattr_tree_args {  struct ocfs2_xattr_reflink * reflink ;  struct buffer_head * old_blk_bh ;  struct buffer_head * new_blk_bh ;  struct ocfs2_xattr_bucket * old_bucket ;  struct ocfs2_xattr_bucket * new_bucket ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_value_buf * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , struct ocfs2_xattr_header * xh , int index , int * block_off , int * new_offset ) ;
...
position p;
@@
 struct ocfs2_extent_rec * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct ocfs2_xattr_bucket * bucket , void * para ) ;
...
typedef u64,u32;
@@
 int cocci_id@p ( struct inode * inode , struct buffer_head * root_bh , u64 blkno , u32 cpos , u32 len , void * para ) ;
...
position p;
@@
 get_xattr_value_root * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xa_loc cocci_id@p ;
...
position p;
@@
 struct ocfs2_dinode * cocci_id@p ;
...
position p;
@@
 struct ocfs2_xattr_tree_list {  char * buffer ;  size_t buffer_size ;  size_t result ; } cocci_id@p ;
