...
typedef dma_addr_t;
@@
 struct kbtab {  unsigned char * data ;  dma_addr_t data_dma ;  struct input_dev * dev ;  struct usb_interface * intf ;  struct urb * irq ;  char phys [ 32 ] ; } cocci_id@p ;
