...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_DUP_MAX + 1 ] ;
...
position p;
@@
 const struct nft_dup_netdev * cocci_id@p ;
...
position p;
@@
 struct nft_dup_netdev cocci_id@p ;
...
position p;
@@
 struct nft_dup_netdev {  enum nft_registers sreg_dev : 8 ; } cocci_id@p ;
