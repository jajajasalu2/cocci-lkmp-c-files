...
typedef u8;
@@
 struct hi8435_priv {  struct spi_device * spi ;  struct mutex lock ;  unsigned long event_scan_mask ;  unsigned int event_prev_val ;  unsigned threshold_lo [ 2 ] ;  unsigned threshold_hi [ 2 ] ;  u8 reg_buffer [ 3 ] ____cacheline_aligned ; } cocci_id@p ;
