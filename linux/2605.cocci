...
typedef u32;
@@
 struct sc27xx_efuse {  struct device * dev ;  struct regmap * regmap ;  struct hwspinlock * hwlock ;  struct mutex mutex ;  u32 base ; } cocci_id@p ;
...
position p;
@@
 struct sc27xx_efuse * cocci_id@p ;
