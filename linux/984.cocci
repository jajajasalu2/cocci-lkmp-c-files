...
typedef bool,u32;
@@
 struct nxp_spifi {  struct device * dev ;  struct clk * clk_spifi ;  struct clk * clk_reg ;  void __iomem * io_base ;  void __iomem * flash_base ;  struct spi_nor nor ;  bool memory_mode ;  u32 mcmd ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SPI_NOR_MAX_ID_LEN ] ;
