...
position p;
@@
 struct tcf_skbmod_params cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_SKBMOD_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_SKBMOD_MAX + 1 ] ;
