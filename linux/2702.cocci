...
position p;
@@
 struct i2c_algo_sibyte_data {  void * data ;  int bus ;  void * reg_base ; } cocci_id@p ;
...
position p;
@@
 struct i2c_adapter cocci_id@p [ 2 ] ;
...
position p;
@@
 struct i2c_algo_sibyte_data * cocci_id@p ;
...
position p;
@@
 struct i2c_algo_sibyte_data cocci_id@p [ 2 ] ;
