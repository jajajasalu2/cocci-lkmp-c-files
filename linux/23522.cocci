...
position p;
@@
 struct cht_acpi_card {  char * codec_id ;  int codec_type ;  struct snd_soc_card * soc_card ; } cocci_id@p ;
...
position p;
@@
 struct cht_acpi_card cocci_id@p [ ] ;
...
position p;
@@
 struct cht_mc_private * cocci_id@p ;
...
position p;
@@
 struct cht_mc_private {  struct snd_soc_jack jack ;  struct cht_acpi_card * acpi_card ;  char codec_name [ SND_ACPI_I2C_ID_LEN ] ;  struct clk * mclk ; } cocci_id@p ;
