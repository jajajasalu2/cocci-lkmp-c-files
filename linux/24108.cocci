...
position p;
@@
 void cocci_id@p ( struct svc_xprt * xprt ) ;
...
position p;
@@
 struct svc_xprt * cocci_id@p ( struct svc_xprt * xprt ) ;
...
position p;
@@
 void cocci_id@p ( struct svc_rqst * ) ;
...
position p;
@@
 int cocci_id@p ( struct svc_xprt * xprt ) ;
...
position p;
@@
 struct svc_xprt * cocci_id@p ( struct svc_serv * serv , struct net * net , struct sockaddr * sa , int salen , int flags ) ;
...
position p;
@@
 struct svcxprt_rdma * cocci_id@p ( struct svc_serv * serv , struct net * net ) ;
