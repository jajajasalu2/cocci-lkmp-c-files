...
typedef bool;
@@
 struct renesas_sdhi_quirks {  bool hs400_disabled ;  bool hs400_4taps ; } cocci_id@p ;
...
position p;
@@
 const struct renesas_sdhi_scc * cocci_id@p ;
...
position p;
@@
 struct renesas_sdhi * cocci_id@p ;
...
position p;
@@
 const struct renesas_sdhi_quirks cocci_id@p ;
...
position p;
@@
 struct tmio_mmc_dma * cocci_id@p ;
...
position p;
@@
 const struct renesas_sdhi_of_data * cocci_id@p ;
