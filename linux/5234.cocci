...
@@
 struct pdc_port_priv {  u8 * pkt ;  dma_addr_t pkt_dma ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct pdc_host_priv {  spinlock_t hard_reset_lock ; } cocci_id@p ;
...
position p;
@@
 const struct ata_host * cocci_id@p ;
...
position p;
@@
 const struct ata_port_info * cocci_id@p [ PDC_MAX_PORTS ] ;
