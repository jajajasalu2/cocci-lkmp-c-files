...
position p;
@@
 enum { REG_IEV , REG_IE , REG_TRIG , CACHE_NR_REGS , } cocci_id@p ;
...
position p;
@@
 struct sprd_pmic_eic * cocci_id@p ;
...
typedef u8,u32;
@@
 struct sprd_pmic_eic {  struct gpio_chip chip ;  struct irq_chip intc ;  struct regmap * map ;  u32 offset ;  u8 reg [ CACHE_NR_REGS ] ;  struct mutex buslock ;  int irq ; } cocci_id@p ;
