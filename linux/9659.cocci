...
position p;
@@
 const struct b43_txstatus * cocci_id@p ;
...
position p;
@@
 const struct b43_phy * cocci_id@p ;
...
position p;
@@
 const struct b43_tx_legacy_rate_phy_ctl_entry cocci_id@p [ ] ;
...
position p;
@@
 const struct b43_rxhdr_fw4 * cocci_id@p ;
