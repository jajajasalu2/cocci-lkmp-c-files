...
position p;
@@
 const struct imx_gpt_data cocci_id@p ;
...
position p;
@@
 struct imx_timer {  enum imx_gpt_type type ;  void __iomem * base ;  int irq ;  struct clk * clk_per ;  struct clk * clk_ipg ;  const struct imx_gpt_data * gpt ;  struct clock_event_device ced ;  struct irqaction act ; } cocci_id@p ;
