...
position p;
@@
 enum upload_code_flags { REBOOT = 1 , } cocci_id@p ;
...
position p;
@@
 struct zd_usb_interrupt * cocci_id@p ;
...
position p;
@@
 struct usb_int_header * cocci_id@p ;
...
position p;
@@
 struct usb_req_rfwrite * cocci_id@p ;
...
position p;
@@
 const struct rx_length_info * cocci_id@p ;
...
position p;
@@
 struct usb_int_regs * cocci_id@p ;
...
position p;
@@
 struct usb_req_write_regs * cocci_id@p ;
...
position p;
@@
 const struct usb_device * cocci_id@p ;
...
position p;
@@
 struct usb_req_read_regs cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct zd_usb * usb , struct usb_req_read_regs * req , unsigned int count ) ;
...
position p;
@@
 struct rx_length_info * cocci_id@p ;
...
position p;
@@
 struct read_regs_int * cocci_id@p ;
