...
position p;
@@
 struct bpqdev {  struct list_head bpq_list ;  struct net_device * ethdev ;  struct net_device * axdev ;  char dest_addr [ 6 ] ;  char acpt_addr [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 const struct bpqdev * cocci_id@p ;
