...
position p;
@@
 struct stv0299_state cocci_id@p ;
...
typedef u8,u32;
@@
 struct stv0299_state {  struct i2c_adapter * i2c ;  const struct stv0299_config * config ;  struct dvb_frontend frontend ;  u8 initialised : 1 ;  u32 tuner_frequency ;  u32 symbol_rate ;  enum fe_code_rate fec_inner ;  int errmode ;  u32 ucblocks ;  u8 mcr_reg ; } cocci_id@p ;
