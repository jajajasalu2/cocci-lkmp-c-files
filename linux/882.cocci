...
position p;
@@
 struct mtk_ecc_stats cocci_id@p ;
...
position p;
@@
 struct mtk_nfc_nand_chip cocci_id@p ;
...
typedef u8;
@@
 struct mtk_nfc {  struct nand_controller controller ;  struct mtk_ecc_config ecc_cfg ;  struct mtk_nfc_clk clk ;  struct mtk_ecc * ecc ;  struct device * dev ;  const struct mtk_nfc_caps * caps ;  void __iomem * regs ;  struct completion done ;  struct list_head chips ;  u8 * buffer ;  unsigned long assigned_cs ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct mtk_nfc_nand_chip {  struct list_head node ;  struct nand_chip nand ;  struct mtk_nfc_bad_mark_ctl bad_mark ;  struct mtk_nfc_fdm fdm ;  u32 spare_per_sector ;  int nsels ;  u8 sels [ 0 ] ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct mtk_nfc_caps {  const u8 * spare_size ;  u8 num_spare_size ;  u8 pageformat_spare_shift ;  u8 nfi_clk_div ;  u8 max_sector ;  u32 max_sector_size ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_nfc_caps cocci_id@p ;
...
position p;
@@
 struct mtk_nfc_bad_mark_ctl * cocci_id@p ;
...
position p;
@@
 struct mtk_nfc_clk {  struct clk * nfi_clk ;  struct clk * pad_clk ; } cocci_id@p ;
...
typedef u32;
@@
 struct mtk_nfc_fdm {  u32 reg_size ;  u32 ecc_size ; } cocci_id@p ;
