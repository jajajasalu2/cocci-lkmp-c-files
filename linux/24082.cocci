...
position p;
@@
 struct decryptor_desc cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ GSS_KRB5_MAX_CKSUM_LEN ] ;
...
position p;
@@
 struct encryptor_desc * cocci_id@p ;
...
typedef u8;
@@
 struct decryptor_desc {  u8 iv [ GSS_KRB5_MAX_BLOCKSIZE ] ;  struct skcipher_request * req ;  struct scatterlist frags [ 4 ] ;  int fragno ;  int fraglen ; } cocci_id@p ;
...
typedef u8;
@@
 struct encryptor_desc {  u8 iv [ GSS_KRB5_MAX_BLOCKSIZE ] ;  struct skcipher_request * req ;  int pos ;  struct xdr_buf * outbuf ;  struct page * * pages ;  struct scatterlist infrags [ 4 ] ;  struct scatterlist outfrags [ 4 ] ;  int fragno ;  int fraglen ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ GSS_KRB5_MAX_KEYLEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ GSS_KRB5_MAX_BLOCKSIZE ] ;
