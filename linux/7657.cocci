...
position p;
@@
 sync_serial_settings cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , int break_state ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_port * port ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * tty ) ;
...
position p;
@@
 int cocci_id@p ( SLMP_INFO * info , struct mgsl_icount __user * user_icount ) ;
...
position p;
@@
 unsigned char cocci_id@p ( SLMP_INFO * info , unsigned char addr ) ;
...
position p;
@@
 int cocci_id@p ( SLMP_INFO * info , int idle_mode ) ;
...
position p;
@@
 void cocci_id@p ( struct pci_dev * dev ) ;
...
position p;
@@
 int cocci_id@p ( SLMP_INFO * info , MGSL_PARAMS __user * params ) ;
...
position p;
@@
 struct _input_signal_events cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( SLMP_INFO * info ) ;
...
position p;
@@
 void cocci_id@p ( SLMP_INFO * info , int enable ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , unsigned int cmd , unsigned long arg ) ;
...
position p;
@@
 void cocci_id@p ( SLMP_INFO * info , const char * data , int count , int xmit ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * tty , struct file * filp ) ;
...
position p;
@@
 struct _input_signal_events {  int ri_up ;  int ri_down ;  int dsr_up ;  int dsr_down ;  int dcd_up ;  int dcd_down ;  int cts_up ;  int cts_down ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * dev , const struct pci_device_id * ent ) ;
...
position p;
@@
 void cocci_id@p ( SLMP_INFO * info , const char * buf , unsigned int count ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , struct file * filp ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , struct file * filp , SLMP_INFO * info ) ;
...
position p;
@@
 int cocci_id@p ( SLMP_INFO * info , int __user * mask_ptr ) ;
...
typedef u16;
@@
 void cocci_id@p ( SLMP_INFO * info , unsigned char addr , u16 val ) ;
...
position p;
@@
 void cocci_id@p ( SLMP_INFO * info , unsigned int first , unsigned int last ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * tty , struct ktermios * old_termios ) ;
...
position p;
@@
 int cocci_id@p ( int adapter_num , struct pci_dev * pdev ) ;
...
position p;
@@
 int cocci_id@p ( SLMP_INFO * info , int arg ) ;
...
typedef u32;
@@
 void cocci_id@p ( SLMP_INFO * info , u32 data_rate ) ;
...
position p;
@@
 unsigned char cocci_id@p [ TESTFRAMESIZE ] ;
...
typedef u16;
@@
 struct _SCADESC_EX {  char * virt_addr ;  u16 phys_entry ; } cocci_id@p ;
...
position p;
@@
 const struct tty_operations cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * tty , char ch ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * tty , int timeout ) ;
...
position p;
@@
 struct serial_icounter_struct * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , const unsigned char * buf , int count ) ;
...
position p;
@@
 void cocci_id@p ( SLMP_INFO * info , char * buf , int size ) ;
...
position p;
@@
 void cocci_id@p ( SLMP_INFO * info , char * dest , const char * src , unsigned short count ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , unsigned int set , unsigned int clear ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty ) ;
...
position p;
@@
 const struct tty_port_operations cocci_id@p ;
...
typedef u8,u16;
@@
 struct _SCADESC {  u16 next ;  u16 buf_ptr ;  u8 buf_base ;  u8 pad1 ;  u16 length ;  u8 status ;  u8 pad2 ; } cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p ( SLMP_INFO * info , unsigned char addr ) ;
...
position p;
@@
 int cocci_id@p ( SLMP_INFO * info , int __user * idle_mode ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , unsigned char ch ) ;
...
position p;
@@
 int cocci_id@p ( SLMP_INFO * info , SCADESC * list , SCADESC_EX * list_ex , int count ) ;
...
position p;
@@
 void cocci_id@p ( SLMP_INFO * info , unsigned char addr , unsigned char val ) ;
...
position p;
@@
 unsigned char cocci_id@p ( SLMP_INFO * info ) ;
...
typedef u16;
@@
 void cocci_id@p ( SLMP_INFO * info , u16 status ) ;
...
position p;
@@
 void cocci_id@p ( SLMP_INFO * info ) ;
...
position p;
@@
 SLMP_INFO * cocci_id@p [ SCA_MAX_PORTS ] ;
...
position p;
@@
 int cocci_id@p ( SLMP_INFO * info , int enable ) ;
