...
typedef bool;
@@
 struct private_data {  struct opp_table * opp_table ;  struct device * cpu_dev ;  const char * reg_name ;  bool have_static_opps ; } cocci_id@p ;
...
position p;
@@
 struct cpufreq_dt_platform_data * cocci_id@p ;
