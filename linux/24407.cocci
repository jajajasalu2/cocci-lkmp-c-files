...
position p;
@@
 struct l2cap_conf_opt * cocci_id@p ;
...
position p;
@@
 struct l2cap_move_chan_req * cocci_id@p ;
...
position p;
@@
 struct l2cap_conf_rsp * cocci_id@p ;
...
position p;
@@
 struct l2cap_info_rsp * cocci_id@p ;
...
typedef u8,u16;
@@
 struct sk_buff * cocci_id@p ( struct l2cap_conn * conn , u8 code , u8 ident , u16 dlen , void * data ) ;
...
position p;
@@
 struct l2cap_disconn_req * cocci_id@p ;
...
position p;
@@
 struct l2cap_disconn_rsp cocci_id@p ;
...
position p;
@@
 struct l2cap_conf_req * cocci_id@p ;
...
position p;
@@
 struct l2cap_conn_param_update_req cocci_id@p ;
...
position p;
@@
 struct l2cap_create_chan_req * cocci_id@p ;
...
position p;
@@
 struct l2cap_move_chan_cfm * cocci_id@p ;
...
position p;
@@
 struct l2cap_le_conn_rsp cocci_id@p ;
...
position p;
@@
 struct l2cap_conn_req cocci_id@p ;
...
position p;
@@
 struct l2cap_info_req cocci_id@p ;
...
position p;
@@
 struct l2cap_le_credits * cocci_id@p ;
...
position p;
@@
 struct l2cap_cmd_rej_unk cocci_id@p ;
...
position p;
@@
 struct l2cap_move_chan_rsp * cocci_id@p ;
...
position p;
@@
 struct l2cap_cmd_hdr cocci_id@p ;
...
position p;
@@
 struct l2cap_conn_rsp * cocci_id@p ;
...
position p;
@@
 struct l2cap_seq_list * cocci_id@p ;
...
position p;
@@
 struct l2cap_le_conn_req * cocci_id@p ;
...
position p;
@@
 struct l2cap_move_chan_cfm_rsp * cocci_id@p ;
...
position p;
@@
 struct l2cap_cmd_rej_cid cocci_id@p ;
...
position p;
@@
 struct l2cap_create_chan_rsp cocci_id@p ;
...
position p;
@@
 struct l2cap_conf_rfc * cocci_id@p ;
...
position p;
@@
 struct l2cap_conn_param_update_rsp cocci_id@p ;
...
typedef u8,u16;
@@
 void cocci_id@p ( struct l2cap_conn * conn , u8 ident , u8 code , u16 len , void * data ) ;
...
position p;
@@
 struct l2cap_conf_efs cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct l2cap_chan * chan , int err ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct l2cap_chan * chan , struct l2cap_ctrl * control , struct sk_buff_head * skbs , u8 event ) ;
