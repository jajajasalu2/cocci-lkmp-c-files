...
position p;
@@
 struct stm32_crc_desc_ctx * cocci_id@p ;
...
typedef u32;
@@
 struct stm32_crc_desc_ctx {  u32 partial ;  struct stm32_crc * crc ; } cocci_id@p ;
...
position p;
@@
 struct stm32_crc_list cocci_id@p ;
...
typedef spinlock_t;
@@
 struct stm32_crc_list {  struct list_head dev_list ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_crc_ctx {  u32 key ;  u32 poly ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct stm32_crc {  struct list_head list ;  struct device * dev ;  void __iomem * regs ;  struct clk * clk ;  u8 pending_data [ sizeof ( u32 ) ] ;  size_t nb_pending_bytes ; } cocci_id@p ;
...
position p;
@@
 struct stm32_crc_ctx * cocci_id@p ;
