...
position p;
@@
 struct ina2xx_chip_info * cocci_id@p ;
...
typedef u16;
@@
 struct ina2xx_config {  u16 config_default ;  int calibration_value ;  int shunt_voltage_lsb ;  int bus_voltage_shift ;  int bus_voltage_lsb ;  int power_lsb_factor ;  enum ina2xx_ids chip_id ; } cocci_id@p ;
...
position p;
@@
 const struct ina2xx_config cocci_id@p [ ] ;
...
typedef s64;
@@
 unsigned short cocci_id@p [ 4 + sizeof ( s64 ) / sizeof ( short ) ] ;
...
position p;
@@
 enum ina2xx_ids { ina219 , ina226 , } cocci_id@p ;
...
typedef bool;
@@
 struct ina2xx_chip_info {  struct regmap * regmap ;  struct task_struct * task ;  const struct ina2xx_config * config ;  struct mutex state_lock ;  unsigned int shunt_resistor_uohm ;  int avg ;  int int_time_vbus ;  int int_time_vshunt ;  int range_vbus ;  int pga_gain_vshunt ;  bool allow_async_readout ; } cocci_id@p ;
...
position p;
@@
 struct ina2xx_platform_data * cocci_id@p ;
