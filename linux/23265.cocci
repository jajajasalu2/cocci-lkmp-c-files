...
position p;
@@
 struct ak5558_priv {  struct snd_soc_component component ;  struct regmap * regmap ;  struct i2c_client * i2c ;  struct gpio_desc * reset_gpiod ;  int slots ;  int slot_width ; } cocci_id@p ;
