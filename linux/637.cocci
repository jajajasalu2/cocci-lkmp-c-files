...
position p;
@@
 const struct seed_ctx * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ SEED_NUM_KCONSTANTS ] ;
...
typedef u32;
@@
 struct seed_ctx {  u32 keysched [ SEED_KEYSCHED_LEN ] ; } cocci_id@p ;
