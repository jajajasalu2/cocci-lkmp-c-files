...
position p;
@@
 struct route_payload cocci_id@p ;
...
position p;
@@
 struct q6adm_cmd_matrix_map_routings_v5 * cocci_id@p ;
...
position p;
@@
 struct q6adm_cmd_device_open_v5 * cocci_id@p ;
...
@@
 struct q6copp {  int afe_port ;  int copp_idx ;  int id ;  int topology ;  int mode ;  int rate ;  int bit_width ;  int channels ;  int app_type ;  int acdb_id ;  struct aprv2_ibasic_rsp_result_t result ;  struct kref refcount ;  wait_queue_head_t wait ;  struct list_head node ;  struct q6adm * adm ; } cocci_id@p ;
...
position p;
@@
 struct q6adm_session_map_node_v5 * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,spinlock_t,aprv2_ibasic_rsp_result_t;
@@
 struct q6adm {  struct apr_device * apr ;  struct device * dev ;  struct q6core_svc_api_info ainfo ;  unsigned long copp_bitmap [ AFE_MAX_PORTS ] ;  struct list_head copps_list ;  spinlock_t copps_list_lock ;  struct aprv2_ibasic_rsp_result_t result ;  struct mutex lock ;  wait_queue_head_t matrix_map_wait ; } cocci_id@p ;
