...
position p;
@@
 int cocci_id@p ( unsigned char * sjis , const unsigned char euc_hi , const unsigned char euc_lo ) ;
...
position p;
@@
 int cocci_id@p ( unsigned char * sjisibm , const unsigned char sjisnec_hi , const unsigned char sjisnec_lo ) ;
...
position p;
@@
 int cocci_id@p ( unsigned char * euc , const unsigned char sjis_hi , const unsigned char sjis_lo ) ;
...
position p;
@@
 struct {  unsigned short euc ;  unsigned char sjis [ 2 ] ; } cocci_id@p [ ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ ] [ 2 ] ;
