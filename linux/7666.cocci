...
position p;
@@
 const struct tty_port_client_operations * cocci_id@p ;
...
position p;
@@
 struct serport {  struct tty_port * port ;  struct tty_struct * tty ;  struct tty_driver * tty_drv ;  int tty_idx ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 const struct serdev_controller_ops cocci_id@p ;
