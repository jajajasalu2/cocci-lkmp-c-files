...
position p;
@@
 struct hns3_stats {  char stats_string [ ETH_GSTRING_LEN ] ;  int stats_offset ; } cocci_id@p ;
...
position p;
@@
 const struct hns3_stats * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ HNS3_SELF_TEST_TYPE_NUM ] [ 2 ] ;
