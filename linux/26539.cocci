...
symbol cocci_id;
position p;
typedef bpf_filter_t;
@@
 const struct bpf_filter_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bpf_tcinfo_t;
@@
 struct bpf_tcinfo_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bpf_netdev_t;
@@
 struct bpf_netdev_t {  struct ip_devname_ifindex * devices ;  int used_len ;  int array_len ;  int filter_idx ; } cocci_id@p ;
...
position p;
@@
 struct bpf_attach_info cocci_id@p ;
...
position p;
@@
 struct ip_devname_ifindex cocci_id@p ;
...
typedef bpf_netdev_t;
@@
 struct bpf_netdev_t * cocci_id@p ;
...
typedef __u32;
@@
 struct bpf_attach_info {  __u32 flow_dissector_id ; } cocci_id@p ;
...
position p;
@@
 struct tc_kind_handle cocci_id@p ;
...
position p;
@@
 enum net_attach_type cocci_id@p ;
...
typedef bpf_filter_t;
@@
 struct bpf_filter_t {  const char * kind ;  const char * devname ;  int ifindex ; } cocci_id@p ;
...
position p;
@@
 struct ip_devname_ifindex {  char devname [ 64 ] ;  int ifindex ; } cocci_id@p ;
...
typedef bpf_filter_t;
@@
 struct bpf_filter_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,bpf_tcinfo_t;
@@
 struct bpf_tcinfo_t {  struct tc_kind_handle * handle_array ;  int used_len ;  int array_len ;  bool is_qdisc ; } cocci_id@p ;
...
position p;
@@
 struct tc_kind_handle {  char kind [ 64 ] ;  int handle ; } cocci_id@p ;
...
position p;
@@
 enum net_attach_type { NET_ATTACH_TYPE_XDP , NET_ATTACH_TYPE_XDP_GENERIC , NET_ATTACH_TYPE_XDP_DRIVER , NET_ATTACH_TYPE_XDP_OFFLOAD , } cocci_id@p ;
