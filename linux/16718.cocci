...
position p;
@@
 struct mcs_touchkey_chip {  unsigned int status_reg ;  unsigned int pressbit ;  unsigned int press_invert ;  unsigned int baseval ; } cocci_id@p ;
...
position p;
@@
 struct mcs_touchkey_chip * cocci_id@p ;
...
position p;
@@
 const struct mcs_platform_data * cocci_id@p ;
...
position p;
@@
 struct mcs_touchkey_data {  void ( * poweron ) ( ) ;  struct i2c_client * client ;  struct input_dev * input_dev ;  struct mcs_touchkey_chip chip ;  unsigned int key_code ;  unsigned int key_val ;  unsigned short keycodes [ ] ; } cocci_id@p ;
...
position p;
@@
 enum mcs_touchkey_type { MCS5000_TOUCHKEY , MCS5080_TOUCHKEY , } cocci_id@p ;
...
position p;
@@
 struct mcs_touchkey_data * cocci_id@p ;
