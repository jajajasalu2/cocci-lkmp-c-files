...
position p;
@@
 struct etm4_enable_arg cocci_id@p ;
...
position p;
@@
 struct etmv4_save_state * cocci_id@p ;
...
position p;
@@
 struct etmv4_config cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct etmv4_config * config ) ;
...
position p;
@@
 struct etmv4_drvdata * cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct etm4_enable_arg {  struct etmv4_drvdata * drvdata ;  int rc ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct etmv4_drvdata * drvdata , struct perf_event * event ) ;
...
position p;
@@
 struct amba_cs_uci_id cocci_id@p [ ] ;
...
position p;
@@
 struct etmv4_drvdata * cocci_id@p ;
