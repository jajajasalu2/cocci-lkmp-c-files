...
position p;
@@
 char cocci_id@p [ DIAG308_VMPARM_SIZE + 1 ] ;
...
position p;
@@
 unsigned long cocci_id@p ( early_ipl_comp_list_size ) ;
...
position p;
@@
 struct shutdown_trigger * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( ipl_cert_list_addr ) ;
...
position p;
@@
 struct shutdown_action {  char * name ;  void ( * fn ) ( struct shutdown_trigger * trigger ) ;  int ( * init ) ( void ) ;  int init_rc ; } cocci_id@p ;
...
position p;
@@
 struct ipl_parameter_block cocci_id@p ( ipl_block ) ;
...
position p;
@@
 struct shutdown_action * cocci_id@p [ ] ;
...
position p;
@@
 unsigned long cocci_id@p ( early_ipl_comp_list_addr ) ;
...
position p;
@@
 int cocci_id@p ( ipl_secure_flag ) ;
...
position p;
@@
 struct ipl_report_certificate * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( ipl_cert_list_size ) ;
...
position p;
@@
 struct ipl_report_component * cocci_id@p ;
...
position p;
@@
 struct shutdown_trigger {  char * name ;  struct shutdown_action * action ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NSS_NAME_SIZE + 1 ] ;
...
position p;
@@
 char cocci_id@p [ LOADPARM_LEN + 1 ] ;
...
position p;
@@
 struct ipl_rb_components cocci_id@p ;
...
position p;
@@
 struct ipl_rb_certificates cocci_id@p ;
...
position p;
@@
 struct sclp_ipl_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( ipl_block_valid ) ;
...
position p;
@@
 struct ipl_parameter_block * cocci_id@p ;
...
position p;
@@
 enum dump_type { DUMP_TYPE_NONE = 1 , DUMP_TYPE_CCW = 2 , DUMP_TYPE_FCP = 4 , } cocci_id@p ;
