...
position p;
@@
 const struct broken_edid cocci_id@p [ ] ;
...
position p;
@@
 const struct fb_monspecs * cocci_id@p ;
...
typedef u32;
@@
 struct __fb_timings {  u32 dclk ;  u32 hfreq ;  u32 vfreq ;  u32 hactive ;  u32 vactive ;  u32 hblank ;  u32 vblank ;  u32 htotal ;  u32 vtotal ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct broken_edid {  u8 manufacturer [ 4 ] ;  u32 model ;  u32 fix ; } cocci_id@p ;
