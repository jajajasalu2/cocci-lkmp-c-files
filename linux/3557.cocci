...
position p;
@@
 struct dw_mci_zx_priv_data {  struct regmap * sysc_base ; } cocci_id@p ;
...
position p;
@@
 enum delay_type { DELAY_TYPE_READ , DELAY_TYPE_CLK , } cocci_id@p ;
...
position p;
@@
 struct dw_mci_zx_priv_data * cocci_id@p ;
