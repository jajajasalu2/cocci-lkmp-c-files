...
position p;
@@
 struct sti_gdp_node_list * cocci_id@p ;
...
typedef u32;
@@
 struct sti_gdp_node {  u32 gam_gdp_ctl ;  u32 gam_gdp_agc ;  u32 reserved1 ;  u32 gam_gdp_vpo ;  u32 gam_gdp_vps ;  u32 gam_gdp_pml ;  u32 gam_gdp_pmp ;  u32 gam_gdp_size ;  u32 reserved2 ;  u32 gam_gdp_nvn ;  u32 gam_gdp_key1 ;  u32 gam_gdp_key2 ;  u32 reserved3 ;  u32 gam_gdp_ppt ;  u32 reserved4 ;  u32 gam_gdp_cml ; } cocci_id@p ;
...
position p;
@@
 struct drm_gem_cma_object * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct sti_gdp_node_list {  struct sti_gdp_node * top_field ;  dma_addr_t top_field_paddr ;  struct sti_gdp_node * btm_field ;  dma_addr_t btm_field_paddr ; } cocci_id@p ;
...
position p;
@@
 struct sti_compositor * cocci_id@p ;
...
position p;
@@
 struct sti_gdp_node cocci_id@p ;
...
position p;
@@
 struct gdp_format_to_str {  int format ;  char name [ 20 ] ; } cocci_id@p [ ] ;
...
typedef bool;
@@
 struct sti_gdp {  struct sti_plane plane ;  struct device * dev ;  void __iomem * regs ;  struct clk * clk_pix ;  struct clk * clk_main_parent ;  struct clk * clk_aux_parent ;  struct notifier_block vtg_field_nb ;  bool is_curr_top ;  struct sti_gdp_node_list node_list [ GDP_NODE_NB_BANK ] ;  struct sti_vtg * vtg ; } cocci_id@p ;
