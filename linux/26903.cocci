...
position p;
@@
 enum afs_lock_state cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct afs_vnode * vnode , int error ) ;
...
position p;
@@
 enum afs_flock_mode cocci_id@p ;
...
position p;
@@
 enum afs_flock_operation cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct file_lock * new , struct file_lock * fl ) ;
...
position p;
@@
 void cocci_id@p ( struct file_lock * fl ) ;
