...
position p;
@@
 enum at91_devtype { AT91_DEVTYPE_SAM9263 , AT91_DEVTYPE_SAM9X5 , } cocci_id@p ;
...
position p;
@@
 const struct at91_devtype_data cocci_id@p ;
...
position p;
@@
 const struct at91_priv * cocci_id@p ;
...
position p;
@@
 enum at91_mb_mode { AT91_MB_MODE_DISABLED = 0 , AT91_MB_MODE_RX = 1 , AT91_MB_MODE_RX_OVRWR = 2 , AT91_MB_MODE_TX = 3 , AT91_MB_MODE_CONSUMER = 4 , AT91_MB_MODE_PRODUCER = 5 , } cocci_id@p ;
...
typedef u32,canid_t;
@@
 struct at91_priv {  struct can_priv can ;  struct napi_struct napi ;  void __iomem * reg_base ;  u32 reg_sr ;  unsigned int tx_next ;  unsigned int tx_echo ;  unsigned int rx_next ;  struct at91_devtype_data devtype_data ;  struct clk * clk ;  struct at91_can_data * pdata ;  canid_t mb0_id ; } cocci_id@p ;
...
position p;
@@
 struct at91_devtype_data {  unsigned int rx_first ;  unsigned int rx_split ;  unsigned int rx_last ;  unsigned int tx_shift ;  enum at91_devtype type ; } cocci_id@p ;
...
position p;
@@
 enum at91_reg { AT91_MR = 0x000 , AT91_IER = 0x004 , AT91_IDR = 0x008 , AT91_IMR = 0x00C , AT91_SR = 0x010 , AT91_BR = 0x014 , AT91_TIM = 0x018 , AT91_TIMESTP = 0x01C , AT91_ECR = 0x020 , AT91_TCR = 0x024 , AT91_ACR = 0x028 , } cocci_id@p ;
...
position p;
@@
 const struct can_bittiming * cocci_id@p ;
