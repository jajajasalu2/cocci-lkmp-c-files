...
position p;
@@
 struct mwifiex_ie_types_chan_rpt_data * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_chan_rpt_req cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_chan_rpt_event cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_pwr_capability * cocci_id@p ;
...
position p;
@@
 struct mwifiex_radar_det_event * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_local_pwr_constraint * cocci_id@p ;
