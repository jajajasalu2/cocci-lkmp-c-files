...
position p;
@@
 struct ata_acpi_gtf * cocci_id@p ;
...
position p;
@@
 struct ata_acpi_gtm * cocci_id@p ;
...
position p;
@@
 const struct ata_acpi_gtf * cocci_id@p ;
...
position p;
@@
 struct ata_acpi_hotplug_context {  struct acpi_hotplug_context hp ;  union {  struct ata_port * ap ;  struct ata_device * dev ; } data ; } cocci_id@p ;
...
position p;
@@
 struct ata_acpi_hotplug_context cocci_id@p ;
...
position p;
@@
 const struct ata_acpi_gtm * cocci_id@p ;
