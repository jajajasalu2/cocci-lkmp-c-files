...
position p;
@@
 struct applesmc_entry * cocci_id@p ;
...
position p;
@@
 struct applesmc_registers * cocci_id@p ;
...
position p;
@@
 struct applesmc_node_group cocci_id@p [ ] ;
...
position p;
@@
 struct applesmc_node_group {  char * format ;  void * show ;  void * store ;  int option ;  struct applesmc_dev_attr * nodes ; } cocci_id@p ;
...
position p;
@@
 const struct applesmc_entry * cocci_id@p ;
...
typedef u8;
@@
 struct applesmc_entry {  char key [ 5 ] ;  u8 valid ;  u8 len ;  char type [ 5 ] ;  u8 flags ; } cocci_id@p ;
...
typedef bool;
@@
 struct applesmc_registers {  struct mutex mutex ;  unsigned int key_count ;  unsigned int fan_count ;  unsigned int temp_count ;  unsigned int temp_begin ;  unsigned int temp_end ;  unsigned int index_count ;  int num_light_sensors ;  bool has_accelerometer ;  bool has_key_backlight ;  bool init_complete ;  struct applesmc_entry * cache ;  const char * * index ; } cocci_id@p ;
...
position p;
@@
 struct applesmc_dev_attr {  struct sensor_device_attribute sda ;  char name [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct applesmc_dev_attr * cocci_id@p ;
