...
@@
 struct qcom_scm_current_perm_info {  __le32 vmid ;  __le32 perm ;  __le64 ctx ;  __le32 ctx_size ;  __le32 unused ; } cocci_id@p ;
...
position p;
@@
 struct qcom_scm_current_perm_info * cocci_id@p ;
...
position p;
@@
 const struct qcom_scm_vmperm * cocci_id@p ;
...
position p;
@@
 enum qcom_scm_ocmem_client cocci_id@p ;
...
typedef __le64;
@@
 struct qcom_scm_mem_map_info {  __le64 mem_addr ;  __le64 mem_size ; } cocci_id@p ;
...
position p;
@@
 struct qcom_scm_mem_map_info * cocci_id@p ;
...
typedef u64;
@@
 struct qcom_scm {  struct device * dev ;  struct clk * core_clk ;  struct clk * iface_clk ;  struct clk * bus_clk ;  struct reset_controller_dev reset ;  u64 dload_mode_addr ; } cocci_id@p ;
