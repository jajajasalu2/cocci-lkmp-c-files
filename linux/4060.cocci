...
position p;
@@
 struct pdc_pin_region * cocci_id@p ;
...
position p;
@@
 enum pdc_irq_config_bits cocci_id@p ;
...
position p;
@@
 enum pdc_irq_config_bits { PDC_LEVEL_LOW = 0b000 , PDC_EDGE_FALLING = 0b010 , PDC_LEVEL_HIGH = 0b100 , PDC_EDGE_RISING = 0b110 , PDC_EDGE_DUAL = 0b111 , } cocci_id@p ;
...
typedef u32;
@@
 struct pdc_pin_region {  u32 pin_base ;  u32 parent_base ;  u32 cnt ; } cocci_id@p ;
