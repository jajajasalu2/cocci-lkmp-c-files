...
position p;
@@
 struct nf_flow_route * cocci_id@p ;
...
position p;
@@
 struct nft_flow_offload * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_FLOW_MAX + 1 ] ;
...
position p;
@@
 struct nft_flow_offload {  struct nft_flowtable * flowtable ; } cocci_id@p ;
