...
position p;
@@
 void cocci_id@p ( struct MPT3SAS_ADAPTER * ioc , struct _pcie_device * pcie_device ) ;
...
symbol cocci_id;
position p;
typedef Mpi25EventDataSasDeviceDiscoveryError_t;
@@
 Mpi25EventDataSasDeviceDiscoveryError_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi26PCIeDevicePage2_t;
@@
 Mpi26PCIeDevicePage2_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SasIOUnitPage1_t;
@@
 Mpi2SasIOUnitPage1_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SCSIIOReply_t;
@@
 Mpi2SCSIIOReply_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SepReply_t;
@@
 Mpi2SepReply_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventAckRequest_t;
@@
 Mpi2EventAckRequest_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi26PCIeDevicePage0_t;
@@
 Mpi26PCIeDevicePage0_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SasIoUnitControlRequest_t;
@@
 Mpi2SasIoUnitControlRequest_t * cocci_id@p ;
...
position p;
@@
 struct pci_error_handlers cocci_id@p ;
...
position p;
@@
 struct _pcie_device * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi26EventDataPCIeTopologyChangeList_t;
@@
 Mpi26EventDataPCIeTopologyChangeList_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataSasDeviceStatusChange_t;
@@
 Mpi2EventDataSasDeviceStatusChange_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct MPT3SAS_ADAPTER * ioc , struct _sas_device * sas_device ) ;
...
position p;
@@
 struct raid_function_template cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2BiosPage2BootDevice_t;
@@
 Mpi2BiosPage2BootDevice_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SCSITaskManagementRequest_t;
@@
 Mpi2SCSITaskManagementRequest_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataIrPhysicalDisk_t;
@@
 Mpi2EventDataIrPhysicalDisk_t * cocci_id@p ;
...
typedef u8;
@@
 struct sense_info {  u8 skey ;  u8 asc ;  u8 ascq ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataSasDiscovery_t;
@@
 Mpi2EventDataSasDiscovery_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SasDevicePage0_t;
@@
 Mpi2SasDevicePage0_t cocci_id@p ;
...
position p;
@@
 struct _event_ack_list * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2RaidActionReply_t;
@@
 Mpi2RaidActionReply_t * cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct MPT3SAS_ADAPTER * ioc , u16 handle ) ;
...
position p;
@@
 struct _enclosure_node cocci_id@p ;
...
position p;
@@
 struct MPT3SAS_DEVICE * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventNotificationReply_t;
@@
 Mpi2EventNotificationReply_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SasPhyPage0_t;
@@
 Mpi2SasPhyPage0_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2ExpanderPage0_t;
@@
 Mpi2ExpanderPage0_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct MPT3SAS_ADAPTER * ioc , struct _sas_node * sas_expander ) ;
...
position p;
@@
 struct scsiio_tracker * cocci_id@p ;
...
position p;
@@
 struct MPT3SAS_ADAPTER cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi26EventDataPCIeEnumeration_t;
@@
 Mpi26EventDataPCIeEnumeration_t * cocci_id@p ;
...
typedef u8,u16;
@@
 int cocci_id@p ( struct MPT3SAS_ADAPTER * ioc , u16 handle , u8 retry_count , u8 is_pd ) ;
...
symbol cocci_id;
position p;
typedef Mpi2RaidVolPage0_t;
@@
 Mpi2RaidVolPage0_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataIrVolume_t;
@@
 Mpi2EventDataIrVolume_t * cocci_id@p ;
...
position p;
@@
 struct fw_event_work * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataSasEnclDevStatusChange_t;
@@
 Mpi2EventDataSasEnclDevStatusChange_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SasIOUnitPage0_t;
@@
 Mpi2SasIOUnitPage0_t cocci_id@p ;
...
position p;
@@
 struct _raid_device * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2RaidActionRequest_t;
@@
 Mpi2RaidActionRequest_t * cocci_id@p ;
...
typedef u8,u16;
@@
 u8 cocci_id@p ( struct MPT3SAS_ADAPTER * ioc , u16 smid ) ;
...
symbol cocci_id;
position p;
typedef MPI2DefaultReply_t;
@@
 MPI2DefaultReply_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2BootDeviceSasWwid_t;
@@
 Mpi2BootDeviceSasWwid_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2RaidVolPage1_t;
@@
 Mpi2RaidVolPage1_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi25SCSIIORequest_t;
@@
 Mpi25SCSIIORequest_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataLogEntryAdded_t;
@@
 Mpi2EventDataLogEntryAdded_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataSasBroadcastPrimitive_t;
@@
 Mpi2EventDataSasBroadcastPrimitive_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataIrOperationStatus_t;
@@
 Mpi2EventDataIrOperationStatus_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SCSITaskManagementReply_t;
@@
 Mpi2SCSITaskManagementReply_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataSasTopologyChangeList_t;
@@
 Mpi2EventDataSasTopologyChangeList_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2RaidPhysDiskPage0_t;
@@
 Mpi2RaidPhysDiskPage0_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2ExpanderPage1_t;
@@
 Mpi2ExpanderPage1_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventIrConfigElement_t;
@@
 Mpi2EventIrConfigElement_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataIrConfigChangeList_t;
@@
 Mpi2EventDataIrConfigChangeList_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2BootDeviceEnclosureSlot_t;
@@
 Mpi2BootDeviceEnclosureSlot_t * cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct MPT3SAS_ADAPTER * ioc , u16 handle ) ;
...
symbol cocci_id;
position p;
typedef Mpi2ConfigReply_t;
@@
 Mpi2ConfigReply_t cocci_id@p ;
...
position p;
@@
 struct SL_WH_TRIGGERS_EVENT_DATA_T * cocci_id@p ;
...
position p;
@@
 struct MPT3SAS_TARGET * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi26EventDataPCIeDeviceStatusChange_t;
@@
 Mpi26EventDataPCIeDeviceStatusChange_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SasEnclosurePage0_t;
@@
 Mpi2SasEnclosurePage0_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SepRequest_t;
@@
 Mpi2SepRequest_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi26EventDataActiveCableExcept_t;
@@
 Mpi26EventDataActiveCableExcept_t * cocci_id@p ;
...
position p;
@@
 struct raid_template * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2BootDeviceDeviceName_t;
@@
 Mpi2BootDeviceDeviceName_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SasIoUnitControlReply_t;
@@
 Mpi2SasIoUnitControlReply_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2EventDataTemperature_t;
@@
 Mpi2EventDataTemperature_t * cocci_id@p ;
