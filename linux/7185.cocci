...
position p;
@@
 struct gpio_extcon_data cocci_id@p ;
...
typedef bool;
@@
 struct gpio_extcon_data {  struct extcon_dev * edev ;  struct delayed_work work ;  unsigned long debounce_jiffies ;  struct gpio_desc * gpiod ;  unsigned int extcon_id ;  unsigned long debounce ;  bool check_on_resume ; } cocci_id@p ;
