...
position p;
@@
 const struct meson_clk_dualdiv_param cocci_id@p [ ] ;
...
position p;
@@
 struct meson_clk_dualdiv_data cocci_id@p ;
...
position p;
@@
 const struct clk_hw_onecell_data cocci_id@p ;
...
position p;
@@
 const struct meson_aoclk_data cocci_id@p ;
