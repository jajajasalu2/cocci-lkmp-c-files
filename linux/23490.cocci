...
position p;
@@
 struct sst_module_runtime * cocci_id@p ;
...
position p;
@@
 struct sst_module_runtime_context * cocci_id@p ;
...
position p;
@@
 const struct sst_block_ops * cocci_id@p ;
...
position p;
@@
 struct sst_dma {  struct sst_dsp * sst ;  struct dw_dma_chip * chip ;  struct dma_async_tx_descriptor * desc ;  struct dma_chan * ch ; } cocci_id@p ;
...
position p;
@@
 struct sst_block_allocator * cocci_id@p ;
...
position p;
@@
 struct sst_mem_block * cocci_id@p ;
