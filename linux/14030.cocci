...
@@
 struct cafe_camera {  int registered ;  struct mcam_camera mcam ;  struct pci_dev * pdev ;  struct i2c_adapter * i2c_adapter ;  wait_queue_head_t smbus_wait ; } cocci_id@p ;
