...
@@
 struct xchk_agfl_info {  unsigned int sz_entries ;  unsigned int nr_entries ;  xfs_agblock_t * entries ;  struct xfs_scrub * sc ; } cocci_id@p ;
...
typedef xfs_agblock_t;
@@
 const xfs_agblock_t * cocci_id@p ;
...
position p;
@@
 struct xchk_agfl_info cocci_id@p ;
