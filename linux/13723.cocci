...
position p;
@@
 enum { S5K6A3_SUPP_VDDA , S5K6A3_SUPP_VDDIO , S5K6A3_SUPP_AFVDD , S5K6A3_NUM_SUPPLIES , } cocci_id@p ;
...
typedef u32;
@@
 struct s5k6a3 {  struct device * dev ;  struct v4l2_subdev subdev ;  struct media_pad pad ;  struct regulator_bulk_data supplies [ S5K6A3_NUM_SUPPLIES ] ;  int gpio_reset ;  struct mutex lock ;  struct v4l2_mbus_framefmt format ;  struct clk * clock ;  u32 clock_frequency ;  int power_count ; } cocci_id@p ;
