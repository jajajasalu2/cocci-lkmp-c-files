...
position p;
@@
 const struct lock_stat_data * cocci_id@p ;
...
position p;
@@
 struct lock_stat_data * cocci_id@p ;
...
position p;
@@
 struct lock_stat_seq cocci_id@p ;
...
position p;
@@
 struct lock_stat_seq {  struct lock_stat_data * iter_end ;  struct lock_stat_data stats [ MAX_LOCKDEP_KEYS ] ; } cocci_id@p ;
...
position p;
@@
 struct lock_stat_data {  struct lock_class * class ;  struct lock_class_stats stats ; } cocci_id@p ;
