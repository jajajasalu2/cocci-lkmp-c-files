...
position p;
@@
 void cocci_id@p ( struct se_device * , struct se_node_acl * , struct t10_pr_registration * , int , int ) ;
...
position p;
@@
 enum register_type { REGISTER , REGISTER_AND_IGNORE_EXISTING_KEY , REGISTER_AND_MOVE , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct se_dev_entry * ) ;
...
position p;
@@
 void cocci_id@p ( struct se_dev_entry * ) ;
...
position p;
@@
 char cocci_id@p [ PR_REG_ISID_ID_LEN ] ;
...
position p;
@@
 unsigned char cocci_id@p [ PR_APTPL_MAX_IPORT_LEN ] ;
...
position p;
@@
 struct t10_pr_registration * cocci_id@p ;
...
position p;
@@
 struct pr_transport_id_holder cocci_id@p ;
...
position p;
@@
 struct se_dev_entry * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ PR_APTPL_MAX_TPORT_LEN ] ;
...
position p;
@@
 unsigned char cocci_id@p [ PR_REG_ISID_LEN ] ;
...
position p;
@@
 struct t10_pr_registration * cocci_id@p ( struct se_device * , struct se_node_acl * , struct se_session * ) ;
...
position p;
@@
 enum preempt_type { PREEMPT , PREEMPT_AND_ABORT , } cocci_id@p ;
...
position p;
@@
 struct t10_reservation * cocci_id@p ;
...
position p;
@@
 struct pr_transport_id_holder {  struct t10_pr_registration * dest_pr_reg ;  struct se_portal_group * dest_tpg ;  struct se_node_acl * dest_node_acl ;  struct se_dev_entry * dest_se_deve ;  struct list_head dest_list ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct t10_pr_registration * ) ;
...
position p;
@@
 void cocci_id@p ( struct se_device * , struct se_node_acl * , struct t10_pr_registration * , enum register_type , int ) ;
