...
position p;
@@
 const struct panel_funcs * cocci_id@p ;
...
position p;
@@
 struct mdfld_dsi_config cocci_id@p ;
...
position p;
@@
 struct mdfld_dsi_encoder * cocci_id@p ;
...
position p;
@@
 struct mdfld_dsi_connector cocci_id@p ;
...
position p;
@@
 struct mdfld_dsi_pkg_sender * cocci_id@p ;
