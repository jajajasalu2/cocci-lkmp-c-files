...
position p;
@@
 struct tps65217_charger {  struct tps65217 * tps ;  struct device * dev ;  struct power_supply * psy ;  int online ;  int prev_online ;  struct task_struct * poll_task ; } cocci_id@p ;
...
position p;
@@
 struct tps65217_charger * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ NUM_CHARGER_IRQS ] ;
