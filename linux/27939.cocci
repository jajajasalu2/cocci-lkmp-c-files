...
position p;
@@
 struct nilfs_binfo_dat cocci_id@p ;
...
position p;
@@
 struct nilfs_binfo_v cocci_id@p ;
...
position p;
@@
 const struct nilfs_sc_operations * cocci_id@p ;
...
position p;
@@
 struct nilfs_checkpoint * cocci_id@p ;
...
position p;
@@
 enum { NILFS_ST_INIT = 0 , NILFS_ST_GC , NILFS_ST_FILE , NILFS_ST_IFILE , NILFS_ST_CPFILE , NILFS_ST_SUFILE , NILFS_ST_DAT , NILFS_ST_SR , NILFS_ST_DSYNC , NILFS_ST_DONE , } cocci_id@p ;
...
position p;
@@
 struct nilfs_inode_info cocci_id@p ;
...
position p;
@@
 struct nilfs_segsum_pointer * cocci_id@p ;
...
position p;
@@
 struct nilfs_segctor_wait_request cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u32,wait_queue_entry_t,atomic_t;
@@
 struct nilfs_segctor_wait_request {  wait_queue_entry_t wq ;  __u32 seq ;  int err ;  atomic_t done ; } cocci_id@p ;
...
position p;
@@
 struct nilfs_cstage cocci_id@p ;
...
position p;
@@
 const struct nilfs_segsum_pointer * cocci_id@p ;
...
position p;
@@
 struct nilfs_segment_summary cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct nilfs_sc_info * , struct buffer_head * , struct inode * ) ;
...
position p;
@@
 struct nilfs_inode_info * cocci_id@p [ SC_N_INODEVEC ] ;
...
position p;
@@
 void cocci_id@p ( struct nilfs_sc_info * ) ;
...
position p;
@@
 struct nilfs_sc_operations {  int ( * collect_data ) ( struct nilfs_sc_info * , struct buffer_head * , struct inode * ) ;  int ( * collect_node ) ( struct nilfs_sc_info * , struct buffer_head * , struct inode * ) ;  int ( * collect_bmap ) ( struct nilfs_sc_info * , struct buffer_head * , struct inode * ) ;  void ( * write_data_binfo ) ( struct nilfs_sc_info * , struct nilfs_segsum_pointer * , union nilfs_binfo * ) ;  void ( * write_node_binfo ) ( struct nilfs_sc_info * , struct nilfs_segsum_pointer * , union nilfs_binfo * ) ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nilfs_sc_info * , int ) ;
...
position p;
@@
 struct nilfs_transaction_info cocci_id@p ;
...
position p;
@@
 struct nilfs_super_block * * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct the_nilfs * , struct list_head * , int ) ;
...
position p;
@@
 struct nilfs_segment_buffer * cocci_id@p ;
...
position p;
@@
 enum { SC_LSEG_SR = 1 , SC_LSEG_DSYNC , SC_FLUSH_FILE , SC_FLUSH_DAT , } cocci_id@p ;
...
position p;
@@
 struct nilfs_sc_info * cocci_id@p ;
...
position p;
@@
 struct nilfs_super_root * cocci_id@p ;
