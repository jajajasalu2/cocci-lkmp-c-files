...
position p;
@@
 struct kfd_perf_attr cocci_id@p ;
...
position p;
@@
 struct kfd_system_properties cocci_id@p ;
...
position p;
@@
 const struct kgd_dev * cocci_id@p ;
...
position p;
@@
 struct kfd_perf_properties * cocci_id@p ;
...
typedef uint32_t;
@@
 struct kfd_perf_attr {  struct kobj_attribute attr ;  uint32_t data ; } cocci_id@p ;
