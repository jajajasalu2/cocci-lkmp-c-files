...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_CT_MAX + 1 ] ;
...
typedef bool;
@@
 struct tc_ct_action_net {  struct tc_action_net tn ;  bool labels ; } cocci_id@p ;
...
position p;
@@
 struct tc_ct_action_net * cocci_id@p ;
...
position p;
@@
 struct tcf_ct_params cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_CT_MAX + 1 ] ;
