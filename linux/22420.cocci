...
typedef __le32,u16;
@@
 struct atiixp_dma_desc {  __le32 addr ;  u16 status ;  u16 size ;  __le32 next ; } cocci_id@p ;
...
position p;
@@
 const struct atiixp_dma_ops cocci_id@p ;
...
position p;
@@
 enum { ATI_DMA_PLAYBACK , ATI_DMA_CAPTURE , ATI_DMA_SPDIF , NUM_ATI_DMAS , } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ NUM_ATI_CODECS ] ;
...
position p;
@@
 struct atiixp_dma_desc * cocci_id@p ;
...
position p;
@@
 enum { ATI_PCMDEV_ANALOG , ATI_PCMDEV_DIGITAL , NUM_ATI_PCMDEVS , } cocci_id@p ;
...
position p;
@@
 enum { ATI_PCM_OUT , ATI_PCM_IN , ATI_PCM_SPDIF , NUM_ATI_PCMS , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct atiixp {  struct snd_card * card ;  struct pci_dev * pci ;  unsigned long addr ;  void __iomem * remap_addr ;  int irq ;  struct snd_ac97_bus * ac97_bus ;  struct snd_ac97 * ac97 [ NUM_ATI_CODECS ] ;  spinlock_t reg_lock ;  struct atiixp_dma dmas [ NUM_ATI_DMAS ] ;  struct ac97_pcm * pcms [ NUM_ATI_PCMS ] ;  struct snd_pcm * pcmdevs [ NUM_ATI_PCMDEVS ] ;  int max_channels ;  unsigned int codec_not_ready_bits ;  int spdif_over_aclink ;  struct mutex open_mutex ; } cocci_id@p ;
