...
position p;
@@
 const struct cs35l36_global_fs_config cocci_id@p [ ] ;
...
position p;
@@
 const struct cs35l36_pll_config * cocci_id@p ;
...
position p;
@@
 struct cs35l36_vpbr_cfg * cocci_id@p ;
...
position p;
@@
 struct cs35l36_pll_config {  int freq ;  int clk_cfg ;  int fll_igain ; } cocci_id@p ;
...
position p;
@@
 struct cs35l36_private cocci_id@p ;
...
position p;
@@
 struct cs35l36_global_fs_config {  int rate ;  int fs_cfg ; } cocci_id@p ;
...
position p;
@@
 struct cs35l36_platform_data * cocci_id@p ;
...
position p;
@@
 struct cs35l36_private {  struct device * dev ;  struct cs35l36_platform_data pdata ;  struct regmap * regmap ;  struct regulator_bulk_data supplies [ 2 ] ;  int num_supplies ;  int clksrc ;  int chip_version ;  int rev_id ;  int ldm_mode_sel ;  struct gpio_desc * reset_gpio ; } cocci_id@p ;
