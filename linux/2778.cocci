...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct i2c_mux_core * , u32 ) ;
...
typedef u32;
@@
 struct i2c_mux_priv {  struct i2c_adapter adap ;  struct i2c_algorithm algo ;  struct i2c_mux_core * muxc ;  u32 chan_id ; } cocci_id@p ;
...
position p;
@@
 struct i2c_mux_priv * cocci_id@p ;
