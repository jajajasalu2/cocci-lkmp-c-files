...
position p;
@@
 struct hclge_mdio_cfg_cmd * cocci_id@p ;
...
typedef u8;
@@
 struct hclge_mdio_cfg_cmd {  u8 ctrl_bit ;  u8 phyid ;  u8 phyad ;  u8 rsvd ;  __le16 reserve ;  __le16 data_wr ;  __le16 data_rd ;  __le16 sta ; } cocci_id@p ;
...
position p;
@@
 enum hclge_mdio_c22_op_seq { HCLGE_MDIO_C22_WRITE = 1 , HCLGE_MDIO_C22_READ = 2 , } cocci_id@p ;
