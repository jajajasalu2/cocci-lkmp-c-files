...
position p;
@@
 struct device_node * cocci_id@p [ FDT_MAX_DEPTH ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long node , const char * uname , void * data ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long node , const char * uname , int depth , void * data ) ;
...
position p;
@@
 const void * ( * cocci_id@p ) ( const char * const * * ) ;
...
position p;
@@
 const struct earlycon_id * cocci_id@p ;
...
typedef u64;
@@
 void * ( * cocci_id@p ) ( u64 size , u64 align ) ;
