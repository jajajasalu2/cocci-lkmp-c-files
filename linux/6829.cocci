...
typedef u8;
@@
 struct aac_reset_iop {  u8 reset_type ; } cocci_id@p ;
...
position p;
@@
 struct aac_pci_info cocci_id@p ;
...
position p;
@@
 void * cocci_id@p [ HBA_MAX_SG_EMBEDDED ] ;
...
position p;
@@
 struct aac_fib_context cocci_id@p ;
...
position p;
@@
 struct aac_hba_info cocci_id@p ;
...
position p;
@@
 struct user_sgentry cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ HBA_MAX_SG_EMBEDDED ] ;
...
position p;
@@
 struct user_sgmap64 * cocci_id@p ;
...
position p;
@@
 struct user_aac_srb * cocci_id@p ;
...
position p;
@@
 struct aac_reset_iop cocci_id@p ;
...
typedef u32;
@@
 struct aac_pci_info {  u32 bus ;  u32 slot ; } cocci_id@p ;
