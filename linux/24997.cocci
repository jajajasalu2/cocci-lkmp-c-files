...
position p;
@@
 int ( * cocci_id@p ) ( struct sk_buff * skb , struct batadv_hard_iface * recv_if ) ;
...
position p;
@@
 enum batadv_uev_type cocci_id@p ;
...
position p;
@@
 const struct batadv_hard_iface * cocci_id@p ;
...
position p;
@@
 struct batadv_icmp_packet_rr cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ 256 ] ) ( struct sk_buff * skb , struct batadv_hard_iface * recv_if ) ;
...
position p;
@@
 struct batadv_bla_claim_dst cocci_id@p ;
...
position p;
@@
 struct batadv_skb_cb cocci_id@p ;
...
position p;
@@
 enum batadv_uev_action cocci_id@p ;
...
position p;
@@
 struct batadv_ogm_packet * cocci_id@p ;
...
position p;
@@
 struct batadv_icmp_header cocci_id@p ;
...
position p;
@@
 struct batadv_tvlv_gateway_data cocci_id@p ;
...
position p;
@@
 struct batadv_frag_packet cocci_id@p ;
...
position p;
@@
 struct batadv_icmp_packet cocci_id@p ;
...
position p;
@@
 struct batadv_coded_packet cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sk_buff * , struct batadv_hard_iface * ) ;
