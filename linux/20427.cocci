...
position p;
@@
 const struct mtrr_ops * cocci_id@p [ X86_VENDOR_NUM ] ;
...
position p;
@@
 struct mtrr_value cocci_id@p [ MTRR_MAX_VAR_RANGES ] ;
...
position p;
@@
 const struct mtrr_ops * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MTRR_MAX_VAR_RANGES ] ;
...
position p;
@@
 struct set_mtrr_data * cocci_id@p ;
...
position p;
@@
 struct set_mtrr_data {  unsigned long smp_base ;  unsigned long smp_size ;  unsigned int smp_reg ;  mtrr_type smp_type ; } cocci_id@p ;
...
position p;
@@
 struct mtrr_value {  mtrr_type ltype ;  unsigned long lbase ;  unsigned long lsize ; } cocci_id@p ;
