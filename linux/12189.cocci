...
position p;
@@
 struct tegra_dc_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_crtc * crtc , struct drm_crtc_state * state ) ;
...
position p;
@@
 const struct tegra_dc_soc_info cocci_id@p ;
...
position p;
@@
 const struct tegra_windowgroup_soc * cocci_id@p ;
...
position p;
@@
 struct tegra_dc_stats * cocci_id@p ;
...
position p;
@@
 const struct tegra_dc_window * cocci_id@p ;
...
position p;
@@
 struct tegra_plane_state * cocci_id@p ;
...
position p;
@@
 struct tegra_bo_tiling * cocci_id@p ;
...
position p;
@@
 struct tegra_dc_window cocci_id@p ;
