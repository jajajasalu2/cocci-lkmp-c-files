...
position p;
@@
 int cocci_id@p ( char * val , const struct kernel_param * kp ) ;
...
position p;
@@
 struct dmatest_done * cocci_id@p ;
...
@@
 struct dmatest_thread {  struct list_head node ;  struct dmatest_info * info ;  struct task_struct * task ;  struct dma_chan * chan ;  struct dmatest_data src ;  struct dmatest_data dst ;  enum dma_transaction_type type ;  wait_queue_head_t done_wait ;  struct dmatest_done test_done ;  bool done ;  bool pending ; } cocci_id@p ;
...
typedef bool,wait_queue_head_t;
@@
 struct dmatest_done {  bool done ;  wait_queue_head_t * wait ; } cocci_id@p ;
...
position p;
@@
 struct dmatest_chan * cocci_id@p ;
...
position p;
@@
 struct dmatest_thread cocci_id@p ;
...
typedef u8;
@@
 struct dmatest_data {  u8 * * raw ;  u8 * * aligned ;  unsigned int cnt ;  unsigned int off ; } cocci_id@p ;
...
position p;
@@
 struct dmatest_chan {  struct list_head node ;  struct dma_chan * chan ;  struct list_head threads ; } cocci_id@p ;
...
position p;
@@
 struct dmatest_data * cocci_id@p ;
...
position p;
@@
 struct dmatest_params * cocci_id@p ;
...
position p;
@@
 struct dmatest_info * cocci_id@p ;
...
typedef bool;
@@
 struct dmatest_info {  struct dmatest_params params ;  struct list_head channels ;  unsigned int nr_channels ;  struct mutex lock ;  bool did_init ; } cocci_id@p ;
