...
position p;
@@
 enum jz4780_nemc_bank_type cocci_id@p ;
...
@@
 struct jz4780_nemc {  spinlock_t lock ;  struct device * dev ;  const struct jz_soc_info * soc_info ;  void __iomem * base ;  struct clk * clk ;  uint32_t clk_period ;  unsigned long banks_present ; } cocci_id@p ;
...
typedef u8;
@@
 struct jz_soc_info {  u8 tas_tah_cycles_max ; } cocci_id@p ;
