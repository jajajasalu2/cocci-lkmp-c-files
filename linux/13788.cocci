...
typedef u32;
@@
 struct adv7183 {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  v4l2_std_id std ;  u32 input ;  u32 output ;  unsigned reset_pin ;  unsigned oe_pin ;  struct v4l2_mbus_framefmt fmt ; } cocci_id@p ;
