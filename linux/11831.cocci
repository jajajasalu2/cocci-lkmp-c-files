...
position p;
@@
 struct gt215_clk {  struct nvkm_clk base ;  struct gt215_clk_info eng [ nv_clk_src_max ] ; } cocci_id@p ;
...
typedef bool,u32;
@@
 u32 cocci_id@p ( struct gt215_clk * , int , bool ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct gt215_clk * , int , u32 ) ;
