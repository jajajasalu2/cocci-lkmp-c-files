...
position p;
@@
 struct drm_i915_gem_sw_finish * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_madvise * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_get_aperture * cocci_id@p ;
...
position p;
@@
 const struct drm_i915_gem_pread * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_pread * cocci_id@p ;
...
position p;
@@
 struct drm_mode_create_dumb * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_pwrite * cocci_id@p ;
...
position p;
@@
 const struct drm_i915_gem_pwrite * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_create * cocci_id@p ;
...
position p;
@@
 struct i915_request * cocci_id@p [ I915_NUM_ENGINES ] ;
