...
position p;
@@
 struct throtl_qnode {  struct list_head node ;  struct bio_list bios ;  struct throtl_grp * tg ; } cocci_id@p ;
...
position p;
@@
 struct latency_bucket cocci_id@p ;
...
position p;
@@
 struct throtl_service_queue {  struct throtl_service_queue * parent_sq ;  struct list_head queued [ 2 ] ;  unsigned int nr_queued [ 2 ] ;  struct rb_root_cached pending_tree ;  unsigned int nr_pending ;  unsigned long first_pending_disptime ;  struct timer_list pending_timer ; } cocci_id@p ;
...
typedef bool;
@@
 struct avg_latency_bucket {  unsigned long latency ;  bool valid ; } cocci_id@p ;
...
position p;
@@
 struct throtl_service_queue * cocci_id@p ;
...
position p;
@@
 struct blkg_rwstat_sample cocci_id@p ;
...
position p;
@@
 enum { LIMIT_LOW , LIMIT_MAX , LIMIT_CNT , } cocci_id@p ;
...
position p;
@@
 struct throtl_qnode cocci_id@p ;
...
position p;
@@
 struct avg_latency_bucket cocci_id@p [ 2 ] [ LATENCY_BUCKET_SIZE ] ;
...
position p;
@@
 enum tg_state_flags { THROTL_TG_PENDING = 1 << 0 , THROTL_TG_WAS_EMPTY = 1 << 1 , } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct throtl_data * td , struct throtl_grp * this_tg ) ;
...
position p;
@@
 void cocci_id@p ( struct throtl_data * td ) ;
...
symbol cocci_id;
position p;
typedef bool,uint64_t;
@@
 struct throtl_grp {  struct blkg_policy_data pd ;  struct rb_node rb_node ;  struct throtl_data * td ;  struct throtl_service_queue service_queue ;  struct throtl_qnode qnode_on_self [ 2 ] ;  struct throtl_qnode qnode_on_parent [ 2 ] ;  unsigned long disptime ;  unsigned int flags ;  bool has_rules [ 2 ] ;  uint64_t bps [ 2 ] [ LIMIT_CNT ] ;  uint64_t bps_conf [ 2 ] [ LIMIT_CNT ] ;  unsigned int iops [ 2 ] [ LIMIT_CNT ] ;  unsigned int iops_conf [ 2 ] [ LIMIT_CNT ] ;  uint64_t bytes_disp [ 2 ] ;  unsigned int io_disp [ 2 ] ;  unsigned long last_low_overflow_time [ 2 ] ;  uint64_t last_bytes_disp [ 2 ] ;  unsigned int last_io_disp [ 2 ] ;  unsigned long last_check_time ;  unsigned long latency_target ;  unsigned long latency_target_conf ;  unsigned long slice_start [ 2 ] ;  unsigned long slice_end [ 2 ] ;  unsigned long last_finish_time ;  unsigned long checked_last_finish_time ;  unsigned long avg_idletime ;  unsigned long idletime_threshold ;  unsigned long idletime_threshold_conf ;  unsigned int bio_cnt ;  unsigned int bad_bio_cnt ;  unsigned long bio_cnt_reset_time ;  struct blkg_rwstat stat_bytes ;  struct blkg_rwstat stat_ios ; } cocci_id@p ;
...
position p;
@@
 struct latency_bucket {  unsigned long total_latency ;  int samples ; } cocci_id@p ;
...
typedef bool;
@@
 struct throtl_data {  struct throtl_service_queue service_queue ;  struct request_queue * queue ;  unsigned int nr_queued [ 2 ] ;  unsigned int throtl_slice ;  struct work_struct dispatch_work ;  unsigned int limit_index ;  bool limit_valid [ LIMIT_CNT ] ;  unsigned long low_upgrade_time ;  unsigned long low_downgrade_time ;  unsigned int scale ;  struct latency_bucket tmp_buckets [ 2 ] [ LATENCY_BUCKET_SIZE ] ;  struct avg_latency_bucket avg_buckets [ 2 ] [ LATENCY_BUCKET_SIZE ] ;  struct latency_bucket __percpu * latency_buckets [ 2 ] ;  unsigned long last_calculate_time ;  unsigned long filtered_latency ;  bool track_bio_latency ; } cocci_id@p ;
