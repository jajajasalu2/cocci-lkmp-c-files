...
position p;
@@
 struct hdmi_connector cocci_id@p ;
...
position p;
@@
 struct hdmi_connector {  struct drm_connector base ;  struct hdmi * hdmi ;  struct work_struct hpd_work ; } cocci_id@p ;
...
position p;
@@
 const struct hdmi_platform_config * cocci_id@p ;
...
position p;
@@
 struct hdmi_gpio_data cocci_id@p ;
