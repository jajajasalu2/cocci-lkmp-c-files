...
position p;
@@
 const struct p9_wstat * cocci_id@p ;
...
position p;
@@
 const struct p9_qid * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct p9_fcall * pdu , int proto_version , const char * fmt , ... ) ;
