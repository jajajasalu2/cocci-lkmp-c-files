...
position p;
@@
 void cocci_id@p ( struct cdns_dp_phy * cdns_phy , unsigned int offset , unsigned char start_bit , unsigned char num_bits , unsigned int val ) ;
...
typedef u32;
@@
 struct cdns_dp_phy {  void __iomem * base ;  void __iomem * sd_base ;  u32 num_lanes ;  u32 max_bit_rate ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cdns_dp_phy * cdns_phy , unsigned int lane ) ;
...
position p;
@@
 void cocci_id@p ( struct cdns_dp_phy * cdns_phy ) ;
