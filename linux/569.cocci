...
position p;
@@
 struct pkcs1pad_inst_ctx * cocci_id@p ;
...
position p;
@@
 struct crypto_akcipher_spawn * cocci_id@p ;
...
position p;
@@
 struct pkcs1pad_ctx cocci_id@p ;
...
position p;
@@
 const struct rsa_asn1_template * cocci_id@p ;
...
position p;
@@
 struct pkcs1pad_request cocci_id@p ;
...
position p;
@@
 struct pkcs1pad_ctx {  struct crypto_akcipher * child ;  unsigned int key_size ; } cocci_id@p ;
...
position p;
@@
 struct pkcs1pad_inst_ctx {  struct crypto_akcipher_spawn spawn ;  const struct rsa_asn1_template * digest_info ; } cocci_id@p ;
...
position p;
@@
 struct akcipher_instance * cocci_id@p ;
...
typedef u8;
@@
 const struct rsa_asn1_template {  const char * name ;  const u8 * data ;  size_t size ; } cocci_id@p [ ] ;
