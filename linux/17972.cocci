...
symbol cocci_id;
position p;
typedef siginfo_extra_v8plus_t;
@@
 siginfo_extra_v8plus_t cocci_id@p ;
...
typedef u32;
@@
 struct sigstack32 {  u32 the_stack ;  int cur_status ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned int g_upper [ 8 ] ;  unsigned int o_upper [ 8 ] ;  unsigned int asi ; } cocci_id@p ;
