...
position p;
@@
 struct drm_tile_group * cocci_id@p ;
...
position p;
@@
 struct detailed_mode_closure cocci_id@p ;
...
typedef u32;
@@
 const struct edid_quirk {  char vendor [ 4 ] ;  int product_id ;  u32 quirks ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct stereo_mandatory_mode cocci_id@p [ ] ;
...
typedef bool,u32;
@@
 struct detailed_mode_closure {  struct drm_connector * connector ;  struct edid * edid ;  bool preferred ;  u32 quirks ;  int modes ; } cocci_id@p ;
...
position p;
@@
 struct detailed_pixel_timing * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_connector * connector , struct edid * edid ) ;
...
position p;
@@
 struct displayid_detailed_timings_1 * cocci_id@p ;
...
position p;
@@
 const struct {  int w , h ; } cocci_id@p [ ] ;
...
position p;
@@
 enum hdmi_picture_aspect cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct detailed_timing * timing , void * closure ) ;
...
position p;
@@
 struct minimode {  short w ;  short h ;  short r ;  short rb ; } cocci_id@p ;
...
position p;
@@
 struct displayid_block * cocci_id@p ;
...
position p;
@@
 struct displayid_hdr cocci_id@p ;
...
position p;
@@
 const struct edid_quirk * cocci_id@p ;
...
position p;
@@
 struct displayid_tiled_block * cocci_id@p ;
...
position p;
@@
 struct displayid_detailed_timing_block * cocci_id@p ;
...
position p;
@@
 enum hdmi_quantization_range cocci_id@p ;
...
position p;
@@
 enum hdmi_3d_structure cocci_id@p ;
...
position p;
@@
 struct hdr_output_metadata * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_display_mode * mode ) ;
...
typedef u8;
@@
 int cocci_id@p ( u8 * displayid , int length , int idx ) ;
...
position p;
@@
 const struct minimode * cocci_id@p ;
