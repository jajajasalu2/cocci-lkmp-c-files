...
position p;
@@
 enum s700_pinconf_pull { OWL_PINCONF_PULL_DOWN , OWL_PINCONF_PULL_UP , } cocci_id@p ;
...
position p;
@@
 const struct owl_pinmux_func cocci_id@p [ ] ;
...
position p;
@@
 struct owl_padinfo cocci_id@p [ NUM_PADS ] ;
