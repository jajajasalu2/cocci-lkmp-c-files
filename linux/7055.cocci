...
position p;
@@
 const struct sis_laptop cocci_id@p [ ] ;
...
typedef u16;
@@
 struct sis_laptop {  u16 device ;  u16 subvendor ;  u16 subdevice ; } cocci_id@p ;
...
typedef u8,u16;
@@
 const struct {  const char * name ;  u16 host_id ;  u8 chipset_family ;  u8 flags ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ ] [ XFER_UDMA_6 - XFER_UDMA_0 + 1 ] ;
