...
position p;
@@
 struct cipher_speed_template * cocci_id@p ;
...
position p;
@@
 struct scatterlist cocci_id@p [ TVMEMSIZE ] ;
...
position p;
@@
 struct aead_speed_template * cocci_id@p ;
...
position p;
@@
 struct test_mb_ahash_data {  struct scatterlist sg [ XBUFSIZE ] ;  char result [ 64 ] ;  struct ahash_request * req ;  struct crypto_wait wait ;  char * xbuf [ XBUFSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct test_mb_aead_data * cocci_id@p ;
...
position p;
@@
 struct test_mb_aead_data {  struct scatterlist sg [ XBUFSIZE ] ;  struct scatterlist sgout [ XBUFSIZE ] ;  struct aead_request * req ;  struct crypto_wait wait ;  char * xbuf [ XBUFSIZE ] ;  char * xoutbuf [ XBUFSIZE ] ;  char * axbuf [ XBUFSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct test_mb_skcipher_data * cocci_id@p ;
...
position p;
@@
 struct test_mb_skcipher_data {  struct scatterlist sg [ XBUFSIZE ] ;  struct skcipher_request * req ;  struct crypto_wait wait ;  char * xbuf [ XBUFSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct test_mb_ahash_data * cocci_id@p ;
