...
position p;
@@
 struct pm_clk_notifier_block * cocci_id@p ;
...
position p;
@@
 enum pce_status { PCE_STATUS_NONE = 0 , PCE_STATUS_ACQUIRED , PCE_STATUS_ENABLED , PCE_STATUS_ERROR , } cocci_id@p ;
...
position p;
@@
 struct pm_clock_entry {  struct list_head node ;  char * con_id ;  struct clk * clk ;  enum pce_status status ; } cocci_id@p ;
...
position p;
@@
 struct pm_clock_entry * cocci_id@p ;
...
position p;
@@
 struct pm_subsys_data * cocci_id@p ;
