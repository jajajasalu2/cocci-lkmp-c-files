...
typedef __be32;
@@
 struct rxkad_level2_hdr {  __be32 data_size ;  __be32 checksum ; } cocci_id@p ;
...
position p;
@@
 const struct rxrpc_crypt * cocci_id@p ;
...
position p;
@@
 const struct rxrpc_call * cocci_id@p ;
...
position p;
@@
 struct rxrpc_skb_priv * cocci_id@p ;
...
position p;
@@
 const struct rxkad_key * cocci_id@p ;
...
position p;
@@
 struct rxkad_response cocci_id@p ;
...
typedef __be32;
@@
 struct rxkad_level1_hdr {  __be32 data_size ; } cocci_id@p ;
...
position p;
@@
 struct rxrpc_host_header * cocci_id@p ;
...
position p;
@@
 struct rxkad_level2_hdr cocci_id@p ;
...
position p;
@@
 const struct rxrpc_security cocci_id@p ;
...
position p;
@@
 struct rxrpc_connection * cocci_id@p ;
...
position p;
@@
 struct rxrpc_wire_header cocci_id@p ;
...
position p;
@@
 const struct rxrpc_key_token * cocci_id@p ;
...
position p;
@@
 struct rxrpc_key_token * cocci_id@p ;
...
position p;
@@
 struct rxkad_challenge cocci_id@p ;
...
position p;
@@
 struct scatterlist cocci_id@p [ 16 ] ;
...
position p;
@@
 struct rxkad_level1_hdr cocci_id@p ;
