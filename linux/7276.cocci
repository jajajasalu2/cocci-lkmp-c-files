...
typedef u8,u16;
@@
 struct arcxcnn_platform_data {  const char * name ;  u16 initial_brightness ;  u8 leden ;  u8 led_config_0 ;  u8 led_config_1 ;  u8 dim_freq ;  u8 comp_config ;  u8 filter_config ;  u8 trim_config ; } cocci_id@p ;
...
position p;
@@
 enum arcxcnn_chip_id { ARC2C0608 , } cocci_id@p ;
...
position p;
@@
 struct arcxcnn {  struct i2c_client * client ;  struct backlight_device * bl ;  struct device * dev ;  struct arcxcnn_platform_data * pdata ; } cocci_id@p ;
