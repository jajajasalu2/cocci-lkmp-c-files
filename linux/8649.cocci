...
position p;
@@
 struct i40e_ddp_profile_list * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct i40e_profile_section_header ) + sizeof ( struct i40e_profile_info ) ] ;
...
position p;
@@
 struct i40e_ddp_version cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ I40E_PROFILE_LIST_SIZE ] ;
...
position p;
@@
 struct i40e_ddp_old_profile_list * cocci_id@p ;
...
position p;
@@
 struct i40e_metadata_segment * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( I40E_DDP_PROFILE_PATH ) + I40E_DDP_PROFILE_NAME_MAX ] ;
