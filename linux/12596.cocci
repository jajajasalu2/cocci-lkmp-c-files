...
position p;
@@
 const struct msm_mdss_funcs cocci_id@p ;
...
position p;
@@
 struct dpu_irq_controller {  unsigned long enabled_mask ;  struct irq_domain * domain ; } cocci_id@p ;
...
typedef u32;
@@
 struct dpu_mdss {  struct msm_mdss base ;  void __iomem * mmio ;  unsigned long mmio_len ;  struct dss_module_power mp ;  struct dpu_irq_controller irq_controller ;  struct icc_path * path [ 2 ] ;  u32 num_paths ; } cocci_id@p ;
