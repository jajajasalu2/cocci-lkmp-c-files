...
position p;
@@
 enum mgmt_direction_type { MGMT_DIRECT_SEND = 0 , MGMT_RESP = 1 , } cocci_id@p ;
...
position p;
@@
 enum msg_segment_type { NOT_LAST_SEGMENT = 0 , LAST_SEGMENT = 1 , } cocci_id@p ;
...
position p;
@@
 enum mgmt_direction_type cocci_id@p ;
...
position p;
@@
 enum msg_ack_type { MSG_ACK = 0 , MSG_NO_ACK = 1 , } cocci_id@p ;
...
position p;
@@
 struct hinic_api_cmd_chain * cocci_id@p ;
...
position p;
@@
 enum hinic_mgmt_msg_type cocci_id@p ;
...
position p;
@@
 struct hinic_recv_msg * cocci_id@p ;
...
position p;
@@
 struct hinic_pf_to_mgmt * cocci_id@p ;
...
typedef u8,u16;
@@
 void ( * cocci_id@p ) ( void * handle , u8 cmd , void * buf_in , u16 in_size , void * buf_out , u16 * out_size ) ;
...
position p;
@@
 struct hinic_mgmt_cb * cocci_id@p ;
