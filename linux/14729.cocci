...
position p;
@@
 const struct clk_gating_soc_desc * cocci_id@p ;
...
@@
 struct clk_gating_ctrl {  spinlock_t * lock ;  struct clk * * gates ;  int num_gates ;  void __iomem * base ;  u32 saved_reg ; } cocci_id@p ;
...
position p;
@@
 struct clk_gating_ctrl * cocci_id@p ;
