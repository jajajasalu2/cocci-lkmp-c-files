...
position p;
@@
 union mod_hdcp_transition_input cocci_id@p ;
...
position p;
@@
 struct mod_hdcp_state cocci_id@p ;
...
position p;
@@
 struct mod_hdcp_trace * cocci_id@p ;
...
position p;
@@
 struct mod_hdcp_display_query * cocci_id@p ;
...
position p;
@@
 enum mod_hdcp_operation_mode cocci_id@p ;
...
position p;
@@
 struct mod_hdcp_output * cocci_id@p ;
...
position p;
@@
 struct mod_hdcp_display * cocci_id@p ;
...
position p;
@@
 struct mod_hdcp_authentication cocci_id@p ;
...
position p;
@@
 enum mod_hdcp_event cocci_id@p ;
...
position p;
@@
 enum mod_hdcp_status cocci_id@p ;
...
position p;
@@
 struct mod_hdcp_config * cocci_id@p ;
...
position p;
@@
 struct mod_hdcp_event_context * cocci_id@p ;
...
position p;
@@
 struct mod_hdcp_link * cocci_id@p ;
