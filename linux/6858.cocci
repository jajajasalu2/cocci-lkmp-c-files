...
typedef u64;
@@
 int cocci_id@p ( struct bnx2fc_cmd * io_req , u64 addr , int sg_len , int bd_index ) ;
...
position p;
@@
 int cocci_id@p ( struct bnx2fc_cmd * io_req ) ;
...
position p;
@@
 struct fcoe_fcp_rsp_payload * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct bnx2fc_cmd * io_req , struct fcoe_fcp_rsp_payload * fcp_rsp , u8 num_rq ) ;
...
position p;
@@
 struct bnx2fc_cmd_mgr cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bnx2fc_cmd * io_req ) ;
