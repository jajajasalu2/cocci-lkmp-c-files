...
position p;
@@
 void cocci_id@p ( struct device_queue_manager * dqm , struct queue * q , struct qcm_process_device * qpd ) ;
...
position p;
@@
 int cocci_id@p ( struct device_queue_manager * dqm , struct qcm_process_device * qpd ) ;
...
position p;
@@
 struct device_queue_manager_asic_ops * cocci_id@p ;
