...
position p;
@@
 const struct dwc_eth_dwmac_data cocci_id@p ;
...
position p;
@@
 struct tegra_eqos {  struct device * dev ;  void __iomem * regs ;  struct reset_control * rst ;  struct clk * clk_master ;  struct clk * clk_slave ;  struct clk * clk_tx ;  struct clk * clk_rx ;  struct gpio_desc * reset ; } cocci_id@p ;
