...
position p;
@@
 struct acpi_sci_handler_info cocci_id@p ;
...
position p;
@@
 acpi_gbl_event_handler cocci_id@p ;
...
position p;
@@
 acpi_exception_handler cocci_id@p ;
...
symbol cocci_id;
position p;
typedef acpi_handle,acpi_status,u8,u32;
@@
 acpi_status cocci_id@p ( acpi_handle gpe_device , u32 gpe_number , u32 type , u8 is_raw_handler , acpi_gpe_handler address , void * context ) ;
...
position p;
@@
 acpi_notify_handler cocci_id@p ;
...
position p;
@@
 struct acpi_gpe_handler_info cocci_id@p ;
