...
position p;
@@
 struct fdt_property * cocci_id@p ;
...
position p;
@@
 union cvmx_uctlx_if_ena cocci_id@p ;
...
position p;
@@
 union cvmx_uctlx_clk_rst_ctl cocci_id@p ;
...
position p;
@@
 struct usb_ehci_pdata cocci_id@p ;
...
position p;
@@
 const struct fdt_property * cocci_id@p ;
...
position p;
@@
 union cvmx_uctlx_uphy_portx_ctl_status cocci_id@p ;
...
position p;
@@
 union cvmx_uctlx_ehci_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_uctlx_ohci_ctl cocci_id@p ;
...
position p;
@@
 enum cvmx_helper_board_usb_clock_types cocci_id@p ;
