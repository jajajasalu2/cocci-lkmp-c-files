...
position p;
@@
 enum bcm281xx_pin_type * cocci_id@p ;
...
position p;
@@
 struct bcm281xx_pinctrl_data cocci_id@p ;
...
position p;
@@
 struct bcm281xx_pin_function {  const char * name ;  const char * const * groups ;  const unsigned ngroups ; } cocci_id@p ;
...
position p;
@@
 const struct bcm281xx_pin_function cocci_id@p [ ] ;
...
position p;
@@
 enum bcm281xx_pin_type { BCM281XX_PIN_TYPE_UNKNOWN = 0 , BCM281XX_PIN_TYPE_STD , BCM281XX_PIN_TYPE_I2C , BCM281XX_PIN_TYPE_HDMI , } cocci_id@p ;
...
position p;
@@
 struct bcm281xx_pinctrl_data {  void __iomem * reg_base ;  const struct pinctrl_pin_desc * pins ;  const unsigned npins ;  const struct bcm281xx_pin_function * functions ;  const unsigned nfunctions ;  struct regmap * regmap ; } cocci_id@p ;
