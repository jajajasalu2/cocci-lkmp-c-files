...
typedef spinlock_t;
@@
 struct belkin_sa_private {  spinlock_t lock ;  unsigned long control_state ;  unsigned char last_lsr ;  unsigned char last_msr ;  int bad_flow_control ; } cocci_id@p ;
...
position p;
@@
 struct belkin_sa_private * cocci_id@p ;
