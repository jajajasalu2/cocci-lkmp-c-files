...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TPROXY_MAX + 1 ] ;
...
typedef u8;
@@
 struct nft_tproxy {  enum nft_registers sreg_addr : 8 ;  enum nft_registers sreg_port : 8 ;  u8 family ; } cocci_id@p ;
...
position p;
@@
 const struct nft_tproxy * cocci_id@p ;
