...
position p;
@@
 struct nvbios_vmap_entry cocci_id@p ;
...
position p;
@@
 struct nvbios_volt_entry cocci_id@p ;
...
position p;
@@
 const struct nvkm_volt_func * cocci_id@p ;
