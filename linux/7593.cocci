...
position p;
@@
 struct aty128_ddafifo cocci_id@p ;
...
position p;
@@
 const struct aty128_crtc * cocci_id@p ;
...
typedef u32;
@@
 struct aty128_pll {  u32 post_divider ;  u32 feedback_divider ;  u32 vclk ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , struct aty128fb_par * par ) ;
...
position p;
@@
 const struct aty128_meminfo cocci_id@p ;
...
position p;
@@
 const struct aty128fb_par * cocci_id@p ;
...
position p;
@@
 volatile unsigned int cocci_id@p ;
...
position p;
@@
 enum { rage_128 , rage_128_pci , rage_128_pro , rage_128_pro_pci , rage_M3 , rage_M3_pci , rage_M4 , rage_128_ultra , } cocci_id@p ;
...
position p;
@@
 const struct aty128_constants cocci_id@p ;
...
position p;
@@
 const struct aty128_ddafifo * cocci_id@p ;
...
typedef u32;
@@
 struct aty128_ddafifo {  u32 dda_config ;  u32 dda_on_off ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int blank , struct fb_info * fb ) ;
...
typedef u32;
@@
 struct aty128_constants {  u32 ref_clk ;  u32 ppll_min ;  u32 ppll_max ;  u32 ref_divider ;  u32 xclk ;  u32 fifo_width ;  u32 fifo_depth ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , const struct aty128fb_par * par ) ;
...
position p;
@@
 const struct aty128_pll * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * info , int power ) ;
...
typedef u_int;
@@
 int cocci_id@p ( struct fb_info * info , u_int cmd , unsigned long arg ) ;
...
position p;
@@
 struct aty128fb_par cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct aty128fb_par * par ) ;
...
position p;
@@
 void cocci_id@p ( const struct aty128fb_par * par ) ;
...
typedef u16;
@@
 void cocci_id@p ( u16 entries , struct aty128fb_par * par ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , struct fb_info * fb ) ;
...
typedef u8;
@@
 struct aty128_meminfo {  u8 ML ;  u8 MB ;  u8 Trcd ;  u8 Trp ;  u8 Twr ;  u8 CL ;  u8 Tr2w ;  u8 LoopLatency ;  u8 DspOn ;  u8 Rloop ;  const char * name ; } cocci_id@p ;
