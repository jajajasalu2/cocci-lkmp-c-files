...
@@
 struct i2c_pca_pf_data {  void __iomem * reg_base ;  int irq ;  struct gpio_desc * gpio ;  wait_queue_head_t wait ;  struct i2c_adapter adap ;  struct i2c_algo_pca_data algo_data ;  unsigned long io_base ;  unsigned long io_size ; } cocci_id@p ;
...
position p;
@@
 struct i2c_pca_pf_data * cocci_id@p ;
