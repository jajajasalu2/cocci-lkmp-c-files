...
position p;
@@
 struct stm32_mdma_chan * cocci_id@p ;
...
position p;
@@
 enum stm32_mdma_trigger_mode { STM32_MDMA_BUFFER , STM32_MDMA_BLOCK , STM32_MDMA_BLOCK_REP , STM32_MDMA_LINKED_LIST , } cocci_id@p ;
...
position p;
@@
 struct stm32_mdma_desc cocci_id@p ;
...
position p;
@@
 struct stm32_mdma_device cocci_id@p ;
...
position p;
@@
 struct stm32_mdma_hwdesc cocci_id@p ;
...
typedef bool,u32;
@@
 struct stm32_mdma_desc {  struct virt_dma_desc vdesc ;  u32 ccr ;  bool cyclic ;  u32 count ;  struct stm32_mdma_desc_node node [ ] ; } cocci_id@p ;
...
position p;
@@
 enum stm32_mdma_inc_mode { STM32_MDMA_FIXED = 0 , STM32_MDMA_INC = 2 , STM32_MDMA_DEC = 3 , } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct stm32_mdma_desc_node {  struct stm32_mdma_hwdesc * hwdesc ;  dma_addr_t hwdesc_phys ; } cocci_id@p ;
...
position p;
@@
 struct stm32_mdma_chan_config * cocci_id@p ;
...
typedef bool,u32;
@@
 struct stm32_mdma_chan {  struct virt_dma_chan vchan ;  struct dma_pool * desc_pool ;  u32 id ;  struct stm32_mdma_desc * desc ;  u32 curr_hwdesc ;  struct dma_slave_config dma_config ;  struct stm32_mdma_chan_config chan_config ;  bool busy ;  u32 mem_burst ;  u32 mem_width ; } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_mdma_chan_config {  u32 request ;  u32 priority_level ;  u32 transfer_config ;  u32 mask_addr ;  u32 mask_data ; } cocci_id@p ;
...
position p;
@@
 enum stm32_mdma_width { STM32_MDMA_BYTE , STM32_MDMA_HALF_WORD , STM32_MDMA_WORD , STM32_MDMA_DOUBLE_WORD , } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_mdma_device {  struct dma_device ddev ;  void __iomem * base ;  struct clk * clk ;  int irq ;  struct reset_control * rst ;  u32 nr_channels ;  u32 nr_requests ;  u32 nr_ahb_addr_masks ;  struct stm32_mdma_chan chan [ STM32_MDMA_MAX_CHANNELS ] ;  u32 ahb_addr_masks [ ] ; } cocci_id@p ;
...
position p;
@@
 struct stm32_mdma_desc_node * cocci_id@p ;
