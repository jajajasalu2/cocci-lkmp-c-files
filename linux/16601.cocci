...
position p;
@@
 struct vmcp_session {  char * response ;  unsigned int bufsize ;  unsigned int cma_alloc : 1 ;  int resp_size ;  int resp_code ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 struct vmcp_session * cocci_id@p ;
