...
position p;
@@
 enum { DIV_CTRL0 = 0 , DIV_CTRL1 = 4 , DIV_CTRL1_N_RESET_MASK = BIT ( 10 ) , } cocci_id@p ;
...
position p;
@@
 const struct dove_clk * cocci_id@p ;
...
@@
 struct dove_clk {  const char * name ;  struct clk_hw hw ;  void __iomem * base ;  spinlock_t * lock ;  u8 div_bit_start ;  u8 div_bit_end ;  u8 div_bit_load ;  u8 div_bit_size ;  u32 * divider_table ; } cocci_id@p ;
