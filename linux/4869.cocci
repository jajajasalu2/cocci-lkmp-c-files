...
position p;
@@
 void cocci_id@p ( struct bnxt_re_dev * rdev ) ;
...
position p;
@@
 struct bnxt_qplib_ctx * cocci_id@p ;
...
position p;
@@
 struct bnxt_re_work cocci_id@p ;
...
position p;
@@
 struct creq_qp_event * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_vf_res cocci_id@p ;
...
position p;
@@
 struct bnxt_msix_entry * cocci_id@p ;
...
position p;
@@
 struct bnxt_ulp_ops cocci_id@p ;
...
position p;
@@
 struct creq_func_event * cocci_id@p ;
