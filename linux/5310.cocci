...
typedef u16;
@@
 struct inic_host_priv {  void __iomem * mmio_base ;  u16 cached_hctl ; } cocci_id@p ;
...
position p;
@@
 struct inic_host_priv * cocci_id@p ;
...
position p;
@@
 struct inic_port_priv * cocci_id@p ;
...
@@
 struct inic_port_priv {  struct inic_pkt * pkt ;  dma_addr_t pkt_dma ;  u32 * cpb_tbl ;  dma_addr_t cpb_tbl_dma ; } cocci_id@p ;
