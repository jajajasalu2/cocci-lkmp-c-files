...
position p;
@@
 struct ttc_timer_clockevent * cocci_id@p ;
...
typedef u32;
@@
 struct ttc_timer_clocksource {  u32 scale_clk_ctrl_reg_old ;  u32 scale_clk_ctrl_reg_new ;  struct ttc_timer ttc ;  struct clocksource cs ; } cocci_id@p ;
...
position p;
@@
 struct ttc_timer_clockevent {  struct ttc_timer ttc ;  struct clock_event_device ce ; } cocci_id@p ;
...
position p;
@@
 struct ttc_timer_clocksource * cocci_id@p ;
...
position p;
@@
 struct ttc_timer {  void __iomem * base_addr ;  unsigned long freq ;  struct clk * clk ;  struct notifier_block clk_rate_change_nb ; } cocci_id@p ;
