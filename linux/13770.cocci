...
position p;
@@
 struct adv7180_state * cocci_id@p ;
...
typedef u8,bool;
@@
 struct adv7180_state {  struct v4l2_ctrl_handler ctrl_hdl ;  struct v4l2_subdev sd ;  struct media_pad pad ;  struct mutex mutex ;  int irq ;  struct gpio_desc * pwdn_gpio ;  v4l2_std_id curr_norm ;  bool powered ;  bool streaming ;  u8 input ;  struct i2c_client * client ;  unsigned int register_page ;  struct i2c_client * csi_client ;  struct i2c_client * vpp_client ;  const struct adv7180_chip_info * chip_info ;  enum v4l2_field field ; } cocci_id@p ;
...
position p;
@@
 enum adv7182_input_type { ADV7182_INPUT_TYPE_CVBS , ADV7182_INPUT_TYPE_DIFF_CVBS , ADV7182_INPUT_TYPE_SVIDEO , ADV7182_INPUT_TYPE_YPBPR , } cocci_id@p ;
...
position p;
@@
 struct adv7180_chip_info {  unsigned int flags ;  unsigned int valid_input_mask ;  int ( * set_std ) ( struct adv7180_state * st , unsigned int std ) ;  int ( * select_input ) ( struct adv7180_state * st , unsigned int input ) ;  int ( * init ) ( struct adv7180_state * state ) ; } cocci_id@p ;
...
position p;
@@
 const struct adv7180_chip_info cocci_id@p ;
...
position p;
@@
 struct adv7180_chip_info * cocci_id@p ;
...
position p;
@@
 enum adv7182_input_type cocci_id@p ;
