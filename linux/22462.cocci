...
position p;
@@
 struct asi_open_state cocci_id@p [ HPI_MAX_ADAPTERS ] [ HPI_MAX_STREAMS ] ;
...
position p;
@@
 struct asi_open_state {  int open_flag ;  void * h_owner ; } cocci_id@p ;
...
position p;
@@
 const struct hpi_pci * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct hpi_message * phm , struct hpi_response * phr ) ;
...
typedef u16;
@@
 void cocci_id@p ( u16 adapter_index ) ;
...
position p;
@@
 hpi_handler_func * cocci_id@p [ HPI_MAX_ADAPTERS ] ;
...
position p;
@@
 struct hpi_stream_response {  struct hpi_response_header h ;  struct hpi_stream_res d ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hpi_message * phm , struct hpi_response * phr , void * h_owner ) ;
...
position p;
@@
 struct adapter_info cocci_id@p [ HPI_MAX_ADAPTERS ] ;
...
position p;
@@
 struct hpi_adapter_response cocci_id@p [ HPI_MAX_ADAPTERS ] ;
...
position p;
@@
 struct hpios_spinlock cocci_id@p ;
...
position p;
@@
 struct hpi_mixer_response cocci_id@p [ HPI_MAX_ADAPTERS ] ;
...
position p;
@@
 struct hpi_adapter_response {  struct hpi_response_header h ;  struct hpi_adapter_res a ; } cocci_id@p ;
...
position p;
@@
 struct hpi_mixer_response {  struct hpi_response_header h ;  struct hpi_mixer_res m ; } cocci_id@p ;
...
position p;
@@
 struct hpi_stream_response cocci_id@p [ HPI_MAX_ADAPTERS ] [ HPI_MAX_STREAMS ] ;
...
position p;
@@
 struct hpi_subsys_response {  struct hpi_response_header h ;  struct hpi_subsys_res s ; } cocci_id@p ;
...
typedef u16;
@@
 struct adapter_info {  u16 type ;  u16 num_instreams ;  u16 num_outstreams ; } cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( u16 adapter_index , void * h_owner ) ;
