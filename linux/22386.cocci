...
position p;
@@
 struct es1371_quirk {  unsigned short vid ;  unsigned short did ;  unsigned char rev ; } cocci_id@p ;
...
position p;
@@
 struct snd_kcontrol_new cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct snd_ratden cocci_id@p ;
...
position p;
@@
 struct es1371_quirk cocci_id@p [ ] ;
...
position p;
@@
 const struct snd_pcm_hw_constraint_ratnums cocci_id@p ;
...
position p;
@@
 const struct snd_ratnum cocci_id@p ;
...
position p;
@@
 const struct snd_pcm_hw_constraint_ratdens cocci_id@p ;
