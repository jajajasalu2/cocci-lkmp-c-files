...
position p;
@@
 struct call_path_root * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef retpoline_state_t;
@@
 enum retpoline_state_t { RETPOLINE_NONE , X86_RETPOLINE_POSSIBLE , X86_RETPOLINE_DETECTED , } cocci_id@p ;
...
position p;
@@
 struct call_return_processor cocci_id@p ;
...
position p;
@@
 struct thread_stack * cocci_id@p ;
...
position p;
@@
 struct thread_stack_entry * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,retpoline_state_t;
@@
 struct thread_stack {  struct thread_stack_entry * stack ;  size_t cnt ;  size_t sz ;  u64 trace_nr ;  u64 branch_count ;  u64 insn_count ;  u64 cyc_count ;  u64 kernel_start ;  u64 last_time ;  struct call_return_processor * crp ;  struct comm * comm ;  unsigned int arr_sz ;  enum retpoline_state_t rstate ; } cocci_id@p ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct call_return * cr , u64 * parent_db_id , void * data ) ;
...
typedef retpoline_state_t;
@@
 enum retpoline_state_t cocci_id@p ;
...
typedef u64,bool;
@@
 struct thread_stack_entry {  u64 ret_addr ;  u64 timestamp ;  u64 ref ;  u64 branch_count ;  u64 insn_count ;  u64 cyc_count ;  u64 db_id ;  struct call_path * cp ;  bool no_call ;  bool trace_end ;  bool non_call ; } cocci_id@p ;
