...
typedef u8;
@@
 struct dib0700_rc_response {  u8 report_id ;  u8 data_state ;  union {  struct {  u8 system ;  u8 not_system ;  u8 data ;  u8 not_data ; } nec ;  struct {  u8 not_used ;  u8 system ;  u8 data ;  u8 not_data ; } rc5 ; } ; } cocci_id@p ;
...
position p;
@@
 struct dib0700_rc_response * cocci_id@p ;
