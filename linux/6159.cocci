...
typedef u32;
@@
 struct hwreg_cfg {  u32 bank ;  unsigned long addr ;  uint fmt ;  unsigned long mask ;  long shift ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ AB8500_MAX_NR_IRQS ] ;
...
typedef u8;
@@
 struct ab8500_reg_range {  u8 first ;  u8 last ;  u8 perm ; } cocci_id@p ;
...
position p;
@@
 struct ab8500_prcmu_ranges * cocci_id@p ;
...
position p;
@@
 struct ab8500_prcmu_ranges cocci_id@p [ AB8500_NUM_BANKS ] ;
...
typedef u8;
@@
 struct ab8500_prcmu_ranges {  u8 num_ranges ;  u8 bankid ;  const struct ab8500_reg_range * range ; } cocci_id@p ;
...
position p;
@@
 struct ab8500_reg_range cocci_id@p [ ] ;
