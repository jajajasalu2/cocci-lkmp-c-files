...
position p;
@@
 struct hpfs_super_block * cocci_id@p ;
...
position p;
@@
 struct hpfs_boot_block * cocci_id@p ;
...
position p;
@@
 struct hpfs_sb_info * cocci_id@p ;
...
position p;
@@
 struct hpfs_inode_info * cocci_id@p ;
...
position p;
@@
 struct quad_buffer_head cocci_id@p ;
...
position p;
@@
 struct hpfs_spare_block * cocci_id@p ;
