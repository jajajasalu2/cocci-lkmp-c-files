...
position p;
@@
 struct uprobe_dispatch_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct uprobe_consumer * con , unsigned long func , struct pt_regs * regs ) ;
...
position p;
@@
 struct uprobe_consumer * cocci_id@p ;
...
typedef rwlock_t;
@@
 struct trace_uprobe_filter {  rwlock_t rwlock ;  int nr_systemwide ;  struct list_head perf_events ; } cocci_id@p ;
...
position p;
@@
 struct trace_uprobe cocci_id@p ;
...
position p;
@@
 struct trace_uprobe {  struct dyn_event devent ;  struct trace_uprobe_filter filter ;  struct uprobe_consumer consumer ;  struct path path ;  struct inode * inode ;  char * filename ;  unsigned long offset ;  unsigned long ref_ctr_offset ;  unsigned long nhit ;  struct trace_probe tp ; } cocci_id@p ;
...
position p;
@@
 struct uprobe_cpu_buffer {  struct mutex mutex ;  void * buf ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct trace_uprobe * tu ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct uprobe_consumer * self , enum uprobe_filter_ctx ctx , struct mm_struct * mm ) ;
...
position p;
@@
 char cocci_id@p [ MAX_ARGSTR_LEN + 1 ] ;
...
position p;
@@
 enum uprobe_filter_ctx cocci_id@p ;
...
position p;
@@
 struct trace_uprobe_filter * cocci_id@p ;
...
position p;
@@
 struct uprobe_cpu_buffer * cocci_id@p ;
...
position p;
@@
 struct uprobe_trace_entry_head cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct uprobe_consumer * con , struct pt_regs * regs ) ;
...
position p;
@@
 struct uprobe_trace_entry_head {  struct trace_entry ent ;  unsigned long vaddr [ ] ; } cocci_id@p ;
...
position p;
@@
 struct event_file_link * cocci_id@p ;
...
position p;
@@
 struct uprobe_dispatch_data {  struct trace_uprobe * tu ;  unsigned long bp_addr ; } cocci_id@p ;
...
position p;
@@
 struct trace_probe_event * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct trace_uprobe * tu , struct perf_event * event ) ;
...
position p;
@@
 char cocci_id@p [ MAX_EVENT_NAME_LEN ] ;
