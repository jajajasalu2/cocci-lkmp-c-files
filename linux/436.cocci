...
typedef u8,u64,bool;
@@
 struct _ioeventfd {  struct list_head list ;  u64 addr ;  int length ;  struct eventfd_ctx * eventfd ;  u64 datamatch ;  struct kvm_io_device dev ;  u8 bus_idx ;  bool wildcard ; } cocci_id@p ;
...
position p;
@@
 struct kvm_kernel_irq_routing_entry cocci_id@p [ KVM_NR_IRQCHIPS ] ;
...
position p;
@@
 struct kvm_irq_ack_notifier * cocci_id@p ;
...
position p;
@@
 struct kvm_kernel_irqfd_resampler cocci_id@p ;
