...
position p;
@@
 void ( * cocci_id@p ) ( const struct dmi_header * , void * ) ;
...
typedef u8,u64,u16;
@@
 struct dmi_memdev_info {  const char * device ;  const char * bank ;  u64 size ;  u16 handle ;  u8 type ; } * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ DMI_STRING_MAX ] ;
...
position p;
@@
 struct dmi_dev_onboard * cocci_id@p ;
