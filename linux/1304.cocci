...
typedef u16;
@@
 struct isd200_info {  struct inquiry_data InquiryData ;  u16 * id ;  struct isd200_config ConfigData ;  unsigned char * RegsBuf ;  unsigned char ATARegs [ 8 ] ;  unsigned char DeviceHead ;  unsigned char DeviceFlags ;  unsigned char MaxLUNs ;  unsigned char cmnd [ BLK_MAX_CDB ] ;  struct scsi_cmnd srb ;  struct scatterlist sg ; } cocci_id@p ;
...
position p;
@@
 struct read_capacity_data cocci_id@p ;
...
position p;
@@
 struct read_block_limits {  unsigned char Reserved ;  unsigned char BlockMaximumSize [ 3 ] ;  unsigned char BlockMinimumSize [ 2 ] ; } cocci_id@p ;
...
typedef __be32;
@@
 struct read_capacity_data {  __be32 LogicalBlockAddress ;  __be32 BytesPerBlock ; } cocci_id@p ;
