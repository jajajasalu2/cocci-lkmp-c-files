...
position p;
@@
 struct as3711_bl_supply {  struct as3711_bl_data su1 ;  struct as3711_bl_data su2 ;  const struct as3711_bl_pdata * pdata ;  struct as3711 * as3711 ; } cocci_id@p ;
...
typedef bool;
@@
 struct as3711_bl_data {  bool powered ;  enum as3711_bl_type type ;  int brightness ;  struct backlight_device * bl ; } cocci_id@p ;
...
position p;
@@
 struct as3711_bl_supply cocci_id@p ;
...
position p;
@@
 const struct as3711_bl_pdata * cocci_id@p ;
...
position p;
@@
 enum as3711_bl_type { AS3711_BL_SU1 , AS3711_BL_SU2 , } cocci_id@p ;
...
position p;
@@
 struct as3711_bl_pdata * cocci_id@p ;
...
position p;
@@
 struct as3711_bl_data * cocci_id@p ;
