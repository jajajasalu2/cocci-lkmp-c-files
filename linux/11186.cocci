...
position p;
@@
 enum hubp_ind_block_size cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_pipe_dest_params_st * cocci_id@p ;
...
position p;
@@
 const struct hubp_funcs cocci_id@p ;
...
position p;
@@
 const struct dc_cursor_attributes * cocci_id@p ;
...
position p;
@@
 const struct vm_context0_param * cocci_id@p ;
...
position p;
@@
 enum cursor_lines_per_chunk cocci_id@p ;
