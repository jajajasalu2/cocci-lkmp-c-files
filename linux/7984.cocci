...
position p;
@@
 struct virtio_driver cocci_id@p ;
...
position p;
@@
 struct virtnet_stat_desc {  char desc [ ETH_GSTRING_LEN ] ;  size_t offset ; } cocci_id@p ;
...
position p;
@@
 struct virtnet_sq_stats cocci_id@p ;
...
position p;
@@
 struct virtio_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct receive_queue {  struct virtqueue * vq ;  struct napi_struct napi ;  struct bpf_prog __rcu * xdp_prog ;  struct virtnet_rq_stats stats ;  struct page * pages ;  struct ewma_pkt_len mrg_avg_pkt_len ;  struct page_frag alloc_frag ;  struct scatterlist sg [ MAX_SKB_FRAGS + 2 ] ;  unsigned int min_buf_len ;  char name [ 40 ] ;  struct xdp_rxq_info xdp_rxq ; } cocci_id@p ;
...
position p;
@@
 struct virtnet_info * cocci_id@p ;
...
position p;
@@
 struct receive_queue cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct virtnet_info * vi ) ;
...
position p;
@@
 struct ewma_pkt_len * cocci_id@p ;
...
position p;
@@
 struct virtio_net_ctrl_mac * cocci_id@p ;
...
position p;
@@
 struct netdev_rx_queue * cocci_id@p ;
...
position p;
@@
 struct padded_vnet_hdr {  struct virtio_net_hdr_mrg_rxbuf hdr ;  char padding [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct scatterlist * cocci_id@p [ 4 ] ;
...
position p;
@@
 struct virtio_net_config cocci_id@p ;
...
position p;
@@
 struct rx_queue_attribute cocci_id@p ;
...
position p;
@@
 struct virtnet_rq_stats * cocci_id@p ;
...
position p;
@@
 struct virtio_net_hdr_mrg_rxbuf cocci_id@p ;
...
symbol cocci_id;
position p;
typedef vq_callback_t;
@@
 vq_callback_t * * cocci_id@p ;
...
typedef u64;
@@
 struct virtnet_rq_stats {  struct u64_stats_sync syncp ;  u64 packets ;  u64 bytes ;  u64 drops ;  u64 xdp_packets ;  u64 xdp_tx ;  u64 xdp_redirects ;  u64 xdp_drops ;  u64 kicks ; } cocci_id@p ;
...
position p;
@@
 const struct virtnet_stat_desc cocci_id@p [ ] ;
...
position p;
@@
 struct padded_vnet_hdr cocci_id@p ;
...
typedef u64;
@@
 struct virtnet_sq_stats {  struct u64_stats_sync syncp ;  u64 packets ;  u64 bytes ;  u64 xdp_tx ;  u64 xdp_tx_drops ;  u64 kicks ; } cocci_id@p ;
...
position p;
@@
 struct virtio_device * cocci_id@p ;
...
typedef u8;
@@
 struct control_buf {  struct virtio_net_ctrl_hdr hdr ;  virtio_net_ctrl_ack status ;  struct virtio_net_ctrl_mq mq ;  u8 promisc ;  u8 allmulti ;  __virtio16 vid ;  __virtio64 offloads ; } cocci_id@p ;
...
position p;
@@
 struct send_queue {  struct virtqueue * vq ;  struct scatterlist sg [ MAX_SKB_FRAGS + 2 ] ;  char name [ 40 ] ;  struct virtnet_sq_stats stats ;  struct napi_struct napi ; } cocci_id@p ;
...
@@
 struct virtnet_info {  struct virtio_device * vdev ;  struct virtqueue * cvq ;  struct net_device * dev ;  struct send_queue * sq ;  struct receive_queue * rq ;  unsigned int status ;  u16 max_queue_pairs ;  u16 curr_queue_pairs ;  u16 xdp_queue_pairs ;  bool big_packets ;  bool mergeable_rx_bufs ;  bool has_cvq ;  bool any_header_sg ;  u8 hdr_len ;  struct delayed_work refill ;  struct work_struct config_work ;  bool affinity_hint_set ;  struct hlist_node node ;  struct hlist_node node_dead ;  struct control_buf * ctrl ;  u8 duplex ;  u32 speed ;  unsigned long guest_offloads ;  unsigned long guest_offloads_capable ;  struct failover * failover ; } cocci_id@p ;
