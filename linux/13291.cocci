...
position p;
@@
 struct SRingBufferDescriptor * cocci_id@p ;
...
position p;
@@
 struct ngene_command * cocci_id@p ;
...
position p;
@@
 struct SBufferHeader * cocci_id@p ;
...
position p;
@@
 const struct cxd2099_cfg cocci_id@p ;
...
position p;
@@
 struct HW_SCATTER_GATHER_ELEMENT cocci_id@p ;
...
position p;
@@
 struct EVENT_BUFFER cocci_id@p ;
...
position p;
@@
 struct FW_STREAM_CONTROL cocci_id@p ;
