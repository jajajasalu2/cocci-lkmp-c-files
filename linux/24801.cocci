...
position p;
@@
 struct ct_iter_state cocci_id@p ;
...
typedef u_int64_t;
@@
 struct ct_iter_state {  struct seq_net_private p ;  struct hlist_nulls_head * hash ;  unsigned int htable_size ;  unsigned int bucket ;  u_int64_t time_now ; } cocci_id@p ;
...
position p;
@@
 struct nf_conntrack_net cocci_id@p ;
