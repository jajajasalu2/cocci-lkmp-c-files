...
position p;
@@
 const struct smc_ism_position * cocci_id@p ;
...
position p;
@@
 struct smc_ism_event_work * cocci_id@p ;
...
position p;
@@
 const struct smcd_ops * cocci_id@p ;
...
position p;
@@
 struct smc_ism_vlanid * cocci_id@p ;
...
position p;
@@
 struct smc_ism_event_work {  struct work_struct work ;  struct smcd_dev * smcd ;  struct smcd_event event ; } cocci_id@p ;
...
position p;
@@
 union smcd_sw_event_info cocci_id@p ;
...
position p;
@@
 struct smcd_dev_list cocci_id@p ;
...
typedef u8,u64,u16;
@@
 union smcd_sw_event_info {  u64 info ;  struct {  u8 uid [ SMC_LGR_ID_SIZE ] ;  unsigned short vlan_id ;  u16 code ; } ; } cocci_id@p ;
