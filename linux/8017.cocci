...
position p;
@@
 struct vsc8531_private * cocci_id@p ;
...
position p;
@@
 const struct vsc85xx_hw_stat cocci_id@p [ ] ;
...
@@
 struct vsc8531_private {  int rate_magic ;  u16 supp_led_modes ;  u32 leds_mode [ MAX_LEDS ] ;  u8 nleds ;  const struct vsc85xx_hw_stat * hw_stats ;  u64 * stats ;  int nstats ;  bool pkg_init ;  unsigned int base_addr ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct vsc85xx_hw_stat {  const char * string ;  u8 reg ;  u16 page ;  u16 mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct vsc8531_edge_rate_table {  u32 vddmac ;  u32 slowdown [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 const struct vsc8531_edge_rate_table cocci_id@p [ ] ;
...
typedef u32,u16;
@@
 struct reg_val {  u16 reg ;  u32 val ; } cocci_id@p ;
...
position p;
@@
 enum rgmii_rx_clock_delay { RGMII_RX_CLK_DELAY_0_2_NS = 0 , RGMII_RX_CLK_DELAY_0_8_NS = 1 , RGMII_RX_CLK_DELAY_1_1_NS = 2 , RGMII_RX_CLK_DELAY_1_7_NS = 3 , RGMII_RX_CLK_DELAY_2_0_NS = 4 , RGMII_RX_CLK_DELAY_2_3_NS = 5 , RGMII_RX_CLK_DELAY_2_6_NS = 6 , RGMII_RX_CLK_DELAY_3_4_NS = 7 , } cocci_id@p ;
