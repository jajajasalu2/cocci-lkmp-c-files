...
position p;
@@
 acpi_rs_length cocci_id@p ( struct acpi_resource_source * resource_source ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( u32 resource_length , u32 minimum_total_length ) ;
