...
typedef bool;
@@
 struct ccs811_data {  struct i2c_client * client ;  struct mutex lock ;  struct ccs811_reading buffer ;  struct iio_trigger * drdy_trig ;  bool drdy_trig_on ; } cocci_id@p ;
