...
position p;
@@
 const struct evtchn_ops * cocci_id@p ;
...
position p;
@@
 struct evtchn_bind_interdomain cocci_id@p ;
...
position p;
@@
 struct evtchn_bind_vcpu cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct irq_data * data ) ;
...
position p;
@@
 struct physdev_unmap_pirq cocci_id@p ;
...
position p;
@@
 struct evtchn_set_priority cocci_id@p ;
...
position p;
@@
 struct evtchn_bind_pirq cocci_id@p ;
...
position p;
@@
 struct evtchn_bind_ipi cocci_id@p ;
...
position p;
@@
 struct evtchn_bind_virq cocci_id@p ;
...
position p;
@@
 struct physdev_get_free_pirq cocci_id@p ;
...
position p;
@@
 struct physdev_irq_status_query cocci_id@p ;
...
position p;
@@
 struct evtchn_status cocci_id@p ;
...
position p;
@@
 struct physdev_map_pirq cocci_id@p ;
...
position p;
@@
 struct physdev_pirq_eoi_gmfn cocci_id@p ;
...
position p;
@@
 struct xen_hvm_param cocci_id@p ;
