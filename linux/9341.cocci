...
position p;
@@
 struct wlcore_cmd_cac_start * cocci_id@p ;
...
position p;
@@
 struct wl18xx_cmd_dfs_radar_debug * cocci_id@p ;
...
position p;
@@
 struct wl18xx_cmd_smart_config_start * cocci_id@p ;
...
position p;
@@
 struct wl18xx_cmd_smart_config_set_group_key * cocci_id@p ;
...
position p;
@@
 struct wl18xx_cmd_channel_switch * cocci_id@p ;
...
position p;
@@
 struct wl18xx_cmd_dfs_master_restart * cocci_id@p ;
