...
position p;
@@
 unsigned char cocci_id@p [ I2C_SMBUS_BLOCK_MAX + 2 ] ;
...
position p;
@@
 struct i2c_smbus_alert_setup * cocci_id@p ;
...
typedef u8,u16;
@@
 int ( * cocci_id@p ) ( struct i2c_adapter * adap , u16 addr , unsigned short flags , char read_write , u8 command , int size , union i2c_smbus_data * data ) ;
...
position p;
@@
 unsigned char cocci_id@p [ I2C_SMBUS_BLOCK_MAX + 3 ] ;
