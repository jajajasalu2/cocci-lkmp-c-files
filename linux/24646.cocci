...
position p;
@@
 union nft_entry {  struct ipt_entry e4 ;  struct ip6t_entry e6 ;  struct ebt_entry ebt ;  struct arpt_entry arp ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_COMPAT_MAX + 1 ] ;
...
position p;
@@
 struct nft_expr_ops cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_MATCH_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_RULE_COMPAT_MAX + 1 ] ;
...
position p;
@@
 struct nft_xt_match_priv {  void * info ; } cocci_id@p ;
...
position p;
@@
 const struct nfnl_callback cocci_id@p [ NFNL_MSG_COMPAT_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TARGET_MAX + 1 ] ;
...
position p;
@@
 struct nft_xt_match_priv cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_RULE_COMPAT_MAX + 1 ] ;
