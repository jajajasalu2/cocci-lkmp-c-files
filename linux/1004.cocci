...
position p;
@@
 int cocci_id@p ( const struct ubi_device * ubi , int pnum ) ;
...
position p;
@@
 int cocci_id@p ( const struct ubi_device * ubi , int pnum , const struct ubi_vid_hdr * vid_hdr ) ;
...
position p;
@@
 int cocci_id@p ( const struct ubi_device * ubi , int pnum , const struct ubi_ec_hdr * ec_hdr ) ;
...
position p;
@@
 const struct ubi_ec_hdr * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ubi_device * ubi , const void * buf , int pnum , int offset , int len ) ;
