...
position p;
@@
 enum mountstat3 { MNT3_OK = 0 , MNT3ERR_PERM = 1 , MNT3ERR_NOENT = 2 , MNT3ERR_IO = 5 , MNT3ERR_ACCES = 13 , MNT3ERR_NOTDIR = 20 , MNT3ERR_INVAL = 22 , MNT3ERR_NAMETOOLONG = 63 , MNT3ERR_NOTSUPP = 10004 , MNT3ERR_SERVERFAULT = 10006 , } cocci_id@p ;
...
position p;
@@
 enum mountstat { MNT_OK = 0 , MNT_EPERM = 1 , MNT_ENOENT = 2 , MNT_EACCES = 13 , MNT_EINVAL = 22 , } cocci_id@p ;
...
typedef u32;
@@
 struct mnt_fhstatus {  u32 status ;  struct nfs_fh * fh ; } cocci_id@p ;
...
position p;
@@
 enum { MOUNTPROC3_NULL = 0 , MOUNTPROC3_MNT = 1 , MOUNTPROC3_DUMP = 2 , MOUNTPROC3_UMNT = 3 , MOUNTPROC3_UMNTALL = 4 , MOUNTPROC3_EXPORT = 5 , } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( mnt_procedures ) ] ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( mnt3_procedures ) ] ;
...
position p;
@@
 const struct nfs_mount_request * cocci_id@p ;
...
position p;
@@
 enum { MOUNTPROC_NULL = 0 , MOUNTPROC_MNT = 1 , MOUNTPROC_DUMP = 2 , MOUNTPROC_UMNT = 3 , MOUNTPROC_UMNTALL = 4 , MOUNTPROC_EXPORT = 5 , } cocci_id@p ;
...
typedef rpc_authflavor_t;
@@
 struct mountres {  int errno ;  struct nfs_fh * fh ;  unsigned int * auth_count ;  rpc_authflavor_t * auth_flavors ; } cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 status ;  int errno ; } cocci_id@p [ ] ;
