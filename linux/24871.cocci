...
position p;
@@
 struct hsr_frame_info cocci_id@p ;
...
position p;
@@
 struct hsrv0_ethhdr_sp * cocci_id@p ;
...
position p;
@@
 struct hsrv1_ethhdr_sp * cocci_id@p ;
...
position p;
@@
 struct hsr_sup_payload cocci_id@p ;
...
typedef bool,u16;
@@
 struct hsr_frame_info {  struct sk_buff * skb_std ;  struct sk_buff * skb_hsr ;  struct hsr_port * port_rcv ;  struct hsr_node * node_src ;  u16 sequence_nr ;  bool is_supervision ;  bool is_vlan ;  bool is_local_dest ;  bool is_local_exclusive ; } cocci_id@p ;
