...
position p;
@@
 struct idt77105_priv cocci_id@p ;
...
position p;
@@
 struct idt77105_stats cocci_id@p ;
...
position p;
@@
 struct idt77105_priv {  struct idt77105_stats stats ;  struct atm_dev * dev ;  struct idt77105_priv * next ;  int loop_mode ;  unsigned char old_mcr ; } cocci_id@p ;
