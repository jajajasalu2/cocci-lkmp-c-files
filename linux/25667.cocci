...
position p;
@@
 struct options {  char * output ;  int fd ; } cocci_id@p ;
...
position p;
@@
 struct buildid_note {  Elf_Note desc ;  char name [ 4 ] ;  char build_id [ 20 ] ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned int namesz ;  unsigned int descsz ;  unsigned int type ;  char name [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct buildid_note * cocci_id@p ;
