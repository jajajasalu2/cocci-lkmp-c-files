...
position p;
@@
 struct pmic_mpp_state * cocci_id@p ;
...
position p;
@@
 struct pmic_mpp_pad * cocci_id@p ;
...
position p;
@@
 struct pmic_mpp_state {  struct device * dev ;  struct regmap * map ;  struct pinctrl_dev * ctrl ;  struct gpio_chip chip ; } cocci_id@p ;
