...
position p;
@@
 struct mobiveil_msi * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef phys_addr_t,raw_spinlock_t;
@@
 struct mobiveil_pcie {  struct platform_device * pdev ;  void __iomem * config_axi_slave_base ;  void __iomem * csr_axi_slave_base ;  void __iomem * apb_csr_base ;  phys_addr_t pcie_reg_base ;  struct irq_domain * intx_domain ;  raw_spinlock_t intx_mask_lock ;  int irq ;  int apio_wins ;  int ppio_wins ;  int ob_wins_configured ;  int ib_wins_configured ;  struct resource * ob_io_res ;  char root_bus_nr ;  struct mobiveil_msi msi ; } cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct mobiveil_msi {  struct mutex lock ;  struct irq_domain * msi_domain ;  struct irq_domain * dev_domain ;  phys_addr_t msi_pages_phys ;  int num_of_vectors ; 
...
position p;
@@
 struct mobiveil_pcie * cocci_id@p ;
