...
position p;
@@
 const struct dp_aud_n_m cocci_id@p [ ] ;
...
position p;
@@
 struct i915_audio_component * cocci_id@p ;
...
typedef u16;
@@
 struct dp_aud_n_m {  int sample_rate ;  int clock ;  u16 m ;  u16 n ; } cocci_id@p ;
...
position p;
@@
 const struct hdmi_aud_ncts cocci_id@p [ ] ;
...
position p;
@@
 struct hdmi_aud_ncts {  int sample_rate ;  int clock ;  int n ;  int cts ; } cocci_id@p ;
...
typedef u32;
@@
 const struct {  int clock ;  u32 config ; } cocci_id@p [ ] ;
