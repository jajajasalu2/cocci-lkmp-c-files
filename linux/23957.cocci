...
position p;
@@
 const struct udp_hslot * cocci_id@p ;
...
position p;
@@
 struct udp_dev_scratch * cocci_id@p ;
...
position p;
@@
 struct ip_options_data cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct sk_buff * skb , u32 info ) ;
