...
position p;
@@
 const char * cocci_id@p [ ACPI_NUM_PREDEFINED_REGIONS ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ ACPI_NUM_NS_TYPES ] ;
...
position p;
@@
 const char * cocci_id@p [ ACPI_GENERIC_NOTIFY_MAX + 1 ] ;
...
position p;
@@
 const char * cocci_id@p [ ACPI_NUM_MUTEX ] ;
...
position p;
@@
 const char * cocci_id@p [ ACPI_NUM_FIXED_EVENTS ] ;
