...
position p;
@@
 struct readdir_callback cocci_id@p ;
...
position p;
@@
 struct linux_dirent * cocci_id@p ;
...
position p;
@@
 struct getdents_callback64 {  struct dir_context ctx ;  struct linux_dirent64 __user * current_dir ;  struct linux_dirent64 __user * previous ;  int count ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct linux_dirent {  unsigned long d_ino ;  unsigned long d_off ;  unsigned short d_reclen ;  char d_name [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct getdents_callback * cocci_id@p ;
...
typedef compat_ulong_t;
@@
 struct compat_old_linux_dirent {  compat_ulong_t d_ino ;  compat_ulong_t d_offset ;  unsigned short d_namlen ;  char d_name [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct compat_getdents_callback cocci_id@p ;
...
position p;
@@
 struct linux_dirent64 * cocci_id@p ;
...
position p;
@@
 struct old_linux_dirent {  unsigned long d_ino ;  unsigned long d_offset ;  unsigned short d_namlen ;  char d_name [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct compat_readdir_callback {  struct dir_context ctx ;  struct compat_old_linux_dirent __user * dirent ;  int result ; } cocci_id@p ;
...
position p;
@@
 struct getdents_callback {  struct dir_context ctx ;  struct linux_dirent __user * current_dir ;  struct linux_dirent __user * previous ;  int count ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct readdir_callback {  struct dir_context ctx ;  struct old_linux_dirent __user * dirent ;  int result ; } cocci_id@p ;
...
position p;
@@
 struct compat_readdir_callback cocci_id@p ;
...
position p;
@@
 struct compat_linux_dirent cocci_id@p ;
...
position p;
@@
 struct getdents_callback64 cocci_id@p ;
...
position p;
@@
 struct old_linux_dirent * cocci_id@p ;
...
position p;
@@
 typeof ( lastdirent -> d_off ) cocci_id@p ;
...
position p;
@@
 struct compat_getdents_callback {  struct dir_context ctx ;  struct compat_linux_dirent __user * current_dir ;  struct compat_linux_dirent __user * previous ;  int count ;  int error ; } cocci_id@p ;
...
typedef compat_ulong_t;
@@
 struct compat_linux_dirent {  compat_ulong_t d_ino ;  compat_ulong_t d_off ;  unsigned short d_reclen ;  char d_name [ 1 ] ; } cocci_id@p ;
