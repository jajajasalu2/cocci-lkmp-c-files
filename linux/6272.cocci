...
position p;
@@
 void ( * cocci_id@p ) ( struct menelaus_chip * ) ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * _menelaus ) ;
...
position p;
@@
 struct menelaus_chip * cocci_id@p ;
...
typedef u8;
@@
 struct menelaus_vtg {  const char * name ;  u8 vtg_reg ;  u8 vtg_shift ;  u8 vtg_bits ;  u8 mode_reg ; } cocci_id@p ;
...
position p;
@@
 const struct menelaus_vtg_value * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct menelaus_chip * menelaus ) ;
...
position p;
@@
 const struct menelaus_vtg cocci_id@p ;
...
position p;
@@
 struct menelaus_platform_data * cocci_id@p ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( void * data , u8 card_mask ) ;
...
typedef u16;
@@
 struct menelaus_vtg_value {  u16 vtg ;  u16 val ; } cocci_id@p ;
