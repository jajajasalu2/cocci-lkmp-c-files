...
typedef u8,u32;
@@
 void cocci_id@p ( u32 * digest , const u8 * src , int blocks ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct sha256_ce_state * sst , const u8 * src , int blocks ) ;
...
position p;
@@
 struct sha256_ce_state cocci_id@p ;
...
typedef u32;
@@
 struct sha256_ce_state {  struct sha256_state sst ;  u32 finalize ; } cocci_id@p ;
