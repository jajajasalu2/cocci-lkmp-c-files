...
typedef dma_addr_t;
@@
 struct fsc_state {  struct mac53c94_regs __iomem * regs ;  int intr ;  struct dbdma_regs __iomem * dma ;  int dmaintr ;  int clk_freq ;  struct Scsi_Host * host ;  struct scsi_cmnd * request_q ;  struct scsi_cmnd * request_qtail ;  struct scsi_cmnd * current_req ;  enum fsc_phase phase ;  struct dbdma_cmd * dma_cmds ;  void * dma_cmd_space ;  struct pci_dev * pdev ;  dma_addr_t dma_addr ;  struct macio_dev * mdev ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fsc_state * , struct scsi_cmnd * ) ;
...
position p;
@@
 void cocci_id@p ( struct fsc_state * ) ;
...
position p;
@@
 enum fsc_phase { idle , selecting , dataing , completing , busfreeing , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fsc_state * , int result ) ;
