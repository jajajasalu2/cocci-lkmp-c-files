...
position p;
@@
 enum i2c_freq_mode { I2C_FREQ_MODE_STANDARD , I2C_FREQ_MODE_FAST , I2C_FREQ_MODE_HIGH_SPEED , I2C_FREQ_MODE_FAST_PLUS , } cocci_id@p ;
...
typedef u32;
@@
 struct nmk_i2c_dev {  struct i2c_vendor_data * vendor ;  struct amba_device * adev ;  struct i2c_adapter adap ;  int irq ;  void __iomem * virtbase ;  struct clk * clk ;  struct i2c_nmk_client cli ;  u32 clk_freq ;  unsigned char tft ;  unsigned char rft ;  int timeout ;  enum i2c_freq_mode sm ;  int stop ;  struct completion xfer_complete ;  int result ; } cocci_id@p ;
...
position p;
@@
 enum i2c_operation { I2C_NO_OPERATION = 0xff , I2C_WRITE = 0x00 , I2C_READ = 0x01 , } cocci_id@p ;
...
position p;
@@
 struct i2c_vendor_data cocci_id@p ;
...
position p;
@@
 enum i2c_status { I2C_NOP , I2C_ON_GOING , I2C_OK , I2C_ABORT , } cocci_id@p ;
...
typedef bool,u32;
@@
 struct i2c_vendor_data {  bool has_mtdws ;  u32 fifodepth ; } cocci_id@p ;
...
position p;
@@
 struct i2c_nmk_client {  unsigned short slave_adr ;  unsigned long count ;  unsigned char * buffer ;  unsigned long xfer_bytes ;  enum i2c_operation operation ; } cocci_id@p ;
