...
position p;
@@
 struct caam_perfmon * cocci_id@p ;
...
position p;
@@
 const struct caam_imx_data * cocci_id@p ;
...
position p;
@@
 struct caam_imx_data {  const struct clk_bulk_data * clks ;  int num_clks ; } cocci_id@p ;
...
typedef u8,u16;
@@
 const struct {  u16 ip_id ;  u8 maj_rev ;  u8 era ; } cocci_id@p [ ] ;
