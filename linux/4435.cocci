...
typedef u64,u32;
@@
 union {  u32 small [ 2 ] ;  u64 large ; } cocci_id@p ;
...
position p;
@@
 const struct aper_size_info_8 cocci_id@p [ 3 ] ;
...
typedef u8,u64;
@@
 struct {  void * gatt ;  u8 io_page_shift ;  u8 dynamic_apbase ;  struct lp_desc {  unsigned long * alloced_map ;  int refcount ;  u64 paddr ;  struct page * page ; } * lp_desc ; } cocci_id@p ;
