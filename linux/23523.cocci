...
position p;
@@
 struct card_private * cocci_id@p ;
...
position p;
@@
 struct hdmi_pcm {  struct list_head head ;  struct snd_soc_dai * codec_dai ;  int device ; } cocci_id@p ;
...
typedef bool;
@@
 struct card_private {  char codec_name [ SND_ACPI_I2C_ID_LEN ] ;  struct snd_soc_jack headset ;  struct list_head hdmi_pcm_list ;  bool common_hdmi_codec_drv ; } cocci_id@p ;
