...
position p;
@@
 struct nexio_priv {  struct urb * ack ;  unsigned char * ack_buf ; } cocci_id@p ;
...
typedef u8;
@@
 struct mtouch_priv {  u8 fw_rev_major ;  u8 fw_rev_minor ; } cocci_id@p ;
...
position p;
@@
 struct usbtouch_usb cocci_id@p ;
...
position p;
@@
 struct usbtouch_device_info * cocci_id@p ;
...
position p;
@@
 struct nexio_touch_packet * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usbtouch_usb * usbtouch , unsigned char * pkt , int len ) ;
