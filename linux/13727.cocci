...
typedef u8,u32,u16;
@@
 struct et8ek8_sensor {  struct v4l2_subdev subdev ;  struct media_pad pad ;  struct v4l2_mbus_framefmt format ;  struct gpio_desc * reset ;  struct regulator * vana ;  struct clk * ext_clk ;  u32 xclk_freq ;  u16 version ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_ctrl * exposure ;  struct v4l2_ctrl * pixel_rate ;  struct et8ek8_reglist * current_reglist ;  u8 priv_mem [ ET8EK8_PRIV_MEM_SIZE ] ;  struct mutex power_lock ;  int power_count ; } cocci_id@p ;
...
position p;
@@
 struct i2c_msg cocci_id@p [ ET8EK8_MAX_MSG ] ;
...
position p;
@@
 struct et8ek8_reglist * cocci_id@p ;
...
typedef u16;
@@
 const struct et8ek8_gain {  u16 analog ;  u16 digital ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct et8ek8_reglist * * cocci_id@p ;
...
position p;
@@
 struct et8ek8_sensor cocci_id@p ;
...
position p;
@@
 const struct et8ek8_reg * cocci_id@p ;
...
position p;
@@
 struct et8ek8_meta_reglist * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ET8EK8_MAX_MSG ] [ 6 ] ;
...
position p;
@@
 enum et8ek8_versions { ET8EK8_REV_1 = 0x0001 , ET8EK8_REV_2 , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ PRIV_MEM_WIN_SIZE ] ;
