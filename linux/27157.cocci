...
position p;
@@
 struct iso_volume_descriptor * cocci_id@p ;
...
position p;
@@
 struct hs_volume_descriptor * cocci_id@p ;
...
position p;
@@
 struct isofs_iget5_callback_data * cocci_id@p ;
...
position p;
@@
 struct iso_supplementary_descriptor * cocci_id@p ;
...
position p;
@@
 struct iso_inode_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct dentry * dentry , unsigned int len , const char * str , const struct qstr * name ) ;
...
position p;
@@
 struct iso_primary_descriptor * cocci_id@p ;
...
position p;
@@
 struct iso9660_options cocci_id@p ;
...
position p;
@@
 struct iso_directory_record * cocci_id@p ;
...
position p;
@@
 enum { Opt_block , Opt_check_r , Opt_check_s , Opt_cruft , Opt_gid , Opt_ignore , Opt_iocharset , Opt_map_a , Opt_map_n , Opt_map_o , Opt_mode , Opt_nojoliet , Opt_norock , Opt_sb , Opt_session , Opt_uid , Opt_unhide , Opt_utf8 , Opt_err , Opt_nocompress , Opt_hide , Opt_showassoc , Opt_dmode , Opt_overriderockperm , } cocci_id@p ;
...
position p;
@@
 struct isofs_iget5_callback_data {  unsigned long block ;  unsigned long offset ; } cocci_id@p ;
...
position p;
@@
 struct isofs_sb_info * cocci_id@p ;
...
position p;
@@
 struct cdrom_tocentry cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * , int relocated ) ;
...
position p;
@@
 int cocci_id@p ( const struct dentry * parent , struct qstr * qstr ) ;
...
position p;
@@
 struct hs_primary_descriptor * cocci_id@p ;
