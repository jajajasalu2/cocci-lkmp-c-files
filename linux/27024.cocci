...
symbol cocci_id;
position p;
typedef xfs_lookup_t;
@@
 xfs_lookup_t cocci_id@p ;
...
typedef uint64_t;
@@
 struct xfs_btree_block_change_owner_info {  uint64_t new_owner ;  struct list_head * buffer_list ; } cocci_id@p ;
...
position p;
@@
 const union xfs_btree_ptr * cocci_id@p ;
...
position p;
@@
 union xfs_btree_ptr * cocci_id@p ;
...
position p;
@@
 union xfs_btree_key * cocci_id@p ;
...
position p;
@@
 struct xfs_btree_split_args cocci_id@p ;
...
typedef bool;
@@
 struct xfs_btree_split_args {  struct xfs_btree_cur * cur ;  int level ;  union xfs_btree_ptr * ptrp ;  union xfs_btree_key * key ;  struct xfs_btree_cur * * curp ;  int * stat ;  int result ;  bool kswapd ;  struct completion * done ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 xfs_btree_visit_blocks_fn cocci_id@p ;
...
position p;
@@
 struct xfs_btree_block_change_owner_info * cocci_id@p ;
...
typedef uint32_t;
@@
 const uint32_t cocci_id@p [ 2 ] [ XFS_BTNUM_MAX ] ;
...
position p;
@@
 xfs_btree_query_range_fn cocci_id@p ;
