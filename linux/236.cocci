...
position p;
@@
 struct kretprobe_trace_entry_head cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct kprobe * kp , struct pt_regs * regs ) ;
...
position p;
@@
 struct kprobe_trace_entry_head cocci_id@p ;
...
position p;
@@
 struct trace_kprobe * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct kretprobe_instance * ri , struct pt_regs * regs ) ;
...
position p;
@@
 struct trace_kprobe {  struct dyn_event devent ;  struct kretprobe rp ;  unsigned long __percpu * nhit ;  const char * symbol ;  struct trace_probe tp ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( int , int , int , int , int , int ) ;
...
position p;
@@
 int cocci_id@p ( struct trace_kprobe * tk ) ;
