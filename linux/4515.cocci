...
position p;
@@
 struct delayed_datagram_info cocci_id@p ;
...
position p;
@@
 struct datagram_entry * cocci_id@p ;
...
typedef u8,bool;
@@
 struct delayed_datagram_info {  struct datagram_entry * entry ;  struct work_struct work ;  bool in_dg_host_queue ;  struct vmci_datagram msg ;  u8 msg_payload [ ] ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct datagram_entry {  struct vmci_resource resource ;  u32 flags ;  bool run_delayed ;  vmci_datagram_recv_cb recv_cb ;  void * client_data ;  u32 priv_flags ; } cocci_id@p ;
