...
position p;
@@
 struct emmaprp_ctx {  struct v4l2_fh fh ;  struct emmaprp_dev * dev ;  int aborting ;  struct emmaprp_q_data q_data [ 2 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct emmaprp_fmt {  u32 fourcc ;  u32 types ; } cocci_id@p ;
...
position p;
@@
 struct emmaprp_q_data * cocci_id@p ;
...
position p;
@@
 struct emmaprp_q_data {  unsigned int width ;  unsigned int height ;  unsigned int sizeimage ;  struct emmaprp_fmt * fmt ; } cocci_id@p ;
