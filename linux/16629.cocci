...
position p;
@@
 enum ctcm_channel_types cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CTCM_ID_SIZE + 1 ] ;
...
position p;
@@
 struct mpc_group * cocci_id@p ( struct ctcm_priv * priv ) ;
