...
position p;
@@
 enum of_overlay_notify_action cocci_id@p ;
...
position p;
@@
 struct overlay_changeset * cocci_id@p ;
...
typedef bool;
@@
 struct overlay_changeset {  int id ;  struct list_head ovcs_list ;  const void * fdt ;  struct device_node * overlay_tree ;  int count ;  struct fragment * fragments ;  bool symbols_fragment ;  struct of_changeset cset ; } cocci_id@p ;
...
typedef bool;
@@
 struct target {  struct device_node * np ;  bool in_livetree ; } cocci_id@p ;
...
position p;
@@
 struct fragment {  struct device_node * overlay ;  struct device_node * target ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct overlay_changeset * ovcs , struct target * target , const struct device_node * overlay_node ) ;
...
position p;
@@
 struct of_overlay_notify_data cocci_id@p ;
...
position p;
@@
 struct of_changeset_entry * cocci_id@p ;
