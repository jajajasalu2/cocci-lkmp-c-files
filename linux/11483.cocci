...
position p;
@@
 struct drm_nouveau_channel_free * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_channel_alloc * cocci_id@p ;
...
position p;
@@
 struct nouveau_abi16_ntfy * cocci_id@p ;
...
position p;
@@
 struct nv_device_v0 cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_notifierobj_alloc * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_grobj_alloc * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_gpuobj_free * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_getparam * cocci_id@p ;
