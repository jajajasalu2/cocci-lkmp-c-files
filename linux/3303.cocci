...
typedef u8;
@@
 struct lm77_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  int temp [ t_num_temp ] ;  u8 alarms ; } cocci_id@p ;
