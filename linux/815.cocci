...
position p;
@@
 struct portdrv_service_data * cocci_id@p ;
...
typedef u32;
@@
 struct portdrv_service_data {  struct pcie_port_service_driver * drv ;  struct device * dev ;  u32 service ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pcie_pm_callback_t;
@@
 pcie_pm_callback_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ PCIE_PORT_DEVICE_MAXSERVICES ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct pcie_device * ) ;
