...
position p;
@@
 struct ibmvmc_hmc cocci_id@p [ MAX_HMCS ] ;
...
position p;
@@
 struct ibmvmc_crq_msg * cocci_id@p ;
...
position p;
@@
 struct ibmvmc_file_session * cocci_id@p ;
...
position p;
@@
 struct ibmvmc_buffer * cocci_id@p ;
...
position p;
@@
 struct ibmvmc_admin_crq_msg * cocci_id@p ;
...
position p;
@@
 struct crq_server_adapter * cocci_id@p ;
...
position p;
@@
 struct vio_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct ibmvmc_struct cocci_id@p ;
...
position p;
@@
 struct ibmvmc_query_struct cocci_id@p ;
