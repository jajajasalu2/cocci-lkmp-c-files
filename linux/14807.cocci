...
typedef spinlock_t;
@@
 struct r8a73a4_cpg {  struct clk_onecell_data data ;  spinlock_t lock ;  void __iomem * reg ; } cocci_id@p ;
...
position p;
@@
 struct div4_clk {  const char * name ;  unsigned int reg ;  unsigned int shift ; } cocci_id@p ;
