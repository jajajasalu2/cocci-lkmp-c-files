...
position p;
@@
 struct eeh_rmv_data {  struct list_head removed_vf_list ;  int removed_dev_count ; } cocci_id@p ;
...
position p;
@@
 enum pci_ers_result ( * cocci_id@p ) ( struct eeh_dev * , struct pci_dev * , struct pci_driver * ) ;
...
position p;
@@
 struct eeh_rmv_data * cocci_id@p ;
