...
position p;
@@
 void cocci_id@p ( struct sbmacdma * d , int rxtx ) ;
...
position p;
@@
 enum sbmac_duplex { sbmac_duplex_none = - 1 , sbmac_duplex_half = DUPLEX_HALF , sbmac_duplex_full = DUPLEX_FULL , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sbmac_softc * sc , struct sbmacdma * d , int work_to_do , int poll ) ;
...
position p;
@@
 enum sbmac_state { sbmac_state_uninit , sbmac_state_off , sbmac_state_on , sbmac_state_broken , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sbmac_softc * sc ) ;
...
position p;
@@
 int cocci_id@p ( struct mii_bus * bus , int phyaddr , int regidx ) ;
...
position p;
@@
 int cocci_id@p ( struct sbmac_softc * sc , struct sbmacdma * d , struct sk_buff * m ) ;
...
position p;
@@
 void cocci_id@p ( struct sbmac_softc * sc , int onoff ) ;
...
position p;
@@
 int cocci_id@p ( struct sbmac_softc * s ) ;
...
position p;
@@
 enum sbmac_speed { sbmac_speed_none = 0 , sbmac_speed_10 = SPEED_10 , sbmac_speed_100 = SPEED_100 , sbmac_speed_1000 = SPEED_1000 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sbmac_softc * s , enum sbmac_speed speed ) ;
...
position p;
@@
 void cocci_id@p ( struct sbmac_softc * s ) ;
...
typedef spinlock_t;
@@
 struct sbmac_softc {  struct net_device * sbm_dev ;  struct napi_struct napi ;  struct phy_device * phy_dev ;  struct mii_bus * mii_bus ;  spinlock_t sbm_lock ;  int sbm_devflags ;  void __iomem * sbm_base ;  enum sbmac_state sbm_state ;  void __iomem * sbm_macenable ;  void __iomem * sbm_maccfg ;  void __iomem * sbm_fifocfg ;  void __iomem * sbm_framecfg ;  void __iomem * sbm_rxfilter ;  void __iomem * sbm_isr ;  void __iomem * sbm_imr ;  void __iomem * sbm_mdio ;  enum sbmac_speed sbm_speed ;  enum sbmac_duplex sbm_duplex ;  enum sbmac_fc sbm_fc ;  int sbm_pause ;  int sbm_link ;  unsigned char sbm_hwaddr [ ETH_ALEN ] ;  struct sbmacdma sbm_txdma ;  struct sbmacdma sbm_rxdma ;  int rx_hw_checksum ;  int sbe_idx ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sbmac_softc * sc , struct sbmacdma * d , int poll ) ;
...
position p;
@@
 void cocci_id@p ( struct sbmacdma * d ) ;
...
position p;
@@
 void cocci_id@p ( void __iomem * sbm_mdio ) ;
...
typedef uint64_t;
@@
 uint64_t cocci_id@p ( unsigned char * ptr ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct mii_bus * bus , int phyaddr , int regidx , u16 val ) ;
...
position p;
@@
 void cocci_id@p ( struct sbmacdma * d , struct sbmac_softc * s , int chan , int txrx , int maxdescr ) ;
...
position p;
@@
 void cocci_id@p ( struct sbmac_softc * sc , struct sbmacdma * d ) ;
...
position p;
@@
 void cocci_id@p ( void __iomem * sbm_mdio , unsigned int data , int bitcnt ) ;
...
typedef uint64_t;
@@
 struct sbdmadscr {  uint64_t dscr_a ;  uint64_t dscr_b ; } cocci_id@p ;
...
position p;
@@
 enum sbmac_fc { sbmac_fc_none , sbmac_fc_disabled , sbmac_fc_frame , sbmac_fc_collision , sbmac_fc_carrier , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sbmac_softc * s , enum sbmac_duplex duplex , enum sbmac_fc fc ) ;
...
position p;
@@
 int cocci_id@p ( struct sbmacdma * d , struct sk_buff * m ) ;
...
position p;
@@
 enum sbmac_state cocci_id@p ( struct sbmac_softc * , enum sbmac_state ) ;
...
position p;
@@
 int cocci_id@p ( struct platform_device * pldev , long long base ) ;
