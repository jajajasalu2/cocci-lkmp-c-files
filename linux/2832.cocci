...
position p;
@@
 struct acpi_exdump_info cocci_id@p [ 5 ] ;
...
position p;
@@
 struct acpi_exdump_info cocci_id@p [ 6 ] ;
...
position p;
@@
 struct acpi_exdump_info cocci_id@p [ 4 ] ;
...
typedef u32;
@@
 void cocci_id@p ( union acpi_operand_object * obj_desc , u32 level , u32 index ) ;
...
position p;
@@
 struct acpi_exdump_info cocci_id@p [ 3 ] ;
...
position p;
@@
 struct acpi_exdump_info cocci_id@p [ 8 ] ;
...
position p;
@@
 struct acpi_exdump_info * cocci_id@p [ ] ;
...
position p;
@@
 struct acpi_exdump_info cocci_id@p [ 7 ] ;
...
position p;
@@
 struct acpi_exdump_info cocci_id@p [ 2 ] ;
...
position p;
@@
 struct acpi_exdump_info cocci_id@p [ 9 ] ;
...
position p;
@@
 void cocci_id@p ( const char * title , const void * value ) ;
...
position p;
@@
 void cocci_id@p ( union acpi_operand_object * obj_desc , struct acpi_exdump_info * info ) ;
