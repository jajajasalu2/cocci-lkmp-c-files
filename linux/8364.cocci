...
position p;
@@
 struct nfp_net_tls_offload_ctx * cocci_id@p ;
...
position p;
@@
 struct nfp_net_fw_version * cocci_id@p ;
...
position p;
@@
 struct nfp_meta_parsed * cocci_id@p ;
...
position p;
@@
 struct nfp_net_r_vector cocci_id@p ;
...
position p;
@@
 struct nfp_net_rx_ring * cocci_id@p ;
...
position p;
@@
 const struct nfp_net_dp * cocci_id@p ;
...
position p;
@@
 struct nfp_net_tx_ring * cocci_id@p ;
...
position p;
@@
 struct nfp_net_rx_buf * cocci_id@p ;
...
position p;
@@
 struct nfp_net_rx_desc * cocci_id@p ;
...
position p;
@@
 struct nfp_net_rx_hash * cocci_id@p ;
...
position p;
@@
 struct nfp_net_tx_desc * cocci_id@p ;
...
position p;
@@
 struct nfp_net_tx_buf * cocci_id@p ;
