...
position p;
@@
 struct alauda_card_info {  unsigned char id ;  unsigned char chipshift ;  unsigned char pageshift ;  unsigned char blockshift ;  unsigned char zoneshift ; } cocci_id@p ;
...
typedef u16;
@@
 struct alauda_media_info {  unsigned long capacity ;  unsigned int pagesize ;  unsigned int blocksize ;  unsigned int uzonesize ;  unsigned int zonesize ;  unsigned int blockmask ;  unsigned char pageshift ;  unsigned char blockshift ;  unsigned char zoneshift ;  u16 * * lba_to_pba ;  u16 * * pba_to_lba ; } cocci_id@p ;
...
position p;
@@
 struct alauda_card_info * cocci_id@p ;
...
position p;
@@
 struct alauda_info {  struct alauda_media_info port [ 2 ] ;  int wr_ep ;  unsigned char sense_key ;  unsigned long sense_asc ;  unsigned long sense_ascq ; } cocci_id@p ;
...
position p;
@@
 struct alauda_media_info * cocci_id@p ;
