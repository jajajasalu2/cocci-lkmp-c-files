...
position p;
@@
 struct clk_rm9200_main * cocci_id@p ;
...
position p;
@@
 struct clk_main_osc * cocci_id@p ;
...
position p;
@@
 struct clk_rm9200_main {  struct clk_hw hw ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct clk_sam9x5_main * cocci_id@p ;
...
position p;
@@
 struct clk_main_osc {  struct clk_hw hw ;  struct regmap * regmap ; } cocci_id@p ;
...
typedef u8;
@@
 struct clk_sam9x5_main {  struct clk_hw hw ;  struct regmap * regmap ;  u8 parent ; } cocci_id@p ;
...
position p;
@@
 struct clk_main_rc_osc {  struct clk_hw hw ;  struct regmap * regmap ;  unsigned long frequency ;  unsigned long accuracy ; } cocci_id@p ;
...
position p;
@@
 struct clk_main_rc_osc * cocci_id@p ;
