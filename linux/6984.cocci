...
position p;
@@
 struct acpi_pcct_subspace * cocci_id@p ;
...
position p;
@@
 struct acpi_subtable_proc cocci_id@p [ ACPI_PCCT_TYPE_RESERVED ] ;
...
position p;
@@
 struct acpi_table_pcct cocci_id@p ;
...
position p;
@@
 struct acpi_pcct_hw_reduced_type2 * cocci_id@p ;
