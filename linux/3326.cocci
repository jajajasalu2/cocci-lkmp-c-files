...
typedef u8,u16;
@@
 struct ds1621_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  enum chips kind ;  u16 temp [ 3 ] ;  u8 conf ;  u8 zbits ;  u16 update_interval ; } cocci_id@p ;
...
position p;
@@
 enum chips { ds1621 , ds1625 , ds1631 , ds1721 , ds1731 , } cocci_id@p ;
