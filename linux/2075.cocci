...
position p;
@@
 struct mlx90614_data {  struct i2c_client * client ;  struct mutex lock ;  struct gpio_desc * wakeup_gpio ;  unsigned long ready_timestamp ; } cocci_id@p ;
...
position p;
@@
 struct mlx90614_data * cocci_id@p ;
