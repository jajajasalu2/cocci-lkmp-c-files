...
typedef bool,u32;
@@
 struct mt7621_pcie_port {  void __iomem * base ;  struct list_head list ;  struct mt7621_pcie * pcie ;  struct phy * phy ;  struct reset_control * pcie_rst ;  u32 slot ;  bool enabled ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,resource_size_t;
@@
 struct mt7621_pcie {  void __iomem * base ;  struct device * dev ;  struct resource io ;  struct resource mem ;  struct resource busn ;  struct {  resource_size_t mem ;  resource_size_t io ; } offset ;  struct list_head ports ;  struct gpio_desc * perst ;  struct reset_control * rst ;  bool resets_inverted ; } cocci_id@p ;
...
position p;
@@
 struct mt7621_pcie_port * cocci_id@p ;
