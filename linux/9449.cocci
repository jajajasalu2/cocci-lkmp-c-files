...
position p;
@@
 struct swchnlcmd cocci_id@p [ MAX_POSTCMD_CNT ] ;
...
typedef u8,bool,u32;
@@
 bool cocci_id@p ( struct ieee80211_hw * hw , u8 channel , u8 * stage , u8 * step , u32 * delay ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ieee80211_hw * hw ) ;
...
position p;
@@
 struct swchnlcmd cocci_id@p [ MAX_PRECMD_CNT ] ;
...
typedef bool,u32;
@@
 bool cocci_id@p ( struct swchnlcmd * cmdtable , u32 cmdtableidx , u32 cmdtablesz , enum swchnlcmd_id cmdid , u32 para1 , u32 para2 , u32 msdelay ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , enum radio_path rfpath , u32 offset , u32 data ) ;
...
position p;
@@
 void cocci_id@p ( struct ieee80211_hw * hw ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct ieee80211_hw * hw , enum radio_path rfpath , u32 offset ) ;
...
typedef u32;
@@
 u32 cocci_id@p [ IQK_MAC_REG_NUM ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ IQK_ADDA_REG_NUM ] ;
...
typedef u8;
@@
 long cocci_id@p ( struct ieee80211_hw * hw , enum wireless_mode wirelessmode , u8 txpwridx ) ;
...
typedef u8,bool;
@@
 bool cocci_id@p ( struct ieee80211_hw * hw , u8 configtype ) ;
...
position p;
@@
 struct swchnlcmd cocci_id@p [ MAX_RFDEPENDCMD_CNT ] ;
...
position p;
@@
 struct rtl8192_tx_ring * cocci_id@p ;
...
position p;
@@
 struct rtl_pci_priv * cocci_id@p ;
