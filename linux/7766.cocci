...
position p;
@@
 struct mps2_uart_port {  struct uart_port port ;  struct clk * clk ;  unsigned int tx_irq ;  unsigned int rx_irq ;  unsigned int flags ; } cocci_id@p ;
...
position p;
@@
 struct mps2_uart_port * cocci_id@p ;
