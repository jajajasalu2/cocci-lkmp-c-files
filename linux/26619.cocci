...
typedef __u32;
@@
 struct hist_key {  struct task t ;  __u32 index ; } cocci_id@p ;
...
typedef __u64;
@@
 struct task {  char comm [ 16 ] ;  __u64 pid_tgid ;  __u64 uid_gid ; } cocci_id@p ;
