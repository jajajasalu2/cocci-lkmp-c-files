...
typedef u8,u32;
@@
 struct frad_state {  fr_proto settings ;  struct pvc_device * first_pvc ;  int dce_pvc_count ;  struct timer_list timer ;  struct net_device * dev ;  unsigned long last_poll ;  int reliable ;  int dce_changed ;  int request ;  int fullrep_sent ;  u32 last_errors ;  u8 n391cnt ;  u8 txseq ;  u8 rxseq ; } cocci_id@p ;
...
position p;
@@
 struct pvc_device {  struct net_device * frad ;  struct net_device * main ;  struct net_device * ether ;  struct pvc_device * next ;  int dlci ;  int open_count ;  struct {  unsigned int new : 1 ;  unsigned int active : 1 ;  unsigned int exist : 1 ;  unsigned int deleted : 1 ;  unsigned int fecn : 1 ;  unsigned int becn : 1 ;  unsigned int bandwidth ; } state ; } cocci_id@p ;
