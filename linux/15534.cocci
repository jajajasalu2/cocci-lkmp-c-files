...
position p;
@@
 struct rx_device_buffer * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ks_wlan_private * priv , struct sk_buff * skb ) ;
...
position p;
@@
 struct ks_sdio_card * cocci_id@p ;
...
position p;
@@
 struct ks_sdio_card {  struct sdio_func * func ;  struct ks_wlan_private * priv ; } cocci_id@p ;
...
position p;
@@
 enum gen_com_reg_a { GCR_A_INIT , GCR_A_REMAP , GCR_A_RUN , } cocci_id@p ;
...
position p;
@@
 struct tx_device_buffer * cocci_id@p ;
...
position p;
@@
 enum gen_com_reg_b { GCR_B_ACTIVE , GCR_B_DOZE , } cocci_id@p ;
...
position p;
@@
 enum reg_status_type { REG_STATUS_BUSY , REG_STATUS_IDLE , } cocci_id@p ;
