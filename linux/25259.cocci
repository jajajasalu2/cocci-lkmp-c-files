...
position p;
@@
 struct tep_plugin_list {  struct tep_plugin_list * next ;  char * name ;  void * handle ; } cocci_id@p ;
...
position p;
@@
 struct registered_plugin_options {  struct registered_plugin_options * next ;  struct tep_plugin_option * options ; } * cocci_id@p ;
...
position p;
@@
 struct trace_plugin_options {  struct trace_plugin_options * next ;  char * plugin ;  char * option ;  char * value ; } * cocci_id@p ;
...
position p;
@@
 struct registered_plugin_options * * cocci_id@p ;
...
position p;
@@
 tep_plugin_unload_func cocci_id@p ;
...
position p;
@@
 struct tep_plugin_list * * cocci_id@p ;
...
position p;
@@
 struct trace_plugin_options * cocci_id@p ;
...
position p;
@@
 struct tep_plugin_option * cocci_id@p ;
...
position p;
@@
 tep_plugin_load_func cocci_id@p ;
...
position p;
@@
 const struct tep_plugin_list * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct tep_handle * tep , const char * path , const char * name , void * data ) ;
