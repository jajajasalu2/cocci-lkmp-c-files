...
position p;
@@
 struct ecryptfs_getdents_callback cocci_id@p ;
...
position p;
@@
 struct ecryptfs_getdents_callback {  struct dir_context ctx ;  struct dir_context * caller ;  struct super_block * sb ;  int filldir_called ;  int entries_written ; } cocci_id@p ;
