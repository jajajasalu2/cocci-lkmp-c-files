...
position p;
@@
 struct dsi_pll_14nm_postdiv cocci_id@p ;
...
position p;
@@
 struct dsi_pll_14nm cocci_id@p ;
...
typedef u8;
@@
 struct dsi_pll_14nm_postdiv {  struct clk_hw hw ;  u8 shift ;  u8 width ;  u8 flags ;  struct dsi_pll_14nm * pll ; } cocci_id@p ;
...
position p;
@@
 struct pll_14nm_cached_state * cocci_id@p ;
...
position p;
@@
 struct dsi_pll_output * cocci_id@p ;
...
position p;
@@
 enum msm_dsi_phy_usecase cocci_id@p ;
...
typedef u8;
@@
 struct pll_14nm_cached_state {  unsigned long vco_rate ;  u8 n2postdiv ;  u8 n1postdiv ; } cocci_id@p ;
...
position p;
@@
 struct dsi_pll_input * cocci_id@p ;
...
position p;
@@
 struct dsi_pll_14nm * cocci_id@p [ DSI_MAX ] ;
