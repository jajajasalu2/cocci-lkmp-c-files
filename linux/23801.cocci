...
position p;
@@
 struct tcf_ife_params * cocci_id@p ;
...
position p;
@@
 const struct tcf_meta_ops * cocci_id@p ;
...
position p;
@@
 struct tcf_meta_ops * cocci_id@p ;
...
position p;
@@
 struct tcf_ife_info cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_IFE_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_IFE_MAX + 1 ] ;
...
position p;
@@
 struct tcf_meta_info * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IFE_META_MAX + 1 ] ;
