...
position p;
@@
 const struct hfa384x_rx_frame * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sk_buff * , int ok , void * ) ;
...
position p;
@@
 struct hfa384x_comms_quality cocci_id@p ;
...
position p;
@@
 struct hostap_ieee80211_mgmt * cocci_id@p ;
...
position p;
@@
 const struct hfa384x_tx_frame * cocci_id@p ;
...
position p;
@@
 enum { NONE , WEP , OTHER , } cocci_id@p ;
