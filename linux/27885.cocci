...
position p;
@@
 struct ovl_readdir_translate cocci_id@p ;
...
position p;
@@
 struct ovl_readdir_data * cocci_id@p ;
...
position p;
@@
 struct ovl_dir_cache * cocci_id@p ;
...
typedef u64,bool;
@@
 struct ovl_cache_entry {  unsigned int len ;  unsigned int type ;  u64 real_ino ;  u64 ino ;  struct list_head l_node ;  struct rb_node node ;  struct ovl_cache_entry * next_maybe_whiteout ;  bool is_upper ;  bool is_whiteout ;  char name [ ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct ovl_readdir_data {  struct dir_context ctx ;  struct dentry * dentry ;  bool is_lowest ;  struct rb_root * root ;  struct list_head * list ;  struct list_head middle ;  struct ovl_cache_entry * first_maybe_whiteout ;  int count ;  int err ;  bool is_upper ;  bool d_type_supported ; } cocci_id@p ;
...
typedef bool;
@@
 struct ovl_dir_file {  bool is_real ;  bool is_upper ;  struct ovl_dir_cache * cache ;  struct list_head * cursor ;  struct file * realfile ;  struct file * upperfile ; } cocci_id@p ;
...
position p;
@@
 struct ovl_dir_file cocci_id@p ;
...
typedef u64;
@@
 struct ovl_dir_cache {  long refcount ;  u64 version ;  struct list_head entries ;  struct rb_root root ; } cocci_id@p ;
...
position p;
@@
 struct ovl_cache_entry cocci_id@p ;
...
typedef u64;
@@
 struct ovl_readdir_translate {  struct dir_context * orig_ctx ;  struct ovl_dir_cache * cache ;  struct dir_context ctx ;  u64 parent_ino ;  int fsid ;  int xinobits ; } cocci_id@p ;
