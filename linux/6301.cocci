...
position p;
@@
 struct pm860x_touch_pdata cocci_id@p ;
...
position p;
@@
 struct pm860x_irq_data cocci_id@p [ ] ;
...
position p;
@@
 struct pm860x_power_pdata cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ INT_STATUS_NUM ] ;
...
position p;
@@
 struct pm860x_led_pdata cocci_id@p ;
...
position p;
@@
 struct pm860x_irq_data {  int reg ;  int mask_reg ;  int enable ;  int offs ; } cocci_id@p ;
...
position p;
@@
 struct pm860x_rtc_pdata cocci_id@p ;
...
position p;
@@
 struct pm860x_platform_data cocci_id@p ;
...
position p;
@@
 struct pm860x_backlight_pdata cocci_id@p ;
...
position p;
@@
 struct charger_regulator cocci_id@p [ ] ;
