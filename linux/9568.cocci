...
position p;
@@
 enum { CCUT_IDX_1R_2G , CCUT_IDX_2R_2G , CCUT_IDX_1R_5G , CCUT_IDX_2R_5G , CCUT_IDX_NR , } cocci_id@p ;
...
position p;
@@
 const struct cca_ccut cocci_id@p ;
...
typedef u8,bool;
@@
 struct rtw8822b_rfe_info {  const struct cca_ccut * cca_ccut_2g ;  const struct cca_ccut * cca_ccut_5g ;  enum rtw_rfe_fem fem ;  bool ifem_ext ;  void ( * rtw_set_channel_rfe ) ( struct rtw_dev * rtwdev , u8 channel ) ; } cocci_id@p ;
...
position p;
@@
 const struct rtw8822b_rfe_info cocci_id@p [ ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ RTW_TXSCALE_SIZE ] ;
...
position p;
@@
 struct rtw8822b_efuse * cocci_id@p ;
...
typedef u32;
@@
 struct cca_ccut {  u32 reg82c [ CCUT_IDX_NR ] ;  u32 reg830 [ CCUT_IDX_NR ] ;  u32 reg838 [ CCUT_IDX_NR ] ; } cocci_id@p ;
