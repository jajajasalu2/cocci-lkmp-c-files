...
typedef u64;
@@
 struct mlxsw_sx_port_hw_stats {  char str [ ETH_GSTRING_LEN ] ;  u64 ( * getter ) ( const char * payload ) ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sx_port_pcpu_stats * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sx_port cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_spmlr_learn_mode cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_sx_port {  struct net_device * dev ;  struct mlxsw_sx_port_pcpu_stats __percpu * pcpu_stats ;  struct mlxsw_sx * mlxsw_sx ;  u8 local_port ;  struct {  u8 module ; } mapping ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SPMLR_LEN ] ;
...
typedef u8;
@@
 struct mlxsw_sx {  struct mlxsw_sx_port * * ports ;  struct mlxsw_core * core ;  const struct mlxsw_bus_info * bus_info ;  u8 hw_id [ ETH_ALEN ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SFGC_LEN ] ;
...
typedef u64,u32;
@@
 struct mlxsw_sx_port_pcpu_stats {  u64 rx_packets ;  u64 rx_bytes ;  u64 tx_packets ;  u64 tx_bytes ;  struct u64_stats_sync syncp ;  u32 tx_dropped ; } cocci_id@p ;
...
typedef u32;
@@
 struct mlxsw_sx_port_link_mode {  u32 mask ;  u32 supported ;  u32 advertised ;  u32 speed ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PLIB_LEN ] ;
...
position p;
@@
 const struct mlxsw_sx_port_link_mode cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SGCR_LEN ] ;
...
position p;
@@
 const struct mlxsw_sx_port_hw_stats cocci_id@p [ ] ;
