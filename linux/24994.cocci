...
position p;
@@
 struct batadv_dat_entry * cocci_id@p ;
...
position p;
@@
 enum batadv_dhcpoptioncode { BATADV_DHCP_OPT_PAD = 0 , BATADV_DHCP_OPT_MSG_TYPE = 53 , BATADV_DHCP_OPT_END = 255 , } cocci_id@p ;
...
position p;
@@
 enum batadv_dhcptype { BATADV_DHCPACK = 5 , } cocci_id@p ;
...
position p;
@@
 struct batadv_dhcp_packet cocci_id@p ;
...
position p;
@@
 struct batadv_unicast_packet cocci_id@p ;
...
position p;
@@
 struct batadv_dat_candidate * cocci_id@p ;
...
position p;
@@
 struct batadv_unicast_4addr_packet cocci_id@p ;
...
position p;
@@
 struct batadv_priv_dat cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 type ;  u8 len ; } * cocci_id@p ;
...
typedef __be32,__u8;
@@
 struct batadv_dhcp_packet {  __u8 op ;  __u8 htype ;  __u8 hlen ;  __u8 hops ;  __be32 xid ;  __be16 secs ;  __be16 flags ;  __be32 ciaddr ;  __be32 yiaddr ;  __be32 siaddr ;  __be32 giaddr ;  __u8 chaddr [ 16 ] ;  __u8 sname [ 64 ] ;  __u8 file [ 128 ] ;  __be32 magic ;  __u8 options [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct batadv_dat_entry * cocci_id@p ;
...
position p;
@@
 enum batadv_bootpop { BATADV_BOOTREPLY = 2 , } cocci_id@p ;
...
position p;
@@
 struct batadv_forw_packet * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ BATADV_DHCP_CHADDR_LEN ] ;
...
typedef __u8;
@@
 struct {  __u8 op ;  __u8 htype ;  __u8 hlen ;  __u8 hops ; } * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct batadv_dat_entry * ) ;
...
position p;
@@
 enum batadv_boothtype { BATADV_HTYPE_ETHERNET = 1 , } cocci_id@p ;
...
position p;
@@
 struct batadv_bcast_packet * cocci_id@p ;
