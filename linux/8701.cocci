...
position p;
@@
 struct iavf_aqc_get_set_rss_key * cocci_id@p ;
...
position p;
@@
 enum iavf_debug_mask cocci_id@p ;
...
position p;
@@
 struct iavf_aqc_get_set_rss_lut * cocci_id@p ;
...
position p;
@@
 enum iavf_admin_queue_err cocci_id@p ;
...
position p;
@@
 struct iavf_asq_cmd_details * cocci_id@p ;
...
position p;
@@
 struct iavf_aqc_queue_shutdown * cocci_id@p ;
...
position p;
@@
 struct iavf_aq_desc cocci_id@p ;
