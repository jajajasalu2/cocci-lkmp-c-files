...
position p;
@@
 struct mlxsw_sp_mr_tcam_erif_list cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_RIGR2_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_mr_erif_sublist cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_mr_tcam_ops * cocci_id@p ;
...
typedef u32;
@@
 struct mlxsw_sp_mr_tcam_erif_list {  struct list_head erif_sublists ;  u32 kvdl_index ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_tcam_route * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_tcam * cocci_id@p ;
...
@@
 struct mlxsw_sp_mr_erif_sublist {  struct list_head list ;  u32 rigr2_kvdl_index ;  int num_erifs ;  u16 erif_indices [ MLXSW_REG_RIGR2_MAX_ERIFS ] ;  bool synced ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_tcam {  void * priv ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct mlxsw_sp_mr_tcam_route {  struct mlxsw_sp_mr_tcam_erif_list erif_list ;  struct mlxsw_afa_block * afa_block ;  u32 counter_index ;  enum mlxsw_sp_mr_route_action action ;  struct mlxsw_sp_mr_route_key key ;  u16 irif_index ;  u16 min_mtu ;  void * priv ; } cocci_id@p ;
