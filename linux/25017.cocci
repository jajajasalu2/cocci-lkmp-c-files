...
position p;
@@
 unsigned char cocci_id@p [ EUI64_ADDR_LEN ] ;
...
position p;
@@
 const struct lowpan_iphc_ctx * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ LOWPAN_IPHC_MAX_HC_BUF_LEN ] ;
...
position p;
@@
 struct lowpan_iphc_ctx * cocci_id@p ;
