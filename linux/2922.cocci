...
typedef u64,u8,s32;
@@
 char * cocci_id@p ( char * string , char * end , u64 number , u8 base , s32 width , s32 precision , u8 type ) ;
...
typedef u64,u8;
@@
 char * cocci_id@p ( char * string , u64 number , u8 base , u8 upper ) ;
...
position p;
@@
 acpi_size cocci_id@p ( const char * string , acpi_size count ) ;
...
position p;
@@
 char * cocci_id@p ( char * string , const char * end , char c ) ;
