...
position p;
@@
 void ( * cocci_id@p ) ( struct brcms_phy * ) ;
...
typedef u16;
@@
 struct chan_info_basic {  u16 chan ;  u16 freq ; } cocci_id@p ;
...
position p;
@@
 const struct chan_info_basic cocci_id@p [ ] ;
...
typedef u16;
@@
 void ( * cocci_id@p ) ( struct brcms_phy * , u16 ) ;
...
position p;
@@
 struct brcms_chanvec * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ 2 * BRCMS_NUM_RATES_OFDM ] ;
