...
position p;
@@
 struct guc_stage_desc * cocci_id@p ;
...
position p;
@@
 const struct i915_wa_list * cocci_id@p ;
...
position p;
@@
 struct intel_uncore_forcewake_domain * cocci_id@p ;
...
position p;
@@
 const struct intel_runtime_info * cocci_id@p ;
...
position p;
@@
 struct i915_power_domains * cocci_id@p ;
...
position p;
@@
 struct intel_guc_client * cocci_id@p ;
...
position p;
@@
 const struct i915_debugfs_files {  const char * name ;  const struct file_operations * fops ; } cocci_id@p [ ] ;
...
position p;
@@
 struct i915_fence_reg * cocci_id@p ;
...
position p;
@@
 const struct i915_wa * cocci_id@p ;
...
position p;
@@
 struct guc_execlist_context * cocci_id@p ;
...
position p;
@@
 struct i915_power_well * cocci_id@p ;
...
position p;
@@
 struct intel_opregion * cocci_id@p ;
...
position p;
@@
 const struct dpcd_block * cocci_id@p ;
...
position p;
@@
 enum guc_log_buffer_type cocci_id@p ;
...
position p;
@@
 const struct intel_guc * cocci_id@p ;
...
typedef bool;
@@
 struct dpcd_block {  unsigned int offset ;  unsigned int end ;  size_t size ;  bool edp ; } cocci_id@p ;
...
position p;
@@
 const struct intel_device_info * cocci_id@p ;
...
position p;
@@
 struct i915_hotplug * cocci_id@p ;
...
position p;
@@
 struct intel_dp_mst_encoder * cocci_id@p ;
...
position p;
@@
 struct i915_gpu_state * cocci_id@p ;
...
position p;
@@
 struct sseu_dev_info * cocci_id@p ;
...
position p;
@@
 struct intel_guc_log * cocci_id@p ;
