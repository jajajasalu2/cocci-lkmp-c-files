...
position p;
@@
 void cocci_id@p ( struct omap_ep * ep , unsigned preferred ) ;
...
typedef u16;
@@
 union u {  u16 word [ 4 ] ;  struct usb_ctrlrequest r ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct omap_ep * , int status ) ;
