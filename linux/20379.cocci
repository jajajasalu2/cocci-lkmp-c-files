...
position p;
@@
 struct user32_fxsr_struct cocci_id@p ;
...
position p;
@@
 struct user_i387_ia32_struct cocci_id@p ;
...
position p;
@@
 struct user_i387_struct cocci_id@p ;
...
position p;
@@
 struct user_regs_struct cocci_id@p ;
...
position p;
@@
 enum x86_regset { REGSET_GENERAL , REGSET_FP , REGSET_XFP , REGSET_IOPERM64 = REGSET_XFP , REGSET_XSTATE , REGSET_TLS , REGSET_IOPERM32 , } cocci_id@p ;
...
typedef compat_ulong_t;
@@
 const compat_ulong_t * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ USER_XSTATE_FX_SW_WORDS ] ;
...
position p;
@@
 struct user_regs_struct32 cocci_id@p ;
...
position p;
@@
 struct user_fxsr_struct cocci_id@p ;
