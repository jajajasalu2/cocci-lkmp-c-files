...
position p;
@@
 struct eth_tx_2nd_bd * cocci_id@p ;
...
position p;
@@
 struct eth_fast_path_rx_tpa_cont_cqe * cocci_id@p ;
...
position p;
@@
 struct eth_fast_path_rx_tpa_end_cqe * cocci_id@p ;
...
position p;
@@
 struct eth_tx_3rd_bd * cocci_id@p ;
...
position p;
@@
 struct eth_fast_path_rx_tpa_start_cqe * cocci_id@p ;
