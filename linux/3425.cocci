...
position p;
@@
 enum { mb_empty = 0 , mb_powering_up , mb_enabling_bay , mb_resetting , mb_ide_resetting , mb_up , mb_powering_down , } cocci_id@p ;
...
position p;
@@
 struct media_bay_info * cocci_id@p ;
...
typedef u32;
@@
 struct media_bay_info {  u32 __iomem * base ;  int content_id ;  int state ;  int last_value ;  int value_count ;  int timer ;  struct macio_dev * mdev ;  const struct mb_ops * ops ;  int index ;  int cached_gpio ;  int sleeping ;  int user_lock ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 const struct mb_ops cocci_id@p ;
...
position p;
@@
 struct media_bay_info cocci_id@p [ MAX_BAYS ] ;
