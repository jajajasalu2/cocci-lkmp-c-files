...
position p;
@@
 const struct cper_sec_proc_generic * cocci_id@p ;
...
position p;
@@
 struct acpi_hest_generic_data_v300 * cocci_id@p ;
...
position p;
@@
 struct cper_sec_proc_ia * cocci_id@p ;
...
position p;
@@
 struct cper_mem_err_compact cocci_id@p ;
...
position p;
@@
 const struct cper_sec_pcie * cocci_id@p ;
...
position p;
@@
 struct cper_sec_proc_generic * cocci_id@p ;
...
position p;
@@
 struct cper_sec_mem_err_old cocci_id@p ;
...
position p;
@@
 const struct acpi_hest_generic_data * cocci_id@p ;
...
position p;
@@
 const struct cper_sec_mem_err * cocci_id@p ;
