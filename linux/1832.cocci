...
position p;
@@
 struct sc27xx_adc_linear_graph cocci_id@p ;
...
position p;
@@
 const struct sc27xx_adc_linear_graph * cocci_id@p ;
...
position p;
@@
 struct sc27xx_adc_linear_graph {  int volt0 ;  int adc0 ;  int volt1 ;  int adc1 ; } cocci_id@p ;
...
typedef u32;
@@
 struct sc27xx_adc_data {  struct device * dev ;  struct regmap * regmap ;  struct hwspinlock * hwlock ;  int channel_scale [ SC27XX_ADC_CHANNEL_MAX ] ;  u32 base ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct sc27xx_adc_data * cocci_id@p ;
