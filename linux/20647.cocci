...
position p;
@@
 void ( * cocci_id@p ) ( struct perf_event * , struct pt_regs * , void * , struct perf_sample_data * , struct pt_regs * ) ;
...
typedef u64;
@@
 union intel_x86_pebs_dse {  u64 val ;  struct {  unsigned int ld_dse : 4 ;  unsigned int ld_stlb_miss : 1 ;  unsigned int ld_locked : 1 ;  unsigned int ld_reserved : 26 ; } ;  struct {  unsigned int st_l1d_hit : 1 ;  unsigned int st_reserved1 : 3 ;  unsigned int st_stlb_miss : 1 ;  unsigned int st_locked : 1 ;  unsigned int st_reserved2 : 26 ; } ; } cocci_id@p ;
...
position p;
@@
 struct pebs_record_hsw cocci_id@p ;
...
position p;
@@
 union intel_x86_pebs_dse cocci_id@p ;
...
typedef u64,u32;
@@
 union hsw_tsx_tuning {  struct {  u32 cycles_last_block : 32 , hle_abort : 1 , rtm_abort : 1 , instruction_abort : 1 , non_instruction_abort : 1 , retry : 1 , data_conflict : 1 , capacity_writes : 1 , capacity_reads : 1 ; } ;  u64 value ; } cocci_id@p ;
...
position p;
@@
 short cocci_id@p [ INTEL_PMC_IDX_FIXED + MAX_FIXED_PEBS_EVENTS ] ;
...
position p;
@@
 struct pebs_record_nhm * cocci_id@p ;
...
position p;
@@
 struct pebs_lbr_entry cocci_id@p ;
...
position p;
@@
 struct pebs_record_skl cocci_id@p ;
...
typedef u64;
@@
 struct bts_record {  u64 from ;  u64 to ;  u64 flags ; } cocci_id@p ;
...
position p;
@@
 struct x86_perf_regs cocci_id@p ;
...
position p;
@@
 struct pebs_record_core cocci_id@p ;
...
position p;
@@
 union hsw_tsx_tuning cocci_id@p ;
...
position p;
@@
 struct pebs_meminfo * cocci_id@p ;
...
position p;
@@
 union perf_mem_data_src cocci_id@p ;
...
position p;
@@
 struct cpu_hw_events * cocci_id@p ;
