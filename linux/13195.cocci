...
position p;
@@
 v4l2_std_id cocci_id@p ( enum tw5864_vid_std std ) ;
...
position p;
@@
 enum tw5864_vid_std * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tw5864_input * dev , int video_nr ) ;
...
position p;
@@
 void cocci_id@p ( struct tw5864_h264_frame * frame ) ;
...
position p;
@@
 struct tw5864_h264_frame * cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ QUANTIZATION_TABLE_LEN ] ;
...
position p;
@@
 void cocci_id@p ( struct tw5864_input * input ) ;
...
typedef u16;
@@
 const u16 cocci_id@p [ VLC_LOOKUP_TABLE_LEN ] ;
...
position p;
@@
 void cocci_id@p ( struct tw5864_input * dev ) ;
...
position p;
@@
 struct tw5864_input cocci_id@p ;
...
position p;
@@
 enum tw5864_vid_std cocci_id@p ( v4l2_std_id v4l2_std ) ;
...
position p;
@@
 void cocci_id@p ( struct tw5864_dev * dev ) ;
