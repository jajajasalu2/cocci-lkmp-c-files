...
position p;
@@
 struct vprbrd_i2c_read_hdr cocci_id@p ;
...
position p;
@@
 struct vprbrd_i2c_status cocci_id@p ;
...
position p;
@@
 struct vprbrd_i2c_write_msg * cocci_id@p ;
...
position p;
@@
 struct vprbrd_i2c_read_msg * cocci_id@p ;
...
position p;
@@
 struct vprbrd_i2c_addr_msg cocci_id@p ;
...
position p;
@@
 struct vprbrd_i2c_write_hdr cocci_id@p ;
...
typedef u8;
@@
 struct vprbrd_i2c {  struct i2c_adapter i2c ;  u8 bus_freq_param ; } cocci_id@p ;
