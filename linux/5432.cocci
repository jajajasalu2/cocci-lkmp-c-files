...
typedef u8;
@@
 struct spi_clps711x_data {  void __iomem * syncio ;  struct regmap * syscon ;  struct clk * spi_clk ;  u8 * tx_buf ;  u8 * rx_buf ;  unsigned int bpw ;  int len ; } cocci_id@p ;
...
position p;
@@
 struct spi_clps711x_data * cocci_id@p ;
