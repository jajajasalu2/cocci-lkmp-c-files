...
position p;
@@
 struct acpi_peripheral * cocci_id@p ;
...
position p;
@@
 struct chromeos_laptop * cocci_id@p ;
...
typedef u32;
@@
 struct i2c_peripheral {  struct i2c_board_info board_info ;  unsigned short alt_addr ;  const char * dmi_name ;  unsigned long irqflags ;  struct resource irq_resource ;  enum i2c_adapter_type type ;  u32 pci_devid ;  struct i2c_client * client ; } cocci_id@p ;
...
position p;
@@
 struct acpi_peripheral {  char hid [ ACPI_ID_LEN ] ;  const struct property_entry * properties ; } cocci_id@p ;
...
position p;
@@
 const struct chromeos_laptop * cocci_id@p ;
...
position p;
@@
 struct acpi_device_id cocci_id@p [ 2 ] ;
...
position p;
@@
 struct chromeos_laptop {  struct i2c_peripheral * i2c_peripherals ;  unsigned int num_i2c_peripherals ;  const struct acpi_peripheral * acpi_peripherals ;  unsigned int num_acpi_peripherals ; } cocci_id@p ;
...
position p;
@@
 enum i2c_adapter_type { I2C_ADAPTER_SMBUS = 0 , I2C_ADAPTER_VGADDC , I2C_ADAPTER_PANEL , I2C_ADAPTER_DESIGNWARE , } cocci_id@p ;
...
position p;
@@
 const struct dmi_dev_onboard * cocci_id@p ;
...
position p;
@@
 const struct acpi_peripheral * cocci_id@p ;
...
position p;
@@
 struct i2c_peripheral * cocci_id@p ;
