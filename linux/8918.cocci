...
position p;
@@
 enum mdio_c22_op_seq { MDIO_C22_WRITE = 1 , MDIO_C22_READ = 2 , } cocci_id@p ;
...
position p;
@@
 const struct hns_mdio_sc_reg * cocci_id@p ;
...
typedef u16;
@@
 struct hns_mdio_sc_reg {  u16 mdio_clk_en ;  u16 mdio_clk_dis ;  u16 mdio_reset_req ;  u16 mdio_reset_dreq ;  u16 mdio_clk_st ;  u16 mdio_reset_st ; } cocci_id@p ;
...
position p;
@@
 enum mdio_st_clause { MDIO_ST_CLAUSE_45 = 0 , MDIO_ST_CLAUSE_22 , } cocci_id@p ;
...
typedef u8;
@@
 struct hns_mdio_device {  u8 __iomem * vbase ;  struct regmap * subctrl_vbase ;  struct hns_mdio_sc_reg sc_reg ; } cocci_id@p ;
...
position p;
@@
 struct hns_mdio_device * cocci_id@p ;
...
position p;
@@
 enum mdio_c45_op_seq { MDIO_C45_WRITE_ADDR = 0 , MDIO_C45_WRITE_DATA , MDIO_C45_READ_INCREMENT , MDIO_C45_READ , } cocci_id@p ;
