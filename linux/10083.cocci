...
position p;
@@
 struct cfhsi_ops * ( * cocci_id@p ) ( void ) ;
...
position p;
@@
 struct cfhsi_cb_ops * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ __IFLA_CAIF_HSI_MAX + 1 ] ;
...
position p;
@@
 const struct cfhsi_config cocci_id@p ;
