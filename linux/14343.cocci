...
typedef u8;
@@
 struct cx24116_state {  struct i2c_adapter * i2c ;  const struct cx24116_config * config ;  struct dvb_frontend frontend ;  struct cx24116_tuning dcur ;  struct cx24116_tuning dnxt ;  u8 skip_fw_load ;  u8 burst ;  struct cx24116_cmd dsec_cmd ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct cx24116_tuning {  u32 frequency ;  u32 symbol_rate ;  enum fe_spectral_inversion inversion ;  enum fe_code_rate fec ;  enum fe_delivery_system delsys ;  enum fe_modulation modulation ;  enum fe_pilot pilot ;  enum fe_rolloff rolloff ;  u8 fec_val ;  u8 fec_mask ;  u8 inversion_val ;  u8 pilot_val ;  u8 rolloff_val ; } cocci_id@p ;
...
typedef u8;
@@
 struct cx24116_cmd {  u8 len ;  u8 args [ CX24116_ARGLEN ] ; } cocci_id@p ;
...
position p;
@@
 enum cmds { CMD_SET_VCO = 0x10 , CMD_TUNEREQUEST = 0x11 , CMD_MPEGCONFIG = 0x13 , CMD_TUNERINIT = 0x14 , CMD_BANDWIDTH = 0x15 , CMD_GETAGC = 0x19 , CMD_LNBCONFIG = 0x20 , CMD_LNBSEND = 0x21 , CMD_LNBDCLEVEL = 0x22 , CMD_SET_TONE = 0x23 , CMD_UPDFWVERS = 0x35 , CMD_TUNERSLEEP = 0x36 , CMD_AGCCONTROL = 0x3b , } cocci_id@p ;
...
typedef u8;
@@
 struct cx24116_modfec {  enum fe_delivery_system delivery_system ;  enum fe_modulation modulation ;  enum fe_code_rate fec ;  u8 mask ;  u8 val ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct cx24116_config * cocci_id@p ;
...
position p;
@@
 struct cx24116_state * cocci_id@p ;
