...
typedef s32;
@@
 struct gadc_thermal_info {  struct device * dev ;  struct thermal_zone_device * tz_dev ;  struct iio_channel * channel ;  s32 * lookup_table ;  int nlookup_table ; } cocci_id@p ;
...
position p;
@@
 struct gadc_thermal_info * cocci_id@p ;
