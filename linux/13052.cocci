...
position p;
@@
 struct llcc_drv_data * cocci_id@p ;
...
position p;
@@
 const struct llcc_slice_config cocci_id@p [ ] ;
...
position p;
@@
 struct qcom_llcc_config {  const struct llcc_slice_config * sct_data ;  int size ; } cocci_id@p ;
...
position p;
@@
 struct llcc_slice_desc * cocci_id@p ;
...
typedef bool,u32;
@@
 struct llcc_slice_config {  u32 usecase_id ;  u32 slice_id ;  u32 max_cap ;  u32 priority ;  bool fixed_size ;  u32 bonus_ways ;  u32 res_ways ;  u32 cache_mode ;  u32 probe_target_ways ;  bool dis_cap_alloc ;  bool retain_on_pc ;  bool activate_on_init ; } cocci_id@p ;
...
position p;
@@
 const struct qcom_llcc_config cocci_id@p ;
