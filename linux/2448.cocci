...
position p;
@@
 const struct shdma_ops * cocci_id@p ;
...
position p;
@@
 enum shdma_desc_status { DESC_IDLE , DESC_PREPARED , DESC_SUBMITTED , DESC_COMPLETED , DESC_WAITING , } cocci_id@p ;
