...
position p;
@@
 struct wkup_m3_platform_data cocci_id@p ;
...
position p;
@@
 struct pdata_init {  const char * compatible ;  void ( * fn ) ( void ) ; } cocci_id@p ;
...
position p;
@@
 struct twl4030_gpio_platform_data cocci_id@p ;
...
position p;
@@
 const struct ti_sysc_cookie * cocci_id@p ;
