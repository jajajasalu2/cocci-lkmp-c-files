...
position p;
@@
 struct fwnode_endpoint cocci_id@p ;
...
position p;
@@
 struct v4l2_fwnode_link * cocci_id@p ;
...
position p;
@@
 const struct v4l2_fwnode_bus_conv * cocci_id@p ;
...
position p;
@@
 parse_endpoint_func cocci_id@p ;
...
position p;
@@
 const struct v4l2_fwnode_bus_conv {  enum v4l2_fwnode_bus_type fwnode_bus_type ;  enum v4l2_mbus_type mbus_type ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct v4l2_fwnode_bus_parallel * cocci_id@p ;
...
position p;
@@
 enum v4l2_fwnode_bus_type { V4L2_FWNODE_BUS_TYPE_GUESS = 0 , V4L2_FWNODE_BUS_TYPE_CSI2_CPHY , V4L2_FWNODE_BUS_TYPE_CSI1 , V4L2_FWNODE_BUS_TYPE_CCP2 , V4L2_FWNODE_BUS_TYPE_CSI2_DPHY , V4L2_FWNODE_BUS_TYPE_PARALLEL , V4L2_FWNODE_BUS_TYPE_BT656 , NR_OF_V4L2_FWNODE_BUS_TYPE , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ 1 + V4L2_FWNODE_CSI2_MAX_DATA_LANES ] ;
...
position p;
@@
 const struct v4l2_fwnode_int_props cocci_id@p [ ] ;
...
position p;
@@
 enum v4l2_fwnode_bus_type cocci_id@p ;
...
position p;
@@
 struct v4l2_fwnode_bus_mipi_csi1 * cocci_id@p ;
...
position p;
@@
 struct v4l2_fwnode_int_props {  const char * name ;  const char * const * props ;  unsigned int nprops ; } cocci_id@p ;
