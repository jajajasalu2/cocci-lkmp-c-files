...
position p;
@@
 int cocci_id@p ( struct net_device * dev , struct net_device * port_dev ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct team_port * port , bool linkup ) ;
...
position p;
@@
 struct team_pcpu_stats * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TEAM_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TEAM_ATTR_OPTION_MAX + 1 ] ;
...
position p;
@@
 void cocci_id@p ( struct team_port * port ) ;
...
symbol cocci_id;
position p;
typedef team_nl_send_func_t;
@@
 team_nl_send_func_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct team * team , struct list_head * sel_opt_inst_list ) ;
...
typedef bool;
@@
 struct team_option_inst {  struct list_head list ;  struct list_head tmp_list ;  struct team_option * option ;  struct team_option_inst_info info ;  bool changed ;  bool removed ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct sk_buff * skb , struct team * team , u32 portid ) ;
...
position p;
@@
 struct team_mode_ops cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct team * team ) ;
...
position p;
@@
 struct netpoll_info * cocci_id@p ;
...
position p;
@@
 struct team_mode_item * cocci_id@p ;
...
position p;
@@
 struct team_option_inst * cocci_id@p ;
...
position p;
@@
 struct team_mode_item {  struct list_head list ;  const struct team_mode * mode ; } cocci_id@p ;
...
position p;
@@
 enum team_option_type cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TEAM_ATTR_OPTION_MAX + 1 ] ;
...
position p;
@@
 const struct team_port * cocci_id@p ;
