...
position p;
@@
 struct omap_sr_nvalue_table * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NVALUE_NAME_LEN + 1 ] ;
...
position p;
@@
 struct omap_sr_class_data * cocci_id@p ;
...
position p;
@@
 struct omap_sr_data * cocci_id@p ;
...
position p;
@@
 struct omap_volt_data * cocci_id@p ;
