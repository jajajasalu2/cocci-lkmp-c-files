...
position p;
@@
 struct vt_setactivate cocci_id@p ;
...
position p;
@@
 struct vt_event_wait * cocci_id@p ;
...
position p;
@@
 struct vt_event_wait {  struct list_head list ;  struct vt_event event ;  int done ; } cocci_id@p ;
...
position p;
@@
 struct compat_consolefontdesc cocci_id@p ;
...
position p;
@@
 struct compat_console_font_op * cocci_id@p ;
...
@@
 struct compat_consolefontdesc {  unsigned short charcount ;  unsigned short charheight ;  compat_caddr_t chardata ; } cocci_id@p ;
...
position p;
@@
 struct compat_unimapdesc cocci_id@p ;
...
typedef compat_caddr_t;
@@
 struct compat_unimapdesc {  unsigned short entry_ct ;  compat_caddr_t entries ; } cocci_id@p ;
...
position p;
@@
 struct vc_data * cocci_id@p [ MAX_NR_CONSOLES ] ;
...
position p;
@@
 struct consolefontdesc cocci_id@p ;
