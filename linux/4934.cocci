...
position p;
@@
 struct roce_hem_item * cocci_id@p ;
...
position p;
@@
 struct roce_hem_item * cocci_id@p [ HNS_ROCE_MAX_BT_LEVEL ] ;
...
position p;
@@
 struct hns_roce_hem_list * cocci_id@p ;
...
position p;
@@
 const struct hns_roce_buf_region * cocci_id@p ;
...
position p;
@@
 struct hns_roce_hem_chunk * cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ HNS_ROCE_MAX_BT_REGION ] ;
...
position p;
@@
 struct list_head cocci_id@p [ HNS_ROCE_MAX_BT_LEVEL ] ;
...
typedef dma_addr_t;
@@
 struct roce_hem_item {  struct list_head list ;  struct list_head sibling ;  void * addr ;  dma_addr_t dma_addr ;  size_t count ;  int start ;  int end ; } cocci_id@p ;
