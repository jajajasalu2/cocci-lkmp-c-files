...
position p;
@@
 struct rmnet_map_header cocci_id@p ;
...
position p;
@@
 struct rmnet_map_ul_csum_header * cocci_id@p ;
...
position p;
@@
 struct rmnet_map_dl_csum_trailer * cocci_id@p ;
