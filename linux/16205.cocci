...
position p;
@@
 struct kpc_core_device_platdata * cocci_id@p ;
...
typedef u32;
@@
 union kp_spi_status {  struct __packed spi_status_bitfield {  unsigned int rx : 1 ;  unsigned int tx : 1 ;  unsigned int eo : 1 ;  unsigned int : 1 ;  unsigned int txffe : 1 ;  unsigned int txfff : 1 ;  unsigned int rxffe : 1 ;  unsigned int rxfff : 1 ;  unsigned int : 24 ; } bitfield ;  u32 reg ; } cocci_id@p ;
...
position p;
@@
 union kp_spi_config cocci_id@p ;
...
typedef u32;
@@
 union kp_spi_ffctrl {  struct __packed spi_ffctrl_bitfield {  unsigned int ffstart : 1 ;  unsigned int : 31 ; } bitfield ;  u32 reg ; } cocci_id@p ;
...
typedef u64;
@@
 struct kp_spi {  struct spi_master * master ;  u64 __iomem * base ;  struct device * dev ; } cocci_id@p ;
...
typedef u32;
@@
 union kp_spi_config {  struct __packed spi_config_bitfield {  unsigned int pha : 1 ;  unsigned int pol : 1 ;  unsigned int epol : 1 ;  unsigned int dpe : 1 ;  unsigned int wl : 5 ;  unsigned int : 3 ;  unsigned int trm : 2 ;  unsigned int cs : 4 ;  unsigned int wcnt : 7 ;  unsigned int ffen : 1 ;  unsigned int spi_en : 1 ;  unsigned int : 5 ; } bitfield ;  u32 reg ; } cocci_id@p ;
...
position p;
@@
 struct kp_spi_controller_state * cocci_id@p ;
...
typedef s64;
@@
 struct kp_spi_controller_state {  void __iomem * base ;  s64 conf_cache ; } cocci_id@p ;
