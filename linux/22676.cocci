...
position p;
@@
 struct {  int busy ;  char buf [ STAT_BUFF_LEN ] ;  int len , ptr ; } cocci_id@p ;
...
position p;
@@
 struct sound_settings cocci_id@p ;
...
position p;
@@
 struct {  int busy ;  int modify_counter ; } cocci_id@p ;
