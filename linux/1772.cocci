...
position p;
@@
 enum { ADF4371_CH_RF8 , ADF4371_CH_RFAUX8 , ADF4371_CH_RF16 , ADF4371_CH_RF32 , } cocci_id@p ;
...
position p;
@@
 struct adf4371_chip_info {  unsigned int num_channels ;  const struct iio_chan_spec * channels ; } cocci_id@p ;
...
position p;
@@
 struct adf4371_state * cocci_id@p ;
...
position p;
@@
 const struct adf4371_chip_info cocci_id@p [ ] ;
...
position p;
@@
 enum adf4371_variant { ADF4371 , ADF4372 , } cocci_id@p ;
...
position p;
@@
 const struct adf4371_pwrdown cocci_id@p [ 4 ] ;
...
position p;
@@
 struct adf4371_pwrdown {  unsigned int reg ;  unsigned int bit ; } cocci_id@p ;
...
position p;
@@
 enum { ADF4371_FREQ , ADF4371_POWER_DOWN , ADF4371_CHANNEL_NAME , } cocci_id@p ;
...
typedef u8;
@@
 struct adf4371_state {  struct spi_device * spi ;  struct regmap * regmap ;  struct clk * clkin ;  struct mutex lock ;  const struct adf4371_chip_info * chip_info ;  unsigned long clkin_freq ;  unsigned long fpfd ;  unsigned int integer ;  unsigned int fract1 ;  unsigned int fract2 ;  unsigned int mod2 ;  unsigned int rf_div_sel ;  unsigned int ref_div_factor ;  u8 buf [ 10 ] ____cacheline_aligned ; } cocci_id@p ;
