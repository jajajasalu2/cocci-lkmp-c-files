...
position p;
@@
 struct ti_sci_msg_rm_udmap_flow_cfg_req * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_reboot * cocci_id@p ;
...
position p;
@@
 struct ti_sci_xfers_info * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_psil_pair * cocci_id@p ;
...
position p;
@@
 const struct ti_sci_msg_rm_udmap_flow_cfg * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_rm_udmap_rx_ch_cfg_req * cocci_id@p ;
...
position p;
@@
 struct ti_sci_rm_psil_ops * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_get_device_state * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_hdr cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_set_ctrl * cocci_id@p ;
...
position p;
@@
 struct ti_sci_handle * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_resp_get_clock_state * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_set_clock_parent * cocci_id@p ;
...
position p;
@@
 const struct ti_sci_handle * * cocci_id@p ;
...
typedef u8;
@@
 struct ti_sci_xfer {  struct ti_msgmgr_message tx_message ;  u8 rx_len ;  u8 * xfer_buf ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_resp_get_clock_num_parents * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_set_clock_freq * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_resp_version * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_rm_udmap_tx_ch_cfg_req * cocci_id@p ;
...
position p;
@@
 struct ti_sci_clk_ops * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_set_clock_state * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_get_clock_parent * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_rm_ring_get_cfg_req * cocci_id@p ;
...
position p;
@@
 const struct ti_sci_desc cocci_id@p ;
...
position p;
@@
 struct ti_sci_core_ops * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_proc_handover * cocci_id@p ;
...
typedef u32,u16;
@@
 struct ti_sci_rm_type_map {  u32 dev_id ;  u16 type ; } cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_set_config * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_manage_irq * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_get_clock_num_parents * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_get_resource_range * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_rm_ring_get_cfg_resp * cocci_id@p ;
...
position p;
@@
 struct ti_sci_resource * cocci_id@p ;
...
position p;
@@
 struct ti_sci_rm_type_map cocci_id@p [ ] ;
...
position p;
@@
 struct ti_sci_rm_core_ops * cocci_id@p ;
...
position p;
@@
 const struct ti_sci_msg_rm_udmap_rx_ch_cfg * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_set_device_state * cocci_id@p ;
...
position p;
@@
 struct ti_sci_rm_ringacc_ops * cocci_id@p ;
...
position p;
@@
 struct ti_sci_proc_ops * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_get_status * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_resp_get_clock_freq * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_resp_get_clock_parent * cocci_id@p ;
...
position p;
@@
 struct ti_sci_version_info * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_psil_unpair * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_resp_get_resource_range * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_proc_release * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_proc_request * cocci_id@p ;
...
position p;
@@
 const struct ti_sci_msg_rm_udmap_tx_ch_cfg * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct ti_sci_xfers_info {  struct semaphore sem_xfer_count ;  struct ti_sci_xfer * xfer_block ;  unsigned long * xfer_alloc_table ;  spinlock_t xfer_lock ; } cocci_id@p ;
...
position p;
@@
 struct ti_sci_rm_udmap_ops * cocci_id@p ;
...
position p;
@@
 struct ti_msgmgr_message * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_set_device_resets * cocci_id@p ;
...
typedef u8;
@@
 struct ti_sci_desc {  u8 default_host_id ;  int max_rx_timeout_ms ;  int max_msgs ;  int max_msg_size ;  struct ti_sci_rm_type_map * rm_type_map ; } cocci_id@p ;
...
position p;
@@
 struct ti_sci_rm_irq_ops * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_get_clock_state * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_query_clock_freq * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_req_get_clock_freq * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_resp_get_status * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_rm_ring_cfg_req * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_resp_query_clock_freq * cocci_id@p ;
...
position p;
@@
 struct ti_sci_msg_resp_get_device_state * cocci_id@p ;
...
position p;
@@
 struct ti_sci_dev_ops * cocci_id@p ;
