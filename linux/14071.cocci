...
position p;
@@
 const struct vimc_sca_device * const cocci_id@p ;
...
position p;
@@
 struct vimc_sca_device cocci_id@p ;
...
typedef u8;
@@
 struct vimc_sca_device {  struct vimc_ent_device ved ;  struct v4l2_subdev sd ;  struct v4l2_mbus_framefmt sink_fmt ;  u8 * src_frame ;  unsigned int src_line_size ;  unsigned int bpp ;  struct media_pad pads [ 2 ] ; } cocci_id@p ;
