...
position p;
@@
 struct falcon_fw_os_header_v1 * cocci_id@p ;
...
position p;
@@
 enum falcon_memory { FALCON_MEMORY_IMEM , FALCON_MEMORY_DATA , } cocci_id@p ;
...
position p;
@@
 struct falcon_fw_bin_header_v1 * cocci_id@p ;
