...
position p;
@@
 struct ipu_dc_priv {  void __iomem * dc_reg ;  void __iomem * dc_tmpl_reg ;  struct ipu_soc * ipu ;  struct device * dev ;  struct ipu_dc channels [ IPU_DC_NUM_CHANNELS ] ;  struct mutex mutex ;  struct completion comp ;  int use_count ; } cocci_id@p ;
...
typedef bool;
@@
 struct ipu_dc {  unsigned int di ;  void __iomem * base ;  struct ipu_dc_priv * priv ;  int chno ;  bool in_use ; } cocci_id@p ;
...
position p;
@@
 enum ipu_dc_map { IPU_DC_MAP_RGB24 , IPU_DC_MAP_RGB565 , IPU_DC_MAP_GBR24 , IPU_DC_MAP_BGR666 , IPU_DC_MAP_LVDS666 , IPU_DC_MAP_BGR24 , } cocci_id@p ;
