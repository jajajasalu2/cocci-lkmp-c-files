...
position p;
@@
 struct ext4_extent_idx * cocci_id@p ;
...
typedef handle_t;
@@
 int cocci_id@p ( handle_t * handle , struct inode * inode , struct ext4_ext_path * * ppath , struct ext4_map_blocks * map , int split_flag , int flags ) ;
...
position p;
@@
 struct ext4_extent_header * cocci_id@p ;
...
position p;
@@
 enum SHIFT_DIRECTION cocci_id@p ;
...
position p;
@@
 struct ext4_extent_tail * cocci_id@p ;
...
position p;
@@
 struct partial_cluster * cocci_id@p ;
