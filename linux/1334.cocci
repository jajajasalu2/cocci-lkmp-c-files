...
@@
 struct twl6030_usb {  struct phy_companion comparator ;  struct device * dev ;  spinlock_t lock ;  struct regulator * usb3v3 ;  struct delayed_work get_status_work ;  struct work_struct set_vbus_work ;  int irq1 ;  int irq2 ;  enum musb_vbus_id_status linkstat ;  u8 asleep ;  bool vbus_enable ; } cocci_id@p ;
