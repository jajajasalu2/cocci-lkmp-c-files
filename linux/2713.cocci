...
typedef u16;
@@
 struct fsi_i2c_port {  struct list_head list ;  struct i2c_adapter adapter ;  struct fsi_i2c_master * master ;  u16 port ;  u16 xfrd ; } cocci_id@p ;
...
position p;
@@
 struct fsi_i2c_master * cocci_id@p ;
...
position p;
@@
 struct fsi_i2c_port * cocci_id@p ;
...
typedef u8;
@@
 struct fsi_i2c_master {  struct fsi_device * fsi ;  u8 fifo_size ;  struct list_head ports ;  struct mutex lock ; } cocci_id@p ;
