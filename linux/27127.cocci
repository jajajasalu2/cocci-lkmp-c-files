...
position p;
@@
 struct ubifs_mst_node * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef loff_t,ino_t;
@@
 struct size_entry {  struct rb_node rb ;  ino_t inum ;  loff_t i_size ;  loff_t d_size ;  int exists ;  struct inode * inode ; } cocci_id@p ;
...
position p;
@@
 struct ubifs_cs_node * cocci_id@p ;
