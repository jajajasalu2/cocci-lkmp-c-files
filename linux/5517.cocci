...
typedef spinlock_t;
@@
 struct sh_rtc {  void __iomem * regbase ;  unsigned long regsize ;  struct resource * res ;  int alarm_irq ;  int periodic_irq ;  int carry_irq ;  struct clk * clk ;  struct rtc_device * rtc_dev ;  spinlock_t lock ;  unsigned long capabilities ;  unsigned short periodic_freq ; } cocci_id@p ;
...
position p;
@@
 struct sh_rtc_platform_info * cocci_id@p ;
