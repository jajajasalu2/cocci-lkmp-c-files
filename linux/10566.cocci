...
position p;
@@
 int ( * cocci_id@p ) ( struct i915_active * ref ) ;
...
position p;
@@
 struct i915_global_active cocci_id@p ;
...
position p;
@@
 const struct i915_active_fence * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct i915_active * ref ) ;
...
typedef u64;
@@
 struct active_node {  struct i915_active_fence base ;  struct i915_active * ref ;  struct rb_node node ;  u64 timeline ; } cocci_id@p ;
...
position p;
@@
 struct i915_global_active {  struct i915_global base ;  struct kmem_cache * slab_cache ; } cocci_id@p ;
...
position p;
@@
 struct i915_active_fence * cocci_id@p ;
