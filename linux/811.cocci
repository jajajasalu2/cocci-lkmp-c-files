...
position p;
@@
 struct pcie_pme_service_data * cocci_id@p ;
...
@@
 struct pcie_pme_service_data {  spinlock_t lock ;  struct pcie_device * srv ;  struct work_struct work ;  bool noirq ; } cocci_id@p ;
