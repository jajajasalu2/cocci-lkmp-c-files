...
position p;
@@
 struct iwl39_stats_general cocci_id@p ;
...
position p;
@@
 struct iwl39_stats_rx_phy cocci_id@p ;
...
position p;
@@
 struct iwl39_stats_rx_non_phy * cocci_id@p ;
...
position p;
@@
 struct iwl39_stats_tx * cocci_id@p ;
...
position p;
@@
 struct iwl39_stats_div * cocci_id@p ;
