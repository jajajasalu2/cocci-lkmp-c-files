...
position p;
@@
 struct asc_port {  struct uart_port port ;  struct gpio_desc * rts ;  struct clk * clk ;  struct pinctrl * pinctrl ;  struct pinctrl_state * states [ 2 ] ;  unsigned int hw_flow_control : 1 ;  unsigned int force_m1 : 1 ; } cocci_id@p ;
...
position p;
@@
 struct asc_port cocci_id@p [ ASC_MAX_PORTS ] ;
