...
position p;
@@
 struct cxusb_medion_dev * cocci_id@p ;
...
position p;
@@
 struct usb_device_id cocci_id@p [ NR__cxusb_table_index + 1 ] ;
...
position p;
@@
 struct dib0700_adapter_state {  int ( * set_param_save ) ( struct dvb_frontend * fe ) ;  struct dib7000p_ops dib7000p_ops ; } cocci_id@p ;
...
position p;
@@
 struct cx22702_config cocci_id@p ;
...
position p;
@@
 enum cxusb_open_type cocci_id@p ;
