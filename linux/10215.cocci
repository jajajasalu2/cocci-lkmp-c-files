...
position p;
@@
 struct pcmcia_cfg_mem cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct pcmcia_device * p_dev , void * priv_data ) ;
...
position p;
@@
 struct pcmcia_loop_mem cocci_id@p ;
...
position p;
@@
 struct pcmcia_loop_get * cocci_id@p ;
...
typedef cisdata_t;
@@
 struct pcmcia_loop_get {  size_t len ;  cisdata_t * * buf ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cisparse_t,cistpl_cftable_entry_t;
@@
 struct pcmcia_cfg_mem {  struct pcmcia_device * p_dev ;  int ( * conf_check ) ( struct pcmcia_device * p_dev , void * priv_data ) ;  void * priv_data ;  cisparse_t parse ;  cistpl_cftable_entry_t dflt ; } cocci_id@p ;
