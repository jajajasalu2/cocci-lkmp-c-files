...
typedef u8;
@@
 struct hidled_device {  const struct hidled_config * config ;  struct hid_device * hdev ;  struct hidled_rgb * rgb ;  u8 * buf ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 const struct hidled_config * cocci_id@p ;
...
position p;
@@
 struct hidled_device * cocci_id@p ;
...
position p;
@@
 const struct hidled_led * cocci_id@p ;
...
position p;
@@
 enum hidled_report_type { RAW_REQUEST , OUTPUT_REPORT , } cocci_id@p ;
...
typedef u8;
@@
 struct hidled_rgb {  struct hidled_device * ldev ;  struct hidled_led red ;  struct hidled_led green ;  struct hidled_led blue ;  u8 num ; } cocci_id@p ;
...
position p;
@@
 struct hidled_led {  struct led_classdev cdev ;  struct hidled_rgb * rgb ;  char name [ 32 ] ; } cocci_id@p ;
...
typedef __u8;
@@
 union delcom_packet {  __u8 data [ 8 ] ;  struct {  __u8 major_cmd ;  __u8 minor_cmd ;  __u8 data_lsb ;  __u8 data_msb ; } tx ;  struct {  __u8 cmd ; } rx ;  struct {  __le16 family_code ;  __le16 security_code ;  __u8 fw_version ; } fw ; } cocci_id@p ;
...
position p;
@@
 union delcom_packet cocci_id@p ;
...
position p;
@@
 enum hidled_type { RISO_KAGAKU , DREAM_CHEEKY , THINGM , DELCOM , LUXAFOR , } cocci_id@p ;
