...
position p;
@@
 enum amd_ip_block_type cocci_id@p [ ] ;
...
position p;
@@
 const struct gpu_info_firmware_v1_0 * cocci_id@p ;
...
position p;
@@
 const struct gpu_info_firmware_v1_2 * cocci_id@p ;
...
position p;
@@
 struct amdgpu_ip_block * cocci_id@p ;
...
position p;
@@
 struct amdgpu_gpu_instance * cocci_id@p ;
...
position p;
@@
 const struct gpu_info_firmware_v1_1 * cocci_id@p ;
