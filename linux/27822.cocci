...
position p;
@@
 struct ocfs2_meta_cache_item * cocci_id@p ;
...
typedef sector_t;
@@
 struct ocfs2_meta_cache_item {  struct rb_node c_node ;  sector_t c_block ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_meta_cache_item * cocci_id@p [ OCFS2_CACHE_INFO_MAX_ARRAY ] ;
