...
position p;
@@
 struct pb0100_ctrls {  struct {  struct v4l2_ctrl * autogain ;  struct v4l2_ctrl * gain ;  struct v4l2_ctrl * exposure ;  struct v4l2_ctrl * red ;  struct v4l2_ctrl * blue ;  struct v4l2_ctrl * natural ; } ;  struct v4l2_ctrl * target ; } cocci_id@p ;
...
position p;
@@
 struct pb0100_ctrls * cocci_id@p ;
