...
position p;
@@
 float64 cocci_id@p ( float64 a , float64 b , flag zSign ) ;
...
position p;
@@
 float32 cocci_id@p ( float32 a , float32 b , flag zSign ) ;
...
position p;
@@
 float32 cocci_id@p ( float32 a , float32 b ) ;
...
position p;
@@
 void cocci_id@p ( bits64 a , int16 count , bits64 * zPtr ) ;
...
position p;
@@
 float64 cocci_id@p ( flag zSign , int16 zExp , bits64 zSig ) ;
...
position p;
@@
 float64 cocci_id@p ( float64 a , float64 b ) ;
...
position p;
@@
 bits64 cocci_id@p ( bits64 a0 , bits64 a1 , bits64 b ) ;
...
position p;
@@
 void cocci_id@p ( bits64 a0 , bits64 a1 , bits64 b0 , bits64 b1 , bits64 * z0Ptr , bits64 * z1Ptr ) ;
...
position p;
@@
 void cocci_id@p ( bits64 aSig , int16 * zExpPtr , bits64 * zSigPtr ) ;
...
position p;
@@
 void cocci_id@p ( bits32 a , int16 count , bits32 * zPtr ) ;
...
position p;
@@
 void cocci_id@p ( bits32 aSig , int16 * zExpPtr , bits32 * zSigPtr ) ;
...
position p;
@@
 signed long long int cocci_id@p ;
...
position p;
@@
 float32 cocci_id@p ( flag zSign , int16 zExp , bits32 zSig ) ;
...
position p;
@@
 void cocci_id@p ( bits64 a , bits64 b , bits64 * z0Ptr , bits64 * z1Ptr ) ;
...
position p;
@@
 void cocci_id@p ( unsigned int flags ) ;
