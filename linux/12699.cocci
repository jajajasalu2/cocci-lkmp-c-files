...
position p;
@@
 struct mbus_dram_target_info cocci_id@p ;
...
position p;
@@
 const struct mvebu_mbus_soc_data cocci_id@p ;
...
position p;
@@
 struct mbus_dram_window * cocci_id@p ;
...
position p;
@@
 struct mvebu_mbus_state cocci_id@p ;
...
typedef u32;
@@
 struct mvebu_mbus_win_data {  u32 ctrl ;  u32 base ;  u32 remap_lo ;  u32 remap_hi ; } cocci_id@p ;
