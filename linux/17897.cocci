...
position p;
@@
 mdesc_node_info_get_f cocci_id@p ;
...
typedef refcount_t;
@@
 struct mdesc_handle {  struct list_head list ;  struct mdesc_mem_ops * mops ;  void * self_base ;  refcount_t refcnt ;  unsigned int handle_size ;  struct mdesc_hdr mdesc ; } cocci_id@p ;
...
position p;
@@
 struct mdesc_mem_ops {  struct mdesc_handle * ( * alloc ) ( unsigned int mdesc_size ) ;  void ( * free ) ( struct mdesc_handle * handle ) ; } cocci_id@p ;
...
typedef u64;
@@
 void ( * cocci_id@p ) ( struct mdesc_handle * , u64 , int ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( union md_node_info * ) ;
...
position p;
@@
 struct mdesc_mem_ops * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( union md_node_info * a_node_info , union md_node_info * b_node_info ) ;
...
position p;
@@
 void cocci_id@p ( union md_node_info * node_info ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( union md_node_info * , union md_node_info * ) ;
...
position p;
@@
 mdesc_node_info_rel_f * cocci_id@p ;
...
typedef u64;
@@
 void * ( * cocci_id@p ) ( struct mdesc_handle * , u64 , int , void * ) ;
...
typedef u64;
@@
 int cocci_id@p ( struct mdesc_handle * md , u64 node , union md_node_info * node_info ) ;
...
typedef u64;
@@
 void ( * cocci_id@p ) ( struct mdesc_handle * , u64 , const char * node_name ) ;
...
position p;
@@
 struct md_node_ops {  char * name ;  mdesc_node_info_get_f get_info ;  mdesc_node_info_rel_f rel_info ;  mdesc_node_match_f node_match ; } cocci_id@p ;
...
position p;
@@
 struct mdesc_notifier_client * cocci_id@p ;
...
position p;
@@
 struct trap_per_cpu * cocci_id@p ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct mdesc_handle * , u64 , union md_node_info * ) ;
