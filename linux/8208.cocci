...
position p;
@@
 struct temac_option * cocci_id@p ;
...
position p;
@@
 struct ll_temac_platform_data * cocci_id@p ;
...
typedef u32;
@@
 struct temac_option {  int flg ;  u32 opt ;  u32 reg ;  u32 m_or ;  u32 m_and ; } cocci_id@p [ ] ;
