...
typedef spinlock_t;
@@
 struct cbus_host {  spinlock_t lock ;  struct device * dev ;  struct gpio_desc * clk ;  struct gpio_desc * dat ;  struct gpio_desc * sel ; } cocci_id@p ;
