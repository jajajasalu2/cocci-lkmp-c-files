...
position p;
@@
 struct vmci_event_msg * cocci_id@p ;
...
typedef u32;
@@
 struct vmci_subscription {  u32 id ;  u32 event ;  vmci_event_cb callback ;  void * callback_data ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ VMCI_EVENT_MAX ] ;
...
position p;
@@
 struct vmci_event_data_max cocci_id@p ;
...
position p;
@@
 struct vmci_subscription * cocci_id@p ;
