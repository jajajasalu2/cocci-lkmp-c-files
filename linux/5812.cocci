...
position p;
@@
 const struct ti_iodelay_reg_data * cocci_id@p ;
...
typedef u32,u16;
@@
 struct ti_iodelay_reg_values {  u16 coarse_ref_count ;  u16 coarse_delay_count ;  u16 fine_ref_count ;  u16 fine_delay_count ;  u16 ref_clk_period ;  u32 cdpe ;  u32 fdpe ; } cocci_id@p ;
...
typedef u16;
@@
 struct ti_iodelay_cfg {  u16 offset ;  u16 a_delay ;  u16 g_delay ; } cocci_id@p ;
...
position p;
@@
 struct ti_iodelay_reg_values * cocci_id@p ;
...
position p;
@@
 struct ti_iodelay_device * cocci_id@p ;
...
position p;
@@
 struct ti_iodelay_reg_data cocci_id@p ;
...
position p;
@@
 struct ti_iodelay_cfg * cocci_id@p ;
...
position p;
@@
 struct ti_iodelay_pingroup {  struct ti_iodelay_cfg * cfg ;  int ncfg ;  unsigned long config ; } cocci_id@p ;
...
position p;
@@
 struct ti_iodelay_pingroup * cocci_id@p ;
...
position p;
@@
 struct ti_iodelay_device {  struct device * dev ;  unsigned long phys_base ;  void __iomem * reg_base ;  struct regmap * regmap ;  struct pinctrl_dev * pctl ;  struct pinctrl_desc desc ;  struct pinctrl_pin_desc * pa ;  const struct ti_iodelay_reg_data * reg_data ;  struct ti_iodelay_reg_values reg_init_conf_values ; } cocci_id@p ;
