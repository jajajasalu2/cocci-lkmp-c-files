...
position p;
@@
 const struct {  unsigned offs : BITS_PER_LONG / 2 ;  unsigned width : BITS_PER_LONG / 2 ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 const u32 * cocci_id@p ( const u32 * fde , const struct unwind_table * ) ;
...
position p;
@@
 struct eh_frame_hdr_table_entry * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 union {  const u8 * p8 ;  const u16 * p16 ;  const u32 * p32 ; } cocci_id@p ;
...
position p;
@@
 struct unwind_frame_info * cocci_id@p ;
...
position p;
@@
 const struct unwind_table * cocci_id@p ;
...
position p;
@@
 struct unlink_table_info {  struct unwind_table * table ;  int init_only ; } cocci_id@p ;
...
position p;
@@
 typeof ( header -> fde_count ) cocci_id@p ;
...
position p;
@@
 typeof ( * header -> table ) cocci_id@p ;
...
typedef u32;
@@
 signed cocci_id@p ( const u32 * cie ) ;
...
position p;
@@
 struct unwind_state cocci_id@p ;
...
position p;
@@
 struct unwind_table * cocci_id@p ;
...
typedef u32;
@@
 const u32 * cocci_id@p ( const u32 * fde ) ;
...
typedef u8;
@@
 unsigned long cocci_id@p ( const u8 * * pLoc , const void * end , signed ptrType ) ;
...
symbol cocci_id;
position p;
typedef u8,u32,u16,s16,s32;
@@
 union {  const u8 * p8 ;  const u16 * p16u ;  const s16 * p16s ;  const u32 * p32u ;  const s32 * p32s ;  const unsigned long * pul ; } cocci_id@p ;
...
position p;
@@
 const struct eh_frame_hdr_table_entry * cocci_id@p ;
...
position p;
@@
 struct unlink_table_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct unwind_table * table , void * ( * alloc ) ( unsigned long ) ) ;
