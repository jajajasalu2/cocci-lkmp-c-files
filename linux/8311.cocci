...
position p;
@@
 struct enic_stat {  char name [ ETH_GSTRING_LEN ] ;  unsigned int index ; } cocci_id@p ;
...
position p;
@@
 struct vnic_tx_stats cocci_id@p ;
...
position p;
@@
 struct enic_rfs_fltr_node * cocci_id@p ;
...
position p;
@@
 const struct enic_stat cocci_id@p [ ] ;
...
position p;
@@
 struct vnic_rx_stats cocci_id@p ;
...
position p;
@@
 struct vnic_enet_config * cocci_id@p ;
...
position p;
@@
 struct vnic_gen_stats cocci_id@p ;
