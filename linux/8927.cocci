...
position p;
@@
 struct hclge_pfc_en_cmd * cocci_id@p ;
...
position p;
@@
 enum hclge_shaper_level { HCLGE_SHAPER_LVL_PRI = 0 , HCLGE_SHAPER_LVL_PG = 1 , HCLGE_SHAPER_LVL_PORT = 2 , HCLGE_SHAPER_LVL_QSET = 3 , HCLGE_SHAPER_LVL_CNT = 4 , HCLGE_SHAPER_LVL_VF = 0 , HCLGE_SHAPER_LVL_PF = 1 , } cocci_id@p ;
...
position p;
@@
 struct hclge_pg_info * cocci_id@p ;
...
position p;
@@
 struct hclge_desc cocci_id@p [ HCLGE_TM_PFC_PKT_GET_CMD_NUM ] ;
...
position p;
@@
 struct hclge_pfc_stats_cmd * cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ HCLGE_SHAPER_LVL_CNT ] ;
...
position p;
@@
 enum hclge_shap_bucket cocci_id@p ;
