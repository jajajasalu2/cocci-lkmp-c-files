...
position p;
@@
 enum mtu3_dr_force_mode cocci_id@p ;
...
position p;
@@
 struct otg_switch_mtk * cocci_id@p ;
...
position p;
@@
 enum mtu3_vbus_id_state cocci_id@p ;
...
position p;
@@
 enum mtu3_vbus_id_state { MTU3_ID_FLOAT = 1 , MTU3_ID_GROUND , MTU3_VBUS_OFF , MTU3_VBUS_VALID , } cocci_id@p ;
