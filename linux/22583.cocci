...
position p;
@@
 const struct hda_hint * cocci_id@p ;
...
position p;
@@
 enum { LINE_MODE_NONE , LINE_MODE_CODEC , LINE_MODE_MODEL , LINE_MODE_PINCFG , LINE_MODE_VERB , LINE_MODE_HINT , LINE_MODE_VENDOR_ID , LINE_MODE_SUBSYSTEM_ID , LINE_MODE_REVISION_ID , LINE_MODE_CHIP_NAME , NUM_LINE_MODES , } cocci_id@p ;
...
position p;
@@
 struct hda_patch_item cocci_id@p [ NUM_LINE_MODES ] ;
...
position p;
@@
 struct hda_hint {  const char * key ;  const char * val ; } cocci_id@p ;
...
position p;
@@
 struct hda_patch_item {  const char * tag ;  const char * alias ;  void ( * parser ) ( char * buf , struct hda_bus * bus , struct hda_codec * * retc ) ; } cocci_id@p ;
