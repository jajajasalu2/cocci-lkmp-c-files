...
typedef bool;
@@
 struct adapter_info {  struct i2c_algo_pch_data pch_data [ PCH_I2C_MAX_DEV ] ;  bool pch_i2c_suspended ;  int ch_num ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct i2c_algo_pch_data {  struct i2c_adapter pch_adapter ;  struct adapter_info * p_adapter_info ;  void __iomem * pch_base_address ;  int pch_buff_mode_en ;  u32 pch_event_flag ;  bool pch_i2c_xfer_in_progress ; } cocci_id@p ;
...
position p;
@@
 struct adapter_info * cocci_id@p ;
...
position p;
@@
 struct i2c_algo_pch_data * cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * pData ) ;
