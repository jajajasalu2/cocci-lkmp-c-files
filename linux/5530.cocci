...
position p;
@@
 struct rx8581 {  struct regmap * regmap ;  struct rtc_device * rtc ; } cocci_id@p ;
...
position p;
@@
 struct rx85x1_config {  struct regmap_config regmap ;  unsigned int num_nvram ; } cocci_id@p ;
...
position p;
@@
 const struct rx85x1_config * cocci_id@p ;
