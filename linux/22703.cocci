...
position p;
@@
 struct fm_instrument * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * p , int note , int vel , struct snd_midi_channel * chan ) ;
...
position p;
@@
 int cocci_id@p [ MAX_OPL3_VOICES ] ;
...
position p;
@@
 enum { FREE = 0 , CHEAP , EXPENSIVE , END , } cocci_id@p ;
...
position p;
@@
 struct snd_opl3_voice * cocci_id@p ;
