...
typedef bool;
@@
 struct ipu_ic {  enum ipu_ic_task task ;  const struct ic_task_regoffs * reg ;  const struct ic_task_bitfields * bit ;  struct ipu_ic_colorspace in_cs ;  struct ipu_ic_colorspace g_in_cs ;  struct ipu_ic_colorspace out_cs ;  bool graphics ;  bool rotation ;  bool in_use ;  struct ipu_ic_priv * priv ; } cocci_id@p ;
...
position p;
@@
 const struct ic_task_regoffs cocci_id@p [ IC_NUM_TASKS ] ;
...
typedef spinlock_t;
@@
 struct ipu_ic_priv {  void __iomem * base ;  void __iomem * tpmem_base ;  spinlock_t lock ;  struct ipu_soc * ipu ;  int use_count ;  int irt_use_count ;  struct ipu_ic task [ IC_NUM_TASKS ] ; } cocci_id@p ;
...
position p;
@@
 const struct ipu_ic_colorspace * cocci_id@p ;
...
typedef u32;
@@
 struct ic_task_bitfields {  u32 ic_conf_en ;  u32 ic_conf_rot_en ;  u32 ic_conf_cmb_en ;  u32 ic_conf_csc1_en ;  u32 ic_conf_csc2_en ;  u32 ic_cmb_galpha_bit ; } cocci_id@p ;
...
position p;
@@
 const struct ipu_ic_csc * cocci_id@p ;
...
position p;
@@
 const struct ic_task_bitfields cocci_id@p [ IC_NUM_TASKS ] ;
...
typedef u32;
@@
 struct ic_task_regoffs {  u32 rsc ;  u32 tpmem_csc [ 2 ] ; } cocci_id@p ;
