...
typedef u8,u32;
@@
 struct stmpe_adc {  struct stmpe * stmpe ;  struct clk * clk ;  struct device * dev ;  struct mutex lock ;  struct iio_chan_spec stmpe_adc_iio_channels [ STMPE_ADC_LAST_NR + 2 ] ;  struct completion completion ;  u8 channel ;  u32 value ; } cocci_id@p ;
