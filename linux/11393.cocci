...
typedef u32,u16;
@@
 struct rpc_channel {  u16 channel_id ;  u32 cookie_high ;  u32 cookie_low ; } cocci_id@p ;
...
position p;
@@
 enum rpc_msg_type { MSG_TYPE_OPEN , MSG_TYPE_SENDSIZE , MSG_TYPE_SENDPAYLOAD , MSG_TYPE_RECVSIZE , MSG_TYPE_RECVPAYLOAD , MSG_TYPE_RECVSTATUS , MSG_TYPE_CLOSE , } cocci_id@p ;
