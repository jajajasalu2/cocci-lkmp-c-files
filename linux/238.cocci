...
position p;
@@
 int cocci_id@p ( struct ftrace_hash * hash , char * buffer ) ;
...
symbol cocci_id;
position p;
typedef ftrace_func_t;
@@
 ftrace_func_t cocci_id@p ;
...
position p;
@@
 struct ftrace_graph_data {  struct ftrace_hash * hash ;  struct ftrace_func_entry * entry ;  int idx ;  enum graph_filter_type type ;  struct ftrace_hash * new_hash ;  const struct seq_operations * seq_ops ;  struct trace_parser parser ; } cocci_id@p ;
...
position p;
@@
 struct ftrace_glob {  char * search ;  unsigned len ;  int type ; } cocci_id@p ;
...
position p;
@@
 struct ftrace_init_func {  struct list_head list ;  unsigned long ip ; } cocci_id@p ;
...
position p;
@@
 struct ftrace_func_probe * cocci_id@p ;
...
position p;
@@
 enum ftrace_bug_type cocci_id@p ;
...
position p;
@@
 struct ftrace_mod_func {  struct list_head list ;  char * name ;  unsigned long ip ;  unsigned int size ; } cocci_id@p ;
...
position p;
@@
 struct ftrace_ops * cocci_id@p ( struct dyn_ftrace * rec ) ;
...
position p;
@@
 struct ftrace_mod_map {  struct rcu_head rcu ;  struct list_head list ;  struct module * mod ;  unsigned long start_addr ;  unsigned long end_addr ;  struct list_head funcs ;  unsigned int num_funcs ; } cocci_id@p ;
...
position p;
@@
 struct ftrace_profile_stat * cocci_id@p ;
...
position p;
@@
 struct ftrace_ops * cocci_id@p ( struct dyn_ftrace * rec , struct ftrace_ops * ops ) ;
...
typedef atomic_t;
@@
 struct ftrace_profile_stat {  atomic_t disabled ;  struct hlist_head * hash ;  struct ftrace_profile_page * pages ;  struct ftrace_profile_page * start ;  struct tracer_stat stat ; } cocci_id@p ;
...
position p;
@@
 struct ftrace_func_command cocci_id@p ;
...
position p;
@@
 struct ftrace_direct_func * cocci_id@p ;
...
position p;
@@
 struct ftrace_init_func * cocci_id@p ;
...
position p;
@@
 const struct ftrace_hash cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ftrace_ops * ops , int filter_hash ) ;
...
position p;
@@
 struct ftrace_func_entry * cocci_id@p ;
...
position p;
@@
 struct ftrace_graph_ent * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ftrace_ops * ops , unsigned char * buf , int len , int reset , int enable ) ;
...
position p;
@@
 struct ftrace_graph_data * cocci_id@p ;
...
position p;
@@
 const struct dyn_ftrace * cocci_id@p ;
...
position p;
@@
 struct ftrace_probe_ops * cocci_id@p ;
...
position p;
@@
 struct ftrace_rec_iter cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long ip , unsigned long parent_ip , struct ftrace_ops * op , struct pt_regs * regs ) ;
...
position p;
@@
 struct ftrace_profile cocci_id@p ;
...
position p;
@@
 struct ftrace_mod_func * cocci_id@p ;
...
position p;
@@
 struct ftrace_page {  struct ftrace_page * next ;  struct dyn_ftrace * records ;  int index ;  int size ; } cocci_id@p ;
...
position p;
@@
 struct ftrace_mod_map cocci_id@p ;
...
position p;
@@
 struct ftrace_profile_page * cocci_id@p ;
...
position p;
@@
 struct ftrace_ops_hash cocci_id@p ;
...
position p;
@@
 struct ftrace_func_probe {  struct ftrace_probe_ops * probe_ops ;  struct ftrace_ops ops ;  struct trace_array * tr ;  struct list_head list ;  void * data ;  int ref ; } cocci_id@p ;
...
position p;
@@
 const struct ftrace_profile * cocci_id@p ;
...
position p;
@@
 struct ftrace_func_mapper * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long ip , unsigned long parent_ip ) ;
...
position p;
@@
 char cocci_id@p [ MAX_PARAM_PREFIX_LEN + sizeof ( this_mod ) + 2 ] ;
...
position p;
@@
 struct trace_pid_list * cocci_id@p ;
...
position p;
@@
 enum { FTRACE_MODIFY_ENABLE_FL = ( 1 << 0 ) , FTRACE_MODIFY_MAY_SLEEP_FL = ( 1 << 1 ) , } cocci_id@p ;
...
position p;
@@
 struct ftrace_direct_func {  struct list_head next ;  unsigned long addr ;  int count ; } cocci_id@p ;
...
position p;
@@
 struct ftrace_mod_load * cocci_id@p ;
...
position p;
@@
 struct trace_parser * cocci_id@p ;
...
position p;
@@
 struct ftrace_profile_page {  struct ftrace_profile_page * next ;  unsigned long index ;  struct ftrace_profile records [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct hlist_head cocci_id@p [ 1 ] ;
...
position p;
@@
 struct ftrace_ret_stack * cocci_id@p ;
...
position p;
@@
 struct ftrace_rec_iter {  struct ftrace_page * pg ;  int index ; } cocci_id@p ;
...
position p;
@@
 struct ftrace_iterator * cocci_id@p ;
...
position p;
@@
 struct ftrace_graph_ret * cocci_id@p ;
...
position p;
@@
 struct ftrace_func_map * cocci_id@p ;
...
position p;
@@
 struct ftrace_func_mapper {  struct ftrace_hash hash ; } cocci_id@p ;
...
position p;
@@
 enum graph_filter_type { GRAPH_FILTER_NOTRACE = 0 , GRAPH_FILTER_FUNCTION , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ftrace_ops * ops ) ;
...
position p;
@@
 struct ftrace_func_map {  struct ftrace_func_entry entry ;  void * data ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ftrace_ops * ops , struct ftrace_hash * new_hash ) ;
