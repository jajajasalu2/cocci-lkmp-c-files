...
position p;
@@
 struct imx_pm_domain * cocci_id@p ;
...
position p;
@@
 struct imx_pm_domain {  struct generic_pm_domain base ;  struct regmap * regmap ;  struct regulator * supply ;  struct clk * clk [ GPC_CLK_MAX ] ;  int num_clks ;  unsigned int reg_offs ;  signed char cntr_pdn_bit ;  unsigned int ipg_rate_mhz ; } cocci_id@p ;
...
typedef bool;
@@
 struct imx_gpc_dt_data {  int num_domains ;  bool err009619_present ;  bool err006287_present ; } cocci_id@p ;
...
position p;
@@
 const struct imx_gpc_dt_data * cocci_id@p ;
