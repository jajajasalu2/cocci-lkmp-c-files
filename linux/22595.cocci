...
typedef spinlock_t;
@@
 struct snd_als300 {  unsigned long port ;  spinlock_t reg_lock ;  struct snd_card * card ;  struct pci_dev * pci ;  struct snd_pcm * pcm ;  struct snd_pcm_substream * playback_substream ;  struct snd_pcm_substream * capture_substream ;  struct snd_ac97 * ac97 ;  struct snd_opl3 * opl3 ;  struct resource * res_port ;  int irq ;  int chip_type ;  char revision ; } cocci_id@p ;
...
position p;
@@
 struct snd_als300_substream_data * cocci_id@p ;
...
position p;
@@
 struct snd_als300_substream_data {  int period_flipflop ;  int control_register ;  int block_counter_register ; } cocci_id@p ;
...
position p;
@@
 enum { DEVICE_ALS300 , DEVICE_ALS300_PLUS , } cocci_id@p ;
