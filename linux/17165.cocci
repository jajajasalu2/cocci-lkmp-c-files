...
symbol cocci_id;
position p;
typedef u8,pmi_message_t,spinlock_t;
@@
 struct pmi_data {  struct list_head handler ;  spinlock_t handler_spinlock ;  spinlock_t pmi_spinlock ;  struct mutex msg_mutex ;  pmi_message_t msg ;  struct completion * completion ;  struct platform_device * dev ;  int irq ;  u8 __iomem * pmi_reg ;  struct work_struct work ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pmi_message_t;
@@
 pmi_message_t cocci_id@p ;
