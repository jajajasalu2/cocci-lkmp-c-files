...
position p;
@@
 struct mutex cocci_id@p [ MAX_CLUSTERS ] ;
...
position p;
@@
 struct clk * cocci_id@p [ MAX_CLUSTERS ] ;
...
position p;
@@
 struct cpufreq_frequency_table * cocci_id@p [ MAX_CLUSTERS + 1 ] ;
...
position p;
@@
 struct thermal_cooling_device * cocci_id@p [ MAX_CLUSTERS ] ;
...
typedef atomic_t;
@@
 atomic_t cocci_id@p [ MAX_CLUSTERS + 1 ] ;
