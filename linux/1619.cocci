...
position p;
@@
 struct usb_debug_descriptor cocci_id@p ;
...
typedef u32;
@@
 struct ehci_dev {  u32 bus ;  u32 slot ;  u32 func ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ DBGP_MAX_PACKET ] ;
