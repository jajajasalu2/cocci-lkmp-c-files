...
typedef u8;
@@
 u8 cocci_id@p [ RMI_F03_DEVICE_COUNT * RMI_F03_BYTES_PER_DEVICE ] ;
...
typedef u8,bool;
@@
 struct f03_data {  struct rmi_function * fn ;  struct serio * serio ;  bool serio_registered ;  unsigned int overwrite_buttons ;  u8 device_count ;  u8 rx_queue_length ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RMI_F03_QUEUE_LENGTH * RMI_F03_OB_SIZE ] ;
