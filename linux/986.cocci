...
position p;
@@
 struct swap_eb {  struct rb_node rb ;  struct rb_root * root ;  unsigned int flags ;  unsigned int active_count ;  unsigned int erase_count ;  unsigned int pad ; } cocci_id@p ;
...
position p;
@@
 struct mtd_blktrans_ops cocci_id@p ;
...
position p;
@@
 enum { MTDSWAP_SCANNED_CLEAN , MTDSWAP_SCANNED_DIRTY , MTDSWAP_SCANNED_BITFLIP , MTDSWAP_SCANNED_BAD , } cocci_id@p ;
...
position p;
@@
 struct mtd_blktrans_dev cocci_id@p ;
...
position p;
@@
 struct mtdswap_tree * cocci_id@p ;
...
position p;
@@
 struct mtdswap_tree {  struct rb_root root ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 struct mtdswap_oobdata * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MTDSWAP_TREE_CNT ] ;
...
position p;
@@
 int cocci_id@p ( struct mtdswap_dev * d , unsigned int background ) ;
...
position p;
@@
 enum { MTDSWAP_CLEAN , MTDSWAP_USED , MTDSWAP_LOWFRAG , MTDSWAP_HIFRAG , MTDSWAP_DIRTY , MTDSWAP_BITFLIP , MTDSWAP_FAILING , MTDSWAP_TREE_CNT , } cocci_id@p ;
