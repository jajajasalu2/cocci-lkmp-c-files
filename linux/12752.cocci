...
position p;
@@
 struct s390_domain_device * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct s390_domain {  struct iommu_domain domain ;  struct list_head devices ;  unsigned long * dma_table ;  spinlock_t dma_table_lock ;  spinlock_t list_lock ; } cocci_id@p ;
...
position p;
@@
 struct s390_domain_device {  struct list_head list ;  struct zpci_dev * zdev ; } cocci_id@p ;
