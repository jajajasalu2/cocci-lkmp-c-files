...
position p;
@@
 struct mxs_mmc_host cocci_id@p ;
...
@@
 struct mxs_mmc_host {  struct mxs_ssp ssp ;  struct mmc_host * mmc ;  struct mmc_request * mrq ;  struct mmc_command * cmd ;  struct mmc_data * data ;  unsigned char bus_width ;  spinlock_t lock ;  int sdio_irq_en ;  bool broken_cd ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mxs_mmc_host * host , struct mmc_command * cmd ) ;
