...
position p;
@@
 const struct phyerr_fft_report * cocci_id@p ;
...
position p;
@@
 const struct wmi_10_2_stats_event * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_set_wmm_params * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_temperature_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_10_4_pdev_stats * cocci_id@p ;
...
position p;
@@
 struct wmi_peer_sta_kickout_event * cocci_id@p ;
...
position p;
@@
 enum wmi_tdls_state cocci_id@p ;
...
position p;
@@
 const struct wmi_tdls_peer_update_cmd_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_install_key_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_peer_kick_ev_arg * cocci_id@p ;
...
position p;
@@
 const struct wmi_scan_chan_list_arg * cocci_id@p ;
...
position p;
@@
 enum wmi_scan_event_type cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_start_response_event * cocci_id@p ;
...
position p;
@@
 enum wmi_10x_event_id cocci_id@p ;
...
position p;
@@
 struct wmi_svc_rdy_ev_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_resource_config_10_4 cocci_id@p ;
...
position p;
@@
 const struct wmi_peer_assoc_complete_arg * cocci_id@p ;
...
position p;
@@
 const struct wmi_10_4_pdev_stats_tx * cocci_id@p ;
...
position p;
@@
 struct wmi_addba_send_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_set_param_cmd * cocci_id@p ;
...
position p;
@@
 struct ath10k_fw_stats_vdev_extd * cocci_id@p ;
...
position p;
@@
 struct ath10k_tpc_stats * cocci_id@p ;
...
position p;
@@
 struct wmi_tdls_peer_capabilities * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_get_tpc_config_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_addba_clear_resp_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_10_4_peer_stats * cocci_id@p ;
...
position p;
@@
 struct wmi_mgmt_rx_hdr_v1 * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_stop_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_chan_info_req_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_mgmt_tx_compl_ev_arg cocci_id@p ;
...
position p;
@@
 struct wmi_scan_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_10_2_pdev_stats * cocci_id@p ;
...
position p;
@@
 struct wmi_mgmt_rx_ev_arg cocci_id@p ;
...
position p;
@@
 struct ath10k_fw_extd_stats_peer * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ WMI_TPC_BUF_SIZE ] ;
...
position p;
@@
 const struct wmi_p2p_noa_info * cocci_id@p ;
...
position p;
@@
 const struct wmi_pdev_stats_rx * cocci_id@p ;
...
position p;
@@
 struct wmi_dfs_status_ev_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_10x_service_ready_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_vdev_start_request_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_up_cmd * cocci_id@p ;
...
position p;
@@
 struct ieee80211_vif * cocci_id@p ;
...
position p;
@@
 enum wmi_10_2_event_id cocci_id@p ;
...
position p;
@@
 struct wmi_peer_flush_tids_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_pdev_stats * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ WMI_TPC_RATE_MAX ] ;
...
position p;
@@
 struct wmi_10_2_peer_assoc_complete_cmd cocci_id@p ;
...
position p;
@@
 struct ath10k_fw_stats_pdev * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ WMI_TPC_TX_N_CHAIN * WMI_TPC_BUF_SIZE ] ;
...
position p;
@@
 const struct wmi_pdev_stats_base * cocci_id@p ;
...
position p;
@@
 struct wmi_service_ready_event * cocci_id@p ;
...
position p;
@@
 struct ieee80211_hdr * cocci_id@p ;
...
position p;
@@
 struct wmi_scan_ev_arg cocci_id@p ;
...
position p;
@@
 struct wmi_10_4_mgmt_rx_hdr * cocci_id@p ;
...
position p;
@@
 struct wmi_host_swba_event * cocci_id@p ;
...
position p;
@@
 struct wmi_mgmt_rx_ext_info * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_start_ev_arg cocci_id@p ;
...
position p;
@@
 struct wmi_10_4_peer_assoc_complete_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_wow_ev_arg cocci_id@p ;
...
position p;
@@
 struct ath10k_tpc_stats_final * cocci_id@p ;
...
position p;
@@
 struct ieee80211_tim_ie * cocci_id@p ;
...
position p;
@@
 struct wmi_peer_sta_ps_state_chg_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_tim_info_arg * cocci_id@p ;
...
position p;
@@
 const struct ath10k_fw_stats_peer * cocci_id@p ;
...
position p;
@@
 const struct wmi_10_2_pdev_ext_stats * cocci_id@p ;
...
position p;
@@
 const struct phyerr_tlv * cocci_id@p ;
...
position p;
@@
 struct wmi_mgmt_tx_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_channel_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_10_4_mgmt_rx_event * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_delete_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_vdev_install_key_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_sta_powersave_mode_cmd * cocci_id@p ;
...
position p;
@@
 const struct ath10k_fw_stats_pdev * cocci_id@p ;
...
position p;
@@
 const struct wmi_pdev_temperature_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_10_4_phyerr_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_bb_timing_cfg_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_ch_info_ev_arg * cocci_id@p ;
...
position p;
@@
 const struct ath10k_fw_stats_vdev * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ WMI_TPC_TX_N_CHAIN ] ;
...
position p;
@@
 struct wmi_pdev_suspend_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_init_cmd_10x * cocci_id@p ;
...
position p;
@@
 struct wmi_stop_scan_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_host_mem_chunks * cocci_id@p ;
...
position p;
@@
 const struct wmi_start_scan_arg * cocci_id@p ;
...
position p;
@@
 const struct wmi_peer_flags_map cocci_id@p ;
...
position p;
@@
 struct wmi_bssid_list * cocci_id@p ;
...
position p;
@@
 struct ath10k_mgmt_tx_pkt_addr * cocci_id@p ;
...
position p;
@@
 struct wmi_echo_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_mgmt_rx_event_v2 * cocci_id@p ;
...
position p;
@@
 struct wmi_init_cmd_10_2 * cocci_id@p ;
...
position p;
@@
 struct ath10k_radar_found_info cocci_id@p ;
...
position p;
@@
 enum wmi_scan_completion_reason cocci_id@p ;
...
position p;
@@
 struct wmi_peer_create_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_start_request_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_create_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_dbglog_cfg_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_ap_ps_peer_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_resource_config cocci_id@p ;
...
position p;
@@
 struct wmi_mac_addr cocci_id@p ;
...
position p;
@@
 struct wmi_chan_info_event * cocci_id@p ;
...
position p;
@@
 const struct wlan_host_mem_req * * cocci_id@p ;
...
position p;
@@
 struct wmi_10_4_tdls_peer_update_cmd * cocci_id@p ;
...
position p;
@@
 struct phyerr_fft_report * cocci_id@p ;
...
position p;
@@
 struct wmi_request_stats_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tdls_peer_event * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_set_quiet_cmd * cocci_id@p ;
...
position p;
@@
 struct phyerr_radar_report * cocci_id@p ;
...
position p;
@@
 struct wmi_echo_ev_arg * cocci_id@p ;
...
position p;
@@
 enum wmi_dfs_region cocci_id@p ;
...
position p;
@@
 const struct wmi_wmm_params_all_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_10_4_phyerr_event * cocci_id@p ;
...
position p;
@@
 struct wmi_resource_config_10x cocci_id@p ;
...
position p;
@@
 enum wmi_sta_ps_mode cocci_id@p ;
...
position p;
@@
 struct ath10k_fw_stats_vdev * cocci_id@p ;
...
position p;
@@
 struct ieee80211_sta * cocci_id@p ;
...
position p;
@@
 struct wmi_10x_start_scan_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_tpc_final_table_event * cocci_id@p ;
...
position p;
@@
 struct wmi_start_scan_common * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_set_regdomain_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_radar_found_info * cocci_id@p ;
...
position p;
@@
 struct wmi_chan_list cocci_id@p ;
...
position p;
@@
 const struct ath10k_fw_stats_vdev_extd * cocci_id@p ;
...
position p;
@@
 struct wmi_start_scan_arg * cocci_id@p ;
...
position p;
@@
 const struct wmi_pdev_stats_extra * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_mgmt_tx_bundle_compl_ev_arg cocci_id@p ;
...
position p;
@@
 struct wmi_phyerr_event * cocci_id@p ;
...
position p;
@@
 struct wmi_swba_ev_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_ext_resource_config_10_4_cmd * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ WMI_TPC_PREAM_TABLE_MAX ] ;
...
position p;
@@
 const struct wmi_stats_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_vdev_spectral_conf_arg * cocci_id@p ;
...
position p;
@@
 const struct wmi_phyerr * cocci_id@p ;
...
position p;
@@
 struct host_memory_chunk * cocci_id@p ;
...
position p;
@@
 struct ath10k_skb_cb * cocci_id@p ;
...
position p;
@@
 enum wmi_bss_survey_req_type cocci_id@p ;
...
position p;
@@
 const struct phyerr_radar_report * cocci_id@p ;
...
position p;
@@
 enum wmi_force_fw_hang_type cocci_id@p ;
...
position p;
@@
 struct wmi_mgmt_rx_event_v1 * cocci_id@p ;
...
position p;
@@
 struct wmi_10_2_4_peer_stats cocci_id@p ;
...
position p;
@@
 struct wmi_rdy_ev_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_peer_param_map cocci_id@p ;
...
position p;
@@
 const struct wmi_peer_stats * cocci_id@p ;
...
position p;
@@
 struct wmi_scan_chan_list_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_peer_delete_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_ssid_list * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ WMI_TPC_FINAL_RATE_MAX ] ;
...
position p;
@@
 struct wmi_pdev_set_param_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_force_fw_hang_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_common_peer_assoc_complete_cmd * cocci_id@p ;
...
position p;
@@
 const struct ath10k_radar_found_info * cocci_id@p ;
...
position p;
@@
 const struct wmi_10_2_peer_stats * cocci_id@p ;
...
position p;
@@
 struct wmi_phyerr_hdr_arg cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_bb_timing_cfg_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_sta_powersave_param_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_init_cmd_10_4 * cocci_id@p ;
...
position p;
@@
 struct wmi_10_4_tdls_set_state_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_roam_ev_arg cocci_id@p ;
...
position p;
@@
 struct mgmt_tx_compl_params cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_pktlog_enable_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_param_map cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_spectral_enable_cmd * cocci_id@p ;
...
position p;
@@
 struct chan_info_params cocci_id@p ;
...
position p;
@@
 struct wmi_10_4_dbglog_cfg_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_wmm_params * cocci_id@p ;
...
position p;
@@
 const struct wmi_10x_pdev_stats * cocci_id@p ;
...
position p;
@@
 struct wmi_delba_send_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_start_scan_tlvs * cocci_id@p ;
...
position p;
@@
 enum wmi_vdev_subtype cocci_id@p ;
...
position p;
@@
 const struct wmi_10x_peer_stats * cocci_id@p ;
...
position p;
@@
 struct ath10k_fw_stats_peer * cocci_id@p ;
...
position p;
@@
 enum wmi_host_platform_type cocci_id@p ;
...
position p;
@@
 struct wmi_main_peer_assoc_complete_cmd * cocci_id@p ;
...
position p;
@@
 struct ieee80211_rx_status * cocci_id@p ;
...
position p;
@@
 struct wmi_phyerr_ev_arg cocci_id@p ;
...
position p;
@@
 struct wmi_10_4_chan_info_event * cocci_id@p ;
...
position p;
@@
 enum wmi_10_4_event_id cocci_id@p ;
...
position p;
@@
 enum wmi_peer_param cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_get_tpc_table_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_spectral_conf_cmd * cocci_id@p ;
...
position p;
@@
 struct ath10k_htc_svc_conn_resp cocci_id@p ;
...
position p;
@@
 struct wmi_bcn_tx_ref_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_param_map cocci_id@p ;
...
position p;
@@
 const struct wmi_pdev_stats_tx * cocci_id@p ;
...
position p;
@@
 struct wmi_10_4_host_swba_event * cocci_id@p ;
...
position p;
@@
 struct wmi_echo_event * cocci_id@p ;
...
position p;
@@
 struct wmi_init_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_ops cocci_id@p ;
...
position p;
@@
 const struct ath10k_fw_extd_stats_peer * cocci_id@p ;
...
position p;
@@
 const struct wmi_tdls_peer_capab_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_peer_set_param_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_set_regdomain_cmd_10x * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_bss_chan_info_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_vdev_stats * cocci_id@p ;
...
position p;
@@
 const struct wmi_10_2_4_ext_peer_stats * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_set_adaptive_cca_params * cocci_id@p ;
...
position p;
@@
 struct wmi_pdev_set_base_macaddr_cmd * cocci_id@p ;

@ script:python depends on r264 @
p << r264.p;
@@

if 264 not in rule_matches:
    rule_matches[264] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['131']:
    rule_matches[264]['correct_lines'].append(p[0].line)
else:
    rule_matches[264]['other_lines'].append(p[0].line)

@ r265 @
symbol cocci_id;
position p;
@@
 const struct wmi_vdev_stats_extd * cocci_id@p ;

@ script:python depends on r265 @
p << r265.p;
@@

if 265 not in rule_matches:
    rule_matches[265] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['231']:
    rule_matches[265]['correct_lines'].append(p[0].line)
else:
    rule_matches[265]['other_lines'].append(p[0].line)

@ r266 @
symbol cocci_id;
position p;
@@
 struct wmi_addba_setresponse_cmd * cocci_id@p ;

@ script:python depends on r266 @
p << r266.p;
@@

if 266 not in rule_matches:
    rule_matches[266] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['36']:
    rule_matches[266]['correct_lines'].append(p[0].line)
else:
    rule_matches[266]['other_lines'].append(p[0].line)
...
@ script:python depends on r267 @
p << r267.p;
@@

if 267 not in rule_matches:
    rule_matches[267] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['224']:
    rule_matches[267]['correct_lines'].append(p[0].line)
else:
    rule_matches[267]['other_lines'].append(p[0].line)

@ r268 @
symbol cocci_id;
position p;
@@
 struct wmi_ready_event * cocci_id@p ;

@ script:python depends on r268 @
p << r268.p;
@@

if 268 not in rule_matches:
    rule_matches[268] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['151']:
    rule_matches[268]['correct_lines'].append(p[0].line)
else:
    rule_matches[268]['other_lines'].append(p[0].line)

@ r269 @
symbol cocci_id;
position p;
@@
 struct wmi_pdev_tpc_config_event * cocci_id@p ;

@ script:python depends on r269 @
p << r269.p;
@@

if 269 not in rule_matches:
    rule_matches[269] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['176']:
    rule_matches[269]['correct_lines'].append(p[0].line)
else:
    rule_matches[269]['other_lines'].append(p[0].line)

@ r270 @
symbol cocci_id;
position p;
@@
 struct pulse_event cocci_id@p ;

@ script:python depends on r270 @
p << r270.p;
@@

if 270 not in rule_matches:
    rule_matches[270] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['205']:
    rule_matches[270]['correct_lines'].append(p[0].line)
else:
    rule_matches[270]['other_lines'].append(p[0].line)
...
@ script:python depends on r271 @
p << r271.p;
@@

if 271 not in rule_matches:
    rule_matches[271] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['153']:
    rule_matches[271]['correct_lines'].append(p[0].line)
else:
    rule_matches[271]['other_lines'].append(p[0].line)
...
@ script:python depends on r272 @
p << r272.p;
@@

if 272 not in rule_matches:
    rule_matches[272] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['150']:
    rule_matches[272]['correct_lines'].append(p[0].line)
else:
    rule_matches[272]['other_lines'].append(p[0].line)

@ r273 @
symbol cocci_id;
position p;
@@
 struct ath10k_wmi * cocci_id@p ;

@ script:python depends on r273 @
p << r273.p;
@@

if 273 not in rule_matches:
    rule_matches[273] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['275']:
    rule_matches[273]['correct_lines'].append(p[0].line)
else:
    rule_matches[273]['other_lines'].append(p[0].line)

@ r274 @
symbol cocci_id;
position p;
@@
 struct wmi_roam_ev * cocci_id@p ;

@ script:python depends on r274 @
p << r274.p;
@@

if 274 not in rule_matches:
    rule_matches[274] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['149']:
    rule_matches[274]['correct_lines'].append(p[0].line)
else:
    rule_matches[274]['other_lines'].append(p[0].line)
...
@ script:python depends on r275 @
p << r275.p;
@@

if 275 not in rule_matches:
    rule_matches[275] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['58']:
    rule_matches[275]['correct_lines'].append(p[0].line)
else:
    rule_matches[275]['other_lines'].append(p[0].line)

@ r276 @
symbol cocci_id;
position p;
@@
 enum wmi_ap_ps_peer_param cocci_id@p ;

@ script:python depends on r276 @
p << r276.p;
@@

if 276 not in rule_matches:
    rule_matches[276] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['68']:
    rule_matches[276]['correct_lines'].append(p[0].line)
else:
    rule_matches[276]['other_lines'].append(p[0].line)

@ r277 @
symbol cocci_id;
position p;
@@
 struct wmi_10_2_4_ext_peer_stats cocci_id@p ;

@ script:python depends on r277 @
p << r277.p;
@@

if 277 not in rule_matches:
    rule_matches[277] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['239']:
    rule_matches[277]['correct_lines'].append(p[0].line)
else:
    rule_matches[277]['other_lines'].append(p[0].line)

@ r278 @
symbol cocci_id;
position p;
@@
 struct wmi_vdev_down_cmd * cocci_id@p ;

@ script:python depends on r278 @
p << r278.p;
@@

if 278 not in rule_matches:
    rule_matches[278] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['86']:
    rule_matches[278]['correct_lines'].append(p[0].line)
else:
    rule_matches[278]['other_lines'].append(p[0].line)

@ r279 @
symbol cocci_id;
position p;
@@
 const struct wmi_wmm_params_arg * cocci_id@p ;

@ script:python depends on r279 @
p << r279.p;
@@

if 279 not in rule_matches:
    rule_matches[279] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['48']:
    rule_matches[279]['correct_lines'].append(p[0].line)
else:
    rule_matches[279]['other_lines'].append(p[0].line)

@ r280 @
symbol cocci_id;
position p;
@@
 const struct wmi_10_4_peer_extd_stats * cocci_id@p ;

@ script:python depends on r280 @
p << r280.p;
@@

if 280 not in rule_matches:
    rule_matches[280] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['233']:
    rule_matches[280]['correct_lines'].append(p[0].line)
else:
    rule_matches[280]['other_lines'].append(p[0].line)
...
@ script:python depends on r281 @
p << r281.p;
@@

if 281 not in rule_matches:
    rule_matches[281] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['109']:
    rule_matches[281]['correct_lines'].append(p[0].line)
else:
    rule_matches[281]['other_lines'].append(p[0].line)

@ r282 @
symbol cocci_id;
position p;
@@
 const struct wmi_stop_scan_arg * cocci_id@p ;

@ script:python depends on r282 @
p << r282.p;
@@

if 282 not in rule_matches:
    rule_matches[282] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['95']:
    rule_matches[282]['correct_lines'].append(p[0].line)
else:
    rule_matches[282]['other_lines'].append(p[0].line)

@ r283 @
symbol cocci_id;
position p;
@@
 struct ath10k_htc_svc_conn_req cocci_id@p ;

@ script:python depends on r283 @
p << r283.p;
@@

if 283 not in rule_matches:
    rule_matches[283] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['134']:
    rule_matches[283]['correct_lines'].append(p[0].line)
else:
    rule_matches[283]['other_lines'].append(p[0].line)

@ r284 @
symbol cocci_id;
position p;
@@
 struct ath10k_fw_stats * cocci_id@p ;

@ script:python depends on r284 @
p << r284.p;
@@

if 284 not in rule_matches:
    rule_matches[284] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['247']:
    rule_matches[284]['correct_lines'].append(p[0].line)
else:
    rule_matches[284]['other_lines'].append(p[0].line)

@ r285 @
symbol cocci_id;
position p;
@@
 const struct wmi_10_4_bss_bcn_filter_stats * cocci_id@p ;

@ script:python depends on r285 @
p << r285.p;
@@

if 285 not in rule_matches:
    rule_matches[285] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['234']:
    rule_matches[285]['correct_lines'].append(p[0].line)
else:
    rule_matches[285]['other_lines'].append(p[0].line)

@ r286 @
symbol cocci_id;
position p;
@@
 struct wmi_10_2_4_host_swba_event * cocci_id@p ;

@ script:python depends on r286 @
p << r286.p;
@@

if 286 not in rule_matches:
    rule_matches[286] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['218']:
    rule_matches[286]['correct_lines'].append(p[0].line)
else:
    rule_matches[286]['other_lines'].append(p[0].line)

@ r287 @
symbol cocci_id;
position p;
@@
 const struct wmi_channel_arg * cocci_id@p ;

@ script:python depends on r287 @
p << r287.p;
@@

if 287 not in rule_matches:
    rule_matches[287] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['13']:
    rule_matches[287]['correct_lines'].append(p[0].line)
else:
    rule_matches[287]['other_lines'].append(p[0].line)

@ r288 @
symbol cocci_id;
position p;
@@
 struct wmi_start_scan_cmd * cocci_id@p ;

@ script:python depends on r288 @
p << r288.p;
@@

if 288 not in rule_matches:
    rule_matches[288] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['99']:
    rule_matches[288]['correct_lines'].append(p[0].line)
else:
    rule_matches[288]['other_lines'].append(p[0].line)

@ r289 @
symbol cocci_id;
position p;
@@
 struct wmi_cmd_map cocci_id@p ;

@ script:python depends on r289 @
p << r289.p;
@@

if 289 not in rule_matches:
    rule_matches[289] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['219']:
    rule_matches[289]['correct_lines'].append(p[0].line)
else:
    rule_matches[289]['other_lines'].append(p[0].line)

@ r290 @
symbol cocci_id;
position p;
@@
 struct wmi_svc_avail_ev_arg cocci_id@p ;

@ script:python depends on r290 @
p << r290.p;
@@

if 290 not in rule_matches:
    rule_matches[290] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['145']:
    rule_matches[290]['correct_lines'].append(p[0].line)
else:
    rule_matches[290]['other_lines'].append(p[0].line)

@ r291 @
symbol cocci_id;
position p;
@@
 struct wmi_10_1_peer_assoc_complete_cmd cocci_id@p ;

@ script:python depends on r291 @
p << r291.p;
@@

if 291 not in rule_matches:
    rule_matches[291] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['55']:
    rule_matches[291]['correct_lines'].append(p[0].line)
else:
    rule_matches[291]['other_lines'].append(p[0].line)
...
@ script:python depends on r292 @
p << r292.p;
@@

if 292 not in rule_matches:
    rule_matches[292] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['259']:
    rule_matches[292]['correct_lines'].append(p[0].line)
else:
    rule_matches[292]['other_lines'].append(p[0].line)

@ r293 @
symbol cocci_id;
position p;
@@
 struct radar_detector_specs cocci_id@p ;

@ script:python depends on r293 @
p << r293.p;
@@

if 293 not in rule_matches:
    rule_matches[293] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['204']:
    rule_matches[293]['correct_lines'].append(p[0].line)
else:
    rule_matches[293]['other_lines'].append(p[0].line)

@ r294 @
symbol cocci_id;
position p;
@@
 enum wmi_sta_powersave_param cocci_id@p ;

@ script:python depends on r294 @
p << r294.p;
@@

if 294 not in rule_matches:
    rule_matches[294] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['71']:
    rule_matches[294]['correct_lines'].append(p[0].line)
else:
    rule_matches[294]['other_lines'].append(p[0].line)

@ r295 @
symbol cocci_id;
position p;
@@
 struct ath10k_peer * cocci_id@p ;

@ script:python depends on r295 @
p << r295.p;
@@

if 295 not in rule_matches:
    rule_matches[295] = {'lines': [], 'correct_lines': [], 'other_lines': []}
if p[0].line in ['162']:
    rule_matches[295]['correct_lines'].append(p[0].line)
else:
    rule_matches[295]['other_lines'].append(p[0].line)
