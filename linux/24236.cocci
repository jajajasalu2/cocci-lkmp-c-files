...
position p;
@@
 const struct nla_policy cocci_id@p [ SEG6_IPTUNNEL_MAX + 1 ] ;
...
position p;
@@
 struct seg6_pernet_data * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ SEG6_IPTUNNEL_MAX + 1 ] ;
...
position p;
@@
 struct seg6_iptunnel_encap * cocci_id@p ;
...
position p;
@@
 struct seg6_lwt {  struct dst_cache cache ;  struct seg6_iptunnel_encap tuninfo [ 0 ] ; } cocci_id@p ;
