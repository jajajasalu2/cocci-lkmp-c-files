...
position p;
@@
 void ( * cocci_id@p ) ( struct usbhs_priv * priv , struct usbhs_pkt * pkt ) ;
...
position p;
@@
 struct sh_dmae_slave * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usbhs_pkt * pkt , int map ) ;
...
position p;
@@
 struct dma_chan * cocci_id@p ( struct usbhs_fifo * fifo , struct usbhs_pkt * pkt ) ;
...
position p;
@@
 void cocci_id@p ( struct usbhs_pipe * pipe , struct usbhs_fifo * fifo ) ;
...
position p;
@@
 enum { USBHSF_PKT_PREPARE , USBHSF_PKT_TRY_RUN , USBHSF_PKT_DMA_DONE , } cocci_id@p ;
...
position p;
@@
 const struct usbhs_pkt_handle cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct usbhs_pkt * pkt , int * is_done ) ;
...
position p;
@@
 struct usbhs_pipe_info * cocci_id@p ;
