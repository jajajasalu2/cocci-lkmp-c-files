...
position p;
@@
 struct cpl_iscsi_hdr * cocci_id@p ;
...
typedef __be64;
@@
 int cocci_id@p ( void * , const __be64 * , const struct pkt_gl * ) ;
...
position p;
@@
 struct cxgbi_ports_map * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cxgbi_sock * , int ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct cxgbi_device * , struct sk_buff * ) ;
...
position p;
@@
 int cocci_id@p ( void * , enum cxgb4_state state ) ;
...
position p;
@@
 struct cxgb4_lld_info * cocci_id@p ;
...
position p;
@@
 struct cxgbi_pagepod * cocci_id@p ;
...
position p;
@@
 cxgb4i_cplhandler_func cocci_id@p [ NUM_CPL_CMDS ] ;
...
position p;
@@
 struct cxgbi_task_tag_info * cocci_id@p ;
...
position p;
@@
 struct cpl_rx_data_ddp * cocci_id@p ;
...
position p;
@@
 struct cxgbi_tag_format cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct cxgbi_sock * , struct sk_buff * , struct l2t_entry * ) ;
...
position p;
@@
 const struct cxgb4_lld_info * cocci_id@p ;
...
position p;
@@
 struct cxgbi_device * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cxgbi_sock * ) ;
...
position p;
@@
 const struct cpl_act_establish * cocci_id@p ;
...
position p;
@@
 const struct cxgb4_uld_info cocci_id@p ;
...
position p;
@@
 struct cpl_set_tcb_field * cocci_id@p ;
...
position p;
@@
 struct cpl_abort_rpl_rss * cocci_id@p ;
...
position p;
@@
 void * cocci_id@p ( const struct cxgb4_lld_info * ) ;
...
position p;
@@
 struct cpl_rx_iscsi_cmp * cocci_id@p ;
