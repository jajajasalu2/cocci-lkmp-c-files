...
position p;
@@
 struct drm_i915_gem_userptr * cocci_id@p ;
...
position p;
@@
 struct i915_mm_struct {  struct mm_struct * mm ;  struct drm_i915_private * i915 ;  struct i915_mmu_notifier * mn ;  struct hlist_node node ;  struct kref kref ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 const struct drm_i915_gem_object_ops cocci_id@p ;
...
position p;
@@
 struct i915_mmu_object * cocci_id@p ;
...
position p;
@@
 struct i915_mmu_notifier cocci_id@p ;
...
typedef spinlock_t;
@@
 struct i915_mmu_notifier {  spinlock_t lock ;  struct hlist_node node ;  struct mmu_notifier mn ;  struct rb_root_cached objects ;  struct i915_mm_struct * mm ; } cocci_id@p ;
...
position p;
@@
 struct i915_mm_struct * cocci_id@p ;
...
position p;
@@
 struct i915_mmu_object {  struct i915_mmu_notifier * mn ;  struct drm_i915_gem_object * obj ;  struct interval_tree_node it ; } cocci_id@p ;
...
position p;
@@
 struct get_pages_work * cocci_id@p ;
...
position p;
@@
 struct get_pages_work {  struct work_struct work ;  struct drm_i915_gem_object * obj ;  struct task_struct * task ; } cocci_id@p ;
