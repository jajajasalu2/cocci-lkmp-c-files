...
position p;
@@
 struct nfcmrvl_i2c_drv_data {  unsigned long flags ;  struct device * dev ;  struct i2c_client * i2c ;  struct nfcmrvl_private * priv ; } cocci_id@p ;
...
position p;
@@
 struct nfcmrvl_i2c_drv_data * cocci_id@p ;
