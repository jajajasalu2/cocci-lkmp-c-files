...
position p;
@@
 struct iwl_link_quality_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_tid_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct iwl_priv * priv , struct sk_buff * skb , struct ieee80211_sta * sta , struct iwl_lq_sta * lq_sta ) ;
...
position p;
@@
 struct iwl_station_priv * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct iwl_lq_sta * lq_sta , u32 * rate_n_flags , int index ) ;
...
position p;
@@
 struct iwl_rxon_context * cocci_id@p ;
...
position p;
@@
 enum mac80211_rate_control_flags cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct iwl_priv * priv , struct iwl_lq_sta * lq_sta , u32 rate_n_flags ) ;
...
position p;
@@
 const struct iwl_rate_info cocci_id@p [ IWL_RATE_COUNT ] ;
...
position p;
@@
 struct iwl_traffic_load * cocci_id@p ;
