...
position p;
@@
 struct ntb_msit_ctx {  struct ntb_dev * ntb ;  struct dentry * dbgfs_dir ;  struct work_struct setup_work ;  struct ntb_msit_isr_ctx {  int irq_idx ;  int irq_num ;  int occurrences ;  struct ntb_msit_ctx * nm ;  struct ntb_msi_desc desc ; } * isr_ctx ;  struct ntb_msit_peer {  struct ntb_msit_ctx * nm ;  int pidx ;  int num_irqs ;  struct completion init_comp ;  struct ntb_msi_desc * msi_desc ; } peers [ ] ; } cocci_id@p ;
...
position p;
@@
 struct ntb_msi_desc * cocci_id@p ;
...
position p;
@@
 struct ntb_msit_peer * cocci_id@p ;
...
position p;
@@
 struct ntb_msit_ctx * cocci_id@p ;
...
position p;
@@
 struct ntb_msit_isr_ctx * cocci_id@p ;
