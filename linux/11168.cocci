...
position p;
@@
 ENABLE_CRTC_PARAMETERS cocci_id@p ;
...
position p;
@@
 struct bp_encoder_control * cocci_id@p ;
...
position p;
@@
 struct bp_spread_spectrum_parameters * cocci_id@p ;
...
position p;
@@
 DIG_ENCODER_CONTROL_PARAMETERS_V4 cocci_id@p ;
...
position p;
@@
 ENABLE_SPREAD_SPECTRUM_ON_PPLL cocci_id@p ;
...
position p;
@@
 DISPLAY_DEVICE_OUTPUT_CONTROL_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 SET_PIXEL_CLOCK_PS_ALLOCATION_V5 cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct bp_pixel_clock_parameters * bp_params ) ;
...
position p;
@@
 struct bp_pixel_clock_parameters * cocci_id@p ;
...
position p;
@@
 DIG_ENCODER_CONTROL_PARAMETERS_V2 cocci_id@p ;
...
position p;
@@
 EXTERNAL_ENCODER_CONTROL_PARAMETERS_V3 * cocci_id@p ;
...
position p;
@@
 SET_PIXEL_CLOCK_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 struct _SET_PIXEL_CLOCK_PS_ALLOCATION_V5 {  PIXEL_CLOCK_PARAMETERS_V5 sPCLKInput ;  ENABLE_SPREAD_SPECTRUM_ON_PPLL sReserved ; } cocci_id@p ;
...
position p;
@@
 SET_DCE_CLOCK_PS_ALLOCATION_V2_1 cocci_id@p ;
...
position p;
@@
 DIG_TRANSMITTER_CONTROL_PARAMETERS_V3 cocci_id@p ;
...
position p;
@@
 ENABLE_DISP_POWER_GATING_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct bp_encoder_control * cntl ) ;
...
position p;
@@
 DIG_TRANSMITTER_CONTROL_PARAMETERS_V2 cocci_id@p ;
...
position p;
@@
 SET_PIXEL_CLOCK_PS_ALLOCATION_V6 cocci_id@p ;
...
position p;
@@
 struct graphics_object_id cocci_id@p ;
...
position p;
@@
 struct bp_transmitter_control * cocci_id@p ;
...
position p;
@@
 struct bp_hw_crtc_timing_parameters * cocci_id@p ;
...
position p;
@@
 PIXEL_CLOCK_PARAMETERS_V3 * cocci_id@p ;
...
position p;
@@
 struct bp_adjust_pixel_clock_parameters * cocci_id@p ;
...
position p;
@@
 ADJUST_DISPLAY_PLL_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct bp_external_encoder_control * cntl ) ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct bp_hw_crtc_timing_parameters * bp_params ) ;
...
typedef bool;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct bp_spread_spectrum_parameters * bp_params , bool enable ) ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct bp_set_dce_clock_parameters * bp_params ) ;
...
position p;
@@
 enum bp_pipe_control_action cocci_id@p ;
...
position p;
@@
 SET_CRTC_USING_DTD_TIMING_PARAMETERS cocci_id@p ;
...
position p;
@@
 DAC_ENCODER_CONTROL_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 PIXEL_CLOCK_PARAMETERS_V7 cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , enum controller_id crtc_id , enum bp_pipe_control_action action ) ;
...
position p;
@@
 ADJUST_DISPLAY_PLL_PS_ALLOCATION_V3 cocci_id@p ;
...
position p;
@@
 struct bp_external_encoder_control * cocci_id@p ;
...
position p;
@@
 DIG_ENCODER_CONTROL_PARAMETERS_V3 cocci_id@p ;
...
position p;
@@
 ENCODER_STREAM_SETUP_PARAMETERS_V5 cocci_id@p ;
...
position p;
@@
 EXTERNAL_ENCODER_CONTROL_PS_ALLOCATION_V3 cocci_id@p ;
...
position p;
@@
 const struct command_table_helper * cocci_id@p ;
...
position p;
@@
 DIG_TRANSMITTER_CONTROL_PARAMETERS_V4 cocci_id@p ;
...
typedef bool;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , bool enable ) ;
...
position p;
@@
 ENABLE_SPREAD_SPECTRUM_ON_PPLL_V2 cocci_id@p ;
...
position p;
@@
 ENABLE_SPREAD_SPECTRUM_ON_PPLL_V3 cocci_id@p ;
...
position p;
@@
 DIG_TRANSMITTER_CONTROL_PARAMETERS_V1_5 cocci_id@p ;
...
position p;
@@
 DIG_TRANSMITTER_CONTROL_PARAMETERS_V1_6 cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bios_parser * bp ) ;
...
typedef bool;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , enum controller_id controller_id , bool enable ) ;
...
position p;
@@
 struct bp_set_dce_clock_parameters * cocci_id@p ;
...
position p;
@@
 SET_CRTC_TIMING_PARAMETERS_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct bp_adjust_pixel_clock_parameters * bp_params ) ;
...
position p;
@@
 struct _SET_PIXEL_CLOCK_PS_ALLOCATION_V6 {  PIXEL_CLOCK_PARAMETERS_V6 sPCLKInput ;  ENABLE_SPREAD_SPECTRUM_ON_PPLL sReserved ; } cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct bp_transmitter_control * cntl ) ;
