...
position p;
@@
 int cocci_id@p ( struct regmap * map , unsigned int reg , unsigned int value ) ;
...
position p;
@@
 struct regcache_rbtree_node {  void * block ;  long * cache_present ;  unsigned int base_reg ;  unsigned int blklen ;  struct rb_node node ; } cocci_id@p ;
...
position p;
@@
 struct regcache_rbtree_node * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct regmap * map ) ;
...
position p;
@@
 struct regcache_rbtree_ctx {  struct rb_root root ;  struct regcache_rbtree_node * cached_rbnode ; } cocci_id@p ;
...
position p;
@@
 struct regcache_ops cocci_id@p ;
...
position p;
@@
 struct regcache_rbtree_ctx * cocci_id@p ;
