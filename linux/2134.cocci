...
position p;
@@
 const struct abx500_maxim_parameters cocci_id@p ;
...
position p;
@@
 const struct abx500_bm_charger_parameters cocci_id@p ;
...
position p;
@@
 const struct abx500_fg_parameters cocci_id@p ;
...
position p;
@@
 struct abx500_battery_type cocci_id@p [ ] ;
...
position p;
@@
 const struct abx500_bm_capacity_levels cocci_id@p ;
