...
position p;
@@
 struct ttm_lru_bulk_move_pos * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ttm_buffer_object * ) ;
...
position p;
@@
 struct ttm_lru_bulk_move * cocci_id@p ;
...
position p;
@@
 struct drm_vma_offset_manager * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kobject * kobj ) ;
...
position p;
@@
 struct ttm_bo_global cocci_id@p ;
