...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct inode * local_alloc_inode ) ;
...
position p;
@@
 struct ocfs2_alloc_reservation * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct ocfs2_dinode * alloc ) ;
...
position p;
@@
 struct ocfs2_reservation_map * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct ocfs2_dinode * alloc , u32 * numbits , struct ocfs2_alloc_reservation * resv ) ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct ocfs2_alloc_context * * ac , struct inode * * bitmap_inode , struct buffer_head * * bitmap_bh ) ;
...
position p;
@@
 enum ocfs2_la_event { OCFS2_LA_EVENT_SLIDE , OCFS2_LA_EVENT_FRAGMENTED , OCFS2_LA_EVENT_ENOSPC , } cocci_id@p ;
...
position p;
@@
 enum ocfs2_la_event cocci_id@p ;
...
position p;
@@
 struct ocfs2_local_alloc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ocfs2_dinode * alloc ) ;
