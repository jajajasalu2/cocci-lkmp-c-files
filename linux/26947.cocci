...
position p;
@@
 struct nfs42_falloc_args cocci_id@p ;
...
position p;
@@
 struct nfs42_netaddr * cocci_id@p ;
...
position p;
@@
 struct nfs42_copy_res cocci_id@p ;
...
position p;
@@
 struct nfs42_offloadcancel_data cocci_id@p ;
...
position p;
@@
 struct nfs4_copy_state cocci_id@p ;
...
position p;
@@
 struct nfs42_layoutstat_data * cocci_id@p ;
...
position p;
@@
 struct nfs42_copy_notify_args cocci_id@p ;
...
position p;
@@
 struct nfs42_seek_res cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct file * dst , nfs4_stateid * std ) ;
...
position p;
@@
 struct nfs42_copy_args * cocci_id@p ;
...
position p;
@@
 struct nfs42_copy_notify_res * cocci_id@p ;
...
position p;
@@
 const struct nfs42_layout_error * cocci_id@p ;
...
position p;
@@
 struct nfs42_clone_res cocci_id@p ;
...
position p;
@@
 struct nfs42_offloadcancel_data {  struct nfs_server * seq_server ;  struct nfs42_offload_status_args args ;  struct nfs42_offload_status_res res ; } cocci_id@p ;
...
position p;
@@
 struct nfs_writeverf cocci_id@p ;
...
position p;
@@
 struct nfs42_layouterror_data * cocci_id@p ;
...
position p;
@@
 struct nfs42_seek_args cocci_id@p ;
...
position p;
@@
 struct nfs42_falloc_res cocci_id@p ;
...
position p;
@@
 struct nfs42_clone_args cocci_id@p ;
