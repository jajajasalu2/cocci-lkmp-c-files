...
position p;
@@
 struct DisconnectCtrlEx_param * cocci_id@p ;
...
position p;
@@
 struct writeRF_parm * cocci_id@p ;
...
position p;
@@
 struct SetMacAddr_param * cocci_id@p ;
...
position p;
@@
 struct drvint_cmd_parm * cocci_id@p ;
