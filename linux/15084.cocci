...
position p;
@@
 const struct wrpll_cfg * cocci_id@p ;
...
typedef u8;
@@
 struct __prci_wrpll_data {  struct wrpll_cfg c ;  void ( * enable_bypass ) ( struct __prci_data * pd ) ;  void ( * disable_bypass ) ( struct __prci_data * pd ) ;  u8 cfg0_offs ; } cocci_id@p ;
...
position p;
@@
 struct __prci_clock {  const char * name ;  const char * parent_name ;  const struct clk_ops * ops ;  struct clk_hw hw ;  struct __prci_wrpll_data * pwd ;  struct __prci_data * pd ; } cocci_id@p ;
...
position p;
@@
 struct __prci_data {  void __iomem * va ;  struct clk_hw_onecell_data hw_clks ; } cocci_id@p ;
