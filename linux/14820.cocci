...
position p;
@@
 struct berlin2_div_map * cocci_id@p ;
...
position p;
@@
 const struct berlin2_div_map * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct berlin2_div {  struct clk_hw hw ;  void __iomem * base ;  struct berlin2_div_map map ;  spinlock_t * lock ; } cocci_id@p ;
