...
position p;
@@
 enum spectre_v2_user_cmd { SPECTRE_V2_USER_CMD_NONE , SPECTRE_V2_USER_CMD_AUTO , SPECTRE_V2_USER_CMD_FORCE , SPECTRE_V2_USER_CMD_PRCTL , SPECTRE_V2_USER_CMD_PRCTL_IBPB , SPECTRE_V2_USER_CMD_SECCOMP , SPECTRE_V2_USER_CMD_SECCOMP_IBPB , } cocci_id@p ;
...
position p;
@@
 enum spectre_v2_mitigation_cmd { SPECTRE_V2_CMD_NONE , SPECTRE_V2_CMD_AUTO , SPECTRE_V2_CMD_FORCE , SPECTRE_V2_CMD_RETPOLINE , SPECTRE_V2_CMD_RETPOLINE_GENERIC , SPECTRE_V2_CMD_RETPOLINE_AMD , } cocci_id@p ;
...
position p;
@@
 enum mds_mitigations cocci_id@p ;
...
position p;
@@
 enum l1tf_mitigations cocci_id@p ;
...
position p;
@@
 enum ssb_mitigation_cmd { SPEC_STORE_BYPASS_CMD_NONE , SPEC_STORE_BYPASS_CMD_AUTO , SPEC_STORE_BYPASS_CMD_ON , SPEC_STORE_BYPASS_CMD_PRCTL , SPEC_STORE_BYPASS_CMD_SECCOMP , } cocci_id@p ;
...
position p;
@@
 enum spectre_v1_mitigation { SPECTRE_V1_MITIGATION_NONE , SPECTRE_V1_MITIGATION_AUTO , } cocci_id@p ;
...
position p;
@@
 enum spectre_v2_mitigation_cmd cocci_id@p ;
...
position p;
@@
 enum ssb_mitigation cocci_id@p ;
...
position p;
@@
 enum ssb_mitigation_cmd cocci_id@p ;
...
position p;
@@
 enum spectre_v1_mitigation cocci_id@p ;
...
position p;
@@
 enum spectre_v2_mitigation cocci_id@p ;
...
position p;
@@
 enum taa_mitigations cocci_id@p ;
...
position p;
@@
 enum spectre_v2_user_mitigation cocci_id@p ;
...
position p;
@@
 enum spectre_v2_user_cmd cocci_id@p ;
