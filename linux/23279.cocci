...
position p;
@@
 struct wm8978_pll_div * cocci_id@p ;
...
typedef u8,u32;
@@
 struct wm8978_pll_div {  u32 k ;  u8 n ;  u8 div2 ; } cocci_id@p ;
...
position p;
@@
 enum wm8978_sysclk_src cocci_id@p ;
...
position p;
@@
 struct wm8978_priv {  struct regmap * regmap ;  unsigned int f_pllout ;  unsigned int f_mclk ;  unsigned int f_256fs ;  unsigned int f_opclk ;  int mclk_idx ;  enum wm8978_sysclk_src sysclk ; } cocci_id@p ;
