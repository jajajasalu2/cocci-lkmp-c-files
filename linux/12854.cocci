...
position p;
@@
 enum amd8111_edac_devs { LPC_BRIDGE = 0 , } cocci_id@p ;
...
position p;
@@
 enum amd8111_edac_pcis { PCI_BRIDGE = 0 , } cocci_id@p ;
...
position p;
@@
 struct amd8111_pci_info * cocci_id@p ;
...
position p;
@@
 struct amd8111_dev_info * cocci_id@p ;
