...
position p;
@@
 struct artpec6_pcie * cocci_id@p ;
...
position p;
@@
 const struct artpec_pcie_of_data * cocci_id@p ;
...
position p;
@@
 enum artpec_pcie_variants cocci_id@p ;
...
position p;
@@
 enum artpec_pcie_variants { ARTPEC6 , ARTPEC7 , } cocci_id@p ;
...
position p;
@@
 struct artpec_pcie_of_data {  enum artpec_pcie_variants variant ;  enum dw_pcie_device_mode mode ; } cocci_id@p ;
...
position p;
@@
 struct artpec_pcie_of_data * cocci_id@p ;
...
position p;
@@
 struct artpec6_pcie {  struct dw_pcie * pci ;  struct regmap * regmap ;  void __iomem * phy_base ;  enum artpec_pcie_variants variant ;  enum dw_pcie_device_mode mode ; } cocci_id@p ;
