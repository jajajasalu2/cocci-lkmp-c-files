...
position p;
@@
 struct sr_pcie_phy_core * cocci_id@p ;
...
typedef u32;
@@
 struct sr_pcie_phy_core {  struct device * dev ;  void __iomem * base ;  struct regmap * cdru ;  struct regmap * mhb ;  u32 pipemux ;  struct sr_pcie_phy phys [ SR_NR_PCIE_PHYS ] ; } cocci_id@p ;
...
position p;
@@
 struct sr_pcie_phy {  struct sr_pcie_phy_core * core ;  unsigned int index ;  struct phy * phy ; } cocci_id@p ;
