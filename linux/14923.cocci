...
typedef bool,u32;
@@
 struct usb_clk_data {  u32 clk_mask ;  u32 reset_mask ;  bool reset_needs_clk ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct usb_reset_data {  void __iomem * reg ;  spinlock_t * lock ;  struct clk * clk ;  struct reset_controller_dev rcdev ; } cocci_id@p ;
...
position p;
@@
 const struct usb_clk_data * cocci_id@p ;
...
position p;
@@
 struct usb_reset_data * cocci_id@p ;
