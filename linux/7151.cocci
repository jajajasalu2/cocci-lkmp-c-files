...
position p;
@@
 struct xen_remove_from_physmap cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xen_pfn_t,domid_t,pgprot_t,xen_ulong_t;
@@
 struct remap_data {  xen_pfn_t * fgfn ;  int nr_fgfn ;  pgprot_t prot ;  domid_t domid ;  struct vm_area_struct * vma ;  int index ;  struct page * * pages ;  struct xen_remap_gfn_info * info ;  int * err_ptr ;  int mapped ;  int h_errs [ XEN_PFN_PER_PAGE ] ;  xen_ulong_t h_idxs [ XEN_PFN_PER_PAGE ] ;  xen_pfn_t h_gpfns [ XEN_PFN_PER_PAGE ] ;  int h_iter ; } cocci_id@p ;
...
position p;
@@
 struct map_balloon_pages cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned long gfn , void * data ) ;
...
typedef pgprot_t;
@@
 struct remap_pfn {  struct mm_struct * mm ;  struct page * * pages ;  pgprot_t prot ;  unsigned long i ; } cocci_id@p ;
...
typedef xen_pfn_t;
@@
 struct map_balloon_pages {  xen_pfn_t * pfns ;  unsigned int idx ; } cocci_id@p ;
...
position p;
@@
 typeof ( info -> nr_fgfn ) cocci_id@p ;
...
position p;
@@
 struct xen_add_to_physmap_range cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xen_gfn_fn_t;
@@
 xen_gfn_fn_t cocci_id@p ;
