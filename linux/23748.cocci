...
position p;
@@
 struct wpan_phy_iter_data * cocci_id@p ;
...
position p;
@@
 struct wpan_phy_iter_data {  int ( * fn ) ( struct wpan_phy * phy , void * data ) ;  void * data ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct wpan_phy * phy , void * data ) ;
