...
position p;
@@
 struct vio_net_dext * cocci_id@p ;
...
position p;
@@
 struct vio_net_desc cocci_id@p ;
...
position p;
@@
 struct vnet_mcast_entry * cocci_id@p ;
...
position p;
@@
 struct vio_net_mcast_info * cocci_id@p ;
...
position p;
@@
 struct vnet_port * ( * cocci_id@p ) ( struct sk_buff * , struct net_device * ) ;
...
position p;
@@
 int cocci_id@p ( struct vnet_port * port ) ;
...
position p;
@@
 struct vio_net_attr_info cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct vnet_port * port , u32 start ) ;
