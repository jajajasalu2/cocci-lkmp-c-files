...
position p;
@@
 struct pa12203001_data cocci_id@p ;
...
typedef bool;
@@
 struct pa12203001_data {  struct i2c_client * client ;  struct mutex lock ;  bool als_enabled ;  bool px_enabled ;  bool als_needs_enable ;  bool px_needs_enable ;  struct regmap * map ; } cocci_id@p ;
