...
position p;
@@
 struct safexcel_context_record cocci_id@p ;
...
position p;
@@
 enum safexcel_eip_version cocci_id@p ;
...
position p;
@@
 const struct firmware * cocci_id@p [ FW_NB ] ;
...
position p;
@@
 struct safexcel_context * cocci_id@p ;
...
position p;
@@
 struct safexcel_ring_irq_data * cocci_id@p ;
...
position p;
@@
 struct result_data_desc * cocci_id@p ;
...
position p;
@@
 struct safexcel_register_offsets * cocci_id@p ;
...
position p;
@@
 struct safexcel_work_data cocci_id@p ;
...
position p;
@@
 struct safexcel_ring_irq_data {  struct safexcel_crypto_priv * priv ;  int ring ; } cocci_id@p ;
