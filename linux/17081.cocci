...
position p;
@@
 struct vdso_patch_def * cocci_id@p ;
...
position p;
@@
 struct lib64_elfinfo cocci_id@p ;
...
position p;
@@
 struct lib32_elfinfo {  Elf32_Ehdr * hdr ;  Elf32_Sym * dynsym ;  unsigned long dynsymsize ;  char * dynstr ;  unsigned long text ; } cocci_id@p ;
...
position p;
@@
 struct lib32_elfinfo cocci_id@p ;
...
position p;
@@
 struct lib64_elfinfo {  Elf64_Ehdr * hdr ;  Elf64_Sym * dynsym ;  unsigned long dynsymsize ;  char * dynstr ;  unsigned long text ; } cocci_id@p ;
...
typedef u8;
@@
 union {  struct vdso_data data ;  u8 page [ PAGE_SIZE ] ; } cocci_id@p ;
