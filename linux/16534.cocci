...
symbol cocci_id;
position p;
typedef xpram_device_t;
@@
 xpram_device_t * cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ XPRAM_MAX_DEVS ] ;
...
typedef xpram_device_t;
@@
 xpram_device_t cocci_id@p [ XPRAM_MAX_DEVS ] ;
...
position p;
@@
 unsigned int cocci_id@p [ XPRAM_MAX_DEVS ] ;
...
position p;
@@
 struct request_queue * cocci_id@p [ XPRAM_MAX_DEVS ] ;
...
position p;
@@
 struct gendisk * cocci_id@p [ XPRAM_MAX_DEVS ] ;
...
position p;
@@
 struct {  unsigned int size ;  unsigned int offset ; } cocci_id@p ;
