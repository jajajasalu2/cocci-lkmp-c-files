...
position p;
@@
 enum clear_nexus_phase cocci_id@p ;
...
position p;
@@
 enum clear_nexus_phase { NEXUS_PHASE_PRE , NEXUS_PHASE_POST , NEXUS_PHASE_RESUME , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct asd_ascb * , struct done_list_struct * ) ;
...
position p;
@@
 struct tasklet_completion_status * cocci_id@p ;
...
position p;
@@
 struct done_list_struct * cocci_id@p ;
...
typedef u8;
@@
 struct tasklet_completion_status {  int dl_opcode ;  int tmf_state ;  u8 tag_valid : 1 ;  __be16 tag ; } cocci_id@p ;
