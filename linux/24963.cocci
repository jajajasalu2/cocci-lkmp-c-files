...
position p;
@@
 const char * const cocci_id@p [ VLAN_NAME_TYPE_HIGHEST ] ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * seq , void * ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_file * seq , void * v ) ;
...
position p;
@@
 const struct vlan_priority_tci_mapping * cocci_id@p ;
