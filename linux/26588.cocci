...
position p;
@@
 struct test_ping_resp_msg_v01 cocci_id@p ;
...
position p;
@@
 struct qmi_sample {  struct qmi_handle qmi ;  struct dentry * de_dir ;  struct dentry * de_data ;  struct dentry * de_ping ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct test_data_resp_msg_v01 {  struct qmi_response_type_v01 resp ;  u8 data_valid ;  u32 data_len ;  u8 data [ TEST_MED_DATA_SIZE_V01 ] ;  u8 service_name_valid ;  struct test_name_type_v01 service_name ; } cocci_id@p ;
...
typedef u32;
@@
 struct test_name_type_v01 {  u32 name_len ;  char name [ TEST_MAX_NAME_SIZE_V01 ] ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct test_data_req_msg_v01 {  u32 data_len ;  u8 data [ TEST_MED_DATA_SIZE_V01 ] ;  u8 client_name_valid ;  struct test_name_type_v01 client_name ; } cocci_id@p ;
...
typedef u8;
@@
 struct test_ping_resp_msg_v01 {  struct qmi_response_type_v01 resp ;  u8 pong_valid ;  char pong [ 4 ] ;  u8 service_name_valid ;  struct test_name_type_v01 service_name ; } cocci_id@p ;
...
position p;
@@
 struct test_name_type_v01 cocci_id@p ;
...
position p;
@@
 struct test_data_resp_msg_v01 cocci_id@p ;
...
position p;
@@
 const struct test_ping_resp_msg_v01 * cocci_id@p ;
...
typedef u8;
@@
 struct test_ping_req_msg_v01 {  char ping [ 4 ] ;  u8 client_name_valid ;  struct test_name_type_v01 client_name ; } cocci_id@p ;
...
position p;
@@
 struct test_ping_req_msg_v01 cocci_id@p ;
...
position p;
@@
 struct test_data_req_msg_v01 * cocci_id@p ;
