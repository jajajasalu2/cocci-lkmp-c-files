...
position p;
@@
 struct cpts_skb_cb_data {  unsigned long tmo ; } cocci_id@p ;
...
typedef u8,u16;
@@
 int cocci_id@p ( struct sk_buff * skb , unsigned int ptp_class , u16 ts_seqid , u8 ts_msgtype ) ;
...
position p;
@@
 struct cpts_skb_cb_data * cocci_id@p ;
