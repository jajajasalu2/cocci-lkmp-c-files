...
position p;
@@
 struct mmc_blk_request cocci_id@p ;
...
typedef u64;
@@
 struct mmc_blk_ioc_data {  struct mmc_ioc_cmd ic ;  unsigned char * buf ;  u64 buf_bytes ;  struct mmc_rpmb_data * rpmb ; } cocci_id@p ;
...
position p;
@@
 struct mmc_rpmb_data {  struct device dev ;  struct cdev chrdev ;  int id ;  unsigned int part_index ;  struct mmc_blk_data * md ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct mmc_queue_req * cocci_id@p ;
...
position p;
@@
 struct mmc_blk_ioc_data * cocci_id@p ;
...
position p;
@@
 struct mmc_blk_ioc_data * cocci_id@p [ 1 ] ;
...
position p;
@@
 int cocci_id@p ( struct mmc_card * card , unsigned int part_type ) ;
...
position p;
@@
 struct mmc_rpmb_data cocci_id@p ;
...
position p;
@@
 struct mmc_blk_data cocci_id@p ;
