...
position p;
@@
 struct uart_cpm_port * cocci_id@p ;
...
position p;
@@
 struct uart_cpm_port cocci_id@p [ UART_NR ] ;
...
position p;
@@
 void cocci_id@p ( struct uart_cpm_port * pinfo ) ;
