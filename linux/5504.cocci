...
position p;
@@
 struct pl022_config_chip cocci_id@p ;
...
position p;
@@
 enum ssp_reading { READING_NULL , READING_U8 , READING_U16 , READING_U32 , } cocci_id@p ;
...
position p;
@@
 struct pl022_ssp_controller cocci_id@p ;
...
position p;
@@
 struct ssp_clock_params cocci_id@p ;
...
@@
 struct chip_data {  u32 cr0 ;  u16 cr1 ;  u16 dmacr ;  u16 cpsr ;  u8 n_bytes ;  bool enable_dma ;  enum ssp_reading read ;  enum ssp_writing write ;  void ( * cs_control ) ( u32 command ) ;  int xfer_type ; } cocci_id@p ;
...
position p;
@@
 const struct pl022_config_chip * cocci_id@p ;
...
position p;
@@
 enum ssp_writing { WRITING_NULL , WRITING_U8 , WRITING_U16 , WRITING_U32 , } cocci_id@p ;
...
typedef bool;
@@
 struct vendor_data {  int fifodepth ;  int max_bpw ;  bool unidir ;  bool extended_cr ;  bool pl023 ;  bool loopback ;  bool internal_cs_ctrl ; } cocci_id@p ;
