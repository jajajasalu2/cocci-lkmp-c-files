...
position p;
@@
 SMC_NIslands_MCRegisters * cocci_id@p ;
...
position p;
@@
 PP_NIslands_CACTABLES * cocci_id@p ;
...
position p;
@@
 NISLANDS_SMC_STATETABLE * cocci_id@p ;
...
position p;
@@
 SMC_NIslands_MCRegisterSet cocci_id@p ;
...
position p;
@@
 NISLANDS_SMC_VOLTAGE_VALUE * cocci_id@p ;
...
position p;
@@
 NISLANDS_SMC_SCLK_VALUE cocci_id@p ;
...
position p;
@@
 NISLANDS_SMC_SWSTATE cocci_id@p ;
...
position p;
@@
 SMC_NISLANDS_SPLL_DIV_TABLE cocci_id@p ;
...
position p;
@@
 NISLANDS_SMC_MCLK_VALUE * cocci_id@p ;
...
position p;
@@
 NISLANDS_SMC_HW_PERFORMANCE_LEVEL cocci_id@p ;
...
position p;
@@
 struct NISLANDS_SMC_VOLTAGE_VALUE * cocci_id@p ;
...
position p;
@@
 SMC_NIslands_MCArbDramTimingRegisterSet * cocci_id@p ;
...
position p;
@@
 const struct ni_cac_weights cocci_id@p ;
...
position p;
@@
 struct ni_mc_reg_table * cocci_id@p ;
...
position p;
@@
 struct ni_mc_reg_entry * cocci_id@p ;
