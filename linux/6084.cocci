...
position p;
@@
 struct imx1_pmx_func cocci_id@p ;
...
position p;
@@
 const struct imx1_pin_group * cocci_id@p ;
...
position p;
@@
 struct imx1_pinctrl {  struct device * dev ;  struct pinctrl_dev * pctl ;  void __iomem * base ;  const struct imx1_pinctrl_soc_info * info ; } cocci_id@p ;
...
position p;
@@
 struct imx1_pin_group cocci_id@p ;
...
position p;
@@
 const struct imx1_pin * cocci_id@p ;
...
position p;
@@
 struct imx1_pinctrl * cocci_id@p ;
...
position p;
@@
 const struct imx1_pinctrl_soc_info * cocci_id@p ;
