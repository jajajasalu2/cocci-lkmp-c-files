...
position p;
@@
 const struct llc_sap * cocci_id@p ;
...
position p;
@@
 struct llc_conn_state_ev * cocci_id@p ;
...
position p;
@@
 struct llc_conn_state_trans * cocci_id@p ( struct sock * sk , struct sk_buff * skb ) ;
...
symbol cocci_id;
position p;
typedef llc_conn_action_t;
@@
 const llc_conn_action_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ NBR_CONN_STATES ] [ NBR_CONN_EV ] ;
...
position p;
@@
 struct llc_conn_state_trans * * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef llc_conn_ev_qfyr_t;
@@
 const llc_conn_ev_qfyr_t * cocci_id@p ;
...
position p;
@@
 const struct llc_addr * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sock * sk , struct llc_conn_state_trans * trans , struct sk_buff * ev ) ;
...
position p;
@@
 struct llc_conn_state * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int state , int ev_type ) ;
