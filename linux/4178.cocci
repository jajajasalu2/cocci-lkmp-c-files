...
position p;
@@
 struct tegra186_xusb_padctl {  struct tegra_xusb_padctl base ;  struct tegra_xusb_fuse_calibration calib ;  struct clk * usb2_trk_clk ;  unsigned int bias_pad_enable ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_usb3_pad * cocci_id@p ;
...
typedef u32;
@@
 struct tegra_xusb_fuse_calibration {  u32 * hs_curr_level ;  u32 hs_squelch ;  u32 hs_term_range_adj ;  u32 rpd_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct tegra186_xusb_padctl * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_usb3_lane * cocci_id@p ;
