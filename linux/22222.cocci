...
position p;
@@
 struct memcg_cgwb_frn * cocci_id@p ;
...
position p;
@@
 struct zone_reclaim_stat * cocci_id@p ;
...
position p;
@@
 struct uncharge_gather * cocci_id@p ;
...
position p;
@@
 enum mc_target_type { MC_TARGET_NONE = 0 , MC_TARGET_PAGE , MC_TARGET_SWAP , MC_TARGET_DEVICE , } cocci_id@p ;
...
position p;
@@
 enum mem_cgroup_events_target cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_eventfd_list {  struct list_head list ;  struct eventfd_ctx * eventfd ; } cocci_id@p ;
...
position p;
@@
 enum charge_type { MEM_CGROUP_CHARGE_TYPE_CACHE = 0 , MEM_CGROUP_CHARGE_TYPE_ANON , MEM_CGROUP_CHARGE_TYPE_SWAPOUT , MEM_CGROUP_CHARGE_TYPE_DROP , NR_CHARGE_TYPE , } cocci_id@p ;
...
position p;
@@
 const struct uncharge_gather * cocci_id@p ;
...
position p;
@@
 struct oom_wait_info * cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_tree cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ NR_VM_EVENT_ITEMS ] ;
...
position p;
@@
 struct memcg_cache_array * cocci_id@p ;
...
position p;
@@
 const struct numa_stat cocci_id@p [ ] ;
...
position p;
@@
 struct mem_cgroup_reclaim_iter * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mem_cgroup * memcg ) ;
...
position p;
@@
 struct bdi_writeback * cocci_id@p ;
...
position p;
@@
 enum node_stat_item cocci_id@p ;
...
typedef spinlock_t;
@@
 struct mem_cgroup_tree_per_node {  struct rb_root rb_root ;  struct rb_node * rb_rightmost ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_event * cocci_id@p ;
...
position p;
@@
 struct numa_stat {  const char * name ;  unsigned int lru_mask ; } cocci_id@p ;
...
position p;
@@
 struct memcg_shrinker_map * cocci_id@p ;
...
position p;
@@
 enum { RES_USAGE , RES_LIMIT , RES_MAX_USAGE , RES_FAILCNT , RES_SOFT_LIMIT , } cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_tree_per_node * cocci_id@p ;
...
position p;
@@
 enum mem_cgroup_protection cocci_id@p ;
...
position p;
@@
 struct memcg_vmstats_percpu cocci_id@p ;
...
position p;
@@
 enum res_type { _MEM , _MEMSWAP , _OOM_TYPE , _KMEM , _TCP , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,wait_queue_entry_t;
@@
 struct mem_cgroup_event {  struct mem_cgroup * memcg ;  struct eventfd_ctx * eventfd ;  struct list_head list ;  int ( * register_event ) ( struct mem_cgroup * memcg , struct eventfd_ctx * eventfd , const char * args ) ;  void ( * unregister_event ) ( struct mem_cgroup * memcg , struct eventfd_ctx * eventfd ) ;  poll_table pt ;  wait_queue_head_t * wqh ;  wait_queue_entry_t wait ;  struct work_struct remove ; } cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_threshold cocci_id@p ;
...
position p;
@@
 struct page_counter * cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_thresholds * cocci_id@p ;
...
position p;
@@
 struct memcg_kmem_cache_create_work cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_reclaim_cookie * cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_per_node * cocci_id@p ;
...
position p;
@@
 struct memcg_kmem_cache_create_work {  struct mem_cgroup * memcg ;  struct kmem_cache * cachep ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_eventfd_list * cocci_id@p ;
...
position p;
@@
 struct memcg_stock_pcp * cocci_id@p ;
...
position p;
@@
 struct uncharge_gather {  struct mem_cgroup * memcg ;  unsigned long pgpgout ;  unsigned long nr_anon ;  unsigned long nr_file ;  unsigned long nr_kmem ;  unsigned long nr_huge ;  unsigned long nr_shmem ;  struct page * dummy_page ; } cocci_id@p ;
...
typedef wait_queue_entry_t;
@@
 struct oom_wait_info {  struct mem_cgroup * memcg ;  wait_queue_entry_t wait ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct task_struct * , void * ) ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,spinlock_t;
@@
 struct move_charge_struct {  spinlock_t lock ;  struct mm_struct * mm ;  struct mem_cgroup * from ;  struct mem_cgroup * to ;  unsigned long flags ;  unsigned long precharge ;  unsigned long moved_charge ;  unsigned long moved_swap ;  struct task_struct * moving_task ;  wait_queue_head_t waitq ; } cocci_id@p ;
...
position p;
@@
 struct css_task_iter cocci_id@p ;
...
position p;
@@
 enum oom_status { OOM_SUCCESS , OOM_FAILED , OOM_ASYNC , OOM_SKIPPED , } cocci_id@p ;
...
position p;
@@
 const struct mm_walk_ops cocci_id@p ;
...
position p;
@@
 const struct mem_cgroup_threshold * cocci_id@p ;
...
position p;
@@
 enum mc_target_type cocci_id@p ;
...
typedef swp_entry_t;
@@
 union mc_target {  struct page * page ;  swp_entry_t ent ; } cocci_id@p ;
...
position p;
@@
 struct mem_cgroup_threshold_ary * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ MEMCG_NR_STAT ] ;
...
position p;
@@
 struct mem_cgroup_tree {  struct mem_cgroup_tree_per_node * rb_tree_per_node [ MAX_NUMNODES ] ; } cocci_id@p ;
