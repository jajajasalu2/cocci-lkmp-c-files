...
position p;
@@
 const struct bm_buffer * cocci_id@p ;
...
position p;
@@
 const struct bman_pool * cocci_id@p ;
...
position p;
@@
 struct bm_mc_command * cocci_id@p ;
...
typedef u8;
@@
 struct bm_mc_command {  u8 _ncw_verb ;  u8 bpid ;  u8 __reserved [ 62 ] ; } cocci_id@p ;
...
position p;
@@
 struct bm_rcr_entry * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct bman_portal * p , u32 is ) ;
...
position p;
@@
 struct bm_addr {  void * ce ;  __be32 * ce_be ;  void __iomem * ci ; } cocci_id@p ;
...
position p;
@@
 enum bm_rcr_cmode { bm_rcr_cci , bm_rcr_cce , } cocci_id@p ;
...
typedef u32;
@@
 struct bman_pool {  u32 bpid ;  struct bman_portal * portal ;  struct bman_pool * next ; } cocci_id@p ;
...
position p;
@@
 struct bman_portal {  struct bm_portal p ;  unsigned long irq_sources ;  const struct bm_portal_config * config ;  char irqname [ MAX_IRQNAME ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct bm_rcr_entry {  union {  struct {  u8 _ncw_verb ;  u8 bpid ;  u8 __reserved1 [ 62 ] ; } ;  struct bm_buffer bufs [ 8 ] ; } ; } cocci_id@p ;
...
position p;
@@
 const struct bm_portal_config * cocci_id@p ;
...
position p;
@@
 const struct bman_portal * cocci_id@p ;
...
position p;
@@
 enum bm_rcr_pmode { bm_rcr_pci = 0 , bm_rcr_pce = 1 , bm_rcr_pvb = 2 , } cocci_id@p ;
...
typedef u8;
@@
 union bm_mc_result {  struct {  u8 verb ;  u8 bpid ;  u8 __reserved [ 62 ] ; } ;  struct bm_buffer bufs [ 8 ] ; } cocci_id@p ;
