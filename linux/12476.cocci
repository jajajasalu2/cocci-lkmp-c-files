...
typedef u16;
@@
 struct burst_levels {  u16 cb ;  u16 cr ; } cocci_id@p ;
...
@@
 struct tv_mode {  char * name ;  u32 mode ;  u32 chroma_freq ;  u16 back_porch ;  u16 front_porch ;  u16 line_number ;  u16 vblank_level ;  u32 hdisplay ;  u16 hfront_porch ;  u16 hsync_len ;  u16 hback_porch ;  u32 vdisplay ;  u16 vfront_porch ;  u16 vsync_len ;  u16 vback_porch ;  bool yc_en ;  bool dac3_en ;  bool dac_bit25_en ;  const struct color_gains * color_gains ;  const struct burst_levels * burst_levels ;  const struct video_levels * video_levels ;  const struct resync_parameters * resync_params ; } cocci_id@p ;
...
typedef u16;
@@
 struct video_levels {  u16 black ;  u16 blank ; } cocci_id@p ;
...
position p;
@@
 const struct video_levels cocci_id@p ;
...
typedef u16;
@@
 struct color_gains {  u16 cb ;  u16 cr ; } cocci_id@p ;
...
position p;
@@
 const struct tv_mode * cocci_id@p ;
...
position p;
@@
 struct sun4i_tv {  struct drm_connector connector ;  struct drm_encoder encoder ;  struct clk * clk ;  struct regmap * regs ;  struct reset_control * reset ;  struct sun4i_drv * drv ; } cocci_id@p ;
...
position p;
@@
 const struct color_gains cocci_id@p ;
...
typedef bool,u16;
@@
 struct resync_parameters {  bool field ;  u16 line ;  u16 pixel ; } cocci_id@p ;
...
position p;
@@
 const struct resync_parameters cocci_id@p ;
...
position p;
@@
 const struct burst_levels cocci_id@p ;
