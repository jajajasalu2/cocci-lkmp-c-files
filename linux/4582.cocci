...
position p;
@@
 struct mic_smpt_hw_info * cocci_id@p ;
...
position p;
@@
 struct mic_smpt_ops cocci_id@p ;
...
position p;
@@
 struct mic_hw_intr_ops cocci_id@p ;
...
position p;
@@
 struct mic_intr_info * cocci_id@p ;
