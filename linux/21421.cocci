...
position p;
@@
 struct fpsimd_last_state_struct {  struct user_fpsimd_state * st ;  void * sve_state ;  unsigned int sve_vl ; } cocci_id@p ;
...
position p;
@@
 const struct fpsimd_last_state_struct * cocci_id@p ;
...
position p;
@@
 struct fpsimd_last_state_struct * cocci_id@p ;
