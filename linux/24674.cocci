...
position p;
@@
 struct nft_counter_percpu_priv * cocci_id@p ;
...
typedef s64;
@@
 struct nft_counter {  s64 bytes ;  s64 packets ; } cocci_id@p ;
...
position p;
@@
 struct nft_counter_percpu_priv {  struct nft_counter __percpu * counter ; } cocci_id@p ;
