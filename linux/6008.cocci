...
position p;
@@
 struct cygnus_gpio_mux {  int is_supported ;  unsigned int offset ;  unsigned int shift ; } cocci_id@p ;
...
position p;
@@
 struct cygnus_mux_log * cocci_id@p ;
...
position p;
@@
 const struct cygnus_pin_group * cocci_id@p ;
...
position p;
@@
 const struct cygnus_mux * cocci_id@p ;
...
position p;
@@
 struct cygnus_pin {  unsigned pin ;  char * name ;  struct cygnus_gpio_mux gpio_mux ; } cocci_id@p ;
...
position p;
@@
 struct cygnus_pin_function {  const char * name ;  const char * const * groups ;  unsigned num_groups ; } cocci_id@p ;
...
position p;
@@
 const struct cygnus_pin_function cocci_id@p [ ] ;
...
position p;
@@
 const struct cygnus_gpio_mux * cocci_id@p ;
...
position p;
@@
 struct cygnus_gpio_mux * cocci_id@p ;
...
position p;
@@
 struct cygnus_mux {  unsigned int offset ;  unsigned int shift ;  unsigned int alt ; } cocci_id@p ;
...
position p;
@@
 struct cygnus_pinctrl * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct cygnus_pinctrl {  struct pinctrl_dev * pctl ;  struct device * dev ;  void __iomem * base0 ;  void __iomem * base1 ;  const struct cygnus_pin_group * groups ;  unsigned num_groups ;  const struct cygnus_pin_function * functions ;  unsigned num_functions ;  struct cygnus_mux_log * mux_log ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct cygnus_pin_group {  const char * name ;  const unsigned * pins ;  unsigned num_pins ;  struct cygnus_mux mux ; } cocci_id@p ;
...
typedef bool;
@@
 struct cygnus_mux_log {  struct cygnus_mux mux ;  bool is_configured ; } cocci_id@p ;
