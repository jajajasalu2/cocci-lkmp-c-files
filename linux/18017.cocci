...
position p;
@@
 enum { sym_vvar_start , sym_VDSO_FAKE_SECTION_TABLE_START , sym_VDSO_FAKE_SECTION_TABLE_END , } cocci_id@p ;
...
position p;
@@
 struct vdso_sym {  const char * name ;  int export ; } cocci_id@p ;
