...
position p;
@@
 struct mvs_slot_info * cocci_id@p ;
...
position p;
@@
 struct mvs_tmf_task cocci_id@p ;
...
position p;
@@
 struct mvs_prv_info * cocci_id@p ;
...
position p;
@@
 struct mvs_err_info cocci_id@p ;
...
position p;
@@
 struct mvs_task_exec_info * cocci_id@p ;
