...
position p;
@@
 struct ti_syscon_reset_data {  struct reset_controller_dev rcdev ;  struct regmap * regmap ;  struct ti_syscon_reset_control * controls ;  unsigned int nr_controls ; } cocci_id@p ;
...
typedef u32;
@@
 struct ti_syscon_reset_control {  unsigned int assert_offset ;  unsigned int assert_bit ;  unsigned int deassert_offset ;  unsigned int deassert_bit ;  unsigned int status_offset ;  unsigned int status_bit ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 struct ti_syscon_reset_control * cocci_id@p ;
...
position p;
@@
 struct ti_syscon_reset_data * cocci_id@p ;
