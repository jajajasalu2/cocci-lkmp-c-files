...
typedef u8;
@@
 struct adxl345_data {  struct regmap * regmap ;  u8 data_range ;  enum adxl345_device_type type ; } cocci_id@p ;
...
position p;
@@
 struct adxl345_data * cocci_id@p ;
...
position p;
@@
 enum adxl345_device_type cocci_id@p ;
