...
position p;
@@
 struct stih407_usb2_picophy * cocci_id@p ;
...
position p;
@@
 struct stih407_usb2_picophy {  struct phy * phy ;  struct regmap * regmap ;  struct device * dev ;  struct reset_control * rstc ;  struct reset_control * rstport ;  int ctrl ;  int param ; } cocci_id@p ;
