...
position p;
@@
 unsigned long cocci_id@p [ TMDNUM ] ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int ) ;
...
position p;
@@
 struct card {  unsigned char id0 , id1 ;  short id_offset ;  short total_size ;  short cmd_offset ;  short addr_offset ;  unsigned char * vendor_id ;  char * cardname ;  unsigned long config ; } cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int ) ;
...
position p;
@@
 struct sk_buff * cocci_id@p [ TMDNUM ] ;
...
position p;
@@
 void cocci_id@p ( struct priv * p , unsigned char * , int , int ) ;
