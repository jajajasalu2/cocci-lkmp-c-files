...
typedef bool;
@@
 int cocci_id@p ( struct regmap * map , unsigned int reg , unsigned int mask , unsigned int val , bool * change , bool force_write ) ;
...
position p;
@@
 struct regmap_range_node * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * context , unsigned int reg , unsigned int val ) ;
