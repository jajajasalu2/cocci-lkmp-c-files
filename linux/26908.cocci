...
position p;
@@
 struct afs_cb_interest * cocci_id@p ;
...
position p;
@@
 struct afs_status_cb cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * old_dir , struct dentry * old_dentry , struct inode * new_dir , struct dentry * new_dentry , unsigned int flags ) ;
...
position p;
@@
 struct afs_lookup_one_cookie * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * dir , struct dentry * dentry , const char * content ) ;
...
typedef bool;
@@
 struct afs_lookup_cookie {  struct dir_context ctx ;  struct qstr name ;  bool found ;  bool one_only ;  unsigned short nr_fids ;  struct inode * * inodes ;  struct afs_status_cb * statuses ;  struct afs_fid fids [ 50 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef afs_dataversion_t;
@@
 afs_dataversion_t cocci_id@p ;
...
position p;
@@
 struct dentry * cocci_id@p ( struct inode * dir , struct dentry * dentry , unsigned int flags ) ;
...
position p;
@@
 struct afs_lookup_cookie * cocci_id@p ;
...
position p;
@@
 struct afs_fs_cursor * cocci_id@p ;
...
typedef bool;
@@
 struct afs_lookup_one_cookie {  struct dir_context ctx ;  struct qstr name ;  bool found ;  struct afs_fid fid ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dentry * dentry , unsigned int flags ) ;
...
position p;
@@
 int cocci_id@p ( struct file * file , struct dir_context * ctx ) ;
...
position p;
@@
 struct afs_super_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct dentry * dentry ) ;
...
position p;
@@
 union afs_xdr_dirent cocci_id@p ;
...
position p;
@@
 struct afs_iget_data cocci_id@p ;
...
position p;
@@
 struct afs_xdr_dir_page * cocci_id@p ;
...
position p;
@@
 union afs_xdr_dir_block cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dentry * dentry , struct inode * inode ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * dir , struct dentry * dentry ) ;
...
position p;
@@
 struct afs_sysnames * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dentry * from , struct inode * dir , struct dentry * dentry ) ;
...
position p;
@@
 void cocci_id@p ( struct page * page , unsigned int offset , unsigned int length ) ;
