...
position p;
@@
 char cocci_id@p [ DEVLINK_FW_STRING_LEN ] ;
...
position p;
@@
 enum mlx5_devlink_param_id { MLX5_DEVLINK_PARAM_ID_BASE = DEVLINK_PARAM_GENERIC_ID_MAX , MLX5_DEVLINK_PARAM_FLOW_STEERING_MODE , } cocci_id@p ;
