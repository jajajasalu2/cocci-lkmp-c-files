...
@@
 struct l2tp_eth {  struct l2tp_session * session ;  atomic_long_t tx_bytes ;  atomic_long_t tx_packets ;  atomic_long_t tx_dropped ;  atomic_long_t rx_bytes ;  atomic_long_t rx_packets ;  atomic_long_t rx_errors ; } cocci_id@p ;
...
position p;
@@
 struct l2tp_eth_sess {  struct net_device __rcu * dev ; } cocci_id@p ;
...
position p;
@@
 struct l2tp_eth_sess * cocci_id@p ;
