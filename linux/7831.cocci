...
typedef u8;
@@
 struct preamble_cfg_sfr {  u8 timeout_symbols : 3 ;  u8 acquisition_symbols : 3 ;  u8 search_symbols : 2 ; } cocci_id@p ;
...
typedef u8;
@@
 struct hwme_set_confirm_pset {  u8 status ;  u8 hw_attribute ; } cocci_id@p ;
...
position p;
@@
 struct mcps_data_request_pset cocci_id@p ;
...
position p;
@@
 struct work_priv_container cocci_id@p ;
...
typedef u8;
@@
 struct hwme_get_confirm_pset {  u8 status ;  u8 hw_attribute ;  u8 hw_attribute_length ;  u8 hw_attribute_value [ MAX_HWME_ATTRIBUTE_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct ieee802154_hw_addr_filt * cocci_id@p ;
...
typedef u8;
@@
 struct tdme_setsfr_confirm_pset {  u8 status ;  u8 sfr_page ;  u8 sfr_address ; } cocci_id@p ;
...
typedef u8;
@@
 struct mcps_data_request_pset {  u8 src_addr_mode ;  struct fulladdr dst ;  u8 msdu_length ;  u8 msdu_handle ;  u8 tx_options ;  u8 msdu [ MAX_DATA_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct mlme_set_request_pset cocci_id@p ;
...
position p;
@@
 const struct wpan_phy_cca * cocci_id@p ;
...
typedef u8;
@@
 struct mlme_set_request_pset {  u8 pib_attribute ;  u8 pib_attribute_index ;  u8 pib_attribute_length ;  u8 pib_attribute_value [ MAX_ATTRIBUTE_SIZE ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct hwme_set_request_pset {  u8 hw_attribute ;  u8 hw_attribute_length ;  u8 hw_attribute_value [ MAX_HWME_ATTRIBUTE_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct ca8210_platform_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct spi_device * spi_device ) ;
...
@@
 struct ca8210_test {  struct dentry * ca8210_dfs_spi_int ;  struct kfifo up_fifo ;  wait_queue_head_t readq ; } cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ CA8210_MAX_ED_LEVELS ] ;
...
typedef u8,u16;
@@
 union macaddr {  u16 short_address ;  u8 ieee_address [ 8 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct cas_control {  struct spi_message msg ;  struct spi_transfer transfer ;  u8 tx_buf [ CA8210_SPI_BUF_SIZE ] ;  u8 tx_in_buf [ CA8210_SPI_BUF_SIZE ] ;  struct ca8210_priv * priv ; } cocci_id@p ;
...
typedef u8;
@@
 struct fulladdr {  u8 mode ;  u8 pan_id [ 2 ] ;  u8 address [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct preamble_cfg_sfr cocci_id@p ;
...
typedef u8;
@@
 union pa_cfg_sfr {  struct {  u8 bias_current_trim : 3 ;  u8 : 1 ;  u8 buffer_capacitor_trim : 3 ;  u8 boost : 1 ; } ;  u8 paib ; } cocci_id@p ;
...
position p;
@@
 struct ieee802154_hw * cocci_id@p ;
...
typedef u8;
@@
 struct hwme_get_request_pset {  u8 hw_attribute ; } cocci_id@p ;
...
typedef u8;
@@
 struct mac_message {  u8 command_id ;  u8 length ;  union {  struct mcps_data_request_pset data_req ;  struct mlme_set_request_pset set_req ;  struct hwme_set_request_pset hwme_set_req ;  struct hwme_get_request_pset hwme_get_req ;  struct tdme_setsfr_request_pset tdme_set_sfr_req ;  struct hwme_set_confirm_pset hwme_set_cnf ;  struct hwme_get_confirm_pset hwme_get_cnf ;  struct tdme_setsfr_confirm_pset tdme_set_sfr_cnf ;  u8 u8param ;  u8 status ;  u8 payload [ 148 ] ; } pdata ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CA8210_SPI_BUF_SIZE ] ;
...
typedef u8;
@@
 struct tdme_setsfr_request_pset {  u8 sfr_page ;  u8 sfr_address ;  u8 sfr_value ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p ( u8 set_default_pib , void * device_ref ) ;
...
typedef s32;
@@
 const s32 cocci_id@p [ CA8210_MAX_TX_POWERS ] ;
...
position p;
@@
 struct ieee802154_hdr cocci_id@p ;
...
position p;
@@
 const struct ieee802154_ops cocci_id@p ;
...
position p;
@@
 struct work_priv_container {  struct work_struct work ;  struct ca8210_priv * priv ; } cocci_id@p ;
...
typedef u8;
@@
 struct secspec {  u8 security_level ;  u8 key_id_mode ;  u8 key_source [ 8 ] ;  u8 key_index ; } cocci_id@p ;
...
typedef bool;
@@
 struct ca8210_platform_data {  bool extclockenable ;  unsigned int extclockfreq ;  unsigned int extclockgpio ;  int gpio_reset ;  int gpio_irq ;  int irq_id ; } cocci_id@p ;
