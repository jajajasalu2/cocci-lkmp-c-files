...
position p;
@@
 const struct vbva_buffer * cocci_id@p ;
...
position p;
@@
 struct vbva_enable_ex * cocci_id@p ;
...
position p;
@@
 struct vbva_buf_ctx * cocci_id@p ;
