...
position p;
@@
 struct netxen_nic_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
...
position p;
@@
 struct netxen_minidump * cocci_id@p ;
...
position p;
@@
 const struct netxen_nic_stats cocci_id@p [ ] ;
