...
position p;
@@
 struct sockaddr_alg * cocci_id@p ;
...
position p;
@@
 struct af_alg_control * cocci_id@p ;
...
position p;
@@
 struct alg_type_list {  const struct af_alg_type * type ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct af_alg_async_req * cocci_id@p ;
...
position p;
@@
 const struct af_alg_ctx * cocci_id@p ;
...
position p;
@@
 const struct af_alg_tsgl * cocci_id@p ;
...
position p;
@@
 struct alg_type_list * cocci_id@p ;
...
position p;
@@
 const struct alg_sock * cocci_id@p ;
...
position p;
@@
 const struct af_alg_type * cocci_id@p ;
