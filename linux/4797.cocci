...
position p;
@@
 char cocci_id@p [ IB_DEVICE_NAME_MAX ] ;
...
position p;
@@
 int cocci_id@p ( struct ib_device * device , struct net * cur_net , struct net * net ) ;
...
position p;
@@
 void cocci_id@p ( struct ib_device * ib_dev ) ;
...
position p;
@@
 struct ib_port_data * cocci_id@p ;
...
position p;
@@
 struct ib_compat_device * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ib_device * ) ;
...
position p;
@@
 struct ib_core_device * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * nb , unsigned long event , void * lsm_data ) ;
...
position p;
@@
 struct rdma_dev_net * cocci_id@p ;
...
position p;
@@
 struct ib_port_data_rcu cocci_id@p ;
...
position p;
@@
 const struct rdma_nl_cbs cocci_id@p [ RDMA_NL_LS_NUM_OPS ] ;
...
position p;
@@
 const struct {  size_t offset ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 enum rdma_driver_id cocci_id@p ;
...
position p;
@@
 roce_netdev_callback cocci_id@p ;
...
position p;
@@
 struct ib_port_data_rcu {  struct rcu_head rcu_head ;  struct ib_port_data pdata [ ] ; } cocci_id@p ;
...
position p;
@@
 struct ib_device_ops * cocci_id@p ;
