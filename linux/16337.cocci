...
position p;
@@
 enum { CH_RX , CH_TX , NUM_CHANNELS , } cocci_id@p ;
...
typedef bool;
@@
 struct hdm_i2c {  struct most_interface most_iface ;  struct most_channel_capability capabilities [ NUM_CHANNELS ] ;  struct i2c_client * client ;  struct rx {  struct delayed_work dwork ;  struct list_head list ;  bool int_disabled ;  unsigned int delay ; } rx ;  char name [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_BUF_SIZE_CONTROL ] ;
