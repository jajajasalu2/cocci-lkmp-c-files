...
position p;
@@
 struct dispc_irq_stats {  unsigned long last_reset ;  unsigned irq_count ;  unsigned irqs [ 32 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,omap_dispc_isr_t;
@@
 struct omap_dispc_isr_data {  omap_dispc_isr_t isr ;  void * arg ;  u32 mask ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef omap_dispc_isr_t;
@@
 omap_dispc_isr_t cocci_id@p ;
...
position p;
@@
 struct omap_dispc_isr_data * cocci_id@p ;
...
position p;
@@
 struct dispc_irq_stats cocci_id@p ;
...
position p;
@@
 struct omap_dispc_isr_data cocci_id@p [ DISPC_MAX_NR_ISRS ] ;
