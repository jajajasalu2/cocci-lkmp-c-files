...
position p;
@@
 struct revmap_entry cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( struct kvm * kvm , unsigned long flags , long pte_index , unsigned long pteh , unsigned long ptel , unsigned long * pte_idx_ret ) ;
...
typedef u32;
@@
 struct kvm_resize_hpt {  struct kvm * kvm ;  struct work_struct work ;  u32 order ;  int error ;  struct kvm_hpt_info hpt ; } cocci_id@p ;
...
position p;
@@
 struct kvm_resize_hpt * cocci_id@p ;
...
position p;
@@
 struct debugfs_htab_state * cocci_id@p ;
...
position p;
@@
 struct kvm_get_htab_header cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct kvm * kvm , struct kvm_memory_slot * memslot , unsigned long gfn ) ;
...
position p;
@@
 struct kvm_htab_ctx * cocci_id@p ;
...
position p;
@@
 struct debugfs_htab_state {  struct kvm * kvm ;  struct mutex mutex ;  unsigned long hpt_index ;  int chars_left ;  int buf_index ;  char buf [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 struct kvm_htab_ctx {  unsigned long index ;  unsigned long flags ;  struct kvm * kvm ;  int first_pass ; } cocci_id@p ;
