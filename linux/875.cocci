...
position p;
@@
 struct meson_nfc_nand_chip * cocci_id@p ;
...
position p;
@@
 struct meson_nand_ecc cocci_id@p [ ] ;
...
position p;
@@
 enum { NFC_ECC_BCH8_1K = 2 , NFC_ECC_BCH24_1K , NFC_ECC_BCH30_1K , NFC_ECC_BCH40_1K , NFC_ECC_BCH50_1K , NFC_ECC_BCH60_1K , } cocci_id@p ;
...
position p;
@@
 struct meson_nfc_data {  const struct nand_ecc_caps * ecc_caps ; } cocci_id@p ;
...
typedef u32;
@@
 struct nand_timing {  u32 twb ;  u32 tadl ;  u32 tbers_max ; } cocci_id@p ;
...
typedef u32;
@@
 struct meson_nfc_param {  u32 chip_select ;  u32 rb_select ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,__le64;
@@
 struct meson_nfc_nand_chip {  struct list_head node ;  struct nand_chip nand ;  unsigned long clk_rate ;  unsigned long level1_divider ;  u32 bus_timing ;  u32 twb ;  u32 tadl ;  u32 tbers_max ;  u32 bch_mode ;  u8 * data_buf ;  __le64 * info_buf ;  u32 nsels ;  u8 sels [ 0 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct meson_nand_ecc {  u32 bch ;  u32 strength ; } cocci_id@p ;
...
@@
 struct meson_nfc {  struct nand_controller controller ;  struct clk * core_clk ;  struct clk * device_clk ;  struct clk * phase_tx ;  struct clk * phase_rx ;  unsigned long clk_rate ;  u32 bus_timing ;  struct device * dev ;  void __iomem * reg_base ;  struct regmap * reg_clk ;  struct completion completion ;  struct list_head chips ;  const struct meson_nfc_data * data ;  struct meson_nfc_param param ;  struct nand_timing timing ;  union {  int cmd [ 32 ] ;  struct nand_rw_cmd rw ; } cmdfifo ;  dma_addr_t daddr ;  dma_addr_t iaddr ;  unsigned long assigned_cs ; } cocci_id@p ;
...
typedef u32;
@@
 struct nand_rw_cmd {  u32 cmd0 ;  u32 addrs [ MAX_CYCLE_ADDRS ] ;  u32 cmd1 ; } cocci_id@p ;
...
position p;
@@
 const struct meson_nfc_data cocci_id@p ;
