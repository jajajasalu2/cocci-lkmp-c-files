...
position p;
@@
 struct gfar_irqinfo cocci_id@p ;
...
position p;
@@
 struct gfar_priv_grp cocci_id@p ;
...
position p;
@@
 struct gfar_rx_buff * cocci_id@p ;
...
position p;
@@
 struct gfar_extra_stats * cocci_id@p ;
