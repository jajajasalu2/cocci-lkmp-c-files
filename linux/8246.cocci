...
position p;
@@
 enum cpdma_state { CPDMA_STATE_IDLE , CPDMA_STATE_ACTIVE , CPDMA_STATE_TEARDOWN , } cocci_id@p ;
...
position p;
@@
 struct cpdma_control_info * cocci_id@p ;
...
position p;
@@
 struct cpdma_params * cocci_id@p ;
...
position p;
@@
 struct cpdma_desc_pool * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct submit_info {  struct cpdma_chan * chan ;  int directed ;  void * token ;  void * data_virt ;  dma_addr_t data_dma ;  int len ; } cocci_id@p ;
...
typedef u32;
@@
 struct cpdma_desc {  u32 hw_next ;  u32 hw_buffer ;  u32 hw_len ;  u32 hw_mode ;  void * sw_token ;  u32 sw_buffer ;  u32 sw_len ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct cpdma_ctlr {  enum cpdma_state state ;  struct cpdma_params params ;  struct device * dev ;  struct cpdma_desc_pool * pool ;  spinlock_t lock ;  struct cpdma_chan * channels [ 2 * CPDMA_MAX_CHANNELS ] ;  int chan_num ;  int num_rx_desc ;  int num_tx_desc ; } cocci_id@p ;
...
position p;
@@
 struct cpdma_chan_stats * cocci_id@p ;
