...
position p;
@@
 struct smb_com_lock_req * cocci_id@p ;
...
position p;
@@
 struct file_notify_information * cocci_id@p ;
...
position p;
@@
 struct dfs_referral_level_3 * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction_change_notify_rsp * cocci_id@p ;
