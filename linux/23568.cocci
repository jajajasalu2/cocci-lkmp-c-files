...
typedef u8;
@@
 struct skl_debug {  struct skl_dev * skl ;  struct device * dev ;  struct dentry * fs ;  struct dentry * modules ;  u8 fw_read_buff [ FW_REG_BUF ] ; } cocci_id@p ;
