...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_PEDIT_MAX + 1 ] ;
...
position p;
@@
 struct tc_pedit_key * cocci_id@p ;
...
position p;
@@
 struct tcf_pedit_key_ex * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_PEDIT_KEY_EX_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_PEDIT_KEY_EX_MAX + 1 ] ;
...
position p;
@@
 enum pedit_header_type cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_PEDIT_MAX + 1 ] ;
