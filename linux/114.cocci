...
symbol cocci_id;
position p;
typedef rt_rq_iter_t;
@@
 rt_rq_iter_t cocci_id@p ;
...
position p;
@@
 struct rt_bandwidth cocci_id@p ;
...
position p;
@@
 struct rt_schedulable_data cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rq * this_rq ) ;
...
position p;
@@
 int cocci_id@p ( struct rt_bandwidth * rt_b , int overrun ) ;
...
position p;
@@
 typeof ( struct task_group ) cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct task_struct * task ) ;
...
position p;
@@
 struct rt_prio_array * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sched_rt_entity * rt_se , unsigned int flags ) ;
...
position p;
@@
 void cocci_id@p ( struct rt_rq * rt_rq ) ;
...
typedef u64;
@@
 struct rt_schedulable_data {  struct task_group * tg ;  u64 rt_period ;  u64 rt_runtime ; } cocci_id@p ;
