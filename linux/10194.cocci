...
position p;
@@
 enum { W6692_ASUS , W6692_WINBOND , W6692_USR , } cocci_id@p ;
...
@@
 struct w6692_hw {  struct list_head list ;  struct pci_dev * pdev ;  char name [ MISDN_MAX_IDLEN ] ;  u32 irq ;  u32 irqcnt ;  u32 addr ;  u32 fmask ;  int subtype ;  spinlock_t lock ;  u8 imask ;  u8 pctl ;  u8 xaddr ;  u8 xdata ;  u8 state ;  struct w6692_ch bc [ 2 ] ;  struct dchannel dch ;  char log [ 64 ] ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct w6692_ch {  struct bchannel bch ;  u32 addr ;  struct timer_list timer ;  u8 b_mode ; } cocci_id@p ;
...
position p;
@@
 const struct w6692map cocci_id@p [ ] ;
...
typedef u_int;
@@
 struct w6692map {  u_int subtype ;  char * name ; } cocci_id@p ;
