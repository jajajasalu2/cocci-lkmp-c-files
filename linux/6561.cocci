...
symbol cocci_id;
position p;
typedef u32,adpt_wait_queue_head_t;
@@
 struct adpt_i2o_post_wait_data {  int status ;  u32 id ;  adpt_wait_queue_head_t * wq ;  struct adpt_i2o_post_wait_data * next ; } cocci_id@p ;
...
position p;
@@
 struct sg_simple_element * cocci_id@p ;
...
position p;
@@
 struct adpt_i2o_post_wait_data * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MAX_MESSAGE_SIZE ] ;
...
position p;
@@
 struct i2o_sys_tbl_entry cocci_id@p ;
