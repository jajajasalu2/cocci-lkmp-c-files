...
position p;
@@
 struct s3fwrn5_i2c_phy {  struct i2c_client * i2c_dev ;  struct nci_dev * ndev ;  unsigned int gpio_en ;  unsigned int gpio_fw_wake ;  struct mutex mutex ;  enum s3fwrn5_mode mode ;  unsigned int irq_skip : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct s3fwrn5_phy_ops cocci_id@p ;
...
position p;
@@
 struct s3fwrn5_i2c_phy * cocci_id@p ;
