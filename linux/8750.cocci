...
position p;
@@
 struct vport_start_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct eth_slow_path_rx_cqe * cocci_id@p ;
...
position p;
@@
 struct rx_queue_update_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_eth_stats cocci_id@p ;
...
position p;
@@
 struct qed_ntuple_filter_params * cocci_id@p ;
...
position p;
@@
 const struct qed_eth_ptp_ops cocci_id@p ;
...
position p;
@@
 struct eth_vport_rss_config * cocci_id@p ;
...
position p;
@@
 struct qed_filter_mcast cocci_id@p ;
...
position p;
@@
 struct vport_update_ramrod_mcast * cocci_id@p ;
...
position p;
@@
 struct qed_eth_stats_ah * cocci_id@p ;
...
position p;
@@
 struct vport_update_ramrod_data_cmn * cocci_id@p ;
...
position p;
@@
 struct qed_spq_comp_cb cocci_id@p ;
...
position p;
@@
 struct eth_vport_tpa_param * cocci_id@p ;
...
position p;
@@
 struct vport_filter_update_ramrod_data * * cocci_id@p ;
...
position p;
@@
 struct vport_update_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct vport_stop_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_eth_stats_bb * cocci_id@p ;
...
position p;
@@
 enum qed_filter_rx_mode_type cocci_id@p ;
...
position p;
@@
 struct qed_update_vport_params * cocci_id@p ;
...
position p;
@@
 struct qed_arfs_config_params * cocci_id@p ;
...
position p;
@@
 struct tx_queue_start_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_tunn_params * cocci_id@p ;
...
position p;
@@
 struct qed_update_vport_rss_params * cocci_id@p ;
...
position p;
@@
 struct eth_filter_cmd * cocci_id@p ;
...
position p;
@@
 enum gft_profile_type cocci_id@p ;
...
position p;
@@
 const struct qed_eth_dcbnl_ops cocci_id@p ;
...
position p;
@@
 struct qed_common_cb_ops * cocci_id@p ;
...
position p;
@@
 struct tstorm_per_port_stat cocci_id@p ;
...
position p;
@@
 struct eth_filter_cmd_header * cocci_id@p ;
...
position p;
@@
 struct rx_update_gft_filter_data * cocci_id@p ;
...
position p;
@@
 const struct qed_eth_ops * cocci_id@p ;
...
typedef u32;
@@
 struct qed_l2_info {  u32 queues ;  unsigned long * * pp_qid_usage ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 enum eth_filter_action cocci_id@p ;
...
position p;
@@
 struct qed_txq_start_ret_params * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ETH_MULTICAST_MAC_BINS_IN_REGS ] ;
...
position p;
@@
 struct qed_filter_ucast_params * cocci_id@p ;
...
position p;
@@
 struct rx_queue_stop_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_eth_stats_common * cocci_id@p ;
...
position p;
@@
 enum qed_filter_config_mode cocci_id@p ;
...
position p;
@@
 struct qed_dev_eth_info * cocci_id@p ;
...
position p;
@@
 struct qed_rxq_start_ret_params * cocci_id@p ;
...
position p;
@@
 struct qed_filter_mcast_params * cocci_id@p ;
...
position p;
@@
 struct rx_queue_start_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_filter_params * cocci_id@p ;
...
position p;
@@
 struct qed_start_vport_params * cocci_id@p ;
