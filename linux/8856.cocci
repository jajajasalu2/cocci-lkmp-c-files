...
symbol cocci_id;
position p;
typedef bool,phy_interface_t;
@@
 struct mediatek_dwmac_plat_data {  const struct mediatek_dwmac_variant * variant ;  struct mac_delay_struct mac_delay ;  struct clk_bulk_data * clks ;  struct device_node * np ;  struct regmap * peri_regmap ;  struct device * dev ;  phy_interface_t phy_mode ;  bool rmii_rxc ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct mac_delay_struct {  u32 tx_delay ;  u32 rx_delay ;  bool tx_inv ;  bool rx_inv ; } cocci_id@p ;
...
position p;
@@
 struct mac_delay_struct * cocci_id@p ;
...
position p;
@@
 const struct mediatek_dwmac_variant * cocci_id@p ;
...
position p;
@@
 struct mediatek_dwmac_plat_data * cocci_id@p ;
...
typedef u32;
@@
 struct mediatek_dwmac_variant {  int ( * dwmac_set_phy_interface ) ( struct mediatek_dwmac_plat_data * plat ) ;  int ( * dwmac_set_delay ) ( struct mediatek_dwmac_plat_data * plat ) ;  const char * const * clk_list ;  int num_clks ;  u32 dma_bit_mask ;  u32 rx_delay_max ;  u32 tx_delay_max ; } cocci_id@p ;
...
position p;
@@
 struct stmmac_resources cocci_id@p ;
...
position p;
@@
 struct plat_stmmacenet_data * cocci_id@p ;
