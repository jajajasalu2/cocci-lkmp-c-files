...
position p;
@@
 const struct max2175_reg_map cocci_id@p [ ] ;
...
position p;
@@
 enum max2175_csm_mode cocci_id@p ;
...
typedef u8;
@@
 struct max2175_reg_map {  u8 idx ;  u8 val ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct max2175_rxmode {  enum max2175_band band ;  u32 freq ;  u8 i2s_word_size ; } cocci_id@p ;
...
position p;
@@
 const struct max2175_rxmode cocci_id@p [ ] ;
...
typedef u8,bool,u32;
@@
 struct max2175 {  struct v4l2_subdev sd ;  struct i2c_client * client ;  struct v4l2_ctrl_handler ctrl_hdl ;  struct v4l2_ctrl * lna_gain ;  struct v4l2_ctrl * if_gain ;  struct v4l2_ctrl * pll_lock ;  struct v4l2_ctrl * i2s_en ;  struct v4l2_ctrl * hsls ;  struct v4l2_ctrl * rx_mode ;  struct regmap * regmap ;  u32 freq ;  const struct max2175_rxmode * rx_modes ;  const struct v4l2_frequency_band * bands_rf ;  unsigned long xtal_freq ;  u32 decim_ratio ;  bool master ;  bool am_hiz ;  u8 rom_bbf_bw_am ;  u8 rom_bbf_bw_fm ;  u8 rom_bbf_bw_dab ;  bool mode_resolved ; } cocci_id@p ;
