...
typedef u32;
@@
 struct ov5695_mode {  u32 width ;  u32 height ;  u32 max_fps ;  u32 hts_def ;  u32 vts_def ;  u32 exp_def ;  const struct regval * reg_list ; } cocci_id@p ;
...
position p;
@@
 const struct ov5695_mode * cocci_id@p ;
