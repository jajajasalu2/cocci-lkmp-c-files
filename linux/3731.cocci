...
position p;
@@
 union cptx_vqx_inprog cocci_id@p ;
...
position p;
@@
 union cptx_vqx_saddr cocci_id@p ;
...
typedef u32;
@@
 struct cptvf_wqe {  struct tasklet_struct twork ;  void * cptvf ;  u32 qno ; } cocci_id@p ;
...
position p;
@@
 struct cptvf_wqe_info {  struct cptvf_wqe vq_wqe [ CPT_NUM_QS_PER_VF ] ; } cocci_id@p ;
...
position p;
@@
 struct pending_queue * cocci_id@p ;
...
position p;
@@
 struct command_queue * cocci_id@p ;
...
position p;
@@
 struct pending_qinfo * cocci_id@p ;
...
position p;
@@
 struct cptvf_wqe_info * cocci_id@p ;
...
position p;
@@
 union cptx_vqx_doorbell cocci_id@p ;
...
position p;
@@
 union cptx_vqx_misc_int cocci_id@p ;
...
position p;
@@
 union cptx_vqx_misc_ena_w1s cocci_id@p ;
...
position p;
@@
 struct command_chunk * cocci_id@p ;
...
position p;
@@
 struct pending_entry cocci_id@p ;
...
position p;
@@
 struct command_qinfo * cocci_id@p ;
...
position p;
@@
 union cptx_vqx_done cocci_id@p ;
...
position p;
@@
 union cptx_vqx_done_ena_w1s cocci_id@p ;
...
position p;
@@
 union cptx_vqx_done_ack cocci_id@p ;
...
position p;
@@
 union cptx_vqx_done_wait cocci_id@p ;
