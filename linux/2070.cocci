...
position p;
@@
 struct ltc2983_thermistor cocci_id@p ;
...
position p;
@@
 struct ltc2983_thermocouple * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,u16,__be32;
@@
 struct ltc2983_data {  struct regmap * regmap ;  struct spi_device * spi ;  struct mutex lock ;  struct completion completion ;  struct iio_chan_spec * iio_chan ;  struct ltc2983_sensor * * sensors ;  u32 mux_delay_config ;  u32 filter_notch_freq ;  u16 custom_table_size ;  u8 num_channels ;  u8 iio_channels ;  __be32 temp ____cacheline_aligned ; } cocci_id@p ;
...
typedef bool;
@@
 struct ltc2983_adc {  struct ltc2983_sensor sensor ;  bool single_ended ; } cocci_id@p ;
...
position p;
@@
 enum { LTC2983_SENSOR_THERMOCOUPLE = 1 , LTC2983_SENSOR_THERMOCOUPLE_CUSTOM = 9 , LTC2983_SENSOR_RTD = 10 , LTC2983_SENSOR_RTD_CUSTOM = 18 , LTC2983_SENSOR_THERMISTOR = 19 , LTC2983_SENSOR_THERMISTOR_STEINHART = 26 , LTC2983_SENSOR_THERMISTOR_CUSTOM = 27 , LTC2983_SENSOR_DIODE = 28 , LTC2983_SENSOR_SENSE_RESISTOR = 29 , LTC2983_SENSOR_DIRECT_ADC = 30 , } cocci_id@p ;
...
typedef u32;
@@
 struct ltc2983_rsense {  struct ltc2983_sensor sensor ;  u32 r_sense_val ; } cocci_id@p ;
...
position p;
@@
 struct ltc2983_rsense * cocci_id@p ;
...
typedef s8,u8,bool;
@@
 struct ltc2983_custom_sensor {  u8 * table ;  size_t size ;  s8 offset ;  bool is_steinhart ; } cocci_id@p ;
...
position p;
@@
 const struct ltc2983_sensor * cocci_id@p ;
...
position p;
@@
 const struct device * cocci_id@p ;
...
position p;
@@
 struct ltc2983_sensor cocci_id@p ;
...
position p;
@@
 struct ltc2983_diode cocci_id@p ;
...
typedef u32;
@@
 struct ltc2983_thermistor {  struct ltc2983_sensor sensor ;  struct ltc2983_custom_sensor * custom ;  u32 sensor_config ;  u32 r_sense_chan ;  u32 excitation_current ; } cocci_id@p ;
...
position p;
@@
 const struct device_node * cocci_id@p ;
...
typedef u32;
@@
 struct ltc2983_thermocouple {  struct ltc2983_sensor sensor ;  struct ltc2983_custom_sensor * custom ;  u32 sensor_config ;  u32 cold_junction_chan ; } cocci_id@p ;
...
position p;
@@
 const struct spi_device_id cocci_id@p [ ] ;
...
typedef u32;
@@
 struct ltc2983_rtd {  struct ltc2983_sensor sensor ;  struct ltc2983_custom_sensor * custom ;  u32 sensor_config ;  u32 r_sense_chan ;  u32 excitation_current ;  u32 rtd_curve ; } cocci_id@p ;
...
position p;
@@
 const struct regmap_access_table cocci_id@p ;
...
position p;
@@
 const struct ltc2983_data * cocci_id@p ;
...
position p;
@@
 const struct regmap_range cocci_id@p [ ] ;
...
position p;
@@
 struct ltc2983_data * cocci_id@p ;
...
typedef u32;
@@
 struct ltc2983_diode {  struct ltc2983_sensor sensor ;  u32 sensor_config ;  u32 excitation_current ;  u32 ideal_factor_value ; } cocci_id@p ;
...
position p;
@@
 struct ltc2983_custom_sensor * cocci_id@p ;
