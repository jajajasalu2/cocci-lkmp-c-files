...
position p;
@@
 struct usb_onetouch * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * onetouch_ ) ;
...
typedef dma_addr_t;
@@
 struct usb_onetouch {  char name [ 128 ] ;  char phys [ 64 ] ;  struct input_dev * dev ;  struct usb_device * udev ;  struct urb * irq ;  unsigned char * data ;  dma_addr_t data_dma ;  unsigned int is_open : 1 ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct us_data * ss ) ;
