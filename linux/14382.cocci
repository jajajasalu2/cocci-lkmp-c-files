...
typedef u8;
@@
 struct cxd2880_tnrdmd_ts_clk_cfg {  u8 srl_clk_mode ;  u8 srl_duty_mode ;  u8 ts_clk_period ; } cocci_id@p ;
...
position p;
@@
 enum cxd2880_io_tgt cocci_id@p ;
...
position p;
@@
 struct cxd2880_tnrdmd_lna_thrs_tbl_cable * cocci_id@p ;
...
position p;
@@
 enum cxd2880_tnrdmd_cfg_id cocci_id@p ;
...
position p;
@@
 enum cxd2880_tnrdmd_gpio_mode cocci_id@p ;
...
position p;
@@
 struct cxd2880_tnrdmd_lna_thrs_tbl_air * cocci_id@p ;
...
position p;
@@
 const struct cxd2880_reg_value cocci_id@p [ ] ;
...
position p;
@@
 struct cxd2880_tnrdmd_ts_clk_cfg cocci_id@p ;
...
position p;
@@
 enum cxd2880_tnrdmd_clockmode cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct cxd2880_tnrdmd * , int * ) ;
...
position p;
@@
 struct cxd2880_tnrdmd_pid_ftr_cfg * cocci_id@p ;
...
position p;
@@
 const struct cxd2880_tnrdmd_ts_clk_cfg cocci_id@p [ 2 ] [ 2 ] ;
...
position p;
@@
 enum cxd2880_dtv_sys cocci_id@p ;
...
position p;
@@
 struct cxd2880_tnrdmd_diver_create_param * cocci_id@p ;
...
position p;
@@
 enum cxd2880_tnrdmd_serial_ts_clk cocci_id@p ;
