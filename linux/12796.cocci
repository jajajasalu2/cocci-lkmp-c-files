...
position p;
@@
 struct intel_th_channel cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct sth_device {  void __iomem * base ;  void __iomem * channels ;  phys_addr_t channels_phys ;  struct device * dev ;  struct stm_data stm ;  unsigned int sw_nmasters ; } cocci_id@p ;
