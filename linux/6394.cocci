...
position p;
@@
 struct vctrl_voltage_range * cocci_id@p ;
...
typedef bool;
@@
 struct vctrl_data {  struct regulator_dev * rdev ;  struct regulator_desc desc ;  struct regulator * ctrl_reg ;  bool enabled ;  unsigned int min_slew_down_rate ;  unsigned int ovp_threshold ;  struct vctrl_voltage_ranges vrange ;  struct vctrl_voltage_table * vtable ;  unsigned int sel ; } cocci_id@p ;
...
position p;
@@
 const struct vctrl_voltage_table * cocci_id@p ;
...
position p;
@@
 struct vctrl_voltage_range {  int min_uV ;  int max_uV ; } cocci_id@p ;
...
position p;
@@
 struct vctrl_voltage_ranges {  struct vctrl_voltage_range ctrl ;  struct vctrl_voltage_range out ; } cocci_id@p ;
...
position p;
@@
 struct vctrl_voltage_table cocci_id@p ;
...
position p;
@@
 struct vctrl_voltage_table {  int ctrl ;  int out ;  int ovp_min_sel ; } cocci_id@p ;
