...
position p;
@@
 struct ttl_control_regs {  __be16 portc ;  __be16 portb ;  __be16 porta ;  __be16 control ; } cocci_id@p ;
...
@@
 struct ttl_module {  struct gpio_chip gpio ;  struct ttl_control_regs __iomem * regs ;  u8 portc_shadow ;  u8 portb_shadow ;  u8 porta_shadow ;  spinlock_t lock ; } cocci_id@p ;
