...
position p;
@@
 int cocci_id@p [ EKTF2127_MAX_TOUCHES ] ;
...
position p;
@@
 struct ektf2127_ts {  struct i2c_client * client ;  struct input_dev * input ;  struct gpio_desc * power_gpios ;  struct touchscreen_properties prop ; } cocci_id@p ;
...
position p;
@@
 struct input_mt_pos cocci_id@p [ EKTF2127_MAX_TOUCHES ] ;
...
position p;
@@
 char cocci_id@p [ EKTF2127_TOUCH_REPORT_SIZE ] ;
