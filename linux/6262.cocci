...
typedef u8;
@@
 u8 cocci_id@p [ MAX8997_NUM_GPIO ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX8997_IRQ_GROUP_NR ] ;
...
position p;
@@
 const struct max8997_irq_data * cocci_id@p ;
...
position p;
@@
 struct max8997_irq_data {  int mask ;  enum max8997_irq_source group ; } cocci_id@p ;
...
position p;
@@
 enum max8997_irq_source cocci_id@p ;
