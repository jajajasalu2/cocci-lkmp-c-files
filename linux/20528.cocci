...
typedef u8,bool;
@@
 void cocci_id@p ( struct bf_ctx * ctx , u8 * dst , const u8 * src , bool xor ) ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( struct bf_ctx * , u8 * , const u8 * ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct bf_ctx * ctx , u8 * dst , const u8 * src ) ;
