...
position p;
@@
 struct fwserial_unit_directory_data cocci_id@p ;
...
position p;
@@
 struct fwserial_mgmt_pkt cocci_id@p ;
...
position p;
@@
 struct fwtty_transaction cocci_id@p ;
...
position p;
@@
 struct fwtty_port * cocci_id@p [ MAX_TOTAL_PORTS ] ;
...
position p;
@@
 struct fwtty_transaction {  struct fw_transaction fw_txn ;  fwtty_transaction_cb callback ;  struct fwtty_port * port ;  union {  struct dma_pending dma_pended ; } ; } cocci_id@p ;
...
position p;
@@
 fwtty_transaction_cb cocci_id@p ;
...
position p;
@@
 struct fw_address_handler cocci_id@p ;
...
position p;
@@
 struct fwtty_peer * cocci_id@p ( struct fw_card * card , 
										  int generation , 
										  int id ) ;
...
position p;
@@
 struct virt_plug_params * cocci_id@p ;
...
position p;
@@
 const struct fwserial_mgmt_pkt cocci_id@p ;
