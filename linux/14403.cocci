...
position p;
@@
 struct tda10086_state cocci_id@p ;
...
position p;
@@
 const struct tda10086_config * cocci_id@p ;
...
typedef bool,u32;
@@
 struct tda10086_state {  struct i2c_adapter * i2c ;  const struct tda10086_config * config ;  struct dvb_frontend frontend ;  u32 frequency ;  u32 symbol_rate ;  bool has_lock ; } cocci_id@p ;
