...
position p;
@@
 struct dib3000_state cocci_id@p ;
...
position p;
@@
 const struct dib3000_config * cocci_id@p ;
...
position p;
@@
 struct dib_fe_xfer_ops * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dvb_frontend * fe , struct dtv_frontend_properties * c ) ;
...
position p;
@@
 struct dib3000_config cocci_id@p ;
