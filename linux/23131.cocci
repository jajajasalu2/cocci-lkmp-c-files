...
position p;
@@
 const struct uniphier_aio_spec * cocci_id@p ;
...
position p;
@@
 struct uniphier_aio_chip * cocci_id@p ;
...
position p;
@@
 const struct uniphier_aio_chip_spec * cocci_id@p ;
...
position p;
@@
 struct uniphier_aio_pll cocci_id@p ;
