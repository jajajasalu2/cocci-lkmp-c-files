...
typedef u8;
@@
 void cocci_id@p ( int base , int reg , u8 val ) ;
...
position p;
@@
 struct watchdog_data cocci_id@p ;
...
typedef u8;
@@
 struct watchdog_data {  unsigned short sioaddr ;  enum chips type ;  unsigned long opened ;  struct mutex lock ;  char expect_close ;  struct watchdog_info ident ;  unsigned short timeout ;  u8 timer_val ;  char minutes_mode ;  u8 pulse_val ;  char pulse_mode ;  char caused_reboot ; } cocci_id@p ;
...
position p;
@@
 enum chips { f71808fg , f71858fg , f71862fg , f71868 , f71869 , f71882fg , f71889fg , f81803 , f81865 , f81866 , } cocci_id@p ;
...
position p;
@@
 union {  struct watchdog_info __user * ident ;  int __user * i ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int base , int reg , int bit ) ;
