...
position p;
@@
 struct hsc_rx_config cocci_id@p ;
...
position p;
@@
 struct hsc_tx_config * cocci_id@p ;
...
position p;
@@
 enum { HSC_CH_OPEN , HSC_CH_READ , HSC_CH_WRITE , HSC_CH_WLINE , } cocci_id@p ;
...
position p;
@@
 struct hsc_client_data * cocci_id@p ;
...
position p;
@@
 struct hsc_client_data {  struct cdev cdev ;  struct mutex lock ;  unsigned long flags ;  unsigned int usecnt ;  struct hsi_client * cl ;  struct hsc_channel channels [ HSC_DEVS ] ; } cocci_id@p ;
...
@@
 struct hsc_channel {  unsigned int ch ;  unsigned long flags ;  struct list_head free_msgs_list ;  struct list_head rx_msgs_queue ;  struct list_head tx_msgs_queue ;  spinlock_t lock ;  struct hsi_client * cl ;  struct hsc_client_data * cl_data ;  wait_queue_head_t rx_wait ;  wait_queue_head_t tx_wait ; } cocci_id@p ;
