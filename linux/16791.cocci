...
position p;
@@
 const struct cma3000_bus_ops * cocci_id@p ;
...
position p;
@@
 struct cma3000_accl_data cocci_id@p ;
...
position p;
@@
 const struct cma3000_platform_data * cocci_id@p ;
...
typedef u8,bool;
@@
 struct cma3000_accl_data {  const struct cma3000_bus_ops * bus_ops ;  const struct cma3000_platform_data * pdata ;  struct device * dev ;  struct input_dev * input_dev ;  int bit_to_mg ;  int irq ;  int g_range ;  u8 mode ;  struct mutex mutex ;  bool opened ;  bool suspended ; } cocci_id@p ;
