...
position p;
@@
 struct tcp_repair_window cocci_id@p ;
...
position p;
@@
 struct tcp_zerocopy_receive * cocci_id@p ;
...
position p;
@@
 struct inet_bind_bucket cocci_id@p ;
...
position p;
@@
 union tcp_md5sum_block cocci_id@p ;
...
position p;
@@
 struct inet_bind_hashbucket cocci_id@p ;
...
position p;
@@
 struct tcp_fastopen_request cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ TCP_ULP_NAME_MAX ] ;
...
position p;
@@
 struct tcp_splice_state cocci_id@p ;
...
position p;
@@
 struct tcp_splice_state {  struct pipe_inode_info * pipe ;  size_t len ;  unsigned int flags ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sk_read_actor_t;
@@
 sk_read_actor_t cocci_id@p ;
...
position p;
@@
 struct inet_ehash_bucket cocci_id@p ;
...
position p;
@@
 struct tcp_congestion_ops cocci_id@p ;
...
position p;
@@
 const struct tcp_congestion_ops * cocci_id@p ;
...
position p;
@@
 struct tcp_fastopen_context * cocci_id@p ;
...
position p;
@@
 struct tcp_repair_opt cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ __TCP_CHRONO_MAX ] ;
