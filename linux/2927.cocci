...
@@
 acpi_status cocci_id@p ( u32 table_index , union acpi_operand_object * * ddb_handle ) ;
...
@@
 acpi_status cocci_id@p ( union acpi_operand_object * obj_desc , u32 length , u8 * buffer ) ;
