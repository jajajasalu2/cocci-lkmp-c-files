...
position p;
@@
 const struct {  unsigned channel ;  unsigned count ; } cocci_id@p [ ] ;
...
position p;
@@
 struct crash_spu_info cocci_id@p [ CRASH_NUM_SPUS ] ;
...
position p;
@@
 struct cbe_spu_info cocci_id@p [ MAX_NUMNODES ] ;
...
typedef u64,u32;
@@
 struct crash_spu_info {  struct spu * spu ;  u32 saved_spu_runcntl_RW ;  u32 saved_spu_status_R ;  u32 saved_spu_npc_RW ;  u64 saved_mfc_sr1_RW ;  u64 saved_mfc_dar ;  u64 saved_mfc_dsisr ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long ea , unsigned long access , unsigned long trap , unsigned long dsisr ) ;
