...
position p;
@@
 struct tty_port_operations cocci_id@p ;
...
position p;
@@
 struct vcc_port * cocci_id@p [ VCC_MAX_PORTS ] ;
...
symbol cocci_id;
position p;
typedef u64,bool,spinlock_t;
@@
 struct vcc_port {  struct vio_driver_state vio ;  spinlock_t lock ;  char * domain ;  struct tty_struct * tty ;  unsigned long index ;  u64 refcnt ;  bool excl_locked ;  bool removed ;  int chars_in_buffer ;  struct vio_vcc buffer ;  struct timer_list rx_timer ;  struct timer_list tx_timer ; } cocci_id@p ;
