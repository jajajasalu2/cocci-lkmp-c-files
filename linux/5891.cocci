...
position p;
@@
 const struct madera_pin_groups * cocci_id@p ;
...
position p;
@@
 struct madera_pin_private * cocci_id@p ;
...
typedef u32;
@@
 const struct {  const char * name ;  const char * const * group_names ;  u32 func ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct madera_pdata * cocci_id@p ;
...
position p;
@@
 const struct madera_pin_chip * cocci_id@p ;
