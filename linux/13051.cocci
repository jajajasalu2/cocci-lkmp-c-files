...
position p;
@@
 enum geni_se_xfer_mode cocci_id@p ;
...
position p;
@@
 struct geni_wrapper * cocci_id@p ;
...
position p;
@@
 struct geni_wrapper {  struct device * dev ;  void __iomem * base ;  struct clk_bulk_data ahb_clks [ NUM_AHB_CLKS ] ; } cocci_id@p ;
