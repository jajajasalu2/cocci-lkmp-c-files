...
position p;
@@
 struct ebt_ip6_info cocci_id@p ;
...
typedef u8;
@@
 union pkthdr {  struct {  __be16 src ;  __be16 dst ; } tcpudphdr ;  struct {  u8 type ;  u8 code ; } icmphdr ; } cocci_id@p ;
...
position p;
@@
 const struct ebt_ip6_info * cocci_id@p ;
