...
typedef u8;
@@
 struct mid_pb_ddata {  struct device * dev ;  int irq ;  struct input_dev * input ;  unsigned short mirqlvl1_addr ;  unsigned short pbstat_addr ;  u8 pbstat_mask ;  int ( * setup ) ( struct mid_pb_ddata * ddata ) ; } cocci_id@p ;
...
position p;
@@
 struct mid_pb_ddata * cocci_id@p ;
...
position p;
@@
 const struct mid_pb_ddata cocci_id@p ;
