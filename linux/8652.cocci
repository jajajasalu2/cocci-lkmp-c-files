...
position p;
@@
 struct i40e_hmc_pd_entry * cocci_id@p ;
...
typedef u16;
@@
 struct i40e_context_ele {  u16 offset ;  u16 size_of ;  u16 width ;  u16 lsb ; } cocci_id@p ;
...
position p;
@@
 struct i40e_context_ele * cocci_id@p ;
...
position p;
@@
 struct i40e_hmc_pd_table * cocci_id@p ;
...
position p;
@@
 struct i40e_hmc_lan_delete_obj_info cocci_id@p ;
...
position p;
@@
 enum i40e_hmc_lan_rsrc_type cocci_id@p ;
...
position p;
@@
 struct i40e_hmc_lan_create_obj_info * cocci_id@p ;
...
position p;
@@
 struct i40e_hmc_sd_entry * cocci_id@p ;
...
position p;
@@
 struct i40e_hmc_obj_info cocci_id@p ;
...
position p;
@@
 enum i40e_hmc_model cocci_id@p ;
...
position p;
@@
 struct i40e_hmc_info * cocci_id@p ;
