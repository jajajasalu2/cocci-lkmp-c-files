...
typedef u16;
@@
 struct ad7291_chip_info {  struct i2c_client * client ;  struct regulator * reg ;  u16 command ;  u16 c_mask ;  struct mutex state_lock ; } cocci_id@p ;
...
position p;
@@
 struct ad7291_platform_data * cocci_id@p ;
...
position p;
@@
 struct ad7291_chip_info * cocci_id@p ;
