...
typedef u8;
@@
 struct mxt_info {  u8 family_id ;  u8 variant_id ;  u8 version ;  u8 build ;  u8 matrix_xsize ;  u8 matrix_ysize ;  u8 object_num ; } cocci_id@p ;
...
@@
 struct mxt_data {  struct i2c_client * client ;  struct input_dev * input_dev ;  char phys [ 64 ] ;  struct mxt_object * object_table ;  struct mxt_info * info ;  void * raw_info_block ;  unsigned int irq ;  unsigned int max_x ;  unsigned int max_y ;  bool invertx ;  bool inverty ;  bool xy_switch ;  u8 xsize ;  u8 ysize ;  bool in_bootloader ;  u16 mem_size ;  u8 t100_aux_ampl ;  u8 t100_aux_area ;  u8 t100_aux_vect ;  u8 max_reportid ;  u32 config_crc ;  u32 info_crc ;  u8 bootloader_addr ;  u8 * msg_buf ;  u8 t6_status ;  bool update_input ;  u8 last_message_count ;  u8 num_touchids ;  u8 multitouch ;  struct t7_config t7_cfg ;  struct mxt_dbg dbg ;  struct gpio_desc * reset_gpio ;  u16 T5_address ;  u8 T5_msg_size ;  u8 T6_reportid ;  u16 T6_address ;  u16 T7_address ;  u16 T71_address ;  u8 T9_reportid_min ;  u8 T9_reportid_max ;  u8 T19_reportid ;  u16 T44_address ;  u8 T100_reportid_min ;  u8 T100_reportid_max ;  struct completion bl_completion ;  struct completion reset_completion ;  struct completion crc_completion ;  u32 * t19_keymap ;  unsigned int t19_num_keys ;  enum mxt_suspend_mode suspend_mode ; } cocci_id@p ;
...
position p;
@@
 struct mxt_vb2_buffer {  struct vb2_buffer vb ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct input_dev * dev ) ;
...
typedef u16;
@@
 struct mxt_dbg {  u16 t37_address ;  u16 diag_cmd_address ;  struct t37_debug * t37_buf ;  unsigned int t37_pages ;  unsigned int t37_nodes ;  struct v4l2_device v4l2 ;  struct v4l2_pix_format format ;  struct video_device vdev ;  struct vb2_queue queue ;  struct mutex lock ;  int input ; } cocci_id@p ;
...
position p;
@@
 const struct vb2_queue cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mxt_data * data ) ;
...
position p;
@@
 enum v4l_dbg_inputs { MXT_V4L_INPUT_DELTAS , MXT_V4L_INPUT_REFS , MXT_V4L_INPUT_MAX , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct input_dev * dev ) ;
...
typedef u8,off_t;
@@
 struct mxt_cfg {  u8 * raw ;  size_t raw_size ;  off_t raw_pos ;  u8 * mem ;  size_t mem_size ;  int start_ofs ;  struct mxt_info info ; } cocci_id@p ;
...
position p;
@@
 const struct mxt_object * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mxt_data * data , const struct firmware * cfg ) ;
...
position p;
@@
 enum t100_type { MXT_T100_TYPE_FINGER = 1 , MXT_T100_TYPE_PASSIVE_STYLUS = 2 , MXT_T100_TYPE_HOVERING_FINGER = 4 , MXT_T100_TYPE_GLOVE = 5 , MXT_T100_TYPE_LARGE_TOUCH = 6 , } cocci_id@p ;
...
position p;
@@
 struct mxt_vb2_buffer cocci_id@p ;
...
position p;
@@
 enum mxt_suspend_mode { MXT_SUSPEND_DEEP_SLEEP = 0 , MXT_SUSPEND_T9_CTRL = 1 , } cocci_id@p ;
