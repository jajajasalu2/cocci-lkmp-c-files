...
position p;
@@
 struct most_video_dev cocci_id@p ;
...
typedef u32;
@@
 struct comp_fh {  struct v4l2_fh fh ;  struct most_video_dev * mdev ;  u32 offs ; } cocci_id@p ;
...
@@
 struct most_video_dev {  struct most_interface * iface ;  int ch_idx ;  struct list_head list ;  bool mute ;  struct list_head pending_mbos ;  spinlock_t list_lock ;  struct v4l2_device v4l2_dev ;  atomic_t access_ref ;  struct video_device * vdev ;  unsigned int ctrl_input ;  struct mutex lock ;  wait_queue_head_t wait_data ; } cocci_id@p ;
