...
position p;
@@
 struct sst_gain_value cocci_id@p [ ARRAY_SIZE ( sst_gain_controls ) / SST_GAIN_NUM_CONTROLS ] ;
...
position p;
@@
 struct swm_input_ids * cocci_id@p ;
...
position p;
@@
 struct sst_dsp_header cocci_id@p ;
...
position p;
@@
 struct sst_cmd_generic cocci_id@p ;
...
position p;
@@
 struct sst_gain_mixer_control * cocci_id@p ;
...
position p;
@@
 struct sst_gain_value * cocci_id@p ;
...
position p;
@@
 const uint cocci_id@p [ SST_SWM_INPUT_COUNT ] ;
...
position p;
@@
 struct sst_cmd_sba_set_media_loop_map cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SST_MAX_TDM_SLOTS ] ;
...
position p;
@@
 struct sst_cmd_set_gain_dual cocci_id@p ;
...
position p;
@@
 struct sst_algo_control * cocci_id@p ;
...
position p;
@@
 const struct sst_ssp_config * cocci_id@p ;
...
position p;
@@
 struct sst_cmd_sba_hw_set_ssp cocci_id@p ;
...
position p;
@@
 struct sst_cmd_set_swm cocci_id@p ;
...
position p;
@@
 struct sst_param_sba_ssp_slot_map cocci_id@p ;
...
position p;
@@
 struct snd_sst_bytes_v2 * cocci_id@p ;
...
position p;
@@
 struct sst_cmd_set_media_path cocci_id@p ;
...
position p;
@@
 struct sst_cmd_set_params * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sst_ids * ids , struct sst_data * drv , int mute ) ;
