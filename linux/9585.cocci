...
position p;
@@
 struct qlink_tlv_ie_set * cocci_id@p ;
...
position p;
@@
 struct qlink_tlv_hdr * cocci_id@p ;
...
position p;
@@
 const struct qlink_iface_limit_record * cocci_id@p ;
...
position p;
@@
 const struct qlink_wowlan_support * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_start_cac * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_vht_cap * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_wowlan_set * cocci_id@p ;
...
position p;
@@
 const struct cfg80211_ap_settings * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_connect * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_disconnect * cocci_id@p ;
...
position p;
@@
 struct qlink_random_mac_addr * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_txpwr * cocci_id@p ;
...
position p;
@@
 struct qlink_tlv_ext_ie * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_reg_notify * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_updown * cocci_id@p ;
...
position p;
@@
 struct qtnf_chan_stats * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_external_auth * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_manage_intf * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_ndev_changeupper * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_chan_switch * cocci_id@p ;
...
position p;
@@
 const struct qlink_sta_stats * cocci_id@p ;
...
position p;
@@
 const struct qlink_sta_info_state * cocci_id@p ;
...
position p;
@@
 const struct qlink_resp_get_hw_info * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_del_key * cocci_id@p ;
...
position p;
@@
 const struct qlink_sband_iftype_data * cocci_id@p ;
...
position p;
@@
 struct qlink_resp_phy_params * cocci_id@p ;
...
position p;
@@
 const struct qlink_tlv_iftype_data * cocci_id@p ;
...
position p;
@@
 struct qlink_channel * cocci_id@p ;
...
position p;
@@
 struct ieee80211_iface_limit * cocci_id@p ;
...
position p;
@@
 struct qlink_tlv_chandef cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_change_sta * cocci_id@p ;
...
position p;
@@
 struct qlink_resp_get_chan_stats * cocci_id@p ;
...
position p;
@@
 const struct qlink_resp_channel_get * cocci_id@p ;
...
position p;
@@
 const struct qlink_resp_get_sta_info * cocci_id@p ;
...
position p;
@@
 struct qlink_tlv_rlimit * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_mgmt_frame_register * cocci_id@p ;
...
position p;
@@
 const struct qlink_sta_info_rate * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_frame_tx * cocci_id@p ;
...
position p;
@@
 struct qlink_tlv_cclass * cocci_id@p ;
...
position p;
@@
 struct qlink_acl_data * cocci_id@p ;
...
position p;
@@
 const struct qlink_tlv_reg_rule * cocci_id@p ;
...
position p;
@@
 const struct qlink_resp * cocci_id@p ;
...
position p;
@@
 const struct qlink_resp_manage_intf * cocci_id@p ;
...
position p;
@@
 const struct cfg80211_acl_data * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_start_ap * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_add_key * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_band_info_get * cocci_id@p ;
...
position p;
@@
 const struct qlink_channel * cocci_id@p ;
...
position p;
@@
 const struct qlink_wowlan_capab_data * cocci_id@p ;
...
position p;
@@
 const struct cfg80211_wowlan * cocci_id@p ;
...
position p;
@@
 const struct qlink_iface_limit * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_del_sta * cocci_id@p ;
...
position p;
@@
 struct wiphy_wowlan_support * cocci_id@p ;
...
position p;
@@
 struct qlink_resp_band_info_get * cocci_id@p ;
...
position p;
@@
 enum qlink_cmd_type cocci_id@p ;
...
position p;
@@
 struct qtnf_mac_info * cocci_id@p ;
...
position p;
@@
 struct qlink_auth_encr * cocci_id@p ;
...
position p;
@@
 struct qlink_tlv_channel * cocci_id@p ;
...
position p;
@@
 struct ieee80211_sband_iftype_data * cocci_id@p ;
...
position p;
@@
 enum qlink_cmd_result cocci_id@p ;
...
position p;
@@
 const struct qlink_resp_get_mac_info * cocci_id@p ;
...
position p;
@@
 struct qlink_wowlan_support * cocci_id@p ;
...
position p;
@@
 const struct qtnf_vif * cocci_id@p ;
...
position p;
@@
 struct qlink_tlv_frag_rts_thr * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_pm_set * cocci_id@p ;
...
position p;
@@
 struct qlink_chan_stats * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_get_sta_info * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_set_def_key * cocci_id@p ;
...
position p;
@@
 const struct qlink_tlv_hdr * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_set_def_mgmt_key * cocci_id@p ;
...
position p;
@@
 const struct qlink_resp_txpwr * cocci_id@p ;
...
position p;
@@
 struct qtnf_hw_info * cocci_id@p ;
...
position p;
@@
 const struct qlink_iface_comb_num * cocci_id@p ;
...
position p;
@@
 struct qlink_cmd_get_chan_stats * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_ht_cap * cocci_id@p ;
