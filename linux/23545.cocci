...
position p;
@@
 struct snd_sst_tstamp cocci_id@p ;
...
position p;
@@
 struct compress_sst_ops cocci_id@p ;
...
position p;
@@
 struct intel_sst_drv * cocci_id@p ;
...
position p;
@@
 struct snd_sst_lib_download * * cocci_id@p ;
...
position p;
@@
 struct sst_compress_cb * cocci_id@p ;
