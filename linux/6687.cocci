...
position p;
@@
 struct PVSCSIRingCmpDesc * cocci_id@p ;
...
position p;
@@
 struct PVSCSICmdDescSetupRings cocci_id@p ;
...
position p;
@@
 struct PVSCSICmdDescConfigCmd cocci_id@p ;
...
position p;
@@
 const struct pvscsi_adapter * cocci_id@p ;
...
position p;
@@
 const struct PVSCSIRingCmpDesc * cocci_id@p ;
...
position p;
@@
 struct PVSCSISGElement * cocci_id@p ;
...
position p;
@@
 struct PVSCSIConfigPageController * cocci_id@p ;
...
position p;
@@
 struct pvscsi_adapter cocci_id@p ;
...
position p;
@@
 struct PVSCSIRingReqDesc * cocci_id@p ;
...
position p;
@@
 struct pvscsi_sg_list cocci_id@p ;
...
position p;
@@
 struct PVSCSIConfigPageHeader * cocci_id@p ;
...
position p;
@@
 struct PVSCSICmdDescSetupReqCall cocci_id@p ;
...
position p;
@@
 struct PVSCSICmdDescSetupMsgRing cocci_id@p ;
...
position p;
@@
 struct PVSCSICmdDescResetDevice cocci_id@p ;
...
position p;
@@
 const struct pvscsi_ctx * cocci_id@p ;
...
position p;
@@
 struct PVSCSIMsgDescDevStatusChanged * cocci_id@p ;
...
position p;
@@
 struct pvscsi_sg_list {  struct PVSCSISGElement sge [ PVSCSI_MAX_NUM_SG_ENTRIES_PER_SEGMENT ] ; } cocci_id@p ;
...
position p;
@@
 struct PVSCSICmdDescAbortCmd cocci_id@p ;
...
position p;
@@
 struct PVSCSIRingsState * cocci_id@p ;
...
position p;
@@
 struct PVSCSIRingMsgDesc * cocci_id@p ;
...
position p;
@@
 const struct PVSCSIRingMsgDesc * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct pvscsi_ctx {  struct scsi_cmnd * cmd ;  struct pvscsi_sg_list * sgl ;  struct list_head list ;  dma_addr_t dataPA ;  dma_addr_t sensePA ;  dma_addr_t sglPA ;  struct completion * abort_cmp ; } cocci_id@p ;
