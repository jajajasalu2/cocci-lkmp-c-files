...
position p;
@@
 struct us428_lights cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_card * card ) ;
...
position p;
@@
 void cocci_id@p ( struct usb_device * usb_device , void * ptr ) ;
...
position p;
@@
 struct snd_usX2Y_AsyncSeq * cocci_id@p ;
...
position p;
@@
 struct us428ctls_sharedmem * cocci_id@p ;
