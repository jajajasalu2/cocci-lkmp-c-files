...
position p;
@@
 struct omap_vc_channel * cocci_id@p ;
...
typedef u8;
@@
 struct omap_vc_channel_cfg {  u8 sa ;  u8 rav ;  u8 rac ;  u8 racen ;  u8 cmd ; } cocci_id@p ;
...
typedef u8;
@@
 struct i2c_init_data {  u8 loadbits ;  u8 load ;  u8 hsscll_38_4 ;  u8 hsscll_26 ;  u8 hsscll_19_2 ;  u8 hsscll_16_8 ;  u8 hsscll_12 ; } cocci_id@p ;
...
typedef u32;
@@
 struct omap3_vc {  struct voltagedomain * vd ;  u32 voltctrl ;  u32 voltsetup1 ;  u32 voltsetup2 ;  struct omap3_vc_timings timings [ 2 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct omap3_vc_timings {  u32 voltsetup1 ;  u32 voltsetup2 ; } cocci_id@p ;
...
position p;
@@
 struct omap_vc_channel_cfg * cocci_id@p ;
...
position p;
@@
 struct voltagedomain * cocci_id@p ;
...
position p;
@@
 const struct i2c_init_data * cocci_id@p ;
...
position p;
@@
 struct omap3_vc_timings * cocci_id@p ;
