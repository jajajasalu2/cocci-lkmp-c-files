...
symbol cocci_id;
position p;
typedef rcv_to_hci_t,llc_failure_t,xmit_to_drv_t;
@@
 struct llc_nop {  struct nfc_hci_dev * hdev ;  xmit_to_drv_t xmit_to_drv ;  rcv_to_hci_t rcv_to_hci ;  int tx_headroom ;  int tx_tailroom ;  llc_failure_t llc_failure ; } cocci_id@p ;
