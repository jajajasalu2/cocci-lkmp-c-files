...
position p;
@@
 struct scifioctl_accept cocci_id@p ;
...
position p;
@@
 struct scifioctl_reg cocci_id@p ;
...
position p;
@@
 struct scifioctl_fence_signal cocci_id@p ;
...
position p;
@@
 struct scifioctl_node_ids cocci_id@p ;
...
position p;
@@
 struct scifioctl_fence_mark cocci_id@p ;
...
position p;
@@
 struct scifioctl_msg cocci_id@p ;
...
position p;
@@
 struct scifioctl_connect cocci_id@p ;
...
position p;
@@
 struct scifioctl_unreg cocci_id@p ;
...
position p;
@@
 struct scifioctl_copy cocci_id@p ;
