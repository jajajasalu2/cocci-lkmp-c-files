...
position p;
@@
 struct iwmmxt_sigframe cocci_id@p ;
...
position p;
@@
 struct crunch_sigframe * cocci_id@p ;
...
position p;
@@
 struct vfp_sigframe cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( * frame ) + 8 ] ;
...
position p;
@@
 const unsigned long cocci_id@p [ 17 ] ;
