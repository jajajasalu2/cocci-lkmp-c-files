...
@@
 struct apds990x_chip {  struct apds990x_platform_data * pdata ;  struct i2c_client * client ;  struct mutex mutex ;  struct regulator_bulk_data regs [ 2 ] ;  wait_queue_head_t wait ;  int prox_en ;  bool prox_continuous_mode ;  bool lux_wait_fresh_res ;  struct apds990x_chip_factors cf ;  struct reverse_factors rcf ;  u16 atime ;  u16 arate ;  u16 a_max_result ;  u8 again_meas ;  u8 again_next ;  u8 pgain ;  u8 pdiode ;  u8 pdrive ;  u8 lux_persistence ;  u8 prox_persistence ;  u32 lux_raw ;  u32 lux ;  u16 lux_clear ;  u16 lux_ir ;  u16 lux_calib ;  u32 lux_thres_hi ;  u32 lux_thres_lo ;  u32 prox_thres ;  u16 prox_data ;  u16 prox_calib ;  char chipname [ 10 ] ;  u8 revision ; } cocci_id@p ;
...
position p;
@@
 struct apds990x_chip * cocci_id@p ;
...
typedef u32;
@@
 struct reverse_factors {  u32 afactor ;  int cf1 ;  int irf1 ;  int cf2 ;  int irf2 ; } cocci_id@p ;
