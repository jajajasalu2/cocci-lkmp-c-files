...
position p;
@@
 struct meson8b_clk_reset {  struct reset_controller_dev reset ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct meson8b_nb_data {  struct notifier_block nb ;  struct clk_hw_onecell_data * onecell_data ; } cocci_id@p ;
...
position p;
@@
 struct meson8b_clk_reset cocci_id@p ;
...
position p;
@@
 struct meson8b_nb_data * cocci_id@p ;
...
typedef u8,u32;
@@
 const struct meson8b_clk_reset_line {  u32 reg ;  u8 bit_idx ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct meson8b_clk_reset_line * cocci_id@p ;
