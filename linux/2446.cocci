...
position p;
@@
 struct tegra_dma_desc * cocci_id@p ;
...
@@
 struct tegra_dma {  struct dma_device dma_dev ;  struct device * dev ;  struct clk * dma_clk ;  struct reset_control * rst ;  spinlock_t global_lock ;  void __iomem * base_addr ;  const struct tegra_dma_chip_data * chip_data ;  u32 global_pause_count ;  u32 reg_gen ;  struct tegra_dma_channel channels [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_dma_chip_data cocci_id@p ;
...
@@
 struct tegra_dma_channel {  struct dma_chan dma_chan ;  char name [ 12 ] ;  bool config_init ;  int id ;  int irq ;  void __iomem * chan_addr ;  spinlock_t lock ;  bool busy ;  struct tegra_dma * tdma ;  bool cyclic ;  struct list_head free_sg_req ;  struct list_head pending_sg_req ;  struct list_head free_dma_desc ;  struct list_head cb_desc ;  dma_isr_handler isr_handler ;  struct tasklet_struct tasklet ;  unsigned int slave_id ;  struct dma_slave_config dma_sconfig ;  struct tegra_dma_channel_regs channel_reg ; } cocci_id@p ;
...
position p;
@@
 struct tegra_dma_channel_regs {  unsigned long csr ;  unsigned long ahb_ptr ;  unsigned long apb_ptr ;  unsigned long ahb_seq ;  unsigned long apb_seq ;  unsigned long wcount ; } cocci_id@p ;
...
position p;
@@
 struct tegra_dma_channel_regs * cocci_id@p ;
...
position p;
@@
 struct tegra_dma_channel * cocci_id@p ;
...
typedef bool;
@@
 struct tegra_dma_chip_data {  int nr_channels ;  int channel_reg_size ;  int max_dma_count ;  bool support_channel_pause ;  bool support_separate_wcount_reg ; } cocci_id@p ;
...
position p;
@@
 struct tegra_dma_desc {  struct dma_async_tx_descriptor txd ;  unsigned int bytes_requested ;  unsigned int bytes_transferred ;  enum dma_status dma_status ;  struct list_head node ;  struct list_head tx_list ;  struct list_head cb_node ;  int cb_count ; } cocci_id@p ;
...
typedef bool;
@@
 void ( * cocci_id@p ) ( struct tegra_dma_channel * tdc , bool to_terminate ) ;
...
typedef dma_cookie_t;
@@
 dma_cookie_t cocci_id@p ( struct dma_async_tx_descriptor * tx ) ;
...
position p;
@@
 struct tegra_dma_sg_req * cocci_id@p ;
...
typedef bool;
@@
 struct tegra_dma_sg_req {  struct tegra_dma_channel_regs ch_regs ;  unsigned int req_len ;  bool configured ;  bool last_sg ;  struct list_head node ;  struct tegra_dma_desc * dma_desc ;  unsigned int words_xferred ; } cocci_id@p ;
