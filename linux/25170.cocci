...
position p;
@@
 enum intel_hsw_ext_id { PC8 = 0 , PC9 , PC10 , HSW_EXT_CSTATE_COUNT , TSC = 0xFFFF , } cocci_id@p ;
...
typedef cstate_t;
@@
 cstate_t cocci_id@p [ HSW_EXT_CSTATE_COUNT ] ;
...
position p;
@@
 enum intel_hsw_ext_id cocci_id@p ;
...
position p;
@@
 unsigned long long * cocci_id@p [ HSW_EXT_CSTATE_COUNT ] ;
