...
position p;
@@
 struct meson_rtc {  struct rtc_device * rtc ;  struct device * dev ;  struct reset_control * reset ;  struct regulator * vdd ;  struct regmap * peripheral ;  struct regmap * serial ; } cocci_id@p ;
