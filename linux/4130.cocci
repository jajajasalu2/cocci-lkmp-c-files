...
position p;
@@
 const struct uniphier_pciephy_soc_data cocci_id@p ;
...
typedef bool;
@@
 struct uniphier_pciephy_soc_data {  bool has_syscon ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_pciephy_priv {  void __iomem * base ;  struct device * dev ;  struct clk * clk ;  struct reset_control * rst ;  const struct uniphier_pciephy_soc_data * data ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_pciephy_priv * cocci_id@p ;
