...
position p;
@@
 struct uac3_hc_descriptor_header cocci_id@p ;
...
position p;
@@
 struct uac3_cluster_information_segment_descriptor * cocci_id@p ;
...
position p;
@@
 struct snd_usb_power_domain * cocci_id@p ;
...
position p;
@@
 struct snd_usb_stream * cocci_id@p ;
...
position p;
@@
 struct uac3_as_header_descriptor * cocci_id@p ;
...
position p;
@@
 struct uac_format_type_i_continuous_descriptor * cocci_id@p ;
...
position p;
@@
 struct snd_usb_substream * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_chmap_elem * cocci_id@p ;
...
position p;
@@
 struct uac3_cluster_segment_descriptor * cocci_id@p ;
...
position p;
@@
 struct uac3_iso_endpoint_descriptor * cocci_id@p ;
