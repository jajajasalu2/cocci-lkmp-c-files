...
position p;
@@
 struct timer16_priv * cocci_id@p ;
...
position p;
@@
 struct timer16_priv {  struct clocksource cs ;  unsigned long total_cycles ;  void __iomem * mapbase ;  void __iomem * mapcommon ;  unsigned short cs_enabled ;  unsigned char enb ;  unsigned char ovf ;  unsigned char ovie ; } cocci_id@p ;
