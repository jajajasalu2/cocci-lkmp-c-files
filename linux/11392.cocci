...
position p;
@@
 struct vmw_simple_resource * cocci_id@p ;
...
position p;
@@
 struct vmw_user_simple_resource {  struct ttm_base_object base ;  size_t account_size ;  struct vmw_simple_resource simple ; } cocci_id@p ;
...
position p;
@@
 struct vmw_user_simple_resource cocci_id@p ;
...
position p;
@@
 const struct vmw_simple_resource_func * cocci_id@p ;
