...
position p;
@@
 struct ves1820_state * cocci_id@p ;
...
position p;
@@
 const struct ves1820_config * cocci_id@p ;
...
typedef u8;
@@
 struct ves1820_state {  struct i2c_adapter * i2c ;  const struct ves1820_config * config ;  struct dvb_frontend frontend ;  u8 reg0 ;  u8 pwm ; } cocci_id@p ;
