...
position p;
@@
 const struct cpcap_regulator cocci_id@p [ ] ;
...
position p;
@@
 struct cpcap_regulator * cocci_id@p ;
...
typedef u16;
@@
 struct cpcap_regulator {  struct regulator_desc rdesc ;  const u16 assign_reg ;  const u16 assign_mask ; } cocci_id@p ;
...
position p;
@@
 struct cpcap_ddata {  struct regmap * reg ;  struct device * dev ;  const struct cpcap_regulator * soc ; } cocci_id@p ;
