...
position p;
@@
 struct acpi_create_field_info * cocci_id@p ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_create_field_info * info , struct acpi_walk_state * walk_state , union acpi_parse_object * arg ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( acpi_status lookup_status , union acpi_parse_object * op , char * path , struct acpi_walk_state * walk_state , struct acpi_namespace_node * * node ) ;
