...
position p;
@@
 const struct fsg_module_parameters * cocci_id@p ;
...
position p;
@@
 struct fsg_lun_config cocci_id@p ;
...
position p;
@@
 enum data_direction cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct fsg_dev * ) ;
...
position p;
@@
 struct fsg_lun_opts * cocci_id@p ;
