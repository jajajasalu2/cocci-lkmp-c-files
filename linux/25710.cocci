...
typedef resource_size_t;
@@
 void __iomem * ( * cocci_id@p ) ( resource_size_t , unsigned long ) ;
...
position p;
@@
 struct nfit_test_request * cocci_id@p ;
...
position p;
@@
 struct iomap_ops {  nfit_test_lookup_fn nfit_test_lookup ;  nfit_test_evaluate_dsm_fn evaluate_dsm ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 nfit_test_lookup_fn cocci_id@p ;
...
position p;
@@
 nfit_test_evaluate_dsm_fn cocci_id@p ;
