...
position p;
@@
 struct si5351_hw_data {  struct clk_hw hw ;  struct si5351_driver_data * drvdata ;  struct si5351_parameters params ;  unsigned char num ; } cocci_id@p ;
...
position p;
@@
 enum si5351_pll_src cocci_id@p ;
...
position p;
@@
 struct si5351_driver_data cocci_id@p ;
...
position p;
@@
 struct si5351_parameters * cocci_id@p ;
...
position p;
@@
 struct si5351_parameters {  unsigned long p1 ;  unsigned long p2 ;  unsigned long p3 ;  int valid ; } cocci_id@p ;
...
position p;
@@
 struct si5351_hw_data cocci_id@p ;
...
position p;
@@
 enum si5351_disable_state cocci_id@p ;
...
position p;
@@
 enum si5351_multisynth_src cocci_id@p ;
...
position p;
@@
 struct si5351_platform_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI5351_PARAMETERS_LENGTH ] ;
...
position p;
@@
 enum si5351_variant cocci_id@p ;
...
position p;
@@
 enum si5351_clkout_src cocci_id@p ;
...
position p;
@@
 enum si5351_drive_strength cocci_id@p ;
