...
position p;
@@
 enum ftm_quaddec_count_function { FTM_QUADDEC_COUNT_ENCODER_MODE_1 , } cocci_id@p ;
...
position p;
@@
 struct ftm_quaddec * constcocci_id ;
...
position p;
@@
 enum ftm_quaddec_synapse_action { FTM_QUADDEC_SYNAPSE_ACTION_BOTH_EDGES , } cocci_id@p ;
...
typedef bool;
@@
 struct ftm_quaddec {  struct counter_device counter ;  struct platform_device * pdev ;  void __iomem * ftm_base ;  bool big_endian ;  struct mutex ftm_quaddec_mutex ; } cocci_id@p ;
