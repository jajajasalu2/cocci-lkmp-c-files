...
position p;
@@
 enum cable_info_err { CABLE_INF_INV_PORT = 0x1 , CABLE_INF_OP_NOSUP = 0x2 , CABLE_INF_NOT_CONN = 0x3 , CABLE_INF_NO_EEPRM = 0x4 , CABLE_INF_PAGE_ERR = 0x5 , CABLE_INF_INV_ADDR = 0x6 , CABLE_INF_I2C_ADDR = 0x7 , CABLE_INF_QSFP_VIO = 0x8 , CABLE_INF_I2C_BUSY = 0x9 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_mac_table * cocci_id@p ;
...
position p;
@@
 struct mlx4_roce_gid_table * cocci_id@p ;
...
position p;
@@
 enum { MLX4_SET_PORT_VL_CAP = 4 , MLX4_SET_PORT_MTU_CAP = 12 , MLX4_CHANGE_PORT_PKEY_TBL_SZ = 20 , MLX4_CHANGE_PORT_VL_CAP = 21 , MLX4_CHANGE_PORT_MTU_CAP = 22 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_set_port_rqp_calc_context * cocci_id@p ;
...
position p;
@@
 struct mlx4_roce_gid_entry * cocci_id@p ;
...
position p;
@@
 struct mlx4_mad_ifc * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct mlx4_cable_info {  u8 i2c_addr ;  u8 page_num ;  __be16 dev_mem_address ;  __be16 reserved1 ;  __be16 size ;  __be32 reserved2 [ 2 ] ;  u8 data [ MODULE_INFO_MAX_READ ] ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_vlan_table * cocci_id@p ;
...
position p;
@@
 struct mlx4_set_port_vxlan_context * cocci_id@p ;
...
position p;
@@
 struct mlx4_cable_info * cocci_id@p ;
...
typedef u8,u32;
@@
 struct mlx4_set_port_vxlan_context {  u32 reserved1 ;  u8 modify_flags ;  u8 reserved2 ;  u8 enable_flags ;  u8 steering ; } cocci_id@p ;
...
position p;
@@
 enum { VXLAN_ENABLE_MODIFY = 1 << 7 , VXLAN_STEERING_MODIFY = 1 << 6 , VXLAN_ENABLE = 1 << 7 , } cocci_id@p ;
