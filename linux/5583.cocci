...
position p;
@@
 struct spear_rtc_config * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct spear_rtc_config {  struct rtc_device * rtc ;  struct clk * clk ;  spinlock_t lock ;  void __iomem * ioaddr ;  unsigned int irq_wake ; } cocci_id@p ;
