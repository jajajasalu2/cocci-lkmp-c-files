...
position p;
@@
 struct compat_video_still_picture * cocci_id@p ;
...
position p;
@@
 struct video_still_picture * cocci_id@p ;
...
position p;
@@
 struct dvb_ringbuffer * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef audio_stream_source_t;
@@
 audio_stream_source_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef video_stream_source_t;
@@
 video_stream_source_t cocci_id@p ;
...
position p;
@@
 enum av7110_video_mode cocci_id@p ;
...
position p;
@@
 struct video_status cocci_id@p ;
...
symbol cocci_id;
position p;
typedef audio_channel_select_t;
@@
 audio_channel_select_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef video_size_t;
@@
 video_size_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef int32_t,compat_uptr_t;
@@
 struct compat_video_still_picture {  compat_uptr_t iFrame ;  int32_t size ; } cocci_id@p ;
...
position p;
@@
 struct dvb_video_events * cocci_id@p ;
...
position p;
@@
 enum av7110_video_mode cocci_id@p [ 16 ] ;
...
symbol cocci_id;
position p;
typedef video_displayformat_t;
@@
 video_displayformat_t cocci_id@p ;
...
typedef u8,u16;
@@
 void cocci_id@p ( const u8 * buf , long int length , u16 pid , u8 * counter , struct dvb_demux_feed * feed ) ;
...
position p;
@@
 struct audio_status cocci_id@p ;
