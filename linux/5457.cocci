...
position p;
@@
 struct spi_bitbang_cs * cocci_id@p ;
...
typedef u8,u32;
@@
 struct spi_bitbang_cs {  unsigned nsecs ;  u32 ( * txrx_word ) ( struct spi_device * spi , unsigned nsecs , u32 word , u8 bits , unsigned flags ) ;  unsigned ( * txrx_bufs ) ( struct spi_device * , u32 ( * txrx_word ) ( struct spi_device * spi , unsigned nsecs , u32 word , u8 bits , unsigned flags ) , unsigned , struct spi_transfer * , unsigned ) ; } cocci_id@p ;
...
typedef u8,u32;
@@
 u32 ( * cocci_id@p ) ( struct spi_device * spi , unsigned nsecs , u32 word , u8 bits , unsigned flags ) ;
