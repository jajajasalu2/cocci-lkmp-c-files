...
position p;
@@
 long cocci_id@p ( struct file * fp , unsigned int cmd , unsigned long arg ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct hfi1_ctxtdata * uctxt , u16 subctxt , unsigned long arg ) ;
...
position p;
@@
 void cocci_id@p ( struct hfi1_ctxtdata * uctxt ) ;
...
position p;
@@
 const struct hfi1_user_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_ctxtdata * uctxt ) ;
...
position p;
@@
 struct hfi1_user_info cocci_id@p ;
...
position p;
@@
 struct hfi1_base_info cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct hfi1_filedata * fd , unsigned long arg , u32 len ) ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_filedata * fd , struct hfi1_ctxtdata * uctxt ) ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_filedata * fd , const struct hfi1_user_info * uinfo ) ;
...
position p;
@@
 struct hfi1_tid_info cocci_id@p ;
...
typedef vm_fault_t;
@@
 vm_fault_t cocci_id@p ( struct vm_fault * vmf ) ;
...
position p;
@@
 int cocci_id@p ( struct file * fp , struct vm_area_struct * vma ) ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_ctxtdata * uctxt , unsigned long arg ) ;
...
position p;
@@
 void cocci_id@p ( struct hfi1_ctxtdata * uctxt , const struct hfi1_user_info * uinfo ) ;
...
position p;
@@
 typeof ( uctxt -> poll_type ) cocci_id@p ;
...
position p;
@@
 struct hfi1_ctxt_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct file * fp ) ;
...
position p;
@@
 enum mmap_types { PIO_BUFS = 1 , PIO_BUFS_SOP , PIO_CRED , RCV_HDRQ , RCV_EGRBUF , UREGS , EVENTS , STATUS , RTAIL , SUBCTXT_UREGS , SUBCTXT_RCV_HDRQ , SUBCTXT_EGRBUF , SDMA_COMP , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_filedata * fd , struct hfi1_devdata * dd , struct hfi1_user_info * uinfo , struct hfi1_ctxtdata * * cd ) ;
...
position p;
@@
 ssize_t cocci_id@p ( struct kiocb * kiocb , struct iov_iter * from ) ;
