...
position p;
@@
 struct mips_cdmm_work_dev {  void * fn ;  struct mips_cdmm_device * dev ; } cocci_id@p ;
...
position p;
@@
 struct mips_cdmm_work_dev * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct mips_cdmm_device * ) ;
...
position p;
@@
 struct mips_cdmm_bus cocci_id@p ;
...
@@
 struct mips_cdmm_bus {  phys_addr_t phys ;  void __iomem * regs ;  unsigned int drbs ;  unsigned int drbs_reserved ;  bool discovered ;  bool offline ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct mips_cdmm_device * ) ;
