...
typedef u32;
@@
 struct imx290_pixfmt {  u32 code ; } cocci_id@p ;
...
position p;
@@
 const struct imx290_pixfmt cocci_id@p [ ] ;
...
position p;
@@
 const struct imx290_mode * cocci_id@p ;
...
position p;
@@
 const struct imx290_regval * cocci_id@p ;
...
typedef u8,u16;
@@
 struct imx290_regval {  u16 reg ;  u8 val ; } cocci_id@p ;
...
typedef u32;
@@
 struct imx290_mode {  u32 width ;  u32 height ;  u32 pixel_rate ;  u32 link_freq_index ;  const struct imx290_regval * data ;  u32 data_size ; } cocci_id@p ;
...
position p;
@@
 struct imx290 {  struct device * dev ;  struct clk * xclk ;  struct regmap * regmap ;  struct v4l2_subdev sd ;  struct v4l2_fwnode_endpoint ep ;  struct media_pad pad ;  struct v4l2_mbus_framefmt current_format ;  const struct imx290_mode * current_mode ;  struct regulator_bulk_data supplies [ IMX290_NUM_SUPPLIES ] ;  struct gpio_desc * rst_gpio ;  struct v4l2_ctrl_handler ctrls ;  struct v4l2_ctrl * link_freq ;  struct v4l2_ctrl * pixel_rate ;  struct mutex lock ; } cocci_id@p ;
