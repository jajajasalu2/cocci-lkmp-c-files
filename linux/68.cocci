...
position p;
@@
 struct namespace_list cocci_id@p ;
...
position p;
@@
 enum export { export_plain , export_unused , export_gpl , export_unused_gpl , export_gpl_future , export_unknown , } cocci_id@p ;
...
position p;
@@
 enum mismatch { TEXT_TO_ANY_INIT , DATA_TO_ANY_INIT , TEXT_TO_ANY_EXIT , DATA_TO_ANY_EXIT , XXXINIT_TO_SOME_INIT , XXXEXIT_TO_SOME_EXIT , ANY_INIT_TO_ANY_EXIT , ANY_EXIT_TO_ANY_INIT , EXPORT_TO_INIT_EXIT , EXTABLE_TO_NON_TEXT , } cocci_id@p ;
...
position p;
@@
 const struct sectioncheck * const cocci_id@p ;
...
position p;
@@
 struct ext_sym_list * cocci_id@p ;
...
position p;
@@
 const struct sectioncheck * cocci_id@p ;
...
position p;
@@
 struct symbol * cocci_id@p [ SYMBOL_HASH_SIZE ] ;
...
position p;
@@
 const char * const cocci_id@p [ 20 ] ;
...
position p;
@@
 const struct {  const char * str ;  enum export export ; } cocci_id@p [ ] ;
...
position p;
@@
 struct sectioncheck cocci_id@p ;
...
position p;
@@
 struct symbol {  struct symbol * next ;  struct module * module ;  unsigned int crc ;  int crc_valid ;  char * namespace ;  unsigned int weak : 1 ;  unsigned int vmlinux : 1 ;  unsigned int kernel : 1 ;  unsigned int is_static : 1 ;  enum export export ;  char name [ 0 ] ; } cocci_id@p ;
...
typedef Elf_Sym;
@@
 void cocci_id@p ( const char * modname , struct elf_info * elf , const struct sectioncheck * const mismatch , Elf_Rela * r , Elf_Sym * sym , const char * fromsec ) ;
...
position p;
@@
 struct ext_sym_list {  struct ext_sym_list * next ;  const char * file ; } cocci_id@p ;
...
position p;
@@
 const struct elf_info * cocci_id@p ;
