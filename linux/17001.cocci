...
position p;
@@
 struct migor_ts_priv {  struct i2c_client * client ;  struct input_dev * input ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct migor_ts_priv * cocci_id@p ;
