...
position p;
@@
 struct ieee1284_info * cocci_id@p ;
...
@@
 struct pp_struct {  struct pardevice * pdev ;  wait_queue_head_t irq_wait ;  atomic_t irqc ;  unsigned int flags ;  int irqresponse ;  unsigned char irqctl ;  struct ieee1284_info state ;  struct ieee1284_info saved_state ;  long default_inactivity ;  int index ; } cocci_id@p ;
...
position p;
@@
 enum ieee1284_phase cocci_id@p ;
...
position p;
@@
 struct device * cocci_id@p [ PARPORT_MAX ] ;
