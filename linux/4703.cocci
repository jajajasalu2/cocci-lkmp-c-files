...
position p;
@@
 struct hbm_notification_response * cocci_id@p ;
...
position p;
@@
 struct hbm_client_connect_response cocci_id@p ;
...
position p;
@@
 enum mei_cb_file_ops cocci_id@p ;
...
position p;
@@
 struct hbm_props_request cocci_id@p ;
...
position p;
@@
 struct hbm_dma_setup_request cocci_id@p ;
...
position p;
@@
 struct hbm_client_connect_request cocci_id@p ;
...
position p;
@@
 struct mei_hbm_cl_cmd * cocci_id@p ;
...
position p;
@@
 struct hbm_host_version_response * cocci_id@p ;
...
position p;
@@
 struct hbm_flow_control cocci_id@p ;
...
position p;
@@
 struct mei_me_client * cocci_id@p ;
...
position p;
@@
 struct hbm_add_client_response cocci_id@p ;
...
position p;
@@
 struct hbm_notification_request cocci_id@p ;
...
position p;
@@
 struct hbm_host_enum_response * cocci_id@p ;
...
position p;
@@
 struct hbm_dma_setup_response * cocci_id@p ;
...
position p;
@@
 enum mei_cl_connect_status cocci_id@p ;
...
position p;
@@
 struct hbm_props_response * cocci_id@p ;
...
position p;
@@
 struct hbm_power_gate cocci_id@p ;
...
position p;
@@
 struct hbm_add_client_request * cocci_id@p ;
...
position p;
@@
 enum mei_hbm_status cocci_id@p ;
...
position p;
@@
 struct hbm_host_version_request cocci_id@p ;
...
position p;
@@
 struct mei_bus_message * cocci_id@p ;
...
position p;
@@
 struct hbm_host_stop_request cocci_id@p ;
...
position p;
@@
 struct hbm_host_enum_request cocci_id@p ;
