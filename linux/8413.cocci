...
position p;
@@
 struct aq_ring_stats_tx_s * cocci_id@p ;
...
position p;
@@
 struct aq_vec_s {  const struct aq_hw_ops * aq_hw_ops ;  struct aq_hw_s * aq_hw ;  struct aq_nic_s * aq_nic ;  unsigned int tx_rings ;  unsigned int rx_rings ;  struct aq_ring_param_s aq_ring_param ;  struct napi_struct napi ;  struct aq_ring_s ring [ AQ_CFG_TCS_MAX ] [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct aq_ring_stats_rx_s * cocci_id@p ;
