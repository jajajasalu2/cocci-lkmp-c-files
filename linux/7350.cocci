...
position p;
@@
 enum cirrusfb_dbg_reg_class cocci_id@p ;
...
position p;
@@
 struct zorro_driver cocci_id@p ;
...
position p;
@@
 const struct fb_var_screeninfo * cocci_id@p ;
...
position p;
@@
 const struct fb_info * cocci_id@p ;
...
position p;
@@
 struct cirrusfb_info cocci_id@p ;
...
position p;
@@
 enum cirrusfb_dbg_reg_class { CRT , SEQ , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_short,u8,u32,u_char;
@@
 void cocci_id@p ( u8 __iomem * regbase , int bits_per_pixel , u_short x , u_short y , u_short width , u_short height , u32 fg_color , u32 bg_color , u_short line_length , u_char blitmode ) ;
...
position p;
@@
 void cocci_id@p ( struct cirrusfb_info * cinfo , unsigned char val ) ;
...
typedef u8,u32;
@@
 struct cirrusfb_info {  u8 __iomem * regbase ;  u8 __iomem * laguna_mmio ;  enum cirrus_board btype ;  unsigned char SFR ;  int multiplexing ;  int doubleVCLK ;  int blank_mode ;  u32 pseudo_palette [ 16 ] ;  void ( * unmap ) ( struct fb_info * info ) ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , struct fb_info * info ) ;
...
position p;
@@
 void cocci_id@p ( struct cirrusfb_info * cinfo , unsigned char regnum , unsigned char red , unsigned char green , unsigned char blue ) ;
...
position p;
@@
 const struct cirrusfb_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct cirrusfb_info * cinfo , unsigned char val ) ;
...
position p;
@@
 const struct fb_image * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p ( const struct cirrusfb_info * cinfo , int regnum ) ;
...
position p;
@@
 void cocci_id@p ( struct cirrusfb_info * cinfo , int on ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 __iomem * regbase ) ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * info ) ;
...
position p;
@@
 void cocci_id@p ( const struct cirrusfb_info * cinfo , int regnum , unsigned char val ) ;
...
position p;
@@
 const struct zorro_device_id cocci_id@p [ ] ;
...
position p;
@@
 const struct pci_dev * cocci_id@p ;
...
position p;
@@
 enum cirrus_board { BT_NONE = 0 , BT_SD64 , BT_PICCOLO , BT_PICASSO , BT_SPECTRUM , BT_PICASSO4 , BT_ALPINE , BT_GD5480 , BT_LAGUNA , BT_LAGUNAB , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct cirrusfb_info * cinfo ) ;
...
position p;
@@
 const struct cirrusfb_board_info_rec * cocci_id@p ;
...
typedef u32;
@@
 struct zorrocl {  enum cirrus_board type ;  u32 regoffset ;  u32 ramsize ;  u32 ramoffset ;  zorro_id ramid ;  zorro_id ramid2 ; } cocci_id@p ;
...
typedef bool;
@@
 const struct cirrusfb_board_info_rec {  char * name ;  long maxclock [ 5 ] ;  bool init_sr07 : 1 ;  bool init_sr1f : 1 ;  bool scrn_start_bit19 : 1 ;  unsigned char sr07 ;  unsigned char sr07_1bpp ;  unsigned char sr07_1bpp_mux ;  unsigned char sr07_8bpp ;  unsigned char sr07_8bpp_mux ;  unsigned char sr1f ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct zorrocl * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( long freq , int * nom , int * den , int * div ) ;
...
typedef u_short,u8;
@@
 void cocci_id@p ( u8 __iomem * regbase , int bits_per_pixel , u_short curx , u_short cury , u_short destx , u_short desty , u_short width , u_short height , u_short line_length ) ;
