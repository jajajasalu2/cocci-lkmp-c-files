...
position p;
@@
 struct nvm_passthru_vio cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_id12_grp * cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_chk_meta cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,__le64,__u32,__u16,__u8;
@@
 struct nvme_nvm_setbbtbl {  __u8 opcode ;  __u8 flags ;  __u16 command_id ;  __le32 nsid ;  __le64 rsvd [ 2 ] ;  __le64 prp1 ;  __le64 prp2 ;  __le64 spba ;  __le16 nlb ;  __u8 value ;  __u8 rsvd3 ;  __u32 rsvd4 [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_bb_tbl cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_id20_addrf cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_ph_rw cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_id20 * cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_id12_addrf cocci_id@p ;
...
position p;
@@
 struct nvm_chk_meta * cocci_id@p ;
...
typedef __u8;
@@
 struct nvme_nvm_id20_addrf {  __u8 grp_len ;  __u8 pu_len ;  __u8 chk_len ;  __u8 lba_len ;  __u8 resv [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_getbbtbl cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_setbbtbl cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,__le64,__u16,__u8,__u64;
@@
 struct nvme_nvm_ph_rw {  __u8 opcode ;  __u8 flags ;  __u16 command_id ;  __le32 nsid ;  __u64 rsvd2 ;  __le64 metadata ;  __le64 prp1 ;  __le64 prp2 ;  __le64 spba ;  __le16 length ;  __le16 control ;  __le32 dsmgmt ;  __le64 resv ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,__le64,__u32,__u16,__u8,__u64;
@@
 struct nvme_nvm_identity {  __u8 opcode ;  __u8 flags ;  __u16 command_id ;  __le32 nsid ;  __u64 rsvd [ 2 ] ;  __le64 prp1 ;  __le64 prp2 ;  __u32 rsvd11 [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_command * cocci_id@p ;
...
position p;
@@
 struct nvm_addrf_12 * cocci_id@p ;
...
typedef __le32,__u8;
@@
 struct nvme_nvm_bb_tbl {  __u8 tblid [ 4 ] ;  __le16 verid ;  __le16 revid ;  __le32 rvsd1 ;  __le32 tblks ;  __le32 tfact ;  __le32 tgrown ;  __le32 tdresv ;  __le32 thresv ;  __le32 rsvd2 [ 8 ] ;  __u8 blk [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_erase_blk cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_command {  union {  struct nvme_common_command common ;  struct nvme_nvm_ph_rw ph_rw ;  struct nvme_nvm_erase_blk erase ;  struct nvme_nvm_identity identity ;  struct nvme_nvm_getbbtbl get_bb ;  struct nvme_nvm_setbbtbl set_bb ; } ; } cocci_id@p ;
...
typedef __le32,__le64,__u16,__u8,__u64;
@@
 struct nvme_nvm_erase_blk {  __u8 opcode ;  __u8 flags ;  __u16 command_id ;  __le32 nsid ;  __u64 rsvd [ 2 ] ;  __le64 prp1 ;  __le64 prp2 ;  __le64 spba ;  __le16 length ;  __le16 control ;  __le32 dsmgmt ;  __le64 resv ; } cocci_id@p ;
...
position p;
@@
 enum nvme_nvm_log_page { NVME_NVM_LOG_REPORT_CHUNK = 0xca , } cocci_id@p ;
...
position p;
@@
 struct nvm_user_vio cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_identity cocci_id@p ;
...
position p;
@@
 struct nvme_nvm_id12 cocci_id@p ;
...
typedef __le64,__u8;
@@
 struct nvme_nvm_chk_meta {  __u8 state ;  __u8 type ;  __u8 wi ;  __u8 rsvd [ 5 ] ;  __le64 slba ;  __le64 cnlb ;  __le64 wp ; } cocci_id@p ;
...
typedef __le32,__le64,__u32,__u16,__u8,__u64;
@@
 struct nvme_nvm_getbbtbl {  __u8 opcode ;  __u8 flags ;  __u16 command_id ;  __le32 nsid ;  __u64 rsvd [ 2 ] ;  __le64 prp1 ;  __le64 prp2 ;  __le64 spba ;  __u32 rsvd4 [ 4 ] ; } cocci_id@p ;
