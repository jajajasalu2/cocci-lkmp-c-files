...
position p;
@@
 struct nf_flow_match * cocci_id@p ;
...
position p;
@@
 const struct flow_offload * cocci_id@p ;
...
position p;
@@
 enum flow_cls_command cocci_id@p ;
...
position p;
@@
 const struct flow_offload_tuple * cocci_id@p ;
...
position p;
@@
 struct flow_offload_work {  struct list_head list ;  enum flow_cls_command cmd ;  int priority ;  struct nf_flowtable * flowtable ;  struct flow_offload * flow ; } cocci_id@p ;
...
position p;
@@
 enum flow_offload_tuple_dir cocci_id@p ;
...
position p;
@@
 struct flow_offload_work cocci_id@p ;
...
position p;
@@
 struct nf_flow_match {  struct flow_dissector dissector ;  struct nf_flow_key key ;  struct nf_flow_key mask ; } cocci_id@p ;
...
position p;
@@
 const struct flow_offload_work * cocci_id@p ;
...
position p;
@@
 struct nf_flowtable * cocci_id@p ;
...
position p;
@@
 struct nf_flow_rule * cocci_id@p ;
...
position p;
@@
 struct nf_flow_rule * cocci_id@p [ FLOW_OFFLOAD_DIR_MAX ] ;
...
position p;
@@
 struct flow_stats cocci_id@p [ FLOW_OFFLOAD_DIR_MAX ] ;
...
position p;
@@
 const struct nf_flowtable * cocci_id@p ;
...
position p;
@@
 struct flow_offload * cocci_id@p ;
...
position p;
@@
 struct nf_flow_rule {  struct nf_flow_match match ;  struct flow_rule * rule ; } cocci_id@p ;
