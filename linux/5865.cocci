...
position p;
@@
 const struct {  struct sh_pfc_function common [ 58 ] ;  struct sh_pfc_function automotive [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 const struct {  struct sh_pfc_pin_group common [ 346 ] ;  struct sh_pfc_pin_group automotive [ 9 ] ; } cocci_id@p ;
