...
position p;
@@
 struct davinci_vcif_dev cocci_id@p ;
...
position p;
@@
 struct davinci_vcif_dev {  struct davinci_vc * davinci_vc ;  struct snd_dmaengine_dai_dma_data dma_data [ 2 ] ;  int dma_request [ 2 ] ; } cocci_id@p ;
