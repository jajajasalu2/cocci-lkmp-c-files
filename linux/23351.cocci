...
position p;
@@
 struct filter_control cocci_id@p ;
...
position p;
@@
 enum amic_idx { AMIC_IDX_1A , AMIC_IDX_1B , AMIC_IDX_2 , } cocci_id@p ;
...
position p;
@@
 struct ab8500_codec_drvdata cocci_id@p ;
...
position p;
@@
 struct amic_settings * cocci_id@p ;
...
position p;
@@
 struct ab8500_codec_platform_data cocci_id@p ;
...
position p;
@@
 struct ab8500_codec_drvdata_dbg {  struct regulator * vaud ;  struct regulator * vamic1 ;  struct regulator * vamic2 ;  struct regulator * vdmic ; } cocci_id@p ;
...
position p;
@@
 enum ab8500_filter { AB8500_FILTER_ANC_FIR = 0 , AB8500_FILTER_ANC_IIR = 1 , AB8500_FILTER_SID_FIR = 2 , } cocci_id@p ;
...
position p;
@@
 struct ab8500_codec_drvdata {  struct regmap * regmap ;  struct mutex ctrl_lock ;  long * sid_fir_values ;  enum sid_state sid_status ;  long * anc_fir_values ;  long * anc_iir_values ;  enum anc_state anc_status ; } cocci_id@p ;
...
position p;
@@
 enum anc_state { ANC_UNCONFIGURED = 0 , ANC_APPLY_FIR_IIR = 1 , ANC_FIR_IIR_CONFIGURED = 2 , ANC_APPLY_FIR = 3 , ANC_FIR_CONFIGURED = 4 , ANC_APPLY_IIR = 5 , ANC_IIR_CONFIGURED = 6 , } cocci_id@p ;
...
position p;
@@
 enum sid_state { SID_UNCONFIGURED = 0 , SID_APPLY_FIR = 1 , SID_FIR_CONFIGURED = 2 , } cocci_id@p ;
...
position p;
@@
 enum ear_cm_voltage cocci_id@p ;
