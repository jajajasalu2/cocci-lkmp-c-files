...
position p;
@@
 struct mcfqspi_platform_data * cocci_id@p ;
...
@@
 struct mcfqspi {  void __iomem * iobase ;  int irq ;  struct clk * clk ;  struct mcfqspi_cs_control * cs_control ;  wait_queue_head_t waitq ; } cocci_id@p ;
