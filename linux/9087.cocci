...
position p;
@@
 enum { MLX5_EQ_POLLING_BUDGET = 128 , } cocci_id@p ;
...
position p;
@@
 enum { MLX5_EQE_OWNER_INIT_VAL = 0x1 , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_eq_out ) ] ;
...
position p;
@@
 struct mlx5_eq_table * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_eq_out ) ] ;
...
position p;
@@
 enum { MLX5_EQ_STATE_ARMED = 0x9 , MLX5_EQ_STATE_FIRED = 0xa , MLX5_EQ_STATE_ALWAYS_ARMED = 0xb , } cocci_id@p ;
...
position p;
@@
 struct mlx5_eq_async cocci_id@p ;
...
position p;
@@
 enum { MLX5_EQ_DOORBEL_OFFSET = 0x40 , } cocci_id@p ;
...
position p;
@@
 struct mlx5_eq_comp cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_eq_in ) ] ;
...
position p;
@@
 struct mlx5_cq_table * cocci_id@p ;
...
position p;
@@
 struct mlx5_eq_table {  struct list_head comp_eqs_list ;  struct mlx5_eq_async pages_eq ;  struct mlx5_eq_async cmd_eq ;  struct mlx5_eq_async async_eq ;  struct atomic_notifier_head nh [ MLX5_EVENT_TYPE_MAX ] ;  struct mlx5_nb cq_err_nb ;  struct mutex lock ;  int num_comp_eqs ;  struct mlx5_irq_table * irq_table ; } cocci_id@p ;
