...
position p;
@@
 int cocci_id@p ( struct mibrec * mib , int isget , struct wlandevice * wlandev , struct hfa384x * hw , struct p80211msg_dot11req_mibset * msg , void * data ) ;
...
typedef u32,u16;
@@
 struct mibrec {  u32 did ;  u16 flag ;  u16 parm1 ;  u16 parm2 ;  u16 parm3 ;  int ( * func ) ( struct mibrec * mib , int isget , struct wlandevice * wlandev , struct hfa384x * hw , struct p80211msg_dot11req_mibset * msg , void * data ) ; } cocci_id@p ;
...
position p;
@@
 struct hfa384x_wpa_data cocci_id@p ;
