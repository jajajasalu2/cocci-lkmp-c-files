...
position p;
@@
 struct kvaser_cmd_busparams cocci_id@p ;
...
position p;
@@
 const struct kvaser_usb * cocci_id@p ;
...
position p;
@@
 const struct kvaser_usb_err_summary * cocci_id@p ;
...
position p;
@@
 struct kvaser_cmd_simple cocci_id@p ;
...
position p;
@@
 const struct kvaser_cmd * cocci_id@p ;
...
position p;
@@
 struct kvaser_cmd_ctrl_mode cocci_id@p ;
...
position p;
@@
 struct kvaser_usb_err_summary * cocci_id@p ;
...
position p;
@@
 struct kvaser_usb_tx_urb_context * cocci_id@p ;
...
position p;
@@
 struct kvaser_usb_net_priv * cocci_id@p ;
...
position p;
@@
 struct kvaser_cmd_flush_queue cocci_id@p ;
...
position p;
@@
 const struct kvaser_usb_net_priv * cocci_id@p ;
...
position p;
@@
 struct kvaser_usb_dev_card_data * cocci_id@p ;
...
position p;
@@
 struct kvaser_cmd_tx_can cocci_id@p ;
...
position p;
@@
 const struct kvaser_usb_dev_cfg cocci_id@p ;
...
position p;
@@
 const struct kvaser_usb_dev_ops cocci_id@p ;
