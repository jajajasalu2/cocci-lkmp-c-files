...
position p;
@@
 struct ufs_buffer_head * cocci_id@p [ 3 ] ;
...
position p;
@@
 struct {  void * p ;  union {  __fs32 key32 ;  __fs64 key64 ; } ;  struct buffer_head * bh ; } cocci_id@p ;
...
typedef u64;
@@
 struct to_free {  struct inode * inode ;  u64 to ;  unsigned count ; } cocci_id@p ;
