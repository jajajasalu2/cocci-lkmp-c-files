...
position p;
@@
 struct nx_host_sds_ring * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct netxen_adapter * , bool ) ;
...
position p;
@@
 struct netxen_cmd_buffer * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , unsigned long ) ;
...
position p;
@@
 struct netxen_legacy_intr_set cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct netxen_adapter * adapter ) ;
...
position p;
@@
 struct netxen_adapter cocci_id@p ;
...
position p;
@@
 struct netxen_skb_frag * cocci_id@p ;
...
position p;
@@
 struct netxen_recv_context * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NETXEN_MAX_SHORT_NAME ] ;
...
position p;
@@
 struct netxen_dimm_cfg cocci_id@p ;
...
position p;
@@
 struct netxen_hardware_context * cocci_id@p ;
...
position p;
@@
 struct nx_host_rds_ring * cocci_id@p ;
...
position p;
@@
 struct nx_host_tx_ring * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct netxen_adapter * adapter ) ;
