...
position p;
@@
 struct Nala_table_entry * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ PWC_FPS_MAX_NALA ] ;
...
position p;
@@
 const struct Timon_table_entry * cocci_id@p ;
...
position p;
@@
 const struct Kiara_table_entry * cocci_id@p ;
...
position p;
@@
 struct Nala_table_entry {  char alternate ;  int compressed ;  unsigned char mode [ 3 ] ; } cocci_id@p ;
