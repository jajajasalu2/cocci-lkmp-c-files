...
position p;
@@
 struct loopback_device {  char name [ MAX_SYSFS_PATH ] ;  char sysfs_entry [ MAX_SYSFS_PATH ] ;  char debugfs_entry [ MAX_SYSFS_PATH ] ;  struct loopback_results results ; } cocci_id@p ;
...
position p;
@@
 struct loopback_device * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_SYSFS_PATH ] ;
...
position p;
@@
 struct loopback_test * cocci_id@p ;
...
position p;
@@
 struct dict {  char * name ;  int type ; } cocci_id@p ;
...
position p;
@@
 struct loopback_results * cocci_id@p ;
...
typedef uint32_t;
@@
 struct loopback_results {  float latency_avg ;  uint32_t latency_max ;  uint32_t latency_min ;  uint32_t latency_jitter ;  float request_avg ;  uint32_t request_max ;  uint32_t request_min ;  uint32_t request_jitter ;  float throughput_avg ;  uint32_t throughput_max ;  uint32_t throughput_min ;  uint32_t throughput_jitter ;  float apbridge_unipro_latency_avg ;  uint32_t apbridge_unipro_latency_max ;  uint32_t apbridge_unipro_latency_min ;  uint32_t apbridge_unipro_latency_jitter ;  float gbphy_firmware_latency_avg ;  uint32_t gbphy_firmware_latency_max ;  uint32_t gbphy_firmware_latency_min ;  uint32_t gbphy_firmware_latency_jitter ;  uint32_t error ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct loopback_test * t , int dev_idx ) ;
