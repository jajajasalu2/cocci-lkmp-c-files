...
position p;
@@
 struct sun4i_ps2data cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sun4i_ps2data {  struct serio * serio ;  struct device * dev ;  void __iomem * reg_base ;  struct clk * clk ;  spinlock_t lock ;  int irq ; } cocci_id@p ;
