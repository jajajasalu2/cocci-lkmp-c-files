...
position p;
@@
 struct xxhash64_tfm_ctx cocci_id@p ;
...
position p;
@@
 struct xxhash64_desc_ctx cocci_id@p ;
...
position p;
@@
 struct xxhash64_desc_ctx {  struct xxh64_state xxhstate ; } cocci_id@p ;
...
typedef u64;
@@
 struct xxhash64_tfm_ctx {  u64 seed ; } cocci_id@p ;
