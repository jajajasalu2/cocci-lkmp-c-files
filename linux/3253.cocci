...
position p;
@@
 struct hwmon_device cocci_id@p ;
...
position p;
@@
 struct hwmon_device_attribute cocci_id@p ;
...
typedef u32;
@@
 struct hwmon_device_attribute {  struct device_attribute dev_attr ;  const struct hwmon_ops * ops ;  enum hwmon_sensor_types type ;  u32 attr ;  int index ;  char name [ MAX_SYSFS_ATTR_NAME_LENGTH ] ; } cocci_id@p ;
...
position p;
@@
 struct hwmon_thermal_data {  struct hwmon_device * hwdev ;  int index ; } cocci_id@p ;
...
position p;
@@
 struct hwmon_device {  const char * name ;  struct device dev ;  const struct hwmon_chip_info * chip ;  struct attribute_group group ;  const struct attribute_group * * groups ; } cocci_id@p ;
...
position p;
@@
 struct hwmon_thermal_data * cocci_id@p ;
