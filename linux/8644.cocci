...
typedef u64;
@@
 struct i40e_pfc_stats {  u64 priority_xon_rx ;  u64 priority_xoff_rx ;  u64 priority_xon_tx ;  u64 priority_xoff_tx ;  u64 priority_xon_2_xoff ; } cocci_id@p ;
...
position p;
@@
 struct i40e_rx_flow_userdef cocci_id@p ;
...
position p;
@@
 const struct i40e_stats * cocci_id@p ;
...
position p;
@@
 struct i40e_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
...
typedef u64,bool;
@@
 struct i40e_priv_flags {  char flag_string [ ETH_GSTRING_LEN ] ;  u64 flag ;  bool read_only ; } cocci_id@p ;
...
position p;
@@
 const struct i40e_priv_flags * cocci_id@p ;
...
position p;
@@
 struct i40e_nvm_access * cocci_id@p ;
...
position p;
@@
 struct i40e_pfc_stats cocci_id@p ;
...
position p;
@@
 enum i40e_ethtool_test_id { I40E_ETH_TEST_REG = 0 , I40E_ETH_TEST_EEPROM , I40E_ETH_TEST_INTR , I40E_ETH_TEST_LINK , } cocci_id@p ;
