...
position p;
@@
 struct hdmi_i2c_dev cocci_id@p ;
...
position p;
@@
 struct hdmi_i2c_dev {  struct i2c_adapter * adap ;  struct mutex i2c_lock ;  struct completion complete ;  int status ;  struct i2c_msg * msg ;  int buf_offset ; } cocci_id@p ;
