...
position p;
@@
 struct smk_port_label * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SMK_NUM_ACCESS_TYPE + 1 ] ;
...
position p;
@@
 struct socket_smack * cocci_id@p ;
...
position p;
@@
 struct smk_net4addr * cocci_id@p ;
...
position p;
@@
 struct smack_known_list_elem cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ TRANS_TRUE_SIZE ] ;
...
position p;
@@
 struct smk_net6addr * cocci_id@p ;
...
position p;
@@
 struct smack_mnt_opts * cocci_id@p ;
...
position p;
@@
 struct superblock_smack cocci_id@p ;
...
position p;
@@
 struct smk_audit_info cocci_id@p ;
...
position p;
@@
 struct {  const char * name ;  int len ;  int opt ; } cocci_id@p [ ] ;
