...
position p;
@@
 struct kunit_test_resource_context * cocci_id@p ;
...
typedef bool;
@@
 struct kunit_test_resource_context {  struct kunit test ;  bool is_resource_initialized ;  int allocate_order [ 2 ] ;  int free_order [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct kunit_try_catch_test_context * cocci_id@p ;
...
position p;
@@
 struct kunit_resource * cocci_id@p [ 5 ] ;
...
typedef bool;
@@
 struct kunit_try_catch_test_context {  struct kunit_try_catch * try_catch ;  bool function_called ; } cocci_id@p ;
