...
position p;
@@
 struct pci_p2pdma_pagemap cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pci_bus_addr_t;
@@
 pci_bus_addr_t cocci_id@p ;
...
position p;
@@
 enum pci_p2pdma_map_type cocci_id@p ;
...
position p;
@@
 const struct pci_p2pdma_whitelist_entry * cocci_id@p ;
...
position p;
@@
 enum pci_p2pdma_map_type { PCI_P2PDMA_MAP_UNKNOWN = 0 , PCI_P2PDMA_MAP_NOT_SUPPORTED , PCI_P2PDMA_MAP_BUS_ADDR , PCI_P2PDMA_MAP_THRU_HOST_BRIDGE , } cocci_id@p ;
...
typedef bool;
@@
 struct pci_p2pdma {  struct gen_pool * pool ;  bool p2pmem_published ;  struct xarray map_types ; } cocci_id@p ;
...
typedef u64;
@@
 struct pci_p2pdma_pagemap {  struct dev_pagemap pgmap ;  struct pci_dev * provider ;  u64 bus_offset ; } cocci_id@p ;
