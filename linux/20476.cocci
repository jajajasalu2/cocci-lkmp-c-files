...
typedef bool;
@@
 long cocci_id@p ( struct vm86plus_struct __user * user_vm86 , bool plus ) ;
...
position p;
@@
 int cocci_id@p ( int subfunction , int irqnumber ) ;
...
position p;
@@
 struct kernel_vm86_regs * cocci_id@p ;
...
position p;
@@
 struct vm86plus_info_struct * cocci_id@p ;
...
position p;
@@
 struct revectored_struct * cocci_id@p ;
...
position p;
@@
 struct vm86_irqs {  struct task_struct * tsk ;  int sig ; } cocci_id@p [ 16 ] ;
