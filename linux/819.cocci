...
position p;
@@
 struct aspm_register_info * cocci_id@p ;
...
typedef u32;
@@
 struct aspm_register_info {  u32 support : 2 ;  u32 enabled : 2 ;  u32 latency_encoding_l0s ;  u32 latency_encoding_l1 ;  u32 l1ss_cap_ptr ;  u32 l1ss_cap ;  u32 l1ss_ctl1 ;  u32 l1ss_ctl2 ; } cocci_id@p ;
...
typedef u32;
@@
 struct pcie_link_state {  struct pci_dev * pdev ;  struct pci_dev * downstream ;  struct pcie_link_state * root ;  struct pcie_link_state * parent ;  struct list_head sibling ;  u32 aspm_support : 7 ;  u32 aspm_enabled : 7 ;  u32 aspm_capable : 7 ;  u32 aspm_default : 7 ;  u32 aspm_disable : 7 ;  u32 clkpm_capable : 1 ;  u32 clkpm_enabled : 1 ;  u32 clkpm_default : 1 ;  u32 clkpm_disable : 1 ;  struct aspm_latency latency_up ;  struct aspm_latency latency_dw ;  struct aspm_latency acceptable [ 8 ] ;  struct {  u32 up_cap_ptr ;  u32 dw_cap_ptr ;  u32 ctl1 ;  u32 ctl2 ; } l1ss ; } cocci_id@p ;
...
typedef u32;
@@
 struct aspm_latency {  u32 l0s ;  u32 l1 ; } cocci_id@p ;
...
position p;
@@
 struct aspm_latency * cocci_id@p ;
...
position p;
@@
 struct pcie_link_state * cocci_id@p ;
