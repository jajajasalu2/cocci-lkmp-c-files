...
symbol cocci_id;
position p;
typedef bool,u16,spinlock_t;
@@
 struct qede_ptp {  const struct qed_eth_ptp_ops * ops ;  struct ptp_clock_info clock_info ;  struct cyclecounter cc ;  struct timecounter tc ;  struct ptp_clock * clock ;  struct work_struct work ;  unsigned long ptp_tx_start ;  struct qede_dev * edev ;  struct sk_buff * tx_skb ;  spinlock_t lock ;  bool hw_ts_ioctl_called ;  u16 tx_type ;  u16 rx_filter ; } cocci_id@p ;
...
position p;
@@
 enum qed_ptp_hwtstamp_tx_type cocci_id@p ;
...
position p;
@@
 enum qed_ptp_filter_type cocci_id@p ;
