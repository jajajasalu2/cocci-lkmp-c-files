...
symbol cocci_id;
position p;
typedef __le32,rx_status_t;
@@
 struct rx_status_t {  __le32 statusinfo ;  __le32 statushashcrc ; } cocci_id@p ;
...
position p;
@@
 struct netdata_local * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,txrx_desc_t;
@@
 struct txrx_desc_t {  __le32 packet ;  __le32 control ; } cocci_id@p ;
