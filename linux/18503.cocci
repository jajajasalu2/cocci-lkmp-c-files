...
position p;
@@
 struct s3c64xx_pm_domain * cocci_id@p ;
...
position p;
@@
 const struct samsung_wakeup_mask cocci_id@p [ ] ;
...
typedef u32;
@@
 struct s3c64xx_pm_domain {  char * const name ;  u32 ena ;  u32 pwr_stat ;  struct generic_pm_domain pd ; } cocci_id@p ;
