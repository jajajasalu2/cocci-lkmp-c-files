...
position p;
@@
 union msr_fidvidctl cocci_id@p ;
...
symbol cocci_id;
position p;
typedef powernow_acpi_control_t;
@@
 union powernow_acpi_control_t cocci_id@p ;
...
typedef u8,u32;
@@
 struct pst_s {  u32 cpuid ;  u8 fsbspeed ;  u8 maxfid ;  u8 startvid ;  u8 numpstates ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct psb_s {  u8 signature [ 10 ] ;  u8 tableversion ;  u8 flags ;  u16 settlingtime ;  u8 reserved1 ;  u8 numpst ; } cocci_id@p ;
...
typedef powernow_acpi_control_t;
@@
 union powernow_acpi_control_t {  struct {  unsigned long fid : 5 , vid : 5 , sgtc : 20 , res1 : 2 ; } bits ;  unsigned long val ; } cocci_id@p ;
...
position p;
@@
 struct acpi_processor_px * cocci_id@p ;
...
position p;
@@
 union msr_fidvidstatus cocci_id@p ;
