...
position p;
@@
 struct xgene_pcie_port * cocci_id@p ;
...
typedef bool,u32;
@@
 struct xgene_pcie_port {  struct device_node * node ;  struct device * dev ;  struct clk * clk ;  void __iomem * csr_base ;  void __iomem * cfg_base ;  unsigned long cfg_addr ;  bool link_up ;  u32 version ; } cocci_id@p ;
