...
position p;
@@
 const struct ixp4xx_irq_chunk cocci_id@p [ ] ;
...
position p;
@@
 struct ixp4xx_irq_chunk {  int irq ;  int hwirq ;  int nr_irqs ; } cocci_id@p ;
...
typedef bool;
@@
 struct ixp4xx_irq {  void __iomem * irqbase ;  bool is_356 ;  struct irq_chip irqchip ;  struct irq_domain * domain ; } cocci_id@p ;
