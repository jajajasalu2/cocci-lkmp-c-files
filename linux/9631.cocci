...
position p;
@@
 struct nphy_iq_comp * cocci_id@p ;
...
typedef u8;
@@
 struct nphy_txiqcal_ladder {  u8 percent ;  u8 g_env ; } cocci_id@p ;
...
position p;
@@
 struct nphy_papd_restore_state * cocci_id@p ;
...
position p;
@@
 struct nphy_iqcal_params cocci_id@p [ 2 ] ;
...
position p;
@@
 struct nphy_ipa_txcalgains * cocci_id@p ;
...
position p;
@@
 struct radio_20xx_regs cocci_id@p [ ] ;
...
position p;
@@
 struct phy_iq_est cocci_id@p [ PHY_CORE_MAX ] ;
...
position p;
@@
 struct nphy_iqcal_params * cocci_id@p ;
...
position p;
@@
 const struct chan_info_nphy_2055 * * cocci_id@p ;
...
position p;
@@
 const struct chan_info_nphy_radio205x * cocci_id@p ;
...
typedef u16;
@@
 struct nphy_sfo_cfg {  u16 PHY_BW1a ;  u16 PHY_BW2 ;  u16 PHY_BW3 ;  u16 PHY_BW4 ;  u16 PHY_BW5 ;  u16 PHY_BW6 ; } cocci_id@p ;
...
position p;
@@
 const struct nphy_sfo_cfg * cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ ] [ NPHY_NUM_DIG_FILT_COEFFS ] ;
...
position p;
@@
 const struct chan_info_nphy_radio2057_rev5 * * cocci_id@p ;
...
typedef s8,u16;
@@
 struct nphy_ipa_txrxgain {  u16 hpvga ;  u16 lpf_biq1 ;  u16 lpf_biq0 ;  u16 lna2 ;  u16 lna1 ;  s8 txpwrindex ; } cocci_id@p ;
...
position p;
@@
 const struct nphy_ipa_txrxgain * cocci_id@p ;
...
typedef u16;
@@
 struct nphy_papd_restore_state {  u16 fbmix [ 2 ] ;  u16 vga_master [ 2 ] ;  u16 intpa_master [ 2 ] ;  u16 afectrl [ 2 ] ;  u16 afeoverride [ 2 ] ;  u16 pwrup [ 2 ] ;  u16 atten [ 2 ] ;  u16 mm ; } cocci_id@p ;
...
typedef u16;
@@
 struct nphy_iqcal_params {  u16 txlpf ;  u16 txgm ;  u16 pga ;  u16 pad ;  u16 ipa ;  u16 cal_gain ;  u16 ncorr [ 5 ] ; } cocci_id@p ;
...
position p;
@@
 const struct chan_info_nphy_radio2057 * cocci_id@p ;
...
typedef u8,bool;
@@
 struct nphy_ipa_txcalgains {  struct nphy_txgains gains ;  bool useindex ;  u8 index ; } cocci_id@p ;
...
position p;
@@
 struct brcms_phy_pub * cocci_id@p ;
...
position p;
@@
 const struct radio_regs cocci_id@p [ ] ;
...
position p;
@@
 struct nphy_ipa_txcalgains cocci_id@p [ 2 ] ;
...
position p;
@@
 struct nphy_txgains cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ 2 ] [ NPHY_IQCAL_NUMGAINS ] [ 8 ] ;
...
position p;
@@
 const struct nphy_txiqcal_ladder cocci_id@p [ ] ;
...
position p;
@@
 enum { NPHY_RXCAL_GAIN_INIT = 0 , NPHY_RXCAL_GAIN_UP , NPHY_RXCAL_GAIN_DOWN , } cocci_id@p ;
