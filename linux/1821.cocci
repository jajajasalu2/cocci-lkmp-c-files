...
typedef u8;
@@
 const u8 cocci_id@p [ CM32181_CONF_REG_NUM ] ;
...
typedef u16;
@@
 struct cm32181_chip {  struct i2c_client * client ;  struct mutex lock ;  u16 conf_regs [ CM32181_CONF_REG_NUM ] ;  int calibscale ; } cocci_id@p ;
...
position p;
@@
 struct cm32181_chip * cocci_id@p ;
