...
position p;
@@
 const struct intel_uc_fw * cocci_id@p ;
...
position p;
@@
 const struct uc_fw_platform_requirement cocci_id@p [ ] ;
...
position p;
@@
 struct uc_css_header cocci_id@p ;
...
position p;
@@
 enum intel_uc_fw_status cocci_id@p ;
...
position p;
@@
 const struct uc_fw_blob * cocci_id@p ;
...
typedef u8;
@@
 struct __packed uc_fw_blob {  u8 major ;  u8 minor ;  const char * path ; } cocci_id@p ;
...
typedef u8;
@@
 struct __packed uc_fw_platform_requirement {  enum intel_platform p ;  u8 rev ;  const struct uc_fw_blob blobs [ INTEL_UC_FW_NUM_TYPES ] ; } cocci_id@p ;
...
position p;
@@
 enum intel_uc_fw_type cocci_id@p ;
