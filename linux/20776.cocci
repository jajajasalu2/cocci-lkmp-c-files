...
position p;
@@
 struct vcpu_register_time_memory_area cocci_id@p ;
...
position p;
@@
 const struct pv_time_ops cocci_id@p ;
...
position p;
@@
 const struct clock_event_device * cocci_id@p ;
...
position p;
@@
 struct xen_clock_event_device * cocci_id@p ;
...
position p;
@@
 struct vcpu_set_singleshot_timer cocci_id@p ;
...
position p;
@@
 struct xen_clock_event_device {  struct clock_event_device evt ;  char name [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 struct pvclock_vsyscall_time_info * cocci_id@p ;
