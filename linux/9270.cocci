...
position p;
@@
 struct host_cmd_ds_rf_ant_siso cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_set_bss_mode cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_header cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_mem_access cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_encrypt_key * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ps_param_in_hs cocci_id@p ;
...
position p;
@@
 struct mwifiex_aes_param cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_snmp_mib * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_extcap * cocci_id@p ;
...
position p;
@@
 struct mwifiex_types_power_group cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_txpwr_cfg cocci_id@p ;
...
position p;
@@
 struct mwifiex_adapter * cocci_id@p ;
...
position p;
@@
 struct mwifiex_tdls_init_cs_params * cocci_id@p ;
...
position p;
@@
 struct pcie_service_card * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_vhtcap cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_gtk_rekey_params * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_key_material_v2 * cocci_id@p ;
...
position p;
@@
 struct mwifiex_tdls_config * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_get_log cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_robust_coex * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_mef_cfg * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_tdls_oper cocci_id@p ;
...
position p;
@@
 struct host_cmd_sdio_sp_rx_aggr_cfg * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_tx_rate_query cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_subsc_evt cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_eeprom_access * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11d_domain_info * cocci_id@p ;
...
position p;
@@
 struct coalesce_receive_filt_rule * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_command * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_tx_rate_cfg cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_rssi_info cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_mef_cfg * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_aid * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_channel_band * cocci_id@p ;
...
position p;
@@
 struct mwifiex_cmac_param * cocci_id@p ;
...
position p;
@@
 struct mwifiex_tdls_stop_cs_params cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_multi_chan_policy cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_rssi_threshold * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_rates cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_version_ext cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_tdls_oper * cocci_id@p ;
...
position p;
@@
 struct ieee80211_country_ie_triplet cocci_id@p ;
...
position p;
@@
 struct mwifiex_fw_mef_entry * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_hs_cfg_enh cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_robust_coex * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_qos_info * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_pcie_details * cocci_id@p ;
...
position p;
@@
 struct ieee80211_vht_cap cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_mac_address cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_ant_cfg * cocci_id@p ;
...
position p;
@@
 struct mwifiex_rate_drop_pattern cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_coalesce_cfg * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_rf_ant_mimo cocci_id@p ;
...
position p;
@@
 struct mwifiex_rate_scope * cocci_id@p ;
...
position p;
@@
 struct mwifiex_mef_entry * cocci_id@p ;
...
position p;
@@
 struct mwifiex_tdls_config_cs_params cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_misc_subsc_evt * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_tdls_idle_timeout * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_bbp_reg_access * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_wmm_get_status cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_mac_addr cocci_id@p ;
...
position p;
@@
 struct ieee80211_ht_cap cocci_id@p ;
...
position p;
@@
 struct coalesce_filt_field_param * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_htcap * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_mem_rw * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_pkt_aggr_ctrl cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_pmic_reg_access * cocci_id@p ;
...
position p;
@@
 struct mwifiex_multicast_list * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_11n_tx_cfg cocci_id@p ;
...
position p;
@@
 struct mwifiex_tkip_param cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_wakeup_reason cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_coalesce_cfg * cocci_id@p ;
...
position p;
@@
 struct mwifiex_wapi_param cocci_id@p ;
...
position p;
@@
 struct mwifiex_wep_param cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_remain_on_chan cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_type_key_param_set_v2 cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_reg_rw * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_rf_tx_pwr cocci_id@p ;
...
position p;
@@
 struct mwifiex_mef_filter * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_key_material * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_mac_control cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_tdls_config * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_read_eeprom * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_auto_ds cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_type_key_param_set cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_mgmt_frame_reg cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_mac_reg_access * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_deauthenticate cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_ibss_status cocci_id@p ;
...
position p;
@@
 struct mwifiex_hs_config_param * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_11n_amsdu_aggr_ctrl cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_mac_multicast_adr * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ietypes_domain_param_set * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_rf_reg_access * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_sta_configure * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_chan_region_cfg * cocci_id@p ;
...
position p;
@@
 struct mwifiex_private * cocci_id@p ;
...
position p;
@@
 struct mwifiex_cmac_aes_param cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_p2p_mode_cfg cocci_id@p ;
