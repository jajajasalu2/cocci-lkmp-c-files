...
position p;
@@
 struct pci9111_private_data * cocci_id@p ;
...
position p;
@@
 enum pci9111_ISC1_sources cocci_id@p ;
...
position p;
@@
 enum pci9111_ISC0_sources { irq_on_eoc , irq_on_fifo_half_full , } cocci_id@p ;
...
position p;
@@
 struct pci9111_private_data {  unsigned long lcr_io_base ;  unsigned int scan_delay ;  unsigned int chunk_counter ;  unsigned int chunk_num_samples ;  unsigned short ai_bounce_buffer [ 2 * PCI9111_FIFO_HALF_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 enum pci9111_ISC0_sources cocci_id@p ;
