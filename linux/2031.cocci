...
position p;
@@
 enum bma220_axis { AXIS_X , AXIS_Y , AXIS_Z , } cocci_id@p ;
...
typedef s8,u8;
@@
 struct bma220_data {  struct spi_device * spi_device ;  struct mutex lock ;  s8 buffer [ 16 ] ;  u8 tx_buf [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
