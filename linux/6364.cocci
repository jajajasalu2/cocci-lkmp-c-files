...
position p;
@@
 struct s5m8767_info cocci_id@p ;
...
position p;
@@
 const struct sec_voltage_desc * cocci_id@p [ ] ;
...
typedef u8,bool;
@@
 struct s5m8767_info {  struct device * dev ;  struct sec_pmic_dev * iodev ;  int num_regulators ;  struct sec_opmode_data * opmode ;  int ramp_delay ;  bool buck2_ramp ;  bool buck3_ramp ;  bool buck4_ramp ;  bool buck2_gpiodvs ;  bool buck3_gpiodvs ;  bool buck4_gpiodvs ;  u8 buck2_vol [ 8 ] ;  u8 buck3_vol [ 8 ] ;  u8 buck4_vol [ 8 ] ;  int buck_gpios [ 3 ] ;  int buck_ds [ 3 ] ;  int buck_gpioindex ; } cocci_id@p ;
...
position p;
@@
 struct sec_regulator_data * cocci_id@p ;
...
position p;
@@
 const struct sec_opmode_data * cocci_id@p ;
...
position p;
@@
 struct sec_opmode_data * cocci_id@p ;
...
position p;
@@
 struct sec_voltage_desc {  int max ;  int min ;  int step ; } cocci_id@p ;
