...
position p;
@@
 enum sun6i_dsi_inst_escape { DSI_INST_ESCA_LPDT = 0 , DSI_INST_ESCA_ULPS , DSI_INST_ESCA_UN1 , DSI_INST_ESCA_UN2 , DSI_INST_ESCA_RESET , DSI_INST_ESCA_UN3 , DSI_INST_ESCA_UN4 , DSI_INST_ESCA_UN5 , } cocci_id@p ;
...
position p;
@@
 enum sun6i_dsi_inst_mode cocci_id@p ;
...
position p;
@@
 struct phy_configure_opts_mipi_dphy * cocci_id@p ;
...
position p;
@@
 enum sun6i_dsi_inst_escape cocci_id@p ;
...
position p;
@@
 enum sun6i_dsi_inst_mode { DSI_INST_MODE_STOP = 0 , DSI_INST_MODE_TBA , DSI_INST_MODE_HS , DSI_INST_MODE_ESCAPE , DSI_INST_MODE_HSCEXIT , DSI_INST_MODE_NOP , } cocci_id@p ;
...
position p;
@@
 enum sun6i_dsi_inst_id cocci_id@p ;
...
position p;
@@
 enum sun6i_dsi_inst_packet cocci_id@p ;
...
position p;
@@
 enum sun6i_dsi_start_inst cocci_id@p ;
...
position p;
@@
 enum sun6i_dsi_inst_id { DSI_INST_ID_LP11 = 0 , DSI_INST_ID_TBA , DSI_INST_ID_HSC , DSI_INST_ID_HSD , DSI_INST_ID_LPDT , DSI_INST_ID_HSCEXIT , DSI_INST_ID_NOP , DSI_INST_ID_DLY , DSI_INST_ID_END = 15 , } cocci_id@p ;
...
position p;
@@
 enum sun6i_dsi_inst_packet { DSI_INST_PACK_PIXEL = 0 , DSI_INST_PACK_COMMAND , } cocci_id@p ;
...
position p;
@@
 enum sun6i_dsi_start_inst { DSI_START_LPRX , DSI_START_LPTX , DSI_START_HSC , DSI_START_HSD , } cocci_id@p ;
...
position p;
@@
 union phy_configure_opts cocci_id@p ;
