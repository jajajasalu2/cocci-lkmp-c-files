...
position p;
@@
 struct emc6w201_data cocci_id@p ;
...
typedef s8,u8,u16;
@@
 struct emc6w201_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u8 in [ 3 ] [ 6 ] ;  s8 temp [ 3 ] [ 6 ] ;  u16 fan [ 2 ] [ 5 ] ; } cocci_id@p ;
...
position p;
@@
 enum subfeature { input , min , max , } cocci_id@p ;
