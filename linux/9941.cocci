...
position p;
@@
 struct ar9170_rx_phystatus cocci_id@p ;
...
position p;
@@
 struct carl9170_rsp * cocci_id@p ;
...
position p;
@@
 struct ar9170_rx_macstatus * cocci_id@p ;
...
position p;
@@
 struct ar9170_stream * cocci_id@p ;
...
position p;
@@
 enum carl9170_restart_reasons cocci_id@p ;
