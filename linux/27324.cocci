...
position p;
@@
 struct asn1_octstr {  unsigned char * data ;  unsigned int len ; } cocci_id@p ;
...
position p;
@@
 struct asn1_ctx {  int error ;  unsigned char * pointer ;  unsigned char * begin ;  unsigned char * end ; } cocci_id@p ;
