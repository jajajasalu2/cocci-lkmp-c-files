...
position p;
@@
 struct sdm845_snd_data * cocci_id@p ;
...
@@
 struct sdm845_snd_data {  struct snd_soc_jack jack ;  bool jack_setup ;  struct snd_soc_card * card ;  uint32_t pri_mi2s_clk_count ;  uint32_t sec_mi2s_clk_count ;  uint32_t quat_tdm_clk_count ; } cocci_id@p ;
