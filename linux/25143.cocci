...
position p;
@@
 void ACPI_INTERNAL_VAR_XFACE cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ACPI_VPRINTF_BUFFER_SIZE ] ;
...
@@
 acpi_status cocci_id@p ( char * buffer , u32 buffer_length , u32 * bytes_read ) ;
...
position p;
@@
 void cocci_id@p ( struct acpi_table_header * existing_table , struct acpi_table_header * * new_table ) ;
