...
position p;
@@
 enum brcmf_btcoex_mode cocci_id@p ;
...
position p;
@@
 enum brcmf_btcoex_state { BRCMF_BT_DHCP_IDLE , BRCMF_BT_DHCP_START , BRCMF_BT_DHCP_OPPR_WIN , BRCMF_BT_DHCP_FLAG_FORCE_TIMEOUT , } cocci_id@p ;
...
position p;
@@
 struct brcmf_btcoex_info cocci_id@p ;
...
@@
 struct brcmf_btcoex_info {  struct brcmf_cfg80211_vif * vif ;  struct timer_list timer ;  u16 timeout ;  bool timer_on ;  bool dhcp_done ;  enum brcmf_btcoex_state bt_state ;  struct work_struct work ;  struct brcmf_cfg80211_info * cfg ;  u32 reg66 ;  u32 reg41 ;  u32 reg68 ;  bool saved_regs_part1 ;  u32 reg50 ;  u32 reg51 ;  u32 reg64 ;  u32 reg65 ;  u32 reg71 ;  bool saved_regs_part2 ; } cocci_id@p ;
...
typedef __le32;
@@
 struct {  __le32 addr ;  __le32 data ; } cocci_id@p ;
