...
position p;
@@
 struct dma_chan_request cocci_id@p ;
...
position p;
@@
 struct idmac_channel * cocci_id@p ;
...
position p;
@@
 struct mx3fb_platform_data * cocci_id@p ;
...
position p;
@@
 const struct di_mapping cocci_id@p [ ] ;
...
position p;
@@
 struct idmac_video_param * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,dma_cookie_t,uint32_t;
@@
 struct mx3fb_info {  int blank ;  enum ipu_channel ipu_ch ;  uint32_t cur_ipu_buf ;  u32 pseudo_palette [ 16 ] ;  struct completion flip_cmpl ;  struct mutex mutex ;  struct mx3fb_data * mx3fb ;  struct idmac_channel * idmac_channel ;  struct dma_async_tx_descriptor * txd ;  dma_cookie_t cookie ;  struct scatterlist sg [ 2 ] ;  struct fb_var_screeninfo cur_var ; } cocci_id@p ;
...
@@
 struct mx3fb_data {  struct fb_info * fbi ;  int backlight_level ;  void __iomem * reg_base ;  spinlock_t lock ;  struct device * dev ;  struct backlight_device * bl ;  uint32_t h_start_width ;  uint32_t v_start_width ;  enum disp_data_mapping disp_data_fmt ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int blank , struct fb_info * fbi ) ;
...
position p;
@@
 struct idmac_tx_desc * cocci_id@p ;
...
position p;
@@
 struct ipu_di_signal_cfg {  unsigned datamask_en : 1 ;  unsigned clksel_en : 1 ;  unsigned clkidle_en : 1 ;  unsigned data_pol : 1 ;  unsigned clk_pol : 1 ;  unsigned enable_pol : 1 ;  unsigned Hsync_pol : 1 ;  unsigned Vsync_pol : 1 ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct mx3fb_data * mx3fb ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_info * fbi ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct fb_info * fbi , unsigned int mem_len , bool lock ) ;
...
position p;
@@
 struct ipu_di_signal_cfg cocci_id@p ;
...
position p;
@@
 enum ipu_panel { IPU_PANEL_SHARP_TFT , IPU_PANEL_TFT , } cocci_id@p ;
...
position p;
@@
 struct dma_chan_request {  struct mx3fb_data * mx3fb ;  enum ipu_channel id ; } cocci_id@p ;
