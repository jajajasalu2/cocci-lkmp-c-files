...
position p;
@@
 enum rockchip_pll_type cocci_id@p ;
...
position p;
@@
 struct rockchip_pll_rate_table cocci_id@p ;
...
@@
 struct rockchip_clk_pll {  struct clk_hw hw ;  struct clk_mux pll_mux ;  const struct clk_ops * pll_mux_ops ;  struct notifier_block clk_nb ;  void __iomem * reg_base ;  int lock_offset ;  unsigned int lock_shift ;  enum rockchip_pll_type type ;  u8 flags ;  const struct rockchip_pll_rate_table * rate_table ;  unsigned int rate_count ;  spinlock_t * lock ;  struct rockchip_clk_provider * ctx ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_clk_pll cocci_id@p ;
...
position p;
@@
 const struct rockchip_pll_rate_table * cocci_id@p ;
