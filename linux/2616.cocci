...
position p;
@@
 struct ocotp_params {  unsigned int nregs ;  unsigned int bank_address_words ;  void ( * set_timing ) ( struct ocotp_priv * priv ) ; } cocci_id@p ;
...
position p;
@@
 const struct ocotp_params cocci_id@p ;
...
position p;
@@
 struct ocotp_priv {  struct device * dev ;  struct clk * clk ;  void __iomem * base ;  const struct ocotp_params * params ;  struct nvmem_config * config ; } cocci_id@p ;
