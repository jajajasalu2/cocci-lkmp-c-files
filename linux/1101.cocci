...
position p;
@@
 struct pxa_cpufreq_data * cocci_id@p ;
...
position p;
@@
 const struct pxa_freqs cocci_id@p [ ] ;
...
position p;
@@
 struct pxa_cpufreq_data {  struct clk * clk_core ; } cocci_id@p ;
...
position p;
@@
 struct cpufreq_frequency_table cocci_id@p [ NUM_PXA25x_RUN_FREQS + 1 ] ;
...
position p;
@@
 struct pxa_freqs {  unsigned int khz ;  int vmin ;  int vmax ; } cocci_id@p ;
...
position p;
@@
 struct cpufreq_frequency_table cocci_id@p [ NUM_PXA25x_TURBO_FREQS + 1 ] ;
...
position p;
@@
 struct cpufreq_frequency_table cocci_id@p [ NUM_PXA27x_FREQS + 1 ] ;
