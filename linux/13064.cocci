...
position p;
@@
 struct qcom_rmtfs_mem cocci_id@p ;
...
position p;
@@
 struct qcom_scm_vmperm cocci_id@p [ 2 ] ;
...
typedef phys_addr_t;
@@
 struct qcom_rmtfs_mem {  struct device dev ;  struct cdev cdev ;  void * base ;  phys_addr_t addr ;  phys_addr_t size ;  unsigned int client_id ;  unsigned int perms ; } cocci_id@p ;
