...
typedef bool;
@@
 struct vfio_pci_walk_info {  int ( * fn ) ( struct pci_dev * , void * data ) ;  void * data ;  struct pci_dev * pdev ;  bool slot ;  int ret ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vfio_pci_reflck * reflck ) ;
...
position p;
@@
 struct vfio_device_ioeventfd cocci_id@p ;
...
position p;
@@
 struct vfio_pci_fill_info * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct pci_dev * , void * data ) ;
...
position p;
@@
 struct vfio_pci_walk_info cocci_id@p ;
...
position p;
@@
 struct vfio_pci_group_entry {  struct vfio_group * group ;  int id ; } cocci_id@p ;
...
position p;
@@
 struct vfio_device_info cocci_id@p ;
...
position p;
@@
 struct vfio_pci_fill_info {  int max ;  int cur ;  struct vfio_pci_dependent_device * devices ; } cocci_id@p ;
...
position p;
@@
 struct vfio_pci_group_info {  int count ;  struct vfio_pci_group_entry * groups ; } cocci_id@p ;
...
position p;
@@
 struct vfio_pci_hot_reset_info cocci_id@p ;
...
position p;
@@
 struct vfio_devices * cocci_id@p ;
...
position p;
@@
 struct vfio_pci_hot_reset cocci_id@p ;
...
position p;
@@
 struct vfio_pci_ioeventfd * cocci_id@p ;
...
position p;
@@
 struct vfio_irq_info cocci_id@p ;
...
position p;
@@
 struct vfio_pci_group_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vfio_pci_device * vdev ) ;
...
position p;
@@
 struct vfio_pci_reflck * cocci_id@p ;
...
position p;
@@
 struct vfio_devices {  struct vfio_device * * devices ;  int cur_index ;  int max_index ; } cocci_id@p ;
...
position p;
@@
 struct vfio_pci_dummy_resource * cocci_id@p ;
...
position p;
@@
 struct vfio_region_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vfio_pci_device * vdev ) ;
...
position p;
@@
 struct vfio_pci_group_entry * cocci_id@p ;
...
position p;
@@
 struct vfio_pci_device * cocci_id@p ;
...
position p;
@@
 struct vfio_region_info_cap_type cocci_id@p ;
...
position p;
@@
 struct vfio_pci_region * cocci_id@p ;
...
position p;
@@
 const struct vfio_pci_regops * cocci_id@p ;
...
position p;
@@
 struct vfio_pci_dependent_device * cocci_id@p ;
