...
typedef u16;
@@
 int cocci_id@p ( struct mlxsw_sp * mlxsw_sp , struct mlxsw_sp_bridge_port * bridge_port , u16 fid_index ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct mlxsw_sp_port * mlxsw_sp_port , struct mlxsw_sp_bridge_port * bridge_port , bool add ) ;
...
position p;
@@
 struct mlxsw_sp_bridge * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_span_respin_work {  struct work_struct work ;  struct mlxsw_sp * mlxsw_sp ; } cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_sfd_op cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_fid * cocci_id@p ;
...
position p;
@@
 const struct switchdev_obj_port_mdb * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_bridge_device * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct mlxsw_sp_bridge_port {  struct net_device * dev ;  struct mlxsw_sp_bridge_device * bridge_device ;  struct list_head list ;  struct list_head vlans_list ;  unsigned int ref_count ;  u8 stp_state ;  unsigned long flags ;  bool mrouter ;  bool lagged ;  union {  u16 lag_id ;  u16 system_port ; } ; } cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_sfdf_flush_type cocci_id@p ;
...
position p;
@@
 const struct switchdev_attr * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_bridge_ops cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_sfd_uc_tunnel_protocol cocci_id@p ;
...
position p;
@@
 struct switchdev_notifier_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SFDAT_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_switchdev_event_work cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_bridge_ops cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_bridge * cocci_id@p ;
...
position p;
@@
 const struct switchdev_obj * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_port * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_bridge_port * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_switchdev_event_work {  struct work_struct work ;  union {  struct switchdev_notifier_fdb_info fdb_info ;  struct switchdev_notifier_vxlan_fdb_info vxlan_fdb_info ; } ;  struct net_device * dev ;  unsigned long event ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_span_respin_work * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlxsw_sp_port * mlxsw_sp_port , struct mlxsw_sp_bridge_port * bridge_port ) ;
...
position p;
@@
 struct switchdev_notifier_vxlan_fdb_info cocci_id@p ;
...
position p;
@@
 struct vxlan_config * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SFDF_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_nve_params cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_bridge_port * cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_sfn_uc_tunnel_protocol cocci_id@p ;
...
position p;
@@
 const union vxlan_addr * cocci_id@p ;
...
position p;
@@
 enum switchdev_notifier_type cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_bridge_vlan * cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_sfd_rec_action cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlxsw_sp_port * mlxsw_sp_port , struct mlxsw_sp_bridge_device * bridge_device ) ;
...
typedef u16;
@@
 struct mlxsw_sp_bridge_vlan {  struct list_head list ;  struct list_head port_vlan_list ;  u16 vid ; } cocci_id@p ;
...
position p;
@@
 struct switchdev_obj_port_vlan * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_bridge_device * cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_sfd_rec_policy cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_flood_type cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mid * cocci_id@p ;
...
position p;
@@
 struct switchdev_notifier_port_obj_info * cocci_id@p ;
