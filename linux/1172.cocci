...
typedef u8,u32,u16;
@@
 struct musb_dma_channel {  struct dma_channel channel ;  struct musb_dma_controller * controller ;  u32 start_addr ;  u32 len ;  u16 max_packet_sz ;  u8 idx ;  u8 epnum ;  u8 transmit ; } cocci_id@p ;
...
typedef u8;
@@
 struct musb_dma_controller {  struct dma_controller controller ;  struct musb_dma_channel channel [ MUSB_HSDMA_CHANNELS ] ;  void * private_data ;  void __iomem * base ;  u8 channel_count ;  u8 used_channels ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct musb_dma_controller cocci_id@p ;
...
position p;
@@
 struct musb_dma_channel * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dma_channel * channel ) ;
