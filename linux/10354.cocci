...
position p;
@@
 struct tda9950_priv * cocci_id@p ;
...
typedef bool,u16;
@@
 struct tda9950_priv {  struct i2c_client * client ;  struct device * hdmi ;  struct cec_adapter * adap ;  struct tda9950_glue * glue ;  u16 addresses ;  struct cec_msg rx_msg ;  struct cec_notifier * notify ;  bool open ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CEC_MAX_MSG_SIZE + 2 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ CEC_MAX_MSG_SIZE + 3 ] ;
...
position p;
@@
 struct tda9950_glue * cocci_id@p ;
