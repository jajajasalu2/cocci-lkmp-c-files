...
position p;
@@
 struct uniphier_u3hsphy_priv * cocci_id@p ;
...
position p;
@@
 const struct uniphier_u3hsphy_soc_data cocci_id@p ;
...
typedef sel_t;
@@
 struct uniphier_u3hsphy_trim_param {  unsigned int rterm ;  unsigned int sel_t ;  unsigned int hs_i ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_u3hsphy_trim_param * cocci_id@p ;
...
position p;
@@
 const struct uniphier_u3hsphy_param * cocci_id@p ;
...
typedef u8;
@@
 struct uniphier_u3hsphy_param {  struct {  int reg_no ;  int msb ;  int lsb ; } field ;  u8 value ; } cocci_id@p ;
