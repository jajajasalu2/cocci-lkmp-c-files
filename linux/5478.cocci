...
position p;
@@
 struct pch_spi_data * cocci_id@p ;
...
typedef u8;
@@
 struct pch_spi_board_data {  struct pci_dev * pdev ;  u8 suspend_sts ;  int num ; } cocci_id@p ;
...
position p;
@@
 struct pch_pd_dev_save * cocci_id@p ;
...
position p;
@@
 struct pch_spi_dma_ctrl * cocci_id@p ;
...
position p;
@@
 struct pch_pd_dev_save {  int num ;  struct platform_device * pd_save [ PCH_SPI_MAX_DEV ] ;  struct pch_spi_board_data * board_dat ; } cocci_id@p ;
...
position p;
@@
 struct pch_spi_board_data * cocci_id@p ;
