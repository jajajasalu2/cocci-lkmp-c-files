...
typedef uint16_t;
@@
 struct {  uint16_t tag_commands [ 16 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bus_dmamap_t;
@@
 bus_dmamap_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ahd_softc * , struct ahd_linux_device * , struct scsi_cmnd * ) ;
...
typedef uint32_t;
@@
 const struct {  const char * name ;  uint32_t * flag ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct ahd_linux_iocell_opts * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef adapter_tag_info_t;
@@
 adapter_tag_info_t cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef bus_dma_filter_t;
@@
 bus_dma_filter_t * cocci_id@p ;
...
typedef u_int;
@@
 u_int cocci_id@p ( struct ahd_softc * ahd , struct ahd_devinfo * devinfo ) ;
...
symbol cocci_id;
position p;
typedef bus_dma_tag_t;
@@
 bus_dma_tag_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct scsi_cmnd * cmd ) ;
...
position p;
@@
 struct ahd_platform_data cocci_id@p ;
...
position p;
@@
 struct ahd_linux_device * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p ( struct ahd_softc * ahd , long port ) ;
...
symbol cocci_id;
position p;
typedef ahd_dev_softc_t;
@@
 ahd_dev_softc_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_device * ) ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * , struct scb * ) ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * , struct scsi_device * , struct scb * ) ;
...
typedef uint8_t;
@@
 struct ahd_linux_iocell_opts {  uint8_t precomp ;  uint8_t slewrate ;  uint8_t amplitude ; } cocci_id@p ;
