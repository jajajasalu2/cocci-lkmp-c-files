...
position p;
@@
 struct summary_data * cocci_id@p ;
...
position p;
@@
 struct regulator_supply_alias {  struct list_head list ;  struct device * src_dev ;  const char * src_supply ;  struct device * alias_dev ;  const char * alias_supply ; } cocci_id@p ;
...
position p;
@@
 struct regulator * cocci_id@p ( struct regulator_dev * rdev , struct device * dev , const char * supply_name ) ;
...
position p;
@@
 struct summary_data {  struct seq_file * s ;  struct regulator_dev * parent ;  int level ; } cocci_id@p ;
...
position p;
@@
 struct regulator_voltage * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct regulator_dev * rdev ) ;
...
position p;
@@
 struct regulator_enable_gpio * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct regulator * regulator ) ;
...
position p;
@@
 const struct regulation_constraints * cocci_id@p ;
...
position p;
@@
 struct regulator_coupler cocci_id@p ;
...
position p;
@@
 struct coupling_desc * cocci_id@p ;
...
position p;
@@
 enum regulator_get_type cocci_id@p ;
...
position p;
@@
 const struct regulator * cocci_id@p ;
...
position p;
@@
 struct summary_lock_data {  struct ww_acquire_ctx * ww_ctx ;  struct regulator_dev * * new_contended_rdev ;  struct regulator_dev * * old_contended_rdev ; } cocci_id@p ;
...
position p;
@@
 const struct regulator_config * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct regulator_dev * rdev , unsigned long event , void * data ) ;
...
position p;
@@
 const struct regulator_init_data * cocci_id@p ;
...
position p;
@@
 struct regulator_map cocci_id@p ;
...
position p;
@@
 struct regulation_constraints * cocci_id@p ;
...
position p;
@@
 struct pre_voltage_change_data cocci_id@p ;
...
position p;
@@
 struct regulator_init_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * s , struct regulator_dev * rdev , int level ) ;
...
position p;
@@
 int cocci_id@p ( struct regulator_dev * rdev , int min_uV , int max_uV ) ;
...
position p;
@@
 struct regulator_map {  struct list_head list ;  const char * dev_name ;  const char * supply ;  struct regulator_dev * regulator ; } cocci_id@p ;
...
position p;
@@
 struct summary_lock_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct regulator * regulator ) ;
...
typedef u32;
@@
 struct regulator_enable_gpio {  struct list_head list ;  struct gpio_desc * gpiod ;  u32 enable_count ;  u32 request_count ; } cocci_id@p ;
...
position p;
@@
 struct regulator_state * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct regulator_dev * rdev ) ;
...
position p;
@@
 struct regulator_supply_alias * cocci_id@p ;
