...
position p;
@@
 union cvmx_pescx_cfg_rd cocci_id@p ;
...
position p;
@@
 union cvmx_sli_ctl_portx cocci_id@p ;
...
position p;
@@
 union cvmx_pemx_bar1_indexx cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg032 cocci_id@p ;
...
position p;
@@
 union cvmx_pemx_cfg_wr cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg455 cocci_id@p ;
...
position p;
@@
 union cvmx_npei_bar1_indexx cocci_id@p ;
...
position p;
@@
 union cvmx_pcie_address cocci_id@p ;
...
position p;
@@
 union cvmx_pescx_bist_status cocci_id@p ;
...
position p;
@@
 union cvmx_pemx_bar_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg001 cocci_id@p ;
...
position p;
@@
 union cvmx_npei_mem_access_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_sli_s2m_portx_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg008 cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg075 cocci_id@p ;
...
position p;
@@
 union cvmx_pescx_cfg_wr cocci_id@p ;
...
position p;
@@
 union cvmx_sli_mem_access_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_pescx_ctl_status cocci_id@p ;
...
position p;
@@
 struct pci_controller cocci_id@p ;
...
position p;
@@
 union cvmx_npei_ctl_status cocci_id@p ;
...
position p;
@@
 union cvmx_ciu_soft_prst cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg070 cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg030 cocci_id@p ;
...
position p;
@@
 union cvmx_pemx_bist_status cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg031 cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg448 cocci_id@p ;
...
position p;
@@
 union cvmx_dpi_sli_prtx_cfg cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg006 cocci_id@p ;
...
position p;
@@
 union cvmx_pemx_ctl_status cocci_id@p ;
...
position p;
@@
 union cvmx_pemx_int_sum cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg011 cocci_id@p ;
...
position p;
@@
 union cvmx_pemx_bist_status2 cocci_id@p ;
...
position p;
@@
 union cvmx_pemx_cfg_rd cocci_id@p ;
...
position p;
@@
 union cvmx_pescx_ctl_status2 cocci_id@p ;
...
@@
 union cvmx_pcie_address {  uint64_t u64 ;  struct {  uint64_t upper : 2 ;  uint64_t reserved_49_61 : 13 ;  uint64_t io : 1 ;  uint64_t did : 5 ;  uint64_t subdid : 3 ;  uint64_t reserved_36_39 : 4 ;  uint64_t es : 2 ;  uint64_t port : 2 ;  uint64_t reserved_29_31 : 3 ;  uint64_t ty : 1 ;  uint64_t bus : 8 ;  uint64_t dev : 5 ;  uint64_t func : 3 ;  uint64_t reg : 12 ; } config ;  struct {  uint64_t upper : 2 ;  uint64_t reserved_49_61 : 13 ;  uint64_t io : 1 ;  uint64_t did : 5 ;  uint64_t subdid : 3 ;  uint64_t reserved_36_39 : 4 ;  uint64_t es : 2 ;  uint64_t port : 2 ;  uint64_t address : 32 ; } io ;  struct {  uint64_t upper : 2 ;  uint64_t reserved_49_61 : 13 ;  uint64_t io : 1 ;  uint64_t did : 5 ;  uint64_t subdid : 3 ;  uint64_t reserved_36_39 : 4 ;  uint64_t address : 36 ; } mem ; } cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg452 cocci_id@p ;
...
position p;
@@
 union cvmx_mio_qlmx_cfg cocci_id@p ;
...
position p;
@@
 union cvmx_sriox_status_reg cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg035 cocci_id@p ;
...
position p;
@@
 union cvmx_pescx_bist_status2 cocci_id@p ;
...
position p;
@@
 union cvmx_npei_ctl_port1 cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg515 cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg034 cocci_id@p ;
...
position p;
@@
 union cvmx_mio_rst_ctlx cocci_id@p ;
...
position p;
@@
 union cvmx_sli_mem_access_subidx cocci_id@p ;
...
position p;
@@
 union cvmx_npei_ctl_status2 cocci_id@p ;
...
position p;
@@
 union cvmx_npei_ctl_port0 cocci_id@p ;
...
position p;
@@
 union octeon_cvmemctl cocci_id@p ;
...
position p;
@@
 union cvmx_npei_mem_access_subidx cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg010 cocci_id@p ;
...
position p;
@@
 union cvmx_pciercx_cfg009 cocci_id@p ;
...
position p;
@@
 union cvmx_npei_dbg_data cocci_id@p ;
