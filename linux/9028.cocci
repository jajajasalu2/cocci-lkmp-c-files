...
position p;
@@
 struct mlx4_device_context * cocci_id@p ;
...
position p;
@@
 struct mlx4_device_context {  struct list_head list ;  struct list_head bond_list ;  struct mlx4_interface * intf ;  void * context ; } cocci_id@p ;
