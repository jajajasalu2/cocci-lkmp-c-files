...
position p;
@@
 struct mt7603_mcu_txd * cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 buffer_mode ;  u8 len ;  u8 pad [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct mt7603_mcu_rxd * cocci_id@p ;
...
position p;
@@
 const struct mt7603_fw_trailer * cocci_id@p ;
...
typedef __le32;
@@
 struct {  __le32 override ;  __le32 addr ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 control_chan ;  u8 center_chan ;  u8 bw ;  u8 tx_streams ;  u8 rx_streams ;  u8 _res0 [ 7 ] ;  u8 txpower [ 21 ] ;  u8 _res1 [ 3 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 center_channel ;  u8 tssi ;  u8 temp_comp ;  u8 target_power [ 2 ] ;  u8 rate_power_delta [ 14 ] ;  u8 bw_power_delta ;  u8 ch_power_delta [ 6 ] ;  u8 temp_comp_power [ 17 ] ;  u8 reserved ; } cocci_id@p ;
