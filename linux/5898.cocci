...
position p;
@@
 const struct armada_37xx_pin_data cocci_id@p ;
...
position p;
@@
 struct armada_37xx_pin_group * cocci_id@p ;
...
position p;
@@
 struct armada_37xx_pmx_func * cocci_id@p ;
...
position p;
@@
 struct armada_37xx_pinctrl * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct armada_37xx_pinctrl {  struct regmap * regmap ;  void __iomem * base ;  const struct armada_37xx_pin_data * data ;  struct device * dev ;  struct gpio_chip gpio_chip ;  struct irq_chip irq_chip ;  spinlock_t irq_lock ;  struct pinctrl_desc pctl ;  struct pinctrl_dev * pctl_dev ;  struct armada_37xx_pin_group * groups ;  unsigned int ngroups ;  struct armada_37xx_pmx_func * funcs ;  unsigned int nfuncs ;  struct armada_37xx_pm_state pm ; } cocci_id@p ;
...
typedef u8;
@@
 struct armada_37xx_pin_data {  u8 nr_pins ;  char * name ;  struct armada_37xx_pin_group * groups ;  int ngroups ; } cocci_id@p ;
...
position p;
@@
 struct armada_37xx_pmx_func {  const char * name ;  const char * * groups ;  unsigned int ngroups ; } cocci_id@p ;
...
typedef u32;
@@
 struct armada_37xx_pin_group {  const char * name ;  unsigned int start_pin ;  unsigned int npins ;  u32 reg_mask ;  u32 val [ NB_FUNCS ] ;  unsigned int extra_pin ;  unsigned int extra_npins ;  const char * funcs [ NB_FUNCS ] ;  unsigned int * pins ; } cocci_id@p ;
...
typedef u32;
@@
 struct armada_37xx_pm_state {  u32 out_en_l ;  u32 out_en_h ;  u32 out_val_l ;  u32 out_val_h ;  u32 irq_en_l ;  u32 irq_en_h ;  u32 irq_pol_l ;  u32 irq_pol_h ;  u32 selection ; } cocci_id@p ;
