...
position p;
@@
 struct machdep_calls cocci_id@p ;
...
position p;
@@
 enum rtas_iov_fw_value_map { NUM_RES_PROPERTY = 0 , LOW_INT = 1 , START_OF_ENTRIES = 2 , APERTURE_PROPERTY = 2 , WDW_SIZE_PROPERTY = 4 , NEXT_ENTRY = 7 , } cocci_id@p ;
...
position p;
@@
 enum get_iov_fw_value_index { BAR_ADDRS = 1 , APERTURE_SIZE = 2 , WDW_SIZE = 3 , } cocci_id@p ;
...
position p;
@@
 enum get_iov_fw_value_index cocci_id@p ;
...
position p;
@@
 enum l1d_flush_type cocci_id@p ;
...
position p;
@@
 struct pci_controller_ops cocci_id@p ;
