...
position p;
@@
 struct ath9k_vif_iter_data * cocci_id@p ;
...
position p;
@@
 enum ath9k_power_mode cocci_id@p ;
...
position p;
@@
 struct ath_regulatory * cocci_id@p ;
...
position p;
@@
 struct ath9k_mib_stats * cocci_id@p ;
...
position p;
@@
 enum ath_reset_type cocci_id@p ;
...
position p;
@@
 struct ath9k_hw_cal_data * cocci_id@p ;
