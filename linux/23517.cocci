...
position p;
@@
 struct snd_soc_jack_gpio cocci_id@p ;
...
position p;
@@
 enum { KBL_DPCM_AUDIO_PB = 0 , KBL_DPCM_AUDIO_CP , KBL_DPCM_AUDIO_HDMI1_PB , KBL_DPCM_AUDIO_HDMI2_PB , KBL_DPCM_AUDIO_HDMI3_PB , } cocci_id@p ;
...
position p;
@@
 struct kbl_codec_private {  struct gpio_desc * gpio_lo_mute ;  struct list_head hdmi_pcm_list ; } cocci_id@p ;
