...
typedef u8,u32,u16;
@@
 struct tsys01_dev {  void * client ;  struct mutex lock ;  int ( * reset ) ( void * cli , u8 cmd , unsigned int delay ) ;  int ( * convert_and_read ) ( void * cli , u8 conv , u8 rd , unsigned int delay , u32 * adc ) ;  int ( * read_prom_word ) ( void * cli , int cmd , u16 * word ) ;  u16 prom [ TSYS01_PROM_WORDS_NB ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ 7 * TSYS01_PROM_WORDS_NB + 1 ] ;
