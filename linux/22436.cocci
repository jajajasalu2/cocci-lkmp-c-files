...
typedef u8;
@@
 void cocci_id@p ( struct snd_ice1712 * ice , u8 flag , int enable ) ;
...
position p;
@@
 struct snd_ice1712_card_info cocci_id@p [ ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ 16 ] ;
...
position p;
@@
 struct snd_ice1712_card_info * const * cocci_id@p ;
...
position p;
@@
 const struct vt1724_pcm_reg * cocci_id@p ;
...
position p;
@@
 struct snd_ice1712_eeprom cocci_id@p ;
...
position p;
@@
 const struct vt1724_pcm_reg cocci_id@p [ 3 ] ;
...
position p;
@@
 struct vt1724_pcm_reg {  unsigned int addr ;  unsigned int size ;  unsigned int count ;  unsigned int start ; } cocci_id@p ;
