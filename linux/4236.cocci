...
typedef ec_cmd_t;
@@
 const struct ec_cmd_t * cocci_id@p ;
...
typedef u8,ec_cmd_t;
@@
 struct ec_cmd_t {  u8 cmd ;  u8 bytes_returned ; } cocci_id@p ;
...
typedef ec_chan_t;
@@
 enum ec_chan_t { CHAN_NONE = 0 , CHAN_SWITCH , CHAN_CMD_RESP , CHAN_KEYBOARD , CHAN_TOUCHPAD , CHAN_EVENT , CHAN_DEBUG , CHAN_CMD_ERROR , } cocci_id@p ;
...
position p;
@@
 struct olpc_xo175_ec * cocci_id@p ;
...
typedef u8;
@@
 struct olpc_xo175_ec_cmd {  u8 command ;  u8 nr_args ;  u8 data_len ;  u8 args [ EC_MAX_CMD_DATA_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct olpc_ec_driver cocci_id@p ;
...
typedef ec_state_t;
@@
 enum ec_state_t { CMD_STATE_IDLE = 0 , CMD_STATE_WAITING_FOR_SWITCH , CMD_STATE_CMD_IN_TX_FIFO , CMD_STATE_CMD_SENT , CMD_STATE_RESP_RECEIVED , CMD_STATE_ERROR_RECEIVED , } cocci_id@p ;
...
typedef u8;
@@
 struct olpc_xo175_ec_resp {  u8 channel ;  u8 byte ; } cocci_id@p ;
