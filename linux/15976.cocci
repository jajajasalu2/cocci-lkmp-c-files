...
position p;
@@
 struct ht_capability_ele * cocci_id@p ;
...
position p;
@@
 struct modes_unit {  char * mode_string ;  int mode_size ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_WPA_IE_LEN * 2 + 30 ] ;
