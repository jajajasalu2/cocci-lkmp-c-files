...
position p;
@@
 struct node_cache_info * cocci_id@p ;
...
position p;
@@
 struct node_access_nodes cocci_id@p ;
...
position p;
@@
 struct node * cocci_id@p [ MAX_NUMNODES ] ;
...
position p;
@@
 struct node_hmem_attrs * cocci_id@p ;
...
position p;
@@
 struct node_attr {  struct device_attribute attr ;  enum node_states state ; } cocci_id@p ;
...
position p;
@@
 struct node_cache_info {  struct device dev ;  struct list_head node ;  struct node_cache_attrs cache_attrs ; } cocci_id@p ;
...
position p;
@@
 struct node_cache_attrs * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef node_registration_func_t;
@@
 node_registration_func_t cocci_id@p ;
