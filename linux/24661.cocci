...
position p;
@@
 const struct hash_ipmark6_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_ipmark6 * cocci_id@p ;
...
position p;
@@
 struct hash_ipmark6_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_ipmark4_elem * cocci_id@p ;
...
position p;
@@
 struct hash_ipmark4_elem cocci_id@p ;
...
position p;
@@
 const struct hash_ipmark4 * cocci_id@p ;
...
@@
 struct hash_ipmark4_elem {  __be32 ip ;  __u32 mark ; } cocci_id@p ;
...
typedef __u32;
@@
 struct hash_ipmark6_elem {  union nf_inet_addr ip ;  __u32 mark ; } cocci_id@p ;
