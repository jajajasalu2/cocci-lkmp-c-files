...
typedef u16;
@@
 const u16 cocci_id@p [ PCI_BRIDGE_VENDOR_MAX ] ;
...
position p;
@@
 struct rtl_rx_buffer_desc * cocci_id@p ;
...
position p;
@@
 struct rtl_tx_buffer_desc * cocci_id@p ;
...
position p;
@@
 const struct rtl_intf_ops cocci_id@p ;
