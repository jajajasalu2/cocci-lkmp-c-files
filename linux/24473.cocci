...
position p;
@@
 enum ccid3_fback_type cocci_id@p ;
...
position p;
@@
 struct ccid3_hc_rx_sock * cocci_id@p ;
...
position p;
@@
 struct ccid_operations cocci_id@p ;
...
position p;
@@
 enum ccid3_hc_tx_states cocci_id@p ;
...
position p;
@@
 struct ccid3_hc_tx_sock * cocci_id@p ;
...
position p;
@@
 const struct ccid3_hc_tx_sock * cocci_id@p ;
...
position p;
@@
 enum ccid3_hc_rx_states cocci_id@p ;
...
position p;
@@
 struct tfrc_tx_info cocci_id@p ;
...
position p;
@@
 struct tfrc_tx_hist_entry * cocci_id@p ;
...
position p;
@@
 struct tfrc_rx_info cocci_id@p ;
...
position p;
@@
 const struct ccid3_hc_rx_sock * cocci_id@p ;
...
position p;
@@
 enum ccid3_fback_type { CCID3_FBACK_NONE = 0 , CCID3_FBACK_INITIAL , CCID3_FBACK_PERIODIC , CCID3_FBACK_PARAM_CHANGE , } cocci_id@p ;
