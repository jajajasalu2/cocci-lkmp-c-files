...
position p;
@@
 unsigned char cocci_id@p [ F2FS_FT_MAX ] ;
...
position p;
@@
 unsigned char cocci_id@p [ S_IFMT >> S_SHIFT ] ;
...
position p;
@@
 struct f2fs_dentry_ptr cocci_id@p ;
...
position p;
@@
 struct f2fs_dentry_block * cocci_id@p ;
...
position p;
@@
 struct f2fs_dir_entry * cocci_id@p ;
...
position p;
@@
 const struct f2fs_sb_info * cocci_id@p ;
