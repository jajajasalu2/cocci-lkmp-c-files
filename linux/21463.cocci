...
position p;
@@
 struct arch_hibernate_hdr_invariants cocci_id@p ;
...
@@
 struct arch_hibernate_hdr {  struct arch_hibernate_hdr_invariants invariants ;  phys_addr_t ttbr1_el1 ;  void ( * reenter_kernel ) ( void ) ;  phys_addr_t __hyp_stub_vectors ;  u64 sleep_cpu_mpidr ; } cocci_id@p ;
...
position p;
@@
 struct arch_hibernate_hdr_invariants {  char uts_version [ __NEW_UTS_LEN + 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct arch_hibernate_hdr * cocci_id@p ;
