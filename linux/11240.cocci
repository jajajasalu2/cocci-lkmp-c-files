...
position p;
@@
 struct core_freesync {  struct mod_freesync public ;  struct dc * dc ; } cocci_id@p ;
...
position p;
@@
 const struct mod_vrr_params * cocci_id@p ;
...
position p;
@@
 struct core_freesync cocci_id@p ;
...
position p;
@@
 enum color_transfer_func cocci_id@p ;
...
position p;
@@
 struct mod_freesync * cocci_id@p ;
...
position p;
@@
 enum vrr_packet_type cocci_id@p ;
