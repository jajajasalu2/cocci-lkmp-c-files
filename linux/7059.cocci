...
position p;
@@
 struct ide_acpi_drive_link * cocci_id@p ;
...
position p;
@@
 struct ide_acpi_hwif_link cocci_id@p ;
...
@@
 struct ide_acpi_drive_link {  acpi_handle obj_handle ;  u8 idbuff [ 512 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct GTM_buffer {  u32 PIO_speed0 ;  u32 DMA_speed0 ;  u32 PIO_speed1 ;  u32 DMA_speed1 ;  u32 GTM_flags ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef acpi_handle,ide_hwif_t;
@@
 struct ide_acpi_hwif_link {  ide_hwif_t * hwif ;  acpi_handle obj_handle ;  struct GTM_buffer gtm ;  struct ide_acpi_drive_link master ;  struct ide_acpi_drive_link slave ; } cocci_id@p ;
