...
position p;
@@
 struct mux {  int cached_state ;  struct mux_control * control ;  struct iio_channel * parent ;  struct iio_dev * indio_dev ;  struct iio_chan_spec * chan ;  struct iio_chan_spec_ext_info * ext_info ;  struct mux_child * child ; } cocci_id@p ;
...
position p;
@@
 struct mux_ext_info_cache * cocci_id@p ;
...
position p;
@@
 struct mux_ext_info_cache {  char * data ;  ssize_t size ; } cocci_id@p ;
...
position p;
@@
 struct mux_child {  struct mux_ext_info_cache * ext_info_cache ; } cocci_id@p ;
