...
position p;
@@
 const unsigned short cocci_id@p [ 255 * 16 + 1 ] ;
...
position p;
@@
 const struct tpg_rbg_color8 cocci_id@p [ TPG_COLOR_MAX ] ;
...
position p;
@@
 const struct tpg_rbg_color16 cocci_id@p [ V4L2_COLORSPACE_DCI_P3 + 1 ] [ V4L2_XFER_FUNC_SMPTE2084 + 1 ] [ TPG_COLOR_CSC_BLACK + 1 ] ;
...
position p;
@@
 enum v4l2_xfer_func cocci_id@p ;
