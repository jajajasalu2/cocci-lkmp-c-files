...
position p;
@@
 struct qeth_vnicc_getset_timeout * cocci_id@p ;
...
position p;
@@
 struct _qeth_sbp_cbctl * cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_vnicc_hdr * cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_addr_change cocci_id@p ;
...
position p;
@@
 struct qeth_sbp_state_change * cocci_id@p ;
...
position p;
@@
 struct qeth_bridge_host_data * cocci_id@p ;
...
position p;
@@
 enum qeth_an_event_type cocci_id@p ;
...
position p;
@@
 struct qdio_brinfo_entry_l2 * cocci_id@p ;
...
position p;
@@
 struct qeth_bridge_state_data {  struct work_struct worker ;  struct qeth_card * card ;  struct qeth_sbp_state_change qports ; } cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_addr_change_entry * cocci_id@p ;
...
position p;
@@
 struct qeth_bridge_host_data {  struct work_struct worker ;  struct qeth_card * card ;  struct qeth_ipacmd_addr_change hostevs ; } cocci_id@p ;
...
position p;
@@
 struct qeth_bridge_state_data cocci_id@p ;
...
typedef bool,u32;
@@
 bool cocci_id@p ( struct qeth_card * card , u32 vnicc , u32 * timeout ) ;
...
position p;
@@
 enum qdio_brinfo_entry_type cocci_id@p ;
...
position p;
@@
 struct net_if_token * cocci_id@p ;
...
position p;
@@
 struct _qeth_l2_vnicc_request_cbctl cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_sbp_hdr * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ccwgroup_device * ) ;
...
position p;
@@
 struct mac_addr_lnid * cocci_id@p ;
...
position p;
@@
 enum qeth_sbp_roles * cocci_id@p ;
...
position p;
@@
 enum qeth_ipa_sbp_cmd cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_vnicc cocci_id@p ;
...
position p;
@@
 enum qeth_sbp_states * cocci_id@p ;
...
position p;
@@
 struct qeth_sbp_query_ports * cocci_id@p ;
...
typedef u32;
@@
 struct _qeth_sbp_cbctl {  union {  u32 supported ;  struct {  enum qeth_sbp_roles * role ;  enum qeth_sbp_states * state ; } qports ; } data ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qeth_card * card , struct qeth_ipa_cmd * cmd ) ;
...
position p;
@@
 enum qeth_an_event_type { anev_reg_unreg , anev_abort , anev_reset , } cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_setbridgeport * cocci_id@p ;
...
typedef u32;
@@
 struct _qeth_l2_vnicc_request_cbctl {  struct {  union {  u32 * sup_cmds ;  u32 * timeout ; } ; } result ; } cocci_id@p ;
...
position p;
@@
 struct qeth_discipline cocci_id@p ;
...
position p;
@@
 struct qeth_sbp_port_entry * cocci_id@p ;
