...
position p;
@@
 struct assign_storage_sccb * cocci_id@p ;
...
typedef u16;
@@
 struct memory_increment {  struct list_head list ;  u16 rn ;  int standby ; } cocci_id@p ;
...
position p;
@@
 struct cpu_configure_sccb * cocci_id@p ;
...
position p;
@@
 struct attach_storage_sccb * cocci_id@p ;
...
position p;
@@
 struct read_storage_sccb * cocci_id@p ;
...
position p;
@@
 struct memory_increment * cocci_id@p ;
...
position p;
@@
 struct read_cpu_info_sccb * cocci_id@p ;
...
position p;
@@
 struct chp_info_sccb * cocci_id@p ;
...
position p;
@@
 struct chp_cfg_sccb * cocci_id@p ;
