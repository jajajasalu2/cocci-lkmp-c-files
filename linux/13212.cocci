...
position p;
@@
 struct cx18_mdl_ack * cocci_id@p ;
...
position p;
@@
 const struct cx18_api_info cocci_id@p [ ] ;
...
position p;
@@
 struct cx18_in_work_order cocci_id@p ;
...
position p;
@@
 struct cx18_videobuf_buffer cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_MB_ARGUMENTS * 11 + 1 ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MAX_MB_ARGUMENTS ] ;
...
typedef u8,u32;
@@
 struct cx18_api_info {  u32 cmd ;  u8 flags ;  u8 rpu ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct cx18_mailbox * cocci_id@p ;
