...
position p;
@@
 struct fsl_re_hw_desc cocci_id@p ;
...
position p;
@@
 struct fsl_re_drv_private * cocci_id@p ;
...
position p;
@@
 struct fsl_re_pq_cdb cocci_id@p ;
...
position p;
@@
 struct fsl_re_move_cdb * cocci_id@p ;
...
position p;
@@
 struct fsl_re_chan_cfg * cocci_id@p ;
...
position p;
@@
 struct fsl_re_xor_cdb * cocci_id@p ;
...
position p;
@@
 struct fsl_re_cmpnd_frame * cocci_id@p ;
