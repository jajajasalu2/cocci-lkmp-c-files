...
typedef u16;
@@
 struct ib_pkey_cache {  int table_len ;  u16 table [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct ib_gid_table_entry {  struct kref kref ;  struct work_struct del_work ;  struct ib_gid_attr attr ;  void * context ;  struct roce_gid_ndev_storage * ndev_storage ;  enum gid_table_entry_state state ; } cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const union ib_gid * gid , const struct ib_gid_attr * , void * ) ;
...
position p;
@@
 struct ib_gid_table * cocci_id@p ;
...
position p;
@@
 struct ib_gid_table_entry * cocci_id@p ;
...
position p;
@@
 enum gid_table_entry_state { GID_TABLE_ENTRY_INVALID = 1 , GID_TABLE_ENTRY_VALID = 2 , GID_TABLE_ENTRY_PENDING_DEL = 3 , } cocci_id@p ;
...
position p;
@@
 struct ib_update_work cocci_id@p ;
...
@@
 struct ib_gid_table {  int sz ;  struct mutex lock ;  rwlock_t rwlock ;  struct ib_gid_table_entry * * data_vec ;  u32 default_gid_indices ; } cocci_id@p ;
...
position p;
@@
 enum gid_attr_find_mask { GID_ATTR_FIND_MASK_GID = 1UL << 0 , GID_ATTR_FIND_MASK_NETDEV = 1UL << 1 , GID_ATTR_FIND_MASK_DEFAULT = 1UL << 2 , GID_ATTR_FIND_MASK_GID_TYPE = 1UL << 3 , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct ib_update_work {  struct work_struct work ;  struct ib_device * device ;  u8 port_num ;  bool enforce_security ; } cocci_id@p ;
...
position p;
@@
 const struct ib_gid_table * cocci_id@p ;
...
position p;
@@
 struct roce_gid_ndev_storage {  struct rcu_head rcu_head ;  struct net_device * ndev ; } cocci_id@p ;
...
position p;
@@
 const struct ib_gid_table_entry * cocci_id@p ;
...
position p;
@@
 struct roce_gid_ndev_storage * cocci_id@p ;
...
position p;
@@
 enum ib_cache_gid_default_mode cocci_id@p ;
...
position p;
@@
 struct ib_pkey_cache * cocci_id@p ;
