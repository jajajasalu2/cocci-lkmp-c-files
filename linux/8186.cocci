...
position p;
@@
 struct otx2_mbox_dev * cocci_id@p ;
...
position p;
@@
 struct get_hw_cap_rsp * cocci_id@p ;
...
position p;
@@
 struct mbox_wq_info * cocci_id@p ;
...
position p;
@@
 enum { TYPE_AFVF , TYPE_AFPF , } cocci_id@p ;
...
position p;
@@
 struct ready_msg_rsp * cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct rvu * rvu , u16 pcifunc ) ;
...
position p;
@@
 int cocci_id@p ( struct rvu * rvu , int pcifunc ) ;
...
position p;
@@
 void cocci_id@p ( struct rvu * rvu , struct rvu_pfvf * pfvf , struct rvu_block * block , int lf ) ;
...
position p;
@@
 struct msix_offset_rsp * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct rvu * rvu , struct mbox_wq_info * mw , int type , int num , void mbox_handler ( struct work_struct * ) , void mbox_up_handler ( struct work_struct * ) ) ;
