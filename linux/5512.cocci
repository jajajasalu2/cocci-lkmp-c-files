...
typedef spinlock_t;
@@
 struct mxc_rtc_data {  struct rtc_device * rtc ;  void __iomem * ioaddr ;  struct clk * clk ;  spinlock_t lock ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct mxc_rtc_data * cocci_id@p ;
...
position p;
@@
 struct mxc_rtc_data * constcocci_id ;
