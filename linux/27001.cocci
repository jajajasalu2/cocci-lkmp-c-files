...
position p;
@@
 const struct xfs_inobt_rec_incore * cocci_id@p ;
...
position p;
@@
 struct xfs_inumbers_chunk {  inumbers_fmt_pf formatter ;  struct xfs_ibulk * breq ; } cocci_id@p ;
...
position p;
@@
 struct xfs_inumbers_chunk cocci_id@p ;
...
position p;
@@
 struct xfs_bstat_chunk cocci_id@p ;
...
position p;
@@
 struct xfs_bstat_chunk {  bulkstat_one_fmt_pf formatter ;  struct xfs_ibulk * breq ;  struct xfs_bulkstat * buf ; } cocci_id@p ;
