...
position p;
@@
 struct rx6110_data {  struct rtc_device * rtc ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 enum { RTC_SEC = 0 , RTC_MIN , RTC_HOUR , RTC_WDAY , RTC_MDAY , RTC_MONTH , RTC_YEAR , RTC_NR_TIME , } cocci_id@p ;
