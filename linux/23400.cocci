...
position p;
@@
 const  cocci_id@p ( adau1781_pga_tlv , 
							     0 , 1 , 
							     TLV_DB_SCALE_ITEM ( 0 , 600 , 0 ) , 
							     2 , 3 , 
							     TLV_DB_SCALE_ITEM ( 1000 , 400 , 0 ) , 
							     4 , 4 , 
							     TLV_DB_SCALE_ITEM ( 1700 , 0 , 0 ) , 
							     5 , 7 , 
							     TLV_DB_SCALE_ITEM ( 2000 , 600 , 0 ) ) ;
...
position p;
@@
 const  cocci_id@p ( adau1781_beep_tlv , 
							     0 , 1 , 
							     TLV_DB_SCALE_ITEM ( 0 , 600 , 0 ) , 
							     2 , 3 , 
							     TLV_DB_SCALE_ITEM ( 1000 , 400 , 0 ) , 
...
position p;
@@
 struct adau1781_platform_data * cocci_id@p ;
