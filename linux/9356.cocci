...
typedef u8;
@@
 struct mt76_fw {  struct mt76_fw_header hdr ;  u8 ivb [ MT_MCU_IVB_SIZE ] ;  u8 ilm [ ] ; } cocci_id@p ;
...
position p;
@@
 struct mt7601u_dma_buf * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct mt76_fw_header {  __le32 ilm_len ;  __le32 dlm_len ;  __le16 build_ver ;  __le16 fw_ver ;  u8 pad [ 4 ] ;  char build_time [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 const struct mt7601u_dma_buf * cocci_id@p ;
...
position p;
@@
 const struct mt76_fw * cocci_id@p ;
...
position p;
@@
 const struct mt76_fw_header * cocci_id@p ;
...
position p;
@@
 const struct mt76_reg_pair * cocci_id@p ;
