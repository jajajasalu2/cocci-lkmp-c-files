...
position p;
@@
 struct diag204_phys_hdr * cocci_id@p ;
...
position p;
@@
 struct hypfs_dbfs_file cocci_id@p ;
...
position p;
@@
 struct diag204_x_phys_hdr * cocci_id@p ;
...
position p;
@@
 struct diag204_part_hdr * cocci_id@p ;
...
position p;
@@
 struct diag204_cpu_info cocci_id@p ;
...
position p;
@@
 struct diag204_phys_cpu cocci_id@p ;
...
position p;
@@
 struct diag204_x_cpu_info * cocci_id@p ;
...
position p;
@@
 struct diag204_x_part_hdr * cocci_id@p ;
...
position p;
@@
 enum diag204_format cocci_id@p ;
...
position p;
@@
 struct x_info_blk_hdr * cocci_id@p ;
...
position p;
@@
 struct dbfs_d204_hdr cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ DIAG204_LPAR_NAME_LEN + 1 ] ;
...
position p;
@@
 struct diag204_x_phys_cpu * cocci_id@p ;
...
position p;
@@
 struct diag204_info_blk_hdr * cocci_id@p ;
