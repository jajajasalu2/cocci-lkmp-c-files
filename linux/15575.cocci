...
position p;
@@
 struct p80211msg_p2req_flashdl_state * cocci_id@p ;
...
position p;
@@
 struct p80211msg_p2req_flashdl_write * cocci_id@p ;
...
position p;
@@
 struct hfa384x_hscan_result_sub * cocci_id@p ;
...
position p;
@@
 struct hfa384x_host_scan_request_data cocci_id@p ;
...
position p;
@@
 struct p80211msg_dot11req_start * cocci_id@p ;
...
position p;
@@
 struct p80211msg_lnxreq_wlansniff * cocci_id@p ;
