...
symbol cocci_id;
position p;
typedef efi_config_table_32_t;
@@
 efi_config_table_32_t cocci_id@p ;
...
position p;
@@
 struct {  const char * uname ;  const char * subnode ;  struct params * params ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ EFIVAR_SSDT_NAME_MAX ] ;
...
position p;
@@
 struct efi_fdt_params * cocci_id@p ;
...
position p;
@@
 struct efivar_operations cocci_id@p ;
...
@@
 const efi_memory_desc_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_config_table_64_t;
@@
 efi_config_table_64_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_properties_table_t;
@@
 efi_properties_table_t * cocci_id@p ;
...
position p;
@@
 struct linux_efi_memreserve * cocci_id@p ;
...
position p;
@@
 struct params {  const char name [ 32 ] ;  const char propname [ 32 ] ;  int offset ;  int size ; } cocci_id@p ;
...
position p;
@@
 struct param_info {  int found ;  void * params ;  const char * missing ; } cocci_id@p ;
...
position p;
@@
 struct linux_efi_random_seed * cocci_id@p ;
