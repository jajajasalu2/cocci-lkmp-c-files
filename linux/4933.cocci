...
position p;
@@
 struct hns_roce_buf_list cocci_id@p ;
...
position p;
@@
 enum ib_cq_notify_flags cocci_id@p ;
...
position p;
@@
 enum hns_roce_link_table_type cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_qp_context * cocci_id@p ;
...
position p;
@@
 struct hns_roce_vf_res_a * cocci_id@p ;
...
position p;
@@
 struct hns_roce_query_version * cocci_id@p ;
...
position p;
@@
 struct hns_roce_cfg_smac_tb * cocci_id@p ;
...
position p;
@@
 enum hns_roce_cmd_return_status cocci_id@p ;
...
position p;
@@
 struct hns_roce_link_table * cocci_id@p ;
...
position p;
@@
 struct hns_roce_sccc_clr_done * cocci_id@p ;
...
position p;
@@
 struct hns_roce_func_clear * cocci_id@p ;
...
position p;
@@
 struct hns_roce_post_mbox * cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_wqe_data_seg * cocci_id@p ;
...
position p;
@@
 enum hns_roce_v2_qp_state cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_ud_send_wqe * cocci_id@p ;
...
position p;
@@
 struct hns_roce_cfg_llm_a * cocci_id@p ;
...
position p;
@@
 struct hns_roce_link_table_entry * cocci_id@p ;
...
position p;
@@
 enum hns_roce_opcode_type cocci_id@p ;
...
position p;
@@
 struct hns_roce_eq_table * cocci_id@p ;
...
position p;
@@
 struct hns_roce_aeqe * cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_cq_context * cocci_id@p ;
...
position p;
@@
 struct hns_roce_cfg_bt_attr * cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_priv cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_rc_send_wqe * cocci_id@p ;
...
position p;
@@
 struct hns_roce_srq * cocci_id@p ;
...
position p;
@@
 enum ib_srq_attr_mask cocci_id@p ;
...
position p;
@@
 struct hns_roce_wqe_atomic_seg * cocci_id@p ;
...
position p;
@@
 struct hns_roce_ceqe * cocci_id@p ;
...
position p;
@@
 struct hns_roce_rinl_sge * cocci_id@p ;
...
position p;
@@
 struct hns_roce_caps * cocci_id@p ;
...
position p;
@@
 const struct hns_roce_hw cocci_id@p ;
...
position p;
@@
 struct hns_roce_eq_context * cocci_id@p ;
...
position p;
@@
 struct hns_roce_mbox_status * cocci_id@p ;
...
position p;
@@
 struct hns_roce_pf_res_a * cocci_id@p ;
...
position p;
@@
 struct hns_roce_hem_table * cocci_id@p ;
...
position p;
@@
 struct hns_roce_vf_res_b * cocci_id@p ;
...
position p;
@@
 struct hns_roce_hem * cocci_id@p ;
...
position p;
@@
 struct hns_roce_hem_iter cocci_id@p ;
...
position p;
@@
 struct hns_roce_work * cocci_id@p ;
...
position p;
@@
 struct hns_roce_wqe_frmr_seg * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ib_qp * ibqp , const struct ib_qp_attr * attr , int attr_mask , enum ib_qp_state cur_state , enum ib_qp_state new_state ) ;
...
position p;
@@
 struct hns_roce_idx_que * cocci_id@p ;
...
position p;
@@
 struct hns_roce_dev * cocci_id@p ;
...
position p;
@@
 struct hns_roce_hem_mhop cocci_id@p ;
...
position p;
@@
 struct hns_roce_ucontext * cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_cqe * cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_db cocci_id@p ;
...
position p;
@@
 struct hns_roce_cfg_global_param * cocci_id@p ;
...
position p;
@@
 struct hns_roce_cmq_desc cocci_id@p [ 2 ] ;
...
position p;
@@
 struct hns_roce_query_fw_info * cocci_id@p ;
...
position p;
@@
 struct hns_roce_pf_res_b * cocci_id@p ;
...
position p;
@@
 struct sg_dma_page_iter cocci_id@p ;
...
position p;
@@
 struct hns_roce_cfg_sgid_tb * cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_cmq_ring * cocci_id@p ;
...
position p;
@@
 struct hns_roce_srq_context * cocci_id@p ;
...
position p;
@@
 const struct hns_roce_dfx_hw cocci_id@p ;
...
position p;
@@
 struct hns_roce_vf_switch * cocci_id@p ;
...
position p;
@@
 struct hns_roce_cmd_mailbox * cocci_id@p ;
...
position p;
@@
 enum hns_roce_sgid_type cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_qp_context cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct hnae3_client_ops cocci_id@p ;
...
position p;
@@
 struct hns_roce_cfg_llm_b * cocci_id@p ;
...
position p;
@@
 struct hns_roce_v2_mpt_entry * cocci_id@p ;
...
position p;
@@
 struct hns_roce_cmq_desc cocci_id@p ;
...
position p;
@@
 struct hns_roce_pf_timer_res_a * cocci_id@p ;
...
position p;
@@
 struct hns_roce_sccc_clr * cocci_id@p ;
