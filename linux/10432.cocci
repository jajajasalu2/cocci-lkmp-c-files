...
position p;
@@
 struct radeon_cs_buckets {  struct list_head bucket [ RADEON_CS_NUM_BUCKETS ] ; } cocci_id@p ;
...
position p;
@@
 struct drm_radeon_cs * cocci_id@p ;
...
position p;
@@
 struct drm_radeon_cs_chunk cocci_id@p ;
...
position p;
@@
 struct drm_radeon_cs_reloc * cocci_id@p ;
...
position p;
@@
 struct radeon_cs_buckets cocci_id@p ;
