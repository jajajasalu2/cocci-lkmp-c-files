...
position p;
@@
 enum { MTHCA_MAX_DIRECT_SRQ_SIZE = 4 * PAGE_SIZE , } cocci_id@p ;
...
position p;
@@
 struct mthca_tavor_srq_context * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,__be32,__be64;
@@
 struct mthca_tavor_srq_context {  __be64 wqe_base_ds ;  __be32 state_pd ;  __be32 lkey ;  __be32 uar ;  __be16 limit_watermark ;  __be16 wqe_cnt ;  u32 reserved [ 2 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,u16,__be32,__be64;
@@
 struct mthca_arbel_srq_context {  __be32 state_logsize_srqn ;  __be32 lkey ;  __be32 db_index ;  __be32 logstride_usrpage ;  __be64 wqe_base ;  __be32 eq_pd ;  __be16 limit_watermark ;  __be16 wqe_cnt ;  u16 reserved1 ;  __be16 wqe_counter ;  u32 reserved2 [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct mthca_arbel_srq_context * cocci_id@p ;
