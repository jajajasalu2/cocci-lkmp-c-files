...
position p;
@@
 struct omapfb2_device * cocci_id@p ;
...
position p;
@@
 struct omapfb_colormode cocci_id@p [ ] ;
...
position p;
@@
 enum omapfb_color_format cocci_id@p ;
...
position p;
@@
 struct omapfb2_mem_region * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct omapfb2_device * fbdev , struct omap_dss_device * dssdev ) ;
...
position p;
@@
 const struct omapfb_info * cocci_id@p ;
...
position p;
@@
 struct omapfb_display_data cocci_id@p ;
...
position p;
@@
 struct omap_overlay * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct omapfb2_device * fbdev , struct fb_info * fbi ) ;
...
position p;
@@
 struct omap_dss_driver * cocci_id@p ;
