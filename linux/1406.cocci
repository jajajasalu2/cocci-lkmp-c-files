...
position p;
@@
 struct ep_queue_head * cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( u32 v , unsigned __iomem * p ) ;
...
position p;
@@
 struct ep_td_struct * cocci_id@p ;
...
typedef u32;
@@
 u32 ( * cocci_id@p ) ( const unsigned __iomem * p ) ;
...
position p;
@@
 struct fsl_usb2_platform_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usb_ep * _ep ) ;
