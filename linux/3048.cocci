...
position p;
@@
 struct acpi_lpi_states_array cocci_id@p [ 2 ] ;
...
position p;
@@
 struct acpi_processor_cx cocci_id@p ;
...
position p;
@@
 struct acpi_lpi_state * cocci_id@p ;
...
position p;
@@
 struct acpi_lpi_states_array {  unsigned int size ;  unsigned int composite_states_size ;  struct acpi_lpi_state * entries ;  struct acpi_lpi_state * composite_states [ ACPI_PROCESSOR_MAX_POWER ] ; } cocci_id@p ;
...
position p;
@@
 struct acpi_power_register * cocci_id@p ;
...
position p;
@@
 struct acpi_processor_power * cocci_id@p ;
...
position p;
@@
 struct acpi_lpi_states_array * cocci_id@p ;
