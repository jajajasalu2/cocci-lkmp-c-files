...
position p;
@@
 enum vmballoon_op_stat_type { VMW_BALLOON_OP_STAT , VMW_BALLOON_OP_FAIL_STAT , } cocci_id@p ;
...
position p;
@@
 enum vmballoon_stat_page { VMW_BALLOON_PAGE_STAT_ALLOC , VMW_BALLOON_PAGE_STAT_ALLOC_FAIL , VMW_BALLOON_PAGE_STAT_REFUSED_ALLOC , VMW_BALLOON_PAGE_STAT_REFUSED_FREE , VMW_BALLOON_PAGE_STAT_FREE , VMW_BALLOON_PAGE_STAT_LAST = VMW_BALLOON_PAGE_STAT_FREE , } cocci_id@p ;
...
position p;
@@
 enum vmballoon_page_size_type { VMW_BALLOON_4K_PAGE , VMW_BALLOON_2M_PAGE , VMW_BALLOON_LAST_SIZE = VMW_BALLOON_2M_PAGE , } cocci_id@p ;
...
position p;
@@
 enum vmballoon_page_size_type cocci_id@p ;
...
position p;
@@
 enum vmballoon_op_stat_type cocci_id@p ;
...
position p;
@@
 enum vmwballoon_capabilities { VMW_BALLOON_BASIC_CMDS = ( 1 << 1 ) , VMW_BALLOON_BATCHED_CMDS = ( 1 << 2 ) , VMW_BALLOON_BATCHED_2M_CMDS = ( 1 << 3 ) , VMW_BALLOON_SIGNALLED_WAKEUP_CMD = ( 1 << 4 ) , VMW_BALLOON_64_BIT_TARGET = ( 1 << 5 ) , } cocci_id@p ;
...
typedef atomic64_t;
@@
 struct vmballoon_stats {  atomic64_t general_stat [ VMW_BALLOON_STAT_NUM ] ;  atomic64_t page_stat [ VMW_BALLOON_PAGE_STAT_NUM ] [ VMW_BALLOON_NUM_PAGE_SIZES ] ;  atomic64_t ops [ VMW_BALLOON_CMD_NUM ] [ VMW_BALLOON_OP_STAT_TYPES ] ; } cocci_id@p ;
...
position p;
@@
 enum vmballoon_op { VMW_BALLOON_INFLATE , VMW_BALLOON_DEFLATE , } cocci_id@p ;
...
position p;
@@
 enum vmballoon_stat_general cocci_id@p ;
...
position p;
@@
 struct vmballoon_ctl cocci_id@p ;
...
position p;
@@
 enum vmballoon_stat_page cocci_id@p ;
...
position p;
@@
 struct vmballoon_ctl {  struct list_head pages ;  struct list_head refused_pages ;  struct list_head prealloc_pages ;  unsigned int n_refused_pages ;  unsigned int n_pages ;  enum vmballoon_page_size_type page_size ;  enum vmballoon_op op ; } cocci_id@p ;
...
position p;
@@
 enum vmballoon_stat_general { VMW_BALLOON_STAT_TIMER , VMW_BALLOON_STAT_DOORBELL , VMW_BALLOON_STAT_RESET , VMW_BALLOON_STAT_SHRINK , VMW_BALLOON_STAT_SHRINK_FREE , VMW_BALLOON_STAT_LAST = VMW_BALLOON_STAT_SHRINK_FREE , } cocci_id@p ;
...
position p;
@@
 struct balloon_dev_info * cocci_id@p ;
...
position p;
@@
 enum vmballoon_error_codes { VMW_BALLOON_SUCCESS , VMW_BALLOON_ERROR_CMD_INVALID , VMW_BALLOON_ERROR_PPN_INVALID , VMW_BALLOON_ERROR_PPN_LOCKED , VMW_BALLOON_ERROR_PPN_UNLOCKED , VMW_BALLOON_ERROR_PPN_PINNED , VMW_BALLOON_ERROR_PPN_NOTNEEDED , VMW_BALLOON_ERROR_RESET , VMW_BALLOON_ERROR_BUSY , } cocci_id@p ;
...
position p;
@@
 struct vmballoon_batch_entry cocci_id@p ;
