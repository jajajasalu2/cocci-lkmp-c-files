...
position p;
@@
 union irq_stack_union * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned long p1 ) ;
...
position p;
@@
 void cocci_id@p ( unsigned long p1 , void * func , unsigned long new_stack ) ;
...
position p;
@@
 union irq_stack_union {  unsigned long stack [ IRQ_STACK_SIZE / sizeof ( unsigned long ) ] ;  volatile unsigned int slock [ 4 ] ;  volatile unsigned int lock [ 1 ] ; } cocci_id@p ;
