...
typedef u32;
@@
 struct rcar_csi2_format {  u32 code ;  unsigned int datatype ;  unsigned int bpp ; } cocci_id@p ;
...
position p;
@@
 enum rcar_csi2_pads { RCAR_CSI2_SINK , RCAR_CSI2_SOURCE_VC0 , RCAR_CSI2_SOURCE_VC1 , RCAR_CSI2_SOURCE_VC2 , RCAR_CSI2_SOURCE_VC3 , NR_OF_RCAR_CSI2_PAD , } cocci_id@p ;
...
position p;
@@
 const struct phtw_value * cocci_id@p ;
...
position p;
@@
 const struct rcar_csi2_format * cocci_id@p ;
...
position p;
@@
 const struct rcar_csi2_info cocci_id@p ;
...
position p;
@@
 const struct rcsi2_mbps_reg * cocci_id@p ;
...
position p;
@@
 struct rcar_csi2 {  struct device * dev ;  void __iomem * base ;  const struct rcar_csi2_info * info ;  struct reset_control * rstc ;  struct v4l2_subdev subdev ;  struct media_pad pads [ NR_OF_RCAR_CSI2_PAD ] ;  struct v4l2_async_notifier notifier ;  struct v4l2_async_subdev asd ;  struct v4l2_subdev * remote ;  struct v4l2_mbus_framefmt mf ;  struct mutex lock ;  int stream_count ;  unsigned short lanes ;  unsigned char lane_swap [ 4 ] ; } cocci_id@p ;
...
typedef u16;
@@
 struct rcsi2_mbps_reg {  u16 mbps ;  u16 reg ; } cocci_id@p ;
...
typedef u16;
@@
 struct phtw_value {  u16 data ;  u16 code ; } cocci_id@p ;
