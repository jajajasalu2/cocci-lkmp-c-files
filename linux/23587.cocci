...
position p;
@@
 enum tegra30_ahub_rxcif * cocci_id@p ;
...
position p;
@@
 enum tegra30_ahub_txcif * cocci_id@p ;
...
position p;
@@
 struct tegra30_ahub * cocci_id@p ;
...
position p;
@@
 struct tegra30_ahub_cif_conf cocci_id@p ;
...
typedef u32;
@@
 const struct {  const char * rst_name ;  u32 mod_list_mask ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct tegra30_ahub_soc_data * cocci_id@p ;
...
position p;
@@
 struct tegra30_ahub_soc_data cocci_id@p ;
