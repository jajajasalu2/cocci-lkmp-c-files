...
position p;
@@
 struct event_counter * cocci_id@p ;
...
position p;
@@
 struct acpi_table_bert * cocci_id@p ;
...
position p;
@@
 struct acpi_table_attr * cocci_id@p ;
...
position p;
@@
 struct acpi_table_attr {  struct bin_attribute attr ;  char name [ ACPI_NAMESEG_SIZE ] ;  int instance ;  char filename [ ACPI_NAMESEG_SIZE + ACPI_INST_SIZE ] ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct acpi_data_attr cocci_id@p ;
...
typedef u32;
@@
 struct event_counter {  u32 count ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 struct acpi_data_obj {  char * name ;  int ( * fn ) ( void * , struct acpi_data_attr * ) ; } cocci_id@p [ ] ;
...
typedef u64;
@@
 struct acpi_data_attr {  struct bin_attribute attr ;  u64 addr ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ACPI_INST_SIZE ] ;
...
position p;
@@
 struct acpi_hest_generic_status cocci_id@p ;
...
position p;
@@
 struct acpi_dlayer {  const char * name ;  unsigned long value ; } cocci_id@p ;
...
position p;
@@
 struct acpi_dlevel {  const char * name ;  unsigned long value ; } cocci_id@p ;
...
position p;
@@
 const struct kobj_attribute cocci_id@p ;
...
position p;
@@
 const struct acpi_dlevel cocci_id@p [ ] ;
...
position p;
@@
 const struct acpi_dlayer cocci_id@p [ ] ;
