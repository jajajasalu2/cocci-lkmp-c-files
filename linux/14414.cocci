...
position p;
@@
 const enum si476x_func cocci_id@p ;
...
position p;
@@
 enum phase_diversity_modes_idx cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_config cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct v4l2_ctrl * ctrl ) ;
...
position p;
@@
 struct si476x_radio cocci_id@p ;
...
typedef u32;
@@
 struct si476x_radio {  struct v4l2_device v4l2dev ;  struct video_device videodev ;  struct v4l2_ctrl_handler ctrl_handler ;  struct si476x_core * core ;  const struct si476x_radio_ops * ops ;  struct dentry * debugfs ;  u32 audmode ; } cocci_id@p ;
...
position p;
@@
 enum si476x_freq_bands { SI476X_BAND_FM , SI476X_BAND_AM , } cocci_id@p ;
...
position p;
@@
 enum si476x_ctrl_idx { SI476X_IDX_RSSI_THRESHOLD , SI476X_IDX_SNR_THRESHOLD , SI476X_IDX_MAX_TUNE_ERROR , SI476X_IDX_HARMONICS_COUNT , SI476X_IDX_DIVERSITY_MODE , SI476X_IDX_INTERCHIP_LINK , } cocci_id@p ;
...
position p;
@@
 const struct si476x_radio_ops cocci_id@p ;
...
position p;
@@
 enum phase_diversity_modes_idx { SI476X_IDX_PHDIV_DISABLED , SI476X_IDX_PHDIV_PRIMARY_COMBINING , SI476X_IDX_PHDIV_PRIMARY_ANTENNA , SI476X_IDX_PHDIV_SECONDARY_ANTENNA , SI476X_IDX_PHDIV_SECONDARY_COMBINING , } cocci_id@p ;
...
position p;
@@
 enum si476x_ctrl_idx cocci_id@p ;
