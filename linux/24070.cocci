...
position p;
@@
 struct gssx_name_attr_array * cocci_id@p ;
...
position p;
@@
 struct gssx_res_accept_sec_context * cocci_id@p ;
...
position p;
@@
 struct gssx_cred_element_array * cocci_id@p ;
...
position p;
@@
 const struct gssx_call_ctx * cocci_id@p ;
...
position p;
@@
 struct gssx_name_attr * cocci_id@p ;
...
position p;
@@
 struct gssx_option_array cocci_id@p ;
...
position p;
@@
 const struct gssx_arg_accept_sec_context * cocci_id@p ;
...
position p;
@@
 const struct gssx_option_array * cocci_id@p ;
...
position p;
@@
 const struct gssp_in_token * cocci_id@p ;
