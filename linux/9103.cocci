...
position p;
@@
 enum mlx5_lag_port_affinity cocci_id@p ;
...
position p;
@@
 struct mlx5_fib_event_work * cocci_id@p ;
...
position p;
@@
 struct mlx5_fib_event_work {  struct work_struct work ;  struct mlx5_lag * ldev ;  unsigned long event ;  union {  struct fib_entry_notifier_info fen_info ;  struct fib_nh_notifier_info fnh_info ; } ; } cocci_id@p ;
