...
position p;
@@
 const struct ak4613_interface * cocci_id@p ;
...
typedef u8;
@@
 struct ak4613_priv {  struct mutex lock ;  const struct ak4613_interface * iface ;  struct snd_pcm_hw_constraint_list constraint ;  struct work_struct dummy_write_work ;  struct snd_soc_component * component ;  unsigned int rate ;  unsigned int sysclk ;  unsigned int fmt ;  u8 oc ;  u8 ic ;  int cnt ; } cocci_id@p ;
...
position p;
@@
 struct ak4613_interface {  struct ak4613_formats capture ;  struct ak4613_formats playback ; } cocci_id@p ;
...
position p;
@@
 const struct ak4613_formats * cocci_id@p ;
...
position p;
@@
 struct ak4613_formats {  unsigned int width ;  unsigned int fmt ; } cocci_id@p ;
