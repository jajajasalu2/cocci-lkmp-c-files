...
position p;
@@
 struct uartlite_data cocci_id@p ;
...
position p;
@@
 struct uart_port cocci_id@p [ ULITE_NR_UARTS ] ;
...
position p;
@@
 struct uartlite_data {  const struct uartlite_reg_ops * reg_ops ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 const struct uartlite_reg_ops cocci_id@p ;
