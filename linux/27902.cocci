...
position p;
@@
 const struct fscache_cookie * cocci_id@p ;
...
position p;
@@
 const struct fscache_cookie_def * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fscache_cache * cache , struct fscache_cookie * cookie ) ;
...
position p;
@@
 struct hlist_bl_head cocci_id@p [ 1 << fscache_cookie_hash_shift ] ;
...
position p;
@@
 int cocci_id@p ( struct fscache_cookie * cookie , struct fscache_object * object ) ;
...
position p;
@@
 enum fscache_cookie_trace cocci_id@p ;
