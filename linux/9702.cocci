...
position p;
@@
 struct iwl_rem_sta_resp * cocci_id@p ;
...
position p;
@@
 struct iwl_station_entry * cocci_id@p ;
...
position p;
@@
 struct iwl_add_sta_resp * cocci_id@p ;
...
position p;
@@
 struct iwl_rem_sta_cmd cocci_id@p ;
...
position p;
@@
 const struct iwl_link_quality_cmd cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct iwl_wep_cmd ) + sizeof ( struct iwl_wep_key ) * WEP_KEYS_MAX ] ;
