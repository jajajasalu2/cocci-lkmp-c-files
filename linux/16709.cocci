...
position p;
@@
 const unsigned short cocci_id@p [ NR_SCANCODES ] ;
...
position p;
@@
 struct dc_kbd {  struct input_dev * dev ;  unsigned short keycode [ NR_SCANCODES ] ;  unsigned char new [ 8 ] ;  unsigned char old [ 8 ] ; } cocci_id@p ;
