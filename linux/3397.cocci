...
position p;
@@
 struct imx_tpm_pwm_param cocci_id@p ;
...
typedef u8,u32;
@@
 struct imx_tpm_pwm_param {  u8 prescale ;  u32 mod ;  u32 val ; } cocci_id@p ;
...
position p;
@@
 struct imx_tpm_pwm_chip cocci_id@p ;
...
typedef u32;
@@
 struct imx_tpm_pwm_chip {  struct pwm_chip chip ;  struct clk * clk ;  void __iomem * base ;  struct mutex lock ;  u32 user_count ;  u32 enable_count ;  u32 real_period ; } cocci_id@p ;
