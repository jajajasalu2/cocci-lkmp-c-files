...
position p;
@@
 enum { MLX5_HEALTH_SYNDR_FW_ERR = 0x1 , MLX5_HEALTH_SYNDR_IRISC_ERR = 0x7 , MLX5_HEALTH_SYNDR_HW_UNRECOVERABLE_ERR = 0x8 , MLX5_HEALTH_SYNDR_CRC_ERR = 0x9 , MLX5_HEALTH_SYNDR_FETCH_PCI_ERR = 0xa , MLX5_HEALTH_SYNDR_HW_FTL_ERR = 0xb , MLX5_HEALTH_SYNDR_ASYNC_EQ_OVERRUN_ERR = 0xc , MLX5_HEALTH_SYNDR_EQ_ERR = 0xd , MLX5_HEALTH_SYNDR_EQ_INV = 0xe , MLX5_HEALTH_SYNDR_FFSER_ERR = 0xf , MLX5_HEALTH_SYNDR_HIGH_TEMP = 0x10 , } cocci_id@p ;
...
position p;
@@
 enum mlx5_vsc_state cocci_id@p ;
...
position p;
@@
 struct mlx5_fw_reporter_ctx * cocci_id@p ;
...
position p;
@@
 enum { MLX5_DROP_NEW_HEALTH_WORK , } cocci_id@p ;
...
position p;
@@
 enum { MLX5_HEALTH_POLL_INTERVAL = 2 * HZ , MAX_MISSES = 3 , } cocci_id@p ;
...
typedef u8;
@@
 struct mlx5_fw_reporter_ctx {  u8 err_synd ;  int miss_counter ; } cocci_id@p ;
...
position p;
@@
 enum { MLX5_SENSOR_NO_ERR = 0 , MLX5_SENSOR_PCI_COMM_ERR = 1 , MLX5_SENSOR_PCI_ERR = 2 , MLX5_SENSOR_NIC_DISABLED = 3 , MLX5_SENSOR_NIC_SW_RESET = 4 , MLX5_SENSOR_FW_SYND_RFR = 5 , } cocci_id@p ;
