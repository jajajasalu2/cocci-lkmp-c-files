...
position p;
@@
 const struct isp_format_info * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_csc cocci_id@p ;
...
position p;
@@
 struct isp_prev_device cocci_id@p ;
...
position p;
@@
 const struct isp_video_operations cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_csup * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_yclimit * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_blkadj * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_cfa * cocci_id@p ;
...
position p;
@@
 enum preview_ycpos_mode cocci_id@p ;
...
position p;
@@
 struct isp_pipeline * cocci_id@p ;
...
position p;
@@
 const struct prev_params * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_nf * cocci_id@p ;
...
position p;
@@
 struct omap3isp_prev_update_config * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_gtables * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_dcor * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_rgbtorgb * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_luma * cocci_id@p ;
...
position p;
@@
 const struct omap3isp_prev_wbal * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ 4 ] [ 4 ] ;
...
position p;
@@
 const struct preview_update cocci_id@p [ ] ;
...
position p;
@@
 const struct omap3isp_prev_hmed * cocci_id@p ;
