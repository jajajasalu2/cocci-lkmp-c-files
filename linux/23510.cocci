...
position p;
@@
 struct glk_hdmi_pcm cocci_id@p ;
...
position p;
@@
 enum { GLK_DPCM_AUDIO_PB = 0 , GLK_DPCM_AUDIO_CP , GLK_DPCM_AUDIO_HS_PB , GLK_DPCM_AUDIO_ECHO_REF_CP , GLK_DPCM_AUDIO_REF_CP , GLK_DPCM_AUDIO_DMIC_CP , GLK_DPCM_AUDIO_HDMI1_PB , GLK_DPCM_AUDIO_HDMI2_PB , GLK_DPCM_AUDIO_HDMI3_PB , } cocci_id@p ;
...
position p;
@@
 struct glk_hdmi_pcm {  struct list_head head ;  struct snd_soc_dai * codec_dai ;  int device ; } cocci_id@p ;
...
position p;
@@
 struct glk_card_private * cocci_id@p ;
...
typedef bool;
@@
 struct glk_card_private {  struct snd_soc_jack geminilake_headset ;  struct list_head hdmi_pcm_list ;  bool common_hdmi_codec_drv ; } cocci_id@p ;
