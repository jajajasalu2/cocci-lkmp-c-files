...
position p;
@@
 enum hnae3_hw_error_type cocci_id@p ;
...
position p;
@@
 struct hclge_tx_buff_alloc_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_vport_mac_addr_cfg * cocci_id@p ;
...
position p;
@@
 struct hclge_mac_mgr_tbl_entry_cmd cocci_id@p ;
...
position p;
@@
 const struct hclge_mac_mgr_tbl_entry_cmd cocci_id@p [ ] ;
...
position p;
@@
 struct hnae3_ring_chain_node * cocci_id@p ;
...
position p;
@@
 struct hns3_mac_stats * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ BD_LIST_MAX_NUM ] ;
...
position p;
@@
 struct hclge_set_fd_key_config_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_serdes_lb_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_desc cocci_id@p [ 1 ] ;
...
position p;
@@
 struct hclge_rx_priv_buff_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_fd_rule * cocci_id@p ;
...
position p;
@@
 struct hclge_pkt_buf_alloc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hclge_dev * hdev ) ;
...
position p;
@@
 struct hclge_fd_ad_config_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_rss_indirection_table_cmd * cocci_id@p ;
...
position p;
@@
 struct hnae3_handle * cocci_id@p ;
...
position p;
@@
 struct hclge_pf_rst_done_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_vport_vtag_tx_cfg_cmd * cocci_id@p ;
...
position p;
@@
 struct hnae3_ae_dev * cocci_id@p ;
...
position p;
@@
 struct hclge_rss_tc_mode_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_func_status_cmd * cocci_id@p ;
...
position p;
@@
 struct ifla_vf_info * cocci_id@p ;
...
position p;
@@
 struct hclge_tx_vlan_type_cfg_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_promisc_cfg_cmd * cocci_id@p ;
...
position p;
@@
 struct ethtool_rx_flow_spec * cocci_id@p ;
...
position p;
@@
 struct hclge_vport_vlan_cfg * cocci_id@p ;
...
position p;
@@
 struct ethtool_usrip6_spec * cocci_id@p ;
...
position p;
@@
 struct hclge_ctrl_vector_chain_cmd * cocci_id@p ;
...
position p;
@@
 struct ethtool_tcpip4_spec * cocci_id@p ;
...
position p;
@@
 struct hclge_cfg_com_tqp_queue_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_umv_spc_alc_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_fd_ad_data cocci_id@p ;
...
position p;
@@
 struct hclge_config_mac_mode_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_rx_priv_wl_buf * cocci_id@p ;
...
position p;
@@
 struct hclge_rss_input_tuple_cmd * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hnae3_handle * handle ) ;
...
position p;
@@
 struct hclge_vlan_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hclge_dev * hdev ) ;
...
position p;
@@
 struct hnae3_knic_private_info * cocci_id@p ;
...
position p;
@@
 struct hclge_tc_thrd * cocci_id@p ;
...
position p;
@@
 struct hclge_fd_rule_tuples * cocci_id@p ;
...
position p;
@@
 struct hclge_get_fd_allocation_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_shared_buf * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hnae3_ae_dev * ae_dev ) ;
...
position p;
@@
 struct hclge_fd_tcam_config_3_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_rx_com_wl * cocci_id@p ;
...
position p;
@@
 struct ethtool_tcpip6_spec * cocci_id@p ;
...
position p;
@@
 struct hclge_cfg_param_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_fd_tcam_config_1_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_config_auto_neg_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_pf_res_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_priv_buf * cocci_id@p ;
...
position p;
@@
 struct hclge_desc cocci_id@p [ 2 ] ;
...
position p;
@@
 struct hclge_reset_tqp_queue_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_misc_vector * cocci_id@p ;
...
position p;
@@
 struct hclge_mac_vlan_tbl_entry_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_sfp_info_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_rx_com_thrd * cocci_id@p ;
...
position p;
@@
 struct hclge_reset_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_vlan_filter_vf_cfg_cmd * cocci_id@p ;
...
position p;
@@
 enum hnae3_reset_type cocci_id@p ;
...
position p;
@@
 enum HCLGE_MAC_ADDR_TYPE cocci_id@p ;
...
position p;
@@
 struct hclge_tqp_map_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_desc cocci_id@p [ HCLGE_PF_CFG_DESC_NUM ] ;
...
typedef bool;
@@
 bool cocci_id@p ( struct hnae3_handle * handle ) ;
...
position p;
@@
 const struct key_info cocci_id@p [ ] ;
...
position p;
@@
 struct hclge_cfg_gro_status_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_set_led_state_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_config_fec_cmd * cocci_id@p ;
...
position p;
@@
 enum hclge_mac_vlan_tbl_opcode cocci_id@p ;
...
position p;
@@
 const struct flow_keys * cocci_id@p ;
...
position p;
@@
 struct hclge_vlan_filter_pf_cfg_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_config_mac_speed_dup_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_tx_vtag_cfg * cocci_id@p ;
...
position p;
@@
 const enum hclge_opcode_type cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct hclge_dev * hdev , int new_mps ) ;
...
position p;
@@
 struct hclge_config_max_frm_size_cmd * cocci_id@p ;
...
position p;
@@
 const struct hclge_comm_stats_str cocci_id@p [ ] ;
...
position p;
@@
 struct hclge_link_status_cmd * cocci_id@p ;
...
position p;
@@
 const struct hnae3_ae_ops cocci_id@p ;
...
position p;
@@
 struct hclge_vlan_filter_ctrl_cmd * cocci_id@p ;
...
position p;
@@
 const struct hclge_fd_rule_tuples * cocci_id@p ;
...
position p;
@@
 struct hclge_vf_rst_cmd * cocci_id@p ;
...
position p;
@@
 enum hnae3_reset_type cocci_id@p ( struct hnae3_ae_dev * ae_dev , unsigned long * addr ) ;
...
position p;
@@
 struct hnae3_client * cocci_id@p ;
...
position p;
@@
 struct hclge_cfg_tso_status_cmd * cocci_id@p ;
...
position p;
@@
 enum hclge_opcode_type cocci_id@p ;
...
typedef bool,u16;
@@
 int cocci_id@p ( struct hclge_dev * hdev , u16 space_size , u16 * allocated_size , bool is_alloc ) ;
...
position p;
@@
 struct hclge_rx_vlan_type_cfg_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_fd_tcam_config_2_cmd * cocci_id@p ;
...
position p;
@@
 enum hnae3_port_base_vlan_state cocci_id@p ;
...
position p;
@@
 struct hclge_get_fd_mode_cmd * cocci_id@p ;
...
position p;
@@
 struct hnae3_vector_info * cocci_id@p ;
...
position p;
@@
 enum HLCGE_PORT_TYPE cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ HCLGE_MAX_TC_NUM ] ;
...
position p;
@@
 struct hnae3_ae_algo cocci_id@p ;
...
position p;
@@
 struct irq_affinity_notify * cocci_id@p ;
...
position p;
@@
 struct hclge_promisc_param cocci_id@p ;
...
position p;
@@
 struct hclge_mac_vlan_switch_cmd * cocci_id@p ;
...
position p;
@@
 enum hclge_cmd_status cocci_id@p ;
...
position p;
@@
 struct ethtool_channels * cocci_id@p ;
...
position p;
@@
 struct ethtool_usrip4_spec * cocci_id@p ;
...
position p;
@@
 struct hclge_rss_config_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_rx_vtag_cfg * cocci_id@p ;
...
position p;
@@
 struct hclge_fd_key_cfg * cocci_id@p ;
...
position p;
@@
 struct hclge_mac_stats cocci_id@p ;
...
position p;
@@
 struct hclge_desc cocci_id@p [ HCLGE_DFX_REG_BD_NUM ] ;
...
position p;
@@
 struct hclge_pf_rst_sync_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_desc cocci_id@p [ HCLGE_MAC_CMD_NUM ] ;
...
position p;
@@
 struct hclge_vport_vtag_rx_cfg_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_desc cocci_id@p [ 3 ] ;
...
position p;
@@
 enum hnae3_reset_notify_type cocci_id@p ;
...
position p;
@@
 enum hclge_led_status { HCLGE_LED_OFF , HCLGE_LED_ON , HCLGE_LED_NO_CHANGE = 0xFF , } cocci_id@p ;
