...
position p;
@@
 struct binder_lru_page * cocci_id@p ;
...
position p;
@@
 struct binder_alloc * cocci_id@p ;
...
position p;
@@
 enum { BINDER_DEBUG_USER_ERROR = 1U << 0 , BINDER_DEBUG_OPEN_CLOSE = 1U << 1 , BINDER_DEBUG_BUFFER_ALLOC = 1U << 2 , BINDER_DEBUG_BUFFER_ALLOC_ASYNC = 1U << 3 , } cocci_id@p ;
