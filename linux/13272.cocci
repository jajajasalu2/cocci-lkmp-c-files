...
position p;
@@
 enum gpio_command { GPIO_COMMAND_RESET = 0x00 , GPIO_COMMAND_REQ1 = 0x04 , GPIO_COMMAND_WRITE = 0x20 , GPIO_COMMAND_REQ2 = 0x24 , GPIO_COMMAND_READ = 0x80 , GPIO_COMMAND_VIDEO = 0x84 , GPIO_COMMAND_IDLE = 0xA0 , GPIO_COMMAND_ADDR = 0xA4 , } cocci_id@p ;
...
position p;
@@
 struct saa7134_go7007 * cocci_id@p ;
...
position p;
@@
 enum hpi_address { HPI_ADDR_VIDEO_BUFFER = 0xe4 , HPI_ADDR_INIT_BUFFER = 0xea , HPI_ADDR_INTR_RET_VALUE = 0xee , HPI_ADDR_INTR_RET_DATA = 0xec , HPI_ADDR_INTR_STATUS = 0xf4 , HPI_ADDR_INTR_WR_PARAM = 0xf6 , HPI_ADDR_INTR_WR_INDEX = 0xf8 , } cocci_id@p ;
...
@@
 struct saa7134_go7007 {  struct v4l2_subdev sd ;  struct saa7134_dev * dev ;  u8 * top ;  u8 * bottom ;  dma_addr_t top_dma ;  dma_addr_t bottom_dma ; } cocci_id@p ;
...
position p;
@@
 const struct go7007_board_info cocci_id@p ;
...
position p;
@@
 const struct go7007_hpi_ops cocci_id@p ;
...
position p;
@@
 struct saa7134_mpeg_ops cocci_id@p ;
