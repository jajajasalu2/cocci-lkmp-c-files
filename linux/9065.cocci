...
position p;
@@
 struct mlx5e_port_buffer cocci_id@p ;
...
position p;
@@
 struct mlx5e_cee_config * cocci_id@p ;
...
position p;
@@
 enum mlx5_dcbx_oper_mode cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct mlx5e_priv * priv , u8 dscp , u8 prio ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLX5E_MAX_PRIORITY ] ;
...
typedef u8;
@@
 int cocci_id@p ( struct mlx5e_priv * priv , u8 trust_state ) ;
...
position p;
@@
 enum { MLX5E_VENDOR_TC_GROUP_NUM = 7 , MLX5E_LOWEST_PRIO_GROUP = 0 , } cocci_id@p ;
