...
position p;
@@
 struct vlan_vid_info * cocci_id@p ;
...
typedef u16;
@@
 struct vlan_vid_info {  struct list_head list ;  __be16 proto ;  u16 vid ;  int refcount ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net_device * dev , int vid , void * arg ) ;
