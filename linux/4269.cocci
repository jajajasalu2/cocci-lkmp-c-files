...
typedef u8;
@@
 struct bios_settings {  const char * vendor ;  const char * product ;  const char * version ;  u8 fanreg ;  u8 tempreg ;  struct fancmd cmd ;  int mcmd_enable ; } cocci_id@p ;
...
position p;
@@
 const struct manualcmd cocci_id@p ;
...
typedef u8;
@@
 struct manualcmd {  u8 mreg ;  u8 moff ; } cocci_id@p ;
...
position p;
@@
 struct ctrl_settings cocci_id@p ;
...
position p;
@@
 const struct bios_settings * cocci_id@p ;
...
typedef u8;
@@
 struct ctrl_settings {  u8 fanreg ;  u8 tempreg ;  struct fancmd cmd ;  int mcmd_enable ; } cocci_id@p ;
...
typedef u8;
@@
 struct fancmd {  u8 cmd_off ;  u8 cmd_auto ; } cocci_id@p ;
