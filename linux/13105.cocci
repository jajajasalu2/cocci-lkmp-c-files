...
position p;
@@
 const struct gnss_operations cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,wait_queue_head_t,speed_t;
@@
 struct sirf_data {  struct gnss_device * gdev ;  struct serdev_device * serdev ;  speed_t speed ;  struct regulator * vcc ;  struct regulator * lna ;  struct gpio_desc * on_off ;  struct gpio_desc * wakeup ;  int irq ;  bool active ;  struct mutex gdev_mutex ;  bool open ;  struct mutex serdev_mutex ;  int serdev_count ;  wait_queue_head_t power_wait ; } cocci_id@p ;
