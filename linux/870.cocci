...
typedef u8;
@@
 u8 cocci_id@p [ NAND_HYNIX_1XNM_RR_REPEAT ] ;
...
position p;
@@
 const struct hynix_read_retry_otp cocci_id@p [ ] ;
...
position p;
@@
 struct hynix_nand {  const struct hynix_read_retry * read_retry ; } cocci_id@p ;
...
position p;
@@
 struct hynix_read_retry * cocci_id@p ;
...
typedef u8;
@@
 struct hynix_read_retry_otp {  int nregs ;  const u8 * regs ;  const u8 * values ;  int page ;  int size ; } cocci_id@p ;
...
position p;
@@
 const struct nand_manufacturer_ops cocci_id@p ;
...
typedef u8;
@@
 struct hynix_read_retry {  int nregs ;  const u8 * regs ;  u8 values [ 0 ] ; } cocci_id@p ;
