...
position p;
@@
 struct uid_gid_extent cocci_id@p ;
...
position p;
@@
 const struct uid_gid_extent * cocci_id@p ;
...
typedef bool,u32;
@@
 struct idmap_key {  bool map_up ;  u32 id ;  u32 count ; } cocci_id@p ;
...
position p;
@@
 const struct idmap_key * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( const struct file * file , struct user_namespace * ns , int cap_setid , struct uid_gid_map * map ) ;
