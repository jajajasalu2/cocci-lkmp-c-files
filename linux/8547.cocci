...
position p;
@@
 struct bcm_enet_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ;  int mib_reg ; } cocci_id@p ;
...
position p;
@@
 struct bcm_enet_priv cocci_id@p ;
...
position p;
@@
 struct bcm63xx_enetsw_platform_data * cocci_id@p ;
...
position p;
@@
 const struct bcm_enet_stats * cocci_id@p ;
...
position p;
@@
 struct bcm63xx_enetsw_port * cocci_id@p ;
...
position p;
@@
 struct bcm_enet_desc * cocci_id@p ;
...
position p;
@@
 struct bcm_enet_stats cocci_id@p ;
...
position p;
@@
 struct bcm63xx_enet_platform_data * cocci_id@p ;
