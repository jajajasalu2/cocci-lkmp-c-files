...
position p;
@@
 struct ti_st_plat_data * cocci_id@p ;
...
position p;
@@
 struct platform_device * cocci_id@p [ MAX_ST_DEVICES ] ;
...
position p;
@@
 struct bts_action_send * cocci_id@p ;
