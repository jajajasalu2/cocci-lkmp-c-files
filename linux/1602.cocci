...
position p;
@@
 const struct pl2303_type_data cocci_id@p [ TYPE_COUNT ] ;
...
position p;
@@
 enum pl2303_type { TYPE_01 , TYPE_HX , TYPE_HXN , TYPE_COUNT , } cocci_id@p ;
...
position p;
@@
 struct pl2303_serial_private {  const struct pl2303_type_data * type ;  unsigned long quirks ; } cocci_id@p ;
...
typedef speed_t;
@@
 struct pl2303_type_data {  speed_t max_baud_rate ;  unsigned long quirks ;  unsigned int no_autoxonxoff : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct pl2303_type_data * cocci_id@p ;
...
position p;
@@
 struct pl2303_serial_private * cocci_id@p ;
...
position p;
@@
 struct pl2303_private * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct usb_serial_port * port , bool enable ) ;
...
@@
 struct pl2303_private {  spinlock_t lock ;  u8 line_control ;  u8 line_status ;  u8 line_settings [ 7 ] ; } cocci_id@p ;
