...
position p;
@@
 void cocci_id@p ( struct dsi_data * dsi ) ;
...
position p;
@@
 struct dsi_irq_stats {  unsigned long last_reset ;  unsigned int irq_count ;  unsigned int dsi_irqs [ 32 ] ;  unsigned int vc_irqs [ 4 ] [ 32 ] ;  unsigned int cio_irqs [ 32 ] ; } cocci_id@p ;
...
typedef u16;
@@
 struct dsi_lp_clock_info {  unsigned long lp_clk ;  u16 lp_clk_div ; } cocci_id@p ;
...
position p;
@@
 struct dss_pll_clock_info cocci_id@p ;
...
position p;
@@
 struct dsi_lane_config cocci_id@p [ DSI_MAX_NR_LANES ] ;
...
position p;
@@
 int cocci_id@p ( struct dsi_data * dsi ) ;
...
position p;
@@
 struct dsi_packet_sent_handler_data * cocci_id@p ;
...
position p;
@@
 struct dsi_lp_clock_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,omap_dsi_isr_t;
@@
 struct dsi_isr_data {  omap_dsi_isr_t isr ;  void * arg ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 enum dsi_quirks { DSI_QUIRK_PLL_PWR_BUG = ( 1 << 0 ) , DSI_QUIRK_DCS_CMD_CONFIG_VC = ( 1 << 1 ) , DSI_QUIRK_VC_OCP_WIDTH = ( 1 << 2 ) , DSI_QUIRK_REVERSE_TXCLKESC = ( 1 << 3 ) , DSI_QUIRK_GNQ = ( 1 << 4 ) , DSI_QUIRK_PHY_DCC = ( 1 << 5 ) , } cocci_id@p ;
...
position p;
@@
 enum dsi_cio_power_state { DSI_COMPLEXIO_POWER_OFF = 0x0 , DSI_COMPLEXIO_POWER_ON = 0x1 , DSI_COMPLEXIO_POWER_ULPS = 0x2 , } cocci_id@p ;
...
position p;
@@
 struct omap_dss_device * cocci_id@p ;
...
position p;
@@
 struct dsi_clk_calc_ctx * cocci_id@p ;
...
position p;
@@
 struct dsi_isr_data * cocci_id@p ;
...
typedef u8;
@@
 struct dsi_lane_config {  enum dsi_lane_function function ;  u8 polarity ; } cocci_id@p ;
...
position p;
@@
 struct omap_dss_dsi_videomode_timings * cocci_id@p ;
...
position p;
@@
 const struct dss_pll_hw cocci_id@p ;
...
position p;
@@
 struct dsi_of_data {  enum dsi_model model ;  const struct dss_pll_hw * pll_hw ;  const struct dsi_module_id_data * modules ;  unsigned int max_fck_freq ;  unsigned int max_pll_lpdiv ;  enum dsi_quirks quirks ; } cocci_id@p ;
...
position p;
@@
 const struct dsi_module_id_data cocci_id@p [ ] ;
...
position p;
@@
 const struct dsi_reg cocci_id@p ;
...
position p;
@@
 struct dsi_packet_sent_handler_data {  struct dsi_data * dsi ;  struct completion * completion ; } cocci_id@p ;
...
position p;
@@
 const struct omap_dss_dsi_videomode_timings * cocci_id@p ;
...
position p;
@@
 struct dsi_isr_tables {  struct dsi_isr_data isr_table [ DSI_MAX_NR_ISRS ] ;  struct dsi_isr_data isr_table_vc [ 4 ] [ DSI_MAX_NR_ISRS ] ;  struct dsi_isr_data isr_table_cio [ DSI_MAX_NR_ISRS ] ; } cocci_id@p ;
...
position p;
@@
 const struct dss_pll_ops cocci_id@p ;
...
position p;
@@
 const struct omap_dsi_pin_config * cocci_id@p ;
...
typedef u32;
@@
 struct dsi_module_id_data {  u32 address ;  int id ; } cocci_id@p ;
...
position p;
@@
 enum dss_dsi_content_type cocci_id@p ;
...
position p;
@@
 struct dsi_irq_stats cocci_id@p ;
...
position p;
@@
 enum fifo_size { DSI_FIFO_SIZE_0 = 0 , DSI_FIFO_SIZE_32 = 1 , DSI_FIFO_SIZE_64 = 2 , DSI_FIFO_SIZE_96 = 3 , DSI_FIFO_SIZE_128 = 4 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dsi_data * dsi , int channel ) ;
...
position p;
@@
 enum dsi_cio_power_state cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ DSI_MAX_NR_LANES ] ;
...
position p;
@@
 enum omap_dss_dsi_pixel_format cocci_id@p ;
...
position p;
@@
 enum dsi_lane_function { DSI_LANE_UNUSED = 0 , DSI_LANE_CLK , DSI_LANE_DATA1 , DSI_LANE_DATA2 , DSI_LANE_DATA3 , DSI_LANE_DATA4 , } cocci_id@p ;
...
position p;
@@
 const enum dsi_lane_function cocci_id@p [ ] ;
...
position p;
@@
 enum dsi_pll_power_state { DSI_PLL_POWER_OFF = 0x0 , DSI_PLL_POWER_ON_HSCLK = 0x1 , DSI_PLL_POWER_ON_ALL = 0x2 , DSI_PLL_POWER_ON_DIV = 0x3 , } cocci_id@p ;
...
position p;
@@
 enum dsi_vc_source { DSI_VC_SOURCE_L4 = 0 , DSI_VC_SOURCE_VP , } cocci_id@p ;
...
typedef u16;
@@
 struct dsi_reg {  u16 module ;  u16 idx ; } cocci_id@p ;
...
position p;
@@
 struct dsi_isr_tables * cocci_id@p ;
...
position p;
@@
 enum dsi_model { DSI_MODEL_OMAP3 , DSI_MODEL_OMAP4 , DSI_MODEL_OMAP5 , } cocci_id@p ;
...
position p;
@@
 struct omap_dsi_pin_config cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( void * arg , u32 mask ) ;
...
position p;
@@
 const struct omap_dss_dsi_config * cocci_id@p ;
...
position p;
@@
 const struct dsi_of_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef omap_dsi_isr_t;
@@
 omap_dsi_isr_t cocci_id@p ;
...
position p;
@@
 enum dsi_pll_power_state cocci_id@p ;
...
position p;
@@
 const struct omap_dss_device_ops cocci_id@p ;
