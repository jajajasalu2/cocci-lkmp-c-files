...
position p;
@@
 struct gen_pool_chunk * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct subchannel * , void * ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct subchannel_id , void * ) ;
...
position p;
@@
 struct channel_subsystem * cocci_id@p [ MAX_CSS_IDX + 1 ] ;
...
position p;
@@
 struct css_device_id * cocci_id@p ;
...
position p;
@@
 struct cb_data {  void * data ;  struct idset * set ;  int ( * fn_known_sch ) ( struct subchannel * , void * ) ;  int ( * fn_unknown_sch ) ( struct subchannel_id , void * ) ; } cocci_id@p ;
