...
position p;
@@
 enum tpacpi_volume_access_mode cocci_id@p ;
...
typedef u32,u16;
@@
 struct thinkpad_id_data {  unsigned int vendor ;  char * bios_version_str ;  char * ec_version_str ;  u32 bios_model ;  u32 ec_model ;  u16 bios_release ;  u16 ec_release ;  char * model_str ;  char * nummodel_str ; } cocci_id@p ;
...
position p;
@@
 enum led_access_mode cocci_id@p ;
...
position p;
@@
 struct ibm_thermal_sensors_struct * cocci_id@p ;
...
position p;
@@
 enum tpacpi_rfkill_state cocci_id@p ;
...
position p;
@@
 enum tpacpi_rfkill_state { TPACPI_RFK_RADIO_OFF = 0 , TPACPI_RFK_RADIO_ON , } cocci_id@p ;
...
position p;
@@
 enum tpacpi_brightness_access_mode cocci_id@p ;
...
position p;
@@
 enum { TP_EC_THERMAL_TMP0 = 0x78 , TP_EC_THERMAL_TMP8 = 0xC0 , TP_EC_THERMAL_TMP_NA = - 128 , TPACPI_THERMAL_SENSOR_NA = - 128000 , } cocci_id@p ;
...
position p;
@@
 struct tp_nvram_state cocci_id@p [ 2 ] ;
...
position p;
@@
 enum video_access_mode cocci_id@p ;
...
position p;
@@
 enum tpacpi_volume_capabilities { TPACPI_VOL_CAP_AUTO = 0 , TPACPI_VOL_CAP_VOLMUTE , TPACPI_VOL_CAP_MUTEONLY , TPACPI_VOL_CAP_MAX , } cocci_id@p ;
...
position p;
@@
 enum { TP_ACPI_WAKEUP_NONE = 0 , TP_ACPI_WAKEUP_BAYEJ , TP_ACPI_WAKEUP_UNDOCK , } cocci_id@p ;
...
position p;
@@
 enum { TPACPI_LED_EC_HLCL = 0x0c , TPACPI_LED_EC_HLBL = 0x0d , TPACPI_LED_EC_HLMS = 0x0e , } cocci_id@p ;
...
position p;
@@
 enum fan_control_commands cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * ignored ) ;
...
position p;
@@
 enum tp_nvram_addr { TP_NVRAM_ADDR_HK2 = 0x57 , TP_NVRAM_ADDR_THINKLIGHT = 0x58 , TP_NVRAM_ADDR_VIDEO = 0x59 , TP_NVRAM_ADDR_BRIGHTNESS = 0x5e , TP_NVRAM_ADDR_MIXER = 0x60 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef tpacpi_keymap_entry_t;
@@
 tpacpi_keymap_entry_t cocci_id@p [ TPACPI_HOTKEY_MAP_LEN ] ;
...
position p;
@@
 enum ADAPTIVE_KEY_MODE { HOME_MODE , WEB_BROWSER_MODE , WEB_CONFERENCE_MODE , FUNCTION_MODE , LAYFLAT_MODE , } cocci_id@p ;
...
position p;
@@
 struct tpacpi_battery_data {  int charge_start ;  int start_support ;  int charge_stop ;  int stop_support ; } cocci_id@p ;
...
position p;
@@
 const struct tpacpi_rfk_ops cocci_id@p ;
...
position p;
@@
 struct device_driver * cocci_id@p ;
...
position p;
@@
 enum tpacpi_volume_capabilities cocci_id@p ;
...
position p;
@@
 enum tpacpi_mute_btn_mode { TP_EC_MUTE_BTN_LATCH = 0 , TP_EC_MUTE_BTN_NONE = 2 , TP_EC_MUTE_BTN_TOGGLE = 3 , } cocci_id@p ;
...
position p;
@@
 struct tpacpi_rfk_ops {  int ( * get_status ) ( void ) ;  int ( * set_status ) ( const enum tpacpi_rfkill_state ) ; } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ TPACPI_LED_NUMLEDS ] ;
...
position p;
@@
 struct tpacpi_led_classdev {  struct led_classdev led_classdev ;  int led ; } cocci_id@p ;
...
position p;
@@
 struct tpacpi_alsa_data * cocci_id@p ;
...
position p;
@@
 enum { TP_ACPI_VIDEO_570_PHSCMD = 0x87 , TP_ACPI_VIDEO_570_PHSMASK = 0x03 , TP_ACPI_VIDEO_570_PHS2CMD = 0x8b , TP_ACPI_VIDEO_570_PHS2SET = 0x80 , } cocci_id@p ;
...
position p;
@@
 const struct tpacpi_rfk * cocci_id@p ;
...
position p;
@@
 enum { THRESHOLD_START , THRESHOLD_STOP , } cocci_id@p ;
...
position p;
@@
 struct tpacpi_alsa_data {  struct snd_card * card ;  struct snd_ctl_elem_id * ctl_mute_id ;  struct snd_ctl_elem_id * ctl_vol_id ; } cocci_id@p ;
...
position p;
@@
 struct acpi_object_list cocci_id@p ;
...
position p;
@@
 struct tp_led_table * cocci_id@p ;
...
typedef u8;
@@
 struct ibm_struct {  char * name ;  int ( * read ) ( struct seq_file * ) ;  int ( * write ) ( char * ) ;  void ( * exit ) ( void ) ;  void ( * resume ) ( void ) ;  void ( * suspend ) ( void ) ;  void ( * shutdown ) ( void ) ;  struct list_head all_drivers ;  struct tp_acpi_drv_struct * acpi ;  struct {  u8 acpi_driver_registered : 1 ;  u8 acpi_notify_installed : 1 ;  u8 proc_created : 1 ;  u8 init_called : 1 ;  u8 experimental : 1 ; } flags ; } cocci_id@p ;
...
position p;
@@
 enum led_brightness cocci_id@p ;
...
typedef umode_t;
@@
 struct ibm_init_struct {  char param [ 32 ] ;  int ( * init ) ( struct ibm_init_struct * ) ;  umode_t base_procfs_mode ;  struct ibm_struct * data ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p ( int is_supported ) ;
...
position p;
@@
 enum { TP_ACPI_WGSV_GET_STATE = 0x01 , TP_ACPI_WGSV_PWR_ON_ON_RESUME = 0x02 , TP_ACPI_WGSV_PWR_OFF_ON_RESUME = 0x03 , TP_ACPI_WGSV_SAVE_STATE = 0x04 , } cocci_id@p ;
...
position p;
@@
 enum { fan_status_offset = 0x2f , fan_rpm_offset = 0x84 , fan_select_offset = 0x31 , TP_EC_FAN_FULLSPEED = 0x40 , TP_EC_FAN_AUTO = 0x80 , TPACPI_FAN_LAST_LEVEL = 0x100 , } cocci_id@p ;
...
position p;
@@
 struct attribute_set * cocci_id@p ;
...
position p;
@@
 enum video_access_mode { TPACPI_VIDEO_NONE = 0 , TPACPI_VIDEO_570 , TPACPI_VIDEO_770 , TPACPI_VIDEO_NEW , } cocci_id@p ;
...
position p;
@@
 struct tp_nvram_state * cocci_id@p ;
...
position p;
@@
 enum { TP_ACPI_WANCARD_HWPRESENT = 0x01 , TP_ACPI_WANCARD_RADIOSSW = 0x02 , TP_ACPI_WANCARD_RESUMECTRL = 0x04 , } cocci_id@p ;
...
position p;
@@
 struct power_supply * cocci_id@p ;
...
position p;
@@
 enum { TP_ACPI_MULTI_MODE_TABLET_LIKE = TP_ACPI_MULTI_MODE_TABLET | TP_ACPI_MULTI_MODE_STAND | TP_ACPI_MULTI_MODE_TENT | TP_ACPI_MULTI_MODE_STAND_TENT , } cocci_id@p ;
...
position p;
@@
 const struct dmi_header * cocci_id@p ;
...
position p;
@@
 enum thermal_access_mode { TPACPI_THERMAL_NONE = 0 , TPACPI_THERMAL_ACPI_TMP07 , TPACPI_THERMAL_ACPI_UPDT , TPACPI_THERMAL_TPEC_8 , TPACPI_THERMAL_TPEC_16 , } cocci_id@p ;
...
typedef u32;
@@
 struct tpacpi_quirk {  unsigned int vendor ;  u32 bios ;  u32 ec ;  unsigned long quirks ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef led_status_t;
@@
 const enum led_status_t cocci_id@p ;
...
position p;
@@
 enum { TP_ACPI_BLTH_GET_ULTRAPORT_ID = 0x00 , TP_ACPI_BLTH_GET_PWR_ON_RESUME = 0x01 , TP_ACPI_BLTH_PWR_ON_ON_RESUME = 0x02 , TP_ACPI_BLTH_PWR_OFF_ON_RESUME = 0x03 , TP_ACPI_BLTH_SAVE_STATE = 0x05 , } cocci_id@p ;
...
position p;
@@
 enum fan_status_access_mode { TPACPI_FAN_NONE = 0 , TPACPI_FAN_RD_ACPI_GFAN , TPACPI_FAN_RD_TPEC , } cocci_id@p ;
...
position p;
@@
 enum { TPACPI_HKEY_NVRAM_KNOWN_MASK = 0x00fb88c0U , TPACPI_HKEY_NVRAM_GOOD_MASK = 0x00fb8000U , } cocci_id@p ;
...
position p;
@@
 struct led_classdev * cocci_id@p ;
...
position p;
@@
 struct ibm_init_struct * cocci_id@p ;
...
position p;
@@
 enum keymap_index { TPACPI_KEYMAP_IBM_GENERIC = 0 , TPACPI_KEYMAP_LENOVO_GENERIC , } cocci_id@p ;
...
typedef led_status_t;
@@
 enum led_status_t { TPACPI_LED_OFF = 0 , TPACPI_LED_ON , TPACPI_LED_BLINK , } cocci_id@p ;
...
position p;
@@
 enum { TP_EC_AUDIO = 0x30 , TP_EC_AUDIO_MUTESW = 6 , TP_EC_AUDIO_LVL_MSK = 0x0F , TP_EC_AUDIO_MUTESW_MSK = ( 1 << TP_EC_AUDIO_MUTESW ) , TP_EC_VOLUME_MAX = 14 , } cocci_id@p ;
...
position p;
@@
 enum tpacpi_rfk_id { TPACPI_RFK_BLUETOOTH_SW_ID = 0 , TPACPI_RFK_WWAN_SW_ID , TPACPI_RFK_UWB_SW_ID , TPACPI_RFK_SW_MAX , } cocci_id@p ;
...
position p;
@@
 struct tpacpi_battery_driver_data cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( const bool may_warn ) ;
...
position p;
@@
 struct tp_led_table cocci_id@p [ TPACPI_LED_MAX ] ;
...
position p;
@@
 struct tp_acpi_drv_struct cocci_id@p ;
...
position p;
@@
 enum { METHOD_ERR = BIT ( 31 ) , } cocci_id@p ;
...
position p;
@@
 struct tpacpi_led_classdev cocci_id@p ;
...
position p;
@@
 const struct backlight_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const unsigned int hkey_event ) ;
...
position p;
@@
 enum led_access_mode { TPACPI_LED_NONE = 0 , TPACPI_LED_570 , TPACPI_LED_OLD , TPACPI_LED_NEW , } cocci_id@p ;
...
position p;
@@
 enum { BAT_ANY = 0 , BAT_PRIMARY = 1 , BAT_SECONDARY = 2 , } cocci_id@p ;
...
position p;
@@
 struct tpacpi_rfk * cocci_id@p [ TPACPI_RFK_SW_MAX ] ;
...
position p;
@@
 struct tpacpi_battery_driver_data {  struct tpacpi_battery_data batteries [ 3 ] ;  int individual_addressing ; } cocci_id@p ;
...
position p;
@@
 enum tpacpi_volume_access_mode { TPACPI_VOL_MODE_AUTO = 0 , TPACPI_VOL_MODE_EC , TPACPI_VOL_MODE_UCMS_STEP , TPACPI_VOL_MODE_ECNVRAM , TPACPI_VOL_MODE_MAX , } cocci_id@p ;
...
position p;
@@
 struct acpi_battery_hook cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const unsigned int scancode ) ;
...
position p;
@@
 enum thermal_access_mode cocci_id@p ;
...
position p;
@@
 enum fan_control_commands { TPACPI_FAN_CMD_SPEED = 0x0001 , TPACPI_FAN_CMD_LEVEL = 0x0002 , TPACPI_FAN_CMD_ENABLE = 0x0004 , } cocci_id@p ;
...
position p;
@@
 enum fan_status_access_mode cocci_id@p ;
...
position p;
@@
 struct thinkpad_id_data cocci_id@p ;
...
position p;
@@
 struct backlight_properties cocci_id@p ;
...
position p;
@@
 struct attribute_set_obj * cocci_id@p ;
...
position p;
@@
 struct backlight_device * cocci_id@p ;
...
position p;
@@
 enum { TP_ACPI_UWB_HWPRESENT = 0x01 , TP_ACPI_UWB_RADIOSSW = 0x02 , } cocci_id@p ;
...
position p;
@@
 struct tpacpi_rfk {  struct rfkill * rfkill ;  enum tpacpi_rfk_id id ;  const struct tpacpi_rfk_ops * ops ; } cocci_id@p ;
...
position p;
@@
 enum { TP_ACPI_MULTI_MODE_INVALID = 0 , TP_ACPI_MULTI_MODE_UNKNOWN = 1 << 0 , TP_ACPI_MULTI_MODE_LAPTOP = 1 << 1 , TP_ACPI_MULTI_MODE_TABLET = 1 << 2 , TP_ACPI_MULTI_MODE_FLAT = 1 << 3 , TP_ACPI_MULTI_MODE_STAND = 1 << 4 , TP_ACPI_MULTI_MODE_TENT = 1 << 5 , TP_ACPI_MULTI_MODE_STAND_TENT = 1 << 6 , } cocci_id@p ;
...
position p;
@@
 enum fan_control_access_mode cocci_id@p ;
...
typedef u8,u16;
@@
 struct tp_nvram_state {  u16 thinkpad_toggle : 1 ;  u16 zoom_toggle : 1 ;  u16 display_toggle : 1 ;  u16 thinklight_toggle : 1 ;  u16 hibernate_toggle : 1 ;  u16 displayexp_toggle : 1 ;  u16 display_state : 1 ;  u16 brightness_toggle : 1 ;  u16 volume_toggle : 1 ;  u16 mute : 1 ;  u8 brightness_level ;  u8 volume_level ; } cocci_id@p ;
...
position p;
@@
 const struct rfkill_ops cocci_id@p ;
...
typedef led_status_t;
@@
 enum led_status_t cocci_id@p [ TPACPI_LED_NUMLEDS ] ;
...
position p;
@@
 const enum tpacpi_rfk_id cocci_id@p ;
...
position p;
@@
 struct led_classdev cocci_id@p [ TPACPI_LED_MAX ] ;
...
position p;
@@
 enum { TPACPI_LIFE_INIT = 0 , TPACPI_LIFE_RUNNING , TPACPI_LIFE_EXITING , } cocci_id@p ;
...
position p;
@@
 struct driver_attribute * cocci_id@p [ ] ;
...
position p;
@@
 struct tp_led_table {  acpi_string name ;  int on_value ;  int off_value ;  int state ; } cocci_id@p ;
...
position p;
@@
 const struct acpi_device_id cocci_id@p [ ] ;
...
position p;
@@
 const struct tpacpi_quirk * cocci_id@p ;
...
position p;
@@
 enum fan_control_access_mode { TPACPI_FAN_WR_NONE = 0 , TPACPI_FAN_WR_ACPI_SFAN , TPACPI_FAN_WR_TPEC , TPACPI_FAN_WR_ACPI_FANS , } cocci_id@p ;
...
position p;
@@
 struct sensor_device_attribute cocci_id@p [ ] ;
...
position p;
@@
 union acpi_object cocci_id@p [ TPACPI_MAX_ACPI_ARGS ] ;
...
position p;
@@
 enum { TP_NVRAM_LEVEL_VOLUME_MAX = 14 , } cocci_id@p ;
...
typedef s32;
@@
 struct ibm_thermal_sensors_struct {  s32 temp [ TPACPI_MAX_THERMAL_SENSORS ] ; } cocci_id@p ;
...
position p;
@@
 enum { TP_EC_BACKLIGHT = 0x31 , TP_EC_BACKLIGHT_LVLMSK = 0x1F , TP_EC_BACKLIGHT_CMDMSK = 0xE0 , TP_EC_BACKLIGHT_MAPSW = 0x20 , } cocci_id@p ;
...
position p;
@@
 struct snd_ctl_elem_info * cocci_id@p ;
...
position p;
@@
 enum { TP_ACPI_BLUETOOTH_HWPRESENT = 0x01 , TP_ACPI_BLUETOOTH_RADIOSSW = 0x02 , TP_ACPI_BLUETOOTH_RESUMECTRL = 0x04 , } cocci_id@p ;
...
position p;
@@
 enum { TP_ACPI_VIDEO_S_LCD = 0x01 , TP_ACPI_VIDEO_S_CRT = 0x02 , TP_ACPI_VIDEO_S_DVI = 0x08 , } cocci_id@p ;
...
typedef u16;
@@
 struct {  u16 hotkey_mask_ff : 1 ;  u16 volume_ctrl_forbidden : 1 ; } cocci_id@p ;
...
position p;
@@
 const enum rfkill_type cocci_id@p ;
...
position p;
@@
 enum tpacpi_brightness_access_mode { TPACPI_BRGHT_MODE_AUTO = 0 , TPACPI_BRGHT_MODE_EC , TPACPI_BRGHT_MODE_UCMS_STEP , TPACPI_BRGHT_MODE_ECNVRAM , TPACPI_BRGHT_MODE_MAX , } cocci_id@p ;
