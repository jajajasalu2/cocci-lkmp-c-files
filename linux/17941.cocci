...
typedef u32;
@@
 const struct msiq_prop {  u32 first_msiq ;  u32 num_msiq ;  u32 first_devino ; } * cocci_id@p ;
...
typedef u32;
@@
 const struct addr_range_prop {  u32 msi32_high ;  u32 msi32_low ;  u32 msi32_len ;  u32 msi64_high ;  u32 msi64_low ;  u32 msi64_len ; } * cocci_id@p ;
...
position p;
@@
 struct msi_range_prop cocci_id@p ;
...
position p;
@@
 struct sparc64_msiq_cookie cocci_id@p ;
...
position p;
@@
 struct addr_range_prop cocci_id@p ;
...
typedef u32;
@@
 const struct msi_range_prop {  u32 first_msi ;  u32 num_msi ; } * cocci_id@p ;
