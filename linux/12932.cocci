...
position p;
@@
 struct chameleon_bdd cocci_id@p ;
...
position p;
@@
 struct chameleon_bar * * cocci_id@p ;
...
position p;
@@
 struct chameleon_gdd cocci_id@p ;
...
position p;
@@
 struct chameleon_fpga_header * cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct mcb_parse_priv {  phys_addr_t mapbase ;  void __iomem * base ; } cocci_id@p ;
