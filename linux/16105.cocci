...
position p;
@@
 const struct ni_route_tables * cocci_id@p ;
...
position p;
@@
 const struct ni_gpct * cocci_id@p ;
...
position p;
@@
 unsigned int ( * cocci_id@p ) ( struct ni_gpct * counter , enum ni_gpct_register reg ) ;
...
position p;
@@
 enum ni_gpct_variant cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ni_gpct * counter , unsigned int value , enum ni_gpct_register reg ) ;
...
position p;
@@
 const struct ni_gpct_device * cocci_id@p ;
