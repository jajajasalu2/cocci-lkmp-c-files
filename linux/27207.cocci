...
symbol cocci_id;
position p;
typedef bool,ext4_lblk_t;
@@
 struct rsvd_count {  int ndelonly ;  bool first_do_lblk_found ;  ext4_lblk_t first_do_lblk ;  ext4_lblk_t last_do_lblk ;  struct extent_status * left_es ;  bool partial ;  ext4_lblk_t lclu ; } cocci_id@p ;
...
position p;
@@
 struct ext4_ext_path * cocci_id@p ;
...
position p;
@@
 struct ext4_es_stats * cocci_id@p ;
...
position p;
@@
 struct ext4_pending_tree * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct extent_status * newes ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct extent_status * es ) ;
...
position p;
@@
 struct pending_reservation * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ext4_inode_info * ei , int * nr_to_scan ) ;
...
position p;
@@
 int cocci_id@p ( struct ext4_sb_info * sbi , int nr_to_scan , struct ext4_inode_info * locked_ei ) ;
...
position p;
@@
 struct ext4_es_tree * cocci_id@p ;
