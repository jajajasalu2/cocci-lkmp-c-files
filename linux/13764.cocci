...
position p;
@@
 struct lm3560_flash cocci_id@p ;
...
position p;
@@
 enum led_enable { MODE_SHDN = 0x0 , MODE_TORCH = 0x2 , MODE_FLASH = 0x3 , } cocci_id@p ;
...
position p;
@@
 struct lm3560_flash {  struct device * dev ;  struct lm3560_platform_data * pdata ;  struct regmap * regmap ;  struct mutex lock ;  enum v4l2_flash_led_mode led_mode ;  struct v4l2_ctrl_handler ctrls_led [ LM3560_LED_MAX ] ;  struct v4l2_subdev subdev_led [ LM3560_LED_MAX ] ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_ops cocci_id@p [ LM3560_LED_MAX ] ;
...
position p;
@@
 struct lm3560_platform_data * cocci_id@p ;
