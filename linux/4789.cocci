...
position p;
@@
 struct iser_reg_resources * cocci_id@p ;
...
position p;
@@
 struct iser_mem_reg * cocci_id@p ;
...
position p;
@@
 struct iser_page_vec * cocci_id@p ;
...
position p;
@@
 struct iser_fr_desc * cocci_id@p ;
...
position p;
@@
 struct iscsi_iser_task * cocci_id@p ;
...
position p;
@@
 enum iser_conn_state cocci_id@p ;
...
position p;
@@
 struct iser_login_desc * cocci_id@p ;
...
position p;
@@
 struct iser_fr_pool * cocci_id@p ;
