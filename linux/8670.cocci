...
position p;
@@
 union ixgbe_adv_rx_desc cocci_id@p ;
...
position p;
@@
 union ixgbe_adv_tx_desc cocci_id@p ;
...
position p;
@@
 struct ixgbe_q_vector cocci_id@p ;
...
position p;
@@
 struct ixgbe_nvm_version cocci_id@p ;
...
position p;
@@
 struct ixgbe_fwd_adapter * cocci_id@p ;
...
position p;
@@
 union ixgbe_atr_hash_dword cocci_id@p ;
...
position p;
@@
 struct tc_configuration * cocci_id@p ;
...
position p;
@@
 struct ixgbe_rx_buffer * cocci_id@p ;
...
position p;
@@
 struct ixgbe_nexthdr * cocci_id@p ;
...
typedef u32;
@@
 struct ixgbe_reg_info {  u32 ofs ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct ixgbe_tx_buffer * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IXGBE_PBANUM_LENGTH ] ;
...
position p;
@@
 const struct ixgbe_reg_info cocci_id@p [ ] ;
...
position p;
@@
 struct upper_walk_data cocci_id@p ;
...
position p;
@@
 struct ixgbe_ipsec_tx_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * , unsigned long event , void * p ) ;
...
position p;
@@
 struct ixgbe_mat_field * cocci_id@p ;
...
position p;
@@
 struct ixgbe_hw_stats * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ixgbe_hw * hw , struct pci_dev * pdev ) ;
...
position p;
@@
 struct ixgbe_reg_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ixgbe_adapter * ) ;
...
position p;
@@
 struct ixgbe_fcoe_ddp_pool * cocci_id@p ;
...
typedef u8,u64;
@@
 struct upper_walk_data {  struct ixgbe_adapter * adapter ;  u64 action ;  int ifindex ;  u8 queue ; } cocci_id@p ;
...
position p;
@@
 struct ixgbe_jump_table * cocci_id@p ;
...
position p;
@@
 struct ixgbe_mac_addr cocci_id@p ;
...
position p;
@@
 struct ixgbe_adapter * cocci_id@p ;
...
position p;
@@
 struct ixgbe_fdir_filter * cocci_id@p ;
...
position p;
@@
 struct ixgbe_ring_container * cocci_id@p ;
...
position p;
@@
 struct ixgbe_dcb_config * cocci_id@p ;
...
position p;
@@
 const struct ixgbe_info * cocci_id@p [ ] ;
...
position p;
@@
 struct ixgbe_mac_info * cocci_id@p ;
...
position p;
@@
 union ixgbe_atr_input * cocci_id@p ;
...
position p;
@@
 struct ixgbe_ring_feature * cocci_id@p ;
...
position p;
@@
 union {  unsigned char * network ;  struct iphdr * ipv4 ;  struct ipv6hdr * ipv6 ; } cocci_id@p ;
