...
position p;
@@
 const struct rockchip_pm_data cocci_id@p ;
...
position p;
@@
 enum { ROCKCHIP_ARM_OFF_LOGIC_NORMAL = 0 , ROCKCHIP_ARM_OFF_LOGIC_DEEP = 1 , } cocci_id@p ;
...
position p;
@@
 struct rockchip_pm_data * cocci_id@p ;
...
position p;
@@
 struct rockchip_pm_data {  const struct platform_suspend_ops * ops ;  int ( * init ) ( struct device_node * np ) ; } cocci_id@p ;
