...
position p;
@@
 struct wm8974_priv {  unsigned int mclk ;  unsigned int fs ; } cocci_id@p ;
...
position p;
@@
 struct pll_ {  unsigned int pre_div : 1 ;  unsigned int n : 4 ;  unsigned int k ; } cocci_id@p ;
