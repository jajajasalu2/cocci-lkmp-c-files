...
position p;
@@
 struct ktd2692_context * cocci_id@p ;
...
position p;
@@
 struct ktd2692_led_config_data cocci_id@p ;
...
position p;
@@
 enum ktd2692_led_mode { KTD2692_MODE_DISABLE = 0 , KTD2692_MODE_MOVIE , KTD2692_MODE_FLASH , } cocci_id@p ;
...
position p;
@@
 enum ktd2692_bitset { KTD2692_LOW = 0 , KTD2692_HIGH , } cocci_id@p ;
...
position p;
@@
 struct ktd2692_context {  struct led_classdev_flash fled_cdev ;  struct mutex lock ;  struct regulator * regulator ;  struct gpio_desc * aux_gpio ;  struct gpio_desc * ctrl_gpio ;  enum ktd2692_led_mode mode ;  enum led_brightness torch_brightness ; } cocci_id@p ;
...
typedef u32;
@@
 struct ktd2692_led_config_data {  u32 movie_max_microamp ;  u32 flash_max_microamp ;  u32 flash_max_timeout ;  enum led_brightness max_brightness ; } cocci_id@p ;
