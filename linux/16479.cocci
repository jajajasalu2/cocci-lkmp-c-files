...
typedef u8,__u8;
@@
 struct uclogic_drvdata {  struct uclogic_params params ;  __u8 * desc_ptr ;  unsigned int desc_size ;  struct input_dev * pen_input ;  struct timer_list inrange_timer ;  u8 re_state ; } cocci_id@p ;
...
position p;
@@
 struct uclogic_drvdata * cocci_id@p ;
...
position p;
@@
 struct uclogic_params cocci_id@p ;
