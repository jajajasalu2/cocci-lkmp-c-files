...
typedef u64;
@@
 struct a5xx_crashdumper {  void * ptr ;  struct drm_gem_object * bo ;  u64 iova ; } cocci_id@p ;
...
position p;
@@
 struct msm_gem_submit * cocci_id@p ;
...
position p;
@@
 struct a5xx_crashdumper * cocci_id@p ;
...
position p;
@@
 struct msm_ringbuffer * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct msm_gpu * gpu ) ;
...
typedef u32;
@@
 struct a5xx_gpu_state {  struct msm_gpu_state base ;  u32 * hlsqregs ; } cocci_id@p ;
...
typedef u32;
@@
 const struct {  u32 type ;  u32 regoffset ;  u32 count ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct adreno_gpu_funcs cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ REG_ADRENO_REGISTER_MAX ] ;
...
typedef u32;
@@
 const struct {  u32 offset ;  u32 value ; } cocci_id@p [ ] ;
...
position p;
@@
 struct a5xx_gpu_state cocci_id@p ;
