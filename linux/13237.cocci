...
position p;
@@
 struct cx23885_tvnorm cocci_id@p [ ] ;
...
position p;
@@
 enum cx23885_field2_lines { CX23885_FIELD2_SAA7114 = 0x00EF , CX23885_FIELD2_SAA7115 = 0x00F0 , CX23885_FIELD2_MICRONAS = 0x0106 , } cocci_id@p ;
...
position p;
@@
 enum cx23885_dma_unit { CX23885_DMA_BYTES , CX23885_DMA_FRAMES , } cocci_id@p ;
...
position p;
@@
 enum cx23885_vbi_mode_bits { CX23885_VBI_BITS_SLICED , CX23885_VBI_BITS_RAW , } cocci_id@p ;
...
position p;
@@
 enum cx23885_data_xfer_status { CX23885_MORE_BUFFERS_FOLLOW , CX23885_LAST_BUFFER , } cocci_id@p ;
...
position p;
@@
 enum cx23885_notification_status { CX23885_NOTIFICATION_OFF , CX23885_NOTIFICATION_ON , } cocci_id@p ;
...
position p;
@@
 enum cx23885_mute_video_shift { CX23885_MUTE_VIDEO_V_SHIFT = 8 , CX23885_MUTE_VIDEO_U_SHIFT = 16 , CX23885_MUTE_VIDEO_Y_SHIFT = 24 , } cocci_id@p ;
...
position p;
@@
 enum cx23885_pause { CX23885_PAUSE_ENCODING , CX23885_RESUME_ENCODING , } cocci_id@p ;
...
position p;
@@
 enum cx23885_mute { CX23885_UNMUTE , CX23885_MUTE , } cocci_id@p ;
...
position p;
@@
 enum cx23885_notification_type { CX23885_NOTIFICATION_REFRESH , } cocci_id@p ;
...
position p;
@@
 enum cx23885_notification_mailbox { CX23885_NOTIFICATION_NO_MAILBOX = - 1 , } cocci_id@p ;
...
position p;
@@
 enum cx23885_stream_port { CX23885_OUTPUT_PORT_MEMORY , CX23885_OUTPUT_PORT_STREAMING , CX23885_OUTPUT_PORT_SERIAL , } cocci_id@p ;
...
position p;
@@
 enum cx23885_field1_lines { CX23885_FIELD1_SAA7114 = 0x00EF , CX23885_FIELD1_SAA7115 = 0x00F0 , CX23885_FIELD1_MICRONAS = 0x0105 , } cocci_id@p ;
...
position p;
@@
 enum cx23885_capture_end { CX23885_END_AT_GOP , CX23885_END_NOW , } cocci_id@p ;
...
position p;
@@
 enum cx23885_mute_video_mask { CX23885_MUTE_VIDEO_V_MASK = 0x0000FF00 , CX23885_MUTE_VIDEO_U_MASK = 0x00FF0000 , CX23885_MUTE_VIDEO_Y_MASK = 0xFF000000 , } cocci_id@p ;
...
position p;
@@
 enum cx23885_custom_data_type { CX23885_CUSTOM_EXTENSION_USR_DATA , CX23885_CUSTOM_PRIVATE_PACKET , } cocci_id@p ;
...
position p;
@@
 enum cx23885_dma_transfer_status_bits { CX23885_DMA_TRANSFER_BITS_DONE = 0x01 , CX23885_DMA_TRANSFER_BITS_ERROR = 0x04 , CX23885_DMA_TRANSFER_BITS_LL_ERROR = 0x10 , } cocci_id@p ;
...
position p;
@@
 struct cx23885_dmaqueue * cocci_id@p ;
...
position p;
@@
 struct cx23885_tsport * cocci_id@p ;
...
position p;
@@
 enum cx23885_copyright { CX23885_COPYRIGHT_OFF , CX23885_COPYRIGHT_ON , } cocci_id@p ;
...
position p;
@@
 enum cx23885_capture_bits { CX23885_RAW_BITS_NONE = 0x00 , CX23885_RAW_BITS_YUV_CAPTURE = 0x01 , CX23885_RAW_BITS_PCM_CAPTURE = 0x02 , CX23885_RAW_BITS_VBI_CAPTURE = 0x04 , CX23885_RAW_BITS_PASSTHRU_CAPTURE = 0x08 , CX23885_RAW_BITS_TO_HOST_CAPTURE = 0x10 , } cocci_id@p ;
...
position p;
@@
 enum cx23885_framerate { CX23885_FRAMERATE_NTSC_30 , CX23885_FRAMERATE_PAL_25 , } cocci_id@p ;
...
position p;
@@
 enum cx23885_picture_mask { CX23885_PICTURE_MASK_NONE , CX23885_PICTURE_MASK_I_FRAMES , CX23885_PICTURE_MASK_I_P_FRAMES = 0x3 , CX23885_PICTURE_MASK_ALL_FRAMES = 0x7 , } cocci_id@p ;
...
position p;
@@
 enum cx23885_capture_type { CX23885_MPEG_CAPTURE , CX23885_RAW_CAPTURE , CX23885_RAW_PASSTHRU_CAPTURE , } cocci_id@p ;
...
position p;
@@
 struct cx23885_buffer * cocci_id@p ;
...
position p;
@@
 enum cx23885_vbi_insertion_bits { CX23885_VBI_BITS_INSERT_IN_XTENSION_USR_DATA , CX23885_VBI_BITS_INSERT_IN_PRIVATE_PACKETS = 0x1 << 1 , CX23885_VBI_BITS_SEPARATE_STREAM = 0x2 << 1 , CX23885_VBI_BITS_SEPARATE_STREAM_USR_DATA = 0x4 << 1 , CX23885_VBI_BITS_SEPARATE_STREAM_PRV_DATA = 0x5 << 1 , } cocci_id@p ;
