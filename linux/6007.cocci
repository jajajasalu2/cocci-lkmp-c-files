...
@@
 struct bcm2835_pinctrl {  struct device * dev ;  void __iomem * base ;  unsigned long enabled_irq_map [ BCM2835_NUM_BANKS ] ;  unsigned int irq_type [ BCM2835_NUM_GPIOS ] ;  struct pinctrl_dev * pctl_dev ;  struct gpio_chip gpio_chip ;  struct pinctrl_gpio_range gpio_range ;  raw_spinlock_t irq_lock [ BCM2835_NUM_BANKS ] ; } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ BCM2835_FSEL_COUNT ] ;
...
position p;
@@
 struct bcm2835_pinctrl * cocci_id@p ;
...
position p;
@@
 enum bcm2835_fsel { BCM2835_FSEL_COUNT = 8 , BCM2835_FSEL_MASK = 0x7 , } cocci_id@p ;
