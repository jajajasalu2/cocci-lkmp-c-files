...
position p;
@@
 struct wmi_tlv_tx_bundle_compl_parse * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_diag_item * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_policy {  size_t min_len ; } cocci_id@p ;
...
position p;
@@
 struct wmi_tdls_set_state_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_pno_scan_req * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_diag_data_ev * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_pdev_set_wmm_cmd * cocci_id@p ;
...
typedef u16;
@@
 int ( * cocci_id@p ) ( struct ath10k * ar , u16 tag , u16 len , const void * ptr , void * data ) ;
...
position p;
@@
 struct wmi_tlv_pdev_set_rd_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_wow_event_info cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_p2p_noa_ev cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_mgmt_rx_ev * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_pktlog_disable * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_peer_create_cmd * cocci_id@p ;
...
typedef bool;
@@
 struct wmi_tlv_swba_parse {  const struct wmi_host_swba_event * ev ;  bool tim_done ;  bool noa_done ;  size_t n_tim ;  size_t n_noa ;  struct wmi_swba_ev_arg * arg ; } cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_mgmt_rx_ev cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_p2p_noa_ev * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_stats_ev * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_phyerr_ev * cocci_id@p ;
...
position p;
@@
 struct wmi_tim_info cocci_id@p ;
...
position p;
@@
 struct wmi_tdls_peer_update_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_tim_info * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_start_scan_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_mgmt_tx_compl_ev * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_bcn_tx_status_ev cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_chan_info_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_policy cocci_id@p [ ] ;
...
position p;
@@
 struct wmi_tlv_bcn_prb_info * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_pdev_temperature_event * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_pdev_get_temp_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_wow_del_pattern_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tdls_peer_capab * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_init_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_echo_event * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_svc_rdy_parse cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_peer_stats_extd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_mgmt_tx_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_sta_keepalive_arp_resp * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_bcn_tx_status_ev * cocci_id@p ;
...
position p;
@@
 enum wmi_tlv_event_id cocci_id@p ;
...
position p;
@@
 struct host_memory_chunk_tlv cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_resource_config * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_wow_add_pattern_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_rfkill_state_change_ev * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_pdev_suspend * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_diag_data_ev cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_p2p_go_bcn_ie * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_vdev_start_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_sta_uapsd_auto_trig_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_peer_delete_resp_ev_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_pktlog_enable * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_set_quiet_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_rdy_ev cocci_id@p ;
...
position p;
@@
 struct wmi_sta_uapsd_auto_trig_param * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_sta_keepalive_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_rdy_ev * cocci_id@p ;
...
position p;
@@
 struct wmi_vht_rate_set * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_wow_event_info * cocci_id@p ;
...
typedef __le32,bool;
@@
 struct wmi_tlv_tx_bundle_compl_parse {  const __le32 * num_reports ;  const __le32 * desc_ids ;  const __le32 * status ;  const __le32 * ppdu_ids ;  const __le32 * ack_rssi ;  bool desc_ids_done ;  bool status_done ;  bool ppdu_ids_done ;  bool ack_rssi_done ; } cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_vdev_set_wmm_cmd * cocci_id@p ;
...
position p;
@@
 struct nlo_configured_parameters * cocci_id@p ;
...
position p;
@@
 struct wmi_scan_prob_req_oui_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_roam_ev cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_wow_host_wakeup_ind * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_prb_tmpl_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_scan_event * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_peer_assoc_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_wow_bitmap_pattern * cocci_id@p ;
...
typedef __le32,bool;
@@
 struct wmi_tlv_svc_rdy_parse {  const struct hal_reg_capabilities * reg ;  const struct wmi_tlv_svc_rdy_ev * ev ;  const __le32 * svc_bmap ;  const struct wlan_host_mem_req * mem_reqs ;  bool svc_bmap_done ;  bool dbs_hw_mode_done ; } cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_wow_add_del_event_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_wow_enable_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_dbglog_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_vdev_start_response_event * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_roam_ev * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_swba_parse * cocci_id@p ;
...
position p;
@@
 const struct hal_reg_capabilities * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_tdls_peer_event * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_tx_pause_ev cocci_id@p ;
...
position p;
@@
 enum wmi_wow_wakeup_event cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_scan_chan_list_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_svc_rdy_ev cocci_id@p ;
...
position p;
@@
 struct wmi_p2p_noa_info cocci_id@p ;
...
position p;
@@
 struct wmi_sta_uapsd_auto_trig_cmd_fixed_param * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_tx_pause_ev * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_wow_nlo_config_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_adaptive_qcs * cocci_id@p ;
...
position p;
@@
 struct wmi_tim_info_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_pdev_temperature_event * cocci_id@p ;
...
position p;
@@
 struct wlan_host_mem_req cocci_id@p ;
...
position p;
@@
 const struct wmi_peer_sta_kickout_event * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_resume_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_svc_rdy_ev * cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_bcn_tmpl_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_sta_keepalive_arg * cocci_id@p ;
...
position p;
@@
 struct hal_reg_capabilities cocci_id@p ;
...
position p;
@@
 struct wmi_tlv_pdev_set_param_cmd * cocci_id@p ;
...
position p;
@@
 const struct wmi_tlv_vdev_stats * cocci_id@p ;
