...
position p;
@@
 struct acx_tx_queue_qos_config * cocci_id@p ;
...
position p;
@@
 struct wl12xx_probe_req_template cocci_id@p ;
...
position p;
@@
 struct wl12xx_probe_resp_template cocci_id@p ;
...
position p;
@@
 struct wl1251_acx_mem_map * cocci_id@p ;
...
position p;
@@
 struct wl12xx_beacon_template cocci_id@p ;
...
position p;
@@
 struct wl12xx_ps_poll_template cocci_id@p ;
...
position p;
@@
 struct wl12xx_qos_null_data_template cocci_id@p ;
