...
position p;
@@
 enum ceph_recover_session_mode { ceph_recover_session_no , ceph_recover_session_clean , } cocci_id@p ;
...
position p;
@@
 struct ceph_parse_opts_ctx * cocci_id@p ;
...
position p;
@@
 enum { Opt_wsize , Opt_rsize , Opt_rasize , Opt_caps_wanted_delay_min , Opt_caps_wanted_delay_max , Opt_caps_max , Opt_readdir_max_entries , Opt_readdir_max_bytes , Opt_congestion_kb , Opt_snapdirname , Opt_mds_namespace , Opt_recover_session , Opt_source , Opt_dirstat , Opt_rbytes , Opt_asyncreaddir , Opt_dcache , Opt_ino32 , Opt_fscache , Opt_poolperm , Opt_require_active_mds , Opt_acl , Opt_quotadf , Opt_copyfrom , } cocci_id@p ;
...
position p;
@@
 struct ceph_parse_opts_ctx {  struct ceph_options * copts ;  struct ceph_mount_options * opts ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct super_block * , struct fs_context * ) ;
...
position p;
@@
 struct ceph_mon_client * cocci_id@p ;
