...
position p;
@@
 union {  struct nv50_mem_map_v0 nv50 ;  struct gf100_mem_map_v0 gf100 ; } cocci_id@p ;
...
position p;
@@
 struct nouveau_drm_tile * cocci_id@p ;
...
position p;
@@
 struct nouveau_fence * cocci_id@p ;
...
position p;
@@
 struct nvkm_fb_tile * cocci_id@p ;
...
position p;
@@
 struct nouveau_channel * cocci_id@p ;
...
typedef u32,s32;
@@
 const struct {  const char * name ;  int engine ;  s32 oclass ;  int ( * exec ) ( struct nouveau_channel * , struct ttm_buffer_object * , struct ttm_mem_reg * , struct ttm_mem_reg * ) ;  int ( * init ) ( struct nouveau_channel * , u32 handle ) ; } cocci_id@p [ ] ;
