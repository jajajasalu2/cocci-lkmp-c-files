...
position p;
@@
 struct em_i2c_device * cocci_id@p ;
...
position p;
@@
 struct em_i2c_device {  void __iomem * base ;  struct i2c_adapter adap ;  struct completion msg_done ;  struct clk * sclk ;  struct i2c_client * slave ;  int irq ; } cocci_id@p ;
