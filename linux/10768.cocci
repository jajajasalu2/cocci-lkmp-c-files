...
position p;
@@
 struct i915_global_block {  struct i915_global base ;  struct kmem_cache * slab_blocks ; } cocci_id@p ;
...
position p;
@@
 struct i915_global_block cocci_id@p ;
...
position p;
@@
 struct i915_buddy_mm * cocci_id@p ;
