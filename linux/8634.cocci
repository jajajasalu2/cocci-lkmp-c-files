...
position p;
@@
 struct ixgb_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int type ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
...
position p;
@@
 enum { NETDEV_STATS , IXGB_STATS , } cocci_id@p ;
