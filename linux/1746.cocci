...
position p;
@@
 struct srf04_cfg {  unsigned long trigger_pulse_us ; } cocci_id@p ;
...
typedef ktime_t;
@@
 struct srf04_data {  struct device * dev ;  struct gpio_desc * gpiod_trig ;  struct gpio_desc * gpiod_echo ;  struct mutex lock ;  int irqnr ;  ktime_t ts_rising ;  ktime_t ts_falling ;  struct completion rising ;  struct completion falling ;  const struct srf04_cfg * cfg ; } cocci_id@p ;
...
position p;
@@
 const struct srf04_cfg cocci_id@p ;
