...
position p;
@@
 struct sifive_serial_port {  struct uart_port port ;  struct device * dev ;  unsigned char ier ;  unsigned long clkin_rate ;  unsigned long baud_rate ;  struct clk * clk ;  struct notifier_block clk_notifier ; } cocci_id@p ;
...
position p;
@@
 struct sifive_serial_port * cocci_id@p [ SIFIVE_SERIAL_MAX_PORTS ] ;
...
position p;
@@
 struct sifive_serial_port * cocci_id@p ;
