...
position p;
@@
 const struct iio_buffer_access_funcs cocci_id@p ;
...
position p;
@@
 struct hw_consumer_buffer * cocci_id@p ;
...
position p;
@@
 struct iio_hw_consumer * * cocci_id@p ;
...
position p;
@@
 struct iio_hw_consumer {  struct list_head buffers ;  struct iio_channel * channels ; } cocci_id@p ;
...
position p;
@@
 struct hw_consumer_buffer {  struct list_head head ;  struct iio_dev * indio_dev ;  struct iio_buffer buffer ;  long scan_mask [ ] ; } cocci_id@p ;
