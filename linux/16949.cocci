...
typedef u32;
@@
 u32 cocci_id@p [ TSC_MAX_SAMPLES ] ;
...
position p;
@@
 enum mx25_adc_configurations { MX25_CFG_PRECHARGE = 0 , MX25_CFG_TOUCH_DETECT , MX25_CFG_X_MEASUREMENT , MX25_CFG_Y_MEASUREMENT , } cocci_id@p ;
...
position p;
@@
 struct mx25_tcq_priv {  struct regmap * regs ;  struct regmap * core_regs ;  struct input_dev * idev ;  enum mx25_tcq_mode mode ;  unsigned int pen_threshold ;  unsigned int sample_count ;  unsigned int expected_samples ;  unsigned int pen_debounce ;  unsigned int settling_time ;  struct clk * clk ;  int irq ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct mx25_tcq_priv * cocci_id@p ;
...
position p;
@@
 enum mx25_tcq_mode { MX25_TS_4WIRE , } cocci_id@p ;
