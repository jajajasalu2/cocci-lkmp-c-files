...
symbol cocci_id;
position p;
typedef bool,hpsa_scsi_dev_t;
@@
 bool cocci_id@p ( struct ctlr_info * h , struct CommandList * c , struct hpsa_scsi_dev_t * dev , unsigned char * scsi3addr ) ;
...
position p;
@@
 struct io_accel1_cmd * cocci_id@p ;
...
typedef u8,u32;
@@
 u32 cocci_id@p ( struct ctlr_info * h , u8 q ) ;
...
position p;
@@
 void cocci_id@p ( struct ctlr_info * h ) ;
...
position p;
@@
 struct io_accel2_cmd * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ctlr_info * h , struct ReportExtendedLUNdata * buf , int bufsize ) ;
...
position p;
@@
 struct raid_map_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ctlr_info * h , struct CommandList * c ) ;
...
position p;
@@
 struct offline_device_entry cocci_id@p ;
...
position p;
@@
 struct bmic_sense_storage_box_params * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( int * bucket , int num_buckets , int nsgs , int min_blocks , u32 * bucket_map ) ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pdev , unsigned long * memory_bar ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_device * sdev ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct ctlr_info * h ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_device * dev , unsigned int cmd , void __user * arg ) ;
...
symbol cocci_id;
position p;
typedef hpsa_scsi_dev_t;
@@
 void cocci_id@p ( struct hpsa_scsi_dev_t * device ) ;
...
typedef bool,u32;
@@
 int cocci_id@p ( struct pci_dev * pdev , u32 * board_id , bool * legacy_board ) ;
...
position p;
@@
 struct Command {  struct CommandListHeader CommandHeader ;  struct RequestBlock Request ;  struct ErrDescriptor ErrorDescriptor ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ctlr_info * h , struct CommandList * c ) ;
...
position p;
@@
 int cocci_id@p ( struct ctlr_info * h , unsigned char lunaddr [ ] , int reply_queue ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * scsicmd ) ;
...
position p;
@@
 int cocci_id@p ( struct ctlr_info * h ) ;
...
position p;
@@
 struct ext_report_lun_entry * cocci_id@p ;
...
position p;
@@
 struct sas_identify * cocci_id@p ;
...
position p;
@@
 struct CommandList * cocci_id@p ( struct ctlr_info * h ) ;
...
position p;
@@
 struct SGDescriptor * cocci_id@p ;
...
position p;
@@
 struct ReportLUNdata * cocci_id@p ;
...
position p;
@@
 BIG_IOCTL_Command_struct * cocci_id@p ;
...
position p;
@@
 struct ioaccel2_sg_element * cocci_id@p ;
...
position p;
@@
 struct reply_queue_buffer * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pdev , void __iomem * vaddr , int wait_for_ready ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t ( * cocci_id@p ) ( int , void * ) ;
...
position p;
@@
 struct sas_function_template cocci_id@p ;
...
typedef hpsa_scsi_dev_t;
@@
 struct hpsa_scsi_dev_t * cocci_id@p ;
...
position p;
@@
 const struct ErrorInfo * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct Scsi_Host * ) ;
...
position p;
@@
 void cocci_id@p ( struct CommandList * c ) ;
...
position p;
@@
 struct access_method cocci_id@p ;
...
typedef hpsa_scsi_dev_t;
@@
 struct hpsa_scsi_dev_t * cocci_id@p ( struct ctlr_info * h , struct sas_rphy * rphy ) ;
...
typedef u8,bool;
@@
 bool cocci_id@p ( struct ctlr_info * h , unsigned char scsi3addr [ ] , u8 page ) ;
...
position p;
@@
 const struct scsi_cmnd cocci_id@p ;
...
position p;
@@
 struct CommandList * cocci_id@p ( struct ctlr_info * h , struct scsi_cmnd * scmd ) ;
...
typedef hpsa_scsi_dev_t;
@@
 int cocci_id@p ( struct hpsa_sas_node * hpsa_sas_node , struct hpsa_scsi_dev_t * device ) ;
...
position p;
@@
 struct raid_map_disk_data * cocci_id@p ;
...
position p;
@@
 struct hpsa_sas_phy * cocci_id@p ;
...
position p;
@@
 struct hpsa_sas_port * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct scsi_device * sdev , int qdepth ) ;
...
position p;
@@
 struct hpsa_sas_node * cocci_id@p ;
...
position p;
@@
 struct hpsa_pci_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,hpsa_scsi_dev_t;
@@
 int cocci_id@p ( struct ctlr_info * h , struct CommandList * c , u32 ioaccel_handle , u8 * cdb , int cdb_len , u8 * scsi3addr , struct hpsa_scsi_dev_t * phys_disk ) ;
...
typedef u64,u32;
@@
 int cocci_id@p ( struct pci_dev * pdev , void __iomem * vaddr , u32 * cfg_base_addr , u64 * cfg_base_addr_index , u64 * cfg_offset ) ;
...
position p;
@@
 struct ReportExtendedLUNdata * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * sh , unsigned long elapsed_time ) ;
...
position p;
@@
 struct hpsa_tmf_struct * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_device * sdev ) ;
