...
position p;
@@
 struct nft_fwd_netdev * cocci_id@p ;
...
position p;
@@
 struct nft_fwd_neigh * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_FWD_MAX + 1 ] ;
...
position p;
@@
 const struct nft_fwd_netdev * cocci_id@p ;
...
typedef u8;
@@
 struct nft_fwd_neigh {  enum nft_registers sreg_dev : 8 ;  enum nft_registers sreg_addr : 8 ;  u8 nfproto ; } cocci_id@p ;
...
position p;
@@
 struct nft_fwd_netdev {  enum nft_registers sreg_dev : 8 ; } cocci_id@p ;
