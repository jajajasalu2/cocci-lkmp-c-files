...
position p;
@@
 unsigned long cocci_id@p [ PG_LEVEL_NUM ] ;
...
position p;
@@
 enum cpa_warn { CPA_CONFLICT , CPA_PROTECT , CPA_DETECT , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cpa_data * cpa , int checkalias ) ;
