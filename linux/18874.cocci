...
position p;
@@
 struct omap_irq_bank cocci_id@p [ ] ;
...
position p;
@@
 struct omap_irq_bank {  unsigned long base_reg ;  void __iomem * va ;  unsigned long trigger_map ;  unsigned long wake_enable ; } cocci_id@p ;
