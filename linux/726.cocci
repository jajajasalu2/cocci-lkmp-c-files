...
position p;
@@
 union apci_descriptor * cocci_id@p ;
...
position p;
@@
 struct notification cocci_id@p ;
...
@@
 void cocci_id@p ( acpi_handle handle , u32 event , void * context ) ;
...
typedef u8,u16;
@@
 union apci_descriptor {  struct {  char sig [ 4 ] ;  u8 len ; } header ;  struct {  u8 type ;  u8 len ;  u16 slot_id ;  u8 bus_id ;  u8 dev_num ;  u8 slot_num ;  u8 slot_attr [ 2 ] ;  u8 attn ;  u8 status [ 2 ] ;  u8 sun ;  u8 res [ 3 ] ; } slot ;  struct {  u8 type ;  u8 len ; } generic ; } cocci_id@p ;
...
position p;
@@
 struct acpiphp_attention_info cocci_id@p ;
...
typedef u8;
@@
 struct notification {  struct acpi_device * device ;  u8 event ; } cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct hotplug_slot * slot , u8 * status ) ;
