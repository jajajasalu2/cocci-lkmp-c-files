...
position p;
@@
 struct extent_crypt_result * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_crypt_stat * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_key_tfm * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_flag_map_elem cocci_id@p [ ] ;
...
typedef u8;
@@
 struct ecryptfs_cipher_code_str_map_elem {  char cipher_str [ 16 ] ;  u8 cipher_code ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ECRYPTFS_SIZE_AND_MARKER_BYTES ] ;
...
position p;
@@
 char cocci_id@p [ ECRYPTFS_MAX_IV_BYTES + 16 ] ;
...
position p;
@@
 struct ecryptfs_filename * cocci_id@p ;
...
position p;
@@
 struct extent_crypt_result {  struct completion completion ;  int rc ; } cocci_id@p ;
...
position p;
@@
 struct ecryptfs_mount_crypt_stat cocci_id@p ;
...
position p;
@@
 struct ecryptfs_global_auth_tok * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_key_sig * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_cipher_code_str_map_elem cocci_id@p [ ] ;
...
typedef u32;
@@
 struct ecryptfs_flag_map_elem {  u32 file_flag ;  u32 local_flag ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MD5_DIGEST_SIZE ] ;
...
position p;
@@
 char cocci_id@p [ ECRYPTFS_MAX_KEY_BYTES ] ;
...
position p;
@@
 char cocci_id@p [ ECRYPTFS_MAX_IV_BYTES ] ;
