...
position p;
@@
 const struct bw_tbl * cocci_id@p ;
...
position p;
@@
 const struct freq_tbl * cocci_id@p ;
...
@@
 struct intbuf {  struct list_head list ;  u32 type ;  size_t size ;  void * va ;  dma_addr_t da ;  unsigned long attrs ; } cocci_id@p ;
...
position p;
@@
 const struct venus_buffer * cocci_id@p ;
...
position p;
@@
 const struct codec_freq_data * cocci_id@p ;
...
position p;
@@
 struct venus_buffer * cocci_id@p ;
