...
position p;
@@
 struct background_tracker * cocci_id@p ;
...
typedef atomic_t;
@@
 struct background_tracker {  unsigned max_work ;  atomic_t pending_promotes ;  atomic_t pending_writebacks ;  atomic_t pending_demotes ;  struct list_head issued ;  struct list_head queued ;  struct rb_root pending ;  struct kmem_cache * work_cache ; } cocci_id@p ;
...
position p;
@@
 struct bt_work {  struct list_head list ;  struct rb_node node ;  struct policy_work work ; } cocci_id@p ;
