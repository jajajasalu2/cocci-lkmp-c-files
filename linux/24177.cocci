...
position p;
@@
 struct ipv6_ac_socklist * cocci_id@p ;
...
position p;
@@
 struct ac6_iter_state {  struct seq_net_private p ;  struct net_device * dev ;  struct inet6_dev * idev ; } cocci_id@p ;
...
position p;
@@
 struct ac6_iter_state cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , const struct in6_addr * addr ) ;
