...
position p;
@@
 struct sdi_clk_calc_ctx cocci_id@p ;
...
typedef bool;
@@
 struct {  struct platform_device * pdev ;  bool update_enabled ;  struct regulator * vdds_sdi_reg ;  struct dss_lcd_mgr_config mgr_config ;  struct omap_video_timings timings ;  int datapairs ;  struct omap_dss_device output ;  bool port_initialized ; } cocci_id@p ;
...
position p;
@@
 const struct omapdss_sdi_ops cocci_id@p ;
