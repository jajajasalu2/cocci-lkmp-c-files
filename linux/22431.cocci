...
position p;
@@
 struct snd_wm8776 {  unsigned char addr ;  unsigned short regs [ WM8776_NUM_REGS ] ;  unsigned char volumes [ WM_NUM_VOLS ] [ 2 ] ;  unsigned int switch_bits ; } cocci_id@p ;
...
position p;
@@
 struct snd_maya44 {  struct snd_ice1712 * ice ;  struct snd_wm8776 wm [ 2 ] ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 struct maya_vol_info {  unsigned int maxval ;  unsigned char regs [ 2 ] ;  unsigned short mask ;  unsigned short offset ;  unsigned short mute ;  unsigned short update ;  unsigned char mux_bits [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum { WM_SW_DAC , WM_SW_BYPASS , WM_NUM_SWITCHES , } cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 10 ] ;
...
position p;
@@
 enum { WM_VOL_HP , WM_VOL_DAC , WM_VOL_ADC , WM_NUM_VOLS , } cocci_id@p ;
...
position p;
@@
 struct maya_vol_info cocci_id@p [ WM_NUM_VOLS ] ;
...
position p;
@@
 struct maya_vol_info * cocci_id@p ;
