...
position p;
@@
 struct clk_peripheral * cocci_id@p ;
...
position p;
@@
 struct clk_sam9x5_peripheral cocci_id@p ;
...
position p;
@@
 const struct clk_pcr_layout * cocci_id@p ;
...
@@
 struct clk_sam9x5_peripheral {  struct clk_hw hw ;  struct regmap * regmap ;  struct clk_range range ;  spinlock_t * lock ;  u32 id ;  u32 div ;  const struct clk_pcr_layout * layout ;  bool auto_div ; } cocci_id@p ;
...
typedef u32;
@@
 struct clk_peripheral {  struct clk_hw hw ;  struct regmap * regmap ;  u32 id ; } cocci_id@p ;
