...
typedef u32;
@@
 struct cryptomgr_param {  struct rtattr * tb [ CRYPTO_MAX_ATTRS + 2 ] ;  struct {  struct rtattr attr ;  struct crypto_attr_type data ; } type ;  union {  struct rtattr attr ;  struct {  struct rtattr attr ;  struct crypto_attr_alg data ; } alg ;  struct {  struct rtattr attr ;  struct crypto_attr_u32 data ; } nu32 ; } attrs [ CRYPTO_MAX_ATTRS ] ;  char template [ CRYPTO_MAX_ALG_NAME ] ;  struct crypto_larval * larval ;  u32 otype ;  u32 omask ; } cocci_id@p ;
...
typedef u32;
@@
 struct crypto_test_param {  char driver [ CRYPTO_MAX_ALG_NAME ] ;  char alg [ CRYPTO_MAX_ALG_NAME ] ;  u32 type ; } cocci_id@p ;
...
position p;
@@
 struct crypto_test_param * cocci_id@p ;
...
position p;
@@
 struct cryptomgr_param * cocci_id@p ;
...
position p;
@@
 struct crypto_larval * cocci_id@p ;
