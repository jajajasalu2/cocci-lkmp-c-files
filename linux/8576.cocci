...
position p;
@@
 struct tg3_rx_prodring_set * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef tg3_stat64_t;
@@
 tg3_stat64_t * cocci_id@p ;
...
position p;
@@
 struct tg3_ocir cocci_id@p [ TG3_SD_NUM_RECS ] ;
...
position p;
@@
 struct msix_entry cocci_id@p [ TG3_IRQ_MAX_VECS ] ;
...
typedef bool;
@@
 int cocci_id@p ( struct tg3 * , bool ) ;
...
position p;
@@
 const struct tg3_firmware_hdr * cocci_id@p ;
...
typedef u32;
@@
 struct mem_entry {  u32 offset ;  u32 len ; } cocci_id@p [ ] ;
...
position p;
@@
 struct tg3_tx_ring_info * cocci_id@p ;
...
position p;
@@
 struct subsys_tbl_ent cocci_id@p [ ] ;
...
position p;
@@
 struct tg3_ext_rx_buffer_desc cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct tg3 * , u32 , u32 ) ;
...
position p;
@@
 struct tg3_ethtool_stats * cocci_id@p ;
...
position p;
@@
 const struct {  const char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct tg3 * , struct rtnl_link_stats64 * ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ NVRAM_SELFBOOT_DATA_SIZE ] ;
...
position p;
@@
 struct tg3_fiber_aneginfo cocci_id@p ;
...
position p;
@@
 struct tg3_internal_buffer_desc cocci_id@p ;
...
position p;
@@
 struct tg3_hw_stats cocci_id@p ;
...
position p;
@@
 struct tg3_tx_buffer_desc * cocci_id@p ;
...
typedef u32;
@@
 struct tg3_dev_id {  u32 vendor ;  u32 device ;  u32 rev ; } cocci_id@p [ ] ;
...
position p;
@@
 struct tg3_rx_buffer_desc cocci_id@p ;
...
typedef u32;
@@
 struct tg3_dev_id {  u32 vendor ;  u32 device ; } cocci_id@p [ ] ;
...
position p;
@@
 struct tg3_firmware_hdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tg3 * , struct tg3_ethtool_stats * ) ;
...
position p;
@@
 struct tg3_hw_status * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tg3 * tp , int irq_sync ) ;
