...
position p;
@@
 unsigned int cocci_id@p ( struct cppc_cpudata * cpu , unsigned int perf ) ;
...
typedef u32;
@@
 struct cppc_workaround_oem_info {  char oem_id [ ACPI_OEM_ID_SIZE + 1 ] ;  char oem_table_id [ ACPI_OEM_TABLE_ID_SIZE + 1 ] ;  u32 oem_revision ; } cocci_id@p ;
...
position p;
@@
 struct cppc_workaround_oem_info cocci_id@p [ ] ;
