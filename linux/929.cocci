...
position p;
@@
 struct s3c2410_nand_info cocci_id@p ;
...
position p;
@@
 enum s3c_cpu_type { TYPE_S3C2410 , TYPE_S3C2412 , TYPE_S3C2440 , } cocci_id@p ;
...
position p;
@@
 enum s3c_nand_clk_state cocci_id@p ;
...
position p;
@@
 struct s3c2410_nand_mtd * cocci_id@p ;
...
position p;
@@
 struct s3c24XX_nand_devtype_data {  enum s3c_cpu_type type ; } cocci_id@p ;
...
position p;
@@
 const struct s3c24XX_nand_devtype_data * cocci_id@p ;
...
position p;
@@
 enum s3c_nand_clk_state { CLOCK_DISABLE = 0 , CLOCK_ENABLE , CLOCK_SUSPEND , } cocci_id@p ;
...
position p;
@@
 struct s3c2410_nand_mtd {  struct nand_chip chip ;  struct s3c2410_nand_set * set ;  struct s3c2410_nand_info * info ; } cocci_id@p ;
