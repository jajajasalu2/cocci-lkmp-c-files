...
symbol cocci_id;
position p;
typedef u8,bool,s64,u16;
@@
 struct mma9553_data {  struct i2c_client * client ;  struct mutex mutex ;  struct mma9553_conf_regs conf ;  struct mma9553_event events [ MMA9553_EVENTS_INFO_SIZE ] ;  int num_events ;  u8 gpio_bitnum ;  bool stepcnt_enabled ;  u16 stepcnt ;  u8 activity ;  s64 timestamp ; } cocci_id@p ;
...
position p;
@@
 struct mma9553_event * cocci_id@p ;
...
position p;
@@
 enum activity_level cocci_id@p ;
...
typedef bool;
@@
 struct mma9553_event {  struct mma9553_event_info * info ;  bool enabled ; } cocci_id@p ;
...
position p;
@@
 struct mma9553_event_info {  enum iio_chan_type type ;  enum iio_modifier mod ;  enum iio_event_direction dir ; } cocci_id@p [ ] ;
...
position p;
@@
 enum activity_level { ACTIVITY_UNKNOWN , ACTIVITY_REST , ACTIVITY_WALKING , ACTIVITY_JOGGING , ACTIVITY_RUNNING , } cocci_id@p ;
...
position p;
@@
 struct mma9553_data * cocci_id@p ;
