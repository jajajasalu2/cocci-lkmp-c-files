...
position p;
@@
 struct sec_dev_info * cocci_id@p [ SEC_MAX_DEVICES ] ;
...
position p;
@@
 struct sec_out_bd_info * cocci_id@p ;
...
position p;
@@
 struct sec_queue_ring_cmd * cocci_id@p ;
...
position p;
@@
 struct sec_queue_ring_db * cocci_id@p ;
...
position p;
@@
 struct sec_queue_ring_cq * cocci_id@p ;
...
position p;
@@
 struct sec_debug_bd_info cocci_id@p ;
