...
typedef __u8;
@@
 int cocci_id@p ( struct usb_serial_port * port , __u8 command , __u8 * data , __u8 datasize ) ;
...
position p;
@@
 struct whiteheat_purge cocci_id@p ;
...
typedef __u8;
@@
 struct whiteheat_private {  __u8 mcr ; } cocci_id@p ;
...
position p;
@@
 struct whiteheat_set_rdb cocci_id@p ;
...
typedef __u8;
@@
 int cocci_id@p ( struct usb_serial_port * port , __u8 rxtx ) ;
...
position p;
@@
 struct whiteheat_dr_info cocci_id@p ;
...
position p;
@@
 struct whiteheat_hw_info * cocci_id@p ;
...
position p;
@@
 struct whiteheat_private * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u8,wait_queue_head_t;
@@
 struct whiteheat_command_private {  struct mutex mutex ;  __u8 port_running ;  __u8 command_finished ;  wait_queue_head_t wait_command ;  __u8 result_buffer [ 64 ] ; } cocci_id@p ;
...
typedef __u8;
@@
 int cocci_id@p ( struct usb_serial_port * port , __u8 onoff ) ;
...
position p;
@@
 struct whiteheat_command_private cocci_id@p ;
...
position p;
@@
 struct whiteheat_port_settings cocci_id@p ;
...
position p;
@@
 struct whiteheat_simple cocci_id@p ;
