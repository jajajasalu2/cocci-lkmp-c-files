...
typedef bool,u32;
@@
 struct {  struct platform_device * pdev ;  void __iomem * base ;  struct mutex venc_lock ;  u32 wss_data ;  struct regulator * vdda_dac_reg ;  struct clk * tv_dac_clk ;  struct omap_video_timings timings ;  enum omap_dss_venc_type type ;  bool invert_polarity ;  struct omap_dss_device output ; } cocci_id@p ;
...
position p;
@@
 const struct omapdss_atv_ops cocci_id@p ;
