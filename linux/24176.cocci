...
position p;
@@
 const struct icmp6_err {  int err ;  int fatal ; } cocci_id@p [ ] ;
...
typedef uint8_t;
@@
 struct icmpv6_msg {  struct sk_buff * skb ;  int offset ;  uint8_t type ; } cocci_id@p ;
