...
position p;
@@
 struct lima_fence {  struct dma_fence base ;  struct lima_sched_pipe * pipe ; } cocci_id@p ;
...
position p;
@@
 struct lima_sched_context * cocci_id@p ;
