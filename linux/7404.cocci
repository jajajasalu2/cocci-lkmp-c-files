...
typedef u8;
@@
 struct panel_drv_data {  struct omap_dss_device dssdev ;  struct omap_dss_device * in ;  int reset_gpio ;  int datapairs ;  struct omap_video_timings videomode ;  char * name ;  int enabled ;  int model ;  int revision ;  u8 display_id [ 3 ] ;  unsigned has_bc : 1 ;  unsigned has_cabc : 1 ;  unsigned cabc_mode ;  unsigned long hw_guard_end ;  unsigned long hw_guard_wait ;  struct spi_device * spi ;  struct mutex mutex ;  struct backlight_device * bl_dev ; } cocci_id@p ;
...
position p;
@@
 const struct panel_acx565akm_platform_data * cocci_id@p ;
