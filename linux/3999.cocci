...
typedef u32;
@@
 struct bcm6345_l1_cpu {  void __iomem * map_base ;  unsigned int parent_irq ;  u32 enable_cache [ ] ; } cocci_id@p ;
...
position p;
@@
 struct bcm6345_l1_cpu cocci_id@p ;
...
@@
 struct bcm6345_l1_chip {  raw_spinlock_t lock ;  unsigned int n_words ;  struct irq_domain * domain ;  struct cpumask cpumask ;  struct bcm6345_l1_cpu * cpus [ NR_CPUS ] ; } cocci_id@p ;
...
position p;
@@
 struct bcm6345_l1_chip * cocci_id@p ;
