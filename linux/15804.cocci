...
position p;
@@
 const struct bm2835_mmal_v4l2_ctrl cocci_id@p [ V4L2_CTRL_COUNT ] ;
...
position p;
@@
 struct mmal_parameter_awbgains cocci_id@p ;
...
position p;
@@
 enum bm2835_mmal_ctrl_type { MMAL_CONTROL_TYPE_STD , MMAL_CONTROL_TYPE_STD_MENU , MMAL_CONTROL_TYPE_INT_MENU , MMAL_CONTROL_TYPE_CLUSTER , } cocci_id@p ;
...
position p;
@@
 enum mmal_parameter_exposuremode cocci_id@p ;
...
position p;
@@
 enum mmal_parameter_exposuremeteringmode cocci_id@p ;
...
position p;
@@
 struct bm2835_mmal_dev * cocci_id@p ;
...
position p;
@@
 struct mmal_parameter_imagefx_parameters cocci_id@p ;
...
position p;
@@
 struct mmal_parameter_fps_range cocci_id@p ;
...
position p;
@@
 const struct bm2835_mmal_v4l2_ctrl * cocci_id@p ;
...
position p;
@@
 struct v4l2_mmal_scene_config {  enum v4l2_scene_mode v4l2_scene ;  enum mmal_parameter_exposuremode exposure_mode ;  enum mmal_parameter_exposuremeteringmode metering_mode ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_mmal_scene_config * cocci_id@p ;
...
typedef s32,u32;
@@
 struct v4l2_to_mmal_effects_setting {  u32 v4l2_effect ;  u32 mmal_effect ;  s32 col_fx_enable ;  s32 col_fx_fixed_cbcr ;  u32 u ;  u32 v ;  u32 num_effect_params ;  u32 effect_params [ MMAL_MAX_IMAGEFX_PARAMETERS ] ; } cocci_id@p ;
...
@@
 struct bm2835_mmal_v4l2_ctrl {  u32 id ;  enum bm2835_mmal_ctrl_type type ;  s64 min ;  s64 max ;  s64 def ;  u64 step ;  const s64 * imenu ;  u32 mmal_id ;  bm2835_mmal_v4l2_ctrl_cb * setter ;  bool ignore_errors ; } cocci_id@p ;
...
position p;
@@
 struct mmal_parameter_video_profile cocci_id@p ;
...
position p;
@@
 const struct v4l2_to_mmal_effects_setting cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct bm2835_mmal_dev * dev , struct v4l2_ctrl * ctrl , const struct bm2835_mmal_v4l2_ctrl * mmal_ctrl ) ;
...
position p;
@@
 struct mmal_parameter_rational cocci_id@p ;
...
position p;
@@
 struct vchiq_mmal_component * cocci_id@p ;
...
position p;
@@
 struct bm2835_mmal_v4l2_ctrl cocci_id@p ;
...
position p;
@@
 struct vchiq_mmal_port * cocci_id@p ;
