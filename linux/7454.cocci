...
position p;
@@
 struct mmp_overlay_ops cocci_id@p ;
...
position p;
@@
 struct mmphw_path_plat * cocci_id@p ;
...
position p;
@@
 struct mmp_path_info * cocci_id@p ;
...
position p;
@@
 struct mmp_mach_plat_info * cocci_id@p ;
...
position p;
@@
 struct mmp_mach_path_config * cocci_id@p ;
