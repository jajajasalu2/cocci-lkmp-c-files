...
position p;
@@
 struct hdmi_i2c_adapter * cocci_id@p ;
...
@@
 struct hdmi_i2c_adapter {  struct i2c_adapter base ;  struct hdmi * hdmi ;  bool sw_done ;  wait_queue_head_t ddc_event ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MAX_TRANSACTIONS ] ;
