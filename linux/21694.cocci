...
position p;
@@
 enum { CTYPE_SEPARATE , CTYPE_DATA , CTYPE_INSTRUCTION , CTYPE_UNIFIED , } cocci_id@p ;
...
position p;
@@
 struct cache_info {  unsigned char : 4 ;  unsigned char scope : 2 ;  unsigned char type : 2 ; } cocci_id@p ;
...
position p;
@@
 union cache_topology cocci_id@p ;
...
position p;
@@
 enum { CACHE_TI_UNIFIED = 0 , CACHE_TI_DATA = 0 , CACHE_TI_INSTRUCTION , } cocci_id@p ;
...
position p;
@@
 enum { CACHE_SCOPE_NOTEXISTS , CACHE_SCOPE_PRIVATE , CACHE_SCOPE_SHARED , CACHE_SCOPE_RESERVED , } cocci_id@p ;
...
position p;
@@
 enum { EXTRACT_TOPOLOGY , EXTRACT_LINE_SIZE , EXTRACT_SIZE , EXTRACT_ASSOCIATIVITY , } cocci_id@p ;
...
position p;
@@
 union cache_topology {  struct cache_info ci [ CACHE_MAX_LEVEL ] ;  unsigned long long raw ; } cocci_id@p ;
