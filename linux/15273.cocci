...
position p;
@@
 enum led_bits { BD2802_OFF , BD2802_BLINK , BD2802_ON , } cocci_id@p ;
...
position p;
@@
 struct bd2802_led_platform_data * cocci_id@p ;
...
position p;
@@
 enum led_colors { RED , GREEN , BLUE , } cocci_id@p ;
...
position p;
@@
 enum led_ids { LED1 , LED2 , LED_NUM , } cocci_id@p ;
...
position p;
@@
 struct bd2802_led {  struct bd2802_led_platform_data * pdata ;  struct i2c_client * client ;  struct rw_semaphore rwsem ;  struct led_state led [ 2 ] ;  struct led_classdev cdev_led1r ;  struct led_classdev cdev_led1g ;  struct led_classdev cdev_led1b ;  struct led_classdev cdev_led2r ;  struct led_classdev cdev_led2g ;  struct led_classdev cdev_led2b ;  int adf_on ;  enum led_ids led_id ;  enum led_colors color ;  enum led_bits state ;  int wave_pattern ;  int rgb_current ; } cocci_id@p ;
...
position p;
@@
 struct led_state {  unsigned r : 2 ;  unsigned g : 2 ;  unsigned b : 2 ; } cocci_id@p ;
