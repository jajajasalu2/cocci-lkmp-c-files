...
position p;
@@
 const struct mtk_desc_pin * cocci_id@p ;
...
position p;
@@
 const struct mtk_desc_function * cocci_id@p ;
...
position p;
@@
 const struct mtk_drv_group_desc * cocci_id@p ;
...
position p;
@@
 const struct mtk_eint_xt cocci_id@p ;
...
position p;
@@
 const struct mtk_pin_spec_pupd_set_samereg * cocci_id@p ;
...
position p;
@@
 const struct mtk_pinctrl_devdata * cocci_id@p ;
...
position p;
@@
 struct mtk_pinctrl_group * cocci_id@p ;
...
position p;
@@
 const struct mtk_pin_ies_smt_set * cocci_id@p ;
...
position p;
@@
 const struct mtk_pin_drv_grp * cocci_id@p ;
