...
position p;
@@
 struct tegra_powergate_info * cocci_id@p ;
...
position p;
@@
 const struct tegra_powergate_info * cocci_id@p ;
...
position p;
@@
 struct mrq_pg_request cocci_id@p ;
...
position p;
@@
 struct tegra_powergate_info {  unsigned int id ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct mrq_pg_response cocci_id@p ;
...
position p;
@@
 struct tegra_powergate {  struct generic_pm_domain genpd ;  struct tegra_bpmp * bpmp ;  unsigned int id ; } cocci_id@p ;
