...
position p;
@@
 void cocci_id@p ( struct camera_data * cam ) ;
...
position p;
@@
 int cocci_id@p ( struct camera_data * cam ) ;
...
position p;
@@
 struct cpia2_command cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct camera_data * cam , unsigned int alt ) ;
