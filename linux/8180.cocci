...
position p;
@@
 int cocci_id@p ( struct net_device * dev , unsigned int maxcnt ) ;
...
position p;
@@
 enum { buffer_write , buffer_read , } cocci_id@p ;
...
position p;
@@
 const struct ether3_data * cocci_id@p ;
