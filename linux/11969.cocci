...
typedef u8,bool;
@@
 struct lt_state {  struct nvkm_dp * dp ;  u8 stat [ 6 ] ;  u8 conf [ 4 ] ;  bool pc2 ;  u8 pc2stat ;  u8 pc2conf [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 const struct nvkm_outp_func cocci_id@p ;
...
position p;
@@
 const struct nvkm_i2c_ntfy_rep * cocci_id@p ;
...
position p;
@@
 struct nvbios_dpout cocci_id@p ;
...
position p;
@@
 struct nvbios_dpcfg cocci_id@p ;
...
position p;
@@
 struct nvkm_i2c_ntfy_req cocci_id@p ;
...
typedef u8,u32;
@@
 const struct dp_rates {  u32 rate ;  u8 bw ;  u8 nr ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nvkm_i2c_ntfy_rep cocci_id@p ;
...
position p;
@@
 const struct dp_rates * cocci_id@p ;
