...
position p;
@@
 int cocci_id@p [ NUM_IWL_RXON_CTX ] ;
...
position p;
@@
 struct iwl_scancomplete_notification * cocci_id@p ;
...
position p;
@@
 struct iwl_scanreq_notification * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_channel * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_scanresults_notification * cocci_id@p ;
...
position p;
@@
 struct iwl_scanstart_notification * cocci_id@p ;
