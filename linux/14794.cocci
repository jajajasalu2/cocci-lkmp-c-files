...
position p;
@@
 const struct r9a06g032_clkdesc cocci_id@p [ ] ;
...
position p;
@@
 struct r9a06g032_gate * cocci_id@p ;
...
position p;
@@
 struct r9a06g032_clk_div * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct r9a06g032_priv {  struct clk_onecell_data data ;  spinlock_t lock ;  void __iomem * reg ; } cocci_id@p ;
...
position p;
@@
 struct r9a06g032_priv * cocci_id@p ;
...
position p;
@@
 struct r9a06g032_clk_bitsel * cocci_id@p ;
...
typedef u16;
@@
 struct r9a06g032_clk_dualgate {  struct clk_hw hw ;  struct r9a06g032_priv * clocks ;  u16 index ;  u16 selector ;  struct r9a06g032_gate gate [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct r9a06g032_clk_gate cocci_id@p ;
...
position p;
@@
 enum { K_GATE = 0 , K_FFC , K_DIV , K_BITSEL , K_DUALGATE , } cocci_id@p ;
...
position p;
@@
 struct r9a06g032_clk_dualgate * cocci_id@p ;
...
typedef u16;
@@
 struct r9a06g032_clk_gate {  struct clk_hw hw ;  struct r9a06g032_priv * clocks ;  u16 index ;  struct r9a06g032_gate gate ; } cocci_id@p ;
...
typedef u16;
@@
 struct r9a06g032_clk_bitsel {  struct clk_hw hw ;  struct r9a06g032_priv * clocks ;  u16 index ;  u16 selector ; } cocci_id@p ;
