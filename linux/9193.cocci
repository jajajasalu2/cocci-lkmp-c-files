...
typedef u32;
@@
 struct i596_cmd {  struct i596_cmd * v_next ;  unsigned short status ;  unsigned short command ;  u32 b_next ; } cocci_id@p ;
...
typedef u32;
@@
 struct i596_reg {  unsigned short porthi ;  unsigned short portlo ;  u32 ca ; } cocci_id@p ;
...
typedef u32;
@@
 struct i596_tbd {  unsigned short size ;  unsigned short pad ;  u32 next ;  u32 data ;  u32 cache_pad [ 5 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct i596_scb {  unsigned short status ;  unsigned short command ;  u32 cmd ;  u32 rfd ;  u32 crc_err ;  u32 align_err ;  u32 resource_err ;  u32 over_err ;  u32 rcvdt_err ;  u32 short_err ;  unsigned short t_on ;  unsigned short t_off ; } cocci_id@p ;
...
typedef u32;
@@
 struct i596_scp {  u32 sysbus ;  u32 pad ;  u32 iscp ; } cocci_id@p ;
...
@@
 struct i596_private {  struct i596_dma * dma ;  u32 stat ;  int last_restart ;  struct i596_rfd * rfd_head ;  struct i596_rbd * rbd_head ;  struct i596_cmd * cmd_tail ;  struct i596_cmd * cmd_head ;  int cmd_backlog ;  u32 last_cmd ;  int next_tx_cmd ;  int options ;  spinlock_t lock ;  dma_addr_t dma_addr ;  void __iomem * mpu_port ;  void __iomem * ca ; } cocci_id@p ;
...
typedef u32;
@@
 struct i596_rfd {  unsigned short stat ;  unsigned short cmd ;  u32 b_next ;  u32 rbd ;  unsigned short count ;  unsigned short size ;  struct i596_rfd * v_next ;  struct i596_rfd * v_prev ; #ifndef __LP64__  u32 cache_pad [ 2 ] ; #endif } cocci_id@p ;
...
typedef u32;
@@
 struct i596_iscp {  u32 stat ;  u32 scb ; } cocci_id@p ;
