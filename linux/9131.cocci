...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_pages_out ) ] ;
...
position p;
@@
 enum { MLX5_PAGES_CANT_GIVE = 0 , MLX5_PAGES_GIVE = 1 , MLX5_PAGES_TAKE = 2 , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( manage_pages_out ) ] ;
...
position p;
@@
 struct mlx5_pages_req * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( manage_pages_in ) ] ;
...
position p;
@@
 enum { MAX_RECLAIM_TIME_MSECS = 5000 , MAX_RECLAIM_VFS_PAGES_TIME_MSECS = 2 * 1000 * 60 , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_pages_in ) ] ;
...
typedef u64,u16;
@@
 struct fw_page {  struct rb_node rb_node ;  u64 addr ;  struct page * page ;  u16 func_id ;  unsigned long bitmask ;  struct list_head list ;  unsigned free_count ; } cocci_id@p ;
...
position p;
@@
 enum { MLX5_BLKS_FOR_RECLAIM_PAGES = 12 , } cocci_id@p ;
...
typedef u8,u16,s32;
@@
 struct mlx5_pages_req {  struct mlx5_core_dev * dev ;  u16 func_id ;  u8 ec_function ;  s32 npages ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 enum { EC_FUNCTION_MASK = 0x8000 , } cocci_id@p ;
...
position p;
@@
 enum { MLX5_MAX_RECLAIM_TIME_MILI = 5000 , MLX5_NUM_4K_IN_PAGE = PAGE_SIZE / MLX5_ADAPTER_PAGE_SIZE , } cocci_id@p ;
