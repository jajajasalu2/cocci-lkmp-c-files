...
position p;
@@
 char cocci_id@p [ UWB_ADDR_STRSIZE ] ;
...
@@
 struct uwb_dbg {  struct uwb_pal pal ;  bool accept ;  struct list_head rsvs ;  struct dentry * root_d ;  struct dentry * command_f ;  struct dentry * reservations_f ;  struct dentry * accept_f ;  struct dentry * drp_avail_f ;  spinlock_t list_lock ; } cocci_id@p ;
...
position p;
@@
 struct uwb_mac_addr cocci_id@p ;
...
position p;
@@
 struct uwb_dbg_cmd_rsv_establish * cocci_id@p ;
...
position p;
@@
 struct uwb_dbg_cmd_rsv_terminate * cocci_id@p ;
...
position p;
@@
 const struct uwb_ie_hdr * cocci_id@p ;
...
position p;
@@
 struct uwb_dbg_cmd_ie * cocci_id@p ;
