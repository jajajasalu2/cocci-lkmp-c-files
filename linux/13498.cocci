...
position p;
@@
 struct dvbt_set_parameters_msg * cocci_id@p ;
...
position p;
@@
 struct cinergyt2_fe_state {  struct dvb_frontend fe ;  struct dvb_usb_device * d ;  unsigned char data [ 64 ] ;  struct mutex data_mutex ;  struct dvbt_get_status_msg status ; } cocci_id@p ;
...
position p;
@@
 struct cinergyt2_fe_state cocci_id@p ;
