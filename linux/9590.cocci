...
position p;
@@
 struct qtnf_pearl_fw_hdr cocci_id@p ;
...
position p;
@@
 struct qtnf_pearl_rx_bd * cocci_id@p ;
...
position p;
@@
 struct qtnf_pcie_pearl_state * cocci_id@p ;
...
position p;
@@
 struct qtnf_frame_meta_info * cocci_id@p ;
...
position p;
@@
 struct qtnf_pearl_tx_bd cocci_id@p ;
...
position p;
@@
 const struct qtnf_pcie_pearl_state * cocci_id@p ;
