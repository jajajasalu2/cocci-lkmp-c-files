...
position p;
@@
 struct bio_slab {  struct kmem_cache * slab ;  unsigned int slab_ref ;  unsigned int slab_size ;  char name [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct bio_map_data * cocci_id@p ;
...
position p;
@@
 struct bio_map_data {  int is_our_pages ;  struct iov_iter iter ;  struct iovec iov [ ] ; } cocci_id@p ;
