...
typedef u32;
@@
 struct rsnd_adg {  struct clk * clk [ CLKMAX ] ;  struct clk * clkout [ CLKOUTMAX ] ;  struct clk_onecell_data onecell ;  struct rsnd_mod mod ;  int clk_rate [ CLKMAX ] ;  u32 flags ;  u32 ckr ;  u32 rbga ;  u32 rbgb ;  int rbga_rate_for_441khz ;  int rbgb_rate_for_48khz ; } cocci_id@p ;
