...
position p;
@@
 struct HUF_CElt_s {  U16 val ;  BYTE nbBits ; } cocci_id@p ;
...
position p;
@@
 U16 cocci_id@p [ HUF_TABLELOG_MAX + 2 ] ;
...
position p;
@@
 U32 cocci_id@p [ HUF_TABLELOG_MAX + 2 ] ;
...
position p;
@@
 struct {  U32 base ;  U32 curr ; } cocci_id@p ;
...
position p;
@@
 nodeElt cocci_id@p [ 2 * HUF_SYMBOLVALUE_MAX + 1 + 1 ] ;
...
position p;
@@
 U16 cocci_id@p [ HUF_TABLELOG_MAX + 1 ] ;
...
position p;
@@
 struct nodeElt_s {  U32 count ;  U16 parent ;  BYTE byte ;  BYTE nbBits ; } cocci_id@p ;
