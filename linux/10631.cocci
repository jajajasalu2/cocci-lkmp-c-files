...
position p;
@@
 struct intel_gvt_gtt_gma_ops cocci_id@p ;
...
position p;
@@
 struct intel_gvt_gtt_pte_ops * cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_gtt * cocci_id@p ;
...
position p;
@@
 struct intel_gvt_gtt_entry * cocci_id@p ;
...
position p;
@@
 struct gtt_type_table_entry {  int entry_type ;  int pt_type ;  int next_pt_type ;  int pse_entry_type ; } cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_oos_page * cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_page_track * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct intel_vgpu * vgpu , struct intel_vgpu_oos_page * oos_page ) ;
...
position p;
@@
 struct intel_vgpu_ppgtt_spt cocci_id@p ;
...
position p;
@@
 struct intel_gvt_partial_pte * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct intel_vgpu_ppgtt_spt * spt ) ;
...
position p;
@@
 struct gtt_type_table_entry cocci_id@p [ ] ;
...
position p;
@@
 struct intel_gvt_gtt * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct intel_gvt * gvt ) ;
...
position p;
@@
 const struct intel_gvt_device_info * cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct intel_vgpu_ppgtt_spt * spt , u64 pa , void * p_data , int bytes ) ;
