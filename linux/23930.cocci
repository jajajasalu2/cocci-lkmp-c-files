...
typedef u8,u16;
@@
 struct fou_cfg {  u16 type ;  u8 protocol ;  u8 flags ;  struct udp_port_cfg udp_config ; } cocci_id@p ;
...
position p;
@@
 struct fou_net {  struct list_head fou_list ;  struct mutex fou_lock ; } cocci_id@p ;
...
position p;
@@
 const struct guehdr * cocci_id@p ;
...
typedef u8,u16;
@@
 struct fou {  struct socket * sock ;  u8 protocol ;  u8 flags ;  __be16 port ;  u8 family ;  u16 type ;  struct list_head list ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ FOU_ATTR_MAX + 1 ] ;
