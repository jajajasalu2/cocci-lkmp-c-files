...
typedef u32;
@@
 struct adc_keys_state {  struct iio_channel * channel ;  u32 num_keys ;  u32 last_key ;  u32 keyup_voltage ;  const struct adc_keys_button * map ; } cocci_id@p ;
...
position p;
@@
 struct adc_keys_state * cocci_id@p ;
...
typedef u32;
@@
 struct adc_keys_button {  u32 voltage ;  u32 keycode ; } cocci_id@p ;
...
position p;
@@
 struct adc_keys_button * cocci_id@p ;
