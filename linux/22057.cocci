...
position p;
@@
 struct radix_tree_node cocci_id@p ;
...
position p;
@@
 struct radix_tree_preload {  unsigned nr ;  struct radix_tree_node * nodes ; } cocci_id@p ;
...
position p;
@@
 struct radix_tree_preload * cocci_id@p ;
...
position p;
@@
 const struct radix_tree_root * cocci_id@p ;
...
position p;
@@
 const struct radix_tree_iter * cocci_id@p ;
...
position p;
@@
 const struct radix_tree_node * cocci_id@p ;
