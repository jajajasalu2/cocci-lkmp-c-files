...
typedef u16;
@@
 struct adc084s021 {  struct spi_device * spi ;  struct spi_message message ;  struct spi_transfer spi_trans ;  struct regulator * reg ;  struct mutex lock ;  u16 tx_buf [ 4 ] ____cacheline_aligned ;  __be16 rx_buf [ 5 ] ; } cocci_id@p ;
