...
position p;
@@
 struct wm8770_priv {  struct regmap * regmap ;  struct regulator_bulk_data supplies [ WM8770_NUM_SUPPLIES ] ;  struct notifier_block disable_nb [ WM8770_NUM_SUPPLIES ] ;  struct snd_soc_component * component ;  int sysclk ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8770_NUM_SUPPLIES ] ;
