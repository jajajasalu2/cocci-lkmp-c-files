...
position p;
@@
 struct nbpf_desc_page * cocci_id@p ;
...
typedef bool;
@@
 struct nbpf_desc {  struct dma_async_tx_descriptor async_tx ;  bool user_wait ;  size_t length ;  struct nbpf_channel * chan ;  struct list_head sg ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct nbpf_channel cocci_id@p ;
...
position p;
@@
 struct nbpf_link_reg * cocci_id@p ;
...
position p;
@@
 enum nbpf_model { NBPF1B4 , NBPF1B8 , NBPF1B16 , NBPF4B4 , NBPF4B8 , NBPF4B16 , NBPF8B4 , NBPF8B8 , NBPF8B16 , } cocci_id@p ;
...
typedef u32;
@@
 struct nbpf_device {  struct dma_device dma_dev ;  void __iomem * base ;  u32 max_burst_mem_read ;  u32 max_burst_mem_write ;  struct clk * clk ;  const struct nbpf_config * config ;  unsigned int eirq ;  struct nbpf_channel chan [ ] ; } cocci_id@p ;
...
position p;
@@
 struct nbpf_link_desc cocci_id@p ;
...
position p;
@@
 struct nbpf_desc_page {  struct list_head node ;  struct nbpf_desc desc [ NBPF_DESCS_PER_PAGE ] ;  struct nbpf_link_desc ldesc [ NBPF_SEGMENTS_PER_PAGE ] ;  struct nbpf_link_reg hwdesc [ NBPF_SEGMENTS_PER_PAGE ] ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct nbpf_link_desc {  struct nbpf_link_reg * hwdesc ;  dma_addr_t hwdesc_dma_addr ;  struct nbpf_desc * desc ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 const struct nbpf_config * cocci_id@p ;
...
position p;
@@
 struct nbpf_config {  int num_channels ;  int buffer_size ; } cocci_id@p ;
