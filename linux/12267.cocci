...
position p;
@@
 unsigned char cocci_id@p [ S6E3HA2_VINT_STATUS_MAX ] ;
...
position p;
@@
 struct s6e3ha2 {  struct device * dev ;  struct drm_panel panel ;  struct backlight_device * bl_dev ;  struct regulator_bulk_data supplies [ 2 ] ;  struct gpio_desc * reset_gpio ;  struct gpio_desc * enable_gpio ;  const struct s6e3ha2_panel_desc * desc ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ S6E3HA2_NUM_GAMMA_STEPS ] [ S6E3HA2_GAMMA_CMD_CNT ] ;
...
position p;
@@
 struct s6e3ha2_panel_desc {  const struct drm_display_mode * mode ;  enum s6e3ha2_type type ; } cocci_id@p ;
...
position p;
@@
 const struct s6e3ha2_panel_desc cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ S6E3HA2_GAMMA_CMD_CNT + 1 ] ;
...
position p;
@@
 enum s6e3ha2_type { HA2_TYPE , HF2_TYPE , } cocci_id@p ;
