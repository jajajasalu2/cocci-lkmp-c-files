...
position p;
@@
 struct virtio_scsi_vq * cocci_id@p ;
...
position p;
@@
 struct virtio_scsi_event_node * cocci_id@p ;
...
position p;
@@
 struct virtio_scsi_config cocci_id@p ;
...
position p;
@@
 struct virtio_scsi_cmd cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct virtio_scsi * vscsi , void * buf ) ;
...
position p;
@@
 struct virtio_scsi_event_node {  struct virtio_scsi * vscsi ;  struct virtio_scsi_event event ;  struct work_struct work ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct virtio_scsi_vq {  spinlock_t vq_lock ;  struct virtqueue * vq ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct virtio_scsi {  struct virtio_device * vdev ;  struct virtio_scsi_event_node event_list [ VIRTIO_SCSI_EVENT_LEN ] ;  u32 num_queues ;  struct hlist_node node ;  bool stop_events ;  struct virtio_scsi_vq ctrl_vq ;  struct virtio_scsi_vq event_vq ;  struct virtio_scsi_vq req_vqs [ ] ; } cocci_id@p ;
...
position p;
@@
 typeof ( ( ( struct virtio_scsi_config * ) 0 ) -> fld ) cocci_id@p ;
