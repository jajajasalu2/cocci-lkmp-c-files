...
position p;
@@
 const unsigned int cocci_id@p [ DDP_MUTEX_SOF_DSI3 + 1 ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ DDP_COMPONENT_ID_MAX ] ;
...
typedef bool;
@@
 struct mtk_disp_mutex {  int id ;  bool claimed ; } cocci_id@p ;
...
typedef bool;
@@
 struct mtk_ddp_data {  const unsigned int * mutex_mod ;  const unsigned int * mutex_sof ;  const unsigned int mutex_mod_reg ;  const unsigned int mutex_sof_reg ;  const bool no_clk ; } cocci_id@p ;
...
position p;
@@
 enum mtk_ddp_mutex_sof_id { DDP_MUTEX_SOF_SINGLE_MODE , DDP_MUTEX_SOF_DSI0 , DDP_MUTEX_SOF_DSI1 , DDP_MUTEX_SOF_DPI0 , DDP_MUTEX_SOF_DPI1 , DDP_MUTEX_SOF_DSI2 , DDP_MUTEX_SOF_DSI3 , } cocci_id@p ;
...
position p;
@@
 struct mtk_ddp {  struct device * dev ;  struct clk * clk ;  void __iomem * regs ;  struct mtk_disp_mutex mutex [ 10 ] ;  const struct mtk_ddp_data * data ; } cocci_id@p ;
...
position p;
@@
 struct mtk_disp_mutex * cocci_id@p ;
...
position p;
@@
 const struct mtk_ddp_data cocci_id@p ;
