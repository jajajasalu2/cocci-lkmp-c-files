...
position p;
@@
 const struct uniphier_u3ssphy_param * cocci_id@p ;
...
typedef u8;
@@
 struct uniphier_u3ssphy_param {  struct {  int reg_no ;  int msb ;  int lsb ; } field ;  u8 value ; } cocci_id@p ;
...
position p;
@@
 const struct uniphier_u3ssphy_soc_data cocci_id@p ;
...
position p;
@@
 struct uniphier_u3ssphy_priv * cocci_id@p ;
...
typedef bool;
@@
 struct uniphier_u3ssphy_soc_data {  bool is_legacy ;  int nparams ;  const struct uniphier_u3ssphy_param param [ MAX_PHY_PARAMS ] ; } cocci_id@p ;
