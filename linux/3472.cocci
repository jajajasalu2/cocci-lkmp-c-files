...
position p;
@@
 struct omap_hsmmc_host * cocci_id@p ;
...
position p;
@@
 struct omap_hsmmc_platform_data * cocci_id@p ;
...
position p;
@@
 const struct omap_mmc_of_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct omap_hsmmc_host * host ) ;
...
position p;
@@
 struct omap_hsmmc_next * cocci_id@p ;
...
typedef u8,u32;
@@
 struct omap_mmc_of_data {  u32 reg_offset ;  u8 controller_flags ; } cocci_id@p ;
...
typedef s32;
@@
 struct omap_hsmmc_next {  unsigned int dma_len ;  s32 cookie ; } cocci_id@p ;
