...
position p;
@@
 struct vega12_hwmgr * cocci_id@p ;
...
position p;
@@
 struct vega12_clock_range * cocci_id@p ;
...
position p;
@@
 struct vega12_dpm_state * cocci_id@p ;
...
position p;
@@
 struct vega12_dpm_table cocci_id@p ;
...
position p;
@@
 struct vega12_single_dpm_table * cocci_id@p ;
