...
position p;
@@
 struct xfs_inobt_rec_incore * cocci_id@p ;
...
typedef xfs_agino_t;
@@
 struct xfs_ialloc_count_inodes {  xfs_agino_t count ;  xfs_agino_t freecount ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_inobt_rec_incore_t;
@@
 xfs_inobt_rec_incore_t cocci_id@p ;
...
position p;
@@
 struct xfs_ialloc_count_inodes cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_inofree_t;
@@
 xfs_inofree_t cocci_id@p ;
