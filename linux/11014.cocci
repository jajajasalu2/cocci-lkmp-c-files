...
position p;
@@
 SMU71_Discrete_VoltageLevel cocci_id@p ;
...
position p;
@@
 const struct iceland_pt_defaults * cocci_id@p ;
...
position p;
@@
 struct iceland_smumgr cocci_id@p ;
...
position p;
@@
 SMU71_Discrete_GraphicsLevel * cocci_id@p ;
...
position p;
@@
 SMU71_Discrete_MCRegisterSet * cocci_id@p ;
...
position p;
@@
 SMU71_Discrete_MCArbDramTimingTable cocci_id@p ;
...
position p;
@@
 struct iceland_mc_reg_table * cocci_id@p ;
...
position p;
@@
 SMU71_Discrete_DpmTable * cocci_id@p ;
...
position p;
@@
 struct SMU71_Discrete_Ulv * cocci_id@p ;
...
position p;
@@
 const struct iceland_smumgr * cocci_id@p ;
...
position p;
@@
 SMU71_Discrete_MCRegisters cocci_id@p ;
...
position p;
@@
 struct SMU71_Discrete_MCArbDramTimingTableEntry * cocci_id@p ;
...
position p;
@@
 SMU71_Discrete_MemoryLevel cocci_id@p ;
...
position p;
@@
 const struct iceland_mc_reg_entry * cocci_id@p ;
...
position p;
@@
 SMU71_Discrete_FanTable cocci_id@p ;
...
position p;
@@
 struct SMU71_Discrete_PmFuses cocci_id@p ;
