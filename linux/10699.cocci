...
position p;
@@
 struct opregion_asle cocci_id@p ;
...
position p;
@@
 struct opregion_asle_ext cocci_id@p ;
...
position p;
@@
 struct opregion_swsci * cocci_id@p ;
...
@@
 const struct {  pci_power_t pci_power_state ;  u32 parm ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( OPREGION_SIGNATURE ) ] ;
...
position p;
@@
 struct opregion_acpi * cocci_id@p ;
