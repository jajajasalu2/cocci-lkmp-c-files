...
position p;
@@
 struct mt6577_auxadc_device * cocci_id@p ;
...
position p;
@@
 struct mt6577_auxadc_device {  void __iomem * reg_base ;  struct clk * adc_clk ;  struct mutex lock ;  const struct mtk_auxadc_compatible * dev_comp ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_auxadc_compatible cocci_id@p ;
...
typedef bool;
@@
 struct mtk_auxadc_compatible {  bool sample_data_cali ;  bool check_global_idle ; } cocci_id@p ;
