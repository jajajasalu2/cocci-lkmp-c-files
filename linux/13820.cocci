...
position p;
@@
 const struct video_i2c_chip cocci_id@p [ ] ;
...
position p;
@@
 const struct hwmon_chip_info cocci_id@p ;
...
position p;
@@
 enum { AMG88XX , MLX90640 , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct video_i2c_data {  struct regmap * regmap ;  const struct video_i2c_chip * chip ;  struct mutex lock ;  spinlock_t slock ;  unsigned int sequence ;  struct mutex queue_lock ;  struct v4l2_device v4l2_dev ;  struct video_device vdev ;  struct vb2_queue vb_vidq ;  struct task_struct * kthread_vid_cap ;  struct list_head vid_cap_active ;  struct v4l2_fract frame_interval ; } cocci_id@p ;
...
position p;
@@
 struct video_i2c_data * cocci_id@p ;
...
position p;
@@
 struct nvmem_config cocci_id@p ;
...
typedef bool;
@@
 struct video_i2c_chip {  const struct v4l2_fmtdesc * format ;  const struct v4l2_frmsize_discrete * size ;  const struct v4l2_fract * frame_intervals ;  unsigned int num_frame_intervals ;  unsigned int buffer_size ;  unsigned int bpp ;  const struct regmap_config * regmap_config ;  struct nvmem_config * nvmem_config ;  int ( * setup ) ( struct video_i2c_data * data ) ;  int ( * xfer ) ( struct video_i2c_data * data , char * buf ) ;  int ( * set_power ) ( struct video_i2c_data * data , bool on ) ;  int ( * hwmon_init ) ( struct video_i2c_data * data ) ; } cocci_id@p ;
...
position p;
@@
 const struct video_i2c_data * cocci_id@p ;
...
position p;
@@
 enum hwmon_sensor_types cocci_id@p ;
...
position p;
@@
 const struct hwmon_channel_info cocci_id@p ;
...
position p;
@@
 struct video_i2c_buffer cocci_id@p ;
...
position p;
@@
 struct video_i2c_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 const struct hwmon_ops cocci_id@p ;
...
position p;
@@
 struct nvmem_device * cocci_id@p ;
...
position p;
@@
 struct video_i2c_chip cocci_id@p ;
