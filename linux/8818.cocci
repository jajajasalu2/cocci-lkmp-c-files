...
position p;
@@
 struct ethqos_emac_por {  unsigned int offset ;  unsigned int value ; } cocci_id@p ;
...
position p;
@@
 struct qcom_ethqos {  struct platform_device * pdev ;  void __iomem * rgmii_base ;  unsigned int rgmii_clk_rate ;  struct clk * rgmii_clk ;  unsigned int speed ;  const struct ethqos_emac_por * por ;  unsigned int num_por ; } cocci_id@p ;
...
position p;
@@
 const struct ethqos_emac_por cocci_id@p [ ] ;
