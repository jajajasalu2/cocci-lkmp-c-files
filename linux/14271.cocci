...
position p;
@@
 struct gs {  struct spi_device * pdev ;  struct v4l2_subdev sd ;  struct v4l2_dv_timings current_timings ;  int enabled ; } cocci_id@p ;
...
position p;
@@
 const struct gs_reg_fmt cocci_id@p [ ] ;
...
typedef u16;
@@
 struct gs_reg_fmt {  u16 reg_value ;  struct v4l2_dv_timings format ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u32,__u64,u16;
@@
 struct gs_reg_fmt_custom {  u16 reg_value ;  __u32 width ;  __u32 height ;  __u64 pixelclock ;  __u32 interlaced ; } cocci_id@p ;
