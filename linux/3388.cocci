...
position p;
@@
 const struct img_pwm_soc_data cocci_id@p ;
...
typedef u32;
@@
 struct img_pwm_chip {  struct device * dev ;  struct pwm_chip chip ;  struct clk * pwm_clk ;  struct clk * sys_clk ;  void __iomem * base ;  struct regmap * periph_regs ;  int max_period_ns ;  int min_period_ns ;  const struct img_pwm_soc_data * data ;  u32 suspend_ctrl_cfg ;  u32 suspend_ch_cfg [ IMG_PWM_NPWM ] ; } cocci_id@p ;
...
position p;
@@
 struct img_pwm_chip * cocci_id@p ;
...
typedef u32;
@@
 struct img_pwm_soc_data {  u32 max_timebase ; } cocci_id@p ;
