...
position p;
@@
 struct mlxsw_rx_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,bool,u32,wait_queue_head_t;
@@
 struct mlxsw_pci {  struct pci_dev * pdev ;  u8 __iomem * hw_addr ;  u64 free_running_clock_offset ;  struct mlxsw_pci_queue_type_group queues [ MLXSW_PCI_QUEUE_TYPE_COUNT ] ;  u32 doorbell_offset ;  struct mlxsw_core * core ;  struct {  struct mlxsw_pci_mem_item * items ;  unsigned int count ; } fw_area ;  struct {  struct mlxsw_pci_mem_item out_mbox ;  struct mlxsw_pci_mem_item in_mbox ;  struct mutex lock ;  bool nopoll ;  wait_queue_head_t wait ;  bool wait_done ;  struct {  u8 status ;  u64 out_param ; } comp ; } cmd ;  struct mlxsw_bus_info bus_info ;  const struct pci_device_id * id ;  enum mlxsw_pci_cqe_v max_cqe_ver ;  u8 num_sdq_cqs ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_pci_queue_ops * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct mlxsw_pci_mem_item {  char * buf ;  dma_addr_t mapaddr ;  size_t size ; } cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_pci_queue_type_group {  struct mlxsw_pci_queue * q ;  u8 count ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_pci_queue_elem_info * cocci_id@p ;
...
position p;
@@
 struct mlxsw_pci_queue_elem_info {  char * elem ;  union {  struct {  struct sk_buff * skb ; } sdq ;  struct {  struct sk_buff * skb ; } rdq ; } u ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_bus_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MRSR_LEN ] ;
...
position p;
@@
 enum mlxsw_pci_cqe_v cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,u16,spinlock_t;
@@
 struct mlxsw_pci_queue {  spinlock_t lock ;  struct mlxsw_pci_mem_item mem_item ;  struct mlxsw_pci_queue_elem_info * elem_info ;  u16 producer_counter ;  u16 consumer_counter ;  u16 count ;  u8 num ;  u8 elem_size ;  enum mlxsw_pci_queue_type type ;  struct tasklet_struct tasklet ;  struct mlxsw_pci * pci ;  union {  struct {  u32 comp_sdq_count ;  u32 comp_rdq_count ;  enum mlxsw_pci_cqe_v v ; } cq ;  struct {  u32 ev_cmd_count ;  u32 ev_comp_count ;  u32 ev_other_count ; } eq ; } u ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_swid_config * cocci_id@p ;
...
position p;
@@
 struct mlxsw_tx_info cocci_id@p ;
...
position p;
@@
 enum mlxsw_pci_queue_type { MLXSW_PCI_QUEUE_TYPE_SDQ , MLXSW_PCI_QUEUE_TYPE_RDQ , MLXSW_PCI_QUEUE_TYPE_CQ , MLXSW_PCI_QUEUE_TYPE_EQ , } cocci_id@p ;
...
position p;
@@
 enum mlxsw_pci_queue_type cocci_id@p ;
...
position p;
@@
 struct mlxsw_pci_queue * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_bus cocci_id@p ;
...
position p;
@@
 const struct mlxsw_pci * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_pci_queue * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_PCI_CQE_SIZE_MAX ] ;
...
position p;
@@
 struct mlxsw_pci_mem_item * cocci_id@p ;
...
position p;
@@
 struct mlxsw_pci_queue_type_group * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ BITS_TO_LONGS ( MLXSW_PCI_CQS_MAX ) ] ;
