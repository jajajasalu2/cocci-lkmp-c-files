...
position p;
@@
 struct panel_init_cmd {  size_t len ;  const char * data ; } cocci_id@p ;
...
typedef bool;
@@
 struct innolux_panel {  struct drm_panel base ;  struct mipi_dsi_device * link ;  const struct panel_desc * desc ;  struct backlight_device * backlight ;  struct regulator_bulk_data * supplies ;  struct gpio_desc * enable_gpio ;  bool prepared ;  bool enabled ; } cocci_id@p ;
...
position p;
@@
 const struct panel_init_cmd cocci_id@p [ ] ;
...
position p;
@@
 struct panel_desc {  const struct drm_display_mode * mode ;  unsigned int bpc ;  struct {  unsigned int width ;  unsigned int height ; } size ;  unsigned long flags ;  enum mipi_dsi_pixel_format format ;  const struct panel_init_cmd * init_cmds ;  unsigned int lanes ;  const char * const * supply_names ;  unsigned int num_supplies ;  unsigned int sleep_mode_delay ;  unsigned int power_down_delay ; } cocci_id@p ;
...
position p;
@@
 struct innolux_panel * cocci_id@p ;
