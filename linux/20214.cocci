...
position p;
@@
 struct memclust_struct * cocci_id@p ;
...
position p;
@@
 struct alpha_machine_vector * cocci_id@p ( const char * ) ;
...
position p;
@@
 struct alpha_machine_vector * cocci_id@p ( unsigned long , unsigned long , unsigned long ) ;
...
position p;
@@
 struct alpha_machine_vector * cocci_id@p ;
...
position p;
@@
 struct memdesc_struct * cocci_id@p ;
...
position p;
@@
 struct atomic_notifier_head cocci_id@p ;
...
position p;
@@
 struct hwrpb_struct * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long , unsigned long , unsigned long , char * * , char * * ) ;
