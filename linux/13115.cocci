...
position p;
@@
 struct dfl_feature_info * cocci_id@p ;
...
position p;
@@
 struct dfl_chardev_info cocci_id@p [ ] ;
...
position p;
@@
 const struct dfl_feature_id * cocci_id@p ;
...
position p;
@@
 struct dfl_feature_platform_data * cocci_id@p ;
...
position p;
@@
 struct dfl_feature_driver * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ DFL_ID_MAX ] ;
...
position p;
@@
 enum dfl_fpga_devt_type cocci_id@p ;
...
typedef u32;
@@
 struct dfl_dev_info {  const char * name ;  u32 dfh_id ;  struct idr id ;  enum dfl_fpga_devt_type devt_type ; } cocci_id@p ;
...
typedef u64;
@@
 struct dfl_feature_info {  u64 fid ;  struct resource mmio_res ;  void __iomem * ioaddr ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct build_feature_devs_info * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct platform_device * , void * ) ;
...
position p;
@@
 struct dfl_fpga_cdev * cocci_id@p ;
...
position p;
@@
 struct build_feature_devs_info {  struct device * dev ;  struct dfl_fpga_cdev * cdev ;  struct platform_device * feature_dev ;  void __iomem * ioaddr ;  struct list_head sub_features ;  int feature_num ; } cocci_id@p ;
...
position p;
@@
 enum dfl_fpga_devt_type { DFL_FPGA_DEVT_FME , DFL_FPGA_DEVT_PORT , DFL_FPGA_DEVT_MAX , } cocci_id@p ;
...
position p;
@@
 struct dfl_fpga_enum_info * cocci_id@p ;
...
position p;
@@
 struct dfl_fpga_enum_dfl * cocci_id@p ;
...
position p;
@@
 struct dfl_fpga_port_ops * cocci_id@p ;
...
typedef dev_t;
@@
 struct dfl_chardev_info {  const char * name ;  dev_t devt ; } cocci_id@p ;
...
position p;
@@
 struct lock_class_key cocci_id@p [ DFL_ID_MAX ] ;
...
position p;
@@
 enum dfl_id_type { FME_ID , PORT_ID , DFL_ID_MAX , } cocci_id@p ;
...
position p;
@@
 struct dfl_dev_info cocci_id@p [ ] ;
