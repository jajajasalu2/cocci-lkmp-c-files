...
position p;
@@
 enum vmw_bo_dirty_method { VMW_BO_DIRTY_PAGETABLE , VMW_BO_DIRTY_MKWRITE , } cocci_id@p ;
...
position p;
@@
 struct vmw_bo_dirty {  unsigned long start ;  unsigned long end ;  enum vmw_bo_dirty_method method ;  unsigned int change_count ;  unsigned int ref_count ;  unsigned long bitmap_size ;  size_t size ;  unsigned long bitmap [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct vmw_bo_dirty * cocci_id@p ;
