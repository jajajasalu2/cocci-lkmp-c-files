...
position p;
@@
 struct fsl_diu_data cocci_id@p ;
...
position p;
@@
 enum mfb_index { PLANE0 = 0 , PLANE1_AOI0 , PLANE1_AOI1 , PLANE2_AOI0 , PLANE2_AOI1 , } cocci_id@p ;
...
position p;
@@
 struct mfb_chroma_key cocci_id@p ;
...
position p;
@@
 struct mfb_info {  enum mfb_index index ;  char * id ;  int registered ;  unsigned long pseudo_palette [ 16 ] ;  struct diu_ad * ad ;  unsigned char g_alpha ;  unsigned int count ;  int x_aoi_d ;  int y_aoi_d ;  struct fsl_diu_data * parent ; } cocci_id@p ;
...
position p;
@@
 const struct mfb_info cocci_id@p [ ] ;
...
position p;
@@
 enum fsl_diu_monitor_port cocci_id@p ;
...
position p;
@@
 struct aoi_display_offset cocci_id@p ;
