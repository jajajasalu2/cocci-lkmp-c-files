...
position p;
@@
 struct iwl_eeprom_calib_hdr * cocci_id@p ;
...
position p;
@@
 const struct iwl_eeprom_channel * cocci_id@p ;
...
position p;
@@
 const struct iwl_nvm_data * cocci_id@p ;
...
position p;
@@
 struct iwl_eeprom_enhanced_txpwr * cocci_id@p ;
...
position p;
@@
 enum eeprom_sku_bits { EEPROM_SKU_CAP_BAND_24GHZ = BIT ( 4 ) , EEPROM_SKU_CAP_BAND_52GHZ = BIT ( 5 ) , EEPROM_SKU_CAP_11N_ENABLE = BIT ( 6 ) , EEPROM_SKU_CAP_AMT_ENABLE = BIT ( 7 ) , EEPROM_SKU_CAP_IPAN_ENABLE = BIT ( 8 ) , } cocci_id@p ;
...
position p;
@@
 enum iwl_eeprom_channel_flags { EEPROM_CHANNEL_VALID = BIT ( 0 ) , EEPROM_CHANNEL_IBSS = BIT ( 1 ) , EEPROM_CHANNEL_ACTIVE = BIT ( 3 ) , EEPROM_CHANNEL_RADAR = BIT ( 4 ) , EEPROM_CHANNEL_WIDE = BIT ( 5 ) , EEPROM_CHANNEL_DFS = BIT ( 7 ) , } cocci_id@p ;
