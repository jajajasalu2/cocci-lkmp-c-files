...
position p;
@@
 struct {  struct xb_req_data * req ;  int idx ;  unsigned int written ; } cocci_id@p ;
...
typedef bool;
@@
 struct {  struct xsd_sockmsg msg ;  char * body ;  union {  void * alloc ;  struct xs_watch_event * watch ; } ;  bool in_msg ;  bool in_hdr ;  unsigned int read ; } cocci_id@p ;
