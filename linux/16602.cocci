...
position p;
@@
 struct tape_med_state_work_data cocci_id@p ;
...
position p;
@@
 enum tape_medium_state cocci_id@p ;
...
position p;
@@
 struct tape_med_state_work_data {  struct tape_device * device ;  enum tape_medium_state state ;  struct work_struct work ; } cocci_id@p ;
