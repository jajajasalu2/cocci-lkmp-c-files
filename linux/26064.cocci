...
typedef sa_family_t;
@@
 union sa46 {  struct sockaddr_in6 v6 ;  struct sockaddr_in v4 ;  sa_family_t family ; } cocci_id@p ;
...
position p;
@@
 enum result cocci_id@p [ NR_RESULTS ] ;
...
position p;
@@
 int cocci_id@p [ REUSEPORT_ARRAY_SIZE ] ;
