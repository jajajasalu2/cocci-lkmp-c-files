...
position p;
@@
 struct patch {  void * addr ;  unsigned int insn ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef probes_insn_fn_t;
@@
 probes_insn_fn_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kprobe_decode_insn_t;
@@
 kprobe_decode_insn_t * cocci_id@p ;
...
@@
 kprobe_opcode_t cocci_id@p [ MAX_INSN_SIZE ] ;
