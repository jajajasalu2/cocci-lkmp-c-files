...
position p;
@@
 struct pcmmio_private * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct pcmmio_private {  spinlock_t pagelock ;  spinlock_t spinlock ;  unsigned int enabled_mask ;  unsigned int active : 1 ; } cocci_id@p ;
