...
typedef u64;
@@
 const u64 cocci_id@p [ HMM_PFN_FLAG_MAX ] ;
...
position p;
@@
 struct nouveau_svm_fault_buffer * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_svm_init * cocci_id@p ;
...
typedef u64;
@@
 struct nouveau_ivmm {  struct nouveau_svmm * svmm ;  u64 inst ;  struct list_head head ; } cocci_id@p ;
...
position p;
@@
 struct nouveau_svm_fault * cocci_id@p ;
...
position p;
@@
 const struct nvif_mclass cocci_id@p [ ] ;
...
position p;
@@
 const struct nouveau_svm_fault * cocci_id@p ;
...
position p;
@@
 struct nvif_vmm_pfnclr_v0 cocci_id@p ;
...
position p;
@@
 struct svm_notifier * cocci_id@p ;
...
position p;
@@
 struct nvif_clb069_v0 cocci_id@p ;
...
position p;
@@
 struct nouveau_svmm {  struct mmu_notifier notifier ;  struct nouveau_vmm * vmm ;  struct {  unsigned long start ;  unsigned long limit ; } unmanaged ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 struct nouveau_svmm * * cocci_id@p ;
...
typedef u64;
@@
 struct {  struct {  struct nvif_ioctl_v0 i ;  struct nvif_ioctl_mthd_v0 m ;  struct nvif_vmm_pfnmap_v0 p ; } i ;  u64 phys [ 16 ] ; } cocci_id@p ;
...
typedef u64;
@@
 const u64 cocci_id@p [ HMM_PFN_VALUE_MAX ] ;
...
position p;
@@
 struct gp100_vmm_fault_replay_vn cocci_id@p ;
...
position p;
@@
 struct gp100_vmm_fault_cancel_v0 cocci_id@p ;
...
position p;
@@
 struct nouveau_ivmm * cocci_id@p ;
...
position p;
@@
 struct gp100_vmm_v0 cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_svm_bind * cocci_id@p ;
...
position p;
@@
 struct svm_notifier {  struct mmu_interval_notifier notifier ;  struct nouveau_svmm * svmm ; } cocci_id@p ;
