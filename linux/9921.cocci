...
position p;
@@
 struct wmi_target_roam_tbl * cocci_id@p ;
...
position p;
@@
 enum ATH6K_DEBUG_MASK cocci_id@p ;
...
typedef u32;
@@
 struct ath6kl_diag_reg_info {  u32 reg_start ;  u32 reg_end ;  const char * reg_info ; } cocci_id@p ;
...
position p;
@@
 const struct ath6kl_diag_reg_info cocci_id@p [ ] ;
...
position p;
@@
 struct htc_endpoint_stats cocci_id@p ;
...
position p;
@@
 struct ath6kl_irq_enable_reg * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct ath6kl_fwlog_slot {  __le32 timestamp ;  __le32 length ;  u8 payload [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct ath6kl_fwlog_slot * cocci_id@p ;
...
position p;
@@
 struct ath6kl_irq_proc_registers * cocci_id@p ;
...
position p;
@@
 struct wmi_bss_roam_info * cocci_id@p ;
...
position p;
@@
 const struct wmi_target_roam_tbl * cocci_id@p ;
