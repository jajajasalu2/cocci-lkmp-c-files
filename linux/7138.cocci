...
position p;
@@
 struct privcmd_buf_vma_private cocci_id@p ;
...
position p;
@@
 struct privcmd_buf_private * cocci_id@p ;
...
position p;
@@
 struct privcmd_buf_vma_private {  struct privcmd_buf_private * file_priv ;  struct list_head list ;  unsigned int users ;  unsigned int n_pages ;  struct page * pages [ ] ; } cocci_id@p ;
...
position p;
@@
 struct privcmd_buf_private {  struct mutex lock ;  struct list_head list ; } cocci_id@p ;
