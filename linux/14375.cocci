...
position p;
@@
 enum operation_mode cocci_id@p ;
...
position p;
@@
 enum drxk_cfg_dvbt_sqi_speed * cocci_id@p ;
...
position p;
@@
 struct s_cfg_pre_saw * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drxk_state * state ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct drxk_state * state , u32 * p_lock_status ) ;
...
position p;
@@
 const struct drxk_config * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drxk_state * state , enum operation_mode o_mode ) ;
...
symbol cocci_id;
position p;
typedef drxk_cfg_dvbt_echo_thres_t;
@@
 struct drxk_cfg_dvbt_echo_thres_t * cocci_id@p ;
...
position p;
@@
 enum e_drxk_constellation cocci_id@p ;
...
typedef s32,u16;
@@
 int cocci_id@p ( struct drxk_state * state , u16 intermediate_freqk_hz , s32 tuner_freq_offset ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct drxk_state * state , bool set_power_mode ) ;
