...
position p;
@@
 struct aspeed_p2a_ctrl_mapping * cocci_id@p ;
...
position p;
@@
 struct aspeed_p2a_model_data {  struct region regions [ P2A_REGION_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct aspeed_p2a_user * cocci_id@p ;
...
typedef u32;
@@
 struct aspeed_p2a_user {  struct file * file ;  struct aspeed_p2a_ctrl * parent ;  u32 read ;  u32 readwrite [ P2A_REGION_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 const struct aspeed_p2a_model_data cocci_id@p ;
...
position p;
@@
 struct aspeed_p2a_ctrl * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,phys_addr_t,resource_size_t;
@@
 struct aspeed_p2a_ctrl {  struct miscdevice miscdev ;  struct regmap * regmap ;  const struct aspeed_p2a_model_data * config ;  struct mutex tracking ;  u32 readers ;  u32 readerwriters [ P2A_REGION_COUNT ] ;  phys_addr_t mem_base ;  resource_size_t mem_size ; } cocci_id@p ;
...
position p;
@@
 const struct region * cocci_id@p ;
...
typedef u64,u32;
@@
 struct region {  u64 min ;  u64 max ;  u32 bit ; } cocci_id@p ;
