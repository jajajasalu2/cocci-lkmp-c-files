...
position p;
@@
 struct virtio_pci_cap cocci_id@p ;
...
position p;
@@
 struct virtio_pci_device * cocci_id@p ;
...
position p;
@@
 struct virtio_pci_common_cfg cocci_id@p ;
...
position p;
@@
 struct virtio_pci_vq_info * cocci_id@p ;
...
position p;
@@
 struct virtio_pci_notify_cap cocci_id@p ;
