...
position p;
@@
 struct hiddev_usage_ref cocci_id@p ;
...
position p;
@@
 struct hiddev_usage_ref_multi cocci_id@p ;
...
position p;
@@
 struct hiddev_field_info cocci_id@p ;
...
position p;
@@
 struct hiddev_report_info cocci_id@p ;
...
position p;
@@
 struct hiddev_list {  struct hiddev_usage_ref buffer [ HIDDEV_BUFFER_SIZE ] ;  int head ;  int tail ;  unsigned flags ;  struct fasync_struct * fasync ;  struct hiddev * hiddev ;  struct list_head node ;  struct mutex thread_lock ; } cocci_id@p ;
...
position p;
@@
 struct hiddev_collection_info cocci_id@p ;
...
position p;
@@
 struct hiddev_event cocci_id@p ;
...
position p;
@@
 struct hiddev_devinfo cocci_id@p ;
...
position p;
@@
 struct usbhid_device * cocci_id@p ;
