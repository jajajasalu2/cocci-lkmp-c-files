...
position p;
@@
 struct ax25_protocol cocci_id@p ;
...
position p;
@@
 struct ax25_linkfail cocci_id@p ;
...
position p;
@@
 struct full_sockaddr_rose * cocci_id@p ;
...
position p;
@@
 struct rose_cause_struct cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ROSE_MIN_LEN ] ;
...
position p;
@@
 struct sockaddr_rose * cocci_id@p ;
...
position p;
@@
 struct rose_facilities_struct cocci_id@p ;
