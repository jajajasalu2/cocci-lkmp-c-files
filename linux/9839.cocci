...
position p;
@@
 struct wil6210_mbox_hdr * cocci_id@p ;
...
position p;
@@
 struct wmi_link_stats_basic cocci_id@p ;
...
position p;
@@
 struct wil_tid_ampdu_rx * cocci_id@p ;
...
position p;
@@
 struct wmi_del_sta_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_port_allocate_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_ring_ba_dis_cmd cocci_id@p ;
...
position p;
@@
 struct wil_ring_tx_data * cocci_id@p ;
...
position p;
@@
 struct wmi_cfg_rx_chain_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_ft_reassoc_status_event * cocci_id@p ;
...
position p;
@@
 struct wmi_temp_sense_cmd cocci_id@p ;
...
position p;
@@
 struct wil_sta_info * cocci_id@p ;
...
position p;
@@
 struct pending_wmi_event cocci_id@p ;
...
position p;
@@
 const struct fw_map cocci_id@p [ ] ;
...
position p;
@@
 struct wmi_pcp_start_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_temp_sense_all_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_link_stats_global * cocci_id@p ;
...
position p;
@@
 struct wmi_traffic_suspend_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_rx_status_ring_add_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_rx_desc_ring_add_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_new_sta_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_start_sched_scan_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_rcp_addba_req_event * cocci_id@p ;
...
position p;
@@
 struct wmi_led_cfg_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_ba_status_event * cocci_id@p ;
...
position p;
@@
 struct wmi_update_ft_ies_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_rx_mgmt_packet_event cocci_id@p ;
...
position p;
@@
 struct wmi_p2p_cfg_cmd cocci_id@p ;
...
position p;
@@
 const struct {  int eventid ;  void ( * handler ) ( struct wil6210_vif * vif , int eventid , void * data , int data_len ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wmi_bcast_desc_ring_add_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_sched_scan_result_event * cocci_id@p ;
...
position p;
@@
 struct wmi_rcp_addba_resp_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_set_mac_address_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_link_stats_event * cocci_id@p ;
...
position p;
@@
 struct wmi_tx_mgmt_packet_event * cocci_id@p ;
...
position p;
@@
 struct fw_map cocci_id@p [ MAX_FW_MAPPING_TABLE_SIZE ] ;
...
position p;
@@
 struct wil_net_stats * cocci_id@p ;
...
position p;
@@
 struct wmi_ps_dev_profile_cfg_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_sched_scan_ssid_match * cocci_id@p ;
...
position p;
@@
 struct wmi_rcp_delba_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_disconnect_sta_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_link_stats_record * cocci_id@p ;
...
position p;
@@
 struct wmi_tx_status_ring_add_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_sw_tx_req_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_cfg_def_rx_offload_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_tx_desc_ring_add_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_ring_ba_en_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_sw_tx_req_ext_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_rcp_addba_resp_edma_cmd cocci_id@p ;
...
position p;
@@
 struct wil6210_mbox_ctl cocci_id@p ;
...
position p;
@@
 struct wmi_temp_sense_all_done_event * cocci_id@p ;
...
position p;
@@
 struct wil6210_mbox_ring_desc cocci_id@p ;
...
position p;
@@
 struct wmi_link_stats_cmd cocci_id@p ;
...
position p;
@@
 struct cfg80211_ssid * cocci_id@p ;
...
position p;
@@
 struct wmi_rbufcap_cfg_cmd cocci_id@p ;
...
position p;
@@
 struct wil6210_priv cocci_id@p ;
...
position p;
@@
 struct wil_status_ring * cocci_id@p ;
...
position p;
@@
 struct wmi_set_ssid_cmd cocci_id@p ;
...
position p;
@@
 struct cfg80211_sched_scan_plan * cocci_id@p ;
...
position p;
@@
 struct wil6210_mbox_ring * cocci_id@p ;
...
position p;
@@
 struct wmi_port_delete_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_eapol_rx_event * cocci_id@p ;
...
position p;
@@
 struct wmi_set_mgmt_retry_limit_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_ft_auth_status_event cocci_id@p ;
...
position p;
@@
 struct wmi_ring_en_event * cocci_id@p ;
...
position p;
@@
 struct cfg80211_inform_bss cocci_id@p ;
...
position p;
@@
 struct blink_on_off_time cocci_id@p [ ] ;
...
position p;
@@
 enum wmi_ps_profile_type cocci_id@p ;
...
position p;
@@
 struct wmi_set_pcp_channel_cmd cocci_id@p ;
