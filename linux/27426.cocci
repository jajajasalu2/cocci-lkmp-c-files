...
position p;
@@
 struct vmcoredd_header * cocci_id@p ;
...
position p;
@@
 struct vmcoredd_node * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ EI_NIDENT ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long pfn ) ;
