...
position p;
@@
 struct cx22702_state cocci_id@p ;
...
typedef u8;
@@
 struct cx22702_state {  struct i2c_adapter * i2c ;  const struct cx22702_config * config ;  struct dvb_frontend frontend ;  u8 prevUCBlocks ; } cocci_id@p ;
