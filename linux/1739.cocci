...
position p;
@@
 struct inv_mpu6050_platform_data * cocci_id@p ;
...
position p;
@@
 const struct inv_mpu6050_hw cocci_id@p [ ] ;
...
position p;
@@
 struct inv_mpu6050_chip_config cocci_id@p ;
...
position p;
@@
 struct inv_mpu6050_state * cocci_id@p ;
...
position p;
@@
 const struct inv_mpu6050_reg_map cocci_id@p ;
...
position p;
@@
 enum inv_mpu6050_filter_e cocci_id@p ;
...
position p;
@@
 const struct inv_mpu6050_chip_config cocci_id@p ;
