...
typedef u8,u16;
@@
 struct munit {  u16 did ;  u16 devfn [ SKX_NUM_IMC ] ;  u8 busidx ;  u8 per_socket ;  enum munittype mtype ; } cocci_id@p ;
...
position p;
@@
 struct decoded_addr * cocci_id@p ;
...
position p;
@@
 enum munittype { CHAN0 , CHAN1 , CHAN2 , SAD_ALL , UTIL_ALL , SAD , ERRCHAN0 , ERRCHAN1 , ERRCHAN2 , } cocci_id@p ;
