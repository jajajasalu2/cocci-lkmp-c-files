...
position p;
@@
 struct omap3_scratchpad_sdrc_block cocci_id@p ;
...
position p;
@@
 struct omap3_scratchpad_prcm_block cocci_id@p ;
...
typedef s16;
@@
 struct control_init_data {  int index ;  void __iomem * mem ;  s16 offset ; } cocci_id@p ;
...
position p;
@@
 const struct omap_prcm_init_data * cocci_id@p ;
...
typedef u32;
@@
 struct omap3_scratchpad_prcm_block {  u32 prm_contents [ 2 ] ;  u32 cm_contents [ 11 ] ;  u32 prcm_block_size ; } cocci_id@p ;
...
position p;
@@
 struct control_init_data * cocci_id@p ;
...
position p;
@@
 struct omap3_control_regs cocci_id@p ;
...
typedef u32;
@@
 struct omap3_scratchpad {  u32 boot_config_ptr ;  u32 public_restore_ptr ;  u32 secure_ram_restore_ptr ;  u32 sdrc_module_semaphore ;  u32 prcm_block_offset ;  u32 sdrc_block_offset ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( am43xx_control_reg_offsets ) ] ;
...
position p;
@@
 struct omap3_scratchpad cocci_id@p ;
...
position p;
@@
 const struct control_init_data cocci_id@p ;
