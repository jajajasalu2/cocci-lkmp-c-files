...
position p;
@@
 struct atmel_uart_port cocci_id@p [ ATMEL_MAX_UART ] ;
...
position p;
@@
 struct atmel_uart_port cocci_id@p ;
...
position p;
@@
 struct atmel_dma_buffer * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct atmel_dma_buffer {  unsigned char * buf ;  dma_addr_t dma_addr ;  unsigned int dma_size ;  unsigned int ofs ; } cocci_id@p ;
...
typedef u16;
@@
 struct atmel_uart_char {  u16 status ;  u16 ch ; } cocci_id@p ;
...
position p;
@@
 struct atmel_uart_char * cocci_id@p ;
