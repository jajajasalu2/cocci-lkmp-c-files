...
position p;
@@
 struct bnx2x_rss_config_obj * cocci_id@p ;
...
position p;
@@
 struct eth_rss_update_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct eth_filter_rules_cmd * cocci_id@p ;
...
position p;
@@
 struct bnx2x_vlan_mac_registry_elem * cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_mac_elem cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ BNX2X_MCAST_VEC_SZ ] ;
...
position p;
@@
 union bnx2x_mcast_config_data cocci_id@p ;
...
position p;
@@
 struct eth_multicast_rules_ramrod_data * cocci_id@p ;
...
position p;
@@
 union bnx2x_classification_ramrod_data * cocci_id@p ;
...
position p;
@@
 union bnx2x_qable_obj * cocci_id@p ;
...
position p;
@@
 union eth_classify_rule_cmd * cocci_id@p ;
...
position p;
@@
 struct bnx2x_exeq_elem * cocci_id@p ;
...
position p;
@@
 struct mac_configuration_entry * cocci_id@p ;
...
position p;
@@
 enum bnx2x_func_cmd cocci_id@p ;
...
position p;
@@
 union bnx2x_mcast_elem {  struct bnx2x_mcast_bin_elem bin_elem ;  struct bnx2x_mcast_mac_elem mac_elem ; } cocci_id@p ;
...
position p;
@@
 const struct bnx2x_func_sp_drv_ops * cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_bin_elem * cocci_id@p ;
...
position p;
@@
 struct set_timesync_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct tx_queue_init_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct client_init_rx_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_rx_mode_obj * cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_elem_group cocci_id@p ;
...
position p;
@@
 struct eth_filter_rules_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_start_params * cocci_id@p ;
...
position p;
@@
 enum bnx2x_func_state cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_obj * cocci_id@p ;
...
position p;
@@
 struct function_start_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_pending_mcast_cmd cocci_id@p ;
...
position p;
@@
 struct eth_classify_rules_ramrod_data * cocci_id@p ;
...
typedef bool,u32;
@@
 struct bnx2x_pending_mcast_cmd {  struct list_head link ;  struct list_head group_head ;  int type ;  union {  struct list_head macs_head ;  u32 macs_num ;  int next_bin ; } data ;  bool set_convert ;  bool done ; } cocci_id@p ;
...
position p;
@@
 struct flow_control_configuration * cocci_id@p ;
...
position p;
@@
 struct client_init_tx_data * cocci_id@p ;
...
position p;
@@
 struct client_init_general_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_credit_pool_obj * cocci_id@p ;
...
position p;
@@
 struct bnx2x_vlan_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct afex_vif_list_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_mac_ramrod_data * cocci_id@p ;
...
typedef u8;
@@
 struct bnx2x_mcast_mac_elem {  struct list_head link ;  u8 mac [ ETH_ALEN ] ;  u8 pad [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct bnx2x_config_rss_params * cocci_id@p ;
...
position p;
@@
 struct bnx2x_vlan_mac_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct mac_configuration_cmd * cocci_id@p ;
...
position p;
@@
 struct client_update_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_func_tx_start_params * cocci_id@p ;
...
position p;
@@
 struct bnx2x_exe_queue_obj * cocci_id@p ;
...
position p;
@@
 struct tpa_update_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_bin_elem {  struct list_head link ;  int bin ;  int type ; } cocci_id@p ;
...
position p;
@@
 struct eth_classify_cmd_header * cocci_id@p ;
...
position p;
@@
 struct tstorm_eth_mac_filter_config * cocci_id@p ;
...
position p;
@@
 struct bnx2x_queue_update_tpa_params * cocci_id@p ;
...
position p;
@@
 enum bnx2x_vlan_mac_cmd cocci_id@p ;
...
position p;
@@
 union bnx2x_mcast_elem cocci_id@p ;
...
position p;
@@
 enum bnx2x_mcast_cmd cocci_id@p ;
...
position p;
@@
 struct function_update_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_mcast_elem_group {  struct list_head mcast_group_link ;  union bnx2x_mcast_elem mcast_elems [ ] ; } cocci_id@p ;
...
position p;
@@
 struct client_init_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct mac_configuration_hdr * cocci_id@p ;
...
position p;
@@
 struct eth_classify_header * cocci_id@p ;
