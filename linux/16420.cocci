...
position p;
@@
 void ( * cocci_id@p ) ( void * unused , const char * format , ... ) ;
...
position p;
@@
 struct hostif_msg_to_sensor cocci_id@p ;
...
position p;
@@
 struct ishtp_hid_data * cocci_id@p ;
...
position p;
@@
 struct hostif_msg_hdr cocci_id@p ;
