...
position p;
@@
 struct tegra_nand_chip cocci_id@p ;
...
position p;
@@
 struct tegra_nand_controller * cocci_id@p ;
...
typedef bool;
@@
 struct tegra_nand_controller {  struct nand_controller controller ;  struct device * dev ;  void __iomem * regs ;  int irq ;  struct clk * clk ;  struct completion command_complete ;  struct completion dma_complete ;  bool last_read_error ;  int cur_cs ;  struct nand_chip * chip ; } cocci_id@p ;
...
typedef u32;
@@
 struct tegra_nand_chip {  struct nand_chip chip ;  struct gpio_desc * wp_gpio ;  struct mtd_oob_region ecc ;  u32 config ;  u32 config_ecc ;  u32 bch_config ;  int cs [ 1 ] ; } cocci_id@p ;
