...
position p;
@@
 enum sctp_event_timeout cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sctp_timer_event_t;
@@
 sctp_timer_event_t * cocci_id@p [ SCTP_NUM_TIMEOUT_TYPES ] ;
...
position p;
@@
 const char * cocci_id@p ( union sctp_subtype ) ;
