...
position p;
@@
 void ( * cocci_id@p ) ( struct intf_hdl * pintf_hdl ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct intf_priv * pintfpriv ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct _io_ops * pops ) ;
...
typedef uint;
@@
 uint ( * cocci_id@p ) ( struct intf_priv * pintfpriv ) ;
