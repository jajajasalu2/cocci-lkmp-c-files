...
position p;
@@
 unsigned char cocci_id@p [ SHTC1_RESPONSE_LENGTH ] ;
...
position p;
@@
 struct shtc1_platform_data * cocci_id@p ;
...
position p;
@@
 enum shtcx_chips { shtc1 , shtc3 , } cocci_id@p ;
...
typedef bool;
@@
 struct shtc1_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  const unsigned char * command ;  unsigned int nonblocking_wait_time ;  struct shtc1_platform_data setup ;  enum shtcx_chips chip ;  int temperature ;  int humidity ; } cocci_id@p ;
