...
position p;
@@
 struct alc5623_priv * cocci_id@p ;
...
typedef u8;
@@
 struct alc5623_priv {  struct regmap * regmap ;  u8 id ;  unsigned int sysclk ;  unsigned int add_ctrl ;  unsigned int jack_det_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct alc5623_platform_data * cocci_id@p ;
...
position p;
@@
 const struct _pll_div cocci_id@p [ ] ;
...
typedef u16;
@@
 struct _coeff_div {  u16 fs ;  u16 regvalue ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct _pll_div {  u32 pll_in ;  u32 pll_out ;  u16 regvalue ; } cocci_id@p ;
