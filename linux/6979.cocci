...
typedef bool,u32;
@@
 struct cmdq_thread {  struct mbox_chan * chan ;  void __iomem * base ;  struct list_head task_busy_list ;  u32 priority ;  bool atomic_exec ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct cmdq_task {  struct cmdq * cmdq ;  struct list_head list_entry ;  dma_addr_t pa_base ;  struct cmdq_thread * thread ;  struct cmdq_pkt * pkt ; } cocci_id@p ;
...
position p;
@@
 struct cmdq_cb_data cocci_id@p ;
...
typedef bool,u32;
@@
 struct cmdq {  struct mbox_controller mbox ;  void __iomem * base ;  u32 irq ;  u32 thread_nr ;  u32 irq_mask ;  struct cmdq_thread * thread ;  struct clk * clock ;  bool suspended ; } cocci_id@p ;
...
position p;
@@
 enum cmdq_cb_status cocci_id@p ;
...
position p;
@@
 struct cmdq_task_cb * cocci_id@p ;
...
position p;
@@
 cmdq_async_flush_cb cocci_id@p ;
