...
position p;
@@
 void cocci_id@p ( struct nsim_bus_dev * nsim_bus_dev ) ;
...
position p;
@@
 struct nsim_vf_config cocci_id@p ;
...
position p;
@@
 struct nsim_bus_dev * cocci_id@p ( unsigned int id , unsigned int port_count ) ;
