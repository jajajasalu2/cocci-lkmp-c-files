...
position p;
@@
 const struct stm32_iwdg_data cocci_id@p ;
...
position p;
@@
 struct stm32_iwdg {  struct watchdog_device wdd ;  const struct stm32_iwdg_data * data ;  void __iomem * regs ;  struct clk * clk_lsi ;  struct clk * clk_pclk ;  unsigned int rate ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct stm32_iwdg_data {  bool has_pclk ;  u32 max_prescaler ; } cocci_id@p ;
