...
@@
 struct sigframe {  u32 sf_ass [ 4 ] ;  u32 sf_pad [ 2 ] ;  struct sigcontext sf_sc ;  sigset_t sf_mask ;  unsigned long long sf_extcontext [ 0 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct rt_sigframe {  u32 rs_ass [ 4 ] ;  u32 rs_pad [ 2 ] ;  struct siginfo rs_info ;  struct ucontext rs_uc ; } cocci_id@p ;
...
position p;
@@
 struct msa_extcontext cocci_id@p ;
