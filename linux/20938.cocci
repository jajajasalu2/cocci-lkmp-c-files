...
position p;
@@
 const struct chan_ops cocci_id@p ;
...
position p;
@@
 struct port_pre_exec_data cocci_id@p ;
...
position p;
@@
 struct port_chan {  int raw ;  struct termios tt ;  void * kernel_data ;  char dev [ sizeof ( "32768\0" ) ] ; } cocci_id@p ;
...
position p;
@@
 struct port_pre_exec_data {  int sock_fd ;  int pipe_fd ; } cocci_id@p ;
