...
typedef spinlock_t;
@@
 struct jz4740_rtc {  void __iomem * base ;  enum jz4740_rtc_type type ;  struct rtc_device * rtc ;  struct clk * clk ;  int irq ;  spinlock_t lock ;  unsigned int min_wakeup_pin_assert_time ;  unsigned int reset_pin_assert_time ; } cocci_id@p ;
...
position p;
@@
 enum jz4740_rtc_type cocci_id@p ;
...
position p;
@@
 enum jz4740_rtc_type { ID_JZ4740 , ID_JZ4780 , } cocci_id@p ;
