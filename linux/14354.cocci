...
typedef u8,u32;
@@
 struct stv6110_priv {  int i2c_address ;  struct i2c_adapter * i2c ;  u32 mclk ;  u8 clk_div ;  u8 gain ;  u8 regs [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 const struct stv6110_config * cocci_id@p ;
...
position p;
@@
 struct stv6110_priv cocci_id@p ;
