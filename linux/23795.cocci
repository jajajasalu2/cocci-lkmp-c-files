...
position p;
@@
 struct teql_sched_data cocci_id@p ;
...
position p;
@@
 struct teql_sched_data {  struct Qdisc * next ;  struct teql_master * m ;  struct sk_buff_head q ; } cocci_id@p ;
...
position p;
@@
 struct teql_master {  struct Qdisc_ops qops ;  struct net_device * dev ;  struct Qdisc * slaves ;  struct list_head master_list ;  unsigned long tx_bytes ;  unsigned long tx_packets ;  unsigned long tx_errors ;  unsigned long tx_dropped ; } cocci_id@p ;
