...
symbol cocci_id;
position p;
typedef wait_queue_head_t,spinlock_t,dma_addr_t;
@@
 struct pxa3xx_gcu_priv {  struct device * dev ;  void __iomem * mmio_base ;  struct clk * clk ;  struct pxa3xx_gcu_shared * shared ;  dma_addr_t shared_phys ;  struct resource * resource_mem ;  struct miscdevice misc_dev ;  wait_queue_head_t wait_idle ;  wait_queue_head_t wait_free ;  spinlock_t spinlock ;  struct timespec64 base_time ;  struct pxa3xx_gcu_batch * free ;  struct pxa3xx_gcu_batch * ready ;  struct pxa3xx_gcu_batch * ready_last ;  struct pxa3xx_gcu_batch * running ; } cocci_id@p ;
...
position p;
@@
 struct pxa3xx_gcu_priv cocci_id@p ;
...
position p;
@@
 struct pxa3xx_gcu_shared * cocci_id@p ;
...
@@
 struct pxa3xx_gcu_batch {  struct pxa3xx_gcu_batch * next ;  u32 * ptr ;  dma_addr_t phys ;  unsigned long length ; } cocci_id@p ;
...
position p;
@@
 struct pxa3xx_gcu_batch * cocci_id@p ;
