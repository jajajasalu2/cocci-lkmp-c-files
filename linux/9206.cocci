...
position p;
@@
 struct dprtc_rsp_get_irq_status * cocci_id@p ;
...
position p;
@@
 struct dprtc_cmd_set_irq_mask * cocci_id@p ;
...
position p;
@@
 struct dprtc_cmd_open * cocci_id@p ;
...
position p;
@@
 struct dprtc_cmd_get_irq_status * cocci_id@p ;
...
position p;
@@
 struct dprtc_cmd_set_irq_enable * cocci_id@p ;
...
position p;
@@
 struct dprtc_cmd_clear_irq_status * cocci_id@p ;
...
position p;
@@
 struct dprtc_rsp_get_irq_mask * cocci_id@p ;
...
position p;
@@
 struct dprtc_rsp_get_irq_enable * cocci_id@p ;
...
position p;
@@
 struct dprtc_cmd_get_irq * cocci_id@p ;
