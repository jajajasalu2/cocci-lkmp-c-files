...
position p;
@@
 const struct pci_dev_acs_enabled * cocci_id@p ;
...
position p;
@@
 const struct pci_dev_reset_methods * cocci_id@p ;
...
position p;
@@
 enum pci_fixup_pass cocci_id@p ;
...
typedef u16;
@@
 const struct pci_dev_acs_ops {  u16 vendor ;  u16 device ;  int ( * enable_acs ) ( struct pci_dev * dev ) ;  int ( * disable_acs_redir ) ( struct pci_dev * dev ) ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 const struct pci_dev_acs_enabled {  u16 vendor ;  u16 device ;  int ( * acs_enabled ) ( struct pci_dev * dev , u16 acs_flags ) ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct pci_dev_acs_ops * cocci_id@p ;
