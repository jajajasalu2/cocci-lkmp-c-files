...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * shost ) ;
...
@@
 void cocci_id@p ( scsi_qla_host_t * ) ;
...
position p;
@@
 struct fxdisc_entry_fx00 cocci_id@p ;
...
position p;
@@
 struct verify_chip_entry_84xx cocci_id@p ;
...
position p;
@@
 struct qla_flt_header cocci_id@p ;
...
position p;
@@
 struct ct_entry_24xx cocci_id@p ;
...
position p;
@@
 struct mid_init_cb_81xx cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * host , struct scsi_cmnd * cmd , struct qla_qpair * qpair ) ;
...
position p;
@@
 enum nexus_wait_type cocci_id@p ;
...
position p;
@@
 struct vf_evfp_entry_24xx cocci_id@p ;
...
position p;
@@
 struct pt_ls4_request cocci_id@p ;
...
position p;
@@
 struct blk_mq_queue_map * cocci_id@p ;
...
position p;
@@
 struct access_chip_84xx cocci_id@p ;
...
position p;
@@
 struct cmd_type_crc_2 cocci_id@p ;
...
position p;
@@
 struct cmd_type_7_fx00 cocci_id@p ;
...
position p;
@@
 struct qla_npiv_entry cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qla_hw_data * ) ;
...
position p;
@@
 struct els_entry_24xx cocci_id@p ;
