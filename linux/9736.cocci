...
position p;
@@
 struct iwl_nvm_access_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mcc_chub_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_mcc_update_resp_v3 * cocci_id@p ;
...
position p;
@@
 struct iwl_nvm_access_resp * cocci_id@p ;
...
position p;
@@
 struct iwl_mcc_update_cmd cocci_id@p ;
...
position p;
@@
 enum { READ_NVM_CHUNK_SUCCEED = 0 , READ_NVM_CHUNK_NOT_VALID_ADDRESS = 1 , } cocci_id@p ;
