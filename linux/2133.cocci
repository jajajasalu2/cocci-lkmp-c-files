...
position p;
@@
 struct power_supply_hwmon * cocci_id@p ;
...
position p;
@@
 const struct power_supply_hwmon * cocci_id@p ;
...
position p;
@@
 struct power_supply_hwmon {  struct power_supply * psy ;  unsigned long * props ; } cocci_id@p ;
