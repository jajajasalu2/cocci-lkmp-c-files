...
position p;
@@
 enum max77686_ramp_rate { RAMP_RATE_13P75MV , RAMP_RATE_27P5MV , RAMP_RATE_55MV , RAMP_RATE_NO_CTRL , } cocci_id@p ;
...
position p;
@@
 struct max77686_data * cocci_id@p ;
...
position p;
@@
 struct max77686_dev * cocci_id@p ;
...
position p;
@@
 struct max77686_data {  struct device * dev ; 
	 DECLARE_BITMAP ( gpio_enabled , MAX77686_REGULATORS ) 
		 ;  unsigned int opmode [ MAX77686_REGULATORS ] ; } cocci_id@p ;
