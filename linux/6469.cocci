...
position p;
@@
 const struct lp8755_mphase cocci_id@p [ MPHASE_CONF_MAX ] ;
...
position p;
@@
 struct lp8755_chip {  struct device * dev ;  struct regmap * regmap ;  struct lp8755_platform_data * pdata ;  int irq ;  unsigned int irqmask ;  int mphase ;  struct regulator_dev * rdev [ LP8755_BUCK_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct lp8755_platform_data * cocci_id@p ;
...
position p;
@@
 struct regulator_init_data cocci_id@p [ LP8755_BUCK_MAX ] ;
...
position p;
@@
 struct lp8755_mphase {  int nreg ;  int buck_num [ LP8755_BUCK_MAX ] ; } cocci_id@p ;
