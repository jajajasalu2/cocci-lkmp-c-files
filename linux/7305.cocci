...
position p;
@@
 struct lms283gf05_state cocci_id@p ;
...
position p;
@@
 struct lms283gf05_state {  struct spi_device * spi ;  struct lcd_device * ld ; } cocci_id@p ;
...
position p;
@@
 struct lms283gf05_pdata * cocci_id@p ;
...
position p;
@@
 const struct lms283gf05_seq cocci_id@p [ ] ;
...
position p;
@@
 struct lms283gf05_seq {  unsigned char reg ;  unsigned short value ;  unsigned char delay ; } cocci_id@p ;
