...
typedef bool;
@@
 int cocci_id@p ( struct radeon_device * rdev , bool gate ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct radeon_device * rdev , u32 max_voltage_steps , struct atom_voltage_table * voltage_table ) ;
...
position p;
@@
 struct ci_mc_reg_table * cocci_id@p ;
...
position p;
@@
 SMU7_Discrete_MCArbDramTimingTableEntry * cocci_id@p ;
...
position p;
@@
 SMU7_Discrete_MCRegisters cocci_id@p ;
...
position p;
@@
 SMU7_Discrete_MCRegisterSet * cocci_id@p ;
...
position p;
@@
 struct ci_dpm_table * cocci_id@p ;
...
position p;
@@
 const struct ci_pt_config_reg * cocci_id@p ;
...
position p;
@@
 SMU7_Discrete_MemoryLevel * cocci_id@p ;
...
position p;
@@
 PPSMC_Result cocci_id@p ( struct radeon_device * rdev , PPSMC_Msg msg ) ;
...
position p;
@@
 const struct ci_mc_reg_entry * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct radeon_device * rdev , u32 arb_freq_src , u32 arb_freq_dest ) ;
...
position p;
@@
 struct ci_single_dpm_table * cocci_id@p ;
...
position p;
@@
 struct radeon_cac_tdp_table * cocci_id@p ;
...
position p;
@@
 struct ci_power_info cocci_id@p ;
...
position p;
@@
 struct ci_vbios_boot_state * cocci_id@p ;
...
position p;
@@
 SMU7_Discrete_DpmTable * cocci_id@p ;
...
position p;
@@
 SMU7_Discrete_MCArbDramTimingTable cocci_id@p ;
...
typedef u8,u32;
@@
 u8 cocci_id@p ( u32 memory_clock ) ;
...
typedef u32;
@@
 PPSMC_Result cocci_id@p ( struct radeon_device * rdev , PPSMC_Msg msg , u32 parameter ) ;
...
typedef bool,u32;
@@
 void cocci_id@p ( struct radeon_device * rdev , u32 block , bool enable ) ;
...
position p;
@@
 SMU7_Discrete_GraphicsLevel cocci_id@p ;
...
position p;
@@
 struct radeon_phase_shedding_limits_table * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 u8 cocci_id@p ( u32 memory_clock , bool strobe_mode ) ;
...
position p;
@@
 SMU7_Discrete_VoltageLevel * cocci_id@p ;
...
position p;
@@
 const struct ci_pt_defaults * cocci_id@p ;
...
position p;
@@
 struct radeon_uvd_clock_voltage_dependency_table * cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct radeon_device * rdev , struct atom_voltage_table_entry * voltage_table , u16 * std_voltage_hi_sidd , u16 * std_voltage_lo_sidd ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct radeon_device * rdev , u32 n ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct radeon_device * rdev , u32 target_tdp ) ;
...
position p;
@@
 struct ci_leakage_voltage * cocci_id@p ;
...
position p;
@@
 const struct radeon_clock_and_voltage_limits * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p ( struct radeon_device * rdev ) ;
...
position p;
@@
 SMU7_Discrete_FanTable cocci_id@p ;
...
position p;
@@
 const struct atom_mc_reg_table * cocci_id@p ;
...
position p;
@@
 struct atom_voltage_table_entry * cocci_id@p ;
