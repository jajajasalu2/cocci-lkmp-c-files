...
typedef u32;
@@
 struct nft_secmark {  u32 secid ;  char * ctx ; } cocci_id@p ;
...
position p;
@@
 struct nft_offload_reg * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_META_MAX + 1 ] ;
...
position p;
@@
 const struct nft_meta * cocci_id@p ;
...
position p;
@@
 struct nft_offload_ctx * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_SECMARK_MAX + 1 ] ;
...
position p;
@@
 const struct nft_secmark * cocci_id@p ;
