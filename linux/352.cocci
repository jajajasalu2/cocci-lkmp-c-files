...
symbol cocci_id;
position p;
typedef __u32,arch_spinlock_t;
@@
 union {  __u32 val ;  arch_spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 bpf_get_current_uid_gid cocci_id@p ;
...
position p;
@@
 bpf_get_numa_node_id cocci_id@p ;
...
position p;
@@
 bpf_get_smp_processor_id cocci_id@p ;
...
position p;
@@
 bpf_get_current_pid_tgid cocci_id@p ;
...
position p;
@@
 bpf_get_current_cgroup_id cocci_id@p ;
