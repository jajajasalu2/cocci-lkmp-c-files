...
position p;
@@
 struct uncached_pool cocci_id@p [ MAX_NUMNODES ] ;
...
typedef atomic_t;
@@
 struct uncached_pool {  struct gen_pool * pool ;  struct mutex add_chunk_mutex ;  int nchunks_added ;  atomic_t status ; } cocci_id@p ;
...
position p;
@@
 struct uncached_pool * cocci_id@p ;
