...
symbol cocci_id;
position p;
typedef bool,pgprotval_t,pgprot_t;
@@
 struct pg_state {  int level ;  pgprot_t current_prot ;  pgprotval_t effective_prot ;  unsigned long start_address ;  unsigned long current_address ;  const struct addr_marker * marker ;  unsigned long lines ;  bool to_dmesg ;  bool check_wx ;  unsigned long wx_pages ; } cocci_id@p ;
...
position p;
@@
 struct addr_marker {  unsigned long start_address ;  const char * name ;  unsigned long max_lines ; } cocci_id@p ;
