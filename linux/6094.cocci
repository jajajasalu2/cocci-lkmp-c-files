...
position p;
@@
 enum buf_end_align_type { SAME_PAGE_UNALIGNED = 0 , SAME_PAGE_ALIGNED , NEXT_PAGE_UNALIGNED , NEXT_PAGE_ALIGNED , NEXT_NEXT_UNALIGNED , LOOP_END , } cocci_id@p ;
...
position p;
@@
 struct binder_buffer * cocci_id@p [ BUFFER_NUM ] ;
