...
position p;
@@
 const struct mips_cdmm_device_id cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef bool,raw_spinlock_t;
@@
 struct mips_ejtag_fdc_console {  struct console cons ;  struct tty_driver * tty_drv ;  raw_spinlock_t lock ;  bool initialised ;  void __iomem * regs [ NR_CPUS ] ; } cocci_id@p ;
...
position p;
@@
 struct mips_cdmm_device * cocci_id@p ;
...
typedef u32;
@@
 struct fdc_word {  u32 word ;  unsigned int bytes ; } cocci_id@p ;
...
@@
 struct mips_ejtag_fdc_tty_port {  struct tty_port port ;  struct mips_ejtag_fdc_tty * driver ;  raw_spinlock_t rx_lock ;  void * rx_buf ;  spinlock_t xmit_lock ;  unsigned int xmit_cnt ;  unsigned int xmit_head ;  unsigned int xmit_tail ;  struct completion xmit_empty ; } cocci_id@p ;
...
position p;
@@
 struct mips_ejtag_fdc_console cocci_id@p ;
...
position p;
@@
 struct mips_cdmm_driver cocci_id@p ;
...
position p;
@@
 struct mips_ejtag_fdc_tty_port cocci_id@p ;
...
position p;
@@
 struct mips_ejtag_fdc_tty * cocci_id@p ;
