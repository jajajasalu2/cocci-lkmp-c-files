...
position p;
@@
 struct exynos_sata_phy * cocci_id@p ;
...
position p;
@@
 struct exynos_sata_phy {  struct phy * phy ;  struct clk * phyclk ;  void __iomem * regs ;  struct regmap * pmureg ;  struct i2c_client * client ; } cocci_id@p ;
