...
position p;
@@
 struct arm_lpae_io_pgtable cocci_id@p ;
...
position p;
@@
 struct arm_lpae_io_pgtable {  struct io_pgtable iop ;  int pgd_bits ;  int start_level ;  int bits_per_level ;  void * pgd ; } cocci_id@p ;
