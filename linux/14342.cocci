...
position p;
@@
 struct s5h1411_state cocci_id@p ;
...
typedef u16;
@@
 struct qam256_snr_tab {  u16 val ;  u16 data ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 struct qam64_snr_tab {  u16 val ;  u16 data ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 struct vsb_snr_tab {  u16 val ;  u16 data ; } cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct s5h1411_state {  struct i2c_adapter * i2c ;  const struct s5h1411_config * config ;  struct dvb_frontend frontend ;  enum fe_modulation current_modulation ;  unsigned int first_tune : 1 ;  u32 current_frequency ;  int if_freq ;  u8 inversion ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct init_tab {  u8 addr ;  u8 reg ;  u16 data ; } cocci_id@p [ ] ;
