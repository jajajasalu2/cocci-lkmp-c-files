...
position p;
@@
 struct uio_portio {  struct kobject kobj ;  struct uio_port * port ; } cocci_id@p ;
...
position p;
@@
 struct uio_map {  struct kobject kobj ;  struct uio_mem * mem ; } cocci_id@p ;
...
position p;
@@
 struct portio_sysfs_entry * cocci_id@p ;
...
position p;
@@
 struct map_sysfs_entry * cocci_id@p ;
...
typedef s32;
@@
 struct uio_listener {  struct uio_device * dev ;  s32 event_count ; } cocci_id@p ;
...
position p;
@@
 struct uio_listener * cocci_id@p ;
