...
position p;
@@
 struct icn8318_data {  struct i2c_client * client ;  struct input_dev * input ;  struct gpio_desc * wake_gpio ;  struct touchscreen_properties prop ; } cocci_id@p ;
...
position p;
@@
 struct icn8318_data * cocci_id@p ;
...
position p;
@@
 struct icn8318_touch_data cocci_id@p ;
...
position p;
@@
 struct icn8318_touch * cocci_id@p ;
