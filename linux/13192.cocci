...
position p;
@@
 void cocci_id@p ( struct netup_dma * dma ) ;
...
position p;
@@
 struct netup_unidvb_buffer cocci_id@p ;
...
position p;
@@
 struct ascot2e_config cocci_id@p ;
...
typedef u32;
@@
 struct netup_unidvb_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * priv , int is_dvb_tc ) ;
...
position p;
@@
 struct vb2_dvb_frontend * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct horus3a_config cocci_id@p ;
