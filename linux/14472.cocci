...
position p;
@@
 const struct stratix10_perip_c_clock * cocci_id@p ;
...
position p;
@@
 const struct stratix10_perip_cnt_clock cocci_id@p [ ] ;
...
position p;
@@
 struct stratix10_clock_data * cocci_id@p ;
...
position p;
@@
 const struct stratix10_pll_clock * cocci_id@p ;
...
position p;
@@
 const struct stratix10_gate_clock cocci_id@p [ ] ;
