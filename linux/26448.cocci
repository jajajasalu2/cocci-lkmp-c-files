...
position p;
@@
 unsigned long cocci_id@p [ HASH_SIZE ] ;
...
typedef uint64_t;
@@
 uint64_t cocci_id@p [ MAX_BIT_FILTERS ] ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ PAGEMAP_BATCH ] ;
...
typedef uint64_t;
@@
 uint64_t cocci_id@p [ KPAGEFLAGS_BATCH ] ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_VMAS ] ;
...
typedef uint64_t;
@@
 uint64_t cocci_id@p [ PAGEMAP_BATCH ] ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_ADDR_RANGES ] ;
