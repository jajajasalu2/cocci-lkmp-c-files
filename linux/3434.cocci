...
position p;
@@
 struct smu_sdbp_cpudiode * cocci_id@p ;
...
typedef u32;
@@
 struct smu_ad_sensor {  struct list_head link ;  u32 reg ;  struct wf_sensor sens ; } cocci_id@p ;
...
position p;
@@
 struct smu_sdbp_cpuvcp * cocci_id@p ;
...
position p;
@@
 struct smu_ad_sensor * cocci_id@p ;
...
position p;
@@
 struct smu_cpu_power_sensor cocci_id@p ;
...
position p;
@@
 struct smu_cpu_power_sensor {  struct list_head link ;  struct wf_sensor * volts ;  struct wf_sensor * amps ;  int fake_volts : 1 ;  int quadratic : 1 ;  struct wf_sensor sens ; } cocci_id@p ;
...
position p;
@@
 struct smu_sdbp_slotspow * cocci_id@p ;
