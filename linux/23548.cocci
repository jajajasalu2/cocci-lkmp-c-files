...
position p;
@@
 struct snd_sst_stream_params cocci_id@p ;
...
position p;
@@
 struct snd_sst_params cocci_id@p ;
...
position p;
@@
 struct pcm_stream_info * cocci_id@p ;
...
position p;
@@
 struct sst_dev_stream_map * cocci_id@p ;
...
position p;
@@
 struct sst_runtime_stream * cocci_id@p ;
...
position p;
@@
 const struct sst_data * cocci_id@p ;
...
position p;
@@
 struct snd_sst_alloc_params_ext cocci_id@p ;
...
position p;
@@
 struct sst_platform_data * cocci_id@p ;
