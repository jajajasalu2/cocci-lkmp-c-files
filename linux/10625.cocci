...
position p;
@@
 struct execlist_context_status_format * cocci_id@p ;
...
position p;
@@
 struct execlist_ctx_descriptor_format cocci_id@p [ 2 ] ;
...
position p;
@@
 struct execlist_status_format cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_execlist_slot * cocci_id@p ;
...
position p;
@@
 struct execlist_context_status_pointer_format cocci_id@p ;
