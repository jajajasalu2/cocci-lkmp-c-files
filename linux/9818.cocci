...
position p;
@@
 const struct ath5k_ini_rfgain * cocci_id@p ;
...
typedef s16;
@@
 s16 cocci_id@p [ ATH5K_NF_CAL_HIST_MAX ] ;
...
position p;
@@
 struct ath5k_rate_pcal_info cocci_id@p ;
...
position p;
@@
 const struct ath5k_ini_rfbuffer * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ AR5K_EEPROM_N_PD_GAINS ] ;
...
position p;
@@
 const struct ath5k_gain_opt * cocci_id@p ;
...
typedef s16;
@@
 s16 cocci_id@p [ AR5K_EEPROM_N_PD_GAINS ] ;
...
position p;
@@
 const struct ath5k_rf_reg * cocci_id@p ;
...
position p;
@@
 struct ath5k_athchan_2ghz cocci_id@p ;
...
position p;
@@
 struct ath5k_eeprom_info * cocci_id@p ;
...
position p;
@@
 const struct ath5k_gain_opt_step * cocci_id@p ;
...
position p;
@@
 struct ath5k_chan_pcal_info * * cocci_id@p ;
...
position p;
@@
 struct ath5k_edge_power * cocci_id@p ;
...
position p;
@@
 struct ath5k_pdgain_info * cocci_id@p ;
...
position p;
@@
 struct ath5k_nfcal_hist * cocci_id@p ;
