...
position p;
@@
 struct sched_domain_topology_level cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( const struct cpumask * cpu_map ) ;
...
position p;
@@
 enum numa_topology_type cocci_id@p ;
...
position p;
@@
 enum s_alloc { sa_rootdomain , sa_sd , sa_sd_storage , sa_none , } cocci_id@p ;
...
position p;
@@
 struct cpufreq_governor cocci_id@p ;
...
position p;
@@
 struct em_perf_domain * cocci_id@p ;
...
position p;
@@
 struct s_data {  struct sched_domain * __percpu * sd ;  struct root_domain * rd ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct cpumask * cpu_map ) ;
