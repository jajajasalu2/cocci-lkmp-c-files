...
position p;
@@
 const struct ucsi_operations cocci_id@p ;
...
position p;
@@
 enum enum_flash_mode * cocci_id@p ;
...
position p;
@@
 enum enum_fw_mode { BOOT , FW1 , FW2 , FW_INVALID , } cocci_id@p ;
...
position p;
@@
 struct fw_config_table * cocci_id@p ;
...
position p;
@@
 const struct i2c_adapter_quirks * cocci_id@p ;
...
typedef u32,u16;
@@
 struct ccg_cmd {  u16 reg ;  u32 data ;  int len ;  u32 delay ; } cocci_id@p ;
...
position p;
@@
 struct version_info cocci_id@p [ 3 ] ;
...
position p;
@@
 struct version_info {  struct version_format base ;  struct version_format app ; } cocci_id@p ;
...
position p;
@@
 struct version_format * cocci_id@p ;
...
typedef u8;
@@
 struct ccg_resp {  u8 code ;  u8 length ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct fw_config_table {  u32 identity ;  u16 table_size ;  u8 fwct_version ;  u8 is_key_change ;  u8 guid [ 16 ] ;  struct version_format base ;  struct version_format app ;  u8 primary_fw_digest [ 32 ] ;  u32 key_exp_length ;  u8 key_modulus [ 256 ] ;  u8 key_exp [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 enum enum_flash_mode { SECONDARY_BL , PRIMARY , SECONDARY , FLASH_NOT_NEEDED , FLASH_INVALID , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ FW_CFG_TABLE_SIG_SIZE ] ;
...
position p;
@@
 struct version_info cocci_id@p ;
...
position p;
@@
 enum ccg_resp_code { CMD_NO_RESP = 0x00 , CMD_SUCCESS = 0x02 , FLASH_DATA_AVAILABLE = 0x03 , CMD_INVALID = 0x05 , FLASH_UPDATE_FAIL = 0x07 , INVALID_FW = 0x08 , INVALID_ARG = 0x09 , CMD_NOT_SUPPORT = 0x0A , TRANSACTION_FAIL = 0x0C , PD_CMD_FAIL = 0x0D , UNDEF_ERROR = 0x0F , INVALID_RESP = 0x10 , } cocci_id@p ;
