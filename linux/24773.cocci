...
position p;
@@
 const struct nf_flow_route * cocci_id@p ;
...
position p;
@@
 struct flow_offload_tuple * cocci_id@p ;
...
position p;
@@
 struct flow_offload_tuple_rhash * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct flow_offload * flow , void * data ) ;
...
position p;
@@
 const struct flow_offload_tuple_rhash * cocci_id@p ;
