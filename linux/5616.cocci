...
typedef spinlock_t;
@@
 struct m48t35_priv {  struct rtc_device * rtc ;  struct m48t35_rtc __iomem * reg ;  size_t size ;  unsigned long baseaddr ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u8;
@@
 struct m48t35_rtc {  u8 pad [ 0x7ff8 ] ;  u8 control ;  u8 sec ;  u8 min ;  u8 hour ;  u8 day ;  u8 date ;  u8 month ;  u8 year ; } cocci_id@p ;
