...
position p;
@@
 struct skb_work_list * cocci_id@p ;
...
position p;
@@
 struct qedi_portid_tbl * cocci_id@p ;
...
position p;
@@
 struct qedi_boot_target * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qedi_ctx * qedi ) ;
...
position p;
@@
 struct nvm_iscsi_block * cocci_id@p ( struct qedi_ctx * qedi ) ;
...
position p;
@@
 struct qedi_itt_map cocci_id@p ;
...
position p;
@@
 struct qedi_fastpath cocci_id@p ;
...
position p;
@@
 struct qedi_nvm_iscsi_image cocci_id@p ;
...
position p;
@@
 struct qedi_percpu_s * cocci_id@p ;
...
position p;
@@
 struct nvm_iscsi_initiator * cocci_id@p ;
...
position p;
@@
 struct qedi_uio_dev * cocci_id@p ;
...
position p;
@@
 struct qedi_uio_ctrl * cocci_id@p ;
...
position p;
@@
 struct iscsi_eqe_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qedi_ctx * qedi ) ;
...
position p;
@@
 struct nvm_iscsi_block * cocci_id@p ;
...
typedef u32;
@@
 struct qedi_cmd * cocci_id@p ( struct qedi_ctx * qedi , u32 tid ) ;
...
position p;
@@
 struct qedi_glbl_q_params cocci_id@p ;
...
position p;
@@
 struct qed_mfw_tlv_iscsi * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qedi_uio_dev * udev ) ;
