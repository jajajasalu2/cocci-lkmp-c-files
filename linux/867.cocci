...
position p;
@@
 struct txx9ndfmc_priv {  struct platform_device * dev ;  struct nand_chip chip ;  int cs ;  const char * mtdname ; } cocci_id@p ;
...
position p;
@@
 struct txx9ndfmc_priv cocci_id@p ;
...
position p;
@@
 struct txx9ndfmc_platform_data * cocci_id@p ;
...
position p;
@@
 struct txx9ndfmc_drvdata * cocci_id@p ;
...
position p;
@@
 struct txx9ndfmc_drvdata {  struct mtd_info * mtds [ MAX_TXX9NDFMC_DEV ] ;  void __iomem * base ;  unsigned char hold ;  unsigned char spw ;  struct nand_controller controller ; } cocci_id@p ;
