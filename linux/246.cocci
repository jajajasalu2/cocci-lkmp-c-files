...
position p;
@@
 enum { TRACE_SELFTEST_REGS_START , TRACE_SELFTEST_REGS_FOUND , TRACE_SELFTEST_REGS_NOT_FOUND , } cocci_id@p ;
...
position p;
@@
 struct wakeup_test_data {  struct completion is_ready ;  int go ; } cocci_id@p ;
...
position p;
@@
 struct wakeup_test_data cocci_id@p ;
