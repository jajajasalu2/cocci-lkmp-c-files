...
position p;
@@
 struct scpi_pm_domain cocci_id@p ;
...
typedef u32;
@@
 struct scpi_pm_domain {  struct generic_pm_domain genpd ;  struct scpi_ops * ops ;  u32 domain ;  char name [ 30 ] ; } cocci_id@p ;
...
position p;
@@
 enum scpi_power_domain_state cocci_id@p ;
...
position p;
@@
 enum scpi_power_domain_state { SCPI_PD_STATE_ON = 0 , SCPI_PD_STATE_OFF = 3 , } cocci_id@p ;
