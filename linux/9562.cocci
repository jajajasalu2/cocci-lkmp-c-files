...
position p;
@@
 struct rtw_lps_pg_dpk_hdr * cocci_id@p ;
...
position p;
@@
 struct rtw_tx_pkt_info cocci_id@p ;
...
position p;
@@
 struct rtw_lps_pg_info_hdr * cocci_id@p ;
...
typedef u8;
@@
 struct rtw_fw_iter_ra_data {  struct rtw_dev * rtwdev ;  u8 * payload ; } cocci_id@p ;
...
position p;
@@
 enum rtw_rsvd_packet_type cocci_id@p ;
...
position p;
@@
 struct rtw_lps_conf * cocci_id@p ;
...
position p;
@@
 struct rtw_fifo_conf * cocci_id@p ;
...
position p;
@@
 struct rtw_fw_iter_ra_data * cocci_id@p ;
...
position p;
@@
 struct rtw_coex_info_req * cocci_id@p ;
