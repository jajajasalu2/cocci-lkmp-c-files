...
typedef u16;
@@
 struct rmi_spi_cmd {  enum rmi_spi_op op ;  u16 addr ; } cocci_id@p ;
...
position p;
@@
 const struct rmi_spi_cmd * cocci_id@p ;
...
position p;
@@
 struct rmi_spi_xport cocci_id@p ;
...
position p;
@@
 enum rmi_spi_op { RMI_SPI_WRITE = 0 , RMI_SPI_READ , RMI_SPI_V2_READ_UNIFIED , RMI_SPI_V2_READ_SPLIT , RMI_SPI_V2_WRITE , } cocci_id@p ;
...
position p;
@@
 struct rmi_device_platform_data_spi * cocci_id@p ;
...
typedef u8;
@@
 struct rmi_spi_xport {  struct rmi_transport_dev xport ;  struct spi_device * spi ;  struct mutex page_mutex ;  int page ;  u8 * rx_buf ;  u8 * tx_buf ;  int xfer_buf_size ;  struct spi_transfer * rx_xfers ;  struct spi_transfer * tx_xfers ;  int rx_xfer_count ;  int tx_xfer_count ; } cocci_id@p ;
