...
position p;
@@
 const struct bxt_ddi_phy_info cocci_id@p [ ] ;
...
typedef bool,u32;
@@
 struct bxt_ddi_phy_info {  bool dual_channel ;  enum dpio_phy rcomp_phy ;  int reset_delay ;  u32 pwron_mask ;  struct {  enum port port ; } channel [ 2 ] ; } cocci_id@p ;
