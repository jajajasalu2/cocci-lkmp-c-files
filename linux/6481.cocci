...
position p;
@@
 struct pbias_of_data {  unsigned int offset ; } cocci_id@p ;
...
position p;
@@
 const struct pbias_reg_info * cocci_id@p ;
...
typedef u32;
@@
 struct pbias_reg_info {  u32 enable ;  u32 enable_mask ;  u32 disable_val ;  u32 vmode ;  unsigned int enable_time ;  char * name ;  const unsigned int * pbias_volt_table ;  int n_voltages ; } cocci_id@p ;
...
position p;
@@
 const struct pbias_of_data cocci_id@p ;
