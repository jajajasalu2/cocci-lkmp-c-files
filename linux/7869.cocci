...
symbol cocci_id;
position p;
typedef u8,u16,port_t;
@@
 struct card_s {  u8 __iomem * rambase ;  u8 __iomem * scabase ;  plx9052 __iomem * plxbase ;  u16 rx_ring_buffers ;  u16 tx_ring_buffers ;  u16 buff_offset ;  u8 irq ;  port_t ports [ 2 ] ; } cocci_id@p ;
