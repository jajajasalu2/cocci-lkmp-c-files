...
position p;
@@
 struct tegra210_xusb_padctl * cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_pad_soc * const cocci_id@p [ ] ;
...
typedef u32;
@@
 struct tegra210_xusb_fuse_calibration {  u32 hs_curr_level [ 4 ] ;  u32 hs_term_range_adj ;  u32 rpd_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct tegra210_xusb_fuse_calibration * cocci_id@p ;
...
position p;
@@
 struct tegra210_xusb_padctl {  struct tegra_xusb_padctl base ;  struct tegra210_xusb_fuse_calibration fuse ; } cocci_id@p ;
