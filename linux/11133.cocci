...
position p;
@@
 const struct audio_clock_info * cocci_id@p ;
...
position p;
@@
 struct audio_clock_info cocci_id@p ;
...
position p;
@@
 union audio_cea_channels cocci_id@p ;
...
@@
 union audio_cea_channels {  uint8_t all ;  struct audio_cea_channels_bits {  uint32_t FL : 1 ;  uint32_t FR : 1 ;  uint32_t LFE : 1 ;  uint32_t FC : 1 ;  uint32_t RL_RC : 1 ;  uint32_t RR : 1 ;  uint32_t RC_RLC_FLC : 1 ;  uint32_t RRC_FRC : 1 ; } channels ; } cocci_id@p ;
...
position p;
@@
 const struct encoder_unblank_param * cocci_id@p ;
...
position p;
@@
 const struct audio_clock_info cocci_id@p [ 16 ] ;
...
position p;
@@
 const struct stream_encoder_funcs cocci_id@p ;
...
position p;
@@
 const struct audio_crtc_info * cocci_id@p ;
...
position p;
@@
 struct audio_crtc_info * cocci_id@p ;
...
position p;
@@
 const struct audio_clock_info cocci_id@p [ 14 ] ;
...
position p;
@@
 const struct encoder_info_frame * cocci_id@p ;
...
position p;
@@
 const struct dc_info_packet * cocci_id@p ;
...
position p;
@@
 struct audio_speaker_flags cocci_id@p ;
