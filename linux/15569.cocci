...
position p;
@@
 struct p80211item_pstr32 * cocci_id@p ;
...
position p;
@@
 struct prism2_wiphy_private * cocci_id@p ;
...
position p;
@@
 struct prism2_wiphy_private {  struct wlandevice * wlandev ;  struct ieee80211_supported_band band ;  struct ieee80211_channel channels [ ARRAY_SIZE ( prism2_channels ) ] ;  struct ieee80211_rate rates [ ARRAY_SIZE ( prism2_rates ) ] ;  struct cfg80211_scan_request * scan_request ; } cocci_id@p ;
...
position p;
@@
 struct p80211msg_lnxreq_autojoin cocci_id@p ;
...
position p;
@@
 struct p80211msg_dot11req_mibset cocci_id@p ;
...
position p;
@@
 struct p80211msg_dot11req_scan cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ PRISM2_NUM_CIPHER_SUITES ] ;
...
position p;
@@
 struct p80211msg_dot11req_scan_results cocci_id@p ;
