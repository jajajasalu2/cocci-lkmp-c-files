...
position p;
@@
 struct hip04_irq_data * cocci_id@p ;
...
position p;
@@
 struct hip04_irq_data {  void __iomem * dist_base ;  void __iomem * cpu_base ;  struct irq_domain * domain ;  unsigned int nr_irqs ; } cocci_id@p ;
