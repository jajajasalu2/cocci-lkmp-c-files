...
position p;
@@
 struct dsp_element_entry cocci_id@p ;
...
position p;
@@
 struct dsp_pipeline_entry {  struct mISDN_dsp_element * elem ;  void * p ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct dsp_pipeline * cocci_id@p ;
...
position p;
@@
 struct dsp_element_entry {  struct mISDN_dsp_element * elem ;  struct device dev ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct dsp_pipeline_entry * cocci_id@p ;
...
position p;
@@
 struct mISDN_dsp_element * cocci_id@p ;
