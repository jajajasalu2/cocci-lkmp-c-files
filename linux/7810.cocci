...
position p;
@@
 enum dmaengine_tx_result cocci_id@p ;
...
position p;
@@
 struct ntb_payload_header * cocci_id@p ;
...
position p;
@@
 struct ntb_transport_client_dev * cocci_id@p ;
...
position p;
@@
 enum { DESC_DONE_FLAG = BIT ( 0 ) , LINK_DOWN_FLAG = BIT ( 1 ) , } cocci_id@p ;
...
position p;
@@
 struct ntb_payload_header {  unsigned int ver ;  unsigned int len ;  unsigned int flags ; } cocci_id@p ;
...
position p;
@@
 struct ntb_transport_mw * cocci_id@p ;
...
position p;
@@
 struct ntb_queue_entry cocci_id@p ;
...
position p;
@@
 enum { VERSION = 0 , QP_LINKS , NUM_QPS , NUM_MWS , MW0_SZ_HIGH , MW0_SZ_LOW , } cocci_id@p ;
...
position p;
@@
 struct ntb_transport_client * cocci_id@p ;
...
position p;
@@
 struct dmaengine_unmap_data * cocci_id@p ;
...
typedef u64,bool;
@@
 struct ntb_transport_ctx {  struct list_head entry ;  struct list_head client_devs ;  struct ntb_dev * ndev ;  struct ntb_transport_mw * mw_vec ;  struct ntb_transport_qp * qp_vec ;  unsigned int mw_count ;  unsigned int qp_count ;  u64 qp_bitmap ;  u64 qp_bitmap_free ;  bool use_msi ;  unsigned int msi_spad_offset ;  u64 msi_db_mask ;  bool link_is_up ;  struct delayed_work link_work ;  struct work_struct link_cleanup ;  struct dentry * debugfs_node_dir ; } cocci_id@p ;
...
position p;
@@
 struct ntb_queue_entry {  struct list_head entry ;  void * cb_data ;  void * buf ;  unsigned int len ;  unsigned int flags ;  int retries ;  int errors ;  unsigned int tx_index ;  unsigned int rx_index ;  struct ntb_transport_qp * qp ;  union {  struct ntb_payload_header __iomem * tx_hdr ;  struct ntb_payload_header * rx_hdr ; } ; } cocci_id@p ;
...
position p;
@@
 const struct ntb_transport_client * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef phys_addr_t,resource_size_t,dma_addr_t;
@@
 struct ntb_transport_mw {  phys_addr_t phys_addr ;  resource_size_t phys_size ;  void __iomem * vbase ;  size_t xlat_size ;  size_t buff_size ;  size_t alloc_size ;  void * alloc_addr ;  void * virt_addr ;  dma_addr_t dma_addr ; } cocci_id@p ;
...
position p;
@@
 struct ntb_rx_info {  unsigned int entry ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ntb_transport_qp * qp , struct ntb_queue_entry * entry ) ;
...
position p;
@@
 struct ntb_transport_ctx cocci_id@p ;
...
position p;
@@
 struct ntb_transport_qp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ntb_queue_entry * entry , void * offset ) ;
...
position p;
@@
 void cocci_id@p ( struct ntb_queue_entry * entry , void __iomem * offset ) ;
...
position p;
@@
 int cocci_id@p ( struct ntb_queue_entry * entry , void * offset ) ;
...
position p;
@@
 const struct dmaengine_result * cocci_id@p ;
...
position p;
@@
 struct ntb_transport_client_dev {  struct list_head entry ;  struct ntb_transport_ctx * nt ;  struct device dev ; } cocci_id@p ;
...
position p;
@@
 const struct ntb_queue_handlers * cocci_id@p ;
...
position p;
@@
 const struct ntb_ctx_ops cocci_id@p ;
