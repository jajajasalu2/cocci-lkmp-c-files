...
position p;
@@
 struct gb_audio_activate_rx_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_set_pcm_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_deactivate_tx_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_set_control_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_get_control_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_set_rx_data_size_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_activate_tx_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_get_control_response cocci_id@p ;
...
position p;
@@
 struct gb_audio_set_tx_data_size_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_deactivate_rx_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_get_topology_size_response cocci_id@p ;
...
position p;
@@
 struct gb_audio_get_pcm_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_enable_widget_request cocci_id@p ;
...
position p;
@@
 struct gb_audio_get_pcm_response cocci_id@p ;
...
position p;
@@
 struct gb_audio_disable_widget_request cocci_id@p ;
