...
typedef u32;
@@
 struct nixge_hw_dma_bd {  u32 next_lo ;  u32 next_hi ;  u32 phys_lo ;  u32 phys_hi ;  u32 reserved3 ;  u32 reserved4 ;  u32 cntrl ;  u32 status ;  u32 app0 ;  u32 app1 ;  u32 app2 ;  u32 app3 ;  u32 app4 ;  u32 sw_id_offset_lo ;  u32 sw_id_offset_hi ;  u32 reserved6 ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,phy_interface_t,dma_addr_t;
@@
 struct nixge_priv {  struct net_device * ndev ;  struct napi_struct napi ;  struct device * dev ;  struct device_node * phy_node ;  phy_interface_t phy_mode ;  int link ;  unsigned int speed ;  unsigned int duplex ;  struct mii_bus * mii_bus ;  void __iomem * ctrl_regs ;  void __iomem * dma_regs ;  struct tasklet_struct dma_err_tasklet ;  int tx_irq ;  int rx_irq ;  struct nixge_hw_dma_bd * tx_bd_v ;  struct nixge_tx_skb * tx_skb ;  dma_addr_t tx_bd_p ;  struct nixge_hw_dma_bd * rx_bd_v ;  dma_addr_t rx_bd_p ;  u32 tx_bd_ci ;  u32 tx_bd_tail ;  u32 rx_bd_ci ;  u32 coalesce_count_rx ;  u32 coalesce_count_tx ; } cocci_id@p ;
...
position p;
@@
 enum nixge_version { NIXGE_V2 , NIXGE_V3 , NIXGE_VERSION_COUNT , } cocci_id@p ;
...
position p;
@@
 struct nixge_tx_skb * cocci_id@p ;
...
position p;
@@
 const struct nixge_priv * cocci_id@p ;
...
@@
 struct nixge_tx_skb {  struct sk_buff * skb ;  dma_addr_t mapping ;  size_t size ;  bool mapped_as_page ; } cocci_id@p ;
...
position p;
@@
 struct nixge_hw_dma_bd * cocci_id@p ;
