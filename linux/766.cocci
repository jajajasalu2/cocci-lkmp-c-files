...
position p;
@@
 const struct pci_epc_ops cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,u32,phys_addr_t;
@@
 struct rockchip_pcie_ep {  struct rockchip_pcie rockchip ;  struct pci_epc * epc ;  u32 max_regions ;  unsigned long ob_region_map ;  phys_addr_t * ob_addr ;  phys_addr_t irq_phys_addr ;  void __iomem * irq_cpu_addr ;  u64 irq_pci_addr ;  u8 irq_pci_fn ;  u8 irq_pending ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_pcie_ep * cocci_id@p ;
...
position p;
@@
 struct rockchip_pcie * cocci_id@p ;
