...
position p;
@@
 struct xgene_msi_group cocci_id@p ;
...
typedef u32;
@@
 struct xgene_msi_group {  struct xgene_msi * msi ;  int gic_irq ;  u32 msi_grp ; } cocci_id@p ;
...
typedef u64;
@@
 struct xgene_msi {  struct device_node * node ;  struct irq_domain * inner_domain ;  struct irq_domain * msi_domain ;  u64 msi_addr ;  void __iomem * msi_regs ;  unsigned long * bitmap ;  struct mutex bitmap_lock ;  struct xgene_msi_group * msi_groups ;  int num_cpus ; } cocci_id@p ;
