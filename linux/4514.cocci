...
position p;
@@
 struct vmci_resource_query_msg * cocci_id@p ;
...
@@
 struct vmci_guest_device {  struct device * dev ;  void __iomem * iobase ;  bool exclusive_vectors ;  struct tasklet_struct datagram_tasklet ;  struct tasklet_struct bm_tasklet ;  void * data_buffer ;  void * notification_bitmap ;  dma_addr_t notification_base ; } cocci_id@p ;
...
position p;
@@
 struct vmci_resource_query_hdr cocci_id@p ;
...
position p;
@@
 struct vmci_guest_device * cocci_id@p ;
...
position p;
@@
 const struct vmci_event_payld_ctx * cocci_id@p ;
