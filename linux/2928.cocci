...
position p;
@@
 struct acpi_gpe_walk_info cocci_id@p ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_gpe_block_info * gpe_block ) ;
...
@@
 acpi_status cocci_id@p ( struct acpi_gpe_block_info * gpe_block , u32 interrupt_number ) ;
