...
position p;
@@
 const hfi1_make_rc_ack cocci_id@p [ 2 ] ;
...
position p;
@@
 struct ib_atomic_eth cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u64,bool,u32;
@@
 void ( * cocci_id@p ) ( struct hfi1_packet * packet , struct hfi1_opa_header * opa_hdr , u8 sc5 , bool is_fecn , u64 * pbc_flags , u32 * hwords , u32 * nwords ) ;
