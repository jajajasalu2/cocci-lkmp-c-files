...
position p;
@@
 struct qt2_device_detail {  int product_id ;  int num_ports ; } cocci_id@p ;
...
position p;
@@
 struct qt2_device_detail cocci_id@p ;
...
position p;
@@
 const struct qt2_device_detail cocci_id@p [ ] ;
...
position p;
@@
 struct qt2_serial_private * cocci_id@p ;
...
position p;
@@
 struct qt2_port_private * cocci_id@p ;
...
@@
 struct qt2_port_private {  u8 device_port ;  spinlock_t urb_lock ;  bool urb_in_use ;  struct urb * write_urb ;  char * write_buffer ;  spinlock_t lock ;  u8 shadowLSR ;  u8 shadowMSR ;  struct usb_serial_port * port ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usb_serial_port * port , unsigned char * ch ) ;
...
position p;
@@
 struct qt2_serial_private {  unsigned char current_port ;  struct urb * read_urb ;  char * read_buffer ; } cocci_id@p ;
