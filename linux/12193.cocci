...
position p;
@@
 struct gr2d_soc {  unsigned int version ; } cocci_id@p ;
...
position p;
@@
 const struct gr2d_soc cocci_id@p ;
...
position p;
@@
 struct gr2d {  struct tegra_drm_client client ;  struct host1x_channel * channel ;  struct clk * clk ;  const struct gr2d_soc * soc ; 
