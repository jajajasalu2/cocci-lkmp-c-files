...
position p;
@@
 struct dsaf_misc_op * cocci_id@p ;
...
position p;
@@
 enum hnae_led_state cocci_id@p ;
...
position p;
@@
 enum _dsm_rst_type { HNS_DSAF_RESET_FUNC = 0x1 , HNS_PPE_RESET_FUNC = 0x2 , HNS_XGE_RESET_FUNC = 0x4 , HNS_GE_RESET_FUNC = 0x5 , HNS_DSAF_CHN_RESET_FUNC = 0x6 , HNS_ROCE_RESET_FUNC = 0x7 , } cocci_id@p ;
...
position p;
@@
 enum _dsm_op_index { HNS_OP_RESET_FUNC = 0x1 , HNS_OP_SERDES_LP_FUNC = 0x2 , HNS_OP_LED_SET_FUNC = 0x3 , HNS_OP_GET_PORT_TYPE_FUNC = 0x4 , HNS_OP_GET_SFP_STAT_FUNC = 0x5 , HNS_OP_LOCATE_LED_SET_FUNC = 0x6 , } cocci_id@p ;
