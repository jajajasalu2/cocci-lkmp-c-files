...
position p;
@@
 struct autofs_dev_ioctl * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct path * path , void * data ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct file * , struct autofs_sb_info * , struct autofs_dev_ioctl * ) ;
