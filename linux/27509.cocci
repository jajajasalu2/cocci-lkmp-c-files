...
@@
 struct ceph_aio_request {  struct kiocb * iocb ;  size_t total_len ;  bool write ;  bool should_dirty ;  int error ;  struct list_head osd_reqs ;  unsigned num_reqs ;  atomic_t pending_reqs ;  struct timespec64 mtime ;  struct ceph_cap_flush * prealloc_cf ; } cocci_id@p ;
...
position p;
@@
 struct ceph_aio_work * cocci_id@p ;
...
position p;
@@
 enum { HAVE_RETRIED = 1 , CHECK_EOF = 2 , READ_INLINE = 3 , } cocci_id@p ;
...
position p;
@@
 struct ceph_dir_file_info * cocci_id@p ;
...
position p;
@@
 struct ceph_aio_work {  struct work_struct work ;  struct ceph_osd_request * req ; } cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p [ ITER_GET_BVECS_PAGES ] ;
...
position p;
@@
 struct ceph_aio_request * cocci_id@p ;
...
position p;
@@
 struct ceph_acl_sec_ctx cocci_id@p ;
