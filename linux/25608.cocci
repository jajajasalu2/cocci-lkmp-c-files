...
position p;
@@
 struct kprobe_blacklist_node cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( unsigned long address ) ;
...
position p;
@@
 struct kprobe_blacklist_node {  struct list_head list ;  unsigned long start ;  unsigned long end ;  char * symbol ; } cocci_id@p ;
