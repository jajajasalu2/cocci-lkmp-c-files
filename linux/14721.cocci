...
position p;
@@
 const struct clk_pll_characteristics cocci_id@p ;
...
typedef u8;
@@
 struct sck {  char * n ;  char * p ;  u8 id ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct at91sam926x_data {  const struct clk_pll_layout * plla_layout ;  const struct clk_pll_characteristics * plla_characteristics ;  const struct clk_pll_layout * pllb_layout ;  const struct clk_pll_characteristics * pllb_characteristics ;  const struct clk_master_characteristics * mck_characteristics ;  const struct sck * sck ;  const struct pck * pck ;  u8 num_sck ;  u8 num_pck ;  u8 num_progck ;  bool has_slck ; } cocci_id@p ;
...
position p;
@@
 const struct clk_master_characteristics cocci_id@p ;
...
typedef u8;
@@
 struct pck {  char * n ;  u8 id ; } cocci_id@p ;
...
position p;
@@
 struct at91sam926x_data cocci_id@p ;
...
position p;
@@
 const struct clk_range cocci_id@p [ ] ;
