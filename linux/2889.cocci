...
position p;
@@
 void cocci_id@p ( void * resource , struct acpi_rsdump_info * table ) ;
...
typedef u8,u16;
@@
 void cocci_id@p ( u16 length , u8 * data ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 length , u8 * data ) ;
...
typedef u8;
@@
 void cocci_id@p ( const char * title , u8 value ) ;
...
position p;
@@
 void cocci_id@p ( char * title , struct acpi_resource_label * resource_label ) ;
...
typedef u16;
@@
 void cocci_id@p ( const char * title , u16 value ) ;
...
position p;
@@
 struct acpi_pci_routing_table * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const char * title , const char * value ) ;
...
position p;
@@
 union acpi_resource_data cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const char * title ) ;
...
position p;
@@
 struct acpi_resource_source * cocci_id@p ;
...
position p;
@@
 struct acpi_resource_label cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( u16 length , u16 * data ) ;
...
position p;
@@
 void cocci_id@p ( struct acpi_resource_source * resource_source ) ;
...
position p;
@@
 void cocci_id@p ( union acpi_resource_data * resource ) ;
...
typedef u64;
@@
 void cocci_id@p ( const char * title , u64 value ) ;
...
typedef u32;
@@
 void cocci_id@p ( const char * title , u32 value ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 length , u32 * data ) ;
