...
position p;
@@
 struct qtnf_shm_ipc cocci_id@p ;
...
position p;
@@
 struct qtnf_shm_ipc_region cocci_id@p ;
...
position p;
@@
 const struct qtnf_shm_ipc_int * cocci_id@p ;
...
position p;
@@
 const struct qtnf_shm_ipc_rx_callback * cocci_id@p ;
...
position p;
@@
 enum qtnf_shm_ipc_direction cocci_id@p ;
