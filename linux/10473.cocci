...
position p;
@@
 struct radeon_ttm_tt cocci_id@p ;
...
position p;
@@
 struct vm_operations_struct cocci_id@p ;
...
@@
 struct radeon_ttm_tt {  struct ttm_dma_tt ttm ;  struct radeon_device * rdev ;  u64 offset ;  uint64_t userptr ;  struct mm_struct * usermm ;  uint32_t userflags ; } cocci_id@p ;
