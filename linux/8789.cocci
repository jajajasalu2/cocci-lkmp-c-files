...
position p;
@@
 int cocci_id@p ( struct net_device * dev , struct nubus_board * board , enum mac8390_type type ) ;
...
position p;
@@
 struct nubus_dirent cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int to , const void * from , int count ) ;
...
position p;
@@
 enum mac8390_access cocci_id@p ;
...
position p;
@@
 struct e8390_pkt_hdr * cocci_id@p ;
...
position p;
@@
 enum mac8390_access { ACCESS_UNKNOWN = 0 , ACCESS_32 , ACCESS_16 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long tp , const void * fp , int count ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int count , struct sk_buff * skb , int ring_offset ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int count , const unsigned char * buf , const int start_page ) ;
...
position p;
@@
 struct nubus_driver cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int count , const unsigned char * buf , int start_page ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , void * to , int from , int count ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , struct e8390_pkt_hdr * hdr , int ring_page ) ;
...
position p;
@@
 void cocci_id@p ( void * tp , unsigned long fp , int count ) ;
...
position p;
@@
 const volatile unsigned short * cocci_id@p ;
...
position p;
@@
 enum mac8390_type { MAC8390_NONE = - 1 , MAC8390_APPLE , MAC8390_ASANTE , MAC8390_FARALLON , MAC8390_CABLETRON , MAC8390_DAYNA , MAC8390_INTERLAN , MAC8390_KINETICS , } cocci_id@p ;
