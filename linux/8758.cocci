...
position p;
@@
 struct qlcnic_vlan_req * cocci_id@p ;
...
position p;
@@
 struct qlcnic_ms_reg_ctrl * cocci_id@p ;
...
position p;
@@
 struct qlcnic_filter * cocci_id@p ;
...
typedef u64,u32;
@@
 struct qlcnic_ms_reg_ctrl {  u32 ocm_window ;  u32 control ;  u32 hi ;  u32 low ;  u32 rd [ 4 ] ;  u32 wd [ 4 ] ;  u64 off ; } cocci_id@p ;
...
position p;
@@
 struct qlcnic_nic_req cocci_id@p ;
...
position p;
@@
 struct qlcnic_ipaddr * cocci_id@p ;
...
position p;
@@
 struct qlcnic_mac_req * cocci_id@p ;
...
position p;
@@
 const struct crb_128M_2M_sub_block_map * cocci_id@p ;
