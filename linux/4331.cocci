...
position p;
@@
 struct intel_menlow_attribute * cocci_id@p ;
...
typedef acpi_handle;
@@
 struct intel_menlow_attribute {  struct device_attribute attr ;  struct device * device ;  acpi_handle handle ;  struct list_head node ; } cocci_id@p ;
