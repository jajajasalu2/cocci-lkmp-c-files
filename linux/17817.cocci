...
symbol cocci_id;
position p;
typedef slidx_list_t;
@@
 struct {  slidx_list_t * buffer ;  int cur_idx ;  int max_idx ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sal_processor_static_info_t;
@@
 sal_processor_static_info_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_cache_check_info_t;
@@
 pal_cache_check_info_t * cocci_id@p ;
...
position p;
@@
 enum { ISOLATE_NG , ISOLATE_OK , ISOLATE_NONE , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef peidx_table_t;
@@
 peidx_table_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sal_log_section_hdr_t;
@@
 sal_log_section_hdr_t * cocci_id@p ;
...
position p;
@@
 struct sal_cpuid_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sal_log_mod_error_info_t;
@@
 sal_log_mod_error_info_t cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p [ MAX_PAGE_ISOLATE ] ;
...
symbol cocci_id;
position p;
typedef pal_bus_check_info_t;
@@
 pal_bus_check_info_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sal_log_processor_info_t;
@@
 sal_log_processor_info_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_tlb_check_info_t;
@@
 pal_tlb_check_info_t * cocci_id@p ;
...
position p;
@@
 enum { MCA_NOT_RECOVERED = 0 , MCA_RECOVERED = 1 , } cocci_id@p ;
...
position p;
@@
 enum { MCA_IS_LOCAL = 0 , MCA_IS_GLOBAL = 1 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef isolate_status_t;
@@
 isolate_status_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef slidx_table_t;
@@
 slidx_table_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_processor_state_info_t;
@@
 pal_processor_state_info_t * cocci_id@p ;
...
@@
 pal_min_state_area_t * cocci_id@p ;
