...
position p;
@@
 struct fcoe_cached_sge_ctx * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bnx2fc_hba * hba , struct fcoe_kcqe * new_cqe_kcqe ) ;
...
position p;
@@
 struct bnx2fc_unsol_els cocci_id@p ;
...
position p;
@@
 struct fcoe_kwqe_destroy cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bnx2fc_hba * hba , struct fcoe_kcqe * destroy_kcqe ) ;
...
position p;
@@
 struct fcoe_err_report_entry * cocci_id@p ;
...
position p;
@@
 struct fcoe_task_ctx_entry cocci_id@p ;
...
position p;
@@
 struct fcoe_rx_seq_ctx cocci_id@p ;
...
position p;
@@
 struct b577xx_fcoe_rx_doorbell * cocci_id@p ;
...
position p;
@@
 struct fcoe_t2_hash_table_entry cocci_id@p ;
...
position p;
@@
 struct fcoe_hash_table_entry cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct bnx2fc_hba * hba , u32 err_code ) ;
...
position p;
@@
 struct b577xx_doorbell_set_prod * cocci_id@p ;
...
position p;
@@
 struct bnx2fc_mp_req * cocci_id@p ;
...
position p;
@@
 struct fcoe_ext_mul_sges_ctx * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bnx2fc_hba * hba , struct fcoe_kcqe * ofld_kcqe ) ;
