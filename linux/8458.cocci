...
position p;
@@
 struct sxgbe_tx_norm_desc cocci_id@p ;
...
position p;
@@
 const struct sxgbe_priv_data * cocci_id@p ;
...
position p;
@@
 struct sxgbe_rx_queue cocci_id@p ;
...
position p;
@@
 struct sxgbe_hw_features * cocci_id@p ;
...
position p;
@@
 struct sxgbe_plat_data * cocci_id@p ;
...
position p;
@@
 struct sxgbe_ops * const cocci_id@p ;
...
position p;
@@
 struct sxgbe_tx_queue * cocci_id@p ;
...
position p;
@@
 struct sxgbe_priv_data cocci_id@p ;
...
position p;
@@
 struct sxgbe_rx_norm_desc cocci_id@p ;
...
position p;
@@
 struct sxgbe_tx_ctxt_desc * cocci_id@p ;
...
position p;
@@
 struct sxgbe_extra_stats cocci_id@p ;
...
position p;
@@
 struct sxgbe_priv_data * const cocci_id@p ;
