...
position p;
@@
 const struct soc_data * cocci_id@p ;
...
typedef u32;
@@
 struct soc_data {  u32 flags ; } cocci_id@p ;
...
position p;
@@
 struct cpu_data {  struct clk * * pclk ;  struct cpufreq_frequency_table * table ; } cocci_id@p ;
