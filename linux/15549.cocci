...
position p;
@@
 enum ad7816_type { ID_AD7816 , ID_AD7817 , ID_AD7818 , } cocci_id@p ;
...
position p;
@@
 struct ad7816_chip_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,kernel_ulong_t;
@@
 struct ad7816_chip_info {  kernel_ulong_t id ;  struct spi_device * spi_dev ;  struct gpio_desc * rdwr_pin ;  struct gpio_desc * convert_pin ;  struct gpio_desc * busy_pin ;  u8 oti_data [ AD7816_CS_MAX + 1 ] ;  u8 channel_id ;  u8 mode ; } cocci_id@p ;
