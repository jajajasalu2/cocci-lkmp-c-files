...
position p;
@@
 const struct net_kern_info cocci_id@p ;
...
typedef bool;
@@
 struct umcast_init {  char * addr ;  int lport ;  int rport ;  int ttl ;  bool unicast ; } cocci_id@p ;
