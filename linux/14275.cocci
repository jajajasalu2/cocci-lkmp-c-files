...
position p;
@@
 struct sp887x_state * cocci_id@p ;
...
typedef u8;
@@
 struct sp887x_state {  struct i2c_adapter * i2c ;  const struct sp887x_config * config ;  struct dvb_frontend frontend ;  u8 initialised : 1 ; } cocci_id@p ;
