...
position p;
@@
 struct otm3225a_data {  struct spi_device * spi ;  struct lcd_device * ld ;  int power ; } cocci_id@p ;
...
position p;
@@
 struct otm3225a_data * cocci_id@p ;
...
position p;
@@
 struct otm3225a_spi_instruction cocci_id@p [ ] ;
...
position p;
@@
 struct otm3225a_spi_instruction {  unsigned char reg ;  unsigned short value ;  unsigned short delay ; } cocci_id@p ;
