...
position p;
@@
 enum rdmacg_file_type { RDMACG_RESOURCE_TYPE_MAX , RDMACG_RESOURCE_TYPE_STAT , } cocci_id@p ;
...
position p;
@@
 enum rdmacg_file_type cocci_id@p ;
...
position p;
@@
 struct rdmacg_device * cocci_id@p ;
...
position p;
@@
 struct rdmacg_resource {  int max ;  int usage ; } cocci_id@p ;
...
position p;
@@
 enum rdmacg_resource_type cocci_id@p ;
...
position p;
@@
 struct rdmacg_resource_pool * cocci_id@p ;
...
typedef u64;
@@
 struct rdmacg_resource_pool {  struct rdmacg_device * device ;  struct rdmacg_resource resources [ RDMACG_RESOURCE_MAX ] ;  struct list_head cg_node ;  struct list_head dev_node ;  u64 usage_sum ;  int num_max_cnt ; } cocci_id@p ;
