...
position p;
@@
 const struct soc_button_info cocci_id@p [ ] ;
...
position p;
@@
 struct soc_button_data {  struct platform_device * children [ BUTTON_TYPES ] ; } cocci_id@p ;
...
position p;
@@
 struct soc_button_data * cocci_id@p ;
...
typedef bool;
@@
 struct soc_button_info {  const char * name ;  int acpi_index ;  unsigned int event_type ;  unsigned int event_code ;  bool autorepeat ;  bool wakeup ; } cocci_id@p ;
...
position p;
@@
 struct soc_device_data {  const struct soc_button_info * button_info ;  int ( * check ) ( struct device * dev ) ; } cocci_id@p ;
...
position p;
@@
 const struct soc_device_data * cocci_id@p ;
...
position p;
@@
 struct soc_button_info * cocci_id@p ;
