...
typedef u8,bool;
@@
 struct pm8xxx_pin_data {  unsigned reg ;  int irq ;  u8 mode ;  bool input ;  bool output ;  bool high_z ;  bool paired ;  bool output_value ;  u8 power_source ;  u8 dtest ;  u8 amux ;  u8 aout_level ;  u8 drive_strength ;  unsigned pullup ; } cocci_id@p ;
...
position p;
@@
 struct pm8xxx_mpp {  struct device * dev ;  struct regmap * regmap ;  struct pinctrl_dev * pctrl ;  struct gpio_chip chip ;  struct pinctrl_desc desc ;  unsigned npins ; } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ PM8XXX_MAX_MPPS ] ;
