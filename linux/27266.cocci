...
position p;
@@
 struct posix_acl_state * cocci_id@p ;
...
position p;
@@
 struct posix_acl_summary {  unsigned short owner ;  unsigned short users ;  unsigned short group ;  unsigned short groups ;  unsigned short other ;  unsigned short mask ; } cocci_id@p ;
...
position p;
@@
 struct posix_ace_state_array {  int n ;  struct posix_user_ace_state aces [ ] ; } cocci_id@p ;
...
position p;
@@
 struct {  char * string ;  int stringlen ;  int type ; } cocci_id@p [ ] ;
...
position p;
@@
 struct posix_ace_state_array cocci_id@p ;
...
position p;
@@
 struct posix_ace_state * cocci_id@p ;
...
position p;
@@
 struct posix_acl_summary cocci_id@p ;
...
typedef u32;
@@
 struct posix_ace_state {  u32 allow ;  u32 deny ; } cocci_id@p ;
...
position p;
@@
 struct posix_acl_entry * cocci_id@p ;
...
@@
 struct posix_user_ace_state {  union {  kuid_t uid ;  kgid_t gid ; } ;  struct posix_ace_state perms ; } cocci_id@p ;
...
position p;
@@
 short cocci_id@p ( struct nfs4_ace * ) ;
...
position p;
@@
 void cocci_id@p ( struct posix_acl * , struct nfs4_acl * , unsigned int ) ;
...
position p;
@@
 struct posix_acl_state {  int empty ;  struct posix_ace_state owner ;  struct posix_ace_state group ;  struct posix_ace_state other ;  struct posix_ace_state everyone ;  struct posix_ace_state mask ;  struct posix_ace_state_array * users ;  struct posix_ace_state_array * groups ; } cocci_id@p ;
...
position p;
@@
 struct posix_user_ace_state cocci_id@p ;
