...
symbol cocci_id;
position p;
typedef u8,u32,pid_t,spinlock_t,local_t;
@@
 struct etb_drvdata {  void __iomem * base ;  struct clk * atclk ;  struct coresight_device * csdev ;  struct miscdevice miscdev ;  spinlock_t spinlock ;  local_t reading ;  pid_t pid ;  u8 * buf ;  u32 mode ;  u32 buffer_depth ;  u32 trigger_cntr ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct coresight_device * csdev , struct perf_output_handle * handle ) ;
