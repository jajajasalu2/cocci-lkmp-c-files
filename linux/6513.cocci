...
position p;
@@
 struct fdomain {  int base ;  struct scsi_cmnd * cur_cmd ;  enum chip_type chip ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 enum chip_type { unknown = 0x00 , tmc1800 = 0x01 , tmc18c50 = 0x02 , tmc18c30 = 0x03 , } cocci_id@p ;
