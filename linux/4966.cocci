...
position p;
@@
 struct qib_sdma_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qib_pportdata * , unsigned ) ;
...
position p;
@@
 enum qib_sdma_events cocci_id@p ;
...
position p;
@@
 enum qib_sdma_states cocci_id@p ;
...
position p;
@@
 struct qib_sdma_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qib_sdma_state * ) ;
...
position p;
@@
 void cocci_id@p ( struct qib_pportdata * , enum qib_sdma_states ) ;
