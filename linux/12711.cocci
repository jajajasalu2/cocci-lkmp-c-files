...
position p;
@@
 struct transaction_callback_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fw_transaction_callback_t;
@@
 fw_transaction_callback_t cocci_id@p ;
...
typedef u32;
@@
 struct fw_request {  struct fw_packet response ;  u32 request_header [ 4 ] ;  int ack ;  u32 length ;  u32 data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct transaction_callback_data {  struct completion done ;  void * payload ;  int rcode ; } cocci_id@p ;
