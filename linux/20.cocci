...
position p;
@@
 enum oper_type { OPER_WRITE_PROP , OPER_CREATE_NODE , } cocci_id@p ;
...
position p;
@@
 struct display_info {  enum oper_type oper ;  int type ;  int size ;  int verbose ;  int auto_path ; } cocci_id@p ;
