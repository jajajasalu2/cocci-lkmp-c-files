...
position p;
@@
 struct pcl816_private * cocci_id@p ;
...
position p;
@@
 const struct pcl816_board * cocci_id@p ;
...
position p;
@@
 struct pcl816_board cocci_id@p ;
...
position p;
@@
 struct pcl816_board {  const char * name ;  int ai_maxdata ;  int ai_chanlist ; } cocci_id@p ;
...
position p;
@@
 struct pcl816_private {  struct comedi_isadma * dma ;  unsigned int ai_poll_ptr ;  unsigned int ai_cmd_running : 1 ;  unsigned int ai_cmd_canceled : 1 ; } cocci_id@p ;
