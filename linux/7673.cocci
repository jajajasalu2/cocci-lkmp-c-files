...
position p;
@@
 struct sirfsoc_fifo_status * cocci_id@p ;
...
position p;
@@
 struct sirfsoc_uart_param * cocci_id@p ;
...
position p;
@@
 struct sirfsoc_uart_port cocci_id@p ;
...
position p;
@@
 struct sirfsoc_int_status * cocci_id@p ;
...
position p;
@@
 struct sirfsoc_uart_register * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct uart_port * port , unsigned int max_rx_count ) ;
...
position p;
@@
 struct sirfsoc_int_en * cocci_id@p ;
...
position p;
@@
 struct sirfsoc_register * cocci_id@p ;
...
position p;
@@
 struct sirfsoc_uart_port * cocci_id@p [ SIRFSOC_UART_NR ] ;
...
position p;
@@
 const struct sirfsoc_baudrate_to_regv cocci_id@p [ ] ;
...
position p;
@@
 unsigned int cocci_id@p ( struct sirfsoc_uart_port * sirfport , int count ) ;
