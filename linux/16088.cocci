...
position p;
@@
 const struct cb_pcidas_board cocci_id@p [ ] ;
...
position p;
@@
 struct cb_pcidas_private {  struct comedi_8254 * ao_pacer ;  unsigned long amcc ;  unsigned long pcibar1 ;  unsigned long pcibar2 ;  unsigned long pcibar4 ;  unsigned int ctrl ;  unsigned int amcc_intcsr ;  unsigned int ao_ctrl ;  unsigned short ai_buffer [ AI_BUFFER_SIZE ] ;  unsigned short ao_buffer [ AO_BUFFER_SIZE ] ;  unsigned int calib_src ; } cocci_id@p ;
...
position p;
@@
 struct cb_pcidas_private * cocci_id@p ;
...
position p;
@@
 enum cb_pcidas_boardid { BOARD_PCIDAS1602_16 , BOARD_PCIDAS1200 , BOARD_PCIDAS1602_12 , BOARD_PCIDAS1200_JR , BOARD_PCIDAS1602_16_JR , BOARD_PCIDAS1000 , BOARD_PCIDAS1001 , BOARD_PCIDAS1002 , } cocci_id@p ;
...
position p;
@@
 struct cb_pcidas_board {  const char * name ;  int ai_speed ;  int ao_scan_speed ;  int fifo_size ;  unsigned int is_16bit ;  unsigned int use_alt_range : 1 ;  unsigned int has_ao : 1 ;  unsigned int has_ao_fifo : 1 ;  unsigned int has_ad8402 : 1 ;  unsigned int has_dac08 : 1 ;  unsigned int is_1602 : 1 ; } cocci_id@p ;
