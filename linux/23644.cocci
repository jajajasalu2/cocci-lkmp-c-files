...
position p;
@@
 struct cygnus_ssp_regs cocci_id@p [ 3 ] ;
...
position p;
@@
 enum cygnus_audio_port_type cocci_id@p ;
...
position p;
@@
 struct cygnus_ssp_regs cocci_id@p ;
...
position p;
@@
 struct cygnus_aio_port * cocci_id@p ;
...
typedef u32;
@@
 struct pll_macro_entry {  u32 mclk ;  u32 pll_ch_num ; } cocci_id@p ;
...
position p;
@@
 struct cygnus_audio cocci_id@p ;
...
position p;
@@
 const struct pll_macro_entry cocci_id@p [ ] ;
...
position p;
@@
 struct snd_soc_dai_driver cocci_id@p [ CYGNUS_MAX_PORTS ] ;
