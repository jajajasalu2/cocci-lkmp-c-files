...
position p;
@@
 struct test {  int alloc_ret ;  unsigned num_pages ;  unsigned * pfn ;  unsigned size ;  unsigned int max_seg ;  unsigned int expected_segments ; } * cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p [ MAX_PAGES ] ;
