...
position p;
@@
 struct mxic_nand_ctlr * cocci_id@p ;
...
position p;
@@
 struct mxic_nand_ctlr {  struct clk * ps_clk ;  struct clk * send_clk ;  struct clk * send_dly_clk ;  struct completion complete ;  void __iomem * regs ;  struct nand_controller controller ;  struct device * dev ;  struct nand_chip chip ; } cocci_id@p ;
