...
position p;
@@
 struct ipoib_cm_data cocci_id@p ;
...
position p;
@@
 struct ipoib_cm_rx_buf * cocci_id@p ;
...
position p;
@@
 struct ipoib_tx_buf * cocci_id@p ;
...
position p;
@@
 struct {  struct ib_recv_wr wr ;  struct ib_sge sge [ IPOIB_CM_RX_SG ] ; } * cocci_id@p ;
