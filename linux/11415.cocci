...
position p;
@@
 enum SVGA3dSurfaceFormat cocci_id@p ;
...
position p;
@@
 const struct drm_vmw_rect * cocci_id@p ;
...
position p;
@@
 struct vmw_display_unit * cocci_id@p ;
...
position p;
@@
 struct vmw_validation_context * cocci_id@p ;
...
position p;
@@
 struct vmw_dma_cmd {  SVGA3dCmdHeader header ;  SVGA3dCmdSurfaceDMA dma ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_display_unit * cocci_id@p [ VMWGFX_NUM_DISPLAY_UNITS ] ;
...
position p;
@@
 struct vmw_vga_topology_state * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_cursor_bypass_arg * cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 cmd ;  SVGAFifoCmdDefineAlphaCursor cursor ; } * cocci_id@p ;
...
position p;
@@
 struct ttm_bo_kmap_obj cocci_id@p ;
...
position p;
@@
 struct ttm_placement * cocci_id@p ;
...
position p;
@@
 const struct drm_clip_rect * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_update_layout_arg * cocci_id@p ;
...
position p;
@@
 struct vmw_crtc_state * cocci_id@p ;
