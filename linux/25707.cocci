...
typedef bool;
@@
 struct {  int command ;  bool list_events ;  bool uprobes ;  bool quiet ;  bool target_used ;  int nevents ;  struct perf_probe_event events [ MAX_PROBES ] ;  struct line_range line_range ;  char * target ;  struct strfilter * filter ;  struct nsinfo * nsi ; } cocci_id@p ;
