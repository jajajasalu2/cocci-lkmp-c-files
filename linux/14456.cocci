...
typedef u8;
@@
 struct avc_command_frame {  u8 ctype ;  u8 subunit ;  u8 opcode ;  u8 operand [ 509 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct avc_response_frame {  u8 response ;  u8 subunit ;  u8 opcode ;  u8 operand [ 509 ] ; } cocci_id@p ;
...
position p;
@@
 struct firedtv_tuner_status * cocci_id@p ;
...
position p;
@@
 struct avc_response_frame * cocci_id@p ;
...
position p;
@@
 struct avc_command_frame * cocci_id@p ;
