...
typedef scope_t;
@@
 void cocci_id@p ( scope_t * scope , int patch ) ;
...
symbol cocci_id;
position p;
typedef path_entry_t;
@@
 path_entry_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int argc , char * argv [ ] ) ;
...
symbol cocci_id;
position p;
typedef symbol_node_t;
@@
 symbol_node_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef critical_section_t;
@@
 critical_section_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( char * ifilename ) ;
...
typedef patch_t;
@@
 int cocci_id@p ( patch_t * * start_patch , int start_instr , int * skip_addr , int * func_vals ) ;
...
symbol cocci_id;
position p;
typedef patch_info_t;
@@
 patch_info_t * cocci_id@p ;
