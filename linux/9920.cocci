...
position p;
@@
 struct wmi_p2p_macaddr * cocci_id@p ;
...
position p;
@@
 struct wmi_tx_meta_v2 * cocci_id@p ;
...
position p;
@@
 struct wmi_add_wow_pattern_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_set_host_sleep_mode_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_probed_ssid_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_set_wmm_txop_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_listen_int_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tkip_micerr_event cocci_id@p ;
...
position p;
@@
 struct wmi_add_cipher_key_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_aplist_event * cocci_id@p ;
...
position p;
@@
 struct wmi_tx_complete_event cocci_id@p ;
...
position p;
@@
 struct wmi_ap_set_pvb_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_snr_threshold_event * cocci_id@p ;
...
position p;
@@
 struct wmi_pstream_timeout_event * cocci_id@p ;
...
position p;
@@
 struct wmi_set_keepalive_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_delete_pstream_cmd * cocci_id@p ;
...
position p;
@@
 struct sq_threshold_params * cocci_id@p ;
...
position p;
@@
 struct roam_ctrl_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_channel_list_reply cocci_id@p ;
...
position p;
@@
 struct wmi_ready_event_2 cocci_id@p ;
...
position p;
@@
 struct ieee80211_qos_hdr cocci_id@p ;
...
position p;
@@
 struct wmi_reconnect_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_enable_sched_scan_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_set_rssi_filter_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_neighbor_report_event * cocci_id@p ;
...
position p;
@@
 struct wmi_rx_action_event * cocci_id@p ;
...
position p;
@@
 struct wmi_power_params_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_delba_event * cocci_id@p ;
...
position p;
@@
 struct wmi_cac_event * cocci_id@p ;
...
position p;
@@
 struct tx_complete_msg_v1 * cocci_id@p ;
...
position p;
@@
 struct wmix_hb_challenge_resp_cmd * cocci_id@p ;
...
position p;
@@
 struct set_beacon_int_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_get_p2p_info * cocci_id@p ;
...
position p;
@@
 struct wmi_set_htcap_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_p2p_info_event * cocci_id@p ;
...
position p;
@@
 struct ieee80211_hdr_3addr * cocci_id@p ;
...
position p;
@@
 struct wmi_set_tx_select_rates32_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_addba_req_event * cocci_id@p ;
...
position p;
@@
 struct ath6kl_htcap * cocci_id@p ;
...
position p;
@@
 struct wmi_set_ie_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_rssi_threshold_event cocci_id@p ;
...
position p;
@@
 struct wmi_connect_event * cocci_id@p ;
...
position p;
@@
 struct wmi_set_lpreamble_cmd * cocci_id@p ;
...
position p;
@@
 struct reg_dmn_pair_mapping * cocci_id@p ;
...
position p;
@@
 enum dot11_auth_mode cocci_id@p ;
...
position p;
@@
 enum htc_endpoint_id cocci_id@p ;
...
position p;
@@
 struct wmi_send_mgmt_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_probe_req_report_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_begin_scan_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_del_wow_pattern_cmd * cocci_id@p ;
...
position p;
@@
 struct ath6kl_llc_snap_hdr cocci_id@p ;
...
position p;
@@
 struct wmi_fix_rates_reply cocci_id@p ;
...
position p;
@@
 struct wmi_tx_meta_v1 * cocci_id@p ;
...
position p;
@@
 struct wmi_set_tx_pwr_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_send_action_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_set_tx_select_rates64_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_disconnect_event cocci_id@p ;
...
position p;
@@
 struct wmi_txe_notify_event * cocci_id@p ;
...
position p;
@@
 struct wmi_create_pstream_cmd cocci_id@p ;
...
position p;
@@
 enum ath6kl_wow_mode cocci_id@p ;
...
position p;
@@
 struct country_code_to_enum_rd * cocci_id@p ;
...
position p;
@@
 struct wmi_pmkid_list_reply cocci_id@p ;
...
position p;
@@
 struct wmi_snr_threshold_params_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_connect_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_ap_info_v1 * cocci_id@p ;
...
position p;
@@
 struct wmi_cancel_remain_on_chnl_event * cocci_id@p ;
...
position p;
@@
 enum ath6kl_crypto_type cocci_id@p ;
...
position p;
@@
 enum wmi_data_hdr_data_type cocci_id@p ;
...
position p;
@@
 struct wmi_set_wow_mode_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_p2p_capabilities_event * cocci_id@p ;
...
position p;
@@
 struct wmi_p2p_rx_probe_req_event * cocci_id@p ;
...
position p;
@@
 struct wmi_delete_cipher_key_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_set_appie_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tx_pwr_reply cocci_id@p ;
...
position p;
@@
 struct wmi_add_krk_cmd * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct wmi * wmi , u8 if_idx ) ;
...
position p;
@@
 struct wmi_set_inact_period_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_ap_apsd_buffered_traffic_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_sta_bmiss_enhance_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_data_sync_bufs cocci_id@p [ WMM_NUM_AC ] ;
...
position p;
@@
 struct ath6kl_wmix_dbglog_cfg_module_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_set_rts_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_p2p_probe_response_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_remain_on_chnl_event * cocci_id@p ;
...
position p;
@@
 struct wmi_rssi_threshold_params_cmd cocci_id@p ;
...
position p;
@@
 struct wmi_bss_info_hdr2 * cocci_id@p ;
...
position p;
@@
 struct wmi_pspoll_event * cocci_id@p ;
...
position p;
@@
 struct wmi_power_mode_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_data_hdr cocci_id@p ;
...
position p;
@@
 struct wmi_bit_rate_reply * cocci_id@p ;
...
position p;
@@
 struct ath6kl_wmi_regdomain * cocci_id@p ;
...
position p;
@@
 struct wmi_ap_set_mlme_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_p2p_hmodel * cocci_id@p ;
...
position p;
@@
 const struct cfg80211_bitrate_mask * cocci_id@p ;
...
position p;
@@
 struct wmi_bmiss_time_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_set_ip_cmd * cocci_id@p ;
...
position p;
@@
 enum wmix_command_id cocci_id@p ;
...
position p;
@@
 struct wmi_remain_on_chnl_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_get_keepalive_cmd cocci_id@p ;
...
position p;
@@
 enum wmi_rssi_threshold_val cocci_id@p ;
...
position p;
@@
 struct wmi_sync_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_set_regdomain_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_disc_timeout_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_peer_node_event cocci_id@p ;
...
position p;
@@
 struct wmi_scan_complete_event * cocci_id@p ;
...
position p;
@@
 struct wmi_mcast_filter_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_disable_11b_rates_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_cmd_error_event * cocci_id@p ;
...
position p;
@@
 struct wmi_bss_filter_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_setpmkid_cmd * cocci_id@p ;
...
position p;
@@
 enum ath6kl_host_mode cocci_id@p ;
...
position p;
@@
 struct wmi_ap_hidden_ssid_cmd * cocci_id@p ;
...
position p;
@@
 enum wmi_snr_threshold_val cocci_id@p ;
...
position p;
@@
 struct wmi_txe_notify_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_mcast_filter_add_del_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_tx_status_event * cocci_id@p ;
...
position p;
@@
 struct wmi_rx_frame_format_cmd * cocci_id@p ;
...
position p;
@@
 struct wmi_scan_params_cmd * cocci_id@p ;
...
position p;
@@
 struct wmix_cmd_hdr cocci_id@p ;
...
position p;
@@
 struct wmi_ap_set_apsd_cmd * cocci_id@p ;
...
position p;
@@
 struct ieee80211_tspec_ie * cocci_id@p ;
...
position p;
@@
 struct wmi_p2p_capabilities * cocci_id@p ;
...
position p;
@@
 struct set_dtim_cmd * cocci_id@p ;
