...
position p;
@@
 struct t10_alua_tg_pt_gp cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ SCSI_INDEX_TYPE_MAX ] ;
...
position p;
@@
 struct t10_alua_lba_map cocci_id@p ;
...
position p;
@@
 const struct sense_info * cocci_id@p ;
...
position p;
@@
 struct t10_alua_lu_gp cocci_id@p ;
...
position p;
@@
 enum transport_state_table cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct se_cmd * , bool , bool * , bool * , unsigned long * flags ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct se_cmd * cmd , struct se_device * dev , int err , bool write_pending ) ;
...
position p;
@@
 void cocci_id@p ( struct se_cmd * cmd ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct se_portal_group * , struct se_session * , void * ) ;
...
typedef u8,bool;
@@
 struct sense_info {  u8 key ;  u8 asc ;  u8 ascq ;  bool add_sector_info ; } cocci_id@p ;
...
position p;
@@
 struct t10_alua_lba_map_member cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ VPD_TMP_BUF_SIZE ] ;
...
symbol cocci_id;
position p;
typedef scsi_index_t;
@@
 scsi_index_t cocci_id@p ;
...
position p;
@@
 struct t10_alua_lu_gp_member cocci_id@p ;
