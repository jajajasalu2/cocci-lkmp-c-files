...
position p;
@@
 struct icmpv6msg_mib cocci_id@p ;
...
position p;
@@
 const struct inet6_skb_parm * cocci_id@p ;
...
position p;
@@
 const struct ipv6_stub cocci_id@p ;
