...
position p;
@@
 struct nsim_bpf_bound_map {  struct netdevsim * ns ;  struct bpf_offloaded_map * map ;  struct mutex mutex ;  struct nsim_map_entry {  void * key ;  void * value ; } entry [ NSIM_BPF_MAX_KEYS ] ;  struct list_head l ; } cocci_id@p ;
...
position p;
@@
 struct xdp_attachment_info * cocci_id@p ;
...
position p;
@@
 const struct bpf_map_dev_ops cocci_id@p ;
...
position p;
@@
 struct nsim_map_entry * cocci_id@p ;
...
position p;
@@
 struct nsim_bpf_bound_prog * cocci_id@p ;
...
position p;
@@
 struct nsim_bpf_bound_map * cocci_id@p ;
...
typedef bool;
@@
 struct nsim_bpf_bound_prog {  struct nsim_dev * nsim_dev ;  struct bpf_prog * prog ;  struct dentry * ddir ;  const char * state ;  bool is_loaded ;  struct list_head l ; } cocci_id@p ;
