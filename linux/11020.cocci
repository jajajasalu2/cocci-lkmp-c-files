...
position p;
@@
 const struct smc_firmware_header_v2_1 * cocci_id@p ;
...
position p;
@@
 struct atom_firmware_info_v3_3 * cocci_id@p ;
...
position p;
@@
 struct smc_soft_pptable_entry * cocci_id@p ;
...
position p;
@@
 enum smu_v11_0_baco_seq cocci_id@p ;
