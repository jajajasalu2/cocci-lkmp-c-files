...
position p;
@@
 enum omapdss_version cocci_id@p ;
...
position p;
@@
 const enum omap_color_mode cocci_id@p [ ] ;
...
position p;
@@
 const struct dss_param_range cocci_id@p [ ] ;
...
position p;
@@
 const struct omap_dss_features * cocci_id@p ;
...
position p;
@@
 const enum dss_feat_id cocci_id@p [ ] ;
...
position p;
@@
 enum dss_range_param cocci_id@p ;
...
position p;
@@
 enum dss_feat_reg_field cocci_id@p ;
