...
position p;
@@
 struct batadv_bla_backbone_gw * cocci_id@p ;
...
position p;
@@
 const struct batadv_bla_backbone_gw * cocci_id@p ;
...
position p;
@@
 const struct batadv_bla_claim * cocci_id@p ;
...
position p;
@@
 struct batadv_priv_bla * cocci_id@p ;
...
position p;
@@
 struct batadv_bcast_duplist_entry * cocci_id@p ;
...
position p;
@@
 struct batadv_bla_claim * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct batadv_priv * bat_priv , struct batadv_bla_backbone_gw * backbone_gw ) ;
