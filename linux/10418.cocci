...
position p;
@@
 struct drm_ioctl_desc cocci_id@p [ ] ;
...
position p;
@@
 struct vgem_device {  struct drm_device drm ;  struct platform_device * platform ; } * cocci_id@p ;
...
position p;
@@
 struct drm_vgem_gem_object * cocci_id@p ;
