...
position p;
@@
 struct spi_mpc8xxx_cs * cocci_id@p ;
...
position p;
@@
 struct mpc8xxx_spi_probe_info * cocci_id@p ;
...
position p;
@@
 struct fsl_spi_match_data cocci_id@p ;
...
position p;
@@
 struct fsl_spi_match_data {  int type ; } cocci_id@p ;
