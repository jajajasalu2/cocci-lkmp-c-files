...
position p;
@@
 struct cros_feature_to_cells {  unsigned int id ;  const struct mfd_cell * mfd_cells ;  unsigned int num_cells ; } cocci_id@p ;
...
position p;
@@
 struct cros_feature_to_name {  unsigned int id ;  const char * name ;  const char * desc ; } cocci_id@p ;
...
position p;
@@
 const struct cros_feature_to_name cocci_id@p [ ] ;
...
position p;
@@
 const struct cros_feature_to_cells cocci_id@p [ ] ;
