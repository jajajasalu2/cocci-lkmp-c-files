...
position p;
@@
 void cocci_id@p ( unsigned long unused ) ;
...
position p;
@@
 const struct hilse_node * cocci_id@p ;
...
position p;
@@
 struct hil_mlc_serio_map * cocci_id@p ;
...
position p;
@@
 const struct hilse_node cocci_id@p [ HILSEN_END ] ;
