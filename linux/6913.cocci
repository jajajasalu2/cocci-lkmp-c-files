...
position p;
@@
 struct matrox_device cocci_id@p ;
...
typedef u8;
@@
 struct matrox_device {  void __iomem * base_addr ;  void __iomem * port_index ;  void __iomem * port_data ;  u8 data_mask ;  unsigned long phys_addr ;  void __iomem * virt_addr ;  unsigned long found ;  struct w1_bus_master * bus_master ; } cocci_id@p ;
