...
position p;
@@
 struct wilc_wfi_mon_priv cocci_id@p ;
...
position p;
@@
 struct wilc_wfi_radiotap_cb_hdr * cocci_id@p ;
...
position p;
@@
 struct tx_complete_mon_data * cocci_id@p ;
...
position p;
@@
 struct wilc_wfi_radiotap_hdr cocci_id@p ;
...
position p;
@@
 struct tx_complete_mon_data {  int size ;  void * buff ; } cocci_id@p ;
