...
typedef u16,__le64;
@@
 struct vnic_txreq {  struct sdma_txreq txreq ;  struct hfi1_vnic_sdma * sdma ;  struct sk_buff * skb ;  unsigned char pad [ HFI1_VNIC_MAX_PAD ] ;  u16 plen ;  __le64 pbc_val ; } cocci_id@p ;
...
position p;
@@
 struct hfi1_vnic_sdma * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ HFI1_VNIC_TXREQ_NAME_LEN ] ;
...
position p;
@@
 struct hfi1_vnic_vport_info * cocci_id@p ;
