...
position p;
@@
 const struct hpre_hw_error cocci_id@p [ ] ;
...
position p;
@@
 enum hpre_ctrl_dbgfs_file cocci_id@p ;
...
position p;
@@
 struct hpre_debugfs_file * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ HPRE_DBGFS_VAL_MAX_LEN ] ;
...
typedef u32;
@@
 struct hpre_hw_error {  u32 int_msk ;  const char * msg ; } cocci_id@p ;
