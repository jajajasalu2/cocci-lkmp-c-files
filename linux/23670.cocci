...
position p;
@@
 struct atmel_i2s_gck_param {  int fs ;  unsigned long mck ;  int imckdiv ;  int imckfs ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_i2s_gck_param * cocci_id@p ;
...
position p;
@@
 struct atmel_i2s_dev {  struct device * dev ;  struct regmap * regmap ;  struct clk * pclk ;  struct clk * gclk ;  struct snd_dmaengine_dai_dma_data playback ;  struct snd_dmaengine_dai_dma_data capture ;  unsigned int fmt ;  const struct atmel_i2s_gck_param * gck_param ;  const struct atmel_i2s_caps * caps ; } cocci_id@p ;
...
position p;
@@
 struct atmel_i2s_caps {  int ( * mck_init ) ( struct atmel_i2s_dev * , struct device_node * np ) ; } cocci_id@p ;
...
position p;
@@
 struct atmel_i2s_dev cocci_id@p ;
...
position p;
@@
 const struct atmel_i2s_caps cocci_id@p ;
