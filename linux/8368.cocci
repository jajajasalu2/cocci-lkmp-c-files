...
position p;
@@
 struct nfp_shared_buf_pool_info_get cocci_id@p ;
...
position p;
@@
 struct nfp_shared_buf * cocci_id@p ;
...
position p;
@@
 struct nfp_shared_buf_pool_info_set cocci_id@p ;
...
position p;
@@
 struct nfp_shared_buf_pool_id cocci_id@p ;
