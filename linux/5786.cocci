...
position p;
@@
 enum { USER_CLOCKSOURCE , USER_CLOCKEVENT , USER_NR , } cocci_id@p ;
...
@@
 struct em_sti_priv {  void __iomem * base ;  struct clk * clk ;  struct platform_device * pdev ;  unsigned int active [ USER_NR ] ;  unsigned long rate ;  raw_spinlock_t lock ;  struct clock_event_device ced ;  struct clocksource cs ; } cocci_id@p ;
