...
typedef u32;
@@
 struct lpfr_cfg {  unsigned long vco_rate ;  u32 resistance ; } cocci_id@p ;
...
position p;
@@
 const struct lpfr_cfg cocci_id@p [ LPFR_LUT_SIZE ] ;
...
position p;
@@
 enum msm_dsi_phy_type cocci_id@p ;
...
typedef u32;
@@
 struct dsi_pll_28nm {  struct msm_dsi_pll base ;  int id ;  struct platform_device * pdev ;  void __iomem * mmio ;  int vco_delay ;  struct clk * clks [ NUM_DSI_CLOCKS_MAX ] ;  u32 num_clks ;  struct clk * provided_clks [ NUM_PROVIDED_CLKS ] ;  struct clk_onecell_data clk_data ;  struct pll_28nm_cached_state cached_state ; } cocci_id@p ;
...
typedef u8;
@@
 struct pll_28nm_cached_state {  unsigned long vco_rate ;  u8 postdiv3 ;  u8 postdiv1 ;  u8 byte_mux ; } cocci_id@p ;
