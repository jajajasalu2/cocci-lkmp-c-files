...
position p;
@@
 struct listxattr_buf {  struct dir_context ctx ;  size_t size ;  size_t pos ;  char * buf ;  struct dentry * dentry ; } cocci_id@p ;
...
position p;
@@
 struct listxattr_buf * cocci_id@p ;
...
position p;
@@
 struct reiserfs_xattr_header * cocci_id@p ;
...
position p;
@@
 struct reiserfs_dentry_buf * cocci_id@p ;
...
position p;
@@
 struct reiserfs_dentry_buf {  struct dir_context ctx ;  struct dentry * xadir ;  int count ;  int err ;  struct dentry * dentries [ 8 ] ; } cocci_id@p ;
