...
position p;
@@
 struct uniphier_u2phy_priv {  struct regmap * regmap ;  struct phy * phy ;  struct regulator * vbus ;  const struct uniphier_u2phy_soc_data * data ;  struct uniphier_u2phy_priv * next ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_u2phy_soc_data {  struct uniphier_u2phy_param config0 ;  struct uniphier_u2phy_param config1 ; } cocci_id@p ;
...
position p;
@@
 const struct uniphier_u2phy_soc_data * cocci_id@p ;
...
typedef u32;
@@
 struct uniphier_u2phy_param {  u32 offset ;  u32 value ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_u2phy_priv * cocci_id@p ;
