...
position p;
@@
 struct nv10_gr_chan * cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct nv10_gr_chan * , u32 , u32 ) ;
...
typedef u32;
@@
 struct nv10_gr_chan {  struct nvkm_object object ;  struct nv10_gr * gr ;  int chid ;  int nv10 [ ARRAY_SIZE ( nv10_gr_ctx_regs ) ] ;  int nv17 [ ARRAY_SIZE ( nv17_gr_ctx_regs ) ] ;  struct pipe_state pipe_state ;  u32 lma_window [ 4 ] ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct nv10_gr {  struct nvkm_gr base ;  struct nv10_gr_chan * chan [ 32 ] ;  spinlock_t lock ; } cocci_id@p ;
...
typedef bool,u32;
@@
 bool ( * cocci_id@p ) ( struct nv10_gr_chan * , u32 , u32 ) ;
...
typedef u32;
@@
 struct pipe_state {  u32 pipe_0x0000 [ 0x040 / 4 ] ;  u32 pipe_0x0040 [ 0x010 / 4 ] ;  u32 pipe_0x0200 [ 0x0c0 / 4 ] ;  u32 pipe_0x4400 [ 0x080 / 4 ] ;  u32 pipe_0x6400 [ 0x3b0 / 4 ] ;  u32 pipe_0x6800 [ 0x2f0 / 4 ] ;  u32 pipe_0x6c00 [ 0x030 / 4 ] ;  u32 pipe_0x7000 [ 0x130 / 4 ] ;  u32 pipe_0x7400 [ 0x0c0 / 4 ] ;  u32 pipe_0x7800 [ 0x0c0 / 4 ] ; } cocci_id@p ;
