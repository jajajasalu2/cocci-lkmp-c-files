...
position p;
@@
 struct qede_arfs_tuple * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ QEDE_FILTER_PRINT_MAX_LEN ] ;
...
position p;
@@
 enum qed_filter_xcast_params_type cocci_id@p ;
...
position p;
@@
 struct qede_arfs_fltr_node * cocci_id@p ;
