...
position p;
@@
 void cocci_id@p ( struct pxa25x_udc * , struct usb_gadget_driver * ) ;
...
typedef u8,u32;
@@
 union {  struct usb_ctrlrequest r ;  u8 raw [ 8 ] ;  u32 word [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct pxa25x_request cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pxa25x_udc * ) ;
...
position p;
@@
 void cocci_id@p ( struct usb_ep * ep ) ;
...
position p;
@@
 void cocci_id@p ( struct pxa25x_ep * , int status ) ;
