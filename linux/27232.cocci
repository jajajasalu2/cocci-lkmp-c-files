...
position p;
@@
 struct ep_send_events_data cocci_id@p ;
...
typedef spinlock_t;
@@
 struct nested_calls {  struct list_head tasks_call_list ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct epitem {  union {  struct rb_node rbn ;  struct rcu_head rcu ; } ;  struct list_head rdllink ;  struct epitem * next ;  struct epoll_filefd ffd ;  int nwait ;  struct list_head pwqlist ;  struct eventpoll * ep ;  struct list_head fllink ;  struct wakeup_source __rcu * ws ;  struct epoll_event event ; } cocci_id@p ;
...
position p;
@@
 struct ep_pqueue {  poll_table pt ;  struct epitem * epi ; } cocci_id@p ;
...
position p;
@@
 struct ep_send_events_data {  int maxevents ;  struct epoll_event __user * events ;  int res ; } cocci_id@p ;
...
position p;
@@
 struct eppoll_entry cocci_id@p ;
...
position p;
@@
 const struct epoll_event * cocci_id@p ;
...
position p;
@@
 struct epoll_filefd * cocci_id@p ;
...
position p;
@@
 const struct epitem * cocci_id@p ;
...
position p;
@@
 struct nested_calls cocci_id@p ;
...
position p;
@@
 struct wakeup_source * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ PATH_ARR_SIZE ] ;
...
position p;
@@
 struct nested_call_node {  struct list_head llink ;  void * cookie ;  void * ctx ; } cocci_id@p ;
...
typedef __poll_t;
@@
 __poll_t ( * cocci_id@p ) ( struct eventpoll * , struct list_head * , void * ) ;
...
@@
 struct eppoll_entry {  struct list_head llink ;  struct epitem * base ;  wait_queue_entry_t wait ;  wait_queue_head_t * whead ; } cocci_id@p ;
...
position p;
@@
 struct nested_call_node cocci_id@p ;
