...
position p;
@@
 struct mwifiex_ie_types_btcoex_scan_time * cocci_id@p ;
...
position p;
@@
 struct mwifiex_tdls_generic_event * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_multi_chan_info cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_mgmt_frame * cocci_id@p ;
...
position p;
@@
 struct mwifiex_fw_dump_header * cocci_id@p ;
...
position p;
@@
 struct mwifiex_tx_pause_tlv * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_btcoex_aggr_win_size * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_mc_group_info * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_11n_batimeout * cocci_id@p ;
