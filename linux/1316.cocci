...
position p;
@@
 struct jumpshot_info {  unsigned long sectors ;  unsigned long ssize ;  unsigned char sense_key ;  unsigned long sense_asc ;  unsigned long sense_ascq ; } cocci_id@p ;
...
position p;
@@
 struct jumpshot_info * cocci_id@p ;
