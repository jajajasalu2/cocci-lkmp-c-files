...
position p;
@@
 struct xrep_agf_allocbt * cocci_id@p ;
...
position p;
@@
 enum { XREP_AGF_BNOBT = 0 , XREP_AGF_CNTBT , XREP_AGF_RMAPBT , XREP_AGF_REFCOUNTBT , XREP_AGF_END , XREP_AGF_MAX , } cocci_id@p ;
...
position p;
@@
 enum { XREP_AGI_INOBT = 0 , XREP_AGI_FINOBT , XREP_AGI_END , XREP_AGI_MAX , } cocci_id@p ;
...
position p;
@@
 struct xrep_find_ag_btree * cocci_id@p ;
...
position p;
@@
 struct xrep_find_ag_btree cocci_id@p [ XREP_AGI_MAX ] ;
...
position p;
@@
 struct xrep_find_ag_btree cocci_id@p [ XREP_AGF_MAX ] ;
...
position p;
@@
 struct xrep_agfl {  struct xfs_bitmap agmetablocks ;  struct xfs_bitmap * freesp ;  struct xfs_scrub * sc ; } cocci_id@p ;
...
position p;
@@
 struct xfs_bitmap_range * cocci_id@p ;
...
typedef xfs_agblock_t;
@@
 struct xrep_agf_allocbt {  struct xfs_scrub * sc ;  xfs_agblock_t freeblks ;  xfs_agblock_t longest ; } cocci_id@p ;
