...
position p;
@@
 struct arizona_ldo1 {  struct regulator_dev * regulator ;  struct regmap * regmap ;  struct regulator_consumer_supply supply ;  struct regulator_init_data init_data ;  struct gpio_desc * ena_gpiod ; } cocci_id@p ;
...
position p;
@@
 struct arizona_ldo1_pdata * cocci_id@p ;
...
position p;
@@
 struct arizona_ldo1 * cocci_id@p ;
