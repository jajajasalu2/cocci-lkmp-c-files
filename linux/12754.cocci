...
position p;
@@
 int ( * cocci_id@p ) ( struct device * , void * ) ;
...
position p;
@@
 struct iommu_gpasid_bind_data * cocci_id@p ;
...
position p;
@@
 struct iommu_group_attribute cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * iommu_data ) ;
...
position p;
@@
 int cocci_id@p ( struct iommu_domain * domain , struct iommu_group * group ) ;
...
position p;
@@
 struct group_device {  struct list_head list ;  struct device * dev ;  char * name ; } cocci_id@p ;
...
position p;
@@
 const struct iommu_sva_ops * cocci_id@p ;
...
position p;
@@
 struct group_device * cocci_id@p ;
...
position p;
@@
 struct iommu_group * cocci_id@p ( struct pci_dev * pdev , unsigned long * devfns ) ;
...
symbol cocci_id;
position p;
typedef iommu_fault_handler_t;
@@
 iommu_fault_handler_t cocci_id@p ;
...
position p;
@@
 struct iommu_cache_invalidate_info * cocci_id@p ;
...
position p;
@@
 struct iommu_fault_page_request * cocci_id@p ;
...
position p;
@@
 struct group_for_pci_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef iommu_dev_fault_handler_t;
@@
 iommu_dev_fault_handler_t cocci_id@p ;
...
position p;
@@
 struct iommu_fault_param * cocci_id@p ;
...
position p;
@@
 struct iommu_page_response * cocci_id@p ;
...
position p;
@@
 struct iommu_group {  struct kobject kobj ;  struct kobject * devices_kobj ;  struct list_head devices ;  struct mutex mutex ;  struct blocking_notifier_head notifier ;  void * iommu_data ;  void ( * iommu_data_release ) ( void * iommu_data ) ;  char * name ;  int id ;  struct iommu_domain * default_domain ;  struct iommu_domain * domain ; } cocci_id@p ;
...
position p;
@@
 struct iommu_domain * cocci_id@p ( struct bus_type * bus , unsigned type ) ;
...
position p;
@@
 struct iommu_domain_geometry * cocci_id@p ;
...
position p;
@@
 struct iommu_fault_event cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct iommu_domain * domain , struct iommu_group * group ) ;
...
position p;
@@
 struct group_for_pci_data {  struct pci_dev * pdev ;  struct iommu_group * group ; } cocci_id@p ;
