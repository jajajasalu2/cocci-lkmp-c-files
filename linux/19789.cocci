...
position p;
@@
 struct pvc_defs cocci_id@p [ N_MACHTYPES ] ;
...
position p;
@@
 struct ds_defs cocci_id@p [ N_MACHTYPES ] ;
...
position p;
@@
 struct lasat_misc cocci_id@p [ N_MACHTYPES ] ;
...
position p;
@@
 void cocci_id@p ( void * , void * , void * ) ;
