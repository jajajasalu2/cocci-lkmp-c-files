...
position p;
@@
 struct sdhci_at91_priv * cocci_id@p ;
...
typedef bool;
@@
 struct sdhci_at91_priv {  struct clk * hclock ;  struct clk * gck ;  struct clk * mainck ;  bool restore_needed ;  bool cal_always_on ; } cocci_id@p ;
