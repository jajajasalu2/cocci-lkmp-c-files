...
position p;
@@
 const hfi1_handle_cnp cocci_id@p [ 2 ] ;
...
position p;
@@
 const rhf_rcv_function_ptr cocci_id@p [ ] ;
...
position p;
@@
 struct hfi1_ib_stats cocci_id@p ;
...
position p;
@@
 struct hfi1_ib_message_header * cocci_id@p ;
...
position p;
@@
 const struct hfi1_ctxtdata * cocci_id@p ;
...
typedef u32;
@@
 struct ps_mdata {  struct hfi1_ctxtdata * rcd ;  u32 rsize ;  u32 maxcnt ;  u32 ps_head ;  u32 ps_tail ;  u32 ps_seq ; } cocci_id@p ;
