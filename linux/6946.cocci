...
position p;
@@
 struct scatterlist cocci_id@p [ 10 ] ;
...
position p;
@@
 struct ms_extra_data_register * cocci_id@p ;
...
position p;
@@
 struct ms_boot_page * cocci_id@p ;
...
position p;
@@
 struct ms_id_register cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct memstick_dev * card , struct memstick_request * * req ) ;
...
position p;
@@
 int cocci_id@p ( struct msb_data * msb ) ;
...
position p;
@@
 const struct chs_entry cocci_id@p [ ] ;
...
position p;
@@
 struct ms_param_register cocci_id@p ;
