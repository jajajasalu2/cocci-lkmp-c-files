...
@@
 struct syncppp {  struct tty_struct * tty ;  unsigned int flags ;  unsigned int rbits ;  int mru ;  spinlock_t xmit_lock ;  spinlock_t recv_lock ;  unsigned long xmit_flags ;  u32 xaccm [ 8 ] ;  u32 raccm ;  unsigned int bytes_sent ;  unsigned int bytes_rcvd ;  struct sk_buff * tpkt ;  unsigned long last_xmit ;  struct sk_buff_head rqueue ;  struct tasklet_struct tsk ;  refcount_t refcnt ;  struct completion dead_cmp ;  struct ppp_channel chan ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct syncppp * ap , const unsigned char * buf , char * flags , int count ) ;
...
position p;
@@
 int cocci_id@p ( struct syncppp * ap ) ;
...
position p;
@@
 struct sk_buff * cocci_id@p ( struct syncppp * ap , struct sk_buff * ) ;
...
position p;
@@
 void cocci_id@p ( struct syncppp * ap ) ;
