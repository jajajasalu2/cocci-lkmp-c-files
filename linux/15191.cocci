...
typedef bool;
@@
 int cocci_id@p ( struct is31fl32xx_priv * priv , bool enable ) ;
...
position p;
@@
 int cocci_id@p ( struct is31fl32xx_priv * priv ) ;
...
position p;
@@
 const struct is31fl32xx_led_data * cocci_id@p ;
...
position p;
@@
 struct is31fl32xx_priv {  const struct is31fl32xx_chipdef * cdef ;  struct i2c_client * client ;  unsigned int num_leds ;  struct is31fl32xx_led_data leds [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct is31fl32xx_priv * cocci_id@p ;
...
position p;
@@
 struct is31fl32xx_led_data * cocci_id@p ;
...
position p;
@@
 const struct is31fl32xx_chipdef * cocci_id@p ;
...
typedef u8;
@@
 struct is31fl32xx_led_data {  struct led_classdev cdev ;  u8 channel ;  struct is31fl32xx_priv * priv ; } cocci_id@p ;
