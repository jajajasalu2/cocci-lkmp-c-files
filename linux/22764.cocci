...
position p;
@@
 void cocci_id@p ( struct snd_emux_voice * vp , int update ) ;
...
position p;
@@
 struct best {  unsigned int time ;  int voice ; } cocci_id@p [ END ] ;
...
position p;
@@
 const struct snd_emux_operators cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_emux * emu , int cmd , int p1 , int p2 ) ;
...
position p;
@@
 struct snd_midi_channel_set * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_emux_voice * vp ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emu8000 * emu , int ch ) ;
...
position p;
@@
 struct snd_emux_port * cocci_id@p ;
...
position p;
@@
 struct snd_midi_channel * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux_voice * vp ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux * emu , int ch ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux * emu , char * buf , int len , int parsed , struct snd_midi_channel_set * chset ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_emux * emu , int type , int mode , const void __user * buf , long len ) ;
...
position p;
@@
 enum { OFF = 0 , RELEASED , PLAYING , END , } cocci_id@p ;
...
position p;
@@
 struct snd_emux_voice * cocci_id@p ( struct snd_emux * emu , struct snd_emux_port * port ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emu8000 * hw , struct snd_emux_voice * vp ) ;
...
position p;
@@
 struct snd_emux_voice * cocci_id@p ;
