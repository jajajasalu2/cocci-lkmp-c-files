...
position p;
@@
 struct sme_populate_pgd_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pmdval_t,pteval_t,pgd_t;
@@
 struct sme_populate_pgd_data {  void * pgtable_area ;  pgd_t * pgd ;  pmdval_t pmd_flags ;  pteval_t pte_flags ;  unsigned long paddr ;  unsigned long vaddr ;  unsigned long vaddr_end ; } cocci_id@p ;
