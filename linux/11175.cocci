...
position p;
@@
 struct dc_reg_value_masks cocci_id@p ;
...
typedef uint32_t;
@@
 struct dc_reg_sequence {  uint32_t addr ;  struct dc_reg_value_masks value_masks ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct dc_reg_value_masks {  uint32_t value ;  uint32_t mask ; } cocci_id@p ;
