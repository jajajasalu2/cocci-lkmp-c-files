...
position p;
@@
 struct iwl_fw_dbg_trigger_tx_status * cocci_id@p ;
...
position p;
@@
 struct iwl_device_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_tx_cmd_gen2 * cocci_id@p ;
...
position p;
@@
 struct iwl_tx_cmd_gen3 cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_ba_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_tx_path_flush_cmd_v1 cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_compressed_ba_tfd * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_compressed_ba_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_tx_path_flush_cmd cocci_id@p ;
