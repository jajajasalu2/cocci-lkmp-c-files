...
position p;
@@
 struct q6afe_dai_priv_data * cocci_id@p ;
...
position p;
@@
 struct q6afe_port_config * cocci_id@p ;
...
position p;
@@
 struct q6afe_dai_data * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ Q6AFE_MAX_MI2S_LINES ] ;
...
typedef uint32_t;
@@
 struct q6afe_dai_priv_data {  uint32_t sd_line_mask ;  uint32_t sync_mode ;  uint32_t sync_src ;  uint32_t data_out_enable ;  uint32_t invert_sync ;  uint32_t data_delay ;  uint32_t data_align ; } cocci_id@p ;
...
typedef bool;
@@
 struct q6afe_dai_data {  struct q6afe_port * port [ AFE_PORT_MAX ] ;  struct q6afe_port_config port_config [ AFE_PORT_MAX ] ;  bool is_port_started [ AFE_PORT_MAX ] ;  struct q6afe_dai_priv_data priv [ AFE_PORT_MAX ] ; } cocci_id@p ;
