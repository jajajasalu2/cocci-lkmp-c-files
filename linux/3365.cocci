...
typedef u32;
@@
 struct atmel_pwm_config {  u32 max_period ;  u32 max_pres ; } cocci_id@p ;
...
position p;
@@
 struct atmel_pwm_chip cocci_id@p ;
...
position p;
@@
 const struct atmel_pwm_data cocci_id@p ;
...
position p;
@@
 struct atmel_pwm_data {  struct atmel_pwm_registers regs ;  struct atmel_pwm_config cfg ; } cocci_id@p ;
...
position p;
@@
 struct atmel_pwm_chip {  struct pwm_chip chip ;  struct clk * clk ;  void __iomem * base ;  const struct atmel_pwm_data * data ;  unsigned int updated_pwms ;  struct mutex isr_lock ; } cocci_id@p ;
...
typedef u8;
@@
 struct atmel_pwm_registers {  u8 period ;  u8 period_upd ;  u8 duty ;  u8 duty_upd ; } cocci_id@p ;
