...
position p;
@@
 struct snd_ca0106_pcm * cocci_id@p ;
...
position p;
@@
 struct snd_ca0106_details cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct snd_ca0106 * chip ) ;
...
position p;
@@
 struct snd_ca0106_channel * cocci_id@p ;
