...
position p;
@@
 struct nfs_callback_data {  unsigned int users ;  struct svc_serv * serv ; } cocci_id@p ;
...
position p;
@@
 struct nfs_callback_data cocci_id@p [ NFS4_MAX_MINOR_VERSION + 1 ] ;
...
position p;
@@
 struct nfs_callback_data * cocci_id@p ;
