...
typedef u32;
@@
 struct ioh_regs {  struct ioh_reg_comn regs [ 8 ] ;  u32 reserve1 [ 16 ] ;  u32 ioh_sel_reg [ 4 ] ;  u32 reserve2 [ 11 ] ;  u32 srst ; } cocci_id@p ;
...
typedef u32;
@@
 struct ioh_gpio_reg_data {  u32 ien_reg ;  u32 imask_reg ;  u32 po_reg ;  u32 pm_reg ;  u32 im0_reg ;  u32 im1_reg ;  u32 use_sel_reg ; } cocci_id@p ;
...
typedef u32;
@@
 struct ioh_reg_comn {  u32 ien ;  u32 istatus ;  u32 idisp ;  u32 iclr ;  u32 imask ;  u32 imaskclr ;  u32 po ;  u32 pi ;  u32 pm ;  u32 im_0 ;  u32 im_1 ;  u32 reserved ; } cocci_id@p ;
...
@@
 struct ioh_gpio {  void __iomem * base ;  struct ioh_regs __iomem * reg ;  struct device * dev ;  struct gpio_chip gpio ;  struct ioh_gpio_reg_data ioh_gpio_reg ;  u32 gpio_use_sel ;  int ch ;  int irq_base ;  spinlock_t spinlock ; } cocci_id@p ;
