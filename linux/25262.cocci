...
position p;
@@
 struct kbuffer_raw_info * cocci_id@p ;
...
position p;
@@
 enum kbuffer_endian cocci_id@p ;
...
position p;
@@
 enum kbuffer_long_size cocci_id@p ;
...
position p;
@@
 enum old_ring_buffer_type { OLD_RINGBUF_TYPE_PADDING , OLD_RINGBUF_TYPE_TIME_EXTEND , OLD_RINGBUF_TYPE_TIME_STAMP , OLD_RINGBUF_TYPE_DATA , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct kbuffer * kbuf ) ;
...
position p;
@@
 enum { KBUFFER_FL_HOST_BIG_ENDIAN = ( 1 << 0 ) , KBUFFER_FL_BIG_ENDIAN = ( 1 << 1 ) , KBUFFER_FL_LONG_8 = ( 1 << 2 ) , KBUFFER_FL_OLD_FORMAT = ( 1 << 3 ) , } cocci_id@p ;
