...
position p;
@@
 const struct mwifiex_pcie_card_reg * cocci_id@p ;
...
position p;
@@
 struct mwifiex_pfu_buf_desc * cocci_id@p ;
...
position p;
@@
 struct mwifiex_msix_context * cocci_id@p ;
...
position p;
@@
 const struct mwifiex_fw_data * cocci_id@p ;
...
position p;
@@
 struct mwifiex_pcie_device * cocci_id@p ;
...
position p;
@@
 struct mwifiex_dma_mapping cocci_id@p ;
...
position p;
@@
 struct mwifiex_pcie_buf_desc * cocci_id@p ;
...
position p;
@@
 struct mwifiex_evt_buf_desc * cocci_id@p ;
...
position p;
@@
 struct memory_type_mapping * cocci_id@p ;
