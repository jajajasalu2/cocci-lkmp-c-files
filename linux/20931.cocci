...
position p;
@@
 struct vhost_user_mem_region * cocci_id@p ;
...
position p;
@@
 struct vhost_user_msg * cocci_id@p ;
...
position p;
@@
 struct virtio_uml_platform_data cocci_id@p ;
...
typedef u32;
@@
 struct virtio_uml_platform_data {  u32 virtio_device_id ;  const char * socket_path ;  struct work_struct conn_broken_wk ;  struct platform_device * pdev ; } cocci_id@p ;
...
position p;
@@
 struct virtio_uml_device cocci_id@p ;
...
typedef u8;
@@
 struct {  struct vhost_user_msg msg ;  u8 extra_payload [ 512 ] ; } cocci_id@p ;
...
position p;
@@
 struct virtio_uml_vq_info * cocci_id@p ;
