...
position p;
@@
 const struct st_lsm6dsx_decimator_entry cocci_id@p [ ] ;
...
position p;
@@
 enum st_lsm6dsx_fifo_mode cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ST_LSM6DSX_SAMPLE_SIZE ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ ST_LSM6DSX_IIO_BUFF_SIZE ] ;
...
position p;
@@
 enum st_lsm6dsx_fifo_tag { ST_LSM6DSX_GYRO_TAG = 0x01 , ST_LSM6DSX_ACC_TAG = 0x02 , ST_LSM6DSX_TS_TAG = 0x04 , ST_LSM6DSX_EXT0_TAG = 0x0f , ST_LSM6DSX_EXT1_TAG = 0x10 , ST_LSM6DSX_EXT2_TAG = 0x11 , } cocci_id@p ;
...
typedef u8;
@@
 struct st_lsm6dsx_decimator_entry {  u8 decimator ;  u8 val ; } cocci_id@p ;
