...
position p;
@@
 enum { MTK_AFE_DAI_MEMIF_RATE_8K = 0 , MTK_AFE_DAI_MEMIF_RATE_16K = 1 , MTK_AFE_DAI_MEMIF_RATE_32K = 2 , MTK_AFE_DAI_MEMIF_RATE_48K = 3 , } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct mtk_base_afe * ) ;
...
position p;
@@
 struct mtk_base_afe_memif * cocci_id@p ;
...
position p;
@@
 const dai_register_cb cocci_id@p [ ] ;
...
position p;
@@
 struct mtk_base_afe_irq * cocci_id@p ;
...
position p;
@@
 const struct mtk_base_irq_data cocci_id@p [ MT8183_IRQ_NUM ] ;
...
position p;
@@
 enum { MTK_AFE_RATE_8K = 0 , MTK_AFE_RATE_11K = 1 , MTK_AFE_RATE_12K = 2 , MTK_AFE_RATE_384K = 3 , MTK_AFE_RATE_16K = 4 , MTK_AFE_RATE_22K = 5 , MTK_AFE_RATE_24K = 6 , MTK_AFE_RATE_130K = 7 , MTK_AFE_RATE_32K = 8 , MTK_AFE_RATE_44K = 9 , MTK_AFE_RATE_48K = 10 , MTK_AFE_RATE_88K = 11 , MTK_AFE_RATE_96K = 12 , MTK_AFE_RATE_176K = 13 , MTK_AFE_RATE_192K = 14 , MTK_AFE_RATE_260K = 15 , } cocci_id@p ;
...
position p;
@@
 enum { MTK_AFE_PCM_RATE_8K = 0 , MTK_AFE_PCM_RATE_16K = 1 , MTK_AFE_PCM_RATE_32K = 2 , MTK_AFE_PCM_RATE_48K = 3 , } cocci_id@p ;
...
position p;
@@
 const struct mtk_base_memif_data cocci_id@p [ MT8183_MEMIF_NUM ] ;
