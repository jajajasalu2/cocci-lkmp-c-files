...
position p;
@@
 struct iommu_table_group_link cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct pnv_ioda_pe * pe , bool enable ) ;
...
position p;
@@
 unsigned long cocci_id@p ( struct pnv_phb * phb ) ;
...
position p;
@@
 long cocci_id@p ( struct iommu_table_group * table_group , int num ) ;
...
position p;
@@
 void cocci_id@p ( struct pnv_ioda_pe * pe , struct iommu_table_group * table_group , struct pci_bus * bus ) ;
...
position p;
@@
 const struct pnv_ioda_pe * cocci_id@p ;
...
position p;
@@
 struct iommu_table_group_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pnv_phb * phb , struct pnv_ioda_pe * pe ) ;
...
position p;
@@
 const struct pci_controller_ops cocci_id@p ;
