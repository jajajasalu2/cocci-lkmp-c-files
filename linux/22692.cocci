...
typedef u8;
@@
 u8 cocci_id@p ( struct parport * p ) ;
...
@@
 struct mts64 {  spinlock_t lock ;  struct snd_card * card ;  struct snd_rawmidi * rmidi ;  struct pardevice * pardev ;  int open_count ;  int current_midi_output_port ;  int current_midi_input_port ;  u8 mode [ MTS64_NUM_INPUT_PORTS ] ;  struct snd_rawmidi_substream * midi_input_substream [ MTS64_NUM_INPUT_PORTS ] ;  int smpte_switch ;  u8 time [ 4 ] ;  u8 fps ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct parport * p ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct parport * p , u8 c ) ;
...
position p;
@@
 int cocci_id@p ( struct mts64 * mts ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct parport * p ) ;
...
position p;
@@
 void cocci_id@p ( struct parport * p ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct parport * p , u8 hours , u8 minutes , u8 seconds , u8 frames , u8 idx ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct mts64 * mts , u8 c , int midiport ) ;
