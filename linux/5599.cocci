...
position p;
@@
 struct tps80031_rtc * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ TPS80031_RTC_TIME_NUM_REGS ] ;
...
position p;
@@
 struct tps80031_rtc {  struct rtc_device * rtc ;  int irq ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ TPS80031_RTC_ALARM_NUM_REGS ] ;
