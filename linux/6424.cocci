...
position p;
@@
 struct tps65090_regulator * cocci_id@p ;
...
position p;
@@
 struct tps65090_regulator_plat_data * cocci_id@p ;
...
position p;
@@
 struct tps65090_platform_data * cocci_id@p ;
...
typedef bool;
@@
 struct tps65090_regulator {  struct device * dev ;  struct regulator_desc * desc ;  struct regulator_dev * rdev ;  bool overcurrent_wait_valid ;  int overcurrent_wait ; } cocci_id@p ;
