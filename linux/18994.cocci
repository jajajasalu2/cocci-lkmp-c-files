...
position p;
@@
 struct kvm_coproc_target_table * cocci_id@p [ KVM_ARM_NUM_TARGETS ] ;
...
position p;
@@
 struct kvm_coproc_target_table * cocci_id@p ;
...
position p;
@@
 const struct coproc_reg * cocci_id@p ;
...
position p;
@@
 struct coproc_params cocci_id@p ;
...
position p;
@@
 const struct coproc_params * cocci_id@p ;
