...
position p;
@@
 struct hci_nokia_neg_hdr * cocci_id@p ;
...
position p;
@@
 struct nokia_bt_dev * cocci_id@p ;
...
position p;
@@
 struct hci_nokia_neg_evt * cocci_id@p ;
...
position p;
@@
 const struct hci_command_hdr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,bdaddr_t;
@@
 struct nokia_bt_dev {  struct hci_uart hu ;  struct serdev_device * serdev ;  struct gpio_desc * reset ;  struct gpio_desc * wakeup_host ;  struct gpio_desc * wakeup_bt ;  unsigned long sysclk_speed ;  int wake_irq ;  struct sk_buff * rx_skb ;  struct sk_buff_head txq ;  bdaddr_t bdaddr ;  int init_error ;  struct completion init_completion ;  u8 man_id ;  u8 ver_id ;  bool initialized ;  bool tx_enabled ;  bool rx_enabled ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hci_uart * hu , struct sk_buff * skb ) ;
...
position p;
@@
 struct hci_nokia_neg_cmd * cocci_id@p ;
...
position p;
@@
 struct hci_nokia_alive_pkt * cocci_id@p ;
...
position p;
@@
 struct hci_nokia_alive_hdr * cocci_id@p ;
