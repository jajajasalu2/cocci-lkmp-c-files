...
position p;
@@
 struct i915_global_object cocci_id@p ;
...
position p;
@@
 struct i915_global_object {  struct i915_global base ;  struct kmem_cache * slab_objects ; } cocci_id@p ;
