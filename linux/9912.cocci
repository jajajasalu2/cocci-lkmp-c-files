...
position p;
@@
 const struct ath9k_percal_data cocci_id@p ;
...
position p;
@@
 struct coeff {  int mag_coeff [ AR9300_MAX_CHAINS ] [ MAX_MEASUREMENT ] [ MAXIQCAL ] ;  int phs_coeff [ AR9300_MAX_CHAINS ] [ MAX_MEASUREMENT ] [ MAXIQCAL ] ;  int iqc_coeff [ 2 ] ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MAX_MEASUREMENT ] [ AR9300_MAX_CHAINS ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ AR9300_MAX_CHAINS ] ;
...
position p;
@@
 struct ath_hw_private_ops * cocci_id@p ;
...
position p;
@@
 struct ath9k_cal_list * cocci_id@p ;
...
position p;
@@
 enum ar9003_cal_types { IQ_MISMATCH_CAL = BIT ( 0 ) , } cocci_id@p ;
