...
position p;
@@
 unsigned long cocci_id@p [ EPOLL_NR_OPS ] ;
...
typedef pthread_t;
@@
 struct worker {  int tid ;  pthread_t thread ;  unsigned long ops [ EPOLL_NR_OPS ] ;  int * fdmap ; } cocci_id@p ;
...
position p;
@@
 enum { OP_EPOLL_ADD , OP_EPOLL_MOD , OP_EPOLL_DEL , EPOLL_NR_OPS , } cocci_id@p ;
...
position p;
@@
 double cocci_id@p [ EPOLL_NR_OPS ] ;
...
position p;
@@
 struct stats cocci_id@p [ EPOLL_NR_OPS ] ;
