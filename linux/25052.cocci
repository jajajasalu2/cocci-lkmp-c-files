...
position p;
@@
 ssize_t ( * cocci_id@p ) ( const struct ieee80211_sub_if_data * , char * , int ) ;
...
position p;
@@
 ssize_t ( * cocci_id@p ) ( struct ieee80211_sub_if_data * , const char * , int ) ;
...
position p;
@@
 const struct ieee80211_sub_if_data * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_if_managed * cocci_id@p ;
