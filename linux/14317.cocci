...
position p;
@@
 struct or51211_state cocci_id@p ;
...
typedef u8,u32;
@@
 struct or51211_state {  struct i2c_adapter * i2c ;  const struct or51211_config * config ;  struct dvb_frontend frontend ;  struct bt878 * bt ;  u8 initialized : 1 ;  u32 snr ;  u32 current_frequency ; } cocci_id@p ;
