...
position p;
@@
 struct p9_trans_module cocci_id@p ;
...
position p;
@@
 struct p9_rdma_context cocci_id@p ;
...
position p;
@@
 struct p9_rdma_opts * cocci_id@p ;
...
typedef bool;
@@
 struct p9_rdma_opts {  short port ;  bool privport ;  int sq_depth ;  int rq_depth ;  long timeout ; } cocci_id@p ;
...
position p;
@@
 struct p9_trans_rdma * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef p9_req_t,dma_addr_t;
@@
 struct p9_rdma_context {  struct ib_cqe cqe ;  dma_addr_t busa ;  union {  struct p9_req_t * req ;  struct p9_fcall rc ; } ; } cocci_id@p ;
