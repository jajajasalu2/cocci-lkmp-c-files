...
typedef uint32_t;
@@
 struct {  uint32_t registerId ;  uint32_t value ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_escape_video_flush * cocci_id@p ;
...
position p;
@@
 struct vmw_escape_video_flush {  struct vmw_escape_header escape ;  SVGAEscapeVideoFlush flush ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct vmw_escape_header {  uint32_t cmd ;  SVGAFifoCmdEscape body ; } cocci_id@p ;
...
position p;
@@
 struct vmw_escape_header * cocci_id@p ;
...
position p;
@@
 const struct vmw_private * cocci_id@p ;
...
position p;
@@
 struct {  struct vmw_escape_header escape ;  SVGAEscapeVideoSetRegs body ;  struct vmw_escape_video_flush flush ; } * cocci_id@p ;
...
typedef uint32_t;
@@
 struct {  struct vmw_escape_header escape ;  struct {  uint32_t cmdType ;  uint32_t streamId ; } header ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_overlay {  struct mutex mutex ;  struct vmw_stream stream [ VMW_MAX_NUM_STREAMS ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct vmw_stream {  struct vmw_buffer_object * buf ;  bool claimed ;  bool paused ;  struct drm_vmw_control_stream_arg saved ; } cocci_id@p ;
