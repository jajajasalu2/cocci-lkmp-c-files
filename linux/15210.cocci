...
position p;
@@
 const struct apu_led_profile cocci_id@p [ ] ;
...
position p;
@@
 struct apu_led_pdata * cocci_id@p ;
...
position p;
@@
 struct apu_led_priv {  struct led_classdev cdev ;  struct apu_param param ; } cocci_id@p ;
...
position p;
@@
 struct apu_led_profile {  const char * name ;  enum led_brightness brightness ;  unsigned long offset ; } cocci_id@p ;
...
position p;
@@
 struct apu_led_priv * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct apu_led_pdata {  struct platform_device * pdev ;  struct apu_led_priv * pled ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct apu_param {  void __iomem * addr ; } cocci_id@p ;
