...
position p;
@@
 struct ocrdma_rx_dbg_stats * cocci_id@p ;
...
position p;
@@
 struct ocrdma_tx_qp_err_stats * cocci_id@p ;
...
position p;
@@
 struct ocrdma_db_err_stats * cocci_id@p ;
...
position p;
@@
 struct ocrdma_tx_stats * cocci_id@p ;
...
position p;
@@
 struct ocrdma_stats * cocci_id@p ;
...
position p;
@@
 struct ocrdma_rx_qp_err_stats * cocci_id@p ;
...
position p;
@@
 struct ocrdma_wqe_stats * cocci_id@p ;
...
position p;
@@
 struct ocrdma_tx_dbg_stats * cocci_id@p ;
...
position p;
@@
 struct ocrdma_rsrc_stats * cocci_id@p ;
...
position p;
@@
 struct ocrdma_rx_stats * cocci_id@p ;
