...
position p;
@@
 struct omapfb_device * cocci_id@p ;
...
position p;
@@
 struct omapfb_update_window cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ OMAPFB_PLANE_NUM ] ;
...
position p;
@@
 struct omapfb_plane_struct * cocci_id@p ;
...
position p;
@@
 struct omapfb_plane_info * cocci_id@p ;
...
position p;
@@
 struct omapfb_update_window_old cocci_id@p ;
...
position p;
@@
 union {  struct omapfb_update_window update_window ;  struct omapfb_plane_info plane_info ;  struct omapfb_mem_info mem_info ;  struct omapfb_color_key color_key ;  enum omapfb_update_mode update_mode ;  struct omapfb_caps caps ;  unsigned int mirror ;  int plane_out ;  int enable_plane ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef omapfb_notifier_callback_t;
@@
 omapfb_notifier_callback_t cocci_id@p ;
...
position p;
@@
 struct omapfb_color_key * cocci_id@p ;
...
position p;
@@
 struct blocking_notifier_head cocci_id@p [ OMAPFB_PLANE_NUM ] ;
...
position p;
@@
 enum omapfb_update_mode cocci_id@p ;
...
position p;
@@
 struct omapfb_mem_region * cocci_id@p ;
...
position p;
@@
 const struct lcd_ctrl * cocci_id@p [ ] ;
...
position p;
@@
 struct lcd_ctrl_extif cocci_id@p ;
...
position p;
@@
 struct caps_table_struct {  unsigned long flag ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct omapfb_mem_info * cocci_id@p ;
...
position p;
@@
 struct omapfb_platform_data * cocci_id@p ;
...
position p;
@@
 const struct caps_table_struct cocci_id@p [ ] ;
...
position p;
@@
 struct omapfb_notifier_block * cocci_id@p ;
