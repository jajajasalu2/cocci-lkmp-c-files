...
typedef u32;
@@
 struct sti_vtg_regs_offs {  u32 h_hd ;  u32 top_v_vd ;  u32 bot_v_vd ;  u32 top_v_hd ;  u32 bot_v_hd ; } cocci_id@p ;
...
typedef u32;
@@
 struct sti_vtg_sync_params {  u32 hsync ;  u32 vsync_line_top ;  u32 vsync_line_bot ;  u32 vsync_off_top ;  u32 vsync_off_bot ; } cocci_id@p ;
...
position p;
@@
 struct sti_vtg_sync_params * cocci_id@p ;
...
position p;
@@
 const struct sti_vtg_regs_offs cocci_id@p [ VTG_MAX_SYNC_OUTPUT ] ;
...
typedef u32;
@@
 struct sti_vtg {  void __iomem * regs ;  struct sti_vtg_sync_params sync_params [ VTG_MAX_SYNC_OUTPUT ] ;  int irq ;  u32 irq_status ;  struct raw_notifier_head notifier_list ;  struct drm_crtc * crtc ; } cocci_id@p ;
