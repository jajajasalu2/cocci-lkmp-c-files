...
position p;
@@
 struct sa1100_gpio_chip cocci_id@p ;
...
position p;
@@
 enum { R_GPLR = 0x00 , R_GPDR = 0x04 , R_GPSR = 0x08 , R_GPCR = 0x0c , R_GRER = 0x10 , R_GFER = 0x14 , R_GEDR = 0x18 , R_GAFR = 0x1c , } cocci_id@p ;
...
typedef u32;
@@
 struct sa1100_gpio_chip {  struct gpio_chip chip ;  void __iomem * membase ;  int irqbase ;  u32 irqmask ;  u32 irqrising ;  u32 irqfalling ;  u32 irqwake ; } cocci_id@p ;
