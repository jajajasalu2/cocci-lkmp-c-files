...
position p;
@@
 struct cooling_dev_stats * cocci_id@p ;
...
position p;
@@
 struct thermal_instance * cocci_id@p ;
...
@@
 struct cooling_dev_stats {  spinlock_t lock ;  unsigned int total_trans ;  unsigned long state ;  unsigned long max_states ;  ktime_t last_time ;  ktime_t * time_in_state ;  unsigned int * trans_table ; } cocci_id@p ;
