...
typedef u8;
@@
 struct ks0127 {  struct v4l2_subdev sd ;  v4l2_std_id norm ;  u8 regs [ 256 ] ; } cocci_id@p ;
...
position p;
@@
 struct adjust {  int contrast ;  int bright ;  int hue ;  int ugain ;  int vgain ; } cocci_id@p ;
