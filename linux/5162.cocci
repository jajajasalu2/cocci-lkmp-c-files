...
position p;
@@
 struct lpc32xx_gpio_chip cocci_id@p [ ] ;
...
position p;
@@
 struct lpc32xx_gpio_chip {  struct gpio_chip chip ;  struct gpio_regs * gpio_grp ;  void __iomem * reg_base ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ LPC32XX_GPI_P3_MAX ] ;
...
position p;
@@
 struct gpio_regs {  unsigned long inp_state ;  unsigned long outp_state ;  unsigned long outp_set ;  unsigned long outp_clr ;  unsigned long dir_set ;  unsigned long dir_clr ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ LPC32XX_GPO_P3_MAX ] ;
...
position p;
@@
 const char * cocci_id@p [ LPC32XX_GPIO_P2_MAX ] ;
...
position p;
@@
 const char * cocci_id@p [ LPC32XX_GPIO_P0_MAX ] ;
...
position p;
@@
 const char * cocci_id@p [ LPC32XX_GPIO_P1_MAX ] ;
...
position p;
@@
 const char * cocci_id@p [ LPC32XX_GPIO_P3_MAX ] ;
