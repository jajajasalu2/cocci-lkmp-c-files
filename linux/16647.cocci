...
position p;
@@
 struct qdio_ssqd_desc * cocci_id@p ;
...
position p;
@@
 struct chsc_brinfo_naihdr cocci_id@p ;
...
position p;
@@
 enum qdio_irq_states cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * priv , enum qdio_brinfo_entry_type type , void * entry ) ;
...
position p;
@@
 struct qdio_brinfo_entry_l3_ipv4 cocci_id@p ;
...
position p;
@@
 struct qdio_brinfo_entry_l3_ipv6 cocci_id@p ;
...
position p;
@@
 struct qdio_output_q * cocci_id@p ;
