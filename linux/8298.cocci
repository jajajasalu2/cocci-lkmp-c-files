...
position p;
@@
 enum { CH_8139 = 0 , CH_8139_K , CH_8139A , CH_8139A_G , CH_8139B , CH_8130 , CH_8139C , CH_8100 , CH_8100B_8139D , CH_8101 , } cocci_id@p ;
...
position p;
@@
 enum IntrStatusBits { PCIErr = 0x8000 , PCSTimeout = 0x4000 , RxFIFOOver = 0x40 , RxUnderrun = 0x20 , RxOverflow = 0x10 , TxErr = 0x08 , TxOK = 0x04 , RxErr = 0x02 , RxOK = 0x01 , RxAckBits = RxFIFOOver | RxOverflow | RxOK , } cocci_id@p ;
...
position p;
@@
 enum tx_config_bits { TxIFGShift = 24 , TxIFG84 = ( 0 << TxIFGShift ) , TxIFG88 = ( 1 << TxIFGShift ) , TxIFG92 = ( 2 << TxIFGShift ) , TxIFG96 = ( 3 << TxIFGShift ) , TxLoopBack = ( 1 << 18 ) | ( 1 << 17 ) , TxCRC = ( 1 << 16 ) , TxClearAbt = ( 1 << 0 ) , TxDMAShift = 8 , TxRetryShift = 4 , TxVersionMask = 0x7C800000 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int phy_id , int location , int val ) ;
...
position p;
@@
 enum ChipCmdBits { CmdReset = 0x10 , CmdRxEnb = 0x08 , CmdTxEnb = 0x04 , RxBufEmpty = 0x01 , } cocci_id@p ;
...
position p;
@@
 struct rtl_extra_stats {  unsigned long early_rx ;  unsigned long tx_buf_mapped ;  unsigned long tx_timeouts ;  unsigned long rx_lost_in_ring ; } cocci_id@p ;
...
position p;
@@
 enum Config5Bits { Cfg5_PME_STS = ( 1 << 0 ) , Cfg5_LANWake = ( 1 << 1 ) , Cfg5_LDPS = ( 1 << 2 ) , Cfg5_FIFOAddrPtr = ( 1 << 3 ) , Cfg5_UWF = ( 1 << 4 ) , Cfg5_MWF = ( 1 << 5 ) , Cfg5_BWF = ( 1 << 6 ) , } cocci_id@p ;
...
position p;
@@
 const unsigned long cocci_id@p [ 4 ] [ 4 ] ;
...
typedef u32;
@@
 const struct {  const char * name ;  u32 hw_flags ; } cocci_id@p [ ] ;
...
position p;
@@
 enum { RTL8139 = 0 , RTL8129 , } cocci_id@p ;
...
position p;
@@
 const struct {  unsigned long mask ;  char * type ; } cocci_id@p [ ] ;
...
position p;
@@
 enum rx_mode_bits { AcceptErr = 0x20 , AcceptRunt = 0x10 , AcceptBroadcast = 0x08 , AcceptMulticast = 0x04 , AcceptMyPhys = 0x02 , AcceptAllPhys = 0x01 , } cocci_id@p ;
...
position p;
@@
 enum RxStatusBits { RxMulticast = 0x8000 , RxPhysical = 0x4000 , RxBroadcast = 0x2000 , RxBadSymbol = 0x0020 , RxRunt = 0x0010 , RxTooLong = 0x0008 , RxCRCErr = 0x0004 , RxBadAlign = 0x0002 , RxStatusOK = 0x0001 , } cocci_id@p ;
...
position p;
@@
 enum TxStatusBits { TxHostOwns = 0x2000 , TxUnderrun = 0x4000 , TxStatOK = 0x8000 , TxOutOfWindow = 0x20000000 , TxAborted = 0x40000000 , TxCarrierLost = 0x80000000 , } cocci_id@p ;
...
position p;
@@
 enum Config3Bits { Cfg3_FBtBEn = ( 1 << 0 ) , Cfg3_FuncRegEn = ( 1 << 1 ) , Cfg3_CLKRUN_En = ( 1 << 2 ) , Cfg3_CardB_En = ( 1 << 3 ) , Cfg3_LinkUp = ( 1 << 4 ) , Cfg3_Magic = ( 1 << 5 ) , Cfg3_PARM_En = ( 1 << 6 ) , Cfg3_GNTSel = ( 1 << 7 ) , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct napi_struct * napi , int budget ) ;
...
position p;
@@
 void cocci_id@p ( struct rtl8139_private * tp ) ;
...
position p;
@@
 enum Config1Bits { Cfg1_PM_Enable = 0x01 , Cfg1_VPD_Enable = 0x02 , Cfg1_PIO = 0x04 , Cfg1_MMIO = 0x08 , LWAKE = 0x10 , Cfg1_Driver_Load = 0x20 , Cfg1_LED0 = 0x40 , Cfg1_LED1 = 0x80 , SLEEP = ( 1 << 1 ) , PWRDN = ( 1 << 0 ) , } cocci_id@p ;
...
position p;
@@
 enum TwisterParamVals { PARA78_default = 0x78fa8388 , PARA7c_default = 0xcb38de43 , PARA7c_xxx = 0xcb38de43 , } cocci_id@p ;
...
typedef u64;
@@
 struct rtl8139_stats {  u64 packets ;  u64 bytes ;  struct u64_stats_sync syncp ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , void * p ) ;
...
position p;
@@
 enum CSCRBits { CSCR_LinkOKBit = 0x0400 , CSCR_LinkChangeBit = 0x0800 , CSCR_LinkStatusBits = 0x0f000 , CSCR_LinkDownOffCmd = 0x003c0 , CSCR_LinkDownCmd = 0x0f3c0 , } cocci_id@p ;
...
position p;
@@
 struct rtl8139_private cocci_id@p ;
...
position p;
@@
 enum { HAS_MII_XCVR = 0x010000 , HAS_CHIP_XCVR = 0x020000 , HAS_LNK_CHNG = 0x040000 , } cocci_id@p ;
...
position p;
@@
 enum RxConfigBits { RxCfgFIFOShift = 13 , RxCfgFIFONone = ( 7 << RxCfgFIFOShift ) , RxCfgDMAShift = 8 , RxCfgDMAUnlimited = ( 7 << RxCfgDMAShift ) , RxCfgRcv8K = 0 , RxCfgRcv16K = ( 1 << 11 ) , RxCfgRcv32K = ( 1 << 12 ) , RxCfgRcv64K = ( 1 << 11 ) | ( 1 << 12 ) , RxNoWrap = ( 1 << 7 ) , } cocci_id@p ;
...
position p;
@@
 enum Cfg9346Bits { Cfg9346_Lock = 0x00 , Cfg9346_Unlock = 0xC0 , } cocci_id@p ;
...
position p;
@@
 enum Config4Bits { LWPTN = ( 1 << 2 ) , } cocci_id@p ;
...
position p;
@@
 struct {  const char str [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( void __iomem * ioaddr , int location , int addr_len ) ;
...
position p;
@@
 enum chip_flags { HasHltClk = ( 1 << 0 ) , HasLWake = ( 1 << 1 ) , } cocci_id@p ;
...
typedef u32;
@@
 const struct {  const char * name ;  u32 version ;  u32 flags ; } cocci_id@p [ ] ;
...
position p;
@@
 enum ClearBitMasks { MultiIntrClear = 0xF000 , ChipCmdClear = 0xE2 , Config1Clear = ( 1 << 7 ) | ( 1 << 6 ) | ( 1 << 3 ) | ( 1 << 2 ) | ( 1 << 1 ) , } cocci_id@p ;
