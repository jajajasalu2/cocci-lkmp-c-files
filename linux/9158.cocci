...
position p;
@@
 struct objagg_hints * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_erp_mask * cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_sp_acl_erp {  struct mlxsw_sp_acl_erp_key key ;  u8 id ;  u8 index ; 
	 DECLARE_BITMAP ( mask_bitmap , MLXSW_SP_ACL_TCAM_MASK_LEN ) 
		 ;  struct list_head list ;  struct mlxsw_sp_acl_erp_table * erp_table ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_erp_table_ops cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_erp_key * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_erp_delta cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlxsw_sp_acl_erp_table * erp_table , struct mlxsw_sp_acl_erp * erp ) ;
...
position p;
@@
 struct mlxsw_sp_acl_erp_master_mask * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam_entry * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_erp_table {  struct mlxsw_sp_acl_erp_master_mask master_mask ; 
...
position p;
@@
 struct mlxsw_sp_acl_erp * cocci_id@p ( struct mlxsw_sp_acl_erp_table * erp_table , struct mlxsw_sp_acl_erp_key * key ) ;
...
position p;
@@
 const struct mlxsw_sp_acl_erp * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_erp_mask * cocci_id@p ;
...
position p;
@@
 const struct objagg_ops cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PTCEX_FLEX_KEY_BLOCKS_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_acl_erp_key * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam_region * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_erp cocci_id@p ;
...
@@
 struct mlxsw_sp_acl_erp_master_mask { 
	 DECLARE_BITMAP ( bitmap , MLXSW_SP_ACL_TCAM_MASK_LEN ) 
		 ;  unsigned int count [ MLXSW_SP_ACL_TCAM_MASK_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_erp_delta * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_erp_table * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PERPT_LEN ] ;
...
typedef u8,u16;
@@
 struct mlxsw_sp_acl_erp_delta {  struct mlxsw_sp_acl_erp_key key ;  u16 start ;  u8 mask ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_erp_core {  unsigned int erpt_entries_size [ MLXSW_SP_ACL_ATCAM_REGION_TYPE_MAX + 1 ] ;  struct gen_pool * erp_tables ;  struct mlxsw_sp * mlxsw_sp ;  struct mlxsw_sp_acl_bf * bf ;  unsigned int num_erp_banks ; } cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_acl_atcam_region_type cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_erp_core * cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_perpt_key_size cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_erp_table * cocci_id@p ;
...
position p;
@@
 const struct objagg_stats * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PERCR_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PERERP_LEN ] ;
