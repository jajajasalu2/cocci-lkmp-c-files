...
typedef u32;
@@
 struct eps_cpu_data {  u32 fsb ; #if IS_ENABLED(CONFIG_ACPI_PROCESSOR)  u32 bios_limit ; #endif  struct cpufreq_frequency_table freq_table [ ] ; } cocci_id@p ;
...
position p;
@@
 struct eps_cpu_data * cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct eps_cpu_data * cocci_id@p ;
