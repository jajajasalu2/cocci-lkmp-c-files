...
position p;
@@
 struct ge_b850v3_lvds {  struct drm_connector connector ;  struct drm_bridge bridge ;  struct i2c_client * stdp4028_i2c ;  struct i2c_client * stdp2690_i2c ;  struct edid * edid ; } cocci_id@p ;
...
position p;
@@
 struct ge_b850v3_lvds * cocci_id@p ;
