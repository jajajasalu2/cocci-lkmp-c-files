...
position p;
@@
 struct das6402_boardinfo cocci_id@p [ ] ;
...
position p;
@@
 struct das6402_boardinfo {  const char * name ;  unsigned int maxdata ; } cocci_id@p ;
...
position p;
@@
 struct das6402_private {  unsigned int irq ;  unsigned int ao_range ; } cocci_id@p ;
...
position p;
@@
 const struct das6402_boardinfo * cocci_id@p ;
...
position p;
@@
 struct das6402_private * cocci_id@p ;
