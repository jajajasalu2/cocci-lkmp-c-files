...
position p;
@@
 struct sd {  struct gspca_dev gspca_dev ;  const struct v4l2_pix_format * cap_mode ;  struct work_struct work_struct ;  struct workqueue_struct * work_thread ; } cocci_id@p ;
