...
position p;
@@
 struct ti_sysc_module_data * cocci_id@p ;
...
position p;
@@
 const struct sysc_regbits cocci_id@p ;
...
position p;
@@
 const struct sysc_capabilities cocci_id@p ;
...
position p;
@@
 const struct sysc_revision_quirk * cocci_id@p ;
...
typedef u64,u32;
@@
 struct sysc {  struct device * dev ;  u64 module_pa ;  u32 module_size ;  void __iomem * module_va ;  int offsets [ SYSC_MAX_REGS ] ;  struct ti_sysc_module_data * mdata ;  struct clk * * clocks ;  const char * * clock_roles ;  int nr_clocks ;  struct reset_control * rsts ;  const char * legacy_mode ;  const struct sysc_capabilities * cap ;  struct sysc_config cfg ;  struct ti_sysc_cookie cookie ;  const char * name ;  u32 revision ;  unsigned int enabled : 1 ;  unsigned int needs_resume : 1 ;  unsigned int child_needs_resume : 1 ;  struct delayed_work idle_work ;  void ( * clk_enable_quirk ) ( struct sysc * sysc ) ;  void ( * clk_disable_quirk ) ( struct sysc * sysc ) ;  void ( * reset_done_quirk ) ( struct sysc * sysc ) ;  void ( * module_enable_quirk ) ( struct sysc * sysc ) ;  void ( * module_disable_quirk ) ( struct sysc * sysc ) ; } cocci_id@p ;
...
position p;
@@
 const struct sysc_dts_quirk cocci_id@p [ ] ;
...
typedef u32;
@@
 struct sysc_dts_quirk {  const char * name ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 enum sysc_clocks { SYSC_FCK , SYSC_ICK , SYSC_OPTFCK0 , SYSC_OPTFCK1 , SYSC_OPTFCK2 , SYSC_OPTFCK3 , SYSC_OPTFCK4 , SYSC_OPTFCK5 , SYSC_OPTFCK6 , SYSC_OPTFCK7 , SYSC_MAX_CLOCKS , } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ SYSC_MAX_CLOCKS ] ;
...
position p;
@@
 struct ti_sysc_platform_data * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct sysc * ddata , struct device_node * np , bool is_child ) ;
...
typedef u32;
@@
 struct sysc_revision_quirk {  const char * name ;  u32 base ;  int rev_offset ;  int sysc_offset ;  int syss_offset ;  u32 revision ;  u32 revision_mask ;  u32 quirks ; } cocci_id@p ;
...
position p;
@@
 enum sysc_registers cocci_id@p ;
