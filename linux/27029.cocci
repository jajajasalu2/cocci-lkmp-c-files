...
position p;
@@
 struct xfs_alloc_cur * cocci_id@p ;
...
position p;
@@
 struct xfs_alloc_query_range_info {  xfs_alloc_query_range_fn fn ;  void * priv ; } cocci_id@p ;
...
position p;
@@
 union xfs_btree_irec cocci_id@p ;
...
position p;
@@
 enum xfs_ag_resv_type cocci_id@p ;
...
position p;
@@
 struct xfs_alloc_rec_incore cocci_id@p ;
...
@@
 int cocci_id@p ( xfs_alloc_arg_t * ) ;
...
position p;
@@
 struct xfs_alloc_query_range_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,xfs_extlen_t,xfs_agblock_t;
@@
 struct xfs_alloc_cur {  struct xfs_btree_cur * cnt ;  struct xfs_btree_cur * bnolt ;  struct xfs_btree_cur * bnogt ;  xfs_extlen_t cur_len ;  xfs_agblock_t rec_bno ;  xfs_extlen_t rec_len ;  xfs_agblock_t bno ;  xfs_extlen_t len ;  xfs_extlen_t diff ;  unsigned int busy_gen ;  bool busy ; } cocci_id@p ;
...
typedef uint8_t;
@@
 const uint8_t cocci_id@p [ XFS_BTNUM_AGF ] ;
...
position p;
@@
 xfs_alloc_query_range_fn cocci_id@p ;
