...
position p;
@@
 struct memmap_init_callback_data cocci_id@p ;
...
position p;
@@
 struct memmap_init_callback_data {  struct page * start ;  struct page * end ;  int nid ;  unsigned long zone ; } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ NR_syscalls ] ;
