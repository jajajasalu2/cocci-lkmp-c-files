...
position p;
@@
 struct ttm_object_device * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ttm_base_object * , enum ttm_ref_type ref_type ) ;
...
position p;
@@
 struct ttm_ref_object {  struct rcu_head rcu_head ;  struct drm_hash_item hash ;  struct list_head head ;  struct kref kref ;  enum ttm_ref_type ref_type ;  struct ttm_base_object * obj ;  struct ttm_object_file * tfile ; } cocci_id@p ;
...
position p;
@@
 struct ttm_prime_object cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dma_buf * dma_buf ) ;
...
position p;
@@
 struct ttm_ref_object cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ttm_base_object * * ) ;
...
position p;
@@
 struct drm_open_hash * cocci_id@p ;
...
position p;
@@
 enum ttm_object_type cocci_id@p ;
...
typedef spinlock_t;
@@
 struct ttm_object_file {  struct ttm_object_device * tdev ;  spinlock_t lock ;  struct list_head ref_list ;  struct drm_open_hash ref_hash [ TTM_REF_NUM ] ;  struct kref refcount ; } cocci_id@p ;
...
@@
 struct ttm_object_device {  spinlock_t object_lock ;  struct drm_open_hash object_hash ;  atomic_t object_count ;  struct ttm_mem_global * mem_glob ;  struct dma_buf_ops ops ;  void ( * dmabuf_release ) ( struct dma_buf * dma_buf ) ;  size_t dma_buf_size ;  struct idr idr ; } cocci_id@p ;
...
position p;
@@
 void __releases ( tfile -> lock ) __acquires ( tfile -> lock ) cocci_id@p ;
...
position p;
@@
 struct drm_hash_item * cocci_id@p ;
