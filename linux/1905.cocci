...
position p;
@@
 enum { TI_ADC141S626 , TI_ADC161S626 , } cocci_id@p ;
...
typedef u8;
@@
 struct ti_adc_data {  struct iio_dev * indio_dev ;  struct spi_device * spi ;  struct regulator * ref ;  u8 read_size ;  u8 shift ;  u8 buffer [ 16 ] ____cacheline_aligned ; } cocci_id@p ;
