...
position p;
@@
 struct via_memblock * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_agp_t;
@@
 drm_via_agp_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_mem_t;
@@
 drm_via_mem_t * cocci_id@p ;
...
position p;
@@
 struct via_memblock {  struct drm_mm_node mm_node ;  struct list_head owner_list ; } cocci_id@p ;
...
position p;
@@
 struct via_file_private * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_fb_t;
@@
 drm_via_fb_t * cocci_id@p ;
