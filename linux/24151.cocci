...
position p;
@@
 struct raw_iter_state cocci_id@p ;
...
position p;
@@
 struct raw6_frag_vec * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sock * sock , struct sk_buff * skb ) ;
...
position p;
@@
 struct raw_hashinfo cocci_id@p ;
...
position p;
@@
 struct icmp6_filter cocci_id@p ;
...
position p;
@@
 struct raw6_frag_vec {  struct msghdr * msg ;  int hlen ;  char c [ 4 ] ; } cocci_id@p ;
