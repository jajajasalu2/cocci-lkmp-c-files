...
position p;
@@
 struct devstate_stat_reg * cocci_id@p ;
...
typedef u32;
@@
 struct rmii_reset_reg {  u32 reg ;  u32 mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct locked_reg {  u32 reg ;  u32 lockreg ;  u32 key ; } cocci_id@p ;
...
position p;
@@
 struct devstate_info {  struct devstate_ctl_reg * ctl ;  struct devstate_stat_reg * stat ; } cocci_id@p ;
...
position p;
@@
 struct dscr_ops {  void ( * init ) ( struct device_node * node ) ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct devstate_ctl_reg {  u32 reg ;  u8 start_id ;  u8 num_ids ;  u8 enable_only ;  u8 enable ;  u8 disable ;  u8 shift ;  u8 nbits ; } cocci_id@p ;
...
@@
 struct dscr_regs {  spinlock_t lock ;  void __iomem * base ;  u32 kick_reg [ 2 ] ;  u32 kick_key [ 2 ] ;  struct locked_reg locked [ MAX_LOCKED_REGS ] ;  struct devstate_info devstate_info [ MAX_DEVSTATE_IDS ] ;  struct rmii_reset_reg rmii_resets [ MAX_SOC_EMACS ] ;  struct devstate_ctl_reg devctl [ MAX_DEVCTL_REGS ] ;  struct devstate_stat_reg devstat [ MAX_DEVSTAT_REGS ] ; } cocci_id@p ;
...
position p;
@@
 struct devstate_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dscr_devstate_t;
@@
 enum dscr_devstate_t cocci_id@p ;
...
typedef u8,u32;
@@
 struct devstate_stat_reg {  u32 reg ;  u8 start_id ;  u8 num_ids ;  u8 enable ;  u8 disable ;  u8 shift ;  u8 nbits ; } cocci_id@p ;
...
position p;
@@
 struct devstate_ctl_reg * cocci_id@p ;
...
position p;
@@
 struct rmii_reset_reg * cocci_id@p ;
