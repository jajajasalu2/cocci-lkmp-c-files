...
position p;
@@
 struct boot_param_header * cocci_id@p ;
...
typedef bool;
@@
 struct platform_support {  bool hash_mmu ;  bool radix_mmu ;  bool radix_gtse ;  bool xive ; } cocci_id@p ;
...
position p;
@@
 struct option_vector6 cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct prom_args * ) ;
...
typedef __be64;
@@
 struct mem_map_entry {  __be64 base ;  __be64 size ; } cocci_id@p ;
...
position p;
@@
 struct option_vector4 cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long dest , unsigned long src , unsigned long size , unsigned long offset ) ;
...
position p;
@@
 void cocci_id@p ( unsigned long r3 , unsigned long r4 , unsigned long r5 , unsigned long r6 , unsigned long r7 , unsigned long r8 , unsigned long r9 ) ;
...
position p;
@@
 int cocci_id@p ( struct prom_args * args , unsigned long entry ) ;
...
position p;
@@
 struct option_vector2 cocci_id@p ;
...
position p;
@@
 struct platform_support * cocci_id@p ;
...
typedef __be32;
@@
 struct prom_args {  __be32 service ;  __be32 nargs ;  __be32 nret ;  __be32 args [ 10 ] ; } cocci_id@p ;
...
typedef u32;
@@
 const struct fake_elf {  Elf32_Ehdr elfhdr ;  Elf32_Phdr phdr [ 2 ] ;  struct chrpnote {  u32 namesz ;  u32 descsz ;  u32 type ;  char name [ 8 ] ;  struct chrpdesc {  u32 real_mode ;  u32 real_base ;  u32 real_size ;  u32 virt_base ;  u32 virt_size ;  u32 load_base ; } chrpdesc ; } chrpnote ;  struct rpanote {  u32 namesz ;  u32 descsz ;  u32 type ;  char name [ 24 ] ;  struct rpadesc {  u32 lpar_affinity ;  u32 min_rmo_size ;  u32 min_rmo_percent ;  u32 max_pft_size ;  u32 splpar ;  u32 min_load ;  u32 new_mem_def ;  u32 ignore_me ; } rpadesc ; } rpanote ; } cocci_id@p ;
...
position p;
@@
 struct option_vector3 cocci_id@p ;
...
typedef prom_t;
@@
 struct prom_t {  ihandle root ;  phandle chosen ;  int cpu ;  ihandle stdout ;  ihandle mmumap ;  ihandle memory ; } cocci_id@p ;
...
position p;
@@
 struct option_vector5 cocci_id@p ;
...
position p;
@@
 const struct ibm_arch_vec cocci_id@p ;
...
position p;
@@
 struct option_vector1 cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( val ) * 2 + 1 ] ;
