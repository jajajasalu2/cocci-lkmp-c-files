...
typedef dma_addr_t;
@@
 struct safe_buffer {  struct list_head node ;  void * ptr ;  size_t size ;  int direction ;  struct dmabounce_pool * pool ;  void * safe ;  dma_addr_t safe_dma_addr ; } cocci_id@p ;
...
position p;
@@
 struct dmabounce_pool * cocci_id@p ;
...
position p;
@@
 struct dmabounce_device_info * cocci_id@p ;
