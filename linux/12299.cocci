...
position p;
@@
 enum ili9881c_op { ILI9881C_SWITCH_PAGE , ILI9881C_COMMAND , } cocci_id@p ;
...
position p;
@@
 struct ili9881c {  struct drm_panel panel ;  struct mipi_dsi_device * dsi ;  struct backlight_device * backlight ;  struct regulator * power ;  struct gpio_desc * reset ; } cocci_id@p ;
...
typedef u8;
@@
 struct ili9881c_instr {  enum ili9881c_op op ;  union arg {  struct cmd {  u8 cmd ;  u8 data ; } cmd ;  u8 page ; } arg ; } cocci_id@p ;
...
position p;
@@
 const struct ili9881c_instr * cocci_id@p ;
