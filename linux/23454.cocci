...
position p;
@@
 struct cs35l33_private * cocci_id@p ;
...
position p;
@@
 struct cs35l33_pdata * cocci_id@p ;
...
typedef u8;
@@
 struct cs35l33_mclk_div {  int mclk ;  int srate ;  u8 adsp_rate ;  u8 int_fs_ratio ; } cocci_id@p ;
...
typedef bool;
@@
 struct cs35l33_private {  struct snd_soc_component * component ;  struct cs35l33_pdata pdata ;  struct regmap * regmap ;  struct gpio_desc * reset_gpio ;  bool amp_cal ;  int mclk_int ;  struct regulator_bulk_data core_supplies [ 2 ] ;  int num_core_supplies ;  bool is_tdm_mode ;  bool enable_soft_ramp ; } cocci_id@p ;
...
position p;
@@
 const struct cs35l33_mclk_div cocci_id@p [ ] ;
