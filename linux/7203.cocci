...
position p;
@@
 struct nvmet_rdma_cmd * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ib_cq * cq , struct ib_wc * wc ) ;
...
position p;
@@
 enum nvmet_rdma_queue_state { NVMET_RDMA_Q_CONNECTING , NVMET_RDMA_Q_LIVE , NVMET_RDMA_Q_DISCONNECTING , } cocci_id@p ;
...
position p;
@@
 struct nvmet_rdma_device cocci_id@p ;
...
position p;
@@
 struct nvme_rdma_cm_req * cocci_id@p ;
...
position p;
@@
 struct nvme_rdma_cm_rej cocci_id@p ;
...
position p;
@@
 enum { NVMET_RDMA_REQ_INLINE_DATA = ( 1 << 0 ) , NVMET_RDMA_REQ_INVALIDATE_RKEY = ( 1 << 1 ) , } cocci_id@p ;
...
position p;
@@
 struct nvme_keyed_sgl_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct nvmet_rdma_device * ndev , struct nvmet_rdma_rsp * r ) ;
...
position p;
@@
 struct nvmet_rdma_rsp * cocci_id@p ;
...
position p;
@@
 struct nvmet_rdma_cmd {  struct ib_sge sge [ NVMET_RDMA_MAX_INLINE_SGE + 1 ] ;  struct ib_cqe cqe ;  struct ib_recv_wr wr ;  struct scatterlist inline_sg [ NVMET_RDMA_MAX_INLINE_SGE ] ;  struct nvme_command * nvme_cmd ;  struct nvmet_rdma_queue * queue ; } cocci_id@p ;
...
position p;
@@
 struct nvmet_rdma_queue * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct nvmet_rdma_rsp * rsp ) ;
...
position p;
@@
 void cocci_id@p ( struct ib_event * event , void * priv ) ;
...
position p;
@@
 struct nvme_sgl_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvmet_rdma_device * ndev , struct nvmet_rdma_rsp * r ) ;
...
position p;
@@
 struct nvme_rdma_cm_rep cocci_id@p ;
...
position p;
@@
 enum nvme_rdma_cm_status cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct nvmet_rdma_rsp {  struct ib_sge send_sge ;  struct ib_cqe send_cqe ;  struct ib_send_wr send_wr ;  struct nvmet_rdma_cmd * cmd ;  struct nvmet_rdma_queue * queue ;  struct ib_cqe read_cqe ;  struct rdma_rw_ctx rw ;  struct nvmet_req req ;  bool allocated ;  u8 n_rdma ;  u32 flags ;  u32 invalidate_rkey ;  struct list_head wait_list ;  struct list_head free_list ; } cocci_id@p ;
...
position p;
@@
 struct nvmet_rdma_device {  struct ib_device * device ;  struct ib_pd * pd ;  struct ib_srq * srq ;  struct nvmet_rdma_cmd * srq_cmds ;  size_t srq_size ;  struct kref ref ;  struct list_head entry ;  int inline_data_size ;  int inline_page_count ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvmet_rdma_queue * queue ) ;
...
@@
 struct nvmet_rdma_queue {  struct rdma_cm_id * cm_id ;  struct nvmet_port * port ;  struct ib_cq * cq ;  atomic_t sq_wr_avail ;  struct nvmet_rdma_device * dev ;  spinlock_t state_lock ;  enum nvmet_rdma_queue_state state ;  struct nvmet_cq nvme_cq ;  struct nvmet_sq nvme_sq ;  struct nvmet_rdma_rsp * rsps ;  struct list_head free_rsps ;  spinlock_t rsps_lock ;  struct nvmet_rdma_cmd * cmds ;  struct work_struct release_work ;  struct list_head rsp_wait_list ;  struct list_head rsp_wr_wait_list ;  spinlock_t rsp_wr_wait_lock ;  int idx ;  int host_qid ;  int recv_queue_size ;  int send_queue_size ;  struct list_head queue_list ; } cocci_id@p ;
