...
position p;
@@
 enum cxd2880_dvbt2_plp_fec cocci_id@p ;
...
position p;
@@
 struct cxd2880_dvbt2_l1pre cocci_id@p ;
...
position p;
@@
 struct cxd2880_dvbt2_bbheader cocci_id@p ;
...
position p;
@@
 enum cxd2880_dvbt2_plp_code_rate cocci_id@p ;
...
position p;
@@
 enum cxd2880_tnrdmd_spectrum_sense cocci_id@p ;
...
position p;
@@
 struct cxd2880_config * cocci_id@p ;
...
position p;
@@
 enum cxd2880_tnrdmd_chip_id cocci_id@p ;
...
position p;
@@
 enum cxd2880_dvbt_guard cocci_id@p ;
...
position p;
@@
 struct cxd2880_tnrdmd * cocci_id@p ;
...
position p;
@@
 struct cxd2880_priv cocci_id@p ;
...
position p;
@@
 struct cxd2880_tnrdmd_create_param cocci_id@p ;
...
position p;
@@
 struct cxd2880_dvbt2_plp cocci_id@p ;
...
position p;
@@
 enum cxd2880_dtv_bandwidth cocci_id@p ;
...
position p;
@@
 struct cxd2880_dvbt2_l1post cocci_id@p ;
...
position p;
@@
 enum cxd2880_dvbt2_plp_constell cocci_id@p ;
...
position p;
@@
 struct cxd2880_dvbt2_tune_param * cocci_id@p ;
...
position p;
@@
 enum cxd2880_dvbt_mode cocci_id@p ;
...
position p;
@@
 struct cxd2880_dvbt_tpsinfo cocci_id@p ;
...
position p;
@@
 struct cxd2880_dvbt_tune_param * cocci_id@p ;
...
position p;
@@
 struct cxd2880_priv {  struct cxd2880_tnrdmd tnrdmd ;  struct spi_device * spi ;  struct cxd2880_io regio ;  struct cxd2880_spi_device spi_device ;  struct cxd2880_spi cxd2880_spi ;  struct cxd2880_dvbt_tune_param dvbt_tune_param ;  struct cxd2880_dvbt2_tune_param dvbt2_tune_param ;  struct mutex * spi_mutex ;  unsigned long pre_ber_update ;  unsigned long pre_ber_interval ;  unsigned long post_ber_update ;  unsigned long post_ber_interval ;  unsigned long ucblock_update ;  unsigned long ucblock_interval ;  enum fe_status s ; } cocci_id@p ;
