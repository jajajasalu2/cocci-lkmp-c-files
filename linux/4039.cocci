...
position p;
@@
 struct uniphier_aidet_priv * cocci_id@p ;
...
@@
 struct uniphier_aidet_priv {  struct irq_domain * domain ;  void __iomem * reg_base ;  spinlock_t lock ;  u32 saved_vals [ UNIPHIER_AIDET_NR_IRQS / 32 ] ; } cocci_id@p ;
