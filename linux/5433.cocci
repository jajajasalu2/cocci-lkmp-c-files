...
position p;
@@
 struct spi_ppc4xx_regs cocci_id@p ;
...
typedef u8;
@@
 struct spi_ppc4xx_regs {  u8 mode ;  u8 rxd ;  u8 txd ;  u8 cr ;  u8 sr ;  u8 dummy ;  u8 cdm ; } cocci_id@p ;
...
position p;
@@
 struct spi_ppc4xx_cs * cocci_id@p ;
...
typedef u8;
@@
 struct spi_ppc4xx_cs {  u8 mode ; } cocci_id@p ;
...
typedef u64;
@@
 struct ppc4xx_spi {  struct spi_bitbang bitbang ;  struct completion done ;  u64 mapbase ;  u64 mapsize ;  int irqnum ;  unsigned int opb_freq ;  int len ;  int count ;  const unsigned char * tx ;  unsigned char * rx ;  int * gpios ;  struct spi_ppc4xx_regs __iomem * regs ;  struct spi_master * master ;  struct device * dev ; } cocci_id@p ;
