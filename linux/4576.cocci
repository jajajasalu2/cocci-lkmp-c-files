...
position p;
@@
 struct scif_copy_work * cocci_id@p ;
...
position p;
@@
 struct scif_mmu_notif * cocci_id@p ;
...
typedef bool,s64;
@@
 struct scif_copy_work {  s64 src_offset ;  s64 dst_offset ;  struct scif_window * src_window ;  struct scif_window * dst_window ;  int loopback ;  size_t len ;  struct scif_dma_comp_cb * comp_cb ;  struct scif_dev * remote_dev ;  int fence_type ;  bool ordered ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,s64,dma_addr_t;
@@
 struct scif_dma_comp_cb {  void ( * dma_completion_func ) ( void * cookie ) ;  void * cb_cookie ;  u8 * temp_buf ;  u8 * temp_buf_to_free ;  bool is_cache ;  s64 dst_offset ;  struct scif_window * dst_window ;  size_t len ;  dma_addr_t temp_phys ;  struct scif_dev * sdev ;  int header_padding ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef scif_pinned_pages_t;
@@
 scif_pinned_pages_t cocci_id@p ;
...
position p;
@@
 struct scif_rma_req cocci_id@p ;
...
position p;
@@
 struct scif_dma_comp_cb * cocci_id@p ;
...
position p;
@@
 struct scif_window_iter * cocci_id@p ;
...
position p;
@@
 struct scif_endpt_rma_info * cocci_id@p ;
