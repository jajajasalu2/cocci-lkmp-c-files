...
position p;
@@
 struct dma_buf_list {  struct list_head head ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 const struct dma_buf_export_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ DMA_BUF_NAME_LEN ] ;
...
position p;
@@
 struct dma_buf_sync cocci_id@p ;
...
position p;
@@
 struct dma_buf_list cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dma_buf_poll_cb_t;
@@
 struct dma_buf_poll_cb_t * cocci_id@p ;
