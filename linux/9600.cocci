...
position p;
@@
 struct brcmf_dload_data_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_rev_info_le cocci_id@p ;
...
position p;
@@
 struct brcmfmac_platform_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ BRCMF_FW_NAME_LEN ] ;
...
position p;
@@
 struct brcmfmac_pd_device * cocci_id@p ;
...
position p;
@@
 enum brcmf_bus_type cocci_id@p ;
...
symbol cocci_id;
position p;
typedef brcmf_mp_global_t;
@@
 struct brcmf_mp_global_t cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ BRCMF_DCMD_SMLEN ] ;
...
position p;
@@
 char cocci_id@p [ BRCMF_FW_ALTPATH_LEN ] ;
