...
position p;
@@
 union vram_info {  struct atom_vram_info_header_v2_3 v23 ;  struct atom_vram_info_header_v2_4 v24 ; } cocci_id@p ;
...
position p;
@@
 union smu_info {  struct atom_smu_info_v3_1 v31 ; } cocci_id@p ;
...
position p;
@@
 struct vram_reserve_block cocci_id@p ;
...
position p;
@@
 union firmware_info {  struct atom_firmware_info_v3_1 v31 ; } cocci_id@p ;
...
position p;
@@
 union gfx_info {  struct atom_gfx_info_v2_4 v24 ; } cocci_id@p ;
...
position p;
@@
 union igp_info {  struct atom_integrated_system_info_v1_11 v11 ; } cocci_id@p ;
...
position p;
@@
 union vram_module {  struct atom_vram_module_v9 v9 ;  struct atom_vram_module_v10 v10 ; } cocci_id@p ;
...
position p;
@@
 union umc_info {  struct atom_umc_info_v3_1 v31 ; } cocci_id@p ;
...
position p;
@@
 struct vram_usagebyfirmware_v2_1 * cocci_id@p ;
