...
position p;
@@
 struct cxd2820r_config cocci_id@p ;
...
typedef bool;
@@
 struct em28xx_dvb {  struct dvb_frontend * fe [ 2 ] ;  struct mutex lock ;  int nfeeds ;  struct dvb_adapter adapter ;  struct dvb_demux demux ;  struct dmxdev dmxdev ;  struct dmx_frontend fe_hw ;  struct dmx_frontend fe_mem ;  struct dvb_net net ;  int ( * gate_ctrl ) ( struct dvb_frontend * fe , int gate ) ;  struct semaphore pll_mutex ;  bool dont_attach_fe1 ;  int lna_gpio ;  struct i2c_client * i2c_client_demod ;  struct i2c_client * i2c_client_tuner ;  struct i2c_client * i2c_client_sec ; } cocci_id@p ;
...
position p;
@@
 const struct {  unsigned char r [ 4 ] ;  int len ; } cocci_id@p [ ] ;
...
position p;
@@
 struct em28xx_i2c_bus * cocci_id@p ;
...
position p;
@@
 struct tda18212_config cocci_id@p ;
...
position p;
@@
 struct qt1010_config cocci_id@p ;
...
position p;
@@
 const struct mb86a20s_config cocci_id@p ;
...
position p;
@@
 struct qm1d1c0042_config cocci_id@p ;
...
position p;
@@
 const struct em28xx_reg_seq cocci_id@p [ ] ;
...
position p;
@@
 struct mt352_config cocci_id@p ;
...
position p;
@@
 struct tda10023_config cocci_id@p ;
