...
position p;
@@
 struct orangefs_writepages * cocci_id@p ;
...
position p;
@@
 struct orangefs_kernel_op_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef loff_t,kgid_t,kuid_t;
@@
 struct orangefs_writepages {  loff_t off ;  size_t len ;  kuid_t uid ;  kgid_t gid ;  int maxpages ;  int npages ;  struct page * * pages ;  struct bio_vec * bv ; } cocci_id@p ;
...
position p;
@@
 struct orangefs_write_range * cocci_id@p ;
...
position p;
@@
 struct orangefs_khandle * cocci_id@p ;
...
position p;
@@
 enum ORANGEFS_io_type cocci_id@p ;
...
position p;
@@
 struct orangefs_read_options * cocci_id@p ;
...
position p;
@@
 struct orangefs_inode_s * cocci_id@p ;
...
position p;
@@
 struct orangefs_object_kref * cocci_id@p ;
