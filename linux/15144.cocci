...
position p;
@@
 const struct vfio_device_ops * cocci_id@p ;
...
typedef bool;
@@
 struct vfio_container {  struct kref kref ;  struct list_head group_list ;  struct rw_semaphore group_lock ;  struct vfio_iommu_driver * iommu_driver ;  void * iommu_data ;  bool noiommu ; } cocci_id@p ;
...
position p;
@@
 struct vfio_unbound_dev * cocci_id@p ;
...
position p;
@@
 struct vfio_group_put_work * cocci_id@p ;
...
position p;
@@
 struct vfio_irq_set cocci_id@p ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,dev_t;
@@
 struct vfio {  struct class * class ;  struct list_head iommu_drivers_list ;  struct mutex iommu_drivers_lock ;  struct list_head group_list ;  struct idr group_idr ;  struct mutex group_lock ;  struct cdev group_cdev ;  dev_t group_devt ;  wait_queue_head_t release_q ; } cocci_id@p ;
...
position p;
@@
 struct vfio_group_put_work {  struct work_struct work ;  struct vfio_group * group ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * nb , unsigned long action , void * data ) ;
...
position p;
@@
 enum vfio_notify_type cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vfio_group * group ) ;
...
position p;
@@
 struct vfio_group_status cocci_id@p ;
...
position p;
@@
 struct vfio_device {  struct kref kref ;  struct device * dev ;  const struct vfio_device_ops * ops ;  struct vfio_group * group ;  struct list_head group_next ;  void * device_data ; } cocci_id@p ;
...
position p;
@@
 struct vfio_unbound_dev {  struct device * dev ;  struct list_head unbound_next ; } cocci_id@p ;
...
position p;
@@
 struct vfio_info_cap_header * cocci_id@p ;
...
position p;
@@
 struct vfio_iommu_driver * cocci_id@p ;
...
position p;
@@
 struct vfio_container * cocci_id@p ;
...
position p;
@@
 const struct vfio_iommu_driver_ops cocci_id@p ;
...
position p;
@@
 struct vfio_info_cap * cocci_id@p ;
...
position p;
@@
 struct vfio_iommu_driver {  const struct vfio_iommu_driver_ops * ops ;  struct list_head vfio_next ; } cocci_id@p ;
