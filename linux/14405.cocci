...
position p;
@@
 struct nxt200x_state * cocci_id@p ;
...
typedef u8;
@@
 struct nxt200x_state {  struct i2c_adapter * i2c ;  const struct nxt200x_config * config ;  struct dvb_frontend frontend ;  nxt_chip_type demod_chip ;  u8 initialised : 1 ; } cocci_id@p ;
