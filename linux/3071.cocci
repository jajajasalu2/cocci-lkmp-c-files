...
position p;
@@
 void cocci_id@p ( struct skd_device * skdev , struct skd_request_context * skreq , const char * event ) ;
...
position p;
@@
 enum skd_drvr_state cocci_id@p ;
...
position p;
@@
 struct skd_msix_entry {  char isr_name [ 30 ] ; } cocci_id@p ;
...
position p;
@@
 struct fit_comp_error_info * cocci_id@p ;
...
position p;
@@
 enum skd_check_status_action cocci_id@p ;
...
position p;
@@
 struct fit_completion_entry_v1 * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct skd_device * skdev , struct skd_fitmsg_context * skmsg ) ;
...
typedef dma_addr_t;
@@
 struct skd_special_context {  struct skd_request_context req ;  void * data_buf ;  dma_addr_t db_dma_address ;  struct skd_msg_buf * msg_buf ;  dma_addr_t mb_dma_address ; } cocci_id@p ;
...
position p;
@@
 struct skd_msix_entry cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct skd_device * skdev , const char * event ) ;
...
position p;
@@
 const char * cocci_id@p ( int state ) ;
...
@@
 struct skd_init_msix_entry {  const char * name ;  irq_handler_t handler ; } cocci_id@p ;
...
position p;
@@
 struct skd_msg_buf {  struct fit_msg_hdr fmh ;  struct skd_scsi_request scsi [ SKD_MAX_REQ_PER_MSG ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct skd_device * skdev , struct skd_special_context * skspcl ) ;
...
@@
 struct skd_fitmsg_context {  u32 id ;  u32 length ;  struct skd_msg_buf * msg_buf ;  dma_addr_t mb_dma_address ; } cocci_id@p ;
...
position p;
@@
 enum skd_check_status_action { SKD_CHECK_STATUS_REPORT_GOOD , SKD_CHECK_STATUS_REPORT_SMART_ALERT , SKD_CHECK_STATUS_REQUEUE_REQUEST , SKD_CHECK_STATUS_REPORT_ERROR , SKD_CHECK_STATUS_BUSY_IMMINENT , } cocci_id@p ;
...
position p;
@@
 struct skd_request_context * cocci_id@p ;
...
typedef u8;
@@
 struct sns_info {  u8 type ;  u8 stat ;  u8 key ;  u8 asc ;  u8 ascq ;  u8 mask ;  enum skd_check_status_action action ; } cocci_id@p ;
...
position p;
@@
 struct fit_sg_descriptor cocci_id@p ;
...
position p;
@@
 struct skd_fitmsg_context cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p ( enum skd_drvr_state state ) ;
...
position p;
@@
 enum skd_irq_type { SKD_IRQ_LEGACY , SKD_IRQ_MSI , SKD_IRQ_MSIX , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct skd_device * skdev , struct skd_request_context * skreq ) ;
...
position p;
@@
 enum skd_req_state { SKD_REQ_STATE_IDLE , SKD_REQ_STATE_SETUP , SKD_REQ_STATE_BUSY , SKD_REQ_STATE_COMPLETED , SKD_REQ_STATE_TIMEOUT , } cocci_id@p ;
...
position p;
@@
 struct skd_scsi_request cocci_id@p ;
...
position p;
@@
 struct skd_init_msix_entry cocci_id@p [ SKD_MAX_MSIX_COUNT ] ;
...
position p;
@@
 struct driver_inquiry_data cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct skd_device * skdev ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct skd_device * skdev , struct skd_request_context * skreq ) ;
...
position p;
@@
 void cocci_id@p ( struct skd_device * skdev , struct fit_completion_entry_v1 * skcomp , struct fit_comp_error_info * skerr ) ;
...
position p;
@@
 struct skd_request_context * const cocci_id@p ;
...
position p;
@@
 struct request_queue * const cocci_id@p ;
...
position p;
@@
 struct skd_device * const cocci_id@p ;
...
position p;
@@
 struct skd_special_context * cocci_id@p ;
...
position p;
@@
 struct skd_command_header cocci_id@p ;
...
position p;
@@
 struct request * const cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct skd_device * skdev ) ;
