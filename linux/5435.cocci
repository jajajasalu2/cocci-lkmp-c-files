...
position p;
@@
 struct altera_spi {  void __iomem * base ;  int irq ;  int len ;  int count ;  int bytes_per_word ;  unsigned long imr ;  const unsigned char * tx ;  unsigned char * rx ; } cocci_id@p ;
