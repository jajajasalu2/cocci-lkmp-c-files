...
typedef u32;
@@
 struct capictr_event {  struct work_struct work ;  unsigned int type ;  u32 controller ; } cocci_id@p ;
...
position p;
@@
 avmb1_loadandconfigdef cocci_id@p ;
...
position p;
@@
 struct capictr_event * cocci_id@p ;
...
position p;
@@
 struct capi_ctr * cocci_id@p [ CAPI_MAXCONTR ] ;
...
position p;
@@
 char cocci_id@p [ CAPI_SERIAL_LEN ] ;
...
position p;
@@
 struct capi_profile cocci_id@p ;
...
position p;
@@
 struct capi20_appl * cocci_id@p [ CAPI_MAXAPPL ] ;
...
position p;
@@
 const struct capi_version cocci_id@p ;
...
position p;
@@
 struct capi_version * cocci_id@p ;
