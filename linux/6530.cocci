...
position p;
@@
 struct cumanascsi2_info {  FAS216_Info info ;  struct expansion_card * ec ;  void __iomem * base ;  unsigned int terms ;  struct scatterlist sg [ NR_SG ] ; } cocci_id@p ;
...
position p;
@@
 struct cumanascsi2_info * cocci_id@p ;
