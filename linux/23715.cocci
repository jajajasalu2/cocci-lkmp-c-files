...
typedef u8;
@@
 struct fsl_audmix_state {  u8 tdms ;  u8 clk ;  char msg [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 const struct fsl_audmix_state cocci_id@p [ 4 ] [ 4 ] ;
...
position p;
@@
 const struct fsl_audmix_state cocci_id@p ;
