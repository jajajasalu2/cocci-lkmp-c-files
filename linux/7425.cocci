...
@@
 struct arcfb_par {  unsigned long dio_addr ;  unsigned long cio_addr ;  unsigned long c2io_addr ;  atomic_t ref_count ;  unsigned char cslut [ 9 ] ;  struct fb_info * info ;  unsigned int irq ;  spinlock_t lock ; } cocci_id@p ;
