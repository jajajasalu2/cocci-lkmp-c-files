...
typedef u32;
@@
 const u32 cocci_id@p [ HNS_PPEV2_RSS_IND_TBL_SIZE ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ HNS_PPEV2_RSS_KEY_NUM ] ;
...
position p;
@@
 struct hns_ppe_hw_stats * cocci_id@p ;
