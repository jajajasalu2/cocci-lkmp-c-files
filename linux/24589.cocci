...
position p;
@@
 void ( * cocci_id@p ) ( struct notifier_block * nb ) ;
...
position p;
@@
 struct fib_notifier_net * cocci_id@p ;
...
position p;
@@
 struct fib_notifier_net {  struct list_head fib_notifier_ops ;  struct atomic_notifier_head fib_chain ; } cocci_id@p ;
