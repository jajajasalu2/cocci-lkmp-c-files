...
position p;
@@
 struct at91_cf_socket * cocci_id@p ;
...
position p;
@@
 struct at91_cf_socket {  struct pcmcia_socket socket ;  unsigned present : 1 ;  struct platform_device * pdev ;  struct at91_cf_data * board ;  unsigned long phys_baseaddr ; } cocci_id@p ;
...
position p;
@@
 struct at91_cf_data * cocci_id@p ;
