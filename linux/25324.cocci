...
position p;
@@
 char cocci_id@p [ 2 * NAME_MAX + 1 + 12 + 3 ] ;
...
typedef __u32;
@@
 struct terms_test {  const char * str ;  __u32 type ;  int ( * check ) ( struct list_head * terms ) ; } cocci_id@p ;
...
typedef bool,__u32;
@@
 struct evlist_test {  const char * name ;  __u32 type ;  const int id ;  bool ( * valid ) ( void ) ;  int ( * check ) ( struct evlist * evlist ) ; } cocci_id@p ;
