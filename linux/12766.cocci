...
position p;
@@
 struct rpmsg_endpoint_info cocci_id@p ;
...
position p;
@@
 struct rpmsg_eptdev * cocci_id@p ;
...
position p;
@@
 struct rpmsg_ctrldev cocci_id@p ;
...
@@
 struct rpmsg_eptdev {  struct device dev ;  struct cdev cdev ;  struct rpmsg_device * rpdev ;  struct rpmsg_channel_info chinfo ;  struct mutex ept_lock ;  struct rpmsg_endpoint * ept ;  spinlock_t queue_lock ;  struct sk_buff_head queue ;  wait_queue_head_t readq ; } cocci_id@p ;
...
position p;
@@
 struct rpmsg_ctrldev {  struct rpmsg_device * rpdev ;  struct cdev cdev ;  struct device dev ; } cocci_id@p ;
