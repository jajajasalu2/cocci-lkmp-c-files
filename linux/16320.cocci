...
position p;
@@
 struct imgu_css_scaler_info {  unsigned int phase_step ;  int exp_shift ;  unsigned int phase_init ;  int pad_left ;  int pad_right ;  int crop_left ;  int crop_top ; } cocci_id@p ;
...
position p;
@@
 enum imgu_abi_frame_format cocci_id@p ;
...
position p;
@@
 struct imgu_abi_osys_formatter_params * cocci_id@p ;
...
position p;
@@
 struct imgu_fw_param_memory_offsets * cocci_id@p ;
...
position p;
@@
 struct imgu_css_pipe * cocci_id@p ;
...
position p;
@@
 struct imgu_css_frame_params cocci_id@p [ IMGU_ABI_OSYS_PINS ] ;
...
position p;
@@
 const struct ipu3_uapi_shd_grid_config * cocci_id@p ;
...
position p;
@@
 struct imgu_css_frame_params cocci_id@p [ ] ;
...
position p;
@@
 const struct imgu_css_bds_config * cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_acc_param * cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_grid_config * cocci_id@p ;
...
position p;
@@
 struct imgu_css_frame_params {  unsigned int enable ;  unsigned int format ;  unsigned int flip ;  unsigned int mirror ;  unsigned int tiling ;  unsigned int reduce_range ;  unsigned int width ;  unsigned int height ;  unsigned int stride ;  unsigned int scaled ;  unsigned int crop_left ;  unsigned int crop_top ; } cocci_id@p ;
...
position p;
@@
 struct imgu_abi_osys_frame_params * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_awb_fr_intra_frame_operations_data * cocci_id@p ;
...
position p;
@@
 struct imgu_css_stripe_params cocci_id@p [ ] ;
...
position p;
@@
 struct imgu_css_reso cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_flags * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_acc_operation * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_awb_intra_frame_operations_data * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_osys_scaler_params * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_awb_fr_config * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_shd_intra_frame_operations_data * cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_isp_tnr3_params * cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_isp_xnr3_vmem_params * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_gdc_warp_param cocci_id@p ;
...
position p;
@@
 struct imgu_abi_acc_transfer_op_data * cocci_id@p ;
...
position p;
@@
 const enum imgu_abi_param_class cocci_id@p ;
...
position p;
@@
 struct imgu_fw_info * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_acc_process_lines_cmd_data * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_shd_transfer_luts_set_data * cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_isp_xnr3_params * cocci_id@p ;
...
position p;
@@
 enum imgu_abi_memories cocci_id@p ;
...
position p;
@@
 struct imgu_abi_osys_config * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_awb_config * cocci_id@p ;
...
position p;
@@
 const enum imgu_abi_memories cocci_id@p ;
...
position p;
@@
 struct imgu_abi_af_intra_frame_operations_data * cocci_id@p ;
...
position p;
@@
 struct imgu_fw_isp_parameter * cocci_id@p ;
...
position p;
@@
 struct imgu_css_scaler_info * cocci_id@p ;
...
position p;
@@
 struct process_lines cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_isp_lin_vmem_params * cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_isp_tnr3_vmem_params * cocci_id@p ;
...
position p;
@@
 const struct ipu3_uapi_ae_weight_elem cocci_id@p ;
...
position p;
@@
 struct imgu_css_stripe_params cocci_id@p [ IPU3_UAPI_MAX_STRIPES ] ;
...
position p;
@@
 struct imgu_abi_stripes cocci_id@p [ ] ;
...
position p;
@@
 struct imgu_abi_acc_param * cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_params * cocci_id@p ;
...
position p;
@@
 struct process_lines {  unsigned int image_height ;  unsigned short grid_height ;  unsigned short block_height ;  unsigned short y_start ;  unsigned char grid_height_per_slice ;  unsigned short max_op ;  unsigned short max_tr ;  unsigned char acc_enable ; } cocci_id@p ;
...
position p;
@@
 struct imgu_abi_af_config * cocci_id@p ;
...
position p;
@@
 const struct process_lines * cocci_id@p ;
...
position p;
@@
 const struct imgu_fw_info * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_input_feeder_data * cocci_id@p ;
