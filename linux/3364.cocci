...
position p;
@@
 struct tegra_pwm_soc {  unsigned int num_channels ;  unsigned long max_frequency ; } cocci_id@p ;
...
position p;
@@
 struct tegra_pwm_chip {  struct pwm_chip chip ;  struct device * dev ;  struct clk * clk ;  struct reset_control * rst ;  unsigned long clk_rate ;  void __iomem * regs ;  const struct tegra_pwm_soc * soc ; } cocci_id@p ;
...
position p;
@@
 struct tegra_pwm_chip * cocci_id@p ;
...
position p;
@@
 const struct tegra_pwm_soc cocci_id@p ;
