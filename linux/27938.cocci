...
position p;
@@
 struct nilfs_sysfs_dev_subgroups cocci_id@p ;
...
position p;
@@
 struct nilfs_segctor_attr * cocci_id@p ;
...
position p;
@@
 struct nilfs_checkpoints_attr * cocci_id@p ;
...
position p;
@@
 struct nilfs_snapshot_attr cocci_id@p ;
...
position p;
@@
 struct nilfs_segments_attr * cocci_id@p ;
...
position p;
@@
 struct nilfs_dev_attr cocci_id@p ;
...
position p;
@@
 struct nilfs_mounted_snapshots_attr * cocci_id@p ;
...
position p;
@@
 struct nilfs_superblock_attr * cocci_id@p ;
