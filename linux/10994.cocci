...
position p;
@@
 struct atom_smc_dpm_info_v4_1 * cocci_id@p ;
...
position p;
@@
 struct pp_atomfwctrl_smc_dpm_parameters * cocci_id@p ;
...
position p;
@@
 struct atom_asic_profiling_info_v4_2 * cocci_id@p ;
...
position p;
@@
 const struct atom_gpio_pin_assignment * cocci_id@p ;
...
position p;
@@
 const union atom_voltage_object_v4 * cocci_id@p ;
...
position p;
@@
 struct compute_gpu_clock_input_parameter_v1_8 cocci_id@p ;
...
position p;
@@
 struct atom_voltage_objects_info_v4_1 cocci_id@p ;
...
position p;
@@
 struct compute_gpu_clock_output_parameter_v1_8 * cocci_id@p ;
...
position p;
@@
 struct pp_atomfwctrl_gpio_pin_assignment * cocci_id@p ;
...
position p;
@@
 const struct atom_voltage_objects_info_v4_1 * cocci_id@p ;
...
position p;
@@
 struct atom_asic_profiling_info_v4_1 * cocci_id@p ;
