...
position p;
@@
 const struct ad7780_chip_info * cocci_id@p ;
...
position p;
@@
 enum ad7780_supported_device_ids { ID_AD7170 , ID_AD7171 , ID_AD7780 , ID_AD7781 , } cocci_id@p ;
...
position p;
@@
 struct ad7780_state {  const struct ad7780_chip_info * chip_info ;  struct regulator * reg ;  struct gpio_desc * powerdown_gpio ;  struct gpio_desc * gain_gpio ;  struct gpio_desc * filter_gpio ;  unsigned int gain ;  unsigned int odr ;  unsigned int int_vref_mv ;  struct ad_sigma_delta sd ; } cocci_id@p ;
...
position p;
@@
 struct ad7780_state * cocci_id@p ;
...
typedef bool;
@@
 struct ad7780_chip_info {  struct iio_chan_spec channel ;  unsigned int pattern_mask ;  unsigned int pattern ;  bool is_ad778x ; } cocci_id@p ;
