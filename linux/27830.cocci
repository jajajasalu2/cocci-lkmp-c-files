...
typedef u64;
@@
 struct mlog_attribute {  struct attribute attr ;  u64 mask ; } cocci_id@p ;
...
position p;
@@
 struct mlog_attribute cocci_id@p [ MLOG_MAX_BITS ] ;
...
position p;
@@
 struct mlog_attribute * cocci_id@p ;
...
position p;
@@
 struct attribute * cocci_id@p [ MLOG_MAX_BITS ] ;
