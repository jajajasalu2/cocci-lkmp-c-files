...
position p;
@@
 struct qxl_cursor_cmd * cocci_id@p ;
...
position p;
@@
 struct qxl_monitors_config cocci_id@p ;
...
position p;
@@
 enum { MONITORS_CONFIG_MODIFIED , MONITORS_CONFIG_UNCHANGED , MONITORS_CONFIG_BAD_CRC , MONITORS_CONFIG_ERROR , } cocci_id@p ;
...
position p;
@@
 struct mode_size {  int w ;  int h ; } cocci_id@p [ ] ;
