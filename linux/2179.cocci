...
typedef u8,bool;
@@
 struct sbsm_data {  struct i2c_client * client ;  struct i2c_mux_core * muxc ;  struct power_supply * psy ;  u8 cur_chan ;  struct gpio_chip chip ;  bool is_ltc1760 ;  unsigned int supported_bats ;  unsigned int last_state ;  unsigned int last_state_cont ; } cocci_id@p ;
