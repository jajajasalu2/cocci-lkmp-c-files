...
position p;
@@
 struct _vcs_dpi_display_dlg_regs_st * cocci_id@p ;
...
position p;
@@
 const struct hw_sequencer_funcs cocci_id@p ;
...
position p;
@@
 struct vm_system_aperture_param cocci_id@p ;
...
position p;
@@
 struct crtc_position * cocci_id@p ;
...
position p;
@@
 struct stream_resource * cocci_id@p ;
...
position p;
@@
 struct dcn_hubp_state * cocci_id@p ;
...
position p;
@@
 struct dcn_dpp_state cocci_id@p ;
...
position p;
@@
 struct dchub_init_data * cocci_id@p ;
...
position p;
@@
 const struct dc_transfer_func * cocci_id@p ;
...
position p;
@@
 enum view_3d_format cocci_id@p ;
...
position p;
@@
 struct dc_transfer_func * cocci_id@p ;
...
position p;
@@
 struct crtc_stereo_flags * cocci_id@p ;
...
position p;
@@
 struct dc_clock_config * cocci_id@p ;
...
position p;
@@
 struct dc_log_buffer_ctx * cocci_id@p ;
...
position p;
@@
 struct dcn_otg_state cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_rq_regs_st * cocci_id@p ;
...
position p;
@@
 enum vertical_interrupt_ref_point cocci_id@p ;
...
position p;
@@
 struct custom_float_format cocci_id@p ;
...
position p;
@@
 struct dc_bias_and_scale cocci_id@p ;
...
position p;
@@
 const struct dc_static_screen_events * cocci_id@p ;
...
position p;
@@
 struct dcn_hubbub_wm cocci_id@p ;
...
position p;
@@
 struct mpcc_blnd_cfg cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_ttu_regs_st * cocci_id@p ;
...
position p;
@@
 struct dpp_cursor_attributes cocci_id@p ;
...
position p;
@@
 struct encoder_unblank_param cocci_id@p ;
...
position p;
@@
 struct vm_context0_param cocci_id@p ;
...
position p;
@@
 PHYSICAL_ADDRESS_LOC cocci_id@p ;
...
position p;
@@
 struct dpp_grph_csc_adjustment cocci_id@p ;
...
position p;
@@
 enum pipe_gating_control cocci_id@p ;
...
position p;
@@
 struct dc_cursor_mi_param cocci_id@p ;
...
position p;
@@
 struct dcn_hubbub_wm_set * cocci_id@p ;
...
position p;
@@
 struct dcn_dsc_state cocci_id@p ;
...
position p;
@@
 struct link_enc_state cocci_id@p ;
...
position p;
@@
 enum dc_timing_3d_format cocci_id@p ;
