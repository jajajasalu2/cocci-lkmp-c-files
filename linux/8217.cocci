...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int phy_id , int loc , int value ) ;
...
position p;
@@
 enum RxCfg { RxAllMulti = 0x0004 , RxPromisc = 0x0002 , RxEnable = 0x0100 , RxStripCRC = 0x0200 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned int addr ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int if_port ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int phy_id , int loc ) ;
