...
position p;
@@
 struct brcmstb_gpio_bank * cocci_id@p ;
...
typedef u32;
@@
 struct brcmstb_gpio_bank {  struct list_head node ;  int id ;  struct gpio_chip gc ;  struct brcmstb_gpio_priv * parent_priv ;  u32 width ;  u32 wake_active ;  u32 saved_regs [ GIO_REG_STAT ] ; } cocci_id@p ;
...
position p;
@@
 enum gio_reg_index { GIO_REG_ODEN = 0 , GIO_REG_DATA , GIO_REG_IODIR , GIO_REG_EC , GIO_REG_EI , GIO_REG_MASK , GIO_REG_LEVEL , GIO_REG_STAT , NUMBER_OF_GIO_REGISTERS , } cocci_id@p ;
...
position p;
@@
 struct brcmstb_gpio_priv {  struct list_head bank_list ;  void __iomem * reg_base ;  struct platform_device * pdev ;  struct irq_domain * irq_domain ;  struct irq_chip irq_chip ;  int parent_irq ;  int gpio_base ;  int num_gpios ;  int parent_wake_irq ; } cocci_id@p ;
...
position p;
@@
 struct brcmstb_gpio_priv * cocci_id@p ;
