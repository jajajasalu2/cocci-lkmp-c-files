...
position p;
@@
 const char * constcocci_id [ TOMOYO_MAX_MAC_INDEX + TOMOYO_MAX_MAC_CATEGORY_INDEX ] ;
...
position p;
@@
 const struct tomoyo_name_union * cocci_id@p ;
...
position p;
@@
 struct tomoyo_path_info cocci_id@p ;
...
position p;
@@
 const struct {  const char * keyword ;  int ( * write ) ( struct tomoyo_acl_param * param ) ; } cocci_id@p [ 5 ] ;
...
position p;
@@
 struct tomoyo_path_number_acl * cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_MAX_CONDITION_KEYWORD ] ;
...
position p;
@@
 struct tomoyo_manager cocci_id@p ;
...
position p;
@@
 struct tomoyo_acl_info * cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_MAX_MEMORY_STAT ] ;
...
position p;
@@
 const struct tomoyo_envp * cocci_id@p ;
...
position p;
@@
 struct tomoyo_aggregator * cocci_id@p ;
...
position p;
@@
 struct tomoyo_policy_namespace * cocci_id@p ;
...
position p;
@@
 struct tomoyo_profile * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_task_acl * cocci_id@p ;
...
position p;
@@
 struct tomoyo_query cocci_id@p ;
...
position p;
@@
 struct tomoyo_io_buffer * cocci_id@p ;
...
typedef u8;
@@
 struct tomoyo_query {  struct list_head list ;  struct tomoyo_domain_info * domain ;  char * query ;  size_t query_len ;  unsigned int serial ;  u8 timer ;  u8 answer ;  u8 retry ; } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_MAX_NETWORK_OPERATION ] ;
...
position p;
@@
 const struct tomoyo_acl_info * cocci_id@p ;
...
position p;
@@
 struct tomoyo_domain_info * cocci_id@p ( unsigned int serial ) ;
...
position p;
@@
 struct tomoyo_mkdev_acl * cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_MAX_PREF ] ;
...
position p;
@@
 const struct tomoyo_acl_head * cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_MAX_PATH_OPERATION ] ;
...
position p;
@@
 struct tomoyo_path_group cocci_id@p ;
...
position p;
@@
 const struct tomoyo_condition * cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_MAX_MAC_CATEGORY_INDEX ] ;
...
position p;
@@
 void cocci_id@p ( struct tomoyo_io_buffer * head , const char * fmt , ... ) __printf ( 2 , 
										      3 ) ;
...
position p;
@@
 struct tomoyo_path2_acl * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_argv * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_number_union * cocci_id@p ;
...
position p;
@@
 struct tomoyo_number_group cocci_id@p ;
...
position p;
@@
 struct tomoyo_domain_info * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_condition_element * cocci_id@p ;
...
position p;
@@
 struct tomoyo_transition_control * cocci_id@p ;
...
position p;
@@
 struct tomoyo_acl_param cocci_id@p ;
...
position p;
@@
 struct tomoyo_env_acl * cocci_id@p ;
...
position p;
@@
 struct tomoyo_task_acl cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ TOMOYO_MAX_GROUP ] ;
...
position p;
@@
 struct tomoyo_address_group * cocci_id@p ;
...
position p;
@@
 struct tomoyo_group * cocci_id@p ;
...
position p;
@@
 const struct task_struct * cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_MAX_POLICY_STAT ] ;
...
position p;
@@
 const struct tomoyo_policy_namespace * cocci_id@p ;
...
position p;
@@
 struct tomoyo_path_acl * cocci_id@p ;
...
position p;
@@
 struct tomoyo_acl_head * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_profile * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_path_info * cocci_id@p ;
...
position p;
@@
 struct tomoyo_inet_acl * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ TOMOYO_MAX_TRANSITION_TYPE ] ;
...
position p;
@@
 unsigned int cocci_id@p [ TOMOYO_MAX_POLICY_STAT ] ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_MAX_DOMAIN_INFO_FLAGS ] ;
...
typedef time64_t;
@@
 time64_t cocci_id@p [ TOMOYO_MAX_POLICY_STAT ] ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_CONFIG_MAX_MODE ] ;
...
position p;
@@
 struct tomoyo_unix_acl * cocci_id@p ;
...
position p;
@@
 struct tomoyo_request_info * cocci_id@p ;
...
position p;
@@
 struct tomoyo_mount_acl * cocci_id@p ;
