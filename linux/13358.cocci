...
typedef bool,u32;
@@
 struct v4l2_ioctl_info {  unsigned int ioctl ;  u32 flags ;  const char * const name ;  int ( * func ) ( const struct v4l2_ioctl_ops * ops , struct file * file , void * fh , void * p ) ;  void ( * debug ) ( const void * arg , bool write_only ) ; } cocci_id@p ;
...
position p;
@@
 struct v4l2_ext_controls cocci_id@p ;
...
position p;
@@
 const struct v4l2_create_buffers * cocci_id@p ;
...
position p;
@@
 const long long unsigned * cocci_id@p ;
...
position p;
@@
 const struct v4l2_meta_format * cocci_id@p ;
...
position p;
@@
 const struct v4l2_sliced_vbi_cap * cocci_id@p ;
...
position p;
@@
 const struct v4l2_frmsizeenum * cocci_id@p ;
...
position p;
@@
 struct v4l2_frequency_band * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ioctl_info * cocci_id@p ;
...
position p;
@@
 const struct v4l2_standard * cocci_id@p ;
...
position p;
@@
 const struct v4l2_control * cocci_id@p ;
...
position p;
@@
 const struct v4l2_frequency_band * cocci_id@p ;
...
position p;
@@
 const struct v4l2_edid * cocci_id@p ;
...
position p;
@@
 const struct v4l2_dbg_chip_info * cocci_id@p ;
...
position p;
@@
 struct v4l2_dbg_chip_info * cocci_id@p ;
...
position p;
@@
 const struct v4l2_cropcap * cocci_id@p ;
...
position p;
@@
 struct v4l2_modulator cocci_id@p ;
...
position p;
@@
 struct v4l2_hw_freq_seek * cocci_id@p ;
...
position p;
@@
 const struct v4l2_framebuffer * cocci_id@p ;
...
position p;
@@
 const struct v4l2_format * cocci_id@p ;
...
position p;
@@
 struct v4l2_dbg_register * cocci_id@p ;
...
position p;
@@
 const struct v4l2_vbi_format * cocci_id@p ;
...
position p;
@@
 const struct v4l2_dv_timings_cap * cocci_id@p ;
...
position p;
@@
 struct v4l2_streamparm * cocci_id@p ;
...
position p;
@@
 const struct v4l2_querymenu * cocci_id@p ;
...
position p;
@@
 struct v4l2_pix_format cocci_id@p ;
...
position p;
@@
 struct v4l2_control * cocci_id@p ;
...
position p;
@@
 const struct v4l2_dv_timings * cocci_id@p ;
...
position p;
@@
 const struct v4l2_hw_freq_seek * cocci_id@p ;
...
position p;
@@
 struct v4l2_queryctrl * cocci_id@p ;
...
position p;
@@
 const struct v4l2_capability * cocci_id@p ;
...
position p;
@@
 const struct v4l2_timecode * cocci_id@p ;
...
position p;
@@
 const struct v4l2_query_ext_ctrl * cocci_id@p ;
...
position p;
@@
 struct v4l2_selection * cocci_id@p ;
...
position p;
@@
 const struct v4l2_crop * cocci_id@p ;
...
position p;
@@
 const struct v4l2_dbg_register * cocci_id@p ;
...
position p;
@@
 const struct v4l2_fmtdesc * cocci_id@p ;
...
position p;
@@
 struct std_descr {  v4l2_std_id std ;  const char * descr ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_outputparm * cocci_id@p ;
...
position p;
@@
 struct v4l2_querymenu * cocci_id@p ;
...
position p;
@@
 struct v4l2_create_buffers * cocci_id@p ;
...
position p;
@@
 const struct v4l2_exportbuffer * cocci_id@p ;
...
position p;
@@
 const struct v4l2_input * cocci_id@p ;
...
position p;
@@
 const struct v4l2_pix_format_mplane * cocci_id@p ;
...
position p;
@@
 const struct v4l2_enum_dv_timings * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ext_controls * cocci_id@p ;
...
position p;
@@
 const struct v4l2_decoder_cmd * cocci_id@p ;
...
position p;
@@
 const struct v4l2_sdr_format * cocci_id@p ;
...
position p;
@@
 struct v4l2_ext_control cocci_id@p ;
...
position p;
@@
 const struct v4l2_captureparm * cocci_id@p ;
...
position p;
@@
 const struct v4l2_tuner * cocci_id@p ;
...
position p;
@@
 struct v4l2_requestbuffers * cocci_id@p ;
...
position p;
@@
 const struct v4l2_requestbuffers * cocci_id@p ;
...
position p;
@@
 const struct v4l2_event_ctrl * cocci_id@p ;
...
position p;
@@
 const struct v4l2_frmivalenum * cocci_id@p ;
...
position p;
@@
 struct v4l2_frequency * cocci_id@p ;
...
position p;
@@
 struct v4l2_sliced_vbi_cap cocci_id@p ;
...
position p;
@@
 const struct v4l2_enc_idx * cocci_id@p ;
...
position p;
@@
 const struct v4l2_sliced_vbi_format * cocci_id@p ;
...
position p;
@@
 const struct v4l2_streamparm * cocci_id@p ;
...
position p;
@@
 const struct v4l2_modulator * cocci_id@p ;
...
position p;
@@
 const struct v4l2_audioout * cocci_id@p ;
...
position p;
@@
 const struct v4l2_audio * cocci_id@p ;
...
position p;
@@
 struct v4l2_ioctl_info cocci_id@p ;
...
position p;
@@
 struct v4l2_query_ext_ctrl * cocci_id@p ;
...
position p;
@@
 struct v4l2_cropcap * cocci_id@p ;
...
position p;
@@
 const struct v4l2_frequency * cocci_id@p ;
...
position p;
@@
 const struct v4l2_output * cocci_id@p ;
...
position p;
@@
 const struct v4l2_queryctrl * cocci_id@p ;
...
position p;
@@
 const struct v4l2_buffer * cocci_id@p ;
...
position p;
@@
 const struct v4l2_encoder_cmd * cocci_id@p ;
...
position p;
@@
 const struct v4l2_selection * cocci_id@p ;
...
position p;
@@
 const struct v4l2_plane * cocci_id@p ;
...
position p;
@@
 const struct v4l2_window * cocci_id@p ;
...
position p;
@@
 enum v4l2_tuner_type cocci_id@p ;
...
position p;
@@
 const struct std_descr cocci_id@p [ ] ;
...
position p;
@@
 struct v4l2_standard * cocci_id@p ;
