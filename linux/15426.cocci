...
position p;
@@
 struct st_wdog_syscfg cocci_id@p ;
...
typedef bool;
@@
 struct st_wdog {  void __iomem * base ;  struct device * dev ;  struct regmap * regmap ;  struct st_wdog_syscfg * syscfg ;  struct clk * clk ;  unsigned long clkrate ;  bool warm_reset ; } cocci_id@p ;
...
position p;
@@
 struct st_wdog_syscfg {  unsigned int reset_type_reg ;  unsigned int reset_type_mask ;  unsigned int enable_reg ;  unsigned int enable_mask ; } cocci_id@p ;
