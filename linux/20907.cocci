...
position p;
@@
 struct cow_header_v3 * cocci_id@p ;
...
typedef __u64;
@@
 int ( * cocci_id@p ) ( __u64 , char * , int , void * ) ;
...
position p;
@@
 union cow_header {  struct cow_header_v1 v1 ;  struct cow_header_v2 v2 ;  struct cow_header_v3 v3 ;  struct cow_header_v3_broken v3_b ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __s64,__u32,__u64;
@@
 struct cow_header_v3_broken {  __u32 magic ;  __u32 version ;  __s64 mtime ;  __u64 size ;  __u32 sectorsize ;  __u32 alignment ;  __u32 cow_format ;  char backing_file [ PATH_LEN_V3 ] ; } cocci_id@p ;
