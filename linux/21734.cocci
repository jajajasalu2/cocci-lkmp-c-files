...
position p;
@@
 enum mac_validity { MAC_NAME_VLD = 0x20 , MAC_ID_VLD = 0x40 , MAC_CNT_VLD = 0x80 , } cocci_id@p ;
...
position p;
@@
 struct lpar_cpu_inf {  struct cpu_inf cp ;  struct cpu_inf ifl ; } cocci_id@p ;
...
position p;
@@
 struct diag204_x_phys_block * cocci_id@p ;
...
position p;
@@
 enum par_flag { PAR_MT_EN = 0x80 , } cocci_id@p ;
...
position p;
@@
 struct lpar_cpu_inf * cocci_id@p ;
...
typedef u64;
@@
 struct cpu_inf {  u64 lpar_cap ;  u64 lpar_grp_cap ;  u64 lpar_weight ;  u64 all_weight ;  int cpu_num_ded ;  int cpu_num_shd ; } cocci_id@p ;
...
position p;
@@
 struct diag204_x_part_block * cocci_id@p ;
...
position p;
@@
 struct diag204_x_info_blk_hdr * cocci_id@p ;
...
position p;
@@
 enum par_validity { PAR_GRP_VLD = 0x08 , PAR_ID_VLD = 0x10 , PAR_ABS_VLD = 0x20 , PAR_WGHT_VLD = 0x40 , PAR_PCNT_VLD = 0x80 , } cocci_id@p ;
...
position p;
@@
 struct sysinfo_1_1_1 * cocci_id@p ;
...
position p;
@@
 enum hdr_flags { HDR_NOT_LPAR = 0x10 , HDR_STACK_INCM = 0x20 , HDR_STSI_UNAV = 0x40 , HDR_PERF_UNAV = 0x80 , } cocci_id@p ;
...
position p;
@@
 struct sthyi_info {  void * info ;  unsigned long end ; } cocci_id@p ;
