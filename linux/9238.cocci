...
position p;
@@
 struct enetc_vf_state * cocci_id@p ;
...
position p;
@@
 struct enetc_mac_filter * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ENETC_RSSHASH_KEY_SIZE ] ;
...
position p;
@@
 struct enetc_msg_swbd * cocci_id@p ;
...
position p;
@@
 struct enetc_msg_cmd_header * cocci_id@p ;
...
position p;
@@
 struct enetc_msg_cmd_set_primary_mac * cocci_id@p ;
