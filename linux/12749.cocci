...
position p;
@@
 struct iommu_regset {  int offset ;  const char * regs ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct tbl_walk {  u16 bus ;  u16 devfn ;  u32 pasid ;  struct root_entry * rt_entry ;  struct context_entry * ctx_entry ;  struct pasid_entry * pasid_tbl_entry ; } cocci_id@p ;
...
position p;
@@
 const struct iommu_regset cocci_id@p [ ] ;
...
position p;
@@
 struct pasid_dir_entry * cocci_id@p ;
