...
position p;
@@
 struct packet_diag_req cocci_id@p ;
...
position p;
@@
 struct packet_diag_info cocci_id@p ;
...
position p;
@@
 struct packet_diag_ring cocci_id@p ;
...
position p;
@@
 struct packet_diag_mclist * cocci_id@p ;
...
position p;
@@
 struct packet_diag_msg * cocci_id@p ;
