...
position p;
@@
 struct vmw_cmdbuf_res_manager {  struct drm_open_hash resources ;  struct list_head list ;  struct vmw_private * dev_priv ; } cocci_id@p ;
...
position p;
@@
 struct vmw_cmdbuf_res {  struct vmw_resource * res ;  struct drm_hash_item hash ;  struct list_head head ;  enum vmw_cmdbuf_res_state state ;  struct vmw_cmdbuf_res_manager * man ; } cocci_id@p ;
...
position p;
@@
 struct vmw_cmdbuf_res cocci_id@p ;
...
position p;
@@
 enum vmw_cmdbuf_res_type cocci_id@p ;
