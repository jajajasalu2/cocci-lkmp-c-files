...
position p;
@@
 struct palm_ext_connection_info * cocci_id@p ;
...
position p;
@@
 struct visor_connection_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial * serial , struct usb_serial_endpoints * epds ) ;
