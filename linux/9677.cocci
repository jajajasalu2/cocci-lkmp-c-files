...
position p;
@@
 struct b43_dfs_file * cocci_id@p ;
...
position p;
@@
 struct b43_dfsentry * cocci_id@p ;
...
position p;
@@
 struct b43_debugfs_fops cocci_id@p ;
...
position p;
@@
 struct b43_txstatus_log * cocci_id@p ;
...
position p;
@@
 const struct b43_debugfs_fops * cocci_id@p ;
