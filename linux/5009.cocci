...
position p;
@@
 struct credit_return * cocci_id@p ;
...
position p;
@@
 struct mem_pool_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct send_context * sc , int pause ) ;
...
position p;
@@
 struct sc_config_sizes * cocci_id@p ;
...
position p;
@@
 struct sc_config_sizes cocci_id@p [ SC_MAX ] ;
...
position p;
@@
 struct credit_return_base cocci_id@p ;
...
position p;
@@
 struct mem_pool_info cocci_id@p [ NUM_SC_POOLS ] ;
...
position p;
@@
 struct rvt_qp * cocci_id@p [ PIO_WAIT_BATCH_SIZE ] ;
...
position p;
@@
 struct mem_pool_info {  int centipercent ;  int count ;  int blocks ;  int size ; } cocci_id@p ;
...
position p;
@@
 struct mem_pool_config cocci_id@p [ NUM_SC_POOLS ] ;
...
position p;
@@
 struct mem_pool_config {  int centipercent ;  int absolute_blocks ; } cocci_id@p ;
...
position p;
@@
 union pio_shadow_ring cocci_id@p ;
...
position p;
@@
 struct pio_map_elem * cocci_id@p ;
