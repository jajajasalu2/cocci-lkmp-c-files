...
position p;
@@
 enum jump_label_type cocci_id@p ;
...
position p;
@@
 const struct jump_entry * cocci_id@p ;
...
position p;
@@
 struct static_key_mod * cocci_id@p ;
...
position p;
@@
 struct static_key_mod {  struct static_key_mod * next ;  struct jump_entry * entries ;  struct module * mod ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct static_key * key ) ;
