...
position p;
@@
 struct fuse_access_in cocci_id@p ;
...
position p;
@@
 struct fuse_rename_in cocci_id@p ;
...
position p;
@@
 struct fuse_setattr_in * cocci_id@p ;
...
position p;
@@
 struct fuse_mknod_in cocci_id@p ;
...
position p;
@@
 struct fuse_mkdir_in cocci_id@p ;
...
typedef u64;
@@
 union fuse_dentry {  u64 time ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct fuse_getattr_in cocci_id@p ;
...
position p;
@@
 struct fuse_attr_out * cocci_id@p ;
...
position p;
@@
 struct fuse_rename2_in cocci_id@p ;
...
position p;
@@
 struct fuse_link_in cocci_id@p ;
...
position p;
@@
 struct fuse_create_in cocci_id@p ;
