...
position p;
@@
 struct hw_stats_attribute * cocci_id@p ;
...
position p;
@@
 enum ib_port_phys_state cocci_id@p ;
...
position p;
@@
 size_t ( * cocci_id@p ) ( const struct ib_gid_attr * gid_attr , char * buf ) ;
...
position p;
@@
 struct port_attribute cocci_id@p ;
...
position p;
@@
 struct port_table_attribute {  struct port_attribute attr ;  char name [ 8 ] ;  int index ;  __be16 attr_id ; } cocci_id@p ;
...
position p;
@@
 struct gid_attr_group {  struct ib_port * port ;  struct kobject kobj ;  struct attribute_group ndev ;  struct attribute_group type ; } cocci_id@p ;
...
position p;
@@
 ssize_t ( * cocci_id@p ) ( struct ib_port * , struct port_attribute * , char * buf ) ;
...
typedef u8;
@@
 struct ib_port {  struct kobject kobj ;  struct ib_device * ibdev ;  struct gid_attr_group * gid_attr_group ;  struct attribute_group gid_group ;  struct attribute_group pkey_group ;  struct attribute_group * pma_table ;  struct attribute_group * hw_stats_ag ;  struct rdma_hw_stats * hw_stats ;  u8 port_num ; } cocci_id@p ;
...
position p;
@@
 struct gid_attr_group * cocci_id@p ;
...
position p;
@@
 struct port_table_attribute cocci_id@p ;
