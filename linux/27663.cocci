...
position p;
@@
 struct hlist_head cocci_id@p [ NLM_HOST_NRHASH ] ;
...
position p;
@@
 struct nlm_lookup_host_info * cocci_id@p ;
...
typedef u32;
@@
 struct nlm_lookup_host_info {  const int server ;  const struct sockaddr * sap ;  const size_t salen ;  const unsigned short protocol ;  const u32 version ;  const char * hostname ;  const size_t hostname_len ;  const int noresvport ;  struct net * net ;  const struct cred * cred ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net * net ) ;
