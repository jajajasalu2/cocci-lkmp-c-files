...
typedef u64,u8;
@@
 struct _hp_private {  volatile u8 __iomem * ioc_regs ;  volatile u8 __iomem * lba_regs ;  int lba_cap_offset ;  u64 * io_pdir ;  u64 * gatt ;  u64 gatt_entries ;  u64 iova_base ;  u64 gart_base ;  u64 gart_size ;  u64 io_pdir_size ;  int io_pdir_owner ;  int io_page_size ;  int io_tlb_shift ;  int io_tlb_ps ;  int io_pages_per_kpage ; } cocci_id@p ;
...
position p;
@@
 struct aper_size_info_fixed cocci_id@p [ ] ;
