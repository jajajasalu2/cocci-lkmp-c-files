...
position p;
@@
 struct dccp_request_sock cocci_id@p ;
...
position p;
@@
 const struct dccp_sock * cocci_id@p ;
...
position p;
@@
 const struct dccp_hdr * cocci_id@p ;
