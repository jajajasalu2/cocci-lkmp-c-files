...
position p;
@@
 struct dh_completion * cocci_id@p ;
...
position p;
@@
 struct keyctl_kdf_params * cocci_id@p ;
...
position p;
@@
 struct dh_completion {  struct completion completion ;  int err ; } cocci_id@p ;
...
position p;
@@
 struct kdf_sdesc {  struct shash_desc shash ;  char ctx [ ] ; } cocci_id@p ;
...
position p;
@@
 struct keyctl_dh_params cocci_id@p ;
