...
position p;
@@
 struct ad8366_info {  int gain_min ;  int gain_max ; } cocci_id@p ;
...
position p;
@@
 struct ad8366_state * cocci_id@p ;
...
position p;
@@
 struct ad8366_state {  struct spi_device * spi ;  struct regulator * reg ;  struct mutex lock ;  struct gpio_desc * reset_gpio ;  unsigned char ch [ 2 ] ;  enum ad8366_type type ;  struct ad8366_info * info ;  unsigned char data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum ad8366_type { ID_AD8366 , ID_ADA4961 , ID_ADL5240 , } cocci_id@p ;
