...
position p;
@@
 const char * cocci_id@p [ REP_MAX + 1 ] ;
...
position p;
@@
 const char * * cocci_id@p [ EV_MAX + 1 ] ;
...
position p;
@@
 const char * cocci_id@p [ MSC_MAX + 1 ] ;
...
position p;
@@
 const char * cocci_id@p [ SND_MAX + 1 ] ;
...
position p;
@@
 struct hid_debug_list cocci_id@p ;
...
position p;
@@
 const struct hid_usage_entry * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ KEY_MAX + 1 ] ;
...
position p;
@@
 const char * cocci_id@p [ LED_MAX + 1 ] ;
...
position p;
@@
 const char * cocci_id@p [ REL_MAX + 1 ] ;
...
position p;
@@
 struct hid_usage_entry {  unsigned page ;  unsigned usage ;  const char * description ; } cocci_id@p ;
