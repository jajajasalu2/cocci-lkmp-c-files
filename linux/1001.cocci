...
position p;
@@
 const struct ubi_attach_info * cocci_id@p ;
...
position p;
@@
 const struct ubi_volume * cocci_id@p ;
...
position p;
@@
 struct ubi_rename_entry * cocci_id@p ;
...
position p;
@@
 struct ubi_vtbl_record * cocci_id@p [ UBI_LAYOUT_VOLUME_EBS ] ;
...
position p;
@@
 const struct ubi_vtbl_record * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct ubi_device * ubi ) ;
...
position p;
@@
 int cocci_id@p [ UBI_LAYOUT_VOLUME_EBS ] ;
...
position p;
@@
 const struct ubi_ainf_volume * cocci_id@p ;
