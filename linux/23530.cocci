...
position p;
@@
 struct bxt_hdmi_pcm {  struct list_head head ;  struct snd_soc_dai * codec_dai ;  int device ; } cocci_id@p ;
...
position p;
@@
 enum { BXT_DPCM_AUDIO_PB = 0 , BXT_DPCM_AUDIO_CP , BXT_DPCM_AUDIO_HS_PB , BXT_DPCM_AUDIO_REF_CP , BXT_DPCM_AUDIO_DMIC_CP , BXT_DPCM_AUDIO_HDMI1_PB , BXT_DPCM_AUDIO_HDMI2_PB , BXT_DPCM_AUDIO_HDMI3_PB , } cocci_id@p ;
...
position p;
@@
 struct bxt_card_private * cocci_id@p ;
...
position p;
@@
 struct bxt_hdmi_pcm cocci_id@p ;
...
typedef bool;
@@
 struct bxt_card_private {  struct list_head hdmi_pcm_list ;  bool common_hdmi_codec_drv ; } cocci_id@p ;
