...
position p;
@@
 struct tlc4541_state {  struct spi_device * spi ;  struct regulator * reg ;  struct spi_transfer scan_single_xfer [ 3 ] ;  struct spi_message scan_single_msg ;  __be16 rx_buf [ 8 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct tlc4541_chip_info {  const struct iio_chan_spec * channels ;  unsigned int num_channels ; } cocci_id@p ;
...
position p;
@@
 const struct tlc4541_chip_info * cocci_id@p ;
...
position p;
@@
 struct tlc4541_state * cocci_id@p ;
...
position p;
@@
 enum tlc4541_id { TLC3541 , TLC4541 , } cocci_id@p ;
