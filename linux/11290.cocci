...
symbol cocci_id;
position p;
typedef bool,gma_clock_t,gma_limit_t;
@@
 bool cocci_id@p ( const struct gma_limit_t * limit , struct drm_crtc * crtc , int target , int refclk , struct gma_clock_t * best_clock ) ;
