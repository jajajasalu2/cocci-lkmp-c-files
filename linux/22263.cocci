...
typedef u32,u16;
@@
 struct avc_entry {  u32 ssid ;  u32 tsid ;  u16 tclass ;  struct av_decision avd ;  struct avc_xperms_node * xp_node ; } cocci_id@p ;
...
position p;
@@
 struct selinux_audit_data cocci_id@p ;
...
position p;
@@
 struct avc_xperms_decision_node cocci_id@p ;
...
position p;
@@
 struct avc_xperms_node cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,atomic_t,spinlock_t;
@@
 struct avc_cache {  struct hlist_head slots [ AVC_CACHE_SLOTS ] ;  spinlock_t slots_lock [ AVC_CACHE_SLOTS ] ;  atomic_t lru_hint ;  atomic_t active_nodes ;  u32 latest_notif ; } cocci_id@p ;
...
position p;
@@
 struct avc_node {  struct avc_entry ae ;  struct hlist_node list ;  struct rcu_head rhead ; } cocci_id@p ;
...
position p;
@@
 struct avc_xperms_node {  struct extended_perms xp ;  struct list_head xpd_head ; } cocci_id@p ;
...
position p;
@@
 struct extended_perms_data cocci_id@p ;
...
position p;
@@
 struct selinux_avc {  unsigned int avc_cache_threshold ;  struct avc_cache avc_cache ; } cocci_id@p ;
...
typedef u32;
@@
 struct avc_callback_node {  int ( * callback ) ( u32 event ) ;  u32 events ;  struct avc_callback_node * next ; } cocci_id@p ;
...
position p;
@@
 struct avc_callback_node * cocci_id@p ;
...
position p;
@@
 struct avc_xperms_decision_node {  struct extended_perms_decision xpd ;  struct list_head xpd_list ; } cocci_id@p ;
