...
position p;
@@
 struct dc_plane_state * const * cocci_id@p ;
...
position p;
@@
 struct encoder_info_frame * cocci_id@p ;
...
position p;
@@
 union hdmi_info_packet cocci_id@p ;
...
position p;
@@
 union display_content_support cocci_id@p ;
...
position p;
@@
 enum dc_rotation_angle cocci_id@p ;
...
position p;
@@
 const struct dc_validation_set cocci_id@p [ ] ;
...
position p;
@@
 const struct resource_straps * cocci_id@p ;
...
position p;
@@
 struct dc_validation_set cocci_id@p ;
...
position p;
@@
 struct dc_plane_state * cocci_id@p [ MAX_SURFACE_NUM ] ;
