...
position p;
@@
 struct replicator_drvdata * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct replicator_drvdata {  void __iomem * base ;  struct clk * atclk ;  struct coresight_device * csdev ;  spinlock_t spinlock ; } cocci_id@p ;
