...
position p;
@@
 struct optee_supp_req cocci_id@p ;
...
typedef bool,u32;
@@
 struct optee_supp_req {  struct list_head link ;  bool in_queue ;  u32 func ;  u32 ret ;  size_t num_params ;  struct tee_param * param ;  struct completion c ; } cocci_id@p ;
