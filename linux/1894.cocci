...
typedef u32;
@@
 struct adc_regs_spear3xx {  u32 status ;  u32 average ;  u32 scan_rate ;  u32 clk ;  u32 ch_ctrl [ SPEAR_ADC_CHANNEL_NUM ] ;  u32 ch_data [ SPEAR_ADC_CHANNEL_NUM ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct spear_adc_state {  struct device_node * np ;  struct adc_regs_spear3xx __iomem * adc_base_spear3xx ;  struct adc_regs_spear6xx __iomem * adc_base_spear6xx ;  struct clk * clk ;  struct completion completion ;  u32 current_clk ;  u32 sampling_freq ;  u32 avg_samples ;  u32 vref_external ;  u32 value ; } cocci_id@p ;
...
typedef u32;
@@
 struct adc_regs_spear6xx {  u32 status ;  u32 pad [ 2 ] ;  u32 clk ;  u32 ch_ctrl [ SPEAR_ADC_CHANNEL_NUM ] ;  struct chan_data ch_data [ SPEAR_ADC_CHANNEL_NUM ] ;  u32 scan_rate_lo ;  u32 scan_rate_hi ;  struct chan_data average ; } cocci_id@p ;
...
position p;
@@
 struct spear_adc_state * cocci_id@p ;
...
typedef u32;
@@
 struct chan_data {  u32 lsb ;  u32 msb ; } cocci_id@p ;
