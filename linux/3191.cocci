...
position p;
@@
 struct f71805f_data cocci_id@p ;
...
position p;
@@
 struct attribute * cocci_id@p [ 4 ] [ 5 ] ;
...
typedef u8,u16;
@@
 struct f71805f_data {  unsigned short addr ;  const char * name ;  struct device * hwmon_dev ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  unsigned long last_limits ;  u8 in [ 11 ] ;  u8 in_high [ 11 ] ;  u8 in_low [ 11 ] ;  u16 has_in ;  u16 fan [ 3 ] ;  u16 fan_low [ 3 ] ;  u16 fan_target [ 3 ] ;  u8 fan_ctrl [ 3 ] ;  u8 pwm [ 3 ] ;  u8 pwm_freq [ 3 ] ;  u8 temp [ 3 ] ;  u8 temp_high [ 3 ] ;  u8 temp_hyst [ 3 ] ;  u8 temp_mode ;  unsigned long alarms ;  struct f71805f_auto_point auto_points [ 3 ] ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct f71805f_auto_point {  u8 temp [ 3 ] ;  u16 fan [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 const struct f71805f_sio_data * cocci_id@p ;
...
position p;
@@
 struct f71805f_sio_data cocci_id@p ;
...
typedef u8;
@@
 struct f71805f_sio_data {  enum kinds kind ;  u8 fnsel1 ; } cocci_id@p ;
...
position p;
@@
 enum kinds { f71805f , f71872f , } cocci_id@p ;
