...
position p;
@@
 struct xive_irq_data * cocci_id@p ;
...
position p;
@@
 struct kvmppc_xive_src_block * cocci_id@p ;
...
position p;
@@
 struct kvmppc_xive_irq_state * cocci_id@p ;
...
position p;
@@
 struct kvmppc_xive_vcpu * cocci_id@p ;
