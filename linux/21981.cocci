...
position p;
@@
 struct ts_fsm_token cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ TS_FSM_TYPE_MAX + 1 ] ;
...
position p;
@@
 struct ts_fsm {  unsigned int ntokens ;  struct ts_fsm_token tokens [ 0 ] ; } cocci_id@p ;
