...
position p;
@@
 struct vpdma_channel_info {  int num ;  int cstat_offset ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vpdma_dtd * dtd ) ;
...
position p;
@@
 enum vpdma_frame_start_event cocci_id@p ;
...
position p;
@@
 struct vpdma_desc_list cocci_id@p ;
...
position p;
@@
 const struct vpdma_channel_info cocci_id@p [ ] ;
