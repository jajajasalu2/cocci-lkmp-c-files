...
position p;
@@
 struct mlx5e_rep_indr_block_priv * cocci_id@p ;
...
position p;
@@
 struct mlx5e_rep_indr_block_priv {  struct net_device * netdev ;  struct mlx5e_rep_priv * rpriv ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5e_neigh_hash_entry * nhe ) ;
...
position p;
@@
 struct mlx5e_neigh_hash_entry * cocci_id@p ( struct mlx5e_priv * priv , struct mlx5e_neigh * m_neigh ) ;
...
position p;
@@
 struct mlx5_tun_entropy * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5e_rep_priv * rpriv , struct net_device * netdev ) ;
...
position p;
@@
 struct mlx5e_neigh_update_table * cocci_id@p ;
...
position p;
@@
 const struct counter_desc cocci_id@p [ ] ;
...
typedef u64;
@@
 struct vport_stats {  u64 vport_rx_packets ;  u64 vport_tx_packets ;  u64 vport_rx_bytes ;  u64 vport_tx_bytes ; } cocci_id@p ;
...
position p;
@@
 const struct mlx5_eswitch_rep_ops cocci_id@p ;
...
position p;
@@
 struct mlx5e_sw_stats cocci_id@p ;
...
position p;
@@
 struct mlx5e_rep_sq * cocci_id@p ;
...
position p;
@@
 const struct mlx5e_rep_priv * cocci_id@p ;
