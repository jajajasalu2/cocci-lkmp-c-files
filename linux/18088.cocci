...
position p;
@@
 enum { TID_CLOCKEVENT , TID_CLOCKSOURCE , } cocci_id@p ;
...
position p;
@@
 struct timer_s {  char * name ;  unsigned int id ;  unsigned long period ;  unsigned long opts ;  unsigned long flags ;  void __iomem * base ;  unsigned long tim_off ;  unsigned long prd_off ;  unsigned long enamode_shift ;  struct irqaction irqaction ; } cocci_id@p ;
...
position p;
@@
 struct davinci_timer_instance * cocci_id@p ;
