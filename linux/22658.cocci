...
position p;
@@
 struct uac_format_type_ii_discrete_descriptor * cocci_id@p ;
...
position p;
@@
 struct uac_format_type_i_ext_descriptor * cocci_id@p ;
...
position p;
@@
 struct uac_format_type_ii_ext_descriptor * cocci_id@p ;
