...
typedef u32;
@@
 u32 cocci_id@p [ RCPM_WAKEUP_CELL_MAX_SIZE ] ;
...
typedef bool;
@@
 struct rcpm {  unsigned int wakeup_cells ;  void __iomem * ippdexpcr_base ;  bool little_endian ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ RCPM_WAKEUP_CELL_MAX_SIZE + 1 ] ;
