...
position p;
@@
 enum rk3x_i2c_state { STATE_IDLE , STATE_START , STATE_READ , STATE_WRITE , STATE_STOP , } cocci_id@p ;
...
position p;
@@
 enum { REG_CON_MOD_TX = 0 , REG_CON_MOD_REGISTER_TX , REG_CON_MOD_RX , REG_CON_MOD_REGISTER_RX , } cocci_id@p ;
...
position p;
@@
 const struct rk3x_i2c_soc_data cocci_id@p ;
...
position p;
@@
 struct rk3x_i2c_calced_timings * cocci_id@p ;
...
position p;
@@
 const struct i2c_spec_values * cocci_id@p ;
...
@@
 struct rk3x_i2c {  struct i2c_adapter adap ;  struct device * dev ;  const struct rk3x_i2c_soc_data * soc_data ;  void __iomem * regs ;  struct clk * clk ;  struct clk * pclk ;  struct notifier_block clk_rate_nb ;  struct i2c_timings t ;  spinlock_t lock ;  wait_queue_head_t wait ;  bool busy ;  struct i2c_msg * msg ;  u8 addr ;  unsigned int mode ;  bool is_last_msg ;  enum rk3x_i2c_state state ;  unsigned int processed ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct i2c_spec_values {  unsigned long min_hold_start_ns ;  unsigned long min_low_ns ;  unsigned long min_high_ns ;  unsigned long min_setup_start_ns ;  unsigned long max_data_hold_ns ;  unsigned long min_data_setup_ns ;  unsigned long min_setup_stop_ns ;  unsigned long min_hold_buffer_ns ; } cocci_id@p ;
...
position p;
@@
 struct rk3x_i2c_calced_timings {  unsigned long div_low ;  unsigned long div_high ;  unsigned int tuning ; } cocci_id@p ;
