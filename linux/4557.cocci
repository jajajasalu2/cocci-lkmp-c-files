...
position p;
@@
 struct gru_set_context_option_req cocci_id@p ;
...
position p;
@@
 struct gru_get_gseg_statistics_req cocci_id@p ;
...
position p;
@@
 struct gru_mm_struct * cocci_id@p ;
...
position p;
@@
 struct gru_tlb_fault_handle * cocci_id@p ;
...
position p;
@@
 struct gru_unload_context_req cocci_id@p ;
...
position p;
@@
 struct gru_tlb_fault_map cocci_id@p ;
...
position p;
@@
 struct gru_instruction_bits * cocci_id@p ;
...
position p;
@@
 struct gru_flush_tlb_req cocci_id@p ;
