...
position p;
@@
 const struct adxl34x_bus_ops * cocci_id@p ;
...
typedef bool;
@@
 struct adxl34x {  struct device * dev ;  struct input_dev * input ;  struct mutex mutex ;  struct adxl34x_platform_data pdata ;  struct axis_triple swcal ;  struct axis_triple hwcal ;  struct axis_triple saved ;  char phys [ 32 ] ;  unsigned orient2d_saved ;  unsigned orient3d_saved ;  bool disabled ;  bool opened ;  bool suspended ;  bool fifo_delay ;  int irq ;  unsigned model ;  unsigned int_mask ;  const struct adxl34x_bus_ops * bops ; } cocci_id@p ;
...
position p;
@@
 struct adxl34x_platform_data * cocci_id@p ;
...
position p;
@@
 const struct adxl34x_platform_data cocci_id@p ;
...
position p;
@@
 struct axis_triple {  int x ;  int y ;  int z ; } cocci_id@p ;
