...
typedef spinlock_t;
@@
 struct dp83640_private {  struct list_head list ;  struct dp83640_clock * clock ;  struct phy_device * phydev ;  struct delayed_work ts_work ;  int hwts_tx_en ;  int hwts_rx_en ;  int layer ;  int version ;  int cfg0 ;  struct phy_txts edata ;  struct list_head rxts ;  struct list_head rxpool ;  struct rxts rx_pool_data [ MAX_RXTS ] ;  spinlock_t rx_lock ;  struct sk_buff_head rx_queue ;  struct sk_buff_head tx_queue ; } cocci_id@p ;
...
typedef u16;
@@
 struct phy_rxts {  u16 ns_lo ;  u16 ns_hi ;  u16 sec_lo ;  u16 sec_hi ;  u16 seqid ;  u16 msgtype ; } cocci_id@p ;
...
position p;
@@
 struct dp83640_clock cocci_id@p ;
...
position p;
@@
 struct dp83640_private cocci_id@p ;
...
position p;
@@
 struct dp83640_clock {  struct list_head list ;  struct mii_bus * bus ;  struct mutex extreg_lock ;  int page ;  struct ptp_clock_info caps ;  struct mutex clock_lock ;  struct dp83640_private * chosen ;  struct list_head phylist ;  struct ptp_clock * ptp_clock ; } cocci_id@p ;
...
position p;
@@
 enum { CALIBRATE_GPIO , PEROUT_GPIO , EXTTS0_GPIO , EXTTS1_GPIO , EXTTS2_GPIO , EXTTS3_GPIO , EXTTS4_GPIO , EXTTS5_GPIO , GPIO_TABLE_SIZE , } cocci_id@p ;
...
position p;
@@
 struct dp83640_skb_info * cocci_id@p ;
...
position p;
@@
 struct dp83640_skb_info {  int ptp_type ;  unsigned long tmo ; } cocci_id@p ;
...
typedef u8,u64,u16;
@@
 struct rxts {  struct list_head list ;  unsigned long tmo ;  u64 ns ;  u16 seqid ;  u8 msgtype ;  u16 hash ; } cocci_id@p ;
...
position p;
@@
 ushort cocci_id@p [ GPIO_TABLE_SIZE ] ;
...
typedef u16;
@@
 struct phy_txts {  u16 ns_lo ;  u16 ns_hi ;  u16 sec_lo ;  u16 sec_hi ; } cocci_id@p ;
