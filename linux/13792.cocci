...
position p;
@@
 const struct m5mols_platform_data * cocci_id@p ;
...
position p;
@@
 enum m5mols_restype cocci_id@p ;
...
typedef bool;
@@
 int ( * cocci_id@p ) ( struct m5mols_info * , bool ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ M5MOLS_I2C_MAX_SIZE + 1 ] ;
...
position p;
@@
 const struct m5mols_resolution cocci_id@p [ ] ;
...
position p;
@@
 struct m5mols_version * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ M5MOLS_I2C_MAX_SIZE + 4 ] ;
...
position p;
@@
 struct v4l2_mbus_framefmt cocci_id@p [ M5MOLS_RESTYPE_MAX ] ;
