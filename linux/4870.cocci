...
position p;
@@
 struct bnxt_qplib_dpi * cocci_id@p ;
...
position p;
@@
 enum bnxt_qplib_hwq_type cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_pd_tbl * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pdev , struct bnxt_qplib_stats * stats ) ;
...
position p;
@@
 struct bnxt_qplib_stats * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_pd * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_sg_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pci_dev * pdev , struct bnxt_qplib_stats * stats ) ;
...
position p;
@@
 struct bnxt_qplib_dpi_tbl * cocci_id@p ;
