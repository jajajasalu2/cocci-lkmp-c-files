...
position p;
@@
 struct gfar_private * cocci_id@p ;
...
position p;
@@
 struct gfar_priv_rx_q * cocci_id@p ;
...
position p;
@@
 struct ethtool_flow_spec_container * cocci_id@p ;
...
position p;
@@
 struct gfar_priv_tx_q * cocci_id@p ;
