...
position p;
@@
 struct intel_gvt_irq_ops * cocci_id@p ;
...
position p;
@@
 struct intel_gvt_vblank_timer cocci_id@p ;
...
position p;
@@
 struct intel_gvt_irq_info cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ INTEL_GVT_EVENT_MAX ] ;
...
position p;
@@
 struct intel_gvt_irq * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef gvt_event_virt_handler_t;
@@
 gvt_event_virt_handler_t cocci_id@p ;
...
position p;
@@
 struct intel_gvt_irq_map cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct intel_vgpu * vgpu , struct intel_gvt_irq_info * info ) ;
