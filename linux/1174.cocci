...
position p;
@@
 struct cppi41_dma_channel * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cppi41_dma_controller {  struct dma_controller controller ;  struct cppi41_dma_channel * rx_channel ;  struct cppi41_dma_channel * tx_channel ;  struct hrtimer early_tx ;  struct list_head early_tx_list ;  u32 rx_mode ;  u32 tx_mode ;  u32 auto_req ;  u32 tdown_reg ;  u32 autoreq_reg ;  void ( * set_dma_mode ) ( struct cppi41_dma_channel * cppi41_channel , unsigned int mode ) ;  u8 num_channels ; } cocci_id@p ;
...
position p;
@@
 struct cppi41_dma_controller * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * private_data , const struct dmaengine_result * result ) ;
