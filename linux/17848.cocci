...
position p;
@@
 struct ia64_nfw_context cocci_id@p ;
...
position p;
@@
 struct ia64_pdesc {  void * ip ;  void * gp ; } cocci_id@p ;
...
typedef u64;
@@
 struct ia64_nfw_context {  u64 arg [ 8 ] ;  struct ia64_sal_retval ret ;  u64 ip ;  u64 gp ;  u64 pad [ 2 ] ; } cocci_id@p ;
