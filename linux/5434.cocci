...
position p;
@@
 struct bcm63xx_hsspi * cocci_id@p ;
...
typedef u8,u32;
@@
 struct bcm63xx_hsspi {  struct completion done ;  struct mutex bus_mutex ;  struct platform_device * pdev ;  struct clk * clk ;  struct clk * pll_clk ;  void __iomem * regs ;  u8 __iomem * fifo ;  u32 speed_hz ;  u8 cs_polarity ; } cocci_id@p ;
