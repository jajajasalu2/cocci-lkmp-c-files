...
position p;
@@
 struct _carl9170_tx_superdesc cocci_id@p ;
...
position p;
@@
 const struct carl9170_rsp * cocci_id@p ;
...
position p;
@@
 struct carl9170_bar_list_entry * cocci_id@p ;
...
position p;
@@
 struct carl9170_tx_info * cocci_id@p ;
...
position p;
@@
 struct _ar9170_tx_hwdesc cocci_id@p ;
