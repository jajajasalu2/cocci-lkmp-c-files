...
typedef u8;
@@
 struct ts2020_reg_val {  u8 reg ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 const struct ts2020_reg_val cocci_id@p [ ] ;
...
position p;
@@
 const struct ts2020_config * cocci_id@p ;
