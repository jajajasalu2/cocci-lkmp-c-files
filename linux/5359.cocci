...
position p;
@@
 struct root_device {  struct device dev ;  struct module * owner ; } cocci_id@p ;
...
position p;
@@
 const struct kobj_ns_type_operations * cocci_id@p ;
...
position p;
@@
 union device_attr_group_devres {  const struct attribute_group * group ;  const struct attribute_group * * groups ; } cocci_id@p ;
...
position p;
@@
 struct dev_ext_attribute cocci_id@p ;
...
position p;
@@
 union device_attr_group_devres * cocci_id@p ;
...
position p;
@@
 struct class_dir {  struct kobject kobj ;  struct class * class ; } cocci_id@p ;
...
position p;
@@
 enum device_link_state cocci_id@p ;
...
position p;
@@
 struct device_private * cocci_id@p ;
