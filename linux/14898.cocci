...
position p;
@@
 const struct asm9260_mux_clock * cocci_id@p ;
...
position p;
@@
 const struct asm9260_gate_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct asm9260_mux_clock {  u8 mask ;  u32 * table ;  const char * name ;  const char * * parent_names ;  u8 num_parents ;  unsigned long offset ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 const struct asm9260_div_clk * cocci_id@p ;
...
typedef u8,u32;
@@
 struct asm9260_gate_data {  unsigned int idx ;  const char * name ;  const char * parent_name ;  u32 reg ;  u8 bit_idx ;  unsigned long flags ; } cocci_id@p ;
...
typedef u32;
@@
 struct asm9260_div_clk {  unsigned int idx ;  const char * name ;  const char * parent_name ;  u32 reg ; } cocci_id@p ;
