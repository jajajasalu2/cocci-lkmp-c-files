...
position p;
@@
 struct sha1_ce_state * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct sha1_ce_state * sst , const u8 * src , int blocks ) ;
...
typedef u32;
@@
 struct sha1_ce_state {  struct sha1_state sst ;  u32 finalize ; } cocci_id@p ;
