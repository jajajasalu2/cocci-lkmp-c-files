...
position p;
@@
 struct pcidev_cookie * cocci_id@p ;
...
position p;
@@
 struct pcic_sn2list {  char * sysname ;  struct pcic_ca2irq * intmap ;  int mapdim ; } cocci_id@p ;
...
position p;
@@
 struct linux_prom_registers cocci_id@p [ PROMREG_MAX ] ;
...
position p;
@@
 struct pcic_sn2list * cocci_id@p ;
...
position p;
@@
 struct linux_pbm_info * cocci_id@p ;
...
position p;
@@
 struct pcic_ca2irq {  unsigned char busno ;  unsigned char devfn ;  unsigned char pin ;  unsigned char irq ;  unsigned int force ; } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct platform_device * op , unsigned int real_irq ) ;
...
position p;
@@
 struct linux_prom_pci_registers cocci_id@p [ PROMREG_MAX ] ;
