...
position p;
@@
 struct intel_memory_region * cocci_id@p ;
...
position p;
@@
 struct capture_vma {  struct capture_vma * next ;  void * * slot ; } cocci_id@p ;
...
typedef bool;
@@
 struct compress {  struct pagevec pool ;  bool wc ; } cocci_id@p ;
...
position p;
@@
 const struct i915_error_uc * cocci_id@p ;
...
position p;
@@
 struct i915_capture_list * cocci_id@p ;
...
position p;
@@
 struct drm_i915_error_object * cocci_id@p ;
...
position p;
@@
 struct drm_i915_error_request * cocci_id@p ;
...
position p;
@@
 const struct drm_i915_error_context * cocci_id@p ;
...
position p;
@@
 const struct intel_engine_execlists * const cocci_id@p ;
...
position p;
@@
 struct i915_error_uc * cocci_id@p ;
...
position p;
@@
 const struct i915_gpu_state * cocci_id@p ;
...
position p;
@@
 const struct drm_i915_error_object * cocci_id@p ;
...
position p;
@@
 const struct drm_i915_error_engine * cocci_id@p ;
...
position p;
@@
 struct drm_i915_error_context * cocci_id@p ;
...
position p;
@@
 struct drm_i915_error_engine * cocci_id@p ;
...
position p;
@@
 const struct intel_driver_caps * cocci_id@p ;
...
position p;
@@
 const struct drm_i915_error_request * cocci_id@p ;
...
typedef bool;
@@
 struct compress {  struct pagevec pool ;  struct z_stream_s zstream ;  void * tmp ;  bool wc ; } cocci_id@p ;
...
position p;
@@
 const struct i915_params * cocci_id@p ;
