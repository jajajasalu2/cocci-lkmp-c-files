...
symbol cocci_id;
position p;
typedef bool,u32,dma_addr_t;
@@
 struct rx_ring {  struct fbr_lookup * fbr [ NUM_FBRS ] ;  void * ps_ring_virtaddr ;  dma_addr_t ps_ring_physaddr ;  u32 local_psr_full ;  u32 psr_entries ;  struct rx_status_block * rx_status_block ;  dma_addr_t rx_status_bus ;  struct list_head recv_list ;  u32 num_ready_recv ;  u32 num_rfd ;  bool unfinished_receives ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct rfd {  struct list_head list_node ;  struct sk_buff * skb ;  u32 len ;  u16 bufferindex ;  u8 ringindex ; } cocci_id@p ;
...
typedef u32;
@@
 struct fbr_desc {  u32 addr_lo ;  u32 addr_hi ;  u32 word2 ; } cocci_id@p ;
...
typedef u32;
@@
 struct pkt_stat_desc {  u32 word0 ;  u32 word1 ; } cocci_id@p ;
...
position p;
@@
 struct rx_status_block cocci_id@p ;
...
@@
 struct et131x_adapter {  struct net_device * netdev ;  struct pci_dev * pdev ;  struct mii_bus * mii_bus ;  struct napi_struct napi ;  u32 flags ;  int link ;  u8 rom_addr [ ETH_ALEN ] ;  u8 addr [ ETH_ALEN ] ;  bool has_eeprom ;  u8 eeprom_data [ 2 ] ;  spinlock_t tcb_send_qlock ;  spinlock_t tcb_ready_qlock ;  spinlock_t rcv_lock ;  u32 packet_filter ;  u32 multicast_addr_count ;  u8 multicast_list [ NIC_MAX_MCAST_LIST ] [ ETH_ALEN ] ;  struct address_map __iomem * regs ;  u8 wanted_flow ;  u32 registry_jumbo_packet ;  u8 flow ;  struct timer_list error_timer ;  u8 boot_coma ;  struct tx_ring tx_ring ;  struct rx_ring rx_ring ;  struct ce_stats stats ; } cocci_id@p ;
...
typedef u32;
@@
 struct tcb {  struct tcb * next ;  u32 count ;  u32 stale ;  struct sk_buff * skb ;  u32 index ;  u32 index_start ; } cocci_id@p ;
...
typedef u32;
@@
 struct ce_stats {  u32 multicast_pkts_rcvd ;  u32 rcvd_pkts_dropped ;  u32 tx_underflows ;  u32 tx_collisions ;  u32 tx_excessive_collisions ;  u32 tx_first_collisions ;  u32 tx_late_collisions ;  u32 tx_max_pkt_errs ;  u32 tx_deferred ;  u32 rx_overflows ;  u32 rx_length_errs ;  u32 rx_align_errs ;  u32 rx_crc_errs ;  u32 rx_code_violations ;  u32 rx_other_errs ;  u32 interrupt_status ; } cocci_id@p ;
...
position p;
@@
 struct et131x_adapter * cocci_id@p ;
...
@@
 struct fbr_lookup {  void * virt [ MAX_DESC_PER_RING_RX ] ;  u32 bus_high [ MAX_DESC_PER_RING_RX ] ;  u32 bus_low [ MAX_DESC_PER_RING_RX ] ;  void * ring_virtaddr ;  dma_addr_t ring_physaddr ;  void * mem_virtaddrs [ MAX_DESC_PER_RING_RX / FBR_CHUNKS ] ;  dma_addr_t mem_physaddrs [ MAX_DESC_PER_RING_RX / FBR_CHUNKS ] ;  u32 local_full ;  u32 num_entries ;  dma_addr_t buffsize ; } cocci_id@p ;
...
typedef u32,dma_addr_t;
@@
 struct tx_ring {  struct tcb * tcb_ring ;  struct tcb * tcb_qhead ;  struct tcb * tcb_qtail ;  struct tcb * send_head ;  struct tcb * send_tail ;  int used ;  struct tx_desc * tx_desc_ring ;  dma_addr_t tx_desc_ring_pa ;  u32 send_idx ;  u32 * tx_status ;  dma_addr_t tx_status_pa ;  int since_irq ; } cocci_id@p ;
...
position p;
@@
 struct pkt_stat_desc * cocci_id@p ;
...
typedef u32;
@@
 struct tx_desc {  u32 addr_hi ;  u32 addr_lo ;  u32 len_vlan ;  u32 flags ; } cocci_id@p ;
...
typedef u32;
@@
 struct rx_status_block {  u32 word0 ;  u32 word1 ; } cocci_id@p ;
