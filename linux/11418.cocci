...
position p;
@@
 struct vmw_bo_blit_line_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,pgprot_t;
@@
 struct vmw_bo_blit_line_data {  u32 mapped_dst ;  u8 * dst_addr ;  struct page * * dst_pages ;  u32 dst_num_pages ;  pgprot_t dst_prot ;  u32 mapped_src ;  u8 * src_addr ;  struct page * * src_pages ;  u32 src_num_pages ;  pgprot_t src_prot ;  struct vmw_diff_cpy * diff ; } cocci_id@p ;
