...
typedef u8,u32;
@@
 struct clk_fepll {  u32 fixed_div ;  const u8 * parent_map ;  struct clk_regmap_div cdiv ;  const struct clk_fepll_vco * pll_vco ;  const struct clk_div_table * div_table ;  const struct freq_tbl * freq_tbl ; } cocci_id@p ;
...
position p;
@@
 const struct qcom_cc_desc cocci_id@p ;
...
typedef u32;
@@
 struct clk_fepll_vco {  u32 fdbkdiv_shift ;  u32 fdbkdiv_width ;  u32 refclkdiv_shift ;  u32 refclkdiv_width ;  u32 reg ; } cocci_id@p ;
...
position p;
@@
 const struct qcom_reset_map cocci_id@p [ ] ;
...
position p;
@@
 const struct clk_fepll_vco cocci_id@p ;
...
position p;
@@
 enum { P_XO , P_FEPLL200 , P_FEPLL500 , P_DDRPLL , P_FEPLLWCSS2G , P_FEPLLWCSS5G , P_FEPLL125DLY , P_DDRPLLAPSS , } cocci_id@p ;
...
position p;
@@
 struct clk_regmap_div cocci_id@p ;
