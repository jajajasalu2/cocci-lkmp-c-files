...
typedef atomic_t;
@@
 struct coda_vm_ops {  atomic_t refcnt ;  struct file * coda_file ;  const struct vm_operations_struct * host_vm_ops ;  struct vm_operations_struct vm_ops ; } cocci_id@p ;
...
position p;
@@
 struct coda_file_info cocci_id@p ;
