...
position p;
@@
 struct nft_range_expr cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_RANGE_MAX + 1 ] ;
...
position p;
@@
 const struct nft_range_expr * cocci_id@p ;
...
typedef u8;
@@
 struct nft_range_expr {  struct nft_data data_from ;  struct nft_data data_to ;  enum nft_registers sreg : 8 ;  u8 len ;  enum nft_range_ops op : 8 ; } cocci_id@p ;
