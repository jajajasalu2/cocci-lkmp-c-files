...
typedef bool,u32;
@@
 struct ls_extirq_data {  struct regmap * syscon ;  u32 intpcr ;  bool bit_reverse ;  u32 nirq ;  struct irq_fwspec map [ MAXIRQ ] ; } cocci_id@p ;
...
position p;
@@
 struct ls_extirq_data * cocci_id@p ;
