...
position p;
@@
 void cocci_id@p ( struct sctp_ulpq * ulpq ) ;
...
position p;
@@
 struct sctp_ulpevent * cocci_id@p ( struct sctp_ulpq * ulpq , struct sctp_ulpevent * ) ;
...
position p;
@@
 struct sctp_ulpevent * cocci_id@p ( struct sctp_ulpq * , struct sctp_ulpevent * ) ;
