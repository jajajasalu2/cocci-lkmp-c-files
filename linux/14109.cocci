...
position p;
@@
 const struct vsp1_sru_param * cocci_id@p ;
...
position p;
@@
 const struct vsp1_entity_operations cocci_id@p ;
...
typedef u32;
@@
 struct vsp1_sru_param {  u32 ctrl0 ;  u32 ctrl2 ; } cocci_id@p ;
