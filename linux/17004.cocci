...
position p;
@@
 const struct zforce_ts_platdata * cocci_id@p ;
...
position p;
@@
 struct zforce_ts_platdata * cocci_id@p ;
...
typedef bool,u16;
@@
 struct zforce_ts {  struct i2c_client * client ;  struct input_dev * input ;  const struct zforce_ts_platdata * pdata ;  char phys [ 32 ] ;  struct regulator * reg_vdd ;  struct gpio_desc * gpio_int ;  struct gpio_desc * gpio_rst ;  bool suspending ;  bool suspended ;  bool boot_complete ;  u16 version_major ;  u16 version_minor ;  u16 version_build ;  u16 version_rev ;  struct mutex access_mutex ;  struct completion command_done ;  struct mutex command_mutex ;  int command_waiting ;  int command_result ; } cocci_id@p ;
...
position p;
@@
 struct zforce_point {  int coord_x ;  int coord_y ;  int state ;  int id ;  int area_major ;  int area_minor ;  int orientation ;  int pressure ;  int prblty ; } cocci_id@p ;
...
position p;
@@
 struct zforce_point cocci_id@p ;
