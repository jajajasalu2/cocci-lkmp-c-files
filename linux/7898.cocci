...
position p;
@@
 const struct vsc73xx_ops cocci_id@p ;
...
position p;
@@
 struct vsc73xx_spi {  struct spi_device * spi ;  struct mutex lock ;  struct vsc73xx vsc ; } cocci_id@p ;
