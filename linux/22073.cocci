...
typedef u8;
@@
 struct test_user {  u8 one ;  unsigned long two ;  char __user * three ;  unsigned long four ; } cocci_id@p ;
...
position p;
@@
 struct test_trailing_hole {  char * one ;  char * two ;  char * three ;  char four ; } cocci_id@p ;
...
position p;
@@
 struct test_small_hole {  size_t one ;  char two ;  int three ;  unsigned long four ; } cocci_id@p ;
...
position p;
@@
 struct test_packed {  unsigned long one ;  unsigned long two ;  unsigned long three ;  unsigned long four ; } cocci_id@p ;
