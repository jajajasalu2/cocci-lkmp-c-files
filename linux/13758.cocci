...
position p;
@@
 struct lm3646_platform_data * cocci_id@p ;
...
position p;
@@
 enum v4l2_flash_led_mode cocci_id@p ;
...
position p;
@@
 struct lm3646_flash cocci_id@p ;
...
position p;
@@
 enum led_mode { MODE_SHDN = 0x0 , MODE_TORCH = 0x2 , MODE_FLASH = 0x3 , } cocci_id@p ;
...
typedef u8;
@@
 struct lm3646_flash {  struct device * dev ;  struct lm3646_platform_data * pdata ;  struct regmap * regmap ;  struct v4l2_ctrl_handler ctrls_led ;  struct v4l2_subdev subdev_led ;  u8 mode_reg ; } cocci_id@p ;
