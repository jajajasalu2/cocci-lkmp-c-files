...
@@
 struct dac7612 {  struct spi_device * spi ;  struct gpio_desc * loaddacs ;  uint16_t cache [ 2 ] ;  uint8_t data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
