...
position p;
@@
 struct direntry_uarea cocci_id@p ;
...
position p;
@@
 struct virtual_node * cocci_id@p ;
...
position p;
@@
 struct item_operations * cocci_id@p [ TYPE_ANY + 1 ] ;
...
position p;
@@
 struct item_operations cocci_id@p ;
...
position p;
@@
 struct virtual_item * cocci_id@p ;
