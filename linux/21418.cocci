...
position p;
@@
 const struct arm64_midr_revidr * cocci_id@p ;
...
position p;
@@
 struct bp_hardening_data cocci_id@p ;
...
position p;
@@
 const struct ssbd_options {  const char * str ;  int state ; } cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef bp_hardening_cb_t;
@@
 bp_hardening_cb_t cocci_id@p ;
