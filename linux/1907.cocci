...
position p;
@@
 struct aspeed_adc_data * cocci_id@p ;
...
position p;
@@
 const struct aspeed_adc_model_data * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct aspeed_adc_data {  struct device * dev ;  void __iomem * base ;  spinlock_t clk_lock ;  struct clk_hw * clk_prescaler ;  struct clk_hw * clk_scaler ;  struct reset_control * rst ; } cocci_id@p ;
...
typedef bool;
@@
 struct aspeed_adc_model_data {  const char * model_name ;  unsigned int min_sampling_rate ;  unsigned int max_sampling_rate ;  unsigned int vref_voltage ;  bool wait_init_sequence ; } cocci_id@p ;
