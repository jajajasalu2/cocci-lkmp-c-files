...
position p;
@@
 struct wm9081_retune_mobile_setting * cocci_id@p ;
...
position p;
@@
 struct wm9081_pdata * cocci_id@p ;
...
position p;
@@
 struct wm9081_priv {  struct regmap * regmap ;  int sysclk_source ;  int mclk_rate ;  int sysclk_rate ;  int fs ;  int bclk ;  int master ;  int fll_fref ;  int fll_fout ;  int tdm_width ;  struct wm9081_pdata pdata ; } cocci_id@p ;
