...
typedef u8;
@@
 struct ab3100_init_setting {  u8 abreg ;  u8 setting ; } cocci_id@p ;
...
typedef u8;
@@
 struct ab_family_id {  u8 id ;  char * name ; } cocci_id@p ;
...
position p;
@@
 const struct ab_family_id cocci_id@p [ ] ;
...
position p;
@@
 struct ab3100_get_set_reg_priv * cocci_id@p ;
...
typedef bool;
@@
 struct ab3100_get_set_reg_priv {  struct ab3100 * ab3100 ;  bool mode ; } cocci_id@p ;
...
position p;
@@
 const struct ab3100_init_setting cocci_id@p [ ] ;
