...
position p;
@@
 const struct decode_checker * cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef probes_opcode_t;
@@
 probes_opcode_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef probes_check_t;
@@
 probes_check_t * cocci_id@p ;
...
position p;
@@
 struct arch_probes_insn * cocci_id@p ;
...
position p;
@@
 const union decode_action * cocci_id@p ;
