...
position p;
@@
 struct compat_fps {  unsigned int regs [ 32 ] ;  unsigned int fsr ;  unsigned int flags ;  unsigned int extra ;  unsigned int fpqd ;  struct compat_fq {  unsigned int insnaddr ;  unsigned int insn ; } fpq [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 struct reg_window32 cocci_id@p ;
...
position p;
@@
 enum sparc_regset { REGSET_GENERAL , REGSET_FP , } cocci_id@p ;
...
position p;
@@
 struct fps {  unsigned int regs [ 64 ] ;  unsigned long fsr ; } cocci_id@p ;
