...
position p;
@@
 struct atmel_aes_authenc_ctx cocci_id@p ;
...
position p;
@@
 struct atmel_aes_base_ctx * cocci_id@p ;
...
position p;
@@
 struct atmel_aes_authenc_reqctx * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ SHA512_DIGEST_SIZE / sizeof ( u32 ) ] ;
...
position p;
@@
 struct atmel_aes_dev * cocci_id@p ;
...
position p;
@@
 struct crypto_platform_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct atmel_aes_dev * dd ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct atmel_aes_dev * dd , int err , bool is_async ) ;
...
position p;
@@
 struct atmel_aes_dma * cocci_id@p ;
...
position p;
@@
 const struct atmel_aes_reqctx * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,atmel_aes_fn_t,spinlock_t;
@@
 struct atmel_aes_dev {  struct list_head list ;  unsigned long phys_base ;  void __iomem * io_base ;  struct crypto_async_request * areq ;  struct atmel_aes_base_ctx * ctx ;  bool is_async ;  atmel_aes_fn_t resume ;  atmel_aes_fn_t cpu_transfer_complete ;  struct device * dev ;  struct clk * iclk ;  int irq ;  unsigned long flags ;  spinlock_t lock ;  struct crypto_queue queue ;  struct tasklet_struct done_task ;  struct tasklet_struct queue_task ;  size_t total ;  size_t datalen ;  u32 * data ;  struct atmel_aes_dma src ;  struct atmel_aes_dma dst ;  size_t buflen ;  void * buf ;  struct scatterlist aligned_sg ;  struct scatterlist * real_dst ;  struct atmel_aes_caps caps ;  u32 hw_version ; } cocci_id@p ;
...
position p;
@@
 struct atmel_aes_authenc_ctx {  struct atmel_aes_base_ctx base ;  struct atmel_sha_authenc_ctx * auth ; } cocci_id@p ;
...
position p;
@@
 struct atmel_aes_gcm_ctx * cocci_id@p ;
...
position p;
@@
 dma_async_tx_callback cocci_id@p ;
...
position p;
@@
 struct at_dma_slave * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,u16,atmel_aes_fn_t;
@@
 struct atmel_aes_base_ctx {  struct atmel_aes_dev * dd ;  atmel_aes_fn_t start ;  int keylen ;  u32 key [ AES_KEYSIZE_256 / sizeof ( u32 ) ] ;  u16 block_size ;  bool is_aead ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef atmel_aes_fn_t;
@@
 atmel_aes_fn_t cocci_id@p ;
...
position p;
@@
 struct atmel_aes_ctr_ctx * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct atmel_aes_dev * ) ;
...
position p;
@@
 struct atmel_aes_xts_ctx cocci_id@p ;
...
position p;
@@
 struct atmel_aes_drv cocci_id@p ;
...
position p;
@@
 const struct atmel_aes_dev * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct atmel_aes_drv {  struct list_head dev_list ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct atmel_aes_ctx cocci_id@p ;
...
typedef bool,u32;
@@
 struct atmel_aes_caps {  bool has_dualbuff ;  bool has_cfb64 ;  bool has_ctr32 ;  bool has_gcm ;  bool has_xts ;  bool has_authenc ;  u32 max_burst_size ; } cocci_id@p ;
...
typedef u8;
@@
 struct atmel_aes_reqctx {  unsigned long mode ;  u8 lastc [ AES_BLOCK_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 enum dma_slave_buswidth cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct atmel_aes_dev * dd , int err ) ;
...
position p;
@@
 struct atmel_aes_reqctx * cocci_id@p ;
...
typedef u32,__be32;
@@
 struct atmel_aes_ctr_ctx {  struct atmel_aes_base_ctx base ;  __be32 iv [ AES_BLOCK_SIZE / sizeof ( u32 ) ] ;  size_t offset ;  struct scatterlist src [ 2 ] ;  struct scatterlist dst [ 2 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct atmel_aes_authenc_reqctx {  struct atmel_aes_reqctx base ;  struct scatterlist src [ 2 ] ;  struct scatterlist dst [ 2 ] ;  size_t textlen ;  u32 digest [ SHA512_DIGEST_SIZE / sizeof ( u32 ) ] ;  struct ahash_request auth_req ; } cocci_id@p ;
...
position p;
@@
 struct crypto_authenc_keys cocci_id@p ;
...
position p;
@@
 struct atmel_aes_ctx {  struct atmel_aes_base_ctx base ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ AES_BLOCK_SIZE / sizeof ( u32 ) ] ;
...
typedef u32;
@@
 struct atmel_aes_xts_ctx {  struct atmel_aes_base_ctx base ;  u32 key2 [ AES_KEYSIZE_256 / sizeof ( u32 ) ] ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_aes_dma * cocci_id@p ;
...
position p;
@@
 struct atmel_aes_dma {  struct dma_chan * chan ;  struct scatterlist * sg ;  int nents ;  unsigned int remainder ;  unsigned int sg_len ; } cocci_id@p ;
