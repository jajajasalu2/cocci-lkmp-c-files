...
@@
 struct applicom_board {  unsigned long PhysIO ;  void __iomem * RamIO ;  wait_queue_head_t FlagSleepSend ;  long irq ;  spinlock_t mutex ; } cocci_id@p [ MAX_BOARD ] ;
...
position p;
@@
 char cocci_id@p [ ( SERIAL_NUMBER - TYPE_CARD ) + 1 ] ;
