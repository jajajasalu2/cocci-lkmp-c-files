...
typedef u8;
@@
 struct chip_desc {  u8 nchans ;  u8 enable ;  u8 has_irq ;  enum muxtype { pca954x_ismux = 0 , pca954x_isswi , } muxtype ;  struct i2c_device_identity id ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s8,u8,raw_spinlock_t;
@@
 struct pca954x {  const struct chip_desc * chip ;  u8 last_chan ;  s8 idle_state ;  struct i2c_client * client ;  struct irq_domain * irq ;  unsigned int irq_mask ;  raw_spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 enum pca_type { pca_9540 , pca_9542 , pca_9543 , pca_9544 , pca_9545 , pca_9546 , pca_9547 , pca_9548 , pca_9846 , pca_9847 , pca_9848 , pca_9849 , } cocci_id@p ;
