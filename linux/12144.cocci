...
position p;
@@
 struct nvkm_pll_vals * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_crtc * crtc , int x , int y , struct drm_framebuffer * old_fb ) ;
...
position p;
@@
 struct nv04_page_flip_state * cocci_id@p ;
...
position p;
@@
 struct nv04_crtc_reg * cocci_id@p ;
...
position p;
@@
 struct nv04_mode_state * cocci_id@p ;
...
position p;
@@
 struct nouveau_fence_chan * cocci_id@p ;
...
position p;
@@
 struct nv04_display * cocci_id@p ;
