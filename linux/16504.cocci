...
position p;
@@
 struct hid_sensor_custom * cocci_id@p ;
...
position p;
@@
 const struct hid_custom_usage_desc {  int usage_id ;  char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 struct hid_sensor_custom_field cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ HID_CUSTOM_NAME_LENGTH ] ;
...
position p;
@@
 struct hid_custom_usage_desc * cocci_id@p ;
...
position p;
@@
 struct hid_sensor_sample cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HID_CUSTOM_MAX_FEATURE_BYTES ] ;
