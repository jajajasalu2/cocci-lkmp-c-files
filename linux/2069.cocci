...
position p;
@@
 enum { MAX6675 , MAX31855 , } cocci_id@p ;
...
position p;
@@
 struct maxim_thermocouple_data * cocci_id@p ;
...
typedef u8;
@@
 struct maxim_thermocouple_data {  struct spi_device * spi ;  const struct maxim_thermocouple_chip * chip ;  u8 buffer [ 16 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 const struct maxim_thermocouple_chip cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct maxim_thermocouple_chip {  const struct iio_chan_spec * channels ;  const unsigned long * scan_masks ;  u8 num_channels ;  u8 read_size ;  u32 status_bit ; } cocci_id@p ;
