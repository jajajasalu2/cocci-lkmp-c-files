...
typedef spinlock_t;
@@
 struct virtio_mmio_device {  struct virtio_device vdev ;  struct platform_device * pdev ;  void __iomem * base ;  unsigned long version ;  spinlock_t lock ;  struct list_head virtqueues ; } cocci_id@p ;
...
position p;
@@
 struct virtio_mmio_device * cocci_id@p ;
...
position p;
@@
 struct virtio_mmio_vq_info {  struct virtqueue * vq ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct virtio_mmio_vq_info * cocci_id@p ;
