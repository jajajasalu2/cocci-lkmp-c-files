...
typedef u8;
@@
 u8 cocci_id@p [ PCAN_USB_CMD_ARGS_LEN ] ;
...
position p;
@@
 struct pcan_usb_msg_context cocci_id@p ;
...
typedef u8,u16;
@@
 struct pcan_usb_msg_context {  u16 ts16 ;  u8 prev_ts8 ;  u8 * ptr ;  u8 * end ;  u8 rec_cnt ;  u8 rec_idx ;  u8 rec_ts_idx ;  struct net_device * netdev ;  struct pcan_usb * pdev ; } cocci_id@p ;
...
position p;
@@
 struct pcan_usb {  struct peak_usb_device dev ;  struct peak_time_ref time_ref ;  struct timer_list restart_timer ; } cocci_id@p ;
