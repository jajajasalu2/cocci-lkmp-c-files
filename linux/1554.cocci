...
position p;
@@
 struct ti_write_data_bytes * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ti_port * tport , struct tty_struct * tty ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct ti_port * tport , u8 * lsr ) ;
...
position p;
@@
 struct ti_port_status cocci_id@p ;
...
typedef bool;
@@
 struct ti_device {  struct mutex td_open_close_lock ;  int td_open_port_count ;  struct usb_serial * td_serial ;  int td_is_3410 ;  bool td_rs485_only ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , struct serial_struct * ss ) ;
...
position p;
@@
 int cocci_id@p ( struct ti_device * tdev ) ;
...
position p;
@@
 struct ti_firmware_header cocci_id@p ;
...
typedef __u16,__u8;
@@
 int cocci_id@p ( struct ti_device * tdev , __u8 command , __u16 moduleid , __u16 value , __u8 * data , int size ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , struct usb_serial_port * port , const unsigned char * data , int count ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct usb_serial_port * port , struct ti_device * tdev , unsigned long addr , u8 mask , u8 byte ) ;
...
@@
 struct ti_port {  int tp_is_open ;  u8 tp_msr ;  u8 tp_shadow_mcr ;  u8 tp_uart_mode ;  unsigned int tp_uart_base_addr ;  struct ti_device * tp_tdev ;  struct usb_serial_port * tp_port ;  spinlock_t tp_lock ;  int tp_read_urb_state ;  int tp_write_urb_in_use ; } cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct ti_port * tport , u8 msr ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct usb_serial_port * port ) ;
...
position p;
@@
 int cocci_id@p ( struct ti_port * tport , struct tty_struct * tty ) ;
...
position p;
@@
 int cocci_id@p ( struct ti_port * tport , unsigned int mcr ) ;
...
position p;
@@
 struct ti_uart_config * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ti_port * tport ) ;
