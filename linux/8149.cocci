...
typedef spinlock_t;
@@
 struct technologic_priv {  spinlock_t io_lock ; } cocci_id@p ;
...
position p;
@@
 const struct sja1000_of_data * cocci_id@p ;
...
position p;
@@
 struct technologic_priv * cocci_id@p ;
...
position p;
@@
 struct sja1000_of_data cocci_id@p ;
...
position p;
@@
 struct sja1000_of_data {  size_t priv_sz ;  int ( * init ) ( struct sja1000_priv * priv , struct device_node * of ) ; } cocci_id@p ;
