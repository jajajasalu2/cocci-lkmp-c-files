...
position p;
@@
 struct mlxsw_sp1_acl_tcam_region * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_acl_tcam_entry * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PTCE2_LEN ] ;
...
position p;
@@
 struct mlxsw_sp1_acl_tcam_region {  struct mlxsw_sp_acl_ctcam_region cregion ;  struct mlxsw_sp_acl_tcam_region * region ;  struct {  struct mlxsw_sp_acl_ctcam_chunk cchunk ;  struct mlxsw_sp_acl_ctcam_entry centry ;  struct mlxsw_sp_acl_rule_info * rulei ; } catchall ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_acl_tcam_chunk {  struct mlxsw_sp_acl_ctcam_chunk cchunk ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_acl_tcam_chunk * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_acl_tcam_entry {  struct mlxsw_sp_acl_ctcam_entry centry ; } cocci_id@p ;
