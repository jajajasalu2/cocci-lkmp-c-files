...
position p;
@@
 struct ipl_rb_certificate_entry cocci_id@p ;
...
position p;
@@
 struct s390_load_data cocci_id@p ;
...
position p;
@@
 struct module_signature * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct kimage * image , struct s390_load_data * data ) ;
