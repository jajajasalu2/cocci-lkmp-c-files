...
position p;
@@
 const struct intel_th_drvdata cocci_id@p ;
...
position p;
@@
 struct resource cocci_id@p [ TH_MMIO_END + TH_NVEC_MAX ] ;
...
position p;
@@
 enum { TH_PCI_CONFIG_BAR = 0 , TH_PCI_STH_SW_BAR = 2 , TH_PCI_RTIT_BAR = 4 , } cocci_id@p ;
