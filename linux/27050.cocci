...
position p;
@@
 struct xfs_bmbt_irec cocci_id@p ;
...
position p;
@@
 struct xfs_cud_log_item cocci_id@p ;
...
position p;
@@
 struct proc_xfs_info cocci_id@p [ ] ;
...
position p;
@@
 struct xfs_btree_cur cocci_id@p ;
...
position p;
@@
 struct xfs_inode_log_item cocci_id@p ;
...
position p;
@@
 struct xfs_iext_cursor cocci_id@p ;
...
position p;
@@
 struct xfs_efd_log_item cocci_id@p ;
...
position p;
@@
 struct xfs_bud_log_item cocci_id@p ;
...
position p;
@@
 typeof ( statp -> f_files ) cocci_id@p ;
...
position p;
@@
 struct xfs_extent_free_item cocci_id@p ;
...
position p;
@@
 struct xfs_icreate_item cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_buftarg_t;
@@
 xfs_buftarg_t * cocci_id@p ;
...
position p;
@@
 struct xfs_rud_log_item cocci_id@p ;
...
typedef uint64_t;
@@
 struct proc_xfs_info {  uint64_t flag ;  char * str ; } cocci_id@p ;
