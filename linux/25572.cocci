...
position p;
@@
 struct hlist_head cocci_id@p [ SRC_HTAB_SZ ] ;
...
position p;
@@
 struct srcfile {  struct hlist_node hash_nd ;  struct list_head nd ;  char * fn ;  char * * lines ;  char * map ;  unsigned numlines ;  size_t maplen ; } cocci_id@p ;
