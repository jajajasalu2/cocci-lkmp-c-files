...
typedef spinlock_t;
@@
 struct orion_gpio_chip {  struct gpio_chip chip ;  spinlock_t lock ;  void __iomem * base ;  unsigned long valid_input ;  unsigned long valid_output ;  int mask_offset ;  int secondary_irq_base ;  struct irq_domain * domain ; } cocci_id@p ;
...
position p;
@@
 struct orion_gpio_chip cocci_id@p [ 2 ] ;
...
position p;
@@
 struct orion_gpio_chip * cocci_id@p ;
