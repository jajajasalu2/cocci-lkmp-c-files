...
position p;
@@
 struct rio_dbell_msg * cocci_id@p ;
...
typedef u32;
@@
 struct rio_dbell_regs {  u32 odmr ;  u32 odsr ;  u32 pad1 [ 4 ] ;  u32 oddpr ;  u32 oddatr ;  u32 pad2 [ 3 ] ;  u32 odretcr ;  u32 pad3 [ 12 ] ;  u32 dmr ;  u32 dsr ;  u32 pad4 ;  u32 dqdpar ;  u32 pad5 ;  u32 dqepar ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct rio_msg_tx_ring {  void * virt ;  dma_addr_t phys ;  void * virt_buffer [ RIO_MAX_TX_RING_SIZE ] ;  dma_addr_t phys_buffer [ RIO_MAX_TX_RING_SIZE ] ;  int tx_slot ;  int size ;  void * dev_id ; } cocci_id@p ;
...
typedef u32;
@@
 struct rio_tx_desc {  u32 pad1 ;  u32 saddr ;  u32 dport ;  u32 dattr ;  u32 pad2 ;  u32 pad3 ;  u32 dwcnt ;  u32 pad4 ; } cocci_id@p ;
...
position p;
@@
 struct fsl_rio_dbell * cocci_id@p ;
...
position p;
@@
 struct rio_msg_regs * cocci_id@p ;
...
typedef u32;
@@
 struct rio_msg_regs {  u32 omr ;  u32 osr ;  u32 pad1 ;  u32 odqdpar ;  u32 pad2 ;  u32 osar ;  u32 odpr ;  u32 odatr ;  u32 odcr ;  u32 pad3 ;  u32 odqepar ;  u32 pad4 [ 13 ] ;  u32 imr ;  u32 isr ;  u32 pad5 ;  u32 ifqdpar ;  u32 pad6 ;  u32 ifqepar ; } cocci_id@p ;
...
position p;
@@
 struct fsl_rmu {  struct rio_msg_regs __iomem * msg_regs ;  struct rio_msg_tx_ring msg_tx_ring ;  struct rio_msg_rx_ring msg_rx_ring ;  int txirq ;  int rxirq ; } cocci_id@p ;
...
typedef u32;
@@
 struct rio_pw_regs {  u32 pwmr ;  u32 pwsr ;  u32 epwqbar ;  u32 pwqbar ; } cocci_id@p ;
...
typedef u16;
@@
 struct rio_dbell_msg {  u16 pad1 ;  u16 tid ;  u16 sid ;  u16 info ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct rio_msg_rx_ring {  void * virt ;  dma_addr_t phys ;  void * virt_buffer [ RIO_MAX_RX_RING_SIZE ] ;  int rx_slot ;  int size ;  void * dev_id ; } cocci_id@p ;
