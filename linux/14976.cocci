...
typedef u8;
@@
 struct npcm7xx_clk_div_fixed_data {  u8 mult ;  u8 div ;  const char * name ;  const char * parent_name ;  u8 clk_divider_flags ;  int onecell_idx ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct npcm7xx_clk_div_data {  u32 reg ;  u8 shift ;  u8 width ;  const char * name ;  const char * parent_name ;  u8 clk_divider_flags ;  unsigned long flags ;  int onecell_idx ; } cocci_id@p ;
...
position p;
@@
 const struct npcm7xx_clk_pll_data * cocci_id@p ;
...
position p;
@@
 struct npcm7xx_clk_pll * cocci_id@p ;
...
typedef u32;
@@
 struct npcm7xx_clk_pll_data {  u32 reg ;  const char * name ;  const char * parent_name ;  unsigned long flags ;  int onecell_idx ; } cocci_id@p ;
...
typedef u8;
@@
 struct npcm7xx_clk_pll {  struct clk_hw hw ;  void __iomem * pllcon ;  u8 flags ; } cocci_id@p ;
...
position p;
@@
 const struct npcm7xx_clk_div_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct npcm7xx_clk_mux_data {  u8 shift ;  u8 mask ;  u32 * table ;  const char * name ;  const char * const * parent_names ;  u8 num_parents ;  unsigned long flags ;  int onecell_idx ; } cocci_id@p ;
...
position p;
@@
 const struct npcm7xx_clk_mux_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct npcm7xx_clk_gate_data {  u32 reg ;  u8 bit_idx ;  const char * name ;  const char * parent_name ;  unsigned long flags ;  int onecell_idx ; } cocci_id@p ;
