...
position p;
@@
 struct solo_enc_dev * cocci_id@p ;
...
position p;
@@
 struct solo_p2m_desc * cocci_id@p ;
...
position p;
@@
 struct solo_enc_buf cocci_id@p ;
...
position p;
@@
 struct solo_vb2_buf * cocci_id@p ;
...
position p;
@@
 struct solo_enc_buf {  enum solo_enc_types type ;  const vop_header * vh ;  int motion ; } cocci_id@p ;
