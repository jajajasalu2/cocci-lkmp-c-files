...
position p;
@@
 struct lpc18xx_eeprom_dev {  struct clk * clk ;  void __iomem * reg_base ;  void __iomem * mem_base ;  struct nvmem_device * nvmem ;  unsigned reg_bytes ;  unsigned val_bytes ;  int size ; } cocci_id@p ;
...
position p;
@@
 struct lpc18xx_eeprom_dev * cocci_id@p ;
