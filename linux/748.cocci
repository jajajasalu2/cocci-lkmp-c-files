...
position p;
@@
 struct qcom_pcie_resources_2_3_2 * cocci_id@p ;
...
position p;
@@
 struct qcom_pcie_resources_2_3_2 {  struct clk * aux_clk ;  struct clk * master_clk ;  struct clk * slave_clk ;  struct clk * cfg_clk ;  struct clk * pipe_clk ;  struct regulator_bulk_data supplies [ QCOM_PCIE_2_3_2_MAX_SUPPLY ] ; } cocci_id@p ;
...
position p;
@@
 struct qcom_pcie_resources_1_0_0 {  struct clk * iface ;  struct clk * aux ;  struct clk * master_bus ;  struct clk * slave_bus ;  struct reset_control * core ;  struct regulator * vdda ; } cocci_id@p ;
...
position p;
@@
 struct qcom_pcie_resources_2_1_0 {  struct clk * iface_clk ;  struct clk * core_clk ;  struct clk * phy_clk ;  struct reset_control * pci_reset ;  struct reset_control * axi_reset ;  struct reset_control * ahb_reset ;  struct reset_control * por_reset ;  struct reset_control * phy_reset ;  struct regulator_bulk_data supplies [ QCOM_PCIE_2_1_0_MAX_SUPPLY ] ; } cocci_id@p ;
...
position p;
@@
 struct qcom_pcie_resources_2_1_0 * cocci_id@p ;
...
position p;
@@
 struct qcom_pcie_resources_1_0_0 * cocci_id@p ;
...
position p;
@@
 struct qcom_pcie_resources_2_3_3 * cocci_id@p ;
...
position p;
@@
 struct qcom_pcie {  struct dw_pcie * pci ;  void __iomem * parf ;  void __iomem * elbi ;  union qcom_pcie_resources res ;  struct phy * phy ;  struct gpio_desc * reset ;  const struct qcom_pcie_ops * ops ; } cocci_id@p ;
...
position p;
@@
 const struct dw_pcie_ops cocci_id@p ;
...
position p;
@@
 const struct qcom_pcie_ops cocci_id@p ;
...
position p;
@@
 union qcom_pcie_resources {  struct qcom_pcie_resources_1_0_0 v1_0_0 ;  struct qcom_pcie_resources_2_1_0 v2_1_0 ;  struct qcom_pcie_resources_2_3_2 v2_3_2 ;  struct qcom_pcie_resources_2_3_3 v2_3_3 ;  struct qcom_pcie_resources_2_4_0 v2_4_0 ; } cocci_id@p ;
...
position p;
@@
 struct qcom_pcie_ops {  int ( * get_resources ) ( struct qcom_pcie * pcie ) ;  int ( * init ) ( struct qcom_pcie * pcie ) ;  int ( * post_init ) ( struct qcom_pcie * pcie ) ;  void ( * deinit ) ( struct qcom_pcie * pcie ) ;  void ( * post_deinit ) ( struct qcom_pcie * pcie ) ;  void ( * ltssm_enable ) ( struct qcom_pcie * pcie ) ; } cocci_id@p ;
...
position p;
@@
 struct qcom_pcie_resources_2_3_3 {  struct clk * iface ;  struct clk * axi_m_clk ;  struct clk * axi_s_clk ;  struct clk * ahb_clk ;  struct clk * aux_clk ;  struct reset_control * rst [ 7 ] ; } cocci_id@p ;
...
position p;
@@
 struct qcom_pcie_resources_2_4_0 * cocci_id@p ;
...
position p;
@@
 const struct dw_pcie_host_ops cocci_id@p ;
