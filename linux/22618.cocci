...
position p;
@@
 enum { LINE6_BASSPODXT , LINE6_BASSPODXTLIVE , LINE6_BASSPODXTPRO , LINE6_POCKETPOD , LINE6_PODXT , LINE6_PODXTLIVE_POD , LINE6_PODXTPRO , } cocci_id@p ;
...
position p;
@@
 struct usb_line6_pod * cocci_id@p ;
...
position p;
@@
 enum { POD_MONITOR_LEVEL = 0x04 , POD_SYSTEM_INVALID = 0x10000 , } cocci_id@p ;
...
position p;
@@
 enum { POD_SYSEX_SAVE = 0x24 , POD_SYSEX_SYSTEM = 0x56 , POD_SYSEX_SYSTEMREQ = 0x57 , POD_SYSEX_STORE = 0x71 , POD_SYSEX_FINISH = 0x72 , POD_SYSEX_DUMPMEM = 0x73 , POD_SYSEX_DUMP = 0x74 , POD_SYSEX_DUMPREQ = 0x75 , } cocci_id@p ;
...
position p;
@@
 enum { POD_BUSY_READ , POD_BUSY_WRITE , POD_CHANNEL_DIRTY , POD_SAVE_PRESSED , POD_BUSY_MIDISEND , } cocci_id@p ;
...
position p;
@@
 enum { POD_STARTUP_VERSIONREQ , POD_STARTUP_SETUP , POD_STARTUP_DONE , } cocci_id@p ;
...
position p;
@@
 enum { POD_DUMP_MEMORY = 2 , } cocci_id@p ;
...
typedef u32;
@@
 struct usb_line6_pod {  struct usb_line6 line6 ;  int monitor_level ;  int startup_progress ;  u32 serial_number ;  int firmware_version ;  int device_id ; } cocci_id@p ;
