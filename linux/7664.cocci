...
typedef spinlock_t;
@@
 struct mxser_port {  struct tty_port port ;  struct mxser_board * board ;  unsigned long ioaddr ;  unsigned long opmode_ioaddr ;  int max_baud ;  int rx_high_water ;  int rx_trigger ;  int rx_low_water ;  int baud_base ;  int type ;  int x_char ;  int IER ;  int MCR ;  unsigned char stop_rx ;  unsigned char ldisc_stop_rx ;  int custom_divisor ;  unsigned char err_shadow ;  struct async_icount icount ;  unsigned int timeout ;  int read_status_mask ;  int ignore_status_mask ;  unsigned int xmit_fifo_size ;  int xmit_head ;  int xmit_tail ;  int xmit_cnt ;  int closing ;  struct ktermios normal_termios ;  struct mxser_mon mon_data ;  spinlock_t slock ; } cocci_id@p ;
...
position p;
@@
 const struct {  int type ;  int tx_fifo ;  int rx_fifo ;  int xmit_fifo_size ;  int rx_high_water ;  int rx_trigger ;  int rx_low_water ;  long max_baud ; } cocci_id@p [ ] ;
...
position p;
@@
 struct mxser_mon_ext {  unsigned long rx_cnt [ 32 ] ;  unsigned long tx_cnt [ 32 ] ;  unsigned long up_rxcnt [ 32 ] ;  unsigned long up_txcnt [ 32 ] ;  int modem_status [ 32 ] ;  long baudrate [ 32 ] ;  int databits [ 32 ] ;  int stopbits [ 32 ] ;  int parity [ 32 ] ;  int flowctrl [ 32 ] ;  int fifo [ 32 ] ;  int iftype [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct mxser_board cocci_id@p [ MXSER_BOARDS ] ;
...
position p;
@@
 struct mxser_board {  unsigned int idx ;  int irq ;  const struct mxser_cardinfo * info ;  unsigned long vector ;  unsigned long vector_mask ;  int chip_flag ;  int uart_type ;  struct mxser_port ports [ MXSER_PORTS_PER_BOARD ] ; } cocci_id@p ;
...
position p;
@@
 struct mxser_mon_ext * cocci_id@p ;
...
position p;
@@
 const struct mxser_cardinfo cocci_id@p [ ] ;
...
position p;
@@
 struct mxser_log {  int tick ;  unsigned long rxcnt [ MXSER_PORTS ] ;  unsigned long txcnt [ MXSER_PORTS ] ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MXSER_PORTS + 1 ] ;
...
position p;
@@
 struct mxser_cardinfo {  char * name ;  unsigned int nports ;  unsigned int flags ; } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ MXSER_BOARDS ] ;
...
position p;
@@
 struct mxser_mon {  unsigned long rxcnt ;  unsigned long txcnt ;  unsigned long up_rxcnt ;  unsigned long up_txcnt ;  int modem_status ;  unsigned char hold_reason ; } cocci_id@p ;
