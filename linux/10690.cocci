...
typedef bool;
@@
 struct intel_dvo {  struct intel_encoder base ;  struct intel_dvo_device dev ;  struct intel_connector * attached_connector ;  bool panel_wants_dither ; } cocci_id@p ;
...
position p;
@@
 const struct intel_dvo_device * cocci_id@p ;
