...
position p;
@@
 enum mixel_dphy_devtype { MIXEL_IMX8MQ , } cocci_id@p ;
...
typedef u8;
@@
 struct mixel_dphy_devdata {  u8 reg_tx_rcal ;  u8 reg_auto_pd_en ;  u8 reg_rxlprp ;  u8 reg_rxcdrp ;  u8 reg_rxhs_settle ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct mixel_dphy_cfg {  u32 cm ;  u32 cn ;  u32 co ;  u8 mc_prg_hs_prepare ;  u8 m_prg_hs_prepare ;  u8 mc_prg_hs_zero ;  u8 m_prg_hs_zero ;  u8 mc_prg_hs_trail ;  u8 m_prg_hs_trail ;  u8 rxhs_settle ; } cocci_id@p ;
...
position p;
@@
 struct mixel_dphy_priv {  struct mixel_dphy_cfg cfg ;  struct regmap * regmap ;  struct clk * phy_ref_clk ;  const struct mixel_dphy_devdata * devdata ; } cocci_id@p ;
...
position p;
@@
 struct mixel_dphy_cfg cocci_id@p ;
...
position p;
@@
 struct mixel_dphy_priv * cocci_id@p ;
...
position p;
@@
 const struct mixel_dphy_devdata cocci_id@p [ ] ;
