...
position p;
@@
 struct tcp_server_args {  unsigned short port ;  int ctl [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct tcp_server_args cocci_id@p ;
...
position p;
@@
 struct memcg_test {  int ( * fn ) ( const char * root ) ;  const char * name ; } cocci_id@p [ ] ;
