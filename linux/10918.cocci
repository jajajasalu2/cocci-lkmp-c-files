...
position p;
@@
 struct ta_ras_enable_features_input cocci_id@p ;
...
position p;
@@
 struct eeprom_table_record * cocci_id@p ;
...
position p;
@@
 struct ras_common_if * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct amdgpu_device * adev , struct ras_badpage * * bps , unsigned int * count ) ;
...
position p;
@@
 struct ras_dispatch_if * cocci_id@p ;
...
position p;
@@
 struct ras_debug_if * cocci_id@p ;
...
position p;
@@
 union ta_ras_cmd_input cocci_id@p ;
...
position p;
@@
 struct ras_query_if cocci_id@p ;
...
position p;
@@
 enum amdgpu_ras_retire_page_reservation { AMDGPU_RAS_RETIRE_PAGE_RESERVED , AMDGPU_RAS_RETIRE_PAGE_PENDING , AMDGPU_RAS_RETIRE_PAGE_FAULT , } cocci_id@p ;
...
position p;
@@
 struct amdgpu_ras_eeprom_control * cocci_id@p ;
...
position p;
@@
 struct ras_manager * cocci_id@p ( struct amdgpu_device * adev , struct ras_common_if * head ) ;
...
position p;
@@
 struct ras_err_handler_data * cocci_id@p ;
...
position p;
@@
 struct ta_ras_disable_features_input cocci_id@p ;
...
position p;
@@
 const enum amdgpu_ras_error_type cocci_id@p ;
