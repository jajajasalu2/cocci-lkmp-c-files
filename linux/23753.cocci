...
position p;
@@
 struct lowpan_addr_info cocci_id@p ;
...
position p;
@@
 struct lowpan_addr_info {  struct ieee802154_addr daddr ;  struct ieee802154_addr saddr ; } cocci_id@p ;
...
position p;
@@
 struct lowpan_802154_neigh * cocci_id@p ;
