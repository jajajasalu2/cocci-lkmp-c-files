...
position p;
@@
 unsigned char cocci_id@p [ SECTORSIZE ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ MAX_SECTORS_PER_UNIT ] ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_SECTORS_PER_UNIT ] ;
