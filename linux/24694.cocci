...
@@
 struct ip_vs_lblc_table {  struct rcu_head rcu_head ;  struct hlist_head bucket [ IP_VS_LBLC_TAB_SIZE ] ;  struct timer_list periodic_timer ;  struct ip_vs_service * svc ;  atomic_t entries ;  int max_size ;  int rover ;  int counter ;  bool dead ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_lblc_table * cocci_id@p ;
...
position p;
@@
 struct ip_vs_lblc_entry {  struct hlist_node list ;  int af ;  union nf_inet_addr addr ;  struct ip_vs_dest * dest ;  unsigned long lastuse ;  struct rcu_head rcu_head ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_lblc_entry cocci_id@p ;
