...
typedef u8;
@@
 struct amd_chipset_type {  enum amd_chipset_gen gen ;  u8 rev ; } cocci_id@p ;
...
position p;
@@
 struct amd_chipset_info * cocci_id@p ;
...
position p;
@@
 enum amd_chipset_gen { NOT_AMD_CHIPSET = 0 , AMD_CHIPSET_SB600 , AMD_CHIPSET_SB700 , AMD_CHIPSET_SB800 , AMD_CHIPSET_HUDSON2 , AMD_CHIPSET_BOLTON , AMD_CHIPSET_YANGTZE , AMD_CHIPSET_TAISHAN , AMD_CHIPSET_UNKNOWN , } cocci_id@p ;
...
typedef bool;
@@
 struct amd_chipset_info {  struct pci_dev * nb_dev ;  struct pci_dev * smbus_dev ;  int nb_type ;  struct amd_chipset_type sb_type ;  int isoc_reqs ;  int probe_count ;  bool need_pll_quirk ; } cocci_id@p ;
