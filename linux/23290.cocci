...
position p;
@@
 const char * cocci_id@p [ WM8904_NUM_SUPPLIES ] ;
...
position p;
@@
 struct wm8904_pdata * cocci_id@p ;
...
position p;
@@
 struct {  int ratio ;  unsigned int clk_sys_rate ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wm8904_priv {  struct regmap * regmap ;  struct clk * mclk ;  enum wm8904_type devtype ;  struct regulator_bulk_data supplies [ WM8904_NUM_SUPPLIES ] ;  struct wm8904_pdata * pdata ;  int deemph ;  const char * * drc_texts ;  int drc_cfg ;  struct soc_enum drc_enum ;  int num_retune_mobile_texts ;  const char * * retune_mobile_texts ;  int retune_mobile_cfg ;  struct soc_enum retune_mobile_enum ;  int fll_src ;  int fll_fref ;  int fll_fout ;  unsigned int mclk_rate ;  int sysclk_src ;  unsigned int sysclk_rate ;  int tdm_width ;  int tdm_slots ;  int bclk ;  int fs ;  int dcs_state [ WM8904_NUM_DCS_CHANNELS ] ; } cocci_id@p ;
...
position p;
@@
 enum wm8904_type { WM8904 , WM8912 , } cocci_id@p ;
