...
position p;
@@
 unsigned int cocci_id@p [ DC__NUM_DPP__MAX ] ;
...
typedef bool;
@@
 void cocci_id@p ( bool GPUVMEnable , enum source_format_class SourcePixelFormat , double VRatio , bool DCCEnable , double LineTime , unsigned int MetaRowByteLuma , unsigned int MetaRowByteChroma , unsigned int meta_row_height_luma , unsigned int meta_row_height_chroma , unsigned int PixelPTEBytesPerRowLuma , unsigned int PixelPTEBytesPerRowChroma , unsigned int dpte_row_height_luma , unsigned int dpte_row_height_chroma , double * meta_row_bw , double * dpte_row_bw ) ;
...
position p;
@@
 unsigned int cocci_id@p ( enum output_format_class pixelFormat ) ;
...
position p;
@@
 double cocci_id@p [ DC__NUM_DPP__MAX ] ;
...
position p;
@@
 double cocci_id@p ( unsigned int PrefetchMode , double DRAMClockChangeLatency , double UrgentLatency , double SREnterPlusExitTime ) ;
...
position p;
@@
 unsigned int cocci_id@p ( unsigned int bpc , double bpp , unsigned int sliceWidth , unsigned int numSlices , enum output_format_class pixelFormat ) ;
...
position p;
@@
 enum scan_direction_class cocci_id@p ;
...
position p;
@@
 enum dm_swizzle_mode cocci_id@p ;
...
position p;
@@
 enum { REQ_256Bytes , REQ_128BytesNonContiguous , REQ_128BytesContiguous , REQ_NA , } cocci_id@p ;
...
position p;
@@
 enum source_format_class cocci_id@p [ ] ;
...
typedef bool;
@@
 double cocci_id@p ( struct display_mode_lib * mode_lib , double VRatio , double vtaps , bool Interlace , bool ProgressiveToInterlaceUnitInOPP , unsigned int SwathHeight , unsigned int ViewportYStart , double * VInitPreFill , unsigned int * MaxNumSwath ) ;
...
position p;
@@
 void cocci_id@p ( double DETBufferSizeInKByte , unsigned int SwathHeightY , unsigned int SwathHeightC , double * DETBufferSizeY , double * DETBufferSizeC ) ;
...
position p;
@@
 enum clock_change_support cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned int NumberOfActivePlanes , double VRatio [ ] , double VRatioPrefetchY [ ] , double VRatioPrefetchC [ ] , unsigned int swath_width_luma_ub [ ] , unsigned int swath_width_chroma_ub [ ] , int DPPPerPlane [ ] , double HRatio [ ] , double PixelClock [ ] , double PSCL_THROUGHPUT [ ] , double PSCL_THROUGHPUT_CHROMA [ ] , double DPPCLK [ ] , double BytePerPixelDETC [ ] , enum scan_direction_class SourceScan [ ] , unsigned int BlockWidth256BytesY [ ] , unsigned int BlockHeight256BytesY [ ] , unsigned int BlockWidth256BytesC [ ] , unsigned int BlockHeight256BytesC [ ] , double DisplayPipeLineDeliveryTimeLuma [ ] , double DisplayPipeLineDeliveryTimeChroma [ ] , double DisplayPipeLineDeliveryTimeLumaPrefetch [ ] , double DisplayPipeLineDeliveryTimeChromaPrefetch [ ] , double DisplayPipeRequestDeliveryTimeLuma [ ] , double DisplayPipeRequestDeliveryTimeChroma [ ] , double DisplayPipeRequestDeliveryTimeLumaPrefetch [ ] , double DisplayPipeRequestDeliveryTimeChromaPrefetch [ ] ) ;
...
position p;
@@
 enum dm_validation_status cocci_id@p ;
...
position p;
@@
 enum output_format_class cocci_id@p ;
...
typedef bool;
@@
 struct {  bool Enable ;  unsigned int MaxPageTableLevels ;  unsigned int CachedPageTableLevels ; } cocci_id@p ;
...
position p;
@@
 enum output_encoder_class cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct display_mode_lib * mode_lib ) ;
...
position p;
@@
 struct display_mode_lib * cocci_id@p ;
...
typedef bool;
@@
 double cocci_id@p ( bool DCCEnabled , bool DCCProgrammingAssumesScanDirectionUnknown , unsigned int ViewportWidth , unsigned int ViewportHeight , double DETBufferSize , unsigned int RequestHeight256Byte , unsigned int SwathHeight , enum dm_swizzle_mode TilingFormat , unsigned int BytePerPixel , enum scan_direction_class ScanOrientation , unsigned int * MaxUncompressedBlock , unsigned int * MaxCompressedBlock , unsigned int * Independent64ByteBlock ) ;
...
position p;
@@
 double cocci_id@p ( double Clock , double VCOSpeed ) ;
...
position p;
@@
 double cocci_id@p ( enum source_format_class WritebackPixelFormat , double WritebackHRatio , double WritebackVRatio , unsigned int WritebackLumaHTaps , unsigned int WritebackLumaVTaps , unsigned int WritebackChromaHTaps , unsigned int WritebackChromaVTaps , unsigned int WritebackDestinationWidth ) ;
