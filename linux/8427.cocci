...
position p;
@@
 void cocci_id@p ( struct dmfe_board_info * , int ) ;
...
position p;
@@
 enum dmfe_offsets { DCR0 = 0x00 , DCR1 = 0x08 , DCR2 = 0x10 , DCR3 = 0x18 , DCR4 = 0x20 , DCR5 = 0x28 , DCR6 = 0x30 , DCR7 = 0x38 , DCR8 = 0x40 , DCR9 = 0x48 , DCR10 = 0x50 , DCR11 = 0x58 , DCR12 = 0x60 , DCR13 = 0x68 , DCR14 = 0x70 , DCR15 = 0x78 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * , struct dmfe_board_info * ) ;
...
typedef u8,u32,u16;
@@
 u16 cocci_id@p ( void __iomem * , u8 , u8 , u32 ) ;
...
typedef u32;
@@
 void cocci_id@p ( void __iomem * , u32 ) ;
...
typedef u32;
@@
 void cocci_id@p ( u32 , void __iomem * ) ;
...
typedef u8,u32;
@@
 u32 cocci_id@p ( unsigned char * , unsigned int , u8 ) ;
...
position p;
@@
 enum dmfe_CR6_bits { CR6_RXSC = 0x2 , CR6_PBF = 0x8 , CR6_PM = 0x40 , CR6_PAM = 0x80 , CR6_FDM = 0x200 , CR6_TXSC = 0x2000 , CR6_STI = 0x100000 , CR6_SFT = 0x200000 , CR6_RXA = 0x40000000 , CR6_NO_PURGE = 0x20000000 , } cocci_id@p ;
...
@@
 struct dmfe_board_info {  u32 chip_id ;  u8 chip_revision ;  struct net_device * next_dev ;  struct pci_dev * pdev ;  spinlock_t lock ;  void __iomem * ioaddr ;  u32 cr0_data ;  u32 cr5_data ;  u32 cr6_data ;  u32 cr7_data ;  u32 cr15_data ;  dma_addr_t buf_pool_dma_ptr ;  dma_addr_t buf_pool_dma_start ;  dma_addr_t desc_pool_dma_ptr ;  dma_addr_t first_tx_desc_dma ;  dma_addr_t first_rx_desc_dma ;  unsigned char * buf_pool_ptr ;  unsigned char * buf_pool_start ;  unsigned char * desc_pool_ptr ;  struct tx_desc * first_tx_desc ;  struct tx_desc * tx_insert_ptr ;  struct tx_desc * tx_remove_ptr ;  struct rx_desc * first_rx_desc ;  struct rx_desc * rx_insert_ptr ;  struct rx_desc * rx_ready_ptr ;  unsigned long tx_packet_cnt ;  unsigned long tx_queue_cnt ;  unsigned long rx_avail_cnt ;  unsigned long interval_rx_cnt ;  u16 HPNA_command ;  u16 HPNA_timer ;  u16 dbug_cnt ;  u16 NIC_capability ;  u16 PHY_reg4 ;  u8 HPNA_present ;  u8 chip_type ;  u8 media_mode ;  u8 op_mode ;  u8 phy_addr ;  u8 wait_reset ;  u8 dm910x_chk_mode ;  u8 first_in_callback ;  u8 wol_mode ;  struct timer_list timer ;  unsigned long tx_fifo_underrun ;  unsigned long tx_loss_carrier ;  unsigned long tx_no_carrier ;  unsigned long tx_late_collision ;  unsigned long tx_excessive_collision ;  unsigned long tx_jabber_timeout ;  unsigned long reset_count ;  unsigned long reset_cr8 ;  unsigned long reset_fatal ;  unsigned long reset_TXtimeout ;  unsigned char srom [ 128 ] ; } cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p ( void __iomem * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct dmfe_board_info * , struct sk_buff * ) ;
...
typedef u8;
@@
 u8 cocci_id@p ( struct dmfe_board_info * ) ;
...
typedef u8,u32,u16;
@@
 void cocci_id@p ( void __iomem * , u8 , u8 , u16 , u32 ) ;
...
position p;
@@
 struct dmfe_board_info * cocci_id@p ;
...
typedef netdev_tx_t;
@@
 netdev_tx_t cocci_id@p ( struct sk_buff * , struct net_device * ) ;
...
position p;
@@
 void cocci_id@p ( struct dmfe_board_info * ) ;
