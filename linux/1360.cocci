...
@@
 struct chaoskey {  struct usb_interface * interface ;  char in_ep ;  struct mutex lock ;  struct mutex rng_lock ;  int open ;  bool present ;  bool reading ;  bool reads_started ;  int size ;  int valid ;  int used ;  char * name ;  struct hwrng hwrng ;  int hwrng_registered ;  wait_queue_head_t wait_q ;  struct urb * urb ;  char * buf ; } cocci_id@p ;
