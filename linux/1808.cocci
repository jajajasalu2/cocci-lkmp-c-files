...
typedef u8;
@@
 const struct {  u8 reg ;  u8 val ; } cocci_id@p [ ] ;
...
position p;
@@
 enum pmode { US5182D_CONTINUOUS , US5182D_ONESHOT , } cocci_id@p ;
...
@@
 struct us5182d_data {  struct i2c_client * client ;  struct mutex lock ;  u32 ga ;  u8 lower_dark_gain ;  u8 upper_dark_gain ;  u16 * us5182d_dark_ths ;  u16 px_low_th ;  u16 px_high_th ;  int rising_en ;  int falling_en ;  u8 opmode ;  u8 power_mode ;  bool als_enabled ;  bool px_enabled ;  bool default_continuous ; } cocci_id@p ;
...
position p;
@@
 struct us5182d_data * cocci_id@p ;
...
position p;
@@
 enum mode { US5182D_ALS_PX , US5182D_ALS_ONLY , US5182D_PX_ONLY , } cocci_id@p ;
