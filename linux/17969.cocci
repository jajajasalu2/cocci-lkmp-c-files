...
position p;
@@
 struct sun4d_ipi_work cocci_id@p ;
...
typedef smpfunc_t;
@@
 struct smp_funcall {  smpfunc_t func ;  unsigned long arg1 ;  unsigned long arg2 ;  unsigned long arg3 ;  unsigned long arg4 ;  unsigned long arg5 ;  unsigned char processors_in [ NR_CPUS ] ;  unsigned char processors_out [ NR_CPUS ] ; } cocci_id@p ;
...
position p;
@@
 struct sun4d_ipi_work {  int single ;  int msk ;  int resched ; } cocci_id@p ;
