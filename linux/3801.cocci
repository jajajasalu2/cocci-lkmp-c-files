...
position p;
@@
 struct exynos_rng_dev * cocci_id@p ;
...
position p;
@@
 struct exynos_rng_ctx cocci_id@p ;
...
position p;
@@
 enum exynos_prng_type cocci_id@p ;
...
position p;
@@
 enum exynos_prng_type { EXYNOS_PRNG_UNKNOWN = 0 , EXYNOS_PRNG_EXYNOS4 , EXYNOS_PRNG_EXYNOS5 , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ EXYNOS_RNG_SEED_SIZE ] ;
...
typedef u8;
@@
 struct exynos_rng_dev {  struct device * dev ;  enum exynos_prng_type type ;  void __iomem * mem ;  struct clk * clk ;  struct mutex lock ;  u8 seed_save [ EXYNOS_RNG_SEED_SIZE ] ;  unsigned int seed_save_len ;  unsigned long last_seeding ;  unsigned long bytes_seeding ; } cocci_id@p ;
...
position p;
@@
 struct exynos_rng_ctx {  struct exynos_rng_dev * rng ; } cocci_id@p ;
