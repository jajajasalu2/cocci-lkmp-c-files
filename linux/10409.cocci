...
symbol cocci_id;
position p;
typedef drm_i810_mc_t;
@@
 drm_i810_mc_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_i810_buf_priv_t;
@@
 drm_i810_buf_priv_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_i810_sarea_t;
@@
 drm_i810_sarea_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_i810_private_t;
@@
 drm_i810_private_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_i810_vertex_t;
@@
 drm_i810_vertex_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_i810_clear_t;
@@
 drm_i810_clear_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_i810_overlay_t;
@@
 drm_i810_overlay_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_i810_ring_buffer_t;
@@
 drm_i810_ring_buffer_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_i810_dma_t;
@@
 drm_i810_dma_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_i810_init_t;
@@
 drm_i810_init_t * cocci_id@p ;
