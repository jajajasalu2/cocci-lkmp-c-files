...
position p;
@@
 const struct cw1200_platform_data_spi * cocci_id@p ;
...
@@
 struct hwbus_priv {  struct spi_device * func ;  struct cw1200_common * core ;  const struct cw1200_platform_data_spi * pdata ;  spinlock_t lock ;  wait_queue_head_t wq ;  int claimed ; } cocci_id@p ;
