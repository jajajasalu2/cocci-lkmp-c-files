...
position p;
@@
 unsigned char cocci_id@p [ WILDFIRE_MAX_QBB ] ;
...
position p;
@@
 void cocci_id@p ( int qbbno , int hoseno ) ;
...
position p;
@@
 void cocci_id@p ( int qbbno , int pcano ) ;
