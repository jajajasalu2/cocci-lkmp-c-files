...
typedef u8;
@@
 u8 cocci_id@p ( struct adapter * padapter ) ;
...
position p;
@@
 struct reportpwrstate_parm * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct adapter * adapter , struct wlan_network * pnetwork ) ;
...
position p;
@@
 struct ndis_802_11_conf cocci_id@p ;
...
position p;
@@
 struct ieee80211_ht_addt_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct adapter * adapter , struct wlan_bssid_ex * pnetwork ) ;
...
position p;
@@
 void cocci_id@p ( struct adapter * padapter , struct wlan_network * pnetwork ) ;
