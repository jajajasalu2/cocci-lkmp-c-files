...
position p;
@@
 struct meta_match {  struct meta_value lvalue ;  struct meta_value rvalue ; } cocci_id@p ;
...
position p;
@@
 const struct meta_type_ops cocci_id@p [ TCF_META_TYPE_MAX + 1 ] ;
...
position p;
@@
 struct meta_type_ops {  void ( * destroy ) ( struct meta_value * ) ;  int ( * compare ) ( struct meta_obj * , struct meta_obj * ) ;  int ( * change ) ( struct meta_value * , struct nlattr * ) ;  void ( * apply_extras ) ( struct meta_value * , struct meta_obj * ) ;  int ( * dump ) ( struct sk_buff * , struct meta_value * , int ) ; } cocci_id@p ;
...
position p;
@@
 const struct meta_type_ops * cocci_id@p ;
...
position p;
@@
 struct tcf_ematch_ops cocci_id@p ;
...
position p;
@@
 struct tcf_pkt_info * cocci_id@p ;
...
position p;
@@
 struct tcf_meta_hdr * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_EM_META_MAX + 1 ] ;
...
position p;
@@
 struct meta_ops {  void ( * get ) ( struct sk_buff * , struct tcf_pkt_info * , struct meta_value * , struct meta_obj * , int * ) ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_EM_META_MAX + 1 ] ;
...
position p;
@@
 struct meta_value {  struct tcf_meta_val hdr ;  unsigned long val ;  unsigned int len ; } cocci_id@p ;
...
position p;
@@
 struct meta_obj {  unsigned long value ;  unsigned int len ; } cocci_id@p ;
...
position p;
@@
 struct meta_ops cocci_id@p [ TCF_META_TYPE_MAX + 1 ] [ TCF_META_ID_MAX + 1 ] ;
