...
position p;
@@
 struct icoll_priv {  void __iomem * vector ;  void __iomem * levelack ;  void __iomem * ctrl ;  void __iomem * stat ;  void __iomem * intr ;  void __iomem * clear ;  enum icoll_type type ; } cocci_id@p ;
...
position p;
@@
 enum icoll_type { ICOLL , ASM9260_ICOLL , } cocci_id@p ;
