...
typedef u16;
@@
 u16 cocci_id@p ( struct capi_ctr * ctrl , struct sk_buff * skb ) ;
...
position p;
@@
 hycapi_appl cocci_id@p [ CAPI_MAXAPPL ] ;
...
position p;
@@
 struct _hycapi_appl {  unsigned int ctrl_mask ;  capi_register_params rp ;  struct sk_buff * listen_req [ CAPI_MAXCONTR ] ; } cocci_id@p ;
