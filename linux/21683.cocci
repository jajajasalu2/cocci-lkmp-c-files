...
position p;
@@
 struct s390_opcode_offset * cocci_id@p ;
...
position p;
@@
 struct s390_insn {  union {  const char name [ 5 ] ;  struct {  unsigned char zero ;  unsigned int offset ; } __packed ; } ;  unsigned char opfrag ;  unsigned char format ; } cocci_id@p ;
...
position p;
@@
 struct s390_operand {  unsigned char bits ;  unsigned char shift ;  unsigned short flags ; } cocci_id@p ;
...
position p;
@@
 const struct s390_operand cocci_id@p [ ] ;
