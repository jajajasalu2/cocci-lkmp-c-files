...
position p;
@@
 struct tse850_priv {  struct gpio_desc * add ;  struct gpio_desc * loop1 ;  struct gpio_desc * loop2 ;  struct regulator * ana ;  int add_cache ;  int loop1_cache ;  int loop2_cache ; } cocci_id@p ;
