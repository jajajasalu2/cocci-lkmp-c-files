...
position p;
@@
 struct wilc_cfg_word * cocci_id@p ;
...
position p;
@@
 const struct wilc_cfg_hword cocci_id@p [ ] ;
...
position p;
@@
 enum cfg_cmd_type { CFG_BYTE_CMD = 0 , CFG_HWORD_CMD = 1 , CFG_WORD_CMD = 2 , CFG_STR_CMD = 3 , CFG_BIN_CMD = 4 , } cocci_id@p ;
...
position p;
@@
 const struct wilc_cfg_str cocci_id@p [ ] ;
...
position p;
@@
 struct wilc_cfg_str_vals * cocci_id@p ;
...
position p;
@@
 struct wilc_cfg_hword * cocci_id@p ;
...
position p;
@@
 const struct wilc_cfg_byte cocci_id@p [ ] ;
...
position p;
@@
 const struct wilc_cfg_word cocci_id@p [ ] ;
