...
position p;
@@
 struct cyttsp4_sysinfo * cocci_id@p ;
...
position p;
@@
 struct cyttsp4_cydata cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( ldr_err_app ) ] ;
...
position p;
@@
 enum cyttsp4_sleep_state cocci_id@p ;
...
position p;
@@
 struct cyttsp4_platform_data * cocci_id@p ;
...
position p;
@@
 struct cyttsp4_touch * cocci_id@p ;
...
position p;
@@
 const struct cyttsp4_bus_ops * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ max ( CY_TMA1036_MAX_TCH , CY_TMA4XX_MAX_TCH ) ] ;
...
position p;
@@
 enum cyttsp4_int_state cocci_id@p ;
...
position p;
@@
 struct cyttsp4_mt_platform_data * cocci_id@p ;
...
position p;
@@
 struct cyttsp4_mt_data * cocci_id@p ;
...
position p;
@@
 enum cyttsp4_tch_abs cocci_id@p ;
...
position p;
@@
 struct cyttsp4_tch_rec_params * cocci_id@p ;
...
position p;
@@
 struct cyttsp4_tch_abs_params * cocci_id@p ;
