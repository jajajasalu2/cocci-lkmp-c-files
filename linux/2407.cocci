...
typedef dma_addr_t;
@@
 struct mtk_cqdma_vdesc {  struct virt_dma_desc vd ;  size_t len ;  size_t residue ;  dma_addr_t dest ;  dma_addr_t src ;  struct dma_chan * ch ;  struct list_head node ;  struct mtk_cqdma_vdesc * parent ; } cocci_id@p ;
...
position p;
@@
 struct mtk_cqdma_vdesc * cocci_id@p ;
...
typedef u32;
@@
 struct mtk_cqdma_device {  struct dma_device ddev ;  struct clk * clk ;  u32 dma_requests ;  u32 dma_channels ;  struct mtk_cqdma_vchan * vc ;  struct mtk_cqdma_pchan * * pc ; } cocci_id@p ;
...
position p;
@@
 struct mtk_cqdma_vchan cocci_id@p ;
...
typedef bool;
@@
 struct mtk_cqdma_vchan {  struct virt_dma_chan vc ;  struct mtk_cqdma_pchan * pc ;  struct completion issue_completion ;  bool issue_synchronize ; } cocci_id@p ;
...
position p;
@@
 struct mtk_cqdma_pchan * cocci_id@p ;
...
position p;
@@
 struct mtk_cqdma_device * cocci_id@p ;
...
@@
 struct mtk_cqdma_pchan {  struct list_head queue ;  void __iomem * base ;  u32 irq ;  refcount_t refcnt ;  struct tasklet_struct tasklet ;  spinlock_t lock ; } cocci_id@p ;
