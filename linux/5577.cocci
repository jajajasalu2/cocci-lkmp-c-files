...
typedef u_int8_t;
@@
 struct pcf50633_time {  u_int8_t time [ PCF50633_TI_EXTENT ] ; } cocci_id@p ;
...
position p;
@@
 struct pcf50633_time cocci_id@p ;
...
position p;
@@
 struct pcf50633_rtc * cocci_id@p ;
...
position p;
@@
 enum pcf50633_time_indexes { PCF50633_TI_SEC , PCF50633_TI_MIN , PCF50633_TI_HOUR , PCF50633_TI_WKDAY , PCF50633_TI_DAY , PCF50633_TI_MONTH , PCF50633_TI_YEAR , PCF50633_TI_EXTENT , } cocci_id@p ;
...
position p;
@@
 struct pcf50633_rtc {  int alarm_enabled ;  int alarm_pending ;  struct pcf50633 * pcf ;  struct rtc_device * rtc_dev ; } cocci_id@p ;
