...
position p;
@@
 struct ucc_geth_tx_firmware_statistics_pram * cocci_id@p ;
...
position p;
@@
 struct ucc_geth_tx_global_pram cocci_id@p ;
...
position p;
@@
 struct ucc_geth_hardware_statistics * cocci_id@p ;
...
position p;
@@
 struct ucc_geth_rx_firmware_statistics * cocci_id@p ;
...
position p;
@@
 struct ucc_fast_private * cocci_id@p ;
...
position p;
@@
 struct ucc_geth_private * cocci_id@p ;
...
position p;
@@
 struct ucc_geth_init_pram cocci_id@p ;
...
position p;
@@
 struct ucc_geth_thread_data_tx cocci_id@p ;
...
position p;
@@
 struct ucc_geth_rx_firmware_statistics_pram cocci_id@p ;
...
position p;
@@
 struct ucc_geth_rx_global_pram cocci_id@p ;
...
position p;
@@
 struct ucc_geth_rx_interrupt_coalescing_entry cocci_id@p ;
...
position p;
@@
 struct ucc_geth_thread_tx_pram cocci_id@p ;
...
position p;
@@
 struct ucc_geth_tx_firmware_statistics * cocci_id@p ;
...
position p;
@@
 struct ucc_geth_rx_bd_queues_entry cocci_id@p ;
...
position p;
@@
 struct ucc_geth_send_queue_qd cocci_id@p ;
...
@@
 const phy_interface_t cocci_id@p [ ] ;
...
position p;
@@
 struct ucc_geth_info cocci_id@p [ 8 ] ;
...
position p;
@@
 struct ucc_geth_thread_data_rx cocci_id@p ;
...
position p;
@@
 enum enet_addr_type cocci_id@p ;
...
position p;
@@
 struct ucc_geth_scheduler cocci_id@p ;
...
position p;
@@
 struct enet_addr_container * cocci_id@p ;
...
position p;
@@
 struct ucc_geth_thread_rx_pram cocci_id@p ;
...
position p;
@@
 struct ucc_geth_rx_prefetched_bds cocci_id@p ;
...
position p;
@@
 struct ucc_geth_exf_global_pram cocci_id@p ;
...
position p;
@@
 struct ucc_fast_info * cocci_id@p ;
...
position p;
@@
 struct ucc_geth_info cocci_id@p ;
