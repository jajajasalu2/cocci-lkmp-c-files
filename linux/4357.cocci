...
position p;
@@
 struct ipmi_recv_msg * cocci_id@p ;
...
position p;
@@
 struct ipmi_device_id * cocci_id@p ;
...
position p;
@@
 struct ipmi_channel_set {  struct ipmi_channel c [ IPMI_MAX_CHANNELS ] ; } cocci_id@p ;
...
position p;
@@
 struct ipmi_recv_msg * cocci_id@p ( void ) ;
...
position p;
@@
 struct ipmi_channel_set cocci_id@p ;
...
position p;
@@
 struct ipmi_channel {  unsigned char medium ;  unsigned char protocol ; } cocci_id@p ;
...
position p;
@@
 struct ipmi_smi_msg * cocci_id@p ;
...
position p;
@@
 struct ipmi_smi_watcher * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ipmi_smi * intf ) ;
...
position p;
@@
 struct ipmi_ipmb_addr * cocci_id@p ;
...
position p;
@@
 struct ipmi_smi_info * cocci_id@p ;
...
position p;
@@
 enum ipmi_panic_event_op { IPMI_SEND_PANIC_EVENT_NONE , IPMI_SEND_PANIC_EVENT , IPMI_SEND_PANIC_EVENT_STRING , } cocci_id@p ;
...
position p;
@@
 struct seq_table {  unsigned int inuse : 1 ;  unsigned int broadcast : 1 ;  unsigned long timeout ;  unsigned long orig_timeout ;  unsigned int retries_left ;  long seqid ;  struct ipmi_recv_msg * recv_msg ; } cocci_id@p ;
...
position p;
@@
 struct ipmi_system_interface_addr * cocci_id@p ;
...
position p;
@@
 const struct prod_dev_id * cocci_id@p ;
...
typedef guid_t;
@@
 struct bmc_device {  struct platform_device pdev ;  struct list_head intfs ;  struct ipmi_device_id id ;  struct ipmi_device_id fetch_id ;  int dyn_id_set ;  unsigned long dyn_id_expiry ;  struct mutex dyn_mutex ;  guid_t guid ;  guid_t fetch_guid ;  int dyn_guid_set ;  struct kref usecount ;  struct work_struct remove_work ; } cocci_id@p ;
...
position p;
@@
 struct kernel_ipmi_msg * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,wait_queue_head_t,atomic_t,spinlock_t;
@@
 struct ipmi_smi {  struct module * owner ;  int intf_num ;  struct kref refcount ;  bool in_shutdown ;  struct list_head link ;  struct list_head users ;  struct srcu_struct users_srcu ;  wait_queue_head_t waitq ;  struct mutex bmc_reg_mutex ;  struct bmc_device tmp_bmc ;  struct bmc_device * bmc ;  bool bmc_registered ;  struct list_head bmc_link ;  char * my_dev_name ;  bool in_bmc_register ;  struct work_struct bmc_reg_work ;  const struct ipmi_smi_handlers * handlers ;  void * send_info ;  struct device * si_dev ;  spinlock_t seq_lock ;  struct seq_table seq_table [ IPMI_IPMB_NUM_SEQ ] ;  int curr_seq ;  spinlock_t waiting_rcv_msgs_lock ;  struct list_head waiting_rcv_msgs ;  atomic_t watchdog_pretimeouts_to_deliver ;  struct tasklet_struct recv_tasklet ;  spinlock_t xmit_msgs_lock ;  struct list_head xmit_msgs ;  struct ipmi_smi_msg * curr_msg ;  struct list_head hp_xmit_msgs ;  struct mutex cmd_rcvrs_mutex ;  struct list_head cmd_rcvrs ;  spinlock_t events_lock ;  struct list_head waiting_events ;  unsigned int waiting_events_count ;  char delivering_events ;  char event_msg_printed ;  atomic_t event_waiters ;  unsigned int ticks_to_req_ev ;  spinlock_t watch_lock ;  unsigned int command_waiters ;  unsigned int watchdog_waiters ;  unsigned int response_waiters ;  unsigned int last_watch_mask ;  unsigned char event_receiver ;  unsigned char event_receiver_lun ;  unsigned char local_sel_device ;  unsigned char local_event_generator ;  int maintenance_mode ;  bool maintenance_mode_enable ;  int auto_maintenance_timeout ;  spinlock_t maintenance_mode_lock ;  int ipmb_maintenance_mode_timeout ;  void ( * null_user_handler ) ( struct ipmi_smi * intf , struct ipmi_recv_msg * msg ) ;  int curr_channel ;  struct ipmi_channel_set * channel_list ;  unsigned int curr_working_cset ;  struct ipmi_channel_set wchannels [ 2 ] ;  struct ipmi_my_addrinfo addrinfo [ IPMI_MAX_CHANNELS ] ;  bool channels_ready ;  atomic_t stats [ IPMI_NUM_STATS ] ;  int run_to_completion ; } cocci_id@p ;
...
position p;
@@
 const struct ipmi_smi_handlers * cocci_id@p ;
...
position p;
@@
 const struct ipmi_user_hndl * cocci_id@p ;
...
position p;
@@
 struct cmd_rcvr {  struct list_head link ;  struct ipmi_user * user ;  unsigned char netfn ;  unsigned char cmd ;  unsigned int chans ;  struct cmd_rcvr * next ; } cocci_id@p ;
...
position p;
@@
 struct ipmi_lan_addr cocci_id@p ;
...
position p;
@@
 enum ipmi_panic_event_op cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ipmi_smi * intf , struct ipmi_device_id * id ) ;
...
position p;
@@
 int cocci_id@p ( struct ipmi_smi * intf , struct ipmi_smi_msg * msg ) ;
...
position p;
@@
 struct ipmi_my_addrinfo {  unsigned char address ;  unsigned char lun ; } cocci_id@p ;
...
typedef bool;
@@
 struct ipmi_user {  struct list_head link ;  struct ipmi_user * self ;  struct srcu_struct release_barrier ;  struct kref refcount ;  const struct ipmi_user_hndl * handler ;  void * handler_data ;  struct ipmi_smi * intf ;  bool gets_events ;  struct work_struct remove_work ; } cocci_id@p ;
...
position p;
@@
 const struct kernel_param_ops cocci_id@p ;
...
position p;
@@
 struct ipmi_channel * cocci_id@p ;
...
position p;
@@
 struct prod_dev_id {  unsigned int product_id ;  unsigned char device_id ; } cocci_id@p ;
...
position p;
@@
 struct watcher_entry {  int intf_num ;  struct ipmi_smi * intf ;  struct list_head link ; } cocci_id@p ;
