...
position p;
@@
 struct lochnagar_hwmon {  struct regmap * regmap ;  long power_nsamples [ ARRAY_SIZE ( lochnagar_chan_names ) ] ;  struct mutex sensor_lock ; } cocci_id@p ;
...
position p;
@@
 enum lochnagar_measure_mode { LN2_CURR = 0 , LN2_VOLT , LN2_TEMP , } cocci_id@p ;
...
position p;
@@
 enum lochnagar_measure_mode cocci_id@p ;
...
position p;
@@
 struct lochnagar_hwmon * cocci_id@p ;
