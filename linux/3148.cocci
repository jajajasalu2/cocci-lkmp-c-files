...
position p;
@@
 struct tb_cfg_result cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_add_device_key cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_add_device_key_response cocci_id@p ;
...
position p;
@@
 enum tb_security_level cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_add_device_key_response cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_challenge_device_response cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_get_topology_response * cocci_id@p ;
...
position p;
@@
 const struct ctl_pkg * cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_driver_ready_response cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_approve_xdomain_response cocci_id@p ;
...
position p;
@@
 const struct icm_tr_event_xdomain_disconnected * cocci_id@p ;
...
position p;
@@
 const struct icm_tr_event_xdomain_connected * cocci_id@p ;
...
typedef u8;
@@
 struct ep_name_entry {  u8 len ;  u8 type ;  u8 data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_approve_xdomain cocci_id@p ;
...
position p;
@@
 const struct icm_tr_event_device_disconnected * cocci_id@p ;
...
position p;
@@
 const struct icm_icl_event_rtd3_veto * cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_approve_xdomain_response cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_challenge_device_response cocci_id@p ;
...
position p;
@@
 const struct tb_nhi * cocci_id@p ;
...
position p;
@@
 const struct tb_cm_ops cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_add_device_key cocci_id@p ;
...
position p;
@@
 struct icm_notification * cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_approve_device cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_challenge_device cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_disconnect_xdomain cocci_id@p ;
...
position p;
@@
 struct icm_ar_pkg_get_route_response cocci_id@p ;
...
position p;
@@
 const struct intel_vss * cocci_id@p ;
...
position p;
@@
 struct icm_ar_pkg_preboot_acl_response cocci_id@p ;
...
position p;
@@
 struct icm_ar_pkg_preboot_acl cocci_id@p ;
...
position p;
@@
 struct icm_ar_pkg_driver_ready_response cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_driver_ready_response cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_approve_xdomain cocci_id@p ;
...
position p;
@@
 struct tb_cfg_request * cocci_id@p ;
...
position p;
@@
 const struct icm_pkg_header * cocci_id@p ;
...
position p;
@@
 const struct icm_fr_event_device_connected * cocci_id@p ;
...
position p;
@@
 const struct icm_fr_event_xdomain_connected * cocci_id@p ;
...
position p;
@@
 const struct tb_cfg_request * cocci_id@p ;
...
position p;
@@
 const struct icm_fr_event_xdomain_disconnected * cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_approve_device cocci_id@p ;
...
position p;
@@
 const struct icm_tr_event_device_connected * cocci_id@p ;
...
position p;
@@
 struct icm_ar_pkg_get_route cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_disconnect_xdomain_response cocci_id@p ;
...
position p;
@@
 const struct ep_name_entry * cocci_id@p ;
...
position p;
@@
 struct icm_pkg_driver_ready cocci_id@p ;
...
position p;
@@
 enum tb_cfg_pkg_type cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct intel_vss {  u16 vendor ;  u16 model ;  u8 mc ;  u8 flags ;  u16 pci_devid ;  u32 nvm_version ; } cocci_id@p ;
...
position p;
@@
 const struct icm_fr_event_device_disconnected * cocci_id@p ;
...
position p;
@@
 struct icm_notification {  struct work_struct work ;  struct icm_pkg_header * pkg ;  struct tb * tb ; } cocci_id@p ;
...
position p;
@@
 struct icm_fr_pkg_get_topology cocci_id@p ;
...
position p;
@@
 struct icm_tr_pkg_challenge_device cocci_id@p ;
