...
position p;
@@
 struct ma901radio_device cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct ma901radio_device {  struct usb_device * usbdev ;  struct usb_interface * intf ;  struct video_device vdev ;  struct v4l2_device v4l2_dev ;  struct v4l2_ctrl_handler hdl ;  u8 * buffer ;  struct mutex lock ;  int curfreq ;  u16 volume ;  int stereo ;  bool muted ; } cocci_id@p ;
