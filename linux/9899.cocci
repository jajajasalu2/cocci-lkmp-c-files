...
position p;
@@
 enum ath_stomp_type cocci_id@p ;
...
position p;
@@
 struct ath_btcoex_hw * cocci_id@p ;
...
position p;
@@
 enum ath_bt_mode { ATH_BT_COEX_MODE_LEGACY , ATH_BT_COEX_MODE_UNSLOTTED , ATH_BT_COEX_MODE_SLOTTED , ATH_BT_COEX_MODE_DISABLED , } cocci_id@p ;
...
position p;
@@
 struct ath9k_hw_mci * cocci_id@p ;
...
typedef u8,bool;
@@
 struct ath_btcoex_config {  u8 bt_time_extend ;  bool bt_txstate_extend ;  bool bt_txframe_extend ;  enum ath_bt_mode bt_mode ;  bool bt_quiet_collision ;  bool bt_rxclear_polarity ;  u8 bt_priority_time ;  u8 bt_first_slot_time ;  bool bt_hold_rx_clear ;  u8 wl_active_time ;  u8 wl_qc_time ; } cocci_id@p ;
...
position p;
@@
 const struct ath_btcoex_config cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ ATH_BTCOEX_STOMP_MAX ] [ AR9300_NUM_WLAN_WEIGHTS ] ;
