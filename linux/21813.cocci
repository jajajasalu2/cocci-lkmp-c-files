...
position p;
@@
 struct kvm_s390_apcb1 cocci_id@p ;
...
position p;
@@
 struct kvm_s390_apcb0 cocci_id@p ;
...
typedef __u8,gpa_t;
@@
 struct vsie_page {  struct kvm_s390_sie_block scb_s ;  struct mcck_volatile_info mcck_info ;  struct kvm_s390_sie_block * scb_o ;  struct gmap * gmap ;  unsigned long fault_addr ;  gpa_t sca_gpa ;  gpa_t itdba_gpa ;  gpa_t gvrd_gpa ;  gpa_t riccbd_gpa ;  gpa_t sdnx_gpa ;  __u8 reserved [ 0x0700 - 0x0258 ] ;  struct kvm_s390_crypto_cb crycb ;  __u8 fac [ S390_ARCH_FAC_LIST_SIZE_BYTE ] ; } cocci_id@p ;
