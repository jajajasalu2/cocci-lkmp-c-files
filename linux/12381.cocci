...
symbol cocci_id;
position p;
typedef drm_r128_depth32_t;
@@
 drm_r128_depth32_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_init_t;
@@
 drm_r128_init_t cocci_id@p ;
...
typedef u32;
@@
 struct drm_r128_getparam32 {  int param ;  u32 value ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_init32_t;
@@
 drm_r128_init32_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_stipple32_t;
@@
 drm_r128_stipple32_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_getparam32_t;
@@
 drm_r128_getparam32_t cocci_id@p ;
...
typedef u32;
@@
 struct drm_r128_depth32 {  int func ;  int n ;  u32 x ;  u32 y ;  u32 buffer ;  u32 mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct drm_r128_stipple32 {  u32 mask ; } cocci_id@p ;
