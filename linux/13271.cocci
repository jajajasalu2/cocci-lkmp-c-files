...
position p;
@@
 struct saa7134_tvnorm cocci_id@p [ ] ;
...
position p;
@@
 struct v4l2_priv_tun_config cocci_id@p ;
...
typedef __u16,__u8;
@@
 struct cliplist {  __u16 position ;  __u8 enable ;  __u8 disable ; } cocci_id@p ;
...
position p;
@@
 const struct cliplist * cocci_id@p ;
...
position p;
@@
 struct saa7134_format cocci_id@p [ ] ;
...
position p;
@@
 struct saa7134_dmaqueue * cocci_id@p ;
...
position p;
@@
 const struct {  int xpsc ;  int xacl ;  int xc2_1 ;  int xdcg ;  int vpfy ; } cocci_id@p [ ] ;
