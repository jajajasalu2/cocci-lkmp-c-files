...
position p;
@@
 void cocci_id@p ( struct wa_xfer * xfer , int starting_index , enum wa_seg_status status ) ;
...
position p;
@@
 struct wa_xfer_hwaiso cocci_id@p ;
...
position p;
@@
 enum { WA_SEGS_MAX = 128 , } cocci_id@p ;
...
position p;
@@
 struct wa_notif_hdr * cocci_id@p ;
...
position p;
@@
 struct wa_xfer_packet_status_len_hwaiso * cocci_id@p ;
...
position p;
@@
 struct wa_xfer_packet_status_hwaiso * cocci_id@p ;
...
position p;
@@
 struct wa_xfer_packet_info_hwaiso cocci_id@p ;
...
position p;
@@
 struct wa_notif_xfer cocci_id@p ;
...
position p;
@@
 struct wa_xfer_abort_buffer {  struct urb urb ;  struct wahc * wa ;  struct wa_xfer_abort cmd ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct wa_rpipe * ) ;
...
position p;
@@
 struct wa_xfer_result * cocci_id@p ;
...
position p;
@@
 enum wa_seg_status { WA_SEG_NOTREADY , WA_SEG_READY , WA_SEG_DELAYED , WA_SEG_SUBMITTED , WA_SEG_PENDING , WA_SEG_DTI_PENDING , WA_SEG_DONE , WA_SEG_ERROR , WA_SEG_ABORTED , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct wa_rpipe * rpipe , int * dto_waiting ) ;
...
typedef u8;
@@
 struct wa_seg {  struct urb tr_urb ;  struct urb * isoc_pack_desc_urb ;  struct urb * dto_urb ;  struct list_head list_node ;  struct wa_xfer * xfer ;  u8 index ;  int isoc_frame_count ;  int isoc_frame_offset ;  int isoc_frame_index ;  int isoc_size ;  enum wa_seg_status status ;  ssize_t result ;  struct wa_xfer_hdr xfer_hdr ; } cocci_id@p ;
...
position p;
@@
 struct wa_xfer_abort_buffer * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct wa_xfer * xfer , struct wa_seg * seg , int curr_iso_frame ) ;
