...
position p;
@@
 void cocci_id@p ( struct ql3_adapter * qdev ) ;
...
position p;
@@
 const struct PHY_DEVICE_INFO cocci_id@p [ ] ;
...
position p;
@@
 struct net_rsp_iocb * cocci_id@p ;
...
position p;
@@
 struct ql_rcv_buf_cb cocci_id@p ;
...
typedef u32,u16;
@@
 struct PHY_DEVICE_INFO {  const enum PHY_DEVICE_TYPE phyDevice ;  const u32 phyIdOUI ;  const u16 phyIdModel ;  const char * name ; } cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct ql3_adapter * qdev , u32 eepromAddr , unsigned short * value ) ;
...
position p;
@@
 enum PHY_DEVICE_TYPE { PHY_TYPE_UNKNOWN = 0 , PHY_VITESSE_VSC8211 , PHY_AGERE_ET1011C , MAX_PHY_DEV_TYPES , } cocci_id@p ;
...
position p;
@@
 struct ql_tx_buf_cb * cocci_id@p ;
...
position p;
@@
 struct bufq_addr_element * cocci_id@p ;
...
position p;
@@
 enum PHY_DEVICE_TYPE cocci_id@p ;
...
position p;
@@
 struct ib_ip_iocb_rsp * cocci_id@p ;
...
position p;
@@
 struct lrg_buf_q_entry cocci_id@p ;
