...
position p;
@@
 const struct twlreg_info * cocci_id@p ;
...
typedef u8,u16;
@@
 struct twlreg_info {  u8 base ;  u8 id ;  u8 table_len ;  const u16 * table ;  u8 remap ;  struct regulator_desc desc ;  unsigned long features ;  void * data ; } cocci_id@p ;
