...
position p;
@@
 const struct phy_control cocci_id@p ;
...
typedef spinlock_t;
@@
 struct am335x_control_usb {  struct device * dev ;  void __iomem * phy_reg ;  void __iomem * wkup ;  spinlock_t lock ;  struct phy_control phy_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct am335x_control_usb cocci_id@p ;
