...
typedef umode_t;
@@
 struct pid_entry {  const char * name ;  unsigned int len ;  umode_t mode ;  const struct inode_operations * iop ;  const struct file_operations * fop ;  union proc_op op ; } cocci_id@p ;
...
position p;
@@
 struct task_io_accounting cocci_id@p ;
...
position p;
@@
 struct limit_names {  const char * name ;  const char * unit ; } cocci_id@p ;
...
position p;
@@
 struct delayed_call * cocci_id@p ;
...
position p;
@@
 struct syscall_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef instantiate_t;
@@
 instantiate_t cocci_id@p ;
...
position p;
@@
 struct rlimit cocci_id@p [ RLIM_NLIMITS ] ;
...
typedef fmode_t;
@@
 struct map_files_info {  unsigned long start ;  unsigned long end ;  fmode_t mode ; } cocci_id@p ;
...
position p;
@@
 struct timers_private * cocci_id@p ;
...
position p;
@@
 struct timers_private {  struct pid * pid ;  struct task_struct * task ;  struct sighand_struct * sighand ;  struct pid_namespace * ns ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 const struct limit_names cocci_id@p [ RLIM_NLIMITS ] ;
...
position p;
@@
 struct latency_record * cocci_id@p ;
...
position p;
@@
 struct tgid_iter {  unsigned int tgid ;  struct task_struct * task ; } cocci_id@p ;
...
position p;
@@
 const struct pid_entry cocci_id@p [ ] ;
