...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct enic * enic , int vf , struct enic_port_profile * prev_state , int * restore_pp ) ;
...
position p;
@@
 struct vic_provinfo * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct enic * enic , int vf , struct enic_port_profile * prev_pp , int * restore_pp ) ;
