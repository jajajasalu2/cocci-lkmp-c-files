...
position p;
@@
 ATOM_PPLIB_POWERPLAYTABLE3 cocci_id@p ;
...
position p;
@@
 const VCEClockInfoArray * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_POWERTUNE_Table_V1 * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_STATE_V2 * cocci_id@p ;
...
position p;
@@
 pp_tables_hw_clock_info_callback cocci_id@p ;
...
position p;
@@
 const ATOM_PowerTune_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_POWERPLAYTABLE5 * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_EXTENDEDHEADER * cocci_id@p ;
...
position p;
@@
 const ATOM_FIRMWARE_INFO_V2_1 * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_EXTENDEDHEADER * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_POWERPLAYTABLE * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_STATE_V2 * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_PhaseSheddingLimits_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_SAMClk_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_COMMON_TABLE_HEADER * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_ACPClk_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_POWERTUNE_Table * cocci_id@p ;
...
position p;
@@
 const struct phm_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_POWERPLAYTABLE5 cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_VCE_Clock_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_VCE_State_Table * cocci_id@p ;
...
typedef uint8_t;
@@
 const uint8_t cocci_id@p [ ( ATOM_PPLIB_LIMITED_REFRESHRATE_VALUE_MASK >> ATOM_PPLIB_LIMITED_REFRESHRATE_VALUE_SHIFT ) + 1 ] ;
...
position p;
@@
 ATOM_PPLIB_NONCLOCK_INFO * cocci_id@p ;
...
position p;
@@
 const NonClockInfoArray * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_PPM_Table * cocci_id@p ;
...
position p;
@@
 const UVDClockInfoArray * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_UVD_Clock_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_PhaseSheddingLimits_Table * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_POWERPLAYTABLE4 cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_POWERPLAYTABLE3 * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_CAC_Leakage_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_FIRMWARE_INFO_V1_4 * cocci_id@p ;
...
position p;
@@
 const ClockInfoArray * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_VCE_State_Record * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_Clock_Voltage_Dependency_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_CAC_Leakage_Table * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_Clock_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_Clock_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_Clock_Voltage_Dependency_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_POWERPLAYTABLE4 * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_NONCLOCK_INFO * cocci_id@p ;
...
position p;
@@
 PP_StateClassificationFlags cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_STATE * cocci_id@p ;
