...
position p;
@@
 struct bnxt_re_srq_req cocci_id@p ;
...
position p;
@@
 struct bnxt_re_cq_resp cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_frpl * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_ah * cocci_id@p ;
...
position p;
@@
 struct bnxt_re_qp_req cocci_id@p ;
...
position p;
@@
 struct bnxt_re_srq_resp cocci_id@p ;
...
position p;
@@
 struct bnxt_re_cq_req cocci_id@p ;
...
position p;
@@
 struct bnxt_re_uctx_resp cocci_id@p ;
...
position p;
@@
 struct bnxt_re_sqp_entries * cocci_id@p ;
...
position p;
@@
 struct bnxt_re_pd_resp cocci_id@p ;
...
position p;
@@
 struct bnxt_re_gid_ctx * cocci_id@p ;
...
position p;
@@
 struct bnxt_re_fence_data * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_sgid_tbl * cocci_id@p ;
...
position p;
@@
 struct bnxt_re_ucontext cocci_id@p ;
...
position p;
@@
 struct bnxt_re_qp_resp cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_dev_attr * cocci_id@p ;
