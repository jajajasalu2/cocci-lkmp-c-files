...
typedef u8;
@@
 struct sabi_header_offsets {  u8 port ;  u8 re_mem ;  u8 iface_func ;  u8 en_mem ;  u8 data_offset ;  u8 data_segment ; } cocci_id@p ;
...
position p;
@@
 struct samsung_quirks cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct sabi_data {  union {  struct {  u32 d0 ;  u32 d1 ;  u16 d2 ;  u8 d3 ; } ;  u8 data [ 11 ] ; } ; } cocci_id@p ;
...
position p;
@@
 struct samsung_laptop * cocci_id@p ;
...
typedef u16;
@@
 struct sabi_commands {  u16 get_brightness ;  u16 set_brightness ;  u16 get_wireless_button ;  u16 set_wireless_button ;  u16 get_backlight ;  u16 set_backlight ;  u16 get_recovery_mode ;  u16 set_recovery_mode ;  u16 get_performance_level ;  u16 set_performance_level ;  u16 get_battery_life_extender ;  u16 set_battery_life_extender ;  u16 get_usb_charge ;  u16 set_usb_charge ;  u16 get_wireless_status ;  u16 set_wireless_status ;  u16 get_lid_handling ;  u16 set_lid_handling ;  u16 kbd_backlight ;  u16 set_linux ; } cocci_id@p ;
...
position p;
@@
 const struct sabi_performance_level * cocci_id@p ;
...
position p;
@@
 const struct sabi_commands * cocci_id@p ;
...
typedef bool;
@@
 struct samsung_quirks {  bool broken_acpi_video ;  bool four_kbd_backlight_levels ;  bool enable_kbd_backlight ;  bool use_native_backlight ;  bool lid_handling ; } cocci_id@p ;
...
position p;
@@
 struct samsung_rfkill {  struct samsung_laptop * samsung ;  struct rfkill * rfkill ;  enum rfkill_type type ; } cocci_id@p ;
...
typedef u16;
@@
 struct sabi_performance_level {  const char * name ;  u16 value ; } cocci_id@p ;
...
typedef u16;
@@
 struct samsung_laptop_debug {  struct dentry * root ;  struct sabi_data data ;  u16 command ;  struct debugfs_blob_wrapper f0000_wrapper ;  struct debugfs_blob_wrapper data_wrapper ;  struct debugfs_blob_wrapper sdiag_wrapper ; } cocci_id@p ;
...
typedef bool;
@@
 struct samsung_laptop {  const struct sabi_config * config ;  void __iomem * sabi ;  void __iomem * sabi_iface ;  void __iomem * f0000_segment ;  struct mutex sabi_mutex ;  struct platform_device * platform_device ;  struct backlight_device * backlight_device ;  struct samsung_rfkill wlan ;  struct samsung_rfkill bluetooth ;  struct led_classdev kbd_led ;  int kbd_led_wk ;  struct workqueue_struct * led_workqueue ;  struct work_struct kbd_led_work ;  struct samsung_laptop_debug debug ;  struct samsung_quirks * quirks ;  struct notifier_block pm_nb ;  bool handle_backlight ;  bool has_stepping_quirk ;  char sdiag [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 const struct sabi_config cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct sabi_config {  int sabi_version ;  const char * test_string ;  u16 main_function ;  const struct sabi_header_offsets header_offsets ;  const struct sabi_commands commands ;  const struct sabi_performance_level performance_levels [ 4 ] ;  u8 min_brightness ;  u8 max_brightness ; } cocci_id@p ;
...
position p;
@@
 struct samsung_rfkill * cocci_id@p ;
