...
position p;
@@
 struct cobalt_params * cocci_id@p ;
...
position p;
@@
 enum { CAKE_FLAG_OVERHEAD = BIT ( 0 ) , CAKE_FLAG_AUTORATE_INGRESS = BIT ( 1 ) , CAKE_FLAG_INGRESS = BIT ( 2 ) , CAKE_FLAG_WASH = BIT ( 3 ) , CAKE_FLAG_SPLIT_GSO = BIT ( 4 ) , } cocci_id@p ;
...
position p;
@@
 struct cake_tin_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct Qdisc * sch ) ;
...
position p;
@@
 const struct cake_flow * cocci_id@p ;
...
position p;
@@
 struct qdisc_walker * cocci_id@p ;
...
position p;
@@
 const struct tcp_sack_block_wire * cocci_id@p ;
...
position p;
@@
 struct cake_sched_data cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_CAKE_MAX + 1 ] ;
...
position p;
@@
 struct cake_heap_entry cocci_id@p ;
...
position p;
@@
 struct cobalt_skb_cb cocci_id@p ;
...
typedef u32,u16;
@@
 struct cake_host {  u32 srchost_tag ;  u32 dsthost_tag ;  u16 srchost_bulk_flow_count ;  u16 dsthost_bulk_flow_count ; } cocci_id@p ;
...
position p;
@@
 struct gnet_stats_queue cocci_id@p ;
...
typedef u64,u32;
@@
 struct cobalt_params {  u64 interval ;  u64 target ;  u64 mtu_time ;  u32 p_inc ;  u32 p_dec ; } cocci_id@p ;
...
position p;
@@
 const struct Qdisc_class_ops cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,ktime_t;
@@
 struct cobalt_vars {  u32 count ;  u32 rec_inv_sqrt ;  ktime_t drop_next ;  ktime_t blue_timer ;  u32 p_drop ;  bool dropping ;  bool ecn_marked ; } cocci_id@p ;
...
typedef u32,ktime_t;
@@
 struct cobalt_skb_cb {  ktime_t enqueue_time ;  u32 adjusted_len ; } cocci_id@p ;
...
position p;
@@
 const struct cake_tin_data * cocci_id@p ;
...
position p;
@@
 enum { CAKE_SET_NONE = 0 , CAKE_SET_SPARSE , CAKE_SET_SPARSE_WAIT , CAKE_SET_BULK , CAKE_SET_DECAYING , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,u16,s32;
@@
 struct cake_flow {  struct sk_buff * head ;  struct sk_buff * tail ;  struct list_head flowchain ;  s32 deficit ;  u32 dropped ;  struct cobalt_vars cvars ;  u16 srchost ;  u16 dsthost ;  u8 set ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,u32,u16,s16,ktime_t;
@@
 struct cake_sched_data {  struct tcf_proto __rcu * filter_list ;  struct tcf_block * block ;  struct cake_tin_data * tins ;  struct cake_heap_entry overflow_heap [ CAKE_QUEUES * CAKE_MAX_TINS ] ;  u16 overflow_timeout ;  u16 tin_cnt ;  u8 tin_mode ;  u8 flow_mode ;  u8 ack_filter ;  u8 atm_mode ;  u32 fwmark_mask ;  u16 fwmark_shft ;  u16 rate_shft ;  ktime_t time_next_packet ;  ktime_t failsafe_next_packet ;  u64 rate_ns ;  u64 rate_bps ;  u16 rate_flags ;  s16 rate_overhead ;  u16 rate_mpu ;  u64 interval ;  u64 target ;  u32 buffer_used ;  u32 buffer_max_used ;  u32 buffer_limit ;  u32 buffer_config_limit ;  u16 cur_tin ;  u16 cur_flow ;  struct qdisc_watchdog watchdog ;  const u8 * tin_index ;  const u8 * tin_order ;  ktime_t last_packet_time ;  ktime_t avg_window_begin ;  u64 avg_packet_interval ;  u64 avg_window_bytes ;  u64 avg_peak_bandwidth ;  ktime_t last_reconfig_time ;  u32 avg_netoff ;  u16 max_netlen ;  u16 max_adjlen ;  u16 min_netlen ;  u16 min_adjlen ; } cocci_id@p ;
...
position p;
@@
 const struct tcphdr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u32,u16,s32,ktime_t;
@@
 struct cake_tin_data {  struct cake_flow flows [ CAKE_QUEUES ] ;  u32 backlogs [ CAKE_QUEUES ] ;  u32 tags [ CAKE_QUEUES ] ;  u16 overflow_idx [ CAKE_QUEUES ] ;  struct cake_host hosts [ CAKE_QUEUES ] ;  u16 flow_quantum ;  struct cobalt_params cparams ;  u32 drop_overlimit ;  u16 bulk_flow_count ;  u16 sparse_flow_count ;  u16 decaying_flow_count ;  u16 unresponsive_flow_count ;  u32 max_skblen ;  struct list_head new_flows ;  struct list_head old_flows ;  struct list_head decaying_flows ;  ktime_t time_next_packet ;  u64 tin_rate_ns ;  u64 tin_rate_bps ;  u16 tin_rate_shft ;  u16 tin_quantum_prio ;  u16 tin_quantum_band ;  s32 tin_deficit ;  u32 tin_backlog ;  u32 tin_dropped ;  u32 tin_ecn_mark ;  u32 packets ;  u64 bytes ;  u32 ack_drops ;  u64 avge_delay ;  u64 peak_delay ;  u64 base_delay ;  u32 way_directs ;  u32 way_hits ;  u32 way_misses ;  u32 way_collisions ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ REC_INV_SQRT_CACHE ] ;
...
position p;
@@
 struct nf_conntrack_tuple cocci_id@p ;
...
position p;
@@
 const struct cake_sched_data * cocci_id@p ;
...
position p;
@@
 const struct skb_shared_info * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_CAKE_MAX + 1 ] ;
