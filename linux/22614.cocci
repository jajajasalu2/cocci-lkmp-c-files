...
position p;
@@
 const struct snd_usb_midi_endpoint_info cocci_id@p ;
...
position p;
@@
 enum { INTF_PLAYBACK , INTF_CAPTURE , INTF_MIDI , INTF_COUNT , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ua101 * ua ) ;
...
position p;
@@
 struct uac_format_type_i_discrete_descriptor * cocci_id@p ;
...
position p;
@@
 const struct uac_format_type_i_discrete_descriptor * cocci_id@p ;
...
position p;
@@
 enum { USB_CAPTURE_RUNNING , USB_PLAYBACK_RUNNING , ALSA_CAPTURE_OPEN , ALSA_PLAYBACK_OPEN , ALSA_CAPTURE_RUNNING , ALSA_PLAYBACK_RUNNING , CAPTURE_URB_COMPLETED , PLAYBACK_URB_COMPLETED , DISCONNECTED , } cocci_id@p ;
...
position p;
@@
 struct ua101_stream * cocci_id@p ;
