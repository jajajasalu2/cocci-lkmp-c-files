...
position p;
@@
 const struct komeda_dev_funcs * cocci_id@p ;
...
position p;
@@
 struct komeda_format_caps cocci_id@p [ ] ;
...
position p;
@@
 struct komeda_chip_info * cocci_id@p ;
...
position p;
@@
 struct komeda_format_caps_table * cocci_id@p ;
