...
position p;
@@
 struct dw_mipi_dsi_plat_data cocci_id@p ;
...
typedef u32;
@@
 struct dw_mipi_dsi_stm {  void __iomem * base ;  struct clk * pllref_clk ;  struct dw_mipi_dsi * dsi ;  u32 hw_version ;  int lane_min_kbps ;  int lane_max_kbps ;  struct regulator * vdd_supply ; } cocci_id@p ;
...
position p;
@@
 enum dsi_color { DSI_RGB565_CONF1 , DSI_RGB565_CONF2 , DSI_RGB565_CONF3 , DSI_RGB666_CONF1 , DSI_RGB666_CONF2 , DSI_RGB888 , } cocci_id@p ;
...
position p;
@@
 struct dw_mipi_dsi_stm * cocci_id@p ;
