...
position p;
@@
 struct vmci_doorbell_unlink_msg cocci_id@p ;
...
position p;
@@
 struct dbell_index_table cocci_id@p ;
...
position p;
@@
 struct vmci_doorbell_notify_msg cocci_id@p ;
...
@@
 struct dbell_entry {  struct vmci_resource resource ;  struct hlist_node node ;  struct work_struct work ;  vmci_callback notify_cb ;  void * client_data ;  u32 idx ;  u32 priv_flags ;  bool run_delayed ;  atomic_t active ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct dbell_index_table {  spinlock_t lock ;  struct hlist_head entries [ VMCI_DOORBELL_INDEX_TABLE_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct vmci_doorbell_link_msg cocci_id@p ;
...
position p;
@@
 struct vmci_resource * cocci_id@p ;
...
position p;
@@
 struct vmci_notify_bm_set_msg cocci_id@p ;
