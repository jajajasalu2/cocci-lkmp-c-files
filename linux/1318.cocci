...
position p;
@@
 void cocci_id@p ( struct uas_dev_info * devinfo ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * cmnd , const char * caller ) ;
...
position p;
@@
 struct uas_cmd_info * cocci_id@p ;
...
position p;
@@
 struct uas_dev_info cocci_id@p ;
...
position p;
@@
 struct uas_cmd_info {  unsigned int state ;  unsigned int uas_tag ;  struct urb * cmd_urb ;  struct urb * data_in_urb ;  struct urb * data_out_urb ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * cmnd , const char * prefix , int status ) ;
...
position p;
@@
 struct usb_host_endpoint * cocci_id@p [ 3 ] ;
...
position p;
@@
 struct usb_host_endpoint * cocci_id@p [ 4 ] ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * cmnd , struct uas_dev_info * devinfo ) ;
