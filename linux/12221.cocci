...
typedef u8,u32;
@@
 struct etnaviv_pm_domain {  char name [ 64 ] ;  u32 profile_read ;  u32 profile_config ;  u8 nr_signals ;  const struct etnaviv_pm_signal * signal ; } cocci_id@p ;
...
position p;
@@
 const struct etnaviv_pm_signal * cocci_id@p ;
...
position p;
@@
 const struct etnaviv_pm_domain_meta * cocci_id@p ;
...
position p;
@@
 const struct drm_etnaviv_gem_submit_pmr * cocci_id@p ;
...
typedef u32;
@@
 struct etnaviv_pm_domain_meta {  const struct etnaviv_pm_domain * domains ;  u32 nr_domains ; } cocci_id@p ;
...
position p;
@@
 struct etnaviv_pm_domain cocci_id@p ;
...
position p;
@@
 const struct etnaviv_pm_domain cocci_id@p [ ] ;
...
typedef u32;
@@
 struct etnaviv_pm_signal {  char name [ 64 ] ;  u32 data ;  u32 ( * sample ) ( struct etnaviv_gpu * gpu , const struct etnaviv_pm_domain * domain , const struct etnaviv_pm_signal * signal ) ; } cocci_id@p ;
