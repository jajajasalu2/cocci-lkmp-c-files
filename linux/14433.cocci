...
typedef u8;
@@
 const u8 cocci_id@p [ SI4713_SET_PROP_NARGS ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_GETREV_NRESP ] ;
...
position p;
@@
 const char cocci_id@p [ RDS_RADIOTEXT_BLK_SIZE ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SI4713_TXMEA_NARGS ] ;
...
position p;
@@
 struct si4713_device * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SI4713_TXSTATUS_NARGS ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_RDSPS_NRESP ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_TXPWR_NRESP ] ;
...
position p;
@@
 int cocci_id@p ( struct v4l2_subdev * sd , const struct v4l2_modulator * ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_TXFREQ_NRESP ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_PWDN_NRESP ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SI4713_GET_PROP_NARGS ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_TXPWR_NARGS ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SI4713_RDSBUFF_NARGS ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_SET_PROP_NRESP ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_PWUP_NRESP ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_GET_STATUS_NRESP ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_TXSTATUS_NRESP ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_TXMEA_NRESP ] ;
...
position p;
@@
 struct si4713_platform_data * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SI4713_TXFREQ_NARGS ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_GET_PROP_NRESP ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_RDSBUFF_NRESP ] ;
...
position p;
@@
 struct radio_si4713_platform_data cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SI4713_RDSPS_NARGS ] ;
...
position p;
@@
 int cocci_id@p ( struct v4l2_subdev * sd , const struct v4l2_frequency * f ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI4713_PWUP_NARGS ] ;
