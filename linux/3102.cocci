...
position p;
@@
 struct cardinfo cocci_id@p [ MM_MAXCARDS ] ;
...
position p;
@@
 struct gendisk * cocci_id@p [ MM_MAXCARDS ] ;
...
position p;
@@
 int cocci_id@p ( struct cardinfo * card ) ;
...
position p;
@@
 void cocci_id@p ( struct cardinfo * card ) ;
