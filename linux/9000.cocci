...
position p;
@@
 struct ethoc_platform_data * cocci_id@p ;
...
position p;
@@
 const struct ethoc_bd * cocci_id@p ;
...
typedef u32;
@@
 struct ethoc_bd {  u32 stat ;  u32 addr ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s8,bool,u32,spinlock_t;
@@
 struct ethoc {  void __iomem * iobase ;  void __iomem * membase ;  bool big_endian ;  unsigned int num_bd ;  unsigned int num_tx ;  unsigned int cur_tx ;  unsigned int dty_tx ;  unsigned int num_rx ;  unsigned int cur_rx ;  void * * vma ;  struct net_device * netdev ;  struct napi_struct napi ;  u32 msg_enable ;  spinlock_t lock ;  struct mii_bus * mdio ;  struct clk * clk ;  s8 phy_id ;  int old_link ;  int old_duplex ; } cocci_id@p ;
