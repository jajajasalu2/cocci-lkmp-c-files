...
position p;
@@
 const struct usb_interface_cache * cocci_id@p ;
...
position p;
@@
 struct class_info {  int class ;  char * class_name ; } cocci_id@p ;
...
position p;
@@
 const struct usb_interface_descriptor * cocci_id@p ;
...
position p;
@@
 const struct usb_hub_descriptor * cocci_id@p ;
...
position p;
@@
 const struct usb_host_config * cocci_id@p ;
...
position p;
@@
 const struct usb_config_descriptor * cocci_id@p ;
...
position p;
@@
 const struct usb_interface_assoc_descriptor * cocci_id@p ;
...
position p;
@@
 const struct class_info cocci_id@p [ ] ;
...
@@
 struct device_connect_event {  atomic_t count ;  wait_queue_head_t wait ; } cocci_id@p ;
