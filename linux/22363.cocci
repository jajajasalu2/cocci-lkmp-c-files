...
position p;
@@
 struct trusted_key_payload * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ TPM_NONCE_SIZE ] ;
...
position p;
@@
 enum { Opt_err , Opt_new , Opt_load , Opt_update , Opt_keyhandle , Opt_keyauth , Opt_blobauth , Opt_pcrinfo , Opt_pcrlock , Opt_migratable , Opt_hash , Opt_policydigest , Opt_policyhandle , } cocci_id@p ;
...
position p;
@@
 const struct trusted_key_payload * cocci_id@p ;
...
position p;
@@
 struct trusted_key_options * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ SHA1_DIGEST_SIZE ] ;
...
position p;
@@
 struct tpm_digests {  unsigned char encauth [ SHA1_DIGEST_SIZE ] ;  unsigned char pubauth [ SHA1_DIGEST_SIZE ] ;  unsigned char xorwork [ SHA1_DIGEST_SIZE * 2 ] ;  unsigned char xorhash [ SHA1_DIGEST_SIZE ] ;  unsigned char nonceodd [ TPM_NONCE_SIZE ] ; } cocci_id@p ;
