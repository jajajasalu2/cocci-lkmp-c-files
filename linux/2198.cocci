...
position p;
@@
 struct max17042_chip * cocci_id@p ;
...
position p;
@@
 struct max17042_platform_data * cocci_id@p ;
...
position p;
@@
 struct max17042_reg_data cocci_id@p [ ] ;
...
position p;
@@
 struct max17042_chip {  struct i2c_client * client ;  struct regmap * regmap ;  struct power_supply * battery ;  enum max170xx_chip_type chip_type ;  struct max17042_platform_data * pdata ;  struct work_struct work ;  int init_complete ; } cocci_id@p ;
...
position p;
@@
 struct max17042_config_data * cocci_id@p ;
