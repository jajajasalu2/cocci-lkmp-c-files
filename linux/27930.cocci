...
position p;
@@
 struct nilfs_dat_info * cocci_id@p ;
...
position p;
@@
 struct nilfs_dat_entry * cocci_id@p ;
...
position p;
@@
 struct nilfs_dat_info {  struct nilfs_mdt_info mi ;  struct nilfs_palloc_cache palloc_cache ;  struct nilfs_shadow_map shadow ; } cocci_id@p ;
