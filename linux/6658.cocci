...
position p;
@@
 struct cxlflash_global cocci_id@p ;
...
position p;
@@
 struct dk_cxlflash_recover_afu * cocci_id@p ;
...
position p;
@@
 struct dk_cxlflash_udirect cocci_id@p ;
...
position p;
@@
 struct dk_cxlflash_release cocci_id@p ;
...
position p;
@@
 struct cxlflash_cfg * cocci_id@p ;
...
position p;
@@
 struct dk_cxlflash_detach cocci_id@p ;
...
position p;
@@
 struct dk_cxlflash_resize * cocci_id@p ;
...
position p;
@@
 struct sisl_rht_entry_f1 * cocci_id@p ;
...
position p;
@@
 struct dk_cxlflash_verify * cocci_id@p ;
...
position p;
@@
 struct dk_cxlflash_hdr * cocci_id@p ;
...
position p;
@@
 struct dk_cxlflash_attach cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( union cxlflash_ioctls ) ] ;
...
position p;
@@
 struct dk_cxlflash_uvirtual cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct scsi_device * , void * ) ;
...
position p;
@@
 struct sisl_rht_entry * cocci_id@p ;
...
position p;
@@
 struct dk_cxlflash_manage_lun cocci_id@p ;
...
position p;
@@
 const struct {  size_t size ;  sioctl ioctl ; } cocci_id@p [ ] ;
...
position p;
@@
 struct dk_cxlflash_clone cocci_id@p ;
