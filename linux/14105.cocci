...
position p;
@@
 const struct vsp1_du_atomic_pipe_config * cocci_id@p ;
...
position p;
@@
 const struct vsp1_du_atomic_config * cocci_id@p ;
...
position p;
@@
 const struct vsp1_du_writeback_config * cocci_id@p ;
...
position p;
@@
 struct vsp1_rwpf * cocci_id@p [ VSP1_MAX_RPF ] ;
...
position p;
@@
 int cocci_id@p ( struct vsp1_device * vsp1 , struct vsp1_pipeline * pipe ) ;
...
position p;
@@
 struct vsp1_drm_pipeline * cocci_id@p ;
...
position p;
@@
 const struct vsp1_du_lif_config * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vsp1_pipeline * pipe ) ;
