...
position p;
@@
 struct flow_indr_block_dev * cocci_id@p ;
...
typedef flow_indr_block_bind_cb_t;
@@
 struct flow_indr_block_cb {  struct list_head list ;  void * cb_priv ;  flow_indr_block_bind_cb_t * cb ;  void * cb_ident ; } cocci_id@p ;
...
position p;
@@
 const struct flow_rule * cocci_id@p ;
...
position p;
@@
 struct flow_match_mpls * cocci_id@p ;
...
position p;
@@
 struct flow_indr_block_cb * cocci_id@p ;
...
position p;
@@
 struct flow_match_meta * cocci_id@p ;
...
position p;
@@
 struct flow_indr_block_dev {  struct rhash_head ht_node ;  struct net_device * dev ;  unsigned int refcnt ;  struct list_head cb_list ; } cocci_id@p ;
