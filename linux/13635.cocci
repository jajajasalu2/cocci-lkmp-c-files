...
position p;
@@
 const struct framerates cocci_id@p [ ] ;
...
position p;
@@
 const struct rate_s * cocci_id@p ;
...
position p;
@@
 enum sensors { SENSOR_OV767x , SENSOR_OV772x , NSENSORS , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gspca_dev * gspca_dev ) ;
...
position p;
@@
 const struct reg_array cocci_id@p [ NSENSORS ] ;
...
position p;
@@
 void cocci_id@p ( struct gspca_dev * gspca_dev ) ;
...
symbol cocci_id;
position p;
typedef u8,__u32,u16;
@@
 struct sd {  struct gspca_dev gspca_dev ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_ctrl * hue ;  struct v4l2_ctrl * saturation ;  struct v4l2_ctrl * brightness ;  struct v4l2_ctrl * contrast ;  struct {  struct v4l2_ctrl * autogain ;  struct v4l2_ctrl * gain ; } ;  struct v4l2_ctrl * autowhitebalance ;  struct {  struct v4l2_ctrl * autoexposure ;  struct v4l2_ctrl * exposure ; } ;  struct v4l2_ctrl * sharpness ;  struct v4l2_ctrl * hflip ;  struct v4l2_ctrl * vflip ;  struct v4l2_ctrl * plfreq ;  __u32 last_pts ;  u16 last_fid ;  u8 frame_rate ;  u8 sensor ; } cocci_id@p ;
...
position p;
@@
 const struct reg_array cocci_id@p [ NSENSORS ] [ 4 ] ;
...
position p;
@@
 struct v4l2_captureparm * cocci_id@p ;
...
typedef u8;
@@
 struct reg_array {  const u8 * val [ 2 ] ;  int len ; } cocci_id@p ;
...
typedef u8;
@@
 struct rate_s {  u8 fps ;  u8 r11 ;  u8 r0d ;  u8 re5 ; } cocci_id@p ;
