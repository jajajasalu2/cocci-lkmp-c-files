...
position p;
@@
 struct nv04_instobj cocci_id@p ;
...
position p;
@@
 struct nv04_instmem cocci_id@p ;
...
position p;
@@
 struct nv04_instmem {  struct nvkm_instmem base ;  struct nvkm_mm heap ; } cocci_id@p ;
...
position p;
@@
 struct nv04_instobj {  struct nvkm_instobj base ;  struct nv04_instmem * imem ;  struct nvkm_mm_node * node ; } cocci_id@p ;
