...
position p;
@@
 struct ti_lmu_data {  const struct mfd_cell * cells ;  int num_cells ;  unsigned int max_register ; } cocci_id@p ;
...
position p;
@@
 const struct ti_lmu_data * cocci_id@p ;
