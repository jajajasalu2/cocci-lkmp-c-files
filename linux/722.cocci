...
typedef u8;
@@
 u8 cocci_id@p ( struct controller * , void __iomem * , u8 , u8 ) ;
...
typedef u8;
@@
 int cocci_id@p ( u8 , u8 , struct controller * ) ;
...
position p;
@@
 int cocci_id@p ( struct slot * , struct slot * ) ;
...
typedef u8;
@@
 int cocci_id@p ( int , struct controller * , void __iomem * , u8 * ) ;
...
typedef u8;
@@
 u8 cocci_id@p ( struct controller * , void __iomem * , u8 ) ;
