...
position p;
@@
 struct atmel_smc_timing_xlate {  const char * name ;  int ( * converter ) ( struct atmel_smc_cs_conf * conf , unsigned int shift , unsigned int nycles ) ;  unsigned int shift ; } cocci_id@p ;
...
position p;
@@
 struct atmel_ebi_dev_config {  int cs ;  struct atmel_smc_cs_conf smcconf ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_smc_timing_xlate * cocci_id@p ;
...
position p;
@@
 struct atmel_ebi_dev_config * cocci_id@p ;
...
position p;
@@
 const struct atmel_ebi_caps cocci_id@p ;
...
typedef u32;
@@
 struct atmel_ebi_dev {  struct list_head node ;  struct atmel_ebi * ebi ;  u32 mode ;  int numcs ;  struct atmel_ebi_dev_config configs [ ] ; } cocci_id@p ;
...
position p;
@@
 struct atmel_ebi {  struct clk * clk ;  struct regmap * regmap ;  struct {  struct regmap * regmap ;  struct clk * clk ;  const struct atmel_hsmc_reg_layout * layout ; } smc ;  struct device * dev ;  const struct atmel_ebi_caps * caps ;  struct list_head devs ; } cocci_id@p ;
...
position p;
@@
 struct atmel_ebi_dev * cocci_id@p ;
