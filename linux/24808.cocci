...
position p;
@@
 struct xt_ct_target_info_v1 cocci_id@p ;
...
position p;
@@
 struct xt_ct_target_info cocci_id@p ;
...
position p;
@@
 const struct xt_ct_target_info * cocci_id@p ;
...
position p;
@@
 const struct xt_ct_target_info_v1 * cocci_id@p ;
