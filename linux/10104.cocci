...
position p;
@@
 struct i2400m_msg_hdr * cocci_id@p ;
...
position p;
@@
 enum { I2400M_TX_BUF_SIZE = 65536 , I2400M_TX_PLD_MAX = 60 , I2400M_TX_PLD_SIZE = sizeof ( struct i2400m_msg_hdr ) + I2400M_TX_PLD_MAX * sizeof ( struct i2400m_pld ) , I2400M_TX_SKIP = 0x80000000 , I2400M_TX_MSG_SIZE = 16384 , } cocci_id@p ;
