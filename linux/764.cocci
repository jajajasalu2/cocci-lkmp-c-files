...
position p;
@@
 struct rcar_pcie {  struct device * dev ;  struct phy * phy ;  void __iomem * base ;  struct list_head resources ;  int root_bus_nr ;  struct clk * bus_clk ;  struct rcar_msi msi ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rcar_pcie * ) ;
...
@@
 struct rcar_msi { 
	 DECLARE_BITMAP ( used , INT_PCI_MSI_NR ) 
		 ;  struct irq_domain * domain ;  struct msi_controller chip ;  unsigned long pages ;  struct mutex lock ;  int irq1 ;  int irq2 ; } cocci_id@p ;
...
position p;
@@
 enum { RCAR_PCI_ACCESS_READ , RCAR_PCI_ACCESS_WRITE , } cocci_id@p ;
