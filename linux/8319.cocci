...
position p;
@@
 const struct xgmac_stats cocci_id@p [ ] ;
...
position p;
@@
 struct xgmac_extra_stats * cocci_id@p ;
...
typedef __le32;
@@
 struct xgmac_dma_desc {  __le32 flags ;  __le32 buf_size ;  __le32 buf1_addr ;  __le32 buf2_addr ;  __le32 ext_status ;  __le32 res [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct xgmac_extra_stats {  unsigned long tx_jabber ;  unsigned long tx_frame_flushed ;  unsigned long tx_payload_error ;  unsigned long tx_ip_header_error ;  unsigned long tx_local_fault ;  unsigned long tx_remote_fault ;  unsigned long rx_watchdog ;  unsigned long rx_da_filter_fail ;  unsigned long rx_payload_error ;  unsigned long rx_ip_header_error ;  unsigned long tx_process_stopped ;  unsigned long rx_buf_unav ;  unsigned long rx_process_stopped ;  unsigned long tx_early ;  unsigned long fatal_bus_error ; } cocci_id@p ;
...
typedef bool;
@@
 struct xgmac_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int stat_offset ;  bool is_reg ; } cocci_id@p ;
...
position p;
@@
 struct xgmac_dma_desc cocci_id@p ;
