...
position p;
@@
 char cocci_id@p [ sizeof ( engine -> name ) ] ;
...
typedef u8;
@@
 const struct {  u8 base , max ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 const struct {  u8 engine ;  u8 sched ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 struct legacy_ring {  struct intel_gt * gt ;  u8 class ;  u8 instance ; } cocci_id@p ;
...
position p;
@@
 const struct legacy_ring * cocci_id@p ;
