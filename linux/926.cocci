...
position p;
@@
 struct atmel_smc_nand_controller {  struct atmel_nand_controller base ;  struct regmap * ebi_csa_regmap ;  struct atmel_smc_nand_ebi_csa_cfg * ebi_csa ; } cocci_id@p ;
...
position p;
@@
 struct atmel_nand {  struct list_head node ;  struct device * dev ;  struct nand_chip base ;  struct atmel_nand_cs * activecs ;  struct atmel_pmecc_user * pmecc ;  struct gpio_desc * cdgpio ;  int numcs ;  struct atmel_nand_cs cs [ ] ; } cocci_id@p ;
...
position p;
@@
 struct atmel_smc_nand_ebi_csa_cfg * cocci_id@p ;
...
position p;
@@
 struct atmel_smc_cs_conf * cocci_id@p ;
...
position p;
@@
 struct atmel_nand_rb {  enum atmel_nand_rb_type type ;  union {  struct gpio_desc * gpio ;  int id ; } ; } cocci_id@p ;
...
position p;
@@
 struct atmel_pmecc_user_req cocci_id@p ;
...
typedef u32;
@@
 struct atmel_smc_nand_ebi_csa_cfg {  u32 offs ;  u32 nfd0_on_d16 ; } cocci_id@p ;
...
position p;
@@
 struct atmel_smc_nand_controller * cocci_id@p ;
...
typedef bool,u32;
@@
 struct atmel_nand_controller_caps {  bool has_dma ;  bool legacy_of_bindings ;  u32 ale_offs ;  u32 cle_offs ;  const char * ebi_csa_regmap_name ;  const struct atmel_nand_controller_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct atmel_nand_controller {  struct nand_controller base ;  const struct atmel_nand_controller_caps * caps ;  struct device * dev ;  struct regmap * smc ;  struct dma_chan * dmac ;  struct atmel_pmecc * pmecc ;  struct list_head chips ;  struct clk * mck ; } cocci_id@p ;
...
position p;
@@
 struct atmel_nand_controller * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct atmel_hsmc_nand_controller {  struct atmel_nand_controller base ;  struct {  struct gen_pool * pool ;  void __iomem * virt ;  dma_addr_t dma ; } sram ;  const struct atmel_hsmc_reg_layout * hsmc_layout ;  struct regmap * io ;  struct atmel_nfc_op op ;  struct completion complete ;  int irq ;  struct clk * clk ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct atmel_nfc_op {  u8 cs ;  u8 ncmds ;  u8 cmds [ 2 ] ;  u8 naddrs ;  u8 addrs [ 5 ] ;  enum atmel_nfc_data_xfer data ;  u32 wait ;  u32 errors ; } cocci_id@p ;
...
position p;
@@
 struct atmel_nfc_op * cocci_id@p ;
...
position p;
@@
 const struct atmel_smc_nand_ebi_csa_cfg cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct atmel_nand_cs {  int id ;  struct atmel_nand_rb rb ;  struct gpio_desc * csgpio ;  struct {  void __iomem * virt ;  dma_addr_t dma ; } io ;  struct atmel_smc_cs_conf smcconf ; } cocci_id@p ;
...
position p;
@@
 struct atmel_nand_controller_caps cocci_id@p ;
...
position p;
@@
 const struct atmel_nand_controller_caps * cocci_id@p ;
...
position p;
@@
 const struct atmel_nand_controller_ops cocci_id@p ;
...
position p;
@@
 enum atmel_nand_rb_type { ATMEL_NAND_NO_RB , ATMEL_NAND_NATIVE_RB , ATMEL_NAND_GPIO_RB , } cocci_id@p ;
...
position p;
@@
 enum atmel_nfc_data_xfer { ATMEL_NFC_NO_DATA , ATMEL_NFC_READ_DATA , ATMEL_NFC_WRITE_DATA , } cocci_id@p ;
...
position p;
@@
 struct atmel_hsmc_nand_controller * cocci_id@p ;
...
position p;
@@
 struct atmel_nand_cs * cocci_id@p ;
