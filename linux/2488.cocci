...
position p;
@@
 struct coh901318_base cocci_id@p ;
...
position p;
@@
 struct coh901318_filter_args * cocci_id@p ;
...
position p;
@@
 const struct coh_dma_channel cocci_id@p [ U300_DMA_CHANNELS ] ;
...
position p;
@@
 struct coh901318_desc cocci_id@p ;
...
typedef u32;
@@
 struct coh901318_params {  u32 config ;  u32 ctrl_lli_last ;  u32 ctrl_lli ;  u32 ctrl_lli_chained ; } cocci_id@p ;
...
position p;
@@
 struct coh901318_chan cocci_id@p ;
...
@@
 struct powersave {  spinlock_t lock ;  u64 started_channels ; } cocci_id@p ;
...
position p;
@@
 struct coh901318_lli * cocci_id@p ;
...
position p;
@@
 const struct coh_dma_channel * cocci_id@p ;
...
position p;
@@
 struct coh_dma_channel {  const char name [ 32 ] ;  const int number ;  const int desc_nbr_max ;  const int priority_high ;  const struct coh901318_params param ; } cocci_id@p ;
...
position p;
@@
 struct coh901318_base {  struct device * dev ;  void __iomem * virtbase ;  unsigned int irq ;  struct coh901318_pool pool ;  struct powersave pm ;  struct dma_device dma_slave ;  struct dma_device dma_memcpy ;  struct coh901318_chan * chans ; } cocci_id@p ;
...
position p;
@@
 struct coh901318_filter_args {  struct coh901318_base * base ;  unsigned int ch_nr ; } cocci_id@p ;
...
typedef u32;
@@
 struct burst_table {  int burst_8bit ;  int burst_16bit ;  int burst_32bit ;  u32 reg ; } cocci_id@p ;
...
position p;
@@
 struct coh901318_params * cocci_id@p ;
...
typedef u32;
@@
 struct coh901318_desc {  struct dma_async_tx_descriptor desc ;  struct list_head node ;  struct scatterlist * sg ;  unsigned int sg_len ;  struct coh901318_lli * lli ;  enum dma_transfer_direction dir ;  unsigned long flags ;  u32 head_config ;  u32 head_ctrl ; } cocci_id@p ;
...
position p;
@@
 const struct coh901318_params * cocci_id@p ;
