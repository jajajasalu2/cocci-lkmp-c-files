...
position p;
@@
 enum dt3k_boardid { BOARD_DT3001 , BOARD_DT3001_PGL , BOARD_DT3002 , BOARD_DT3003 , BOARD_DT3003_PGL , BOARD_DT3004 , BOARD_DT3005 , } cocci_id@p ;
...
position p;
@@
 struct dt3k_boardtype {  const char * name ;  int adchan ;  int ai_speed ;  const struct comedi_lrange * adrange ;  unsigned int ai_is_16bit : 1 ;  unsigned int has_ao : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct dt3k_boardtype cocci_id@p [ ] ;
...
position p;
@@
 struct dt3k_private {  unsigned int lock ;  unsigned int ai_front ;  unsigned int ai_rear ; } cocci_id@p ;
...
position p;
@@
 struct dt3k_private * cocci_id@p ;
