...
position p;
@@
 struct samsung_pmx_func * cocci_id@p ;
...
position p;
@@
 struct samsung_pin_group * cocci_id@p ;
...
position p;
@@
 struct pin_config {  const char * property ;  enum pincfg_type param ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct samsung_pin_group * cocci_id@p ;
...
position p;
@@
 const struct samsung_pinctrl_of_match_data * cocci_id@p ;
...
position p;
@@
 const struct samsung_pin_bank_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pinctrl_dev * pctldev , unsigned int pin , unsigned long * config ) ;
...
position p;
@@
 const struct samsung_pmx_func * cocci_id@p ;
...
position p;
@@
 const struct samsung_pin_ctrl * cocci_id@p ;
