...
position p;
@@
 struct hdmi_hdcp_reg_data cocci_id@p [ ] ;
...
position p;
@@
 struct hdmi_hdcp_ctrl cocci_id@p ;
...
position p;
@@
 struct qcom_scm_hdcp_req cocci_id@p [ QCOM_SCM_HDCP_MAX_REQ_CNT ] ;
...
typedef u32;
@@
 struct hdmi_hdcp_reg_data {  u32 reg_id ;  u32 off ;  char * name ;  u32 reg_val ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HDCP_DDC_WRITE_MAX_BYTE_NUM ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( reg_data ) ] ;
...
position p;
@@
 enum hdmi_hdcp_state { HDCP_STATE_NO_AKSV , HDCP_STATE_INACTIVE , HDCP_STATE_AUTHENTICATING , HDCP_STATE_AUTHENTICATED , HDCP_STATE_AUTH_FAILED , } cocci_id@p ;
...
position p;
@@
 enum DS_TYPE { DS_UNKNOWN , DS_RECEIVER , DS_REPEATER , } cocci_id@p ;
