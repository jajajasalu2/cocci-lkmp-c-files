...
typedef u16;
@@
 u16 cocci_id@p [ TWL4030_MAX_ROWS ] ;
...
typedef bool,u16;
@@
 struct twl4030_keypad {  unsigned short keymap [ TWL4030_KEYMAP_SIZE ] ;  u16 kp_state [ TWL4030_MAX_ROWS ] ;  bool autorepeat ;  unsigned int n_rows ;  unsigned int n_cols ;  unsigned int irq ;  struct device * dbg_dev ;  struct input_dev * input ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ TWL4030_MAX_ROWS ] ;
...
position p;
@@
 struct twl4030_keypad_data * cocci_id@p ;
...
position p;
@@
 struct twl4030_keypad * cocci_id@p ;
