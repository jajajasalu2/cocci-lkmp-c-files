...
position p;
@@
 struct fsi_master_gpio cocci_id@p ;
...
position p;
@@
 struct fsi_gpio_msg * cocci_id@p ;
...
@@
 struct fsi_master_gpio {  struct fsi_master master ;  struct device * dev ;  struct mutex cmd_lock ;  struct gpio_desc * gpio_clk ;  struct gpio_desc * gpio_data ;  struct gpio_desc * gpio_trans ;  struct gpio_desc * gpio_enable ;  struct gpio_desc * gpio_mux ;  bool external_mode ;  bool no_delays ;  uint32_t last_addr ;  uint8_t t_send_delay ;  uint8_t t_echo_delay ; } cocci_id@p ;
...
position p;
@@
 const struct fsi_gpio_msg * cocci_id@p ;
...
@@
 struct fsi_gpio_msg {  uint64_t msg ;  uint8_t bits ; } cocci_id@p ;
