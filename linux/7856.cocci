...
position p;
@@
 enum { PC300_RSV = 1 , PC300_X21 , PC300_TE , } cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 loc_addr_range [ 4 ] ;  u32 loc_rom_range ;  u32 loc_addr_base [ 4 ] ;  u32 loc_rom_base ;  u32 loc_bus_descr [ 4 ] ;  u32 rom_bus_descr ;  u32 cs_base [ 4 ] ;  u32 intr_ctrl_stat ;  u32 init_ctrl ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,u16,port_t;
@@
 struct card_s {  int type ;  int n_ports ;  u8 __iomem * rambase ;  u8 __iomem * scabase ;  plx9050 __iomem * plxbase ;  u32 init_ctrl_value ;  u16 rx_ring_buffers ;  u16 tx_ring_buffers ;  u16 buff_offset ;  u8 irq ;  port_t ports [ 2 ] ; } cocci_id@p ;
