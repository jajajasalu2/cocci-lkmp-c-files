...
typedef u16;
@@
 struct nft_queue {  enum nft_registers sreg_qnum : 8 ;  u16 queuenum ;  u16 queues_total ;  u16 flags ; } cocci_id@p ;
...
position p;
@@
 const struct nft_queue * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_QUEUE_MAX + 1 ] ;
