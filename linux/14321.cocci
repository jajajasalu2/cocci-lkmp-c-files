...
position p;
@@
 struct cx24120_state * cocci_id@p ;
...
position p;
@@
 enum fe_spectral_inversion cocci_id@p ;
...
typedef u8;
@@
 struct cx24120_modfec_table {  enum fe_delivery_system delsys ;  enum fe_modulation mod ;  enum fe_code_rate fec ;  u8 val ; } cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct cx24120_state * state , u8 flag ) ;
...
position p;
@@
 const struct cx24120_modfec_table cocci_id@p [ ] ;
...
position p;
@@
 struct cx24120_initial_mpeg_config cocci_id@p ;
...
typedef u8,u32;
@@
 struct cx24120_tuning {  u32 frequency ;  u32 symbol_rate ;  enum fe_spectral_inversion inversion ;  enum fe_code_rate fec ;  enum fe_delivery_system delsys ;  enum fe_modulation modulation ;  enum fe_pilot pilot ;  u8 fec_val ;  u8 fec_mask ;  u8 clkdiv ;  u8 ratediv ;  u8 inversion_val ;  u8 pilot_val ; } cocci_id@p ;
...
position p;
@@
 const struct cx24120_clock_ratios_table cocci_id@p [ ] ;
...
typedef u32;
@@
 struct cx24120_clock_ratios_table {  enum fe_delivery_system delsys ;  enum fe_pilot pilot ;  enum fe_modulation mod ;  enum fe_code_rate fec ;  u32 m_rat ;  u32 n_rat ;  u32 rate ; } cocci_id@p ;
...
position p;
@@
 const struct cx24120_modfec cocci_id@p [ ] ;
...
position p;
@@
 const struct cx24120_config * cocci_id@p ;
...
typedef u8;
@@
 struct cx24120_cmd {  u8 id ;  u8 len ;  u8 arg [ CX24120_MAX_CMD_LEN ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct cx24120_modfec {  enum fe_delivery_system delsys ;  enum fe_modulation mod ;  enum fe_code_rate fec ;  u8 val ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct cx24120_state {  struct i2c_adapter * i2c ;  const struct cx24120_config * config ;  struct dvb_frontend frontend ;  u8 cold_init ;  u8 mpeg_enabled ;  u8 need_clock_set ;  struct cx24120_tuning dcur ;  struct cx24120_tuning dnxt ;  enum fe_status fe_status ;  u32 bitrate ;  u32 berw_usecs ;  u32 ber_prev ;  u32 ucb_offset ;  unsigned long ber_jiffies_stats ;  unsigned long per_jiffies_stats ; } cocci_id@p ;
