...
position p;
@@
 struct mlx4_en_phy_stats * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_query_port_context * cocci_id@p ;
...
position p;
@@
 const struct mlx4_en_tx_ring * cocci_id@p ;
...
position p;
@@
 struct mlx4_set_vlan_fltr_mbox * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_stat_out_mbox * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_stat_out_flow_control_mbox * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_port_state * cocci_id@p ;
