...
position p;
@@
 struct dax_id {  struct list_head list ;  char dev_name [ DAX_NAME_LEN ] ; } cocci_id@p ;
...
position p;
@@
 enum id_action { ID_REMOVE , ID_ADD , } cocci_id@p ;
...
position p;
@@
 enum dev_dax_subsys cocci_id@p ;
...
position p;
@@
 struct dax_device_driver cocci_id@p ;
