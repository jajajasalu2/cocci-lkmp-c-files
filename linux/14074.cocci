...
typedef u32,u16;
@@
 struct vimc_ent_link {  unsigned int src_ent ;  u16 src_pad ;  unsigned int sink_ent ;  u16 sink_pad ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 struct vimc_ent_config cocci_id@p [ ] ;
...
position p;
@@
 struct vimc_pipeline_config {  const struct vimc_ent_config * ents ;  size_t num_ents ;  const struct vimc_ent_link * links ;  size_t num_links ; } cocci_id@p ;
...
position p;
@@
 const struct vimc_ent_link cocci_id@p [ ] ;
...
position p;
@@
 struct vimc_pipeline_config cocci_id@p ;
