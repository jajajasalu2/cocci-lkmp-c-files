...
position p;
@@
 struct pcie_soc_ops {  int ( * hisi_pcie_link_up ) ( struct hisi_pcie * hisi_pcie ) ; } cocci_id@p ;
...
typedef u32;
@@
 struct hisi_pcie {  struct dw_pcie * pci ;  struct regmap * subctrl ;  u32 port_id ;  const struct pcie_soc_ops * soc_ops ; } cocci_id@p ;
...
position p;
@@
 struct pcie_soc_ops cocci_id@p ;
