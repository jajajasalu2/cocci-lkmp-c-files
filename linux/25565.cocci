...
position p;
@@
 const struct probe_trace_event * cocci_id@p ;
...
typedef bool;
@@
 struct bpf_prog_priv {  bool is_tp ;  char * sys_name ;  char * evt_name ;  struct perf_probe_event pev ;  bool need_prologue ;  struct bpf_insn * insns_buf ;  int nr_types ;  int * type_mapping ; } cocci_id@p ;
...
position p;
@@
 enum bpf_map_op_type { BPF_MAP_OP_SET_VALUE , BPF_MAP_OP_SET_EVSEL , } cocci_id@p ;
...
position p;
@@
 struct bpf_obj_config__map_func {  const char * config_opt ;  int ( * config_func ) ( struct bpf_map * , struct parse_events_term * , struct evlist * ) ; } cocci_id@p ;
...
position p;
@@
 struct perf_probe_event * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ NR_ERRNO ] ;
...
position p;
@@
 struct probe_trace_arg_ref * cocci_id@p ;
...
position p;
@@
 struct {  const char * key ;  const char * usage ;  const char * desc ;  int ( * func ) ( const char * , struct perf_probe_event * ) ; } cocci_id@p [ ] ;
...
position p;
@@
 enum bpf_map_key_type { BPF_MAP_KEY_ALL , BPF_MAP_KEY_RANGES , } cocci_id@p ;
...
position p;
@@
 struct probe_trace_event * cocci_id@p ;
...
position p;
@@
 struct bpf_prog_priv * cocci_id@p ;
...
position p;
@@
 struct bpf_map_priv {  struct list_head ops_list ; } cocci_id@p ;
...
position p;
@@
 struct probe_trace_arg * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bpf_prog_iter_callback_t;
@@
 bpf_prog_iter_callback_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef map_config_func_t;
@@
 map_config_func_t cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ EVENTS_WRITE_BUFSIZE ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( const char * name , int map_fd , const struct bpf_map_def * pdef , struct bpf_map_op * op , void * pkey , void * arg ) ;
...
position p;
@@
 struct bpf_map_priv * cocci_id@p ;
...
typedef u64;
@@
 struct bpf_map_op {  struct list_head list ;  enum bpf_map_op_type op_type ;  enum bpf_map_key_type key_type ;  union {  struct parse_events_array array ; } k ;  union {  u64 value ;  struct evsel * evsel ; } v ; } cocci_id@p ;
