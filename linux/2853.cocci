...
position p;
@@
 struct acpi_interface_info * cocci_id@p ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_namespace_node * node , char * name ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 sleep_state ) ;
...
position p;
@@
 struct acpi_table_desc * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * aml1_buffer , acpi_rsdesc_size aml1_buffer_length , u8 * aml2_buffer , acpi_rsdesc_size aml2_buffer_length ) ;
