...
typedef u8,u32,u16;
@@
 struct dr_qp_rtr_attr {  struct mlx5dr_cmd_gid_attr dgid_attr ;  enum ib_mtu mtu ;  u32 qp_num ;  u16 port_num ;  u8 min_rnr_timer ;  u8 sgid_index ;  u16 udp_src_port ; } cocci_id@p ;
...
position p;
@@
 struct postsend_info cocci_id@p ;
...
position p;
@@
 struct dr_qp_rtr_attr cocci_id@p ;
...
position p;
@@
 struct mlx5dr_send_ring * cocci_id@p ;
...
typedef u8;
@@
 struct dr_qp_rts_attr {  u8 timeout ;  u8 retry_cnt ;  u8 rnr_retry ; } cocci_id@p ;
...
position p;
@@
 struct dr_qp_rts_attr * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( rst2init_qp_in ) ] ;
...
position p;
@@
 struct mlx5dr_domain * cocci_id@p ;
...
position p;
@@
 struct dr_qp_init_attr cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( cqc ) ] ;
...
position p;
@@
 struct mlx5_uars_page * cocci_id@p ;
...
typedef u64,u32;
@@
 struct dr_data_seg {  u64 addr ;  u32 length ;  u32 lkey ;  unsigned int send_flags ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_wq_param cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( init2rtr_qp_in ) ] ;
...
position p;
@@
 struct mlx5dr_ste_htbl * cocci_id@p ;
...
typedef u32;
@@
 struct dr_qp_init_attr {  u32 cqn ;  u32 pdn ;  u32 max_send_wr ;  struct mlx5_uars_page * uar ; } cocci_id@p ;
...
position p;
@@
 enum { CQ_OK = 0 , CQ_EMPTY = - 1 , CQ_POLL_ERR = - 2 , } cocci_id@p ;
...
typedef u64,u32;
@@
 struct postsend_info {  struct dr_data_seg write ;  struct dr_data_seg read ;  u64 remote_addr ;  u32 rkey ; } cocci_id@p ;
...
position p;
@@
 struct mlx5dr_ste_send_info * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_mkey_in ) ] ;
...
position p;
@@
 struct mlx5dr_action * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( qpc ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( rtr2rts_qp_in ) ] ;
