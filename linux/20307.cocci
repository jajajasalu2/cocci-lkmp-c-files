...
position p;
@@
 struct physdev_setup_gsi cocci_id@p ;
...
position p;
@@
 struct xen_device_domain_owner * cocci_id@p ;
...
typedef domid_t;
@@
 struct xen_device_domain_owner {  domid_t domain ;  struct pci_dev * dev ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct physdev_restore_msi cocci_id@p ;
