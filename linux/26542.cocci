...
typedef bool;
@@
 struct event_pipe_ctx {  bool all_cpus ;  int cpu ;  int idx ; } cocci_id@p ;
...
position p;
@@
 struct perf_event_lost cocci_id@p ;
...
position p;
@@
 struct event_ring_info {  int fd ;  int key ;  unsigned int cpu ;  void * mem ; } cocci_id@p ;
...
typedef u64,__u32;
@@
 struct perf_event_sample {  struct perf_event_header header ;  u64 time ;  __u32 size ;  unsigned char data [ ] ; } cocci_id@p ;
...
position p;
@@
 struct perf_event_sample * cocci_id@p ;
...
position p;
@@
 struct event_pipe_ctx cocci_id@p ;
...
position p;
@@
 struct perf_buffer_raw_opts cocci_id@p ;
...
typedef __u64;
@@
 struct perf_event_lost {  struct perf_event_header header ;  __u64 id ;  __u64 lost ; } cocci_id@p ;
