...
position p;
@@
 int cocci_id@p ( struct qib_devdata * dd ) ;
...
position p;
@@
 int cocci_id@p ( struct qib_devdata * dd , const struct firmware * fw ) ;
...
position p;
@@
 int cocci_id@p ( struct qib_devdata * dd , int val ) ;
...
position p;
@@
 void cocci_id@p ( struct qib_devdata * dd , const char * where ) ;
...
position p;
@@
 int cocci_id@p ( struct qib_devdata * dd , int sdnum , int claim ) ;
...
typedef uint8_t;
@@
 struct dds_init {  uint8_t reg_vals [ NUM_DDS_REGS ] ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 int cocci_id@p ( struct qib_devdata * dd , int sdnum , u32 loc , u32 data , u32 mask ) ;
...
position p;
@@
 unsigned char cocci_id@p [ VFY_CHUNK ] ;
...
position p;
@@
 int cocci_id@p ( struct qib_devdata * dd , int loc , int val , int mask ) ;
...
typedef u8,u16;
@@
 struct rxeq_init {  u16 rdesc ;  u8 rdata [ 4 ] ; } cocci_id@p [ ] ;
