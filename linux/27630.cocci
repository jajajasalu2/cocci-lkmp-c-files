...
position p;
@@
 int cocci_id@p ( struct inode * , struct dentry * , struct inode * , struct dentry * , unsigned int ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * , struct dentry * ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * , struct dentry * , const char * ) ;
...
position p;
@@
 int cocci_id@p ( struct dentry * , struct inode * , struct dentry * ) ;
