...
typedef atomic_t;
@@
 struct xpnet_pending_msg {  struct sk_buff * skb ;  atomic_t use_count ; } cocci_id@p ;
...
position p;
@@
 struct xpnet_message * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct xpnet_message {  u16 version ;  u16 embedded_bytes ;  u32 magic ;  unsigned long buf_pa ;  u32 size ;  u8 leadin_ignore ;  u8 tailout_ignore ;  unsigned char data ; } cocci_id@p ;
...
position p;
@@
 struct xpnet_pending_msg * cocci_id@p ;
