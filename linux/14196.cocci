...
position p;
@@
 const struct camif_fmt * * cocci_id@p ;
...
position p;
@@
 const struct s3c_camif_variant * cocci_id@p ;
...
position p;
@@
 struct camif_buffer cocci_id@p ;
...
position p;
@@
 struct camif_scaler cocci_id@p ;
...
position p;
@@
 const struct camif_pix_limits * cocci_id@p ;
...
position p;
@@
 const struct vp_pix_limits * cocci_id@p ;
