...
position p;
@@
 struct mt6380_regulator_info * cocci_id@p ;
...
typedef u32;
@@
 struct mt6380_regulator_info {  struct regulator_desc desc ;  u32 vselon_reg ;  u32 modeset_reg ;  u32 modeset_mask ; } cocci_id@p ;
