...
position p;
@@
 struct psy_am_i_supplied_data cocci_id@p ;
...
position p;
@@
 const struct power_supply_config * cocci_id@p ;
...
position p;
@@
 struct psy_am_i_supplied_data {  struct power_supply * psy ;  unsigned int count ; } cocci_id@p ;
