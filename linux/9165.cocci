...
position p;
@@
 struct mlxsw_sp_sb_port cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_sb_cm * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_sb_pm * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_sb_pm cocci_id@p [ ] ;
...
typedef u32,u16;
@@
 struct mlxsw_sp_sb_mm {  u32 min_buff ;  u32 max_buff ;  u16 pool_index ; } cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_sbxx_dir cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_sb_sr_occ_query_cb_ctx cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_sb_vals cocci_id@p ;
...
typedef u32;
@@
 struct mlxsw_sp_sb_pm {  u32 min_buff ;  u32 max_buff ;  struct mlxsw_cp_sb_occ occ ; } cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_sp_sb_pool_des {  enum mlxsw_reg_sbxx_dir dir ;  u8 pool ; } cocci_id@p ;
...
typedef u32;
@@
 struct mlxsw_cp_sb_occ {  u32 cur ;  u32 max ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_sb_pr * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_sb_mm cocci_id@p [ ] ;
...
position p;
@@
 struct mlxsw_core_port * cocci_id@p ;
...
typedef u64,u32;
@@
 struct mlxsw_sp_sb {  struct mlxsw_sp_sb_pr * prs ;  struct mlxsw_sp_sb_port * ports ;  u32 cell_size ;  u32 max_headroom_cells ;  u64 sb_size ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_sb_cm * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_sb_pool_des cocci_id@p [ ] ;
...
position p;
@@
 struct mlxsw_sp_sb_port {  struct mlxsw_sp_sb_cm ing_cms [ MLXSW_SP_SB_ING_TC_COUNT ] ;  struct mlxsw_sp_sb_cm eg_cms [ MLXSW_SP_SB_EG_TC_COUNT ] ;  struct mlxsw_sp_sb_pm * pms ; } cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_sp_sb_sr_occ_query_cb_ctx {  u8 masked_count ;  u8 local_port_1 ; } cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_sbpr_mode cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SBMM_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PPTB_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SBCM_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SBPM_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SBPR_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_sb_pr * cocci_id@p ;
