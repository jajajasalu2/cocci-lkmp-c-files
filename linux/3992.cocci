...
position p;
@@
 struct alpine_msix_data * cocci_id@p ;
...
@@
 struct alpine_msix_data {  spinlock_t msi_map_lock ;  phys_addr_t addr ;  u32 spi_first ;  u32 num_spis ;  unsigned long * msi_map ; } cocci_id@p ;
