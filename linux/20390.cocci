...
position p;
@@
 struct irq_alloc_info cocci_id@p ;
...
typedef u32;
@@
 union entry_union {  struct {  u32 w1 , w2 ; } ;  struct IO_APIC_route_entry entry ; } cocci_id@p ;
...
position p;
@@
 struct io_apic {  unsigned int index ;  unsigned int unused [ 3 ] ;  unsigned int data ;  unsigned int unused2 [ 11 ] ;  unsigned int eoi ; } cocci_id@p ;
...
position p;
@@
 union IO_APIC_reg_00 cocci_id@p ;
...
position p;
@@
 union IO_APIC_reg_02 cocci_id@p ;
...
position p;
@@
 union IO_APIC_reg_03 cocci_id@p ;
...
position p;
@@
 struct IR_IO_APIC_route_entry * cocci_id@p ;
...
position p;
@@
 struct irq_pin_list cocci_id@p ;
...
position p;
@@
 struct mp_ioapic_gsi * cocci_id@p ;
...
position p;
@@
 struct ioapic_domain_cfg * cocci_id@p ;
...
position p;
@@
 struct IO_APIC_route_entry cocci_id@p ;
...
symbol cocci_id;
position p;
typedef physid_mask_t;
@@
 physid_mask_t cocci_id@p ;
...
position p;
@@
 struct mp_chip_data * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct irq_pin_list * entry ) ;
...
position p;
@@
 struct mpc_intsrc cocci_id@p [ MAX_IRQ_SOURCES ] ;
...
typedef u32;
@@
 int cocci_id@p ( u32 gsi , int * trigger , int * polarity ) ;
...
position p;
@@
 union IO_APIC_reg_01 cocci_id@p ;
...
typedef u32;
@@
 struct mp_ioapic_gsi {  u32 gsi_base ;  u32 gsi_end ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct mp_chip_data {  struct list_head irq_2_pin ;  struct IO_APIC_route_entry entry ;  int trigger ;  int polarity ;  u32 count ;  bool isa_irq ; } cocci_id@p ;
...
position p;
@@
 struct {  int pin , apic ; } cocci_id@p ;
...
position p;
@@
 struct ioapic {  int nr_registers ;  struct IO_APIC_route_entry * saved_registers ;  struct mpc_ioapic mp_config ;  struct mp_ioapic_gsi gsi_config ;  struct ioapic_domain_cfg irqdomain_cfg ;  struct irq_domain * irqdomain ;  struct resource * iomem_res ; } cocci_id@p [ MAX_IO_APICS ] ;
