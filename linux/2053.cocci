...
position p;
@@
 struct adis16136 {  const struct adis16136_chip_info * chip_info ;  struct adis adis ; } cocci_id@p ;
...
position p;
@@
 const struct adis16136_chip_info cocci_id@p [ ] ;
...
position p;
@@
 struct adis16136_chip_info {  unsigned int precision ;  unsigned int fullscale ; } cocci_id@p ;
...
position p;
@@
 enum adis16136_id { ID_ADIS16133 , ID_ADIS16135 , ID_ADIS16136 , ID_ADIS16137 , } cocci_id@p ;
...
position p;
@@
 enum { ADIS16136_SCAN_GYRO , ADIS16136_SCAN_TEMP , } cocci_id@p ;
