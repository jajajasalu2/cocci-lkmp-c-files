...
position p;
@@
 struct acpi_repair_info {  char name [ ACPI_NAMESEG_SIZE ] ;  acpi_repair_function repair_function ; } cocci_id@p ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_evaluate_info * info , union acpi_operand_object * * return_object_ptr ) ;
...
position p;
@@
 const struct acpi_repair_info * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( union acpi_operand_object * obj_desc , u32 index ) ;
...
symbol cocci_id;
position p;
typedef u8,acpi_status,u32;
@@
 acpi_status cocci_id@p ( struct acpi_evaluate_info * info , union acpi_operand_object * return_object , u32 start_index , u32 expected_count , u32 sort_index , u8 sort_direction , char * sort_key_name ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( union acpi_operand_object * * elements , u32 count , u32 index , u8 sort_direction ) ;
...
position p;
@@
 struct acpi_evaluate_info * cocci_id@p ;
...
position p;
@@
 const struct acpi_repair_info * cocci_id@p ( struct acpi_namespace_node * node ) ;
