...
position p;
@@
 void cocci_id@p ( struct rxrpc_peer * , int , enum rxrpc_call_completion ) ;
...
position p;
@@
 enum rxrpc_rtt_rx_trace cocci_id@p ;
...
position p;
@@
 enum rxrpc_call_completion cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rxrpc_peer * , struct sock_exterr_skb * ) ;
