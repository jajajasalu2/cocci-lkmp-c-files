...
position p;
@@
 struct pmic_thermal_data {  const struct thermal_irq_map * maps ;  int num_maps ; } cocci_id@p ;
...
position p;
@@
 const struct trip_config_map cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct trip_config_map {  u16 irq_reg ;  u16 irq_en ;  u16 evt_stat ;  u8 irq_mask ;  u8 irq_en_mask ;  u8 evt_mask ;  u8 trip_num ; } cocci_id@p ;
...
position p;
@@
 const struct pmic_thermal_data cocci_id@p ;
...
position p;
@@
 struct thermal_irq_map {  char handle [ 20 ] ;  int num_trips ;  const struct trip_config_map * trip_config ; } cocci_id@p ;
...
position p;
@@
 struct pmic_thermal_data * cocci_id@p ;
...
position p;
@@
 const struct thermal_irq_map cocci_id@p [ ] ;
