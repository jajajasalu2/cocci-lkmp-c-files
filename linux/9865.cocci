...
position p;
@@
 void cocci_id@p ( struct ath_softc * sc , struct ath_atx_tid * tid , struct ath_buf * bf ) ;
...
position p;
@@
 void cocci_id@p ( struct ath_softc * sc , struct ath_buf * bf , struct ath_tx_status * ts , int nframes , int nbad , int txok ) ;
...
position p;
@@
 struct ath_tx_status cocci_id@p ;
...
position p;
@@
 struct ath_tx_control cocci_id@p ;
...
position p;
@@
 struct ath_frame_info * cocci_id@p ;
...
position p;
@@
 struct ath9k_tx_queue_info * cocci_id@p ;
...
position p;
@@
 struct modal_eep_header * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ath_softc * sc , struct sk_buff * skb , int tx_flags , struct ath_txq * txq , struct ieee80211_sta * sta ) ;
...
position p;
@@
 struct ath_beacon_config * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ WME_BA_BMP_SIZE >> 5 ] ;
...
position p;
@@
 void cocci_id@p ( struct ath_softc * sc , struct ath_buf * bf , struct ath_txq * txq , struct list_head * bf_q , struct ieee80211_sta * sta , struct ath_tx_status * ts , int txok ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct ath_softc * sc , struct ath_txq * txq , struct list_head * head , bool internal ) ;
...
position p;
@@
 struct ath_buf * cocci_id@p ( struct ath_softc * sc , struct ath_txq * txq , struct ath_atx_tid * tid , struct sk_buff * skb ) ;
...
position p;
@@
 struct ieee80211_tx_rate cocci_id@p [ 4 ] ;
...
position p;
@@
 struct ar5416_eeprom_def * cocci_id@p ;
...
position p;
@@
 enum { MCS_HT20 , MCS_HT20_SGI , MCS_HT40 , MCS_HT40_SGI , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ath_softc * sc , struct ath_txq * txq , struct ath_atx_tid * tid , struct sk_buff * skb ) ;
...
position p;
@@
 enum ath9k_pkt_type cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ieee80211_hw * hw , struct sk_buff * skb , struct ath_tx_control * txctl ) ;
...
position p;
@@
 struct ath9k_channel * cocci_id@p ;
...
position p;
@@
 enum ath9k_key_type cocci_id@p ;
