...
position p;
@@
 union cvmx_asxx_prt_loop cocci_id@p ;
...
position p;
@@
 struct cvmx_sysinfo * cocci_id@p ;
...
position p;
@@
 union cvmx_pko_mem_queue_qos cocci_id@p [ 16 ] ;
...
position p;
@@
 union cvmx_gmxx_tx_ovr_bp cocci_id@p ;
...
position p;
@@
 union cvmx_asxx_tx_prt_en cocci_id@p ;
...
position p;
@@
 union cvmx_asxx_rx_prt_en cocci_id@p ;
...
position p;
@@
 union cvmx_pko_mem_queue_qos cocci_id@p ;
...
position p;
@@
 union cvmx_gmxx_rxx_frm_ctl cocci_id@p ;
