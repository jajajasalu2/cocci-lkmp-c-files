...
position p;
@@
 enum typec_accessory * cocci_id@p ;
...
position p;
@@
 const struct typec_altmode * cocci_id@p ;
...
position p;
@@
 struct typec_altmode_desc * cocci_id@p ;
...
position p;
@@
 struct ucsi_altmode cocci_id@p [ 2 ] ;
...
position p;
@@
 struct ucsi_connector cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct ucsi * ucsi , u64 command ) ;
