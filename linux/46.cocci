...
position p;
@@
 struct expr * cocci_id@p ( struct expr * e ) ;
...
position p;
@@
 enum string_value_kind { k_string , k_signed , k_unsigned , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct expr * e1 , struct expr * e2 ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * , struct symbol * , const char * ) ;
...
position p;
@@
 enum string_value_kind cocci_id@p ;
...
position p;
@@
 union string_value {  unsigned long long u ;  signed long long s ; } cocci_id@p ;
