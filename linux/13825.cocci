...
typedef u32;
@@
 struct imx319_reg_list {  u32 num_of_regs ;  const struct imx319_reg * regs ; } cocci_id@p ;
...
typedef u32;
@@
 struct imx319_mode {  u32 width ;  u32 height ;  u32 fll_def ;  u32 fll_min ;  u32 llp ;  u32 link_freq_index ;  struct imx319_reg_list reg_list ; } cocci_id@p ;
...
position p;
@@
 const struct imx319_reg_list * cocci_id@p ;
...
position p;
@@
 const struct imx319_mode * cocci_id@p ;
...
position p;
@@
 struct imx319_hwcfg * cocci_id@p ;
...
position p;
@@
 const struct imx319_reg cocci_id@p [ ] ;
...
typedef bool,s64;
@@
 struct imx319 {  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_ctrl * link_freq ;  struct v4l2_ctrl * pixel_rate ;  struct v4l2_ctrl * vblank ;  struct v4l2_ctrl * hblank ;  struct v4l2_ctrl * exposure ;  struct v4l2_ctrl * vflip ;  struct v4l2_ctrl * hflip ;  const struct imx319_mode * cur_mode ;  struct imx319_hwcfg * hwcfg ;  s64 link_def_freq ;  struct mutex mutex ;  bool streaming ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct imx319_reg {  u16 address ;  u8 val ; } cocci_id@p ;
...
typedef u32,s64;
@@
 struct imx319_hwcfg {  u32 ext_clk ;  s64 * link_freqs ;  unsigned int nr_of_link_freqs ; } cocci_id@p ;
