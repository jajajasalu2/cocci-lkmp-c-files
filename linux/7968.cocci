...
position p;
@@
 struct arcnet_local * cocci_id@p ;
...
position p;
@@
 const struct arcnet_local * cocci_id@p ;
...
position p;
@@
 enum arcnet_led_event cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , struct archdr * pkt , int length , int bufnum ) ;
...
position p;
@@
 struct arc_hardware cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int bufnum ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int bufnum , struct archdr * pkthdr , int length ) ;
...
position p;
@@
 struct ArcProto * cocci_id@p [ 256 ] ;
