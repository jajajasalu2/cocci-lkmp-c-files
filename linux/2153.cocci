...
position p;
@@
 struct twl4030_madc_bat_calibration cocci_id@p ;
...
position p;
@@
 struct twl4030_madc_bat_platform_data * cocci_id@p ;
...
position p;
@@
 struct twl4030_madc_battery * cocci_id@p ;
...
position p;
@@
 struct twl4030_madc_battery {  struct power_supply * psy ;  struct twl4030_madc_bat_platform_data * pdata ;  struct iio_channel * channel_temp ;  struct iio_channel * channel_ichg ;  struct iio_channel * channel_vbat ; } cocci_id@p ;
