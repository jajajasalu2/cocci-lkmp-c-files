...
position p;
@@
 enum action { NONE , PAUSE , RESUME , } cocci_id@p ;
...
position p;
@@
 struct perf_mmap_param * cocci_id@p ;
...
position p;
@@
 enum bkw_mmap_state cocci_id@p ;
...
position p;
@@
 struct perf_evlist_mmap_ops cocci_id@p ;
...
typedef pid_t;
@@
 int cocci_id@p ( pid_t pid , int sig , const union sigval value ) ;
