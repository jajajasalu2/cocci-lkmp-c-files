...
typedef bool,u32;
@@
 struct omap_mcpdm {  struct device * dev ;  unsigned long phys_base ;  void __iomem * io_base ;  int irq ;  struct pm_qos_request pm_qos_req ;  int latency [ 2 ] ;  struct mutex mutex ;  struct mcpdm_link_config config [ 2 ] ;  u32 dn_rx_offset ;  bool restart ;  int pm_active_count ;  struct snd_dmaengine_dai_dma_data dma_data [ 2 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct mcpdm_link_config {  u32 link_mask ;  u32 threshold ; } cocci_id@p ;
