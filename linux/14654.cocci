...
position p;
@@
 const int cocci_id@p [ NUM_I2S_CLOCKS ] ;
...
position p;
@@
 struct artpec6_clkctrl_drvdata * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct artpec6_clkctrl_drvdata {  struct clk * clk_table [ ARTPEC6_CLK_NUMCLOCKS ] ;  void __iomem * syscon_base ;  struct clk_onecell_data clk_data ;  spinlock_t i2scfg_lock ; } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ NUM_I2S_CLOCKS ] ;
