...
position p;
@@
 struct offb_par {  volatile void __iomem * cmap_adr ;  volatile void __iomem * cmap_data ;  int cmap_type ;  int blanked ; } cocci_id@p ;
...
position p;
@@
 enum { cmap_unknown , cmap_simple , cmap_r128 , cmap_M3A , cmap_M3B , cmap_radeon , cmap_gxt2000 , cmap_avivo , cmap_qemu , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef boot_infos_t;
@@
 boot_infos_t * cocci_id@p ;
