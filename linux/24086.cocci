...
position p;
@@
 const struct rpc_task_setup * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rpc_task * task ) ;
...
position p;
@@
 const struct rpc_auth * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rpc_clnt * , struct rpc_xprt * , void * ) ;
...
position p;
@@
 struct rpc_xprt_iter cocci_id@p ;
...
position p;
@@
 const struct rpc_message * cocci_id@p ;
...
position p;
@@
 const struct rpc_timeout * cocci_id@p ;
...
position p;
@@
 struct connect_timeout_data cocci_id@p ;
...
position p;
@@
 const struct rpc_task * cocci_id@p ;
...
position p;
@@
 struct connect_timeout_data {  unsigned long connect_timeout ;  unsigned long reconnect_timeout ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct rpc_task * ) ;
...
position p;
@@
 struct rpc_add_xprt_test * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct rpc_clnt * clnt ) ;
...
position p;
@@
 struct rpc_cb_add_xprt_calldata * cocci_id@p ;
...
position p;
@@
 const struct rpc_rqst * cocci_id@p ;
...
position p;
@@
 struct rpc_cb_add_xprt_calldata {  struct rpc_xprt_switch * xps ;  struct rpc_xprt * xprt ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct rpc_task * task , struct xdr_stream * xdr ) ;
...
position p;
@@
 const struct rpc_create_args * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rpc_clnt * , struct rpc_xprt_switch * , struct rpc_xprt * , void * ) ;
...
symbol cocci_id;
position p;
typedef rpc_display_format_t;
@@
 enum rpc_display_format_t cocci_id@p ;
