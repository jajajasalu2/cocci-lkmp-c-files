...
position p;
@@
 struct gcov_ctr_info {  unsigned int num ;  gcov_type * values ; } cocci_id@p ;
...
position p;
@@
 struct gcov_fn_info {  const struct gcov_info * key ;  unsigned int ident ;  unsigned int lineno_checksum ;  unsigned int cfg_checksum ;  struct gcov_ctr_info ctrs [ 0 ] ; } cocci_id@p ;
