...
position p;
@@
 struct blk_cmd_filter * cocci_id@p ;
...
position p;
@@
 struct compat_sg_io_hdr cocci_id@p ;
...
position p;
@@
 struct cdrom_generic_command cocci_id@p ;
...
position p;
@@
 enum { OMAX_SB_LEN = 16 , } cocci_id@p ;
...
position p;
@@
 const struct sg_io_hdr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uint_t,compat_uptr_t,compat_int_t;
@@
 struct compat_sg_io_hdr {  compat_int_t interface_id ;  compat_int_t dxfer_direction ;  unsigned char cmd_len ;  unsigned char mx_sb_len ;  unsigned short iovec_count ;  compat_uint_t dxfer_len ;  compat_uint_t dxferp ;  compat_uptr_t cmdp ;  compat_uptr_t sbp ;  compat_uint_t timeout ;  compat_uint_t flags ;  compat_int_t pack_id ;  compat_uptr_t usr_ptr ;  unsigned char status ;  unsigned char masked_status ;  unsigned char msg_status ;  unsigned char sb_len_wr ;  unsigned short host_status ;  unsigned short driver_status ;  compat_int_t resid ;  compat_uint_t duration ;  compat_uint_t info ; } cocci_id@p ;
...
position p;
@@
 struct blk_cmd_filter {  unsigned long read_ok [ BLK_SCSI_CMD_PER_LONG ] ;  unsigned long write_ok [ BLK_SCSI_CMD_PER_LONG ] ; } cocci_id@p ;
