...
position p;
@@
 struct exynos5433_cmu_data * cocci_id@p ;
...
position p;
@@
 struct exynos5433_cmu_data {  struct samsung_clk_reg_dump * clk_save ;  unsigned int nr_clk_save ;  const struct samsung_clk_reg_dump * clk_suspend ;  unsigned int nr_clk_suspend ;  struct clk * clk ;  struct clk * * pclks ;  int nr_pclks ;  struct samsung_clk_provider ctx ; } cocci_id@p ;
