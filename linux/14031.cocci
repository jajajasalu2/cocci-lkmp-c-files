...
position p;
@@
 struct mmp_camera {  struct platform_device * pdev ;  struct mcam_camera mcam ;  struct list_head devlist ;  struct clk * mipi_clk ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct mmp_camera_platform_data * cocci_id@p ;
