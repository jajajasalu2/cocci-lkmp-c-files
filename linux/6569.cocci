...
position p;
@@
 struct orc_extended_scb * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct orc_host * host , struct orc_scb * scb ) ;
...
position p;
@@
 struct orc_scb * cocci_id@p ( struct orc_host * host ) ;
