...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PEMRBT_LEN ] ;
...
position p;
@@
 struct mlxsw_sp2_mr_route cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_mr_tcam {  struct mlxsw_sp * mlxsw_sp ;  struct mlxsw_sp_acl_block * acl_block ;  struct mlxsw_sp_acl_ruleset * ruleset4 ;  struct mlxsw_sp_acl_ruleset * ruleset6 ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_mr_tcam * cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_pemrbt_protocol cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_mr_route {  struct mlxsw_sp2_mr_tcam * mr_tcam ; } cocci_id@p ;
