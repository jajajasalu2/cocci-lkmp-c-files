...
position p;
@@
 struct mc13xxx_adcdone_data * cocci_id@p ;
...
position p;
@@
 struct mc13xxx_variant cocci_id@p ;
...
position p;
@@
 struct mc13xxx_adcdone_data {  struct mc13xxx * mc13xxx ;  struct completion done ; } cocci_id@p ;
