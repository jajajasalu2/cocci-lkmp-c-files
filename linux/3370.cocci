...
position p;
@@
 struct sprd_pwm_chn * cocci_id@p ;
...
position p;
@@
 struct sprd_pwm_chip cocci_id@p ;
...
typedef u32;
@@
 struct sprd_pwm_chn {  struct clk_bulk_data clks [ SPRD_PWM_CHN_CLKS_NUM ] ;  u32 clk_rate ; } cocci_id@p ;
...
position p;
@@
 struct sprd_pwm_chip {  void __iomem * base ;  struct device * dev ;  struct pwm_chip chip ;  int num_pwms ;  struct sprd_pwm_chn chn [ SPRD_PWM_CHN_NUM ] ; } cocci_id@p ;
