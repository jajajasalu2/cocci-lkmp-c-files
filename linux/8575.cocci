...
position p;
@@
 enum bgmac_dma_ring_type cocci_id@p ;
...
position p;
@@
 struct bgmac_slot_info * cocci_id@p ;
...
position p;
@@
 struct bgmac_dma_desc * cocci_id@p ;
...
position p;
@@
 const struct bgmac_stat * cocci_id@p ;
...
position p;
@@
 struct bgmac_rx_header * cocci_id@p ;
...
position p;
@@
 struct bgmac_dma_ring * cocci_id@p ;
...
typedef u8,u32;
@@
 struct bgmac_stat {  u8 size ;  u32 offset ;  const char * name ; } cocci_id@p ;
