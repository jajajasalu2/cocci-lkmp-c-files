...
position p;
@@
 enum { I2400M_ROQ_LOG_LENGTH = 32 , } cocci_id@p ;
...
position p;
@@
 enum i2400m_ro_type cocci_id@p ;
...
position p;
@@
 struct i2400m_roq_data {  unsigned sn ;  enum i2400m_cs cs ; } cocci_id@p ;
...
position p;
@@
 struct i2400m_roq {  unsigned ws ;  struct sk_buff_head queue ;  struct i2400m_roq_log * log ; } cocci_id@p ;
...
position p;
@@
 const struct i2400m_msg_hdr * cocci_id@p ;
...
position p;
@@
 struct i2400m_report_hook_args {  struct sk_buff * skb_rx ;  const struct i2400m_l3l4_hdr * l3l4_hdr ;  size_t size ;  struct list_head list_node ; } cocci_id@p ;
...
position p;
@@
 struct i2400m_report_hook_args * cocci_id@p ;
...
position p;
@@
 struct i2400m_roq_log * cocci_id@p ;
...
position p;
@@
 struct i2400m_roq_log_entry * cocci_id@p ;
...
position p;
@@
 const struct i2400m_pld * cocci_id@p ;
...
position p;
@@
 const struct i2400m_pl_edata_hdr * cocci_id@p ;
...
position p;
@@
 struct i2400m_roq_data * cocci_id@p ;
