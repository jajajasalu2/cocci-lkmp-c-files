...
position p;
@@
 char cocci_id@p [ MAX_COLLECTION_LEVELS + 1 ] ;
...
symbol cocci_id;
position p;
typedef s8,u32,dma_addr_t;
@@
 struct gtco {  struct input_dev * inputdevice ;  struct usb_interface * intf ;  struct urb * urbinfo ;  dma_addr_t buf_dma ;  unsigned char * buffer ;  char usbpath [ PATHLENGTH ] ;  int openCount ;  u32 usage ;  u32 min_X ;  u32 max_X ;  u32 min_Y ;  u32 max_Y ;  s8 mintilt_X ;  s8 maxtilt_X ;  s8 mintilt_Y ;  s8 maxtilt_Y ;  u32 maxpressure ;  u32 minpressure ; } cocci_id@p ;
