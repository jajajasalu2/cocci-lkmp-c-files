...
position p;
@@
 struct efa_ibv_alloc_ucontext_resp cocci_id@p ;
...
typedef u8,u64;
@@
 struct efa_user_mmap_entry {  struct rdma_user_mmap_entry rdma_entry ;  u64 address ;  u8 mmap_flag ; } cocci_id@p ;
...
position p;
@@
 struct efa_ucontext * cocci_id@p ;
...
position p;
@@
 struct efa_com_reg_mr_params cocci_id@p ;
...
position p;
@@
 struct efa_com_ctrl_buff_info * cocci_id@p ;
...
position p;
@@
 struct efa_user_mmap_entry * cocci_id@p ;
...
position p;
@@
 struct pbl_chunk_list {  struct pbl_chunk * chunks ;  unsigned int size ; } cocci_id@p ;
...
position p;
@@
 struct efa_com_create_qp_params * cocci_id@p ;
...
position p;
@@
 struct efa_com_create_cq_params cocci_id@p ;
...
position p;
@@
 struct efa_com_alloc_uar_result cocci_id@p ;
...
position p;
@@
 struct efa_com_create_ah_params cocci_id@p ;
...
position p;
@@
 struct efa_com_query_qp_result cocci_id@p ;
...
position p;
@@
 struct efa_com_destroy_qp_params cocci_id@p ;
...
position p;
@@
 struct efa_ibv_create_qp_resp cocci_id@p ;
...
position p;
@@
 struct efa_com_modify_qp_params cocci_id@p ;
...
position p;
@@
 struct efa_com_get_device_attr_result * cocci_id@p ;
...
position p;
@@
 union efa_com_get_stats_result cocci_id@p ;
...
position p;
@@
 struct efa_ibv_alloc_pd_resp cocci_id@p ;
...
position p;
@@
 struct efa_ibv_create_cq cocci_id@p ;
...
position p;
@@
 struct efa_com_get_stats_params cocci_id@p ;
...
position p;
@@
 struct efa_com_dealloc_uar_params cocci_id@p ;
...
position p;
@@
 struct efa_com_stats_admin * cocci_id@p ;
...
position p;
@@
 struct ib_block_iter cocci_id@p ;
...
position p;
@@
 struct efa_com_create_ah_result cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u64,u32,dma_addr_t;
@@
 struct pbl_context {  union {  struct {  dma_addr_t dma_addr ; } continuous ;  struct {  u32 pbl_buf_size_in_pages ;  struct scatterlist * sgl ;  int sg_dma_cnt ;  struct pbl_chunk_list chunk_list ; } indirect ; } phys ;  u64 * pbl_buf ;  u32 pbl_buf_size_in_bytes ;  u8 physically_continuous ; } cocci_id@p ;
...
position p;
@@
 struct pbl_chunk_list * cocci_id@p ;
...
position p;
@@
 enum { EFA_MMAP_DMA_PAGE = 0 , EFA_MMAP_IO_WC , EFA_MMAP_IO_NC , } cocci_id@p ;
...
position p;
@@
 struct efa_com_reg_mr_result cocci_id@p ;
...
position p;
@@
 struct efa_com_dealloc_pd_params cocci_id@p ;
...
position p;
@@
 struct efa_ibv_ex_query_device_resp cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u32,dma_addr_t;
@@
 struct pbl_chunk {  dma_addr_t dma_addr ;  u64 * buf ;  u32 length ; } cocci_id@p ;
...
position p;
@@
 struct efa_com_create_cq_result cocci_id@p ;
...
position p;
@@
 struct efa_com_alloc_pd_result cocci_id@p ;
...
position p;
@@
 enum efa_hw_stats { EFA_TX_BYTES , EFA_TX_PKTS , EFA_RX_BYTES , EFA_RX_PKTS , EFA_RX_DROPS , EFA_SUBMITTED_CMDS , EFA_COMPLETED_CMDS , EFA_NO_COMPLETION_CMDS , EFA_KEEP_ALIVE_RCVD , EFA_ALLOC_PD_ERR , EFA_CREATE_QP_ERR , EFA_REG_MR_ERR , EFA_ALLOC_UCONTEXT_ERR , EFA_CREATE_AH_ERR , } cocci_id@p ;
...
position p;
@@
 struct efa_ibv_create_qp cocci_id@p ;
...
position p;
@@
 struct efa_com_query_qp_params cocci_id@p ;
...
position p;
@@
 struct efa_com_destroy_cq_params cocci_id@p ;
...
position p;
@@
 struct efa_ibv_create_cq_resp cocci_id@p ;
...
position p;
@@
 struct efa_com_dereg_mr_params cocci_id@p ;
...
position p;
@@
 struct efa_com_basic_stats * cocci_id@p ;
...
position p;
@@
 struct efa_com_create_qp_result cocci_id@p ;
...
position p;
@@
 struct efa_com_destroy_ah_params cocci_id@p ;
...
position p;
@@
 struct efa_ibv_create_ah_resp cocci_id@p ;
