...
position p;
@@
 struct compat_ebt_mark_t_info cocci_id@p ;
...
position p;
@@
 struct ebt_mark_t_info * cocci_id@p ;
...
@@
 struct compat_ebt_mark_t_info {  compat_ulong_t mark ;  compat_uint_t target ; } cocci_id@p ;
...
position p;
@@
 const struct ebt_mark_t_info * cocci_id@p ;
...
position p;
@@
 const struct compat_ebt_mark_t_info * cocci_id@p ;
