...
position p;
@@
 void cocci_id@p ( struct xc4000_priv * priv ) ;
...
typedef u16;
@@
 struct XC_TV_STANDARD {  const char * Name ;  u16 audio_mode ;  u16 video_mode ;  u16 int_freq ; } cocci_id@p ;
...
position p;
@@
 struct XC_TV_STANDARD cocci_id@p [ MAX_TV_STANDARD ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ XC_MAX_I2C_WRITE_LENGTH ] ;
...
typedef u16;
@@
 int cocci_id@p ( struct xc4000_priv * priv , u16 reg , u16 * val ) ;
