...
position p;
@@
 struct uPD98402_priv * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct uPD98402_priv {  struct k_sonet_stats sonet_stats ;  unsigned char framing ;  int loop_mode ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 const struct atmphy_ops cocci_id@p ;
