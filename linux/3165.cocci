...
typedef s8;
@@
 struct w83l785ts_data {  struct device * hwmon_dev ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  s8 temp [ 2 ] ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p ( struct i2c_client * client , u8 reg , u8 defval ) ;
...
position p;
@@
 struct w83l785ts_data * cocci_id@p ;
...
position p;
@@
 struct w83l785ts_data * cocci_id@p ( struct device * dev ) ;
