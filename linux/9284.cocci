...
position p;
@@
 struct cmd_ds_802_11_set_wep cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_ad_hoc_result * cocci_id@p ;
...
position p;
@@
 struct mrvl_ie_ds_param_set * cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_deauthenticate cocci_id@p ;
...
position p;
@@
 struct chanscanparamset cocci_id@p ;
...
position p;
@@
 struct mrvl_ie_auth_type * cocci_id@p ;
...
position p;
@@
 const struct region_code_mapping cocci_id@p [ ] ;
...
position p;
@@
 struct cmd_ds_802_11_associate * cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_ad_hoc_start cocci_id@p ;
...
position p;
@@
 struct mrvl_ie_ssid_param_set * cocci_id@p ;
...
position p;
@@
 struct mrvl_ie_header cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_scan * cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_authenticate cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_associate_response * cocci_id@p ;
...
position p;
@@
 struct mrvl_ie_rates_param_set * cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_ad_hoc_stop cocci_id@p ;
...
position p;
@@
 struct mrvl_ie_cf_param_set * cocci_id@p ;
...
position p;
@@
 struct region_code_mapping {  const char * cn ;  int code ; } cocci_id@p ;
...
position p;
@@
 struct cmd_key_material cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ 2 + IEEE80211_MAX_SSID_LEN + 2 + 4 + 2 + 1 + 2 + 2 + 2 + 8 ] ;
...
position p;
@@
 struct cmd_ds_802_11_enable_rsn cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_ad_hoc_join cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_scan_rsp * cocci_id@p ;
