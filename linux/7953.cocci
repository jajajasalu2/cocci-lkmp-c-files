...
position p;
@@
 struct vl600_pkt_hdr * cocci_id@p ;
...
position p;
@@
 struct vl600_state {  struct sk_buff * current_rx_buf ; } cocci_id@p ;
...
position p;
@@
 struct vl600_frame_hdr * cocci_id@p ;
