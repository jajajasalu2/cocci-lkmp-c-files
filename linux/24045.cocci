...
position p;
@@
 struct sw_flow_stats * cocci_id@p ;
...
typedef u8;
@@
 struct llc_snap_hdr {  u8 dsap ;  u8 ssap ;  u8 ctrl ;  u8 oui [ 3 ] ;  __be16 ethertype ; } cocci_id@p ;
...
position p;
@@
 struct arp_eth_header cocci_id@p ;
