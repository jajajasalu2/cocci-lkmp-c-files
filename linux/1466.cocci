...
position p;
@@
 struct guas_setup_wq {  struct work_struct work ;  struct f_uas * fu ;  unsigned int alt ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usbg_tpg * ) ;
...
position p;
@@
 int cocci_id@p ( struct f_uas * , void * , unsigned int ) ;
...
position p;
@@
 struct tcm_usbg_nexus * cocci_id@p ;
...
position p;
@@
 struct usb_pipe_usage_descriptor cocci_id@p ;
...
position p;
@@
 struct guas_setup_wq cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usbg_tpg * ) ;
...
position p;
@@
 void cocci_id@p ( struct usb_ep * , struct usb_request * ) ;
...
position p;
@@
 struct tpg_instance cocci_id@p [ TPG_INSTANCES ] ;
...
position p;
@@
 void cocci_id@p ( struct usb_ep * ep , struct usb_request * req ) ;
...
position p;
@@
 struct tpg_instance {  struct usb_function_instance * func_inst ;  struct usbg_tpg * tpg ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usbg_cmd * , struct usb_request * ) ;
...
position p;
@@
 unsigned char cocci_id@p [ USBG_NAMELEN ] ;
