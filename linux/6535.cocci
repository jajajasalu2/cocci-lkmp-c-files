...
position p;
@@
 enum res_find { res_failed , res_success , res_hw_abort , } cocci_id@p ;
...
position p;
@@
 enum { sync , async , none , reject , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( FAS216_Info * , struct scsi_cmnd * , unsigned int ) ;
...
position p;
@@
 void cocci_id@p ( FAS216_Info * info ) ;
...
position p;
@@
 struct {  int command ;  void * from ; } cocci_id@p [ 8 ] ;
...
position p;
@@
 void cocci_id@p ( FAS216_Info * info , unsigned int result ) ;
...
symbol cocci_id;
position p;
typedef fasdmatype_t;
@@
 fasdmatype_t cocci_id@p ;
...
position p;
@@
 struct {  int stat , ssr , isr , ph ; } cocci_id@p [ PH_SIZE ] ;
...
position p;
@@
 struct fas216_device * cocci_id@p ;
