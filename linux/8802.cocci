...
position p;
@@
 void cocci_id@p ( struct net_device * dev , const int count , const unsigned char * buf , const int start_page ) ;
...
position p;
@@
 struct {  unsigned char value , offset ; } cocci_id@p [ ] ;
...
position p;
@@
 enum { ONLY_16BIT_IO = 8 , ONLY_32BIT_IO = 4 , FORCE_FDX = 0x20 , REALTEK_FDX = 0x40 , HOLTEK_FDX = 0x80 , STOP_PG_0x60 = 0x100 , } cocci_id@p ;
...
position p;
@@
 enum ne2k_pci_chipsets { CH_RealTek_RTL_8029 = 0 , CH_Winbond_89C940 , CH_Compex_RL2000 , CH_KTI_ET32P2 , CH_NetVin_NV5000SC , CH_Via_86C926 , CH_SureCom_NE34 , CH_Winbond_W89C940F , CH_Holtek_HT80232 , CH_Holtek_HT80229 , CH_Winbond_89C940_8c4a , } cocci_id@p ;
...
position p;
@@
 struct {  char * name ;  int flags ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ne2k_pci_card {  struct net_device * dev ;  struct pci_dev * pci_dev ; } cocci_id@p ;
