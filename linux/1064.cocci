...
position p;
@@
 struct gemini_flash {  struct device * dev ;  struct pinctrl * p ;  struct pinctrl_state * enabled_state ;  struct pinctrl_state * disabled_state ; } cocci_id@p ;
...
position p;
@@
 struct gemini_flash * cocci_id@p ;
