...
position p;
@@
 enum { uli_5289 = 0 , uli_5287 = 1 , uli_5281 = 2 , uli_max_ports = 4 , ULI5287_BASE = 0x90 , ULI5287_OFFS = 0x10 , ULI5281_BASE = 0x60 , ULI5281_OFFS = 0x60 , } cocci_id@p ;
...
position p;
@@
 struct uli_priv {  unsigned int scr_cfg_addr [ uli_max_ports ] ; } cocci_id@p ;
