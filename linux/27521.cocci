...
position p;
@@
 struct cuse_init_args {  struct fuse_args_pages ap ;  struct cuse_init_in in ;  struct cuse_init_out out ;  struct page * page ;  struct fuse_page_desc desc ; } cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ CUSE_CONNTBL_LEN ] ;
...
position p;
@@
 struct cuse_init_args * cocci_id@p ;
...
typedef bool;
@@
 struct cuse_conn {  struct list_head list ;  struct fuse_conn fc ;  struct cdev * cdev ;  struct device * dev ;  bool unrestricted_ioctl ; } cocci_id@p ;
...
position p;
@@
 struct cuse_devinfo * cocci_id@p ;
...
position p;
@@
 struct cuse_init_out * cocci_id@p ;
...
position p;
@@
 struct cuse_devinfo {  const char * name ; } cocci_id@p ;
