...
position p;
@@
 enum vnic_devcmd_cmd cocci_id@p ;
...
position p;
@@
 struct vnic_res {  void __iomem * vaddr ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 struct vnic_resource cocci_id@p ;
...
position p;
@@
 struct devcmd2_controller * cocci_id@p ;
...
position p;
@@
 enum vnic_dev_intr_mode cocci_id@p ;
...
position p;
@@
 struct vnic_devcmd2 * cocci_id@p ;
...
position p;
@@
 struct vnic_devcmd_fw_info * * cocci_id@p ;
...
position p;
@@
 struct vnic_devcmd_notify cocci_id@p ;
...
position p;
@@
 struct vnic_dev_ring * cocci_id@p ;
...
position p;
@@
 struct devcmd2_result * cocci_id@p ;
...
typedef u16;
@@
 struct devcmd2_controller {  struct vnic_wq_ctrl __iomem * wq_ctrl ;  struct vnic_dev_ring results_ring ;  struct vnic_wq wq ;  struct vnic_devcmd2 * cmd_ring ;  struct devcmd2_result * result ;  u16 next_result ;  u16 result_size ;  int color ; } cocci_id@p ;
...
position p;
@@
 struct vnic_resource_header cocci_id@p ;
