...
position p;
@@
 struct hfsplus_unistr * cocci_id@p ;
...
position p;
@@
 struct hfsplus_cat_thread cocci_id@p ;
...
position p;
@@
 struct hfsplus_readdir_data cocci_id@p ;
...
position p;
@@
 const hfsplus_btree_key * cocci_id@p ;
