...
position p;
@@
 struct connection {  struct list_head list ;  int fd ;  int helper_pid ;  int socket [ 2 ] ;  int telnetd_pid ;  struct port_list * port ; } cocci_id@p ;
...
position p;
@@
 struct port_dev {  struct port_list * port ;  int helper_pid ;  int telnetd_pid ; } cocci_id@p ;
...
@@
 struct port_list {  struct list_head list ;  atomic_t wait_count ;  int has_connection ;  struct completion done ;  int port ;  int fd ;  spinlock_t lock ;  struct list_head pending ;  struct list_head connections ; } cocci_id@p ;
