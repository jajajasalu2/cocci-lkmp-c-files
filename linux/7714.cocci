...
position p;
@@
 struct lpuart_soc_data cocci_id@p ;
...
position p;
@@
 enum lpuart_type { VF610_LPUART , LS1021A_LPUART , IMX7ULP_LPUART , IMX8QXP_LPUART , } cocci_id@p ;
...
position p;
@@
 struct lpuart_port * cocci_id@p [ UART_NR ] ;
...
position p;
@@
 const struct lpuart_soc_data * cocci_id@p ;
...
typedef u8;
@@
 struct lpuart_soc_data {  enum lpuart_type devtype ;  char iotype ;  u8 reg_off ; } cocci_id@p ;
