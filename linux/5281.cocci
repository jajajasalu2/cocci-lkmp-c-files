...
position p;
@@
 enum xgene_ahci_version cocci_id@p ;
...
position p;
@@
 enum xgene_ahci_version { XGENE_AHCI_V1 = 1 , XGENE_AHCI_V2 , } cocci_id@p ;
...
position p;
@@
 struct xgene_ahci_context * cocci_id@p ;
...
typedef u8,u32;
@@
 struct xgene_ahci_context {  struct ahci_host_priv * hpriv ;  struct device * dev ;  u8 last_cmd [ MAX_AHCI_CHN_PERCTR ] ;  u32 class [ MAX_AHCI_CHN_PERCTR ] ;  void __iomem * csr_core ;  void __iomem * csr_diag ;  void __iomem * csr_axi ;  void __iomem * csr_mux ; } cocci_id@p ;
