...
position p;
@@
 struct smack_parsed_rule * cocci_id@p ;
...
position p;
@@
 struct smack_parsed_rule {  struct smack_known * smk_subject ;  struct smack_known * smk_object ;  int smk_access1 ;  int smk_access2 ; } cocci_id@p ;
...
position p;
@@
 struct netlbl_lsm_catmap * cocci_id@p ;
