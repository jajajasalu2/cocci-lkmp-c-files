...
typedef uint;
@@
 void cocci_id@p ( struct xmit_frame * pxmitframe , uint * pmem , int sz ) ;
...
position p;
@@
 void cocci_id@p ( struct _adapter * padapter , struct xmit_frame * pxmitframe ) ;
