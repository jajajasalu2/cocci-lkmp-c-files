...
position p;
@@
 struct fll_config {  int src ;  int in ;  int out ; } cocci_id@p ;
...
typedef u16;
@@
 struct fll_div {  u16 outdiv ;  u16 n ;  u16 k ;  u16 clk_ref_div ;  u16 fll_fratio ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8995_NUM_SUPPLIES ] ;
