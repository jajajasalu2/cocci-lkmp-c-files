...
position p;
@@
 struct yuv_playback_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_long_t,video_size_t;
@@
 struct compat_video_event {  __s32 type ;  compat_long_t timestamp ;  union {  video_size_t size ;  unsigned int frame_rate ;  unsigned char vsync_field ; } u ; } cocci_id@p ;
...
position p;
@@
 struct compat_video_event cocci_id@p ;
...
position p;
@@
 struct v4l2_enc_idx * cocci_id@p ;
...
position p;
@@
 struct ivtv_open_id * cocci_id@p ;
...
position p;
@@
 struct v4l2_audioout cocci_id@p ;
...
position p;
@@
 struct v4l2_enc_idx_entry * cocci_id@p ;
...
position p;
@@
 struct ivtv_dma_frame * cocci_id@p ;
...
position p;
@@
 struct v4l2_sliced_vbi_data cocci_id@p ;
