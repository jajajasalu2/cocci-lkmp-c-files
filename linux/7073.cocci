...
position p;
@@
 const struct hpt_info cocci_id@p ;
...
typedef u8;
@@
 struct hpt_info {  char * chip_name ;  u8 chip_type ;  u8 udma_mask ;  u8 dpll_clk ;  u8 pci_clk ;  struct hpt_timings * timings ;  u8 clock ; } cocci_id@p ;
...
position p;
@@
 enum ata_clock { ATA_CLOCK_25MHZ , ATA_CLOCK_33MHZ , ATA_CLOCK_40MHZ , ATA_CLOCK_50MHZ , ATA_CLOCK_66MHZ , NUM_ATA_CLOCKS , } cocci_id@p ;
...
position p;
@@
 enum { HPT36x , HPT370 , HPT370A , HPT374 , HPT372 , HPT372A , HPT302 , HPT371 , HPT372N , HPT302N , HPT371N , } cocci_id@p ;
...
typedef u32;
@@
 struct hpt_timings {  u32 pio_mask ;  u32 dma_mask ;  u32 ultra_mask ;  u32 * clock_table [ NUM_ATA_CLOCKS ] ; } cocci_id@p ;
