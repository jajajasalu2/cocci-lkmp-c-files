...
@@
 struct i2c_smbus_ioctl_data32 {  u8 read_write ;  u8 command ;  u32 size ;  compat_caddr_t data ; } cocci_id@p ;
...
position p;
@@
 struct i2c_rdwr_ioctl_data cocci_id@p ;
...
position p;
@@
 struct i2c_dev {  struct list_head list ;  struct i2c_adapter * adap ;  struct device * dev ;  struct cdev cdev ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u16,compat_caddr_t;
@@
 struct i2c_msg32 {  u16 addr ;  u16 flags ;  u16 len ;  compat_caddr_t buf ; } cocci_id@p ;
...
position p;
@@
 struct i2c_smbus_ioctl_data32 cocci_id@p ;
...
position p;
@@
 struct i2c_rdwr_ioctl_data32 cocci_id@p ;
...
position p;
@@
 struct i2c_smbus_ioctl_data cocci_id@p ;
...
@@
 struct i2c_rdwr_ioctl_data32 {  compat_caddr_t msgs ;  u32 nmsgs ; } cocci_id@p ;
