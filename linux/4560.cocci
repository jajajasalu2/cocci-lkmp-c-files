...
position p;
@@
 struct gru_create_context_req cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ GRU_CHIPLETS_PER_BLADE ] ;
...
position p;
@@
 struct gru_config_info cocci_id@p ;
...
position p;
@@
 struct gru_vma_data * cocci_id@p ;
