...
position p;
@@
 struct tja11xx_phy_stats cocci_id@p [ ] ;
...
position p;
@@
 struct tja11xx_priv {  char * hwmon_name ;  struct device * hwmon_dev ; } cocci_id@p ;
...
position p;
@@
 struct tja11xx_priv * cocci_id@p ;
...
typedef u8,u16;
@@
 struct tja11xx_phy_stats {  const char * string ;  u8 reg ;  u8 off ;  u16 mask ; } cocci_id@p ;
