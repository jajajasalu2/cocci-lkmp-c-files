...
position p;
@@
 unsigned char cocci_id@p [ ISCSI_IQN_LEN ] ;
...
position p;
@@
 struct iscsi_node_stat_grps cocci_id@p ;
...
position p;
@@
 struct iscsi_wwn_stat_grps cocci_id@p ;
...
position p;
@@
 struct iscsi_sess_err_stats * cocci_id@p ;
...
position p;
@@
 struct iscsi_logout_stats * cocci_id@p ;
