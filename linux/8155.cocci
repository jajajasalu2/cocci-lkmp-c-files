...
position p;
@@
 unsigned short cocci_id@p ( unsigned char * * cpp ) ;
...
position p;
@@
 long cocci_id@p ( unsigned char * * cpp ) ;
...
position p;
@@
 unsigned char * cocci_id@p ( unsigned char * cp , unsigned short x ) ;
...
position p;
@@
 unsigned char * cocci_id@p ( unsigned char * cp , unsigned short n ) ;
