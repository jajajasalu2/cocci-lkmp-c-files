...
position p;
@@
 struct ddw_create_response * cocci_id@p ;
...
position p;
@@
 struct dynamic_dma_window_prop * cocci_id@p ;
...
position p;
@@
 struct direct_window * cocci_id@p ;
...
position p;
@@
 struct ddw_query_response * cocci_id@p ;
...
typedef u32;
@@
 struct ddw_create_response {  u32 liobn ;  u32 addr_hi ;  u32 addr_lo ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct iommu_table * , long , long ) ;
...
typedef u32;
@@
 struct ddw_query_response {  u32 windows_available ;  u32 largest_available_block ;  u32 page_size ;  u32 migration_capable ; } cocci_id@p ;
...
position p;
@@
 struct direct_window {  struct device_node * device ;  const struct dynamic_dma_window_prop * prop ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct failed_ddw_pdn * cocci_id@p ;
...
@@
 struct dynamic_dma_window_prop {  __be32 liobn ;  __be64 dma_base ;  __be32 tce_shift ;  __be32 window_shift ; } cocci_id@p ;
...
position p;
@@
 struct iommu_table_ops cocci_id@p ;
...
position p;
@@
 const struct dynamic_dma_window_prop * cocci_id@p ;
...
position p;
@@
 struct failed_ddw_pdn {  struct device_node * pdn ;  struct list_head list ; } cocci_id@p ;
