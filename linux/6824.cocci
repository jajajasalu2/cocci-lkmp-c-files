...
position p;
@@
 enum scsi_host_state cocci_id@p ;
...
position p;
@@
 const struct {  enum scsi_device_state value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct {  enum scsi_host_state value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct {  unsigned char value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 enum scsi_device_state cocci_id@p ;
