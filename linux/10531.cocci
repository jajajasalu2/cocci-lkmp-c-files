...
typedef u32;
@@
 u32 cocci_id@p [ SUMO_MAX_HARDWARE_POWERLEVELS ] ;
...
position p;
@@
 union igp_info {  struct _ATOM_INTEGRATED_SYSTEM_INFO info ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V2 info_2 ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V5 info_5 ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V6 info_6 ; } cocci_id@p ;
...
position p;
@@
 struct sumo_power_info cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ SUMO_PM_NUMBER_OF_TC ] ;
...
position p;
@@
 struct sumo_disp_clock_voltage_mapping_table * cocci_id@p ;
