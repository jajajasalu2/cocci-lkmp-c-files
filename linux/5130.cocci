...
typedef u32;
@@
 struct tegra_gpio_info {  struct device * dev ;  void __iomem * regs ;  struct irq_domain * irq_domain ;  struct tegra_gpio_bank * bank_info ;  const struct tegra_gpio_soc_config * soc ;  struct gpio_chip gc ;  struct irq_chip ic ;  u32 bank_count ; } cocci_id@p ;
...
position p;
@@
 struct tegra_gpio_info cocci_id@p ;
...
position p;
@@
 struct tegra_gpio_bank * cocci_id@p ;
...
position p;
@@
 const struct tegra_gpio_soc_config cocci_id@p ;
...
typedef bool,u32;
@@
 struct tegra_gpio_soc_config {  bool debounce_supported ;  u32 bank_stride ;  u32 upper_offset ; } cocci_id@p ;
