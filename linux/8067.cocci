...
position p;
@@
 struct at803x_context * cocci_id@p ;
...
typedef u16;
@@
 struct at803x_context {  u16 bmcr ;  u16 advertise ;  u16 control1000 ;  u16 int_enable ;  u16 smart_speed ;  u16 led_control ; } cocci_id@p ;
...
position p;
@@
 const struct at803x_context * cocci_id@p ;
