...
position p;
@@
 struct adp5520_backlight_platform_data * cocci_id@p ;
...
position p;
@@
 struct adp5520_bl {  struct device * master ;  struct adp5520_backlight_platform_data * pdata ;  struct mutex lock ;  unsigned long cached_daylight_max ;  int id ;  int current_brightness ; } cocci_id@p ;
