...
position p;
@@
 struct datafab_info {  unsigned long sectors ;  unsigned long ssize ;  signed char lun ;  unsigned char sense_key ;  unsigned long sense_asc ;  unsigned long sense_ascq ; } cocci_id@p ;
...
position p;
@@
 struct datafab_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct us_data * us , struct datafab_info * info ) ;
