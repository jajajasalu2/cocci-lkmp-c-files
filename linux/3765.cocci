...
position p;
@@
 struct sev_data_send_update_data cocci_id@p ;
...
position p;
@@
 struct sev_user_data_pek_cert_import cocci_id@p ;
...
position p;
@@
 struct sev_data_init cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SEV_FW_NAME_SIZE ] ;
...
position p;
@@
 struct sev_data_receive_update_vmsa cocci_id@p ;
...
position p;
@@
 struct sev_data_receive_start cocci_id@p ;
...
position p;
@@
 struct sev_data_download_firmware * cocci_id@p ;
...
position p;
@@
 struct sev_data_receive_update_data cocci_id@p ;
...
position p;
@@
 struct sev_data_receive_finish cocci_id@p ;
...
position p;
@@
 struct sev_user_data_pdh_cert_export cocci_id@p ;
...
position p;
@@
 struct sev_user_data_pek_csr cocci_id@p ;
...
position p;
@@
 struct sev_data_send_finish cocci_id@p ;
...
position p;
@@
 struct sev_issue_cmd * cocci_id@p ;
...
position p;
@@
 struct sev_data_pek_cert_import cocci_id@p ;
...
position p;
@@
 struct sev_data_pek_csr cocci_id@p ;
...
position p;
@@
 struct sev_data_send_update_vmsa cocci_id@p ;
...
position p;
@@
 struct sev_data_get_id cocci_id@p ;
...
position p;
@@
 struct sev_data_pdh_cert_export * cocci_id@p ;
...
position p;
@@
 struct sev_user_data_get_id cocci_id@p ;
...
position p;
@@
 struct sev_data_send_start cocci_id@p ;
...
position p;
@@
 struct sev_data_launch_update_vmsa cocci_id@p ;
...
position p;
@@
 struct sev_user_data_get_id2 cocci_id@p ;
...
position p;
@@
 struct sev_misc_dev * cocci_id@p ;
