...
position p;
@@
 w1_slave_found_callback cocci_id@p ;
...
position p;
@@
 struct w1_bus_master cocci_id@p ;
...
typedef u8,u16;
@@
 struct ds_device {  struct list_head ds_entry ;  struct usb_device * udev ;  struct usb_interface * intf ;  int ep [ NUM_EP ] ;  int spu_sleep ;  u16 spu_bit ;  u8 st_buf [ ST_SIZE ] ;  u8 byte_buf ;  struct w1_bus_master master ; } cocci_id@p ;
...
typedef u8;
@@
 struct ds_status {  u8 enable ;  u8 speed ;  u8 pullup_dur ;  u8 ppuls_dur ;  u8 pulldown_slew ;  u8 write1_time ;  u8 write0_time ;  u8 reserved0 ;  u8 status ;  u8 command0 ;  u8 command1 ;  u8 command_buffer_status ;  u8 data_out_buffer_status ;  u8 data_in_buffer_status ;  u8 reserved1 ;  u8 reserved2 ; } cocci_id@p ;
