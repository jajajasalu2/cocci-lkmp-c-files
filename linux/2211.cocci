...
@@
 sense_reason_t cocci_id@p ( int state , int valid , int * primary , int explicit ) ;
...
position p;
@@
 int cocci_id@p ( struct se_lun * lun , int explicit , int offline ) ;
...
position p;
@@
 void cocci_id@p ( struct se_lun * lun , struct t10_alua_tg_pt_gp * tg_pt_gp ) ;
