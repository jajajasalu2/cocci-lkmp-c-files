...
position p;
@@
 struct bcm_sock {  struct sock sk ;  int bound ;  int ifindex ;  struct notifier_block notifier ;  struct list_head rx_ops ;  struct list_head tx_ops ;  unsigned long dropped_usr_msgs ;  struct proc_dir_entry * bcm_proc_read ;  char procname [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct bcm_msg_head cocci_id@p ;
...
position p;
@@
 const struct canfd_frame * cocci_id@p ;
