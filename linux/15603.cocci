...
position p;
@@
 struct rtllib_pspoll_hdr cocci_id@p ;
...
position p;
@@
 struct rtllib_assoc_request_frame cocci_id@p ;
...
position p;
@@
 struct sk_buff * cocci_id@p ( struct rtllib_device * ieee ) ;
...
position p;
@@
 void cocci_id@p ( struct rtllib_device * ieee , short nl ) ;
...
position p;
@@
 struct rtllib_disassoc * cocci_id@p ;
...
position p;
@@
 struct rtllib_authentication cocci_id@p ;
...
position p;
@@
 struct rtllib_probe_request * cocci_id@p ;
...
position p;
@@
 struct rtllib_disauth * cocci_id@p ;
