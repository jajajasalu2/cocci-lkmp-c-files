...
position p;
@@
 struct qed_spq_comp_done * cocci_id@p ;
...
position p;
@@
 struct slow_path_element * cocci_id@p ;
...
position p;
@@
 struct core_db_data * cocci_id@p ;
...
position p;
@@
 struct event_ring_entry * cocci_id@p ;
...
position p;
@@
 union event_ring_element cocci_id@p ;
...
position p;
@@
 struct e4_core_conn_context * cocci_id@p ;
...
position p;
@@
 qed_spq_async_comp_cb cocci_id@p ;
