...
position p;
@@
 struct clk_psc_data * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct clk_psc {  struct clk_hw hw ;  struct clk_psc_data * psc_data ;  spinlock_t * lock ; } cocci_id@p ;
...
typedef u32;
@@
 struct clk_psc_data {  void __iomem * control_base ;  void __iomem * domain_base ;  u32 domain_id ; } cocci_id@p ;
