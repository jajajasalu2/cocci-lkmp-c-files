...
position p;
@@
 const struct uniphier_clk_gate_data * cocci_id@p ;
...
position p;
@@
 struct uniphier_clk_gate * cocci_id@p ;
...
position p;
@@
 struct uniphier_clk_gate {  struct clk_hw hw ;  struct regmap * regmap ;  unsigned int reg ;  unsigned int bit ; } cocci_id@p ;
