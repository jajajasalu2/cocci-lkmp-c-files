...
typedef bool,u32;
@@
 struct rpmhpd {  struct device * dev ;  struct generic_pm_domain pd ;  struct generic_pm_domain * parent ;  struct rpmhpd * peer ;  const bool active_only ;  unsigned int corner ;  unsigned int active_corner ;  u32 level [ RPMH_ARC_MAX_LEVELS ] ;  size_t level_count ;  bool enabled ;  const char * res_name ;  u32 addr ; } cocci_id@p ;
...
position p;
@@
 const struct rpmhpd_desc * cocci_id@p ;
...
position p;
@@
 struct rpmhpd_desc {  struct rpmhpd * * rpmhpds ;  size_t num_pds ; } cocci_id@p ;
