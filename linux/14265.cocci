...
position p;
@@
 enum osd_blink_interval cocci_id@p ;
...
position p;
@@
 enum osd_pix_format cocci_id@p ;
...
position p;
@@
 struct osd_window_state * cocci_id@p ;
...
position p;
@@
 struct osd_platform_data * cocci_id@p ;
...
position p;
@@
 const struct osd_layer_config * cocci_id@p ;
...
position p;
@@
 enum osd_blending_factor cocci_id@p ;
...
position p;
@@
 const struct vpbe_osd_ops cocci_id@p ;
...
position p;
@@
 struct osd_osdwin_state * cocci_id@p ;
...
position p;
@@
 enum osd_zoom_factor cocci_id@p ;
