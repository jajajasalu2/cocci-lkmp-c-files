...
position p;
@@
 struct ddb * cocci_id@p [ DDB_MAX_ADAPTER ] ;
...
position p;
@@
 struct lnbh25_config cocci_id@p ;
...
position p;
@@
 const struct ddb_regmap * cocci_id@p ;
...
position p;
@@
 struct stv6110x_config cocci_id@p ;
...
position p;
@@
 const struct stv6110x_devctl * cocci_id@p ;
...
position p;
@@
 const struct stv0910_cfg cocci_id@p ;
...
position p;
@@
 const struct ddb_info * cocci_id@p ;
...
position p;
@@
 const struct lnbh25_config cocci_id@p ;
