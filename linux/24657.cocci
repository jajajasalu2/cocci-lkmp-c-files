...
position p;
@@
 struct hash_ipmac6_elem cocci_id@p ;
...
position p;
@@
 const struct hash_ipmac6_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_ipmac4_elem * cocci_id@p ;
...
position p;
@@
 struct hash_ipmac4_elem cocci_id@p ;
...
typedef __be32;
@@
 struct hash_ipmac6_elem {  union nf_inet_addr ip ;  union {  unsigned char ether [ ETH_ALEN ] ;  __be32 foo [ 2 ] ; } ; } cocci_id@p ;
...
typedef __be32;
@@
 struct hash_ipmac4_elem {  __be32 ip ;  union {  unsigned char ether [ ETH_ALEN ] ;  __be32 foo [ 2 ] ; } ; } cocci_id@p ;
