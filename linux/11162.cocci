...
position p;
@@
 void cocci_id@p ( ATOM_COMMON_TABLE_HEADER * atom_data_tbl , struct atom_data_revision * tbl_revision ) ;
...
position p;
@@
 ATOM_COMMON_TABLE_HEADER cocci_id@p ;
...
position p;
@@
 ATOM_ASIC_INTERNAL_SS_INFO_V2 cocci_id@p ;
...
position p;
@@
 ATOM_ASIC_INTERNAL_SS_INFO_V3 * cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , ATOM_I2C_RECORD * record , struct graphics_object_i2c_info * info ) ;
...
position p;
@@
 ATOM_INTEGRATED_SYSTEM_INFO_V1_9 cocci_id@p ;
...
position p;
@@
 ATOM_FIRMWARE_INFO_V1_4 cocci_id@p ;
...
position p;
@@
 ATOM_OBJECT * cocci_id@p ( struct bios_parser * bp , struct graphics_object_id id ) ;
...
position p;
@@
 ATOM_INTEGRATED_SYSTEM_INFO_V1_8 cocci_id@p ;
...
typedef uint32_t;
@@
 uint32_t cocci_id@p ( struct device_id device_id ) ;
...
position p;
@@
 ATOM_ASIC_SS_ASSIGNMENT_V2 cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct dc_bios * dcb , struct embedded_panel_info * info ) ;
...
position p;
@@
 ATOM_FIRMWARE_INFO_V2_1 * cocci_id@p ;
...
position p;
@@
 ATOM_SPREAD_SPECTRUM_INFO * cocci_id@p ;
...
position p;
@@
 ATOM_ENCODER_CAP_RECORD_V2 * cocci_id@p ;
...
position p;
@@
 ATOM_CONNECTOR_DEVICE_TAG_RECORD * * cocci_id@p ;
...
position p;
@@
 ATOM_ASIC_SS_ASSIGNMENT_V3 cocci_id@p ;
...
position p;
@@
 ATOM_BRACKET_LAYOUT_RECORD cocci_id@p ;
...
typedef uint32_t;
@@
 uint32_t cocci_id@p ( enum as_signal_type signal ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct bios_parser * bp , struct bp_init_data * init , enum dce_version dce_version ) ;
...
typedef uint16_t;
@@
 struct device_id cocci_id@p ( uint16_t device_id ) ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p ( struct dc_bios * dcb ) ;
...
position p;
@@
 ATOM_OBJECT_HEADER_V3 cocci_id@p ;
...
position p;
@@
 ATOM_HPD_INT_RECORD * cocci_id@p ( struct bios_parser * bp , ATOM_OBJECT * object ) ;
...
position p;
@@
 ATOM_CONNECTOR_DEVICE_TAG cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct embedded_panel_info * info ) ;
