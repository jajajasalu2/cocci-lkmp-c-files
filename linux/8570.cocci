...
position p;
@@
 struct vf_pf_event_data * cocci_id@p ;
...
position p;
@@
 struct vfpf_init_tlv * cocci_id@p ;
...
position p;
@@
 struct pfvf_general_resp_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_port_phys_id_resp_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_q_mac_vlan_filter * cocci_id@p ;
...
position p;
@@
 struct vfpf_fp_hsi_resp_tlv * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct bnx2x * bp , int qidx ) ;
...
position p;
@@
 struct vfpf_set_q_filters_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_setup_q_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_close_tlv * cocci_id@p ;
...
position p;
@@
 struct bnx2x_vf_mbx * cocci_id@p ;
...
position p;
@@
 struct vfpf_rss_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_q_op_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_release_tlv * cocci_id@p ;
