...
position p;
@@
 struct fanotify_event * cocci_id@p ;
...
position p;
@@
 struct fanotify_response * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fsnotify_connp_t;
@@
 fsnotify_connp_t * cocci_id@p ;
...
position p;
@@
 struct fanotify_event_info_fid cocci_id@p ;
...
position p;
@@
 struct fsnotify_event * cocci_id@p ;
...
position p;
@@
 struct fanotify_event_metadata cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ FANOTIFY_INLINE_FH_LEN ] ;
...
position p;
@@
 struct fanotify_perm_event * cocci_id@p ;
