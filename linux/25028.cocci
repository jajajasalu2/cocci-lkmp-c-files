...
symbol cocci_id;
position p;
typedef digital_poll_t;
@@
 digital_poll_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u16,nfc_digital_cmd_complete_t;
@@
 struct digital_cmd {  struct list_head queue ;  u8 type ;  u8 pending ;  u16 timeout ;  struct sk_buff * req ;  struct sk_buff * resp ;  struct digital_tg_mdaa_params * mdaa_params ;  nfc_digital_cmd_complete_t cmd_cb ;  void * cb_context ; } cocci_id@p ;
...
position p;
@@
 struct digital_data_exch * cocci_id@p ;
...
position p;
@@
 struct digital_poll_tech * cocci_id@p ;
