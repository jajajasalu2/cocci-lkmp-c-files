...
position p;
@@
 struct capture_control * cocci_id@p ;
...
position p;
@@
 struct memblock_region * cocci_id@p ;
...
position p;
@@
 enum memmap_context cocci_id@p ;
...
position p;
@@
 struct deferred_split * cocci_id@p ;
...
position p;
@@
 struct alloc_context cocci_id@p ;
...
position p;
@@
 struct compact_control * cocci_id@p ;
...
position p;
@@
 char * const cocci_id@p [ MAX_NR_ZONES ] ;
...
position p;
@@
 void cocci_id@p ( struct per_cpu_pageset * p , unsigned long batch ) ;
...
position p;
@@
 unsigned long cocci_id@p [ NR_LRU_LISTS ] ;
...
position p;
@@
 char cocci_id@p [ MIGRATE_TYPES + 1 ] ;
...
position p;
@@
 struct mminit_pfnnid_cache * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MIGRATE_TYPES ] [ 4 ] ;
...
typedef bool,u32;
@@
 struct {  struct fault_attr attr ;  bool ignore_gfp_highmem ;  bool ignore_gfp_reclaim ;  u32 min_order ; } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_ORDER ] ;
...
position p;
@@
 compound_page_dtor * const cocci_id@p [ ] ;
...
position p;
@@
 struct per_cpu_pageset * cocci_id@p ;
...
position p;
@@
 enum compact_priority cocci_id@p ;
...
position p;
@@
 enum compact_result * cocci_id@p ;
...
position p;
@@
 struct per_cpu_nodestat cocci_id@p ;
...
position p;
@@
 struct per_cpu_pages * cocci_id@p ;
...
position p;
@@
 const struct alloc_context * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct page * page , unsigned int order ) ;
...
position p;
@@
 struct page_frag_cache * cocci_id@p ;
...
position p;
@@
 struct pcpu_drain {  struct zone * zone ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 enum numa_stat_item cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ MIGRATE_TYPES ] ;
...
position p;
@@
 const char cocci_id@p [ MIGRATE_TYPES ] ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_ORDER ] ;
