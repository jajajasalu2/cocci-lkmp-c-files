...
position p;
@@
 struct btrfs_io_ctl cocci_id@p ;
...
position p;
@@
 const struct btrfs_free_space_op cocci_id@p ;
...
position p;
@@
 struct btrfs_trim_range cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_free_space_ctl * ctl , struct btrfs_free_space * info ) ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_root * root , struct btrfs_trans_handle * trans , struct btrfs_io_ctl * io_ctl , struct btrfs_path * path ) ;
...
position p;
@@
 struct btrfs_free_space_header cocci_id@p ;
...
position p;
@@
 struct btrfs_free_space_entry * cocci_id@p ;
...
position p;
@@
 void noinline_for_stack cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfs_free_space_ctl * ctl , struct btrfs_free_space * info ) ;
...
typedef u64;
@@
 struct btrfs_trim_range {  u64 start ;  u64 bytes ;  struct list_head list ; } cocci_id@p ;
