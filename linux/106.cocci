...
position p;
@@
 enum numa_faults_stats cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( struct numa_group * ng ) ;
...
position p;
@@
 struct cfs_bandwidth * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sched_entity * curr , struct sched_entity * se ) ;
...
symbol cocci_id;
position p;
typedef pid_t,spinlock_t,refcount_t;
@@
 struct numa_group {  refcount_t refcount ;  spinlock_t lock ;  int nr_tasks ;  pid_t gid ;  int active_nodes ;  struct rcu_head rcu ;  unsigned long total_faults ;  unsigned long max_faults_cpu ;  unsigned long * faults_cpu ;  unsigned long faults [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct task_struct * p , int prev_cpu , int cpu ) ;
...
position p;
@@
 void cocci_id@p ( struct cfs_rq * cfs_rq ) ;
...
position p;
@@
 enum sched_tunable_scaling cocci_id@p ;
...
position p;
@@
 const struct sched_class * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( struct task_struct * p ) ;
...
position p;
@@
 struct sched_entity * * cocci_id@p ;
...
position p;
@@
 struct task_numa_env cocci_id@p ;
...
position p;
@@
 const struct sched_avg * cocci_id@p ;
...
position p;
@@
 struct lb_env {  struct sched_domain * sd ;  struct rq * src_rq ;  int src_cpu ;  int dst_cpu ;  struct rq * dst_rq ;  struct cpumask * dst_grpmask ;  int new_dst_cpu ;  enum cpu_idle_type idle ;  long imbalance ;  struct cpumask * cpus ;  unsigned int flags ;  unsigned int loop ;  unsigned int loop_break ;  unsigned int loop_max ;  enum fbq_type fbq_type ;  enum migration_type migration_type ;  struct list_head tasks ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct cfs_rq * cfs_rq ) ;
...
position p;
@@
 int cocci_id@p ( struct cfs_rq * cfs_rq ) ;
...
symbol cocci_id;
position p;
typedef cpumask_var_t,atomic_t;
@@
 struct {  cpumask_var_t idle_cpus_mask ;  atomic_t nr_cpus ;  int has_blocked ;  unsigned long next_balance ;  unsigned long next_blocked ; } cocci_id@p ;
...
position p;
@@
 struct sched_group * cocci_id@p ( struct sched_domain * sd , struct task_struct * p , int this_cpu , int sd_flag ) ;
...
position p;
@@
 enum fbq_type { regular , remote , all , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sched_entity * se ) ;
...
position p;
@@
 struct sd_lb_stats {  struct sched_group * busiest ;  struct sched_group * local ;  unsigned long total_load ;  unsigned long total_capacity ;  unsigned long avg_load ;  unsigned int prefer_sibling ;  struct sg_lb_stats busiest_stat ;  struct sg_lb_stats local_stat ; } cocci_id@p ;
...
position p;
@@
 struct sched_domain_shared * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( struct cfs_rq * cfs_rq ) ;
...
position p;
@@
 struct sched_domain * cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct cfs_rq * cfs_rq , u64 delta_exec ) ;
...
position p;
@@
 struct cpuidle_state * cocci_id@p ;
...
position p;
@@
 struct task_numa_env {  struct task_struct * p ;  int src_cpu , src_nid ;  int dst_cpu , dst_nid ;  struct numa_stats src_stats , dst_stats ;  int imbalance_pct ;  int dist ;  struct task_struct * best_task ;  long best_imp ;  int best_cpu ; } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( int cpu ) ;
...
position p;
@@
 struct softirq_action * cocci_id@p ;
...
position p;
@@
 struct sched_group_capacity * cocci_id@p ;
...
position p;
@@
 struct numa_stats {  unsigned long load ;  unsigned long compute_capacity ; } cocci_id@p ;
