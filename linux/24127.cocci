...
position p;
@@
 struct sockaddr_can * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef can_err_mask_t;
@@
 can_err_mask_t cocci_id@p ;
...
position p;
@@
 struct uniqframe {  int skbcnt ;  const struct sk_buff * skb ;  unsigned int join_rx_count ; } cocci_id@p ;
...
position p;
@@
 struct can_skb_priv cocci_id@p ;
...
typedef can_err_mask_t;
@@
 struct raw_sock {  struct sock sk ;  int bound ;  int ifindex ;  struct notifier_block notifier ;  int loopback ;  int recv_own_msgs ;  int fd_frames ;  int join_filters ;  int count ;  struct can_filter dfilter ;  struct can_filter * filter ;  can_err_mask_t err_mask ;  struct uniqframe __percpu * uniq ; } cocci_id@p ;
...
position p;
@@
 const struct can_proto cocci_id@p ;
