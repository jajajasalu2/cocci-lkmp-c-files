...
position p;
@@
 const struct dpaa2_io_desc * cocci_id@p ;
...
position p;
@@
 struct dpaa2_io_store * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct dpaa2_io {  struct dpaa2_io_desc dpio_desc ;  struct qbman_swp_desc swp_desc ;  struct qbman_swp * swp ;  struct list_head node ;  spinlock_t lock_mgmt_cmd ;  spinlock_t lock_notifications ;  struct list_head notifications ;  struct device * dev ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct dpaa2_io_store {  unsigned int max ;  dma_addr_t paddr ;  struct dpaa2_dq * vaddr ;  void * alloced_addr ;  unsigned int idx ;  struct qbman_swp * swp ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct dpaa2_io * cocci_id@p [ NR_CPUS ] ;
