...
position p;
@@
 struct mop500_ab8500_drvdata * cocci_id@p ;
...
position p;
@@
 struct mop500_ab8500_drvdata {  enum mclk mclk_sel ;  struct clk * clk_ptr_intclk ;  struct clk * clk_ptr_sysclk ;  struct clk * clk_ptr_ulpclk ; } cocci_id@p ;
...
position p;
@@
 enum mclk { MCLK_SYSCLK , MCLK_ULPCLK , } cocci_id@p ;
