...
position p;
@@
 struct speedtch_instance_data * cocci_id@p ;
...
position p;
@@
 const struct usb_host_interface * cocci_id@p ;
...
position p;
@@
 struct speedtch_instance_data {  struct usbatm_data * usbatm ;  struct speedtch_params params ;  struct timer_list status_check_timer ;  struct work_struct status_check_work ;  unsigned char last_status ;  int poll_delay ;  struct timer_list resubmit_timer ;  struct urb * int_urb ;  unsigned char int_data [ 16 ] ;  unsigned char scratch_buffer [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_interface * , const struct usb_device_id * ) ;
...
position p;
@@
 struct speedtch_params {  unsigned int altsetting ;  unsigned int BMaxDSL ;  unsigned char ModemMode ;  unsigned char ModemOption [ MODEM_OPTION_LENGTH ] ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MODEM_OPTION_LENGTH ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ MODEM_OPTION_LENGTH ] ;
