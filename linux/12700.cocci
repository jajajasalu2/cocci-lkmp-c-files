...
position p;
@@
 struct imx_weim_devtype {  unsigned int cs_count ;  unsigned int cs_regs_count ;  unsigned int cs_stride ;  unsigned int wcr_offset ;  unsigned int wcr_bcm ; } cocci_id@p ;
...
position p;
@@
 struct cs_timing_state * cocci_id@p ;
...
position p;
@@
 const struct imx_weim_devtype * cocci_id@p ;
...
typedef bool,u32;
@@
 struct cs_timing {  bool is_applied ;  u32 regs [ MAX_CS_REGS_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct cs_timing_state {  struct cs_timing cs [ MAX_CS_COUNT ] ; } cocci_id@p ;
