...
position p;
@@
 struct extra_kernel_map_info * cocci_id@p ;
...
typedef u64,bool;
@@
 struct extra_kernel_map_info {  int cnt ;  int max_cnt ;  struct extra_kernel_map * maps ;  bool get_entry_trampolines ;  u64 entry_trampoline ; } cocci_id@p ;
