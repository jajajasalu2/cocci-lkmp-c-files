...
position p;
@@
 struct ehea_dir_bmap cocci_id@p ;
...
position p;
@@
 const enum ehea_eq_type cocci_id@p ;
...
position p;
@@
 struct ehea_top_bmap * cocci_id@p ;
