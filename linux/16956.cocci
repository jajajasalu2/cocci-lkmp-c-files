...
typedef spinlock_t;
@@
 struct sx8654 {  struct input_dev * input ;  struct i2c_client * client ;  struct gpio_desc * gpio_reset ;  spinlock_t lock ;  struct timer_list timer ;  struct touchscreen_properties props ;  const struct sx865x_data * data ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,irq_handler_t;
@@
 struct sx865x_data {  u8 cmd_manual ;  u8 chan_mask ;  bool has_irq_penrelease ;  bool has_reg_irqmask ;  irq_handler_t irqh ; } cocci_id@p ;
...
position p;
@@
 const struct sx865x_data cocci_id@p ;
