...
position p;
@@
 enum chips { ad7416 , ad7417 , ad7418 , } cocci_id@p ;
...
typedef s16,u16;
@@
 struct ad7418_data {  struct i2c_client * client ;  enum chips type ;  struct mutex lock ;  int adc_max ;  char valid ;  unsigned long last_updated ;  s16 temp [ 3 ] ;  u16 in [ 4 ] ; } cocci_id@p ;
