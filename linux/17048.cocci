...
position p;
@@
 struct sw {  struct gameport * gameport ;  struct input_dev * dev [ 4 ] ;  char name [ 64 ] ;  char phys [ 4 ] [ 32 ] ;  int length ;  int type ;  int bits ;  int number ;  int fail ;  int ok ;  int reads ;  int bads ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ SW_LENGTH ] ;
