...
position p;
@@
 struct gpio_desc {  unsigned valid : 1 ;  unsigned can_wakeup : 1 ;  unsigned keypad_gpio : 1 ;  unsigned dir_inverted : 1 ;  unsigned int mask ;  unsigned int mux_mask ;  unsigned long config ; } cocci_id@p ;
...
position p;
@@
 struct gpio_desc cocci_id@p [ MFP_PIN_GPIO127 + 1 ] ;
