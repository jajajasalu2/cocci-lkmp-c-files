...
position p;
@@
 enum fsl_ssi_type { FSL_SSI_MCP8610 , FSL_SSI_MX21 , FSL_SSI_MX35 , FSL_SSI_MX51 , } cocci_id@p ;
...
position p;
@@
 struct fsl_ssi_soc_data cocci_id@p ;
...
typedef u32;
@@
 struct fsl_ssi_regvals {  u32 sier ;  u32 srcr ;  u32 stcr ;  u32 scr ; } cocci_id@p ;
...
position p;
@@
 struct fsl_ssi_regvals * cocci_id@p ;
...
typedef bool,u32;
@@
 struct fsl_ssi_soc_data {  bool imx ;  bool imx21regs ;  bool offline_config ;  u32 sisr_write_mask ; } cocci_id@p ;
