...
position p;
@@
 struct kempld_wdt_stage * cocci_id@p ;
...
position p;
@@
 struct kempld_wdt_data * cocci_id@p ;
...
typedef u32;
@@
 struct kempld_wdt_stage {  unsigned int id ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 enum { ACTION_NONE = 0 , ACTION_RESET , ACTION_NMI , ACTION_SMI , ACTION_SCI , ACTION_DELAY , } cocci_id@p ;
...
position p;
@@
 enum { STAGE_TIMEOUT = 0 , STAGE_PRETIMEOUT , } cocci_id@p ;
...
position p;
@@
 enum { PRESCALER_21 = 0 , PRESCALER_17 , PRESCALER_12 , } cocci_id@p ;
...
position p;
@@
 struct kempld_device_data * cocci_id@p ;
