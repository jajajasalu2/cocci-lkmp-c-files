...
position p;
@@
 const struct tulip_chip_table cocci_id@p [ ] ;
...
typedef u32;
@@
 void cocci_id@p ( struct pci_dev * pdev , u32 wolopts ) ;
...
position p;
@@
 struct tulip_tx_desc * cocci_id@p ;
...
position p;
@@
 struct tulip_private * cocci_id@p ;
...
position p;
@@
 struct tulip_rx_desc cocci_id@p ;
