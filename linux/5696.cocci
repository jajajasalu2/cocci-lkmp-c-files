...
position p;
@@
 struct dax_device {  struct hlist_node list ;  struct inode inode ;  struct cdev cdev ;  const char * host ;  void * private ;  unsigned long flags ;  const struct dax_operations * ops ; } cocci_id@p ;
...
position p;
@@
 struct hlist_head cocci_id@p [ DAX_HASH_SIZE ] ;
...
position p;
@@
 enum dax_device_flags { DAXDEV_ALIVE , DAXDEV_WRITE_CACHE , DAXDEV_SYNC , } cocci_id@p ;
