...
position p;
@@
 int cocci_id@p ( struct inode * inode , const char * name ) ;
...
position p;
@@
 struct hfs_bnode_desc * cocci_id@p ;
...
position p;
@@
 struct hfsplus_cat_folder cocci_id@p ;
...
position p;
@@
 struct hfsplus_sb_info * cocci_id@p ;
...
position p;
@@
 struct hfs_btree_header_rec cocci_id@p ;
...
position p;
@@
 struct hfsplus_attr_key cocci_id@p ;
...
position p;
@@
 struct hfsplus_inode_info * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct FInfo ) + sizeof ( struct FXInfo ) ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct DInfo ) + sizeof ( struct DXInfo ) ] ;
...
position p;
@@
 struct hfs_find_data cocci_id@p ;
...
position p;
@@
 struct hfsplus_cat_file cocci_id@p ;
...
position p;
@@
 struct hfsplus_attr_inline_data cocci_id@p ;
...
position p;
@@
 const struct hfsplus_unistr * cocci_id@p ;
