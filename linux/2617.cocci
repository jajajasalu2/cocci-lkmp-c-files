...
position p;
@@
 const struct rockchip_data cocci_id@p ;
...
position p;
@@
 struct rockchip_otp {  struct device * dev ;  void __iomem * base ;  struct clk_bulk_data * clks ;  int num_clks ;  struct reset_control * rst ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_data {  int size ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_otp cocci_id@p ;
