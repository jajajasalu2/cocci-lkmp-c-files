...
position p;
@@
 struct surface_button cocci_id@p ;
...
typedef bool;
@@
 struct surface_button {  unsigned int type ;  struct input_dev * input ;  char phys [ 32 ] ;  unsigned long pushed ;  bool suspended ; } cocci_id@p ;
