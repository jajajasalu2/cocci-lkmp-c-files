...
position p;
@@
 enum sctp_event_type cocci_id@p ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p [ SCTP_STATE_NUM_STATES ] ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p [ SCTP_NUM_AUTH_CHUNK_TYPES ] [ SCTP_STATE_NUM_STATES ] ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p [ SCTP_NUM_BASE_CHUNK_TYPES ] [ SCTP_STATE_NUM_STATES ] ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p [ SCTP_NUM_TIMEOUT_TYPES ] [ SCTP_STATE_NUM_STATES ] ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p [ SCTP_NUM_RECONF_CHUNK_TYPES ] [ SCTP_STATE_NUM_STATES ] ;
...
position p;
@@
 const struct sctp_sm_table_entry * cocci_id@p ( struct net * net , enum sctp_cid cid , enum sctp_state state ) ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p [ SCTP_NUM_OTHER_TYPES ] [ SCTP_STATE_NUM_STATES ] ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p [ SCTP_NUM_PRSCTP_CHUNK_TYPES ] [ SCTP_STATE_NUM_STATES ] ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p [ SCTP_NUM_ADDIP_CHUNK_TYPES ] [ SCTP_STATE_NUM_STATES ] ;
...
position p;
@@
 const struct sctp_sm_table_entry cocci_id@p [ SCTP_NUM_PRIMITIVE_TYPES ] [ SCTP_STATE_NUM_STATES ] ;
