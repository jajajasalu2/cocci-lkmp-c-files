...
symbol cocci_id;
position p;
typedef compat_xfs_fsop_handlereq_t;
@@
 compat_xfs_fsop_handlereq_t * cocci_id@p ;
...
position p;
@@
 bulkstat_one_fmt_pf cocci_id@p ;
...
position p;
@@
 struct compat_xfs_fsop_geom_v1 cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_xfs_attr_multiop_t;
@@
 compat_xfs_attr_multiop_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_bstime_t;
@@
 xfs_bstime_t * cocci_id@p ;
...
position p;
@@
 struct xfs_growfs_data * cocci_id@p ;
...
position p;
@@
 struct xfs_fsop_handlereq cocci_id@p ;
...
position p;
@@
 struct compat_xfs_inogrp cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_time_t;
@@
 compat_time_t cocci_id@p ;
...
position p;
@@
 struct xfs_growfs_rt cocci_id@p ;
...
position p;
@@
 struct compat_xfs_bstat cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_xfs_fsop_attrmulti_handlereq_t;
@@
 compat_xfs_fsop_attrmulti_handlereq_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_xfs_fsop_attrlist_handlereq_t;
@@
 compat_xfs_fsop_attrlist_handlereq_t cocci_id@p ;
