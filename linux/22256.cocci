...
position p;
@@
 int cocci_id@p ( struct page * page , struct list_head * pagelist , unsigned long flags ) ;
...
typedef nodemask_t;
@@
 const struct mempolicy_operations {  int ( * create ) ( struct mempolicy * pol , const nodemask_t * nodes ) ;  void ( * rebind ) ( struct mempolicy * pol , const nodemask_t * nodes ) ; } cocci_id@p [ MPOL_MAX ] ;
...
position p;
@@
 struct nodemask_scratch * cocci_id@p ;
...
position p;
@@
 const struct mempolicy * cocci_id@p ;
...
position p;
@@
 struct mempolicy cocci_id@p [ MAX_NUMNODES ] ;
...
position p;
@@
 const struct mempolicy_operations cocci_id@p [ MPOL_MAX ] ;
...
typedef nodemask_t;
@@
 struct queue_pages {  struct list_head * pagelist ;  unsigned long flags ;  nodemask_t * nmask ;  unsigned long start ;  unsigned long end ;  struct vm_area_struct * first ; } cocci_id@p ;
...
position p;
@@
 struct shared_policy * cocci_id@p ;
