...
typedef u32;
@@
 int cocci_id@p ( struct user_sdma_request * req , struct user_sdma_txreq * tx , u32 datalen ) ;
...
position p;
@@
 struct user_sdma_txreq cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ AHG_KDETH_ARRAY_SIZE ] ;
...
typedef u32;
@@
 int cocci_id@p ( struct user_sdma_request * req , struct hfi1_pkt_header * hdr , u32 lrhlen , u32 datalen ) ;
...
position p;
@@
 enum hfi1_sdma_comp_state cocci_id@p ;
...
position p;
@@
 struct sdma_mmu_node * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( void * arg , struct mmu_rb_node * mnode , void * arg2 , bool * stop ) ;
...
position p;
@@
 struct hfi1_pkt_header * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct hfi1_pkt_header , u32 len ) ;
...
position p;
@@
 int cocci_id@p ( void * arg , struct mmu_rb_node * mnode ) ;
...
typedef bool,uint;
@@
 int cocci_id@p ( struct sdma_engine * sde , struct iowait_work * wait , struct sdma_txreq * txreq , uint seq , bool pkts_sent ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct user_sdma_request * req , bool unpin ) ;
...
position p;
@@
 void cocci_id@p ( struct hfi1_user_sdma_pkt_q * pq ) ;
...
position p;
@@
 int cocci_id@p ( struct user_sdma_request * req , struct user_sdma_iovec * iovec ) ;
...
position p;
@@
 struct hfi1_filedata * cocci_id@p ;
...
position p;
@@
 struct hfi1_user_sdma_comp_q * cocci_id@p ;
...
position p;
@@
 struct hfi1_user_sdma_pkt_q cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mm_struct * mm , struct page * * pages , unsigned start , unsigned npages ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct user_sdma_request * req , u16 maxpkts ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct user_sdma_request * req , struct user_sdma_txreq * tx , u32 len ) ;
...
position p;
@@
 struct user_sdma_iovec * cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct hfi1_user_sdma_pkt_q * pq , struct hfi1_user_sdma_comp_q * cq , u16 idx , enum hfi1_sdma_comp_state state , int ret ) ;
...
position p;
@@
 void cocci_id@p ( void * arg , struct mmu_rb_node * mnode ) ;
...
position p;
@@
 void cocci_id@p ( struct iowait * wait , int reason ) ;
...
position p;
@@
 void cocci_id@p ( struct sdma_txreq * txreq , int status ) ;
...
position p;
@@
 struct user_sdma_request * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct mmu_rb_node * node , unsigned long addr , unsigned long len ) ;
...
position p;
@@
 struct sdma_req_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,__be32;
@@
 u32 cocci_id@p ( __be32 bthpsn , u8 expct , u32 frags ) ;
