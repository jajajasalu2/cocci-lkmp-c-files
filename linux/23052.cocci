...
position p;
@@
 struct davinci_mcasp_pdata * cocci_id@p ;
...
position p;
@@
 struct davinci_mcasp cocci_id@p ;
...
position p;
@@
 struct davinci_mcasp_context * cocci_id@p ;
...
position p;
@@
 struct davinci_mcasp_ruledata {  struct davinci_mcasp * mcasp ;  int serializers ; } cocci_id@p ;
...
position p;
@@
 struct davinci_mcasp_ruledata * cocci_id@p ;
...
typedef bool,u32;
@@
 struct davinci_mcasp_context {  u32 config_regs [ ARRAY_SIZE ( context_regs ) ] ;  u32 afifo_regs [ 2 ] ;  u32 * xrsr_regs ;  bool pm_state ; } cocci_id@p ;
...
position p;
@@
 enum { PCM_EDMA , PCM_SDMA , } cocci_id@p ;
