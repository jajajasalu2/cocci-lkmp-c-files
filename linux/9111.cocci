...
position p;
@@
 struct mlx5dr_match_spec * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_ste_build * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLX5_ST_SZ_BYTES ( fte_match_set_lyr_2_4 ) ] ;
...
position p;
@@
 struct mlx5dr_htbl_connect_info cocci_id@p ;
...
typedef u8;
@@
 struct dr_hw_ste_format {  u8 ctrl [ DR_STE_SIZE_CTRL ] ;  u8 tag [ DR_STE_SIZE_TAG ] ;  u8 mask [ DR_STE_SIZE_MASK ] ; } cocci_id@p ;
...
position p;
@@
 struct mlx5dr_match_misc2 * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_ste_htbl_ctrl * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_match_parameters * cocci_id@p ;
...
position p;
@@
 enum dr_ste_action_type { DR_STE_ACTION_TYPE_PUSH_VLAN = 1 , DR_STE_ACTION_TYPE_ENCAP_L3 = 3 , DR_STE_ACTION_TYPE_ENCAP = 4 , } cocci_id@p ;
...
position p;
@@
 struct dr_hw_ste_format * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_match_misc cocci_id@p ;
...
position p;
@@
 enum dr_ste_tunl_action { DR_STE_TUNL_ACTION_NONE = 0 , DR_STE_TUNL_ACTION_ENABLE = 1 , DR_STE_TUNL_ACTION_DECAP = 2 , DR_STE_TUNL_ACTION_L3_DECAP = 3 , DR_STE_TUNL_ACTION_POP_VLAN = 4 , } cocci_id@p ;
...
position p;
@@
 struct mlx5dr_match_param * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_match_misc3 * cocci_id@p ;
