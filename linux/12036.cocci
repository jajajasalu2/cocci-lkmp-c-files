...
position p;
@@
 const struct nvkm_event_func cocci_id@p ;
...
position p;
@@
 const struct nvkm_disp_oclass * cocci_id@p ;
...
position p;
@@
 struct nvbios_connE cocci_id@p ;
...
position p;
@@
 const struct nvkm_disp_func * cocci_id@p ;
...
position p;
@@
 const struct nvkm_oproxy_func cocci_id@p ;
...
position p;
@@
 union {  struct nvif_notify_conn_req_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_notify_head_req_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 struct nvif_notify_head_rep_v0 cocci_id@p ;
