...
position p;
@@
 const struct vmw_ctx_bindinfo * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetSOTargets body ; } * cocci_id@p ;
...
position p;
@@
 const struct vmw_binding_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vmw_ctx_binding_state * cbs ) ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetShader body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_dx_shader_bindings * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdSetShader body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetIndexBuffer body ; } * cocci_id@p ;
...
position p;
@@
 const struct vmw_ctx_bindinfo_vb * cocci_id@p ;
...
position p;
@@
 const struct vmw_ctx_binding_state * cocci_id@p ;
...
typedef bool;
@@
 int ( * cocci_id@p ) ( struct vmw_ctx_bindinfo * , bool ) ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdSetRenderTarget body ; } * cocci_id@p ;
...
position p;
@@
 const struct vmw_ctx_bindinfo_so * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetVertexBuffers body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetSingleConstantBuffer body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  struct {  SVGA3dCmdSetTextureState c ;  SVGA3dTextureState s1 ; } body ; } * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct vmw_ctx_bindinfo * bi , bool rebind ) ;
...
position p;
@@
 struct vmw_binding_info {  size_t size ;  const size_t * offsets ;  vmw_scrub_func scrub_func ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ vmw_ctx_binding_max ] ;
...
position p;
@@
 const struct vmw_ctx_bindinfo_view * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetRenderTargets body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetShaderResources body ; } * cocci_id@p ;
