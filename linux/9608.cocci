...
position p;
@@
 enum brcmf_netif_stop_reason cocci_id@p ;
...
position p;
@@
 struct brcmf_rev_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BRCMU_BOARDREV_LEN ] ;
...
position p;
@@
 enum brcmf_bus_state cocci_id@p ;
...
position p;
@@
 struct wlc_d11rxhdr cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BRCMU_DOTREV_LEN ] ;
