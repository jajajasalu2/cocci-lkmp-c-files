...
position p;
@@
 struct s5p_mfc_enc_params * cocci_id@p ;
...
position p;
@@
 const struct s5p_mfc_codec_ops cocci_id@p ;
...
position p;
@@
 enum v4l2_mpeg_video_h264_vui_sar_idc cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ V4L2_MPEG_VIDEO_H264_LEVEL_4_0 + 1 ] ;
...
position p;
@@
 unsigned int cocci_id@p [ V4L2_MPEG_VIDEO_H264_VUI_SAR_IDC_EXTENDED + 1 ] ;
...
position p;
@@
 enum v4l2_mpeg_video_hevc_level cocci_id@p ;
...
position p;
@@
 enum v4l2_mpeg_video_mpeg4_level cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ V4L2_MPEG_VIDEO_MPEG4_LEVEL_5 + 1 ] ;
