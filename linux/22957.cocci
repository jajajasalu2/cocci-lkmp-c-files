...
position p;
@@
 struct snd_seq_queue_timer * cocci_id@p ;
...
position p;
@@
 struct snd_seq_running_info * cocci_id@p ;
...
position p;
@@
 struct snd_seq_fifo * cocci_id@p ;
...
position p;
@@
 union {  int pversion ;  int client_id ;  struct snd_seq_system_info system_info ;  struct snd_seq_running_info running_info ;  struct snd_seq_client_info client_info ;  struct snd_seq_port_info port_info ;  struct snd_seq_port_subscribe port_subscribe ;  struct snd_seq_queue_info queue_info ;  struct snd_seq_queue_status queue_status ;  struct snd_seq_queue_tempo tempo ;  struct snd_seq_queue_timer queue_timer ;  struct snd_seq_queue_client queue_client ;  struct snd_seq_client_pool client_pool ;  struct snd_seq_remove_events remove_events ;  struct snd_seq_query_subs query_subs ; } cocci_id@p ;
...
position p;
@@
 struct snd_seq_system_info * cocci_id@p ;
...
position p;
@@
 struct snd_seq_addr cocci_id@p ;
...
position p;
@@
 struct snd_seq_client_pool * cocci_id@p ;
...
position p;
@@
 struct snd_seq_client_info * cocci_id@p ;
...
position p;
@@
 struct snd_seq_subscribers cocci_id@p ;
...
position p;
@@
 struct snd_seq_queue_client * cocci_id@p ;
...
position p;
@@
 const struct ioctl_handler * cocci_id@p ;
...
position p;
@@
 struct snd_seq_port_subs_info * cocci_id@p ;
...
position p;
@@
 struct snd_seq_query_subs * cocci_id@p ;
...
position p;
@@
 const struct ioctl_handler {  unsigned int cmd ;  int ( * func ) ( struct snd_seq_client * client , void * arg ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct snd_seq_remove_events * cocci_id@p ;
...
position p;
@@
 struct snd_seq_port_callback * cocci_id@p ;
...
position p;
@@
 struct snd_seq_queue * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_seq_client * client , struct snd_seq_event * event , int filter , int atomic , int hop ) ;
...
position p;
@@
 struct snd_seq_queue_info * cocci_id@p ;
...
position p;
@@
 struct snd_seq_port_info * cocci_id@p ;
...
position p;
@@
 struct snd_seq_usage * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_seq_client * client , struct snd_seq_event * event , int err , int atomic , int hop ) ;
...
position p;
@@
 struct snd_seq_event cocci_id@p ;
...
position p;
@@
 struct snd_seq_event_cell * cocci_id@p ;
...
position p;
@@
 struct snd_seq_client * cocci_id@p [ SNDRV_SEQ_MAX_CLIENTS ] ;
...
position p;
@@
 char cocci_id@p [ SNDRV_SEQ_MAX_CLIENTS ] ;
...
position p;
@@
 struct snd_seq_queue_tempo * cocci_id@p ;
...
position p;
@@
 struct snd_seq_queue_status * cocci_id@p ;
...
position p;
@@
 struct snd_seq_timer * cocci_id@p ;
...
position p;
@@
 struct snd_seq_client_port * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SNDRV_SEQ_GLOBAL_CLIENTS ] ;
...
position p;
@@
 struct snd_seq_user_client * cocci_id@p ;
...
position p;
@@
 struct snd_seq_client * cocci_id@p ;
...
position p;
@@
 struct snd_seq_port_subscribe * cocci_id@p ;
