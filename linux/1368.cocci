...
position p;
@@
 struct cdns3_device cocci_id@p ;
...
position p;
@@
 struct cdns3_aligned_buf * cocci_id@p ;
...
position p;
@@
 struct cdns3_request * cocci_id@p ;
...
position p;
@@
 struct cdns3_endpoint * cocci_id@p ;
...
position p;
@@
 struct cdns3_role_driver * cocci_id@p ;
