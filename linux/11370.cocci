...
typedef u8,u32;
@@
 const struct sii902x_sample_freq {  u32 freq ;  u8 val ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct sii902x {  struct i2c_client * i2c ;  struct regmap * regmap ;  struct drm_bridge bridge ;  struct drm_connector connector ;  struct gpio_desc * reset_gpio ;  struct i2c_mux_core * i2cmux ;  struct mutex mutex ;  struct sii902x_audio {  struct platform_device * pdev ;  struct clk * mclk ;  u32 i2s_fifo_sequence [ 4 ] ; } audio ; } cocci_id@p ;
...
position p;
@@
 const struct drm_bridge_timings cocci_id@p ;
