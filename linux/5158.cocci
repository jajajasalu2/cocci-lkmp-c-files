...
typedef u8;
@@
 struct idio_16_gpio_reg {  u8 out0_7 ;  u8 in0_7 ;  u8 irq_ctl ;  u8 filter_ctl ;  u8 out8_15 ;  u8 in8_15 ;  u8 irq_status ; } cocci_id@p ;
...
@@
 struct idio_16_gpio {  struct gpio_chip chip ;  raw_spinlock_t lock ;  struct idio_16_gpio_reg __iomem * reg ;  unsigned long irq_mask ; } cocci_id@p ;
...
position p;
@@
 struct idio_16_gpio * cocci_id@p ;
...
position p;
@@
 struct idio_16_gpio * constcocci_id ;
...
position p;
@@
 const char * cocci_id@p [ IDIO_16_NGPIO ] ;
