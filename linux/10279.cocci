...
position p;
@@
 struct cdn_dp_device cocci_id@p ;
...
position p;
@@
 union extcon_property_value cocci_id@p ;
...
typedef u8;
@@
 struct cdn_dp_data {  u8 max_phy ; } cocci_id@p ;
...
position p;
@@
 struct cdn_firmware_header * cocci_id@p ;
...
position p;
@@
 const struct cdn_firmware_header * cocci_id@p ;
