...
position p;
@@
 struct jack_gpio_tbl {  int count ;  struct snd_soc_jack * jack ;  struct snd_soc_jack_gpio * gpios ; } cocci_id@p ;
...
position p;
@@
 struct jack_gpio_tbl * cocci_id@p ;
...
position p;
@@
 struct snd_soc_jack_zone * cocci_id@p ;
