...
position p;
@@
 struct vmbus_channel_version_response cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct vmbus_channel * channel , u16 dev_type ) ;
...
position p;
@@
 struct vmbus_channel_gpadl_teardown * cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_offer_channel * cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_gpadl_created cocci_id@p ;
...
position p;
@@
 const struct vmbus_device cocci_id@p [ ] ;
...
position p;
@@
 struct vmbus_channel_gpadl_header * cocci_id@p ;
...
position p;
@@
 struct vmbuspipe_hdr cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_relid_released cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct vmbus_channel * ) ;
...
position p;
@@
 struct vmbus_channel_open_result cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_gpadl_torndown cocci_id@p ;
...
position p;
@@
 const struct vmbus_channel_message_table_entry cocci_id@p [ CHANNELMSG_COUNT ] ;
...
position p;
@@
 struct vmbus_channel_open_channel * cocci_id@p ;
...
position p;
@@
 struct icmsg_negotiate * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct vmbus_channel * new_sc ) ;
...
position p;
@@
 const struct vmbus_channel_offer_channel * cocci_id@p ;
