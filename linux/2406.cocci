...
position p;
@@
 struct mtk_hsdma_cb * cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_ring * cocci_id@p ;
...
position p;
@@
 const struct mtk_hsdma_soc cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_cb {  struct virt_dma_desc * vd ;  enum mtk_hsdma_vdesc_flag flag ; } cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_vdesc * cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_device * cocci_id@p ;
...
position p;
@@
 struct virt_dma_chan * cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_pchan * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct mtk_hsdma_vdesc {  struct virt_dma_desc vd ;  size_t len ;  size_t residue ;  dma_addr_t dest ;  dma_addr_t src ; } cocci_id@p ;
...
typedef bool;
@@
 struct mtk_hsdma_vchan {  struct virt_dma_chan vc ;  struct completion issue_completion ;  bool issue_synchronize ;  struct list_head desc_hw_processing ; } cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_vchan cocci_id@p ;
...
typedef atomic_t;
@@
 struct mtk_hsdma_pchan {  struct mtk_hsdma_ring ring ;  size_t sz_ring ;  atomic_t nr_free ; } cocci_id@p ;
...
typedef __le32;
@@
 struct mtk_hsdma_soc {  __le32 ddone ;  __le32 ls0 ; } cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_pdesc * cocci_id@p ;
...
position p;
@@
 enum mtk_hsdma_vdesc_flag { MTK_HSDMA_VDESC_FINISHED = 0x01 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,spinlock_t,refcount_t;
@@
 struct mtk_hsdma_device {  struct dma_device ddev ;  void __iomem * base ;  struct clk * clk ;  u32 irq ;  u32 dma_requests ;  struct mtk_hsdma_vchan * vc ;  struct mtk_hsdma_pchan * pc ;  refcount_t pc_refcnt ;  spinlock_t lock ;  const struct mtk_hsdma_soc * soc ; } cocci_id@p ;
...
@@
 struct mtk_hsdma_ring {  struct mtk_hsdma_pdesc * txd ;  struct mtk_hsdma_pdesc * rxd ;  struct mtk_hsdma_cb * cb ;  dma_addr_t tphys ;  dma_addr_t rphys ;  u16 cur_tptr ;  u16 cur_rptr ; } cocci_id@p ;
