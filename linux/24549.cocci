...
position p;
@@
 struct vmci_transport cocci_id@p ;
...
position p;
@@
 vmci_datagram_recv_cb cocci_id@p ;
...
position p;
@@
 struct vmci_transport_recv_pkt_info cocci_id@p ;
...
position p;
@@
 struct vmci_transport_recv_pkt_info {  struct work_struct work ;  struct sock * sk ;  struct vmci_transport_packet pkt ; } cocci_id@p ;
...
position p;
@@
 struct vmci_transport_waiting_info * cocci_id@p ;
...
position p;
@@
 struct vsock_transport_recv_notify_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * data , struct vmci_datagram * dg ) ;
...
typedef bool,u16;
@@
 bool cocci_id@p ( struct sock * sk , u16 * proto , bool old_pkt_proto ) ;
...
position p;
@@
 struct vmci_transport_send_notify_data * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( u32 sub_id , const struct vmci_event_data * ed , void * client_data ) ;
...
position p;
@@
 const struct vmci_event_data * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( bool * old_pkt_proto ) ;
...
position p;
@@
 int cocci_id@p ( struct sock * sk , struct sock * pending , struct vmci_transport_packet * pkt ) ;
...
position p;
@@
 enum vmci_transport_packet_type cocci_id@p ;
...
position p;
@@
 const struct vmci_event_payload_qp * cocci_id@p ;
...
position p;
@@
 struct vsock_transport_send_notify_data * cocci_id@p ;
...
position p;
@@
 struct vmci_transport_recv_notify_data * cocci_id@p ;
...
position p;
@@
 struct vmci_transport_packet * cocci_id@p ;
...
position p;
@@
 struct vsock_transport cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct vsock_sock * vsk ) ;
...
position p;
@@
 int cocci_id@p ( struct sock * sk , struct vmci_transport_packet * pkt ) ;
