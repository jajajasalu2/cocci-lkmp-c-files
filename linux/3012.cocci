...
position p;
@@
 const struct acpi_predefined_names * cocci_id@p ;
...
position p;
@@
 struct acpi_hp_work cocci_id@p ;
...
position p;
@@
 const struct acpi_debugger_ops * cocci_id@p ;
...
position p;
@@
 const struct resource * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ACPI_MAX_OVERRIDE_LEN ] ;
...
position p;
@@
 acpi_adr_space_type cocci_id@p ;
...
typedef u8,u32;
@@
 int ( * cocci_id@p ) ( u8 sleep_state , u32 val_a , u32 val_b ) ;
...
symbol cocci_id;
position p;
typedef acpi_cache_t;
@@
 acpi_cache_t * cocci_id@p ;
...
position p;
@@
 struct acpi_debugger cocci_id@p ;
...
position p;
@@
 struct acpi_ioremap * cocci_id@p ;
...
position p;
@@
 struct acpi_os_dpc {  acpi_osd_exec_callback function ;  void * context ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct acpi_generic_address * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( acpi_osd_exec_callback , void * ) ;
...
position p;
@@
 struct acpi_ioremap {  struct list_head list ;  void __iomem * virt ;  acpi_physical_address phys ;  acpi_size size ;  unsigned long refcount ; } cocci_id@p ;
...
typedef u8,u32;
@@
 int ( * cocci_id@p ) ( u8 sleep_state , u32 pm1a_ctrl , u32 pm1b_ctrl ) ;
...
typedef u32;
@@
 struct acpi_hp_work {  struct work_struct work ;  struct acpi_device * adev ;  u32 src ; } cocci_id@p ;
...
position p;
@@
 acpi_osd_exec_callback cocci_id@p ;
...
position p;
@@
 struct acpi_mem_space_context * * cocci_id@p ;
