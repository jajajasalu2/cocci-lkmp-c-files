...
position p;
@@
 struct { DECLARE_BITMAP ( bits , MAX_NR_CPUS ) 
		 ; } cocci_id@p ;
...
typedef cpumask_t;
@@
 struct topology {  cpumask_t * sib_core ;  int sib_core_nr ;  cpumask_t * sib_thr ;  int sib_thr_nr ; } cocci_id@p ;
