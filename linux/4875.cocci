...
position p;
@@
 enum fw_ri_wr_flags cocci_id@p ;
...
position p;
@@
 struct fw_ri_rdma_write_cmpl_wr * cocci_id@p ;
...
position p;
@@
 struct c4iw_create_qp_resp cocci_id@p ;
...
position p;
@@
 struct fw_ri_res_wr * cocci_id@p ;
...
position p;
@@
 struct fw_ri_immd_cmpl * cocci_id@p ;
...
position p;
@@
 struct c4iw_ucontext * cocci_id@p ;
...
position p;
@@
 struct fw_ri_fr_nsmr_tpte_wr * cocci_id@p ;
...
position p;
@@
 struct t4_srq_pending_wr * cocci_id@p ;
...
position p;
@@
 struct c4iw_create_srq_resp cocci_id@p ;
...
position p;
@@
 struct c4iw_mm_entry * cocci_id@p ;
...
position p;
@@
 struct terminate_message * cocci_id@p ;
...
position p;
@@
 struct c4iw_dev_ucontext * cocci_id@p ;
