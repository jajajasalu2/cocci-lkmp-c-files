...
position p;
@@
 struct modem_private_data * cocci_id@p ;
...
position p;
@@
 struct omap1_cam_platform_data cocci_id@p ;
...
position p;
@@
 struct omap_usb_config cocci_id@p ;
...
position p;
@@
 const struct omap_lcd_config cocci_id@p ;
...
position p;
@@
 struct omap_kp_platform_data cocci_id@p ;
...
position p;
@@
 struct modem_private_data {  struct regulator * regulator ; } cocci_id@p ;
