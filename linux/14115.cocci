...
position p;
@@
 const struct vsp1_format_info * cocci_id@p ;
...
position p;
@@
 struct vsp1_partition * cocci_id@p ;
...
position p;
@@
 struct vsp1_pipeline * cocci_id@p ;
...
position p;
@@
 struct vsp1_vb2_buffer * cocci_id@p ;
...
position p;
@@
 struct vsp1_partition_window cocci_id@p ;
...
position p;
@@
 struct media_entity_enum cocci_id@p ;
...
position p;
@@
 enum vsp1_pipeline_state cocci_id@p ;
