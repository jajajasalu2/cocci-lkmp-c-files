...
position p;
@@
 const struct NCR_700_Host_Parameters * cocci_id@p ;
...
position p;
@@
 struct NCR_700_SG_List * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct scsi_device * SDpnt , int depth ) ;
...
position p;
@@
 struct NCR_700_command_slot * cocci_id@p ;
...
position p;
@@
 struct NCR_700_Host_Parameters * cocci_id@p ;
...
position p;
@@
 struct NCR_700_Device_Parameters cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct scsi_device * SDpnt ) ;
...
position p;
@@
 void cocci_id@p ( struct Scsi_Host * host ) ;
...
position p;
@@
 enum NCR_700_Host_State cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * SCpnt ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_device * SDpnt ) ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * h , struct scsi_cmnd * ) ;
