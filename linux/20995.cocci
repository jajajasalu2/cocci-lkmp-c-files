...
position p;
@@
 struct wide_stack {  unsigned long arg0 ;  unsigned long arg1 ;  unsigned long arg2 ;  unsigned long arg3 ;  unsigned long arg4 ;  unsigned long arg5 ;  unsigned long arg6 ;  unsigned long arg7 ;  unsigned long arg8 ;  unsigned long arg9 ;  unsigned long arg10 ;  unsigned long arg11 ;  unsigned long arg12 ;  unsigned long arg13 ;  unsigned long frame_marker [ 2 ] ;  unsigned long sp ; } cocci_id@p ;
...
position p;
@@
 struct pdc_pat_cell_info_rtn_block cocci_id@p ;
...
position p;
@@
 struct pdc_pat_cell_mod_maddr_block cocci_id@p ;
...
position p;
@@
 struct pdc_pat_mem_phys_mem_location * cocci_id@p ;
...
position p;
@@
 struct pdc_memory_map * cocci_id@p ;
...
position p;
@@
 struct pdc_initiator * cocci_id@p ;
...
position p;
@@
 struct pdc_system_map_mod_info * cocci_id@p ;
...
position p;
@@
 struct pdc_btlb_info * cocci_id@p ;
...
position p;
@@
 struct pdc_pat_cell_num * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ NUM_PDC_RESULT ] ;
...
position p;
@@
 struct hardware_path * cocci_id@p ;
...
position p;
@@
 struct pdc_pat_mem_read_pd_retinfo * cocci_id@p ;
...
position p;
@@
 struct pdc_system_map_addr_info * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( unsigned long * , unsigned long * , unsigned long ) ;
...
position p;
@@
 struct pdc_chassis_info * cocci_id@p ;
...
position p;
@@
 struct narrow_stack {  unsigned int arg13 ;  unsigned int arg12 ;  unsigned int arg11 ;  unsigned int arg10 ;  unsigned int arg9 ;  unsigned int arg8 ;  unsigned int arg7 ;  unsigned int arg6 ;  unsigned int arg5 ;  unsigned int arg4 ;  unsigned int arg3 ;  unsigned int arg2 ;  unsigned int arg1 ;  unsigned int arg0 ;  unsigned int frame_marker [ 8 ] ;  unsigned int sp ; } cocci_id@p ;
...
position p;
@@
 struct pdc_module_path * cocci_id@p ;
...
position p;
@@
 struct pdc_pat_cpu_num * cocci_id@p ;
...
position p;
@@
 struct pdc_coproc_cfg * cocci_id@p ;
...
position p;
@@
 struct narrow_stack cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( unsigned long function , ... ) ;
...
position p;
@@
 struct pdc_pat_mem_retinfo * cocci_id@p ;
...
position p;
@@
 struct pdc_mem_read_pdt * cocci_id@p ;
...
position p;
@@
 struct pdc_mem_retinfo * cocci_id@p ;
...
position p;
@@
 struct pdc_pat_mem_cell_pdt_retinfo * cocci_id@p ;
...
position p;
@@
 struct pdc_memory_table_raddr * cocci_id@p ;
...
position p;
@@
 struct pdc_cache_info * cocci_id@p ;
...
position p;
@@
 struct pdc_memory_table * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( unsigned int * , unsigned int * , unsigned int ) ;
