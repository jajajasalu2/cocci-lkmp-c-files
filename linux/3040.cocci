...
position p;
@@
 struct intel_pmic_opregion {  struct mutex lock ;  struct acpi_lpat_conversion_table * lpat_table ;  struct regmap * regmap ;  struct intel_pmic_opregion_data * data ;  struct intel_pmic_regs_handler_ctx ctx ; } cocci_id@p ;
...
position p;
@@
 struct intel_pmic_opregion_data * cocci_id@p ;
...
typedef u16;
@@
 struct intel_pmic_regs_handler_ctx {  unsigned int val ;  u16 addr ; } cocci_id@p ;
...
position p;
@@
 struct intel_pmic_opregion * cocci_id@p ;
