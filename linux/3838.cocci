...
position p;
@@
 struct iproc_reqctx_s * cocci_id@p ;
...
position p;
@@
 struct spu_hash_export_s * cocci_id@p ;
...
position p;
@@
 struct spu_hash_parms cocci_id@p ;
...
position p;
@@
 struct spu_request_opts cocci_id@p ;
...
position p;
@@
 struct spu_cipher_parms cocci_id@p ;
...
position p;
@@
 struct spu_type_subtype cocci_id@p ;
...
position p;
@@
 struct spu_aead_parms cocci_id@p ;
...
position p;
@@
 enum spu_spu_subtype cocci_id@p ;
...
position p;
@@
 const struct iproc_reqctx_s * cocci_id@p ;
...
position p;
@@
 const struct spu_type_subtype * cocci_id@p ;
