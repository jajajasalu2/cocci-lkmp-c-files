...
position p;
@@
 struct xvip_dma_buffer {  struct vb2_v4l2_buffer buf ;  struct list_head queue ;  struct xvip_dma * dma ; } cocci_id@p ;
...
position p;
@@
 struct xvip_composite_device * cocci_id@p ;
...
position p;
@@
 struct xvip_dma_buffer cocci_id@p ;
...
position p;
@@
 struct xvip_pipeline * cocci_id@p ;
