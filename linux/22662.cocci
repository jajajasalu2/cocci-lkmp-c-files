...
position p;
@@
 struct sbus_dma_info * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sbus_dma_info {  spinlock_t lock ;  int dir ;  void __iomem * regs ; } cocci_id@p ;
...
position p;
@@
 struct cs4231_dma_control * cocci_id@p ;
...
position p;
@@
 struct ebus_dma_info * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ 14 ] ;
