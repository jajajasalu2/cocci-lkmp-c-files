...
position p;
@@
 struct panel_drv_data {  struct omap_dss_device dssdev ;  struct omap_dss_device * in ;  struct omap_video_timings videomode ;  int data_lines ;  int res_gpio ;  int qvga_gpio ;  struct spi_device * spi ; } cocci_id@p ;
...
position p;
@@
 const struct {  unsigned char addr ;  unsigned char dat ; } cocci_id@p [ ] ;
