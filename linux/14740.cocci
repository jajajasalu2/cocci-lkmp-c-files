...
position p;
@@
 struct clk_corediv_desc {  unsigned int mask ;  unsigned int offset ;  unsigned int fieldbit ; } cocci_id@p ;
...
position p;
@@
 const struct clk_corediv_desc cocci_id@p [ ] ;
...
position p;
@@
 const struct clk_corediv_soc_desc * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct clk_corediv {  struct clk_hw hw ;  void __iomem * reg ;  const struct clk_corediv_desc * desc ;  const struct clk_corediv_soc_desc * soc_desc ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u32;
@@
 struct clk_corediv_soc_desc {  const struct clk_corediv_desc * descs ;  unsigned int ndescs ;  const struct clk_ops ops ;  u32 ratio_reload ;  u32 enable_bit_offset ;  u32 ratio_offset ; } cocci_id@p ;
