...
typedef s32;
@@
 s32 cocci_id@p [ RATE_COUNT_3945 ] ;
...
position p;
@@
 struct il3945_tpt_entry * cocci_id@p ;
...
typedef s8,u8;
@@
 struct il3945_tpt_entry {  s8 min_rssi ;  u8 idx ; } cocci_id@p ;
...
position p;
@@
 struct il3945_rs_sta * cocci_id@p ;
...
position p;
@@
 struct il3945_rate_scale_data * cocci_id@p ;
