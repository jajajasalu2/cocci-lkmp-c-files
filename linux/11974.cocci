...
position p;
@@
 struct nv50_disp_root * cocci_id@p ;
...
position p;
@@
 union {  struct nv50_disp_sor_dp_mst_vcpi_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nv50_disp_sor_dp_mst_link_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nv50_disp_root_func * cocci_id@p ;
...
position p;
@@
 union {  struct nv50_disp_mthd_v0 v0 ;  struct nv50_disp_mthd_v1 v1 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nv50_disp_dac_load_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nv50_disp_user * cocci_id@p ;
...
position p;
@@
 union {  struct nv50_disp_sor_lvds_script_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nv50_disp_sor_hda_eld_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nv50_disp_acquire_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nv50_disp_sor_hdmi_pwr_v0 v0 ; } * cocci_id@p ;
