...
position p;
@@
 enum direction { OUT , IN , } cocci_id@p ;
...
position p;
@@
 struct libmnt_context * cocci_id@p ;
...
position p;
@@
 struct libmnt_table * cocci_id@p ;
