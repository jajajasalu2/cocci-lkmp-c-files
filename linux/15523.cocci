...
position p;
@@
 struct siox_gpio_ddata * cocci_id@p ;
...
position p;
@@
 struct siox_gpio_ddata {  struct gpio_desc * din ;  struct gpio_desc * dout ;  struct gpio_desc * dclk ;  struct gpio_desc * dld ; } cocci_id@p ;
