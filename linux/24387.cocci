...
position p;
@@
 struct a2mp_cmd_rej * cocci_id@p ;
...
position p;
@@
 struct a2mp_amp_assoc_req cocci_id@p ;
...
position p;
@@
 struct a2mp_amp_assoc_rsp * cocci_id@p ;
...
position p;
@@
 struct a2mp_discov_req * cocci_id@p ;
...
position p;
@@
 struct a2mp_info_req cocci_id@p ;
...
position p;
@@
 struct a2mp_info_rsp * cocci_id@p ;
...
position p;
@@
 struct a2mp_physlink_req * cocci_id@p ;
...
position p;
@@
 struct a2mp_discov_rsp * cocci_id@p ;
...
position p;
@@
 struct a2mp_physlink_rsp cocci_id@p ;
