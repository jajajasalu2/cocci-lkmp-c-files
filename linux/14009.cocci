...
position p;
@@
 const struct mceusb_model cocci_id@p [ ] ;
...
typedef u32;
@@
 struct mceusb_model {  u32 mce_gen1 : 1 ;  u32 mce_gen2 : 1 ;  u32 mce_gen3 : 1 ;  u32 tx_mask_normal : 1 ;  u32 no_tx : 1 ;  u32 broken_irtimeout : 1 ;  u32 rx2 ;  int ir_intfnum ;  const char * rc_map ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 enum mceusb_model_type { MCE_GEN2 = 0 , MCE_GEN1 , MCE_GEN3 , MCE_GEN3_BROKEN_IRTIMEOUT , MCE_GEN2_TX_INV , MCE_GEN2_TX_INV_RX_GOOD , POLARIS_EVK , CX_HYBRID_TV , MULTIFUNCTION , TIVO_KIT , MCE_GEN2_NO_TX , HAUPPAUGE_CX_HYBRID_TV , EVROMEDIA_FULL_HYBRID_FULLHD , ASTROMETA_T2HYBRID , } cocci_id@p ;
...
position p;
@@
 enum mceusb_model_type cocci_id@p ;
