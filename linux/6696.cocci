...
position p;
@@
 struct qla8044_minidump_entry_rdocm * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_rddfe * cocci_id@p ;
...
position p;
@@
 struct qla8044_reset_entry_hdr * cocci_id@p ;
...
position p;
@@
 struct qla8044_pex_dma_descriptor cocci_id@p ;
...
position p;
@@
 struct qla8044_reset_template_hdr * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_template_hdr * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_pollwr * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_rdmem_pex_dma * cocci_id@p ;
...
position p;
@@
 struct qla8044_poll cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_rdmdio * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_pollrd * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_rdmux2 * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_queue * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_pollrdmwr * cocci_id@p ;
...
position p;
@@
 struct qla8044_quad_entry * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_rdrom * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_mux * cocci_id@p ;
...
position p;
@@
 struct qla8044_entry * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_hdr * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_cache * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_crb * cocci_id@p ;
...
position p;
@@
 struct qla8044_minidump_entry_rdmem * cocci_id@p ;
