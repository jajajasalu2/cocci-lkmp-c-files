...
position p;
@@
 struct acpi_madt_local_sapic * cocci_id@p ;
...
position p;
@@
 struct acpi_table_madt cocci_id@p ;
...
position p;
@@
 struct acpi_subtable_proc cocci_id@p ;
...
position p;
@@
 struct acpi_madt_io_apic * cocci_id@p ;
...
position p;
@@
 struct acpi_madt_local_apic_nmi * cocci_id@p ;
...
position p;
@@
 struct acpi_madt_local_x2apic * cocci_id@p ;
...
position p;
@@
 struct acpi_madt_local_x2apic_nmi * cocci_id@p ;
...
position p;
@@
 struct acpi_subtable_entry * cocci_id@p ;
...
position p;
@@
 struct acpi_subtable_entry {  union acpi_subtable_headers * hdr ;  enum acpi_subtable_type type ; } cocci_id@p ;
...
position p;
@@
 struct acpi_madt_interrupt_source * cocci_id@p ;
...
position p;
@@
 enum acpi_subtable_type { ACPI_SUBTABLE_COMMON , ACPI_SUBTABLE_HMAT , } cocci_id@p ;
...
position p;
@@
 struct acpi_madt_interrupt_override * cocci_id@p ;
...
position p;
@@
 acpi_tbl_table_handler cocci_id@p ;
...
position p;
@@
 struct acpi_madt_io_sapic * cocci_id@p ;
...
position p;
@@
 struct acpi_madt_local_apic_override * cocci_id@p ;
...
position p;
@@
 struct acpi_madt_nmi_source * cocci_id@p ;
...
position p;
@@
 struct acpi_madt_local_apic * cocci_id@p ;
