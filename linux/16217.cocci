...
position p;
@@
 void cocci_id@p ( unsigned int set , unsigned int clear ) ;
...
position p;
@@
 struct spk_ldisc_data cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct spk_synth * in_synth , const char ch ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct spk_synth * in_synth , u16 ch ) ;
...
typedef bool;
@@
 struct spk_ldisc_data {  char buf ;  struct completion completion ;  bool buf_free ; } cocci_id@p ;
