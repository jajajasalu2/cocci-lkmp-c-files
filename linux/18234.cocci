...
symbol cocci_id;
position p;
typedef mini2440_features_t;
@@
 struct mini2440_features_t * cocci_id@p ;
...
position p;
@@
 struct s3c24xx_uda134x_platform_data cocci_id@p ;
...
position p;
@@
 struct uda134x_platform_data cocci_id@p ;
...
position p;
@@
 struct s3c24xx_led_platdata cocci_id@p ;
...
typedef mini2440_features_t;
@@
 struct mini2440_features_t {  int count ;  int done ;  int lcd_index ;  struct platform_device * optional [ 8 ] ; } cocci_id@p ;
