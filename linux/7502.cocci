...
position p;
@@
 void cocci_id@p ( struct tmds_chip_information * tmds_chip , struct tmds_setting_information * tmds_setting ) ;
...
position p;
@@
 struct tmds_chip_information * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( int index , u8 * buff , int buff_len ) ;
...
position p;
@@
 struct tmds_setting_information * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( int index , u8 data ) ;
