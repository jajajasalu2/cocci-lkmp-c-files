...
position p;
@@
 struct carmine_resolution cocci_id@p [ ] ;
...
typedef u32;
@@
 struct carmine_fb {  void __iomem * display_reg ;  void __iomem * screen_base ;  u32 smem_offset ;  u32 cur_mode ;  u32 new_mode ;  struct carmine_resolution * res ;  u32 pseudo_palette [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 const struct carmine_fb * cocci_id@p ;
...
typedef u32;
@@
 struct carmine_resolution {  u32 htp ;  u32 hsp ;  u32 hsw ;  u32 hdp ;  u32 vtr ;  u32 vsp ;  u32 vsw ;  u32 vdp ;  u32 disp_mode ; } cocci_id@p ;
...
position p;
@@
 const struct carmine_hw * cocci_id@p ;
...
position p;
@@
 struct carmine_hw {  void __iomem * v_regs ;  void __iomem * screen_mem ;  struct fb_info * fb [ MAX_DISPLAY ] ; } cocci_id@p ;
