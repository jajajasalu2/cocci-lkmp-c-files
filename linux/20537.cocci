...
typedef u8;
@@
 u8 cocci_id@p [ DES3_EDE_BLOCK_SIZE ] ;
...
position p;
@@
 struct des3_ede_x86_ctx cocci_id@p ;
...
typedef u8,u32;
@@
 void cocci_id@p ( const u32 * expkey , u8 * dst , const u8 * src ) ;
...
position p;
@@
 struct des3_ede_x86_ctx {  struct des3_ede_ctx enc ;  struct des3_ede_ctx dec ; } cocci_id@p ;
