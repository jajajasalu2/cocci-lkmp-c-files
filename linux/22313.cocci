...
position p;
@@
 union aa_buffer {  struct list_head list ;  char buffer [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( char * buffer , const struct kernel_param * kp ) ;
