...
position p;
@@
 struct ath9k_htc_rxbuf cocci_id@p ;
...
position p;
@@
 struct wmi_event_txstatus * cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_tx_event cocci_id@p ;
...
position p;
@@
 struct ath_htc_rx_status * cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_tx_ctl * cocci_id@p ;
