...
position p;
@@
 enum xirc_rsr { PhyPkt = 0x01 , BrdcstPkt = 0x02 , PktTooLong = 0x04 , AlignErr = 0x10 , CRCErr = 0x20 , PktRxOk = 0x80 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned int ioaddr ) ;
...
position p;
@@
 enum xirc_cmd { Transmit = 0x01 , EnableRecv = 0x04 , DisableRecv = 0x08 , Abort = 0x10 , Online = 0x20 , IntrAck = 0x40 , Offline = 0x80 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned int ioaddr , unsigned data , int len ) ;
...
position p;
@@
 struct set_address_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int full ) ;
...
position p;
@@
 struct set_address_info {  int reg_nr ;  int page_nr ;  int mohawk ;  unsigned int ioaddr ; } cocci_id@p ;
...
position p;
@@
 struct local_info {  struct net_device * dev ;  struct pcmcia_device * p_dev ;  int card_type ;  int probe_port ;  int silicon ;  int mohawk ;  int dingo ;  int new_mii ;  int modem ;  void __iomem * dingo_ccr ;  unsigned last_ptr_value ;  const char * manf_str ;  struct work_struct tx_timeout_task ; } cocci_id@p ;
...
position p;
@@
 enum xirc_isr { TxBufOvr = 0x01 , PktTxed = 0x02 , MACIntr = 0x04 , TxResGrant = 0x08 , RxFullPkt = 0x20 , RxPktRej = 0x40 , ForcedIntr = 0x80 , } cocci_id@p ;
...
position p;
@@
 enum xirc_ecr { FullDuplex = 0x04 , LongTPMode = 0x08 , DisablePolCor = 0x10 , DisableLinkPulse = 0x20 , DisableAutoTx = 0x40 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , struct ifmap * map ) ;
...
position p;
@@
 void cocci_id@p ( struct pcmcia_device * link ) ;
...
typedef u_char;
@@
 void cocci_id@p ( unsigned int ioaddr , u_char phyaddr , u_char phyreg , unsigned data , int len ) ;
...
position p;
@@
 void cocci_id@p ( unsigned int ioaddr , unsigned data ) ;
...
position p;
@@
 enum xirc_esr { FullPktRcvd = 0x01 , PktRejected = 0x04 , TxPktPend = 0x08 , IncorPolarity = 0x10 , MediaSelect = 0x20 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned int ioaddr ) ;
...
typedef u_char;
@@
 unsigned cocci_id@p ( unsigned int ioaddr , u_char phyaddr , u_char phyreg ) ;
...
position p;
@@
 enum xirc_cr { TransmitPacket = 0x01 , SoftReset = 0x02 , EnableIntr = 0x04 , ForceIntr = 0x08 , ClearTxFIFO = 0x10 , ClearRxOvrun = 0x20 , RestartTx = 0x40 , } cocci_id@p ;
