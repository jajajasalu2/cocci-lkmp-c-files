...
position p;
@@
 void ( * cocci_id@p ) ( struct atmel_i2c_work_data * work_data , void * areq , int status ) ;
...
typedef u8;
@@
 const struct {  u8 value ;  const char * error_text ; } cocci_id@p [ ] ;
