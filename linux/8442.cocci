...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int cmd ) ;
...
position p;
@@
 void cocci_id@p ( unsigned int ioaddr , int bits ) ;
...
position p;
@@
 enum elxl_status { IntLatch = 0x0001 , AdapterFailure = 0x0002 , TxComplete = 0x0004 , TxAvailable = 0x0008 , RxComplete = 0x0010 , RxEarly = 0x0020 , IntReq = 0x0040 , StatsFull = 0x0080 , CmdBusy = 0x1000 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned int ioaddr , int phy_id , int location , int value ) ;
...
position p;
@@
 unsigned short cocci_id@p ( unsigned int ioaddr , int index ) ;
...
position p;
@@
 enum Window4 { Wn4_FIFODiag = 4 , Wn4_NetDiag = 6 , Wn4_PhysicalMgmt = 8 , Wn4_Media = 10 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned int ioaddr , int phy_id , int location ) ;
...
position p;
@@
 enum Win0_EEPROM_cmds { EEPROM_Read = 0x200 , EEPROM_WRITE = 0x100 , EEPROM_ERASE = 0x300 , EEPROM_EWENB = 0x30 , EEPROM_EWDIS = 0x00 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int worklimit ) ;
...
position p;
@@
 enum Window1 { TX_FIFO = 0x10 , RX_FIFO = 0x10 , RxErrors = 0x14 , RxStatus = 0x18 , Timer = 0x1A , TxStatus = 0x1B , TxFree = 0x0C , RunnerRdCtrl = 0x16 , RunnerWrCtrl = 0x1c , } cocci_id@p ;
...
position p;
@@
 enum Window0 { Wn0EepromCmd = 10 , Wn0EepromData = 12 , IntrStatus = 0x0E , } cocci_id@p ;
