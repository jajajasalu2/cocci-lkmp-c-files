...
position p;
@@
 enum raydium_bl_ack { RAYDIUM_ACK_NULL = 0 , RAYDIUM_WAIT_READY , RAYDIUM_PATH_READY , } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct raydium_info {  __le32 hw_ver ;  u8 main_ver ;  u8 sub_ver ;  __le16 ft_ver ;  u8 x_num ;  u8 y_num ;  __le16 x_max ;  __le16 y_max ;  u8 x_res ;  u8 y_res ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct raydium_data_info {  __le32 data_bank_addr ;  u8 pkg_size ;  u8 tp_info_size ; } cocci_id@p ;
...
position p;
@@
 struct raydium_data * cocci_id@p ;
...
position p;
@@
 enum raydium_bl_cmd { BL_HEADER = 0 , BL_PAGE_STR , BL_PKG_IDX , BL_DATA_STR , } cocci_id@p ;
...
position p;
@@
 struct raydium_data_info cocci_id@p ;
...
position p;
@@
 enum raydium_bl_ack cocci_id@p ;
...
position p;
@@
 enum raydium_boot_mode { RAYDIUM_TS_MAIN = 0 , RAYDIUM_TS_BLDR , } cocci_id@p ;
