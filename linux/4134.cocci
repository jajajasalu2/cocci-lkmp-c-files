...
position p;
@@
 struct exynos_dp_video_phy * cocci_id@p ;
...
position p;
@@
 const struct exynos_dp_video_phy_drvdata cocci_id@p ;
...
typedef u32;
@@
 struct exynos_dp_video_phy_drvdata {  u32 phy_ctrl_offset ; } cocci_id@p ;
...
position p;
@@
 struct exynos_dp_video_phy {  struct regmap * regs ;  const struct exynos_dp_video_phy_drvdata * drvdata ; } cocci_id@p ;
