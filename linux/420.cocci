...
position p;
@@
 struct vgic_register_region cocci_id@p [ ] ;
...
position p;
@@
 const struct vgic_its_abi cocci_id@p [ ] ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct vgic_its * its , u32 id , void * entry , void * opaque ) ;
...
position p;
@@
 struct vgic_its_abi {  int cte_esz ;  int dte_esz ;  int ite_esz ;  int ( * save_tables ) ( struct vgic_its * its ) ;  int ( * restore_tables ) ( struct vgic_its * its ) ;  int ( * commit ) ( struct vgic_its * its ) ; } cocci_id@p ;
...
position p;
@@
 struct vgic_translation_cache_entry * cocci_id@p ;
...
position p;
@@
 struct vgic_io_device * cocci_id@p ;
...
typedef u32;
@@
 struct its_collection {  struct list_head coll_list ;  u32 collection_id ;  u32 target_addr ; } cocci_id@p ;
...
typedef u32,gpa_t;
@@
 struct its_device {  struct list_head dev_list ;  struct list_head itt_head ;  u32 num_eventid_bits ;  gpa_t itt_addr ;  u32 device_id ; } cocci_id@p ;
...
typedef u32;
@@
 struct its_ite {  struct list_head ite_list ;  struct vgic_irq * irq ;  struct its_collection * collection ;  u32 event_id ; } cocci_id@p ;
...
@@
 struct vgic_translation_cache_entry {  struct list_head entry ;  phys_addr_t db ;  u32 devid ;  u32 eventid ;  struct vgic_irq * irq ; } cocci_id@p ;
...
position p;
@@
 const struct vgic_register_region * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vgic_its * its ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct kvm * kvm , struct vgic_irq * irq , struct kvm_vcpu * filter_vcpu , bool needs_inv ) ;
