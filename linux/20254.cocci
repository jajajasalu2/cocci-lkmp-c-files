...
position p;
@@
 struct ev7_pal_subpacket * cocci_id@p ;
...
position p;
@@
 struct el_subpacket_annotation cocci_id@p [ ] ;
...
position p;
@@
 struct el_subpacket_handler cocci_id@p ;
...
position p;
@@
 struct ev7_lf_subpackets * cocci_id@p ;
...
position p;
@@
 struct ev7_pal_rbox_subpacket * cocci_id@p ;
...
position p;
@@
 struct ev7_pal_logout_subpacket * cocci_id@p ;
...
position p;
@@
 struct ev7_pal_zbox_subpacket * cocci_id@p ;
...
position p;
@@
 struct ev7_pal_io_subpacket * cocci_id@p ;
...
position p;
@@
 struct ev7_pal_processor_subpacket * cocci_id@p ;
...
position p;
@@
 struct ev7_pal_environmental_subpacket * cocci_id@p ;
...
position p;
@@
 struct el_subpacket * cocci_id@p ;
