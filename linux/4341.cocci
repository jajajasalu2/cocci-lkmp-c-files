...
@@
 struct raw32_config_request {  compat_int_t raw_minor ;  compat_u64 block_major ;  compat_u64 block_minor ; } cocci_id@p ;
...
position p;
@@
 struct raw_config_request cocci_id@p ;
...
position p;
@@
 struct raw32_config_request cocci_id@p ;
...
position p;
@@
 struct raw_device_data * cocci_id@p ;
...
position p;
@@
 struct raw_device_data {  struct block_device * binding ;  int inuse ; } cocci_id@p ;
