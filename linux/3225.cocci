...
typedef u8;
@@
 u8 cocci_id@p [ CFFPS_INPUT_HISTORY_SIZE + 1 ] ;
...
position p;
@@
 char cocci_id@p [ I2C_SMBUS_BLOCK_MAX ] ;
...
typedef u8;
@@
 struct ibm_cffps_input_history {  struct mutex update_lock ;  unsigned long last_update ;  u8 byte_count ;  u8 data [ CFFPS_INPUT_HISTORY_SIZE ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct ibm_cffps {  enum versions version ;  struct i2c_client * client ;  struct ibm_cffps_input_history input_history ;  int debugfs_entries [ CFFPS_DEBUGFS_NUM_ENTRIES ] ;  char led_name [ 32 ] ;  u8 led_state ;  struct led_classdev led ; } cocci_id@p ;
...
position p;
@@
 enum { CFFPS_DEBUGFS_INPUT_HISTORY = 0 , CFFPS_DEBUGFS_FRU , CFFPS_DEBUGFS_PN , CFFPS_DEBUGFS_SN , CFFPS_DEBUGFS_CCIN , CFFPS_DEBUGFS_FW , CFFPS_DEBUGFS_NUM_ENTRIES , } cocci_id@p ;
...
position p;
@@
 struct pmbus_platform_data cocci_id@p ;
...
position p;
@@
 enum versions { cffps1 , cffps2 , cffps_unknown , } cocci_id@p ;
