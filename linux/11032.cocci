...
position p;
@@
 int cocci_id@p ( struct device_queue_manager * dqm , unsigned int pasid , unsigned int vmid ) ;
...
position p;
@@
 struct qcm_process_device * cocci_id@p ;
...
position p;
@@
 struct device_queue_manager * cocci_id@p ;
...
position p;
@@
 struct scheduling_resources cocci_id@p ;
...
position p;
@@
 struct device_process_node * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct device_queue_manager * dqm ) ;
...
position p;
@@
 struct kernel_queue * cocci_id@p ;
...
position p;
@@
 enum kfd_queue_type cocci_id@p ;
...
position p;
@@
 enum kfd_unmap_queues_filter cocci_id@p ;
...
position p;
@@
 const struct packet_manager_funcs * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct device_queue_manager * dqm , struct queue * q ) ;
...
position p;
@@
 void cocci_id@p ( struct device_queue_manager * dqm , struct queue * q ) ;
