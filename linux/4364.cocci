...
position p;
@@
 struct ipmb_request_elem * cocci_id@p ;
...
@@
 struct ipmb_dev {  struct i2c_client * client ;  struct miscdevice miscdev ;  struct ipmb_msg request ;  struct list_head request_queue ;  atomic_t request_queue_len ;  size_t msg_idx ;  spinlock_t lock ;  wait_queue_head_t wait_queue ;  struct mutex file_mutex ; } cocci_id@p ;
...
position p;
@@
 enum i2c_slave_event cocci_id@p ;
...
position p;
@@
 struct ipmb_request_elem {  struct list_head list ;  struct ipmb_msg request ; } cocci_id@p ;
