...
typedef u8,s32,u32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 subcmd , u8 * addr ) ;
...
symbol cocci_id;
position p;
typedef s32,bool,u16;
@@
 s32 cocci_id@p ( struct e1000_hw * , u16 , bool ) ;
...
position p;
@@
 struct e1000_mbx_info * cocci_id@p ;
...
typedef u8,u32;
@@
 void cocci_id@p ( struct e1000_hw * hw , u8 * , u32 , u32 , u32 ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( struct e1000_hw * , u8 * , u32 ) ;
...
typedef s32,u16;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u16 * speed , u16 * duplex ) ;
