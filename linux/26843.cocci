...
position p;
@@
 reiserfs_acl_header cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct reiserfs_transaction_handle * th , struct inode * inode , int type , struct posix_acl * acl ) ;
