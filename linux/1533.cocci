...
position p;
@@
 struct find_interface_arg cocci_id@p ;
...
position p;
@@
 struct find_interface_arg {  int minor ;  struct device_driver * drv ; } cocci_id@p ;
...
position p;
@@
 const struct find_interface_arg * cocci_id@p ;
...
position p;
@@
 struct each_dev_arg {  void * data ;  int ( * fn ) ( struct usb_device * , void * ) ; } cocci_id@p ;
...
position p;
@@
 struct each_dev_arg * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct usb_device * , void * ) ;
...
position p;
@@
 const struct usb_interface * cocci_id@p ;
