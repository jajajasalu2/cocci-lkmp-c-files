...
position p;
@@
 struct ocxl_process_element cocci_id@p ;
...
typedef u64;
@@
 struct spa {  struct ocxl_process_element * spa_mem ;  int spa_order ;  struct mutex spa_lock ;  struct radix_tree_root pe_tree ;  char * irq_name ;  int virq ;  void __iomem * reg_dsisr ;  void __iomem * reg_dar ;  void __iomem * reg_tfc ;  void __iomem * reg_pe_handle ;  struct xsl_fault {  struct work_struct fault_work ;  u64 pe ;  u64 dsisr ;  u64 dar ;  struct pe_data pe_data ; } xsl_fault ; } cocci_id@p ;
...
typedef atomic_t;
@@
 struct ocxl_link {  struct list_head list ;  struct kref ref ;  int domain ;  int bus ;  int dev ;  atomic_t irq_available ;  struct spa * spa ;  void * platform_data ; } cocci_id@p ;
...
typedef u64;
@@
 void ( * cocci_id@p ) ( void * data , u64 addr , u64 dsisr ) ;
...
position p;
@@
 enum xsl_response { CONTINUE , ADDRESS_ERROR , RESTART , } cocci_id@p ;
