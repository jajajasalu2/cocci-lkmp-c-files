...
position p;
@@
 struct ncsi_oem_gma_handler {  unsigned int mfr_id ;  int ( * handler ) ( struct ncsi_cmd_arg * nca ) ; } cocci_id@p [ ] ;
...
position p;
@@
 unsigned char cocci_id@p [ NCSI_OEM_BCM_CMD_GMA_LEN ] ;
...
typedef u8,u32;
@@
 union {  u8 data_u8 [ NCSI_OEM_MLX_CMD_GMA_LEN ] ;  u32 data_u32 [ NCSI_OEM_MLX_CMD_GMA_LEN / sizeof ( u32 ) ] ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ncsi_dev * ndev ) ;
...
position p;
@@
 struct ncsi_oem_gma_handler * cocci_id@p ;
