...
position p;
@@
 enum _iaq_buffer_state { IAQ_BUFFER_EMPTY = 0 , IAQ_BUFFER_DEFAULT_VALS , IAQ_BUFFER_VALID , } cocci_id@p ;
...
position p;
@@
 enum sgpc3_channel_idx { SGPC3_IAQ_TVOC_IDX = 10 , SGPC3_SIG_ETOH_IDX , } cocci_id@p ;
...
position p;
@@
 const struct sgp_device cocci_id@p [ ] ;
...
position p;
@@
 struct sgp_device {  const struct iio_chan_spec * channels ;  int num_channels ; } cocci_id@p ;
...
position p;
@@
 const struct sgp_version cocci_id@p [ ] ;
...
position p;
@@
 const struct sgp_data * cocci_id@p ;
...
position p;
@@
 struct sgp_crc_word * cocci_id@p ;
...
position p;
@@
 enum sgp_product_id { SGP30 = 0 , SGPC3 , } cocci_id@p ;
...
position p;
@@
 enum sgp30_channel_idx { SGP30_IAQ_TVOC_IDX = 0 , SGP30_IAQ_CO2EQ_IDX , SGP30_SIG_ETOH_IDX , SGP30_SIG_H2_IDX , } cocci_id@p ;
...
typedef u8;
@@
 union sgp_reading {  u8 start ;  struct sgp_crc_word raw_words [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 enum sgp_cmd { SGP_CMD_IAQ_INIT = SGP_CMD ( 0x2003 ) , SGP_CMD_IAQ_MEASURE = SGP_CMD ( 0x2008 ) , SGP_CMD_GET_FEATURE_SET = SGP_CMD ( 0x202f ) , SGP_CMD_GET_SERIAL_ID = SGP_CMD ( 0x3682 ) , SGP30_CMD_MEASURE_SIGNAL = SGP_CMD ( 0x2050 ) , SGPC3_CMD_MEASURE_RAW = SGP_CMD ( 0x2046 ) , } cocci_id@p ;
...
typedef u8;
@@
 struct sgp_version {  u8 major ;  u8 minor ; } cocci_id@p ;
