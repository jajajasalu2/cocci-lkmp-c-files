...
position p;
@@
 struct arizona_micsupp {  struct regulator_dev * regulator ;  struct regmap * regmap ;  struct snd_soc_dapm_context * * dapm ;  unsigned int enable_reg ;  struct device * dev ;  struct regulator_consumer_supply supply ;  struct regulator_init_data init_data ;  struct work_struct check_cp_work ; } cocci_id@p ;
...
position p;
@@
 struct arizona_micsupp_pdata * cocci_id@p ;
...
position p;
@@
 struct arizona_micsupp * cocci_id@p ;
