...
symbol cocci_id;
position p;
typedef async_func_t,async_cookie_t;
@@
 struct async_entry {  struct list_head domain_list ;  struct list_head global_list ;  struct work_struct work ;  async_cookie_t cookie ;  async_func_t func ;  void * data ;  struct async_domain * domain ; } cocci_id@p ;
...
position p;
@@
 struct async_domain * cocci_id@p ;
