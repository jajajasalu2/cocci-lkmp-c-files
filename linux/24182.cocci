...
position p;
@@
 const struct ipv6_txoptions * cocci_id@p ;
...
position p;
@@
 const struct tlvtype_proc * cocci_id@p ;
...
typedef bool;
@@
 struct tlvtype_proc {  int type ;  bool ( * func ) ( struct sk_buff * skb , int offset ) ; } cocci_id@p ;
