...
position p;
@@
 struct mtk_thermal_bank {  struct mtk_thermal * mt ;  int id ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_thermal_data * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ MT2701_NUM_CONTROLLER ] ;
...
position p;
@@
 const int cocci_id@p [ MT8183_NUM_SENSORS_PER_ZONE ] ;
...
position p;
@@
 const int cocci_id@p [ MT2712_NUM_SENSORS ] ;
...
position p;
@@
 enum { VTS1 , VTS2 , VTS3 , VTS4 , VTS5 , VTSABB , MAX_NUM_VTS , } cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ MT7622_NUM_SENSORS ] ;
...
position p;
@@
 const int cocci_id@p [ MT8173_NUM_SENSORS_PER_ZONE ] ;
...
position p;
@@
 struct thermal_bank_cfg {  unsigned int num_sensors ;  const int * sensors ; } cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ MT8173_NUM_SENSORS ] ;
...
position p;
@@
 const int cocci_id@p [ MT7622_NUM_SENSORS_PER_ZONE ] ;
...
position p;
@@
 const int cocci_id@p [ MT8183_NUM_CONTROLLER ] ;
...
position p;
@@
 const int cocci_id@p [ MT8173_NUM_ZONES ] [ 3 ] ;
...
position p;
@@
 const int cocci_id@p [ MT2712_NUM_SENSORS_PER_ZONE ] ;
...
position p;
@@
 const int cocci_id@p [ MT2712_NUM_CONTROLLER ] ;
...
position p;
@@
 const int cocci_id@p [ MT2701_NUM_SENSORS ] ;
...
position p;
@@
 const int cocci_id@p [ MT2701_NUM_SENSORS_PER_ZONE ] ;
...
position p;
@@
 const int cocci_id@p [ MT8183_NUM_SENSORS ] ;
...
position p;
@@
 const int cocci_id@p [ MT8173_NUM_CONTROLLER ] ;
...
position p;
@@
 const int cocci_id@p [ MT7622_NUM_CONTROLLER ] ;
...
position p;
@@
 struct mtk_thermal_bank * cocci_id@p ;
...
typedef s32;
@@
 struct mtk_thermal {  struct device * dev ;  void __iomem * thermal_base ;  struct clk * clk_peri_therm ;  struct clk * clk_auxadc ;  struct mutex lock ;  s32 adc_ge ;  s32 degc_cali ;  s32 o_slope ;  s32 vts [ MAX_NUM_VTS ] ;  const struct mtk_thermal_data * conf ;  struct mtk_thermal_bank banks [ MAX_NUM_ZONES ] ; } cocci_id@p ;
