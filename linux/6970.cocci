...
position p;
@@
 struct sti_channel {  struct sti_mbox_device * mdev ;  unsigned int instance ;  unsigned int channel ; } cocci_id@p ;
...
position p;
@@
 struct sti_mbox_pdata * cocci_id@p ;
...
position p;
@@
 const struct sti_mbox_pdata cocci_id@p ;
...
position p;
@@
 struct sti_mbox_pdata {  unsigned int num_inst ;  unsigned int num_chan ; } cocci_id@p ;
...
@@
 struct sti_mbox_device {  struct device * dev ;  struct mbox_controller * mbox ;  void __iomem * base ;  const char * name ;  u32 enabled [ STI_MBOX_INST_MAX ] ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct sti_mbox_device * cocci_id@p ;
