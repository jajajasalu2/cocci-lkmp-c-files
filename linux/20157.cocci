...
position p;
@@
 struct alchemy_auxpll_clk * cocci_id@p ;
...
position p;
@@
 struct alchemy_auxpll_clk {  struct clk_hw hw ;  unsigned long reg ;  int maxmult ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct alchemy_fgcs_clk {  struct clk_hw hw ;  spinlock_t * reglock ;  unsigned long reg ;  int shift ;  int parent ;  int isen ;  int * dt ; } cocci_id@p ;
...
position p;
@@
 struct alchemy_fgcs_clk * cocci_id@p ;
...
position p;
@@
 struct clk_aliastable * cocci_id@p ;
