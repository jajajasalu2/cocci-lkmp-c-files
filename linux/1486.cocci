...
position p;
@@
 struct hidg_func_descriptor * cocci_id@p ;
...
position p;
@@
 struct hidg_func_node * cocci_id@p ;
...
position p;
@@
 struct hidg_func_node {  struct usb_function_instance * fi ;  struct usb_function * f ;  struct list_head node ;  struct hidg_func_descriptor * func ; } cocci_id@p ;
