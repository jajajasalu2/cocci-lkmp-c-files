...
position p;
@@
 enum pm_sleep_mode { PM_SLEEP_MODE_STBY , PM_SLEEP_MODE_RET , PM_SLEEP_MODE_SPC , PM_SLEEP_MODE_PC , PM_SLEEP_MODE_NR , } cocci_id@p ;
...
position p;
@@
 struct spm_driver_data {  void __iomem * reg_base ;  const struct spm_reg_data * reg_data ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct spm_reg_data {  const u8 * reg_offset ;  u32 spm_cfg ;  u32 spm_dly ;  u32 pmic_dly ;  u32 pmic_data [ MAX_PMIC_DATA ] ;  u8 seq [ MAX_SEQ_DATA ] ;  u8 start_index [ PM_SLEEP_MODE_NR ] ; } cocci_id@p ;
...
position p;
@@
 idle_fn cocci_id@p [ CPUIDLE_STATE_MAX ] ;
...
position p;
@@
 enum spm_reg { SPM_REG_CFG , SPM_REG_SPM_CTL , SPM_REG_DLY , SPM_REG_PMIC_DLY , SPM_REG_PMIC_DATA_0 , SPM_REG_PMIC_DATA_1 , SPM_REG_VCTL , SPM_REG_SEQ_ENTRY , SPM_REG_SPM_STS , SPM_REG_PMIC_STS , SPM_REG_NR , } cocci_id@p ;
...
position p;
@@
 struct spm_driver_data * cocci_id@p ;
...
position p;
@@
 const struct cpuidle_ops cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SPM_REG_NR ] ;
...
position p;
@@
 const struct spm_reg_data cocci_id@p ;
