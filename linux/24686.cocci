...
position p;
@@
 enum { IP_VS_RT_MODE_LOCAL = 1 , IP_VS_RT_MODE_NON_LOCAL = 2 , IP_VS_RT_MODE_RDR = 4 , IP_VS_RT_MODE_CONNECT = 8 , IP_VS_RT_MODE_KNOWN_NH = 16 , IP_VS_RT_MODE_TUNNEL = 32 , } cocci_id@p ;
