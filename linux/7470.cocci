...
position p;
@@
 struct mbxfb_debugfs_data {  struct dentry * dir ;  struct dentry * sysconf ;  struct dentry * clock ;  struct dentry * display ;  struct dentry * gsctl ;  struct dentry * sdram ;  struct dentry * misc ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BIG_BUFFER_SIZE ] ;
