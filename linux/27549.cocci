...
position p;
@@
 struct btrfs_qgroup_info_item cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup_swapped_block cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup_limit * cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup_limit_item * cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup_status_item cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup_extent_record * cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup_list * cocci_id@p ;
...
position p;
@@
 const struct btrfs_qgroup * cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup_list {  struct list_head next_group ;  struct list_head next_member ;  struct btrfs_qgroup * group ;  struct btrfs_qgroup * member ; } cocci_id@p ;
...
position p;
@@
 enum btrfs_qgroup_rsv_type cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup_swapped_blocks * cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct btrfs_fs_info * fs_info , u64 progress_objectid , int init_flags ) ;
