...
typedef u8;
@@
 int cocci_id@p ( struct i2c_client * client , u8 chipid ) ;
...
position p;
@@
 struct w83781d_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s8,u8,u32,u16;
@@
 struct w83781d_data {  struct i2c_client * client ;  struct device * hwmon_dev ;  struct mutex lock ;  enum chips type ;  const char * name ;  int isa_addr ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  struct i2c_client * lm75 [ 2 ] ;  u8 in [ 9 ] ;  u8 in_max [ 9 ] ;  u8 in_min [ 9 ] ;  u8 fan [ 3 ] ;  u8 fan_min [ 3 ] ;  s8 temp ;  s8 temp_max ;  s8 temp_max_hyst ;  u16 temp_add [ 2 ] ;  u16 temp_max_add [ 2 ] ;  u16 temp_max_hyst_add [ 2 ] ;  u8 fan_div [ 3 ] ;  u8 vid ;  u32 alarms ;  u32 beep_mask ;  u8 pwm [ 4 ] ;  u8 pwm2_enable ;  u16 sens [ 3 ] ;  u8 vrm ; } cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct w83781d_data * data , u16 reg , u16 value ) ;
...
position p;
@@
 enum vendor { winbond , asus , } cocci_id@p ;
...
position p;
@@
 struct w83781d_data * cocci_id@p ( struct device * dev ) ;
...
position p;
@@
 enum chips { w83781d , w83782d , w83783s , as99127f , } cocci_id@p ;
...
position p;
@@
 struct w83781d_data * cocci_id@p ( void ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct w83781d_data * data , u16 reg ) ;
