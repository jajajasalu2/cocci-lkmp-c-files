...
position p;
@@
 struct l2cap_options cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sock * sk , struct sock * parent ) ;
...
position p;
@@
 struct l2cap_conninfo cocci_id@p ;
