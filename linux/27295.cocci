...
position p;
@@
 struct autofs_sb_info * cocci_id@p ;
...
position p;
@@
 struct autofs_v5_packet * cocci_id@p ;
...
position p;
@@
 union {  struct autofs_packet_hdr hdr ;  union autofs_packet_union v4_pkt ;  union autofs_v5_packet_union v5_pkt ; } cocci_id@p ;
...
position p;
@@
 struct autofs_wait_queue * cocci_id@p ;
...
position p;
@@
 struct autofs_packet_expire_multi * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef autofs_wqt_t;
@@
 autofs_wqt_t cocci_id@p ;
...
position p;
@@
 struct autofs_packet_missing * cocci_id@p ;
