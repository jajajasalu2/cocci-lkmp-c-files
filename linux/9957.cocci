...
position p;
@@
 unsigned char cocci_id@p [ ETH_ALEN * ZD1201_MAXMULTI ] ;
...
position p;
@@
 char cocci_id@p [ IW_ESSID_MAX_SIZE + 2 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ IW_ESSID_MAX_SIZE + 2 ] ;
