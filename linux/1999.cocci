...
position p;
@@
 const struct dac5571_spec * cocci_id@p ;
...
position p;
@@
 enum chip_id { single_8bit , single_10bit , single_12bit , quad_8bit , quad_10bit , quad_12bit , } cocci_id@p ;
...
typedef u8;
@@
 struct dac5571_spec {  u8 num_channels ;  u8 resolution ; } cocci_id@p ;
...
position p;
@@
 struct dac5571_data * cocci_id@p ;
