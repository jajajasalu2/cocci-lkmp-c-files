...
typedef spinlock_t;
@@
 struct clk_pll {  struct clk_hw hw ;  void __iomem * reg ;  spinlock_t * lock ;  int type ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct clk_device {  struct clk_hw hw ;  void __iomem * div_reg ;  unsigned int div_mask ;  void __iomem * en_reg ;  int en_bit ;  spinlock_t * lock ; } cocci_id@p ;
