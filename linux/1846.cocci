...
position p;
@@
 const struct ab8500_gpadc_chan_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ ARRAY_SIZE ( otp4_cal_regs ) ] ;
...
position p;
@@
 enum ab8500_gpadc_channel cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ARRAY_SIZE ( otp_cal_regs ) ] ;
...
position p;
@@
 struct ab8500_gpadc_chan_info * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ARRAY_SIZE ( otp4_cal_regs ) ] ;
...
position p;
@@
 int cocci_id@p [ ARRAY_SIZE ( otp_cal_regs ) ] ;
...
typedef s64,u16;
@@
 struct ab8500_adc_cal_data {  s64 gain ;  s64 offset ;  u16 otp_calib_hi ;  u16 otp_calib_lo ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct ab8500_gpadc_chan_info {  const char * name ;  u8 id ;  bool hardware_control ;  bool falling_edge ;  u8 avg_sample ;  u8 trig_timer ; } cocci_id@p ;
...
position p;
@@
 enum ab8500_cal_channels { AB8500_CAL_VMAIN = 0 , AB8500_CAL_BTEMP , AB8500_CAL_VBAT , AB8500_CAL_IBAT , AB8500_CAL_NR , } cocci_id@p ;
...
position p;
@@
 struct ab8500_gpadc * cocci_id@p ;
...
position p;
@@
 struct ab8500_gpadc {  struct device * dev ;  struct ab8500 * ab8500 ;  struct ab8500_gpadc_chan_info * chans ;  unsigned int nchans ;  struct completion complete ;  struct regulator * vddadc ;  int irq_sw ;  int irq_hw ;  struct ab8500_adc_cal_data cal_data [ AB8500_CAL_NR ] ; } cocci_id@p ;
