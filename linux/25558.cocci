...
position p;
@@
 struct perf_record_record_cpu_map cocci_id@p ;
...
position p;
@@
 struct perf_record_cpu_map_data cocci_id@p ;
...
position p;
@@
 struct cpu_map_entries * cocci_id@p ;
...
position p;
@@
 struct perf_record_stat cocci_id@p ;
...
position p;
@@
 struct id_index_entry * cocci_id@p ;
...
position p;
@@
 struct perf_sample_id * cocci_id@p ;
...
position p;
@@
 struct perf_record_stat_config * cocci_id@p ;
...
position p;
@@
 struct perf_record_thread_map_entry * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,perf_event__handler_t;
@@
 struct synthesize_threads_arg {  struct perf_tool * tool ;  perf_event__handler_t process ;  struct machine * machine ;  bool mmap_data ;  struct dirent * * dirent ;  int num ;  int start ; } cocci_id@p ;
...
position p;
@@
 struct perf_record_id_index cocci_id@p ;
...
position p;
@@
 struct perf_record_cpu_map * cocci_id@p ;
...
position p;
@@
 struct sample_read_value cocci_id@p ;
...
position p;
@@
 struct perf_record_sample cocci_id@p ;
...
position p;
@@
 struct tracing_data * cocci_id@p ;
...
position p;
@@
 const struct perf_sample * cocci_id@p ;
...
position p;
@@
 struct synthesize_threads_arg * cocci_id@p ;
