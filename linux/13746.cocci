...
position p;
@@
 const struct ov5670_mode * cocci_id@p ;
...
position p;
@@
 const struct ov5670_reg_list * cocci_id@p ;
...
typedef u32;
@@
 struct ov5670_mode {  u32 width ;  u32 height ;  u32 vts_def ;  u32 vts_min ;  u32 link_freq_index ;  const struct ov5670_reg_list reg_list ; } cocci_id@p ;
...
typedef bool;
@@
 struct ov5670 {  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_ctrl * link_freq ;  struct v4l2_ctrl * pixel_rate ;  struct v4l2_ctrl * vblank ;  struct v4l2_ctrl * hblank ;  struct v4l2_ctrl * exposure ;  const struct ov5670_mode * cur_mode ;  struct mutex mutex ;  bool streaming ; } cocci_id@p ;
...
typedef u32;
@@
 struct ov5670_reg_list {  u32 num_of_regs ;  const struct ov5670_reg * regs ; } cocci_id@p ;
...
typedef u32;
@@
 struct ov5670_link_freq_config {  u32 pixel_rate ;  const struct ov5670_reg_list reg_list ; } cocci_id@p ;
...
position p;
@@
 const struct ov5670_reg cocci_id@p [ ] ;
...
position p;
@@
 const struct v4l2_subdev_sensor_ops cocci_id@p ;
...
position p;
@@
 const struct ov5670_link_freq_config cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct ov5670_reg {  u16 address ;  u8 val ; } cocci_id@p ;
