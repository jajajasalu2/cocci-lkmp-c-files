...
position p;
@@
 struct aic26 {  struct spi_device * spi ;  struct regmap * regmap ;  struct snd_soc_component * component ;  int master ;  int datfm ;  int mclk ;  int keyclick_amplitude ;  int keyclick_freq ;  int keyclick_len ; } cocci_id@p ;
