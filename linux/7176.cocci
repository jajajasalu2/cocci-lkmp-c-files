...
position p;
@@
 struct xen_compile_info cocci_id@p ;
...
position p;
@@
 struct xen_feature_info cocci_id@p ;
...
position p;
@@
 struct xen_pmu_params cocci_id@p ;
...
position p;
@@
 struct hyp_sysfs_attr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xen_domain_handle_t;
@@
 xen_domain_handle_t cocci_id@p ;
...
typedef uint32_t;
@@
 struct pmu_mode {  const char * name ;  uint32_t mode ; } cocci_id@p ;
...
position p;
@@
 struct xen_build_id * cocci_id@p ;
