...
position p;
@@
 struct clk_audio_pad cocci_id@p ;
...
position p;
@@
 struct clk_audio_pmc * cocci_id@p ;
...
position p;
@@
 struct clk_audio_frac * cocci_id@p ;
...
typedef u8;
@@
 struct clk_audio_pmc {  struct clk_hw hw ;  struct regmap * regmap ;  u8 qdpmc ; } cocci_id@p ;
...
typedef u8;
@@
 struct clk_audio_pad {  struct clk_hw hw ;  struct regmap * regmap ;  u8 qdaudio ;  u8 div ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct clk_audio_frac {  struct clk_hw hw ;  struct regmap * regmap ;  u32 fracr ;  u8 nd ; } cocci_id@p ;
