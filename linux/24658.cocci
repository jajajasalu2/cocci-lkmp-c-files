...
position p;
@@
 struct bitmap_port_adt_elem cocci_id@p ;
...
position p;
@@
 const struct bitmap_port_adt_elem * cocci_id@p ;
...
position p;
@@
 struct bitmap_port_elem { } cocci_id@p ;
...
typedef u16;
@@
 struct bitmap_port_adt_elem {  u16 id ; } cocci_id@p ;
...
position p;
@@
 const struct bitmap_port * cocci_id@p ;
