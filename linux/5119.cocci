...
position p;
@@
 struct property_entry cocci_id@p [ GPIO_MOCKUP_MAX_PROP ] ;
...
position p;
@@
 int cocci_id@p [ GPIO_MOCKUP_MAX_RANGES ] ;
...
position p;
@@
 struct gpio_mockup_line_status {  int dir ;  int value ;  int pull ; } cocci_id@p ;
...
position p;
@@
 struct gpio_mockup_chip {  struct gpio_chip gc ;  struct gpio_mockup_line_status * lines ;  struct irq_sim irqsim ;  struct dentry * dbg_dir ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct platform_device * cocci_id@p [ GPIO_MOCKUP_MAX_GC ] ;
...
position p;
@@
 struct gpio_mockup_dbgfs_private {  struct gpio_mockup_chip * chip ;  struct gpio_desc * desc ;  unsigned int offset ; } cocci_id@p ;
...
position p;
@@
 struct gpio_mockup_dbgfs_private * cocci_id@p ;
...
position p;
@@
 struct gpio_mockup_chip * cocci_id@p ;
