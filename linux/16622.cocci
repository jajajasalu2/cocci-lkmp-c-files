...
position p;
@@
 struct ism_resp_hdr * cocci_id@p ;
...
position p;
@@
 union ism_cmd_simple cocci_id@p ;
...
position p;
@@
 union ism_set_vlan_id cocci_id@p ;
...
position p;
@@
 union ism_unreg_dmb cocci_id@p ;
...
position p;
@@
 union ism_query_rgid cocci_id@p ;
