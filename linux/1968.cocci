...
typedef bool,u16;
@@
 struct mcp4725_data {  struct i2c_client * client ;  int id ;  unsigned ref_mode ;  bool vref_buffered ;  u16 dac_value ;  bool powerdown ;  unsigned powerdown_mode ;  struct regulator * vdd_reg ;  struct regulator * vref_reg ; } cocci_id@p ;
...
position p;
@@
 enum chip_id { MCP4725 , MCP4726 , } cocci_id@p ;
...
position p;
@@
 struct mcp4725_platform_data * cocci_id@p ;
...
position p;
@@
 struct mcp4725_data * cocci_id@p ;
