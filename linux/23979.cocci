...
position p;
@@
 struct tcp_out_options * cocci_id@p ;
...
position p;
@@
 const enum tcp_chrono cocci_id@p ;
...
position p;
@@
 struct tsq_tasklet {  struct tasklet_struct tasklet ;  struct list_head head ; } cocci_id@p ;
