...
typedef u32;
@@
 struct netlbl_cipsov4_doiwalk_arg {  struct netlink_callback * nl_cb ;  struct sk_buff * skb ;  u32 seq ; } cocci_id@p ;
...
position p;
@@
 struct netlbl_cipsov4_doiwalk_arg * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NLBL_CIPSOV4_A_MAX + 1 ] ;
