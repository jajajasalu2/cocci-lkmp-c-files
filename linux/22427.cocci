...
symbol cocci_id;
position p;
typedef als4k_iobase_t;
@@
 enum als4k_iobase_t cocci_id@p ;
...
position p;
@@
 struct snd_card_als4000 * cocci_id@p ;
...
position p;
@@
 const struct {  unsigned char dsp_cmd , dma_on , dma_off , format ; } cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef als4k_gcr8c_t;
@@
 enum als4k_gcr8c_t { ALS4K_GCR8C_IRQ_MASK_CTRL_ENABLE = 0x8000 , ALS4K_GCR8C_CHIP_REV_MASK = 0xf0000 , } cocci_id@p ;
...
position p;
@@
 enum { CMD_WIDTH8 = 0x04 , CMD_SIGNED = 0x10 , CMD_MONO = 0x80 , CMD_STEREO = 0xA0 , } cocci_id@p ;
...
typedef als4k_cr0_t;
@@
 enum als4k_cr0_t { ALS4K_CR0_DMA_CONTIN_MODE_CTRL = 0x02 , ALS4K_CR0_DMA_90H_MODE_CTRL = 0x04 , ALS4K_CR0_MX80_81_REG_WRITE_ENABLE = 0x80 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef als4k_iobase_0e_t;
@@
 enum als4k_iobase_0e_t { ALS4K_IOB_0E_MPU_IRQ = 0x10 , ALS4K_IOB_0E_CR1E_IRQ = 0x40 , ALS4K_IOB_0E_SB_DMA_IRQ = 0x80 , } cocci_id@p ;
