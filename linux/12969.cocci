...
typedef u32;
@@
 struct pmu_domain {  struct pmu_data * pmu ;  u32 pwr_mask ;  u32 rst_mask ;  u32 iso_mask ;  struct generic_pm_domain base ; } cocci_id@p ;
...
position p;
@@
 const struct dove_pmu_initdata * cocci_id@p ;
...
position p;
@@
 const struct dove_pmu_domain_initdata * cocci_id@p ;
