...
position p;
@@
 const struct exynos_pm_domain_config cocci_id@p ;
...
position p;
@@
 struct exynos_pm_domain * cocci_id@p ;
...
typedef u32;
@@
 struct exynos_pm_domain_config {  u32 local_pwr_cfg ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct exynos_pm_domain {  void __iomem * base ;  bool is_off ;  struct generic_pm_domain pd ;  u32 local_pwr_cfg ; } cocci_id@p ;
