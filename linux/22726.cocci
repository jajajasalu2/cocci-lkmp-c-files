...
position p;
@@
 struct snd_hal2 {  struct snd_card * card ;  struct hal2_ctl_regs * ctl_regs ;  struct hal2_aes_regs * aes_regs ;  struct hal2_vol_regs * vol_regs ;  struct hal2_syn_regs * syn_regs ;  struct hal2_codec dac ;  struct hal2_codec adc ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct hal2_codec {  struct snd_pcm_indirect pcm_indirect ;  struct snd_pcm_substream * substream ;  unsigned char * buffer ;  dma_addr_t buffer_dma ;  struct hal2_desc * desc ;  dma_addr_t desc_dma ;  int desc_count ;  struct hal2_pbus pbus ;  int voices ;  unsigned int sample_rate ;  unsigned int master ;  unsigned short mod ;  unsigned short inc ; } cocci_id@p ;
...
position p;
@@
 struct hal2_ctl_regs * cocci_id@p ;
...
position p;
@@
 struct hal2_aes_regs * cocci_id@p ;
...
position p;
@@
 struct hal2_pbus {  struct hpc3_pbus_dmacregs * pbus ;  int pbusnr ;  unsigned int ctrl ; } cocci_id@p ;
...
position p;
@@
 struct hal2_syn_regs * cocci_id@p ;
...
position p;
@@
 struct hal2_vol_regs * cocci_id@p ;
...
typedef u32;
@@
 struct hal2_desc {  struct hpc_dma_desc desc ;  u32 pad ; } cocci_id@p ;
