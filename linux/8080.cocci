...
position p;
@@
 struct unimac_mdio_pdata * cocci_id@p ;
...
typedef u32;
@@
 struct unimac_mdio_priv {  struct mii_bus * mii_bus ;  void __iomem * base ;  int ( * wait_func ) ( void * wait_func_data ) ;  void * wait_func_data ;  struct clk * clk ;  u32 clk_freq ; } cocci_id@p ;
...
position p;
@@
 struct unimac_mdio_priv * cocci_id@p ;
