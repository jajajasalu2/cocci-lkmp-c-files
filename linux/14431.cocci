...
typedef u8;
@@
 struct si4713_usb_device {  struct usb_device * usbdev ;  struct usb_interface * intf ;  struct video_device vdev ;  struct v4l2_device v4l2_dev ;  struct v4l2_subdev * v4l2_subdev ;  struct mutex lock ;  struct i2c_adapter i2c_adapter ;  u8 * buffer ; } cocci_id@p ;
...
position p;
@@
 struct si4713_command_table cocci_id@p [ ] ;
...
position p;
@@
 struct si4713_usb_device cocci_id@p ;
...
typedef u8;
@@
 struct si4713_command_table {  int command_id ;  u8 payload [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 const struct si4713_start_seq_table cocci_id@p [ ] ;
...
typedef u8;
@@
 struct si4713_start_seq_table {  int len ;  u8 payload [ 8 ] ; } cocci_id@p ;
