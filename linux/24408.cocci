...
position p;
@@
 const struct sco_param cocci_id@p [ ] ;
...
position p;
@@
 struct hci_conn_info_req cocci_id@p ;
...
position p;
@@
 struct hci_auth_info_req cocci_id@p ;
...
position p;
@@
 struct hci_cp_le_conn_update cocci_id@p ;
...
position p;
@@
 struct hci_conn_info cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( * cp ) + sizeof ( * p ) * 3 ] ;
...
typedef u8,u16;
@@
 struct sco_param {  u16 pkt_type ;  u16 max_latency ;  u8 retrans_effort ; } cocci_id@p ;
...
position p;
@@
 struct hci_cp_le_ext_conn_param * cocci_id@p ;
...
position p;
@@
 struct hci_cp_read_clock_offset cocci_id@p ;
...
position p;
@@
 struct hci_cp_sniff_subrate cocci_id@p ;
...
position p;
@@
 struct hci_conn_list_req cocci_id@p ;
