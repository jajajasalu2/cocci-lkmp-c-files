...
position p;
@@
 const struct chipset_bus_clock_list_entry * cocci_id@p ;
...
position p;
@@
 struct chipset_bus_clock_list_entry * cocci_id@p ;
...
typedef u8;
@@
 struct chipset_bus_clock_list_entry {  u8 xfer_speed ;  u8 chipset_settings ;  u8 ultra_settings ; } cocci_id@p ;
