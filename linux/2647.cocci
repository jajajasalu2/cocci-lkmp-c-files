...
position p;
@@
 struct xlr_i2c_private * cocci_id@p ;
...
@@
 struct xlr_i2c_private {  struct i2c_adapter adap ;  u32 __iomem * iobase ;  int irq ;  int pos ;  struct i2c_msg * msg ;  const struct xlr_i2c_config * cfg ;  wait_queue_head_t wait ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 const struct xlr_i2c_config cocci_id@p ;
...
typedef u32;
@@
 struct xlr_i2c_config {  u32 flags ;  u32 status_busy ;  u32 cfg_extra ; } cocci_id@p ;
