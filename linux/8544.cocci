...
position p;
@@
 struct slic_rx_desc * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ SLIC_FIRMWARE_MAX_SECTIONS ] ;
...
position p;
@@
 struct slic_stat_desc * cocci_id@p ;
...
position p;
@@
 struct slic_rx_queue * cocci_id@p ;
...
position p;
@@
 struct slic_rx_info_mojave * cocci_id@p ;
...
position p;
@@
 struct slic_shmem_data * cocci_id@p ;
...
position p;
@@
 struct slic_tx_buffer * cocci_id@p ;
...
position p;
@@
 struct slic_rx_buffer * cocci_id@p ;
...
position p;
@@
 struct slic_tx_desc * cocci_id@p ;
...
position p;
@@
 struct slic_oasis_eeprom * cocci_id@p ;
...
position p;
@@
 struct slic_mojave_eeprom * cocci_id@p ;
...
position p;
@@
 struct slic_rx_info_oasis * cocci_id@p ;
...
position p;
@@
 struct slic_stat_queue * cocci_id@p ;
...
position p;
@@
 struct slic_upr_list * cocci_id@p ;
...
position p;
@@
 struct slic_tx_queue * cocci_id@p ;
