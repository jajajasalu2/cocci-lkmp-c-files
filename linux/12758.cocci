...
position p;
@@
 struct iova_magazine * cocci_id@p ;
...
position p;
@@
 struct iova_magazine {  unsigned long size ;  unsigned long pfns [ IOVA_MAG_SIZE ] ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct iova_cpu_rcache {  spinlock_t lock ;  struct iova_magazine * loaded ;  struct iova_magazine * prev ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct iova_domain * iovad ) ;
...
position p;
@@
 struct iova_cpu_rcache * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( struct iova_domain * iovad , unsigned long size , unsigned long limit_pfn ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct iova_domain * iovad , unsigned long pfn , unsigned long size ) ;
