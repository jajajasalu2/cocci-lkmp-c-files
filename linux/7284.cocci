...
position p;
@@
 struct max8925_backlight_data cocci_id@p ;
...
position p;
@@
 struct max8925_backlight_data {  struct max8925_chip * chip ;  int current_brightness ;  int reg_mode_cntl ;  int reg_cntl ; } cocci_id@p ;
