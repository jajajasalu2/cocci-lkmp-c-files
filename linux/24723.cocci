...
position p;
@@
 struct nft_objref_map cocci_id@p ;
...
position p;
@@
 const struct nft_objref_map * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_OBJREF_MAX + 1 ] ;
...
position p;
@@
 struct nft_objref_map {  struct nft_set * set ;  enum nft_registers sreg : 8 ;  struct nft_set_binding binding ; } cocci_id@p ;
