...
position p;
@@
 const struct adv748x_hdmi_video_standards cocci_id@p [ ] ;
...
position p;
@@
 struct adv748x_state * cocci_id@p ;
...
position p;
@@
 struct adv748x_hdmi * cocci_id@p ;
...
typedef u8;
@@
 struct adv748x_hdmi_video_standards {  struct v4l2_dv_timings timings ;  u8 vid_std ;  u8 v_freq ; } cocci_id@p ;
