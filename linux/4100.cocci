...
position p;
@@
 const struct rockchip_usb3phy_port_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct rockchip_typec_phy * cocci_id@p ;
...
typedef u32,u16;
@@
 struct phy_reg {  u16 value ;  u32 addr ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_usb3phy_port_cfg {  unsigned int reg ;  struct usb3phy_reg typec_conn_dir ;  struct usb3phy_reg usb3tousb2_en ;  struct usb3phy_reg external_psm ;  struct usb3phy_reg pipe_status ;  struct usb3phy_reg usb3_host_disable ;  struct usb3phy_reg usb3_host_port ;  struct usb3phy_reg uphy_dp_sel ; } cocci_id@p ;
...
position p;
@@
 const struct usb3phy_reg * cocci_id@p ;
...
typedef u32;
@@
 struct usb3phy_reg {  u32 offset ;  u32 enable_bit ;  u32 write_enable ; } cocci_id@p ;
