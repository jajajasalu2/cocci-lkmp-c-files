...
position p;
@@
 struct rbtx4939_led_data cocci_id@p ;
...
position p;
@@
 struct mtd_partition cocci_id@p [ 4 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ RBTX4939_MAX_7SEGLEDS ] ;
...
position p;
@@
 struct rbtx4939_led_data {  struct led_classdev cdev ;  char name [ 32 ] ;  unsigned int num ; } cocci_id@p ;
...
position p;
@@
 struct {  struct platform_device dev ;  struct resource res ;  struct rbtx4939_flash_data data ; } cocci_id@p [ 4 ] ;
...
position p;
@@
 struct rbtx4939_flash_data * cocci_id@p ;
