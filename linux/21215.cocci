...
position p;
@@
 struct sh7786_pcie_port cocci_id@p ;
...
@@
 struct sh7786_pcie_hwops {  int ( * core_init ) ( void ) ;  async_func_t port_init_hw ; } * cocci_id@p ;
...
position p;
@@
 struct sh7786_pcie_hwops cocci_id@p ;
