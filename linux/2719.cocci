...
position p;
@@
 struct i2c_algo_pcf_data * cocci_id@p ;
...
position p;
@@
 struct icy_i2c {  struct i2c_adapter adapter ;  void __iomem * reg_s0 ;  void __iomem * reg_s1 ;  struct fwnode_handle * ltc2990_fwnode ;  struct i2c_client * ltc2990_client ; } cocci_id@p ;
