...
position p;
@@
 const struct property_entry cocci_id@p [ ] ;
...
position p;
@@
 struct pcf857x_platform_data cocci_id@p ;
...
position p;
@@
 enum stargate2_ldos { vcc_vref , vcc_cc2420 , vcc_mica , vcc_bt , vcc_sensor_1_8 , vcc_sensor_3 , vcc_sram_ext , vcc_pxa_pll , vcc_pxa_usim , vcc_pxa_mem , vcc_pxa_flash , vcc_pxa_core , vcc_lcd , vcc_bb , vcc_bbio , vcc_io , } cocci_id@p ;
...
position p;
@@
 struct platdata_mtd_ram cocci_id@p ;
