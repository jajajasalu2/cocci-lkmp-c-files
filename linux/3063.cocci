...
@@
 struct ps3vram_priv {  struct request_queue * queue ;  struct gendisk * gendisk ;  u64 size ;  u64 memory_handle ;  u64 context_handle ;  u32 __iomem * ctrl ;  void __iomem * reports ;  u8 * xdr_buf ;  u32 * fifo_base ;  u32 * fifo_ptr ;  struct ps3vram_cache cache ;  spinlock_t lock ;  struct bio_list list ; } cocci_id@p ;
...
position p;
@@
 struct ps3vram_priv * cocci_id@p ;
...
position p;
@@
 struct ps3vram_cache {  unsigned int page_count ;  unsigned int page_size ;  struct ps3vram_tag * tags ;  unsigned int hit ;  unsigned int miss ; } cocci_id@p ;
...
position p;
@@
 struct ps3vram_tag {  unsigned int address ;  unsigned int flags ; } cocci_id@p ;
...
position p;
@@
 struct ps3vram_cache * cocci_id@p ;
