...
position p;
@@
 struct i5k_device_attribute * cocci_id@p ;
...
typedef u16;
@@
 struct i5k_amb_data {  struct device * hwmon_dev ;  unsigned long amb_base ;  unsigned long amb_len ;  u16 amb_present [ MAX_MEM_CHANNELS ] ;  void __iomem * amb_mmio ;  struct i5k_device_attribute * attrs ;  unsigned int num_attrs ; } cocci_id@p ;
...
position p;
@@
 struct i5k_amb_data * cocci_id@p ;
...
position p;
@@
 struct {  unsigned long err ;  unsigned long fbd0 ; } cocci_id@p [ ] ;
...
position p;
@@
 struct i5k_device_attribute {  struct sensor_device_attribute s_attr ;  char name [ AMB_SYSFS_NAME_LEN ] ; } cocci_id@p ;
