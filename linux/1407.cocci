...
position p;
@@
 const struct at91_udc_caps cocci_id@p ;
...
position p;
@@
 struct at91_request * cocci_id@p ;
...
position p;
@@
 struct at91_udc_data * cocci_id@p ;
...
typedef u8;
@@
 union setup {  u8 raw [ 8 ] ;  struct usb_ctrlrequest r ; } cocci_id@p ;
