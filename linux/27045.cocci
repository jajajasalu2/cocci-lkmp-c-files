...
position p;
@@
 struct xfs_rmap_rec * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct xfs_mount * mp , struct xfs_buf * bp , struct aghdr_init_data * id ) ;
...
symbol cocci_id;
position p;
typedef bool,xfs_btnum_t,xfs_daddr_t;
@@
 struct xfs_aghdr_grow_data {  xfs_daddr_t daddr ;  size_t numblks ;  const struct xfs_buf_ops * ops ;  aghdr_init_work_f work ;  xfs_btnum_t type ;  bool need_init ; } cocci_id@p ;
...
position p;
@@
 struct xfs_aghdr_grow_data * cocci_id@p ;
...
position p;
@@
 struct aghdr_init_data * cocci_id@p ;
...
position p;
@@
 struct xfs_alloc_rec * cocci_id@p ;
