...
position p;
@@
 enum sensors { SENSOR_CX0342 , SENSOR_SOI763A , NSENSORS , } cocci_id@p ;
...
typedef u8;
@@
 struct cmd {  u8 reg ;  u8 val ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ NGAMMA ] [ 3 ] [ 1024 ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ NSENSORS ] [ 18 ] ;
...
position p;
@@
 enum bridges { BRIDGE_TP6800 , BRIDGE_TP6810 , } cocci_id@p ;
