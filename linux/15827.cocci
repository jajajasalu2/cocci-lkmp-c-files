...
position p;
@@
 int cocci_id@p ( struct net_device * pnetdev ) ;
...
position p;
@@
 struct rtw_netdev_priv_indicator * cocci_id@p ;
...
position p;
@@
 struct rtw_ieee80211_channel cocci_id@p [ RTW_CHANNEL_SCAN_AMOUNT ] ;
...
position p;
@@
 enum NDIS_802_11_AUTHENTICATION_MODE cocci_id@p ;
...
position p;
@@
 struct rtw_wdev_priv * cocci_id@p ;
