...
symbol cocci_id;
position p;
typedef bool,u32,wait_queue_head_t,spinlock_t,atomic_t;
@@
 struct io_ring_ctx {  struct {  struct percpu_ref refs ; } ____cacheline_aligned_in_smp ;  struct {  unsigned int flags ;  bool compat ;  bool account_mem ;  bool cq_overflow_flushed ;  bool drain_next ;  u32 * sq_array ;  unsigned cached_sq_head ;  unsigned sq_entries ;  unsigned sq_mask ;  unsigned sq_thread_idle ;  unsigned cached_sq_dropped ;  atomic_t cached_cq_overflow ;  struct io_uring_sqe * sq_sqes ;  struct list_head defer_list ;  struct list_head timeout_list ;  struct list_head cq_overflow_list ;  wait_queue_head_t inflight_wait ; } ____cacheline_aligned_in_smp ;  struct io_rings * rings ;  struct io_wq * io_wq ;  struct task_struct * sqo_thread ;  struct mm_struct * sqo_mm ;  wait_queue_head_t sqo_wait ;  struct fixed_file_table * file_table ;  unsigned nr_user_files ;  unsigned nr_user_bufs ;  struct io_mapped_ubuf * user_bufs ;  struct user_struct * user ;  const struct cred * creds ;  struct completion * completions ;  struct io_kiocb * fallback_req ; #if defined(CONFIG_UNIX)  struct socket * ring_sock ; #endif  struct {  unsigned cached_cq_tail ;  unsigned cq_entries ;  unsigned cq_mask ;  atomic_t cq_timeouts ;  struct wait_queue_head cq_wait ;  struct fasync_struct * cq_fasync ;  struct eventfd_ctx * cq_ev_fd ; } ____cacheline_aligned_in_smp ;  struct {  struct mutex uring_lock ;  wait_queue_head_t wait ; } ____cacheline_aligned_in_smp ;  struct {  spinlock_t completion_lock ;  bool poll_multi_file ;  struct list_head poll_list ;  struct hlist_head * cancel_hash ;  unsigned cancel_hash_bits ;  spinlock_t inflight_lock ;  struct list_head inflight_list ; } ____cacheline_aligned_in_smp ; } cocci_id@p ;
...
position p;
@@
 struct iovec cocci_id@p [ UIO_FASTIOV ] ;
...
position p;
@@
 struct io_async_rw {  struct iovec fast_iov [ UIO_FASTIOV ] ;  struct iovec * iov ;  ssize_t nr_segs ;  ssize_t size ; } cocci_id@p ;
...
typedef loff_t;
@@
 struct io_sync {  struct file * file ;  loff_t len ;  loff_t off ;  int flags ; } cocci_id@p ;
...
position p;
@@
 struct io_timeout_data * cocci_id@p ;
...
position p;
@@
 struct io_accept {  struct file * file ;  struct sockaddr __user * addr ;  int __user * addr_len ;  int flags ; } cocci_id@p ;
...
position p;
@@
 struct io_sr_msg {  struct file * file ;  struct user_msghdr __user * msg ;  int msg_flags ; } cocci_id@p ;
...
typedef u64;
@@
 struct io_timeout {  struct file * file ;  u64 addr ;  int flags ;  unsigned count ; } cocci_id@p ;
...
position p;
@@
 struct io_mapped_ubuf * cocci_id@p ;
...
typedef u32;
@@
 struct io_rings {  struct io_uring sq , cq ;  u32 sq_ring_mask , cq_ring_mask ;  u32 sq_ring_entries , cq_ring_entries ;  u32 sq_dropped ;  u32 sq_flags ;  u32 cq_overflow ;  struct io_uring_cqe cqes [ ] ____cacheline_aligned_in_smp ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct io_kiocb * req ) ;
...
position p;
@@
 void * cocci_id@p [ IO_IOPOLL_BATCH ] ;
...
position p;
@@
 struct io_async_msghdr {  struct iovec fast_iov [ UIO_FASTIOV ] ;  struct iovec * iov ;  struct sockaddr __user * uaddr ;  struct msghdr msg ; } cocci_id@p ;
...
position p;
@@
 struct io_poll_table cocci_id@p ;
...
position p;
@@
 struct io_uring_cqe * cocci_id@p ;
...
position p;
@@
 struct io_poll_table {  struct poll_table_struct pt ;  struct io_kiocb * req ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct fixed_file_table cocci_id@p ;
...
typedef u64;
@@
 struct io_rw {  struct kiocb kiocb ;  u64 addr ;  u64 len ; } cocci_id@p ;
...
position p;
@@
 struct files_struct * cocci_id@p ;
...
typedef u64;
@@
 struct io_mapped_ubuf {  u64 ubuf ;  size_t len ;  struct bio_vec * bvec ;  unsigned int nr_bvecs ; } cocci_id@p ;
...
position p;
@@
 struct io_uring_sqe cocci_id@p ;
...
position p;
@@
 struct compat_iovec cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct io_kiocb * req , long res ) ;
...
position p;
@@
 struct io_connect {  struct file * file ;  struct sockaddr __user * addr ;  int addr_len ; } cocci_id@p ;
...
position p;
@@
 struct fixed_file_table {  struct file * * files ; } cocci_id@p ;
...
typedef u64;
@@
 struct io_cancel {  struct file * file ;  u64 addr ; } cocci_id@p ;
...
position p;
@@
 struct io_submit_state {  struct blk_plug plug ;  void * reqs [ IO_IOPOLL_BATCH ] ;  unsigned int free_reqs ;  unsigned int cur_req ;  struct file * file ;  unsigned int fd ;  unsigned int has_refs ;  unsigned int used_refs ;  unsigned int ios_left ; } cocci_id@p ;
...
typedef u32;
@@
 struct io_timeout_data {  struct io_kiocb * req ;  struct hrtimer timer ;  struct timespec64 ts ;  enum hrtimer_mode mode ;  u32 seq_offset ; } cocci_id@p ;
...
position p;
@@
 struct io_async_ctx * cocci_id@p ;
...
position p;
@@
 struct io_async_msghdr * cocci_id@p ;
...
position p;
@@
 struct wait_queue_head * cocci_id@p ;
...
position p;
@@
 struct io_submit_state * cocci_id@p ;
...
typedef u32;
@@
 struct io_uring {  u32 head ____cacheline_aligned_in_smp ;  u32 tail ____cacheline_aligned_in_smp ; } cocci_id@p ;
...
position p;
@@
 struct io_uring_files_update cocci_id@p ;
...
position p;
@@
 struct io_async_ctx {  union {  struct io_async_rw rw ;  struct io_async_msghdr msg ;  struct io_async_connect connect ;  struct io_timeout_data timeout ; } ; } cocci_id@p ;
...
position p;
@@
 struct io_poll_iocb * cocci_id@p ;
...
position p;
@@
 struct io_uring_params * cocci_id@p ;
...
position p;
@@
 struct sk_buff_head * cocci_id@p ;
...
position p;
@@
 struct io_async_connect {  struct sockaddr_storage address ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct io_wq_work * * workptr ) ;
...
position p;
@@
 struct io_wait_queue cocci_id@p ;
...
position p;
@@
 const struct io_uring_sqe * cocci_id@p ;
...
position p;
@@
 struct io_kiocb * cocci_id@p ( struct io_kiocb * req ) ;
...
symbol cocci_id;
position p;
typedef u64,bool,__poll_t;
@@
 struct io_poll_iocb {  struct file * file ;  union {  struct wait_queue_head * head ;  u64 addr ; } ;  __poll_t events ;  bool done ;  bool canceled ;  struct wait_queue_entry wait ; } cocci_id@p ;
...
position p;
@@
 const struct bio_vec * cocci_id@p ;
...
position p;
@@
 struct io_wait_queue {  struct wait_queue_entry wq ;  struct io_ring_ctx * ctx ;  unsigned to_wait ;  unsigned nr_timeouts ; } cocci_id@p ;
