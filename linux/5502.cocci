...
symbol cocci_id;
position p;
typedef u8,u32,dev_t,spinlock_t;
@@
 struct spidev_data {  dev_t devt ;  spinlock_t spi_lock ;  struct spi_device * spi ;  struct list_head device_entry ;  struct mutex buf_lock ;  unsigned users ;  u8 * tx_buffer ;  u8 * rx_buffer ;  u32 speed_hz ; } cocci_id@p ;
...
position p;
@@
 struct spi_ioc_transfer * cocci_id@p ;
