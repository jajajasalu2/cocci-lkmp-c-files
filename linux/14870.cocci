...
typedef bool;
@@
 struct tegra_clk_emc {  struct clk_hw hw ;  void __iomem * reg ;  bool mc_same_freq ;  bool want_low_jitter ;  tegra20_clk_emc_round_cb * round_cb ;  void * cb_arg ; } cocci_id@p ;
...
position p;
@@
 tegra20_clk_emc_round_cb * cocci_id@p ;
