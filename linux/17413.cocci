...
position p;
@@
 struct pmf_cmd {  const void * cmdptr ;  const void * cmdend ;  struct pmf_function * func ;  void * instdata ;  struct pmf_args * args ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct pmf_irq_client * cocci_id@p ;
...
position p;
@@
 struct pmf_device {  struct list_head link ;  struct device_node * node ;  struct pmf_handlers * handlers ;  struct list_head functions ;  struct kref ref ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct pmf_cmd * cmd , struct pmf_handlers * h ) ;
...
symbol cocci_id;
position p;
typedef pmf_cmd_parser_t;
@@
 pmf_cmd_parser_t cocci_id@p [ PMF_CMD_COUNT ] ;
