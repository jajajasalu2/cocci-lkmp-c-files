...
position p;
@@
 const struct tmdc_model {  unsigned char id ;  const char * name ;  char abs ;  char hats ;  char btnc [ 4 ] ;  char btno [ 4 ] ;  const signed char * axes ;  const short * buttons ; } cocci_id@p [ ] ;
...
position p;
@@
 struct tmdc {  struct gameport * gameport ;  struct tmdc_port * port [ 2 ] ; 
 #if 0 
 ...
 * 
 ...
 #endif 
  int reads ;  int bads ;  unsigned char exists ; } cocci_id@p ;
...
position p;
@@
 const signed char cocci_id@p [ TMDC_ABS_HAT ] ;
...
position p;
@@
 struct gameport_driver * cocci_id@p ;
...
position p;
@@
 const struct tmdc_model * cocci_id@p ;
...
position p;
@@
 const short cocci_id@p [ TMDC_BTN ] ;
...
position p;
@@
 const signed char cocci_id@p [ TMDC_ABS ] ;
...
position p;
@@
 unsigned char cocci_id@p [ 2 ] [ TMDC_MAX_LENGTH ] ;
...
position p;
@@
 struct tmdc_port {  struct input_dev * dev ;  char name [ 64 ] ;  char phys [ 32 ] ;  int mode ;  const signed char * abs ;  const short * btn ;  unsigned char absc ;  unsigned char btnc [ 4 ] ;  unsigned char btno [ 4 ] ; } cocci_id@p ;
