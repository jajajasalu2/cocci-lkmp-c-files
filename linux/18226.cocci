...
position p;
@@
 struct zx_pm_domain * cocci_id@p ;
...
position p;
@@
 enum { PCU_DM_NEON0 = 0 , PCU_DM_NEON1 , PCU_DM_GPU , PCU_DM_DECPPU , PCU_DM_VOU , PCU_DM_R2D , PCU_DM_TOP , } cocci_id@p ;
...
position p;
@@
 struct zx_pm_domain {  struct generic_pm_domain dm ;  unsigned int bit ; } cocci_id@p ;
