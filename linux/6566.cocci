...
typedef __le32;
@@
 struct sis_base_struct {  __le32 revision ;  __le32 flags ;  __le32 error_buffer_paddr_low ;  __le32 error_buffer_paddr_high ;  __le32 error_buffer_element_length ;  __le32 error_buffer_num_elements ; } cocci_id@p ;
...
position p;
@@
 struct sis_sync_cmd_params cocci_id@p ;
...
position p;
@@
 struct sis_base_struct cocci_id@p ;
...
typedef u32;
@@
 struct sis_sync_cmd_params {  u32 mailbox [ 6 ] ; } cocci_id@p ;
