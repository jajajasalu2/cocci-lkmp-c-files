...
position p;
@@
 const struct hyperbus_ops cocci_id@p ;
...
position p;
@@
 struct am654_hbmc_priv {  struct hyperbus_ctlr ctlr ;  struct hyperbus_device hbdev ;  struct mux_control * mux_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct am654_hbmc_priv * cocci_id@p ;
...
position p;
@@
 struct hyperbus_device * cocci_id@p ;
