...
position p;
@@
 int cocci_id@p ( struct list_head * list , char * name ) ;
...
position p;
@@
 struct pmu_events_map * cocci_id@p ;
...
position p;
@@
 const struct sevent * cocci_id@p ;
...
position p;
@@
 struct sevent {  char * name ;  char * desc ;  char * topic ;  char * str ;  char * pmu ;  char * metric_expr ;  char * metric_name ; } cocci_id@p ;
...
position p;
@@
 struct perf_pmu_format {  char * name ;  int value ; 
	 DECLARE_BITMAP ( bits , PERF_PMU_FORMAT_BITS ) 
		 ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct perf_pmu_format * cocci_id@p ;
