...
position p;
@@
 struct xive_irq_bitmap * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct xive_irq_bitmap {  unsigned long * bitmap ;  unsigned int base ;  unsigned int count ;  spinlock_t lock ;  struct list_head list ; } cocci_id@p ;
