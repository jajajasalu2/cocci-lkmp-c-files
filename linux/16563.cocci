...
position p;
@@
 struct ap_matrix_mdev * cocci_id@p ;
...
position p;
@@
 struct ap_qirq_ctrl cocci_id@p ;
...
position p;
@@
 struct vfio_ap_queue_reserved cocci_id@p ;
...
position p;
@@
 struct vfio_ap_queue * cocci_id@p ;
...
position p;
@@
 struct ap_queue_status cocci_id@p ;
...
typedef bool;
@@
 struct vfio_ap_queue_reserved {  unsigned long * apid ;  unsigned long * apqi ;  bool reserved ; } cocci_id@p ;
