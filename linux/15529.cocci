...
position p;
@@
 struct i3c_ibi_slot cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_defslvs * cocci_id@p ;
...
position p;
@@
 struct i3c_ibi_setup cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_getdcr * cocci_id@p ;
...
position p;
@@
 const struct i3c_master_controller_ops * cocci_id@p ;
...
position p;
@@
 struct i3c_device_info * cocci_id@p ;
...
position p;
@@
 struct i3c_dev_desc * cocci_id@p ;
...
position p;
@@
 struct i2c_dev_desc * cocci_id@p ;
...
position p;
@@
 struct i3c_generic_ibi_pool * cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_getpid * cocci_id@p ;
...
position p;
@@
 struct i3c_master_controller cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_cmd_dest * cocci_id@p ;
...
position p;
@@
 struct i3c_generic_ibi_slot {  struct list_head node ;  struct i3c_ibi_slot base ; } cocci_id@p ;
...
position p;
@@
 struct i3c_generic_ibi_slot cocci_id@p ;
...
position p;
@@
 struct i3c_ibi_payload cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_gethdrcap * cocci_id@p ;
...
position p;
@@
 const struct i2c_dev_boardinfo * cocci_id@p ;
...
position p;
@@
 struct i3c_device_ibi_info * cocci_id@p ;
...
position p;
@@
 enum i3c_addr_slot_status cocci_id@p ;
...
position p;
@@
 struct i2c_dev_boardinfo * cocci_id@p ;
...
position p;
@@
 const struct i3c_master_controller * cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_dev_desc * cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_setda * cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_getmxds * cocci_id@p ;
...
position p;
@@
 const struct i3c_ibi_setup * cocci_id@p ;
...
position p;
@@
 const struct i3c_device_info * cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_events * cocci_id@p ;
...
position p;
@@
 struct i3c_dev_boardinfo * cocci_id@p ;
...
position p;
@@
 struct i3c_ccc_getbcr * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct i3c_generic_ibi_pool {  spinlock_t lock ;  unsigned int num_slots ;  struct i3c_generic_ibi_slot * slots ;  void * payload_buf ;  struct list_head free_slots ;  struct list_head pending ; } cocci_id@p ;
...
position p;
@@
 struct i3c_priv_xfer * cocci_id@p ;
