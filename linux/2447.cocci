...
position p;
@@
 struct imxdma_filter_data cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct imxdma_desc {  struct list_head node ;  struct dma_async_tx_descriptor desc ;  enum dma_status status ;  dma_addr_t src ;  dma_addr_t dest ;  size_t len ;  enum dma_transfer_direction direction ;  enum imxdma_prep_type type ;  unsigned int config_port ;  unsigned int config_mem ;  unsigned int x ;  unsigned int y ;  unsigned int w ;  struct scatterlist * sg ;  unsigned int sgcount ; } cocci_id@p ;
...
typedef u16;
@@
 struct imx_dma_2d_config {  u16 xsr ;  u16 ysr ;  u16 wsr ;  int count ; } cocci_id@p ;
...
position p;
@@
 enum imx_dma_type { IMX1_DMA , IMX21_DMA , IMX27_DMA , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct imxdma_engine {  struct device * dev ;  struct device_dma_parameters dma_parms ;  struct dma_device dma_device ;  void __iomem * base ;  struct clk * dma_ahb ;  struct clk * dma_ipg ;  spinlock_t lock ;  struct imx_dma_2d_config slots_2d [ IMX_DMA_2D_SLOTS ] ;  struct imxdma_channel channel [ IMX_DMA_CHANNELS ] ;  enum imx_dma_type devtype ;  unsigned int irq ;  unsigned int irq_err ; } cocci_id@p ;
...
position p;
@@
 struct imxdma_engine * cocci_id@p ;
...
position p;
@@
 struct imxdma_channel * cocci_id@p ;
...
position p;
@@
 struct imxdma_filter_data {  struct imxdma_engine * imxdma ;  int request ; } cocci_id@p ;
...
position p;
@@
 enum imxdma_prep_type { IMXDMA_DESC_MEMCPY , IMXDMA_DESC_INTERLEAVED , IMXDMA_DESC_SLAVE_SG , IMXDMA_DESC_CYCLIC , } cocci_id@p ;
