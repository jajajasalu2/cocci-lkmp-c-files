...
position p;
@@
 struct hda_vendor_id cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct hdac_device * codec ) ;
...
position p;
@@
 struct hda_rate_tbl cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct hdac_device * codec ) ;
...
position p;
@@
 const struct hda_vendor_id * cocci_id@p ;
...
position p;
@@
 struct hda_vendor_id {  unsigned int id ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct hda_rate_tbl {  unsigned int hz ;  unsigned int alsa_bits ;  unsigned int hda_fmt ; } cocci_id@p ;
