...
position p;
@@
 void cocci_id@p ( struct av7110 * av7110 ) ;
...
position p;
@@
 const struct sp8870_config cocci_id@p ;
...
position p;
@@
 struct ves1820_config cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dvb_demux_feed * feed ) ;
...
position p;
@@
 struct tda8083_config cocci_id@p ;
...
position p;
@@
 struct dmx_section_filter * cocci_id@p ;
...
position p;
@@
 struct ves1x93_config cocci_id@p ;
...
position p;
@@
 struct l64781_config cocci_id@p ;
