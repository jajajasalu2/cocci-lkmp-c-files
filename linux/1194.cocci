...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * shost , struct scsi_cmnd * srb ) ;
...
position p;
@@
 const unsigned char cocci_id@p [ 256 / 8 ] ;
...
position p;
@@
 void cocci_id@p ( struct urb * transfer ) ;
...
position p;
@@
 mts_scsi_cmnd_callback cocci_id@p ;
