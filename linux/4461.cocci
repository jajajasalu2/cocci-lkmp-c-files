...
typedef u32;
@@
 struct omap_rom_rng {  struct clk * clk ;  struct device * dev ;  struct hwrng ops ;  u32 ( * rom_rng_call ) ( u32 ptr , u32 count , u32 flag ) ; } cocci_id@p ;
...
position p;
@@
 struct omap_rom_rng * cocci_id@p ;
