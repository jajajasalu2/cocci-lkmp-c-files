...
position p;
@@
 struct bch_geometry * cocci_id@p ;
...
position p;
@@
 struct gpmi_transfer * cocci_id@p ;
...
position p;
@@
 const struct gpmi_devdata cocci_id@p ;
...
position p;
@@
 struct boot_rom_geometry * cocci_id@p ;
...
position p;
@@
 struct gpmi_nfc_hardware_timing * cocci_id@p ;
...
position p;
@@
 struct gpmi_nand_data * cocci_id@p ;
