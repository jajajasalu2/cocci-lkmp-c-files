...
typedef s32;
@@
 struct hid_humidity_state {  struct hid_sensor_common common_attributes ;  struct hid_sensor_hub_attribute_info humidity_attr ;  s32 humidity_data ;  int scale_pre_decml ;  int scale_post_decml ;  int scale_precision ;  int value_offset ; } cocci_id@p ;
...
position p;
@@
 struct hid_humidity_state * cocci_id@p ;
