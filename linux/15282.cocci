...
typedef u32;
@@
 struct sc27xx_led_priv {  struct sc27xx_led leds [ SC27XX_LEDS_MAX ] ;  struct regmap * regmap ;  struct mutex lock ;  u32 base ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct sc27xx_led {  struct fwnode_handle * fwnode ;  struct led_classdev ldev ;  struct sc27xx_led_priv * priv ;  u8 line ;  bool active ; } cocci_id@p ;
...
position p;
@@
 struct sc27xx_led_priv * cocci_id@p ;
