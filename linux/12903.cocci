...
position p;
@@
 struct d_cr_dmap cocci_id@p [ DNV_NUM_CHANNELS ] ;
...
position p;
@@
 struct b_cr_touud_hi_pci cocci_id@p ;
...
position p;
@@
 struct b_cr_asym_mem_region_denverton * cocci_id@p ;
...
position p;
@@
 struct b_cr_asym_mem_region0_mchbar * cocci_id@p ;
...
position p;
@@
 struct d_cr_dmap2 cocci_id@p [ DNV_NUM_CHANNELS ] ;
...
position p;
@@
 struct b_cr_mot_out_base_mchbar cocci_id@p ;
...
position p;
@@
 struct b_cr_slice_channel_hash cocci_id@p ;
...
position p;
@@
 struct b_cr_asym_2way_mem_region_mchbar * cocci_id@p ;
...
position p;
@@
 struct d_cr_dmap1 cocci_id@p [ DNV_NUM_CHANNELS ] ;
...
position p;
@@
 struct mem_ctl_info * cocci_id@p ;
...
position p;
@@
 struct b_cr_mchbar_hi_pci cocci_id@p ;
...
position p;
@@
 enum hw_event_mc_err_type cocci_id@p ;
...
position p;
@@
 struct b_cr_mchbar_lo_pci cocci_id@p ;
...
position p;
@@
 struct b_cr_mot_out_mask_mchbar cocci_id@p ;
...
position p;
@@
 struct d_cr_dmap5 cocci_id@p [ DNV_NUM_CHANNELS ] ;
...
position p;
@@
 struct d_cr_ecc_ctrl cocci_id@p [ DNV_NUM_CHANNELS ] ;
...
position p;
@@
 struct d_cr_dmap3 cocci_id@p [ DNV_NUM_CHANNELS ] ;
...
position p;
@@
 struct b_cr_tolud_pci cocci_id@p ;
...
position p;
@@
 struct dram_addr {  int chan ;  int dimm ;  int rank ;  int bank ;  int row ;  int col ; } cocci_id@p ;
...
position p;
@@
 struct b_cr_touud_lo_pci cocci_id@p ;
...
position p;
@@
 struct dimm_geometry * cocci_id@p ;
...
position p;
@@
 struct d_cr_dmap4 cocci_id@p [ DNV_NUM_CHANNELS ] ;
...
position p;
@@
 struct d_cr_drp cocci_id@p [ DNV_NUM_CHANNELS ] ;
...
position p;
@@
 const int cocci_id@p [ APL_NUM_CHANNELS ] ;
...
position p;
@@
 const int cocci_id@p [ DNV_NUM_CHANNELS ] ;
...
position p;
@@
 struct b_cr_asym_mem_region1_mchbar cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PND2_BLOB_SIZE ] ;
...
position p;
@@
 struct edac_mc_layer cocci_id@p [ 2 ] ;
...
position p;
@@
 struct debugfs_blob_wrapper cocci_id@p ;
...
typedef u64,u8;
@@
 struct region {  u64 base ;  u64 limit ;  u8 enabled ; } cocci_id@p ;
...
position p;
@@
 struct d_cr_drp0 cocci_id@p [ APL_NUM_CHANNELS ] ;
