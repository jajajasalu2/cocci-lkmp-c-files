...
position p;
@@
 const enum edac_type cocci_id@p [ ] ;
...
position p;
@@
 struct amd76x_error_info * cocci_id@p ;
...
typedef u32;
@@
 struct amd76x_error_info {  u32 ecc_mode_status ; } cocci_id@p ;
...
position p;
@@
 struct amd76x_dev_info {  const char * ctl_name ; } cocci_id@p ;
...
position p;
@@
 enum amd76x_chips { AMD761 = 0 , AMD762 , } cocci_id@p ;
...
position p;
@@
 const struct amd76x_dev_info cocci_id@p [ ] ;
