...
position p;
@@
 struct s3c24xx_uart_port * cocci_id@p ;
...
position p;
@@
 struct s3c2410_uartcfg cocci_id@p ;
...
position p;
@@
 struct s3c24xx_serial_drv_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct uart_port * port , unsigned char c ) ;
...
position p;
@@
 struct samsung_early_console_data * cocci_id@p ;
...
position p;
@@
 struct s3c24xx_uart_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s3c24xx_uart_port * ourport ) ;
...
position p;
@@
 int cocci_id@p ( struct uart_port * port ) ;
...
typedef u32;
@@
 struct samsung_early_console_data {  u32 txfull_mask ; } cocci_id@p ;
...
position p;
@@
 struct s3c24xx_uart_dma * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_CLK_NAME_LENGTH ] ;
...
position p;
@@
 struct s3c24xx_uart_port cocci_id@p [ CONFIG_SERIAL_SAMSUNG_UARTS ] ;
