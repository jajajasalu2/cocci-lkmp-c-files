...
position p;
@@
 enum rpmsg_ns_flags { RPMSG_NS_CREATE = 0 , RPMSG_NS_DESTROY = 1 , } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct rpmsg_endpoint * ept , void * data , int len , u32 dst ) ;
...
position p;
@@
 struct virtio_rpmsg_channel * cocci_id@p ;
...
position p;
@@
 struct virtio_rpmsg_channel {  struct rpmsg_device rpdev ;  struct virtproc_info * vrp ; } cocci_id@p ;
...
position p;
@@
 struct rpmsg_ns_msg cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rpmsg_endpoint * ept ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct rpmsg_endpoint * ept , u32 src , u32 dst , void * data , int len ) ;
...
position p;
@@
 struct virtproc_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct rpmsg_endpoint * ept , void * data , int len ) ;
