...
typedef u32;
@@
 struct _pll_div {  u32 divsel : 1 ;  u32 divctl : 1 ;  u32 lf : 1 ;  u32 n : 4 ;  u32 k : 24 ; } cocci_id@p ;
...
typedef u32;
@@
 struct wm9713_priv {  struct snd_ac97 * ac97 ;  u32 pll_in ;  unsigned int hp_mixer [ 2 ] ;  struct mutex lock ;  struct wm97xx_platform_data * mfd_pdata ; } cocci_id@p ;
