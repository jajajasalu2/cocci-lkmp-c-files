...
position p;
@@
 const struct timing_reg cocci_id@p [ ] ;
...
position p;
@@
 struct devfreq_event_data cocci_id@p ;
...
typedef u32;
@@
 struct dmc_opp_table {  u32 freq_hz ;  u32 volt_uv ; } cocci_id@p ;
...
position p;
@@
 struct dmc_opp_table cocci_id@p ;
...
position p;
@@
 struct devfreq_event_dev cocci_id@p ;
...
position p;
@@
 struct timing_reg {  char * name ;  int bit_beg ;  int bit_end ;  unsigned int val ; } cocci_id@p ;
