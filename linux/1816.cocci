...
position p;
@@
 struct ltr501_samp_table {  int freq_val ;  int time_val ; } cocci_id@p ;
...
position p;
@@
 struct ltr501_chip_info * cocci_id@p ;
...
position p;
@@
 const struct ltr501_samp_table * cocci_id@p ;
...
position p;
@@
 enum { ltr501 = 0 , ltr559 , ltr301 , } cocci_id@p ;
...
position p;
@@
 struct ltr501_gain {  int scale ;  int uscale ; } cocci_id@p ;
...
typedef u8;
@@
 struct ltr501_chip_info {  u8 partid ;  struct ltr501_gain * als_gain ;  int als_gain_tbl_size ;  struct ltr501_gain * ps_gain ;  int ps_gain_tbl_size ;  u8 als_mode_active ;  u8 als_gain_mask ;  u8 als_gain_shift ;  const struct iio_chan_spec * channels ;  const int no_channels ;  const struct iio_info * info ;  const struct iio_info * info_no_irq ; } cocci_id@p ;
