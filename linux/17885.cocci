...
position p;
@@
 struct cookie_state cocci_id@p ;
...
position p;
@@
 const struct ldc_mode_ops cocci_id@p ;
...
position p;
@@
 struct ldc_mtable_entry * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct ldc_iommu {  spinlock_t lock ;  struct ldc_mtable_entry * page_table ;  struct iommu_map_table iommu_map_table ; } cocci_id@p ;
...
typedef u16;
@@
 struct ldc_version {  u16 major ;  u16 minor ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct cookie_state {  struct ldc_mtable_entry * page_table ;  struct ldc_trans_cookie * cookies ;  u64 mte_base ;  u64 prev_cookie ;  u32 pte_idx ;  u32 nc ; } cocci_id@p ;
...
position p;
@@
 const struct ldc_channel_config * cocci_id@p ;
...
position p;
@@
 struct iommu_map_table * cocci_id@p ;
...
position p;
@@
 struct ldc_mode_ops {  int ( * write ) ( struct ldc_channel * , const void * , unsigned int ) ;  int ( * read ) ( struct ldc_channel * , void * , unsigned int ) ; } cocci_id@p ;
