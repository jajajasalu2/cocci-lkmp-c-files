...
position p;
@@
 enum cachefiles_obj_ref_trace cocci_id@p ;
...
position p;
@@
 struct cachefiles_cache cocci_id@p ;
...
position p;
@@
 struct cachefiles_xattr * cocci_id@p ;
...
position p;
@@
 struct cachefiles_object cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fscache_object * _object ) ;
...
position p;
@@
 const struct fscache_cache_ops cocci_id@p ;
...
position p;
@@
 struct cachefiles_lookup_data {  struct cachefiles_xattr * auxdata ;  char * key ; } cocci_id@p ;
...
position p;
@@
 struct cachefiles_lookup_data * cocci_id@p ;
