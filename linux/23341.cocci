...
position p;
@@
 struct {  int div ;  int rate ;  int mode ;  int mclk_div ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wm8903_platform_data * cocci_id@p ;
...
position p;
@@
 struct {  int rate ;  int value ; } cocci_id@p [ ] ;
...
position p;
@@
 const char * cocci_id@p [ WM8903_NUM_SUPPLIES ] ;
...
position p;
@@
 struct {  int ratio ;  int div ; } cocci_id@p [ ] ;
