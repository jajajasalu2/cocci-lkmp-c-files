...
typedef u32;
@@
 u32 cocci_id@p [ 3 ] [ RF_REG_NUM_FOR_C_CUT_5G_INTERNALPA ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ RF_REG_NUM_FOR_C_CUT_5G ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ 1 ] [ 3 ] [ MAX_RF_IMR_INDEX_NORMAL ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ TARGET_CHNL_NUM_2G ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ RF_REG_NUM_FOR_C_CUT_2G ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ 3 ] [ RF_REG_NUM_FOR_C_CUT_2G ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ TARGET_CHNL_NUM_5G ] ;
...
position p;
@@
 struct iqk_matrix_regs cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RF_CHNL_NUM_5G_40M ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ RF_REG_NUM_FOR_C_CUT_5G_INTERNALPA ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MAX_RF_IMR_INDEX_NORMAL ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ RF_REG_NUM_FOR_C_CUT_2G ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ 5 ] [ RF_REG_NUM_FOR_C_CUT_5G ] ;
