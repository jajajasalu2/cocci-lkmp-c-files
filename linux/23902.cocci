...
position p;
@@
 struct xfrm_user_polexpire cocci_id@p ;
...
position p;
@@
 struct xfrm_user_offload cocci_id@p ;
...
position p;
@@
 struct xfrm_user_tmpl cocci_id@p [ XFRM_MAX_DEPTH ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ XFRMA_MAX + 1 ] ;
...
position p;
@@
 struct xfrm_user_acquire * cocci_id@p ;
...
position p;
@@
 struct xfrm_userpolicy_id * cocci_id@p ;
...
position p;
@@
 struct xfrm_replay_state_esn * * cocci_id@p ;
...
position p;
@@
 struct xfrm_algo_auth cocci_id@p ;
...
position p;
@@
 struct xfrmu_spdhthresh cocci_id@p ;
...
position p;
@@
 struct netlink_kernel_cfg cocci_id@p ;
...
position p;
@@
 struct xfrm_userspi_info * cocci_id@p ;
...
position p;
@@
 struct xfrm_userpolicy_type * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfrm_attr_type_t;
@@
 enum xfrm_attr_type_t cocci_id@p ;
...
position p;
@@
 struct xfrm_replay_state cocci_id@p ;
...
position p;
@@
 struct xfrm_algo_aead * cocci_id@p ;
...
position p;
@@
 struct xfrm_usersa_flush cocci_id@p ;
...
position p;
@@
 struct xfrm_user_tmpl * cocci_id@p ;
...
position p;
@@
 const struct xfrm_link * cocci_id@p ;
...
position p;
@@
 struct xfrm_user_mapping cocci_id@p ;
...
position p;
@@
 struct xfrm_dump_info * cocci_id@p ;
...
position p;
@@
 struct xfrm_user_kmaddress * cocci_id@p ;
...
position p;
@@
 struct xfrm_algo_desc * ( * cocci_id@p ) ( const char * , int ) ;
...
position p;
@@
 struct xfrm_userpolicy_info cocci_id@p ;
...
position p;
@@
 struct xfrm_state_offload * cocci_id@p ;
...
position p;
@@
 struct xfrm_user_report * cocci_id@p ;
...
position p;
@@
 struct xfrm_lifetime_cur * cocci_id@p ;
...
position p;
@@
 struct xfrm_usersa_info cocci_id@p ;
...
position p;
@@
 struct xfrmk_sadinfo cocci_id@p ;
...
position p;
@@
 struct xfrm_user_expire cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ XFRM_NR_MSGTYPES ] ;
...
position p;
@@
 struct xfrm_user_migrate cocci_id@p ;
...
position p;
@@
 struct xfrm_state_walk * cocci_id@p ;
...
position p;
@@
 struct xfrm_aevent_id cocci_id@p ;
...
position p;
@@
 struct xfrmu_spdhinfo cocci_id@p ;
...
typedef u32,u16;
@@
 struct xfrm_dump_info {  struct sk_buff * in_skb ;  struct sk_buff * out_skb ;  u32 nlmsg_seq ;  u16 nlmsg_flags ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ XFRMA_SPD_MAX + 1 ] ;
...
position p;
@@
 struct xfrm_usersa_id * cocci_id@p ;
...
position p;
@@
 struct xfrmu_sadhinfo cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ XFRMA_MAX + 1 ] ;
...
position p;
@@
 struct xfrmu_spdinfo cocci_id@p ;
