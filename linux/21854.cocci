...
typedef u8;
@@
 struct genradix_node {  union {  struct genradix_node * children [ GENRADIX_ARY ] ;  u8 data [ PAGE_SIZE ] ; } ; } cocci_id@p ;
...
position p;
@@
 struct genradix_iter * cocci_id@p ;
...
position p;
@@
 struct genradix_node * * cocci_id@p ;
...
position p;
@@
 struct genradix_root * cocci_id@p ;
