...
position p;
@@
 struct cbcmac_desc_ctx * cocci_id@p ;
...
position p;
@@
 struct ccm_instance_ctx * cocci_id@p ;
...
position p;
@@
 struct crypto_ccm_req_priv_ctx * cocci_id@p ;
...
position p;
@@
 struct scatterlist cocci_id@p [ 3 ] ;
...
position p;
@@
 struct cbcmac_tfm_ctx {  struct crypto_cipher * child ; } cocci_id@p ;
...
position p;
@@
 struct crypto_rfc4309_req_ctx {  struct scatterlist src [ 3 ] ;  struct scatterlist dst [ 3 ] ;  struct aead_request subreq ; } cocci_id@p ;
...
position p;
@@
 struct crypto_rfc4309_ctx cocci_id@p ;
...
position p;
@@
 struct crypto_spawn * cocci_id@p ;
...
position p;
@@
 struct crypto_rfc4309_req_ctx cocci_id@p ;
...
position p;
@@
 struct cbcmac_desc_ctx {  unsigned int len ; } cocci_id@p ;
...
position p;
@@
 struct ccm_instance_ctx {  struct crypto_skcipher_spawn ctr ;  struct crypto_ahash_spawn mac ; } cocci_id@p ;
...
position p;
@@
 struct crypto_ccm_ctx cocci_id@p ;
...
position p;
@@
 struct cbcmac_tfm_ctx * cocci_id@p ;
...
position p;
@@
 struct shash_instance * cocci_id@p ;
...
typedef u8,u32;
@@
 struct crypto_ccm_req_priv_ctx {  u8 odata [ 16 ] ;  u8 idata [ 16 ] ;  u8 auth_tag [ 16 ] ;  u32 flags ;  struct scatterlist src [ 3 ] ;  struct scatterlist dst [ 3 ] ;  union {  struct ahash_request ahreq ;  struct skcipher_request skreq ; } ; } cocci_id@p ;
...
typedef u8;
@@
 struct crypto_rfc4309_ctx {  struct crypto_aead * child ;  u8 nonce [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct crypto_ccm_ctx {  struct crypto_ahash * mac ;  struct crypto_skcipher * ctr ; } cocci_id@p ;
