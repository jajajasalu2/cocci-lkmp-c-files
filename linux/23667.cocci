...
position p;
@@
 const struct {  int rate ;  int sample_rate ;  int dsp_clk ;  unsigned long gclk_rate ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct atmel_classd_pdata * cocci_id@p ;
...
position p;
@@
 struct atmel_classd * cocci_id@p ;
...
position p;
@@
 struct atmel_classd_pdata * cocci_id@p ;
...
typedef bool;
@@
 struct atmel_classd_pdata {  bool non_overlap_enable ;  int non_overlap_time ;  int pwm_type ;  const char * card_name ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct atmel_classd {  dma_addr_t phy_base ;  struct regmap * regmap ;  struct clk * pclk ;  struct clk * gclk ;  struct device * dev ;  int irq ;  const struct atmel_classd_pdata * pdata ; } cocci_id@p ;
