...
typedef u32;
@@
 struct ep93xx_tstat {  u32 tstat0 ; } cocci_id@p ;
...
position p;
@@
 struct ep93xx_rstat cocci_id@p ;
...
typedef u32;
@@
 struct ep93xx_tdesc {  u32 buf_addr ;  u32 tdesc1 ; } cocci_id@p ;
...
position p;
@@
 struct ep93xx_eth_data * cocci_id@p ;
...
position p;
@@
 struct ep93xx_tdesc cocci_id@p ;
...
position p;
@@
 struct ep93xx_descs cocci_id@p ;
...
position p;
@@
 struct ep93xx_rdesc cocci_id@p ;
...
position p;
@@
 struct ep93xx_tstat * cocci_id@p ;
...
position p;
@@
 struct ep93xx_descs {  struct ep93xx_rdesc rdesc [ RX_QUEUE_ENTRIES ] ;  struct ep93xx_tdesc tdesc [ TX_QUEUE_ENTRIES ] ;  struct ep93xx_rstat rstat [ RX_QUEUE_ENTRIES ] ;  struct ep93xx_tstat tstat [ TX_QUEUE_ENTRIES ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct ep93xx_rstat {  u32 rstat0 ;  u32 rstat1 ; } cocci_id@p ;
...
typedef u32;
@@
 struct ep93xx_rdesc {  u32 buf_addr ;  u32 rdesc1 ; } cocci_id@p ;
