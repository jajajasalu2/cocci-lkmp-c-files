...
typedef s64;
@@
 struct acpi_dev_match_info {  struct acpi_device_id hid [ 2 ] ;  const char * uid ;  s64 hrv ; } cocci_id@p ;
...
position p;
@@
 struct acpi_pld_info * * cocci_id@p ;
...
position p;
@@
 const struct acpi_platform_list * cocci_id@p ;
...
position p;
@@
 const struct acpi_dev_match_info * cocci_id@p ;
...
position p;
@@
 struct acpi_dev_match_info cocci_id@p ;
