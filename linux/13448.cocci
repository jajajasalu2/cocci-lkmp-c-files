...
position p;
@@
 const struct em28xx_ops * cocci_id@p ;
...
position p;
@@
 const struct em28xx_vol_otable cocci_id@p [ ] ;
...
typedef u8;
@@
 struct em28xx_vol_otable {  enum em28xx_aout mux ;  u8 reg ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct em28xx * dev , struct urb * urb ) ;
...
typedef u8;
@@
 struct em28xx_vol_itable {  enum em28xx_amux mux ;  u8 reg ; } cocci_id@p ;
...
position p;
@@
 struct em28xx_vol_itable cocci_id@p [ ] ;
...
position p;
@@
 struct em28xx_usb_bufs * cocci_id@p ;
...
position p;
@@
 enum em28xx_led_role cocci_id@p ;
