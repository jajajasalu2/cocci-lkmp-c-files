...
position p;
@@
 struct tfp410_encoder {  struct drm_encoder base ;  struct tfp410_module * mod ;  int dpms ; } cocci_id@p ;
...
position p;
@@
 struct tfp410_module * cocci_id@p ;
...
position p;
@@
 struct tfp410_connector * cocci_id@p ;
...
position p;
@@
 struct tfp410_module {  struct tilcdc_module base ;  struct i2c_adapter * i2c ;  int gpio ; } cocci_id@p ;
...
position p;
@@
 struct tfp410_encoder cocci_id@p ;
...
position p;
@@
 struct tfp410_connector {  struct drm_connector base ;  struct drm_encoder * encoder ;  struct tfp410_module * mod ; } cocci_id@p ;
