...
position p;
@@
 struct jz4740_wdt_drvdata cocci_id@p ;
...
position p;
@@
 struct jz4740_wdt_drvdata {  struct watchdog_device wdt ;  struct regmap * map ;  struct clk * clk ;  unsigned long clk_rate ; } cocci_id@p ;
