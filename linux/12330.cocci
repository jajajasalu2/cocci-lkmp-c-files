...
position p;
@@
 struct vc4_dpi_encoder cocci_id@p ;
...
position p;
@@
 struct vc4_dpi_encoder {  struct vc4_encoder base ;  struct vc4_dpi * dpi ; } cocci_id@p ;
...
position p;
@@
 struct vc4_dpi {  struct platform_device * pdev ;  struct drm_encoder * encoder ;  void __iomem * regs ;  struct clk * pixel_clock ;  struct clk * core_clock ;  struct debugfs_regset32 regset ; } cocci_id@p ;
