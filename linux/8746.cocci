...
position p;
@@
 struct fcoe_rx_stat cocci_id@p ;
...
position p;
@@
 struct qed_fcoe_conn * cocci_id@p ;
...
position p;
@@
 struct fcoe_conn_terminate_ramrod_params * cocci_id@p ;
...
position p;
@@
 struct fcoe_conn_offload_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_fcoe_pf_params * cocci_id@p ;
...
position p;
@@
 struct qed_hash_fcoe_con {  struct hlist_node node ;  struct qed_fcoe_conn * con ; } cocci_id@p ;
...
position p;
@@
 struct qed_cxt_info cocci_id@p ;
...
position p;
@@
 struct qed_fcoe_tid * cocci_id@p ;
...
position p;
@@
 struct e4_fcoe_task_context cocci_id@p ;
...
position p;
@@
 struct qed_fcoe_info * cocci_id@p ;
...
position p;
@@
 struct qed_dev_fcoe_info * cocci_id@p ;
...
position p;
@@
 struct qed_mcp_fcoe_stats * cocci_id@p ;
...
position p;
@@
 struct e4_fcoe_conn_context * cocci_id@p ;
...
position p;
@@
 struct qed_hash_fcoe_con * cocci_id@p ;
...
position p;
@@
 struct fcoe_init_func_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct fcoe_tx_stat cocci_id@p ;
