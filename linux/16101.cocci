...
position p;
@@
 struct das800_board {  const char * name ;  int ai_speed ;  const struct comedi_lrange * ai_range ;  int resolution ; } cocci_id@p ;
...
position p;
@@
 struct das800_private {  unsigned int do_bits ; } cocci_id@p ;
...
position p;
@@
 const struct das800_board cocci_id@p [ ] ;
...
position p;
@@
 enum das800_boardinfo { BOARD_DAS800 , BOARD_CIODAS800 , BOARD_DAS801 , BOARD_CIODAS801 , BOARD_DAS802 , BOARD_CIODAS802 , BOARD_CIODAS80216 , } cocci_id@p ;
...
position p;
@@
 struct das800_private * cocci_id@p ;
...
position p;
@@
 struct das800_board cocci_id@p ;
