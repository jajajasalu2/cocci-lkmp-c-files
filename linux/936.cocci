...
position p;
@@
 struct gpiomtd {  void __iomem * io_sync ;  struct nand_chip nand_chip ;  struct gpio_nand_platdata plat ;  struct gpio_desc * nce ;  struct gpio_desc * cle ;  struct gpio_desc * ale ;  struct gpio_desc * rdy ;  struct gpio_desc * nwp ; } cocci_id@p ;
...
position p;
@@
 struct gpio_nand_platdata * cocci_id@p ;
