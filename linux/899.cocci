...
position p;
@@
 struct nand_operation cocci_id@p ;
...
position p;
@@
 struct nand_op_instr cocci_id@p [ ] ;
...
position p;
@@
 struct nand_op_parser_ctx cocci_id@p ;
...
position p;
@@
 const struct nand_op_parser_pattern * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ONFI_SUBFEATURE_PARAM_LEN ] ;
...
position p;
@@
 struct nand_flash_dev * cocci_id@p ;
...
position p;
@@
 const struct nand_pos * cocci_id@p ;
...
position p;
@@
 const struct nand_ecc_caps * cocci_id@p ;
...
position p;
@@
 const struct nand_ecc_step_info * cocci_id@p ;
...
position p;
@@
 struct nand_op_parser_ctx {  const struct nand_op_instr * instrs ;  unsigned int ninstrs ;  struct nand_subop subop ; } cocci_id@p ;
...
position p;
@@
 const struct nand_ops cocci_id@p ;
...
position p;
@@
 const struct nand_op_parser_pattern_elem * cocci_id@p ;
...
position p;
@@
 const struct nand_op_parser_ctx * cocci_id@p ;
...
position p;
@@
 struct nand_bch_control * cocci_id@p ;
...
position p;
@@
 struct mtd_ecc_stats cocci_id@p ;
...
position p;
@@
 const struct nand_manufacturer * cocci_id@p ;
...
position p;
@@
 struct nand_data_interface cocci_id@p ;
