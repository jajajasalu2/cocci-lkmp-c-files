...
position p;
@@
 struct sock * cocci_id@p [ SKARR_SZ ] ;
...
position p;
@@
 const struct inet_diag_handler * * cocci_id@p ;
...
position p;
@@
 struct inet_diag_req_v2 cocci_id@p ;
...
position p;
@@
 struct inet_diag_entry cocci_id@p ;
...
position p;
@@
 struct tcpvegas_info cocci_id@p ;
...
position p;
@@
 struct inet_diag_handler * cocci_id@p ;
...
position p;
@@
 struct inet_diag_hostcond * cocci_id@p ;
...
position p;
@@
 struct inet_diag_msg cocci_id@p ;
...
position p;
@@
 struct inet_diag_meminfo cocci_id@p ;
...
position p;
@@
 struct inet_diag_req cocci_id@p ;
...
position p;
@@
 struct inet_diag_bc_op cocci_id@p ;
...
position p;
@@
 const struct inet_diag_bc_op * cocci_id@p ;
...
position p;
@@
 const struct inet_diag_entry * cocci_id@p ;
...
position p;
@@
 struct inet_diag_markcond * cocci_id@p ;
...
position p;
@@
 const struct inet_diag_req_v2 * cocci_id@p ;
...
position p;
@@
 const struct inet_diag_hostcond * cocci_id@p ;
...
position p;
@@
 const struct sock_diag_handler cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,u16,__be32;
@@
 struct inet_diag_entry {  const __be32 * saddr ;  const __be32 * daddr ;  u16 sport ;  u16 dport ;  u16 family ;  u16 userlocks ;  u32 ifindex ;  u32 mark ; } cocci_id@p ;
