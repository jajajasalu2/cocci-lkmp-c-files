...
typedef u16;
@@
 const u16 cocci_id@p [ UDA1380_CACHEREGNUM ] ;
...
position p;
@@
 struct uda1380_priv cocci_id@p ;
...
typedef u16;
@@
 struct uda1380_priv {  struct snd_soc_component * component ;  unsigned int dac_clk ;  struct work_struct work ;  struct i2c_client * i2c ;  u16 * reg_cache ; } cocci_id@p ;
