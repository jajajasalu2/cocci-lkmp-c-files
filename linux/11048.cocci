...
position p;
@@
 struct kfd_hsa_hw_exception_data cocci_id@p ;
...
position p;
@@
 struct kfd_hsa_memory_exception_data cocci_id@p ;
...
position p;
@@
 const struct kfd_event * cocci_id@p ;
...
position p;
@@
 struct kfd_event_waiter * cocci_id@p ;
...
position p;
@@
 struct kfd_event_data cocci_id@p ;
...
@@
 struct kfd_signal_page {  uint64_t * kernel_address ;  uint64_t __user * user_address ;  bool need_to_free_pages ; } cocci_id@p ;
...
@@
 struct kfd_event_waiter {  wait_queue_entry_t wait ;  struct kfd_event * event ;  bool activated ; } cocci_id@p ;
...
position p;
@@
 struct kfd_signal_page * cocci_id@p ;
