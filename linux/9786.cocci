...
position p;
@@
 struct ath10k_swap_code_seg_tail cocci_id@p ;
...
position p;
@@
 struct ath10k_swap_code_seg_info * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ATH10K_SWAP_CODE_SEG_MAGIC_BYTES_SZ ] ;
...
position p;
@@
 const struct ath10k_fw_file * cocci_id@p ;
...
position p;
@@
 struct ath10k_swap_code_seg_tlv cocci_id@p ;
...
position p;
@@
 union ath10k_swap_code_seg_item * cocci_id@p ;
