...
position p;
@@
 enum { BAT_TEMP = 0 , PMIC_TEMP , SYSTEM_TEMP , BAT_CHRG_CURR , BAT_D_CURR , BAT_VOLT , IIO_CHANNEL_NUM , } cocci_id@p ;
...
position p;
@@
 struct axp288_fg_info {  struct platform_device * pdev ;  struct regmap * regmap ;  struct regmap_irq_chip_data * regmap_irqc ;  int irq [ AXP288_FG_INTR_NUM ] ;  struct iio_channel * iio_channel [ IIO_CHANNEL_NUM ] ;  struct power_supply * bat ;  struct mutex lock ;  int status ;  int max_volt ;  struct dentry * debug_file ; } cocci_id@p ;
...
position p;
@@
 enum { QWBTU_IRQ = 0 , WBTU_IRQ , QWBTO_IRQ , WBTO_IRQ , WL2_IRQ , WL1_IRQ , } cocci_id@p ;
...
position p;
@@
 struct axp288_fg_info * cocci_id@p ;
