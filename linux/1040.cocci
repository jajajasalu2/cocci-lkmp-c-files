...
position p;
@@
 struct ltq_mtd {  struct resource * res ;  struct mtd_info * mtd ;  struct map_info * map ; } cocci_id@p ;
...
position p;
@@
 enum { LTQ_NOR_PROBING , LTQ_NOR_NORMAL , } cocci_id@p ;
