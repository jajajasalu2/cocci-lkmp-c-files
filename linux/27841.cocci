...
position p;
@@
 char cocci_id@p [ OCFS2_ORPHAN_NAMELEN + 1 ] ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct buffer_head * * bh1 , struct inode * inode1 , struct buffer_head * * bh2 , struct inode * inode2 , int rename ) ;
...
typedef u64,bool;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct inode * * ret_orphan_dir , u64 blkno , char * name , struct ocfs2_dir_lookup_result * lookup , bool dio ) ;
...
position p;
@@
 char cocci_id@p [ OCFS2_DIO_ORPHAN_PREFIX_LEN + OCFS2_ORPHAN_NAMELEN + 1 ] ;
...
position p;
@@
 void cocci_id@p ( struct inode * inode1 , struct inode * inode2 ) ;
