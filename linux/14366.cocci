...
typedef u8;
@@
 int cocci_id@p ( struct dvb_ca_en50221 * ca , int slot , u8 * ebuf , int ecount ) ;
...
position p;
@@
 const struct dvb_ca_en50221 cocci_id@p ;
