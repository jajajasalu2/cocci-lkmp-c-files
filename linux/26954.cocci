...
position p;
@@
 const struct nfs4_string * cocci_id@p ;
...
position p;
@@
 const struct nfs4_fs_locations * cocci_id@p ;
...
position p;
@@
 const struct nfs4_pathname * cocci_id@p ;
...
position p;
@@
 const struct nfs4_fs_location * cocci_id@p ;
