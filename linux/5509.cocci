...
position p;
@@
 const struct driver_data * cocci_id@p ;
...
position p;
@@
 const struct ssp_device * cocci_id@p ;
...
position p;
@@
 const struct lpss_config * cocci_id@p ;
...
typedef u32;
@@
 struct lpss_config {  unsigned offset ;  int reg_general ;  int reg_ssp ;  int reg_cs_ctrl ;  int reg_capabilities ;  u32 rx_threshold ;  u32 tx_threshold_lo ;  u32 tx_threshold_hi ;  unsigned cs_sel_shift ;  unsigned cs_sel_mask ;  unsigned cs_num ; } cocci_id@p ;
