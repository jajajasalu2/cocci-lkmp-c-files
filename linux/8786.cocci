...
position p;
@@
 struct be_wrb_params * cocci_id@p ;
...
position p;
@@
 struct be_pmem_stats * cocci_id@p ;
...
position p;
@@
 struct be_port_rxf_stats_v2 * cocci_id@p ;
...
position p;
@@
 struct be_rxf_stats_v1 * cocci_id@p ;
...
position p;
@@
 struct amap_eth_tx_compl cocci_id@p ;
...
position p;
@@
 struct be_hw_stats_v0 * cocci_id@p ;
...
position p;
@@
 struct be_set_eqd cocci_id@p [ MAX_EVT_QS ] ;
...
position p;
@@
 struct be_eth_tx_compl * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RSS_HASH_KEY_LEN ] ;
...
position p;
@@
 struct be_hw_stats_v1 * cocci_id@p ;
...
position p;
@@
 struct be_rx_page_info * cocci_id@p ;
...
position p;
@@
 struct be_vxlan_port * cocci_id@p ;
...
position p;
@@
 struct be_port_rxf_stats_v0 * cocci_id@p ;
...
position p;
@@
 struct be_tx_compl_info * cocci_id@p ;
...
position p;
@@
 struct be_error_recovery cocci_id@p ;
...
position p;
@@
 struct be_cmd_req_get_stats_v2 cocci_id@p ;
...
position p;
@@
 struct be_erx_stats_v2 * cocci_id@p ;
...
position p;
@@
 struct be_rxf_stats_v0 * cocci_id@p ;
...
position p;
@@
 struct be_rxf_stats_v2 * cocci_id@p ;
...
position p;
@@
 struct be_port_rxf_stats_v1 * cocci_id@p ;
...
position p;
@@
 struct be_eth_rx_compl * cocci_id@p ;
...
position p;
@@
 struct amap_eth_rx_compl_v1 cocci_id@p ;
...
position p;
@@
 struct be_drv_stats * cocci_id@p ;
...
position p;
@@
 const struct be_rx_stats * cocci_id@p ;
...
position p;
@@
 struct be_cmd_req_get_stats_v0 cocci_id@p ;
...
position p;
@@
 struct be_hw_stats_v2 * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ BE_NUM_VLANS_SUPPORTED ] ;
...
position p;
@@
 struct be_eth_hdr_wrb * cocci_id@p ;
...
position p;
@@
 struct lancer_pport_stats * cocci_id@p ;
...
position p;
@@
 struct be_cmd_req_get_stats_v1 cocci_id@p ;
...
position p;
@@
 struct be_rx_compl_info * cocci_id@p ;
...
position p;
@@
 struct be_cmd_resp_get_stats_v2 * cocci_id@p ;
...
position p;
@@
 struct be_cmd_resp_get_stats_v0 * cocci_id@p ;
...
position p;
@@
 struct be_cmd_resp_get_stats_v1 * cocci_id@p ;
...
position p;
@@
 const struct be_tx_stats * cocci_id@p ;
