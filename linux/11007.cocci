...
position p;
@@
 struct SMU7_Discrete_PmFuses cocci_id@p ;
...
position p;
@@
 struct SMU7_Discrete_GraphicsLevel * cocci_id@p ;
...
position p;
@@
 struct pp_atomctrl_internal_ss_info cocci_id@p ;
...
position p;
@@
 struct SMU7_Discrete_MCArbDramTimingTableEntry * cocci_id@p ;
...
position p;
@@
 struct SMU7_Discrete_MemoryLevel * cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 4 ] ;
...
position p;
@@
 const struct phm_phase_shedding_limits_table * cocci_id@p ;
...
position p;
@@
 const struct ci_smumgr * cocci_id@p ;
...
position p;
@@
 pp_atomctrl_voltage_table_entry * cocci_id@p ;
...
position p;
@@
 struct SMU7_Discrete_Ulv * cocci_id@p ;
...
position p;
@@
 struct cgs_firmware_info cocci_id@p ;
