...
position p;
@@
 struct hash_ipport6_elem cocci_id@p ;
...
position p;
@@
 const struct hash_ipport4_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_ipport6_elem * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct hash_ipport4_elem {  __be32 ip ;  __be16 port ;  u8 proto ;  u8 padding ; } cocci_id@p ;
...
typedef u8;
@@
 struct hash_ipport6_elem {  union nf_inet_addr ip ;  __be16 port ;  u8 proto ;  u8 padding ; } cocci_id@p ;
...
position p;
@@
 struct hash_ipport4_elem cocci_id@p ;
...
position p;
@@
 const struct hash_ipport6 * cocci_id@p ;
...
position p;
@@
 const struct hash_ipport4 * cocci_id@p ;
