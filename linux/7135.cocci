...
position p;
@@
 struct xen_pvcalls_sring * cocci_id@p ;
...
position p;
@@
 struct pvcalls_bedata cocci_id@p ;
...
@@
 struct pvcalls_bedata {  struct xen_pvcalls_front_ring ring ;  grant_ref_t ref ;  int irq ;  struct list_head socket_mappings ;  spinlock_t socket_lock ;  wait_queue_head_t inflight_req ;  struct xen_pvcalls_response rsp [ PVCALLS_NR_RSP_PER_RING ] ; } cocci_id@p ;
