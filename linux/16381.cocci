...
position p;
@@
 const struct roccat_common2_device * cocci_id@p ;
...
position p;
@@
 struct roccat_common2_device * cocci_id@p ;
...
position p;
@@
 const struct savu_mouse_report_special * cocci_id@p ;
...
position p;
@@
 struct savu_roccat_report cocci_id@p ;
