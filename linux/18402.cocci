...
position p;
@@
 struct l4f00242t03_pdata cocci_id@p ;
...
position p;
@@
 struct imxmmc_platform_data cocci_id@p ;
...
position p;
@@
 const struct fsl_usb2_platform_data cocci_id@p ;
...
position p;
@@
 const struct mxc_nand_platform_data cocci_id@p ;
