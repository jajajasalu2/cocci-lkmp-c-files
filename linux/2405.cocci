...
position p;
@@
 struct mmp_pdma_desc_sw {  struct mmp_pdma_desc_hw desc ;  struct list_head node ;  struct list_head tx_list ;  struct dma_async_tx_descriptor async_tx ; } cocci_id@p ;
...
position p;
@@
 struct mmp_pdma_device cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dma_chan * dchan , struct dma_slave_config * cfg , enum dma_transfer_direction direction ) ;
...
typedef spinlock_t;
@@
 struct mmp_pdma_device {  int dma_channels ;  void __iomem * base ;  struct device * dev ;  struct dma_device device ;  struct mmp_pdma_phy * phy ;  spinlock_t phy_lock ; } cocci_id@p ;
...
position p;
@@
 struct mmp_pdma_phy cocci_id@p ;
...
position p;
@@
 struct mmp_pdma_desc_sw * cocci_id@p ;
...
position p;
@@
 struct mmp_pdma_phy {  int idx ;  void __iomem * base ;  struct mmp_pdma_chan * vchan ; } cocci_id@p ;
...
position p;
@@
 struct mmp_pdma_chan * cocci_id@p ;
...
position p;
@@
 struct mmp_dma_platdata * cocci_id@p ;
...
@@
 struct mmp_pdma_chan {  struct device * dev ;  struct dma_chan chan ;  struct dma_async_tx_descriptor desc ;  struct mmp_pdma_phy * phy ;  enum dma_transfer_direction dir ;  struct dma_slave_config slave_config ;  struct mmp_pdma_desc_sw * cyclic_first ;  struct tasklet_struct tasklet ;  u32 dcmd ;  u32 drcmr ;  u32 dev_addr ;  spinlock_t desc_lock ;  struct list_head chain_pending ;  struct list_head chain_running ;  bool idle ;  bool byte_align ;  struct dma_pool * desc_pool ; } cocci_id@p ;
