...
position p;
@@
 struct nfsd3_createres cocci_id@p ;
...
position p;
@@
 struct nfsd3_linkres * cocci_id@p ;
...
position p;
@@
 struct nfsd3_symlinkargs * cocci_id@p ;
...
position p;
@@
 struct nfsd3_attrstatres cocci_id@p ;
...
position p;
@@
 struct nfsd3_diropargs * cocci_id@p ;
...
position p;
@@
 struct nfsd3_fhandleargs cocci_id@p ;
...
position p;
@@
 struct nfsd3_diropres * cocci_id@p ;
...
position p;
@@
 struct nfsd3_voidres cocci_id@p ;
...
position p;
@@
 struct nfsd3_readdirargs * cocci_id@p ;
...
position p;
@@
 struct nfsd3_createargs cocci_id@p ;
...
position p;
@@
 struct nfsd3_commitres cocci_id@p ;
...
position p;
@@
 struct nfsd3_linkargs * cocci_id@p ;
...
position p;
@@
 struct nfsd3_mknodargs cocci_id@p ;
...
position p;
@@
 struct nfsd3_readdirplusargs cocci_id@p ;
...
position p;
@@
 struct nfsd3_mkdirargs cocci_id@p ;
...
position p;
@@
 struct nfsd3_fsinfores * cocci_id@p ;
...
position p;
@@
 struct nfsd3_pathconfres * cocci_id@p ;
...
position p;
@@
 struct nfsd3_accessargs cocci_id@p ;
...
position p;
@@
 struct nfsd3_readargs * cocci_id@p ;
...
position p;
@@
 struct nfsd3_voidargs {  int dummy ; } cocci_id@p ;
...
position p;
@@
 struct nfsd3_wccstatres cocci_id@p ;
...
position p;
@@
 struct nfsd3_fsstatres * cocci_id@p ;
...
position p;
@@
 struct nfsd3_writeres * cocci_id@p ;
...
position p;
@@
 struct nfsd3_readdirres cocci_id@p ;
...
position p;
@@
 struct nfsd3_renameres cocci_id@p ;
...
position p;
@@
 struct nfsd3_writeargs * cocci_id@p ;
...
position p;
@@
 struct nfsd3_accessres cocci_id@p ;
...
position p;
@@
 struct nfsd3_renameargs cocci_id@p ;
...
position p;
@@
 struct nfsd3_readlinkres cocci_id@p ;
...
position p;
@@
 struct nfsd3_readlinkargs cocci_id@p ;
...
position p;
@@
 struct nfsd3_readres cocci_id@p ;
...
position p;
@@
 struct nfsd3_commitargs * cocci_id@p ;
...
position p;
@@
 struct nfsd3_attrstat * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( nfsd_procedures3 ) ] ;
...
position p;
@@
 const struct svc_procedure cocci_id@p [ 22 ] ;
...
position p;
@@
 struct nfsd_fhandle * cocci_id@p ;
...
position p;
@@
 struct nfsd3_sattrargs cocci_id@p ;
...
position p;
@@
 struct nfsd3_voidargs cocci_id@p ;
