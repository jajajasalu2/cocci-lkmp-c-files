...
typedef bool;
@@
 void cocci_id@p ( struct intel_dvo_device * dvo , bool enable ) ;
...
position p;
@@
 void cocci_id@p ( struct intel_dvo_device * dvo ) ;
...
typedef u8;
@@
 struct ch7017_priv {  u8 dummy ; } cocci_id@p ;
