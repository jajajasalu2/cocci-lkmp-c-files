...
typedef spinlock_t;
@@
 struct hid_time_state {  struct hid_sensor_hub_callbacks callbacks ;  struct hid_sensor_common common_attributes ;  struct hid_sensor_hub_attribute_info info [ TIME_RTC_CHANNEL_MAX ] ;  struct rtc_time last_time ;  spinlock_t lock_last_time ;  struct completion comp_last_time ;  struct rtc_time time_buf ;  struct rtc_device * rtc ; } cocci_id@p ;
...
position p;
@@
 struct hid_time_state * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ TIME_RTC_CHANNEL_MAX ] ;
...
position p;
@@
 enum hid_time_channel { CHANNEL_SCAN_INDEX_YEAR , CHANNEL_SCAN_INDEX_MONTH , CHANNEL_SCAN_INDEX_DAY , CHANNEL_SCAN_INDEX_HOUR , CHANNEL_SCAN_INDEX_MINUTE , CHANNEL_SCAN_INDEX_SECOND , TIME_RTC_CHANNEL_MAX , } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ TIME_RTC_CHANNEL_MAX ] ;
