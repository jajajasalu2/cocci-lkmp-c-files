...
position p;
@@
 struct xen_snd_front_card_info * cocci_id@p ;
...
position p;
@@
 struct xen_snd_front_evtchnl * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u32,snd_pcm_uframes_t,atomic_t;
@@
 struct xen_snd_front_pcm_stream_info {  struct xen_snd_front_info * front_info ;  struct xen_snd_front_evtchnl_pair * evt_pair ;  struct xen_front_pgdir_shbuf shbuf ;  u8 * buffer ;  size_t buffer_sz ;  int num_pages ;  struct page * * pages ;  int index ;  bool is_open ;  struct snd_pcm_hardware pcm_hw ;  snd_pcm_uframes_t be_cur_frame ;  atomic_t hw_ptr ;  u32 out_frames ; } cocci_id@p ;
...
position p;
@@
 struct xen_front_cfg_pcm_instance * cocci_id@p ;
...
position p;
@@
 const struct alsa_sndif_sample_format cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef u8,snd_pcm_format_t;
@@
 struct alsa_sndif_sample_format {  u8 sndif ;  snd_pcm_format_t alsa ; } cocci_id@p ;
...
position p;
@@
 struct xen_snd_front_pcm_instance_info * cocci_id@p ;
...
position p;
@@
 struct xen_snd_front_info * cocci_id@p ;
...
position p;
@@
 struct xensnd_query_hw_param cocci_id@p ;
...
position p;
@@
 struct xen_snd_front_pcm_instance_info {  struct xen_snd_front_card_info * card_info ;  struct snd_pcm * pcm ;  struct snd_pcm_hardware pcm_hw ;  int num_pcm_streams_pb ;  struct xen_snd_front_pcm_stream_info * streams_pb ;  int num_pcm_streams_cap ;  struct xen_snd_front_pcm_stream_info * streams_cap ; } cocci_id@p ;
...
position p;
@@
 struct xen_snd_front_pcm_stream_info * cocci_id@p ;
...
position p;
@@
 struct xen_snd_front_card_info {  struct xen_snd_front_info * front_info ;  struct snd_card * card ;  struct snd_pcm_hardware pcm_hw ;  int num_pcm_instances ;  struct xen_snd_front_pcm_instance_info * pcm_instances ; } cocci_id@p ;
...
position p;
@@
 struct xen_front_cfg_card * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,snd_pcm_hw_param_t;
@@
 struct alsa_sndif_hw_param {  u8 sndif ;  snd_pcm_hw_param_t alsa ; } cocci_id@p ;
...
position p;
@@
 struct xen_front_pgdir_shbuf_cfg cocci_id@p ;
