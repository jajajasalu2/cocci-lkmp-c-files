...
position p;
@@
 const struct gfs2_quota_data * * cocci_id@p ;
...
position p;
@@
 struct gfs2_quota_lvb * cocci_id@p ;
...
position p;
@@
 struct gfs2_quota_data cocci_id@p ;
...
position p;
@@
 struct list_lru_one * cocci_id@p ;
...
position p;
@@
 const struct gfs2_quota_change * cocci_id@p ;
...
position p;
@@
 struct gfs2_quota_data * cocci_id@p [ 4 ] ;
...
position p;
@@
 struct hlist_bl_head cocci_id@p [ GFS2_QD_HASH_SIZE ] ;
...
position p;
@@
 struct hlist_bl_node * cocci_id@p ;
