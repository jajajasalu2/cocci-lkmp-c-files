...
position p;
@@
 const  cocci_id@p ( mic_boost_tlv , 
...
position p;
@@
 const  cocci_id@p ( eq_band_pga_tlv , 
...
position p;
@@
 const  cocci_id@p ( eq_overall_tlv , 
...
typedef bool;
@@
 struct da732x_priv {  struct regmap * regmap ;  unsigned int sysclk ;  bool pll_en ; } cocci_id@p ;
