...
position p;
@@
 enum davinci_lpsc_state cocci_id@p ;
...
position p;
@@
 const struct davinci_lpsc_clkdev_info * cocci_id@p ;
...
position p;
@@
 enum davinci_lpsc_state { LPSC_STATE_SWRSTDISABLE = 0 , LPSC_STATE_SYNCRST = 1 , LPSC_STATE_DISABLE = 2 , LPSC_STATE_ENABLE = 3 , } cocci_id@p ;
...
position p;
@@
 struct davinci_lpsc_clk cocci_id@p ;
...
position p;
@@
 struct davinci_psc_data {  struct clk_onecell_data clk_data ;  struct genpd_onecell_data pm_data ;  struct reset_controller_dev rcdev ; } cocci_id@p ;
...
position p;
@@
 struct davinci_psc_data cocci_id@p ;
...
position p;
@@
 const struct davinci_lpsc_clk_info * cocci_id@p ;
...
typedef u32;
@@
 struct davinci_lpsc_clk {  struct device * dev ;  struct clk_hw hw ;  struct generic_pm_domain pm_domain ;  struct clk * genpd_clk ;  struct regmap * regmap ;  u32 md ;  u32 pd ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 const struct davinci_psc_init_data * cocci_id@p ;
