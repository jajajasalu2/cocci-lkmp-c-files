...
position p;
@@
 const struct imx_pgc_domain_data cocci_id@p ;
...
position p;
@@
 struct imx_pgc_domain * cocci_id@p ;
...
typedef u32;
@@
 struct imx_pgc_domain {  struct generic_pm_domain genpd ;  struct regmap * regmap ;  struct regulator * regulator ;  struct clk * clk [ GPC_CLK_MAX ] ;  int num_clks ;  unsigned int pgc ;  const struct {  u32 pxx ;  u32 map ;  u32 hsk ; } bits ;  const int voltage ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 const struct imx_pgc_domain cocci_id@p [ ] ;
...
position p;
@@
 struct imx_pgc_domain_data {  const struct imx_pgc_domain * domains ;  size_t domains_num ;  const struct regmap_access_table * reg_access_table ; } cocci_id@p ;
