...
typedef bool;
@@
 struct gpio_rcar_info {  bool has_outdtsel ;  bool has_both_edge_trigger ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,atomic_t,spinlock_t;
@@
 struct gpio_rcar_priv {  void __iomem * base ;  spinlock_t lock ;  struct device * dev ;  struct gpio_chip gpio_chip ;  struct irq_chip irq_chip ;  unsigned int irq_parent ;  atomic_t wakeup_path ;  bool has_outdtsel ;  bool has_both_edge_trigger ;  struct gpio_rcar_bank_info bank_info ; } cocci_id@p ;
...
position p;
@@
 const struct gpio_rcar_info cocci_id@p ;
...
typedef u32;
@@
 struct gpio_rcar_bank_info {  u32 iointsel ;  u32 inoutsel ;  u32 outdt ;  u32 posneg ;  u32 edglevel ;  u32 bothedge ;  u32 intmsk ; } cocci_id@p ;
...
position p;
@@
 struct gpio_rcar_priv * cocci_id@p ;
