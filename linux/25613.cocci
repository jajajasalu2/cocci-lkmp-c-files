...
position p;
@@
 struct perf_record_fork cocci_id@p ;
...
@@
 struct pyrf_cpu_map { 
 PyObject_HEAD 
  struct perf_cpu_map * cpus ; } cocci_id@p ;
...
position p;
@@
 struct perf_record_throttle cocci_id@p ;
...
position p;
@@
 PyMODINIT_FUNC cocci_id@p ( void ) ;
...
position p;
@@
 struct perf_record_mmap cocci_id@p ;
...
position p;
@@
 struct {  const char * name ;  int value ; } cocci_id@p [ ] ;
...
position p;
@@
 struct pyrf_cpu_map * cocci_id@p ;
...
@@
 struct pyrf_event { 
 PyObject_HEAD 
  struct evsel * evsel ;  struct perf_sample sample ;  union perf_event event ; } cocci_id@p ;
...
position p;
@@
 struct perf_record_switch cocci_id@p ;
...
@@
 ...
 PyObject_HEAD 
  struct perf_thread_map * threads ; } cocci_id@p ;
...
position p;
@@
 struct pyrf_thread_map * cocci_id@p ;
...
position p;
@@
 struct perf_record_lost cocci_id@p ;
...
position p;
@@
 struct perf_record_comm cocci_id@p ;
...
@@
 struct pyrf_evlist { 
 PyObject_HEAD 
  struct evlist evlist ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int level , int var , const char * fmt , ... ) ;
