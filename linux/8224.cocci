...
position p;
@@
 struct hmeal_init_block * cocci_id@p ;
...
position p;
@@
 struct hme_tx_logent cocci_id@p [ TX_LOG_LEN ] ;
...
position p;
@@
 int cocci_id@p ( struct happy_meal * hp ) ;
...
position p;
@@
 struct happy_meal_txd * cocci_id@p ;
...
position p;
@@
 struct hme_tx_logent * cocci_id@p ;
...
position p;
@@
 struct happy_meal_rxd * cocci_id@p ;
