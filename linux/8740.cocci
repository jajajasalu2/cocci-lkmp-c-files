...
position p;
@@
 enum qed_mfw_tlv_type cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ QED_MAX_NVM_BUF_LEN ] ;
...
position p;
@@
 struct qed_mfw_tlv_generic * cocci_id@p ;
...
position p;
@@
 struct qed_int_params * cocci_id@p ;
...
position p;
@@
 enum qed_slowpath_wq_flag cocci_id@p ;
...
position p;
@@
 struct qed_devlink {  struct qed_dev * cdev ; } cocci_id@p ;
...
position p;
@@
 union qed_mfw_tlv_data * cocci_id@p ;
...
position p;
@@
 struct qed_simd_fp_handler cocci_id@p ;
...
position p;
@@
 enum qed_devlink_param_id { QED_DEVLINK_PARAM_ID_BASE = DEVLINK_PARAM_GENERIC_ID_MAX , QED_DEVLINK_PARAM_ID_IWARP_CMT , } cocci_id@p ;
...
position p;
@@
 struct qed_int_param cocci_id@p ;
...
position p;
@@
 struct qed_selftest_ops cocci_id@p ;
