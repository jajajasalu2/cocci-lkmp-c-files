...
position p;
@@
 enum SMU_ASIC_RESET_MODE cocci_id@p ;
...
position p;
@@
 const struct smu10_power_state * cocci_id@p ;
...
position p;
@@
 struct smu10_power_state * cocci_id@p ;
...
position p;
@@
 struct smu10_clock_voltage_information * cocci_id@p ;
...
position p;
@@
 struct smu10_voltage_dependency_table * * cocci_id@p ;
