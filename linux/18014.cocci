...
position p;
@@
 const struct vdso_elfinfo32 * cocci_id@p ;
...
position p;
@@
 struct vdso_elfinfo {  union {  struct vdso_elfinfo32 elf32 ;  struct vdso_elfinfo64 elf64 ; } u ; } cocci_id@p ;
...
position p;
@@
 struct vdso_elfinfo64 {  Elf64_Ehdr * hdr ;  Elf64_Sym * dynsym ;  unsigned long dynsymsize ;  const char * dynstr ;  unsigned long text ; } cocci_id@p ;
...
position p;
@@
 struct vdso_elfinfo32 * cocci_id@p ;
...
position p;
@@
 struct vdso_elfinfo32 {  Elf32_Ehdr * hdr ;  Elf32_Sym * dynsym ;  unsigned long dynsymsize ;  const char * dynstr ;  unsigned long text ; } cocci_id@p ;
...
position p;
@@
 const struct vdso_image * cocci_id@p ;
...
position p;
@@
 const struct vdso_elfinfo64 * cocci_id@p ;
...
position p;
@@
 struct vdso_elfinfo * cocci_id@p ;
...
position p;
@@
 struct vdso_elfinfo64 * cocci_id@p ;
