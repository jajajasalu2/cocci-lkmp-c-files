...
position p;
@@
 struct es7134_clock_mode {  unsigned int rate_min ;  unsigned int rate_max ;  unsigned int * mclk_fs ;  unsigned int mclk_fs_num ; } cocci_id@p ;
...
position p;
@@
 const struct es7134_chip * cocci_id@p ;
...
position p;
@@
 const struct es7134_clock_mode * cocci_id@p ;
...
position p;
@@
 struct es7134_chip {  struct snd_soc_dai_driver * dai_drv ;  const struct es7134_clock_mode * modes ;  unsigned int mode_num ;  const struct snd_soc_dapm_widget * extra_widgets ;  unsigned int extra_widget_num ;  const struct snd_soc_dapm_route * extra_routes ;  unsigned int extra_route_num ; } cocci_id@p ;
...
position p;
@@
 struct es7134_data {  unsigned int mclk ;  const struct es7134_chip * chip ; } cocci_id@p ;
