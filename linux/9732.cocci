...
typedef u8;
@@
 struct iwl_mvm_scan_channel_segment {  u8 start_idx ;  u8 end_idx ;  u8 first_channel_id ;  u8 last_channel_id ;  u8 channel_spacing_shift ;  u8 band ; } cocci_id@p ;
...
position p;
@@
 struct iwl_scan_config_v1 cocci_id@p ;
...
position p;
@@
 struct iwl_scan_req_umac_v13 * cocci_id@p ;
...
position p;
@@
 struct iwl_is_dcm_with_go_iterator_data * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_umac_schedule * cocci_id@p ;
...
typedef u32;
@@
 struct iwl_mvm_scan_timing_params {  u32 suspend_time ;  u32 max_out_time ; } cocci_id@p ;
...
position p;
@@
 struct iwl_scan_config cocci_id@p ;
...
position p;
@@
 struct iwl_scan_probe_params_v4 * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_req_tx_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_offload_blacklist * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_channel_params_v4 * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_req_lmac cocci_id@p ;
...
position p;
@@
 struct iwl_scan_req_params_v11 * cocci_id@p ;
...
position p;
@@
 struct iwl_periodic_scan_complete * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_general_params_v10 * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_probe_req_v1 cocci_id@p ;
...
position p;
@@
 struct iwl_lmac_scan_complete_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_req_umac_tail_v1 * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ IWL_RATE_COUNT ] ;
...
position p;
@@
 struct iwl_scan_req_params_v13 * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_req_umac_v12 * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_scan_timing_params cocci_id@p [ ] ;
...
position p;
@@
 struct iwl_scan_config_v2 * cocci_id@p ;
...
position p;
@@
 enum iwl_scan_ebs_status cocci_id@p ;
...
position p;
@@
 const struct iwl_mvm_scan_channel_segment cocci_id@p [ ] ;
...
position p;
@@
 struct iwl_scan_req_params_v12 * cocci_id@p ;
...
position p;
@@
 struct iwl_umac_scan_iter_complete_notif * cocci_id@p ;
...
typedef u8;
@@
 struct iwl_scan_umac_handler {  u8 version ;  int ( * handler ) ( struct iwl_mvm * mvm , struct ieee80211_vif * vif , struct iwl_mvm_scan_params * params , int type , int uid ) ; } cocci_id@p ;
...
position p;
@@
 struct iwl_scan_offload_profile_cfg * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_scan_params * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_req_umac * cocci_id@p ;
...
position p;
@@
 const struct iwl_scan_umac_handler * cocci_id@p ;
...
position p;
@@
 const struct iwl_ucode_capabilities * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_req_umac_tail_v2 cocci_id@p ;
...
position p;
@@
 struct iwl_scan_channel_cfg_umac * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_dwell * cocci_id@p ;
...
position p;
@@
 struct iwl_umac_scan_abort cocci_id@p ;
...
position p;
@@
 struct iwl_scan_channel_params_v3 * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_offload_profile * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_probe_req * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_channel_cfg_lmac cocci_id@p ;
...
position p;
@@
 enum iwl_mvm_scan_type cocci_id@p ;
...
position p;
@@
 struct iwl_scan_req_umac_v11 * cocci_id@p ;
...
position p;
@@
 struct iwl_umac_scan_complete * cocci_id@p ;
...
position p;
@@
 enum iwl_mvm_traffic_load cocci_id@p ;
...
position p;
@@
 struct iwl_scan_umac_chan_param * cocci_id@p ;
...
typedef bool;
@@
 struct iwl_is_dcm_with_go_iterator_data {  struct ieee80211_vif * current_vif ;  bool is_dcm_with_p2p_go ; } cocci_id@p ;
...
position p;
@@
 struct iwl_scan_probe_params_v3 * cocci_id@p ;
