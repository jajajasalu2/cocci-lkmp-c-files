...
typedef u8,bool,u32;
@@
 struct ceu_mbus_fmt {  u32 mbus_code ;  u32 fmt_order ;  u32 fmt_order_swap ;  bool swapped ;  u8 bps ;  u8 bpp ; } cocci_id@p ;
...
position p;
@@
 const struct ceu_platform_data * cocci_id@p ;
...
position p;
@@
 const struct ceu_async_subdev * cocci_id@p ;
...
position p;
@@
 struct ceu_subdev {  struct v4l2_subdev * v4l2_sd ;  struct v4l2_async_subdev asd ;  unsigned int mbus_flags ;  struct ceu_mbus_fmt mbus_fmt ; } cocci_id@p ;
...
typedef u32;
@@
 struct ceu_data {  u32 irq_mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct ceu_fmt {  u32 fourcc ;  u32 bpp ; } cocci_id@p ;
...
@@
 struct ceu_device {  struct device * dev ;  struct video_device vdev ;  struct v4l2_device v4l2_dev ;  struct ceu_subdev * subdevs ;  struct ceu_subdev * sd ;  unsigned int sd_index ;  unsigned int num_sd ;  u32 irq_mask ;  enum v4l2_field field ;  struct v4l2_pix_format_mplane v4l2_pix ;  struct v4l2_async_notifier notifier ;  struct vb2_queue vb2_vq ;  struct list_head capture ;  struct vb2_v4l2_buffer * active ;  unsigned int sequence ;  struct mutex mlock ;  spinlock_t lock ;  void __iomem * base ; } cocci_id@p ;
...
position p;
@@
 struct ceu_mbus_fmt * cocci_id@p ;
...
position p;
@@
 const struct ceu_data * cocci_id@p ;
...
position p;
@@
 struct ceu_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head queue ; } cocci_id@p ;
...
position p;
@@
 const struct ceu_fmt * cocci_id@p ;
