...
typedef uint8_t;
@@
 struct ds4424_data {  struct i2c_client * client ;  struct mutex lock ;  uint8_t save [ DS4424_MAX_DAC_CHANNELS ] ;  struct regulator * vcc_reg ;  uint8_t raw [ DS4424_MAX_DAC_CHANNELS ] ; } cocci_id@p ;
...
position p;
@@
 union ds4424_raw_data cocci_id@p ;
...
position p;
@@
 enum ds4424_device_ids { ID_DS4422 , ID_DS4424 , } cocci_id@p ;
...
typedef u8;
@@
 union ds4424_raw_data {  struct {  u8 dx : 7 ;  u8 source_bit : 1 ; } ;  u8 bits ; } cocci_id@p ;
