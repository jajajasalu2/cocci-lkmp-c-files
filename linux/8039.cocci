...
position p;
@@
 struct ks8995_pdata * cocci_id@p ;
...
position p;
@@
 struct ks8995_chip_params {  char * name ;  int family_id ;  int chip_id ;  int regs_size ;  int addr_width ;  int addr_shift ; } cocci_id@p ;
...
position p;
@@
 struct ks8995_pdata {  int reset_gpio ;  enum of_gpio_flags reset_gpio_flags ; } cocci_id@p ;
...
position p;
@@
 const struct ks8995_chip_params cocci_id@p [ ] ;
...
position p;
@@
 enum ks8995_chip_variant { ks8995 , ksz8864 , ksz8795 , max_variant , } cocci_id@p ;
...
position p;
@@
 struct ks8995_switch {  struct spi_device * spi ;  struct mutex lock ;  struct ks8995_pdata * pdata ;  struct bin_attribute regs_attr ;  const struct ks8995_chip_params * chip ;  int revision_id ; } cocci_id@p ;
...
position p;
@@
 struct ks8995_switch * cocci_id@p ;
