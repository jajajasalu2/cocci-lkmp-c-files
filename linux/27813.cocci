...
position p;
@@
 struct ocfs2_find_inode_args * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , struct buffer_head * bh ) ;
...
typedef u64;
@@
 struct ocfs2_find_inode_args {  u64 fi_blkno ;  unsigned long fi_ino ;  unsigned int fi_flags ;  unsigned int fi_sysfile_type ; } cocci_id@p ;
...
position p;
@@
 struct lock_class_key cocci_id@p [ NUM_SYSTEM_INODES ] ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , void * opaque ) ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct inode * inode , struct buffer_head * fe_bh ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct ocfs2_find_inode_args * args ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct buffer_head * * bh , int flags , int type ) ;
