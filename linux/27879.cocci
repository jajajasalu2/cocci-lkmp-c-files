...
position p;
@@
 unsigned char cocci_id@p [ READ_BUFFERS ] [ BUFFER_SIZE ] ;
...
position p;
@@
 const struct cramfs_inode * cocci_id@p ;
...
position p;
@@
 unsigned cocci_id@p [ READ_BUFFERS ] ;
...
position p;
@@
 struct cramfs_sb_info cocci_id@p ;
...
position p;
@@
 struct cramfs_super cocci_id@p ;
...
@@
 struct cramfs_sb_info {  unsigned long magic ;  unsigned long size ;  unsigned long blocks ;  unsigned long files ;  unsigned long flags ;  void * linear_virt_addr ;  resource_size_t linear_phys_addr ;  size_t mtd_point_size ; } cocci_id@p ;
...
position p;
@@
 struct super_block * cocci_id@p [ READ_BUFFERS ] ;
...
position p;
@@
 struct page * cocci_id@p [ BLKS_PER_BUF ] ;
...
position p;
@@
 struct cramfs_inode * cocci_id@p ;
