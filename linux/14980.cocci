...
position p;
@@
 struct bcm2835_clock * cocci_id@p ;
...
position p;
@@
 const struct bcm2835_clk_desc * cocci_id@p ;
...
position p;
@@
 struct bcm2835_cprman * cocci_id@p ;
...
position p;
@@
 struct bcm2835_clock_data cocci_id@p ;
...
position p;
@@
 struct bcm2835_pll_divider * cocci_id@p ;
...
position p;
@@
 const struct bcm2835_pll_data * cocci_id@p ;
...
position p;
@@
 struct cprman_plat_data {  unsigned int soc ; } cocci_id@p ;
...
position p;
@@
 struct debugfs_reg32 * cocci_id@p ;
...
typedef u32;
@@
 struct bcm2835_pll_divider_data {  const char * name ;  const char * source_pll ;  u32 cm_reg ;  u32 a2w_reg ;  u32 load_mask ;  u32 hold_mask ;  u32 fixed_divider ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 const struct cprman_plat_data * cocci_id@p ;
...
position p;
@@
 struct clk_hw * ( * cocci_id@p ) ( struct bcm2835_cprman * cprman , const void * data ) ;
...
typedef spinlock_t;
@@
 struct bcm2835_cprman {  struct device * dev ;  void __iomem * regs ;  spinlock_t regs_lock ;  const char * real_parent_names [ ARRAY_SIZE ( cprman_parent_names ) ] ;  struct clk_hw_onecell_data onecell ; } cocci_id@p ;
...
position p;
@@
 const struct bcm2835_gate_data * cocci_id@p ;
...
typedef u32;
@@
 struct bcm2835_pll_data {  const char * name ;  u32 cm_ctrl_reg ;  u32 a2w_ctrl_reg ;  u32 frac_reg ;  u32 ana_reg_base ;  u32 reference_enable_mask ;  u32 lock_mask ;  const struct bcm2835_pll_ana_bits * ana ;  unsigned long min_rate ;  unsigned long max_rate ;  unsigned long max_fb_rate ; } cocci_id@p ;
...
position p;
@@
 struct bcm2835_pll_divider {  struct clk_divider div ;  struct bcm2835_cprman * cprman ;  const struct bcm2835_pll_divider_data * data ; } cocci_id@p ;
...
typedef u32;
@@
 struct bcm2835_pll_ana_bits {  u32 mask0 ;  u32 set0 ;  u32 mask1 ;  u32 set1 ;  u32 mask3 ;  u32 set3 ;  u32 fb_prediv_mask ; } cocci_id@p ;
...
position p;
@@
 struct bcm2835_clock {  struct clk_hw hw ;  struct bcm2835_cprman * cprman ;  const struct bcm2835_clock_data * data ; } cocci_id@p ;
...
position p;
@@
 const struct bcm2835_pll_ana_bits cocci_id@p ;
...
position p;
@@
 const struct bcm2835_pll_divider_data * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ 1 << CM_SRC_BITS ] ;
...
position p;
@@
 struct bcm2835_pll_divider_data cocci_id@p ;
...
position p;
@@
 struct bcm2835_clk_desc {  bcm2835_clk_register clk_register ;  unsigned int supported ;  const void * data ; } cocci_id@p ;
...
position p;
@@
 struct clk_rate_request * cocci_id@p ;
...
position p;
@@
 struct debugfs_regset32 * cocci_id@p ;
...
typedef u32;
@@
 struct bcm2835_gate_data {  const char * name ;  const char * parent ;  u32 ctl_reg ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct bcm2835_clock_data {  const char * name ;  const char * const * parents ;  int num_mux_parents ;  unsigned int set_rate_parent ;  u32 ctl_reg ;  u32 div_reg ;  u32 int_bits ;  u32 frac_bits ;  u32 flags ;  bool is_vpu_clock ;  bool is_mash_clock ;  bool low_jitter ;  u32 tcnt_mux ; } cocci_id@p ;
...
position p;
@@
 struct bcm2835_gate_data cocci_id@p ;
...
position p;
@@
 bcm2835_clk_register cocci_id@p ;
...
position p;
@@
 struct bcm2835_pll_data cocci_id@p ;
...
position p;
@@
 struct bcm2835_pll {  struct clk_hw hw ;  struct bcm2835_cprman * cprman ;  const struct bcm2835_pll_data * data ; } cocci_id@p ;
...
position p;
@@
 const struct bcm2835_clock_data * cocci_id@p ;
