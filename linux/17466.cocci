...
position p;
@@
 const struct vio_dev * cocci_id@p ;
...
position p;
@@
 struct vio_cmo_dev_entry cocci_id@p ;
...
typedef spinlock_t;
@@
 struct vio_cmo {  spinlock_t lock ;  struct delayed_work balance_q ;  struct list_head device_list ;  size_t entitled ;  struct vio_cmo_pool reserve ;  struct vio_cmo_pool excess ;  size_t spare ;  size_t min ;  size_t desired ;  size_t curr ;  size_t high ; } cocci_id@p ;
...
position p;
@@
 enum vio_dev_family cocci_id@p ;
...
position p;
@@
 struct vio_cmo_pool {  size_t size ;  size_t free ; } cocci_id@p ;
...
position p;
@@
 struct vio_cmo_dev_entry {  struct vio_dev * viodev ;  struct list_head list ; } cocci_id@p ;
