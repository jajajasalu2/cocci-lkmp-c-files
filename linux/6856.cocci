...
position p;
@@
 struct fc_els_rtv_acc * cocci_id@p ;
...
position p;
@@
 struct {  struct fc_els_prli prli ;  struct fc_els_spp spp ; } * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_rport_priv * , int ) ;
...
position p;
@@
 struct fc_els_adisc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_rport_priv * ) ;
...
position p;
@@
 enum fc_els_spp_resp cocci_id@p ;
...
position p;
@@
 enum fc_rport_state cocci_id@p ;
...
position p;
@@
 struct fc_els_rls_resp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_rport_priv * , struct fc_frame * ) ;
...
position p;
@@
 struct {  struct fc_els_prlo prlo ;  struct fc_els_spp spp ; } * cocci_id@p ;
