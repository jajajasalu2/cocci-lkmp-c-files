...
typedef atomic64_t;
@@
 struct nft_quota {  atomic64_t quota ;  unsigned long flags ;  atomic64_t consumed ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_QUOTA_MAX + 1 ] ;
