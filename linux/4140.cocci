...
position p;
@@
 const struct exynos_pcie_phy_data cocci_id@p ;
...
position p;
@@
 struct exynos_pcie_phy {  const struct exynos_pcie_phy_data * drv_data ;  void __iomem * phy_base ;  void __iomem * blk_base ; } cocci_id@p ;
...
position p;
@@
 struct exynos_pcie_phy_data {  const struct phy_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct exynos_pcie_phy * cocci_id@p ;
