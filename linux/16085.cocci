...
position p;
@@
 struct adl_pci7x3x_boardinfo {  const char * name ;  int nsubdevs ;  int di_nchan ;  int do_nchan ; } cocci_id@p ;
...
position p;
@@
 enum apci1516_boardid { BOARD_PCI7230 , BOARD_PCI7233 , BOARD_PCI7234 , BOARD_PCI7432 , BOARD_PCI7433 , BOARD_PCI7434 , } cocci_id@p ;
...
position p;
@@
 const struct adl_pci7x3x_boardinfo cocci_id@p [ ] ;
