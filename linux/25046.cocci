...
position p;
@@
 struct dest_spec_params * cocci_id@p ;
...
position p;
@@
 struct core_conn_create_data {  int length ;  struct nci_core_conn_create_cmd * cmd ; } cocci_id@p ;
...
position p;
@@
 struct nci_loopback_data * cocci_id@p ;
...
position p;
@@
 struct nci_core_conn_create_cmd cocci_id@p ;
...
typedef __u8;
@@
 struct nci_rf_discover_select_param {  __u8 rf_discovery_id ;  __u8 rf_protocol ; } cocci_id@p ;
...
position p;
@@
 struct nci_cmd_param * cocci_id@p ;
...
position p;
@@
 struct nci_rf_disc_map_cmd cocci_id@p ;
...
position p;
@@
 struct core_conn_create_dest_spec_params * cocci_id@p ;
...
position p;
@@
 struct core_conn_create_data cocci_id@p ;
...
position p;
@@
 struct nci_rf_discover_select_cmd cocci_id@p ;
...
position p;
@@
 struct nci_rf_discover_select_param * cocci_id@p ;
...
position p;
@@
 struct nci_conn_info * cocci_id@p ;
...
typedef __u16,__u8;
@@
 struct nci_cmd_param {  __u16 opcode ;  size_t len ;  __u8 * payload ; } cocci_id@p ;
...
position p;
@@
 struct nci_ctrl_hdr * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct nci_dev * ndev , unsigned long opt ) ;
...
position p;
@@
 struct nci_nfcee_mode_set_cmd cocci_id@p ;
...
position p;
@@
 struct nci_set_config_param cocci_id@p ;
...
position p;
@@
 struct nci_rf_discover_param cocci_id@p ;
...
typedef __u8;
@@
 struct nci_set_config_param {  __u8 id ;  size_t len ;  __u8 * val ; } cocci_id@p ;
...
position p;
@@
 struct nci_rf_deactivate_cmd cocci_id@p ;
...
position p;
@@
 struct nci_core_set_config_cmd cocci_id@p ;
...
position p;
@@
 struct disc_map_config cocci_id@p ;
...
position p;
@@
 struct nci_core_reset_cmd cocci_id@p ;
...
typedef u8;
@@
 struct nci_loopback_data {  u8 conn_id ;  struct sk_buff * data ; } cocci_id@p ;
...
position p;
@@
 struct nci_driver_ops * cocci_id@p ;
...
position p;
@@
 struct nci_nfcee_discover_cmd cocci_id@p ;
...
typedef __u32;
@@
 struct nci_rf_discover_param {  __u32 im_protocols ;  __u32 tm_protocols ; } cocci_id@p ;
...
position p;
@@
 struct nci_rf_disc_cmd cocci_id@p ;
