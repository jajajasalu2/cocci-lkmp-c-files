...
position p;
@@
 struct xfs_dir3_free_hdr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_da_state_blk_t;
@@
 xfs_da_state_blk_t * cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_free_hdr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_free_t;
@@
 xfs_dir2_free_t * cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_free * cocci_id@p ;
...
position p;
@@
 struct xfs_dir3_free * cocci_id@p ;
