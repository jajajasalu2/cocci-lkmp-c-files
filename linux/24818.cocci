...
position p;
@@
 struct nft_payload_set * cocci_id@p ;
...
position p;
@@
 const struct nft_payload * cocci_id@p ;
...
position p;
@@
 enum nft_payload_bases cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_PAYLOAD_MAX + 1 ] ;
...
position p;
@@
 const struct nft_payload_set * cocci_id@p ;
