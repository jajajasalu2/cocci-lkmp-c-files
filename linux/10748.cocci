...
typedef u32;
@@
 struct clear_pages_work {  struct dma_fence dma ;  struct dma_fence_cb cb ;  struct i915_sw_fence wait ;  struct work_struct work ;  struct irq_work irq_work ;  struct i915_sleeve * sleeve ;  struct intel_context * ce ;  u32 value ; } cocci_id@p ;
...
position p;
@@
 struct i915_page_sizes * cocci_id@p ;
...
position p;
@@
 struct clear_pages_work * cocci_id@p ;
...
position p;
@@
 struct i915_sleeve {  struct i915_vma * vma ;  struct drm_i915_gem_object * obj ;  struct sg_table * pages ;  struct i915_page_sizes page_sizes ; } cocci_id@p ;
