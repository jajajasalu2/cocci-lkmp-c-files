...
typedef u32;
@@
 u32 ( * cocci_id@p ) ( struct hashtab * h , const void * key ) ;
...
position p;
@@
 struct hashtab_node cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct hashtab * h , const void * key1 , const void * key2 ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * k , void * d , void * args ) ;
