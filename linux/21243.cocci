...
position p;
@@
 struct ak881x_pdata cocci_id@p ;
...
position p;
@@
 struct sh_mmcif_plat_data cocci_id@p ;
...
position p;
@@
 struct tsc2007_platform_data cocci_id@p ;
...
position p;
@@
 struct heartbeat_data cocci_id@p ;
...
position p;
@@
 struct sh_keysc_info cocci_id@p ;
...
position p;
@@
 struct gpio_backlight_platform_data cocci_id@p ;
...
position p;
@@
 struct sh_eth_plat_data cocci_id@p ;
...
position p;
@@
 struct renesas_usbhs_platform_info cocci_id@p ;
...
position p;
@@
 struct sh_machine_vector cocci_id@p ;
...
position p;
@@
 struct mt9t112_platform_data cocci_id@p ;
...
position p;
@@
 struct mmc_spi_platform_data cocci_id@p ;
...
position p;
@@
 struct asoc_simple_card_info cocci_id@p ;
...
position p;
@@
 struct ceu_platform_data cocci_id@p ;
