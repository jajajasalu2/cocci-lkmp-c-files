...
position p;
@@
 const struct sp_dev_vdata cocci_id@p [ ] ;
...
position p;
@@
 struct sp_dev_vdata * cocci_id@p ;
...
position p;
@@
 struct sp_platform {  int coherent ;  unsigned int irq_count ; } cocci_id@p ;
