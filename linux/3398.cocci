...
position p;
@@
 const unsigned int cocci_id@p [ PERIOD_CDIV_MAX ] ;
...
position p;
@@
 struct mxs_pwm_chip * cocci_id@p ;
...
position p;
@@
 struct mxs_pwm_chip {  struct pwm_chip chip ;  struct clk * clk ;  void __iomem * base ; } cocci_id@p ;
