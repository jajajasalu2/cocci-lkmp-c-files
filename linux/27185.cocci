...
typedef __u32,__u8;
@@
 struct dlm_lksb32 {  __u32 sb_status ;  __u32 sb_lkid ;  __u8 sb_flags ;  __u32 sb_lvbptr ; } cocci_id@p ;
...
position p;
@@
 struct dlm_user_proc * cocci_id@p ;
...
position p;
@@
 struct dlm_write_request32 * cocci_id@p ;
...
position p;
@@
 struct dlm_device_version cocci_id@p ;
...
position p;
@@
 struct dlm_user_args cocci_id@p ;
...
typedef __u32,__u8;
@@
 struct dlm_write_request32 {  __u32 version [ 3 ] ;  __u8 cmd ;  __u8 is64bit ;  __u8 unused [ 2 ] ;  union {  struct dlm_lock_params32 lock ;  struct dlm_lspace_params lspace ;  struct dlm_purge_params purge ; } i ; } cocci_id@p ;
...
position p;
@@
 struct dlm_lspace_params * cocci_id@p ;
...
position p;
@@
 struct dlm_lock_result cocci_id@p ;
...
typedef __u32,__u8;
@@
 struct dlm_lock_result32 {  __u32 version [ 3 ] ;  __u32 length ;  __u32 user_astaddr ;  __u32 user_astparam ;  __u32 user_lksb ;  struct dlm_lksb32 lksb ;  __u8 bast_mode ;  __u8 unused [ 3 ] ;  __u32 lvb_offset ; } cocci_id@p ;
...
position p;
@@
 struct dlm_lock_result32 * cocci_id@p ;
...
position p;
@@
 struct dlm_purge_params * cocci_id@p ;
...
position p;
@@
 struct dlm_write_request * cocci_id@p ;
...
position p;
@@
 struct dlm_callback cocci_id@p ;
...
position p;
@@
 struct dlm_lock_params * cocci_id@p ;
...
@@
 struct dlm_lock_params32 {  __u8 mode ;  __u8 namelen ;  __u16 unused ;  __u32 flags ;  __u32 lkid ;  __u32 parent ;  __u64 xid ;  __u64 timeout ;  __u32 castparam ;  __u32 castaddr ;  __u32 bastparam ;  __u32 bastaddr ;  __u32 lksb ;  char lvb [ DLM_USER_LVB_LEN ] ;  char name [ 0 ] ; } cocci_id@p ;
