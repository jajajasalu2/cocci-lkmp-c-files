...
position p;
@@
 struct max77620_regulator_info cocci_id@p [ MAX77620_NUM_REGS ] ;
...
position p;
@@
 struct max77620_regulator * cocci_id@p ;
...
position p;
@@
 struct max77620_regulator_info * cocci_id@p ;
...
position p;
@@
 struct regulator_desc * cocci_id@p ;
...
position p;
@@
 struct max77620_regulator_pdata {  int active_fps_src ;  int active_fps_pd_slot ;  int active_fps_pu_slot ;  int suspend_fps_src ;  int suspend_fps_pd_slot ;  int suspend_fps_pu_slot ;  int current_mode ;  int power_ok ;  int ramp_rate_setting ; } cocci_id@p ;
...
position p;
@@
 enum max77620_regulator_type { MAX77620_REGULATOR_TYPE_SD , MAX77620_REGULATOR_TYPE_LDO_N , MAX77620_REGULATOR_TYPE_LDO_P , } cocci_id@p ;
...
position p;
@@
 struct max77620_chip * cocci_id@p ;
...
typedef u8;
@@
 struct max77620_regulator_info {  u8 type ;  u8 fps_addr ;  u8 volt_addr ;  u8 cfg_addr ;  u8 power_mode_mask ;  u8 power_mode_shift ;  u8 remote_sense_addr ;  u8 remote_sense_mask ;  struct regulator_desc desc ; } cocci_id@p ;
...
position p;
@@
 struct max77620_regulator_pdata * cocci_id@p ;
...
position p;
@@
 struct max77620_regulator {  struct device * dev ;  struct regmap * rmap ;  struct max77620_regulator_info * rinfo [ MAX77620_NUM_REGS ] ;  struct max77620_regulator_pdata reg_pdata [ MAX77620_NUM_REGS ] ;  int enable_power_mode [ MAX77620_NUM_REGS ] ;  int current_power_mode [ MAX77620_NUM_REGS ] ;  int active_fps_src [ MAX77620_NUM_REGS ] ; } cocci_id@p ;
