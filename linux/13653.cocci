...
typedef u16;
@@
 int cocci_id@p ( struct gspca_dev * gspca_dev , u16 vendor_id , u16 product_id ) ;
...
position p;
@@
 int cocci_id@p ( struct gspca_dev * gspca_dev , const struct usb_device_id * id ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct gspca_dev * gspca_dev , u8 * data , int len ) ;
