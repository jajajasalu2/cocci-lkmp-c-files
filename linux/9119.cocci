...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_esw_vport_context_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_esw_vport_context_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_flow_table_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_roce_address_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_hca_cap_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_roce_address_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( sync_steering_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( sync_steering_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_flow_table_out ) ] ;
...
position p;
@@
 struct mlx5dr_cmd_caps * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_esw_caps * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_cmd_gid_attr * cocci_id@p ;
