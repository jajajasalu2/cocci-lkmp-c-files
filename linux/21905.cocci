...
position p;
@@
 struct subprocess_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "SEQNUM=" ) + 21 ] ;
...
position p;
@@
 struct uevent_sock {  struct list_head list ;  struct sock * sk ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ UEVENT_HELPER_PATH_LEN ] ;
