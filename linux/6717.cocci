...
position p;
@@
 const struct ibmvfc_async_desc cocci_id@p ;
...
position p;
@@
 struct ibmvfc_port_login * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_process_login * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_query_tgt * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_passthru_fc_iu cocci_id@p ;
...
position p;
@@
 const struct {  enum ibmvfc_ae_link_state state ;  const char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ibmvfc_prli_svc_parms * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_fcp_rsp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ibmvfc_host * ) ;
...
position p;
@@
 struct ibmvfc_target cocci_id@p ;
...
position p;
@@
 struct ibmvfc_npiv_logout_mad * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_trace_entry * cocci_id@p ;
...
position p;
@@
 const struct {  enum ibmvfc_fc_type fc_type ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ibmvfc_fcp_cmd_iu cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ibmvfc_target * ) ;
...
position p;
@@
 struct ibmvfc_npiv_login_mad * cocci_id@p ;
...
typedef u8,u16;
@@
 const struct {  u16 status ;  u16 error ;  u8 result ;  u8 retry ;  int log ;  char * name ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 const struct {  u16 fc_explain ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ibmvfc_async_crq * cocci_id@p ;
...
position p;
@@
 const struct {  int code ;  int retry ;  int logged_in ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ibmvfc_event_pool * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_passthru_mad * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ibmvfc_event * , void * ) ;
...
position p;
@@
 struct ibmvfc_crq_queue * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_implicit_logout * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_event cocci_id@p ;
...
position p;
@@
 enum ibmvfc_target_action cocci_id@p ;
...
position p;
@@
 enum ibmvfc_host_action cocci_id@p ;
...
position p;
@@
 struct ibmvfc_npiv_login * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_npiv_login_resp * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ibmvfc_event * ) ;
...
position p;
@@
 struct ibmvfc_async_crq_queue * cocci_id@p ;
...
position p;
@@
 struct ibmvfc_discover_targets * cocci_id@p ;
...
position p;
@@
 enum ibmvfc_ae_link_state cocci_id@p ;
...
position p;
@@
 struct ibmvfc_mad_common * cocci_id@p ;
...
position p;
@@
 enum ibmvfc_host_state cocci_id@p ;
