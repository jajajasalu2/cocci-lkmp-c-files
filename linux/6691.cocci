...
position p;
@@
 struct qla27xx_fwdt_entry * cocci_id@p ;
...
position p;
@@
 struct qla27xx_fwdt_template * cocci_id@p ;
...
position p;
@@
 struct device_reg_24xx * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void __iomem * , void * , ulong * ) ;
...
typedef uint;
@@
 struct {  uint type ;  typeof ( qla27xx_fwdt_entry_other ) * call ; } cocci_id@p [ ] ;
