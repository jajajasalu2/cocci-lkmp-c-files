...
typedef u_long;
@@
 int cocci_id@p ( int maxflag , u_long mib , u_long limit , u_long * oper ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int level ) ;
