...
position p;
@@
 struct wm97xx_mach_ops cocci_id@p ;
...
position p;
@@
 struct au1xmmc_platform_data cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct mmc_host * , unsigned long ) ;
...
position p;
@@
 struct pata_platform_info cocci_id@p ;
