...
position p;
@@
 const struct i915_power_well_ops cocci_id@p ;
...
position p;
@@
 const struct i915_power_well_regs * cocci_id@p ;
...
position p;
@@
 enum skl_power_gate cocci_id@p ;
...
position p;
@@
 struct intel_cdclk_state cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_i915_private * dev_priv ) ;
...
position p;
@@
 const struct i915_power_well_desc cocci_id@p [ ] ;
...
typedef bool;
@@
 bool cocci_id@p ( struct drm_i915_private * dev_priv , enum i915_power_well_id power_well_id ) ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct i915_power_domains * power_domains ) ;
