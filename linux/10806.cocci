...
position p;
@@
 struct mmsch_v1_0_init_header cocci_id@p ;
...
position p;
@@
 struct mmsch_v1_0_cmd_direct_polling cocci_id@p ;
...
position p;
@@
 struct mmsch_v1_0_cmd_direct_read_modify_write cocci_id@p ;
...
position p;
@@
 struct mmsch_v1_0_cmd_direct_write cocci_id@p ;
...
position p;
@@
 struct amdgpu_vmhub * cocci_id@p ;
...
position p;
@@
 struct mmsch_v1_0_cmd_end cocci_id@p ;
...
position p;
@@
 struct amdgpu_mm_table * cocci_id@p ;
