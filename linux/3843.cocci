...
position p;
@@
 enum cc_sg_cpy_direct cocci_id@p ;
...
position p;
@@
 struct buff_mgr_handle * cocci_id@p ;
...
position p;
@@
 struct buffer_array * cocci_id@p ;
...
position p;
@@
 struct buff_mgr_handle {  struct dma_pool * mlli_buffs_pool ; } cocci_id@p ;
...
position p;
@@
 union buffer_array_entry * cocci_id@p ;
...
position p;
@@
 enum dma_buffer_type { DMA_NULL_TYPE = - 1 , DMA_SGL_TYPE = 1 , DMA_BUFF_TYPE = 2 , } cocci_id@p ;
...
typedef dma_addr_t;
@@
 union buffer_array_entry {  struct scatterlist * sgl ;  dma_addr_t buffer_dma ; } cocci_id@p ;
