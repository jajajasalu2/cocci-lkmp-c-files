...
position p;
@@
 struct nouveau_framebuffer * cocci_id@p ;
...
position p;
@@
 struct nouveau_drm_prop_enum_list cocci_id@p [ ] ;
...
typedef u8;
@@
 struct nouveau_drm_prop_enum_list {  u8 gen_mask ;  int type ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct nvif_notify_head_req_v0 cocci_id@p ;
...
position p;
@@
 struct {  struct nv04_disp_mthd_v0 base ;  struct nv04_disp_scanoutpos_v0 scan ; } cocci_id@p ;
