...
position p;
@@
 struct cros_ec_codec_priv cocci_id@p ;
...
position p;
@@
 struct ec_param_ec_codec_i2s_rx cocci_id@p ;
...
position p;
@@
 struct ec_param_ec_codec_wov_set_lang_shm * cocci_id@p ;
...
position p;
@@
 struct ec_response_ec_codec_dmic_get_gain_idx cocci_id@p ;
...
position p;
@@
 struct ec_response_ec_codec_wov_get_lang cocci_id@p ;
...
position p;
@@
 struct cros_ec_device * cocci_id@p ;
...
position p;
@@
 struct ec_param_ec_codec cocci_id@p ;
...
position p;
@@
 struct ec_param_ec_codec_wov_set_lang * cocci_id@p ;
...
position p;
@@
 enum ec_codec_i2s_rx_sample_depth cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ SHA256_DIGEST_SIZE ] ;
...
position p;
@@
 enum { DMIC_CTL_GAIN = 0 , } cocci_id@p ;
...
position p;
@@
 struct ec_response_ec_codec_get_shm_addr cocci_id@p ;
...
position p;
@@
 struct ec_response_ec_codec_wov_read_audio cocci_id@p ;
...
position p;
@@
 struct ec_response_ec_codec_dmic_get_max_gain cocci_id@p ;
...
position p;
@@
 struct ec_response_ec_codec_wov_read_audio_shm cocci_id@p ;
...
position p;
@@
 enum ec_codec_i2s_rx_daifmt cocci_id@p ;
...
position p;
@@
 struct ec_param_ec_codec_dmic cocci_id@p ;
...
position p;
@@
 struct ec_param_ec_codec_wov cocci_id@p ;
...
position p;
@@
 struct cros_ec_command * cocci_id@p ;
...
position p;
@@
 struct ec_response_ec_codec_get_capabilities cocci_id@p ;
