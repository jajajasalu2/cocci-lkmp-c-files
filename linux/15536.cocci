...
position p;
@@
 struct hostif_adhoc_set2_request * cocci_id@p ;
...
position p;
@@
 struct association_response * cocci_id@p ;
...
position p;
@@
 struct association_request * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MICHAEL_MIC_LEN ] ;
...
position p;
@@
 struct hostif_request * cocci_id@p ;
...
position p;
@@
 struct hostif_adhoc_set_request * cocci_id@p ;
...
position p;
@@
 struct hostif_start_request * cocci_id@p ;
...
position p;
@@
 enum sleep_mode_type cocci_id@p ;
...
position p;
@@
 struct ieee802_1x_hdr * cocci_id@p ;
...
position p;
@@
 struct ks_wlan_private cocci_id@p ;
...
position p;
@@
 struct hostif_power_mgmt_request * cocci_id@p ;
...
position p;
@@
 struct link_ap_info * cocci_id@p ;
...
position p;
@@
 struct hostif_stop_request * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef hostif_mib_set_request_t;
@@
 struct hostif_mib_set_request_t * cocci_id@p ;
...
position p;
@@
 struct hostif_data_request * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NIC_MAX_MCAST_LIST * ETH_ALEN ] ;
...
position p;
@@
 struct hostif_ps_adhoc_set_request * cocci_id@p ;
...
position p;
@@
 struct hostif_bss_scan_request * cocci_id@p ;
...
position p;
@@
 struct hostif_sleep_request * cocci_id@p ;
...
position p;
@@
 struct hostif_mib_get_request * cocci_id@p ;
...
position p;
@@
 struct hostif_infrastructure_set_request * cocci_id@p ;
...
position p;
@@
 struct hostif_phy_information_request * cocci_id@p ;
...
position p;
@@
 struct hostif_mic_failure_request * cocci_id@p ;
...
position p;
@@
 struct wpa_eapol_key * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ RATE_SET_MAX_SIZE ] ;
