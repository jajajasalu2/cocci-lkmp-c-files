...
position p;
@@
 struct dpaa2_qdma_priv * cocci_id@p ;
...
position p;
@@
 struct dpaa2_qdma_comp * cocci_id@p ;
...
position p;
@@
 struct dpdmai_rx_queue_cfg cocci_id@p ;
...
position p;
@@
 struct dpaa2_qdma_engine * cocci_id@p ;
...
position p;
@@
 struct dpaa2_qdma_priv_per_prio cocci_id@p ;
...
position p;
@@
 struct dpaa2_qdma_chan cocci_id@p ;
...
position p;
@@
 struct dpaa2_qdma_sd_d * cocci_id@p ;
