...
position p;
@@
 struct pcan_usb_pro_devid * cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_fwinfo * cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_rxstatus * cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_txmsg cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_btr cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_rxmsg cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_blinfo * cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_setled cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_rxts cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_interface * cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_setts cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_busact cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_silent cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_interface {  struct peak_usb_device * dev [ PCAN_USBPRO_CHANNEL_COUNT ] ;  struct peak_time_ref time_ref ;  int cm_ignore_count ;  int dev_opened_count ; } cocci_id@p ;
...
typedef u8;
@@
 struct pcan_usb_pro_msg {  u8 * rec_ptr ;  int rec_buffer_size ;  int rec_buffer_len ;  union {  __le16 * rec_cnt_rd ;  __le32 * rec_cnt ;  u8 * rec_buffer ; } u ; } cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_device cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_filter cocci_id@p ;
...
position p;
@@
 union pcan_usb_pro_rec * cocci_id@p ;
...
typedef u32;
@@
 struct pcan_usb_pro_device {  struct peak_usb_device dev ;  struct pcan_usb_pro_interface * usb_if ;  u32 cached_ccbt ; } cocci_id@p ;
...
position p;
@@
 struct pcan_usb_pro_msg * cocci_id@p ;
