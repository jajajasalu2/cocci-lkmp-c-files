...
position p;
@@
 struct dcn10_resource_pool * cocci_id@p ;
...
position p;
@@
 const struct dcn_mpc_registers cocci_id@p ;
...
position p;
@@
 enum dcn10_clk_src_array_id { DCN10_CLK_SRC_PLL0 , DCN10_CLK_SRC_PLL1 , DCN10_CLK_SRC_PLL2 , DCN10_CLK_SRC_PLL3 , DCN10_CLK_SRC_TOTAL , DCN101_CLK_SRC_TOTAL = DCN10_CLK_SRC_PLL3 , } cocci_id@p ;
...
position p;
@@
 const struct dcn_dpp_mask cocci_id@p ;
...
position p;
@@
 struct dcn10_link_encoder cocci_id@p ;
...
position p;
@@
 struct dcn10_hubbub * cocci_id@p ;
...
position p;
@@
 const struct dcn10_opp_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dc_cap_funcs cocci_id@p ;
...
position p;
@@
 const struct dcn_mi_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct resource_funcs cocci_id@p ;
...
position p;
@@
 const struct dcn_dpp_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dcn_mi_shift cocci_id@p ;
...
position p;
@@
 const struct dc_plane_state * cocci_id@p ;
...
position p;
@@
 struct dcn_ip_params * cocci_id@p ;
...
position p;
@@
 const struct dcn10_opp_shift cocci_id@p ;
...
position p;
@@
 const struct _vcs_dpi_soc_bounding_box_st cocci_id@p ;
...
position p;
@@
 const struct dcn10_opp_mask cocci_id@p ;
...
position p;
@@
 const struct dcn_mpc_mask cocci_id@p ;
...
position p;
@@
 const struct dcn_mpc_shift cocci_id@p ;
...
position p;
@@
 struct dcn_soc_bounding_box * cocci_id@p ;
...
position p;
@@
 const struct _vcs_dpi_ip_params_st cocci_id@p ;
...
position p;
@@
 const struct dcn_dpp_shift cocci_id@p ;
...
position p;
@@
 const struct dcn_mi_mask cocci_id@p ;
