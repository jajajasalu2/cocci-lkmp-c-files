...
position p;
@@
 struct qcom_phy {  struct device * dev ;  void __iomem * base ;  struct regulator_bulk_data vregs [ 2 ] ;  struct reset_control * phy_reset ;  struct reset_control * pipe_reset ;  struct clk * pipe_clk ; } cocci_id@p ;
