...
position p;
@@
 struct arm64_jit_data * cocci_id@p ;
...
typedef u8;
@@
 struct arm64_jit_data {  struct bpf_binary_header * header ;  u8 * image ;  struct jit_ctx ctx ; } cocci_id@p ;
...
typedef u32;
@@
 struct jit_ctx {  const struct bpf_prog * prog ;  int idx ;  int epilogue_offset ;  int * offset ;  __le32 * image ;  u32 stack_size ; } cocci_id@p ;
