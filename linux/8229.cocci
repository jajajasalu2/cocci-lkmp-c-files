...
position p;
@@
 struct cpsw_switchdev_event_work {  struct work_struct work ;  struct switchdev_notifier_fdb_info fdb_info ;  struct cpsw_priv * priv ;  unsigned long event ; } cocci_id@p ;
...
position p;
@@
 struct cpsw_switchdev_event_work * cocci_id@p ;
