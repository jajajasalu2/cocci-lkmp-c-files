...
position p;
@@
 struct ioasid_allocator_ops * cocci_id@p ;
...
position p;
@@
 struct ioasid_allocator_data * cocci_id@p ;
...
typedef ioasid_t;
@@
 struct ioasid_data {  ioasid_t id ;  struct ioasid_set * set ;  void * private ;  struct rcu_head rcu ; } cocci_id@p ;
...
typedef ioasid_t;
@@
 void cocci_id@p ( ioasid_t ioasid , void * opaque ) ;
