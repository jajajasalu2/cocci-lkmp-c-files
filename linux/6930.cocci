...
position p;
@@
 struct w1_eprom_data cocci_id@p ;
...
typedef u8;
@@
 struct w1_eprom_data {  size_t size ;  int ( * read ) ( struct w1_slave * sl , int pageno ) ;  u8 eprom [ W1_DS2505_SIZE ] ; 
	 DECLARE_BITMAP ( page_present , W1_DS2505_SIZE / W1_PAGE_SIZE ) 
		 ;  char nvmem_name [ 64 ] ; } cocci_id@p ;
