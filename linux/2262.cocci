...
position p;
@@
 struct zx2967_thermal_priv * cocci_id@p ;
...
position p;
@@
 struct zx2967_thermal_priv {  struct thermal_zone_device * tzd ;  struct mutex lock ;  struct clk * clk_topcrm ;  struct clk * clk_apb ;  void __iomem * regs ;  struct device * dev ; } cocci_id@p ;
