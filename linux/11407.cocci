...
position p;
@@
 union drm_vmw_alloc_dmabuf_arg cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * nb , unsigned long val , void * ptr ) ;
...
position p;
@@
 const char * cocci_id@p [ vmw_dma_map_max ] ;
...
position p;
@@
 struct drm_vmw_get_3d_cap_arg cocci_id@p ;
...
position p;
@@
 struct drm_vmw_control_stream_arg cocci_id@p ;
...
position p;
@@
 struct drm_vmw_unref_dmabuf_arg cocci_id@p ;
...
position p;
@@
 volatile SVGA3dQueryResult * cocci_id@p ;
...
position p;
@@
 struct vmw_cmdbuf_man * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_stream_arg cocci_id@p ;
...
position p;
@@
 struct drm_vmw_getparam_arg cocci_id@p ;
...
position p;
@@
 struct drm_vmw_synccpu_arg cocci_id@p ;
...
position p;
@@
 struct drm_vmw_present_readback_arg cocci_id@p ;
...
position p;
@@
 struct drm_vmw_present_arg cocci_id@p ;
