...
position p;
@@
 struct mlxsw_sp2_kvdl {  struct mlxsw_sp2_kvdl_part * parts [ MLXSW_SP2_KVDL_PARTS_INFO_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_kvdl_part {  const struct mlxsw_sp2_kvdl_part_info * info ;  unsigned int usage_bit_count ;  unsigned int indexes_per_usage_bit ;  unsigned int last_allocated_bit ;  unsigned long usage [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_kvdl cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp2_kvdl_part_info * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_kvdl_part * cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_sp2_kvdl_part_info {  u8 res_type ;  enum mlxsw_res_id usage_bit_count_res_id ;  enum mlxsw_res_id index_range_res_id ; } cocci_id@p ;
