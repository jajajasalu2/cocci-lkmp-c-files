...
position p;
@@
 struct receiver_context * cocci_id@p ;
...
position p;
@@
 struct receiver_context {  unsigned int num_packets ;  int in_fds [ 2 ] ;  int ready_out ;  int wakefd ; } cocci_id@p ;
...
position p;
@@
 struct sender_context cocci_id@p ;
...
position p;
@@
 struct sender_context {  unsigned int num_fds ;  int ready_out ;  int wakefd ;  int out_fds [ 0 ] ; } cocci_id@p ;
