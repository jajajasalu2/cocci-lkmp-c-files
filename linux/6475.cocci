...
position p;
@@
 struct wm8350_dcdc_efficiency {  int uA_load_min ;  int uA_load_max ;  unsigned int mode ; } cocci_id@p ;
...
position p;
@@
 const struct regulator_desc cocci_id@p [ NUM_WM8350_REGULATORS ] ;
...
position p;
@@
 const struct wm8350_dcdc_efficiency * cocci_id@p ;
