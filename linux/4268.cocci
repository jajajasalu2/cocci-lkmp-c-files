...
typedef u8;
@@
 struct sonypi_eventtypes {  u8 data ;  unsigned long mask ;  struct sonypi_event * events ; } cocci_id@p ;
...
position p;
@@
 struct sony_pic_dev cocci_id@p ;
...
typedef u8;
@@
 struct sony_nc_event {  u8 data ;  u8 event ; } cocci_id@p ;
...
position p;
@@
 struct acpi_resource * cocci_id@p ;
...
position p;
@@
 struct sonypi_compat_s cocci_id@p ;
...
position p;
@@
 struct snc_gfx_switch_control {  struct device_attribute attr ;  unsigned int handle ; } cocci_id@p ;
...
position p;
@@
 struct sony_nc_value cocci_id@p [ ] ;
...
position p;
@@
 struct touchpad_control cocci_id@p ;
...
position p;
@@
 struct snc_thermal_ctrl {  unsigned int mode ;  unsigned int profiles ;  struct device_attribute mode_attr ;  struct device_attribute profiles_attr ; } cocci_id@p ;
...
position p;
@@
 struct snc_lid_resume_control {  struct device_attribute attrs [ LID_RESUME_MAX ] ;  unsigned int status ;  int handle ; } cocci_id@p ;
...
position p;
@@
 struct battery_care_control {  struct device_attribute attrs [ 2 ] ;  unsigned int handle ; } cocci_id@p ;
...
position p;
@@
 struct sonypi_event cocci_id@p [ ] ;
...
position p;
@@
 struct rfkill * cocci_id@p [ N_SONY_RFKILL ] ;
...
position p;
@@
 struct acpi_resource_io * cocci_id@p ;
...
position p;
@@
 struct snc_thermal_ctrl cocci_id@p ;
...
position p;
@@
 struct snc_gfx_switch_control cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct platform_device * pd , unsigned int handle ) ;
...
position p;
@@
 struct sony_pic_ioport * cocci_id@p ;
...
position p;
@@
 struct sony_nc_handles * cocci_id@p ;
...
position p;
@@
 enum sony_nc_rfkill cocci_id@p ;
...
position p;
@@
 struct sony_pic_irq {  struct acpi_resource_irq irq ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct sony_nc_event cocci_id@p [ ] ;
...
position p;
@@
 enum gfx_switch { SPEED , STAMINA , AUTO , } cocci_id@p ;
...
typedef u8;
@@
 struct sony_backlight_props {  struct backlight_device * dev ;  int handle ;  int cmd_base ;  u8 offset ;  u8 maxlvl ; } cocci_id@p ;
...
position p;
@@
 struct sony_pic_irq * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,atomic_t,spinlock_t;
@@
 struct sonypi_compat_s {  struct fasync_struct * fifo_async ;  struct kfifo fifo ;  spinlock_t fifo_lock ;  wait_queue_head_t fifo_proc_list ;  atomic_t open_count ; } cocci_id@p ;
...
position p;
@@
 struct acpi_resource_irq * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const int , const int ) ;
...
position p;
@@
 struct sony_backlight_props cocci_id@p ;
...
position p;
@@
 struct sony_nc_value {  char * name ;  char * * acpiget ;  char * * acpiset ;  int ( * validate ) ( const int , const int ) ;  int value ;  int valid ;  int debug ;  struct device_attribute devattr ; } cocci_id@p ;
...
position p;
@@
 struct battery_care_control * cocci_id@p ;
...
position p;
@@
 struct sony_pic_ioport {  struct acpi_resource_io io1 ;  struct acpi_resource_io io2 ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct sony_laptop_input_s cocci_id@p ;
...
position p;
@@
 struct {  struct acpi_resource res1 ;  struct acpi_resource res2 ;  struct acpi_resource res3 ;  struct acpi_resource res4 ; } * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct acpi_device * device , unsigned int handle ) ;
...
position p;
@@
 struct sonypi_eventtypes cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct sony_pic_dev {  struct acpi_device * acpi_dev ;  struct sony_pic_irq * cur_irq ;  struct sony_pic_ioport * cur_ioport ;  struct list_head interrupts ;  struct list_head ioports ;  struct mutex lock ;  struct sonypi_eventtypes * event_types ;  int ( * handle_irq ) ( const u8 , const u8 ) ;  int model ;  u16 evport_offset ;  u8 camera_power ;  u8 bluetooth_power ;  u8 wwan_power ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct platform_device * pd ) ;
...
typedef u8;
@@
 struct sonypi_event {  u8 data ;  u8 event ; } cocci_id@p ;
...
position p;
@@
 enum event_types { HOTKEY = 1 , KILLSWITCH , GFX_SWITCH , } cocci_id@p ;
...
typedef u16;
@@
 struct sony_nc_handles {  u16 cap [ 0x10 ] ;  struct device_attribute devattr ; } cocci_id@p ;
...
position p;
@@
 struct sony_laptop_keypress cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct platform_device * pd ) ;
...
position p;
@@
 struct kbd_backlight {  unsigned int handle ;  unsigned int base ;  unsigned int mode ;  unsigned int timeout ;  unsigned int has_timeout ;  struct device_attribute mode_attr ;  struct device_attribute timeout_attr ; } cocci_id@p ;
...
position p;
@@
 struct snc_lid_resume_control cocci_id@p ;
...
position p;
@@
 struct kbd_backlight * cocci_id@p ;
...
position p;
@@
 struct sony_laptop_keypress {  struct input_dev * dev ;  int key ; } cocci_id@p ;
...
position p;
@@
 struct acpi_device_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct platform_device * pd , unsigned int handle ) ;
...
@@
 struct sony_laptop_input_s {  atomic_t users ;  struct input_dev * jog_dev ;  struct input_dev * key_dev ;  struct kfifo fifo ;  spinlock_t fifo_lock ;  struct timer_list release_key_timer ; } cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct device * , struct device_attribute * , char * ) ;
...
position p;
@@
 struct touchpad_control {  struct device_attribute attr ;  int handle ; } cocci_id@p ;
...
position p;
@@
 enum sony_nc_rfkill { SONY_WIFI , SONY_BLUETOOTH , SONY_WWAN , SONY_WIMAX , N_SONY_RFKILL , } cocci_id@p ;
