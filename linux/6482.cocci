...
position p;
@@
 struct gpio_regulator_data * cocci_id@p ;
...
position p;
@@
 struct gpio_regulator_data {  struct regulator_desc desc ;  struct gpio_desc * * gpiods ;  int nr_gpios ;  struct gpio_regulator_state * states ;  int nr_states ;  int state ; } cocci_id@p ;
