...
position p;
@@
 struct augmented_arg {  unsigned int size ;  int err ;  char value [ PATH_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct augmented_args_payload * cocci_id@p ;
...
position p;
@@
 struct syscall_enter_args {  unsigned long long common_tp_fields ;  long syscall_nr ;  unsigned long args [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 struct syscall_exit_args cocci_id@p ;
...
position p;
@@
 struct syscall_enter_args * cocci_id@p ;
...
typedef bool,u16;
@@
 struct syscall {  bool enabled ;  u16 string_args_len [ 6 ] ; } cocci_id@p ;
