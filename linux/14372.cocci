...
typedef u8;
@@
 struct i2c_device {  struct i2c_adapter * i2c_adap ;  u8 i2c_addr ; } cocci_id@p ;
...
position p;
@@
 struct dib7000p_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dib7000p_state * state , int mode ) ;
...
position p;
@@
 enum dib7000p_power_mode { DIB7000P_POWER_ALL = 0 , DIB7000P_POWER_ANALOG_ADC , DIB7000P_POWER_INTERFACE_ONLY , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dvb_frontend * fe , int mode ) ;
...
position p;
@@
 int cocci_id@p ( struct dvb_frontend * fe , int onoff ) ;
...
position p;
@@
 enum dib7000p_power_mode cocci_id@p ;
