...
position p;
@@
 struct oxnas_gpio_bank {  void __iomem * reg_base ;  struct gpio_chip gpio_chip ;  struct irq_chip irq_chip ;  unsigned int id ; } cocci_id@p ;
...
position p;
@@
 struct oxnas_pinctrl cocci_id@p ;
...
position p;
@@
 const struct oxnas_pin_group * cocci_id@p ;
...
position p;
@@
 struct oxnas_gpio_bank * cocci_id@p ;
...
position p;
@@
 const struct oxnas_pinctrl_data * cocci_id@p ;
...
position p;
@@
 struct oxnas_pin_group {  const char * name ;  unsigned int pin ;  unsigned int bank ;  struct oxnas_desc_function * functions ; } cocci_id@p ;
...
position p;
@@
 const struct oxnas_function * cocci_id@p ;
...
position p;
@@
 struct oxnas_desc_function {  const char * name ;  unsigned int fct ; } cocci_id@p ;
...
position p;
@@
 struct oxnas_pinctrl {  struct regmap * regmap ;  struct device * dev ;  struct pinctrl_dev * pctldev ;  const struct oxnas_function * functions ;  unsigned int nfunctions ;  const struct oxnas_pin_group * groups ;  unsigned int ngroups ;  struct oxnas_gpio_bank * gpio_banks ;  unsigned int nbanks ; } cocci_id@p ;
...
position p;
@@
 struct oxnas_desc_function cocci_id@p [ ] ;
...
position p;
@@
 struct oxnas_function {  const char * name ;  const char * const * groups ;  unsigned int ngroups ; } cocci_id@p ;
...
position p;
@@
 struct oxnas_pinctrl_data cocci_id@p ;
...
position p;
@@
 struct oxnas_pinctrl_data {  struct pinctrl_desc * desc ;  struct oxnas_pinctrl * pctl ; } cocci_id@p ;
