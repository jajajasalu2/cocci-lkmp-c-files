...
position p;
@@
 const struct intel_bw_info * cocci_id@p ;
...
position p;
@@
 const struct intel_bw_state * cocci_id@p ;
...
position p;
@@
 struct intel_qgv_point * cocci_id@p ;
...
position p;
@@
 const struct intel_qgv_point * cocci_id@p ;
...
position p;
@@
 struct intel_qgv_info cocci_id@p ;
...
typedef u8;
@@
 struct intel_qgv_info {  struct intel_qgv_point points [ 3 ] ;  u8 num_points ;  u8 num_channels ;  u8 t_bl ;  enum intel_dram_type dram_type ; } cocci_id@p ;
...
position p;
@@
 const struct intel_qgv_info * cocci_id@p ;
...
position p;
@@
 const struct intel_sa_info * cocci_id@p ;
...
position p;
@@
 struct intel_bw_info * cocci_id@p ;
