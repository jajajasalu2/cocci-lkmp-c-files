...
position p;
@@
 struct lm3697 {  struct gpio_desc * enable_gpio ;  struct regulator * regulator ;  struct i2c_client * client ;  struct regmap * regmap ;  struct device * dev ;  struct mutex lock ;  int bank_cfg ;  struct lm3697_led leds [ ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct lm3697_led {  u32 hvled_strings [ LM3697_MAX_LED_STRINGS ] ;  char label [ LED_MAX_NAME_SIZE ] ;  struct led_classdev led_dev ;  struct lm3697 * priv ;  struct ti_lmu_bank lmu_data ;  int control_bank ;  int enabled ;  int num_leds ; } cocci_id@p ;
