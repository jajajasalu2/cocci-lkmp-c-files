...
typedef u8;
@@
 struct bus_node * cocci_id@p ( u8 , struct bus_node * * , u8 ) ;
...
position p;
@@
 int cocci_id@p ( struct bus_node * , struct bus_node * ) ;
...
position p;
@@
 int cocci_id@p ( struct bus_node * * ) ;
...
position p;
@@
 void cocci_id@p ( struct bus_node * ) ;
...
position p;
@@
 void cocci_id@p ( struct bus_node * bus_cur , int type , int rangeno ) ;
...
position p;
@@
 int cocci_id@p ( int type , struct range_node * , struct bus_node * ) ;
