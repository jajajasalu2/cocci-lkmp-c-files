...
position p;
@@
 struct ice_aqc_query_txsched_res_resp * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_topo_elem * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_rl_profile * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ ICE_AQC_TOPO_MAX_LEVEL_NUM ] ;
...
position p;
@@
 struct ice_aqc_rl_profile_generic_elem * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_rl_profile_elem * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_suspend_resume_elem * cocci_id@p ;
...
position p;
@@
 struct ice_sched_agg_info * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_sched_elem_cmd * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_conf_elem * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_add_elem * cocci_id@p ;
...
position p;
@@
 struct ice_bw_type_info * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_rl_profile_info * cocci_id@p ;
...
position p;
@@
 struct ice_sched_agg_vsi_info * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_topo * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_txsched_elem * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_delete_elem * cocci_id@p ;
