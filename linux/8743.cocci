...
position p;
@@
 enum qed_coalescing_fsm cocci_id@p ;
...
position p;
@@
 struct qed_sb_sp_info * cocci_id@p ;
...
position p;
@@
 struct igu_prod_cons_update cocci_id@p ;
...
position p;
@@
 struct atten_status_block * cocci_id@p ;
...
position p;
@@
 struct aeu_invert_reg_bit * cocci_id@p ;
...
position p;
@@
 enum qed_attention_type { QED_ATTN_TYPE_ATTN , QED_ATTN_TYPE_PARITY , } cocci_id@p ;
...
position p;
@@
 struct aeu_invert_reg_bit cocci_id@p [ AEU_INVERT_REG_SPECIAL_MAX ] ;
...
position p;
@@
 struct aeu_invert_reg cocci_id@p [ NUM_ATTN_REGS ] ;
...
position p;
@@
 enum aeu_invert_reg_special_type { AEU_INVERT_REG_SPECIAL_CNIG_0 , AEU_INVERT_REG_SPECIAL_CNIG_1 , AEU_INVERT_REG_SPECIAL_CNIG_2 , AEU_INVERT_REG_SPECIAL_CNIG_3 , AEU_INVERT_REG_SPECIAL_MAX , } cocci_id@p ;
...
position p;
@@
 struct aeu_invert_reg * cocci_id@p ;
...
position p;
@@
 struct qed_sb_attn_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef qed_int_comp_cb_t;
@@
 struct qed_pi_info {  qed_int_comp_cb_t comp_cb ;  void * cookie ; } cocci_id@p ;
...
position p;
@@
 struct cau_pi_entry cocci_id@p ;
...
@@
 struct qed_sb_attn_info {  struct atten_status_block * sb_attn ;  dma_addr_t sb_phys ;  u16 index ;  u32 parity_mask [ NUM_ATTN_REGS ] ;  struct aeu_invert_reg * p_aeu_desc ;  u16 known_attn ;  u32 mfw_attn_addr ; } cocci_id@p ;
...
position p;
@@
 struct qed_sb_sp_info {  struct qed_sb_info sb_info ;  struct qed_pi_info pi_info_arr [ PIS_PER_SB_E4 ] ; } cocci_id@p ;
...
position p;
@@
 struct aeu_invert_reg {  struct aeu_invert_reg_bit bits [ 32 ] ; } cocci_id@p ;
