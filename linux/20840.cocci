...
position p;
@@
 struct hv_message_header cocci_id@p ;
...
position p;
@@
 struct hv_send_ipi_ex cocci_id@p ;
...
position p;
@@
 union hv_stimer_config cocci_id@p ;
...
position p;
@@
 struct kvm_vcpu_hv_synic * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct kvm_vcpu_hv_stimer * stimer , bool vcpu_kick ) ;
...
position p;
@@
 HV_REFERENCE_TSC_PAGE cocci_id@p ;
...
position p;
@@
 struct hv_timer_message_payload * cocci_id@p ;
...
position p;
@@
 struct hv_message_page cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ KVM_HV_MAX_SPARSE_VCPU_SET_BITS ] ;
...
position p;
@@
 struct kvm_vcpu_hv_stimer cocci_id@p ;
...
position p;
@@
 struct hv_tlb_flush cocci_id@p ;
...
position p;
@@
 struct hv_tlb_flush_ex cocci_id@p ;
