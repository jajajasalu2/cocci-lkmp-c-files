...
typedef spinlock_t;
@@
 struct goldfish_battery_data {  void __iomem * reg_base ;  int irq ;  spinlock_t lock ;  struct power_supply * battery ;  struct power_supply * ac ; } cocci_id@p ;
...
position p;
@@
 struct goldfish_battery_data * cocci_id@p ;
