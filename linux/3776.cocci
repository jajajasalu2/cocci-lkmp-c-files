...
position p;
@@
 struct atmel_ecdh_ctx cocci_id@p ;
...
typedef u8,bool;
@@
 struct atmel_ecdh_ctx {  struct i2c_client * client ;  struct crypto_kpp * fallback ;  const u8 * public_key ;  unsigned int curve_id ;  size_t n_sz ;  bool do_fallback ; } cocci_id@p ;
...
position p;
@@
 struct atmel_ecc_driver_data cocci_id@p ;
...
position p;
@@
 struct atmel_i2c_work_data * cocci_id@p ;
...
position p;
@@
 struct atmel_i2c_client_priv * cocci_id@p ;
...
position p;
@@
 struct atmel_i2c_cmd * cocci_id@p ;
