...
position p;
@@
 union {  struct nvif_notify_uevent_req none ; } * cocci_id@p ;
...
position p;
@@
 struct nvif_notify_uevent_rep cocci_id@p ;
...
position p;
@@
 struct nv50_disp_chan * cocci_id@p ;
...
position p;
@@
 const struct nv50_disp_mthd_list * cocci_id@p ;
...
position p;
@@
 struct nv50_disp_chan_object {  struct nvkm_oproxy oproxy ;  struct nv50_disp * disp ;  int hash ; } cocci_id@p ;
...
position p;
@@
 const struct nv50_disp_chan_func * cocci_id@p ;
...
position p;
@@
 struct nv50_disp_chan_object * cocci_id@p ;
...
position p;
@@
 const struct nv50_disp_chan_mthd * cocci_id@p ;
