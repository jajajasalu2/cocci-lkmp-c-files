...
position p;
@@
 const struct usb_mon_operations * cocci_id@p ;
...
position p;
@@
 const struct usb_hcd * cocci_id@p ;
...
position p;
@@
 struct giveback_urb_bh * cocci_id@p ;
