...
position p;
@@
 struct sysinfo_1_2_2_extension * cocci_id@p ;
...
position p;
@@
 struct sysinfo_1_2_2 * cocci_id@p ;
...
position p;
@@
 struct stsi_file {  const struct file_operations * fops ;  char * name ; } cocci_id@p ;
