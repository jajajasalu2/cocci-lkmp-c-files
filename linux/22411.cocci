...
position p;
@@
 const struct oxygen_model cocci_id@p ;
...
position p;
@@
 struct xonar_pcm179x cocci_id@p ;
...
position p;
@@
 struct xonar_hdav {  struct xonar_pcm179x pcm179x ;  struct xonar_hdmi hdmi ; } cocci_id@p ;
...
typedef s8,u8,bool;
@@
 struct xonar_pcm179x {  struct xonar_generic generic ;  unsigned int dacs ;  u8 pcm1796_regs [ 4 ] [ 5 ] ;  unsigned int current_rate ;  bool h6 ;  bool hp_active ;  s8 hp_gain_offset ;  bool has_cs2000 ;  u8 cs2000_regs [ 0x1f ] ;  bool broken_i2c ; } cocci_id@p ;
