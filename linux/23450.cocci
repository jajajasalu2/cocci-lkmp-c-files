...
position p;
@@
 const struct sigma_fw_chunk_control * cocci_id@p ;
...
position p;
@@
 const struct sigmadsp_ops * cocci_id@p ;
...
position p;
@@
 const struct sigma_fw_chunk * cocci_id@p ;
...
position p;
@@
 const struct sigma_fw_chunk_data * cocci_id@p ;
...
position p;
@@
 struct sigma_fw_chunk_data * cocci_id@p ;
...
position p;
@@
 struct sigma_firmware_header cocci_id@p ;
...
position p;
@@
 struct sigma_action * cocci_id@p ;
...
position p;
@@
 const struct sigma_fw_chunk_samplerate * cocci_id@p ;
...
position p;
@@
 enum { SIGMA_ACTION_WRITEXBYTES = 0 , SIGMA_ACTION_WRITESINGLE , SIGMA_ACTION_WRITESAFELOAD , SIGMA_ACTION_END , } cocci_id@p ;
...
position p;
@@
 struct sigma_fw_chunk * cocci_id@p ;
...
position p;
@@
 const struct sigma_firmware_header * cocci_id@p ;
...
position p;
@@
 struct snd_kcontrol_volatile * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,uint8_t,uint32_t;
@@
 struct sigmadsp_control {  struct list_head head ;  uint32_t samplerates ;  unsigned int addr ;  unsigned int num_bytes ;  const char * name ;  struct snd_kcontrol * kcontrol ;  bool cached ;  uint8_t cache [ ] ; } cocci_id@p ;
...
position p;
@@
 struct sigmadsp_control * cocci_id@p ;
...
position p;
@@
 struct sigmadsp_data * cocci_id@p ;
...
@@
 struct sigmadsp_data {  struct list_head head ;  uint32_t samplerates ;  unsigned int addr ;  unsigned int length ;  uint8_t data [ ] ; } cocci_id@p ;
