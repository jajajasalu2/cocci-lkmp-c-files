...
position p;
@@
 struct pll_out_data cocci_id@p [ ] ;
...
@@
 struct pll_out_data {  char * div_name ;  char * pll_out_name ;  u32 offset ;  int clk_id ;  u8 div_shift ;  u8 div_flags ;  u8 rst_shift ;  spinlock_t * lock ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_clk_periph_regs * cocci_id@p ;
