...
position p;
@@
 enum { RES_USAGE , RES_LIMIT , RES_MAX_USAGE , RES_FAILCNT , } cocci_id@p ;
...
position p;
@@
 struct hugetlb_cgroup {  struct cgroup_subsys_state css ;  struct page_counter hugepage [ HUGE_MAX_HSTATE ] ; } cocci_id@p ;
