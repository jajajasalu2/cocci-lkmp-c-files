...
typedef __u8;
@@
 struct usb_idmouse {  struct usb_device * udev ;  struct usb_interface * interface ;  unsigned char * bulk_in_buffer ;  size_t bulk_in_size ;  size_t orig_bi_size ;  __u8 bulk_in_endpointAddr ;  int open ;  int present ;  struct mutex lock ; } cocci_id@p ;
