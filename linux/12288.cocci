...
position p;
@@
 struct rb070d30_panel {  struct drm_panel panel ;  struct mipi_dsi_device * dsi ;  struct backlight_device * backlight ;  struct regulator * supply ;  struct {  struct gpio_desc * power ;  struct gpio_desc * reset ;  struct gpio_desc * updn ;  struct gpio_desc * shlr ; } gpios ; } cocci_id@p ;
...
position p;
@@
 struct rb070d30_panel * cocci_id@p ;
