...
position p;
@@
 struct adau1373_dai * cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( adau1373_bass_tlv , 
							      0 , 2 , 
...
position p;
@@
 enum adau1373_micbias_voltage cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( adau1373_3d_tlv , 
							      0 , 0 , 
...
position p;
@@
 struct adau1373 {  struct regmap * regmap ;  struct adau1373_dai dais [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct adau1373_platform_data * cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( adau1373_out_tlv , 
							      0 , 7 , 
...
typedef bool;
@@
 struct adau1373_dai {  unsigned int clk_src ;  unsigned int sysclk ;  bool enable_src ;  bool master ; } cocci_id@p ;
