...
position p;
@@
 void cocci_id@p ( struct task_struct * task , struct pt_regs * regs ) ;
...
position p;
@@
 struct pdc_hpmc_pim_11 * cocci_id@p ;
...
position p;
@@
 struct pdc_hpmc_pim_20 * cocci_id@p ;
