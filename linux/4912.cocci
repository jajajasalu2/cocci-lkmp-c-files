...
position p;
@@
 struct mthca_mpt_entry cocci_id@p ;
...
typedef u32;
@@
 struct mthca_mtt {  struct mthca_buddy * buddy ;  int order ;  u32 first_seg ; } cocci_id@p ;
