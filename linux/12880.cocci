...
position p;
@@
 enum i5000_chips { I5000P = 0 , I5000V = 1 , I5000X = 2 , } cocci_id@p ;
...
typedef u16;
@@
 struct i5000_dev_info {  const char * ctl_name ;  u16 fsb_mapping_errors ; } cocci_id@p ;
...
position p;
@@
 struct i5000_dimm_info * cocci_id@p ;
...
position p;
@@
 struct i5000_dimm_info {  int megabytes ;  int dual_rank ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ EDAC_MC_LABEL_LEN + 1 + 160 ] ;
...
position p;
@@
 char cocci_id@p [ EDAC_MC_LABEL_LEN + 1 + 170 ] ;
...
position p;
@@
 const struct i5000_dev_info cocci_id@p [ ] ;
...
typedef u32,u16;
@@
 struct i5000_error_info {  u32 ferr_fat_fbd ;  u32 nerr_fat_fbd ;  u32 ferr_nf_fbd ;  u32 nerr_nf_fbd ;  u32 redmemb ;  u16 recmema ;  u32 recmemb ;  u16 nrecmema ;  u32 nrecmemb ; } cocci_id@p ;
...
position p;
@@
 struct i5000_error_info * cocci_id@p ;
