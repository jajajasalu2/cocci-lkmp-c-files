...
symbol cocci_id;
position p;
typedef u8,bool,u32,psched_time_t;
@@
 struct pie_params {  psched_time_t target ;  u32 tupdate ;  u32 limit ;  u32 alpha ;  u32 beta ;  bool ecn ;  bool bytemode ;  u8 dq_rate_estimator ; } cocci_id@p ;
...
position p;
@@
 struct pie_sched_data * cocci_id@p ;
...
position p;
@@
 struct pie_sched_data {  struct pie_params params ;  struct pie_vars vars ;  struct pie_stats stats ;  struct timer_list adapt_timer ;  struct Qdisc * sch ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_PIE_MAX + 1 ] ;
...
position p;
@@
 struct tc_pie_xstats cocci_id@p ;
...
typedef u32;
@@
 struct pie_stats {  u32 packets_in ;  u32 dropped ;  u32 overlimit ;  u32 maxq ;  u32 ecn_mark ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_PIE_MAX + 1 ] ;
...
symbol cocci_id;
position p;
typedef u8,u64,u32,psched_time_t;
@@
 struct pie_vars {  u64 prob ;  psched_time_t burst_time ;  psched_time_t qdelay ;  psched_time_t qdelay_old ;  u64 dq_count ;  psched_time_t dq_tstamp ;  u64 accu_prob ;  u32 avg_dq_rate ;  u32 qlen_old ;  u8 accu_prob_overflows ; } cocci_id@p ;
...
typedef psched_time_t;
@@
 struct pie_skb_cb {  psched_time_t enqueue_time ; } cocci_id@p ;
