...
position p;
@@
 struct armada37xx_cpufreq_state * cocci_id@p ;
...
position p;
@@
 struct armada_37xx_dvfs cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct armada_37xx_dvfs {  u32 cpu_freq_max ;  u8 divider [ LOAD_LEVEL_NR ] ;  u32 avs [ LOAD_LEVEL_NR ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct armada37xx_cpufreq_state {  struct regmap * regmap ;  u32 nb_l0l1 ;  u32 nb_l2l3 ;  u32 nb_dyn_mod ;  u32 nb_cpu_load ; } cocci_id@p ;
