...
position p;
@@
 const  cocci_id@p ( max98090_micboost_tlv , 
							      0 , 1 , 
...
position p;
@@
 struct max98090_priv * cocci_id@p ;
...
position p;
@@
 struct dmic_table {  int pclk ;  struct {  int freq ;  int comp [ 6 ] ; } settings [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( max98090_mixout_tlv , 
							      0 , 1 , 
...
position p;
@@
 const  cocci_id@p ( max98090_line_single_ended_tlv , 
							      - 600 , 600 , 0 ) ;
...
position p;
@@
 struct max98090_cdata * cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( max98090_hp_tlv , 
							      0 , 6 , 
...
position p;
@@
 const struct dmic_table cocci_id@p [ ] ;
...
position p;
@@
 const  cocci_id@p ( max98090_line_tlv , 
							      0 , 3 , 
...
position p;
@@
 const  cocci_id@p ( max98090_spk_tlv , 
							      0 , 4 , 
...
position p;
@@
 const  cocci_id@p ( max98090_rcv_lout_tlv , 
							      0 , 6 , 
