...
position p;
@@
 struct da9055_wdt_data {  struct watchdog_device wdt ;  struct da9055 * da9055 ; } cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 reg_val ;  int user_time ; } cocci_id@p [ ] ;
...
position p;
@@
 struct da9055_wdt_data * cocci_id@p ;
