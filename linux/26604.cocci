...
position p;
@@
 struct {  struct nlmsghdr nl ;  struct rtmsg rt ;  char buf [ 8192 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __be32,__u8,__be64;
@@
 struct trie_value {  __u8 prefix [ 4 ] ;  __be64 value ;  int ifindex ;  int metric ;  __be32 gw ; } * cocci_id@p ;
...
typedef __be64;
@@
 struct direct_map {  struct arp_table arp ;  int ifindex ;  __be64 mac ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nlmsghdr nl ;  struct ndmsg rt ;  char buf [ 8192 ] ; } cocci_id@p ;
...
@@
 struct arp_table {  __be64 mac ;  __be32 dst ; } cocci_id@p ;
...
position p;
@@
 struct bpf_lpm_trie_key * cocci_id@p ;
