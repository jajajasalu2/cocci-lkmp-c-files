...
position p;
@@
 const struct ni_65xx_board cocci_id@p [ ] ;
...
position p;
@@
 struct ni_65xx_board {  const char * name ;  unsigned int num_dio_ports ;  unsigned int num_di_ports ;  unsigned int num_do_ports ;  unsigned int legacy_invert : 1 ; } cocci_id@p ;
