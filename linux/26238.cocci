...
typedef ip6_addr_t;
@@
 struct ip6_addr_t {  unsigned long long hi ;  unsigned long long lo ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ip6_addr_t,ip6_srh_t;
@@
 struct ip6_srh_t {  unsigned char nexthdr ;  unsigned char hdrlen ;  unsigned char type ;  unsigned char segments_left ;  unsigned char first_segment ;  unsigned char flags ;  unsigned short tag ;  struct ip6_addr_t segments [ 0 ] ; } cocci_id@p ;
...
typedef sr6_tlv_t;
@@
 struct sr6_tlv_t {  unsigned char type ;  unsigned char len ;  unsigned char value [ 0 ] ; } cocci_id@p ;
...
typedef ip6_t;
@@
 struct ip6_t {  unsigned int ver : 4 ;  unsigned int priority : 8 ;  unsigned int flow_label : 20 ;  unsigned short payload_len ;  unsigned char next_header ;  unsigned char hop_limit ;  unsigned long long src_hi ;  unsigned long long src_lo ;  unsigned long long dst_hi ;  unsigned long long dst_lo ; } cocci_id@p ;
