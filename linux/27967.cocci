...
symbol cocci_id;
position p;
typedef compat_ssize_t;
@@
 compat_ssize_t cocci_id@p ;
...
@@
 struct compat_msgbuf {  compat_long_t mtype ;  char mtext [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct compat_msqid_ds cocci_id@p ;
...
position p;
@@
 struct msg_sender {  struct list_head list ;  struct task_struct * tsk ;  size_t msgsz ; } cocci_id@p ;
...
position p;
@@
 struct msg_receiver cocci_id@p ;
...
position p;
@@
 struct compat_msqid64_ds cocci_id@p ;
...
position p;
@@
 struct msg_receiver {  struct list_head r_list ;  struct task_struct * r_tsk ;  int r_mode ;  long r_msgtype ;  long r_maxsize ;  struct msg_msg * r_msg ; } cocci_id@p ;
...
typedef time64_t;
@@
 struct msg_queue {  struct kern_ipc_perm q_perm ;  time64_t q_stime ;  time64_t q_rtime ;  time64_t q_ctime ;  unsigned long q_cbytes ;  unsigned long q_qnum ;  unsigned long q_qbytes ;  struct pid * q_lspid ;  struct pid * q_lrpid ;  struct list_head q_messages ;  struct list_head q_receivers ;  struct list_head q_senders ; } cocci_id@p ;
