...
position p;
@@
 struct v4l2_m2m_queue_ctx * cocci_id@p ;
...
position p;
@@
 enum v4l2_m2m_entity_type cocci_id@p ;
...
position p;
@@
 struct v4l2_m2m_dev cocci_id@p ;
...
position p;
@@
 enum v4l2_m2m_entity_type { MEM2MEM_ENT_TYPE_SOURCE , MEM2MEM_ENT_TYPE_SINK , MEM2MEM_ENT_TYPE_PROC , } cocci_id@p ;
