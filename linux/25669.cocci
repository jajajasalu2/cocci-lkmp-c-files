...
position p;
@@
 struct bt_ctf_field_type * cocci_id@p ;
...
position p;
@@
 struct bt_ctf_event * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct bt_ctf_field * field , const char * string ) ;
...
position p;
@@
 struct bt_ctf_stream * cocci_id@p ;
...
position p;
@@
 struct bt_ctf_clock * cocci_id@p ;
...
position p;
@@
 struct bt_ctf_writer * cocci_id@p ;
...
position p;
@@
 struct bt_ctf_field * cocci_id@p ;
...
position p;
@@
 struct bt_ctf_event_class * cocci_id@p ;
...
position p;
@@
 struct perf_data_convert_opts * cocci_id@p ;
...
position p;
@@
 struct bt_ctf_stream_class * cocci_id@p ;
...
typedef u32;
@@
 struct ctf_stream {  struct bt_ctf_stream * stream ;  int cpu ;  u32 count ; } cocci_id@p ;
...
position p;
@@
 struct evsel_priv {  struct bt_ctf_event_class * event_class ; } cocci_id@p ;
...
typedef u64;
@@
 struct convert {  struct perf_tool tool ;  struct ctf_writer writer ;  u64 events_size ;  u64 events_count ;  u64 non_sample_count ;  u64 queue_size ; } cocci_id@p ;
