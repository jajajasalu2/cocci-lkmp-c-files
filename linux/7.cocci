...
position p;
@@
 const struct provider * cocci_id@p ;
...
position p;
@@
 enum checkstatus { UNCHECKED = 0 , PREREQ , PASSED , FAILED , } cocci_id@p ;
...
position p;
@@
 const struct bus_type cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct check * c , struct dt_info * dti , struct node * node ) ;
...
typedef bool;
@@
 struct provider {  const char * prop_name ;  const char * cell_name ;  bool optional ; } cocci_id@p ;
