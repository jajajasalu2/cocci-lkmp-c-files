...
position p;
@@
 void cocci_id@p ( struct fb_par_valkyrie * par , struct fb_fix_screeninfo * fix ) ;
...
position p;
@@
 struct fb_par_valkyrie * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fb_fix_screeninfo * fix , struct fb_info_valkyrie * p ) ;
...
position p;
@@
 struct fb_info_valkyrie * cocci_id@p ;
...
position p;
@@
 struct valkyrie_regs cocci_id@p ;
...
position p;
@@
 struct fb_par_valkyrie {  int vmode , cmode ;  int xres , yres ;  int vxres , vyres ;  struct valkyrie_regvals * init ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , struct fb_par_valkyrie * par , const struct fb_info * fb_info ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_info * info , struct fb_info_valkyrie * p ) ;
...
position p;
@@
 struct valkyrie_regvals * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_info_valkyrie * p ) ;
