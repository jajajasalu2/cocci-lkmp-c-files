...
position p;
@@
 struct clear_hold_work * cocci_id@p ;
...
position p;
@@
 struct most_dci_obj cocci_id@p ;
...
position p;
@@
 struct most_channel_config * cocci_id@p ;
...
typedef u16;
@@
 struct most_dci_obj {  struct device dev ;  struct usb_device * usb_device ;  u16 reg_addr ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct most_interface * , unsigned char , unsigned char * ) ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * wq_obj ) ;
...
position p;
@@
 struct most_channel_capability * cocci_id@p ;
...
position p;
@@
 struct clear_hold_work {  struct work_struct ws ;  struct most_dev * mdev ;  unsigned int channel ;  int pipe ; } cocci_id@p ;
...
typedef u16;
@@
 struct regs {  const char * name ;  u16 reg ; } cocci_id@p ;
...
@@
 struct most_dev {  struct usb_device * usb_device ;  struct most_interface iface ;  struct most_channel_capability * cap ;  struct most_channel_config * conf ;  struct most_dci_obj * dci ;  u8 * ep_address ;  char description [ MAX_STRING_LEN ] ;  char suffix [ MAX_NUM_ENDPOINTS ] [ MAX_SUFFIX_LEN ] ;  spinlock_t channel_lock [ MAX_NUM_ENDPOINTS ] ;  bool padding_active [ MAX_NUM_ENDPOINTS ] ;  bool is_channel_healthy [ MAX_NUM_ENDPOINTS ] ;  struct clear_hold_work clear_work [ MAX_NUM_ENDPOINTS ] ;  struct usb_anchor * busy_urbs ;  struct mutex io_mutex ;  struct timer_list link_stat_timer ;  struct work_struct poll_work_obj ;  void ( * on_netinfo ) ( struct most_interface * most_iface , unsigned char link_state , unsigned char * addrs ) ; } cocci_id@p ;
...
position p;
@@
 struct most_channel_config * const cocci_id@p ;
