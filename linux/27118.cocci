...
position p;
@@
 struct ubifs_lpt_lprops cocci_id@p ;
...
position p;
@@
 struct lpt_scan_node {  union {  struct ubifs_nnode nnode ;  struct ubifs_pnode pnode ;  struct ubifs_cnode cnode ; } ;  int in_tree ;  union {  struct ubifs_nnode * nnode ;  struct ubifs_pnode * pnode ;  struct ubifs_cnode * cnode ; } ptr ; } cocci_id@p ;
...
position p;
@@
 ubifs_lpt_scan_callback cocci_id@p ;
...
position p;
@@
 struct ubifs_lprops * const cocci_id@p ;
...
position p;
@@
 struct lpt_scan_node cocci_id@p ;
...
position p;
@@
 struct ubifs_nbranch * cocci_id@p ;
