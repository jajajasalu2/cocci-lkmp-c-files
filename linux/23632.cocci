...
position p;
@@
 int ( * cocci_id@p ) ( struct asoc_simple_priv * priv , struct device_node * cpu_ep , struct device_node * codec_ep , struct link_info * li ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct asoc_simple_priv * priv , struct device_node * cpu_ep , struct device_node * codec_ep , struct link_info * li , int dup_codec ) ;
...
position p;
@@
 struct simple_dai_props * cocci_id@p ;
...
position p;
@@
 struct asoc_simple_dai * cocci_id@p ;
...
position p;
@@
 struct asoc_simple_priv * cocci_id@p ;
...
position p;
@@
 struct asoc_simple_data * cocci_id@p ;
