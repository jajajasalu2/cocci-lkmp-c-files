...
position p;
@@
 union acpi_object cocci_id@p [ 4 ] ;
...
position p;
@@
 struct cmpc_accel {  int sensitivity ;  int g_select ;  int inputdev_state ; } cocci_id@p ;
...
position p;
@@
 struct ipml200_dev {  struct backlight_device * bd ;  struct rfkill * rf ; } cocci_id@p ;
