...
typedef u8,u16;
@@
 union {  u8 buf [ MLXSW_REG_MCIA_TH_ITEM_SIZE ] ;  u16 temp ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MCIA_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MCIA_EEPROM_SIZE ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLXSW_REG_MCIA_EEPROM_MODULE_INFO_SIZE ] ;
