...
position p;
@@
 struct ieee80211_sta_vht_cap cocci_id@p ;
...
position p;
@@
 struct ath10k_mac_change_chanctx_arg cocci_id@p ;
...
position p;
@@
 const struct ath10k_skb_cb * cocci_id@p ;
...
position p;
@@
 enum wmi_tlv_tx_pause_action cocci_id@p ;
...
position p;
@@
 struct wmi_sta_keepalive_arg cocci_id@p ;
...
position p;
@@
 struct wmi_scan_chan_list_arg cocci_id@p ;
...
position p;
@@
 struct wmi_wmm_params_arg * cocci_id@p ;
...
position p;
@@
 struct wmi_bb_timing_cfg_arg * cocci_id@p ;
...
position p;
@@
 struct ieee80211_chanctx_conf * cocci_id@p ;
...
position p;
@@
 struct ath10k_mac_tdls_iter_data cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ NL80211_VHT_NSS_MAX ] ;
...
position p;
@@
 struct ath10k_vif_iter cocci_id@p ;
...
position p;
@@
 enum wmi_tlv_tx_pause_id cocci_id@p ;
...
position p;
@@
 struct wmi_peer_assoc_complete_arg * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_supported_band * cocci_id@p ;
...
position p;
@@
 enum ieee80211_roc_type cocci_id@p ;
...
position p;
@@
 struct wmi_sta_uapsd_auto_trig_arg cocci_id@p ;
...
position p;
@@
 const struct ieee80211_hdr * cocci_id@p ;
...
position p;
@@
 struct ath10k_mac_change_chanctx_arg {  struct ieee80211_chanctx_conf * ctx ;  struct ieee80211_vif_chanctx_switch * vifs ;  int n_vifs ;  int next_vif ; } cocci_id@p ;
...
position p;
@@
 struct wmi_rate_set_arg * cocci_id@p ;
...
position p;
@@
 enum ieee80211_sta_state cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_start_request_arg cocci_id@p ;
...
position p;
@@
 struct ieee80211_vif_chanctx_switch * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_sta_vht_cap * cocci_id@p ;
...
position p;
@@
 struct ieee80211_txq * cocci_id@p ;
...
position p;
@@
 enum ath10k_mac_tx_path cocci_id@p ;
...
position p;
@@
 struct ieee80211_mutable_offsets cocci_id@p ;
...
position p;
@@
 struct wmi_tdls_peer_capab_arg cocci_id@p ;
...
position p;
@@
 struct ieee80211_iface_combination cocci_id@p [ ] ;
...
position p;
@@
 struct ath10k_mac_tx_pause * cocci_id@p ;
...
position p;
@@
 enum wmi_tlv_rfkill_enable_radio cocci_id@p ;
...
position p;
@@
 const struct ieee80211_sta_ht_cap * cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_install_key_arg cocci_id@p ;
...
position p;
@@
 enum ieee80211_chanctx_switch_mode cocci_id@p ;
...
typedef u32;
@@
 struct ath10k_mac_tdls_iter_data {  u32 num_tdls_stations ;  struct ieee80211_vif * curr_vif ; } cocci_id@p ;
...
typedef u32;
@@
 struct ath10k_mac_tx_pause {  u32 vdev_id ;  enum wmi_tlv_tx_pause_id pause_id ;  enum wmi_tlv_tx_pause_action action ; } cocci_id@p ;
...
position p;
@@
 struct ieee80211_sta_ht_cap cocci_id@p ;
...
position p;
@@
 struct ieee80211_ops * cocci_id@p ;
...
position p;
@@
 struct ath10k_hw_params * cocci_id@p ;
...
position p;
@@
 struct wmi_stop_scan_arg cocci_id@p ;
...
position p;
@@
 struct ieee80211_scan_request * cocci_id@p ;
...
position p;
@@
 enum ath10k_mac_tx_path { ATH10K_MAC_TX_HTT , ATH10K_MAC_TX_HTT_MGMT , ATH10K_MAC_TX_WMI_MGMT , ATH10K_MAC_TX_UNKNOWN , } cocci_id@p ;
...
position p;
@@
 struct wmi_tdls_peer_update_cmd_arg cocci_id@p ;
...
position p;
@@
 enum wmi_tdls_peer_state cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ IEEE80211_HT_MCS_MASK_LEN ] ;
...
position p;
@@
 enum ath10k_hw_txrx_mode cocci_id@p ;
...
position p;
@@
 enum ieee80211_reconfig_type cocci_id@p ;
...
position p;
@@
 const struct ieee80211_tx_info * cocci_id@p ;
