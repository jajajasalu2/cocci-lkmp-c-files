...
position p;
@@
 const struct xen_pmu_data * cocci_id@p ;
...
typedef uint8_t;
@@
 struct xenpmu {  struct xen_pmu_data * xenpmu_data ;  uint8_t flags ; } cocci_id@p ;
...
position p;
@@
 struct xen_pmu_data cocci_id@p ;
...
position p;
@@
 struct xen_pmu_intel_ctxt * cocci_id@p ;
...
position p;
@@
 struct xen_pmu_cntr_pair * cocci_id@p ;
...
position p;
@@
 struct xen_pmu_amd_ctxt * cocci_id@p ;
...
position p;
@@
 const struct xen_pmu_regs * cocci_id@p ;
