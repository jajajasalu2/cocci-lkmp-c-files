...
position p;
@@
 union {  struct hdcp2_rep_stream_manage stream_manage ;  struct hdcp2_rep_stream_ready stream_ready ; } cocci_id@p ;
...
typedef u8,u32;
@@
 union {  u32 reg [ 2 ] ;  u8 shim [ DRM_HDCP_KSV_LEN ] ; } cocci_id@p ;
...
position p;
@@
 union {  struct hdcp2_ake_init ake_init ;  struct hdcp2_ake_send_cert send_cert ;  struct hdcp2_ake_no_stored_km no_stored_km ;  struct hdcp2_ake_send_hprime send_hprime ;  struct hdcp2_ake_send_pairing_info pairing_info ; } cocci_id@p ;
...
position p;
@@
 union {  struct hdcp2_lc_init lc_init ;  struct hdcp2_lc_send_lprime send_lprime ; } cocci_id@p ;
...
position p;
@@
 union {  struct hdcp2_rep_send_receiverid_list recvid_list ;  struct hdcp2_rep_send_ack rep_ack ; } cocci_id@p ;
...
position p;
@@
 enum i915_power_well_id cocci_id@p ;
...
typedef u8,u32;
@@
 union {  u32 reg [ 2 ] ;  u8 shim [ DRM_HDCP_AN_LEN ] ; } cocci_id@p ;
