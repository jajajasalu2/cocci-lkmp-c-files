...
typedef bool;
@@
 struct most_snd_grp {  struct config_group group ;  bool create_card ;  struct list_head list ; } cocci_id@p ;
...
typedef bool,u16;
@@
 struct mdev_link {  struct config_item item ;  struct list_head list ;  bool create_link ;  bool destroy_link ;  u16 num_buffers ;  u16 buffer_size ;  u16 subbuffer_size ;  u16 packets_per_xact ;  u16 dbr_size ;  char datatype [ PAGE_SIZE ] ;  char direction [ PAGE_SIZE ] ;  char name [ PAGE_SIZE ] ;  char device [ PAGE_SIZE ] ;  char channel [ PAGE_SIZE ] ;  char comp [ PAGE_SIZE ] ;  char comp_params [ PAGE_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct most_snd_grp * cocci_id@p ;
...
position p;
@@
 struct most_sound {  struct configfs_subsystem subsys ;  struct list_head soundcard_list ;  struct module * mod ; } cocci_id@p ;
...
position p;
@@
 struct most_common {  struct config_group group ;  struct module * mod ;  struct configfs_subsystem subsys ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct mdev_link * link ) ;
