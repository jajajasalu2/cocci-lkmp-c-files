...
position p;
@@
 struct vpif_interface * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ VPIF_NUMBER_OF_OBJECTS ] [ 2 ] ;
...
position p;
@@
 struct vpif_capture_chan_config * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct channel_obj * ch , int muxmode ) ;
...
position p;
@@
 struct vpif_cap_buffer * cocci_id@p ;
...
position p;
@@
 const struct vpif_channel_config_params * cocci_id@p ;
...
position p;
@@
 struct vpif_channel_config_params cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct channel_obj * ch ) ;
