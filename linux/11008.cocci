...
position p;
@@
 const struct vegam_pt_defaults * cocci_id@p ;
...
position p;
@@
 SMU75_Discrete_MCArbDramTimingTableEntry * cocci_id@p ;
...
position p;
@@
 SMU75_Discrete_DpmTable * cocci_id@p ;
...
position p;
@@
 struct SMU75_Discrete_Ulv * cocci_id@p ;
...
position p;
@@
 struct SMU75_Discrete_MCArbDramTimingTable cocci_id@p ;
...
position p;
@@
 struct SMU75_Discrete_PmFuses cocci_id@p ;
...
position p;
@@
 struct vegam_smumgr * cocci_id@p ;
...
position p;
@@
 struct SMU75_Discrete_GraphicsLevel cocci_id@p ;
...
position p;
@@
 const SMU75_Discrete_DpmTable * cocci_id@p ;
...
position p;
@@
 struct pp_atomctrl_memory_clock_param_ai cocci_id@p ;
...
position p;
@@
 const struct vegam_pt_defaults cocci_id@p [ POWERTUNE_DEFAULT_SET_MAX ] ;
...
position p;
@@
 struct SMU75_Discrete_DpmTable * cocci_id@p ;
...
position p;
@@
 struct SMU75_Discrete_MemoryLevel * cocci_id@p ;
