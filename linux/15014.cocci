...
position p;
@@
 const struct hi6220_divider_clock * cocci_id@p ;
...
position p;
@@
 const struct hisi_fixed_factor_clock * cocci_id@p ;
...
position p;
@@
 const struct hisi_gate_clock * cocci_id@p ;
...
position p;
@@
 const struct hisi_mux_clock * cocci_id@p ;
...
position p;
@@
 const struct hisi_divider_clock * cocci_id@p ;
...
position p;
@@
 const struct hisi_fixed_rate_clock * cocci_id@p ;
