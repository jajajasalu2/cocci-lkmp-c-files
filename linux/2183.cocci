...
position p;
@@
 struct lego_ev3_battery * cocci_id@p ;
...
position p;
@@
 struct lego_ev3_battery {  struct iio_channel * iio_v ;  struct iio_channel * iio_i ;  struct gpio_desc * rechargeable_gpio ;  struct power_supply * psy ;  int technology ;  int v_max ;  int v_min ; } cocci_id@p ;
