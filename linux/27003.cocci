...
position p;
@@
 void cocci_id@p ( struct xfs_dquot * dqp ) ;
...
position p;
@@
 struct xfs_quotainfo cocci_id@p ;
...
position p;
@@
 struct xfs_qm_isolate cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct xfs_dquot * dqp , void * data ) ;
...
position p;
@@
 struct xfs_qm_isolate {  struct list_head buffers ;  struct list_head dispose ; } cocci_id@p ;
...
position p;
@@
 struct xfs_dquot * cocci_id@p [ XFS_DQ_LOOKUP_BATCH ] ;
...
position p;
@@
 void cocci_id@p ( struct xfs_quotainfo * qi ) ;
...
position p;
@@
 struct xfs_def_quota * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xfs_mount * mp ) ;
