...
position p;
@@
 enum igb_diagnostics_results { TEST_REG = 0 , TEST_EEP , TEST_IRQ , TEST_LOOP , TEST_LINK , } cocci_id@p ;
...
position p;
@@
 struct igb_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
...
position p;
@@
 const struct igb_stats cocci_id@p [ ] ;
...
position p;
@@
 struct igb_reg_test * cocci_id@p ;
...
position p;
@@
 struct e1000_dev_spec_82575 * cocci_id@p ;
...
position p;
@@
 struct igb_rx_queue_stats cocci_id@p ;
...
typedef u32,u16;
@@
 struct igb_reg_test {  u16 reg ;  u16 reg_offset ;  u16 array_len ;  u16 test_type ;  u32 mask ;  u32 write ; } cocci_id@p ;
...
position p;
@@
 struct e1000_sfp_flags * cocci_id@p ;
