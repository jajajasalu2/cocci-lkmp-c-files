...
position p;
@@
 enum sec_cipher_alg cocci_id@p ;
...
position p;
@@
 const struct sec_c_alg_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct sec_alg_tfm_ctx * cocci_id@p ;
...
position p;
@@
 struct sec_dev_info * cocci_id@p ;
...
position p;
@@
 struct sec_c_alg_cfg {  unsigned c_alg : 3 ;  unsigned c_mode : 3 ;  unsigned key_len : 2 ;  unsigned c_width : 2 ; } cocci_id@p ;
...
position p;
@@
 struct sec_request_el cocci_id@p ;
