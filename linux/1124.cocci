...
position p;
@@
 struct od_dbs_tuners * cocci_id@p ;
...
position p;
@@
 unsigned int ( * cocci_id@p ) ( struct cpufreq_policy * , unsigned int , unsigned int ) ;
...
position p;
@@
 struct od_policy_dbs_info * cocci_id@p ;
