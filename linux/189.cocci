...
position p;
@@
 int cocci_id@p [ IRQ_TIMINGS_SIZE ] ;
...
typedef u64;
@@
 struct irqt_stat {  u64 last_ts ;  u64 ema_time [ PREDICTION_BUFFER_SIZE ] ;  int timings [ IRQ_TIMINGS_SIZE ] ;  int circ_timings [ IRQ_TIMINGS_SIZE ] ;  int count ; } cocci_id@p ;
...
typedef u64;
@@
 struct timings_intervals {  u64 * intervals ;  size_t count ; } cocci_id@p ;
...
position p;
@@
 struct timings_intervals * cocci_id@p ;
