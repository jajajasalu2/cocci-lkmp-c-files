...
position p;
@@
 struct exynos_ppmu {  struct devfreq_event_dev * * edev ;  struct devfreq_event_desc * desc ;  unsigned int num_events ;  struct device * dev ;  struct regmap * regmap ;  struct exynos_ppmu_data ppmu ;  enum exynos_ppmu_type ppmu_type ; } cocci_id@p ;
...
position p;
@@
 struct __exynos_ppmu_events {  char * name ;  int id ; } cocci_id@p [ ] ;
...
position p;
@@
 enum exynos_ppmu_type { EXYNOS_TYPE_PPMU , EXYNOS_TYPE_PPMU_V2 , } cocci_id@p ;
...
position p;
@@
 enum exynos_ppmu_type cocci_id@p ;
...
position p;
@@
 struct devfreq_event_desc * cocci_id@p ;
...
position p;
@@
 const struct devfreq_event_ops cocci_id@p ;
...
position p;
@@
 struct exynos_ppmu_data {  struct clk * clk ; } cocci_id@p ;
