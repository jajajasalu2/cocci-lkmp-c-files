...
position p;
@@
 const struct edac_device_prv_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct device_node * np ) ;
...
position p;
@@
 struct altr_edac_device_dev * cocci_id@p ;
...
position p;
@@
 struct altr_sdram_mc_data * cocci_id@p ;
...
position p;
@@
 struct altr_arria10_edac * cocci_id@p ;
...
position p;
@@
 const struct altr_sdram_prv_data cocci_id@p ;
