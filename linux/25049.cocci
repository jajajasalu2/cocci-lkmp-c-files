...
position p;
@@
 struct nci_core_set_config_rsp * cocci_id@p ;
...
position p;
@@
 struct nci_nfcee_discover_rsp * cocci_id@p ;
...
position p;
@@
 struct nci_core_conn_create_rsp * cocci_id@p ;
...
position p;
@@
 struct nci_core_init_rsp_2 * cocci_id@p ;
...
position p;
@@
 struct nci_core_init_rsp_1 * cocci_id@p ;
...
position p;
@@
 struct nci_core_reset_rsp * cocci_id@p ;
