...
typedef u8;
@@
 struct pca963x_led {  struct pca963x * chip ;  struct led_classdev led_cdev ;  int led_num ;  char name [ 32 ] ;  u8 gdc ;  u8 gfrq ; } cocci_id@p ;
...
position p;
@@
 struct pca963x_chipdef * cocci_id@p ;
...
position p;
@@
 struct pca963x {  struct pca963x_chipdef * chipdef ;  struct mutex mutex ;  struct i2c_client * client ;  struct pca963x_led * leds ;  unsigned long leds_on ; } cocci_id@p ;
...
position p;
@@
 struct pca963x_platform_data * cocci_id@p ;
...
position p;
@@
 enum pca963x_type { pca9633 , pca9634 , pca9635 , } cocci_id@p ;
...
typedef u8;
@@
 struct pca963x_chipdef {  u8 grppwm ;  u8 grpfreq ;  u8 ledout_base ;  int n_leds ;  unsigned int scaling ; } cocci_id@p ;
