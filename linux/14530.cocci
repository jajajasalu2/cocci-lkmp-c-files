...
position p;
@@
 const struct sunxi_ccu_desc cocci_id@p ;
...
position p;
@@
 struct ccu_reset_map cocci_id@p [ ] ;
...
position p;
@@
 const struct ccu_mux_fixed_prediv cocci_id@p [ ] ;
...
position p;
@@
 const struct ccu_mux_var_prediv cocci_id@p [ ] ;
