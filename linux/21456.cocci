...
position p;
@@
 struct acpi_madt_generic_interrupt cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 enum ipi_msg_type { IPI_RESCHEDULE , IPI_CALL_FUNC , IPI_CPU_STOP , IPI_CPU_CRASH_STOP , IPI_TIMER , IPI_IRQ_WORK , IPI_WAKEUP , } cocci_id@p ;
