...
position p;
@@
 struct tc_mqprio_qopt_offload * cocci_id@p ;
...
position p;
@@
 struct i40e_hw_port_stats * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ I40E_HKEY_ARRAY_SIZE ] ;
...
position p;
@@
 int cocci_id@p ( struct i40e_pf * pf ) ;
...
position p;
@@
 const unsigned short cocci_id@p ;
...
position p;
@@
 struct i40e_cloud_filter * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct i40e_vsi * vsi ) ;
...
position p;
@@
 struct i40e_lump_tracking cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct i40e_pf * pf , bool reinit ) ;
...
position p;
@@
 struct i40e_tx_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct i40e_veb * veb ) ;
...
position p;
@@
 void cocci_id@p ( struct i40e_pf * pf ) ;
...
position p;
@@
 struct i40e_eth_stats * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct i40e_vsi * vsi ) ;
...
position p;
@@
 struct i40e_channel * cocci_id@p ;
...
position p;
@@
 struct i40e_netdev_priv cocci_id@p ;
...
position p;
@@
 struct i40e_virt_mem * cocci_id@p ;
...
position p;
@@
 struct i40e_fdir_filter * cocci_id@p ;
...
position p;
@@
 enum pci_channel_state cocci_id@p ;
...
position p;
@@
 struct i40e_dcbx_config cocci_id@p ;
...
position p;
@@
 struct i40e_q_vector * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct i40e_pf * pf , struct i40e_hw * hw ) ;
...
position p;
@@
 struct i40e_mac_filter * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct i40e_pf * pf ) ;
...
position p;
@@
 struct i40e_veb_tc_stats * cocci_id@p ;
...
position p;
@@
 struct i40e_tx_buffer * cocci_id@p ;
...
position p;
@@
 struct i40e_arq_event_info * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct i40e_pf * pf , bool lock_acquired ) ;
...
position p;
@@
 struct i40e_new_mac_filter * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ I40E_INT_NAME_STR_LEN ] ;
...
position p;
@@
 struct i40e_aqc_lan_overflow * cocci_id@p ;
...
position p;
@@
 struct i40e_flex_pit * cocci_id@p ;
...
position p;
@@
 struct flow_match_enc_keyid cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PCI_WIDTH_SIZE ] ;
...
position p;
@@
 struct i40e_dcb_app_priority_table cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ I40E_MAX_TRAFFIC_CLASS ] ;
...
position p;
@@
 int cocci_id@p ( struct i40e_veb * veb , struct i40e_vsi * vsi ) ;
...
position p;
@@
 struct i40e_aqc_switch_config_element_resp * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct i40e_pf * pf , bool reinit , bool lock_acquired ) ;
...
position p;
@@
 struct i40e_fwd_adapter * cocci_id@p ;
...
position p;
@@
 struct i40e_udp_port_config * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct i40e_pf * pf , enum i40e_admin_queue_opc list_type ) ;
...
position p;
@@
 struct i40e_dma_mem * cocci_id@p ;
...
position p;
@@
 struct i40e_hmc_obj_rxq cocci_id@p ;
...
position p;
@@
 struct i40e_hmc_obj_txq cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PCI_SPEED_SIZE ] ;
