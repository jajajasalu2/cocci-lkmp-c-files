...
typedef u64;
@@
 struct fake_sym {  u64 start ;  u64 length ;  const char * name ; } cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 pid ;  const char * comm ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  const char * dso_name ;  struct fake_sym * syms ;  size_t nr_syms ; } cocci_id@p [ ] ;
...
typedef u64,u32;
@@
 struct {  u32 pid ;  u64 start ;  const char * filename ; } cocci_id@p [ ] ;
