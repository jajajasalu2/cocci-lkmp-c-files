...
typedef spinlock_t;
@@
 struct snd_ad1889 {  struct snd_card * card ;  struct pci_dev * pci ;  int irq ;  unsigned long bar ;  void __iomem * iobase ;  struct snd_ac97 * ac97 ;  struct snd_ac97_bus * ac97_bus ;  struct snd_pcm * pcm ;  struct snd_info_entry * proc ;  struct snd_pcm_substream * psubs ;  struct snd_pcm_substream * csubs ;  struct ad1889_register_state wave ;  struct ad1889_register_state ramc ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct ad1889_register_state {  u16 reg ;  u32 addr ;  unsigned long size ; } cocci_id@p ;
