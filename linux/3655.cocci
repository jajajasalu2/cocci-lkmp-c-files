...
position p;
@@
 int cocci_id@p [ IMX_SC_ERR_LAST ] ;
...
position p;
@@
 enum imx_sc_error_codes { IMX_SC_ERR_NONE = 0 , IMX_SC_ERR_VERSION = 1 , IMX_SC_ERR_CONFIG = 2 , IMX_SC_ERR_PARM = 3 , IMX_SC_ERR_NOACCESS = 4 , IMX_SC_ERR_LOCKED = 5 , IMX_SC_ERR_UNAVAILABLE = 6 , IMX_SC_ERR_NOTFOUND = 7 , IMX_SC_ERR_NOPOWER = 8 , IMX_SC_ERR_IPC = 9 , IMX_SC_ERR_BUSY = 10 , IMX_SC_ERR_FAIL = 11 , IMX_SC_ERR_LAST , } cocci_id@p ;
...
position p;
@@
 struct imx_sc_chan {  struct imx_sc_ipc * sc_ipc ;  struct mbox_client cl ;  struct mbox_chan * ch ;  int idx ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct imx_sc_ipc {  struct imx_sc_chan chans [ SCU_MU_CHAN_NUM ] ;  struct device * dev ;  struct mutex lock ;  struct completion done ;  u32 * msg ;  u8 rx_size ;  u8 count ; } cocci_id@p ;
