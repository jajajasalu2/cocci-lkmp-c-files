...
position p;
@@
 struct p80211item_pstr6 * cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct wlandevice * wlandev , u16 fc ) ;
...
position p;
@@
 struct p80211item_unk392 * cocci_id@p ;
...
position p;
@@
 struct p80211ioctl_req * cocci_id@p ;
...
position p;
@@
 struct p80211_hdr_a3 * cocci_id@p ;
