...
position p;
@@
 void ( * cocci_id@p ) ( struct rio_mport * mport , void * dev_id , int mbox , int slot ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rio_mport * mport , void * context , union rio_pw_msg * msg , int step ) ;
...
position p;
@@
 struct rio_disc_work {  struct work_struct work ;  struct rio_mport * mport ; } cocci_id@p ;
...
position p;
@@
 struct rio_disc_work * cocci_id@p ;
...
position p;
@@
 struct rio_switch_ops * cocci_id@p ;
...
position p;
@@
 struct rio_scan_node * cocci_id@p ;
...
position p;
@@
 enum rio_device_state cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rio_dev * rdev , union rio_pw_msg * msg , int step ) ;
...
position p;
@@
 struct rio_pwrite {  struct list_head node ;  int ( * pwcback ) ( struct rio_mport * mport , void * context , union rio_pw_msg * msg , int step ) ;  void * context ; } cocci_id@p ;
...
typedef u16;
@@
 void ( * cocci_id@p ) ( struct rio_mport * mport , void * dev_id , u16 src , u16 dst , u16 info ) ;
