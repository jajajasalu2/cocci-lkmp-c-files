...
typedef u16;
@@
 const u16 cocci_id@p [ 2 ] [ DA9052_CHG_LIM_COLS ] ;
...
position p;
@@
 enum charger_type_enum { DA9052_NOCHARGER = 1 , DA9052_CHARGER , } cocci_id@p ;
...
position p;
@@
 struct da9052_battery cocci_id@p ;
...
position p;
@@
 struct da9052_battery {  struct da9052 * da9052 ;  struct power_supply * psy ;  struct notifier_block nb ;  int charger_type ;  int status ;  int health ; } cocci_id@p ;
...
position p;
@@
 struct da9052_pdata * cocci_id@p ;
