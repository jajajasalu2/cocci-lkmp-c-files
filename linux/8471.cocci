...
position p;
@@
 struct lance_init_block cocci_id@p ;
...
position p;
@@
 struct lance_init_block {  unsigned short mode ;  unsigned short phys_addr [ 3 ] ;  unsigned short filter [ 4 ] ;  unsigned short rx_ptr ;  unsigned short rx_len ;  unsigned short tx_ptr ;  unsigned short tx_len ;  short gap [ 4 ] ;  struct lance_rx_desc brx_ring [ RX_RING_SIZE ] ;  struct lance_tx_desc btx_ring [ TX_RING_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 const struct tc_device_id cocci_id@p [ ] ;
...
position p;
@@
 volatile struct lance_regs * cocci_id@p ;
...
position p;
@@
 struct lance_rx_desc {  unsigned short rmd0 ;  unsigned short rmd1 ;  short length ;  unsigned short mblength ; } cocci_id@p ;
...
position p;
@@
 struct lance_regs {  volatile unsigned short rdp ;  unsigned short pad ;  volatile unsigned short rap ; } cocci_id@p ;
...
position p;
@@
 struct lance_tx_desc {  unsigned short tmd0 ;  unsigned short tmd1 ;  short length ;  unsigned short misc ; } cocci_id@p ;
...
position p;
@@
 struct lance_rx_desc cocci_id@p ;
...
position p;
@@
 struct lance_tx_desc cocci_id@p ;
