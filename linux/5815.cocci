...
position p;
@@
 const struct mtk_drive_desc * cocci_id@p ;
...
typedef u8;
@@
 struct mtk_drive_desc {  u8 min ;  u8 max ;  u8 step ;  u8 scal ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_pin_reg_calc * cocci_id@p ;
...
position p;
@@
 struct mtk_pin_field * cocci_id@p ;
...
position p;
@@
 const struct mtk_pin_field_calc * cocci_id@p ;
