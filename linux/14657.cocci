...
typedef u32;
@@
 struct s2mps11_clk {  struct sec_pmic_dev * iodev ;  struct device_node * clk_np ;  struct clk_hw hw ;  struct clk * clk ;  struct clk_lookup * lookup ;  u32 mask ;  unsigned int reg ; } cocci_id@p ;
...
position p;
@@
 struct clk_init_data cocci_id@p [ S2MPS11_CLKS_NUM ] ;
...
position p;
@@
 enum sec_device_type cocci_id@p ;
