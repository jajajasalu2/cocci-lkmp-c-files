...
position p;
@@
 struct drm_audio_component_audio_ops cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_soc_dapm_widget * src , struct snd_soc_dapm_widget * sink ) ;
...
position p;
@@
 struct snd_soc_jack * cocci_id@p ;
...
position p;
@@
 struct hdac_hdmi_pcm * cocci_id@p ;
...
position p;
@@
 struct hdac_hdmi_drv_data {  unsigned int vendor_nid ;  const int * port_map ;  int port_num ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_soc_dapm_widget * , struct snd_kcontrol * , int ) ;
...
position p;
@@
 enum snd_soc_dapm_type cocci_id@p ;
...
position p;
@@
 struct hdac_hdmi_dai_port_map * cocci_id@p ;
...
position p;
@@
 struct hdac_hdmi_priv * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,hda_nid_t;
@@
 struct hdac_hdmi_pin {  struct list_head head ;  hda_nid_t nid ;  bool mst_capable ;  struct hdac_hdmi_port * ports ;  int num_ports ;  struct hdac_device * hdev ; } cocci_id@p ;
...
position p;
@@
 struct hdac_hdmi_drv_data cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ HDMI_INFOFRAME_HEADER_SIZE + HDMI_AUDIO_INFOFRAME_SIZE ] ;
...
position p;
@@
 char * cocci_id@p [ HDA_MAX_CONNECTIONS ] ;
...
position p;
@@
 struct hdac_hdmi_cvt * cocci_id@p ;
...
typedef u8;
@@
 struct dp_audio_infoframe {  u8 type ;  u8 len ;  u8 ver ;  u8 CC02_CT47 ;  u8 SS01_SF24 ;  u8 CXT04 ;  u8 CA ;  u8 LFEPBL01_LSV36_DM_INH7 ; } cocci_id@p ;
...
typedef hda_nid_t;
@@
 struct hdac_hdmi_cvt {  struct list_head head ;  hda_nid_t nid ;  const char * name ;  struct hdac_hdmi_cvt_params params ; } cocci_id@p ;
...
typedef u8;
@@
 struct hdac_hdmi_parsed_eld {  u8 spk_alloc ; } cocci_id@p ;
...
typedef bool;
@@
 struct hdac_hdmi_eld {  bool monitor_present ;  bool eld_valid ;  int eld_size ;  char eld_buffer [ ELD_MAX_SIZE ] ;  struct hdac_hdmi_parsed_eld info ; } cocci_id@p ;
...
typedef bool;
@@
 struct hdac_hdmi_pcm {  struct list_head head ;  int pcm_id ;  struct list_head port_list ;  struct hdac_hdmi_cvt * cvt ;  struct snd_soc_jack * jack ;  int stream_tag ;  int channels ;  int format ;  bool chmap_set ;  unsigned char chmap [ 8 ] ;  struct mutex lock ;  int jack_event ; } cocci_id@p ;
...
position p;
@@
 struct dp_audio_infoframe cocci_id@p ;
...
position p;
@@
 struct hdac_hdmi_pin * cocci_id@p ;
...
typedef u64,u32;
@@
 struct hdac_hdmi_cvt_params {  unsigned int channels_min ;  unsigned int channels_max ;  u32 rates ;  u64 formats ;  unsigned int maxbps ; } cocci_id@p ;
...
position p;
@@
 struct hdac_hdmi_port * cocci_id@p ;
...
position p;
@@
 struct hdac_ext_link * cocci_id@p ;
...
position p;
@@
 struct hdac_hdmi_dai_port_map {  int dai_id ;  struct hdac_hdmi_port * port ;  struct hdac_hdmi_cvt * cvt ; } cocci_id@p ;
...
typedef bool,hda_nid_t;
@@
 struct hdac_hdmi_port {  struct list_head head ;  int id ;  struct hdac_hdmi_pin * pin ;  int num_mux_nids ;  hda_nid_t mux_nids [ HDA_MAX_CONNECTIONS ] ;  struct hdac_hdmi_eld eld ;  const char * jack_pin ;  bool is_connect ;  struct snd_soc_dapm_context * dapm ;  const char * output_pin ;  struct work_struct dapm_work ; } cocci_id@p ;
