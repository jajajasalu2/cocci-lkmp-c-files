...
symbol cocci_id;
position p;
typedef Mpi2ManufacturingPage11_t;
@@
 struct Mpi2ManufacturingPage11_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2RaidConfigurationPage0_t;
@@
 Mpi2RaidConfigurationPage0_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2SasDevicePage1_t;
@@
 Mpi2SasDevicePage1_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u16,dma_addr_t;
@@
 struct config_request {  u16 sz ;  void * page ;  dma_addr_t page_dma ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOUnitPage0_t;
@@
 Mpi2IOUnitPage0_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2BiosPage2_t;
@@
 Mpi2BiosPage2_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2ManufacturingPage7_t;
@@
 Mpi2ManufacturingPage7_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOCPage8_t;
@@
 Mpi2IOCPage8_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2ManufacturingPage0_t;
@@
 Mpi2ManufacturingPage0_t * cocci_id@p ;
...
position p;
@@
 struct config_request * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOUnitPage8_t;
@@
 Mpi2IOUnitPage8_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2IOUnitPage1_t;
@@
 Mpi2IOUnitPage1_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2BiosPage3_t;
@@
 Mpi2BiosPage3_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef Mpi2ManufacturingPage10_t;
@@
 struct Mpi2ManufacturingPage10_t * cocci_id@p ;
