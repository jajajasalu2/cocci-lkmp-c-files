...
position p;
@@
 struct ext4_new_group_data * cocci_id@p ;
...
position p;
@@
 struct fiemap_extent cocci_id@p ;
...
typedef __u32;
@@
 struct getfsmap_info {  struct super_block * gi_sb ;  struct fsmap_head __user * gi_data ;  unsigned int gi_idx ;  __u32 gi_last_flags ; } cocci_id@p ;
