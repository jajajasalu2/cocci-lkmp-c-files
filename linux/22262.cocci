...
position p;
@@
 struct list_head cocci_id@p [ SEL_NETIF_HASH_SIZE ] ;
...
position p;
@@
 struct sel_netif {  struct list_head list ;  struct netif_security_struct nsec ;  struct rcu_head rcu_head ; } cocci_id@p ;
