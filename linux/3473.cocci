...
typedef u32;
@@
 struct sdhci_tegra_autocal_offsets {  u32 pull_up_3v3 ;  u32 pull_down_3v3 ;  u32 pull_up_3v3_timeout ;  u32 pull_down_3v3_timeout ;  u32 pull_up_1v8 ;  u32 pull_down_1v8 ;  u32 pull_up_1v8_timeout ;  u32 pull_down_1v8_timeout ;  u32 pull_up_sdr104 ;  u32 pull_down_sdr104 ;  u32 pull_up_hs400 ;  u32 pull_down_hs400 ; } cocci_id@p ;
...
position p;
@@
 struct sdhci_tegra_autocal_offsets * cocci_id@p ;
...
position p;
@@
 const struct sdhci_tegra_soc_data cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct sdhci_tegra_soc_data {  const struct sdhci_pltfm_data * pdata ;  u64 dma_mask ;  u32 nvquirks ;  u8 min_tap_delay ;  u8 max_tap_delay ; } cocci_id@p ;
