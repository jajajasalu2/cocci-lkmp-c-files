...
position p;
@@
 struct ebt_among_info cocci_id@p ;
...
position p;
@@
 struct ebt_mac_wormhash cocci_id@p ;
...
position p;
@@
 struct ebt_mac_wormhash_tuple cocci_id@p ;
...
position p;
@@
 const struct ebt_mac_wormhash_tuple * cocci_id@p ;
...
position p;
@@
 const struct ebt_among_info * cocci_id@p ;
...
position p;
@@
 const struct ebt_mac_wormhash * cocci_id@p ;
