...
position p;
@@
 struct ps3_notify_cmd * cocci_id@p ;
...
position p;
@@
 struct layout {  struct ps3_system_bus_device dev ;  struct ps3_dma_region d_region ;  struct ps3_mmio_region m_region ; } * cocci_id@p ;
...
position p;
@@
 struct ps3_repository_device cocci_id@p ;
...
position p;
@@
 struct layout {  struct ps3_system_bus_device dev ;  struct ps3_dma_region d_region ; } * cocci_id@p ;
...
position p;
@@
 enum ps3_interrupt_type cocci_id@p ;
...
position p;
@@
 const struct ps3_repository_device * cocci_id@p ;
...
@@
 struct ps3_notification_device {  struct ps3_system_bus_device sbd ;  spinlock_t lock ;  u64 tag ;  u64 lv1_status ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 struct ps3_storage_device * cocci_id@p ;
...
position p;
@@
 enum ps3_notify_type { notify_device_ready = 0 , notify_region_probe = 1 , notify_region_update = 2 , } cocci_id@p ;
...
typedef u64;
@@
 struct ps3_notify_cmd {  u64 operation_code ;  u64 event_mask ; } cocci_id@p ;
...
position p;
@@
 struct layout {  struct ps3_system_bus_device dev ; } * cocci_id@p ;
...
position p;
@@
 struct ps3_notify_event * cocci_id@p ;
...
position p;
@@
 struct ps3_notification_device * cocci_id@p ;
...
typedef u64;
@@
 struct ps3_notify_event {  u64 event_type ;  u64 bus_id ;  u64 dev_id ;  u64 dev_type ;  u64 dev_port ; } cocci_id@p ;
