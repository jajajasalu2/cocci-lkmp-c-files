...
symbol cocci_id;
position p;
typedef tracepoint_ptr_t;
@@
 tracepoint_ptr_t * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct tracepoint * tp , void * priv ) ;
...
position p;
@@
 struct tp_probes {  struct rcu_head rcu ;  struct tracepoint_func probes [ 0 ] ; } cocci_id@p ;
