...
position p;
@@
 struct stat_session * cocci_id@p ;
...
position p;
@@
 struct stat_session {  struct list_head session_list ;  struct tracer_stat * ts ;  struct rb_root stat_root ;  struct mutex stat_mutex ;  struct dentry * file ; } cocci_id@p ;
...
position p;
@@
 struct stat_node {  struct rb_node node ;  void * stat ; } cocci_id@p ;
