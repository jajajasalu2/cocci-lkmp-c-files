...
position p;
@@
 void cocci_id@p ( struct neighbour * , struct sk_buff * ) ;
...
position p;
@@
 struct dn_short_packet * cocci_id@p ;
...
position p;
@@
 struct dn_long_packet * cocci_id@p ;
...
position p;
@@
 struct elist_cb_state cocci_id@p ;
...
position p;
@@
 struct rtnode_hello_message * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct neighbour * neigh , struct sk_buff * skb ) ;
