...
typedef u8;
@@
 struct adv7842_video_standards {  struct v4l2_dv_timings timings ;  u8 vid_std ;  u8 v_freq ; } cocci_id@p ;
...
position p;
@@
 const struct adv7842_video_standards * cocci_id@p ;
...
position p;
@@
 struct adv7842_sdp_io_sync_adjustment * cocci_id@p ;
...
position p;
@@
 enum adv7842_vid_std_select cocci_id@p ;
...
position p;
@@
 const struct adv7842_format_info * cocci_id@p ;
...
position p;
@@
 union i2c_smbus_data cocci_id@p ;
...
position p;
@@
 struct adv7842_state cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct adv7842_state {  struct adv7842_platform_data pdata ;  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler hdl ;  enum adv7842_mode mode ;  struct v4l2_dv_timings timings ;  enum adv7842_vid_std_select vid_std_select ;  const struct adv7842_format_info * format ;  v4l2_std_id norm ;  struct {  u8 edid [ 256 ] ;  u32 present ; } hdmi_edid ;  struct {  u8 edid [ 256 ] ;  u32 present ; } vga_edid ;  struct v4l2_fract aspect_ratio ;  u32 rgb_quantization_range ;  bool is_cea_format ;  struct delayed_work delayed_work_enable_hotplug ;  bool restart_stdi_once ;  bool hdmi_port_a ;  struct i2c_client * i2c_sdp_io ;  struct i2c_client * i2c_sdp ;  struct i2c_client * i2c_cp ;  struct i2c_client * i2c_vdp ;  struct i2c_client * i2c_afe ;  struct i2c_client * i2c_hdmi ;  struct i2c_client * i2c_repeater ;  struct i2c_client * i2c_edid ;  struct i2c_client * i2c_infoframe ;  struct i2c_client * i2c_cec ;  struct i2c_client * i2c_avlink ;  struct v4l2_ctrl * detect_tx_5v_ctrl ;  struct v4l2_ctrl * analog_sampling_phase_ctrl ;  struct v4l2_ctrl * free_run_color_ctrl_manual ;  struct v4l2_ctrl * free_run_color_ctrl ;  struct v4l2_ctrl * rgb_quantization_range_ctrl ;  struct cec_adapter * cec_adap ;  u8 cec_addr [ ADV7842_MAX_ADDRS ] ;  u8 cec_valid_addrs ;  bool cec_enabled_adap ; } cocci_id@p ;
...
typedef u8;
@@
 struct adv7842_cfg_read_infoframe {  const char * desc ;  u8 present_mask ;  u8 head_addr ;  u8 payload_addr ; } cocci_id@p ;
...
position p;
@@
 const struct adv7842_cfg_read_infoframe * cocci_id@p ;
...
position p;
@@
 const struct adv7842_sdp_csc_coeff * cocci_id@p ;
...
position p;
@@
 struct adv7842_platform_data * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct adv7842_format_info {  u32 code ;  u8 op_ch_sel ;  bool rgb_out ;  bool swap_cb_cr ;  u8 op_format_sel ; } cocci_id@p ;
