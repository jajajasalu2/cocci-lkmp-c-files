...
position p;
@@
 struct parport_pc_superio {  int ( * probe ) ( struct pci_dev * pdev , int autoirq , int autodma , const struct parport_pc_via_data * via ) ;  const struct parport_pc_via_data * via ; } cocci_id@p [ ] ;
...
position p;
@@
 struct pci_parport_data * cocci_id@p ;
...
position p;
@@
 const struct parport_pc_via_data * cocci_id@p ;
...
position p;
@@
 struct pci_parport_data {  int num ;  struct parport * ports [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct parport_pc_private * cocci_id@p ;
...
position p;
@@
 const struct parport_pc_private * cocci_id@p ;
...
position p;
@@
 enum parport_pc_sio_types { sio_via_686a = 0 , sio_via_8231 , sio_ite_8872 , last_sio , } cocci_id@p ;
...
position p;
@@
 struct superio_struct * cocci_id@p ;
...
position p;
@@
 struct parport_pc_via_data cocci_id@p ;
...
position p;
@@
 struct parport_pc_pci {  int numports ;  struct {  int lo ;  int hi ; } addr [ 4 ] ;  int ( * preinit_hook ) ( struct pci_dev * pdev , int autoirq , int autodma ) ;  void ( * postinit_hook ) ( struct pci_dev * pdev , int failed ) ; } cocci_id@p [ ] ;
...
position p;
@@
 char * cocci_id@p [ PARPORT_PC_MAX_PORTS ] ;
...
position p;
@@
 struct superio_struct {  int io ;  int irq ;  int dma ; } cocci_id@p [ NR_SUPERIOS ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( int io , int key ) ;
