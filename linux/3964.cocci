...
position p;
@@
 const struct gic_clk_data cocci_id@p ;
...
position p;
@@
 struct gic_chip_pm {  struct gic_chip_data * chip_data ;  const struct gic_clk_data * clk_data ;  struct clk_bulk_data * clks ; } cocci_id@p ;
...
position p;
@@
 struct gic_clk_data {  unsigned int num_clocks ;  const char * const * clocks ; } cocci_id@p ;
