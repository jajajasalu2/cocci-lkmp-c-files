...
position p;
@@
 int cocci_id@p ( union sctp_addr * s1 , union sctp_addr * s2 ) ;
...
position p;
@@
 const struct sctp_sock * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const union sctp_addr * addr1 , const union sctp_addr * addr2 ) ;
...
position p;
@@
 void cocci_id@p ( union sctp_addr * addr , struct in6_addr * saddr , __be16 port ) ;
