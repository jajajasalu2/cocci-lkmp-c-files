...
@@
 struct zx_spdif_info {  struct snd_dmaengine_dai_dma_data dma_data ;  struct clk * dai_clk ;  void __iomem * reg_base ;  resource_size_t mapbase ; } cocci_id@p ;
...
position p;
@@
 struct zx_spdif_info * cocci_id@p ;
