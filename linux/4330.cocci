...
position p;
@@
 enum hp_wmi_radio { HPWMI_WIFI = 0x0 , HPWMI_BLUETOOTH = 0x1 , HPWMI_WWAN = 0x2 , HPWMI_GPS = 0x3 , } cocci_id@p ;
...
position p;
@@
 struct rfkill2_device cocci_id@p [ HPWMI_MAX_RFKILL2_DEVICES ] ;
...
typedef u8,u32;
@@
 struct bios_args {  u32 signature ;  u32 command ;  u32 commandtype ;  u32 datasize ;  u8 data [ 128 ] ; } cocci_id@p ;
...
position p;
@@
 enum hp_wmi_hardware_mask { HPWMI_DOCK_MASK = 0x01 , HPWMI_TABLET_MASK = 0x04 , } cocci_id@p ;
...
position p;
@@
 struct bios_rfkill2_state cocci_id@p ;
...
typedef u8;
@@
 struct bios_rfkill2_state {  u8 unknown [ 7 ] ;  u8 count ;  u8 pad [ 8 ] ;  struct bios_rfkill2_device_state device [ HPWMI_MAX_RFKILL2_DEVICES ] ; } cocci_id@p ;
...
position p;
@@
 enum hp_wmi_command { HPWMI_READ = 0x01 , HPWMI_WRITE = 0x02 , HPWMI_ODM = 0x03 , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct bios_rfkill2_device_state {  u8 radio_type ;  u8 bus_type ;  u16 vendor_id ;  u16 product_id ;  u16 subsys_vendor_id ;  u16 subsys_product_id ;  u8 rfkill_id ;  u8 power ;  u8 unknown [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct bios_rfkill2_device_state * cocci_id@p ;
...
position p;
@@
 enum hp_wmi_command cocci_id@p ;
...
typedef u8;
@@
 struct rfkill2_device {  u8 id ;  int num ;  struct rfkill * rfkill ; } cocci_id@p ;
...
typedef u32;
@@
 struct bios_return {  u32 sigpass ;  u32 return_code ; } cocci_id@p ;
...
position p;
@@
 enum hp_return_value { HPWMI_RET_WRONG_SIGNATURE = 0x02 , HPWMI_RET_UNKNOWN_COMMAND = 0x03 , HPWMI_RET_UNKNOWN_CMDTYPE = 0x04 , HPWMI_RET_INVALID_PARAMETERS = 0x05 , } cocci_id@p ;
...
position p;
@@
 enum hp_wireless2_bits { HPWMI_POWER_STATE = 0x01 , HPWMI_POWER_SOFT = 0x02 , HPWMI_POWER_BIOS = 0x04 , HPWMI_POWER_HARD = 0x08 , } cocci_id@p ;
