...
position p;
@@
 struct gen_74x164_chip * cocci_id@p ;
...
typedef u8,u32;
@@
 struct gen_74x164_chip {  struct gpio_chip gpio_chip ;  struct mutex lock ;  struct gpio_desc * gpiod_oe ;  u32 registers ;  u8 buffer [ ] ; } cocci_id@p ;
