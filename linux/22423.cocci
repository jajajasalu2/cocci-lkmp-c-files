...
position p;
@@
 int cocci_id@p ( struct snd_pcm_substream * substream , int cmd ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_device * device ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_kcontrol * kcontrol , struct snd_ctl_elem_info * uinfo ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_pcm_substream * substream , struct snd_pcm_hw_params * hw_params ) ;
...
position p;
@@
 int cocci_id@p ( struct aw2 * chip ) ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pci , const struct pci_device_id * pci_id ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_pcm_substream * substream ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_card * card , struct pci_dev * pci , struct aw2 * * rchip ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_kcontrol * kcontrol , struct snd_ctl_elem_value * ucontrol ) ;
...
typedef spinlock_t;
@@
 struct aw2 {  struct snd_aw2_saa7146 saa7146 ;  struct pci_dev * pci ;  int irq ;  spinlock_t reg_lock ;  struct mutex mtx ;  unsigned long iobase_phys ;  void __iomem * iobase_virt ;  struct snd_card * card ;  struct aw2_pcm_device device_playback [ NB_STREAM_PLAYBACK ] ;  struct aw2_pcm_device device_capture [ NB_STREAM_CAPTURE ] ; } cocci_id@p ;
...
position p;
@@
 struct aw2_pcm_device * cocci_id@p ;
...
position p;
@@
 snd_aw2_saa7146_it_cb cocci_id@p ;
...
typedef snd_pcm_uframes_t;
@@
 snd_pcm_uframes_t cocci_id@p ( struct snd_pcm_substream * substream ) ;
...
position p;
@@
 struct aw2_pcm_device {  struct snd_pcm * pcm ;  unsigned int stream_number ;  struct aw2 * chip ; } cocci_id@p ;
