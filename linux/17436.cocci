...
@@
 struct spufs_fs_context {  kuid_t uid ;  kgid_t gid ;  umode_t mode ; } cocci_id@p ;
...
position p;
@@
 enum { Opt_uid , Opt_gid , Opt_mode , Opt_debug , } cocci_id@p ;
...
position p;
@@
 struct spufs_sb_info * cocci_id@p ;
...
position p;
@@
 struct spufs_fs_context * cocci_id@p ;
...
typedef bool;
@@
 struct spufs_sb_info {  bool debug ; } cocci_id@p ;
