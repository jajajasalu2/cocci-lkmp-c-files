...
position p;
@@
 enum VIA_HDA_CODEC { UNKNOWN = - 1 , VT1708 , VT1709_10CH , VT1709_6CH , VT1708B_8CH , VT1708B_4CH , VT1708S , VT1708BCE , VT1702 , VT1718S , VT1716S , VT2002P , VT1812 , VT1802 , VT1705CF , VT1808 , CODEC_TYPES , } cocci_id@p ;
...
position p;
@@
 enum VIA_HDA_CODEC cocci_id@p ( struct hda_codec * codec ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct hda_codec * codec ) ;
...
typedef bool;
@@
 struct via_spec {  struct hda_gen_spec gen ;  unsigned int dmic_enabled ;  enum VIA_HDA_CODEC codec_type ;  bool alc_mode ;  int hp_work_active ;  int vt1708_jack_detect ; } cocci_id@p ;
...
position p;
@@
 enum { VIA_FIXUP_INTMIC_BOOST , VIA_FIXUP_ASUS_G75 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hda_pcm_stream * hinfo , struct hda_codec * codec , struct snd_pcm_substream * substream , int action ) ;
