...
position p;
@@
 struct i40iw_hmc_create_obj_info cocci_id@p ;
...
position p;
@@
 struct i40iw_hmc_pble_rsrc * cocci_id@p ;
...
position p;
@@
 struct i40iw_hmc_del_obj_info cocci_id@p ;
...
position p;
@@
 struct i40iw_cq_shadow_area cocci_id@p ;
...
position p;
@@
 struct l2params_work * cocci_id@p ;
...
position p;
@@
 struct i40e_qv_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ I40E_CLIENT_STR_LENGTH ] ;
...
position p;
@@
 struct i40iw_msix_vector * cocci_id@p ;
...
position p;
@@
 struct i40iw_puda_rsrc_info cocci_id@p ;
...
position p;
@@
 struct i40iw_hmc_fcn_info cocci_id@p ;
...
position p;
@@
 const struct i40e_client_ops cocci_id@p ;
...
position p;
@@
 struct i40iw_cqp_sq_wqe cocci_id@p ;
...
position p;
@@
 enum i40iw_hmc_rsrc_type cocci_id@p [ ] ;
...
position p;
@@
 struct i40iw_cqp_ctx cocci_id@p ;
...
typedef u8,u32,u16;
@@
 enum i40iw_status_code cocci_id@p ( struct i40iw_sc_dev * dev , u32 vf_id , u8 * msg , u16 len ) ;
...
position p;
@@
 struct i40iw_handler * cocci_id@p ;
...
position p;
@@
 struct i40e_qvlist_info cocci_id@p ;
