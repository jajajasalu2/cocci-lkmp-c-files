...
position p;
@@
 void cocci_id@p ( struct drm_plane * plane , struct drm_framebuffer * fb ) ;
...
@@
 struct mdp4_plane {  struct drm_plane base ;  const char * name ;  enum mdp4_pipe pipe ;  uint32_t caps ;  uint32_t nformats ;  uint32_t formats [ 32 ] ;  bool enabled ; } cocci_id@p ;
...
position p;
@@
 enum mdp4_frame_format cocci_id@p ;
