...
position p;
@@
 const struct das16cs_board * cocci_id@p ;
...
position p;
@@
 struct das16cs_board {  const char * name ;  int device_id ;  unsigned int has_ao : 1 ;  unsigned int has_4dio : 1 ; } cocci_id@p ;
...
position p;
@@
 struct das16cs_private * cocci_id@p ;
...
position p;
@@
 struct das16cs_private {  unsigned short misc1 ;  unsigned short misc2 ; } cocci_id@p ;
