...
position p;
@@
 enum spi_nor_protocol cocci_id@p ;
...
typedef u32;
@@
 struct sfdp_4bait {  u32 hwcaps ;  u32 supported_bit ; } cocci_id@p ;
...
position p;
@@
 const struct spi_nor_read_command * cocci_id@p ;
...
position p;
@@
 const struct spi_nor_hwcaps * cocci_id@p ;
...
position p;
@@
 const struct spi_nor_erase_region * cocci_id@p ;
...
position p;
@@
 struct spi_nor_fixups {  void ( * default_init ) ( struct spi_nor * nor ) ;  int ( * post_bfpt ) ( struct spi_nor * nor , const struct sfdp_parameter_header * bfpt_header , const struct sfdp_bfpt * bfpt , struct spi_nor_flash_parameter * params ) ;  void ( * post_sfdp ) ( struct spi_nor * nor ) ; } cocci_id@p ;
...
position p;
@@
 const struct spi_nor * cocci_id@p ;
...
position p;
@@
 const struct sfdp_bfpt * cocci_id@p ;
...
position p;
@@
 const struct spi_nor_erase_type * cocci_id@p ;
...
position p;
@@
 struct spi_nor_erase_map * cocci_id@p ;
...
typedef u32;
@@
 struct sfdp_bfpt_erase {  u32 dword ;  u32 shift ; } cocci_id@p ;
...
position p;
@@
 const struct sfdp_bfpt_read * cocci_id@p ;
...
position p;
@@
 struct spi_nor_flash_parameter cocci_id@p ;
...
position p;
@@
 const struct sfdp_4bait cocci_id@p [ ] ;
...
position p;
@@
 struct spi_nor_erase_region * cocci_id@p ;
...
typedef u8,u32;
@@
 struct sfdp_header {  u32 signature ;  u8 minor ;  u8 major ;  u8 nph ;  u8 unused ;  struct sfdp_parameter_header bfpt_header ; } cocci_id@p ;
...
position p;
@@
 struct spi_nor_erase_type * cocci_id@p ;
...
position p;
@@
 struct spi_nor_erase_command * cocci_id@p ;
...
position p;
@@
 struct sfdp_parameter_header * cocci_id@p ;
...
position p;
@@
 struct spi_nor_pp_command * cocci_id@p ;
...
position p;
@@
 struct spi_nor_read_command * cocci_id@p ;
...
typedef u32;
@@
 struct sfdp_bfpt {  u32 dwords [ BFPT_DWORD_MAX ] ; } cocci_id@p ;
...
position p;
@@
 const struct sfdp_bfpt_erase cocci_id@p [ ] ;
...
position p;
@@
 const struct spi_nor_pp_command * cocci_id@p ;
...
position p;
@@
 const struct spi_nor_erase_map * cocci_id@p ;
...
position p;
@@
 const struct sfdp_parameter_header * cocci_id@p ;
...
position p;
@@
 const struct spi_nor_locking_ops cocci_id@p ;
...
position p;
@@
 struct spi_nor_fixups cocci_id@p ;
...
position p;
@@
 const struct flash_info * cocci_id@p ;
...
position p;
@@
 struct spi_mem_driver cocci_id@p ;
...
position p;
@@
 struct flash_platform_data * cocci_id@p ;
...
typedef u32;
@@
 struct sfdp_bfpt_read {  u32 hwcaps ;  u32 supported_dword ;  u32 supported_bit ;  u32 settings_dword ;  u32 settings_shift ;  enum spi_nor_protocol proto ; } cocci_id@p ;
...
typedef u8;
@@
 struct sfdp_parameter_header {  u8 id_lsb ;  u8 minor ;  u8 major ;  u8 length ;  u8 parameter_table_pointer [ 3 ] ;  u8 id_msb ; } cocci_id@p ;
...
position p;
@@
 const struct sfdp_4bait cocci_id@p [ SNOR_ERASE_TYPE_MAX ] ;
