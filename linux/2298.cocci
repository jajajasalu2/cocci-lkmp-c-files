...
position p;
@@
 struct rcar_thermal_chip {  unsigned int use_of_thermal : 1 ;  unsigned int has_filonoff : 1 ;  unsigned int irq_per_ch : 1 ;  unsigned int needs_suspend_resume : 1 ;  unsigned int nirqs ;  unsigned int ctemp_bands ; } cocci_id@p ;
...
position p;
@@
 const struct rcar_thermal_chip cocci_id@p ;
...
position p;
@@
 struct rcar_thermal_priv cocci_id@p ;
...
typedef spinlock_t;
@@
 struct rcar_thermal_common {  void __iomem * base ;  struct device * dev ;  struct list_head head ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct rcar_thermal_common * cocci_id@p ;
...
typedef u32;
@@
 struct rcar_thermal_priv {  void __iomem * base ;  struct rcar_thermal_common * common ;  struct thermal_zone_device * zone ;  const struct rcar_thermal_chip * chip ;  struct delayed_work work ;  struct mutex lock ;  struct list_head list ;  int id ;  u32 ctemp ; } cocci_id@p ;
