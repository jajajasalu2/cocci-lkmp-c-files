...
position p;
@@
 struct gre_hdr {  __be16 flags ;  __be16 proto ; } cocci_id@p ;
...
position p;
@@
 enum { IP , IPV6 , IPV6OP , IPV6FR , MPLS , VLAN , } cocci_id@p ;
...
position p;
@@
 last_dissection cocci_id@p ( ".maps" ) ;
...
typedef __be32,__u8;
@@
 struct frag_hdr {  __u8 nexthdr ;  __u8 reserved ;  __be16 frag_off ;  __be32 identification ; } cocci_id@p ;
