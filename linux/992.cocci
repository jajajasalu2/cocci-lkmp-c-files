...
position p;
@@
 int cocci_id@p ( struct ubi_device * ubi , int nested ) ;
...
position p;
@@
 int cocci_id@p ( const struct ubi_device * ubi , struct ubi_wl_entry * e , struct rb_root * root ) ;
...
position p;
@@
 int cocci_id@p ( struct ubi_device * ubi , struct ubi_work * wl_wrk ) ;
...
position p;
@@
 int cocci_id@p ( struct ubi_device * ubi , struct ubi_work * wl_wrk , int shutdown ) ;
...
position p;
@@
 struct ubi_ainf_volume * cocci_id@p ;
...
position p;
@@
 struct ubi_attach_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct ubi_device * ubi , struct ubi_wl_entry * e ) ;
...
position p;
@@
 int cocci_id@p ( struct ubi_device * ubi , int pnum , int ec ) ;
