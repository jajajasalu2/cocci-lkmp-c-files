...
typedef bool;
@@
 struct smsc_phy_priv {  bool energy_enable ; } cocci_id@p ;
...
position p;
@@
 struct smsc_hw_stat cocci_id@p [ ] ;
...
typedef u8;
@@
 struct smsc_hw_stat {  const char * string ;  u8 reg ;  u8 bits ; } cocci_id@p ;
...
position p;
@@
 struct smsc_phy_priv * cocci_id@p ;
