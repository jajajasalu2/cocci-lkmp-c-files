...
position p;
@@
 struct rackmeter_dma cocci_id@p ;
...
position p;
@@
 struct rackmeter_cpu cocci_id@p ;
...
@@
 struct rackmeter {  struct macio_dev * mdev ;  unsigned int irq ;  struct device_node * i2s ;  u8 * ubuf ;  struct dbdma_regs __iomem * dma_regs ;  void __iomem * i2s_regs ;  dma_addr_t dma_buf_p ;  struct rackmeter_dma * dma_buf_v ;  int stale_irq ;  struct rackmeter_cpu cpu [ 2 ] ;  int paused ;  struct mutex sem ; } cocci_id@p ;
...
position p;
@@
 struct kernel_cpustat * cocci_id@p ;
