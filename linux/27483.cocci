...
position p;
@@
 struct fsverity_descriptor cocci_id@p ;
...
position p;
@@
 struct fsverity_info * cocci_id@p ;
...
position p;
@@
 const struct fsverity_operations * cocci_id@p ;
...
position p;
@@
 const struct fsverity_enable_arg * cocci_id@p ;
...
position p;
@@
 struct merkle_tree_params cocci_id@p ;
...
position p;
@@
 struct fsverity_enable_arg cocci_id@p ;
