...
position p;
@@
 struct stats_query_cmd_group cocci_id@p ;
...
position p;
@@
 struct bnx2x_sp_objs * cocci_id@p ;
...
position p;
@@
 struct eth_fast_path_rx_cqe * cocci_id@p ;
...
position p;
@@
 struct bnx2x_fw_stats_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_agg_info cocci_id@p ;
...
position p;
@@
 struct bnx2x_alloc_pool * cocci_id@p ;
...
position p;
@@
 struct per_pf_stats cocci_id@p ;
...
position p;
@@
 struct per_queue_stats cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bnx2x * bp ) ;
...
position p;
@@
 struct bnx2x_fp_stats cocci_id@p ;
...
position p;
@@
 const struct bnx2x_fastpath * cocci_id@p ;
...
position p;
@@
 enum eth_rss_hash_type cocci_id@p ;
...
position p;
@@
 const struct eth_fast_path_rx_cqe * cocci_id@p ;
...
position p;
@@
 struct bnx2x_fw_stats_req * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct bnx2x * , struct sk_buff * ) ;
...
position p;
@@
 struct eth_tx_parse_2nd_bd * cocci_id@p ;
...
position p;
@@
 struct bnx2x_link_report_data * cocci_id@p ;
...
position p;
@@
 union host_hc_status_block cocci_id@p ;
...
position p;
@@
 struct stats_counter cocci_id@p ;
...
position p;
@@
 struct per_port_stats cocci_id@p ;
...
position p;
@@
 struct eth_end_agg_rx_cqe * cocci_id@p ;
...
position p;
@@
 struct stats_query_header cocci_id@p ;
...
position p;
@@
 enum eth_rx_cqe_type cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ BNX2X_MAX_PRIORITY ] ;
...
position p;
@@
 struct bnx2x_eth_q_stats * cocci_id@p ;
