...
position p;
@@
 struct omap_iommu_domain cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct omap_iommu * , u32 , u32 , u32 ) ;
...
position p;
@@
 struct orphan_dev {  struct device * dev ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct omap_iommu_arch_data * cocci_id@p ;
...
position p;
@@
 struct iommu_platform_data * cocci_id@p ;
...
position p;
@@
 struct omap_iommu_device * cocci_id@p ;
