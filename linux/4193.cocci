...
position p;
@@
 struct sun4i_usb_phy_data * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct sun4i_usb_phy_cfg {  int num_phys ;  int hsic_index ;  enum sun4i_usb_phy_type type ;  u32 disc_thresh ;  u8 phyctl_offset ;  bool dedicated_clocks ;  bool enable_pmu_unk1 ;  bool phy0_dual_route ;  int missing_phys ; } cocci_id@p ;
...
position p;
@@
 const struct sun4i_usb_phy_cfg cocci_id@p ;
...
position p;
@@
 struct sun4i_usb_phy * cocci_id@p ;
...
position p;
@@
 enum sun4i_usb_phy_type { sun4i_a10_phy , sun6i_a31_phy , sun8i_a33_phy , sun8i_a83t_phy , sun8i_h3_phy , sun8i_r40_phy , sun8i_v3s_phy , sun50i_a64_phy , sun50i_h6_phy , } cocci_id@p ;
