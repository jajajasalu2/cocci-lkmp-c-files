...
position p;
@@
 struct iio_dummy_eventgen * cocci_id@p ;
...
position p;
@@
 struct iio_dummy_regs * cocci_id@p ;
...
typedef bool;
@@
 struct iio_dummy_eventgen {  struct iio_dummy_regs regs [ IIO_EVENTGEN_NO ] ;  struct mutex lock ;  bool inuse [ IIO_EVENTGEN_NO ] ;  struct irq_sim irq_sim ;  int base ; } cocci_id@p ;
