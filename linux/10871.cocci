...
position p;
@@
 struct i2s_platform_data * cocci_id@p ;
...
position p;
@@
 enum { ACP_TILE_P1 = 0 , ACP_TILE_P2 , ACP_TILE_DSP0 , ACP_TILE_DSP1 , ACP_TILE_DSP2 , } cocci_id@p ;
...
position p;
@@
 struct acp_pm_domain {  void * adev ;  struct generic_pm_domain gpd ; } cocci_id@p ;
...
position p;
@@
 struct acp_pm_domain * cocci_id@p ;
