...
position p;
@@
 struct p8_aes_xts_ctx cocci_id@p ;
...
position p;
@@
 const struct p8_aes_xts_ctx * cocci_id@p ;
...
position p;
@@
 struct p8_aes_xts_ctx {  struct crypto_skcipher * fallback ;  struct aes_key enc_key ;  struct aes_key dec_key ;  struct aes_key tweak_key ; } cocci_id@p ;
