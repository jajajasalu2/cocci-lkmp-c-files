...
typedef __be32;
@@
 struct usb_td {  __be16 status ;  __be16 length ;  __be32 buf_ptr ;  __be16 extra ;  __be16 reserved ; } cocci_id@p ;
...
position p;
@@
 struct fhci_ep_pram cocci_id@p ;
