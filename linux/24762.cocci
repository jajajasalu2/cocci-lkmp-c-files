...
position p;
@@
 struct nft_rule * const * cocci_id@p ;
...
position p;
@@
 struct nft_jumpstack {  const struct nft_chain * chain ;  struct nft_rule * const * rules ; } cocci_id@p ;
...
position p;
@@
 struct nft_jumpstack cocci_id@p [ NFT_JUMP_STACK_SIZE ] ;
...
position p;
@@
 enum nft_trace_types cocci_id@p ;
...
position p;
@@
 struct nft_traceinfo * cocci_id@p ;
