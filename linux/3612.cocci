...
typedef u32;
@@
 struct rpi_firmware {  struct mbox_client cl ;  struct mbox_chan * chan ;  struct completion c ;  u32 enabled ; } cocci_id@p ;
...
position p;
@@
 struct rpi_firmware_property_tag_header * cocci_id@p ;
