...
position p;
@@
 struct zl10039_state * cocci_id@p ;
...
position p;
@@
 enum zl10039_reg_addr { PLL0 = 0 , PLL1 , PLL2 , PLL3 , RFFE , BASE0 , BASE1 , BASE2 , LO0 , LO1 , LO2 , LO3 , LO4 , LO5 , LO6 , GENERAL , } cocci_id@p ;
...
position p;
@@
 enum zl10039_model_id { ID_ZL10039 = 1 , } cocci_id@p ;
...
position p;
@@
 const enum zl10039_reg_addr cocci_id@p ;
...
position p;
@@
 const struct zl10039_state * cocci_id@p ;
...
typedef u8;
@@
 struct zl10039_state {  struct i2c_adapter * i2c ;  u8 i2c_addr ;  u8 id ; } cocci_id@p ;
