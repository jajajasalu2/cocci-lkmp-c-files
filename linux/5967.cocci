...
typedef bool;
@@
 void cocci_id@p ( struct pinctrl * p , bool inlist ) ;
...
position p;
@@
 struct pinctrl_maps * cocci_id@p ;
...
position p;
@@
 struct pinctrl_setting * cocci_id@p ;
...
position p;
@@
 const struct pinctrl_map * cocci_id@p ;
...
position p;
@@
 struct dev_pin_info * cocci_id@p ;
