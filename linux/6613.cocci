...
position p;
@@
 struct fc_rnid_common_id_data_s * cocci_id@p ;
...
position p;
@@
 struct fc_rnid_cmd_s cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fcgs_gnnid_req_t;
@@
 fcgs_gnnid_req_t cocci_id@p ;
...
position p;
@@
 struct fc_rnid_general_topology_data_s cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fcgs_gmal_req_t;
@@
 fcgs_gmal_req_t cocci_id@p ;
...
position p;
@@
 struct fcgs_rffid_req_s * cocci_id@p ;
...
position p;
@@
 struct fc_rpsc_acc_s cocci_id@p ;
...
position p;
@@
 struct fcgs_rsnn_nn_req_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fcgs_gpnid_req_t;
@@
 fcgs_gpnid_req_t * cocci_id@p ;
...
position p;
@@
 struct fc_rpsc2_cmd_s cocci_id@p ;
...
position p;
@@
 struct fc_rscn_pl_s cocci_id@p ;
...
position p;
@@
 struct fcgs_rpnid_req_s * cocci_id@p ;
...
position p;
@@
 struct fc_rnid_acc_s * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct fchs_s * fchs , u32 d_id , u32 s_id , __be16 ox_id ) ;
...
position p;
@@
 struct fcgs_gidft_req_s * cocci_id@p ;
...
position p;
@@
 struct fcgs_rcsid_req_s cocci_id@p ;
...
position p;
@@
 struct fc_rpsc_cmd_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fcgs_gfn_req_t;
@@
 fcgs_gfn_req_t cocci_id@p ;
...
position p;
@@
 struct fcgs_rptid_req_s cocci_id@p ;
...
position p;
@@
 struct fc_prlo_acc_s * cocci_id@p ;
...
position p;
@@
 struct fcgs_rspnid_req_s cocci_id@p ;
...
position p;
@@
 enum bfa_lport_role cocci_id@p ;
...
position p;
@@
 struct fc_tprlo_acc_s * cocci_id@p ;
...
position p;
@@
 struct fcgs_gidpn_req_s cocci_id@p ;
...
position p;
@@
 struct fcgs_ganxt_req_s * cocci_id@p ;
...
position p;
@@
 struct fcgs_rnnid_req_s * cocci_id@p ;
...
position p;
@@
 struct fcgs_rftid_req_s * cocci_id@p ;
...
position p;
@@
 enum fc_parse_status cocci_id@p ;
