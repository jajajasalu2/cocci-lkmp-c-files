...
position p;
@@
 const struct fsr_info * cocci_id@p ;
...
position p;
@@
 struct fsr_info {  int ( * fn ) ( unsigned long addr , unsigned int fsr , struct pt_regs * regs ) ;  int sig ;  int code ;  const char * name ; } cocci_id@p ;
