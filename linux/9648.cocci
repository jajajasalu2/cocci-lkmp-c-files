...
position p;
@@
 struct b43legacy_wldev * cocci_id@p ;
...
position p;
@@
 struct b43legacy_firmware * cocci_id@p ;
...
position p;
@@
 struct b43legacy_wl * cocci_id@p ;
...
position p;
@@
 struct b43legacy_phy * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ssb_device * dev ) ;
...
position p;
@@
 struct b43legacy_fw_header cocci_id@p ;
...
position p;
@@
 struct b43legacy_iv cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( modparam_fwpostfix ) + 32 ] ;
...
position p;
@@
 int cocci_id@p ( struct ssb_device * dev , struct b43legacy_wl * wl ) ;
...
position p;
@@
 int cocci_id@p ( struct b43legacy_wldev * dev ) ;
...
position p;
@@
 struct b43legacy_lopair cocci_id@p ;
...
position p;
@@
 struct b43legacy_plcp_hdr4 cocci_id@p ;
...
position p;
@@
 struct b43legacy_plcp_hdr6 cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct b43legacy_wldev * dev ) ;
...
position p;
@@
 struct b43legacy_txstatus cocci_id@p ;
...
position p;
@@
 const struct b43legacy_fw_header * cocci_id@p ;
...
position p;
@@
 const struct b43legacy_iv * cocci_id@p ;
