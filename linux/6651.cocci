...
position p;
@@
 struct qla_fw cocci_id@p [ QL_NUM_FW_IMAGES ] ;
...
symbol cocci_id;
position p;
typedef cmd_a64_entry_t;
@@
 cmd_a64_entry_t * cocci_id@p ;
...
position p;
@@
 enum tokens { TOKEN_NVRAM , TOKEN_SYNC , TOKEN_WIDE , TOKEN_PPR , TOKEN_VERBOSE , TOKEN_DEBUG , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_qla_host * , struct response * , struct list_head * ) ;
...
position p;
@@
 struct setup_tokens {  char * token ;  int val ; } cocci_id@p ;
...
typedef uint16_t;
@@
 uint16_t cocci_id@p ( volatile uint16_t __iomem * ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_qla_host * , int ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_qla_host * , struct srb * ) ;
...
position p;
@@
 struct qla_fw {  char * fwname ;  const struct firmware * fw ; } cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct scsi_qla_host * , int , int , int , u8 ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_qla_host * ) ;
...
position p;
@@
 struct scsi_pointer cocci_id@p ;
...
typedef request_t;
@@
 request_t * cocci_id@p ( struct scsi_qla_host * ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_qla_host * , struct srb * , int ) ;
...
position p;
@@
 struct cont_a64_entry * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * cmd ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_qla_host * , struct scsi_device * ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_qla_host * , unsigned int ) ;
...
typedef uint16_t;
@@
 uint16_t cocci_id@p [ MAILBOX_REGISTER_COUNT ] ;
...
position p;
@@
 struct qla_driver_setup cocci_id@p ;
...
position p;
@@
 struct qla_boards {  char * name ;  int numPorts ;  int fw_index ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_qla_host * ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_qla_host * , int , int ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_qla_host * , struct list_head * ) ;
