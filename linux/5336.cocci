...
symbol cocci_id;
position p;
typedef genpd_xlate_t;
@@
 struct of_genpd_provider {  struct list_head link ;  struct device_node * node ;  genpd_xlate_t xlate ;  void * data ; } cocci_id@p ;
...
position p;
@@
 const struct genpd_lock_ops cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device * __dev ) ;
...
position p;
@@
 const struct generic_pm_domain * cocci_id@p ;
...
position p;
@@
 type ( * cocci_id@p ) ( struct device * __d ) ;
...
position p;
@@
 enum pm_qos_flags_status cocci_id@p ;
...
position p;
@@
 struct generic_pm_domain_data * cocci_id@p ;
...
position p;
@@
 struct genpd_power_state * * cocci_id@p ;
...
position p;
@@
 struct dev_power_governor * cocci_id@p ;
...
position p;
@@
 struct gpd_timing_data * cocci_id@p ;
...
position p;
@@
 struct of_genpd_provider * cocci_id@p ;
...
position p;
@@
 struct pm_domain_data * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct device * __dev ) ;
