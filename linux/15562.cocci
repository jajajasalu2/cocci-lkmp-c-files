...
position p;
@@
 const struct gasket_mappable_region * cocci_id@p ;
...
position p;
@@
 struct gasket_bar_desc cocci_id@p ;
...
position p;
@@
 struct gasket_internal_desc cocci_id@p [ GASKET_FRAMEWORK_DESC_MAX ] ;
...
position p;
@@
 const struct gasket_num_name cocci_id@p [ ] ;
...
position p;
@@
 struct gasket_sysfs_attribute * cocci_id@p ;
...
position p;
@@
 struct gasket_cdev_info cocci_id@p ;
...
position p;
@@
 const struct gasket_bar_desc * cocci_id@p ;
...
position p;
@@
 enum do_map_region_status { DO_MAP_REGION_SUCCESS , DO_MAP_REGION_FAILURE , DO_MAP_REGION_INVALID , } cocci_id@p ;
...
position p;
@@
 struct gasket_ownership * cocci_id@p ;
...
position p;
@@
 enum do_map_region_status cocci_id@p ;
...
position p;
@@
 struct gasket_coherent_buffer_desc cocci_id@p ;
...
symbol cocci_id;
position p;
typedef gasket_ioctl_permissions_cb_t;
@@
 gasket_ioctl_permissions_cb_t cocci_id@p ;
...
position p;
@@
 enum gasket_sysfs_attribute_type cocci_id@p ;
...
position p;
@@
 struct gasket_internal_desc * cocci_id@p ;
...
position p;
@@
 const struct gasket_sysfs_attribute cocci_id@p [ ] ;
...
position p;
@@
 const struct gasket_driver_desc * cocci_id@p ;
...
position p;
@@
 enum gasket_sysfs_attribute_type { ATTR_BAR_OFFSETS , ATTR_BAR_SIZES , ATTR_DRIVER_VERSION , ATTR_FRAMEWORK_VERSION , ATTR_DEVICE_TYPE , ATTR_HARDWARE_REVISION , ATTR_PCI_ADDRESS , ATTR_STATUS , ATTR_IS_DEVICE_OWNED , ATTR_DEVICE_OWNER , ATTR_WRITE_OPEN_COUNT , ATTR_RESET_COUNT , ATTR_USER_MEM_RANGES , } cocci_id@p ;
...
position p;
@@
 struct gasket_mappable_region cocci_id@p ;
...
position p;
@@
 const struct gasket_dev * cocci_id@p ;
...
position p;
@@
 const struct vm_area_struct * cocci_id@p ;
...
position p;
@@
 struct gasket_internal_desc {  const struct gasket_driver_desc * driver_desc ;  struct mutex mutex ;  struct class * class ;  struct gasket_dev * devs [ GASKET_DEV_MAX ] ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct gasket_dev * ) ;
