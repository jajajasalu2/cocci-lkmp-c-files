...
position p;
@@
 struct soundfont_chorus_fx cocci_id@p ;
...
position p;
@@
 unsigned short cocci_id@p [ 12 ] [ 3 ] ;
...
position p;
@@
 struct soundfont_chorus_fx {  unsigned short feedback ;  unsigned short delay_offset ;  unsigned short lfo_depth ;  unsigned int delay ;  unsigned int lfo_freq ; } cocci_id@p ;
...
position p;
@@
 struct soundfont_reverb_fx cocci_id@p ;
...
position p;
@@
 struct soundfont_reverb_fx {  unsigned short parms [ 28 ] ; } cocci_id@p ;
...
position p;
@@
 struct soundfont_chorus_fx cocci_id@p [ SNDRV_EMU8000_CHORUS_NUMBERS ] ;
...
position p;
@@
 unsigned short cocci_id@p [ 12 ] [ 9 ] ;
...
position p;
@@
 struct soundfont_reverb_fx cocci_id@p [ SNDRV_EMU8000_REVERB_NUMBERS ] ;
...
position p;
@@
 struct snd_kcontrol_new * cocci_id@p [ EMU8000_NUM_CONTROLS ] ;
...
position p;
@@
 char cocci_id@p [ SNDRV_EMU8000_CHORUS_NUMBERS ] ;
