...
position p;
@@
 struct posix_cputimer_base * cocci_id@p ;
...
position p;
@@
 const struct posix_cputimers * cocci_id@p ;
...
position p;
@@
 struct signal_struct * const cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( struct restart_block * restart_block ) ;
...
position p;
@@
 struct posix_cputimers * cocci_id@p ;
...
position p;
@@
 struct task_cputime_atomic * cocci_id@p ;
...
position p;
@@
 struct timerqueue_head * cocci_id@p ;
...
position p;
@@
 struct itimerspec64 * cocci_id@p ;
...
position p;
@@
 const struct k_clock cocci_id@p ;
...
position p;
@@
 struct timerqueue_node * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct k_itimer * timer ) ;
...
position p;
@@
 struct thread_group_cputimer * cocci_id@p ;
