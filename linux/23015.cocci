...
position p;
@@
 struct sof_ipc_window * cocci_id@p ;
...
position p;
@@
 struct snd_sof_mod_hdr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_sof_dev * sof_dev , struct snd_sof_mod_hdr * hdr ) ;
...
position p;
@@
 struct sof_ipc_ext_data_hdr * cocci_id@p ;
...
position p;
@@
 struct snd_sof_fw_header * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_window_elem * cocci_id@p ;
