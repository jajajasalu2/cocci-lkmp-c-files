...
position p;
@@
 enum lcdc_load_mode { OMAP_LCDC_LOAD_PALETTE , OMAP_LCDC_LOAD_FRAME , OMAP_LCDC_LOAD_PALETTE_AND_FRAME , } cocci_id@p ;
...
position p;
@@
 enum lcdc_load_mode cocci_id@p ;
