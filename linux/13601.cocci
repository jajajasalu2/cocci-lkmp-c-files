...
typedef u8;
@@
 struct sd {  struct gspca_dev gspca_dev ;  struct v4l2_ctrl * brightness ;  struct v4l2_ctrl * saturation ;  struct v4l2_ctrl * sharpness ;  struct v4l2_ctrl * gamma ;  struct {  struct v4l2_ctrl * illum_top ;  struct v4l2_ctrl * illum_bottom ; } ;  u8 jpeg_hdr [ JPEG_HDR_SZ ] ; } cocci_id@p ;
...
typedef s32;
@@
 void cocci_id@p ( struct gspca_dev * gspca_dev , s32 val ) ;
