...
position p;
@@
 struct fuse_init_args * cocci_id@p ;
...
position p;
@@
 enum { OPT_SOURCE , OPT_SUBTYPE , OPT_FD , OPT_ROOTMODE , OPT_USER_ID , OPT_GROUP_ID , OPT_DEFAULT_PERMISSIONS , OPT_ALLOW_OTHER , OPT_MAX_READ , OPT_BLKSIZE , OPT_ERR , } cocci_id@p ;
...
position p;
@@
 struct fuse_statfs_out cocci_id@p ;
...
position p;
@@
 struct fuse_entry_out cocci_id@p ;
...
position p;
@@
 struct fuse_init_out * cocci_id@p ;
...
position p;
@@
 struct fuse_init_args {  struct fuse_args args ;  struct fuse_init_in in ;  struct fuse_init_out out ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct fuse_inode_handle {  u64 nodeid ;  u32 generation ; } cocci_id@p ;
...
position p;
@@
 struct fuse_inode_handle * cocci_id@p ;
...
position p;
@@
 struct fuse_kstatfs * cocci_id@p ;
