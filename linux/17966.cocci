...
position p;
@@
 struct cpuinfo_level * cocci_id@p ;
...
position p;
@@
 struct cpuinfo_tree {  int total_nodes ;  struct cpuinfo_level level [ CPUINFO_LVL_MAX ] ;  struct cpuinfo_node nodes [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 enum { CPUINFO_LVL_ROOT = 0 , CPUINFO_LVL_NODE , CPUINFO_LVL_CORE , CPUINFO_LVL_PROC , CPUINFO_LVL_MAX , } cocci_id@p ;
...
position p;
@@
 struct cpuinfo_tree * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ CPUINFO_LVL_MAX ] ;
...
position p;
@@
 struct cpuinfo_node * cocci_id@p ;
...
position p;
@@
 struct cpuinfo_node {  int id ;  int level ;  int num_cpus ;  int parent_index ;  int child_start ;  int child_end ;  int rover ; } cocci_id@p ;
...
position p;
@@
 struct cpuinfo_level {  int start_index ;  int end_index ;  int num_nodes ; } cocci_id@p ;
...
position p;
@@
 struct cpuinfo_level cocci_id@p [ CPUINFO_LVL_MAX ] ;
...
position p;
@@
 enum { ROVER_NO_OP = 0 , ROVER_INC_ON_VISIT = 1 << 0 , ROVER_INC_PARENT_ON_LOOP = 1 << 1 , } cocci_id@p ;
