...
typedef u16;
@@
 struct imx_i2c_clk_pair {  u16 div ;  u16 val ; } cocci_id@p ;
...
position p;
@@
 struct imx_i2c_hwdata cocci_id@p ;
...
position p;
@@
 const struct imx_i2c_hwdata cocci_id@p ;
...
position p;
@@
 enum imx_i2c_type { IMX1_I2C , IMX21_I2C , VF610_I2C , } cocci_id@p ;
...
position p;
@@
 struct imx_i2c_struct * cocci_id@p ;
...
position p;
@@
 struct i2c_bus_recovery_info * cocci_id@p ;
...
position p;
@@
 struct imxi2c_platform_data * cocci_id@p ;
...
position p;
@@
 struct imx_i2c_hwdata {  enum imx_i2c_type devtype ;  unsigned regshift ;  struct imx_i2c_clk_pair * clk_div ;  unsigned ndivs ;  unsigned i2sr_clr_opcode ;  unsigned i2cr_ien_opcode ; } cocci_id@p ;
...
position p;
@@
 struct imx_i2c_clk_pair cocci_id@p [ ] ;
...
typedef dma_addr_t;
@@
 struct imx_i2c_dma {  struct dma_chan * chan_tx ;  struct dma_chan * chan_rx ;  struct dma_chan * chan_using ;  struct completion cmd_complete ;  dma_addr_t dma_buf ;  unsigned int dma_len ;  enum dma_transfer_direction dma_transfer_dir ;  enum dma_data_direction dma_data_dir ; } cocci_id@p ;
