...
position p;
@@
 struct wlan_pwr_cfg cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CHANNEL_MAX_NUMBER_5G_80M ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_WOL_BIT_MASK_SIZE ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_WOL_PATTERN_SIZE ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ CHANNEL_MAX_NUMBER_5G ] ;
...
position p;
@@
 struct rtl_wow_pattern cocci_id@p ;
