...
position p;
@@
 struct ispstat_generic_config * cocci_id@p ;
...
position p;
@@
 struct omap3isp_stat_data * cocci_id@p ;
...
position p;
@@
 struct ispstat_buffer * cocci_id@p ;
...
position p;
@@
 struct omap3isp_stat_event_status * cocci_id@p ;
...
position p;
@@
 struct omap3isp_stat_data_time32 * cocci_id@p ;
