...
position p;
@@
 enum sixpack_flags { SIXPF_ERROR , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef tx_t,refcount_t,spinlock_t,resync_t;
@@
 struct sixpack {  struct tty_struct * tty ;  struct net_device * dev ;  unsigned char * rbuff ;  int rcount ;  unsigned char * xbuff ;  unsigned char * xhead ;  int xleft ;  unsigned char raw_buf [ 4 ] ;  unsigned char cooked_buf [ 400 ] ;  unsigned int rx_count ;  unsigned int rx_count_cooked ;  int mtu ;  int buffsize ;  unsigned long flags ;  unsigned char mode ;  unsigned char tx_delay ;  unsigned char persistence ;  unsigned char slottime ;  unsigned char duplex ;  unsigned char led_state ;  unsigned char status ;  unsigned char status1 ;  unsigned char status2 ;  unsigned char tx_enable ;  unsigned char tnc_state ;  struct timer_list tx_t ;  struct timer_list resync_t ;  refcount_t refcnt ;  struct completion dead ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct sockaddr_ax25 * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned char * , unsigned char * , int , unsigned char ) ;
...
position p;
@@
 void cocci_id@p ( struct sixpack * , const unsigned char [ ] , int ) ;
