...
position p;
@@
 enum lp8727_die_temp { LP8788_TEMP_75C , LP8788_TEMP_95C , LP8788_TEMP_115C , LP8788_TEMP_135C , } cocci_id@p ;
...
position p;
@@
 struct lp8727_platform_data * cocci_id@p ;
...
position p;
@@
 enum lp8727_die_temp cocci_id@p ;
...
position p;
@@
 struct lp8727_chg {  struct device * dev ;  struct i2c_client * client ;  struct mutex xfer_lock ;  struct lp8727_psy * psy ;  struct lp8727_platform_data * pdata ;  enum lp8727_dev_id devid ;  struct lp8727_chg_param * chg_param ;  int irq ;  struct delayed_work work ;  unsigned long debounce_jiffies ; } cocci_id@p ;
...
position p;
@@
 struct lp8727_chg_param * cocci_id@p ;
...
position p;
@@
 struct lp8727_psy {  struct power_supply * ac ;  struct power_supply * usb ;  struct power_supply * batt ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ LP8788_NUM_INTREGS ] ;
...
position p;
@@
 enum lp8727_dev_id { LP8727_ID_NONE , LP8727_ID_TA , LP8727_ID_DEDICATED_CHG , LP8727_ID_USB_CHG , LP8727_ID_USB_DS , LP8727_ID_MAX , } cocci_id@p ;
