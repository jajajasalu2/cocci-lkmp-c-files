...
position p;
@@
 void ( * cocci_id@p ) ( struct device * , void * ) ;
...
typedef bool;
@@
 struct component {  struct list_head node ;  struct master * master ;  bool bound ;  const struct component_ops * ops ;  int subcomponent ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct component_match_array * cocci_id@p ;
...
typedef bool;
@@
 struct master {  struct list_head node ;  bool bound ;  const struct component_master_ops * ops ;  struct device * dev ;  struct component_match * match ;  struct dentry * dentry ; } cocci_id@p ;
...
position p;
@@
 struct component_match {  size_t alloc ;  size_t num ;  struct component_match_array * compare ; } cocci_id@p ;
...
typedef bool;
@@
 struct component_match_array {  void * data ;  int ( * compare ) ( struct device * , void * ) ;  int ( * compare_typed ) ( struct device * , int , void * ) ;  void ( * release ) ( struct device * , void * ) ;  struct component * component ;  bool duplicate ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device * , int , void * ) ;
