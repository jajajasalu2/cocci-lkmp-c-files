...
typedef u8,u16;
@@
 const struct {  u16 command ;  u8 arg ; } cocci_id@p [ ] ;
...
typedef s32,bool;
@@
 struct byd_data {  struct timer_list timer ;  struct psmouse * psmouse ;  s32 abs_x ;  s32 abs_y ;  typeof ( jiffies ) last_touch_time ;  bool btn_left ;  bool btn_right ;  bool touch ; } cocci_id@p ;
