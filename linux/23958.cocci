...
position p;
@@
 const struct nla_policy cocci_id@p [ NHA_MAX + 1 ] ;
...
position p;
@@
 void cocci_id@p ( struct net * net , struct nexthop * nh , struct nl_info * nlinfo ) ;
...
position p;
@@
 const struct nh_info * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct fib6_nh * nh , void * arg ) ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NHA_MAX + 1 ] ;
...
position p;
@@
 struct nh_grp_entry * cocci_id@p ;
