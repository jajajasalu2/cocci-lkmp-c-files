...
position p;
@@
 struct pfect_lru {  struct list_head list ;  struct pfect_lru_node * free_nodes ;  unsigned int cur_size ;  unsigned int lru_size ;  unsigned int nr_unique ;  unsigned int nr_misses ;  unsigned int total ;  int map_fd ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( int i , void * data ) ;
...
position p;
@@
 struct pfect_lru_node cocci_id@p ;
...
position p;
@@
 const typeof ( ( ( type * ) 0 ) -> member ) * cocci_id@p ;
...
position p;
@@
 struct pfect_lru_node {  struct list_head list ;  unsigned long long key ; } cocci_id@p ;
