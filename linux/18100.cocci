...
position p;
@@
 int cocci_id@p [ MAX_NR_CLUSTERS ] [ MAX_CPUS_PER_CLUSTER ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned int affinity_level ) ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_NR_CLUSTERS ] [ MAX_CPUS_PER_CLUSTER ] ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_NR_CLUSTERS ] [ MAX_CPUS_PER_CLUSTER ] [ 2 ] ;
...
position p;
@@
 const struct mcpm_platform_ops * cocci_id@p ;
...
position p;
@@
 struct mcpm_sync_struct * cocci_id@p ;
