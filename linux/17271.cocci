...
position p;
@@
 struct ps3_mmio_region * cocci_id@p ;
...
position p;
@@
 const struct ps3_mmio_region * cocci_id@p ;
...
position p;
@@
 struct {  struct mutex mutex ;  int sb_11 ;  int sb_12 ;  int gpu ; } cocci_id@p ;
...
position p;
@@
 enum ps3_mmio_page_size cocci_id@p ;
...
position p;
@@
 const struct ps3_mmio_region_ops cocci_id@p ;
