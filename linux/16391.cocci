...
position p;
@@
 struct hammer_kbd_leds * cocci_id@p ;
...
typedef bool;
@@
 struct cbas_ec {  struct device * dev ;  struct input_dev * input ;  bool base_present ;  bool base_folded ;  struct notifier_block notifier ; } cocci_id@p ;
...
typedef u8;
@@
 struct hammer_kbd_leds {  struct led_classdev cdev ;  struct hid_device * hdev ;  u8 buf [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ec_params_mkbp_info * cocci_id@p ;
