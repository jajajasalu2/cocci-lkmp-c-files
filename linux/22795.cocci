...
position p;
@@
 struct intel_hdmi_lpe_audio_port_pdata * cocci_id@p ;
...
position p;
@@
 union aud_ch_status_0 cocci_id@p ;
...
position p;
@@
 union aud_info_frame3 cocci_id@p ;
...
position p;
@@
 union aud_info_frame2 cocci_id@p ;
...
position p;
@@
 struct cea_channel_speaker_allocation * cocci_id@p ;
...
position p;
@@
 union aud_ch_status_1 cocci_id@p ;
...
position p;
@@
 struct snd_intelhad * cocci_id@p ;
...
position p;
@@
 struct snd_intelhad_card * cocci_id@p ;
...
position p;
@@
 const struct channel_map_table cocci_id@p [ ] ;
...
position p;
@@
 struct intel_hdmi_lpe_audio_pdata * cocci_id@p ;
...
position p;
@@
 union aud_buf_config cocci_id@p ;
