...
position p;
@@
 struct nlattr * cocci_id@p [ NFCTH_POLICY_SET_MAX + 1 ] ;
...
position p;
@@
 struct nf_conntrack_expect_policy cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFCTH_TUPLE_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFCTH_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFCTH_POLICY_SET_MAX + 1 ] ;
...
position p;
@@
 struct nfnl_cthelper * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFCTH_POLICY_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFCTH_TUPLE_MAX + 1 ] ;
...
position p;
@@
 const struct nfnl_callback cocci_id@p [ NFNL_MSG_CTHELPER_MAX ] ;
...
position p;
@@
 struct nfnl_cthelper {  struct list_head list ;  struct nf_conntrack_helper helper ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFCTH_POLICY_MAX + 1 ] ;
