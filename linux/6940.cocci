...
position p;
@@
 struct realtek_pci_ms cocci_id@p ;
...
position p;
@@
 enum memstick_param cocci_id@p ;
...
typedef u8,bool;
@@
 struct realtek_pci_ms {  struct platform_device * pdev ;  struct rtsx_pcr * pcr ;  struct memstick_host * msh ;  struct memstick_request * req ;  struct mutex host_mutex ;  struct work_struct handle_req ;  u8 ssc_depth ;  unsigned int clock ;  unsigned char ifmode ;  bool eject ; } cocci_id@p ;
