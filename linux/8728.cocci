...
position p;
@@
 struct roce_create_qp_resp_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct roce_destroy_qp_resp_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct roce_query_qp_req_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct roce_create_qp_req_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct roce_destroy_qp_req_output_params * cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct qed_hwfn * p_hwfn , u16 icid ) ;
...
position p;
@@
 union rdma_eqe_data cocci_id@p ;
...
position p;
@@
 struct roce_destroy_qp_req_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct roce_destroy_qp_resp_output_params * cocci_id@p ;
...
position p;
@@
 struct roce_modify_qp_resp_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct roce_modify_qp_req_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct roce_query_qp_resp_output_params * cocci_id@p ;
...
position p;
@@
 struct roce_query_qp_resp_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct roce_query_qp_req_output_params * cocci_id@p ;
