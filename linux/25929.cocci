...
position p;
@@
 struct stats {  char name [ 16 ] ;  unsigned long total ;  unsigned long count ;  unsigned long bytes ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ TEST6_VERSION_SZ ] ;
...
position p;
@@
 unsigned char cocci_id@p [ TEST3_VERSION_SZ ] ;
...
position p;
@@
 unsigned char cocci_id@p [ TEST2_VERSION_SZ ] ;
...
position p;
@@
 unsigned long long int cocci_id@p [ MAX_RANGES_SUPPORTED ] ;
...
position p;
@@
 unsigned char cocci_id@p [ TEST1_VERSION_SZ ] ;
...
position p;
@@
 unsigned char cocci_id@p [ TEST7_VERSION_SZ ] ;
...
position p;
@@
 const struct stats * const cocci_id@p ;
