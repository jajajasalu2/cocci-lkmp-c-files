...
position p;
@@
 const struct rpmpd_desc cocci_id@p ;
...
position p;
@@
 struct rpmpd_desc {  struct rpmpd * * rpmpds ;  size_t num_pds ;  unsigned int max_state ; } cocci_id@p ;
...
typedef __le32,bool;
@@
 struct rpmpd {  struct generic_pm_domain pd ;  struct rpmpd * peer ;  const bool active_only ;  unsigned int corner ;  bool enabled ;  const char * res_name ;  const int res_type ;  const int res_id ;  struct qcom_smd_rpm * rpm ;  unsigned int max_state ;  __le32 key ; } cocci_id@p ;
...
typedef __le32;
@@
 struct rpmpd_req {  __le32 key ;  __le32 nbytes ;  __le32 value ; } cocci_id@p ;
