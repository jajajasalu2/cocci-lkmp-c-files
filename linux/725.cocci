...
position p;
@@
 struct ebda_rsrc_list * cocci_id@p ;
...
position p;
@@
 struct rio_table_hdr * cocci_id@p ;
...
position p;
@@
 struct ebda_pci_rsrc * cocci_id@p ;
...
position p;
@@
 struct ebda_hpc_list cocci_id@p ;
...
position p;
@@
 struct ebda_hpc_bus cocci_id@p ;
...
position p;
@@
 struct ebda_hpc_slot * cocci_id@p ;
