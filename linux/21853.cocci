...
position p;
@@
 const struct _ddebug * cocci_id@p ;
...
position p;
@@
 struct ddebug_iter {  struct ddebug_table * table ;  unsigned int idx ; } cocci_id@p ;
...
position p;
@@
 struct ddebug_table * cocci_id@p ;
...
position p;
@@
 struct ddebug_table {  struct list_head link ;  const char * mod_name ;  unsigned int num_ddebugs ;  struct _ddebug * ddebugs ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned flag : 8 ;  char opt_char ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ DDEBUG_STRING_SIZE ] ;
...
position p;
@@
 const struct ddebug_query * cocci_id@p ;
...
position p;
@@
 struct ddebug_query cocci_id@p ;
