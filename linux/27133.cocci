...
position p;
@@
 struct ubifs_lp_stats cocci_id@p ;
...
position p;
@@
 const struct ubifs_znode * cocci_id@p ;
...
position p;
@@
 const struct ubifs_info * cocci_id@p ;
...
position p;
@@
 struct ubifs_global_debug_info cocci_id@p ;
...
position p;
@@
 const struct ubifs_mst_node * cocci_id@p ;
...
position p;
@@
 const struct ubifs_sb_node * cocci_id@p ;
...
position p;
@@
 const struct ubifs_orph_node * cocci_id@p ;
...
position p;
@@
 struct ubifs_scan_leb * cocci_id@p ;
...
position p;
@@
 const struct ubifs_budg_info * cocci_id@p ;
...
position p;
@@
 const struct ubifs_budget_req * cocci_id@p ;
...
position p;
@@
 const struct ubifs_inode * cocci_id@p ;
...
position p;
@@
 const struct ubifs_data_node * cocci_id@p ;
...
position p;
@@
 struct ubifs_dent_node * cocci_id@p ;
...
position p;
@@
 const struct ubifs_pad_node * cocci_id@p ;
...
position p;
@@
 struct ubifs_data_node * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ino_t,umode_t;
@@
 struct fsck_inode {  struct rb_node rb ;  ino_t inum ;  umode_t mode ;  unsigned int nlink ;  unsigned int xattr_cnt ;  int references ;  int calc_cnt ;  long long size ;  unsigned int xattr_sz ;  long long calc_sz ;  long long calc_xcnt ;  long long calc_xsz ;  unsigned int xattr_nms ;  long long calc_xnms ; } cocci_id@p ;
...
position p;
@@
 struct ubifs_lprops * cocci_id@p ;
...
position p;
@@
 const struct ubifs_ch * cocci_id@p ;
...
position p;
@@
 const struct ubifs_scan_leb * cocci_id@p ;
...
position p;
@@
 const struct ubifs_lprops * cocci_id@p ;
...
position p;
@@
 const struct ubifs_ref_node * cocci_id@p ;
...
position p;
@@
 struct ubifs_lpt_heap * cocci_id@p ;
...
position p;
@@
 struct fsck_data {  struct rb_root inodes ; } cocci_id@p ;
...
position p;
@@
 struct ubifs_gced_idx_leb * cocci_id@p ;
...
position p;
@@
 struct ubifs_debug_info cocci_id@p ;
...
position p;
@@
 const struct ubifs_branch * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ DBG_KEY_BUF_LEN ] ;
...
position p;
@@
 const struct ubifs_trun_node * cocci_id@p ;
...
position p;
@@
 struct ubifs_budg_info cocci_id@p ;
...
position p;
@@
 const struct ubifs_dent_node * cocci_id@p ;
...
position p;
@@
 const struct ubifs_ino_node * cocci_id@p ;
...
position p;
@@
 struct ubifs_ino_node * cocci_id@p ;
...
position p;
@@
 const struct ubifs_lp_stats * cocci_id@p ;
...
position p;
@@
 const struct ubifs_idx_node * cocci_id@p ;
...
position p;
@@
 struct ubifs_zbranch * cocci_id@p ;
...
position p;
@@
 struct ubifs_scan_node * cocci_id@p ;
...
position p;
@@
 const union ubifs_key * cocci_id@p ;
...
position p;
@@
 const struct ubifs_zbranch * cocci_id@p ;
