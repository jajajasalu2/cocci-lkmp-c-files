...
position p;
@@
 const struct group_desc cocci_id@p [ ] ;
...
position p;
@@
 enum jz_version { ID_JZ4740 , ID_JZ4725B , ID_JZ4760 , ID_JZ4760B , ID_JZ4770 , ID_JZ4780 , ID_X1000 , ID_X1000E , ID_X1500 , } cocci_id@p ;
...
position p;
@@
 struct ingenic_gpio_chip * cocci_id@p ;
...
position p;
@@
 struct ingenic_pinctrl {  struct device * dev ;  struct regmap * map ;  struct pinctrl_dev * pctl ;  struct pinctrl_pin_desc * pdesc ;  enum jz_version version ;  const struct ingenic_chip_info * info ; } cocci_id@p ;
...
position p;
@@
 const struct ingenic_chip_info * cocci_id@p ;
...
position p;
@@
 const struct function_desc * cocci_id@p ;
...
position p;
@@
 struct ingenic_pinctrl * cocci_id@p ;
