...
position p;
@@
 struct fasync_struct * cocci_id@p [ 256 ] ;
...
position p;
@@
 struct cosa_data cocci_id@p [ MAX_CARDS ] ;
...
position p;
@@
 void cocci_id@p ( struct cosa_data * cosa , int status ) ;
...
position p;
@@
 void cocci_id@p ( struct cosa_data * cosa , int data ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * d ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct file * file , int on ) ;
...
position p;
@@
 int cocci_id@p ( struct cosa_data * cosa , char __user * data , int addr , int len ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * d ) ;
...
position p;
@@
 struct channel_data cocci_id@p ;
...
position p;
@@
 struct cosa_download cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cosa_data * cosa , void __user * a ) ;
...
position p;
@@
 void cocci_id@p ( struct channel_data * chan ) ;
...
position p;
@@
 int cocci_id@p ( struct channel_data * channel , char * buf , int size ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , unsigned short encoding , unsigned short parity ) ;
...
position p;
@@
 int cocci_id@p ( struct channel_data * channel , int size ) ;
...
position p;
@@
 int cocci_id@p ( struct channel_data * channel ) ;
...
position p;
@@
 int cocci_id@p ( struct channel_data * chan , char * buf , int data ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * cosa ) ;
...
position p;
@@
 char * cocci_id@p ( struct channel_data * channel , int size ) ;
...
position p;
@@
 int cocci_id@p ( struct cosa_data * cosa ) ;
...
position p;
@@
 int cocci_id@p ( struct cosa_data * cosa , const char __user * data , int addr , int len ) ;
...
position p;
@@
 int cocci_id@p ( struct cosa_data * cosa , int address ) ;
...
position p;
@@
 void cocci_id@p ( struct cosa_data * cosa ) ;
...
position p;
@@
 char cocci_id@p [ COSA_MAX_ID_STRING ] ;
...
typedef netdev_tx_t;
@@
 netdev_tx_t cocci_id@p ( struct sk_buff * skb , struct net_device * d ) ;
...
position p;
@@
 int cocci_id@p ( struct cosa_data * cosa , int data ) ;
...
position p;
@@
 int cocci_id@p ( struct cosa_data * cosa , int number ) ;
...
position p;
@@
 int cocci_id@p ( int ioaddr , int irq , int dma ) ;
...
position p;
@@
 int cocci_id@p ( struct cosa_data * cosa , char * id ) ;
