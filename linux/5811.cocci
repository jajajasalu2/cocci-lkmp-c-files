...
position p;
@@
 struct npcm7xx_func cocci_id@p [ ] ;
...
position p;
@@
 struct npcm7xx_gpio * cocci_id@p ;
...
position p;
@@
 struct npcm7xx_group cocci_id@p [ ] ;
...
position p;
@@
 struct npcm7xx_func {  const char * name ;  const unsigned int ngroups ;  const char * const * groups ; } cocci_id@p ;
...
position p;
@@
 const struct npcm7xx_pincfg * cocci_id@p ;
...
position p;
@@
 struct npcm7xx_pinctrl * cocci_id@p ;
...
position p;
@@
 struct npcm7xx_group {  const char * name ;  const unsigned int * pins ;  int npins ; } cocci_id@p ;
...
typedef u32;
@@
 struct npcm7xx_pinctrl {  struct pinctrl_dev * pctldev ;  struct device * dev ;  struct npcm7xx_gpio gpio_bank [ NPCM7XX_GPIO_BANK_NUM ] ;  struct irq_domain * domain ;  struct regmap * gcr_regmap ;  void __iomem * regs ;  u32 bank_num ; } cocci_id@p ;
