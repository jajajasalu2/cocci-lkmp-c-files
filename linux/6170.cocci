...
position p;
@@
 struct timberdale_device * cocci_id@p ;
...
position p;
@@
 struct ocores_i2c_platform_data cocci_id@p ;
...
position p;
@@
 struct ks8842_platform_data cocci_id@p ;
...
position p;
@@
 struct timb_radio_platform_data cocci_id@p ;
...
position p;
@@
 const struct max7301_platform_data cocci_id@p ;
...
position p;
@@
 const struct mc33880_platform_data cocci_id@p ;
...
position p;
@@
 struct xiic_i2c_platform_data cocci_id@p ;
...
position p;
@@
 struct timb_video_platform_data cocci_id@p ;
...
@@
 struct timberdale_device {  resource_size_t ctl_mapbase ;  unsigned char __iomem * ctl_membase ;  struct {  u32 major ;  u32 minor ;  u32 config ; } fw ; } cocci_id@p ;
...
position p;
@@
 struct timbgpio_platform_data cocci_id@p ;
...
position p;
@@
 struct xspi_platform_data cocci_id@p ;
