...
position p;
@@
 struct vexpress_hwmon_data {  struct device * hwmon_dev ;  struct regmap * reg ; } cocci_id@p ;
...
position p;
@@
 const struct vexpress_hwmon_type * cocci_id@p ;
...
position p;
@@
 struct vexpress_hwmon_type cocci_id@p ;
...
position p;
@@
 struct vexpress_hwmon_data * cocci_id@p ;
...
position p;
@@
 struct vexpress_hwmon_type {  const char * name ;  const struct attribute_group * * attr_groups ; } cocci_id@p ;
