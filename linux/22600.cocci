...
position p;
@@
 const  cocci_id@p ( db_scale_audio1 , 
						      0 , 8 , 
...
position p;
@@
 const  cocci_id@p ( db_scale_master , 
						      0 , 54 , 
...
position p;
@@
 const  cocci_id@p ( db_scale_audio2 , 
						      0 , 8 , 
...
position p;
@@
 unsigned char cocci_id@p [ SAVED_REG_SIZE + 1 ] ;
...
position p;
@@
 const  cocci_id@p ( db_scale_line , 
						      0 , 8 , 
