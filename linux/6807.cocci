...
position p;
@@
 struct {  enum fc_port_state value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct fc_rport * ) ;
...
position p;
@@
 struct {  enum fc_vport_state value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct request_queue * ) ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * , struct fc_host_attrs * ) ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * shost , int channel , struct device * pdev , struct fc_vport_identifiers * ids , struct fc_vport * * vport ) ;
...
position p;
@@
 struct fc_bsg_host_del_rport cocci_id@p ;
...
position p;
@@
 const struct {  enum fc_tgtid_binding_type value ;  char * name ;  int matchlen ; } cocci_id@p [ ] ;
...
position p;
@@
 enum fc_host_event_code cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * , struct work_struct * ) ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * , struct fc_rport * ) ;
...
typedef u32;
@@
 const struct {  u32 value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 enum fc_tgtid_binding_type cocci_id@p ;
...
position p;
@@
 struct fc_bsg_host_add_rport cocci_id@p ;
...
position p;
@@
 struct attribute_container * cocci_id@p ;
...
position p;
@@
 struct fc_bsg_host_ct cocci_id@p ;
...
position p;
@@
 struct fc_bsg_rport_els cocci_id@p ;
...
position p;
@@
 struct fc_bsg_host_els cocci_id@p ;
...
position p;
@@
 struct {  enum fc_port_type value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct fc_bsg_rport_ct cocci_id@p ;
...
position p;
@@
 struct fc_starget_attrs cocci_id@p ;
...
position p;
@@
 struct transport_container * cocci_id@p ;
...
position p;
@@
 struct fc_bsg_host_vendor cocci_id@p ;
...
position p;
@@
 const struct {  enum fc_host_event_code value ;  char * name ; } cocci_id@p [ ] ;
