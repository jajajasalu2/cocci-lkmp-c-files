...
typedef u32;
@@
 void cocci_id@p ( void * data , u32 mask ) ;
...
position p;
@@
 struct mgr_priv_data * cocci_id@p ;
...
typedef bool;
@@
 struct {  struct ovl_priv_data ovl_priv_data_array [ MAX_DSS_OVERLAYS ] ;  struct mgr_priv_data mgr_priv_data_array [ MAX_DSS_MANAGERS ] ;  bool irq_enabled ; } cocci_id@p ;
...
position p;
@@
 struct omap_overlay_info * cocci_id@p [ MAX_DSS_OVERLAYS ] ;
...
typedef bool;
@@
 struct mgr_priv_data {  bool user_info_dirty ;  struct omap_overlay_manager_info user_info ;  bool info_dirty ;  struct omap_overlay_manager_info info ;  bool shadow_info_dirty ;  bool busy ;  bool updating ;  bool enabled ;  bool extra_info_dirty ;  bool shadow_extra_info_dirty ;  struct omap_video_timings timings ;  struct dss_lcd_mgr_config lcd_config ;  void ( * framedone_handler ) ( void * ) ;  void * framedone_handler_data ; } cocci_id@p ;
...
position p;
@@
 struct ovl_priv_data * cocci_id@p ;
