...
position p;
@@
 struct khugepaged_scan cocci_id@p ;
...
position p;
@@
 struct khugepaged_scan {  struct list_head mm_head ;  struct mm_slot * mm_slot ;  unsigned long address ; } cocci_id@p ;
...
position p;
@@
 struct mm_slot {  struct hlist_node hash ;  struct list_head mm_node ;  struct mm_struct * mm ;  int nr_pte_mapped_thp ;  unsigned long pte_mapped_thp [ MAX_PTE_MAPPED_THP ] ; } cocci_id@p ;
