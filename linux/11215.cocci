...
position p;
@@
 display_data_rq_regs_st * cocci_id@p ;
...
position p;
@@
 const display_e2e_pipe_params_st * cocci_id@p ;
...
position p;
@@
 display_data_rq_sizing_params_st * cocci_id@p ;
...
position p;
@@
 const display_data_rq_sizing_params_st cocci_id@p ;
...
position p;
@@
 display_dlg_sys_params_st cocci_id@p ;
...
position p;
@@
 enum source_macro_tile_size cocci_id@p ;
...
position p;
@@
 const display_pipe_dest_params_st * cocci_id@p ;
...
position p;
@@
 display_rq_params_st * cocci_id@p ;
...
position p;
@@
 const scaler_taps_st * cocci_id@p ;
...
position p;
@@
 const scaler_ratio_depth_st * cocci_id@p ;
...
position p;
@@
 display_data_rq_dlg_params_st * cocci_id@p ;
...
position p;
@@
 const display_rq_params_st cocci_id@p ;
...
position p;
@@
 const display_pipe_source_params_st * cocci_id@p ;
...
position p;
@@
 display_data_rq_misc_params_st * cocci_id@p ;
...
position p;
@@
 const display_rq_dlg_params_st cocci_id@p ;
...
position p;
@@
 const enum source_macro_tile_size cocci_id@p ;
...
position p;
@@
 display_dlg_regs_st * cocci_id@p ;
...
position p;
@@
 const display_pipe_params_st cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct display_mode_lib * mode_lib , display_rq_params_st * rq_param , const display_pipe_source_params_st pipe_src_param ) ;
...
position p;
@@
 const display_clocks_and_cfg_st * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct display_mode_lib * mode_lib , double * refcyc_per_req_delivery_pre_cur , double * refcyc_per_req_delivery_cur , double refclk_freq_in_mhz , double ref_freq_to_pix_freq , double hscale_pixel_rate_l , double hscl_ratio , double vratio_pre_l , double vratio_l , unsigned int cur_width , enum cursor_bpp cur_bpp ) ;
...
position p;
@@
 const display_output_params_st * cocci_id@p ;
...
position p;
@@
 const display_dlg_sys_params_st cocci_id@p ;
...
position p;
@@
 display_ttu_regs_st * cocci_id@p ;
