...
position p;
@@
 struct drm_simple_display_pipe * cocci_id@p ;
...
position p;
@@
 enum repaper_model { E1144CS021 = 1 , E1190CS021 , E2200CS021 , E2271CS021 , } cocci_id@p ;
...
position p;
@@
 const struct drm_simple_display_pipe_funcs cocci_id@p ;
...
position p;
@@
 enum repaper_stage { REPAPER_COMPENSATE , REPAPER_WHITE , REPAPER_INVERSE , REPAPER_NORMAL , } cocci_id@p ;
...
position p;
@@
 enum repaper_epd_border_byte { REPAPER_BORDER_BYTE_NONE , REPAPER_BORDER_BYTE_ZERO , REPAPER_BORDER_BYTE_SET , } cocci_id@p ;
