...
@@
 struct wbcir_data {  spinlock_t spinlock ;  struct rc_dev * dev ;  struct led_classdev led ;  unsigned long wbase ;  unsigned long ebase ;  unsigned long sbase ;  unsigned int irq ;  u8 irqmask ;  enum wbcir_rxstate rxstate ;  int carrier_report_enabled ;  u32 pulse_duration ;  enum wbcir_txstate txstate ;  u32 txlen ;  u32 txoff ;  u32 * txbuf ;  u8 txmask ;  u32 txcarrier ; } cocci_id@p ;
...
position p;
@@
 enum wbcir_rxstate { WBCIR_RXSTATE_INACTIVE = 0 , WBCIR_RXSTATE_ACTIVE , WBCIR_RXSTATE_ERROR , } cocci_id@p ;
...
position p;
@@
 enum wbcir_bank { WBCIR_BANK_0 = 0x00 , WBCIR_BANK_1 = 0x80 , WBCIR_BANK_2 = 0xE0 , WBCIR_BANK_3 = 0xE4 , WBCIR_BANK_4 = 0xE8 , WBCIR_BANK_5 = 0xEC , WBCIR_BANK_6 = 0xF0 , WBCIR_BANK_7 = 0xF4 , } cocci_id@p ;
...
position p;
@@
 struct rc_scancode_filter * cocci_id@p ;
...
position p;
@@
 enum wbcir_txstate { WBCIR_TXSTATE_INACTIVE = 0 , WBCIR_TXSTATE_ACTIVE , WBCIR_TXSTATE_ERROR , } cocci_id@p ;
...
position p;
@@
 enum wbcir_protocol { IR_PROTOCOL_RC5 = 0x0 , IR_PROTOCOL_NEC = 0x1 , IR_PROTOCOL_RC6 = 0x2 , } cocci_id@p ;
