...
typedef u16;
@@
 void ( * cocci_id@p ) ( void __iomem * addr , unsigned offset , u16 data ) ;
...
position p;
@@
 struct musb_pending_work * cocci_id@p ;
...
position p;
@@
 const struct musb_hdrc_config * cocci_id@p ;
...
position p;
@@
 struct usb_phy_io_ops cocci_id@p ;
...
position p;
@@
 const struct musb_fifo_cfg * cocci_id@p ;
...
position p;
@@
 struct musb_fifo_cfg cocci_id@p [ ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( enum musb_vbus_id_status status ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct dma_controller * c ) ;
...
position p;
@@
 void cocci_id@p ( struct musb * musb ) ;
...
position p;
@@
 enum { MUSB_CONTROLLER_MHDRC , MUSB_CONTROLLER_HDRC , } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct musb * musb , void * data ) ;
...
typedef u16;
@@
 u16 ( * cocci_id@p ) ( const void __iomem * addr , unsigned offset ) ;
...
position p;
@@
 struct dma_controller * ( * cocci_id@p ) ( struct musb * musb , void __iomem * base ) ;
...
typedef u8;
@@
 u8 ( * cocci_id@p ) ( const void __iomem * addr , unsigned offset ) ;
...
position p;
@@
 enum musb_vbus_id_status cocci_id@p ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( void __iomem * addr , unsigned offset , u8 data ) ;
