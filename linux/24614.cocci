...
position p;
@@
 struct devlink_dpipe_action * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ DEVLINK_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct devlink_trap_group_item * cocci_id@p ;
...
position p;
@@
 const struct devlink_dpipe_header * cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_value * cocci_id@p ;
...
position p;
@@
 enum devlink_param_type cocci_id@p ;
...
position p;
@@
 const struct devlink_param * cocci_id@p ;
...
position p;
@@
 struct devlink_trap_item {  const struct devlink_trap * trap ;  struct devlink_trap_group_item * group_item ;  struct list_head list ;  enum devlink_trap_action action ;  struct devlink_stats __percpu * stats ;  void * priv ; } cocci_id@p ;
...
position p;
@@
 enum devlink_sb_threshold_type cocci_id@p ;
...
position p;
@@
 struct devlink_info_req cocci_id@p ;
...
position p;
@@
 enum devlink_port_flavour cocci_id@p ;
...
position p;
@@
 const struct devlink_health_reporter_ops * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct devlink * devlink , unsigned int port_index , struct devlink_param_item * param_item , enum devlink_command cmd ) ;
...
position p;
@@
 struct devlink_trap_item * cocci_id@p ;
...
position p;
@@
 struct devlink_stats * cocci_id@p ;
...
position p;
@@
 enum devlink_multicast_groups { DEVLINK_MCGRP_CONFIG , } cocci_id@p ;
...
position p;
@@
 struct devlink_fmsg * cocci_id@p ;
...
position p;
@@
 struct devlink_trap_group_item * cocci_id@p ;
...
position p;
@@
 const struct genl_dumpit_info * cocci_id@p ;
...
position p;
@@
 const struct devlink_trap_group cocci_id@p [ ] ;
...
position p;
@@
 struct devlink_dpipe_headers * cocci_id@p ;
...
position p;
@@
 const struct devlink_resource_size_params * cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_header cocci_id@p ;
...
position p;
@@
 union devlink_param_value cocci_id@p ;
...
position p;
@@
 struct devlink_region * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,bool,refcount_t;
@@
 struct devlink_health_reporter {  struct list_head list ;  void * priv ;  const struct devlink_health_reporter_ops * ops ;  struct devlink * devlink ;  struct devlink_fmsg * dump_fmsg ;  struct mutex dump_lock ;  u64 graceful_period ;  bool auto_recover ;  u8 health_state ;  u64 dump_ts ;  u64 dump_real_ts ;  u64 error_count ;  u64 recovery_count ;  u64 last_recovery_ts ;  refcount_t refcount ; } cocci_id@p ;
...
typedef u64;
@@
 struct devlink_stats {  u64 rx_bytes ;  u64 rx_packets ;  struct u64_stats_sync syncp ; } cocci_id@p ;
...
position p;
@@
 const struct devlink_ops * cocci_id@p ;
...
position p;
@@
 enum devlink_sb_pool_type cocci_id@p ;
...
typedef refcount_t;
@@
 struct devlink_trap_group_item {  const struct devlink_trap_group * group ;  refcount_t refcount ;  struct list_head list ;  struct devlink_stats __percpu * stats ; } cocci_id@p ;
...
position p;
@@
 struct devlink_param_gset_ctx cocci_id@p ;
...
position p;
@@
 struct devlink_sb_pool_info cocci_id@p ;
...
position p;
@@
 struct devlink_param_item * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef devlink_snapshot_data_dest_t;
@@
 devlink_snapshot_data_dest_t * cocci_id@p ;
...
position p;
@@
 const struct devlink_trap cocci_id@p [ ] ;
...
position p;
@@
 enum devlink_port_type cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,devlink_snapshot_data_dest_t;
@@
 struct devlink_snapshot {  struct list_head list ;  struct devlink_region * region ;  devlink_snapshot_data_dest_t * data_destructor ;  u8 * data ;  u32 id ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef devlink_resource_occ_get_t;
@@
 devlink_resource_occ_get_t * cocci_id@p ;
...
typedef u8,u16;
@@
 struct devlink_fmsg_item {  struct list_head list ;  int attrtype ;  u8 nla_type ;  u16 len ;  int value [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_table_ops * cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_field cocci_id@p [ ] ;
...
typedef u32,u16;
@@
 struct devlink_sb {  struct list_head list ;  unsigned int index ;  u32 size ;  u16 ingress_pools_count ;  u16 egress_pools_count ;  u16 ingress_tc_count ;  u16 egress_tc_count ; } cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_entry * cocci_id@p ;
...
position p;
@@
 enum devlink_eswitch_encap_mode cocci_id@p ;
...
typedef u64,u32;
@@
 struct devlink_region {  struct devlink * devlink ;  struct list_head list ;  const char * name ;  struct list_head snapshot_list ;  u32 max_snapshots ;  u32 cur_snapshots ;  u64 size ; } cocci_id@p ;
...
position p;
@@
 struct devlink_fmsg_item * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ DEVLINK_PARAM_CMODE_MAX + 1 ] ;
...
position p;
@@
 struct devlink_dpipe_dump_ctx cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_table cocci_id@p ;
...
position p;
@@
 struct devlink_resource_size_params * cocci_id@p ;
...
position p;
@@
 enum devlink_command cocci_id@p ;
...
position p;
@@
 enum devlink_trap_action cocci_id@p ;
...
position p;
@@
 struct devlink_fmsg {  struct list_head item_list ; } cocci_id@p ;
...
position p;
@@
 enum devlink_param_cmode cocci_id@p ;
...
position p;
@@
 const struct devlink * cocci_id@p ;
...
position p;
@@
 struct devlink_snapshot * cocci_id@p ;
...
position p;
@@
 struct devlink_resource cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_match * cocci_id@p ;
...
position p;
@@
 enum devlink_health_reporter_state cocci_id@p ;
...
position p;
@@
 struct devlink_info_req {  struct sk_buff * msg ; } cocci_id@p ;
...
position p;
@@
 struct net_dm_hw_metadata * cocci_id@p ;
...
position p;
@@
 struct devlink_port_attrs * cocci_id@p ;
...
position p;
@@
 union devlink_param_value cocci_id@p [ DEVLINK_PARAM_CMODE_MAX + 1 ] ;
...
position p;
@@
 struct devlink_health_reporter * cocci_id@p ;
...
position p;
@@
 const struct devlink_trap_item * cocci_id@p ;
