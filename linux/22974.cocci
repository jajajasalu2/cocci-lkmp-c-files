...
position p;
@@
 struct snd_timer_gstatus cocci_id@p ;
...
position p;
@@
 struct snd_timer_tread cocci_id@p ;
...
position p;
@@
 enum { SNDRV_TIMER_IOCTL_START_OLD = _IO ( 'T' , 0x20 ) , SNDRV_TIMER_IOCTL_STOP_OLD = _IO ( 'T' , 0x21 ) , SNDRV_TIMER_IOCTL_CONTINUE_OLD = _IO ( 'T' , 0x22 ) , SNDRV_TIMER_IOCTL_PAUSE_OLD = _IO ( 'T' , 0x23 ) , } cocci_id@p ;
...
position p;
@@
 struct snd_timer_params cocci_id@p ;
...
@@
 struct snd_timer_user {  struct snd_timer_instance * timeri ;  int tread ;  unsigned long ticks ;  unsigned long overrun ;  int qhead ;  int qtail ;  int qused ;  int queue_size ;  bool disconnected ;  struct snd_timer_read * queue ;  struct snd_timer_tread * tqueue ;  spinlock_t qlock ;  unsigned long last_resolution ;  unsigned int filter ;  struct timespec tstamp ;  wait_queue_head_t qchange_sleep ;  struct fasync_struct * fasync ;  struct mutex ioctl_lock ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_timer * timer ) ;
...
position p;
@@
 struct snd_timer_system_private * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_timer_instance * timeri , struct device * * card_devp_to_put ) ;
...
position p;
@@
 struct snd_timer_ginfo * cocci_id@p ;
...
position p;
@@
 struct snd_timer_read * cocci_id@p ;
...
position p;
@@
 struct snd_timer_select cocci_id@p ;
...
position p;
@@
 struct snd_timer_status cocci_id@p ;
...
position p;
@@
 struct snd_timer_system_private {  struct timer_list tlist ;  struct snd_timer * snd_timer ;  unsigned long last_expires ;  unsigned long last_jiffies ;  unsigned long correction ; } cocci_id@p ;
...
position p;
@@
 struct snd_timer_user * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_timer * timer , unsigned long ticks_left ) ;
...
position p;
@@
 struct snd_timer_info * cocci_id@p ;
...
position p;
@@
 struct snd_timer_gparams cocci_id@p ;
