...
position p;
@@
 struct twl4030_platform_data * cocci_id@p ;
...
position p;
@@
 struct twl_mapping {  unsigned char sid ;  unsigned char base ; } cocci_id@p ;
...
position p;
@@
 const struct regmap_config cocci_id@p [ 4 ] ;
...
position p;
@@
 struct twl_client {  struct i2c_client * client ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct twl_regulator_driver_data cocci_id@p ;
...
position p;
@@
 const struct regmap_config cocci_id@p [ 3 ] ;
...
position p;
@@
 struct of_dev_auxdata cocci_id@p [ ] ;
...
typedef bool,u32;
@@
 struct twl_private {  bool ready ;  u32 twl_idcode ;  unsigned int twl_id ;  struct twl_mapping * twl_map ;  struct twl_client * twl_modules ; } cocci_id@p ;
...
position p;
@@
 struct twl4030_clock_init_data * cocci_id@p ;
