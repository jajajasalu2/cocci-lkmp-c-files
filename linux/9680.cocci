...
position p;
@@
 const struct b43_lcntab_tx_gain_tbl_entry cocci_id@p [ B43_LCNTAB_TX_GAIN_SIZE ] ;
...
typedef u8;
@@
 struct b43_lcntab_tx_gain_tbl_entry {  u8 gm ;  u8 pga ;  u8 pad ;  u8 dac ;  u8 bb_mult ; } cocci_id@p ;
...
position p;
@@
 const struct b43_lcntab_tx_gain_tbl_entry * cocci_id@p ;
