...
position p;
@@
 struct crypto_authenc_esn_ctx {  unsigned int reqoff ;  struct crypto_ahash * auth ;  struct crypto_skcipher * enc ;  struct crypto_sync_skcipher * null ; } cocci_id@p ;
...
position p;
@@
 struct authenc_esn_request_ctx {  struct scatterlist src [ 2 ] ;  struct scatterlist dst [ 2 ] ;  char tail [ ] ; } cocci_id@p ;
...
position p;
@@
 struct crypto_authenc_esn_ctx cocci_id@p ;
...
position p;
@@
 struct authenc_esn_request_ctx cocci_id@p ;
...
position p;
@@
 struct authenc_esn_instance_ctx {  struct crypto_ahash_spawn auth ;  struct crypto_skcipher_spawn enc ; } cocci_id@p ;
...
position p;
@@
 struct authenc_esn_instance_ctx * cocci_id@p ;
