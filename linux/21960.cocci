...
position p;
@@
 struct pcim_iomap_devres * cocci_id@p ;
...
position p;
@@
 enum devm_ioremap_type cocci_id@p ;
...
position p;
@@
 enum devm_ioremap_type { DEVM_IOREMAP = 0 , DEVM_IOREMAP_NC , DEVM_IOREMAP_UC , DEVM_IOREMAP_WC , } cocci_id@p ;
...
position p;
@@
 struct pcim_iomap_devres {  void __iomem * table [ PCIM_IOMAP_MAX ] ; } cocci_id@p ;
