...
@@
 struct rme32 {  spinlock_t lock ;  int irq ;  unsigned long port ;  void __iomem * iobase ;  u32 wcreg ;  u32 wcreg_spdif ;  u32 wcreg_spdif_stream ;  u32 rcreg ;  u8 rev ;  struct snd_pcm_substream * playback_substream ;  struct snd_pcm_substream * capture_substream ;  int playback_frlog ;  int capture_frlog ;  size_t playback_periodsize ;  size_t capture_periodsize ;  unsigned int fullduplex_mode ;  int running ;  struct snd_pcm_indirect playback_pcm ;  struct snd_pcm_indirect capture_pcm ;  struct snd_card * card ;  struct snd_pcm * spdif_pcm ;  struct snd_pcm * adat_pcm ;  struct pci_dev * pci ;  struct snd_kcontrol * spdif_ctl ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_card * card , struct rme32 * rme32 ) ;
...
position p;
@@
 void cocci_id@p ( struct rme32 * rme32 ) ;
