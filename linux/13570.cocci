...
typedef u8;
@@
 struct ttusbdecfe_state {  const struct ttusbdecfe_config * config ;  struct dvb_frontend frontend ;  u8 hi_band ;  u8 voltage ; } cocci_id@p ;
...
position p;
@@
 struct ttusbdecfe_state * cocci_id@p ;
