...
typedef u32;
@@
 u32 ( * cocci_id@p ) ( void __iomem * const regs ) ;
...
position p;
@@
 struct intel_pipe_crc * cocci_id@p ;
...
position p;
@@
 struct drm_i915_private * constcocci_id ;
...
typedef bool,u32;
@@
 bool cocci_id@p ( enum hpd_pin pin , u32 val ) ;
...
typedef u32;
@@
 const u32 cocci_id@p [ HPD_NUM_PINS ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( void __iomem * const regs ) ;
...
position p;
@@
 long_pulse_detect_func cocci_id@p ;
