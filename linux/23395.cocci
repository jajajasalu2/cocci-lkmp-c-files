...
position p;
@@
 enum da7218_micbias_voltage cocci_id@p ;
...
position p;
@@
 enum da7218_dmic_clk_rate cocci_id@p ;
...
position p;
@@
 enum da7218_hpldet_jack_debounce cocci_id@p ;
...
position p;
@@
 enum da7218_hpldet_jack_rate cocci_id@p ;
...
position p;
@@
 enum da7218_mic_amp_in_sel cocci_id@p ;
...
position p;
@@
 struct da7218_pdata * cocci_id@p ;
...
position p;
@@
 enum da7218_hpldet_jack_thr cocci_id@p ;
...
position p;
@@
 struct da7218_hpldet_pdata * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ DA7218_NUM_SUPPLIES ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ DA7218_BIQ_CFG_SIZE ] ;
...
position p;
@@
 enum da7218_dmic_data_sel cocci_id@p ;
...
position p;
@@
 enum da7218_dmic_samplephase cocci_id@p ;
