...
position p;
@@
 struct axg_pdm_filters {  struct axg_pdm_hcic hcic ;  struct axg_pdm_hpf hpf ;  struct axg_pdm_lpf lpf [ PDM_LPF_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct axg_pdm_cfg {  const struct axg_pdm_filters * filters ;  unsigned int sys_rate ; } cocci_id@p ;
...
position p;
@@
 struct axg_pdm_hcic {  unsigned int shift ;  unsigned int mult ;  unsigned int steps ;  unsigned int ds ; } cocci_id@p ;
...
position p;
@@
 const struct axg_pdm_hpf * cocci_id@p ;
...
position p;
@@
 struct axg_pdm {  const struct axg_pdm_cfg * cfg ;  struct regmap * map ;  struct clk * dclk ;  struct clk * sysclk ;  struct clk * pclk ; } cocci_id@p ;
...
position p;
@@
 const struct axg_pdm_filters cocci_id@p ;
...
position p;
@@
 struct axg_pdm_hpf {  unsigned int out_factor ;  unsigned int steps ; } cocci_id@p ;
...
position p;
@@
 const struct axg_pdm_lpf * cocci_id@p ;
...
position p;
@@
 struct axg_pdm_lpf {  unsigned int ds ;  unsigned int round_mode ;  const unsigned int * tap ;  unsigned int tap_num ; } cocci_id@p ;
...
position p;
@@
 const struct axg_pdm_hcic * cocci_id@p ;
...
position p;
@@
 const struct axg_pdm_cfg cocci_id@p ;
