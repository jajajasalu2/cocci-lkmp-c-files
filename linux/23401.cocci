...
position p;
@@
 struct max98088_pdata * cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( max98088_hp_tlv , 
							      0 , 6 , 
...
position p;
@@
 const  cocci_id@p ( max98088_spk_tlv , 
							      0 , 6 , 
...
position p;
@@
 struct max98088_eq_cfg * cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( max98088_micboost_tlv , 
							      0 , 1 , 
...
position p;
@@
 struct max98088_priv cocci_id@p ;
...
position p;
@@
 struct max98088_cdata {  unsigned int rate ;  unsigned int fmt ;  int eq_sel ; } cocci_id@p ;
...
position p;
@@
 enum max98088_type { MAX98088 , MAX98089 , } cocci_id@p ;
...
typedef u8;
@@
 struct max98088_priv {  struct regmap * regmap ;  enum max98088_type devtype ;  struct max98088_pdata * pdata ;  struct clk * mclk ;  unsigned int sysclk ;  struct max98088_cdata dai [ 2 ] ;  int eq_textcnt ;  const char * * eq_texts ;  struct soc_enum eq_enum ;  u8 ina_state ;  u8 inb_state ;  unsigned int ex_mode ;  unsigned int digmic ;  unsigned int mic1pre ;  unsigned int mic2pre ;  unsigned int extmic_mode ; } cocci_id@p ;
...
position p;
@@
 struct max98088_cdata * cocci_id@p ;
