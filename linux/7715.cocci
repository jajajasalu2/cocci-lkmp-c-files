...
typedef dma_addr_t;
@@
 struct sprd_uart_port {  struct uart_port port ;  char name [ 16 ] ;  struct clk * clk ;  struct sprd_uart_dma tx_dma ;  struct sprd_uart_dma rx_dma ;  dma_addr_t pos ;  unsigned char * rx_buf_tail ; } cocci_id@p ;
...
position p;
@@
 struct sprd_uart_port * cocci_id@p [ UART_NR_MAX ] ;
...
position p;
@@
 struct sprd_uart_dma * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,dma_cookie_t,dma_addr_t;
@@
 struct sprd_uart_dma {  struct dma_chan * chn ;  unsigned char * virt ;  dma_addr_t phys_addr ;  dma_cookie_t cookie ;  u32 trans_len ;  bool enable ; } cocci_id@p ;
...
position p;
@@
 struct sprd_uart_port * cocci_id@p ;
