...
position p;
@@
 struct vdec_vp9_inst cocci_id@p ;
...
position p;
@@
 struct vp9_dram_buf {  unsigned long va ;  unsigned long pa ;  unsigned int sz ;  unsigned int padding ; } cocci_id@p ;
...
position p;
@@
 struct vp9_ref_cnt_buf {  struct vp9_fb_info buf ;  unsigned int ref_cnt ; } cocci_id@p ;
...
position p;
@@
 struct vdec_vp9_vsi {  unsigned char sf_bs_buf [ VP9_SUPER_FRAME_BS_SZ ] ;  struct vp9_sf_ref_fb sf_ref_fb [ VP9_MAX_FRM_BUF_NUM - 1 ] ;  int sf_next_ref_fb_idx ;  unsigned int sf_frm_cnt ;  unsigned int sf_frm_offset [ VP9_MAX_FRM_BUF_NUM - 1 ] ;  unsigned int sf_frm_sz [ VP9_MAX_FRM_BUF_NUM - 1 ] ;  unsigned int sf_frm_idx ;  unsigned int sf_init ;  struct vdec_fb fb ;  struct mtk_vcodec_mem bs ;  struct vdec_fb cur_fb ;  unsigned int pic_w ;  unsigned int pic_h ;  unsigned int buf_w ;  unsigned int buf_h ;  unsigned int buf_sz_y_bs ;  unsigned int buf_sz_c_bs ;  unsigned int buf_len_sz_y ;  unsigned int buf_len_sz_c ;  unsigned int profile ;  unsigned int show_frame ;  unsigned int show_existing_frame ;  unsigned int frm_to_show_idx ;  unsigned int refresh_frm_flags ;  unsigned int resolution_changed ;  struct vp9_ref_cnt_buf frm_bufs [ VP9_MAX_FRM_BUF_NUM ] ;  int ref_frm_map [ MAX_NUM_REF_FRAMES ] ;  unsigned int new_fb_idx ;  unsigned int frm_num ;  struct vp9_dram_buf mv_buf ;  struct vp9_ref_buf frm_refs [ REFS_PER_FRAME ] ;  struct vp9_dram_buf seg_id_buf ; } cocci_id@p ;
...
position p;
@@
 struct vdec_vp9_vsi * cocci_id@p ;
...
position p;
@@
 struct vp9_ref_buf {  struct vp9_fb_info * buf ;  unsigned int idx ;  unsigned int reserved [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 struct vp9_sf_ref_fb cocci_id@p ;
...
position p;
@@
 struct vp9_fb_info {  struct vdec_fb * fb ;  unsigned int reserved [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct vp9_sf_ref_fb {  struct vdec_fb fb ;  int used ;  int padding ; } cocci_id@p ;
