...
position p;
@@
 const struct da8xx_cfgchip_gate_clk_info cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device * dev , struct regmap * regmap ) ;
...
position p;
@@
 struct da8xx_cfgchip_mux_clk cocci_id@p ;
...
position p;
@@
 struct da8xx_usb0_clk48 {  struct clk_hw hw ;  struct clk * fck ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct da8xx_usb0_clk48 cocci_id@p ;
...
position p;
@@
 const struct da8xx_cfgchip_mux_clk_info * cocci_id@p ;
...
position p;
@@
 struct da8xx_cfgchip_gate_clk * cocci_id@p ;
...
typedef u32;
@@
 struct da8xx_cfgchip_mux_clk_info {  const char * name ;  const char * parent0 ;  const char * parent1 ;  u32 cfgchip ;  u32 bit ; } cocci_id@p ;
...
position p;
@@
 struct da8xx_usb1_clk48 cocci_id@p ;
...
typedef u32;
@@
 struct da8xx_cfgchip_gate_clk_info {  const char * name ;  u32 cfgchip ;  u32 bit ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 struct da8xx_usb1_clk48 {  struct clk_hw hw ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct da8xx_cfgchip_clk_platform_data * cocci_id@p ;
...
typedef u32;
@@
 struct da8xx_cfgchip_gate_clk {  struct clk_hw hw ;  struct regmap * regmap ;  u32 reg ;  u32 mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct da8xx_cfgchip_mux_clk {  struct clk_hw hw ;  struct regmap * regmap ;  u32 reg ;  u32 mask ; } cocci_id@p ;
