...
position p;
@@
 const struct xt_conntrack_mtinfo2 * cocci_id@p ;
...
position p;
@@
 const struct xt_conntrack_mtinfo3 * cocci_id@p ;
...
position p;
@@
 struct xt_conntrack_mtinfo1 cocci_id@p ;
...
position p;
@@
 const struct xt_conntrack_mtinfo1 * cocci_id@p ;
...
position p;
@@
 struct xt_conntrack_mtinfo3 cocci_id@p ;
...
position p;
@@
 struct xt_conntrack_mtinfo2 cocci_id@p ;
