...
position p;
@@
 const struct {  enum iscsi_ipaddress_state value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  int value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 enum iscsi_uevent_e cocci_id@p ;
...
position p;
@@
 struct iscsi_bsg_host_vendor cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct device * dev , struct va_format * ) ;
...
position p;
@@
 enum iscsi_ipaddress_state cocci_id@p ;
...
position p;
@@
 struct iscsi_internal * cocci_id@p ;
...
position p;
@@
 struct iscsi_scan_data cocci_id@p ;
...
position p;
@@
 struct iscsi_uevent cocci_id@p ;
...
position p;
@@
 const struct {  enum iscsi_router_state value ;  char * name ; } cocci_id@p [ ] ;
...
typedef u64;
@@
 struct iscsi_scan_data {  unsigned int channel ;  unsigned int id ;  u64 lun ;  enum scsi_scan_mode rescan ; } cocci_id@p ;
...
position p;
@@
 enum iscsi_conn_state cocci_id@p ;
...
position p;
@@
 const struct {  enum iscsi_port_state value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct iscsi_stats_custom cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct iscsi_cls_session * ) ;
...
position p;
@@
 enum iscsi_router_state cocci_id@p ;
...
position p;
@@
 const struct {  enum iscsi_port_speed value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct iscsi_internal {  struct scsi_transport_template t ;  struct iscsi_transport * iscsi_transport ;  struct list_head list ;  struct device dev ;  struct transport_container conn_cont ;  struct transport_container session_cont ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device * dev , void * data ) ;
...
position p;
@@
 const struct {  enum iscsi_discovery_parent_type value ;  char * name ; } cocci_id@p [ ] ;
