...
typedef u32;
@@
 struct brcmstb_waketmr {  struct rtc_device * rtc ;  struct device * dev ;  void __iomem * base ;  int irq ;  struct notifier_block reboot_notifier ;  struct clk * clk ;  u32 rate ; } cocci_id@p ;
...
typedef u32;
@@
 struct wktmr_time {  u32 sec ;  u32 pre ; } cocci_id@p ;
...
position p;
@@
 struct brcmstb_waketmr cocci_id@p ;
