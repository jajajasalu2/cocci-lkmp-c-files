...
position p;
@@
 const struct dcn10_dwbc_mask * cocci_id@p ;
...
position p;
@@
 const struct dcn10_dwbc_shift * cocci_id@p ;
...
position p;
@@
 const struct dcn10_dwbc_registers * cocci_id@p ;
