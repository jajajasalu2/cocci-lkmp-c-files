...
position p;
@@
 struct esp_driver_ops cocci_id@p ;
...
position p;
@@
 struct mac_esp_priv cocci_id@p ;
...
position p;
@@
 struct mac_esp_priv {  struct esp * esp ;  void __iomem * pdma_regs ;  void __iomem * pdma_io ; } cocci_id@p ;
