...
position p;
@@
 const struct chv_pin_context * cocci_id@p ;
...
position p;
@@
 struct chv_gpio_pinrange {  unsigned int base ;  unsigned int npins ; } cocci_id@p ;
...
position p;
@@
 const struct chv_gpio_pinrange * cocci_id@p ;
...
position p;
@@
 const struct chv_community * cocci_id@p [ ] ;
...
position p;
@@
 struct chv_pin_context * cocci_id@p ;
...
position p;
@@
 const struct chv_alternate_function cocci_id@p [ ] ;
...
position p;
@@
 const struct chv_pingroup cocci_id@p [ ] ;
...
position p;
@@
 const struct intel_function cocci_id@p [ ] ;
...
typedef u32;
@@
 struct chv_pin_context {  u32 padctrl0 ;  u32 padctrl1 ; } cocci_id@p ;
...
typedef u32;
@@
 struct chv_pinctrl {  struct device * dev ;  struct pinctrl_desc pctldesc ;  struct pinctrl_dev * pctldev ;  struct gpio_chip chip ;  struct irq_chip irqchip ;  void __iomem * regs ;  unsigned int irq ;  unsigned int intr_lines [ 16 ] ;  const struct chv_community * community ;  u32 saved_intmask ;  struct chv_pin_context * saved_pin_context ; } cocci_id@p ;
...
position p;
@@
 struct chv_pingroup {  const char * name ;  const unsigned int * pins ;  size_t npins ;  struct chv_alternate_function altfunc ;  const struct chv_alternate_function * overrides ;  size_t noverrides ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct chv_alternate_function {  unsigned int pin ;  u8 mode ;  bool invert_oe ; } cocci_id@p ;
