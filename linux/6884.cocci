...
position p;
@@
 enum blogic_msglevel cocci_id@p ;
...
position p;
@@
 enum blogic_setccb_fmt cocci_id@p ;
...
position p;
@@
 struct bios_diskparam * cocci_id@p ;
...
position p;
@@
 struct blogic_ext_setup cocci_id@p ;
...
position p;
@@
 struct blogic_probe_options cocci_id@p ;
...
position p;
@@
 union blogic_int_reg cocci_id@p ;
...
position p;
@@
 struct blogic_drvr_options cocci_id@p [ BLOGIC_MAX_ADAPTERS ] ;
...
position p;
@@
 char cocci_id@p [ BLOGIC_LINEBUF_SIZE ] ;
...
position p;
@@
 struct blogic_tgt_flags * cocci_id@p ;
...
position p;
@@
 enum blogic_queuetag cocci_id@p ;
...
position p;
@@
 struct blogic_tgt_stats * cocci_id@p ;
...
position p;
@@
 enum blogic_tgt_status cocci_id@p ;
...
position p;
@@
 struct blogic_inbox * cocci_id@p ;
...
position p;
@@
 struct blogic_outbox cocci_id@p ;
...
position p;
@@
 struct blogic_fetch_localram cocci_id@p ;
...
position p;
@@
 struct blogic_autoscsi_byte45 cocci_id@p ;
...
position p;
@@
 enum blogic_isa_ioport cocci_id@p ;
...
position p;
@@
 struct blogic_drvr_options cocci_id@p ;
...
position p;
@@
 struct blogic_adapter cocci_id@p ;
...
position p;
@@
 struct blogic_probeinfo * cocci_id@p ;
...
position p;
@@
 struct blogic_adapter_info cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BLOGIC_MAXDEV + 1 ] ;
...
position p;
@@
 struct blogic_autoscsi cocci_id@p ;
...
position p;
@@
 struct blogic_probeinfo cocci_id@p [ BLOGIC_MAX_ADAPTERS ] ;
...
position p;
@@
 struct scsi_inquiry * cocci_id@p ;
...
position p;
@@
 union blogic_geo_reg cocci_id@p ;
...
position p;
@@
 struct blogic_bios_drvmap cocci_id@p ;
...
position p;
@@
 union blogic_stat_reg cocci_id@p ;
...
position p;
@@
 struct blogic_setup_info cocci_id@p ;
...
position p;
@@
 struct blogic_board_id cocci_id@p ;
...
position p;
@@
 struct blogic_config cocci_id@p ;
...
position p;
@@
 enum blogic_adapter_status cocci_id@p ;
...
position p;
@@
 struct blogic_extmbox_req cocci_id@p ;
...
position p;
@@
 enum blogic_cmplt_code cocci_id@p ;
...
position p;
@@
 struct blogic_global_options cocci_id@p ;
