...
typedef u32;
@@
 struct qcom_wdt {  struct watchdog_device wdd ;  unsigned long rate ;  void __iomem * base ;  const u32 * layout ; } cocci_id@p ;
...
position p;
@@
 enum wdt_reg { WDT_RST , WDT_EN , WDT_STS , WDT_BARK_TIME , WDT_BITE_TIME , } cocci_id@p ;
