...
position p;
@@
 enum chips { tmp401 , tmp411 , tmp431 , tmp432 , tmp435 , tmp461 , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct tmp401_data {  struct i2c_client * client ;  const struct attribute_group * groups [ 3 ] ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  enum chips kind ;  unsigned int update_interval ;  u8 status [ 4 ] ;  u8 config ;  u16 temp [ 7 ] [ 3 ] ;  u8 temp_crit_hyst ; } cocci_id@p ;
