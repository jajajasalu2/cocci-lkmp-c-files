...
position p;
@@
 struct auto_pin_cfg_item * cocci_id@p ;
...
position p;
@@
 struct auto_out_pin cocci_id@p [ ARRAY_SIZE ( cfg -> speaker_pins ) ] ;
...
position p;
@@
 const struct auto_out_pin * cocci_id@p ;
...
position p;
@@
 const struct auto_pin_cfg_item * cocci_id@p ;
...
position p;
@@
 struct auto_out_pin * cocci_id@p ;
...
typedef hda_nid_t;
@@
 struct auto_out_pin {  hda_nid_t pin ;  short seq ; } cocci_id@p ;
...
position p;
@@
 struct auto_out_pin cocci_id@p [ ARRAY_SIZE ( cfg -> hp_pins ) ] ;
...
position p;
@@
 struct auto_out_pin cocci_id@p [ ARRAY_SIZE ( cfg -> line_out_pins ) ] ;
