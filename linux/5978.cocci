...
typedef u16;
@@
 struct u300_pmx_mask {  u16 mask ;  u16 bits ; } cocci_id@p ;
...
position p;
@@
 const struct u300_pmx_mask cocci_id@p [ ] ;
...
position p;
@@
 struct u300_pmx_func {  const char * name ;  const char * const * groups ;  const unsigned num_groups ;  const struct u300_pmx_mask * mask ; } cocci_id@p ;
...
position p;
@@
 const struct u300_pmx_func cocci_id@p [ ] ;
...
position p;
@@
 const struct u300_pin_group cocci_id@p [ ] ;
...
position p;
@@
 struct u300_pmx {  struct device * dev ;  struct pinctrl_dev * pctl ;  void __iomem * virtbase ; } cocci_id@p ;
...
position p;
@@
 struct u300_pin_group {  const char * name ;  const unsigned int * pins ;  const unsigned num_pins ; } cocci_id@p ;
