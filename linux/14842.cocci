...
typedef u8,u16;
@@
 struct clk_sysctrl {  struct clk_hw hw ;  struct device * dev ;  u8 parent_index ;  u16 reg_sel [ SYSCTRL_MAX_NUM_PARENTS ] ;  u8 reg_mask [ SYSCTRL_MAX_NUM_PARENTS ] ;  u8 reg_bits [ SYSCTRL_MAX_NUM_PARENTS ] ;  unsigned long rate ;  unsigned long enable_delay_us ; } cocci_id@p ;
