...
position p;
@@
 struct altera_ci_state {  struct fpga_internal * internal ;  struct dvb_ca_en50221 ca ;  int status ;  int nr ; } cocci_id@p ;
...
position p;
@@
 struct fpga_internal * cocci_id@p ;
...
position p;
@@
 struct netup_hw_pid_filter cocci_id@p ;
...
position p;
@@
 struct fpga_internal {  void * dev ;  struct mutex fpga_mutex ;  struct netup_hw_pid_filter * pid_filt [ 2 ] ;  struct altera_ci_state * state [ 2 ] ;  struct work_struct work ;  int ( * fpga_rw ) ( void * dev , int flag , int data , int rw ) ;  int cis_used ;  int filts_used ;  int strt_wrk ; } cocci_id@p ;
...
position p;
@@
 struct altera_ci_state * cocci_id@p ;
...
position p;
@@
 struct netup_hw_pid_filter {  struct fpga_internal * internal ;  struct dvb_demux * demux ;  int ( * start_feed ) ( struct dvb_demux_feed * feed ) ;  int ( * stop_feed ) ( struct dvb_demux_feed * feed ) ;  int status ;  int nr ; } cocci_id@p ;
...
position p;
@@
 struct fpga_inode {  struct fpga_internal * internal ;  struct fpga_inode * next_inode ; } cocci_id@p ;
