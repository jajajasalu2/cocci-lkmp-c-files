...
position p;
@@
 struct mux_pkt_header * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * data , int len , int tty_index , struct tty_dev * tty_dev , int complete ) ;
