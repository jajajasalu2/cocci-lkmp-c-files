...
position p;
@@
 const struct err_reg_info cocci_id@p [ NUM_VARIOUS ] ;
...
typedef u32;
@@
 const char * cocci_id@p ( struct hfi1_pportdata * ppd , u32 state ) ;
...
typedef u8,u32;
@@
 struct rsm_rule_data {  u8 offset ;  u8 pkt_type ;  u32 field1_off ;  u32 field2_off ;  u32 index1_off ;  u32 index1_width ;  u32 index2_off ;  u32 index2_width ;  u32 mask1 ;  u32 value1 ;  u32 mask2 ;  u32 value2 ; } cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u8 * ldr ) ;
...
typedef u32;
@@
 const char * cocci_id@p ( u32 state ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u8 rule_index ) ;
...
typedef u64;
@@
 int cocci_id@p ( struct hfi1_devdata * dd , u64 * data ) ;
...
typedef u64;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , unsigned int context , u64 err_status ) ;
...
position p;
@@
 struct rsm_map_table * cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct hfi1_pportdata * ppd , u16 link_width ) ;
...
position p;
@@
 const struct hfi1_devdata * cocci_id@p ;
...
typedef u8,u16;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u16 * device_id , u8 * device_rev ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct hfi1_devdata * dd , u32 chip_lstate ) ;
...
position p;
@@
 struct hfi1_ctxtdata * cocci_id@p ;
...
typedef u8,u64;
@@
 struct cntr_entry {  char * name ;  u64 csr ;  int offset ;  u8 flags ;  u64 ( * rw_cntr ) ( const struct cntr_entry * , void * context , int vl , int mode , u64 data ) ; } cocci_id@p ;
...
position p;
@@
 struct send_context_info * cocci_id@p ;
...
typedef u64,u32;
@@
 struct err_reg_info {  u32 status ;  u32 clear ;  u32 mask ;  void ( * handler ) ( struct hfi1_devdata * dd , u32 source , u64 reg ) ;  const char * desc ; } cocci_id@p ;
...
position p;
@@
 struct hfi1_asic_data * cocci_id@p ;
...
position p;
@@
 const struct err_reg_info * cocci_id@p ;
...
typedef u64,u32;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u32 unused , u64 reg ) ;
...
position p;
@@
 const struct is_table * cocci_id@p ;
...
position p;
@@
 struct cntr_entry cocci_id@p [ PORT_CNTR_LAST ] ;
...
typedef u8;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u8 * power_management , u8 * continuous ) ;
...
typedef u16;
@@
 const struct link_bits {  u16 from ;  u16 to ; } cocci_id@p [ ] ;
...
position p;
@@
 struct cntr_entry cocci_id@p [ DEV_CNTR_LAST ] ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_pportdata * ppd , int msecs ) ;
...
position p;
@@
 const struct err_reg_info cocci_id@p [ NUM_DC_ERRS ] ;
...
typedef u8;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u8 * enable_lane_rx ) ;
...
typedef u64,u32;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u32 source , u64 reg ) ;
...
position p;
@@
 struct ib_vl_weight_elem * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u8 * pdrrc ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct hfi1_devdata * dd , u8 * enable_lane_tx , u8 * tx_polarity_inversion , u8 * rx_polarity_inversion , u8 * max_rate ) ;
...
position p;
@@
 struct rsm_rule_data cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ CCE_NUM_INT_CSRS ] ;
...
position p;
@@
 void cocci_id@p ( struct hfi1_pportdata * ppd ) ;
...
typedef u64;
@@
 struct rsm_map_table {  u64 map [ NUM_MAP_REGS ] ;  unsigned int used ; } cocci_id@p ;
...
position p;
@@
 const struct err_reg_info cocci_id@p [ NUM_MISC_ERRS ] ;
...
position p;
@@
 void cocci_id@p ( struct hfi1_devdata * dd ) ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_devdata * dd , int wait_ms ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct hfi1_pportdata * ppd , u32 state , int msecs ) ;
...
typedef u64,u32;
@@
 int cocci_id@p ( struct hfi1_devdata * dd , u32 type , u64 in_data , u64 * out_data ) ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_devdata * dd ) ;
...
typedef u64,u32,u16;
@@
 struct flag_table {  u64 flag ;  char * str ;  u16 extra ;  u16 unused0 ;  u32 unused1 ; } cocci_id@p ;
...
position p;
@@
 const struct cntr_entry * cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct hfi1_devdata * dd , u64 state ) ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_devdata * dd , unsigned int * mp , unsigned int * np ) ;
...
position p;
@@
 struct send_context * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct hfi1_pportdata * ppd , u32 state ) ;
...
typedef u8,u16;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u8 * remote_tx_rate , u16 * link_widths ) ;
...
position p;
@@
 struct vl_arb_cache * cocci_id@p ;
...
typedef u8,u16;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u8 * misc_bits , u8 * flag_bits , u16 * link_widths ) ;
...
typedef u8,u16;
@@
 void cocci_id@p ( struct hfi1_devdata * dd , u8 * vau , u8 * z , u8 * vcu , u16 * vl15buf , u8 * crc_sizes ) ;
