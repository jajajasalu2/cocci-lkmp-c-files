...
position p;
@@
 struct bpf_stack_map cocci_id@p ;
...
position p;
@@
 struct stack_map_bucket cocci_id@p ;
...
position p;
@@
 struct stack_map_irq_work {  struct irq_work irq_work ;  struct rw_semaphore * sem ; } cocci_id@p ;
...
typedef u32;
@@
 struct bpf_stack_map {  struct bpf_map map ;  void * elems ;  struct pcpu_freelist freelist ;  u32 n_buckets ;  struct stack_map_bucket * buckets [ ] ; } cocci_id@p ;
...
position p;
@@
 struct bpf_stack_build_id cocci_id@p ;
...
position p;
@@
 struct stack_map_irq_work cocci_id@p ;
...
typedef u64,u32;
@@
 struct stack_map_bucket {  struct pcpu_freelist_node fnode ;  u32 hash ;  u32 nr ;  u64 data [ ] ; } cocci_id@p ;
