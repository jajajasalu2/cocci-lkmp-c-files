...
position p;
@@
 struct {  struct nv_device_info_v1 m ;  struct {  struct nv_device_info_v1_data channels ; } v ; } cocci_id@p ;
...
position p;
@@
 struct nv03_channel_dma_v0 cocci_id@p ;
...
position p;
@@
 union {  struct nv50_channel_gpfifo_v0 nv50 ;  struct fermi_channel_gpfifo_v0 fermi ;  struct kepler_channel_gpfifo_a_v0 kepler ;  struct volta_channel_gpfifo_a_v0 volta ; } cocci_id@p ;
