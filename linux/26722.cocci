...
position p;
@@
 void cocci_id@p ( struct metapage * mp ) ;
...
position p;
@@
 void cocci_id@p ( struct inode * ip , struct maplock * maplock , struct tblock * tblk ) ;
...
@@
 struct {  int freetid ;  int freelock ;  wait_queue_head_t freewait ;  wait_queue_head_t freelockwait ;  wait_queue_head_t lowlockwait ;  int tlocksInUse ;  spinlock_t LazyLock ;  struct list_head unlock_queue ;  struct list_head anon_list ;  struct list_head anon_list2 ; } cocci_id@p ;
...
typedef lid_t,tid_t;
@@
 struct {  tid_t maxtid ;  lid_t maxlid ;  int ntid ;  int nlid ;  int waitlock ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct jfs_log * log , struct tblock * tblk , struct lrd * lrd , struct tlock * tlck ) ;
...
position p;
@@
 struct {  uint txBegin ;  uint txBegin_barrier ;  uint txBegin_lockslow ;  uint txBegin_freetid ;  uint txBeginAnon ;  uint txBeginAnon_barrier ;  uint txBeginAnon_lockslow ;  uint txLockAlloc ;  uint txLockAlloc_freelock ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tblock * tblk ) ;
...
position p;
@@
 int cocci_id@p ( struct jfs_log * log , struct tblock * tblk , struct lrd * lrd , struct tlock * tlck , struct commit * cd ) ;
...
position p;
@@
 void cocci_id@p ( struct jfs_log * log , struct tblock * tblk , struct lrd * lrd , struct tlock * tlck ) ;
...
position p;
@@
 int cocci_id@p ( struct jfs_log * log , struct tblock * tblk , struct commit * cd ) ;
