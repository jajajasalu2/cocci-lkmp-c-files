...
position p;
@@
 const struct armada_variant * cocci_id@p ;
...
position p;
@@
 struct armada_gem_object * cocci_id@p ;
...
position p;
@@
 struct armada_clk_result * cocci_id@p ;
...
position p;
@@
 const struct armada_clocking_params * cocci_id@p ;
...
position p;
@@
 struct armada_regs cocci_id@p [ 17 ] ;
