...
position p;
@@
 struct thunderx_l2c {  void __iomem * regs ;  struct pci_dev * pdev ;  struct edac_device_ctl_info * edac_dev ;  struct dentry * debugfs ;  int index ;  struct msix_entry msix_ent ;  struct l2c_err_ctx err_ctx [ RING_ENTRIES ] ;  unsigned long ring_head ;  unsigned long ring_tail ; } cocci_id@p ;
...
position p;
@@
 struct thunderx_ocx cocci_id@p ;
...
position p;
@@
 const struct error_descr cocci_id@p [ ] ;
...
position p;
@@
 struct debugfs_entry * * cocci_id@p ;
...
typedef u64;
@@
 struct lmc_err_ctx {  u64 reg_int ;  u64 reg_fadr ;  u64 reg_nxm_fadr ;  u64 reg_scram_fadr ;  u64 reg_ecc_synd ; } cocci_id@p ;
...
typedef u64;
@@
 struct l2c_err_ctx {  char * reg_ext_name ;  u64 reg_int ;  u64 reg_ext ; } cocci_id@p ;
...
position p;
@@
 struct thunderx_l2c * cocci_id@p ;
...
position p;
@@
 struct ocx_com_err_ctx * cocci_id@p ;
...
position p;
@@
 enum { ERR_CORRECTED = 1 , ERR_UNCORRECTED = 2 , ERR_UNKNOWN = 3 , } cocci_id@p ;
...
typedef umode_t;
@@
 struct debugfs_entry {  const char * name ;  umode_t mode ;  const struct file_operations fops ; } cocci_id@p ;
...
typedef u64;
@@
 struct ocx_link_err_ctx {  u64 reg_com_link_int ;  int link ; } cocci_id@p ;
...
position p;
@@
 struct thunderx_lmc cocci_id@p ;
...
typedef u64;
@@
 struct error_syndrome {  u64 reg [ MAX_SYNDROME_REGS ] ; } cocci_id@p ;
...
position p;
@@
 struct ocx_link_err_ctx * cocci_id@p ;
...
typedef u64;
@@
 struct ocx_com_err_ctx {  u64 reg_com_int ;  u64 reg_lane_int [ OCX_RX_LANES ] ;  u64 reg_lane_stat11 [ OCX_RX_LANES ] ; } cocci_id@p ;
...
position p;
@@
 struct edac_mc_layer cocci_id@p ;
...
position p;
@@
 struct edac_device_ctl_info * cocci_id@p ;
...
typedef u64;
@@
 struct error_descr {  int type ;  u64 mask ;  char * descr ; } cocci_id@p ;
