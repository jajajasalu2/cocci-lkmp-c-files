...
position p;
@@
 struct pmbus_samples_reg * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct pmbus_sensor {  struct pmbus_sensor * next ;  char name [ PMBUS_NAME_SIZE ] ;  struct device_attribute attribute ;  u8 page ;  u16 reg ;  enum pmbus_sensor_classes class ;  bool update ;  bool convert ;  int data ; } cocci_id@p ;
...
position p;
@@
 struct pmbus_boolean cocci_id@p ;
...
position p;
@@
 const struct pmbus_sensor_attr * cocci_id@p ;
...
position p;
@@
 struct pmbus_samples_reg {  int page ;  struct pmbus_samples_attr * attr ;  struct device_attribute dev_attr ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct _pmbus_status {  u32 func ;  u16 base ;  u16 reg ; } cocci_id@p [ ] ;
...
typedef bool,u16;
@@
 struct pmbus_limit_attr {  u16 reg ;  u16 sbit ;  bool update ;  bool low ;  const char * attr ;  const char * alarm ; } cocci_id@p ;
...
position p;
@@
 struct _pmbus_status * cocci_id@p ;
...
position p;
@@
 struct pmbus_samples_attr * cocci_id@p ;
...
position p;
@@
 struct pmbus_boolean {  char name [ PMBUS_NAME_SIZE ] ;  struct sensor_device_attribute attribute ;  struct pmbus_sensor * s1 ;  struct pmbus_sensor * s2 ; } cocci_id@p ;
...
position p;
@@
 enum pmbus_fan_mode cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct i2c_client * client , int page , int reg ) ;
...
position p;
@@
 const struct pmbus_platform_data * cocci_id@p ;
...
@@
 struct pmbus_sensor_attr {  u16 reg ;  u16 gbit ;  u8 nlimit ;  enum pmbus_sensor_classes class ;  const char * label ;  bool paged ;  bool update ;  bool compare ;  u32 func ;  u32 sfunc ;  int sbase ;  const struct pmbus_limit_attr * limit ; } cocci_id@p ;
...
position p;
@@
 const struct pmbus_limit_attr * cocci_id@p ;
...
typedef u8;
@@
 struct pmbus_debugfs_entry {  struct i2c_client * client ;  u8 page ;  u8 reg ; } cocci_id@p ;
...
position p;
@@
 const struct pmbus_driver_info * cocci_id@p ;
...
position p;
@@
 struct pmbus_sensor cocci_id@p ;
...
position p;
@@
 enum pmbus_sensor_classes cocci_id@p ;
...
position p;
@@
 const struct regulator_ops cocci_id@p ;
...
typedef u8,bool,u32,u16;
@@
 struct pmbus_data {  struct device * dev ;  struct device * hwmon_dev ;  u32 flags ;  int exponent [ PMBUS_PAGES ] ;  const struct pmbus_driver_info * info ;  int max_attributes ;  int num_attributes ;  struct attribute_group group ;  const struct attribute_group * * groups ;  struct dentry * debugfs ;  struct pmbus_sensor * sensors ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  u16 status [ PB_NUM_STATUS_REG ] ;  bool has_status_word ;  int ( * read_status ) ( struct i2c_client * client , int page ) ;  u8 currpage ; } cocci_id@p ;
...
position p;
@@
 struct pmbus_label {  char name [ PMBUS_NAME_SIZE ] ;  struct device_attribute attribute ;  char label [ PMBUS_NAME_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 ssize_t ( * cocci_id@p ) ( struct device * dev , struct device_attribute * attr , char * buf ) ;
...
position p;
@@
 struct pmbus_driver_info * cocci_id@p ;
...
position p;
@@
 struct pmbus_debugfs_entry * cocci_id@p ;
...
position p;
@@
 struct pmbus_samples_attr {  int reg ;  char * name ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PMBUS_NAME_SIZE ] ;
