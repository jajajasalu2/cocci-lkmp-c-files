...
position p;
@@
 LZ4_stream_t_internal * constcocci_id ;
...
position p;
@@
 const dict_directive cocci_id@p ;
...
position p;
@@
 const dictIssue_directive cocci_id@p ;
...
position p;
@@
 LZ4_stream_t_internal * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef LZ4_stream_t;
@@
 LZ4_stream_t cocci_id@p ;
...
position p;
@@
 const limitedOutput_directive cocci_id@p ;
