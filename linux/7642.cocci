...
position p;
@@
 struct hvsi_query_response cocci_id@p ;
...
position p;
@@
 enum HVSI_PROTOCOL_STATE { HVSI_CLOSED , HVSI_WAIT_FOR_VER_RESPONSE , HVSI_WAIT_FOR_VER_QUERY , HVSI_OPEN , HVSI_WAIT_FOR_MCTRL_RESPONSE , HVSI_FSP_DIED , } cocci_id@p ;
...
position p;
@@
 struct hvsi_control * cocci_id@p ;
...
position p;
@@
 struct hvsi_struct cocci_id@p [ MAX_NR_HVSI_CONSOLES ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct hvsi_struct * hp , int state ) ;
...
position p;
@@
 const struct hvsi_header * cocci_id@p ;
...
position p;
@@
 const struct hvsi_struct * cocci_id@p ;
