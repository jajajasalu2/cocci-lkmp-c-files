...
typedef u64;
@@
 u64 cocci_id@p [ 2 ] [ ECC_MAX_DIGITS ] ;
...
position p;
@@
 const struct ecc_point * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ ECC_MAX_DIGITS * 2 ] ;
...
position p;
@@
 const struct ecc_point * cocci_id@p [ 4 ] ;
...
typedef u64;
@@
 struct {  u64 m_low ;  u64 m_high ; } cocci_id@p ;
