...
position p;
@@
 struct atlas7_grp_mux cocci_id@p ;
...
position p;
@@
 struct atlas7_pmx_func {  const char * name ;  const char * const * groups ;  const unsigned num_groups ;  const struct atlas7_grp_mux * grpmux ; } cocci_id@p ;
...
position p;
@@
 struct atlas7_pinctrl_data cocci_id@p ;
...
position p;
@@
 struct pinctrl_pin_desc * cocci_id@p ;
...
position p;
@@
 struct atlas7_pmx_func cocci_id@p [ ] ;
...
position p;
@@
 const struct atlas7_ds_info cocci_id@p [ ] ;
...
typedef u8;
@@
 struct atlas7_pad_status {  u8 func ;  u8 pull ;  u8 dstr ;  u8 reserved ; } cocci_id@p ;
...
position p;
@@
 const struct atlas7_pull_info * cocci_id@p ;
...
typedef u8;
@@
 struct atlas7_pull_info {  u8 pad_type ;  u8 mask ;  const struct map_data * v2s ;  const struct map_data * s2v ; } cocci_id@p ;
...
position p;
@@
 struct atlas7_pin_group {  const char * name ;  const unsigned int * pins ;  const unsigned num_pins ; } cocci_id@p ;
...
typedef u32;
@@
 struct atlas7_ds_ma_info {  u32 ma ;  u32 ds_16st ;  u32 ds_4we ;  u32 ds_0204m31 ;  u32 ds_0610m31 ; } cocci_id@p ;
...
position p;
@@
 const struct atlas7_grp_mux * cocci_id@p ;
...
position p;
@@
 const struct map_data cocci_id@p [ ] ;
...
typedef u32;
@@
 struct atlas7_pad_mux {  u32 bank ;  u32 pin ;  u32 func ;  u32 dinput_reg ;  u32 dinput_bit ;  u32 dinput_val_reg ;  u32 dinput_val_bit ; } cocci_id@p ;
...
position p;
@@
 struct atlas7_gpio_chip * cocci_id@p ;
...
typedef u8,u32;
@@
 struct atlas7_pad_config {  const u32 id ;  u32 type ;  u32 mux_reg ;  u32 pupd_reg ;  u32 drvstr_reg ;  u32 ad_ctrl_reg ;  u8 mux_bit ;  u8 pupd_bit ;  u8 drvstr_bit ;  u8 ad_ctrl_bit ; } cocci_id@p ;
...
typedef u8;
@@
 struct map_data {  u8 idx ;  u8 data ; } cocci_id@p ;
...
position p;
@@
 enum altas7_pad_type { PAD_T_4WE_PD = 0 , PAD_T_4WE_PU , PAD_T_16ST , PAD_T_M31_0204_PD , PAD_T_M31_0204_PU , PAD_T_M31_0610_PD , PAD_T_M31_0610_PU , PAD_T_AD , } cocci_id@p ;
...
position p;
@@
 struct dt_params {  const char * property ;  int value ; } cocci_id@p ;
...
position p;
@@
 const struct pinctrl_ops cocci_id@p ;
...
position p;
@@
 struct atlas7_pad_status * cocci_id@p ;
...
position p;
@@
 struct atlas7_pad_config * cocci_id@p ;
...
position p;
@@
 struct atlas7_gpio_bank * cocci_id@p ;
...
position p;
@@
 const struct pinconf_ops cocci_id@p ;
...
position p;
@@
 struct atlas7_grp_mux {  unsigned int group ;  unsigned int pad_mux_count ;  const struct atlas7_pad_mux * pad_mux_list ; } cocci_id@p ;
...
position p;
@@
 struct atlas7_pinctrl_data {  struct pinctrl_pin_desc * pads ;  int pads_cnt ;  struct atlas7_pin_group * grps ;  int grps_cnt ;  struct atlas7_pmx_func * funcs ;  int funcs_cnt ;  struct atlas7_pad_config * confs ;  int confs_cnt ; } cocci_id@p ;
...
position p;
@@
 const struct atlas7_pad_mux * cocci_id@p ;
...
position p;
@@
 struct atlas7_pin_group cocci_id@p [ ] ;
...
@@
 struct atlas7_gpio_chip {  const char * name ;  void __iomem * reg ;  struct clk * clk ;  int nbank ;  raw_spinlock_t lock ;  struct gpio_chip chip ;  struct atlas7_gpio_bank banks [ 0 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct atlas7_ds_info {  u8 type ;  u8 mask ;  u8 imval ;  u8 reserved ; } cocci_id@p ;
...
position p;
@@
 const struct atlas7_ds_ma_info cocci_id@p [ ] ;
...
position p;
@@
 const struct pinmux_ops cocci_id@p ;
...
position p;
@@
 struct atlas7_pad_mux cocci_id@p [ ] ;
...
typedef u32;
@@
 struct atlas7_gpio_bank {  int id ;  int irq ;  void __iomem * base ;  unsigned int gpio_offset ;  unsigned int ngpio ;  const unsigned int * gpio_pins ;  u32 sleep_data [ NGPIO_OF_BANK ] ; } cocci_id@p ;
...
position p;
@@
 struct gpio_irq_chip * cocci_id@p ;
