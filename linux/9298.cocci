...
typedef u16;
@@
 u16 cocci_id@p [ MRVDRV_MAX_REGION_CODE ] ;
...
position p;
@@
 const struct channel_range cocci_id@p [ ] ;
...
position p;
@@
 struct lbtf_private * cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_beacon_control cocci_id@p ;
...
position p;
@@
 struct cmd_ctrl_node * cocci_id@p ( struct lbtf_private * priv ) ;
...
position p;
@@
 struct cmd_ds_802_11_beacon_set cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct lbtf_private * , unsigned long , struct cmd_header * ) ;
...
position p;
@@
 struct cmd_ds_mac_multicast_addr cocci_id@p ;
...
position p;
@@
 struct cmd_ds_set_bssid cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_mac_address cocci_id@p ;
...
position p;
@@
 struct cmd_ds_set_mode cocci_id@p ;
