...
position p;
@@
 struct pmcraid_instance cocci_id@p ;
...
position p;
@@
 struct pmcraid_ioadl_desc cocci_id@p ;
...
position p;
@@
 struct pmcraid_sglist cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct pmcraid_instance * , u32 ) ;
...
position p;
@@
 struct pmcraid_hostrcb * cocci_id@p ;
...
position p;
@@
 struct pmcraid_hcam_ldn cocci_id@p ;
...
position p;
@@
 struct pmcraid_config_table_entry cocci_id@p ;
...
position p;
@@
 struct pmcraid_hcam_hdr cocci_id@p ;
...
position p;
@@
 struct pmcraid_ioarcb cocci_id@p ;
...
position p;
@@
 struct pmcraid_isr_param * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct pmcraid_cmd * ) ;
...
position p;
@@
 struct pmcraid_hcam_ccn_ext cocci_id@p ;
...
position p;
@@
 struct pmcraid_ioctl_header * cocci_id@p ;
...
position p;
@@
 struct pmcraid_hcam_ccn * cocci_id@p ;
...
position p;
@@
 struct pmcraid_ioasa * cocci_id@p ;
...
position p;
@@
 enum { PMCRAID_AEN_CMD_UNSPEC , PMCRAID_AEN_CMD_EVENT , __PMCRAID_AEN_CMD_MAX , } cocci_id@p ;
...
position p;
@@
 struct pmcraid_config_table_entry_ext cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pmcraid_cmd * cmd ) ;
...
position p;
@@
 struct pmcraid_resource_entry cocci_id@p ;
...
position p;
@@
 struct pmcraid_aen_msg * cocci_id@p ;
...
position p;
@@
 struct pmcraid_config_table cocci_id@p ;
...
position p;
@@
 struct pmcraid_interrupts * cocci_id@p ;
...
position p;
@@
 struct pmcraid_control_block cocci_id@p ;
...
position p;
@@
 struct genl_multicast_group cocci_id@p [ ] ;
...
position p;
@@
 struct pmcraid_passthrough_ioctl_buffer * cocci_id@p ;
...
position p;
@@
 struct pmcraid_inquiry_data cocci_id@p ;
...
position p;
@@
 struct pmcraid_chip_details * cocci_id@p ;
...
position p;
@@
 enum { PMCRAID_AEN_ATTR_UNSPEC , PMCRAID_AEN_ATTR_EVENT , __PMCRAID_AEN_ATTR_MAX , } cocci_id@p ;
...
position p;
@@
 struct pmcraid_ioasc_error * cocci_id@p ;
...
position p;
@@
 struct pmcraid_timestamp_data cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pmcraid_instance * ) ;
