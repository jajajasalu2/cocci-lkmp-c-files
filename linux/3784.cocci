...
position p;
@@
 struct hash_driver_data cocci_id@p ;
...
position p;
@@
 struct hash_device_data cocci_id@p ;
...
typedef u8,u32;
@@
 void cocci_id@p ( struct hash_device_data * device_data , const u32 * message , u8 index_bytes ) ;
...
position p;
@@
 struct hash_algo_template * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SHA256_DIGEST_SIZE ] ;
...
position p;
@@
 struct hash_req_ctx cocci_id@p ;
...
position p;
@@
 struct hash_algo_template {  struct hash_config conf ;  struct ahash_alg hash ; } cocci_id@p ;
...
position p;
@@
 struct hash_platform_data * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SHA1_DIGEST_SIZE ] ;
...
position p;
@@
 const struct hash_state * cocci_id@p ;
...
position p;
@@
 struct hash_driver_data {  struct klist device_list ;  struct semaphore device_allocation ; } cocci_id@p ;
