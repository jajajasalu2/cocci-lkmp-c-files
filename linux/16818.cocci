...
position p;
@@
 enum apanel_chip { CHIP_NONE = 0 , CHIP_OZ992C = 1 , CHIP_OZ163T = 2 , CHIP_OZ711M3 = 4 , } cocci_id@p ;
...
typedef u16;
@@
 struct apanel {  struct input_dev * idev ;  struct i2c_client * client ;  unsigned short keymap [ MAX_PANEL_KEYS ] ;  u16 nkeys ;  struct led_classdev mail_led ; } cocci_id@p ;
...
position p;
@@
 const unsigned short cocci_id@p [ MAX_PANEL_KEYS ] ;
...
position p;
@@
 enum apanel_devid { APANEL_DEV_NONE = 0 , APANEL_DEV_APPBTN = 1 , APANEL_DEV_CDBTN = 2 , APANEL_DEV_LCD = 3 , APANEL_DEV_LED = 4 , APANEL_DEV_MAX , } cocci_id@p ;
...
position p;
@@
 enum apanel_chip cocci_id@p [ APANEL_DEV_MAX ] ;
