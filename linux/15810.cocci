...
position p;
@@
 struct shim_service cocci_id@p ;
...
position p;
@@
 struct vchi_queue_user_message_context cocci_id@p ;
...
symbol cocci_id;
position p;
typedef opaque_vchi_service_t;
@@
 struct opaque_vchi_service_t * cocci_id@p ;
...
position p;
@@
 enum vchi_service_option cocci_id@p ;
...
position p;
@@
 struct vchi_service_handle * cocci_id@p ;
...
position p;
@@
 struct shim_service {  unsigned int handle ;  struct vchiu_queue queue ;  vchi_callback callback ;  void * callback_param ; } cocci_id@p ;
...
position p;
@@
 const struct vchi_service_handle * cocci_id@p ;
...
position p;
@@
 struct vchi_queue_user_message_context {  void __user * data ; } cocci_id@p ;
