...
@@
 struct pluto {  struct pci_dev * pdev ;  u8 __iomem * io_mem ;  struct dmx_frontend hw_frontend ;  struct dmx_frontend mem_frontend ;  struct dmxdev dmxdev ;  struct dvb_adapter dvb_adapter ;  struct dvb_demux demux ;  struct dvb_frontend * fe ;  struct dvb_net dvbnet ;  unsigned int full_ts_users ;  unsigned int users ;  struct i2c_algo_bit_data i2c_bit ;  struct i2c_adapter i2c_adap ;  unsigned int i2cbug ;  unsigned int overflow ;  unsigned int dead ;  dma_addr_t dma_addr ;  u8 dma_buf [ TS_DMA_BYTES ] ;  u8 dummy [ 4096 ] ; } cocci_id@p ;
