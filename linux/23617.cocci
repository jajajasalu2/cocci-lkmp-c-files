...
position p;
@@
 void ( * cocci_id@p [ ] ) ( struct rsnd_priv * priv ) ;
...
position p;
@@
 struct rsnd_kctrl_cfg_m * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MOD_NAME_NUM ] [ MOD_NAME_SIZE ] ;
...
position p;
@@
 struct rsnd_mod * ( * cocci_id@p ) ( struct rsnd_priv * priv , int id ) ;
...
position p;
@@
 struct rsnd_kctrl_cfg_s * cocci_id@p ;
...
position p;
@@
 struct rsnd_dai_stream * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct rsnd_priv * priv ) ;
...
position p;
@@
 enum rsnd_mod_type cocci_id@p [ ] [ RSND_MOD_MAX ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct rsnd_dai_stream * io , struct rsnd_mod * mod ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rsnd_dai_stream * io ) ;
...
position p;
@@
 struct rsnd_kctrl_cfg * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct rsnd_mod * mod , struct rsnd_dai_stream * io ) ;
...
position p;
@@
 struct rsnd_mod_ops * cocci_id@p ;
