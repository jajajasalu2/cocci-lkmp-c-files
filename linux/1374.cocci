...
position p;
@@
 enum typec_data_role cocci_id@p ;
...
position p;
@@
 enum typec_port_type cocci_id@p ;
...
position p;
@@
 struct typec_cable_desc * cocci_id@p ;
...
position p;
@@
 struct typec_plug {  struct device dev ;  enum typec_plug_index index ;  struct ida mode_ids ; } cocci_id@p ;
...
position p;
@@
 struct typec_partner * cocci_id@p ;
...
position p;
@@
 struct device_connection * cocci_id@p ;
...
position p;
@@
 struct typec_device_id cocci_id@p ;
...
position p;
@@
 struct typec_plug_desc * cocci_id@p ;
...
position p;
@@
 struct typec_partner_desc * cocci_id@p ;
...
position p;
@@
 const struct typec_altmode_desc * cocci_id@p ;
...
position p;
@@
 struct typec_cable {  struct device dev ;  enum typec_plug_type type ;  struct usb_pd_identity * identity ;  unsigned int active : 1 ; } cocci_id@p ;
...
position p;
@@
 struct usb_pd_identity * cocci_id@p ;
...
position p;
@@
 struct typec_altmode * cocci_id@p ;
...
position p;
@@
 enum typec_orientation cocci_id@p ;
...
position p;
@@
 enum typec_pwr_opmode cocci_id@p ;
...
position p;
@@
 struct typec_partner {  struct device dev ;  unsigned int usb_pd : 1 ;  struct usb_pd_identity * identity ;  enum typec_accessory accessory ;  struct ida mode_ids ; } cocci_id@p ;
...
position p;
@@
 const struct typec_capability * cocci_id@p ;
