...
position p;
@@
 const struct nsp_mux * cocci_id@p ;
...
position p;
@@
 struct nsp_pin_group {  const char * name ;  const unsigned int * pins ;  const unsigned int num_pins ;  const struct nsp_mux mux ; } cocci_id@p ;
...
position p;
@@
 const struct nsp_pin_group cocci_id@p [ ] ;
...
typedef spinlock_t;
@@
 struct nsp_pinctrl {  struct pinctrl_dev * pctl ;  struct device * dev ;  void __iomem * base0 ;  void __iomem * base1 ;  void __iomem * base2 ;  const struct nsp_pin_group * groups ;  unsigned int num_groups ;  const struct nsp_pin_function * functions ;  unsigned int num_functions ;  struct nsp_mux_log * mux_log ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct nsp_pin {  unsigned int pin ;  char * name ;  unsigned int gpio_select ; } cocci_id@p ;
...
position p;
@@
 const struct nsp_pin_function * cocci_id@p ;
...
position p;
@@
 struct nsp_pin_function {  const char * name ;  const char * const * groups ;  const unsigned int num_groups ; } cocci_id@p ;
...
typedef bool;
@@
 struct nsp_mux_log {  struct nsp_mux mux ;  bool is_configured ; } cocci_id@p ;
...
position p;
@@
 struct nsp_mux {  unsigned int base ;  unsigned int shift ;  unsigned int mask ;  unsigned int alt ; } cocci_id@p ;
