...
symbol cocci_id;
position p;
typedef uint8_t,atomic_t,uint32_t;
@@
 struct persistent_ram_buffer {  uint32_t sig ;  atomic_t start ;  atomic_t size ;  uint8_t data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct persistent_ram_ecc_info * cocci_id@p ;
...
position p;
@@
 struct persistent_ram_buffer cocci_id@p ;
