...
position p;
@@
 struct ks_pcie_of_data {  enum dw_pcie_device_mode mode ;  const struct dw_pcie_host_ops * host_ops ;  const struct dw_pcie_ep_ops * ep_ops ;  unsigned int version ; } cocci_id@p ;
...
position p;
@@
 struct ks_pcie_of_data * cocci_id@p ;
...
position p;
@@
 const struct dw_pcie_ep_ops * cocci_id@p ;
...
position p;
@@
 const struct ks_pcie_of_data cocci_id@p ;
...
position p;
@@
 const struct pci_epc_features * cocci_id@p ;
...
typedef bool,u32;
@@
 struct keystone_pcie {  struct dw_pcie * pci ;  u32 device_id ;  int legacy_host_irqs [ PCI_NUM_INTX ] ;  struct device_node * legacy_intc_np ;  int msi_host_irq ;  int num_lanes ;  u32 num_viewport ;  struct phy * * phy ;  struct device_link * * link ;  struct device_node * msi_intc_np ;  struct irq_domain * legacy_irq_domain ;  struct device_node * np ;  void __iomem * va_app_base ;  struct resource app ;  bool is_am6 ; } cocci_id@p ;
...
position p;
@@
 struct keystone_pcie * cocci_id@p ;
...
position p;
@@
 enum dw_pcie_device_mode cocci_id@p ;
...
position p;
@@
 enum pci_epc_irq_type cocci_id@p ;
