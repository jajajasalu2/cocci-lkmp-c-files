...
typedef s64;
@@
 struct cros_ec_spi {  struct spi_device * spi ;  s64 last_transfer_ns ;  unsigned int start_of_msg_delay ;  unsigned int end_of_msg_delay ;  struct kthread_worker * high_pri_worker ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cros_ec_xfer_fn_t;
@@
 struct cros_ec_xfer_work_params {  struct kthread_work work ;  cros_ec_xfer_fn_t fn ;  struct cros_ec_device * ec_dev ;  struct cros_ec_command * ec_msg ;  int ret ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct cros_ec_device * ec_dev , struct cros_ec_command * ec_msg ) ;
...
position p;
@@
 struct ec_host_response cocci_id@p ;
...
position p;
@@
 struct cros_ec_xfer_work_params cocci_id@p ;
...
position p;
@@
 struct ec_host_request cocci_id@p ;
...
position p;
@@
 struct ec_response_get_protocol_info cocci_id@p ;
