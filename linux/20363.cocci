...
position p;
@@
 struct apm_bios_call cocci_id@p ;
...
symbol cocci_id;
position p;
typedef apm_eventinfo_t;
@@
 apm_eventinfo_t * cocci_id@p ;
...
typedef lookup_t;
@@
 struct lookup_t {  int key ;  char * msg ; } cocci_id@p ;
...
typedef u32;
@@
 struct apm_bios_call {  u32 func ;  u32 ebx ;  u32 ecx ;  u32 eax ;  u32 edx ;  u32 esi ;  int err ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned long offset ;  unsigned short segment ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cpuidle_device * dev , struct cpuidle_driver * drv , int index ) ;
