...
position p;
@@
 struct bcm590xx_info cocci_id@p [ ] ;
...
typedef u8;
@@
 struct bcm590xx_info {  const char * name ;  const char * vin_name ;  u8 n_voltages ;  const unsigned int * volt_table ;  u8 n_linear_ranges ;  const struct regulator_linear_range * linear_ranges ; } cocci_id@p ;
...
position p;
@@
 struct bcm590xx_reg {  struct regulator_desc * desc ;  struct bcm590xx * mfd ; } cocci_id@p ;
...
position p;
@@
 struct bcm590xx_reg * cocci_id@p ;
