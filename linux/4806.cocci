...
position p;
@@
 struct ib_umad_port cocci_id@p ;
...
position p;
@@
 struct ib_user_mad_hdr_old cocci_id@p ;
...
@@
 struct ib_umad_file {  struct mutex mutex ;  struct ib_umad_port * port ;  struct list_head recv_list ;  struct list_head send_list ;  struct list_head port_list ;  spinlock_t send_lock ;  wait_queue_head_t recv_wait ;  struct ib_mad_agent * agent [ IB_UMAD_MAX_AGENTS ] ;  int agents_dead ;  u8 use_pkey_index ;  u8 already_used ; } cocci_id@p ;
...
position p;
@@
 struct ib_umad_device * cocci_id@p ;
...
position p;
@@
 struct ib_umad_packet cocci_id@p ;
...
position p;
@@
 struct ib_user_mad_hdr cocci_id@p ;
...
position p;
@@
 const struct ib_device * cocci_id@p ;
...
position p;
@@
 struct ib_umad_packet {  struct ib_mad_send_buf * msg ;  struct ib_mad_recv_wc * recv_wc ;  struct list_head list ;  int length ;  struct ib_user_mad mad ; } cocci_id@p ;
...
position p;
@@
 struct ib_umad_file * cocci_id@p ;
...
position p;
@@
 struct ib_user_mad_reg_req cocci_id@p ;
...
position p;
@@
 struct class_attribute * cocci_id@p ;
...
position p;
@@
 enum { IB_UMAD_MAX_PORTS = RDMA_MAX_PORTS , IB_UMAD_MAX_AGENTS = 32 , IB_UMAD_MAJOR = 231 , IB_UMAD_MINOR_BASE = 0 , IB_UMAD_NUM_FIXED_MINOR = 64 , IB_UMAD_NUM_DYNAMIC_MINOR = IB_UMAD_MAX_PORTS - IB_UMAD_NUM_FIXED_MINOR , IB_ISSM_MINOR_BASE = IB_UMAD_NUM_FIXED_MINOR , } cocci_id@p ;
...
position p;
@@
 struct ib_umad_device {  struct kref kref ;  struct ib_umad_port ports [ ] ; } cocci_id@p ;
...
position p;
@@
 struct ib_user_mad_reg_req2 cocci_id@p ;
...
typedef u8;
@@
 struct ib_umad_port {  struct cdev cdev ;  struct device dev ;  struct cdev sm_cdev ;  struct device sm_dev ;  struct semaphore sm_sem ;  struct mutex file_mutex ;  struct list_head file_list ;  struct ib_device * ib_dev ;  struct ib_umad_device * umad_dev ;  int dev_num ;  u8 port_num ; } cocci_id@p ;
