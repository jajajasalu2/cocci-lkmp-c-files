...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_BITWISE_MAX + 1 ] ;
...
typedef u8;
@@
 struct nft_bitwise {  enum nft_registers sreg : 8 ;  enum nft_registers dreg : 8 ;  u8 len ;  struct nft_data mask ;  struct nft_data xor ; } cocci_id@p ;
...
position p;
@@
 const struct nft_bitwise * cocci_id@p ;
