...
position p;
@@
 struct o2net_send_tracking cocci_id@p ;
...
position p;
@@
 struct o2net_status_wait * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct o2net_sock_container * sc ) ;
...
position p;
@@
 enum o2net_system_error cocci_id@p ;
...
position p;
@@
 struct o2net_handshake cocci_id@p ;
...
position p;
@@
 struct o2net_sock_container * * cocci_id@p ;
...
position p;
@@
 o2net_post_msg_handler_func * cocci_id@p ;
...
position p;
@@
 struct o2net_msg_handler cocci_id@p ;
...
position p;
@@
 struct o2net_node cocci_id@p [ O2NM_MAX_NODES ] ;
...
position p;
@@
 o2net_msg_handler_func * cocci_id@p ;
