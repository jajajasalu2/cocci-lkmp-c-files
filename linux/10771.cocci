...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct drm_i915_private * i915 , struct i915_address_space * vm , u64 hole_start , u64 hole_end , unsigned long end_time ) ;
...
position p;
@@
 typeof ( obj -> base . size ) cocci_id@p ;
...
typedef u64;
@@
 const struct {  const char * name ;  u64 offset ;  int step ; } cocci_id@p [ ] ;
