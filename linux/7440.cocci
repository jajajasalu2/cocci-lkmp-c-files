...
typedef bool;
@@
 bool cocci_id@p ( struct SiS_Private * SiS_Pr ) ;
...
position p;
@@
 int cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned char modeno , unsigned char rateindex , struct fb_var_screeninfo * var ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned char modeno , int * htotal , int * vtotal , unsigned char rateindex ) ;
...
position p;
@@
 int cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned char modeno , unsigned char rateindex ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned short * ModeNo , unsigned short * ModeIdIndex ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned char * crdata , int xres , int yres , struct fb_var_screeninfo * var , bool writeres ) ;
