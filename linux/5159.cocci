...
typedef u32;
@@
 struct syscon_gpio_priv {  struct gpio_chip chip ;  struct regmap * syscon ;  const struct syscon_gpio_data * data ;  u32 dreg_offset ;  u32 dir_reg_offset ; } cocci_id@p ;
...
position p;
@@
 struct syscon_gpio_priv * cocci_id@p ;
...
position p;
@@
 struct syscon_gpio_data {  const char * compatible ;  unsigned int flags ;  unsigned int bit_count ;  unsigned int dat_bit_offset ;  unsigned int dir_bit_offset ;  void ( * set ) ( struct gpio_chip * chip , unsigned offset , int value ) ; } cocci_id@p ;
...
position p;
@@
 const struct syscon_gpio_data cocci_id@p ;
