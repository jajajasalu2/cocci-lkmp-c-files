...
position p;
@@
 void cocci_id@p ( struct qla_tgt * tgt ) ;
...
typedef u64;
@@
 int cocci_id@p ( struct fc_port * sess , u64 lun , int fn , void * iocb , int flags ) ;
...
typedef uint32_t;
@@
 uint32_t cocci_id@p ( struct qla_qpair * ) ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct scsi_qla_host * , void * , u64 , u64 ) ;
...
symbol cocci_id;
position p;
typedef qlt_plogi_ack_t;
@@
 struct qlt_plogi_ack_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_port * sess ) ;
...
position p;
@@
 struct vp_config_entry_24xx * cocci_id@p ;
...
position p;
@@
 struct ctio_to_2xxx * cocci_id@p ;
...
position p;
@@
 struct ctio7_to_24xx * cocci_id@p ;
...
position p;
@@
 struct atio_from_isp * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef qlt_port_logo_t;
@@
 qlt_port_logo_t cocci_id@p ;
...
position p;
@@
 struct qla_msix_entry * cocci_id@p ;
...
position p;
@@
 enum fcp_resp_rsp_codes { FCP_TMF_CMPL = 0 , FCP_DATA_LEN_INVALID = 1 , FCP_CMND_FIELDS_INVALID = 2 , FCP_DATA_PARAM_MISMATCH = 3 , FCP_TMF_REJECTED = 4 , FCP_TMF_FAILED = 5 , FCP_TMF_INVALID_LUN = 9 , } cocci_id@p ;
...
position p;
@@
 struct abts_resp_to_24xx * cocci_id@p ;
...
position p;
@@
 struct imm_ntfy_from_isp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qla_qpair * , struct qla_tgt_cmd * cmd , struct atio_from_isp * atio , int ha_locked , int ul_abort ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_qla_host * vha , struct imm_ntfy_from_isp * imm , int ha_locked ) ;
...
position p;
@@
 struct qla_tgt_sess_work_param * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef qlt_plogi_link_t;
@@
 enum qlt_plogi_link_t cocci_id@p ;
...
position p;
@@
 struct abts_recv_from_24xx * cocci_id@p ;
...
position p;
@@
 struct qla_tgt_sess_op cocci_id@p ;
...
position p;
@@
 struct qla_tgt_mgmt_cmd * cocci_id@p ;
...
position p;
@@
 struct init_cb_81xx * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cont_entry_t;
@@
 cont_entry_t * cocci_id@p ;
...
position p;
@@
 struct ctio_crc_from_fw * cocci_id@p ;
...
typedef port_id_t;
@@
 struct {  port_id_t id ;  int cmd_count ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct gid_list_info * cocci_id@p ;
...
position p;
@@
 struct init_cb_24xx * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_qla_host * vha ) ;
...
position p;
@@
 struct qla_tgt_vp_map cocci_id@p ;
...
position p;
@@
 struct qla_qpair_hint cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cont_a64_entry_t;
@@
 cont_a64_entry_t * cocci_id@p ;
...
position p;
@@
 struct abts_resp_from_24xx_fw * cocci_id@p ;
...
position p;
@@
 struct vp_rpt_id_entry_24xx * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef scsi_qla_host_t;
@@
 scsi_qla_host_t * cocci_id@p ;
...
position p;
@@
 struct qla_tc_param cocci_id@p ;
...
position p;
@@
 struct ctio_crc2_to_fw * cocci_id@p ;
...
position p;
@@
 struct ctio7_from_24xx * cocci_id@p ;
...
position p;
@@
 struct qla_work_evt * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_qla_host * , struct abts_recv_from_24xx * ) ;
