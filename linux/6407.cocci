...
position p;
@@
 enum { MAX8660_OVER1 , MAX8660_OVER2 , MAX8660_VCC1 , MAX8660_ADTV1 , MAX8660_ADTV2 , MAX8660_SDTV1 , MAX8660_SDTV2 , MAX8660_MDTV1 , MAX8660_MDTV2 , MAX8660_L12VCR , MAX8660_FPWM , MAX8660_N_REGS , } cocci_id@p ;
...
position p;
@@
 struct max8660_subdev_data cocci_id@p ;
...
position p;
@@
 enum { MAX8660 = 0 , MAX8661 = 1 , } cocci_id@p ;
...
position p;
@@
 struct max8660_platform_data cocci_id@p ;
...
position p;
@@
 struct device_node * cocci_id@p [ MAX8660_V_END ] ;
...
position p;
@@
 struct of_regulator_match cocci_id@p [ ARRAY_SIZE ( max8660_reg ) ] ;
...
typedef u8;
@@
 struct max8660 {  struct i2c_client * client ;  u8 shadow_regs [ MAX8660_N_REGS ] ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ MAX8660_N_REGS ] ;
