...
position p;
@@
 const struct ani_ofdm_level_entry * cocci_id@p ;
...
position p;
@@
 const struct ani_cck_level_entry * cocci_id@p ;
...
position p;
@@
 struct ani_ofdm_level_entry {  int spur_immunity_level ;  int fir_step_level ;  int ofdm_weak_signal_on ; } cocci_id@p ;
...
position p;
@@
 struct ani_cck_level_entry {  int fir_step_level ;  int mrc_cck_on ; } cocci_id@p ;
