...
position p;
@@
 enum bmg160_axis { AXIS_X , AXIS_Y , AXIS_Z , AXIS_MAX , } cocci_id@p ;
...
position p;
@@
 const struct {  int odr ;  int filter ;  int bw_bits ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct {  int scale ;  int dps_range ; } cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef s16,bool,u32;
@@
 struct bmg160_data {  struct regmap * regmap ;  struct iio_trigger * dready_trig ;  struct iio_trigger * motion_trig ;  struct iio_mount_matrix orientation ;  struct mutex mutex ;  s16 buffer [ 8 ] ;  u32 dps_range ;  int ev_enable_state ;  int slope_thres ;  bool dready_trigger_on ;  bool motion_trigger_on ;  int irq ; } cocci_id@p ;
