...
position p;
@@
 const struct em28xx_board cocci_id@p [ ] ;
...
position p;
@@
 struct em28xx_reg_seq cocci_id@p [ ] ;
...
position p;
@@
 const struct em28xx_hash_table cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct em28xx * dev ) ;
...
position p;
@@
 struct em28xx_hash_table {  unsigned long hash ;  unsigned int model ;  unsigned int tuner ; } cocci_id@p ;
