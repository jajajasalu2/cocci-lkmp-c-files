...
position p;
@@
 struct milbeaut_xdmac_device * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct milbeaut_xdmac_desc {  struct virt_dma_desc vd ;  size_t len ;  dma_addr_t src ;  dma_addr_t dst ; } cocci_id@p ;
...
position p;
@@
 struct milbeaut_xdmac_device {  struct dma_device ddev ;  void __iomem * reg_base ;  struct milbeaut_xdmac_chan channels [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct milbeaut_xdmac_chan cocci_id@p ;
...
position p;
@@
 struct milbeaut_xdmac_desc * cocci_id@p ;
...
position p;
@@
 struct milbeaut_xdmac_chan {  struct virt_dma_chan vc ;  struct milbeaut_xdmac_desc * md ;  void __iomem * reg_ch_base ; } cocci_id@p ;
