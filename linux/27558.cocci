...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct btrfs_trans_handle * , struct btrfs_fs_info * , struct btrfs_block_group * , struct btrfs_path * , u32 alignment ) ;
...
position p;
@@
 const struct free_space_extent cocci_id@p [ ] ;
...
position p;
@@
 const struct free_space_extent * const cocci_id@p ;
...
typedef u64;
@@
 struct free_space_extent {  u64 start ;  u64 length ; } cocci_id@p ;
...
position p;
@@
 struct btrfs_free_space_info * cocci_id@p ;
