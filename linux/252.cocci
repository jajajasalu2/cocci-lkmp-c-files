...
position p;
@@
 struct ctx_switch_entry * cocci_id@p ;
...
position p;
@@
 const struct trace_print_flags_u64 * cocci_id@p ;
...
position p;
@@
 const struct trace_mark {  unsigned long long val ;  char sym ; } cocci_id@p [ ] ;
