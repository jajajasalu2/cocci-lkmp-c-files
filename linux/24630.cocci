...
position p;
@@
 struct {  struct nlattr opt ;  struct gnet_estimator est ; } cocci_id@p ;
...
position p;
@@
 struct xt_rateest_net * cocci_id@p ;
...
position p;
@@
 struct xt_rateest_target_info * cocci_id@p ;
...
position p;
@@
 struct xt_rateest_net {  struct mutex hash_lock ;  struct hlist_head hash [ RATEEST_HSIZE ] ; } cocci_id@p ;
...
position p;
@@
 const struct xt_rateest_target_info * cocci_id@p ;
