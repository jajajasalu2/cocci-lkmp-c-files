...
position p;
@@
 struct gsc_pix_align cocci_id@p ;
...
position p;
@@
 const struct gsc_fmt cocci_id@p [ ] ;
...
position p;
@@
 const struct gsc_driverdata * cocci_id@p ;
