...
position p;
@@
 struct max_sync_cop * cocci_id@p ;
...
position p;
@@
 struct nx_crypto_ctx * cocci_id@p ;
...
position p;
@@
 struct nx_crypto_driver cocci_id@p ;
