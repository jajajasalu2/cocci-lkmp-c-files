...
typedef u64;
@@
 struct root_entry {  u64 root_objectid ;  u64 num_refs ;  struct rb_node node ; } cocci_id@p ;
...
typedef u64;
@@
 struct block_entry {  u64 bytenr ;  u64 len ;  u64 num_refs ;  int metadata ;  int from_disk ;  struct rb_root roots ;  struct rb_root refs ;  struct rb_node node ;  struct list_head actions ; } cocci_id@p ;
...
typedef u64;
@@
 struct ref_action {  int action ;  u64 root ;  struct ref_entry ref ;  struct list_head list ;  unsigned long trace [ MAX_TRACE ] ;  unsigned int trace_len ; } cocci_id@p ;
...
typedef u64;
@@
 struct ref_entry {  u64 root_objectid ;  u64 parent ;  u64 owner ;  u64 offset ;  u64 num_refs ;  struct rb_node node ; } cocci_id@p ;
