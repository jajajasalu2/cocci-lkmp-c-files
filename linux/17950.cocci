...
position p;
@@
 struct irq_handler_data cocci_id@p ;
...
position p;
@@
 struct irq_handler_data {  union {  struct {  unsigned int dev_handle ;  unsigned int dev_ino ; } ;  unsigned long sysino ; } ;  struct ino_bucket bucket ;  unsigned long iclr ;  unsigned long imap ; } cocci_id@p ;
...
typedef u64;
@@
 struct sun5_timer {  u64 count0 ;  u64 limit0 ;  u64 count1 ;  u64 limit1 ; } cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct irq_handler_data * data , u32 devhandle , unsigned int devino ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned int , void * , void * ) ;
