...
position p;
@@
 struct aspeed_smc_chip * cocci_id@p ;
...
typedef u32;
@@
 struct aspeed_smc_controller {  struct device * dev ;  struct mutex mutex ;  const struct aspeed_smc_info * info ;  void __iomem * regs ;  void __iomem * ahb_base ;  u32 ahb_window_size ;  struct aspeed_smc_chip * chips [ 0 ] ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct aspeed_smc_info {  u32 maxsize ;  u8 nce ;  bool hastype ;  u8 we0 ;  u8 ctl0 ;  void ( * set_4b ) ( struct aspeed_smc_chip * chip ) ; } cocci_id@p ;
...
typedef u32;
@@
 struct aspeed_smc_chip {  int cs ;  struct aspeed_smc_controller * controller ;  void __iomem * ctl ;  void __iomem * ahb_base ;  u32 ahb_window_size ;  u32 ctl_val [ smc_max ] ;  enum aspeed_smc_flash_type type ;  struct spi_nor nor ; } cocci_id@p ;
...
position p;
@@
 const struct aspeed_smc_info * cocci_id@p ;
...
position p;
@@
 struct aspeed_smc_controller cocci_id@p ;
...
position p;
@@
 enum aspeed_smc_ctl_reg_value { smc_base , smc_read , smc_write , smc_max , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct aspeed_smc_chip * chip ) ;
