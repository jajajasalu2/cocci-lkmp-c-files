...
symbol cocci_id;
position p;
typedef drm_mga_buf_priv_t;
@@
 drm_mga_buf_priv_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_mga_private_t;
@@
 drm_mga_private_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_mga_sarea_t;
@@
 drm_mga_sarea_t * cocci_id@p ;
...
position p;
@@
 struct drm_map_list * cocci_id@p ;
...
typedef drm_mga_private_t;
@@
 drm_mga_private_t * const cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_mga_freelist_t;
@@
 drm_mga_freelist_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_device * dev , int full_cleanup ) ;
...
symbol cocci_id;
position p;
typedef drm_mga_primary_buffer_t;
@@
 drm_mga_primary_buffer_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_mga_dma_bootstrap_t;
@@
 drm_mga_dma_bootstrap_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_mga_init_t;
@@
 drm_mga_init_t * cocci_id@p ;
...
typedef drm_mga_private_t;
@@
 const drm_mga_private_t * const cocci_id@p ;
