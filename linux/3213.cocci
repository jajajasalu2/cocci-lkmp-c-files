...
typedef u8,u16;
@@
 struct sch56xx_watchdog_data {  u16 addr ;  struct mutex * io_lock ;  struct watchdog_info wdinfo ;  struct watchdog_device wddev ;  u8 watchdog_preset ;  u8 watchdog_control ;  u8 watchdog_output_enable ; } cocci_id@p ;
...
position p;
@@
 struct sch56xx_watchdog_data * cocci_id@p ;
