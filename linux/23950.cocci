...
position p;
@@
 struct ip_frag_state cocci_id@p ;
...
position p;
@@
 struct ip_fraglist_iter cocci_id@p ;
...
position p;
@@
 const struct ip_reply_arg * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net * net , struct sock * sk , struct sk_buff * skb , unsigned int mtu , int ( * output ) ( struct net * , struct sock * , struct sk_buff * ) ) ;
...
position p;
@@
 const struct ip_options * cocci_id@p ;
