...
position p;
@@
 enum puda_resource_type cocci_id@p ;
...
typedef bool;
@@
 enum i40iw_status_code cocci_id@p ( struct i40iw_puda_rsrc * rsrc , bool initial ) ;
...
position p;
@@
 struct i40iw_puda_send_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct i40iw_sc_vsi * vsi , struct i40iw_puda_buf * buf ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct i40iw_sc_qp * qp , u32 wqe_idx ) ;
...
position p;
@@
 void cocci_id@p ( struct i40iw_sc_vsi * vsi , void * sqwrid ) ;
