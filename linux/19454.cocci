...
typedef __u32;
@@
 struct {  __u32 flag ;  const char * str ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  struct pci_controller * channel ;  struct tx4927_pcic_reg __iomem * pcicptr ; } cocci_id@p [ 2 ] ;
...
position p;
@@
 struct tx4927_pcic_reg cocci_id@p ;
...
typedef u8,u16;
@@
 struct {  u8 trdyto ;  u8 retryto ;  u16 gbwc ; } cocci_id@p ;
