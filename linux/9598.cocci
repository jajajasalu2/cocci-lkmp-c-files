...
position p;
@@
 struct brcmf_usbdev * cocci_id@p ;
...
typedef __le32;
@@
 struct trx_header_le {  __le32 magic ;  __le32 len ;  __le32 crc32 ;  __le32 flag_version ;  __le32 offsets [ TRX_MAX_OFFSET ] ; } cocci_id@p ;
...
position p;
@@
 struct rdl_state_le cocci_id@p ;
...
position p;
@@
 struct brcmf_usbdev_info * cocci_id@p ;
...
position p;
@@
 struct brcmf_usbreq cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct brcmf_usbdev_info * devinfo , struct brcmf_usbreq * req ) ;
...
typedef __le32;
@@
 struct bootrom_id_le {  __le32 chip ;  __le32 chiprev ;  __le32 ramsize ;  __le32 remapbase ;  __le32 boardtype ;  __le32 boardrev ; } cocci_id@p ;
...
position p;
@@
 struct trx_header_le * cocci_id@p ;
...
position p;
@@
 struct bootrom_id_le cocci_id@p ;
...
typedef __le32;
@@
 struct rdl_state_le {  __le32 state ;  __le32 bytes ; } cocci_id@p ;
...
typedef s8,u8;
@@
 struct brcmf_usb_image {  struct list_head list ;  s8 * fwname ;  u8 * image ;  int image_len ; } cocci_id@p ;
