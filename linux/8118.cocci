...
@@
 struct pciefd_can {  struct peak_canfd_priv ucan ;  void __iomem * reg_base ;  struct pciefd_board * board ;  struct pucan_command pucan_cmd ;  dma_addr_t rx_dma_laddr ;  void * rx_dma_vaddr ;  dma_addr_t tx_dma_laddr ;  void * tx_dma_vaddr ;  struct pciefd_page tx_pages [ PCIEFD_TX_PAGE_COUNT ] ;  u16 tx_pages_free ;  u16 tx_page_index ;  spinlock_t tx_lock ;  u32 irq_status ;  u32 irq_tag ; } cocci_id@p ;
...
position p;
@@
 struct pciefd_board * cocci_id@p ;
...
@@
 struct pciefd_page {  void * vbase ;  dma_addr_t lbase ;  u32 offset ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 struct pciefd_tx_link cocci_id@p ;
...
position p;
@@
 struct pciefd_rx_dma * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct pciefd_board {  void __iomem * reg_base ;  struct pci_dev * pci_dev ;  int can_count ;  spinlock_t cmd_lock ;  struct pciefd_can * can [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct pciefd_board * cocci_id@p ;
...
position p;
@@
 const struct pciefd_can * cocci_id@p ;
...
position p;
@@
 struct peak_canfd_priv * cocci_id@p ;
