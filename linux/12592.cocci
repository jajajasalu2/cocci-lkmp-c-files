...
position p;
@@
 enum dpu_sspp_multirect_index cocci_id@p ;
...
position p;
@@
 enum dpu_sspp_multirect_mode cocci_id@p ;
...
position p;
@@
 struct dpu_hw_pipe_qos_cfg * cocci_id@p ;
...
position p;
@@
 struct dpu_hw_blk_ops cocci_id@p ;
...
position p;
@@
 struct dpu_hw_blk_reg_map * cocci_id@p ;
