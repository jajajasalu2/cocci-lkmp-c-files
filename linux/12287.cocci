...
position p;
@@
 struct panel_simple cocci_id@p ;
...
typedef bool;
@@
 struct panel_simple {  struct drm_panel base ;  bool prepared ;  bool enabled ;  bool no_hpd ;  const struct panel_desc * desc ;  struct backlight_device * backlight ;  struct regulator * supply ;  struct i2c_adapter * ddc ;  struct gpio_desc * enable_gpio ;  struct drm_display_mode override_mode ; } cocci_id@p ;
...
position p;
@@
 const struct drm_panel_funcs cocci_id@p ;
...
position p;
@@
 struct mipi_dsi_driver cocci_id@p ;
...
position p;
@@
 const struct panel_desc_dsi * cocci_id@p ;
...
position p;
@@
 const struct panel_desc * cocci_id@p ;
...
position p;
@@
 const struct display_timing * cocci_id@p ;
...
position p;
@@
 struct panel_desc_dsi {  struct panel_desc desc ;  unsigned long flags ;  enum mipi_dsi_pixel_format format ;  unsigned int lanes ; } cocci_id@p ;
...
position p;
@@
 struct display_timing cocci_id@p ;
...
typedef u32;
@@
 struct panel_desc {  const struct drm_display_mode * modes ;  unsigned int num_modes ;  const struct display_timing * timings ;  unsigned int num_timings ;  unsigned int bpc ;  struct {  unsigned int width ;  unsigned int height ; } size ;  struct {  unsigned int prepare ;  unsigned int hpd_absent_delay ;  unsigned int enable ;  unsigned int disable ;  unsigned int unprepare ; } delay ;  u32 bus_format ;  u32 bus_flags ;  int connector_type ; } cocci_id@p ;
