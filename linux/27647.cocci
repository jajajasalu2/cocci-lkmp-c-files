...
position p;
@@
 struct op_inode_info cocci_id@p ;
...
position p;
@@
 enum op_inode_type { op_inode_node , op_inode_prop , } cocci_id@p ;
...
position p;
@@
 struct op_inode_info {  struct inode vfs_inode ;  enum op_inode_type type ;  union op_inode_data u ; } cocci_id@p ;
...
position p;
@@
 union op_inode_data {  struct device_node * node ;  struct property * prop ; } cocci_id@p ;
...
position p;
@@
 union op_inode_data cocci_id@p ;
