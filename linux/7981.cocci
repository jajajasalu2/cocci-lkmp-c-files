...
position p;
@@
 struct xenvif_pkt_state * cocci_id@p ;
...
position p;
@@
 struct xenvif_pkt_state {  struct sk_buff * skb ;  size_t remaining_len ;  struct sk_buff * frag_iter ;  int frag ;  unsigned int frag_offset ;  struct xen_netif_extra_info extras [ XEN_NETIF_EXTRA_TYPE_MAX - 1 ] ;  unsigned int extra_count ;  unsigned int slot ; } cocci_id@p ;
