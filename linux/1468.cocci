...
position p;
@@
 struct uvc_output_terminal_descriptor * cocci_id@p ;
...
position p;
@@
 struct uvc_header_descriptor * cocci_id@p ;
...
position p;
@@
 struct uvc_control_endpoint_descriptor cocci_id@p ;
...
position p;
@@
 const struct uvc_descriptor_header * const * cocci_id@p ;
...
position p;
@@
 const struct usb_descriptor_header * const cocci_id@p [ ] ;
...
position p;
@@
 struct uvc_color_matching_descriptor * cocci_id@p ;
