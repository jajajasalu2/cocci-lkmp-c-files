...
position p;
@@
 unsigned long cocci_id@p [ PAGE_OWNER_STACK_DEPTH ] ;
...
symbol cocci_id;
position p;
typedef depot_stack_handle_t,gfp_t;
@@
 struct page_owner {  unsigned short order ;  short last_migrate_reason ;  gfp_t gfp_mask ;  depot_stack_handle_t handle ;  depot_stack_handle_t free_handle ; } cocci_id@p ;
...
position p;
@@
 struct page_ext_operations cocci_id@p ;
