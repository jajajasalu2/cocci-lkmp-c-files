...
position p;
@@
 struct ocxl_ioctl_irq_fd cocci_id@p ;
...
position p;
@@
 struct ocxl_kernel_event_xsl_fault_error cocci_id@p ;
...
position p;
@@
 struct ocxl_file_info * cocci_id@p ;
...
position p;
@@
 struct ocxl_ioctl_attach cocci_id@p ;
...
position p;
@@
 struct ocxl_kernel_event_header * cocci_id@p ;
...
position p;
@@
 struct ocxl_ioctl_metadata cocci_id@p ;
...
position p;
@@
 struct ocxl_ioctl_features cocci_id@p ;
...
position p;
@@
 struct ocxl_context * cocci_id@p ;
...
position p;
@@
 struct ocxl_ioctl_p9_wait cocci_id@p ;
...
position p;
@@
 enum ocxl_context_status cocci_id@p ;
