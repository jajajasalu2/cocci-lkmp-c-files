...
position p;
@@
 const struct imc_uncore_pci_dev * cocci_id@p ;
...
position p;
@@
 enum perf_snb_uncore_imc_freerunning_types { SNB_PCI_UNCORE_IMC_DATA = 0 , SNB_PCI_UNCORE_IMC_FREERUNNING_TYPE_MAX , } cocci_id@p ;
...
typedef __u32;
@@
 struct imc_uncore_pci_dev {  __u32 pci_id ;  struct pci_driver * driver ; } cocci_id@p ;
...
position p;
@@
 enum { SNB_PCI_UNCORE_IMC , } cocci_id@p ;
