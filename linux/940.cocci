...
position p;
@@
 struct sm_sysfs_attribute * cocci_id@p ;
...
position p;
@@
 struct sm_sysfs_attribute {  struct device_attribute dev_attr ;  char * data ;  int len ; } cocci_id@p ;
