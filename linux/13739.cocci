...
position p;
@@
 struct mt9m111_context * cocci_id@p ;
...
typedef u32;
@@
 struct mt9m111_datafmt {  u32 code ;  enum v4l2_colorspace colorspace ; } cocci_id@p ;
...
position p;
@@
 struct mt9m111_mode_info {  unsigned int sensor_w ;  unsigned int sensor_h ;  unsigned int max_image_w ;  unsigned int max_image_h ;  unsigned int max_fps ;  unsigned int reg_val ;  unsigned int reg_mask ; } cocci_id@p ;
...
position p;
@@
 const struct mt9m111_datafmt * cocci_id@p ;
...
position p;
@@
 const struct i2c_client * cocci_id@p ;
...
typedef u16;
@@
 struct mt9m111_context {  u16 read_mode ;  u16 blanking_h ;  u16 blanking_v ;  u16 reducer_xzoom ;  u16 reducer_yzoom ;  u16 reducer_xsize ;  u16 reducer_ysize ;  u16 output_fmt_ctrl2 ;  u16 control ; } cocci_id@p ;
...
position p;
@@
 const struct mt9m111_mode_info cocci_id@p [ MT9M111_NUM_MODES ] ;
...
position p;
@@
 enum mt9m111_mode_id { MT9M111_MODE_SXGA_8FPS , MT9M111_MODE_SXGA_15FPS , MT9M111_MODE_QSXGA_30FPS , MT9M111_NUM_MODES , } cocci_id@p ;
...
position p;
@@
 const struct mt9m111_mode_info * cocci_id@p ;
