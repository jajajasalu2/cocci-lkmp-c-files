...
position p;
@@
 struct mtk_afe_i2s_priv cocci_id@p ;
...
position p;
@@
 struct mtk_afe_i2s_priv {  int id ;  int rate ;  int low_jitter_en ;  const char * share_property_name ;  int share_i2s_id ;  int mclk_id ;  int mclk_rate ;  int mclk_apll ; } cocci_id@p ;
...
position p;
@@
 enum { I2S1_SEL_O28_O29 = 0 , I2S1_SEL_O03_O04 = 1 , } cocci_id@p ;
...
position p;
@@
 enum { DAI_I2S0 = 0 , DAI_I2S1 , DAI_I2S2 , DAI_I2S3 , DAI_I2S5 , DAI_I2S_NUM , } cocci_id@p ;
...
position p;
@@
 enum { I2S_WLEN_16_BIT = 0 , I2S_WLEN_32_BIT = 1 , } cocci_id@p ;
...
position p;
@@
 enum { I2S_IN_PAD_CONNSYS = 0 , I2S_IN_PAD_IO_MUX = 1 , } cocci_id@p ;
...
position p;
@@
 enum { SUPPLY_SEQ_APLL , SUPPLY_SEQ_I2S_MCLK_EN , SUPPLY_SEQ_I2S_HD_EN , SUPPLY_SEQ_I2S_EN , } cocci_id@p ;
...
position p;
@@
 const struct mtk_afe_i2s_priv cocci_id@p [ DAI_I2S_NUM ] ;
...
position p;
@@
 enum { I2S_HD_NORMAL = 0 , I2S_HD_LOW_JITTER = 1 , } cocci_id@p ;
...
position p;
@@
 enum { I2S_FMT_EIAJ = 0 , I2S_FMT_I2S = 1 , } cocci_id@p ;
