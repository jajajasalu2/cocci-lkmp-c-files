...
typedef rwlock_t;
@@
 struct ping_table {  struct hlist_nulls_head hash [ PING_HTABLE_SIZE ] ;  rwlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct ping_iter_state cocci_id@p ;
