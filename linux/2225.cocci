...
symbol cocci_id;
position p;
typedef sense_reason_t,uint8_t;
@@
 struct {  uint8_t page ;  sense_reason_t ( * emulate ) ( struct se_cmd * , unsigned char * ) ; } cocci_id@p [ ] ;
...
position p;
@@
 unsigned char cocci_id@p [ SE_SENSE_BUF ] ;
...
position p;
@@
 unsigned char cocci_id@p [ SE_MODE_PAGE_BUF ] ;
...
@@
 sense_reason_t cocci_id@p ( struct se_cmd * cmd , unsigned char * buf ) ;
...
typedef u8,uint8_t;
@@
 struct {  uint8_t page ;  uint8_t subpage ;  int ( * emulate ) ( struct se_cmd * , u8 , unsigned char * ) ; } cocci_id@p [ ] ;
