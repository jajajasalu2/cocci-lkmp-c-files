...
position p;
@@
 const struct {  __s32 x ;  __s32 y ; } cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef hid_usage_cmp_t;
@@
 hid_usage_cmp_t cocci_id@p ;
...
position p;
@@
 const struct hid_field * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct hid_usage * usage , unsigned int cur_idx , unsigned int val ) ;
