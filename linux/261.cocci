...
typedef wait_queue_entry_t;
@@
 struct wait_opts {  enum pid_type wo_type ;  int wo_flags ;  struct pid * wo_pid ;  struct waitid_info * wo_info ;  int wo_stat ;  struct rusage * wo_rusage ;  wait_queue_entry_t child_wait ;  int notask_error ; } cocci_id@p ;
...
typedef uid_t,pid_t;
@@
 struct waitid_info {  pid_t pid ;  uid_t uid ;  int status ;  int cause ; } cocci_id@p ;
...
position p;
@@
 struct sighand_struct * const cocci_id@p ;
