...
position p;
@@
 struct ams_delta_nand cocci_id@p ;
...
typedef bool;
@@
 struct ams_delta_nand {  struct nand_controller base ;  struct nand_chip nand_chip ;  struct gpio_desc * gpiod_rdy ;  struct gpio_desc * gpiod_nce ;  struct gpio_desc * gpiod_nre ;  struct gpio_desc * gpiod_nwp ;  struct gpio_desc * gpiod_nwe ;  struct gpio_desc * gpiod_ale ;  struct gpio_desc * gpiod_cle ;  struct gpio_descs * data_gpiods ;  bool data_in ; } cocci_id@p ;
