...
position p;
@@
 struct acpi_hmat_cache * cocci_id@p ;
...
position p;
@@
 struct acpi_table_hmat cocci_id@p ;
...
typedef bool;
@@
 struct memory_target {  struct list_head node ;  unsigned int memory_pxm ;  unsigned int processor_pxm ;  struct resource memregions ;  struct node_hmem_attrs hmem_attrs ;  struct list_head caches ;  struct node_cache_attrs cache_attrs ;  bool registered ; } cocci_id@p ;
...
position p;
@@
 enum acpi_hmat_type cocci_id@p ;
...
position p;
@@
 struct memory_initiator * cocci_id@p ;
...
position p;
@@
 struct memory_locality * cocci_id@p ;
...
position p;
@@
 struct memory_initiator {  struct list_head node ;  unsigned int processor_pxm ; } cocci_id@p ;
...
position p;
@@
 enum locality_types { WRITE_LATENCY , READ_LATENCY , WRITE_BANDWIDTH , READ_BANDWIDTH , } cocci_id@p ;
...
position p;
@@
 struct acpi_hmat_locality * cocci_id@p ;
...
position p;
@@
 struct acpi_hmat_structure * cocci_id@p ;
...
position p;
@@
 struct target_cache {  struct list_head node ;  struct node_cache_attrs cache_attrs ; } cocci_id@p ;
...
position p;
@@
 struct memory_locality {  struct list_head node ;  struct acpi_hmat_locality * hmat_loc ; } cocci_id@p ;
...
position p;
@@
 struct acpi_srat_mem_affinity * cocci_id@p ;
...
position p;
@@
 struct target_cache * cocci_id@p ;
...
position p;
@@
 struct memregion_info cocci_id@p ;
...
position p;
@@
 struct acpi_hmat_proximity_domain * cocci_id@p ;
...
position p;
@@
 struct memory_locality * cocci_id@p [ 4 ] ;
...
position p;
@@
 struct memory_target * cocci_id@p ;
