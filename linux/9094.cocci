...
position p;
@@
 struct aes_gcm_keymat * cocci_id@p ;
...
position p;
@@
 struct mlx5e_ipsec_modify_state_work * cocci_id@p ;
...
position p;
@@
 struct mlx5e_ipsec_modify_state_work {  struct work_struct work ;  struct mlx5_accel_esp_xfrm_attrs attrs ;  struct mlx5e_ipsec_sa_entry * sa_entry ; } cocci_id@p ;
...
position p;
@@
 struct aead_geniv_ctx * cocci_id@p ;
