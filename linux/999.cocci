...
position p;
@@
 struct ubi_eba_leb_desc cocci_id@p ;
...
position p;
@@
 struct ubi_vid_io_buf * cocci_id@p ;
...
position p;
@@
 struct ubi_fm_volhdr cocci_id@p ;
...
position p;
@@
 struct ubi_fm_scan_pool cocci_id@p ;
...
position p;
@@
 struct ubi_fastmap_layout * cocci_id@p ;
