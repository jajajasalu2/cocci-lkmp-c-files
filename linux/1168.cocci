...
typedef u8,u32;
@@
 void cocci_id@p ( struct musb * musb , u8 epnum , struct urb * urb , int is_out , u8 * buf , u32 offset , u32 len ) ;
...
typedef u8;
@@
 struct musb_temp_buffer {  void * kmalloc_ptr ;  void * old_xfer_buffer ;  u8 data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct musb_temp_buffer * cocci_id@p ;
