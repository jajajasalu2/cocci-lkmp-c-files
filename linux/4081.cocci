...
position p;
@@
 struct devfreq_freqs * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ DEVFREQ_NAME_LEN + 1 ] ;
...
position p;
@@
 struct devfreq_notifier_devres {  struct devfreq * devfreq ;  struct notifier_block * nb ;  unsigned int list ; } cocci_id@p ;
...
position p;
@@
 const struct devfreq_governor * cocci_id@p ;
...
position p;
@@
 struct devfreq_notifier_devres * cocci_id@p ;
