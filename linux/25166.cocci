...
position p;
@@
 enum operation_mode_e { list = 1 , show , show_all , } cocci_id@p ;
...
position p;
@@
 struct cpupower_topology cocci_id@p ;
...
position p;
@@
 struct cpuidle_monitor * cocci_id@p [ MONITORS_MAX ] ;
