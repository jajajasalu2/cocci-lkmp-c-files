...
position p;
@@
 struct i82875p_error_info cocci_id@p ;
...
position p;
@@
 const struct i82875p_dev_info cocci_id@p [ ] ;
...
position p;
@@
 struct i82875p_pvt {  struct pci_dev * ovrfl_pdev ;  void __iomem * ovrfl_window ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct i82875p_error_info {  u16 errsts ;  u32 eap ;  u8 des ;  u8 derrsyn ;  u16 errsts2 ; } cocci_id@p ;
...
position p;
@@
 enum i82875p_chips { I82875P = 0 , } cocci_id@p ;
...
position p;
@@
 struct i82875p_dev_info {  const char * ctl_name ; } cocci_id@p ;
