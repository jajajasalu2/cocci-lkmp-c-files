...
position p;
@@
 struct drm_amdgpu_info_gds cocci_id@p ;
...
position p;
@@
 struct amdgpu_bo_list * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_info_firmware * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_info_vram_gtt cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_info_num_handles cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_info_hw_ip * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_memory_info cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_query_fw cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_info_vce_clock_table cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_info_device cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_info * cocci_id@p ;
