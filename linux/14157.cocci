...
position p;
@@
 enum viacam_opstate { S_IDLE = 0 , S_RUNNING = 1 , } cocci_id@p ;
...
position p;
@@
 struct via_buffer {  struct vb2_v4l2_buffer vbuf ;  struct list_head queue ; } cocci_id@p ;
...
position p;
@@
 enum viacam_opstate cocci_id@p ;
...
position p;
@@
 struct viafb_pm_hooks cocci_id@p ;
...
typedef u32,__u32;
@@
 struct via_format {  __u32 pixelformat ;  int bpp ;  u32 mbus_code ; } cocci_id@p [ ] ;
