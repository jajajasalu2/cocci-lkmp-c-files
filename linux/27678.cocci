...
position p;
@@
 struct buffer_head * cocci_id@p ( struct inode * , struct ext2_xattr_header * ) ;
...
position p;
@@
 struct ext2_xattr_header cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * , struct buffer_head * , struct ext2_xattr_header * ) ;
...
position p;
@@
 void cocci_id@p ( struct ext2_xattr_header * , struct ext2_xattr_entry * ) ;
...
position p;
@@
 struct ext2_xattr_entry * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mb_cache * , struct buffer_head * ) ;
