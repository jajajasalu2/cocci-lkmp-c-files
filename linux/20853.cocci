...
position p;
@@
 struct fixed_mtrr_segment * cocci_id@p ;
...
typedef u64;
@@
 struct fixed_mtrr_segment {  u64 start ;  u64 end ;  int range_shift ;  int range_start ; } cocci_id@p ;
...
typedef u64,bool;
@@
 struct mtrr_iter {  struct kvm_mtrr * mtrr_state ;  u64 start ;  u64 end ;  int mem_type ;  bool mtrr_disabled ;  bool partial_map ;  union {  struct {  int index ;  int seg ; } ;  struct {  struct kvm_mtrr_range * range ;  u64 start_max ; } ; } ;  bool fixed ; } cocci_id@p ;
...
position p;
@@
 struct kvm_mtrr_range * cocci_id@p ;
