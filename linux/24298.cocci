...
position p;
@@
 struct brnf_frag_data * cocci_id@p ;
...
typedef u8,u16;
@@
 struct brnf_frag_data {  char mac [ NF_BRIDGE_MAX_MAC_HEADER_LENGTH ] ;  u8 encap_size ;  u8 size ;  u16 vlan_tci ;  __be16 vlan_proto ; } cocci_id@p ;
...
position p;
@@
 const struct nf_bridge_info * cocci_id@p ;
...
position p;
@@
 const struct nf_hook_entries * cocci_id@p ;
...
position p;
@@
 const struct nf_br_ops cocci_id@p ;
