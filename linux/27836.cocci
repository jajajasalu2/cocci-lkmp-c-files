...
position p;
@@
 struct ocfs2_dlm_debug cocci_id@p ;
...
position p;
@@
 struct ocfs2_unblock_ctl cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_lock_res * lockres , int blocking ) ;
...
position p;
@@
 enum ocfs2_unblock_action { UNBLOCK_CONTINUE = 0 , UNBLOCK_CONTINUE_POST = 1 , UNBLOCK_STOP_POST = 2 , } cocci_id@p ;
...
position p;
@@
 struct ocfs2_locking_protocol cocci_id@p ;
...
position p;
@@
 struct ocfs2_lock_res * cocci_id@p ;
...
position p;
@@
 struct ocfs2_lock_stats cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ocfs2_super * osb ) ;
...
position p;
@@
 void cocci_id@p ( struct ocfs2_super * osb , struct ocfs2_lock_res * lockres ) ;
...
position p;
@@
 struct ocfs2_super * cocci_id@p ( struct ocfs2_lock_res * lockres ) ;
...
position p;
@@
 struct ocfs2_mask_waiter * cocci_id@p ;
...
position p;
@@
 struct ocfs2_dlm_seq_priv {  struct ocfs2_dlm_debug * p_dlm_debug ;  struct ocfs2_lock_res p_iter_res ;  struct ocfs2_lock_res p_tmp_res ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ocfs2_lock_res * lockres ) ;
...
position p;
@@
 struct ocfs2_orphan_scan_lvb * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ocfs2_super * osb , struct ocfs2_lock_res * lockres , int level , unsigned long caller_ip ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct ocfs2_lock_res * lockres , int level , u32 dlm_flags ) ;
...
position p;
@@
 struct ocfs2_cluster_connection * cocci_id@p ;
...
position p;
@@
 struct ocfs2_global_disk_dqinfo * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct ocfs2_lock_res * lockres ) ;
...
position p;
@@
 void cocci_id@p ( struct ocfs2_lock_res * lockres , int convert ) ;
...
position p;
@@
 struct ocfs2_trim_fs_lvb * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct ocfs2_lock_res * lockres , int new_level , int lvb , unsigned int generation ) ;
...
position p;
@@
 enum ocfs2_lock_type cocci_id@p ;
...
position p;
@@
 struct lock_class_key cocci_id@p [ OCFS2_NUM_LOCK_TYPES ] ;
...
position p;
@@
 struct ocfs2_dlm_lksb * cocci_id@p ;
...
position p;
@@
 struct ocfs2_dlm_seq_priv * cocci_id@p ;
...
position p;
@@
 struct ocfs2_qinfo_lvb * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct buffer_head * * bh ) ;
...
position p;
@@
 struct ocfs2_dentry_lock * cocci_id@p ;
...
position p;
@@
 struct ocfs2_lock_res_ops {  struct ocfs2_super * ( * get_osb ) ( struct ocfs2_lock_res * ) ;  void ( * post_unlock ) ( struct ocfs2_super * , struct ocfs2_lock_res * ) ;  int ( * check_downconvert ) ( struct ocfs2_lock_res * , int ) ;  void ( * set_lvb ) ( struct ocfs2_lock_res * ) ;  int ( * downconvert_worker ) ( struct ocfs2_lock_res * , int ) ;  int flags ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_file_private * cocci_id@p ;
...
position p;
@@
 struct ocfs2_mem_dqinfo * cocci_id@p ;
...
position p;
@@
 struct ocfs2_lock_res_ops cocci_id@p ;
...
position p;
@@
 struct ocfs2_meta_lvb * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_lock_res * lockres , int new_level ) ;
...
position p;
@@
 unsigned int cocci_id@p ( struct ocfs2_lock_res * lockres , int new_level ) ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_lock_res * lockres , int wanted ) ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_lock_res * lockres , int level ) ;
...
position p;
@@
 struct ocfs2_unblock_ctl {  int requeue ;  enum ocfs2_unblock_action unblock_action ; } cocci_id@p ;
