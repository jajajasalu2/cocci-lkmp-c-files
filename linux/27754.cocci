...
position p;
@@
 ntfs_attr_search_ctx cocci_id@p ;
...
position p;
@@
 RESTART_PAGE_HEADER * * cocci_id@p ;
...
position p;
@@
 const NTFS_BOOT_SECTOR * cocci_id@p ;
...
position p;
@@
 enum { ON_ERRORS_PANIC = 0x01 , ON_ERRORS_REMOUNT_RO = 0x02 , ON_ERRORS_CONTINUE = 0x04 , ON_ERRORS_RECOVER = 0x10 , } cocci_id@p ;
