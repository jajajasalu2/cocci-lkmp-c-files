...
position p;
@@
 enum injection_type { SW_INJ = 0 , HW_INJ , DFR_INT_INJ , THR_INT_INJ , N_INJ_TYPES , } cocci_id@p ;
...
typedef umode_t;
@@
 struct dfs_node {  char * name ;  const struct file_operations * fops ;  umode_t perm ; } cocci_id@p [ ] ;
...
position p;
@@
 enum injection_type cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_FLAG_OPT_SIZE ] ;
