...
position p;
@@
 enum i82975x_chips { I82975X = 0 , } cocci_id@p ;
...
position p;
@@
 const struct i82975x_dev_info cocci_id@p [ ] ;
...
position p;
@@
 struct i82975x_error_info * cocci_id@p ;
...
position p;
@@
 struct i82975x_pvt {  void __iomem * mch_window ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct i82975x_error_info {  u16 errsts ;  u32 eap ;  u8 des ;  u8 derrsyn ;  u16 errsts2 ;  u8 chan ;  u8 xeap ; } cocci_id@p ;
...
position p;
@@
 struct i82975x_dev_info {  const char * ctl_name ; } cocci_id@p ;
