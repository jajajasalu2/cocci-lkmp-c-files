...
typedef u32;
@@
 struct i7core_info {  u32 mc_control ;  u32 mc_status ;  u32 max_dod ;  u32 ch_map ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct i7core_channel {  bool is_3dimms_present ;  bool is_single_4rank ;  bool has_4rank ;  u32 dimms ; } cocci_id@p ;
...
position p;
@@
 struct memdev_dmi_entry * cocci_id@p ;
...
position p;
@@
 struct pci_id_table {  const struct pci_id_descr * descr ;  int n_devs ; } cocci_id@p ;
...
position p;
@@
 struct pci_id_descr {  int dev ;  int func ;  int dev_id ;  int optional ; } cocci_id@p ;
...
typedef u8;
@@
 struct i7core_dev {  struct list_head list ;  u8 socket ;  struct pci_dev * * pdev ;  int n_devs ;  struct mem_ctl_info * mci ; } cocci_id@p ;
