...
typedef u8;
@@
 struct max77693_muic_info {  struct device * dev ;  struct max77693_dev * max77693 ;  struct extcon_dev * edev ;  int prev_cable_type ;  int prev_cable_type_gnd ;  int prev_chg_type ;  int prev_button_type ;  u8 status [ 2 ] ;  int irq ;  struct work_struct irq_work ;  struct mutex mutex ;  struct delayed_work wq_detcable ;  struct input_dev * dock ;  int path_usb ;  int path_uart ; } cocci_id@p ;
...
position p;
@@
 struct max77693_muic_platform_data * cocci_id@p ;
...
position p;
@@
 struct max77693_muic_irq * cocci_id@p ;
...
position p;
@@
 struct max77693_platform_data * cocci_id@p ;
...
position p;
@@
 struct max77693_muic_info * cocci_id@p ;
...
position p;
@@
 enum max77693_muic_charger_type { MAX77693_CHARGER_TYPE_NONE = 0 , MAX77693_CHARGER_TYPE_USB , MAX77693_CHARGER_TYPE_DOWNSTREAM_PORT , MAX77693_CHARGER_TYPE_DEDICATED_CHG , MAX77693_CHARGER_TYPE_APPLE_500MA , MAX77693_CHARGER_TYPE_APPLE_1A_2A , MAX77693_CHARGER_TYPE_DEAD_BATTERY = 7 , } cocci_id@p ;
...
position p;
@@
 enum max77693_muic_adc_debounce_time { ADC_DEBOUNCE_TIME_5MS = 0 , ADC_DEBOUNCE_TIME_10MS , ADC_DEBOUNCE_TIME_25MS , ADC_DEBOUNCE_TIME_38_62MS , } cocci_id@p ;
...
position p;
@@
 enum max77693_muic_cable_group cocci_id@p ;
...
position p;
@@
 struct max77693_reg_data cocci_id@p [ ] ;
...
position p;
@@
 enum max77693_muic_adc_debounce_time cocci_id@p ;
...
position p;
@@
 enum max77693_muic_cable_group { MAX77693_CABLE_GROUP_ADC = 0 , MAX77693_CABLE_GROUP_ADC_GND , MAX77693_CABLE_GROUP_CHG , MAX77693_CABLE_GROUP_VBVOLT , } cocci_id@p ;
...
position p;
@@
 struct max77693_muic_irq {  unsigned int irq ;  const char * name ;  unsigned int virq ; } cocci_id@p ;
