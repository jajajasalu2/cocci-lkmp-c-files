...
position p;
@@
 struct qcom_reset_controller * cocci_id@p ;
...
position p;
@@
 struct qcom_cc {  struct qcom_reset_controller reset ;  struct clk_regmap * * rclks ;  size_t num_rclks ; } cocci_id@p ;
