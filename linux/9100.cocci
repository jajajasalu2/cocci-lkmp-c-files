...
position p;
@@
 struct mlx5e_ethtool_table * cocci_id@p ;
...
position p;
@@
 struct mlx5e_ethtool_rule * cocci_id@p ;
...
position p;
@@
 enum mlx5e_rq_group cocci_id@p ;
...
position p;
@@
 struct mlx5e_ethtool_rule {  struct list_head list ;  struct ethtool_rx_flow_spec flow_spec ;  struct mlx5_flow_handle * rule ;  struct mlx5e_ethtool_table * eth_ft ; } cocci_id@p ;
