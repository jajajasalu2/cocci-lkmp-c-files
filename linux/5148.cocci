...
position p;
@@
 const struct tegra_gpio_port * cocci_id@p ;
...
position p;
@@
 struct tegra_gpio_soc {  const struct tegra_gpio_port * ports ;  unsigned int num_ports ;  const char * name ;  unsigned int instance ; } cocci_id@p ;
...
position p;
@@
 struct tegra_gpio_port {  const char * name ;  unsigned int bank ;  unsigned int port ;  unsigned int pins ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_gpio_soc cocci_id@p ;
...
position p;
@@
 struct tegra_gpio {  struct gpio_chip gpio ;  struct irq_chip intc ;  unsigned int num_irq ;  unsigned int * irq ;  const struct tegra_gpio_soc * soc ;  void __iomem * secure ;  void __iomem * base ; } cocci_id@p ;
