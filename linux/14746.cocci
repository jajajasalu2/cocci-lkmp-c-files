...
position p;
@@
 const struct max77686_hw_clk_info cocci_id@p [ MAX77686_CLKS_NUM ] ;
...
position p;
@@
 struct max77686_clk_init_data cocci_id@p ;
...
position p;
@@
 const struct max77686_hw_clk_info * cocci_id@p ;
...
position p;
@@
 struct max77686_clk_driver_data {  enum max77686_chip_name chip ;  struct max77686_clk_init_data * max_clk_data ;  size_t num_clks ; } cocci_id@p ;
...
position p;
@@
 struct max77686_clk_driver_data * cocci_id@p ;
...
position p;
@@
 struct max77686_clk_init_data {  struct regmap * regmap ;  struct clk_hw hw ;  struct clk_init_data clk_idata ;  const struct max77686_hw_clk_info * clk_info ; } cocci_id@p ;
...
position p;
@@
 const struct max77686_hw_clk_info cocci_id@p [ MAX77620_CLKS_NUM ] ;
...
position p;
@@
 enum max77686_chip_name { CHIP_MAX77686 , CHIP_MAX77802 , CHIP_MAX77620 , } cocci_id@p ;
...
typedef u32;
@@
 struct max77686_hw_clk_info {  const char * name ;  u32 clk_reg ;  u32 clk_enable_mask ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 const struct max77686_hw_clk_info cocci_id@p [ MAX77802_CLKS_NUM ] ;
