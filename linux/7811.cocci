...
typedef u64,u32;
@@
 struct ntb_msi {  u64 base_addr ;  u64 end_addr ;  void ( * desc_changed ) ( void * ctx ) ;  u32 __iomem * peer_mws [ ] ; } cocci_id@p ;
...
position p;
@@
 struct ntb_msi_devres * cocci_id@p ;
...
position p;
@@
 struct ntb_msi_devres {  struct ntb_dev * ntb ;  struct msi_desc * entry ;  struct ntb_msi_desc * msi_desc ; } cocci_id@p ;
