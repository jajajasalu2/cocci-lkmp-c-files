...
position p;
@@
 struct protocol * cocci_id@p [ HASHSZ ] ;
...
position p;
@@
 struct product * cocci_id@p [ HASHSZ ] ;
...
position p;
@@
 struct vendor * cocci_id@p [ HASHSZ ] ;
...
position p;
@@
 struct genericstrtable {  struct genericstrtable * next ;  unsigned int num ;  char name [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct pool {  struct pool * next ;  void * mem ; } cocci_id@p ;
...
position p;
@@
 struct subclass * cocci_id@p [ HASHSZ ] ;
...
position p;
@@
 struct class * cocci_id@p [ HASHSZ ] ;
...
typedef u_int8_t;
@@
 struct class {  struct class * next ;  u_int8_t classid ;  char name [ 1 ] ; } cocci_id@p ;
...
typedef u_int16_t;
@@
 struct vendor {  struct vendor * next ;  u_int16_t vendorid ;  char name [ 1 ] ; } cocci_id@p ;
