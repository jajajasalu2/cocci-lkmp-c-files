...
position p;
@@
 const struct sun4i_spdif_quirks * cocci_id@p ;
...
position p;
@@
 struct sun4i_spdif_dev * cocci_id@p ;
...
position p;
@@
 struct sun4i_spdif_dev {  struct platform_device * pdev ;  struct clk * spdif_clk ;  struct clk * apb_clk ;  struct reset_control * rst ;  struct snd_soc_dai_driver cpu_dai_drv ;  struct regmap * regmap ;  struct snd_dmaengine_dai_dma_data dma_params_tx ;  const struct sun4i_spdif_quirks * quirks ; } cocci_id@p ;
...
typedef bool;
@@
 struct sun4i_spdif_quirks {  unsigned int reg_dac_txdata ;  bool has_reset ;  unsigned int val_fctl_ftx ; } cocci_id@p ;
