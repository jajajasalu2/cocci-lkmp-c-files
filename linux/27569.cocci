...
position p;
@@
 struct recorded_ref * cocci_id@p ;
...
position p;
@@
 enum btrfs_compare_tree_result cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_send_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_timespec cocci_id@p ;
...
typedef u8;
@@
 int ( * cocci_id@p ) ( int num , struct btrfs_key * di_key , const char * name , int name_len , const char * data , int data_len , u8 type , void * ctx ) ;
...
position p;
@@
 struct parent_paths_ctx {  struct list_head * refs ;  struct send_ctx * sctx ; } cocci_id@p ;
...
typedef u64;
@@
 struct waiting_dir_move * cocci_id@p ( struct send_ctx * sctx , u64 ino ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct btrfs_path * left_path , struct btrfs_path * right_path , struct btrfs_key * key , enum btrfs_compare_tree_result result , void * ctx ) ;
...
position p;
@@
 enum inode_state { inode_state_no_change , inode_state_will_create , inode_state_did_create , inode_state_will_delete , inode_state_did_delete , } cocci_id@p ;
...
position p;
@@
 enum btrfs_compare_tree_result { BTRFS_COMPARE_TREE_NEW , BTRFS_COMPARE_TREE_DELETED , BTRFS_COMPARE_TREE_CHANGED , BTRFS_COMPARE_TREE_SAME , } cocci_id@p ;
...
position p;
@@
 struct btrfs_stream_header cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct send_ctx * sctx , u64 dir_ino ) ;
...
position p;
@@
 struct pending_dir_move * cocci_id@p ;
...
typedef u64;
@@
 struct orphan_dir_info {  struct rb_node node ;  u64 ino ;  u64 gen ;  u64 last_dir_index_offset ; } cocci_id@p ;
...
position p;
@@
 struct name_cache_entry cocci_id@p ;
...
symbol cocci_id;
position p;
typedef btrfs_changed_cb_t;
@@
 btrfs_changed_cb_t cocci_id@p ;
...
position p;
@@
 const struct btrfs_root * cocci_id@p ;
...
typedef u64;
@@
 struct name_cache_entry {  struct list_head list ;  struct list_head radix_list ;  u64 ino ;  u64 gen ;  u64 parent_ino ;  u64 parent_gen ;  int ret ;  int need_later_update ;  int name_len ;  char name [ ] ; } cocci_id@p ;
...
position p;
@@
 struct waiting_dir_move cocci_id@p ;
...
position p;
@@
 struct find_ref_ctx * cocci_id@p ;
...
position p;
@@
 struct parent_paths_ctx cocci_id@p ;
...
position p;
@@
 struct orphan_dir_info * cocci_id@p ;
...
position p;
@@
 struct find_xattr_ctx {  const char * name ;  int name_len ;  int found_idx ;  char * found_data ;  int found_data_len ; } cocci_id@p ;
...
typedef u64;
@@
 struct recorded_ref {  struct list_head list ;  char * name ;  struct fs_path * full_path ;  u64 dir ;  u64 dir_gen ;  int name_len ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef iterate_dir_item_t;
@@
 iterate_dir_item_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef iterate_inode_ref_t;
@@
 iterate_inode_ref_t cocci_id@p ;
...
typedef u64;
@@
 struct find_ref_ctx {  u64 dir ;  u64 dir_gen ;  struct btrfs_root * root ;  struct fs_path * name ;  int found_idx ; } cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct send_ctx * sctx , u64 ino ) ;
...
typedef u64;
@@
 struct backref_ctx {  struct send_ctx * sctx ;  u64 found ;  u64 cur_objectid ;  u64 cur_offset ;  u64 extent_len ;  u64 data_offset ;  int found_itself ; } cocci_id@p ;
...
typedef u64,bool;
@@
 struct waiting_dir_move {  struct rb_node node ;  u64 ino ;  u64 rmdir_ino ;  bool orphanized ; } cocci_id@p ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( int num , u64 dir , int index , struct fs_path * p , void * ctx ) ;
...
typedef u64;
@@
 struct clone_root {  struct btrfs_root * root ;  u64 ino ;  u64 offset ;  u64 found_refs ; } cocci_id@p ;
...
position p;
@@
 struct find_xattr_ctx * cocci_id@p ;
...
position p;
@@
 struct btrfs_tlv_header * cocci_id@p ;
...
typedef u64;
@@
 struct pending_dir_move {  struct rb_node node ;  struct list_head list ;  u64 parent_ino ;  u64 ino ;  u64 gen ;  struct list_head update_refs ; } cocci_id@p ;
...
position p;
@@
 struct fs_path {  union {  struct {  char * start ;  char * end ;  char * buf ;  unsigned short buf_len : 15 ;  unsigned short reversed : 1 ;  char inline_buf [ ] ; } ;  char pad [ 256 ] ; } ; } cocci_id@p ;
...
position p;
@@
 struct btrfs_cmd_header * cocci_id@p ;
