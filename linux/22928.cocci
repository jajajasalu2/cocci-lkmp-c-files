...
position p;
@@
 struct snd_pcm_oss_file * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_pcm_oss_file * pcm_oss_file ) ;
...
position p;
@@
 struct snd_pcm_plugin_channel * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_oss_setup cocci_id@p [ 2 ] ;
...
position p;
@@
 struct snd_pcm_plugin * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_notify cocci_id@p ;
...
position p;
@@
 struct snd_pcm_oss_setup * cocci_id@p ;
...
position p;
@@
 struct audio_buf_info cocci_id@p ;
