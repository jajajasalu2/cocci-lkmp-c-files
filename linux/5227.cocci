...
position p;
@@
 struct pata_icside_info cocci_id@p ;
...
@@
 const expansioncard_ops_t cocci_id@p ;
...
position p;
@@
 const struct portinfo cocci_id@p ;
...
position p;
@@
 struct pata_icside_state * cocci_id@p ;
...
position p;
@@
 struct portinfo {  unsigned int dataoffset ;  unsigned int ctrloffset ;  unsigned int stepping ; } cocci_id@p ;
...
typedef u8;
@@
 struct pata_icside_state {  void __iomem * irq_port ;  void __iomem * ioc_base ;  unsigned int type ;  unsigned int dma ;  struct {  u8 port_sel ;  u8 disabled ;  unsigned int speed [ ATA_MAX_DEVICES ] ; } port [ 2 ] ; } cocci_id@p ;
...
typedef expansioncard_ops_t;
@@
 struct pata_icside_info {  struct pata_icside_state * state ;  struct expansion_card * ec ;  void __iomem * base ;  void __iomem * irqaddr ;  unsigned int irqmask ;  const expansioncard_ops_t * irqops ;  unsigned int mwdma_mask ;  unsigned int nr_ports ;  const struct portinfo * port [ 2 ] ;  unsigned long raw_base ;  unsigned long raw_ioc_base ; } cocci_id@p ;
