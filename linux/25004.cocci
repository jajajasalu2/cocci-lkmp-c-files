...
position p;
@@
 const struct nla_policy cocci_id@p [ NUM_BATADV_ATTR ] ;
...
position p;
@@
 enum batadv_nl_commands cocci_id@p ;
...
position p;
@@
 enum batadv_genl_ops_flags { BATADV_FLAG_NEED_MESH = BIT ( 0 ) , BATADV_FLAG_NEED_HARDIF = BIT ( 1 ) , BATADV_FLAG_NEED_VLAN = BIT ( 2 ) , } cocci_id@p ;
...
position p;
@@
 enum batadv_netlink_multicast_groups { BATADV_NL_MCGRP_CONFIG , BATADV_NL_MCGRP_TPMETER , } cocci_id@p ;
