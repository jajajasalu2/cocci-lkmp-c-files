...
position p;
@@
 struct mlxsw_sib_port cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_sib_port {  struct mlxsw_sib * mlxsw_sib ;  u8 local_port ;  struct {  u8 module ; } mapping ; } cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_sib {  struct mlxsw_sib_port * * ports ;  struct mlxsw_core * core ;  const struct mlxsw_bus_info * bus_info ;  u8 hw_id [ ETH_ALEN ] ; } cocci_id@p ;
