...
position p;
@@
 struct smb2_lease_break_work * cocci_id@p ;
...
typedef __le32,__u8;
@@
 struct smb2_lease_break_work {  struct work_struct lease_break ;  struct tcon_link * tlink ;  __u8 lease_key [ 16 ] ;  __le32 lease_state ; } cocci_id@p ;
...
typedef bool;
@@
 const bool cocci_id@p [ NUMBER_OF_SMB2_COMMANDS ] ;
...
position p;
@@
 struct close_cancelled_open * cocci_id@p ;
...
position p;
@@
 struct smb2_lease_break * cocci_id@p ;
