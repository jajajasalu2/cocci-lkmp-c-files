...
typedef __le32;
@@
 struct dma64desc {  __le32 ctrl1 ;  __le32 ctrl2 ;  __le32 addrlow ;  __le32 addrhigh ; } cocci_id@p ;
...
position p;
@@
 struct brcms_ampdu_session * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,u16,uint,dma_addr_t;
@@
 struct dma_info {  struct dma_pub dma ;  char name [ MAXNAMEL ] ;  struct bcma_device * core ;  struct device * dmadev ;  struct brcms_ampdu_session ampdu_session ;  bool dma64 ;  bool addrext ;  uint d64txregbase ;  uint d64rxregbase ;  struct dma64desc * txd64 ;  struct dma64desc * rxd64 ;  u16 dmadesc_align ;  u16 ntxd ;  u16 txin ;  u16 txout ;  struct sk_buff * * txp ;  dma_addr_t txdpa ;  dma_addr_t txdpaorig ;  u16 txdalign ;  u32 txdalloc ;  u32 xmtptrbase ;  u16 nrxd ;  u16 rxin ;  u16 rxout ;  struct sk_buff * * rxp ;  dma_addr_t rxdpa ;  dma_addr_t rxdpaorig ;  u16 rxdalign ;  u32 rxdalloc ;  u32 rcvptrbase ;  unsigned int rxbufsize ;  uint rxextrahdrroom ;  uint nrxpost ;  unsigned int rxoffset ;  uint ddoffsetlow ;  uint ddoffsethigh ;  uint dataoffsetlow ;  uint dataoffsethigh ;  bool aligndesc_4k ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * pkt , void * arg_a ) ;
