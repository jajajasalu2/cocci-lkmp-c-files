...
position p;
@@
 struct spear_pmx_mode * cocci_id@p ;
...
position p;
@@
 struct spear_gpio_pingroup * cocci_id@p ;
...
position p;
@@
 const struct spear_modemux * cocci_id@p ;
...
position p;
@@
 const struct spear_pingroup * cocci_id@p ;
...
position p;
@@
 struct spear_pinctrl_machdata * cocci_id@p ;
...
position p;
@@
 struct spear_muxreg * cocci_id@p ;
...
position p;
@@
 struct spear_pingroup * cocci_id@p ;
...
position p;
@@
 struct spear_modemux * cocci_id@p ;
