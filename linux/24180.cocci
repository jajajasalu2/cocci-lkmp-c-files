...
position p;
@@
 struct xfrm6_protocol cocci_id@p ;
...
position p;
@@
 struct ipv6_destopt_hao * cocci_id@p ;
...
position p;
@@
 union {  struct ipv6hdr * iph ;  struct ipv6_opt_hdr * opth ;  struct ipv6_rt_hdr * rth ;  char * raw ; } cocci_id@p ;
...
position p;
@@
 struct ah_skb_cb {  struct xfrm_skb_cb xfrm ;  void * tmp ; } cocci_id@p ;
...
position p;
@@
 struct tmp_ext { #if IS_ENABLED(CONFIG_IPV6_MIP6)  struct in6_addr saddr ; #endif  struct in6_addr daddr ;  char hdrs [ 0 ] ; } cocci_id@p ;
