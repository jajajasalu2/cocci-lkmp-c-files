...
typedef uint64_t;
@@
 char cocci_id@p [ CMSG_SPACE ( sizeof ( uint64_t ) ) ] ;
...
position p;
@@
 struct timed_send cocci_id@p [ MAX_NUM_PKT ] ;
...
typedef int64_t;
@@
 struct timed_send {  char data ;  int64_t delay_us ; } cocci_id@p ;
