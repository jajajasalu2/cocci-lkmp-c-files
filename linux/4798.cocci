...
position p;
@@
 char cocci_id@p [ RDMA_NLDEV_ATTR_CHARDEV_TYPE_SIZE ] ;
...
symbol cocci_id;
position p;
typedef res_fill_func_t;
@@
 res_fill_func_t cocci_id@p ;
...
position p;
@@
 enum rdma_nl_counter_mask cocci_id@p ;
...
position p;
@@
 struct rdma_restrack_root * cocci_id@p ;
...
typedef u8,u32;
@@
 struct nldev_fill_res_entry {  enum rdma_nldev_attr nldev_attr ;  enum rdma_nldev_command nldev_cmd ;  u8 flags ;  u32 entry ;  u32 id ; } cocci_id@p ;
...
position p;
@@
 enum rdma_nldev_print_type cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ IB_FW_VERSION_NAME_MAX ] ;
...
position p;
@@
 enum rdma_nl_counter_mode cocci_id@p ;
...
position p;
@@
 const struct nldev_fill_res_entry cocci_id@p [ RDMA_RESTRACK_MAX ] ;
...
position p;
@@
 const struct nldev_fill_res_entry * cocci_id@p ;
...
position p;
@@
 struct rdma_link_ops * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ RDMA_NLDEV_ATTR_MAX ] ;
...
position p;
@@
 enum nldev_res_flags { NLDEV_PER_DEV = 1 << 0 , } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ RDMA_RESTRACK_MAX ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ RDMA_NLDEV_ATTR_MAX ] ;
...
position p;
@@
 enum rdma_restrack_type cocci_id@p ;
...
position p;
@@
 struct rdma_counter_mode * cocci_id@p ;
...
position p;
@@
 const struct rdma_link_ops * cocci_id@p ;
...
position p;
@@
 const struct rdma_nl_cbs cocci_id@p [ RDMA_NLDEV_NUM_OPS ] ;
