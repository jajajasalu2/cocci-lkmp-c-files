...
position p;
@@
 struct nilfs_palloc_group_desc * cocci_id@p ;
...
position p;
@@
 struct nilfs_palloc_req * cocci_id@p ;
...
position p;
@@
 struct nilfs_palloc_cache * cocci_id@p ;
...
position p;
@@
 const struct nilfs_palloc_group_desc * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct inode * , struct buffer_head * , void * ) ;
...
position p;
@@
 struct nilfs_bh_assoc * cocci_id@p ;
