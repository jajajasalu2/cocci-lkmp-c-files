...
position p;
@@
 struct physdev_manage_pci cocci_id@p ;
...
position p;
@@
 struct physdev_pci_device_add * cocci_id@p ;
...
position p;
@@
 struct physdev_pci_mmcfg_reserved cocci_id@p ;
...
position p;
@@
 struct physdev_manage_pci_ext cocci_id@p ;
...
typedef uint32_t;
@@
 struct {  struct physdev_pci_device_add add ;  uint32_t pxm ; } cocci_id@p ;
