...
position p;
@@
 struct uniphier_mdmac_desc {  struct virt_dma_desc vd ;  struct scatterlist * sgl ;  unsigned int sg_len ;  unsigned int sg_cur ;  enum dma_transfer_direction dir ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_mdmac_device * cocci_id@p ;
...
position p;
@@
 struct uniphier_mdmac_chan {  struct virt_dma_chan vc ;  struct uniphier_mdmac_device * mdev ;  struct uniphier_mdmac_desc * md ;  void __iomem * reg_ch_base ;  unsigned int chan_id ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_mdmac_device {  struct dma_device ddev ;  struct clk * clk ;  void __iomem * reg_base ;  struct uniphier_mdmac_chan channels [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_mdmac_desc cocci_id@p ;
...
position p;
@@
 struct uniphier_mdmac_chan * cocci_id@p ;
