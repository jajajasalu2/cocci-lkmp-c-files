...
position p;
@@
 struct host_cmd_ds_802_11_associate * cocci_id@p ;
...
position p;
@@
 union ieee_types_phy_param_set cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_htinfo cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_ad_hoc_join * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_ad_hoc_start * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_ad_hoc_join_result * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_rsn_param_set * cocci_id@p ;
...
position p;
@@
 struct ieee_types_assoc_rsp cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_ad_hoc_start_result * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_ssid_param_set * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_auth_type * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_phy_param_set * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_ss_param_set * cocci_id@p ;
...
position p;
@@
 union ieee_types_ss_param_set cocci_id@p ;
