...
position p;
@@
 enum { ID_DAC5311 = 0 , ID_DAC6311 , ID_DAC7311 , } cocci_id@p ;
...
typedef u8;
@@
 struct ti_dac_spec {  u8 resolution ; } cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct ti_dac_chip {  struct mutex lock ;  struct regulator * vref ;  struct spi_device * spi ;  u16 val ;  bool powerdown ;  u8 powerdown_mode ;  u8 resolution ;  u8 buf [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum { POWER_1KOHM_TO_GND = 0 , POWER_100KOHM_TO_GND , POWER_TRI_STATE , } cocci_id@p ;
