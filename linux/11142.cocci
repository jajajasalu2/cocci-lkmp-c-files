...
position p;
@@
 const struct dcn_optc_registers cocci_id@p [ ] ;
...
position p;
@@
 struct resource_funcs cocci_id@p ;
...
position p;
@@
 struct irq_service_init_data cocci_id@p ;
...
position p;
@@
 const struct dcn20_dsc_mask cocci_id@p ;
...
position p;
@@
 struct dc_writeback_info * cocci_id@p ;
...
position p;
@@
 struct timing_generator * cocci_id@p ;
...
position p;
@@
 const struct dcn20_mmhubbub_mask cocci_id@p ;
...
position p;
@@
 const struct dce110_aux_registers_shift cocci_id@p ;
...
position p;
@@
 enum dcn20_clk_src_array_id { DCN20_CLK_SRC_PLL0 , DCN20_CLK_SRC_PLL1 , DCN20_CLK_SRC_PLL2 , DCN20_CLK_SRC_PLL3 , DCN20_CLK_SRC_PLL4 , DCN20_CLK_SRC_PLL5 , DCN20_CLK_SRC_TOTAL , } cocci_id@p ;
...
position p;
@@
 const struct dce_abm_mask cocci_id@p ;
...
position p;
@@
 const struct dce110_clk_src_regs cocci_id@p [ ] ;
...
position p;
@@
 const struct dcn10_link_enc_aux_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dccg_mask cocci_id@p ;
...
position p;
@@
 const struct dcn_vmid_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dce_i2c_shift cocci_id@p ;
...
position p;
@@
 const struct dce_abm_shift cocci_id@p ;
...
position p;
@@
 const struct dcn_hubp2_shift cocci_id@p ;
...
position p;
@@
 const struct dce110_aux_registers cocci_id@p [ ] ;
...
position p;
@@
 struct resource_straps * cocci_id@p ;
...
position p;
@@
 const struct dcn20_opp_shift cocci_id@p ;
...
position p;
@@
 struct output_pixel_processor * cocci_id@p ;
...
position p;
@@
 struct dcn20_mmhubbub * cocci_id@p ;
...
position p;
@@
 const struct dce_hwseq_registers cocci_id@p ;
...
position p;
@@
 const struct dce_hwseq_mask cocci_id@p ;
...
position p;
@@
 const struct dcn10_stream_encoder_mask cocci_id@p ;
...
position p;
@@
 display_pipe_source_params_st * cocci_id@p ;
...
position p;
@@
 const struct dce_audio_mask cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_ip_params_st cocci_id@p ;
...
position p;
@@
 struct dcn20_link_encoder cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_voltage_scaling_st cocci_id@p [ MAX_CLOCK_LIMIT_STATES ] ;
...
position p;
@@
 struct input_pixel_processor * cocci_id@p ;
...
position p;
@@
 struct pixel_clk_params * cocci_id@p ;
...
position p;
@@
 const struct dcn_optc_shift cocci_id@p ;
...
position p;
@@
 const struct dcn2_dpp_shift cocci_id@p ;
...
position p;
@@
 const struct dce_i2c_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dccg_registers cocci_id@p ;
...
position p;
@@
 const struct dcn10_stream_enc_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dce_hwseq_shift cocci_id@p ;
...
position p;
@@
 const struct dc_debug_options cocci_id@p ;
...
position p;
@@
 enum swizzle_mode_values cocci_id@p ;
...
position p;
@@
 const struct dcn10_ipp_shift cocci_id@p ;
...
position p;
@@
 const struct dcn20_dwbc_shift cocci_id@p ;
...
position p;
@@
 const struct dcn20_mmhubbub_registers cocci_id@p [ ] ;
...
position p;
@@
 enum clock_source_id cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_soc_bounding_box_st cocci_id@p ;
...
position p;
@@
 const struct dce110_clk_src_shift cocci_id@p ;
...
position p;
@@
 const struct dcn20_mpc_mask cocci_id@p ;
...
position p;
@@
 struct dce110_clk_src cocci_id@p ;
...
position p;
@@
 const struct dc_dcc_surface_param * cocci_id@p ;
...
position p;
@@
 enum surface_pixel_format cocci_id@p ;
...
position p;
@@
 const struct bios_registers cocci_id@p ;
...
position p;
@@
 struct display_stream_compressor * cocci_id@p ;
...
position p;
@@
 struct dcn10_stream_encoder cocci_id@p ;
...
position p;
@@
 const struct dcn10_link_enc_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dcn10_stream_encoder_shift cocci_id@p ;
...
position p;
@@
 const struct resource_create_funcs cocci_id@p ;
...
position p;
@@
 struct pp_smu_nv_clock_table cocci_id@p ;
...
position p;
@@
 const struct dce_dmcu_registers cocci_id@p ;
...
position p;
@@
 const struct dcn20_opp_mask cocci_id@p ;
...
position p;
@@
 const struct encoder_feature_support cocci_id@p ;
...
position p;
@@
 struct link_encoder * cocci_id@p ;
...
position p;
@@
 struct dcn20_hubbub cocci_id@p ;
...
position p;
@@
 const struct dce_dmcu_mask cocci_id@p ;
...
position p;
@@
 struct resource_pool * * cocci_id@p ;
...
position p;
@@
 const struct dce_i2c_mask cocci_id@p ;
...
position p;
@@
 const struct dcn20_mmhubbub_shift cocci_id@p ;
...
position p;
@@
 struct clock_source * * cocci_id@p ;
...
position p;
@@
 const struct dc_init_data * cocci_id@p ;
...
position p;
@@
 const struct dcn10_ipp_registers cocci_id@p [ ] ;
...
position p;
@@
 struct aux_engine_dce110 * cocci_id@p ;
...
position p;
@@
 display_pipe_dest_params_st * cocci_id@p ;
...
position p;
@@
 const struct dcn2_dpp_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dcn20_dwbc_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dce110_aux_registers_mask cocci_id@p ;
...
position p;
@@
 const struct dccg_shift cocci_id@p ;
...
position p;
@@
 const struct dcn10_link_enc_shift cocci_id@p ;
...
position p;
@@
 const struct dcn20_dwbc_mask cocci_id@p ;
...
position p;
@@
 display_e2e_pipe_params_st cocci_id@p ;
...
position p;
@@
 struct pp_smu_wm_range_sets cocci_id@p ;
...
position p;
@@
 const struct dcn10_link_enc_mask cocci_id@p ;
...
position p;
@@
 const struct dcn_hubp2_mask cocci_id@p ;
...
position p;
@@
 const struct dcn_hubp2_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dcn20_vmid_mask cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pp_smu_funcs * * pp_smu ) ;
...
position p;
@@
 const struct dcn20_vmid_shift cocci_id@p ;
...
position p;
@@
 const struct dcn_hubbub_shift cocci_id@p ;
...
position p;
@@
 const struct dcn_optc_mask cocci_id@p ;
...
position p;
@@
 const struct dcn_hubbub_registers cocci_id@p ;
...
position p;
@@
 const struct encoder_init_data * cocci_id@p ;
...
position p;
@@
 const struct dcn_hubbub_mask cocci_id@p ;
...
position p;
@@
 const struct resource_caps cocci_id@p ;
...
position p;
@@
 const struct dce_audio_shift cocci_id@p ;
...
position p;
@@
 struct resource_context * cocci_id@p ;
...
position p;
@@
 struct pp_smu_funcs * * cocci_id@p ;
...
position p;
@@
 const struct dce110_clk_src_mask cocci_id@p ;
...
position p;
@@
 const struct gpu_info_soc_bounding_box_v1_0 * cocci_id@p ;
...
position p;
@@
 const struct pipe_ctx * cocci_id@p ;
...
position p;
@@
 const struct dcn2_dpp_mask cocci_id@p ;
...
position p;
@@
 const struct dce_audio_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dcn20_mpc_registers cocci_id@p ;
...
position p;
@@
 const struct dcn20_opp_registers cocci_id@p [ ] ;
...
position p;
@@
 struct _vcs_dpi_voltage_scaling_st cocci_id@p ;
...
position p;
@@
 struct dcn20_resource_pool cocci_id@p ;
...
position p;
@@
 const struct dce_dmcu_shift cocci_id@p ;
...
position p;
@@
 enum mmhubbub_wbif_mode cocci_id@p ;
...
position p;
@@
 struct stream_encoder * cocci_id@p ;
...
position p;
@@
 const struct dcn20_dsc_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct resource_pool * cocci_id@p ;
...
position p;
@@
 const struct dcn20_mpc_shift cocci_id@p ;
...
position p;
@@
 const struct dcn10_link_enc_hpd_registers cocci_id@p [ ] ;
...
position p;
@@
 struct dc_cap_funcs cocci_id@p ;
...
position p;
@@
 struct mcif_arb_params * cocci_id@p ;
...
position p;
@@
 const struct dcn10_ipp_mask cocci_id@p ;
...
position p;
@@
 const struct dcn20_dsc_shift cocci_id@p ;
...
position p;
@@
 const struct dce_abm_registers cocci_id@p ;
