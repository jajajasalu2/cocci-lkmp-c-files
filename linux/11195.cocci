...
typedef uint16_t;
@@
 struct out_csc_color_matrix_type {  enum dc_color_space_type color_space_type ;  uint16_t regval [ 12 ] ; } cocci_id@p ;
...
position p;
@@
 const struct out_csc_color_matrix_type cocci_id@p [ ] ;
...
position p;
@@
 enum dc_color_space_type { COLOR_SPACE_RGB_TYPE , COLOR_SPACE_RGB_LIMITED_TYPE , COLOR_SPACE_YCBCR601_TYPE , COLOR_SPACE_YCBCR709_TYPE , COLOR_SPACE_YCBCR2020_TYPE , COLOR_SPACE_YCBCR601_LIMITED_TYPE , COLOR_SPACE_YCBCR709_LIMITED_TYPE , COLOR_SPACE_YCBCR709_BLACK_TYPE , } cocci_id@p ;
...
position p;
@@
 enum dc_color_space_type cocci_id@p ;
...
position p;
@@
 enum black_color_format { BLACK_COLOR_FORMAT_RGB_FULLRANGE = 0 , BLACK_COLOR_FORMAT_RGB_LIMITED , BLACK_COLOR_FORMAT_YUV_TV , BLACK_COLOR_FORMAT_YUV_CV , BLACK_COLOR_FORMAT_YUV_SUPER_AA , BLACK_COLOR_FORMAT_DEBUG , } cocci_id@p ;
