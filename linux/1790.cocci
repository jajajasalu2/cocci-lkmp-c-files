...
typedef u8;
@@
 const struct {  int val ;  int val2 ;  u8 it ; } cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct cm3232_chip {  struct i2c_client * client ;  struct cm3232_als_info * als_info ;  u8 regs_cmd ;  u16 regs_als ; } cocci_id@p ;
...
position p;
@@
 struct cm3232_als_info * cocci_id@p ;
...
typedef u8;
@@
 struct cm3232_als_info {  u8 regs_cmd_default ;  u8 hw_id ;  int calibscale ;  int mlux_per_bit ;  int mlux_per_bit_base_it ; } cocci_id@p ;
