...
typedef __u32,__u64;
@@
 struct diag2fc_parm_list {  char userid [ NAME_LEN ] ;  char aci_grp [ NAME_LEN ] ;  __u64 addr ;  __u32 size ;  __u32 fmt ; } cocci_id@p ;
...
position p;
@@
 struct diag2fc_data * cocci_id@p ;
...
position p;
@@
 struct dbfs_d2fc_hdr cocci_id@p ;
...
position p;
@@
 struct diag2fc_parm_list cocci_id@p ;
