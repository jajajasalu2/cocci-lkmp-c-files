...
position p;
@@
 const unsigned char cocci_id@p [ SNDRV_PCM_FORMAT_S32_LE + 1 ] ;
...
position p;
@@
 struct davinci_mcbsp_dev * cocci_id@p ;
...
position p;
@@
 enum { DAVINCI_MCBSP_WORD_8 = 0 , DAVINCI_MCBSP_WORD_12 , DAVINCI_MCBSP_WORD_16 , DAVINCI_MCBSP_WORD_20 , DAVINCI_MCBSP_WORD_24 , DAVINCI_MCBSP_WORD_32 , } cocci_id@p ;
