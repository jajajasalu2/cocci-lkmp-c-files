...
position p;
@@
 struct ad5504_state * cocci_id@p ;
...
position p;
@@
 enum ad5504_supported_device_ids { ID_AD5504 , ID_AD5501 , } cocci_id@p ;
...
position p;
@@
 struct ad5504_platform_data * cocci_id@p ;
...
position p;
@@
 struct ad5504_state {  struct spi_device * spi ;  struct regulator * reg ;  unsigned short vref_mv ;  unsigned pwr_down_mask ;  unsigned pwr_down_mode ;  __be16 data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
