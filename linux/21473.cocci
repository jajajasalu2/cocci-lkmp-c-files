...
position p;
@@
 struct compat_rt_sigframe cocci_id@p ;
...
position p;
@@
 struct arm64_ftr_reg cocci_id@p ;
...
position p;
@@
 struct sleep_stack_data cocci_id@p ;
...
position p;
@@
 struct arm_smccc_quirk cocci_id@p ;
...
position p;
@@
 struct kvm_host_data cocci_id@p ;
...
position p;
@@
 struct compat_sigframe cocci_id@p ;
...
position p;
@@
 struct cpu_suspend_ctx cocci_id@p ;
