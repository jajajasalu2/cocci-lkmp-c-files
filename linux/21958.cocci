...
position p;
@@
 endCondition_directive cocci_id@p ;
...
symbol cocci_id;
position p;
typedef LZ4_streamDecode_t;
@@
 LZ4_streamDecode_t * cocci_id@p ;
...
position p;
@@
 LZ4_streamDecode_t_internal * cocci_id@p ;
