...
position p;
@@
 struct pvrdma_cmd_create_srq_resp * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_create_srq * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_destroy_srq * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_query_srq_resp * cocci_id@p ;
...
position p;
@@
 struct pvrdma_create_srq_resp cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_query_srq * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_modify_srq * cocci_id@p ;
...
position p;
@@
 struct pvrdma_create_srq cocci_id@p ;
