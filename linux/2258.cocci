...
position p;
@@
 struct thermal_hwmon_device {  char type [ THERMAL_NAME_LENGTH ] ;  struct device * device ;  int count ;  struct list_head tz_list ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct thermal_hwmon_temp cocci_id@p ;
...
position p;
@@
 struct thermal_hwmon_attr {  struct device_attribute attr ;  char name [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 const struct thermal_hwmon_device * cocci_id@p ;
...
position p;
@@
 const struct thermal_zone_device * cocci_id@p ;
...
position p;
@@
 struct thermal_hwmon_device * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ THERMAL_NAME_LENGTH ] ;
...
position p;
@@
 struct thermal_hwmon_attr cocci_id@p ;
...
position p;
@@
 struct thermal_hwmon_temp {  struct list_head hwmon_node ;  struct thermal_zone_device * tz ;  struct thermal_hwmon_attr temp_input ;  struct thermal_hwmon_attr temp_crit ; } cocci_id@p ;
