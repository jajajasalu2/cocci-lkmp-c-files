...
typedef u64;
@@
 struct aqr107_priv {  u64 sgmii_stats [ AQR107_SGMII_STAT_SZ ] ; } cocci_id@p ;
...
position p;
@@
 const struct aqr107_hw_stat cocci_id@p [ ] ;
...
position p;
@@
 struct aqr107_hw_stat {  const char * name ;  int reg ;  int size ; } cocci_id@p ;
