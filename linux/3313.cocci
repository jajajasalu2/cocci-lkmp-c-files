...
position p;
@@
 struct scmi_sensors * cocci_id@p ;
...
position p;
@@
 struct hwmon_chip_info cocci_id@p ;
...
position p;
@@
 const struct scmi_sensors * cocci_id@p ;
...
position p;
@@
 struct scmi_sensors {  const struct scmi_handle * handle ;  const struct scmi_sensor_info * * info [ hwmon_max ] ; } cocci_id@p ;
...
position p;
@@
 const struct scmi_device_id cocci_id@p [ ] ;
