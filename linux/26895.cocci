...
symbol cocci_id;
position p;
typedef afs_access_t;
@@
 afs_access_t * cocci_id@p ;
...
position p;
@@
 enum afs_cb_break_reason cocci_id@p ;
...
@@
 const afs_dataversion_t * cocci_id@p ;
...
position p;
@@
 struct afs_vnode_cache_aux cocci_id@p ;
