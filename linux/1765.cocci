...
position p;
@@
 enum hts221_sensor_type cocci_id@p ;
...
typedef u8;
@@
 struct hts221_odr {  u8 hz ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 const struct hts221_avg * cocci_id@p ;
...
position p;
@@
 const struct hts221_odr cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct hts221_avg {  u8 addr ;  u8 mask ;  u16 avg_avl [ HTS221_AVG_DEPTH ] ; } cocci_id@p ;
