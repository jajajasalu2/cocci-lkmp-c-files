...
position p;
@@
 struct qlcnic_add_rings_mbx_out * cocci_id@p ;
...
position p;
@@
 struct qlcnic_rds_mbx cocci_id@p ;
...
position p;
@@
 struct qlc_83xx_idc * cocci_id@p ;
...
position p;
@@
 struct qlcnic_mailbox cocci_id@p ;
...
position p;
@@
 const struct qlcnic_mailbox_metadata * cocci_id@p ;
...
position p;
@@
 const struct qlcnic_mbx_ops * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ QLC_83XX_MBX_AEN_CNT ] ;
...
position p;
@@
 struct qlcnic_tx_mbx cocci_id@p ;
...
position p;
@@
 struct qlcnic_sds_mbx cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct qlcnic_adapter * , u8 * , u8 , struct qlcnic_cmd_args * ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct qlcnic_adapter * adapter , u32 data [ ] ) ;
...
position p;
@@
 struct qlcnic_bc_hdr cocci_id@p ;
...
position p;
@@
 struct qlcnic_rcv_mbx_out * cocci_id@p ;
...
position p;
@@
 struct qlcnic_nic_intr_coalesce * cocci_id@p ;
...
position p;
@@
 struct qlcnic_macvlan_mbx cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct qlcnic_adapter * , u8 ) ;
...
position p;
@@
 struct qlcnic_tx_mbx_out * cocci_id@p ;
