...
position p;
@@
 struct dt2801_board {  const char * name ;  int boardcode ;  int ad_diff ;  int ad_chan ;  int adbits ;  int adrangetype ;  int dabits ; } cocci_id@p ;
...
position p;
@@
 struct dt2801_private {  const struct comedi_lrange * dac_range_types [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct dt2801_private * cocci_id@p ;
...
position p;
@@
 const struct dt2801_board cocci_id@p [ ] ;
