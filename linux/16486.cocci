...
position p;
@@
 struct holtekff_device * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ HOLTEKFF_MSG_LENGTH ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ HOLTEKFF_MSG_LENGTH ] ;
...
position p;
@@
 struct holtekff_device {  struct hid_field * field ; } cocci_id@p ;
