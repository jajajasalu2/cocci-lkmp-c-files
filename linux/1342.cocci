...
symbol cocci_id;
position p;
typedef __s64,__u8,wait_queue_head_t,spinlock_t;
@@
 struct usb_yurex {  struct usb_device * udev ;  struct usb_interface * interface ;  __u8 int_in_endpointAddr ;  struct urb * urb ;  unsigned char * int_buffer ;  struct urb * cntl_urb ;  struct usb_ctrlrequest * cntl_req ;  unsigned char * cntl_buffer ;  struct kref kref ;  struct mutex io_mutex ;  unsigned long disconnected : 1 ;  struct fasync_struct * async_queue ;  wait_queue_head_t waitq ;  spinlock_t lock ;  __s64 bbu ; } cocci_id@p ;
