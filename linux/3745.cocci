...
position p;
@@
 struct nitrox_sgtable * cocci_id@p ;
...
position p;
@@
 struct nitrox_sgcomp * cocci_id@p ;
...
position p;
@@
 struct nitrox_softreq * cocci_id@p ;
...
position p;
@@
 struct nitrox_q_vector * cocci_id@p ;
