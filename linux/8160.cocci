...
position p;
@@
 struct nsim_trap_data cocci_id@p ;
...
position p;
@@
 struct nsim_trap_item cocci_id@p ;
...
position p;
@@
 struct nsim_trap_item {  void * trap_ctx ;  enum devlink_trap_action action ; } cocci_id@p ;
...
position p;
@@
 enum nsim_devlink_param_id { NSIM_DEVLINK_PARAM_ID_BASE = DEVLINK_PARAM_GENERIC_ID_MAX , NSIM_DEVLINK_PARAM_ID_TEST1 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct nsim_dev * nsim_dev , struct netlink_ext_ack * extack ) ;
...
position p;
@@
 enum { NSIM_TRAP_ID_BASE = DEVLINK_TRAP_GENERIC_ID_MAX , NSIM_TRAP_ID_FID_MISS , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nsim_dev * nsim_dev ) ;
...
position p;
@@
 struct nsim_bus_dev * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct nsim_trap_data {  struct delayed_work trap_report_dw ;  struct nsim_trap_item * trap_items_arr ;  struct nsim_dev * nsim_dev ;  spinlock_t trap_lock ; } cocci_id@p ;
...
position p;
@@
 struct nsim_dev_port * cocci_id@p ;
