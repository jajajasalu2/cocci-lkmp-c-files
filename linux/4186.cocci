...
position p;
@@
 struct pll_ratio {  int clk_ref ;  int calset_1 ;  int calset_2 ;  int calset_3 ;  int calset_4 ;  int cal_ctrl ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct miphy28lp_phy {  struct phy * phy ;  struct miphy28lp_dev * phydev ;  void __iomem * base ;  void __iomem * pipebase ;  bool osc_force_ext ;  bool osc_rdy ;  bool px_rx_pol_inv ;  bool ssc ;  bool tx_impedance ;  struct reset_control * miphy_rst ;  u32 sata_gen ;  u32 syscfg_reg [ SYSCFG_REG_MAX ] ;  u8 type ; } cocci_id@p ;
...
position p;
@@
 struct miphy28lp_pll_gen {  int bank ;  int speed ;  int bias_boost_1 ;  int bias_boost_2 ;  int tx_ctrl_1 ;  int tx_ctrl_2 ;  int tx_ctrl_3 ;  int rx_k_gain ;  int rx_vga_gain ;  int rx_equ_gain_1 ;  int rx_equ_gain_2 ;  int rx_equ_gain_3 ;  int rx_buff_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct miphy28lp_pll_gen * cocci_id@p ;
...
position p;
@@
 enum { SYSCFG_CTRL , SYSCFG_STATUS , SYSCFG_PCI , SYSCFG_SATA , SYSCFG_REG_MAX , } cocci_id@p ;
...
position p;
@@
 struct miphy28lp_phy * cocci_id@p ;
...
position p;
@@
 struct miphy28lp_dev {  struct device * dev ;  struct regmap * regmap ;  struct mutex miphy_mutex ;  struct miphy28lp_phy * * phys ;  int nphys ; } cocci_id@p ;
...
typedef u16;
@@
 struct miphy_initval {  u16 reg ;  u16 val ; } cocci_id@p ;
...
position p;
@@
 struct miphy28lp_dev * cocci_id@p ;
...
position p;
@@
 enum miphy_sata_gen { SATA_GEN1 , SATA_GEN2 , SATA_GEN3 , } cocci_id@p ;
