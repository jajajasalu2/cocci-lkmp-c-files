...
position p;
@@
 struct kthread_worker * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * dummy ) ;
...
position p;
@@
 struct pkg_cstate_info * cocci_id@p ;
...
position p;
@@
 struct powerclamp_calibration_data cocci_id@p [ MAX_TARGET_RATIO ] ;
...
position p;
@@
 struct powerclamp_calibration_data {  unsigned long confidence ;  unsigned long steady_comp ;  unsigned long dynamic_comp ; } cocci_id@p ;
...
position p;
@@
 struct thermal_cooling_device_ops cocci_id@p ;
...
position p;
@@
 struct powerclamp_worker_data cocci_id@p ;
...
typedef bool;
@@
 struct pkg_cstate_info {  bool skip ;  int msr_index ;  int cstate_id ; } cocci_id@p ;
...
typedef bool;
@@
 struct powerclamp_worker_data {  struct kthread_worker * worker ;  struct kthread_work balancing_work ;  struct kthread_delayed_work idle_injection_work ;  unsigned int cpu ;  unsigned int count ;  unsigned int guard ;  unsigned int window_size_now ;  unsigned int target_ratio ;  unsigned int duration_jiffies ;  bool clamping ; } cocci_id@p ;
...
position p;
@@
 struct powerclamp_calibration_data * cocci_id@p ;
