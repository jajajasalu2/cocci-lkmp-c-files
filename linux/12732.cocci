...
position p;
@@
 struct intel_svm_dev * cocci_id@p ;
...
position p;
@@
 struct page_req_dsc * cocci_id@p ;
...
typedef u64;
@@
 struct page_req_dsc {  union {  struct {  u64 type : 8 ;  u64 pasid_present : 1 ;  u64 priv_data_present : 1 ;  u64 rsvd : 6 ;  u64 rid : 16 ;  u64 pasid : 20 ;  u64 exe_req : 1 ;  u64 pm_req : 1 ;  u64 rsvd2 : 10 ; } ;  u64 qw_0 ; } ;  union {  struct {  u64 rd_req : 1 ;  u64 wr_req : 1 ;  u64 lpig : 1 ;  u64 prg_index : 9 ;  u64 addr : 52 ; } ;  u64 qw_1 ; } ;  u64 priv_data [ 2 ] ; } cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * d ) ;
