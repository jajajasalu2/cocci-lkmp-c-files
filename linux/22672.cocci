...
position p;
@@
 const unsigned char cocci_id@p [ 5 ] ;
...
symbol cocci_id;
position p;
typedef ak4114_read_t;
@@
 ak4114_read_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ak4114_write_t;
@@
 ak4114_write_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ak4114 * chip ) ;
