...
typedef u32;
@@
 void cocci_id@p ( struct net_device * dev , enum rf90_radio_path eRFPath , u32 Offset , u32 Data ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct net_device * dev , enum rf90_radio_path eRFPath , u32 Offset ) ;
...
position p;
@@
 struct bb_reg_definition * cocci_id@p ;
...
position p;
@@
 enum sw_chnl_cmd_id cocci_id@p ;
...
position p;
@@
 enum ht_extchnl_offset cocci_id@p ;
...
position p;
@@
 enum rf90_radio_path cocci_id@p ;
