...
typedef bool;
@@
 struct qpnp_tm_chip {  struct regmap * map ;  struct device * dev ;  struct thermal_zone_device * tz_dev ;  unsigned int subtype ;  long temp ;  unsigned int thresh ;  unsigned int stage ;  unsigned int prev_stage ;  unsigned int base ;  struct mutex lock ;  bool initialized ;  struct iio_channel * adc ; } cocci_id@p ;
...
position p;
@@
 struct qpnp_tm_chip * cocci_id@p ;
