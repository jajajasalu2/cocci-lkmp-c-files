...
position p;
@@
 struct uv_rtc_timer_head * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long , struct clock_event_device * ) ;
...
@@
 struct uv_rtc_timer_head {  spinlock_t lock ;  int next_cpu ;  int ncpus ;  struct {  int lcpu ;  u64 expires ; } cpu [ 1 ] ; } cocci_id@p ;
