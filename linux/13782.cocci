...
position p;
@@
 struct tc358743_state * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct v4l2_subdev * sd , bool cable_connected ) ;
...
position p;
@@
 int cocci_id@p ( struct v4l2_subdev * sd ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ I2C_MAX_XFER_SIZE ] ;
...
position p;
@@
 struct tc358743_platform_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct tc358743_state {  struct tc358743_platform_data pdata ;  struct v4l2_fwnode_bus_mipi_csi2 bus ;  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler hdl ;  struct i2c_client * i2c_client ;  struct mutex confctl_mutex ;  struct v4l2_ctrl * detect_tx_5v_ctrl ;  struct v4l2_ctrl * audio_sampling_rate_ctrl ;  struct v4l2_ctrl * audio_present_ctrl ;  struct delayed_work delayed_work_enable_hotplug ;  struct timer_list timer ;  struct work_struct work_i2c_poll ;  u8 edid_blocks_written ;  struct v4l2_dv_timings timings ;  u32 mbus_fmt_code ;  u8 csi_lanes_in_use ;  struct gpio_desc * reset_gpio ;  struct cec_adapter * cec_adap ; } cocci_id@p ;
...
position p;
@@
 struct v4l2_subdev_edid * cocci_id@p ;
