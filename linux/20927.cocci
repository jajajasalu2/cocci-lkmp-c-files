...
position p;
@@
 struct pcap_handler_data {  char * buffer ;  int len ; } cocci_id@p ;
...
position p;
@@
 struct pcap_handler_data cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PCAP_ERRBUF_SIZE ] ;
...
position p;
@@
 const struct pcap_pkthdr * cocci_id@p ;
