...
position p;
@@
 const struct reg {  const char * name ;  unsigned long platforms ;  unsigned int offset ; } cocci_id@p [ ] ;
...
typedef bool;
@@
 struct {  const struct intel_forcewake_range * ranges ;  unsigned int num_ranges ;  bool is_watertight ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct intel_forcewake_range * cocci_id@p ;
...
typedef i915_reg_t;
@@
 struct {  const i915_reg_t * regs ;  unsigned int size ; } cocci_id@p [ ] ;
