...
position p;
@@
 struct mpc5121_rtc_data * cocci_id@p ;
...
position p;
@@
 struct mpc5121_rtc_data {  unsigned irq ;  unsigned irq_periodic ;  struct mpc5121_rtc_regs __iomem * regs ;  struct rtc_device * rtc ;  struct rtc_wkalrm wkalarm ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct mpc5121_rtc_regs {  u8 set_time ;  u8 hour_set ;  u8 minute_set ;  u8 second_set ;  u8 set_date ;  u8 month_set ;  u8 weekday_set ;  u8 date_set ;  u8 write_sw ;  u8 sw_set ;  u16 year_set ;  u8 alm_enable ;  u8 alm_hour_set ;  u8 alm_min_set ;  u8 int_enable ;  u8 reserved1 ;  u8 hour ;  u8 minute ;  u8 second ;  u8 month ;  u8 wday_mday ;  u16 year ;  u8 int_alm ;  u8 int_sw ;  u8 alm_status ;  u8 sw_minute ;  u8 bus_error_1 ;  u8 int_day ;  u8 int_min ;  u8 int_sec ;  u32 target_time ;  u32 actual_time ;  u32 keep_alive ; } cocci_id@p ;
