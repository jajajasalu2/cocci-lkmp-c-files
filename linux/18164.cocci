...
position p;
@@
 char cocci_id@p [ sizeof ( " 12345678" ) * 8 + 1 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct pt_regs * regs , unsigned int instr ) ;
...
position p;
@@
 void cocci_id@p ( const char * , const char * , unsigned long , unsigned long ) ;
