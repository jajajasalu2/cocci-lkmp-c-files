...
typedef u8;
@@
 struct mlxreg_led_data {  struct mlxreg_core_data * data ;  struct led_classdev led_cdev ;  u8 base_color ;  void * data_parent ;  char led_cdev_name [ MLXREG_CORE_LABEL_MAX_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxreg_led_data * cocci_id@p ;
...
position p;
@@
 struct mlxreg_led_priv_data * cocci_id@p ;
...
position p;
@@
 struct mlxreg_led_priv_data {  struct platform_device * pdev ;  struct mlxreg_core_platform_data * pdata ;  struct mutex access_lock ; } cocci_id@p ;
