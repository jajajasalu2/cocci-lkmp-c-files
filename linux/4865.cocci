...
position p;
@@
 struct bnxt_qplib_cqe * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_res * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_nq_work cocci_id@p ;
...
position p;
@@
 struct sq_send_raweth_qp1 * cocci_id@p ;
...
position p;
@@
 struct cmdq_query_qp cocci_id@p ;
...
position p;
@@
 struct creq_query_srq_resp_sb * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_srq * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct bnxt_qplib_srq * srq , u32 arm_type ) ;
...
position p;
@@
 struct creq_create_qp_resp cocci_id@p ;
...
position p;
@@
 struct cmdq_create_srq cocci_id@p ;
...
position p;
@@
 struct creq_query_qp_resp_sb * cocci_id@p ;
...
position p;
@@
 struct sq_psn_search_ext * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_rcfw * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_swq * cocci_id@p ;
...
position p;
@@
 struct creq_create_srq_resp cocci_id@p ;
...
position p;
@@
 struct cq_res_raweth_qp1 * cocci_id@p ;
...
position p;
@@
 struct cmdq_destroy_qp cocci_id@p ;
...
position p;
@@
 struct cmdq_destroy_srq cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_hwq * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_pbl * cocci_id@p ;
...
position p;
@@
 struct cmdq_modify_qp cocci_id@p ;
...
typedef u8;
@@
 int ( * cocci_id@p ) ( struct bnxt_qplib_nq * nq , struct bnxt_qplib_srq * , u8 event ) ;
...
position p;
@@
 struct bnxt_qplib_qp * * cocci_id@p ;
...
position p;
@@
 struct sq_psn_search cocci_id@p ;
...
position p;
@@
 struct creq_destroy_srq_resp cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct bnxt_qplib_nq * nq , struct bnxt_qplib_cq * ) ;
...
position p;
@@
 struct bnxt_qplib_gid cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_q * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_nq * cocci_id@p ;
...
position p;
@@
 struct creq_create_cq_resp cocci_id@p ;
...
position p;
@@
 struct nq_srq_event * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_cq * cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_sge * cocci_id@p ;
...
position p;
@@
 struct cmdq_create_qp cocci_id@p ;
...
position p;
@@
 struct creq_destroy_cq_resp cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_swqe * cocci_id@p ;
...
position p;
@@
 struct creq_query_srq_resp cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bnxt_qplib_cq * cq ) ;
...
position p;
@@
 struct creq_modify_qp_resp cocci_id@p ;
...
position p;
@@
 struct sq_localinvalidate * cocci_id@p ;
...
position p;
@@
 struct cmdq_create_qp1 cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct bnxt_qplib_cq * cq , u64 qp ) ;
...
position p;
@@
 struct bnxt_qplib_rcfw_sbuf * cocci_id@p ;
...
position p;
@@
 struct cmdq_destroy_cq cocci_id@p ;
...
position p;
@@
 struct cmdq_create_cq cocci_id@p ;
...
position p;
@@
 struct creq_create_qp1_resp cocci_id@p ;
...
position p;
@@
 struct creq_query_qp_resp cocci_id@p ;
...
position p;
@@
 struct creq_destroy_qp_resp cocci_id@p ;
...
position p;
@@
 struct cmdq_query_srq cocci_id@p ;
