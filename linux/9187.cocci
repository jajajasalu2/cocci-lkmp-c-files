...
position p;
@@
 struct mlxsw_sp_acl_bf * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ MLXSW_BLOOM_KEY_CHUNKS ] ;
...
typedef refcount_t;
@@
 struct mlxsw_sp_acl_bf {  struct mutex lock ;  unsigned int bank_size ;  refcount_t refcnt [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_BLOOM_KEY_LEN ] ;
