...
typedef u8;
@@
 struct mma8452_data {  struct i2c_client * client ;  struct mutex lock ;  u8 ctrl_reg1 ;  u8 data_cfg ;  const struct mma_chip_info * chip_info ;  int sleep_val ;  struct regulator * vdd_reg ;  struct regulator * vddio_reg ; } cocci_id@p ;
...
position p;
@@
 struct mma8452_data * cocci_id@p ;
...
position p;
@@
 enum { mma8451 , mma8452 , mma8453 , mma8652 , mma8653 , fxls8471 , } cocci_id@p ;
...
position p;
@@
 const struct mma8452_event_regs cocci_id@p ;
...
position p;
@@
 const struct mma_chip_info cocci_id@p [ ] ;
...
typedef u8;
@@
 struct mma8452_event_regs {  u8 ev_cfg ;  u8 ev_cfg_ele ;  u8 ev_cfg_chan_shift ;  u8 ev_src ;  u8 ev_ths ;  u8 ev_ths_mask ;  u8 ev_count ; } cocci_id@p ;
...
typedef u8;
@@
 struct mma_chip_info {  u8 chip_id ;  const struct iio_chan_spec * channels ;  int num_channels ;  const int mma_scales [ 3 ] [ 2 ] ;  int all_events ;  int enabled_events ; } cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ 4 ] [ 8 ] ;
