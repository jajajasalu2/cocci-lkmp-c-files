...
position p;
@@
 struct io_cq_ring {  unsigned * head ;  unsigned * tail ;  unsigned * ring_mask ;  unsigned * ring_entries ;  struct io_uring_cqe * cqes ; } cocci_id@p ;
...
typedef pthread_t;
@@
 struct submitter {  pthread_t thread ;  int ring_fd ;  struct drand48_data rand ;  struct io_sq_ring sq_ring ;  struct io_uring_sqe * sqes ;  struct iovec iovecs [ DEPTH ] ;  struct io_cq_ring cq_ring ;  int inflight ;  unsigned long reaps ;  unsigned long done ;  unsigned long calls ;  volatile int finish ;  __s32 * fds ;  struct file files [ MAX_FDS ] ;  unsigned nr_files ;  unsigned cur_file ; } cocci_id@p ;
...
position p;
@@
 struct io_sq_ring {  unsigned * head ;  unsigned * tail ;  unsigned * ring_mask ;  unsigned * ring_entries ;  unsigned * flags ;  unsigned * array ; } cocci_id@p ;
...
position p;
@@
 struct file {  unsigned long max_blocks ;  unsigned pending_ios ;  int real_fd ;  int fixed_fd ; } cocci_id@p ;
