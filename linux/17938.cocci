...
position p;
@@
 struct grpci2_barcfg * cocci_id@p ;
...
typedef u32;
@@
 struct grpci2_priv {  struct leon_pci_info info ;  struct grpci2_regs __iomem * regs ;  char irq ;  char irq_mode ;  char bt_enabled ;  char do_reset ;  char irq_mask ;  u32 pciid ;  unsigned char irq_map [ 4 ] ;  unsigned int virq_err ;  unsigned int virq_dma ;  unsigned long pci_area ;  unsigned long pci_area_end ;  unsigned long pci_io ;  unsigned long pci_conf ;  unsigned long pci_conf_end ;  unsigned long pci_io_va ;  struct grpci2_barcfg tgtbars [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 struct grpci2_bd_chan {  unsigned int ctrl ;  unsigned int nchan ;  unsigned int nbd ;  unsigned int res ; } cocci_id@p ;
...
position p;
@@
 struct grpci2_cap_first {  unsigned int ctrl ;  unsigned int pci2ahb_map [ 6 ] ;  unsigned int ext2ahb_map ;  unsigned int io_map ;  unsigned int pcibar_size [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 struct grpci2_regs {  unsigned int ctrl ;  unsigned int sts_cap ;  int res1 ;  unsigned int io_map ;  unsigned int dma_ctrl ;  unsigned int dma_bdbase ;  int res2 [ 2 ] ;  unsigned int bars [ 6 ] ;  int res3 [ 2 ] ;  unsigned int ahbmst_map [ 16 ] ;  unsigned int t_ctrl ;  unsigned int t_cnt ;  unsigned int t_adpat ;  unsigned int t_admask ;  unsigned int t_sigpat ;  unsigned int t_sigmask ;  unsigned int t_adstate ;  unsigned int t_sigstate ; } cocci_id@p ;
...
position p;
@@
 struct grpci2_barcfg {  unsigned long pciadr ;  unsigned long ahbadr ; } cocci_id@p ;
...
position p;
@@
 struct grpci2_bd_data {  unsigned int ctrl ;  unsigned int pci_adr ;  unsigned int ahb_adr ;  unsigned int next ; } cocci_id@p ;
