...
position p;
@@
 enum { MTK_YEA , MTK_MON , MTK_DOM , MTK_DOW , MTK_HOU , MTK_MIN , MTK_SEC , } cocci_id@p ;
...
position p;
@@
 struct mtk_rtc {  struct rtc_device * rtc ;  void __iomem * base ;  int irq ;  struct clk * clk ; } cocci_id@p ;
