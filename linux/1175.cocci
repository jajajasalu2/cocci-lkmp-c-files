...
position p;
@@
 struct tusb6010_glue {  struct device * dev ;  struct platform_device * musb ;  struct platform_device * phy ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct musb * musb , int is_on ) ;
...
position p;
@@
 struct tusb6010_glue * cocci_id@p ;
