...
position p;
@@
 struct sensor_device_attr_u * cocci_id@p ;
...
position p;
@@
 struct nct6683_data * cocci_id@p ;
...
typedef u8,bool;
@@
 struct sensor_device_template {  struct device_attribute dev_attr ;  union {  struct {  u8 nr ;  u8 index ; } s ;  int index ; } u ;  bool s2 ; } cocci_id@p ;
...
position p;
@@
 struct nct6683_sio_data * cocci_id@p ;
...
position p;
@@
 struct nct6683_sio_data {  int sioreg ;  enum kinds kind ; } cocci_id@p ;
...
typedef umode_t;
@@
 struct sensor_template_group {  struct sensor_device_template * * templates ;  umode_t ( * is_visible ) ( struct kobject * , struct attribute * , int ) ;  int base ; } cocci_id@p ;
...
position p;
@@
 const struct sensor_template_group * cocci_id@p ;
...
position p;
@@
 struct sensor_device_template * cocci_id@p [ ] ;
...
position p;
@@
 struct sensor_device_attr_u {  union {  struct sensor_device_attribute a1 ;  struct sensor_device_attribute_2 a2 ; } u ;  char name [ 32 ] ; } cocci_id@p ;
