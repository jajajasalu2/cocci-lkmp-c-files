...
position p;
@@
 const FSE_DTableHeader * cocci_id@p ;
...
position p;
@@
 enum { FSE_static_assert = 1 / ( int ) ( ! ! ( c ) ) , } cocci_id@p ;
...
position p;
@@
 FSE_DTableHeader * constcocci_id ;
...
symbol cocci_id;
position p;
typedef FSE_DState_t;
@@
 FSE_DState_t cocci_id@p ;
...
position p;
@@
 const FSE_FUNCTION_TYPE cocci_id@p ;
