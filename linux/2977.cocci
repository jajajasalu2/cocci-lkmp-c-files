...
position p;
@@
 struct lpit_residency_info cocci_id@p ;
...
position p;
@@
 struct acpi_lpit_native * cocci_id@p ;
...
typedef u64;
@@
 struct lpit_residency_info {  struct acpi_generic_address gaddr ;  u64 frequency ;  void __iomem * iomem_addr ; } cocci_id@p ;
...
position p;
@@
 struct acpi_table_lpit * cocci_id@p ;
