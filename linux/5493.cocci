...
position p;
@@
 struct mxs_spi {  struct mxs_ssp ssp ;  struct completion c ;  unsigned int sck ; } cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 pio [ 4 ] ;  struct scatterlist sg ; } * cocci_id@p ;
