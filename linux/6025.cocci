...
position p;
@@
 struct pm8xxx_pin_data cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ PM8XXX_MAX_GPIOS ] ;
...
typedef u8,bool;
@@
 struct pm8xxx_pin_data {  unsigned reg ;  u8 power_source ;  u8 mode ;  bool open_drain ;  bool output_value ;  u8 bias ;  u8 pull_up_strength ;  u8 output_strength ;  bool disable ;  u8 function ;  bool inverted ; } cocci_id@p ;
...
position p;
@@
 const struct pin_config_item cocci_id@p [ ARRAY_SIZE ( pm8xxx_gpio_bindings ) ] ;
...
position p;
@@
 struct pm8xxx_gpio {  struct device * dev ;  struct regmap * regmap ;  struct pinctrl_dev * pctrl ;  struct gpio_chip chip ;  struct pinctrl_desc desc ;  unsigned npins ; } cocci_id@p ;
