...
position p;
@@
 struct pic32_rtc_dev * cocci_id@p ;
...
@@
 struct pic32_rtc_dev {  struct rtc_device * rtc ;  void __iomem * reg_base ;  struct clk * clk ;  spinlock_t alarm_lock ;  int alarm_irq ;  bool alarm_clk_enabled ; } cocci_id@p ;
