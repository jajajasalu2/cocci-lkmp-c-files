...
position p;
@@
 struct grpci1_regs {  unsigned int cfg_stat ;  unsigned int bar0 ;  unsigned int page0 ;  unsigned int bar1 ;  unsigned int page1 ;  unsigned int iomap ;  unsigned int stat_cmd ;  unsigned int irq ; } cocci_id@p ;
...
position p;
@@
 struct grpci1_priv {  struct leon_pci_info info ;  struct grpci1_regs __iomem * regs ;  struct device * dev ;  int pci_err_mask ;  int irq ;  unsigned char irq_map [ 4 ] ;  unsigned int irq_err ;  unsigned long pci_area ;  unsigned long pci_area_end ;  unsigned long pci_io ;  unsigned long pci_conf ;  unsigned long pci_conf_end ;  unsigned long pci_io_va ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct grpci1_priv * priv , unsigned int bus , unsigned int devfn , int where , u32 val ) ;
