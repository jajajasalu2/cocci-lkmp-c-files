...
position p;
@@
 struct abe_twl6040 {  struct snd_soc_card card ;  struct snd_soc_dai_link dai_links [ 2 ] ;  int jack_detection ;  int mclk_freq ; } cocci_id@p ;
