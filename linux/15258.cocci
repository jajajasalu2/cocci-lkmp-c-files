...
position p;
@@
 struct lp3952_ctrl_hdl * cocci_id@p ;
...
position p;
@@
 struct ptrn_gen_cmd cocci_id@p ;
...
position p;
@@
 struct lp3952_led_array * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ LP3952_LED_ALL ] ;
