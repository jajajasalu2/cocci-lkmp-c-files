...
position p;
@@
 struct v4l2_ctrl_mpeg2_slice_params * cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_hevc_pps * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct v4l2_ctrl * ctrl ) ;
...
position p;
@@
 enum v4l2_ctrl_type * cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_fwht_params cocci_id@p ;
...
position p;
@@
 const struct v4l2_subscribed_event_ops cocci_id@p ;
...
position p;
@@
 union v4l2_ctrl_ptr cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_helper * cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_vp8_frame_header cocci_id@p ;
...
position p;
@@
 v4l2_ctrl_notify_fnc cocci_id@p ;
...
typedef u32;
@@
 struct v4l2_ctrl_helper {  struct v4l2_ctrl_ref * mref ;  struct v4l2_ctrl_ref * ref ;  u32 next ; } cocci_id@p ;
...
position p;
@@
 struct media_request_object * cocci_id@p ;
...
position p;
@@
 const struct media_request_object_ops cocci_id@p ;
...
position p;
@@
 struct v4l2_hevc_dpb_entry * cocci_id@p ;
...
position p;
@@
 struct media_request * cocci_id@p ;
...
position p;
@@
 struct media_device * cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_hevc_slice_params * cocci_id@p ;
...
position p;
@@
 const union v4l2_ctrl_ptr cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_type_ops * cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_hevc_sps * cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_h264_slice_params cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_mpeg2_quantization cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_h264_sps cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_ref * * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct v4l2_ext_control * c , struct v4l2_ctrl * ctrl ) ;
...
position p;
@@
 struct v4l2_ctrl_h264_decode_params cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_helper cocci_id@p [ 4 ] ;
...
position p;
@@
 struct v4l2_subscribed_event * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ V4L2_CTRL_MAX_DIMS ] ;
...
position p;
@@
 const struct v4l2_area * cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_h264_scaling_matrix cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl * cocci_id@p ;
...
position p;
@@
 struct v4l2_ctrl_h264_pps cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_handler * cocci_id@p ;
