...
position p;
@@
 enum shdlc_state { SHDLC_DISCONNECTED = 0 , SHDLC_CONNECTING = 1 , SHDLC_NEGOTIATING = 2 , SHDLC_HALF_CONNECTED = 3 , SHDLC_CONNECTED = 4 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xmit_to_drv_t;
@@
 xmit_to_drv_t cocci_id@p ;
...
position p;
@@
 enum uframe_modifier cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,wait_queue_head_t,rcv_to_hci_t,llc_failure_t,xmit_to_drv_t;
@@
 struct llc_shdlc {  struct nfc_hci_dev * hdev ;  xmit_to_drv_t xmit_to_drv ;  rcv_to_hci_t rcv_to_hci ;  struct mutex state_mutex ;  enum shdlc_state state ;  int hard_fault ;  wait_queue_head_t * connect_wq ;  int connect_tries ;  int connect_result ;  struct timer_list connect_timer ;  u8 w ;  bool srej_support ;  struct timer_list t1_timer ;  bool t1_active ;  struct timer_list t2_timer ;  bool t2_active ;  int ns ;  int nr ;  int dnr ;  struct sk_buff_head rcv_q ;  struct sk_buff_head send_q ;  bool rnr ;  struct sk_buff_head ack_pending_q ;  struct work_struct sm_work ;  int tx_headroom ;  int tx_tailroom ;  llc_failure_t llc_failure ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef llc_failure_t;
@@
 llc_failure_t cocci_id@p ;
...
position p;
@@
 enum uframe_modifier { U_FRAME_UA = 0x06 , U_FRAME_RSET = 0x19 , } cocci_id@p ;
...
position p;
@@
 enum sframe_type { S_FRAME_RR = 0x00 , S_FRAME_REJ = 0x01 , S_FRAME_RNR = 0x02 , S_FRAME_SREJ = 0x03 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rcv_to_hci_t;
@@
 rcv_to_hci_t cocci_id@p ;
