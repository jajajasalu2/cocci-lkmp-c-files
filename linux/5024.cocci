...
typedef u32;
@@
 int cocci_id@p ( struct rvt_qp * qp , struct send_context * sc , struct hfi1_pkt_state * ps , u32 flag ) ;
...
position p;
@@
 struct hfi1_sdma_header * cocci_id@p ;
...
position p;
@@
 struct hfi1_opcode_stats_perctx * cocci_id@p ;
...
position p;
@@
 const enum ib_wc_opcode cocci_id@p [ ] ;
...
position p;
@@
 struct hfi1_opa_header * cocci_id@p ;
...
position p;
@@
 const opcode_handler cocci_id@p [ 256 ] ;
...
position p;
@@
 struct hfi1_16b_header * cocci_id@p ;
...
position p;
@@
 struct rvt_mcast_qp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sdma_txreq * cookie , int status ) ;
...
position p;
@@
 struct hfi1_ahg_info * cocci_id@p ;
