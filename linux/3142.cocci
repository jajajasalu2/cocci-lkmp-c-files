...
typedef bool;
@@
 struct tb_cm {  struct list_head tunnel_list ;  struct list_head dp_resources ;  bool hotplug_active ; } cocci_id@p ;
...
position p;
@@
 struct tb_hotplug_event * cocci_id@p ;
...
position p;
@@
 enum tb_tunnel_type cocci_id@p ;
...
typedef u8,u64,bool;
@@
 struct tb_hotplug_event {  struct work_struct work ;  struct tb * tb ;  u64 route ;  u8 port ;  bool unplug ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tb_port * port ) ;
...
position p;
@@
 const struct cfg_event_pkg * cocci_id@p ;
