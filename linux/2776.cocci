...
position p;
@@
 struct i2c_demux_pinctrl_chan {  struct device_node * parent_np ;  struct i2c_adapter * parent_adap ;  struct of_changeset chgset ; } cocci_id@p ;
...
position p;
@@
 struct i2c_demux_pinctrl_priv * cocci_id@p ;
...
position p;
@@
 struct i2c_demux_pinctrl_priv {  int cur_chan ;  int num_chan ;  struct device * dev ;  const char * bus_name ;  struct i2c_adapter cur_adap ;  struct i2c_algorithm algo ;  struct i2c_demux_pinctrl_chan chan [ ] ; } cocci_id@p ;
