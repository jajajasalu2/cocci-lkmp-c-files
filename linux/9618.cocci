...
position p;
@@
 const struct brcmf_firmware_mapping cocci_id@p [ ] ;
...
position p;
@@
 struct brcmf_console * cocci_id@p ;
...
position p;
@@
 struct brcmf_sdio_dev * cocci_id@p ;
...
typedef uint;
@@
 struct brcmf_sdio_count {  uint intrcount ;  uint lastintrs ;  uint pollcnt ;  uint regfails ;  uint tx_sderrs ;  uint fcqueued ;  uint rxrtx ;  uint rx_toolong ;  uint rxc_errors ;  uint rx_hdrfail ;  uint rx_badhdr ;  uint rx_badseq ;  uint fc_rcvd ;  uint fc_xoff ;  uint fc_xon ;  uint rxglomfail ;  uint rxglomframes ;  uint rxglompkts ;  uint f2rxhdrs ;  uint f2rxdata ;  uint f2txdata ;  uint f1regdata ;  uint tickcnt ;  ulong tx_ctlerrs ;  ulong tx_ctlpkts ;  ulong rx_ctlerrs ;  ulong rx_ctlpkts ;  ulong rx_readahead_cnt ; } cocci_id@p ;
...
position p;
@@
 const struct brcmf_bus_ops cocci_id@p ;
...
typedef __le32;
@@
 struct brcmf_trap_info {  __le32 type ;  __le32 epc ;  __le32 cpsr ;  __le32 spsr ;  __le32 r0 ;  __le32 r1 ;  __le32 r2 ;  __le32 r3 ;  __le32 r4 ;  __le32 r5 ;  __le32 r6 ;  __le32 r7 ;  __le32 r8 ;  __le32 r9 ;  __le32 r10 ;  __le32 r11 ;  __le32 r12 ;  __le32 r13 ;  __le32 r14 ;  __le32 pc ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_bus_stats * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct sdpcm_shared_le {  __le32 flags ;  __le32 trap_addr ;  __le32 assert_exp_addr ;  __le32 assert_file_addr ;  __le32 assert_line ;  __le32 console_addr ;  __le32 msgtrace_addr ;  u8 tag [ 32 ] ;  __le32 brpt_addr ; } cocci_id@p ;
...
position p;
@@
 struct sdpcm_shared * cocci_id@p ;
...
position p;
@@
 struct brcmf_sdio_count * cocci_id@p ;
...
position p;
@@
 struct brcmf_fw_name cocci_id@p [ ] ;
...
position p;
@@
 struct brcmf_trap_info cocci_id@p ;
...
typedef __le32;
@@
 struct rte_log_le {  __le32 buf ;  __le32 buf_size ;  __le32 idx ;  char * _buf_compat ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CONSOLE_LINE_MAX ] ;
...
position p;
@@
 enum brcmf_sdio_frmtype cocci_id@p ;
...
position p;
@@
 struct brcmf_fw_request * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct brcmf_sdio_hdrinfo {  u8 seq_num ;  u8 channel ;  u16 len ;  u16 len_left ;  u16 len_nxtfrm ;  u8 dat_offset ;  bool lastfrm ;  u16 tail_pad ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_sdio_hdrinfo * cocci_id@p ;
...
position p;
@@
 struct sdpcm_shared_le cocci_id@p ;
...
position p;
@@
 const struct sdiod_drive_str * cocci_id@p ;
...
typedef uint;
@@
 struct rte_console {  uint vcons_in ;  uint vcons_out ;  struct rte_log_le log_le ;  uint cbuf_idx ;  char cbuf [ CBUF_LEN ] ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct sdpcm_shared {  u32 flags ;  u32 trap_addr ;  u32 assert_exp_addr ;  u32 assert_file_addr ;  u32 assert_line ;  u32 console_addr ;  u32 msgtrace_addr ;  u8 tag [ 32 ] ;  u32 brpt_addr ; } cocci_id@p ;
...
typedef u8;
@@
 struct sdiod_drive_str {  u8 strength ;  u8 sel ; } cocci_id@p ;
...
position p;
@@
 const struct brcmf_buscore_ops cocci_id@p ;
...
typedef u8,uint;
@@
 struct brcmf_console {  uint count ;  uint log_addr ;  struct rte_log_le log_le ;  uint bufsize ;  u8 * buf ;  uint last ; } cocci_id@p ;
...
position p;
@@
 enum brcmf_sdio_frmtype { BRCMF_SDIO_FT_NORMAL , BRCMF_SDIO_FT_SUPER , BRCMF_SDIO_FT_SUB , } cocci_id@p ;
