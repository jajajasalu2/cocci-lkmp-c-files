...
position p;
@@
 struct velocity_context * cocci_id@p ;
...
position p;
@@
 struct velocity_info * cocci_id@p ;
...
position p;
@@
 struct velocity_td_info * cocci_id@p ;
...
position p;
@@
 enum velocity_bus_type cocci_id@p ;
...
position p;
@@
 const struct velocity_info_tbl * cocci_id@p ;
...
position p;
@@
 struct velocity_info_tbl cocci_id@p [ ] ;
...
position p;
@@
 struct velocity_rd_info * cocci_id@p ;
...
position p;
@@
 enum velocity_bus_type { BUS_PCI , BUS_PLATFORM , } cocci_id@p ;
...
position p;
@@
 struct velocity_opt * cocci_id@p ;
...
position p;
@@
 enum velocity_init_type cocci_id@p ;
