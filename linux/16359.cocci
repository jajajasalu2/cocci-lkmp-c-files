...
position p;
@@
 struct exfat_mount_options * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef name_dentry_t;
@@
 struct name_dentry_t cocci_id@p ;
...
position p;
@@
 struct exfat_inode_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pbr_sector_t;
@@
 struct pbr_sector_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ext_dentry_t;
@@
 struct ext_dentry_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef entry_set_cache_t;
@@
 struct entry_set_cache_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct writeback_control * wbc ) ;
...
position p;
@@
 struct exfat_sb_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bmap_dentry_t;
@@
 struct bmap_dentry_t cocci_id@p ;
...
position p;
@@
 const struct exfat_sb_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef strm_dentry_t;
@@
 struct strm_dentry_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef file_dentry_t;
@@
 struct file_dentry_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef volm_dentry_t;
@@
 struct volm_dentry_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef case_dentry_t;
@@
 struct case_dentry_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dos_dentry_t;
@@
 struct dos_dentry_t cocci_id@p ;
