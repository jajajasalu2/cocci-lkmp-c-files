...
position p;
@@
 struct code_page_directory * cocci_id@p ;
...
position p;
@@
 struct extended_attribute * cocci_id@p ;
...
position p;
@@
 struct code_page_data * cocci_id@p ;
