...
typedef bool;
@@
 struct bt_iter_data {  struct blk_mq_hw_ctx * hctx ;  busy_iter_fn * fn ;  void * data ;  bool reserved ; } cocci_id@p ;
...
position p;
@@
 struct bt_iter_data cocci_id@p ;
...
position p;
@@
 struct bt_tags_iter_data * cocci_id@p ;
...
typedef bool;
@@
 struct bt_tags_iter_data {  struct blk_mq_tags * tags ;  busy_tag_iter_fn * fn ;  void * data ;  bool reserved ; } cocci_id@p ;
