...
position p;
@@
 struct xdp_link_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef libbpf_dump_nlmsg_t;
@@
 libbpf_dump_nlmsg_t cocci_id@p ;
...
position p;
@@
 struct {  struct nlmsghdr nh ;  struct ifinfomsg ifinfo ;  char attrbuf [ 64 ] ; } cocci_id@p ;
...
typedef __u32;
@@
 struct xdp_id_md {  int ifindex ;  __u32 flags ;  struct xdp_link_info info ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nlmsghdr nlh ;  struct tcmsg t ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nlmsghdr nlh ;  struct ifinfomsg ifm ; } cocci_id@p ;
