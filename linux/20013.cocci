...
typedef u64,u32;
@@
 struct jit_ctx {  const struct bpf_prog * skf ;  int stack_size ;  u32 idx ;  u32 flags ;  u32 * offsets ;  u32 * target ;  u64 * reg_val_types ;  unsigned int long_b_conversion : 1 ;  unsigned int gen_b_offsets : 1 ;  unsigned int use_bbit_insns : 1 ; } cocci_id@p ;
...
position p;
@@
 enum which_ebpf_reg cocci_id@p ;
...
position p;
@@
 enum reg_val_type { REG_UNKNOWN , REG_64BIT , REG_64BIT_32BIT , REG_32BIT , REG_32BIT_POS , } cocci_id@p ;
...
position p;
@@
 enum which_ebpf_reg { src_reg , src_reg_no_fp , dst_reg , dst_reg_fp_ok , } cocci_id@p ;
