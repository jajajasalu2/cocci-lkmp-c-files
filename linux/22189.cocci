...
position p;
@@
 int cocci_id@p ( struct backing_dev_info * bdi ) ;
...
position p;
@@
 enum wb_congested_state cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bdi_writeback * wb ) ;
...
typedef wait_queue_head_t;
@@
 wait_queue_head_t cocci_id@p [ 2 ] ;
