...
position p;
@@
 enum page_entry_size cocci_id@p ;
...
position p;
@@
 struct exceptional_entry_key cocci_id@p ;
...
position p;
@@
 struct wait_exceptional_entry_queue cocci_id@p ;
...
@@
 wait_queue_head_t cocci_id@p [ DAX_WAIT_TABLE_ENTRIES ] ;
...
typedef wait_queue_entry_t;
@@
 struct wait_exceptional_entry_queue {  wait_queue_entry_t wait ;  struct exceptional_entry_key key ; } cocci_id@p ;
...
typedef pgoff_t;
@@
 struct exceptional_entry_key {  struct xarray * xa ;  pgoff_t entry_start ; } cocci_id@p ;
