...
symbol cocci_id;
position p;
typedef ide_handler_t;
@@
 ide_handler_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ide_startstop_t,ide_drive_t;
@@
 ide_startstop_t cocci_id@p ( ide_drive_t * , struct ide_cmd * ) ;
...
typedef ide_startstop_t,ide_drive_t;
@@
 ide_startstop_t cocci_id@p ( ide_drive_t * ) ;
...
position p;
@@
 struct ide_task_request_s cocci_id@p ;
