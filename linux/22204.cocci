...
position p;
@@
 struct kasan_alloc_meta cocci_id@p ;
...
position p;
@@
 const volatile void * cocci_id@p ;
...
position p;
@@
 struct kasan_free_meta cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ KASAN_STACK_DEPTH ] ;
