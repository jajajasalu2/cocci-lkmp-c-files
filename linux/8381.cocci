...
typedef __le32;
@@
 struct nffw_fwinfo {  __le32 loaded__mu_da__mip_off_hi ;  __le32 mip_cppid ;  __le32 mip_offset_lo ; } cocci_id@p ;
...
position p;
@@
 struct nfp_nffw_info {  struct nfp_cpp * cpp ;  struct nfp_resource * res ;  struct nfp_nffw_info_data fwinf ; } cocci_id@p ;
...
position p;
@@
 struct nfp_nffw_info * cocci_id@p ;
...
position p;
@@
 struct nfp_nffw_info_data * cocci_id@p ;
...
typedef __le32;
@@
 struct nffw_meinfo {  __le32 ctxmask__fwid__meid ; } cocci_id@p ;
...
position p;
@@
 const struct nfp_nffw_info_data * cocci_id@p ;
...
position p;
@@
 struct nfp_nffw_info_v2 {  struct nffw_meinfo meinfo [ NFFW_MEINFO_CNT_V2 ] ;  struct nffw_fwinfo fwinfo [ NFFW_FWINFO_CNT_V2 ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct nfp_nffw_info_data {  __le32 flags [ 2 ] ;  union {  struct nfp_nffw_info_v1 v1 ;  struct nfp_nffw_info_v2 v2 ; } info ; } cocci_id@p ;
...
position p;
@@
 const struct nffw_fwinfo * cocci_id@p ;
...
position p;
@@
 struct nfp_nffw_info_v1 {  struct nffw_meinfo meinfo [ NFFW_MEINFO_CNT_V1 ] ;  struct nffw_fwinfo fwinfo [ NFFW_FWINFO_CNT_V1 ] ; } cocci_id@p ;
