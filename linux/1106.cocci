...
position p;
@@
 struct dbs_governor cocci_id@p ;
...
position p;
@@
 struct policy_dbs_info * cocci_id@p ;
...
position p;
@@
 struct cs_dbs_tuners {  unsigned int down_threshold ;  unsigned int freq_step ; } cocci_id@p ;
...
position p;
@@
 struct cs_dbs_tuners * cocci_id@p ;
...
position p;
@@
 struct cs_policy_dbs_info cocci_id@p ;
...
position p;
@@
 struct cs_policy_dbs_info {  struct policy_dbs_info policy_dbs ;  unsigned int down_skip ;  unsigned int requested_freq ; } cocci_id@p ;
