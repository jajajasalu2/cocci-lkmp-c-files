...
typedef u8;
@@
 struct stpmic1_regulator_cfg {  struct regulator_desc desc ;  u8 mask_reset_reg ;  u8 mask_reset_mask ;  u8 icc_reg ;  u8 icc_mask ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct regulator_dev * rdev , unsigned int mode ) ;
...
position p;
@@
 const struct stpmic1_regulator_cfg cocci_id@p [ ] ;
...
position p;
@@
 unsigned int cocci_id@p ( unsigned int mode ) ;
...
position p;
@@
 struct stpmic1_regulator_cfg * cocci_id@p ;
...
position p;
@@
 enum { STPMIC1_BUCK1 = 0 , STPMIC1_BUCK2 = 1 , STPMIC1_BUCK3 = 2 , STPMIC1_BUCK4 = 3 , STPMIC1_LDO1 = 4 , STPMIC1_LDO2 = 5 , STPMIC1_LDO3 = 6 , STPMIC1_LDO4 = 7 , STPMIC1_LDO5 = 8 , STPMIC1_LDO6 = 9 , STPMIC1_VREF_DDR = 10 , STPMIC1_BOOST = 11 , STPMIC1_VBUS_OTG = 12 , STPMIC1_SW_OUT = 13 , } cocci_id@p ;
