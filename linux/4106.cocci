...
position p;
@@
 struct mvebu_a3700_utmi_caps {  int usb32 ;  const struct phy_ops * ops ; } cocci_id@p ;
...
position p;
@@
 const struct mvebu_a3700_utmi_caps cocci_id@p ;
...
position p;
@@
 struct mvebu_a3700_utmi * cocci_id@p ;
...
position p;
@@
 struct mvebu_a3700_utmi {  void __iomem * regs ;  struct regmap * usb_misc ;  const struct mvebu_a3700_utmi_caps * caps ;  struct phy * phy ; } cocci_id@p ;
