...
position p;
@@
 struct ser_cardstate * cocci_id@p ;
...
typedef atomic_t;
@@
 struct ser_cardstate {  struct platform_device dev ;  struct tty_struct * tty ;  atomic_t refcnt ;  struct completion dead_cmp ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cardstate * ) ;
