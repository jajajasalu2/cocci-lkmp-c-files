...
position p;
@@
 const struct ip_options_rcu * cocci_id@p ;
...
position p;
@@
 struct fnhe_hash_bucket * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dst_entry * dst ) ;
...
position p;
@@
 struct neighbour * cocci_id@p ( const struct dst_entry * dst , struct sk_buff * skb , const void * daddr ) ;
...
position p;
@@
 const struct rtable * cocci_id@p ;
...
position p;
@@
 struct rt_cache_stat * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct dst_entry * dst , const void * daddr ) ;
...
position p;
@@
 const struct fib_result * cocci_id@p ;
...
position p;
@@
 struct dst_entry * cocci_id@p ( struct dst_entry * dst ) ;
...
position p;
@@
 struct fib_nh_exception * cocci_id@p ;
...
position p;
@@
 const struct inet_sock * cocci_id@p ;
