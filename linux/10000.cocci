...
position p;
@@
 struct prism2_download_param * cocci_id@p ;
...
position p;
@@
 struct hfa384x_join_request cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_SSID_LEN + 2 ] ;
...
position p;
@@
 struct hfa384x_hostscan_result * cocci_id@p ;
...
position p;
@@
 struct hfa384x_scan_request cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_NAME_LEN + 3 ] ;
...
position p;
@@
 struct hfa384x_hostscan_request cocci_id@p ;
...
position p;
@@
 struct prism2_download_area cocci_id@p ;
