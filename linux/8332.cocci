...
position p;
@@
 struct oct_nic_stats_resp cocci_id@p ;
...
position p;
@@
 struct oct_link_stats cocci_id@p ;
...
position p;
@@
 struct oct_nic_vf_stats_resp * cocci_id@p ;
...
position p;
@@
 struct oct_nic_seapi_resp * cocci_id@p ;
...
position p;
@@
 struct nic_tx_stats * cocci_id@p ;
...
position p;
@@
 struct nic_rx_stats * cocci_id@p ;
...
position p;
@@
 struct octeon_droq_ops cocci_id@p ;
...
symbol cocci_id;
position p;
typedef call_single_data_t;
@@
 call_single_data_t * cocci_id@p ;
