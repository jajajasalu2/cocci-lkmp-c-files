...
symbol cocci_id;
position p;
typedef gro_result_t;
@@
 gro_result_t cocci_id@p ;
...
position p;
@@
 struct wmi_bcast_vring_cfg_cmd cocci_id@p ;
...
position p;
@@
 struct vring_rx_desc * cocci_id@p ;
...
position p;
@@
 struct wmi_vring_cfg_cmd cocci_id@p ;
...
position p;
@@
 volatile struct vring_rx_desc * cocci_id@p ;
...
position p;
@@
 struct wil_eapol_key cocci_id@p ;
...
position p;
@@
 struct wil6210_rtap cocci_id@p ;
...
position p;
@@
 struct vring_tx_desc cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct wil6210_priv * wil , struct wil6210_vif * vif , struct wil_ring * ring , struct sk_buff * skb ) ;
...
position p;
@@
 const struct wil_1x_hdr * cocci_id@p ;
