...
position p;
@@
 enum { R7 = 7 , R11 = 11 , R12 , R13 , R14 , R15 , R16 , R17 , R18 , R19 , R20 , R21 , R23 = 23 , TOT_REGS , } cocci_id@p ;
...
position p;
@@
 struct wm8775_state * cocci_id@p ;
...
position p;
@@
 struct wm8775_platform_data * cocci_id@p ;
...
typedef u8;
@@
 struct wm8775_state {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  struct v4l2_ctrl * mute ;  struct v4l2_ctrl * vol ;  struct v4l2_ctrl * bal ;  struct v4l2_ctrl * loud ;  u8 input ; } cocci_id@p ;
