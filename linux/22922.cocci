...
position p;
@@
 struct snd_kctl_ioctl * cocci_id@p ;
...
position p;
@@
 struct snd_kctl_event * cocci_id@p ;
...
position p;
@@
 const struct {  int op ;  int perm ; } cocci_id@p [ ] ;
...
position p;
@@
 struct user_element cocci_id@p ;
...
position p;
@@
 struct snd_ctl_file * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_kctl_ioctl_func_t;
@@
 snd_kctl_ioctl_func_t cocci_id@p ;
...
position p;
@@
 enum snd_ctl_add_mode { CTL_ADD_EXCLUSIVE , CTL_REPLACE , CTL_ADD_ON_REPLACE , } cocci_id@p ;
...
position p;
@@
 struct snd_ctl_card_info * cocci_id@p ;
...
position p;
@@
 struct snd_ctl_event cocci_id@p ;
...
position p;
@@
 struct snd_ctl_elem_list cocci_id@p ;
...
typedef snd_kctl_ioctl_func_t;
@@
 struct snd_kctl_ioctl {  struct list_head list ;  snd_kctl_ioctl_func_t fioctl ; } cocci_id@p ;
...
position p;
@@
 struct user_element {  struct snd_ctl_elem_info info ;  struct snd_card * card ;  char * elem_data ;  unsigned long elem_data_size ;  void * tlv_data ;  unsigned long tlv_data_size ;  void * priv_data ; } cocci_id@p ;
...
position p;
@@
 enum snd_ctl_add_mode cocci_id@p ;
