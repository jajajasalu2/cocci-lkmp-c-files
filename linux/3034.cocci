...
typedef u32;
@@
 struct tps68470_pmic_table {  u32 address ;  u32 reg ;  u32 bitmask ; } cocci_id@p ;
...
position p;
@@
 struct tps68470_pmic_opregion * cocci_id@p ;
...
position p;
@@
 const struct tps68470_pmic_table * cocci_id@p ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct regmap * , int , int , u64 ) ;
...
position p;
@@
 struct tps68470_pmic_opregion {  struct mutex lock ;  struct regmap * regmap ; } cocci_id@p ;
