...
typedef s8,u8,u16;
@@
 struct adm1025_data {  struct i2c_client * client ;  const struct attribute_group * groups [ 3 ] ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u8 in [ 6 ] ;  u8 in_max [ 6 ] ;  u8 in_min [ 6 ] ;  s8 temp [ 2 ] ;  s8 temp_min [ 2 ] ;  s8 temp_max [ 2 ] ;  u16 alarms ;  u8 vid ;  u8 vrm ; } cocci_id@p ;
...
position p;
@@
 enum chips { adm1025 , ne1619 , } cocci_id@p ;
...
position p;
@@
 struct adm1025_data cocci_id@p ;
