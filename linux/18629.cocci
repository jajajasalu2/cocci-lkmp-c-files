...
position p;
@@
 struct omap_smp_config cocci_id@p ;
...
position p;
@@
 const struct omap_smp_config * cocci_id@p ;
...
position p;
@@
 struct omap_smp_config {  unsigned long cpu1_rstctrl_pa ;  void __iomem * cpu1_rstctrl_va ;  void __iomem * scu_base ;  void __iomem * wakeupgen_base ;  void * startup_addr ; } cocci_id@p ;
