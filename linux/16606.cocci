...
position p;
@@
 struct monwrite_hdr * cocci_id@p ;
...
position p;
@@
 struct appldata_parameter_list * cocci_id@p ;
...
position p;
@@
 struct mon_buf {  struct list_head list ;  struct monwrite_hdr hdr ;  int diag_done ;  char * data ; } cocci_id@p ;
...
position p;
@@
 struct mon_private {  struct list_head priv_list ;  struct list_head list ;  struct monwrite_hdr hdr ;  size_t hdr_to_read ;  size_t data_to_read ;  struct mon_buf * current_buf ;  struct mutex thread_mutex ; } cocci_id@p ;
...
position p;
@@
 struct appldata_product_id * cocci_id@p ;
