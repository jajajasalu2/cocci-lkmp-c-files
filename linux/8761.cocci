...
position p;
@@
 struct qlc_83xx_entry * cocci_id@p ;
...
position p;
@@
 struct qlc_83xx_rmw * cocci_id@p ;
...
position p;
@@
 struct qlc_83xx_entry_hdr * cocci_id@p ;
...
position p;
@@
 struct qlc_83xx_reset_hdr * cocci_id@p ;
...
position p;
@@
 struct qlc_83xx_quad_entry * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qlcnic_adapter * p_dev ) ;
...
position p;
@@
 struct qlc_83xx_poll cocci_id@p ;
...
position p;
@@
 struct qlc_83xx_fw_info * cocci_id@p ;
