...
position p;
@@
 const struct nt39016_panel_info cocci_id@p ;
...
position p;
@@
 struct nt39016 {  struct drm_panel drm_panel ;  struct device * dev ;  struct regmap * map ;  struct regulator * supply ;  const struct nt39016_panel_info * panel_info ;  struct gpio_desc * reset_gpio ;  struct backlight_device * backlight ; } cocci_id@p ;
