...
position p;
@@
 struct netlbl_domhsh_walk_arg cocci_id@p ;
...
typedef u32;
@@
 struct netlbl_calipso_doiwalk_arg {  struct netlink_callback * nl_cb ;  struct sk_buff * skb ;  u32 seq ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NLBL_CALIPSO_A_MAX + 1 ] ;
...
typedef u32;
@@
 struct netlbl_domhsh_walk_arg {  struct netlbl_audit * audit_info ;  u32 doi ; } cocci_id@p ;
...
position p;
@@
 struct netlbl_calipso_doiwalk_arg * cocci_id@p ;
