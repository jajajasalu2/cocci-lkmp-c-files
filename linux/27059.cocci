...
symbol cocci_id;
position p;
typedef xfs_efi_log_format_64_t;
@@
 xfs_efi_log_format_64_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_efi_log_format_t;
@@
 xfs_efi_log_format_t * cocci_id@p ;
...
position p;
@@
 const struct xfs_defer_op_type cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_extent_t;
@@
 xfs_extent_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_efi_log_format_32_t;
@@
 xfs_efi_log_format_32_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_log_iovec_t;
@@
 xfs_log_iovec_t * cocci_id@p ;
