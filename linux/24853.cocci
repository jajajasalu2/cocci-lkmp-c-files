...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_TIMEOUT_DCCP_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_PROTOINFO_DCCP_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_PROTOINFO_DCCP_MAX + 1 ] ;
...
position p;
@@
 const struct dccp_hdr_ack_bits * cocci_id@p ;
...
typedef u_int8_t;
@@
 const u_int8_t cocci_id@p [ CT_DCCP_ROLE_MAX + 1 ] [ DCCP_PKT_SYNCACK + 1 ] [ CT_DCCP_MAX + 1 ] ;
