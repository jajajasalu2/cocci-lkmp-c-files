...
position p;
@@
 struct hif_aes_pairwise_key * cocci_id@p ;
...
position p;
@@
 struct hif_wep_group_key * cocci_id@p ;
...
position p;
@@
 struct hif_aes_group_key * cocci_id@p ;
...
position p;
@@
 struct hif_tkip_pairwise_key * cocci_id@p ;
...
position p;
@@
 struct hif_igtk_group_key * cocci_id@p ;
...
position p;
@@
 struct hif_wapi_group_key * cocci_id@p ;
...
position p;
@@
 struct hif_tkip_group_key * cocci_id@p ;
...
position p;
@@
 struct hif_wapi_pairwise_key * cocci_id@p ;
...
position p;
@@
 struct hif_wep_pairwise_key * cocci_id@p ;
