...
position p;
@@
 struct hci_pdn_table_ind * cocci_id@p ;
...
position p;
@@
 struct neighbour_solicitation * cocci_id@p ;
...
typedef u8;
@@
 struct arpdata {  u8 ar_sha [ ETH_ALEN ] ;  u8 ar_sip [ 4 ] ;  u8 ar_tha [ ETH_ALEN ] ;  u8 ar_tip [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct {  int ref_cnt ;  struct sock * sock ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 union {  struct {  u8 ph_src [ 16 ] ;  u8 ph_dst [ 16 ] ;  u32 ph_len ;  u8 ph_zero [ 3 ] ;  u8 ph_nxt ; } ph __packed ;  u16 pa [ 20 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct neighbour_solicitation {  u8 target_address [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 struct neighbour_advertisement cocci_id@p ;
...
typedef u8;
@@
 struct neighbour_advertisement {  u8 target_address [ 16 ] ;  u8 type ;  u8 length ;  u8 link_layer_address [ 6 ] ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct icmp6hdr ) + sizeof ( struct neighbour_advertisement ) ] ;
...
position p;
@@
 struct hci_connect_ind * cocci_id@p ;
