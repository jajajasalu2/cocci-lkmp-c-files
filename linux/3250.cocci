...
position p;
@@
 struct max6650_data cocci_id@p ;
...
position p;
@@
 const struct max6650_data * cocci_id@p ;
...
typedef u8,bool;
@@
 struct max6650_data {  struct i2c_client * client ;  struct mutex update_lock ;  int nr_fans ;  bool valid ;  unsigned long last_updated ;  u8 speed ;  u8 config ;  u8 tach [ 4 ] ;  u8 count ;  u8 dac ;  u8 alarm ;  u8 alarm_en ;  unsigned long cooling_dev_state ; } cocci_id@p ;
