...
position p;
@@
 const struct rockchip_mbox_data cocci_id@p ;
...
typedef u32;
@@
 struct rockchip_mbox {  struct mbox_controller mbox ;  struct clk * pclk ;  void __iomem * mbox_base ;  u32 buf_size ;  struct rockchip_mbox_chan * chans ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_mbox_chan * cocci_id@p ;
...
position p;
@@
 struct rockchip_mbox_msg * cocci_id@p ;
...
typedef u32;
@@
 struct rockchip_mbox_msg {  u32 cmd ;  int rx_size ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_mbox * cocci_id@p ;
...
position p;
@@
 struct rockchip_mbox_data {  int num_chans ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_mbox_chan {  int idx ;  int irq ;  struct rockchip_mbox_msg * msg ;  struct rockchip_mbox * mb ; } cocci_id@p ;
