...
position p;
@@
 struct mxs_function * cocci_id@p ;
...
position p;
@@
 struct mxs_pinctrl_data * cocci_id@p ;
...
position p;
@@
 struct mxs_pinctrl_data {  struct device * dev ;  struct pinctrl_dev * pctl ;  void __iomem * base ;  struct mxs_pinctrl_soc_data * soc ; } cocci_id@p ;
