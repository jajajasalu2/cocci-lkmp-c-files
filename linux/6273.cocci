...
position p;
@@
 struct pcap_platform_data * cocci_id@p ;
...
position p;
@@
 struct pcap_adc_sync_request * cocci_id@p ;
...
typedef u16;
@@
 struct pcap_adc_sync_request {  u16 res [ 2 ] ;  struct completion completion ; } cocci_id@p ;
...
position p;
@@
 struct pcap_adc_request * cocci_id@p ;
...
@@
 struct pcap_chip {  struct spi_device * spi ;  u32 buf ;  spinlock_t io_lock ;  unsigned int irq_base ;  u32 msr ;  struct work_struct isr_work ;  struct work_struct msr_work ;  struct workqueue_struct * workqueue ;  struct pcap_adc_request * adc_queue [ PCAP_ADC_MAXQ ] ;  u8 adc_head ;  u8 adc_tail ;  spinlock_t adc_lock ; } cocci_id@p ;
