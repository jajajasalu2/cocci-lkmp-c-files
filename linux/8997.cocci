...
position p;
@@
 struct t4vf_port_stats cocci_id@p ;
...
typedef u64;
@@
 struct queue_port_stats {  u64 tso ;  u64 tx_csum ;  u64 rx_csum ;  u64 vlan_ex ;  u64 vlan_ins ;  u64 lro_pkts ;  u64 lro_merged ; } cocci_id@p ;
...
position p;
@@
 struct msix_entry cocci_id@p [ MSIX_ENTRIES ] ;
...
position p;
@@
 struct vf_resources * cocci_id@p ;
...
typedef __be64;
@@
 enum { MAX_TXQ_ENTRIES = 16384 , MAX_RSPQ_ENTRIES = 16384 , MAX_RX_BUFFERS = 16384 , MIN_TXQ_ENTRIES = 32 , MIN_RSPQ_ENTRIES = 128 , MIN_FL_ENTRIES = 16 , EQ_UNIT = SGE_EQ_IDXSIZE , FL_PER_EQ_UNIT = EQ_UNIT / sizeof ( __be64 ) , MIN_FL_RESID = FL_PER_EQ_UNIT , } cocci_id@p ;
...
position p;
@@
 struct cxgb4vf_debugfs_entry cocci_id@p [ ] ;
...
typedef umode_t;
@@
 struct cxgb4vf_debugfs_entry {  const char * name ;  umode_t mode ;  const struct file_operations * fops ; } cocci_id@p ;
...
position p;
@@
 union rss_vi_config cocci_id@p ;
...
position p;
@@
 struct queue_port_stats * cocci_id@p ;
