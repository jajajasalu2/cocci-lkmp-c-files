...
position p;
@@
 struct br_vlan_bind_walk_data cocci_id@p ;
...
position p;
@@
 struct br_vlan_link_state_walk_data cocci_id@p ;
...
position p;
@@
 struct br_vlan_link_state_walk_data {  struct net_bridge * br ; } cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct net_bridge_port * p , u16 vid ) ;
...
typedef u16;
@@
 struct br_vlan_bind_walk_data {  u16 vid ;  struct net_device * result ; } cocci_id@p ;
...
position p;
@@
 const struct net_bridge_vlan * cocci_id@p ;
