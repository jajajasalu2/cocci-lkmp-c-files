...
position p;
@@
 struct cdce706_hw_data {  struct cdce706_dev_data * dev_data ;  unsigned idx ;  unsigned parent ;  struct clk_hw hw ;  unsigned div ;  unsigned mul ;  unsigned mux ; } cocci_id@p ;
...
position p;
@@
 struct cdce706_dev_data * cocci_id@p ;
...
position p;
@@
 struct cdce706_hw_data * cocci_id@p ;
...
position p;
@@
 struct cdce706_dev_data {  struct i2c_client * client ;  struct regmap * regmap ;  struct clk * clkin_clk [ 2 ] ;  const char * clkin_name [ 2 ] ;  struct cdce706_hw_data clkin [ 1 ] ;  struct cdce706_hw_data pll [ 3 ] ;  struct cdce706_hw_data divider [ 6 ] ;  struct cdce706_hw_data clkout [ 6 ] ; } cocci_id@p ;
