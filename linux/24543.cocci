...
typedef bool;
@@
 struct sctp_comm_param {  struct sk_buff * skb ;  struct netlink_callback * cb ;  const struct inet_diag_req_v2 * r ;  const struct nlmsghdr * nlh ;  bool net_admin ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sock * sk , struct inet_diag_msg * r , void * info ) ;
...
position p;
@@
 struct sctp_comm_param cocci_id@p ;
