...
position p;
@@
 const struct typhoon_section_header * cocci_id@p ;
...
position p;
@@
 enum completion_wait_values { NoWait = 0 , WaitNoSleep , WaitSleep , } cocci_id@p ;
...
position p;
@@
 struct typhoon_file_header cocci_id@p ;
...
position p;
@@
 const struct typhoon_file_header * cocci_id@p ;
...
position p;
@@
 struct typhoon_shared cocci_id@p ;
...
position p;
@@
 struct typhoon_indexes * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct rxbuff_ent {  struct sk_buff * skb ;  dma_addr_t dma_addr ; } cocci_id@p ;
...
position p;
@@
 struct typhoon_card_info {  const char * name ;  const int capabilities ; } cocci_id@p ;
...
position p;
@@
 struct typhoon_interface * cocci_id@p ;
...
position p;
@@
 struct transmit_ring * cocci_id@p ;
...
position p;
@@
 struct typhoon_section_header cocci_id@p ;
...
position p;
@@
 struct typhoon_card_info cocci_id@p [ ] ;
...
position p;
@@
 enum state_values { Sleeping = 0 , Running , } cocci_id@p ;
...
position p;
@@
 enum typhoon_cards { TYPHOON_TX = 0 , TYPHOON_TX95 , TYPHOON_TX97 , TYPHOON_SVR , TYPHOON_SVR95 , TYPHOON_SVR97 , TYPHOON_TXM , TYPHOON_BSVR , TYPHOON_FX95 , TYPHOON_FX97 , TYPHOON_FX95SVR , TYPHOON_FX97SVR , TYPHOON_FXM , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,u8,u32,spinlock_t,dma_addr_t;
@@
 struct typhoon {  struct transmit_ring txLoRing ____cacheline_aligned ;  struct pci_dev * tx_pdev ;  void __iomem * tx_ioaddr ;  u32 txlo_dma_addr ;  void __iomem * ioaddr ____cacheline_aligned ;  struct typhoon_indexes * indexes ;  u8 awaiting_resp ;  u8 duplex ;  u8 speed ;  u8 card_state ;  struct basic_ring rxLoRing ;  struct pci_dev * pdev ;  struct net_device * dev ;  struct napi_struct napi ;  struct basic_ring rxHiRing ;  struct basic_ring rxBuffRing ;  struct rxbuff_ent rxbuffers [ RXENT_ENTRIES ] ;  spinlock_t command_lock ____cacheline_aligned ;  struct basic_ring cmdRing ;  struct basic_ring respRing ;  struct net_device_stats stats_saved ;  struct typhoon_shared * shared ;  dma_addr_t shared_dma ;  __le16 xcvr_select ;  __le16 wol_events ;  __le32 offload ;  int capabilities ;  struct transmit_ring txHiRing ; } cocci_id@p ;
