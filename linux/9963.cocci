...
position p;
@@
 struct hwbus_priv {  struct sdio_func * func ;  struct cw1200_common * core ;  const struct cw1200_platform_data_sdio * pdata ; } cocci_id@p ;
...
position p;
@@
 struct cw1200_platform_data_sdio * cocci_id@p ;
...
position p;
@@
 const struct cw1200_platform_data_sdio * cocci_id@p ;
