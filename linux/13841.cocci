...
position p;
@@
 enum rc5_state { STATE_INACTIVE , STATE_BIT_START , STATE_BIT_END , STATE_CHECK_RC5X , STATE_FINISHED , } cocci_id@p ;
...
position p;
@@
 const struct ir_raw_timings_manchester cocci_id@p [ 2 ] ;
