...
position p;
@@
 struct mpc512x_psc_spi_cs * cocci_id@p ;
...
position p;
@@
 enum { TYPE_MPC5121 , TYPE_MPC5125 , } cocci_id@p ;
...
position p;
@@
 struct mpc512x_psc_spi_cs {  int bits_per_word ;  int speed_hz ; } cocci_id@p ;
...
position p;
@@
 struct mpc512x_psc_fifo * cocci_id@p ;
...
position p;
@@
 struct mpc512x_psc_spi * cocci_id@p ;
