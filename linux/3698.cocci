...
position p;
@@
 struct virtio_crypto_sym_request cocci_id@p ;
...
position p;
@@
 struct virtio_crypto_skcipher_ctx cocci_id@p ;
...
position p;
@@
 struct virtio_crypto_algo cocci_id@p [ ] ;
...
@@
 struct virtio_crypto_sym_request {  struct virtio_crypto_request base ;  uint32_t type ;  struct virtio_crypto_skcipher_ctx * skcipher_ctx ;  struct skcipher_request * skcipher_req ;  uint8_t * iv ;  bool encrypt ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct virtio_crypto_algo {  uint32_t algonum ;  uint32_t service ;  unsigned int active_devs ;  struct skcipher_alg algo ; } cocci_id@p ;
...
position p;
@@
 struct virtio_crypto_skcipher_ctx {  struct crypto_engine_ctx enginectx ;  struct virtio_crypto * vcrypto ;  struct crypto_skcipher * tfm ;  struct virtio_crypto_sym_session_info enc_sess_info ;  struct virtio_crypto_sym_session_info dec_sess_info ; } cocci_id@p ;
...
position p;
@@
 struct virtio_crypto * cocci_id@p ;
...
position p;
@@
 struct virtio_crypto_request * cocci_id@p ;
...
position p;
@@
 struct virtio_crypto_destroy_session_req * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct virtio_crypto_sym_request * vc_sym_req , struct skcipher_request * req , int err ) ;
...
position p;
@@
 struct virtio_crypto_op_data_req * cocci_id@p ;
