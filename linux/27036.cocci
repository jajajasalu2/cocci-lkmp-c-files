...
symbol cocci_id;
position p;
typedef xfs_alloc_rec_t;
@@
 xfs_alloc_rec_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_alloc_key_t;
@@
 xfs_alloc_key_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_alloc_rec_incore_t;
@@
 xfs_alloc_rec_incore_t * cocci_id@p ;
