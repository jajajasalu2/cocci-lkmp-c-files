...
position p;
@@
 const struct seiko_panel_desc * cocci_id@p ;
...
typedef bool;
@@
 struct seiko_panel {  struct drm_panel base ;  bool prepared ;  bool enabled ;  const struct seiko_panel_desc * desc ;  struct backlight_device * backlight ;  struct regulator * dvdd ;  struct regulator * avdd ; } cocci_id@p ;
...
typedef u32;
@@
 struct seiko_panel_desc {  const struct drm_display_mode * modes ;  unsigned int num_modes ;  const struct display_timing * timings ;  unsigned int num_timings ;  unsigned int bpc ;  struct {  unsigned int width ;  unsigned int height ; } size ;  u32 bus_format ;  u32 bus_flags ; } cocci_id@p ;
