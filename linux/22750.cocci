...
typedef spinlock_t;
@@
 struct snd_opl3sa2 {  int version ;  unsigned long port ;  struct resource * res_port ;  int irq ;  int single_dma ;  spinlock_t reg_lock ;  struct snd_hwdep * synth ;  struct snd_rawmidi * rmidi ;  struct snd_wss * wss ;  unsigned char ctlregs [ 0x20 ] ;  int ymode ;  struct snd_kcontrol * master_switch ;  struct snd_kcontrol * master_volume ; } cocci_id@p ;
