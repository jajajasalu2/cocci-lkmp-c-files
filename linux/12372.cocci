...
position p;
@@
 enum hdmi_mapped_regs { HDMI_PHY_STATUS = HDMI_MAPPED_BASE , HDMI_PHY_RSTOUT , HDMI_ACR_CON , HDMI_ACR_MCTS0 , HDMI_ACR_CTS0 , HDMI_ACR_N0 , } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ ] [ HDMI_TYPE_COUNT ] ;
...
position p;
@@
 const struct hdmi_driver_data cocci_id@p ;
...
typedef bool;
@@
 struct hdmi_audio {  struct platform_device * pdev ;  struct hdmi_audio_infoframe infoframe ;  struct hdmi_codec_params params ;  bool mute ; } cocci_id@p ;
...
position p;
@@
 struct hdmi_context cocci_id@p ;
...
position p;
@@
 struct hdmi_driver_data {  unsigned int type ;  unsigned int is_apb_phy : 1 ;  unsigned int has_sysreg : 1 ;  struct hdmiphy_configs phy_confs ;  struct string_array_spec clk_gates ;  struct string_array_spec clk_muxes ; } cocci_id@p ;
...
position p;
@@
 struct hdmiphy_configs {  int count ;  const struct hdmiphy_config * data ; } cocci_id@p ;
...
position p;
@@
 struct exynos_drm_clk * cocci_id@p ;
...
position p;
@@
 const struct string_array_spec * cocci_id@p ;
...
typedef u8;
@@
 struct hdmiphy_config {  int pixel_clock ;  u8 conf [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct string_array_spec {  int count ;  const char * const * data ; } cocci_id@p ;
...
position p;
@@
 struct exynos_drm_crtc * cocci_id@p ;
...
position p;
@@
 const struct hdmiphy_configs * cocci_id@p ;
...
position p;
@@
 enum hdmi_type { HDMI_TYPE13 , HDMI_TYPE14 , HDMI_TYPE_COUNT , } cocci_id@p ;
...
position p;
@@
 const struct hdmiphy_config cocci_id@p [ ] ;
