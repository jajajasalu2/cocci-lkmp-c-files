...
position p;
@@
 struct sddr09_card_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * srb , struct us_data * us ) ;
...
position p;
@@
 struct nand_flash_dev {  int model_id ;  int chipshift ;  char pageshift ;  char blockshift ;  char zoneshift ;  char pageadrlen ; } cocci_id@p ;
