...
position p;
@@
 struct pwm_vibrator cocci_id@p ;
...
@@
 struct pwm_vibrator {  struct input_dev * input ;  struct pwm_device * pwm ;  struct pwm_device * pwm_dir ;  struct regulator * vcc ;  struct work_struct play_work ;  u16 level ;  u32 direction_duty_cycle ;  bool vcc_on ; } cocci_id@p ;
