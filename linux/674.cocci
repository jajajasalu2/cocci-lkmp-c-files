...
position p;
@@
 char cocci_id@p [ NSLABEL_NAME_LEN ] ;
...
position p;
@@
 struct nd_namespace_index * cocci_id@p ;
...
position p;
@@
 struct nd_namespace_common * cocci_id@p ;
...
position p;
@@
 struct blk_alloc_info cocci_id@p ;
...
position p;
@@
 struct nvdimm_drvdata * cocci_id@p ;
...
position p;
@@
 struct nd_namespace_label * cocci_id@p ;
...
position p;
@@
 struct nd_namespace_blk * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( const struct device * dev ) ;
...
position p;
@@
 struct nd_label_ent * cocci_id@p ;
...
position p;
@@
 struct nd_namespace_pmem * cocci_id@p ;
...
position p;
@@
 struct nd_namespace_io * cocci_id@p ;
...
typedef resource_size_t;
@@
 const resource_size_t cocci_id@p ;
...
position p;
@@
 enum alloc_loc { ALLOC_ERR = 0 , ALLOC_BEFORE , ALLOC_MID , ALLOC_AFTER , } cocci_id@p ;
