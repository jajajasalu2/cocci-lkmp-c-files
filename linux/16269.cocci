...
position p;
@@
 struct v4l2_mbus_framefmt * cocci_id@p ( struct iss_ipipe_device * ipipe , struct v4l2_subdev_pad_config * cfg , unsigned int pad , enum v4l2_subdev_format_whence which ) ;
...
position p;
@@
 struct iss_ipipe_device * cocci_id@p ;
