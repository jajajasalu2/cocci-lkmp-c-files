...
position p;
@@
 struct ad5755_state * cocci_id@p ;
...
position p;
@@
 const struct ad5755_chip_info cocci_id@p [ ] ;
...
typedef u8,__be32;
@@
 struct ad5755_state {  struct spi_device * spi ;  const struct ad5755_chip_info * chip_info ;  unsigned int pwr_down ;  unsigned int ctrl [ AD5755_NUM_CHANNELS ] ;  struct iio_chan_spec channels [ AD5755_NUM_CHANNELS ] ;  union {  __be32 d32 ;  u8 d8 [ 4 ] ; } data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
typedef bool;
@@
 struct ad5755_chip_info {  const struct iio_chan_spec channel_template ;  unsigned int calib_shift ;  bool has_voltage_out ; } cocci_id@p ;
...
position p;
@@
 struct ad5755_platform_data * cocci_id@p ;
...
position p;
@@
 enum ad5755_type { ID_AD5755 , ID_AD5757 , ID_AD5735 , ID_AD5737 , } cocci_id@p ;
...
position p;
@@
 const struct ad5755_platform_data * cocci_id@p ;
