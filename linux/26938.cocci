...
position p;
@@
 const struct nfs_auth_info * cocci_id@p ;
...
position p;
@@
 struct nfs_mount_data * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct super_block * , void * ) ;
...
@@
 const struct {  rpc_authflavor_t flavour ;  const char * str ; } cocci_id@p [ NFS_AUTH_INFO_MAX_FLAVORS ] ;
...
position p;
@@
 struct dentry * cocci_id@p ( struct file_system_type * fs_type , int flags , const char * dev_name , void * raw_data ) ;
...
position p;
@@
 enum { Opt_vers_2 , Opt_vers_3 , Opt_vers_4 , Opt_vers_4_0 , Opt_vers_4_1 , Opt_vers_4_2 , Opt_vers_err , } cocci_id@p ;
...
position p;
@@
 enum { Opt_lookupcache_all , Opt_lookupcache_positive , Opt_lookupcache_none , Opt_lookupcache_err , } cocci_id@p ;
...
position p;
@@
 struct nfs_auth_info * cocci_id@p ;
...
typedef rpc_authflavor_t;
@@
 rpc_authflavor_t cocci_id@p [ NFS_MAX_SECFLAVORS ] ;
...
position p;
@@
 struct nfs_clone_mount * cocci_id@p ;
...
position p;
@@
 struct nfs_subversion * cocci_id@p ;
...
position p;
@@
 struct nfs_sb_mountdata {  struct nfs_server * server ;  int mntflags ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nfs_parsed_mount_data * ) ;
...
position p;
@@
 enum { Opt_local_lock_all , Opt_local_lock_flock , Opt_local_lock_posix , Opt_local_lock_none , Opt_local_lock_err , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * options , struct nfs_parsed_mount_data * args , const char * dev_name ) ;
...
position p;
@@
 struct nfs4_mount_data * cocci_id@p ;
...
position p;
@@
 struct nfs_mount_info cocci_id@p ;
...
position p;
@@
 struct nfs_sb_mountdata * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NFS4_CLIENT_ID_UNIQ_LEN ] ;
...
position p;
@@
 const struct proc_nfs_info * cocci_id@p ;
...
position p;
@@
 const struct proc_nfs_info {  int flag ;  const char * str ;  const char * nostr ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct rpc_clnt * cocci_id@p ;
...
position p;
@@
 const struct user_namespace * cocci_id@p ;
...
position p;
@@
 enum { Opt_sec_none , Opt_sec_sys , Opt_sec_krb5 , Opt_sec_krb5i , Opt_sec_krb5p , Opt_sec_lkey , Opt_sec_lkeyi , Opt_sec_lkeyp , Opt_sec_spkm , Opt_sec_spkmi , Opt_sec_spkmp , Opt_sec_err , } cocci_id@p ;
...
position p;
@@
 struct nfs_parsed_mount_data * cocci_id@p ;
...
position p;
@@
 struct nfs_mount_request cocci_id@p ;
