...
position p;
@@
 struct color cocci_id@p [ MAX_LINUX_LOGO_COLORS ] ;
...
position p;
@@
 const char * cocci_id@p [ LINUX_LOGO_GRAY256 + 1 ] ;
...
position p;
@@
 const struct color cocci_id@p [ 16 ] ;
...
position p;
@@
 struct color {  unsigned char red ;  unsigned char green ;  unsigned char blue ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void ) __attribute ( ( noreturn ) ) ;
