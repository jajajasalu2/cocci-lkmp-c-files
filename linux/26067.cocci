...
position p;
@@
 struct other_val {  long long foo ;  long long bar ; } cocci_id@p ;
...
position p;
@@
 struct bpf_cgroup_storage_key cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cap_flag_value_t;
@@
 cap_flag_value_t cocci_id@p ;
...
position p;
@@
 struct test_val {  unsigned int index ;  int foo [ MAX_ENTRIES ] ; } cocci_id@p ;
