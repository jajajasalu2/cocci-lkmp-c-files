...
typedef u8;
@@
 u8 cocci_id@p [ 2 + sizeof ( struct ieee80211_ch_switch_timing ) ] ;
...
position p;
@@
 struct ieee80211_tdls_ch_sw_params cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ 2 + sizeof ( struct ieee80211_sec_chan_offs_ie ) + 2 + sizeof ( struct ieee80211_ch_switch_timing ) ] ;
