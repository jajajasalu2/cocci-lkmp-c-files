...
position p;
@@
 struct sti_dvo_connector {  struct drm_connector drm_connector ;  struct drm_encoder * encoder ;  struct sti_dvo * dvo ; } cocci_id@p ;
...
position p;
@@
 struct awg_code_generation_params cocci_id@p ;
...
position p;
@@
 struct sti_dvo_connector cocci_id@p ;
