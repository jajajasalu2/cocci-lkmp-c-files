...
position p;
@@
 const struct zfile_header * cocci_id@p ;
...
position p;
@@
 struct cyclades_icount cocci_id@p ;
...
position p;
@@
 struct cyclades_card * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cyclades_port * , struct tty_struct * ) ;
...
position p;
@@
 struct cyclades_port cocci_id@p ;
...
position p;
@@
 const struct zfile_config * cocci_id@p ;
...
position p;
@@
 enum zblock_type { ZBLOCK_PRG = 0 , ZBLOCK_FPGA = 1 , } cocci_id@p ;
...
position p;
@@
 const struct zfile_block * cocci_id@p ;
...
position p;
@@
 struct cyclades_card cocci_id@p [ NR_CARDS ] ;
...
typedef __u32,__u8;
@@
 int cocci_id@p ( struct cyclades_card * , __u32 , __u8 , __u32 ) ;
...
position p;
@@
 unsigned cocci_id@p ( void __iomem * ) ;
