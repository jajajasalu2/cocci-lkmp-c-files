...
position p;
@@
 struct comedi_device * cocci_id@p [ COMEDI_NUM_BOARD_MINORS ] ;
...
position p;
@@
 struct comedi_buf_map * cocci_id@p ;
...
position p;
@@
 struct comedi_devinfo cocci_id@p ;
...
position p;
@@
 struct comedi_insnlist cocci_id@p ;
...
position p;
@@
 struct comedi_subdinfo * cocci_id@p ;
...
position p;
@@
 struct comedi_file {  struct comedi_device * dev ;  struct comedi_subdevice * read_subdev ;  struct comedi_subdevice * write_subdev ;  unsigned int last_detach_count ;  unsigned int last_attached : 1 ; } cocci_id@p ;
...
position p;
@@
 struct comedi_subdevice * cocci_id@p [ COMEDI_NUM_SUBDEVICE_MINORS ] ;
...
position p;
@@
 struct comedi_chaninfo cocci_id@p ;
...
position p;
@@
 struct comedi_bufconfig cocci_id@p ;
...
position p;
@@
 struct comedi_buf_page * cocci_id@p ;
...
position p;
@@
 struct comedi_bufinfo cocci_id@p ;
