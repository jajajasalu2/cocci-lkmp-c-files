...
position p;
@@
 struct usbdevfs_urb * cocci_id@p ;
...
position p;
@@
 struct usbdevfs_bulktransfer cocci_id@p ;
...
position p;
@@
 struct usbdevfs_disconnect_claim cocci_id@p ;
...
position p;
@@
 struct usbdevfs_iso_packet_desc * cocci_id@p ;
...
@@
 struct usb_memory {  struct list_head memlist ;  int vma_use_count ;  int urb_use_count ;  u32 size ;  void * mem ;  dma_addr_t dma_handle ;  unsigned long vm_start ;  struct usb_dev_state * ps ; } cocci_id@p ;
...
position p;
@@
 struct usb_dev_state cocci_id@p ;
...
position p;
@@
 struct usbdevfs_ioctl32 cocci_id@p ;
...
position p;
@@
 struct usbdevfs_ioctl * cocci_id@p ;
...
position p;
@@
 struct usbdevfs_setinterface cocci_id@p ;
...
position p;
@@
 struct usbdevfs_disconnectsignal cocci_id@p ;
...
position p;
@@
 struct usbdevfs_getdriver cocci_id@p ;
...
position p;
@@
 struct usbdevfs_conninfo_ex cocci_id@p ;
...
position p;
@@
 const struct usbdevfs_urb * cocci_id@p ;
...
position p;
@@
 struct usb_host_config * cocci_id@p ;
...
position p;
@@
 struct usbdevfs_disconnectsignal32 cocci_id@p ;
...
position p;
@@
 struct usbdevfs_urb32 cocci_id@p ;
...
position p;
@@
 enum snoop_when { SUBMIT , COMPLETE , } cocci_id@p ;
...
position p;
@@
 struct usbdevfs_ctrltransfer cocci_id@p ;
...
position p;
@@
 struct usbdevfs_connectinfo cocci_id@p ;
...
typedef u8,sigval_t;
@@
 struct async {  struct list_head asynclist ;  struct usb_dev_state * ps ;  struct pid * pid ;  const struct cred * cred ;  unsigned int signr ;  unsigned int ifnum ;  void __user * userbuffer ;  void __user * userurb ;  sigval_t userurb_sigval ;  struct urb * urb ;  struct usb_memory * usbm ;  unsigned int mem_usage ;  int status ;  u8 bulk_addr ;  u8 bulk_status ; } cocci_id@p ;
