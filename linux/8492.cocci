...
position p;
@@
 struct phy_device * const cocci_id@p ;
...
position p;
@@
 struct au1000_private cocci_id@p ;
...
position p;
@@
 struct au1000_private * const cocci_id@p ;
...
position p;
@@
 struct net_device * const cocci_id@p ;
