...
position p;
@@
 struct i2c_payloads {  struct vector payloads ; } cocci_id@p ;
...
position p;
@@
 enum { DP_SINK_CAP_SIZE = DP_EDP_CONFIGURATION_CAP - DP_DPCD_REV + 1 , } cocci_id@p ;
...
position p;
@@
 struct i2c_payloads * * cocci_id@p ;
...
position p;
@@
 struct gpio_ddc_hw_info cocci_id@p ;
...
typedef uint8_t;
@@
 union hdmi_scdc_status_flags_data {  uint8_t byte [ 2 ] ;  struct {  uint8_t CLOCK_DETECTED : 1 ;  uint8_t CH0_LOCKED : 1 ;  uint8_t CH1_LOCKED : 1 ;  uint8_t CH2_LOCKED : 1 ;  uint8_t RESERVED : 4 ;  uint8_t RESERVED2 : 8 ;  uint8_t RESERVED3 : 8 ; } fields ; } cocci_id@p ;
...
typedef uint8_t;
@@
 union hdmi_scdc_update_read_data {  uint8_t byte [ 2 ] ;  struct {  uint8_t STATUS_UPDATE : 1 ;  uint8_t CED_UPDATE : 1 ;  uint8_t RR_TEST : 1 ;  uint8_t RESERVED : 5 ;  uint8_t RESERVED2 : 8 ; } fields ; } cocci_id@p ;
...
@@
 struct dp_hdmi_dongle_signature_data {  int8_t id [ 15 ] ;  uint8_t eot ; } cocci_id@p ;
...
position p;
@@
 enum ddc_service_type cocci_id@p ;
...
typedef uint8_t;
@@
 union hdmi_scdc_ced_data {  uint8_t byte [ 7 ] ;  struct {  uint8_t CH0_8LOW : 8 ;  uint8_t CH0_7HIGH : 7 ;  uint8_t CH0_VALID : 1 ;  uint8_t CH1_8LOW : 8 ;  uint8_t CH1_7HIGH : 7 ;  uint8_t CH1_VALID : 1 ;  uint8_t CH2_8LOW : 8 ;  uint8_t CH2_7HIGH : 7 ;  uint8_t CH2_VALID : 1 ;  uint8_t CHECKSUM : 8 ;  uint8_t RESERVED : 8 ;  uint8_t RESERVED2 : 8 ;  uint8_t RESERVED3 : 8 ;  uint8_t RESERVED4 : 4 ; } fields ; } cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DP_ADAPTOR_TYPE2_SIZE ] ;
...
position p;
@@
 enum aux_channel_operation_result * cocci_id@p ;
...
typedef uint8_t,int8_t;
@@
 struct dvi_hdmi_dongle_signature_data {  int8_t vendor [ 3 ] ;  uint8_t version [ 2 ] ;  uint8_t size ;  int8_t id [ 11 ] ; } cocci_id@p ;
...
position p;
@@
 struct dp_hdmi_dongle_signature_data * cocci_id@p ;
...
position p;
@@
 struct aux_payloads {  struct vector payloads ; } cocci_id@p ;
...
position p;
@@
 union hdmi_scdc_status_flags_data cocci_id@p ;
...
position p;
@@
 struct i2c_payload cocci_id@p [ 2 ] ;
