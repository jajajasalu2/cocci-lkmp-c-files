...
position p;
@@
 const struct hi556_mode * cocci_id@p ;
...
position p;
@@
 const struct hi556_link_freq_config cocci_id@p [ ] ;
...
typedef u32;
@@
 struct hi556_mode {  u32 width ;  u32 height ;  u32 llp ;  u32 fll_def ;  u32 fll_min ;  u32 link_freq_index ;  const struct hi556_reg_list reg_list ; } cocci_id@p ;
...
typedef bool;
@@
 struct hi556 {  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_ctrl * link_freq ;  struct v4l2_ctrl * pixel_rate ;  struct v4l2_ctrl * vblank ;  struct v4l2_ctrl * hblank ;  struct v4l2_ctrl * exposure ;  const struct hi556_mode * cur_mode ;  struct mutex mutex ;  bool streaming ; } cocci_id@p ;
...
position p;
@@
 enum { HI556_LINK_FREQ_437MHZ_INDEX , } cocci_id@p ;
...
typedef u32;
@@
 struct hi556_reg_list {  u32 num_of_regs ;  const struct hi556_reg * regs ; } cocci_id@p ;
...
position p;
@@
 struct hi556_link_freq_config {  const struct hi556_reg_list reg_list ; } cocci_id@p ;
...
position p;
@@
 const struct hi556_reg_list * cocci_id@p ;
...
position p;
@@
 const struct hi556_reg cocci_id@p [ ] ;
...
typedef u16;
@@
 struct hi556_reg {  u16 address ;  u16 val ; } cocci_id@p ;
