...
position p;
@@
 enum vmpressure_levels { VMPRESSURE_LOW = 0 , VMPRESSURE_MEDIUM , VMPRESSURE_CRITICAL , VMPRESSURE_NUM_LEVELS , } cocci_id@p ;
...
position p;
@@
 enum vmpressure_modes { VMPRESSURE_NO_PASSTHROUGH = 0 , VMPRESSURE_HIERARCHY , VMPRESSURE_LOCAL , VMPRESSURE_NUM_MODES , } cocci_id@p ;
...
position p;
@@
 const enum vmpressure_levels cocci_id@p ;
...
position p;
@@
 struct vmpressure_event {  struct eventfd_ctx * efd ;  enum vmpressure_levels level ;  enum vmpressure_modes mode ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 enum vmpressure_levels cocci_id@p ;
...
position p;
@@
 struct vmpressure_event * cocci_id@p ;
...
position p;
@@
 enum vmpressure_modes cocci_id@p ;
