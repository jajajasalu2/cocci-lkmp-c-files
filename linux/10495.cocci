...
position p;
@@
 struct vce_v1_0_fw_signature * cocci_id@p ;
...
@@
 struct vce_v1_0_fw_signature {  int32_t off ;  uint32_t len ;  int32_t num ;  struct {  uint32_t chip_id ;  uint32_t keyselect ;  uint32_t nonce [ 4 ] ;  uint32_t sigval [ 4 ] ; } val [ 8 ] ; } cocci_id@p ;
