...
position p;
@@
 struct iss_pipeline * cocci_id@p ;
...
position p;
@@
 struct iss_csi2_ctx_cfg * cocci_id@p ;
...
position p;
@@
 struct iss_csi2_device cocci_id@p ;
...
position p;
@@
 const struct iss_v4l2_subdevs_group * cocci_id@p ;
...
position p;
@@
 struct iss_csi2_ctrl_cfg * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ V4L2_SUBDEV_NAME_SIZE ] ;
...
position p;
@@
 const struct iss_format_info * cocci_id@p ;
...
position p;
@@
 const struct iss_video_operations cocci_id@p ;
...
position p;
@@
 struct iss_csi2_timing_cfg * cocci_id@p ;
