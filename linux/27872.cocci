...
position p;
@@
 struct affs_inode_info cocci_id@p ;
...
position p;
@@
 enum { Opt_bs , Opt_mode , Opt_mufs , Opt_notruncate , Opt_prefix , Opt_protect , Opt_reserved , Opt_root , Opt_setgid , Opt_setuid , Opt_verbose , Opt_volume , Opt_ignore , Opt_err , } cocci_id@p ;
...
position p;
@@
 struct affs_sb_info cocci_id@p ;
...
position p;
@@
 struct affs_root_tail * cocci_id@p ;
