...
typedef u8;
@@
 struct zd1301_demod_dev {  struct platform_device * pdev ;  struct dvb_frontend frontend ;  struct i2c_adapter adapter ;  u8 gain ; } cocci_id@p ;
...
position p;
@@
 struct zd1301_demod_platform_data * cocci_id@p ;
...
position p;
@@
 struct zd1301_demod_dev * cocci_id@p ;
