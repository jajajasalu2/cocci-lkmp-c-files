...
typedef bool;
@@
 struct arm_dma_free_args {  struct device * dev ;  size_t size ;  void * cpu_addr ;  struct page * page ;  bool want_vaddr ; } cocci_id@p ;
...
position p;
@@
 struct arm_dma_free_args * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,gfp_t,pgprot_t;
@@
 struct arm_dma_alloc_args {  struct device * dev ;  size_t size ;  gfp_t gfp ;  pgprot_t prot ;  const void * caller ;  bool want_vaddr ;  int coherent_flag ; } cocci_id@p ;
...
position p;
@@
 struct arm_dma_buffer * cocci_id@p ;
...
position p;
@@
 struct arm_dma_alloc_args * cocci_id@p ;
...
position p;
@@
 struct arm_dma_allocator {  void * ( * alloc ) ( struct arm_dma_alloc_args * args , struct page * * ret_page ) ;  void ( * free ) ( struct arm_dma_free_args * args ) ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dma_iommu_mapping * mapping ) ;
...
position p;
@@
 struct arm_dma_buffer {  struct list_head list ;  void * virt ;  struct arm_dma_allocator * allocator ; } cocci_id@p ;
...
position p;
@@
 struct arm_dma_allocator cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct dma_contig_early_reserve {  phys_addr_t base ;  unsigned long size ; } cocci_id@p ;
