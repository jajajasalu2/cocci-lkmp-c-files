...
position p;
@@
 const struct tegra_slink_chip_data * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ MAX_CHIP_SELECT ] ;
...
typedef bool;
@@
 struct tegra_slink_chip_data {  bool cs_hold_time ; } cocci_id@p ;
...
position p;
@@
 struct tegra_slink_data * cocci_id@p ;
