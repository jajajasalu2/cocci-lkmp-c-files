...
position p;
@@
 int cocci_id@p ( int n , char * * con_remove ) ;
...
position p;
@@
 int cocci_id@p ( char * dev , char * str , int size , char * * error_out ) ;
...
position p;
@@
 int cocci_id@p ( char * str , char * * error_out ) ;
...
position p;
@@
 struct line cocci_id@p [ MAX_TTYS ] ;
