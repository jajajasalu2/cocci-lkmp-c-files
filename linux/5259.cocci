...
position p;
@@
 enum brcm_ahci_quirks { BRCM_AHCI_QUIRK_SKIP_PHY_ENABLE = BIT ( 0 ) , } cocci_id@p ;
...
position p;
@@
 enum brcm_ahci_version { BRCM_SATA_BCM7425 = 1 , BRCM_SATA_BCM7445 , BRCM_SATA_NSP , } cocci_id@p ;
...
position p;
@@
 enum brcm_ahci_version cocci_id@p ;
...
typedef u32;
@@
 struct brcm_ahci_priv {  struct device * dev ;  void __iomem * top_ctrl ;  u32 port_mask ;  u32 quirks ;  enum brcm_ahci_version version ;  struct reset_control * rcdev ; } cocci_id@p ;
...
position p;
@@
 struct brcm_ahci_priv * cocci_id@p ;
