...
position p;
@@
 struct mlx5_ib_dbg_param * cocci_id@p ;
...
position p;
@@
 enum mlx5_ib_cong_node_type cocci_id@p ;
...
position p;
@@
 enum mlx5_ib_dbg_cc_types cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_dbg_cc_params * cocci_id@p ;
...
position p;
@@
 enum mlx5_ib_cong_node_type { MLX5_IB_RROCE_ECN_RP = 1 , MLX5_IB_RROCE_ECN_NP = 2 , } cocci_id@p ;
