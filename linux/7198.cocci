...
typedef bool;
@@
 struct cht_wc_extcon_data {  struct device * dev ;  struct regmap * regmap ;  struct extcon_dev * edev ;  unsigned int previous_cable ;  bool usb_host ; } cocci_id@p ;
...
position p;
@@
 enum cht_wc_mux_select { MUX_SEL_PMIC = 0 , MUX_SEL_SOC , } cocci_id@p ;
...
position p;
@@
 struct cht_wc_extcon_data * cocci_id@p ;
