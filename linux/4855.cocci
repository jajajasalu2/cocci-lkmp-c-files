...
position p;
@@
 struct mlx4_tunnel_mad * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_demux_pv_ctx * * cocci_id@p ;
...
position p;
@@
 struct mlx4_mad_rcv_buf cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct mlx4_ib_dev * dev , u8 port_num ) ;
...
position p;
@@
 struct mlx4_ib_demux_ctx * cocci_id@p ;
...
position p;
@@
 struct mlx4_rcv_tunnel_mad cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct mlx4_ib_dev * dev , int port_num , int block , u32 change_bitmap ) ;
...
@@
 struct {  __be32 my_qpn ;  u32 reserved1 ;  __be32 rqpn ;  u8 sl ;  u8 g_path ;  u16 reserved2 [ 2 ] ;  __be16 pkey ;  u32 reserved3 [ 11 ] ;  u8 grh [ 40 ] ; } * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_tun_tx_buf cocci_id@p ;
...
position p;
@@
 struct ib_port_info * cocci_id@p ;
...
position p;
@@
 struct mlx4_mad_snd_buf * cocci_id@p ;
...
position p;
@@
 enum { MLX4_IB_VENDOR_CLASS1 = 0x9 , MLX4_IB_VENDOR_CLASS2 = 0xa , } cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_demux_pv_qp * cocci_id@p ;
