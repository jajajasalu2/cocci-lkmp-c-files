...
position p;
@@
 enum ads8688_range { ADS8688_PLUSMINUS25VREF , ADS8688_PLUSMINUS125VREF , ADS8688_PLUSMINUS0625VREF , ADS8688_PLUS25VREF , ADS8688_PLUS125VREF , } cocci_id@p ;
...
position p;
@@
 struct ads8688_state * cocci_id@p ;
...
typedef u8;
@@
 struct ads8688_ranges {  enum ads8688_range range ;  unsigned int scale ;  int offset ;  u8 reg ; } cocci_id@p ;
...
typedef u16,s64;
@@
 u16 cocci_id@p [ ADS8688_MAX_CHANNELS + sizeof ( s64 ) / sizeof ( u16 ) ] ;
...
position p;
@@
 const struct ads8688_chip_info cocci_id@p [ ] ;
...
position p;
@@
 const struct ads8688_ranges cocci_id@p [ 5 ] ;
...
position p;
@@
 struct ads8688_chip_info {  const struct iio_chan_spec * channels ;  unsigned int num_channels ; } cocci_id@p ;
...
position p;
@@
 enum ads8688_id { ID_ADS8684 , ID_ADS8688 , } cocci_id@p ;
...
typedef u8,__be32;
@@
 struct ads8688_state {  struct mutex lock ;  const struct ads8688_chip_info * chip_info ;  struct spi_device * spi ;  struct regulator * reg ;  unsigned int vref_mv ;  enum ads8688_range range [ 8 ] ;  union {  __be32 d32 ;  u8 d8 [ 4 ] ; } data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
