...
position p;
@@
 int cocci_id@p ( struct irq_data * data , unsigned int type ) ;
...
position p;
@@
 struct ocelot_pinctrl * cocci_id@p ;
...
position p;
@@
 struct ocelot_pmx_func {  const char * * groups ;  unsigned int ngroups ; } cocci_id@p ;
...
position p;
@@
 struct ocelot_pin_caps * cocci_id@p ;
...
position p;
@@
 struct ocelot_pin_caps {  unsigned int pin ;  unsigned char functions [ OCELOT_FUNC_PER_PIN ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct ocelot_pinctrl {  struct device * dev ;  struct pinctrl_dev * pctl ;  struct gpio_chip gpio_chip ;  struct regmap * map ;  struct pinctrl_desc * desc ;  struct ocelot_pmx_func func [ FUNC_MAX ] ;  u8 stride ; } cocci_id@p ;
