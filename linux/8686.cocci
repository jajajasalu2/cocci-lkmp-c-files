...
position p;
@@
 struct fm10k_ring_feature * cocci_id@p ;
...
typedef u8;
@@
 union {  struct iphdr * ipv4 ;  struct ipv6hdr * ipv6 ;  u8 * raw ; } cocci_id@p ;
...
position p;
@@
 struct fm10k_nvgre_hdr * cocci_id@p ;
...
position p;
@@
 struct fm10k_tx_buffer * cocci_id@p ;
...
typedef __be32;
@@
 struct fm10k_nvgre_hdr {  __be16 flags ;  __be16 proto ;  __be32 tni ; } cocci_id@p ;
...
position p;
@@
 struct fm10k_l2_accel * cocci_id@p ;
...
position p;
@@
 struct fm10k_ring_container * cocci_id@p ;
...
position p;
@@
 struct fm10k_udp_port cocci_id@p ;
...
position p;
@@
 struct fm10k_rx_buffer * cocci_id@p ;
