...
position p;
@@
 struct ath10k_usb_ctrl_diag_resp_read cocci_id@p ;
...
position p;
@@
 struct ath10k_usb_ctrl_diag_cmd_read * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ath10k * ar , struct ath10k_usb_pipe * recv_pipe ) ;
...
position p;
@@
 struct ath10k_usb_ctrl_diag_cmd_write * cocci_id@p ;
...
position p;
@@
 struct ath10k_urb_context cocci_id@p ;
...
position p;
@@
 struct ath10k_usb_pipe cocci_id@p ;
