...
position p;
@@
 enum isl29028_als_ir_mode { ISL29028_MODE_NONE = 0 , ISL29028_MODE_ALS , ISL29028_MODE_IR , } cocci_id@p ;
...
position p;
@@
 const struct isl29028_prox_data cocci_id@p [ ] ;
...
position p;
@@
 enum isl29028_als_ir_mode cocci_id@p ;
...
position p;
@@
 struct isl29028_prox_data {  int sampling_int ;  int sampling_fract ;  int sleep_time ; } cocci_id@p ;
...
typedef bool;
@@
 struct isl29028_chip {  struct mutex lock ;  struct regmap * regmap ;  int prox_sampling_int ;  int prox_sampling_frac ;  bool enable_prox ;  int lux_scale ;  enum isl29028_als_ir_mode als_ir_mode ; } cocci_id@p ;
...
position p;
@@
 struct isl29028_chip * cocci_id@p ;
