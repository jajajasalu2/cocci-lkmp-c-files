...
position p;
@@
 enum ispif_intf_cmd { CMD_DISABLE_FRAME_BOUNDARY = 0x0 , CMD_ENABLE_FRAME_BOUNDARY = 0x1 , CMD_DISABLE_IMMEDIATELY = 0x2 , CMD_ALL_DISABLE_IMMEDIATELY = 0xaaaaaaaa , CMD_ALL_NO_CHANGE = 0xffffffff , } cocci_id@p ;
...
position p;
@@
 struct ispif_device * cocci_id@p ;
...
position p;
@@
 const struct resources_ispif * cocci_id@p ;
