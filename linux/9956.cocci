...
typedef u16;
@@
 u16 cocci_id@p [ USB_MAX_IOREAD32_COUNT * 2 ] ;
...
position p;
@@
 struct zd_ioreq16 cocci_id@p [ USB_MAX_IOWRITE32_COUNT * 2 ] ;
...
typedef zd_addr_t;
@@
 zd_addr_t cocci_id@p [ USB_MAX_IOREAD32_COUNT * 2 ] ;
...
position p;
@@
 const struct zd_ioreq32 cocci_id@p [ 2 ] ;
...
typedef u32;
@@
 struct aw_pt_bi {  u32 atim_wnd_period ;  u32 pre_tbtt ;  u32 beacon_interval ; } cocci_id@p ;
...
position p;
@@
 const struct zd_ioreq16 cocci_id@p [ ] ;
...
position p;
@@
 struct zd_ioreq32 cocci_id@p [ 3 ] ;
...
position p;
@@
 struct zd_ioreq16 cocci_id@p [ ARRAY_SIZE ( a ) ] ;
...
position p;
@@
 const struct zd_ioreq32 * cocci_id@p ;
...
position p;
@@
 struct zd_ioreq16 cocci_id@p [ 3 ] ;
...
position p;
@@
 struct zd_ioreq32 cocci_id@p [ 2 ] ;
