...
position p;
@@
 struct mlx4_en_filter * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_mc_list cocci_id@p ;
...
position p;
@@
 struct mlx4_en_bond {  struct work_struct work ;  struct mlx4_en_priv * priv ;  int is_bonded ;  struct mlx4_port_map port_map ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_en_rx_ring * cocci_id@p ;
...
position p;
@@
 struct mlx4_spec_list cocci_id@p ;
...
position p;
@@
 struct mlx4_en_bond cocci_id@p ;
...
position p;
@@
 struct ethtool_flow_id * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_priv * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ETH_ALEN + 2 ] ;
...
position p;
@@
 struct mlx4_en_stats_bitmap * cocci_id@p ;
...
position p;
@@
 struct mlx4_net_trans_rule cocci_id@p ;
...
position p;
@@
 struct mlx4_en_rx_desc cocci_id@p ;
...
position p;
@@
 struct mlx4_en_tx_ring * * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_port_profile * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,u32,__be32;
@@
 struct mlx4_en_filter {  struct list_head next ;  struct work_struct work ;  u8 ip_proto ;  __be32 src_ip ;  __be32 dst_ip ;  __be16 src_port ;  __be16 dst_port ;  int rxq_index ;  struct mlx4_en_priv * priv ;  u32 flow_id ;  int id ;  u64 reg_id ;  u8 activated ;  struct hlist_node filter_chain ; } cocci_id@p ;
...
position p;
@@
 enum mlx4_net_trans_rule_id cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx4_en_priv * priv ) ;
...
position p;
@@
 struct netdev_notifier_bonding_info * cocci_id@p ;
...
position p;
@@
 struct mlx4_mac_entry * cocci_id@p ;
...
position p;
@@
 struct netdev_bonding_info * cocci_id@p ;
