...
symbol cocci_id;
position p;
typedef xfs_suminfo_t;
@@
 xfs_suminfo_t * cocci_id@p ;
...
position p;
@@
 struct xfs_rtalloc_rec cocci_id@p [ 2 ] ;
...
symbol cocci_id;
position p;
typedef xfs_rtword_t;
@@
 xfs_rtword_t cocci_id@p ;
...
position p;
@@
 xfs_rtalloc_query_range_fn cocci_id@p ;
