...
position p;
@@
 enum SCIC_SDS_APC_ACTIVITY cocci_id@p ;
...
position p;
@@
 enum SCIC_SDS_APC_ACTIVITY { SCIC_SDS_APC_SKIP_PHY , SCIC_SDS_APC_ADD_PHY , SCIC_SDS_APC_START_TIMER , SCIC_SDS_APC_ACTIVITY_MAX , } cocci_id@p ;
...
position p;
@@
 struct sci_port_configuration_agent * cocci_id@p ;
...
position p;
@@
 enum sci_port_configuration_mode cocci_id@p ;
