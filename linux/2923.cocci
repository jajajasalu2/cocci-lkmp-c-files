...
position p;
@@
 struct acpi_fadt_pm_info cocci_id@p [ ] ;
...
typedef u8,u64;
@@
 void cocci_id@p ( struct acpi_generic_address * generic_address , u8 space_id , u8 byte_width , u64 address , const char * register_name , u8 flags ) ;
...
position p;
@@
 struct acpi_fadt_info cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct acpi_fadt_pm_info {  struct acpi_generic_address * target ;  u16 source ;  u8 register_num ; } cocci_id@p ;
...
typedef u64,u32;
@@
 u64 cocci_id@p ( char * register_name , u32 address32 , u64 address64 ) ;
...
typedef u8,u16;
@@
 struct acpi_fadt_info {  const char * name ;  u16 address64 ;  u16 address32 ;  u16 length ;  u8 default_length ;  u8 flags ; } cocci_id@p ;
