...
position p;
@@
 struct freq_qos_request * cocci_id@p ;
...
position p;
@@
 struct cpufreq_driver cocci_id@p ;
...
typedef bool;
@@
 struct global_params {  bool no_turbo ;  bool turbo_disabled ;  bool turbo_disabled_mf ;  int max_perf_pct ;  int min_perf_pct ; } cocci_id@p ;
...
position p;
@@
 struct pstate_funcs * cocci_id@p ;
...
typedef int32_t;
@@
 struct vid_data {  int min ;  int max ;  int turbo ;  int32_t ratio ; } cocci_id@p ;
...
position p;
@@
 const struct pstate_funcs cocci_id@p ;
...
typedef u64,int32_t;
@@
 struct sample {  int32_t core_avg_perf ;  int32_t busy_scaled ;  u64 aperf ;  u64 mperf ;  u64 tsc ;  u64 time ; } cocci_id@p ;
...
position p;
@@
 struct acpi_processor * cocci_id@p ;
...
position p;
@@
 struct global_params cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cpudata * cpudata ) ;
...
position p;
@@
 struct pstate_data {  int current_pstate ;  int min_pstate ;  int max_pstate ;  int max_pstate_physical ;  int scaling ;  int turbo_pstate ;  unsigned int max_freq ;  unsigned int turbo_freq ; } cocci_id@p ;
...
typedef u64;
@@
 struct pstate_funcs {  int ( * get_max ) ( void ) ;  int ( * get_max_physical ) ( void ) ;  int ( * get_min ) ( void ) ;  int ( * get_turbo ) ( void ) ;  int ( * get_scaling ) ( void ) ;  int ( * get_aperf_mperf_shift ) ( void ) ;  u64 ( * get_val ) ( struct cpudata * , int pstate ) ;  void ( * get_vid ) ( struct cpudata * ) ; } cocci_id@p ;
...
position p;
@@
 struct cppc_perf_caps cocci_id@p ;
...
position p;
@@
 struct update_util_data * cocci_id@p ;
...
position p;
@@
 enum freq_qos_req_type cocci_id@p ;
