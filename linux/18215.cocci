...
typedef u8,u32;
@@
 void cocci_id@p ( void * state , const u8 * src , u32 len , u32 hibit ) ;
...
typedef u8;
@@
 void cocci_id@p ( void * state , const u8 * key ) ;
...
typedef __le32,u32;
@@
 void cocci_id@p ( void * state , __le32 * digest , const u32 * nonce ) ;
