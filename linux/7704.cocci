...
position p;
@@
 struct uart_port cocci_id@p [ SIU_PORTS_MAX ] ;
...
symbol cocci_id;
position p;
typedef irda_speed_t;
@@
 irda_speed_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef irda_module_t;
@@
 irda_module_t cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ SIU_PORTS_MAX ] ;
...
symbol cocci_id;
position p;
typedef siu_interface_t;
@@
 siu_interface_t cocci_id@p ;
