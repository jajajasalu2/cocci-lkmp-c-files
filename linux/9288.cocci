...
position p;
@@
 int ( * cocci_id@p ) ( struct lbs_private * , unsigned long , struct cmd_header * ) ;
...
position p;
@@
 struct cmd_ds_host_sleep cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_monitor_mode cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_rssi cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_pa_cfg cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11d_domain_info cocci_id@p ;
...
position p;
@@
 struct cmd_ds_reg_access cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_tpc_cfg cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_ps_mode cocci_id@p ;
...
position p;
@@
 struct mrvl_ie_domain_param_set * cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_rf_tx_power cocci_id@p ;
...
position p;
@@
 struct cmd_ds_get_hw_spec cocci_id@p ;
...
position p;
@@
 struct cmd_ds_mac_control cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_radio_control cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_rf_channel cocci_id@p ;
...
position p;
@@
 struct sleep_params * cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_sleep_params cocci_id@p ;
...
position p;
@@
 struct cmd_ds_802_11_snmp_mib cocci_id@p ;
