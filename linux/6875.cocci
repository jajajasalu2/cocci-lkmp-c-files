...
position p;
@@
 struct fnic_dflt_sgl_list cocci_id@p ;
...
position p;
@@
 struct fnic_sgl_list cocci_id@p ;
...
position p;
@@
 struct kmem_cache * cocci_id@p [ FNIC_SGL_NUM_CACHES ] ;
...
position p;
@@
 struct fc_host_statistics * cocci_id@p ( struct Scsi_Host * ) ;
