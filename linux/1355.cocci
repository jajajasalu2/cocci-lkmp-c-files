...
position p;
@@
 struct usb_port_status * cocci_id@p ;
...
typedef u8,bool;
@@
 struct lvs_rh {  struct usb_interface * intf ;  bool present ;  int portnum ;  u8 buffer [ 8 ] ;  struct usb_hub_descriptor descriptor ;  struct urb * urb ;  struct work_struct rh_work ;  struct usb_port_status port_status ; } cocci_id@p ;
