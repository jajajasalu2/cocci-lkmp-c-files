...
position p;
@@
 int cocci_id@p ( struct linux_binprm * , struct mm_struct * , struct elf_fdpic_params * , struct elf_fdpic_params * ) ;
...
symbol cocci_id;
position p;
typedef elf_fpxregset_t;
@@
 elf_fpxregset_t * cocci_id@p ;
...
position p;
@@
 struct elf_fdpic_params cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct elf_fdpic_params * , struct file * , struct mm_struct * , const char * ) ;
...
position p;
@@
 struct elf32_fdpic_loadseg * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct linux_binprm * ) ;
...
position p;
@@
 struct elf32_fdpic_loadmap * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct elf_fdpic_params * , struct file * , struct mm_struct * ) ;
...
position p;
@@
 int cocci_id@p ( struct elf_fdpic_params * , struct file * ) ;
