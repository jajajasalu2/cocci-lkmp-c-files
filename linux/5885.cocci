...
position p;
@@
 struct rzn1_pinctrl * cocci_id@p ;
...
position p;
@@
 struct rzn1_pin_group * cocci_id@p ;
...
position p;
@@
 enum { LOCK_LEVEL1 = 0x1 , LOCK_LEVEL2 = 0x2 , LOCK_ALL = LOCK_LEVEL1 | LOCK_LEVEL2 , } cocci_id@p ;
...
typedef u32;
@@
 struct rzn1_pinctrl_regs {  u32 conf [ 170 ] ;  u32 pad0 [ 86 ] ;  u32 status_protect ;  u32 l2_mdio [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct rzn1_pmx_func * cocci_id@p ;
...
typedef u8;
@@
 struct rzn1_pin_group {  const char * name ;  const char * func ;  unsigned int npins ;  unsigned int * pins ;  u8 * pin_ids ; } cocci_id@p ;
...
position p;
@@
 const struct rzn1_pin_group * cocci_id@p ;
...
position p;
@@
 struct rzn1_pmx_func {  const char * name ;  const char * * groups ;  unsigned int num_groups ; } cocci_id@p ;
...
typedef u32;
@@
 struct rzn1_pinctrl {  struct device * dev ;  struct clk * clk ;  struct pinctrl_dev * pctl ;  struct rzn1_pinctrl_regs __iomem * lev1 ;  struct rzn1_pinctrl_regs __iomem * lev2 ;  u32 lev1_protect_phys ;  u32 lev2_protect_phys ;  int mdio_func [ 2 ] ;  struct rzn1_pin_group * groups ;  unsigned int ngroups ;  struct rzn1_pmx_func * functions ;  unsigned int nfunctions ; } cocci_id@p ;
...
position p;
@@
 const struct rzn1_pinctrl * cocci_id@p ;
