...
position p;
@@
 struct bcm3510_config cocci_id@p ;
...
position p;
@@
 struct flexcop_device * cocci_id@p ;
...
position p;
@@
 struct itd1000_config cocci_id@p ;
...
position p;
@@
 struct s5h1420_config cocci_id@p ;
...
symbol cocci_id;
position p;
typedef flexcop_device_type_t;
@@
 struct {  flexcop_device_type_t type ;  int ( * attach ) ( struct flexcop_device * , struct i2c_adapter * ) ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct cx24113_config cocci_id@p ;
...
position p;
@@
 struct cx24123_config cocci_id@p ;
