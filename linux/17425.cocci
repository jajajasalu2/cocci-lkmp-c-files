...
position p;
@@
 struct mpc52xx_intr cocci_id@p ;
...
position p;
@@
 struct mpc52xx_gpio cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void __iomem * sram , void __iomem * mbar ) ;
...
position p;
@@
 struct mpc52xx_gpio_wkup cocci_id@p ;
