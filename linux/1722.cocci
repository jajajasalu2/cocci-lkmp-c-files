...
position p;
@@
 enum kmx61_axis { KMX61_AXIS_X , KMX61_AXIS_Y , KMX61_AXIS_Z , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct kmx61_data {  struct i2c_client * client ;  struct mutex lock ;  bool acc_stby ;  bool mag_stby ;  bool acc_ps ;  bool mag_ps ;  u8 range ;  u8 odr_bits ;  u8 wake_thresh ;  u8 wake_duration ;  struct iio_dev * acc_indio_dev ;  struct iio_trigger * acc_dready_trig ;  struct iio_trigger * motion_trig ;  bool acc_dready_trig_on ;  bool motion_trig_on ;  bool ev_enable_state ;  struct iio_dev * mag_indio_dev ;  struct iio_trigger * mag_dready_trig ;  bool mag_dready_trig_on ; } cocci_id@p ;
...
position p;
@@
 const struct {  int val ;  int val2 ; } cocci_id@p [ ] ;
...
position p;
@@
 enum kmx61_range { KMX61_RANGE_2G , KMX61_RANGE_4G , KMX61_RANGE_8G , } cocci_id@p ;
...
position p;
@@
 const struct {  int val ;  int val2 ;  int odr_bits ; } cocci_id@p [ ] ;
