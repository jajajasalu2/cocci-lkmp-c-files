...
typedef bool;
@@
 struct rbtn_data {  enum rbtn_type type ;  struct rfkill * rfkill ;  struct input_dev * input_dev ;  bool suspended ; } cocci_id@p ;
...
position p;
@@
 enum rbtn_type { RBTN_UNKNOWN , RBTN_TOGGLE , RBTN_SLIDER , } cocci_id@p ;
