...
position p;
@@
 struct udp_iter_state * cocci_id@p ;
...
position p;
@@
 struct inet_cork_full cocci_id@p ;
...
typedef u8,__be32;
@@
 int ( * cocci_id@p ) ( struct sk_buff * skb , struct inet6_skb_parm * opt , u8 type , u8 code , int offset , __be32 info ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * , char * , int , int , int , struct sk_buff * ) ;
...
position p;
@@
 struct ipcm6_cookie cocci_id@p ;
...
position p;
@@
 struct udp_seq_afinfo cocci_id@p ;
