...
symbol cocci_id;
position p;
typedef s8,bool,wait_queue_head_t;
@@
 struct sunkbd {  unsigned char keycode [ ARRAY_SIZE ( sunkbd_keycode ) ] ;  struct input_dev * dev ;  struct serio * serio ;  struct work_struct tq ;  wait_queue_head_t wait ;  char name [ 64 ] ;  char phys [ 32 ] ;  char type ;  bool enabled ;  volatile s8 reset ;  volatile s8 layout ; } cocci_id@p ;
