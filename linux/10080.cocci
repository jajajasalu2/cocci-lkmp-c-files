...
position p;
@@
 int cocci_id@p ( struct ipddp_route * rt ) ;
...
position p;
@@
 int cocci_id@p ( struct ipddp_route * new_rt ) ;
...
position p;
@@
 struct ipddp_route * cocci_id@p ( struct ipddp_route * rt ) ;
