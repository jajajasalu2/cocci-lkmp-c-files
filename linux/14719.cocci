...
position p;
@@
 struct clk_master_characteristics * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ USB_SOURCE_MAX ] ;
...
position p;
@@
 struct clk_pll_characteristics * cocci_id@p ;
...
position p;
@@
 const struct clk_pll_layout * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ MASTER_SOURCE_MAX ] ;
...
position p;
@@
 const char * cocci_id@p [ GENERATED_SOURCE_MAX ] ;
...
position p;
@@
 const char * cocci_id@p [ PROG_SOURCE_MAX ] ;
...
position p;
@@
 const char * cocci_id@p [ SMD_SOURCE_MAX ] ;
