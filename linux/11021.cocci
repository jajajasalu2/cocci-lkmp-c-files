...
position p;
@@
 struct smu_12_0_cmn2aisc_mapping cocci_id@p [ SMU_MSG_MAX_COUNT ] ;
...
position p;
@@
 struct smu_12_0_cmn2aisc_mapping cocci_id@p ;
...
typedef uint32_t;
@@
 struct clk_feature_map {  enum smu_clk_type clk_type ;  uint32_t feature ; } cocci_id@p [ ] ;
...
position p;
@@
 struct smu_12_0_cmn2aisc_mapping cocci_id@p [ SMU_TABLE_COUNT ] ;
