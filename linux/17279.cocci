...
typedef u64;
@@
 struct mem_region {  u64 base ;  u64 size ;  unsigned long offset ;  int destroy ; } cocci_id@p ;
...
position p;
@@
 enum ps3_dma_page_size cocci_id@p ;
...
position p;
@@
 struct ps3_dma_region * cocci_id@p ;
...
position p;
@@
 enum ps3_dma_region_type cocci_id@p ;
...
position p;
@@
 const struct ps3_dma_region * cocci_id@p ;
...
position p;
@@
 const struct dma_chunk * cocci_id@p ;
...
position p;
@@
 struct dma_chunk {  struct ps3_dma_region * region ;  unsigned long lpar_addr ;  unsigned long bus_addr ;  unsigned long len ;  struct list_head link ;  unsigned int usage_count ; } cocci_id@p ;
...
position p;
@@
 const struct ps3_dma_region_ops cocci_id@p ;
...
position p;
@@
 const struct mem_region * cocci_id@p ;
...
position p;
@@
 enum { PAGE_SHIFT_4K = 12U , PAGE_SHIFT_64K = 16U , PAGE_SHIFT_16M = 24U , } cocci_id@p ;
...
position p;
@@
 enum { HTAB_SIZE_MAX = 20U , HTAB_SIZE_MIN = 18U , } cocci_id@p ;
...
typedef u64;
@@
 struct map {  u64 total ;  u64 vas_id ;  u64 htab_size ;  struct mem_region rm ;  struct mem_region r1 ; } cocci_id@p ;
...
position p;
@@
 enum { ALLOCATE_MEMORY_TRY_ALT_UNIT = 0X04 , ALLOCATE_MEMORY_ADDR_ZERO = 0X08 , } cocci_id@p ;
