...
typedef u8;
@@
 struct pll_div {  int fref ;  int fout ;  u8 div1 ;  u8 div2 ;  u8 div3 ;  u8 mode ; } cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( lineout_vol_tlv , 
							    0x0 , 0x10 , 
							    TLV_DB_SCALE_ITEM ( TLV_DB_GAIN_MUTE , 0 , 1 ) , 
...
position p;
@@
 struct da7210_priv {  struct regmap * regmap ;  unsigned int mclk_rate ;  int master ; } cocci_id@p ;
...
position p;
@@
 enum clk_src { DA7210_CLKSRC_MCLK , } cocci_id@p ;
...
position p;
@@
 const struct pll_div cocci_id@p [ ] ;
