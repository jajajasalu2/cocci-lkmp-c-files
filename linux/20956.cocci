...
position p;
@@
 char cocci_id@p [ CMSG_SPACE ( sizeof ( new ) ) ] ;
...
position p;
@@
 union {  char control [ CMSG_SPACE ( sizeof ( * fds ) * OS_SENDMSG_MAX_FDS ) ] ;  struct cmsghdr align ; } cocci_id@p ;
...
position p;
@@
 const struct stat64 * cocci_id@p ;
