...
position p;
@@
 struct ps3rom_private cocci_id@p ;
...
position p;
@@
 enum lv1_atapi_proto { NON_DATA_PROTO = 0 , PIO_DATA_IN_PROTO = 1 , PIO_DATA_OUT_PROTO = 2 , DMA_PROTO = 3 , } cocci_id@p ;
...
position p;
@@
 struct lv1_atapi_cmnd_block cocci_id@p ;
...
position p;
@@
 enum lv1_atapi_in_out { DIR_WRITE = 0 , DIR_READ = 1 , } cocci_id@p ;
...
position p;
@@
 struct ps3rom_private {  struct ps3_storage_device * dev ;  struct scsi_cmnd * curr_cmd ; } cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct lv1_atapi_cmnd_block {  u8 pkt [ 32 ] ;  u32 pktlen ;  u32 blocks ;  u32 block_size ;  u32 proto ;  u32 in_out ;  u64 buffer ;  u32 arglen ; } cocci_id@p ;
