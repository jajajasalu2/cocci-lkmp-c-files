...
typedef u8;
@@
 struct phy_lane_info {  void __iomem * phy_base ;  u8 lane_mapping ;  u8 phy_devs ;  u8 tx_atten ; } cocci_id@p ;
...
position p;
@@
 struct phy_lane_info cocci_id@p [ CPHY_PORT_COUNT ] ;
...
position p;
@@
 struct device_node * cocci_id@p [ CPHY_PHY_COUNT ] ;
...
position p;
@@
 struct ecx_plat_data * cocci_id@p ;
...
position p;
@@
 struct phy_lane_info cocci_id@p ;
...
typedef u32;
@@
 struct ecx_plat_data {  u32 n_ports ;  u32 pre_clocks ;  u32 post_clocks ;  struct gpio_desc * sgpio_gpiod [ SGPIO_PINS ] ;  u32 sgpio_pattern ;  u32 port_to_sgpio [ SGPIO_PORTS ] ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ CPHY_PORT_COUNT ] ;
