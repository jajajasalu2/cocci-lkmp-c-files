...
position p;
@@
 const struct wil_fw_record_gateway_data * cocci_id@p ;
...
position p;
@@
 const struct wil_fw_record_file_header * cocci_id@p ;
...
position p;
@@
 const struct wil_fw_record_head * cocci_id@p ;
...
position p;
@@
 const struct wil_fw_record_data * cocci_id@p ;
...
position p;
@@
 struct wil_fw_record_concurrency cocci_id@p ;
...
position p;
@@
 const struct wil_fw_record_comment_hdr * cocci_id@p ;
...
position p;
@@
 struct wil_brd_info cocci_id@p ;
...
position p;
@@
 const struct wil_fw_record_brd_file * cocci_id@p ;
...
position p;
@@
 const struct wil_fw_record_direct_write * cocci_id@p ;
...
position p;
@@
 const struct wil_fw_record_capabilities * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( block -> value ) ] ;
...
position p;
@@
 const struct wil_fw_record_fill * cocci_id@p ;
...
position p;
@@
 struct wil_fw_record_brd_file cocci_id@p ;
...
position p;
@@
 struct wil_fw_record_capabilities cocci_id@p ;
...
position p;
@@
 struct wil_fw_record_file_header cocci_id@p ;
...
position p;
@@
 const struct wil_fw_data_gw * cocci_id@p ;
...
position p;
@@
 struct wil_fw_record_data cocci_id@p ;
...
position p;
@@
 const struct wil_fw_data_gw4 * cocci_id@p ;
...
position p;
@@
 const struct wil_fw_record_gateway_data4 * cocci_id@p ;
...
position p;
@@
 const struct wil_fw_data_dwrite * cocci_id@p ;
