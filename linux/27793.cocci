...
position p;
@@
 struct ocfs2_dio_write_ctxt cocci_id@p ;
...
position p;
@@
 struct ocfs2_write_cluster_desc * cocci_id@p ;
...
typedef u32;
@@
 struct ocfs2_write_cluster_desc {  u32 c_cpos ;  u32 c_phys ;  unsigned c_new ;  unsigned c_clear_unwritten ;  unsigned c_needs_zero ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,ocfs2_write_type_t,handle_t;
@@
 struct ocfs2_write_ctxt {  u32 w_cpos ;  u32 w_clen ;  u32 w_first_new_cpos ;  ocfs2_write_type_t w_type ;  struct ocfs2_write_cluster_desc w_desc [ OCFS2_MAX_CLUSTERS_PER_PAGE ] ;  unsigned int w_large_pages ;  unsigned int w_num_pages ;  struct page * w_pages [ OCFS2_MAX_CTXT_PAGES ] ;  struct page * w_target_page ;  unsigned int w_target_locked : 1 ;  unsigned int w_target_from ;  unsigned int w_target_to ;  handle_t * w_handle ;  struct buffer_head * w_di_bh ;  struct ocfs2_cached_dealloc_ctxt w_dealloc ;  struct list_head w_unwritten_list ;  unsigned int w_unwritten_count ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ocfs2_write_type_t;
@@
 ocfs2_write_type_t cocci_id@p ;
...
typedef handle_t;
@@
 int ( * cocci_id@p ) ( handle_t * handle , struct buffer_head * bh ) ;
...
typedef u32;
@@
 struct ocfs2_unwritten_extent {  struct list_head ue_node ;  struct list_head ue_ip_node ;  u32 ue_cpos ;  u32 ue_phys ; } cocci_id@p ;
...
typedef pid_t;
@@
 struct ocfs2_dio_write_ctxt {  struct list_head dw_zero_list ;  unsigned dw_zero_count ;  int dw_orphaned ;  pid_t dw_writer_pid ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_write_ctxt cocci_id@p ;
...
position p;
@@
 struct ocfs2_unwritten_extent cocci_id@p ;
