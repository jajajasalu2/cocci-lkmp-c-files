...
position p;
@@
 struct extended_perms_decision * cocci_id@p ;
...
position p;
@@
 struct security_class_mapping * cocci_id@p ;
...
position p;
@@
 struct cond_bool_datum * cocci_id@p ;
...
position p;
@@
 struct sidtab_convert_params cocci_id@p ;
...
position p;
@@
 struct selinux_audit_rule cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ __POLICYDB_CAPABILITY_MAX ] ;
...
typedef u16;
@@
 void cocci_id@p ( struct policydb * policydb , struct context * scontext , struct context * tcontext , u16 tclass , struct av_decision * avd , struct extended_perms * xperms ) ;
...
position p;
@@
 struct netlbl_lsm_secattr * cocci_id@p ;
...
position p;
@@
 struct ebitmap_node * cocci_id@p ;
...
position p;
@@
 struct constraint_expr * cocci_id@p ;
...
position p;
@@
 struct filename_trans cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct selinux_state * state , struct policydb * newpolicydb ) ;
...
typedef u32;
@@
 struct selinux_audit_rule {  u32 au_seqno ;  struct context au_ctxt ; } cocci_id@p ;
...
position p;
@@
 struct filename_trans_datum * cocci_id@p ;
...
position p;
@@
 struct convert_context_args {  struct selinux_state * state ;  struct policydb * oldp ;  struct policydb * newp ; } cocci_id@p ;
...
position p;
@@
 struct constraint_node * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct policydb * policydb , struct context * context , char * * scontext , u32 * scontext_len ) ;
...
position p;
@@
 struct selinux_mapping * cocci_id@p ;
...
position p;
@@
 struct convert_context_args * cocci_id@p ;
...
position p;
@@
 struct extended_perms * cocci_id@p ;
...
position p;
@@
 struct common_datum * cocci_id@p ;
