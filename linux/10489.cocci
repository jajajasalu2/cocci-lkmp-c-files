...
typedef u32;
@@
 struct array_mode_checker {  int array_mode ;  u32 group_size ;  u32 nbanks ;  u32 npipes ;  u32 nsamples ;  u32 blocksize ; } cocci_id@p ;
...
position p;
@@
 struct array_mode_checker cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct drm_device * dev , u32 * npipes , u32 * nbanks , u32 * group_size ) ;
...
position p;
@@
 struct r600_cs_track * cocci_id@p ;
...
position p;
@@
 const struct gpu_formats cocci_id@p [ ] ;
...
position p;
@@
 struct gpu_formats {  unsigned blockwidth ;  unsigned blockheight ;  unsigned blocksize ;  unsigned valid_color ;  enum radeon_family min_family ; } cocci_id@p ;
