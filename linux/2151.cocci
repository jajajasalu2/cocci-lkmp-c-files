...
position p;
@@
 struct ingenic_battery * cocci_id@p ;
...
position p;
@@
 struct ingenic_battery {  struct device * dev ;  struct iio_channel * channel ;  struct power_supply_desc desc ;  struct power_supply * battery ;  struct power_supply_battery_info info ; } cocci_id@p ;
