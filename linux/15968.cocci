...
position p;
@@
 struct cmpk_query_cfg cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cmpk_tx_rahis_t;
@@
 cmpk_tx_rahis_t cocci_id@p ;
...
position p;
@@
 struct cmd_pkt_tx_feedback cocci_id@p ;
...
position p;
@@
 struct cmd_pkt_interrupt_status cocci_id@p ;
