...
position p;
@@
 struct ip6t_get_entries cocci_id@p ;
...
position p;
@@
 struct xt_counters_info cocci_id@p ;
...
position p;
@@
 const struct xt_standard_target * cocci_id@p ;
...
position p;
@@
 struct compat_ip6t_replace cocci_id@p ;
...
position p;
@@
 struct xt_mtchk_param * cocci_id@p ;
...
position p;
@@
 const struct xt_mtchk_param * cocci_id@p ;
...
position p;
@@
 struct xt_tgdtor_param cocci_id@p ;
...
position p;
@@
 const struct compat_ip6t_replace * cocci_id@p ;
...
@@
 struct compat_ip6t_replace {  char name [ XT_TABLE_MAXNAMELEN ] ;  u32 valid_hooks ;  u32 num_entries ;  u32 size ;  u32 hook_entry [ NF_INET_NUMHOOKS ] ;  u32 underflow [ NF_INET_NUMHOOKS ] ;  u32 num_counters ;  compat_uptr_t counters ;  struct compat_ip6t_entry entries [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct ip6t_icmp * cocci_id@p ;
...
position p;
@@
 struct xt_table_info cocci_id@p ;
...
position p;
@@
 struct xt_get_revision cocci_id@p ;
...
position p;
@@
 struct xt_entry_match * cocci_id@p ;
...
position p;
@@
 struct xt_action_param cocci_id@p ;
...
position p;
@@
 const struct xt_table_info * cocci_id@p ;
...
position p;
@@
 struct ip6t_getinfo cocci_id@p ;
...
position p;
@@
 const struct nf_loginfo cocci_id@p ;
...
position p;
@@
 const struct xt_entry_match * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ XT_TABLE_MAXNAMELEN ] ;
...
position p;
@@
 struct xt_tgchk_param cocci_id@p ;
...
position p;
@@
 const struct xt_counters * cocci_id@p ;
...
position p;
@@
 struct ip6t_replace cocci_id@p ;
...
typedef compat_uint_t;
@@
 struct compat_ip6t_get_entries {  char name [ XT_TABLE_MAXNAMELEN ] ;  compat_uint_t size ;  struct compat_ip6t_entry entrytable [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct ip6t_replace * cocci_id@p ;
...
position p;
@@
 const struct xt_action_param * cocci_id@p ;
...
position p;
@@
 struct xt_entry_target * cocci_id@p ;
...
position p;
@@
 const struct ip6t_entry * cocci_id@p ;
...
position p;
@@
 struct compat_ip6t_get_entries cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sock * , int , void __user * , int * ) ;
...
position p;
@@
 struct compat_ip6t_entry cocci_id@p ;
...
position p;
@@
 struct compat_xt_entry_target cocci_id@p ;
...
position p;
@@
 const struct xt_entry_target * cocci_id@p ;
...
position p;
@@
 struct xt_standard_target * cocci_id@p ;
...
position p;
@@
 struct xt_percpu_counter_alloc_state * cocci_id@p ;
...
position p;
@@
 const struct xt_table * cocci_id@p ;
...
position p;
@@
 const struct ip6t_ip6 * cocci_id@p ;
...
position p;
@@
 struct xt_mtdtor_param cocci_id@p ;
...
position p;
@@
 enum nf_ip_trace_comments { NF_IP6_TRACE_COMMENT_RULE , NF_IP6_TRACE_COMMENT_RETURN , NF_IP6_TRACE_COMMENT_POLICY , } cocci_id@p ;
