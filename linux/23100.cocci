...
position p;
@@
 const struct samsung_i2s_dai_data cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ ARRAY_SIZE ( i2s_clk_desc ) ] ;
...
position p;
@@
 struct samsung_i2s_dai_data * cocci_id@p ;
...
position p;
@@
 struct s3c_audio_pdata * cocci_id@p ;
...
@@
 struct samsung_i2s_priv {  struct platform_device * pdev ;  struct platform_device * pdev_sec ;  spinlock_t pcm_lock ;  struct i2s_dai * dai ;  struct snd_soc_dai_driver * dai_drv ;  int num_dais ;  struct clk * clk ;  struct clk * op_clk ;  unsigned long rclk_srcrate ;  u32 suspend_i2smod ;  u32 suspend_i2scon ;  u32 suspend_i2spsr ;  const struct samsung_i2s_variant_regs * variant_regs ;  u32 quirks ;  struct clk * clk_table [ 3 ] ;  struct clk_onecell_data clk_data ;  spinlock_t lock ;  void __iomem * addr ;  bool slave_mode ; } cocci_id@p ;
...
position p;
@@
 struct samsung_i2s_priv * cocci_id@p ;
...
position p;
@@
 const struct samsung_i2s_variant_regs * cocci_id@p ;
...
typedef u32;
@@
 struct samsung_i2s_dai_data {  u32 quirks ;  unsigned int pcm_rates ;  const struct samsung_i2s_variant_regs * i2s_variant_regs ; } cocci_id@p ;
...
position p;
@@
 struct samsung_i2s_variant_regs {  unsigned int bfs_off ;  unsigned int rfs_off ;  unsigned int sdf_off ;  unsigned int txr_off ;  unsigned int rclksrc_off ;  unsigned int mss_off ;  unsigned int cdclkcon_off ;  unsigned int lrp_off ;  unsigned int bfs_mask ;  unsigned int rfs_mask ;  unsigned int ftx0cnt_off ; } cocci_id@p ;
