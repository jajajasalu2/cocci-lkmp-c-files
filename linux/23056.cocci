...
typedef bool,s16;
@@
 struct omap_mcbsp_st_data {  void __iomem * io_base_st ;  struct clk * mcbsp_iclk ;  bool running ;  bool enabled ;  s16 taps [ 128 ] ;  int nr_taps ;  s16 ch0gain ;  s16 ch1gain ; } cocci_id@p ;
...
position p;
@@
 struct omap_mcbsp_st_data * cocci_id@p ;
