...
position p;
@@
 struct xdp_umem_reg_v1 cocci_id@p ;
...
typedef __u32,__u64;
@@
 struct xdp_umem_reg_v1 {  __u64 addr ;  __u64 len ;  __u32 chunk_size ;  __u32 headroom ; } cocci_id@p ;
...
position p;
@@
 struct xsk_map_node cocci_id@p ;
...
position p;
@@
 struct xdp_umem_ring cocci_id@p ;
...
position p;
@@
 struct xdp_ring_offset_v1 * cocci_id@p ;
...
position p;
@@
 struct xdp_umem_page * cocci_id@p ;
...
position p;
@@
 struct xdp_statistics cocci_id@p ;
...
position p;
@@
 struct xdp_rxtx_ring cocci_id@p ;
