...
position p;
@@
 int cocci_id@p [ WM5100_NUM_BCLK_RATES ] ;
...
position p;
@@
 int cocci_id@p [ WM5100_SYNC_SRS ] ;
...
position p;
@@
 const char * cocci_id@p [ WM5100_NUM_CORE_SUPPLIES ] ;
...
position p;
@@
 struct wm5100_fll {  int fref ;  int fout ;  int src ;  struct completion lock ; } cocci_id@p ;
...
position p;
@@
 struct wm5100_jack_mode * cocci_id@p ;
...
position p;
@@
 struct wm5100_pdata * cocci_id@p ;
