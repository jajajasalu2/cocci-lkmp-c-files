...
position p;
@@
 const struct nfnl_ct_hook * cocci_id@p ;
...
position p;
@@
 struct nfulnl_instance * cocci_id@p ;
...
position p;
@@
 struct nfulnl_msg_config_mode cocci_id@p ;
...
position p;
@@
 const struct nfnl_callback cocci_id@p [ NFULNL_MSG_MAX ] ;
...
position p;
@@
 struct nfulnl_msg_config_cmd * cocci_id@p ;
...
position p;
@@
 struct nfulnl_msg_packet_timestamp cocci_id@p ;
...
position p;
@@
 const struct nfulnl_instance * cocci_id@p ;
...
position p;
@@
 struct nfulnl_msg_packet_hw cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sk_buff_data_t;
@@
 sk_buff_data_t cocci_id@p ;
...
position p;
@@
 struct nfnl_log_net cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nfulnl_instance * inst ) ;
...
position p;
@@
 struct nfulnl_msg_packet_hdr cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFULA_CFG_MAX + 1 ] ;
...
@@
 struct nfnl_log_net {  spinlock_t instances_lock ;  struct hlist_head instance_table [ INSTANCE_BUCKETS ] ;  atomic_t global_seq ; } cocci_id@p ;
