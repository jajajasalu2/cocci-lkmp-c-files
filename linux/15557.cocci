...
symbol cocci_id;
position p;
typedef s8,u8,__be32;
@@
 struct ad7746_chip_info {  struct i2c_client * client ;  struct mutex lock ;  u8 config ;  u8 cap_setup ;  u8 vt_setup ;  u8 capdac [ 2 ] [ 2 ] ;  s8 capdac_set ;  union {  __be32 d32 ;  u8 d8 [ 4 ] ; } data ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum ad7746_chan { VIN , VIN_VDD , TEMP_INT , TEMP_EXT , CIN1 , CIN1_DIFF , CIN2 , CIN2_DIFF , } cocci_id@p ;
...
position p;
@@
 struct ad7746_chip_info * cocci_id@p ;
...
position p;
@@
 struct ad7746_platform_data * cocci_id@p ;
