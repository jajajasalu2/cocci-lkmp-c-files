...
position p;
@@
 const struct snd_kcontrol_new cocci_id@p [ 1 ] ;
...
position p;
@@
 struct snd_ac97_res_table cocci_id@p [ ] ;
...
position p;
@@
 struct snd_kcontrol * cocci_id@p ( struct snd_ac97 * ac97 , const char * name ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_ac97 * ac97 , char * name , const unsigned int * tlv , const char * const * slaves ) ;
...
position p;
@@
 struct vt1618_uaj_item {  unsigned short mask ;  unsigned short shift ;  const char * const items [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct snd_kcontrol_new cocci_id@p [ 3 ] ;
...
position p;
@@
 struct vt1618_uaj_item cocci_id@p [ 3 ] ;
