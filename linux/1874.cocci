...
position p;
@@
 struct imx7d_adc_feature * cocci_id@p ;
...
typedef u32;
@@
 struct imx7d_adc_feature {  enum imx7d_adc_clk_pre_div clk_pre_div ;  enum imx7d_adc_average_num avg_num ;  u32 core_time_unit ; } cocci_id@p ;
...
position p;
@@
 enum imx7d_adc_average_num { IMX7D_ADC_AVERAGE_NUM_4 , IMX7D_ADC_AVERAGE_NUM_8 , IMX7D_ADC_AVERAGE_NUM_16 , IMX7D_ADC_AVERAGE_NUM_32 , } cocci_id@p ;
...
position p;
@@
 struct imx7d_adc_analogue_core_clk cocci_id@p ;
...
typedef u32;
@@
 struct imx7d_adc_analogue_core_clk {  u32 pre_div ;  u32 reg_config ; } cocci_id@p ;
...
typedef u32;
@@
 struct imx7d_adc {  struct device * dev ;  void __iomem * regs ;  struct clk * clk ;  u32 vref_uv ;  u32 value ;  u32 channel ;  u32 pre_div_num ;  struct regulator * vref ;  struct imx7d_adc_feature adc_feature ;  struct completion completion ; } cocci_id@p ;
...
position p;
@@
 const struct imx7d_adc_analogue_core_clk cocci_id@p [ ] ;
...
position p;
@@
 enum imx7d_adc_clk_pre_div { IMX7D_ADC_ANALOG_CLK_PRE_DIV_4 , IMX7D_ADC_ANALOG_CLK_PRE_DIV_8 , IMX7D_ADC_ANALOG_CLK_PRE_DIV_16 , IMX7D_ADC_ANALOG_CLK_PRE_DIV_32 , IMX7D_ADC_ANALOG_CLK_PRE_DIV_64 , IMX7D_ADC_ANALOG_CLK_PRE_DIV_128 , } cocci_id@p ;
