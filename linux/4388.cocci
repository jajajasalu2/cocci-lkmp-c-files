...
position p;
@@
 enum tpm2_handle_types { TPM2_HT_HMAC_SESSION = 0x02000000 , TPM2_HT_POLICY_SESSION = 0x03000000 , TPM2_HT_TRANSIENT = 0x80000000 , } cocci_id@p ;
...
position p;
@@
 struct tpm2_cap_handles * cocci_id@p ;
...
position p;
@@
 struct tpm2_context * cocci_id@p ;
