...
position p;
@@
 enum uwb_drp_reason cocci_id@p ;
...
position p;
@@
 struct uwb_cnflt_alien cocci_id@p ;
...
position p;
@@
 struct uwb_ie_drp_avail * cocci_id@p ;
...
position p;
@@
 struct uwb_dev_addr cocci_id@p ;
...
position p;
@@
 struct uwb_drp_backoff_win * cocci_id@p ;
...
position p;
@@
 enum uwb_drp_conflict_action { UWB_DRP_CONFLICT_MANTAIN = 0 , UWB_DRP_CONFLICT_ACT1 , UWB_DRP_CONFLICT_ACT2 , UWB_DRP_CONFLICT_ACT3 , } cocci_id@p ;
...
position p;
@@
 struct uwb_rsv_move * cocci_id@p ;
