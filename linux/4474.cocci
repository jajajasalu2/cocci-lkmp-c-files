...
position p;
@@
 struct optee_rng_private * cocci_id@p ;
...
typedef u32;
@@
 struct optee_rng_private {  struct device * dev ;  struct tee_context * ctx ;  u32 session_id ;  u32 data_rate ;  struct tee_shm * entropy_shm_pool ;  struct hwrng optee_rng ; } cocci_id@p ;
