...
position p;
@@
 enum fuse_parse_result { FOUND_ERR = - 1 , FOUND_NONE = 0 , FOUND_SOME , FOUND_ALL , } cocci_id@p ;
...
position p;
@@
 enum fuse_parse_result cocci_id@p ;
...
position p;
@@
 struct fuse_direntplus * cocci_id@p ;
