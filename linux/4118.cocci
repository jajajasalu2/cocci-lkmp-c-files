...
position p;
@@
 struct da8xx_usb_phy * cocci_id@p ;
...
position p;
@@
 struct da8xx_usb_phy {  struct phy_provider * phy_provider ;  struct phy * usb11_phy ;  struct phy * usb20_phy ;  struct clk * usb11_clk ;  struct clk * usb20_clk ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct da8xx_usb_phy_platform_data * cocci_id@p ;
