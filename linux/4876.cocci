...
position p;
@@
 void cocci_id@p ( struct c4iw_ep * ep , int status ) ;
...
position p;
@@
 struct mpa_v2_conn_params cocci_id@p ;
...
position p;
@@
 struct fw_ofld_connection_wr cocci_id@p ;
...
position p;
@@
 struct cpl_act_open_req * cocci_id@p ;
...
position p;
@@
 enum { NUM_FAKE_CPLS = 2 , FAKE_CPL_PUT_EP_SAFE = NUM_CPL_CMDS + 0 , FAKE_CPL_PASS_PUT_EP_SAFE = NUM_CPL_CMDS + 1 , } cocci_id@p ;
...
position p;
@@
 struct cpl_close_listsvr_rpl * cocci_id@p ;
...
position p;
@@
 struct cpl_t5_act_open_req6 * cocci_id@p ;
...
position p;
@@
 struct cpl_t6_act_open_req6 * cocci_id@p ;
...
position p;
@@
 struct tcp_options_received cocci_id@p ;
...
position p;
@@
 struct cpl_get_tcb_rpl * cocci_id@p ;
...
position p;
@@
 struct cpl_rx_data_ack cocci_id@p ;
...
position p;
@@
 struct cpl_abort_req_rss6 * cocci_id@p ;
...
position p;
@@
 struct cpl_abort_req_rss * cocci_id@p ;
...
position p;
@@
 struct c4iw_listen_ep * cocci_id@p ;
...
position p;
@@
 struct cpl_rdma_terminate * cocci_id@p ;
...
position p;
@@
 struct cpl_t5_pass_accept_rpl * cocci_id@p ;
...
position p;
@@
 struct cpl_pass_accept_rpl * cocci_id@p ;
...
position p;
@@
 struct cpl_abort_rpl_rss6 * cocci_id@p ;
...
position p;
@@
 struct cpl_act_open_req6 cocci_id@p ;
...
position p;
@@
 struct cpl_act_open_rpl * cocci_id@p ;
...
position p;
@@
 struct cpl_pass_establish * cocci_id@p ;
...
position p;
@@
 struct cpl_t5_act_open_req cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct c4iw_dev * dev , struct sk_buff * skb ) ;
...
position p;
@@
 struct cpl_pass_accept_req * cocci_id@p ;
...
position p;
@@
 struct cpl_peer_close * cocci_id@p ;
...
position p;
@@
 struct cpl_set_tcb_rpl * cocci_id@p ;
...
position p;
@@
 struct fw_ofld_tx_data_wr * cocci_id@p ;
...
position p;
@@
 struct cpl_abort_rpl cocci_id@p ;
...
position p;
@@
 struct cpl_pass_open_rpl * cocci_id@p ;
...
position p;
@@
 struct cpl_close_con_req cocci_id@p ;
...
position p;
@@
 struct cpl_abort_req * cocci_id@p ;
...
position p;
@@
 enum c4iw_qp_attr_mask cocci_id@p ;
...
position p;
@@
 struct cpl_t6_act_open_req * cocci_id@p ;
...
position p;
@@
 struct cpl_close_con_rpl * cocci_id@p ;
...
position p;
@@
 struct c4iw_qp_attributes cocci_id@p ;
...
position p;
@@
 struct cpl_act_establish * cocci_id@p ;
...
position p;
@@
 struct c4iw_wr_wait * cocci_id@p ;
...
position p;
@@
 struct cpl_fw6_msg_ofld_connection_wr_rpl * cocci_id@p ;
...
position p;
@@
 c4iw_handler_func cocci_id@p [ NUM_CPL_CMDS + NUM_FAKE_CPLS ] ;
...
position p;
@@
 struct c4iw_ep_common * cocci_id@p ;
...
position p;
@@
 c4iw_handler_func cocci_id@p [ NUM_CPL_CMDS ] ;
