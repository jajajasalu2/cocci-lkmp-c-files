...
position p;
@@
 struct cs35l35_private cocci_id@p ;
...
typedef u8;
@@
 struct cs35l35_sysclk_config {  int sysclk ;  int srate ;  u8 clk_cfg ; } cocci_id@p ;
...
position p;
@@
 struct cs35l35_platform_data cocci_id@p ;
...
position p;
@@
 struct cs35l35_sysclk_config cocci_id@p [ ] ;
