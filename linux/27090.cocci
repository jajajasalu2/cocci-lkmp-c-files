...
position p;
@@
 int ( * cocci_id@p ) ( struct xfs_trans * , struct xfs_getfsmap_info * , struct xfs_btree_cur * * , void * ) ;
...
position p;
@@
 struct xfs_getfsmap_dev cocci_id@p ;
...
position p;
@@
 struct xfs_getfsmap_info * cocci_id@p ;
...
position p;
@@
 struct xfs_rtalloc_rec * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,xfs_agnumber_t,xfs_fsmap_format_t,xfs_daddr_t;
@@
 struct xfs_getfsmap_info {  struct xfs_fsmap_head * head ;  xfs_fsmap_format_t formatter ;  void * format_arg ;  struct xfs_buf * agf_bp ;  xfs_daddr_t next_daddr ;  u64 missing_owner ;  u32 dev ;  xfs_agnumber_t agno ;  struct xfs_rmap_irec low ;  struct xfs_rmap_irec high ;  bool last ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_fsmap_format_t;
@@
 xfs_fsmap_format_t cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct xfs_trans * , struct xfs_getfsmap_info * ) ;
...
position p;
@@
 struct xfs_rmap_irec * cocci_id@p ;
...
position p;
@@
 const struct xfs_getfsmap_dev * cocci_id@p ;
...
position p;
@@
 struct xfs_getfsmap_dev cocci_id@p [ XFS_GETFSMAP_DEVS ] ;
...
typedef u32;
@@
 struct xfs_getfsmap_dev {  u32 dev ;  int ( * fn ) ( struct xfs_trans * tp , struct xfs_fsmap * keys , struct xfs_getfsmap_info * info ) ; } cocci_id@p ;
...
position p;
@@
 struct xfs_alloc_rec_incore cocci_id@p [ 2 ] ;
