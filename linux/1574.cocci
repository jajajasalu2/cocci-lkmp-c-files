...
position p;
@@
 const struct omninet_header * cocci_id@p ;
...
position p;
@@
 struct omninet_header * cocci_id@p ;
...
typedef __u8;
@@
 struct omninet_header {  __u8 oh_seq ;  __u8 oh_len ;  __u8 oh_xxx ;  __u8 oh_pad ; } cocci_id@p ;
...
typedef __u8;
@@
 struct omninet_data {  __u8 od_outseq ; } cocci_id@p ;
...
position p;
@@
 struct omninet_data * cocci_id@p ;
