...
position p;
@@
 struct nfp_insn_meta * cocci_id@p [ MAX_CALL_FRAMES ] ;
...
position p;
@@
 enum nfp_bpf_map_use cocci_id@p ;
...
position p;
@@
 struct nfp_bpf_reg_state * cocci_id@p ;
...
position p;
@@
 unsigned short cocci_id@p [ MAX_CALL_FRAMES ] ;
