...
position p;
@@
 struct yenta_socket cocci_id@p ;
...
position p;
@@
 struct cardbus_type cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct yenta_socket * socket ) ;
...
typedef u32;
@@
 unsigned int cocci_id@p ( struct yenta_socket * socket , u32 isa_irq_mask ) ;
...
position p;
@@
 struct pccard_io_map * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef socket_state_t;
@@
 socket_state_t * cocci_id@p ;
...
position p;
@@
 enum { CARDBUS_TYPE_DEFAULT = - 1 , CARDBUS_TYPE_TI , CARDBUS_TYPE_TI113X , CARDBUS_TYPE_TI12XX , CARDBUS_TYPE_TI1250 , CARDBUS_TYPE_RICOH , CARDBUS_TYPE_TOPIC95 , CARDBUS_TYPE_TOPIC97 , CARDBUS_TYPE_O2MICRO , CARDBUS_TYPE_ENE , } cocci_id@p ;
...
position p;
@@
 struct pccard_operations cocci_id@p ;
...
position p;
@@
 struct pccard_mem_map * cocci_id@p ;
