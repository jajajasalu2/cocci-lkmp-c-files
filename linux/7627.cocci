...
position p;
@@
 enum hdmi_ycc_quantization_range cocci_id@p ;
...
position p;
@@
 enum hdmi_content_type cocci_id@p ;
...
position p;
@@
 const struct hdmi_avi_infoframe * cocci_id@p ;
...
position p;
@@
 const struct hdmi_vendor_infoframe * cocci_id@p ;
...
position p;
@@
 const struct hdmi_spd_infoframe * cocci_id@p ;
...
position p;
@@
 const struct hdmi_drm_infoframe * cocci_id@p ;
...
position p;
@@
 const struct hdmi_any_infoframe * cocci_id@p ;
...
position p;
@@
 const union hdmi_vendor_any_infoframe * cocci_id@p ;
...
position p;
@@
 enum hdmi_audio_coding_type cocci_id@p ;
...
position p;
@@
 enum hdmi_colorspace cocci_id@p ;
...
position p;
@@
 enum hdmi_active_aspect cocci_id@p ;
...
position p;
@@
 union hdmi_vendor_any_infoframe * cocci_id@p ;
...
position p;
@@
 enum hdmi_extended_colorimetry cocci_id@p ;
...
position p;
@@
 struct hdmi_any_infoframe * cocci_id@p ;
...
position p;
@@
 enum hdmi_colorimetry cocci_id@p ;
...
position p;
@@
 enum hdmi_scan_mode cocci_id@p ;
...
position p;
@@
 enum hdmi_audio_sample_frequency cocci_id@p ;
...
position p;
@@
 enum hdmi_audio_coding_type_ext cocci_id@p ;
