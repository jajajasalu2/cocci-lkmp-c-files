...
position p;
@@
 struct con3270 {  struct raw3270_view view ;  struct list_head freemem ;  struct list_head lines ;  struct list_head update ;  int line_nr ;  int nr_lines ;  int nr_up ;  unsigned long update_flags ;  struct string * cline ;  struct string * status ;  struct raw3270_request * write ;  struct timer_list timer ;  struct string * input ;  struct raw3270_request * read ;  struct raw3270_request * kreset ;  struct tasklet_struct readlet ; } cocci_id@p ;
