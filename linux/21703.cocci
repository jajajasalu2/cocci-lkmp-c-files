...
symbol cocci_id;
position p;
typedef u64,u32,u16,s16,s32,s64;
@@
 union split_register {  u64 u64 ;  u32 u32 [ 2 ] ;  u16 u16 [ 4 ] ;  s64 s64 ;  s32 s32 [ 2 ] ;  s16 s16 [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 union split_register * cocci_id@p ;
