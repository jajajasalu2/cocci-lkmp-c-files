...
typedef __be32;
@@
 struct nfp_dumpspec_csr {  struct nfp_dump_tl tl ;  struct nfp_dump_common_cpp cpp ;  __be32 register_width ; } cocci_id@p ;
...
position p;
@@
 struct nfp_dump_rtsym * cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_dump_csr {  struct nfp_dump_tl tl ;  struct nfp_dump_common_cpp cpp ;  __be32 register_width ;  __be32 error ;  __be32 error_offset ; } cocci_id@p ;
...
position p;
@@
 struct nfp_dump_state cocci_id@p ;
...
position p;
@@
 struct nfp_dumpspec_cpp_isl_id cocci_id@p ;
...
position p;
@@
 struct nfp_dump_prolog cocci_id@p ;
...
typedef u8;
@@
 struct nfp_dumpspec_cpp_isl_id {  u8 target ;  u8 action ;  u8 token ;  u8 island ; } cocci_id@p ;
...
typedef u32,__be32;
@@
 struct nfp_level_size {  __be32 requested_level ;  u32 total_size ; } cocci_id@p ;
...
position p;
@@
 struct nfp_dump_error cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_dump_error {  struct nfp_dump_tl tl ;  __be32 error ;  char padding [ 4 ] ;  char spec [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct nfp_level_size * cocci_id@p ;
...
position p;
@@
 struct nfp_dumpspec * cocci_id@p ;
...
typedef u32,__be32;
@@
 struct nfp_dump_state {  __be32 requested_level ;  u32 dumped_size ;  u32 buf_size ;  void * p ; } cocci_id@p ;
...
position p;
@@
 struct nfp_rtsym_table * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct nfp_dump_rtsym {  struct nfp_dump_tl tl ;  struct nfp_dump_common_cpp cpp ;  __be32 error ;  u8 padded_name_length ;  char rtsym [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct nfp_dumpspec_rtsym {  struct nfp_dump_tl tl ;  char rtsym [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct nfp_rtsym * cocci_id@p ;
...
position p;
@@
 struct nfp_dumpspec_csr * cocci_id@p ;
...
position p;
@@
 struct nfp_dumpspec_rtsym * cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_dump_prolog {  struct nfp_dump_tl tl ;  __be32 dump_level ; } cocci_id@p ;
...
position p;
@@
 struct nfp_dump_csr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct nfp_pf * pf , struct nfp_dump_tl * tl , void * param ) ;
...
typedef __be32;
@@
 struct nfp_dump_common_cpp {  struct nfp_dumpspec_cpp_isl_id cpp_id ;  __be32 offset ;  __be32 dump_length ; } cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_dump_tl {  __be32 type ;  __be32 length ;  char data [ 0 ] ; } cocci_id@p ;
