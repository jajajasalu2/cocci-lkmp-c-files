...
position p;
@@
 struct sys_reg_params cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p ( const struct sys_reg_desc * reg ) ;
...
position p;
@@
 struct sys_reg_desc cocci_id@p [ ] ;
...
position p;
@@
 struct kvm_sys_reg_target_table * cocci_id@p [ KVM_ARM_NUM_TARGETS ] ;
...
position p;
@@
 const struct sys_reg_desc * cocci_id@p ;
...
position p;
@@
 struct kvm_sys_reg_target_table * cocci_id@p ;
...
position p;
@@
 const struct sys_reg_params * cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( void __user * uaddr , const u64 * val , u64 id ) ;
...
typedef u64;
@@
 int cocci_id@p ( u64 * val , const void __user * uaddr , u64 id ) ;
