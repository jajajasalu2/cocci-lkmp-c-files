...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TUNNEL_KEY_IP6_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TUNNEL_MAX + 1 ] ;
...
position p;
@@
 struct nft_tunnel_obj * cocci_id@p ;
...
position p;
@@
 struct nft_tunnel_opts * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TUNNEL_KEY_OPTS_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_TUNNEL_KEY_IP6_MAX + 1 ] ;
...
position p;
@@
 const struct nft_tunnel * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TUNNEL_KEY_IP_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TUNNEL_KEY_MAX + 1 ] ;
...
position p;
@@
 struct nft_tunnel_obj {  struct metadata_dst * md ;  struct nft_tunnel_opts opts ; } cocci_id@p ;
...
position p;
@@
 struct nft_tunnel {  enum nft_tunnel_keys key : 8 ;  enum nft_registers dreg : 8 ;  enum nft_tunnel_mode mode : 8 ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_TUNNEL_KEY_ERSPAN_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_TUNNEL_KEY_OPTS_MAX + 1 ] ;
...
typedef u32;
@@
 struct nft_tunnel_opts {  union {  struct vxlan_metadata vxlan ;  struct erspan_metadata erspan ; } u ;  u32 len ;  __be16 flags ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TUNNEL_KEY_VXLAN_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_TUNNEL_KEY_IP_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_TUNNEL_KEY_VXLAN_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TUNNEL_KEY_ERSPAN_MAX + 1 ] ;
