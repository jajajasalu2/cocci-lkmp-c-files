...
typedef __u8;
@@
 struct tower_get_version_reply {  __le16 size ;  __u8 err_code ;  __u8 spare ;  __u8 major ;  __u8 minor ;  __le16 build_no ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lego_usb_tower * dev ) ;
...
position p;
@@
 struct tower_get_version_reply * cocci_id@p ;
...
position p;
@@
 struct tower_reset_reply * cocci_id@p ;
...
typedef __u8;
@@
 struct tower_reset_reply {  __le16 size ;  __u8 err_code ;  __u8 spare ; } cocci_id@p ;
...
position p;
@@
 struct lego_usb_tower * cocci_id@p ;
