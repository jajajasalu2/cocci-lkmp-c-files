...
position p;
@@
 struct rcar_gen3_phy * cocci_id@p ;
...
typedef bool,u32;
@@
 struct rcar_gen3_phy {  struct phy * phy ;  struct rcar_gen3_chan * ch ;  u32 int_enable_bits ;  bool initialized ;  bool otg_initialized ;  bool powered ; } cocci_id@p ;
...
position p;
@@
 enum rcar_gen3_phy_index { PHY_INDEX_BOTH_HC , PHY_INDEX_OHCI , PHY_INDEX_EHCI , PHY_INDEX_HSUSB , } cocci_id@p ;
...
position p;
@@
 struct rcar_gen3_chan cocci_id@p ;
...
typedef bool;
@@
 struct rcar_gen3_chan {  void __iomem * base ;  struct device * dev ;  struct extcon_dev * extcon ;  struct rcar_gen3_phy rphys [ NUM_OF_PHYS ] ;  struct regulator * vbus ;  struct work_struct work ;  struct mutex lock ;  enum usb_dr_mode dr_mode ;  bool extcon_host ;  bool is_otg_channel ;  bool uses_otg_pins ; } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ NUM_OF_PHYS ] ;
