...
position p;
@@
 struct hfi1_eprom_table_entry * cocci_id@p ;
...
typedef u32;
@@
 struct hfi1_eprom_table_entry {  u32 type ;  u32 offset ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 struct hfi1_eprom_footer * cocci_id@p ;
...
typedef u32,u16;
@@
 struct hfi1_eprom_footer {  u32 oprom_size ;  u16 num_table_entries ;  u16 version ;  u32 magic ; } cocci_id@p ;
