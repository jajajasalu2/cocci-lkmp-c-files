...
typedef uint32_t;
@@
 struct cdv_intel_dp_m_n {  uint32_t tu ;  uint32_t gmch_m ;  uint32_t gmch_n ;  uint32_t link_m ;  uint32_t link_n ; } cocci_id@p ;
...
position p;
@@
 struct i2c_algo_dp_aux_data * cocci_id@p ;
...
position p;
@@
 struct cdv_intel_dp_m_n cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gma_encoder * encoder ) ;
...
position p;
@@
 struct psb_intel_mode_device * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DP_LINK_STATUS_SIZE ] ;
...
position p;
@@
 struct cdv_intel_dp cocci_id@p ;
...
typedef uint32_t;
@@
 struct ddi_regoff {  uint32_t PreEmph1 ;  uint32_t PreEmph2 ;  uint32_t VSwing1 ;  uint32_t VSwing2 ;  uint32_t VSwing3 ;  uint32_t VSwing4 ;  uint32_t VSwing5 ; } cocci_id@p ;
...
position p;
@@
 struct child_device_config * cocci_id@p ;
