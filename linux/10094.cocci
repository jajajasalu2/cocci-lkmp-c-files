...
position p;
@@
 void * cocci_id@p ( unsigned char * options , int opt_len , int decomp ) ;
...
position p;
@@
 int cocci_id@p ( void * db , unsigned char * options , int opt_len , int unit , int debug , int decomp ) ;
...
position p;
@@
 int cocci_id@p ( struct compressor * cp ) ;
...
position p;
@@
 void cocci_id@p ( void * state , unsigned char * ibuf , int icnt ) ;
...
position p;
@@
 void cocci_id@p ( void * state , struct compstat * stats ) ;
...
position p;
@@
 void * cocci_id@p ( unsigned char * options , int opt_len ) ;
...
position p;
@@
 struct bsd_dict {  union {  unsigned long fcode ;  struct { #if defined(__LITTLE_ENDIAN)		/* Little endian order */  unsigned short prefix ;  unsigned char suffix ;  unsigned char pad ; #elif defined(__BIG_ENDIAN)		/* Big endian order */  unsigned char pad ;  unsigned char suffix ;  unsigned short prefix ; #else #error Endianness not defined...
 #endif } hs ; } f ;  unsigned short codem1 ;  unsigned short cptr ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * state , unsigned char * options , int opt_len , int unit , int opthdr , int mru , int debug ) ;
...
position p;
@@
 int cocci_id@p ( void * state , unsigned char * ibuf , int isize , unsigned char * obuf , int osize ) ;
...
position p;
@@
 int cocci_id@p ( void * state , unsigned char * rptr , unsigned char * obuf , int isize , int osize ) ;
...
position p;
@@
 int cocci_id@p ( void * state , unsigned char * options , int opt_len , int unit , int opthdr , int debug ) ;
...
position p;
@@
 void cocci_id@p ( struct compressor * cp ) ;
