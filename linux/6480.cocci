...
position p;
@@
 struct max8998_data cocci_id@p ;
...
position p;
@@
 struct max8998_platform_data * cocci_id@p ;
...
position p;
@@
 struct max8998_regulator_data * cocci_id@p ;
...
typedef u8;
@@
 struct max8998_data {  struct device * dev ;  struct max8998_dev * iodev ;  int num_regulators ;  u8 buck1_vol [ 4 ] ;  u8 buck2_vol [ 2 ] ;  unsigned int buck1_idx ;  unsigned int buck2_idx ; } cocci_id@p ;
