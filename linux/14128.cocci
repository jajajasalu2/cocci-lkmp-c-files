...
position p;
@@
 struct isp_csi2_device * cocci_id@p ;
...
position p;
@@
 const struct isp_bus_cfg * cocci_id@p ;
...
position p;
@@
 struct isp_csi2_timing_cfg * cocci_id@p ;
...
position p;
@@
 struct isp_csi2_ctrl_cfg * cocci_id@p ;
...
position p;
@@
 struct isp_csi2_ctx_cfg * cocci_id@p ;
