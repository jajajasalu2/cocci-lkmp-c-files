...
position p;
@@
 struct da9063_onkey cocci_id@p ;
...
position p;
@@
 struct da906x_chip_config {  int onkey_status ;  int onkey_pwr_signalling ;  int onkey_fault_log ;  int onkey_shutdown ;  int onkey_nonkey_mask ;  int onkey_nonkey_lock_mask ;  int onkey_key_reset_mask ;  int onkey_shutdown_mask ;  const char * name ; } cocci_id@p ;
...
typedef bool;
@@
 struct da9063_onkey {  struct delayed_work work ;  struct input_dev * input ;  struct device * dev ;  struct regmap * regmap ;  const struct da906x_chip_config * config ;  char phys [ 32 ] ;  bool key_power ; } cocci_id@p ;
...
position p;
@@
 const struct da906x_chip_config * cocci_id@p ;
