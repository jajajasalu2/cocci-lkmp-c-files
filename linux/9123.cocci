...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_modify_qp_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_query_qp_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_FPGA_ACCESS_REG_SZ ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_modify_qp_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_query_qp_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_cap ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_query_qp_counters_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_create_qp_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_destroy_qp_out ) ] ;
...
position p;
@@
 enum mlx5_fpga_qpc_field_select cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_query * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_destroy_qp_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_ctrl ) ] ;
...
position p;
@@
 struct mlx5_fpga_qp_counters * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_query_qp_counters_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( fpga_create_qp_in ) ] ;
