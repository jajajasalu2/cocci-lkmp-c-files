...
position p;
@@
 enum { adc12130 , adc12132 , adc12138 , } cocci_id@p ;
...
typedef u8;
@@
 struct adc12138 {  struct spi_device * spi ;  unsigned int id ;  struct clk * cclk ;  struct regulator * vref_p ;  struct regulator * vref_n ;  struct mutex lock ;  struct completion complete ;  unsigned int acquisition_time ;  u8 tx_buf [ 2 ] ____cacheline_aligned ;  u8 rx_buf [ 2 ] ; } cocci_id@p ;
