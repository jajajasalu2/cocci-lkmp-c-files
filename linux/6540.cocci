...
position p;
@@
 struct sym_driver_setup cocci_id@p ;
...
position p;
@@
 struct sym_ucmd {  struct completion * eh_done ; } cocci_id@p ;
...
typedef u_long;
@@
 struct sym_usrcmd {  u_long target ;  u_long lun ;  u_long data ;  u_long cmd ; } cocci_id@p ;
