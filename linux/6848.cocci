...
position p;
@@
 enum fc_els_rscn_ev_qual cocci_id@p ;
...
position p;
@@
 struct fc_ns_gid_pn * cocci_id@p ;
...
position p;
@@
 struct fc_ns_gid_ft cocci_id@p ;
...
position p;
@@
 enum fc_els_rscn_addr_fmt cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fc_lport * , struct fc_disc_port * ) ;
...
position p;
@@
 void cocci_id@p ( struct fc_disc * , enum fc_disc_event ) ;
...
position p;
@@
 void cocci_id@p ( struct fc_disc * ) ;
...
position p;
@@
 struct fc_disc_port * cocci_id@p ;
