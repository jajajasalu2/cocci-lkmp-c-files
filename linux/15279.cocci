...
typedef bool,u32;
@@
 struct is31fl319x_chip {  const struct is31fl319x_chipdef * cdef ;  struct i2c_client * client ;  struct regmap * regmap ;  struct mutex lock ;  u32 audio_gain_db ;  struct is31fl319x_led {  struct is31fl319x_chip * chip ;  struct led_classdev cdev ;  u32 max_microamp ;  bool configured ; } leds [ IS31FL319X_MAX_LEDS ] ; } cocci_id@p ;
...
position p;
@@
 const struct is31fl319x_chipdef cocci_id@p ;
...
position p;
@@
 struct is31fl319x_led cocci_id@p ;
...
position p;
@@
 struct is31fl319x_chip * cocci_id@p ;
...
position p;
@@
 struct is31fl319x_chipdef {  int num_leds ; } cocci_id@p ;
