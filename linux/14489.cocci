...
position p;
@@
 struct rockchip_cpuclk * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct rockchip_cpuclk {  struct clk_hw hw ;  struct clk_mux cpu_mux ;  const struct clk_ops * cpu_mux_ops ;  struct clk * alt_parent ;  void __iomem * reg_base ;  struct notifier_block clk_nb ;  unsigned int rate_count ;  struct rockchip_cpuclk_rate_table * rate_table ;  const struct rockchip_cpuclk_reg_data * reg_data ;  spinlock_t * lock ; } cocci_id@p ;
...
position p;
@@
 const struct rockchip_cpuclk_clksel * cocci_id@p ;
