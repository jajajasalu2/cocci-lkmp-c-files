...
position p;
@@
 struct sst_byt_pcm_data * cocci_id@p ;
...
position p;
@@
 struct sst_byt_priv_data * cocci_id@p ;
...
typedef bool;
@@
 struct sst_byt_priv_data {  struct sst_byt * byt ;  struct sst_byt_pcm_data pcm [ BYT_PCM_COUNT ] ;  bool restore_stream ; } cocci_id@p ;
...
typedef u32;
@@
 struct sst_byt_pcm_data {  struct sst_byt_stream * stream ;  struct snd_pcm_substream * substream ;  struct mutex mutex ;  u32 hw_ptr ;  struct work_struct work ; } cocci_id@p ;
