...
typedef u64;
@@
 u64 cocci_id@p ( struct clocksource * cs ) ;
...
position p;
@@
 struct {  struct resource _ciab , _ciaa , _custom , _kickstart ; } cocci_id@p ;
...
@@
 void cocci_id@p ( irq_handler_t handler ) ;
...
position p;
@@
 struct resource cocci_id@p [ NUM_MEMINFO ] ;
...
position p;
@@
 const struct bi_record * cocci_id@p ;
...
position p;
@@
 const struct ConfigDev * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * m ) ;
...
position p;
@@
 struct savekmsg {  unsigned long magic1 ;  unsigned long magic2 ;  unsigned long magicptr ;  unsigned long size ;  char data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct zorro_dev_init * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct console * co , const char * b , unsigned int count ) ;
...
position p;
@@
 void cocci_id@p ( unsigned int count , unsigned int ticks ) ;
...
position p;
@@
 struct amiga_hw_present cocci_id@p ;
