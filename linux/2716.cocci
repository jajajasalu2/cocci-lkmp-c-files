...
position p;
@@
 const struct mpc_i2c_data cocci_id@p ;
...
typedef u16;
@@
 struct mpc_i2c_divider {  u16 divider ;  u16 fdr ; } cocci_id@p ;
...
position p;
@@
 const struct mpc_i2c_divider cocci_id@p [ ] ;
...
typedef u32;
@@
 struct mpc_i2c_data {  void ( * setup ) ( struct device_node * node , struct mpc_i2c * i2c , u32 clock ) ; } cocci_id@p ;
