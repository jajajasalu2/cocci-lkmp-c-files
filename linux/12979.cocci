...
position p;
@@
 const struct meson_gx_pwrc_vpu * cocci_id@p ;
...
position p;
@@
 struct meson_gx_pwrc_vpu {  struct generic_pm_domain genpd ;  struct regmap * regmap_ao ;  struct regmap * regmap_hhi ;  struct reset_control * rstc ;  struct clk * vpu_clk ;  struct clk * vapb_clk ; } cocci_id@p ;
...
position p;
@@
 struct meson_gx_pwrc_vpu * cocci_id@p ;
