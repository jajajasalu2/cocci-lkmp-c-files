...
position p;
@@
 enum { EPecma = 0 , EPdec , EPeq , EPgt , EPlt , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , int new_x , int new_y ) ;
...
position p;
@@
 struct con_driver cocci_id@p [ MAX_NR_CON_DRIVER ] ;
...
position p;
@@
 struct console_font cocci_id@p ;
...
typedef u8;
@@
 struct rgb {  u8 r ;  u8 g ;  u8 b ; } cocci_id@p ;
...
typedef char32_t;
@@
 struct uni_screen {  char32_t * lines [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 enum { blank_off = 0 , blank_normal_wait , blank_vesa_wait , } cocci_id@p ;
...
position p;
@@
 const struct vc_data * cocci_id@p ;
...
position p;
@@
 struct vc cocci_id@p [ MAX_NR_CONSOLES ] ;
...
position p;
@@
 const struct interval cocci_id@p [ ] ;
...
position p;
@@
 struct vt_notifier_param cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct timer_list * unused ) ;
...
position p;
@@
 const struct consw * cocci_id@p [ MAX_NR_CONSOLES ] ;
...
position p;
@@
 struct console_font_op * cocci_id@p ;
...
position p;
@@
 struct con_driver {  const struct consw * con ;  const char * desc ;  struct device * dev ;  int node ;  int first ;  int last ;  int flag ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct interval {  uint32_t first ;  uint32_t last ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , unsigned int rows , unsigned int cols , int do_clear ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * vc , int do_clear ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct vc_data * vc , const struct rgb * c ) ;
...
position p;
@@
 enum { ESnormal , ESesc , ESsquare , ESgetpars , ESfunckey , EShash , ESsetG0 , ESsetG1 , ESpercent , EScsiignore , ESnonstd , ESpalette , ESosc , } cocci_id@p ;
