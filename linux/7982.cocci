...
symbol cocci_id;
position p;
typedef slave_queue_t;
@@
 slave_queue_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef slaving_request_t;
@@
 slaving_request_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef master_config_t;
@@
 master_config_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef slave_config_t;
@@
 slave_config_t cocci_id@p ;
