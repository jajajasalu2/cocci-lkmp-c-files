...
position p;
@@
 struct multiprocess_signals * cocci_id@p ;
...
position p;
@@
 const struct kernel_siginfo * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef old_sigset_t;
@@
 old_sigset_t * cocci_id@p ;
...
position p;
@@
 struct sighand_struct * cocci_id@p ;
...
position p;
@@
 enum siginfo_layout cocci_id@p ;
...
position p;
@@
 const struct old_sigaction * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_stack_t;
@@
 compat_stack_t cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SI_EXPANSION_SIZE ] ;
...
symbol cocci_id;
position p;
typedef compat_sigset_t;
@@
 compat_sigset_t cocci_id@p ;
...
position p;
@@
 struct compat_siginfo cocci_id@p ;
...
position p;
@@
 const struct sigaction * cocci_id@p ;
...
position p;
@@
 struct signal_struct * cocci_id@p ;
...
position p;
@@
 struct old_sigaction * cocci_id@p ;
...
position p;
@@
 const struct {  unsigned char limit , layout ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct compat_siginfo * cocci_id@p ;
