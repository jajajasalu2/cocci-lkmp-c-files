...
position p;
@@
 struct orangefs_dir_part * cocci_id@p ;
...
position p;
@@
 struct orangefs_readdir_response_s * cocci_id@p ;
...
position p;
@@
 struct orangefs_dir_part {  struct orangefs_dir_part * next ;  size_t len ; } cocci_id@p ;
...
@@
 struct orangefs_dir {  __u64 token ;  struct orangefs_dir_part * part ;  loff_t end ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct orangefs_dir cocci_id@p ;
