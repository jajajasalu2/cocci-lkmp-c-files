...
position p;
@@
 const struct svc_serv_ops * cocci_id@p ;
...
position p;
@@
 const struct svc_serv * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct svc_serv * serv , struct net * net ) ;
...
position p;
@@
 struct svc_process_info * cocci_id@p ;
...
position p;
@@
 const struct svc_rqst * cocci_id@p ;
...
position p;
@@
 struct svc_pool_map * cocci_id@p ;
...
position p;
@@
 const struct svc_procedure * cocci_id@p ;
...
position p;
@@
 const struct svc_pool_map * cocci_id@p ;
...
position p;
@@
 const struct svc_program * cocci_id@p ;
