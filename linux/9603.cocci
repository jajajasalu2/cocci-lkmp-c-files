...
position p;
@@
 struct brcmf_fweh_info cocci_id@p ;
...
position p;
@@
 enum brcmf_fweh_event_code cocci_id@p ;
...
position p;
@@
 struct brcmf_event_msg_be * cocci_id@p ;
...
typedef s8;
@@
 s8 cocci_id@p [ BRCMF_EVENTING_MASK_LEN ] ;
...
position p;
@@
 struct brcmf_event_msg cocci_id@p ;
...
typedef u8,u32;
@@
 struct brcmf_fweh_queue_item {  struct list_head q ;  enum brcmf_fweh_event_code code ;  u8 ifidx ;  u8 ifaddr [ ETH_ALEN ] ;  struct brcmf_event_msg_be emsg ;  u32 datalen ;  u8 data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_fweh_event_name cocci_id@p [ ] ;
...
position p;
@@
 struct brcmf_fweh_queue_item cocci_id@p ;
...
symbol cocci_id;
position p;
typedef brcmf_fweh_handler_t;
@@
 brcmf_fweh_handler_t cocci_id@p ;
...
position p;
@@
 struct brcmf_fweh_event_name {  enum brcmf_fweh_event_code code ;  const char * name ; } cocci_id@p ;
