...
position p;
@@
 struct milbeaut_hdmac_chan * cocci_id@p ;
...
position p;
@@
 struct milbeaut_hdmac_desc {  struct virt_dma_desc vd ;  struct scatterlist * sgl ;  unsigned int sg_len ;  unsigned int sg_cur ;  enum dma_transfer_direction dir ; } cocci_id@p ;
...
position p;
@@
 struct milbeaut_hdmac_device * cocci_id@p ;
...
position p;
@@
 struct milbeaut_hdmac_device {  struct dma_device ddev ;  struct clk * clk ;  void __iomem * reg_base ;  struct milbeaut_hdmac_chan channels [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct milbeaut_hdmac_desc cocci_id@p ;
...
position p;
@@
 struct milbeaut_hdmac_chan {  struct virt_dma_chan vc ;  struct milbeaut_hdmac_device * mdev ;  struct milbeaut_hdmac_desc * md ;  void __iomem * reg_ch_base ;  unsigned int slave_id ;  struct dma_slave_config cfg ; } cocci_id@p ;
