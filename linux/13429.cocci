...
typedef u8,u64;
@@
 struct tm6000_IR {  struct tm6000_core * dev ;  struct rc_dev * rc ;  char name [ 32 ] ;  char phys [ 32 ] ;  int polling ;  struct delayed_work work ;  u8 wait : 1 ;  u8 pwled : 2 ;  u8 submit_urb : 1 ;  struct urb * int_urb ;  u64 rc_proto ; } cocci_id@p ;
...
typedef u16;
@@
 struct tm6000_ir_poll_result {  u16 rc_data ; } cocci_id@p ;
