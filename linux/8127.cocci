...
position p;
@@
 struct c_can_pci_data * cocci_id@p ;
...
position p;
@@
 enum c_can_pci_reg_align { C_CAN_REG_ALIGN_16 , C_CAN_REG_ALIGN_32 , C_CAN_REG_32 , } cocci_id@p ;
...
position p;
@@
 const struct c_can_pci_data cocci_id@p ;
...
typedef bool;
@@
 struct c_can_pci_data {  enum c_can_dev_id type ;  enum c_can_pci_reg_align reg_align ;  unsigned int freq ;  int bar ;  void ( * init ) ( const struct c_can_priv * priv , bool enable ) ; } cocci_id@p ;
