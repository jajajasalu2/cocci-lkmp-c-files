...
position p;
@@
 struct adxrs450_state * cocci_id@p ;
...
position p;
@@
 enum { ID_ADXRS450 , ID_ADXRS453 , } cocci_id@p ;
...
position p;
@@
 const struct iio_chan_spec cocci_id@p [ 2 ] [ 2 ] ;
...
typedef __be32;
@@
 struct adxrs450_state {  struct spi_device * us ;  struct mutex buf_lock ;  __be32 tx ____cacheline_aligned ;  __be32 rx ; } cocci_id@p ;
