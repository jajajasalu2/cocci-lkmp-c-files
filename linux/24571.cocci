...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_CAIF_MAX + 1 ] ;
...
position p;
@@
 enum caif_states { CAIF_CONNECTED = 1 , CAIF_CONNECTING , CAIF_DISCONNECTED , CAIF_SHUTDOWN , } cocci_id@p ;
...
@@
 struct chnl_net {  struct cflayer chnl ;  struct caif_connect_request conn_req ;  struct list_head list_field ;  struct net_device * netdev ;  char name [ 256 ] ;  wait_queue_head_t netmgmt_wq ;  bool flowenabled ;  enum caif_states state ; } cocci_id@p ;
