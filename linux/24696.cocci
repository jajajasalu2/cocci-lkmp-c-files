...
position p;
@@
 struct ip_vs_dest_set_elem {  struct list_head list ;  struct ip_vs_dest * dest ;  struct rcu_head rcu_head ; } cocci_id@p ;
...
@@
 struct ip_vs_lblcr_table {  struct rcu_head rcu_head ;  struct hlist_head bucket [ IP_VS_LBLCR_TAB_SIZE ] ;  atomic_t entries ;  int max_size ;  struct timer_list periodic_timer ;  struct ip_vs_service * svc ;  int rover ;  int counter ;  bool dead ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_dest_set_elem * cocci_id@p ;
...
position p;
@@
 struct ip_vs_dest_set * cocci_id@p ;
...
typedef atomic_t;
@@
 struct ip_vs_dest_set {  atomic_t size ;  unsigned long lastmod ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_lblcr_table * cocci_id@p ;
...
position p;
@@
 struct ip_vs_lblcr_entry * cocci_id@p ;
...
position p;
@@
 struct ip_vs_lblcr_entry {  struct hlist_node list ;  int af ;  union nf_inet_addr addr ;  struct ip_vs_dest_set set ;  unsigned long lastuse ;  struct rcu_head rcu_head ; } cocci_id@p ;
