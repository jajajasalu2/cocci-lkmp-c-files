...
position p;
@@
 enum hotmod_op { HM_ADD , HM_REMOVE , } cocci_id@p ;
...
position p;
@@
 struct hotmod_vals {  const char * name ;  const int val ; } cocci_id@p ;
...
position p;
@@
 const struct hotmod_vals * cocci_id@p ;
