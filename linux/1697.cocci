...
position p;
@@
 struct iio_dma_buffer_queue * cocci_id@p ;
...
position p;
@@
 struct dmaengine_buffer * cocci_id@p ;
...
position p;
@@
 const struct iio_dma_buffer_ops cocci_id@p ;
...
position p;
@@
 struct dmaengine_buffer {  struct iio_dma_buffer_queue queue ;  struct dma_chan * chan ;  struct list_head active ;  size_t align ;  size_t max_size ; } cocci_id@p ;
...
position p;
@@
 struct iio_dma_buffer_block * cocci_id@p ;
