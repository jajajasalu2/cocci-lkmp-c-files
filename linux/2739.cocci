...
position p;
@@
 struct highlander_i2c_dev * cocci_id@p ;
...
typedef u8;
@@
 struct highlander_i2c_dev {  struct device * dev ;  void __iomem * base ;  struct i2c_adapter adapter ;  struct completion cmd_complete ;  unsigned long last_read_time ;  int irq ;  u8 * buf ;  size_t buf_len ; } cocci_id@p ;
