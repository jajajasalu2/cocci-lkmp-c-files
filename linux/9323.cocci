...
position p;
@@
 struct wl1251_cmd_vbm_update * cocci_id@p ;
...
position p;
@@
 struct wl1251_cmd_packet_template * cocci_id@p ;
...
position p;
@@
 struct wl1251_cmd_ps_params * cocci_id@p ;
...
position p;
@@
 struct wl1251_cmd_trigger_scan_to * cocci_id@p ;
...
position p;
@@
 struct wl1251_cmd_header * cocci_id@p ;
...
position p;
@@
 struct wl1251_command * cocci_id@p ;
...
position p;
@@
 struct wl1251_cmd_scan * cocci_id@p ;
...
position p;
@@
 struct cmd_read_write_memory * cocci_id@p ;
