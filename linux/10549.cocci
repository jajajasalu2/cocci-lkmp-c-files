...
position p;
@@
 struct drm_i915_query_engine_info cocci_id@p ;
...
position p;
@@
 struct drm_i915_engine_info cocci_id@p ;
...
position p;
@@
 struct drm_i915_query_item cocci_id@p ;
...
position p;
@@
 struct drm_i915_query_topology_info cocci_id@p ;
...
position p;
@@
 struct drm_i915_query * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct drm_i915_private * dev_priv , struct drm_i915_query_item * query_item ) ;
...
position p;
@@
 struct drm_i915_query_perf_config cocci_id@p ;
