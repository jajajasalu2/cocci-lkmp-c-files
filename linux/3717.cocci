...
position p;
@@
 struct qat_crypto_instance * cocci_id@p ;
...
position p;
@@
 struct qat_rsa_output_params cocci_id@p ;
...
position p;
@@
 struct qat_rsa_input_params cocci_id@p ;
...
position p;
@@
 struct qat_dh_input_params cocci_id@p ;
...
@@
 struct qat_rsa_input_params {  union {  struct {  dma_addr_t m ;  dma_addr_t e ;  dma_addr_t n ; } enc ;  struct {  dma_addr_t c ;  dma_addr_t d ;  dma_addr_t n ; } dec ;  struct {  dma_addr_t c ;  dma_addr_t p ;  dma_addr_t q ;  dma_addr_t dp ;  dma_addr_t dq ;  dma_addr_t qinv ; } dec_crt ;  u64 in_tab [ 8 ] ; } ; } __packed __aligned ( 64 ) cocci_id@p ;
...
@@
 struct qat_rsa_ctx {  char * n ;  char * e ;  char * d ;  char * p ;  char * q ;  char * dp ;  char * dq ;  char * qinv ;  dma_addr_t dma_n ;  dma_addr_t dma_e ;  dma_addr_t dma_d ;  dma_addr_t dma_p ;  dma_addr_t dma_q ;  dma_addr_t dma_dp ;  dma_addr_t dma_dq ;  dma_addr_t dma_qinv ;  unsigned int key_sz ;  bool crt_mode ;  struct qat_crypto_instance * inst ; } __packed __aligned ( 64 ) cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_pke_request * cocci_id@p ;
...
typedef u64,dma_addr_t;
@@
 struct qat_dh_output_params {  union {  dma_addr_t r ;  u64 out_tab [ 8 ] ; } ; } __packed __aligned ( 64 ) cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_pke_resp * cocci_id@p ;
...
position p;
@@
 struct qat_asym_request cocci_id@p ;
...
typedef bool,dma_addr_t;
@@
 struct qat_dh_ctx {  char * g ;  char * xa ;  char * p ;  dma_addr_t dma_g ;  dma_addr_t dma_xa ;  dma_addr_t dma_p ;  unsigned int p_size ;  bool g2 ;  struct qat_crypto_instance * inst ; } __packed __aligned ( 64 ) cocci_id@p ;
...
position p;
@@
 struct qat_dh_output_params cocci_id@p ;
...
typedef u64,dma_addr_t;
@@
 struct qat_rsa_output_params {  union {  struct {  dma_addr_t c ; } enc ;  struct {  dma_addr_t m ; } dec ;  u64 out_tab [ 8 ] ; } ; } __packed __aligned ( 64 ) cocci_id@p ;
...
position p;
@@
 struct akcipher_alg cocci_id@p ;
...
typedef u64,dma_addr_t;
@@
 struct qat_dh_input_params {  union {  struct {  dma_addr_t b ;  dma_addr_t xa ;  dma_addr_t p ; } in ;  struct {  dma_addr_t xa ;  dma_addr_t p ; } in_g2 ;  u64 in_tab [ 8 ] ; } ; } __packed __aligned ( 64 ) cocci_id@p ;
