...
position p;
@@
 struct pci_mailbox_address * cocci_id@p ;
...
position p;
@@
 struct pci_master_address_conversion cocci_id@p ;
...
position p;
@@
 struct pci_target_address_window cocci_id@p ;
...
position p;
@@
 struct pci_controller_unit_setup * cocci_id@p ;
...
position p;
@@
 struct pci_target_address_conversion * cocci_id@p ;
