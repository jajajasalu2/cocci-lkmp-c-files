...
position p;
@@
 struct ds1216_priv {  struct rtc_device * rtc ;  void __iomem * ioaddr ; } cocci_id@p ;
...
typedef u8;
@@
 struct ds1216_regs {  u8 tsec ;  u8 sec ;  u8 min ;  u8 hour ;  u8 wday ;  u8 mday ;  u8 month ;  u8 year ; } cocci_id@p ;
