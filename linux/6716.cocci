...
position p;
@@
 struct ip22_hostdata cocci_id@p ;
...
typedef u32;
@@
 struct hpc_chunk {  struct hpc_dma_desc desc ;  u32 _padding ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct ip22_hostdata {  struct WD33C93_hostdata wh ;  dma_addr_t dma ;  void * cpu ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct sgiwd93_platform_data * cocci_id@p ;
...
position p;
@@
 struct hpc3_scsiregs * cocci_id@p ;
