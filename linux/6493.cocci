...
position p;
@@
 struct visor_vbus_headerinfo cocci_id@p ;
...
typedef u32;
@@
 struct visor_busdev {  u32 bus_no ;  u32 dev_no ; } cocci_id@p ;
...
position p;
@@
 struct visor_vbus_channel cocci_id@p ;
...
position p;
@@
 struct visor_busdev cocci_id@p ;
...
position p;
@@
 const struct visor_busdev * cocci_id@p ;
...
position p;
@@
 struct visor_vbus_deviceinfo * cocci_id@p ;
