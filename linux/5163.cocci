...
typedef u16;
@@
 struct moxtet_gpio_desc {  u16 in_mask ;  u16 out_mask ; } cocci_id@p ;
...
position p;
@@
 struct moxtet_gpio_chip * cocci_id@p ;
...
position p;
@@
 struct moxtet_gpio_chip {  struct device * dev ;  struct gpio_chip gpio_chip ;  const struct moxtet_gpio_desc * desc ; } cocci_id@p ;
...
position p;
@@
 const struct moxtet_gpio_desc cocci_id@p [ ] ;
