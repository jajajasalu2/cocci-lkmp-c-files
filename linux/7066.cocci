...
typedef ide_hwif_t;
@@
 int cocci_id@p ( ide_hwif_t * , const struct ide_port_info * ) ;
...
symbol cocci_id;
position p;
typedef mdma_timings_t;
@@
 struct mdma_timings_t {  int accessTime ;  int recoveryTime ;  int cycleTime ; } cocci_id@p ;
...
position p;
@@
 enum { controller_ohare , controller_heathrow , controller_kl_ata3 , controller_kl_ata4 , controller_un_ata6 , controller_k2_ata6 , controller_sh_ata6 , } cocci_id@p ;
...
typedef mdma_timings_t;
@@
 struct mdma_timings_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pmac_ide_hwif_t;
@@
 pmac_ide_hwif_t * cocci_id@p ;
...
position p;
@@
 struct {  int addrSetup ;  int rdy2pause ;  int wrDataSetup ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct ide_dma_ops cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,ide_hwif_t;
@@
 struct pmac_ide_hwif {  unsigned long regbase ;  int irq ;  int kind ;  int aapl_bus_id ;  unsigned broken_dma : 1 ;  unsigned broken_dma_warn : 1 ;  struct device_node * node ;  struct macio_dev * mdev ;  u32 timings [ 4 ] ;  volatile u32 __iomem * * kauai_fcr ;  ide_hwif_t * hwif ;  volatile struct dbdma_regs __iomem * dma_regs ;  struct dbdma_cmd * dma_table_cpu ; } cocci_id@p ;
...
position p;
@@
 const struct ide_port_info * cocci_id@p ;
...
typedef u32;
@@
 struct kauai_timing {  int cycle_time ;  u32 timing_reg ; } cocci_id@p ;
...
position p;
@@
 const struct ide_tp_ops cocci_id@p ;
...
position p;
@@
 struct kauai_timing * cocci_id@p ;
...
position p;
@@
 struct of_device_id cocci_id@p [ ] ;
...
position p;
@@
 const struct ide_port_ops cocci_id@p ;
...
position p;
@@
 struct ide_port_info cocci_id@p ;
