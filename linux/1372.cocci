...
position p;
@@
 struct cdns_ti {  struct device * dev ;  void __iomem * usbss ;  int usb2_only : 1 ;  int vbus_divider : 1 ;  struct clk * usb2_refclk ;  struct clk * lpm_clk ; } cocci_id@p ;
...
position p;
@@
 enum modestrap_mode { USBSS_MODESTRAP_MODE_NONE , USBSS_MODESTRAP_MODE_HOST , USBSS_MODESTRAP_MODE_PERIPHERAL , } cocci_id@p ;
