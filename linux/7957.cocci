...
position p;
@@
 struct rndis_data_hdr cocci_id@p ;
...
position p;
@@
 union {  void * buf ;  struct rndis_msg_hdr * header ;  struct rndis_query * get ;  struct rndis_query_c * get_c ; } cocci_id@p ;
...
position p;
@@
 struct rndis_msg_hdr * cocci_id@p ;
...
position p;
@@
 union {  void * buf ;  struct rndis_msg_hdr * header ;  struct rndis_init * init ;  struct rndis_init_c * init_c ;  struct rndis_query * get ;  struct rndis_query_c * get_c ;  struct rndis_set * set ;  struct rndis_set_c * set_c ;  struct rndis_halt * halt ; } cocci_id@p ;
...
position p;
@@
 struct rndis_indicate * cocci_id@p ;
...
position p;
@@
 struct rndis_keepalive_c * cocci_id@p ;
