...
typedef bool;
@@
 void cocci_id@p ( bool force_restart ) ;
...
position p;
@@
 struct sclp_register * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sclp_mask_state_t;
@@
 volatile enum sclp_mask_state_t { sclp_mask_state_idle , sclp_mask_state_initializing , } cocci_id@p ;
...
position p;
@@
 struct evbuf_header * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sclp_suspend_state_t;
@@
 enum sclp_suspend_state_t { sclp_suspend_state_running , sclp_suspend_state_suspended , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sclp_activation_state_t;
@@
 volatile enum sclp_activation_state_t { sclp_activation_state_active , sclp_activation_state_deactivating , sclp_activation_state_inactive , sclp_activation_state_activating , } cocci_id@p ;
...
position p;
@@
 struct sclp_statechangebuf cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sclp_running_state_t;
@@
 volatile enum sclp_running_state_t { sclp_running_state_idle , sclp_running_state_running , sclp_running_state_reset_pending , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sclp_reading_state_t;
@@
 volatile enum sclp_reading_state_t { sclp_reading_state_idle , sclp_reading_state_reading , } cocci_id@p ;
