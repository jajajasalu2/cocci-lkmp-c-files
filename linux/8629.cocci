...
position p;
@@
 struct e1000_phy_regs * cocci_id@p ;
...
position p;
@@
 union e1000_rx_desc_extended * cocci_id@p ;
...
position p;
@@
 const struct e1000_reg_info cocci_id@p [ ] ;
...
position p;
@@
 struct e1000_buffer * cocci_id@p ;
...
position p;
@@
 union e1000_rx_desc_packet_split * cocci_id@p ;
...
typedef u32;
@@
 struct e1000_reg_info {  u32 ofs ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct e1000_reg_info * cocci_id@p ;
...
position p;
@@
 struct e1000_ps_page * cocci_id@p ;
...
typedef __le64;
@@
 struct my_u1 {  __le64 a ;  __le64 b ;  __le64 c ;  __le64 d ; } * cocci_id@p ;
...
typedef __le64;
@@
 struct my_u0 {  __le64 a ;  __le64 b ; } * cocci_id@p ;
