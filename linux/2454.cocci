...
position p;
@@
 const struct dw_edma_pcie_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,off_t;
@@
 struct dw_edma_pcie_data {  enum pci_barno rg_bar ;  off_t rg_off ;  size_t rg_sz ;  enum pci_barno ll_bar ;  off_t ll_off ;  size_t ll_sz ;  enum pci_barno dt_bar ;  off_t dt_off ;  size_t dt_sz ;  u32 version ;  enum dw_edma_mode mode ;  u8 irqs ; } cocci_id@p ;
