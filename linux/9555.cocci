...
position p;
@@
 struct rtl8xxxu_txdesc32 * cocci_id@p ;
...
position p;
@@
 struct rtl8723au_phy_stats cocci_id@p ;
...
position p;
@@
 struct rtl8xxxu_txdesc40 * cocci_id@p ;
...
position p;
@@
 struct rtl8723bu_c2h * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ RTL8XXXU_ADDA_REGS ] ;
...
position p;
@@
 struct rtl8xxxu_priv * cocci_id@p ;
...
position p;
@@
 struct rtl8xxxu_tx_urb cocci_id@p ;
...
position p;
@@
 struct rtl8xxxu_rfregs cocci_id@p [ ] ;
...
position p;
@@
 struct rtl8xxxu_reg32val * cocci_id@p ;
...
position p;
@@
 enum rtl8xxxu_rfpath cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct rtl8xxxu_priv * priv , struct rtl8xxxu_rx_urb * rx_urb ) ;
...
position p;
@@
 struct rtl8xxxu_firmware_header cocci_id@p ;
...
position p;
@@
 struct rtl8xxxu_reg8val cocci_id@p [ ] ;
...
position p;
@@
 struct rtl8xxxu_btcoex * cocci_id@p ;
...
position p;
@@
 struct rtl8xxxu_rxdesc16 cocci_id@p ;
...
position p;
@@
 struct rtl8xxxu_rxdesc24 * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RTL8723A_MAX_RF_PATHS ] ;
...
position p;
@@
 struct rtl8xxxu_power_base * cocci_id@p ;
...
position p;
@@
 struct rtl8xxxu_rx_urb cocci_id@p ;
...
position p;
@@
 struct rtl8xxxu_fileops * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ RTL8XXXU_BB_REGS ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ RTL8XXXU_MAC_REGS ] ;
...
position p;
@@
 struct rtl8xxxu_rfregval * cocci_id@p ;
