...
position p;
@@
 struct qla82xx_legacy_intr_set cocci_id@p [ ] ;
...
position p;
@@
 struct qla82xx_md_entry_queue * cocci_id@p ;
...
position p;
@@
 struct qla82xx_md_entry_rdocm * cocci_id@p ;
...
position p;
@@
 struct qla82xx_md_entry_rdmem * cocci_id@p ;
...
position p;
@@
 struct qla82xx_md_entry_crb * cocci_id@p ;
...
position p;
@@
 struct qla82xx_md_entry_mux * cocci_id@p ;
...
position p;
@@
 struct qla82xx_md_entry_rdrom * cocci_id@p ;
...
position p;
@@
 struct qla82xx_md_entry_cache * cocci_id@p ;
...
position p;
@@
 struct qla82xx_uri_table_desc * cocci_id@p ;
...
position p;
@@
 struct qla82xx_uri_data_desc * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef qla82xx_md_entry_hdr_t;
@@
 qla82xx_md_entry_hdr_t * cocci_id@p ;
...
position p;
@@
 struct qla82xx_md_template_hdr * cocci_id@p ;
