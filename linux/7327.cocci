...
typedef u32;
@@
 union {  u32 all ;  struct {  unsigned enable : 1 ;  unsigned waitBlank : 1 ;  unsigned reserved1 : 4 ;  unsigned lutOffset : 10 ;  unsigned lutType : 2 ;  unsigned reserved2 : 4 ;  unsigned length : 10 ; } fields ; } cocci_id@p ;
...
position p;
@@
 struct {  __s32 video_config_reg ;  __s32 misc_video_start ;  __s32 horiz_timing_fmt ;  __s32 serr_timing_fmt ;  __s32 vert_timing_fmt ;  __s32 horiz_state ;  __s32 vert_state ;  __s32 vtg_state_elements ;  __s32 pipeline_delay ;  __s32 misc_video_end ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,ngle_rom_t;
@@
 struct stifb_info {  struct fb_info info ;  unsigned int id ;  ngle_rom_t ngle_rom ;  struct sti_struct * sti ;  int deviceSpecificConfig ;  u32 pseudo_palette [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 struct {  __s16 sizeof_ngle_data ;  __s16 x_size_visible ;  __s16 y_size_visible ;  __s16 pad2 [ 15 ] ;  __s16 cursor_pipeline_delay ;  __s16 video_interleaves ;  __s32 pad3 [ 11 ] ; } cocci_id@p ;
