...
position p;
@@
 enum { PORT_ABORT = 0x1000 , PORT_REPORT , PORT_DONE , } cocci_id@p ;
...
position p;
@@
 volatile struct kvm_run * cocci_id@p ;
...
position p;
@@
 enum { VMXON_PAGE = 0 , VMCS_PAGE , MSR_BITMAP_PAGE , NUM_VMX_PAGES , } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ L2_GUEST_STACK_SIZE ] ;
