...
position p;
@@
 enum { Opt_user_xattr , Opt_nouser_xattr , Opt_acl , Opt_noacl , Opt_cache_strategy , Opt_err , } cocci_id@p ;
...
position p;
@@
 struct erofs_super_block * cocci_id@p ;
...
position p;
@@
 struct erofs_inode_compact cocci_id@p ;
