...
position p;
@@
 struct mlx5_reg_host_endianness cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_issi_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_issi_in ) ] ;
...
position p;
@@
 struct mlx5_profile * cocci_id@p ;
...
position p;
@@
 struct mlx5_core_health * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( enable_hca_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( enable_hca_out ) ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLX5_ST_SZ_BYTES ( query_hca_cap_in ) ] ;
...
position p;
@@
 enum { MLX5_ATOMIC_REQ_MODE_BE = 0x0 , MLX5_ATOMIC_REQ_MODE_HOST_ENDIANNESS = 0x1 , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_issi_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( disable_hca_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_issi_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_hca_cap_out ) ] ;
...
typedef u8;
@@
 struct mlx5_reg_host_endianness {  u8 he ;  u8 rsvd [ 15 ] ; } cocci_id@p ;
...
position p;
@@
 enum { MLX5_CAP_BITS_RW_MASK = CAP_MASK ( MLX5_CAP_OFF_CMDIF_CSUM , 2 ) | MLX5_DEV_CAP_FLAG_DCT , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLX5_ST_SZ_BYTES ( set_driver_version_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( disable_hca_in ) ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLX5_ST_SZ_BYTES ( set_driver_version_in ) ] ;
