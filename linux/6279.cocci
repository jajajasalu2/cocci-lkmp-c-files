...
typedef u8;
@@
 struct rc5t583_irq_data {  u8 int_type ;  u8 master_bit ;  u8 int_en_bit ;  u8 mask_reg_index ;  int grp_index ; } cocci_id@p ;
...
position p;
@@
 enum int_type { SYS_INT = 0x1 , DCDC_INT = 0x2 , RTC_INT = 0x4 , ADC_INT = 0x8 , GPIO_INT = 0x10 , } cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ RC5T583_MAX_INTERRUPT_MASK_REGS ] ;
...
position p;
@@
 const struct rc5t583_irq_data * cocci_id@p ;
...
position p;
@@
 const struct rc5t583_irq_data cocci_id@p [ RC5T583_MAX_IRQS ] ;
