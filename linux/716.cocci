...
position p;
@@
 struct pnv_php_event * cocci_id@p ;
...
position p;
@@
 struct pnv_php_slot * cocci_id@p ;
...
typedef bool;
@@
 struct pnv_php_event {  bool added ;  struct pnv_php_slot * php_slot ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct device_node * dn ) ;
