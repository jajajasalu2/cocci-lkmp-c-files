...
position p;
@@
 enum tomoyo_policy_id cocci_id@p ;
...
position p;
@@
 struct tomoyo_condition * cocci_id@p ;
...
position p;
@@
 typeof ( struct tomoyo_name ) cocci_id@p ;
...
position p;
@@
 const enum tomoyo_policy_id cocci_id@p ;
...
position p;
@@
 struct tomoyo_shared_acl_head * cocci_id@p ;
...
position p;
@@
 struct tomoyo_name_union * cocci_id@p ;
...
position p;
@@
 typeof ( struct tomoyo_domain_info ) cocci_id@p ;
...
position p;
@@
 struct tomoyo_number_union * cocci_id@p ;
