...
position p;
@@
 struct meson_pcie_clk_res * cocci_id@p ;
...
position p;
@@
 struct meson_pcie_param cocci_id@p ;
...
position p;
@@
 struct meson_pcie {  struct dw_pcie pci ;  struct meson_pcie_mem_res mem_res ;  struct meson_pcie_clk_res clk_res ;  struct meson_pcie_rc_reset mrst ;  struct gpio_desc * reset_gpio ;  struct phy * phy ;  const struct meson_pcie_param * param ; } cocci_id@p ;
...
position p;
@@
 struct meson_pcie_rc_reset {  struct reset_control * phy ;  struct reset_control * port ;  struct reset_control * apb ; } cocci_id@p ;
...
position p;
@@
 struct meson_pcie_clk_res {  struct clk * clk ;  struct clk * mipi_gate ;  struct clk * port_clk ;  struct clk * general_clk ; } cocci_id@p ;
...
position p;
@@
 struct meson_pcie_rc_reset * cocci_id@p ;
...
position p;
@@
 enum pcie_data_rate { PCIE_GEN1 , PCIE_GEN2 , PCIE_GEN3 , PCIE_GEN4 , } cocci_id@p ;
...
position p;
@@
 const struct meson_pcie_param * cocci_id@p ;
...
typedef bool;
@@
 struct meson_pcie_param {  bool has_shared_phy ; } cocci_id@p ;
...
position p;
@@
 struct meson_pcie_mem_res {  void __iomem * elbi_base ;  void __iomem * cfg_base ;  void __iomem * phy_base ; } cocci_id@p ;
