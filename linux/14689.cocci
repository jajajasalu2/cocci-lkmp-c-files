...
position p;
@@
 struct samsung_clk_provider * cocci_id@p ;
...
position p;
@@
 const struct samsung_fixed_rate_clock * cocci_id@p ;
...
position p;
@@
 const struct samsung_fixed_factor_clock * cocci_id@p ;
...
position p;
@@
 struct samsung_clock_reg_cache * cocci_id@p ;
...
position p;
@@
 const struct samsung_clock_alias * cocci_id@p ;
...
position p;
@@
 const struct samsung_div_clock * cocci_id@p ;
...
position p;
@@
 struct samsung_clk_reg_dump * cocci_id@p ;
...
position p;
@@
 const struct samsung_gate_clock * cocci_id@p ;
...
position p;
@@
 const struct samsung_mux_clock * cocci_id@p ;
...
position p;
@@
 struct samsung_fixed_rate_clock * cocci_id@p ;
...
position p;
@@
 const struct samsung_cmu_info * cocci_id@p ;
...
position p;
@@
 const struct samsung_clk_reg_dump * cocci_id@p ;
