...
position p;
@@
 struct event_list {  struct event_list * next ;  struct tep_event * event ; } cocci_id@p ;
...
position p;
@@
 enum tep_filter_exp_type cocci_id@p ;
...
position p;
@@
 enum tep_filter_op_type * cocci_id@p ;
...
position p;
@@
 const struct tep_filter_type * cocci_id@p ;
...
position p;
@@
 enum tep_filter_cmp_type * cocci_id@p ;
...
position p;
@@
 struct tep_filter_type * cocci_id@p ;
...
position p;
@@
 enum filter_vals { FILTER_VAL_NORM , FILTER_VAL_FALSE , FILTER_VAL_TRUE , } cocci_id@p ;
...
position p;
@@
 enum op_type { OP_NONE , OP_BOOL , OP_NOT , OP_EXP , OP_CMP , } cocci_id@p ;
...
position p;
@@
 struct tep_filter_arg cocci_id@p ;
...
position p;
@@
 unsigned long long cocci_id@p ( struct tep_event * event , struct tep_filter_arg * arg , struct tep_record * record , enum tep_errno * err ) ;
...
position p;
@@
 struct tep_event_filter * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tep_event * event , struct tep_filter_arg * arg , struct tep_record * record , enum tep_errno * err ) ;
...
position p;
@@
 char * cocci_id@p ( struct tep_event_filter * filter , struct tep_filter_arg * arg ) ;
