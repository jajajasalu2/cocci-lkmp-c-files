...
position p;
@@
 const struct uvc_camera_terminal_descriptor cocci_id@p ;
...
position p;
@@
 const struct uvc_output_terminal_descriptor cocci_id@p ;
...
position p;
@@
 const struct uvc_processing_unit_descriptor cocci_id@p ;
...
position p;
@@
 const struct uvc_descriptor_header * cocci_id@p ;
...
position p;
@@
 const struct uvc_format_mjpeg cocci_id@p ;
...
position p;
@@
 const struct uvc_format_uncompressed cocci_id@p ;
...
position p;
@@
 const struct uvc_color_matching_descriptor cocci_id@p ;
