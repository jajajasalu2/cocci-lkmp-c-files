...
typedef u64;
@@
 struct clk_si570 {  struct clk_hw hw ;  struct regmap * regmap ;  unsigned int div_offset ;  u64 max_freq ;  u64 fxtal ;  unsigned int n1 ;  unsigned int hs_div ;  u64 rfreq ;  u64 frequency ;  struct i2c_client * i2c_client ; } cocci_id@p ;
...
position p;
@@
 enum clk_si570_variant cocci_id@p ;
...
position p;
@@
 enum clk_si570_variant { si57x , si59x , } cocci_id@p ;
