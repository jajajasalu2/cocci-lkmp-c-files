...
position p;
@@
 enum { LCP_OPTION_MRU = 1 , LCP_OPTION_ACCM , LCP_OPTION_MAGIC = 5 , } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ STATES ] ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , struct ifreq * ifr ) ;
...
typedef u8,u16;
@@
 struct proto {  struct net_device * dev ;  struct timer_list timer ;  unsigned long timeout ;  u16 pid ;  u8 state ;  u8 cr_id ;  u8 restart_counter ; } cocci_id@p ;
...
position p;
@@
 enum { CP_CONF_REQ = 1 , CP_CONF_ACK , CP_CONF_NAK , CP_CONF_REJ , CP_TERM_REQ , CP_TERM_ACK , CP_CODE_REJ , LCP_PROTO_REJ , LCP_ECHO_REQ , LCP_ECHO_REPLY , LCP_DISC_REQ , CP_CODES , } cocci_id@p ;
...
position p;
@@
 enum { IDX_LCP = 0 , IDX_IPCP , IDX_IPV6CP , IDX_COUNT , } cocci_id@p ;
...
typedef u8;
@@
 struct cp_header {  u8 code ;  u8 id ;  __be16 len ; } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ EVENTS ] ;
...
position p;
@@
 enum { INV = 0x10 , IRC = 0x20 , ZRC = 0x40 , SCR = 0x80 , SCA = 0x100 , SCN = 0x200 , STR = 0x400 , STA = 0x800 , SCJ = 0x1000 , } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ CP_CODES ] ;
...
typedef u8;
@@
 struct hdlc_header {  u8 address ;  u8 control ;  __be16 protocol ; } cocci_id@p ;
...
position p;
@@
 enum { CLOSED = 0 , STOPPED , STOPPING , REQ_SENT , ACK_RECV , ACK_SENT , OPENED , STATES , STATE_MASK = 0xF , } cocci_id@p ;
...
position p;
@@
 enum { START = 0 , STOP , TO_GOOD , TO_BAD , RCR_GOOD , RCR_BAD , RCA , RCN , RTR , RTA , RUC , RXJ_GOOD , RXJ_BAD , EVENTS , } cocci_id@p ;
