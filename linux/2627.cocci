...
position p;
@@
 struct timestamp_event_queue * cocci_id@p ;
...
position p;
@@
 struct ptp_extts_event cocci_id@p ;
...
position p;
@@
 struct ptp_sys_offset_precise cocci_id@p ;
...
position p;
@@
 struct ptp_sys_offset * cocci_id@p ;
...
position p;
@@
 struct ptp_clock_caps cocci_id@p ;
...
position p;
@@
 struct ptp_sys_offset_extended * cocci_id@p ;
