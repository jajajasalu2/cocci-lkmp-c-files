...
position p;
@@
 void cocci_id@p ( struct fw_event_work * fw_event ) ;
...
symbol cocci_id;
position p;
typedef MpiEventDataSasDeviceStatusChange_t;
@@
 MpiEventDataSasDeviceStatusChange_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SCSITaskMgmtReply_t;
@@
 SCSITaskMgmtReply_t * cocci_id@p ;
...
position p;
@@
 struct mptsas_target_reset_event cocci_id@p ;
...
position p;
@@
 struct mptsas_enclosure * cocci_id@p ;
...
position p;
@@
 struct mptsas_portinfo cocci_id@p ;
...
typedef u64;
@@
 struct mptsas_portinfo * cocci_id@p ( MPT_ADAPTER * ioc , u64 sas_address ) ;
...
position p;
@@
 MPI_SAS_IO_UNIT0_PHY_DATA * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SCSITaskMgmt_t;
@@
 SCSITaskMgmt_t * cocci_id@p ;
...
position p;
@@
 struct rep_manu_reply cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( MPT_ADAPTER * ioc , struct mptsas_enclosure * enclosure , u32 form , u32 form_specific ) ;
...
position p;
@@
 struct sas_expander_device * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SmpPassthroughRequest_t;
@@
 SmpPassthroughRequest_t cocci_id@p ;
...
position p;
@@
 struct mptsas_phyinfo * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sas_identify * identify , struct mptsas_devinfo * device_info ) ;
...
position p;
@@
 EVENT_DATA_SAS_DEVICE_STATUS_CHANGE * cocci_id@p ;
...
position p;
@@
 EVENT_DATA_SAS_BROADCAST_PRIMITIVE * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef EventDataQueueFull_t;
@@
 EventDataQueueFull_t * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( MPT_ADAPTER * ioc , struct mptsas_devinfo * device_info , u32 form , u32 form_specific ) ;
...
position p;
@@
 struct mptsas_device_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SasPhyPage1_t;
@@
 SasPhyPage1_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef MpiEventDataSasPhyLinkStatus_t;
@@
 MpiEventDataSasPhyLinkStatus_t * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( MPT_ADAPTER * ioc , struct mptsas_portinfo * port_info , u8 force ) ;
...
position p;
@@
 struct mptsas_devinfo * cocci_id@p ;
...
position p;
@@
 struct mptsas_portinfo_details * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( MPT_ADAPTER * ioc , u8 id ) ;
...
symbol cocci_id;
position p;
typedef SmpPassthroughReply_t;
@@
 SmpPassthroughReply_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( MPT_ADAPTER * ioc , struct mptsas_phyinfo * phy_info , struct sas_rphy * rphy ) ;
...
symbol cocci_id;
position p;
typedef SasExpanderPage0_t;
@@
 SasExpanderPage0_t * cocci_id@p ;
...
position p;
@@
 struct rep_manu_request * cocci_id@p ;
...
typedef u8;
@@
 struct rep_manu_request {  u8 smp_frame_type ;  u8 function ;  u8 reserved ;  u8 request_length ; } cocci_id@p ;
...
position p;
@@
 struct mptsas_hotplug_event * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( MPT_ADAPTER * ioc , struct mptsas_phyinfo * phy_info ) ;
...
symbol cocci_id;
position p;
typedef EventDataSasDiscovery_t;
@@
 EventDataSasDiscovery_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SasExpanderPage1_t;
@@
 SasExpanderPage1_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SasPhyPage0_t;
@@
 SasPhyPage0_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( MPT_ADAPTER * ioc , struct mptsas_phyinfo * phy_info ) ;
...
typedef u64;
@@
 struct mptsas_phyinfo * cocci_id@p ( MPT_ADAPTER * ioc , u64 sas_address ) ;
...
position p;
@@
 enum device_state { DEVICE_RETRY , DEVICE_ERROR , DEVICE_READY , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef MpiEventDataSasExpanderStatusChange_t;
@@
 MpiEventDataSasExpanderStatusChange_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SasEnclosurePage0_t;
@@
 SasEnclosurePage0_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SasIOUnitPage1_t;
@@
 SasIOUnitPage1_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SasDevicePage0_t;
@@
 SasDevicePage0_t * cocci_id@p ;
