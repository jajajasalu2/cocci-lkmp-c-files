...
position p;
@@
 const struct crci_config * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ ] [ MAX_GSBI ] ;
...
typedef u32;
@@
 struct gsbi_info {  struct clk * hclk ;  u32 mode ;  u32 crci ;  struct regmap * tcsr ; } cocci_id@p ;
...
typedef u32;
@@
 struct crci_config {  u32 num_rows ;  const u32 * array [ MAX_GSBI ] ; } cocci_id@p ;
