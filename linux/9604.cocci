...
position p;
@@
 struct brcmfmac_sdio_pd * cocci_id@p ;
...
@@
 struct brcmf_sdiod_freezer {  atomic_t freezing ;  atomic_t thread_count ;  u32 frozen_count ;  wait_queue_head_t thread_freeze ;  struct completion resumed ; } cocci_id@p ;
...
position p;
@@
 enum brcmf_sdiod_state cocci_id@p ;
