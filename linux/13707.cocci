...
position p;
@@
 const struct rj54n1_datafmt cocci_id@p [ ] ;
...
typedef u8,ratio_t;
@@
 struct rj54n1_clock_div {  u8 ratio_tg ;  u8 ratio_t ;  u8 ratio_r ;  u8 ratio_op ;  u8 ratio_o ; } cocci_id@p ;
...
position p;
@@
 const struct rj54n1_reg_val cocci_id@p [ ] ;
...
typedef s32;
@@
 int cocci_id@p ( struct v4l2_subdev * sd , s32 * in_w , s32 * in_h , s32 * out_w , s32 * out_h ) ;
...
position p;
@@
 struct rj54n1_pdata * cocci_id@p ;
...
position p;
@@
 const struct rj54n1_clock_div cocci_id@p ;
...
typedef u32;
@@
 struct rj54n1_datafmt {  u32 code ;  enum v4l2_colorspace colorspace ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct rj54n1_reg_val {  u16 reg ;  u8 val ; } cocci_id@p ;
