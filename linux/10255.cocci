...
typedef u32;
@@
 struct host1x_firewall {  struct host1x_job * job ;  struct device * dev ;  unsigned int num_relocs ;  struct host1x_reloc * reloc ;  struct host1x_bo * cmdbuf ;  unsigned int offset ;  u32 words ;  u32 class ;  u32 reg ;  u32 mask ;  u32 count ; } cocci_id@p ;
...
position p;
@@
 struct host1x_firewall * cocci_id@p ;
...
position p;
@@
 struct host1x_job_unpin_data cocci_id@p ;
...
position p;
@@
 struct host1x_job_gather * cocci_id@p ;
...
position p;
@@
 struct host1x_channel * cocci_id@p ;
