...
position p;
@@
 struct omap_rproc {  struct mbox_chan * mbox ;  struct mbox_client client ;  struct rproc * rproc ; } cocci_id@p ;
...
position p;
@@
 struct omap_rproc_pdata * cocci_id@p ;
