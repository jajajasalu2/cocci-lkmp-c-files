...
position p;
@@
 const struct iio_chan_spec cocci_id@p [ MX25_NUM_CFGS ] ;
...
position p;
@@
 enum mx25_gcq_cfgs { MX25_CFG_XP = 0 , MX25_CFG_YP , MX25_CFG_XN , MX25_CFG_YN , MX25_CFG_WIPER , MX25_CFG_INAUX0 , MX25_CFG_INAUX1 , MX25_CFG_INAUX2 , MX25_NUM_CFGS , } cocci_id@p ;
...
typedef u32;
@@
 struct mx25_gcq_priv {  struct regmap * regs ;  struct completion completed ;  struct clk * clk ;  int irq ;  struct regulator * vref [ 4 ] ;  u32 channel_vref_mv [ MX25_NUM_CFGS ] ; } cocci_id@p ;
...
position p;
@@
 struct mx25_gcq_priv * cocci_id@p ;
