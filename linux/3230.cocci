...
position p;
@@
 struct ucd9000_data * cocci_id@p ;
...
position p;
@@
 struct ucd9000_debugfs_entry * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ UCD9000_DEBUGFS_NAME_LEN ] ;
...
position p;
@@
 enum chips { ucd9000 , ucd90120 , ucd90124 , ucd90160 , ucd9090 , ucd90910 , } cocci_id@p ;
...
typedef u8;
@@
 struct ucd9000_debugfs_entry {  struct i2c_client * client ;  u8 index ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ( I2C_SMBUS_BLOCK_MAX * 2 ) + 2 ] ;
