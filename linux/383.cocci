...
position p;
@@
 struct region_devres cocci_id@p ;
...
position p;
@@
 struct resource_constraint * cocci_id@p ;
...
position p;
@@
 struct resource cocci_id@p [ MAXRESERVE ] ;
...
typedef resource_size_t;
@@
 struct region_devres {  struct resource * parent ;  resource_size_t start ;  resource_size_t n ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long , unsigned long , void * ) ;
...
position p;
@@
 enum { MAX_IORES_LEVEL = 5 , } cocci_id@p ;
