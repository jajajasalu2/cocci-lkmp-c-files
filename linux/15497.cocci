...
@@
 struct nfcsim_link {  struct mutex lock ;  u8 rf_tech ;  u8 mode ;  u8 shutdown ;  struct sk_buff * skb ;  wait_queue_head_t recv_wait ;  u8 cond ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u16,nfc_digital_cmd_complete_t;
@@
 struct nfcsim {  struct nfc_digital_dev * nfc_digital_dev ;  struct work_struct recv_work ;  struct delayed_work send_work ;  struct nfcsim_link * link_in ;  struct nfcsim_link * link_out ;  bool up ;  u8 mode ;  u8 rf_tech ;  u16 recv_timeout ;  nfc_digital_cmd_complete_t cb ;  void * arg ;  u8 dropframe ; } cocci_id@p ;
