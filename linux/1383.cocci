...
position p;
@@
 enum typec_cc_status cocci_id@p ;
...
position p;
@@
 enum wcove_typec_role { WCOVE_ROLE_HOST , WCOVE_ROLE_DEVICE , } cocci_id@p ;
...
position p;
@@
 enum typec_cc_polarity cocci_id@p ;
...
position p;
@@
 const struct pd_message * cocci_id@p ;
...
position p;
@@
 struct intel_soc_pmic * cocci_id@p ;
...
position p;
@@
 enum wcove_typec_orientation { WCOVE_ORIENTATION_NORMAL , WCOVE_ORIENTATION_REVERSE , } cocci_id@p ;
...
position p;
@@
 enum wcove_typec_func cocci_id@p ;
...
typedef bool,guid_t;
@@
 struct wcove_typec {  struct mutex lock ;  struct device * dev ;  struct regmap * regmap ;  guid_t guid ;  bool vbus ;  struct tcpc_dev tcpc ;  struct tcpm_port * tcpm ; } cocci_id@p ;
...
position p;
@@
 enum tcpm_transmit_type cocci_id@p ;
...
position p;
@@
 enum wcove_typec_func { WCOVE_FUNC_DRIVE_VBUS = 1 , WCOVE_FUNC_ORIENTATION , WCOVE_FUNC_ROLE , WCOVE_FUNC_DRIVE_VCONN , } cocci_id@p ;
