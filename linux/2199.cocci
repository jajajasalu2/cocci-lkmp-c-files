...
typedef bool;
@@
 struct smb347_charger {  struct mutex lock ;  struct device * dev ;  struct regmap * regmap ;  struct power_supply * mains ;  struct power_supply * usb ;  struct power_supply * battery ;  bool mains_online ;  bool usb_online ;  bool charging_enabled ;  const struct smb347_charger_platform_data * pdata ; } cocci_id@p ;
...
position p;
@@
 struct smb347_charger * cocci_id@p ;
...
position p;
@@
 const struct smb347_charger_platform_data * cocci_id@p ;
