...
position p;
@@
 enum FC11_REG_VCOCAL_bits { FC11_VCOCAL_RUN = 0 , FC11_VCOCAL_VALUEMASK = 0x3F , FC11_VCOCAL_OK = 0x40 , FC11_VCOCAL_RESET = 0x80 , } cocci_id@p ;
...
position p;
@@
 enum FC11_REG_VCOSEL_bits { FC11_VCOSEL_2 = 0x08 , FC11_VCOSEL_1 = 0x10 , FC11_VCOSEL_CLKOUT = 0x20 , FC11_VCOSEL_BW7M = 0x40 , FC11_VCOSEL_BW6M = 0x80 , } cocci_id@p ;
...
position p;
@@
 enum FC11_REG_RCCAL_bits { FC11_RCCAL_FORCE = 0x10 , } cocci_id@p ;
...
position p;
@@
 enum { FC11_REG_0 , FC11_REG_FA , FC11_REG_FP , FC11_REG_XINHI , FC11_REG_XINLO , FC11_REG_VCO , FC11_REG_VCOSEL , FC11_REG_7 , FC11_REG_8 , FC11_REG_9 , FC11_REG_10 , FC11_REG_11 , FC11_REG_12 , FC11_REG_RCCAL , FC11_REG_VCOCAL , FC11_REG_15 , FC11_REG_16 , FC11_REG_17 , FC11_NR_REGS , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct fc0011_priv {  struct i2c_adapter * i2c ;  u8 addr ;  u32 frequency ;  u32 bandwidth ; } cocci_id@p ;
...
position p;
@@
 const struct fc0011_config * cocci_id@p ;
