...
position p;
@@
 struct usnic_filter_action * cocci_id@p ;
...
position p;
@@
 struct usnic_vnic_res * cocci_id@p ;
...
position p;
@@
 enum usnic_transport_type cocci_id@p ;
...
position p;
@@
 struct usnic_fwd_flow * cocci_id@p ;
...
position p;
@@
 struct usnic_fwd_dev * cocci_id@p ;
...
position p;
@@
 enum usnic_vnic_res_type cocci_id@p ;
