...
position p;
@@
 const struct pte_setting * cocci_id@p ;
...
position p;
@@
 enum mi_bits_per_pixel cocci_id@p ;
...
position p;
@@
 const struct mem_input_funcs cocci_id@p ;
...
position p;
@@
 const struct pte_setting cocci_id@p [ mi_tiling_count ] [ mi_bpp_count ] ;
...
position p;
@@
 enum mi_bits_per_pixel { mi_bpp_8 = 0 , mi_bpp_16 , mi_bpp_32 , mi_bpp_64 , mi_bpp_count , } cocci_id@p ;
...
position p;
@@
 const struct dc_plane_address * cocci_id@p ;
...
typedef uint32_t;
@@
 const uint32_t cocci_id@p [ ROTATION_ANGLE_COUNT ] ;
...
position p;
@@
 enum mi_tiling_format cocci_id@p ;
...
position p;
@@
 struct pte_setting {  unsigned int bpp ;  unsigned int page_width ;  unsigned int page_height ;  unsigned char min_pte_before_flip_horiz_scan ;  unsigned char min_pte_before_flip_vert_scan ;  unsigned char pte_req_per_chunk ;  unsigned char param_6 ;  unsigned char param_7 ;  unsigned char param_8 ; } cocci_id@p ;
