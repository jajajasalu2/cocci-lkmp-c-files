...
position p;
@@
 struct hmc5843_data * cocci_id@p ;
...
position p;
@@
 struct hmc5843_chip_info {  const struct iio_chan_spec * channels ;  const int * regval_to_samp_freq [ 2 ] ;  const int n_regval_to_samp_freq ;  const int * regval_to_nanoscale ;  const int n_regval_to_nanoscale ; } cocci_id@p ;
...
position p;
@@
 const struct hmc5843_chip_info cocci_id@p [ ] ;
