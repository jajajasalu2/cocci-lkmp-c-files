...
@@
 acpi_status cocci_id@p ( u8 type , u32 index , union acpi_operand_object * object , struct acpi_walk_state * walk_state ) ;
...
typedef u32,u16;
@@
 acpi_object_type cocci_id@p ( u16 opcode , u32 index , struct acpi_walk_state * walk_state ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 type , u32 index , struct acpi_walk_state * walk_state ) ;
