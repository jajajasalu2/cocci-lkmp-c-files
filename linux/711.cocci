...
position p;
@@
 struct acpiphp_slot * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct acpi_device * adev , u32 type ) ;
...
position p;
@@
 struct acpiphp_bridge cocci_id@p ;
...
position p;
@@
 struct acpiphp_root_context * cocci_id@p ;
...
position p;
@@
 struct acpiphp_func * cocci_id@p ;
...
position p;
@@
 struct acpiphp_context * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct acpi_device * adev ) ;
...
position p;
@@
 void cocci_id@p ( struct pci_bus * bus ) ;
...
position p;
@@
 int cocci_id@p ( struct acpiphp_slot * slot ) ;
...
typedef u32;
@@
 void cocci_id@p ( u32 type , struct acpiphp_context * context ) ;
