...
typedef s32;
@@
 struct {  s32 oclass ;  int version ;  int ( * new ) ( struct nouveau_drm * , enum drm_plane_type , int , s32 , struct nv50_wndw * * ) ; } cocci_id@p [ ] ;
...
position p;
@@
 enum nv50_disp_interlock_type cocci_id@p ;
...
position p;
@@
 const struct drm_color_ctm * cocci_id@p ;
...
position p;
@@
 struct {  struct nv_dma_v0 base ;  union {  struct nv50_dma_v0 nv50 ;  struct gf100_dma_v0 gf100 ;  struct gf119_dma_v0 gf119 ; } ; } cocci_id@p ;
...
position p;
@@
 const struct nv50_wndw_func * cocci_id@p ;
...
position p;
@@
 struct nv50_wndw_ctxdma * cocci_id@p ;
...
position p;
@@
 union nv50_wndw_atom_mask cocci_id@p ;
