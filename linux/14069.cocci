...
position p;
@@
 struct sh_vou_geometry {  struct v4l2_rect output ;  unsigned int in_width ;  unsigned int in_height ;  int scale_idx_h ;  int scale_idx_v ; } cocci_id@p ;
...
position p;
@@
 struct sh_vou_buffer cocci_id@p ;
...
position p;
@@
 enum sh_vou_bus_fmt cocci_id@p ;
...
position p;
@@
 struct sh_vou_device cocci_id@p ;
...
position p;
@@
 struct sh_vou_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct sh_vou_pdata * cocci_id@p ;
...
position p;
@@
 struct sh_vou_geometry * cocci_id@p ;
...
typedef u32;
@@
 struct sh_vou_fmt {  u32 pfmt ;  unsigned char bpp ;  unsigned char bpl ;  unsigned char rgb ;  unsigned char yf ;  unsigned char pkf ; } cocci_id@p ;
...
position p;
@@
 enum sh_vou_status { SH_VOU_IDLE , SH_VOU_INITIALISING , SH_VOU_RUNNING , } cocci_id@p ;
