...
position p;
@@
 struct hisi_zip_resource {  struct hisi_zip * hzip ;  int distance ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct hisi_zip_ctrl * cocci_id@p ;
...
position p;
@@
 struct ctrl_debug_file * cocci_id@p ;
...
position p;
@@
 const struct hisi_zip_hw_error cocci_id@p [ ] ;
...
typedef u32;
@@
 struct hisi_zip_hw_error {  u32 int_msk ;  const char * msg ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct ctrl_debug_file {  enum ctrl_debug_file_index index ;  spinlock_t lock ;  struct hisi_zip_ctrl * ctrl ; } cocci_id@p ;
...
position p;
@@
 struct hisi_zip_resource * cocci_id@p ;
...
typedef u32;
@@
 struct hisi_zip_ctrl {  u32 num_vfs ;  struct hisi_zip * hisi_zip ;  struct dentry * debug_root ;  struct ctrl_debug_file files [ HZIP_DEBUG_FILE_NUM ] ; } cocci_id@p ;
...
position p;
@@
 enum { HZIP_COMP_CORE0 , HZIP_COMP_CORE1 , HZIP_DECOMP_CORE0 , HZIP_DECOMP_CORE1 , HZIP_DECOMP_CORE2 , HZIP_DECOMP_CORE3 , HZIP_DECOMP_CORE4 , HZIP_DECOMP_CORE5 , } cocci_id@p ;
...
position p;
@@
 enum ctrl_debug_file_index { HZIP_CURRENT_QM , HZIP_CLEAR_ENABLE , HZIP_DEBUG_FILE_NUM , } cocci_id@p ;
