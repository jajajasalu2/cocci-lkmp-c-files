...
position p;
@@
 int cocci_id@p ( struct pci_dev * dev , const struct pci_device_id * entry ) ;
...
typedef u8;
@@
 int cocci_id@p ( u8 regno , u8 * red , u8 * green , u8 * blue , u8 * transp , struct fb_info * info ) ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * info , struct i810fb_par * par ) ;
