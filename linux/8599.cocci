...
position p;
@@
 const struct e1000_stats cocci_id@p [ ] ;
...
position p;
@@
 enum { NETDEV_STATS , E1000_STATS , } cocci_id@p ;
...
position p;
@@
 struct e1000_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int type ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
