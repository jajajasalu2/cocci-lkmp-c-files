...
position p;
@@
 const struct hdmi4_features * cocci_id@p ;
...
position p;
@@
 struct hdmi_core_video_config cocci_id@p ;
...
position p;
@@
 struct hdmi_core_packet_enable_repeat cocci_id@p ;
...
typedef bool;
@@
 struct hdmi4_features {  bool cts_swmode ;  bool audio_use_mclk ; } cocci_id@p ;
