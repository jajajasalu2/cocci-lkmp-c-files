...
position p;
@@
 enum { MEASURE_AUX2 , MEASURE_VCHG , MEASURE_VBBATT , MEASURE_VMBATT , MEASURE_ISNS , MEASURE_THM , MEASURE_TDIE , MEASURE_MAX , } cocci_id@p ;
...
position p;
@@
 struct max8925_power_info * cocci_id@p ;
...
position p;
@@
 struct max8925_chip * cocci_id@p ;
...
position p;
@@
 struct max8925_power_pdata * cocci_id@p ;
...
position p;
@@
 struct max8925_power_info {  struct max8925_chip * chip ;  struct i2c_client * gpm ;  struct i2c_client * adc ;  struct power_supply * ac ;  struct power_supply * usb ;  struct power_supply * battery ;  int irq_base ;  unsigned ac_online : 1 ;  unsigned usb_online : 1 ;  unsigned bat_online : 1 ;  unsigned chg_mode : 2 ;  unsigned batt_detect : 1 ;  unsigned topoff_threshold : 2 ;  unsigned fast_charge : 3 ;  unsigned no_temp_support : 1 ;  unsigned no_insert_detect : 1 ;  int ( * set_charger ) ( int ) ; } cocci_id@p ;
