...
position p;
@@
 struct elantech_attr_data * cocci_id@p ;
...
position p;
@@
 struct elantech_device_info * cocci_id@p ;
...
position p;
@@
 struct elantech_attr_data {  size_t field_offset ;  unsigned char reg ; } cocci_id@p ;
...
position p;
@@
 enum { ELANTECH_SMBUS_NOT_SET = - 1 , ELANTECH_SMBUS_OFF , ELANTECH_SMBUS_ON , } cocci_id@p ;
...
position p;
@@
 struct property_entry cocci_id@p [ 11 ] ;
...
position p;
@@
 struct elantech_data * cocci_id@p ;
