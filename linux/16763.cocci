...
@@
 struct userio_device {  struct serio * serio ;  struct mutex mutex ;  bool running ;  u8 head ;  u8 tail ;  spinlock_t buf_lock ;  unsigned char buf [ USERIO_BUFSIZE ] ;  wait_queue_head_t waitq ; } cocci_id@p ;
...
position p;
@@
 struct userio_device * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ USERIO_BUFSIZE ] ;
