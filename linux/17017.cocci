...
position p;
@@
 enum { STYLUS = 1 , ERASER , CURSOR , } cocci_id@p ;
...
position p;
@@
 enum { MODEL_CINTIQ = 0x504C , MODEL_CINTIQ2 = 0x4454 , MODEL_DIGITIZER_II = 0x5544 , MODEL_GRAPHIRE = 0x4554 , MODEL_PENPARTNER = 0x4354 , MODEL_ARTPAD_II = 0x4B54 , } cocci_id@p ;
...
position p;
@@
 const struct {  int device_id ;  int input_id ; } cocci_id@p [ ] ;
