...
position p;
@@
 const struct lineop * cocci_id@p ;
...
position p;
@@
 unsigned char ( * cocci_id@p [ ] ) ( struct parport * ) ;
...
position p;
@@
 void ( * cocci_id@p [ ] ) ( struct parport * , unsigned char ) ;
...
position p;
@@
 struct i2c_par {  struct pardevice * pdev ;  struct i2c_adapter adapter ;  struct i2c_algo_bit_data algo_data ;  struct i2c_smbus_alert_setup alert_data ;  struct i2c_client * ara ;  struct list_head node ; } cocci_id@p ;
