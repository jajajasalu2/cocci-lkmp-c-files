...
position p;
@@
 const struct dc_dsc_policy * cocci_id@p ;
...
position p;
@@
 struct dc_dsc_bw_range * cocci_id@p ;
...
typedef bool;
@@
 struct dc_dsc_policy {  bool use_min_slices_h ;  int max_slices_h ;  int min_sice_height ;  int max_target_bpp ;  int min_target_bpp ; } cocci_id@p ;
...
position p;
@@
 const struct dsc_enc_caps * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MIN_AVAILABLE_SLICES_SIZE ] ;
...
position p;
@@
 union dsc_enc_slice_caps cocci_id@p ;
...
position p;
@@
 const struct dsc_dec_dpcd_caps * cocci_id@p ;
...
position p;
@@
 const struct display_stream_compressor * cocci_id@p ;
