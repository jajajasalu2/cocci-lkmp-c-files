...
position p;
@@
 struct lm3533_als_attribute cocci_id@p ;
...
typedef u8;
@@
 struct lm3533_als_attribute {  struct device_attribute dev_attr ;  enum lm3533_als_attribute_type type ;  u8 val1 ;  u8 val2 ; } cocci_id@p ;
...
position p;
@@
 enum lm3533_als_attribute_type { LM3533_ATTR_TYPE_HYSTERESIS , LM3533_ATTR_TYPE_TARGET , LM3533_ATTR_TYPE_THRESH_FALLING , LM3533_ATTR_TYPE_THRESH_RAISING , } cocci_id@p ;
...
position p;
@@
 struct lm3533_als_platform_data * cocci_id@p ;
...
typedef atomic_t;
@@
 struct lm3533_als {  struct lm3533 * lm3533 ;  struct platform_device * pdev ;  unsigned long flags ;  int irq ;  atomic_t zone ;  struct mutex thresh_mutex ; } cocci_id@p ;
