...
position p;
@@
 struct atk_acpi_ret_buffer * cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct atk_sensor_data * sensor , u64 * value ) ;
...
typedef u32;
@@
 struct atk_acpi_input_buf {  u32 id ;  u32 param1 ;  u32 param2 ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct atk_acpi_ret_buffer {  u32 flags ;  u32 value ;  u8 data [ ] ; } cocci_id@p ;
...
position p;
@@
 enum atk_pack_member { HWMON_PACK_FLAGS , HWMON_PACK_NAME , HWMON_PACK_LIMIT1 , HWMON_PACK_LIMIT2 , HWMON_PACK_ENABLE , } cocci_id@p ;
...
position p;
@@
 struct atk_sensor_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct atk_data * data , union acpi_object * obj ) ;
...
position p;
@@
 enum atk_pack_member cocci_id@p ;
...
position p;
@@
 struct atk_acpi_input_buf cocci_id@p ;
