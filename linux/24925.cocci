...
position p;
@@
 struct tipc_link_config * cocci_id@p ;
...
position p;
@@
 struct tipc_name_table_query * cocci_id@p ;
...
position p;
@@
 struct tipc_nl_compat_cmd_dump {  int ( * header ) ( struct tipc_nl_compat_msg * ) ;  int ( * dumpit ) ( struct sk_buff * , struct netlink_callback * ) ;  int ( * format ) ( struct tipc_nl_compat_msg * msg , struct nlattr * * attrs ) ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TIPC_NLA_MEDIA_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TIPC_NLA_BEARER_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TIPC_NLA_CON_MAX + 1 ] ;
...
position p;
@@
 struct tipc_genlmsghdr * cocci_id@p ;
...
position p;
@@
 struct genl_dumpit_info cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TIPC_NLA_STATS_MAX + 1 ] ;
...
position p;
@@
 struct tipc_nl_compat_cmd_doit {  int ( * doit ) ( struct sk_buff * skb , struct genl_info * info ) ;  int ( * transcode ) ( struct tipc_nl_compat_cmd_doit * cmd , struct sk_buff * skb , struct tipc_nl_compat_msg * msg ) ; } cocci_id@p ;
...
position p;
@@
 struct tipc_nl_compat_cmd_doit * cocci_id@p ;
...
typedef u16;
@@
 struct tipc_nl_compat_msg {  u16 cmd ;  int rep_type ;  int rep_size ;  int req_type ;  int req_size ;  struct net * net ;  struct sk_buff * rep ;  struct tlv_desc * req ;  struct sock * dst_sk ; } cocci_id@p ;
...
position p;
@@
 struct tipc_link_info cocci_id@p ;
...
position p;
@@
 struct tipc_bearer_config cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TIPC_NLA_PUBL_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TIPC_NLA_NAME_TABLE_MAX + 1 ] ;
...
position p;
@@
 struct tipc_nl_compat_msg * cocci_id@p ;
...
position p;
@@
 struct tipc_nl_compat_cmd_dump cocci_id@p ;
...
position p;
@@
 struct tipc_node_info cocci_id@p ;
