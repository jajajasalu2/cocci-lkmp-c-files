...
position p;
@@
 char cocci_id@p [ CONFIG_BUF_SIZE ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( char * , char * , int , char * * ) ;
...
position p;
@@
 char cocci_id@p [ MCONSOLE_MAX_DATA ] ;
...
position p;
@@
 struct mconsole_entry * cocci_id@p ;
...
position p;
@@
 struct mconsole_output * cocci_id@p ;
...
position p;
@@
 struct unplugged_pages cocci_id@p ;
...
position p;
@@
 struct mconsole_output {  struct list_head list ;  struct mc_request * req ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "18446744073709551615" ) ] ;
...
position p;
@@
 struct unplugged_pages {  struct list_head list ;  void * pages [ UNPLUGGED_PER_PAGE ] ; } cocci_id@p ;
