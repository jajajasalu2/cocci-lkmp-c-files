...
position p;
@@
 struct palmas_gpadc_info cocci_id@p [ ] ;
...
position p;
@@
 struct palmas_gpadc * cocci_id@p ;
...
typedef u8,bool;
@@
 struct palmas_gpadc_info {  int x1 ;  int x2 ;  int v1 ;  int v2 ;  u8 trim1_reg ;  u8 trim2_reg ;  int gain ;  int offset ;  int gain_error ;  bool is_uncalibrated ; } cocci_id@p ;
...
position p;
@@
 struct palmas_platform_data * cocci_id@p ;
...
position p;
@@
 struct palmas_gpadc_platform_data * cocci_id@p ;
