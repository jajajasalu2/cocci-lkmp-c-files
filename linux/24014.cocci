...
position p;
@@
 struct arpt_getinfo cocci_id@p ;
...
position p;
@@
 const struct arpt_arp * cocci_id@p ;
...
@@
 struct compat_arpt_get_entries {  char name [ XT_TABLE_MAXNAMELEN ] ;  compat_uint_t size ;  struct compat_arpt_entry entrytable [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct compat_arpt_get_entries cocci_id@p ;
...
@@
 struct compat_arpt_replace {  char name [ XT_TABLE_MAXNAMELEN ] ;  u32 valid_hooks ;  u32 num_entries ;  u32 size ;  u32 hook_entry [ NF_ARP_NUMHOOKS ] ;  u32 underflow [ NF_ARP_NUMHOOKS ] ;  u32 num_counters ;  compat_uptr_t counters ;  struct compat_arpt_entry entries [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct compat_arpt_replace cocci_id@p ;
...
position p;
@@
 const struct compat_arpt_replace * cocci_id@p ;
...
position p;
@@
 const struct arpt_entry * cocci_id@p ;
...
position p;
@@
 struct compat_arpt_entry * cocci_id@p ;
...
position p;
@@
 struct arpt_get_entries cocci_id@p ;
...
position p;
@@
 const struct arpt_devaddr_info * cocci_id@p ;
...
position p;
@@
 const struct arpt_replace * cocci_id@p ;
...
position p;
@@
 struct arpt_replace cocci_id@p ;
