...
position p;
@@
 struct aggr_info_conn cocci_id@p ;
...
position p;
@@
 struct ath6kl_node_mapping cocci_id@p ;
...
position p;
@@
 struct wmi_rx_meta_v1 cocci_id@p ;
...
position p;
@@
 struct wmi_rx_meta_v2 cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ ATH6KL_VIF_MAX ] ;
