...
position p;
@@
 struct hash_net6_elem cocci_id@p ;
...
@@
 struct hash_net4_elem {  __be32 ip ;  u16 padding0 ;  u8 nomatch ;  u8 cidr ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct hash_net6_elem {  union nf_inet_addr ip ;  u16 padding0 ;  u8 nomatch ;  u8 cidr ; } cocci_id@p ;
...
position p;
@@
 const struct hash_net4 * cocci_id@p ;
...
position p;
@@
 const struct hash_net6 * cocci_id@p ;
...
position p;
@@
 struct hash_net4_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_net4_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_net6_elem * cocci_id@p ;
