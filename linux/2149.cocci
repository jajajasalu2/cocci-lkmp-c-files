...
position p;
@@
 struct axp20x_batt_ps cocci_id@p ;
...
typedef bool;
@@
 struct axp_data {  int ccc_scale ;  int ccc_offset ;  bool has_fg_valid ;  int ( * get_max_voltage ) ( struct axp20x_batt_ps * batt , int * val ) ;  int ( * set_max_voltage ) ( struct axp20x_batt_ps * batt , int val ) ; } cocci_id@p ;
...
position p;
@@
 struct axp20x_batt_ps {  struct regmap * regmap ;  struct power_supply * batt ;  struct device * dev ;  struct iio_channel * batt_chrg_i ;  struct iio_channel * batt_dischrg_i ;  struct iio_channel * batt_v ;  unsigned int max_ccc ;  const struct axp_data * data ; } cocci_id@p ;
