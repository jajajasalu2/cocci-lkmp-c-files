...
position p;
@@
 struct tnetd7200_clocks {  struct tnetd7200_clock cpu ;  struct tnetd7200_clock dsp ;  struct tnetd7200_clock usb ; } cocci_id@p ;
...
position p;
@@
 struct tnetd7300_clocks cocci_id@p ;
...
position p;
@@
 struct tnetd7300_clock * cocci_id@p ;
...
position p;
@@
 struct tnetd7200_clock * cocci_id@p ;
...
position p;
@@
 struct tnetd7200_clocks cocci_id@p ;
...
position p;
@@
 struct tnetd7300_clocks {  struct tnetd7300_clock bus ;  struct tnetd7300_clock cpu ;  struct tnetd7300_clock usb ;  struct tnetd7300_clock dsp ; } cocci_id@p ;
