...
@@
 const dma_cap_mask_t * cocci_id@p ;
...
position p;
@@
 struct dmaengine_unmap_pool * cocci_id@p ;
...
typedef mempool_t;
@@
 struct dmaengine_unmap_pool {  struct kmem_cache * cache ;  const char * name ;  mempool_t * pool ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 struct dma_chan_tbl_ent cocci_id@p ;
...
position p;
@@
 struct dma_chan_dev * cocci_id@p ;
...
position p;
@@
 struct dma_chan_tbl_ent {  struct dma_chan * chan ; } cocci_id@p ;
