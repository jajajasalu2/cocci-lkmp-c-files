...
typedef bool,u32;
@@
 struct dce10_wm_params {  u32 dram_channels ;  u32 yclk ;  u32 sclk ;  u32 disp_clk ;  u32 src_width ;  u32 active_time ;  u32 blank_time ;  bool interlaced ;  fixed20_12 vsc ;  u32 num_heads ;  u32 bytes_per_pixel ;  u32 lb_size ;  u32 vtaps ; } cocci_id@p ;
...
position p;
@@
 struct dce10_wm_params cocci_id@p ;
...
typedef uint32_t;
@@
 const struct {  uint32_t reg ;  uint32_t vblank ;  uint32_t vline ;  uint32_t hpd ; } cocci_id@p [ ] ;
