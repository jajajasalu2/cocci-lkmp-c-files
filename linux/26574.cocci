...
typedef __u32;
@@
 struct {  struct mic_device_desc dd ;  struct mic_vqconfig vqconfig [ 2 ] ;  __u32 host_features , guest_acknowledgements ;  struct virtio_console_config cons_config ; } cocci_id@p ;
...
position p;
@@
 struct mic_device_desc * cocci_id@p ;
...
position p;
@@
 struct mic_copy_desc * cocci_id@p ;
...
position p;
@@
 struct _mic_vring_info cocci_id@p ;
...
position p;
@@
 struct pollfd cocci_id@p [ MAX_CONSOLE_FD ] ;
...
position p;
@@
 struct virtio_blk_outhdr * cocci_id@p ;
...
typedef __u32;
@@
 struct {  struct mic_device_desc dd ;  struct mic_vqconfig vqconfig [ 2 ] ;  __u32 host_features , guest_acknowledgements ;  struct virtio_net_config net_config ; } cocci_id@p ;
...
position p;
@@
 struct pollfd cocci_id@p [ MAX_NET_FD ] ;
...
typedef __u32;
@@
 struct {  struct mic_device_desc dd ;  struct mic_vqconfig vqconfig [ 1 ] ;  __u32 host_features , guest_acknowledgements ;  struct virtio_blk_config blk_config ; } cocci_id@p ;
