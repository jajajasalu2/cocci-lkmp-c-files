...
position p;
@@
 struct sockaddr_rxrpc cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rxrpc_notify_rx_t;
@@
 rxrpc_notify_rx_t cocci_id@p ;
...
position p;
@@
 struct rxrpc_call_params cocci_id@p ;
...
position p;
@@
 struct rxrpc_conn_parameters cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rxrpc_discard_new_call_t;
@@
 rxrpc_discard_new_call_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rxrpc_notify_new_call_t;
@@
 rxrpc_notify_new_call_t cocci_id@p ;
