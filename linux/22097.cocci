...
typedef bool;
@@
 struct kmod_test_device {  int dev_idx ;  struct test_config config ;  struct miscdevice misc_dev ;  struct device * dev ;  struct mutex config_mutex ;  struct mutex trigger_mutex ;  struct mutex thread_mutex ;  unsigned int done ;  bool test_is_oom ;  struct completion kthreads_done ;  struct list_head list ;  struct kmod_test_device_info * info ; } cocci_id@p ;
...
position p;
@@
 struct test_config {  char * test_driver ;  char * test_fs ;  unsigned int num_threads ;  enum kmod_test_case test_case ;  int test_result ; } cocci_id@p ;
...
position p;
@@
 enum kmod_test_case { __TEST_KMOD_INVALID = 0 , TEST_KMOD_DRIVER , TEST_KMOD_FS_TYPE , __TEST_KMOD_MAX , } cocci_id@p ;
...
position p;
@@
 enum kmod_test_case cocci_id@p ;
...
position p;
@@
 struct kmod_test_device_info * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct kmod_test_device * test_dev ) ;
...
position p;
@@
 struct kmod_test_device cocci_id@p ;
...
typedef bool;
@@
 struct kmod_test_device_info {  int ret_sync ;  struct file_system_type * fs_sync ;  struct task_struct * task_sync ;  unsigned int thread_idx ;  struct kmod_test_device * test_dev ;  bool need_mod_put ; } cocci_id@p ;
