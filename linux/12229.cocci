...
position p;
@@
 struct zx_vga_i2c {  struct i2c_adapter adap ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct zx_vga_pwrctrl * cocci_id@p ;
...
typedef u32;
@@
 struct zx_vga_pwrctrl {  struct regmap * regmap ;  u32 reg ;  u32 mask ; } cocci_id@p ;
...
typedef bool;
@@
 struct zx_vga {  struct drm_connector connector ;  struct drm_encoder encoder ;  struct zx_vga_i2c * ddc ;  struct device * dev ;  void __iomem * mmio ;  struct clk * i2c_wclk ;  struct zx_vga_pwrctrl pwrctrl ;  struct completion complete ;  bool connected ; } cocci_id@p ;
