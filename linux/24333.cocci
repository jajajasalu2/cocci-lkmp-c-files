...
position p;
@@
 int ( * cocci_id@p ) ( struct qrtr_node * , struct sk_buff * , int , struct sockaddr_qrtr * , struct sockaddr_qrtr * ) ;
...
position p;
@@
 int cocci_id@p ( struct qrtr_node * node , struct sk_buff * skb , int type , struct sockaddr_qrtr * from , struct sockaddr_qrtr * to ) ;
...
position p;
@@
 const struct sockaddr_qrtr * cocci_id@p ;
...
position p;
@@
 struct qrtr_ctrl_pkt * cocci_id@p ;
...
position p;
@@
 struct qrtr_node {  struct mutex ep_lock ;  struct qrtr_endpoint * ep ;  struct kref ref ;  unsigned int nid ;  struct sk_buff_head rx_queue ;  struct work_struct work ;  struct list_head item ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct qrtr_hdr_v2 {  u8 version ;  u8 type ;  u8 flags ;  u8 optlen ;  __le32 size ;  __le16 src_node_id ;  __le16 src_port_id ;  __le16 dst_node_id ;  __le16 dst_port_id ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct qrtr_cb {  u32 src_node ;  u32 src_port ;  u32 dst_node ;  u32 dst_port ;  u8 type ;  u8 confirm_rx ; } cocci_id@p ;
...
position p;
@@
 const struct qrtr_hdr_v2 * cocci_id@p ;
...
position p;
@@
 const struct qrtr_hdr_v1 * cocci_id@p ;
...
position p;
@@
 struct qrtr_endpoint * cocci_id@p ;
...
position p;
@@
 struct qrtr_sock * cocci_id@p ( int port ) ;
...
position p;
@@
 void cocci_id@p ( struct qrtr_sock * ipc ) ;
...
position p;
@@
 struct qrtr_sock {  struct sock sk ;  struct sockaddr_qrtr us ;  struct sockaddr_qrtr peer ; } cocci_id@p ;
