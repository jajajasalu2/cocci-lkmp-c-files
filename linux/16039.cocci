...
position p;
@@
 const struct pcl818_board cocci_id@p [ ] ;
...
position p;
@@
 struct pcl818_private {  struct comedi_isadma * dma ;  unsigned int ns_min ;  unsigned int act_chanlist [ 16 ] ;  unsigned int act_chanlist_len ;  unsigned int act_chanlist_pos ;  unsigned int usefifo : 1 ;  unsigned int ai_cmd_running : 1 ;  unsigned int ai_cmd_canceled : 1 ; } cocci_id@p ;
...
position p;
@@
 struct pcl818_board cocci_id@p ;
...
position p;
@@
 struct pcl818_private * cocci_id@p ;
...
position p;
@@
 struct pcl818_board {  const char * name ;  unsigned int ns_min ;  int n_aochan ;  const struct comedi_lrange * ai_range_type ;  unsigned int has_dma : 1 ;  unsigned int has_fifo : 1 ;  unsigned int is_818 : 1 ; } cocci_id@p ;
