...
position p;
@@
 struct nilfs_cpstat cocci_id@p ;
...
position p;
@@
 struct nilfs_cpinfo cocci_id@p ;
...
position p;
@@
 struct nilfs_period cocci_id@p ;
...
position p;
@@
 struct nilfs_argv cocci_id@p [ 5 ] ;
...
position p;
@@
 struct nilfs_cpmode cocci_id@p ;
