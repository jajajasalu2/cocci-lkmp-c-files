...
position p;
@@
 struct vma_swap_readahead * cocci_id@p ;
...
position p;
@@
 struct {  unsigned long add_total ;  unsigned long del_total ;  unsigned long find_success ;  unsigned long find_total ; } cocci_id@p ;
