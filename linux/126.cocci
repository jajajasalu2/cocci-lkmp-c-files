...
position p;
@@
 struct sched_dl_entity * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct rt_rq * rt_rq ) ;
...
position p;
@@
 struct dl_bandwidth * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rq * rq , struct task_struct * p , int flags ) ;
...
position p;
@@
 struct rq * cocci_id@p ( struct task_struct * task , struct rq * rq ) ;
