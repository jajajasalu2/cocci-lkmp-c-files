...
@@
 struct prp_priv {  struct imx_ic_priv * ic_priv ;  struct media_pad pad [ PRPENCVF_NUM_PADS ] ;  struct imx_media_video_dev * vdev ;  struct mutex lock ;  struct ipu_ic * ic ;  struct ipuv3_channel * out_ch ;  struct ipuv3_channel * rot_in_ch ;  struct ipuv3_channel * rot_out_ch ;  struct imx_media_buffer * active_vb2_buf [ 2 ] ;  struct imx_media_dma_buf underrun_buf ;  int ipu_buf_num ;  struct media_entity * sink ;  struct v4l2_subdev * src_sd ;  struct v4l2_mbus_framefmt format_mbus [ PRPENCVF_NUM_PADS ] ;  const struct imx_media_pixfmt * cc [ PRPENCVF_NUM_PADS ] ;  struct v4l2_fract frame_interval ;  struct imx_media_dma_buf rot_buf [ 2 ] ;  struct v4l2_ctrl_handler ctrl_hdlr ;  int rotation ;  bool hflip ;  bool vflip ;  enum ipu_rotate_mode rot_mode ;  spinlock_t irqlock ;  struct timer_list eof_timeout_timer ;  int eof_irq ;  int nfb4eof_irq ;  int stream_count ;  u32 frame_sequence ;  bool last_eof ;  bool nfb4eof ;  bool interweave_swap ;  struct completion last_eof_comp ; } cocci_id@p ;
...
typedef u32;
@@
 const struct prp_channels {  u32 out_ch ;  u32 rot_in_ch ;  u32 rot_out_ch ; } cocci_id@p [ ] ;
