...
position p;
@@
 struct prp_priv {  struct imx_ic_priv * ic_priv ;  struct media_pad pad [ PRP_NUM_PADS ] ;  struct mutex lock ;  struct v4l2_subdev * src_sd ;  struct v4l2_subdev * sink_sd_prpenc ;  struct v4l2_subdev * sink_sd_prpvf ;  int csi_id ;  struct v4l2_mbus_framefmt format_mbus ;  struct v4l2_fract frame_interval ;  int stream_count ; } cocci_id@p ;
