...
position p;
@@
 struct vl6180_data {  struct i2c_client * client ;  struct mutex lock ;  unsigned int als_gain_milli ;  unsigned int als_it_ms ; } cocci_id@p ;
...
position p;
@@
 const struct vl6180_chan_regs cocci_id@p [ ] ;
...
position p;
@@
 enum { VL6180_ALS , VL6180_RANGE , VL6180_PROX , } cocci_id@p ;
