...
position p;
@@
 struct resource_map cocci_id@p ;
...
position p;
@@
 struct pcmcia_align_data * cocci_id@p ;
...
position p;
@@
 struct pcmcia_align_data {  unsigned long mask ;  unsigned long offset ;  struct resource_map * map ; } cocci_id@p ;
...
position p;
@@
 struct socket_data {  struct resource_map mem_db ;  struct resource_map mem_db_valid ;  struct resource_map io_db ; } cocci_id@p ;
...
position p;
@@
 struct pccard_resource_ops cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pcmcia_socket * s , struct resource * res , unsigned int * value ) ;
