...
position p;
@@
 struct bzimage64_data * cocci_id@p ;
...
position p;
@@
 struct kexec_entry64_regs cocci_id@p ;
...
position p;
@@
 struct bzimage64_data {  void * bootparams_buf ; } cocci_id@p ;
...
position p;
@@
 const struct kexec_file_ops cocci_id@p ;
