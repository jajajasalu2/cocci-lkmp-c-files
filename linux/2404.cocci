...
position p;
@@
 struct sun6i_dma_config cocci_id@p ;
...
typedef u32;
@@
 struct sun6i_pchan {  u32 idx ;  void __iomem * base ;  struct sun6i_vchan * vchan ;  struct sun6i_desc * desc ;  struct sun6i_desc * done ; } cocci_id@p ;
...
position p;
@@
 struct sun6i_dma_dev cocci_id@p ;
...
typedef u8,bool;
@@
 struct sun6i_vchan {  struct virt_dma_chan vc ;  struct list_head node ;  struct dma_slave_config cfg ;  struct sun6i_pchan * phy ;  u8 port ;  u8 irq_type ;  bool cyclic ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct sun6i_desc {  struct virt_dma_desc vd ;  dma_addr_t p_lli ;  struct sun6i_dma_lli * v_lli ; } cocci_id@p ;
...
position p;
@@
 struct sun6i_dma_lli * cocci_id@p ;
...
typedef u32;
@@
 struct sun6i_dma_lli {  u32 cfg ;  u32 src ;  u32 dst ;  u32 len ;  u32 para ;  u32 p_lli_next ;  struct sun6i_dma_lli * v_lli_next ; } cocci_id@p ;
