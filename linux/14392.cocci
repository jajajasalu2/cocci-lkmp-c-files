...
position p;
@@
 enum stv0367_cab_signal_type cocci_id@p ;
...
position p;
@@
 enum stv0367_ts_mode cocci_id@p ;
...
position p;
@@
 struct stv0367cab_state cocci_id@p ;
...
typedef s8,u8,u32;
@@
 struct stv0367ter_state {  enum stv0367_ter_signal_type state ;  enum stv0367_ter_if_iq_mode if_iq_mode ;  enum stv0367_ter_mode mode ;  enum fe_guard_interval guard ;  enum stv0367_ter_hierarchy hierarchy ;  u32 frequency ;  enum fe_spectral_inversion sense ;  u8 force ;  u8 bw ;  u8 pBW ;  u32 pBER ;  u32 pPER ;  u32 ucblocks ;  s8 echo_pos ;  u8 first_lock ;  u8 unlock_counter ;  u32 agc_val ; } cocci_id@p ;
...
position p;
@@
 struct stv0367_state cocci_id@p ;
...
position p;
@@
 enum stv0367_ter_mode cocci_id@p ;
...
position p;
@@
 struct stv0367ter_state * cocci_id@p ;
...
position p;
@@
 enum stv0367_clk_pol cocci_id@p ;
...
position p;
@@
 enum stv0367cab_mod cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ RF_LOOKUP_TABLE_SIZE ] [ RF_LOOKUP_TABLE_SIZE ] ;
...
position p;
@@
 const struct stv0367_config * cocci_id@p ;
...
position p;
@@
 const struct st_register * cocci_id@p ;
...
typedef u8;
@@
 struct stv0367_state {  struct dvb_frontend fe ;  struct i2c_adapter * i2c ;  const struct stv0367_config * config ;  u8 chip_id ;  struct stv0367cab_state * cab_state ;  struct stv0367ter_state * ter_state ;  u8 use_i2c_gatectrl ;  u8 deftabs ;  u8 reinit_on_setfrontend ;  u8 auto_if_khz ;  enum active_demod_state activedemod ; } cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ RF_LOOKUP_TABLE2_SIZE ] [ RF_LOOKUP_TABLE2_SIZE ] ;
...
typedef s32,u32;
@@
 struct stv0367cab_state {  enum stv0367_cab_signal_type state ;  u32 mclk ;  u32 adc_clk ;  s32 search_range ;  s32 derot_offset ;  int locked ;  u32 freq_khz ;  u32 symbol_rate ;  enum fe_spectral_inversion spect_inv ;  u32 qamfec_status_reg ; } cocci_id@p ;
...
position p;
@@
 enum stv0367_ter_signal_type cocci_id@p ;
