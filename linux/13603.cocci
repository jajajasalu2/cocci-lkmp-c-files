...
typedef u8;
@@
 struct sensor_w_data {  u8 reg ;  u8 flags ;  u8 data [ 16 ] ;  int len ; } cocci_id@p ;
...
position p;
@@
 const struct sensor_w_data cocci_id@p [ ] ;
...
typedef u8;
@@
 struct sd {  struct gspca_dev gspca_dev ;  struct {  struct v4l2_ctrl * exposure ;  struct v4l2_ctrl * min_clockdiv ; } ;  u8 sof_read ;  u8 cam_type ;  u8 sensor_type ;  u8 do_lcd_stop ;  u8 adj_colors ; } cocci_id@p ;
