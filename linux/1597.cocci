...
position p;
@@
 struct spcp8x5_private * cocci_id@p ;
...
@@
 struct spcp8x5_private {  unsigned quirks ;  spinlock_t lock ;  u8 line_control ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct spcp8x5_usb_ctrl_arg {  u8 type ;  u8 cmd ;  u8 cmd_type ;  u16 value ;  u16 index ;  u16 length ; } cocci_id@p ;
