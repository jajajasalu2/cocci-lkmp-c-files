...
position p;
@@
 struct ucode_header * cocci_id@p ;
...
position p;
@@
 union cptx_pf_exe_bist_status cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct ucode_header {  u8 version [ CPT_UCODE_VERSION_SZ ] ;  u32 code_length ;  u32 data_length ;  u64 sram_address ; } cocci_id@p ;
...
position p;
@@
 union cptx_pf_bist_status cocci_id@p ;
...
position p;
@@
 union cptx_pf_constants cocci_id@p ;
