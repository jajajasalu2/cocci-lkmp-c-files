...
position p;
@@
 struct chsc_ssqd_area * cocci_id@p ;
...
position p;
@@
 struct chsc_scssc_area * cocci_id@p ;
...
position p;
@@
 struct chsc_brinfo_resume_token cocci_id@p ;
...
position p;
@@
 struct chsc_ssd_info * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct {  struct chsc_header request ;  u16 op ;  u8 reserved01 [ 2 ] ;  u8 reserved02 : 4 ;  u8 fmt : 4 ;  u8 reserved03 [ 7 ] ;  u8 reserved04 [ 4 ] ;  u32 gib_origin ;  u8 reserved05 [ 10 ] ;  u8 aix ;  u8 reserved06 [ 4029 ] ;  struct chsc_header response ;  u8 reserved07 [ 4 ] ; } * cocci_id@p ;
...
position p;
@@
 struct {  struct chsc_header request ;  unsigned int rsvd0 [ 3 ] ;  struct chsc_header response ;  char data [ ] ; } * cocci_id@p ;
...
typedef u32;
@@
 struct {  struct chsc_header request ;  u32 operation_code : 2 ;  u32 : 30 ;  u32 key : 4 ;  u32 : 28 ;  u32 zeroes1 ;  u32 cub_addr1 ;  u32 zeroes2 ;  u32 cub_addr2 ;  u32 reserved [ 13 ] ;  struct chsc_header response ;  u32 status : 8 ;  u32 : 4 ;  u32 fmt : 4 ;  u32 : 16 ; } * cocci_id@p ;
...
position p;
@@
 struct chsc_sei_nt0_area * cocci_id@p ;
...
typedef u8,u32;
@@
 struct {  struct chsc_header request ;  u8 atype ;  u32 : 24 ;  u32 reserved1 [ 6 ] ;  struct chsc_header response ;  u32 reserved2 [ 3 ] ;  struct {  u8 cssid ;  u32 : 24 ; } list [ 0 ] ; } * cocci_id@p ;
...
position p;
@@
 struct node_descriptor * cocci_id@p ;
...
position p;
@@
 struct chsc_sda_area * cocci_id@p ;
...
position p;
@@
 struct chsc_pnso_area * cocci_id@p ;
...
position p;
@@
 struct css_chsc_char cocci_id@p ;
...
position p;
@@
 struct chsc_scm_info * cocci_id@p ;
...
typedef u64;
@@
 struct {  struct chsc_header request ;  unsigned int rsvd0 ;  unsigned int op : 8 ;  unsigned int rsvd1 : 8 ;  unsigned int ctrl : 16 ;  unsigned int rsvd2 [ 5 ] ;  struct chsc_header response ;  unsigned int rsvd3 [ 3 ] ;  u64 clock_delta ;  unsigned int rsvd4 [ 2 ] ; } * cocci_id@p ;
...
typedef u32;
@@
 struct {  struct chsc_header request ;  u32 : 24 ;  u32 first_chpid : 8 ;  u32 : 24 ;  u32 last_chpid : 8 ;  u32 zeroes1 ;  struct chsc_header response ;  u32 zeroes2 ;  u32 not_valid : 1 ;  u32 shared : 1 ;  u32 : 22 ;  u32 chpid : 8 ;  u32 cmcv : 5 ;  u32 : 11 ;  u32 cmgq : 8 ;  u32 cmg : 8 ;  u32 zeroes3 ;  u32 data [ NR_MEASUREMENT_CHARS ] ; } * cocci_id@p ;
...
typedef u32;
@@
 struct {  struct chsc_header request ;  u32 word1 ;  struct subchannel_id sid ;  u32 word3 ;  struct chsc_header response ;  u32 word [ 11 ] ; } * cocci_id@p ;
...
typedef u8;
@@
 struct chp_config_data {  u8 map [ 32 ] ;  u8 op ;  u8 pc ; } cocci_id@p ;
...
position p;
@@
 struct chp_config_data * cocci_id@p ;
...
typedef u32;
@@
 struct {  struct chsc_header request ;  u32 reserved1 ;  u32 reserved2 ;  u32 reserved3 ;  struct chsc_header response ;  u32 reserved4 ;  u32 general_char [ 510 ] ;  u32 chsc_char [ 508 ] ; } * cocci_id@p ;
...
position p;
@@
 struct chsc_sei_nt2_area * cocci_id@p ;
...
position p;
@@
 struct css_general_char cocci_id@p ;
...
position p;
@@
 struct channel_path * cocci_id@p ;
...
position p;
@@
 struct chsc_ssd_area * cocci_id@p ;
...
position p;
@@
 struct channel_subsystem * cocci_id@p ;
