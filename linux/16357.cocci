...
typedef bool,u32;
@@
 struct gdma_dma_desc {  struct virt_dma_desc vdesc ;  enum dma_transfer_direction direction ;  bool cyclic ;  u32 residue ;  unsigned int num_sgs ;  struct gdma_dma_sg sg [ ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct gdma_data {  int chancnt ;  u32 done_int_reg ;  void ( * init ) ( struct gdma_dma_dev * dma_dev ) ;  int ( * start_transfer ) ( struct gdma_dmaengine_chan * chan ) ; } cocci_id@p ;
...
typedef atomic_t;
@@
 struct gdma_dma_dev {  struct dma_device ddev ;  struct device_dma_parameters dma_parms ;  struct gdma_data * data ;  void __iomem * base ;  struct tasklet_struct task ;  volatile unsigned long chan_issued ;  atomic_t cnt ;  struct gdma_dmaengine_chan chan [ ] ; } cocci_id@p ;
...
position p;
@@
 struct gdma_dma_dev * cocci_id@p ;
...
position p;
@@
 enum gdma_dma_transfer_size { GDMA_TRANSFER_SIZE_4BYTE = 0 , GDMA_TRANSFER_SIZE_8BYTE = 1 , GDMA_TRANSFER_SIZE_16BYTE = 2 , GDMA_TRANSFER_SIZE_32BYTE = 3 , GDMA_TRANSFER_SIZE_64BYTE = 4 , } cocci_id@p ;
...
@@
 struct gdma_dma_sg {  dma_addr_t src_addr ;  dma_addr_t dst_addr ;  u32 len ; } cocci_id@p ;
...
position p;
@@
 enum gdma_dma_transfer_size cocci_id@p ;
...
position p;
@@
 struct gdma_dma_desc cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct gdma_dmaengine_chan {  struct virt_dma_chan vchan ;  unsigned int id ;  unsigned int slave_id ;  dma_addr_t fifo_addr ;  enum gdma_dma_transfer_size burst_size ;  struct gdma_dma_desc * desc ;  unsigned int next_sg ; } cocci_id@p ;
...
position p;
@@
 struct gdma_dmaengine_chan cocci_id@p ;
