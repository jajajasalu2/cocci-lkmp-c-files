...
position p;
@@
 struct isl29501_private * cocci_id@p ;
...
position p;
@@
 const struct isl29501_register_desc cocci_id@p [ ] ;
...
typedef u8;
@@
 struct isl29501_register_desc {  u8 msb ;  u8 lsb ; } cocci_id@p ;
...
position p;
@@
 enum isl29501_correction_coeff { COEFF_TEMP_A , COEFF_TEMP_B , COEFF_LIGHT_A , COEFF_LIGHT_B , COEFF_MAX , } cocci_id@p ;
...
position p;
@@
 enum isl29501_correction_coeff cocci_id@p ;
...
position p;
@@
 enum isl29501_register_name cocci_id@p ;
...
position p;
@@
 struct isl29501_private {  struct i2c_client * client ;  struct mutex lock ;  unsigned int shadow_coeffs [ COEFF_MAX ] ; } cocci_id@p ;
