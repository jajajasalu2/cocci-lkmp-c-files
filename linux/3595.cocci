...
position p;
@@
 struct find_dmi_data {  struct dmi_sysfs_entry * entry ;  dmi_callback callback ;  void * private ;  int instance_countdown ;  ssize_t ret ; } cocci_id@p ;
...
position p;
@@
 struct dmi_sysfs_entry * cocci_id@p ;
...
position p;
@@
 struct dmi_sysfs_mapped_attribute * cocci_id@p ;
...
position p;
@@
 struct dmi_sysfs_attribute * cocci_id@p ;
...
position p;
@@
 struct dmi_sysfs_mapped_attribute {  struct attribute attr ;  ssize_t ( * show ) ( struct dmi_sysfs_entry * entry , const struct dmi_header * dh , char * buf ) ; } cocci_id@p ;
...
position p;
@@
 struct dmi_entry_attr_show_data cocci_id@p ;
...
position p;
@@
 struct find_dmi_data * cocci_id@p ;
...
position p;
@@
 struct dmi_sysfs_attribute {  struct attribute attr ;  ssize_t ( * show ) ( struct dmi_sysfs_entry * entry , char * buf ) ; } cocci_id@p ;
...
position p;
@@
 struct dmi_entry_attr_show_data {  struct attribute * attr ;  char * buf ; } cocci_id@p ;
...
position p;
@@
 struct dmi_read_state * cocci_id@p ;
...
position p;
@@
 struct dmi_system_event_log cocci_id@p ;
...
position p;
@@
 ssize_t ( * cocci_id@p ) ( struct dmi_sysfs_entry * , const struct dmi_header * dh , void * ) ;
...
typedef loff_t;
@@
 struct dmi_read_state {  char * buf ;  loff_t pos ;  size_t count ; } cocci_id@p ;
...
position p;
@@
 const struct dmi_system_event_log * cocci_id@p ;
...
position p;
@@
 struct dmi_sysfs_entry {  struct dmi_header dh ;  struct kobject kobj ;  int instance ;  int position ;  struct list_head list ;  struct kobject * child ; } cocci_id@p ;
