...
position p;
@@
 enum cedrus_h264_sram_off cocci_id@p ;
...
position p;
@@
 enum cedrus_irq_status cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CEDRUS_MAX_REF_IDX ] ;
...
position p;
@@
 const struct v4l2_h264_weight_factors * cocci_id@p ;
...
position p;
@@
 const struct cedrus_buffer * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_h264_pps * cocci_id@p ;
...
position p;
@@
 struct cedrus_h264_sram_ref_pic cocci_id@p [ CEDRUS_H264_FRAME_NUM ] ;
...
position p;
@@
 struct cedrus_h264_sram_ref_pic * cocci_id@p ;
...
position p;
@@
 const struct v4l2_h264_pred_weight_table * cocci_id@p ;
...
position p;
@@
 struct cedrus_dec_ops cocci_id@p ;
...
position p;
@@
 struct cedrus_buffer * cocci_id@p ;
