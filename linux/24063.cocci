...
position p;
@@
 struct switchdev_deferred_item * cocci_id@p ;
...
position p;
@@
 struct switchdev_obj_port_mdb cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net_device * dev , const struct switchdev_obj * obj ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net_device * dev , const struct switchdev_obj * obj , struct switchdev_trans * trans , struct netlink_ext_ack * extack ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net_device * dev , const struct switchdev_attr * attr , struct switchdev_trans * trans ) ;
...
symbol cocci_id;
position p;
typedef switchdev_deferred_func_t;
@@
 switchdev_deferred_func_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , const void * data ) ;
...
typedef switchdev_deferred_func_t;
@@
 struct switchdev_deferred_item {  struct list_head list ;  struct net_device * dev ;  switchdev_deferred_func_t * func ;  unsigned long data [ 0 ] ; } cocci_id@p ;
