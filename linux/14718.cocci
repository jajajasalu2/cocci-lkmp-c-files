...
typedef u32;
@@
 struct at91sam9x5_clk_usb {  struct clk_hw hw ;  struct regmap * regmap ;  u32 usbs_mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct at91rm9200_clk_usb {  struct clk_hw hw ;  struct regmap * regmap ;  u32 divisors [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct at91rm9200_clk_usb * cocci_id@p ;
...
position p;
@@
 struct at91sam9x5_clk_usb * cocci_id@p ;
