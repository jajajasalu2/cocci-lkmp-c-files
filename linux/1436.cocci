...
position p;
@@
 void cocci_id@p ( struct gr_udc * dev , struct gr_request * req ) ;
...
typedef u8,u32;
@@
 union {  struct usb_ctrlrequest ctrl ;  u8 raw [ 8 ] ;  u32 word [ 2 ] ; } cocci_id@p ;
