...
position p;
@@
 const struct wfx_scan_params * cocci_id@p ;
...
position p;
@@
 struct hif_req_set_bss_params * cocci_id@p ;
...
position p;
@@
 struct hif_ssid_def cocci_id@p ;
...
position p;
@@
 struct hif_req_map_link * cocci_id@p ;
...
position p;
@@
 struct hif_cnf_read_mib cocci_id@p ;
...
position p;
@@
 struct hif_req_start * cocci_id@p ;
...
position p;
@@
 struct hif_req_join * cocci_id@p ;
...
position p;
@@
 struct hif_req_add_key * cocci_id@p ;
...
position p;
@@
 const struct hif_req_start * cocci_id@p ;
...
position p;
@@
 struct hif_req_update_ie cocci_id@p ;
...
position p;
@@
 struct hif_req_start_scan * cocci_id@p ;
...
position p;
@@
 struct hif_req_configuration cocci_id@p ;
...
position p;
@@
 struct hif_req_beacon_transmit * cocci_id@p ;
...
position p;
@@
 struct hif_req_write_mib * cocci_id@p ;
...
position p;
@@
 const struct hif_ie_flags * cocci_id@p ;
...
position p;
@@
 struct hif_req_sl_exchange_pub_keys * cocci_id@p ;
...
position p;
@@
 const struct hif_req_join * cocci_id@p ;
...
position p;
@@
 struct hif_req_reset * cocci_id@p ;
...
position p;
@@
 struct hif_ie_flags cocci_id@p ;
...
position p;
@@
 struct hif_req_set_sl_mac_key * cocci_id@p ;
...
position p;
@@
 const struct hif_req_set_bss_params * cocci_id@p ;
...
position p;
@@
 const struct hif_req_edca_queue_params * cocci_id@p ;
...
position p;
@@
 struct hif_req_read_mib * cocci_id@p ;
...
position p;
@@
 struct hif_req_sl_configure * cocci_id@p ;
...
position p;
@@
 struct hif_req_remove_key * cocci_id@p ;
...
position p;
@@
 struct hif_map_link_flags * cocci_id@p ;
...
position p;
@@
 struct hif_req_edca_queue_params * cocci_id@p ;
...
position p;
@@
 struct hif_req_set_pm_mode * cocci_id@p ;
...
position p;
@@
 const struct hif_req_add_key * cocci_id@p ;
...
position p;
@@
 const struct hif_req_set_pm_mode * cocci_id@p ;
