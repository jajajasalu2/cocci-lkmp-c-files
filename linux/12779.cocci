...
position p;
@@
 struct hv_hotadd_state {  struct list_head list ;  unsigned long start_pfn ;  unsigned long covered_start_pfn ;  unsigned long covered_end_pfn ;  unsigned long ha_end_pfn ;  unsigned long end_pfn ;  struct list_head gap_list ; } cocci_id@p ;
...
position p;
@@
 struct memory_notify * cocci_id@p ;
...
position p;
@@
 struct dm_version_response * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hv_dynmem_device * dm ) ;
...
position p;
@@
 struct hv_dynmem_device * cocci_id@p ;
...
position p;
@@
 union dm_mem_page_range cocci_id@p ;
...
position p;
@@
 struct dm_capabilities cocci_id@p ;
...
typedef __u32,__u8;
@@
 struct dm_info_msg {  struct dm_header hdr ;  __u32 reserved ;  __u32 info_size ;  __u8 info [ ] ; } cocci_id@p ;
...
position p;
@@
 struct hv_hotadd_gap cocci_id@p ;
...
position p;
@@
 struct dm_info_header * cocci_id@p ;
...
position p;
@@
 struct dm_unballoon_request * cocci_id@p ;
...
position p;
@@
 struct hv_hotadd_gap {  struct list_head list ;  unsigned long start_pfn ;  unsigned long end_pfn ; } cocci_id@p ;
...
position p;
@@
 struct dm_balloon_response * cocci_id@p ;
...
position p;
@@
 enum hv_dm_state { DM_INITIALIZING = 0 , DM_INITIALIZED , DM_BALLOON_UP , DM_BALLOON_DOWN , DM_HOT_ADD , DM_INIT_ERROR , } cocci_id@p ;
...
typedef __u32;
@@
 struct balloon_state {  __u32 num_pages ;  struct work_struct wrk ; } cocci_id@p ;
...
position p;
@@
 struct dm_unballoon_response cocci_id@p ;
...
position p;
@@
 struct dm_hot_add_response cocci_id@p ;
...
position p;
@@
 enum dm_info_type { INFO_TYPE_MAX_PAGE_CNT = 0 , MAX_INFO_TYPE , } cocci_id@p ;
...
position p;
@@
 struct hot_add_wrk {  union dm_mem_page_range ha_page_range ;  union dm_mem_page_range ha_region_range ;  struct work_struct wrk ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,__u32,spinlock_t;
@@
 struct hv_dynmem_device {  struct hv_device * dev ;  enum hv_dm_state state ;  struct completion host_event ;  struct completion config_event ;  unsigned int num_pages_ballooned ;  unsigned int num_pages_onlined ;  unsigned int num_pages_added ;  struct balloon_state balloon_wrk ;  struct hot_add_wrk ha_wrk ;  bool host_specified_ha_region ;  struct completion ol_waitevent ;  bool ha_waiting ;  struct task_struct * thread ;  spinlock_t ha_lock ;  struct list_head ha_region_list ;  __u32 next_version ;  __u32 version ; } cocci_id@p ;
...
position p;
@@
 struct dm_capabilities_resp_msg * cocci_id@p ;
...
position p;
@@
 struct hv_hotadd_state cocci_id@p ;
...
position p;
@@
 struct dm_version_request cocci_id@p ;
