...
position p;
@@
 struct mhp_restrictions * cocci_id@p ;
...
position p;
@@
 struct mem_section_usage * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef online_page_callback_t;
@@
 online_page_callback_t cocci_id@p ;
