...
position p;
@@
 struct bpf_sockopt_kern * cocci_id@p ;
...
position p;
@@
 struct bpf_cgroup_dev_ctx cocci_id@p ;
...
position p;
@@
 struct bpf_cgroup_storage * cocci_id@p [ MAX_BPF_CGROUP_STORAGE_TYPE ] ;
...
position p;
@@
 const struct ctl_dir * cocci_id@p ;
...
position p;
@@
 struct bpf_prog_list * cocci_id@p ;
...
position p;
@@
 struct bpf_prog_array * cocci_id@p [ NR ] ;
...
position p;
@@
 struct bpf_sysctl_kern cocci_id@p ;
