...
position p;
@@
 struct iwl_tx_ant_config_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_ct_kill_throttling_config cocci_id@p ;
...
position p;
@@
 struct iwl_tx_beacon_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_ct_kill_config cocci_id@p ;
...
position p;
@@
 struct iwl_calib_cfg_cmd cocci_id@p ;
