...
position p;
@@
 struct nlattr * cocci_id@p [ IWPM_NLA_RREG_PID_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IWPM_NLA_RMANAGE_MAPPING_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IWPM_NLA_ERR_MAX ] ;
...
position p;
@@
 struct iwpm_remote_info cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IWPM_NLA_RQUERY_MAPPING_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IWPM_NLA_MAPINFO_NUM_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IWPM_NLA_MAPINFO_REQ_MAX ] ;
...
position p;
@@
 struct iwpm_sa_data * cocci_id@p ;
...
position p;
@@
 struct iwpm_dev_data * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IWPM_NLA_RMANAGE_MAPPING_MAX ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IWPM_NLA_ERR_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IWPM_NLA_HELLO_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IWPM_NLA_RQUERY_MAPPING_MAX ] ;
...
position p;
@@
 struct iwpm_nlmsg_request * cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ IWPM_ULIBNAME_SIZE ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IWPM_NLA_MAPINFO_REQ_MAX ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IWPM_NLA_HELLO_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IWPM_NLA_RREG_PID_MAX ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IWPM_NLA_MAPINFO_NUM_MAX ] ;
