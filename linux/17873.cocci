...
position p;
@@
 enum jump_type { none , jabs , ind , ret , reg , relb , relw , } cocci_id@p ;
...
position p;
@@
 const struct optable cocci_id@p [ ] ;
...
position p;
@@
 const struct optables_list {  const struct optable * ptr ;  int size ; } cocci_id@p [ ] ;
