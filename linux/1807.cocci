...
typedef u8,ktime_t;
@@
 struct vcnl4200_channel {  u8 reg ;  ktime_t last_measurement ;  ktime_t sampling_rate ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct vcnl4000_data {  struct i2c_client * client ;  enum vcnl4000_device_ids id ;  int rev ;  int al_scale ;  const struct vcnl4000_chip_spec * chip_spec ;  struct mutex vcnl4000_lock ;  struct vcnl4200_channel vcnl4200_al ;  struct vcnl4200_channel vcnl4200_ps ; } cocci_id@p ;
...
position p;
@@
 struct vcnl4000_chip_spec {  const char * prod ;  int ( * init ) ( struct vcnl4000_data * data ) ;  int ( * measure_light ) ( struct vcnl4000_data * data , int * val ) ;  int ( * measure_proximity ) ( struct vcnl4000_data * data , int * val ) ; } cocci_id@p ;
...
position p;
@@
 enum vcnl4000_device_ids { VCNL4000 , VCNL4010 , VCNL4040 , VCNL4200 , } cocci_id@p ;
...
position p;
@@
 const struct vcnl4000_chip_spec cocci_id@p [ ] ;
...
position p;
@@
 struct vcnl4200_channel * cocci_id@p ;
...
position p;
@@
 struct vcnl4000_data * cocci_id@p ;
