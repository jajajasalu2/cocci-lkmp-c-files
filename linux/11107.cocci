...
position p;
@@
 struct wm_range_table_entry * cocci_id@p ;
...
position p;
@@
 struct dcn21_resource_pool * cocci_id@p ;
...
position p;
@@
 enum dcn20_clk_src_array_id { DCN20_CLK_SRC_PLL0 , DCN20_CLK_SRC_PLL1 , DCN20_CLK_SRC_TOTAL_DCN21 , } cocci_id@p ;
...
position p;
@@
 const struct dcn21_dmcub_registers cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dc * dc , struct resource_context * res_ctx , display_e2e_pipe_params_st * pipes ) ;
...
position p;
@@
 const struct dcn21_dmcub_shift cocci_id@p ;
...
position p;
@@
 struct clk_bw_params * cocci_id@p ;
...
position p;
@@
 struct dcn_watermarks * cocci_id@p ;
...
position p;
@@
 struct dcn21_link_encoder * cocci_id@p ;
...
position p;
@@
 const struct dcn21_dmcub_mask cocci_id@p ;
