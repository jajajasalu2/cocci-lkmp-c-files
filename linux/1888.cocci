...
position p;
@@
 const struct adc5_channels * cocci_id@p ;
...
position p;
@@
 const struct adc5_channels cocci_id@p [ ADC5_MAX_CHANNEL ] ;
...
position p;
@@
 struct adc5_channel_prop {  unsigned int channel ;  enum adc5_cal_method cal_method ;  enum adc5_cal_val cal_val ;  unsigned int decimation ;  unsigned int prescale ;  unsigned int hw_settle_time ;  unsigned int avg_samples ;  enum vadc_scale_fn_type scale_fn_type ;  const char * datasheet_name ; } cocci_id@p ;
...
position p;
@@
 const struct vadc_prescale_ratio cocci_id@p [ ] ;
...
position p;
@@
 enum adc5_cal_method { ADC5_NO_CAL = 0 , ADC5_RATIOMETRIC_CAL , ADC5_ABSOLUTE_CAL , } cocci_id@p ;
...
position p;
@@
 struct adc5_channels {  const char * datasheet_name ;  unsigned int prescale_index ;  enum iio_chan_type type ;  long info_mask ;  enum vadc_scale_fn_type scale_fn_type ; } cocci_id@p ;
...
position p;
@@
 enum adc5_cal_val { ADC5_TIMER_CAL = 0 , ADC5_NEW_CAL , } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ VADC_HW_SETTLE_SAMPLES_MAX ] ;
...
typedef bool,u16;
@@
 struct adc5_chip {  struct regmap * regmap ;  struct device * dev ;  u16 base ;  unsigned int nchannels ;  struct adc5_channel_prop * chan_props ;  struct iio_chan_spec * iio_chans ;  bool poll_eoc ;  struct completion complete ;  struct mutex lock ;  const struct adc5_data * data ; } cocci_id@p ;
...
position p;
@@
 const struct adc5_data cocci_id@p ;
...
position p;
@@
 struct adc5_channel_prop cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ADC5_DECIMATION_SAMPLES_MAX ] ;
