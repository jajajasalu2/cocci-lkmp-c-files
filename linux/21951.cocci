...
position p;
@@
 struct kunit_binary_ptr_assert * cocci_id@p ;
...
position p;
@@
 struct kunit_binary_str_assert cocci_id@p ;
...
position p;
@@
 struct kunit_binary_assert cocci_id@p ;
...
position p;
@@
 struct kunit_unary_assert cocci_id@p ;
...
position p;
@@
 struct kunit_ptr_not_err_assert * cocci_id@p ;
...
position p;
@@
 const struct kunit_assert * cocci_id@p ;
