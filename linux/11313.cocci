...
position p;
@@
 struct sis_memblock * cocci_id@p ;
...
position p;
@@
 struct sis_memblock {  struct drm_mm_node mm_node ;  struct sis_memreq req ;  struct list_head owner_list ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_sis_mem_t;
@@
 drm_sis_mem_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_sis_fb_t;
@@
 drm_sis_fb_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_sis_agp_t;
@@
 drm_sis_agp_t * cocci_id@p ;
...
position p;
@@
 struct sis_file_private * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_sis_private_t;
@@
 drm_sis_private_t * cocci_id@p ;
