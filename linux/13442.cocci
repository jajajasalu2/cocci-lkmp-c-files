...
typedef u32;
@@
 const struct {  u32 width ;  u32 height ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct framerate_info cocci_id@p [ ] ;
...
position p;
@@
 struct framerate_info {  int value ;  struct v4l2_fract period ; } cocci_id@p ;
