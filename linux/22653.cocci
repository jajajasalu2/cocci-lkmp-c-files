...
position p;
@@
 enum { DEPTH_NONE = 0 , DEPTH_16 = 1 , DEPTH_24 = 2 , DEPTH_32 = 3 , } cocci_id@p ;
...
position p;
@@
 enum { SAMPLERATE_44100 = 0 , SAMPLERATE_48000 = 1 , SAMPLERATE_96000 = 2 , SAMPLERATE_192000 = 3 , SAMPLERATE_88200 = 4 , SAMPLERATE_INVALID = 0xff , } cocci_id@p ;
...
position p;
@@
 struct snd_usb_caiaqdev cocci_id@p ;
...
position p;
@@
 struct caiaq_device_spec cocci_id@p ;
