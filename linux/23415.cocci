...
position p;
@@
 struct wm8804_priv {  struct device * dev ;  struct regmap * regmap ;  struct regulator_bulk_data supplies [ WM8804_NUM_SUPPLIES ] ;  struct notifier_block disable_nb [ WM8804_NUM_SUPPLIES ] ;  int mclk_div ;  struct gpio_desc * reset ;  int aif_pwr ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8804_NUM_SUPPLIES ] ;
...
typedef u32;
@@
 struct pll_div {  u32 prescale : 1 ;  u32 mclkdiv : 1 ;  u32 freqmode : 2 ;  u32 n : 4 ;  u32 k : 22 ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned int div ;  unsigned int freqmode ;  unsigned int mclkdiv ; } cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct snd_soc_dapm_widget * w , struct snd_kcontrol * kcontrol , int event ) ;
