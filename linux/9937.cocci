...
position p;
@@
 const enum carl9170_cmd_oids cocci_id@p ;
...
position p;
@@
 struct carl9170_tally_rsp cocci_id@p ;
...
position p;
@@
 struct carl9170_psm cocci_id@p ;
...
position p;
@@
 struct carl9170_cmd_head cocci_id@p ;
...
position p;
@@
 struct carl9170_bcn_ctrl_cmd cocci_id@p ;
...
position p;
@@
 struct carl9170_cmd * cocci_id@p ;
