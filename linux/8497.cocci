...
position p;
@@
 struct bfa_cee_attr * cocci_id@p ;
...
position p;
@@
 struct bfa_cee_lldp_cfg * cocci_id@p ;
...
position p;
@@
 struct bfi_cee_get_rsp * cocci_id@p ;
...
position p;
@@
 struct bfa_cee_stats cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_cee_lldp_cfg * lldp_cfg ) ;
...
position p;
@@
 struct bfi_cee_get_req * cocci_id@p ;
