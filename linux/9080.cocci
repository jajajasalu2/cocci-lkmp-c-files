...
symbol cocci_id;
position p;
typedef mlx5_devcom_event_handler_t;
@@
 mlx5_devcom_event_handler_t cocci_id@p ;
...
position p;
@@
 enum mlx5_devcom_components cocci_id@p ;
...
position p;
@@
 struct mlx5_devcom_list {  struct list_head list ;  struct mlx5_devcom_component components [ MLX5_DEVCOM_NUM_COMPONENTS ] ;  struct mlx5_core_dev * devs [ MLX5_MAX_PORTS ] ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_devcom_component * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,mlx5_devcom_event_handler_t;
@@
 struct mlx5_devcom_component {  struct {  void * data ; } device [ MLX5_MAX_PORTS ] ;  mlx5_devcom_event_handler_t handler ;  struct rw_semaphore sem ;  bool paired ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_devcom_list * cocci_id@p ;
...
position p;
@@
 struct mlx5_devcom {  struct mlx5_devcom_list * priv ;  int idx ; } cocci_id@p ;
