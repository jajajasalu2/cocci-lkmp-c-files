...
typedef __be32;
@@
 struct fcrypt_ctx {  __be32 sched [ ROUNDS ] ; } cocci_id@p ;
...
position p;
@@
 const struct fcrypt_ctx * cocci_id@p ;
...
typedef u8,__be32;
@@
 union lc4 {  __be32 l ;  u8 c [ 4 ] ; } cocci_id@p ;
