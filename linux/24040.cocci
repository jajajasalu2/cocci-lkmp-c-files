...
position p;
@@
 const struct nla_policy cocci_id@p [ OVS_BAND_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct dp_meter_band * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ OVS_METER_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ OVS_BAND_ATTR_MAX + 1 ] ;
