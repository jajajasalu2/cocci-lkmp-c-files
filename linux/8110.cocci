...
position p;
@@
 struct tcan4x5x_priv * cocci_id@p ;
...
position p;
@@
 struct regmap_async * cocci_id@p ;
...
position p;
@@
 struct tcan4x5x_priv {  struct regmap * regmap ;  struct spi_device * spi ;  struct m_can_classdev * mcan_dev ;  struct gpio_desc * reset_gpio ;  struct gpio_desc * device_wake_gpio ;  struct gpio_desc * device_state_gpio ;  struct regulator * power ;  int mram_start ;  int reg_offset ; } cocci_id@p ;
