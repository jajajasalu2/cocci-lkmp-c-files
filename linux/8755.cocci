...
position p;
@@
 struct qlcnic_info_le cocci_id@p ;
...
position p;
@@
 struct qlcnic_hostrq_rds_ring cocci_id@p ;
...
position p;
@@
 struct qlcnic_cardrsp_tx_ctx cocci_id@p ;
...
position p;
@@
 struct qlcnic_mac_statistics * cocci_id@p ;
...
position p;
@@
 struct qlcnic_esw_stats_le * cocci_id@p ;
...
position p;
@@
 struct qlcnic_pci_info_le cocci_id@p ;
...
position p;
@@
 const struct qlcnic_info_le * cocci_id@p ;
...
position p;
@@
 struct qlcnic_cardrsp_sds_ring * cocci_id@p ;
...
position p;
@@
 struct qlcnic_hostrq_sds_ring * cocci_id@p ;
...
position p;
@@
 struct qlcnic_mac_statistics_le * cocci_id@p ;
...
position p;
@@
 struct qlcnic_hostrq_cds_ring * cocci_id@p ;
...
position p;
@@
 struct qlcnic_hostrq_rx_ctx cocci_id@p ;
...
position p;
@@
 struct qlcnic_hostrq_tx_ctx * cocci_id@p ;
...
position p;
@@
 struct qlcnic_cardrsp_rx_ctx cocci_id@p ;
...
position p;
@@
 struct qlcnic_cardrsp_rds_ring * cocci_id@p ;
