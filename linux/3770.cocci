...
position p;
@@
 struct ccp_sha_engine * cocci_id@p ;
...
position p;
@@
 struct ccp_dm_workarea * cocci_id@p ;
...
position p;
@@
 struct ccp_aes_engine * cocci_id@p ;
...
position p;
@@
 struct ccp_passthru_nomap_engine * cocci_id@p ;
...
position p;
@@
 struct ccp_ecc_engine * cocci_id@p ;
...
position p;
@@
 struct ccp_passthru_engine * cocci_id@p ;
...
position p;
@@
 struct ccp_xts_aes_engine * cocci_id@p ;
...
position p;
@@
 struct ccp_sg_workarea * cocci_id@p ;
...
position p;
@@
 struct ccp_rsa_engine * cocci_id@p ;
...
position p;
@@
 struct ccp_des3_engine * cocci_id@p ;
