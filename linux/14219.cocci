...
position p;
@@
 struct hfi_msg_session_fbd_compressed_pkt cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_empty_buffer_done_pkt cocci_id@p ;
...
position p;
@@
 struct hfi_msg_sys_init_done_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_buffer_requirements * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_start_done_pkt cocci_id@p ;
...
position p;
@@
 struct hfi_msg_sys_release_resource_done_pkt cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_property_info_pkt cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_init_done_pkt cocci_id@p ;
...
position p;
@@
 struct hfi_bit_depth * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_release_buffers_done_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_load_resources_done_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_extradata_input_crop * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_sys_session_abort_done_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_stop_done_pkt cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_get_sequence_hdr_done_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_pic_struct * cocci_id@p ;
...
position p;
@@
 const struct hfi_done_handler * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_sys_property_info_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_event_data cocci_id@p ;
...
typedef bool,u32;
@@
 struct hfi_done_handler {  u32 pkt ;  u32 pkt_sz ;  u32 pkt_sz2 ;  void ( * done ) ( struct venus_core * , struct venus_inst * , void * ) ;  bool is_sys_pkt ; } cocci_id@p ;
...
position p;
@@
 struct hfi_msg_sys_pc_prep_done_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_fbd_uncompressed_plane0_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_event_release_buffer_ref_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_end_done_pkt cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_release_resources_done_pkt cocci_id@p ;
...
position p;
@@
 union hfi_get_property * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_sys_ping_ack_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_session_flush_done_pkt cocci_id@p ;
...
position p;
@@
 struct hfi_colour_space * cocci_id@p ;
...
position p;
@@
 struct hfi_msg_sys_idle_pkt cocci_id@p ;
