...
position p;
@@
 struct nfs_diropargs cocci_id@p ;
...
position p;
@@
 struct nfs_createdata * cocci_id@p ;
...
position p;
@@
 const struct nfs_createdata * cocci_id@p ;
...
position p;
@@
 struct nfs_sattrargs cocci_id@p ;
...
position p;
@@
 struct nfs_symlinkargs cocci_id@p ;
...
position p;
@@
 struct nfs_createdata {  struct nfs_createargs arg ;  struct nfs_diropok res ;  struct nfs_fh fhandle ;  struct nfs_fattr fattr ; } cocci_id@p ;
...
position p;
@@
 struct nfs_readdirargs cocci_id@p ;
...
position p;
@@
 struct nfs_readlinkargs cocci_id@p ;
...
position p;
@@
 struct nfs_linkargs cocci_id@p ;
