...
position p;
@@
 struct base_eep_header * cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_sta * cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_cap_target cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_target_rate * cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_vif * cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_target_aggr cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_target_vif cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_target_rate_mask cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_priv cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_target_sta cocci_id@p ;
