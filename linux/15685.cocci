...
position p;
@@
 struct dpsw_link_state * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_set_irq_mask * cocci_id@p ;
...
position p;
@@
 enum dpsw_fdb_learning_mode cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_if_set_flooding * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_open * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_fdb_set_learning_mode * cocci_id@p ;
...
position p;
@@
 struct dpsw_rsp_if_get_link_state * cocci_id@p ;
...
position p;
@@
 struct dpsw_tci_cfg * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_set_irq_enable * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_if_get_link_state * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_if_set_tci * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_get_irq_status * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_fdb_multicast_op * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_if_set_stp * cocci_id@p ;
...
position p;
@@
 const struct dpsw_stp_cfg * cocci_id@p ;
...
position p;
@@
 struct dpsw_rsp_if_get_tci * cocci_id@p ;
...
position p;
@@
 struct dpsw_link_cfg * cocci_id@p ;
...
position p;
@@
 struct dpsw_rsp_fdb_dump * cocci_id@p ;
...
position p;
@@
 struct dpsw_rsp_get_attr * cocci_id@p ;
...
position p;
@@
 const struct dpsw_fdb_multicast_cfg * cocci_id@p ;
...
position p;
@@
 struct dpsw_rsp_get_irq_status * cocci_id@p ;
...
position p;
@@
 struct dpsw_rsp_if_get_counter * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_if_set_max_frame_length * cocci_id@p ;
...
position p;
@@
 const struct dpsw_vlan_if_cfg * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_if_set_broadcast * cocci_id@p ;
...
position p;
@@
 struct dpsw_vlan_add * cocci_id@p ;
...
position p;
@@
 const struct dpsw_vlan_cfg * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_if_get_counter * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_if_get_tci * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_fdb_unicast_op * cocci_id@p ;
...
position p;
@@
 const struct dpsw_fdb_unicast_cfg * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_clear_irq_status * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_fdb_dump * cocci_id@p ;
...
position p;
@@
 const struct dpsw_tci_cfg * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_vlan_remove * cocci_id@p ;
...
position p;
@@
 struct dpsw_rsp_get_api_version * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_if_set_link_cfg * cocci_id@p ;
...
position p;
@@
 struct dpsw_cmd_vlan_manage_if * cocci_id@p ;
