...
position p;
@@
 struct kmem_cache_node * cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ SHRINK_PROMOTE_MAX ] ;
...
position p;
@@
 const struct kset_uevent_ops cocci_id@p ;
...
typedef nodemask_t;
@@
 struct location {  unsigned long count ;  unsigned long addr ;  long long sum_time ;  long min_time ;  long max_time ;  long min_pid ;  long max_pid ; 
	 DECLARE_BITMAP ( cpus , NR_CPUS ) 
		 ;  nodemask_t nodes ; } cocci_id@p ;
...
position p;
@@
 enum track_item { TRACK_ALLOC , TRACK_FREE , } cocci_id@p ;
...
position p;
@@
 enum slab_modes { M_NONE , M_PARTIAL , M_FULL , M_FREE , } cocci_id@p ;
...
position p;
@@
 struct kmem_cache_cpu * * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kmem_cache * s , struct page * page , int drain ) ;
...
position p;
@@
 int cocci_id@p ( struct kmem_cache * ) ;
...
position p;
@@
 struct saved_alias {  struct kmem_cache * s ;  const char * name ;  struct saved_alias * next ; } cocci_id@p ;
...
position p;
@@
 struct kmem_cache_order_objects cocci_id@p ;
...
position p;
@@
 struct detached_freelist cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct kmem_cache * , const char * ) ;
...
position p;
@@
 const struct kmem_cache * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef slab_flags_t;
@@
 slab_flags_t cocci_id@p ;
...
position p;
@@
 struct slab_attribute * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kmem_cache * s ) ;
...
position p;
@@
 struct detached_freelist {  struct page * page ;  void * tail ;  void * freelist ;  int cnt ;  struct kmem_cache * s ; } cocci_id@p ;
...
position p;
@@
 struct loc_track {  unsigned long max ;  unsigned long count ;  struct location * loc ; } cocci_id@p ;
...
position p;
@@
 enum slab_stat_type { SL_ALL , SL_PARTIAL , SL_CPU , SL_OBJECTS , SL_TOTAL , } cocci_id@p ;
