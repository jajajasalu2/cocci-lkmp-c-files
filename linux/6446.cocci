...
position p;
@@
 struct tps_pmic {  struct regulator_dev * rdev [ TPS65023_NUM_REGULATOR ] ;  const struct tps_driver_data * driver_data ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct tps_driver_data * cocci_id@p ;
...
typedef u8;
@@
 struct tps_driver_data {  const struct regulator_desc * desc ;  u8 core_regulator ; } cocci_id@p ;
