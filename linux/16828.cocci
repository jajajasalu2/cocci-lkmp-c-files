...
position p;
@@
 struct palmas_pwron * cocci_id@p ;
...
position p;
@@
 struct palmas_pwron {  struct palmas * palmas ;  struct input_dev * input_dev ;  struct delayed_work input_work ;  int irq ; } cocci_id@p ;
...
typedef u8;
@@
 struct palmas_pwron_config {  u8 long_press_time_val ;  u8 pwron_debounce_val ; } cocci_id@p ;
...
position p;
@@
 struct palmas_pwron_config * cocci_id@p ;
