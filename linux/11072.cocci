...
position p;
@@
 const struct irq_source_info_funcs cocci_id@p ;
...
position p;
@@
 const struct irq_source_info cocci_id@p [ DAL_IRQ_SOURCES_NUMBER ] ;
...
position p;
@@
 const struct irq_service_funcs cocci_id@p ;
...
position p;
@@
 const struct irq_source_info * cocci_id@p ;
