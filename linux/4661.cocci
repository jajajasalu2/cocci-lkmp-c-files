...
position p;
@@
 struct altera_procinfo cocci_id@p ;
...
typedef u8;
@@
 struct altera_procinfo {  char * name ;  u8 attrs ;  struct altera_procinfo * next ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ HEX_LINE_CHARS + 1 ] ;
