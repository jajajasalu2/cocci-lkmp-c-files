...
position p;
@@
 const struct uprobe_xol_ops cocci_id@p ;
...
typedef u32;
@@
 volatile u32 cocci_id@p [ 256 / 32 ] ;
...
typedef bool;
@@
 struct uprobe_xol_ops {  bool ( * emulate ) ( struct arch_uprobe * , struct pt_regs * ) ;  int ( * pre_xol ) ( struct arch_uprobe * , struct pt_regs * ) ;  int ( * post_xol ) ( struct arch_uprobe * , struct pt_regs * ) ;  void ( * abort ) ( struct arch_uprobe * , struct pt_regs * ) ; } cocci_id@p ;
