...
position p;
@@
 struct ux500_musb_board_data * cocci_id@p ;
...
position p;
@@
 struct ux500_dma_controller * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct ux500_dma_controller {  struct dma_controller controller ;  struct ux500_dma_channel rx_channel [ UX500_MUSB_DMA_NUM_RX_TX_CHANNELS ] ;  struct ux500_dma_channel tx_channel [ UX500_MUSB_DMA_NUM_RX_TX_CHANNELS ] ;  void * private_data ;  dma_addr_t phy_base ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,dma_cookie_t;
@@
 struct ux500_dma_channel {  struct dma_channel channel ;  struct ux500_dma_controller * controller ;  struct musb_hw_ep * hw_ep ;  struct dma_chan * dma_chan ;  unsigned int cur_len ;  dma_cookie_t cookie ;  u8 ch_num ;  u8 is_tx ;  u8 is_allocated ; } cocci_id@p ;
...
position p;
@@
 struct ux500_dma_channel * cocci_id@p ;
