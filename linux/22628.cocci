...
position p;
@@
 struct usb_desc_validator cocci_id@p [ ] ;
...
position p;
@@
 const struct usb_desc_validator * cocci_id@p ;
...
position p;
@@
 const struct uac_processing_unit_descriptor * cocci_id@p ;
...
position p;
@@
 struct uac3_ac_header_descriptor cocci_id@p ;
...
position p;
@@
 struct uac3_clock_multiplier_descriptor cocci_id@p ;
...
position p;
@@
 const struct usb_midi_out_jack_descriptor * cocci_id@p ;
...
typedef bool;
@@
 struct usb_desc_validator {  unsigned char protocol ;  unsigned char type ;  bool ( * func ) ( const void * p , const struct usb_desc_validator * v ) ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 const struct uac_feature_unit_descriptor * cocci_id@p ;
...
position p;
@@
 const struct uac_selector_unit_descriptor * cocci_id@p ;
...
position p;
@@
 const struct uac1_ac_header_descriptor * cocci_id@p ;
...
position p;
@@
 struct uac_clock_multiplier_descriptor cocci_id@p ;
...
position p;
@@
 const struct uac3_feature_unit_descriptor * cocci_id@p ;
...
position p;
@@
 const struct uac2_feature_unit_descriptor * cocci_id@p ;
...
position p;
@@
 const struct uac_mixer_unit_descriptor * cocci_id@p ;
