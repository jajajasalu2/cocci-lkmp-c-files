...
typedef int64_t;
@@
 struct {  __le16 values [ DLN2_ADC_MAX_CHANNELS ] ;  int64_t timestamp_space ; } cocci_id@p ;
...
position p;
@@
 struct dln2_adc_get_all_vals {  __le16 channel_mask ;  __le16 values [ DLN2_ADC_MAX_CHANNELS ] ; } cocci_id@p ;
...
position p;
@@
 struct dln2_adc_get_all_vals cocci_id@p ;
...
position p;
@@
 struct dln2_adc_port_chan cocci_id@p ;
...
typedef u8;
@@
 struct dln2_adc_port_chan {  u8 port ;  u8 chan ; } cocci_id@p ;
...
position p;
@@
 struct dln2_adc_demux_table {  unsigned int from ;  unsigned int to ;  unsigned int length ; } cocci_id@p ;
...
position p;
@@
 struct dln2_adc_demux_table * cocci_id@p ;
...
position p;
@@
 const struct dln2_adc_demux_table * cocci_id@p ;
