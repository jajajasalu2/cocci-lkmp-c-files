...
position p;
@@
 struct dvbsky_state cocci_id@p ;
...
typedef u8;
@@
 struct dvbsky_state {  u8 ibuf [ DVBSKY_BUF_LEN ] ;  u8 obuf [ DVBSKY_BUF_LEN ] ;  u8 last_lock ;  struct i2c_client * i2c_client_demod ;  struct i2c_client * i2c_client_tuner ;  struct i2c_client * i2c_client_ci ;  int ( * fe_set_voltage ) ( struct dvb_frontend * fe , enum fe_sec_voltage voltage ) ;  int ( * fe_read_status ) ( struct dvb_frontend * fe , enum fe_status * status ) ; } cocci_id@p ;
