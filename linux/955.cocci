...
typedef u8;
@@
 struct dataflash {  u8 command [ 4 ] ;  char name [ 24 ] ;  unsigned short page_offset ;  unsigned int page_size ;  struct mutex lock ;  struct spi_device * spi ;  struct mtd_info mtd ; } cocci_id@p ;
