...
position p;
@@
 volatile struct lance_init_block * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ RX_RING_SIZE + 1 ] ;
...
position p;
@@
 struct lance_init_block {  unsigned short mode ;  unsigned char phys_addr [ 6 ] ;  unsigned filter [ 2 ] ;  unsigned short rx_ptr ;  unsigned short rx_len ;  unsigned short tx_ptr ;  unsigned short tx_len ;  struct lance_rx_desc brx_ring [ RX_RING_SIZE ] ;  struct lance_tx_desc btx_ring [ TX_RING_SIZE ] ;  char rx_buf [ RX_RING_SIZE ] [ RX_BUFF_SIZE ] ;  char tx_buf [ TX_RING_SIZE ] [ TX_BUFF_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct zorro_dev * z , const struct zorro_device_id * ent ) ;
...
position p;
@@
 volatile struct lance_tx_desc * cocci_id@p ;
...
position p;
@@
 volatile struct lance_rx_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct zorro_dev * z ) ;
