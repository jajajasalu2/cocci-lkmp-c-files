...
position p;
@@
 struct geni_i2c_dev * cocci_id@p ;
...
position p;
@@
 const struct geni_i2c_err_log cocci_id@p [ ] ;
...
position p;
@@
 const struct geni_i2c_clk_fld * cocci_id@p ;
...
typedef u8,u32;
@@
 struct geni_i2c_clk_fld {  u32 clk_freq_out ;  u8 clk_div ;  u8 t_high_cnt ;  u8 t_low_cnt ;  u8 t_cycle_cnt ; } cocci_id@p ;
...
@@
 struct geni_i2c_dev {  struct geni_se se ;  u32 tx_wm ;  int irq ;  int err ;  struct i2c_adapter adap ;  struct completion done ;  struct i2c_msg * cur ;  int cur_wr ;  int cur_rd ;  spinlock_t lock ;  u32 clk_freq_out ;  const struct geni_i2c_clk_fld * clk_fld ;  int suspended ; } cocci_id@p ;
...
position p;
@@
 struct geni_i2c_err_log {  int err ;  const char * msg ; } cocci_id@p ;
...
position p;
@@
 enum geni_i2c_err_code { GP_IRQ0 , NACK , GP_IRQ2 , BUS_PROTO , ARB_LOST , GP_IRQ5 , GENI_OVERRUN , GENI_ILLEGAL_CMD , GENI_ABORT_DONE , GENI_TIMEOUT , } cocci_id@p ;
