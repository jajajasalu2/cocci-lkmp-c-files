...
position p;
@@
 enum control_action cocci_id@p ;
...
position p;
@@
 enum control_action { CTL_READ , CTL_WRITE , } cocci_id@p ;
...
position p;
@@
 enum control_attribute { CTL_MIN = 0x02 , CTL_MAX = 0x03 , CTL_CURRENT = 0x10 , } cocci_id@p ;
...
position p;
@@
 enum control_attribute cocci_id@p ;
...
typedef u8,s16,bool;
@@
 struct fw_spkr {  bool mute ;  s16 volume [ 6 ] ;  s16 volume_min ;  s16 volume_max ;  unsigned int mixer_channels ;  u8 mute_fb_id ;  u8 volume_fb_id ; } cocci_id@p ;
