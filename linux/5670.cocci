...
position p;
@@
 struct cpcap_time {  int day ;  int tod1 ;  int tod2 ; } cocci_id@p ;
...
typedef bool,u16;
@@
 struct cpcap_rtc {  struct regmap * regmap ;  struct rtc_device * rtc_dev ;  u16 vendor ;  int alarm_irq ;  bool alarm_enabled ;  int update_irq ;  bool update_enabled ; } cocci_id@p ;
