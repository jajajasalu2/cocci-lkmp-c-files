...
position p;
@@
 struct sh_mobile_i2c_data cocci_id@p ;
...
position p;
@@
 const struct sh_mobile_dt_config * cocci_id@p ;
...
position p;
@@
 enum sh_mobile_i2c_op cocci_id@p ;
...
position p;
@@
 enum sh_mobile_i2c_op { OP_START = 0 , OP_TX_FIRST , OP_TX , OP_TX_STOP , OP_TX_TO_RX , OP_RX , OP_RX_STOP , OP_RX_STOP_DATA , } cocci_id@p ;
...
position p;
@@
 struct sh_mobile_dt_config {  int clks_per_count ;  int ( * setup ) ( struct sh_mobile_i2c_data * pd ) ; } cocci_id@p ;
