...
position p;
@@
 struct hfa384x_tx_frame cocci_id@p ;
...
position p;
@@
 struct hfa384x_usbctlx cocci_id@p ;
...
position p;
@@
 struct usbctlx_rrid_completor {  struct usbctlx_completor head ;  const struct hfa384x_usb_rridresp * rridresp ;  void * riddata ;  unsigned int riddatalen ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hfa384x * hw , struct hfa384x_usbctlx * ctlx ) ;
...
position p;
@@
 struct hfa384x_rridresult cocci_id@p ;
...
position p;
@@
 struct p80211_caphdr * cocci_id@p ;
...
position p;
@@
 const struct hfa384x_usbctlx * cocci_id@p ;
...
position p;
@@
 struct usbctlx_cmd_completor * cocci_id@p ;
...
position p;
@@
 struct hfa384x_cmdresult cocci_id@p ;
...
position p;
@@
 struct usbctlx_completor * cocci_id@p ;
...
position p;
@@
 struct p80211_rxmeta * cocci_id@p ;
...
position p;
@@
 union hfa384x_usbin cocci_id@p ;
...
position p;
@@
 struct usbctlx_rmem_completor * cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct hfa384x * hw , u16 page , u16 offset , void * data , unsigned int len ) ;
...
position p;
@@
 struct hfa384x_metacmd * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct wlandevice * wlandev , union hfa384x_usbin * usbin ) ;
...
position p;
@@
 struct hfa384x_usb_rxfrm * cocci_id@p ;
...
position p;
@@
 struct hfa384x_rx_frame * cocci_id@p ;
...
position p;
@@
 struct p80211_metawep * cocci_id@p ;
...
position p;
@@
 const struct hfa384x_usb_statusresp * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ctlx_usercb_t;
@@
 ctlx_usercb_t cocci_id@p ;
...
position p;
@@
 const struct hfa384x_usb_rridresp * cocci_id@p ;
...
typedef u32,u16;
@@
 struct pdaloc {  u32 cardaddr ;  u16 auxctl ; } cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct hfa384x * hw , struct hfa384x_metacmd * cmd ) ;
...
position p;
@@
 void cocci_id@p ( const struct hfa384x_usb_rridresp * rridresp , struct hfa384x_rridresult * result ) ;
...
position p;
@@
 void cocci_id@p ( unsigned long data ) ;
...
position p;
@@
 int cocci_id@p ( const struct hfa384x_usb_statusresp * cmdresp , struct hfa384x_cmdresult * result ) ;
...
position p;
@@
 enum cmd_mode { DOWAIT = 0 , DOASYNC , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ctlx_cmdcb_t;
@@
 ctlx_cmdcb_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct wlandevice * wlandev , struct sk_buff * skb ) ;
...
position p;
@@
 struct usbctlx_completor {  int ( * complete ) ( struct usbctlx_completor * completor ) ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hfa384x * hw , const struct hfa384x_usbctlx * ctlx ) ;
...
position p;
@@
 struct usbctlx_rmem_completor {  struct usbctlx_completor head ;  const struct hfa384x_usb_rmemresp * rmemresp ;  void * data ;  unsigned int len ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hfa384x * hw , struct hfa384x_usbctlx * ctlx ) ;
...
position p;
@@
 struct usbctlx_cmd_completor {  struct usbctlx_completor head ;  const struct hfa384x_usb_statusresp * cmdresp ;  struct hfa384x_cmdresult * result ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hfa384x * hw , struct hfa384x_usbctlx * ctlx , struct usbctlx_completor * completor ) ;
...
position p;
@@
 struct usbctlx_rrid_completor * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hfa384x * hw ) ;
...
position p;
@@
 void cocci_id@p ( struct hfa384x * hw , union hfa384x_usbin * usbin , int urb_status ) ;
...
position p;
@@
 struct hfa384x_usb_rmemresp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct wlandevice * wlandev , struct hfa384x_usb_rxfrm * rxfrm ) ;
...
position p;
@@
 enum USBIN_ACTION { HANDLE , RESUBMIT , ABORT , } cocci_id@p ;
