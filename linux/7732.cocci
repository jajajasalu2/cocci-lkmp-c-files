...
position p;
@@
 const struct ingenic_uart_config cocci_id@p ;
...
position p;
@@
 struct ingenic_uart_data * cocci_id@p ;
...
position p;
@@
 struct ingenic_uart_data {  struct clk * clk_module ;  struct clk * clk_baud ;  int line ; } cocci_id@p ;
...
position p;
@@
 struct ingenic_uart_config {  int tx_loadsz ;  int fifosize ; } cocci_id@p ;
