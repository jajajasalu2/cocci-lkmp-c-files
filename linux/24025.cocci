...
position p;
@@
 struct list_head cocci_id@p [ SOCK_MAX ] ;
...
position p;
@@
 const struct net_offload cocci_id@p ;
...
position p;
@@
 struct net_protocol cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sk_buff * , int ) ;
