...
position p;
@@
 struct sdricoh_host {  struct device * dev ;  struct mmc_host * mmc ;  unsigned char __iomem * iobase ;  struct pci_dev * pci_dev ;  int app_cmd ; } cocci_id@p ;
...
position p;
@@
 struct sdricoh_host * cocci_id@p ;
