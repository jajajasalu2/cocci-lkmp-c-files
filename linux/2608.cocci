...
position p;
@@
 const struct nvmem_device * cocci_id@p ;
...
position p;
@@
 const struct nvmem_cell_info * cocci_id@p ;
...
position p;
@@
 struct nvmem_cell {  const char * name ;  int offset ;  int bytes ;  int bit_offset ;  int nbits ;  struct device_node * np ;  struct nvmem_device * nvmem ;  struct list_head node ; } cocci_id@p ;
