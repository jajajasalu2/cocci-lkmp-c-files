...
position p;
@@
 struct display_head * cocci_id@p ;
...
typedef u64,u32;
@@
 struct gpu_irq {  u32 irq_outlet ;  u32 status ;  u32 mask ;  u32 video_cause ;  u32 graph_cause ;  u32 user_cause ;  u32 res1 ;  u64 res2 ;  u32 reserved [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct gpu_driver_info * cocci_id@p ;
...
typedef u64,u32;
@@
 struct display_head {  u64 be_time_stamp ;  u32 status ;  u32 offset ;  u32 res1 ;  u32 res2 ;  u32 field ;  u32 reserved1 ;  u64 res3 ;  u32 raster ;  u64 vblank_count ;  u32 field_vsync ;  u32 reserved2 ; } cocci_id@p ;
...
position p;
@@
 struct ps3fb_ioctl_res cocci_id@p ;
...
typedef u32;
@@
 struct gpu_driver_info {  u32 version_driver ;  u32 version_gpu ;  u32 memory_size ;  u32 hardware_channel ;  u32 nvcore_frequency ;  u32 memory_frequency ;  u32 reserved [ 1063 ] ;  struct display_head display_head [ 8 ] ;  struct gpu_irq irq ; } cocci_id@p ;
