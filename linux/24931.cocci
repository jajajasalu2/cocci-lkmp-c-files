...
position p;
@@
 struct distr_queue_item * cocci_id@p ;
...
typedef u32;
@@
 struct distr_queue_item {  struct distr_item i ;  u32 dtype ;  u32 node ;  unsigned long expires ;  struct list_head next ; } cocci_id@p ;
