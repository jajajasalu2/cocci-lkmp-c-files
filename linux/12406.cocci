...
position p;
@@
 const struct csc_table cocci_id@p ;
...
position p;
@@
 struct hdmi_video_format cocci_id@p ;
...
position p;
@@
 struct hdmi_audio_dma cocci_id@p ;
...
position p;
@@
 const struct hdmi_config * cocci_id@p ;
...
position p;
@@
 struct snd_cea_861_aud_if * cocci_id@p ;
...
position p;
@@
 struct hdmi_core_data * cocci_id@p ;
...
position p;
@@
 struct hdmi_wp_data * cocci_id@p ;
...
position p;
@@
 struct hdmi_core_audio_config cocci_id@p ;
...
position p;
@@
 const struct hdmi_core_vid_config * cocci_id@p ;
...
position p;
@@
 struct hdmi_core_vid_config cocci_id@p ;
...
position p;
@@
 struct omap_dss_audio * cocci_id@p ;
...
position p;
@@
 struct hdmi_audio_format cocci_id@p ;
