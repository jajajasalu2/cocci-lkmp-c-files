...
position p;
@@
 struct ceph_pool_perm cocci_id@p ;
...
position p;
@@
 enum { POOL_READ = 1 , POOL_WRITE = 2 , } cocci_id@p ;
...
position p;
@@
 struct ceph_writeback_ctl * cocci_id@p ;
...
position p;
@@
 struct ceph_rw_context * cocci_id@p ;
...
@@
 struct ceph_writeback_ctl {  loff_t i_size ;  u64 truncate_size ;  u32 truncate_seq ;  bool size_stable ;  bool head_snapc ; } cocci_id@p ;
