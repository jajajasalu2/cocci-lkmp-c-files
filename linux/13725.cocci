...
typedef u8;
@@
 struct ov6650_reg {  u8 reg ;  u8 val ; } cocci_id@p ;
...
typedef u8;
@@
 struct ov6650_xclk {  unsigned long rate ;  u8 clkrc ; } cocci_id@p ;
...
position p;
@@
 const struct ov6650_xclk * cocci_id@p ;
...
typedef bool,u32;
@@
 struct ov6650 {  struct v4l2_subdev subdev ;  struct v4l2_ctrl_handler hdl ;  struct {  struct v4l2_ctrl * autoexposure ;  struct v4l2_ctrl * exposure ; } ;  struct {  struct v4l2_ctrl * autogain ;  struct v4l2_ctrl * gain ; } ;  struct {  struct v4l2_ctrl * autowb ;  struct v4l2_ctrl * blue ;  struct v4l2_ctrl * red ; } ;  struct v4l2_clk * clk ;  bool half_scale ;  struct v4l2_rect rect ;  struct v4l2_fract tpf ;  u32 code ; } cocci_id@p ;
