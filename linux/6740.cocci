...
position p;
@@
 void cocci_id@p ( struct ncb * np , struct scsi_cmnd * cmd ) ;
...
position p;
@@
 struct m_link {  struct m_link * next ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ncb * np , struct tcb * tp ) ;
...
symbol cocci_id;
position p;
typedef u_long,u_char,u32,u16,tagmap_t;
@@
 struct lcb {  struct link jump_lcb ;  ncrcmd load_jump_ccb [ 3 ] ;  struct link jump_tag ;  ncrcmd p_jump_ccb ;  u32 jump_ccb_0 ;  u32 * jump_ccb ;  struct list_head free_ccbq ;  struct list_head busy_ccbq ;  struct list_head wait_ccbq ;  struct list_head skip_ccbq ;  u_char actccbs ;  u_char busyccbs ;  u_char queuedccbs ;  u_char queuedepth ;  u_char scdev_depth ;  u_char maxnxs ;  u_char ia_tag ;  u_char if_tag ;  u_char cb_tags [ MAX_TAGS ] ;  u_char usetags ;  u_char maxtags ;  u_char numtags ;  u16 num_good ;  tagmap_t tags_umap ;  tagmap_t tags_smap ;  u_long tags_stime ;  struct ccb * held_ccb ; } cocci_id@p ;
...
typedef u_char;
@@
 void cocci_id@p ( struct ncb * np , u_char tn ) ;
...
position p;
@@
 struct link {  ncrcmd l_cmd ;  ncrcmd l_paddr ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ncb * np , int delay ) ;
...
position p;
@@
 struct spi_function_template cocci_id@p ;
...
typedef u_char;
@@
 void cocci_id@p ( struct ncb * np , u_char tn , u_char ln ) ;
...
position p;
@@
 struct scsi_cmnd * cocci_id@p ( int to_remove , struct ncb * np , struct scsi_cmnd * cmd ) ;
...
typedef u_long;
@@
 void cocci_id@p ( struct ncb * np , u_long code ) ;
...
typedef u_char;
@@
 void cocci_id@p ( struct ncb * np , u_char scntl3 ) ;
...
position p;
@@
 int cocci_id@p ( struct ncb * np , struct ccb * cp , struct scsi_cmnd * cmd ) ;
...
position p;
@@
 enum spi_signal_type cocci_id@p ;
...
typedef u_long;
@@
 void cocci_id@p ( struct ncb * np , int reset , char * msg , u_long code ) ;
...
typedef u_char;
@@
 void cocci_id@p ( struct ncb * np , struct ccb * cp , u_char wide , u_char ack ) ;
...
position p;
@@
 void cocci_id@p ( struct ncb * np , struct scsi_device * sdev ) ;
...
position p;
@@
 struct launch {  ncrcmd setup_dsa [ 3 ] ;  struct link schedule ;  ncrcmd p_phys ; } cocci_id@p ;
...
typedef u_char,u32;
@@
 struct head {  u32 savep ;  u32 lastp ;  u32 goalp ;  u32 wlastp ;  u32 wgoalp ;  struct ccb * cp ;  u_char scr_st [ 4 ] ;  u_char status [ 4 ] ; } cocci_id@p ;
...
typedef u_char;
@@
 struct lcb * cocci_id@p ( struct ncb * np , u_char tn , u_char ln ) ;
...
position p;
@@
 void cocci_id@p ( struct ncb * np , struct lcb * lp , int maxn ) ;
...
position p;
@@
 struct ccb * cocci_id@p ( struct ncb * np , struct scsi_cmnd * cmd ) ;
...
typedef u_char;
@@
 int cocci_id@p ( struct ncb * np , struct ccb * cp , u_char * msgptr ) ;
...
position p;
@@
 void cocci_id@p ( struct ncb * np , int mult ) ;
...
typedef u_long;
@@
 struct usrcmd {  u_long target ;  u_long lun ;  u_long data ;  u_long cmd ; } cocci_id@p ;
...
position p;
@@
 struct dsb {  struct head header ;  struct scr_tblsel select ;  struct scr_tblmove smsg ;  struct scr_tblmove cmd ;  struct scr_tblmove sense ;  struct scr_tblmove data [ MAX_SCATTER ] ; } cocci_id@p ;
...
position p;
@@
 struct host_data {  struct ncb * ncb ; } cocci_id@p ;
...
position p;
@@
 struct ncr_driver_setup cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ncb * np , int sts ) ;
...
typedef m_addr_t;
@@
 struct m_vtob {  struct m_vtob * next ;  m_addr_t vaddr ;  m_addr_t baddr ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_long,u_char,u32;
@@
 struct ccb {  struct dsb phys ;  struct launch start ;  struct launch restart ;  ncrcmd patch [ 8 ] ;  struct scsi_cmnd * cmd ;  u_char cdb_buf [ 16 ] ;  u_char sense_buf [ 64 ] ;  int data_len ;  u_char scsi_smsg [ 8 ] ;  u_char scsi_smsg2 [ 8 ] ;  u_long p_ccb ;  u_char sensecmd [ 6 ] ;  u_char tag ;  u_char target ;  u_char lun ;  u_char queued ;  u_char auto_sense ;  struct ccb * link_ccb ;  struct list_head link_ccbq ;  u32 startp ;  u_long magic ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ncb * np , struct ccb * cp ) ;
...
position p;
@@
 struct lcb * cocci_id@p ( struct ncb * np , struct scsi_device * sdev ) ;
...
typedef u_char;
@@
 void cocci_id@p ( struct ncb * np , u_char sfac , u_char * fakp , u_char * scntl3p ) ;
...
position p;
@@
 void cocci_id@p ( struct script * scr , struct scripth * scripth ) ;
...
position p;
@@
 void cocci_id@p ( struct ncb * np , ncrcmd * src , ncrcmd * dst , int len ) ;
...
typedef u_char;
@@
 void cocci_id@p ( struct ncb * np , struct ccb * cp , u_char scntl3 , u_char sxfer ) ;
