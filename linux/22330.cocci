...
position p;
@@
 const struct timezone * cocci_id@p ;
...
position p;
@@
 enum lockdown_reason cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const char * new , char * * result ) ;
...
position p;
@@
 struct security_hook_heads cocci_id@p ;
