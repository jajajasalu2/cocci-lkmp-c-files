...
position p;
@@
 struct radeon_encoder_ext_tmds * cocci_id@p ;
...
position p;
@@
 enum radeon_combios_connector cocci_id@p ;
...
position p;
@@
 const struct radeon_tmds_pll cocci_id@p [ CHIP_LAST ] [ 4 ] ;
...
position p;
@@
 enum radeon_combios_ddc { DDC_NONE_DETECTED , DDC_MONID , DDC_DVI , DDC_VGA , DDC_CRT2 , DDC_LCD , DDC_GPIO , } cocci_id@p ;
...
typedef uint32_t;
@@
 const uint32_t cocci_id@p [ CHIP_LAST ] ;
...
position p;
@@
 enum radeon_combios_table_offset cocci_id@p ;
...
position p;
@@
 enum radeon_combios_connector { CONNECTOR_NONE_LEGACY , CONNECTOR_PROPRIETARY_LEGACY , CONNECTOR_CRT_LEGACY , CONNECTOR_DVI_I_LEGACY , CONNECTOR_DVI_D_LEGACY , CONNECTOR_CTV_LEGACY , CONNECTOR_STV_LEGACY , CONNECTOR_UNSUPPORTED_LEGACY , } cocci_id@p ;
...
position p;
@@
 enum radeon_combios_ddc cocci_id@p ;
