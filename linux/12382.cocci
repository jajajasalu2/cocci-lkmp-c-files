...
position p;
@@
 struct drm_device_dma * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_depth_t;
@@
 drm_r128_depth_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_texture_regs_t;
@@
 drm_r128_texture_regs_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_stipple_t;
@@
 drm_r128_stipple_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_indirect_t;
@@
 drm_r128_indirect_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_indices_t;
@@
 drm_r128_indices_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_blit_t;
@@
 drm_r128_blit_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_getparam_t;
@@
 drm_r128_getparam_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_vertex_t;
@@
 drm_r128_vertex_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_context_regs_t;
@@
 drm_r128_context_regs_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_private_t;
@@
 drm_r128_private_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_sarea_t;
@@
 drm_r128_sarea_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_clear_t;
@@
 drm_r128_clear_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_r128_buf_priv_t;
@@
 drm_r128_buf_priv_t * cocci_id@p ;
