...
position p;
@@
 ATOM_PPLIB_POWERTUNE_Table_V1 * cocci_id@p ;
...
position p;
@@
 struct _ATOM_PPLIB_POWERPLAYTABLE3 cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_ACPClk_Voltage_Limit_Record cocci_id@p ;
...
position p;
@@
 struct amdgpu_vce_clock_voltage_dependency_entry cocci_id@p ;
...
position p;
@@
 enum amdgpu_pcie_gen cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_SAMClk_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 struct amdgpu_dpm_dynamic_state * cocci_id@p ;
...
position p;
@@
 struct amdgpu_clock_voltage_dependency_entry cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_ACPClk_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 struct amdgpu_cac_tdp_table cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_VCE_Clock_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 struct amdgpu_phase_shedding_limits_entry cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_VCE_State_Record cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_SAMClk_Voltage_Limit_Record cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_Clock_Voltage_Dependency_Record * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_UVD_Clock_Voltage_Limit_Record * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_CAC_Leakage_Record cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_PhaseSheddingLimits_Record * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_VCE_Clock_Voltage_Limit_Record cocci_id@p ;
...
position p;
@@
 struct amdgpu_i2c_bus_rec cocci_id@p ;
...
position p;
@@
 struct _ATOM_PPLIB_POWERPLAYTABLE4 cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_UVD_Clock_Voltage_Limit_Table * cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_VCE_State_Table * cocci_id@p ;
...
position p;
@@
 struct amdgpu_uvd_clock_voltage_dependency_entry cocci_id@p ;
...
position p;
@@
 enum amdgpu_int_thermal_type cocci_id@p ;
...
position p;
@@
 union fan_info {  struct _ATOM_PPLIB_FANTABLE fan ;  struct _ATOM_PPLIB_FANTABLE2 fan2 ;  struct _ATOM_PPLIB_FANTABLE3 fan3 ; } cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_POWERPLAYTABLE * cocci_id@p ;
...
position p;
@@
 struct _ATOM_PPLIB_POWERPLAYTABLE5 cocci_id@p ;
...
position p;
@@
 ATOM_PPLIB_POWERTUNE_Table * cocci_id@p ;
...
position p;
@@
 struct amdgpu_ppm_table cocci_id@p ;
...
position p;
@@
 ATOM_PowerTune_Table * cocci_id@p ;
...
position p;
@@
 struct amdgpu_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct amdgpu_cac_leakage_table cocci_id@p ;
