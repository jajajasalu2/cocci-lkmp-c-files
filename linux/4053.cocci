...
position p;
@@
 struct its_cmd_desc * cocci_id@p ;
...
position p;
@@
 union acpi_subtable_headers * cocci_id@p ;
...
position p;
@@
 struct its_collection * ( * cocci_id@p ) ( struct its_node * , struct its_cmd_block * , struct its_cmd_desc * ) ;
...
typedef u32;
@@
 struct lpi_range {  struct list_head entry ;  u32 base_id ;  u32 span ; } cocci_id@p ;
...
position p;
@@
 struct its_cmd_block * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u32,phys_addr_t,raw_spinlock_t;
@@
 struct its_node {  raw_spinlock_t lock ;  struct mutex dev_alloc_lock ;  struct list_head entry ;  void __iomem * base ;  phys_addr_t phys_base ;  struct its_cmd_block * cmd_base ;  struct its_cmd_block * cmd_write ;  struct its_baser tables [ GITS_BASER_NR_REGS ] ;  struct its_collection * collections ;  struct fwnode_handle * fwnode_handle ;  u64 ( * get_msi_base ) ( struct its_device * its_dev ) ;  u64 typer ;  u64 cbaser_save ;  u32 ctlr_save ;  struct list_head its_device_list ;  u64 flags ;  unsigned long list_nr ;  int numa_node ;  unsigned int msi_domain_flags ;  u32 pre_its_base ;  int vlpi_redist_offset ; } cocci_id@p ;
...
typedef u64,__le64;
@@
 struct its_cmd_block {  union {  u64 raw_cmd [ 4 ] ;  __le64 raw_cmd_le [ 4 ] ; } ; } cocci_id@p ;
...
position p;
@@
 struct its_srat_map * cocci_id@p ;
...
position p;
@@
 struct its_vlpi_map * cocci_id@p ;
...
typedef u64,u16;
@@
 struct its_collection {  u64 target_address ;  u16 col_id ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct its_baser {  void * base ;  u64 val ;  u32 order ;  u32 psz ; } cocci_id@p ;
...
position p;
@@
 const struct irq_domain_ops cocci_id@p ;
...
position p;
@@
 struct its_collection * cocci_id@p ;
...
@@
 struct {  raw_spinlock_t lock ;  struct its_device * dev ;  struct its_vpe * * vpes ;  int next_victim ; } cocci_id@p ;
...
position p;
@@
 struct acpi_madt_generic_translator * cocci_id@p ;
...
typedef bool,u32;
@@
 struct its_device {  struct list_head entry ;  struct its_node * its ;  struct event_lpi_map event_map ;  void * itt ;  u32 nr_ites ;  u32 device_id ;  bool shared ; } cocci_id@p ;
...
position p;
@@
 struct acpi_srat_gic_its_affinity * cocci_id@p ;
...
position p;
@@
 struct acpi_table_srat cocci_id@p ;
...
position p;
@@
 struct its_vpe * ( * cocci_id@p ) ( struct its_node * , struct its_cmd_block * , struct its_cmd_desc * ) ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct its_device * , u32 ) ;
...
position p;
@@
 const struct gic_quirk cocci_id@p [ ] ;
...
position p;
@@
 struct its_cmd_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u16,irq_hw_number_t,raw_spinlock_t;
@@
 struct event_lpi_map {  unsigned long * lpi_map ;  u16 * col_map ;  irq_hw_number_t lpi_base ;  int nr_lpis ;  raw_spinlock_t vlpi_lock ;  struct its_vm * vm ;  struct its_vlpi_map * vlpi_maps ;  int nr_vlpis ; } cocci_id@p ;
...
typedef u32;
@@
 struct its_srat_map {  u32 numa_node ;  u32 its_id ; } cocci_id@p ;
...
position p;
@@
 enum irqchip_irq_state cocci_id@p ;
