...
position p;
@@
 struct rfkill_gpio_data * cocci_id@p ;
...
typedef bool;
@@
 struct rfkill_gpio_data {  const char * name ;  enum rfkill_type type ;  struct gpio_desc * reset_gpio ;  struct gpio_desc * shutdown_gpio ;  struct rfkill * rfkill_dev ;  struct clk * clk ;  bool clk_enabled ; } cocci_id@p ;
