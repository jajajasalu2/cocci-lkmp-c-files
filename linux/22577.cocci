...
position p;
@@
 void ( * cocci_id@p ) ( struct hda_codec * ) ;
...
position p;
@@
 const struct automic_entry * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hda_codec * codec , struct hda_jack_callback * jack ) ;
...
position p;
@@
 const char * const cocci_id@p [ NUM_VREFS ] ;
...
typedef bool;
@@
 bool cocci_id@p ( struct hda_codec * codec , int cur ) ;
...
position p;
@@
 enum { BAD_NO_PRIMARY_DAC = 0x10000 , BAD_NO_DAC = 0x4000 , BAD_MULTI_IO = 0x120 , BAD_NO_EXTRA_DAC = 0x102 , BAD_NO_EXTRA_SURR_DAC = 0x101 , BAD_SHARED_SURROUND = 0x100 , BAD_NO_INDEP_HP = 0x10 , BAD_SHARED_CLFE = 0x10 , BAD_SHARED_EXTRA_SURROUND = 0x10 , BAD_SHARED_VOL = 0x10 , } cocci_id@p ;
...
position p;
@@
 struct hda_amp_list * cocci_id@p ;
...
position p;
@@
 struct hda_gen_spec * cocci_id@p ;
...
position p;
@@
 const struct auto_pin_cfg * cocci_id@p ;
...
position p;
@@
 enum { HDA_CTL_WIDGET_VOL , HDA_CTL_WIDGET_MUTE , HDA_CTL_BIND_MUTE , } cocci_id@p ;
...
position p;
@@
 const struct nid_path * cocci_id@p ;
...
position p;
@@
 const struct badness_table * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hda_codec * codec , unsigned int adc_idx , unsigned int idx ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct hda_codec * codec , bool do_mix , int nomix_path_idx , int mix_path_idx , int out_type ) ;
...
position p;
@@
 hda_jack_callback_fn cocci_id@p ;
...
position p;
@@
 enum { MICMUTE_LED_ON , MICMUTE_LED_OFF , MICMUTE_LED_FOLLOW_CAPTURE , MICMUTE_LED_FOLLOW_MUTE , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hda_codec * codec ) ;
