...
position p;
@@
 struct pamu_isr_data * cocci_id@p ;
...
typedef u32;
@@
 struct ccsr_law {  u32 lawbarh ;  u32 lawbarl ;  u32 lawar ;  u32 reserved ; } cocci_id@p ;
...
position p;
@@
 struct pamu_isr_data {  void __iomem * pamu_reg_base ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 struct pamu_mmap_regs * cocci_id@p ;
...
typedef u32;
@@
 const struct {  u32 svr ;  u32 port_id ; } cocci_id@p [ ] ;
