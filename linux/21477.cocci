...
@@
 struct aarch64_insn_patch {  void * * text_addrs ;  u32 * new_insns ;  int insn_cnt ;  atomic_t cpu_count ; } cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_logic_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_movewide_type cocci_id@p ;
...
position p;
@@
 struct aarch64_insn_patch * cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_register_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_prfm_target cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_imm_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_data2_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_prfm_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_adsb_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_size_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_data1_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_prfm_policy cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_hint_op cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_condition cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_branch_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_ldst_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_bitfield_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_register cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_data3_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_variant cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pstate_check_t;
@@
 pstate_check_t * const cocci_id@p [ 16 ] ;
...
position p;
@@
 enum aarch64_insn_adr_type cocci_id@p ;
