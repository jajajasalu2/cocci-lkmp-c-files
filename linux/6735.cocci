...
position p;
@@
 struct csio_scsi_level_data * cocci_id@p ;
...
position p;
@@
 struct fw_scsi_write_wr cocci_id@p ;
...
position p;
@@
 struct fw_scsi_abrt_cls_wr * cocci_id@p ;
...
position p;
@@
 struct csio_scsi_qset * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct csio_ioreq * , enum csio_scsi_ev ) ;
...
position p;
@@
 struct fw_scsi_read_wr cocci_id@p ;
...
position p;
@@
 struct fw_scsi_cmd_wr cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct csio_hw * , struct csio_ioreq * , bool ) ;
