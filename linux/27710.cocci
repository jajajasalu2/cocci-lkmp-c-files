...
position p;
@@
 struct msdos_inode_info * cocci_id@p ;
...
position p;
@@
 struct msdos_sb_info cocci_id@p ;
...
position p;
@@
 struct fat_floppy_defaults {  unsigned nr_sectors ;  unsigned sec_per_clus ;  unsigned dir_entries ;  unsigned media ;  unsigned fat_length ; } cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , int wait ) ;
...
position p;
@@
 struct fat_boot_fsinfo * cocci_id@p ;
...
position p;
@@
 struct msdos_dir_entry cocci_id@p ;
...
position p;
@@
 struct fat_floppy_defaults * cocci_id@p ;
...
position p;
@@
 struct fat_boot_sector * cocci_id@p ;
...
position p;
@@
 struct fat_bios_param_block cocci_id@p ;
...
position p;
@@
 struct fat_mount_options * cocci_id@p ;
