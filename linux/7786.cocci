...
position p;
@@
 int cocci_id@p ( struct tegra_uart_port * tup ) ;
...
position p;
@@
 struct tegra_uart_chip_data cocci_id@p ;
...
position p;
@@
 struct tegra_uart_port cocci_id@p ;
...
typedef s32,u32;
@@
 struct tegra_baud_tolerance {  u32 lower_range_baud ;  u32 upper_range_baud ;  s32 tolerance ; } cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct tegra_uart_port * tup , bool dma_to_memory ) ;
...
symbol cocci_id;
position p;
typedef bool,dma_cookie_t,dma_addr_t;
@@
 struct tegra_uart_port {  struct uart_port uport ;  const struct tegra_uart_chip_data * cdata ;  struct clk * uart_clk ;  struct reset_control * rst ;  unsigned int current_baud ;  unsigned long fcr_shadow ;  unsigned long mcr_shadow ;  unsigned long lcr_shadow ;  unsigned long ier_shadow ;  bool rts_active ;  int tx_in_progress ;  unsigned int tx_bytes ;  bool enable_modem_interrupt ;  bool rx_timeout ;  int rx_in_progress ;  int symb_bit ;  struct dma_chan * rx_dma_chan ;  struct dma_chan * tx_dma_chan ;  dma_addr_t rx_dma_buf_phys ;  dma_addr_t tx_dma_buf_phys ;  unsigned char * rx_dma_buf_virt ;  unsigned char * tx_dma_buf_virt ;  struct dma_async_tx_descriptor * tx_dma_desc ;  struct dma_async_tx_descriptor * rx_dma_desc ;  dma_cookie_t tx_cookie ;  dma_cookie_t rx_cookie ;  unsigned int tx_bytes_requested ;  unsigned int rx_bytes_requested ;  struct tegra_baud_tolerance * baud_tolerance ;  int n_adjustable_baud_rates ;  int required_rate ;  int configured_rate ;  bool use_rx_pio ;  bool use_tx_pio ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tegra_uart_port * tup ) ;
...
typedef bool;
@@
 struct tegra_uart_chip_data {  bool tx_fifo_full_status ;  bool allow_txfifo_reset_fifo_mode ;  bool support_clk_src_div ;  bool fifo_mode_enable_status ;  int uart_max_port ;  int max_dma_burst_bytes ;  int error_tolerance_low_range ;  int error_tolerance_high_range ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_uart_chip_data * cocci_id@p ;
