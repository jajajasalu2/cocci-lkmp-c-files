...
typedef bool;
@@
 struct mt9m032 {  struct v4l2_subdev subdev ;  struct media_pad pad ;  struct mt9m032_platform_data * pdata ;  unsigned int pix_clock ;  struct v4l2_ctrl_handler ctrls ;  struct {  struct v4l2_ctrl * hflip ;  struct v4l2_ctrl * vflip ; } ;  struct mutex lock ;  bool streaming ;  struct v4l2_mbus_framefmt format ;  struct v4l2_rect crop ;  struct v4l2_fract frame_interval ; } cocci_id@p ;
...
position p;
@@
 struct mt9m032_platform_data * cocci_id@p ;
