...
position p;
@@
 const enum mdp4_pipe cocci_id@p [ ] ;
...
position p;
@@
 struct mdp4_platform_config * cocci_id@p ( struct platform_device * dev ) ;
...
position p;
@@
 const enum mdp4_dma cocci_id@p [ ] ;
...
position p;
@@
 struct mdp4_platform_config * cocci_id@p ;
