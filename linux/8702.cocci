...
position p;
@@
 int cocci_id@p ( struct iavf_info * ldev , struct iavf_client * client , struct iavf_qvlist_info * qvlist_info ) ;
...
position p;
@@
 struct iavf_client_instance * cocci_id@p ;
...
position p;
@@
 struct iavf_qvlist_info * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 u32 cocci_id@p ( struct iavf_info * ldev , struct iavf_client * client , u8 * msg , u16 len ) ;
...
position p;
@@
 struct iavf_qv_info * cocci_id@p ;
