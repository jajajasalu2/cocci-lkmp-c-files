...
@@
 struct prng_context {  spinlock_t prng_lock ;  unsigned char rand_data [ DEFAULT_BLK_SZ ] ;  unsigned char last_rand_data [ DEFAULT_BLK_SZ ] ;  unsigned char DT [ DEFAULT_BLK_SZ ] ;  unsigned char I [ DEFAULT_BLK_SZ ] ;  unsigned char V [ DEFAULT_BLK_SZ ] ;  u32 rand_data_valid ;  struct crypto_cipher * tfm ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 struct prng_context cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ DEFAULT_BLK_SZ ] ;
