...
position p;
@@
 enum { CP110_CLK_TYPE_CORE , CP110_CLK_TYPE_GATABLE , } cocci_id@p ;
...
typedef u8;
@@
 struct cp110_gate_clk {  struct clk_hw hw ;  struct regmap * regmap ;  u8 bit_idx ; } cocci_id@p ;
...
position p;
@@
 struct cp110_gate_clk * cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ ARRAY_SIZE ( gate_base_names ) ] ;
