...
position p;
@@
 struct cas_init_block * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cas_hp_inst_t;
@@
 cas_hp_inst_t * cocci_id@p ;
...
position p;
@@
 struct {  const char name [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  const int offsets ; } cocci_id@p [ ] ;
