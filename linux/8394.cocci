...
position p;
@@
 struct nfp_fl_set_mpls cocci_id@p ;
...
position p;
@@
 struct nfp_fl_pop_vlan * cocci_id@p ;
...
typedef u8;
@@
 struct ipv6_hop_limit_word {  __be16 payload_len ;  u8 nexthdr ;  u8 hop_limit ; } cocci_id@p ;
...
position p;
@@
 struct nfp_fl_push_geneve * cocci_id@p ;
...
position p;
@@
 struct ipv4_ttl_word * cocci_id@p ;
...
position p;
@@
 struct ipv6_hop_limit_word * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_pedit_acts cocci_id@p ;
...
position p;
@@
 struct nfp_fl_push_mpls * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_pre_tunnel cocci_id@p ;
...
position p;
@@
 struct nfp_fl_pop_mpls cocci_id@p ;
...
position p;
@@
 enum flow_action_mangle_base cocci_id@p ;
...
typedef __u8;
@@
 struct ipv4_ttl_word {  __u8 ttl ;  __u8 protocol ;  __sum16 check ; } cocci_id@p ;
...
position p;
@@
 struct nfp_fl_pre_lag * cocci_id@p ;
