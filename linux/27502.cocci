...
typedef u64;
@@
 struct ceph_aux_inode {  u64 version ;  u64 mtime_sec ;  u64 mtime_nsec ; } cocci_id@p ;
...
position p;
@@
 struct fscache_netfs cocci_id@p ;
...
position p;
@@
 const struct ceph_fsid * cocci_id@p ;
...
position p;
@@
 struct ceph_aux_inode cocci_id@p ;
...
position p;
@@
 struct ceph_fscache_entry * cocci_id@p ;
...
position p;
@@
 struct ceph_fscache_entry {  struct list_head list ;  struct fscache_cookie * fscache ;  size_t uniq_len ;  struct ceph_fsid fsid ;  char uniquifier [ 0 ] ; } cocci_id@p ;
