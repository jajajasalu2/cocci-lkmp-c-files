...
position p;
@@
 struct xdbc_ep_context * cocci_id@p ;
...
position p;
@@
 struct xdbc_context * cocci_id@p ;
...
position p;
@@
 struct xdbc_strings * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ XDBC_MAX_PACKET ] ;
...
position p;
@@
 struct xdbc_erst_entry * cocci_id@p ;
...
position p;
@@
 struct xdbc_segment * cocci_id@p ;
