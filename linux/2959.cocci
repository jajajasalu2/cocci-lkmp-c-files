...
position p;
@@
 const struct acpi_device_data * cocci_id@p ;
...
position p;
@@
 struct acpi_data_node cocci_id@p ;
...
position p;
@@
 const struct acpi_data_node * cocci_id@p ;
...
position p;
@@
 const struct fwnode_operations cocci_id@p ;
...
position p;
@@
 struct acpi_device_data * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( const union acpi_object * desc , struct acpi_device_data * data ) ;
...
position p;
@@
 struct acpi_device_properties * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,acpi_handle;
@@
 bool cocci_id@p ( acpi_handle scope , const union acpi_object * desc , struct acpi_device_data * data , struct fwnode_handle * parent ) ;
...
position p;
@@
 const struct acpi_device_properties * cocci_id@p ;
