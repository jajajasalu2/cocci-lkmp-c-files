...
position p;
@@
 struct xhci_transfer_event * cocci_id@p ;
...
position p;
@@
 enum xhci_ep_reset_type cocci_id@p ;
...
position p;
@@
 struct xhci_event_cmd * cocci_id@p ;
...
position p;
@@
 struct xhci_bus_state * cocci_id@p ;
...
position p;
@@
 struct xhci_generic_trb * cocci_id@p ;
