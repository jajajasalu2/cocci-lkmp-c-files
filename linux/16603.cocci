...
@@
 struct fs3270 {  struct raw3270_view view ;  struct pid * fs_pid ;  int read_command ;  int write_command ;  int attention ;  int active ;  struct raw3270_request * init ;  wait_queue_head_t wait ;  struct idal_buffer * rdbuf ;  size_t rdbuf_size ; } cocci_id@p ;
...
position p;
@@
 struct raw3270_iocb cocci_id@p ;
