...
position p;
@@
 struct bcm2835_alsa_stream * cocci_id@p ;
...
position p;
@@
 struct bcm2835_audio_instance {  struct device * dev ;  struct vchi_service_handle * vchi_handle ;  struct completion msg_avail_comp ;  struct mutex vchi_mutex ;  struct bcm2835_alsa_stream * alsa_stream ;  int result ;  unsigned int max_packet ;  short peer_version ; } cocci_id@p ;
...
position p;
@@
 struct bcm2835_audio_instance * cocci_id@p ;
...
position p;
@@
 struct vc_audio_msg * cocci_id@p ;
