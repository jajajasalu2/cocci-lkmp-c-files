...
position p;
@@
 struct lm3530_pwm_data * cocci_id@p ;
...
typedef u8;
@@
 struct lm3530_als_data {  u8 config ;  u8 imp_sel ;  u8 zones [ LM3530_ALS_ZB_MAX ] ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ LM3530_REG_MAX ] ;
...
position p;
@@
 struct lm3530_platform_data * cocci_id@p ;
...
position p;
@@
 struct lm3530_als_data * cocci_id@p ;
...
position p;
@@
 struct lm3530_mode_map cocci_id@p [ ] ;
...
typedef bool;
@@
 struct lm3530_data {  struct led_classdev led_dev ;  struct i2c_client * client ;  struct lm3530_platform_data * pdata ;  enum lm3530_mode mode ;  struct regulator * regulator ;  enum led_brightness brightness ;  bool enable ; } cocci_id@p ;
...
position p;
@@
 struct lm3530_mode_map {  const char * mode ;  enum lm3530_mode mode_val ; } cocci_id@p ;
