...
position p;
@@
 const unsigned long long cocci_id@p [ N_COEFF_P ] ;
...
position p;
@@
 const unsigned long long cocci_id@p [ N_COEFF_N ] ;
...
position p;
@@
 const unsigned long long cocci_id@p [ N_COEFF_PH ] ;
...
position p;
@@
 const unsigned long long cocci_id@p [ N_COEFF_NH ] ;
