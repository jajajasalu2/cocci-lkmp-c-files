...
position p;
@@
 struct gnet_estimator * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,seqcount_t,spinlock_t;
@@
 struct net_rate_estimator {  struct gnet_stats_basic_packed * bstats ;  spinlock_t * stats_lock ;  seqcount_t * running ;  struct gnet_stats_basic_cpu __percpu * cpu_bstats ;  u8 ewma_log ;  u8 intvl_log ;  seqcount_t seq ;  u64 last_packets ;  u64 last_bytes ;  u64 avpps ;  u64 avbps ;  unsigned long next_jiffies ;  struct timer_list timer ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct net_rate_estimator * * cocci_id@p ;
