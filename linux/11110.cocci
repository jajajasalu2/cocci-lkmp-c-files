...
position p;
@@
 const struct drr_params * cocci_id@p ;
...
position p;
@@
 const enum signal_type cocci_id@p ;
...
position p;
@@
 const struct dcp_gsl_params * cocci_id@p ;
...
position p;
@@
 enum test_pattern_color_format cocci_id@p ;
...
position p;
@@
 struct crtc_trigger_info * cocci_id@p ;
...
position p;
@@
 enum trigger_source_select cocci_id@p ;
...
position p;
@@
 const struct timing_generator_funcs cocci_id@p ;
...
position p;
@@
 const struct crc_params * cocci_id@p ;
...
position p;
@@
 enum test_pattern_dyn_range cocci_id@p ;
...
position p;
@@
 enum test_pattern_mode cocci_id@p ;
...
position p;
@@
 const struct tg_color * cocci_id@p ;
