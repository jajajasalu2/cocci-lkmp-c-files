...
position p;
@@
 const char * cocci_id@p [ MAX_NUMBER_OF_PLLS ] ;
...
position p;
@@
 struct clk_cdce925_chip_info {  int num_plls ;  int num_outputs ; } cocci_id@p ;
...
position p;
@@
 enum { CDCE913 , CDCE925 , CDCE937 , CDCE949 , } cocci_id@p ;
...
position p;
@@
 struct clk_cdce925_chip cocci_id@p ;
...
typedef u8,u16;
@@
 struct clk_cdce925_output {  struct clk_hw hw ;  struct clk_cdce925_chip * chip ;  u8 index ;  u16 pdiv ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct clk_cdce925_pll {  struct clk_hw hw ;  struct clk_cdce925_chip * chip ;  u8 index ;  u16 m ;  u16 n ; } cocci_id@p ;
...
position p;
@@
 struct clk_cdce925_output cocci_id@p ;
...
position p;
@@
 const struct clk_cdce925_chip_info cocci_id@p [ ] ;
...
position p;
@@
 struct clk_cdce925_pll * cocci_id@p ;
...
position p;
@@
 struct clk_cdce925_chip {  struct regmap * regmap ;  struct i2c_client * i2c_client ;  const struct clk_cdce925_chip_info * chip_info ;  struct clk_cdce925_pll pll [ MAX_NUMBER_OF_PLLS ] ;  struct clk_cdce925_output clk [ MAX_NUMBER_OF_OUTPUTS ] ; } cocci_id@p ;
