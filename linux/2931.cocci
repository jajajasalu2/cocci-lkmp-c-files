...
position p;
@@
 struct acpi_vendor_walk_info cocci_id@p ;
...
position p;
@@
 acpi_walk_resource_callback cocci_id@p ;
...
symbol cocci_id;
position p;
typedef acpi_status,acpi_handle;
@@
 acpi_status cocci_id@p ( acpi_handle device_handle , struct acpi_buffer * buffer , struct acpi_namespace_node * * return_node ) ;
