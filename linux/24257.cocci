...
position p;
@@
 void cocci_id@p ( struct net_bridge_port * p ) ;
...
position p;
@@
 struct br_mcast_stats * cocci_id@p ;
...
position p;
@@
 struct bridge_mcast_querier * cocci_id@p ;
...
position p;
@@
 struct bridge_mcast_own_query * cocci_id@p ;
...
typedef __u16;
@@
 void cocci_id@p ( struct net_bridge * br , struct net_bridge_port * port , const struct in6_addr * group , __u16 vid , const unsigned char * src ) ;
...
position p;
@@
 void cocci_id@p ( struct net_bridge * br , struct net_bridge_port * port ) ;
...
position p;
@@
 struct bridge_mcast_stats * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_bridge * br , struct bridge_mcast_own_query * query ) ;
...
position p;
@@
 struct bridge_mcast_other_query * cocci_id@p ;
...
position p;
@@
 const struct net_bridge * cocci_id@p ;
...
position p;
@@
 struct net_bridge_mdb_entry * cocci_id@p ;
...
position p;
@@
 struct net_bridge_port_group __rcu * * cocci_id@p ;
...
position p;
@@
 struct switchdev_attr cocci_id@p ;
...
position p;
@@
 struct net_bridge_port_group * cocci_id@p ;
...
position p;
@@
 struct net_bridge_port * cocci_id@p ;
...
typedef __u16;
@@
 void cocci_id@p ( struct net_bridge * br , struct net_bridge_port * port , __be32 group , __u16 vid , const unsigned char * src ) ;
