...
position p;
@@
 struct stm32_lptimer * cocci_id@p ;
...
position p;
@@
 enum stm32_lptim_synapse_action { STM32_LPTIM_SYNAPSE_ACTION_RISING_EDGE , STM32_LPTIM_SYNAPSE_ACTION_FALLING_EDGE , STM32_LPTIM_SYNAPSE_ACTION_BOTH_EDGES , STM32_LPTIM_SYNAPSE_ACTION_NONE , } cocci_id@p ;
...
typedef bool,u32;
@@
 struct stm32_lptim_cnt {  struct counter_device counter ;  struct device * dev ;  struct regmap * regmap ;  struct clk * clk ;  u32 ceiling ;  u32 polarity ;  u32 quadrature_mode ;  bool enabled ; } cocci_id@p ;
...
position p;
@@
 struct stm32_lptim_cnt * cocci_id@p ;
...
position p;
@@
 enum stm32_lptim_cnt_function { STM32_LPTIM_COUNTER_INCREASE , STM32_LPTIM_ENCODER_BOTH_EDGE , } cocci_id@p ;
...
position p;
@@
 struct stm32_lptim_cnt * const cocci_id@p ;
