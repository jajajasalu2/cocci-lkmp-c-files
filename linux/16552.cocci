...
typedef bool;
@@
 void cocci_id@p ( struct airq_struct * airq , bool floating ) ;
...
position p;
@@
 struct bus_attribute * const cocci_id@p [ ] ;
...
position p;
@@
 struct ap_device_id * cocci_id@p ;
...
position p;
@@
 union ap_qact_ap_info cocci_id@p ;
