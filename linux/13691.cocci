...
position p;
@@
 const struct saa7146_use_ops cocci_id@p ;
...
position p;
@@
 struct saa7146_format cocci_id@p [ ] ;
...
position p;
@@
 struct saa7146_pgtable * cocci_id@p ;
...
position p;
@@
 struct videobuf_dmabuf * cocci_id@p ;
...
position p;
@@
 struct saa7146_dmaqueue * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct file * file , void * fh , struct v4l2_format * f ) ;
