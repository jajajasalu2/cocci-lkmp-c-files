...
position p;
@@
 const struct kirin_drm_data * cocci_id@p ;
...
position p;
@@
 struct kirin_drm_private {  struct kirin_crtc crtc ;  struct kirin_plane planes [ KIRIN_MAX_PLANE ] ;  void * hw_ctx ; } cocci_id@p ;
...
position p;
@@
 struct kirin_drm_private * cocci_id@p ;
