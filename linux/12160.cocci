...
position p;
@@
 const struct nouveau_debugfs_files {  const char * name ;  const struct file_operations * fops ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nvif_control_pstate_info_v0 cocci_id@p ;
...
position p;
@@
 struct nvif_control_pstate_attr_v0 cocci_id@p ;
...
position p;
@@
 struct nouveau_debugfs * cocci_id@p ;
...
position p;
@@
 struct nvif_control_pstate_user_v0 cocci_id@p ;
