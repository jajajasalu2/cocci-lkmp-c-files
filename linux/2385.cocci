...
position p;
@@
 enum ppc_adma_init_code { PPC_ADMA_INIT_OK = 0 , PPC_ADMA_INIT_MEMRES , PPC_ADMA_INIT_MEMREG , PPC_ADMA_INIT_ALLOC , PPC_ADMA_INIT_COHERENT , PPC_ADMA_INIT_CHANNEL , PPC_ADMA_INIT_IRQ1 , PPC_ADMA_INIT_IRQ2 , PPC_ADMA_INIT_REGISTER , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct ppc440spe_adma_chan * chan ) ;
...
position p;
@@
 struct ppc_dma_chan_ref {  struct dma_chan * chan ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 enum ppc_adma_init_code cocci_id@p [ PPC440SPE_ADMA_ENGINES_NUM ] ;
...
position p;
@@
 struct ppc440spe_adma_desc_slot cocci_id@p ;
...
position p;
@@
 struct ppc_dma_chan_ref * cocci_id@p ;
...
position p;
@@
 struct ppc440spe_rxor cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ppc440spe_adma_chan * chan ) ;
...
position p;
@@
 enum dma_transaction_type cocci_id@p ;
...
position p;
@@
 enum sum_check_flags * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ppc440spe_rxor * cursor ) ;
...
position p;
@@
 struct ppc440spe_adma_desc_slot * cocci_id@p [ 3 ] ;
...
typedef u32;
@@
 int cocci_id@p ( struct ppc440spe_adma_desc_slot * desc , struct ppc440spe_rxor * cursor , int index , int src_cnt , u32 addr ) ;
...
position p;
@@
 int cocci_id@p ( struct dma_chan * chan ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct ppc440spe_adma_desc_slot * desc , int index , u8 mult ) ;
...
position p;
@@
 struct ppc440spe_adma_chan * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ppc440spe_adma_desc_slot * desc , int src_cnt ) ;
...
position p;
@@
 void cocci_id@p ( struct ppc440spe_adma_desc_slot * tx , unsigned char mult , int index , int dst_pos ) ;
...
position p;
@@
 struct ppc440spe_adma_device * cocci_id@p ;
