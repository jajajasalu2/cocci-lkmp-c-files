...
position p;
@@
 struct batadv_priv_mcast cocci_id@p ;
...
position p;
@@
 struct batadv_mcast_mla_flags cocci_id@p ;
...
position p;
@@
 struct batadv_tvlv_mcast_data cocci_id@p ;
...
position p;
@@
 struct batadv_mcast_querier_state * cocci_id@p ;
...
position p;
@@
 struct batadv_hw_addr * cocci_id@p ;
...
position p;
@@
 enum batadv_forw_mode cocci_id@p ;
