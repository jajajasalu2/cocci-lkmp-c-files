...
position p;
@@
 int cocci_id@p ( struct nau8825 * nau8825 , int clk_id , unsigned int freq ) ;
...
position p;
@@
 struct nau8825_fll {  int mclk_src ;  int ratio ;  int fll_frac ;  int fll_int ;  int clk_ref_div ; } cocci_id@p ;
...
position p;
@@
 struct nau8825_fll_attr {  unsigned int param ;  unsigned int val ; } cocci_id@p ;
...
position p;
@@
 const struct nau8825_osr_attr cocci_id@p [ ] ;
...
position p;
@@
 const struct nau8825_fll_attr cocci_id@p [ ] ;
...
position p;
@@
 struct nau8825_osr_attr {  unsigned int osr ;  unsigned int clk_src ; } cocci_id@p ;
...
position p;
@@
 const unsigned short cocci_id@p [ 256 ] ;
