...
position p;
@@
 const struct axp20x_time * cocci_id@p ;
...
position p;
@@
 struct axp20x_info {  const struct axp20x_time * startup_time ;  unsigned int startup_mask ;  const struct axp20x_time * shutdown_time ;  unsigned int shutdown_mask ; } cocci_id@p ;
...
position p;
@@
 struct axp20x_time {  unsigned int time ;  unsigned int idx ; } cocci_id@p ;
...
position p;
@@
 struct axp20x_pek {  struct axp20x_dev * axp20x ;  struct input_dev * input ;  struct axp20x_info * info ;  int irq_dbr ;  int irq_dbf ; } cocci_id@p ;
...
position p;
@@
 const struct axp20x_info cocci_id@p ;
