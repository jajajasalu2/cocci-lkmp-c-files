...
position p;
@@
 struct mvpp2_port_pcpu cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ MVPP2_MAX_PORTS ] ;
...
position p;
@@
 struct mvpp2_txq_pcpu_buf * cocci_id@p ;
...
position p;
@@
 const struct mvpp2_ethtool_counter * cocci_id@p ;
...
position p;
@@
 struct mvpp2_pcpu_stats * cocci_id@p ;
...
position p;
@@
 enum mvpp2_bm_pool_log_num { MVPP2_BM_SHORT , MVPP2_BM_LONG , MVPP2_BM_JUMBO , MVPP2_BM_POOLS_NUM , } cocci_id@p ;
...
position p;
@@
 struct mvpp2_tx_queue * cocci_id@p ;
...
position p;
@@
 enum mvpp2_bm_pool_log_num cocci_id@p ;
...
position p;
@@
 struct mvpp2_txq_pcpu * cocci_id@p ;
...
position p;
@@
 struct mvpp2_queue_vector cocci_id@p ;
...
position p;
@@
 const struct mvpp2_bm_pool * cocci_id@p ;
...
typedef bool;
@@
 struct mvpp2_ethtool_counter {  unsigned int offset ;  const char string [ ETH_GSTRING_LEN ] ;  bool reg_is_64b ; } cocci_id@p ;
...
position p;
@@
 struct mvpp2_rx_queue * cocci_id@p ;
...
position p;
@@
 struct mvpp2_tx_desc * cocci_id@p ;
...
position p;
@@
 struct mvpp2_bm_pool * cocci_id@p ;
...
position p;
@@
 struct mvpp2_rx_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct phylink_config * config , unsigned int mode , const struct phylink_link_state * state ) ;
...
position p;
@@
 struct {  int pkt_size ;  int buf_num ; } cocci_id@p [ MVPP2_BM_POOLS_NUM ] ;
