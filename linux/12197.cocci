...
position p;
@@
 struct tegra_shared_plane * cocci_id@p ;
...
position p;
@@
 struct tegra_display_hub_state * cocci_id@p ;
...
position p;
@@
 const struct tegra_display_hub_soc cocci_id@p ;
...
position p;
@@
 struct tegra_display_hub * cocci_id@p ;
...
position p;
@@
 struct tegra_windowgroup * cocci_id@p ;
