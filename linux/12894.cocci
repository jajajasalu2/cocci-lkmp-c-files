...
position p;
@@
 const struct i5100_priv * cocci_id@p ;
...
typedef u8,u64,u16;
@@
 struct i5100_priv {  int dimm_numrank [ I5100_CHANNELS ] [ I5100_MAX_DIMM_SLOTS_PER_CHAN ] ;  int dimm_csmap [ I5100_MAX_DIMM_SLOTS_PER_CHAN ] [ I5100_MAX_RANKS_PER_DIMM ] ;  struct {  u64 limit ;  unsigned way [ 2 ] ; } mir [ I5100_CHANNELS ] ;  unsigned amir [ I5100_CHANNELS ] ;  struct {  unsigned rank [ I5100_MAX_RANK_INTERLEAVE ] ;  u64 limit ; } dmir [ I5100_CHANNELS ] [ I5100_MAX_DMIRS ] ;  struct {  unsigned present ;  unsigned ethrottle ;  unsigned width ;  unsigned numbank ;  unsigned numrow ;  unsigned numcol ; } mtr [ I5100_CHANNELS ] [ I5100_MAX_RANKS_PER_CHAN ] ;  u64 tolm ;  unsigned ranksperchan ;  struct pci_dev * mc ;  struct pci_dev * einj ;  struct pci_dev * ch0mm ;  struct pci_dev * ch1mm ;  struct delayed_work i5100_scrubbing ;  int scrub_enable ;  u8 inject_channel ;  u8 inject_hlinesel ;  u8 inject_deviceptr1 ;  u8 inject_deviceptr2 ;  u16 inject_eccmask1 ;  u16 inject_eccmask2 ;  struct dentry * debugfs ; } cocci_id@p ;
