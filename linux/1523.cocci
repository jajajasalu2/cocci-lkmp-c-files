...
position p;
@@
 struct usbip_header_ret_unlink * cocci_id@p ;
...
position p;
@@
 struct usbip_header_cmd_unlink * cocci_id@p ;
...
position p;
@@
 struct usbip_header_basic * cocci_id@p ;
...
position p;
@@
 struct usbip_header_cmd_submit * cocci_id@p ;
...
position p;
@@
 struct usbip_iso_packet_descriptor * cocci_id@p ;
...
position p;
@@
 struct usbip_header_ret_submit * cocci_id@p ;
...
position p;
@@
 struct usbip_header * cocci_id@p ;
