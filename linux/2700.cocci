...
position p;
@@
 struct slimpro_i2c_dev * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,phys_addr_t;
@@
 struct slimpro_i2c_dev {  struct i2c_adapter adapter ;  struct device * dev ;  struct mbox_chan * mbox_chan ;  struct mbox_client mbox_client ;  int mbox_idx ;  struct completion rd_complete ;  u8 dma_buffer [ I2C_SMBUS_BLOCK_MAX + 1 ] ;  u32 * resp_msg ;  phys_addr_t comm_base_addr ;  void * pcc_comm_addr ; } cocci_id@p ;
...
position p;
@@
 enum slimpro_i2c_version { XGENE_SLIMPRO_I2C_V1 = 0 , XGENE_SLIMPRO_I2C_V2 = 1 , } cocci_id@p ;
