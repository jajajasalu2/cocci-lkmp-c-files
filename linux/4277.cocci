...
position p;
@@
 struct ideapad_rfk_priv * cocci_id@p ;
...
position p;
@@
 enum { BMCMD_CONSERVATION_ON = 3 , BMCMD_CONSERVATION_OFF = 5 , HACMD_FNLOCK_ON = 0xe , HACMD_FNLOCK_OFF = 0xf , } cocci_id@p ;
...
position p;
@@
 struct ideapad_rfk_priv {  int dev ;  struct ideapad_private * priv ; } cocci_id@p ;
...
position p;
@@
 struct ideapad_private * cocci_id@p ;
...
position p;
@@
 const struct ideapad_rfk_data cocci_id@p [ ] ;
...
typedef bool;
@@
 struct ideapad_private {  struct acpi_device * adev ;  struct rfkill * rfk [ IDEAPAD_RFKILL_DEV_NUM ] ;  struct ideapad_rfk_priv rfk_priv [ IDEAPAD_RFKILL_DEV_NUM ] ;  struct platform_device * platform_device ;  struct input_dev * inputdev ;  struct backlight_device * blightdev ;  struct dentry * debug ;  unsigned long cfg ;  bool has_hw_rfkill_switch ;  const char * fnesc_guid ; } cocci_id@p ;
...
position p;
@@
 struct ideapad_rfk_data {  char * name ;  int cfgbit ;  int opcode ;  int type ; } cocci_id@p ;
