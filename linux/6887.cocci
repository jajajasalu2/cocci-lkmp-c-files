...
position p;
@@
 struct mraid_pci_blk * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mraid_device_t;
@@
 mraid_device_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint8_t,mbox_t;
@@
 uint8_t cocci_id@p [ sizeof ( mbox_t ) ] ;
...
position p;
@@
 struct uioc_timeout cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct device * , struct device_attribute * attr , char * ) ;
...
symbol cocci_id;
position p;
typedef scb_t,adapter_t;
@@
 scb_t * cocci_id@p ( adapter_t * , struct scsi_cmnd * , int * ) ;
...
symbol cocci_id;
position p;
typedef mraid_mmadp_t;
@@
 mraid_mmadp_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mraid_inquiry3_t;
@@
 mraid_inquiry3_t * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ MBOX_MAX_FIRMWARE_STATUS ] ;
