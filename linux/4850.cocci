...
position p;
@@
 struct mlx4_wqe_datagram_seg cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx4_ib_cq * send_cq , struct mlx4_ib_cq * recv_cq ) ;
...
position p;
@@
 enum mlx4_ib_qp_type cocci_id@p ;
...
position p;
@@
 enum { MLX4_RAW_QP_MTU = 7 , MLX4_RAW_QP_MSGMAX = 31 , } cocci_id@p ;
...
position p;
@@
 const struct ib_ud_wr * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_create_wq cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ib_wq * ibwq , enum ib_wq_state new_state , struct ib_udata * udata ) ;
...
position p;
@@
 struct mlx4_ib_create_qp cocci_id@p ;
...
position p;
@@
 struct mlx4_port_gid_table * cocci_id@p ;
...
position p;
@@
 enum mlx4_ib_source_type { MLX4_IB_QP_SRC = 0 , MLX4_IB_RWQ_SRC = 1 , } cocci_id@p ;
...
position p;
@@
 union sl2vl_tbl_to_u64 cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_drain_cqe * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_proxy_sqp_hdr cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_create_qp_rss * cocci_id@p ;
...
position p;
@@
 enum mlx4_ib_source_type cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_qp_tunnel_init_attr * cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_local_inval_seg cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_atomic_seg * cocci_id@p ;
...
position p;
@@
 enum { MLX4_IB_UD_HEADER_SIZE = 82 , MLX4_IB_LSO_HEADER_SPARE = 128 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_masked_atomic_seg * cocci_id@p ;
...
typedef u8,u32;
@@
 struct mlx4_ib_sqp {  struct mlx4_ib_qp qp ;  int pkey_index ;  u32 qkey ;  u32 send_psn ;  struct ib_ud_header ud_header ;  u8 header_buf [ MLX4_IB_UD_HEADER_SIZE ] ;  struct ib_qp * roce_v2_gsi ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_ctrl_seg cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_iboe * cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_inline_seg * cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_fmr_seg * cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_raddr_seg cocci_id@p ;
...
position p;
@@
 struct mlx4_wqn_range cocci_id@p ;
...
position p;
@@
 struct mlx4_rss_context * cocci_id@p ;
...
position p;
@@
 const struct ib_atomic_wr * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_create_rwq_ind_tbl_resp cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_modify_wq cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_tunnel_header cocci_id@p ;
...
position p;
@@
 struct counter_index * cocci_id@p ;
...
position p;
@@
 struct mlx4_roce_smac_vlan_info * cocci_id@p ;
...
position p;
@@
 struct mlx4_qp_path * cocci_id@p ;
...
position p;
@@
 enum { MLX4_IB_ACK_REQ_FREQ = 8 , } cocci_id@p ;
...
position p;
@@
 enum { MLX4_QPC_ROCE_MODE_1 = 0 , MLX4_QPC_ROCE_MODE_2 = 2 , MLX4_QPC_ROCE_MODE_UNDEFINED = 0xff , } cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_mlx_seg * cocci_id@p ;
...
position p;
@@
 enum { MLX4_IB_MODIFY_QP_RSS_SUP_ATTR_MSK = ( IB_QP_STATE | IB_QP_PORT ) , } cocci_id@p ;
...
position p;
@@
 enum { MLX4_IB_DEFAULT_SCHED_QUEUE = 0x83 , MLX4_IB_DEFAULT_QP0_SCHED_QUEUE = 0x3f , MLX4_IB_LINK_TYPE_IB = 0 , MLX4_IB_LINK_TYPE_ETH = 1 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_ucontext cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_gid_entry * cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_data_seg * cocci_id@p ;
...
position p;
@@
 struct mlx4_wqe_lso_seg * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_drain_cqe {  struct ib_cqe cqe ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 enum { MLX4_IB_MIN_SQ_STRIDE = 6 , MLX4_IB_CACHE_LINE_SIZE = 64 , } cocci_id@p ;
