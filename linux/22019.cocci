...
symbol cocci_id;
position p;
typedef sortedSymbol_t;
@@
 sortedSymbol_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef BIT_DStream_t;
@@
 BIT_DStream_t cocci_id@p ;
...
position p;
@@
 struct {  BYTE symbol ;  BYTE weight ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rankValCol_t;
@@
 rankValCol_t * cocci_id@p ;
...
typedef sortedSymbol_t;
@@
 const sortedSymbol_t * cocci_id@p ;
...
position p;
@@
 struct {  U16 sequence ;  BYTE nbBits ;  BYTE length ; } cocci_id@p ;
...
position p;
@@
 U32 cocci_id@p [ HUF_TABLELOG_MAX + 1 ] ;
...
position p;
@@
 struct {  BYTE byte ;  BYTE nbBits ; } cocci_id@p ;
...
typedef algo_time_t;
@@
 const algo_time_t cocci_id@p [ 16 ] [ 3 ] ;
...
position p;
@@
 struct {  BYTE maxTableLog ;  BYTE tableType ;  BYTE tableLog ;  BYTE reserved ; } cocci_id@p ;
...
position p;
@@
 const HUF_DEltX4 * constcocci_id ;
...
position p;
@@
 enum { HUF_static_assert = 1 / ( int ) ( ! ! ( c ) ) , } cocci_id@p ;
...
position p;
@@
 U32 cocci_id@p [ HUF_TABLELOG_MAX ] [ HUF_TABLELOG_MAX + 1 ] ;
...
position p;
@@
 const HUF_DEltX2 * constcocci_id ;
...
position p;
@@
 struct {  U32 tableTime ;  U32 decode256Time ; } cocci_id@p ;
