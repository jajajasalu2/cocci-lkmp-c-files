...
position p;
@@
 struct bfi_msgq_cfg_req * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_msgq_rspq * rspq ) ;
...
position p;
@@
 struct bfi_msgq_h2i_db * cocci_id@p ;
...
position p;
@@
 struct bfa_msgq_rspq cocci_id@p ;
...
position p;
@@
 struct bfi_msgq_i2h_cmdq_copy_req * cocci_id@p ;
...
position p;
@@
 struct bfa_msgq_cmdq cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_msgq_mcfunc_t;
@@
 bfa_msgq_mcfunc_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_msgq_cmdq * cmdq ) ;
...
position p;
@@
 enum rspq_event { RSPQ_E_START = 1 , RSPQ_E_STOP = 2 , RSPQ_E_FAIL = 3 , RSPQ_E_RESP = 4 , RSPQ_E_INIT_RESP = 5 , RSPQ_E_DB_READY = 6 , } cocci_id@p ;
...
position p;
@@
 struct bfi_msgq_h2i_cmdq_copy_rsp * cocci_id@p ;
...
position p;
@@
 struct bfi_msgq_i2h_db * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_msgq_cmdcbfn_t;
@@
 bfa_msgq_cmdcbfn_t cocci_id@p ;
...
position p;
@@
 enum cmdq_event { CMDQ_E_START = 1 , CMDQ_E_STOP = 2 , CMDQ_E_FAIL = 3 , CMDQ_E_POST = 4 , CMDQ_E_INIT_RESP = 5 , CMDQ_E_DB_READY = 6 , } cocci_id@p ;
...
position p;
@@
 struct bfa_msgq_cmd_entry cocci_id@p ;
