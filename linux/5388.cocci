...
position p;
@@
 const struct tee_client_device_id * cocci_id@p ;
...
position p;
@@
 struct tee_ioctl_cancel_arg cocci_id@p ;
...
position p;
@@
 struct match_dev_data {  struct tee_ioctl_version_data * vers ;  const void * data ;  int ( * match ) ( struct tee_ioctl_version_data * , const void * ) ; } cocci_id@p ;
...
position p;
@@
 struct tee_ioctl_buf_data cocci_id@p ;
...
position p;
@@
 struct tee_client_device * cocci_id@p ;
...
position p;
@@
 struct tee_ioctl_invoke_arg cocci_id@p ;
...
position p;
@@
 struct tee_shm_pool * cocci_id@p ;
...
position p;
@@
 const struct match_dev_data * cocci_id@p ;
...
position p;
@@
 struct tee_iocl_supp_recv_arg cocci_id@p ;
...
position p;
@@
 struct tee_ioctl_open_session_arg * cocci_id@p ;
...
position p;
@@
 const struct tee_desc * cocci_id@p ;
...
position p;
@@
 struct tee_ioctl_param cocci_id@p ;
...
position p;
@@
 struct tee_ioctl_version_data * cocci_id@p ;
...
position p;
@@
 struct match_dev_data cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct tee_ioctl_version_data * , const void * ) ;
...
position p;
@@
 struct tee_ioctl_close_session_arg cocci_id@p ;
...
position p;
@@
 struct tee_ioctl_shm_register_data cocci_id@p ;
...
position p;
@@
 struct tee_ioctl_shm_alloc_data cocci_id@p ;
...
position p;
@@
 struct tee_iocl_supp_send_arg cocci_id@p ;
