...
position p;
@@
 struct mon_str {  int tick ;  int rxcnt [ MAX_PORTS ] ;  int txcnt [ MAX_PORTS ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct moxa_port * , int , int ) ;
...
position p;
@@
 struct moxa_board_conf {  int boardType ;  int numPorts ;  int busType ;  unsigned int ready ;  struct moxa_port * ports ;  void __iomem * basemem ;  void __iomem * intNdx ;  void __iomem * intPend ;  void __iomem * intTable ; } cocci_id@p [ MAX_BOARDS ] ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_BOARDS ] ;
...
position p;
@@
 void cocci_id@p ( struct moxa_port * , int ) ;
...
position p;
@@
 int cocci_id@p ( struct moxa_port * ) ;
...
position p;
@@
 struct mxser_mstatus cocci_id@p ;
...
typedef __le32,u8;
@@
 const struct {  __le32 magic ;  u8 reserved1 [ 2 ] ;  u8 type ;  u8 model ;  u8 reserved2 [ 8 ] ;  __le16 len [ 5 ] ; } * cocci_id@p ;
...
position p;
@@
 enum { MOXA_BOARD_C218_PCI = 1 , MOXA_BOARD_C218_ISA , MOXA_BOARD_C320_PCI , MOXA_BOARD_C320_ISA , MOXA_BOARD_CP204J , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tty_port * ) ;
...
typedef tcflag_t;
@@
 struct mxser_mstatus {  tcflag_t cflag ;  int cts ;  int dsr ;  int ri ;  int dcd ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct moxa_port * port , int enable ) ;
...
position p;
@@
 struct moxa_board_conf * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * ) ;
...
position p;
@@
 struct moxaq_str {  int inq ;  int outq ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tty_port * ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_port * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct moxa_port * , int , int , int , int , int ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * , const unsigned char * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * , struct file * ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * , struct ktermios * ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * , struct file * ) ;
...
position p;
@@
 int cocci_id@p ( struct moxa_port * , int * , int * ) ;
...
position p;
@@
 void cocci_id@p ( struct moxa_port * ) ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_BOARDS ] ;
...
typedef u8;
@@
 struct moxa_port {  struct tty_port port ;  struct moxa_board_conf * board ;  void __iomem * tableAddr ;  int type ;  int cflag ;  unsigned long statusflags ;  u8 DCDState ;  u8 lineCtrl ;  u8 lowChkFlag ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * , struct serial_struct * ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * ) ;
