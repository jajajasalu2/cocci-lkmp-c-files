...
position p;
@@
 void cocci_id@p ( struct aoedev * d , struct aoetgt * t ) ;
...
position p;
@@
 void cocci_id@p ( struct aoedev * d ) ;
...
position p;
@@
 enum { Sms = 250 , Tms = 30 * 1000 , } cocci_id@p ;
...
position p;
@@
 enum flush_parms { NOT_EXITING = 0 , EXITING = 1 , } cocci_id@p ;
