...
position p;
@@
 struct hisi_sas_complete_v1_hdr cocci_id@p ;
...
typedef __le32,u32;
@@
 struct hisi_sas_err_record_v1 {  __le32 dma_err_type ;  __le32 trans_tx_fail_type ;  __le32 trans_rx_fail_type ;  u32 rsvd ; } cocci_id@p ;
...
typedef irq_handler_t;
@@
 irq_handler_t cocci_id@p [ HISI_SAS_MAX_QUEUES ] ;
...
position p;
@@
 struct hisi_sas_err_record_v1 * cocci_id@p ;
...
position p;
@@
 enum { HISI_SAS_PHY_BCAST_ACK = 0 , HISI_SAS_PHY_SL_PHY_ENABLED , HISI_SAS_PHY_INT_ABNORMAL , HISI_SAS_PHY_INT_NR , } cocci_id@p ;
...
typedef __le32;
@@
 struct hisi_sas_complete_v1_hdr {  __le32 data ; } cocci_id@p ;
