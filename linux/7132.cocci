...
position p;
@@
 struct xen_processor_px * cocci_id@p ;
...
position p;
@@
 struct xen_processor_performance * cocci_id@p ;
...
position p;
@@
 struct xen_processor_cx * cocci_id@p ;
...
position p;
@@
 struct xen_psd_package cocci_id@p ;
...
position p;
@@
 struct xenpf_pcpuinfo * cocci_id@p ;
...
position p;
@@
 struct xen_pct_register * cocci_id@p ;
