...
position p;
@@
 struct atpx_px_params cocci_id@p ;
...
symbol cocci_id;
position p;
typedef acpi_handle,bool;
@@
 struct amdgpu_atpx_priv {  bool atpx_detected ;  bool bridge_pm_usable ;  unsigned int quirks ;  acpi_handle dhandle ;  acpi_handle other_handle ;  struct amdgpu_atpx atpx ; } cocci_id@p ;
...
position p;
@@
 const struct amdgpu_px_quirk * cocci_id@p ;
...
position p;
@@
 enum vga_switcheroo_client_id cocci_id@p ;
...
position p;
@@
 enum vga_switcheroo_state cocci_id@p ;
...
position p;
@@
 const struct vga_switcheroo_handler cocci_id@p ;
...
position p;
@@
 struct atpx_power_control cocci_id@p ;
...
typedef acpi_handle,bool;
@@
 struct amdgpu_atpx {  acpi_handle handle ;  struct amdgpu_atpx_functions functions ;  bool is_hybrid ;  bool dgpu_req_power_for_displays ; } cocci_id@p ;
...
typedef bool;
@@
 struct amdgpu_atpx_functions {  bool px_params ;  bool power_cntl ;  bool disp_mux_cntl ;  bool i2c_mux_cntl ;  bool switch_start ;  bool switch_end ;  bool disp_connectors_mapping ;  bool disp_detection_ports ; } cocci_id@p ;
...
typedef u32;
@@
 struct amdgpu_px_quirk {  u32 chip_vendor ;  u32 chip_device ;  u32 subsys_vendor ;  u32 subsys_device ;  u32 px_quirk_flags ; } cocci_id@p ;
...
position p;
@@
 struct atpx_verify_interface cocci_id@p ;
...
symbol cocci_id;
position p;
typedef vga_switcheroo_handler_flags_t;
@@
 enum vga_switcheroo_handler_flags_t cocci_id@p ;
...
position p;
@@
 struct amdgpu_atpx_functions * cocci_id@p ;
