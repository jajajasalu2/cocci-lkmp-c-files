...
position p;
@@
 struct cx18_enc_idx_entry * cocci_id@p ;
...
position p;
@@
 const struct cx18_card_video_input * cocci_id@p ;
...
position p;
@@
 struct cx18_open_id * cocci_id@p ;
