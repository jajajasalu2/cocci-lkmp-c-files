...
position p;
@@
 enum { KNL_PCI_UNCORE_MC_UCLK , KNL_PCI_UNCORE_MC_DCLK , KNL_PCI_UNCORE_EDC_UCLK , KNL_PCI_UNCORE_EDC_ECLK , KNL_PCI_UNCORE_M2PCIE , KNL_PCI_UNCORE_IRP , } cocci_id@p ;
...
position p;
@@
 struct freerunning_counters cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct intel_uncore_box * box , struct perf_event * event ) ;
...
position p;
@@
 struct intel_uncore_ops cocci_id@p ;
...
position p;
@@
 struct event_constraint * cocci_id@p ;
...
position p;
@@
 struct uncore_event_desc cocci_id@p [ ] ;
...
position p;
@@
 struct hw_perf_event_extra * cocci_id@p ;
...
position p;
@@
 enum { BDX_PCI_UNCORE_HA , BDX_PCI_UNCORE_IMC , BDX_PCI_UNCORE_IRP , BDX_PCI_UNCORE_QPI , BDX_PCI_UNCORE_R2PCIE , BDX_PCI_UNCORE_R3QPI , } cocci_id@p ;
...
position p;
@@
 enum { SKX_PCI_UNCORE_IMC , SKX_PCI_UNCORE_M2M , SKX_PCI_UNCORE_UPI , SKX_PCI_UNCORE_M2PCIE , SKX_PCI_UNCORE_M3UPI , } cocci_id@p ;
...
position p;
@@
 enum perf_uncore_snr_iio_freerunning_type_id { SNR_IIO_MSR_IOCLK , SNR_IIO_MSR_BW_IN , SNR_IIO_FREERUNNING_TYPE_MAX , } cocci_id@p ;
...
position p;
@@
 enum { SNBEP_PCI_UNCORE_HA , SNBEP_PCI_UNCORE_IMC , SNBEP_PCI_UNCORE_QPI , SNBEP_PCI_UNCORE_R2PCIE , SNBEP_PCI_UNCORE_R3QPI , } cocci_id@p ;
...
position p;
@@
 enum { HSWEP_PCI_UNCORE_HA , HSWEP_PCI_UNCORE_IMC , HSWEP_PCI_UNCORE_IRP , HSWEP_PCI_UNCORE_QPI , HSWEP_PCI_UNCORE_R2PCIE , HSWEP_PCI_UNCORE_R3QPI , } cocci_id@p ;
...
position p;
@@
 struct intel_uncore_extra_reg * cocci_id@p ;
...
position p;
@@
 enum { IVBEP_PCI_UNCORE_HA , IVBEP_PCI_UNCORE_IMC , IVBEP_PCI_UNCORE_IRP , IVBEP_PCI_UNCORE_QPI , IVBEP_PCI_UNCORE_R2PCIE , IVBEP_PCI_UNCORE_R3QPI , } cocci_id@p ;
...
position p;
@@
 struct intel_uncore_box * cocci_id@p ;
...
position p;
@@
 enum perf_uncore_iio_freerunning_type_id { SKX_IIO_MSR_IOCLK = 0 , SKX_IIO_MSR_BW = 1 , SKX_IIO_MSR_UTIL = 2 , SKX_IIO_FREERUNNING_TYPE_MAX , } cocci_id@p ;
...
position p;
@@
 enum perf_uncore_snr_imc_freerunning_type_id { SNR_IMC_DCLK , SNR_IMC_DDR , SNR_IMC_FREERUNNING_TYPE_MAX , } cocci_id@p ;
...
position p;
@@
 struct intel_uncore_type * cocci_id@p [ ] ;
...
position p;
@@
 enum { SNR_PCI_UNCORE_M2M , SNR_PCI_UNCORE_PCIE3 , } cocci_id@p ;
...
position p;
@@
 enum { SNBEP_PCI_QPI_PORT0_FILTER , SNBEP_PCI_QPI_PORT1_FILTER , BDX_PCI_QPI_PORT2_FILTER , HSWEP_PCI_PCU_3 , } cocci_id@p ;
