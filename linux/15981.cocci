...
position p;
@@
 struct ieee80211_disassoc cocci_id@p ;
...
position p;
@@
 struct ieee80211_probe_request cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_CHANNEL_NUMBER + 1 ] ;
...
position p;
@@
 struct rtl_80211_hdr * cocci_id@p ;
...
position p;
@@
 struct ieee80211_txb * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ieee80211_device * ieee , short nl ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ IW_ESSID_MAX_SIZE + 1 ] ;
...
position p;
@@
 struct ieee80211_crypto_ops * cocci_id@p ;
...
position p;
@@
 struct sk_buff * cocci_id@p ( struct ieee80211_device * ieee ) ;
...
position p;
@@
 struct ieee80211_authentication cocci_id@p ;
...
position p;
@@
 struct ieee80211_assoc_request_frame cocci_id@p ;
...
position p;
@@
 struct rt_dot11d_info cocci_id@p ;
...
position p;
@@
 struct ieee80211_security cocci_id@p ;
...
position p;
@@
 const struct ieee80211_network * cocci_id@p ;
