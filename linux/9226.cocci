...
position p;
@@
 typeof ( params -> base_addr ) cocci_id@p ;
...
typedef u8;
@@
 struct mac_address {  u8 addr [ ETH_ALEN ] ;  struct list_head list ; } cocci_id@p ;
