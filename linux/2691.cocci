...
position p;
@@
 int cocci_id@p ( struct i2c_client * slave ) ;
...
position p;
@@
 enum i2c_slave_read_status { I2C_SLAVE_RX_FIFO_EMPTY = 0 , I2C_SLAVE_RX_START , I2C_SLAVE_RX_DATA , I2C_SLAVE_RX_END , } cocci_id@p ;
...
position p;
@@
 enum bus_speed_index { I2C_SPD_100K = 0 , I2C_SPD_400K , } cocci_id@p ;
...
position p;
@@
 enum bcm_iproc_i2c_type { IPROC_I2C , IPROC_I2C_NIC , } cocci_id@p ;
...
position p;
@@
 enum bcm_iproc_i2c_type cocci_id@p ;
...
position p;
@@
 struct bcm_iproc_i2c_dev * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct bcm_iproc_i2c_dev * iproc_i2c , bool enable ) ;
