...
position p;
@@
 struct aiptek_features {  int odmCode ;  int modelCode ;  int firmwareCode ;  char usbPath [ 64 + 1 ] ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct aiptek {  struct input_dev * inputdev ;  struct usb_interface * intf ;  struct urb * urb ;  dma_addr_t data_dma ;  struct aiptek_features features ;  struct aiptek_settings curSetting ;  struct aiptek_settings newSetting ;  unsigned int ifnum ;  int diagnostic ;  unsigned long eventCount ;  int inDelay ;  unsigned long endDelay ;  int previousJitterable ;  int lastMacro ;  int previousToolMode ;  unsigned char * data ; } cocci_id@p ;
...
position p;
@@
 struct aiptek_map {  const char * string ;  int value ; } cocci_id@p ;
...
position p;
@@
 struct aiptek_settings {  int pointerMode ;  int coordinateMode ;  int toolMode ;  int xTilt ;  int yTilt ;  int wheel ;  int stylusButtonUpper ;  int stylusButtonLower ;  int mouseButtonLeft ;  int mouseButtonMiddle ;  int mouseButtonRight ;  int programmableDelay ;  int jitterDelay ; } cocci_id@p ;
...
position p;
@@
 const struct aiptek_map * cocci_id@p ;
...
position p;
@@
 struct aiptek_settings cocci_id@p ;
