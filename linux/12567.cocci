...
typedef u32;
@@
 struct dsi_pll_28nm {  struct msm_dsi_pll base ;  int id ;  struct platform_device * pdev ;  void __iomem * mmio ;  struct clk_bytediv * bytediv ;  struct clk * clks [ NUM_DSI_CLOCKS_MAX ] ;  u32 num_clks ;  struct clk * provided_clks [ NUM_PROVIDED_CLKS ] ;  struct clk_onecell_data clk_data ;  struct pll_28nm_cached_state cached_state ; } cocci_id@p ;
...
typedef u8;
@@
 struct pll_28nm_cached_state {  unsigned long vco_rate ;  u8 postdiv3 ;  u8 postdiv2 ;  u8 postdiv1 ; } cocci_id@p ;
...
position p;
@@
 struct dsi_pll_28nm cocci_id@p ;
...
position p;
@@
 struct pll_28nm_cached_state * cocci_id@p ;
...
position p;
@@
 struct clk_bytediv {  struct clk_hw hw ;  void __iomem * reg ; } cocci_id@p ;
