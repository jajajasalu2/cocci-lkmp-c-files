...
position p;
@@
 unsigned long long * cocci_id@p [ SNB_CSTATE_COUNT ] ;
...
position p;
@@
 enum intel_snb_id { C7 = 0 , PC2 , PC7 , SNB_CSTATE_COUNT , TSC = 0xFFFF , } cocci_id@p ;
...
typedef cstate_t;
@@
 cstate_t cocci_id@p [ SNB_CSTATE_COUNT ] ;
