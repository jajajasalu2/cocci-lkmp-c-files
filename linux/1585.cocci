...
symbol cocci_id;
position p;
typedef bool,__u8,atomic_t,spinlock_t;
@@
 struct mos7715_parport {  struct parport * pp ;  struct kref ref_count ;  struct list_head deferred_urbs ;  struct list_head active_urbs ;  spinlock_t listlock ;  bool msg_pending ;  struct completion syncmsg_compl ;  struct tasklet_struct urb_tasklet ;  struct usb_serial * serial ;  __u8 shadowECR ;  __u8 shadowDCR ;  atomic_t shadowDSR ; } cocci_id@p ;
...
position p;
@@
 struct mos7715_parport * cocci_id@p ;
...
position p;
@@
 struct parport_state * cocci_id@p ;
...
position p;
@@
 enum mos7715_pp_modes cocci_id@p ;
...
position p;
@@
 struct parport_operations cocci_id@p ;
...
position p;
@@
 struct urbtracker {  struct mos7715_parport * mos_parport ;  struct list_head urblist_entry ;  struct kref ref_count ;  struct urb * urb ;  struct usb_ctrlrequest * setup ; } cocci_id@p ;
...
position p;
@@
 struct moschip_port * cocci_id@p ;
...
position p;
@@
 enum mos7715_pp_modes { SPP = 0 << 5 , PS2 = 1 << 5 , PPF = 2 << 5 , } cocci_id@p ;
...
position p;
@@
 enum mos_regs { MOS7720_THR , MOS7720_RHR , MOS7720_IER , MOS7720_FCR , MOS7720_ISR , MOS7720_LCR , MOS7720_MCR , MOS7720_LSR , MOS7720_MSR , MOS7720_SPR , MOS7720_DLL , MOS7720_DLM , MOS7720_DPR , MOS7720_DSR , MOS7720_DCR , MOS7720_ECR , MOS7720_SP1_REG , MOS7720_SP2_REG , MOS7720_PP_REG , MOS7720_SP_CONTROL_REG , } cocci_id@p ;
...
typedef __u8;
@@
 struct moschip_port {  __u8 shadowLCR ;  __u8 shadowMCR ;  __u8 shadowMSR ;  char open ;  struct usb_serial_port * port ;  struct urb * write_urb_pool [ NUM_URBS ] ; } cocci_id@p ;
