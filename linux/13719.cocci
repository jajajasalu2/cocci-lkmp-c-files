...
@@
 struct saa7110 {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  u8 reg [ SAA7110_NR_REG ] ;  v4l2_std_id norm ;  int input ;  int enable ;  wait_queue_head_t wq ; } cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 1 + SAA7110_NR_REG ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ 9 ] [ 8 ] ;
