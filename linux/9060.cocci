...
position p;
@@
 struct mlx5e_qcounter_stats cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_q_counter_out ) ] ;
...
position p;
@@
 struct mlx5e_ch_stats * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mpcnt_reg ) ] ;
...
position p;
@@
 const struct mlx5e_stats_grp cocci_id@p [ ] ;
...
position p;
@@
 struct mlx5e_pcie_stats * cocci_id@p ;
