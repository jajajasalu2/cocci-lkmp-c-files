...
typedef uint32_t;
@@
 uint32_t cocci_id@p [ ARRAY_SIZE ( gpu -> last_cntrs ) ] ;
...
position p;
@@
 struct msm_rbmemptrs cocci_id@p ;
...
position p;
@@
 struct drm_print_iterator cocci_id@p ;
...
position p;
@@
 const struct msm_gpu_funcs * cocci_id@p ;
...
position p;
@@
 struct msm_gpu_state_bo cocci_id@p ;
...
position p;
@@
 volatile struct msm_gpu_submit_stats * cocci_id@p ;
...
position p;
@@
 struct msm_gpu_config * cocci_id@p ;
