...
position p;
@@
 struct rv6xx_power_info * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct radeon_device * rdev , u32 unscaled_count , u32 unit ) ;
...
position p;
@@
 struct rv6xx_sclk_stepping cocci_id@p ;
