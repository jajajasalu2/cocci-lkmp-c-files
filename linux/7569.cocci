...
position p;
@@
 enum sm501_controller { HEAD_CRT = 0 , HEAD_PANEL = 1 , } cocci_id@p ;
...
typedef u32;
@@
 struct sm501fb_par {  u32 pseudo_palette [ 16 ] ;  enum sm501_controller head ;  struct sm501_mem cursor ;  struct sm501_mem screen ;  struct fb_ops ops ;  void * store_fb ;  void * store_cursor ;  void __iomem * cursor_regs ;  struct sm501fb_info * info ; } cocci_id@p ;
...
position p;
@@
 enum sm501_controller cocci_id@p ;
...
typedef u8;
@@
 struct sm501fb_info {  struct device * dev ;  struct fb_info * fb [ 2 ] ;  struct resource * fbmem_res ;  struct resource * regs_res ;  struct resource * regs2d_res ;  struct sm501_platdata_fb * pdata ;  unsigned long pm_crt_ctrl ;  int irq ;  int swap_endian ;  void __iomem * regs ;  void __iomem * regs2d ;  void __iomem * fbmem ;  size_t fbmem_len ;  u8 * edid_data ; } cocci_id@p ;
...
position p;
@@
 struct sm501_mem {  unsigned long size ;  unsigned long sm_addr ;  void __iomem * k_addr ; } cocci_id@p ;
...
position p;
@@
 struct sm501fb_info * cocci_id@p ;
