...
position p;
@@
 int cocci_id@p ( struct stimx274 * priv , struct v4l2_fract frame_interval ) ;
...
position p;
@@
 int cocci_id@p ( struct stimx274 * priv , int val ) ;
...
position p;
@@
 int cocci_id@p ( struct stimx274 * priv , struct v4l2_ctrl * ctrl ) ;
...
position p;
@@
 struct stimx274 {  struct v4l2_subdev sd ;  struct media_pad pad ;  struct i2c_client * client ;  struct imx274_ctrls ctrls ;  struct v4l2_rect crop ;  struct v4l2_mbus_framefmt format ;  struct v4l2_fract frame_interval ;  struct regmap * regmap ;  struct gpio_desc * reset_gpio ;  struct mutex lock ;  const struct imx274_mode * mode ; } cocci_id@p ;
...
position p;
@@
 struct imx274_ctrls {  struct v4l2_ctrl_handler handler ;  struct v4l2_ctrl * exposure ;  struct v4l2_ctrl * gain ;  struct v4l2_ctrl * vflip ;  struct v4l2_ctrl * test_pattern ; } cocci_id@p ;
...
position p;
@@
 struct imx274_mode {  const struct reg_8 * init_regs ;  unsigned int bin_ratio ;  int min_frame_len ;  int min_SHR ;  int max_fps ;  int nocpiop ; } cocci_id@p ;
...
position p;
@@
 const struct imx274_mode * cocci_id@p ;
...
position p;
@@
 enum imx274_binning { IMX274_BINNING_OFF , IMX274_BINNING_2_1 , IMX274_BINNING_3_1 , } cocci_id@p ;
