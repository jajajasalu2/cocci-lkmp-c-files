...
position p;
@@
 enum max9611_conf_ids { CONF_SENSE_1x , CONF_SENSE_4x , CONF_SENSE_8x , CONF_IN_VOLT , CONF_TEMP , } cocci_id@p ;
...
position p;
@@
 enum max9611_csa_gain * cocci_id@p ;
...
position p;
@@
 struct max9611_dev {  struct device * dev ;  struct i2c_client * i2c_client ;  struct mutex lock ;  unsigned int shunt_resistor_uohm ; } cocci_id@p ;
...
position p;
@@
 enum max9611_csa_gain_params { CSA_GAIN_LSB_nV , CSA_GAIN_OFFS_RAW , } cocci_id@p ;
...
position p;
@@
 enum max9611_conf_ids cocci_id@p ;
...
position p;
@@
 enum max9611_csa_gain { CSA_GAIN_1x , CSA_GAIN_4x , CSA_GAIN_8x , } cocci_id@p ;
...
position p;
@@
 enum max9611_chan_addrs { MAX9611_CHAN_VOLTAGE_INPUT , MAX9611_CHAN_VOLTAGE_SENSE , MAX9611_CHAN_TEMPERATURE , MAX9611_CHAN_CURRENT_LOAD , MAX9611_CHAN_POWER_LOAD , } cocci_id@p ;
