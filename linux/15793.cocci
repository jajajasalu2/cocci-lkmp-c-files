...
position p;
@@
 struct oid_par_priv cocci_id@p ;
...
position p;
@@
 struct mp_ioctl_handler * cocci_id@p ;
...
position p;
@@
 struct mp_ioctl_param * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , struct iw_request_info * info , union iwreq_data * wrqu , char * extra ) ;
