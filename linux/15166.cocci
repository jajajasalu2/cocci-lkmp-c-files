...
position p;
@@
 struct pps_fdata_compat cocci_id@p ;
...
position p;
@@
 struct pps_ktime_compat cocci_id@p ;
...
position p;
@@
 struct pps_bind_args cocci_id@p ;
