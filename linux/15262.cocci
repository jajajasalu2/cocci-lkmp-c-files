...
position p;
@@
 struct uleds_device cocci_id@p ;
...
position p;
@@
 struct uleds_user_dev cocci_id@p ;
...
position p;
@@
 enum uleds_state { ULEDS_STATE_UNKNOWN , ULEDS_STATE_REGISTERED , } cocci_id@p ;
...
@@
 struct uleds_device {  struct uleds_user_dev user_dev ;  struct led_classdev led_cdev ;  struct mutex mutex ;  enum uleds_state state ;  wait_queue_head_t waitq ;  int brightness ;  bool new_data ; } cocci_id@p ;
