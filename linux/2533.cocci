...
position p;
@@
 struct rdev_sysfs_entry cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mdu_array_info_t;
@@
 mdu_array_info_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mddev * mddev ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct md_thread * ) ;
...
position p;
@@
 struct md_personality * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mddev * mddev , int raid_disks ) ;
...
symbol cocci_id;
position p;
typedef mdu_disk_info_t;
@@
 mdu_disk_info_t * cocci_id@p ;
...
typedef sector_t;
@@
 sector_t cocci_id@p [ SYNC_MARKS ] ;
...
position p;
@@
 struct mdp_superblock_1 * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mddev * mddev , struct md_rdev * this ) ;
...
position p;
@@
 int cocci_id@p ( struct mddev * mddev , int ro , struct block_device * bdev ) ;
...
position p;
@@
 struct md_cluster_operations * cocci_id@p ;
...
position p;
@@
 enum array_state { clear , inactive , suspended , readonly , read_auto , clean , active , write_pending , active_idle , broken , bad_word , } cocci_id@p ;
...
position p;
@@
 struct detected_devices_node * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mddev * mddev ) ;
...
symbol cocci_id;
position p;
typedef mdu_bitmap_file_t;
@@
 mdu_bitmap_file_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mdu_version_t;
@@
 mdu_version_t cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ SYNC_MARKS ] ;
...
typedef dev_t;
@@
 struct detected_devices_node {  struct list_head list ;  dev_t dev ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mddev * mddev , struct block_device * bdev ) ;
