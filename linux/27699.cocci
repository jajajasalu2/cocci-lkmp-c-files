...
position p;
@@
 struct volume_header * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * s , void * d , int silent ) ;
...
position p;
@@
 struct efs_inode_info cocci_id@p ;
