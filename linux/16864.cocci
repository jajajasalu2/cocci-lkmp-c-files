...
position p;
@@
 struct input_leds {  struct input_handle handle ;  unsigned int num_leds ;  struct input_led leds [ ] ; } cocci_id@p ;
...
position p;
@@
 struct input_led {  struct led_classdev cdev ;  struct input_handle * handle ;  unsigned int code ; } cocci_id@p ;
...
position p;
@@
 const struct {  const char * name ;  const char * trigger ; } cocci_id@p [ LED_CNT ] ;
