...
position p;
@@
 struct hisi_femac_queue * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct hisi_femac_queue {  struct sk_buff * * skb ;  dma_addr_t * dma_phys ;  int num ;  unsigned int head ;  unsigned int tail ; } cocci_id@p ;
...
position p;
@@
 struct hisi_femac_priv cocci_id@p ;
