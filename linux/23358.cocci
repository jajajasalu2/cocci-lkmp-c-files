...
position p;
@@
 struct wm8955_priv {  struct regmap * regmap ;  unsigned int mclk_rate ;  int deemph ;  int fs ;  struct regulator_bulk_data supplies [ WM8955_NUM_SUPPLIES ] ; } cocci_id@p ;
...
position p;
@@
 struct pll_factors {  int n ;  int k ;  int outdiv ; } cocci_id@p ;
...
position p;
@@
 struct {  int mclk ;  int fs ;  int usb ;  int sr ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wm8955_pdata * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8955_NUM_SUPPLIES ] ;
