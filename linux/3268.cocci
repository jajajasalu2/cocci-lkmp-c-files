...
symbol cocci_id;
position p;
typedef s8,u8,bool,u16;
@@
 struct emc2103_data {  struct i2c_client * client ;  const struct attribute_group * groups [ 4 ] ;  struct mutex update_lock ;  bool valid ;  bool fan_rpm_control ;  int temp_count ;  unsigned long last_updated ;  struct temperature temp [ 4 ] ;  s8 temp_min [ 4 ] ;  s8 temp_max [ 4 ] ;  u8 temp_min_alarm ;  u8 temp_max_alarm ;  u8 fan_multiplier ;  u16 fan_tach ;  u16 fan_target ; } cocci_id@p ;
...
typedef s8,u8;
@@
 struct temperature {  s8 degrees ;  u8 fraction ; } cocci_id@p ;
...
position p;
@@
 struct emc2103_data * cocci_id@p ;
