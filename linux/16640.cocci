...
position p;
@@
 unsigned long cocci_id@p [ __MAX_SSID + 1 ] [ __BL_DEV_WORDS ] ;
...
position p;
@@
 struct ccwdev_iter {  int devno ;  int ssid ;  int in_range ; } cocci_id@p ;
