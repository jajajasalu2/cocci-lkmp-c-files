...
position p;
@@
 struct gsc_driverdata * cocci_id@p ;
...
position p;
@@
 struct gsc_driverdata {  const struct drm_exynos_ipp_limit * limits ;  int num_limits ;  const char * clk_names [ GSC_MAX_CLOCKS ] ;  int num_clocks ; } cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ GSC_COEF_RATIO ] [ GSC_COEF_ATTR ] [ GSC_COEF_V_4T ] ;
...
position p;
@@
 struct exynos_drm_ipp_formats * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ GSC_COEF_RATIO ] [ GSC_COEF_ATTR ] [ GSC_COEF_H_8T ] ;
...
typedef bool,u32;
@@
 struct gsc_scaler {  bool range ;  u32 pre_shfactor ;  u32 pre_hratio ;  u32 pre_vratio ;  unsigned long main_hratio ;  unsigned long main_vratio ; } cocci_id@p ;
