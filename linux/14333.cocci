...
position p;
@@
 bcm3510_register_value cocci_id@p ;
...
position p;
@@
 struct bcm3510_state cocci_id@p ;
...
position p;
@@
 struct bcm3510_hab_cmd_ext_acquire cocci_id@p ;
...
position p;
@@
 struct bcm3510_hab_cmd_set_agc cocci_id@p ;
...
position p;
@@
 const struct bcm3510_config * cocci_id@p ;
...
typedef u8;
@@
 struct bcm3510_state {  struct i2c_adapter * i2c ;  const struct bcm3510_config * config ;  struct dvb_frontend frontend ;  struct mutex hab_mutex ;  u8 firmware_loaded : 1 ;  unsigned long next_status_check ;  unsigned long status_check_interval ;  struct bcm3510_hab_cmd_status1 status1 ;  struct bcm3510_hab_cmd_status2 status2 ; } cocci_id@p ;
...
position p;
@@
 struct bcm3510_hab_cmd_bert_control cocci_id@p ;
...
position p;
@@
 struct bcm3510_hab_cmd_get_version_info cocci_id@p ;
...
position p;
@@
 struct bcm3510_hab_cmd_tune cocci_id@p ;
