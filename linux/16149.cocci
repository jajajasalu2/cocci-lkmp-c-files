...
position p;
@@
 const struct cb_pcidda_board * cocci_id@p ;
...
typedef u16;
@@
 struct cb_pcidda_private {  unsigned long daqio ;  unsigned int dac_cal1_bits ;  unsigned int ao_range [ MAX_AO_CHANNELS ] ;  u16 eeprom_data [ EEPROM_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct cb_pcidda_board {  const char * name ;  int ao_chans ;  int ao_bits ; } cocci_id@p ;
...
position p;
@@
 enum cb_pcidda_boardid { BOARD_DDA02_12 , BOARD_DDA04_12 , BOARD_DDA08_12 , BOARD_DDA02_16 , BOARD_DDA04_16 , BOARD_DDA08_16 , } cocci_id@p ;
...
position p;
@@
 struct cb_pcidda_private * cocci_id@p ;
