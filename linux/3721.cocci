...
position p;
@@
 struct adf_accel_vf_info * cocci_id@p ;
...
position p;
@@
 struct adf_pf2vf_resp {  struct work_struct pf2vf_resp_work ;  struct adf_accel_vf_info * vf_info ; } cocci_id@p ;
...
position p;
@@
 struct adf_pf2vf_resp cocci_id@p ;
