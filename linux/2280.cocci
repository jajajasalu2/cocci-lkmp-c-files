...
typedef u32;
@@
 struct thermal_soc_data {  u32 version ;  u32 sensor_ctrl ;  u32 power_down_mask ;  u32 measure_temp_mask ;  u32 measure_freq_ctrl ;  u32 measure_freq_mask ;  u32 measure_freq_shift ;  u32 temp_data ;  u32 temp_value_mask ;  u32 temp_value_shift ;  u32 temp_valid_mask ;  u32 panic_alarm_ctrl ;  u32 panic_alarm_mask ;  u32 panic_alarm_shift ;  u32 high_alarm_ctrl ;  u32 high_alarm_mask ;  u32 high_alarm_shift ;  u32 low_alarm_ctrl ;  u32 low_alarm_mask ;  u32 low_alarm_shift ; } cocci_id@p ;
...
position p;
@@
 struct thermal_soc_data cocci_id@p ;
...
position p;
@@
 enum imx_thermal_trip { IMX_TRIP_PASSIVE , IMX_TRIP_CRITICAL , IMX_TRIP_NUM , } cocci_id@p ;
...
position p;
@@
 struct imx_thermal_data * cocci_id@p ;
...
position p;
@@
 const struct thermal_soc_data * cocci_id@p ;
