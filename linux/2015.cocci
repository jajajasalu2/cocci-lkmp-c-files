...
position p;
@@
 struct stk8312_data * cocci_id@p ;
...
typedef s8,u8,bool;
@@
 struct stk8312_data {  struct i2c_client * client ;  struct mutex lock ;  u8 range ;  u8 sample_rate_idx ;  u8 mode ;  struct iio_trigger * dready_trig ;  bool dready_trigger_on ;  s8 buffer [ 16 ] ; } cocci_id@p ;
