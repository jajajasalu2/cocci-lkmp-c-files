...
symbol cocci_id;
position p;
typedef refcount_t,dma_addr_t;
@@
 struct vb2_dc_buf {  struct device * dev ;  void * vaddr ;  unsigned long size ;  void * cookie ;  dma_addr_t dma_addr ;  unsigned long attrs ;  enum dma_data_direction dma_dir ;  struct sg_table * dma_sgt ;  struct frame_vector * vec ;  struct vb2_vmarea_handler handler ;  refcount_t refcount ;  struct sg_table * sgt_base ;  struct dma_buf_attachment * db_attach ; } cocci_id@p ;
...
position p;
@@
 struct vb2_dc_attachment {  struct sg_table sgt ;  enum dma_data_direction dma_dir ; } cocci_id@p ;
...
position p;
@@
 struct vb2_dc_attachment * cocci_id@p ;
