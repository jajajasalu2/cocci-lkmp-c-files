...
position p;
@@
 struct ff_condition_effect * cocci_id@p ;
...
position p;
@@
 struct pidff_device * cocci_id@p ;
...
typedef s32;
@@
 struct pidff_usage {  struct hid_field * field ;  s32 * value ; } cocci_id@p ;
