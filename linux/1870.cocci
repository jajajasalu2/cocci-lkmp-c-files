...
position p;
@@
 const struct ad7887_chip_info cocci_id@p [ ] ;
...
position p;
@@
 struct ad7887_platform_data * cocci_id@p ;
...
typedef u16;
@@
 struct ad7887_chip_info {  u16 int_vref_mv ;  struct iio_chan_spec channel [ 3 ] ; } cocci_id@p ;
...
typedef s64;
@@
 struct ad7887_state {  struct spi_device * spi ;  const struct ad7887_chip_info * chip_info ;  struct regulator * reg ;  struct spi_transfer xfer [ 4 ] ;  struct spi_message msg [ 3 ] ;  struct spi_message * ring_msg ;  unsigned char tx_cmd_buf [ 4 ] ;  unsigned char data [ ALIGN ( 4 , sizeof ( s64 ) ) + sizeof ( s64 ) ] 
...
position p;
@@
 struct ad7887_state * cocci_id@p ;
...
position p;
@@
 enum ad7887_supported_device_ids { ID_AD7887 , } cocci_id@p ;
...
position p;
@@
 enum ad7887_channels { AD7887_CH0 , AD7887_CH0_CH1 , AD7887_CH1 , } cocci_id@p ;
