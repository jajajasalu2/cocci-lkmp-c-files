...
position p;
@@
 void cocci_id@p ( struct inode * inode , struct ea_buffer * ea_buf ) ;
...
typedef dxd_t;
@@
 struct ea_buffer {  int flag ;  int max_size ;  dxd_t new_ea ;  struct metapage * mp ;  struct jfs_ea_list * xattr ; } cocci_id@p ;
