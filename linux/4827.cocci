...
position p;
@@
 const struct rdma_nl_cbs cocci_id@p [ ] ;
...
position p;
@@
 struct {  const struct rdma_nl_cbs * cb_table ;  struct rw_semaphore sem ; } cocci_id@p [ RDMA_NL_NUM_CLIENTS ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ RDMA_NL_NUM_CLIENTS ] ;
