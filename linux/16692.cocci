...
position p;
@@
 unsigned short cocci_id@p [ KBC_MAX_KPENT ] ;
...
position p;
@@
 const struct tegra_kbc_pin_cfg * cocci_id@p ;
...
position p;
@@
 struct tegra_kbc_hw_support {  int max_rows ;  int max_columns ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ KBC_MAX_KPENT ] ;
...
position p;
@@
 const struct tegra_kbc_hw_support cocci_id@p ;
...
position p;
@@
 struct tegra_kbc_pin_cfg {  enum tegra_pin_type type ;  unsigned char num ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_kbc * cocci_id@p ;
...
position p;
@@
 enum tegra_pin_type { PIN_CFG_IGNORE , PIN_CFG_COL , PIN_CFG_ROW , } cocci_id@p ;
