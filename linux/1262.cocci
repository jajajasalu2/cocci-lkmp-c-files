...
position p;
@@
 struct ohci_at91_priv cocci_id@p ;
...
position p;
@@
 struct at91_usbh_data * cocci_id@p ;
...
typedef u8;
@@
 struct at91_usbh_data {  struct gpio_desc * vbus_pin [ AT91_MAX_USBH_PORTS ] ;  struct gpio_desc * overcurrent_pin [ AT91_MAX_USBH_PORTS ] ;  u8 ports ;  u8 overcurrent_supported ;  u8 overcurrent_status [ AT91_MAX_USBH_PORTS ] ;  u8 overcurrent_changed [ AT91_MAX_USBH_PORTS ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usb_hcd * , struct platform_device * ) ;
...
position p;
@@
 const struct ohci_driver_overrides cocci_id@p ;
...
typedef bool;
@@
 struct ohci_at91_priv {  struct clk * iclk ;  struct clk * fclk ;  struct clk * hclk ;  bool clocked ;  bool wakeup ;  struct regmap * sfr_regmap ; } cocci_id@p ;
