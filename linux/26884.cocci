...
position p;
@@
 struct z_erofs_maprecorder cocci_id@p ;
...
position p;
@@
 struct z_erofs_vle_decompressed_index cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u16,erofs_blk_t;
@@
 struct z_erofs_maprecorder {  struct inode * inode ;  struct erofs_map_blocks * map ;  void * kaddr ;  unsigned long lcn ;  u8 type ;  u16 clusterofs ;  u16 delta [ 2 ] ;  erofs_blk_t pblk ; } cocci_id@p ;
...
position p;
@@
 struct z_erofs_map_header * cocci_id@p ;
