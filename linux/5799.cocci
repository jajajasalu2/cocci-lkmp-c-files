...
position p;
@@
 enum rockchip_pin_drv_type { DRV_TYPE_IO_DEFAULT = 0 , DRV_TYPE_IO_1V8_OR_3V0 , DRV_TYPE_IO_1V8_ONLY , DRV_TYPE_IO_1V8_3V0_AUTO , DRV_TYPE_IO_3V3_ONLY , DRV_TYPE_MAX , } cocci_id@p ;
...
position p;
@@
 struct rockchip_pin_ctrl * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gpio_chip * gc , unsigned offset , int value ) ;
...
position p;
@@
 struct irq_chip_generic * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gpio_chip * gc , unsigned offset ) ;
...
position p;
@@
 struct rockchip_pmx_func * cocci_id@p ;
...
position p;
@@
 struct rockchip_pin_bank cocci_id@p [ ] ;
...
position p;
@@
 struct rockchip_drv * cocci_id@p ;
...
position p;
@@
 struct rockchip_iomux * cocci_id@p ;
...
position p;
@@
 const struct gpio_chip cocci_id@p ;
...
position p;
@@
 enum rockchip_pinctrl_type { PX30 , RV1108 , RK2928 , RK3066B , RK3128 , RK3188 , RK3288 , RK3308 , RK3368 , RK3399 , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct rockchip_mux_route_data {  u8 bank_num ;  u8 pin ;  u8 func ;  enum rockchip_mux_route_location route_location ;  u32 route_offset ;  u32 route_val ; } cocci_id@p ;
...
position p;
@@
 const struct rockchip_pin_group * cocci_id@p ;
...
position p;
@@
 struct rockchip_mux_route_data * cocci_id@p ;
...
position p;
@@
 struct rockchip_pin_group cocci_id@p ;
...
position p;
@@
 struct rockchip_iomux {  int type ;  int offset ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_mux_recalced_data * cocci_id@p ;
...
position p;
@@
 enum pin_config_param cocci_id@p ;
...
position p;
@@
 enum rockchip_mux_route_location { ROCKCHIP_ROUTE_SAME = 0 , ROCKCHIP_ROUTE_PMU , ROCKCHIP_ROUTE_GRF , } cocci_id@p ;
...
position p;
@@
 const struct rockchip_pinctrl * cocci_id@p ;
...
position p;
@@
 struct rockchip_pinctrl * cocci_id@p ;
...
typedef u8;
@@
 struct rockchip_pmx_func {  const char * name ;  const char * * groups ;  u8 ngroups ; } cocci_id@p ;
...
position p;
@@
 struct pinctrl_desc * cocci_id@p ;
...
position p;
@@
 struct rockchip_pin_config {  unsigned int func ;  unsigned long * configs ;  unsigned int nconfigs ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_pin_group {  const char * name ;  unsigned int npins ;  unsigned int * pins ;  struct rockchip_pin_config * data ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_pin_config cocci_id@p ;
...
position p;
@@
 enum rockchip_pin_pull_type { PULL_TYPE_IO_DEFAULT = 0 , PULL_TYPE_IO_1V8_ONLY , PULL_TYPE_MAX , } cocci_id@p ;
...
position p;
@@
 const struct rockchip_pin_config * cocci_id@p ;
...
typedef u8,u32;
@@
 struct rockchip_mux_recalced_data {  u8 num ;  u8 pin ;  u32 reg ;  u8 bit ;  u8 mask ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ PULL_TYPE_MAX ] [ 4 ] ;
...
position p;
@@
 struct rockchip_drv {  enum rockchip_pin_drv_type drv_type ;  int offset ; } cocci_id@p ;
