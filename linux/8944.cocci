...
position p;
@@
 enum hnae_port_type cocci_id@p ;
...
position p;
@@
 struct hns_nic_ring_data cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hns_nic_priv * priv ) ;
...
position p;
@@
 struct hns_nic_priv * cocci_id@p ;
...
position p;
@@
 struct hnae_desc_cb * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct hns_nic_ring_data * , struct sk_buff * ) ;
