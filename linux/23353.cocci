...
position p;
@@
 struct rt5677_irq_desc {  unsigned int enable_mask ;  unsigned int status_mask ;  unsigned int polarity_mask ; } cocci_id@p ;
...
position p;
@@
 const struct rt5677_irq_desc cocci_id@p [ ] ;
