...
position p;
@@
 struct ath5k_ani_state * cocci_id@p ;
...
position p;
@@
 struct ath5k_hw_all_rx_desc * cocci_id@p ;
...
position p;
@@
 struct eeprom_private * cocci_id@p ;
...
position p;
@@
 struct ath5k_hw_5212_tx_desc * cocci_id@p ;
...
position p;
@@
 struct ath5k_statistics * cocci_id@p ;
...
typedef u16;
@@
 struct eeprom_private {  u16 * buf ;  int len ; } cocci_id@p ;
...
position p;
@@
 const struct {  enum ath5k_debug_level level ;  const char * name ;  const char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 struct reg {  const char * name ;  int addr ; } cocci_id@p ;
