...
position p;
@@
 const unsigned char * const cocci_id@p [ 256 ] ;
...
position p;
@@
 const struct utf8_table cocci_id@p [ ] ;
...
position p;
@@
 struct utf8_table {  int cmask ;  int cval ;  int shift ;  long lmask ;  long lval ; } cocci_id@p ;
