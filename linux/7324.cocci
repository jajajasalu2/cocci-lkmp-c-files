...
position p;
@@
 struct lms501kf03 {  struct device * dev ;  struct spi_device * spi ;  unsigned int power ;  struct lcd_device * ld ;  struct lcd_platform_data * lcd_pd ; } cocci_id@p ;
