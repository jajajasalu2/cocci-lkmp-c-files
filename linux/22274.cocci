...
position p;
@@
 int ( * cocci_id@p [ SYM_NUM ] ) ( void * key , void * datum , void * datap ) ;
...
position p;
@@
 int ( * cocci_id@p [ SYM_NUM ] ) ( struct policydb * p , struct hashtab * h , void * fp ) ;
...
position p;
@@
 struct hashtab_info cocci_id@p ;
...
position p;
@@
 const struct filename_trans * cocci_id@p ;
...
position p;
@@
 struct policydb_compat_info {  int version ;  int sym_num ;  int ocon_num ; } cocci_id@p ;
...
position p;
@@
 struct policydb_compat_info * cocci_id@p ;
...
position p;
@@
 const struct range_trans * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ SYM_NUM ] ;
