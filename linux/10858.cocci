...
position p;
@@
 struct {  void ( * func ) ( atom_exec_context * , int * , int ) ;  int arg ; } cocci_id@p [ ATOM_OP_CNT ] ;
...
@@
 struct {  struct atom_context * ctx ;  uint32_t * ps , * ws ;  int ps_shift ;  uint16_t start ;  unsigned last_jump ;  unsigned long last_jump_jiffies ;  bool abort ; } cocci_id@p ;
