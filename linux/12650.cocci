...
position p;
@@
 struct drm_msm_gem_info * cocci_id@p ;
...
position p;
@@
 struct drm_msm_gem_cpu_prep * cocci_id@p ;
...
position p;
@@
 struct drm_msm_wait_fence * cocci_id@p ;
...
position p;
@@
 struct drm_msm_gem_cpu_fini * cocci_id@p ;
...
position p;
@@
 struct drm_msm_gem_new * cocci_id@p ;
...
position p;
@@
 struct drm_msm_submitqueue * cocci_id@p ;
...
position p;
@@
 struct msm_file_private * cocci_id@p ;
...
position p;
@@
 struct drm_msm_gem_madvise * cocci_id@p ;
...
position p;
@@
 struct msm_vblank_work * cocci_id@p ;
...
position p;
@@
 struct drm_msm_timespec cocci_id@p ;
...
position p;
@@
 struct msm_gem_object * cocci_id@p ;
...
typedef bool;
@@
 struct msm_vblank_work {  struct work_struct work ;  int crtc_id ;  bool enable ;  struct msm_drm_private * priv ; } cocci_id@p ;
...
position p;
@@
 struct msm_gpu_submitqueue * cocci_id@p ;
...
position p;
@@
 struct drm_msm_param * cocci_id@p ;
...
position p;
@@
 struct clk_bulk_data * cocci_id@p ;
