...
position p;
@@
 struct lm3639_chip_data * cocci_id@p ;
...
position p;
@@
 struct lm3639_chip_data {  struct device * dev ;  struct lm3639_platform_data * pdata ;  struct backlight_device * bled ;  struct led_classdev cdev_flash ;  struct led_classdev cdev_torch ;  struct regmap * regmap ;  unsigned int bled_mode ;  unsigned int bled_map ;  unsigned int last_flag ; } cocci_id@p ;
...
position p;
@@
 struct lm3639_platform_data * cocci_id@p ;
