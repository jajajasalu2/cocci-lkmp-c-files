...
position p;
@@
 struct ioctl_gntalloc_dealloc_gref cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint64_t,grant_ref_t;
@@
 struct gntalloc_gref {  struct list_head next_gref ;  struct list_head next_file ;  struct page * page ;  uint64_t file_index ;  unsigned int users ;  grant_ref_t gref_id ;  struct notify_info notify ; } cocci_id@p ;
...
position p;
@@
 struct ioctl_gntalloc_alloc_gref * cocci_id@p ;
...
position p;
@@
 struct gntalloc_vma_private_data * cocci_id@p ;
...
position p;
@@
 struct gntalloc_vma_private_data {  struct gntalloc_gref * gref ;  int users ;  int count ; } cocci_id@p ;
...
typedef uint16_t;
@@
 struct notify_info {  uint16_t pgoff : 12 ;  uint16_t flags : 2 ;  int event ; } cocci_id@p ;
...
position p;
@@
 struct ioctl_gntalloc_unmap_notify cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gntalloc_gref * gref ) ;
...
typedef uint64_t;
@@
 struct gntalloc_file_private_data {  struct list_head list ;  uint64_t index ; } cocci_id@p ;
...
position p;
@@
 struct gntalloc_gref * cocci_id@p ;
...
position p;
@@
 struct gntalloc_file_private_data * cocci_id@p ;
