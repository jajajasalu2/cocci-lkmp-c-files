...
position p;
@@
 void cocci_id@p ( struct fb_info_platinum * pinfo ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_info_platinum * pinfo ) ;
...
position p;
@@
 int cocci_id@p ( int video_mode , int color_mode ) ;
...
position p;
@@
 struct platinum_regvals * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , struct fb_info_platinum * pinfo , int check_only ) ;
...
position p;
@@
 struct fb_info_platinum * cocci_id@p ;
