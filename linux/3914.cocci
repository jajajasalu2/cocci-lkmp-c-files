...
position p;
@@
 const struct udmabuf_create_list * cocci_id@p ;
...
position p;
@@
 struct udmabuf_create_item cocci_id@p ;
...
position p;
@@
 const struct udmabuf_create_item * cocci_id@p ;
...
position p;
@@
 struct udmabuf_create cocci_id@p ;
...
position p;
@@
 struct udmabuf_create_list cocci_id@p ;
...
typedef pgoff_t;
@@
 struct udmabuf {  pgoff_t pagecount ;  struct page * * pages ; } cocci_id@p ;
