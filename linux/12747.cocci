...
position p;
@@
 arm_v7s_iopte cocci_id@p [ ARM_V7S_CONT_PAGES ] ;
...
position p;
@@
 struct arm_v7s_io_pgtable * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct arm_v7s_io_pgtable {  struct io_pgtable iop ;  arm_v7s_iopte * pgd ;  struct kmem_cache * l2_tables ;  spinlock_t split_lock ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( arm_v7s_iopte pte , int lvl ) ;
...
position p;
@@
 struct io_pgtable_init_fns cocci_id@p ;
