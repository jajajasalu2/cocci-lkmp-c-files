...
position p;
@@
 enum { VHOST_TEST_VQ = 0 , VHOST_TEST_VQ_MAX = 1 , } cocci_id@p ;
...
position p;
@@
 struct vhost_test {  struct vhost_dev dev ;  struct vhost_virtqueue vqs [ VHOST_TEST_VQ_MAX ] ; } cocci_id@p ;
