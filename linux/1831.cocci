...
position p;
@@
 const struct ad7266_chan_info cocci_id@p [ ] ;
...
position p;
@@
 struct ad7266_state * cocci_id@p ;
...
position p;
@@
 struct ad7266_platform_data * cocci_id@p ;
...
position p;
@@
 struct ad7266_chan_info {  const struct iio_chan_spec * channels ;  unsigned int num_channels ;  const unsigned long * scan_masks ; } cocci_id@p ;
...
typedef bool,s64;
@@
 struct ad7266_state {  struct spi_device * spi ;  struct regulator * reg ;  unsigned long vref_mv ;  struct spi_transfer single_xfer [ 3 ] ;  struct spi_message single_msg ;  enum ad7266_range range ;  enum ad7266_mode mode ;  bool fixed_addr ;  struct gpio gpios [ 3 ] ;  struct {  __be16 sample [ 2 ] ;  s64 timestamp ; } data ____cacheline_aligned ; } cocci_id@p ;
