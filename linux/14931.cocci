...
position p;
@@
 struct stm_pll {  unsigned long mdiv ;  unsigned long ndiv ;  unsigned long pdiv ;  unsigned long odf ;  unsigned long idf ;  unsigned long ldf ;  unsigned long cp ; } cocci_id@p ;
...
position p;
@@
 struct clkgen_pll_data * cocci_id@p ;
...
@@
 struct clkgen_pll {  struct clk_hw hw ;  struct clkgen_pll_data * data ;  void __iomem * regs_base ;  spinlock_t * lock ;  u32 ndiv ;  u32 idf ;  u32 odf ;  u32 cp ; } cocci_id@p ;
...
position p;
@@
 struct clkgen_field * cocci_id@p ;
...
position p;
@@
 const struct clkgen_pll_data cocci_id@p ;
