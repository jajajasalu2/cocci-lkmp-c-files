...
position p;
@@
 struct ssm2518_platform_data * cocci_id@p ;
...
typedef bool;
@@
 struct ssm2518 {  struct regmap * regmap ;  bool right_j ;  unsigned int sysclk ;  const struct snd_pcm_hw_constraint_list * constraints ;  int enable_gpio ; } cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( ssm2518_limiter_tlv , 
							     0 , 7 , 
...
position p;
@@
 struct ssm2518_mcs_lut {  unsigned int rate ;  const unsigned int * sysclks ; } cocci_id@p ;
...
position p;
@@
 const struct ssm2518_mcs_lut cocci_id@p [ ] ;
