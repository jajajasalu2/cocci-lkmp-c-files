...
position p;
@@
 struct cache_request * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cache_head * item ) ;
...
position p;
@@
 void cocci_id@p ( struct cache_detail * detail , struct cache_head * ch ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct cache_detail * detail ) ;
...
position p;
@@
 struct cache_request {  struct cache_queue q ;  struct cache_head * item ;  char * buf ;  int len ;  int readers ; } cocci_id@p ;
...
position p;
@@
 struct hlist_head cocci_id@p [ DFR_HASHSIZE ] ;
...
position p;
@@
 struct thread_deferred_req * cocci_id@p ;
...
position p;
@@
 struct cache_reader * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cache_head * head , struct cache_detail * detail ) ;
...
position p;
@@
 struct cache_deferred_req cocci_id@p ;
...
position p;
@@
 struct cache_reader {  struct cache_queue q ;  int offset ; } cocci_id@p ;
...
position p;
@@
 struct cache_queue {  struct list_head list ;  int reader ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct cache_req * req , struct cache_head * item ) ;
...
position p;
@@
 struct thread_deferred_req {  struct cache_deferred_req handle ;  struct completion completion ; } cocci_id@p ;
