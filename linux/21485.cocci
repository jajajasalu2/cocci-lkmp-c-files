...
typedef u8,u32;
@@
 void cocci_id@p ( u32 * state , u8 * dst , const u8 * src , int nrounds , int bytes ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u32 * state , u8 * dst , const u8 * src , int nrounds ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ CHACHA_BLOCK_SIZE ] ;
...
typedef u32;
@@
 void cocci_id@p ( const u32 * state , u32 * out , int nrounds ) ;
...
position p;
@@
 const struct chacha_ctx * cocci_id@p ;
