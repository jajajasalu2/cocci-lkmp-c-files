...
position p;
@@
 struct atl1e_tx_buffer cocci_id@p ;
...
position p;
@@
 struct atl1e_adapter * cocci_id@p ;
...
position p;
@@
 struct atl1e_tpd_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct atl1e_adapter * adapter ) ;
...
position p;
@@
 struct atl1e_rx_page_desc * cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ AT_MAX_RECEIVE_QUEUE ] ;
...
position p;
@@
 struct atl1e_tx_ring * cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ AT_MAX_RECEIVE_QUEUE ] [ AT_PAGE_NUM_PER_QUEUE ] ;
...
position p;
@@
 struct atl1e_recv_ret_status cocci_id@p ;
...
position p;
@@
 struct atl1e_hw_stats * cocci_id@p ;
...
position p;
@@
 struct atl1e_rx_page * cocci_id@p ;
...
position p;
@@
 struct atl1e_rx_ring * cocci_id@p ;
