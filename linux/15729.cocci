...
position p;
@@
 const struct wfx_ht_info * cocci_id@p ;
...
position p;
@@
 struct hif_mib_uc_mc_bc_data_frame_condition cocci_id@p ;
...
position p;
@@
 struct wfx_hif_event * cocci_id@p ;
...
position p;
@@
 struct wfx_link_entry * cocci_id@p ;
...
position p;
@@
 struct hif_mib_bcn_filter_enable cocci_id@p ;
...
position p;
@@
 struct hif_mib_arp_ip_addr_table cocci_id@p ;
...
position p;
@@
 struct wfx_sta_priv * cocci_id@p ;
...
position p;
@@
 const struct wfx_edca_params * cocci_id@p ;
...
position p;
@@
 struct wfx_grp_addr_table * cocci_id@p ;
...
position p;
@@
 struct hif_mib_set_data_filtering cocci_id@p ;
...
position p;
@@
 struct hif_mib_set_association_mode cocci_id@p ;
...
position p;
@@
 struct hif_mib_mac_addr_data_frame_condition cocci_id@p ;
...
position p;
@@
 struct hif_mib_rcpi_rssi_threshold cocci_id@p ;
...
position p;
@@
 struct hif_mib_config_data_filter cocci_id@p ;
...
position p;
@@
 struct hif_mib_template_frame * cocci_id@p ;
...
position p;
@@
 struct hif_ie_table_entry cocci_id@p [ ] ;
...
position p;
@@
 struct hif_ind_suspend_resume_tx * cocci_id@p ;
