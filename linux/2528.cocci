...
position p;
@@
 struct raid1_plug_cb {  struct blk_plug_cb cb ;  struct bio_list pending ;  int pending_cnt ; } cocci_id@p ;
...
position p;
@@
 struct raid1_plug_cb cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mddev * mddev , void * priv ) ;
