...
position p;
@@
 struct block_header_column {  const char * name ;  int width ; } cocci_id@p [ PERF_HPP_REPORT__BLOCK_MAX_INDEX ] ;
...
position p;
@@
 struct block_report cocci_id@p ;
