...
position p;
@@
 struct sctp_supported_ext_param cocci_id@p ;
...
position p;
@@
 void * cocci_id@p ( struct sctp_chunk * chunk , int len , const void * data ) ;
...
position p;
@@
 struct sctp_strreset_addstrm cocci_id@p ;
...
typedef __u8;
@@
 struct sctp_cookie_param * cocci_id@p ( const struct sctp_endpoint * ep , const struct sctp_association * asoc , const struct sctp_chunk * init_chunk , int * cookie_len , const __u8 * raw_addrs , int addrs_len ) ;
...
position p;
@@
 const struct sctp_sndrcvinfo * cocci_id@p ;
...
position p;
@@
 struct sctp_gap_ack_block cocci_id@p [ SCTP_MAX_GABS ] ;
...
position p;
@@
 struct sctp_strreset_outreq cocci_id@p ;
...
position p;
@@
 struct sctp_ipv6addr_param cocci_id@p ;
...
position p;
@@
 struct sctp_gap_ack_block cocci_id@p ;
...
position p;
@@
 struct sctp_adaptation_ind_param cocci_id@p ;
...
position p;
@@
 struct sctp_strreset_inreq cocci_id@p ;
...
position p;
@@
 struct sctp_strreset_tsnreq cocci_id@p ;
...
position p;
@@
 const struct sctp_bind_addr * cocci_id@p ;
...
position p;
@@
 const struct sctp_paramhdr cocci_id@p ;
...
position p;
@@
 struct sctp_strreset_resp cocci_id@p ;
...
position p;
@@
 struct sctp_ifwdtsn_hdr cocci_id@p ;
...
position p;
@@
 struct sctp_supported_addrs_param cocci_id@p ;
...
position p;
@@
 struct sctp_cookie_param * cocci_id@p ;
...
position p;
@@
 struct sctp_addip_param * cocci_id@p ;
...
position p;
@@
 struct sctp_strreset_resptsn cocci_id@p ;
...
position p;
@@
 struct sctp_ipv4addr_param cocci_id@p ;
...
position p;
@@
 struct sctp_fwdtsn_skip cocci_id@p ;
...
position p;
@@
 struct sctp_ifwdtsn_skip * cocci_id@p ;
...
position p;
@@
 const struct sctp_transport * cocci_id@p ;
