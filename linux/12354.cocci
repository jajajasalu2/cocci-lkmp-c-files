...
position p;
@@
 struct drm_exynos_vidi_connection * cocci_id@p ;
...
position p;
@@
 struct vidi_context * cocci_id@p ;
...
position p;
@@
 struct exynos_drm_plane_config cocci_id@p ;
