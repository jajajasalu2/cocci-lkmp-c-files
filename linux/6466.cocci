...
position p;
@@
 struct max77650_regulator_desc * * cocci_id@p ;
...
position p;
@@
 struct max77650_regulator_desc {  struct regulator_desc desc ;  unsigned int regA ;  unsigned int regB ; } cocci_id@p ;
...
position p;
@@
 enum { MAX77650_REGULATOR_ID_LDO = 0 , MAX77650_REGULATOR_ID_SBB0 , MAX77650_REGULATOR_ID_SBB1 , MAX77650_REGULATOR_ID_SBB2 , MAX77650_REGULATOR_NUM_REGULATORS , } cocci_id@p ;
