...
position p;
@@
 struct acpi_pct_register * cocci_id@p ;
...
position p;
@@
 enum { UNDEFINED_CAPABLE = 0 , SYSTEM_INTEL_MSR_CAPABLE , SYSTEM_AMD_MSR_CAPABLE , SYSTEM_IO_CAPABLE , } cocci_id@p ;
...
position p;
@@
 struct cpufreq_frequency_table * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,cpumask_var_t;
@@
 struct acpi_cpufreq_data {  unsigned int resume ;  unsigned int cpu_feature ;  unsigned int acpi_perf_cpu ;  cpumask_var_t freqdomain_cpus ;  void ( * cpu_freq_write ) ( struct acpi_pct_register * reg , u32 val ) ;  u32 ( * cpu_freq_read ) ( struct acpi_pct_register * reg ) ; } cocci_id@p ;
...
typedef u32;
@@
 struct drv_cmd {  struct acpi_pct_register * reg ;  u32 val ;  union {  void ( * write ) ( struct acpi_pct_register * reg , u32 val ) ;  u32 ( * read ) ( struct acpi_pct_register * reg ) ; } func ; } cocci_id@p ;
...
position p;
@@
 struct acpi_processor_performance cocci_id@p ;
...
position p;
@@
 struct acpi_cpufreq_data * cocci_id@p ;
