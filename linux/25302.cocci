...
typedef int64_t;
@@
 int64_t ( * cocci_id@p ) ( struct hist_entry * , struct hist_entry * ) ;
...
position p;
@@
 struct perf_hpp_list * cocci_id@p ;
...
position p;
@@
 double cocci_id@p ( struct c2c_hist_entry * ) ;
...
position p;
@@
 struct c2c_fmt {  struct perf_hpp_fmt fmt ;  struct c2c_dimension * dim ; } cocci_id@p ;
...
position p;
@@
 struct c2c_cacheline_browser * cocci_id@p ;
...
position p;
@@
 struct c2c_dimension * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ DISPLAY_MAX ] ;
...
position p;
@@
 struct hist_entry_ops cocci_id@p ;
...
position p;
@@
 struct c2c_hist_entry cocci_id@p ;
...
position p;
@@
 struct compute_stats {  struct stats lcl_hitm ;  struct stats rmt_hitm ;  struct stats load ; } cocci_id@p ;
...
typedef int64_t;
@@
 struct c2c_dimension {  struct c2c_header header ;  const char * name ;  int width ;  struct sort_entry * se ;  int64_t ( * cmp ) ( struct perf_hpp_fmt * fmt , struct hist_entry * , struct hist_entry * ) ;  int ( * entry ) ( struct perf_hpp_fmt * fmt , struct perf_hpp * hpp , struct hist_entry * he ) ;  int ( * color ) ( struct perf_hpp_fmt * fmt , struct perf_hpp * hpp , struct hist_entry * he ) ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct c2c_hists * hists , const char * sort , int nr_header_lines ) ;
...
position p;
@@
 struct c2c_header cocci_id@p [ 3 ] ;
...
position p;
@@
 struct c2c_header {  struct {  const char * text ;  int span ; } line [ C2C_HEADER_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct perf_hpp_fmt * cocci_id@p ;
...
position p;
@@
 struct callchain_param * cocci_id@p ;
...
position p;
@@
 struct c2c_hists {  struct hists hists ;  struct perf_hpp_list list ;  struct c2c_stats stats ; } cocci_id@p ;
...
position p;
@@
 struct c2c_cacheline_browser {  struct hist_browser hb ;  struct hist_entry * he ; } cocci_id@p ;
...
position p;
@@
 enum perf_call_graph_mode cocci_id@p ;
...
typedef bool;
@@
 struct c2c_hist_entry {  struct c2c_hists * hists ;  struct c2c_stats stats ;  unsigned long * cpuset ;  unsigned long * nodeset ;  struct c2c_stats * node_stats ;  unsigned int cacheline_idx ;  struct compute_stats cstats ;  unsigned long paddr ;  unsigned long paddr_cnt ;  bool paddr_zero ;  char * nodestr ;  struct hist_entry he ; } cocci_id@p ;
...
position p;
@@
 struct compute_stats * cocci_id@p ;
...
position p;
@@
 struct hist_browser * cocci_id@p ;
...
position p;
@@
 enum { DISPLAY_LCL , DISPLAY_RMT , DISPLAY_TOT , DISPLAY_MAX , } cocci_id@p ;
