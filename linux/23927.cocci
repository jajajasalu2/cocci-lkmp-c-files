...
position p;
@@
 struct inet_timewait_death_row * cocci_id@p ;
...
position p;
@@
 const union tcp_md5_addr * cocci_id@p ;
...
position p;
@@
 const struct tcp_request_sock_ops cocci_id@p ;
...
position p;
@@
 enum tcp_synack_type cocci_id@p ;
...
position p;
@@
 struct tcp4_pseudohdr * cocci_id@p ;
...
position p;
@@
 const struct inet_request_sock * cocci_id@p ;
...
position p;
@@
 struct timewait_sock_ops cocci_id@p ;
...
position p;
@@
 struct tcp_iter_state * cocci_id@p ;
...
position p;
@@
 const struct tcp_sock_af_ops cocci_id@p ;
...
position p;
@@
 struct ip_reply_arg cocci_id@p ;
...
typedef __be32;
@@
 int cocci_id@p ( char * md5_hash , const struct tcp_md5sig_key * key , __be32 daddr , __be32 saddr , const struct tcphdr * th ) ;
...
position p;
@@
 struct inet_hashinfo cocci_id@p ;
...
position p;
@@
 struct inet_timewait_sock * cocci_id@p ;
...
position p;
@@
 struct tcp_timewait_sock cocci_id@p ;
...
position p;
@@
 struct tcp_md5sig_info * cocci_id@p ;
...
position p;
@@
 struct inet_connection_sock * cocci_id@p ;
...
position p;
@@
 struct tcp_md5sig_pool * cocci_id@p ;
...
position p;
@@
 struct tcp_seq_afinfo * cocci_id@p ;
...
position p;
@@
 const struct tcp_sock * cocci_id@p ;
...
position p;
@@
 const struct tcp_iter_state * cocci_id@p ;
...
position p;
@@
 struct tcp_md5sig_key * cocci_id@p ;
...
position p;
@@
 const struct inet_connection_sock * cocci_id@p ;
...
position p;
@@
 const struct tcp_md5sig_key * cocci_id@p ;
...
position p;
@@
 struct inet_listen_hashbucket * cocci_id@p ;
...
position p;
@@
 const struct tcp_md5sig_info * cocci_id@p ;
...
position p;
@@
 const struct tcp_timewait_sock * cocci_id@p ;
...
position p;
@@
 const struct inet_timewait_sock * cocci_id@p ;
...
position p;
@@
 struct tcp_request_sock cocci_id@p ;
...
position p;
@@
 const struct fastopen_queue * cocci_id@p ;
...
position p;
@@
 struct tcp_fastopen_cookie * cocci_id@p ;
...
position p;
@@
 struct inet_request_sock * cocci_id@p ;
...
position p;
@@
 const struct inet_connection_sock_af_ops cocci_id@p ;
...
position p;
@@
 struct request_sock_ops cocci_id@p ;
