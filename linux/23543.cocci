...
position p;
@@
 union interrupt_reg_mrfld cocci_id@p ;
...
position p;
@@
 union sst_imr_reg_mrfld cocci_id@p ;
...
position p;
@@
 union ipc_header_mrfld cocci_id@p ;
...
position p;
@@
 struct intel_sst_ops cocci_id@p ;
