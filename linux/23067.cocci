...
position p;
@@
 const char * cocci_id@p [ MT8173_CLK_NUM ] ;
...
position p;
@@
 struct mt8173_afe_private {  struct clk * clocks [ MT8173_CLK_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct mt8173_afe_rate {  unsigned int rate ;  unsigned int regvalue ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_base_memif_data cocci_id@p [ MT8173_AFE_MEMIF_NUM ] ;
...
position p;
@@
 const struct mtk_base_irq_data cocci_id@p [ MT8173_AFE_IRQ_NUM ] ;
...
position p;
@@
 struct mt8173_afe_private * cocci_id@p ;
...
position p;
@@
 enum afe_tdm_ch_start { AFE_TDM_CH_START_O30_O31 = 0 , AFE_TDM_CH_START_O32_O33 , AFE_TDM_CH_START_O34_O35 , AFE_TDM_CH_START_O36_O37 , AFE_TDM_CH_ZERO , } cocci_id@p ;
...
position p;
@@
 const struct mt8173_afe_rate cocci_id@p [ ] ;
