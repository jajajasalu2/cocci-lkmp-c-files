...
position p;
@@
 struct pn544_i2c_fw_secure_blob * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ PN544_HCI_I2C_LLC_MAX_SIZE - 1 ] ;
...
position p;
@@
 struct pn544_i2c_phy * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ PN544_FW_I2C_MAX_PAYLOAD ] ;
...
position p;
@@
 struct pn544_i2c_fw_secure_frame * cocci_id@p ;
...
position p;
@@
 struct pn544_i2c_fw_frame_response cocci_id@p ;
...
position p;
@@
 struct pn544_i2c_fw_blob * cocci_id@p ;
...
typedef u8,u64;
@@
 struct pn544_i2c_fw_secure_blob {  u64 header ;  u8 data [ ] ; } cocci_id@p ;
...
position p;
@@
 struct pn544_i2c_fw_frame_write * cocci_id@p ;
...
typedef u8,u32;
@@
 struct pn544_i2c_fw_blob {  u32 be_size ;  u32 be_destaddr ;  u8 data [ ] ; } cocci_id@p ;
...
position p;
@@
 struct pn544_i2c_fw_frame_check cocci_id@p ;
