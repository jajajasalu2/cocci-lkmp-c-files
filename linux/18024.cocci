...
symbol cocci_id;
position p;
typedef tag_storage_desc_t;
@@
 tag_storage_desc_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long old_tsb_base , unsigned long old_tsb_size , unsigned long new_tsb_base , unsigned long new_tsb_size , unsigned long page_size_shift ) ;
...
position p;
@@
 struct hv_tsb_descr * cocci_id@p ;
