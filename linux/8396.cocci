...
position p;
@@
 struct nfp_flower_meta_tci * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_act_head * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_set_ipv4_tun * cocci_id@p ;
...
position p;
@@
 enum nfp_flower_tun_type * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_merge_check {  union {  struct {  __be16 tci ;  struct nfp_flower_mac_mpls l2 ;  struct nfp_flower_tp_ports l4 ;  union {  struct nfp_flower_ipv4 ipv4 ;  struct nfp_flower_ipv6 ipv6 ; } ; } ;  unsigned long vals [ 8 ] ; } ; } cocci_id@p ;
...
position p;
@@
 struct nfp_flower_merge_check * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_tp_ports cocci_id@p ;
...
position p;
@@
 struct nfp_fl_push_vlan cocci_id@p ;
...
position p;
@@
 struct nfp_flower_ext_meta cocci_id@p ;
...
position p;
@@
 struct nfp_fl_payload_link cocci_id@p ;
...
position p;
@@
 struct nfp_fl_set_eth * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_ipv4 cocci_id@p ;
...
position p;
@@
 struct nfp_flower_indr_block_cb_priv * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_geneve_options cocci_id@p ;
...
position p;
@@
 struct nfp_fl_set_ipv6_tc_hl_fl * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_key_ls * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_ipv6 cocci_id@p ;
...
position p;
@@
 struct flow_match_enc_opts cocci_id@p ;
...
position p;
@@
 struct nfp_flower_mac_mpls cocci_id@p ;
...
position p;
@@
 struct nfp_flower_ipv4_udp_tun cocci_id@p ;
...
position p;
@@
 struct nfp_fl_set_tport * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_set_ip4_ttl_tos * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_in_port cocci_id@p ;
...
position p;
@@
 struct nfp_fl_set_ip4_addrs * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_set_ipv6_addr * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_rule_metadata cocci_id@p ;
...
position p;
@@
 struct nfp_flower_indr_block_cb_priv {  struct net_device * netdev ;  struct nfp_app * app ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct nfp_fl_output cocci_id@p ;
...
position p;
@@
 struct nfp_flower_ipv4_gre_tun cocci_id@p ;
