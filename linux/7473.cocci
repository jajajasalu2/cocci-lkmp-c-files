...
position p;
@@
 struct dlfb_deferred_free {  struct list_head list ;  void * mem ; } cocci_id@p ;
...
typedef uint8_t;
@@
 const uint8_t * const cocci_id@p ;
...
position p;
@@
 struct dlfb_deferred_free cocci_id@p ;
...
typedef uint16_t;
@@
 const uint16_t * const cocci_id@p ;
...
position p;
@@
 struct urb * cocci_id@p ( struct dlfb_data * dlfb ) ;
...
position p;
@@
 void cocci_id@p ( struct dlfb_data * dlfb ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct dlfb_data * dlfb , struct fb_info * info , u32 new_len ) ;
