...
position p;
@@
 struct lpc32xx_clock_event_ddata * cocci_id@p ;
...
typedef u32;
@@
 struct lpc32xx_clock_event_ddata {  struct clock_event_device evtdev ;  void __iomem * base ;  u32 ticks_per_jiffy ; } cocci_id@p ;
