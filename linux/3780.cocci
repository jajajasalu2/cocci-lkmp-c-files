...
typedef u32;
@@
 struct ixp_aead_alg {  struct aead_alg crypto ;  const struct ix_hash_algo * hash ;  u32 cfg_enc ;  u32 cfg_dec ;  int registered ; } cocci_id@p ;
...
position p;
@@
 struct ixp_aead_alg cocci_id@p [ ] ;
...
@@
 struct ix_sa_dir {  unsigned char * npe_ctx ;  dma_addr_t npe_ctx_phys ;  int npe_ctx_idx ;  u8 npe_mode ; } cocci_id@p ;
...
position p;
@@
 struct ablk_ctx {  struct buffer_desc * src ;  struct buffer_desc * dst ; } cocci_id@p ;
...
typedef u32;
@@
 struct ix_hash_algo {  u32 cfgword ;  unsigned char * icv ; } cocci_id@p ;
...
position p;
@@
 const struct ix_hash_algo cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CTR_RFC3686_BLOCK_SIZE ] ;
...
typedef u8,atomic_t;
@@
 struct ixp_ctx {  struct ix_sa_dir encrypt ;  struct ix_sa_dir decrypt ;  int authkey_len ;  u8 authkey [ MAX_KEYLEN ] ;  int enckey_len ;  u8 enckey [ MAX_KEYLEN ] ;  u8 salt [ MAX_IVLEN ] ;  u8 nonce [ CTR_RFC3686_NONCE_SIZE ] ;  unsigned salted ;  atomic_t configuring ;  struct completion completion ; } cocci_id@p ;
...
typedef u8;
@@
 struct aead_ctx {  struct buffer_desc * src ;  struct buffer_desc * dst ;  struct scatterlist ivlist ;  u8 * hmac_virt ;  int encrypt ; } cocci_id@p ;
...
typedef u32;
@@
 struct ixp_alg {  struct skcipher_alg crypto ;  const struct ix_hash_algo * hash ;  u32 cfg_enc ;  u32 cfg_dec ;  int registered ; } cocci_id@p ;
