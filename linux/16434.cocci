...
typedef spinlock_t;
@@
 struct appleir {  struct input_dev * input_dev ;  struct hid_device * hid ;  unsigned short keymap [ ARRAY_SIZE ( appleir_key_table ) ] ;  struct timer_list key_up_timer ;  spinlock_t lock ;  int current_key ;  int prev_key_idx ; } cocci_id@p ;
