...
position p;
@@
 struct nfsd4_voidargs {  int dummy ; } cocci_id@p ;
...
position p;
@@
 struct nfsd4_verify * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( nfsd_procedures4 ) ] ;
...
position p;
@@
 const struct nfsd4_layout_seg * cocci_id@p ;
...
position p;
@@
 const struct svc_procedure cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct svc_version cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p ( unsigned opnum ) ;
...
position p;
@@
 struct nfsd4_voidres cocci_id@p ;
...
position p;
@@
 struct nfsd4_voidargs cocci_id@p ;
...
position p;
@@
 struct nfsd4_deviceid_map * cocci_id@p ;
