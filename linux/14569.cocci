...
position p;
@@
 struct clk_omap_divider * cocci_id@p ;
...
position p;
@@
 struct clk_omap_mux * cocci_id@p ;
...
position p;
@@
 union omap4_timeout cocci_id@p ;
...
position p;
@@
 const struct omap_clkctrl_data * cocci_id@p ;
...
typedef u16;
@@
 struct omap_clkctrl_clk {  struct clk_hw * clk ;  u16 reg_offset ;  int bit_offset ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 const struct omap_clkctrl_reg_data * cocci_id@p ;
...
position p;
@@
 const struct omap_clkctrl_bit_data * cocci_id@p ;
...
typedef u32,ktime_t;
@@
 union omap4_timeout {  u32 cycles ;  ktime_t start ; } cocci_id@p ;
...
position p;
@@
 const struct omap_clkctrl_div_data * cocci_id@p ;
...
position p;
@@
 struct omap_clkctrl_provider * cocci_id@p ;
...
position p;
@@
 struct omap_clkctrl_provider {  void __iomem * base ;  struct list_head clocks ;  char * clkdm_name ; } cocci_id@p ;
...
position p;
@@
 struct omap_clkctrl_clk * cocci_id@p ;
