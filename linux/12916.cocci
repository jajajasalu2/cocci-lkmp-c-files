...
position p;
@@
 struct atmtcp_control cocci_id@p ;
...
position p;
@@
 const struct atmtcp_control * cocci_id@p ;
...
position p;
@@
 struct atmtcp_dev_data * cocci_id@p ;
...
position p;
@@
 struct atmtcp_dev_data {  struct atm_vcc * vcc ;  int persist ; } cocci_id@p ;
