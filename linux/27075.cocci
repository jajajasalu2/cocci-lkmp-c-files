...
position p;
@@
 struct xchk_rmap_ownedby_info cocci_id@p ;
...
typedef xfs_filblks_t;
@@
 struct xchk_rmap_ownedby_info {  const struct xfs_owner_info * oinfo ;  xfs_filblks_t * blocks ; } cocci_id@p ;
