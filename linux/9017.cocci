...
position p;
@@
 struct mlx4_cmd_context * cocci_id@p ;
...
typedef u8,u64,u16;
@@
 struct mlx4_cmd_context {  struct completion done ;  int result ;  int next ;  u64 out_param ;  u16 token ;  u8 fw_status ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mlx4_dev * dev , int slave , struct mlx4_vhcr_cmd * in_vhcr ) ;
...
position p;
@@
 enum mlx4_vlan_transition { MLX4_VLAN_TRANSITION_VST_VST = 0 , MLX4_VLAN_TRANSITION_VST_VGT = 1 , MLX4_VLAN_TRANSITION_VGT_VST = 2 , MLX4_VLAN_TRANSITION_VGT_VGT = 3 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_vport_state cocci_id@p ;
...
position p;
@@
 struct mlx4_vport_qos_param cocci_id@p [ MLX4_NUM_UP ] ;
...
position p;
@@
 enum { GO_BIT_TIMEOUT_MSECS = 10000 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_mfunc_master_ctx * cocci_id@p ;
...
position p;
@@
 struct mlx4_vf_admin_state cocci_id@p ;
...
position p;
@@
 struct mlx4_vlan_fltr cocci_id@p ;
...
position p;
@@
 struct mlx4_vport_qos_param cocci_id@p ;
...
position p;
@@
 struct mlx4_vf_oper_state cocci_id@p ;
...
position p;
@@
 struct mlx4_qos_manager * cocci_id@p ;
...
position p;
@@
 const struct mlx4_active_ports * cocci_id@p ;
...
position p;
@@
 enum { HCR_IN_PARAM_OFFSET = 0x00 , HCR_IN_MODIFIER_OFFSET = 0x08 , HCR_OUT_PARAM_OFFSET = 0x0c , HCR_TOKEN_OFFSET = 0x14 , HCR_STATUS_OFFSET = 0x18 , HCR_OPMOD_SHIFT = 12 , HCR_T_BIT = 21 , HCR_E_BIT = 22 , HCR_GO_BIT = 23 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_vhcr_cmd cocci_id@p ;
