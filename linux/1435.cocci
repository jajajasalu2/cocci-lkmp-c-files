...
position p;
@@
 void cocci_id@p ( struct mv_u3d * u3d , struct usb_gadget_driver * driver ) ;
...
position p;
@@
 void cocci_id@p ( struct mv_u3d_ep * ep , int status ) ;
...
position p;
@@
 struct mv_u3d_ep_context * cocci_id@p ;
...
position p;
@@
 struct mv_u3d_trb_hw cocci_id@p ;
