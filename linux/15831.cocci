...
typedef u8;
@@
 void cocci_id@p ( u8 * a , u8 * b , u8 * out ) ;
...
typedef u8,uint;
@@
 void cocci_id@p ( u8 * mic_header1 , sint qc_exists , sint a4_exists , u8 * mpdu , uint payload_length , u8 * pn_vector , uint frtype ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * ina , u8 * inb , u8 * out ) ;
...
typedef u8,u32;
@@
 struct arc4context {  u32 x ;  u32 y ;  u8 state [ 256 ] ; } cocci_id@p ;
...
typedef u8,uint;
@@
 void cocci_id@p ( u8 * mic_header1 , sint header_length , u8 * mpdu , uint frtype ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * key , sint round ) ;
...
typedef u8,uint;
@@
 void cocci_id@p ( u8 * ctr_preload , sint a4_exists , sint qc_exists , u8 * mpdu , u8 * pn_vector , sint c , uint frtype ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * mic_header2 , u8 * mpdu , sint a4_exists , sint qc_exists ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * key , u8 * data , u8 * ciphertext ) ;
...
position p;
@@
 const unsigned short cocci_id@p [ 2 ] [ 256 ] ;
