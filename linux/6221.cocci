...
position p;
@@
 struct lp8788_irq_data {  struct lp8788 * lp ;  struct mutex irq_lock ;  struct irq_domain * domain ;  int enabled [ LP8788_INT_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct lp8788_irq_data * cocci_id@p ;
