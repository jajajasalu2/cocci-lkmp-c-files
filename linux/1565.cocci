...
position p;
@@
 struct ark3116_private * cocci_id@p ;
...
@@
 struct ark3116_private {  int irda ;  struct mutex hw_lock ;  int quot ;  __u32 lcr ;  __u32 hcr ;  __u32 mcr ;  spinlock_t status_lock ;  __u32 msr ;  __u32 lsr ; } cocci_id@p ;
