...
position p;
@@
 struct i2c_device_identity * cocci_id@p ;
...
position p;
@@
 struct i2c_dummy_devres * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct i2c_adapter * adap , unsigned short addr ) ;
...
position p;
@@
 int cocci_id@p ( struct i2c_adapter * adapter , struct i2c_driver * driver ) ;
...
position p;
@@
 struct class_compat * cocci_id@p ;
...
position p;
@@
 struct i2c_dummy_devres {  struct i2c_client * client ; } cocci_id@p ;
...
position p;
@@
 struct i2c_cmd_arg {  unsigned cmd ;  void * arg ; } cocci_id@p ;
