...
position p;
@@
 struct bmi_target_info * cocci_id@p ;
...
position p;
@@
 struct ath10k_snoc_pipe * cocci_id@p ;
...
position p;
@@
 const struct ath10k_snoc_drv_priv cocci_id@p ;
...
position p;
@@
 struct ath10k_svc_pipe_cfg cocci_id@p ;
...
position p;
@@
 struct ath10k_tgt_pipe_cfg cocci_id@p [ CE_COUNT_MAX ] ;
...
position p;
@@
 struct ath10k_shadow_reg_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct ath10k_tgt_pipe_cfg cocci_id@p ;
