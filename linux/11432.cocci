...
typedef u8,u64;
@@
 struct usif_object {  struct list_head head ;  struct list_head ntfy ;  u8 route ;  u64 token ; } cocci_id@p ;
...
position p;
@@
 struct nvif_notify_rep_v0 cocci_id@p ;
...
typedef u8;
@@
 struct usif_notify_p {  struct drm_pending_event base ;  struct {  struct drm_event base ;  u8 data [ ] ; } e ; } cocci_id@p ;
...
position p;
@@
 const union {  struct nvif_notify_rep_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_notify_req_v0 v0 ; } * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u64,u32,u16,atomic_t;
@@
 struct usif_notify {  struct list_head head ;  atomic_t enabled ;  u32 handle ;  u16 reply ;  u8 route ;  u64 token ;  struct usif_notify_p * p ; } cocci_id@p ;
