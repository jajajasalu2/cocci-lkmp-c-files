...
position p;
@@
 const struct imx074_datafmt * cocci_id@p ;
...
typedef u32;
@@
 struct imx074_datafmt {  u32 code ;  enum v4l2_colorspace colorspace ; } cocci_id@p ;
...
position p;
@@
 struct imx074 {  struct v4l2_subdev subdev ;  const struct imx074_datafmt * fmt ;  struct v4l2_clk * clk ; } cocci_id@p ;
