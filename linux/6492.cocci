...
position p;
@@
 struct visor_controlvm_channel cocci_id@p ;
...
position p;
@@
 struct efi_visor_indication cocci_id@p ;
...
position p;
@@
 enum crash_obj_type cocci_id@p ;
...
position p;
@@
 struct parahotplug_request {  struct list_head list ;  int id ;  unsigned long expiration ;  struct controlvm_message msg ; } cocci_id@p ;
...
position p;
@@
 struct parser_context * cocci_id@p ;
...
typedef u8,bool;
@@
 struct parser_context {  unsigned long allocbytes ;  unsigned long param_bytes ;  u8 * curr ;  unsigned long bytes_remaining ;  bool byte_stream ;  struct visor_controlvm_parameters_header data ; } cocci_id@p ;
...
position p;
@@
 struct controlvm_message_packet * cocci_id@p ;
...
position p;
@@
 struct visorchipset_device * cocci_id@p ;
...
position p;
@@
 enum visor_chipset_feature cocci_id@p ;
...
position p;
@@
 struct parahotplug_request * cocci_id@p ;
...
position p;
@@
 struct controlvm_message_header * cocci_id@p ;
...
position p;
@@
 struct visor_controlvm_parameters_header cocci_id@p ;
...
position p;
@@
 enum vmcall_result { VMCALL_RESULT_SUCCESS = 0 , VMCALL_RESULT_INVALID_PARAM = 1 , VMCALL_RESULT_DATA_UNAVAILABLE = 2 , VMCALL_RESULT_FAILURE_UNAVAILABLE = 3 , VMCALL_RESULT_DEVICE_ERROR = 4 , VMCALL_RESULT_DEVICE_NOT_READY = 5 , } cocci_id@p ;
...
position p;
@@
 enum crash_obj_type { CRASH_DEV , CRASH_BUS , } cocci_id@p ;
...
position p;
@@
 struct controlvm_message cocci_id@p ;
...
typedef bool;
@@
 struct visorchipset_device {  struct acpi_device * acpi_device ;  unsigned long poll_jiffies ;  unsigned long most_recent_message_jiffies ;  struct delayed_work periodic_controlvm_work ;  struct visorchannel * controlvm_channel ;  unsigned long controlvm_payload_bytes_buffered ;  struct controlvm_message controlvm_pending_msg ;  bool controlvm_pending_msg_valid ;  struct vmcall_io_controlvm_addr_params controlvm_params ; } cocci_id@p ;
...
position p;
@@
 struct visor_segment_state cocci_id@p ;
...
position p;
@@
 struct visor_device * cocci_id@p ;
...
position p;
@@
 struct visorchannel * cocci_id@p ;
