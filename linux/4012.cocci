...
position p;
@@
 struct combiner_reg {  void __iomem * addr ;  unsigned long enabled ; } cocci_id@p ;
...
position p;
@@
 struct combiner_reg * cocci_id@p ;
...
position p;
@@
 struct get_registers_context cocci_id@p ;
...
position p;
@@
 struct get_registers_context {  struct device * dev ;  struct combiner * combiner ;  int err ; } cocci_id@p ;
...
typedef u32;
@@
 struct combiner {  struct irq_domain * domain ;  int parent_irq ;  u32 nirqs ;  u32 nregs ;  struct combiner_reg regs [ 0 ] ; } cocci_id@p ;
