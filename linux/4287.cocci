...
position p;
@@
 struct wmi_smbios_priv cocci_id@p ;
...
position p;
@@
 struct misc_bios_flags_structure cocci_id@p ;
...
typedef u32;
@@
 struct wmi_smbios_priv {  struct dell_wmi_smbios_buffer * buf ;  struct list_head list ;  struct wmi_device * wdev ;  struct device * child ;  u32 req_buf_size ; } cocci_id@p ;
