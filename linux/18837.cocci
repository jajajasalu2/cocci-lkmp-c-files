...
position p;
@@
 struct smc91x_platdata cocci_id@p ;
...
position p;
@@
 struct mainstone_led * cocci_id@p ;
...
position p;
@@
 const struct {  const char * name ;  const char * trigger ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 struct mainstone_led {  struct led_classdev cdev ;  u8 mask ; } cocci_id@p ;
...
position p;
@@
 struct flash_platform_data cocci_id@p [ 2 ] ;
