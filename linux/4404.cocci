...
position p;
@@
 struct tpm_bank_info * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ TPM2_PCR_SELECT_MIN ] ;
...
position p;
@@
 struct tpm2_pcr_read_out * cocci_id@p ;
...
position p;
@@
 struct tpm2_get_random_out cocci_id@p ;
...
position p;
@@
 struct tpm2_null_auth_area cocci_id@p ;
...
position p;
@@
 struct tpm2_get_cap_out * cocci_id@p ;
...
position p;
@@
 struct tpm2_pcr_selection cocci_id@p ;
