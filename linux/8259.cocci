...
typedef bool;
@@
 bool cocci_id@p ( struct efx_nic * efx ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct efx_nic * efx , bool driver_operating , bool * was_attached_out ) ;
...
position p;
@@
 struct efx_mtd_partition * cocci_id@p ;
...
position p;
@@
 struct efx_mcdi_async_param cocci_id@p ;
...
typedef bool;
@@
 struct efx_mcdi_async_param {  struct list_head list ;  unsigned int cmd ;  size_t inlen ;  size_t outlen ;  bool quiet ;  efx_mcdi_async_completer * complete ;  unsigned long cookie ; } cocci_id@p ;
