...
typedef u8,bool;
@@
 struct cros_ec_bs_map {  unsigned int ev_type ;  unsigned int code ;  u8 bit ;  bool inverted ; } cocci_id@p ;
...
position p;
@@
 const struct cros_ec_bs_map * cocci_id@p ;
...
position p;
@@
 struct cros_ec_keyb * cocci_id@p ;
...
position p;
@@
 enum ec_mkbp_info_type cocci_id@p ;
...
@@
 struct cros_ec_keyb {  unsigned int rows ;  unsigned int cols ;  int row_shift ;  const struct matrix_keymap_data * keymap_data ;  bool ghost_filter ;  uint8_t * valid_keys ;  uint8_t * old_kb_state ;  struct device * dev ;  struct cros_ec_device * ec ;  struct input_dev * idev ;  struct input_dev * bs_idev ;  struct notifier_block notifier ; } cocci_id@p ;
...
position p;
@@
 union ec_response_get_next_data * cocci_id@p ;
