...
position p;
@@
 struct se_dev_attrib * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ LU_GROUP_NAME_BUF ] ;
...
position p;
@@
 char cocci_id@p [ TARGET_CORE_NAME_MAX_LEN ] ;
...
position p;
@@
 unsigned char cocci_id@p [ INQUIRY_REVISION_LEN + 2 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ TG_PT_GROUP_NAME_BUF ] ;
...
position p;
@@
 unsigned char cocci_id@p [ INQUIRY_VENDOR_LEN + 2 ] ;
...
position p;
@@
 struct target_backend * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ INQUIRY_MODEL_LEN + 2 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ INQUIRY_VPD_SERIAL_LEN ] ;
