...
position p;
@@
 struct kvaser_pciefd_cfg_img * cocci_id@p ;
...
position p;
@@
 struct kvaser_pciefd_rx_packet * cocci_id@p ;
...
position p;
@@
 struct kvaser_pciefd * cocci_id@p ;
...
position p;
@@
 struct kvaser_pciefd_tx_packet cocci_id@p ;
...
typedef __le32;
@@
 struct kvaser_pciefd_cfg_img {  __le32 version ;  __le32 magic ;  __le32 crc ;  struct kvaser_pciefd_cfg_param params [ KVASER_PCIEFD_CFG_MAX_PARAMS ] ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct kvaser_pciefd_cfg_param {  __le32 magic ;  __le32 nr ;  __le32 len ;  u8 data [ KVASER_PCIEFD_CFG_PARAM_MAX_SZ ] ; } cocci_id@p ;
...
position p;
@@
 struct kvaser_pciefd_can * cocci_id@p ;
...
typedef u8,u32;
@@
 struct kvaser_pciefd {  struct pci_dev * pci ;  void __iomem * reg_base ;  struct kvaser_pciefd_can * can [ KVASER_PCIEFD_MAX_CAN_CHANNELS ] ;  void * dma_data [ KVASER_PCIEFD_DMA_COUNT ] ;  u8 nr_channels ;  u32 bus_freq ;  u32 freq ;  u32 freq_to_ticks_div ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct kvaser_pciefd_rx_packet {  u32 header [ 2 ] ;  u64 timestamp ; } cocci_id@p ;
...
position p;
@@
 struct kvaser_pciefd_cfg_param * cocci_id@p ;
...
typedef u8,u32;
@@
 struct kvaser_pciefd_tx_packet {  u32 header [ 2 ] ;  u8 data [ 64 ] ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 dma_addr_t cocci_id@p [ KVASER_PCIEFD_DMA_COUNT ] ;
