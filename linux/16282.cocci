...
typedef u8;
@@
 struct vp8_prob_tbl_packed {  u8 prob_mb_skip_false ;  u8 prob_intra ;  u8 prob_ref_last ;  u8 prob_ref_golden ;  u8 prob_segment [ 3 ] ;  u8 padding0 ;  u8 prob_luma_16x16_pred_mode [ 4 ] ;  u8 prob_chroma_pred_mode [ 3 ] ;  u8 padding1 ;  u8 prob_mv_context [ 2 ] [ 19 ] ;  u8 padding2 [ 2 ] ;  u8 prob_coeffs [ 4 ] [ 8 ] [ 3 ] [ 11 ] ;  u8 padding3 [ 96 ] ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_vp8_entropy_header * cocci_id@p ;
...
position p;
@@
 struct hantro_vp8_dec_hw_ctx * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_vp8_frame_header * cocci_id@p ;
...
position p;
@@
 struct vp8_prob_tbl_packed cocci_id@p ;
