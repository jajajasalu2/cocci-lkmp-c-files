...
position p;
@@
 struct ia64_sal_desc_ap_wakeup * cocci_id@p ;
...
position p;
@@
 struct ia64_sal_desc_platform_feature * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ia64_sal_desc_ptc_t;
@@
 ia64_sal_desc_ptc_t * cocci_id@p ;
...
position p;
@@
 struct ia64_sal_desc_entry_point * cocci_id@p ;
...
position p;
@@
 struct {  void * addr ;  void * gpval ; } cocci_id@p ;
