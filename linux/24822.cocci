...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_HASH_MAX + 1 ] ;
...
typedef u8,bool,u32;
@@
 struct nft_jhash {  enum nft_registers sreg : 8 ;  enum nft_registers dreg : 8 ;  u8 len ;  bool autogen_seed : 1 ;  u32 modulus ;  u32 seed ;  u32 offset ; } cocci_id@p ;
...
position p;
@@
 const struct nft_jhash * cocci_id@p ;
...
position p;
@@
 const struct nft_symhash * cocci_id@p ;
...
typedef u32;
@@
 struct nft_symhash {  enum nft_registers dreg : 8 ;  u32 modulus ;  u32 offset ; } cocci_id@p ;
