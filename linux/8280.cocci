...
position p;
@@
 struct efx_farch_filter_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct efx_nic * efx , struct efx_farch_filter_table * table , unsigned int filter_idx ) ;
...
position p;
@@
 enum efx_farch_filter_table_id { EFX_FARCH_FILTER_TABLE_RX_IP = 0 , EFX_FARCH_FILTER_TABLE_RX_MAC , EFX_FARCH_FILTER_TABLE_RX_DEF , EFX_FARCH_FILTER_TABLE_TX_MAC , EFX_FARCH_FILTER_TABLE_COUNT , } cocci_id@p ;
...
position p;
@@
 union efx_multicast_hash * cocci_id@p ;
...
position p;
@@
 struct efx_farch_filter_spec * cocci_id@p ;
...
position p;
@@
 struct efx_special_buffer * cocci_id@p ;
...
position p;
@@
 enum efx_farch_filter_index { EFX_FARCH_FILTER_INDEX_UC_DEF , EFX_FARCH_FILTER_INDEX_MC_DEF , EFX_FARCH_FILTER_SIZE_RX_DEF , } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct efx_farch_filter_spec {  u8 type : 4 ;  u8 priority : 4 ;  u8 flags ;  u16 dmaq_id ;  u32 data [ 3 ] ; } cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct efx_channel * channel , u32 magic ) ;
...
position p;
@@
 const struct efx_farch_register_test * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ EFX_FARCH_FILTER_TYPE_COUNT ] ;
...
position p;
@@
 const struct efx_farch_filter_spec * cocci_id@p ;
...
position p;
@@
 struct efx_farch_filter_table * cocci_id@p ;
...
position p;
@@
 enum efx_farch_filter_table_id cocci_id@p ;
...
position p;
@@
 struct siena_nic_data * cocci_id@p ;
...
position p;
@@
 const enum efx_farch_filter_table_id cocci_id@p [ ] ;
...
typedef u32;
@@
 struct efx_farch_filter_table {  enum efx_farch_filter_table_id id ;  u32 offset ;  unsigned size ;  unsigned step ;  unsigned used ;  unsigned long * used_bitmap ;  struct efx_farch_filter_spec * spec ;  unsigned search_limit [ EFX_FARCH_FILTER_TYPE_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct efx_farch_filter_state {  struct rw_semaphore lock ;  struct efx_farch_filter_table table [ EFX_FARCH_FILTER_TABLE_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 enum efx_farch_filter_type { EFX_FARCH_FILTER_TCP_FULL = 0 , EFX_FARCH_FILTER_TCP_WILD , EFX_FARCH_FILTER_UDP_FULL , EFX_FARCH_FILTER_UDP_WILD , EFX_FARCH_FILTER_MAC_FULL = 4 , EFX_FARCH_FILTER_MAC_WILD , EFX_FARCH_FILTER_UC_DEF = 8 , EFX_FARCH_FILTER_MC_DEF , EFX_FARCH_FILTER_TYPE_COUNT , } cocci_id@p ;
