...
typedef bool,u32;
@@
 struct mtk_dsi_driver_data {  const u32 reg_cmdq_off ;  bool has_shadow_ctl ;  bool has_size_ctl ; } cocci_id@p ;
...
typedef u32;
@@
 struct mtk_phy_timing {  u32 lpx ;  u32 da_hs_prepare ;  u32 da_hs_zero ;  u32 da_hs_trail ;  u32 ta_go ;  u32 ta_sure ;  u32 ta_get ;  u32 da_hs_exit ;  u32 clk_hs_zero ;  u32 clk_hs_trail ;  u32 clk_hs_prepare ;  u32 clk_hs_post ;  u32 clk_hs_exit ; } cocci_id@p ;
...
position p;
@@
 struct mtk_phy_timing * cocci_id@p ;
...
position p;
@@
 const struct mtk_dsi_driver_data cocci_id@p ;
