...
position p;
@@
 union myrs_cmd_mbox * cocci_id@p ;
...
position p;
@@
 struct {  int ev_code ;  unsigned char * ev_msg ; } cocci_id@p [ ] ;
...
position p;
@@
 unsigned char cocci_id@p [ MYRS_LINE_BUFFER_SIZE ] ;
...
position p;
@@
 struct myrs_ctlr_info * cocci_id@p ;
...
position p;
@@
 struct myrs_devstate_name_entry * cocci_id@p ;
...
position p;
@@
 struct myrs_ldev_info cocci_id@p ;
...
position p;
@@
 struct myrs_stat_mbox * cocci_id@p ;
...
position p;
@@
 struct myrs_cpu_type_tbl {  enum myrs_cpu_type type ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct myrs_cpu_type_tbl * cocci_id@p ;
...
position p;
@@
 struct myrs_raid_level_name_entry {  enum myrs_raid_level level ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 enum myrs_raid_level cocci_id@p ;
...
position p;
@@
 enum myrs_ioctl_opcode cocci_id@p ;
...
symbol cocci_id;
position p;
typedef enable_mbox_t;
@@
 enable_mbox_t cocci_id@p ;
...
position p;
@@
 struct myrs_privdata * cocci_id@p ;
...
position p;
@@
 struct myrs_pdev_info * cocci_id@p ;
...
position p;
@@
 struct myrs_devstate_name_entry {  enum myrs_devstate state ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct myrs_raid_level_name_entry * cocci_id@p ;
