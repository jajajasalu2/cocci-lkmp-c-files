...
typedef u8;
@@
 u8 cocci_id@p [ FS_VERITY_MAX_DIGEST_SIZE ] ;
...
position p;
@@
 unsigned int cocci_id@p [ FS_VERITY_MAX_LEVELS ] ;
...
position p;
@@
 struct page * cocci_id@p [ FS_VERITY_MAX_LEVELS ] ;
...
position p;
@@
 const struct merkle_tree_params * cocci_id@p ;
...
position p;
@@
 const struct fsverity_info * cocci_id@p ;
