...
position p;
@@
 struct build_release_number * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ WCN36XX_TM_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ WCN36XX_TM_ATTR_MAX + 1 ] ;
