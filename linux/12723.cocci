...
position p;
@@
 struct virtio_iommu_req_map cocci_id@p ;
...
position p;
@@
 struct viommu_event * cocci_id@p ;
...
position p;
@@
 struct virtio_iommu_probe_property * cocci_id@p ;
...
position p;
@@
 struct virtio_iommu_req_tail * cocci_id@p ;
...
position p;
@@
 struct viommu_domain * cocci_id@p ;
...
position p;
@@
 struct viommu_mapping * cocci_id@p ;
...
position p;
@@
 struct interval_tree_node * cocci_id@p ;
...
position p;
@@
 struct virtio_iommu_probe_resv_mem * cocci_id@p ;
...
position p;
@@
 struct viommu_endpoint * cocci_id@p ;
...
@@
 struct viommu_domain {  struct iommu_domain domain ;  struct viommu_dev * viommu ;  struct mutex mutex ;  unsigned int id ;  u32 map_flags ;  spinlock_t mappings_lock ;  struct rb_root_cached mappings ;  unsigned long nr_endpoints ; } cocci_id@p ;
...
position p;
@@
 struct viommu_request * cocci_id@p ;
...
position p;
@@
 struct viommu_endpoint {  struct device * dev ;  struct viommu_dev * viommu ;  struct viommu_domain * vdomain ;  struct list_head resv_regions ; } cocci_id@p ;
...
position p;
@@
 struct virtio_iommu_fault * cocci_id@p ;
...
position p;
@@
 struct viommu_request {  struct list_head list ;  void * writeback ;  unsigned int write_offset ;  unsigned int len ;  char buf [ ] ; } cocci_id@p ;
...
position p;
@@
 struct virtio_iommu_req_unmap cocci_id@p ;
...
@@
 struct viommu_mapping {  phys_addr_t paddr ;  struct interval_tree_node iova ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 struct virtio_iommu_req_probe * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u32,spinlock_t;
@@
 struct viommu_dev {  struct iommu_device iommu ;  struct device * dev ;  struct virtio_device * vdev ;  struct ida domain_ids ;  struct virtqueue * vqs [ VIOMMU_NR_VQS ] ;  spinlock_t request_lock ;  struct list_head requests ;  void * evts ;  struct iommu_domain_geometry geometry ;  u64 pgsize_bitmap ;  u32 first_domain ;  u32 last_domain ;  u32 map_flags ;  u32 probe_size ; } cocci_id@p ;
...
position p;
@@
 struct virtio_iommu_req_attach cocci_id@p ;
...
position p;
@@
 struct virtio_iommu_config cocci_id@p ;
...
position p;
@@
 struct virtio_iommu_req_head * cocci_id@p ;
...
typedef u32;
@@
 struct viommu_event {  union {  u32 head ;  struct virtio_iommu_fault fault ; } ; } cocci_id@p ;
