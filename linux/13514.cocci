...
typedef bool;
@@
 struct hdpvr_fh {  struct v4l2_fh fh ;  bool legacy_mode ; } cocci_id@p ;
...
position p;
@@
 struct hdpvr_device * cocci_id@p ;
...
position p;
@@
 struct hdpvr_video_info cocci_id@p ;
...
position p;
@@
 struct hdpvr_buffer cocci_id@p ;
...
position p;
@@
 struct hdpvr_options * cocci_id@p ;
