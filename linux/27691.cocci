...
position p;
@@
 int cocci_id@p ( struct dentry * , struct iattr * ) ;
...
position p;
@@
 unsigned long cocci_id@p ( struct file * file , unsigned long addr , unsigned long len , unsigned long pgoff , unsigned long flags ) ;
