...
position p;
@@
 struct qcom_pdc_reset_data * cocci_id@p ;
...
position p;
@@
 const struct qcom_pdc_reset_map cocci_id@p [ ] ;
...
typedef u8;
@@
 struct qcom_pdc_reset_map {  u8 bit ; } cocci_id@p ;
...
position p;
@@
 struct qcom_pdc_reset_data {  struct reset_controller_dev rcdev ;  struct regmap * regmap ; } cocci_id@p ;
