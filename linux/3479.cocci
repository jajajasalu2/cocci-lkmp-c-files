...
position p;
@@
 void cocci_id@p ( struct sdhci_host * host ) ;
...
position p;
@@
 struct sdhci_pci_chip * cocci_id@p ;
...
position p;
@@
 enum amd_chipset_gen cocci_id@p ;
...
position p;
@@
 enum amd_chipset_gen { AMD_CHIPSET_BEFORE_ML , AMD_CHIPSET_CZ , AMD_CHIPSET_NL , AMD_CHIPSET_UNKNOWN , } cocci_id@p ;
...
typedef bool,u32;
@@
 struct intel_host {  u32 dsm_fns ;  int drv_strength ;  bool d3_retune ;  bool rpm_retune_ok ;  u32 glk_rx_ctrl1 ;  u32 glk_tun_val ; } cocci_id@p ;
...
position p;
@@
 const struct sdhci_pci_fixes * cocci_id@p ;
...
position p;
@@
 struct sdhci_pci_slot * cocci_id@p ;
...
position p;
@@
 struct mmc_host_ops * cocci_id@p ;
...
position p;
@@
 enum { INTEL_DSM_FNS = 0 , INTEL_DSM_V18_SWITCH = 3 , INTEL_DSM_V33_SWITCH = 4 , INTEL_DSM_DRV_STRENGTH = 9 , INTEL_DSM_D3_RETUNE = 10 , } cocci_id@p ;
