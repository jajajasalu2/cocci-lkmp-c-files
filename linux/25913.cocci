...
position p;
@@
 struct pkey_malloc_record * cocci_id@p ;
...
position p;
@@
 struct pkey_malloc_record {  void * ptr ;  long size ;  int prot ; } cocci_id@p ;
...
typedef u16;
@@
 void ( * cocci_id@p [ ] ) ( int * ptr , u16 pkey ) ;
...
typedef u16;
@@
 void * ( * cocci_id@p [ ] ) ( long size , int prot , u16 pkey ) ;
...
position p;
@@
 char cocci_id@p [ DPRINT_IN_SIGNAL_BUF_SIZE ] ;
