...
position p;
@@
 struct artpec6_hash_request_context cocci_id@p ;
...
typedef spinlock_t;
@@
 struct artpec6_crypto {  void __iomem * base ;  spinlock_t queue_lock ;  struct list_head queue ;  struct list_head pending ;  struct tasklet_struct task ;  struct kmem_cache * dma_cache ;  int pending_count ;  struct timer_list timer ;  enum artpec6_crypto_variant variant ;  void * pad_buffer ;  void * zero_buffer ; } cocci_id@p ;
...
position p;
@@
 const struct artpec6_hash_export_state * cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto_request_context * cocci_id@p ;
...
position p;
@@
 enum artpec6_crypto_hash_flags { HASH_FLAG_INIT_CTX = 2 , HASH_FLAG_UPDATE = 4 , HASH_FLAG_FINALIZE = 8 , HASH_FLAG_HMAC = 16 , HASH_FLAG_UPDATE_KEY = 32 , } cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto cocci_id@p ;
...
position p;
@@
 const struct artpec6_hash_request_context * cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto_req_common cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct artpec6_crypto_req_common * common ) ;
...
position p;
@@
 struct pdma_stat_descr {  unsigned char pad1 : 1 ;  unsigned char pad2 : 1 ;  unsigned char eop : 1 ;  unsigned char pad3 : 5 ;  unsigned int len : 24 ; } cocci_id@p ;
...
position p;
@@
 enum { ARTPEC6_CRYPTO_PREPARE_HASH_NO_START , ARTPEC6_CRYPTO_PREPARE_HASH_START , } cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto_dma_map * cocci_id@p ;
...
typedef u32,mode_t;
@@
 struct dbgfs_u32 {  char * name ;  mode_t mode ;  u32 * flag ;  char * desc ; } cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto_walk * cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto_dma_descriptors * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ahash_request * areq ) ;
...
position p;
@@
 struct artpec6_hashalg_context cocci_id@p ;
...
typedef u64;
@@
 struct artpec6_hash_export_state {  char partial_buffer [ SHA256_BLOCK_SIZE ] ;  unsigned char digeststate [ SHA256_DIGEST_SIZE ] ;  size_t partial_bytes ;  u64 digcnt ;  int oper ;  unsigned int hash_flags ; } cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto_aead_req_ctx cocci_id@p ;
...
position p;
@@
 struct artpec6_hash_export_state * cocci_id@p ;
...
position p;
@@
 struct artpec6_hashalg_context {  char hmac_key [ SHA256_BLOCK_SIZE ] ;  size_t hmac_key_length ;  struct crypto_shash * child_hash ; } cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto_walk {  struct scatterlist * sg ;  size_t offset ; } cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto_bounce_buffer cocci_id@p ;
...
position p;
@@
 struct artpec6_cryptotfm_context cocci_id@p ;
...
position p;
@@
 struct crypto_shash * cocci_id@p ;
...
typedef u32;
@@
 struct artpec6_cryptotfm_context {  unsigned char aes_key [ 2 * AES_MAX_KEY_SIZE ] ;  size_t key_length ;  u32 key_md ;  int crypto_type ;  struct crypto_sync_skcipher * fallback ; } cocci_id@p ;
...
position p;
@@
 enum artpec6_crypto_variant cocci_id@p ;
...
position p;
@@
 struct crypto_ahash * cocci_id@p ;
...
position p;
@@
 struct artpec6_crypto_bounce_buffer {  struct list_head list ;  size_t length ;  struct scatterlist * sg ;  size_t offset ;  void * buf ; } cocci_id@p ;
...
position p;
@@
 struct ahash_request * cocci_id@p ;
...
position p;
@@
 enum artpec6_crypto_variant { ARTPEC6_CRYPTO , ARTPEC7_CRYPTO , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,__u8;
@@
 struct artpec6_crypto_aead_req_ctx {  struct artpec6_crypto_aead_hw_ctx hw_ctx ;  u32 cipher_md ;  bool decrypt ;  struct artpec6_crypto_req_common common ;  __u8 decryption_tag [ AES_BLOCK_SIZE ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct skcipher_request * areq ) ;
...
position p;
@@
 int cocci_id@p ( struct aead_request * areq ) ;
...
position p;
@@
 const struct artpec6_crypto_walk * cocci_id@p ;
...
typedef gfp_t;
@@
 struct artpec6_crypto_req_common {  struct list_head list ;  struct list_head complete_in_progress ;  struct artpec6_crypto_dma_descriptors * dma ;  struct crypto_async_request * req ;  void ( * complete ) ( struct crypto_async_request * req ) ;  gfp_t gfp_flags ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct crypto_async_request * req ) ;
...
position p;
@@
 struct artpec6_crypto_aead_hw_ctx cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct artpec6_crypto_req_common * common ) ;
...
typedef __u8,__be64;
@@
 struct artpec6_crypto_aead_hw_ctx {  __be64 aad_length_bits ;  __be64 text_length_bits ;  __u8 J0 [ AES_BLOCK_SIZE ] ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct artpec6_crypto_request_context {  u32 cipher_md ;  bool decrypt ;  struct artpec6_crypto_req_common common ; } cocci_id@p ;
...
position p;
@@
 struct pdma_descr {  struct pdma_descr_ctrl ctrl ;  union {  struct pdma_data_descr data ;  struct pdma_short_descr shrt ; } ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct artpec6_crypto_dma_map {  dma_addr_t dma_addr ;  size_t size ;  enum dma_data_direction dir ; } cocci_id@p ;
