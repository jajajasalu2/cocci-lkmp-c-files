...
position p;
@@
 enum ov2680_mode_id { OV2680_MODE_QUXGA_800_600 , OV2680_MODE_720P_1280_720 , OV2680_MODE_UXGA_1600_1200 , OV2680_MODE_MAX , } cocci_id@p ;
...
position p;
@@
 const struct ov2680_mode_info cocci_id@p ;
...
typedef u8,u16;
@@
 struct reg_value {  u16 reg_addr ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 struct ov2680_ctrls {  struct v4l2_ctrl_handler handler ;  struct {  struct v4l2_ctrl * auto_exp ;  struct v4l2_ctrl * exposure ; } ;  struct {  struct v4l2_ctrl * auto_gain ;  struct v4l2_ctrl * gain ; } ;  struct v4l2_ctrl * hflip ;  struct v4l2_ctrl * vflip ;  struct v4l2_ctrl * test_pattern ; } cocci_id@p ;
...
typedef u32;
@@
 struct ov2680_mode_info {  const char * name ;  enum ov2680_mode_id id ;  u32 width ;  u32 height ;  const struct reg_value * reg_data ;  u32 reg_data_size ; } cocci_id@p ;
...
position p;
@@
 const struct ov2680_mode_info cocci_id@p [ OV2680_MODE_MAX ] ;
...
typedef bool,u32;
@@
 struct ov2680_dev {  struct i2c_client * i2c_client ;  struct v4l2_subdev sd ;  struct media_pad pad ;  struct clk * xvclk ;  u32 xvclk_freq ;  struct regulator_bulk_data supplies [ OV2680_NUM_SUPPLIES ] ;  struct gpio_desc * reset_gpio ;  struct mutex lock ;  bool mode_pending_changes ;  bool is_enabled ;  bool is_streaming ;  struct ov2680_ctrls ctrls ;  struct v4l2_mbus_framefmt fmt ;  struct v4l2_fract frame_interval ;  const struct ov2680_mode_info * current_mode ; } cocci_id@p ;
...
position p;
@@
 struct ov2680_ctrls * cocci_id@p ;
