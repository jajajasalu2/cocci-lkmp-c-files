...
position p;
@@
 struct div4_clk {  const char * name ;  const char * parent ;  unsigned int reg ;  unsigned int shift ; } cocci_id@p ;
...
position p;
@@
 const struct div4_clk * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sh73a0_cpg {  struct clk_onecell_data data ;  spinlock_t lock ;  void __iomem * reg ; } cocci_id@p ;
