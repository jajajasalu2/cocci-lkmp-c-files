...
position p;
@@
 struct skl_wrpll_params cocci_id@p ;
...
position p;
@@
 struct icl_combo_pll_params {  int clock ;  struct skl_wrpll_params wrpll ; } cocci_id@p ;
...
position p;
@@
 struct hsw_wrpll_rnp * cocci_id@p ;
...
position p;
@@
 const struct bxt_clk_div * cocci_id@p ;
...
typedef bool,u32;
@@
 struct bxt_clk_div {  int clock ;  u32 p1 ;  u32 p2 ;  u32 m2_int ;  u32 m2_frac ;  bool m2_frac_en ;  u32 n ;  int vco ; } cocci_id@p ;
...
position p;
@@
 const struct intel_dpll_mgr cocci_id@p ;
...
position p;
@@
 const struct icl_combo_pll_params * cocci_id@p ;
...
position p;
@@
 const struct icl_port_dpll * cocci_id@p ;
...
position p;
@@
 const struct {  const int * list ;  int n_dividers ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct skl_wrpll_params cocci_id@p ;
...
position p;
@@
 struct intel_shared_dpll_state * cocci_id@p ;
...
position p;
@@
 const struct dpll_info cocci_id@p [ ] ;
...
position p;
@@
 struct skl_wrpll_context * cocci_id@p ;
...
position p;
@@
 struct icl_port_dpll * cocci_id@p ;
...
typedef u32;
@@
 struct skl_wrpll_params {  u32 dco_fraction ;  u32 dco_integer ;  u32 qdiv_ratio ;  u32 qdiv_mode ;  u32 kdiv ;  u32 pdiv ;  u32 central_freq ; } cocci_id@p ;
...
position p;
@@
 const struct intel_shared_dpll_funcs cocci_id@p ;
...
position p;
@@
 const struct skl_dpll_regs cocci_id@p [ 4 ] ;
...
typedef u64;
@@
 struct skl_wrpll_context {  u64 min_deviation ;  u64 central_freq ;  u64 dco_freq ;  unsigned int p ; } cocci_id@p ;
...
position p;
@@
 const struct skl_dpll_regs * cocci_id@p ;
