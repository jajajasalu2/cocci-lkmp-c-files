...
symbol cocci_id;
position p;
typedef u64,bool,guid_t,spinlock_t;
@@
 struct visorchannel {  u64 physaddr ;  ulong nbytes ;  void * mapped ;  bool requested ;  struct channel_header chan_hdr ;  guid_t guid ;  bool needs_lock ;  spinlock_t insert_lock ;  spinlock_t remove_lock ;  guid_t type ;  guid_t inst ; } cocci_id@p ;
...
position p;
@@
 struct signal_queue_header cocci_id@p ;
