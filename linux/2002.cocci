...
position p;
@@
 struct stk8ba50_data * cocci_id@p ;
...
typedef u8,u16;
@@
 const struct {  u8 reg_val ;  u16 samp_freq ; } cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 const struct {  u8 reg_val ;  u32 scale_val ; } cocci_id@p [ ] ;
...
typedef u8,s16,bool;
@@
 struct stk8ba50_data {  struct i2c_client * client ;  struct mutex lock ;  int range ;  u8 sample_rate_idx ;  struct iio_trigger * dready_trig ;  bool dready_trigger_on ;  s16 buffer [ 8 ] ; } cocci_id@p ;
