...
position p;
@@
 struct gcov_info {  unsigned int version ;  struct gcov_info * next ;  unsigned int stamp ;  const char * filename ;  unsigned int n_functions ;  const struct gcov_fn_info * functions ;  unsigned int ctr_mask ;  struct gcov_ctr_info counts [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct gcov_iterator {  struct gcov_info * info ;  int record ;  unsigned int function ;  unsigned int type ;  unsigned int count ;  int num_types ;  struct type_info type_info [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct gcov_link cocci_id@p [ ] ;
...
position p;
@@
 struct gcov_fn_info * cocci_id@p ;
...
position p;
@@
 struct gcov_ctr_info * cocci_id@p ;
...
position p;
@@
 struct gcov_ctr_info {  unsigned int num ;  gcov_type * values ;  void ( * merge ) ( gcov_type * , unsigned int ) ; } cocci_id@p ;
...
position p;
@@
 struct gcov_fn_info {  unsigned int ident ;  unsigned int checksum ;  unsigned int n_ctrs [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct gcov_iterator * cocci_id@p ;
...
position p;
@@
 struct type_info {  int ctr_type ;  unsigned int offset ; } cocci_id@p ;
