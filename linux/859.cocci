...
position p;
@@
 struct lpc32xx_nand_cfg_slc * cocci_id@p ;
...
typedef uint32_t;
@@
 struct lpc32xx_nand_cfg_slc {  uint32_t wdr_clks ;  uint32_t wwidth ;  uint32_t whold ;  uint32_t wsetup ;  uint32_t rdr_clks ;  uint32_t rwidth ;  uint32_t rhold ;  uint32_t rsetup ;  int wp_gpio ;  struct mtd_partition * parts ;  unsigned num_parts ; } cocci_id@p ;
...
@@
 struct lpc32xx_nand_host {  struct nand_chip nand_chip ;  struct lpc32xx_slc_platform_data * pdata ;  struct clk * clk ;  void __iomem * io_base ;  struct lpc32xx_nand_cfg_slc * ncfg ;  struct completion comp ;  struct dma_chan * dma_chan ;  uint32_t dma_buf_len ;  struct dma_slave_config dma_slave_config ;  struct scatterlist sgl ;  uint32_t * ecc_buf ;  uint8_t * data_buf ;  dma_addr_t io_base_dma ; } cocci_id@p ;
