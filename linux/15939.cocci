...
position p;
@@
 int ( * cocci_id@p ) ( struct uwb_event * ) ;
...
position p;
@@
 struct uwbd_evt_type_handler * cocci_id@p ;
...
position p;
@@
 struct uwbd_event {  uwbd_evt_handler_f handler ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 const struct uwbd_event cocci_id@p [ ] ;
...
position p;
@@
 struct uwbd_evt_type_handler {  const char * name ;  struct uwbd_event * uwbd_events ;  size_t size ; } cocci_id@p ;
