...
position p;
@@
 enum wl1273_mode { WL1273_MODE_BT , WL1273_MODE_FM_RX , WL1273_MODE_FM_TX , } cocci_id@p ;
...
position p;
@@
 struct wl1273_priv {  enum wl1273_mode mode ;  struct wl1273_core * core ;  unsigned int channels ; } cocci_id@p ;
