...
position p;
@@
 struct mtk_drm_private * cocci_id@p ;
...
typedef bool;
@@
 struct mtk_crtc_state {  struct drm_crtc_state base ;  bool pending_config ;  unsigned int pending_width ;  unsigned int pending_height ;  unsigned int pending_vrefresh ; } cocci_id@p ;
...
position p;
@@
 struct mtk_plane_state * cocci_id@p ;
...
position p;
@@
 const enum mtk_ddp_comp_id * cocci_id@p ;
...
position p;
@@
 struct mtk_drm_crtc * cocci_id@p ;
...
position p;
@@
 enum mtk_ddp_comp_id cocci_id@p ;
...
position p;
@@
 struct mtk_crtc_state cocci_id@p ;
