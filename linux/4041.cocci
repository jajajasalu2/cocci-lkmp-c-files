...
position p;
@@
 struct acpi_madt_generic_interrupt * cocci_id@p ;
...
position p;
@@
 enum irq_domain_bus_token cocci_id@p ;
...
position p;
@@
 enum acpi_madt_type cocci_id@p ;
...
position p;
@@
 struct acpi_subtable_header * cocci_id@p ;
...
position p;
@@
 struct acpi_probe_entry * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct redist_region * , void __iomem * ) ;
...
position p;
@@
 struct gic_kvm_info cocci_id@p ;
...
@@
 struct redist_region {  void __iomem * redist_base ;  phys_addr_t phys_base ;  bool single_redist ; } cocci_id@p ;
...
position p;
@@
 enum gic_intid_range cocci_id@p ;
...
position p;
@@
 struct gic_chip_data cocci_id@p ;
...
@@
 struct {  void __iomem * dist_base ;  struct redist_region * redist_regs ;  u32 nr_redist_regions ;  bool single_redist ;  u32 maint_irq ;  int maint_irq_mode ;  phys_addr_t vcpu_base ; } cocci_id@p ;
...
position p;
@@
 struct partition_affinity * cocci_id@p ;
...
position p;
@@
 enum gic_intid_range { PPI_RANGE , SPI_RANGE , EPPI_RANGE , ESPI_RANGE , LPI_RANGE , __INVALID_RANGE__ , } cocci_id@p ;
...
position p;
@@
 struct acpi_madt_generic_distributor * cocci_id@p ;
...
position p;
@@
 typeof ( * gic_data . rdists . rdist ) cocci_id@p ;
...
position p;
@@
 struct acpi_madt_generic_redistributor * cocci_id@p ;
...
@@
 struct gic_chip_data {  struct fwnode_handle * fwnode ;  void __iomem * dist_base ;  struct redist_region * redist_regions ;  struct rdists rdists ;  struct irq_domain * domain ;  u64 redist_stride ;  u32 nr_redist_regions ;  u64 flags ;  bool has_rss ;  unsigned int ppi_nr ;  struct partition_desc * * ppi_descs ; } cocci_id@p ;
...
position p;
@@
 struct redist_region * cocci_id@p ;
...
position p;
@@
 acpi_tbl_entry_handler cocci_id@p ;
...
position p;
@@
 struct partition_desc * cocci_id@p ;
