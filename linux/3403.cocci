...
position p;
@@
 struct pwm_mediatek_chip * cocci_id@p ;
...
position p;
@@
 struct pwm_mediatek_chip {  struct pwm_chip chip ;  void __iomem * regs ;  struct clk * clk_top ;  struct clk * clk_main ;  struct clk * * clk_pwms ;  const struct pwm_mediatek_of_data * soc ; } cocci_id@p ;
...
position p;
@@
 const struct pwm_mediatek_of_data cocci_id@p ;
...
typedef bool;
@@
 struct pwm_mediatek_of_data {  unsigned int num_pwms ;  bool pwm45_fixup ; } cocci_id@p ;
