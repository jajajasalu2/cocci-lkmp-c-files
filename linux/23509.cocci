...
position p;
@@
 const struct acpi_gpio_params cocci_id@p ;
...
position p;
@@
 struct property_entry cocci_id@p [ MAX_NO_PROPS ] ;
...
position p;
@@
 struct acpi_chan_package cocci_id@p ;
...
position p;
@@
 struct snd_soc_acpi_package_context cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SND_ACPI_I2C_ID_LEN ] ;
...
position p;
@@
 struct snd_soc_jack_pin cocci_id@p [ ] ;
...
position p;
@@
 struct snd_soc_acpi_mach * cocci_id@p ;
...
typedef u64;
@@
 struct acpi_chan_package {  u64 aif_value ;  u64 mclock_value ; } cocci_id@p ;
...
position p;
@@
 enum { BYT_RT5651_DMIC_MAP , BYT_RT5651_IN1_MAP , BYT_RT5651_IN2_MAP , BYT_RT5651_IN1_IN2_MAP , } cocci_id@p ;
...
position p;
@@
 enum { BYT_RT5651_JD_NULL = ( RT5651_JD_NULL << 4 ) , BYT_RT5651_JD1_1 = ( RT5651_JD1_1 << 4 ) , BYT_RT5651_JD1_2 = ( RT5651_JD1_2 << 4 ) , BYT_RT5651_JD2 = ( RT5651_JD2 << 4 ) , } cocci_id@p ;
...
position p;
@@
 enum { BYT_RT5651_OVCD_SF_0P5 = ( RT5651_OVCD_SF_0P5 << 13 ) , BYT_RT5651_OVCD_SF_0P75 = ( RT5651_OVCD_SF_0P75 << 13 ) , BYT_RT5651_OVCD_SF_1P0 = ( RT5651_OVCD_SF_1P0 << 13 ) , BYT_RT5651_OVCD_SF_1P5 = ( RT5651_OVCD_SF_1P5 << 13 ) , } cocci_id@p ;
...
position p;
@@
 enum { BYT_RT5651_OVCD_TH_600UA = ( 6 << 8 ) , BYT_RT5651_OVCD_TH_1500UA = ( 15 << 8 ) , BYT_RT5651_OVCD_TH_2000UA = ( 20 << 8 ) , } cocci_id@p ;
...
position p;
@@
 const struct acpi_gpio_mapping cocci_id@p [ ] ;
...
position p;
@@
 struct byt_rt5651_private {  struct clk * mclk ;  struct gpio_desc * ext_amp_gpio ;  struct gpio_desc * hp_detect ;  struct snd_soc_jack jack ; } cocci_id@p ;
...
position p;
@@
 struct byt_rt5651_private * cocci_id@p ;
...
position p;
@@
 const struct snd_soc_ops cocci_id@p ;
