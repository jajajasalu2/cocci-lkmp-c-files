...
position p;
@@
 struct zx_dma_desc_sw cocci_id@p ;
...
typedef u32;
@@
 struct zx_dma_phy {  u32 idx ;  void __iomem * base ;  struct zx_dma_chan * vchan ;  struct zx_dma_desc_sw * ds_run ;  struct zx_dma_desc_sw * ds_done ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct zx_dma_desc_sw {  struct virt_dma_desc vd ;  dma_addr_t desc_hw_lli ;  size_t desc_num ;  size_t size ;  struct zx_desc_hw * desc_hw ; } cocci_id@p ;
...
position p;
@@
 enum zx_dma_burst_width { ZX_DMA_WIDTH_8BIT = 0 , ZX_DMA_WIDTH_16BIT = 1 , ZX_DMA_WIDTH_32BIT = 2 , ZX_DMA_WIDTH_64BIT = 3 , } cocci_id@p ;
...
@@
 struct zx_dma_dev {  struct dma_device slave ;  void __iomem * base ;  spinlock_t lock ;  struct list_head chan_pending ;  struct zx_dma_phy * phy ;  struct zx_dma_chan * chans ;  struct clk * clk ;  struct dma_pool * pool ;  u32 dma_channels ;  u32 dma_requests ;  int irq ; } cocci_id@p ;
...
@@
 struct zx_dma_chan {  struct dma_slave_config slave_cfg ;  int id ;  u32 ccfg ;  u32 cyclic ;  struct virt_dma_chan vc ;  struct zx_dma_phy * phy ;  struct list_head node ;  dma_addr_t dev_addr ;  enum dma_status status ; } cocci_id@p ;
...
position p;
@@
 enum zx_dma_burst_width cocci_id@p ;
