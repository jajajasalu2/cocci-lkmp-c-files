...
position p;
@@
 struct sw_sync_create_fence_data cocci_id@p ;
...
position p;
@@
 struct sync_timeline * cocci_id@p ;
...
typedef __u32;
@@
 struct sw_sync_create_fence_data {  __u32 value ;  char name [ 32 ] ;  __s32 fence ; } cocci_id@p ;
