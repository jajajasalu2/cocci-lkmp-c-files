...
position p;
@@
 struct ipmi_smi_powernv * cocci_id@p ;
...
position p;
@@
 struct opal_ipmi_msg * cocci_id@p ;
...
@@
 struct ipmi_smi_powernv {  u64 interface_id ;  struct ipmi_smi * intf ;  unsigned int irq ;  spinlock_t msg_lock ;  struct ipmi_smi_msg * cur_msg ;  struct opal_ipmi_msg * opal_msg ; } cocci_id@p ;
