...
position p;
@@
 struct flexcan_priv cocci_id@p ;
...
typedef u8,u32;
@@
 struct flexcan_regs {  u32 mcr ;  u32 ctrl ;  u32 timer ;  u32 _reserved1 ;  u32 rxgmask ;  u32 rx14mask ;  u32 rx15mask ;  u32 ecr ;  u32 esr ;  u32 imask2 ;  u32 imask1 ;  u32 iflag2 ;  u32 iflag1 ;  union {  u32 gfwr_mx28 ;  u32 ctrl2 ; } ;  u32 esr2 ;  u32 imeur ;  u32 lrfr ;  u32 crcr ;  u32 rxfgmask ;  u32 rxfir ;  u32 _reserved3 [ 12 ] ;  u8 mb [ 2 ] [ 512 ] ;  u32 _reserved4 [ 256 ] ;  u32 rximr [ 64 ] ;  u32 _reserved5 [ 24 ] ;  u32 gfwr_mx6 ;  u32 _reserved6 [ 63 ] ;  u32 mecr ;  u32 erriar ;  u32 erridpr ;  u32 errippr ;  u32 rerrar ;  u32 rerrdr ;  u32 rerrsynr ;  u32 errsr ; } cocci_id@p ;
...
position p;
@@
 struct can_rx_offload * cocci_id@p ;
...
typedef u32;
@@
 struct flexcan_mb {  u32 can_ctrl ;  u32 can_id ;  u32 data [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct flexcan_devtype_data * cocci_id@p ;
...
position p;
@@
 const struct flexcan_priv * cocci_id@p ;
...
typedef u8;
@@
 struct flexcan_stop_mode {  struct regmap * gpr ;  u8 req_gpr ;  u8 req_bit ;  u8 ack_gpr ;  u8 ack_bit ; } cocci_id@p ;
...
typedef u32;
@@
 struct flexcan_devtype_data {  u32 quirks ; } cocci_id@p ;
...
position p;
@@
 struct flexcan_devtype_data * cocci_id@p ;
