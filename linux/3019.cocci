...
position p;
@@
 const struct iort_dev_config * cocci_id@p ;
...
position p;
@@
 struct iort_fwnode {  struct list_head list ;  struct acpi_iort_node * iort_node ;  struct fwnode_handle * fwnode ; } cocci_id@p ;
...
position p;
@@
 struct iort_pci_alias_info {  struct device * dev ;  struct acpi_iort_node * node ; } cocci_id@p ;
...
position p;
@@
 struct acpi_table_iort * cocci_id@p ;
...
position p;
@@
 struct iort_pci_alias_info * cocci_id@p ;
...
position p;
@@
 struct iort_its_msi_chip * cocci_id@p ;
...
position p;
@@
 struct acpi_iort_root_complex * cocci_id@p ;
...
typedef acpi_status;
@@
 acpi_status ( * cocci_id@p ) ( struct acpi_iort_node * node , void * context ) ;
...
position p;
@@
 iort_find_node_callback cocci_id@p ;
...
position p;
@@
 struct acpi_iort_named_component * cocci_id@p ;
...
position p;
@@
 struct acpi_iort_id_mapping cocci_id@p ;
...
@@
 struct iort_its_msi_chip {  struct list_head list ;  struct fwnode_handle * fw_node ;  phys_addr_t base_addr ;  u32 translation_id ; } cocci_id@p ;
...
position p;
@@
 struct acpi_iort_pmcg * cocci_id@p ;
...
position p;
@@
 struct acpi_iort_smmu * cocci_id@p ;
...
position p;
@@
 enum acpi_iort_node_type cocci_id@p ;
...
position p;
@@
 struct acpi_iort_its_group * cocci_id@p ;
