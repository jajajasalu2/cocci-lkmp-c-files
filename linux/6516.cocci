...
position p;
@@
 struct devfreq_dev_status * cocci_id@p ;
...
position p;
@@
 struct ufs_query_req * * cocci_id@p ;
...
position p;
@@
 struct ufs_clk_info * cocci_id@p ;
...
position p;
@@
 struct utp_transfer_req_desc cocci_id@p ;
...
position p;
@@
 struct utp_task_req_desc * cocci_id@p ;
...
position p;
@@
 struct ufs_clk_scaling * cocci_id@p ;
...
position p;
@@
 struct ufs_pa_layer_attr cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct ufs_hba * hba , bool on ) ;
...
position p;
@@
 struct ufs_query_res cocci_id@p ;
...
position p;
@@
 struct ufs_vreg_info * cocci_id@p ;
...
position p;
@@
 enum { UFSHCD_MAX_CHANNEL = 0 , UFSHCD_MAX_ID = 1 , UFSHCD_CMD_PER_LUN = 32 , UFSHCD_CAN_QUEUE = 32 , } cocci_id@p ;
...
position p;
@@
 enum unit_desc_param cocci_id@p ;
...
position p;
@@
 struct ufs_err_reg_hist * cocci_id@p ;
...
position p;
@@
 struct ufs_dev_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ufs_hba * hba ) ;
...
position p;
@@
 struct utp_upiu_req cocci_id@p ;
...
position p;
@@
 struct ufshcd_sg_entry * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct ufs_hba * hba , bool on , bool skip_ref_clk ) ;
...
position p;
@@
 int cocci_id@p ( struct ufs_hba * hba , struct ufs_pa_layer_attr * pwr_mode ) ;
...
position p;
@@
 struct ufs_pm_lvl_states cocci_id@p [ ] ;
...
position p;
@@
 enum ufs_dev_pwr_mode cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "ufs_clkscaling_00" ) ] ;
...
typedef bool;
@@
 int cocci_id@p ( struct ufs_hba * hba , bool scale_up ) ;
...
position p;
@@
 enum { UFSHCD_UIC_DL_PA_INIT_ERROR = ( 1 << 0 ) , UFSHCD_UIC_DL_NAC_RECEIVED_ERROR = ( 1 << 1 ) , UFSHCD_UIC_DL_TCx_REPLAY_ERROR = ( 1 << 2 ) , UFSHCD_UIC_NL_ERROR = ( 1 << 3 ) , UFSHCD_UIC_TL_ERROR = ( 1 << 4 ) , UFSHCD_UIC_DME_ERROR = ( 1 << 5 ) , } cocci_id@p ;
...
position p;
@@
 enum { UFSHCD_STATE_RESET , UFSHCD_STATE_ERROR , UFSHCD_STATE_OPERATIONAL , UFSHCD_STATE_EH_SCHEDULED , } cocci_id@p ;
...
position p;
@@
 struct utp_transfer_cmd_desc cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ QUERY_DESC_HDR_SIZE ] ;
...
position p;
@@
 struct uc_string_id * cocci_id@p ;
...
position p;
@@
 enum ufs_ref_clk_freq cocci_id@p ;
...
position p;
@@
 enum { UFSHCD_EH_IN_PROGRESS = ( 1 << 0 ) , } cocci_id@p ;
...
position p;
@@
 struct devfreq_dev_profile cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "ufs_clk_gating_00" ) ] ;
...
position p;
@@
 void cocci_id@p ( struct ufs_hba * hba ) ;
...
position p;
@@
 struct utp_upiu_rsp cocci_id@p ;
...
position p;
@@
 enum uic_link_state cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * __hba ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( struct ufs_hba * hba ) ;
...
position p;
@@
 int cocci_id@p ( struct ufs_hba * hba , int tag ) ;
