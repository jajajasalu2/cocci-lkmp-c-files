...
position p;
@@
 struct microcode_header_amd * cocci_id@p ;
...
position p;
@@
 struct equiv_cpu_table {  unsigned int num_entries ;  struct equiv_cpu_entry * entry ; } cocci_id@p ;
...
position p;
@@
 struct ucode_cpu_info * cocci_id@p ;
...
position p;
@@
 struct equiv_cpu_entry * cocci_id@p ;
...
position p;
@@
 struct microcode_amd * cocci_id@p ;
...
position p;
@@
 struct microcode_ops cocci_id@p ;
...
position p;
@@
 struct cpu_signature * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cont_desc {  struct microcode_amd * mc ;  u32 cpuid_1_eax ;  u32 psize ;  u8 * data ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 struct equiv_cpu_table * cocci_id@p ;
