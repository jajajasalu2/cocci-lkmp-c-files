...
position p;
@@
 struct rockchip_hdmi * cocci_id@p ;
...
typedef u32;
@@
 struct rockchip_hdmi_chip_data {  int lcdsel_grf_reg ;  u32 lcdsel_big ;  u32 lcdsel_lit ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_hdmi_chip_data cocci_id@p ;
...
position p;
@@
 struct dw_hdmi_plat_data * cocci_id@p ;
...
position p;
@@
 struct rockchip_hdmi {  struct device * dev ;  struct regmap * regmap ;  struct drm_encoder encoder ;  const struct rockchip_hdmi_chip_data * chip_data ;  struct clk * vpll_clk ;  struct clk * grf_clk ;  struct dw_hdmi * hdmi ;  struct phy * phy ; } cocci_id@p ;
