...
position p;
@@
 struct mtk8250_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct uart_8250_port * up ) ;
...
position p;
@@
 enum { MTK_UART_FC_NONE , MTK_UART_FC_SW , MTK_UART_FC_HW , } cocci_id@p ;
...
position p;
@@
 enum dma_rx_status { DMA_RX_START = 0 , DMA_RX_RUNNING = 1 , DMA_RX_SHUTDOWN = 2 , } cocci_id@p ;
