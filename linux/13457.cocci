...
position p;
@@
 struct pvr2_sysfs_class {  struct class class ; } cocci_id@p ;
...
position p;
@@
 struct pvr2_sysfs_ctl_item cocci_id@p ;
...
position p;
@@
 struct pvr2_sysfs_debugifc {  struct device_attribute attr_debugcmd ;  struct device_attribute attr_debuginfo ;  int debugcmd_created_ok ;  int debuginfo_created_ok ; } cocci_id@p ;
...
position p;
@@
 struct pvr2_sysfs_class * cocci_id@p ;
...
position p;
@@
 struct pvr2_sysfs_debugifc * cocci_id@p ;
