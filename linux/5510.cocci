...
@@
 struct spi_xcomm {  struct i2c_client * i2c ;  uint16_t settings ;  uint16_t chipselect ;  unsigned int current_speed ;  uint8_t buf [ 63 ] ; } cocci_id@p ;
