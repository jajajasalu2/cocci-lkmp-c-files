...
position p;
@@
 struct tegra_spi_client_data * cocci_id@p ;
...
position p;
@@
 struct tegra_spi_soc_data cocci_id@p ;
...
position p;
@@
 struct tegra_spi_data * cocci_id@p ;
...
position p;
@@
 struct tegra_spi_client_data {  int tx_clk_tap_delay ;  int rx_clk_tap_delay ; } cocci_id@p ;
...
typedef bool;
@@
 struct tegra_spi_soc_data {  bool has_intr_mask_reg ; } cocci_id@p ;
