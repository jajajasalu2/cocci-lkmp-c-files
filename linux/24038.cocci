...
position p;
@@
 int cocci_id@p ( struct file * file , struct vm_area_struct * vma ) ;
...
position p;
@@
 struct ip_options_rcu * cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 21 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned int , void __user * ) ;
...
position p;
@@
 unsigned long cocci_id@p [ AUDITSC_ARGS ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net * , unsigned int cmd , void __user * arg ) ;
...
position p;
@@
 struct socket_alloc cocci_id@p ;
...
position p;
@@
 struct ipv6_txoptions * cocci_id@p ;
...
position p;
@@
 struct compat_ifconf cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct kiocb * iocb , struct iov_iter * from ) ;
...
position p;
@@
 int cocci_id@p ( int fd , struct file * filp , int on ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net * , unsigned int , void __user * ) ;
...
position p;
@@
 struct used_address * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net * , void __user * ) ;
...
position p;
@@
 struct scm_ts_pktinfo cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( struct file * file , unsigned int cmd , unsigned long arg ) ;
...
position p;
@@
 struct compat_ifreq cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net * , void __user * arg ) ;
...
position p;
@@
 enum sock_shutdown_cmd cocci_id@p ;
...
typedef u32;
@@
 struct rtentry32 {  u32 rt_pad1 ;  struct sockaddr rt_dst ;  struct sockaddr rt_gateway ;  struct sockaddr rt_genmask ;  unsigned short rt_flags ;  short rt_pad2 ;  u32 rt_pad3 ;  unsigned char rt_tos ;  unsigned char rt_class ;  short rt_pad4 ;  short rt_metric ;  u32 rt_dev ;  u32 rt_mtu ;  u32 rt_window ;  unsigned short rt_irtt ; } cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct kiocb * iocb , struct iov_iter * to ) ;
...
position p;
@@
 struct compat_ethtool_rxnfc cocci_id@p ;
...
position p;
@@
 struct used_address {  struct sockaddr_storage name ;  unsigned int name_len ; } cocci_id@p ;
...
position p;
@@
 struct scm_timestamping_internal cocci_id@p ;
...
typedef u32,u16,s32;
@@
 struct in6_rtmsg32 {  struct in6_addr rtmsg_dst ;  struct in6_addr rtmsg_src ;  struct in6_addr rtmsg_gateway ;  u32 rtmsg_type ;  u16 rtmsg_dst_len ;  u16 rtmsg_src_len ;  u32 rtmsg_metric ;  u32 rtmsg_info ;  u32 rtmsg_flags ;  s32 rtmsg_ifindex ; } cocci_id@p ;
