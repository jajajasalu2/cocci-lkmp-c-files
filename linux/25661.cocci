...
position p;
@@
 const char * cocci_id@p [ PERF_COUNT_SW_MAX ] ;
...
position p;
@@
 struct {  size_t size ;  int ( * init ) ( struct evsel * evsel ) ;  void ( * fini ) ( struct evsel * evsel ) ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct evsel * evsel ) ;
...
position p;
@@
 enum { NO_CHANGE , SET_TO_MAX , INCREASED_MAX , } cocci_id@p ;
...
position p;
@@
 enum evsel_term_type cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ PERF_COUNT_HW_CACHE_OP_MAX ] [ PERF_EVSEL__MAX_ALIASES ] ;
...
position p;
@@
 struct perf_stat_evsel * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ PERF_COUNT_HW_CACHE_MAX ] [ PERF_EVSEL__MAX_ALIASES ] ;
...
position p;
@@
 const char * cocci_id@p [ PERF_COUNT_HW_MAX ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct evsel * evsel ) ;
...
position p;
@@
 enum perf_event_sample_format cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ PERF_COUNT_HW_CACHE_RESULT_MAX ] [ PERF_EVSEL__MAX_ALIASES ] ;
...
position p;
@@
 struct perf_missing_features cocci_id@p ;
...
position p;
@@
 const union perf_event * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ C ( MAX ) ] ;
