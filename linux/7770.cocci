...
typedef u8;
@@
 void cocci_id@p ( struct uart_omap_port * up , u8 mdr1 ) ;
...
position p;
@@
 struct uart_omap_port cocci_id@p ;
...
position p;
@@
 struct uart_omap_port * cocci_id@p [ OMAP_MAX_HSUART_PORTS ] ;
...
@@
 struct uart_omap_dma {  u8 uart_dma_tx ;  u8 uart_dma_rx ;  int rx_dma_channel ;  int tx_dma_channel ;  dma_addr_t rx_buf_dma_phys ;  dma_addr_t tx_buf_dma_phys ;  unsigned int uart_base ;  unsigned char * rx_buf ;  unsigned int prev_rx_dma_pos ;  int tx_buf_size ;  int tx_dma_used ;  int rx_dma_used ;  spinlock_t tx_lock ;  spinlock_t rx_lock ;  struct timer_list rx_timer ;  unsigned int rx_buf_size ;  unsigned int rx_poll_rate ;  unsigned int rx_timeout ; } cocci_id@p ;
...
position p;
@@
 struct omap_uart_port_info * cocci_id@p ;
