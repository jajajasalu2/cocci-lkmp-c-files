...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , struct pxafb_info * ) ;
...
position p;
@@
 struct pxafb_layer_ops cocci_id@p [ ] ;
...
position p;
@@
 struct pxafb_dma_descriptor * cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct pxafb_info * fbi , u_int state ) ;
...
position p;
@@
 struct pxafb_dma_buff cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pxafb_info * fbi , struct fb_var_screeninfo * var , int branch ) ;
