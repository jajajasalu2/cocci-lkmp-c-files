...
position p;
@@
 struct xen_pci_frontend_ops cocci_id@p ;
...
position p;
@@
 struct pcifront_sd {  struct pci_sysdata sd ;  struct pcifront_device * pdev ; } cocci_id@p ;
...
position p;
@@
 struct pci_bus_entry * cocci_id@p ;
...
position p;
@@
 struct xen_pci_sharedinfo * cocci_id@p ;
...
position p;
@@
 struct pcifront_device cocci_id@p ;
...
position p;
@@
 struct pci_bus_entry {  struct list_head list ;  struct pci_bus * bus ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct pcifront_device {  struct xenbus_device * xdev ;  struct list_head root_buses ;  int evtchn ;  int gnt_ref ;  int irq ;  spinlock_t sh_info_lock ;  struct xen_pci_sharedinfo * sh_info ;  struct work_struct op_work ;  unsigned long flags ; } cocci_id@p ;
