...
typedef u32;
@@
 struct aspeed_wdt_config {  u32 ext_pulse_width_mask ; } cocci_id@p ;
...
position p;
@@
 const struct aspeed_wdt_config cocci_id@p ;
...
typedef u32;
@@
 struct aspeed_wdt {  struct watchdog_device wdd ;  void __iomem * base ;  u32 ctrl ; } cocci_id@p ;
