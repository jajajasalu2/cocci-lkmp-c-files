...
position p;
@@
 const struct ad7793_chip_info cocci_id@p [ ] ;
...
typedef u16;
@@
 struct ad7793_chip_info {  unsigned int id ;  const struct iio_chan_spec * channels ;  unsigned int num_channels ;  unsigned int flags ;  const struct iio_info * iio_info ;  const u16 * sample_freq_avail ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct ad7793_state {  const struct ad7793_chip_info * chip_info ;  struct regulator * reg ;  u16 int_vref_mv ;  u16 mode ;  u16 conf ;  u32 scale_avail [ 8 ] [ 2 ] ;  struct ad_sigma_delta sd ; } cocci_id@p ;
...
position p;
@@
 const struct ad_sd_calib_data cocci_id@p [ 6 ] ;
...
position p;
@@
 struct ad7793_state cocci_id@p ;
...
position p;
@@
 enum ad7793_supported_device_ids { ID_AD7785 , ID_AD7792 , ID_AD7793 , ID_AD7794 , ID_AD7795 , ID_AD7796 , ID_AD7797 , ID_AD7798 , ID_AD7799 , } cocci_id@p ;
...
position p;
@@
 const struct ad7793_platform_data * cocci_id@p ;
