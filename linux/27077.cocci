...
position p;
@@
 struct xchk_refcnt_frag {  struct list_head list ;  struct xfs_rmap_irec rm ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_agblock_t,xfs_nlink_t,xfs_extlen_t;
@@
 struct xchk_refcnt_check {  struct xfs_scrub * sc ;  struct list_head fragments ;  xfs_agblock_t bno ;  xfs_extlen_t len ;  xfs_nlink_t refcount ;  xfs_nlink_t seen ; } cocci_id@p ;
...
position p;
@@
 struct xchk_refcnt_check cocci_id@p ;
...
position p;
@@
 struct xchk_refcnt_frag cocci_id@p ;
