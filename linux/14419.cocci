...
position p;
@@
 struct fm_cmd_msg_hdr * cocci_id@p ;
...
position p;
@@
 struct fm_rdsdata_format cocci_id@p ;
...
position p;
@@
 int_handler_prototype cocci_id@p [ ] ;
...
position p;
@@
 struct fm_event_msg_hdr * cocci_id@p ;
...
position p;
@@
 struct tuned_station_info * cocci_id@p ;
...
position p;
@@
 long ( * cocci_id@p ) ( struct sk_buff * skb ) ;
