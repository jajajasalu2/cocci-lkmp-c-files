...
position p;
@@
 struct sdma_driver_data cocci_id@p ;
...
position p;
@@
 struct sdma_script_start_addrs cocci_id@p ;
...
position p;
@@
 enum sdma_peripheral_type cocci_id@p ;
...
position p;
@@
 struct sdma_firmware_header * cocci_id@p ;
...
position p;
@@
 struct sdma_buffer_descriptor cocci_id@p ;
...
position p;
@@
 struct sdma_context_data cocci_id@p ;
...
position p;
@@
 struct sdma_platform_data * cocci_id@p ;
...
position p;
@@
 const struct sdma_firmware_header * cocci_id@p ;
...
position p;
@@
 struct sdma_channel cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct sdma_desc {  struct virt_dma_desc vd ;  unsigned int num_bd ;  dma_addr_t bd_phys ;  unsigned int buf_tail ;  unsigned int buf_ptail ;  unsigned int period_len ;  unsigned int chn_real_count ;  unsigned int chn_count ;  struct sdma_channel * sdmac ;  struct sdma_buffer_descriptor * bd ; } cocci_id@p ;
...
position p;
@@
 struct imx_dma_data * cocci_id@p ;
...
position p;
@@
 const struct sdma_driver_data * cocci_id@p ;
...
typedef bool;
@@
 struct sdma_driver_data {  int chnenbl0 ;  int num_events ;  struct sdma_script_start_addrs * script_addrs ;  bool check_ratio ; } cocci_id@p ;
...
position p;
@@
 const struct sdma_script_start_addrs * cocci_id@p ;
...
position p;
@@
 struct sdma_channel_control cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dma_chan * chan , struct dma_slave_config * dmaengine_cfg , enum dma_transfer_direction direction ) ;
...
typedef u32;
@@
 struct sdma_firmware_header {  u32 magic ;  u32 version_major ;  u32 version_minor ;  u32 script_addrs_start ;  u32 num_script_addrs ;  u32 ram_code_start ;  u32 ram_code_size ; } cocci_id@p ;
