...
position p;
@@
 struct nvme_tcp_queue cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,bool,spinlock_t;
@@
 struct nvme_tcp_queue {  struct socket * sock ;  struct work_struct io_work ;  int io_cpu ;  spinlock_t lock ;  struct list_head send_list ;  void * pdu ;  int pdu_remaining ;  int pdu_offset ;  size_t data_remaining ;  size_t ddgst_remaining ;  unsigned int nr_cqe ;  struct nvme_tcp_request * request ;  int queue_size ;  size_t cmnd_capsule_len ;  struct nvme_tcp_ctrl * ctrl ;  unsigned long flags ;  bool rd_enabled ;  bool hdr_digest ;  bool data_digest ;  struct ahash_request * rcv_hash ;  struct ahash_request * snd_hash ;  __le32 exp_ddgst ;  __le32 recv_ddgst ;  struct page_frag_cache pf_cache ;  void ( * state_change ) ( struct sock * ) ;  void ( * data_ready ) ( struct sock * ) ;  void ( * write_space ) ( struct sock * ) ; } cocci_id@p ;
...
position p;
@@
 struct nvme_tcp_r2t_pdu * cocci_id@p ;
...
position p;
@@
 struct nvme_tcp_hdr * cocci_id@p ;
...
position p;
@@
 struct nvme_tcp_data_pdu * cocci_id@p ;
...
position p;
@@
 struct nvme_tcp_rsp_pdu * cocci_id@p ;
...
position p;
@@
 struct nvme_tcp_request cocci_id@p ;
...
position p;
@@
 struct nvme_tcp_icreq_pdu * cocci_id@p ;
...
position p;
@@
 struct nvme_tcp_ctrl cocci_id@p ;
...
typedef u32;
@@
 struct nvme_tcp_ctrl {  struct nvme_tcp_queue * queues ;  struct blk_mq_tag_set tag_set ;  struct list_head list ;  struct blk_mq_tag_set admin_tag_set ;  struct sockaddr_storage addr ;  struct sockaddr_storage src_addr ;  struct nvme_ctrl ctrl ;  struct work_struct err_work ;  struct delayed_work connect_work ;  struct nvme_tcp_request async_req ;  u32 io_queues [ HCTX_MAX_TYPES ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,u32,u16;
@@
 struct nvme_tcp_request {  struct nvme_request req ;  void * pdu ;  struct nvme_tcp_queue * queue ;  u32 data_len ;  u32 pdu_len ;  u32 pdu_sent ;  u16 ttag ;  struct list_head entry ;  __le32 ddgst ;  struct bio * curr_bio ;  struct iov_iter iter ;  size_t offset ;  size_t data_sent ;  enum nvme_tcp_send_state state ; } cocci_id@p ;
...
position p;
@@
 struct nvme_tcp_cmd_pdu * cocci_id@p ;
...
position p;
@@
 enum nvme_tcp_recv_state { NVME_TCP_RECV_PDU = 0 , NVME_TCP_RECV_DATA , NVME_TCP_RECV_DDGST , } cocci_id@p ;
...
position p;
@@
 enum nvme_tcp_send_state { NVME_TCP_SEND_CMD_PDU = 0 , NVME_TCP_SEND_H2C_PDU , NVME_TCP_SEND_DATA , NVME_TCP_SEND_DDGST , } cocci_id@p ;
...
position p;
@@
 enum nvme_tcp_queue_flags { NVME_TCP_Q_ALLOCATED = 0 , NVME_TCP_Q_LIVE = 1 , } cocci_id@p ;
...
position p;
@@
 struct nvme_tcp_icresp_pdu * cocci_id@p ;
...
position p;
@@
 enum nvme_tcp_recv_state cocci_id@p ;
