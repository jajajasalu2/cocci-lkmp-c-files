...
position p;
@@
 enum { LS_START , LS_HASH , LS_DIRTY , } cocci_id@p ;
...
typedef Linetype;
@@
 Linetype cocci_id@p ( const char * * ) ;
...
position p;
@@
 const char * cocci_id@p ( const char * ) ;
...
position p;
@@
 enum { LT_TRUEI , LT_FALSEI , LT_IF , LT_TRUE , LT_FALSE , LT_ELIF , LT_ELTRUE , LT_ELFALSE , LT_ELSE , LT_ENDIF , LT_DODGY , LT_DODGY_LAST = LT_DODGY + LT_ENDIF , LT_PLAIN , LT_EOF , LT_ERROR , LT_COUNT , } cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( bool , bool , char * ) ;
...
position p;
@@
 enum { IS_OUTSIDE , IS_FALSE_PREFIX , IS_TRUE_PREFIX , IS_PASS_MIDDLE , IS_FALSE_MIDDLE , IS_TRUE_MIDDLE , IS_PASS_ELSE , IS_FALSE_ELSE , IS_TRUE_ELSE , IS_FALSE_TRAILER , IS_COUNT , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAXLINE + EDITSLOP ] ;
...
typedef Linetype;
@@
 Linetype cocci_id@p ( const struct ops * , int * , const char * * ) ;
...
position p;
@@
 state_fn * const cocci_id@p [ IS_COUNT ] [ LT_COUNT ] ;
...
position p;
@@
 enum { NO_COMMENT = false , C_COMMENT , CXX_COMMENT , STARTING_COMMENT , FINISHING_COMMENT , CHAR_LITERAL , STRING_LITERAL , } cocci_id@p ;
