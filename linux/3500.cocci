...
position p;
@@
 struct sh_mmcif_host cocci_id@p ;
...
position p;
@@
 enum sh_mmcif_wait_for { MMCIF_WAIT_FOR_REQUEST , MMCIF_WAIT_FOR_CMD , MMCIF_WAIT_FOR_MREAD , MMCIF_WAIT_FOR_MWRITE , MMCIF_WAIT_FOR_READ , MMCIF_WAIT_FOR_WRITE , MMCIF_WAIT_FOR_READ_END , MMCIF_WAIT_FOR_WRITE_END , MMCIF_WAIT_FOR_STOP , } cocci_id@p ;
...
position p;
@@
 enum sh_mmcif_state { STATE_IDLE , STATE_REQUEST , STATE_IOS , STATE_TIMEOUT , } cocci_id@p ;
