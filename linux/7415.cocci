...
position p;
@@
 struct panel_drv_data {  struct omap_dss_device dssdev ;  struct omap_dss_device * in ;  struct regulator * vcc ;  int data_lines ;  struct omap_video_timings videomode ;  struct gpio_desc * resb_gpio ;  struct gpio_desc * ini_gpio ;  struct gpio_desc * mo_gpio ;  struct gpio_desc * lr_gpio ;  struct gpio_desc * ud_gpio ; } cocci_id@p ;
