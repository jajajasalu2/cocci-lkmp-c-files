...
position p;
@@
 union drbd_dev_state cocci_id@p ;
...
position p;
@@
 enum drbd_state_rv cocci_id@p ( union drbd_state os , union drbd_state ns ) ;
...
position p;
@@
 enum drbd_io_error_p cocci_id@p ;
...
position p;
@@
 struct connection_info cocci_id@p ;
...
position p;
@@
 enum drbd_state_rv cocci_id@p ( union drbd_state , union drbd_state , struct drbd_connection * ) ;
...
position p;
@@
 struct drbd_connection_state_change cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drbd_work * w , int unused ) ;
...
position p;
@@
 enum sanitize_state_warnings * cocci_id@p ;
...
position p;
@@
 struct drbd_resource_state_change * cocci_id@p ;
...
position p;
@@
 enum drbd_state_rv cocci_id@p ( struct drbd_device * , union drbd_state ) ;
...
position p;
@@
 struct peer_device_info cocci_id@p ;
...
position p;
@@
 struct after_conn_state_chg_work {  struct drbd_work w ;  enum drbd_conns oc ;  union drbd_state ns_min ;  union drbd_state ns_max ;  enum chg_state_flags flags ;  struct drbd_connection * connection ;  struct drbd_state_change * state_change ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct drbd_device * ) ;
...
position p;
@@
 struct after_state_chg_work * cocci_id@p ;
...
position p;
@@
 struct drbd_device_state_change * cocci_id@p ;
...
position p;
@@
 struct drbd_peer_device_state_change cocci_id@p ;
...
position p;
@@
 struct after_conn_state_chg_work cocci_id@p ;
...
position p;
@@
 struct drbd_state_change * cocci_id@p ;
...
position p;
@@
 enum drbd_notification_type cocci_id@p ;
...
position p;
@@
 union drbd_state cocci_id@p ( struct drbd_device * device , union drbd_state os , union drbd_state ns , enum sanitize_state_warnings * warn ) ;
...
position p;
@@
 struct after_state_chg_work {  struct drbd_work w ;  struct drbd_device * device ;  union drbd_state os ;  union drbd_state ns ;  enum chg_state_flags flags ;  struct completion * done ;  struct drbd_state_change * state_change ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drbd_device * device , union drbd_state os , union drbd_state ns , enum chg_state_flags flags , struct drbd_state_change * ) ;
...
position p;
@@
 enum drbd_fencing_p cocci_id@p ;
...
position p;
@@
 enum sanitize_state_warnings { NO_WARNING , ABORTED_ONLINE_VERIFY , ABORTED_RESYNC , CONNECTION_LOST_NEGOTIATING , IMPLICITLY_UPGRADED_DISK , IMPLICITLY_UPGRADED_PDSK , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sk_buff * , unsigned int , void * , enum drbd_notification_type ) ;
