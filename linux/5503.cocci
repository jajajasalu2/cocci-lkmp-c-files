...
@@
 struct pic32_sqi {  void __iomem * regs ;  struct clk * sys_clk ;  struct clk * base_clk ;  struct spi_master * master ;  int irq ;  struct completion xfer_done ;  struct ring_desc * ring ;  void * bd ;  dma_addr_t bd_dma ;  struct list_head bd_list_free ;  struct list_head bd_list_used ;  struct spi_device * cur_spi ;  u32 cur_speed ;  u8 cur_mode ; } cocci_id@p ;
...
typedef u32;
@@
 struct buf_desc {  u32 bd_ctrl ;  u32 bd_status ;  u32 bd_addr ;  u32 bd_nextp ; } cocci_id@p ;
...
@@
 struct ring_desc {  struct list_head list ;  struct buf_desc * bd ;  dma_addr_t bd_dma ;  u32 xfer_len ; } cocci_id@p ;
