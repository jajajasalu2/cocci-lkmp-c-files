...
position p;
@@
 struct vlan_hdr {  __be16 h_vlan_TCI ;  __be16 h_vlan_encapsulated_proto ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct xdp_exception_ctx {  u64 __pad ;  int prog_id ;  u32 act ;  int ifindex ; } cocci_id@p ;
...
position p;
@@
 struct cpumap_kthread_ctx * cocci_id@p ;
...
position p;
@@
 enum { XDP_REDIRECT_SUCCESS = 0 , XDP_REDIRECT_ERROR = 1 , } cocci_id@p ;
...
position p;
@@
 struct xdp_redirect_ctx * cocci_id@p ;
...
position p;
@@
 cpumap_kthread_cnt cocci_id@p ( ".maps" ) ;
...
position p;
@@
 struct xdp_exception_ctx * cocci_id@p ;
...
typedef u64,u32;
@@
 struct cpumap_kthread_ctx {  u64 __pad ;  int map_id ;  u32 act ;  int cpu ;  unsigned int drops ;  unsigned int processed ;  int sched ; } cocci_id@p ;
...
typedef __u64;
@@
 struct datarec {  __u64 processed ;  __u64 dropped ;  __u64 issue ; } cocci_id@p ;
...
position p;
@@
 cpus_available cocci_id@p ( ".maps" ) ;
...
position p;
@@
 redirect_err_cnt cocci_id@p ( ".maps" ) ;
...
typedef u64,u32;
@@
 struct cpumap_enqueue_ctx {  u64 __pad ;  int map_id ;  u32 act ;  int cpu ;  unsigned int drops ;  unsigned int processed ;  int to_cpu ; } cocci_id@p ;
...
position p;
@@
 cpumap_enqueue_cnt cocci_id@p ( ".maps" ) ;
...
position p;
@@
 struct cpumap_enqueue_ctx * cocci_id@p ;
...
typedef u64,u32;
@@
 struct xdp_redirect_ctx {  u64 __pad ;  int prog_id ;  u32 act ;  int ifindex ;  int err ;  int to_ifindex ;  u32 map_id ;  int map_index ; } cocci_id@p ;
