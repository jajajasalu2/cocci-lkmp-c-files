...
position p;
@@
 const struct {  int index ;  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ TOTAL_SWITCH_COUNTER_NUM ] ;
...
position p;
@@
 const struct ksz_dev_ops cocci_id@p ;
...
typedef bool,u32;
@@
 struct ksz_chip_data {  u32 chip_id ;  const char * dev_name ;  int num_vlans ;  int num_alus ;  int num_statics ;  int cpu_ports ;  int port_cnt ;  bool phy_errata_9477 ; } cocci_id@p ;
...
position p;
@@
 const struct ksz_chip_data cocci_id@p [ ] ;
