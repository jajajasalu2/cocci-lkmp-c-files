...
position p;
@@
 struct clk {  struct list_head node ;  unsigned long rate ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned long mrate ;  unsigned long prate ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  unsigned long rate ;  unsigned long cfg ;  unsigned long div ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  unsigned long prate ;  unsigned long rate ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  unsigned long prate ;  unsigned long drate ; } cocci_id@p [ ] ;
