...
typedef u32,u16;
@@
 struct token_range {  u32 need_capability ;  u16 min ;  u16 max ; } cocci_id@p ;
...
typedef u32;
@@
 struct smbios_call {  u32 need_capability ;  int cmd_class ;  int cmd_select ; } cocci_id@p ;
...
position p;
@@
 struct calling_interface_structure * cocci_id@p ;
...
position p;
@@
 struct smbios_device * cocci_id@p ;
...
position p;
@@
 struct smbios_device {  struct list_head list ;  struct device * device ;  int ( * call_fn ) ( struct calling_interface_buffer * arg ) ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct calling_interface_buffer * ) ;
