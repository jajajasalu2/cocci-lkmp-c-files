...
typedef u32;
@@
 struct clkctrl_provider {  int num_addrs ;  u32 * addr ;  u32 * size ;  struct device_node * node ;  struct list_head link ; } cocci_id@p ;
...
position p;
@@
 const struct omap_hwmod_reset * cocci_id@p ;
...
position p;
@@
 const struct ti_sysc_module_data * cocci_id@p ;
...
position p;
@@
 struct omap_hwmod_ocp_if * cocci_id@p ;
...
position p;
@@
 struct omap_hwmod_rst_info cocci_id@p ;
...
position p;
@@
 struct omap_hwmod_opt_clk * cocci_id@p ;
...
position p;
@@
 struct ti_sysc_cookie * cocci_id@p ;
...
position p;
@@
 struct omap_hwmod_soc_ops cocci_id@p ;
...
position p;
@@
 struct omap_hwmod_reset {  const char * match ;  int len ;  int ( * reset ) ( struct omap_hwmod * oh ) ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct omap_hwmod * oh , void * data ) ;
...
position p;
@@
 struct clkctrl_provider * cocci_id@p ;
...
position p;
@@
 struct omap_hwmod_class * cocci_id@p ;
...
position p;
@@
 struct sysc_regbits * * cocci_id@p ;
...
position p;
@@
 struct omap_hwmod_class_sysconfig * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct omap_hwmod * oh , void * user ) ;
