...
position p;
@@
 struct delayed_led_classdev * cocci_id@p ;
...
position p;
@@
 union axis_conversion * cocci_id@p ;
...
position p;
@@
 struct delayed_led_classdev {  struct led_classdev led_classdev ;  struct work_struct work ;  enum led_brightness new_brightness ;  unsigned int led ;  void ( * set_brightness ) ( struct delayed_led_classdev * data , enum led_brightness value ) ; } cocci_id@p ;
