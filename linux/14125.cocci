...
position p;
@@
 struct dma_iommu_mapping * cocci_id@p ;
...
position p;
@@
 enum isp_of_phy { ISP_OF_PHY_PARALLEL = 0 , ISP_OF_PHY_CSIPHY1 , ISP_OF_PHY_CSIPHY2 , } cocci_id@p ;
...
position p;
@@
 struct isp_async_subdev * cocci_id@p ;
...
position p;
@@
 enum ccdc_input_entity cocci_id@p ;
...
position p;
@@
 const struct isp_parallel_cfg * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct isp_device * isp ) ;
...
position p;
@@
 enum isp_pipeline_stream_state cocci_id@p ;
...
position p;
@@
 enum isp_sbl_resource cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct isp_device * isp ) ;
...
position p;
@@
 const struct isp_res_mapping cocci_id@p [ ] ;
...
position p;
@@
 enum isp_subclk_resource cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 phy ;  u32 csi2_if ;  u32 csi1_if ; } cocci_id@p [ 2 ] ;
...
position p;
@@
 enum isp_interface_type cocci_id@p ;
