...
position p;
@@
 enum chips { lm83 , lm82 , } cocci_id@p ;
...
typedef s8,u16;
@@
 struct lm83_data {  struct i2c_client * client ;  const struct attribute_group * groups [ 3 ] ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  s8 temp [ 9 ] ;  u16 alarms ; } cocci_id@p ;
