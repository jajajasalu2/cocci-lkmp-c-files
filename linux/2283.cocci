...
position p;
@@
 struct int3403_sensor {  struct int34x_thermal_zone * int340x_zone ; } cocci_id@p ;
...
position p;
@@
 struct int3403_sensor * cocci_id@p ;
...
position p;
@@
 struct int3403_priv cocci_id@p ;
...
position p;
@@
 struct int3403_cdev {  struct thermal_cooling_device * cdev ;  unsigned long max_state ; } cocci_id@p ;
...
position p;
@@
 struct int3403_cdev * cocci_id@p ;
...
typedef u64;
@@
 struct int3403_performance_state {  u64 performance ;  u64 power ;  u64 latency ;  u64 linear ;  u64 control ;  u64 raw_performace ;  char * raw_unit ;  int reserved ; } cocci_id@p ;
...
position p;
@@
 struct int3403_priv {  struct platform_device * pdev ;  struct acpi_device * adev ;  unsigned long long type ;  void * priv ; } cocci_id@p ;
