...
position p;
@@
 const struct message_header cocci_id@p ;
...
position p;
@@
 struct control_block_extended_exc_detail * cocci_id@p ;
...
position p;
@@
 struct message_queue {  union gru_mesqhead head __gru_cacheline_aligned__ ;  int qlines ;  long hstatus [ 2 ] ;  void * next __gru_cacheline_aligned__ ;  void * limit ;  void * start ;  void * start2 ;  char data ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ GRU_CACHE_LINE_BYTES ] ;
...
position p;
@@
 struct message_queue cocci_id@p ;
...
position p;
@@
 struct message_header * cocci_id@p ;
...
position p;
@@
 struct gru_control_block_status * cocci_id@p ;
...
position p;
@@
 struct gru_blade_state * cocci_id@p ;
...
position p;
@@
 struct message_header {  char present ;  char present2 ;  char lines ;  char fill ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ GRU_EXC_STR_SIZE ] ;
...
position p;
@@
 struct gru_control_block_extended * cocci_id@p ;
...
position p;
@@
 struct gru_thread_state * cocci_id@p ;
