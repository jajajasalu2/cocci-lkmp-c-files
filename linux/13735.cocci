...
position p;
@@
 const struct smiapp_csi_data_format * cocci_id@p ;
...
position p;
@@
 struct smiapp_subdev * cocci_id@p ;
...
position p;
@@
 struct smiapp_sensor * cocci_id@p ;
...
position p;
@@
 const struct smiapp_module_ident cocci_id@p [ ] ;
...
position p;
@@
 struct smiapp_binning_subtype * cocci_id@p ;
...
position p;
@@
 struct smiapp_module_info * cocci_id@p ;
...
position p;
@@
 struct smiapp_flash_strobe_parms * cocci_id@p ;
...
position p;
@@
 struct smiapp_pll_limits cocci_id@p ;
...
position p;
@@
 struct smiapp_hwconfig * cocci_id@p ;
...
position p;
@@
 struct v4l2_rect * cocci_id@p [ SMIAPP_PADS ] ;
