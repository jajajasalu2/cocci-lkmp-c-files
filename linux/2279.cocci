...
position p;
@@
 struct bcm2835_thermal_data * cocci_id@p ;
...
position p;
@@
 struct bcm2835_thermal_data {  struct thermal_zone_device * tz ;  void __iomem * regs ;  struct clk * clk ;  struct dentry * debugfsdir ; } cocci_id@p ;
