...
position p;
@@
 const struct stmmac_ops cocci_id@p ;
...
position p;
@@
 const struct stmmac_dma_ops cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct emac_variant {  u32 default_syscon_value ;  const struct reg_field * syscon_field ;  bool soc_has_internal_phy ;  bool support_mii ;  bool support_rmii ;  bool support_rgmii ;  u8 rx_delay_max ;  u8 tx_delay_max ; } cocci_id@p ;
...
position p;
@@
 struct sunxi_priv_data * cocci_id@p ;
...
position p;
@@
 struct stmmac_dma_cfg * cocci_id@p ;
...
position p;
@@
 const struct emac_variant cocci_id@p ;
...
position p;
@@
 struct mac_device_info * cocci_id@p ;
...
typedef bool;
@@
 struct sunxi_priv_data {  struct clk * tx_clk ;  struct clk * ephy_clk ;  struct regulator * regulator ;  struct reset_control * rst_ephy ;  const struct emac_variant * variant ;  struct regmap_field * regmap_field ;  bool internal_phy_powered ;  void * mux_handle ; } cocci_id@p ;
