...
position p;
@@
 struct dcn_watermark_set * cocci_id@p ;
...
position p;
@@
 enum dcn_hubbub_page_table_depth cocci_id@p ;
...
position p;
@@
 struct dcn_vmid_page_table_config cocci_id@p ;
...
position p;
@@
 const struct hubbub_funcs cocci_id@p ;
...
position p;
@@
 enum dcn_hubbub_page_table_block_size cocci_id@p ;
