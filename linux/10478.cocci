...
position p;
@@
 struct radeon_px_quirk * cocci_id@p ;
...
typedef uint32_t;
@@
 uint32_t * cocci_id@p [ RADEON_NUM_RINGS ] ;
...
position p;
@@
 unsigned cocci_id@p [ RADEON_NUM_RINGS ] ;
...
typedef u32;
@@
 struct radeon_px_quirk {  u32 chip_vendor ;  u32 chip_device ;  u32 subsys_vendor ;  u32 subsys_device ;  u32 px_quirk_flags ; } cocci_id@p ;
