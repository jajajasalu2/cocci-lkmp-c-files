...
position p;
@@
 struct sch311x_gpio_priv * cocci_id@p ;
...
position p;
@@
 struct sch311x_gpio_block * cocci_id@p ;
...
position p;
@@
 struct sch311x_pdev_data * cocci_id@p ;
...
position p;
@@
 struct sch311x_gpio_block_def {  unsigned short data_reg ;  unsigned short config_regs [ 8 ] ;  unsigned short base ; } cocci_id@p ;
...
position p;
@@
 struct sch311x_gpio_block_def cocci_id@p [ ] ;
...
position p;
@@
 struct sch311x_pdev_data {  unsigned short runtime_reg ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sch311x_gpio_block {  struct gpio_chip chip ;  unsigned short data_reg ;  unsigned short * config_regs ;  unsigned short runtime_reg ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct sch311x_gpio_priv {  struct sch311x_gpio_block blocks [ 6 ] ; } cocci_id@p ;
