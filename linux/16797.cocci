...
position p;
@@
 struct max8925_onkey_info * cocci_id@p ;
...
position p;
@@
 struct max8925_onkey_info {  struct input_dev * idev ;  struct i2c_client * i2c ;  struct device * dev ;  unsigned int irq [ 2 ] ; } cocci_id@p ;
