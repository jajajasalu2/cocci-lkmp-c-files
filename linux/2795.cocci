...
position p;
@@
 struct acpi_gpe_block_info * cocci_id@p ;
...
position p;
@@
 struct acpi_handler_info cocci_id@p [ ] ;
...
position p;
@@
 struct acpi_gpe_xrupt_info * cocci_id@p ;
...
position p;
@@
 const struct acpi_opcode_info * cocci_id@p ;
...
position p;
@@
 struct acpi_handler_info {  void * handler ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct acpi_gpe_register_info * cocci_id@p ;
...
position p;
@@
 struct acpi_gpe_notify_info * cocci_id@p ;
...
position p;
@@
 struct acpi_gpe_event_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( union acpi_parse_object * op ) ;
