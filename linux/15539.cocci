...
position p;
@@
 struct ib_ae_iocb_rsp * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ql_adapter * ) ;
...
position p;
@@
 struct flash_params_8012 cocci_id@p ;
...
position p;
@@
 struct ob_mac_iocb_req cocci_id@p ;
...
position p;
@@
 struct tx_ring_desc cocci_id@p ;
...
position p;
@@
 struct ql_mpi_coredump cocci_id@p ;
...
position p;
@@
 struct flash_params_8000 cocci_id@p ;
...
position p;
@@
 struct ib_mac_iocb_rsp * cocci_id@p ;
...
position p;
@@
 const struct nic_operations cocci_id@p ;
...
position p;
@@
 struct ob_mac_iocb_rsp * cocci_id@p ;
...
position p;
@@
 struct ob_mac_tso_iocb_req * cocci_id@p ;
...
position p;
@@
 struct intr_context * cocci_id@p ;
...
position p;
@@
 struct qlge_bq_desc * cocci_id@p ;
...
position p;
@@
 struct ql_net_rsp_iocb * cocci_id@p ;
...
position p;
@@
 struct qlge_page_chunk * cocci_id@p ;
