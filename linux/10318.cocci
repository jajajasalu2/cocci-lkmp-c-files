...
position p;
@@
 struct komeda_timing_ctrlr_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct komeda_scaler * scaler , struct komeda_data_flow_cfg * dflow , struct komeda_data_flow_cfg * l_dflow , struct komeda_data_flow_cfg * r_dflow ) ;
...
position p;
@@
 struct komeda_merger * cocci_id@p ;
...
position p;
@@
 struct komeda_compiz_state * cocci_id@p ;
...
position p;
@@
 struct komeda_layer * cocci_id@p ;
...
position p;
@@
 struct komeda_data_flow_cfg * cocci_id@p ;
...
position p;
@@
 struct komeda_component_state * cocci_id@p ;
...
position p;
@@
 struct komeda_splitter * cocci_id@p ;
...
position p;
@@
 struct komeda_pipeline * cocci_id@p ;
...
position p;
@@
 struct komeda_timing_ctrlr * cocci_id@p ;
...
position p;
@@
 struct komeda_plane_state * cocci_id@p ;
...
position p;
@@
 struct komeda_component * cocci_id@p ;
...
position p;
@@
 struct komeda_layer_state * cocci_id@p ;
...
position p;
@@
 struct komeda_crtc_state * cocci_id@p ;
...
position p;
@@
 struct komeda_scaler_state * cocci_id@p ;
...
position p;
@@
 struct komeda_improc_state * cocci_id@p ;
...
position p;
@@
 struct komeda_merger_state * cocci_id@p ;
...
position p;
@@
 struct komeda_splitter_state * cocci_id@p ;
...
position p;
@@
 struct komeda_improc * cocci_id@p ;
...
position p;
@@
 struct komeda_scaler * cocci_id@p ;
...
position p;
@@
 struct komeda_pipeline_state * cocci_id@p ;
...
position p;
@@
 struct komeda_component_output * cocci_id@p ;
...
position p;
@@
 struct komeda_compiz_input_cfg * cocci_id@p ;
...
position p;
@@
 struct komeda_compiz * cocci_id@p ;
