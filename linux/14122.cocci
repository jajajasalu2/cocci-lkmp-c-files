...
position p;
@@
 struct resizer_ratio * cocci_id@p ;
...
position p;
@@
 enum resizer_chroma_algo cocci_id@p ;
...
position p;
@@
 struct isp_res_device * cocci_id@p ;
...
position p;
@@
 const struct isprsz_coef cocci_id@p ;
...
position p;
@@
 enum resizer_input_entity cocci_id@p ;
...
position p;
@@
 const struct resizer_ratio * cocci_id@p ;
...
position p;
@@
 struct resizer_luma_yenh cocci_id@p ;
...
position p;
@@
 enum resizer_colors_type cocci_id@p ;
