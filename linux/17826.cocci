...
position p;
@@
 struct {  unsigned long qp : 6 ;  unsigned long r1 : 7 ;  unsigned long imm : 7 ;  unsigned long r3 : 7 ;  unsigned long x : 1 ;  unsigned long hint : 2 ;  unsigned long x6_sz : 2 ;  unsigned long x6_op : 4 ;  unsigned long m : 1 ;  unsigned long op : 4 ;  unsigned long pad : 23 ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( char * str , struct pt_regs * regs , long err ) ;
...
symbol cocci_id;
position p;
typedef load_store_t;
@@
 load_store_t cocci_id@p ;
...
typedef load_store_t;
@@
 union {  unsigned long l ;  load_store_t insn ; } cocci_id@p ;
...
position p;
@@
 struct ia64_fpreg cocci_id@p [ 2 ] ;
...
position p;
@@
 enum { UPD_IMMEDIATE , UPD_REG , } cocci_id@p ;
