...
position p;
@@
 struct of_pci_range_parser cocci_id@p ;
...
typedef bool,u32;
@@
 struct tegra_pcie_soc {  unsigned int num_ports ;  const struct tegra_pcie_port_soc * ports ;  unsigned int msi_base_shift ;  unsigned long afi_pex2_ctrl ;  u32 pads_pll_ctl ;  u32 tx_ref_sel ;  u32 pads_refclk_cfg0 ;  u32 pads_refclk_cfg1 ;  u32 update_fc_threshold ;  bool has_pex_clkreq_en ;  bool has_pex_bias_ctrl ;  bool has_intr_prsnt_sense ;  bool has_cml_clk ;  bool has_gen2 ;  bool force_pca_enable ;  bool program_uphy ;  bool update_clamp_threshold ;  bool program_deskew_time ;  bool raw_violation_fixup ;  bool update_fc_timer ;  bool has_cache_bars ;  struct {  struct {  u32 rp_ectl_2_r1 ;  u32 rp_ectl_4_r1 ;  u32 rp_ectl_5_r1 ;  u32 rp_ectl_6_r1 ;  u32 rp_ectl_2_r2 ;  u32 rp_ectl_4_r2 ;  u32 rp_ectl_5_r2 ;  u32 rp_ectl_6_r2 ; } regs ;  bool enable ; } ectl ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct tegra_msi {  struct msi_controller chip ; 
	 DECLARE_BITMAP ( used , INT_PCI_MSI_NR ) 
		 ;  struct irq_domain * domain ;  struct mutex lock ;  void * virt ;  dma_addr_t phys ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct tegra_pcie_port cocci_id@p ;
...
position p;
@@
 struct msi_controller * cocci_id@p ;
...
position p;
@@
 const struct tegra_pcie_port_soc cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_pcie_bus {  struct list_head list ;  unsigned int nr ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_pcie_soc * cocci_id@p ;
...
typedef u8;
@@
 struct tegra_pcie_port_soc {  struct {  u8 turnoff_bit ;  u8 ack_bit ; } pme ; } cocci_id@p ;
...
position p;
@@
 struct of_pci_range cocci_id@p ;
...
position p;
@@
 struct tegra_pcie_port {  struct tegra_pcie * pcie ;  struct device_node * np ;  struct list_head list ;  struct resource regs ;  void __iomem * base ;  unsigned int index ;  unsigned int lanes ;  struct phy * * phys ;  struct gpio_desc * reset_gpio ; } cocci_id@p ;
