...
position p;
@@
 const struct fs_context_operations cocci_id@p ;
...
position p;
@@
 enum usb_functionfs_event_type cocci_id@p ;
...
position p;
@@
 struct ffs_function * cocci_id@p ;
...
position p;
@@
 struct ffs_desc_helper * cocci_id@p ;
...
position p;
@@
 struct ffs_dev * cocci_id@p ( void ) ;
...
position p;
@@
 struct usb_interface_assoc_descriptor * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_function * , const struct usb_ctrlrequest * ) ;
...
position p;
@@
 struct usb_ext_prop_desc * cocci_id@p ;
...
position p;
@@
 struct usb_functionfs_event cocci_id@p [ ARRAY_SIZE ( ffs -> ev . types ) ] ;
...
position p;
@@
 void cocci_id@p ( struct ffs_data * ffs ) ;
...
position p;
@@
 enum ffs_os_desc_type cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ffs_dev * dev ) ;
...
position p;
@@
 struct usb_gadget_strings * * cocci_id@p ;
...
position p;
@@
 struct ffs_buffer {  size_t length ;  char * data ;  char storage [ ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ffs_function * func ) ;
...
position p;
@@
 void cocci_id@p ( struct ffs_data * ffs_data ) ;
...
position p;
@@
 struct ffs_desc_helper {  struct ffs_data * ffs ;  unsigned interfaces_count ;  unsigned eps_count ; } cocci_id@p ;
...
position p;
@@
 struct hid_descriptor cocci_id@p ;
...
position p;
@@
 struct usb_configuration * cocci_id@p ;
...
position p;
@@
 struct ccid_descriptor cocci_id@p ;
...
position p;
@@
 enum ffs_entity_type { FFS_DESCRIPTOR , FFS_INTERFACE , FFS_STRING , FFS_ENDPOINT , } cocci_id@p ;
...
position p;
@@
 struct usb_os_desc_table * cocci_id@p ;
...
typedef u8;
@@
 struct ffs_ep {  struct usb_ep * ep ;  struct usb_request * req ;  struct usb_endpoint_descriptor * descs [ 3 ] ;  u8 num ;  int status ; } cocci_id@p ;
...
position p;
@@
 struct ffs_file_perms * cocci_id@p ;
...
position p;
@@
 ffs_os_desc_callback cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usb_function * ) ;
...
position p;
@@
 enum { Opt_no_disconnect , Opt_rmode , Opt_fmode , Opt_mode , Opt_uid , Opt_gid , } cocci_id@p ;
...
position p;
@@
 enum ffs_entity_type cocci_id@p ;
...
position p;
@@
 struct usb_ss_ep_comp_descriptor cocci_id@p ;
...
position p;
@@
 const struct super_operations cocci_id@p ;
...
position p;
@@
 struct usb_descriptor_header * cocci_id@p ;
...
typedef u8;
@@
 struct ffs_function {  struct usb_configuration * conf ;  struct usb_gadget * gadget ;  struct ffs_data * ffs ;  struct ffs_ep * eps ;  u8 eps_revmap [ 16 ] ;  short * interfaces_nums ;  struct usb_function function ; } cocci_id@p ;
...
position p;
@@
 struct ffs_sb_fill_data * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( enum ffs_os_desc_type entity , struct usb_os_desc_header * h , void * data , unsigned len , void * priv ) ;
...
position p;
@@
 struct ffs_dev * cocci_id@p ( const char * name ) ;
...
typedef u8;
@@
 int ( * cocci_id@p ) ( enum ffs_entity_type entity , u8 * valuep , struct usb_descriptor_header * desc , void * priv ) ;
...
position p;
@@
 struct dentry * cocci_id@p ( struct super_block * sb , const char * name , void * data , const struct file_operations * fops ) ;
...
position p;
@@
 struct usb_os_desc_header * cocci_id@p ;
...
position p;
@@
 struct configfs_item_operations cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct ffs_function * func , u8 num ) ;
...
position p;
@@
 struct usb_endpoint_descriptor * cocci_id@p ;
...
position p;
@@
 struct usb_function * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_configuration * , struct usb_function * ) ;
...
position p;
@@
 struct usb_os_desc_ext_prop cocci_id@p ;
...
position p;
@@
 ffs_entity_callback cocci_id@p ;
...
position p;
@@
 const struct config_item_type cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ffs_epfile * epfiles , unsigned count ) ;
...
position p;
@@
 int cocci_id@p ( struct ffs_data * ffs ) ;
...
symbol cocci_id;
position p;
typedef bool,umode_t;
@@
 struct ffs_sb_fill_data {  struct ffs_file_perms perms ;  umode_t root_mode ;  const char * dev_name ;  bool no_disconnect ;  struct ffs_data * ffs_data ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct usb_function * , const struct usb_ctrlrequest * , bool config0 ) ;
...
position p;
@@
 void * cocci_id@p ( const char * dev_name ) ;
...
position p;
@@
 struct usb_functionfs_event cocci_id@p ;
...
position p;
@@
 enum ffs_os_desc_type { FFS_OS_DESC , FFS_OS_DESC_EXT_COMPAT , FFS_OS_DESC_EXT_PROP , } cocci_id@p ;
...
typedef bool;
@@
 struct ffs_io_data {  bool aio ;  bool read ;  struct kiocb * kiocb ;  struct iov_iter data ;  const void * to_free ;  char * buf ;  struct mm_struct * mm ;  struct work_struct work ;  struct usb_ep * ep ;  struct usb_request * req ;  struct sg_table sgt ;  bool use_sg ;  struct ffs_data * ffs ; } cocci_id@p ;
...
position p;
@@
 struct usb_ext_compat_desc cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct ffs_function * func , u8 intf ) ;
...
position p;
@@
 struct usb_otg_descriptor cocci_id@p ;
...
position p;
@@
 const struct usb_ctrlrequest * cocci_id@p ;
...
position p;
@@
 struct usb_composite_dev * cocci_id@p ;
...
position p;
@@
 enum ffs_setup_state cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_function * , unsigned , unsigned ) ;
...
position p;
@@
 struct usb_interface_descriptor * cocci_id@p ;
...
position p;
@@
 struct usb_function_instance * cocci_id@p ;
