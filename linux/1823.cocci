...
position p;
@@
 const struct opt3001 * cocci_id@p ;
...
position p;
@@
 struct opt3001_scale {  int val ;  int val2 ; } cocci_id@p ;
...
position p;
@@
 const struct opt3001_scale cocci_id@p [ ] ;
...
@@
 struct opt3001 {  struct i2c_client * client ;  struct device * dev ;  struct mutex lock ;  bool ok_to_ignore_lock ;  bool result_ready ;  wait_queue_head_t result_ready_queue ;  u16 result ;  u32 int_time ;  u32 mode ;  u16 high_thresh_mantissa ;  u16 low_thresh_mantissa ;  u8 high_thresh_exp ;  u8 low_thresh_exp ;  bool use_irq ; } cocci_id@p ;
