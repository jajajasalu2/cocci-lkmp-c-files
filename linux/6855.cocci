...
position p;
@@
 enum fc_lport_state cocci_id@p ;
...
position p;
@@
 struct fc_fdmi_dhba cocci_id@p ;
...
position p;
@@
 struct fc_fdmi_attr_entry cocci_id@p ;
...
typedef u32,u16;
@@
 struct fc_bsg_info {  struct bsg_job * job ;  struct fc_lport * lport ;  u16 rsp_code ;  struct scatterlist * sg ;  u32 nents ;  size_t offset ; } cocci_id@p ;
...
position p;
@@
 struct fc_seq_els_data cocci_id@p ;
...
position p;
@@
 enum fc_rport_event cocci_id@p ;
...
position p;
@@
 struct fc_els_flogi * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_lport * , struct fc_frame * ) ;
...
position p;
@@
 struct fc_fdmi_rhba cocci_id@p ;
...
position p;
@@
 struct fc_rport_operations cocci_id@p ;
...
position p;
@@
 struct fc_fdmi_dprt cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_lport * , enum fc_lport_state ) ;
...
position p;
@@
 struct fc_ns_rff_id cocci_id@p ;
...
position p;
@@
 struct {  struct fc_els_rnid_resp rnid ;  struct fc_els_rnid_cid cid ;  struct fc_els_rnid_gen gen ; } * cocci_id@p ;
...
position p;
@@
 const struct fc_els_spp * cocci_id@p ;
