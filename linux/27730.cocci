...
position p;
@@
 struct gfs2_ea_header * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ea_skeleton_call_t;
@@
 ea_skeleton_call_t cocci_id@p ;
...
position p;
@@
 struct ea_set {  int ea_split ;  struct gfs2_ea_request * es_er ;  struct gfs2_ea_location * es_el ;  struct buffer_head * es_bh ;  struct gfs2_ea_header * es_ea ; } cocci_id@p ;
...
position p;
@@
 struct gfs2_ea_location * cocci_id@p ;
...
position p;
@@
 struct ea_list {  struct gfs2_ea_request * ei_er ;  unsigned int ei_size ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct gfs2_inode * ip , struct gfs2_ea_request * er , void * private ) ;
...
position p;
@@
 struct gfs2_ea_request cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct gfs2_inode * ip , struct buffer_head * bh , struct gfs2_ea_header * ea , struct gfs2_ea_header * prev , void * private ) ;
...
position p;
@@
 struct ea_find {  int type ;  const char * name ;  size_t namel ;  struct gfs2_ea_location * ef_el ; } cocci_id@p ;
