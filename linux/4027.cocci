...
position p;
@@
 struct al_fic {  void __iomem * base ;  struct irq_domain * domain ;  const char * name ;  unsigned int parent_irq ;  enum al_fic_state state ; } cocci_id@p ;
...
position p;
@@
 enum al_fic_state { AL_FIC_UNCONFIGURED = 0 , AL_FIC_CONFIGURED_LEVEL , AL_FIC_CONFIGURED_RISING_EDGE , } cocci_id@p ;
