...
position p;
@@
 const  cocci_id@p ( max98371_dht_rot_gain , 
							     0 , 1 , 
...
position p;
@@
 struct max98371_priv * cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( max98371_dht_max_gain , 
							     0 , 1 , 
...
position p;
@@
 const  cocci_id@p ( max98371_dht_min_gain , 
							     0 , 1 , 
							     TLV_DB_SCALE_ITEM ( 537 , 66 , 0 ) , 
							     2 , 3 , 
							     TLV_DB_SCALE_ITEM ( 677 , 82 , 0 ) , 
...
position p;
@@
 const  cocci_id@p ( max98371_gain_tlv , 
							      0 , 7 , 
