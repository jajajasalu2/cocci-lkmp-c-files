...
position p;
@@
 struct twl6030_gpadc_data {  struct device * dev ;  struct mutex lock ;  struct completion irq_complete ;  struct twl6030_chnl_calib * twl6030_cal_tbl ;  const struct twl6030_gpadc_platform_data * pdata ; } cocci_id@p ;
...
typedef s32;
@@
 struct twl6030_chnl_calib {  s32 gain ;  s32 gain_error ;  s32 offset_error ; } cocci_id@p ;
...
typedef u8;
@@
 struct twl6030_gpadc_platform_data {  const int nchannels ;  const struct iio_chan_spec * iio_channels ;  const struct twl6030_ideal_code * ideal ;  int ( * start_conversion ) ( int channel ) ;  u8 ( * channel_to_reg ) ( int channel ) ;  int ( * calibrate ) ( struct twl6030_gpadc_data * gpadc ) ; } cocci_id@p ;
...
typedef u16;
@@
 struct twl6030_ideal_code {  int channel ;  u16 code1 ;  u16 code2 ;  u16 volt1 ;  u16 volt2 ; } cocci_id@p ;
...
position p;
@@
 const struct twl6030_ideal_code * cocci_id@p ;
...
position p;
@@
 struct twl6030_gpadc_data * cocci_id@p ;
...
position p;
@@
 const struct twl6030_gpadc_platform_data * cocci_id@p ;
...
position p;
@@
 const struct twl6030_ideal_code cocci_id@p [ TWL6030_GPADC_USED_CHANNELS ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ TWL6030_GPADC_NUM_TRIM_REGS ] ;
...
position p;
@@
 const struct twl6030_ideal_code cocci_id@p [ TWL6032_GPADC_USED_CHANNELS ] ;
