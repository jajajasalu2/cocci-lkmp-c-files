...
position p;
@@
 struct ebt_standard_target * cocci_id@p ;
...
typedef u32;
@@
 struct ebt_entries_buf_state {  char * buf_kern_start ;  u32 buf_kern_len ;  u32 buf_kern_offset ;  u32 buf_user_offset ; } cocci_id@p ;
...
position p;
@@
 struct ebt_cl_stack {  struct ebt_chainstack cs ;  int from ;  unsigned int hookmask ; } cocci_id@p ;
...
position p;
@@
 struct ebt_entry_watcher cocci_id@p ;
...
position p;
@@
 struct ebt_entries_buf_state cocci_id@p ;
...
position p;
@@
 struct ebt_table_info * cocci_id@p ;
...
position p;
@@
 const struct ebt_entry * cocci_id@p ;
...
position p;
@@
 enum compat_mwt { EBT_COMPAT_MATCH , EBT_COMPAT_WATCHER , EBT_COMPAT_TARGET , } cocci_id@p ;
...
position p;
@@
 struct ebt_cl_stack * cocci_id@p ;
...
position p;
@@
 const struct ebt_counter * cocci_id@p ;
...
position p;
@@
 struct ebt_entry_target cocci_id@p ;
...
position p;
@@
 const struct ebt_table * cocci_id@p ;
...
position p;
@@
 struct compat_ebt_replace cocci_id@p ;
...
position p;
@@
 struct compat_ebt_entry_mwt cocci_id@p ;
...
position p;
@@
 const struct ebt_table_info * cocci_id@p ;
...
position p;
@@
 const struct ebt_entry_target * cocci_id@p ;
...
position p;
@@
 const struct ebt_entry_match * cocci_id@p ;
...
position p;
@@
 struct ebt_chainstack * cocci_id@p ;
...
position p;
@@
 const struct net_bridge_port * cocci_id@p ;
...
position p;
@@
 struct ebt_entry_match * cocci_id@p ;
...
position p;
@@
 const struct xt_match * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uint_t,compat_uptr_t;
@@
 struct compat_ebt_replace {  char name [ EBT_TABLE_MAXNAMELEN ] ;  compat_uint_t valid_hooks ;  compat_uint_t nentries ;  compat_uint_t entries_size ;  compat_uptr_t hook_entry [ NF_BR_NUMHOOKS ] ;  compat_uint_t num_counters ;  compat_uptr_t counters ;  compat_uptr_t entries ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ EBT_EXTENSION_MAXNAMELEN ] ;
...
position p;
@@
 const struct ebt_entry_watcher * cocci_id@p ;
...
position p;
@@
 struct {  struct list_head list ;  char name [ EBT_FUNCTION_MAXNAMELEN ] ; } * cocci_id@p ;
...
position p;
@@
 const struct ebt_entries * cocci_id@p ;
...
position p;
@@
 struct ebt_replace_kernel * cocci_id@p ;
...
position p;
@@
 const struct ebt_replace * cocci_id@p ;
...
position p;
@@
 const struct xt_target * cocci_id@p ;
