...
position p;
@@
 struct sel_netnode_bkt cocci_id@p [ SEL_NETNODE_HASH_SIZE ] ;
...
position p;
@@
 struct sel_netnode {  struct netnode_security_struct nsec ;  struct list_head list ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct sel_netnode_bkt {  unsigned int size ;  struct list_head list ; } cocci_id@p ;
