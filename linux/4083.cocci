...
position p;
@@
 struct exynos_bus {  struct device * dev ;  struct devfreq * devfreq ;  struct devfreq_event_dev * * edev ;  unsigned int edev_count ;  struct mutex lock ;  unsigned long curr_freq ;  struct opp_table * opp_table ;  struct clk * clk ;  unsigned int ratio ; } cocci_id@p ;
...
position p;
@@
 struct devfreq_passive_data * cocci_id@p ;
...
position p;
@@
 struct devfreq_simple_ondemand_data * cocci_id@p ;
