...
position p;
@@
 struct ab8500_regulator_info cocci_id@p [ AB8505_NUM_REGULATORS ] ;
...
position p;
@@
 struct ab8500_shared_mode cocci_id@p ;
...
typedef u8;
@@
 struct ab8500_reg_init {  u8 bank ;  u8 addr ;  u8 mask ; } cocci_id@p ;
...
typedef bool;
@@
 struct ab8500_shared_mode {  struct ab8500_regulator_info * shared_regulator ;  bool lp_mode_req ; } cocci_id@p ;
...
position p;
@@
 struct ab8500_regulator_info cocci_id@p [ AB8500_NUM_REGULATORS ] ;
...
position p;
@@
 struct ab8500_reg_init cocci_id@p [ ] ;
...
position p;
@@
 struct ab8500_regulator_info * cocci_id@p ;
...
position p;
@@
 struct {  struct ab8500_regulator_info * info ;  int info_size ;  struct ab8500_reg_init * init ;  int init_size ;  struct of_regulator_match * match ;  int match_size ; } cocci_id@p ;
