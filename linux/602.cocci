...
typedef u32;
@@
 struct pkcs8_parse_context {  struct public_key * pub ;  unsigned long data ;  enum OID last_oid ;  enum OID algo_oid ;  u32 key_size ;  const void * key ; } cocci_id@p ;
...
position p;
@@
 struct pkcs8_parse_context cocci_id@p ;
