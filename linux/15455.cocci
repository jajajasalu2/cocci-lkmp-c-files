...
position p;
@@
 struct wm831x_watchdog_pdata * cocci_id@p ;
...
position p;
@@
 struct wm831x_wdt_drvdata * cocci_id@p ;
...
typedef u16;
@@
 struct {  unsigned int time ;  u16 val ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wm831x_wdt_drvdata {  struct watchdog_device wdt ;  struct wm831x * wm831x ;  struct mutex lock ;  int update_gpio ;  int update_state ; } cocci_id@p ;
