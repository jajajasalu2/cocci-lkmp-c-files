...
position p;
@@
 struct imgu_mmu_info * cocci_id@p ;
...
@@
 struct imgu_mmu {  struct device * dev ;  void __iomem * base ;  spinlock_t lock ;  void * dummy_page ;  u32 dummy_page_pteval ;  u32 * dummy_l2pt ;  u32 dummy_l2pt_pteval ;  u32 * * l2pts ;  u32 * l1pt ;  struct imgu_mmu_info geometry ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct imgu_mmu * mmu ) ;
