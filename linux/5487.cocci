...
position p;
@@
 struct mpc52xx_psc_spi * cocci_id@p ;
...
position p;
@@
 struct fsl_spi_platform_data * cocci_id@p ;
...
position p;
@@
 struct mpc52xx_psc_spi_cs {  int bits_per_word ;  int speed_hz ; } cocci_id@p ;
...
position p;
@@
 struct mpc52xx_psc_spi_cs * cocci_id@p ;
