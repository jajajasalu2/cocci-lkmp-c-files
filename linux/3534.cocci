...
position p;
@@
 struct dw_mci_rockchip_priv_data {  struct clk * drv_clk ;  struct clk * sample_clk ;  int default_sample_phase ;  int num_phases ; } cocci_id@p ;
...
position p;
@@
 struct dw_mci_rockchip_priv_data * cocci_id@p ;
...
typedef range_t;
@@
 struct range_t {  int start ;  int end ; } cocci_id@p ;
