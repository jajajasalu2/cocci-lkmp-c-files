...
@@
 struct hdq_data {  struct device * dev ;  void __iomem * hdq_base ;  struct mutex hdq_mutex ;  int hdq_usecount ;  u8 hdq_irqstatus ;  spinlock_t hdq_spinlock ;  int init_trans ;  int rrw ;  int mode ; } cocci_id@p ;
