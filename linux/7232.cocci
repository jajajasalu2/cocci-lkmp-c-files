...
typedef spinlock_t;
@@
 struct bluecard_info {  struct pcmcia_device * p_dev ;  struct hci_dev * hdev ;  spinlock_t lock ;  struct timer_list timer ;  struct sk_buff_head txq ;  unsigned long tx_state ;  unsigned long rx_state ;  unsigned long rx_count ;  struct sk_buff * rx_skb ;  unsigned char ctrl_reg ;  unsigned long hw_state ; } cocci_id@p ;
...
position p;
@@
 struct bluecard_info * cocci_id@p ;
