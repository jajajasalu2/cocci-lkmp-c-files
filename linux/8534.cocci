...
position p;
@@
 struct atl1_adapter * cocci_id@p ;
...
position p;
@@
 struct rx_free_desc cocci_id@p ;
...
position p;
@@
 struct tx_packet_desc cocci_id@p ;
...
position p;
@@
 struct atl1_opt_list * cocci_id@p ;
...
position p;
@@
 struct rx_return_desc * cocci_id@p ;
...
position p;
@@
 struct atl1_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
...
position p;
@@
 struct atl1_tpd_ring cocci_id@p ;
...
position p;
@@
 struct atl1_option {  enum { enable_option , range_option , list_option , } type ;  char * name ;  char * err ;  int def ;  union {  struct {  int min ;  int max ; } r ;  struct {  int nr ;  struct atl1_opt_list {  int i ;  char * str ; } * p ; } l ; } arg ; } cocci_id@p ;
...
position p;
@@
 struct coals_msg_block cocci_id@p ;
...
position p;
@@
 struct atl1_ring_header cocci_id@p ;
...
position p;
@@
 struct atl1_rrd_ring * cocci_id@p ;
...
position p;
@@
 struct atl1_rfd_ring * cocci_id@p ;
...
position p;
@@
 struct stats_msg_block * cocci_id@p ;
