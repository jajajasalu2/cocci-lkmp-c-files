...
position p;
@@
 const struct snd_dmaengine_dai_dma_data * cocci_id@p ;
...
@@
 struct dmaengine_pcm_runtime_data {  struct dma_chan * dma_chan ;  dma_cookie_t cookie ;  unsigned int pos ; } cocci_id@p ;
...
position p;
@@
 struct dmaengine_pcm_runtime_data * cocci_id@p ;
...
position p;
@@
 const struct snd_pcm_substream * cocci_id@p ;
