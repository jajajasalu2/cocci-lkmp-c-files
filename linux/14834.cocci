...
position p;
@@
 struct pxa910_clk_unit {  struct mmp_clk_unit unit ;  void __iomem * mpmu_base ;  void __iomem * apmu_base ;  void __iomem * apbc_base ;  void __iomem * apbcp_base ; } cocci_id@p ;
...
position p;
@@
 struct pxa910_clk_unit * cocci_id@p ;
