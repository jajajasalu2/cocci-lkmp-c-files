...
position p;
@@
 const struct sci_phy_oem_params * cocci_id@p ;
...
position p;
@@
 struct scu_unsolicited_frame_header * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sci_state_transition_t;
@@
 sci_state_transition_t cocci_id@p ;
...
position p;
@@
 const struct sci_oem_params * cocci_id@p ;
...
position p;
@@
 enum cable_selections cocci_id@p ;
