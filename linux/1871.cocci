...
typedef bool;
@@
 struct ingenic_adc {  void __iomem * base ;  struct clk * clk ;  struct mutex lock ;  struct mutex aux_lock ;  const struct ingenic_adc_soc_data * soc_data ;  bool low_vref_mode ; } cocci_id@p ;
...
position p;
@@
 const struct ingenic_adc_soc_data cocci_id@p ;
