...
position p;
@@
 struct b43legacy_dfs_file * cocci_id@p ;
...
position p;
@@
 struct b43legacy_debugfs_fops cocci_id@p ;
...
position p;
@@
 struct b43legacy_dfsentry * cocci_id@p ;
...
position p;
@@
 enum b43legacy_dyndbg cocci_id@p ;
...
position p;
@@
 const struct b43legacy_debugfs_fops * cocci_id@p ;
...
position p;
@@
 struct b43legacy_txstatus_log * cocci_id@p ;
