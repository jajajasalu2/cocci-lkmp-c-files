...
position p;
@@
 struct mt7601u_rx_queue * cocci_id@p ;
...
position p;
@@
 struct mt7601u_dma_buf_tx * cocci_id@p ;
...
position p;
@@
 struct mt7601u_dma_buf_rx * cocci_id@p ;
...
position p;
@@
 struct mt7601u_tx_queue * cocci_id@p ;
