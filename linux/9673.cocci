...
position p;
@@
 enum n_rail_type { N_RAIL_I = 0 , N_RAIL_Q = 1 , } cocci_id@p ;
...
position p;
@@
 enum b43_nphy_rf_sequence cocci_id@p ;
...
typedef s32,u32;
@@
 struct nphy_iq_est {  s32 iq0_prod ;  u32 i0_pwr ;  u32 q0_pwr ;  s32 iq1_prod ;  u32 i1_pwr ;  u32 q1_pwr ; } cocci_id@p ;
...
typedef u16;
@@
 struct nphy_iqcal_params {  u16 tx_lpf ;  u16 txgm ;  u16 pga ;  u16 pad ;  u16 ipa ;  u16 cal_gain ;  u16 ncorr [ 5 ] ; } cocci_id@p ;
...
position p;
@@
 const struct b43_phy_operations cocci_id@p ;
...
position p;
@@
 struct b43_chanspec * cocci_id@p ;
...
position p;
@@
 enum n_intc_override cocci_id@p ;
...
position p;
@@
 const struct b43_nphy_chantabent_rev7_2g * cocci_id@p ;
...
position p;
@@
 struct nphy_gain_ctl_workaround_entry * cocci_id@p ;
...
position p;
@@
 const struct b43_nphy_channeltab_entry_rev3 * cocci_id@p ;
...
position p;
@@
 struct b43_phy_n_iq_comp cocci_id@p ;
...
position p;
@@
 const struct nphy_rf_control_override_rev2 * cocci_id@p ;
...
position p;
@@
 enum n_rf_ctl_over_cmd { N_RF_CTL_OVER_CMD_RXRF_PU = 0 , N_RF_CTL_OVER_CMD_RX_PU = 1 , N_RF_CTL_OVER_CMD_TX_PU = 2 , N_RF_CTL_OVER_CMD_RX_GAIN = 3 , N_RF_CTL_OVER_CMD_TX_GAIN = 4 , } cocci_id@p ;
...
position p;
@@
 enum n_intc_override { N_INTC_OVERRIDE_OFF = 0 , N_INTC_OVERRIDE_TRSW = 1 , N_INTC_OVERRIDE_PA = 2 , N_INTC_OVERRIDE_EXT_LNA_PU = 3 , N_INTC_OVERRIDE_EXT_LNA_GAIN = 4 , } cocci_id@p ;
...
position p;
@@
 enum n_rssi_type { N_RSSI_W1 = 0 , N_RSSI_W2 , N_RSSI_NB , N_RSSI_IQ , N_RSSI_TSSI_2G , N_RSSI_TSSI_5G , N_RSSI_TBD , } cocci_id@p ;
...
position p;
@@
 enum b43_nphy_rf_sequence { B43_RFSEQ_RX2TX , B43_RFSEQ_TX2RX , B43_RFSEQ_RESET2RX , B43_RFSEQ_UPDATE_GAINH , B43_RFSEQ_UPDATE_GAINL , B43_RFSEQ_UPDATE_GAINU , } cocci_id@p ;
...
position p;
@@
 const struct nphy_rf_control_override_rev7 * cocci_id@p ;
...
position p;
@@
 const struct b43_nphy_channeltab_entry_rev2 * cocci_id@p ;
...
position p;
@@
 const struct b43_nphy_chantabent_rev7 * cocci_id@p ;
...
position p;
@@
 const struct nphy_rf_control_override_rev3 * cocci_id@p ;
...
position p;
@@
 enum b43_txpwr_result cocci_id@p ;
...
typedef u16;
@@
 struct nphy_txgains {  u16 tx_lpf [ 2 ] ;  u16 txgm [ 2 ] ;  u16 pga [ 2 ] ;  u16 pad [ 2 ] ;  u16 ipa [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum n_rf_ctl_over_cmd cocci_id@p ;
...
position p;
@@
 const struct b43_phy_n_sfo_cfg * cocci_id@p ;
