...
position p;
@@
 const struct esdhc_clk_fixup cocci_id@p ;
...
position p;
@@
 struct esdhc_clk_fixup {  const unsigned int sd_dflt_max_clk ;  const unsigned int max_clk [ MMC_TIMING_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct soc_device_attribute cocci_id@p [ ] ;
