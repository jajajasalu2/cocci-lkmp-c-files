...
position p;
@@
 struct vpfe_ccdc_black_compensation * cocci_id@p ;
...
position p;
@@
 struct vpfe_cap_buffer * cocci_id@p ;
...
position p;
@@
 struct ccdc_params_ycbcr * cocci_id@p ;
...
position p;
@@
 struct vpfe_ccdc_config_params_raw * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vpfe_device * vpfe , const struct vpfe_fmt * fmt , struct v4l2_format * f ) ;
...
position p;
@@
 struct vpfe_ccdc_black_clamp * cocci_id@p ;
...
position p;
@@
 struct vpfe_subdev_info * cocci_id@p ;
...
position p;
@@
 struct vpfe_fmt cocci_id@p [ VPFE_NUM_FORMATS ] ;
...
position p;
@@
 struct vpfe_hw_if_param * cocci_id@p ;
...
position p;
@@
 struct ccdc_params_raw * cocci_id@p ;
...
position p;
@@
 struct vpfe_standard {  v4l2_std_id std_id ;  unsigned int width ;  unsigned int height ;  struct v4l2_fract pixelaspect ;  int frame_format ; } cocci_id@p ;
...
position p;
@@
 const struct vpfe_standard cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct vpfe_device * vpfe , struct v4l2_mbus_framefmt * fmt ) ;
...
position p;
@@
 const struct vpfe_fmt * cocci_id@p ;
