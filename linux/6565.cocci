...
position p;
@@
 struct bmic_csmi_smp_passthru * cocci_id@p ;
...
position p;
@@
 struct pqi_sas_port * cocci_id@p ;
...
position p;
@@
 struct bmic_csmi_ioctl_header * cocci_id@p ;
...
position p;
@@
 struct pqi_sas_node * cocci_id@p ;
