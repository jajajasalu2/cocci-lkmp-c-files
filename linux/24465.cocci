...
position p;
@@
 struct dccp_hdr_reset cocci_id@p ;
...
position p;
@@
 struct dccp_hdr_ext cocci_id@p ;
...
position p;
@@
 const enum dccp_pkt_type cocci_id@p ;
...
position p;
@@
 struct dccp_hdr_response cocci_id@p ;
...
position p;
@@
 enum dccp_reset_codes cocci_id@p ;
