...
position p;
@@
 struct scb_ampdu_tid_ini * cocci_id@p ;
...
position p;
@@
 struct brcms_fifo_info * cocci_id@p ;
...
typedef u16;
@@
 struct cb_del_ampdu_pars {  struct ieee80211_sta * sta ;  u16 tid ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct brcms_fifo_info {  u16 ampdu_pld_size ;  u8 mcs2ampdu_table [ FFPLD_MAX_MCS + 1 ] ;  u16 prev_txfunfl ;  u32 accum_txfunfl ;  u32 accum_txampdu ;  u32 prev_txampdu ;  u32 dmaxferrate ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ T_RAM_ACCESS_SZ * 2 ] ;
