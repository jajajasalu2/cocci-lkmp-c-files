...
typedef u64;
@@
 struct aer_stats {  u64 dev_cor_errs [ AER_MAX_TYPEOF_COR_ERRS ] ;  u64 dev_fatal_errs [ AER_MAX_TYPEOF_UNCOR_ERRS ] ;  u64 dev_nonfatal_errs [ AER_MAX_TYPEOF_UNCOR_ERRS ] ;  u64 dev_total_cor_errs ;  u64 dev_total_fatal_errs ;  u64 dev_total_nonfatal_errs ;  u64 rootport_total_cor_errs ;  u64 rootport_total_fatal_errs ;  u64 rootport_total_nonfatal_errs ; } cocci_id@p ;
...
position p;
@@
 struct aer_hest_parse_info cocci_id@p ;
...
position p;
@@
 struct aer_hest_parse_info {  struct pci_dev * pci_dev ;  int firmware_first ; } cocci_id@p ;
...
position p;
@@
 struct pci_cap_saved_state * cocci_id@p ;
...
position p;
@@
 struct aer_err_source cocci_id@p ;
...
position p;
@@
 struct aer_err_source {  unsigned int status ;  unsigned int id ; } cocci_id@p ;
...
position p;
@@
 struct aer_recover_entry cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ AER_MAX_TYPEOF_COR_ERRS ] ;
...
position p;
@@
 const char * cocci_id@p [ AER_MAX_TYPEOF_UNCOR_ERRS ] ;
...
position p;
@@
 struct aer_err_info * cocci_id@p ;
...
position p;
@@
 struct pcie_port_service_driver cocci_id@p ;
...
position p;
@@
 struct aer_header_log_regs * cocci_id@p ;
...
typedef u8,u16;
@@
 struct aer_recover_entry {  u8 bus ;  u8 devfn ;  u16 domain ;  int severity ;  struct aer_capability_regs * regs ; } cocci_id@p ;
...
position p;
@@
 struct aer_capability_regs * cocci_id@p ;
...
position p;
@@
 struct acpi_hest_header * cocci_id@p ;
...
position p;
@@
 struct acpi_hest_aer_common * cocci_id@p ;
