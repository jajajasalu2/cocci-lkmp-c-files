...
position p;
@@
 struct grip_mp {  struct gameport * gameport ;  struct grip_port * port [ GRIP_MAX_PORTS ] ;  int reads ;  int bads ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int i , struct grip_mp * grip ) ;
...
position p;
@@
 struct grip_port {  struct input_dev * dev ;  int mode ;  int registered ;  int buttons ;  int xaxes ;  int yaxes ;  int dirty ; } cocci_id@p ;
