...
position p;
@@
 struct lio_vf_rep_resp * cocci_id@p ;
...
position p;
@@
 struct lio_vf_rep_req * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , struct rtnl_link_stats64 * stats64 ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * ndev , int new_mtu ) ;
...
position p;
@@
 struct lio_vf_rep_desc cocci_id@p ;
...
position p;
@@
 struct octeon_instr_pki_ih3 * cocci_id@p ;
...
position p;
@@
 struct octeon_skb_page_info * cocci_id@p ;
...
typedef netdev_tx_t;
@@
 netdev_tx_t cocci_id@p ( struct sk_buff * skb , struct net_device * ndev ) ;
...
position p;
@@
 struct lio_vf_rep_stats cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , struct netdev_phys_item_id * ppid ) ;
