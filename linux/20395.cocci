...
typedef atomic_t;
@@
 atomic_t cocci_id@p [ APIC_EILVT_NR_MAX ] ;
...
typedef u32;
@@
 union apic_ir {  unsigned long map [ APIC_IR_MAPSIZE ] ;  u32 regs [ APIC_IR_REGS ] ; } cocci_id@p ;
...
position p;
@@
 enum apic_intr_mode_id cocci_id@p ;
...
position p;
@@
 struct {  int active ;  unsigned int apic_id ;  unsigned int apic_taskpri ;  unsigned int apic_ldr ;  unsigned int apic_dfr ;  unsigned int apic_spiv ;  unsigned int apic_lvtt ;  unsigned int apic_lvtpc ;  unsigned int apic_lvt0 ;  unsigned int apic_lvt1 ;  unsigned int apic_lvterr ;  unsigned int apic_tmict ;  unsigned int apic_tdcr ;  unsigned int apic_thmr ;  unsigned int apic_cmci ; } cocci_id@p ;
...
position p;
@@
 enum { X2APIC_OFF , X2APIC_ON , X2APIC_DISABLED , } cocci_id@p ;
