...
typedef dma_addr_t;
@@
 struct rpi_ts {  struct platform_device * pdev ;  struct input_dev * input ;  struct touchscreen_properties prop ;  void __iomem * fw_regs_va ;  dma_addr_t fw_regs_phys ;  int known_ids ; } cocci_id@p ;
...
typedef u8;
@@
 struct rpi_ts_regs {  u8 device_mode ;  u8 gesture_id ;  u8 num_points ;  struct rpi_ts_touch {  u8 xh ;  u8 xl ;  u8 yh ;  u8 yl ;  u8 pressure ;  u8 area ; } point [ RPI_TS_MAX_SUPPORTED_POINTS ] ; } cocci_id@p ;
