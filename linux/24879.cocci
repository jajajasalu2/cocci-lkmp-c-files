...
position p;
@@
 struct br2684_filter_set cocci_id@p ;
...
position p;
@@
 struct atm_newif_br2684 cocci_id@p ;
...
position p;
@@
 const struct br2684_vcc * cocci_id@p ;
...
position p;
@@
 enum br2684_encaps { e_vc = BR2684_ENCAPS_VC , e_llc = BR2684_ENCAPS_LLC , } cocci_id@p ;
...
position p;
@@
 enum br2684_payload cocci_id@p ;
...
position p;
@@
 const struct br2684_dev * cocci_id@p ;
...
position p;
@@
 struct atm_backend_br2684 cocci_id@p ;
...
position p;
@@
 struct br2684_dev {  struct net_device * net_dev ;  struct list_head br2684_devs ;  int number ;  struct list_head brvccs ;  int mac_was_set ;  enum br2684_payload payload ; } cocci_id@p ;
...
position p;
@@
 const struct br2684_if_spec * cocci_id@p ;
