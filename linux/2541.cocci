...
position p;
@@
 void cocci_id@p ( struct mddev * mddev , struct r10bio * r10_bio ) ;
...
position p;
@@
 struct raid10_plug_cb * cocci_id@p ;
...
position p;
@@
 struct resync_pages cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct r10conf * conf ) ;
...
position p;
@@
 int cocci_id@p ( struct r10conf * conf , int previous , int ignore ) ;
...
position p;
@@
 struct raid10_plug_cb {  struct blk_plug_cb cb ;  struct bio_list pending ;  int pending_cnt ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct r10conf * conf , int ignore ) ;
...
position p;
@@
 int cocci_id@p ( struct mddev * mddev , struct r10bio * r10_bio ) ;
...
position p;
@@
 enum geo_type { geo_new , geo_old , geo_start , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct r10bio * r10_bio ) ;
