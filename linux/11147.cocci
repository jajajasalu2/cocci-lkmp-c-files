...
position p;
@@
 enum dwb_subsample_position cocci_id@p ;
...
position p;
@@
 struct scaling_taps cocci_id@p ;
...
position p;
@@
 enum wbscl_coef_filter_type_sel cocci_id@p ;
