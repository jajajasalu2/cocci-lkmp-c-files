...
position p;
@@
 struct drm_vgem_fence_attach * cocci_id@p ;
...
position p;
@@
 struct vgem_fence {  struct dma_fence base ;  struct spinlock lock ;  struct timer_list timer ; } cocci_id@p ;
...
position p;
@@
 struct drm_vgem_fence_signal * cocci_id@p ;
