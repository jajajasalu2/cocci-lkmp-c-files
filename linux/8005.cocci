...
position p;
@@
 struct ntb_netdev {  struct pci_dev * pdev ;  struct net_device * ndev ;  struct ntb_transport_qp * qp ;  struct timer_list tx_timer ; } cocci_id@p ;
