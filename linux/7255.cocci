...
typedef spinlock_t;
@@
 struct ll_struct {  struct sk_buff * rx_skb ;  struct sk_buff_head txq ;  spinlock_t hcill_lock ;  unsigned long hcill_state ;  struct sk_buff_head tx_wait_q ; } cocci_id@p ;
...
position p;
@@
 struct bts_action_delay * cocci_id@p ;
...
typedef bdaddr_t;
@@
 struct ll_device {  struct hci_uart hu ;  struct serdev_device * serdev ;  struct gpio_desc * enable_gpio ;  struct clk * ext_clk ;  bdaddr_t bdaddr ; } cocci_id@p ;
...
position p;
@@
 enum hcill_states_e { HCILL_ASLEEP , HCILL_ASLEEP_TO_AWAKE , HCILL_AWAKE , HCILL_AWAKE_TO_ASLEEP , } cocci_id@p ;
