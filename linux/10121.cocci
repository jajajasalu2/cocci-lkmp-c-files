...
position p;
@@
 int cocci_id@p ( struct bonding * bond , const struct bond_opt_value * newval ) ;
...
position p;
@@
 const struct bond_option cocci_id@p [ BOND_OPT_LAST ] ;
...
position p;
@@
 const struct bond_option * cocci_id@p ;
...
typedef __be32;
@@
 int cocci_id@p ( struct bonding * bond , __be32 target ) ;
