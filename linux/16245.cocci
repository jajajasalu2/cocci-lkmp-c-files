...
position p;
@@
 unsigned char cocci_id@p [ ARRAY_SIZE ( code_tab_102us ) + ARRAY_SIZE ( extcode_tab_us102 ) ] ;
...
typedef bool;
@@
 struct nvec_keys {  struct input_dev * input ;  struct notifier_block notifier ;  struct nvec_chip * nvec ;  bool caps_lock ; } cocci_id@p ;
...
position p;
@@
 enum kbd_subcmds { CNFG_WAKE = 3 , CNFG_WAKE_KEY_REPORTING , SET_LEDS = 0xed , ENABLE_KBD = 0xf4 , DISABLE_KBD , } cocci_id@p ;
