...
position p;
@@
 enum mdp5_pipe cocci_id@p [ ] [ MAX_PIPE_STAGE ] ;
...
@@
 struct mdp5_ctl {  struct mdp5_ctl_manager * ctlm ;  u32 id ;  u32 status ;  bool encoder_enabled ;  u32 flush_mask ;  spinlock_t hw_lock ;  u32 reg_offset ;  u32 pending_ctl_trigger ;  bool cursor_on ;  bool flush_pending ;  struct mdp5_ctl * pair ; } cocci_id@p ;
...
position p;
@@
 struct mdp5_cfg_handler * cocci_id@p ;
...
position p;
@@
 const struct mdp5_ctl_block * cocci_id@p ;
...
typedef bool,u32,spinlock_t;
@@
 struct mdp5_ctl_manager {  struct drm_device * dev ;  u32 nlm ;  u32 nctl ;  u32 flush_hw_mask ;  bool single_flush_supported ;  u32 single_flush_pending_mask ;  spinlock_t pool_lock ;  struct mdp5_ctl ctls [ MAX_CTL ] ; } cocci_id@p ;
