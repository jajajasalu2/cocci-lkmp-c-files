...
position p;
@@
 struct qib_ctxt_info cocci_id@p ;
...
position p;
@@
 struct qib_filedata cocci_id@p ;
...
position p;
@@
 const struct qib_tid_info * cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct kiocb * , struct iov_iter * ) ;
...
position p;
@@
 const struct qib_user_info * cocci_id@p ;
