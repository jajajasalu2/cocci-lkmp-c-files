...
position p;
@@
 struct cs35l32_platform_data * cocci_id@p ;
...
position p;
@@
 struct cs35l32_private {  struct regmap * regmap ;  struct snd_soc_component * component ;  struct regulator_bulk_data supplies [ CS35L32_NUM_SUPPLIES ] ;  struct cs35l32_platform_data pdata ;  struct gpio_desc * reset_gpio ; } cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ CS35L32_NUM_SUPPLIES ] ;
...
position p;
@@
 struct cs35l32_private * cocci_id@p ;
