...
position p;
@@
 const struct mem_info * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rtc_pll_info * ) ;
...
position p;
@@
 struct m68k_mem_info cocci_id@p ;
...
position p;
@@
 const struct nvram_ops cocci_id@p ;
...
position p;
@@
 struct m68k_mem_info cocci_id@p [ NUM_MEMINFO ] ;
...
position p;
@@
 int cocci_id@p ( const struct bi_record * ) ;
