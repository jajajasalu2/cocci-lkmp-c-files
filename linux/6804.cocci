...
position p;
@@
 struct rdac_mode_common * cocci_id@p ;
...
typedef u8;
@@
 struct c9_inquiry {  u8 peripheral_info ;  u8 page_code ;  u8 reserved1 ;  u8 page_len ;  u8 page_id [ 4 ] ;  u8 avte_cvp ;  u8 path_prio ;  u8 reserved2 [ 38 ] ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct rdac_mode_10_hdr {  u16 data_len ;  u8 medium_type ;  u8 device_params ;  u16 reserved ;  u16 block_desc_len ; } cocci_id@p ;
...
typedef u8;
@@
 struct rdac_pg_expanded {  struct rdac_mode_10_hdr hdr ;  u8 page_code ;  u8 subpage_code ;  u8 page_len [ 2 ] ;  struct rdac_mode_common common ;  u8 lun_table [ 256 ] ;  u8 reserved3 ;  u8 reserved4 ; } cocci_id@p ;
...
typedef u8;
@@
 struct c8_inquiry {  u8 peripheral_info ;  u8 page_code ;  u8 reserved1 ;  u8 page_len ;  u8 page_id [ 4 ] ;  u8 reserved2 [ 3 ] ;  u8 vol_uniq_id_len ;  u8 vol_uniq_id [ 16 ] ;  u8 vol_user_label_len ;  u8 vol_user_label [ 60 ] ;  u8 array_uniq_id_len ;  u8 array_unique_id [ UNIQUE_ID_LEN ] ;  u8 array_user_label_len ;  u8 array_user_label [ 60 ] ;  u8 lun [ 8 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct rdac_mode_common {  u8 controller_serial [ 16 ] ;  u8 alt_controller_serial [ 16 ] ;  u8 rdac_mode [ 2 ] ;  u8 alt_rdac_mode [ 2 ] ;  u8 quiescence_timeout ;  u8 rdac_options ; } cocci_id@p ;
...
position p;
@@
 struct rdac_dh_data * cocci_id@p ;
...
position p;
@@
 struct rdac_controller cocci_id@p ;
...
position p;
@@
 struct rdac_queue_data {  struct list_head entry ;  struct rdac_dh_data * h ;  activate_complete callback_fn ;  void * callback_data ; } cocci_id@p ;
...
typedef u8;
@@
 struct c2_inquiry {  u8 peripheral_info ;  u8 page_code ;  u8 reserved1 ;  u8 page_len ;  u8 page_id [ 4 ] ;  u8 sw_version [ 3 ] ;  u8 sw_date [ 3 ] ;  u8 features_enabled ;  u8 max_lun_supported ;  u8 partitions [ 239 ] ; } cocci_id@p ;
...
position p;
@@
 struct rdac_pg_legacy cocci_id@p ;
...
position p;
@@
 struct rdac_pg_expanded * cocci_id@p ;
...
@@
 struct rdac_controller {  u8 array_id [ UNIQUE_ID_LEN ] ;  int use_ms10 ;  struct kref kref ;  struct list_head node ;  union {  struct rdac_pg_legacy legacy ;  struct rdac_pg_expanded expanded ; } mode_select ;  u8 index ;  u8 array_name [ ARRAY_LABEL_LEN ] ;  struct Scsi_Host * host ;  spinlock_t ms_lock ;  int ms_queued ;  struct work_struct ms_work ;  struct scsi_device * ms_sdev ;  struct list_head ms_head ;  struct list_head dh_list ; } cocci_id@p ;
...
typedef u8;
@@
 struct rdac_mode_6_hdr {  u8 data_len ;  u8 medium_type ;  u8 device_params ;  u8 block_desc_len ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ARRAY_LABEL_LEN ] ;
...
typedef u8;
@@
 struct c4_inquiry {  u8 peripheral_info ;  u8 page_code ;  u8 reserved1 ;  u8 page_len ;  u8 page_id [ 4 ] ;  u8 subsys_id [ SUBSYS_ID_LEN ] ;  u8 revision [ 4 ] ;  u8 slot_id [ SLOT_ID_LEN ] ;  u8 reserved [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct scsi_device_handler cocci_id@p ;
...
position p;
@@
 struct rdac_queue_data * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_COMMAND_SIZE ] ;
