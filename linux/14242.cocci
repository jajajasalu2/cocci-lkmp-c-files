...
@@
 struct delta_ipc_open_msg {  struct delta_ipc_header_msg header ;  u32 ipc_buf_size ;  dma_addr_t ipc_buf_paddr ;  char name [ 32 ] ;  u32 param_size ;  dma_addr_t param_paddr ; } cocci_id@p ;
...
position p;
@@
 struct rpmsg_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct delta_ipc_set_stream_msg cocci_id@p ;
...
position p;
@@
 struct delta_ipc_ctx * cocci_id@p ;
...
position p;
@@
 struct delta_ipc_close_msg {  struct delta_ipc_header_msg header ; } cocci_id@p ;
...
position p;
@@
 struct delta_ipc_decode_msg cocci_id@p ;
...
position p;
@@
 struct delta_ipc_cb_msg {  struct delta_ipc_header_msg header ;  int err ; } cocci_id@p ;
...
typedef u32,dma_addr_t;
@@
 struct delta_ipc_decode_msg {  struct delta_ipc_header_msg header ;  u32 param_size ;  dma_addr_t param_paddr ;  u32 status_size ;  dma_addr_t status_paddr ; } cocci_id@p ;
...
position p;
@@
 struct delta_ipc_cb_msg * cocci_id@p ;
...
position p;
@@
 enum delta_ipc_fw_command { DELTA_IPC_OPEN , DELTA_IPC_SET_STREAM , DELTA_IPC_DECODE , DELTA_IPC_CLOSE , } cocci_id@p ;
...
typedef u32;
@@
 struct delta_ipc_header_msg {  u32 tag ;  void * host_hdl ;  u32 copro_hdl ;  u32 command ; } cocci_id@p ;
...
position p;
@@
 struct delta_ipc_header_msg * cocci_id@p ;
...
position p;
@@
 struct delta_ipc_open_msg cocci_id@p ;
...
position p;
@@
 struct delta_ipc_close_msg cocci_id@p ;
...
position p;
@@
 struct delta_ipc_param * cocci_id@p ;
...
position p;
@@
 enum delta_ipc_fw_command cocci_id@p ;
...
typedef u32,dma_addr_t;
@@
 struct delta_ipc_set_stream_msg {  struct delta_ipc_header_msg header ;  u32 param_size ;  dma_addr_t param_paddr ; } cocci_id@p ;
