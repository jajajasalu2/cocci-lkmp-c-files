...
position p;
@@
 struct ncsi_cmd_rc_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_handler * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_arg * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_oem_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_handler {  unsigned char type ;  int payload ;  int ( * handler ) ( struct sk_buff * skb , struct ncsi_cmd_arg * nca ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ncsi_cmd_sp_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_dc_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_pkt_hdr cocci_id@p ;
