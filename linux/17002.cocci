...
typedef u8;
@@
 u8 cocci_id@p [ ILI210X_DATA_SIZE ] ;
...
typedef bool;
@@
 struct ili210x {  struct i2c_client * client ;  struct input_dev * input ;  struct gpio_desc * reset_gpio ;  struct touchscreen_properties prop ;  const struct ili2xxx_chip * chip ;  bool stop ; } cocci_id@p ;
...
position p;
@@
 const struct ili2xxx_chip cocci_id@p ;
