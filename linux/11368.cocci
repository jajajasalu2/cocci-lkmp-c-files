...
position p;
@@
 struct ti_sn_bridge cocci_id@p ;
...
position p;
@@
 struct ti_sn_bridge {  struct device * dev ;  struct regmap * regmap ;  struct drm_dp_aux aux ;  struct drm_bridge bridge ;  struct drm_connector connector ;  struct dentry * debugfs ;  struct device_node * host_node ;  struct mipi_dsi_device * dsi ;  struct clk * refclk ;  struct drm_panel * panel ;  struct gpio_desc * enable_gpio ;  struct regulator_bulk_data supplies [ SN_REGULATOR_SUPPLY_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct i2c_device_id cocci_id@p [ ] ;
...
position p;
@@
 const struct mipi_dsi_device_info cocci_id@p ;
