...
position p;
@@
 struct opa_vnic_grp_stats * cocci_id@p ;
...
position p;
@@
 struct opa_vnic_rdma_netdev cocci_id@p ;
...
position p;
@@
 struct opa_vnic_stats * cocci_id@p ;
...
position p;
@@
 struct hfi1_vnic_rx_queue * cocci_id@p ;
...
position p;
@@
 struct opa_vnic_skb_mdata * cocci_id@p ;
