...
position p;
@@
 struct mrq_i2c_request cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_i2c {  struct i2c_adapter adapter ;  struct device * dev ;  struct tegra_bpmp * bpmp ;  unsigned int bus ; } cocci_id@p ;
...
position p;
@@
 struct mrq_i2c_response * cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_i2c * cocci_id@p ;
