...
position p;
@@
 struct f75375s_platform_data * cocci_id@p ;
...
position p;
@@
 enum chips { f75373 , f75375 , f75387 , } cocci_id@p ;
...
@@
 struct f75375_data {  unsigned short addr ;  struct device * hwmon_dev ;  const char * name ;  int kind ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  unsigned long last_limits ;  u8 in [ 4 ] ;  u8 in_max [ 4 ] ;  u8 in_min [ 4 ] ;  u16 fan [ 2 ] ;  u16 fan_min [ 2 ] ;  u16 fan_max [ 2 ] ;  u16 fan_target [ 2 ] ;  u8 fan_timer ;  u8 pwm [ 2 ] ;  u8 pwm_mode [ 2 ] ;  u8 pwm_enable [ 2 ] ;  s16 temp11 [ 2 ] ;  s8 temp_high [ 2 ] ;  s8 temp_max_hyst [ 2 ] ; } cocci_id@p ;
