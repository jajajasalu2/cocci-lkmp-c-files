...
position p;
@@
 struct msr_hwp_request * cocci_id@p ;
...
position p;
@@
 struct msr_hwp_request {  unsigned char hwp_min ;  unsigned char hwp_max ;  unsigned char hwp_desired ;  unsigned char hwp_epp ;  unsigned int hwp_window ;  unsigned char hwp_use_pkg ; } cocci_id@p ;
...
position p;
@@
 struct msr_hwp_cap {  unsigned char highest ;  unsigned char guaranteed ;  unsigned char efficient ;  unsigned char lowest ; } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_PACKAGES ] ;
