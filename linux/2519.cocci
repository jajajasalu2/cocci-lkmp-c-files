...
position p;
@@
 struct r5l_meta_block cocci_id@p ;
...
position p;
@@
 struct r5l_payload_flush * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,sector_t,atomic_t;
@@
 struct r5l_io_unit {  struct r5l_log * log ;  struct page * meta_page ;  int meta_offset ;  struct bio * current_bio ;  atomic_t pending_stripe ;  u64 seq ;  sector_t log_start ;  sector_t log_end ;  struct list_head log_sibling ;  struct list_head stripe_list ;  int state ;  bool need_split_bio ;  struct bio * split_bio ;  unsigned int has_flush : 1 ;  unsigned int has_fua : 1 ;  unsigned int has_null_flush : 1 ;  unsigned int has_flush_payload : 1 ;  unsigned int io_deferred : 1 ;  struct bio_list flush_barriers ; } cocci_id@p ;
...
position p;
@@
 struct md_sysfs_entry cocci_id@p ;
...
@@
 struct r5l_recovery_ctx {  struct page * meta_page ;  sector_t meta_total_blocks ;  sector_t pos ;  u64 seq ;  int data_parity_stripes ;  int data_only_stripes ;  struct list_head cached_list ;  struct page * ra_pool [ R5L_RECOVERY_PAGE_POOL_SIZE ] ;  sector_t pool_offset ;  int total_pages ;  int valid_pages ;  struct bio * ra_bio ; } cocci_id@p ;
...
position p;
@@
 enum r5l_io_unit_state { IO_UNIT_RUNNING = 0 , IO_UNIT_IO_START = 1 , IO_UNIT_IO_END = 2 , IO_UNIT_STRIPE_END = 3 , } cocci_id@p ;
...
position p;
@@
 struct r5l_payload_data_parity * cocci_id@p ;
...
position p;
@@
 enum r5l_io_unit_state cocci_id@p ;
...
position p;
@@
 struct stripe_head_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct r5l_io_unit * io ) ;
...
position p;
@@
 struct r5l_recovery_ctx * cocci_id@p ;
