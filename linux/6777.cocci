...
position p;
@@
 struct esp_event_ent * cocci_id@p ;
...
position p;
@@
 struct esp_cmd_priv * cocci_id@p ;
...
position p;
@@
 struct esp_cmd_entry * cocci_id@p ;
...
position p;
@@
 struct esp_lun_data * cocci_id@p ;
...
position p;
@@
 struct esp_target_data * cocci_id@p ;
