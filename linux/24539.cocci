...
position p;
@@
 struct sctp_stream_in * cocci_id@p ;
...
position p;
@@
 struct sctp_stream_interleave cocci_id@p ;
...
position p;
@@
 struct sctp_idatahdr cocci_id@p ;
...
position p;
@@
 struct sctp_fwdtsn_chunk cocci_id@p ;
...
position p;
@@
 struct sctp_ifwdtsn_chunk cocci_id@p ;
...
position p;
@@
 struct sctp_ifwdtsn_skip cocci_id@p [ 10 ] ;
...
position p;
@@
 struct sctp_idata_chunk cocci_id@p ;
