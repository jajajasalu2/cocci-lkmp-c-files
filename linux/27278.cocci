...
position p;
@@
 typeof ( struct svc_xprt ) cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct net * , const struct svc_program * , u32 , int , unsigned short , unsigned short ) ;
