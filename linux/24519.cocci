...
typedef u16;
@@
 enum sctp_xmit cocci_id@p ( struct sctp_packet * packet , struct sctp_chunk * chunk , u16 chunk_len ) ;
...
position p;
@@
 enum sctp_xmit cocci_id@p ( struct sctp_packet * packet , struct sctp_chunk * chunk ) ;
...
position p;
@@
 void cocci_id@p ( struct sctp_packet * packet , struct sctp_chunk * chunk ) ;
