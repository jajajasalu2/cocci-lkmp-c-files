...
position p;
@@
 struct mthca_raddr_seg cocci_id@p ;
...
position p;
@@
 enum { MTHCA_SEND_DOORBELL_FENCE = 1 << 5 , } cocci_id@p ;
...
position p;
@@
 enum { MTHCA_QP_OPTPAR_ALT_ADDR_PATH = 1 << 0 , MTHCA_QP_OPTPAR_RRE = 1 << 1 , MTHCA_QP_OPTPAR_RAE = 1 << 2 , MTHCA_QP_OPTPAR_RWE = 1 << 3 , MTHCA_QP_OPTPAR_PKEY_INDEX = 1 << 4 , MTHCA_QP_OPTPAR_Q_KEY = 1 << 5 , MTHCA_QP_OPTPAR_RNR_TIMEOUT = 1 << 6 , MTHCA_QP_OPTPAR_PRIMARY_ADDR_PATH = 1 << 7 , MTHCA_QP_OPTPAR_SRA_MAX = 1 << 8 , MTHCA_QP_OPTPAR_RRA_MAX = 1 << 9 , MTHCA_QP_OPTPAR_PM_STATE = 1 << 10 , MTHCA_QP_OPTPAR_PORT_NUM = 1 << 11 , MTHCA_QP_OPTPAR_RETRY_COUNT = 1 << 12 , MTHCA_QP_OPTPAR_ALT_RNR_RETRY = 1 << 13 , MTHCA_QP_OPTPAR_ACK_TIMEOUT = 1 << 14 , MTHCA_QP_OPTPAR_RNR_RETRY = 1 << 15 , MTHCA_QP_OPTPAR_SCHED_QUEUE = 1 << 16 , } cocci_id@p ;
...
position p;
@@
 enum { MTHCA_QP_BIT_DE = 1 << 8 , MTHCA_QP_BIT_SRE = 1 << 15 , MTHCA_QP_BIT_SWE = 1 << 14 , MTHCA_QP_BIT_SAE = 1 << 13 , MTHCA_QP_BIT_SIC = 1 << 4 , MTHCA_QP_BIT_SSC = 1 << 3 , MTHCA_QP_BIT_RRE = 1 << 15 , MTHCA_QP_BIT_RWE = 1 << 14 , MTHCA_QP_BIT_RAE = 1 << 13 , MTHCA_QP_BIT_RIC = 1 << 4 , MTHCA_QP_BIT_RSC = 1 << 3 , } cocci_id@p ;
...
position p;
@@
 enum { MTHCA_QP_PM_MIGRATED = 0x3 , MTHCA_QP_PM_ARMED = 0x0 , MTHCA_QP_PM_REARM = 0x1 , } cocci_id@p ;
...
position p;
@@
 enum { MTHCA_QP_STATE_RST = 0 , MTHCA_QP_STATE_INIT = 1 , MTHCA_QP_STATE_RTR = 2 , MTHCA_QP_STATE_RTS = 3 , MTHCA_QP_STATE_SQE = 4 , MTHCA_QP_STATE_SQD = 5 , MTHCA_QP_STATE_ERR = 6 , MTHCA_QP_STATE_DRAINING = 7 , } cocci_id@p ;
...
position p;
@@
 enum { MTHCA_QP_ST_RC = 0x0 , MTHCA_QP_ST_UC = 0x1 , MTHCA_QP_ST_RD = 0x2 , MTHCA_QP_ST_UD = 0x3 , MTHCA_QP_ST_MLX = 0x7 , } cocci_id@p ;
...
position p;
@@
 struct mthca_next_seg cocci_id@p ;
...
position p;
@@
 struct mthca_arbel_ud_seg * cocci_id@p ;
...
position p;
@@
 enum { RC , UC , UD , RD , RDEE , MLX , NUM_TRANS , } cocci_id@p ;
...
position p;
@@
 struct mthca_qp_path * cocci_id@p ;
...
position p;
@@
 struct mthca_ucontext cocci_id@p ;
...
position p;
@@
 struct mthca_init_ib_param cocci_id@p ;
...
position p;
@@
 enum { MTHCA_MAX_DIRECT_QP_SIZE = 4 * PAGE_SIZE , MTHCA_ACK_REQ_FREQ = 10 , MTHCA_FLIGHT_LIMIT = 9 , MTHCA_UD_HEADER_SIZE = 72 , MTHCA_INLINE_HEADER_SIZE = 4 , MTHCA_INLINE_CHUNK_SIZE = 16 , } cocci_id@p ;
...
position p;
@@
 struct mthca_mlx_seg * cocci_id@p ;
...
position p;
@@
 struct mthca_atomic_seg cocci_id@p ;
...
position p;
@@
 struct mthca_data_seg * cocci_id@p ;
...
position p;
@@
 struct mthca_qp_param * cocci_id@p ;
...
position p;
@@
 struct mthca_qp_context * cocci_id@p ;
...
position p;
@@
 struct mthca_tavor_ud_seg cocci_id@p ;
...
position p;
@@
 struct mthca_mailbox * cocci_id@p ;
...
position p;
@@
 struct mthca_bind_seg cocci_id@p ;
