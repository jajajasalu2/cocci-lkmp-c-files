...
position p;
@@
 struct nvme_hwmon_data * cocci_id@p ;
...
position p;
@@
 struct nvme_hwmon_data {  struct nvme_ctrl * ctrl ;  struct nvme_smart_log log ;  struct mutex read_lock ; } cocci_id@p ;
...
position p;
@@
 const struct nvme_hwmon_data * cocci_id@p ;
