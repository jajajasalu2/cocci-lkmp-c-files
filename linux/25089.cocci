...
position p;
@@
 enum mpath_frame_type { MPATH_PREQ = 0 , MPATH_PREP , MPATH_PERR , MPATH_RANN , } cocci_id@p ;
...
position p;
@@
 enum mpath_frame_type cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct mesh_path * , u8 ) ;
...
position p;
@@
 const struct ieee80211_rann_ie * cocci_id@p ;
...
position p;
@@
 struct mesh_preq_queue cocci_id@p ;
