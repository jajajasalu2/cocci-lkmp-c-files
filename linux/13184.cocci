...
position p;
@@
 struct ivtv_osd_coords {  unsigned long offset ;  unsigned long max_offset ;  int pixel_stride ;  int lines ;  int x ;  int y ; } cocci_id@p ;
...
position p;
@@
 const struct ivtv_osd_coords * cocci_id@p ;
...
position p;
@@
 struct ivtvfb_dma_frame cocci_id@p ;
...
typedef u32;
@@
 struct osd_info {  unsigned long video_pbase ;  u32 video_rbase ;  volatile char __iomem * video_vbase ;  u32 video_buffer_size ;  unsigned long fb_start_aligned_physaddr ;  unsigned long fb_end_aligned_physaddr ;  int wc_cookie ;  int set_osd_coords_x ;  int set_osd_coords_y ;  int display_width ;  int display_height ;  int display_byte_stride ;  int bits_per_pixel ;  int bytes_per_pixel ;  struct fb_info ivtvfb_info ;  struct fb_var_screeninfo ivtvfb_defined ;  struct fb_fix_screeninfo ivtvfb_fix ;  struct fb_var_screeninfo fbvar_cur ;  int blank_cur ;  u32 palette_cur [ 256 ] ;  u32 pan_cur ; } cocci_id@p ;
...
position p;
@@
 struct ivtv_osd_coords * cocci_id@p ;
