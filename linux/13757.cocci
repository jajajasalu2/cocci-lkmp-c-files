...
position p;
@@
 struct ov772x_win_size {  char * name ;  unsigned char com7_bit ;  unsigned int sizeimage ;  struct v4l2_rect rect ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct ov772x_color_format {  u32 code ;  enum v4l2_colorspace colorspace ;  u8 dsp3 ;  u8 dsp4 ;  u8 com3 ;  u8 com7 ; } cocci_id@p ;
...
position p;
@@
 const struct ov772x_win_size * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ov772x_priv * priv , const struct ov772x_color_format * cfmt , const struct ov772x_win_size * win ) ;
...
position p;
@@
 const struct ov772x_color_format cocci_id@p [ ] ;
...
typedef u8;
@@
 struct {  unsigned int mult ;  u8 com4 ; } cocci_id@p [ ] ;
