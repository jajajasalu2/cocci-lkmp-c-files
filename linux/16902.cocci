...
typedef u8,bool;
@@
 struct trackpoint_attr_data {  size_t field_offset ;  u8 command ;  u8 mask ;  bool inverted ;  u8 power_on_default ; } cocci_id@p ;
...
position p;
@@
 struct trackpoint_data * cocci_id@p ;
...
position p;
@@
 struct trackpoint_attr_data * cocci_id@p ;
