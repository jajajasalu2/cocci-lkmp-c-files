...
position p;
@@
 enum rk_spdif_type { RK_SPDIF_RK3066 , RK_SPDIF_RK3188 , RK_SPDIF_RK3288 , RK_SPDIF_RK3366 , } cocci_id@p ;
...
position p;
@@
 struct rk_spdif_dev {  struct device * dev ;  struct clk * mclk ;  struct clk * hclk ;  struct snd_dmaengine_dai_dma_data playback_dma_data ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct rk_spdif_dev * cocci_id@p ;
