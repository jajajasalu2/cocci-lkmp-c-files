...
position p;
@@
 enum rmi_f54_report_type cocci_id@p ;
...
@@
 struct f54_data {  struct rmi_function * fn ;  u8 num_rx_electrodes ;  u8 num_tx_electrodes ;  u8 capabilities ;  u16 clock_rate ;  u8 family ;  enum rmi_f54_report_type report_type ;  u8 * report_data ;  int report_size ;  bool is_busy ;  struct mutex status_mutex ;  struct mutex data_mutex ;  struct workqueue_struct * workqueue ;  struct delayed_work work ;  unsigned long timeout ;  struct completion cmd_done ;  struct v4l2_device v4l2 ;  struct v4l2_pix_format format ;  struct video_device vdev ;  struct vb2_queue queue ;  struct mutex lock ;  u32 sequence ;  int input ;  enum rmi_f54_report_type inputs [ F54_MAX_REPORT_TYPE ] ; } cocci_id@p ;
...
position p;
@@
 enum rmi_f54_report_type { F54_REPORT_NONE = 0 , F54_8BIT_IMAGE = 1 , F54_16BIT_IMAGE = 2 , F54_RAW_16BIT_IMAGE = 3 , F54_TRUE_BASELINE = 9 , F54_FULL_RAW_CAP = 19 , F54_FULL_RAW_CAP_RX_OFFSET_REMOVED = 20 , F54_MAX_REPORT_TYPE , } cocci_id@p ;
