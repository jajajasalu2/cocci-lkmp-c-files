...
position p;
@@
 struct clusterip_net * cocci_id@p ;
...
position p;
@@
 const struct xt_tgchk_param * cocci_id@p ;
...
position p;
@@
 struct clusterip_seq_position * cocci_id@p ;
...
position p;
@@
 struct ipt_clusterip_tgt_info cocci_id@p ;
...
position p;
@@
 const struct clusterip_config * cocci_id@p ;
...
position p;
@@
 const struct ipt_clusterip_tgt_info * cocci_id@p ;
...
position p;
@@
 struct clusterip_seq_position {  unsigned int pos ;  unsigned int weight ;  unsigned int bit ;  unsigned long val ; } cocci_id@p ;
...
position p;
@@
 struct clusterip_config * cocci_id@p ;
...
position p;
@@
 struct compat_ipt_clusterip_tgt_info cocci_id@p ;
...
position p;
@@
 const struct xt_tgdtor_param * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_int8_t,compat_uptr_t,u_int16_t,u_int32_t;
@@
 struct compat_ipt_clusterip_tgt_info {  u_int32_t flags ;  u_int8_t clustermac [ 6 ] ;  u_int16_t num_total_nodes ;  u_int16_t num_local_nodes ;  u_int16_t local_nodes [ CLUSTERIP_MAX_NODES ] ;  u_int32_t hash_mode ;  u_int32_t hash_initval ;  compat_uptr_t config ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PROC_WRITELEN + 1 ] ;
