...
position p;
@@
 struct sa1100_port_fns cocci_id@p ;
...
position p;
@@
 struct sa1100fb_mach_info cocci_id@p ;
...
position p;
@@
 struct ucb1x00_plat_data cocci_id@p ;
...
position p;
@@
 struct mcp_plat_data cocci_id@p ;
...
position p;
@@
 struct irda_platform_data cocci_id@p ;
