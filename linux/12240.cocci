...
@@
 void cocci_id@p ( drm_via_private_t * dev_priv ) ;
...
typedef drm_via_private_t;
@@
 int cocci_id@p ( drm_via_private_t * dev_priv ) ;
...
typedef drm_via_private_t;
@@
 void cocci_id@p ( drm_via_private_t * dev_priv , int qwords ) ;
...
symbol cocci_id;
position p;
typedef drm_via_cmdbuf_size_t;
@@
 drm_via_cmdbuf_size_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_cmdbuffer_t;
@@
 drm_via_cmdbuffer_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_dma_init_t;
@@
 drm_via_dma_init_t * cocci_id@p ;
