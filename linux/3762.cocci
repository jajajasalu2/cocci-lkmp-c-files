...
position p;
@@
 const struct ccp_aes_xts_def cocci_id@p [ ] ;
...
position p;
@@
 struct ccp_aes_xts_def {  const char * name ;  const char * drv_name ; } cocci_id@p ;
...
position p;
@@
 struct ccp_unit_size_map cocci_id@p [ ] ;
...
typedef u32;
@@
 struct ccp_unit_size_map {  unsigned int size ;  u32 value ; } cocci_id@p ;
