...
position p;
@@
 struct iio_hwmon_state * cocci_id@p ;
...
position p;
@@
 struct iio_hwmon_state {  struct iio_channel * channels ;  int num_channels ;  struct attribute_group attr_group ;  const struct attribute_group * groups [ 2 ] ;  struct attribute * * attrs ; } cocci_id@p ;
