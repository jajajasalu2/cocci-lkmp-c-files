...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( union acpi_object * user_obj , union acpi_operand_object * * return_obj ) ;
...
symbol cocci_id;
position p;
typedef acpi_status,u8;
@@
 acpi_status cocci_id@p ( union acpi_operand_object * internal_object , u8 * buffer , acpi_size * space_used ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( union acpi_operand_object * source_desc , union acpi_operand_object * dest_desc ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( union acpi_operand_object * source_obj , union acpi_operand_object * dest_obj , struct acpi_walk_state * walk_state ) ;
...
position p;
@@
 struct acpi_pkg_info cocci_id@p ;
...
typedef acpi_status,u8;
@@
 acpi_status cocci_id@p ( u8 object_type , union acpi_operand_object * source_object , union acpi_generic_state * state , void * context ) ;
...
typedef acpi_status,u8;
@@
 acpi_status cocci_id@p ( union acpi_operand_object * internal_object , union acpi_object * external_object , u8 * data_space , acpi_size * buffer_space_used ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( union acpi_object * external_object , union acpi_operand_object * * internal_object ) ;
