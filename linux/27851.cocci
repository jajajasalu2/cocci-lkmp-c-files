...
position p;
@@
 int cocci_id@p ( struct cachefiles_cache * , char * ) ;
...
position p;
@@
 struct cachefiles_daemon_cmd {  char name [ 8 ] ;  int ( * handler ) ( struct cachefiles_cache * cache , char * args ) ; } cocci_id@p ;
...
position p;
@@
 const struct cachefiles_daemon_cmd * cocci_id@p ;
