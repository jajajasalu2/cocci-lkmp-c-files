...
@@
 struct ismt_priv {  struct i2c_adapter adapter ;  void __iomem * smba ;  struct pci_dev * pci_dev ;  struct ismt_desc * hw ;  dma_addr_t io_rng_dma ;  u8 head ;  struct completion cmp ;  u8 buffer [ I2C_SMBUS_BLOCK_MAX + 16 ] ; } cocci_id@p ;
...
position p;
@@
 const struct ismt_desc * cocci_id@p ;
