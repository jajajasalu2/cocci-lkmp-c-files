...
typedef u8;
@@
 const struct nvkm_i2c_drv {  u8 bios ;  u8 addr ;  int ( * pad_new ) ( struct nvkm_i2c_bus * , int id , u8 addr , struct nvkm_i2c_pad * * ) ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct nvkm_i2c_drv * cocci_id@p ;
...
position p;
@@
 struct dcb_i2c_entry cocci_id@p ;
...
position p;
@@
 const struct nvkm_i2c_func * cocci_id@p ;
...
position p;
@@
 struct nvkm_i2c_pad * cocci_id@p ;
