...
position p;
@@
 struct f_gether_opts * cocci_id@p ;
...
position p;
@@
 struct gfs_configuration cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct usb_composite_dev * cdev ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_configuration * c ) ;
...
position p;
@@
 struct gfs_configuration {  struct usb_configuration c ;  int ( * eth ) ( struct usb_configuration * c ) ;  int num ; } cocci_id@p ;
