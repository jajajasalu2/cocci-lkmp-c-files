...
position p;
@@
 struct xfs_mru_cache cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_mru_cache_free_func_t;
@@
 xfs_mru_cache_free_func_t cocci_id@p ;
