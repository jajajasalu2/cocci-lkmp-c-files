...
position p;
@@
 void cocci_id@p ( nsp32_hw_data * , int , int ) ;
...
position p;
@@
 void cocci_id@p ( const char * , int , char * , char * , ... ) ;
...
position p;
@@
 void cocci_id@p ( const char * , int , int , char * , ... ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * , unsigned char , unsigned char ) ;
...
position p;
@@
 int cocci_id@p ( nsp32_hw_data * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * , unsigned int ) ;
...
position p;
@@
 void cocci_id@p ( nsp32_hw_data * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * , unsigned long , unsigned short ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * , unsigned int ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * , unsigned short ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * , unsigned short ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * , unsigned char ) ;
...
position p;
@@
 char cocci_id@p [ NSP32_DEBUG_BUF_LEN ] ;
