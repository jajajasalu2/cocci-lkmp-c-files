...
position p;
@@
 struct bfad_debug_info cocci_id@p ;
...
typedef umode_t;
@@
 struct bfad_debugfs_entry {  const char * name ;  umode_t mode ;  const struct file_operations * fops ; } cocci_id@p ;
...
position p;
@@
 struct bfad_debug_info {  char * debug_buffer ;  void * i_private ;  int buffer_len ; } cocci_id@p ;
...
position p;
@@
 const struct bfad_debugfs_entry cocci_id@p [ ] ;
