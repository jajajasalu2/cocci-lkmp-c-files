...
position p;
@@
 struct nv40_instmem cocci_id@p ;
...
position p;
@@
 struct nv40_instobj * cocci_id@p ;
...
position p;
@@
 struct nv40_instmem {  struct nvkm_instmem base ;  struct nvkm_mm heap ;  void __iomem * iomem ; } cocci_id@p ;
...
position p;
@@
 struct nv40_instobj {  struct nvkm_instobj base ;  struct nv40_instmem * imem ;  struct nvkm_mm_node * node ; } cocci_id@p ;
