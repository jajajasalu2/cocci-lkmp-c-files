...
position p;
@@
 struct imx_pcm_fiq_params * cocci_id@p ;
...
position p;
@@
 struct imx_pcm_runtime_data cocci_id@p ;
...
typedef atomic_t;
@@
 struct imx_pcm_runtime_data {  unsigned int period ;  int periods ;  unsigned long offset ;  struct hrtimer hrt ;  int poll_time_ns ;  struct snd_pcm_substream * substream ;  atomic_t playing ;  atomic_t capturing ; } cocci_id@p ;
