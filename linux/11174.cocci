...
typedef bool;
@@
 struct protection_properties {  bool supported ;  bool ( * process_transaction ) ( struct dc_link * link , struct hdcp_protection_message * message_info ) ; } cocci_id@p ;
...
position p;
@@
 struct hdcp_protection_message * cocci_id@p ;
...
position p;
@@
 const struct protection_properties cocci_id@p ;
