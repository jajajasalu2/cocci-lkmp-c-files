...
typedef bool,u32;
@@
 struct f_sdhost_priv {  struct clk * clk_iface ;  struct clk * clk ;  u32 vendor_hs200 ;  struct device * dev ;  bool enable_cmd_dat_delay ; } cocci_id@p ;
...
position p;
@@
 struct f_sdhost_priv cocci_id@p ;
