...
typedef __u8;
@@
 void cocci_id@p ( struct tty_struct * tty , const __u8 * cp , char * fp , int count ) ;
...
position p;
@@
 struct n_hdlc_buf_list * cocci_id@p ;
...
position p;
@@
 struct n_hdlc_buf * cocci_id@p ( struct n_hdlc_buf_list * list ) ;
...
position p;
@@
 void cocci_id@p ( struct n_hdlc_buf_list * list , struct n_hdlc_buf * buf ) ;
...
position p;
@@
 struct n_hdlc_buf {  struct list_head list_item ;  int count ;  char buf [ 1 ] ; } cocci_id@p ;
...
typedef __u32;
@@
 struct n_hdlc {  int magic ;  __u32 flags ;  struct tty_struct * tty ;  struct tty_struct * backup_tty ;  int tbusy ;  int woke_up ;  struct n_hdlc_buf_list tx_buf_list ;  struct n_hdlc_buf_list rx_buf_list ;  struct n_hdlc_buf_list tx_free_buf_list ;  struct n_hdlc_buf_list rx_free_buf_list ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct n_hdlc_buf_list {  struct list_head list ;  int count ;  spinlock_t spinlock ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct n_hdlc_buf_list * buf_list , struct n_hdlc_buf * buf ) ;
