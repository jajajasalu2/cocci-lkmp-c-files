...
@@
 struct image_header_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef image_header_t,uint16_t,uint32_t;
@@
 struct image_header_t {  uint16_t magic ;  uint16_t version ;  uint32_t size ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef manage_flash_t;
@@
 struct manage_flash_t {  int status ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef validate_flash_t;
@@
 struct validate_flash_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef validate_flash_t,uint32_t;
@@
 struct validate_flash_t {  int status ;  void * buf ;  uint32_t buf_size ;  uint32_t result ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef image_data_t,uint32_t;
@@
 struct image_data_t {  int status ;  void * data ;  uint32_t size ; } cocci_id@p ;
...
typedef manage_flash_t;
@@
 struct manage_flash_t * const cocci_id@p ;
...
position p;
@@
 struct opal_sg_list * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef update_flash_t;
@@
 struct update_flash_t * const cocci_id@p ;
...
@@
 struct image_data_t cocci_id@p ;
...
typedef manage_flash_t;
@@
 struct manage_flash_t cocci_id@p ;
...
typedef update_flash_t;
@@
 struct update_flash_t {  int status ; } cocci_id@p ;
...
typedef update_flash_t;
@@
 struct update_flash_t cocci_id@p ;
...
position p;
@@
 enum { IMAGE_INVALID , IMAGE_LOADING , IMAGE_READY , } cocci_id@p ;
