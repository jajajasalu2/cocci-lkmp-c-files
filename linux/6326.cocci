...
position p;
@@
 struct asic3_clk {  int enabled ;  unsigned int cdex ;  unsigned long rate ; } cocci_id@p ;
...
position p;
@@
 enum { ASIC3_CLOCK_SPI , ASIC3_CLOCK_OWM , ASIC3_CLOCK_PWM0 , ASIC3_CLOCK_PWM1 , ASIC3_CLOCK_LED0 , ASIC3_CLOCK_LED1 , ASIC3_CLOCK_LED2 , ASIC3_CLOCK_SD_HOST , ASIC3_CLOCK_SD_BUS , ASIC3_CLOCK_SMBUS , ASIC3_CLOCK_EX0 , ASIC3_CLOCK_EX1 , } cocci_id@p ;
...
position p;
@@
 struct mfd_cell cocci_id@p [ ASIC3_NUM_LEDS ] ;
...
position p;
@@
 const int cocci_id@p [ ASIC3_NUM_LEDS ] ;
...
position p;
@@
 struct tmio_mmc_data cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ ASIC3_NUM_GPIO_BANKS ] ;
...
symbol cocci_id;
position p;
typedef u16,raw_spinlock_t;
@@
 struct asic3 {  void __iomem * mapping ;  unsigned int bus_shift ;  unsigned int irq_nr ;  unsigned int irq_base ;  raw_spinlock_t lock ;  u16 irq_bothedge [ 4 ] ;  struct gpio_chip gpio ;  struct device * dev ;  void __iomem * tmio_cnf ;  struct asic3_clk clocks [ ARRAY_SIZE ( asic3_clk_init ) ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gpio_chip * chip , unsigned offset ) ;
...
position p;
@@
 struct ds1wm_driver_data cocci_id@p ;
