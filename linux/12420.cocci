...
typedef bool;
@@
 int cocci_id@p ( struct panel_drv_data * ddata , bool enable ) ;
...
position p;
@@
 struct omap_dss_dsi_config cocci_id@p ;
...
position p;
@@
 struct panel_drv_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct panel_drv_data * ddata ) ;
...
@@
 struct panel_drv_data {  struct omap_dss_device dssdev ;  struct omap_dss_device * src ;  struct videomode vm ;  struct platform_device * pdev ;  struct mutex lock ;  struct backlight_device * bldev ;  struct backlight_device * extbldev ;  unsigned long hw_guard_end ;  unsigned long hw_guard_wait ;  struct gpio_desc * reset_gpio ;  struct gpio_desc * ext_te_gpio ;  struct regulator * vpnl ;  struct regulator * vddi ;  bool use_dsi_backlight ;  int width_mm ;  int height_mm ;  struct omap_dsi_pin_config pin_config ;  bool enabled ;  bool te_enabled ;  atomic_t do_update ;  int channel ;  struct delayed_work te_timeout_work ;  bool intro_printed ;  struct workqueue_struct * workqueue ;  bool ulps_enabled ;  unsigned int ulps_timeout ;  struct delayed_work ulps_work ; } cocci_id@p ;
