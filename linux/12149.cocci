...
position p;
@@
 const struct drm_encoder_slave_funcs cocci_id@p ;
...
position p;
@@
 struct nv17_tv_norm_params * cocci_id@p ;
...
position p;
@@
 const struct {  int hdisplay ;  int vdisplay ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nv17_tv_encoder * cocci_id@p ;
...
position p;
@@
 struct nv17_tv_state * cocci_id@p ;
