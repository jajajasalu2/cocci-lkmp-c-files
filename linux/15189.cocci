...
typedef u8;
@@
 struct cr0014114_led {  struct cr0014114 * priv ;  struct led_classdev ldev ;  u8 brightness ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct cr0014114 {  bool do_recount ;  size_t count ;  struct delayed_work work ;  struct device * dev ;  struct mutex lock ;  struct spi_device * spi ;  u8 * buf ;  unsigned long delay ;  struct cr0014114_led leds [ ] ; } cocci_id@p ;
...
position p;
@@
 struct cr0014114_led * cocci_id@p ;
