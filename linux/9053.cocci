...
position p;
@@
 enum mlx5_ptys_rate { MLX5_PTYS_RATE_SDR = 1 << 0 , MLX5_PTYS_RATE_DDR = 1 << 1 , MLX5_PTYS_RATE_QDR = 1 << 2 , MLX5_PTYS_RATE_FDR10 = 1 << 3 , MLX5_PTYS_RATE_FDR = 1 << 4 , MLX5_PTYS_RATE_EDR = 1 << 5 , MLX5_PTYS_RATE_HDR = 1 << 6 , } cocci_id@p ;
...
position p;
@@
 enum mlx5_ptys_width { MLX5_PTYS_WIDTH_1X = 1 << 0 , MLX5_PTYS_WIDTH_2X = 1 << 1 , MLX5_PTYS_WIDTH_4X = 1 << 2 , MLX5_PTYS_WIDTH_8X = 1 << 3 , MLX5_PTYS_WIDTH_12X = 1 << 4 , } cocci_id@p ;
...
position p;
@@
 enum mlx5_ptys_width cocci_id@p ;
...
position p;
@@
 enum mlx5_ptys_rate cocci_id@p ;
