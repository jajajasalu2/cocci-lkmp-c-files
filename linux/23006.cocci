...
@@
 struct sprd_compr_dma {  struct dma_chan * chan ;  struct dma_async_tx_descriptor * desc ;  dma_cookie_t cookie ;  dma_addr_t phys ;  void * virt ;  int trans_len ; } cocci_id@p ;
...
position p;
@@
 struct sprd_pcm_dma_params * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct sprd_compr_stream {  struct snd_compr_stream * cstream ;  struct sprd_compr_ops * compr_ops ;  struct sprd_compr_dma dma [ SPRD_COMPR_DMA_CHANS ] ;  int num_channels ;  struct snd_dma_buffer iram_buffer ;  struct snd_dma_buffer compr_buffer ;  dma_addr_t info_phys ;  void * info_area ;  int info_size ;  int copied_total ;  int received_total ;  int received_stage0 ;  int received_stage1 ;  int stage1_pointer ; } cocci_id@p ;
...
position p;
@@
 struct sprd_compr_data * cocci_id@p ;
...
position p;
@@
 struct sprd_compr_playinfo * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_compr_stream * cstream , int cmd ) ;
...
position p;
@@
 struct sprd_compr_callback cocci_id@p ;
...
position p;
@@
 struct sprd_compr_dma * cocci_id@p ;
...
position p;
@@
 struct sprd_compr_stream * cocci_id@p ;
...
position p;
@@
 struct sprd_compr_params cocci_id@p ;
...
position p;
@@
 const struct snd_compr_ops cocci_id@p ;
