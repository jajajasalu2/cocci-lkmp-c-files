...
position p;
@@
 struct asb100_data * cocci_id@p ( struct device * dev ) ;
...
typedef u8,u32,u16;
@@
 struct asb100_data {  struct device * hwmon_dev ;  struct mutex lock ;  struct mutex update_lock ;  unsigned long last_updated ;  struct i2c_client * lm75 [ 2 ] ;  char valid ;  u8 in [ 7 ] ;  u8 in_max [ 7 ] ;  u8 in_min [ 7 ] ;  u8 fan [ 3 ] ;  u8 fan_min [ 3 ] ;  u16 temp [ 4 ] ;  u16 temp_max [ 4 ] ;  u16 temp_hyst [ 4 ] ;  u8 fan_div [ 3 ] ;  u8 pwm ;  u8 vid ;  u32 alarms ;  u8 vrm ; } cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct i2c_client * client , u16 reg , u16 val ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct i2c_client * client , u16 reg ) ;
