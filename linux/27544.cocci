...
typedef u8,u32;
@@
 struct heuristic_ws {  u8 * sample ;  u32 sample_size ;  struct bucket_item * bucket ;  struct bucket_item * bucket_b ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 const struct btrfs_compress_op * const cocci_id@p [ ] ;
...
position p;
@@
 struct compressed_bio * cocci_id@p ;
...
position p;
@@
 struct list_head * cocci_id@p ( unsigned int level ) ;
...
position p;
@@
 enum btrfs_compression_type cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct compressed_bio * cb ) ;
...
typedef u64;
@@
 int cocci_id@p ( struct list_head * ws , struct address_space * mapping , u64 start , struct page * * pages , unsigned long * out_pages , unsigned long * total_in , unsigned long * total_out ) ;
...
position p;
@@
 int cocci_id@p ( struct list_head * ws , struct compressed_bio * cb ) ;
...
position p;
@@
 void cocci_id@p ( struct list_head * ws ) ;
...
position p;
@@
 struct workspace_manager cocci_id@p ;
...
typedef u32;
@@
 struct bucket_item {  u32 count ; } cocci_id@p ;
...
position p;
@@
 struct heuristic_ws cocci_id@p ;
...
position p;
@@
 const struct compressed_bio * cocci_id@p ;
...
position p;
@@
 const struct btrfs_compress_op * cocci_id@p ;
...
position p;
@@
 const struct heuristic_ws * cocci_id@p ;
