...
position p;
@@
 struct bnad_debug_info * cocci_id@p ;
...
position p;
@@
 struct bnad_drvinfo * cocci_id@p ;
...
typedef umode_t;
@@
 struct bnad_debugfs_entry {  const char * name ;  umode_t mode ;  const struct file_operations * fops ; } cocci_id@p ;
...
position p;
@@
 const struct bnad_debugfs_entry * cocci_id@p ;
...
position p;
@@
 struct bnad_debug_info {  char * debug_buffer ;  void * i_private ;  int buffer_len ; } cocci_id@p ;
