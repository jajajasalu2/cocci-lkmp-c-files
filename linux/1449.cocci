...
typedef u8;
@@
 int cocci_id@p ( struct usb_audio_control * con , u8 cmd ) ;
...
position p;
@@
 struct uac1_as_header_descriptor cocci_id@p ;
...
position p;
@@
 struct uac_format_type_i_discrete_descriptor_1 cocci_id@p ;
...
position p;
@@
 enum { STR_AC_IF , STR_INPUT_TERMINAL , STR_INPUT_TERMINAL_CH_NAMES , STR_FEAT_DESC_0 , STR_OUTPUT_TERMINAL , STR_AS_IF_ALT0 , STR_AS_IF_ALT1 , } cocci_id@p ;
...
position p;
@@
 struct uac_iso_endpoint_descriptor cocci_id@p ;
...
position p;
@@
 struct usb_audio_control_selector * cocci_id@p ;
...
typedef u8;
@@
 struct f_audio_buf {  u8 * buf ;  int actual ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct f_uac1_legacy_opts cocci_id@p ;
...
position p;
@@
 struct usb_audio_control cocci_id@p ;
...
position p;
@@
 struct uac_feature_unit_descriptor_0 cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct usb_audio_control * con , u8 cmd , int value ) ;
