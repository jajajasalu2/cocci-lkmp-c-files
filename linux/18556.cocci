...
position p;
@@
 struct coverage_entry * cocci_id@p ;
...
position p;
@@
 const struct decode_header * cocci_id@p ;
...
position p;
@@
 struct decode_header * cocci_id@p ;
...
position p;
@@
 struct decode_table * cocci_id@p ;
...
position p;
@@
 struct kretprobe_instance * cocci_id@p ;
...
position p;
@@
 struct test_arg_regptr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const struct decode_header * , void * ) ;
...
typedef u32;
@@
 u32 cocci_id@p [ TEST_MEMORY_SIZE / sizeof ( u32 ) ] ;
...
typedef bool;
@@
 struct test_probe {  struct kprobe kprobe ;  bool registered ;  int hit ; } cocci_id@p ;
...
position p;
@@
 struct coverage_entry {  const struct decode_header * header ;  unsigned regs ;  unsigned nesting ;  char matched ; } cocci_id@p ;
...
position p;
@@
 struct coverage_table * cocci_id@p ;
...
typedef u32;
@@
 struct table_test_args {  const union decode_item * root_table ;  u32 parent_mask ;  u32 parent_value ; } cocci_id@p ;
...
position p;
@@
 struct decode_custom cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ NUM_DECODE_TYPES ] ;
...
symbol cocci_id;
position p;
typedef kprobe_opcode_t;
@@
 kprobe_opcode_t * cocci_id@p ;
...
position p;
@@
 struct decode_simulate cocci_id@p ;
...
position p;
@@
 const union decode_item * cocci_id@p ;
...
position p;
@@
 struct decode_emulate cocci_id@p ;
...
position p;
@@
 struct test_arg_end * cocci_id@p ;
...
position p;
@@
 struct decode_reject cocci_id@p ;
...
position p;
@@
 struct benchmarks {  void ( * fn ) ( void ) ;  unsigned offset ;  const char * title ; } cocci_id@p ;
...
position p;
@@
 struct table_test_args cocci_id@p ;
...
position p;
@@
 enum decode_reg_type cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( long r0 , long r1 ) ;
...
position p;
@@
 struct coverage_table {  struct coverage_entry * base ;  unsigned num_entries ;  unsigned nesting ; } cocci_id@p ;
...
position p;
@@
 struct test_arg_mem * cocci_id@p ;
