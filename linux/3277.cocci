...
position p;
@@
 struct max1619_data * cocci_id@p ;
...
position p;
@@
 enum temp_index { t_input1 = 0 , t_input2 , t_low2 , t_high2 , t_crit2 , t_hyst2 , t_num_regs , } cocci_id@p ;
...
typedef u8;
@@
 struct max1619_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u8 temp [ t_num_regs ] ;  u8 alarms ; } cocci_id@p ;
