...
position p;
@@
 enum nfp_eth_raw { NSP_ETH_RAW_PORT = 0 , NSP_ETH_RAW_STATE , NSP_ETH_RAW_MAC , NSP_ETH_RAW_CONTROL , NSP_ETH_NUM_RAW , } cocci_id@p ;
...
position p;
@@
 enum nfp_eth_rate { RATE_INVALID = 0 , RATE_10M , RATE_100M , RATE_1G , RATE_10G , RATE_25G , } cocci_id@p ;
...
position p;
@@
 union eth_table_entry cocci_id@p ;
...
typedef u8,__le64;
@@
 union eth_table_entry {  struct {  __le64 port ;  __le64 state ;  u8 mac_addr [ 6 ] ;  u8 resv [ 2 ] ;  __le64 control ; } ;  __le64 raw [ NSP_ETH_NUM_RAW ] ; } cocci_id@p ;
...
position p;
@@
 const union eth_table_entry * cocci_id@p ;
...
position p;
@@
 struct nfp_eth_table_port * cocci_id@p ;
...
position p;
@@
 const struct {  enum nfp_eth_rate rate ;  unsigned int speed ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nfp_eth_table * cocci_id@p ;
