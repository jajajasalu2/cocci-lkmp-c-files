...
position p;
@@
 int cocci_id@p ( struct tsi721_tx_desc * desc ) ;
...
position p;
@@
 struct tsi721_bdma_chan cocci_id@p ;
...
position p;
@@
 struct tsi721_tx_desc cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * ptr ) ;
