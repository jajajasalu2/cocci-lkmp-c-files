...
position p;
@@
 struct mlx5dr_ste_send_info * cocci_id@p [ DR_ACTION_MAX_STES ] ;
...
position p;
@@
 struct mlx5dr_rule_member * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_rule_action_member {  struct mlx5dr_action * action ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct mlx5dr_rule_rx_tx * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_rule_action_member * cocci_id@p ;
