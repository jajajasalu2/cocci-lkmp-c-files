...
position p;
@@
 struct clk_gemini_pci cocci_id@p ;
...
position p;
@@
 struct gemini_reset cocci_id@p ;
...
position p;
@@
 struct clk_gemini_pci {  struct clk_hw hw ;  struct regmap * map ;  unsigned long rate ; } cocci_id@p ;
...
position p;
@@
 struct gemini_reset {  struct regmap * map ;  struct reset_controller_dev rcdev ; } cocci_id@p ;
...
typedef u8;
@@
 struct gemini_gate_data {  u8 bit_idx ;  const char * name ;  const char * parent_name ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 const struct gemini_gate_data cocci_id@p [ ] ;
