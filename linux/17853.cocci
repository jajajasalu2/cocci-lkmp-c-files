...
typedef pg_data_t;
@@
 pg_data_t * cocci_id@p [ MAX_NUMNODES ] ;
...
position p;
@@
 struct early_node_data {  struct ia64_node_data * node_data ;  unsigned long pernode_addr ;  unsigned long pernode_size ;  unsigned long min_pfn ;  unsigned long max_pfn ; } cocci_id@p ;
...
position p;
@@
 struct ia64_node_data cocci_id@p ;
