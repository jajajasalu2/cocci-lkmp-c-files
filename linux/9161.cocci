...
position p;
@@
 struct mlxsw_sp_acl_ruleset * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_ruleset_ht_key cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_ruleset * cocci_id@p ;
...
position p;
@@
 enum mlxsw_afk_element cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_rule cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl * cocci_id@p ;
...
typedef u32;
@@
 struct mlxsw_sp_acl_ruleset_ht_key {  struct mlxsw_sp_acl_block * block ;  u32 chain_index ;  const struct mlxsw_sp_acl_profile_ops * ops ; } cocci_id@p ;
...
typedef u64;
@@
 struct mlxsw_sp_acl_rule {  struct rhash_head ht_node ;  struct list_head list ;  unsigned long cookie ;  struct mlxsw_sp_acl_ruleset * ruleset ;  struct mlxsw_sp_acl_rule_info * rulei ;  u64 last_used ;  u64 last_packets ;  u64 last_bytes ;  unsigned long priv [ 0 ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct mlxsw_sp_acl_block_binding {  struct list_head list ;  struct net_device * dev ;  struct mlxsw_sp_port * mlxsw_sp_port ;  bool ingress ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_ruleset {  struct rhash_head ht_node ;  struct mlxsw_sp_acl_ruleset_ht_key ht_key ;  struct rhashtable rule_ht ;  unsigned int ref_count ;  unsigned long priv [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_block_binding cocci_id@p ;
