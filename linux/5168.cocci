...
position p;
@@
 enum GPIO_REG { GPLR = 0 , GPDR , GPSR , GPCR , GRER , GFER , GEDR , GAFR , } cocci_id@p ;
...
position p;
@@
 struct intel_mid_gpio * cocci_id@p ;
...
position p;
@@
 const struct intel_mid_gpio_ddata cocci_id@p ;
...
position p;
@@
 struct intel_mid_gpio_ddata * cocci_id@p ;
...
typedef u32,u16;
@@
 struct intel_mid_gpio_ddata {  u16 ngpio ;  u32 chip_irq_type ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct intel_mid_gpio {  struct gpio_chip chip ;  void __iomem * reg_base ;  spinlock_t lock ;  struct pci_dev * pdev ; } cocci_id@p ;
