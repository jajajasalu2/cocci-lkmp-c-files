...
position p;
@@
 struct fake_ksigaction cocci_id@p ;
...
position p;
@@
 const struct user_desc * cocci_id@p ;
...
position p;
@@
 struct fake_ksigaction {  void * handler ;  unsigned long sa_flags ;  void ( * sa_restorer ) ( void ) ;  unsigned char sigset [ 8 ] ; } cocci_id@p ;
