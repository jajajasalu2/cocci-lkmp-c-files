...
position p;
@@
 struct sta2x11_instance * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sta2x11_mfd {  struct sta2x11_instance * instance ;  struct regmap * regmap [ sta2x11_n_mfd_plat_devs ] ;  spinlock_t lock [ sta2x11_n_mfd_plat_devs ] ;  struct list_head list ;  void __iomem * regs [ sta2x11_n_mfd_plat_devs ] ; } cocci_id@p ;
...
position p;
@@
 struct sta2x11_mfd_setup_data {  struct sta2x11_mfd_bar_setup_data bars [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum mfd1_bar0_cells { STA2X11_VIC = 0 , } cocci_id@p ;
...
position p;
@@
 struct regmap_config * cocci_id@p [ sta2x11_n_mfd_plat_devs ] ;
...
position p;
@@
 const char * cocci_id@p [ sta2x11_n_mfd_plat_devs ] ;
...
position p;
@@
 enum mfd0_bar1_cells { STA2X11_APBREG = 0 , } cocci_id@p ;
...
position p;
@@
 struct sta2x11_mfd_setup_data * cocci_id@p ;
...
position p;
@@
 enum mfd1_bar1_cells { STA2X11_APB_SOC_REGS = 0 , } cocci_id@p ;
...
position p;
@@
 struct sta2x11_mfd_bar_setup_data {  struct mfd_cell * cells ;  int ncells ; } cocci_id@p ;
...
position p;
@@
 enum mfd0_bar0_cells { STA2X11_GPIO_0 = 0 , STA2X11_GPIO_1 , STA2X11_GPIO_2 , STA2X11_GPIO_3 , STA2X11_SCTL , STA2X11_SCR , STA2X11_TIME , } cocci_id@p ;
...
position p;
@@
 enum sta2x11_mfd_plat_dev cocci_id@p ;
