...
position p;
@@
 struct sockaddr * const cocci_id@p ;
...
position p;
@@
 const struct test_params cocci_id@p ;
...
typedef uint16_t;
@@
 struct test_params {  int recv_family ;  int send_family ;  int protocol ;  size_t recv_socks ;  uint16_t recv_port ;  uint16_t send_port_min ; } cocci_id@p ;
