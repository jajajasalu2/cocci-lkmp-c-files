...
position p;
@@
 struct ahci_qoriq_priv * cocci_id@p ;
...
position p;
@@
 enum ahci_qoriq_type cocci_id@p ;
...
typedef bool;
@@
 struct ahci_qoriq_priv {  struct ccsr_ahci * reg_base ;  enum ahci_qoriq_type type ;  void __iomem * ecc_addr ;  bool is_dmacoherent ; } cocci_id@p ;
...
position p;
@@
 enum ahci_qoriq_type { AHCI_LS1021A , AHCI_LS1028A , AHCI_LS1043A , AHCI_LS2080A , AHCI_LS1046A , AHCI_LS1088A , AHCI_LS2088A , AHCI_LX2160A , } cocci_id@p ;
