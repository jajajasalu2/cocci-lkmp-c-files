...
position p;
@@
 struct fixed_mdio_bus cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,seqcount_t;
@@
 struct fixed_phy {  int addr ;  struct phy_device * phydev ;  seqcount_t seqcount ;  struct fixed_phy_status status ;  bool no_carrier ;  int ( * link_update ) ( struct net_device * , struct fixed_phy_status * ) ;  struct list_head node ;  struct gpio_desc * link_gpiod ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net_device * , struct fixed_phy_status * ) ;
...
position p;
@@
 struct fixed_mdio_bus {  struct mii_bus * mii_bus ;  struct list_head phys ; } cocci_id@p ;
