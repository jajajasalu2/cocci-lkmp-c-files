...
position p;
@@
 struct iavf_cloud_filter * cocci_id@p ;
...
position p;
@@
 struct virtchnl_ether_addr cocci_id@p ;
...
position p;
@@
 struct virtchnl_vsi_resource cocci_id@p ;
...
position p;
@@
 struct iavf_mac_filter * cocci_id@p ;
...
position p;
@@
 struct iavf_arq_event_info cocci_id@p ;
...
position p;
@@
 struct iavf_vlan_filter * cocci_id@p ;
...
position p;
@@
 struct iavf_eth_stats * cocci_id@p ;
...
position p;
@@
 struct iavf_q_vector * cocci_id@p ;
...
position p;
@@
 struct iavf_adapter * cocci_id@p ;
