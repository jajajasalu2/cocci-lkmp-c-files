...
position p;
@@
 enum cdns_dphy_clk_lane_cfg cocci_id@p ;
...
position p;
@@
 const struct cdns_dphy_ops cocci_id@p ;
...
position p;
@@
 struct cdns_dphy {  struct cdns_dphy_cfg cfg ;  void __iomem * regs ;  struct clk * psm_clk ;  struct clk * pll_ref_clk ;  const struct cdns_dphy_ops * ops ;  struct phy * phy ; } cocci_id@p ;
...
position p;
@@
 enum cdns_dphy_clk_lane_cfg { DPHY_CLK_CFG_LEFT_DRIVES_ALL = 0 , DPHY_CLK_CFG_LEFT_DRIVES_RIGHT = 1 , DPHY_CLK_CFG_LEFT_DRIVES_LEFT = 2 , DPHY_CLK_CFG_RIGHT_DRIVES_ALL = 3 , } cocci_id@p ;
...
position p;
@@
 struct cdns_dphy_cfg cocci_id@p ;
...
typedef u8,u16;
@@
 struct cdns_dphy_cfg {  u8 pll_ipdiv ;  u8 pll_opdiv ;  u16 pll_fbdiv ;  unsigned int nlanes ; } cocci_id@p ;
...
position p;
@@
 const struct cdns_dphy_cfg * cocci_id@p ;
