...
position p;
@@
 struct guc_doorbell_info * cocci_id@p ;
...
position p;
@@
 struct guc_process_desc * cocci_id@p ;
...
position p;
@@
 enum { GUC_PREEMPT_NONE = 0 , GUC_PREEMPT_INPROGRESS , GUC_PREEMPT_FINISHED , } cocci_id@p ;
