...
position p;
@@
 const struct ath_gen_timer_configuration cocci_id@p [ ] ;
...
position p;
@@
 const struct ath9k_beacon_state * cocci_id@p ;
...
typedef u16;
@@
 struct {  u16 version ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ath_gen_timer_table * cocci_id@p ;
...
position p;
@@
 struct ath_gen_timer cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 version ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct ar5416IniArray * cocci_id@p ;
...
position p;
@@
 const struct ath9k_channel * cocci_id@p ;
...
typedef bool,u32;
@@
 bool cocci_id@p ( struct ath_hw * ah , u32 type ) ;
