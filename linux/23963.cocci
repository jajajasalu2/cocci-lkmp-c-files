...
position p;
@@
 const struct frag_v4_compare_key * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ipq * qp , struct sk_buff * skb , struct sk_buff * prev_tail , struct net_device * dev ) ;
...
position p;
@@
 struct frag_v4_compare_key cocci_id@p ;
...
typedef u8,u16;
@@
 struct ipq {  struct inet_frag_queue q ;  u8 ecn ;  u16 max_df_size ;  int iif ;  unsigned int rid ;  struct inet_peer * peer ; } cocci_id@p ;
