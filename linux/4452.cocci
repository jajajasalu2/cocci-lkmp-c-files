...
typedef u32;
@@
 struct xgene_rng_dev {  u32 irq ;  void __iomem * csr_base ;  u32 revision ;  u32 datum_size ;  u32 failure_cnt ;  unsigned long failure_ts ;  struct timer_list failure_timer ;  struct device * dev ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 struct xgene_rng_dev * cocci_id@p ;
