...
position p;
@@
 struct veml6070_data * cocci_id@p ;
...
typedef u8;
@@
 struct veml6070_data {  struct i2c_client * client1 ;  struct i2c_client * client2 ;  u8 config ;  struct mutex lock ; } cocci_id@p ;
