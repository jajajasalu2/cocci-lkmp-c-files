...
position p;
@@
 struct dlm_unlock_lock cocci_id@p ;
...
typedef u8;
@@
 enum dlm_status cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , struct dlm_lock * lock , struct dlm_lockstatus * lksb , int flags , u8 owner ) ;
...
position p;
@@
 enum dlm_status cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , struct dlm_lock * lock , struct dlm_lockstatus * lksb , int * actions ) ;
...
symbol cocci_id;
position p;
typedef dlm_astunlockfunc_t;
@@
 dlm_astunlockfunc_t * cocci_id@p ;
