...
typedef bool;
@@
 struct img_spfi_device_data {  bool gpio_requested ; } cocci_id@p ;
...
position p;
@@
 struct img_spfi_device_data * cocci_id@p ;
...
@@
 struct img_spfi {  struct device * dev ;  struct spi_master * master ;  spinlock_t lock ;  void __iomem * regs ;  phys_addr_t phys ;  int irq ;  struct clk * spfi_clk ;  struct clk * sys_clk ;  struct dma_chan * rx_ch ;  struct dma_chan * tx_ch ;  bool tx_dma_busy ;  bool rx_dma_busy ; } cocci_id@p ;
