...
position p;
@@
 const struct ieee80211_mesh_sync_ops * cocci_id@p ;
...
typedef u8;
@@
 struct sync_method {  u8 method ;  struct ieee80211_mesh_sync_ops ops ; } cocci_id@p ;
...
position p;
@@
 const struct sync_method cocci_id@p [ ] ;
