...
position p;
@@
 char cocci_id@p [ EC_USB_PD_MAX_PORTS * 40 ] ;
...
@@
 struct cros_ec_debugfs {  struct cros_ec_dev * ec ;  struct dentry * dir ;  struct circ_buf log_buffer ;  struct cros_ec_command * read_msg ;  struct mutex log_mutex ;  wait_queue_head_t log_wq ;  struct delayed_work log_poll_work ;  struct debugfs_blob_wrapper panicinfo_blob ; } cocci_id@p ;
...
position p;
@@
 struct ec_params_usb_pd_control * cocci_id@p ;
...
position p;
@@
 struct ec_params_console_read_v1 * cocci_id@p ;
...
position p;
@@
 struct ec_params_get_cmd_versions_v1 * cocci_id@p ;
...
position p;
@@
 struct ec_response_uptime_info * cocci_id@p ;
...
position p;
@@
 struct cros_ec_debugfs cocci_id@p ;
...
position p;
@@
 struct ec_response_usb_pd_control_v1 * cocci_id@p ;
