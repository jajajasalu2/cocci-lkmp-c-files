...
position p;
@@
 enum iproc_pinconf_ctrl_type cocci_id@p ;
...
position p;
@@
 enum iproc_pinconf_ctrl_type { IOCTRL_TYPE_AON = 1 , IOCTRL_TYPE_CDRU , IOCTRL_TYPE_INVALID , } cocci_id@p ;
...
position p;
@@
 enum iproc_pinconf_param { IPROC_PINCONF_DRIVE_STRENGTH = 0 , IPROC_PINCONF_BIAS_DISABLE , IPROC_PINCONF_BIAS_PULL_UP , IPROC_PINCONF_BIAS_PULL_DOWN , IPROC_PINCON_MAX , } cocci_id@p ;
