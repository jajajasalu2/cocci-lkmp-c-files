...
position p;
@@
 struct ecryptfs_key_record * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_parse_tag_70_packet_silly_stack * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_auth_tok * * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_write_tag_70_packet_silly_stack * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_password cocci_id@p ;
...
position p;
@@
 struct ecryptfs_auth_tok_list_item cocci_id@p ;
...
position p;
@@
 struct ecryptfs_message * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ECRYPTFS_SIG_SIZE ] ;
...
position p;
@@
 struct ecryptfs_session_key * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_msg_ctx * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_private_key cocci_id@p ;
