...
position p;
@@
 struct snd_mixer_oss_assign_table * cocci_id@p ;
...
position p;
@@
 struct snd_mixer_oss_file cocci_id@p ;
...
position p;
@@
 struct snd_mixer_oss * cocci_id@p ;
...
position p;
@@
 struct snd_mixer_oss_assign_table {  int oss_id ;  const char * name ;  int index ; } cocci_id@p ;
...
position p;
@@
 struct slot {  unsigned int signature ;  unsigned int present ;  unsigned int channels ;  unsigned int numid [ SNDRV_MIXER_OSS_ITEM_COUNT ] ;  unsigned int capture_item ;  struct snd_mixer_oss_assign_table * assigned ;  unsigned int allocated : 1 ; } cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ SNDRV_OSS_MAX_MIXERS ] ;
...
position p;
@@
 struct snd_mixer_oss_slot * cocci_id@p ;
