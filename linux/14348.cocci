...
typedef u8;
@@
 struct cx24117_priv {  u8 demod_address ;  struct i2c_adapter * i2c ;  u8 skip_fw_load ;  struct mutex fe_lock ;  struct tuner_i2c_props i2c_props ;  struct list_head hybrid_tuner_instance_list ; } cocci_id@p ;
...
position p;
@@
 enum fe_delivery_system cocci_id@p ;
...
position p;
@@
 struct cx24117_priv cocci_id@p ;
...
position p;
@@
 struct cx24117_state {  struct cx24117_priv * priv ;  struct dvb_frontend frontend ;  struct cx24117_tuning dcur ;  struct cx24117_tuning dnxt ;  struct cx24117_cmd dsec_cmd ;  int demod ; } cocci_id@p ;
...
position p;
@@
 const struct cx24117_config * cocci_id@p ;
...
position p;
@@
 struct cx24117_state * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dvb_frontend * fe , const struct firmware * fw ) ;
...
typedef u8;
@@
 struct cx24117_cmd {  u8 len ;  u8 args [ CX24117_ARGLEN ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct cx24117_modfec {  enum fe_delivery_system delivery_system ;  enum fe_modulation modulation ;  enum fe_code_rate fec ;  u8 mask ;  u8 val ; } cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct cx24117_tuning {  u32 frequency ;  u32 symbol_rate ;  enum fe_spectral_inversion inversion ;  enum fe_code_rate fec ;  enum fe_delivery_system delsys ;  enum fe_modulation modulation ;  enum fe_pilot pilot ;  enum fe_rolloff rolloff ;  u8 fec_val ;  u8 fec_mask ;  u8 inversion_val ;  u8 pilot_val ;  u8 rolloff_val ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CX24117_ARGLEN + 1 ] ;
