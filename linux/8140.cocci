...
position p;
@@
 const struct mpc5xxx_can_data cocci_id@p ;
...
typedef u32;
@@
 struct mpc5xxx_can_data {  unsigned int type ;  u32 ( * get_clock ) ( struct platform_device * ofdev , const char * clock_name , int * mscan_clksrc ) ;  void ( * put_clock ) ( struct platform_device * ofdev ) ; } cocci_id@p ;
...
position p;
@@
 enum { CLK_FROM_AUTO , CLK_FROM_IPS , CLK_FROM_SYS , CLK_FROM_REF , } cocci_id@p ;
