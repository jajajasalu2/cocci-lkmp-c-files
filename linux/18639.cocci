...
position p;
@@
 struct omap_wakeupgen_ops cocci_id@p ;
...
position p;
@@
 struct omap_wakeupgen_ops {  void ( * save_context ) ( void ) ;  void ( * restore_context ) ( void ) ; } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_NR_REG_BANKS ] ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_IRQS ] ;
