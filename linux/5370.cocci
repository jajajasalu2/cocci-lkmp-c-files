...
position p;
@@
 char cocci_id@p [ ASYNC_DRV_NAMES_MAX_LEN ] ;
...
position p;
@@
 struct device_attach_data cocci_id@p ;
...
typedef bool;
@@
 struct device_attach_data {  struct device * dev ;  bool check_async ;  bool want_async ;  bool have_async ; } cocci_id@p ;
