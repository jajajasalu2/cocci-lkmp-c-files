...
position p;
@@
 struct nitrox_crypto_ctx cocci_id@p ;
...
position p;
@@
 struct nitrox_aead_rctx * cocci_id@p ;
...
position p;
@@
 struct flexi_crypto_context cocci_id@p ;
...
position p;
@@
 struct nitrox_rfc4106_rctx * cocci_id@p ;
...
position p;
@@
 struct nitrox_kcrypt_request * cocci_id@p ;
...
position p;
@@
 struct crypto_ctx_hdr * cocci_id@p ;
...
position p;
@@
 struct se_crypto_request * cocci_id@p ;
