...
position p;
@@
 struct p9_trans_fd {  struct file * rd ;  struct file * wr ;  struct p9_conn conn ; } cocci_id@p ;
...
position p;
@@
 struct p9_poll_wait cocci_id@p ;
...
position p;
@@
 enum { Opt_port , Opt_rfdno , Opt_wfdno , Opt_err , Opt_privport , } cocci_id@p ;
...
@@
 struct p9_poll_wait {  struct p9_conn * conn ;  wait_queue_entry_t wait ;  wait_queue_head_t * wait_addr ; } cocci_id@p ;
...
position p;
@@
 enum { Rworksched = 1 , Rpending = 2 , Wworksched = 4 , Wpending = 8 , } cocci_id@p ;
...
typedef bool,u16;
@@
 struct p9_fd_opts {  int rfd ;  int wfd ;  u16 port ;  bool privport ; } cocci_id@p ;
