...
position p;
@@
 struct au8522_state cocci_id@p ;
...
position p;
@@
 const struct au8522_register_config cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct au8522_register_config {  u16 reg_name ;  u8 reg_val [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct au8522_register_config cocci_id@p ;
