...
position p;
@@
 struct aper_size_info_32 * cocci_id@p ;
...
position p;
@@
 const struct aper_size_info_32 cocci_id@p [ 7 ] ;
...
position p;
@@
 struct aper_size_info_32 cocci_id@p [ 7 ] ;
...
position p;
@@
 const struct aper_size_info_32 cocci_id@p [ 5 ] ;
