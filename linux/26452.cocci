...
position p;
@@
 enum { PACKET_FIELD_DETAIL = 0x01 , PACKET_FIELD_DATA_LENGTH = 0x02 , PACKET_FIELD_TRANSACTION = 0x04 , } cocci_id@p ;
...
position p;
@@
 enum { PACKET_RESERVED , PACKET_REQUEST , PACKET_RESPONSE , PACKET_OTHER , } cocci_id@p ;
...
position p;
@@
 struct packet_info {  const char * name ;  int type ;  int response_tcode ;  const struct packet_field * fields ;  int field_count ; } cocci_id@p ;
...
position p;
@@
 const struct packet_field cocci_id@p [ ] ;
...
position p;
@@
 const struct packet_info cocci_id@p [ ] ;
...
position p;
@@
 enum { VIEW_TRANSACTION , VIEW_PACKET , VIEW_STATS , } cocci_id@p ;
...
position p;
@@
 struct protocol_decoder {  const char * name ;  int ( * decode ) ( struct link_transaction * t ) ; } cocci_id@p ;
...
position p;
@@
 struct link_transaction cocci_id@p ;
...
position p;
@@
 struct packet_field {  const char * name ;  int offset ;  int width ;  int flags ;  const char * const * value_names ; } cocci_id@p ;
...
position p;
@@
 const struct protocol_decoder cocci_id@p [ ] ;
