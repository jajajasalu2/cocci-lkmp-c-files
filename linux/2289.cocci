...
typedef u8;
@@
 struct int3400_thermal_priv {  struct acpi_device * adev ;  struct thermal_zone_device * thermal ;  int mode ;  int art_count ;  struct art * arts ;  int trt_count ;  struct trt * trts ;  u8 uuid_bitmap ;  int rel_misc_dev_res ;  int current_uuid_index ; } cocci_id@p ;
...
position p;
@@
 struct int3400_thermal_priv * cocci_id@p ;
...
position p;
@@
 enum int3400_thermal_uuid cocci_id@p ;
...
position p;
@@
 struct acpi_osc_context cocci_id@p ;
...
position p;
@@
 struct thermal_zone_params cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ INT3400_THERMAL_MAXIMUM_UUID ] ;
