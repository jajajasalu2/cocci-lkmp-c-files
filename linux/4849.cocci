...
position p;
@@
 struct ib_event_work cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_demux_work cocci_id@p ;
...
position p;
@@
 const struct default_rules * cocci_id@p ;
...
position p;
@@
 struct mlx4_flow_reg_id cocci_id@p ;
...
position p;
@@
 struct mlx4_clock_params cocci_id@p ;
...
position p;
@@
 enum mlx4_dev_event cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_alloc_ucontext_resp cocci_id@p ;
...
position p;
@@
 enum mlx4_net_trans_promisc_mode cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_flow * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_xrcd * cocci_id@p ;
...
position p;
@@
 struct ib_flow_spec_ib cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( diag_device_only ) + ARRAY_SIZE ( diag_ext ) + ARRAY_SIZE ( diag_basic ) ] ;
...
position p;
@@
 const struct diag_counter cocci_id@p [ ] ;
...
typedef u8,__be32;
@@
 struct {  union ib_gid gid ;  __be32 rsrvd1 [ 2 ] ;  __be16 rsrvd2 ;  u8 type ;  u8 version ;  __be32 rsrvd3 ; } * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_steering * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_alloc_ucontext_resp_v3 cocci_id@p ;
...
position p;
@@
 struct gid_cache_context * cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_diag_counters * cocci_id@p ;
...
typedef __u32,__u8;
@@
 struct default_rules {  __u32 mandatory_fields [ IB_FLOW_SPEC_SUPPORT_LAYERS ] ;  __u32 mandatory_not_fields [ IB_FLOW_SPEC_SUPPORT_LAYERS ] ;  __u32 rules_create_list [ IB_FLOW_SPEC_SUPPORT_LAYERS ] ;  __u8 link_layer ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_steering {  struct list_head list ;  struct mlx4_flow_reg_id reg_id ;  union ib_gid gid ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_counters * cocci_id@p ;
...
typedef u8;
@@
 enum rdma_link_layer cocci_id@p ( struct ib_device * device , u8 port_num ) ;
...
position p;
@@
 struct mlx4_uverbs_ex_query_device_resp cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx4_ib_dev * ibdev , int slave , int do_init ) ;
...
position p;
@@
 struct mlx4_interface cocci_id@p ;
...
typedef u32;
@@
 struct diag_counter {  const char * name ;  u32 offset ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_uverbs_ex_query_device cocci_id@p ;
