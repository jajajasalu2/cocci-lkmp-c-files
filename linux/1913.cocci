...
typedef u8,bool,u32;
@@
 struct meson_sar_adc_param {  bool has_bl30_integration ;  unsigned long clock_rate ;  u32 bandgap_reg ;  unsigned int resolution ;  const struct regmap_config * regmap_config ;  u8 temperature_trimming_bits ;  unsigned int temperature_multiplier ;  unsigned int temperature_divider ; } cocci_id@p ;
...
position p;
@@
 const struct meson_sar_adc_param cocci_id@p ;
...
position p;
@@
 enum meson_sar_adc_chan7_mux_sel cocci_id@p ;
...
position p;
@@
 const struct meson_sar_adc_data cocci_id@p ;
...
position p;
@@
 enum meson_sar_adc_num_samples cocci_id@p ;
...
position p;
@@
 struct meson_sar_adc_data {  const struct meson_sar_adc_param * param ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 enum meson_sar_adc_num_samples { ONE_SAMPLE = 0x0 , TWO_SAMPLES = 0x1 , FOUR_SAMPLES = 0x2 , EIGHT_SAMPLES = 0x3 , } cocci_id@p ;
...
position p;
@@
 enum meson_sar_adc_avg_mode { NO_AVERAGING = 0x0 , MEAN_AVERAGING = 0x1 , MEDIAN_AVERAGING = 0x2 , } cocci_id@p ;
...
position p;
@@
 struct meson_sar_adc_priv * cocci_id@p ;
...
position p;
@@
 enum meson_sar_adc_chan7_mux_sel { CHAN7_MUX_VSS = 0x0 , CHAN7_MUX_VDD_DIV4 = 0x1 , CHAN7_MUX_VDD_DIV2 = 0x2 , CHAN7_MUX_VDD_MUL3_DIV4 = 0x3 , CHAN7_MUX_VDD = 0x4 , CHAN7_MUX_CH7_INPUT = 0x7 , } cocci_id@p ;
...
position p;
@@
 enum meson_sar_adc_avg_mode cocci_id@p ;
