...
typedef u8,bool;
@@
 struct si1145_part_info {  u8 part ;  const struct iio_info * iio_info ;  const struct iio_chan_spec * channels ;  unsigned int num_channels ;  unsigned int num_leds ;  bool uncompressed_meas_rate ; } cocci_id@p ;
...
position p;
@@
 const struct si1145_part_info cocci_id@p [ ] ;
...
typedef bool;
@@
 struct si1145_data {  struct i2c_client * client ;  struct mutex lock ;  struct mutex cmdlock ;  int rsp_seq ;  const struct si1145_part_info * part_info ;  unsigned long scan_mask ;  bool autonomous ;  struct iio_trigger * trig ;  int meas_rate ; } cocci_id@p ;
...
position p;
@@
 enum { SI1132 , SI1141 , SI1142 , SI1143 , SI1145 , SI1146 , SI1147 , } cocci_id@p ;
