...
typedef bool,u32;
@@
 struct clk_pll_data {  bool has_pllctrl ;  u32 phy_pllm ;  u32 phy_pll_ctl0 ;  void __iomem * pllm ;  void __iomem * pllod ;  void __iomem * pll_ctl0 ;  u32 pllm_lower_mask ;  u32 pllm_upper_mask ;  u32 pllm_upper_shift ;  u32 plld_mask ;  u32 clkod_mask ;  u32 clkod_shift ;  u32 postdiv ; } cocci_id@p ;
...
position p;
@@
 struct clk_pll {  struct clk_hw hw ;  struct clk_pll_data * pll_data ; } cocci_id@p ;
...
position p;
@@
 struct clk_pll_data * cocci_id@p ;
