...
position p;
@@
 struct qm_rf_pq_map_e4 cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ 1 ] [ NUM_OF_CONNECTION_TYPES_E4 ] ;
...
position p;
@@
 struct init_qm_port_params cocci_id@p [ MAX_NUM_PORTS ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ QM_CMD_STRUCT_SIZE ( QM_STOP_CMD ) ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ 3 ] [ NUM_OF_CONNECTION_TYPES_E4 ] ;
...
position p;
@@
 struct qed_qm_pf_rt_init_params * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MAX_QM_TX_QUEUES / QM_PF_QUEUE_GROUP_SIZE ] ;
