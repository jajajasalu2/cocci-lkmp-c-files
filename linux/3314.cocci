...
position p;
@@
 const struct tmp51x_data * cocci_id@p ;
...
typedef u32,u16;
@@
 struct tmp51x_data {  u16 shunt_config ;  u16 pga_gain ;  u32 vbus_range_uvolt ;  u16 temp_config ;  u32 nfactor [ 3 ] ;  u32 shunt_uohms ;  u32 curr_lsb_ua ;  u32 pwr_lsb_uw ;  enum tmp51x_ids id ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 enum tmp51x_ids { tmp512 , tmp513 , } cocci_id@p ;
