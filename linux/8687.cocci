...
position p;
@@
 const struct fm10k_tlv_attr cocci_id@p [ ] ;
...
position p;
@@
 struct fm10k_hw_stats * cocci_id@p ;
...
position p;
@@
 struct fm10k_swapi_table_info * cocci_id@p ;
...
position p;
@@
 struct fm10k_mac_update cocci_id@p ;
...
position p;
@@
 struct fm10k_global_table_data * cocci_id@p ;
...
position p;
@@
 const struct fm10k_mac_ops cocci_id@p ;
...
position p;
@@
 struct fm10k_swapi_error cocci_id@p ;
...
position p;
@@
 const struct fm10k_iov_ops cocci_id@p ;
