...
position p;
@@
 struct zynqmp_ipi_message cocci_id@p ;
...
position p;
@@
 struct zynqmp_ipi_pdata * cocci_id@p ;
...
position p;
@@
 struct zynqmp_ipi_mchan {  int is_opened ;  void __iomem * req_buf ;  void __iomem * resp_buf ;  void * rx_buf ;  size_t req_buf_size ;  size_t resp_buf_size ;  unsigned int chan_type ; } cocci_id@p ;
...
typedef u32;
@@
 struct zynqmp_ipi_mbox {  struct zynqmp_ipi_pdata * pdata ;  struct device dev ;  u32 remote_id ;  struct mbox_controller mbox ;  struct zynqmp_ipi_mchan mchans [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct zynqmp_ipi_mchan * cocci_id@p ;
...
position p;
@@
 struct zynqmp_ipi_mbox * cocci_id@p ;
...
typedef u32;
@@
 struct zynqmp_ipi_pdata {  struct device * dev ;  int irq ;  unsigned int method ;  u32 local_id ;  int num_mboxes ;  struct zynqmp_ipi_mbox * ipi_mboxes ; } cocci_id@p ;
