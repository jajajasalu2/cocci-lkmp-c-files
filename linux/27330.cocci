...
position p;
@@
 struct ntlmssp2_name cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CIFS_ENCPWD_SIZE ] ;
...
position p;
@@
 const struct cifs_ses * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CIFS_SESS_KEY_SIZE ] ;
...
position p;
@@
 unsigned char cocci_id@p [ CIFS_SESS_KEY_SIZE ] ;
...
position p;
@@
 char cocci_id@p [ CIFS_NTHASH_SIZE ] ;
