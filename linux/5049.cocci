...
position p;
@@
 struct mxs_gpio_port * cocci_id@p ;
...
position p;
@@
 enum mxs_gpio_id { IMX23_GPIO , IMX28_GPIO , } cocci_id@p ;
...
typedef u32;
@@
 struct mxs_gpio_port {  void __iomem * base ;  int id ;  int irq ;  struct irq_domain * domain ;  struct gpio_chip gc ;  struct device * dev ;  enum mxs_gpio_id devid ;  u32 both_edges ; } cocci_id@p ;
