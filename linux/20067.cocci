...
position p;
@@
 struct {  struct hpc3_stat pbdma [ 8 ] ;  struct hpc3_stat scsi [ 2 ] ;  struct hpc3_stat ethrx , ethtx ; } cocci_id@p ;
...
typedef u32;
@@
 struct {  unsigned long err_addr ;  struct {  u32 lo ;  u32 hi ; } tags [ 1 ] [ 2 ] , tagd [ 4 ] [ 2 ] , tagi [ 4 ] [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct hpc3_stat {  unsigned long addr ;  unsigned int ctrl ;  unsigned int cbp ;  unsigned int ndptr ; } cocci_id@p ;
