...
position p;
@@
 struct virtio_gpu_resp_capset cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_resource_flush * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_object * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_cmd_get_edid * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_resource_create_3d * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_device * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_ctx_resource * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_resp_capset_info cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_get_capset_info * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_cmd_submit * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_ctrl_hdr * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_resource_create_2d * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_resource_unref * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_set_scanout * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_resp_edid cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_output * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_transfer_to_host_2d * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_box * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_command * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_mem_entry * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_vbuffer * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_resource_detach_backing * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_resource_attach_backing * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_ctx_destroy * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_object_array * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_get_capset * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_drv_cap_cache * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_update_cursor * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_object_params * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_resp_display_info * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_ctx_create * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_fence * cocci_id@p ;
...
position p;
@@
 struct virtio_gpu_transfer_host_3d * cocci_id@p ;
