...
position p;
@@
 void cocci_id@p ( struct pcpu_chunk * chunk , int page_start , int page_end ) ;
...
position p;
@@
 const struct pcpu_group_info * cocci_id@p ;
...
position p;
@@
 const struct pcpu_chunk * cocci_id@p ;
...
position p;
@@
 struct pcpu_block_md * cocci_id@p ;
...
position p;
@@
 struct pcpu_alloc_info * cocci_id@p ;
...
position p;
@@
 const struct pcpu_alloc_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pcpu_fc_free_fn_t;
@@
 pcpu_fc_free_fn_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pcpu_chunk * chunk ) ;
...
symbol cocci_id;
position p;
typedef pcpu_fc_cpu_distance_fn_t;
@@
 pcpu_fc_cpu_distance_fn_t cocci_id@p ;
...
position p;
@@
 const struct pcpu_block_md * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pcpu_fc_alloc_fn_t;
@@
 pcpu_fc_alloc_fn_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pcpu_fc_populate_pte_fn_t;
@@
 pcpu_fc_populate_pte_fn_t cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p ( void * addr ) ;
...
typedef gfp_t;
@@
 struct pcpu_chunk * cocci_id@p ( gfp_t gfp ) ;
...
position p;
@@
 struct pcpu_group_info * cocci_id@p ;
