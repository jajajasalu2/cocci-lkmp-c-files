...
typedef bool,u32;
@@
 struct stm32_dma_desc {  struct virt_dma_desc vdesc ;  bool cyclic ;  u32 num_sgs ;  struct stm32_dma_sg_req sg_req [ ] ; } cocci_id@p ;
...
position p;
@@
 enum stm32_dma_burst_size { STM32_DMA_BURST_SINGLE , STM32_DMA_BURST_INCR4 , STM32_DMA_BURST_INCR8 , STM32_DMA_BURST_INCR16 , } cocci_id@p ;
...
position p;
@@
 struct stm32_dma_chan_reg * cocci_id@p ;
...
typedef bool;
@@
 struct stm32_dma_device {  struct dma_device ddev ;  void __iomem * base ;  struct clk * clk ;  struct reset_control * rst ;  bool mem2mem ;  struct stm32_dma_chan chan [ STM32_DMA_MAX_CHANNELS ] ; } cocci_id@p ;
...
position p;
@@
 struct stm32_dma_cfg cocci_id@p ;
...
position p;
@@
 struct stm32_dma_device * cocci_id@p ;
...
position p;
@@
 struct stm32_dma_desc cocci_id@p ;
...
typedef bool,u32;
@@
 struct stm32_dma_chan {  struct virt_dma_chan vchan ;  bool config_init ;  bool busy ;  u32 id ;  u32 irq ;  struct stm32_dma_desc * desc ;  u32 next_sg ;  struct dma_slave_config dma_sconfig ;  struct stm32_dma_chan_reg chan_reg ;  u32 threshold ;  u32 mem_burst ;  u32 mem_width ; } cocci_id@p ;
...
position p;
@@
 struct stm32_dma_chan * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct stm32_dma_chan * chan ) ;
...
typedef u32;
@@
 struct stm32_dma_cfg {  u32 channel_id ;  u32 request_line ;  u32 stream_config ;  u32 features ; } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_dma_sg_req {  u32 len ;  struct stm32_dma_chan_reg chan_reg ; } cocci_id@p ;
...
position p;
@@
 enum stm32_dma_width { STM32_DMA_BYTE , STM32_DMA_HALF_WORD , STM32_DMA_WORD , } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_dma_chan_reg {  u32 dma_lisr ;  u32 dma_hisr ;  u32 dma_lifcr ;  u32 dma_hifcr ;  u32 dma_scr ;  u32 dma_sndtr ;  u32 dma_spar ;  u32 dma_sm0ar ;  u32 dma_sm1ar ;  u32 dma_sfcr ; } cocci_id@p ;
...
position p;
@@
 struct stm32_dma_sg_req * cocci_id@p ;
