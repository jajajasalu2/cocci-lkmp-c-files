...
position p;
@@
 enum hi3110_model { CAN_HI3110_HI3110 = 0x3110 , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HI3110_RX_BUF_LEN - 1 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ HI3110_TX_EXT_BUF_LEN ] ;
