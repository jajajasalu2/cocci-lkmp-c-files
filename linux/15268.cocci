...
position p;
@@
 struct sunfire_led {  struct led_classdev led_cdev ;  void __iomem * reg ; } cocci_id@p ;
...
position p;
@@
 struct led_type {  const char * name ;  set_handler handler ;  const char * default_trigger ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct led_classdev * , enum led_brightness ) ;
...
position p;
@@
 struct sunfire_drvdata * cocci_id@p ;
...
position p;
@@
 struct led_type cocci_id@p [ NUM_LEDS_PER_BOARD ] ;
...
position p;
@@
 struct sunfire_drvdata {  struct sunfire_led leds [ NUM_LEDS_PER_BOARD ] ; } cocci_id@p ;
