...
position p;
@@
 struct subdev_8255_private {  unsigned long regbase ;  int ( * io ) ( struct comedi_device * dev , int dir , int port , int data , unsigned long regbase ) ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct comedi_device * dev , int dir , int port , int data , unsigned long regbase ) ;
...
position p;
@@
 struct subdev_8255_private * cocci_id@p ;
