...
position p;
@@
 struct atmel_pin {  unsigned pin_id ;  unsigned mux ;  unsigned ioset ;  unsigned bank ;  unsigned line ;  const char * device ; } cocci_id@p ;
...
typedef u32;
@@
 struct atmel_group {  const char * name ;  u32 pin ; } cocci_id@p ;
...
position p;
@@
 struct atmel_pioctrl_data {  unsigned nbanks ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_pioctrl_data * cocci_id@p ;
...
position p;
@@
 struct atmel_pioctrl * cocci_id@p ;
...
typedef u32;
@@
 struct atmel_pioctrl {  void __iomem * reg_base ;  struct clk * clk ;  unsigned nbanks ;  struct pinctrl_dev * pinctrl_dev ;  struct atmel_group * groups ;  const char * const * group_names ;  struct atmel_pin * * pins ;  unsigned npins ;  struct gpio_chip * gpio_chip ;  struct irq_domain * irq_domain ;  int * irqs ;  unsigned * pm_wakeup_sources ;  struct {  u32 imr ;  u32 odsr ;  u32 cfgr [ ATMEL_PIO_NPINS_PER_BANK ] ; } * pm_suspend_backup ;  struct device * dev ;  struct device_node * node ; } cocci_id@p ;
