...
position p;
@@
 struct atmel_hlcdc_pwm * cocci_id@p ;
...
position p;
@@
 const struct atmel_hlcdc_pwm_errata cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_pwm {  struct pwm_chip chip ;  struct atmel_hlcdc * hlcdc ;  struct clk * cur_clk ;  const struct atmel_hlcdc_pwm_errata * errata ; } cocci_id@p ;
...
typedef bool;
@@
 struct atmel_hlcdc_pwm_errata {  bool slow_clk_erratum ;  bool div1_clk_erratum ; } cocci_id@p ;
