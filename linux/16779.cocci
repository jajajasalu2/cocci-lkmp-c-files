...
typedef bool,u16;
@@
 struct f01_data {  struct f01_basic_properties properties ;  struct f01_device_control device_control ;  u16 doze_interval_addr ;  u16 wakeup_threshold_addr ;  u16 doze_holdoff_addr ;  bool suspended ;  bool old_nosleep ;  unsigned int num_of_irq_regs ; } cocci_id@p ;
...
typedef u8;
@@
 struct f01_device_control {  u8 ctrl0 ;  u8 doze_interval ;  u8 wakeup_threshold ;  u8 doze_holdoff ; } cocci_id@p ;
...
@@
 struct f01_basic_properties {  u8 manufacturer_id ;  bool has_lts ;  bool has_adjustable_doze ;  bool has_adjustable_doze_holdoff ;  char dom [ 11 ] ;  u8 product_id [ RMI_PRODUCT_ID_LENGTH + 1 ] ;  u16 productinfo ;  u32 firmware_id ;  u32 package_id ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RMI_F01_BASIC_QUERY_LEN ] ;
...
position p;
@@
 struct f01_basic_properties * cocci_id@p ;
