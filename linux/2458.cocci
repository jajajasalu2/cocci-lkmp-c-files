...
position p;
@@
 struct msgdma_device cocci_id@p ;
...
typedef u32;
@@
 struct msgdma_extended_desc {  u32 read_addr_lo ;  u32 write_addr_lo ;  u32 len ;  u32 burst_seq_num ;  u32 stride ;  u32 read_addr_hi ;  u32 write_addr_hi ;  u32 control ; } cocci_id@p ;
...
position p;
@@
 struct msgdma_sw_desc {  struct dma_async_tx_descriptor async_tx ;  struct msgdma_extended_desc hw_desc ;  struct list_head node ;  struct list_head tx_list ; } cocci_id@p ;
...
position p;
@@
 struct msgdma_sw_desc * cocci_id@p ;
...
position p;
@@
 struct msgdma_extended_desc * cocci_id@p ;
