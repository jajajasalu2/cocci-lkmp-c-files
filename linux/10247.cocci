...
position p;
@@
 enum pmic_arb_chnl_status { PMIC_ARB_STATUS_DONE = BIT ( 0 ) , PMIC_ARB_STATUS_FAILURE = BIT ( 1 ) , PMIC_ARB_STATUS_DENIED = BIT ( 2 ) , PMIC_ARB_STATUS_DROPPED = BIT ( 3 ) , } cocci_id@p ;
...
position p;
@@
 struct spmi_pmic_arb * cocci_id@p ;
...
position p;
@@
 enum pmic_arb_cmd_op_code { PMIC_ARB_OP_EXT_WRITEL = 0 , PMIC_ARB_OP_EXT_READL = 1 , PMIC_ARB_OP_EXT_WRITE = 2 , PMIC_ARB_OP_RESET = 3 , PMIC_ARB_OP_SLEEP = 4 , PMIC_ARB_OP_SHUTDOWN = 5 , PMIC_ARB_OP_WAKEUP = 6 , PMIC_ARB_OP_AUTHENTICATE = 7 , PMIC_ARB_OP_MSTR_READ = 8 , PMIC_ARB_OP_MSTR_WRITE = 9 , PMIC_ARB_OP_EXT_READ = 13 , PMIC_ARB_OP_WRITE = 14 , PMIC_ARB_OP_READ = 15 , PMIC_ARB_OP_ZERO_WRITE = 16 , } cocci_id@p ;
...
position p;
@@
 struct pmic_arb_ver_ops cocci_id@p ;
...
position p;
@@
 enum pmic_arb_channel cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,u16,resource_size_t,raw_spinlock_t;
@@
 struct spmi_pmic_arb {  void __iomem * rd_base ;  void __iomem * wr_base ;  void __iomem * intr ;  void __iomem * cnfg ;  void __iomem * core ;  resource_size_t core_size ;  raw_spinlock_t lock ;  u8 channel ;  int irq ;  u8 ee ;  u16 min_apid ;  u16 max_apid ;  u32 * mapping_table ; 
	 DECLARE_BITMAP ( mapping_table_valid , PMIC_ARB_MAX_PERIPHS ) 
		 ;  struct irq_domain * domain ;  struct spmi_controller * spmic ;  const struct pmic_arb_ver_ops * ver_ops ;  u16 * ppid_to_apid ;  u16 last_apid ;  struct apid_data apid_data [ PMIC_ARB_MAX_PERIPHS ] ; } cocci_id@p ;
...
position p;
@@
 struct spmi_pmic_arb_qpnpint_type cocci_id@p ;
...
position p;
@@
 enum qpnpint_regs { QPNPINT_REG_RT_STS = 0x10 , QPNPINT_REG_SET_TYPE = 0x11 , QPNPINT_REG_POLARITY_HIGH = 0x12 , QPNPINT_REG_POLARITY_LOW = 0x13 , QPNPINT_REG_LATCHED_CLR = 0x14 , QPNPINT_REG_EN_SET = 0x15 , QPNPINT_REG_EN_CLR = 0x16 , QPNPINT_REG_LATCHED_STS = 0x18 , } cocci_id@p ;
...
position p;
@@
 const struct pmic_arb_ver_ops * cocci_id@p ;
...
typedef u8,u16;
@@
 struct apid_data {  u16 ppid ;  u8 write_ee ;  u8 irq_ee ; } cocci_id@p ;
...
position p;
@@
 enum pmic_arb_channel { PMIC_ARB_CHANNEL_RW , PMIC_ARB_CHANNEL_OBS , } cocci_id@p ;
...
position p;
@@
 struct spmi_controller * cocci_id@p ;
