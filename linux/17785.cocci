...
position p;
@@
 int cocci_id@p ( unsigned long , void * , int ) ;
...
position p;
@@
 struct arch_hw_breakpoint cocci_id@p ;
...
position p;
@@
 unsigned long ( * cocci_id@p ) ( unsigned long , unsigned long , unsigned long , unsigned long , unsigned long , unsigned long , unsigned long , unsigned long ) ;
...
position p;
@@
 instruction_dump_func cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( int spr , unsigned long default_value ) ;
...
position p;
@@
 void cocci_id@p ( unsigned char * , int ) ;
...
position p;
@@
 struct spu_info cocci_id@p [ XMON_NUM_SPUS ] ;
...
position p;
@@
 struct sysrq_key_op cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long sp , unsigned long lr , unsigned long pc ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long inst , unsigned long addr ) ;
...
position p;
@@
 struct bpt * cocci_id@p ( unsigned long pc ) ;
...
typedef u8,u64,u32;
@@
 struct spu_info {  struct spu * spu ;  u64 saved_mfc_sr1_RW ;  u32 saved_spu_runcntl_RW ;  unsigned long dump_addr ;  u8 stopped_ok ; } cocci_id@p ;
...
typedef atomic_t;
@@
 struct bpt {  unsigned long address ;  unsigned int instr [ 2 ] ;  atomic_t ref_count ;  int enabled ;  unsigned long pad ; } cocci_id@p ;
...
position p;
@@
 const struct bug_entry * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int , unsigned long ) ;
...
position p;
@@
 const char * cocci_id@p [ N_PTREGS ] ;
...
position p;
@@
 struct bpt * cocci_id@p ( unsigned long pc , unsigned long * offp ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long * valp ) ;
...
position p;
@@
 void cocci_id@p ( struct pt_regs * ) ;
...
position p;
@@
 void cocci_id@p ( unsigned long , long ) ;
...
position p;
@@
 const char * cocci_id@p ( unsigned long vec ) ;
...
position p;
@@
 void cocci_id@p ( unsigned long address , const char * mid , const char * after ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long , long , int ) ;
...
position p;
@@
 void cocci_id@p ( int spr , unsigned long value ) ;
...
position p;
@@
 int cocci_id@p ( int , unsigned long * ) ;
...
position p;
@@
 void cocci_id@p ( unsigned char * , unsigned char * , unsigned , unsigned ) ;
