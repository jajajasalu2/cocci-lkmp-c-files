...
position p;
@@
 const struct zx_crtc_regs cocci_id@p ;
...
position p;
@@
 const struct vou_layer_bits * cocci_id@p ;
...
typedef u32;
@@
 struct zx_crtc_regs {  u32 fir_active ;  u32 fir_htiming ;  u32 fir_vtiming ;  u32 sec_vtiming ;  u32 timing_shift ;  u32 timing_pi_shift ; } cocci_id@p ;
...
position p;
@@
 enum vou_inf_data_sel { VOU_YUV444 = 0 , VOU_RGB_101010 = 1 , VOU_RGB_888 = 2 , VOU_RGB_666 = 3 , } cocci_id@p ;
...
position p;
@@
 struct vou_div_config * cocci_id@p ;
...
position p;
@@
 enum vou_chn_type { VOU_CHN_MAIN , VOU_CHN_AUX , } cocci_id@p ;
...
position p;
@@
 const struct vou_layer_bits cocci_id@p [ VL_NUM ] ;
...
position p;
@@
 const struct zx_crtc_bits cocci_id@p ;
...
typedef u32;
@@
 struct vou_layer_bits {  u32 enable ;  u32 chnsel ;  u32 clksel ; } cocci_id@p ;
...
position p;
@@
 const struct vou_layer_bits cocci_id@p [ GL_NUM ] ;
...
position p;
@@
 struct zx_crtc {  struct drm_crtc crtc ;  struct drm_plane * primary ;  struct zx_vou_hw * vou ;  void __iomem * chnreg ;  void __iomem * chncsc ;  void __iomem * dither ;  const struct zx_crtc_regs * regs ;  const struct zx_crtc_bits * bits ;  enum vou_chn_type chn_type ;  struct clk * pixclk ; } cocci_id@p ;
...
position p;
@@
 enum vou_inf_hdmi_audio cocci_id@p ;
...
typedef u32;
@@
 struct vou_inf {  enum vou_inf_id id ;  enum vou_inf_data_sel data_sel ;  u32 clocks_en_bits ;  u32 clocks_sel_bits ; } cocci_id@p ;
...
position p;
@@
 struct zx_vou_hw {  struct device * dev ;  void __iomem * osd ;  void __iomem * timing ;  void __iomem * vouctl ;  void __iomem * otfppu ;  void __iomem * dtrc ;  struct clk * axi_clk ;  struct clk * ppu_clk ;  struct clk * main_clk ;  struct clk * aux_clk ;  struct zx_crtc * main_crtc ;  struct zx_crtc * aux_crtc ; } cocci_id@p ;
