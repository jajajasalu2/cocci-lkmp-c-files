...
position p;
@@
 struct dfll_rate_req cocci_id@p ;
...
typedef u8;
@@
 struct dfll_rate_req {  unsigned long rate ;  unsigned long dvco_target_rate ;  int lut_index ;  u8 mult_bits ;  u8 scale_bits ; } cocci_id@p ;
...
position p;
@@
 enum dfll_ctrl_mode cocci_id@p ;
...
position p;
@@
 enum tegra_dfll_pmu_if { TEGRA_DFLL_PMU_I2C = 0 , TEGRA_DFLL_PMU_PWM = 1 , } cocci_id@p ;
...
position p;
@@
 enum dfll_tune_range { DFLL_TUNE_UNINITIALIZED = 0 , DFLL_TUNE_LOW = 1 , } cocci_id@p ;
...
position p;
@@
 enum dfll_ctrl_mode { DFLL_UNINITIALIZED = 0 , DFLL_DISABLED = 1 , DFLL_OPEN_LOOP = 2 , DFLL_CLOSED_LOOP = 3 , } cocci_id@p ;
...
position p;
@@
 struct tegra_dfll_soc_data * cocci_id@p ;
