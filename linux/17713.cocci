...
position p;
@@
 struct addr_range {  void * addr ;  unsigned long size ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kernel_entry_t;
@@
 kernel_entry_t cocci_id@p ;
...
position p;
@@
 struct platform_ops cocci_id@p ;
