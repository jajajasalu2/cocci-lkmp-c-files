...
typedef u32;
@@
 u32 cocci_id@p ( struct gk104_clk * , u32 ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct gk104_clk * , int , u32 , u32 ) ;
...
typedef u32;
@@
 struct gk104_clk_info {  u32 freq ;  u32 ssel ;  u32 mdiv ;  u32 dsrc ;  u32 ddiv ;  u32 coef ; } cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 mask ;  void ( * exec ) ( struct gk104_clk * , int ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct gk104_clk {  struct nvkm_clk base ;  struct gk104_clk_info eng [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 struct gk104_clk_info * cocci_id@p ;
