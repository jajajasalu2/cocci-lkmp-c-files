...
position p;
@@
 char cocci_id@p [ USB251XB_I2C_REG_SZ ] ;
...
position p;
@@
 const struct usb251xb_data cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct usb251xb_data {  u16 product_id ;  u8 port_cnt ;  bool led_support ;  bool bat_support ;  char product_str [ USB251XB_STRING_BUFSIZE / 2 ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ USB251XB_I2C_WRITE_SZ + 1 ] ;
...
position p;
@@
 char cocci_id@p [ USB251XB_STRING_BUFSIZE / 2 ] ;
...
position p;
@@
 struct usb251xb_data * cocci_id@p ;
