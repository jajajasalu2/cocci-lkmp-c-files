...
position p;
@@
 struct kvaser_cmd_ext cocci_id@p ;
...
position p;
@@
 const struct kvaser_cmd_ext * cocci_id@p ;
...
position p;
@@
 const struct can_berr_counter * cocci_id@p ;
...
position p;
@@
 const struct kvaser_err_frame_data * cocci_id@p ;
...
position p;
@@
 struct kvaser_usb_dev_card_data_hydra * cocci_id@p ;
