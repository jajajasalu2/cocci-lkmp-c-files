...
position p;
@@
 const struct {  const char * name ;  unsigned int mctrl ;  enum gpiod_flags flags ; } cocci_id@p [ UART_GPIO_MAX ] ;
...
typedef bool;
@@
 struct mctrl_gpios {  struct uart_port * port ;  struct gpio_desc * gpio [ UART_GPIO_MAX ] ;  int irq [ UART_GPIO_MAX ] ;  unsigned int mctrl_prev ;  bool mctrl_on ; } cocci_id@p ;
...
position p;
@@
 struct gpio_desc * cocci_id@p [ UART_GPIO_MAX ] ;
