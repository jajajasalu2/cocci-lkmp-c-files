...
position p;
@@
 struct mlxcpld_led_priv cocci_id@p ;
...
typedef spinlock_t;
@@
 struct mlxcpld_led_pdata {  struct platform_device * pdev ;  struct mlxcpld_led_priv * pled ;  struct mlxcpld_led_profile * profile ;  int num_led_instances ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct mlxcpld_led_pdata * cocci_id@p ;
...
position p;
@@
 struct mlxcpld_led_profile cocci_id@p [ ] ;
...
position p;
@@
 enum mlxcpld_led_platform_types { MLXCPLD_LED_PLATFORM_DEFAULT , MLXCPLD_LED_PLATFORM_MSN2100 , } cocci_id@p ;
...
typedef u8;
@@
 struct mlxcpld_param {  u8 offset ;  u8 mask ;  u8 base_color ; } cocci_id@p ;
...
position p;
@@
 enum mlxcpld_led_platform_types cocci_id@p ;
...
position p;
@@
 struct mlxcpld_led_priv {  struct led_classdev cdev ;  struct mlxcpld_param param ; } cocci_id@p ;
...
typedef u8;
@@
 struct mlxcpld_led_profile {  u8 offset ;  u8 mask ;  u8 base_color ;  enum led_brightness brightness ;  const char * name ; } cocci_id@p ;
