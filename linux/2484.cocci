...
typedef u64;
@@
 struct hidma_mgmt_fileinfo {  char * name ;  int mode ;  int ( * get ) ( struct hidma_mgmt_dev * mdev ) ;  int ( * set ) ( struct hidma_mgmt_dev * mdev , u64 val ) ; } cocci_id@p ;
...
position p;
@@
 struct hidma_mgmt_dev * cocci_id@p ;
...
position p;
@@
 struct hidma_chan_attr {  struct hidma_mgmt_dev * mdev ;  int index ;  struct kobj_attribute attr ; } cocci_id@p ;
...
position p;
@@
 struct hidma_mgmt_fileinfo cocci_id@p [ ] ;
...
position p;
@@
 struct hidma_chan_attr * cocci_id@p ;
