...
position p;
@@
 struct powr1220_data * cocci_id@p ;
...
typedef bool;
@@
 struct powr1220_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool adc_valid [ MAX_POWR1220_ADC_VALUES ] ;  unsigned long adc_last_updated [ MAX_POWR1220_ADC_VALUES ] ;  int adc_maxes [ MAX_POWR1220_ADC_VALUES ] ;  int adc_values [ MAX_POWR1220_ADC_VALUES ] ; } cocci_id@p ;
...
position p;
@@
 enum powr1220_adc_values { VMON1 , VMON2 , VMON3 , VMON4 , VMON5 , VMON6 , VMON7 , VMON8 , VMON9 , VMON10 , VMON11 , VMON12 , VCCA , VCCINP , MAX_POWR1220_ADC_VALUES , } cocci_id@p ;
