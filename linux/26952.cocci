...
position p;
@@
 struct nfs42_write_res * cocci_id@p ;
...
position p;
@@
 const struct nfs42_copy_args * cocci_id@p ;
...
position p;
@@
 const struct nl4_server * cocci_id@p ;
...
position p;
@@
 const struct nfs42_copy_notify_args * cocci_id@p ;
...
position p;
@@
 const struct nfs42_falloc_args * cocci_id@p ;
...
position p;
@@
 struct nfs42_layouterror_res * cocci_id@p ;
...
position p;
@@
 const struct nfs42_offload_status_args * cocci_id@p ;
...
position p;
@@
 const struct nfs42_layouterror_args * cocci_id@p ;
...
position p;
@@
 struct nfs42_layoutstat_res * cocci_id@p ;
...
position p;
@@
 const struct nfs42_layoutstat_args * cocci_id@p ;
...
position p;
@@
 const struct nfs42_clone_args * cocci_id@p ;
...
position p;
@@
 const struct nfs42_device_error * cocci_id@p ;
...
position p;
@@
 const struct nfs42_seek_args * cocci_id@p ;
...
position p;
@@
 struct nfs42_offload_status_res * cocci_id@p ;
