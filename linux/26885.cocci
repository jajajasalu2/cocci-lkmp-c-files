...
position p;
@@
 const struct erofs_qstr * cocci_id@p ;
...
position p;
@@
 struct erofs_qstr {  const unsigned char * name ;  const unsigned char * end ; } cocci_id@p ;
...
position p;
@@
 struct erofs_dirent * cocci_id@p ;
...
position p;
@@
 struct erofs_dirent * const cocci_id@p ;
