...
position p;
@@
 struct iio_demux_table {  unsigned from ;  unsigned to ;  unsigned length ;  struct list_head l ; } cocci_id@p ;
...
position p;
@@
 struct iio_device_config cocci_id@p ;
...
typedef bool;
@@
 struct iio_device_config {  unsigned int mode ;  unsigned int watermark ;  const unsigned long * scan_mask ;  unsigned int scan_bytes ;  bool scan_timestamp ; } cocci_id@p ;
...
position p;
@@
 struct iio_demux_table * * cocci_id@p ;
