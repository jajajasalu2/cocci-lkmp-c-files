...
@@
 struct ipu_cpmem {  struct ipu_ch_param __iomem * base ;  u32 module ;  spinlock_t lock ;  int use_count ;  struct ipu_soc * ipu ; } cocci_id@p ;
...
typedef u32;
@@
 struct ipu_cpmem_word {  u32 data [ 5 ] ;  u32 res [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 const struct ipu_rgb cocci_id@p ;
...
position p;
@@
 struct ipu_ch_param {  struct ipu_cpmem_word word [ 2 ] ; } cocci_id@p ;
