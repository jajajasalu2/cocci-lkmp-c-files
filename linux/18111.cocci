...
position p;
@@
 struct locomo_save_data cocci_id@p ;
...
position p;
@@
 struct locomo_driver * cocci_id@p ;
...
position p;
@@
 struct locomo_dev_info {  unsigned long offset ;  unsigned long length ;  unsigned int devid ;  unsigned int irq [ 1 ] ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct locomo_dev_info * cocci_id@p ;
...
typedef u16;
@@
 struct locomo_save_data {  u16 LCM_GPO ;  u16 LCM_SPICT ;  u16 LCM_GPE ;  u16 LCM_ASD ;  u16 LCM_SPIMD ; } cocci_id@p ;
