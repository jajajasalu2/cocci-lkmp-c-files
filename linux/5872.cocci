...
typedef u32;
@@
 struct exynos_eint_gpio_save {  u32 eint_con ;  u32 eint_fltcon0 ;  u32 eint_fltcon1 ; } cocci_id@p ;
...
position p;
@@
 struct exynos_irq_chip * cocci_id@p ;
...
position p;
@@
 struct samsung_pin_bank * cocci_id@p ;
...
position p;
@@
 const struct samsung_retention_data * cocci_id@p ;
...
position p;
@@
 struct samsung_retention_ctrl * cocci_id@p ;
...
position p;
@@
 struct exynos_eint_gpio_save * cocci_id@p ;
...
position p;
@@
 struct exynos_muxed_weint_data * cocci_id@p ;
...
position p;
@@
 const struct exynos_irq_chip cocci_id@p ;
...
position p;
@@
 const struct samsung_pin_bank_type * cocci_id@p ;
...
position p;
@@
 struct exynos_weint_data * cocci_id@p ;
...
position p;
@@
 struct samsung_pinctrl_drv_data * cocci_id@p ;
...
typedef u32;
@@
 struct exynos_irq_chip {  struct irq_chip chip ;  u32 eint_con ;  u32 eint_mask ;  u32 eint_pend ;  u32 eint_wake_mask_value ;  u32 eint_wake_mask_reg ; } cocci_id@p ;
