...
position p;
@@
 struct dib3000mc_state * cocci_id@p ;
...
position p;
@@
 struct dib3000mc_config * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct dib3000mc_state {  struct dvb_frontend demod ;  struct dib3000mc_config * cfg ;  u8 i2c_addr ;  struct i2c_adapter * i2c_adap ;  struct dibx000_i2c_master i2c_master ;  u32 timf ;  u32 current_bandwidth ;  u16 dev_id ;  u8 sfn_workaround_active : 1 ; } cocci_id@p ;
