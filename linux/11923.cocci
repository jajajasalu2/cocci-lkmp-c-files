...
position p;
@@
 struct nv04_gr_chan * cocci_id@p ;
...
typedef u32;
@@
 struct nv04_gr_chan {  struct nvkm_object object ;  struct nv04_gr * gr ;  int chid ;  u32 nv04 [ ARRAY_SIZE ( nv04_gr_ctx_regs ) ] ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct nv04_gr {  struct nvkm_gr base ;  struct nv04_gr_chan * chan [ 16 ] ;  spinlock_t lock ; } cocci_id@p ;
...
typedef bool,u32;
@@
 bool ( * cocci_id@p ) ( struct nvkm_device * , u32 , u32 ) ;
...
typedef bool,u32;
@@
 bool ( * cocci_id@p ) ( struct nvkm_device * , u32 , u32 , u32 ) ;
