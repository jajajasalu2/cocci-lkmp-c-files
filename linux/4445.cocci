...
position p;
@@
 struct octeon_rng {  struct hwrng ops ;  void __iomem * control_status ;  void __iomem * result ; } cocci_id@p ;
...
position p;
@@
 union cvmx_rnm_ctl_status cocci_id@p ;
