...
position p;
@@
 struct ef4_loopback_payload * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ EF4_MAX_CHANNELS ] ;
...
@@
 struct ef4_loopback_state {  bool flush ;  int packet_count ;  struct sk_buff * * skbs ;  bool offload_csum ;  atomic_t rx_good ;  atomic_t rx_bad ;  struct ef4_loopback_payload payload ; } cocci_id@p ;
...
position p;
@@
 struct ef4_loopback_state * cocci_id@p ;
