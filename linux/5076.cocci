...
position p;
@@
 struct lpc18xx_gpio_pin_ic {  void __iomem * base ;  struct irq_domain * domain ;  struct raw_spinlock lock ; } cocci_id@p ;
...
position p;
@@
 struct lpc18xx_gpio_chip * cocci_id@p ;
...
position p;
@@
 struct lpc18xx_gpio_pin_ic * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct lpc18xx_gpio_chip {  struct gpio_chip gpio ;  void __iomem * base ;  struct clk * clk ;  struct lpc18xx_gpio_pin_ic * pin_ic ;  spinlock_t lock ; } cocci_id@p ;
