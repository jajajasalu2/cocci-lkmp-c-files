...
typedef u8;
@@
 u8 cocci_id@p [ HCLGE_RSS_MBX_RESP_LEN ] ;
...
position p;
@@
 struct hclge_cmq_ring * cocci_id@p ;
...
position p;
@@
 struct hclge_mbx_pf_to_vf_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_vf_vlan_cfg * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HCLGE_TQPS_DEPTH_INFO_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ HCLGE_TQPS_RSS_INFO_LEN ] ;
