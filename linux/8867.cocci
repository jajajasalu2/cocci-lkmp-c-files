...
position p;
@@
 struct hinic_sq_ctxt_block * cocci_id@p ;
...
position p;
@@
 struct hinic_rq_ctxt_block * cocci_id@p ;
...
position p;
@@
 struct hinic_clean_queue_ctxt * cocci_id@p ;
...
position p;
@@
 struct hinic_free_db_area * cocci_id@p ;
...
position p;
@@
 enum io_cmd { IO_CMD_MODIFY_QUEUE_CTXT = 0 , IO_CMD_CLEAN_QUEUE_CTXT , } cocci_id@p ;
