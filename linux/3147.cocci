...
position p;
@@
 const struct tb_path_hop * cocci_id@p ;
...
position p;
@@
 const struct tb_path * cocci_id@p ;
...
position p;
@@
 const struct tb_regs_hop * cocci_id@p ;
