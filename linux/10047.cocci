...
position p;
@@
 struct rt2x00lib_erp * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ TX_PWR_CFG_IDX_COUNT ] ;
...
position p;
@@
 struct txdone_entry_desc cocci_id@p ;
...
position p;
@@
 struct mac_wcid_entry cocci_id@p ;
...
position p;
@@
 struct rt2x00lib_crypto * cocci_id@p ;
...
position p;
@@
 struct rt2x00intf_conf * cocci_id@p ;
...
position p;
@@
 struct rt2800_drv_data * cocci_id@p ;
...
position p;
@@
 const struct rt2x00debug cocci_id@p ;
...
position p;
@@
 struct hw_mode_spec * cocci_id@p ;
...
position p;
@@
 struct rt2x00_field32 cocci_id@p ;
...
position p;
@@
 struct rxdone_entry_desc * cocci_id@p ;
...
position p;
@@
 const struct rf_channel cocci_id@p [ ] ;
...
position p;
@@
 struct rt2x00lib_conf * cocci_id@p ;
...
position p;
@@
 struct txentry_desc * cocci_id@p ;
...
position p;
@@
 struct mac_iveiv_entry cocci_id@p ;
...
position p;
@@
 struct hw_key_entry cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ EEPROM_WORD_COUNT ] ;
...
position p;
@@
 struct channel_info * cocci_id@p ;
...
position p;
@@
 struct antenna_setup * cocci_id@p ;
...
position p;
@@
 struct skb_frame_desc * cocci_id@p ;
...
position p;
@@
 const enum rt2800_eeprom_word cocci_id@p ;
