...
position p;
@@
 const struct sh_veu_format * cocci_id@p ;
...
typedef bool;
@@
 struct sh_veu_file {  struct v4l2_fh fh ;  struct sh_veu_dev * veu_dev ;  bool cfg_needed ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * priv , struct vb2_queue * src_vq , struct vb2_queue * dst_vq ) ;
...
position p;
@@
 enum sh_veu_fmt_idx { SH_VEU_FMT_NV12 , SH_VEU_FMT_NV16 , SH_VEU_FMT_NV24 , SH_VEU_FMT_RGB332 , SH_VEU_FMT_RGB444 , SH_VEU_FMT_RGB565 , SH_VEU_FMT_RGB666 , SH_VEU_FMT_RGB24 , } cocci_id@p ;
...
position p;
@@
 struct sh_veu_vfmt {  struct v4l2_rect frame ;  unsigned int bytesperline ;  unsigned int offset_y ;  unsigned int offset_c ;  const struct sh_veu_format * fmt ; } cocci_id@p ;
...
typedef u32;
@@
 struct sh_veu_format {  u32 fourcc ;  unsigned int depth ;  unsigned int ydepth ; } cocci_id@p ;
...
@@
 struct sh_veu_dev {  struct v4l2_device v4l2_dev ;  struct video_device vdev ;  struct v4l2_m2m_dev * m2m_dev ;  struct device * dev ;  struct v4l2_m2m_ctx * m2m_ctx ;  struct sh_veu_vfmt vfmt_out ;  struct sh_veu_vfmt vfmt_in ;  struct sh_veu_file * capture ;  struct sh_veu_file * output ;  struct mutex fop_lock ;  void __iomem * base ;  spinlock_t lock ;  bool is_2h ;  unsigned int xaction ;  bool aborting ; } cocci_id@p ;
