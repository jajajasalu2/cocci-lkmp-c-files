...
position p;
@@
 struct dprc_cmd_get_irq_status * cocci_id@p ;
...
position p;
@@
 const struct dprc_endpoint * cocci_id@p ;
...
position p;
@@
 struct dprc_cmd_set_irq_mask * cocci_id@p ;
...
position p;
@@
 struct dprc_cmd_get_obj * cocci_id@p ;
...
position p;
@@
 struct dprc_rsp_get_irq_status * cocci_id@p ;
...
position p;
@@
 struct dprc_cmd_set_irq_enable * cocci_id@p ;
...
position p;
@@
 struct dprc_cmd_set_obj_irq * cocci_id@p ;
...
position p;
@@
 struct dprc_rsp_get_obj_region * cocci_id@p ;
...
position p;
@@
 struct dprc_rsp_get_obj_count * cocci_id@p ;
...
position p;
@@
 struct dprc_cmd_clear_irq_status * cocci_id@p ;
...
position p;
@@
 struct dprc_rsp_get_obj * cocci_id@p ;
...
position p;
@@
 struct dprc_cmd_get_obj_region * cocci_id@p ;
...
position p;
@@
 struct dprc_cmd_get_connection * cocci_id@p ;
...
position p;
@@
 struct dprc_cmd_open * cocci_id@p ;
...
position p;
@@
 struct dprc_rsp_get_connection * cocci_id@p ;
...
position p;
@@
 struct dprc_rsp_get_attributes * cocci_id@p ;
...
position p;
@@
 struct dprc_cmd_set_irq * cocci_id@p ;
...
position p;
@@
 struct dprc_irq_cfg * cocci_id@p ;
