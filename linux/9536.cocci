...
typedef u8;
@@
 const u8 cocci_id@p [ 8 ] [ INDEX_MAPPING_NUM ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ 5 ] [ INDEX_MAPPING_NUM ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ RX_INDEX_MAPPING_NUM ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ OFDM_TABLE_SIZE_92D ] ;
