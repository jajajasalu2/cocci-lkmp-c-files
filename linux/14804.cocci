...
position p;
@@
 struct raw_notifier_head * cocci_id@p ;
...
position p;
@@
 const struct cpg_core_clk * cocci_id@p ;
...
position p;
@@
 struct rpcd2_clock {  struct clk_fixed_factor fixed ;  struct clk_gate gate ; } cocci_id@p ;
...
position p;
@@
 struct cpg_z_clk {  struct clk_hw hw ;  void __iomem * reg ;  void __iomem * kick_reg ;  unsigned long mask ;  unsigned int fixed_div ; } cocci_id@p ;
...
position p;
@@
 const struct sd_div_table cocci_id@p [ ] ;
...
position p;
@@
 struct cpg_simple_notifier cocci_id@p ;
...
position p;
@@
 struct rpc_clock {  struct clk_divider div ;  struct clk_gate gate ;  struct cpg_simple_notifier csn ; } cocci_id@p ;
...
position p;
@@
 struct sd_clock {  struct clk_hw hw ;  const struct sd_div_table * div_table ;  struct cpg_simple_notifier csn ;  unsigned int div_num ;  unsigned int cur_div_idx ; } cocci_id@p ;
...
typedef u32;
@@
 struct sd_div_table {  u32 val ;  unsigned int div ; } cocci_id@p ;
...
typedef u32;
@@
 struct cpg_simple_notifier {  struct notifier_block nb ;  void __iomem * reg ;  u32 saved ; } cocci_id@p ;
