...
position p;
@@
 struct topology_core * cocci_id@p ;
...
typedef cpumask_t;
@@
 struct mask_info {  struct mask_info * next ;  unsigned char id ;  cpumask_t mask ; } cocci_id@p ;
...
position p;
@@
 struct topology_container * cocci_id@p ;
...
position p;
@@
 struct cpu_topology_s390 cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct cpu_topology_s390 * cocci_id@p ;
...
position p;
@@
 enum { TOPOLOGY_MODE_HW , TOPOLOGY_MODE_SINGLE , TOPOLOGY_MODE_PACKAGE , TOPOLOGY_MODE_UNINITIALIZED , } cocci_id@p ;
...
position p;
@@
 struct sysinfo_15_1_x * cocci_id@p ;
...
position p;
@@
 union topology_entry * cocci_id@p ;
