...
position p;
@@
 struct wb_completion * cocci_id@p ;
...
position p;
@@
 struct wb_lock_cookie cocci_id@p ;
...
position p;
@@
 struct wb_writeback_work cocci_id@p ;
...
position p;
@@
 struct inode_switch_wbs_context * cocci_id@p ;
...
position p;
@@
 struct wb_writeback_work {  long nr_pages ;  struct super_block * sb ;  unsigned long * older_than_this ;  enum writeback_sync_modes sync_mode ;  unsigned int tagged_writepages : 1 ;  unsigned int for_kupdate : 1 ;  unsigned int range_cyclic : 1 ;  unsigned int for_background : 1 ;  unsigned int for_sync : 1 ;  unsigned int auto_free : 1 ;  enum wb_reason reason ;  struct list_head list ;  struct wb_completion * done ; } cocci_id@p ;
...
position p;
@@
 struct inode_switch_wbs_context {  struct inode * inode ;  struct bdi_writeback * new_wb ;  struct rcu_head rcu_head ;  struct work_struct work ; } cocci_id@p ;
