...
position p;
@@
 struct cpl_rx_iscsi_ddp * cocci_id@p ;
...
position p;
@@
 union cxgbit_skb_cb cocci_id@p ;
...
position p;
@@
 struct cpl_iscsi_data * cocci_id@p ;
...
position p;
@@
 struct cxgbit_dcb_work cocci_id@p ;
...
position p;
@@
 struct cxgbit_dcb_work {  struct dcb_app_type dcb_app ;  struct work_struct work ; } cocci_id@p ;
