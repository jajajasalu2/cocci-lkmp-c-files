...
position p;
@@
 struct hdmi_pll_8960 * cocci_id@p ;
...
typedef u32;
@@
 struct pll_rate {  unsigned long rate ;  int num_reg ;  struct {  u32 val ;  u32 reg ; } conf [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct hdmi_pll_8960 {  struct platform_device * pdev ;  struct clk_hw clk_hw ;  void __iomem * mmio ;  unsigned long pixclk ; } cocci_id@p ;
