...
position p;
@@
 const struct sock_diag_handler * cocci_id@p [ AF_MAX ] ;
...
position p;
@@
 struct broadcast_sk {  struct sock * sk ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct sock_diag_req * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sk_buff * skb , struct nlmsghdr * nlh ) ;
...
position p;
@@
 struct broadcast_sk * cocci_id@p ;
...
position p;
@@
 const enum sknetlink_groups cocci_id@p ;
