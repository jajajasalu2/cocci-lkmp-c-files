...
position p;
@@
 void cocci_id@p ( struct vnt_private * priv ) ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pcid , const struct pci_device_id * ent ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct vnt_private * , struct vnt_rx_desc * ) ;
...
position p;
@@
 int cocci_id@p ( struct vnt_private * priv ) ;
...
position p;
@@
 int cocci_id@p ( struct vnt_private * priv , unsigned int idx ) ;
...
position p;
@@
 void cocci_id@p ( struct vnt_private * , struct vnt_tx_desc * ) ;
...
position p;
@@
 void cocci_id@p ( struct vnt_private * priv , struct vnt_rx_desc * rd ) ;
