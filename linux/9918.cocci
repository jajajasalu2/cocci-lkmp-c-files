...
position p;
@@
 struct htc_service_connect_req * cocci_id@p ;
...
position p;
@@
 struct htc_credit_report cocci_id@p ;
...
position p;
@@
 struct htc_record_hdr cocci_id@p ;
...
position p;
@@
 enum htc_credit_dist_reason cocci_id@p ;
...
position p;
@@
 struct htc_setup_comp_msg * cocci_id@p ;
...
position p;
@@
 struct htc_endpoint_credit_dist * cocci_id@p ;
...
position p;
@@
 struct htc_frame_hdr * cocci_id@p ;
...
position p;
@@
 struct ath6kl_htc_credit_info * cocci_id@p ;
...
position p;
@@
 struct htc_ready_ext_msg * cocci_id@p ;
...
position p;
@@
 struct htc_endpoint * cocci_id@p ;
...
position p;
@@
 struct hif_scatter_req * cocci_id@p ;
...
position p;
@@
 struct htc_setup_comp_ext_msg cocci_id@p ;
...
position p;
@@
 struct htc_ep_callbacks cocci_id@p ;
...
position p;
@@
 struct htc_bundle_lkahd_rpt * cocci_id@p ;
...
position p;
@@
 struct htc_conn_service_msg * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ HTC_HOST_MAX_MSG_PER_BUNDLE ] ;
...
position p;
@@
 void cocci_id@p ( struct htc_target * target ) ;
...
position p;
@@
 struct htc_lookahead_report * cocci_id@p ;
...
position p;
@@
 struct htc_conn_service_resp * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct htc_target * target , struct list_head * pkt_queue ) ;
...
position p;
@@
 struct htc_service_connect_resp cocci_id@p ;
...
position p;
@@
 struct htc_ready_msg cocci_id@p ;
...
position p;
@@
 struct ath6kl_device * cocci_id@p ;
...
position p;
@@
 const struct ath6kl_htc_ops cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct htc_target * target , struct ath6kl_htc_credit_info * cred_info , u16 svc_pri_order [ ] , int len ) ;
