...
position p;
@@
 struct kvmppc_uvmem_page_pvt * cocci_id@p ;
...
typedef bool;
@@
 struct kvmppc_uvmem_page_pvt {  struct kvm * kvm ;  unsigned long gpa ;  bool skip_page_out ; } cocci_id@p ;
...
position p;
@@
 struct kvmppc_uvmem_slot * cocci_id@p ;
...
position p;
@@
 struct kvmppc_uvmem_slot {  struct list_head list ;  unsigned long nr_pfns ;  unsigned long base_pfn ;  unsigned long * pfns ; } cocci_id@p ;
