...
typedef u64,u32;
@@
 struct ppc4xx_hsta_msi {  struct device * dev ;  u32 __iomem * data ;  u64 address ;  struct msi_bitmap bmp ;  int * irq_map ;  int irq_count ; } cocci_id@p ;
...
position p;
@@
 struct ppc4xx_hsta_msi cocci_id@p ;
