...
position p;
@@
 struct minstrel_mcs_group_data * cocci_id@p ;
...
position p;
@@
 struct minstrel_priv * cocci_id@p ;
...
position p;
@@
 struct minstrel_rate_stats * cocci_id@p ;
...
position p;
@@
 struct minstrel_ht_sta_priv * cocci_id@p ;
...
position p;
@@
 struct minstrel_ht_sta * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct minstrel_priv * mp , struct minstrel_ht_sta * mi ) ;
...
position p;
@@
 struct minstrel_rate cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ MINSTREL_GROUPS_NB ] ;
...
position p;
@@
 struct ieee80211_tx_status * cocci_id@p ;
