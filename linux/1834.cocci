...
position p;
@@
 struct at91_adc_state cocci_id@p ;
...
position p;
@@
 const struct at91_adc_trigger cocci_id@p [ ] ;
...
position p;
@@
 struct at91_adc_soc_info {  unsigned startup_time ;  unsigned min_sample_rate ;  unsigned max_sample_rate ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,s64,phys_addr_t,dma_addr_t;
@@
 struct at91_adc_dma {  struct dma_chan * dma_chan ;  u8 * rx_buf ;  dma_addr_t rx_dma_buf ;  phys_addr_t phys_addr ;  int buf_idx ;  int rx_buf_sz ;  int watermark ;  s64 dma_ts ; } cocci_id@p ;
...
position p;
@@
 struct at91_adc_touch * cocci_id@p ;
...
typedef bool;
@@
 struct at91_adc_trigger {  char * name ;  unsigned int trgmod_value ;  unsigned int edge_type ;  bool hw_trig ; } cocci_id@p ;
...
typedef bool,u16;
@@
 struct at91_adc_touch {  u16 sample_period_val ;  bool touching ;  u16 x_pos ;  unsigned long channels_bitmask ;  struct work_struct workq ; } cocci_id@p ;
