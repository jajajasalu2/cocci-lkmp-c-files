...
position p;
@@
 struct mdio_board_info cocci_id@p ;
...
position p;
@@
 struct dsa_chip_data * cocci_id@p ;
...
position p;
@@
 struct mv_xor_channel_data cocci_id@p [ 2 ] ;
...
position p;
@@
 struct orion_ehci_data cocci_id@p ;
...
position p;
@@
 enum orion_ehci_phy_ver cocci_id@p ;
