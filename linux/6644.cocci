...
position p;
@@
 struct qed_mfw_tlv_fcoe * cocci_id@p ;
...
position p;
@@
 struct qedf_skb_work cocci_id@p ;
...
position p;
@@
 struct qedf_io_work cocci_id@p ;
...
position p;
@@
 struct qed_fcoe_stats cocci_id@p ;
...
position p;
@@
 struct qed_fcoe_cb_ops cocci_id@p ;
...
position p;
@@
 struct qedf_fastpath * cocci_id@p ;
...
position p;
@@
 struct qed_dcbx_get * cocci_id@p ;
...
position p;
@@
 struct global_queue cocci_id@p ;
...
position p;
@@
 struct qed_fcoe_params_offload cocci_id@p ;
...
position p;
@@
 struct qed_ll2_cb_ops cocci_id@p ;
...
position p;
@@
 struct qedf_glbl_q_params cocci_id@p ;
...
position p;
@@
 const struct qed_fcoe_ops * cocci_id@p ;
