...
position p;
@@
 struct cpcap_phy_ddata cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cpcap_phy_ddata * ddata ) ;
...
typedef atomic_t;
@@
 struct cpcap_phy_ddata {  struct regmap * reg ;  struct device * dev ;  struct clk * refclk ;  struct usb_phy phy ;  struct delayed_work detect_work ;  struct pinctrl * pins ;  struct pinctrl_state * pins_ulpi ;  struct pinctrl_state * pins_utmi ;  struct pinctrl_state * pins_uart ;  struct gpio_desc * gpio [ 2 ] ;  struct iio_channel * vbus ;  struct iio_channel * id ;  struct regulator * vusb ;  atomic_t active ; } cocci_id@p ;
...
position p;
@@
 enum cpcap_gpio_mode cocci_id@p ;
...
position p;
@@
 enum cpcap_gpio_mode { CPCAP_DM_DP , CPCAP_MDM_RX_TX , CPCAP_UNKNOWN , CPCAP_OTG_DM_DP , } cocci_id@p ;
...
position p;
@@
 struct cpcap_usb_ints_state cocci_id@p ;
...
typedef bool;
@@
 struct cpcap_usb_ints_state {  bool id_ground ;  bool id_float ;  bool chrg_det ;  bool rvrs_chrg ;  bool vbusov ;  bool chrg_se1b ;  bool se0conn ;  bool rvrs_mode ;  bool chrgcurr1 ;  bool vbusvld ;  bool sessvld ;  bool sessend ;  bool se1 ;  bool battdetb ;  bool dm ;  bool dp ; } cocci_id@p ;
