...
position p;
@@
 struct x38_dev_info {  const char * ctl_name ; } cocci_id@p ;
...
position p;
@@
 struct x38_error_info cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ X38_CHANNELS ] [ X38_RANKS_PER_CHANNEL ] ;
...
position p;
@@
 enum x38_chips { X38 = 0 , } cocci_id@p ;
...
position p;
@@
 const struct x38_dev_info cocci_id@p [ ] ;
...
typedef u64,u16;
@@
 struct x38_error_info {  u16 errsts ;  u16 errsts2 ;  u64 eccerrlog [ X38_CHANNELS ] ; } cocci_id@p ;
