...
position p;
@@
 struct ak4458_drvdata {  struct snd_soc_dai_driver * dai_drv ;  const struct snd_soc_component_driver * comp_drv ; } cocci_id@p ;
...
position p;
@@
 const struct ak4458_drvdata cocci_id@p ;
...
position p;
@@
 struct ak4458_priv {  struct device * dev ;  struct regmap * regmap ;  struct gpio_desc * reset_gpiod ;  struct gpio_desc * mute_gpiod ;  int digfil ;  int fs ;  int fmt ;  int slots ;  int slot_width ; } cocci_id@p ;
