...
typedef u8,u16;
@@
 struct i2c_reg_u16 {  u8 reg ;  u16 val ; } cocci_id@p ;
...
position p;
@@
 const struct i2c_reg_u16 * cocci_id@p ;
...
position p;
@@
 const struct i2c_reg_u8 cocci_id@p [ ] ;
...
typedef u8;
@@
 struct i2c_reg_u8 {  u8 reg ;  u8 val ; } cocci_id@p ;
