...
position p;
@@
 fs64 * cocci_id@p ( struct befs_btree_node * node ) ;
...
position p;
@@
 long long unsigned int cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , const befs_data_stream * ds , befs_btree_super * sup ) ;
...
position p;
@@
 struct befs_btree_node * cocci_id@p ;
...
position p;
@@
 befs_disk_btree_super * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct befs_btree_node * node ) ;
...
position p;
@@
 befs_btree_nodehead cocci_id@p ;
...
position p;
@@
 struct befs_btree_node {  befs_host_btree_nodehead head ;  struct buffer_head * bh ;  befs_btree_nodehead * od_node ; } cocci_id@p ;
...
typedef u16;
@@
 char * cocci_id@p ( struct super_block * sb , struct befs_btree_node * node , int index , u16 * keylen ) ;
...
position p;
@@
 fs16 * cocci_id@p ( struct befs_btree_node * node ) ;
...
position p;
@@
 int cocci_id@p ( const void * key1 , int keylen1 , const void * key2 , int keylen2 ) ;
...
position p;
@@
 char * cocci_id@p ( struct befs_btree_node * node ) ;
