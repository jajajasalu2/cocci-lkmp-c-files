...
position p;
@@
 unsigned int cocci_id@p [ MAX_NUM_DIO48E ] ;
...
position p;
@@
 const char * cocci_id@p [ DIO48E_NGPIO ] ;
...
@@
 struct dio48e_gpio {  struct gpio_chip chip ;  unsigned char io_state [ 6 ] ;  unsigned char out_state [ 6 ] ;  unsigned char control [ 2 ] ;  raw_spinlock_t lock ;  unsigned base ;  unsigned char irq_mask ; } cocci_id@p ;
...
position p;
@@
 struct dio48e_gpio * const cocci_id@p ;
