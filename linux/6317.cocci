...
typedef u8,u32;
@@
 union {  u8 bytes [ 4 ] ;  u32 word ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct sih_agent {  int irq_base ;  const struct sih * sih ;  u32 imr ;  bool imr_change_pending ;  u32 edge_change ;  struct mutex irq_lock ;  char * irq_name ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct sih {  char name [ 8 ] ;  u8 module ;  u8 control_offset ;  bool set_cor ;  u8 bits ;  u8 bytes_ixr ;  u8 edr_offset ;  u8 bytes_edr ;  u8 irq_lines ;  struct sih_irq_data {  u8 isr_offset ;  u8 imr_offset ; } mask [ 2 ] ; } cocci_id@p ;
...
typedef u8,u32;
@@
 union {  u32 word ;  u8 bytes [ 4 ] ; } cocci_id@p ;
