...
position p;
@@
 struct g12a_ephy_pll * cocci_id@p ;
...
position p;
@@
 struct g12a_ephy_pll {  void __iomem * base ;  struct clk_hw hw ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ PLL_MUX_NUM_PARENT ] ;
...
typedef bool;
@@
 struct g12a_mdio_mux {  bool pll_is_enabled ;  void __iomem * regs ;  void * mux_handle ;  struct clk * pclk ;  struct clk * pll ; } cocci_id@p ;
...
position p;
@@
 struct g12a_mdio_mux * cocci_id@p ;
