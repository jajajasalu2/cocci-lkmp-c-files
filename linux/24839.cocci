...
position p;
@@
 const struct xt_NFQ_info * cocci_id@p ;
...
position p;
@@
 const struct xt_NFQ_info_v1 * cocci_id@p ;
...
position p;
@@
 struct xt_NFQ_info_v2 cocci_id@p ;
...
position p;
@@
 struct xt_NFQ_info_v1 cocci_id@p ;
...
position p;
@@
 struct xt_NFQ_info_v3 cocci_id@p ;
...
position p;
@@
 const struct xt_NFQ_info_v2 * cocci_id@p ;
...
position p;
@@
 const struct xt_NFQ_info_v3 * cocci_id@p ;
