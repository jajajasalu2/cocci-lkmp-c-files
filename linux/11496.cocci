...
position p;
@@
 struct nvif_vmm_unmap_v0 cocci_id@p ;
...
position p;
@@
 struct nvif_vmm_put_v0 cocci_id@p ;
...
position p;
@@
 struct nvif_vmm_page_v0 cocci_id@p ;
...
position p;
@@
 struct nvif_vmm_map_v0 * cocci_id@p ;
...
position p;
@@
 struct nvif_vmm_get_v0 cocci_id@p ;
