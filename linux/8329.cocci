...
position p;
@@
 struct octnic_ctrl_pkt cocci_id@p ;
...
position p;
@@
 struct handshake {  struct completion init ;  struct completion started ;  struct pci_dev * pci_dev ;  int init_ok ;  int started_ok ; } cocci_id@p ;
...
position p;
@@
 union octnic_cmd_setup cocci_id@p ;
...
position p;
@@
 struct octeon_recv_info * cocci_id@p ;
...
position p;
@@
 struct lio_trusted_vf_ctx {  struct completion complete ;  int status ; } cocci_id@p ;
...
typedef u64;
@@
 struct oct_timestamp_resp {  u64 rh ;  u64 timestamp ;  u64 status ; } cocci_id@p ;
...
position p;
@@
 struct octnic_gather * cocci_id@p ;
...
position p;
@@
 struct lio_devlink_priv cocci_id@p ;
...
position p;
@@
 struct liquidio_if_cfg_resp * cocci_id@p ;
...
position p;
@@
 struct octeon_soft_command * cocci_id@p ;
...
position p;
@@
 struct octeon_instr_ih3 * cocci_id@p ;
...
position p;
@@
 struct octeon_instr_queue * cocci_id@p ;
...
position p;
@@
 struct oct_link_info * cocci_id@p ;
...
position p;
@@
 struct octeon_device * cocci_id@p ;
...
position p;
@@
 struct octeon_instr_ih2 * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ LIO_MAX_FW_TYPE_LEN ] ;
...
position p;
@@
 int cocci_id@p ( struct octeon_device * ) ;
...
typedef u64;
@@
 struct oct_link_status_resp {  u64 rh ;  struct oct_link_info link_info ;  u64 status ; } cocci_id@p ;
...
position p;
@@
 struct liquidio_if_cfg_info cocci_id@p ;
...
position p;
@@
 struct octeon_device_priv cocci_id@p ;
...
position p;
@@
 struct oct_timestamp_resp cocci_id@p ;
...
position p;
@@
 enum octnet_ifflags cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct octeon_device * oct , u32 console_num , char * prefix , char * suffix ) ;
...
position p;
@@
 struct octdev_props * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ LIO_MAX_FW_FILENAME_LEN ] ;
...
position p;
@@
 struct oct_droq_stats * cocci_id@p ;
...
position p;
@@
 struct octnet_buf_free_info * cocci_id@p ;
...
position p;
@@
 union oct_link_status * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * netdev , int vfidx , int linkstate ) ;
...
position p;
@@
 struct oct_vf_stats cocci_id@p ;
...
position p;
@@
 struct octeon_instr_irh * cocci_id@p ;
...
position p;
@@
 struct octnic_data_pkt cocci_id@p ;
...
position p;
@@
 struct octeon_recv_pkt * cocci_id@p ;
...
position p;
@@
 union oct_nic_if_cfg cocci_id@p ;
...
position p;
@@
 struct handshake cocci_id@p [ MAX_OCTEON_DEVICES ] ;
...
position p;
@@
 struct oct_iq_stats * cocci_id@p ;
