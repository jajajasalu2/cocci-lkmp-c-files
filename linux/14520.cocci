...
position p;
@@
 struct clk_si5341_output * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ SI5341_NUM_SYNTH ] ;
...
position p;
@@
 struct clk_si5341_output_config cocci_id@p [ SI5341_MAX_NUM_OUTPUTS ] ;
...
typedef u8;
@@
 struct clk_si5341_output {  struct clk_hw hw ;  struct clk_si5341 * data ;  u8 index ; } cocci_id@p ;
...
position p;
@@
 struct clk_si5341_output_config * cocci_id@p ;
...
position p;
@@
 const struct si5341_reg_default * cocci_id@p ;
...
typedef u8,u16;
@@
 struct si5341_reg_default {  u16 address ;  u8 value ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct clk_si5341_output_config {  u8 out_format_drv_bits ;  u8 out_cm_ampl_bits ;  bool synth_master ;  bool always_on ; } cocci_id@p ;
...
position p;
@@
 struct clk_si5341_synth cocci_id@p ;
...
typedef u8;
@@
 struct clk_si5341_synth {  struct clk_hw hw ;  struct clk_si5341 * data ;  u8 index ; } cocci_id@p ;
...
typedef u8,u64,u16;
@@
 struct clk_si5341 {  struct clk_hw hw ;  struct regmap * regmap ;  struct i2c_client * i2c_client ;  struct clk_si5341_synth synth [ SI5341_NUM_SYNTH ] ;  struct clk_si5341_output clk [ SI5341_MAX_NUM_OUTPUTS ] ;  struct clk * pxtal ;  const char * pxtal_name ;  const u16 * reg_output_offset ;  const u16 * reg_rdiv_offset ;  u64 freq_vco ;  u8 num_outputs ;  u8 num_synth ; } cocci_id@p ;
