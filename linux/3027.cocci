...
position p;
@@
 struct acpi_genl_event cocci_id@p ;
...
position p;
@@
 enum { ACPI_GENL_ATTR_UNSPEC , ACPI_GENL_ATTR_EVENT , __ACPI_GENL_ATTR_MAX , } cocci_id@p ;
...
typedef u32;
@@
 struct acpi_genl_event {  acpi_device_class device_class ;  char bus_id [ 15 ] ;  u32 type ;  u32 data ; } cocci_id@p ;
...
position p;
@@
 enum { ACPI_GENL_CMD_UNSPEC , ACPI_GENL_CMD_EVENT , __ACPI_GENL_CMD_MAX , } cocci_id@p ;
