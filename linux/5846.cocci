...
position p;
@@
 const struct {  struct sh_pfc_function common [ 51 ] ;  struct sh_pfc_function automotive [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct {  struct sh_pfc_pin_group common [ 318 ] ;  struct sh_pfc_pin_group automotive [ 30 ] ; } cocci_id@p ;
