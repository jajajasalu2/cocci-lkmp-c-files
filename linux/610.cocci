...
typedef u8;
@@
 void ( * cocci_id@p ) ( struct crypto_tfm * , u8 * , const u8 * ) ;
...
position p;
@@
 struct crypto_rfc3686_req_ctx cocci_id@p ;
...
position p;
@@
 struct crypto_rfc3686_ctx * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_CIPHER_BLOCKSIZE + MAX_CIPHER_ALIGNMASK ] ;
...
typedef u8;
@@
 struct crypto_rfc3686_ctx {  struct crypto_skcipher * child ;  u8 nonce [ CTR_RFC3686_NONCE_SIZE ] ; } cocci_id@p ;
