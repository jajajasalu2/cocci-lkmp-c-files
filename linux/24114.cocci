...
position p;
@@
 struct ip_map * cocci_id@p ( struct cache_detail * cd , char * class , struct in6_addr * addr ) ;
...
position p;
@@
 union {  struct sockaddr sa ;  struct sockaddr_in s4 ;  struct sockaddr_in6 s6 ; } cocci_id@p ;
...
position p;
@@
 struct unix_domain {  struct auth_domain h ; } cocci_id@p ;
...
position p;
@@
 struct ip_map {  struct cache_head h ;  char m_class [ 8 ] ;  struct in6_addr m_addr ;  struct unix_domain * m_client ;  struct rcu_head m_rcu ; } cocci_id@p ;
...
typedef kuid_t;
@@
 struct unix_gid {  struct cache_head h ;  kuid_t uid ;  struct group_info * gi ;  struct rcu_head rcu ; } cocci_id@p ;
