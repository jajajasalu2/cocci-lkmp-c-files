...
position p;
@@
 enum audit_ntp_type cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,kuid_t,pid_t;
@@
 struct audit_aux_data_pids {  struct audit_aux_data d ;  pid_t target_pid [ AUDIT_AUX_PIDS ] ;  kuid_t target_auid [ AUDIT_AUX_PIDS ] ;  kuid_t target_uid [ AUDIT_AUX_PIDS ] ;  unsigned int target_sessionid [ AUDIT_AUX_PIDS ] ;  u32 target_sid [ AUDIT_AUX_PIDS ] ;  char target_comm [ AUDIT_AUX_PIDS ] [ TASK_COMM_LEN ] ;  int pid_count ; } cocci_id@p ;
...
position p;
@@
 const struct audit_ntp_val * cocci_id@p ;
...
position p;
@@
 struct audit_aux_data_bprm_fcaps {  struct audit_aux_data d ;  struct audit_cap_data fcap ;  unsigned int fcap_ver ;  struct audit_cap_data old_pcap ;  struct audit_cap_data new_pcap ; } cocci_id@p ;
...
position p;
@@
 struct audit_tree_refs {  struct audit_tree_refs * next ;  struct audit_chunk * c [ 31 ] ; } cocci_id@p ;
...
position p;
@@
 const struct audit_krule * cocci_id@p ;
...
position p;
@@
 struct audit_aux_data {  struct audit_aux_data * next ;  int type ; } cocci_id@p ;
...
position p;
@@
 struct audit_context * cocci_id@p ;
...
position p;
@@
 struct audit_tree_refs * cocci_id@p ;
...
position p;
@@
 struct audit_aux_data_pids * cocci_id@p ;
...
position p;
@@
 struct cpu_vfs_cap_data cocci_id@p ;
...
position p;
@@
 const struct audit_ntp_data * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( current -> comm ) ] ;
...
position p;
@@
 struct audit_aux_data * cocci_id@p ;
...
position p;
@@
 struct audit_aux_data_bprm_fcaps * cocci_id@p ;
