...
position p;
@@
 enum g760a_regs { G760A_REG_SET_CNT = 0x00 , G760A_REG_ACT_CNT = 0x01 , G760A_REG_FAN_STA = 0x02 , } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct g760a_data {  struct i2c_client * client ;  struct mutex update_lock ;  u32 clk ;  u16 fan_div ;  unsigned int valid : 1 ;  unsigned long last_updated ;  u8 set_cnt ;  u8 act_cnt ;  u8 fan_sta ; } cocci_id@p ;
