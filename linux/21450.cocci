...
position p;
@@
 struct user_sve_header * cocci_id@p ;
...
position p;
@@
 const struct user_pac_generic_keys * cocci_id@p ;
...
position p;
@@
 struct user_hwdebug_state cocci_id@p ;
...
position p;
@@
 struct user_pac_generic_keys * cocci_id@p ;
...
position p;
@@
 enum ptrace_syscall_dir { PTRACE_SYSCALL_ENTER = 0 , PTRACE_SYSCALL_EXIT , } cocci_id@p ;
...
position p;
@@
 struct user_pac_address_keys * cocci_id@p ;
...
position p;
@@
 const struct pt_regs_offset * cocci_id@p ;
...
position p;
@@
 struct user_pac_mask cocci_id@p ;
...
position p;
@@
 struct arch_hw_breakpoint_ctrl cocci_id@p ;
...
position p;
@@
 struct user_pt_regs cocci_id@p ;
...
position p;
@@
 enum ptrace_syscall_dir cocci_id@p ;
...
position p;
@@
 const struct user_pac_address_keys * cocci_id@p ;
...
position p;
@@
 enum compat_regset { REGSET_COMPAT_GPR , REGSET_COMPAT_VFP , } cocci_id@p ;
...
position p;
@@
 const struct ptrauth_keys * cocci_id@p ;
...
position p;
@@
 struct ptrauth_keys * cocci_id@p ;
...
position p;
@@
 struct pt_regs_offset {  const char * name ;  int offset ; } cocci_id@p ;
...
position p;
@@
 const struct user_sve_header * cocci_id@p ;
...
position p;
@@
 const struct ptrauth_key * cocci_id@p ;
