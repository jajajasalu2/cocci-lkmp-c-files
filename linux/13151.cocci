...
position p;
@@
 struct bttv_buffer_set * cocci_id@p ;
...
position p;
@@
 struct saa6588_command cocci_id@p ;
...
position p;
@@
 const struct bttv_tvnorm * cocci_id@p ;
...
position p;
@@
 const struct bttv_format cocci_id@p [ ] ;
...
position p;
@@
 struct btcx_riscmem * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ BTTV_MAX ] ;
...
position p;
@@
 struct bttv * cocci_id@p [ BTTV_MAX ] ;
