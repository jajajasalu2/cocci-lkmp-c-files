...
typedef spinlock_t;
@@
 struct simdisk {  const char * filename ;  spinlock_t lock ;  struct request_queue * queue ;  struct gendisk * gd ;  struct proc_dir_entry * procfile ;  int users ;  unsigned long size ;  int fd ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ MAX_SIMDISK_COUNT ] ;
