...
typedef u32,u16;
@@
 struct mlx5_flow_table * cocci_id@p ( struct mlx5_eswitch * esw , u32 chain , u16 prio , int level ) ;
...
position p;
@@
 const struct mlx5_eswitch * cocci_id@p ;
...
position p;
@@
 struct offloads_fdb cocci_id@p ;
...
position p;
@@
 struct mlx5_eswitch_rep_data * cocci_id@p ;
...
position p;
@@
 struct mlx5_host_work cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_destination cocci_id@p [ MLX5_MAX_FLOW_FWD_VPORTS + 1 ] ;
...
typedef u32,u16;
@@
 void cocci_id@p ( struct mlx5_eswitch * esw , u32 chain , u16 prio , int level ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLX5_UN_SZ_BYTES ( set_action_in_add_action_in_auto ) ] ;
...
position p;
@@
 struct mlx5_esw_offload * cocci_id@p ;
...
position p;
@@
 const struct mlx5_vport * cocci_id@p ;
...
position p;
@@
 struct mlx5_esw_functions * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ 4 ] ;
