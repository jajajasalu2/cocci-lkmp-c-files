...
position p;
@@
 enum { MW_NOT_ENABLED = 0 , MW_ONESHOT , MW_START , MW_RESTART , MW_STOP , } cocci_id@p ;
...
position p;
@@
 const struct malidp_irq_map * cocci_id@p ;
...
position p;
@@
 const struct malidp_layer cocci_id@p [ ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ ] [ SE_N_SCALING_COEFFS ] ;
...
position p;
@@
 const struct malidp_format_id cocci_id@p [ ] ;
...
position p;
@@
 const struct malidp_hw cocci_id@p [ MALIDP_MAX_DEVICES ] ;
