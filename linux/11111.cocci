...
typedef uint32_t;
@@
 struct input_csc_matrix {  enum dc_color_space color_space ;  uint32_t regval [ 12 ] ; } cocci_id@p ;
...
position p;
@@
 enum { OUTPUT_CSC_MATRIX_SIZE = 12 , } cocci_id@p ;
...
position p;
@@
 struct input_csc_matrix cocci_id@p ;
...
position p;
@@
 const struct input_csc_matrix cocci_id@p [ ] ;
