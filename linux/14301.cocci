...
position p;
@@
 struct tda10048_state * cocci_id@p ;
...
position p;
@@
 const struct tda10048_config * cocci_id@p ;
...
typedef u32;
@@
 struct pll_tab {  u32 clk_freq_khz ;  u32 if_freq_khz ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct tda10048_state {  struct i2c_adapter * i2c ;  struct tda10048_config config ;  struct dvb_frontend frontend ;  int fwloaded ;  u32 freq_if_hz ;  u32 xtal_hz ;  u32 pll_mfactor ;  u32 pll_nfactor ;  u32 pll_pfactor ;  u32 sample_freq ;  u32 bandwidth ; } cocci_id@p ;
...
typedef u8;
@@
 struct snr_tab {  u8 val ;  u8 data ; } cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct init_tab {  u8 reg ;  u16 data ; } cocci_id@p [ ] ;
