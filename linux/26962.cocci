...
position p;
@@
 struct nfs3_readlinkargs cocci_id@p ;
...
position p;
@@
 const struct nlmclnt_operations cocci_id@p ;
...
position p;
@@
 struct nfs3_diropargs cocci_id@p ;
...
position p;
@@
 struct nfs3_readdirargs cocci_id@p ;
...
position p;
@@
 struct nfs3_linkargs cocci_id@p ;
...
position p;
@@
 struct nfs3_sattrargs cocci_id@p ;
...
position p;
@@
 struct nfs3_accessargs cocci_id@p ;
...
position p;
@@
 struct nfs3_createdata * cocci_id@p ;
...
position p;
@@
 struct nfs3_createdata {  struct rpc_message msg ;  union {  struct nfs3_createargs create ;  struct nfs3_mkdirargs mkdir ;  struct nfs3_symlinkargs symlink ;  struct nfs3_mknodargs mknod ; } arg ;  struct nfs3_diropres res ;  struct nfs_fh fh ;  struct nfs_fattr fattr ;  struct nfs_fattr dir_attr ; } cocci_id@p ;
