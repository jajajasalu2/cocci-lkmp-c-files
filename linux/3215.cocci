...
position p;
@@
 enum chips { max34440 , max34441 , max34446 , max34451 , max34460 , max34461 , } cocci_id@p ;
...
position p;
@@
 struct max34440_data cocci_id@p ;
...
position p;
@@
 struct max34440_data {  int id ;  struct pmbus_driver_info info ; } cocci_id@p ;
...
position p;
@@
 const struct max34440_data * cocci_id@p ;
