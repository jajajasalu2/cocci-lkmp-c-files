...
position p;
@@
 struct gb_lights_get_light_config_response cocci_id@p ;
...
position p;
@@
 struct gb_lights_set_color_request cocci_id@p ;
...
position p;
@@
 struct gb_connection * cocci_id@p ;
...
position p;
@@
 const struct led_flash_ops cocci_id@p ;
...
position p;
@@
 struct gb_lights_set_flash_strobe_request cocci_id@p ;
...
position p;
@@
 struct gb_lights_get_channel_flash_config_request cocci_id@p ;
...
position p;
@@
 struct gb_lights_get_channel_flash_config_response cocci_id@p ;
...
position p;
@@
 struct gb_lights_get_lights_response cocci_id@p ;
...
position p;
@@
 struct gb_lights_set_fade_request cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct gb_channel * channel , u32 color ) ;
...
position p;
@@
 struct greybus_descriptor_cport * cocci_id@p ;
...
position p;
@@
 struct gb_lights_set_brightness_request cocci_id@p ;
...
position p;
@@
 struct gb_lights_get_light_config_request cocci_id@p ;
...
position p;
@@
 struct v4l2_flash_config cocci_id@p ;
...
position p;
@@
 struct gb_lights_blink_request cocci_id@p ;
...
position p;
@@
 struct gb_lights_set_flash_intensity_request cocci_id@p ;
...
position p;
@@
 struct gb_lights_get_flash_fault_response cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct gb_channel {  u8 id ;  u32 flags ;  u32 color ;  char * color_name ;  u8 fade_in ;  u8 fade_out ;  u32 mode ;  char * mode_name ;  struct attribute * * attrs ;  struct attribute_group * attr_group ;  const struct attribute_group * * attr_groups ;  struct led_classdev * led ; #if IS_REACHABLE(CONFIG_LEDS_CLASS_FLASH)  struct led_classdev_flash fled ;  struct led_flash_setting intensity_uA ;  struct led_flash_setting timeout_us ; #else  struct led_classdev cled ; #endif  struct gb_light * light ;  bool is_registered ;  bool releasing ;  bool strobe_state ;  bool active ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 const struct greybus_bundle_id * cocci_id@p ;
...
position p;
@@
 struct led_classdev_flash * cocci_id@p ;
...
position p;
@@
 struct gb_operation * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gb_channel * channel ) ;
...
typedef u8,bool,u32;
@@
 struct gb_light {  u8 id ;  char * name ;  struct gb_lights * glights ;  u32 flags ;  u8 channels_count ;  struct gb_channel * channels ;  bool has_flash ;  bool ready ; #if IS_REACHABLE(CONFIG_V4L2_FLASH_LED_CLASS)  struct v4l2_flash * v4l2_flash ;  struct v4l2_flash * v4l2_flash_ind ; #endif } cocci_id@p ;
...
position p;
@@
 const struct v4l2_flash_ops cocci_id@p ;
...
position p;
@@
 struct gb_lights_get_channel_config_response cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gb_channel * channel ) ;
...
typedef u8;
@@
 struct gb_lights {  struct gb_connection * connection ;  u8 lights_count ;  struct gb_light * lights ;  struct mutex lights_lock ; } cocci_id@p ;
...
position p;
@@
 struct gb_lights_get_channel_config_request cocci_id@p ;
...
position p;
@@
 struct led_flash_setting * cocci_id@p ;
...
position p;
@@
 struct greybus_driver cocci_id@p ;
...
position p;
@@
 struct gb_lights_set_flash_timeout_request cocci_id@p ;
...
position p;
@@
 struct gb_lights_get_flash_fault_request cocci_id@p ;
...
position p;
@@
 struct gb_lights_event_request * cocci_id@p ;
