...
typedef u16,s32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u16 offset , u16 words , u16 * data ) ;
...
typedef s32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , e1000_rev_polarity * polarity ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct e1000_hw * hw , u32 * eecd ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct e1000_hw * hw , u32 offset , u32 value ) ;
...
typedef u32,u16;
@@
 void cocci_id@p ( struct e1000_hw * hw , u32 data , u16 count ) ;
...
typedef u32,u16,s32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 reg_addr , u16 phy_data ) ;
...
typedef u16;
@@
 const u16 cocci_id@p [ IGP01E1000_AGC_LENGTH_TABLE_SIZE ] ;
...
typedef u32;
@@
 void cocci_id@p ( struct e1000_hw * hw , u32 * ctrl ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct e1000_hw * hw , u16 data , u16 count ) ;
...
position p;
@@
 struct e1000_eeprom_info * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct e1000_hw * hw , u16 count ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct e1000_hw * hw ) ;
...
typedef s32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , struct e1000_phy_info * phy_info ) ;
...
typedef u16,s32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u16 * min_length , u16 * max_length ) ;
...
typedef bool,s32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , bool link_up ) ;
...
typedef u16;
@@
 const u16 cocci_id@p [ IGP01E1000_PHY_CHANNEL_NUM ] ;
