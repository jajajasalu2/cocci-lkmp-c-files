...
position p;
@@
 struct ipmi_dmi_info * cocci_id@p ;
...
position p;
@@
 struct ipmi_plat_data cocci_id@p ;
...
typedef u8;
@@
 struct ipmi_dmi_info {  enum si_type si_type ;  unsigned int space ;  unsigned long addr ;  u8 slave_addr ;  struct ipmi_dmi_info * next ; } cocci_id@p ;
