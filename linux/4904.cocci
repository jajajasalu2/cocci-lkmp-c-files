...
position p;
@@
 struct qedr_discon_work * cocci_id@p ;
...
position p;
@@
 struct qedr_iw_listener * cocci_id@p ;
...
position p;
@@
 const struct qed_iwarp_cm_info * cocci_id@p ;
...
position p;
@@
 struct qedr_discon_work {  struct work_struct work ;  struct qedr_iw_ep * ep ;  enum qed_iwarp_event_type event ;  int status ; } cocci_id@p ;
