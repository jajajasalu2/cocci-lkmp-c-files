...
position p;
@@
 struct binderfs_device * cocci_id@p ;
...
position p;
@@
 struct binderfs_mount_opts * cocci_id@p ;
...
position p;
@@
 enum { Opt_max , Opt_stats_mode , Opt_err , } cocci_id@p ;
...
position p;
@@
 enum binderfs_stats_mode { STATS_NONE , STATS_GLOBAL , } cocci_id@p ;
