...
position p;
@@
 struct snd_card * cocci_id@p [ SNDRV_CARDS ] ;
...
symbol cocci_id;
position p;
typedef snd_card_saa7134_t;
@@
 snd_card_saa7134_t * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct snd_card_saa7134_pcm {  struct saa7134_dev * dev ;  spinlock_t lock ;  struct snd_pcm_substream * substream ; } cocci_id@p ;
...
position p;
@@
 struct saa7134_dmasound * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_card_saa7134_pcm_t;
@@
 snd_card_saa7134_pcm_t * cocci_id@p ;
