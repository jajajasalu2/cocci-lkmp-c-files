...
position p;
@@
 struct qm1d1b0004_state {  struct qm1d1b0004_config cfg ;  struct i2c_client * i2c ; } cocci_id@p ;
...
position p;
@@
 struct qm1d1b0004_state cocci_id@p ;
...
position p;
@@
 const struct qm1d1b0004_cb_map cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct qm1d1b0004_cb_map {  u32 frequency ;  u8 cb ; } cocci_id@p ;
