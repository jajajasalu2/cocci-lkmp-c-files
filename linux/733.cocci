...
position p;
@@
 void cocci_id@p ( struct controller * ctrl ) ;
...
position p;
@@
 struct resource_lists * cocci_id@p ;
...
position p;
@@
 struct pci_resource cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct controller * ctrl , struct pci_func * func , u8 behind_bridge , struct resource_lists * resources ) ;
...
typedef u8,u32;
@@
 u32 cocci_id@p ( struct controller * ctrl , struct pci_func * func , u8 behind_bridge , struct resource_lists * resources ) ;
