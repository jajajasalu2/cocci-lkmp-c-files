...
position p;
@@
 struct snd_aw2_saa7146_cb_param cocci_id@p [ NB_STREAM_CAPTURE ] ;
...
position p;
@@
 struct snd_aw2_saa7146_cb_param cocci_id@p [ NB_STREAM_PLAYBACK ] ;
...
position p;
@@
 struct snd_aw2_saa7146 * cocci_id@p ;
