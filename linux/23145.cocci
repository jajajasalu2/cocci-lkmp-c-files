...
position p;
@@
 struct txx9aclc_soc_device {  struct txx9aclc_dmadata dmadata [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct txx9aclc_dmadata * cocci_id@p ;
...
position p;
@@
 struct txx9aclc_soc_device * cocci_id@p ;
...
position p;
@@
 struct txx9aclc_plat_drvdata * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct txx9aclc_soc_device * dev , struct txx9aclc_dmadata * dmadata ) ;
