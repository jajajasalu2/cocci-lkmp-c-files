...
position p;
@@
 struct nft_chain_hook cocci_id@p ;
...
position p;
@@
 struct nft_userdata cocci_id@p ;
...
position p;
@@
 const struct nft_expr_info * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_SET_DESC_MAX + 1 ] ;
...
position p;
@@
 struct nft_object_hash_key cocci_id@p ;
...
position p;
@@
 struct nft_rule_dump_ctx {  char * table ;  char * chain ; } cocci_id@p ;
...
position p;
@@
 const struct nft_set_iter * cocci_id@p ;
...
typedef u32;
@@
 struct nft_obj_filter {  char * table ;  u32 type ; } cocci_id@p ;
...
position p;
@@
 const struct nf_flowtable_type * cocci_id@p ;
...
position p;
@@
 const struct nft_verdict * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct rhashtable_compare_arg * , const void * ) ;
...
position p;
@@
 const struct nft_rule * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NFT_CHAIN_MAXNAMELEN + 1 ] ;
...
position p;
@@
 struct nft_trans_elem cocci_id@p ;
...
position p;
@@
 struct nft_trans_table cocci_id@p ;
...
position p;
@@
 struct nft_object_type * cocci_id@p ;
...
position p;
@@
 struct nft_data_desc * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_COUNTER_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_SET_ELEM_MAX + 1 ] ;
...
position p;
@@
 const struct nft_ctx * cocci_id@p ;
...
position p;
@@
 struct nft_trans_set cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NFT_OBJ_MAXNAMELEN ] ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * w ) ;
...
position p;
@@
 struct nft_trans_obj cocci_id@p ;
...
position p;
@@
 struct nft_trans_chain cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_FLOWTABLE_HOOK_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_VERDICT_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_DATA_MAX + 1 ] ;
...
position p;
@@
 const struct nft_object_ops * cocci_id@p ;
...
position p;
@@
 struct nft_expr_info * cocci_id@p ;
...
position p;
@@
 const struct nfnetlink_subsystem cocci_id@p ;
...
position p;
@@
 const struct nft_set_type * cocci_id@p ;
...
position p;
@@
 const struct nft_set_elem * cocci_id@p ;
...
position p;
@@
 const struct nft_chain_type * cocci_id@p [ NFPROTO_NUMPROTO ] [ NFT_CHAIN_T_MAX ] ;
...
position p;
@@
 const struct nfnl_callback cocci_id@p [ NFT_MSG_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_CHAIN_MAX + 1 ] ;
...
position p;
@@
 struct nft_base_chain * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( const void * data , u32 len , u32 seed ) ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_DATA_MAX + 1 ] ;
...
position p;
@@
 const struct nft_set_ext_tmpl * cocci_id@p ;
...
position p;
@@
 const struct nft_hook * cocci_id@p ;
...
position p;
@@
 struct nft_set_gc_batch cocci_id@p ;
...
position p;
@@
 const struct nft_chain * cocci_id@p ;
...
position p;
@@
 const struct nft_expr_ops * cocci_id@p ;
...
position p;
@@
 struct nft_set_desc cocci_id@p ;
...
position p;
@@
 const struct nft_set_desc * cocci_id@p ;
...
position p;
@@
 const struct nf_hook_ops * cocci_id@p ;
...
position p;
@@
 struct pernet_operations cocci_id@p ;
...
position p;
@@
 struct nft_trans_flowtable cocci_id@p ;
...
position p;
@@
 const struct nft_object_type * cocci_id@p ;
...
position p;
@@
 struct nft_set_dump_args {  const struct netlink_callback * cb ;  struct nft_set_iter iter ;  struct sk_buff * skb ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MODULE_NAME_LEN ] ;
...
position p;
@@
 struct nft_expr_info {  const struct nft_expr_ops * ops ;  struct nlattr * tb [ NFT_EXPR_MAXATTR + 1 ] ; } cocci_id@p ;
...
position p;
@@
 const struct nft_set_ext_type cocci_id@p [ ] ;
...
position p;
@@
 const struct nft_base_chain * cocci_id@p ;
...
position p;
@@
 struct nft_set_dump_ctx {  const struct nft_set * set ;  struct nft_ctx ctx ; } cocci_id@p ;
...
position p;
@@
 struct nft_set_dump_args cocci_id@p ;
...
position p;
@@
 struct nft_obj_filter * cocci_id@p ;
...
position p;
@@
 struct nft_expr_type * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct nft_ctx * ctx , const struct nft_chain * chain ) ;
...
position p;
@@
 struct nft_rules_old cocci_id@p ;
...
position p;
@@
 const struct nlattr * const cocci_id@p [ ] ;
...
position p;
@@
 const struct nft_set_ext * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_SET_ELEM_LIST_MAX + 1 ] ;
...
position p;
@@
 struct nft_flow_rule * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_HOOK_MAX + 1 ] ;
...
position p;
@@
 struct nft_set_type * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_OBJ_MAX + 1 ] ;
...
position p;
@@
 struct netlink_dump_control cocci_id@p ;
...
typedef s32,u32;
@@
 struct nft_chain_hook {  u32 num ;  s32 priority ;  const struct nft_chain_type * type ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct nft_immediate_expr * cocci_id@p ;
...
position p;
@@
 struct nft_set_dump_ctx * cocci_id@p ;
...
position p;
@@
 const struct nlmsghdr * cocci_id@p ;
...
position p;
@@
 struct nft_set_estimate cocci_id@p ;
...
position p;
@@
 struct nft_rules_old {  struct rcu_head h ;  struct nft_rule * * start ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_TABLE_MAX + 1 ] ;
...
position p;
@@
 const struct nft_object_hash_key * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_SET_ELEM_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_FLOWTABLE_MAX + 1 ] ;
...
position p;
@@
 const struct nft_chain_type * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_COUNTER_MAX + 1 ] ;
...
position p;
@@
 struct nft_rule_dump_ctx * cocci_id@p ;
...
position p;
@@
 struct nft_trans_rule cocci_id@p ;
...
position p;
@@
 struct nft_rule * cocci_id@p ( const struct net * net , const struct nlattr * nla ) ;
...
position p;
@@
 struct nft_set_iter cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_EXPR_MAX + 1 ] ;
...
position p;
@@
 const struct nft_rule_dump_ctx * cocci_id@p ;
...
position p;
@@
 const struct nft_data * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_EXPR_MAX + 1 ] ;
...
position p;
@@
 const struct nft_set_ops * cocci_id@p ;
...
position p;
@@
 const struct nft_object * cocci_id@p ;
...
position p;
@@
 struct nft_flowtable * cocci_id@p ;
...
position p;
@@
 const struct nft_table * cocci_id@p ;
...
position p;
@@
 const struct nft_set * cocci_id@p ;
...
position p;
@@
 struct nft_set_elem cocci_id@p ;
...
position p;
@@
 struct nft_flowtable_filter * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_SET_DESC_MAX + 1 ] ;
...
position p;
@@
 enum { NFT_VALIDATE_SKIP = 0 , NFT_VALIDATE_NEED , NFT_VALIDATE_DO , } cocci_id@p ;
...
position p;
@@
 struct nft_set_binding * cocci_id@p ;
...
position p;
@@
 enum nft_set_policies cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_HOOK_MAX + 1 ] ;
...
position p;
@@
 const struct nfgenmsg * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_RULE_MAX + 1 ] ;
...
position p;
@@
 enum nft_chain_types cocci_id@p ;
...
position p;
@@
 const struct nft_expr_type * cocci_id@p ;
...
position p;
@@
 struct nft_flowtable_filter {  char * table ; } cocci_id@p ;
...
position p;
@@
 const struct nft_expr * cocci_id@p ;
...
position p;
@@
 enum nft_trans_phase cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_FLOWTABLE_HOOK_MAX + 1 ] ;
...
position p;
@@
 enum nft_data_types cocci_id@p ;
...
position p;
@@
 struct nft_set_ext_tmpl cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFTA_VERDICT_MAX + 1 ] ;
...
position p;
@@
 struct nf_flowtable_type * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_SET_MAX + 1 ] ;
...
position p;
@@
 const struct nft_chain_hook * cocci_id@p ;
