...
position p;
@@
 struct of_intc_desc * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef of_irq_init_cb_t;
@@
 struct of_intc_desc {  struct list_head list ;  of_irq_init_cb_t irq_init_cb ;  struct device_node * dev ;  struct device_node * interrupt_parent ; } cocci_id@p ;
