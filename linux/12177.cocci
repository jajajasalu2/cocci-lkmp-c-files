...
position p;
@@
 struct drm_lima_gem_submit * cocci_id@p ;
...
position p;
@@
 struct drm_lima_gem_create * cocci_id@p ;
...
position p;
@@
 struct drm_lima_gem_submit_bo * cocci_id@p ;
...
position p;
@@
 struct lima_sched_pipe * cocci_id@p ;
...
position p;
@@
 struct drm_lima_get_param * cocci_id@p ;
...
position p;
@@
 struct drm_lima_ctx_create * cocci_id@p ;
...
position p;
@@
 struct drm_lima_gem_wait * cocci_id@p ;
...
position p;
@@
 struct drm_lima_gem_info * cocci_id@p ;
...
position p;
@@
 struct lima_sched_task * cocci_id@p ;
...
position p;
@@
 struct lima_drm_priv * cocci_id@p ;
