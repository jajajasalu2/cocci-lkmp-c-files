...
position p;
@@
 struct iwl_proto_offload_cmd_common * cocci_id@p ;
...
position p;
@@
 struct iwl_targ_addr * cocci_id@p ;
...
position p;
@@
 struct iwl_ns_config * cocci_id@p ;
...
position p;
@@
 union {  struct iwl_proto_offload_cmd_v1 v1 ;  struct iwl_proto_offload_cmd_v2 v2 ;  struct iwl_proto_offload_cmd_v3_small v3s ;  struct iwl_proto_offload_cmd_v3_large v3l ; } cocci_id@p ;
