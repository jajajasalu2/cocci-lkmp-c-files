...
position p;
@@
 const struct drm_i915_cmd_descriptor cocci_id@p ;
...
@@
 struct drm_i915_reg_descriptor {  i915_reg_t addr ;  u32 mask ;  u32 value ; } cocci_id@p ;
...
position p;
@@
 struct drm_i915_reg_table {  const struct drm_i915_reg_descriptor * regs ;  int num_regs ; } cocci_id@p ;
...
position p;
@@
 const struct drm_i915_reg_descriptor * cocci_id@p ;
...
position p;
@@
 struct cmd_node {  const struct drm_i915_cmd_descriptor * desc ;  struct hlist_node node ; } cocci_id@p ;
...
position p;
@@
 const struct drm_i915_cmd_table * cocci_id@p ;
...
position p;
@@
 const struct drm_i915_reg_table * cocci_id@p ;
...
position p;
@@
 struct drm_i915_cmd_descriptor * cocci_id@p ;
...
position p;
@@
 struct drm_i915_cmd_table {  const struct drm_i915_cmd_descriptor * table ;  int count ; } cocci_id@p ;
