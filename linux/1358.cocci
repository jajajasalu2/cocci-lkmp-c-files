...
position p;
@@
 struct usb_ext_cap_descriptor * cocci_id@p ;
...
position p;
@@
 struct transfer_context * cocci_id@p ;
...
position p;
@@
 struct usbtest_param_32 cocci_id@p ;
...
typedef atomic_t;
@@
 struct queued_ctx {  struct completion complete ;  atomic_t pending ;  unsigned num ;  int status ;  struct urb * * urbs ; } cocci_id@p ;
...
position p;
@@
 struct usbtest_info cocci_id@p ;
...
position p;
@@
 struct usb_sg_request * cocci_id@p ;
...
position p;
@@
 struct usb_ss_container_id_descriptor * cocci_id@p ;
...
position p;
@@
 struct usb_bos_descriptor * cocci_id@p ;
...
typedef u8;
@@
 struct usbtest_info {  const char * name ;  u8 ep_in ;  u8 ep_out ;  unsigned autoconf : 1 ;  unsigned ctrl_out : 1 ;  unsigned iso : 1 ;  unsigned intr : 1 ;  int alt ; } cocci_id@p ;
...
position p;
@@
 struct usb_device_descriptor cocci_id@p ;
...
position p;
@@
 struct usb_dev_cap_header cocci_id@p ;
...
position p;
@@
 struct usb_qualifier_descriptor cocci_id@p ;
...
typedef __u32;
@@
 struct usbtest_param_32 {  __u32 test_num ;  __u32 iterations ;  __u32 length ;  __u32 vary ;  __u32 sglen ;  __s32 duration_sec ;  __s32 duration_usec ; } cocci_id@p ;
...
typedef __s64,__u32;
@@
 struct usbtest_param_64 {  __u32 test_num ;  __u32 iterations ;  __u32 length ;  __u32 vary ;  __u32 sglen ;  __s64 duration_sec ;  __s64 duration_usec ; } cocci_id@p ;
...
position p;
@@
 struct usb_config_descriptor cocci_id@p ;
...
position p;
@@
 struct urb * cocci_id@p [ MAX_SGLEN ] ;
...
position p;
@@
 struct usbtest_param_64 * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct ctrl_ctx {  spinlock_t lock ;  struct usbtest_dev * dev ;  struct completion complete ;  unsigned count ;  unsigned pending ;  int status ;  struct urb * * urb ;  struct usbtest_param_32 * param ;  int last ; } cocci_id@p ;
...
position p;
@@
 struct usb_ss_cap_descriptor * cocci_id@p ;
...
@@
 struct transfer_context {  unsigned count ;  unsigned pending ;  spinlock_t lock ;  struct completion done ;  int submit_error ;  unsigned long errors ;  unsigned long packet_count ;  struct usbtest_dev * dev ;  bool is_iso ; } cocci_id@p ;
...
position p;
@@
 struct sg_timeout {  struct timer_list timer ;  struct usb_sg_request * req ; } cocci_id@p ;
...
position p;
@@
 struct subcase {  struct usb_ctrlrequest setup ;  int number ;  int expected ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef usb_complete_t;
@@
 usb_complete_t cocci_id@p ;
