...
position p;
@@
 struct ia_constants cocci_id@p ;
...
position p;
@@
 const struct ia_constants * cocci_id@p ;
...
position p;
@@
 struct ia_constants {  unsigned int min_gpu_freq ;  unsigned int max_gpu_freq ;  unsigned int min_ring_freq ;  unsigned int max_ia_freq ; } cocci_id@p ;
