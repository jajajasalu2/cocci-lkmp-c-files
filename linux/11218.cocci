...
position p;
@@
 struct _vcs_dpi_display_data_rq_regs_st * cocci_id@p ;
...
position p;
@@
 const struct _vcs_dpi_display_data_rq_sizing_params_st cocci_id@p ;
...
position p;
@@
 const struct _vcs_dpi_display_dlg_sys_params_st cocci_id@p ;
...
position p;
@@
 const struct _vcs_dpi_display_rq_params_st cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_data_rq_sizing_params_st * cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_data_rq_misc_params_st * cocci_id@p ;
...
position p;
@@
 const struct _vcs_dpi_display_rq_dlg_params_st cocci_id@p ;
...
position p;
@@
 const struct _vcs_dpi_display_pipe_source_params_st cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_data_rq_dlg_params_st * cocci_id@p ;
...
position p;
@@
 const struct _vcs_dpi_display_e2e_pipe_params_st cocci_id@p ;
