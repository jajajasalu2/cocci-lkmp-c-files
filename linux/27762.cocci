...
position p;
@@
 struct buffer_head * cocci_id@p [ MAX_BHS ] ;
...
typedef u8;
@@
 struct {  u8 added_cluster : 1 ;  u8 added_run : 1 ;  u8 mp_rebuilt : 1 ; } cocci_id@p ;
