...
position p;
@@
 void cocci_id@p ( struct intel_th_device * thdev ) ;
...
typedef bool;
@@
 const struct intel_th_subdevice {  const char * name ;  struct resource res [ 3 ] ;  unsigned nres ;  unsigned type ;  unsigned otype ;  bool mknode ;  unsigned scrpd ;  int id ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct intel_th_subdevice * cocci_id@p ;
...
position p;
@@
 struct intel_th_drvdata * cocci_id@p ;
