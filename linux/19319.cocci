...
position p;
@@
 const unsigned int * cocci_id@p [ PERF_COUNT_HW_CACHE_MAX ] [ PERF_COUNT_HW_CACHE_OP_MAX ] [ PERF_COUNT_HW_CACHE_RESULT_MAX ] ;
...
position p;
@@
 void cocci_id@p ( struct nds32_pmu * cpu_pmu ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct nds32_pmu * nds32_pmu ) ;
...
position p;
@@
 struct pmu_hw_events cocci_id@p ;
...
position p;
@@
 const unsigned int * cocci_id@p [ PERF_COUNT_HW_MAX ] ;
...
position p;
@@
 struct frame_tail_opt_size cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct stackframe * , void * ) ;
