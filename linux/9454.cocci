...
typedef u8;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , u8 * efuse ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct ieee80211_hw * hw , u8 offset , u8 word_en , u8 * data ) ;
...
position p;
@@
 struct pgpkt_struct cocci_id@p ;
...
typedef u8,u16;
@@
 int cocci_id@p ( struct ieee80211_hw * hw , u16 addr , u8 data ) ;
...
typedef u8,u16;
@@
 u8 cocci_id@p ( struct ieee80211_hw * hw , u16 efuse_addr , u8 word_en , u8 * data ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct ieee80211_hw * hw ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct ieee80211_hw * hw , u8 offset , u8 * data ) ;
...
position p;
@@
 const struct rtl_efuse_ops cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , u16 offset , u16 * value ) ;
...
typedef u32,u16;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , u16 offset , u32 * value ) ;
...
typedef u8,u16;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , u16 offset , u8 value ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 word_en , u8 * sourdata , u8 * targetdata ) ;
