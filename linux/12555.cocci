...
typedef bool;
@@
 struct edp_aux {  void __iomem * base ;  bool msg_err ;  struct completion msg_comp ;  struct mutex msg_mutex ;  struct drm_dp_aux drm_aux ; } cocci_id@p ;
