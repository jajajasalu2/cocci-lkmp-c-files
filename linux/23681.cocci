...
position p;
@@
 struct spdif_in_dev {  struct clk * clk ;  struct spear_dma_data dma_params ;  struct spdif_in_params saved_params ;  void * io_base ;  struct device * dev ;  void ( * reset_perip ) ( void ) ;  int irq ;  struct snd_dmaengine_dai_dma_data dma_params_rx ;  struct snd_dmaengine_pcm_config config ; } cocci_id@p ;
...
position p;
@@
 struct spdif_in_dev * cocci_id@p ;
...
position p;
@@
 struct spear_spdif_platform_data * cocci_id@p ;
...
typedef u32;
@@
 struct spdif_in_params {  u32 format ; } cocci_id@p ;
