...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( dev -> dma_reason ) ] ;
...
position p;
@@
 const struct ssb_device_id * cocci_id@p ;
...
position p;
@@
 const struct bcma_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct b43_request_fw_context * cocci_id@p ;
...
position p;
@@
 struct b43_txstatus cocci_id@p ;
...
position p;
@@
 struct b43_wldev * cocci_id@p ( struct b43_wldev * dev ) ;
...
position p;
@@
 int cocci_id@p ( struct b43_wl * wl ) ;
...
position p;
@@
 void cocci_id@p ( struct b43_wldev * dev ) ;
...
position p;
@@
 const struct b43_fw_header * cocci_id@p ;
...
position p;
@@
 struct b43_plcp_hdr4 cocci_id@p ;
...
position p;
@@
 struct ssb_chipcommon * cocci_id@p ;
...
position p;
@@
 struct b43_plcp_hdr6 cocci_id@p ;
...
position p;
@@
 struct b43_firmware_file * cocci_id@p ;
...
position p;
@@
 const struct b43_iv * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct b43_bus_dev * dev , struct b43_wl * wl ) ;
...
typedef u16;
@@
 u16 cocci_id@p [ B43_NR_QOSPARAMS ] ;
...
typedef u32;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , struct ieee80211_vif * vif , struct ieee80211_bss_conf * conf , u32 changed ) ;
...
position p;
@@
 struct b43_fw_header * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct b43_wldev * dev ) ;
...
position p;
@@
 void cocci_id@p ( struct b43_bus_dev * dev ) ;
...
position p;
@@
 struct b43_firmware * cocci_id@p ;
...
position p;
@@
 struct b43_qos_params * cocci_id@p ;
