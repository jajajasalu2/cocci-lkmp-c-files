...
position p;
@@
 struct btrfs_delayed_item * cocci_id@p ;
...
position p;
@@
 struct btrfs_delayed_node * cocci_id@p [ 8 ] ;
...
position p;
@@
 struct btrfs_delayed_node cocci_id@p ;
...
position p;
@@
 struct btrfs_async_delayed_work {  struct btrfs_delayed_root * delayed_root ;  int nr ;  struct btrfs_work work ; } cocci_id@p ;
...
position p;
@@
 struct btrfs_async_delayed_work cocci_id@p ;
