...
position p;
@@
 void cocci_id@p ( struct kref * ref ) ;
...
position p;
@@
 void cocci_id@p ( struct usb_interface * intf ) ;
...
position p;
@@
 void cocci_id@p ( struct hso_shared_int * shared_int ) ;
...
position p;
@@
 struct hso_device * cocci_id@p [ HSO_SERIAL_TTY_MINORS ] ;
...
position p;
@@
 struct hso_serial_state_notification cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u16,spinlock_t;
@@
 struct hso_serial {  struct hso_device * parent ;  int magic ;  u8 minor ;  struct hso_shared_int * shared_int ;  struct urb * rx_urb [ MAX_RX_URBS ] ;  u8 num_rx_urbs ;  u8 * rx_data [ MAX_RX_URBS ] ;  u16 rx_data_length ;  struct urb * tx_urb ;  u8 * tx_data ;  u8 * tx_buffer ;  u16 tx_data_length ;  u16 tx_data_count ;  u16 tx_buffer_count ;  struct usb_ctrlrequest ctrl_req_tx ;  struct usb_ctrlrequest ctrl_req_rx ;  struct usb_endpoint_descriptor * in_endp ;  struct usb_endpoint_descriptor * out_endp ;  enum rx_ctrl_state rx_state ;  u8 rts_state ;  u8 dtr_state ;  unsigned tx_urb_used : 1 ;  struct tty_port port ;  spinlock_t serial_lock ;  int ( * write_data ) ( struct hso_serial * serial ) ;  struct hso_tiocmget * tiocmget ;  int curr_rx_urb_idx ;  u8 rx_urb_filled [ MAX_RX_URBS ] ;  struct tasklet_struct unthrottle_tasklet ; } cocci_id@p ;
...
position p;
@@
 struct usb_endpoint_descriptor * cocci_id@p ( struct usb_interface * intf , int type , int dir ) ;
...
position p;
@@
 void cocci_id@p ( struct hso_serial * serial ) ;
...
position p;
@@
 struct hso_tiocmget * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hso_device * hso_dev ) ;
...
typedef spinlock_t;
@@
 struct hso_net {  struct hso_device * parent ;  struct net_device * net ;  struct rfkill * rfkill ;  char name [ 24 ] ;  struct usb_endpoint_descriptor * in_endp ;  struct usb_endpoint_descriptor * out_endp ;  struct urb * mux_bulk_rx_urb_pool [ MUX_BULK_RX_BUF_COUNT ] ;  struct urb * mux_bulk_tx_urb ;  void * mux_bulk_rx_buf_pool [ MUX_BULK_RX_BUF_COUNT ] ;  void * mux_bulk_tx_buf ;  struct sk_buff * skb_rx_buf ;  struct sk_buff * skb_tx_buf ;  enum pkt_parse_state rx_parse_state ;  spinlock_t net_lock ;  unsigned short rx_buf_size ;  unsigned short rx_buf_missing ;  struct iphdr rx_ip_hdr ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int status , const char * function , struct hso_device * hso_dev ) ;
...
position p;
@@
 struct hso_shared_int {  struct usb_endpoint_descriptor * intr_endp ;  void * shared_intr_buf ;  struct urb * shared_intr_urb ;  struct usb_device * usb ;  int use_count ;  int ref_count ;  struct mutex shared_int_lock ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hso_serial * serial ) ;
...
position p;
@@
 enum pkt_parse_state { WAIT_IP , WAIT_DATA , WAIT_SYNC , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_interface * intf , unsigned char * ports ) ;
...
position p;
@@
 int cocci_id@p ( struct urb * urb , struct hso_serial * serial ) ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * data ) ;
...
position p;
@@
 struct hso_shared_int * cocci_id@p ;
...
position p;
@@
 struct hso_device * cocci_id@p [ HSO_MAX_NET_DEVICES ] ;
...
symbol cocci_id;
position p;
typedef u16,wait_queue_head_t;
@@
 struct hso_tiocmget {  struct mutex mutex ;  wait_queue_head_t waitq ;  int intr_completed ;  struct usb_endpoint_descriptor * endp ;  struct urb * urb ;  struct hso_serial_state_notification * serial_state_notification ;  u16 prev_UART_state_bitmap ;  struct uart_icount icount ; } cocci_id@p ;
...
position p;
@@
 enum rx_ctrl_state { RX_IDLE , RX_SENT , RX_PENDING , } cocci_id@p ;
