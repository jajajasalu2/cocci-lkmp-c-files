...
position p;
@@
 struct touchkey_variant cocci_id@p ;
...
position p;
@@
 struct tm2_touchkey_data cocci_id@p ;
...
typedef u8,bool;
@@
 struct touchkey_variant {  u8 keycode_reg ;  u8 base_reg ;  u8 cmd_led_on ;  u8 cmd_led_off ;  bool no_reg ;  bool fixed_regulator ; } cocci_id@p ;
...
position p;
@@
 const struct touchkey_variant cocci_id@p ;
...
typedef u32;
@@
 struct tm2_touchkey_data {  struct i2c_client * client ;  struct input_dev * input_dev ;  struct led_classdev led_dev ;  struct regulator * vdd ;  struct regulator_bulk_data regulators [ 2 ] ;  const struct touchkey_variant * variant ;  u32 keycodes [ 4 ] ;  int num_keycodes ; } cocci_id@p ;
