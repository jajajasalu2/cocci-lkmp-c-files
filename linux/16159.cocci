...
position p;
@@
 const struct me_board * cocci_id@p ;
...
position p;
@@
 struct me_private_data * cocci_id@p ;
...
position p;
@@
 struct me_private_data {  void __iomem * plx_regbase ;  unsigned short ctrl1 ;  unsigned short ctrl2 ;  unsigned short dac_ctrl ; } cocci_id@p ;
...
position p;
@@
 enum me_boardid { BOARD_ME2600 , BOARD_ME2000 , } cocci_id@p ;
...
position p;
@@
 struct me_board {  const char * name ;  int needs_firmware ;  int has_ao ; } cocci_id@p ;
