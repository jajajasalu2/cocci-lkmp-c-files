...
position p;
@@
 struct timer_group_priv cocci_id@p ;
...
typedef spinlock_t;
@@
 struct timer_group_priv {  struct timer_regs __iomem * regs ;  struct mpic_timer timer [ TIMERS_PER_GROUP ] ;  struct list_head node ;  unsigned int timerfreq ;  unsigned int idle ;  unsigned int flags ;  spinlock_t lock ;  void __iomem * group_tcr ; } cocci_id@p ;
...
typedef u32;
@@
 struct timer_regs {  u32 gtccr ;  u32 res0 [ 3 ] ;  u32 gtbcr ;  u32 res1 [ 3 ] ;  u32 gtvpr ;  u32 res2 [ 3 ] ;  u32 gtdr ;  u32 res3 [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct cascade_priv cocci_id@p [ ] ;
...
typedef u32;
@@
 struct cascade_priv {  u32 tcr_value ;  unsigned int cascade_map ;  unsigned int timer_num ; } cocci_id@p ;
