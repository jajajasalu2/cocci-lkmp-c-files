...
position p;
@@
 struct pci_root_info {  struct acpi_pci_root_info common ;  struct pci_controller controller ;  struct list_head io_resources ; } cocci_id@p ;
...
position p;
@@
 struct pci_root_info * cocci_id@p ;
...
position p;
@@
 enum pci_mmap_state cocci_id@p ;
