...
position p;
@@
 struct cadence_nand_cdma_desc * cocci_id@p ;
...
position p;
@@
 struct cadence_nand_dt * cocci_id@p ;
...
typedef u32;
@@
 struct cadence_nand_dt_devdata {  u32 if_skew ;  unsigned int has_dma : 1 ; } cocci_id@p ;
...
position p;
@@
 struct nand_ecc_caps * cocci_id@p ;
...
position p;
@@
 struct cdns_nand_ctrl * cocci_id@p ;
...
position p;
@@
 struct cadence_nand_irq_status cocci_id@p ;
...
typedef u64,u32,u16;
@@
 struct cadence_nand_cdma_desc {  u64 next_pointer ;  u32 flash_pointer ;  u16 bank ;  u16 rsvd0 ;  u16 command_type ;  u16 rsvd1 ;  u16 command_flags ;  u16 rsvd2 ;  u64 memory_pointer ;  u32 status ;  u32 rsvd3 ;  u64 sync_flag_pointer ;  u32 sync_arguments ;  u32 rsvd4 ;  u64 ctrl_data_ptr ; } cocci_id@p ;
...
position p;
@@
 struct cdns_nand_chip cocci_id@p ;
...
typedef u8,bool;
@@
 struct cdns_nand_caps {  u8 max_banks ;  u8 data_dma_width ;  bool data_control_supp ;  bool is_phy_type_dll ; } cocci_id@p ;
...
typedef u32;
@@
 struct cadence_nand_timings {  u32 async_toggle_timings ;  u32 timings0 ;  u32 timings1 ;  u32 timings2 ;  u32 dll_phy_ctrl ;  u32 phy_ctrl ;  u32 phy_dqs_timing ;  u32 phy_gate_lpbk_ctrl ; } cocci_id@p ;
...
typedef u32;
@@
 struct cadence_nand_irq_status {  u32 trd_status ;  u32 trd_error ;  u32 status ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct cdns_nand_chip {  struct cadence_nand_timings timings ;  struct nand_chip chip ;  u8 nsels ;  struct list_head node ;  u32 avail_oob_size ;  u32 sector_size ;  u32 sector_count ;  u8 bbm_offs ;  u8 bbm_len ;  u8 corr_str_idx ;  u8 cs [ ] ; } cocci_id@p ;
...
position p;
@@
 struct cadence_nand_timings * cocci_id@p ;
...
position p;
@@
 struct cadence_nand_dt {  struct cdns_nand_ctrl cdns_ctrl ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 const struct cadence_nand_dt_devdata * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,spinlock_t,dma_addr_t;
@@
 struct cdns_nand_ctrl {  struct device * dev ;  struct nand_controller controller ;  struct cadence_nand_cdma_desc * cdma_desc ;  const struct cadence_nand_dt_devdata * caps1 ;  struct cdns_nand_caps caps2 ;  u8 ctrl_rev ;  dma_addr_t dma_cdma_desc ;  u8 * buf ;  u32 buf_size ;  u8 curr_corr_str_idx ;  void __iomem * reg ;  struct {  void __iomem * virt ;  dma_addr_t dma ; } io ;  int irq ;  struct cadence_nand_irq_status irq_status ;  struct cadence_nand_irq_status irq_mask ;  struct completion complete ;  spinlock_t irq_lock ;  int ecc_strengths [ BCH_MAX_NUM_CORR_CAPS ] ;  struct nand_ecc_step_info ecc_stepinfos [ BCH_MAX_NUM_SECTOR_SIZES ] ;  struct nand_ecc_caps ecc_caps ;  int curr_trans_type ;  struct dma_chan * dmac ;  u32 nf_clk_rate ;  u32 board_delay ;  struct nand_chip * selected_chip ;  unsigned long assigned_cs ;  struct list_head chips ; } cocci_id@p ;
