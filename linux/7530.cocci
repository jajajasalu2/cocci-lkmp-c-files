...
typedef bool,u32;
@@
 struct sh_mobile_lcdc_format_info {  u32 fourcc ;  unsigned int bpp ;  bool yuv ;  u32 lddfr ; } cocci_id@p ;
...
@@
 struct sh_mobile_lcdc_overlay {  struct sh_mobile_lcdc_chan * channel ;  const struct sh_mobile_lcdc_overlay_cfg * cfg ;  struct fb_info * info ;  unsigned int index ;  unsigned long base ;  bool enabled ;  enum sh_mobile_lcdc_overlay_mode mode ;  unsigned int alpha ;  unsigned int rop3 ;  void * fb_mem ;  unsigned long fb_size ;  dma_addr_t dma_handle ;  unsigned long base_addr_y ;  unsigned long base_addr_c ;  unsigned long pan_y_offset ;  const struct sh_mobile_lcdc_format_info * format ;  unsigned int xres ;  unsigned int xres_virtual ;  unsigned int yres ;  unsigned int yres_virtual ;  unsigned int pitch ;  int pos_x ;  int pos_y ; } cocci_id@p ;
...
position p;
@@
 struct sh_mobile_lcdc_priv * cocci_id@p ;
...
position p;
@@
 enum sh_mobile_lcdc_overlay_mode { LCDC_OVERLAY_BLEND , LCDC_OVERLAY_ROP3 , } cocci_id@p ;
...
position p;
@@
 struct sh_mobile_lcdc_overlay * cocci_id@p ;
...
position p;
@@
 struct sh_mobile_lcdc_info * cocci_id@p ;
...
typedef atomic_t;
@@
 struct sh_mobile_lcdc_priv {  void __iomem * base ;  int irq ;  atomic_t hw_usecnt ;  struct device * dev ;  struct clk * dot_clk ;  unsigned long lddckr ;  struct sh_mobile_lcdc_chan ch [ 2 ] ;  struct sh_mobile_lcdc_overlay overlays [ 4 ] ;  int started ;  int forced_fourcc ; } cocci_id@p ;
...
position p;
@@
 const struct sh_mobile_lcdc_format_info cocci_id@p [ ] ;
...
position p;
@@
 struct fb_deferred_io * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ NR_CH_REGS ] ;
...
position p;
@@
 const struct sh_mobile_lcdc_chan_cfg * cocci_id@p ;
...
position p;
@@
 struct sh_mobile_lcdc_sys_bus_ops cocci_id@p ;
...
position p;
@@
 const struct sh_mobile_lcdc_panel_cfg * cocci_id@p ;
...
position p;
@@
 struct sh_mobile_lcdc_chan * cocci_id@p ;
