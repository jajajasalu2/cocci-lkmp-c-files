...
@@
 struct gart_device {  void __iomem * regs ;  u32 * savedata ;  unsigned long iovmm_base ;  unsigned long iovmm_end ;  spinlock_t pte_lock ;  spinlock_t dom_lock ;  unsigned int active_devices ;  struct iommu_domain * active_domain ;  struct iommu_device iommu ;  struct device * dev ; } cocci_id@p ;
