...
position p;
@@
 int cocci_id@p ( struct atm_dev * atm_dev , unsigned int cmd , void __user * arg ) ;
...
position p;
@@
 struct usbatm_vcc_data cocci_id@p ;
...
typedef u32;
@@
 struct usbatm_control {  struct atm_skb_data atm ;  u32 len ;  u32 crc ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct atm_dev * atm_dev ) ;
...
position p;
@@
 struct usbatm_channel * cocci_id@p ;
...
position p;
@@
 struct usbatm_control * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usbatm_data * instance , const unsigned char * data , int len ) ;
...
position p;
@@
 struct usbatm_vcc_data {  struct list_head list ;  short vpi ;  int vci ;  struct atm_vcc * vcc ;  struct sk_buff * sarb ; } cocci_id@p ;
