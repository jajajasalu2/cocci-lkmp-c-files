...
position p;
@@
 struct kobject * cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct sq_mapping {  const char * name ;  unsigned long sq_addr ;  unsigned long addr ;  unsigned int size ;  struct sq_mapping * next ; } cocci_id@p ;
...
position p;
@@
 struct sq_sysfs_attr * cocci_id@p ;
