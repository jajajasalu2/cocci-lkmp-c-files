...
typedef bool;
@@
 struct pxa_clk {  struct clk_hw hw ;  struct clk_fixed_factor lp ;  struct clk_fixed_factor hp ;  struct clk_gate gate ;  bool ( * is_in_low_power ) ( void ) ; } cocci_id@p ;
...
position p;
@@
 const struct desc_clk_cken * cocci_id@p ;
