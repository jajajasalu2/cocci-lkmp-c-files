...
position p;
@@
 char cocci_id@p [ CMSG_SPACE ( sizeof ( cfg_gso_size ) ) + CMSG_SPACE ( sizeof ( cfg_tx_ts ) ) ] ;
...
position p;
@@
 struct iovec cocci_id@p [ max_nr_msg ] ;
...
position p;
@@
 char cocci_id@p [ CMSG_SPACE ( sizeof ( struct scm_timestamping ) ) + CMSG_SPACE ( sizeof ( struct sock_extended_err ) ) + CMSG_SPACE ( sizeof ( struct sockaddr_in6 ) ) ] ;
...
position p;
@@
 char cocci_id@p [ CMSG_SPACE ( sizeof ( cfg_tx_ts ) ) ] ;
...
position p;
@@
 struct mmsghdr cocci_id@p [ max_nr_msg ] ;
...
position p;
@@
 char cocci_id@p [ NUM_PKT ] [ ETH_MAX_MTU ] ;
