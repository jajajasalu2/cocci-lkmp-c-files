...
position p;
@@
 enum { OPT_LOWERDIR , OPT_UPPERDIR , OPT_WORKDIR , OPT_DEFAULT_PERMISSIONS , OPT_REDIRECT_DIR , OPT_INDEX_ON , OPT_INDEX_OFF , OPT_NFS_EXPORT_ON , OPT_NFS_EXPORT_OFF , OPT_XINO_ON , OPT_XINO_OFF , OPT_XINO_AUTO , OPT_METACOPY_ON , OPT_METACOPY_OFF , OPT_ERR , } cocci_id@p ;
...
position p;
@@
 enum { OVL_XINO_OFF , OVL_XINO_AUTO , OVL_XINO_ON , } cocci_id@p ;
