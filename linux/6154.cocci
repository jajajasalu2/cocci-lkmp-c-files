...
typedef u32;
@@
 struct sprd_pmic_data {  u32 irq_base ;  u32 num_irqs ; } cocci_id@p ;
...
position p;
@@
 struct sprd_pmic {  struct regmap * regmap ;  struct device * dev ;  struct regmap_irq * irqs ;  struct regmap_irq_chip irq_chip ;  struct regmap_irq_chip_data * irq_data ;  int irq ; } cocci_id@p ;
...
position p;
@@
 const struct sprd_pmic_data cocci_id@p ;
