...
typedef spinlock_t;
@@
 struct digi_serial {  spinlock_t ds_serial_lock ;  struct usb_serial_port * ds_oob_port ;  int ds_oob_port_num ;  int ds_device_started ; } cocci_id@p ;
...
@@
 struct digi_port {  spinlock_t dp_port_lock ;  int dp_port_num ;  int dp_out_buf_len ;  unsigned char dp_out_buf [ DIGI_OUT_BUF_SIZE ] ;  int dp_write_urb_in_use ;  unsigned int dp_modem_signals ;  int dp_transmit_idle ;  wait_queue_head_t dp_transmit_idle_wait ;  int dp_throttled ;  int dp_throttle_restart ;  wait_queue_head_t dp_flush_wait ;  wait_queue_head_t dp_close_wait ;  struct work_struct dp_wakeup_work ;  struct usb_serial_port * dp_port ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * port , unsigned char * buf , int count , unsigned long timeout ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * port , unsigned long timeout ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * port , unsigned char * buf , int count , int interruptible ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * port , unsigned int modem_signals , int interruptible ) ;
