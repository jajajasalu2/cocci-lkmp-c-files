...
position p;
@@
 struct dmx_exportbuffer * cocci_id@p ;
...
position p;
@@
 struct dmx_requestbuffers * cocci_id@p ;
...
position p;
@@
 enum dmx_buffer_flags * cocci_id@p ;
