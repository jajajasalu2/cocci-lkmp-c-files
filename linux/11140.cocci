...
position p;
@@
 enum dwb_outside_pix_strategy { DWB_OUTSIDE_PIX_STRATEGY_BLACK = 0 , DWB_OUTSIDE_PIX_STRATEGY_EDGE = 1 , } cocci_id@p ;
...
position p;
@@
 struct dwb_warmup_params * cocci_id@p ;
...
position p;
@@
 struct dwb_stereo_params * cocci_id@p ;
...
position p;
@@
 struct dc_dwb_params * cocci_id@p ;
...
position p;
@@
 const struct dwbc_funcs cocci_id@p ;
