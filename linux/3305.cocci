...
position p;
@@
 struct thermal_data * cocci_id@p ;
...
position p;
@@
 enum emc1403_chip { emc1402 , emc1403 , emc1404 , } cocci_id@p ;
...
position p;
@@
 struct thermal_data {  struct regmap * regmap ;  struct mutex mutex ;  const struct attribute_group * groups [ 4 ] ; } cocci_id@p ;
