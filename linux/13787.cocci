...
position p;
@@
 struct ad5820_device * cocci_id@p ;
...
typedef bool,u32;
@@
 struct ad5820_device {  struct v4l2_subdev subdev ;  struct ad5820_platform_data * platform_data ;  struct regulator * vana ;  struct v4l2_ctrl_handler ctrls ;  u32 focus_absolute ;  u32 focus_ramp_time ;  u32 focus_ramp_mode ;  struct gpio_desc * enable_gpio ;  struct mutex power_lock ;  int power_count ;  bool standby ; } cocci_id@p ;
