...
typedef __u16,__u8;
@@
 struct {  __u8 callee_used_stack [ __SIGNAL_FRAMESIZE32 ] ;  struct sigcontext32 sc ;  _sigregs32 sregs ;  int signo ;  _sigregs_ext32 sregs_ext ;  __u16 svc_insn ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u16,__u8,compat_siginfo_t;
@@
 struct {  __u8 callee_used_stack [ __SIGNAL_FRAMESIZE32 ] ;  __u16 svc_insn ;  compat_siginfo_t info ;  struct ucontext32 uc ; } cocci_id@p ;
