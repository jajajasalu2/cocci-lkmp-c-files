...
position p;
@@
 enum mxl5007t_bw_mhz { MxL_BW_6MHz = 6 , MxL_BW_7MHz = 7 , MxL_BW_8MHz = 8 , } cocci_id@p ;
...
position p;
@@
 struct mxl5007t_state cocci_id@p ;
...
position p;
@@
 enum mxl5007t_bw_mhz cocci_id@p ;
...
position p;
@@
 enum mxl5007t_chip_version { MxL_UNKNOWN_ID = 0x00 , MxL_5007_V1_F1 = 0x11 , MxL_5007_V1_F2 = 0x12 , MxL_5007_V4 = 0x14 , MxL_5007_V2_100_F1 = 0x21 , MxL_5007_V2_100_F2 = 0x22 , MxL_5007_V2_200_F1 = 0x23 , MxL_5007_V2_200_F2 = 0x24 , } cocci_id@p ;
...
position p;
@@
 enum mxl5007t_mode { MxL_MODE_ISDBT = 0 , MxL_MODE_DVBT = 1 , MxL_MODE_ATSC = 2 , MxL_MODE_CABLE = 0x10 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,reg_pair_t;
@@
 struct mxl5007t_state {  struct list_head hybrid_tuner_instance_list ;  struct tuner_i2c_props i2c_props ;  struct mutex lock ;  struct mxl5007t_config * config ;  enum mxl5007t_chip_version chip_id ;  struct reg_pair_t tab_init [ ARRAY_SIZE ( init_tab ) ] ;  struct reg_pair_t tab_init_cable [ ARRAY_SIZE ( init_tab_cable ) ] ;  struct reg_pair_t tab_rftune [ ARRAY_SIZE ( reg_pair_rftune ) ] ;  enum mxl5007t_if_freq if_freq ;  u32 frequency ;  u32 bandwidth ; } cocci_id@p ;
...
position p;
@@
 enum mxl5007t_xtal_freq cocci_id@p ;
...
position p;
@@
 enum mxl5007t_if_freq cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,reg_pair_t;
@@
 struct reg_pair_t {  u8 reg ;  u8 val ; } cocci_id@p ;
