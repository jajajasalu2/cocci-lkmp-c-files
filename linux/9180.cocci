...
position p;
@@
 struct mlxsw_sp_mr_route * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_route_vif_entry * cocci_id@p ;
...
position p;
@@
 const struct mr_mfc * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_mr_table * cocci_id@p ;
...
typedef u16;
@@
 struct mlxsw_sp_mr_route {  struct list_head node ;  struct rhash_head ht_node ;  struct mlxsw_sp_mr_route_key key ;  enum mlxsw_sp_mr_route_action route_action ;  u16 min_mtu ;  struct mr_mfc * mfc ;  void * route_priv ;  const struct mlxsw_sp_mr_table * mr_table ;  struct list_head evif_list ;  struct mlxsw_sp_mr_route_vif_entry ivif ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_vif * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_vif {  struct net_device * dev ;  const struct mlxsw_sp_rif * rif ;  unsigned long vif_flags ;  struct list_head route_evif_list ;  struct list_head route_ivif_list ;  const struct mlxsw_sp_mr_vif_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_route_vif_entry {  struct list_head vif_node ;  struct list_head route_node ;  struct mlxsw_sp_mr_vif * mr_vif ;  struct mlxsw_sp_mr_route * mr_route ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_mr_vif * cocci_id@p ;
...
typedef bool;
@@
 struct mlxsw_sp_mr_table_ops {  bool ( * is_route_valid ) ( const struct mlxsw_sp_mr_table * mr_table , const struct mr_mfc * mfc ) ;  void ( * key_create ) ( struct mlxsw_sp_mr_table * mr_table , struct mlxsw_sp_mr_route_key * key , struct mr_mfc * mfc ) ;  bool ( * is_route_starg ) ( const struct mlxsw_sp_mr_table * mr_table , const struct mlxsw_sp_mr_route * mr_route ) ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_vif_ops cocci_id@p [ ] ;
...
position p;
@@
 struct mlxsw_sp_mr_route_key cocci_id@p ;
...
typedef u32;
@@
 struct mlxsw_sp_mr_table {  struct list_head node ;  enum mlxsw_sp_l3proto proto ;  struct mlxsw_sp * mlxsw_sp ;  u32 vr_id ;  struct mlxsw_sp_mr_vif vifs [ MAXVIFS ] ;  struct list_head route_list ;  struct rhashtable route_ht ;  const struct mlxsw_sp_mr_table_ops * ops ;  char catchall_route_priv [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_route_info * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_table_ops cocci_id@p [ ] ;
...
position p;
@@
 const struct mlxsw_sp_mr_route * cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_mr_route_action cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_mr_route_prio cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_mr_route_params cocci_id@p ;
...
typedef bool;
@@
 struct mlxsw_sp_mr_vif_ops {  bool ( * is_regular ) ( const struct mlxsw_sp_mr_vif * vif ) ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_mr_ops * cocci_id@p ;
