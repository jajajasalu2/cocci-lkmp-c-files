...
position p;
@@
 struct tuntap_pre_exec_data cocci_id@p ;
...
position p;
@@
 struct tuntap_pre_exec_data {  int stdout_fd ;  int close_me ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CMSG_SPACE ( sizeof ( * fd_out ) ) ] ;
