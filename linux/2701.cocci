...
typedef u32;
@@
 struct brcmstb_i2c_dev {  struct device * device ;  void __iomem * base ;  int irq ;  struct bsc_regs * bsc_regmap ;  struct i2c_adapter adapter ;  struct completion done ;  u32 clk_freq_hz ;  int data_regsz ; } cocci_id@p ;
...
position p;
@@
 struct brcmstb_i2c_dev * cocci_id@p ;
...
position p;
@@
 enum bsc_xfer_cmd { CMD_WR , CMD_RD , CMD_WR_NOACK , CMD_RD_NOACK , } cocci_id@p ;
...
position p;
@@
 const struct bsc_clk_param cocci_id@p [ ] ;
...
typedef u32;
@@
 struct bsc_clk_param {  u32 hz ;  u32 scl_mask ;  u32 div_mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct bsc_regs {  u32 chip_address ;  u32 data_in [ N_DATA_REGS ] ;  u32 cnt_reg ;  u32 ctl_reg ;  u32 iic_enable ;  u32 data_out [ N_DATA_REGS ] ;  u32 ctlhi_reg ;  u32 scl_param ; } cocci_id@p ;
...
position p;
@@
 enum bus_speeds { SPD_375K , SPD_390K , SPD_187K , SPD_200K , SPD_93K , SPD_97K , SPD_46K , SPD_50K , } cocci_id@p ;
