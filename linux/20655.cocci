...
position p;
@@
 int cocci_id@p [ UNCORE_PMC_IDX_MAX ] ;
...
position p;
@@
 unsigned long cocci_id@p [ BITS_TO_LONGS ( UNCORE_PMC_IDX_MAX ) ] ;
...
position p;
@@
 struct intel_uncore_pmu cocci_id@p ;
...
position p;
@@
 struct pci_extra_dev cocci_id@p ;
...
position p;
@@
 struct {  struct attribute_group group ;  struct attribute * attrs [ ] ; } * cocci_id@p ;
...
position p;
@@
 struct intel_uncore_init_fun * cocci_id@p ;
...
position p;
@@
 const struct intel_uncore_init_fun cocci_id@p ;
...
position p;
@@
 struct intel_uncore_init_fun {  void ( * cpu_init ) ( void ) ;  int ( * pci_init ) ( void ) ;  void ( * mmio_init ) ( void ) ; } cocci_id@p ;
