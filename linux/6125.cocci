...
position p;
@@
 struct usbhs_hcd_omap * cocci_id@p ;
...
position p;
@@
 enum usbhs_omap_port_mode cocci_id@p ;
...
position p;
@@
 struct usbhs_omap_platform_data * cocci_id@p ;
