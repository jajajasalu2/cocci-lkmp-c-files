...
position p;
@@
 struct ftm_clock_device * cocci_id@p ;
...
typedef bool;
@@
 struct ftm_clock_device {  void __iomem * clksrc_base ;  void __iomem * clkevt_base ;  unsigned long periodic_cyc ;  unsigned long ps ;  bool big_endian ; } cocci_id@p ;
