...
position p;
@@
 struct kvm_vfio_group {  struct list_head node ;  struct vfio_group * vfio_group ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct kvm_device * dev , u32 type ) ;
...
typedef bool;
@@
 struct kvm_vfio {  struct list_head group_list ;  struct mutex lock ;  bool noncoherent ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct vfio_group * ) ;
...
position p;
@@
 struct vfio_group * ( * cocci_id@p ) ( struct file * ) ;
...
position p;
@@
 long ( * cocci_id@p ) ( struct vfio_group * , unsigned long ) ;
...
position p;
@@
 struct kvm_vfio_spapr_tce cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct vfio_group * , struct kvm * ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct vfio_group * ) ;
...
position p;
@@
 struct kvm_vfio_group * cocci_id@p ;
