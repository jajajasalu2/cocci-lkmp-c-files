...
typedef atomic_t;
@@
 struct clock_sync_data {  atomic_t cpus ;  int in_sync ;  unsigned long long clock_delta ; } cocci_id@p ;
...
position p;
@@
 struct clock_sync_data cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct stp_irq_parm * ) ;
...
position p;
@@
 unsigned char cocci_id@p [ STORE_CLOCK_EXT_SIZE ] ;
...
position p;
@@
 struct stp_irq_parm * cocci_id@p ;
