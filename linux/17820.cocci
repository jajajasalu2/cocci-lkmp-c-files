...
symbol cocci_id;
position p;
typedef pal_cache_shared_info_t;
@@
 pal_cache_shared_info_t cocci_id@p ;
...
position p;
@@
 struct cpu_cache_info {  struct cache_info * cache_leaves ;  int num_cache_leaves ;  struct kobject kobj ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cpumask_t,pal_cache_config_info_t;
@@
 struct cache_info {  pal_cache_config_info_t cci ;  cpumask_t shared_cpu_map ;  int level ;  int type ;  struct kobject kobj ; } cocci_id@p ;
...
position p;
@@
 struct cpu_cache_info cocci_id@p [ NR_CPUS ] ;
