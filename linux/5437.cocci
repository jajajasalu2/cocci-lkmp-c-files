...
position p;
@@
 struct omap1_spi100k * cocci_id@p ;
...
position p;
@@
 struct omap1_spi100k {  struct clk * ick ;  struct clk * fck ;  void __iomem * base ; } cocci_id@p ;
...
position p;
@@
 struct omap1_spi100k_cs * cocci_id@p ;
...
position p;
@@
 struct omap1_spi100k_cs {  void __iomem * base ;  int word_len ; } cocci_id@p ;
