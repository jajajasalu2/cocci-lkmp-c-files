...
position p;
@@
 struct dm_stat_percpu {  unsigned long long sectors [ 2 ] ;  unsigned long long ios [ 2 ] ;  unsigned long long merges [ 2 ] ;  unsigned long long ticks [ 2 ] ;  unsigned long long io_ticks [ 2 ] ;  unsigned long long io_ticks_total ;  unsigned long long time_in_queue ;  unsigned long long * histogram ; } cocci_id@p ;
...
typedef sector_t;
@@
 struct dm_stat {  struct list_head list_entry ;  int id ;  unsigned stat_flags ;  size_t n_entries ;  sector_t start ;  sector_t end ;  sector_t step ;  unsigned n_histogram_entries ;  unsigned long long * histogram_boundaries ;  const char * program_id ;  const char * aux_data ;  struct rcu_head rcu_head ;  size_t shared_alloc_size ;  size_t percpu_alloc_size ;  size_t histogram_alloc_size ;  struct dm_stat_percpu * stat_percpu [ NR_CPUS ] ;  struct dm_stat_shared stat_shared [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct dm_stat_shared cocci_id@p ;
...
position p;
@@
 struct dm_stats_aux * cocci_id@p ;
...
position p;
@@
 struct dm_stats_last_position cocci_id@p ;
...
position p;
@@
 struct dm_stat_percpu cocci_id@p ;
...
typedef atomic_t;
@@
 struct dm_stat_shared {  atomic_t in_flight [ 2 ] ;  unsigned long long stamp ;  struct dm_stat_percpu tmp ; } cocci_id@p ;
...
typedef sector_t;
@@
 struct dm_stats_last_position {  sector_t last_sector ;  unsigned last_rw ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct mapped_device * ) ;
