...
position p;
@@
 enum count_cache_flush_type cocci_id@p ;
...
position p;
@@
 enum count_cache_flush_type { COUNT_CACHE_FLUSH_NONE = 0x1 , COUNT_CACHE_FLUSH_SW = 0x2 , COUNT_CACHE_FLUSH_HW = 0x4 , } cocci_id@p ;
