...
position p;
@@
 struct cxgbi_task_data * cocci_id@p ;
...
position p;
@@
 struct iscsi_tcp_task * cocci_id@p ;
...
position p;
@@
 struct iscsi_tcp_conn * cocci_id@p ;
...
position p;
@@
 struct cxgbi_endpoint * cocci_id@p ;
...
position p;
@@
 struct cxgbi_pagepod_hdr cocci_id@p ;
...
position p;
@@
 const struct cxgbi_sock * cocci_id@p ;
...
position p;
@@
 struct cxgbi_skb_cb cocci_id@p ;
