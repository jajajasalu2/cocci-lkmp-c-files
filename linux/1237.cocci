...
position p;
@@
 void cocci_id@p ( struct imx21 * imx21 , struct etd_priv * etd , int status ) ;
...
position p;
@@
 void cocci_id@p ( struct imx21 * imx21 , struct etd_priv * etd ) ;
...
position p;
@@
 struct imx21_dmem_area * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct imx21 * imx21 , struct urb * urb ) ;
...
position p;
@@
 struct mx21_usbh_platform_data cocci_id@p ;
