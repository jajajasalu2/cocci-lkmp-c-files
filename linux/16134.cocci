...
position p;
@@
 struct apci1032_private {  unsigned long amcc_iobase ;  unsigned int mode1 ;  unsigned int mode2 ;  unsigned int ctrl ; } cocci_id@p ;
...
position p;
@@
 struct apci1032_private * cocci_id@p ;
