...
position p;
@@
 struct mlxsw_m_port cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_m {  struct mlxsw_m_port * * ports ;  int * module_to_port ;  struct mlxsw_core * core ;  const struct mlxsw_bus_info * bus_info ;  u8 base_mac [ ETH_ALEN ] ;  u8 max_ports ; } cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_m_port {  struct net_device * dev ;  struct mlxsw_m * mlxsw_m ;  u8 local_port ;  u8 module ; } cocci_id@p ;
