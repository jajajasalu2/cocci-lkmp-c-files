...
position p;
@@
 struct pcf8584_channel {  unsigned char chnl_no ;  unsigned char io_direction ;  unsigned char type ;  unsigned char last ; } cocci_id@p ;
...
position p;
@@
 struct pcf8584_tblprop cocci_id@p ;
...
position p;
@@
 struct pcf8584_tblprop {  unsigned int type ;  unsigned int scale ;  unsigned int offset ;  unsigned int size ; } cocci_id@p ;
...
position p;
@@
 struct pcf8584_channel cocci_id@p ;
...
typedef i2c_child_t;
@@
 struct i2c_child_t * cocci_id@p ( unsigned char ) ;
...
typedef i2c_child_t;
@@
 struct i2c_child_t {  unsigned char i2ctype ;  unsigned long addr ;  struct pcf8584_channel chnl_array [ PCF8584_MAX_CHANNELS ] ;  unsigned int total_chnls ;  unsigned char fan_mask ;  unsigned char voltage_mask ;  struct pcf8584_tblprop tblprop_array [ PCF8584_MAX_CHANNELS ] ;  unsigned int total_tbls ;  char * tables ;  char chnls_desc [ CHANNEL_DESC_SZ ] ;  char mon_type [ PCF8584_MAX_CHANNELS ] ; } cocci_id@p ;
...
typedef i2c_child_t;
@@
 struct i2c_child_t cocci_id@p [ ENVCTRL_MAX_CPU * 2 ] ;
