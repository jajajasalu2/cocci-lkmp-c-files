...
position p;
@@
 const struct cfctrl_link_param * cocci_id@p ;
...
position p;
@@
 const struct cfctrl_request_info * cocci_id@p ;
...
position p;
@@
 struct cfctrl_request_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cfctrl * ctrl , int cmd , struct cfpkt * pkt ) ;
