...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( qcam_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( pmlp_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( qtct_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mcia_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( qpts_reg ) ] ;
...
position p;
@@
 struct mlx5_reg_pcap cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( pvlc_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mlcr_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( pcmr_reg ) ] ;
...
typedef u8,__be32;
@@
 struct mlx5_reg_pcap {  u8 rsvd0 ;  u8 port_num ;  u8 rsvd1 [ 2 ] ;  __be32 caps_127_96 ;  __be32 caps_95_64 ;  __be32 caps_63_32 ;  __be32 caps_31_0 ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_wol_rol_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_wol_rol_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( dcbx_param ) ] ;
...
position p;
@@
 enum mlx5_port_status cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( paos_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( pcam_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_wol_rol_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( pfcc_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mtppse_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mcam_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( qetc_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( mtpps_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( pmtu_reg ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_wol_rol_in ) ] ;
