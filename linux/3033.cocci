...
position p;
@@
 struct acpi_tsd_package * cocci_id@p ;
...
position p;
@@
 struct acpi_processor_tx_tss cocci_id@p ;
...
position p;
@@
 struct throttling_tstate * cocci_id@p ;
...
position p;
@@
 struct acpi_processor_throttling_arg cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct acpi_processor * pr ) ;
...
position p;
@@
 struct acpi_processor_limit * cocci_id@p ;
...
position p;
@@
 struct acpi_processor_throttling * cocci_id@p ;
...
typedef bool;
@@
 struct acpi_processor_throttling_arg {  struct acpi_processor * pr ;  int target_state ;  bool force ; } cocci_id@p ;
...
position p;
@@
 struct acpi_ptc_register cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct acpi_processor * pr , int state , bool force , bool direct ) ;
...
position p;
@@
 struct throttling_tstate {  unsigned int cpu ;  int target_state ; } cocci_id@p ;
