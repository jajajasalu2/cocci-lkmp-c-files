...
typedef u16;
@@
 struct mulaw_priv {  mulaw_f func ;  int cvt_endian ;  unsigned int native_ofs ;  unsigned int copy_ofs ;  unsigned int native_bytes ;  unsigned int copy_bytes ;  u16 flip ; } cocci_id@p ;
