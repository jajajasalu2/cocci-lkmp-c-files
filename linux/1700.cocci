...
position p;
@@
 const struct iio_cb_buffer * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const void * data , void * private ) ;
...
position p;
@@
 struct iio_cb_buffer {  struct iio_buffer buffer ;  int ( * cb ) ( const void * data , void * private ) ;  void * private ;  struct iio_channel * channels ;  struct iio_dev * indio_dev ; } cocci_id@p ;
...
position p;
@@
 struct iio_cb_buffer cocci_id@p ;
