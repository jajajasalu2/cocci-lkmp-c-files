...
position p;
@@
 struct bpf_offload_dev {  const struct bpf_prog_offload_ops * ops ;  struct list_head netdevs ;  void * priv ; } cocci_id@p ;
...
position p;
@@
 enum bpf_netdev_command cocci_id@p ;
...
position p;
@@
 struct ns_get_path_bpf_prog_args {  struct bpf_prog * prog ;  struct bpf_prog_info * info ; } cocci_id@p ;
...
position p;
@@
 struct ns_get_path_bpf_prog_args * cocci_id@p ;
...
position p;
@@
 struct bpf_offload_netdev {  struct rhash_head l ;  struct net_device * netdev ;  struct bpf_offload_dev * offdev ;  struct list_head progs ;  struct list_head maps ;  struct list_head offdev_netdevs ; } cocci_id@p ;
...
position p;
@@
 struct ns_get_path_bpf_map_args {  struct bpf_offloaded_map * offmap ;  struct bpf_map_info * info ; } cocci_id@p ;
...
position p;
@@
 const struct bpf_prog_offload_ops * cocci_id@p ;
...
position p;
@@
 struct bpf_offload_netdev cocci_id@p ;
...
position p;
@@
 struct bpf_prog_offload * cocci_id@p ;
...
position p;
@@
 struct bpf_offload_dev * cocci_id@p ;
...
position p;
@@
 struct bpf_offloaded_map * cocci_id@p ;
...
position p;
@@
 struct ns_get_path_bpf_map_args * cocci_id@p ;
