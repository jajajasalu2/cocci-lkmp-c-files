...
position p;
@@
 struct binary_header cocci_id@p ;
...
position p;
@@
 struct ip_discovery_header * cocci_id@p ;
...
position p;
@@
 struct gc_info_v1_0 * cocci_id@p ;
...
position p;
@@
 struct gpu_info_header * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ HW_ID_MAX ] ;
