...
position p;
@@
 const struct lochnagar_pin * cocci_id@p ;
...
position p;
@@
 const struct lochnagar_group cocci_id@p [ ] ;
...
typedef bool;
@@
 struct lochnagar_pin {  const char name [ 20 ] ;  enum lochnagar_pin_type type ;  unsigned int reg ;  int shift ;  bool invert ; } cocci_id@p ;
...
position p;
@@
 struct lochnagar_pin_priv {  struct lochnagar * lochnagar ;  struct device * dev ;  const struct lochnagar_func * funcs ;  unsigned int nfuncs ;  const struct pinctrl_pin_desc * pins ;  unsigned int npins ;  const struct lochnagar_group * groups ;  unsigned int ngroups ;  struct lochnagar_func_groups func_groups [ LN_FTYPE_COUNT ] ;  struct gpio_chip gpio_chip ; } cocci_id@p ;
...
position p;
@@
 const struct lochnagar_aif * cocci_id@p ;
...
position p;
@@
 struct lochnagar_group {  const char * const name ;  enum lochnagar_func_type type ;  const unsigned int * pins ;  unsigned int npins ;  const void * priv ; } cocci_id@p ;
...
position p;
@@
 enum lochnagar_func_type { LN_FTYPE_PIN , LN_FTYPE_AIF , LN_FTYPE_COUNT , } cocci_id@p ;
...
position p;
@@
 const struct lochnagar_func * cocci_id@p ;
...
position p;
@@
 struct lochnagar_func_groups {  const char * * groups ;  unsigned int ngroups ; } cocci_id@p ;
...
typedef u8;
@@
 struct lochnagar_func {  const char * const name ;  enum lochnagar_func_type type ;  u8 op ; } cocci_id@p ;
...
position p;
@@
 struct lochnagar_pin_priv * cocci_id@p ;
...
position p;
@@
 struct lochnagar_func_groups * cocci_id@p ;
...
position p;
@@
 enum lochnagar_pin_type { LN_PTYPE_GPIO , LN_PTYPE_MUX , LN_PTYPE_AIF , LN_PTYPE_COUNT , } cocci_id@p ;
...
typedef u16;
@@
 struct lochnagar_aif {  const char name [ 16 ] ;  unsigned int pins [ 4 ] ;  u16 src_reg ;  u16 src_mask ;  u16 ctrl_reg ;  u16 ena_mask ;  u16 master_mask ; } cocci_id@p ;
...
position p;
@@
 const struct pinctrl_desc cocci_id@p ;
