...
position p;
@@
 struct dmar_drhd_unit * cocci_id@p ;
...
position p;
@@
 struct device_domain_info cocci_id@p ;
...
position p;
@@
 struct iommu_device * cocci_id@p ;
...
position p;
@@
 struct acpi_dmar_reserved_memory cocci_id@p ;
...
position p;
@@
 struct dmar_pci_notify_info * cocci_id@p ;
...
position p;
@@
 enum iommu_resv_type cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct device * dev ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device_domain_info * info , void * data ) ;
...
typedef u8;
@@
 struct dmar_atsr_unit {  struct list_head list ;  struct acpi_dmar_header * hdr ;  struct dmar_dev_scope * devices ;  int devices_cnt ;  u8 include_all : 1 ; } cocci_id@p ;
...
position p;
@@
 struct dmar_rmrr_unit * cocci_id@p ;
...
position p;
@@
 struct acpi_dmar_atsr cocci_id@p ;
...
position p;
@@
 struct domain_context_mapping_data {  struct dmar_domain * domain ;  struct intel_iommu * iommu ;  struct pasid_table * table ; } cocci_id@p ;
...
position p;
@@
 struct domain_context_mapping_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dmar_domain * domain ) ;
...
position p;
@@
 enum dma_sync_target cocci_id@p ;
...
position p;
@@
 enum iommu_dev_features cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dmar_domain * domain , int guest_width ) ;
...
position p;
@@
 const struct dma_map_ops cocci_id@p ;
...
position p;
@@
 struct context_entry * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct device_domain_info * info ) ;
...
position p;
@@
 struct dmar_atsr_unit * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct iommu_domain * domain , struct device * dev ) ;
...
position p;
@@
 int cocci_id@p ( struct dmar_domain * domain , struct intel_iommu * iommu ) ;
...
position p;
@@
 struct acpi_dmar_header * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct intel_iommu * iommu , struct device * dev ) ;
...
position p;
@@
 struct acpi_device_physical_node * cocci_id@p ;
...
typedef u64;
@@
 struct dmar_rmrr_unit {  struct list_head list ;  struct acpi_dmar_header * hdr ;  u64 base_address ;  u64 end_address ;  struct dmar_dev_scope * devices ;  int devices_cnt ; } cocci_id@p ;
...
position p;
@@
 const struct iommu_ops cocci_id@p ;
