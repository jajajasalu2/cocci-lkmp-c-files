...
position p;
@@
 struct libipw_reassoc_request * cocci_id@p ;
...
position p;
@@
 struct libipw_probe_request * cocci_id@p ;
...
position p;
@@
 struct libipw_disassoc * cocci_id@p ;
...
position p;
@@
 struct libipw_qos_parameter_info cocci_id@p ;
...
position p;
@@
 struct libipw_info_element * cocci_id@p ;
...
position p;
@@
 struct libipw_frag_entry * cocci_id@p ;
...
position p;
@@
 struct libipw_qos_ac_parameter * cocci_id@p ;
...
position p;
@@
 struct libipw_action * cocci_id@p ;
...
position p;
@@
 struct libipw_deauth * cocci_id@p ;
