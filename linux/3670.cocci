...
position p;
@@
 struct edd_attribute * cocci_id@p [ ] ;
...
position p;
@@
 struct edd_device {  unsigned int index ;  unsigned int mbr_signature ;  struct edd_info * info ;  struct kobject kobj ; } cocci_id@p ;
...
position p;
@@
 struct pci_dev * cocci_id@p ( struct edd_device * edev ) ;
...
position p;
@@
 struct edd_device * cocci_id@p [ EDD_MBR_SIG_MAX ] ;
...
position p;
@@
 int cocci_id@p ( struct edd_device * edev , const char * type ) ;
...
position p;
@@
 struct edd_attribute {  struct attribute attr ;  ssize_t ( * show ) ( struct edd_device * edev , char * buf ) ;  int ( * test ) ( struct edd_device * edev ) ; } cocci_id@p ;
