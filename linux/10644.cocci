...
typedef bool;
@@
 bool cocci_id@p ( struct kvmgt_guest_info * info ) ;
...
symbol cocci_id;
position p;
typedef dma_addr_t,gfn_t;
@@
 struct gvt_dma {  struct intel_vgpu * vgpu ;  struct rb_node gfn_node ;  struct rb_node dma_addr_node ;  gfn_t gfn ;  dma_addr_t dma_addr ;  unsigned long size ;  struct kref ref ; } cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct intel_vgpu * vgpu , unsigned int index , unsigned int start , unsigned int count , u32 flags , void * data ) ;
...
position p;
@@
 const struct intel_gvt_ops * cocci_id@p ;
...
position p;
@@
 const struct intel_vgpu_regops * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mdev_device * mdev ) ;
...
position p;
@@
 struct vfio_edid_region * cocci_id@p ;
...
position p;
@@
 struct vfio_region_info_cap_sparse_mmap * cocci_id@p ;
...
position p;
@@
 struct vfio_edid_region {  struct vfio_region_gfx_edid vfio_edid_regs ;  void * edid_blob ; } cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_type * cocci_id@p ;
...
position p;
@@
 struct mdev_parent_ops cocci_id@p ;
...
typedef u32;
@@
 struct vfio_region {  u32 type ;  u32 subtype ;  size_t size ;  u32 flags ;  const struct intel_vgpu_regops * ops ;  void * data ; } cocci_id@p ;
...
position p;
@@
 struct kvmgt_guest_info cocci_id@p ;
...
position p;
@@
 struct intel_gvt_mpt cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_port * cocci_id@p ;
...
typedef gfn_t;
@@
 struct kvmgt_pgfn {  gfn_t gfn ;  struct hlist_node hnode ; } cocci_id@p ;
