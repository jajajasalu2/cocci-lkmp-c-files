...
typedef u8;
@@
 struct sun8i_codec_clk_div {  u8 div ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 struct sun8i_codec {  struct device * dev ;  struct regmap * regmap ;  struct clk * clk_module ;  struct clk * clk_bus ; } cocci_id@p ;
...
position p;
@@
 const struct sun8i_codec_clk_div * cocci_id@p ;
