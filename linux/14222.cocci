...
position p;
@@
 struct hfi_session_set_buffers_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_session_get_property_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_session_flush_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_profile_level * cocci_id@p ;
...
position p;
@@
 struct hfi_sys_ping_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_sys_pc_prep_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_sys_set_property_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_vc1e_perf_cfg_type * cocci_id@p ;
...
position p;
@@
 struct hfi_intra_refresh * cocci_id@p ;
...
position p;
@@
 struct hfi_scs_threshold * cocci_id@p ;
...
position p;
@@
 struct hfi_uncompressed_format_select * cocci_id@p ;
...
position p;
@@
 struct hfi_conceal_color * cocci_id@p ;
...
position p;
@@
 struct hfi_session_init_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_resource_ocmem * cocci_id@p ;
...
position p;
@@
 struct hfi_h264_vui_timing_info * cocci_id@p ;
...
position p;
@@
 struct hfi_enable_picture * cocci_id@p ;
...
position p;
@@
 struct hfi_h264_db_control * cocci_id@p ;
...
position p;
@@
 struct hfi_sys_init_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_quantization * cocci_id@p ;
...
position p;
@@
 struct hfi_intra_refresh_3x * cocci_id@p ;
...
position p;
@@
 struct hfi_max_num_b_frames * cocci_id@p ;
...
position p;
@@
 struct hfi_mvc_buffer_layout_descp_type * cocci_id@p ;
...
position p;
@@
 struct hfi_vpe_color_space_conversion * cocci_id@p ;
...
position p;
@@
 struct hfi_session_empty_buffer_compressed_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_sys_release_resource_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_operations_type * cocci_id@p ;
...
position p;
@@
 struct hfi_h264_entropy_control * cocci_id@p ;
...
position p;
@@
 struct hfi_framesize * cocci_id@p ;
...
position p;
@@
 struct hfi_debug_config * cocci_id@p ;
...
position p;
@@
 struct hfi_session_set_property_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_buffer_alloc_mode * cocci_id@p ;
...
position p;
@@
 struct hfi_mpeg4_header_extension * cocci_id@p ;
...
position p;
@@
 struct hfi_sys_test_ssr_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_buffer_size_actual * cocci_id@p ;
...
position p;
@@
 struct hfi_buffer_display_hold_count_actual * cocci_id@p ;
...
position p;
@@
 struct hfi_quantization_range * cocci_id@p ;
...
position p;
@@
 struct hfi_framerate * cocci_id@p ;
...
position p;
@@
 struct hfi_videocores_usage_type * cocci_id@p ;
...
position p;
@@
 struct hfi_session_fill_buffer_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_idr_period * cocci_id@p ;
...
position p;
@@
 struct hfi_buffer_count_actual * cocci_id@p ;
...
position p;
@@
 struct hfi_sys_set_resource_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_sys_get_property_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_session_release_buffer_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_session_parse_sequence_header_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_multi_stream * cocci_id@p ;
...
position p;
@@
 struct hfi_intra_period * cocci_id@p ;
...
position p;
@@
 struct hfi_mpeg4_time_resolution * cocci_id@p ;
...
position p;
@@
 struct hfi_session_get_sequence_header_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_buffer_count_actual_4xx * cocci_id@p ;
...
position p;
@@
 struct hfi_ltr_mark * cocci_id@p ;
...
position p;
@@
 struct hfi_nal_stream_format_select * cocci_id@p ;
...
position p;
@@
 struct hfi_initial_quantization * cocci_id@p ;
...
position p;
@@
 struct hfi_buffer_desc * cocci_id@p ;
...
position p;
@@
 struct hfi_display_picture_buffer_count * cocci_id@p ;
...
position p;
@@
 struct hfi_multi_stream_3x * cocci_id@p ;
...
position p;
@@
 struct hfi_ltr_mode * cocci_id@p ;
...
position p;
@@
 struct hfi_frame_data * cocci_id@p ;
...
position p;
@@
 struct hfi_session_empty_buffer_uncompressed_plane0_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_buffer_info * cocci_id@p ;
...
position p;
@@
 struct hfi_hybrid_hierp * cocci_id@p ;
...
position p;
@@
 struct hfi_session_pkt * cocci_id@p ;
...
position p;
@@
 struct hfi_video_work_mode * cocci_id@p ;
...
position p;
@@
 struct hfi_multi_slice_control * cocci_id@p ;
