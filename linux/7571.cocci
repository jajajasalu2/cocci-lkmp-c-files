...
position p;
@@
 struct uvesafb_ktask * cocci_id@p ;
...
position p;
@@
 struct uvesafb_pal_entry * cocci_id@p ;
...
position p;
@@
 struct uvesafb_task * cocci_id@p ;
...
position p;
@@
 struct uvesafb_ktask * cocci_id@p [ UVESAFB_TASKS_MAX ] ;
