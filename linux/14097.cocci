...
typedef u32;
@@
 struct vim2m_fmt {  u32 fourcc ;  int depth ;  u32 types ; } cocci_id@p ;
...
position p;
@@
 struct vim2m_q_data * cocci_id@p ;
...
position p;
@@
 struct vim2m_q_data {  unsigned int width ;  unsigned int height ;  unsigned int sizeimage ;  unsigned int sequence ;  struct vim2m_fmt * fmt ; } cocci_id@p ;
...
@@
 struct vim2m_ctx {  struct v4l2_fh fh ;  struct vim2m_dev * dev ;  struct v4l2_ctrl_handler hdl ;  u8 num_processed ;  u32 translen ;  u32 transtime ;  struct mutex vb_mutex ;  struct delayed_work work_run ;  spinlock_t irqlock ;  int aborting ;  int mode ;  enum v4l2_colorspace colorspace ;  enum v4l2_ycbcr_encoding ycbcr_enc ;  enum v4l2_xfer_func xfer_func ;  enum v4l2_quantization quant ;  struct vim2m_q_data q_data [ 2 ] ; } cocci_id@p ;
