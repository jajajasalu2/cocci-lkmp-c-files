...
typedef u8;
@@
 struct nic78bx_led {  u8 bit ;  u8 mask ;  struct nic78bx_led_data * data ;  struct led_classdev cdev ; } cocci_id@p ;
...
@@
 struct nic78bx_led_data {  u16 io_base ;  spinlock_t lock ;  struct platform_device * pdev ; } cocci_id@p ;
...
position p;
@@
 struct nic78bx_led_data * cocci_id@p ;
