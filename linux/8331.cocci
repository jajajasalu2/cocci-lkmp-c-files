...
position p;
@@
 struct cvmx_bootmem_named_block_desc * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ OCTEON_CONSOLE_MAX_READ_BYTES ] ;
...
typedef u32;
@@
 int cocci_id@p ( struct octeon_device * oct , u32 console_num , char * buffer , u32 buf_size ) ;
...
position p;
@@
 struct octeon_firmware_file_header cocci_id@p ;
...
typedef u64,u32;
@@
 struct octeon_pci_console {  u64 input_base_addr ;  u32 input_read_index ;  u32 input_write_index ;  u64 output_base_addr ;  u32 output_read_index ;  u32 output_write_index ;  u32 lock ;  u32 buf_size ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct cvmx_bootmem_desc {  u32 lock ;  u32 flags ;  u64 head_addr ;  u32 major_version ;  u32 minor_version ;  u64 app_data_addr ;  u64 app_data_size ;  u32 nb_num_blocks ;  u32 named_block_name_len ;  u64 named_block_array_addr ; } cocci_id@p ;
...
typedef u64,u32;
@@
 u64 cocci_id@p ( struct octeon_device * oct , const char * name , u32 flags ) ;
...
position p;
@@
 char cocci_id@p [ MAX_BOOTTIME_SIZE ] ;
...
typedef u64,u32;
@@
 struct octeon_pci_console_desc {  u32 major_version ;  u32 minor_version ;  u32 lock ;  u32 flags ;  u32 num_consoles ;  u32 pad ;  u64 console_addr_array [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct octeon_pci_console cocci_id@p ;
...
position p;
@@
 struct cvmx_bootmem_desc cocci_id@p ;
...
position p;
@@
 struct octeon_pci_console_desc cocci_id@p ;
...
position p;
@@
 const struct cvmx_bootmem_named_block_desc * cocci_id@p ;
...
position p;
@@
 struct octeon_console * cocci_id@p ;
