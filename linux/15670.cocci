...
position p;
@@
 struct gb_hid_input_report_request * cocci_id@p ;
...
position p;
@@
 struct gb_hid_get_report_request cocci_id@p ;
...
position p;
@@
 struct gb_hid_set_report_request * cocci_id@p ;
