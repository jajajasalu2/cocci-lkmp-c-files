...
typedef u32;
@@
 struct clk_icst {  struct clk_hw hw ;  struct regmap * map ;  u32 vcoreg_off ;  u32 lockreg_off ;  struct icst_params * params ;  unsigned long rate ;  enum icst_control_type ctype ; } cocci_id@p ;
...
position p;
@@
 const struct clk_icst_desc * cocci_id@p ;
...
position p;
@@
 struct clk_icst_desc cocci_id@p ;
...
position p;
@@
 enum icst_control_type { ICST_VERSATILE , ICST_INTEGRATOR_AP_CM , ICST_INTEGRATOR_AP_SYS , ICST_INTEGRATOR_AP_PCI , ICST_INTEGRATOR_CP_CM_CORE , ICST_INTEGRATOR_CP_CM_MEM , } cocci_id@p ;
...
position p;
@@
 const struct icst_params cocci_id@p ;
...
position p;
@@
 enum icst_control_type cocci_id@p ;
