...
position p;
@@
 struct rds_ib_cache_head cocci_id@p ;
...
position p;
@@
 struct rds_page_frag * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct list_head * new_item , struct rds_ib_refill_cache * cache ) ;
...
position p;
@@
 struct rds_ib_incoming cocci_id@p ;
...
position p;
@@
 struct rds_inc_usercopy cocci_id@p ;
...
position p;
@@
 struct list_head * cocci_id@p ( struct rds_ib_refill_cache * cache ) ;
...
position p;
@@
 struct rds_ib_refill_cache * cocci_id@p ;
