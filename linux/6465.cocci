...
position p;
@@
 struct tps51632_chip {  struct device * dev ;  struct regulator_desc desc ;  struct regulator_dev * rdev ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct tps51632_chip * cocci_id@p ;
...
position p;
@@
 struct tps51632_regulator_platform_data * cocci_id@p ;
