...
position p;
@@
 const struct sti_dwmac_of_data * cocci_id@p ;
...
position p;
@@
 struct sti_dwmac_of_data {  void ( * fix_retime_src ) ( void * priv , unsigned int speed ) ; } cocci_id@p ;
...
position p;
@@
 enum { TX_RETIME_SRC_NA = 0 , TX_RETIME_SRC_TXCLK = 1 , TX_RETIME_SRC_CLK_125 , TX_RETIME_SRC_PHYCLK , TX_RETIME_SRC_CLKGEN , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,phy_interface_t;
@@
 struct sti_dwmac {  phy_interface_t interface ;  bool ext_phyclk ;  u32 tx_retime_src ;  struct clk * clk ;  u32 ctrl_reg ;  int clk_sel_reg ;  struct regmap * regmap ;  bool gmac_en ;  u32 speed ;  void ( * fix_retime_src ) ( void * priv , unsigned int speed ) ; } cocci_id@p ;
