...
typedef __be32;
@@
 __be32 ( * cocci_id@p ) ( struct cmp_connection * c , __be32 old ) ;
...
typedef __be32;
@@
 int ( * cocci_id@p ) ( struct cmp_connection * c , __be32 pcr ) ;
...
position p;
@@
 enum bus_reset_handling cocci_id@p ;
...
position p;
@@
 enum bus_reset_handling { ABORT_ON_BUS_RESET , SUCCEED_ON_BUS_RESET , } cocci_id@p ;
