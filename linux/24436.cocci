...
position p;
@@
 struct nlattr * cocci_id@p [ NL80211_PMSR_REQ_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NL80211_PMSR_FTM_REQ_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NL80211_PMSR_PEER_ATTR_MAX + 1 ] ;
