...
position p;
@@
 struct wf_sat_sensor cocci_id@p ;
...
position p;
@@
 struct wf_sat_sensor {  struct list_head link ;  int index ;  int index2 ;  int shift ;  struct wf_sat * sat ;  struct wf_sensor sens ; } cocci_id@p ;
...
typedef u8;
@@
 struct wf_sat {  struct kref ref ;  int nr ;  struct mutex mutex ;  unsigned long last_read ;  u8 cache [ 16 ] ;  struct list_head sensors ;  struct i2c_client * i2c ;  struct device_node * node ; } cocci_id@p ;
...
position p;
@@
 const struct wf_sensor_ops cocci_id@p ;
