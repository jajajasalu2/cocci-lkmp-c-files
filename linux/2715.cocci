...
typedef u8,u32;
@@
 struct sirfsoc_i2c {  void __iomem * base ;  struct clk * clk ;  u32 cmd_ptr ;  u8 * buf ;  u32 msg_len ;  u32 finished_len ;  u32 read_cmd_len ;  int msg_read ;  int err_status ;  u32 sda_delay ;  u32 clk_div ;  int last ;  struct completion done ;  struct i2c_adapter adapter ; } cocci_id@p ;
