...
position p;
@@
 struct arizona_voice_trigger_info cocci_id@p ;
...
position p;
@@
 struct wm5110_priv {  struct arizona_priv core ;  struct arizona_fll fll [ 2 ] ;  unsigned int in_value ;  int in_pre_pending ;  int in_post_pending ;  unsigned int in_pga_cache [ 6 ] ; } cocci_id@p ;
