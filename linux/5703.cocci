...
position p;
@@
 enum slimbus_resp_enum_type_v01 { SLIMBUS_RESP_ENUM_TYPE_MIN_VAL_V01 = INT_MIN , SLIMBUS_RESP_SYNCHRONOUS_V01 = 1 , SLIMBUS_RESP_ENUM_TYPE_MAX_VAL_V01 = INT_MAX , } cocci_id@p ;
...
position p;
@@
 struct qcom_slim_ngd_qmi cocci_id@p ;
...
position p;
@@
 enum slimbus_pm_enum_type_v01 { SLIMBUS_PM_ENUM_TYPE_MIN_ENUM_VAL_V01 = INT_MIN , SLIMBUS_PM_INACTIVE_V01 = 1 , SLIMBUS_PM_ACTIVE_V01 = 2 , SLIMBUS_PM_ENUM_TYPE_MAX_ENUM_VAL_V01 = INT_MAX , } cocci_id@p ;
...
position p;
@@
 struct slimbus_power_resp_msg_v01 * cocci_id@p ;
...
position p;
@@
 struct qcom_slim_ngd_dma_desc * cocci_id@p ;
...
position p;
@@
 struct qcom_slim_ngd_qmi {  struct qmi_handle qmi ;  struct sockaddr_qrtr svc_info ;  struct qmi_handle svc_event_hdl ;  struct qmi_response_type_v01 resp ;  struct qmi_handle * handle ;  struct completion qmi_comp ; } cocci_id@p ;
...
position p;
@@
 struct qcom_slim_ngd_ctrl cocci_id@p ;
...
position p;
@@
 struct slimbus_select_inst_req_msg_v01 cocci_id@p ;
...
position p;
@@
 struct qmi_elem_info cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef uint8_t,uint32_t;
@@
 struct slimbus_select_inst_req_msg_v01 {  uint32_t instance ;  uint8_t mode_valid ;  enum slimbus_mode_enum_type_v01 mode ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dma_cookie_t,dma_addr_t;
@@
 struct qcom_slim_ngd_dma_desc {  struct dma_async_tx_descriptor * desc ;  struct qcom_slim_ngd_ctrl * ctrl ;  struct completion * comp ;  dma_cookie_t cookie ;  dma_addr_t phys ;  void * base ; } cocci_id@p ;
...
position p;
@@
 struct slimbus_power_req_msg_v01 * cocci_id@p ;
...
position p;
@@
 struct slimbus_select_inst_resp_msg_v01 cocci_id@p ;
...
typedef uint8_t;
@@
 struct slimbus_power_req_msg_v01 {  enum slimbus_pm_enum_type_v01 pm_req ;  uint8_t resp_type_valid ;  enum slimbus_resp_enum_type_v01 resp_type ; } cocci_id@p ;
...
position p;
@@
 struct slim_val_inf cocci_id@p ;
...
position p;
@@
 struct slim_msg_txn cocci_id@p ;
...
position p;
@@
 struct sockaddr_qrtr * cocci_id@p ;
...
position p;
@@
 const struct ngd_reg_offset_data cocci_id@p ;
...
position p;
@@
 struct qmi_msg_handler cocci_id@p [ ] ;
...
position p;
@@
 enum slimbus_resp_enum_type_v01 cocci_id@p ;
...
position p;
@@
 enum qcom_slim_ngd_state cocci_id@p ;
...
position p;
@@
 struct slimbus_power_resp_msg_v01 {  struct qmi_response_type_v01 resp ; } cocci_id@p ;
...
position p;
@@
 enum slimbus_mode_enum_type_v01 { SLIMBUS_MODE_ENUM_TYPE_MIN_ENUM_VAL_V01 = INT_MIN , SLIMBUS_MODE_SATELLITE_V01 = 1 , SLIMBUS_MODE_MASTER_V01 = 2 , SLIMBUS_MODE_ENUM_TYPE_MAX_ENUM_VAL_V01 = INT_MAX , } cocci_id@p ;
...
position p;
@@
 enum slimbus_mode_enum_type_v01 cocci_id@p ;
...
position p;
@@
 enum qcom_slim_ngd_state { QCOM_SLIM_NGD_CTRL_AWAKE , QCOM_SLIM_NGD_CTRL_IDLE , QCOM_SLIM_NGD_CTRL_ASLEEP , QCOM_SLIM_NGD_CTRL_DOWN , } cocci_id@p ;
...
position p;
@@
 struct slim_controller * cocci_id@p ;
...
position p;
@@
 struct slim_stream_runtime * cocci_id@p ;
...
position p;
@@
 enum slimbus_pm_enum_type_v01 cocci_id@p ;
...
position p;
@@
 struct qcom_slim_ngd {  struct platform_device * pdev ;  void __iomem * base ;  int id ; } cocci_id@p ;
...
position p;
@@
 struct slimbus_select_inst_resp_msg_v01 {  struct qmi_response_type_v01 resp ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SLIM_MSGQ_BUF_LEN ] ;
...
position p;
@@
 struct qcom_slim_ngd cocci_id@p ;
...
position p;
@@
 struct qmi_response_type_v01 cocci_id@p ;
