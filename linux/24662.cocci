...
position p;
@@
 const struct hash_netportnet6_elem * cocci_id@p ;
...
position p;
@@
 struct hash_netportnet6_elem * cocci_id@p ;
...
position p;
@@
 struct hash_netportnet4_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_netportnet4 * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u16,__be32,__be64;
@@
 struct hash_netportnet4_elem {  union {  __be32 ip [ 2 ] ;  __be64 ipcmp ; } ;  __be16 port ;  union {  u8 cidr [ 2 ] ;  u16 ccmp ; } ;  u16 padding ;  u8 nomatch ;  u8 proto ; } cocci_id@p ;
...
position p;
@@
 const struct hash_netportnet6 * cocci_id@p ;
...
position p;
@@
 const struct hash_netportnet4_elem * cocci_id@p ;
...
typedef u8,u16;
@@
 struct hash_netportnet6_elem {  union nf_inet_addr ip [ 2 ] ;  __be16 port ;  union {  u8 cidr [ 2 ] ;  u16 ccmp ; } ;  u16 padding ;  u8 nomatch ;  u8 proto ; } cocci_id@p ;
