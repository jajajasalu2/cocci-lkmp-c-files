...
position p;
@@
 enum bfa_status cocci_id@p ( void __iomem * rb , enum bfi_asic_mode asic_mode ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct bfa_ioc * ioc , bool msix ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioc * ioc , enum bfi_ioc_state fwstate ) ;
...
typedef u32;
@@
 const struct {  u32 hfn ;  u32 lpu ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 const struct {  u32 hfn_mbox ;  u32 lpu_mbox ;  u32 hfn_pgn ;  u32 hfn ;  u32 lpu ;  u32 lpu_read ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct bfa_ioc_hwif cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct bfa_ioc * ioc ) ;
...
position p;
@@
 enum bfi_ioc_state cocci_id@p ( struct bfa_ioc * ioc ) ;
...
typedef u32;
@@
 const struct {  u32 hfn_mbox ;  u32 lpu_mbox ;  u32 hfn_pgn ; } cocci_id@p [ ] ;
