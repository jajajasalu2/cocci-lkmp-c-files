...
position p;
@@
 struct l2tp_dfs_seq_data * cocci_id@p ;
...
position p;
@@
 struct l2tp_dfs_seq_data {  struct net * net ;  int tunnel_idx ;  int session_idx ;  struct l2tp_tunnel * tunnel ;  struct l2tp_session * session ; } cocci_id@p ;
