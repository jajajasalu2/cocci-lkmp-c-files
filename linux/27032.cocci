...
position p;
@@
 struct xfs_defer_pending cocci_id@p ;
...
position p;
@@
 struct xfs_inode * cocci_id@p [ XFS_DEFER_OPS_NR_INODES ] ;
...
position p;
@@
 struct xfs_buf * cocci_id@p [ XFS_DEFER_OPS_NR_BUFS ] ;
...
position p;
@@
 enum xfs_defer_ops_type cocci_id@p ;
