...
position p;
@@
 struct sd {  struct gspca_dev gspca_dev ;  struct {  struct v4l2_ctrl * exposure ;  struct v4l2_ctrl * gain ; } ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct dtcs033_usb_requests {  u8 bRequestType ;  u8 bRequest ;  u16 wValue ;  u16 wIndex ;  u16 wLength ; } cocci_id@p ;
...
position p;
@@
 const struct dtcs033_usb_requests * cocci_id@p ;
