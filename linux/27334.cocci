...
position p;
@@
 struct smb2_symlink_err_rsp cocci_id@p ;
...
typedef bool,__u32;
@@
 void cocci_id@p ( struct cifsInodeInfo * cinode , __u32 oplock , unsigned int epoch , bool * purge_cache ) ;
...
position p;
@@
 struct smb_query_info cocci_id@p ;
...
position p;
@@
 struct cifs_server_iface * cocci_id@p ;
...
position p;
@@
 struct resume_key_req cocci_id@p ;
...
position p;
@@
 struct smb2_err_rsp * cocci_id@p ;
...
position p;
@@
 struct smb_snapshot_array cocci_id@p ;
...
position p;
@@
 struct smb2_transform_hdr cocci_id@p ;
...
position p;
@@
 struct cifsInodeInfo * cocci_id@p ;
...
position p;
@@
 struct create_lease_v2 cocci_id@p ;
...
position p;
@@
 const struct cifs_fid * cocci_id@p ;
...
position p;
@@
 struct smb_version_values cocci_id@p ;
...
position p;
@@
 struct iface_info_ipv6 * cocci_id@p ;
...
position p;
@@
 struct smb2_decrypt_work {  struct work_struct decrypt ;  struct TCP_Server_Info * server ;  struct page * * ppages ;  char * buf ;  unsigned int npages ;  unsigned int len ; } cocci_id@p ;
...
position p;
@@
 struct fsctl_set_integrity_information_req cocci_id@p ;
...
position p;
@@
 struct lease_context cocci_id@p ;
...
position p;
@@
 struct smb2_decrypt_work * cocci_id@p ;
...
position p;
@@
 struct reparse_symlink_data_buffer * cocci_id@p ;
...
position p;
@@
 struct copychunk_ioctl * cocci_id@p ;
...
position p;
@@
 struct create_lease cocci_id@p ;
...
position p;
@@
 const struct cifs_credits * cocci_id@p ;
...
position p;
@@
 struct network_interface_info_ioctl_rsp * cocci_id@p ;
...
position p;
@@
 struct duplicate_extents_to_file cocci_id@p ;
...
position p;
@@
 struct file_allocated_range_buffer cocci_id@p ;
...
position p;
@@
 const struct cifs_server_iface * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SMB2_SIGNATURE_SIZE ] ;
...
position p;
@@
 struct copychunk_ioctl_rsp cocci_id@p ;
...
position p;
@@
 struct iface_info_ipv4 * cocci_id@p ;
...
position p;
@@
 struct smb_version_operations cocci_id@p ;
...
position p;
@@
 struct reparse_data_buffer * cocci_id@p ;
...
position p;
@@
 struct file_zero_data_information cocci_id@p ;
...
position p;
@@
 struct get_dfs_referral_rsp * cocci_id@p ;
...
position p;
@@
 struct lease_context_v2 cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SMB3_SIGN_KEY_SIZE ] ;
...
position p;
@@
 struct kvec cocci_id@p [ SMB2_SET_INFO_IOV_SIZE ] ;
...
position p;
@@
 struct fsctl_get_dfs_referral_req * cocci_id@p ;
