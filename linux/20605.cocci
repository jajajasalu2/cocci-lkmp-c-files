...
typedef bool;
@@
 struct imr_device {  bool init ;  struct mutex lock ;  int max_imr ;  int reg_base ; } cocci_id@p ;
...
typedef u32;
@@
 struct imr_regs {  u32 addr_lo ;  u32 addr_hi ;  u32 rmask ;  u32 wmask ; } cocci_id@p ;
