...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_PROTONAT_MAX + 1 ] ;
...
position p;
@@
 struct nf_nat_lookup_hook_priv {  struct nf_hook_entries __rcu * entries ;  struct rcu_head rcu_head ; } cocci_id@p ;
...
position p;
@@
 struct nf_nat_proto_clean cocci_id@p ;
...
position p;
@@
 struct nf_nat_range2 cocci_id@p ;
...
position p;
@@
 struct nf_nat_hooks_net {  struct nf_hook_ops * nat_hook_ops ;  unsigned int users ; } cocci_id@p ;
...
position p;
@@
 const union nf_conntrack_man_proto * cocci_id@p ;
...
position p;
@@
 const struct nf_nat_proto_clean * cocci_id@p ;
...
position p;
@@
 struct nat_net {  struct nf_nat_hooks_net nat_proto_net [ NFPROTO_NUMPROTO ] ; } cocci_id@p ;
...
position p;
@@
 struct nf_nat_hooks_net * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_PROTONAT_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ CTA_NAT_MAX + 1 ] ;
...
typedef u8;
@@
 struct nf_nat_proto_clean {  u8 l3proto ;  u8 l4proto ; } cocci_id@p ;
...
position p;
@@
 struct nf_ct_ext_type cocci_id@p ;
...
position p;
@@
 struct nf_nat_lookup_hook_priv * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ CTA_NAT_MAX + 1 ] ;
...
position p;
@@
 struct nf_hook_entries * cocci_id@p ;
