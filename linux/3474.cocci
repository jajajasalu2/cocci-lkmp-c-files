...
position p;
@@
 enum atmci_pdc_buf { PDC_FIRST_BUF = 0 , PDC_SECOND_BUF , } cocci_id@p ;
...
position p;
@@
 struct atmel_mci_slot * cocci_id@p ;
...
position p;
@@
 enum { EVENT_CMD_RDY = 0 , EVENT_XFER_COMPLETE , EVENT_NOTBUSY , EVENT_DATA_ERROR , } cocci_id@p ;
...
position p;
@@
 enum atmel_mci_state cocci_id@p ;
...
position p;
@@
 struct mci_slot_pdata * cocci_id@p ;
...
position p;
@@
 struct mci_platform_data * cocci_id@p ;
...
position p;
@@
 struct atmel_mci_dma {  struct dma_chan * chan ;  struct dma_async_tx_descriptor * data_desc ; } cocci_id@p ;
...
position p;
@@
 enum atmel_mci_state { STATE_IDLE = 0 , STATE_SENDING_CMD , STATE_DATA_XFER , STATE_WAITING_NOTBUSY , STATE_SENDING_STOP , STATE_END_REQUEST , } cocci_id@p ;
...
position p;
@@
 enum atmci_xfer_dir cocci_id@p ;
...
position p;
@@
 enum atmci_xfer_dir { XFER_RECEIVE = 0 , XFER_TRANSMIT , } cocci_id@p ;
...
typedef bool;
@@
 struct atmel_mci_caps {  bool has_dma_conf_reg ;  bool has_pdc ;  bool has_cfg_reg ;  bool has_cstor_reg ;  bool has_highspeed ;  bool has_rwproof ;  bool has_odd_clk_div ;  bool has_bad_data_ordering ;  bool need_reset_after_xfer ;  bool need_blksz_mul_4 ;  bool need_notbusy_for_read_ops ; } cocci_id@p ;
