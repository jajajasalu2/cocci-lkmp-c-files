...
position p;
@@
 struct netxen_minidump_entry_mux * cocci_id@p ;
...
position p;
@@
 struct netxen_minidump_entry_crb * cocci_id@p ;
...
position p;
@@
 struct netxen_minidump_entry * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_mac_req_t;
@@
 nx_mac_req_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_mac_list_t;
@@
 nx_mac_list_t cocci_id@p ;
...
position p;
@@
 struct netxen_minidump_entry_rdmem * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct netxen_adapter * adapter , void __iomem * addr ) ;
...
symbol cocci_id;
position p;
typedef crb_128M_2M_sub_block_map_t;
@@
 crb_128M_2M_sub_block_map_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_nic_req_t;
@@
 nx_nic_req_t cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct netxen_adapter * adapter , void __iomem * addr , u32 data ) ;
...
position p;
@@
 struct netxen_minidump_entry_cache * cocci_id@p ;
...
position p;
@@
 struct netxen_minidump_entry_queue * cocci_id@p ;
...
position p;
@@
 struct netxen_minidump_template_hdr * cocci_id@p ;
...
position p;
@@
 struct netxen_minidump_entry_rdrom * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct netxen_adapter * adapter , int new_mtu ) ;
...
position p;
@@
 struct netxen_minidump_entry_rdocm * cocci_id@p ;
