...
position p;
@@
 struct acx_frag_threshold * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_rssi_snr_trigger * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_arp_filter * cocci_id@p ;
...
position p;
@@
 struct acx_tx_config_options * cocci_id@p ;
...
position p;
@@
 struct conf_itrim_settings * cocci_id@p ;
...
position p;
@@
 struct acx_default_rx_filter * cocci_id@p ;
...
position p;
@@
 struct acx_ctsprotect * cocci_id@p ;
...
position p;
@@
 struct acx_rx_msdu_lifetime * cocci_id@p ;
...
position p;
@@
 struct conf_tx_rate_class * cocci_id@p ;
...
position p;
@@
 struct acx_sleep_auth * cocci_id@p ;
...
position p;
@@
 struct conf_rate_policy_settings * cocci_id@p ;
...
position p;
@@
 struct acx_event_mask * cocci_id@p ;
...
position p;
@@
 struct wl12xx_acx_config_hangover * cocci_id@p ;
...
position p;
@@
 struct wl12xx_acx_fw_tsf_information * cocci_id@p ;
...
position p;
@@
 struct wl12xx_acx_set_rate_mgmt_params * cocci_id@p ;
...
position p;
@@
 struct wl12xx_rx_filter * cocci_id@p ;
...
position p;
@@
 struct conf_bcn_filt_rule * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_bet_enable * cocci_id@p ;
...
position p;
@@
 struct wl12xx_acx_config_memory * cocci_id@p ;
...
position p;
@@
 enum rx_filter_action cocci_id@p ;
...
position p;
@@
 struct acx_beacon_filter_option * cocci_id@p ;
...
position p;
@@
 struct conf_hangover_settings * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_fm_coex * cocci_id@p ;
...
position p;
@@
 struct acx_beacon_broadcast * cocci_id@p ;
...
position p;
@@
 struct acx_wake_up_condition * cocci_id@p ;
...
position p;
@@
 struct conf_pm_config_settings * cocci_id@p ;
...
position p;
@@
 struct acx_tid_config * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_ht_information * cocci_id@p ;
...
position p;
@@
 enum acx_ctsprotect_type cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_ba_receiver_setup * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_keep_alive_mode * cocci_id@p ;
...
position p;
@@
 struct acx_feature_config * cocci_id@p ;
...
position p;
@@
 struct acx_preamble * cocci_id@p ;
...
position p;
@@
 struct acx_dco_itrim_params * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_ap_max_tx_retry * cocci_id@p ;
...
position p;
@@
 struct conf_roam_trigger_settings * cocci_id@p ;
...
position p;
@@
 struct acx_rate_policy * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_ba_initiator_policy * cocci_id@p ;
...
position p;
@@
 struct acx_energy_detection * cocci_id@p ;
...
position p;
@@
 struct acx_beacon_filter_ie_table * cocci_id@p ;
...
position p;
@@
 struct acx_rx_filter_cfg * cocci_id@p ;
...
position p;
@@
 struct acx_rts_threshold * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_inconnection_sta * cocci_id@p ;
...
position p;
@@
 struct acx_current_tx_power * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_keep_alive_config * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_rx_config_opt * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_mem_map cocci_id@p ;
...
position p;
@@
 struct acx_conn_monit_params * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_ps_rx_streaming * cocci_id@p ;
...
position p;
@@
 struct acx_bt_wlan_coex * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_ht_capabilities * cocci_id@p ;
...
position p;
@@
 enum acx_preamble_type cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_config_ps * cocci_id@p ;
...
position p;
@@
 struct acx_roaming_stats * cocci_id@p ;
...
position p;
@@
 struct acx_bt_wlan_coex_param * cocci_id@p ;
...
position p;
@@
 struct conf_memory_settings * cocci_id@p ;
...
position p;
@@
 struct conf_sg_settings * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_pm_config * cocci_id@p ;
...
position p;
@@
 struct wl1271_acx_rssi_snr_avg_weights * cocci_id@p ;
...
position p;
@@
 struct acx_dot11_grp_addr_tbl * cocci_id@p ;
...
position p;
@@
 struct acx_rx_timeout * cocci_id@p ;
