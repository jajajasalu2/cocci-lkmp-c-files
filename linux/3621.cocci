...
position p;
@@
 struct efi_graphics_output_protocol_32 * cocci_id@p ;
...
position p;
@@
 struct efi_pixel_bitmask cocci_id@p ;
...
position p;
@@
 struct efi_graphics_output_protocol_mode_64 * cocci_id@p ;
...
position p;
@@
 struct efi_graphics_output_mode_info * cocci_id@p ;
...
position p;
@@
 struct efi_graphics_output_protocol_64 * cocci_id@p ;
...
position p;
@@
 struct efi_graphics_output_protocol_mode_32 * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_handle_t;
@@
 efi_handle_t cocci_id@p ;
