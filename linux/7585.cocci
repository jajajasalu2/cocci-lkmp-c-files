...
symbol cocci_id;
position p;
typedef u_int,u_long;
@@
 int cocci_id@p ( struct fb_info * info , u_int cmd , u_long arg ) ;
...
position p;
@@
 const struct atyfb_par * cocci_id@p ;
...
typedef u8,u32;
@@
 struct atyclk {  u32 ref_clk_per ;  u8 pll_ref_div ;  u8 mclk_fb_div ;  u8 mclk_post_div ;  u8 mclk_fb_mult ;  u8 xclk_post_div ;  u8 vclk_fb_div ;  u8 vclk_post_div ;  u32 dsp_xclks_per_row ;  u32 dsp_loop_latency ;  u32 dsp_precision ;  u32 dsp_on ;  u32 dsp_off ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct atyfb_par * par ) ;
...
position p;
@@
 struct pci_mmap_map {  unsigned long voff ;  unsigned long poff ;  unsigned long size ;  unsigned long prot_flag ;  unsigned long prot_mask ; } cocci_id@p ;
...
typedef u_int;
@@
 int cocci_id@p ( u_int regno , u_int red , u_int green , u_int blue , u_int transp , struct fb_info * info ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_info * info , int user ) ;
...
position p;
@@
 void cocci_id@p ( struct atyfb_par * par , const struct fb_info * info ) ;
...
position p;
@@
 void cocci_id@p ( const struct atyfb_par * par , const struct crtc * crtc ) ;
...
position p;
@@
 const struct fb_fix_screeninfo cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct atyfb_par * par , struct crtc * crtc ) ;
...
position p;
@@
 int cocci_id@p ( const struct fb_info * info , const struct fb_var_screeninfo * var , struct crtc * crtc ) ;
...
typedef u32,u16;
@@
 struct {  u16 pci_id ;  const char * name ;  int pll , mclk , xclk , ecp_max ;  u32 features ; } cocci_id@p [ ] ;
...
position p;
@@
 struct aty_interrupt * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct crtc * crtc , struct fb_var_screeninfo * var ) ;
...
position p;
@@
 const struct fb_videomode cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ FB_MAX ] ;
...
position p;
@@
 int cocci_id@p ( struct fb_info * info , struct vm_area_struct * vma ) ;
