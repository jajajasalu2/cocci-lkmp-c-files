...
position p;
@@
 struct sun4d_timer_regs cocci_id@p ;
...
typedef u32;
@@
 struct sun4d_timer_regs {  u32 l10_timer_limit ;  u32 l10_cur_countx ;  u32 l10_limit_noclear ;  u32 ctrl ;  u32 l10_cur_count ; } cocci_id@p ;
...
position p;
@@
 struct sun4d_handler_data * cocci_id@p ;
...
position p;
@@
 struct sun4d_handler_data {  unsigned int cpuid ;  unsigned int real_irq ; } cocci_id@p ;
