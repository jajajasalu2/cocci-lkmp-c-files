...
position p;
@@
 const struct div_data cocci_id@p ;
...
position p;
@@
 struct factors_data cocci_id@p ;
...
typedef u8,bool;
@@
 struct divs_data {  const struct factors_data * factors ;  int ndivs ;  struct {  u8 self ;  u8 fixed ;  struct clk_div_table * table ;  u8 shift ;  u8 pow ;  u8 gate ;  bool critical ; } div [ SUNXI_DIVS_MAX_QTY ] ; } cocci_id@p ;
...
position p;
@@
 const struct mux_data * cocci_id@p ;
...
typedef u8;
@@
 struct div_data {  u8 shift ;  u8 pow ;  u8 width ;  const struct clk_div_table * table ; } cocci_id@p ;
...
position p;
@@
 const struct factors_data cocci_id@p ;
...
position p;
@@
 const struct divs_data cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ SUNXI_MAX_PARENTS ] ;
...
position p;
@@
 const struct clk_factors_config cocci_id@p ;
...
position p;
@@
 struct factors_request * cocci_id@p ;
...
typedef u8;
@@
 struct mux_data {  u8 shift ; } cocci_id@p ;
