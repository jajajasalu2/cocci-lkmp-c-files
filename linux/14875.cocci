...
position p;
@@
 struct tegra_audio_clk_initdata * cocci_id@p ;
...
typedef u8;
@@
 struct tegra_audio2x_clk_initdata {  char * parent ;  char * gate_name ;  char * name_2x ;  char * div_name ;  int clk_id ;  int clk_num ;  u8 div_offset ; } cocci_id@p ;
...
typedef u32;
@@
 struct tegra_audio_clk_initdata {  char * gate_name ;  char * mux_name ;  u32 offset ;  int gate_clk_id ;  int mux_clk_id ; } cocci_id@p ;
...
position p;
@@
 struct tegra_audio2x_clk_initdata * cocci_id@p ;
...
position p;
@@
 struct tegra_sync_source_initdata * cocci_id@p ;
...
position p;
@@
 struct tegra_sync_source_initdata {  char * name ;  unsigned long rate ;  unsigned long max_rate ;  int clk_id ; } cocci_id@p ;
