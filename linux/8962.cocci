...
position p;
@@
 struct fw_vi_rxmode_cmd cocci_id@p ;
...
position p;
@@
 struct lb_port_stats * cocci_id@p ;
...
position p;
@@
 struct fw_rss_vi_config_cmd cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ NMTUS ] [ NCCTRL_WIN ] ;
...
position p;
@@
 struct exprom_header {  unsigned char hdr_arr [ 16 ] ;  unsigned char hdr_ver [ 4 ] ; } * cocci_id@p ;
...
position p;
@@
 struct fw_vi_enable_cmd cocci_id@p ;
...
position p;
@@
 struct fw_params_cmd cocci_id@p ;
...
position p;
@@
 struct tp_usm_stats * cocci_id@p ;
...
position p;
@@
 struct fw_initialize_cmd cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ DIV_ROUND_UP ( sizeof ( struct exprom_header ) , sizeof ( u32 ) ) ] ;
...
position p;
@@
 const struct intr_info * cocci_id@p ;
...
position p;
@@
 struct fw_reset_cmd cocci_id@p ;
...
position p;
@@
 struct fw_acl_mac_cmd cocci_id@p ;
...
position p;
@@
 struct exprom_header * cocci_id@p ;
...
position p;
@@
 enum fw_params_param_dev_fwcache cocci_id@p ;
...
@@
 struct intr_info {  unsigned int mask ;  const char * msg ;  short stat_idx ;  unsigned short fatal ;  int_handler_t int_handler ; } cocci_id@p ;
...
position p;
@@
 struct fw_rss_glb_config_cmd cocci_id@p ;
...
position p;
@@
 struct fw_rss_ind_tbl_cmd cocci_id@p ;
...
position p;
@@
 struct devlog_params * cocci_id@p ;
...
position p;
@@
 enum { SF_ATTEMPTS = 10 , SF_PROG_PAGE = 2 , SF_WR_DISABLE = 4 , SF_RD_STATUS = 5 , SF_WR_ENABLE = 6 , SF_RD_DATA_FAST = 0xb , SF_RD_ID = 0x9f , SF_ERASE_SECTOR = 0xd8 , } cocci_id@p ;
...
position p;
@@
 struct pf_resources * cocci_id@p ;
...
position p;
@@
 struct fw_vi_mac_cmd cocci_id@p ;
...
position p;
@@
 struct fw_eq_eth_cmd cocci_id@p ;
...
position p;
@@
 struct sge_idma_monitor_state * cocci_id@p ;
...
typedef u32;
@@
 struct flash_desc {  u32 vendor_and_model_id ;  u32 size_mb ; } cocci_id@p ;
...
position p;
@@
 struct fw_hello_cmd cocci_id@p ;
...
position p;
@@
 struct fw_debug_cmd cocci_id@p ;
...
position p;
@@
 const struct trace_params * cocci_id@p ;
...
position p;
@@
 struct tp_tcp_stats * cocci_id@p ;
...
typedef u32;
@@
 union {  u32 word ;  char byte [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct fw_hdr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fw_port_cap16_t;
@@
 fw_port_cap16_t cocci_id@p ;
...
position p;
@@
 struct fw_filter_wr * cocci_id@p ;
...
position p;
@@
 struct fw_vi_mac_raw * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ TP_MIB_TCP_RXT_SEG_LO_A - TP_MIB_TCP_OUT_RST_A + 1 ] ;
...
position p;
@@
 struct fw_vi_mac_exact * cocci_id@p ;
...
position p;
@@
 struct fw_eq_ofld_cmd cocci_id@p ;
...
position p;
@@
 struct fw_sched_cmd cocci_id@p ;
...
position p;
@@
 const struct fw_port_cmd * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fw_port_cap32_t;
@@
 fw_port_cap32_t cocci_id@p ;
...
position p;
@@
 struct fw_vi_mac_vni * cocci_id@p ;
...
position p;
@@
 struct mbox_cmd_log * cocci_id@p ;
...
position p;
@@
 struct fw_eq_ctrl_cmd cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ NCCTRL_WIN ] ;
...
position p;
@@
 struct tp_rdma_stats * cocci_id@p ;
...
position p;
@@
 struct tp_fcoe_stats * cocci_id@p ;
...
position p;
@@
 enum fw_port_module_type cocci_id@p ;
...
position p;
@@
 struct fw_devlog_cmd cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct adapter * adap ) ;
...
position p;
@@
 struct trace_params * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ NTX_SCHED ] ;
...
position p;
@@
 struct tp_cpl_stats * cocci_id@p ;
...
position p;
@@
 struct tp_err_stats * cocci_id@p ;
...
position p;
@@
 struct fw_acl_vlan_cmd cocci_id@p ;
