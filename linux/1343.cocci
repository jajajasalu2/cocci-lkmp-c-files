...
position p;
@@
 int cocci_id@p ( struct usb_device * dev , unsigned char reset_bit ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_device * dev ) ;
...
typedef __u8;
@@
 int cocci_id@p ( struct usb_device * dev , int address , const unsigned char * data , int length , __u8 bRequest ) ;
