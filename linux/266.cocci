...
position p;
@@
 char cocci_id@p [ TAINT_FLAGS_COUNT + sizeof ( "Tainted: " ) ] ;
...
position p;
@@
 struct warn_args {  const char * fmt ;  va_list args ; } cocci_id@p ;
...
position p;
@@
 const struct taint_flag * cocci_id@p ;
...
position p;
@@
 const struct taint_flag cocci_id@p [ TAINT_FLAGS_COUNT ] ;
