...
position p;
@@
 char cocci_id@p [ sizeof ( h -> magic_num ) + 1 ] ;
...
typedef u8,u32;
@@
 struct os_area_header {  u8 magic_num [ 16 ] ;  u32 hdr_version ;  u32 db_area_offset ;  u32 ldr_area_offset ;  u32 _reserved_1 ;  u32 ldr_format ;  u32 ldr_size ;  u32 _reserved_2 [ 6 ] ; } cocci_id@p ;
...
typedef uint8_t;
@@
 struct db_index {  uint8_t owner : 5 ;  uint8_t key : 3 ; } cocci_id@p ;
...
position p;
@@
 enum os_area_db_key { OS_AREA_DB_KEY_ANY = - 1 , OS_AREA_DB_KEY_NONE = 0 , OS_AREA_DB_KEY_RTC_DIFF = 1 , OS_AREA_DB_KEY_VIDEO_MODE = 2 , OS_AREA_DB_KEY_MAX = 8 , } cocci_id@p ;
...
position p;
@@
 struct os_area_header * cocci_id@p ;
...
position p;
@@
 const struct ps3_os_area_flash_ops * cocci_id@p ;
...
position p;
@@
 enum os_area_ctrl_button { PARAM_CTRL_BUTTON_O_IS_YES = 0 , PARAM_CTRL_BUTTON_X_IS_YES = 1 , } cocci_id@p ;
...
position p;
@@
 enum os_area_db_owner { OS_AREA_DB_OWNER_ANY = - 1 , OS_AREA_DB_OWNER_NONE = 0 , OS_AREA_DB_OWNER_PROTOTYPE = 1 , OS_AREA_DB_OWNER_LINUX = 2 , OS_AREA_DB_OWNER_PETITBOOT = 3 , OS_AREA_DB_OWNER_MAX = 32 , } cocci_id@p ;
...
position p;
@@
 const struct property * cocci_id@p ;
...
position p;
@@
 enum os_area_boot_flag { PARAM_BOOT_FLAG_GAME_OS = 0 , PARAM_BOOT_FLAG_OTHER_OS = 1 , } cocci_id@p ;
...
position p;
@@
 enum { HEADER_SIZE = offsetof ( struct os_area_db , _db_data ) , INDEX_64_COUNT = 64 , VALUES_64_COUNT = 57 , INDEX_32_COUNT = 64 , VALUES_32_COUNT = 57 , INDEX_16_COUNT = 64 , VALUES_16_COUNT = 57 , } cocci_id@p ;
...
typedef s64;
@@
 struct saved_params {  unsigned int valid ;  s64 rtc_diff ;  unsigned int av_multi_out ; } cocci_id@p ;
...
position p;
@@
 const struct os_area_header * cocci_id@p ;
...
position p;
@@
 struct os_area_params * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct os_area_db {  u8 magic_num [ 4 ] ;  u16 version ;  u16 _reserved_1 ;  u16 index_64 ;  u16 count_64 ;  u16 index_32 ;  u16 count_32 ;  u16 index_16 ;  u16 count_16 ;  u32 _reserved_2 ;  u8 _db_data [ 1000 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint64_t,uint16_t,uint32_t;
@@
 struct db_iterator {  const struct os_area_db * db ;  struct os_area_db_id match_id ;  struct db_index * idx ;  struct db_index * last_idx ;  union {  uint64_t * value_64 ;  uint32_t * value_32 ;  uint16_t * value_16 ; } ; } cocci_id@p ;
...
position p;
@@
 const struct os_area_db_id * cocci_id@p ;
...
position p;
@@
 const struct os_area_db * cocci_id@p ;
...
position p;
@@
 enum { OS_AREA_SEGMENT_SIZE = 0X200 , } cocci_id@p ;
...
position p;
@@
 const struct os_area_params * cocci_id@p ;
...
position p;
@@
 struct os_area_db_id {  int owner ;  int key ; } cocci_id@p ;
...
typedef u8,u32,s64;
@@
 struct os_area_params {  u32 boot_flag ;  u32 _reserved_1 [ 3 ] ;  u32 num_params ;  u32 _reserved_2 [ 3 ] ;  s64 rtc_diff ;  u8 av_multi_out ;  u8 ctrl_button ;  u8 _reserved_3 [ 6 ] ;  u8 static_ip_addr [ 4 ] ;  u8 network_mask [ 4 ] ;  u8 default_gateway [ 4 ] ;  u8 _reserved_4 [ 4 ] ;  u8 dns_primary [ 4 ] ;  u8 dns_secondary [ 4 ] ;  u8 _reserved_5 [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 enum ps3_param_av_multi_out cocci_id@p ;
...
position p;
@@
 enum os_area_ldr_format { HEADER_LDR_FORMAT_RAW = 0 , HEADER_LDR_FORMAT_GZIP = 1 , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( db -> magic_num ) + 1 ] ;
