...
position p;
@@
 struct ocxl_afu_config * cocci_id@p ;
...
position p;
@@
 struct cxl_event_afu_interrupt cocci_id@p ;
...
position p;
@@
 const struct cxlflash_backend_ops cocci_id@p ;
...
position p;
@@
 struct ocxlflash_irqs * cocci_id@p ;
...
position p;
@@
 enum ocxlflash_ctx_state cocci_id@p ;
...
position p;
@@
 struct ocxlflash_context * cocci_id@p ;
...
position p;
@@
 struct cxl_event_header cocci_id@p ;
...
position p;
@@
 struct ocxl_fn_config * cocci_id@p ;
...
position p;
@@
 struct cxl_event_data_storage cocci_id@p ;
