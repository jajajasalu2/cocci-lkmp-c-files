...
position p;
@@
 const struct regmap_config cocci_id@p [ PALMAS_NUM_CLIENTS ] ;
...
position p;
@@
 struct palmas_driver_data {  unsigned int * features ;  struct regmap_irq_chip * irq_chip ; } cocci_id@p ;
...
position p;
@@
 struct palmas_driver_data * cocci_id@p ;
...
position p;
@@
 enum palmas_external_requestor_id cocci_id@p ;
