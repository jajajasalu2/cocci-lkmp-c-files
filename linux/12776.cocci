...
position p;
@@
 struct vmbus_channel_gpadl_body * cocci_id@p ;
...
position p;
@@
 enum vmbus_packet_type cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_close_channel cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_packet_page_buffer cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_tl_connect_request cocci_id@p ;
