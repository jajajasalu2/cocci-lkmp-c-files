...
position p;
@@
 enum dpmac_counter_id cocci_id@p ;
...
position p;
@@
 struct dpmac_cmd_open * cocci_id@p ;
...
position p;
@@
 struct dpmac_cmd_get_counter * cocci_id@p ;
...
position p;
@@
 struct dpmac_cmd_set_link_state * cocci_id@p ;
...
position p;
@@
 struct dpmac_link_state * cocci_id@p ;
...
position p;
@@
 struct dpmac_rsp_get_attributes * cocci_id@p ;
...
position p;
@@
 struct dpmac_rsp_get_counter * cocci_id@p ;
