...
position p;
@@
 struct rds6_info_rdma_connection cocci_id@p ;
...
position p;
@@
 struct rds_info_rdma_connection cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ ( sizeof ( struct rds_info_rdma_connection ) + 7 ) / 8 ] ;
...
typedef u64;
@@
 u64 cocci_id@p [ ( sizeof ( struct rds6_info_rdma_connection ) + 7 ) / 8 ] ;
...
position p;
@@
 struct rds_ib_ipaddr * cocci_id@p ;
