...
position p;
@@
 struct rt5663_platform_data * cocci_id@p ;
...
position p;
@@
 enum { CODEC_VER_1 , CODEC_VER_0 , } cocci_id@p ;
...
position p;
@@
 struct impedance_mapping_table cocci_id@p ;
...
position p;
@@
 struct impedance_mapping_table {  unsigned int imp_min ;  unsigned int imp_max ;  unsigned int vol ;  unsigned int dc_offset_l_manual ;  unsigned int dc_offset_r_manual ;  unsigned int dc_offset_l_manual_mic ;  unsigned int dc_offset_r_manual_mic ; } cocci_id@p ;
