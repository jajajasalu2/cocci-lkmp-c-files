...
position p;
@@
 unsigned char cocci_id@p [ BLK_MAX_CDB ] ;
...
position p;
@@
 struct request_sense * cocci_id@p ;
...
typedef __be32;
@@
 struct {  __be32 lba ;  __be32 blocklen ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ATAPI_CAPABILITIES_PAGE_SIZE ] ;
...
position p;
@@
 const struct ide_proc_devset * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ide_startstop_t;
@@
 ide_startstop_t cocci_id@p ;
...
position p;
@@
 const struct cd_list_entry cocci_id@p [ ] ;
...
position p;
@@
 struct cd_list_entry {  const char * id_model ;  const char * id_firmware ;  unsigned int cd_flags ; } cocci_id@p ;
...
position p;
@@
 struct atapi_toc_header cocci_id@p ;
...
position p;
@@
 struct {  struct atapi_toc_header hdr ;  struct atapi_toc_entry ent ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ide_expiry_t;
@@
 ide_expiry_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ide_proc_entry_t;
@@
 ide_proc_entry_t cocci_id@p [ ] ;
...
position p;
@@
 struct atapi_toc_entry cocci_id@p ;
