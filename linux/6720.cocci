...
position p;
@@
 struct amap_cq_context cocci_id@p ;
...
position p;
@@
 struct be_cmd_set_features * cocci_id@p ;
...
position p;
@@
 struct iscsi_cleanup_req_v1 * cocci_id@p ;
...
position p;
@@
 struct be_defq_create_req * cocci_id@p ;
...
position p;
@@
 struct be_async_event_sli * cocci_id@p ;
...
position p;
@@
 struct be_cmd_set_vlan_req * cocci_id@p ;
...
position p;
@@
 struct be_post_sgl_pages_req * cocci_id@p ;
...
position p;
@@
 struct amap_be_default_pdu_context cocci_id@p ;
...
position p;
@@
 struct be_cmd_set_host_data * cocci_id@p ;
...
position p;
@@
 struct be_remove_template_pages_req * cocci_id@p ;
...
position p;
@@
 struct be_post_template_pages_req * cocci_id@p ;
...
position p;
@@
 struct be_mgmt_controller_attributes cocci_id@p ;
...
position p;
@@
 struct amap_mcc_context cocci_id@p ;
...
position p;
@@
 struct be_cmd_req_mcc_create_ext * cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_port_name * cocci_id@p ;
...
position p;
@@
 struct be_wrbq_create_resp * cocci_id@p ;
...
position p;
@@
 struct iscsi_cleanup_req * cocci_id@p ;
...
position p;
@@
 struct be_wrbq_create_req * cocci_id@p ;
...
position p;
@@
 struct be_mgmt_controller_attributes_resp * cocci_id@p ;
...
position p;
@@
 struct amap_default_pdu_context_ext cocci_id@p ;
...
position p;
@@
 struct be_defq_create_resp * cocci_id@p ;
