...
position p;
@@
 unsigned char cocci_id@p [ NCTS_BYTES ] ;
...
position p;
@@
 struct arm_smccc_res cocci_id@p ;
...
position p;
@@
 enum hdmi_aud_channel_swap_type { HDMI_AUD_SWAP_LR , HDMI_AUD_SWAP_LFE_CC , HDMI_AUD_SWAP_LSRS , HDMI_AUD_SWAP_RLS_RRS , HDMI_AUD_SWAP_LR_STATUS , } cocci_id@p ;
...
position p;
@@
 enum hdmi_aud_input_type { HDMI_AUD_INPUT_I2S = 0 , HDMI_AUD_INPUT_SPDIF , } cocci_id@p ;
...
position p;
@@
 struct hdmi_codec_pdata cocci_id@p ;
...
position p;
@@
 enum hdmi_aud_i2s_fmt { HDMI_I2S_MODE_RJT_24BIT = 0 , HDMI_I2S_MODE_RJT_16BIT , HDMI_I2S_MODE_LJT_24BIT , HDMI_I2S_MODE_LJT_16BIT , HDMI_I2S_MODE_I2S_24BIT , HDMI_I2S_MODE_I2S_16BIT , } cocci_id@p ;
...
position p;
@@
 const struct hdmi_acr_n * cocci_id@p ;
...
position p;
@@
 enum mtk_hdmi_clk_id { MTK_HDMI_CLK_HDMI_PIXEL , MTK_HDMI_CLK_HDMI_PLL , MTK_HDMI_CLK_AUD_BCLK , MTK_HDMI_CLK_AUD_SPDIF , MTK_HDMI_CLK_COUNT , } cocci_id@p ;
...
position p;
@@
 enum hdmi_aud_channel_type cocci_id@p ;
...
position p;
@@
 enum hdmi_aud_channel_swap_type cocci_id@p ;
...
position p;
@@
 struct hdmi_audio_param * cocci_id@p ;
...
position p;
@@
 struct hdmi_codec_params * cocci_id@p ;
...
position p;
@@
 enum hdmi_aud_i2s_fmt cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ MTK_HDMI_CLK_COUNT ] ;
...
position p;
@@
 enum hdmi_audio_sample_size cocci_id@p ;
...
position p;
@@
 struct hdmi_acr_n {  unsigned int clock ;  unsigned int n [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 enum hdmi_aud_input_type cocci_id@p ;
...
position p;
@@
 struct mtk_hdmi_phy * cocci_id@p ;
...
position p;
@@
 struct hdmi_codec_daifmt * cocci_id@p ;
...
position p;
@@
 enum hdmi_aud_mclk { HDMI_AUD_MCLK_128FS , HDMI_AUD_MCLK_192FS , HDMI_AUD_MCLK_256FS , HDMI_AUD_MCLK_384FS , HDMI_AUD_MCLK_512FS , HDMI_AUD_MCLK_768FS , HDMI_AUD_MCLK_1152FS , } cocci_id@p ;
...
position p;
@@
 const struct hdmi_codec_ops cocci_id@p ;
