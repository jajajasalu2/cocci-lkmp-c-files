...
typedef timer_t;
@@
 struct k_itimer * cocci_id@p ( timer_t timer_id , unsigned long * flags ) ;
...
position p;
@@
 const struct k_clock * const cocci_id@p [ ] ;
...
typedef clockid_t;
@@
 const struct k_clock * cocci_id@p ( const clockid_t id ) ;
