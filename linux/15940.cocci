...
position p;
@@
 struct uwb_rsv_row_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ UWB_MAS_PER_ZONE ] ;
...
position p;
@@
 struct uwb_rsv_col_set_info cocci_id@p ;
...
position p;
@@
 struct uwb_rsv_alloc_info * cocci_id@p ;
...
position p;
@@
 struct uwb_rsv_col_info * cocci_id@p ;
