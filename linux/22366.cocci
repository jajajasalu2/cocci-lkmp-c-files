...
position p;
@@
 enum big_key_op { BIG_KEY_ENC , BIG_KEY_DEC , } cocci_id@p ;
...
position p;
@@
 struct big_key_buf {  unsigned int nr_pages ;  void * virt ;  struct scatterlist * sg ;  struct page * pages [ ] ; } cocci_id@p ;
...
position p;
@@
 enum { big_key_data , big_key_path , big_key_path_2nd_part , big_key_len , } cocci_id@p ;
