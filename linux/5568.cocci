...
position p;
@@
 struct v3020 {  void __iomem * ioaddress ;  int leftshift ;  struct gpio * gpio ;  const struct v3020_chip_ops * ops ;  struct rtc_device * rtc ; } cocci_id@p ;
...
position p;
@@
 const struct v3020_chip_ops cocci_id@p ;
