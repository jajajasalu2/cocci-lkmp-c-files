...
typedef u8;
@@
 struct adc128 {  struct spi_device * spi ;  struct regulator * reg ;  struct mutex lock ;  u8 buffer [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
typedef u8;
@@
 struct adc128_configuration {  const struct iio_chan_spec * channels ;  u8 num_channels ; } cocci_id@p ;
...
position p;
@@
 const struct adc128_configuration cocci_id@p [ ] ;
