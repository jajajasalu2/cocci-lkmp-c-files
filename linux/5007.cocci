...
position p;
@@
 struct hfi1_sl2sc_attr {  struct attribute attr ;  int sl ; } cocci_id@p ;
...
position p;
@@
 struct hfi1_vl2mtu_attr * cocci_id@p ;
...
position p;
@@
 struct hfi1_sl2sc_attr cocci_id@p ;
...
position p;
@@
 struct hfi1_port_attr cocci_id@p ;
...
position p;
@@
 struct sde_attribute cocci_id@p ;
...
position p;
@@
 struct opa_congestion_setting_attr_shadow cocci_id@p ;
...
position p;
@@
 struct hfi1_sc2vl_attr cocci_id@p ;
...
position p;
@@
 struct hfi1_sc2vl_attr {  struct attribute attr ;  int sc ; } cocci_id@p ;
...
position p;
@@
 struct hfi1_vl2mtu_attr {  struct attribute attr ;  int vl ; } cocci_id@p ;
