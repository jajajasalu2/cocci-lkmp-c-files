...
typedef u8,__be32;
@@
 struct ad5764_state {  struct spi_device * spi ;  const struct ad5764_chip_info * chip_info ;  struct regulator_bulk_data vref_reg [ 2 ] ;  union {  __be32 d32 ;  u8 d8 [ 4 ] ; } data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ad5764_chip_info {  unsigned long int_vref ;  const struct iio_chan_spec * channels ; } cocci_id@p ;
...
position p;
@@
 enum ad5764_type { ID_AD5744 , ID_AD5744R , ID_AD5764 , ID_AD5764R , } cocci_id@p ;
...
position p;
@@
 struct ad5764_state * cocci_id@p ;
...
position p;
@@
 const struct ad5764_chip_info cocci_id@p [ ] ;
