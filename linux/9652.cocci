...
typedef u16;
@@
 const u16 cocci_id@p [ B43legacy_ILT_NOISEA3_SIZE ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ B43legacy_ILT_NOISESCALEG_SIZE ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ B43legacy_ILT_NOISEG2_SIZE ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ B43legacy_ILT_FINEFREQA_SIZE ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ B43legacy_ILT_FINEFREQG_SIZE ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ B43legacy_ILT_NOISEA2_SIZE ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ B43legacy_ILT_NOISEG1_SIZE ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ B43legacy_ILT_RETARD_SIZE ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ B43legacy_ILT_SIGMASQR_SIZE ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ B43legacy_ILT_ROTOR_SIZE ] ;
