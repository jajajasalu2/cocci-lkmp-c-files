...
position p;
@@
 const struct nvt_chip cocci_id@p [ ] ;
...
position p;
@@
 const struct nvt_dev * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvt_dev * nvt ) ;
