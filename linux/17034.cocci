...
position p;
@@
 unsigned char cocci_id@p [ GF2K_LENGTH ] ;
...
position p;
@@
 struct gf2k {  struct gameport * gameport ;  struct input_dev * dev ;  int reads ;  int bads ;  unsigned char id ;  unsigned char length ;  char phys [ 32 ] ; } cocci_id@p ;
