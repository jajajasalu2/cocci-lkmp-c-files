...
position p;
@@
 struct intc_prio_reg * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ INTC_NR_IRQS ] ;
...
position p;
@@
 struct intc_mask_reg * cocci_id@p ;
...
position p;
@@
 unsigned long ( * cocci_id@p ) ( unsigned long , unsigned long , unsigned long ( * ) ( unsigned long , unsigned long , unsigned long ) , unsigned int ) ;
...
position p;
@@
 struct intc_sense_reg * cocci_id@p ;
