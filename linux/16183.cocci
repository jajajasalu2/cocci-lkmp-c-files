...
position p;
@@
 struct dt2811_board {  const char * name ;  unsigned int is_pgh : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct dt2811_board * cocci_id@p ;
...
position p;
@@
 struct dt2811_board cocci_id@p ;
...
position p;
@@
 struct dt2811_private * cocci_id@p ;
...
position p;
@@
 struct dt2811_private {  unsigned int ai_divisor ; } cocci_id@p ;
