...
position p;
@@
 struct ecard_request * cocci_id@p ;
...
position p;
@@
 const struct expansion_card_ops * cocci_id@p ;
...
position p;
@@
 struct in_chunk_dir cocci_id@p ;
...
typedef ecard_t;
@@
 struct expcard_blacklist {  unsigned short manufacturer ;  unsigned short product ;  const char * type ;  void ( * init ) ( ecard_t * ec ) ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef expansioncard_ops_t;
@@
 expansioncard_ops_t cocci_id@p ;
...
position p;
@@
 struct expansion_card * cocci_id@p ;
...
typedef ecard_t;
@@
 struct ecard_request {  void ( * fn ) ( struct ecard_request * ) ;  ecard_t * ec ;  unsigned int address ;  unsigned int length ;  unsigned int use_loader ;  void * buffer ;  struct completion * complete ; } cocci_id@p ;
...
position p;
@@
 struct ex_chunk_dir cocci_id@p ;
...
position p;
@@
 struct ecard_driver * cocci_id@p ;
...
position p;
@@
 const struct ecard_id * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef card_speed_t;
@@
 card_speed_t cocci_id@p ;
