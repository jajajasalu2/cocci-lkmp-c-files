...
position p;
@@
 const struct meson_gx_package_id {  const char * name ;  unsigned int major_id ;  unsigned int pack_id ;  unsigned int pack_mask ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct meson_gx_soc_id {  const char * name ;  unsigned int id ; } cocci_id@p [ ] ;
