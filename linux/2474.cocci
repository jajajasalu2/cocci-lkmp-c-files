...
position p;
@@
 struct axi_dma_chan * cocci_id@p ;
...
position p;
@@
 struct axi_dma_chip * cocci_id@p ;
...
position p;
@@
 struct axi_dma_desc cocci_id@p ;
...
position p;
@@
 struct dw_axi_dma_hcfg * cocci_id@p ;
