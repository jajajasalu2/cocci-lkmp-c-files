...
position p;
@@
 void cocci_id@p ( int if_num , struct device * device ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ipmi_user * user ) ;
...
position p;
@@
 struct poweroff_function {  char * platform_type ;  int ( * detect ) ( struct ipmi_user * user ) ;  void ( * poweroff_func ) ( struct ipmi_user * user ) ; } cocci_id@p ;
...
position p;
@@
 struct poweroff_function cocci_id@p [ ] ;
