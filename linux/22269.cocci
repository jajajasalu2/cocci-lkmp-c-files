...
position p;
@@
 struct cond_insertf_data * cocci_id@p ;
...
position p;
@@
 struct cond_insertf_data {  struct policydb * p ;  struct cond_av_list * other ;  struct cond_av_list * head ;  struct cond_av_list * tail ; } cocci_id@p ;
...
position p;
@@
 struct cond_av_list * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ COND_EXPR_MAXDEPTH ] ;
