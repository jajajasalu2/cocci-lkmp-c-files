...
typedef bool;
@@
 struct altera_mbox {  bool is_sender ;  bool intr_mode ;  int irq ;  void __iomem * mbox_base ;  struct device * dev ;  struct mbox_controller controller ;  struct timer_list rxpoll_timer ;  struct mbox_chan * chan ; } cocci_id@p ;
...
position p;
@@
 enum altera_mbox_msg { MBOX_CMD = 0 , MBOX_PTR , } cocci_id@p ;
