...
position p;
@@
 struct uasm_reloc cocci_id@p [ 5 ] ;
...
position p;
@@
 struct uasm_label cocci_id@p [ 5 ] ;
...
position p;
@@
 void cocci_id@p ( void * to , void * from ) ;
...
position p;
@@
 enum label_id { label_clear_nopref = 1 , label_clear_pref , label_copy_nopref , label_copy_pref_both , label_copy_pref_store , } cocci_id@p ;
