...
typedef u16;
@@
 struct vring_desc_state_packed {  void * data ;  struct vring_packed_desc * indir_desc ;  u16 num ;  u16 next ;  u16 last ; } cocci_id@p ;
...
@@
 struct vring_desc_extra_packed {  dma_addr_t addr ;  u32 len ;  u16 flags ; } cocci_id@p ;
...
position p;
@@
 struct vring_packed_desc cocci_id@p ;
...
position p;
@@
 const struct vring_virtqueue * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct virtqueue * ) ;
...
typedef u32;
@@
 union {  struct {  __le16 off_wrap ;  __le16 flags ; } ;  u32 u32 ; } cocci_id@p ;
...
position p;
@@
 struct vring_desc_state_split cocci_id@p ;
...
position p;
@@
 struct vring_virtqueue cocci_id@p ;
...
position p;
@@
 struct vring_packed_desc_event * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct virtqueue * ) ;
...
position p;
@@
 struct vring_desc_state_packed * cocci_id@p ;
...
position p;
@@
 struct vring_desc_extra_packed cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct virtqueue * vq ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct virtqueue * vq ) ;
...
position p;
@@
 struct vring_desc_state_split {  void * data ;  struct vring_desc * indir_desc ; } cocci_id@p ;
