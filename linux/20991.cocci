...
position p;
@@
 enum ipi_message_type { IPI_NOP = 0 , IPI_RESCHEDULE = 1 , IPI_CALL_FUNC , IPI_CPU_START , IPI_CPU_STOP , IPI_CPU_TEST , } cocci_id@p ;
...
position p;
@@
 volatile struct task_struct * cocci_id@p ;
