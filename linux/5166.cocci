...
position p;
@@
 struct bcm_kona_gpio_bank {  int id ;  int irq ;  struct bcm_kona_gpio * kona_gpio ; } cocci_id@p ;
...
position p;
@@
 struct bcm_kona_gpio * cocci_id@p ;
...
position p;
@@
 struct bcm_kona_gpio_bank * cocci_id@p ;
...
@@
 struct bcm_kona_gpio {  void __iomem * reg_base ;  int num_bank ;  raw_spinlock_t lock ;  struct gpio_chip gpio_chip ;  struct irq_domain * irq_domain ;  struct bcm_kona_gpio_bank * banks ;  struct platform_device * pdev ; } cocci_id@p ;
