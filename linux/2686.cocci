...
position p;
@@
 struct st_i2c_client * cocci_id@p ;
...
typedef bool,u32;
@@
 struct st_i2c_dev {  struct i2c_adapter adap ;  struct device * dev ;  void __iomem * base ;  struct completion complete ;  int irq ;  struct clk * clk ;  int mode ;  u32 scl_min_width_us ;  u32 sda_min_width_us ;  struct st_i2c_client client ;  bool busy ; } cocci_id@p ;
...
typedef u32;
@@
 struct st_i2c_timings {  u32 rate ;  u32 rep_start_hold ;  u32 rep_start_setup ;  u32 start_hold ;  u32 data_setup_time ;  u32 stop_setup_time ;  u32 bus_free_time ;  u32 sda_pulse_min_limit ; } cocci_id@p ;
...
position p;
@@
 struct st_i2c_timings * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct st_i2c_client {  u8 addr ;  u32 count ;  u32 xfered ;  u8 * buf ;  int result ;  bool stop ; } cocci_id@p ;
...
position p;
@@
 enum st_i2c_mode { I2C_MODE_STANDARD , I2C_MODE_FAST , I2C_MODE_END , } cocci_id@p ;
