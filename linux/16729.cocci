...
position p;
@@
 struct pwrkey_drv_data * cocci_id@p ;
...
typedef u8;
@@
 struct pwrkey_drv_data {  struct regmap * snvs ;  int irq ;  int keycode ;  int keystate ;  int wakeup ;  struct timer_list check_timer ;  struct input_dev * input ;  u8 minor_rev ; } cocci_id@p ;
