...
position p;
@@
 struct {  struct maar_config cfgs [ 3 ] ;  unsigned used ; } cocci_id@p ;
...
position p;
@@
 struct maar_walk_info * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * begin , void * end ) ;
...
position p;
@@
 struct maar_walk_info {  struct maar_config cfg [ 16 ] ;  unsigned int num_cfg ; } cocci_id@p ;
