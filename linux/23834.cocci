...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_MIRRED_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_MIRRED_MAX + 1 ] ;
...
position p;
@@
 tc_action_priv_destructor * cocci_id@p ;
