...
typedef bool,u32;
@@
 struct at91wdt {  struct watchdog_device wdd ;  void __iomem * base ;  unsigned long next_heartbeat ;  struct timer_list timer ;  u32 mr ;  u32 mr_mask ;  unsigned long heartbeat ;  bool nowayout ;  unsigned int irq ;  struct clk * sclk ; } cocci_id@p ;
