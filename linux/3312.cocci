...
position p;
@@
 enum chips { thmc50 , adm1022 , } cocci_id@p ;
...
typedef s8,u8;
@@
 struct thmc50_data {  struct i2c_client * client ;  const struct attribute_group * groups [ 3 ] ;  struct mutex update_lock ;  enum chips type ;  unsigned long last_updated ;  char has_temp3 ;  char valid ;  s8 temp_input [ 3 ] ;  s8 temp_max [ 3 ] ;  s8 temp_min [ 3 ] ;  s8 temp_critical [ 3 ] ;  u8 analog_out ;  u8 alarms ; } cocci_id@p ;
