...
position p;
@@
 void cocci_id@p ( struct ipc_namespace * ns , struct shmid_kernel * shp ) ;
...
typedef time64_t;
@@
 struct shmid_kernel {  struct kern_ipc_perm shm_perm ;  struct file * shm_file ;  unsigned long shm_nattch ;  unsigned long shm_segsz ;  time64_t shm_atim ;  time64_t shm_dtim ;  time64_t shm_ctim ;  struct pid * shm_cprid ;  struct pid * shm_lprid ;  struct user_struct * mlock_user ;  struct task_struct * shm_creator ;  struct list_head shm_clist ; } cocci_id@p ;
...
position p;
@@
 struct shmid_kernel cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct seq_file * s , void * it ) ;
...
position p;
@@
 struct pid_namespace * cocci_id@p ;
...
position p;
@@
 const struct ipc_ops cocci_id@p ;
...
position p;
@@
 struct shm_file_data {  int id ;  struct ipc_namespace * ns ;  struct file * file ;  const struct vm_operations_struct * vm_ops ; } cocci_id@p ;
...
position p;
@@
 struct compat_shmid64_ds cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ipc_namespace * , struct ipc_params * ) ;
...
position p;
@@
 struct compat_shmid_ds cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_ipc_pid_t,compat_uptr_t,old_time32_t;
@@
 struct compat_shmid_ds {  struct compat_ipc_perm shm_perm ;  int shm_segsz ;  old_time32_t shm_atime ;  old_time32_t shm_dtime ;  old_time32_t shm_ctime ;  compat_ipc_pid_t shm_cpid ;  compat_ipc_pid_t shm_lpid ;  unsigned short shm_nattch ;  unsigned short shm_unused ;  compat_uptr_t shm_unused2 ;  compat_uptr_t shm_unused3 ; } cocci_id@p ;
...
@@
 struct compat_shminfo64 {  compat_ulong_t shmmax ;  compat_ulong_t shmmin ;  compat_ulong_t shmmni ;  compat_ulong_t shmseg ;  compat_ulong_t shmall ;  compat_ulong_t __unused1 ;  compat_ulong_t __unused2 ;  compat_ulong_t __unused3 ;  compat_ulong_t __unused4 ; } cocci_id@p ;
...
position p;
@@
 struct shm_file_data * cocci_id@p ;
...
position p;
@@
 struct compat_shm_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vm_area_struct * vma ) ;
...
position p;
@@
 struct compat_shminfo64 cocci_id@p ;
...
position p;
@@
 struct shmem_inode_info * cocci_id@p ;
...
position p;
@@
 struct ipc_namespace * cocci_id@p ;
