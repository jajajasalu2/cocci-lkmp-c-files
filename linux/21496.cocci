...
position p;
@@
 struct aesbs_ctr_ctx {  struct aesbs_ctx key ;  struct crypto_aes_ctx fallback ; } cocci_id@p ;
...
typedef u32;
@@
 struct aesbs_cbc_ctx {  struct aesbs_ctx key ;  u32 enc [ AES_MAX_KEYLENGTH_U32 ] ; } cocci_id@p ;
...
position p;
@@
 struct aesbs_ctr_ctx cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u8 rk [ ] , int rounds , int blocks , u8 iv [ ] , u8 final [ ] ) ;
...
position p;
@@
 struct aesbs_xts_ctx * cocci_id@p ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( u8 out [ ] , const u8 in [ ] , const u8 rk [ ] , int rounds , int blocks , u8 iv [ ] ) ;
...
position p;
@@
 struct aesbs_cbc_ctx * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u8 rk [ ] , int rounds , int blocks ) ;
...
typedef u32;
@@
 struct aesbs_xts_ctx {  struct aesbs_ctx key ;  u32 twkey [ AES_MAX_KEYLENGTH_U32 ] ;  struct crypto_aes_ctx cts ; } cocci_id@p ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 out [ ] , const u32 rk [ ] , int rounds ) ;
