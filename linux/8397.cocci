...
position p;
@@
 struct nfp_ipv4_addr_entry cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_tun_active_tuns {  __be32 seq ;  __be32 count ;  __be32 flags ;  struct route_ip_info {  __be32 ipv4 ;  __be32 egress_port ;  __be32 extra [ 2 ] ; } tun_info [ ] ; } cocci_id@p ;
...
position p;
@@
 struct nfp_tun_ipv4_addr cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_ipv4_addr_entry {  __be32 ipv4_addr ;  int ref_count ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct nfp_tun_mac_addr_offload cocci_id@p ;
...
position p;
@@
 struct nfp_tun_neigh cocci_id@p ;
...
position p;
@@
 struct nfp_tun_offloaded_mac cocci_id@p ;
...
position p;
@@
 struct nfp_tun_req_route_ipv4 * cocci_id@p ;
...
typedef u8;
@@
 struct nfp_tun_mac_addr_offload {  __be16 flags ;  __be16 count ;  __be16 index ;  u8 addr [ ETH_ALEN ] ; } cocci_id@p ;
...
typedef u8,__be32;
@@
 struct nfp_tun_neigh {  __be32 dst_ipv4 ;  __be32 src_ipv4 ;  u8 dst_addr [ ETH_ALEN ] ;  u8 src_addr [ ETH_ALEN ] ;  __be32 port_id ; } cocci_id@p ;
...
position p;
@@
 struct nfp_fl_payload * cocci_id@p ;
...
position p;
@@
 enum nfp_flower_mac_offload_cmd { NFP_TUNNEL_MAC_OFFLOAD_ADD = 0 , NFP_TUNNEL_MAC_OFFLOAD_DEL = 1 , NFP_TUNNEL_MAC_OFFLOAD_MOD = 2 , } cocci_id@p ;
...
position p;
@@
 struct nfp_tun_active_tuns * cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_ipv4_route_entry {  __be32 ipv4_addr ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct nfp_flower_non_repr_priv * cocci_id@p ;
...
position p;
@@
 struct nfp_tun_pre_tun_rule cocci_id@p ;
...
position p;
@@
 struct nfp_flower_repr_priv cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_tun_pre_tun_rule {  __be32 flags ;  __be16 port_idx ;  __be16 vlan_tci ;  __be32 host_ctx_id ; } cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_tun_ipv4_addr {  __be32 count ;  __be32 ipv4_addr [ NFP_FL_IPV4_ADDRS_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct nfp_ipv4_route_entry cocci_id@p ;
...
position p;
@@
 struct nfp_flower_priv * cocci_id@p ;
...
position p;
@@
 enum nfp_flower_mac_offload_cmd cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_tun_req_route_ipv4 {  __be32 ingress_port ;  __be32 ipv4_addr ;  __be32 reserved [ 2 ] ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct nfp_tun_offloaded_mac {  struct rhash_head ht_node ;  u8 addr [ ETH_ALEN ] ;  u16 index ;  int ref_count ;  struct list_head repr_list ;  int bridge_count ; } cocci_id@p ;
