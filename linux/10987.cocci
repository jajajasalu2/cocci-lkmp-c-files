...
position p;
@@
 ATOM_Vega10_PowerTune_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_PCIE_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_PIXCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 struct phm_tdp_table * * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_PowerTune_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_Fan_Table_V2 * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_Fan_Table_V2 * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_State_Array * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_PowerTune_Table_V3 * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_POWERPLAYTABLE * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_Fan_Table_V3 * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_PHYCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_Voltage_Lookup_Table * cocci_id@p ;
...
position p;
@@
 const Vega10_PPTable_Generic_SubTable_Header * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_Fan_Table * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_PowerTune_Table_V2 * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_PCIE_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_GFXCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_PowerTune_Table_V3 * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_DCEFCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_MM_Dependency_Record * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_MM_Dependency_Table * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_Voltage_Lookup_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_Hard_Limit_Table * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_Thermal_Controller * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_State * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_SOCCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_Fan_Table_V3 * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_State_Array * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_MCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_PowerTune_Table_V2 * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_Fan_Table * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_Thermal_Controller * cocci_id@p ;
...
position p;
@@
 const ATOM_Vega10_DISPCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v1_pcie_record cocci_id@p ;
