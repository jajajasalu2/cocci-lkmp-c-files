...
symbol cocci_id;
position p;
typedef u32,pm2type_t;
@@
 struct pm2fb_par {  pm2type_t type ;  unsigned char __iomem * v_regs ;  u32 memclock ;  u32 video ;  u32 mem_config ;  u32 mem_control ;  u32 boot_address ;  u32 palette [ 16 ] ;  int wc_cookie ; } cocci_id@p ;
...
typedef u16;
@@
 const struct {  u16 width ;  u16 pp ; } cocci_id@p [ ] ;
