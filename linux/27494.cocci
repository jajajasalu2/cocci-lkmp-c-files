...
position p;
@@
 struct ceph_mds_snap_head * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_snap_realm * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ceph_mds_client * mdsc , struct ceph_snap_realm * realm ) ;
...
position p;
@@
 struct ceph_snapid_map cocci_id@p ;
