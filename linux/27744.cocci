...
position p;
@@
 const struct gfs2_dirent * cocci_id@p ;
...
position p;
@@
 struct dirent_gather * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef gfs2_dscan_t;
@@
 gfs2_dscan_t cocci_id@p ;
...
position p;
@@
 const struct gfs2_meta_header * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const struct gfs2_dirent * dent , const struct qstr * name , void * opaque ) ;
...
position p;
@@
 struct dirent_gather {  const struct gfs2_dirent * * pdent ;  unsigned offset ; } cocci_id@p ;
