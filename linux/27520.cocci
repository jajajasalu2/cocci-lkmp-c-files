...
position p;
@@
 const struct virtio_device_id cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ sizeof_field ( struct virtio_fs_config , tag ) ] ;
...
position p;
@@
 struct virtio_fs {  struct kref refcount ;  struct list_head list ;  char * tag ;  struct virtio_fs_vq * vqs ;  unsigned int nvqs ;  unsigned int num_request_queues ; } cocci_id@p ;
...
position p;
@@
 enum { VQ_HIPRIO , VQ_REQUEST , } cocci_id@p ;
...
position p;
@@
 struct virtio_fs_forget {  struct list_head list ;  struct virtio_fs_forget_req req ; } cocci_id@p ;
...
position p;
@@
 struct virtio_fs_config cocci_id@p ;
...
position p;
@@
 struct virtio_fs_forget_req {  struct fuse_in_header ih ;  struct fuse_forget_in arg ; } cocci_id@p ;
...
position p;
@@
 struct virtio_fs_vq * cocci_id@p ;
...
position p;
@@
 struct scatterlist * cocci_id@p [ 6 ] ;
...
position p;
@@
 struct virtio_fs_forget_req * cocci_id@p ;
...
position p;
@@
 struct fuse_fs_context cocci_id@p ;
...
position p;
@@
 struct virtio_fs_forget * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct virtio_fs_vq * fsvq , struct fuse_req * req , bool in_flight ) ;
...
position p;
@@
 struct scatterlist cocci_id@p [ ARRAY_SIZE ( stack_sgs ) ] ;
