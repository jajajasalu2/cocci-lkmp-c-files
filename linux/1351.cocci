...
position p;
@@
 struct sisusb_command cocci_id@p ;
...
position p;
@@
 struct sisusb_packet cocci_id@p ;
...
position p;
@@
 struct sisusb_usb_data * cocci_id@p ;
...
position p;
@@
 struct sisusb_urb_context * cocci_id@p ;
