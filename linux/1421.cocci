...
position p;
@@
 struct net2280_request * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_gadget * _gadget , struct usb_gadget_driver * driver ) ;
...
position p;
@@
 void cocci_id@p ( struct net2280 * dev , struct usb_gadget_driver * driver ) ;
...
position p;
@@
 void cocci_id@p ( struct net2280 * dev ) ;
...
position p;
@@
 void cocci_id@p ( struct net2280_ep * ep ) ;
...
typedef u32;
@@
 union {  u32 raw [ 2 ] ;  struct usb_ctrlrequest r ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_ep * _ep ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_gadget * _gadget ) ;
...
position p;
@@
 void cocci_id@p ( struct net2280_ep * ) ;
