...
position p;
@@
 struct vb2_vmalloc_attachment {  struct sg_table sgt ;  enum dma_data_direction dma_dir ; } cocci_id@p ;
...
position p;
@@
 struct vb2_vmalloc_attachment * cocci_id@p ;
...
position p;
@@
 struct vb2_vmalloc_buf * cocci_id@p ;
...
typedef refcount_t;
@@
 struct vb2_vmalloc_buf {  void * vaddr ;  struct frame_vector * vec ;  enum dma_data_direction dma_dir ;  unsigned long size ;  refcount_t refcount ;  struct vb2_vmarea_handler handler ;  struct dma_buf * dbuf ; } cocci_id@p ;
