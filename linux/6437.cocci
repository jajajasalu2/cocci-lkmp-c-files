...
position p;
@@
 struct max1586_data {  struct i2c_client * client ;  unsigned int min_uV ;  unsigned int max_uV ;  unsigned int v3_curr_sel ;  unsigned int v6_curr_sel ; } cocci_id@p ;
...
position p;
@@
 struct max1586_data * cocci_id@p ;
...
position p;
@@
 struct of_regulator_match cocci_id@p [ ARRAY_SIZE ( max1586_reg ) ] ;
