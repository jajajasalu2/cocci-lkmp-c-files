...
position p;
@@
 union {  struct nv_device_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_sclass cocci_id@p ;
...
position p;
@@
 union {  struct nv_device_time_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nv_device_info_v0 v0 ;  struct nv_device_info_v1 v1 ; } * cocci_id@p ;
...
position p;
@@
 struct nvkm_udevice cocci_id@p ;
...
position p;
@@
 struct nvkm_udevice {  struct nvkm_object object ;  struct nvkm_device * device ; } cocci_id@p ;
