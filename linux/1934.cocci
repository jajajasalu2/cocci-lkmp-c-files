...
position p;
@@
 struct ams_iaqcore_data {  struct i2c_client * client ;  struct mutex lock ;  unsigned long last_update ;  struct ams_iaqcore_reading buffer ; } cocci_id@p ;
...
position p;
@@
 struct ams_iaqcore_data * cocci_id@p ;
