...
position p;
@@
 struct dc_virtual_addr_space_config * cocci_id@p ;
...
position p;
@@
 struct dcn_hubbub_phys_addr_config cocci_id@p ;
...
position p;
@@
 struct dc_phy_addr_space_config * cocci_id@p ;
...
position p;
@@
 struct dcn_hubbub_virt_addr_config cocci_id@p ;
...
position p;
@@
 struct dc_dmdata_attributes cocci_id@p ;
...
position p;
@@
 const struct tg_color cocci_id@p [ 6 ] ;
...
position p;
@@
 enum mpc_output_csc_mode cocci_id@p ;
...
position p;
@@
 enum dynamic_metadata_mode cocci_id@p ;
