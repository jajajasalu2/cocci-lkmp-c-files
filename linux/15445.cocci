...
typedef u8;
@@
 const struct {  u8 reg_val ;  int time ; } cocci_id@p [ ] ;
...
position p;
@@
 struct da9052_wdt_data {  struct watchdog_device wdt ;  struct da9052 * da9052 ;  unsigned long jpast ; } cocci_id@p ;
...
position p;
@@
 struct da9052_wdt_data * cocci_id@p ;
