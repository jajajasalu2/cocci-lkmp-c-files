...
position p;
@@
 struct mpc52xx_lpbfifo cocci_id@p ;
...
@@
 struct mpc52xx_lpbfifo {  struct device * dev ;  phys_addr_t regs_phys ;  void __iomem * regs ;  int irq ;  spinlock_t lock ;  struct bcom_task * bcom_tx_task ;  struct bcom_task * bcom_rx_task ;  struct bcom_task * bcom_cur_task ;  struct mpc52xx_lpbfifo_request * req ;  int dma_irqs_enabled ; } cocci_id@p ;
...
position p;
@@
 struct mpc52xx_lpbfifo_request * cocci_id@p ;
