...
position p;
@@
 struct corgi_lcd_platform_data * cocci_id@p ;
...
position p;
@@
 struct scoop_config cocci_id@p ;
...
position p;
@@
 struct matrix_keypad_platform_data cocci_id@p ;
...
position p;
@@
 struct sharpsl_nand_platform_data cocci_id@p ;
...
position p;
@@
 const struct matrix_keymap_data cocci_id@p ;
...
position p;
@@
 struct scoop_pcmcia_config cocci_id@p ;
...
position p;
@@
 struct scoop_pcmcia_dev cocci_id@p [ ] ;
