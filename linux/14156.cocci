...
position p;
@@
 const struct pxa_camera_format_xlate * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,u16,spinlock_t;
@@
 struct pxa_camera_dev {  struct v4l2_device v4l2_dev ;  struct video_device vdev ;  struct v4l2_async_notifier notifier ;  struct vb2_queue vb2_vq ;  struct v4l2_subdev * sensor ;  struct pxa_camera_format_xlate * user_formats ;  const struct pxa_camera_format_xlate * current_fmt ;  struct v4l2_pix_format current_pix ;  struct v4l2_async_subdev asd ;  struct clk * clk ;  unsigned int irq ;  void __iomem * base ;  int channels ;  struct dma_chan * dma_chans [ 3 ] ;  struct pxacamera_platform_data * pdata ;  struct resource * res ;  unsigned long platform_flags ;  unsigned long ciclk ;  unsigned long mclk ;  u32 mclk_divisor ;  struct v4l2_clk * mclk_clk ;  u16 width_flags ;  struct list_head capture ;  spinlock_t lock ;  struct mutex mlock ;  unsigned int buf_sequence ;  struct pxa_buffer * active ;  struct tasklet_struct task_eof ;  u32 save_cicr [ 5 ] ; } cocci_id@p ;
...
position p;
@@
 struct v4l2_mbus_framefmt * cocci_id@p ;
...
position p;
@@
 struct pxa_cam {  unsigned long flags ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,dma_cookie_t;
@@
 struct pxa_buffer {  struct vb2_v4l2_buffer vbuf ;  struct list_head queue ;  u32 code ;  int nb_planes ;  struct dma_async_tx_descriptor * descs [ 3 ] ;  dma_cookie_t cookie [ 3 ] ;  struct scatterlist * sg [ 3 ] ;  int sg_len [ 3 ] ;  size_t plane_sizes [ 3 ] ;  int inwork ;  enum pxa_camera_active_dma active_dma ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_clk_ops cocci_id@p ;
...
typedef u32;
@@
 struct pxa_camera_format_xlate {  u32 code ;  const struct pxa_mbus_pixelfmt * host_fmt ; } cocci_id@p ;
...
position p;
@@
 enum pxa_camera_active_dma cocci_id@p ;
...
typedef u32;
@@
 struct pxa_mbus_lookup {  u32 code ;  struct pxa_mbus_pixelfmt fmt ; } cocci_id@p ;
...
position p;
@@
 enum pxa_mbus_packing { PXA_MBUS_PACKING_NONE , PXA_MBUS_PACKING_2X8_PADHI , PXA_MBUS_PACKING_EXTEND16 , } cocci_id@p ;
...
position p;
@@
 const struct pxa_mbus_lookup cocci_id@p [ ] ;
...
position p;
@@
 const struct pxa_mbus_pixelfmt cocci_id@p [ ] ;
...
position p;
@@
 enum pxa_mbus_layout { PXA_MBUS_LAYOUT_PACKED = 0 , PXA_MBUS_LAYOUT_PLANAR_2Y_U_V , PXA_MBUS_LAYOUT_PLANAR_2Y_C , PXA_MBUS_LAYOUT_PLANAR_Y_C , } cocci_id@p ;
...
position p;
@@
 const struct v4l2_async_notifier_operations cocci_id@p ;
...
typedef u8,u32;
@@
 struct pxa_mbus_pixelfmt {  const char * name ;  u32 fourcc ;  enum pxa_mbus_packing packing ;  enum pxa_mbus_order order ;  enum pxa_mbus_layout layout ;  u8 bits_per_sample ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pxa_camera_dev * pcdev , enum pxa_camera_active_dma act_dma ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct v4l2_device * , unsigned int , struct pxa_camera_format_xlate * xlate ) ;
...
position p;
@@
 struct v4l2_async_notifier * cocci_id@p ;
...
position p;
@@
 struct v4l2_subdev_pad_config cocci_id@p ;
...
position p;
@@
 const struct v4l2_mbus_config * cocci_id@p ;
...
position p;
@@
 struct v4l2_subdev_mbus_code_enum cocci_id@p ;
...
position p;
@@
 struct v4l2_mbus_config cocci_id@p ;
...
position p;
@@
 struct v4l2_async_subdev * cocci_id@p ;
...
position p;
@@
 enum pxa_mbus_order { PXA_MBUS_ORDER_LE , PXA_MBUS_ORDER_BE , } cocci_id@p ;
...
position p;
@@
 struct pxa_camera_format_xlate * cocci_id@p ;
...
position p;
@@
 struct pxa_camera_dev cocci_id@p ;
...
position p;
@@
 enum pxa_camera_active_dma { DMA_Y = 0x1 , DMA_U = 0x2 , DMA_V = 0x4 , } cocci_id@p ;
...
position p;
@@
 struct v4l2_fwnode_endpoint cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ V4L2_CLK_NAME_SIZE ] ;
