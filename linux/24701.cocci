...
position p;
@@
 unsigned char cocci_id@p [ MAX_GET_ARGLEN ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ CMDID ( IP_VS_SO_SET_MAX ) + 1 ] ;
...
position p;
@@
 struct ip_vs_service * cocci_id@p ;
...
position p;
@@
 struct ip_vs_daemon_user * cocci_id@p ;
...
position p;
@@
 struct ip_vs_scheduler * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IPVS_DAEMON_ATTR_MAX + 1 ] ;
...
position p;
@@
 union ip_vs_set_arglen cocci_id@p ;
...
position p;
@@
 const struct ip_vs_service * cocci_id@p ;
...
position p;
@@
 union ip_vs_get_arglen cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct ip_vs_service * svc , bool cleanup ) ;
...
position p;
@@
 struct ip_vs_svcdest_user {  struct ip_vs_service_user s ;  struct ip_vs_dest_user d ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_getinfo cocci_id@p ;
...
position p;
@@
 const struct ip_vs_iter * cocci_id@p ;
...
position p;
@@
 struct ip_vs_service_user_kern * cocci_id@p ;
...
position p;
@@
 struct ipvs_sync_daemon_cfg cocci_id@p ;
...
position p;
@@
 struct ip_vs_timeout_user cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_SET_ARGLEN ] ;
...
position p;
@@
 struct ip_vs_get_dests * cocci_id@p ;
...
position p;
@@
 struct ip_vs_cpu_stats * cocci_id@p ;
...
position p;
@@
 struct ip_vs_get_services * cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ CMDID ( IP_VS_SO_GET_MAX ) + 1 ] ;
...
position p;
@@
 const struct ip_vs_get_services * cocci_id@p ;
...
position p;
@@
 struct ip_vs_iter {  struct seq_net_private p ;  struct hlist_head * table ;  int bucket ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IPVS_SVC_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ip_vs_service_user cocci_id@p ;
...
position p;
@@
 const struct ip_vs_get_dests * cocci_id@p ;
...
position p;
@@
 struct hlist_head cocci_id@p [ IP_VS_SVC_TAB_SIZE ] ;
...
position p;
@@
 struct ip_vs_dest_user_kern cocci_id@p ;
...
position p;
@@
 struct nf_sockopt_ops cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IPVS_DEST_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ip_vs_kstats * cocci_id@p ;
...
position p;
@@
 struct ip_vs_service_entry cocci_id@p ;
...
position p;
@@
 struct ip_vs_dest_dst cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IPVS_CMD_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ip_vs_dest_entry cocci_id@p ;
...
position p;
@@
 const struct ip_vs_dest * cocci_id@p ;
...
position p;
@@
 union ip_vs_set_arglen {  struct ip_vs_service_user field_IP_VS_SO_SET_ADD ;  struct ip_vs_service_user field_IP_VS_SO_SET_EDIT ;  struct ip_vs_service_user field_IP_VS_SO_SET_DEL ;  struct ip_vs_svcdest_user field_IP_VS_SO_SET_ADDDEST ;  struct ip_vs_svcdest_user field_IP_VS_SO_SET_DELDEST ;  struct ip_vs_svcdest_user field_IP_VS_SO_SET_EDITDEST ;  struct ip_vs_timeout_user field_IP_VS_SO_SET_TIMEOUT ;  struct ip_vs_daemon_user field_IP_VS_SO_SET_STARTDAEMON ;  struct ip_vs_daemon_user field_IP_VS_SO_SET_STOPDAEMON ;  struct ip_vs_service_user field_IP_VS_SO_SET_ZERO ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_svcdest_user cocci_id@p ;
...
position p;
@@
 struct ip_vs_proto_data * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IPVS_SVC_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IPVS_CMD_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IPVS_DAEMON_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ip_vs_stats_user * cocci_id@p ;
...
position p;
@@
 struct ip_vs_daemon_user cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IPVS_DEST_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ip_vs_dest_user * cocci_id@p ;
