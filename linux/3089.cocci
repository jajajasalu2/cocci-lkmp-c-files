...
typedef u8;
@@
 void cocci_id@p ( Interface * ppc , u8 * data , long count ) ;
...
typedef u8,u16;
@@
 struct ppc_storage {  u16 lpt_addr ;  u8 ppc_id ;  u8 mode ;  u8 ppc_flags ;  u8 org_data ;  u8 org_ctrl ;  u8 cur_ctrl ; } cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( Interface * ppc , u8 regdata ) ;
...
typedef u8;
@@
 void cocci_id@p ( Interface * ppc , u8 port , u8 * data , long length ) ;
...
typedef u8;
@@
 void cocci_id@p ( Interface * ppc , u8 data ) ;
...
typedef u8;
@@
 u8 cocci_id@p ( Interface * ppc , u8 port ) ;
...
typedef u8;
@@
 void cocci_id@p ( Interface * ppc , u8 cmd ) ;
...
typedef u8;
@@
 void cocci_id@p ( Interface * ppc , u8 port , u8 data ) ;
