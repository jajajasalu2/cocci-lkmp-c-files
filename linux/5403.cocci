...
@@
 struct bcm_qspi_irq {  const char * irq_name ;  const irq_handler_t irq_handler ;  int irq_source ;  u32 mask ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct bcm_qspi {  struct platform_device * pdev ;  struct spi_master * master ;  struct clk * clk ;  u32 base_clk ;  u32 max_speed_hz ;  void __iomem * base [ BASEMAX ] ;  struct bcm_qspi_soc_intc * soc_intc ;  struct bcm_qspi_parms last_parms ;  struct qspi_trans trans_pos ;  int curr_cs ;  int bspi_maj_rev ;  int bspi_min_rev ;  int bspi_enabled ;  const struct spi_mem_op * bspi_rf_op ;  u32 bspi_rf_op_idx ;  u32 bspi_rf_op_len ;  u32 bspi_rf_op_status ;  struct bcm_xfer_mode xfer_mode ;  u32 s3_strap_override_ctrl ;  bool bspi_mode ;  bool big_endian ;  int num_irqs ;  struct bcm_qspi_dev_id * dev_ids ;  struct completion mspi_done ;  struct completion bspi_done ; } cocci_id@p ;
...
position p;
@@
 struct bcm_qspi_parms cocci_id@p ;
...
position p;
@@
 const struct bcm_qspi_parms * cocci_id@p ;
...
position p;
@@
 struct bcm_qspi_dev_id * cocci_id@p ;
...
position p;
@@
 const struct spi_controller_mem_ops cocci_id@p ;
...
position p;
@@
 const struct bcm_qspi_irq cocci_id@p [ ] ;
...
typedef bool;
@@
 struct qspi_trans {  struct spi_transfer * trans ;  int byte ;  bool mspi_last_trans ; } cocci_id@p ;
...
position p;
@@
 struct bcm_qspi_soc_intc * cocci_id@p ;
...
position p;
@@
 const struct spi_mem_op * cocci_id@p ;
...
position p;
@@
 enum irq_source { SINGLE_L2 , MUXED_L1 , } cocci_id@p ;
...
position p;
@@
 struct bcm_qspi_dev_id {  const struct bcm_qspi_irq * irqp ;  void * dev ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct bcm_qspi_parms {  u32 speed_hz ;  u8 mode ;  u8 bits_per_word ; } cocci_id@p ;
...
typedef bool;
@@
 struct bcm_xfer_mode {  bool flex_mode ;  unsigned int width ;  unsigned int addrlen ;  unsigned int hp ; } cocci_id@p ;
...
position p;
@@
 enum base_type { MSPI , BSPI , CHIP_SELECT , BASEMAX , } cocci_id@p ;
