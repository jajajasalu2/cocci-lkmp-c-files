...
typedef spinlock_t;
@@
 struct {  char fw_ver_str [ 6 ] ;  int revision ;  int supports_temp ;  int command_mode ;  int boot_status ;  int io_addr ;  spinlock_t io_lock ;  struct timer_list timer ;  unsigned long next_heartbeat ; } cocci_id@p ;
