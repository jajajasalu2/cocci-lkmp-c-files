...
position p;
@@
 struct open_bucket {  struct list_head list ;  unsigned int last_write_point ;  unsigned int sectors_free ;  BKEY_PADDED ( key ) ; } cocci_id@p ;
