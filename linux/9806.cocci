...
position p;
@@
 struct ath10k_qmi_driver_event cocci_id@p ;
...
position p;
@@
 struct wlfw_cap_req_msg_v01 cocci_id@p ;
...
position p;
@@
 enum ath10k_qmi_driver_event_type cocci_id@p ;
...
position p;
@@
 struct wlfw_fw_ready_ind_msg_v01 cocci_id@p ;
...
position p;
@@
 struct ath10k_msa_mem_info * cocci_id@p ;
...
position p;
@@
 struct ath10k_qmi_wlan_enable_cfg * cocci_id@p ;
...
position p;
@@
 struct wlfw_msa_ready_ind_msg_v01 cocci_id@p ;
...
position p;
@@
 struct qcom_scm_vmperm cocci_id@p [ 3 ] ;
...
position p;
@@
 struct wlfw_msa_ready_req_msg_v01 cocci_id@p ;
