...
position p;
@@
 enum pm_suspend_mode { PM_SUSPEND_MODE_FIRST = 0 , PM_SUSPEND_MODE_STD = PM_SUSPEND_MODE_FIRST , PM_SUSPEND_MODE_POWER_OFF , } cocci_id@p ;
...
position p;
@@
 enum pm_api_cb_id { PM_INIT_SUSPEND_CB = 30 , PM_ACKNOWLEDGE_CB , PM_NOTIFY_CB , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ CB_PAYLOAD_SIZE ] ;
...
position p;
@@
 enum pm_suspend_mode cocci_id@p ;
