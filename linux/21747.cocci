...
typedef u8,u32;
@@
 struct ghash_desc_ctx {  u8 icv [ GHASH_BLOCK_SIZE ] ;  u8 key [ GHASH_BLOCK_SIZE ] ;  u8 buffer [ GHASH_BLOCK_SIZE ] ;  u32 bytes ; } cocci_id@p ;
...
typedef u8;
@@
 struct ghash_ctx {  u8 key [ GHASH_BLOCK_SIZE ] ; } cocci_id@p ;
