...
typedef u32;
@@
 struct icc_req {  struct hlist_node req_node ;  struct icc_node * node ;  struct device * dev ;  u32 tag ;  u32 avg_bw ;  u32 peak_bw ; } cocci_id@p ;
...
position p;
@@
 struct icc_path {  size_t num_nodes ;  struct icc_req reqs [ ] ; } cocci_id@p ;
