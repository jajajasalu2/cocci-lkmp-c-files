...
typedef bool;
@@
 struct olpc_battery_data {  struct power_supply * olpc_ac ;  struct power_supply * olpc_bat ;  char bat_serial [ 17 ] ;  bool new_proto ;  bool little_endian ; } cocci_id@p ;
...
position p;
@@
 struct olpc_battery_data * cocci_id@p ;
