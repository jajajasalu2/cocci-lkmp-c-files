...
position p;
@@
 struct pixclock_div * cocci_id@p ;
...
position p;
@@
 struct mbxfb_planeorder cocci_id@p ;
...
position p;
@@
 struct mbxfb_overlaySetup * cocci_id@p ;
...
position p;
@@
 struct mbxfb_alphaCtl cocci_id@p ;
...
typedef u8;
@@
 struct pixclock_div {  u8 m ;  u8 n ;  u8 p ; } cocci_id@p ;
...
position p;
@@
 struct mbxfb_platform_data * cocci_id@p ;
