...
position p;
@@
 struct pca953x_reg_config {  int direction ;  int output ;  int input ;  int invert ; } cocci_id@p ;
...
position p;
@@
 struct pca953x_chip * cocci_id@p ;
...
position p;
@@
 const struct pca953x_reg_config cocci_id@p ;
