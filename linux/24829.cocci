...
position p;
@@
 struct xt_led_info_internal {  struct list_head list ;  int refcnt ;  char * trigger_id ;  struct led_trigger netfilter_led_trigger ;  struct timer_list timer ; } cocci_id@p ;
...
position p;
@@
 const struct xt_led_info * cocci_id@p ;
...
position p;
@@
 struct xt_led_info_internal cocci_id@p ;
