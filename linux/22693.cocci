...
position p;
@@
 struct snd_uart16550 * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct snd_uart16550 {  struct snd_card * card ;  struct snd_rawmidi * rmidi ;  struct snd_rawmidi_substream * midi_output [ SNDRV_SERIAL_MAX_OUTS ] ;  struct snd_rawmidi_substream * midi_input [ SNDRV_SERIAL_MAX_INS ] ;  int filemode ;  spinlock_t open_lock ;  int irq ;  unsigned long base ;  struct resource * res_base ;  unsigned int speed ;  unsigned int speed_base ;  unsigned char divisor ;  unsigned char old_divisor_lsb ;  unsigned char old_divisor_msb ;  unsigned char old_line_ctrl_reg ;  short int fifo_limit ;  short int fifo_count ;  int adaptor ;  int prev_in ;  unsigned char rstatus ;  int prev_out ;  unsigned char prev_status [ SNDRV_SERIAL_MAX_OUTS ] ;  unsigned char tx_buff [ TX_BUFF_SIZE ] ;  int buff_in_count ;  int buff_in ;  int buff_out ;  int drop_on_full ;  unsigned int timer_running : 1 ;  struct timer_list buffer_timer ; } cocci_id@p ;
...
position p;
@@
 struct snd_rawmidi_str * cocci_id@p ;
