...
position p;
@@
 struct gr3d {  struct tegra_drm_client client ;  struct host1x_channel * channel ;  struct clk * clk_secondary ;  struct clk * clk ;  struct reset_control * rst_secondary ;  struct reset_control * rst ;  const struct gr3d_soc * soc ; 
...
position p;
@@
 struct gr3d_soc {  unsigned int version ; } cocci_id@p ;
...
position p;
@@
 const struct gr3d_soc cocci_id@p ;
