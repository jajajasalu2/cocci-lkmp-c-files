...
position p;
@@
 const struct dn_fib_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( __le16 local , struct net_device * dev , int force ) ;
...
typedef u32;
@@
 struct {  struct nlattr hdr ;  u32 oif ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  int error ;  u8 scope ; } cocci_id@p [ RTN_MAX + 1 ] ;
...
position p;
@@
 struct {  struct nlmsghdr nlh ;  struct rtmsg rtm ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nlattr hdr ;  __le16 prefsrc ; } cocci_id@p ;
...
position p;
@@
 struct dn_fib_table * cocci_id@p ;
...
position p;
@@
 struct {  struct nlattr hdr ;  __le16 dst ; } cocci_id@p ;
