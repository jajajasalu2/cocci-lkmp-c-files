...
position p;
@@
 int cocci_id@p ( struct fscache_object * , enum fscache_obj_ref_trace ) ;
...
position p;
@@
 const struct fscache_state * cocci_id@p ;
...
position p;
@@
 const struct fscache_state * cocci_id@p ( struct fscache_object * , int ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct fscache_object * , int ) ;
...
position p;
@@
 struct fscache_cache * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fscache_object * ) ;
...
position p;
@@
 const struct fscache_transition * cocci_id@p ;
...
position p;
@@
 struct fscache_object * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fscache_object * , enum fscache_obj_ref_trace ) ;
...
position p;
@@
 struct fscache_operation * cocci_id@p ;
...
position p;
@@
 enum fscache_checkaux cocci_id@p ;
...
position p;
@@
 enum fscache_obj_ref_trace cocci_id@p ;
...
position p;
@@
 enum fscache_why_object_killed cocci_id@p ;
...
position p;
@@
 struct fscache_cookie * cocci_id@p ;
...
position p;
@@
 struct fscache_state * cocci_id@p ;
