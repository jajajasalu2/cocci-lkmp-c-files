...
position p;
@@
 struct ahc_tmode_event * cocci_id@p ;
...
position p;
@@
 const struct ahc_phase_table_entry * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ahc_io_ctx_t;
@@
 ahc_io_ctx_t cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct ahc_devinfo * devinfo , u_int bus_width ) ;
...
typedef u_int;
@@
 struct ahc_tmode_tstate * cocci_id@p ( struct ahc_softc * ahc , u_int scsi_id , char channel ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , u_int tcl , u_int busyid ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct ahc_tmode_lstate * lstate , u_int initiator_id , u_int event_type , u_int event_arg ) ;
...
position p;
@@
 struct ahc_tmode_lstate * * cocci_id@p ;
...
typedef u_int;
@@
 int cocci_id@p ( struct ahc_softc * ahc , ahc_msgtype type , u_int msgval , int full ) ;
...
position p;
@@
 const struct ahc_syncrate cocci_id@p [ ] ;
...
position p;
@@
 struct ahc_transinfo * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct scb_tailq * queue ) ;
...
position p;
@@
 int cocci_id@p ( struct ahc_softc * ahc , struct target_cmd * cmd ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct ahc_devinfo * devinfo , u_int period , u_int offset , u_int bus_width , u_int ppr_options ) ;
...
typedef u_int;
@@
 u_int cocci_id@p ( struct ahc_softc * ahc , u_int scbpos , u_int prev ) ;
...
position p;
@@
 int cocci_id@p ( struct ahc_softc * ahc , struct ahc_devinfo * devinfo ) ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct scb * prev_scb , struct scb * scb ) ;
...
typedef uint8_t;
@@
 struct ahc_hard_error_entry {  uint8_t errno ;  const char * errmesg ; } cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , u_int intstat ) ;
...
position p;
@@
 struct ahc_tmode_tstate * cocci_id@p ;
...
position p;
@@
 struct ahc_initiator_tinfo * cocci_id@p ;
...
position p;
@@
 struct scsi_sense_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct ahc_devinfo * devinfo ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , u_int tcl ) ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct scb * scb ) ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , int paused ) ;
...
typedef u_int;
@@
 u_int cocci_id@p ( struct ahc_softc * ahc , u_int prev , u_int scbptr ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct ahc_devinfo * devinfo , u_int period , u_int offset ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , u_int scsi_id , char channel , int force ) ;
...
position p;
@@
 int cocci_id@p ( struct ahc_softc * ahc ) ;
...
symbol cocci_id;
position p;
typedef ahc_reg_parse_entry_t;
@@
 const ahc_reg_parse_entry_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct ahc_devinfo * devinfo , cam_status status , char * message , int verbose_level ) ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct ahc_devinfo * devinfo , struct scb * scb ) ;
...
position p;
@@
 const struct ahc_hard_error_entry cocci_id@p [ ] ;
...
position p;
@@
 enum { AHCMSG_1B , AHCMSG_2B , AHCMSG_EXT , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc ) ;
...
typedef u_int;
@@
 u_int cocci_id@p ( struct ahc_softc * ahc , u_int tcl ) ;
...
typedef u_int;
@@
 int cocci_id@p ( struct ahc_softc * ahc , const struct patch * * start_patch , u_int start_instr , u_int * skip_addr ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , u_int targid_mask ) ;
