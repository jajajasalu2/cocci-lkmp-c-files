...
typedef u8,u32;
@@
 struct alps_dev {  struct input_dev * input ;  struct input_dev * input2 ;  struct hid_device * hdev ;  enum dev_num dev_type ;  u8 max_fingers ;  u8 has_sp ;  u8 sp_btn_info ;  u32 x_active_len_mm ;  u32 y_active_len_mm ;  u32 x_max ;  u32 y_max ;  u32 x_min ;  u32 y_min ;  u32 btn_cnt ;  u32 sp_btn_cnt ; } cocci_id@p ;
...
position p;
@@
 struct t4_input_report * cocci_id@p ;
...
position p;
@@
 enum dev_num { U1 , T4 , UNKNOWN , } cocci_id@p ;
...
typedef u8;
@@
 struct t4_contact_data {  u8 palm ;  u8 x_lo ;  u8 x_hi ;  u8 y_lo ;  u8 y_hi ; } cocci_id@p ;
