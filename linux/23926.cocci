...
position p;
@@
 struct ipfrag_skb_cb * cocci_id@p ;
...
position p;
@@
 struct ipfrag_skb_cb {  union {  struct inet_skb_parm h4 ;  struct inet6_skb_parm h6 ; } ;  struct sk_buff * next_frag ;  int frag_run_len ; } cocci_id@p ;
