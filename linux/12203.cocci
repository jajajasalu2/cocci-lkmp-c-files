...
position p;
@@
 struct xendispl_event_page * cocci_id@p ;
...
position p;
@@
 struct xendispl_evt * cocci_id@p ;
...
position p;
@@
 enum xen_drm_front_evtchnl_state cocci_id@p ;
...
position p;
@@
 enum xen_drm_front_evtchnl_type cocci_id@p ;
...
position p;
@@
 struct xen_drm_front_evtchnl_pair cocci_id@p ;
...
position p;
@@
 struct xen_displif_sring * cocci_id@p ;
...
position p;
@@
 struct xendispl_resp * cocci_id@p ;
