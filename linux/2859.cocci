...
position p;
@@
 void cocci_id@p ( struct acpi_evaluate_info * info ) ;
...
position p;
@@
 struct acpi_get_devices_info * cocci_id@p ;
...
position p;
@@
 struct acpi_pnp_device_id * cocci_id@p ;
...
position p;
@@
 acpi_object_handler cocci_id@p ;
