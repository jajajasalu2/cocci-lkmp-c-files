...
typedef u8,u32;
@@
 struct shf {  u32 freq ;  u32 ofst_th ;  u8 shf_val ;  u8 shf_dir ; } cocci_id@p ;
...
position p;
@@
 struct mxl301rf_state {  struct mxl301rf_config cfg ;  struct i2c_client * i2c ; } cocci_id@p ;
...
position p;
@@
 struct mxl301rf_state * cocci_id@p ;
