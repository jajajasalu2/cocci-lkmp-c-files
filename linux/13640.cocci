...
position p;
@@
 const struct sensor_val cocci_id@p [ ] ;
...
position p;
@@
 struct stk1135_pkt_header * cocci_id@p ;
...
typedef u16;
@@
 struct sensor_val {  u16 reg ;  u16 val ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct sd {  struct gspca_dev gspca_dev ;  u8 pkt_seq ;  u8 sensor_page ;  bool flip_status ;  u8 flip_debounce ;  struct v4l2_ctrl * hflip ;  struct v4l2_ctrl * vflip ; } cocci_id@p ;
