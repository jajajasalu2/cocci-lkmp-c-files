...
position p;
@@
 struct bd6107_platform_data * cocci_id@p ;
...
position p;
@@
 struct bd6107 {  struct i2c_client * client ;  struct backlight_device * backlight ;  struct bd6107_platform_data * pdata ; } cocci_id@p ;
