...
position p;
@@
 int cocci_id@p ( struct net2272_ep * , struct net2272_request * ) ;
...
position p;
@@
 struct net2272_request cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net2272_ep * ) ;
...
typedef u8;
@@
 union {  u8 raw [ 8 ] ;  struct usb_ctrlrequest r ; } cocci_id@p ;
