...
position p;
@@
 struct apbps2_priv {  struct serio * io ;  struct apbps2_regs * regs ; } cocci_id@p ;
...
typedef u32;
@@
 struct apbps2_regs {  u32 __iomem data ;  u32 __iomem status ;  u32 __iomem ctrl ;  u32 __iomem reload ; } cocci_id@p ;
