...
position p;
@@
 struct audit_parent cocci_id@p ;
...
position p;
@@
 struct audit_fsnotify_mark * cocci_id@p ;
...
position p;
@@
 struct audit_parent {  struct list_head watches ;  struct fsnotify_mark mark ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dev_t,refcount_t;
@@
 struct audit_watch {  refcount_t count ;  dev_t dev ;  char * path ;  unsigned long ino ;  struct audit_parent * parent ;  struct list_head wlist ;  struct list_head rules ; } cocci_id@p ;
