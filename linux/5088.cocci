...
typedef spinlock_t;
@@
 struct xlp_gpio_priv {  struct gpio_chip chip ; 
	 DECLARE_BITMAP ( gpio_enabled_mask , XLP_MAX_NR_GPIO ) 
		 ;  void __iomem * gpio_intr_en ;  void __iomem * gpio_intr_stat ;  void __iomem * gpio_intr_type ;  void __iomem * gpio_intr_pol ;  void __iomem * gpio_out_en ;  void __iomem * gpio_paddrv ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct xlp_gpio_priv * cocci_id@p ;
...
position p;
@@
 enum { XLP_GPIO_VARIANT_XLP832 = 1 , XLP_GPIO_VARIANT_XLP316 , XLP_GPIO_VARIANT_XLP208 , XLP_GPIO_VARIANT_XLP980 , XLP_GPIO_VARIANT_XLP532 , GPIO_VARIANT_VULCAN , } cocci_id@p ;
