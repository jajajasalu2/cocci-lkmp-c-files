...
typedef u32;
@@
 struct qede_link_mode_mapping {  u32 qed_link_mode ;  u32 ethtool_link_mode ; } cocci_id@p ;
...
position p;
@@
 struct eth_fast_path_rx_reg_cqe * cocci_id@p ;
...
position p;
@@
 enum { QEDE_PRI_FLAG_CMT , QEDE_PRI_FLAG_SMART_AN_SUPPORT , QEDE_PRI_FLAG_LEN , } cocci_id@p ;
...
typedef u64;
@@
 const struct {  u64 offset ;  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct eth_tx_1st_bd * cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ QEDE_PRI_FLAG_LEN ] [ ETH_GSTRING_LEN ] ;
...
position p;
@@
 enum qede_ethtool_tests { QEDE_ETHTOOL_INT_LOOPBACK , QEDE_ETHTOOL_INTERRUPT_TEST , QEDE_ETHTOOL_MEMORY_TEST , QEDE_ETHTOOL_REGISTER_TEST , QEDE_ETHTOOL_CLOCK_TEST , QEDE_ETHTOOL_NVRAM_TEST , QEDE_ETHTOOL_TEST_MAX , } cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ QEDE_ETHTOOL_TEST_MAX ] [ ETH_GSTRING_LEN ] ;
...
position p;
@@
 const struct qede_link_mode_mapping cocci_id@p [ ] ;
