...
typedef bool;
@@
 struct ak7375_device {  struct v4l2_ctrl_handler ctrls_vcm ;  struct v4l2_subdev sd ;  struct v4l2_ctrl * focus ;  bool active ; } cocci_id@p ;
...
position p;
@@
 struct ak7375_device * cocci_id@p ;
