...
position p;
@@
 struct assoc_array_walk_result cocci_id@p ;
...
position p;
@@
 const struct assoc_array * cocci_id@p ;
...
position p;
@@
 enum assoc_array_walk_status cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const void * object , void * iterator_data ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( const void * leaf , void * iterator_data ) ;
...
position p;
@@
 struct assoc_array_delete_collapse_context {  struct assoc_array_node * node ;  const void * skip_leaf ;  int slot ; } cocci_id@p ;
...
position p;
@@
 struct assoc_array_walk_result {  struct {  struct assoc_array_node * node ;  int level ;  int slot ; } terminal_node ;  struct {  struct assoc_array_shortcut * shortcut ;  int level ;  int sc_level ;  unsigned long sc_segments ;  unsigned long dissimilarity ; } wrong_shortcut ; } cocci_id@p ;
...
position p;
@@
 struct assoc_array_delete_collapse_context * cocci_id@p ;
...
position p;
@@
 const struct assoc_array_shortcut * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( void * object , void * iterator_data ) ;
...
position p;
@@
 const struct assoc_array_node * cocci_id@p ;
