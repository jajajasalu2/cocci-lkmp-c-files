...
position p;
@@
 const struct exar8250_platform cocci_id@p ;
...
position p;
@@
 const struct exar8250_board * cocci_id@p ;
...
position p;
@@
 struct exar8250_board * cocci_id@p ;
...
position p;
@@
 struct exar8250 {  unsigned int nr ;  struct exar8250_board * board ;  void __iomem * virt ;  int line [ 0 ] ; } cocci_id@p ;
