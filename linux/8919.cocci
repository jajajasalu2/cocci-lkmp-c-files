...
typedef __le32;
@@
 struct sg_desc {  __le32 total_len ;  __le32 resvd0 ;  __le32 linear_addr ;  __le32 linear_len ;  struct frags_info frags [ SG_MAX_SKB_FRAGS + 1 ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct frags_info {  __le32 addr ;  __le32 size ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct hix5hd2_sg_desc_ring {  struct sg_desc * desc ;  dma_addr_t phys_addr ; } cocci_id@p ;
...
position p;
@@
 struct hix5hd2_desc * cocci_id@p ;
...
position p;
@@
 struct hix5hd2_priv * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct hix5hd2_desc_sw {  struct hix5hd2_desc * desc ;  dma_addr_t phys_addr ;  unsigned int count ;  unsigned int size ; } cocci_id@p ;
...
position p;
@@
 enum phy_reset_delays { PRE_DELAY , PULSE , POST_DELAY , DELAYS_NUM , } cocci_id@p ;
