...
position p;
@@
 enum qed_cxt_elem_type cocci_id@p ;
...
position p;
@@
 const struct qed_rdma_ops cocci_id@p ;
...
position p;
@@
 struct qed_rdma_info * cocci_id@p ;
...
position p;
@@
 struct rdma_srq_modify_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct rdma_create_cq_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_dev_rdma_info * cocci_id@p ;
...
position p;
@@
 struct rdma_register_tid_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct rdma_close_func_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct rdma_init_func_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_rdma_cnq_params * cocci_id@p ;
...
position p;
@@
 struct rdma_destroy_cq_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_rdma_register_tid_in_params * cocci_id@p ;
...
position p;
@@
 struct rdma_deregister_tid_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct rdma_init_func_hdr * cocci_id@p ;
...
position p;
@@
 struct rdma_destroy_cq_output_params * cocci_id@p ;
...
position p;
@@
 struct rdma_srq_create_ramrod_data * cocci_id@p ;
...
position p;
@@
 enum qed_rdma_toggle_bit cocci_id@p ;
...
position p;
@@
 struct rdma_srq_destroy_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct rdma_cnq_params * cocci_id@p ;
