...
position p;
@@
 struct nouveau_gem_object_unmap {  struct nouveau_cli_work work ;  struct nouveau_vma * vma ; } cocci_id@p ;
...
position p;
@@
 struct nouveau_abi16_chan * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_gem_new * cocci_id@p ;
...
position p;
@@
 struct nouveau_abi16 * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_gem_pushbuf_reloc * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_gem_pushbuf_bo * cocci_id@p ;
...
position p;
@@
 struct validate_op {  struct list_head list ;  struct ww_acquire_ctx ticket ; } cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_gem_cpu_fini * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_gem_cpu_prep * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_gem_pushbuf * cocci_id@p ;
...
position p;
@@
 struct nouveau_cli_work * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_gem_pushbuf_push * cocci_id@p ;
...
position p;
@@
 struct drm_nouveau_gem_info * cocci_id@p ;
...
position p;
@@
 struct nouveau_gem_object_unmap * cocci_id@p ;
