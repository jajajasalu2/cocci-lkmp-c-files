...
position p;
@@
 struct kthread_create_info * cocci_id@p ;
...
position p;
@@
 struct kthread_create_info {  int ( * threadfn ) ( void * data ) ;  void * data ;  int node ;  struct task_struct * result ;  struct completion * done ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct kthread_flush_work {  struct kthread_work work ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 struct kthread_delayed_work * cocci_id@p ;
...
position p;
@@
 struct kthread_flush_work cocci_id@p ;
...
position p;
@@
 enum KTHREAD_BITS { KTHREAD_IS_PER_CPU = 0 , KTHREAD_SHOULD_STOP , KTHREAD_SHOULD_PARK , } cocci_id@p ;
