...
position p;
@@
 struct ubi_volume_info * cocci_id@p ;
...
position p;
@@
 struct ubiblock_param {  int ubi_num ;  int vol_id ;  char name [ UBIBLOCK_PARAM_LEN + 1 ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ UBIBLOCK_PARAM_LEN ] ;
...
position p;
@@
 char * cocci_id@p [ UBIBLOCK_PARAM_COUNT ] ;
...
position p;
@@
 struct ubi_volume_desc * cocci_id@p ;
...
position p;
@@
 struct ubiblock_pdu * cocci_id@p ;
...
position p;
@@
 struct ubiblock_pdu {  struct work_struct work ;  struct ubi_sgl usgl ; } cocci_id@p ;
...
position p;
@@
 struct ubiblock {  struct ubi_volume_desc * desc ;  int ubi_num ;  int vol_id ;  int refcnt ;  int leb_size ;  struct gendisk * gd ;  struct request_queue * rq ;  struct workqueue_struct * wq ;  struct mutex dev_mutex ;  struct list_head list ;  struct blk_mq_tag_set tag_set ; } cocci_id@p ;
...
position p;
@@
 struct ubiblock_param * cocci_id@p ;
...
position p;
@@
 struct ubi_notification * cocci_id@p ;
