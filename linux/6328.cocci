...
position p;
@@
 struct blocking_notifier_head * cocci_id@p ;
...
position p;
@@
 struct rave_sp_reply cocci_id@p ;
...
typedef u8;
@@
 struct rave_sp_reply {  size_t length ;  void * data ;  u8 code ;  u8 ackid ;  struct completion received ; } cocci_id@p ;
...
position p;
@@
 struct rave_sp_deframer * cocci_id@p ;
...
position p;
@@
 struct rave_sp_variant_cmds {  int ( * translate ) ( enum rave_sp_command ) ;  int ( * get_status ) ( struct rave_sp * sp , struct rave_sp_status * ) ; } cocci_id@p ;
...
position p;
@@
 enum rave_sp_deframer_state { RAVE_SP_EXPECT_SOF , RAVE_SP_EXPECT_DATA , RAVE_SP_EXPECT_ESCAPED_DATA , } cocci_id@p ;
...
position p;
@@
 struct rave_sp_variant {  const struct rave_sp_checksum * checksum ;  struct rave_sp_variant_cmds cmd ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ RAVE_SP_TX_BUFFER_SIZE ] ;
...
position p;
@@
 enum rave_sp_command cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ RAVE_SP_CHECKSUM_SIZE ] ;
...
typedef atomic_t;
@@
 struct rave_sp {  struct serdev_device * serdev ;  struct rave_sp_deframer deframer ;  atomic_t ackid ;  struct mutex bus_lock ;  struct mutex reply_lock ;  struct rave_sp_reply * reply ;  const struct rave_sp_variant * variant ;  struct blocking_notifier_head event_notifier_list ;  const char * part_number_firmware ;  const char * part_number_bootloader ; } cocci_id@p ;
...
position p;
@@
 const struct serdev_device_ops cocci_id@p ;
...
position p;
@@
 struct rave_sp_status cocci_id@p ;
...
position p;
@@
 struct rave_sp_deframer {  enum rave_sp_deframer_state state ;  unsigned char data [ RAVE_SP_RX_BUFFER_SIZE ] ;  size_t length ; } cocci_id@p ;
...
position p;
@@
 struct rave_sp_version * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RAVE_SP_CHECKSUM_SIZE ] ;
...
position p;
@@
 const struct rave_sp_checksum cocci_id@p ;
...
position p;
@@
 const struct rave_sp_variant cocci_id@p ;
