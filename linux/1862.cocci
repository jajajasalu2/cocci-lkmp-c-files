...
position p;
@@
 const struct vadc_map_pt * cocci_id@p ;
...
position p;
@@
 const struct vadc_linear_graph * cocci_id@p ;
...
position p;
@@
 enum vadc_scale_fn_type cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( const struct vadc_prescale_ratio * prescale , const struct adc5_data * data , u16 adc_code , int * result_mdec ) ;
...
typedef u16;
@@
 int cocci_id@p ( const struct vadc_prescale_ratio * prescale , const struct adc5_data * data , u16 adc_code , int * result_uv ) ;
...
position p;
@@
 struct qcom_adc5_scale_type cocci_id@p [ ] ;
