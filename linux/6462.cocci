...
position p;
@@
 struct mt6397_regulator_info cocci_id@p [ ] ;
...
typedef u32;
@@
 struct mt6397_regulator_info {  struct regulator_desc desc ;  u32 qi ;  u32 vselon_reg ;  u32 vselctrl_reg ;  u32 vselctrl_mask ;  u32 modeset_reg ;  u32 modeset_mask ;  u32 modeset_shift ; } cocci_id@p ;
