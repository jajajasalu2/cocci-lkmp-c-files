...
position p;
@@
 struct ds1305_platform_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ 1 + DS1305_ALM_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ 1 + DS1305_RTC_LEN ] ;
