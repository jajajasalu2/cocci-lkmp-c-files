...
position p;
@@
 struct tc_action * cocci_id@p [ TCA_ACT_MAX_PRIO ] ;
...
position p;
@@
 const struct tcf_chain * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_ACT_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_ACT_MAX_PRIO + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_ACT_MAX + 1 ] ;
...
position p;
@@
 struct gnet_stats_basic_cpu cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_ROOT_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_ROOT_MAX + 1 ] ;
...
position p;
@@
 struct nla_bitfield32 cocci_id@p ;
...
position p;
@@
 struct gnet_stats_basic cocci_id@p ;
