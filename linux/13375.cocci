...
position p;
@@
 struct v4l2_flash_ctrl_data * cocci_id@p ;
...
position p;
@@
 enum ctrl_init_data_id { LED_MODE , TORCH_INTENSITY , FLASH_INTENSITY , INDICATOR_INTENSITY , FLASH_TIMEOUT , STROBE_SOURCE , FLASH_STROBE , STROBE_STOP , STROBE_STATUS , FLASH_FAULT , NUM_FLASH_CTRLS , } cocci_id@p ;
