...
typedef u8;
@@
 struct upd78f0730_set_err_chr {  u8 opcode ;  u8 state ;  u8 err_char ; } cocci_id@p ;
...
position p;
@@
 struct upd78f0730_set_dtr_rts cocci_id@p ;
...
typedef u8;
@@
 struct upd78f0730_set_dtr_rts {  u8 opcode ;  u8 params ; } cocci_id@p ;
...
typedef u8;
@@
 struct upd78f0730_set_xon_xoff_chr {  u8 opcode ;  u8 xon ;  u8 xoff ; } cocci_id@p ;
...
position p;
@@
 struct upd78f0730_port_private * cocci_id@p ;
...
position p;
@@
 const struct upd78f0730_open_close cocci_id@p ;
...
position p;
@@
 struct upd78f0730_line_control cocci_id@p ;
...
typedef u8;
@@
 struct upd78f0730_port_private {  struct mutex lock ;  u8 line_signals ; } cocci_id@p ;
...
typedef u8;
@@
 struct upd78f0730_open_close {  u8 opcode ;  u8 state ; } cocci_id@p ;
