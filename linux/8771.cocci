...
symbol cocci_id;
position p;
typedef nx_hostrq_sds_ring_t;
@@
 nx_hostrq_sds_ring_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_cardrsp_sds_ring_t;
@@
 nx_cardrsp_sds_ring_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_cardrsp_rds_ring_t;
@@
 nx_cardrsp_rds_ring_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_hostrq_rx_ctx_t;
@@
 nx_hostrq_rx_ctx_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_cardrsp_tx_ctx_t;
@@
 nx_cardrsp_tx_ctx_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_hostrq_rds_ring_t;
@@
 nx_hostrq_rds_ring_t * cocci_id@p ;
...
position p;
@@
 struct netxen_ring_ctx cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_cardrsp_rx_ctx_t;
@@
 nx_cardrsp_rx_ctx_t cocci_id@p ;
...
position p;
@@
 struct netxen_cmd_args cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nx_hostrq_tx_ctx_t;
@@
 nx_hostrq_tx_ctx_t * cocci_id@p ;
...
position p;
@@
 struct netxen_recv_crb cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef nx_hostrq_cds_ring_t;
@@
 nx_hostrq_cds_ring_t * cocci_id@p ;
