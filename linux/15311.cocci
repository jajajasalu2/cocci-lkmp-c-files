...
position p;
@@
 struct meson_wdt_data {  unsigned int enable ;  unsigned int terminal_count_mask ;  unsigned int count_unit ; } cocci_id@p ;
...
position p;
@@
 struct meson_wdt_data cocci_id@p ;
...
position p;
@@
 struct meson_wdt_dev {  struct watchdog_device wdt_dev ;  void __iomem * wdt_base ;  const struct meson_wdt_data * data ; } cocci_id@p ;
...
position p;
@@
 struct meson_wdt_dev * cocci_id@p ;
