...
position p;
@@
 const struct bcm_sf2_of_data cocci_id@p ;
...
typedef u32,u16;
@@
 struct bcm_sf2_of_data {  u32 type ;  const u16 * reg_offsets ;  unsigned int core_reg_align ;  unsigned int num_cfp_rules ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ BCM_SF2_REGS_NUM ] ;
...
position p;
@@
 struct dsa_switch_ops * cocci_id@p ;
