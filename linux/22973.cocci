...
position p;
@@
 struct snd_monitor_file * cocci_id@p ;
...
position p;
@@
 struct snd_monitor_file {  struct file * file ;  const struct file_operations * disconnected_f_op ;  struct list_head shutdown_list ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_card * card , int free_flag ) ;
...
position p;
@@
 char cocci_id@p [ sizeof ( card -> id ) ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct module * , int ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_card * card ) ;
