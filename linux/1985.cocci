...
position p;
@@
 struct ad5686_state * cocci_id@p ;
...
position p;
@@
 const struct ad5686_chip_info cocci_id@p [ ] ;
...
position p;
@@
 enum ad5686_supported_device_ids cocci_id@p ;
