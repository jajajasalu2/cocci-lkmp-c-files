...
position p;
@@
 void cocci_id@p ( struct sc27xx_fgu_data * data , int cap ) ;
...
position p;
@@
 struct power_supply_battery_ocv_table * cocci_id@p ;
...
position p;
@@
 struct sc27xx_fgu_data * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct sc27xx_fgu_data * data , int cap , bool int_mode ) ;
...
position p;
@@
 int cocci_id@p ( struct sc27xx_fgu_data * data , int capacity ) ;
...
typedef bool,u32;
@@
 struct sc27xx_fgu_data {  struct regmap * regmap ;  struct device * dev ;  struct power_supply * battery ;  u32 base ;  struct mutex lock ;  struct gpio_desc * gpiod ;  struct iio_channel * channel ;  struct iio_channel * charge_chan ;  bool bat_present ;  int internal_resist ;  int total_cap ;  int init_cap ;  int alarm_cap ;  int init_clbcnt ;  int max_volt ;  int min_volt ;  int table_len ;  int cur_1000ma_adc ;  int vol_1000mv_adc ;  struct power_supply_battery_ocv_table * cap_table ; } cocci_id@p ;
