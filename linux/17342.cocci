...
typedef uint64_t;
@@
 struct elog_obj {  struct kobject kobj ;  struct bin_attribute raw_attr ;  uint64_t id ;  uint64_t type ;  size_t size ;  char * buffer ; } cocci_id@p ;
...
position p;
@@
 struct elog_attribute * cocci_id@p ;
