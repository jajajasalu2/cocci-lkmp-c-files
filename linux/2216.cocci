...
position p;
@@
 struct sbp_target_agent * cocci_id@p ;
...
position p;
@@
 const struct fw_address_region cocci_id@p ;
...
position p;
@@
 struct sbp_page_table_entry cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sbp_target_request * ) ;
...
position p;
@@
 struct sbp_target_request * cocci_id@p ;
...
position p;
@@
 struct sbp_management_agent cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sbp_target_agent * ) ;
...
position p;
@@
 void cocci_id@p ( struct sbp_target_request * ) ;
...
position p;
@@
 const struct sbp_management_request * cocci_id@p ;
...
position p;
@@
 struct sbp_target_agent * cocci_id@p ( struct sbp_login_descriptor * ) ;
...
position p;
@@
 struct sbp_login_response_block * cocci_id@p ;
...
position p;
@@
 struct sbp_management_request * cocci_id@p ;
...
position p;
@@
 struct sbp_login_descriptor * cocci_id@p ;
