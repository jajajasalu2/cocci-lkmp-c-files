...
typedef u16;
@@
 struct cmv_dsc_e4 {  u16 function ;  u16 offset ;  u16 address ;  u16 group ; } cocci_id@p ;
...
position p;
@@
 enum { ADI930 = 0 , EAGLE_I , EAGLE_II , EAGLE_III , EAGLE_IV , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ UEA_FW_NAME_MAX ] ;
...
position p;
@@
 struct block_info_e1 cocci_id@p ;
...
position p;
@@
 struct block_info_e4 cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct cmv_dsc_e1 {  u8 function ;  u16 idx ;  u32 address ;  u16 offset ; } cocci_id@p ;
...
position p;
@@
 union cmv_dsc {  struct cmv_dsc_e1 e1 ;  struct cmv_dsc_e4 e4 ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ 2 * ETH_ALEN + 1 ] ;
...
position p;
@@
 unsigned int cocci_id@p [ NB_MODEM ] ;
