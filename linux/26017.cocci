...
typedef uint64_t;
@@
 struct eptPageTablePointer {  uint64_t memory_type : 3 ;  uint64_t page_walk_length : 3 ;  uint64_t ad_enabled : 1 ;  uint64_t reserved_11_07 : 5 ;  uint64_t address : 40 ;  uint64_t reserved_63_52 : 12 ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sparsebit_idx_t;
@@
 sparsebit_idx_t cocci_id@p ;
...
position p;
@@
 struct eptPageTablePointer cocci_id@p ;
...
position p;
@@
 struct eptPageTableEntry * cocci_id@p ;
...
position p;
@@
 struct userspace_mem_region * cocci_id@p ;
...
typedef uint64_t;
@@
 struct eptPageTableEntry {  uint64_t readable : 1 ;  uint64_t writable : 1 ;  uint64_t executable : 1 ;  uint64_t memory_type : 3 ;  uint64_t ignore_pat : 1 ;  uint64_t page_size : 1 ;  uint64_t accessed : 1 ;  uint64_t dirty : 1 ;  uint64_t ignored_11_10 : 2 ;  uint64_t address : 40 ;  uint64_t ignored_62_52 : 11 ;  uint64_t suppress_ve : 1 ; } cocci_id@p ;
