...
position p;
@@
 struct xfrm_pol_inexact_node cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,xfrm_address_t;
@@
 struct xfrm_pol_inexact_node {  struct rb_node node ;  union {  xfrm_address_t addr ;  struct rcu_head rcu ; } ;  u8 prefixlen ;  struct rb_root root ;  struct hlist_head hhead ; } cocci_id@p ;
...
position p;
@@
 struct xfrm_policy * cocci_id@p [ XFRM_POLICY_TYPE_MAX ] ;
...
position p;
@@
 struct xfrm_pol_inexact_candidates * cocci_id@p ;
...
position p;
@@
 const struct xfrm_tmpl * cocci_id@p ;
...
position p;
@@
 const struct xfrm_state * cocci_id@p ;
...
position p;
@@
 struct xfrm_dst * cocci_id@p [ XFRM_MAX_DEPTH ] ;
...
position p;
@@
 struct xfrm_encap_tmpl * cocci_id@p ;
...
position p;
@@
 const struct xfrm_selector * cocci_id@p ;
...
position p;
@@
 const struct rb_root * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xfrm_dst * * bundle , int nr ) ;
...
position p;
@@
 const struct sec_path * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfrm_address_t;
@@
 xfrm_address_t * cocci_id@p ;
...
position p;
@@
 struct xfrm_state * cocci_id@p [ XFRM_MAX_DEPTH ] ;
...
position p;
@@
 const struct flowi4 * cocci_id@p ;
...
position p;
@@
 const struct xfrm_pol_inexact_key * cocci_id@p ;
...
typedef bool;
@@
 struct xfrm_policy * cocci_id@p ( struct hlist_head * chain , struct xfrm_policy * policy , bool excl ) ;
...
position p;
@@
 const struct xfrm_policy_afinfo * cocci_id@p ;
...
position p;
@@
 struct xfrm_selector * cocci_id@p ;
...
position p;
@@
 struct xfrm_pol_inexact_candidates {  struct hlist_head * res [ XFRM_POL_CAND_MAX ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xfrm_dst * xdst ) ;
...
position p;
@@
 struct xfrm_kmaddress * cocci_id@p ;
...
position p;
@@
 struct xfrm_policy_walk * cocci_id@p ;
...
position p;
@@
 const struct xfrm_migrate * cocci_id@p ;
...
position p;
@@
 struct linux_xfrm_mib cocci_id@p ;
...
position p;
@@
 struct ipv6_opt_hdr * cocci_id@p ;
...
position p;
@@
 struct xfrm_policy_walk_entry cocci_id@p ;
...
position p;
@@
 const struct xfrm_if_cb * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct xfrm_pol_inexact_bin * cocci_id@p ( struct net * net , u8 type , u16 family , u8 dir , u32 if_id ) ;
...
position p;
@@
 const struct xfrm_policy * cocci_id@p ;
...
position p;
@@
 struct audit_buffer * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct xfrm_policy * , int , int , void * ) ;
...
position p;
@@
 int cocci_id@p ( struct dst_entry * dst ) ;
...
position p;
@@
 struct xfrm_pol_inexact_bin * cocci_id@p ;
...
position p;
@@
 struct xfrm_policy * cocci_id@p ( struct xfrm_policy * pol , int dir ) ;
...
position p;
@@
 struct xfrm_migrate * cocci_id@p ;
...
position p;
@@
 const struct xfrm_pol_inexact_bin * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xfrm_policy * pol , int dir ) ;
...
position p;
@@
 enum xfrm_pol_inexact_candidate_type { XFRM_POL_CAND_BOTH , XFRM_POL_CAND_SADDR , XFRM_POL_CAND_DADDR , XFRM_POL_CAND_ANY , XFRM_POL_CAND_MAX , } cocci_id@p ;
...
typedef u8;
@@
 struct xfrm_flo {  struct dst_entry * dst_orig ;  u8 flags ; } cocci_id@p ;
...
position p;
@@
 struct xfrmk_spdinfo * cocci_id@p ;
...
position p;
@@
 const struct xfrm_state_afinfo * cocci_id@p ;
...
position p;
@@
 struct xfrm_sec_ctx * cocci_id@p ;
...
typedef seqcount_t;
@@
 struct xfrm_pol_inexact_bin {  struct xfrm_pol_inexact_key k ;  struct rhash_head head ;  struct hlist_head hhead ;  seqcount_t count ;  struct rb_root root_d ;  struct rb_root root_s ;  struct list_head inexact_bins ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct xfrm_policy_queue * cocci_id@p ;
...
position p;
@@
 const struct rb_node * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hlist_head * chain , struct xfrm_policy * policy ) ;
...
position p;
@@
 struct xfrm_policy_hash * cocci_id@p ;
...
position p;
@@
 struct xfrm_pol_inexact_key cocci_id@p ;
...
position p;
@@
 const struct xfrm_mode * cocci_id@p ;
...
position p;
@@
 struct xfrm_tmpl * cocci_id@p [ XFRM_MAX_DEPTH ] ;
...
symbol cocci_id;
position p;
typedef bool,xfrm_address_t;
@@
 bool cocci_id@p ( struct xfrm_pol_inexact_candidates * cand , struct xfrm_pol_inexact_bin * b , const xfrm_address_t * saddr , const xfrm_address_t * daddr ) ;
...
typedef xfrm_address_t;
@@
 const xfrm_address_t * cocci_id@p ;
