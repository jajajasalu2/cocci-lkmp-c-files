...
position p;
@@
 struct dpu_crtc_state * cocci_id@p ;
...
position p;
@@
 struct msm_display_topology cocci_id@p ;
...
position p;
@@
 struct dpu_vsync_source_cfg cocci_id@p ;
...
position p;
@@
 struct dpu_hw_mixer * cocci_id@p [ MAX_CHANNELS_PER_ENC ] ;
...
position p;
@@
 struct dpu_mdss_cfg * cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( void * , u32 event ) ;
...
position p;
@@
 struct dpu_rm_hw_iter cocci_id@p ;
...
position p;
@@
 struct dpu_hw_ctl * cocci_id@p [ MAX_CHANNELS_PER_ENC ] ;
...
position p;
@@
 enum dpu_enc_rc_states { DPU_ENC_RC_STATE_OFF , DPU_ENC_RC_STATE_PRE_OFF , DPU_ENC_RC_STATE_ON , DPU_ENC_RC_STATE_IDLE , } cocci_id@p ;
...
position p;
@@
 struct dpu_encoder_hw_resources * cocci_id@p ;
...
position p;
@@
 struct dpu_encoder_virt cocci_id@p ;
...
position p;
@@
 struct dpu_encoder_phys * cocci_id@p ;
...
position p;
@@
 struct msm_drm_private * cocci_id@p ;
...
position p;
@@
 struct dpu_enc_phys_init_params * cocci_id@p ;
...
position p;
@@
 const struct dpu_encoder_virt_ops cocci_id@p ;
...
position p;
@@
 struct msm_display_info * cocci_id@p ;
...
position p;
@@
 struct dpu_hw_pingpong * cocci_id@p ;
...
position p;
@@
 struct dpu_encoder_irq * cocci_id@p ;
...
position p;
@@
 enum dpu_enc_rc_events { DPU_ENC_RC_EVENT_KICKOFF = 1 , DPU_ENC_RC_EVENT_FRAME_DONE , DPU_ENC_RC_EVENT_PRE_STOP , DPU_ENC_RC_EVENT_STOP , DPU_ENC_RC_EVENT_ENTER_IDLE , } cocci_id@p ;
...
position p;
@@
 enum msm_event_wait cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct dpu_encoder_phys * phys_enc ) ;
...
position p;
@@
 struct dpu_encoder_wait_info * cocci_id@p ;
...
position p;
@@
 struct kthread_work * cocci_id@p ;
...
position p;
@@
 struct split_pipe_cfg cocci_id@p ;
...
position p;
@@
 struct dpu_hw_mixer * cocci_id@p ;
...
position p;
@@
 struct msm_drm_thread * cocci_id@p ;
