...
position p;
@@
 struct sched_flowc_entry * cocci_id@p ;
...
position p;
@@
 struct sched_queue_entry * cocci_id@p ;
...
position p;
@@
 const struct ch_sched_params * cocci_id@p ;
...
position p;
@@
 struct ch_sched_flowc * cocci_id@p ;
...
position p;
@@
 enum sched_bind_type cocci_id@p ;
