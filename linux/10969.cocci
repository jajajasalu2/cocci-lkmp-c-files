...
position p;
@@
 struct pp_clock_levels_with_voltage * cocci_id@p ;
...
position p;
@@
 struct pp_atomfwctrl_clock_dividers_soc15 cocci_id@p ;
...
position p;
@@
 struct pp_atomfwctrl_gpio_parameters cocci_id@p ;
...
position p;
@@
 struct vega10_power_state cocci_id@p ;
...
position p;
@@
 struct pp_atomfwctrl_avfs_parameters cocci_id@p ;
...
position p;
@@
 struct vega10_performance_level * cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v1_clock_voltage_dependency_table * cocci_id@p [ 3 ] ;
...
symbol cocci_id;
position p;
typedef Watermarks_t;
@@
 Watermarks_t * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_POWERPLAYTABLE * cocci_id@p ;
...
position p;
@@
 struct pp_clock_levels_with_latency * cocci_id@p ;
...
position p;
@@
 struct vega10_hwmgr * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_SOCCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 struct vega10_single_dpm_table * cocci_id@p ;
...
position p;
@@
 struct phm_fuses_default cocci_id@p ;
...
position p;
@@
 struct vega10_leakage_voltage * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef PllSetting_t;
@@
 PllSetting_t * cocci_id@p ;
...
position p;
@@
 const struct vega10_performance_level * cocci_id@p ;
...
position p;
@@
 struct pp_atomfwctrl_voltage_table cocci_id@p ;
...
position p;
@@
 const struct vega10_power_state * cocci_id@p ;
...
position p;
@@
 struct vega10_odn_vddc_lookup_table * cocci_id@p ;
...
position p;
@@
 struct vega10_dpm_state * cocci_id@p ;
...
position p;
@@
 struct pp_atomfwctrl_bios_boot_up_values cocci_id@p ;
...
position p;
@@
 struct pp_display_clock_request cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_GFXCLK_Dependency_Record_V2 * cocci_id@p ;
...
position p;
@@
 struct vega10_odn_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_MCLK_Dependency_Table * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef AvfsFuseOverride_t;
@@
 AvfsFuseOverride_t * cocci_id@p ;
...
position p;
@@
 struct vega10_dpm_table cocci_id@p ;
...
position p;
@@
 struct vega10_odn_dpm_table * cocci_id@p ;
...
position p;
@@
 ATOM_Vega10_GFXCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 struct vega10_pcie_table * cocci_id@p ;
...
position p;
@@
 struct dm_pp_wm_sets_with_clock_ranges_soc15 * cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v2_information * cocci_id@p ;
...
position p;
@@
 enum { CLK_SMNCLK = 0 , CLK_SOCCLK , CLK_MP0CLK , CLK_MP1CLK , CLK_LCLK , CLK_DCEFCLK , CLK_VCLK , CLK_DCLK , CLK_ECLK , CLK_UCLK , CLK_GFXCLK , CLK_COUNT , } cocci_id@p ;
