...
position p;
@@
 const struct mlxsw_sp_acl_tcam_pattern * cocci_id@p ;
...
position p;
@@
 struct mlxsw_afk_element_usage cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_group * cocci_id@p ;
...
typedef u16;
@@
 struct mlxsw_sp_acl_tcam_group {  struct mlxsw_sp_acl_tcam * tcam ;  u16 id ;  struct mutex lock ;  struct list_head region_list ;  unsigned int region_count ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_afk_key_info * cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_acl_profile cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_entry {  struct mlxsw_sp_acl_tcam_ventry * ventry ;  struct mlxsw_sp_acl_tcam_chunk * chunk ;  unsigned long priv [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_mr_rule cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_mr_ruleset cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_vregion cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_rehash_ctx * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_flower_ruleset cocci_id@p ;
...
position p;
@@
 const enum mlxsw_afk_element cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct mlxsw_sp * mlxsw_sp , struct mlxsw_sp_acl_tcam_vregion * vregion , int * credits ) ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_mr_rule {  struct mlxsw_sp_acl_tcam_ventry ventry ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_tcam_ops * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_profile_ops * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_pattern {  const enum mlxsw_afk_element * elements ;  unsigned int elements_count ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_ventry {  struct mlxsw_sp_acl_tcam_entry * entry ;  struct list_head list ;  struct mlxsw_sp_acl_tcam_vchunk * vchunk ;  struct mlxsw_sp_acl_rule_info * rulei ; } cocci_id@p ;
...
typedef bool;
@@
 struct mlxsw_sp_acl_tcam_rehash_ctx {  void * hints_priv ;  bool this_is_rollback ;  struct mlxsw_sp_acl_tcam_vchunk * current_vchunk ;  struct mlxsw_sp_acl_tcam_ventry * start_ventry ;  struct mlxsw_sp_acl_tcam_ventry * stop_ventry ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_vchunk cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_ventry * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PPBT_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_vregion {  struct mutex lock ;  struct mlxsw_sp_acl_tcam_region * region ;  struct mlxsw_sp_acl_tcam_region * region2 ;  struct list_head list ;  struct list_head tlist ;  struct list_head vchunk_list ;  struct mlxsw_afk_key_info * key_info ;  struct mlxsw_sp_acl_tcam * tcam ;  struct mlxsw_sp_acl_tcam_vgroup * vgroup ;  struct {  struct delayed_work dw ;  struct mlxsw_sp_acl_tcam_rehash_ctx ctx ; } rehash ;  struct mlxsw_sp * mlxsw_sp ;  unsigned int ref_count ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PAGT_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_chunk {  struct mlxsw_sp_acl_tcam_vchunk * vchunk ;  struct mlxsw_sp_acl_tcam_region * region ;  unsigned long priv [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_flower_rule {  struct mlxsw_sp_acl_tcam_ventry ventry ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_flower_ruleset {  struct mlxsw_sp_acl_tcam_vgroup vgroup ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_vgroup * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_flower_rule cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_vchunk {  struct mlxsw_sp_acl_tcam_chunk * chunk ;  struct mlxsw_sp_acl_tcam_chunk * chunk2 ;  struct list_head list ;  struct rhash_head ht_node ;  struct list_head ventry_list ;  unsigned int priority ;  struct mlxsw_sp_acl_tcam_vgroup * vgroup ;  struct mlxsw_sp_acl_tcam_vregion * vregion ;  unsigned int ref_count ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PTAR_LEN ] ;
...
position p;
@@
 const struct mlxsw_sp_acl_tcam_rehash_ctx * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_entry * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_mr_ruleset {  struct mlxsw_sp_acl_tcam_vchunk * vchunk ;  struct mlxsw_sp_acl_tcam_vgroup vgroup ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PACL_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_chunk * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_rule_info * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_tcam_region * cocci_id@p ;
