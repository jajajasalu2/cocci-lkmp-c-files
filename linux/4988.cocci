...
position p;
@@
 struct i40iw_inline_rdma_write * cocci_id@p ;
...
position p;
@@
 struct i40iw_post_send * cocci_id@p ;
...
position p;
@@
 struct i40iw_rdma_read * cocci_id@p ;
...
position p;
@@
 struct i40iw_inv_local_stag * cocci_id@p ;
...
position p;
@@
 const struct i40iw_device_uk_ops cocci_id@p ;
...
position p;
@@
 const struct i40iw_qp_uk_ops cocci_id@p ;
...
position p;
@@
 struct i40iw_rdma_write * cocci_id@p ;
...
position p;
@@
 struct i40iw_post_inline_send * cocci_id@p ;
...
position p;
@@
 struct i40iw_dev_uk * cocci_id@p ;
...
position p;
@@
 struct i40iw_extended_cqe * cocci_id@p ;
...
position p;
@@
 const struct i40iw_cq_ops cocci_id@p ;
...
position p;
@@
 struct i40iw_bind_window * cocci_id@p ;
