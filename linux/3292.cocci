...
position p;
@@
 const struct adt7x10_ops * cocci_id@p ;
...
typedef u8,s16,bool;
@@
 struct adt7x10_data {  const struct adt7x10_ops * ops ;  const char * name ;  struct device * hwmon_dev ;  struct mutex update_lock ;  u8 config ;  u8 oldconfig ;  bool valid ;  unsigned long last_updated ;  s16 temp [ 4 ] ;  u8 hyst ; } cocci_id@p ;
...
position p;
@@
 struct adt7x10_data * cocci_id@p ;
