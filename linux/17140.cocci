...
position p;
@@
 struct nvram_os_partition cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kmsg_dumper * dumper , enum kmsg_dump_reason reason ) ;
...
position p;
@@
 struct nvram_partition * cocci_id@p ;
...
position p;
@@
 struct nvram_header {  unsigned char signature ;  unsigned char checksum ;  unsigned short length ;  char name [ 12 ] ; } cocci_id@p ;
...
position p;
@@
 struct err_log_info cocci_id@p ;
...
position p;
@@
 struct oops_log_info * cocci_id@p ;
...
position p;
@@
 enum pstore_type_id cocci_id@p [ ] ;
...
position p;
@@
 struct nvram_partition {  struct list_head partition ;  struct nvram_header header ;  unsigned int index ; } cocci_id@p ;
...
position p;
@@
 struct nvram_header * cocci_id@p ;
