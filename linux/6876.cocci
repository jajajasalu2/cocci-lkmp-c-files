...
symbol cocci_id;
position p;
typedef fnic_dbgfs_t;
@@
 fnic_dbgfs_t cocci_id@p ;
...
position p;
@@
 struct fc_trace_flag_type * cocci_id@p ;
...
position p;
@@
 struct stats_debug_info cocci_id@p ;
...
position p;
@@
 struct io_path_stats cocci_id@p ;
...
typedef u8;
@@
 struct fc_trace_flag_type {  u8 fc_row_file ;  u8 fc_normal_file ;  u8 fnic_trace ;  u8 fc_trace ;  u8 fc_clear ; } cocci_id@p ;
