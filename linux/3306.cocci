...
typedef u8,bool,u16;
@@
 struct it87_sio_data {  int sioaddr ;  enum chips type ;  u8 revision ;  u8 vid_value ;  u8 beep_pin ;  u8 internal ;  bool need_in7_reroute ;  u16 skip_in ;  u8 skip_vid ;  u8 skip_fan ;  u8 skip_pwm ;  u8 skip_temp ; } cocci_id@p ;
...
position p;
@@
 const struct it87_devices cocci_id@p [ ] ;
...
position p;
@@
 struct it87_sio_data * cocci_id@p ;
...
position p;
@@
 enum chips { it87 , it8712 , it8716 , it8718 , it8720 , it8721 , it8728 , it8732 , it8771 , it8772 , it8781 , it8782 , it8783 , it8786 , it8790 , it8792 , it8603 , it8620 , it8622 , it8628 , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct it87_devices {  const char * name ;  const char * const suffix ;  u32 features ;  u8 peci_mask ;  u8 old_peci_mask ; } cocci_id@p ;
...
position p;
@@
 const struct it87_sio_data * cocci_id@p ;
...
position p;
@@
 const struct it87_data * cocci_id@p ;
...
position p;
@@
 struct platform_device * cocci_id@p [ 2 ] ;
...
symbol cocci_id;
position p;
typedef s8,u8,bool,u32,u16;
@@
 struct it87_data {  const struct attribute_group * groups [ 7 ] ;  int sioaddr ;  enum chips type ;  u32 features ;  u8 peci_mask ;  u8 old_peci_mask ;  unsigned short addr ;  const char * name ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u16 in_scaled ;  u16 in_internal ;  u16 has_in ;  u8 in [ NUM_VIN ] [ 3 ] ;  bool need_in7_reroute ;  u8 has_fan ;  u16 fan [ NUM_FAN ] [ 2 ] ;  u8 has_temp ;  s8 temp [ NUM_TEMP ] [ 4 ] ;  u8 sensor ;  u8 extra ;  u8 fan_div [ NUM_FAN_DIV ] ;  bool has_vid ;  u8 vid ;  u8 vrm ;  u32 alarms ;  bool has_beep ;  u8 beeps ;  u8 fan_main_ctrl ;  u8 fan_ctl ;  u8 has_pwm ;  u8 pwm_ctrl [ NUM_PWM ] ;  u8 pwm_duty [ NUM_PWM ] ;  u8 pwm_temp_map [ NUM_PWM ] ;  u8 auto_pwm [ NUM_AUTO_PWM ] [ 4 ] ;  s8 auto_temp [ NUM_AUTO_PWM ] [ 5 ] ; } cocci_id@p ;
