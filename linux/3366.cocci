...
position p;
@@
 enum lp3943_pwm_output * cocci_id@p ;
...
position p;
@@
 struct lp3943_pwm {  struct pwm_chip chip ;  struct lp3943 * lp3943 ;  struct lp3943_platform_data * pdata ; } cocci_id@p ;
...
position p;
@@
 struct lp3943_pwm_map * cocci_id@p ;
...
position p;
@@
 struct lp3943_platform_data * cocci_id@p ;
