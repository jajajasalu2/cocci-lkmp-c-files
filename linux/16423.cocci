...
position p;
@@
 struct ish_system_states_query_subscribers cocci_id@p ;
...
position p;
@@
 struct dma_alloc_notify cocci_id@p ;
...
position p;
@@
 struct ishtp_fw_client * cocci_id@p ;
...
position p;
@@
 struct ishtp_device * cocci_id@p ;
...
position p;
@@
 struct ish_system_states_status cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ ISHTP_RD_MSG_BUF_SIZE ] ;
...
position p;
@@
 struct ishtp_bus_message * cocci_id@p ;
...
position p;
@@
 struct dma_xfer_hbm * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ IPC_PAYLOAD_SIZE ] ;
...
position p;
@@
 struct ish_system_states_header * cocci_id@p ;
...
position p;
@@
 struct ishtp_msg_hdr * cocci_id@p ;
...
position p;
@@
 struct ishtp_hbm_cl_cmd * cocci_id@p ;
