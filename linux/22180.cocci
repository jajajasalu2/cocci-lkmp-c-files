...
position p;
@@
 struct hugetlb_cgroup * cocci_id@p ;
...
position p;
@@
 enum vma_resv_mode { VMA_NEEDS_RESV , VMA_COMMIT_RESV , VMA_END_RESV , VMA_ADD_RESV , } cocci_id@p ;
...
position p;
@@
 struct node_hstate {  struct kobject * hugepages_kobj ;  struct kobject * hstate_kobjs [ HUGE_MAX_HSTATE ] ; } cocci_id@p ;
...
position p;
@@
 struct node_hstate cocci_id@p [ MAX_NUMNODES ] ;
...
position p;
@@
 struct kobject * cocci_id@p [ HUGE_MAX_HSTATE ] ;
...
position p;
@@
 struct huge_bootmem_page * cocci_id@p ;
...
position p;
@@
 struct file_region {  struct list_head link ;  long from ;  long to ; } cocci_id@p ;
...
position p;
@@
 struct hugepage_subpool * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hstate * h , struct page * page , int nid ) ;
...
position p;
@@
 struct hstate cocci_id@p [ HUGE_MAX_HSTATE ] ;
...
position p;
@@
 struct hstate * cocci_id@p ( struct kobject * kobj , int * nidp ) ;
...
position p;
@@
 struct mmu_notifier_range cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hstate * h , long delta ) ;
