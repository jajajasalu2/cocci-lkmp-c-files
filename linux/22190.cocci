...
typedef slobidx_t;
@@
 struct slob_block {  slobidx_t units ; } cocci_id@p ;
...
position p;
@@
 struct slob_rcu {  struct rcu_head head ;  int size ; } cocci_id@p ;
