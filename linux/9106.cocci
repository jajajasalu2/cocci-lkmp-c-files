...
position p;
@@
 enum { EQ_NUM_EQES , EQ_INTR , EQ_LOG_PG_SZ , } cocci_id@p ;
...
position p;
@@
 enum { CQ_PID , CQ_NUM_CQES , CQ_LOG_PG_SZ , } cocci_id@p ;
...
position p;
@@
 enum { QP_PID , QP_STATE , QP_XPORT , QP_MTU , QP_N_RECV , QP_RECV_SZ , QP_N_SEND , QP_LOG_PG_SZ , QP_RQPN , } cocci_id@p ;
...
position p;
@@
 struct mlx5_rsc_debug * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_eq_in ) ] ;
...
position p;
@@
 struct mlx5_field_desc * cocci_id@p ;
