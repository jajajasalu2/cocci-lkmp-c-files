...
typedef __u8;
@@
 struct ms_data {  unsigned long quirks ;  struct hid_device * hdev ;  struct work_struct ff_worker ;  __u8 strong ;  __u8 weak ;  void * output_report_dmabuf ; } cocci_id@p ;
...
position p;
@@
 struct xb1s_ff_report * cocci_id@p ;
...
position p;
@@
 enum { MAGNITUDE_STRONG = 2 , MAGNITUDE_WEAK , MAGNITUDE_NUM , } cocci_id@p ;
