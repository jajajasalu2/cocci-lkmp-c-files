...
position p;
@@
 struct iio_sw_device_type cocci_id@p ;
...
position p;
@@
 const struct iio_sw_device_ops cocci_id@p ;
...
position p;
@@
 struct iio_dummy_state * cocci_id@p ;
...
position p;
@@
 const struct iio_dummy_accel_calibscale cocci_id@p [ ] ;
...
position p;
@@
 struct iio_sw_device * cocci_id@p ;
...
position p;
@@
 struct iio_dummy_accel_calibscale {  int val ;  int val2 ;  int regval ; } cocci_id@p ;
