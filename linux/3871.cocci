...
position p;
@@
 struct cipher_wr_param cocci_id@p ;
...
position p;
@@
 struct chcr_ahash_req_ctx * cocci_id@p ;
...
position p;
@@
 struct chcr_hctx_per_wr cocci_id@p ;
...
position p;
@@
 struct chcr_authenc_ctx cocci_id@p ;
...
position p;
@@
 struct chcr_alg_template cocci_id@p ;
...
position p;
@@
 struct cpl_rx_phys_dsgl cocci_id@p ;
...
position p;
@@
 struct chcr_aead_reqctx cocci_id@p ;
...
position p;
@@
 struct phys_sge_pairs * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ CHCR_HASH_MAX_BLOCK_SIZE_128 ] ;
...
position p;
@@
 int cocci_id@p ( struct skcipher_request * req , unsigned char * input , int err ) ;
...
position p;
@@
 struct hash_wr_param * cocci_id@p ;
...
position p;
@@
 struct sha256_state cocci_id@p ;
...
position p;
@@
 struct chcr_aead_ctx cocci_id@p ;
...
position p;
@@
 struct chcr_skcipher_req_ctx cocci_id@p ;
...
position p;
@@
 struct chcr_gcm_ctx * cocci_id@p ;
...
position p;
@@
 struct cpl_tx_sec_pdu * cocci_id@p ;
...
position p;
@@
 struct chcr_context * cocci_id@p ;
...
position p;
@@
 struct sha512_state cocci_id@p ;
