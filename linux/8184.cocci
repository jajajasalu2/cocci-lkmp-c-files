...
position p;
@@
 void cocci_id@p ( struct seq_file * filp , struct rvu_pfvf * pfvf ) ;
...
position p;
@@
 enum nix_stat_lf_tx { TX_UCAST = 0x0 , TX_BCAST = 0x1 , TX_MCAST = 0x2 , TX_DROP = 0x3 , TX_OCTS = 0x4 , TX_STATS_ENUM_LAST , } cocci_id@p ;
...
position p;
@@
 struct npa_aq_enq_rsp * cocci_id@p ;
...
position p;
@@
 struct cgx_link_user_info cocci_id@p ;
...
position p;
@@
 struct npa_aq_enq_req cocci_id@p ;
...
position p;
@@
 enum { CGX_STAT0 , CGX_STAT1 , CGX_STAT2 , CGX_STAT3 , CGX_STAT4 , CGX_STAT5 , CGX_STAT6 , CGX_STAT7 , CGX_STAT8 , CGX_STAT9 , CGX_STAT10 , CGX_STAT11 , CGX_STAT12 , CGX_STAT13 , CGX_STAT14 , CGX_STAT15 , CGX_STAT16 , CGX_STAT17 , CGX_STAT18 , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct seq_file * m , struct npa_aq_enq_rsp * rsp ) ;
...
position p;
@@
 enum nix_stat_lf_rx { RX_OCTS = 0x0 , RX_UCAST = 0x1 , RX_BCAST = 0x2 , RX_MCAST = 0x3 , RX_DROP = 0x4 , RX_DROP_OCTS = 0x5 , RX_FCS = 0x6 , RX_ERR = 0x7 , RX_DRP_BCAST = 0x8 , RX_DRP_MCAST = 0x9 , RX_DRP_L3BCAST = 0xa , RX_DRP_L3MCAST = 0xb , RX_STATS_ENUM_LAST , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct seq_file * filp , struct nix_aq_enq_rsp * rsp ) ;
