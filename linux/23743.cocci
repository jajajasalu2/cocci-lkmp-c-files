...
position p;
@@
 struct ieee802154_llsec_device * cocci_id@p ;
...
position p;
@@
 const struct ieee802154_llsec_key_entry * cocci_id@p ;
...
position p;
@@
 struct ieee802154_llsec_seclevel cocci_id@p ;
...
position p;
@@
 struct nl802154_dump_wpan_phy_state * cocci_id@p ;
...
position p;
@@
 enum nl802154_multicast_groups { NL802154_MCGRP_CONFIG , } cocci_id@p ;
...
position p;
@@
 struct ieee802154_addr * cocci_id@p ;
...
position p;
@@
 const struct wpan_phy_supported * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NL802154_DEV_ADDR_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ieee802154_llsec_device_key cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NL802154_DEV_ADDR_ATTR_MAX + 1 ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ NL802154_CMD_FRAME_NR_IDS / 32 ] ;
...
position p;
@@
 const struct ieee802154_llsec_device_key * cocci_id@p ;
...
position p;
@@
 const struct ieee802154_llsec_device * cocci_id@p ;
...
position p;
@@
 struct ieee802154_llsec_key cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NL802154_KEY_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct ieee802154_llsec_key_id * cocci_id@p ;
...
typedef s64;
@@
 struct nl802154_dump_wpan_phy_state {  s64 filter_wpan_phy ;  long start ; } cocci_id@p ;
...
position p;
@@
 struct ieee802154_llsec_key_entry * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NL802154_KEY_ID_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ieee802154_llsec_params cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NL802154_SECLEVEL_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NL802154_KEY_ID_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ieee802154_llsec_key_id * cocci_id@p ;
...
position p;
@@
 struct ieee802154_llsec_table * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NL802154_DEVKEY_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NL802154_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NL802154_DEV_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct cfg802154_registered_device * * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NL802154_DEV_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct wpan_phy_cca cocci_id@p ;
...
position p;
@@
 const struct ieee802154_llsec_seclevel * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NL802154_DEVKEY_ATTR_MAX + 1 ] ;
...
position p;
@@
 enum nl802154_commands cocci_id@p ;
...
position p;
@@
 enum nl802154_iftype cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NL802154_KEY_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NL802154_SECLEVEL_ATTR_MAX + 1 ] ;
