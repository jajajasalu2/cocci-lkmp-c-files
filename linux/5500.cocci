...
typedef u32;
@@
 void ( * cocci_id@p ) ( u32 * , const u32 * , unsigned int ) ;
...
position p;
@@
 struct sh_msiof_spi_priv * cocci_id@p ;
...
position p;
@@
 struct sh_msiof_spi_info cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sh_msiof_spi_priv * , const void * , int , int ) ;
...
typedef u32,u16;
@@
 struct sh_msiof_chipdata {  u32 bits_per_word_mask ;  u16 tx_fifo_size ;  u16 rx_fifo_size ;  u16 ctlr_flags ;  u16 min_div_pow ; } cocci_id@p ;
...
position p;
@@
 const struct sh_msiof_chipdata * cocci_id@p ;
...
position p;
@@
 const struct sh_msiof_spi_info * cocci_id@p ;
...
@@
 struct sh_msiof_spi_priv {  struct spi_controller * ctlr ;  void __iomem * mapbase ;  struct clk * clk ;  struct platform_device * pdev ;  struct sh_msiof_spi_info * info ;  struct completion done ;  struct completion done_txdma ;  unsigned int tx_fifo_size ;  unsigned int rx_fifo_size ;  unsigned int min_div_pow ;  void * tx_dma_page ;  void * rx_dma_page ;  dma_addr_t tx_dma_addr ;  dma_addr_t rx_dma_addr ;  unsigned short unused_ss ;  bool native_cs_inited ;  bool native_cs_high ;  bool slave_aborted ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sh_msiof_spi_priv * , void * , int , int ) ;
