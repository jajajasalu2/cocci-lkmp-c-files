...
position p;
@@
 const struct hdcp2_hdmi_msg_timeout cocci_id@p [ ] ;
...
position p;
@@
 enum hdcp_wired_protocol cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ VIDEO_DIP_DATA_SIZE ] ;
...
position p;
@@
 struct drm_scrambling * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HDCP_2_2_HDMI_RXSTATUS_LEN ] ;
...
typedef u8,u16;
@@
 struct hdcp2_hdmi_msg_timeout {  u8 msg_id ;  u16 timeout ; } cocci_id@p ;
...
position p;
@@
 enum drm_dp_dual_mode_type cocci_id@p ;
...
position p;
@@
 const struct drm_hdmi_info * cocci_id@p ;
...
typedef u8,u32;
@@
 union {  u32 reg ;  u8 shim [ DRM_HDCP_RI_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct hdmi_spd_infoframe * cocci_id@p ;
