...
position p;
@@
 void cocci_id@p ( SMbuf * mb , int len ) ;
...
position p;
@@
 struct smt_p_latency cocci_id@p ;
...
typedef u_long;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_echo * echo , u_long seed , int len ) ;
...
position p;
@@
 int cocci_id@p ( struct s_smc * smc , int mac ) ;
...
position p;
@@
 struct smt_p_mac_status cocci_id@p ;
...
position p;
@@
 struct smp_p_manufacturer * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int report ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , SMbuf * rej , int fc , int reason , int local ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_version * vers ) ;
...
typedef u_long;
@@
 int cocci_id@p ( u_long upper , u_long lower ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_lem * lem , int phy ) ;
...
position p;
@@
 struct smt_p_mac_fnc * cocci_id@p ;
...
typedef u_long;
@@
 void cocci_id@p ( struct s_smc * smc , struct fddi_addr * dest , int fc , u_long tid , int type , int len ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_latency * latency ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_policy * policy ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_sde * sde ) ;
...
position p;
@@
 struct smt_p_setcount * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_mac_counter * mc ) ;
...
position p;
@@
 struct smt_p_version cocci_id@p ;
...
position p;
@@
 struct smt_p_refused cocci_id@p ;
...
position p;
@@
 struct smt_p_priority cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_una * una ) ;
...
position p;
@@
 int cocci_id@p ( struct s_smc * smc , int phy ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_setcount * setcount ) ;
...
position p;
@@
 struct smt_p_timestamp cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_mac_fnc * fnc ) ;
...
position p;
@@
 const struct fddi_addr * cocci_id@p ;
...
position p;
@@
 struct smt_sif_config * cocci_id@p ;
...
position p;
@@
 struct smt_p_mac_counter * cocci_id@p ;
...
position p;
@@
 struct smt_p_neighbor * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smp_p_manufacturer * man ) ;
...
typedef u_long;
@@
 void cocci_id@p ( struct s_smc * smc , const struct fddi_addr * dest , int fc , u_long tid , int type , int local ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , char * data , int len ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int dna ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc ) ;
...
position p;
@@
 struct smt_p_reason cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( char * data , const char * format , int len ) ;
...
position p;
@@
 struct smt_p_policy cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smp_p_user * user ) ;
...
position p;
@@
 int cocci_id@p ( struct s_smc * smc , struct smt_p_path * path ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_state * state ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_timestamp * ts ) ;
...
position p;
@@
 const struct smt_pdef {  int ptype ;  int plen ;  const char * pswap ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_mac_status * st ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_fsc * fsc ) ;
...
typedef u_long;
@@
 void cocci_id@p ( struct s_smc * smc , struct fddi_addr * dest , u_long tid , int local ) ;
...
position p;
@@
 const struct smt_pdef * cocci_id@p ;
...
position p;
@@
 struct smt_sif_operation * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct smt_p_neighbor * neighbor ) ;
