...
position p;
@@
 const struct mcb_device_id * cocci_id@p ;
...
position p;
@@
 struct men_z135_port cocci_id@p ;
...
@@
 struct men_z135_port {  struct uart_port port ;  struct mcb_device * mdev ;  struct resource * mem ;  unsigned char * rxbuf ;  u32 stat_reg ;  spinlock_t lock ;  bool automode ; } cocci_id@p ;
