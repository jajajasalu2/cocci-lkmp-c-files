...
position p;
@@
 const struct mlxsw_afk_ops * cocci_id@p ;
...
position p;
@@
 struct mlxsw_afk {  struct list_head key_info_list ;  unsigned int max_blocks ;  const struct mlxsw_afk_ops * ops ;  const struct mlxsw_afk_block * blocks ;  unsigned int blocks_count ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_afk_element_values * cocci_id@p ;
...
position p;
@@
 struct mlxsw_afk_picker * cocci_id@p ;
...
position p;
@@
 struct mlxsw_afk_picker {  struct { 
		 DECLARE_BITMAP ( element , MLXSW_AFK_ELEMENT_MAX ) 
			 ;  unsigned int total ; } hits [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_afk_element_inst * cocci_id@p ;
...
position p;
@@
 struct mlxsw_afk_key_info {  struct list_head list ;  unsigned int ref_count ;  unsigned int blocks_count ;  int element_to_block [ MLXSW_AFK_ELEMENT_MAX ] ;  struct mlxsw_afk_element_usage elusage ;  const struct mlxsw_afk_block * blocks [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_item * cocci_id@p ;
...
position p;
@@
 struct mlxsw_afk_element_inst * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_SP_AFK_KEY_BLOCK_MAX_SIZE ] ;
...
position p;
@@
 const struct mlxsw_afk_block * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_afk_key_info * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_afk_element_info * cocci_id@p ;
