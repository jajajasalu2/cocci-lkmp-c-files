...
position p;
@@
 struct reset_controller_dev cocci_id@p ;
...
typedef u8,u32;
@@
 struct atlas7_mux_init_data {  const char * mux_name ;  const char * const * parent_names ;  u8 parent_num ;  unsigned long flags ;  u8 mux_flags ;  u32 mux_offset ;  u8 shift ;  u8 width ; } cocci_id@p ;
...
@@
 struct atlas7_div_init_data {  const char * div_name ;  const char * parent_name ;  const char * gate_name ;  unsigned long flags ;  u8 divider_flags ;  u8 gate_flags ;  u32 div_offset ;  u8 shift ;  u8 width ;  u32 gate_offset ;  u8 gate_bit ;  spinlock_t * lock ; } cocci_id@p ;
...
position p;
@@
 struct atlas7_div_init_data * cocci_id@p ;
...
position p;
@@
 struct atlas7_reset_desc * cocci_id@p ;
...
position p;
@@
 const struct clk_init_data cocci_id@p ;
...
position p;
@@
 const struct reset_control_ops cocci_id@p ;
...
position p;
@@
 struct clk * cocci_id@p [ ARRAY_SIZE ( unit_list ) + ARRAY_SIZE ( mux_list ) ] ;
...
typedef u8,u32,spinlock_t;
@@
 struct atlas7_unit_init_data {  u32 index ;  const char * unit_name ;  const char * parent_name ;  unsigned long flags ;  u32 regofs ;  u8 bit ;  u32 type ;  u8 idle_bit ;  spinlock_t * lock ; } cocci_id@p ;
...
typedef u16;
@@
 struct clk_pll {  struct clk_hw hw ;  u16 regofs ; } cocci_id@p ;
...
typedef u16;
@@
 struct clk_dto {  struct clk_hw hw ;  u16 inc_offset ;  u16 src_offset ; } cocci_id@p ;
...
position p;
@@
 enum clk_unit_type { CLK_UNIT_NOC_OTHER , CLK_UNIT_NOC_CLOCK , CLK_UNIT_NOC_SOCKET , } cocci_id@p ;
...
typedef u8,u32,spinlock_t;
@@
 struct atlas7_reset_desc {  const char * name ;  u32 clk_ofs ;  u8 clk_bit ;  u32 rst_ofs ;  u8 rst_bit ;  spinlock_t * lock ; } cocci_id@p ;
...
position p;
@@
 struct atlas7_mux_init_data * cocci_id@p ;
...
@@
 struct clk_unit {  struct clk_hw hw ;  u16 regofs ;  u16 bit ;  u32 type ;  u8 idle_bit ;  spinlock_t * lock ; } cocci_id@p ;
...
position p;
@@
 struct atlas7_unit_init_data * cocci_id@p ;
