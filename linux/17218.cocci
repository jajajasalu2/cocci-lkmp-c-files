...
typedef bool;
@@
 struct mclk_setup_data {  enum mclk_type type ;  bool has_mclk1 ;  const char * name_mux0 ;  const char * name_en0 ;  const char * name_div0 ;  const char * parent_names_mux1 [ 2 ] ;  const char * name_mclk ; } cocci_id@p ;
...
position p;
@@
 struct clk * cocci_id@p [ MPC512x_CLK_LAST_PRIVATE ] ;
...
position p;
@@
 struct mclk_setup_data * cocci_id@p ;
...
position p;
@@
 enum soc_type { MPC512x_SOC_MPC5121 , MPC512x_SOC_MPC5123 , MPC512x_SOC_MPC5125 , } cocci_id@p ;
...
position p;
@@
 enum { MCLK_IDX_MUX0 , MCLK_IDX_EN0 , MCLK_IDX_DIV0 , MCLK_MAX_IDX , } cocci_id@p ;
...
position p;
@@
 enum { MPC512x_CLK_START_PRIVATE = MPC512x_CLK_LAST_PUBLIC , MPC512x_CLK_DDR , MPC512x_CLK_MEM , MPC512x_CLK_IIM , MPC512x_CLK_DDR_UG , MPC512x_CLK_SDHC_x4 , MPC512x_CLK_SDHC_UG , MPC512x_CLK_SDHC2_UG , MPC512x_CLK_DIU_x4 , MPC512x_CLK_DIU_UG , MPC512x_CLK_MBX_BUS_UG , MPC512x_CLK_MBX_UG , MPC512x_CLK_MBX_3D_UG , MPC512x_CLK_PCI_UG , MPC512x_CLK_NFC_UG , MPC512x_CLK_LPC_UG , MPC512x_CLK_SPDIF_TX_IN , MPC512x_CLK_MCLKS_FIRST , MPC512x_CLK_MCLKS_LAST = MPC512x_CLK_MCLKS_FIRST + NR_MCLKS * MCLK_MAX_IDX , MPC512x_CLK_LAST_PRIVATE , } cocci_id@p ;
...
position p;
@@
 enum mclk_type { MCLK_TYPE_PSC , MCLK_TYPE_MSCAN , MCLK_TYPE_SPDIF , MCLK_TYPE_OUTCLK , } cocci_id@p ;
...
position p;
@@
 enum did_reg_flags { DID_REG_PSC = BIT ( 0 ) , DID_REG_PSCFIFO = BIT ( 1 ) , DID_REG_NFC = BIT ( 2 ) , DID_REG_CAN = BIT ( 3 ) , DID_REG_I2C = BIT ( 4 ) , DID_REG_DIU = BIT ( 5 ) , DID_REG_VIU = BIT ( 6 ) , DID_REG_FEC = BIT ( 7 ) , DID_REG_USB = BIT ( 8 ) , DID_REG_PATA = BIT ( 9 ) , } cocci_id@p ;
