...
position p;
@@
 struct rockchip_emmc_phy {  unsigned int reg_offset ;  struct regmap * reg_base ;  struct clk * emmcclk ;  unsigned int drive_impedance ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_emmc_phy * cocci_id@p ;
