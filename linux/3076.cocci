...
position p;
@@
 struct mtip_int_cmd cocci_id@p ;
...
position p;
@@
 struct mtip_cmd_hdr cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct driver_data * dd ) ;
...
position p;
@@
 unsigned long cocci_id@p [ SLOTBITS_IN_LONGS ] ;
...
position p;
@@
 struct mtip_compat_ide_task_request_s cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ide_task_request_t;
@@
 ide_task_request_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mtip_port * port , unsigned int id , struct smart_attr * attrib ) ;
...
@@
 struct mtip_int_cmd {  int fis_len ;  dma_addr_t buffer ;  int buf_len ;  u32 opts ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u8,ide_reg_valid_t,compat_ulong_t;
@@
 struct mtip_compat_ide_task_request_s {  __u8 io_ports [ 8 ] ;  __u8 hob_ports [ 8 ] ;  ide_reg_valid_t out_flags ;  ide_reg_valid_t in_flags ;  int data_phase ;  int req_cmd ;  compat_ulong_t out_size ;  compat_ulong_t in_size ; } cocci_id@p ;
