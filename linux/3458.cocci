...
position p;
@@
 struct hv_uio_private_data cocci_id@p ;
...
position p;
@@
 enum hv_uio_map { TXRX_RING_MAP = 0 , INT_PAGE_MAP , MON_PAGE_MAP , RECV_BUF_MAP , SEND_BUF_MAP , } cocci_id@p ;
...
@@
 struct hv_uio_private_data {  struct uio_info info ;  struct hv_device * device ;  atomic_t refcnt ;  void * recv_buf ;  u32 recv_gpadl ;  char recv_name [ 32 ] ;  void * send_buf ;  u32 send_gpadl ;  char send_name [ 32 ] ; } cocci_id@p ;
