...
symbol cocci_id;
position p;
typedef u8,u64,int64_t;
@@
 int64_t cocci_id@p ( int64_t term_number , u64 * length , const u8 * buffer ) ;
...
@@
 int64_t cocci_id@p ( uint64_t * outstanding_event_mask ) ;
...
typedef uint64_t,int64_t;
@@
 int64_t cocci_id@p ( uint64_t term_number ) ;
...
position p;
@@
 void cocci_id@p ( unsigned long fdt_addr , void * vmlinux_addr ) ;
...
typedef u64;
@@
 struct opal {  u64 base ;  u64 entry ; } cocci_id@p ;
