...
position p;
@@
 struct arc_uart_port * cocci_id@p ;
...
position p;
@@
 struct arc_uart_port {  struct uart_port port ;  unsigned long baud ; } cocci_id@p ;
...
position p;
@@
 struct arc_uart_port cocci_id@p [ CONFIG_SERIAL_ARC_NR_PORTS ] ;
