...
position p;
@@
 struct sti_tvout_encoder {  struct drm_encoder encoder ;  struct sti_tvout * tvout ; } cocci_id@p ;
...
position p;
@@
 enum sti_tvout_video_out_type { STI_TVOUT_VIDEO_OUT_RGB , STI_TVOUT_VIDEO_OUT_YUV , } cocci_id@p ;
...
position p;
@@
 struct sti_tvout_encoder * cocci_id@p ;
...
position p;
@@
 enum sti_tvout_video_out_type cocci_id@p ;
...
typedef bool;
@@
 struct sti_tvout {  struct device * dev ;  struct drm_device * drm_dev ;  void __iomem * regs ;  struct reset_control * reset ;  struct drm_encoder * hdmi ;  struct drm_encoder * hda ;  struct drm_encoder * dvo ;  bool debugfs_registered ; } cocci_id@p ;
