...
position p;
@@
 struct mv88e6xxx_hw_stat * cocci_id@p ;
...
position p;
@@
 const struct mv88e6xxx_info cocci_id@p [ ] ;
...
position p;
@@
 enum mv88e6xxx_policy_action cocci_id@p ;
...
position p;
@@
 struct dsa_mall_mirror_tc_entry * cocci_id@p ;
...
position p;
@@
 const struct irq_chip cocci_id@p ;
...
position p;
@@
 struct mv88e6xxx_atu_entry cocci_id@p ;
...
position p;
@@
 struct mv88e6xxx_vtu_entry * cocci_id@p ;
...
position p;
@@
 struct mv88e6xxx_chip * cocci_id@p ;
...
position p;
@@
 struct mv88e6xxx_mdio_bus cocci_id@p ;
...
position p;
@@
 const struct mv88e6xxx_policy * cocci_id@p ;
...
position p;
@@
 const struct mv88e6xxx_ops cocci_id@p ;
...
position p;
@@
 enum mv88e6xxx_devlink_resource_id { MV88E6XXX_RESOURCE_ID_ATU , MV88E6XXX_RESOURCE_ID_ATU_BIN_0 , MV88E6XXX_RESOURCE_ID_ATU_BIN_1 , MV88E6XXX_RESOURCE_ID_ATU_BIN_2 , MV88E6XXX_RESOURCE_ID_ATU_BIN_3 , } cocci_id@p ;
...
position p;
@@
 const struct dsa_switch_ops cocci_id@p ;
...
position p;
@@
 enum mv88e6xxx_egress_direction cocci_id@p ;
...
position p;
@@
 enum mv88e6xxx_policy_mapping cocci_id@p ;
...
position p;
@@
 enum mv88e6xxx_frame_mode cocci_id@p ;
...
position p;
@@
 enum dsa_tag_protocol cocci_id@p ;
...
position p;
@@
 const struct dsa_mv88e6xxx_pdata * cocci_id@p ;
...
position p;
@@
 enum mv88e6xxx_egress_mode cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dsa_fdb_dump_cb_t;
@@
 dsa_fdb_dump_cb_t * cocci_id@p ;
...
position p;
@@
 struct mv88e6xxx_port * cocci_id@p ;
...
position p;
@@
 struct dsa_mv88e6xxx_pdata * cocci_id@p ;
...
position p;
@@
 struct mv88e6xxx_policy * cocci_id@p ;
...
position p;
@@
 struct dsa_switch_tree * cocci_id@p ;
...
position p;
@@
 enum mv88e6xxx_devlink_param_id { MV88E6XXX_DEVLINK_PARAM_ID_BASE = DEVLINK_PARAM_GENERIC_ID_MAX , MV88E6XXX_DEVLINK_PARAM_ID_ATU_HASH , } cocci_id@p ;
