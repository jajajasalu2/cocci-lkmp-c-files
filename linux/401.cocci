...
typedef time64_t;
@@
 struct dir_entry {  struct list_head list ;  char * name ;  time64_t mtime ; } cocci_id@p ;
...
position p;
@@
 enum state { Start , Collect , GotHeader , SkipIt , GotName , CopyFile , GotSymlink , Reset , } cocci_id@p ;
