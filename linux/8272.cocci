...
position p;
@@
 struct txc43128_data * cocci_id@p ;
...
position p;
@@
 struct txc43128_data {  unsigned long bug10934_timer ;  enum ef4_phy_mode phy_mode ;  enum ef4_loopback_mode loopback_mode ; } cocci_id@p ;
