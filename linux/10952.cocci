...
position p;
@@
 enum { MAX_TRAPID = 8 , MAX_WATCH_ADDRESSES = 4 , } cocci_id@p ;
...
position p;
@@
 union TCP_WATCH_CNTL_BITS cocci_id@p ;
...
position p;
@@
 enum kfd_preempt_type cocci_id@p ;
...
position p;
@@
 enum { ADDRESS_WATCH_REG_ADDR_HI = 0 , ADDRESS_WATCH_REG_ADDR_LO , ADDRESS_WATCH_REG_CNTL , ADDRESS_WATCH_REG_MAX , } cocci_id@p ;
...
position p;
@@
 enum hqd_dequeue_request_type cocci_id@p ;
...
typedef uint32_t;
@@
 union TCP_WATCH_CNTL_BITS {  struct {  uint32_t mask : 24 ;  uint32_t vmid : 4 ;  uint32_t atc : 1 ;  uint32_t mode : 2 ;  uint32_t valid : 1 ; } bitfields , bits ;  uint32_t u32All ;  signed int i32All ;  float f32All ; } cocci_id@p ;
...
position p;
@@
 const struct kfd2kgd_calls cocci_id@p ;
...
position p;
@@
 enum hqd_dequeue_request_type { NO_ACTION = 0 , DRAIN_PIPE , RESET_WAVES , } cocci_id@p ;
...
position p;
@@
 enum { ADDRESS_WATCH_REG_CNTL_ATC_BIT = 0x10000000UL , ADDRESS_WATCH_REG_CNTL_DEFAULT_MASK = 0x00FFFFFF , ADDRESS_WATCH_REG_ADDLOW_MASK_EXTENSION = 0x03000000 , ADDRESS_WATCH_REG_ADDLOW_SHIFT = 6 , ADDRESS_WATCH_REG_ADDHIGH_MASK = 0xFFFF , } cocci_id@p ;
...
position p;
@@
 struct cik_sdma_rlc_registers * cocci_id@p ;
...
typedef uint32_t;
@@
 const uint32_t cocci_id@p [ MAX_WATCH_ADDRESSES * ADDRESS_WATCH_REG_MAX ] ;
