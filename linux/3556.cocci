...
typedef u8,u32;
@@
 struct dw_mci_exynos_priv_data {  enum dw_mci_exynos_type ctrl_type ;  u8 ciu_div ;  u32 sdr_timing ;  u32 ddr_timing ;  u32 hs400_timing ;  u32 tuned_sample ;  u32 cur_speed ;  u32 dqs_delay ;  u32 saved_dqs_en ;  u32 saved_strobe_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct dw_mci_exynos_compatible {  char * compatible ;  enum dw_mci_exynos_type ctrl_type ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct dw_mci_drv_data * cocci_id@p ;
...
position p;
@@
 enum dw_mci_exynos_type { DW_MCI_TYPE_EXYNOS4210 , DW_MCI_TYPE_EXYNOS4412 , DW_MCI_TYPE_EXYNOS5250 , DW_MCI_TYPE_EXYNOS5420 , DW_MCI_TYPE_EXYNOS5420_SMU , DW_MCI_TYPE_EXYNOS7 , DW_MCI_TYPE_EXYNOS7_SMU , } cocci_id@p ;
...
position p;
@@
 struct dw_mci_exynos_priv_data * cocci_id@p ;
