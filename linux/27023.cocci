...
position p;
@@
 struct xfs_da_state_path * cocci_id@p ;
...
@@
 int cocci_id@p ( xfs_da_state_t * state , int * retval ) ;
...
position p;
@@
 struct xfs_da3_intnode * cocci_id@p ;
...
position p;
@@
 struct xfs_da3_node_hdr * cocci_id@p ;
...
position p;
@@
 struct xfs_da_node_entry * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_da_intnode_t;
@@
 xfs_da_intnode_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_rfsblock_t;
@@
 xfs_rfsblock_t cocci_id@p ;
