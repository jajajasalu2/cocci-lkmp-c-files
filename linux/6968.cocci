...
position p;
@@
 struct mbox_test_device * cocci_id@p ;
...
@@
 struct mbox_test_device {  struct device * dev ;  void __iomem * tx_mmio ;  void __iomem * rx_mmio ;  struct mbox_chan * tx_channel ;  struct mbox_chan * rx_channel ;  char * rx_buffer ;  char * signal ;  char * message ;  spinlock_t lock ;  wait_queue_head_t waitq ;  struct fasync_struct * async_queue ;  struct dentry * root_debugfs_dir ; } cocci_id@p ;
