...
position p;
@@
 struct vdso_info {  struct vdso_file vdso ; #if BITS_PER_LONG == 64  struct vdso_file vdso32 ;  struct vdso_file vdsox32 ; #endif } cocci_id@p ;
...
typedef bool;
@@
 struct vdso_file {  bool found ;  bool error ;  char temp_file_name [ sizeof ( VDSO__TEMP_FILE_NAME ) ] ;  const char * dso_name ;  const char * read_prog ; } cocci_id@p ;
...
position p;
@@
 const struct vdso_info cocci_id@p ;
