...
position p;
@@
 int cocci_id@p ( struct nilfs_segment_buffer * segbuf ) ;
...
position p;
@@
 int cocci_id@p ( struct nilfs_segment_buffer * segbuf , struct the_nilfs * nilfs ) ;
...
position p;
@@
 struct nilfs_write_info cocci_id@p ;
