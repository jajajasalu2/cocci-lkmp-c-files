...
position p;
@@
 struct i82365_socket cocci_id@p [ 8 ] ;
...
position p;
@@
 struct i82365_socket * cocci_id@p ;
...
typedef u_short;
@@
 struct pcic {  char * name ;  u_short flags ; } cocci_id@p ;
...
position p;
@@
 struct cirrus_state * cocci_id@p ;
...
position p;
@@
 enum pcic_id { IS_I82365A , IS_I82365B , IS_I82365DF , IS_IBM , IS_RF5Cx96 , IS_VLSI , IS_VG468 , IS_VG469 , IS_PD6710 , IS_PD672X , IS_VT83C469 , } cocci_id@p ;
