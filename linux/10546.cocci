...
typedef u32;
@@
 struct insert_entries {  struct i915_address_space * vm ;  struct i915_vma * vma ;  enum i915_cache_level level ;  u32 flags ; } cocci_id@p ;
...
typedef u64;
@@
 struct clear_range {  struct i915_address_space * vm ;  u64 start ;  u64 length ; } cocci_id@p ;
...
position p;
@@
 struct gen6_ppgtt * constcocci_id ;
...
position p;
@@
 struct i915_page_dma * cocci_id@p ;
...
position p;
@@
 struct i915_ppgtt * constcocci_id ;
...
position p;
@@
 const struct i915_vma_ops cocci_id@p ;
...
position p;
@@
 typeof ( struct i915_page_directory ) cocci_id@p ;
...
position p;
@@
 struct i915_page_directory * cocci_id@p ;
...
position p;
@@
 const enum i915_cache_level cocci_id@p ;
...
position p;
@@
 const struct i915_page_scratch * constcocci_id ;
...
position p;
@@
 const struct gen6_ppgtt * cocci_id@p ;
...
position p;
@@
 enum i915_cache_level cocci_id@p ;
...
position p;
@@
 struct intel_remapped_info * cocci_id@p ;
...
position p;
@@
 enum drm_mm_insert_mode cocci_id@p ;
...
position p;
@@
 struct insert_entries * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct i915_vma * vma ) ;
...
position p;
@@
 struct i915_page_table * cocci_id@p ;
...
@@
 struct insert_page {  struct i915_address_space * vm ;  dma_addr_t addr ;  u64 offset ;  enum i915_cache_level level ; } cocci_id@p ;
...
position p;
@@
 struct i915_page_directory * constcocci_id ;
...
typedef u64,dma_addr_t;
@@
 u64 ( * cocci_id@p ) ( const  dma_addr_t , const enum i915_cache_level ) ;
...
position p;
@@
 const struct drm_mm_node * cocci_id@p ;
...
position p;
@@
 struct i915_page_dma * constcocci_id ;
...
position p;
@@
 struct i915_ggtt * constcocci_id ;
...
position p;
@@
 const struct i915_page_table * cocci_id@p ;
...
position p;
@@
 struct i915_page_table * constcocci_id ;
...
position p;
@@
 const struct i915_address_space * cocci_id@p ;
...
position p;
@@
 const struct i915_page_dma * cocci_id@p ;
...
position p;
@@
 struct i915_address_space * constcocci_id ;
