...
position p;
@@
 struct raid_kobject * cocci_id@p ;
...
position p;
@@
 struct btrfs_fs_devices * cocci_id@p ( struct kobject * kobj ) ;
...
position p;
@@
 struct btrfs_feature_attr cocci_id@p [ FEAT_MAX ] [ NUM_FEATURE_BITS ] ;
...
position p;
@@
 char cocci_id@p [ FEAT_MAX ] [ NUM_FEATURE_BITS ] [ BTRFS_FEATURE_NAME_MAX ] ;
...
position p;
@@
 char cocci_id@p [ BTRFS_UUID_UNPARSED_SIZE ] ;
...
typedef u64;
@@
 struct raid_kobject {  u64 flags ;  struct kobject kobj ; } cocci_id@p ;
...
position p;
@@
 struct btrfs_fs_info * cocci_id@p ( struct kobject * kobj ) ;
...
position p;
@@
 ssize_t cocci_id@p ( struct kobject * kobj , struct kobj_attribute * attr , char * buf ) ;
...
position p;
@@
 const char * const cocci_id@p [ FEAT_MAX ] ;
...
position p;
@@
 struct btrfs_feature_attr * cocci_id@p ;
...
typedef u64;
@@
 struct btrfs_feature_attr {  struct kobj_attribute kobj_attr ;  enum btrfs_feature_set feature_set ;  u64 feature_bit ; } cocci_id@p ;
