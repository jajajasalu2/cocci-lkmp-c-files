...
position p;
@@
 struct ip6_fraglist_iter * cocci_id@p ;
...
position p;
@@
 struct ip6_frag_state cocci_id@p ;
...
position p;
@@
 const struct rt6key * cocci_id@p ;
...
position p;
@@
 struct ip6_ra_chain * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net * , struct sock * , struct sk_buff * ) ;
...
position p;
@@
 int cocci_id@p ( void * from , char * to , int offset , int len , int odd , struct sk_buff * skb ) ;
