...
position p;
@@
 struct bfi_pbc_vport_s cocci_id@p [ BFI_PBC_MAX_VPORTS ] ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcs_fabric_s * fabric , enum bfa_fcs_fabric_event event ) ;
...
position p;
@@
 char cocci_id@p [ BFA_ADAPTER_MODEL_NAME_LEN ] ;
...
typedef u16;
@@
 void cocci_id@p ( struct bfa_fcs_fabric_s * fabric , struct fchs_s * fchs , u16 len ) ;
...
position p;
@@
 enum bfa_fcs_fabric_event cocci_id@p ;
...
position p;
@@
 struct bfa_fcs_lport_n2n_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcs_fabric_s * fabric ) ;
