...
typedef u32;
@@
 struct gxt4500_par {  void __iomem * regs ;  int wc_cookie ;  int pixfmt ;  int refclk_ps ;  int pll_m ;  int pll_n ;  int pll_pd1 ;  int pll_pd2 ;  u32 pseudo_palette [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 enum gxt_cards { GXT4500P , GXT6500P , GXT4000P , GXT6000P , } cocci_id@p ;
...
position p;
@@
 const struct cardinfo {  int refclk_ps ;  const char * cardname ; } cocci_id@p [ ] ;
