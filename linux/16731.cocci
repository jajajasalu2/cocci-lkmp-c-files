...
position p;
@@
 struct pxa930_rotary_platform_data * cocci_id@p ;
...
position p;
@@
 struct pxa930_rotary {  struct input_dev * input_dev ;  void __iomem * mmio_base ;  int last_ercr ;  struct pxa930_rotary_platform_data * pdata ; } cocci_id@p ;
...
position p;
@@
 struct pxa930_rotary cocci_id@p ;
