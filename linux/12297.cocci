...
typedef bool;
@@
 struct jh057n {  struct device * dev ;  struct drm_panel panel ;  struct gpio_desc * reset_gpio ;  struct backlight_device * backlight ;  struct regulator * vcc ;  struct regulator * iovcc ;  bool prepared ;  struct dentry * debugfs ; } cocci_id@p ;
