...
position p;
@@
 const struct rza1_bidir_entry cocci_id@p [ RZA1_NPORTS ] ;
...
typedef u8;
@@
 struct rza1_bidir_pin {  u8 pin : 4 ;  u8 func : 4 ; } cocci_id@p ;
...
position p;
@@
 const struct rza1_bidir_entry * cocci_id@p ;
...
position p;
@@
 const struct rza1_pinmux_conf * cocci_id@p ;
...
position p;
@@
 const struct rza1_bidir_pin cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct rza1_mux_conf {  u16 id ;  u8 port ;  u8 pin ;  u8 mux_func ;  u8 mux_flags ;  u8 value ; } cocci_id@p ;
...
position p;
@@
 struct rza1_pinctrl * cocci_id@p ;
...
position p;
@@
 const struct rza1_swio_pin * cocci_id@p ;
...
position p;
@@
 struct rza1_mux_conf * cocci_id@p ;
...
position p;
@@
 const struct rza1_swio_entry cocci_id@p [ ] ;
...
position p;
@@
 struct rza1_pinctrl {  struct device * dev ;  struct mutex mutex ;  void __iomem * base ;  unsigned int nport ;  struct rza1_port * ports ;  struct pinctrl_pin_desc * pins ;  struct pinctrl_desc desc ;  struct pinctrl_dev * pctl ;  const void * data ; } cocci_id@p ;
...
position p;
@@
 struct rza1_pinmux_conf {  const struct rza1_bidir_entry * bidir_entries ;  const struct rza1_swio_entry * swio_entries ; } cocci_id@p ;
...
typedef u16;
@@
 struct rza1_swio_pin {  u16 pin : 4 ;  u16 port : 4 ;  u16 func : 4 ;  u16 input : 1 ; } cocci_id@p ;
...
position p;
@@
 struct rza1_bidir_entry {  const unsigned int npins ;  const struct rza1_bidir_pin * pins ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct rza1_port {  spinlock_t lock ;  unsigned int id ;  void __iomem * base ;  struct pinctrl_pin_desc * pins ; } cocci_id@p ;
...
position p;
@@
 struct rza1_swio_entry {  const unsigned int npins ;  const struct rza1_swio_pin * pins ; } cocci_id@p ;
