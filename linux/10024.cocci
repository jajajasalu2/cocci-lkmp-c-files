...
typedef u8;
@@
 u8 cocci_id@p [ 4 ] [ ORINOCO_SEQ_LEN ] ;
...
position p;
@@
 const struct cfg80211_ssid * cocci_id@p ;
...
position p;
@@
 struct orinoco_key cocci_id@p [ ORINOCO_MAX_KEYS ] ;
...
typedef u16;
@@
 const struct {  int bitrate ;  int automatic ;  u16 agere_txratectrl ;  u16 intersil_txratectrl ; } cocci_id@p [ ] ;
...
position p;
@@
 struct hermes_multicast cocci_id@p ;
...
position p;
@@
 struct hermes_idstring cocci_id@p ;
