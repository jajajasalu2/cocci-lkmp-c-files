...
typedef u8;
@@
 struct atusb {  struct ieee802154_hw * hw ;  struct usb_device * usb_dev ;  struct atusb_chip_data * data ;  int shutdown ;  int err ;  struct delayed_work work ;  struct usb_anchor idle_urbs ;  struct usb_anchor rx_urbs ;  struct usb_ctrlrequest tx_dr ;  struct urb * tx_urb ;  struct sk_buff * tx_skb ;  u8 tx_ack_seq ;  unsigned char fw_ver_maj ;  unsigned char fw_ver_min ;  unsigned char fw_hw_type ; } cocci_id@p ;
...
position p;
@@
 struct atusb_chip_data cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ ATUSB_MAX_ED_LEVELS + 1 ] ;
...
typedef u8,s32,u16;
@@
 struct atusb_chip_data {  u16 t_channel_switch ;  int rssi_base_val ;  int ( * set_channel ) ( struct ieee802154_hw * , u8 , u8 ) ;  int ( * set_txpower ) ( struct ieee802154_hw * , s32 ) ; } cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ ATUSB_MAX_TX_POWERS + 1 ] ;
