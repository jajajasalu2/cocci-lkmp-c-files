...
position p;
@@
 struct {  void __iomem * start ;  void __iomem * end ; } cocci_id@p [ 2 ] [ EDMA_V0_MAX_NR_CH ] ;
...
position p;
@@
 const struct debugfs_entries cocci_id@p [ ] ;
...
typedef dma_addr_t;
@@
 struct debugfs_entries {  const char * name ;  dma_addr_t * reg ; } cocci_id@p ;
