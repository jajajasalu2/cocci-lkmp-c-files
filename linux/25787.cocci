...
position p;
@@
 char cocci_id@p [ LOGDIR_NAME_SIZE ] ;
...
position p;
@@
 char cocci_id@p [ LOGDIR_NAME_SIZE + 30 ] ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_THREADS ] ;
...
typedef pthread_t;
@@
 pthread_t cocci_id@p [ MAX_THREADS ] ;
