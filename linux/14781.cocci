...
position p;
@@
 enum rz_clk_types { CLK_TYPE_RZA_MAIN = CLK_TYPE_CUSTOM , CLK_TYPE_RZA_PLL , } cocci_id@p ;
...
position p;
@@
 enum clk_ids { LAST_DT_CORE_CLK = R7S9210_CLK_P0 , CLK_EXTAL , CLK_MAIN , CLK_PLL , MOD_CLK_BASE , } cocci_id@p ;
...
position p;
@@
 const struct {  unsigned int i ;  unsigned int g ;  unsigned int b ;  unsigned int p1 ; ; } cocci_id@p [ 5 ] ;
