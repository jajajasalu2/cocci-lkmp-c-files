...
typedef u64;
@@
 long ( * cocci_id@p ) ( u64 , u64 , u64 , u64 * ) ;
...
typedef u8,u64,u16;
@@
 struct ai_header {  u16 version ;  u8 reserved0 [ 6 ] ;  u16 vendor ;  u16 device ;  u16 subsystem_vendor ;  u16 subsystem ;  u64 image_offset ;  u64 image_length ;  u8 reserved1 [ 96 ] ; } cocci_id@p ;
...
position p;
@@
 struct update_props_workarea * cocci_id@p ;
...
position p;
@@
 struct update_nodes_workarea * cocci_id@p ;
...
position p;
@@
 struct cxl_adapter_image * cocci_id@p ;
...
position p;
@@
 unsigned long * cocci_id@p [ CXL_AI_MAX_ENTRIES ] ;
