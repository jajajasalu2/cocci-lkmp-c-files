...
position p;
@@
 enum soc_type { SOC_ARCH_EXYNOS3250 = 1 , SOC_ARCH_EXYNOS4210 , SOC_ARCH_EXYNOS4412 , SOC_ARCH_EXYNOS5250 , SOC_ARCH_EXYNOS5260 , SOC_ARCH_EXYNOS5420 , SOC_ARCH_EXYNOS5420_TRIMINFO , SOC_ARCH_EXYNOS5433 , SOC_ARCH_EXYNOS7 , } cocci_id@p ;
...
position p;
@@
 const struct thermal_trip * constcocci_id ;
...
position p;
@@
 struct exynos_tmu_data * cocci_id@p ;
