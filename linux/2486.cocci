...
position p;
@@
 struct stm32_dmamux_data * cocci_id@p ;
...
typedef u32;
@@
 struct stm32_dmamux {  u32 master ;  u32 request ;  u32 chan_id ; } cocci_id@p ;
...
@@
 struct stm32_dmamux_data {  struct dma_router dmarouter ;  struct clk * clk ;  struct reset_control * rst ;  void __iomem * iomem ;  u32 dma_requests ;  u32 dmamux_requests ;  spinlock_t lock ;  unsigned long * dma_inuse ;  u32 dma_reqs [ ] ; } cocci_id@p ;
...
position p;
@@
 struct stm32_dmamux * cocci_id@p ;
