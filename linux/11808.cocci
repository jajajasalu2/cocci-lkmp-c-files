...
position p;
@@
 const enum nvkm_memory_target cocci_id@p ;
...
position p;
@@
 const struct nvkm_vmm_func cocci_id@p ;
...
position p;
@@
 const struct nvkm_vmm_page * cocci_id@p ;
...
position p;
@@
 union {  struct gp100_vmm_vn vn ;  struct gp100_vmm_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_vmm_desc cocci_id@p [ ] ;
...
position p;
@@
 union {  struct gp100_vmm_fault_replay_vn vn ; } * cocci_id@p ;
...
position p;
@@
 union {  struct gp100_vmm_map_vn vn ;  struct gp100_vmm_map_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_vmm_desc_func cocci_id@p ;
...
position p;
@@
 union {  struct gp100_vmm_fault_cancel_v0 v0 ; } * cocci_id@p ;
