...
position p;
@@
 const struct {  const int timeout ;  const int regval ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct ts4800_wdt {  struct watchdog_device wdd ;  struct regmap * regmap ;  u32 feed_offset ;  u32 feed_val ; } cocci_id@p ;
