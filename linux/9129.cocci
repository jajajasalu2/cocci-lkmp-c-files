...
position p;
@@
 int cocci_id@p [ MLX5_ST_SZ_DW ( query_hca_vport_context_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_vport_state_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( modify_vport_state_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_nic_vport_context_out ) ] ;
...
position p;
@@
 enum mlx5_list_type cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLX5_ST_SZ_BYTES ( modify_hca_vport_context_out ) ] ;
...
position p;
@@
 enum mlx5_vport_roce_state cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( modify_nic_vport_context_out ) ] ;
...
position p;
@@
 enum { UC_LOCAL_LB , MC_LOCAL_LB , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( modify_vport_state_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_nic_vport_context_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_vnic_env_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( modify_nic_vport_context_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_vnic_env_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_vport_state_in ) ] ;
...
position p;
@@
 enum mlx5_vport_roce_state { MLX5_VPORT_ROCE_DISABLED = 0 , MLX5_VPORT_ROCE_ENABLED = 1 , } cocci_id@p ;
