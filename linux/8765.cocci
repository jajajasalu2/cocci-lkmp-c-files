...
position p;
@@
 struct qlcnic_adapter * cocci_id@p ;
...
position p;
@@
 const struct dcbnl_rtnl_ops cocci_id@p ;
...
position p;
@@
 struct qlcnic_dcb_capability * cocci_id@p ;
...
typedef u32;
@@
 struct qlcnic_dcb_cfg {  struct qlcnic_dcb_cee type [ QLC_DCB_NUM_PARAM ] ;  struct qlcnic_dcb_capability capability ;  u32 version ; } cocci_id@p ;
...
typedef bool;
@@
 struct qlcnic_dcb_prio_cfg {  bool valid ;  enum qlcnic_dcb_pfc_type pfc_type ; } cocci_id@p ;
...
position p;
@@
 struct qlcnic_dcb_pg_cfg cocci_id@p ;
...
typedef u32;
@@
 struct qlcnic_dcb_param {  u32 hdr_prio_pfc_map [ 2 ] ;  u32 prio_pg_map [ 2 ] ;  u32 pg_bw_map [ 2 ] ;  u32 pg_tsa_map [ 2 ] ;  u32 app [ QLC_DCB_MAX_APP ] ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct qlcnic_dcb_tc_cfg {  bool valid ;  struct qlcnic_dcb_prio_cfg prio_cfg [ QLC_DCB_MAX_PRIO ] ;  enum qlcnic_dcb_prio_type prio_type ;  u8 link_percent ;  u8 bwg_percent ;  u8 up_tc_map ;  u8 pgid ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qlcnic_adapter * ) ;
...
position p;
@@
 struct qlcnic_dcb_tc_cfg cocci_id@p ;
...
position p;
@@
 struct qlcnic_dcb_param * cocci_id@p ;
...
position p;
@@
 struct qlcnic_82xx_dcb_param_mbx_le cocci_id@p ;
...
typedef u32;
@@
 struct qlcnic_dcb_mbx_params {  struct qlcnic_dcb_param type [ 3 ] ;  u32 prio_tc_map ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qlcnic_dcb * , char * ) ;
...
position p;
@@
 enum qlcnic_dcb_pfc_type { QLC_PFC_DISABLED = 0 , QLC_PFC_FULL , QLC_PFC_TX , QLC_PFC_RX , } cocci_id@p ;
...
position p;
@@
 enum qlcnic_dcb_prio_type { QLC_PRIO_NONE = 0 , QLC_PRIO_GROUP , QLC_PRIO_LINK , } cocci_id@p ;
...
position p;
@@
 struct qlcnic_dcb_mbx_params cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct qlcnic_dcb * , char * , u8 ) ;
...
position p;
@@
 struct dcb_peer_app_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qlcnic_dcb * , void * ) ;
...
position p;
@@
 int cocci_id@p ( struct qlcnic_dcb * ) ;
...
position p;
@@
 struct qlcnic_dcb_app * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct qlcnic_dcb_app {  bool valid ;  enum qlcnic_dcb_selector selector ;  u16 protocol ;  u8 priority ; } cocci_id@p ;
...
typedef __le32;
@@
 struct qlcnic_82xx_dcb_param_mbx_le {  __le32 hdr_prio_pfc_map [ 2 ] ;  __le32 prio_pg_map [ 2 ] ;  __le32 pg_bw_map [ 2 ] ;  __le32 pg_tsa_map [ 2 ] ;  __le32 app [ QLC_DCB_MAX_APP ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct qlcnic_dcb_cee {  struct qlcnic_dcb_tc_cfg tc_cfg [ QLC_DCB_MAX_TC ] ;  struct qlcnic_dcb_pg_cfg pg_cfg [ QLC_DCB_MAX_PG ] ;  struct qlcnic_dcb_app app [ QLC_DCB_MAX_APP ] ;  bool tc_param_valid ;  bool pfc_mode_enable ; } cocci_id@p ;
...
position p;
@@
 struct qlcnic_dcb_cfg cocci_id@p ;
...
position p;
@@
 struct qlcnic_cmd_args cocci_id@p ;
...
typedef u8,bool;
@@
 struct qlcnic_dcb_capability {  bool tsa_capability ;  bool ets_capability ;  u8 max_num_tc ;  u8 max_ets_tc ;  u8 max_pfc_tc ;  u8 dcb_capability ; } cocci_id@p ;
...
position p;
@@
 enum qlcnic_dcb_selector { QLC_SELECTOR_DEF = 0x0 , QLC_SELECTOR_ETHER , QLC_SELECTOR_TCP , QLC_SELECTOR_UDP , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct qlcnic_dcb_pg_cfg {  bool valid ;  u8 total_bw_percent ;  u8 prio_count ;  u8 tsa_type ; } cocci_id@p ;
...
position p;
@@
 const struct qlcnic_dcb_ops cocci_id@p ;
...
position p;
@@
 struct qlcnic_dcb_cee * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qlcnic_dcb * ) ;
