...
typedef intptr_t;
@@
 struct percpu_buffer_node {  intptr_t data ; } cocci_id@p ;
...
position p;
@@
 struct percpu_memcpy_buffer_node cocci_id@p ;
...
position p;
@@
 struct inc_thread_test_data * cocci_id@p ;
...
position p;
@@
 struct percpu_lock {  struct percpu_lock_entry c [ CPU_SETSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct spinlock_test_data * cocci_id@p ;
...
typedef pthread_t;
@@
 pthread_t cocci_id@p [ num_threads ] ;
...
position p;
@@
 struct percpu_buffer cocci_id@p ;
...
position p;
@@
 struct inc_test_data {  struct test_data_entry c [ CPU_SETSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct inc_test_data * cocci_id@p ;
...
position p;
@@
 struct inc_thread_test_data cocci_id@p [ num_threads ] ;
...
position p;
@@
 struct spinlock_test_data {  struct percpu_lock lock ;  struct test_data_entry c [ CPU_SETSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct percpu_memcpy_buffer {  struct percpu_memcpy_buffer_entry c [ CPU_SETSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct spinlock_thread_test_data cocci_id@p [ num_threads ] ;
...
typedef intptr_t;
@@
 struct percpu_list_node {  intptr_t data ;  struct percpu_list_node * next ; } cocci_id@p ;
...
position p;
@@
 struct percpu_list {  struct percpu_list_entry c [ CPU_SETSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct percpu_buffer {  struct percpu_buffer_entry c [ CPU_SETSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct spinlock_thread_test_data {  struct spinlock_test_data * data ;  long long reps ;  int reg ; } cocci_id@p ;
...
position p;
@@
 struct spinlock_thread_test_data * cocci_id@p ;
...
position p;
@@
 struct percpu_list_node * cocci_id@p ;
...
position p;
@@
 struct inc_thread_test_data {  struct inc_test_data * data ;  long long reps ;  int reg ; } cocci_id@p ;
...
position p;
@@
 struct percpu_memcpy_buffer * cocci_id@p ;
...
position p;
@@
 struct percpu_buffer_node * cocci_id@p ;
...
@@
 struct percpu_memcpy_buffer_node {  intptr_t data1 ;  uint64_t data2 ; } cocci_id@p ;
