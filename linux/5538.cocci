...
position p;
@@
 unsigned char cocci_id@p [ PALMAS_NUM_TIME_REGS ] ;
...
position p;
@@
 struct palmas_rtc {  struct rtc_device * rtc ;  struct device * dev ;  unsigned int irq ; } cocci_id@p ;
