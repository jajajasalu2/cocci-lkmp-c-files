...
position p;
@@
 const struct nfs4_slot * cocci_id@p ;
...
position p;
@@
 struct cb_getattrres * cocci_id@p ;
...
position p;
@@
 struct referring_call * cocci_id@p ;
...
position p;
@@
 const struct cb_sequenceargs * cocci_id@p ;
...
position p;
@@
 struct cb_sequenceres * cocci_id@p ;
...
position p;
@@
 const struct nfs4_slot_table * cocci_id@p ;
