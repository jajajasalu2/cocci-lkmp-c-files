...
typedef u8,__be32;
@@
 struct hmark_tuple {  __be32 src ;  __be32 dst ;  union hmark_ports uports ;  u8 proto ; } cocci_id@p ;
...
position p;
@@
 struct xt_hmark_info cocci_id@p ;
...
position p;
@@
 const struct xt_hmark_info * cocci_id@p ;
