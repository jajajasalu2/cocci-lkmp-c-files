...
position p;
@@
 const struct aa_data * cocci_id@p ;
...
typedef u32;
@@
 struct aa_ext {  void * start ;  void * end ;  void * pos ;  u32 version ; } cocci_id@p ;
...
position p;
@@
 enum aa_code { AA_U8 , AA_U16 , AA_U32 , AA_U64 , AA_NAME , AA_STRING , AA_BLOB , AA_STRUCT , AA_STRUCTEND , AA_LIST , AA_LISTEND , AA_ARRAY , AA_ARRAYEND , } cocci_id@p ;
