...
position p;
@@
 enum lp8788_buck_id { BUCK1 , BUCK2 , BUCK3 , BUCK4 , } cocci_id@p ;
...
position p;
@@
 enum lp8788_dvs_mode { REGISTER , EXTPIN , } cocci_id@p ;
...
position p;
@@
 enum lp8788_buck_id cocci_id@p ;
...
position p;
@@
 struct lp8788_buck1_dvs * cocci_id@p ;
...
position p;
@@
 enum lp8788_dvs_state cocci_id@p ;
...
position p;
@@
 enum lp8788_dvs_state { DVS_LOW = GPIOF_OUT_INIT_LOW , DVS_HIGH = GPIOF_OUT_INIT_HIGH , } cocci_id@p ;
...
position p;
@@
 enum lp8788_dvs_mode cocci_id@p ;
...
position p;
@@
 struct lp8788_buck {  struct lp8788 * lp ;  struct regulator_dev * regulator ;  void * dvs ; } cocci_id@p ;
...
position p;
@@
 struct lp8788_platform_data * cocci_id@p ;
...
position p;
@@
 struct lp8788_buck2_dvs * cocci_id@p ;
