...
position p;
@@
 struct coredump_segment_record cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_install_update_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_find_dir_entry_input cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_read_input cocci_id@p ;
...
position p;
@@
 enum { RX_TOTAL_DISCARDS , TX_TOTAL_DISCARDS , } cocci_id@p ;
...
position p;
@@
 struct hwrm_selftest_qlist_output * cocci_id@p ;
...
position p;
@@
 struct bnxt_hwrm_dbg_dma_info * cocci_id@p ;
...
position p;
@@
 struct hwrm_dbg_coredump_list_input cocci_id@p ;
...
position p;
@@
 struct hwrm_dbg_coredump_retrieve_output cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_modify_input cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_erase_dir_entry_input cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_get_dir_info_input cocci_id@p ;
...
position p;
@@
 struct ethtool_link_settings * cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_find_dir_entry_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_install_update_input cocci_id@p ;
...
typedef u32,u16;
@@
 int cocci_id@p ( struct net_device * dev , u16 type , u16 ordinal , u16 ext , u16 * index , u32 * item_length , u32 * data_length ) ;
...
position p;
@@
 const struct ethtool_link_settings * cocci_id@p ;
...
position p;
@@
 struct bnxt_ucode_trailer cocci_id@p ;
...
position p;
@@
 struct bnxt_led_cfg * cocci_id@p ;
...
position p;
@@
 struct hwrm_selftest_exec_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_dbg_cmn_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_get_dir_info_output * cocci_id@p ;
...
position p;
@@
 struct ethtool_dump * cocci_id@p ;
...
position p;
@@
 struct hwrm_port_led_cfg_input cocci_id@p ;
...
position p;
@@
 struct bnxt_coredump_segment_hdr * cocci_id@p ;
...
position p;
@@
 struct hwrm_dbg_coredump_initiate_input cocci_id@p ;
...
position p;
@@
 struct bnxt_fw_header cocci_id@p ;
...
position p;
@@
 struct hwrm_port_phy_i2c_read_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_selftest_exec_input cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_write_input cocci_id@p ;
...
position p;
@@
 struct bnxt_coredump_record cocci_id@p ;
...
position p;
@@
 struct hwrm_port_phy_i2c_read_input cocci_id@p ;
...
position p;
@@
 struct hwrm_selftest_qlist_input cocci_id@p ;
...
position p;
@@
 struct hwrm_dbg_cmn_input * cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_get_dir_entries_input cocci_id@p ;
...
position p;
@@
 struct bnxt_test_info * cocci_id@p ;
...
position p;
@@
 struct hwrm_dbg_coredump_retrieve_input cocci_id@p ;
...
position p;
@@
 const struct {  long offset ;  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct hwrm_selftest_irq_input cocci_id@p ;
...
position p;
@@
 struct bnxt_coredump cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SFF_DIAG_SUPPORT_OFFSET + 1 ] ;
...
position p;
@@
 struct hwrm_port_mac_cfg_input cocci_id@p ;
...
typedef u64;
@@
 struct {  u64 counter ;  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ethtool_flash * cocci_id@p ;
...
position p;
@@
 const struct {  long base_off ;  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct hwrm_dbg_coredump_list_output cocci_id@p ;
