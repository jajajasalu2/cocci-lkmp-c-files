...
position p;
@@
 struct value_to_freq cocci_id@p ;
...
@@
 struct armada38x_rtc {  struct rtc_device * rtc_dev ;  void __iomem * regs ;  void __iomem * regs_soc ;  spinlock_t lock ;  int irq ;  bool initialized ;  struct value_to_freq * val_to_freq ;  const struct armada38x_rtc_data * data ; } cocci_id@p ;
...
position p;
@@
 struct armada38x_rtc cocci_id@p ;
...
typedef u8,u32;
@@
 struct value_to_freq {  u32 value ;  u8 freq ; } cocci_id@p ;
...
position p;
@@
 const struct armada38x_rtc_data cocci_id@p ;
