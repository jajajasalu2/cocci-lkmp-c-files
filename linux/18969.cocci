...
@@
 struct sram_bank_info {  char * pool_name ;  struct gen_pool * gpool ;  int granularity ;  phys_addr_t sram_phys ;  void __iomem * sram_virt ;  u32 sram_size ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct sram_bank_info * cocci_id@p ;
