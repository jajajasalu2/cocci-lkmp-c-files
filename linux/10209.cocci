...
position p;
@@
 struct socket_info cocci_id@p [ MAX_SOCKETS ] ;
...
position p;
@@
 struct socket_info {  int number ;  int card_state ;  unsigned int io_base ;  struct pcmcia_socket socket ;  struct pci_dev * dev ; } cocci_id@p ;
