...
position p;
@@
 struct sctp_endpoint * cocci_id@p ( struct net * net , struct sk_buff * skb , const union sctp_addr * laddr , const union sctp_addr * daddr ) ;
...
position p;
@@
 const struct sctp_hash_cmp_arg * cocci_id@p ;
...
position p;
@@
 struct sctp_hash_cmp_arg cocci_id@p ;
...
position p;
@@
 struct sctp_association * cocci_id@p ( struct net * net , struct sk_buff * skb , const union sctp_addr * paddr , const union sctp_addr * laddr , struct sctp_transport * * transportp ) ;
...
position p;
@@
 struct sctp_association * cocci_id@p ( struct net * net , const union sctp_addr * local , const union sctp_addr * peer , struct sctp_transport * * pt ) ;
...
position p;
@@
 struct sctp_hash_cmp_arg {  const union sctp_addr * paddr ;  const struct net * net ;  __be16 lport ; } cocci_id@p ;
