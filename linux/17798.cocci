...
symbol cocci_id;
position p;
typedef palinfo_smp_data_t;
@@
 palinfo_smp_data_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_cache_config_info_t;
@@
 pal_cache_config_info_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_version_u_t;
@@
 pal_version_u_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_vm_info_1_u_t;
@@
 pal_vm_info_1_u_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_tc_info_u_t;
@@
 pal_tc_info_u_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ia64_ptce_info_t;
@@
 ia64_ptce_info_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef palinfo_func_t;
@@
 struct {  palinfo_func_t func ;  struct seq_file * m ;  int ret ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_func_cpu_u_t;
@@
 pal_func_cpu_u_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_vm_info_2_u_t;
@@
 pal_vm_info_2_u_t cocci_id@p ;
...
typedef u64;
@@
 union {  u64 value ;  struct {  unsigned req_cpu : 32 ;  unsigned func_id : 32 ; } pal_func_cpu ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_hints_u_t;
@@
 pal_hints_u_t cocci_id@p ;
...
position p;
@@
 struct itir_reg {  unsigned long rv1 : 2 ;  unsigned long ps : 6 ;  unsigned long key : 24 ;  unsigned long rv2 : 32 ; } * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_power_mgmt_info_u_t;
@@
 pal_power_mgmt_info_u_t * cocci_id@p ;
...
position p;
@@
 struct gr_reg {  unsigned long p : 1 ;  unsigned long rv1 : 1 ;  unsigned long ma : 3 ;  unsigned long a : 1 ;  unsigned long d : 1 ;  unsigned long pl : 2 ;  unsigned long ar : 3 ;  unsigned long ppn : 38 ;  unsigned long rv2 : 2 ;  unsigned long ed : 1 ;  unsigned long ig : 11 ; } * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_perf_mon_info_u_t;
@@
 pal_perf_mon_info_u_t cocci_id@p ;
...
position p;
@@
 struct pal_freq_ratio cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_bus_features_u_t;
@@
 pal_bus_features_u_t cocci_id@p ;
...
typedef palinfo_func_t;
@@
 struct {  const char * name ;  palinfo_func_t proc_read ;  struct proc_dir_entry * entry ; } cocci_id@p ;
...
position p;
@@
 struct rid_reg {  unsigned long ig1 : 1 ;  unsigned long rv1 : 1 ;  unsigned long ig2 : 6 ;  unsigned long rid : 24 ;  unsigned long rv2 : 32 ; } * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_tr_valid_u_t;
@@
 pal_tr_valid_u_t cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct seq_file * ) ;
...
symbol cocci_id;
position p;
typedef palinfo_entry_t;
@@
 const palinfo_entry_t cocci_id@p [ ] ;
...
position p;
@@
 const char * const * const cocci_id@p [ ] ;
...
position p;
@@
 struct ifa_reg {  unsigned long valid : 1 ;  unsigned long ig : 11 ;  unsigned long vpn : 52 ; } * cocci_id@p ;
