...
typedef spinlock_t;
@@
 struct dummy_systimer_pcm {  const struct dummy_timer_ops * timer_ops ;  spinlock_t lock ;  struct timer_list timer ;  unsigned long base_time ;  unsigned int frac_pos ;  unsigned int frac_period_rest ;  unsigned int frac_buffer_size ;  unsigned int frac_period_size ;  unsigned int rate ;  int elapsed ;  struct snd_pcm_substream * substream ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct snd_dummy {  struct snd_card * card ;  struct dummy_model * model ;  struct snd_pcm * pcm ;  struct snd_pcm_hardware pcm_hw ;  spinlock_t mixer_lock ;  int mixer_volume [ MIXER_ADDR_LAST + 1 ] [ 2 ] ;  int capture_source [ MIXER_ADDR_LAST + 1 ] [ 2 ] ;  int iobox ;  struct snd_kcontrol * cd_volume_ctl ;  struct snd_kcontrol * cd_switch_ctl ; } cocci_id@p ;
...
position p;
@@
 struct dummy_hw_field {  const char * name ;  const char * format ;  unsigned int offset ;  unsigned int size ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef atomic_t,ktime_t;
@@
 struct dummy_hrtimer_pcm {  const struct dummy_timer_ops * timer_ops ;  ktime_t base_time ;  ktime_t period_time ;  atomic_t running ;  struct hrtimer timer ;  struct snd_pcm_substream * substream ; } cocci_id@p ;
...
@@
 struct dummy_timer_ops {  int ( * create ) ( struct snd_pcm_substream * ) ;  void ( * free ) ( struct snd_pcm_substream * ) ;  int ( * prepare ) ( struct snd_pcm_substream * ) ;  int ( * start ) ( struct snd_pcm_substream * ) ;  int ( * stop ) ( struct snd_pcm_substream * ) ;  snd_pcm_uframes_t ( * pointer ) ( struct snd_pcm_substream * ) ; } cocci_id@p ;
...
position p;
@@
 struct dummy_hrtimer_pcm cocci_id@p ;
...
position p;
@@
 const struct dummy_timer_ops cocci_id@p ;
...
typedef u64;
@@
 struct dummy_model {  const char * name ;  int ( * playback_constraints ) ( struct snd_pcm_runtime * runtime ) ;  int ( * capture_constraints ) ( struct snd_pcm_runtime * runtime ) ;  u64 formats ;  size_t buffer_bytes_max ;  size_t period_bytes_min ;  size_t period_bytes_max ;  unsigned int periods_min ;  unsigned int periods_max ;  unsigned int rates ;  unsigned int rate_min ;  unsigned int rate_max ;  unsigned int channels_min ;  unsigned int channels_max ; } cocci_id@p ;
...
position p;
@@
 struct snd_pcm_hardware cocci_id@p ;
...
position p;
@@
 struct dummy_systimer_pcm * cocci_id@p ;
...
position p;
@@
 struct dummy_hw_field cocci_id@p [ ] ;
