...
position p;
@@
 struct mlx5e_tls_offload_context_tx * cocci_id@p ;
...
position p;
@@
 struct mlx5e_tls_metadata cocci_id@p ;
...
@@
 struct sync_info {  u64 rcd_sn ;  s32 sync_len ;  int nr_frags ;  skb_frag_t frags [ MAX_SKB_FRAGS ] ; } cocci_id@p ;
