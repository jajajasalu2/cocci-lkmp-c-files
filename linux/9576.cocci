...
position p;
@@
 struct rtw_iter_bitrate_mask_data cocci_id@p ;
...
position p;
@@
 struct rtw_sec_desc * cocci_id@p ;
...
position p;
@@
 const struct rtw_vif_port cocci_id@p [ ] ;
...
position p;
@@
 struct rtw_iter_bitrate_mask_data {  struct rtw_dev * rtwdev ;  struct ieee80211_vif * vif ;  const struct cfg80211_bitrate_mask * mask ; } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ IEEE80211_NUM_ACS ] ;
