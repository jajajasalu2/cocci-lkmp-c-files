...
typedef u8,u32;
@@
 struct nft_osf {  enum nft_registers dreg : 8 ;  u8 ttl ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 const struct nft_osf * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_OSF_MAX + 1 ] ;
...
position p;
@@
 char cocci_id@p [ NFT_OSF_MAXGENRELEN + 1 ] ;
