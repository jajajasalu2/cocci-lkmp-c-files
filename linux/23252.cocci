...
position p;
@@
 struct aic31xx_disable_nb cocci_id@p ;
...
position p;
@@
 struct aic31xx_priv * cocci_id@p ;
...
position p;
@@
 struct aic31xx_disable_nb {  struct notifier_block nb ;  struct aic31xx_priv * aic31xx ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct aic31xx_rate_divs {  u32 mclk_p ;  u32 rate ;  u8 pll_j ;  u16 pll_d ;  u16 dosr ;  u8 ndac ;  u8 mdac ;  u8 aosr ;  u8 nadc ;  u8 madc ; } cocci_id@p ;
...
position p;
@@
 const struct aic31xx_rate_divs cocci_id@p [ ] ;
...
typedef u8,bool;
@@
 struct aic31xx_priv {  struct snd_soc_component * component ;  u8 i2c_regs_status ;  struct device * dev ;  struct regmap * regmap ;  enum aic31xx_type codec_type ;  struct gpio_desc * gpio_reset ;  int micbias_vg ;  struct aic31xx_pdata pdata ;  struct regulator_bulk_data supplies [ AIC31XX_NUM_SUPPLIES ] ;  struct aic31xx_disable_nb disable_nb [ AIC31XX_NUM_SUPPLIES ] ;  struct snd_soc_jack * jack ;  unsigned int sysclk ;  u8 p_div ;  int rate_div_line ;  bool master_dapm_route_applied ;  int irq ;  u8 ocmv ; } cocci_id@p ;
