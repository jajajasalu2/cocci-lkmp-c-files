...
position p;
@@
 struct vega20_dpm_state * cocci_id@p ;
...
position p;
@@
 struct vega20_od8_settings * cocci_id@p ;
...
position p;
@@
 struct vega20_dpm_table cocci_id@p ;
...
position p;
@@
 struct atom_smc_dpm_info_v4_4 * cocci_id@p ;
...
position p;
@@
 struct vega20_single_dpm_table * cocci_id@p ;
...
position p;
@@
 struct smu_power_state cocci_id@p ;
...
position p;
@@
 ATOM_Vega20_POWERPLAYTABLE * cocci_id@p ;
