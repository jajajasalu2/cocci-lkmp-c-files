...
position p;
@@
 struct led_pwm_priv * cocci_id@p ;
...
position p;
@@
 struct led_pwm_data * cocci_id@p ;
...
position p;
@@
 struct led_pwm_data {  struct led_classdev cdev ;  struct pwm_device * pwm ;  unsigned int active_low ;  unsigned int period ;  int duty ; } cocci_id@p ;
...
position p;
@@
 struct led_pwm_priv {  int num_leds ;  struct led_pwm_data leds [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct led_pwm_platform_data * cocci_id@p ;
