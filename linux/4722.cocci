...
position p;
@@
 struct xpc_interface cocci_id@p ;
...
position p;
@@
 enum xp_retval ( * cocci_id@p ) ( unsigned long phys_addr , unsigned long size ) ;
...
position p;
@@
 enum xp_retval ( * cocci_id@p ) ( short , void * ) ;
...
position p;
@@
 struct xpc_registration cocci_id@p [ XPC_MAX_NCHANNELS ] ;
...
position p;
@@
 unsigned long ( * cocci_id@p ) ( void * addr ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( short , int , void * ) ;
...
position p;
@@
 struct xpc_registration * cocci_id@p ;
...
typedef u32,u16;
@@
 enum xp_retval ( * cocci_id@p ) ( short , int , u32 , void * , u16 ) ;
...
typedef u32,u16;
@@
 enum xp_retval ( * cocci_id@p ) ( short , int , u32 , void * , u16 , xpc_notify_func , void * ) ;
...
position p;
@@
 unsigned long ( * cocci_id@p ) ( unsigned long gpa ) ;
