...
position p;
@@
 struct qlcnic_fw_msg * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qlcnic_host_sds_ring * sds_ring , int max ) ;
...
position p;
@@
 struct qlcnic_rx_buffer * cocci_id@p ;
...
typedef u16;
@@
 struct sk_buff * cocci_id@p ( struct qlcnic_adapter * , struct qlcnic_host_rds_ring * , u16 , u16 ) ;
...
position p;
@@
 struct qlcnic_skb_frag * cocci_id@p ;
