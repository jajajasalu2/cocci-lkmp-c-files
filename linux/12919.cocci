...
position p;
@@
 struct host_bsq_entry * cocci_id@p ;
...
position p;
@@
 const struct linux_prom_registers * cocci_id@p ;
...
position p;
@@
 struct host_txq_entry * cocci_id@p ;
...
position p;
@@
 struct host_cmdq_entry * cocci_id@p ;
...
position p;
@@
 const struct fore200e_bus cocci_id@p ;
...
position p;
@@
 struct fore200e_vcc cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ BUFFER_SCHEME_NBR ] [ BUFFER_MAGN_NBR ] ;
...
position p;
@@
 struct fore200e_vc_map * cocci_id@p ;
...
position p;
@@
 struct stats_opcode cocci_id@p ;
...
position p;
@@
 const struct fw_header * cocci_id@p ;
...
position p;
@@
 struct deactivate_opcode cocci_id@p ;
...
position p;
@@
 struct activate_opcode cocci_id@p ;
...
position p;
@@
 struct host_rxq_entry * cocci_id@p ;
