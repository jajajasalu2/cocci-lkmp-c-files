...
position p;
@@
 enum addr_type { ADDR_TYPE_LOCAL , ADDR_TYPE_REMOTE , ADDR_TYPE_MCAST , ADDR_TYPE_EXPECTED_LOCAL , ADDR_TYPE_EXPECTED_REMOTE , } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ sizeof ( struct sockaddr_in6 ) ] ;
