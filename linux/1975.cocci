...
position p;
@@
 struct ad8801_state * cocci_id@p ;
...
position p;
@@
 enum ad8801_device_ids { ID_AD8801 , ID_AD8803 , } cocci_id@p ;
...
position p;
@@
 struct ad8801_state {  struct spi_device * spi ;  unsigned char dac_cache [ 8 ] ;  unsigned int vrefh_mv ;  unsigned int vrefl_mv ;  struct regulator * vrefh_reg ;  struct regulator * vrefl_reg ;  __be16 data ____cacheline_aligned ; } cocci_id@p ;
