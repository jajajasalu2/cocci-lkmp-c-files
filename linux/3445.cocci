...
position p;
@@
 struct adb_regs {  struct preg intr ;  struct preg data [ 9 ] ;  struct preg intr_enb ;  struct preg dcount ;  struct preg error ;  struct preg ctrl ;  struct preg autopoll ;  struct preg active_hi ;  struct preg active_lo ;  struct preg test ; } cocci_id@p ;
...
position p;
@@
 struct preg {  unsigned char r ;  char pad [ 15 ] ; } cocci_id@p ;
