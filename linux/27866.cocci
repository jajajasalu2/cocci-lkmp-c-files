...
position p;
@@
 struct inode * cocci_id@p ( struct super_block * , unsigned long ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , const char * in , int in_len , char * * out , int * out_len ) ;
...
position p;
@@
 enum { Opt_uid , Opt_gid , Opt_charset , Opt_debug , Opt_err , } cocci_id@p ;
...
position p;
@@
 struct dentry * cocci_id@p ( struct super_block * sb , struct fid * fid , int fh_len , int fh_type ) ;
...
position p;
@@
 int cocci_id@p ( struct file * , struct dir_context * ) ;
...
position p;
@@
 int cocci_id@p ( struct file * , struct page * ) ;
...
position p;
@@
 int cocci_id@p ( char * , struct befs_mount_options * ) ;
...
position p;
@@
 struct befs_mount_options * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BEFS_NAME_LEN + 1 ] ;
...
position p;
@@
 const befs_data_stream * cocci_id@p ;
...
position p;
@@
 struct dentry * cocci_id@p ( struct inode * , struct dentry * , unsigned int ) ;
...
position p;
@@
 int cocci_id@p ( struct file * file , struct page * page ) ;
...
position p;
@@
 struct befs_inode_info cocci_id@p ;
...
position p;
@@
 struct befs_sb_info * cocci_id@p ;
...
position p;
@@
 struct dentry * cocci_id@p ( struct dentry * child ) ;
