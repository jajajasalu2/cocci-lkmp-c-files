...
position p;
@@
 unsigned long cocci_id@p ( struct s_smc * smc , void * virt ) ;
...
position p;
@@
 unsigned long cocci_id@p ( struct s_smc * smc , void * virt , int len , int flag ) ;
...
position p;
@@
 void cocci_id@p ( unsigned char * frame , unsigned char * hw_addr ) ;
...
typedef u_int;
@@
 void * cocci_id@p ( struct s_smc * smc , u_int size ) ;
...
position p;
@@
 struct s_skfp_ioctl cocci_id@p ;
...
typedef u_short;
@@
 void cocci_id@p ( struct s_smc * smc , u_short queue ) ;
...
position p;
@@
 void cocci_id@p ( unsigned char * Data , int length ) ;
