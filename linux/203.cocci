...
position p;
@@
 struct _kdbmsg {  int km_diag ;  char * km_msg ; } cocci_id@p ;
...
typedef u64;
@@
 union {  u64 word ;  unsigned char c [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ KDB_ENVBUFSIZE ] ;
...
typedef kdbtab_t;
@@
 kdbtab_t cocci_id@p [ KDB_BASE_CMD_MAX ] ;
...
symbol cocci_id;
position p;
typedef kdb_cmdflags_t;
@@
 kdb_cmdflags_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kdb_reason_t;
@@
 kdb_reason_t cocci_id@p ;
...
typedef bool;
@@
 struct defcmd_set {  int count ;  bool usable ;  char * name ;  char * usage ;  char * help ;  char * * command ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ KDB_CMD_HISTORY_COUNT ] [ CMD_BUFLEN ] ;
...
position p;
@@
 char cocci_id@p [ KDB_GREP_STRLEN ] ;
...
symbol cocci_id;
position p;
typedef kdb_dbtrap_t;
@@
 kdb_dbtrap_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kdb_symtab_t;
@@
 kdb_symtab_t cocci_id@p ;
