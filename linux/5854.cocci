...
position p;
@@
 const struct pinmux_drive_reg * cocci_id@p ;
...
typedef bool;
@@
 struct sh_pfc_pin_config {  unsigned int mux_mark ;  bool mux_set ;  bool gpio_enabled ; } cocci_id@p ;
...
position p;
@@
 const struct sh_pfc_pin_group * cocci_id@p ;
...
position p;
@@
 struct sh_pfc_pin_config * cocci_id@p ;
...
position p;
@@
 struct sh_pfc_pinctrl {  struct pinctrl_dev * pctl ;  struct pinctrl_desc pctl_desc ;  struct sh_pfc * pfc ;  struct pinctrl_pin_desc * pins ;  struct sh_pfc_pin_config * configs ;  const char * func_prop_name ;  const char * groups_prop_name ;  const char * pins_prop_name ; } cocci_id@p ;
...
position p;
@@
 const struct pinmux_drive_reg_field * cocci_id@p ;
...
position p;
@@
 struct sh_pfc_pinctrl * cocci_id@p ;
