...
position p;
@@
 struct ad7923_chip_info {  const struct iio_chan_spec * channels ;  unsigned int num_channels ; } cocci_id@p ;
...
position p;
@@
 const struct ad7923_chip_info * cocci_id@p ;
...
position p;
@@
 struct ad7923_state * cocci_id@p ;
...
position p;
@@
 enum ad7923_id { AD7904 , AD7914 , AD7924 , } cocci_id@p ;
...
position p;
@@
 struct ad7923_state {  struct spi_device * spi ;  struct spi_transfer ring_xfer [ 5 ] ;  struct spi_transfer scan_single_xfer [ 2 ] ;  struct spi_message ring_msg ;  struct spi_message scan_single_msg ;  struct regulator * reg ;  unsigned int settings ;  __be16 rx_buf [ 4 ] ____cacheline_aligned ;  __be16 tx_buf [ 4 ] ; } cocci_id@p ;
