...
position p;
@@
 struct pkcs7_parse_context * cocci_id@p ;
...
position p;
@@
 struct pkcs7_message cocci_id@p ;
...
position p;
@@
 const struct pkcs7_message * cocci_id@p ;
...
position p;
@@
 struct pkcs7_signed_info cocci_id@p ;
...
typedef bool;
@@
 struct pkcs7_parse_context {  struct pkcs7_message * msg ;  struct pkcs7_signed_info * sinfo ;  struct pkcs7_signed_info * * ppsinfo ;  struct x509_certificate * certs ;  struct x509_certificate * * ppcerts ;  unsigned long data ;  enum OID last_oid ;  unsigned x509_index ;  unsigned sinfo_index ;  const void * raw_serial ;  unsigned raw_serial_size ;  unsigned raw_issuer_size ;  const void * raw_issuer ;  const void * raw_skid ;  unsigned raw_skid_size ;  bool expect_skid ; } cocci_id@p ;
...
position p;
@@
 struct x509_certificate * cocci_id@p ;
