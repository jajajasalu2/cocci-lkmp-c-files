...
position p;
@@
 void ( * cocci_id@p ) ( void * ( * fn ) ( void * ) , void * arg , unsigned long cpu ) ;
...
position p;
@@
 struct actions {  void ( * setup ) ( int , int ) ;  void * ( * thread1 ) ( void * ) ;  void * ( * thread2 ) ( void * ) ; } cocci_id@p ;
