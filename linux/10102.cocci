...
position p;
@@
 struct i2400m_barker_db * cocci_id@p ;
...
position p;
@@
 const struct i2400m_bcf_hdr * * cocci_id@p ;
...
position p;
@@
 struct i2400m_bootrom_header * cocci_id@p ;
...
typedef __le32;
@@
 struct i2400m_barker_db {  __le32 data [ 4 ] ; } * cocci_id@p ;
...
position p;
@@
 const struct i2400m_bootrom_header * cocci_id@p ;
...
position p;
@@
 struct i2400m_fw {  struct kref kref ;  const struct firmware * fw ; } cocci_id@p ;
