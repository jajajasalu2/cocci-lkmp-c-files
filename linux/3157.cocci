...
position p;
@@
 enum { IDX_TEMP1_INPUT = 0 , IDX_TEMP1_MIN , IDX_TEMP1_MAX , IDX_TEMP1_CRIT , IDX_TEMP2_INPUT , IDX_TEMP2_MIN , IDX_TEMP2_MAX , IDX_TEMP2_CRIT , TEMP_IDX_LEN , } cocci_id@p ;
...
position p;
@@
 struct amc6821_data * cocci_id@p ;
...
position p;
@@
 enum { IDX_FAN1_INPUT = 0 , IDX_FAN1_MIN , IDX_FAN1_MAX , FAN1_IDX_LEN , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct amc6821_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  int temp [ TEMP_IDX_LEN ] ;  u16 fan [ FAN1_IDX_LEN ] ;  u8 fan1_div ;  u8 pwm1 ;  u8 temp1_auto_point_temp [ 3 ] ;  u8 temp2_auto_point_temp [ 3 ] ;  u8 pwm1_auto_point_pwm [ 3 ] ;  u8 pwm1_enable ;  u8 pwm1_auto_channels_temp ;  u8 stat1 ;  u8 stat2 ; } cocci_id@p ;
