...
position p;
@@
 struct imgu_vb2_buffer cocci_id@p ;
...
position p;
@@
 struct imgu_video_device * cocci_id@p ;
...
position p;
@@
 const struct imgu_fmt cocci_id@p [ ] ;
...
position p;
@@
 const struct imgu_meta_fmt cocci_id@p [ ] ;
...
position p;
@@
 struct v4l2_subdev_internal_ops cocci_id@p ;
...
position p;
@@
 struct imgu_media_pipe * cocci_id@p ;
...
typedef __u32;
@@
 struct imgu_meta_fmt {  __u32 fourcc ;  char * name ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct imgu_fmt {  u32 fourcc ;  u16 type ; } cocci_id@p ;
...
position p;
@@
 struct imgu_v4l2_subdev cocci_id@p ;
