...
position p;
@@
 enum { STRICT , LEGACY , STD2008 , RELAXED , } cocci_id@p ;
...
position p;
@@
 enum ftlb_flags { FTLB_EN = 1 << 0 , FTLB_SET_PROB = 1 << 1 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cpuinfo_mips * c , enum ftlb_flags flags ) ;
