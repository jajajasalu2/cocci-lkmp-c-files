...
symbol cocci_id;
position p;
typedef u8,s16,s32,bool,dma_addr_t;
@@
 struct malidp_mw_connector_state {  struct drm_connector_state base ;  dma_addr_t addrs [ 2 ] ;  s32 pitches [ 2 ] ;  u8 format ;  u8 n_planes ;  bool rgb2yuv_initialized ;  const s16 * rgb2yuv_coeffs ; } cocci_id@p ;
...
typedef s16;
@@
 const s16 cocci_id@p [ MALIDP_COLORADJ_NUM_COEFFS ] ;
...
position p;
@@
 struct malidp_mw_connector_state * cocci_id@p ;
...
position p;
@@
 struct malidp_hw_device * cocci_id@p ;
