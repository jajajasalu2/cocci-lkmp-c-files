...
position p;
@@
 enum dwc3_omap_utmi_mode { DWC3_OMAP_UTMI_MODE_UNKNOWN = 0 , DWC3_OMAP_UTMI_MODE_HW , DWC3_OMAP_UTMI_MODE_SW , } cocci_id@p ;
...
position p;
@@
 enum omap_dwc3_vbus_id_status cocci_id@p ;
...
typedef u32;
@@
 struct dwc3_omap {  struct device * dev ;  int irq ;  void __iomem * base ;  u32 utmi_otg_ctrl ;  u32 utmi_otg_offset ;  u32 irqmisc_offset ;  u32 irq_eoi_offset ;  u32 debug_offset ;  u32 irq0_offset ;  struct extcon_dev * edev ;  struct notifier_block vbus_nb ;  struct notifier_block id_nb ;  struct regulator * vbus_reg ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dwc3_omap * omap ) ;
...
position p;
@@
 enum omap_dwc3_vbus_id_status { OMAP_DWC3_ID_FLOAT , OMAP_DWC3_ID_GROUND , OMAP_DWC3_VBUS_OFF , OMAP_DWC3_VBUS_VALID , } cocci_id@p ;
