...
position p;
@@
 struct thunderx_line cocci_id@p ;
...
position p;
@@
 struct thunderx_line {  struct thunderx_gpio * txgpio ;  unsigned int line ;  unsigned int fil_bits ; } cocci_id@p ;
...
position p;
@@
 struct thunderx_gpio * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,raw_spinlock_t;
@@
 struct thunderx_gpio {  struct gpio_chip chip ;  u8 __iomem * register_base ;  struct msix_entry * msix_entries ;  struct thunderx_line * line_entries ;  raw_spinlock_t lock ;  unsigned long invert_mask [ 2 ] ;  unsigned long od_mask [ 2 ] ;  int base_msi ; } cocci_id@p ;
