...
position p;
@@
 struct writequeue_entry * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct connection * c ) ;
...
position p;
@@
 struct sockaddr_storage * cocci_id@p [ DLM_MAX_ADDR_COUNT ] ;
...
position p;
@@
 struct dlm_node_addr * cocci_id@p ;
...
position p;
@@
 struct writequeue_entry {  struct list_head list ;  struct page * page ;  int offset ;  int len ;  int end ;  int users ;  struct connection * con ; } cocci_id@p ;
...
position p;
@@
 struct listen_sock_callbacks {  void ( * sk_error_report ) ( struct sock * ) ;  void ( * sk_data_ready ) ( struct sock * ) ;  void ( * sk_state_change ) ( struct sock * ) ;  void ( * sk_write_space ) ( struct sock * ) ; } cocci_id@p ;
...
position p;
@@
 struct cbuf {  unsigned int base ;  unsigned int len ;  unsigned int mask ; } cocci_id@p ;
...
position p;
@@
 struct dlm_node_addr {  struct list_head list ;  int nodeid ;  int addr_count ;  int curr_addr_index ;  struct sockaddr_storage * addr [ DLM_MAX_ADDR_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct hlist_head cocci_id@p [ CONN_HASH_SIZE ] ;
