...
position p;
@@
 struct rpr0521_samp_freq {  int als_hz ;  int als_uhz ;  int pxs_hz ;  int pxs_uhz ; } cocci_id@p ;
...
position p;
@@
 const struct rpr0521_gain cocci_id@p [ 3 ] ;
...
typedef u8;
@@
 const struct rpr0521_gain_info {  u8 reg ;  u8 mask ;  u8 shift ;  const struct rpr0521_gain * gain ;  int size ; } cocci_id@p [ ] ;
...
position p;
@@
 struct rpr0521_gain {  int scale ;  int uscale ; } cocci_id@p ;
...
position p;
@@
 const struct rpr0521_reg_desc cocci_id@p [ ] ;
...
position p;
@@
 struct rpr0521_data * cocci_id@p ;
...
position p;
@@
 enum rpr0521_scan_index_order { RPR0521_CHAN_INDEX_PXS , RPR0521_CHAN_INDEX_BOTH , RPR0521_CHAN_INDEX_IR , } cocci_id@p ;
...
position p;
@@
 const struct rpr0521_gain cocci_id@p [ 4 ] ;
...
typedef bool,s64;
@@
 struct rpr0521_data {  struct i2c_client * client ;  struct mutex lock ;  bool als_dev_en ;  bool pxs_dev_en ;  struct iio_trigger * drdy_trigger0 ;  s64 irq_timestamp ;  bool als_ps_need_en ;  bool pxs_ps_need_en ;  bool als_need_dis ;  bool pxs_need_dis ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 const struct rpr0521_samp_freq cocci_id@p [ 13 ] ;
...
position p;
@@
 enum rpr0521_channel { RPR0521_CHAN_PXS , RPR0521_CHAN_ALS_DATA0 , RPR0521_CHAN_ALS_DATA1 , } cocci_id@p ;
...
typedef u8;
@@
 struct rpr0521_reg_desc {  u8 address ;  u8 device_mask ; } cocci_id@p ;
