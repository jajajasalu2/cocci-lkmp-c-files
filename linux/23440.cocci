...
position p;
@@
 const  cocci_id@p ( in_adc_tlv , 
							    0x00 , 0xef , 
							    SNDRV_CTL_TLVD_DB_SCALE_ITEM ( - 71625 , 375 , 1 ) , 
							    0xf0 , 0xff , 
							    SNDRV_CTL_TLVD_DB_SCALE_ITEM ( 17625 , 0 , 0 ) ) ;
...
position p;
@@
 const  cocci_id@p ( out_sidetone_tlv , 
							    0x00 , 0x0c , 
							    SNDRV_CTL_TLVD_DB_SCALE_ITEM ( - 3600 , 300 , 0 ) , 
							    0x0d , 0x0f , 
							    SNDRV_CTL_TLVD_DB_SCALE_ITEM ( 0 , 0 , 0 ) ) ;
...
position p;
@@
 const  cocci_id@p ( out_pga_tlv , 
							    0x00 , 0x2f , 
							    SNDRV_CTL_TLVD_DB_SCALE_ITEM ( SNDRV_CTL_TLVD_DB_GAIN_MUTE , 0 , 1 ) , 
							    0x30 , 0x7f , 
							    SNDRV_CTL_TLVD_DB_SCALE_ITEM ( - 7300 , 100 , 0 ) ) ;
...
typedef u32;
@@
 struct _pll_div {  u32 div2 ;  u32 n ;  u32 k ; } cocci_id@p ;
...
position p;
@@
 struct wm8991_priv {  struct regmap * regmap ;  unsigned int pcmclk ; } cocci_id@p ;
