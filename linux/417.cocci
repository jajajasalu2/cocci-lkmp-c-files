...
typedef u32;
@@
 struct vgic_state_iter {  int nr_cpus ;  int nr_spis ;  int nr_lpis ;  int dist_id ;  int vcpu_id ;  int intid ;  int lpi_idx ;  u32 * lpi_array ; } cocci_id@p ;
...
position p;
@@
 struct vgic_state_iter * cocci_id@p ;
