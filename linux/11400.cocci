...
position p;
@@
 struct drm_vmw_context_arg * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXBindContext body ; } * cocci_id@p ;
...
position p;
@@
 union drm_vmw_extended_context_arg * cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_binding_state * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDefineContext body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdReadbackGBContext body ; } * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct vmw_user_context {  struct ttm_base_object base ;  struct vmw_resource res ;  struct vmw_ctx_binding_state * cbs ;  struct vmw_cmdbuf_res_manager * man ;  struct vmw_resource * cotables [ SVGA_COTABLE_DX10_MAX ] ;  spinlock_t cotable_lock ;  struct vmw_buffer_object * dx_query_mob ; } cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdBindGBContext body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_user_context * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXDestroyContext body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDefineGBContext body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXReadbackContext body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDestroyContext body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXDefineContext body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDestroyGBContext body ; } * cocci_id@p ;
