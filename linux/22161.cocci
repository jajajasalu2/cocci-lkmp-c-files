...
position p;
@@
 void cocci_id@p ( struct percpu_ref * percpu_ref ) ;
...
position p;
@@
 struct kmem_cache * cocci_id@p [ NR_KMALLOC_TYPES ] [ KMALLOC_SHIFT_HIGH + 1 ] ;
...
position p;
@@
 enum kmalloc_cache_type cocci_id@p ;
