...
position p;
@@
 struct tsi721_ob_win * cocci_id@p ;
...
position p;
@@
 struct msix_entry cocci_id@p [ TSI721_VECT_MAX ] ;
...
position p;
@@
 struct tsi721_imsg_desc cocci_id@p ;
...
position p;
@@
 struct tsi721_omsg_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tsi721_device * priv , int ch ) ;
...
position p;
@@
 struct tsi721_ib_win * cocci_id@p ;
...
position p;
@@
 struct tsi721_dma_desc * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ TSI721_RIO_PW_MSG_SIZE / sizeof ( u32 ) ] ;
...
typedef u8,u64;
@@
 union {  u64 msg ;  u8 bytes [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct tsi721_dma_sts cocci_id@p ;
...
position p;
@@
 struct tsi721_obw_bar * cocci_id@p ;
...
position p;
@@
 struct tsi721_device cocci_id@p ;
...
position p;
@@
 struct tsi721_ib_win_mapping * cocci_id@p ;
...
position p;
@@
 struct tsi721_bdma_maint * cocci_id@p ;
