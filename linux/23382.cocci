...
position p;
@@
 struct ak4642_drvdata {  const struct regmap_config * regmap_config ;  int extended_frequencies ; } cocci_id@p ;
...
position p;
@@
 const struct ak4642_drvdata * cocci_id@p ;
...
position p;
@@
 struct ak4642_priv {  const struct ak4642_drvdata * drvdata ;  struct clk * mcko ; } cocci_id@p ;
