...
position p;
@@
 struct ep93xx_gpio_bank cocci_id@p [ ] ;
...
position p;
@@
 struct ep93xx_gpio {  void __iomem * base ;  struct gpio_chip gc [ 8 ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct ep93xx_gpio_bank {  const char * label ;  int data ;  int dir ;  int base ;  bool has_irq ;  bool has_hierarchical_irq ;  unsigned int irq_base ; } cocci_id@p ;
