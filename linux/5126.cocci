...
typedef uint8_t;
@@
 struct adp5588_gpio {  struct i2c_client * client ;  struct gpio_chip gpio_chip ;  struct mutex lock ;  struct mutex irq_lock ;  uint8_t dat_out [ 3 ] ;  uint8_t dir [ 3 ] ;  uint8_t int_lvl_low [ 3 ] ;  uint8_t int_lvl_high [ 3 ] ;  uint8_t int_en [ 3 ] ;  uint8_t irq_mask [ 3 ] ;  uint8_t int_input_en [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct adp5588_gpio * cocci_id@p ;
...
position p;
@@
 struct adp5588_gpio_platform_data * cocci_id@p ;
