...
position p;
@@
 struct mips_hi16 {  struct mips_hi16 * next ;  Elf32_Addr * addr ;  Elf32_Addr value ; } cocci_id@p ;
...
position p;
@@
 struct vpe_notifications * cocci_id@p ;
