...
position p;
@@
 struct bw_stats_struct cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint64_t,l2_bad_t,l2_cor_t,uint32_t;
@@
 struct bw_stats_struct {  uint64_t status ;  uint32_t l2_err ;  uint32_t memio_err ;  int status_printed ;  unsigned long l2_cor_d ;  unsigned long l2_bad_d ;  unsigned long l2_cor_t ;  unsigned long l2_bad_t ;  unsigned long mem_cor_d ;  unsigned long mem_bad_d ;  unsigned long bus_error ; } cocci_id@p ;
