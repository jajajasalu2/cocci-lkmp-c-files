...
position p;
@@
 struct radeon_sa_bo cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct radeon_sa_manager * sa_manager ) ;
...
position p;
@@
 struct radeon_sa_manager * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct radeon_sa_bo * sa_bo ) ;
