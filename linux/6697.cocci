...
position p;
@@
 struct ct_sns_gpnft_rsp cocci_id@p ;
...
position p;
@@
 struct ct_fdmi_port_attr * cocci_id@p ;
...
position p;
@@
 struct ct_fdmiv2_hba_attr * cocci_id@p ;
...
position p;
@@
 struct ct_sns_gpn_ft_data * cocci_id@p ;
...
position p;
@@
 struct ct_fdmi_hba_attr * cocci_id@p ;
...
position p;
@@
 struct ct_sns_gid_pt_data * cocci_id@p ;
...
position p;
@@
 struct ct_fdmiv2_port_attr * cocci_id@p ;
