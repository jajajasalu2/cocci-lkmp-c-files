...
position p;
@@
 const struct cmac_statistics * cocci_id@p ;
...
position p;
@@
 const struct board_info * cocci_id@p ;
...
position p;
@@
 const struct espi_intr_counts * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct adapter * adapter , int mode ) ;
...
position p;
@@
 enum { M_CORE_BITS = 9 , T_CORE_VAL = 0 , T_CORE_BITS = 2 , N_CORE_VAL = 0 , N_CORE_BITS = 2 , M_MEM_BITS = 9 , T_MEM_VAL = 0 , T_MEM_BITS = 2 , N_MEM_VAL = 0 , N_MEM_BITS = 2 , NP_LOAD = 1 << 17 , S_LOAD_MEM = 1 << 5 , S_LOAD_CORE = 1 << 6 , S_CLOCK = 1 << 3 , } cocci_id@p ;
...
position p;
@@
 enum { S_CLOCK = 1 << 3 , S_DATA = 1 << 4 , } cocci_id@p ;
...
position p;
@@
 struct mdio_if_info * cocci_id@p ;
