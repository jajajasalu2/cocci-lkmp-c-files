...
position p;
@@
 struct z_erofs_decompressqueue * cocci_id@p [ ] ;
...
position p;
@@
 struct page * cocci_id@p [ Z_EROFS_VMAP_ONSTACK_PAGES ] ;
...
position p;
@@
 struct erofs_sb_info * cocci_id@p ;
...
position p;
@@
 struct erofs_sb_info * const cocci_id@p ;
...
position p;
@@
 struct z_erofs_collection * const cocci_id@p ;
...
position p;
@@
 struct erofs_workgroup * cocci_id@p ;
...
position p;
@@
 struct z_erofs_collector * cocci_id@p ;
...
position p;
@@
 struct erofs_map_blocks * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,erofs_off_t;
@@
 struct z_erofs_decompress_frontend {  struct inode * const inode ;  struct z_erofs_collector clt ;  struct erofs_map_blocks map ;  bool backmost ;  erofs_off_t headoffset ; } cocci_id@p ;
...
position p;
@@
 const struct z_erofs_decompressqueue * cocci_id@p ;
...
position p;
@@
 enum z_erofs_cache_alloctype cocci_id@p ;
...
position p;
@@
 enum z_erofs_cache_alloctype { DONTALLOC , DELAYEDALLOC , } cocci_id@p ;
...
position p;
@@
 struct z_erofs_pcluster cocci_id@p ;
...
symbol cocci_id;
position p;
typedef z_erofs_next_pcluster_t;
@@
 z_erofs_next_pcluster_t cocci_id@p ;
...
typedef z_erofs_next_pcluster_t;
@@
 z_erofs_next_pcluster_t cocci_id@p [ NR_JOBQUEUES ] ;
...
position p;
@@
 struct z_erofs_pagevec_ctor cocci_id@p ;
...
position p;
@@
 enum z_erofs_collectmode { COLLECT_SECONDARY , COLLECT_PRIMARY , COLLECT_PRIMARY_HOOKED , COLLECT_PRIMARY_FOLLOWED_NOINPLACE , COLLECT_PRIMARY_FOLLOWED , } cocci_id@p ;
...
position p;
@@
 enum z_erofs_page_type cocci_id@p ;
...
position p;
@@
 struct erofs_map_blocks * const cocci_id@p ;
...
position p;
@@
 struct z_erofs_decompressqueue * cocci_id@p [ NR_JOBQUEUES ] ;
...
position p;
@@
 struct z_erofs_collection * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compressed_page_t;
@@
 compressed_page_t cocci_id@p ;
...
position p;
@@
 struct z_erofs_pcluster * const cocci_id@p ;
...
position p;
@@
 const struct z_erofs_pcluster * cocci_id@p ;
...
position p;
@@
 struct z_erofs_decompress_req cocci_id@p ;
...
position p;
@@
 enum { JQ_BYPASS , JQ_SUBMIT , NR_JOBQUEUES , } cocci_id@p ;
...
position p;
@@
 struct z_erofs_decompress_frontend cocci_id@p ;
...
typedef z_erofs_next_pcluster_t;
@@
 z_erofs_next_pcluster_t * const cocci_id@p ;
...
position p;
@@
 enum z_erofs_collectmode cocci_id@p ;
...
position p;
@@
 struct z_erofs_collector * const cocci_id@p ;
...
position p;
@@
 struct address_space * const cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p [ Z_EROFS_VMAP_GLOBAL_PAGES ] ;
