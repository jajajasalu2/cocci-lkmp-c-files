...
position p;
@@
 struct tc_prio_qopt cocci_id@p ;
...
position p;
@@
 struct prio_sched_data cocci_id@p ;
...
position p;
@@
 struct Qdisc * cocci_id@p [ TCQ_PRIO_BANDS ] ;
...
typedef u8;
@@
 struct prio_sched_data {  int bands ;  struct tcf_proto __rcu * filter_list ;  struct tcf_block * block ;  u8 prio2band [ TC_PRIO_MAX + 1 ] ;  struct Qdisc * queues [ TCQ_PRIO_BANDS ] ; } cocci_id@p ;
