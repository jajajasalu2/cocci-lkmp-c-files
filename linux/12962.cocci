...
position p;
@@
 struct knav_dma_pool_device * cocci_id@p ;
...
position p;
@@
 struct reg_tx_sched cocci_id@p ;
...
typedef u32;
@@
 struct reg_rx_flow {  u32 control ;  u32 tags ;  u32 tag_sel ;  u32 fdq_sel [ 2 ] ;  u32 thresh [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct knav_dma_pool_device {  struct device * dev ;  struct list_head list ; } cocci_id@p ;
...
typedef u32;
@@
 struct reg_chan {  u32 control ;  u32 mode ;  u32 __rsvd [ 6 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct reg_tx_sched {  u32 prio ; } cocci_id@p ;
...
position p;
@@
 struct knav_dma_chan * cocci_id@p ;
...
typedef u32;
@@
 struct reg_global {  u32 revision ;  u32 perf_control ;  u32 emulation_control ;  u32 priority_control ;  u32 qm_base_address [ DMA_MAX_QMS ] ; } cocci_id@p ;
...
position p;
@@
 struct knav_dma_device * cocci_id@p ;
