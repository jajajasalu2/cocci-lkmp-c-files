...
position p;
@@
 struct ieee80211_fragment_entry * cocci_id@p ;
...
position p;
@@
 struct ieee80211_radiotap_he_mu cocci_id@p ;
...
position p;
@@
 ieee80211_rx_result cocci_id@p ;
...
position p;
@@
 ieee80211_rx_result debug_noinline cocci_id@p ;
...
position p;
@@
 struct ieee80211_fast_rx * cocci_id@p ;
...
position p;
@@
 struct ieee80211_tdls_data cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 snap [ sizeof ( rfc1042_header ) ] ;  __be16 proto ; } * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IEEE80211_CCMP_PN_LEN ] ;
...
position p;
@@
 struct ieee80211_sta_rx_stats * cocci_id@p ;
...
position p;
@@
 struct ieee80211_bar * cocci_id@p ;
...
position p;
@@
 struct ieee80211_radiotap_lsig * cocci_id@p ;
...
position p;
@@
 struct tid_ampdu_rx * cocci_id@p ;
...
position p;
@@
 struct ieee80211_radiotap_he * cocci_id@p ;
...
position p;
@@
 struct ieee80211_mmie * cocci_id@p ;
...
position p;
@@
 struct ieee80211_rx_data cocci_id@p ;
...
position p;
@@
 struct ieee80211_mmie_16 * cocci_id@p ;
...
position p;
@@
 struct ieee80211s_hdr * cocci_id@p ;
