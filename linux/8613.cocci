...
position p;
@@
 struct ice_pkg_enum * cocci_id@p ;
...
position p;
@@
 struct ice_ptg_ptype * cocci_id@p ;
...
position p;
@@
 struct ice_generic_seg_hdr * cocci_id@p ;
...
position p;
@@
 struct ice_prof_id_section * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_download_pkg_resp * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ ICE_BLK_COUNT ] [ ICE_SID_OFF_COUNT ] ;
...
position p;
@@
 struct ice_aqc_download_pkg * cocci_id@p ;
...
position p;
@@
 struct ice_prof_tcam * cocci_id@p ;
...
position p;
@@
 struct ice_vsig_vsi * * cocci_id@p ;
...
position p;
@@
 struct ice_xlt1_section * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ICE_PKG_FLAG_COUNT + 1 ] ;
...
position p;
@@
 struct ice_global_metadata_seg * cocci_id@p ;
...
position p;
@@
 struct ice_nvm_table * cocci_id@p ;
...
typedef u8,u16;
@@
 struct ice_blk_size_details {  u16 xlt1 ;  u16 xlt2 ;  u16 prof_tcam ;  u16 prof_id ;  u8 prof_cdid_bits ;  u16 prof_redir ;  u16 es ;  u16 fvw ;  u8 overwrite ;  u8 reverse ; } cocci_id@p ;
...
position p;
@@
 enum ice_sid_all { ICE_SID_XLT1_OFF = 0 , ICE_SID_XLT2_OFF , ICE_SID_PR_OFF , ICE_SID_PR_REDIR_OFF , ICE_SID_ES_OFF , ICE_SID_OFF_COUNT , } cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_pkg_info_resp * cocci_id@p ;
...
position p;
@@
 struct ice_xlt2_section * cocci_id@p ;
...
position p;
@@
 struct ice_buf_table * cocci_id@p ;
...
position p;
@@
 struct ice_sw_fv_section * cocci_id@p ;
...
position p;
@@
 const struct ice_blk_size_details cocci_id@p [ ICE_BLK_COUNT ] ;
...
position p;
@@
 struct ice_prof_redir * cocci_id@p ;
...
position p;
@@
 struct ice_prof_redir_section * cocci_id@p ;
