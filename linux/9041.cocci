...
position p;
@@
 enum { MLX5_HV_VHCA_STATS_VERSION = 1 , MLX5_HV_VHCA_STATS_UPDATE_ONCE = 0xFFFF , } cocci_id@p ;
...
position p;
@@
 struct mlx5e_hv_vhca_stats_agent * cocci_id@p ;
...
position p;
@@
 struct mlx5e_hv_vhca_per_ring_stats cocci_id@p ;
...
typedef u64;
@@
 struct mlx5e_hv_vhca_per_ring_stats {  u64 rx_packets ;  u64 rx_bytes ;  u64 tx_packets ;  u64 tx_bytes ; } cocci_id@p ;
