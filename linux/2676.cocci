...
typedef u8;
@@
 struct riic_dev {  void __iomem * base ;  u8 * buf ;  struct i2c_msg * msg ;  int bytes_left ;  int err ;  int is_last ;  struct completion msg_done ;  struct i2c_adapter adapter ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 struct riic_irq_desc cocci_id@p [ ] ;
...
@@
 struct riic_irq_desc {  int res_num ;  irq_handler_t isr ;  char * name ; } cocci_id@p ;
