...
position p;
@@
 int cocci_id@p ( struct amdgpu_device * adev , struct amdgpu_cu_info * cu_info ) ;
...
position p;
@@
 const struct common_firmware_header * cocci_id@p ;
...
position p;
@@
 const struct ras_gfx_subblock cocci_id@p [ ] ;
...
position p;
@@
 const struct rlc_firmware_header_v2_0 * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct amdgpu_ring * ring ) ;
...
position p;
@@
 enum drm_sched_priority cocci_id@p ;
...
position p;
@@
 const struct rlc_firmware_header_v2_1 * cocci_id@p ;
...
position p;
@@
 const struct nbio_hdp_flush_reg * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct amdgpu_device * adev , u32 se_num , u32 sh_num , u32 instance ) ;
...
position p;
@@
 const struct soc15_reg_entry cocci_id@p [ ] ;
...
position p;
@@
 struct v9_ce_ib_state cocci_id@p ;
...
position p;
@@
 const struct soc15_reg_golden cocci_id@p [ ] ;
...
position p;
@@
 const struct cs_section_def * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct amdgpu_device * adev , void * inject_if ) ;
...
position p;
@@
 struct ras_gfx_subblock {  unsigned char * name ;  int ta_subblock ;  int hw_supported_error_type ;  int sw_supported_error_type ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct ras_gfx_subblock_reg {  const char * name ;  uint32_t hwip ;  uint32_t inst ;  uint32_t seg ;  uint32_t reg_offset ;  uint32_t sec_count_mask ;  uint32_t sec_count_shift ;  uint32_t ded_count_mask ;  uint32_t ded_count_shift ; } cocci_id@p ;
...
position p;
@@
 enum amdgpu_interrupt_state cocci_id@p ;
...
position p;
@@
 const struct cs_extent_def * cocci_id@p ;
...
position p;
@@
 const struct amdgpu_rlc_funcs cocci_id@p ;
...
position p;
@@
 struct v9_gfx_meta_data cocci_id@p ;
...
position p;
@@
 struct v9_de_ib_state cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct amdgpu_device * adev , void * ras_error_status ) ;
...
position p;
@@
 const struct ras_gfx_subblock_reg cocci_id@p [ ] ;
...
position p;
@@
 struct v9_mqd_allocation * cocci_id@p ;
...
position p;
@@
 const struct amdgpu_gfx_funcs cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct amdgpu_ring * ring ) ;
...
position p;
@@
 struct ta_ras_trigger_error_input cocci_id@p ;
...
position p;
@@
 struct amdgpu_cu_info * cocci_id@p ;
...
position p;
@@
 struct ras_inject_if * cocci_id@p ;
...
typedef uint64_t;
@@
 uint64_t cocci_id@p ( struct amdgpu_device * adev ) ;
...
position p;
@@
 const struct amdgpu_ring_funcs cocci_id@p ;
...
position p;
@@
 const struct gfx_firmware_header_v1_0 * cocci_id@p ;
...
position p;
@@
 struct amdgpu_iv_entry * cocci_id@p ;
...
position p;
@@
 struct ras_err_data * cocci_id@p ;
...
position p;
@@
 struct amdgpu_firmware_info * cocci_id@p ;
