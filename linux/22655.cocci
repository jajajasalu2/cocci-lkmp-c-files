...
position p;
@@
 struct scarlett_device_info cocci_id@p ;
...
position p;
@@
 struct scarlett_device_info {  int matrix_in ;  int matrix_out ;  int input_len ;  int output_len ;  struct scarlett_mixer_elem_enum_info opt_master ;  struct scarlett_mixer_elem_enum_info opt_matrix ;  int matrix_mux_init [ SND_SCARLETT_MATRIX_IN_MAX ] ;  int num_controls ;  const struct scarlett_mixer_control controls [ SND_SCARLETT_CONTROLS_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct scarlett_mixer_control {  unsigned char num ;  unsigned char type ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 const struct scarlett_mixer_elem_enum_info * cocci_id@p ;
...
position p;
@@
 const struct scarlett_mixer_control * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef usb_mixer_elem_resume_func_t;
@@
 usb_mixer_elem_resume_func_t cocci_id@p ;
...
position p;
@@
 struct scarlett_mixer_elem_enum_info * cocci_id@p ;
...
position p;
@@
 const struct scarlett_device_info * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ 2 * MAX_CHANNELS ] ;
...
position p;
@@
 struct scarlett_mixer_elem_enum_info {  int start ;  int len ;  int offsets [ SND_SCARLETT_OFFSETS_MAX ] ;  const char * const * names ; } cocci_id@p ;
...
position p;
@@
 enum { SCARLETT_OFFSET_PCM = 0 , SCARLETT_OFFSET_ANALOG = 1 , SCARLETT_OFFSET_SPDIF = 2 , SCARLETT_OFFSET_ADAT = 3 , SCARLETT_OFFSET_MIX = 4 , } cocci_id@p ;
...
position p;
@@
 enum { SCARLETT_OUTPUTS , SCARLETT_SWITCH_IMPEDANCE , SCARLETT_SWITCH_PAD , SCARLETT_SWITCH_GAIN , } cocci_id@p ;
