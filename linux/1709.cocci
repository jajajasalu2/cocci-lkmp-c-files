...
position p;
@@
 struct tpl0102_data * cocci_id@p ;
...
position p;
@@
 struct tpl0102_data {  struct regmap * regmap ;  const struct tpl0102_cfg * cfg ; } cocci_id@p ;
...
position p;
@@
 const struct tpl0102_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct tpl0102_cfg {  int wipers ;  int avail [ 3 ] ;  int kohms ; } cocci_id@p ;
...
position p;
@@
 enum tpl0102_type { CAT5140_503 , CAT5140_104 , TPL0102_104 , TPL0401_103 , } cocci_id@p ;
