...
typedef u8;
@@
 struct ab3100_regulator {  struct device * dev ;  struct ab3100_platform_data * plfdata ;  u8 regreg ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ AB3100_NUM_REGULATORS + 2 ] ;
...
position p;
@@
 struct ab3100_platform_data * cocci_id@p ;
...
position p;
@@
 struct ab3100_regulator cocci_id@p [ AB3100_NUM_REGULATORS ] ;
...
position p;
@@
 const struct regulator_desc cocci_id@p [ AB3100_NUM_REGULATORS ] ;
...
position p;
@@
 struct ab3100_regulator * cocci_id@p ;
