...
typedef spinlock_t;
@@
 struct mlx5i_pkey_qpn_ht {  struct hlist_head buckets [ 1 << MLX5I_MAX_LOG_PKEY_SUP ] ;  spinlock_t ht_lock ; } cocci_id@p ;
...
typedef u32;
@@
 struct qpn_to_netdev {  struct net_device * netdev ;  struct hlist_node hlist ;  u32 underlay_qpn ; } cocci_id@p ;
...
position p;
@@
 struct mlx5i_pkey_qpn_ht * cocci_id@p ;
...
position p;
@@
 struct qpn_to_netdev * cocci_id@p ;
