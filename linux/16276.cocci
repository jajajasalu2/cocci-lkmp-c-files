...
position p;
@@
 struct amvdec_session cocci_id@p ;
...
position p;
@@
 struct amvdec_buffer * cocci_id@p ;
...
position p;
@@
 struct amvdec_codec_ops * cocci_id@p ;
...
position p;
@@
 struct amvdec_timestamp * cocci_id@p ;
...
position p;
@@
 const struct amvdec_format * cocci_id@p ;
...
position p;
@@
 const struct vdec_platform * cocci_id@p ;
...
position p;
@@
 struct dummy_buf {  struct vb2_v4l2_buffer vb ;  struct list_head list ; } cocci_id@p ;
