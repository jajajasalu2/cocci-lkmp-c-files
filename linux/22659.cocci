...
symbol cocci_id;
position p;
typedef quirk_func_t;
@@
 const quirk_func_t cocci_id@p [ ] ;
...
position p;
@@
 enum { EMU_QUIRK_SR_44100HZ = 0 , EMU_QUIRK_SR_48000HZ , EMU_QUIRK_SR_88200HZ , EMU_QUIRK_SR_96000HZ , EMU_QUIRK_SR_176400HZ , EMU_QUIRK_SR_192000HZ , } cocci_id@p ;
...
position p;
@@
 const struct audioformat cocci_id@p ;
...
position p;
@@
 struct snd_usb_endpoint * cocci_id@p ;
...
position p;
@@
 struct usb_midi_out_jack_descriptor * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_usb_audio * , struct usb_interface * , struct usb_driver * , const struct snd_usb_audio_quirk * ) ;
