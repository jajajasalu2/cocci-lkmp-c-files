...
position p;
@@
 union gic_base {  void __iomem * common_base ;  void __percpu * __iomem * percpu_base ; } cocci_id@p ;
...
@@
 struct {  phys_addr_t cpu_phys_base ;  u32 maint_irq ;  int maint_irq_mode ;  phys_addr_t vctrl_base ;  phys_addr_t vcpu_base ; } cocci_id@p ;
...
position p;
@@
 void __iomem * ( * cocci_id@p ) ( union gic_base * ) ;
