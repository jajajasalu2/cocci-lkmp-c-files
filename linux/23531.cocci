...
position p;
@@
 enum { SKL_DPCM_AUDIO_PB = 0 , SKL_DPCM_AUDIO_CP , SKL_DPCM_AUDIO_REF_CP , SKL_DPCM_AUDIO_DMIC_CP , SKL_DPCM_AUDIO_HDMI1_PB , SKL_DPCM_AUDIO_HDMI2_PB , SKL_DPCM_AUDIO_HDMI3_PB , } cocci_id@p ;
...
position p;
@@
 struct skl_nau88125_private * cocci_id@p ;
...
position p;
@@
 struct skl_nau88125_private {  struct list_head hdmi_pcm_list ; } cocci_id@p ;
