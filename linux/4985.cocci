...
position p;
@@
 struct i40iw_cm_core * cocci_id@p ;
...
position p;
@@
 union all_known_options * cocci_id@p ;
...
position p;
@@
 struct i40iw_kmem_info * cocci_id@p ;
...
position p;
@@
 struct i40iw_cm_listener cocci_id@p ;
...
position p;
@@
 struct i40iw_puda_rsrc * cocci_id@p ;
...
position p;
@@
 enum iw_cm_event_type cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct i40iw_cm_node * ) ;
...
position p;
@@
 enum i40iw_cm_event_type cocci_id@p ;
...
position p;
@@
 struct i40iw_cm_info * cocci_id@p ;
...
position p;
@@
 struct i40iw_timer_entry * cocci_id@p ;
...
position p;
@@
 enum i40iw_timer_type cocci_id@p ;
...
position p;
@@
 struct i40iw_cm_node * cocci_id@p ;
...
position p;
@@
 enum i40iw_cm_listener_state cocci_id@p ;
...
position p;
@@
 struct disconn_work * cocci_id@p ;
...
position p;
@@
 struct i40iw_cm_event cocci_id@p ;
...
position p;
@@
 struct ietf_rtr_msg * cocci_id@p ;
...
position p;
@@
 enum i40iw_quad_hash_manage_type cocci_id@p ;
...
position p;
@@
 struct option_windowscale cocci_id@p ;
...
position p;
@@
 enum i40iw_cm_node_state cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( struct option_mss ) + sizeof ( struct option_windowscale ) + sizeof ( struct option_base ) + TCP_OPTIONS_PADDING ] ;
...
position p;
@@
 void cocci_id@p ( struct i40iw_cm_event * event ) ;
...
position p;
@@
 enum i40iw_tcpip_pkt_type cocci_id@p ;
