...
position p;
@@
 struct commit_callback {  void ( * callback ) ( void * , int success ) ;  void * context ; } cocci_id@p ;
...
position p;
@@
 struct mdata_req {  struct dm_io_region * where ;  struct dm_io_request * io_req ;  struct work_struct work ;  int result ; } cocci_id@p ;
...
position p;
@@
 struct disk_exception * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * , int success ) ;
...
position p;
@@
 struct dm_exception * cocci_id@p ;
...
typedef uint64_t;
@@
 struct core_exception {  uint64_t old_chunk ;  uint64_t new_chunk ; } cocci_id@p ;
...
position p;
@@
 struct dm_exception_store_type cocci_id@p ;
...
position p;
@@
 struct dm_exception_store * cocci_id@p ;
...
position p;
@@
 struct core_exception cocci_id@p ;
...
position p;
@@
 struct dm_bufio_client * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef atomic_t,chunk_t,uint32_t;
@@
 struct pstore {  struct dm_exception_store * store ;  int version ;  int valid ;  uint32_t exceptions_per_area ;  void * area ;  void * zero_area ;  void * header_area ;  chunk_t current_area ;  chunk_t next_free ;  uint32_t current_committed ;  atomic_t pending_count ;  uint32_t callback_count ;  struct commit_callback * callbacks ;  struct dm_io_client * io_client ;  struct workqueue_struct * metadata_wq ; } cocci_id@p ;
...
position p;
@@
 struct commit_callback * cocci_id@p ;
