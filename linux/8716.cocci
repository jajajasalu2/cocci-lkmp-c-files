...
position p;
@@
 enum vxge_hw_status cocci_id@p ;
...
position p;
@@
 struct vxge_hw_xmac_vpath_rx_stats cocci_id@p ;
...
position p;
@@
 struct vxge_hw_ring_rxd_1 * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_srpcim_reg cocci_id@p ;
...
position p;
@@
 struct vxge_hw_vp_config * cocci_id@p ;
...
position p;
@@
 enum vxge_debug_level cocci_id@p ;
...
position p;
@@
 struct vxge_hw_xmac_port_stats * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_xmac_aggr_stats * cocci_id@p ;
...
position p;
@@
 struct __vxge_hw_vpath_handle * * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_mrpcim_reg cocci_id@p ;
...
position p;
@@
 struct vxge_hw_vpath_reg cocci_id@p ;
...
position p;
@@
 struct vxge_hw_ring_config * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_device_stats_hw_info cocci_id@p ;
...
position p;
@@
 struct vxge_hw_device_stats_sw_info * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_fifo_config * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_device_date * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_vpath_stats_hw_info * cocci_id@p ;
...
position p;
@@
 const struct vxge_hw_mempool_cbs * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_vpmgmt_reg cocci_id@p ;
...
position p;
@@
 struct vxge_hw_mempool_cbs cocci_id@p ;
...
position p;
@@
 enum vxge_hw_mgmt_reg_type cocci_id@p ;
...
position p;
@@
 struct vxge_hw_vpath_attr * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_xmac_stats * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_device_config cocci_id@p ;
...
position p;
@@
 struct vxge_hw_mempool cocci_id@p ;
...
position p;
@@
 struct vxge_hw_fifo_txd * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_device_attr * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_device_hw_info * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_mempool_dma cocci_id@p ;
...
position p;
@@
 struct vxge_hw_xmac_vpath_tx_stats cocci_id@p ;
...
position p;
@@
 struct vxge_hw_device_version * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_fifo_attr * cocci_id@p ;
...
position p;
@@
 struct __vxge_hw_device * * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_common_reg cocci_id@p ;
...
position p;
@@
 struct vxge_hw_toc_reg cocci_id@p ;
...
position p;
@@
 struct vxge_hw_ring_attr * cocci_id@p ;
...
position p;
@@
 enum vxge_hw_rth_algoritms cocci_id@p ;
...
position p;
@@
 struct vxge_hw_rth_hash_types * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_legacy_reg cocci_id@p ;
