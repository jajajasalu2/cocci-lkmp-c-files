...
position p;
@@
 struct gpio_leds_priv * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,gpio_blink_set_t;
@@
 struct gpio_led_data {  struct led_classdev cdev ;  struct gpio_desc * gpiod ;  u8 can_sleep ;  u8 blinking ;  gpio_blink_set_t platform_gpio_blink_set ; } cocci_id@p ;
...
position p;
@@
 struct gpio_leds_priv {  int num_leds ;  struct gpio_led_data leds [ ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef gpio_blink_set_t;
@@
 gpio_blink_set_t cocci_id@p ;
...
position p;
@@
 struct gpio_led_data * cocci_id@p ;
