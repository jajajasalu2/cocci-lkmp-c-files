...
position p;
@@
 struct usb_hub_status * cocci_id@p ;
...
position p;
@@
 struct usb_set_sel_req * cocci_id@p ;
...
position p;
@@
 struct usb_host_bos * cocci_id@p ;
...
position p;
@@
 enum usb_device_state cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_device * udev ) ;
...
position p;
@@
 enum usb_port_connect_type cocci_id@p ;
...
position p;
@@
 enum usb3_link_state cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * ws ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_hub * hub , int port1 , int set_state ) ;
...
position p;
@@
 enum hub_activation_type cocci_id@p ;
...
position p;
@@
 enum hub_activation_type { HUB_INIT , HUB_INIT2 , HUB_INIT3 , HUB_POST_RESET , HUB_RESUME , HUB_RESET_RESUME , } cocci_id@p ;
...
position p;
@@
 struct usb_tt_clear cocci_id@p ;
...
position p;
@@
 struct usb3_lpm_parameters * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ USB_MAXCHILDREN + 1 ] ;
...
position p;
@@
 struct usbdevfs_hub_portinfo * cocci_id@p ;
...
position p;
@@
 enum hub_quiescing_type { HUB_DISCONNECT , HUB_PRE_RESET , HUB_SUSPEND , } cocci_id@p ;
...
position p;
@@
 struct usb_ssp_cap_descriptor * cocci_id@p ;
...
position p;
@@
 enum hub_quiescing_type cocci_id@p ;
...
typedef bool,u16;
@@
 bool cocci_id@p ( struct usb_hub * hub , int port1 , u16 portstatus ) ;
