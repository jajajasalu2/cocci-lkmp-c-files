...
position p;
@@
 struct bfa_defs_fcpim_throttle_s cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioim_s * ioim , enum bfa_ioim_event event ) ;
...
position p;
@@
 struct bfa_itnim_latency_s * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct bfa_s * bfa , struct bfi_msg_s * m ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_tskim_s * tskim , enum bfa_tskim_event event ) ;
...
position p;
@@
 struct bfad_tskim_s * cocci_id@p ;
...
position p;
@@
 enum bfa_itnim_event cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_itnim_s * itnim , enum bfa_itnim_event event ) ;
...
position p;
@@
 enum bfa_ioim_event { BFA_IOIM_SM_START = 1 , BFA_IOIM_SM_COMP_GOOD = 2 , BFA_IOIM_SM_COMP = 3 , BFA_IOIM_SM_COMP_UTAG = 4 , BFA_IOIM_SM_DONE = 5 , BFA_IOIM_SM_FREE = 6 , BFA_IOIM_SM_ABORT = 7 , BFA_IOIM_SM_ABORT_COMP = 8 , BFA_IOIM_SM_ABORT_DONE = 9 , BFA_IOIM_SM_QRESUME = 10 , BFA_IOIM_SM_SGALLOCED = 11 , BFA_IOIM_SM_SQRETRY = 12 , BFA_IOIM_SM_HCB = 13 , BFA_IOIM_SM_CLEANUP = 14 , BFA_IOIM_SM_TMSTART = 15 , BFA_IOIM_SM_TMDONE = 16 , BFA_IOIM_SM_HWFAIL = 17 , BFA_IOIM_SM_IOTOV = 18 , } cocci_id@p ;
...
position p;
@@
 struct bfi_tskim_abortreq_s * cocci_id@p ;
...
position p;
@@
 enum bfa_ioim_lm_ua_status { BFA_IOIM_LM_UA_RESET = 0 , BFA_IOIM_LM_UA_SET = 1 , } cocci_id@p ;
...
position p;
@@
 union bfi_itn_i2h_msg_u cocci_id@p ;
...
position p;
@@
 struct bfi_itn_delete_req_s * cocci_id@p ;
...
position p;
@@
 struct bfi_tskim_rsp_s * cocci_id@p ;
...
position p;
@@
 struct bfi_itn_create_req_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_itnim_s * itnim ) ;
...
position p;
@@
 struct bfa_ioim_sp_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * itnim_cbarg ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_tskim_s * tskim ) ;
...
typedef bfa_boolean_t;
@@
 bfa_boolean_t cocci_id@p ( struct bfa_itnim_s * itnim ) ;
...
position p;
@@
 enum bfa_ioim_event cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioim_s * ioim ) ;
...
position p;
@@
 void cocci_id@p ( void * tskim_cbarg ) ;
...
position p;
@@
 struct bfa_itnim_ioprofile_s * cocci_id@p ;
...
position p;
@@
 struct bfa_lun_mask_s * cocci_id@p ;
...
position p;
@@
 struct bfa_throttle_cfg_s * cocci_id@p ;
...
typedef bfa_boolean_t;
@@
 bfa_boolean_t cocci_id@p ( struct bfa_tskim_s * tskim , struct scsi_lun lun ) ;
...
position p;
@@
 struct bfa_fcp_mod_s * cocci_id@p ;
...
position p;
@@
 enum bfa_itnim_event { BFA_ITNIM_SM_CREATE = 1 , BFA_ITNIM_SM_ONLINE = 2 , BFA_ITNIM_SM_OFFLINE = 3 , BFA_ITNIM_SM_FWRSP = 4 , BFA_ITNIM_SM_DELETE = 5 , BFA_ITNIM_SM_CLEANUP = 6 , BFA_ITNIM_SM_SLER = 7 , BFA_ITNIM_SM_HWFAIL = 8 , BFA_ITNIM_SM_QRESUME = 9 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * itnim_arg ) ;
...
position p;
@@
 enum bfa_tskim_event { BFA_TSKIM_SM_START = 1 , BFA_TSKIM_SM_DONE = 2 , BFA_TSKIM_SM_QRESUME = 3 , BFA_TSKIM_SM_HWFAIL = 5 , BFA_TSKIM_SM_HCB = 6 , BFA_TSKIM_SM_IOS_DONE = 7 , BFA_TSKIM_SM_CLEANUP = 8 , BFA_TSKIM_SM_CLEANUP_DONE = 9 , BFA_TSKIM_SM_UTAG = 10 , } cocci_id@p ;
...
position p;
@@
 struct bfi_tskim_req_s * cocci_id@p ;
...
position p;
@@
 enum bfa_tskim_event cocci_id@p ;
...
typedef bfa_boolean_t;
@@
 bfa_boolean_t cocci_id@p ( struct bfa_tskim_s * tskim ) ;
...
position p;
@@
 struct bfi_ioim_req_s * cocci_id@p ;
...
position p;
@@
 struct bfi_ioim_abort_req_s * cocci_id@p ;
...
typedef bfa_boolean_t;
@@
 bfa_boolean_t cocci_id@p ( struct bfa_ioim_s * ioim ) ;
...
position p;
@@
 struct bfi_ioim_rsp_s * cocci_id@p ;
