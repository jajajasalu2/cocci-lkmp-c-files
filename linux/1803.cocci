...
typedef s16;
@@
 struct gainadj {  s16 ch0 ;  s16 ch1 ;  s16 mean ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ TSL2583_MAX_LUX_TABLE_ENTRIES * 3 + 1 ] ;
...
position p;
@@
 struct tsl2583_lux {  unsigned int ratio ;  unsigned int ch0 ;  unsigned int ch1 ; } cocci_id@p ;
...
position p;
@@
 struct tsl2583_chip * cocci_id@p ;
...
position p;
@@
 const struct gainadj cocci_id@p [ ] ;
...
position p;
@@
 const struct tsl2583_lux cocci_id@p [ ] ;
...
typedef u16;
@@
 struct tsl2583_als_info {  u16 als_ch0 ;  u16 als_ch1 ;  u16 lux ; } cocci_id@p ;
...
position p;
@@
 struct tsl2583_chip {  struct mutex als_mutex ;  struct i2c_client * client ;  struct tsl2583_als_info als_cur_info ;  struct tsl2583_settings als_settings ;  int als_time_scale ;  int als_saturation ; } cocci_id@p ;
...
position p;
@@
 struct tsl2583_settings {  int als_time ;  int als_gain ;  int als_gain_trim ;  int als_cal_target ;  struct tsl2583_lux als_device_lux [ TSL2583_MAX_LUX_TABLE_ENTRIES ] ; } cocci_id@p ;
