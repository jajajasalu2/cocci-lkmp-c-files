...
position p;
@@
 struct sugov_tunables cocci_id@p ;
...
position p;
@@
 struct sugov_policy * cocci_id@p ;
...
position p;
@@
 struct gov_attr_set * cocci_id@p ;
...
position p;
@@
 struct sugov_tunables {  struct gov_attr_set attr_set ;  unsigned int rate_limit_us ; } cocci_id@p ;
...
position p;
@@
 enum schedutil_type cocci_id@p ;
...
position p;
@@
 struct governor_attr cocci_id@p ;
