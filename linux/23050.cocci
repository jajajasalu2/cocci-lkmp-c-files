...
position p;
@@
 struct omap_hdmi_audio_pdata * cocci_id@p ;
...
position p;
@@
 struct hdmi_audio_data * cocci_id@p ;
...
position p;
@@
 struct hdmi_audio_data {  struct snd_soc_card * card ;  const struct omap_hdmi_audio_ops * ops ;  struct device * dssdev ;  struct snd_dmaengine_dai_dma_data dma_data ;  struct omap_dss_audio dss_audio ;  struct snd_aes_iec958 iec ;  struct snd_cea_861_aud_if cea ;  struct mutex current_stream_lock ;  struct snd_pcm_substream * current_stream ; } cocci_id@p ;
