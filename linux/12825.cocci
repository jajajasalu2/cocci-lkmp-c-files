...
typedef u32;
@@
 struct da8xx_ddrctl_setting {  const char * name ;  u32 val ; } cocci_id@p ;
...
position p;
@@
 const struct da8xx_ddrctl_board_settings * cocci_id@p ;
...
position p;
@@
 const struct da8xx_ddrctl_setting cocci_id@p [ ] ;
...
position p;
@@
 const struct da8xx_ddrctl_config_knob cocci_id@p [ ] ;
...
position p;
@@
 struct da8xx_ddrctl_board_settings {  const char * board ;  const struct da8xx_ddrctl_setting * settings ; } cocci_id@p ;
...
typedef u32;
@@
 struct da8xx_ddrctl_config_knob {  const char * name ;  u32 reg ;  u32 mask ;  u32 shift ; } cocci_id@p ;
