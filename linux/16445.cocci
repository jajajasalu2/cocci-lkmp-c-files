...
position p;
@@
 struct asus_kbd_leds * cocci_id@p ;
...
position p;
@@
 struct asus_touchpad_info {  int max_x ;  int max_y ;  int res_x ;  int res_y ;  int contact_size ;  int max_contacts ; } cocci_id@p ;
...
typedef bool;
@@
 struct asus_kbd_leds {  struct led_classdev cdev ;  struct hid_device * hdev ;  struct work_struct work ;  unsigned int brightness ;  bool removed ; } cocci_id@p ;
...
position p;
@@
 struct asus_drvdata * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct asus_drvdata * , u8 * , int ) ;
...
position p;
@@
 const struct asus_touchpad_info cocci_id@p ;
