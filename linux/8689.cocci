...
position p;
@@
 struct igc_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
...
position p;
@@
 const struct igc_stats cocci_id@p [ ] ;
...
position p;
@@
 enum igc_diagnostics_results { TEST_REG = 0 , TEST_EEP , TEST_IRQ , TEST_LOOP , TEST_LINK , } cocci_id@p ;
...
position p;
@@
 struct igc_rx_queue_stats cocci_id@p ;
