...
position p;
@@
 int cocci_id@p ( struct altera_tse_private * priv , struct sgdma_descrip __iomem * desc ) ;
...
position p;
@@
 int cocci_id@p ( struct altera_tse_private * priv ) ;
...
position p;
@@
 struct altera_tse_private * cocci_id@p ;
...
position p;
@@
 struct tse_buffer * cocci_id@p ( struct altera_tse_private * priv ) ;
...
position p;
@@
 void cocci_id@p ( struct altera_tse_private * priv , struct tse_buffer * buffer ) ;
...
typedef dma_addr_t;
@@
 dma_addr_t cocci_id@p ( struct altera_tse_private * priv , struct sgdma_descrip __iomem * desc ) ;
