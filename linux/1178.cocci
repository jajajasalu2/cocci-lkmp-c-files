...
typedef dma_addr_t;
@@
 struct free_record {  struct list_head list ;  struct device * dev ;  unsigned bytes ;  dma_addr_t dma ; } cocci_id@p ;
...
position p;
@@
 struct musb_request cocci_id@p ;
