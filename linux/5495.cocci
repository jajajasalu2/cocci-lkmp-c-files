...
position p;
@@
 const struct spi_bitbang * cocci_id@p ;
...
position p;
@@
 struct spi_gpio {  struct spi_bitbang bitbang ;  struct gpio_desc * sck ;  struct gpio_desc * miso ;  struct gpio_desc * mosi ;  struct gpio_desc * * cs_gpios ; } cocci_id@p ;
