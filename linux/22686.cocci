...
position p;
@@
 void cocci_id@p ( struct snd_sf_list * sflist , struct snd_sf_zone * zp ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sf_list * sflist , const char __user * data , int count , int client ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_soundfont * sf , int type , unsigned char * name ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sf_list * sflist ) ;
...
position p;
@@
 struct soundfont_voice_parm * cocci_id@p ;
...
position p;
@@
 struct soundfont_sample_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_sf_list * sflist , int sample_id ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_sf_list * sflist ) ;
...
position p;
@@
 struct snd_sf_sample * cocci_id@p ( struct snd_sf_list * sflist , struct snd_soundfont * sf ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_sf_list * sflist , struct snd_soundfont * sf , struct snd_sf_zone * zp ) ;
...
position p;
@@
 struct soundfont_open_parm cocci_id@p ;
...
position p;
@@
 struct snd_sf_callback * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_sf_list * sflist , const void __user * data , int count ) ;
...
position p;
@@
 void cocci_id@p ( struct soundfont_voice_info * avp ) ;
...
position p;
@@
 int cocci_id@p ( int bank , int instr , int key ) ;
...
position p;
@@
 struct snd_sf_zone * cocci_id@p ( struct snd_sf_list * sflist , struct snd_soundfont * sf ) ;
...
position p;
@@
 struct soundfont_voice_rec_hdr cocci_id@p ;
...
position p;
@@
 struct snd_soundfont * cocci_id@p ;
...
position p;
@@
 struct snd_util_memhdr * cocci_id@p ;
...
position p;
@@
 struct snd_sf_sample * cocci_id@p ( struct snd_soundfont * sf , struct soundfont_voice_info * avp ) ;
...
position p;
@@
 struct soundfont_voice_map cocci_id@p ;
...
position p;
@@
 struct snd_soundfont * cocci_id@p ( struct snd_sf_list * sflist , int type , char * name ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sf_list * sflist , struct snd_soundfont * sf , int bank , int instr ) ;
...
position p;
@@
 void cocci_id@p ( struct soundfont_voice_parm * pp ) ;
...
position p;
@@
 struct soundfont_patch_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_sf_list * sflist , struct snd_sf_zone * cur ) ;
...
position p;
@@
 struct snd_sf_sample * cocci_id@p ( struct snd_soundfont * sf , int sample_id ) ;
...
position p;
@@
 struct snd_sf_zone * cocci_id@p ( struct snd_sf_list * sflist , int bank , int preset , int key ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sf_list * sflist , int * notep , int vel , int preset , int bank , struct snd_sf_zone * * table , int max_layers , int level ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_sf_list * sflist , const void __user * data , long count ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_sf_list * sflist , struct snd_soundfont * sf , struct snd_sf_sample * sp ) ;
...
position p;
@@
 struct soundfont_voice_info * cocci_id@p ;
...
position p;
@@
 struct snd_sf_sample * cocci_id@p ;
