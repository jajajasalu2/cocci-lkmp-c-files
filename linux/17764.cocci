...
position p;
@@
 struct rtas_handler cocci_id@p [ ] ;
...
position p;
@@
 struct kvm_rtas_token_args cocci_id@p ;
...
position p;
@@
 struct rtas_handler {  void ( * handler ) ( struct kvm_vcpu * vcpu , struct rtas_args * args ) ;  char * name ; } cocci_id@p ;
...
typedef u64;
@@
 struct rtas_token_definition {  struct list_head list ;  struct rtas_handler * handler ;  u64 token ; } cocci_id@p ;
...
position p;
@@
 struct rtas_token_definition * cocci_id@p ;
