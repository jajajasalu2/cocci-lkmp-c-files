...
@ r2 @
symbol cocci_id,endp,urb,buf,len,toggle_bits,error_count,condition_code,repeat_number,halted,skipped,actual,non_null;
position p;
typedef u8;
@@
 struct u132_target {  void * endp ;  struct urb * urb ;  int toggle_bits ;  int error_count ;  int condition_code ;  int repeat_number ;  int halted ;  int skipped ;  int actual ;  int non_null ;  int active ;  int abandoning ;  void ( * callback ) ( void * endp , struct urb * urb , u8 * buf , int len , int toggle_bits , int error_count , int condition_code , int repeat_number , int halted , int skipped , int actual , int non_null ) ; } cocci_id@p ;
...
@ r10 @
symbol cocci_id,ftdi;
position p;
@@
 void cocci_id@p ( struct usb_ftdi * ftdi ) ;
...
typedef u8,u32;
@@
 struct u132_respond {  u8 header ;  u8 address ;  u32 * value ;  int * result ;  struct completion wait_completion ; } cocci_id@p ;
...
@ r18 @
symbol cocci_id,ftdi,target,buffer,length;
position p;
typedef u8;
@@
 void cocci_id@p ( struct usb_ftdi * ftdi , struct u132_target * target , u8 * buffer , int length ) ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( void * , struct urb * , u8 * , int , int , int , int , int , int , int , int , int ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_ftdi * ftdi ) ;
...
typedef u8,u32,u16;
@@
 struct u132_command {  u8 header ;  u16 length ;  u8 address ;  u8 width ;  u32 value ;  int follows ;  void * buffer ; } cocci_id@p ;
...
position p;
@@
 struct u132_command * cocci_id@p ;
...
position p;
@@
 struct u132_respond * cocci_id@p ;
