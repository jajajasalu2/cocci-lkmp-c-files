...
@@
 struct iproc_pcie_ob_map {  resource_size_t window_sizes [ MAX_NUM_OB_WINDOW_SIZES ] ;  unsigned int nr_sizes ; } cocci_id@p ;
...
position p;
@@
 const struct iproc_pcie_ib_map cocci_id@p [ ] ;
...
position p;
@@
 enum iproc_pcie_ib_map_type cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u16,resource_size_t;
@@
 struct iproc_pcie_ib_map {  enum iproc_pcie_ib_map_type type ;  unsigned int size_unit ;  resource_size_t region_sizes [ MAX_NUM_IB_REGION_SIZES ] ;  unsigned int nr_sizes ;  unsigned int nr_windows ;  u16 imap_addr_offset ;  u16 imap_window_offset ; } cocci_id@p ;
...
position p;
@@
 struct iproc_pcie_ib * cocci_id@p ;
...
position p;
@@
 enum iproc_pcie_ib_map_type { IPROC_PCIE_IB_MAP_MEM = 0 , IPROC_PCIE_IB_MAP_IO , IPROC_PCIE_IB_MAP_INVALID , } cocci_id@p ;
...
position p;
@@
 enum iproc_pcie_reg cocci_id@p ;
...
position p;
@@
 const struct iproc_pcie_ob_map cocci_id@p [ ] ;
...
position p;
@@
 struct iproc_pcie_ob * cocci_id@p ;
