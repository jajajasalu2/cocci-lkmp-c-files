...
position p;
@@
 const struct ubi_vid_hdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ubi_attach_info * ai , struct ubi_ainf_volume * av , struct list_head * list ) ;
...
position p;
@@
 const struct ubi_ainf_peb * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ubi_device * ubi , struct ubi_attach_info * ai ) ;
