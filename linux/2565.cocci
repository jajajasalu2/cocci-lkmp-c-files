...
position p;
@@
 struct receiving_pkg cocci_id@p ;
...
position p;
@@
 struct dm_ulog_request * cocci_id@p ;
...
typedef uint32_t;
@@
 struct receiving_pkg {  struct list_head list ;  struct completion complete ;  uint32_t seq ;  int error ;  size_t * data_size ;  char * data ; } cocci_id@p ;
