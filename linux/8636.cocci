...
position p;
@@
 int cocci_id@p ( struct ixgb_adapter * adapter ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ixgb_adapter * adapter ) ;
...
position p;
@@
 struct ixgb_desc_ring * cocci_id@p ;
...
position p;
@@
 struct ixgb_context_desc * cocci_id@p ;
...
position p;
@@
 struct ixgb_rx_desc cocci_id@p ;
...
position p;
@@
 struct ixgb_adapter * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ixgb_adapter * adapter ) ;
...
position p;
@@
 struct ixgb_tx_desc cocci_id@p ;
...
typedef pci_ers_result_t;
@@
 pci_ers_result_t cocci_id@p ( struct pci_dev * pdev , enum pci_channel_state state ) ;
...
position p;
@@
 void cocci_id@p ( struct ixgb_adapter * , int ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ixgb_adapter * , int * , int ) ;
