...
position p;
@@
 struct mmu_notifier_mm cocci_id@p ;
...
@@
 struct mmu_notifier_mm {  struct hlist_head list ;  bool has_itree ;  spinlock_t lock ;  unsigned long invalidate_seq ;  unsigned long active_invalidate_ranges ;  struct rb_root_cached itree ;  wait_queue_head_t wq ;  struct hlist_head deferred_list ; } cocci_id@p ;
