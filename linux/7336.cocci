...
position p;
@@
 struct omapfb_mem_desc * cocci_id@p ;
...
position p;
@@
 struct hwa742_request {  struct list_head entry ;  unsigned int flags ;  int ( * handler ) ( struct hwa742_request * req ) ;  void ( * complete ) ( void * data ) ;  void * complete_data ;  union {  struct update_param update ;  struct completion * sync ; } par ; } cocci_id@p ;
...
position p;
@@
 struct hwa742_request cocci_id@p ;
...
position p;
@@
 struct update_param * cocci_id@p ;
...
position p;
@@
 struct extif_timings * cocci_id@p ;
