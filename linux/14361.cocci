...
position p;
@@
 const enum fe_modulation cocci_id@p [ 3 ] ;
...
position p;
@@
 const struct cx22700_config * cocci_id@p ;
...
position p;
@@
 const enum fe_code_rate cocci_id@p [ 5 ] ;
...
position p;
@@
 struct cx22700_state * cocci_id@p ;
...
position p;
@@
 struct cx22700_state {  struct i2c_adapter * i2c ;  const struct cx22700_config * config ;  struct dvb_frontend frontend ; } cocci_id@p ;
