...
position p;
@@
 const struct mrp_attr * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ MRP_APPLICANT_MAX + 1 ] [ MRP_EVENT_MAX + 1 ] ;
...
position p;
@@
 const struct mrp_pdu_hdr * cocci_id@p ;
...
position p;
@@
 struct mrp_vecattr_hdr * cocci_id@p ;
...
position p;
@@
 struct mrp_applicant * cocci_id@p ;
...
position p;
@@
 struct mrp_application * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ MRP_APPLICANT_MAX + 1 ] ;
...
position p;
@@
 enum mrp_applicant_state cocci_id@p ;
...
position p;
@@
 const struct mrp_applicant * cocci_id@p ;
...
position p;
@@
 enum mrp_vecattr_event cocci_id@p ;
...
position p;
@@
 const struct mrp_application * cocci_id@p ;
