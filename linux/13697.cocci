...
position p;
@@
 const struct tpg_data * cocci_id@p ;
...
position p;
@@
 struct tpg_draw_params * cocci_id@p ;
...
typedef bool;
@@
 struct tpg_draw_params {  bool is_tv ;  bool is_60hz ;  unsigned twopixsize ;  unsigned img_width ;  unsigned stride ;  unsigned hmax ;  unsigned frame_line ;  unsigned frame_line_next ;  unsigned mv_hor_old ;  unsigned mv_hor_new ;  unsigned mv_vert_old ;  unsigned mv_vert_new ;  unsigned wss_width ;  unsigned wss_random_offset ;  unsigned sav_eav_f ;  unsigned left_pillar_width ;  unsigned right_pillar_start ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ TPG_MAX_PLANES ] [ 8 ] ;
...
typedef u8;
@@
 u8 * cocci_id@p [ TPG_MAX_PLANES ] [ 2 ] ;
...
position p;
@@
 const enum tpg_color cocci_id@p [ 3 ] [ 8 ] ;
...
position p;
@@
 const struct tpg_draw_params * cocci_id@p ;
