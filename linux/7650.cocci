...
@@
 struct goldfish_tty {  struct tty_port port ;  spinlock_t lock ;  void __iomem * base ;  u32 irq ;  int opencount ;  struct console console ;  u32 version ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct goldfish_tty * cocci_id@p ;
