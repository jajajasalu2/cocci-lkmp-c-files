...
position p;
@@
 struct keene_device cocci_id@p ;
...
typedef u8,bool;
@@
 struct keene_device {  struct usb_device * usbdev ;  struct usb_interface * intf ;  struct video_device vdev ;  struct v4l2_device v4l2_dev ;  struct v4l2_ctrl_handler hdl ;  struct mutex lock ;  u8 * buffer ;  unsigned curfreq ;  u8 tx ;  u8 pa ;  bool stereo ;  bool muted ;  bool preemph_75_us ; } cocci_id@p ;
