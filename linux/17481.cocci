...
@@
 struct dtl {  struct dtl_entry * buf ;  int cpu ;  int buf_entries ;  u64 last_idx ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u64;
@@
 struct dtl_ring {  u64 write_index ;  struct dtl_entry * write_ptr ;  struct dtl_entry * buf ;  struct dtl_entry * buf_end ; } cocci_id@p ;
