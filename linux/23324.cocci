...
typedef u8;
@@
 struct max9860_priv {  struct regmap * regmap ;  struct regulator * dvddio ;  struct notifier_block dvddio_nb ;  u8 psclk ;  unsigned long pclk_rate ;  int fmt ; } cocci_id@p ;
...
position p;
@@
 struct max9860_priv cocci_id@p ;
