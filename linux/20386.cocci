...
position p;
@@
 struct uv_hub_info_s cocci_id@p ;
...
position p;
@@
 union uvh_rh_gam_gru_overlay_config_mmr_u cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ACPI_OEM_ID_SIZE + 1 ] ;
...
position p;
@@
 union uvh_node_id_u cocci_id@p ;
...
position p;
@@
 union uvh_rh_gam_config_mmr_u cocci_id@p ;
...
position p;
@@
 union uvh_rh_gam_mmr_overlay_config_mmr_u cocci_id@p ;
...
position p;
@@
 enum uv_system_type cocci_id@p ;
...
position p;
@@
 enum map_type { map_wb , map_uc , } cocci_id@p ;
...
position p;
@@
 struct uv_gam_range_entry * cocci_id@p ;
...
position p;
@@
 union uv3h_gr0_gam_gr_config_u cocci_id@p ;
...
position p;
@@
 struct uv_gam_parameters * cocci_id@p ;
...
position p;
@@
 struct uv_gam_range_s cocci_id@p ;
...
position p;
@@
 struct mn {  unsigned char m_val ;  unsigned char n_val ;  unsigned char m_shift ;  unsigned char n_lshift ; } cocci_id@p ;
...
position p;
@@
 union uvh_rh_gam_mmioh_overlay_config_mmr_u cocci_id@p ;
...
position p;
@@
 struct {  unsigned int apicid_shift ;  unsigned int apicid_mask ;  unsigned int socketid_shift ;  unsigned int pnode_mask ;  unsigned int gpa_shift ;  unsigned int gnode_shift ; } cocci_id@p ;
...
position p;
@@
 union uvh_rh_gam_alias210_overlay_config_2_mmr_u cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ACPI_OEM_TABLE_ID_SIZE + 1 ] ;
...
position p;
@@
 union uvh_rh_gam_alias210_redirect_config_2_mmr_u cocci_id@p ;
...
position p;
@@
 union uv1h_lb_target_physical_apic_id_mask_u cocci_id@p ;
