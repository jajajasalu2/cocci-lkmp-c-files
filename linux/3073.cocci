...
position p;
@@
 struct gnttab_unmap_grant_ref cocci_id@p [ BLKIF_MAX_SEGMENTS_PER_REQUEST ] ;
...
position p;
@@
 union blkif_back_rings * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xen_blkif_ring * ring , struct blkif_request * req , struct pending_req * pending_req ) ;
...
position p;
@@
 struct gntab_unmap_queue_data * cocci_id@p ;
...
position p;
@@
 struct gnttab_map_grant_ref cocci_id@p [ BLKIF_MAX_SEGMENTS_PER_REQUEST ] ;
...
position p;
@@
 struct persistent_gnt cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct xen_blkif_ring * ring , u64 id , unsigned short op , int st ) ;
...
position p;
@@
 int cocci_id@p ( struct xen_blkif_ring * ring ) ;
...
position p;
@@
 struct page * cocci_id@p [ NUM_BATCH_FREE_PAGES ] ;
...
position p;
@@
 struct page * cocci_id@p [ BLKIF_MAX_SEGMENTS_PER_REQUEST ] ;
...
position p;
@@
 struct xen_blkif_ring * cocci_id@p ;
