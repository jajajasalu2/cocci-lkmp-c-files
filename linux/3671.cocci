...
position p;
@@
 struct ibft_kobject * cocci_id@p ;
...
position p;
@@
 struct ibft_initiator * cocci_id@p ;
...
position p;
@@
 struct ibft_kobject {  struct acpi_table_ibft * header ;  union {  struct ibft_initiator * initiator ;  struct ibft_nic * nic ;  struct ibft_tgt * tgt ;  struct ibft_hdr * hdr ; } ; } cocci_id@p ;
...
position p;
@@
 struct acpi_table_ibft * cocci_id@p ;
...
position p;
@@
 const struct {  char * sign ; } cocci_id@p [ ] ;
...
position p;
@@
 struct iscsi_boot_kset * cocci_id@p ;
...
position p;
@@
 struct ibft_control * cocci_id@p ;
