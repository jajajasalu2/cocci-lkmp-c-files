...
symbol cocci_id;
position p;
typedef u8,acpi_status;
@@
 acpi_status cocci_id@p ( u8 enable_mask , struct acpi_gpe_register_info * gpe_register_info ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_gpe_xrupt_info * gpe_xrupt_info , struct acpi_gpe_block_info * gpe_block , void * context ) ;
