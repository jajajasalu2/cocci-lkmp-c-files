...
symbol cocci_id;
position p;
typedef pm_cpu_match_t;
@@
 pm_cpu_match_t cocci_id@p ;
...
position p;
@@
 struct saved_context * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const struct x86_cpu_id * ) ;
