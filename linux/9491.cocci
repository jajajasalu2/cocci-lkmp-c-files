...
position p;
@@
 enum _power_dec_inc { power_dec , power_inc , } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ OFDM_TABLE_SIZE ] ;
...
position p;
@@
 struct rate_adaptive * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ CCK_TABLE_SIZE ] [ 8 ] ;
...
position p;
@@
 enum pwr_track_control_method cocci_id@p ;
...
position p;
@@
 struct false_alarm_statistics * cocci_id@p ;
