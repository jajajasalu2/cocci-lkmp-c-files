...
typedef u8;
@@
 const struct {  unsigned int cutoff ;  u8 mask ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 struct kxtj9_data {  struct i2c_client * client ;  struct kxtj9_platform_data pdata ;  struct input_dev * input_dev ;  unsigned int last_poll_interval ;  u8 shift ;  u8 ctrl_reg1 ;  u8 data_ctrl ;  u8 int_ctrl ; } cocci_id@p ;
...
position p;
@@
 const struct kxtj9_platform_data * cocci_id@p ;
