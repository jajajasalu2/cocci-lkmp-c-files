...
position p;
@@
 const int cocci_id@p [ LPADC_MAX ] ;
...
position p;
@@
 struct lp8788_adc {  struct lp8788 * lp ;  struct iio_map * map ;  struct mutex lock ; } cocci_id@p ;
