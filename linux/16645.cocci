...
position p;
@@
 int cocci_id@p ( struct subchannel * , struct chp_link * , int ) ;
...
position p;
@@
 enum io_sch_action { IO_SCH_UNREG , IO_SCH_ORPH_UNREG , IO_SCH_ATTACH , IO_SCH_UNREG_ATTACH , IO_SCH_ORPH_ATTACH , IO_SCH_REPROBE , IO_SCH_VERIFY , IO_SCH_DISC , IO_SCH_NOP , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ccw_device * , struct subchannel * ) ;
...
position p;
@@
 struct io_subchannel_private * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct subchannel * ) ;
...
position p;
@@
 const struct ccw_device_id * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct subchannel * ) ;
...
position p;
@@
 int cocci_id@p ( struct subchannel * , int ) ;
