...
typedef u64;
@@
 const u64 cocci_id@p [ PERF_COUNT_HW_CACHE_MAX ] [ PERF_COUNT_HW_CACHE_OP_MAX ] [ PERF_COUNT_HW_CACHE_RESULT_MAX ] ;
...
position p;
@@
 struct p4_pebs_bind {  unsigned int metric_pebs ;  unsigned int metric_vert ; } cocci_id@p ;
...
position p;
@@
 struct p4_event_bind * cocci_id@p ;
...
position p;
@@
 struct p4_pebs_bind cocci_id@p [ ] ;
...
position p;
@@
 struct p4_event_bind {  unsigned int opcode ;  unsigned int escr_msr [ 2 ] ;  unsigned int escr_emask ;  unsigned int shared ;  char cntr [ 2 ] [ P4_CNTR_LIMIT ] ; } cocci_id@p ;
...
typedef u64;
@@
 struct p4_event_alias {  u64 original ;  u64 alternative ; } cocci_id@p [ ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ P4_ESCR_MSR_TABLE_SIZE ] ;
...
position p;
@@
 const struct x86_pmu cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ PERF_COUNT_HW_MAX ] ;
...
position p;
@@
 unsigned long cocci_id@p [ BITS_TO_LONGS ( P4_ESCR_MSR_TABLE_SIZE ) ] ;
