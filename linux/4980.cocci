...
position p;
@@
 struct ocrdma_create_eq_req * cocci_id@p ;
...
position p;
@@
 struct ocrdma_dev_attr * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_cq_cmd * cocci_id@p ;
...
position p;
@@
 struct ocrdma_ae_pvid_mcqe * cocci_id@p ;
...
position p;
@@
 struct ocrdma_destroy_qp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_alloc_pd_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_qp_params * cocci_id@p ;
...
position p;
@@
 struct ocrdma_get_dcbx_cfg_req cocci_id@p ;
...
position p;
@@
 struct ocrdma_mbx_hdr * cocci_id@p ;
...
position p;
@@
 struct ocrdma_destroy_srq * cocci_id@p ;
...
position p;
@@
 struct ocrdma_ae_mcqe * cocci_id@p ;
...
position p;
@@
 struct ocrdma_alloc_pd * cocci_id@p ;
...
position p;
@@
 struct ocrdma_destroy_cq * cocci_id@p ;
...
position p;
@@
 struct ocrdma_hdr_wqe * cocci_id@p ;
...
position p;
@@
 struct ocrdma_get_link_speed_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_mq_req * cocci_id@p ;
...
position p;
@@
 struct ocrdma_alloc_lkey_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_modify_qp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_cq_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_mqe_sge * cocci_id@p ;
...
position p;
@@
 union {  struct sockaddr_in _sockaddr_in ;  struct sockaddr_in6 _sockaddr_in6 ; } cocci_id@p ;
...
position p;
@@
 struct ocrdma_mbx_query_config * cocci_id@p ;
...
position p;
@@
 struct ocrdma_delete_q_req * cocci_id@p ;
...
position p;
@@
 struct ocrdma_get_phy_info_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_query_qp_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_query_srq * cocci_id@p ;
...
position p;
@@
 struct ocrdma_dcbx_cfg cocci_id@p ;
...
position p;
@@
 struct ocrdma_mbx_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_fw_ver_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_dealloc_pd * cocci_id@p ;
...
position p;
@@
 struct ocrdma_query_srq_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_dealloc_pd_range * cocci_id@p ;
...
position p;
@@
 struct mgmt_hba_attribs * cocci_id@p ;
...
position p;
@@
 struct ocrdma_query_qp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_delete_ah_tbl * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_cq_cmd_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_rdma_stats_resp cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_mq_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_qp_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_reg_nsmr_cont * cocci_id@p ;
...
position p;
@@
 struct ocrdma_get_dcbx_cfg_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_hw_mr * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_srq * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_cq * cocci_id@p ;
...
position p;
@@
 struct ocrdma_pd_resource_mgr cocci_id@p ;
...
position p;
@@
 struct ocrdma_get_ctrl_attribs_rsp cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_ah_tbl_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_srq_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_eq_rsp * cocci_id@p ;
...
position p;
@@
 enum cqe_status { OCRDMA_MBX_CQE_STATUS_INSUFFICIENT_PRIVILEDGES = 1 , OCRDMA_MBX_CQE_STATUS_INVALID_PARAMETER = 2 , OCRDMA_MBX_CQE_STATUS_INSUFFICIENT_RESOURCES = 3 , OCRDMA_MBX_CQE_STATUS_QUEUE_FLUSHING = 4 , OCRDMA_MBX_CQE_STATUS_DMA_FAILED = 5 , } cocci_id@p ;
...
position p;
@@
 struct ocrdma_alloc_pd_range_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_rdma_stats_req * cocci_id@p ;
...
position p;
@@
 struct ocrdma_modify_eqd_req * cocci_id@p ;
...
position p;
@@
 struct ocrdma_modify_srq * cocci_id@p ;
...
position p;
@@
 enum ocrdma_qp_state cocci_id@p ;
...
position p;
@@
 struct ocrdma_queue_info * cocci_id@p ;
...
position p;
@@
 struct ocrdma_ae_lnkst_mcqe * cocci_id@p ;
...
position p;
@@
 struct ocrdma_reg_nsmr * cocci_id@p ;
...
position p;
@@
 enum additional_status { OCRDMA_MBX_ADDI_STATUS_INSUFFICIENT_RESOURCES = 22 , } cocci_id@p ;
...
position p;
@@
 struct ocrdma_dma_mem cocci_id@p ;
...
position p;
@@
 struct ocrdma_mqe_hdr cocci_id@p ;
...
position p;
@@
 struct ocrdma_dealloc_lkey * cocci_id@p ;
...
position p;
@@
 struct ocrdma_fw_conf_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_ah_tbl * cocci_id@p ;
...
position p;
@@
 struct ocrdma_alloc_pd_range * cocci_id@p ;
...
position p;
@@
 struct ocrdma_alloc_lkey * cocci_id@p ;
...
position p;
@@
 struct ocrdma_reg_nsmr_rsp * cocci_id@p ;
...
position p;
@@
 struct ocrdma_app_parameter * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_qp_req * cocci_id@p ;
