...
position p;
@@
 struct dpni_rule_cfg cocci_id@p ;
...
position p;
@@
 struct dpni_fs_action_cfg cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ DPNI_STATISTICS_CNT ] ;
...
position p;
@@
 struct ethtool_flow_ext * cocci_id@p ;
...
position p;
@@
 struct dpaa2_eth_ch_stats * cocci_id@p ;
