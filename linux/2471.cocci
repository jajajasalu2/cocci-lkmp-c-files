...
position p;
@@
 struct ioat_ring_ent cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ioatdma_device * ioat_dma ) ;
...
position p;
@@
 struct ioatdma_chan * cocci_id@p ;
...
position p;
@@
 struct ioatdma_device * cocci_id@p ;
...
typedef dma_addr_t;
@@
 dma_addr_t cocci_id@p [ IOAT_NUM_SRC_TEST + 1 ] ;
...
position p;
@@
 int cocci_id@p ( struct ioatdma_device * ioat_dma ) ;
...
position p;
@@
 struct page * cocci_id@p [ IOAT_NUM_SRC_TEST + 1 ] ;
...
position p;
@@
 void cocci_id@p ( struct ioatdma_device * ioat_dma , struct ioatdma_chan * ioat_chan , int idx ) ;
...
position p;
@@
 struct page * cocci_id@p [ IOAT_NUM_SRC_TEST ] ;
