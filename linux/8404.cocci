...
position p;
@@
 struct ks8842_rx_dma_ctl {  struct dma_chan * chan ;  struct dma_async_tx_descriptor * adesc ;  struct sk_buff * skb ;  struct scatterlist sg ;  struct tasklet_struct tasklet ;  int channel ; } cocci_id@p ;
...
position p;
@@
 struct ks8842_adapter * cocci_id@p ;
...
position p;
@@
 struct ks8842_tx_dma_ctl {  struct dma_chan * chan ;  struct dma_async_tx_descriptor * adesc ;  void * buf ;  struct scatterlist sg ;  int channel ; } cocci_id@p ;
...
position p;
@@
 struct ks8842_tx_dma_ctl * cocci_id@p ;
...
position p;
@@
 struct ks8842_rx_dma_ctl * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct ks8842_adapter {  void __iomem * hw_addr ;  int irq ;  unsigned long conf_flags ;  struct tasklet_struct tasklet ;  spinlock_t lock ;  struct work_struct timeout_work ;  struct net_device * netdev ;  struct device * dev ;  struct ks8842_tx_dma_ctl dma_tx ;  struct ks8842_rx_dma_ctl dma_rx ; } cocci_id@p ;
