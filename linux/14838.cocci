...
position p;
@@
 const struct oxnas_stdclk_data * cocci_id@p ;
...
position p;
@@
 struct clk_oxnas_gate * cocci_id@p [ ] ;
...
position p;
@@
 struct clk_oxnas_gate {  struct clk_hw hw ;  unsigned int bit ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct oxnas_stdclk_data {  struct clk_hw_onecell_data * onecell_data ;  struct clk_oxnas_gate * * gates ;  unsigned int ngates ;  struct clk_oxnas_pll * * plls ;  unsigned int nplls ; } cocci_id@p ;
...
position p;
@@
 struct oxnas_stdclk_data cocci_id@p ;
