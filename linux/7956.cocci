...
@@
 struct smsc75xx_priv {  struct usbnet * dev ;  u32 rfe_ctl ;  u32 wolopts ;  u32 multicast_hash_table [ DP_SEL_VHF_HASH_LEN ] ;  struct mutex dataport_mutex ;  spinlock_t rfe_ctl_lock ;  struct work_struct set_multicast ;  u8 suspend_flags ; } cocci_id@p ;
...
position p;
@@
 struct smsc75xx_priv * cocci_id@p ;
...
position p;
@@
 struct usb_context {  struct usb_ctrlrequest req ;  struct usbnet * dev ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usbnet * dev ) ;
