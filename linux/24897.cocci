...
position p;
@@
 struct l2tp_ip6_sock * cocci_id@p ;
...
position p;
@@
 const struct l2tp_ip6_sock * cocci_id@p ;
...
typedef u32;
@@
 struct l2tp_ip6_sock {  struct inet_sock inet ;  u32 conn_id ;  u32 peer_conn_id ;  struct ipv6_pinfo inet6 ; } cocci_id@p ;
