...
position p;
@@
 enum fe_stv0900_rolloff cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_fec cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_search_standard cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_search_algo cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_signal_type cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_tracking_standard cocci_id@p ;
