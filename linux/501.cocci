...
symbol cocci_id;
position p;
typedef bool,acquire_inflight_cb_t;
@@
 struct rq_qos_wait_data {  struct wait_queue_entry wq ;  struct task_struct * task ;  struct rq_wait * rqw ;  acquire_inflight_cb_t * cb ;  void * private_data ;  bool got_token ; } cocci_id@p ;
...
position p;
@@
 struct rq_qos_wait_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef acquire_inflight_cb_t;
@@
 acquire_inflight_cb_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cleanup_cb_t;
@@
 cleanup_cb_t * cocci_id@p ;
