...
typedef u32;
@@
 struct ep_tb_s {  u32 alt ;  u32 bandwidth ; } cocci_id@p ;
...
position p;
@@
 struct gspca_buffer cocci_id@p ;
...
position p;
@@
 enum gspca_packet_type cocci_id@p ;
...
position p;
@@
 struct ep_tb_s cocci_id@p [ MAX_ALT ] ;
