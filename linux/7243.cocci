...
position p;
@@
 struct btmtksdio_dev cocci_id@p ;
...
position p;
@@
 struct btmtksdio_data {  const char * fwname ; } cocci_id@p ;
...
position p;
@@
 struct mtkbtsdio_hdr * cocci_id@p ;
...
position p;
@@
 const struct btmtksdio_data cocci_id@p ;
...
position p;
@@
 struct btmtksdio_dev {  struct hci_dev * hdev ;  struct sdio_func * func ;  struct device * dev ;  struct work_struct tx_work ;  unsigned long tx_state ;  struct sk_buff_head txq ;  struct sk_buff * evt_skb ;  const struct btmtksdio_data * data ; } cocci_id@p ;
...
position p;
@@
 struct mtk_hci_wmt_cmd cocci_id@p ;
...
position p;
@@
 const struct sdio_device_id * cocci_id@p ;
...
position p;
@@
 enum { MTK_WMT_PATCH_DWNLD = 0x1 , MTK_WMT_TEST = 0x2 , MTK_WMT_WAKEUP = 0x3 , MTK_WMT_HIF = 0x4 , MTK_WMT_FUNC_CTRL = 0x6 , MTK_WMT_RST = 0x7 , MTK_WMT_SEMAPHORE = 0x17 , } cocci_id@p ;
