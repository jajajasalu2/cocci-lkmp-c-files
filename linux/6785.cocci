...
position p;
@@
 int cocci_id@p ( unsigned long , char * ) ;
...
position p;
@@
 struct NCR5380_hostdata cocci_id@p ;
...
position p;
@@
 struct sun3_udc_regs {  unsigned short rsel ;  unsigned short addr_hi ;  unsigned short addr_lo ;  unsigned short count ;  unsigned short mode_hi ;  unsigned short mode_lo ; } cocci_id@p ;
...
position p;
@@
 volatile struct sun3_dma_regs * cocci_id@p ;
...
position p;
@@
 struct sun3_udc_regs * cocci_id@p ;
...
position p;
@@
 struct sun3_dma_regs * cocci_id@p ;
...
position p;
@@
 struct sun3_dma_regs {  unsigned short dma_addr_hi ;  unsigned short dma_addr_lo ;  unsigned short dma_count_hi ;  unsigned short dma_count_lo ;  unsigned short udc_data ;  unsigned short udc_addr ;  unsigned short fifo_data ;  unsigned short fifo_count ;  unsigned short csr ;  unsigned short bpack_hi ;  unsigned short bpack_lo ;  unsigned short ivect ;  unsigned short fifo_count_hi ; } cocci_id@p ;
