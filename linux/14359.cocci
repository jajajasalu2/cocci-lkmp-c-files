...
position p;
@@
 enum lgdt3305_tp_clock_mode cocci_id@p ;
...
position p;
@@
 struct lgdt3305_state cocci_id@p ;
...
position p;
@@
 struct lgdt3305_reg * cocci_id@p ;
...
position p;
@@
 enum lgdt3305_tp_clock_edge cocci_id@p ;
...
position p;
@@
 enum lgdt3305_tp_valid_polarity cocci_id@p ;
...
typedef u8,u16;
@@
 struct lgdt3305_reg {  u16 reg ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 enum lgdt3305_mpeg_mode cocci_id@p ;
...
position p;
@@
 const struct lgdt3305_config * cocci_id@p ;
...
typedef u32;
@@
 struct lgdt3305_state {  struct i2c_adapter * i2c_adap ;  const struct lgdt3305_config * cfg ;  struct dvb_frontend frontend ;  enum fe_modulation current_modulation ;  u32 current_frequency ;  u32 snr ; } cocci_id@p ;
