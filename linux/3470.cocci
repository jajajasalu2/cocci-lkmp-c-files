...
typedef spinlock_t;
@@
 struct aspeed_sdc {  struct clk * clk ;  struct resource * res ;  spinlock_t lock ;  void __iomem * regs ; } cocci_id@p ;
...
typedef u32;
@@
 struct aspeed_sdhci {  struct aspeed_sdc * parent ;  u32 width_mask ; } cocci_id@p ;
...
position p;
@@
 struct aspeed_sdhci * cocci_id@p ;
