...
position p;
@@
 struct hash_netnet4_elem cocci_id@p ;
...
position p;
@@
 const struct hash_netnet4_elem * cocci_id@p ;
...
@@
 struct hash_netnet4_elem {  union {  __be32 ip [ 2 ] ;  __be64 ipcmp ; } ;  u8 nomatch ;  u8 padding ;  union {  u8 cidr [ 2 ] ;  u16 ccmp ; } ; } cocci_id@p ;
...
position p;
@@
 struct hash_netnet6_elem * cocci_id@p ;
...
typedef u8,u16;
@@
 struct hash_netnet6_elem {  union nf_inet_addr ip [ 2 ] ;  u8 nomatch ;  u8 padding ;  union {  u8 cidr [ 2 ] ;  u16 ccmp ; } ; } cocci_id@p ;
...
position p;
@@
 const struct hash_netnet4 * cocci_id@p ;
...
position p;
@@
 const struct hash_netnet6 * cocci_id@p ;
...
position p;
@@
 const struct hash_netnet6_elem * cocci_id@p ;
