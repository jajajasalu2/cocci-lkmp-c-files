...
position p;
@@
 struct vcpu_register_vcpu_info cocci_id@p ;
...
position p;
@@
 struct sched_shutdown cocci_id@p ;
...
position p;
@@
 enum xen_domain_type cocci_id@p ;
...
typedef bool;
@@
 struct {  const char * compat ;  const char * prefix ;  const char * version ;  bool found ; } cocci_id@p ;
