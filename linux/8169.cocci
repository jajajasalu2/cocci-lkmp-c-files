...
position p;
@@
 struct hcp_ehea_port_cb0 * cocci_id@p ;
...
position p;
@@
 struct ehea_mc_list * cocci_id@p ;
...
position p;
@@
 struct hcp_ehea_port_cb7 * cocci_id@p ;
...
position p;
@@
 struct port_res_cfg * cocci_id@p ;
...
position p;
@@
 struct hcp_ehea_port_cb4 * cocci_id@p ;
...
position p;
@@
 struct ehea_adapter * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct platform_device * dev ) ;
...
position p;
@@
 struct hcp_ehea_port_cb2 * cocci_id@p ;
...
position p;
@@
 struct ehea_port_res cocci_id@p ;
...
position p;
@@
 struct hcp_query_ehea * cocci_id@p ;
...
position p;
@@
 struct hcp_modify_qp_cb0 * cocci_id@p ;
...
position p;
@@
 struct ehea_vsgentry * cocci_id@p ;
...
position p;
@@
 struct ehea_qp_init_attr * cocci_id@p ;
...
position p;
@@
 struct ehea_fw_handle_entry * cocci_id@p ;
...
position p;
@@
 struct ehea_q_skb_arr * cocci_id@p ;
...
position p;
@@
 struct ehea_bcmc_reg_array cocci_id@p ;
...
position p;
@@
 struct ehea_bcmc_reg_entry * cocci_id@p ;
...
position p;
@@
 struct ehea_fw_handle_array cocci_id@p ;
...
position p;
@@
 struct hcp_ehea_port_cb1 * cocci_id@p ;
