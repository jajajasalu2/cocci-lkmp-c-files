...
position p;
@@
 struct sd {  struct gspca_dev gspca_dev ;  unsigned int this_f ;  struct v4l2_ctrl * blue ;  struct v4l2_ctrl * red ; } cocci_id@p ;
...
typedef u16;
@@
 struct cmd {  u16 value ;  u16 index ; } cocci_id@p ;
