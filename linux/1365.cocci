...
position p;
@@
 struct parport_uss720_private * cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 9 ] ;
...
@@
 struct parport_uss720_private {  struct usb_device * usbdev ;  struct parport * pp ;  struct kref ref_count ;  __u8 reg [ 7 ] ;  struct list_head asynclist ;  spinlock_t asynclock ; } cocci_id@p ;
...
typedef __u8;
@@
 struct uss720_async_request {  struct parport_uss720_private * priv ;  struct kref ref_count ;  struct list_head asynclist ;  struct completion compl ;  struct urb * urb ;  struct usb_ctrlrequest * dr ;  __u8 reg [ 7 ] ; } cocci_id@p ;
...
position p;
@@
 struct uss720_async_request * cocci_id@p ;
