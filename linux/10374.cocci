...
position p;
@@
 const char * const cocci_id@p [ MTK_DDP_COMP_TYPE_MAX ] ;
...
position p;
@@
 enum mtk_ddp_comp_type cocci_id@p ;
...
position p;
@@
 const struct mtk_ddp_comp_match cocci_id@p [ DDP_COMPONENT_ID_MAX ] ;
...
position p;
@@
 struct mtk_ddp_comp_match {  enum mtk_ddp_comp_type type ;  int alias_id ;  const struct mtk_ddp_comp_funcs * funcs ; } cocci_id@p ;
