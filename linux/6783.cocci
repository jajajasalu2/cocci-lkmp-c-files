...
position p;
@@
 struct set_phy_profile_req cocci_id@p ;
...
position p;
@@
 struct set_phy_profile_resp * cocci_id@p ;
...
position p;
@@
 struct set_ctrl_cfg_resp * cocci_id@p ;
...
position p;
@@
 struct kek_mgmt_resp * cocci_id@p ;
...
position p;
@@
 struct phy_stop_resp * cocci_id@p ;
...
position p;
@@
 struct set_ctrl_cfg_req cocci_id@p ;
...
position p;
@@
 struct kek_mgmt_req cocci_id@p ;
...
position p;
@@
 struct thermal_hw_event * cocci_id@p ;
...
position p;
@@
 struct phy_start_resp * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SASProtocolTimerConfig_t;
@@
 SASProtocolTimerConfig_t cocci_id@p ;
