...
position p;
@@
 struct kernfs_open_node * cocci_id@p ;
...
@@
 struct kernfs_open_node {  atomic_t refcnt ;  atomic_t event ;  wait_queue_head_t poll ;  struct list_head files ; } cocci_id@p ;
...
position p;
@@
 const struct kernfs_ops * cocci_id@p ;
...
position p;
@@
 struct kernfs_super_info * cocci_id@p ;
