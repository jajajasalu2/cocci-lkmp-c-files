...
position p;
@@
 struct ipc_proc_iface {  const char * path ;  const char * header ;  int ids ;  int ( * show ) ( struct seq_file * , void * ) ; } cocci_id@p ;
...
position p;
@@
 struct ipc_proc_iface * cocci_id@p ;
...
position p;
@@
 struct ipc_proc_iter * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct rcu_head * head ) ;
...
position p;
@@
 struct ipc_proc_iter {  struct ipc_namespace * ns ;  struct pid_namespace * pid_ns ;  struct ipc_proc_iface * iface ; } cocci_id@p ;
