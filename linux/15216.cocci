...
position p;
@@
 struct wm831x_status * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct wm831x_status {  struct led_classdev cdev ;  struct wm831x * wm831x ;  struct mutex mutex ;  spinlock_t value_lock ;  int reg ;  int reg_val ;  int blink ;  int blink_time ;  int blink_cyc ;  int src ;  enum led_brightness brightness ; } cocci_id@p ;
