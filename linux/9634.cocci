...
position p;
@@
 const struct locale_mimo_info cocci_id@p ;
...
typedef u8;
@@
 struct country_info {  const u8 locale_mimo_2G ;  const u8 locale_mimo_5G ; } cocci_id@p ;
...
position p;
@@
 struct brcms_regd {  struct country_info country ;  const struct ieee80211_regdomain * regdomain ; } cocci_id@p ;
...
position p;
@@
 struct brcms_cm_info cocci_id@p ;
...
position p;
@@
 const struct country_info * cocci_id@p ;
...
typedef s8;
@@
 struct locale_mimo_info {  s8 maxpwr20 [ BRCMS_MAXPWR_MIMO_TBL_SIZE ] ;  s8 maxpwr40 [ BRCMS_MAXPWR_MIMO_TBL_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 const struct brcms_regd * cocci_id@p ;
...
position p;
@@
 struct brcms_cm_info {  struct brcms_pub * pub ;  struct brcms_c_info * wlc ;  const struct brcms_regd * world_regd ; } cocci_id@p ;
