...
position p;
@@
 struct wusb_keydvt_out cocci_id@p ;
...
position p;
@@
 const struct wusb_keydvt_in cocci_id@p ;
...
position p;
@@
 const struct wusb_keydvt_out cocci_id@p ;
...
position p;
@@
 const struct aes_ccm_nonce * cocci_id@p ;
...
position p;
@@
 struct wusb_mac_scratch * cocci_id@p ;
...
position p;
@@
 const struct aes_ccm_label * cocci_id@p ;
...
position p;
@@
 const struct usb_handshake cocci_id@p ;
...
position p;
@@
 struct wusb_mac_scratch {  struct aes_ccm_b0 b0 ;  struct aes_ccm_b1 b1 ;  struct aes_ccm_a ax ; } cocci_id@p ;
...
position p;
@@
 struct aes_ccm_block cocci_id@p ;
...
position p;
@@
 struct aes_ccm_nonce cocci_id@p ;
