...
position p;
@@
 struct tegra_output * cocci_id@p ;
...
typedef u32;
@@
 struct tegra_sor_config {  u32 bits_per_pixel ;  u32 active_polarity ;  u32 active_count ;  u32 tu_size ;  u32 active_frac ;  u32 watermark ;  u32 hblank_symbols ;  u32 vblank_symbols ; } cocci_id@p ;
...
position p;
@@
 const struct drm_info_list cocci_id@p [ ] ;
...
typedef u8;
@@
 struct tegra_sor_hdmi_settings {  unsigned long frequency ;  u8 vcocap ;  u8 filter ;  u8 ichpmp ;  u8 loadadj ;  u8 tmds_termadj ;  u8 tx_pu_value ;  u8 bg_temp_coef ;  u8 bg_vref_level ;  u8 avdd10_level ;  u8 avdd14_level ;  u8 sparepll ;  u8 drive_current [ 4 ] ;  u8 preemphasis [ 4 ] ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HDMI_INFOFRAME_SIZE ( AUDIO ) ] ;
...
position p;
@@
 const struct drm_dp_link_ops cocci_id@p ;
...
position p;
@@
 const struct tegra_sor_soc * cocci_id@p ;
...
position p;
@@
 struct tegra_sor_state {  struct drm_connector_state base ;  unsigned int link_speed ;  unsigned long pclk ;  unsigned int bpc ; } cocci_id@p ;
...
position p;
@@
 struct tegra_sor_state * cocci_id@p ;
...
position p;
@@
 const struct debugfs_reg32 cocci_id@p [ ] ;
...
position p;
@@
 const struct tegra_sor_regs cocci_id@p ;
...
position p;
@@
 struct host1x_client * cocci_id@p ;
...
position p;
@@
 struct tegra_sor_params * cocci_id@p ;
...
position p;
@@
 struct tegra_sor_hdmi_settings * cocci_id@p ;
...
position p;
@@
 struct tegra_sor_ops {  const char * name ;  int ( * probe ) ( struct tegra_sor * sor ) ;  int ( * remove ) ( struct tegra_sor * sor ) ;  void ( * audio_enable ) ( struct tegra_sor * sor ) ;  void ( * audio_disable ) ( struct tegra_sor * sor ) ; } cocci_id@p ;
...
position p;
@@
 struct drm_display_info * cocci_id@p ;
...
position p;
@@
 struct tegra_sor_config cocci_id@p ;
...
position p;
@@
 const struct tegra_sor_config * cocci_id@p ;
...
position p;
@@
 const struct host1x_client_ops cocci_id@p ;
...
typedef u8,bool;
@@
 struct tegra_sor_soc {  bool supports_lvds ;  bool supports_hdmi ;  bool supports_dp ;  bool supports_audio ;  bool supports_hdcp ;  const struct tegra_sor_regs * regs ;  bool has_nvdisplay ;  const struct tegra_sor_hdmi_settings * settings ;  unsigned int num_settings ;  const u8 * xbar_cfg ;  const u8 * lane_map ;  const u8 * voltage_swing [ 4 ] [ 4 ] ;  const u8 * pre_emphasis [ 4 ] [ 4 ] ;  const u8 * post_cursor [ 4 ] [ 4 ] ;  const u8 * tx_pu [ 4 ] [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct hdmi_audio_infoframe cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HDMI_INFOFRAME_SIZE ( AVI ) ] ;
...
position p;
@@
 const struct tegra_sor_hdmi_settings cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_sor_regs {  unsigned int head_state0 ;  unsigned int head_state1 ;  unsigned int head_state2 ;  unsigned int head_state3 ;  unsigned int head_state4 ;  unsigned int head_state5 ;  unsigned int pll0 ;  unsigned int pll1 ;  unsigned int pll2 ;  unsigned int pll3 ;  unsigned int dp_padctl0 ;  unsigned int dp_padctl2 ; } cocci_id@p ;
...
position p;
@@
 struct tegra_clk_sor_pad * cocci_id@p ;
...
position p;
@@
 struct tegra_clk_sor_pad {  struct clk_hw hw ;  struct tegra_sor * sor ; } cocci_id@p ;
...
typedef u64;
@@
 struct tegra_sor_params {  unsigned int num_clocks ;  u64 ratio ;  u64 precision ;  unsigned int active_polarity ;  unsigned int active_count ;  unsigned int active_frac ;  unsigned int tu_size ;  unsigned int error ; } cocci_id@p ;
...
position p;
@@
 struct drm_info_node * cocci_id@p ;
...
position p;
@@
 const struct tegra_sor_ops cocci_id@p ;
