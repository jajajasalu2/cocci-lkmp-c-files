...
position p;
@@
 acpi_adr_space_setup cocci_id@p ;
...
position p;
@@
 union acpi_operand_object * cocci_id@p [ 3 ] ;
...
position p;
@@
 struct acpi_reg_walk_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct acpi_namespace_node * ec_device_node ) ;
...
position p;
@@
 struct acpi_connection_info * cocci_id@p ;
...
position p;
@@
 acpi_adr_space_handler cocci_id@p ;
...
@@
 acpi_status cocci_id@p ( acpi_handle obj_handle , u32 level , void * context , void * * return_value ) ;
