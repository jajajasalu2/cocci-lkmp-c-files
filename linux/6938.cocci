...
@@
 struct w1_cb_block {  atomic_t refcnt ;  u32 portid ;  u16 maxlen ;  struct cn_msg * first_cn ;  struct cn_msg * cn ;  struct w1_netlink_msg * msg ;  struct w1_netlink_cmd * cmd ;  struct w1_netlink_msg * cur_msg ;  struct cn_msg request_cn ; } cocci_id@p ;
...
position p;
@@
 struct w1_cb_node {  struct w1_async_cmd async ;  struct w1_cb_block * block ;  struct w1_netlink_msg * msg ;  struct w1_slave * sl ;  struct w1_master * dev ; } cocci_id@p ;
...
position p;
@@
 struct w1_netlink_cmd cocci_id@p ;
...
position p;
@@
 struct w1_netlink_msg * cocci_id@p ;
...
position p;
@@
 struct {  struct cn_msg cn ;  struct w1_netlink_msg msg ; } cocci_id@p ;
...
position p;
@@
 struct w1_async_cmd * cocci_id@p ;
