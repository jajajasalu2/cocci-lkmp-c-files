...
position p;
@@
 void cocci_id@p ( struct rpc_xprt * xprt , struct net * net ) ;
...
position p;
@@
 enum xprt_xid_rb_cmp cocci_id@p ;
...
position p;
@@
 enum xprt_xid_rb_cmp { XID_RB_EQUAL , XID_RB_LEFT , XID_RB_RIGHT , } cocci_id@p ;
