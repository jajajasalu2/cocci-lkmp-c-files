...
position p;
@@
 struct amdgpu_i2c_chan cocci_id@p ;
...
position p;
@@
 union aux_channel_transaction cocci_id@p ;
...
position p;
@@
 struct amdgpu_atombios_dp_link_train_info cocci_id@p ;
...
position p;
@@
 DP_ENCODER_SERVICE_PARAMETERS cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ DP_DPCD_SIZE ] ;
...
position p;
@@
 union aux_channel_transaction {  PROCESS_AUX_CHANNEL_TRANSACTION_PS_ALLOCATION v1 ;  PROCESS_AUX_CHANNEL_TRANSACTION_PARAMETERS_V2 v2 ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct amdgpu_atombios_dp_link_train_info {  struct amdgpu_device * adev ;  struct drm_encoder * encoder ;  struct drm_connector * connector ;  int dp_clock ;  int dp_lane_count ;  bool tp3_supported ;  u8 dpcd [ DP_RECEIVER_CAP_SIZE ] ;  u8 train_set [ 4 ] ;  u8 link_status [ DP_LINK_STATUS_SIZE ] ;  u8 tries ;  struct drm_dp_aux * aux ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ DP_LINK_STATUS_SIZE ] ;
