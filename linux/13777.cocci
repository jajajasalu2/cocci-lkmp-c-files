...
position p;
@@
 enum mt9p031_model { MT9P031_MODEL_COLOR , MT9P031_MODEL_MONOCHROME , } cocci_id@p ;
...
position p;
@@
 const struct aptina_pll_limits cocci_id@p ;
...
typedef bool,u16;
@@
 struct mt9p031 {  struct v4l2_subdev subdev ;  struct media_pad pad ;  struct v4l2_rect crop ;  struct v4l2_mbus_framefmt format ;  struct mt9p031_platform_data * pdata ;  struct mutex power_lock ;  int power_count ;  struct clk * clk ;  struct regulator_bulk_data regulators [ 3 ] ;  enum mt9p031_model model ;  struct aptina_pll pll ;  unsigned int clk_div ;  bool use_pll ;  struct gpio_desc * reset ;  struct v4l2_ctrl_handler ctrls ;  struct v4l2_ctrl * blc_auto ;  struct v4l2_ctrl * blc_offset ;  u16 output_control ;  u16 mode2 ; } cocci_id@p ;
...
position p;
@@
 struct mt9p031_platform_data * cocci_id@p ;
