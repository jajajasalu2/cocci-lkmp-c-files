...
position p;
@@
 void cocci_id@p ( struct gpio_chip * chip , unsigned gpio , int value ) ;
...
typedef spinlock_t;
@@
 struct dc_pinmap {  void __iomem * regs ;  struct device * dev ;  struct pinctrl_dev * pctl ;  struct pinctrl_desc * desc ;  const char * pin_names [ PINS_COUNT ] ;  struct gpio_chip chip ;  spinlock_t lock ; } cocci_id@p ;
