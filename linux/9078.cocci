...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( general_obj_in_cmd_hdr ) ] ;
...
typedef u8,u32;
@@
 struct mlx5_geneve {  struct mlx5_core_dev * mdev ;  __be16 opt_class ;  u8 opt_type ;  u32 obj_id ;  struct mutex sync_lock ;  u32 refcount ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_geneve_tlv_option_in ) ] ;
