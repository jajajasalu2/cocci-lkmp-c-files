...
position p;
@@
 struct interact {  struct gameport * gameport ;  struct input_dev * dev ;  int bads ;  int reads ;  unsigned char type ;  unsigned char length ;  char phys [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct interact_type cocci_id@p [ ] ;
...
position p;
@@
 struct interact_type {  int id ;  short * abs ;  short * btn ;  char * name ;  unsigned char length ;  unsigned char b8 ; } cocci_id@p ;
