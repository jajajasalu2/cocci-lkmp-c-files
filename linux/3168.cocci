...
typedef u16;
@@
 const u16 cocci_id@p [ SCH5636_NO_TEMPS ] ;
...
typedef u8,u16;
@@
 struct sch5636_data {  unsigned short addr ;  struct device * hwmon_dev ;  struct sch56xx_watchdog_data * watchdog ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u8 in [ SCH5636_NO_INS ] ;  u8 temp_val [ SCH5636_NO_TEMPS ] ;  u8 temp_ctrl [ SCH5636_NO_TEMPS ] ;  u16 fan_val [ SCH5636_NO_FANS ] ;  u8 fan_ctrl [ SCH5636_NO_FANS ] ; } cocci_id@p ;
...
position p;
@@
 struct sch5636_data cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ SCH5636_NO_INS ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ SCH5636_NO_FANS ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ SCH5636_NO_INS ] ;
