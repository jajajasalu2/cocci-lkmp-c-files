...
typedef u8;
@@
 u8 * cocci_id@p [ RTW_RATE_SECTION_MAX ] ;
...
position p;
@@
 struct phy_cfg_pair cocci_id@p ;
...
position p;
@@
 enum rtw_phy_band_type { PHY_BAND_2G = 0 , PHY_BAND_5G = 1 , } cocci_id@p ;
...
position p;
@@
 struct rtw_5g_txpwr_idx * cocci_id@p ;
...
position p;
@@
 struct rtw_phy_cond cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RA_FLOOR_TABLE_SIZE ] ;
...
position p;
@@
 struct rtw_phy_stat_iter_data cocci_id@p ;
...
position p;
@@
 const struct rtw_phy_pg_cfg_pair * cocci_id@p ;
...
position p;
@@
 struct rtw_sta_info * cocci_id@p ;
...
position p;
@@
 union phy_table_tile {  struct rtw_phy_cond cond ;  struct phy_cfg_pair cfg ; } cocci_id@p ;
...
typedef u8;
@@
 struct rtw_phy_stat_iter_data {  struct rtw_dev * rtwdev ;  u8 min_rssi ; } cocci_id@p ;
...
typedef u32;
@@
 struct phy_cfg_pair {  u32 addr ;  u32 data ; } cocci_id@p ;
...
position p;
@@
 struct rtw_power_params * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ RTW_MAX_CHANNEL_NUM_5G ] ;
...
position p;
@@
 const struct rtw_txpwr_lmt_cfg_pair * cocci_id@p ;
...
position p;
@@
 struct rtw_txpwr_idx * cocci_id@p ;
...
position p;
@@
 struct rtw_2g_txpwr_idx * cocci_id@p ;
...
position p;
@@
 const union phy_table_tile * cocci_id@p ;
...
position p;
@@
 union phy_table_tile cocci_id@p ;
