...
position p;
@@
 struct asd_ddb_sata_tag cocci_id@p ;
...
position p;
@@
 struct asd_ddb_ssp_smp_target_port cocci_id@p ;
...
position p;
@@
 struct asd_ddb_stp_sata_target_port cocci_id@p ;
...
position p;
@@
 struct asd_ddb_sata_pm_port cocci_id@p ;
