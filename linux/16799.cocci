...
position p;
@@
 const struct regulator_haptic_data * cocci_id@p ;
...
position p;
@@
 struct regulator_haptic * cocci_id@p ;
...
typedef bool;
@@
 struct regulator_haptic {  struct device * dev ;  struct input_dev * input_dev ;  struct regulator * regulator ;  struct work_struct work ;  struct mutex mutex ;  bool active ;  bool suspended ;  unsigned int max_volt ;  unsigned int min_volt ;  unsigned int magnitude ; } cocci_id@p ;
