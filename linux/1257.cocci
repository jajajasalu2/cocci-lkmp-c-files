...
typedef bool;
@@
 struct tegra_ehci_soc_config {  bool has_hostpc ; } cocci_id@p ;
...
position p;
@@
 struct dma_aligned_buffer * cocci_id@p ;
...
position p;
@@
 const struct tegra_ehci_soc_config * cocci_id@p ;
...
position p;
@@
 const struct ehci_driver_overrides cocci_id@p ;
...
typedef u8;
@@
 struct dma_aligned_buffer {  void * kmalloc_ptr ;  void * old_xfer_buffer ;  u8 data [ 0 ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct tegra_ehci_hcd {  struct tegra_usb_phy * phy ;  struct clk * clk ;  struct reset_control * rst ;  int port_resuming ;  bool needs_double_reset ;  enum tegra_usb_phy_port_speed port_speed ; } cocci_id@p ;
...
position p;
@@
 struct tegra_ehci_hcd cocci_id@p ;
