...
position p;
@@
 struct tegra_rtc_info * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct tegra_rtc_info {  struct platform_device * pdev ;  struct rtc_device * rtc ;  void __iomem * base ;  struct clk * clk ;  int irq ;  spinlock_t lock ; } cocci_id@p ;
