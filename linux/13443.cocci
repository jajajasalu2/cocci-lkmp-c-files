...
symbol cocci_id;
position p;
typedef flexcop_access_op_t;
@@
 flexcop_access_op_t cocci_id@p ;
...
position p;
@@
 flexcop_ibi_register cocci_id@p ;
...
symbol cocci_id;
position p;
typedef flexcop_usb_i2c_function_t;
@@
 flexcop_usb_i2c_function_t cocci_id@p ;
...
position p;
@@
 struct flexcop_i2c_adapter * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef flexcop_usb_request_t;
@@
 flexcop_usb_request_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef flexcop_usb_mem_page_t;
@@
 flexcop_usb_mem_page_t cocci_id@p ;
