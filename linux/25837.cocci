...
position p;
@@
 struct options {  int so_timestamp ;  int so_timestampns ;  int so_timestamping ; } cocci_id@p ;
...
position p;
@@
 struct scm_timestamping * cocci_id@p ;
...
typedef bool;
@@
 struct tstamps {  bool tstamp ;  bool tstampns ;  bool swtstamp ;  bool hwtstamp ; } cocci_id@p ;
...
typedef bool;
@@
 struct socket_type {  char * friendly_name ;  int type ;  int protocol ;  bool enabled ; } cocci_id@p ;
...
position p;
@@
 struct sof_flag {  int mask ;  char * name ; } cocci_id@p ;
...
typedef bool;
@@
 struct test_case {  struct options sockopt ;  struct tstamps expected ;  bool enabled ; } cocci_id@p ;
