...
position p;
@@
 struct qib_sl2vl_attr * cocci_id@p ;
...
position p;
@@
 struct qib_sl2vl_attr {  struct attribute attr ;  int sl ; } cocci_id@p ;
...
position p;
@@
 struct ib_cc_congestion_setting_attr_shadow cocci_id@p ;
...
position p;
@@
 struct qib_diagc_attr {  struct attribute attr ;  size_t counter ; } cocci_id@p ;
...
position p;
@@
 struct qib_diagc_attr cocci_id@p ;
...
position p;
@@
 struct qib_port_attr cocci_id@p ;
