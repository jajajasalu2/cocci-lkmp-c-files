...
position p;
@@
 struct gb_control_connected_request cocci_id@p ;
...
position p;
@@
 struct gb_control_disconnected_request cocci_id@p ;
...
position p;
@@
 struct gb_control_bundle_pm_response cocci_id@p ;
...
position p;
@@
 struct gb_control_disconnecting_request * cocci_id@p ;
...
position p;
@@
 struct gb_control_bundle_pm_request cocci_id@p ;
...
position p;
@@
 struct gb_control_version_request cocci_id@p ;
...
position p;
@@
 struct gb_control_get_manifest_size_response cocci_id@p ;
...
position p;
@@
 struct gb_control_bundle_version_request cocci_id@p ;
...
position p;
@@
 struct gb_control_version_response cocci_id@p ;
...
position p;
@@
 struct gb_control_intf_pm_response cocci_id@p ;
...
position p;
@@
 struct gb_control_bundle_version_response cocci_id@p ;
