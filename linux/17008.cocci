...
typedef u16;
@@
 struct mip4_fw_version {  u16 boot ;  u16 core ;  u16 app ;  u16 param ; } cocci_id@p ;
...
position p;
@@
 struct mip4_fw_version cocci_id@p ;
...
position p;
@@
 const struct mip4_bin_tail * * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( ts -> fw_version ) ] ;
...
position p;
@@
 struct mip4_bin_tail cocci_id@p ;
