...
typedef guid_t;
@@
 struct ucsi_acpi {  struct device * dev ;  struct ucsi * ucsi ;  void __iomem * base ;  struct completion complete ;  unsigned long flags ;  guid_t guid ; } cocci_id@p ;
