...
position p;
@@
 void cocci_id@p ( struct i2c_client * c , unsigned int freq ) ;
...
position p;
@@
 enum if_vid_dec_pad_index { IF_VID_DEC_PAD_IF_INPUT , IF_VID_DEC_PAD_OUT , IF_VID_DEC_PAD_NUM_PADS , } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * dev , int component , int cmd , int arg ) ;
...
position p;
@@
 struct analog_demod_ops cocci_id@p ;
...
position p;
@@
 const struct analog_demod_ops cocci_id@p ;
...
position p;
@@
 struct analog_parameters cocci_id@p ;
...
typedef bool;
@@
 struct tuner {  struct dvb_frontend fe ;  struct i2c_client * i2c ;  struct v4l2_subdev sd ;  struct list_head list ;  v4l2_std_id std ;  unsigned int tv_freq ;  unsigned int radio_freq ;  unsigned int audmode ;  enum v4l2_tuner_type mode ;  unsigned int mode_mask ;  bool standby ;  unsigned int type ;  void * config ;  const char * name ; #if defined(CONFIG_MEDIA_CONTROLLER)  struct media_pad pad [ TUNER_NUM_PADS ] ; #endif } cocci_id@p ;
...
position p;
@@
 const struct v4l2_priv_tun_config * cocci_id@p ;
...
position p;
@@
 enum tuner_pad_index { TUNER_PAD_RF_INPUT , TUNER_PAD_OUTPUT , TUNER_PAD_AUD_OUT , TUNER_NUM_PADS , } cocci_id@p ;
