...
position p;
@@
 struct at91_adc_caps cocci_id@p ;
...
position p;
@@
 struct at91_adc_trigger cocci_id@p ;
...
typedef u8,u32;
@@
 struct at91_adc_reg_desc {  u8 channel_base ;  u32 drdy_mask ;  u8 status_register ;  u8 trigger_register ;  u32 mr_prescal_mask ;  u32 mr_startup_mask ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct at91_adc_caps {  bool has_ts ;  bool has_tsmr ;  u8 ts_filter_average ;  u8 ts_pen_detect_sensitivity ;  u32 ( * calc_startup_ticks ) ( u32 startup_time , u32 adc_clk_khz ) ;  u8 num_channels ;  struct at91_adc_reg_desc registers ; } cocci_id@p ;
...
position p;
@@
 struct at91_adc_reg_desc * cocci_id@p ;
...
position p;
@@
 struct at91_adc_data * cocci_id@p ;
