...
position p;
@@
 const struct mssr_mod_reparent * cocci_id@p ;
...
typedef u32;
@@
 struct mstp_clock {  struct clk_hw hw ;  u32 index ;  struct cpg_mssr_priv * priv ; } cocci_id@p ;
...
position p;
@@
 const struct mssr_mod_clk * cocci_id@p ;
...
position p;
@@
 struct cpg_mssr_clk_domain {  struct generic_pm_domain genpd ;  unsigned int num_core_pm_clks ;  unsigned int core_pm_clks [ ] ; } cocci_id@p ;
...
position p;
@@
 struct mssr_mod_clk * cocci_id@p ;
...
position p;
@@
 struct cpg_mssr_priv cocci_id@p ;
...
position p;
@@
 struct cpg_mssr_clk_domain * cocci_id@p ;
...
position p;
@@
 struct cpg_core_clk * cocci_id@p ;
