...
position p;
@@
 enum { TCP_BPF_BASE , TCP_BPF_TX , TCP_BPF_NUM_CFGS , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sock * sk , long timeout ) ;
...
position p;
@@
 struct proto cocci_id@p [ TCP_BPF_NUM_CFGS ] ;
...
position p;
@@
 enum { TCP_BPF_IPV4 , TCP_BPF_IPV6 , TCP_BPF_NUM_PROTS , } cocci_id@p ;
...
position p;
@@
 struct proto cocci_id@p [ TCP_BPF_NUM_PROTS ] [ TCP_BPF_NUM_CFGS ] ;
