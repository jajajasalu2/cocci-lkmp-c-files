...
position p;
@@
 struct mt76_queue_entry * cocci_id@p ;
...
position p;
@@
 struct mt76_txwi_cache * cocci_id@p ;
...
position p;
@@
 struct mt76_channel_state * cocci_id@p ;
...
position p;
@@
 struct mt76_tx_info * cocci_id@p ;
...
position p;
@@
 struct mt7615_rate_set * cocci_id@p ;
...
position p;
@@
 struct mt7615_tx_free * cocci_id@p ;
...
position p;
@@
 enum mt7615_cipher_type cocci_id@p ;
