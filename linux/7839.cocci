...
position p;
@@
 struct cc2520_platform_data * cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ CC2520_MAX_TX_POWERS + 1 ] ;
...
@@
 struct cc2520_private {  struct spi_device * spi ;  struct ieee802154_hw * hw ;  u8 * buf ;  struct mutex buffer_mutex ;  bool is_tx ;  bool amplified ;  int fifo_pin ;  struct work_struct fifop_irqwork ;  spinlock_t lock ;  struct completion tx_complete ;  bool promiscuous ; } cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ CC2520_CC2591_MAX_TX_POWERS + 1 ] ;
...
position p;
@@
 struct cc2520_private cocci_id@p ;
