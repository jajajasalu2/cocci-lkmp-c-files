...
typedef bool;
@@
 struct rti800_private {  bool adc_2comp ;  bool dac_2comp [ 2 ] ;  const struct comedi_lrange * ao_range_type_list [ 2 ] ;  unsigned char muxgain_bits ; } cocci_id@p ;
...
position p;
@@
 struct rti800_private * cocci_id@p ;
...
position p;
@@
 struct rti800_board {  const char * name ;  int has_ao ; } cocci_id@p ;
...
position p;
@@
 struct rti800_board cocci_id@p ;
...
position p;
@@
 const struct rti800_board cocci_id@p [ ] ;
