...
position p;
@@
 struct packet_data {  struct list_head list ;  size_t length ;  void * data ;  int ordernum ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct _rbu_data {  void * image_update_buffer ;  unsigned long image_update_buffer_size ;  unsigned long bios_image_size ;  int image_update_ordernum ;  spinlock_t lock ;  unsigned long packet_read_count ;  unsigned long num_packets ;  unsigned long packetsize ;  unsigned long imagesize ;  int entry_created ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_IMAGE_LENGTH + 1 ] ;
