...
position p;
@@
 struct atmel_hlcdc_crtc_state * cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_crtc cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_crtc_state {  struct drm_crtc_state base ;  unsigned int output_mode ; } cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_crtc {  struct drm_crtc base ;  struct atmel_hlcdc_dc * dc ;  struct drm_pending_vblank_event * event ;  int id ; } cocci_id@p ;
