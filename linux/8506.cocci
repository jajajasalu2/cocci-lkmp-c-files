...
position p;
@@
 struct w5500_spi_priv cocci_id@p ;
...
typedef u8;
@@
 struct w5200_spi_priv {  struct mutex cmd_lock ;  u8 cmd_buf [ 4 ] ____cacheline_aligned ; } cocci_id@p ;
...
typedef u8;
@@
 struct w5500_spi_priv {  struct mutex cmd_lock ;  u8 cmd_buf [ 3 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct w5200_spi_priv * cocci_id@p ;
