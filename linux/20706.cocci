...
typedef u_char;
@@
 int cocci_id@p ( u_char * Byte , u_char __user * * fpu_eip , overrides * override ) ;
...
position p;
@@
 struct swregs_state * cocci_id@p ;
...
position p;
@@
 struct math_emu_info * cocci_id@p ;
