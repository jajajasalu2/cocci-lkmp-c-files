...
position p;
@@
 enum esi_systab_entry_type { ESI_DESC_ENTRY_POINT = 0 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ia64_esi_desc_entry_point_t;
@@
 ia64_esi_desc_entry_point_t * cocci_id@p ;
...
position p;
@@
 struct ia64_sal_systab * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_config_table_t;
@@
 efi_config_table_t * cocci_id@p ;
...
position p;
@@
 struct pdesc {  void * addr ;  void * gp ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u64,efi_guid_t;
@@
 struct ia64_esi_desc_entry_point {  u8 type ;  u8 reserved1 [ 15 ] ;  u64 esi_proc ;  u64 gp ;  efi_guid_t guid ; } cocci_id@p ;
