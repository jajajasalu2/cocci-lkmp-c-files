...
@@
 struct reset_data {  void __iomem * reg ;  spinlock_t * lock ;  struct reset_controller_dev rcdev ;  u8 offset ; } cocci_id@p ;
...
position p;
@@
 const struct sun4i_a10_display_clk_data * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct sun4i_a10_display_clk_data {  bool has_div ;  u8 num_rst ;  u8 parents ;  u8 offset_en ;  u8 offset_div ;  u8 offset_mux ;  u8 offset_rst ;  u8 width_div ;  u8 width_mux ;  u32 flags ; } cocci_id@p ;
