...
position p;
@@
 struct asymmetric_key_subtype * cocci_id@p ;
...
position p;
@@
 struct key_match_data * cocci_id@p ;
...
position p;
@@
 struct asymmetric_key_ids * cocci_id@p ;
...
position p;
@@
 struct asymmetric_key_parser * cocci_id@p ;
...
position p;
@@
 const struct asymmetric_key_ids * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct asymmetric_key_id * kid1 , const struct asymmetric_key_id * kid2 ) ;
...
position p;
@@
 struct asymmetric_key_id * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct key * , const struct key_match_data * ) ;
...
position p;
@@
 const char * const cocci_id@p [ NR__KEY_BEING_USED_FOR ] ;
...
position p;
@@
 const struct asymmetric_key_id * cocci_id@p ;
...
position p;
@@
 const struct asymmetric_key_subtype * cocci_id@p ;
...
position p;
@@
 struct public_key_signature cocci_id@p ;
...
position p;
@@
 struct kernel_pkey_params * cocci_id@p ;
