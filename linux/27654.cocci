...
position p;
@@
 struct jbd2_revoke_table_s {  int hash_size ;  int hash_shift ;  struct list_head * hash_table ; } cocci_id@p ;
...
position p;
@@
 struct jbd2_revoke_table_s * cocci_id@p ;
...
typedef transaction_t;
@@
 void cocci_id@p ( transaction_t * , struct list_head * , struct buffer_head * * , int * , struct jbd2_revoke_record_s * ) ;
...
position p;
@@
 struct jbd2_revoke_record_s * cocci_id@p ;
...
typedef journal_t;
@@
 void cocci_id@p ( journal_t * , struct buffer_head * , int ) ;
...
typedef tid_t;
@@
 struct jbd2_revoke_record_s {  struct list_head hash ;  tid_t sequence ;  unsigned long long blocknr ; } cocci_id@p ;
