...
position p;
@@
 struct nvm_ioctl_create_extended cocci_id@p ;
...
position p;
@@
 struct nvm_ioctl_info cocci_id@p ;
...
position p;
@@
 struct nvm_ioctl_get_devices * cocci_id@p ;
...
position p;
@@
 struct nvm_ioctl_dev_init cocci_id@p ;
...
position p;
@@
 struct nvm_ioctl_dev_factory cocci_id@p ;
...
position p;
@@
 struct nvm_ioctl_create_simple * cocci_id@p ;
...
position p;
@@
 struct nvm_ioctl_info_tgt * cocci_id@p ;
...
position p;
@@
 struct nvm_ioctl_create * cocci_id@p ;
...
position p;
@@
 struct nvm_tgt_type * cocci_id@p ;
...
position p;
@@
 struct nvm_ioctl_remove cocci_id@p ;
...
position p;
@@
 struct nvm_dev_map {  struct nvm_ch_map * chnls ;  int num_ch ; } cocci_id@p ;
...
position p;
@@
 struct nvm_ioctl_device_info * cocci_id@p ;
...
position p;
@@
 struct nvm_ch_map {  int ch_off ;  int num_lun ;  int * lun_offs ; } cocci_id@p ;
...
position p;
@@
 const struct ppa_addr * cocci_id@p ;
