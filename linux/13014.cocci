...
position p;
@@
 const struct tegra_pmc_regs cocci_id@p ;
...
position p;
@@
 struct tegra_powergate {  struct generic_pm_domain genpd ;  struct tegra_pmc * pmc ;  unsigned int id ;  struct clk * * clks ;  unsigned int num_clks ;  struct reset_control * reset ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_pmc_soc * cocci_id@p ;
...
position p;
@@
 struct tegra_io_pad_soc cocci_id@p ;
...
position p;
@@
 struct tegra_io_pad_soc {  enum tegra_io_pad id ;  unsigned int dpd ;  unsigned int voltage ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct generic_pm_domain * cocci_id@p ;
...
position p;
@@
 const struct tegra_wake_event cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_wake_event {  const char * name ;  unsigned int id ;  unsigned int irq ;  struct {  unsigned int instance ;  unsigned int pin ; } gpio ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_io_pad_soc cocci_id@p [ ] ;
...
position p;
@@
 enum tegra_suspend_mode cocci_id@p ;
...
position p;
@@
 struct tegra_powergate * cocci_id@p ;
...
position p;
@@
 struct tegra_pmc_regs {  unsigned int scratch0 ;  unsigned int dpd_req ;  unsigned int dpd_status ;  unsigned int dpd2_req ;  unsigned int dpd2_status ;  unsigned int rst_status ;  unsigned int rst_source_shift ;  unsigned int rst_source_mask ;  unsigned int rst_level_shift ;  unsigned int rst_level_mask ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct tegra_pmc {  struct device * dev ;  void __iomem * base ;  void __iomem * wake ;  void __iomem * aotag ;  void __iomem * scratch ;  struct clk * clk ;  struct dentry * debugfs ;  const struct tegra_pmc_soc * soc ;  bool tz_only ;  unsigned long rate ;  enum tegra_suspend_mode suspend_mode ;  u32 cpu_good_time ;  u32 cpu_off_time ;  u32 core_osc_time ;  u32 core_pmu_time ;  u32 core_off_time ;  bool corereq_high ;  bool sysclkreq_high ;  bool combined_req ;  bool cpu_pwr_good_en ;  u32 lp0_vec_phys ;  u32 lp0_vec_size ; 
	 DECLARE_BITMAP ( powergates_available , TEGRA_POWERGATE_MAX ) 
		 ;  struct mutex powergates_lock ;  struct pinctrl_dev * pctl_dev ;  struct irq_domain * domain ;  struct irq_chip irq ;  struct notifier_block clk_nb ; } cocci_id@p ;
...
position p;
@@
 struct clk_notifier_data * cocci_id@p ;
