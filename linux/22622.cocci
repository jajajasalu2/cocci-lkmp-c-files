...
position p;
@@
 enum { LINE6_PODXTLIVE_VARIAX , LINE6_VARIAX , } cocci_id@p ;
...
position p;
@@
 struct usb_line6_variax cocci_id@p ;
...
position p;
@@
 enum { VARIAX_STARTUP_VERSIONREQ , VARIAX_STARTUP_ACTIVATE , VARIAX_STARTUP_SETUP , } cocci_id@p ;
...
position p;
@@
 struct usb_line6_variax {  struct usb_line6 line6 ;  unsigned char * buffer_activate ;  int startup_progress ; } cocci_id@p ;
