...
position p;
@@
 const struct rpm_reg_parts * cocci_id@p ;
...
position p;
@@
 struct rpm_regulator_data {  const char * name ;  int resource ;  const struct qcom_rpm_reg * template ;  const char * supply ; } cocci_id@p ;
...
position p;
@@
 struct qcom_rpm_reg * cocci_id@p ;
...
position p;
@@
 const struct rpm_regulator_data cocci_id@p [ ] ;
...
position p;
@@
 struct request_member {  int word ;  unsigned int mask ;  int shift ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct qcom_rpm_reg {  struct qcom_rpm * rpm ;  struct mutex lock ;  struct device * dev ;  struct regulator_desc desc ;  const struct rpm_reg_parts * parts ;  int resource ;  u32 val [ MAX_REQUEST_LEN ] ;  int uV ;  int is_enabled ;  bool supports_force_mode_auto ;  bool supports_force_mode_bypass ; } cocci_id@p ;
...
position p;
@@
 const struct qcom_rpm_reg cocci_id@p ;
...
position p;
@@
 const struct request_member * cocci_id@p ;
