...
position p;
@@
 struct bbc_fan_control * cocci_id@p ;
...
position p;
@@
 struct bbc_cpu_temperature * cocci_id@p ;
...
position p;
@@
 struct temp_limits cocci_id@p [ 2 ] ;
