...
typedef u16;
@@
 u16 cocci_id@p [ ARRAY_SIZE ( ctx -> __reserved ) ] ;
...
position p;
@@
 struct extra_context cocci_id@p ;
...
position p;
@@
 const struct rt_sigframe_user_layout * cocci_id@p ;
...
position p;
@@
 struct sigcontext __user * constcocci_id ;
...
position p;
@@
 struct frame_record cocci_id@p ;
...
position p;
@@
 const __user char * constcocci_id ;
...
position p;
@@
 int cocci_id@p ( void __user * ctx ) ;
...
position p;
@@
 struct fpsimd_context cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct user_ctxs * user ) ;
...
position p;
@@
 struct user_ctxs {  struct fpsimd_context __user * fpsimd ;  struct sve_context __user * sve ; } cocci_id@p ;
...
position p;
@@
 struct _aarch64_ctx cocci_id@p ;
...
position p;
@@
 struct rt_sigframe_user_layout cocci_id@p ;
...
position p;
@@
 struct rt_sigframe_user_layout {  struct rt_sigframe __user * sigframe ;  struct frame_record __user * next_frame ;  unsigned long size ;  unsigned long limit ;  unsigned long fpsimd_offset ;  unsigned long esr_offset ;  unsigned long sve_offset ;  unsigned long extra_offset ;  unsigned long end_offset ; } cocci_id@p ;
...
typedef u64;
@@
 struct frame_record {  u64 fp ;  u64 lr ; } cocci_id@p ;
...
position p;
@@
 const struct user_fpsimd_state * cocci_id@p ;
...
position p;
@@
 struct rt_sigframe {  struct siginfo info ;  struct ucontext uc ; } cocci_id@p ;
...
position p;
@@
 struct user_fpsimd_state cocci_id@p ;
