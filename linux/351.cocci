...
@@
 struct lpm_trie {  struct bpf_map map ;  struct lpm_trie_node __rcu * root ;  size_t n_entries ;  size_t max_prefixlen ;  size_t data_size ;  raw_spinlock_t lock ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct lpm_trie_node {  struct rcu_head rcu ;  struct lpm_trie_node __rcu * child [ 2 ] ;  u32 prefixlen ;  u32 flags ;  u8 data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct bpf_lpm_trie_key * cocci_id@p ;
...
position p;
@@
 const struct lpm_trie * cocci_id@p ;
...
position p;
@@
 struct lpm_trie_node cocci_id@p ;
...
position p;
@@
 const struct lpm_trie_node * cocci_id@p ;
