...
position p;
@@
 struct service_processor cocci_id@p ;
...
position p;
@@
 struct ibmasmfs_heartbeat_data cocci_id@p ;
...
position p;
@@
 struct ibmasmfs_event_data {  struct service_processor * sp ;  struct event_reader reader ;  int active ; } cocci_id@p ;
...
position p;
@@
 struct ibmasmfs_command_data {  struct service_processor * sp ;  struct command * command ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , struct fs_context * fc ) ;
...
position p;
@@
 struct ibmasmfs_command_data * cocci_id@p ;
...
position p;
@@
 struct inode * cocci_id@p ( struct super_block * sb , int mode ) ;
...
position p;
@@
 struct event_reader * cocci_id@p ;
...
position p;
@@
 struct ibmasmfs_event_data * cocci_id@p ;
...
position p;
@@
 struct ibmasmfs_heartbeat_data {  struct service_processor * sp ;  struct reverse_heartbeat heartbeat ;  int active ; } cocci_id@p ;
