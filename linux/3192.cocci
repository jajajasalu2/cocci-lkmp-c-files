...
position p;
@@
 struct ds620_platform_data * cocci_id@p ;
...
typedef s16;
@@
 struct ds620_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  s16 temp [ 3 ] ; } cocci_id@p ;
