...
position p;
@@
 struct evergreen_arb_registers * cocci_id@p ;
...
position p;
@@
 struct radeon_clock_array * cocci_id@p ;
...
position p;
@@
 struct evergreen_mc_reg_table * cocci_id@p ;
...
position p;
@@
 struct rv7xx_ps * cocci_id@p ( struct radeon_ps * rps ) ;
...
position p;
@@
 const struct radeon_blacklist_clocks cocci_id@p [ ] ;
