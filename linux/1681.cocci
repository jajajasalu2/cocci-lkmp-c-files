...
position p;
@@
 struct cros_ec_sensors_state * cocci_id@p ;
...
position p;
@@
 struct cros_ec_sensors_state {  struct cros_ec_sensors_core_state core ;  struct iio_chan_spec channels [ CROS_EC_SENSORS_MAX_CHANNELS ] ; } cocci_id@p ;
