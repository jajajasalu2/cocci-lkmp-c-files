...
position p;
@@
 const struct unlock_addr cocci_id@p [ ] ;
...
@@
 struct amd_flash_info {  const char * name ;  const uint16_t mfr_id ;  const uint16_t dev_id ;  const uint8_t dev_size ;  const uint8_t nr_regions ;  const uint16_t cmd_set ;  const uint32_t regions [ 6 ] ;  const uint8_t devtypes ;  const uint8_t uaddr ; } cocci_id@p ;
...
position p;
@@
 enum uaddr { MTD_UADDR_NOT_SUPPORTED = 0 , MTD_UADDR_0x0555_0x02AA , MTD_UADDR_0x0555_0x0AAA , MTD_UADDR_0x5555_0x2AAA , MTD_UADDR_0x0AAA_0x0554 , MTD_UADDR_0x0AAA_0x0555 , MTD_UADDR_0xAAAA_0x5555 , MTD_UADDR_DONT_CARE , MTD_UADDR_UNNECESSARY , } cocci_id@p ;
...
position p;
@@
 const struct amd_flash_info * cocci_id@p ;
...
typedef uint32_t;
@@
 struct unlock_addr {  uint32_t addr1 ;  uint32_t addr2 ; } cocci_id@p ;
