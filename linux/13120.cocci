...
position p;
@@
 struct socfpga_fpga_priv * cocci_id@p ;
...
position p;
@@
 const enum fpga_mgr_states cocci_id@p [ ] ;
...
typedef bool,u32;
@@
 struct cfgmgr_mode {  u32 ctrl ;  bool valid ; } cocci_id@p ;
...
position p;
@@
 struct socfpga_fpga_priv {  void __iomem * fpga_base_addr ;  void __iomem * fpga_data_addr ;  struct completion status_complete ;  int irq ; } cocci_id@p ;
