...
position p;
@@
 struct padlock_sha_ctx * cocci_id@p ;
...
position p;
@@
 struct padlock_sha_desc cocci_id@p ;
...
position p;
@@
 struct padlock_sha_ctx {  struct crypto_shash * fallback ; } cocci_id@p ;
...
position p;
@@
 struct padlock_sha_desc {  struct shash_desc fallback ; } cocci_id@p ;
