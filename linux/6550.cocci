...
position p;
@@
 struct Marker_Entry cocci_id@p ;
...
position p;
@@
 struct Command_Entry * cocci_id@p ;
...
position p;
@@
 struct Continuation_Entry * cocci_id@p ;
...
position p;
@@
 struct Status_Entry * cocci_id@p ;
