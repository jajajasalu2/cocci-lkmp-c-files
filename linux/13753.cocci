...
position p;
@@
 struct msp3400c_init_data_dem * cocci_id@p ;
...
position p;
@@
 struct msp3400c_init_data_dem {  int fir1 [ 6 ] ;  int fir2 [ 6 ] ;  int cdo1 ;  int cdo2 ;  int ad_cv ;  int mode_reg ;  int dsp_src ;  int dsp_matrix ; } cocci_id@p [ ] ;
...
position p;
@@
 struct msp3400c_carrier_detect {  int cdo ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct {  int retval ;  int main , second ;  char * name ;  v4l2_std_id std ; } cocci_id@p [ ] ;
...
position p;
@@
 struct msp3400c_carrier_detect * cocci_id@p ;
