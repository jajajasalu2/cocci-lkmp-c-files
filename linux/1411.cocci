...
position p;
@@
 struct mv_usb_platform_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mv_udc * udc , struct usb_gadget_driver * driver ) ;
...
position p;
@@
 void cocci_id@p ( struct mv_ep * ep , int status ) ;
