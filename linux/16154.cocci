...
position p;
@@
 struct apci1500_private {  unsigned long amcc ;  unsigned long addon ;  unsigned int clk_src ;  unsigned int pm [ 2 ] ;  unsigned int pt [ 2 ] ;  unsigned int pp [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct apci1500_private * cocci_id@p ;
