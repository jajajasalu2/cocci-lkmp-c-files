...
position p;
@@
 struct rt_firmware_hdr * cocci_id@p ;
...
position p;
@@
 enum HAL_ODM_VARIABLE cocci_id@p ;
...
position p;
@@
 struct c2h_evt_hdr_88xx * cocci_id@p ;
...
position p;
@@
 struct TxPowerInfo24G cocci_id@p ;
...
position p;
@@
 enum HAL_DEF_VARIABLE cocci_id@p ;
