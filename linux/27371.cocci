...
position p;
@@
 struct coda_zapdir_out cocci_id@p ;
...
position p;
@@
 struct coda_purgefid_out cocci_id@p ;
...
position p;
@@
 struct coda_replace_out cocci_id@p ;
...
position p;
@@
 struct coda_purgeuser_out cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct venus_comm * vc , int inSize , int * outSize , union inputArgs * buffer ) ;
...
position p;
@@
 struct coda_zapfile_out cocci_id@p ;
