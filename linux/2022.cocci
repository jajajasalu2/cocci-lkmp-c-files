...
position p;
@@
 enum bmc150_power_modes cocci_id@p ;
...
position p;
@@
 const struct iio_event_spec cocci_id@p ;
...
typedef atomic_t;
@@
 struct bmc150_accel_interrupt {  const struct bmc150_accel_interrupt_info * info ;  atomic_t users ; } cocci_id@p ;
...
position p;
@@
 const struct bmc150_scale_info * cocci_id@p ;
...
position p;
@@
 enum bmc150_accel_interrupt_id { BMC150_ACCEL_INT_DATA_READY , BMC150_ACCEL_INT_ANY_MOTION , BMC150_ACCEL_INT_WATERMARK , BMC150_ACCEL_INTERRUPTS , } cocci_id@p ;
...
position p;
@@
 const struct attribute * cocci_id@p [ ] ;
...
typedef u8;
@@
 const struct {  int sleep_dur ;  u8 reg_value ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ BMC150_ACCEL_FIFO_LENGTH * 3 ] ;
...
typedef u8;
@@
 struct bmc150_accel_chip_info {  const char * name ;  u8 chip_id ;  const struct iio_chan_spec * channels ;  int num_channels ;  const struct bmc150_scale_info scale_table [ 4 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct bmc150_scale_info {  int scale ;  u8 reg_range ; } cocci_id@p ;
...
typedef bool;
@@
 const struct {  int intr ;  const char * name ;  int ( * setup ) ( struct bmc150_accel_trigger * t , bool state ) ; } cocci_id@p [ BMC150_ACCEL_TRIGGERS ] ;
...
typedef u8;
@@
 const struct {  int val ;  int val2 ;  u8 bw_bits ; } cocci_id@p [ ] ;
...
position p;
@@
 enum iio_event_type cocci_id@p ;
...
position p;
@@
 const struct iio_dev * cocci_id@p ;
...
position p;
@@
 struct bmc150_accel_data * cocci_id@p ;
...
position p;
@@
 struct bmc150_accel_interrupt * cocci_id@p ;
...
position p;
@@
 const struct bmc150_accel_chip_info cocci_id@p [ ] ;
...
position p;
@@
 const struct iio_mount_matrix * cocci_id@p ;
...
position p;
@@
 enum bmc150_accel_trigger_id { BMC150_ACCEL_TRIGGER_DATA_READY , BMC150_ACCEL_TRIGGER_ANY_MOTION , BMC150_ACCEL_TRIGGERS , } cocci_id@p ;
...
position p;
@@
 enum iio_event_direction cocci_id@p ;
...
position p;
@@
 const struct bmc150_accel_interrupt_info * cocci_id@p ;
...
position p;
@@
 enum bmc150_accel_axis { AXIS_X , AXIS_Y , AXIS_Z , AXIS_MAX , } cocci_id@p ;
...
position p;
@@
 const struct iio_trigger_ops cocci_id@p ;
...
position p;
@@
 struct bmc150_accel_trigger * cocci_id@p ;
...
position p;
@@
 enum iio_event_info cocci_id@p ;
...
typedef bool;
@@
 struct bmc150_accel_trigger {  struct bmc150_accel_data * data ;  struct iio_trigger * indio_trig ;  int ( * setup ) ( struct bmc150_accel_trigger * t , bool state ) ;  int intr ;  bool enabled ; } cocci_id@p ;
...
typedef u8;
@@
 const struct bmc150_accel_interrupt_info {  u8 map_reg ;  u8 map_bitmask ;  u8 en_reg ;  u8 en_bitmask ; } cocci_id@p [ BMC150_ACCEL_INTERRUPTS ] ;
...
position p;
@@
 const struct {  int bw_bits ;  int msec ; } cocci_id@p [ ] ;
...
position p;
@@
 enum bmc150_power_modes { BMC150_ACCEL_SLEEP_MODE_NORMAL , BMC150_ACCEL_SLEEP_MODE_DEEP_SUSPEND , BMC150_ACCEL_SLEEP_MODE_LPM , BMC150_ACCEL_SLEEP_MODE_SUSPEND = 0x04 , } cocci_id@p ;
