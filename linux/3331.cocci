...
position p;
@@
 struct w83627hf_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct w83627hf_data * data ) ;
...
position p;
@@
 struct w83627hf_sio_data {  enum chips type ;  int sioaddr ; } cocci_id@p ;
...
position p;
@@
 enum chips { w83627hf , w83627thf , w83697hf , w83637hf , w83687thf , } cocci_id@p ;
...
position p;
@@
 struct w83627hf_sio_data cocci_id@p ;
...
position p;
@@
 const struct w83627hf_sio_data * cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct w83627hf_data * data , u16 reg ) ;
...
position p;
@@
 struct w83627hf_data * cocci_id@p ( struct device * dev ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct w83627hf_data * data , u16 reg , u16 value ) ;
