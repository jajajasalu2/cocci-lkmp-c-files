...
position p;
@@
 struct tb_switch_nvm * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ TB_SWITCH_KEY_SIZE ] ;
...
position p;
@@
 struct tb_regs_port_header * cocci_id@p ;
...
position p;
@@
 const struct tb_switch * cocci_id@p ;
...
position p;
@@
 struct tb_sw_lookup cocci_id@p ;
...
position p;
@@
 const struct tb_port * cocci_id@p ;
...
typedef u32,uuid_t;
@@
 struct nvm_auth_status {  struct list_head list ;  uuid_t uuid ;  u32 status ; } cocci_id@p ;
...
position p;
@@
 struct nvm_auth_status * cocci_id@p ;
...
@@
 struct tb_sw_lookup {  struct tb * tb ;  u8 link ;  u8 depth ;  const uuid_t * uuid ;  u64 route ; } cocci_id@p ;
...
position p;
@@
 const struct tb_sw_lookup * cocci_id@p ;
...
position p;
@@
 struct tb_regs_switch_header * cocci_id@p ;
