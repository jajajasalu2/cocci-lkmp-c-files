...
typedef u8,u16;
@@
 struct nft_bitmap {  struct list_head list ;  u16 bitmap_size ;  u8 bitmap [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct nft_bitmap * cocci_id@p ;
...
position p;
@@
 struct nft_bitmap_elem {  struct list_head head ;  struct nft_set_ext ext ; } cocci_id@p ;
...
position p;
@@
 struct nft_bitmap_elem cocci_id@p ;
