...
position p;
@@
 struct octeon_droq_desc * cocci_id@p ;
...
position p;
@@
 struct octeon_recv_buffer * cocci_id@p ;
...
typedef octeon_dispatch_fn_t;
@@
 struct __dispatch {  struct list_head list ;  struct octeon_recv_info * rinfo ;  octeon_dispatch_fn_t disp_fn ; } cocci_id@p ;
...
position p;
@@
 struct niclist {  struct list_head list ;  void * ptr ; } cocci_id@p ;
...
position p;
@@
 struct octeon_droq_info * cocci_id@p ;
