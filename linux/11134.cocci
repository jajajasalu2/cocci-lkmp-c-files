...
position p;
@@
 const struct clamping_and_pixel_encoding_params * cocci_id@p ;
...
position p;
@@
 const struct opp_funcs cocci_id@p ;
...
position p;
@@
 enum { MAX_LUT_ENTRY = 256 , MAX_NUMBER_OF_ENTRIES = 256 , } cocci_id@p ;
...
position p;
@@
 enum { MAX_PWL_ENTRY = 128 , MAX_REGIONS_NUMBER = 16 , } cocci_id@p ;
...
position p;
@@
 struct clamping_and_pixel_encoding_params * cocci_id@p ;
