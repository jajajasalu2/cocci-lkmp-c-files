...
typedef u64;
@@
 struct acpi_fan_fif {  u64 revision ;  u64 fine_grain_ctrl ;  u64 step_size ;  u64 low_speed_notification ; } cocci_id@p ;
...
position p;
@@
 struct acpi_fan_fps cocci_id@p ;
...
typedef bool;
@@
 struct acpi_fan {  bool acpi4 ;  struct acpi_fan_fif fif ;  struct acpi_fan_fps * fps ;  int fps_count ;  struct thermal_cooling_device * cdev ; } cocci_id@p ;
...
typedef u64;
@@
 struct acpi_fan_fps {  u64 control ;  u64 trip_point ;  u64 speed ;  u64 noise_level ;  u64 power ; } cocci_id@p ;
...
position p;
@@
 const struct acpi_fan_fps * cocci_id@p ;
