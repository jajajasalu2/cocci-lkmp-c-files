...
position p;
@@
 unsigned int cocci_id@p [ AZX_NUM_DRIVERS ] ;
...
position p;
@@
 void cocci_id@p ( struct azx * chip ) ;
...
position p;
@@
 const struct hda_controller_ops cocci_id@p ;
...
position p;
@@
 const struct vga_switcheroo_client_ops cocci_id@p ;
...
position p;
@@
 struct pci_dev * cocci_id@p ( struct pci_dev * pci ) ;
...
position p;
@@
 int cocci_id@p ( struct azx * chip , int do_disconnect ) ;
...
position p;
@@
 int cocci_id@p ( struct azx * chip , struct azx_dev * azx_dev ) ;
...
position p;
@@
 enum { POS_FIX_AUTO , POS_FIX_LPIB , POS_FIX_POSBUF , POS_FIX_VIACOMBO , POS_FIX_COMBO , POS_FIX_SKL , POS_FIX_FIFO , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef azx_get_pos_callback_t;
@@
 azx_get_pos_callback_t cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct azx * chip ) ;
