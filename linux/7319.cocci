...
position p;
@@
 struct platform_lcd {  struct device * us ;  struct lcd_device * lcd ;  struct plat_lcd_data * pdata ;  unsigned int power ;  unsigned int suspended : 1 ; } cocci_id@p ;
...
position p;
@@
 struct platform_lcd cocci_id@p ;
