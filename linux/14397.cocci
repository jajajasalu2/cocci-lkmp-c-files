...
position p;
@@
 struct zl10353_state cocci_id@p ;
...
typedef u32;
@@
 struct zl10353_state {  struct i2c_adapter * i2c ;  struct dvb_frontend frontend ;  struct zl10353_config config ;  u32 bandwidth ;  u32 ucblocks ;  u32 frequency ; } cocci_id@p ;
