...
symbol cocci_id;
position p;
typedef drm_via_state_t;
@@
 drm_via_state_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef verifier_state_t;
@@
 verifier_state_t cocci_id@p ;
...
typedef hazard_t;
@@
 struct {  unsigned int code ;  hazard_t hz ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_sequence_t;
@@
 drm_via_sequence_t cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef drm_via_private_t;
@@
 drm_via_private_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_local_map_t;
@@
 drm_local_map_t * cocci_id@p ;
...
position p;
@@
 enum { state_command , state_header2 , state_header1 , state_vheader5 , state_vheader6 , state_error , } cocci_id@p ;
