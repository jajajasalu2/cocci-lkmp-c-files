...
position p;
@@
 struct hfs_iget_data * cocci_id@p ;
...
position p;
@@
 struct hfs_cat_file cocci_id@p ;
...
position p;
@@
 struct hfs_iget_data {  struct hfs_cat_key * key ;  hfs_cat_rec * rec ; } cocci_id@p ;
