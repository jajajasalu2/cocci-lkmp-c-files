...
position p;
@@
 struct lm8333 {  struct i2c_client * client ;  struct input_dev * input ;  unsigned short keycodes [ LM8333_NUM_ROWS << LM8333_ROW_SHIFT ] ; } cocci_id@p ;
...
position p;
@@
 const struct lm8333_platform_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ LM8333_FIFO_TRANSFER_SIZE ] ;
