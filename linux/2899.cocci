...
@@
 acpi_status cocci_id@p ( u64 * accumulated_value , u32 base , int ascii_digit ) ;
...
typedef acpi_status,u64,u32;
@@
 acpi_status cocci_id@p ( u64 multiplicand , u32 base , u64 * out_product ) ;
...
typedef acpi_status,u64,u32;
@@
 acpi_status cocci_id@p ( u64 addend1 , u32 digit , u64 * out_sum ) ;
