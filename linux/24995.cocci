...
typedef u8,u16;
@@
 int ( * cocci_id@p ) ( struct batadv_priv * bat_priv , u8 * src , u8 * dst , void * tvlv_value , u16 tvlv_value_len ) ;
...
typedef u8,u16;
@@
 void ( * cocci_id@p ) ( struct batadv_priv * bat_priv , struct batadv_orig_node * orig , u8 flags , void * tvlv_value , u16 tvlv_value_len ) ;
...
position p;
@@
 struct batadv_tvlv_container * cocci_id@p ;
...
position p;
@@
 struct batadv_tvlv_handler cocci_id@p ;
