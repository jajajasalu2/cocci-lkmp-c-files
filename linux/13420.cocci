...
position p;
@@
 struct airspy_frame_buf * cocci_id@p ;
...
position p;
@@
 struct airspy_format cocci_id@p [ ] ;
...
position p;
@@
 struct airspy_frame_buf {  struct vb2_v4l2_buffer vb ;  struct list_head list ; } cocci_id@p ;
...
typedef u32;
@@
 struct airspy_format {  u32 pixelformat ;  u32 buffersize ; } cocci_id@p ;
