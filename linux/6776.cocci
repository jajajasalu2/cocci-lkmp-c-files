...
position p;
@@
 struct myrb_raidlevel_name_entry * cocci_id@p ;
...
position p;
@@
 struct myrb_ldev_info * cocci_id@p ;
...
position p;
@@
 struct myrb_devstate_name_entry * cocci_id@p ;
...
position p;
@@
 struct myrb_enquiry2 cocci_id@p ;
...
position p;
@@
 struct myrb_privdata * cocci_id@p ;
...
position p;
@@
 union myrb_cmd_mbox cocci_id@p ;
...
position p;
@@
 struct myrb_bgi_status cocci_id@p ;
...
position p;
@@
 struct myrb_rbld_progress * cocci_id@p ;
...
position p;
@@
 struct myrb_devstate_name_entry {  enum myrb_devstate state ;  const char * name ; } cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef mbox_mmio_init_t;
@@
 mbox_mmio_init_t cocci_id@p ;
...
position p;
@@
 struct myrb_enquiry cocci_id@p ;
...
position p;
@@
 struct myrb_raidlevel_name_entry {  enum myrb_raidlevel level ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 enum myrb_cmd_opcode cocci_id@p ;
...
position p;
@@
 struct myrb_log_entry cocci_id@p ;
...
position p;
@@
 struct myrb_config2 * cocci_id@p ;
...
position p;
@@
 struct myrb_stat_mbox cocci_id@p ;
...
position p;
@@
 struct myrb_error_entry cocci_id@p ;
...
position p;
@@
 enum myrb_raidlevel cocci_id@p ;
...
position p;
@@
 struct myrb_pdev_state cocci_id@p ;
...
position p;
@@
 struct myrb_error_entry cocci_id@p [ MYRB_MAX_CHANNELS * MYRB_MAX_TARGETS ] ;
...
position p;
@@
 void cocci_id@p ( void * DeviceState ) ;
