...
position p;
@@
 const char * cocci_id@p [ DA7219_NUM_SUPPLIES ] ;
...
position p;
@@
 const struct clk_ops cocci_id@p [ DA7219_DAI_NUM_CLKS ] ;
...
position p;
@@
 struct da7219_pdata * cocci_id@p ;
...
position p;
@@
 enum da7219_micbias_voltage cocci_id@p ;
...
position p;
@@
 enum da7219_mic_amp_in_sel cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( da7219_dac_dig_gain_tlv , 
							   0x0 , 0x07 , 
							   TLV_DB_SCALE_ITEM ( TLV_DB_GAIN_MUTE , 0 , 1 ) , 
							   
							   0x08 , 0x7f , 
							   TLV_DB_SCALE_ITEM ( - 7725 , 75 , 0 ) ) ;
