...
typedef u16;
@@
 struct bh1750_chip_info {  u16 mtreg_min ;  u16 mtreg_max ;  u16 mtreg_default ;  int mtreg_to_usec ;  int mtreg_to_scale ;  int inc ;  u16 int_time_low_mask ;  u16 int_time_high_mask ; } cocci_id@p ;
...
position p;
@@
 const struct bh1750_chip_info cocci_id@p [ ] ;
...
position p;
@@
 enum { BH1710 , BH1721 , BH1750 , } cocci_id@p ;
...
position p;
@@
 struct bh1750_chip_info cocci_id@p ;
...
typedef u16;
@@
 struct bh1750_data {  struct i2c_client * client ;  struct mutex lock ;  const struct bh1750_chip_info * chip_info ;  u16 mtreg ; } cocci_id@p ;
