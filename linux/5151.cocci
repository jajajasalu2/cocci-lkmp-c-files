...
typedef bool;
@@
 struct max77620_gpio {  struct gpio_chip gpio_chip ;  struct regmap * rmap ;  struct device * dev ;  struct mutex buslock ;  unsigned int irq_type [ 8 ] ;  bool irq_enabled [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct max77620_gpio * cocci_id@p ;
