...
symbol cocci_id;
position p;
typedef bool,i915_reg_t;
@@
 struct intel_crt {  struct intel_encoder base ;  struct intel_connector * connector ;  bool force_hotplug_required ;  i915_reg_t adpa_reg ; } cocci_id@p ;
