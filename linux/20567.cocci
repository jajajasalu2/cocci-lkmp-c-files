...
position p;
@@
 struct init_nmi {  unsigned int offset ;  unsigned int mask ;  unsigned int data ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nmi_action {  char * action ;  char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 struct uv_hub_nmi_s * cocci_id@p ;
