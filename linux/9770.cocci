...
position p;
@@
 struct il_channel_info cocci_id@p ;
...
position p;
@@
 const struct il_priv * cocci_id@p ;
...
position p;
@@
 const struct il_rxon_cmd * cocci_id@p ;
...
position p;
@@
 const struct il_eeprom_channel * * cocci_id@p ;
...
position p;
@@
 struct il_qosparam_cmd cocci_id@p ;
...
position p;
@@
 struct il_scancomplete_notification * cocci_id@p ;
...
position p;
@@
 struct il_csa_notification * cocci_id@p ;
...
position p;
@@
 struct il_spectrum_notification * cocci_id@p ;
...
position p;
@@
 struct il_stats_cmd cocci_id@p ;
...
position p;
@@
 const struct ieee80211_tpt_blink cocci_id@p [ ] ;
...
position p;
@@
 struct il_scanstart_notification * cocci_id@p ;
...
position p;
@@
 const struct il_queue * cocci_id@p ;
...
position p;
@@
 const struct il_rx_queue * cocci_id@p ;
...
position p;
@@
 struct il_powertable_cmd * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct il_priv * il , struct il_device_cmd * cmd , struct il_rx_pkt * pkt ) ;
...
position p;
@@
 struct il_rem_sta_cmd cocci_id@p ;
...
position p;
@@
 struct il_station_priv_common * cocci_id@p ;
...
position p;
@@
 struct il_eeprom_channel * cocci_id@p ;
...
position p;
@@
 struct il_rxon_time_cmd cocci_id@p ;
...
position p;
@@
 struct il_force_reset * cocci_id@p ;
...
position p;
@@
 struct il_scanresults_notification * cocci_id@p ;
...
position p;
@@
 struct il_scanreq_notification * cocci_id@p ;
...
position p;
@@
 struct il_station_entry * cocci_id@p ;
...
position p;
@@
 struct il_sleep_notification * cocci_id@p ;
