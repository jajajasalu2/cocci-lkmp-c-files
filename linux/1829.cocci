...
typedef u32;
@@
 struct adc108s102_state {  struct spi_device * spi ;  struct regulator * reg ;  u32 va_millivolt ;  struct spi_transfer ring_xfer ;  struct spi_transfer scan_single_xfer ;  struct spi_message ring_msg ;  struct spi_message scan_single_msg ;  __be16 rx_buf [ 13 ] ____cacheline_aligned ;  __be16 tx_buf [ 9 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct adc108s102_state * cocci_id@p ;
