...
position p;
@@
 struct mt76x02_dfs_sequence cocci_id@p ;
...
position p;
@@
 struct mt76x02_dfs_event * cocci_id@p ;
...
position p;
@@
 struct mt76x02_dfs_event_rb * cocci_id@p ;
...
position p;
@@
 struct mt76x02_dfs_hw_pulse * cocci_id@p ;
...
position p;
@@
 struct mt76x02_dfs_pattern_detector * cocci_id@p ;
...
position p;
@@
 const struct mt76x02_radar_specs * cocci_id@p ;
...
position p;
@@
 struct mt76x02_dfs_sw_detector_params * cocci_id@p ;
