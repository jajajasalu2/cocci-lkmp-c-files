...
typedef u8,u32;
@@
 void cocci_id@p ( u32 * h , const u8 * src , const u32 * r , unsigned int blocks ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u32 * h , const u8 * src , const u32 * r , unsigned int blocks , const u32 * u ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ POLY1305_BLOCK_SIZE ] ;
