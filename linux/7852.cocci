...
position p;
@@
 int cocci_id@p ( struct net_device * const ) ;
...
position p;
@@
 struct lmc_xilinx_control cocci_id@p ;
...
symbol cocci_id;
position p;
typedef lmc_csrptr_t;
@@
 lmc_csrptr_t cocci_id@p ;
...
typedef lmc_softc_t;
@@
 void cocci_id@p ( lmc_softc_t * const sc ) ;
