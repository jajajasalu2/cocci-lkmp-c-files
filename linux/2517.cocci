...
position p;
@@
 struct dm_delay_info cocci_id@p ;
...
typedef sector_t;
@@
 struct delay_class {  struct dm_dev * dev ;  sector_t start ;  unsigned delay ;  unsigned ops ; } cocci_id@p ;
...
position p;
@@
 struct dm_delay_info {  struct delay_c * context ;  struct delay_class * class ;  struct list_head list ;  unsigned long expires ; } cocci_id@p ;
...
typedef atomic_t;
@@
 struct delay_c {  struct timer_list delay_timer ;  struct mutex timer_lock ;  struct workqueue_struct * kdelayd_wq ;  struct work_struct flush_expired_bios ;  struct list_head delayed_bios ;  atomic_t may_delay ;  struct delay_class read ;  struct delay_class write ;  struct delay_class flush ;  int argc ; } cocci_id@p ;
