...
typedef bool;
@@
 struct intel_lvds_pps {  int t1_t2 ;  int t3 ;  int t4 ;  int t5 ;  int tx ;  int divider ;  int port ;  bool powerdown_on_reset ; } cocci_id@p ;
...
position p;
@@
 struct intel_lvds_pps * cocci_id@p ;
...
position p;
@@
 struct intel_lvds_encoder cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,i915_reg_t;
@@
 struct intel_lvds_encoder {  struct intel_encoder base ;  bool is_dual_link ;  i915_reg_t reg ;  u32 a3_power ;  struct intel_lvds_pps init_pps ;  u32 init_lvds_val ;  struct intel_connector * attached_connector ; } cocci_id@p ;
