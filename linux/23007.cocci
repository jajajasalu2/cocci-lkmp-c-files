...
position p;
@@
 enum sprd_mcdt_dma_chan cocci_id@p ;
...
position p;
@@
 enum sprd_mcdt_fifo_sts { MCDT_ADC_FIFO_REAL_FULL , MCDT_ADC_FIFO_REAL_EMPTY , MCDT_ADC_FIFO_AF , MCDT_ADC_FIFO_AE , MCDT_DAC_FIFO_REAL_FULL , MCDT_DAC_FIFO_REAL_EMPTY , MCDT_DAC_FIFO_AF , MCDT_DAC_FIFO_AE , } cocci_id@p ;
...
position p;
@@
 enum sprd_mcdt_fifo_sts cocci_id@p ;
...
position p;
@@
 struct sprd_mcdt_dev * cocci_id@p ;
...
position p;
@@
 enum sprd_mcdt_channel_type cocci_id@p ;
...
position p;
@@
 struct sprd_mcdt_chan_callback * cocci_id@p ;
...
position p;
@@
 enum sprd_mcdt_fifo_int { MCDT_ADC_FIFO_AE_INT , MCDT_ADC_FIFO_AF_INT , MCDT_DAC_FIFO_AE_INT , MCDT_DAC_FIFO_AF_INT , MCDT_ADC_FIFO_OV_INT , MCDT_DAC_FIFO_OV_INT , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sprd_mcdt_dev {  struct device * dev ;  void __iomem * base ;  spinlock_t lock ;  struct sprd_mcdt_chan chan [ MCDT_CHANNEL_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct sprd_mcdt_chan * cocci_id@p ;
...
position p;
@@
 enum sprd_mcdt_fifo_int cocci_id@p ;
