...
position p;
@@
 union cvmx_pow_nw_tim cocci_id@p ;
...
position p;
@@
 union cvmx_mio_rst_boot cocci_id@p ;
...
position p;
@@
 struct cvmx_bootinfo * cocci_id@p ;
...
position p;
@@
 union cvmx_rst_boot cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const char * arg ) ;
...
position p;
@@
 struct octeon_boot_descriptor * cocci_id@p ;
