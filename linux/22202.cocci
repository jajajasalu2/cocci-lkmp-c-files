...
position p;
@@
 struct qlist_head cocci_id@p [ QUARANTINE_BATCHES ] ;
...
position p;
@@
 struct qlist_head {  struct qlist_node * head ;  struct qlist_node * tail ;  size_t bytes ; } cocci_id@p ;
