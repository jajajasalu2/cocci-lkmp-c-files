...
position p;
@@
 struct hwsim_tx_rate cocci_id@p [ IEEE80211_TX_MAX_RATES ] ;
...
position p;
@@
 struct hwsim_tx_rate_flag cocci_id@p [ IEEE80211_TX_MAX_RATES ] ;
...
typedef u32;
@@
 struct hwsim_sta_priv {  u32 magic ; } cocci_id@p ;
...
position p;
@@
 struct ieee80211_pspoll * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct hwsim_new_radio_params {  unsigned int channels ;  const char * reg_alpha2 ;  const struct ieee80211_regdomain * regd ;  bool reg_strict ;  bool p2p_device ;  bool use_chanctx ;  bool destroy_on_close ;  const char * hwname ;  bool no_vif ;  const u8 * perm_addr ;  u32 iftypes ;  u32 * ciphers ;  u8 n_ciphers ; } cocci_id@p ;
...
position p;
@@
 struct ieee80211_vendor_radiotap * cocci_id@p ;
...
typedef u32;
@@
 struct hwsim_net {  int netgroup ;  u32 wmediumd ; } cocci_id@p ;
...
position p;
@@
 struct tx_iter_data * cocci_id@p ;
...
typedef u8,bool;
@@
 struct mac80211_hwsim_addr_match_data {  u8 addr [ ETH_ALEN ] ;  bool ret ; } cocci_id@p ;
...
position p;
@@
 struct mac80211_hwsim_addr_match_data * cocci_id@p ;
...
position p;
@@
 struct hwsim_sta_priv cocci_id@p ;
...
position p;
@@
 struct hwsim_vif_priv cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ HWSIM_ATTR_MAX + 1 ] ;
...
position p;
@@
 enum hwsim_testmode_attr { __HWSIM_TM_ATTR_INVALID = 0 , HWSIM_TM_ATTR_CMD = 1 , HWSIM_TM_ATTR_PS = 2 , __HWSIM_TM_ATTR_AFTER_LAST , HWSIM_TM_ATTR_MAX = __HWSIM_TM_ATTR_AFTER_LAST - 1 , } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ HWSIM_TM_ATTR_MAX + 1 ] ;
...
position p;
@@
 enum hwsim_multicast_groups { HWSIM_MCGRP_CONFIG , } cocci_id@p ;
...
position p;
@@
 enum hwsim_testmode_cmd { HWSIM_TM_CMD_SET_PS = 0 , HWSIM_TM_CMD_GET_PS = 1 , HWSIM_TM_CMD_STOP_QUEUES = 2 , HWSIM_TM_CMD_WAKE_QUEUES = 3 , } cocci_id@p ;
...
position p;
@@
 struct mac80211_hwsim_data cocci_id@p ;
...
typedef u32;
@@
 struct hwsim_chanctx_priv {  u32 magic ; } cocci_id@p ;
...
@@
 struct hwsim_vif_priv {  u32 magic ;  u8 bssid [ ETH_ALEN ] ;  bool assoc ;  bool bcn_en ;  u16 aid ; } cocci_id@p ;
...
position p;
@@
 struct hwsim_chanctx_priv * cocci_id@p ;
...
position p;
@@
 struct hwsim_new_radio_params cocci_id@p ;
...
position p;
@@
 struct hwsim_tx_rate cocci_id@p ;
...
typedef bool;
@@
 struct tx_iter_data {  struct ieee80211_channel * channel ;  bool receive ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ QCA_WLAN_VENDOR_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct hwsim_radiotap_ack_hdr * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ QCA_WLAN_VENDOR_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct hwsim_radiotap_hdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , struct sk_buff * skb , struct ieee80211_channel * chan ) ;
...
position p;
@@
 struct nlattr * cocci_id@p [ HWSIM_TM_ATTR_MAX + 1 ] ;
...
position p;
@@
 const char * cocci_id@p [ IEEE80211_SMPS_NUM_MODES ] ;
...
position p;
@@
 enum qca_nl80211_vendor_subcmds { QCA_WLAN_VENDOR_ATTR_TEST = 8 , QCA_WLAN_VENDOR_ATTR_MAX = QCA_WLAN_VENDOR_ATTR_TEST , } cocci_id@p ;
...
position p;
@@
 struct hwsim_tx_rate_flag cocci_id@p ;
...
position p;
@@
 struct wiphy_vendor_command cocci_id@p [ ] ;
