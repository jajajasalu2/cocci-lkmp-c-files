...
position p;
@@
 struct analogix_dp_device cocci_id@p ;
...
position p;
@@
 struct bridge_init {  struct i2c_client * client ;  struct device_node * node ; } cocci_id@p ;
