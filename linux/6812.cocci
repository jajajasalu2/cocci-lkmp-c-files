...
position p;
@@
 void cocci_id@p ( unsigned int base ) ;
...
@@
 struct {  struct pardevice * dev ;  int base ;  int base_hi ;  int mode ;  struct scsi_cmnd * cur_cmd ;  struct delayed_work imm_tq ;  unsigned long jstart ;  unsigned failed : 1 ;  unsigned dp : 1 ;  unsigned rd : 1 ;  unsigned wanted : 1 ;  unsigned int dev_no ;  wait_queue_head_t * waiting ;  struct Scsi_Host * host ;  struct list_head list ; } cocci_id@p ;
