...
position p;
@@
 enum bss_compare_mode { BSS_CMP_REGULAR , BSS_CMP_HIDE_ZLEN , BSS_CMP_HIDE_NUL , } cocci_id@p ;
...
position p;
@@
 enum ieee80211_privacy cocci_id@p ;
...
position p;
@@
 enum bss_compare_mode cocci_id@p ;
...
position p;
@@
 struct cfg80211_non_tx_bss * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct wiphy * wiphy , struct cfg80211_bss * bss , void * data ) ;
...
position p;
@@
 struct cfg80211_bss_ies * cocci_id@p ;
...
typedef u8;
@@
 struct cfg80211_non_tx_bss {  struct cfg80211_bss * tx_bss ;  u8 max_bssid_indicator ;  u8 bssid_index ; } cocci_id@p ;
