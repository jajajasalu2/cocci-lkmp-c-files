...
position p;
@@
 const struct snvs_lpgpr_cfg cocci_id@p ;
...
position p;
@@
 struct snvs_lpgpr_priv * cocci_id@p ;
...
position p;
@@
 struct snvs_lpgpr_priv {  struct device_d * dev ;  struct regmap * regmap ;  struct nvmem_config cfg ;  const struct snvs_lpgpr_cfg * dcfg ; } cocci_id@p ;
...
position p;
@@
 struct snvs_lpgpr_cfg {  int offset ;  int offset_hplr ;  int offset_lplr ;  int size ; } cocci_id@p ;
