...
position p;
@@
 union dig_transmitter_control cocci_id@p ;
...
position p;
@@
 DAC_LOAD_DETECTION_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 ENABLE_YUV_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 union dig_transmitter_control {  DIG_TRANSMITTER_CONTROL_PS_ALLOCATION v1 ;  DIG_TRANSMITTER_CONTROL_PARAMETERS_V2 v2 ;  DIG_TRANSMITTER_CONTROL_PARAMETERS_V3 v3 ;  DIG_TRANSMITTER_CONTROL_PARAMETERS_V4 v4 ;  DIG_TRANSMITTER_CONTROL_PARAMETERS_V1_5 v5 ; } cocci_id@p ;
...
position p;
@@
 union dig_encoder_control {  DIG_ENCODER_CONTROL_PS_ALLOCATION v1 ;  DIG_ENCODER_CONTROL_PARAMETERS_V2 v2 ;  DIG_ENCODER_CONTROL_PARAMETERS_V3 v3 ;  DIG_ENCODER_CONTROL_PARAMETERS_V4 v4 ; } cocci_id@p ;
...
position p;
@@
 struct radeon_backlight_privdata * cocci_id@p ;
...
position p;
@@
 union dvo_encoder_control cocci_id@p ;
...
position p;
@@
 struct radeon_connector_atom_dig * cocci_id@p ;
...
position p;
@@
 union dig_encoder_control cocci_id@p ;
...
position p;
@@
 union crtc_source_param {  SELECT_CRTC_SOURCE_PS_ALLOCATION v1 ;  SELECT_CRTC_SOURCE_PARAMETERS_V2 v2 ; } cocci_id@p ;
...
position p;
@@
 union crtc_source_param cocci_id@p ;
...
position p;
@@
 struct radeon_encoder_atom_dac * cocci_id@p ;
...
position p;
@@
 TV_ENCODER_CONTROL_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 union lvds_encoder_control cocci_id@p ;
...
position p;
@@
 union external_encoder_control {  EXTERNAL_ENCODER_CONTROL_PS_ALLOCATION v1 ;  EXTERNAL_ENCODER_CONTROL_PS_ALLOCATION_V3 v3 ; } cocci_id@p ;
...
position p;
@@
 union lvds_encoder_control {  LVDS_ENCODER_CONTROL_PS_ALLOCATION v1 ;  LVDS_ENCODER_CONTROL_PS_ALLOCATION_V2 v2 ; } cocci_id@p ;
...
position p;
@@
 union dvo_encoder_control {  ENABLE_EXTERNAL_TMDS_ENCODER_PS_ALLOCATION ext_tmds ;  DVO_ENCODER_CONTROL_PS_ALLOCATION dvo ;  DVO_ENCODER_CONTROL_PS_ALLOCATION_V3 dvo_v3 ;  DVO_ENCODER_CONTROL_PS_ALLOCATION_V1_4 dvo_v4 ; } cocci_id@p ;
...
position p;
@@
 struct radeon_legacy_backlight_privdata * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct radeon_device * rdev , int index , struct drm_display_mode * mode ) ;
...
position p;
@@
 union external_encoder_control cocci_id@p ;
