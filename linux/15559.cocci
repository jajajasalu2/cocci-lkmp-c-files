...
position p;
@@
 struct gasket_interrupt_data {  const char * name ;  int type ;  struct pci_dev * pci_dev ;  int msix_configured ;  int num_interrupts ;  const struct gasket_interrupt_desc * interrupts ;  int interrupt_bar_index ;  int pack_width ;  int num_configured ;  struct msix_entry * msix_entries ;  struct eventfd_ctx * * eventfd_ctxs ;  ulong * interrupt_counts ;  int irq ; } cocci_id@p ;
...
position p;
@@
 enum interrupt_sysfs_attribute_type { ATTR_INTERRUPT_COUNTS , } cocci_id@p ;
...
position p;
@@
 struct gasket_interrupt_data * cocci_id@p ;
...
position p;
@@
 enum interrupt_sysfs_attribute_type cocci_id@p ;
