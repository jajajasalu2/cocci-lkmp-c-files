...
position p;
@@
 struct ip_vs_dh_bucket * cocci_id@p ;
...
position p;
@@
 struct ip_vs_dh_state cocci_id@p ;
...
position p;
@@
 struct ip_vs_dh_state {  struct ip_vs_dh_bucket buckets [ IP_VS_DH_TAB_SIZE ] ;  struct rcu_head rcu_head ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_dh_bucket {  struct ip_vs_dest __rcu * dest ; } cocci_id@p ;
