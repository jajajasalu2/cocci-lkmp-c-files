...
position p;
@@
 struct tcm_qla2xxx_fc_loopid * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tcm_qla2xxx_lport * , struct tcm_qla2xxx_nacl * , struct fc_port * ) ;
...
position p;
@@
 struct tcm_qla2xxx_nacl * cocci_id@p ;
...
position p;
@@
 struct tcm_qla2xxx_tpg cocci_id@p ;
...
position p;
@@
 struct tcm_qla2xxx_lport cocci_id@p ;
...
position p;
@@
 struct qla_tgt_func_tmpl cocci_id@p ;
