...
position p;
@@
 const struct test_string_1 * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ string_get_size_maxbuf ] ;
...
position p;
@@
 struct test_string_2 {  const char * in ;  struct test_string_1 s1 [ TEST_STRING_2_MAX_S1 ] ; } cocci_id@p ;
...
position p;
@@
 struct test_string_1 {  const char * out ;  unsigned int flags ; } cocci_id@p ;
...
position p;
@@
 struct test_string {  const char * in ;  const char * out ;  unsigned int flags ; } cocci_id@p ;
...
position p;
@@
 const struct test_string_2 * cocci_id@p ;
