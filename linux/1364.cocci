...
position p;
@@
 struct usb3503_platform_data * cocci_id@p ;
...
typedef u8,bool;
@@
 struct usb3503 {  enum usb3503_mode mode ;  struct regmap * regmap ;  struct device * dev ;  struct clk * clk ;  u8 port_off_mask ;  int gpio_intn ;  int gpio_reset ;  int gpio_connect ;  bool secondary_ref_clk ; } cocci_id@p ;
