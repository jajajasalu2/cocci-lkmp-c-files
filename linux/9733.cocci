...
position p;
@@
 struct iwl_mvm_rx_phy_data cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_rss_sync_notif cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_reorder_buffer * cocci_id@p ;
...
position p;
@@
 struct iwl_rxq_sync_notification * cocci_id@p ;
...
position p;
@@
 struct iwl_rx_no_data * cocci_id@p ;
...
position p;
@@
 const struct iwl_mvm_nssn_sync_data * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_rxq_dup_data * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_baid_data * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_delba_data * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_radiotap_he cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_reorder_buf_entry * cocci_id@p ;
...
position p;
@@
 enum iwl_mvm_release_flags { IWL_MVM_RELEASE_SEND_RSS_SYNC = BIT ( 0 ) , IWL_MVM_RELEASE_FROM_RSS_SYNC = BIT ( 1 ) , } cocci_id@p ;
...
position p;
@@
 struct iwl_rxq_sync_cmd * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct iwl_rxq_sync_cmd ) + sizeof ( struct iwl_mvm_rss_sync_notif ) ] ;
...
position p;
@@
 const struct ieee80211_radiotap_he_mu cocci_id@p ;
...
position p;
@@
 struct iwl_bar_frame_release * cocci_id@p ;
...
position p;
@@
 struct iwl_frame_release * cocci_id@p ;
