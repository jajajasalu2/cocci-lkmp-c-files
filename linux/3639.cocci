...
position p;
@@
 struct efi_dev_path * * cocci_id@p ;
...
typedef u32;
@@
 struct dev_header {  u32 len ;  u32 prop_count ;  struct efi_dev_path path [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct properties_header * cocci_id@p ;
...
typedef u32;
@@
 struct properties_header {  u32 len ;  u32 version ;  u32 dev_count ;  struct dev_header dev_header [ 0 ] ; } cocci_id@p ;
