...
position p;
@@
 struct txx9_sramc_dev * cocci_id@p ;
...
typedef u8;
@@
 struct txx9_iocled_data {  struct gpio_chip chip ;  u8 cur_val ;  void __iomem * mmioaddr ;  struct gpio_led_platform_data pdata ;  struct gpio_led leds [ TXX9_IOCLED_MAXLEDS ] ;  char names [ TXX9_IOCLED_MAXLEDS ] [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct txx9_tmr_reg cocci_id@p ;
...
position p;
@@
 struct mtd_partition cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct txx9ndfmc_platform_data * cocci_id@p ;
...
position p;
@@
 const struct physmap_flash_data * cocci_id@p ;
...
position p;
@@
 struct txx9_iocled_data * cocci_id@p ;
...
position p;
@@
 struct txx9dmac_chan_platform_data cocci_id@p ;
...
position p;
@@
 struct txx9_sramc_dev {  struct device dev ;  struct bin_attribute bindata_attr ;  void __iomem * base ; } cocci_id@p ;
...
position p;
@@
 struct txx9_board_vec cocci_id@p ;
...
typedef u16;
@@
 u16 ( * cocci_id@p ) ( volatile u16 * a , u16 x ) ;
...
position p;
@@
 unsigned long ( * cocci_id@p ) ( unsigned long port ) ;
...
position p;
@@
 const struct txx9dmac_platform_data * cocci_id@p ;
