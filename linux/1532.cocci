...
position p;
@@
 struct usbport_trig_data {  struct led_classdev * led_cdev ;  struct list_head ports ;  struct notifier_block nb ;  int count ; } cocci_id@p ;
...
position p;
@@
 struct usbport_trig_data cocci_id@p ;
...
typedef bool;
@@
 struct usbport_trig_port {  struct usbport_trig_data * data ;  struct usb_device * hub ;  int portnum ;  char * port_name ;  bool observed ;  struct device_attribute attr ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct usbport_trig_port * cocci_id@p ;
