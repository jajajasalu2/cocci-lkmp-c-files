...
typedef u8;
@@
 struct antenna_sel {  u8 word ;  u8 value [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 const struct antenna_sel * cocci_id@p ;
...
position p;
@@
 const struct rt2x00lib_ops cocci_id@p ;
...
position p;
@@
 struct eeprom_93cx6 * cocci_id@p ;
...
position p;
@@
 struct queue_entry_priv_mmio * cocci_id@p ;
...
position p;
@@
 struct hw_pairwise_ta_entry cocci_id@p ;
...
position p;
@@
 const struct rt2x00_ops cocci_id@p ;
