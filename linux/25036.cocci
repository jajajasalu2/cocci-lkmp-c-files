...
position p;
@@
 struct hci_create_pipe_resp * cocci_id@p ;
...
position p;
@@
 struct hci_all_pipe_cleared_noti * cocci_id@p ;
...
position p;
@@
 struct hci_delete_pipe_noti * cocci_id@p ;
