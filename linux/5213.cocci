...
position p;
@@
 int cocci_id@p ( struct ata_link * link , unsigned long deadline ) ;
...
position p;
@@
 enum { adma_state_idle , adma_state_pkt , adma_state_mmio , } cocci_id@p ;
...
position p;
@@
 struct adma_port_priv * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,adma_state_t,dma_addr_t;
@@
 struct adma_port_priv {  u8 * pkt ;  dma_addr_t pkt_dma ;  adma_state_t state ; } cocci_id@p ;
...
position p;
@@
 enum { ADMA_MMIO_BAR = 4 , ADMA_PORTS = 2 , ADMA_CPB_BYTES = 40 , ADMA_PRD_BYTES = LIBATA_MAX_PRD * 16 , ADMA_PKT_BYTES = ADMA_CPB_BYTES + ADMA_PRD_BYTES , ADMA_DMA_BOUNDARY = 0xffffffff , ADMA_MODE_LOCK = 0x00c7 , ADMA_CONTROL = 0x0000 , ADMA_STATUS = 0x0002 , ADMA_CPB_COUNT = 0x0004 , ADMA_CPB_CURRENT = 0x000c , ADMA_CPB_NEXT = 0x000c , ADMA_CPB_LOOKUP = 0x0010 , ADMA_FIFO_IN = 0x0014 , ADMA_FIFO_OUT = 0x0016 , aNIEN = ( 1 << 8 ) , aGO = ( 1 << 7 ) , aRSTADM = ( 1 << 5 ) , aPIOMD4 = 0x0003 , aPSD = ( 1 << 6 ) , aUIRQ = ( 1 << 4 ) , aPERR = ( 1 << 0 ) , cDONE = ( 1 << 0 ) , cATERR = ( 1 << 3 ) , cVLD = ( 1 << 0 ) , cDAT = ( 1 << 2 ) , cIEN = ( 1 << 3 ) , pORD = ( 1 << 4 ) , pDIRO = ( 1 << 5 ) , pEND = ( 1 << 7 ) , rIGN = ( 1 << 5 ) , rEND = ( 1 << 7 ) , ADMA_REGS_CONTROL = 0x0e , ADMA_REGS_SECTOR_COUNT = 0x12 , ADMA_REGS_LBA_LOW = 0x13 , ADMA_REGS_LBA_MID = 0x14 , ADMA_REGS_LBA_HIGH = 0x15 , ADMA_REGS_DEVICE = 0x16 , ADMA_REGS_COMMAND = 0x17 , board_1841_idx = 0 , } cocci_id@p ;
