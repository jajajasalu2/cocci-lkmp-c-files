...
position p;
@@
 const struct rockchip_dp_chip_data * cocci_id@p ;
...
position p;
@@
 struct rockchip_dp_device * cocci_id@p ;
...
position p;
@@
 struct rockchip_dp_device {  struct drm_device * drm_dev ;  struct device * dev ;  struct drm_encoder encoder ;  struct drm_display_mode mode ;  struct clk * pclk ;  struct clk * grfclk ;  struct regmap * grf ;  struct reset_control * rst ;  const struct rockchip_dp_chip_data * data ;  struct analogix_dp_device * adp ;  struct analogix_dp_plat_data plat_data ; } cocci_id@p ;
...
position p;
@@
 struct analogix_dp_plat_data * cocci_id@p ;
...
typedef u32;
@@
 struct rockchip_dp_chip_data {  u32 lcdsel_grf_reg ;  u32 lcdsel_big ;  u32 lcdsel_lit ;  u32 chip_type ; } cocci_id@p ;
