...
typedef u32;
@@
 const u32 cocci_id@p [ GYRO_3D_CHANNEL_MAX ] ;
...
position p;
@@
 enum gyro_3d_channel { CHANNEL_SCAN_INDEX_X , CHANNEL_SCAN_INDEX_Y , CHANNEL_SCAN_INDEX_Z , GYRO_3D_CHANNEL_MAX , } cocci_id@p ;
...
position p;
@@
 struct gyro_3d_state * cocci_id@p ;
...
typedef u32;
@@
 struct gyro_3d_state {  struct hid_sensor_hub_callbacks callbacks ;  struct hid_sensor_common common_attributes ;  struct hid_sensor_hub_attribute_info gyro [ GYRO_3D_CHANNEL_MAX ] ;  u32 gyro_val [ GYRO_3D_CHANNEL_MAX ] ;  int scale_pre_decml ;  int scale_post_decml ;  int scale_precision ;  int value_offset ; } cocci_id@p ;
