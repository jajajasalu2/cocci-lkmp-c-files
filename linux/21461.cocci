...
position p;
@@
 struct acpi_pci_generic_root_info {  struct acpi_pci_root_info common ;  struct pci_config_window * cfg ; } cocci_id@p ;
...
position p;
@@
 struct acpi_pci_generic_root_info * cocci_id@p ;
