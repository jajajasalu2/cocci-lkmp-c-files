...
position p;
@@
 struct hws_basic_entry * cocci_id@p ;
...
position p;
@@
 struct hws_trailer_entry * cocci_id@p ;
...
position p;
@@
 struct sf_buffer {  unsigned long * sdbt ;  unsigned long num_sdb ;  unsigned long num_sdbt ;  unsigned long * tail ; } cocci_id@p ;
...
position p;
@@
 struct hws_lsctl_request_block cocci_id@p ;
...
position p;
@@
 struct perf_sf_sde_regs * cocci_id@p ;
...
position p;
@@
 const struct hws_qsi_info_block * cocci_id@p ;
...
position p;
@@
 struct hws_qsi_info_block * cocci_id@p ;
...
position p;
@@
 struct attribute * cocci_id@p [ SF_CYCLES_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct aux_buffer {  struct sf_buffer sfb ;  unsigned long head ;  unsigned long alert_mark ;  unsigned long empty_mark ;  unsigned long * sdb_index ;  unsigned long * sdbt_index ; } cocci_id@p ;
...
position p;
@@
 struct cpu_hw_sf {  struct hws_qsi_info_block qsi ;  struct hws_lsctl_request_block lsctl ;  struct sf_buffer sfb ;  unsigned int flags ;  struct perf_event * event ;  struct perf_output_handle handle ; } cocci_id@p ;
...
position p;
@@
 enum { SF_CYCLES_BASIC_ATTR_IDX = 0 , SF_CYCLES_BASIC_DIAG_ATTR_IDX , SF_CYCLES_ATTR_MAX , } cocci_id@p ;
