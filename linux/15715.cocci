...
position p;
@@
 const signed char cocci_id@p [ DIFFUSING_MATRIX_WIDTH ] [ DIFFUSING_MATRIX_HEIGHT ] ;
...
position p;
@@
 const struct fbtft_gpio * cocci_id@p ;
...
position p;
@@
 struct {  int xs , ys_page , xe , ye_page ; } cocci_id@p ;
