...
position p;
@@
 enum discover_event cocci_id@p ;
...
position p;
@@
 struct sas_discovery_event * cocci_id@p ;
...
typedef work_func_t;
@@
 const work_func_t cocci_id@p [ DISC_NUM_EVENTS ] ;
...
position p;
@@
 struct sas_discovery * cocci_id@p ;
