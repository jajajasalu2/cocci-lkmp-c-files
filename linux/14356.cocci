...
position p;
@@
 struct horus3a_priv * cocci_id@p ;
...
position p;
@@
 enum horus3a_state { STATE_UNKNOWN , STATE_SLEEP , STATE_ACTIVE , } cocci_id@p ;
...
position p;
@@
 const struct horus3a_config * cocci_id@p ;
...
typedef u8,u32;
@@
 struct horus3a_priv {  u32 frequency ;  u8 i2c_address ;  struct i2c_adapter * i2c ;  enum horus3a_state state ;  void * set_tuner_data ;  int ( * set_tuner ) ( void * , int ) ; } cocci_id@p ;
