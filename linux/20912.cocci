...
position p;
@@
 struct vector_private * cocci_id@p ;
...
position p;
@@
 struct iovec cocci_id@p [ 3 + MAX_IOV_SIZE ] ;
...
position p;
@@
 struct vector_device cocci_id@p ;
...
position p;
@@
 struct vector_queue * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int n , struct arglist * def ) ;
...
position p;
@@
 struct vector_device {  struct list_head list ;  struct net_device * dev ;  struct platform_device pdev ;  int unit ;  int opened ; } cocci_id@p ;
...
position p;
@@
 struct iovec cocci_id@p [ 2 + MAX_IOV_SIZE ] ;
...
position p;
@@
 struct vector_cmd_line_arg * cocci_id@p ;
...
position p;
@@
 struct vector_estats cocci_id@p ;
...
position p;
@@
 struct vector_cmd_line_arg {  struct list_head list ;  int unit ;  char * arguments ; } cocci_id@p ;
