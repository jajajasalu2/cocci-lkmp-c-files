...
position p;
@@
 void cocci_id@p ( struct usb_ep * usbep , struct usb_request * usbreq ) ;
...
position p;
@@
 struct udc_data_dma * cocci_id@p ;
...
position p;
@@
 union udc_setup_data cocci_id@p ;
...
position p;
@@
 struct udc_request * cocci_id@p ( struct udc_ep * ep ) ;
...
position p;
@@
 void cocci_id@p ( struct udc * dev ) ;
