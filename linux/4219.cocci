...
position p;
@@
 struct cros_ec_rpmsg_response cocci_id@p ;
...
position p;
@@
 struct cros_ec_rpmsg {  struct rpmsg_device * rpdev ;  struct completion xfer_ack ;  struct work_struct host_event_work ;  struct rpmsg_endpoint * ept ; } cocci_id@p ;
...
position p;
@@
 struct cros_ec_rpmsg cocci_id@p ;
