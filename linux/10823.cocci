...
position p;
@@
 struct amdgpu_prt_cb cocci_id@p ;
...
position p;
@@
 struct amdgpu_vm_pt cocci_id@p ;
...
position p;
@@
 struct amdgpu_vm_bo_base * cocci_id@p ;
...
position p;
@@
 struct amdgpu_bo_va_mapping * cocci_id@p ;
...
position p;
@@
 union drm_amdgpu_vm * cocci_id@p ;
...
position p;
@@
 struct amdgpu_task_info * cocci_id@p ;
...
position p;
@@
 struct amdgpu_prt_cb {  struct amdgpu_device * adev ;  struct dma_fence_cb cb ; } cocci_id@p ;
...
position p;
@@
 struct amdgpu_vm_pt_cursor * cocci_id@p ;
...
position p;
@@
 struct amdgpu_vmid_mgr * cocci_id@p ;
...
position p;
@@
 struct amdgpu_vm_update_params * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * p , struct amdgpu_bo * bo ) ;
...
position p;
@@
 const struct amdgpu_ip_block * cocci_id@p ;
...
typedef uint64_t;
@@
 struct amdgpu_vm_pt_cursor {  uint64_t pfn ;  struct amdgpu_vm_pt * parent ;  struct amdgpu_vm_pt * entry ;  unsigned level ; } cocci_id@p ;
...
position p;
@@
 enum amdgpu_vm_level cocci_id@p ;
