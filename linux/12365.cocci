...
position p;
@@
 struct mipi_dsi_host * cocci_id@p ;
...
position p;
@@
 struct exynos_dsi_transfer cocci_id@p ;
...
position p;
@@
 const struct mipi_dsi_msg * cocci_id@p ;
...
position p;
@@
 const struct exynos_dsi_driver_data * cocci_id@p ;
...
position p;
@@
 struct exynos_dsi_driver_data {  const unsigned int * reg_ofs ;  unsigned int plltmr_reg ;  unsigned int has_freqband : 1 ;  unsigned int has_clklane_stop : 1 ;  unsigned int num_clks ;  unsigned int max_freq ;  unsigned int wait_for_reset ;  unsigned int num_bits_resol ;  const unsigned int * reg_values ; } cocci_id@p ;
...
position p;
@@
 enum exynos_dsi_transfer_type { EXYNOS_DSI_TX , EXYNOS_DSI_RX , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct exynos_dsi_transfer {  struct list_head list ;  struct completion completed ;  int result ;  struct mipi_dsi_packet packet ;  u16 flags ;  u16 tx_done ;  u8 * rx_payload ;  u16 rx_len ;  u16 rx_done ; } cocci_id@p ;
...
position p;
@@
 const struct mipi_dsi_host_ops cocci_id@p ;
...
position p;
@@
 enum reg_value_idx { RESET_TYPE , PLL_TIMER , STOP_STATE_CNT , PHYCTRL_ULPS_EXIT , PHYCTRL_VREG_LP , PHYCTRL_SLEW_UP , PHYTIMING_LPX , PHYTIMING_HS_EXIT , PHYTIMING_CLK_PREPARE , PHYTIMING_CLK_ZERO , PHYTIMING_CLK_POST , PHYTIMING_CLK_TRAIL , PHYTIMING_HS_PREPARE , PHYTIMING_HS_ZERO , PHYTIMING_HS_TRAIL , } cocci_id@p ;
...
position p;
@@
 struct mipi_dsi_packet * cocci_id@p ;
...
position p;
@@
 struct mipi_dsi_device * cocci_id@p ;
...
position p;
@@
 enum { DSI_PORT_IN , DSI_PORT_OUT , } cocci_id@p ;
