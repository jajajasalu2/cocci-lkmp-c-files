...
position p;
@@
 struct mmp_tdma_desc * cocci_id@p ;
...
position p;
@@
 struct mmp_tdma_device * cocci_id@p ;
...
position p;
@@
 struct mmp_tdma_filter_param {  unsigned int chan_id ; } cocci_id@p ;
...
position p;
@@
 struct mmp_tdma_filter_param cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dma_chan * chan , enum dma_transfer_direction dir , struct dma_slave_config * dmaengine_cfg ) ;
...
typedef u32;
@@
 struct mmp_tdma_desc {  u32 byte_cnt ;  u32 src_addr ;  u32 dst_addr ;  u32 nxt_desc ; } cocci_id@p ;
...
position p;
@@
 struct mmp_tdma_device {  struct device * dev ;  void __iomem * base ;  struct dma_device device ;  struct mmp_tdma_chan * tdmac [ TDMA_CHANNEL_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct mmp_tdma_chan cocci_id@p ;
...
position p;
@@
 enum mmp_tdma_type { MMP_AUD_TDMA = 0 , PXA910_SQU , } cocci_id@p ;
