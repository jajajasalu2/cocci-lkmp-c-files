...
position p;
@@
 struct rtl2832_sdr_dev cocci_id@p ;
...
position p;
@@
 struct rtl2832_sdr_frame_buf cocci_id@p ;
...
position p;
@@
 struct rtl2832_sdr_format cocci_id@p [ ] ;
...
typedef u32;
@@
 struct rtl2832_sdr_format {  char * name ;  u32 pixelformat ;  u32 buffersize ; } cocci_id@p ;
...
position p;
@@
 struct rtl2832_sdr_frame_buf {  struct vb2_v4l2_buffer vb ;  struct list_head list ; } cocci_id@p ;
