...
position p;
@@
 struct drm_mode_modeinfo cocci_id@p ;
...
position p;
@@
 struct drm_mode_get_connector * cocci_id@p ;
...
position p;
@@
 const struct drm_file * cocci_id@p ;
...
position p;
@@
 struct drm_mode_connector_set_property * cocci_id@p ;
...
position p;
@@
 enum drm_connector_force cocci_id@p ;
...
position p;
@@
 const struct drm_prop_enum_list cocci_id@p [ ] ;
...
position p;
@@
 struct drm_conn_prop_enum_list cocci_id@p [ ] ;
...
position p;
@@
 struct drm_conn_prop_enum_list {  int type ;  const char * name ;  struct ida ida ; } cocci_id@p ;
...
position p;
@@
 struct drm_mode_obj_set_property cocci_id@p ;
...
position p;
@@
 enum subpixel_order cocci_id@p ;
...
position p;
@@
 struct drm_cmdline_mode * cocci_id@p ;
