...
position p;
@@
 struct isp_ccdc_device * cocci_id@p ;
...
position p;
@@
 struct isp_parallel_cfg * cocci_id@p ;
...
position p;
@@
 struct ispccdc_lsc_config_req * cocci_id@p ;
...
position p;
@@
 struct v4l2_mbus_framefmt * cocci_id@p ( struct isp_ccdc_device * ccdc , struct v4l2_subdev_pad_config * cfg , unsigned int pad , enum v4l2_subdev_format_whence which ) ;
...
position p;
@@
 struct omap3isp_ccdc_update_config * cocci_id@p ;
...
position p;
@@
 struct omap3isp_ccdc_fpc cocci_id@p ;
...
position p;
@@
 struct omap3isp_ccdc_lsc_config * cocci_id@p ;
