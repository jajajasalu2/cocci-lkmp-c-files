...
typedef u32;
@@
 int cocci_id@p ( char * argument , u32 to_be_done ) ;
...
position p;
@@
 struct ap_dump_action * cocci_id@p ;
...
position p;
@@
 int ACPI_SYSTEM_XFACE cocci_id@p ;
...
position p;
@@
 struct ap_dump_action cocci_id@p [ AP_MAX_ACTIONS ] ;
