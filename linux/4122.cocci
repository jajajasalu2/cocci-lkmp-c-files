...
position p;
@@
 struct serdes_am654_clk_mux {  struct clk_hw hw ;  struct regmap * regmap ;  unsigned int reg ;  int clk_id ;  struct clk_init_data clk_data ; } cocci_id@p ;
...
position p;
@@
 struct serdes_am654_clk_mux cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ SERDES_NUM_CLOCKS ] ;
...
position p;
@@
 struct serdes_am654 * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ SERDES_NUM_MUX_COMBINATIONS ] [ SERDES_NUM_CLOCKS ] ;
