...
position p;
@@
 struct tfrc_rx_hist_entry cocci_id@p ;
...
position p;
@@
 struct tfrc_rx_hist * cocci_id@p ;
...
position p;
@@
 const struct tfrc_rx_hist * cocci_id@p ;
...
position p;
@@
 struct tfrc_loss_hist * cocci_id@p ;
