...
position p;
@@
 struct da9055_hwmon cocci_id@p ;
...
position p;
@@
 struct da9055_hwmon {  struct da9055 * da9055 ;  struct mutex hwmon_lock ;  struct mutex irq_lock ;  struct completion done ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ DA9055_ADC_TJUNC + 1 ] ;
