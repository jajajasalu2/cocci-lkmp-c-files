...
position p;
@@
 struct fptr {  unsigned long fp ;  unsigned long gp ; } * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_logical_to_physical_t;
@@
 pal_logical_to_physical_t cocci_id@p ;
...
position p;
@@
 volatile int cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct sal_to_os_boot * cocci_id@p ;
...
position p;
@@
 struct smp_boot_data cocci_id@p ;
...
position p;
@@
 volatile unsigned long cocci_id@p [ SLAVE + 1 ] ;
...
position p;
@@
 struct sal_to_os_boot cocci_id@p [ NR_CPUS ] ;
