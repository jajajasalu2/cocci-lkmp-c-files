...
position p;
@@
 const struct max1363_chip_info cocci_id@p [ ] ;
...
position p;
@@
 const enum max1363_modes cocci_id@p [ ] ;
...
position p;
@@
 const struct max1363_mode cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct max1363_chip_info {  const struct iio_info * info ;  const struct iio_chan_spec * channels ;  int num_channels ;  const enum max1363_modes * mode_list ;  enum max1363_modes default_mode ;  u16 int_vref_mv ;  u8 num_modes ;  u8 bits ; } cocci_id@p ;
...
typedef int8_t;
@@
 struct max1363_mode {  int8_t conf ; 
...
position p;
@@
 struct max1363_state cocci_id@p ;
