...
position p;
@@
 struct br_mdb_complete_info * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ MDBA_SET_ENTRY_MAX + 1 ] ;
...
position p;
@@
 struct br_mdb_entry * * cocci_id@p ;
...
position p;
@@
 struct br_mdb_complete_info {  struct net_bridge_port * port ;  struct br_ip ip ; } cocci_id@p ;
