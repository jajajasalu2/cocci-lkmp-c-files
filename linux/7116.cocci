...
typedef pte_t;
@@
 void cocci_id@p ( unsigned long , unsigned long , void ( * ) ( pte_t * , unsigned long ) , unsigned long ) ;
...
position p;
@@
 struct ibase_data_struct cocci_id@p ;
...
typedef pte_t;
@@
 void cocci_id@p ( pte_t * , unsigned long ) ;
...
position p;
@@
 struct ibase_data_struct {  struct ioc * ioc ;  int ioc_num ; } cocci_id@p ;
...
position p;
@@
 struct sba_dma_pair * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct parisc_device * , u32 , u32 ) ;
...
position p;
@@
 int cocci_id@p ( struct parisc_device * ) ;
