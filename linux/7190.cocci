...
position p;
@@
 struct max14577_muic_info cocci_id@p ;
...
position p;
@@
 enum max14577_muic_cable_group { MAX14577_CABLE_GROUP_ADC = 0 , MAX14577_CABLE_GROUP_CHG , } cocci_id@p ;
...
position p;
@@
 struct max14577_muic_irq cocci_id@p [ ] ;
...
position p;
@@
 enum max14577_muic_cable_group cocci_id@p ;
...
position p;
@@
 enum max14577_muic_status { MAX14577_MUIC_STATUS1 = 0 , MAX14577_MUIC_STATUS2 = 1 , MAX14577_MUIC_STATUS_END , } cocci_id@p ;
...
position p;
@@
 struct max14577_muic_irq {  unsigned int irq ;  const char * name ;  unsigned int virq ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct max14577_muic_info {  struct device * dev ;  struct max14577 * max14577 ;  struct extcon_dev * edev ;  int prev_cable_type ;  int prev_chg_type ;  u8 status [ MAX14577_MUIC_STATUS_END ] ;  struct max14577_muic_irq * muic_irqs ;  unsigned int muic_irqs_num ;  bool irq_adc ;  bool irq_chg ;  struct work_struct irq_work ;  struct mutex mutex ;  struct delayed_work wq_detcable ;  int path_usb ;  int path_uart ; } cocci_id@p ;
...
position p;
@@
 enum max14577_muic_adc_debounce_time cocci_id@p ;
...
position p;
@@
 enum max14577_muic_adc_debounce_time { ADC_DEBOUNCE_TIME_5MS = 0 , ADC_DEBOUNCE_TIME_10MS , ADC_DEBOUNCE_TIME_25MS , ADC_DEBOUNCE_TIME_38_62MS , } cocci_id@p ;
