...
position p;
@@
 struct nfit_set_info cocci_id@p ;
...
position p;
@@
 const struct nfit_set_info_map * cocci_id@p ;
...
position p;
@@
 struct nd_mapping_desc * cocci_id@p ;
...
typedef u64,u32;
@@
 struct nfit_set_info {  struct nfit_set_info_map {  u64 region_offset ;  u32 serial_number ;  u32 pad ; } mapping [ 0 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,u32,u16;
@@
 struct nfit_set_info2 {  struct nfit_set_info_map2 {  u64 region_offset ;  u32 serial_number ;  u16 vendor_id ;  u16 manufacturing_date ;  u8 manufacturing_location ;  u8 reserved [ 31 ] ; } mapping [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct nfit_set_info_map2 * cocci_id@p ;
...
position p;
@@
 struct nd_blk_region_desc * cocci_id@p ;
...
position p;
@@
 struct nfit_set_info2 * cocci_id@p ;
...
position p;
@@
 enum { BCW_OFFSET_MASK = ( 1ULL << 48 ) - 1 , BCW_LEN_SHIFT = 48 , BCW_LEN_MASK = ( 1ULL << 8 ) - 1 , BCW_CMD_SHIFT = 56 , } cocci_id@p ;
...
position p;
@@
 struct acpi_table_nfit cocci_id@p ;
...
position p;
@@
 struct nfit_table_prev {  struct list_head spas ;  struct list_head memdevs ;  struct list_head dcrs ;  struct list_head bdws ;  struct list_head idts ;  struct list_head flushes ; } cocci_id@p ;
...
position p;
@@
 struct acpi_nfit_header * cocci_id@p ;
...
position p;
@@
 struct nd_mapping_desc cocci_id@p [ ND_MAX_MAPPINGS ] ;
...
typedef guid_t;
@@
 guid_t cocci_id@p [ NFIT_UUID_MAX ] ;
...
position p;
@@
 struct nfit_table_prev * cocci_id@p ;
...
position p;
@@
 struct acpi_nfit_interleave cocci_id@p ;
...
position p;
@@
 const struct nvdimm_security_ops * cocci_id@p ;
...
position p;
@@
 const struct nd_cmd_desc * cocci_id@p ;
...
position p;
@@
 struct nd_interleave_set * cocci_id@p ;
...
position p;
@@
 struct acpi_nfit_smbios cocci_id@p ;
...
position p;
@@
 const struct nfit_set_info_map2 * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ NVDIMM_FAMILY_MAX + 1 ] [ 32 ] ;
...
position p;
@@
 enum nfit_aux_cmds { NFIT_CMD_TRANSLATE_SPA = 5 , NFIT_CMD_ARS_INJECT_SET = 7 , NFIT_CMD_ARS_INJECT_CLEAR = 8 , NFIT_CMD_ARS_INJECT_GET = 9 , } cocci_id@p ;
...
position p;
@@
 enum nfit_ars_state cocci_id@p ;
...
position p;
@@
 struct nfit_set_info_map cocci_id@p ;
...
position p;
@@
 struct nd_cmd_dimm_flags cocci_id@p ;
...
position p;
@@
 struct acpi_table_header * cocci_id@p ;
...
position p;
@@
 struct nd_region_desc * cocci_id@p ;
