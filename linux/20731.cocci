...
position p;
@@
 struct rt_sigframe {  char __user * pretcode ;  int sig ;  struct siginfo __user * pinfo ;  void __user * puc ;  struct siginfo info ;  struct ucontext uc ;  struct _xstate fpstate ;  char retcode [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct sigframe {  char __user * pretcode ;  int sig ;  struct sigcontext sc ;  struct _xstate fpstate ;  unsigned long extramask [ _NSIG_WORDS - 1 ] ;  char retcode [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct rt_sigframe {  char __user * pretcode ;  struct ucontext uc ;  struct siginfo info ;  struct _xstate fpstate ; } cocci_id@p ;
