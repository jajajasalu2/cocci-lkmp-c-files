...
typedef u32;
@@
 struct dax_header {  u32 ccb_version : 4 ;  u32 pipe : 1 ;  u32 longccb : 1 ;  u32 cond : 1 ;  u32 serial : 1 ;  u32 opcode : 8 ;  u32 reserved : 3 ;  u32 table_addr_type : 2 ;  u32 out_addr_type : 3 ;  u32 sec_addr_type : 3 ;  u32 pri_addr_type : 3 ;  u32 cca_addr_type : 2 ; } cocci_id@p ;
...
typedef u64;
@@
 struct dax_ccb {  struct dax_header hdr ;  struct dax_control ctrl ;  void * ca ;  void * pri ;  struct dax_data_access dac ;  void * sec ;  u64 dword5 ;  void * out ;  void * tbl ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * i , struct file * f ) ;
...
typedef u64,u32;
@@
 struct dax_ctx {  struct dax_ccb * ccb_buf ;  u64 ccb_buf_ra ;  struct dax_cca * ca_buf ;  u64 ca_buf_ra ;  struct page * pages [ DAX_CA_ELEMS ] [ NUM_STREAM_TYPES ] ;  struct task_struct * owner ;  struct task_struct * client ;  union ccb_result result ;  u32 ccb_count ;  u32 fail_count ; } cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct dax_cca {  u8 status ;  u8 err ;  u8 rsvd [ 2 ] ;  u32 n_remaining ;  u32 output_sz ;  u32 rsvd2 ;  u64 run_cycles ;  u64 run_stats ;  u32 n_processed ;  u32 rsvd3 [ 5 ] ;  u64 retval ;  u64 rsvd4 [ 8 ] ; } cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( u64 ca , struct ccb_info_result * info ) ;
...
typedef u32;
@@
 struct dax_control {  u32 pri_fmt : 4 ;  u32 pri_elem_size : 5 ;  u32 pri_offset : 3 ;  u32 sec_encoding : 1 ;  u32 sec_offset : 3 ;  u32 sec_elem_size : 2 ;  u32 out_fmt : 2 ;  u32 out_elem_size : 2 ;  u32 misc : 10 ; } cocci_id@p ;
...
typedef u64,u16;
@@
 int cocci_id@p ( u64 ca , u16 * kill_res ) ;
...
typedef u64;
@@
 struct dax_data_access {  u64 flow_ctrl : 2 ;  u64 pipe_target : 2 ;  u64 out_buf_size : 20 ;  u64 unused1 : 8 ;  u64 out_alloc : 5 ;  u64 unused2 : 1 ;  u64 pri_len_fmt : 2 ;  u64 pri_len : 24 ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct file * f , struct vm_area_struct * vma ) ;
...
position p;
@@
 enum { OUT , PRI , SEC , TBL , NUM_STREAM_TYPES , } cocci_id@p ;
...
position p;
@@
 struct ccb_info_result * cocci_id@p ;
