...
symbol cocci_id;
position p;
typedef clockid_t,ktime_t,spinlock_t;
@@
 struct alarm_base {  spinlock_t lock ;  struct timerqueue_head timerqueue ;  ktime_t ( * gettime ) ( void ) ;  clockid_t base_clockid ; } cocci_id@p [ ALARM_NUMTYPE ] ;
...
position p;
@@
 enum alarmtimer_type cocci_id@p ;
