...
position p;
@@
 void cocci_id@p ( struct s3c2410_udc * dev ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_ep * _ep , int value ) ;
...
position p;
@@
 enum s3c2410_udc_cmd_e cocci_id@p ;
...
position p;
@@
 struct s3c2410_request * cocci_id@p ;
