...
position p;
@@
 struct alt_fpga2sdram_data * cocci_id@p ;
...
typedef u32;
@@
 struct prop_map {  char * prop_name ;  u32 * prop_value ;  u32 prop_max ; } cocci_id@p ;
...
position p;
@@
 const struct fpga_bridge_ops cocci_id@p ;
...
position p;
@@
 struct alt_fpga2sdram_data {  struct device * dev ;  struct regmap * sdrctl ;  int mask ; } cocci_id@p ;
