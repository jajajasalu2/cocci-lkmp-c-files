...
position p;
@@
 enum abx80x_chip { AB0801 , AB0803 , AB0804 , AB0805 , AB1801 , AB1803 , AB1804 , AB1805 , RV1805 , ABX80X , } cocci_id@p ;
...
typedef bool,u16;
@@
 struct abx80x_cap {  u16 pn ;  bool has_tc ;  bool has_wdog ; } cocci_id@p ;
...
position p;
@@
 struct abx80x_priv {  struct rtc_device * rtc ;  struct i2c_client * client ;  struct watchdog_device wdog ; } cocci_id@p ;
