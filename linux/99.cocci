...
position p;
@@
 struct resume_swap_area cocci_id@p ;
...
position p;
@@
 struct snapshot_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_loff_t;
@@
 compat_loff_t cocci_id@p ;
...
typedef bool;
@@
 struct snapshot_data {  struct snapshot_handle handle ;  int swap ;  int mode ;  bool frozen ;  bool ready ;  bool platform_support ;  bool free_bitmaps ; } cocci_id@p ;
