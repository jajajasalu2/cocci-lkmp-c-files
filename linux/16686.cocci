...
position p;
@@
 struct clps711x_gpio_data * cocci_id@p ;
...
position p;
@@
 struct clps711x_keypad_data * cocci_id@p ;
...
position p;
@@
 struct clps711x_keypad_data {  struct regmap * syscon ;  int row_count ;  unsigned int row_shift ;  struct clps711x_gpio_data * gpio_data ; } cocci_id@p ;
...
position p;
@@
 struct clps711x_gpio_data {  struct gpio_desc * desc ; 
