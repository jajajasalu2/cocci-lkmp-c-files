...
position p;
@@
 struct artpec6_pmx_func {  const char * name ;  const char * const * groups ;  const unsigned int num_groups ; } cocci_id@p ;
...
position p;
@@
 struct artpec6_pmx {  struct device * dev ;  struct pinctrl_dev * pctl ;  void __iomem * base ;  struct pinctrl_pin_desc * pins ;  unsigned int num_pins ;  const struct artpec6_pin_group * pin_groups ;  unsigned int num_pin_groups ;  const struct artpec6_pmx_func * functions ;  unsigned int num_functions ; } cocci_id@p ;
...
position p;
@@
 const struct artpec6_pmx_func cocci_id@p [ ] ;
...
position p;
@@
 const struct pin_register cocci_id@p [ ] ;
...
position p;
@@
 const struct artpec6_pin_group cocci_id@p [ ] ;
...
position p;
@@
 struct pin_register {  unsigned int start ;  unsigned int end ;  unsigned int reg_base ; } cocci_id@p ;
...
position p;
@@
 struct artpec6_pin_group {  const char * name ;  const unsigned int * pins ;  const unsigned int num_pins ;  unsigned char config ; } cocci_id@p ;
