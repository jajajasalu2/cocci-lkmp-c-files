...
position p;
@@
 struct lm355x_chip_data * cocci_id@p ;
...
position p;
@@
 struct lm355x_chip_data {  struct device * dev ;  enum lm355x_type type ;  struct led_classdev cdev_flash ;  struct led_classdev cdev_torch ;  struct led_classdev cdev_indicator ;  struct lm355x_platform_data * pdata ;  struct regmap * regmap ;  struct mutex lock ;  unsigned int last_flag ;  struct lm355x_reg_data * regs ; } cocci_id@p ;
...
typedef u8;
@@
 struct lm355x_reg_data {  u8 regno ;  u8 mask ;  u8 shift ; } cocci_id@p ;
...
position p;
@@
 enum lm3556_indic_period { INDIC_PERIOD_0 = 0 , INDIC_PERIOD_1 , INDIC_PERIOD_2 , INDIC_PERIOD_3 , INDIC_PERIOD_4 , INDIC_PERIOD_5 , INDIC_PERIOD_6 , INDIC_PERIOD_7 , } cocci_id@p ;
...
position p;
@@
 enum lm355x_mode { MODE_SHDN = 0 , MODE_INDIC , MODE_TORCH , MODE_FLASH , } cocci_id@p ;
...
position p;
@@
 struct lm355x_reg_data * cocci_id@p ;
...
position p;
@@
 struct lm355x_reg_data cocci_id@p [ REG_MAX ] ;
...
typedef u8;
@@
 struct indicator {  u8 blinking ;  u8 period_cnt ; } cocci_id@p ;
...
position p;
@@
 struct lm355x_platform_data * cocci_id@p ;
...
position p;
@@
 enum lm355x_regs { REG_FLAG = 0 , REG_TORCH_CFG , REG_TORCH_CTRL , REG_STROBE_CFG , REG_FLASH_CTRL , REG_INDI_CFG , REG_INDI_CTRL , REG_OPMODE , REG_MAX , } cocci_id@p ;
...
position p;
@@
 enum lm355x_type { CHIP_LM3554 = 0 , CHIP_LM3556 , } cocci_id@p ;
...
position p;
@@
 struct indicator cocci_id@p [ INDIC_PATTERN_SIZE ] ;
...
position p;
@@
 enum lm3556_indic_n_blank { INDIC_N_BLANK_0 = 0 , INDIC_N_BLANK_1 , INDIC_N_BLANK_2 , INDIC_N_BLANK_3 , INDIC_N_BLANK_4 , INDIC_N_BLANK_5 , INDIC_N_BLANK_6 , INDIC_N_BLANK_7 , INDIC_N_BLANK_8 , INDIC_N_BLANK_9 , INDIC_N_BLANK_10 , INDIC_N_BLANK_11 , INDIC_N_BLANK_12 , INDIC_N_BLANK_13 , INDIC_N_BLANK_14 , INDIC_N_BLANK_15 , } cocci_id@p ;
