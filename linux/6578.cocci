...
position p;
@@
 struct device_info {  int func_num ;  int device_type ;  int port_num ; } cocci_id@p ;
...
position p;
@@
 enum { UNKNOWN_CLASS = 0 , NIC_CLASS , FCOE_CLASS , ISCSI_CLASS , } cocci_id@p ;
...
position p;
@@
 struct qla4_83xx_reset_template_hdr cocci_id@p ;
...
position p;
@@
 struct qla4_83xx_quad_entry * cocci_id@p ;
...
position p;
@@
 struct qla4_83xx_rmw * cocci_id@p ;
...
position p;
@@
 struct qla4_83xx_poll cocci_id@p ;
...
position p;
@@
 struct qla4_83xx_reset_entry_hdr cocci_id@p ;
...
position p;
@@
 struct device_info cocci_id@p [ 16 ] ;
...
position p;
@@
 struct qla4_83xx_entry * cocci_id@p ;
