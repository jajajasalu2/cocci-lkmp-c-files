...
position p;
@@
 enum ps3_vendor_id { PS3_VENDOR_ID_NONE = 0 , PS3_VENDOR_ID_SONY = 0x8000000000000000UL , } cocci_id@p ;
...
position p;
@@
 enum ps3_lpar_id { PS3_LPAR_ID_CURRENT = 0 , PS3_LPAR_ID_PME = 1 , } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const struct ps3_repository_device * repo ) ;
