...
position p;
@@
 struct omap_intc_regs cocci_id@p ;
...
typedef u32;
@@
 struct omap_intc_regs {  u32 sysconfig ;  u32 protection ;  u32 idle ;  u32 threshold ;  u32 ilr [ INTCPS_NR_ILR_REGS ] ;  u32 mir [ INTCPS_NR_MIR_REGS ] ; } cocci_id@p ;
