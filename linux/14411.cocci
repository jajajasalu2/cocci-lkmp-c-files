...
position p;
@@
 struct media_v2_link cocci_id@p ;
...
position p;
@@
 struct media_link_desc cocci_id@p ;
...
position p;
@@
 const struct media_ioctl_info cocci_id@p [ ] ;
...
position p;
@@
 struct media_links_enum * cocci_id@p ;
...
position p;
@@
 struct media_entity_notify * cocci_id@p ;
...
position p;
@@
 struct media_interface * cocci_id@p ;
...
@@
 struct media_links_enum32 {  __u32 entity ;  compat_uptr_t pads ;  compat_uptr_t links ;  __u32 reserved [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct media_v2_topology * cocci_id@p ;
...
position p;
@@
 struct media_intf_devnode * cocci_id@p ;
...
position p;
@@
 const struct media_file_operations cocci_id@p ;
...
position p;
@@
 struct media_v2_pad cocci_id@p ;
...
position p;
@@
 struct media_links_enum32 cocci_id@p ;
...
position p;
@@
 struct media_pad_desc cocci_id@p ;
...
position p;
@@
 struct media_devnode * cocci_id@p ;
...
position p;
@@
 struct media_v2_interface cocci_id@p ;
...
position p;
@@
 struct media_v2_entity cocci_id@p ;
...
position p;
@@
 struct media_entity_desc * cocci_id@p ;
...
position p;
@@
 struct media_device_info * cocci_id@p ;
