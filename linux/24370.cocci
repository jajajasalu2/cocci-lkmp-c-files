...
position p;
@@
 struct ceph_x_encrypt_header * cocci_id@p ;
...
position p;
@@
 struct ceph_crypto_key * cocci_id@p ;
...
position p;
@@
 struct ceph_authorizer * cocci_id@p ;
...
position p;
@@
 const struct ceph_auth_client_ops cocci_id@p ;
...
position p;
@@
 struct ceph_x_server_challenge * cocci_id@p ;
...
position p;
@@
 struct ceph_x_authorize_reply * cocci_id@p ;
...
position p;
@@
 struct ceph_x_service_ticket_request * cocci_id@p ;
...
position p;
@@
 struct ceph_x_authorize_b * cocci_id@p ;
...
position p;
@@
 struct ceph_x_authenticate * cocci_id@p ;
...
position p;
@@
 struct ceph_x_ticket_handler * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ceph_auth_client * ac , int * pneed ) ;
...
position p;
@@
 struct ceph_x_authorizer * cocci_id@p ;
...
position p;
@@
 struct ceph_x_request_header * cocci_id@p ;
...
position p;
@@
 struct ceph_x_reply_header * cocci_id@p ;
...
position p;
@@
 struct ceph_x_challenge_blob * cocci_id@p ;
...
position p;
@@
 struct ceph_x_authorize_challenge * cocci_id@p ;
...
position p;
@@
 struct ceph_x_authorize_a * cocci_id@p ;
