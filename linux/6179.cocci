...
position p;
@@
 const struct qcom_rpm_resource cocci_id@p [ ] ;
...
typedef u32;
@@
 struct qcom_rpm_data {  u32 version ;  const struct qcom_rpm_resource * resource_table ;  unsigned int n_resources ;  unsigned int req_ctx_off ;  unsigned int req_sel_off ;  unsigned int ack_ctx_off ;  unsigned int ack_sel_off ;  unsigned int req_sel_size ;  unsigned int ack_sel_size ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ RPM_MAX_SEL_SIZE ] ;
...
position p;
@@
 const struct qcom_rpm_data * cocci_id@p ;
...
position p;
@@
 struct qcom_rpm_resource {  unsigned target_id ;  unsigned status_id ;  unsigned select_id ;  unsigned size ; } cocci_id@p ;
...
typedef u32;
@@
 struct qcom_rpm {  struct device * dev ;  struct regmap * ipc_regmap ;  unsigned ipc_offset ;  unsigned ipc_bit ;  struct clk * ramclk ;  struct completion ack ;  struct mutex lock ;  void __iomem * status_regs ;  void __iomem * ctrl_regs ;  void __iomem * req_regs ;  u32 ack_status ;  const struct qcom_rpm_data * data ; } cocci_id@p ;
