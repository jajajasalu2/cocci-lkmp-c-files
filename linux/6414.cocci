...
position p;
@@
 struct da9062_regulator * cocci_id@p ;
...
position p;
@@
 const struct da9062_regulator_info cocci_id@p [ ] ;
...
position p;
@@
 enum { DA9061_ID_BUCK1 , DA9061_ID_BUCK2 , DA9061_ID_BUCK3 , DA9061_ID_LDO1 , DA9061_ID_LDO2 , DA9061_ID_LDO3 , DA9061_ID_LDO4 , DA9061_MAX_REGULATORS , } cocci_id@p ;
...
position p;
@@
 struct da9062_regulators {  int irq_ldo_lim ;  unsigned n_regulators ;  struct da9062_regulator regulator [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct da9062_regulators * cocci_id@p ;
...
position p;
@@
 enum { DA9062_ID_BUCK1 , DA9062_ID_BUCK2 , DA9062_ID_BUCK3 , DA9062_ID_BUCK4 , DA9062_ID_LDO1 , DA9062_ID_LDO2 , DA9062_ID_LDO3 , DA9062_ID_LDO4 , DA9062_MAX_REGULATORS , } cocci_id@p ;
...
position p;
@@
 struct da9062_regulator {  struct regulator_desc desc ;  struct regulator_dev * rdev ;  struct da9062 * hw ;  const struct da9062_regulator_info * info ;  struct regmap_field * mode ;  struct regmap_field * suspend ;  struct regmap_field * sleep ;  struct regmap_field * suspend_sleep ; } cocci_id@p ;
...
position p;
@@
 struct da9062_regulator_info {  struct regulator_desc desc ;  struct reg_field mode ;  struct reg_field suspend ;  struct reg_field sleep ;  struct reg_field suspend_sleep ;  unsigned int suspend_vsel_reg ;  struct reg_field oc_event ; } cocci_id@p ;
