...
position p;
@@
 struct sharpsl_nand_partinfo * cocci_id@p ;
...
position p;
@@
 struct sharpsl_ftl {  unsigned int logmax ;  unsigned int * log2phy ; } cocci_id@p ;
...
position p;
@@
 struct sharpsl_nand_partinfo cocci_id@p [ SHARPSL_NAND_PARTS ] ;
...
symbol cocci_id;
position p;
typedef __le32,u32,__be32;
@@
 struct sharpsl_nand_partinfo {  __le32 start ;  __le32 end ;  __be32 magic ;  u32 reserved ; } cocci_id@p ;
