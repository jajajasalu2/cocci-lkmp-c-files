...
position p;
@@
 struct itd1000_state * cocci_id@p ;
...
typedef u8,u32;
@@
 struct {  u32 symbol_rate ;  u8 pgaext : 4 ;  u8 bbgvmin : 4 ; } cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 const struct {  u32 freq ;  u8 values [ 10 ] ; } cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct {  u8 vcorg ;  u32 fmax_rg ; } cocci_id@p [ ] ;
