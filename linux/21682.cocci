...
position p;
@@
 struct cpu_cf_events * cocci_id@p ;
...
position p;
@@
 struct cf_ctrset_entry cocci_id@p ;
...
position p;
@@
 struct cf_diag_csd {  size_t used ;  unsigned char start [ PAGE_SIZE ] ;  unsigned char data [ PAGE_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct cf_trailer_entry {  union {  struct {  unsigned int clock_base : 1 ;  unsigned int speed : 1 ;  unsigned int mtda : 1 ;  unsigned int caca : 1 ;  unsigned int lcda : 1 ; } ;  unsigned long flags ; } ;  unsigned int cfvn : 16 ;  unsigned int csvn : 16 ;  unsigned int cpu_speed : 32 ;  unsigned long timestamp ;  union {  struct {  unsigned long progusage1 ;  unsigned long progusage2 ;  unsigned long progusage3 ;  unsigned long tod_base ; } ;  unsigned long progusage [ 4 ] ; } ;  unsigned int mach_type : 16 ;  unsigned int res1 : 16 ;  unsigned int res2 : 32 ; } cocci_id@p ;
...
position p;
@@
 struct cf_trailer_entry * cocci_id@p ;
...
position p;
@@
 struct cpumf_ctr_info * cocci_id@p ;
...
position p;
@@
 struct cf_ctrset_entry {  unsigned int def : 16 ;  unsigned int set : 16 ;  unsigned int ctr : 16 ;  unsigned int res1 : 16 ; } cocci_id@p ;
