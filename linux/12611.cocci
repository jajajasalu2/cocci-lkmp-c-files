...
position p;
@@
 struct dpu_core_perf * cocci_id@p ;
...
position p;
@@
 struct dpu_core_perf_params * cocci_id@p ;
...
position p;
@@
 enum dpu_crtc_client_type cocci_id@p ;
...
position p;
@@
 enum dpu_perf_mode { DPU_PERF_MODE_NORMAL , DPU_PERF_MODE_MINIMUM , DPU_PERF_MODE_FIXED , DPU_PERF_MODE_MAX , } cocci_id@p ;
