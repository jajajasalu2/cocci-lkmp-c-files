...
position p;
@@
 const struct netlbl_lsm_secattr * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ CALIPSO_MAX_BUFFER ] ;
...
position p;
@@
 struct calipso_map_cache_entry cocci_id@p ;
...
position p;
@@
 struct calipso_map_cache_bkt * cocci_id@p ;
...
typedef u32;
@@
 struct calipso_map_cache_entry {  u32 hash ;  unsigned char * key ;  size_t key_len ;  struct netlbl_lsm_cache * lsm_data ;  u32 activity ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct calipso_doi * doi_def , void * arg ) ;
...
position p;
@@
 const struct calipso_doi * cocci_id@p ;
...
position p;
@@
 const struct netlbl_calipso_ops cocci_id@p ;
...
@@
 struct calipso_map_cache_bkt {  spinlock_t lock ;  u32 size ;  struct list_head list ; } cocci_id@p ;
