...
@@
 struct twl4030_usb {  struct usb_phy phy ;  struct device * dev ;  struct regulator * usb1v5 ;  struct regulator * usb1v8 ;  struct regulator * usb3v1 ;  struct mutex lock ;  enum twl4030_usb_mode usb_mode ;  int irq ;  enum musb_vbus_id_status linkstat ;  atomic_t connected ;  bool vbus_supplied ;  bool musb_mailbox_pending ;  struct delayed_work id_workaround_work ; } cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * _twl ) ;
...
position p;
@@
 enum twl4030_usb_mode * cocci_id@p ;
...
position p;
@@
 struct twl4030_usb_data * cocci_id@p ;
