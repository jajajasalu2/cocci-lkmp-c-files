...
position p;
@@
 struct dove_thermal_priv * cocci_id@p ;
...
position p;
@@
 struct dove_thermal_priv {  void __iomem * sensor ;  void __iomem * control ; } cocci_id@p ;
...
position p;
@@
 const struct dove_thermal_priv * cocci_id@p ;
