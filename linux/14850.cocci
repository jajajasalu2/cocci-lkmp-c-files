...
position p;
@@
 struct clk_sp810_timerclken * cocci_id@p ;
...
position p;
@@
 struct clk_sp810_timerclken {  struct clk_hw hw ;  struct clk * clk ;  struct clk_sp810 * sp810 ;  int channel ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct clk_sp810 {  struct device_node * node ;  void __iomem * base ;  spinlock_t lock ;  struct clk_sp810_timerclken timerclken [ 4 ] ; } cocci_id@p ;
