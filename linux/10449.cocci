...
position p;
@@
 enum radeon_int_thermal_type cocci_id@p ;
...
position p;
@@
 struct radeon_dpm_dynamic_state * cocci_id@p ;
...
position p;
@@
 struct radeon_vce_clock_voltage_dependency_entry cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ R600_PM_NUMBER_OF_TC ] ;
...
position p;
@@
 enum r600_display_watermark cocci_id@p ;
...
position p;
@@
 enum r600_power_level cocci_id@p ;
...
position p;
@@
 struct radeon_phase_shedding_limits_entry cocci_id@p ;
...
position p;
@@
 struct radeon_uvd_clock_voltage_dependency_entry cocci_id@p ;
