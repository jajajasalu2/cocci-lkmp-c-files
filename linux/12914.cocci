...
position p;
@@
 void cocci_id@p ( ns_dev * card , struct sk_buff * iovb ) ;
...
position p;
@@
 void cocci_id@p ( ns_dev * card , struct sk_buff * skb ) ;
...
position p;
@@
 unsigned char cocci_id@p ( struct atm_dev * dev , unsigned long addr ) ;
...
position p;
@@
 void cocci_id@p ( ns_dev * card , struct iovec * iov , int count ) ;
...
position p;
@@
 void cocci_id@p ( ns_dev * card , scq_info * scq , struct atm_vcc * vcc ) ;
...
position p;
@@
 int cocci_id@p ( ns_dev * card , vc_map * vc , scq_info * scq , ns_scqe * tbd , struct sk_buff * skb ) ;
...
typedef u32;
@@
 scq_info * cocci_id@p ( ns_dev * card , int size , u32 scd ) ;
...
position p;
@@
 int cocci_id@p ( int i , struct pci_dev * pcidev ) ;
...
position p;
@@
 void cocci_id@p ( ns_dev * card , struct sk_buff * lb ) ;
...
position p;
@@
 void cocci_id@p ( ns_dev * card , scq_info * scq , int pos ) ;
...
position p;
@@
 struct ns_dev * cocci_id@p [ NS_MAX_CARDS ] ;
...
position p;
@@
 void cocci_id@p ( ns_dev * card , int error ) ;
...
position p;
@@
 void cocci_id@p ( struct atm_vcc * vcc ) ;
...
position p;
@@
 void cocci_id@p ( ns_dev * card , int n , vc_map * vc ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( ns_dev * card , u32 sram_address ) ;
...
position p;
@@
 int cocci_id@p ( struct atm_vcc * vcc ) ;
...
position p;
@@
 void cocci_id@p ( struct atm_dev * dev , unsigned char value , unsigned long addr ) ;
...
position p;
@@
 void cocci_id@p ( ns_dev * , struct sk_buff * ) ;
...
position p;
@@
 void cocci_id@p ( ns_dev * card , struct sk_buff * sb ) ;
...
typedef u32;
@@
 void cocci_id@p ( ns_dev * card , u32 sram_address , u32 * value , int count ) ;
...
position p;
@@
 void cocci_id@p ( ns_dev * card , ns_rsqe * rsqe ) ;
...
position p;
@@
 int cocci_id@p ( struct atm_vcc * vcc , struct sk_buff * skb ) ;
...
position p;
@@
 int cocci_id@p ( struct atm_dev * dev , unsigned int cmd , void __user * arg ) ;
