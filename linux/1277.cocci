...
position p;
@@
 enum { MAX3421_USBIRQ_OSCOKIRQ_BIT = 0 , MAX3421_USBIRQ_NOVBUSIRQ_BIT = 5 , MAX3421_USBIRQ_VBUSIRQ_BIT , } cocci_id@p ;
...
position p;
@@
 enum pkt_state { PKT_STATE_SETUP , PKT_STATE_TRANSFER , PKT_STATE_TERMINATE , } cocci_id@p ;
...
position p;
@@
 enum { MAX3421_HCTL_BUSRST_BIT = 0 , MAX3421_HCTL_FRMRST_BIT , MAX3421_HCTL_SAMPLEBUS_BIT , MAX3421_HCTL_SIGRSM_BIT , MAX3421_HCTL_RCVTOG0_BIT , MAX3421_HCTL_RCVTOG1_BIT , MAX3421_HCTL_SNDTOG0_BIT , MAX3421_HCTL_SNDTOG1_BIT , } cocci_id@p ;
...
position p;
@@
 struct spi_transfer cocci_id@p [ 2 ] ;
...
position p;
@@
 enum { MAX3421_USBCTL_PWRDOWN_BIT = 4 , MAX3421_USBCTL_CHIPRES_BIT , } cocci_id@p ;
...
position p;
@@
 enum { MAX3421_MODE_HOST_BIT = 0 , MAX3421_MODE_LOWSPEED_BIT , MAX3421_MODE_HUBPRE_BIT , MAX3421_MODE_SOFKAENAB_BIT , MAX3421_MODE_SEPIRQ_BIT , MAX3421_MODE_DELAYISO_BIT , MAX3421_MODE_DMPULLDN_BIT , MAX3421_MODE_DPPULLDN_BIT , } cocci_id@p ;
...
position p;
@@
 enum { MAX3421_PINCTL_GPXA_BIT = 0 , MAX3421_PINCTL_GPXB_BIT , MAX3421_PINCTL_POSINT_BIT , MAX3421_PINCTL_INTLEVEL_BIT , MAX3421_PINCTL_FDUPSPI_BIT , MAX3421_PINCTL_EP0INAK_BIT , MAX3421_PINCTL_EP2INAK_BIT , MAX3421_PINCTL_EP3INAK_BIT , } cocci_id@p ;
...
position p;
@@
 struct max3421_hcd_platform_data * cocci_id@p ;
...
typedef u8;
@@
 struct max3421_dma_buf {  u8 data [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum { ENABLE_IRQ = 0 , RESET_HCD , RESET_PORT , CHECK_UNLINK , IOPIN_UPDATE , } cocci_id@p ;
...
position p;
@@
 enum { MAX3421_HI_BUSEVENT_BIT = 0 , MAX3421_HI_RWU_BIT , MAX3421_HI_RCVDAV_BIT , MAX3421_HI_SNDBAV_BIT , MAX3421_HI_SUSDN_BIT , MAX3421_HI_CONDET_BIT , MAX3421_HI_FRAME_BIT , MAX3421_HI_HXFRDN_BIT , } cocci_id@p ;
...
position p;
@@
 enum scheduling_pass { SCHED_PASS_PERIODIC , SCHED_PASS_NON_PERIODIC , SCHED_PASS_DONE , } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct max3421_ep {  struct usb_host_endpoint * ep ;  struct list_head ep_list ;  u32 naks ;  u16 last_active ;  enum pkt_state pkt_state ;  u8 retries ;  u8 retransmit ; } cocci_id@p ;
...
position p;
@@
 enum { MAX3421_CPUCTL_IE_BIT = 0 , MAX3421_CPUCTL_PULSEWID0_BIT = 6 , MAX3421_CPUCTL_PULSEWID1_BIT , } cocci_id@p ;
...
position p;
@@
 enum max3421_rh_state { MAX3421_RH_RESET , MAX3421_RH_SUSPENDED , MAX3421_RH_RUNNING , } cocci_id@p ;
