...
position p;
@@
 struct raid_component * cocci_id@p ;
...
position p;
@@
 struct raid_component {  struct list_head node ;  struct device dev ;  int num ; } cocci_id@p ;
...
position p;
@@
 struct raid_internal * cocci_id@p ;
...
position p;
@@
 struct {  enum raid_level value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct {  enum raid_state value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct raid_internal {  struct raid_template r ;  struct raid_function_template * f ;  struct device_attribute private_attrs [ RAID_NUM_ATTRS ] ;  struct device_attribute * attrs [ RAID_NUM_ATTRS + 1 ] ; } cocci_id@p ;
