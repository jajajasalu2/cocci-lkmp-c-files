...
position p;
@@
 struct mtk_chip_config * cocci_id@p ;
...
typedef bool;
@@
 struct mtk_spi_compatible {  bool need_pad_sel ;  bool must_tx ;  bool enhance_timing ;  bool dma_ext ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_chip_config cocci_id@p ;
...
position p;
@@
 const struct mtk_spi_compatible cocci_id@p ;
