...
position p;
@@
 struct mixart_delete_group_resp cocci_id@p ;
...
position p;
@@
 struct mixart_bufferinfo cocci_id@p ;
...
position p;
@@
 struct mixart_stream * cocci_id@p ;
...
position p;
@@
 struct mixart_flowinfo * cocci_id@p ;
...
position p;
@@
 struct mixart_clock_properties_resp cocci_id@p ;
...
position p;
@@
 struct mixart_return_uid cocci_id@p ;
...
position p;
@@
 struct mixart_group_state_resp cocci_id@p ;
...
position p;
@@
 struct mixart_group_state_req cocci_id@p ;
...
position p;
@@
 struct mixart_stream_param_desc cocci_id@p ;
...
position p;
@@
 struct mixart_stream_state_req cocci_id@p ;
...
position p;
@@
 struct mixart_clock_properties cocci_id@p ;
...
position p;
@@
 struct {  struct mixart_streaming_group_req sgroup_req ;  struct mixart_streaming_group sgroup_resp ; } * cocci_id@p ;
