...
position p;
@@
 const struct iwl_dvm_cfg cocci_id@p ;
...
position p;
@@
 struct iwl5000_channel_switch_cmd cocci_id@p ;
...
position p;
@@
 struct iwl6000_channel_switch_cmd * cocci_id@p ;
...
position p;
@@
 const struct iwl_dvm_bt_params cocci_id@p ;
