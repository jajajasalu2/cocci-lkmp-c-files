...
position p;
@@
 enum ps3_sys_manager_next_op { PS3_SM_NEXT_OP_SYS_SHUTDOWN = 1 , PS3_SM_NEXT_OP_SYS_REBOOT = 2 , PS3_SM_NEXT_OP_LPAR_REBOOT = 0x82 , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct {  u8 version ;  u8 reserved_1 [ 3 ] ;  u32 attribute ; } cocci_id@p ;
...
position p;
@@
 struct ps3_vuart_port_driver cocci_id@p ;
...
position p;
@@
 enum ps3_sys_manager_next_op cocci_id@p ;
...
position p;
@@
 struct ps3_sys_manager_ops cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 version ;  u8 reserved_1 [ 3 ] ;  u8 status ;  u8 reserved_2 [ 11 ] ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct {  u8 version ;  u8 type ;  u8 reserved_1 [ 2 ] ;  u32 value ;  u8 reserved_2 [ 8 ] ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct ps3_sys_manager_header {  u8 version ;  u8 size ;  u16 reserved_1 ;  u32 payload_size ;  u16 service_id ;  u16 reserved_2 ;  u32 request_tag ; } cocci_id@p ;
...
position p;
@@
 enum ps3_sys_manager_button_event { PS3_SM_BUTTON_EVENT_HARD = 0 , PS3_SM_BUTTON_EVENT_SOFT = 1 , } cocci_id@p ;
...
position p;
@@
 enum ps3_sys_manager_attr cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 version ;  u8 type ;  u8 gos_id ;  u8 reserved_1 [ 13 ] ; } cocci_id@p ;
...
position p;
@@
 enum ps3_sys_manager_wake_source { PS3_SM_WAKE_DEFAULT = 0 , PS3_SM_WAKE_W_O_L = 0x00000400 , PS3_SM_WAKE_P_O_R = 0x80000000 , } cocci_id@p ;
...
position p;
@@
 struct ps3_sys_manager_header cocci_id@p ;
...
position p;
@@
 enum ps3_sys_manager_cmd { PS3_SM_CMD_SHUTDOWN = 1 , } cocci_id@p ;
...
position p;
@@
 enum ps3_sys_manager_event { PS3_SM_EVENT_POWER_PRESSED = 3 , PS3_SM_EVENT_POWER_RELEASED = 4 , PS3_SM_EVENT_RESET_PRESSED = 5 , PS3_SM_EVENT_RESET_RELEASED = 6 , PS3_SM_EVENT_THERMAL_ALERT = 7 , PS3_SM_EVENT_THERMAL_CLEARED = 8 , } cocci_id@p ;
...
position p;
@@
 enum ps3_sys_manager_service_id { PS3_SM_SERVICE_ID_REQUEST = 1 , PS3_SM_SERVICE_ID_RESPONSE = 2 , PS3_SM_SERVICE_ID_COMMAND = 3 , PS3_SM_SERVICE_ID_EXTERN_EVENT = 4 , PS3_SM_SERVICE_ID_SET_NEXT_OP = 5 , PS3_SM_SERVICE_ID_REQUEST_ERROR = 6 , PS3_SM_SERVICE_ID_SET_ATTR = 8 , } cocci_id@p ;
...
position p;
@@
 enum { PS3_SM_RX_MSG_LEN_MIN = 24 , PS3_SM_RX_MSG_LEN_MAX = 32 , } cocci_id@p ;
...
position p;
@@
 enum ps3_sys_manager_wake_source cocci_id@p ;
...
position p;
@@
 enum ps3_sys_manager_attr { PS3_SM_ATTR_POWER = 1 , PS3_SM_ATTR_RESET = 2 , PS3_SM_ATTR_THERMAL = 4 , PS3_SM_ATTR_CONTROLLER = 8 , PS3_SM_ATTR_ALL = 0x0f , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct {  u8 version ;  u8 type ;  u8 gos_id ;  u8 reserved_1 ;  u32 wake_source ;  u8 reserved_2 [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct ps3_system_bus_device * cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 version ;  u8 type ;  u8 reserved_1 [ 14 ] ; } cocci_id@p ;
...
position p;
@@
 const struct ps3_sys_manager_header * cocci_id@p ;
