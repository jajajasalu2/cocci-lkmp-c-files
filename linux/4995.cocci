...
position p;
@@
 struct tid_flow_state * cocci_id@p ;
...
position p;
@@
 struct tid_rdma_flow * cocci_id@p ;
...
position p;
@@
 struct tid_rdma_request * cocci_id@p ;
...
position p;
@@
 struct tid_rdma_read_req * cocci_id@p ;
...
position p;
@@
 struct hfi1_qp_priv cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct rvt_qp * qp ) ;
...
position p;
@@
 void cocci_id@p ( struct tid_rdma_request * req ) ;
...
position p;
@@
 struct rvt_sge_state * * cocci_id@p ;
...
position p;
@@
 struct hfi1_ack_priv * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rvt_qp * qp ) ;
...
position p;
@@
 struct kern_tid_node * cocci_id@p ;
...
position p;
@@
 struct hfi1_swqe_priv * cocci_id@p ;
...
typedef bool,u32;
@@
 void cocci_id@p ( struct hfi1_packet * packet , struct ib_other_headers * ohdr , struct rvt_qp * qp , u32 psn , int diff , bool fecn ) ;
...
position p;
@@
 struct tid_rdma_qp_params cocci_id@p ;
...
position p;
@@
 struct tid_rdma_read_resp * cocci_id@p ;
...
position p;
@@
 struct hfi1_pkt_state cocci_id@p ;
...
position p;
@@
 struct tid_rdma_params * cocci_id@p ;
...
typedef u8,u32;
@@
 u32 cocci_id@p ( struct hfi1_devdata * dd , u8 ctxt , u8 fidx ) ;
...
position p;
@@
 struct ib_other_headers * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct hfi1_packet * packet , struct hfi1_qp_priv * priv , struct hfi1_ctxtdata * rcd , struct tid_rdma_flow * flow , bool fecn ) ;
...
position p;
@@
 int cocci_id@p ( struct rvt_qp * qp , struct ib_other_headers * ohdr , struct hfi1_pkt_state * ps ) ;
...
position p;
@@
 struct tid_rdma_pageset * cocci_id@p ;
...
position p;
@@
 struct rvt_ack_entry * cocci_id@p ;
...
position p;
@@
 struct tid_rdma_write_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rvt_qp * qp , struct tid_rdma_request * req ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct rvt_qp * qp , bool intr_ctx ) ;
