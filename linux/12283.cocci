...
position p;
@@
 const struct versatile_panel_type * cocci_id@p ;
...
typedef bool,u32;
@@
 struct versatile_panel_type {  const char * name ;  u32 magic ;  struct drm_display_mode mode ;  u32 bus_flags ;  u32 width_mm ;  u32 height_mm ;  bool ib2 ; } cocci_id@p ;
...
position p;
@@
 struct versatile_panel * cocci_id@p ;
...
position p;
@@
 struct versatile_panel {  struct device * dev ;  struct drm_panel panel ;  const struct versatile_panel_type * panel_type ;  struct regmap * map ;  struct regmap * ib2_map ; } cocci_id@p ;
