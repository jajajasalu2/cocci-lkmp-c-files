...
position p;
@@
 struct essiv_tfm_ctx * cocci_id@p ;
...
position p;
@@
 const struct essiv_tfm_ctx * cocci_id@p ;
...
position p;
@@
 struct essiv_aead_request_ctx cocci_id@p ;
...
position p;
@@
 struct essiv_instance_ctx {  union {  struct crypto_skcipher_spawn skcipher_spawn ;  struct crypto_aead_spawn aead_spawn ; } u ;  char essiv_cipher_name [ CRYPTO_MAX_ALG_NAME ] ;  char shash_driver_name [ CRYPTO_MAX_ALG_NAME ] ; } cocci_id@p ;
...
position p;
@@
 struct essiv_instance_ctx * cocci_id@p ;
...
typedef u8;
@@
 struct essiv_aead_request_ctx {  struct scatterlist sg [ 4 ] ;  u8 * assoc ;  struct aead_request aead_req ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HASH_MAX_DIGESTSIZE ] ;
...
position p;
@@
 struct essiv_tfm_ctx {  union {  struct crypto_skcipher * skcipher ;  struct crypto_aead * aead ; } u ;  struct crypto_cipher * essiv_cipher ;  struct crypto_shash * hash ;  int ivoffset ; } cocci_id@p ;
