...
position p;
@@
 struct mvm_statistics_rx_non_phy_v3 * cocci_id@p ;
...
position p;
@@
 struct iwl_bt_coex_profile_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_he_monitor_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_sniffer_apply cocci_id@p ;
...
position p;
@@
 struct iwl_bt_coex_ci_cmd * cocci_id@p ;
...
typedef u8,u16;
@@
 struct iwl_mvm_sniffer_apply {  struct iwl_mvm * mvm ;  u8 * bssid ;  u16 aid ; } cocci_id@p ;
...
position p;
@@
 struct iwl_dbg_mem_access_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_ltr_config_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_frame_stats * cocci_id@p ;
...
position p;
@@
 struct mvm_statistics_rx_non_phy * cocci_id@p ;
...
position p;
@@
 struct iwl_rss_config_cmd cocci_id@p ;
...
position p;
@@
 struct mvm_statistics_rx_phy * cocci_id@p ;
...
position p;
@@
 struct mvm_statistics_rx_ht_phy * cocci_id@p ;
...
position p;
@@
 struct iwl_mac_beacon_cmd cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ BT_FORCE_ANT_MAX ] ;
...
position p;
@@
 const struct iwl_fw_bcast_mac * cocci_id@p ;
...
position p;
@@
 struct mvm_statistics_rx_phy_v2 * cocci_id@p ;
...
position p;
@@
 struct iwl_dbg_mem_access_rsp * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IWL_MVM_UAPSD_NOAGG_BSSIDS_NUM * ETH_ALEN * 3 + 1 ] ;
...
position p;
@@
 struct iwl_lq_sta_rs_fw * cocci_id@p ;
...
position p;
@@
 struct mvm_statistics_rx_ht_phy_v1 * cocci_id@p ;
...
position p;
@@
 const struct iwl_fw_bcast_filter_attr * cocci_id@p ;
