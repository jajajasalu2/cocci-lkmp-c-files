...
typedef spinlock_t;
@@
 struct size_class {  spinlock_t lock ;  struct list_head fullness_list [ NR_ZS_FULLNESS ] ;  int size ;  int objs_per_zspage ;  int pages_per_zspage ;  unsigned int index ;  struct zs_size_stat stats ; } cocci_id@p ;
...
position p;
@@
 struct zs_pool_stats * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct zs_pool * pool , struct zspage * zspage ) ;
...
position p;
@@
 struct zs_compact_control cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( struct size_class * class ) ;
...
position p;
@@
 enum fullness_group * cocci_id@p ;
...
position p;
@@
 const struct zpool_ops * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef isolate_mode_t;
@@
 isolate_mode_t cocci_id@p ;
...
position p;
@@
 enum fullness_group cocci_id@p [ 2 ] ;
...
position p;
@@
 void cocci_id@p ( struct zspage * zspage ) ;
...
position p;
@@
 struct zs_compact_control {  struct page * s_page ;  struct page * d_page ;  int obj_idx ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct zs_pool * pool ) ;
...
position p;
@@
 int cocci_id@p ( struct zs_pool * pool ) ;
...
position p;
@@
 struct link_free {  union {  unsigned long next ;  unsigned long handle ; } ; } cocci_id@p ;
...
position p;
@@
 struct zs_size_stat {  unsigned long objs [ NR_ZS_STAT_TYPE ] ; } cocci_id@p ;
...
position p;
@@
 enum fullness_group { ZS_EMPTY , ZS_ALMOST_EMPTY , ZS_ALMOST_FULL , ZS_FULL , NR_ZS_FULLNESS , } cocci_id@p ;
...
position p;
@@
 struct zpool_driver cocci_id@p ;
...
position p;
@@
 struct mapping_area * cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p [ ZS_MAX_PAGES_PER_ZSPAGE ] ;
...
position p;
@@
 enum zs_stat_type { CLASS_EMPTY , CLASS_ALMOST_EMPTY , CLASS_ALMOST_FULL , CLASS_FULL , OBJ_ALLOCATED , OBJ_USED , NR_ZS_STAT_TYPE , } cocci_id@p ;
