...
position p;
@@
 struct octeon_lmc_pvt cocci_id@p ;
...
position p;
@@
 union cvmx_lmcx_int cocci_id@p ;
...
position p;
@@
 union cvmx_lmcx_fadr cocci_id@p ;
...
position p;
@@
 union cvmx_lmcx_config cocci_id@p ;
...
position p;
@@
 struct octeon_lmc_pvt {  unsigned long inject ;  unsigned long error_type ;  unsigned long dimm ;  unsigned long rank ;  unsigned long bank ;  unsigned long row ;  unsigned long col ; } cocci_id@p ;
...
position p;
@@
 union cvmx_lmcx_mem_cfg0 cocci_id@p ;
...
position p;
@@
 union cvmx_lmcx_int_en cocci_id@p ;
