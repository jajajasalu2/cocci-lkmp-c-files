...
symbol cocci_id;
position p;
typedef async_func_t;
@@
 async_func_t cocci_id@p ;
...
position p;
@@
 struct dpm_watchdog * cocci_id@p ;
...
position p;
@@
 struct dpm_watchdog {  struct device * dev ;  struct task_struct * tsk ;  struct timer_list timer ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pm_callback_t;
@@
 pm_callback_t cocci_id@p ;
...
position p;
@@
 struct suspend_stats cocci_id@p ;
