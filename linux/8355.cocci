...
position p;
@@
 enum nfp_abm_q_action cocci_id@p ;
...
position p;
@@
 struct nfp_abm_link * cocci_id@p ;
...
position p;
@@
 enum nfp_qdisc_type cocci_id@p ;
...
position p;
@@
 struct tc_gred_vq_qopt_offload_params * cocci_id@p ;
...
position p;
@@
 struct nfp_alink_stats * cocci_id@p ;
...
position p;
@@
 struct tc_gred_qopt_offload_stats * cocci_id@p ;
...
position p;
@@
 struct nfp_alink_xstats * cocci_id@p ;
...
position p;
@@
 struct tc_mq_qopt_offload * cocci_id@p ;
