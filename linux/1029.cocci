...
position p;
@@
 struct mtd_pairing_info * cocci_id@p ;
...
position p;
@@
 const struct mtd_pairing_info * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct mtd_info * , int section , struct mtd_oob_region * oobregion ) ;
...
position p;
@@
 struct mtd_notifier * cocci_id@p ;
