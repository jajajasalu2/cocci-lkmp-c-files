...
typedef cstate_t;
@@
 cstate_t cocci_id@p [ NHM_CSTATE_COUNT ] ;
...
position p;
@@
 unsigned long long * cocci_id@p [ NHM_CSTATE_COUNT ] ;
...
position p;
@@
 enum intel_nhm_id { C3 = 0 , C6 , PC3 , PC6 , TSC = 0xFFFF , } cocci_id@p ;
