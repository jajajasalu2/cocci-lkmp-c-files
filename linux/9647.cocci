...
position p;
@@
 struct b43legacy_pio_txpacket * * cocci_id@p ;
...
position p;
@@
 union txhdr_union {  struct b43legacy_txhdr_fw3 txhdr_fw3 ; } cocci_id@p ;
...
position p;
@@
 struct b43legacy_pioqueue * cocci_id@p ;
...
position p;
@@
 struct b43legacy_pio * cocci_id@p ;
