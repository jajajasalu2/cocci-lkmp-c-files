...
position p;
@@
 const struct s5k5baf_pixfmt * cocci_id@p ;
...
position p;
@@
 enum selection_rect { R_CIS , R_CROP_SINK , R_COMPOSE , R_CROP_SOURCE , R_INVALID , } cocci_id@p ;
...
position p;
@@
 const struct v4l2_rect * cocci_id@p ;
...
position p;
@@
 struct s5k5baf_gpio * cocci_id@p ;
...
typedef u32,u16;
@@
 struct s5k5baf_pixfmt {  u32 code ;  u32 colorspace ;  u16 reg_p_fmt ; } cocci_id@p ;
...
position p;
@@
 struct s5k5baf_gpio {  int gpio ;  int level ; } cocci_id@p ;
...
position p;
@@
 struct s5k5baf_ctrls {  struct v4l2_ctrl_handler handler ;  struct {  struct v4l2_ctrl * awb ;  struct v4l2_ctrl * gain_red ;  struct v4l2_ctrl * gain_blue ; } ;  struct {  struct v4l2_ctrl * hflip ;  struct v4l2_ctrl * vflip ; } ;  struct {  struct v4l2_ctrl * auto_exp ;  struct v4l2_ctrl * exposure ;  struct v4l2_ctrl * gain ; } ; } cocci_id@p ;
...
position p;
@@
 struct s5k5baf_ctrls * cocci_id@p ;
...
position p;
@@
 enum { S5K5BAF_FW_ID_PATCH , S5K5BAF_FW_ID_CCM , S5K5BAF_FW_ID_CIS , } cocci_id@p ;
...
position p;
@@
 enum s5k5baf_gpio_id { STBY , RST , NUM_GPIOS , } cocci_id@p ;
...
typedef u16;
@@
 struct s5k5baf_fw {  u16 count ;  struct {  u16 id ;  u16 offset ; } seq [ 0 ] ;  u16 data [ 0 ] ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct s5k5baf {  struct s5k5baf_gpio gpios [ NUM_GPIOS ] ;  enum v4l2_mbus_type bus_type ;  u8 nlanes ;  struct regulator_bulk_data supplies [ S5K5BAF_NUM_SUPPLIES ] ;  struct clk * clock ;  u32 mclk_frequency ;  struct s5k5baf_fw * fw ;  struct v4l2_subdev cis_sd ;  struct media_pad cis_pad ;  struct v4l2_subdev sd ;  struct media_pad pads [ NUM_ISP_PADS ] ;  struct mutex lock ;  int error ;  struct v4l2_rect crop_sink ;  struct v4l2_rect compose ;  struct v4l2_rect crop_source ;  int pixfmt ;  u16 fiv ;  u16 req_fiv ;  u16 auto_alg ;  struct s5k5baf_ctrls ctrls ;  unsigned int streaming : 1 ;  unsigned int apply_cfg : 1 ;  unsigned int apply_crop : 1 ;  unsigned int valid_auto_alg : 1 ;  unsigned int power ; } cocci_id@p ;
...
position p;
@@
 enum selection_rect cocci_id@p ;
