...
position p;
@@
 struct kcm_unattach * cocci_id@p ;
...
position p;
@@
 const struct strp_callbacks cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kcm_sock * kcm ) ;
