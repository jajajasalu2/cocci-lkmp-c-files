...
position p;
@@
 struct trace_mmiotrace_map * cocci_id@p ;
...
position p;
@@
 const struct pci_driver * cocci_id@p ;
...
position p;
@@
 struct trace_mmiotrace_rw * cocci_id@p ;
...
position p;
@@
 struct header_iter {  struct pci_dev * dev ; } cocci_id@p ;
...
position p;
@@
 struct mmiotrace_map * cocci_id@p ;
...
position p;
@@
 struct mmiotrace_rw * cocci_id@p ;
