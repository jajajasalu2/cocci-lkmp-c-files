...
position p;
@@
 volatile struct mac_iop * cocci_id@p [ NUM_IOPS ] ;
...
position p;
@@
 struct iop_msg cocci_id@p [ NUM_IOP_MSGS ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct iop_msg * ) ;
...
position p;
@@
 struct iop_msg * cocci_id@p [ NUM_IOPS ] [ NUM_IOP_CHAN ] ;
...
position p;
@@
 volatile struct mac_iop * cocci_id@p ;
...
position p;
@@
 struct listener cocci_id@p [ NUM_IOPS ] [ NUM_IOP_CHAN ] ;
...
position p;
@@
 struct listener {  const char * devname ;  void ( * handler ) ( struct iop_msg * ) ; } cocci_id@p ;
