...
position p;
@@
 const struct snd_mx27vis_platform_data cocci_id@p ;
...
position p;
@@
 struct mx2_camera_platform_data cocci_id@p ;
...
position p;
@@
 struct soc_camera_link cocci_id@p ;
...
position p;
@@
 const struct mxc_usbh_platform_data cocci_id@p ;
...
position p;
@@
 struct aic32x4_pdata cocci_id@p ;
...
position p;
@@
 const struct imx_ssi_platform_data cocci_id@p ;
...
position p;
@@
 const struct gpio_keys_platform_data cocci_id@p ;
