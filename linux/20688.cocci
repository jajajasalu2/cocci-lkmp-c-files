...
symbol cocci_id;
position p;
typedef bool,pteval_t;
@@
 struct kmmio_fault_page {  struct list_head list ;  struct kmmio_fault_page * release_next ;  unsigned long addr ;  pteval_t old_presence ;  bool armed ;  int count ;  bool scheduled_for_release ; } cocci_id@p ;
...
position p;
@@
 struct kmmio_fault_page * cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ KMMIO_PAGE_TABLE_SIZE ] ;
...
position p;
@@
 struct kmmio_context {  struct kmmio_fault_page * fpage ;  struct kmmio_probe * probe ;  unsigned long saved_flags ;  unsigned long addr ;  int active ; } cocci_id@p ;
...
position p;
@@
 struct kmmio_delayed_release {  struct rcu_head rcu ;  struct kmmio_fault_page * release_list ; } cocci_id@p ;
...
position p;
@@
 struct kmmio_delayed_release * cocci_id@p ;
...
position p;
@@
 struct kmmio_context * cocci_id@p ;
