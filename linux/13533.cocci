...
position p;
@@
 struct cx231xx_i2c_xfer_data * cocci_id@p ;
...
position p;
@@
 struct VENDOR_REQUEST_IN cocci_id@p ;
...
position p;
@@
 struct cx231xx_reg_seq * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct cx231xx * dev , struct urb * urb ) ;
