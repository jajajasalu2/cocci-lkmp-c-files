...
position p;
@@
 struct hinic_cmd_base_qpn cocci_id@p ;
...
position p;
@@
 struct hinic_cmd_hw_ioctxt cocci_id@p ;
...
typedef u8,u16;
@@
 struct hinic_dev_cap {  u8 status ;  u8 version ;  u8 rsvd0 [ 6 ] ;  u8 rsvd1 [ 5 ] ;  u8 intr_type ;  u8 rsvd2 [ 66 ] ;  u16 max_sqs ;  u16 max_rqs ;  u8 rsvd3 [ 208 ] ; } cocci_id@p ;
...
position p;
@@
 struct hinic_nic_cb * cocci_id@p ;
...
position p;
@@
 enum hinic_msix_state cocci_id@p ;
...
position p;
@@
 enum hinic_db_state cocci_id@p ;
...
position p;
@@
 struct hinic_dev_cap * cocci_id@p ;
...
position p;
@@
 enum hw_ioctxt_set_cmdq_depth { HW_IOCTXT_SET_CMDQ_DEPTH_DEFAULT , } cocci_id@p ;
...
position p;
@@
 enum hinic_cb_state cocci_id@p ;
...
position p;
@@
 struct hinic_cmd_fw_ctxt cocci_id@p ;
...
position p;
@@
 struct hinic_cmd_set_res_state cocci_id@p ;
...
position p;
@@
 struct hinic_cmd_hw_ci cocci_id@p ;
...
position p;
@@
 enum io_status { IO_STOPPED = 0 , IO_RUNNING = 1 , } cocci_id@p ;
...
typedef u16;
@@
 void ( * cocci_id@p ) ( void * handle , void * buf_in , u16 in_size , void * buf_out , u16 * out_size ) ;
...
position p;
@@
 struct hinic_cmd_clear_io_res cocci_id@p ;
...
position p;
@@
 struct hinic_cmd_io_status cocci_id@p ;
...
position p;
@@
 enum hinic_res_state cocci_id@p ;
...
position p;
@@
 enum intr_type { INTR_MSIX_TYPE , } cocci_id@p ;
...
position p;
@@
 enum hinic_mgmt_msg_cmd cocci_id@p ;
...
position p;
@@
 enum hinic_outbound_state cocci_id@p ;
