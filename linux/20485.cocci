...
position p;
@@
 struct patch_lock {  unsigned char queued_spin_unlock [ 3 ] ;  unsigned char vcpu_is_preempted [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 const struct patch_xxl cocci_id@p ;
...
position p;
@@
 const struct patch_lock cocci_id@p ;
