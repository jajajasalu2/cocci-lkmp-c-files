...
position p;
@@
 const struct asn1_template * cocci_id@p ;
...
position p;
@@
 struct kernel_pkey_query * cocci_id@p ;
...
position p;
@@
 const struct public_key_signature * cocci_id@p ;
...
position p;
@@
 const struct tpm_key * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ SHA1_DIGEST_SIZE ] ;
...
position p;
@@
 const struct kernel_pkey_params * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ PUB_KEY_BUF_SIZE ] ;
...
typedef u8;
@@
 const struct asn1_template {  const char * name ;  const u8 * data ;  size_t size ; } cocci_id@p [ ] ;
