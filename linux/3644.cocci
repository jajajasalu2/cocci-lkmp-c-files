...
symbol cocci_id;
position p;
typedef u8,bool,efi_guid_t,efi_char16_t;
@@
 struct variable_validate {  efi_guid_t vendor ;  char * name ;  bool ( * validate ) ( efi_char16_t * var_name , int match , u8 * data , unsigned long len ) ; } cocci_id@p ;
...
position p;
@@
 const struct variable_validate cocci_id@p [ ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct efivar_entry * , void * ) ;
