...
position p;
@@
 struct cppc_cpudata * cocci_id@p ;
...
position p;
@@
 struct acpi_psd_package * cocci_id@p ;
...
position p;
@@
 struct acpi_pcct_shared_memory * cocci_id@p ;
...
position p;
@@
 struct cppc_perf_fb_ctrs * cocci_id@p ;
...
position p;
@@
 struct cppc_pcc_data * cocci_id@p ;
...
position p;
@@
 struct acpi_pcct_hw_reduced * cocci_id@p ;
...
position p;
@@
 struct cppc_perf_ctrls * cocci_id@p ;
...
position p;
@@
 struct cpc_register_resource * cocci_id@p ;
...
position p;
@@
 struct cppc_pcc_data * cocci_id@p [ MAX_PCC_SUBSPACES ] ;
