...
symbol cocci_id;
position p;
typedef snd_pcm_access_t;
@@
 snd_pcm_access_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_pcm_subformat_t;
@@
 snd_pcm_subformat_t cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ SNDRV_PCM_CLASS_LAST + 1 ] ;
...
position p;
@@
 int cocci_id@p ( struct snd_pcm * pcm ) ;
