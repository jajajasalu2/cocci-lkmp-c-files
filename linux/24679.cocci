...
typedef u16;
@@
 struct nft_redir {  enum nft_registers sreg_proto_min : 8 ;  enum nft_registers sreg_proto_max : 8 ;  u16 flags ; } cocci_id@p ;
...
position p;
@@
 const struct nft_redir * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_REDIR_MAX + 1 ] ;
...
position p;
@@
 struct nf_nat_ipv4_multi_range_compat cocci_id@p ;
