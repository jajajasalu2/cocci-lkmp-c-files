...
typedef bool,u32;
@@
 struct anatop_regulator {  u32 delay_reg ;  int delay_bit_shift ;  int delay_bit_width ;  struct regulator_desc rdesc ;  bool bypass ;  int sel ; } cocci_id@p ;
...
position p;
@@
 struct anatop_regulator * cocci_id@p ;
