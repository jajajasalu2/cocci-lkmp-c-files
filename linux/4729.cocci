...
position p;
@@
 struct xsdfec_stats cocci_id@p ;
...
position p;
@@
 struct xsdfec_ldpc_params * cocci_id@p ;
...
position p;
@@
 struct xsdfec_config * cocci_id@p ;
...
position p;
@@
 struct xsdfec_clks {  struct clk * core_clk ;  struct clk * axi_clk ;  struct clk * din_words_clk ;  struct clk * din_clk ;  struct clk * dout_clk ;  struct clk * dout_words_clk ;  struct clk * ctrl_clk ;  struct clk * status_clk ; } cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p [ MAX_NUM_PAGES ] ;
...
position p;
@@
 struct xsdfec_status cocci_id@p ;
...
position p;
@@
 enum xsdfec_axis_word_include cocci_id@p ;
...
@@
 struct xsdfec_dev {  struct miscdevice miscdev ;  struct xsdfec_clks clks ;  wait_queue_head_t waitq ;  struct xsdfec_config config ;  char dev_name [ DEV_NAME_LEN ] ;  unsigned long flags ;  void __iomem * regs ;  struct device * dev ;  enum xsdfec_state state ;  spinlock_t error_data_lock ;  int dev_id ;  u32 isr_err_count ;  u32 cecc_count ;  u32 uecc_count ;  int irq ;  bool state_updated ;  bool stats_updated ;  bool intr_enabled ; } cocci_id@p ;
...
position p;
@@
 enum xsdfec_axis_width cocci_id@p ;
...
position p;
@@
 struct xsdfec_turbo cocci_id@p ;
