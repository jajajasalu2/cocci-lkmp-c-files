...
position p;
@@
 struct wm831x_power * cocci_id@p ;
...
position p;
@@
 struct wm831x_battery_pdata * cocci_id@p ;
...
position p;
@@
 struct chg_map {  int val ;  int reg_val ; } cocci_id@p ;
...
typedef bool;
@@
 struct wm831x_power {  struct wm831x * wm831x ;  struct power_supply * wall ;  struct power_supply * usb ;  struct power_supply * battery ;  struct power_supply_desc wall_desc ;  struct power_supply_desc usb_desc ;  struct power_supply_desc battery_desc ;  char wall_name [ 20 ] ;  char usb_name [ 20 ] ;  char battery_name [ 20 ] ;  bool have_battery ;  struct usb_phy * usb_phy ;  struct notifier_block usb_notify ; } cocci_id@p ;
