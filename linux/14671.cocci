...
position p;
@@
 struct samsung_clk_pll cocci_id@p ;
...
position p;
@@
 struct samsung_pll_rate_table cocci_id@p ;
...
position p;
@@
 const struct samsung_pll_clock * cocci_id@p ;
...
position p;
@@
 const struct samsung_pll_rate_table * cocci_id@p ;
...
position p;
@@
 struct samsung_clk_pll {  struct clk_hw hw ;  void __iomem * lock_reg ;  void __iomem * con_reg ;  unsigned short enable_offs ;  unsigned short lock_offs ;  enum samsung_pll_type type ;  unsigned int rate_count ;  const struct samsung_pll_rate_table * rate_table ; } cocci_id@p ;
