...
position p;
@@
 struct crypto_rfc4106_ctx * cocci_id@p ;
...
position p;
@@
 struct crypto_rfc4543_req_ctx * cocci_id@p ;
...
position p;
@@
 struct crypto_rfc4106_req_ctx {  struct scatterlist src [ 3 ] ;  struct scatterlist dst [ 3 ] ;  struct aead_request subreq ; } cocci_id@p ;
...
position p;
@@
 struct crypto_rfc4543_instance_ctx * cocci_id@p ;
...
position p;
@@
 struct crypto_gcm_ctx {  struct crypto_skcipher * ctr ;  struct crypto_ahash * ghash ; } cocci_id@p ;
...
position p;
@@
 struct gcm_instance_ctx * cocci_id@p ;
...
position p;
@@
 struct crypto_gcm_req_priv_ctx cocci_id@p ;
...
position p;
@@
 struct crypto_gcm_ctx * cocci_id@p ;
...
position p;
@@
 struct crypto_rfc4543_req_ctx {  struct aead_request subreq ; } cocci_id@p ;
...
position p;
@@
 struct crypto_rfc4543_instance_ctx {  struct crypto_aead_spawn aead ; } cocci_id@p ;
...
typedef u8;
@@
 struct crypto_rfc4106_ctx {  struct crypto_aead * child ;  u8 nonce [ 4 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct crypto_gcm_req_priv_ctx {  u8 iv [ 16 ] ;  u8 auth_tag [ 16 ] ;  u8 iauth_tag [ 16 ] ;  struct scatterlist src [ 3 ] ;  struct scatterlist dst [ 3 ] ;  struct scatterlist sg ;  struct crypto_gcm_ghash_ctx ghash_ctx ;  union {  struct ahash_request ahreq ;  struct skcipher_request skreq ; } u ; } cocci_id@p ;
...
position p;
@@
 struct crypto_rfc4106_req_ctx cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct crypto_async_request * areq , int err ) ;
...
position p;
@@
 struct crypto_rfc4543_ctx cocci_id@p ;
...
typedef u8;
@@
 struct crypto_rfc4543_ctx {  struct crypto_aead * child ;  struct crypto_sync_skcipher * null ;  u8 nonce [ 4 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  be128 hash ;  u8 iv [ 16 ] ;  struct crypto_wait wait ;  struct scatterlist sg [ 1 ] ;  struct skcipher_request req ; } * cocci_id@p ;
...
position p;
@@
 struct crypto_gcm_ghash_ctx * cocci_id@p ;
...
typedef u32;
@@
 struct crypto_gcm_ghash_ctx {  unsigned int cryptlen ;  struct scatterlist * src ;  int ( * complete ) ( struct aead_request * req , u32 flags ) ; } cocci_id@p ;
...
position p;
@@
 struct gcm_instance_ctx {  struct crypto_skcipher_spawn ctr ;  struct crypto_ahash_spawn ghash ; } cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct aead_request * req , bool enc ) ;
...
typedef u8;
@@
 struct {  u8 buf [ 16 ] ;  struct scatterlist sg ; } * cocci_id@p ;
