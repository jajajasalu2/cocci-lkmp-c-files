...
position p;
@@
 struct byt_gpio {  struct gpio_chip chip ;  struct platform_device * pdev ;  struct pinctrl_dev * pctl_dev ;  struct pinctrl_desc pctl_desc ;  const struct intel_pinctrl_soc_data * soc_data ;  struct intel_community * communities_copy ;  struct byt_gpio_pin_context * saved_context ; } cocci_id@p ;
...
typedef u32;
@@
 struct byt_gpio_pin_context {  u32 conf0 ;  u32 val ; } cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ BYT_NGPIO_SUS ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ BYT_NGPIO_NCORE ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ BYT_NGPIO_SCORE ] ;
