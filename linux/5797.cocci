...
position p;
@@
 const struct tb10x_pinfuncgrp cocci_id@p [ ] ;
...
position p;
@@
 struct tb10x_port {  unsigned int mode ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 struct tb10x_pinfuncgrp {  const char * name ;  const unsigned int * pins ;  const unsigned int pincnt ;  const int port ;  const unsigned int mode ;  const int isgpio ; } cocci_id@p ;
...
position p;
@@
 struct tb10x_of_pinfunc {  const char * name ;  const char * group ; } cocci_id@p ;
...
position p;
@@
 struct tb10x_pinctrl {  struct pinctrl_dev * pctl ;  void * base ;  const struct tb10x_pinfuncgrp * pingroups ;  unsigned int pinfuncgrpcnt ;  unsigned int pinfuncnt ;  struct mutex mutex ;  struct tb10x_port ports [ TB10X_PORTS ] ; 
	 DECLARE_BITMAP ( gpios , MAX_PIN + 1 ) 
		 ;  struct tb10x_of_pinfunc pinfuncs [ ] ; } cocci_id@p ;
...
position p;
@@
 struct tb10x_pinctrl * cocci_id@p ;
