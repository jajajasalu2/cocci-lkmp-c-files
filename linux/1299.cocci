...
typedef u8;
@@
 struct freecom_ide_in {  u8 Type ;  u8 Pad [ 63 ] ; } cocci_id@p ;
...
position p;
@@
 struct freecom_cb_wrap * cocci_id@p ;
...
typedef u8;
@@
 struct freecom_cb_wrap {  u8 Type ;  u8 Timeout ;  u8 Atapi [ 12 ] ;  u8 Filler [ 50 ] ; } cocci_id@p ;
...
position p;
@@
 struct freecom_status * cocci_id@p ;
...
position p;
@@
 struct freecom_xfer_wrap * cocci_id@p ;
...
typedef u8;
@@
 struct freecom_status {  u8 Status ;  u8 Reason ;  __le16 Count ;  u8 Pad [ 60 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct freecom_ide_out {  u8 Type ;  u8 Pad ;  __le16 Value ;  u8 Pad2 [ 60 ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct us_data * us , void * ibuffer , int length ) ;
