...
typedef u32;
@@
 struct ns_pinctrl {  struct device * dev ;  unsigned int chipset_flag ;  struct pinctrl_dev * pctldev ;  struct regmap * regmap ;  u32 offset ;  struct pinctrl_desc pctldesc ;  struct ns_pinctrl_group * groups ;  unsigned int num_groups ;  struct ns_pinctrl_function * functions ;  unsigned int num_functions ; } cocci_id@p ;
...
position p;
@@
 struct ns_pinctrl_function {  const char * name ;  const char * const * groups ;  const unsigned int num_groups ;  unsigned int chipsets ; } cocci_id@p ;
...
position p;
@@
 struct ns_pinctrl_group {  const char * name ;  const unsigned int * pins ;  const unsigned int num_pins ;  unsigned int chipsets ; } cocci_id@p ;
...
position p;
@@
 struct ns_pinctrl_group cocci_id@p ;
...
position p;
@@
 struct ns_pinctrl_function * cocci_id@p ;
...
position p;
@@
 const struct ns_pinctrl_function * cocci_id@p ;
...
position p;
@@
 const struct ns_pinctrl_group * cocci_id@p ;
