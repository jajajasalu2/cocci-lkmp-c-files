...
position p;
@@
 struct b43_bbatt_list * cocci_id@p ;
...
position p;
@@
 struct init2050_saved_values cocci_id@p ;
...
position p;
@@
 struct b43_rfatt_list * cocci_id@p ;
...
position p;
@@
 enum b43_interference_mitigation cocci_id@p ;
