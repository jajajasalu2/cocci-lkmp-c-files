...
typedef u8;
@@
 struct sun4i_i2s_clk_div {  u8 div ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 const struct sun4i_i2s * cocci_id@p ;
...
position p;
@@
 const struct sun4i_i2s_clk_div * cocci_id@p ;
...
typedef s8,bool;
@@
 struct sun4i_i2s_quirks {  bool has_reset ;  unsigned int reg_offset_txdata ;  const struct regmap_config * sun4i_i2s_regmap ;  struct reg_field field_clkdiv_mclk_en ;  struct reg_field field_fmt_wss ;  struct reg_field field_fmt_sr ;  const struct sun4i_i2s_clk_div * bclk_dividers ;  unsigned int num_bclk_dividers ;  const struct sun4i_i2s_clk_div * mclk_dividers ;  unsigned int num_mclk_dividers ;  unsigned long ( * get_bclk_parent_rate ) ( const struct sun4i_i2s * ) ;  s8 ( * get_sr ) ( const struct sun4i_i2s * , int ) ;  s8 ( * get_wss ) ( const struct sun4i_i2s * , int ) ;  int ( * set_chan_cfg ) ( const struct sun4i_i2s * , const struct snd_pcm_hw_params * ) ;  int ( * set_fmt ) ( const struct sun4i_i2s * , unsigned int ) ; } cocci_id@p ;
...
position p;
@@
 const struct sun4i_i2s_quirks cocci_id@p ;
...
position p;
@@
 struct sun4i_i2s {  struct clk * bus_clk ;  struct clk * mod_clk ;  struct regmap * regmap ;  struct reset_control * rst ;  unsigned int format ;  unsigned int mclk_freq ;  unsigned int slots ;  unsigned int slot_width ;  struct snd_dmaengine_dai_dma_data capture_dma_data ;  struct snd_dmaengine_dai_dma_data playback_dma_data ;  struct regmap_field * field_clkdiv_mclk_en ;  struct regmap_field * field_fmt_wss ;  struct regmap_field * field_fmt_sr ;  const struct sun4i_i2s_quirks * variant ; } cocci_id@p ;
