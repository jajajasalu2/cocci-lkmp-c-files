...
position p;
@@
 union cvmx_l2c_tadx_tag cocci_id@p ;
...
position p;
@@
 enum cvmx_l2c_event cocci_id@p ;
...
position p;
@@
 union cvmx_mio_fus_dat3 cocci_id@p ;
...
position p;
@@
 union cvmx_l2c_pfctl cocci_id@p ;
...
position p;
@@
 union cvmx_l2c_lckbase cocci_id@p ;
...
position p;
@@
 union cvmx_l2c_lckoff cocci_id@p ;
...
position p;
@@
 union cvmx_l2c_tadx_prf cocci_id@p ;
