...
position p;
@@
 const struct msm_mmu_funcs cocci_id@p ;
...
@@
 struct msm_gpummu {  struct msm_mmu base ;  struct msm_gpu * gpu ;  dma_addr_t pt_base ;  uint32_t * table ; } cocci_id@p ;
