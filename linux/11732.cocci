...
typedef u8,u32,u16;
@@
 struct nvkm_hwsq {  struct nvkm_subdev * subdev ;  u32 addr ;  u32 data ;  struct {  u8 data [ 512 ] ;  u16 size ; } c ; } cocci_id@p ;
