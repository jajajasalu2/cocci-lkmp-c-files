...
position p;
@@
 struct vt8500_port * cocci_id@p [ VT8500_MAX_PORTS ] ;
...
position p;
@@
 struct vt8500_port {  struct uart_port uart ;  char name [ 16 ] ;  struct clk * clk ;  unsigned int clk_predivisor ;  unsigned int ier ;  unsigned int vt8500_uart_flags ; } cocci_id@p ;
