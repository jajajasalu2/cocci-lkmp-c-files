...
position p;
@@
 union sab82532_irq_status * cocci_id@p ;
...
position p;
@@
 struct uart_sunsab_port cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct uart_port * ) ;
...
position p;
@@
 void cocci_id@p ( struct uart_sunsab_port * ) ;
...
position p;
@@
 struct uart_sunsab_port {  struct uart_port port ;  union sab82532_async_regs __iomem * regs ;  unsigned long irqflags ;  int dsr ;  unsigned int cec_timeout ;  unsigned int tec_timeout ;  unsigned char interrupt_mask0 ;  unsigned char interrupt_mask1 ;  unsigned char pvr_dtr_bit ;  unsigned char pvr_dsr_bit ;  unsigned int gis_shift ;  int type ;  unsigned int cached_ebrg ;  unsigned char cached_mode ;  unsigned char cached_pvr ;  unsigned char cached_dafo ; } cocci_id@p ;
...
position p;
@@
 union sab82532_async_regs cocci_id@p ;
