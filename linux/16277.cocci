...
typedef u8,s32;
@@
 struct hantro_h264_reflist_builder {  const struct v4l2_h264_dpb_entry * dpb ;  s32 pocs [ HANTRO_H264_DPB_SIZE ] ;  u8 unordered_reflist [ HANTRO_H264_DPB_SIZE ] ;  int frame_nums [ HANTRO_H264_DPB_SIZE ] ;  s32 curpoc ;  u8 num_valid ; } cocci_id@p ;
...
position p;
@@
 struct hantro_h264_dec_priv_tbl * cocci_id@p ;
...
position p;
@@
 struct hantro_h264_reflist_builder cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_h264_slice_params * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_h264_sps * cocci_id@p ;
...
position p;
@@
 struct hantro_h264_dec_hw_ctx * cocci_id@p ;
...
typedef u8,u32;
@@
 struct hantro_h264_dec_priv_tbl {  u32 cabac_table [ CABAC_INIT_BUFFER_SIZE ] ;  u32 poc [ POC_BUFFER_SIZE ] ;  u8 scaling_list [ SCALING_LIST_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_h264_dpb_entry * cocci_id@p ;
...
position p;
@@
 struct v4l2_h264_dpb_entry * cocci_id@p ;
...
position p;
@@
 struct hantro_h264_dec_ctrls * cocci_id@p ;
...
position p;
@@
 const struct hantro_h264_dec_ctrls * cocci_id@p ;
...
position p;
@@
 const struct hantro_h264_reflist_builder * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_h264_decode_params * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_h264_scaling_matrix * cocci_id@p ;
...
position p;
@@
 struct hantro_aux_buf * cocci_id@p ;
