...
typedef u32;
@@
 struct m88rs6000t_dev {  struct m88rs6000t_config cfg ;  struct i2c_client * client ;  struct regmap * regmap ;  u32 frequency_khz ; } cocci_id@p ;
...
position p;
@@
 const struct m88rs6000t_reg_val cocci_id@p [ ] ;
...
position p;
@@
 struct m88rs6000t_dev * cocci_id@p ;
...
typedef u8;
@@
 struct m88rs6000t_reg_val {  u8 reg ;  u8 val ; } cocci_id@p ;
