...
position p;
@@
 struct v2_disk_dqheader * cocci_id@p ;
...
position p;
@@
 struct qtree_mem_dqinfo * cocci_id@p ;
...
position p;
@@
 struct v2r0_disk_dqblk * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * dp , struct dquot * dquot ) ;
...
position p;
@@
 struct v2_disk_dqinfo cocci_id@p ;
...
position p;
@@
 const struct qtree_fmt_operations cocci_id@p ;
...
position p;
@@
 struct v2r1_disk_dqblk cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * dp , struct dquot * dquot ) ;
...
position p;
@@
 void cocci_id@p ( struct dquot * dquot , void * dp ) ;
