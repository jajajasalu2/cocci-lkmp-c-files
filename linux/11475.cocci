...
typedef bool;
@@
 struct nv50_mstm {  struct nouveau_encoder * outp ;  struct drm_dp_mst_topology_mgr mgr ;  struct nv50_msto * msto [ 4 ] ;  bool modified ;  bool disabled ;  int links ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nv50_disp_mthd_v1 base ;  struct nv50_disp_sor_lvds_script_v0 lvds ; } cocci_id@p ;
...
position p;
@@
 struct nv50_head_atom * cocci_id@p ;
...
position p;
@@
 struct drm_hdmi_info * cocci_id@p ;
...
position p;
@@
 struct nv50_outp_atom * cocci_id@p ;
...
position p;
@@
 struct nouveau_conn_atom * cocci_id@p ;
...
position p;
@@
 struct nv50_mstc {  struct nv50_mstm * mstm ;  struct drm_dp_mst_port * port ;  struct drm_connector connector ;  struct drm_display_mode * native ;  struct edid * edid ; } cocci_id@p ;
...
position p;
@@
 struct nvkm_i2c_aux * cocci_id@p ;
...
position p;
@@
 struct nouveau_connector * cocci_id@p ;
...
position p;
@@
 struct nouveau_crtc * cocci_id@p ;
...
position p;
@@
 struct nouveau_encoder * cocci_id@p ;
...
position p;
@@
 struct nvkm_i2c_bus * cocci_id@p ;
...
position p;
@@
 struct {  struct nv50_disp_mthd_v1 base ;  struct nv50_disp_acquire_v0 info ; } cocci_id@p ;
...
position p;
@@
 struct nv50_wndw_atom * cocci_id@p ;
...
position p;
@@
 struct {  struct nv50_disp_mthd_v1 base ;  struct nv50_disp_sor_dp_mst_link_v0 mst ; } cocci_id@p ;
...
typedef u8;
@@
 struct __packed {  struct {  struct nv50_disp_mthd_v1 mthd ;  struct nv50_disp_sor_hda_eld_v0 eld ; } base ;  u8 data [ sizeof ( nv_connector -> base . eld ) ] ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nv50_disp_mthd_v1 base ; } cocci_id@p ;
...
position p;
@@
 struct nv50_disp_core_channel_dma_v0 * cocci_id@p ;
...
position p;
@@
 struct {  struct nv50_disp_mthd_v1 base ;  struct nv50_disp_sor_dp_mst_vcpi_v0 vcpi ; } cocci_id@p ;
...
position p;
@@
 union hdmi_infoframe cocci_id@p ;
...
position p;
@@
 struct drm_dp_payload * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ NV50_DISP_INTERLOCK__SIZE ] ;
...
position p;
@@
 struct drm_dp_mst_port * cocci_id@p ;
...
position p;
@@
 struct {  struct nv50_disp_mthd_v1 base ;  struct nv50_disp_sor_hdmi_pwr_v0 pwr ; } cocci_id@p ;
...
position p;
@@
 struct {  struct nv50_disp_mthd_v1 base ;  struct nv50_disp_dac_load_v0 load ; } cocci_id@p ;
...
typedef bool;
@@
 struct nv50_msto {  struct drm_encoder encoder ;  struct nv50_head * head ;  struct nv50_mstc * mstc ;  bool disabled ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  struct nv50_disp_mthd_v1 base ;  struct nv50_disp_sor_hdmi_pwr_v0 pwr ;  u8 infoframes [ 2 * 17 ] ; } cocci_id@p ;
...
position p;
@@
 const struct drm_dp_mst_topology_cbs cocci_id@p ;
...
position p;
@@
 struct {  struct nv50_disp_mthd_v1 base ;  struct nv50_disp_sor_hda_eld_v0 eld ; } cocci_id@p ;
