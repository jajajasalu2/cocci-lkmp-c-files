...
@@
 struct nft_ng_inc {  enum nft_registers dreg : 8 ;  u32 modulus ;  atomic_t counter ;  u32 offset ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_NG_MAX + 1 ] ;
...
position p;
@@
 struct nft_ng_random * cocci_id@p ;
...
position p;
@@
 const struct nft_ng_inc * cocci_id@p ;
...
position p;
@@
 const struct nft_ng_random * cocci_id@p ;
...
typedef u32;
@@
 struct nft_ng_random {  enum nft_registers dreg : 8 ;  u32 modulus ;  u32 offset ; } cocci_id@p ;
