...
position p;
@@
 struct hw_atl_utils_mbox_header * cocci_id@p ;
...
typedef u32,u16;
@@
 struct aq_hw_atl_utils_fw_rpc_tid_s {  union {  u32 val ;  struct {  u16 tid ;  u16 len ; } ; } ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( u32 ver_expected , u32 ver_actual ) ;
...
position p;
@@
 enum mcp_area { MCP_AREA_CONFIG = 0x80000000 , MCP_AREA_SETTINGS = 0x20000000 , } cocci_id@p ;
...
position p;
@@
 struct aq_hw_atl_utils_fw_rpc_tid_s cocci_id@p ;
