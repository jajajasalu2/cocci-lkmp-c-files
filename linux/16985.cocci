...
position p;
@@
 struct wm97xx_platform_data * cocci_id@p ;
...
position p;
@@
 enum wm97xx_gpio_dir cocci_id@p ;
...
position p;
@@
 enum wm97xx_gpio_status cocci_id@p ;
...
position p;
@@
 enum wm97xx_gpio_sticky cocci_id@p ;
...
position p;
@@
 enum wm97xx_gpio_pol cocci_id@p ;
...
position p;
@@
 enum wm97xx_gpio_wake cocci_id@p ;
