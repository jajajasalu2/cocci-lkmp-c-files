...
position p;
@@
 void ( * cocci_id@p ) ( int , struct mce * ) ;
...
position p;
@@
 struct amd_decoder_ops * cocci_id@p ;
...
position p;
@@
 struct smca_mce_desc {  const char * const * descs ;  unsigned int num_descs ; } cocci_id@p ;
...
position p;
@@
 struct smca_mce_desc cocci_id@p [ ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( int node_id , struct mce * m ) ;
