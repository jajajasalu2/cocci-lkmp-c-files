...
typedef u8,u32;
@@
 struct cfp_udf_slice_layout {  u8 slices [ UDFS_PER_SLICE ] ;  u32 mask_value ;  u32 base_offset ; } cocci_id@p ;
...
position p;
@@
 const struct bcm_sf2_cfp_stat * cocci_id@p ;
...
position p;
@@
 const struct cfp_udf_slice_layout * cocci_id@p ;
...
position p;
@@
 const struct cfp_udf_layout cocci_id@p ;
...
position p;
@@
 const struct bcm_sf2_cfp_stat {  unsigned int offset ;  unsigned int ram_loc ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct cfp_rule {  int port ;  struct ethtool_rx_flow_spec fs ;  struct list_head next ; } cocci_id@p ;
...
position p;
@@
 struct cfp_udf_layout {  struct cfp_udf_slice_layout udfs [ UDF_NUM_SLICES ] ; } cocci_id@p ;
...
position p;
@@
 struct bcm_sf2_priv * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ UDFS_PER_SLICE ] ;
...
position p;
@@
 struct ethtool_rx_flow_spec_input cocci_id@p ;
