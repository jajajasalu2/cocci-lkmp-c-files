...
position p;
@@
 unsigned int cocci_id@p [ TPS6591X_MAX_NUM_GPIO ] ;
...
position p;
@@
 struct tps65910_gpio {  struct gpio_chip gpio_chip ;  struct tps65910 * tps65910 ; } cocci_id@p ;
...
position p;
@@
 struct tps65910_gpio * cocci_id@p ;
