...
position p;
@@
 struct cb_recallargs * cocci_id@p ;
...
position p;
@@
 struct cb_sequenceargs * cocci_id@p ;
...
position p;
@@
 struct cb_compound_hdr_res cocci_id@p ;
...
position p;
@@
 struct cb_process_state cocci_id@p ;
...
position p;
@@
 const struct cb_getattrres * cocci_id@p ;
...
position p;
@@
 const struct nfs4_sessionid * cocci_id@p ;
...
position p;
@@
 struct cb_offloadargs * cocci_id@p ;
...
position p;
@@
 struct referring_call_list * cocci_id@p ;
...
position p;
@@
 struct cb_layoutrecallargs * cocci_id@p ;
...
position p;
@@
 struct cb_devicenotifyargs * cocci_id@p ;
...
position p;
@@
 struct cb_compound_hdr_arg * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( nfs4_callback_procedures1 ) ] ;
...
position p;
@@
 const struct cb_sequenceres * cocci_id@p ;
...
position p;
@@
 struct cb_getattrargs * cocci_id@p ;
...
position p;
@@
 struct cb_recallanyargs * cocci_id@p ;
...
position p;
@@
 struct cb_recallslotargs * cocci_id@p ;
...
position p;
@@
 struct cb_devicenotifyitem * cocci_id@p ;
