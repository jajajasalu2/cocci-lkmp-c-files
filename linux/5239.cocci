...
position p;
@@
 enum { sis_180 = 0 , SIS_SCR_PCI_BAR = 5 , SIS_GENCTL = 0x54 , SIS_SCR_BASE = 0xc0 , SIS180_SATA1_OFS = 0x10 , SIS182_SATA1_OFS = 0x20 , SIS_PMR = 0x90 , SIS_PMR_COMBINED = 0x30 , SIS_FLAG_CFGSCR = ( 1 << 30 ) , GENCTL_IOMAPPED_SCR = ( 1 << 26 ) , } cocci_id@p ;
