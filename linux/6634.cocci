...
position p;
@@
 struct ipr_resource_entry cocci_id@p ;
...
position p;
@@
 struct ipr_mode_page_hdr cocci_id@p ;
...
position p;
@@
 struct ipr_dev_bus_entry * cocci_id@p ;
...
position p;
@@
 struct ipr_inquiry_pageC4 * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_fabric_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ipr_ioa_cfg * , enum ipr_shutdown_type ) ;
...
position p;
@@
 struct ipr_driver_dump cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 status ;  char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ipr_inquiry_page0 * cocci_id@p ;
...
position p;
@@
 struct ipr_ioasa_gata cocci_id@p ;
...
position p;
@@
 struct ipr_ioa_dump cocci_id@p ;
...
position p;
@@
 struct ata_port_info cocci_id@p ;
...
position p;
@@
 struct ipr_config_table_hdr64 cocci_id@p ;
...
position p;
@@
 struct ipr_ioadl_desc * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ipr_chip_cfg_t;
@@
 const struct ipr_chip_cfg_t cocci_id@p [ ] ;
...
position p;
@@
 struct ipr_hostrcb_type_07_error * cocci_id@p ;
...
position p;
@@
 struct ipr_ioadl64_desc cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ipr_cmnd * , void * ) ;
...
typedef ipr_chip_t;
@@
 const struct ipr_chip_t cocci_id@p [ ] ;
...
position p;
@@
 struct ipr_hostrcb_type_21_error * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ipr_cmnd * ) ;
...
position p;
@@
 struct ipr_config_table_entry_wrapper cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_30_error * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_config_element * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb64_fabric_desc * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_17_error * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_13_error * cocci_id@p ;
...
position p;
@@
 struct ipr_dump_trace_entry cocci_id@p ;
...
position p;
@@
 struct ipr_bus_attributes * cocci_id@p ;
...
position p;
@@
 struct bin_attribute * cocci_id@p ;
...
position p;
@@
 struct ipr_mode_page24 cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_03_error * cocci_id@p ;
...
position p;
@@
 struct ipr_config_table_entry cocci_id@p ;
...
position p;
@@
 struct ipr_config_table_entry64 cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb64_error cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb64_device_data_entry_enhanced * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_14_error * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ IPR_MAX_RES_PATH_LENGTH ] ;
...
position p;
@@
 struct ipr_hostrcb_type_24_error * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_array_data_entry_enhanced * cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 active ;  char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ipr_hostrcb_device_data_entry * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_23_error * cocci_id@p ;
...
position p;
@@
 struct ipr_misc_cbs cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ IPR_SERIAL_NUM_LEN ] ;
...
position p;
@@
 struct ipr_inquiry_cap * cocci_id@p ;
...
position p;
@@
 struct ipr_interrupts * cocci_id@p ;
...
position p;
@@
 struct ipr_dump_entry_header cocci_id@p ;
...
position p;
@@
 struct ipr_dump_ioa_type_entry cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_error cocci_id@p ;
...
position p;
@@
 struct ipr_sata_port * cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 state ;  char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ipr_mode_pages cocci_id@p ;
...
position p;
@@
 struct ipr_mode_page28 cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ipr_cmnd * ) ;
...
position p;
@@
 char cocci_id@p [ IPR_VENDOR_ID_LEN + IPR_PROD_ID_LEN + IPR_SERIAL_NUM_LEN ] ;
...
position p;
@@
 struct ipr_dump_version_entry cocci_id@p ;
...
position p;
@@
 const struct ipr_interrupt_offsets * cocci_id@p ;
...
position p;
@@
 struct ipr_supported_device * cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 type ;  char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ IPR_VENDOR_ID_LEN + IPR_PROD_ID_LEN + IPR_SERIAL_NUM_LEN + 3 ] ;
...
position p;
@@
 struct ipr_hostrcb_type_02_error * cocci_id@p ;
...
position p;
@@
 struct ipr_ioarcb_ata_regs * cocci_id@p ;
...
position p;
@@
 const struct ipr_ses_table_entry * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_41_error * cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_20_error cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_device_data_entry_enhanced * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct irq_poll * iop , int budget ) ;
...
position p;
@@
 struct ipr_sdt_entry cocci_id@p ;
...
position p;
@@
 struct ipr_config_table_hdr cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_12_error * cocci_id@p ;
...
position p;
@@
 struct ipr_trace_entry cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb64_array_data_entry * cocci_id@p ;
...
position p;
@@
 struct ipr_hrr_queue cocci_id@p ;
...
position p;
@@
 struct ipr_dump_location_entry cocci_id@p ;
...
position p;
@@
 struct ipr_inquiry_page3 cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb64_config_element * cocci_id@p ;
...
position p;
@@
 struct ipr_std_inq_vpids cocci_id@p ;
...
position p;
@@
 struct ipr_std_inq_data cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_array_data_entry * cocci_id@p ;
...
position p;
@@
 struct ipr_sdt_header cocci_id@p ;
...
position p;
@@
 struct ipr_hostrcb_type_04_error * cocci_id@p ;
...
position p;
@@
 struct ipr_dump_header cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ipr_error_table_t;
@@
 const struct ipr_error_table_t cocci_id@p [ ] ;
...
position p;
@@
 enum ipr_shutdown_type cocci_id@p ;
...
position p;
@@
 struct ipr_ucode_image_header * cocci_id@p ;
