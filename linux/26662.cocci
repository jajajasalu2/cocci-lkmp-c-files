...
@@
 struct flow_key_record {  __be32 src ;  __be32 dst ;  union {  __be32 ports ;  __be16 port16 [ 2 ] ; } ;  __u16 thoff ;  __u8 ip_proto ; } cocci_id@p ;
...
position p;
@@
 struct pair {  long packets ;  long bytes ; } cocci_id@p ;
...
position p;
@@
 struct flow_key_record * cocci_id@p ;
