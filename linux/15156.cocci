...
position p;
@@
 struct nokia_modem_device {  struct tasklet_struct nokia_modem_rst_ind_tasklet ;  int nokia_modem_rst_ind_irq ;  struct device * device ;  struct nokia_modem_gpio * gpios ;  int gpio_amount ;  struct hsi_client * ssi_protocol ;  struct hsi_client * cmt_speech ; } cocci_id@p ;
...
position p;
@@
 struct nokia_modem_device * cocci_id@p ;
...
position p;
@@
 struct hsi_board_info cocci_id@p ;
...
position p;
@@
 struct nokia_modem_gpio {  struct gpio_desc * gpio ;  const char * name ; } cocci_id@p ;
