...
position p;
@@
 struct iscsi_boot_attr * cocci_id@p ;
...
position p;
@@
 ssize_t ( * cocci_id@p ) ( void * data , int type , char * buf ) ;
...
position p;
@@
 struct iscsi_boot_attr {  struct attribute attr ;  int type ;  ssize_t ( * show ) ( void * data , int type , char * buf ) ; } cocci_id@p ;
...
typedef umode_t;
@@
 umode_t ( * cocci_id@p ) ( void * data , int type ) ;
