...
position p;
@@
 struct latency_info * cocci_id@p ;
...
typedef u64;
@@
 struct latency_info {  u64 io_interval ;  u64 cpu_interval ;  u64 timer_start1 ;  u64 timer_start2 ;  u64 max_latency ;  u64 min_latency ;  u64 latency_sum ;  u64 average_latency ;  u64 interrupt_cnt ; } cocci_id@p ;
