...
position p;
@@
 struct codec_connect_info * cocci_id@p ;
...
position p;
@@
 struct codec_connection cocci_id@p [ ] ;
...
position p;
@@
 struct layout_dev_ptr * cocci_id@p ;
...
position p;
@@
 struct codec_connect_info {  char * name ;  struct codec_connection * connections ; } cocci_id@p ;
...
position p;
@@
 struct soundbus_dev * cocci_id@p ;
...
position p;
@@
 struct layout_dev_ptr {  struct layout_dev * ptr ; } cocci_id@p ;
...
position p;
@@
 struct codec_connection {  int connected ;  int codec_bit ; } cocci_id@p ;
...
position p;
@@
 struct soundbus_driver cocci_id@p ;
