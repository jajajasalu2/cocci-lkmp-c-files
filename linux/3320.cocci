...
position p;
@@
 struct sensor_template cocci_id@p [ ] ;
...
position p;
@@
 struct acpi_power_meter_capabilities cocci_id@p ;
...
position p;
@@
 struct acpi_power_meter_resource cocci_id@p ;
...
typedef u64;
@@
 struct acpi_power_meter_capabilities {  u64 flags ;  u64 units ;  u64 type ;  u64 accuracy ;  u64 sampling_time ;  u64 min_avg_interval ;  u64 max_avg_interval ;  u64 hysteresis ;  u64 configurable_cap ;  u64 min_cap ;  u64 max_cap ; } cocci_id@p ;
