...
position p;
@@
 enum bw_defines cocci_id@p [ maximum_number_of_surfaces ] ;
...
position p;
@@
 const struct bw_calcs_dceip * cocci_id@p ;
...
position p;
@@
 struct bw_calcs_data cocci_id@p ;
...
position p;
@@
 const struct pipe_ctx * cocci_id@p [ MAX_PIPES ] ;
...
position p;
@@
 enum bw_calcs_version cocci_id@p ;
...
position p;
@@
 struct dce_bw_output * cocci_id@p ;
...
position p;
@@
 const struct dce_bw_output * cocci_id@p ;
...
position p;
@@
 const struct bw_calcs_vbios * cocci_id@p ;
