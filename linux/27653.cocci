...
typedef journal_t;
@@
 struct jbd2_stats_proc_session {  journal_t * journal ;  struct transaction_stats_s * stats ;  int start ;  int max ; } cocci_id@p ;
...
position p;
@@
 struct kmem_cache * cocci_id@p [ JBD2_MAX_SLABS ] ;
...
position p;
@@
 struct jbd2_stats_proc_session * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( size_t slab_size ) ;
...
typedef journal_t;
@@
 void cocci_id@p ( journal_t * journal , int errno ) ;
...
position p;
@@
 struct journal_superblock_s cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ JBD2_MAX_SLABS ] ;
...
position p;
@@
 struct transaction_stats_s cocci_id@p ;
