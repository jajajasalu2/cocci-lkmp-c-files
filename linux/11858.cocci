...
position p;
@@
 const struct nvkm_sw_func cocci_id@p ;
...
typedef atomic_t;
@@
 struct nv04_sw_chan {  struct nvkm_sw_chan base ;  atomic_t ref ; } cocci_id@p ;
...
position p;
@@
 union {  struct nv04_nvsw_get_ref_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_nvsw_func cocci_id@p ;
...
position p;
@@
 struct nv04_sw_chan * cocci_id@p ;
...
position p;
@@
 const struct nvkm_sw_chan_func cocci_id@p ;
...
position p;
@@
 struct nvkm_sw_chan * cocci_id@p ;
