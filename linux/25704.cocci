...
symbol cocci_id;
position p;
typedef u8,u64,pthread_mutex_t,cpu_set_t;
@@
 struct thread_data {  int curr_cpu ;  cpu_set_t bind_cpumask ;  int bind_node ;  u8 * process_data ;  int process_nr ;  int thread_nr ;  int task_nr ;  unsigned int loops_done ;  u64 val ;  u64 runtime_ns ;  u64 system_time_ns ;  u64 user_time_ns ;  double speed_gbs ;  pthread_mutex_t * process_lock ; } cocci_id@p ;
...
@@
 pthread_mutexattr_t cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ ] [ MAX_ARGS ] ;
...
position p;
@@
 int cocci_id@p ( const struct option * opt , const char * arg , int unset ) ;
...
typedef bool,u32;
@@
 struct params {  bool serialize_startup ;  int nr_proc ;  int nr_threads ;  const char * mb_global_str ;  const char * mb_proc_str ;  const char * mb_proc_locked_str ;  const char * mb_thread_str ;  double mb_global ;  double mb_proc ;  double mb_proc_locked ;  double mb_thread ;  bool data_reads ;  bool data_writes ;  bool data_backwards ;  bool data_zero_memset ;  bool data_rand_walk ;  u32 nr_loops ;  u32 nr_secs ;  u32 sleep_usecs ;  bool init_zero ;  bool init_random ;  bool init_cpu0 ;  int show_details ;  int run_all ;  int thp ;  long bytes_global ;  long bytes_process ;  long bytes_process_locked ;  long bytes_thread ;  int nr_tasks ;  bool show_quiet ;  bool show_convergence ;  bool measure_convergence ;  int perturb_secs ;  int nr_cpus ;  int nr_nodes ;  char * cpu_list_str ;  char * node_list_str ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u64,bool,pthread_mutex_t;
@@
 struct global_info {  u8 * data ;  pthread_mutex_t startup_mutex ;  int nr_tasks_started ;  pthread_mutex_t startup_done_mutex ;  pthread_mutex_t start_work_mutex ;  int nr_tasks_working ;  pthread_mutex_t stop_work_mutex ;  u64 bytes_done ;  struct thread_data * threads ;  bool all_converged ;  bool stop_work ;  int print_once ;  struct params p ; } cocci_id@p ;
