...
position p;
@@
 struct ieee80211_qos_parameter_info * cocci_id@p ;
...
position p;
@@
 struct ieee80211_frag_entry * cocci_id@p ;
...
position p;
@@
 struct rtl_80211_hdr_3addrqos * cocci_id@p ;
...
position p;
@@
 struct ieee80211_rxb * * cocci_id@p ;
...
position p;
@@
 struct ieee80211_probe_response * cocci_id@p ;
...
position p;
@@
 struct ieee80211_info_element * cocci_id@p ;
...
position p;
@@
 struct rtl_80211_hdr_4addr cocci_id@p ;
...
position p;
@@
 struct ieee80211_qos_ac_parameter * cocci_id@p ;
...
position p;
@@
 struct rtl_80211_hdr_4addrqos * cocci_id@p ;
...
position p;
@@
 struct ieee80211_qos_information_element * cocci_id@p ;
...
position p;
@@
 struct ieee80211_tim_parameters cocci_id@p ;
...
position p;
@@
 PRT_HIGH_THROUGHPUT cocci_id@p ;
...
position p;
@@
 struct ieee80211_qos_data cocci_id@p ;
