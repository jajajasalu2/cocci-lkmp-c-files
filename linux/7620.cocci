...
typedef u32;
@@
 struct grvga_par {  struct grvga_regs * regs ;  u32 color_palette [ 16 ] ;  int clk_sel ;  int fb_alloced ; } cocci_id@p ;
...
typedef u32;
@@
 struct grvga_regs {  u32 status ;  u32 video_length ;  u32 front_porch ;  u32 sync_length ;  u32 line_length ;  u32 fb_pos ;  u32 clk_vector [ 4 ] ;  u32 clut ; } cocci_id@p ;
