...
position p;
@@
 const struct em28xx_button * cocci_id@p ;
...
position p;
@@
 const struct em28xx_led * cocci_id@p ;
...
position p;
@@
 struct em28xx_ir_poll_result * cocci_id@p ;
...
typedef u32;
@@
 struct em28xx_ir_poll_result {  unsigned int toggle_bit : 1 ;  unsigned int read_count : 7 ;  enum rc_proto protocol ;  u32 scancode ; } cocci_id@p ;
