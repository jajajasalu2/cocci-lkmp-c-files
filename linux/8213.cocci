...
typedef u32;
@@
 struct smsc911x_ops {  u32 ( * reg_read ) ( struct smsc911x_data * pdata , u32 reg ) ;  void ( * reg_write ) ( struct smsc911x_data * pdata , u32 reg , u32 val ) ;  void ( * rx_readfifo ) ( struct smsc911x_data * pdata , unsigned int * buf , unsigned int wordcount ) ;  void ( * tx_writefifo ) ( struct smsc911x_data * pdata , unsigned int * buf , unsigned int wordcount ) ; } cocci_id@p ;
...
position p;
@@
 struct smsc911x_data * cocci_id@p ;
...
position p;
@@
 const struct smsc911x_ops cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SMSC911X_EEPROM_SIZE ] ;
