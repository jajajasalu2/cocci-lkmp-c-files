...
position p;
@@
 int cocci_id@p [ ACPI_MAX_PLATFORM_INTERRUPTS ] ;
...
position p;
@@
 struct acpi_table_slit * cocci_id@p ;
...
position p;
@@
 struct node_memblk_s * cocci_id@p ;
...
position p;
@@
 struct acpi_srat_cpu_affinity * cocci_id@p ;
