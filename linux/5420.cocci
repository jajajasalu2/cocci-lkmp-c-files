...
typedef bool;
@@
 struct fsl_qspi_devtype_data {  unsigned int rxfifo ;  unsigned int txfifo ;  int invalid_mstrid ;  unsigned int ahb_buf_size ;  unsigned int quirks ;  bool little_endian ; } cocci_id@p ;
...
position p;
@@
 const struct fsl_qspi_devtype_data cocci_id@p ;
