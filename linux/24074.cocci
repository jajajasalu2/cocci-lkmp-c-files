...
position p;
@@
 struct gssp_in_token * cocci_id@p ;
...
position p;
@@
 struct rsi * cocci_id@p ( struct cache_detail * cd , struct rsi * new , struct rsi * old ) ;
...
position p;
@@
 struct rsc * cocci_id@p ( struct cache_detail * cd , struct rsc * item ) ;
...
position p;
@@
 struct gssp_upcall_data cocci_id@p ;
...
position p;
@@
 struct rsc * cocci_id@p ( struct cache_detail * cd , struct rsc * new , struct rsc * old ) ;
...
position p;
@@
 struct rpc_gss_wire_cred * cocci_id@p ;
...
position p;
@@
 struct rsi * cocci_id@p ( struct cache_detail * cd , struct rsi * item ) ;
...
position p;
@@
 struct gss_svc_data {  struct rpc_gss_wire_cred clcred ;  __be32 * verf_start ;  struct rsc * rsci ; } cocci_id@p ;
...
position p;
@@
 struct rsc {  struct cache_head h ;  struct xdr_netobj handle ;  struct svc_cred cred ;  struct gss_svc_seq_data seqdata ;  struct gss_ctx * mechctx ;  struct rcu_head rcu_head ; } cocci_id@p ;
...
position p;
@@
 struct cache_detail * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct gss_svc_seq_data {  int sd_max ;  unsigned long sd_win [ GSS_SEQ_WIN / BITS_PER_LONG ] ;  spinlock_t sd_lock ; } cocci_id@p ;
...
position p;
@@
 struct gss_svc_data * cocci_id@p ;
...
typedef u32;
@@
 struct gss_domain {  struct auth_domain h ;  u32 pseudoflavor ; } cocci_id@p ;
...
position p;
@@
 struct gss_svc_seq_data * cocci_id@p ;
...
position p;
@@
 const struct cache_detail cocci_id@p ;
