...
position p;
@@
 struct afe_port_cmd_device_start * cocci_id@p ;
...
position p;
@@
 struct q6afe_slim_cfg * cocci_id@p ;
...
position p;
@@
 struct afe_digital_clk_cfg cocci_id@p ;
...
position p;
@@
 struct afe_port_map cocci_id@p [ AFE_PORT_MAX ] ;
...
typedef spinlock_t;
@@
 struct q6afe {  struct apr_device * apr ;  struct device * dev ;  struct q6core_svc_api_info ainfo ;  struct mutex lock ;  struct list_head port_list ;  spinlock_t port_list_lock ; } cocci_id@p ;
...
position p;
@@
 struct afe_port_cmd_device_stop * cocci_id@p ;
...
position p;
@@
 struct q6afe_i2s_cfg * cocci_id@p ;
...
position p;
@@
 struct afe_port_cmd_set_param_v2 * cocci_id@p ;
...
position p;
@@
 struct q6afe_hdmi_cfg * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,aprv2_ibasic_rsp_result_t;
@@
 struct q6afe_port {  wait_queue_head_t wait ;  union afe_port_config port_cfg ;  struct afe_param_id_slot_mapping_cfg * scfg ;  struct aprv2_ibasic_rsp_result_t result ;  int token ;  int id ;  int cfg_type ;  struct q6afe * afe ;  struct kref refcount ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct afe_svc_cmd_set_param * cocci_id@p ;
...
position p;
@@
 struct q6afe_tdm_cfg * cocci_id@p ;
...
position p;
@@
 struct afe_port_param_data_v2 * cocci_id@p ;
...
position p;
@@
 struct afe_port_map {  int port_id ;  int token ;  int is_rx ;  int is_dig_pcm ; } cocci_id@p ;
...
position p;
@@
 union afe_port_config * cocci_id@p ;
...
@@
 struct afe_clk_set {  uint32_t clk_set_minor_version ;  uint32_t clk_id ;  uint32_t clk_freq_in_hz ;  uint16_t clk_attri ;  uint16_t clk_root ;  uint32_t enable ; } cocci_id@p ;
