...
position p;
@@
 const struct sensor_info * cocci_id@p ;
...
typedef s8,u8,u16;
@@
 struct sensor_info {  s8 sensorId ;  u8 I2cAdd ;  u8 IdAdd ;  u16 VpId ;  u8 m1 ;  u8 m2 ;  u8 op ; } cocci_id@p ;
...
position p;
@@
 enum sensors { SENSOR_HV7131R , SENSOR_MI0360 , SENSOR_MI1310_SOC , SENSOR_MI1320 , SENSOR_MI1320_SOC , SENSOR_OV7660 , SENSOR_OV7670 , SENSOR_PO1200 , SENSOR_PO3130NC , SENSOR_POxxxx , NSENSORS , } cocci_id@p ;
...
position p;
@@
 enum bridges { BRIDGE_VC0321 , BRIDGE_VC0323 , } cocci_id@p ;
