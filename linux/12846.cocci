...
position p;
@@
 const struct lpddr2_addressing * cocci_id@p ;
...
position p;
@@
 struct ddr_device_info * cocci_id@p ;
...
position p;
@@
 const struct ddr_device_info * cocci_id@p ;
...
position p;
@@
 struct emif_custom_configs * cocci_id@p ;
...
position p;
@@
 struct emif_platform_data * cocci_id@p ;
...
position p;
@@
 const struct lpddr2_timings * cocci_id@p ;
...
position p;
@@
 struct lpddr2_timings cocci_id@p ;
...
position p;
@@
 const struct lpddr2_min_tck * cocci_id@p ;
...
position p;
@@
 const struct emif_custom_configs * cocci_id@p ;
