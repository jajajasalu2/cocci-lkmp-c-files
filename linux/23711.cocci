...
position p;
@@
 struct machine_data * cocci_id@p ;
...
position p;
@@
 struct machine_data {  struct snd_soc_dai_link dai [ 2 ] ;  struct snd_soc_card card ;  unsigned int dai_format ;  unsigned int codec_clk_direction ;  unsigned int cpu_clk_direction ;  unsigned int clk_frequency ;  unsigned int ssi_id ;  unsigned int dma_id [ 2 ] ;  unsigned int dma_channel_id [ 2 ] ;  char platform_name [ 2 ] [ DAI_NAME_SIZE ] ; } cocci_id@p ;
