...
typedef bool;
@@
 struct virtual_consumer_data {  struct mutex lock ;  struct regulator * regulator ;  bool enabled ;  int min_uV ;  int max_uV ;  int min_uA ;  int max_uA ;  unsigned int mode ; } cocci_id@p ;
...
position p;
@@
 struct virtual_consumer_data cocci_id@p ;
