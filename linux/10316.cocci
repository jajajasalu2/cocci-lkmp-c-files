...
typedef u32;
@@
 u32 cocci_id@p [ MALIDP_COEFFTAB_NUM_COEFFS ] ;
...
position p;
@@
 struct malidp_se_config * cocci_id@p ;
...
position p;
@@
 struct malidp_error_stats cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_OUTPUT_CHANNELS ] ;
