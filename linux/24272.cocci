...
typedef u8;
@@
 struct stp_config_pdu {  u8 flags ;  u8 root [ 8 ] ;  u8 root_cost [ 4 ] ;  u8 sender [ 8 ] ;  u8 port [ 2 ] ;  u8 msg_age [ 2 ] ;  u8 max_age [ 2 ] ;  u8 hello_time [ 2 ] ;  u8 forward_delay [ 2 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct stp_header {  u8 dsap ;  u8 ssap ;  u8 ctrl ;  u8 pid ;  u8 vers ;  u8 type ; } cocci_id@p ;
...
position p;
@@
 struct ebt_stp_info cocci_id@p ;
...
position p;
@@
 const struct stp_header * cocci_id@p ;
...
position p;
@@
 const struct stp_config_pdu * cocci_id@p ;
...
position p;
@@
 const struct ebt_stp_info * cocci_id@p ;
...
position p;
@@
 struct stp_config_pdu cocci_id@p ;
...
position p;
@@
 const struct ebt_stp_config_info * cocci_id@p ;
