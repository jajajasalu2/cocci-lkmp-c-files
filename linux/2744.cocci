...
typedef u16;
@@
 struct wmt_i2c_dev {  struct i2c_adapter adapter ;  struct completion complete ;  struct device * dev ;  void __iomem * base ;  struct clk * clk ;  int mode ;  int irq ;  u16 cmd_status ; } cocci_id@p ;
