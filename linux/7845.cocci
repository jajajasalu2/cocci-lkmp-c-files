...
position p;
@@
 int cocci_id@p ( unsigned char * p , unsigned char * d , int len ) ;
...
position p;
@@
 const struct lapb_register_struct cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct x25_asy * sl , unsigned char c ) ;
