...
position p;
@@
 struct c4iw_alloc_ucontext_resp cocci_id@p ;
...
position p;
@@
 enum counters { IP4INSEGS , IP4OUTSEGS , IP4RETRANSSEGS , IP4OUTRSTS , IP6INSEGS , IP6OUTSEGS , IP6RETRANSSEGS , IP6OUTRSTS , NR_COUNTERS , } cocci_id@p ;
...
position p;
@@
 struct c4iw_alloc_pd_resp cocci_id@p ;
