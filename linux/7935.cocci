...
position p;
@@
 unsigned char cocci_id@p [ sizeof ( fw_hdr -> checksum ) ] ;
...
position p;
@@
 struct fw_phy_patch_key * cocci_id@p ;
...
position p;
@@
 enum tx_csum_stat { TX_CSUM_SUCCESS = 0 , TX_CSUM_TSO , TX_CSUM_NONE , } cocci_id@p ;
...
position p;
@@
 enum spd_duplex { NWAY_10M_HALF , NWAY_10M_FULL , NWAY_100M_HALF , NWAY_100M_FULL , NWAY_1000M_FULL , FORCE_10M_HALF , FORCE_10M_FULL , FORCE_100M_HALF , FORCE_100M_FULL , } cocci_id@p ;
...
position p;
@@
 enum rtl_register_content { _1000bps = 0x10 , _100bps = 0x08 , _10bps = 0x04 , LINK_STATUS = 0x02 , FULL_DUP = 0x01 , } cocci_id@p ;
...
position p;
@@
 const struct ethtool_tunable * cocci_id@p ;
...
position p;
@@
 enum rtl_fw_type { RTL_FW_END = 0 , RTL_FW_PLA , RTL_FW_USB , RTL_FW_PHY_START , RTL_FW_PHY_STOP , RTL_FW_PHY_NC , } cocci_id@p ;
...
position p;
@@
 struct tally_counter cocci_id@p ;
...
typedef u32;
@@
 struct tx_agg {  struct list_head list ;  struct urb * urb ;  struct r8152 * context ;  void * buffer ;  void * head ;  u32 skb_num ;  u32 skb_len ; } cocci_id@p ;
...
position p;
@@
 enum rtl_version { RTL_VER_UNKNOWN = 0 , RTL_VER_01 , RTL_VER_02 , RTL_VER_03 , RTL_VER_04 , RTL_VER_05 , RTL_VER_06 , RTL_VER_07 , RTL_VER_08 , RTL_VER_09 , RTL_VER_MAX , } cocci_id@p ;
...
@@
 struct tally_counter {  __le64 tx_packets ;  __le64 rx_packets ;  __le64 tx_errors ;  __le32 rx_errors ;  __le16 rx_missed ;  __le16 align_errors ;  __le32 tx_one_collision ;  __le32 tx_multi_collision ;  __le64 rx_unicast ;  __le64 rx_broadcast ;  __le32 rx_multicast ;  __le16 tx_aborted ;  __le16 tx_underrun ; } cocci_id@p ;
...
position p;
@@
 enum rtl8152_flags { RTL8152_UNPLUG = 0 , RTL8152_SET_RX_MODE , WORK_ENABLE , RTL8152_LINK_CHG , SELECTIVE_SUSPEND , PHY_RESET , SCHEDULE_TASKLET , GREEN_ETHERNET , DELL_TB_RX_AGG_BUG , LENOVO_MACPASSTHRU , } cocci_id@p ;
