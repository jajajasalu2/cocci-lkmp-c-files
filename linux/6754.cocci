...
@@
 struct {  struct pardevice * dev ;  int base ;  int mode ;  struct scsi_cmnd * cur_cmd ;  struct delayed_work ppa_tq ;  unsigned long jstart ;  unsigned long recon_tmo ;  unsigned int failed : 1 ;  unsigned wanted : 1 ;  unsigned int dev_no ;  wait_queue_head_t * waiting ;  struct Scsi_Host * host ;  struct list_head list ; } cocci_id@p ;
