...
position p;
@@
 struct vp702x_fe_state cocci_id@p ;
...
typedef u8;
@@
 struct vp702x_fe_state {  struct dvb_frontend fe ;  struct dvb_usb_device * d ;  struct dvb_frontend_ops ops ;  enum fe_sec_voltage voltage ;  enum fe_sec_tone_mode tone_mode ;  u8 lnb_buf [ 8 ] ;  u8 lock ;  u8 sig ;  u8 snr ;  unsigned long next_status_check ;  unsigned long status_check_interval ; } cocci_id@p ;
...
position p;
@@
 struct vp702x_device_state * cocci_id@p ;
