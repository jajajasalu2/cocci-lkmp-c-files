...
position p;
@@
 const struct amdgpu_gds_reg_offset cocci_id@p [ ] ;
...
position p;
@@
 union {  struct vi_de_ib_state regular ;  struct vi_de_ib_state_chained_ib chained ; } cocci_id@p ;
...
position p;
@@
 union {  struct vi_ce_ib_state regular ;  struct vi_ce_ib_state_chained_ib chained ; } cocci_id@p ;
...
position p;
@@
 enum { BPM_REG_CGLS_EN = 0 , BPM_REG_CGLS_ON , BPM_REG_CGCG_OVERRIDE , BPM_REG_MGCG_OVERRIDE , BPM_REG_FGCG_OVERRIDE , BPM_REG_FGCG_MAX , } cocci_id@p ;
...
position p;
@@
 struct vi_mqd_allocation * cocci_id@p ;
...
position p;
@@
 struct vi_gfx_meta_data_chained_ib cocci_id@p ;
...
position p;
@@
 struct vi_gfx_meta_data cocci_id@p ;
