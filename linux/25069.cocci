...
typedef u8;
@@
 u8 cocci_id@p [ WLAN_KEY_LEN_TKIP ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ieee80211_hw * hw , struct ieee80211_vif * vif , struct ieee80211_sta * sta , struct ieee80211_key_conf * key , void * data ) ;
