...
position p;
@@
 struct mtk_tphy {  struct device * dev ;  void __iomem * sif_base ;  struct clk * u3phya_ref ;  const struct mtk_phy_pdata * pdata ;  struct mtk_phy_instance * * phys ;  int nphys ;  int src_ref_clk ;  int src_coef ; } cocci_id@p ;
...
typedef bool;
@@
 struct mtk_phy_pdata {  bool avoid_rx_sen_degradation ;  enum mtk_phy_version version ; } cocci_id@p ;
...
position p;
@@
 struct u3phy_banks {  void __iomem * spllc ;  void __iomem * chip ;  void __iomem * phyd ;  void __iomem * phya ; } cocci_id@p ;
...
position p;
@@
 enum mtk_phy_version { MTK_PHY_V1 = 1 , MTK_PHY_V2 , } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct mtk_phy_instance {  struct phy * phy ;  void __iomem * port_base ;  union {  struct u2phy_banks u2_banks ;  struct u3phy_banks u3_banks ; } ;  struct clk * ref_clk ;  u32 index ;  u8 type ;  int eye_src ;  int eye_vrt ;  int eye_term ;  bool bc12_en ; } cocci_id@p ;
...
position p;
@@
 struct u2phy_banks {  void __iomem * misc ;  void __iomem * fmreg ;  void __iomem * com ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_phy_pdata cocci_id@p ;
...
position p;
@@
 struct mtk_phy_instance * cocci_id@p ;
