...
position p;
@@
 struct ibm_iic_timings {  unsigned int hd_sta ;  unsigned int su_sto ;  unsigned int low ;  unsigned int high ;  unsigned int buf ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ibm_iic_private * cocci_id@p ;
...
position p;
@@
 const struct ibm_iic_timings * cocci_id@p ;
