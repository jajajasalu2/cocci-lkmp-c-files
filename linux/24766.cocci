...
position p;
@@
 const struct xt_hashlimit_mtinfo2 * cocci_id@p ;
...
position p;
@@
 const struct xt_hashlimit_htable * cocci_id@p ;
...
position p;
@@
 struct hashlimit_net * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u_int8_t,u_int32_t,spinlock_t;
@@
 struct xt_hashlimit_htable {  struct hlist_node node ;  int use ;  u_int8_t family ;  bool rnd_initialized ;  struct hashlimit_cfg3 cfg ;  spinlock_t lock ;  u_int32_t rnd ;  unsigned int count ;  struct delayed_work gc_work ;  struct proc_dir_entry * pde ;  const char * name ;  struct net * net ;  struct hlist_head hash [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct hashlimit_cfg3 cocci_id@p ;
...
position p;
@@
 const struct dsthash_ent * cocci_id@p ;
...
position p;
@@
 struct xt_hashlimit_mtinfo2 * cocci_id@p ;
...
position p;
@@
 struct xt_hashlimit_htable * cocci_id@p ;
...
position p;
@@
 const struct hashlimit_cfg3 * cocci_id@p ;
...
position p;
@@
 struct xt_hashlimit_mtinfo1 * cocci_id@p ;
...
position p;
@@
 struct xt_hashlimit_mtinfo3 * cocci_id@p ;
...
position p;
@@
 const struct xt_mtdtor_param * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct xt_hashlimit_htable * ht , const struct dsthash_ent * he ) ;
...
position p;
@@
 struct dsthash_dst {  union {  struct {  __be32 src ;  __be32 dst ; } ip ; #if IS_ENABLED(CONFIG_IP6_NF_IPTABLES)  struct {  __be32 src [ 4 ] ;  __be32 dst [ 4 ] ; } ip6 ; #endif } ;  __be16 src_port ;  __be16 dst_port ; } cocci_id@p ;
...
position p;
@@
 const struct dsthash_dst * cocci_id@p ;
...
position p;
@@
 const struct xt_hashlimit_mtinfo3 * cocci_id@p ;
...
position p;
@@
 struct hashlimit_cfg2 * cocci_id@p ;
...
position p;
@@
 struct hashlimit_net {  struct hlist_head htables ;  struct proc_dir_entry * ipt_hashlimit ;  struct proc_dir_entry * ip6t_hashlimit ; } cocci_id@p ;
...
position p;
@@
 const struct xt_hashlimit_mtinfo1 * cocci_id@p ;
...
position p;
@@
 struct hashlimit_cfg1 * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_int64_t,u_int32_t,spinlock_t,int64_t;
@@
 struct dsthash_ent {  struct hlist_node node ;  struct dsthash_dst dst ;  spinlock_t lock ;  unsigned long expires ;  struct {  unsigned long prev ;  union {  struct {  u_int64_t credit ;  u_int64_t credit_cap ;  u_int64_t cost ; } ;  struct {  u_int32_t interval , prev_window ;  u_int64_t current_rate ;  u_int64_t rate ;  int64_t burst ; } ; } ; } rateinfo ;  struct rcu_head rcu ; } cocci_id@p ;
