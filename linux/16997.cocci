...
position p;
@@
 const struct auo_pixcir_ts_platdata * cocci_id@p ;
...
@@
 struct auo_pixcir_ts {  struct i2c_client * client ;  struct input_dev * input ;  const struct auo_pixcir_ts_platdata * pdata ;  char phys [ 32 ] ;  bool touch_ind_mode ;  wait_queue_head_t wait ;  bool stopped ; } cocci_id@p ;
...
typedef auo_point_t;
@@
 struct auo_point_t {  int coord_x ;  int coord_y ;  int area_major ;  int area_minor ;  int orientation ; } cocci_id@p ;
...
position p;
@@
 struct auo_pixcir_ts cocci_id@p ;
...
position p;
@@
 struct auo_pixcir_ts_platdata * cocci_id@p ;
...
typedef auo_point_t;
@@
 struct auo_point_t cocci_id@p [ AUO_PIXCIR_REPORT_POINTS ] ;
