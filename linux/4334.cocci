...
position p;
@@
 const struct hswc_params * cocci_id@p ;
...
position p;
@@
 struct asus_wireless_data * cocci_id@p ;
...
typedef u8;
@@
 struct hswc_params {  u8 on ;  u8 off ;  u8 status ; } cocci_id@p ;
...
position p;
@@
 struct asus_wireless_data {  struct input_dev * idev ;  struct acpi_device * adev ;  const struct hswc_params * hswc_params ;  struct workqueue_struct * wq ;  struct work_struct led_work ;  struct led_classdev led ;  int led_state ; } cocci_id@p ;
