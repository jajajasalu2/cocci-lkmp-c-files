...
typedef as102_dev_t;
@@
 void cocci_id@p ( struct as102_dev_t * dev ) ;
...
symbol cocci_id;
position p;
typedef as10x_bus_adapter_t;
@@
 struct as10x_bus_adapter_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef as102_priv_ops_t;
@@
 const struct as102_priv_ops_t cocci_id@p ;
...
typedef as102_dev_t;
@@
 int cocci_id@p ( struct as102_dev_t * dev ) ;
