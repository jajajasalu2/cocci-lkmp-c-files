...
position p;
@@
 struct iwl_cmd_header_wide cocci_id@p ;
...
position p;
@@
 const struct iwl_host_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_cmd_meta * cocci_id@p ;
...
position p;
@@
 struct iwlagn_scd_bc_tbl cocci_id@p ;
...
position p;
@@
 struct iwl_pcie_txq_entry cocci_id@p ;
...
position p;
@@
 struct iwl_gen3_bc_tbl cocci_id@p ;
...
typedef u8;
@@
 const u8 * cocci_id@p [ IWL_MAX_CMD_TBS_PER_TFD ] ;
...
position p;
@@
 const struct iwl_txq * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ IWL_MAX_CMD_TBS_PER_TFD ] ;
