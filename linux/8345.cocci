...
position p;
@@
 struct nicvf_rss_info * cocci_id@p ;
...
position p;
@@
 struct nicvf_hw_stats * cocci_id@p ;
...
position p;
@@
 struct bgx_stats_msg * cocci_id@p ;
...
position p;
@@
 struct xcast_addr_list * cocci_id@p ;
...
position p;
@@
 struct nicvf_cq_poll * cocci_id@p ;
...
position p;
@@
 struct nicvf_drv_stats cocci_id@p ;
