...
position p;
@@
 struct nft_rt {  enum nft_rt_keys key : 8 ;  enum nft_registers dreg : 8 ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_RT_MAX + 1 ] ;
...
position p;
@@
 const struct nft_rt * cocci_id@p ;
