...
@@
 struct compat_ica_rsa_modexpo_crt {  compat_uptr_t inputdata ;  unsigned int inputdatalength ;  compat_uptr_t outputdata ;  unsigned int outputdatalength ;  compat_uptr_t bp_key ;  compat_uptr_t bq_key ;  compat_uptr_t np_prime ;  compat_uptr_t nq_prime ;  compat_uptr_t u_mult_inv ; } cocci_id@p ;
...
position p;
@@
 const struct class_attribute cocci_id@p ;
...
typedef compat_uptr_t;
@@
 struct compat_ica_rsa_modexpo {  compat_uptr_t inputdata ;  unsigned int inputdatalength ;  compat_uptr_t outputdata ;  unsigned int outputdatalength ;  compat_uptr_t b_key ;  compat_uptr_t n_modulus ; } cocci_id@p ;
...
position p;
@@
 struct zcrypt_device_status_ext * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_ZDEV_CARDIDS ] ;
...
position p;
@@
 struct compat_ica_rsa_modexpo cocci_id@p ;
...
position p;
@@
 struct zcdn_device {  struct device device ;  struct ap_perms perms ; } cocci_id@p ;
...
position p;
@@
 struct zcrypt_queue * cocci_id@p ;
...
position p;
@@
 struct ica_rsa_modexpo_crt cocci_id@p ;
...
position p;
@@
 struct ep11_target_dev * cocci_id@p ;
...
position p;
@@
 struct ica_rsa_modexpo cocci_id@p ;
...
position p;
@@
 struct compat_ica_xcRB cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const char * name ) ;
...
position p;
@@
 struct zcrypt_device_status * cocci_id@p ;
...
position p;
@@
 struct compat_ica_rsa_modexpo_crt cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MAX_ZDEV_CARDIDS ] ;
