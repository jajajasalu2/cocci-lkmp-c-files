...
position p;
@@
 const struct ocfs2_extent_tree_operations * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_extent_tree * et ) ;
...
position p;
@@
 struct ocfs2_per_slot_free_list * cocci_id@p ;
...
position p;
@@
 enum ocfs2_split_type { SPLIT_NONE = 0 , SPLIT_LEFT , SPLIT_RIGHT , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ocfs2_extent_tree * et , struct ocfs2_extent_rec * rec ) ;
...
symbol cocci_id;
position p;
typedef path_insert_t;
@@
 path_insert_t * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct ocfs2_extent_tree * et ) ;
...
position p;
@@
 void cocci_id@p ( struct ocfs2_extent_tree * et ) ;
...
position p;
@@
 struct find_path_data cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_cached_dealloc_ctxt * ctxt , struct ocfs2_extent_block * eb ) ;
...
position p;
@@
 struct fstrim_range * cocci_id@p ;
...
position p;
@@
 struct ocfs2_merge_ctxt cocci_id@p ;
...
position p;
@@
 struct ocfs2_path_item * cocci_id@p ;
...
position p;
@@
 struct ocfs2_merge_ctxt {  enum ocfs2_contig_type c_contig_type ;  int c_has_empty_extent ;  int c_split_covers_rec ; } cocci_id@p ;
...
typedef u64;
@@
 struct ocfs2_cached_block_free {  struct ocfs2_cached_block_free * free_next ;  u64 free_bg ;  u64 free_blk ;  unsigned int free_bit ; } cocci_id@p ;
...
position p;
@@
 enum ocfs2_contig_type cocci_id@p ( struct super_block * sb , struct ocfs2_extent_rec * ext , struct ocfs2_extent_rec * insert_rec ) ;
...
position p;
@@
 struct ocfs2_insert_type * cocci_id@p ;
...
position p;
@@
 struct ocfs2_dx_root_block * cocci_id@p ;
...
position p;
@@
 struct ocfs2_per_slot_free_list {  struct ocfs2_per_slot_free_list * f_next_suballocator ;  int f_inode_type ;  int f_slot ;  struct ocfs2_cached_block_free * f_first ; } cocci_id@p ;
...
position p;
@@
 enum ocfs2_contig_type { CONTIG_NONE = 0 , CONTIG_LEFT , CONTIG_RIGHT , CONTIG_LEFTRIGHT , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * , struct buffer_head * ) ;
...
typedef handle_t;
@@
 int cocci_id@p ( handle_t * handle , struct ocfs2_extent_tree * et , struct buffer_head * * new_eb_bh , int blk_wanted , int * blk_given ) ;
...
position p;
@@
 struct ocfs2_trim_fs_info cocci_id@p ;
...
position p;
@@
 struct find_path_data {  int index ;  struct ocfs2_path * path ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_truncate_rec cocci_id@p ;
...
position p;
@@
 enum ocfs2_split_type cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_extent_tree * et , struct ocfs2_extent_rec * rec ) ;
...
typedef u64;
@@
 void cocci_id@p ( struct ocfs2_extent_tree * et , u64 blkno ) ;
...
position p;
@@
 struct ocfs2_group_desc * cocci_id@p ;
...
position p;
@@
 struct ocfs2_truncate_log * cocci_id@p ;
...
position p;
@@
 struct ocfs2_cached_block_free * cocci_id@p ;
...
typedef handle_t;
@@
 void cocci_id@p ( handle_t * handle , struct ocfs2_extent_tree * et , struct ocfs2_path * path , struct ocfs2_extent_rec * insert_rec ) ;
...
position p;
@@
 enum ocfs2_append_type { APPEND_NONE = 0 , APPEND_TAIL , } cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct ocfs2_extent_tree * et , u32 clusters ) ;
...
position p;
@@
 struct ocfs2_insert_type {  enum ocfs2_split_type ins_split ;  enum ocfs2_append_type ins_appending ;  enum ocfs2_contig_type ins_contig ;  int ins_contig_index ;  int ins_tree_depth ; } cocci_id@p ;
...
position p;
@@
 enum ocfs2_contig_type cocci_id@p ;
...
position p;
@@
 struct ocfs2_journal * cocci_id@p ;
...
typedef u64,u32;
@@
 struct ocfs2_extent_tree_operations {  void ( * eo_set_last_eb_blk ) ( struct ocfs2_extent_tree * et , u64 blkno ) ;  u64 ( * eo_get_last_eb_blk ) ( struct ocfs2_extent_tree * et ) ;  void ( * eo_update_clusters ) ( struct ocfs2_extent_tree * et , u32 new_clusters ) ;  void ( * eo_extent_map_insert ) ( struct ocfs2_extent_tree * et , struct ocfs2_extent_rec * rec ) ;  void ( * eo_extent_map_truncate ) ( struct ocfs2_extent_tree * et , u32 clusters ) ;  int ( * eo_insert_check ) ( struct ocfs2_extent_tree * et , struct ocfs2_extent_rec * rec ) ;  int ( * eo_sanity_check ) ( struct ocfs2_extent_tree * et ) ;  void ( * eo_fill_root_el ) ( struct ocfs2_extent_tree * et ) ;  void ( * eo_fill_max_leaf_clusters ) ( struct ocfs2_extent_tree * et ) ;  enum ocfs2_contig_type ( * eo_extent_contig ) ( struct ocfs2_extent_tree * et , struct ocfs2_extent_rec * ext , struct ocfs2_extent_rec * insert_rec ) ; } cocci_id@p ;
