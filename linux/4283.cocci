...
position p;
@@
 struct mlxplat_mlxcpld_regmap_context {  void __iomem * base ; } cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ ] [ MLXPLAT_CPLD_GRP_CHNL_NUM ] ;
...
position p;
@@
 struct mlxplat_mlxcpld_regmap_context * cocci_id@p ;
...
position p;
@@
 struct mlxplat_priv * cocci_id@p ;
...
position p;
@@
 struct mlxreg_core_platform_data * cocci_id@p [ MLXPLAT_CPLD_WD_MAX_DEVS ] ;
...
position p;
@@
 struct i2c_mux_reg_platform_data cocci_id@p [ ] ;
