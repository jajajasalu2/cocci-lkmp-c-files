...
position p;
@@
 enum { CH_BRD_T110_1CU , CH_BRD_N110_1F , CH_BRD_N210_1F , CH_BRD_T210_1F , CH_BRD_T210_1CU , CH_BRD_N204_4CU , } cocci_id@p ;
...
position p;
@@
 struct adapter_params * cocci_id@p ;
...
position p;
@@
 const struct mdio_ops cocci_id@p ;
...
symbol cocci_id;
position p;
typedef chelsio_vpd_t;
@@
 struct chelsio_vpd_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,chelsio_vpd_t;
@@
 struct chelsio_vpd_t {  u32 format_version ;  u8 serial_number [ 16 ] ;  u8 mac_base_address [ 6 ] ;  u8 pad [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct chelsio_pci_params * cocci_id@p ;
