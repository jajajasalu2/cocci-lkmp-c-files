...
position p;
@@
 struct rockchip_iodomain * cocci_id@p ;
...
position p;
@@
 struct rockchip_iodomain_soc_data {  int grf_offset ;  const char * supply_names [ MAX_SUPPLIES ] ;  void ( * init ) ( struct rockchip_iodomain * iod ) ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_iodomain_supply {  struct rockchip_iodomain * iod ;  struct regulator * reg ;  struct notifier_block nb ;  int idx ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_iodomain_supply * cocci_id@p ;
...
position p;
@@
 const struct rockchip_iodomain_soc_data cocci_id@p ;
...
position p;
@@
 struct rockchip_iodomain {  struct device * dev ;  struct regmap * grf ;  const struct rockchip_iodomain_soc_data * soc_data ;  struct rockchip_iodomain_supply supplies [ MAX_SUPPLIES ] ; } cocci_id@p ;
