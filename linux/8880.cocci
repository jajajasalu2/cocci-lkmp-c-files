...
position p;
@@
 struct xrx200_chan {  int tx_free ;  struct napi_struct napi ;  struct ltq_dma_channel dma ;  struct sk_buff * skb [ LTQ_DESC_NUM ] ;  struct xrx200_priv * priv ; } cocci_id@p ;
...
position p;
@@
 struct xrx200_priv {  struct clk * clk ;  struct xrx200_chan chan_tx ;  struct xrx200_chan chan_rx ;  struct net_device * net_dev ;  struct device * dev ; 
	 __iomem 
		  void * pmac_reg ; } cocci_id@p ;
