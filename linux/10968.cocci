...
position p;
@@
 pp_atomctrl_clock_dividers_kong * cocci_id@p ;
...
position p;
@@
 GET_EVV_VOLTAGE_INFO_OUTPUT_PARAMETER_V1_3 * cocci_id@p ;
...
position p;
@@
 GET_VOLTAGE_INFO_INPUT_PARAMETER_V1_3 cocci_id@p ;
...
position p;
@@
 READ_EFUSE_VALUE_PARAMETER cocci_id@p ;
...
position p;
@@
 SET_VOLTAGE_PS_ALLOCATION cocci_id@p ;
...
position p;
@@
 ATOM_ASIC_SS_ASSIGNMENT cocci_id@p ;
...
position p;
@@
 SET_VOLTAGE_PARAMETERS_V1_3 * cocci_id@p ;
...
position p;
@@
 COMPUTE_MEMORY_ENGINE_PLL_PARAMETERS_V4 cocci_id@p ;
...
position p;
@@
 EFUSE_INPUT_PARAMETER cocci_id@p ;
...
position p;
@@
 ATOM_ASIC_INTERNAL_SS_INFO * cocci_id@p ;
...
position p;
@@
 const ATOM_VOLTAGE_OBJECT_INFO_V3_1 * cocci_id@p ;
...
position p;
@@
 ATOM_ASIC_PROFILING_INFO_V3_4 * cocci_id@p ;
...
position p;
@@
 EFUSE_LOGISTIC_FUNC_PARAM cocci_id@p ;
...
position p;
@@
 ATOM_ASIC_PROFILING_INFO_V3_3 * cocci_id@p ;
...
position p;
@@
 ATOM_VRAM_INFO_HEADER_V2_1 * cocci_id@p ;
...
position p;
@@
 ATOM_ASIC_PROFILING_INFO_V3_6 * cocci_id@p ;
...
position p;
@@
 GET_EVV_VOLTAGE_INFO_OUTPUT_PARAMETER_V1_2 * cocci_id@p ;
...
position p;
@@
 pp_atomctrl_clock_dividers_ai * cocci_id@p ;
...
position p;
@@
 pp_atomctrl_memory_clock_param_ai * cocci_id@p ;
...
position p;
@@
 const ATOM_GPIO_PIN_ASSIGNMENT * cocci_id@p ;
...
position p;
@@
 const ATOM_VOLTAGE_OBJECT_V3 * cocci_id@p ;
...
position p;
@@
 COMPUTE_GPU_CLOCK_OUTPUT_PARAMETERS_V1_7 cocci_id@p ;
...
position p;
@@
 COMPUTE_MEMORY_CLOCK_PARAM_PARAMETERS_V2_3 cocci_id@p ;
...
position p;
@@
 GET_VOLTAGE_INFO_INPUT_PARAMETER_V1_2 cocci_id@p ;
...
position p;
@@
 DYNAMICE_MEMORY_SETTINGS_PARAMETER_V2_1 cocci_id@p ;
...
position p;
@@
 EFUSE_LINEAR_FUNC_PARAM cocci_id@p ;
...
position p;
@@
 COMPUTE_MEMORY_CLOCK_PARAM_PARAMETERS_V2_2 cocci_id@p ;
...
position p;
@@
 COMPUTE_GPU_CLOCK_OUTPUT_PARAMETERS_V1_6 cocci_id@p ;
