...
position p;
@@
 struct audio_payload cocci_id@p ;
...
typedef __be32;
@@
 struct audio_payload {  __be32 sample_count ;  __be32 signature ;  __be32 sample_total ;  __be32 reserved ;  __be16 samples [ 2 * MAX_FRAMES_PER_PACKET ] ; } cocci_id@p ;
...
position p;
@@
 const struct audio_payload * cocci_id@p ;
