...
position p;
@@
 int cocci_id@p ( struct hv_util_service * srv ) ;
...
position p;
@@
 struct shutdown_msg_data * cocci_id@p ;
...
position p;
@@
 struct hv_util_service cocci_id@p ;
...
position p;
@@
 struct ictimesync_data * cocci_id@p ;
...
position p;
@@
 struct ictimesync_ref_data * cocci_id@p ;
...
position p;
@@
 struct heartbeat_msg_data * cocci_id@p ;
...
@@
 struct {  u64 host_time ;  u64 ref_time ;  spinlock_t lock ; } cocci_id@p ;
