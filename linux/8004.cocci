...
position p;
@@
 union fza_buffer_txp cocci_id@p ;
...
position p;
@@
 struct fza_buffer_tx * cocci_id@p ;
...
position p;
@@
 union fza_buffer_txp {  struct fza_buffer_tx * data_ptr ;  struct fza_buffer_tx __iomem * mmio_ptr ; } cocci_id@p ;
