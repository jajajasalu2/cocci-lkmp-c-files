...
position p;
@@
 const struct mlxsw_sp_fid_ops * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_fid_core * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_fid_8021d * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_flood_table {  enum mlxsw_sp_flood_type packet_type ;  enum mlxsw_reg_sfgc_bridge_type bridge_type ;  enum mlxsw_flood_table_type table_type ;  int table_index ; } cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_sfmr_op cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_flood_table cocci_id@p [ ] ;
...
typedef u16;
@@
 struct mlxsw_sp_fid_8021q {  struct mlxsw_sp_fid common ;  u16 vid ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_fid_8021q cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_fid_family cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_fid_8021d {  struct mlxsw_sp_fid common ;  int br_ifindex ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SVFA_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SFMR_LEN ] ;
...
position p;
@@
 const struct mlxsw_sp_fid_family cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_fid_core {  struct rhashtable fid_ht ;  struct rhashtable vni_ht ;  struct mlxsw_sp_fid_family * fid_family_arr [ MLXSW_SP_FID_TYPE_MAX ] ;  unsigned int * port_fid_mappings ; } cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ MLXSW_REG_SFGC_TYPE_MAX ] ;
...
position p;
@@
 enum mlxsw_reg_svfa_mt cocci_id@p ;
