...
position p;
@@
 union jffs2_sum_mem * cocci_id@p ;
...
position p;
@@
 struct jffs2_raw_xattr * cocci_id@p ;
...
position p;
@@
 struct jffs2_summary cocci_id@p ;
...
position p;
@@
 struct jffs2_raw_xref cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_inode_mem cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_xref_mem cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_marker cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_unknown_flash * cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_inode_flash * cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_xref_flash * cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_dirent_mem cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_xattr_mem cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_xattr_flash * cocci_id@p ;
...
position p;
@@
 struct jffs2_raw_summary cocci_id@p ;
...
position p;
@@
 struct jffs2_sum_dirent_flash * cocci_id@p ;
