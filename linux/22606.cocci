...
position p;
@@
 struct cmipci_sb_reg cocci_id@p ;
...
position p;
@@
 struct cmipci_switch_args {  int reg ;  unsigned int mask ;  unsigned int mask_on ;  unsigned int is_byte : 1 ;  unsigned int ac3_sensitive : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct cmipci_mixer_auto_switches cocci_id@p [ ] ;
...
typedef u8;
@@
 struct cmipci_pcm {  struct snd_pcm_substream * substream ;  u8 running ;  u8 fmt ;  u8 is_dac ;  u8 needs_silencing ;  unsigned int dma_size ;  unsigned int shift ;  unsigned int ch ;  unsigned int offset ; } cocci_id@p ;
...
position p;
@@
 struct cmipci_switch_args * cocci_id@p ;
...
position p;
@@
 struct cmipci_mixer_auto_switches {  const char * name ;  int toggle_on ; } cocci_id@p ;
