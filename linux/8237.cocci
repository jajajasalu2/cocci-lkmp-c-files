...
position p;
@@
 const struct davinci_mdio_of_param cocci_id@p ;
...
position p;
@@
 struct mdio_platform_data * cocci_id@p ;
...
position p;
@@
 const struct mdio_platform_data cocci_id@p ;
...
typedef bool,u32;
@@
 struct davinci_mdio_data {  struct mdio_platform_data pdata ;  struct davinci_mdio_regs __iomem * regs ;  struct clk * clk ;  struct device * dev ;  struct mii_bus * bus ;  bool active_in_suspend ;  unsigned long access_time ;  bool skip_scan ;  u32 clk_div ; } cocci_id@p ;
...
position p;
@@
 struct davinci_mdio_of_param {  int autosuspend_delay_ms ; } cocci_id@p ;
...
position p;
@@
 struct davinci_mdio_data * cocci_id@p ;
