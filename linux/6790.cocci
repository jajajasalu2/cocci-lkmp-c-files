...
position p;
@@
 unsigned long long cocci_id@p [ LPFC_NVMET_MAX_PORTS ] ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_HBAS_NO_RESET ] ;
...
position p;
@@
 struct lpfc_lnk_stat * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ LPFC_MAX_NVME_INFO_TMP_LEN ] ;
...
position p;
@@
 char cocci_id@p [ LPFC_MAX_DATA_CTRL_LEN ] ;
...
position p;
@@
 struct lpfc_trunk_link cocci_id@p ;
