...
position p;
@@
 struct ab8500_btemp * cocci_id@p ;
...
position p;
@@
 struct ab8500_btemp_interrupts cocci_id@p [ ] ;
...
position p;
@@
 struct ab8500_btemp_ranges {  int btemp_high_limit ;  int btemp_med_limit ;  int btemp_low_limit ; } cocci_id@p ;
...
position p;
@@
 const struct abx500_res_to_temp * cocci_id@p ;
...
typedef irqreturn_t;
@@
 struct ab8500_btemp_interrupts {  char * name ;  irqreturn_t ( * isr ) ( int irq , void * data ) ; } cocci_id@p ;
...
typedef bool;
@@
 struct ab8500_btemp_events {  bool batt_rem ;  bool btemp_high ;  bool btemp_medhigh ;  bool btemp_lowmed ;  bool btemp_low ;  bool ac_conn ;  bool usb_conn ; } cocci_id@p ;
...
typedef bool;
@@
 struct ab8500_btemp {  struct device * dev ;  struct list_head node ;  int curr_source ;  int bat_temp ;  int prev_bat_temp ;  struct ab8500 * parent ;  struct iio_channel * btemp_ball ;  struct iio_channel * bat_ctrl ;  struct ab8500_fg * fg ;  struct abx500_bm_data * bm ;  struct power_supply * btemp_psy ;  struct ab8500_btemp_events events ;  struct ab8500_btemp_ranges btemp_ranges ;  struct workqueue_struct * btemp_wq ;  struct delayed_work btemp_periodic_work ;  bool initialized ; } cocci_id@p ;
