...
position p;
@@
 struct mrfld_extcon_data {  struct device * dev ;  struct regmap * regmap ;  struct extcon_dev * edev ;  unsigned int status ;  unsigned int id ; } cocci_id@p ;
...
position p;
@@
 struct mrfld_extcon_data * cocci_id@p ;
