...
position p;
@@
 struct nlattr * cocci_id@p [ LWTUNNEL_IP_OPT_GENEVE_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ LWTUNNEL_IP_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ LWTUNNEL_IP_OPT_VXLAN_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ LWTUNNEL_IP6_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ LWTUNNEL_IP_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ LWTUNNEL_IP6_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ LWTUNNEL_IP_OPTS_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ LWTUNNEL_IP_OPT_VXLAN_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ LWTUNNEL_IP_OPT_ERSPAN_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ LWTUNNEL_IP_OPT_ERSPAN_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ LWTUNNEL_IP_OPT_GENEVE_MAX + 1 ] ;
