...
position p;
@@
 struct pxa3xx_u2d_ulpi * cocci_id@p ;
...
position p;
@@
 struct pxa3xx_u2d_ulpi {  struct clk * clk ;  void __iomem * mmio_base ;  struct usb_phy * otg ;  unsigned int ulpi_mode ; } cocci_id@p ;
...
position p;
@@
 enum u2d_ulpi_phy_mode cocci_id@p ;
...
position p;
@@
 enum u2d_ulpi_phy_mode { SYNCH = 0 , CARKIT = ( 1 << 0 ) , SER_3PIN = ( 1 << 1 ) , SER_6PIN = ( 1 << 2 ) , LOWPOWER = ( 1 << 3 ) , } cocci_id@p ;
