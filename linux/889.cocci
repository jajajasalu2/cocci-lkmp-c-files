...
position p;
@@
 struct desc_info {  struct list_head node ;  enum dma_data_direction dir ;  union {  struct scatterlist adm_sgl ;  struct {  struct scatterlist * bam_sgl ;  int sgl_cnt ; } ; } ;  struct dma_async_tx_descriptor * dma_desc ; } cocci_id@p ;
...
position p;
@@
 struct qcom_nand_controller cocci_id@p ;
...
typedef __le32;
@@
 struct nandc_regs {  __le32 cmd ;  __le32 addr0 ;  __le32 addr1 ;  __le32 chip_sel ;  __le32 exec ;  __le32 cfg0 ;  __le32 cfg1 ;  __le32 ecc_bch_cfg ;  __le32 clrflashstatus ;  __le32 clrreadstatus ;  __le32 cmd1 ;  __le32 vld ;  __le32 orig_cmd1 ;  __le32 orig_vld ;  __le32 ecc_buf_cfg ;  __le32 read_location0 ;  __le32 read_location1 ;  __le32 read_location2 ;  __le32 read_location3 ;  __le32 erased_cw_detect_cfg_clr ;  __le32 erased_cw_detect_cfg_set ; } cocci_id@p ;
...
position p;
@@
 struct bam_cmd_element cocci_id@p ;
...
position p;
@@
 struct qcom_nand_host cocci_id@p ;
...
position p;
@@
 const struct qcom_nandc_props cocci_id@p ;
...
typedef __le32;
@@
 struct read_stats {  __le32 flash ;  __le32 buffer ;  __le32 erased_cw ; } cocci_id@p ;
...
position p;
@@
 struct bam_transaction * cocci_id@p ;
...
typedef bool,u32;
@@
 struct qcom_nandc_props {  u32 ecc_modes ;  bool is_bam ;  u32 dev_cmd_reg_start ; } cocci_id@p ;
