...
position p;
@@
 enum { MLX4_ICM_ALLOC_SIZE = 1 << 18 , MLX4_TABLE_CHUNK_SIZE = 1 << 18 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_icm_chunk * cocci_id@p ;
...
position p;
@@
 struct mlx4_icm_buf * cocci_id@p ;
...
position p;
@@
 struct mlx4_icm_table * cocci_id@p ;
