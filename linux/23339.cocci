...
position p;
@@
 enum { I2S_SCLK_STRENGTH_DISABLE , I2S_SCLK_STRENGTH_LOW , I2S_SCLK_STRENGTH_MEDIUM , I2S_SCLK_STRENGTH_HIGH , } cocci_id@p ;
...
position p;
@@
 enum { HP_POWER_EVENT , DAC_POWER_EVENT , ADC_POWER_EVENT , LAST_POWER_EVENT = ADC_POWER_EVENT , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct sgtl5000_priv {  int sysclk ;  int master ;  int fmt ;  struct regulator_bulk_data supplies [ SGTL5000_SUPPLY_NUM ] ;  int num_supplies ;  struct regmap * regmap ;  struct clk * mclk ;  int revision ;  u8 micbias_resistor ;  u8 micbias_voltage ;  u8 lrclk_strength ;  u8 sclk_strength ;  u16 mute_state [ LAST_POWER_EVENT + 1 ] ; } cocci_id@p ;
...
position p;
@@
 enum { I2S_LRCLK_STRENGTH_DISABLE , I2S_LRCLK_STRENGTH_LOW , I2S_LRCLK_STRENGTH_MEDIUM , I2S_LRCLK_STRENGTH_HIGH , } cocci_id@p ;
...
position p;
@@
 enum sgtl5000_micbias_resistor { SGTL5000_MICBIAS_OFF = 0 , SGTL5000_MICBIAS_2K = 2 , SGTL5000_MICBIAS_4K = 4 , SGTL5000_MICBIAS_8K = 8 , } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ SGTL5000_SUPPLY_NUM ] ;
...
position p;
@@
 struct sgtl5000_priv * cocci_id@p ;
...
position p;
@@
 enum sgtl5000_regulator_supplies { VDDA , VDDIO , VDDD , SGTL5000_SUPPLY_NUM , } cocci_id@p ;
