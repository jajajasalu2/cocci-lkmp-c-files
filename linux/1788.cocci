...
position p;
@@
 struct cros_ec_light_prox_state * cocci_id@p ;
...
position p;
@@
 struct cros_ec_light_prox_state {  struct cros_ec_sensors_core_state core ;  struct iio_chan_spec channels [ CROS_EC_LIGHT_PROX_MAX_CHANNELS ] ; } cocci_id@p ;
