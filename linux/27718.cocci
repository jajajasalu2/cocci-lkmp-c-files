...
position p;
@@
 struct omfs_root_block * cocci_id@p ;
...
position p;
@@
 struct omfs_sb_info * cocci_id@p ;
...
position p;
@@
 struct omfs_super_block * cocci_id@p ;
...
position p;
@@
 enum { Opt_uid , Opt_gid , Opt_umask , Opt_dmask , Opt_fmask , Opt_err , } cocci_id@p ;
