...
position p;
@@
 struct ax88179_data * cocci_id@p ;
...
typedef u8,u16;
@@
 int ( * cocci_id@p ) ( struct usbnet * , u8 , u8 , u16 , u16 , const void * , u16 ) ;
...
position p;
@@
 const struct {  unsigned char ctrl , timer_l , timer_h , size , ifg ; } cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 int ( * cocci_id@p ) ( struct usbnet * , u8 , u8 , u16 , u16 , void * , u16 ) ;
...
position p;
@@
 struct ax88179_int_data * cocci_id@p ;
...
typedef u8,u16;
@@
 int ( * cocci_id@p ) ( struct usbnet * , u8 , u16 , u16 , u16 , void * ) ;
...
typedef u8,u16;
@@
 struct ax88179_data {  u8 eee_enabled ;  u8 eee_active ;  u16 rxctl ;  u16 reserved ; } cocci_id@p ;
...
typedef __le32;
@@
 struct ax88179_int_data {  __le32 intdata1 ;  __le32 intdata2 ; } cocci_id@p ;
