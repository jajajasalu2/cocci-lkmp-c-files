...
position p;
@@
 struct module_param_attrs {  unsigned int num ;  struct attribute_group grp ;  struct param_attribute attrs [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct kmalloced_param * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( char * param , char * val , const char * doing , void * arg ) ;
...
position p;
@@
 const struct kparam_string * cocci_id@p ;
...
position p;
@@
 const struct module_version_attribute * cocci_id@p [ ] ;
...
position p;
@@
 struct module_version_attribute cocci_id@p ;
...
position p;
@@
 const struct kparam_array * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const char * , const struct kernel_param * kp ) ;
...
position p;
@@
 struct param_attribute cocci_id@p ;
...
position p;
@@
 struct param_attribute {  struct module_attribute mattr ;  const struct kernel_param * param ; } cocci_id@p ;
...
position p;
@@
 struct kmalloced_param {  struct list_head list ;  char val [ ] ; } cocci_id@p ;
...
position p;
@@
 struct module_param_attrs * cocci_id@p ;
