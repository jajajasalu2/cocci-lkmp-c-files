...
position p;
@@
 const struct k3dma_soc_data * cocci_id@p ;
...
position p;
@@
 struct k3dma_soc_data {  unsigned long flags ; } cocci_id@p ;
...
@@
 struct k3_dma_dev {  struct dma_device slave ;  void __iomem * base ;  struct tasklet_struct task ;  spinlock_t lock ;  struct list_head chan_pending ;  struct k3_dma_phy * phy ;  struct k3_dma_chan * chans ;  struct clk * clk ;  struct dma_pool * pool ;  u32 dma_channels ;  u32 dma_requests ;  u32 dma_channel_mask ;  unsigned int irq ; } cocci_id@p ;
...
typedef u32;
@@
 struct k3_dma_phy {  u32 idx ;  void __iomem * base ;  struct k3_dma_chan * vchan ;  struct k3_dma_desc_sw * ds_run ;  struct k3_dma_desc_sw * ds_done ; } cocci_id@p ;
...
position p;
@@
 struct k3_dma_desc_sw cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct k3_dma_desc_sw {  struct virt_dma_desc vd ;  dma_addr_t desc_hw_lli ;  size_t desc_num ;  size_t size ;  struct k3_desc_hw * desc_hw ; } cocci_id@p ;
...
@@
 struct k3_dma_chan {  u32 ccfg ;  struct virt_dma_chan vc ;  struct k3_dma_phy * phy ;  struct list_head node ;  dma_addr_t dev_addr ;  enum dma_status status ;  bool cyclic ;  struct dma_slave_config slave_config ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dma_chan * chan , enum dma_transfer_direction dir , struct dma_slave_config * cfg ) ;
