...
position p;
@@
 struct gb_pwm_enable_request cocci_id@p ;
...
position p;
@@
 struct gb_pwm_activate_request cocci_id@p ;
...
position p;
@@
 struct gb_pwm_disable_request cocci_id@p ;
...
position p;
@@
 struct gb_pwm_polarity_request cocci_id@p ;
...
position p;
@@
 struct gb_pwm_deactivate_request cocci_id@p ;
...
position p;
@@
 struct gb_pwm_config_request cocci_id@p ;
...
typedef u8;
@@
 struct gb_pwm_chip {  struct gb_connection * connection ;  u8 pwm_max ;  struct pwm_chip chip ;  struct pwm_chip * pwm ; } cocci_id@p ;
...
position p;
@@
 struct gb_pwm_count_response cocci_id@p ;
