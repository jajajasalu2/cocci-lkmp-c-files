...
position p;
@@
 const struct cpu_dev * cocci_id@p ;
...
position p;
@@
 const struct cpu_dev * const * cocci_id@p ;
...
position p;
@@
 const struct cpu_dev * cocci_id@p [ X86_VENDOR_NUM ] ;
...
position p;
@@
 const struct cpuid_dependent_feature * cocci_id@p ;
...
position p;
@@
 struct stack_canary cocci_id@p ;
...
position p;
@@
 struct fixed_percpu_data cocci_id@p ;
...
typedef u32;
@@
 struct cpuid_dependent_feature {  u32 feature ;  u32 level ; } cocci_id@p ;
...
position p;
@@
 const struct legacy_cpu_model_info * cocci_id@p ;
