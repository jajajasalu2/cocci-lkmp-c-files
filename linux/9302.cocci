...
position p;
@@
 struct wl1271_if_operations cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ WSPI_MAX_NUM_OF_CHUNKS ] ;
...
position p;
@@
 struct wl12xx_spi_glue * cocci_id@p ;
...
position p;
@@
 const struct wilink_family_data cocci_id@p ;
...
position p;
@@
 struct spi_transfer cocci_id@p [ 1 ] ;
...
position p;
@@
 struct wl12xx_spi_glue {  struct device * dev ;  struct platform_device * core ;  struct regulator * reg ; } cocci_id@p ;
