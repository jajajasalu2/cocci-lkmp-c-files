...
position p;
@@
 const struct ath10k_fw_ie * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ 9 + ATH10K_SMBIOS_BDF_EXT_STR_LENGTH ] ;
...
position p;
@@
 const struct ath10k_fw_components * cocci_id@p ;
...
position p;
@@
 const struct ath10k_hw_params * cocci_id@p ;
...
position p;
@@
 struct ath10k_fw_file * cocci_id@p ;
...
position p;
@@
 enum ath10k_fw_features cocci_id@p ;
...
position p;
@@
 struct ath10k_fw_ie * cocci_id@p ;
...
position p;
@@
 const struct ath10k_bus_params * cocci_id@p ;
