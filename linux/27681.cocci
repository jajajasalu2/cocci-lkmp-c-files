...
position p;
@@
 struct ext2_group_desc * cocci_id@p ;
...
position p;
@@
 struct ext2_super_block * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ext2_fsblk_t;
@@
 ext2_fsblk_t cocci_id@p ;
...
position p;
@@
 struct ext2_mount_options cocci_id@p ;
...
position p;
@@
 enum { Opt_bsd_df , Opt_minix_df , Opt_grpid , Opt_nogrpid , Opt_resgid , Opt_resuid , Opt_sb , Opt_err_cont , Opt_err_panic , Opt_err_ro , Opt_nouid32 , Opt_nocheck , Opt_debug , Opt_oldalloc , Opt_orlov , Opt_nobh , Opt_user_xattr , Opt_nouser_xattr , Opt_acl , Opt_noacl , Opt_xip , Opt_dax , Opt_ignore , Opt_err , Opt_quota , Opt_usrquota , Opt_grpquota , Opt_reservation , Opt_noreservation , } cocci_id@p ;
...
position p;
@@
 struct ext2_sb_info * cocci_id@p ;
...
position p;
@@
 struct ext2_inode_info * cocci_id@p ;
