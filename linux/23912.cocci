...
typedef u32;
@@
 void cocci_id@p ( struct xfrm_state * x , int hard , u32 portid ) ;
...
position p;
@@
 const struct xfrm_type_offload * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xfrm_state * x , struct xfrm_tmpl * t , struct xfrm_policy * pol ) ;
...
position p;
@@
 const struct xfrm_type * cocci_id@p ;
...
position p;
@@
 struct xfrm_state_afinfo * cocci_id@p ;
...
position p;
@@
 const struct xfrm_mode cocci_id@p [ XFRM_MODE_MAX ] ;
...
position p;
@@
 int cocci_id@p ( struct xfrm_state * x ) ;
...
typedef bool;
@@
 bool cocci_id@p ( const struct km_event * c ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct xfrm_state * , int , void * ) ;
...
typedef u32;
@@
 struct xfrm_state * cocci_id@p ( struct net * net , u32 mark , u32 seq ) ;
