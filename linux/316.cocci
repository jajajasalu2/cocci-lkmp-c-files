...
position p;
@@
 void cocci_id@p ( struct workqueue_struct * wq ) ;
...
position p;
@@
 void cocci_id@p ( struct pool_workqueue * pwq ) ;
...
position p;
@@
 int cocci_id@p [ NR_STD_WORKER_POOLS ] ;
...
position p;
@@
 struct execute_work * cocci_id@p ;
...
position p;
@@
 struct pool_workqueue cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ WORKER_DESC_LEN ] ;
...
@@
 struct cwt_wait {  wait_queue_entry_t wait ;  struct work_struct * work ; } cocci_id@p ;
...
position p;
@@
 struct debug_obj_descr cocci_id@p ;
...
position p;
@@
 const struct workqueue_attrs * cocci_id@p ;
...
position p;
@@
 struct work_for_cpu cocci_id@p ;
...
position p;
@@
 struct worker_pool cocci_id@p [ NR_STD_WORKER_POOLS ] ;
...
position p;
@@
 struct wq_barrier {  struct work_struct work ;  struct completion done ;  struct task_struct * task ; } cocci_id@p ;
...
position p;
@@
 struct wq_device {  struct workqueue_struct * wq ;  struct device dev ; } cocci_id@p ;
...
position p;
@@
 struct apply_wqattrs_ctx {  struct workqueue_struct * wq ;  struct workqueue_attrs * attrs ;  struct list_head list ;  struct pool_workqueue * dfl_pwq ;  struct pool_workqueue * pwq_tbl [ ] ; } cocci_id@p ;
...
position p;
@@
 enum debug_obj_state cocci_id@p ;
...
position p;
@@
 struct workqueue_attrs * cocci_id@p [ NR_STD_WORKER_POOLS ] ;
...
position p;
@@
 struct workqueue_attrs * cocci_id@p ;
...
position p;
@@
 struct wq_flusher {  struct list_head list ;  int flush_color ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 struct apply_wqattrs_ctx * cocci_id@p ;
...
position p;
@@
 struct work_for_cpu {  struct work_struct work ;  long ( * fn ) ( void * ) ;  void * arg ;  long ret ; } cocci_id@p ;
