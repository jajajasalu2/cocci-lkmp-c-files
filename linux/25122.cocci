...
position p;
@@
 const struct speed_string cocci_id@p [ ] ;
...
position p;
@@
 struct op_common_status_string {  int num ;  char * desc ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SYSFS_BUS_ID_SIZE ] ;
...
position p;
@@
 struct portst_string {  int num ;  char * desc ; } cocci_id@p ;
...
position p;
@@
 struct speed_string {  int num ;  char * speed ;  char * desc ; } cocci_id@p ;
...
position p;
@@
 struct portst_string cocci_id@p [ ] ;
...
position p;
@@
 struct op_common_status_string cocci_id@p [ ] ;
