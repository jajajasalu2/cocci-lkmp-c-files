...
position p;
@@
 struct hsu_dma_chip * cocci_id@p ;
...
position p;
@@
 struct mid8250_board * cocci_id@p ;
...
position p;
@@
 struct mid8250_board {  unsigned int flags ;  unsigned long freq ;  unsigned int base_baud ;  int ( * setup ) ( struct mid8250 * , struct uart_port * p ) ;  void ( * exit ) ( struct mid8250 * ) ; } cocci_id@p ;
...
position p;
@@
 struct hsu_dma_slave * cocci_id@p ;
...
position p;
@@
 const struct mid8250_board cocci_id@p ;
...
position p;
@@
 struct mid8250 {  int line ;  int dma_index ;  struct pci_dev * dma_dev ;  struct uart_8250_dma dma ;  struct mid8250_board * board ;  struct hsu_dma_chip dma_chip ; } cocci_id@p ;
