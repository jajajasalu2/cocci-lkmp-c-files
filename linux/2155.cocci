...
position p;
@@
 struct wm831x_backup * cocci_id@p ;
...
position p;
@@
 struct wm831x_backup {  struct wm831x * wm831x ;  struct power_supply * backup ;  struct power_supply_desc backup_desc ;  char name [ 20 ] ; } cocci_id@p ;
