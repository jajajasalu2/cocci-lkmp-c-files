...
position p;
@@
 struct cs35l34_platform_data * cocci_id@p ;
...
typedef bool;
@@
 struct cs35l34_private {  struct snd_soc_component * component ;  struct cs35l34_platform_data pdata ;  struct regmap * regmap ;  struct regulator_bulk_data core_supplies [ 2 ] ;  int num_core_supplies ;  int mclk_int ;  bool tdm_mode ;  struct gpio_desc * reset_gpio ; } cocci_id@p ;
...
typedef u8;
@@
 struct cs35l34_mclk_div {  int mclk ;  int srate ;  u8 adsp_rate ; } cocci_id@p ;
...
position p;
@@
 struct cs35l34_private * cocci_id@p ;
...
position p;
@@
 struct cs35l34_mclk_div cocci_id@p [ ] ;
