...
position p;
@@
 enum xcan_ip_type { XAXI_CAN = 0 , XZYNQ_CANPS , XAXI_CANFD , XAXI_CANFD_2_0 , } cocci_id@p ;
...
position p;
@@
 struct xcan_devtype_data {  enum xcan_ip_type cantype ;  unsigned int flags ;  const struct can_bittiming_const * bittiming_const ;  const char * bus_clk_name ;  unsigned int btr_ts2_shift ;  unsigned int btr_sjw_shift ; } cocci_id@p ;
...
position p;
@@
 const struct xcan_priv * cocci_id@p ;
...
position p;
@@
 const struct xcan_devtype_data cocci_id@p ;
