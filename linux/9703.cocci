...
position p;
@@
 struct iwl_wipan_params_cmd cocci_id@p ;
...
position p;
@@
 enum iwl_rxon_context_id cocci_id@p ;
...
position p;
@@
 struct iwl_qosparam_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_rxon_time_cmd cocci_id@p ;
...
position p;
@@
 const struct iwl_rxon_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_rxon_assoc_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_calib_chain_noise_reset_cmd cocci_id@p ;
