...
position p;
@@
 struct tuner_simple_priv cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ TUNER_SIMPLE_MAX ] ;
...
position p;
@@
 struct tuner_params * cocci_id@p ;
...
@@
 struct tuner_simple_priv {  unsigned int nr ;  u16 last_div ;  struct tuner_i2c_props i2c_props ;  struct list_head hybrid_tuner_instance_list ;  unsigned int type ;  struct tunertype * tun ;  u32 frequency ;  u32 bandwidth ;  bool radio_mode ; } cocci_id@p ;
...
position p;
@@
 struct tuner_i2c_props cocci_id@p ;
