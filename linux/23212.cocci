...
position p;
@@
 enum tas572x_type { TAS5720 , TAS5722 , } cocci_id@p ;
...
position p;
@@
 struct tas5720_data {  struct snd_soc_component * component ;  struct regmap * regmap ;  struct i2c_client * tas5720_client ;  enum tas572x_type devtype ;  struct regulator_bulk_data supplies [ TAS5720_NUM_SUPPLIES ] ;  struct delayed_work fault_check_work ;  unsigned int last_fault ; } cocci_id@p ;
...
position p;
@@
 struct tas5720_data cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( dac_analog_tlv , 
							     0x0 , 0x0 , 
