...
position p;
@@
 struct clk_double_div cocci_id@p ;
...
position p;
@@
 struct clk_periph_data cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct clk_pm_cpu {  struct clk_hw hw ;  void __iomem * reg_mux ;  u8 shift_mux ;  u32 mask_mux ;  void __iomem * reg_div ;  u8 shift_div ;  struct regmap * nb_pm_base ; } cocci_id@p ;
...
@@
 struct clk_periph_driver_data {  struct clk_hw_onecell_data * hw_data ;  spinlock_t lock ;  void __iomem * reg ;  u32 tbg_sel ;  u32 div_sel0 ;  u32 div_sel1 ;  u32 div_sel2 ;  u32 clk_sel ;  u32 clk_dis ; } cocci_id@p ;
...
position p;
@@
 struct clk_periph_driver_data * cocci_id@p ;
...
typedef u8;
@@
 struct clk_double_div {  struct clk_hw hw ;  void __iomem * reg1 ;  u8 shift1 ;  void __iomem * reg2 ;  u8 shift2 ; } cocci_id@p ;
...
position p;
@@
 const struct clk_periph_data * cocci_id@p ;
...
typedef bool;
@@
 struct clk_periph_data {  const char * name ;  const char * const * parent_names ;  int num_parents ;  struct clk_hw * mux_hw ;  struct clk_hw * rate_hw ;  struct clk_hw * gate_hw ;  struct clk_hw * muxrate_hw ;  bool is_double_div ; } cocci_id@p ;
