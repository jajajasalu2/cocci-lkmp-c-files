...
position p;
@@
 union recv_frame * cocci_id@p ( struct adapter * adapter , union recv_frame * precv_frame ) ;
...
position p;
@@
 union recv_frame * cocci_id@p ( struct adapter * padapter , union recv_frame * precv_frame ) ;
...
position p;
@@
 struct recv_frame_hdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct adapter * padapter , union recv_frame * precv_frame ) ;
...
position p;
@@
 int cocci_id@p ( struct adapter * padapter , union recv_frame * prframe ) ;
...
position p;
@@
 struct ieee80211_snap_hdr * cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct recv_reorder_ctrl * preorder_ctrl , u16 seq_num ) ;
...
position p;
@@
 int cocci_id@p ( struct recv_reorder_ctrl * preorder_ctrl , union recv_frame * prframe ) ;
...
position p;
@@
 struct stainfo_rxcache * cocci_id@p ;
...
position p;
@@
 struct sta_recv_priv cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct debug_priv * pdbgpriv , u64 prev_seq , u64 current_seq ) ;
...
position p;
@@
 int cocci_id@p ( struct adapter * padapter , union recv_frame * rframe ) ;
...
position p;
@@
 sint cocci_id@p ( struct adapter * adapter , union recv_frame * precv_frame ) ;
...
position p;
@@
 sint cocci_id@p ( struct adapter * padapter , union recv_frame * precv_frame ) ;
...
position p;
@@
 void cocci_id@p ( struct adapter * padapter , union recv_frame * prframe , struct sta_info * sta ) ;
...
position p;
@@
 sint cocci_id@p ( struct adapter * adapter , union recv_frame * precvframe ) ;
...
typedef u8;
@@
 sint cocci_id@p ( union recv_frame * precv_frame , u8 bretry , struct stainfo_rxcache * prxcache ) ;
...
position p;
@@
 sint cocci_id@p ( union recv_frame * precvframe ) ;
...
position p;
@@
 sint cocci_id@p ( struct adapter * adapter , union recv_frame * precv_frame , struct sta_info * * psta ) ;
...
position p;
@@
 int cocci_id@p ( struct adapter * padapter , struct recv_reorder_ctrl * preorder_ctrl , int bforced ) ;
