...
position p;
@@
 struct iwl_binding_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_iface_iterator_data * cocci_id@p ;
...
typedef u16;
@@
 struct iwl_mvm_iface_iterator_data {  struct ieee80211_vif * ignore_vif ;  int idx ;  struct iwl_mvm_phy_ctxt * phyctxt ;  u16 ids [ MAX_MACS_IN_BINDING ] ;  u16 colors [ MAX_MACS_IN_BINDING ] ; } cocci_id@p ;
