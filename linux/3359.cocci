...
position p;
@@
 const struct sun4i_pwm_data cocci_id@p ;
...
@@
 struct sun4i_pwm_chip {  struct pwm_chip chip ;  struct clk * clk ;  void __iomem * base ;  spinlock_t ctrl_lock ;  const struct sun4i_pwm_data * data ;  unsigned long next_period [ 2 ] ;  bool needs_delay [ 2 ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct sun4i_pwm_data {  bool has_prescaler_bypass ;  unsigned int npwm ; } cocci_id@p ;
...
position p;
@@
 struct sun4i_pwm_chip * cocci_id@p ;
