...
position p;
@@
 struct pnfs_layout_range * cocci_id@p ;
...
position p;
@@
 const struct pnfs_layout_segment * cocci_id@p ;
...
position p;
@@
 const struct pnfs_layout_hdr * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct pnfs_layout_segment * lseg , struct list_head * tmp_list ) ;
...
position p;
@@
 void cocci_id@p ( struct pnfs_layout_hdr * lo ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct pnfs_layout_segment * , struct pnfs_layout_segment * ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct pnfs_layout_hdr * lo , struct list_head * free_me , const struct pnfs_layout_range * range , u32 seq ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct pnfs_layout_range * , const struct pnfs_layout_range * ) ;
