...
position p;
@@
 const struct j1939_sock * cocci_id@p ;
...
position p;
@@
 enum j1939_sk_errqueue_type cocci_id@p ;
...
position p;
@@
 struct j1939_filter cocci_id@p ;
...
position p;
@@
 const struct j1939_sk_buff_cb * cocci_id@p ;
...
position p;
@@
 struct j1939_session cocci_id@p ;
...
position p;
@@
 const struct j1939_filter * cocci_id@p ;
...
position p;
@@
 struct j1939_sk_buff_cb * cocci_id@p ;
