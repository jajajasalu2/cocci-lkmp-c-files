...
position p;
@@
 struct mt9v032_platform_data * cocci_id@p ;
...
position p;
@@
 const struct mt9v032_model_version cocci_id@p [ ] ;
...
position p;
@@
 const struct mt9v032_model_data cocci_id@p [ ] ;
...
position p;
@@
 struct mt9v032_model_data {  unsigned int min_row_time ;  unsigned int min_hblank ;  unsigned int min_vblank ;  unsigned int max_vblank ;  unsigned int min_shutter ;  unsigned int max_shutter ;  unsigned int pclk_reg ;  unsigned int aec_max_shutter_reg ;  const struct v4l2_ctrl_config * const aec_max_shutter_v4l2_ctrl ; } cocci_id@p ;
...
typedef bool;
@@
 struct mt9v032_model_info {  const struct mt9v032_model_data * data ;  bool color ; } cocci_id@p ;
...
position p;
@@
 enum mt9v032_model { MT9V032_MODEL_V022_COLOR , MT9V032_MODEL_V022_MONO , MT9V032_MODEL_V024_COLOR , MT9V032_MODEL_V024_MONO , MT9V032_MODEL_V032_COLOR , MT9V032_MODEL_V032_MONO , MT9V032_MODEL_V034_COLOR , MT9V032_MODEL_V034_MONO , } cocci_id@p ;
...
position p;
@@
 const struct mt9v032_model_info cocci_id@p [ ] ;
...
position p;
@@
 struct mt9v032_model_version {  unsigned int version ;  const char * name ; } cocci_id@p ;
