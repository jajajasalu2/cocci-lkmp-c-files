...
position p;
@@
 struct i40iw_virtchnl_op_buf * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct i40iw_virtchnl_resp_buf ) ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct i40iw_virtchnl_resp_buf ) + sizeof ( struct i40iw_dev_hw_stats ) - 1 ] ;
...
position p;
@@
 struct i40iw_virtchnl_req * cocci_id@p ;
...
typedef u8,u16;
@@
 u8 cocci_id@p [ sizeof ( struct i40iw_virtchnl_resp_buf ) + sizeof ( u16 ) - 1 ] ;
...
position p;
@@
 struct i40iw_virtchnl_resp_buf * cocci_id@p ;
...
typedef u8,u32;
@@
 u8 cocci_id@p [ sizeof ( struct i40iw_virtchnl_resp_buf ) + sizeof ( u32 ) - 1 ] ;
...
position p;
@@
 struct i40iw_virtchnl_hmc_obj_range cocci_id@p ;
