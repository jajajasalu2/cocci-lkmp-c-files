...
position p;
@@
 const struct clk_rpmh_desc cocci_id@p ;
...
typedef u8,u32;
@@
 struct clk_rpmh {  struct clk_hw hw ;  const char * res_name ;  u8 div ;  u32 res_addr ;  u32 res_on_val ;  u32 state ;  u32 aggr_state ;  u32 last_sent_aggr_state ;  u32 valid_state_mask ;  u32 unit ;  struct device * dev ;  struct clk_rpmh * peer ; } cocci_id@p ;
...
position p;
@@
 struct clk_rpmh_desc * cocci_id@p ;
...
position p;
@@
 struct clk_rpmh_desc {  struct clk_hw * * clks ;  size_t num_clks ; } cocci_id@p ;
