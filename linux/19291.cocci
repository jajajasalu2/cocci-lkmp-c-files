...
position p;
@@
 struct cpuinfo_arc_cache * cocci_id@p ;
...
typedef phys_addr_t;
@@
 void ( * cocci_id@p ) ( phys_addr_t paddr , unsigned long vaddr , unsigned long sz , const int op , const int full_page ) ;
...
typedef phys_addr_t;
@@
 void ( * cocci_id@p ) ( phys_addr_t start , unsigned long sz ) ;
