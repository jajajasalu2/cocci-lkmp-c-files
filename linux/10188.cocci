...
position p;
@@
 enum addr_mode { AM_NONE = 0 , AM_IO , AM_MEMIO , AM_IND_IO , } cocci_id@p ;
...
position p;
@@
 const struct inf_cinfo cocci_id@p [ ] ;
...
position p;
@@
 struct _ioaddr {  enum addr_mode mode ;  union {  void __iomem * p ;  struct _ioport io ; } a ; } cocci_id@p ;
...
@@
 struct _iohandle {  enum addr_mode mode ;  resource_size_t size ;  resource_size_t start ;  void __iomem * p ; } cocci_id@p ;
...
@@
 struct inf_hw {  struct list_head list ;  struct pci_dev * pdev ;  const struct inf_cinfo * ci ;  char name [ MISDN_MAX_IDLEN ] ;  u32 irq ;  u32 irqcnt ;  struct _iohandle cfg ;  struct _iohandle addr ;  struct _ioaddr isac ;  struct _ioaddr hscx ;  spinlock_t lock ;  struct ipac_hw ipac ;  struct inf_hw * sc [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 enum inf_types { INF_NONE , INF_DIVA20 , INF_DIVA20U , INF_DIVA201 , INF_DIVA202 , INF_SPEEDWIN , INF_SAPHIR3 , INF_QS1000 , INF_QS3000 , INF_NICCY , INF_SCT_1 , INF_SCT_2 , INF_SCT_3 , INF_SCT_4 , INF_GAZEL_R685 , INF_GAZEL_R753 , } cocci_id@p ;
...
typedef u8;
@@
 struct inf_cinfo {  enum inf_types typ ;  const char * full ;  const char * name ;  enum addr_mode cfg_mode ;  enum addr_mode addr_mode ;  u8 cfg_bar ;  u8 addr_bar ;  void * irqfunc ; } cocci_id@p ;
