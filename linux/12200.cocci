...
typedef bool;
@@
 struct vic_config {  const char * firmware ;  unsigned int version ;  bool supports_sid ; } cocci_id@p ;
...
position p;
@@
 const struct vic_config cocci_id@p ;
...
position p;
@@
 const struct tegra_drm_client_ops cocci_id@p ;
...
typedef bool;
@@
 struct vic {  struct falcon falcon ;  bool booted ;  void __iomem * regs ;  struct tegra_drm_client client ;  struct host1x_channel * channel ;  struct device * dev ;  struct clk * clk ;  struct reset_control * rst ;  const struct vic_config * config ; } cocci_id@p ;
