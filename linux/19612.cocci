...
position p;
@@
 int cocci_id@p [ CONFIG_MIPS_NR_CPU_NR_MAP ] ;
...
position p;
@@
 struct flush_tlb_data {  struct vm_area_struct * vma ;  unsigned long addr1 ;  unsigned long addr2 ; } cocci_id@p ;
...
position p;
@@
 struct flush_tlb_data cocci_id@p ;
...
position p;
@@
 const struct plat_smp_ops * cocci_id@p ;
