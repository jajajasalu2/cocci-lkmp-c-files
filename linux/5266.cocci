...
position p;
@@
 const struct ata_port_info * const * cocci_id@p ;
...
position p;
@@
 const struct ata_force_param * cocci_id@p ;
...
position p;
@@
 const struct ata_blacklist_entry * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct ata_device * dev ) ;
...
position p;
@@
 const struct ata_port_operations cocci_id@p ;
...
position p;
@@
 struct ata_force_ent * cocci_id@p ;
...
typedef u16;
@@
 unsigned int cocci_id@p ( struct ata_device * dev , u16 heads , u16 sectors ) ;
...
position p;
@@
 struct ata_force_param {  const char * name ;  unsigned int cbl ;  int spd_limit ;  unsigned long xfer_mask ;  unsigned int horkage_on ;  unsigned int horkage_off ;  unsigned int lflags ; } cocci_id@p ;
...
position p;
@@
 enum ata_lpm_policy cocci_id@p ;
...
position p;
@@
 struct ata_blacklist_entry {  const char * model_num ;  const char * model_rev ;  unsigned long horkage ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ata_link * link ) ;
...
position p;
@@
 const struct pci_bits * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ATA_ID_FW_REV_LEN + 1 ] ;
...
position p;
@@
 enum ata_dev_iter_mode cocci_id@p ;
...
position p;
@@
 const struct ata_device * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ 2 ] [ ATA_ID_SERNO_LEN + 1 ] ;
...
position p;
@@
 const struct ata_link * cocci_id@p ;
...
position p;
@@
 const struct ata_port * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ ATA_MAX_DEVICES ] ;
...
position p;
@@
 const struct ata_xfer_ent * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ATA_ID_PROD_LEN + 1 ] ;
...
position p;
@@
 enum ata_link_iter_mode cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( const struct ata_device * dev ) ;
...
position p;
@@
 const struct ata_force_ent * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ATA_ID_FW_REV_LEN + 1 ] ;
...
position p;
@@
 const struct ata_timing * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ 2 ] [ ATA_ID_PROD_LEN + 1 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ata_link * ) ;
...
position p;
@@
 struct ata_force_ent {  int port ;  int device ;  struct ata_force_param param ; } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ATA_MAX_DEVICES ] ;
