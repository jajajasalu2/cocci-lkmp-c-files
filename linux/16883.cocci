...
position p;
@@
 struct bcm5974_config {  int ansi , iso , jis ;  int caps ;  int bt_ep ;  int bt_datalen ;  int tp_ep ;  enum tp_type tp_type ;  int tp_header ;  int tp_datalen ;  int tp_button ;  int tp_fsize ;  int tp_delta ;  int um_size ;  int um_req_val ;  int um_req_idx ;  int um_switch_idx ;  int um_switch_on ;  int um_switch_off ;  struct bcm5974_param p ;  struct bcm5974_param w ;  struct bcm5974_param x ;  struct bcm5974_param y ;  struct bcm5974_param o ; } cocci_id@p ;
...
position p;
@@
 const struct bcm5974_param * cocci_id@p ;
...
position p;
@@
 const struct bcm5974_config * cocci_id@p ;
...
position p;
@@
 enum tp_type { TYPE1 , TYPE2 , TYPE3 , TYPE4 , } cocci_id@p ;
...
position p;
@@
 const struct bcm5974 * cocci_id@p ;
...
position p;
@@
 struct bcm5974_param {  int snratio ;  int min ;  int max ; } cocci_id@p ;
...
typedef u8;
@@
 struct bcm5974 {  char phys [ 64 ] ;  struct usb_device * udev ;  struct usb_interface * intf ;  struct input_dev * input ;  struct bcm5974_config cfg ;  struct mutex pm_mutex ;  int opened ;  struct urb * bt_urb ;  struct bt_data * bt_data ;  struct urb * tp_urb ;  u8 * tp_data ;  const struct tp_finger * index [ MAX_FINGERS ] ;  struct input_mt_pos pos [ MAX_FINGERS ] ;  int slots [ MAX_FINGERS ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct bt_data {  u8 unknown1 ;  u8 button ;  u8 rel_x ;  u8 rel_y ; } cocci_id@p ;
