...
position p;
@@
 struct smbus_block_data * cocci_id@p ;
...
typedef u8;
@@
 struct smbus_block_data {  struct list_head node ;  u8 command ;  u8 len ;  u8 block [ I2C_SMBUS_BLOCK_MAX ] ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct stub_chip {  u8 pointer ;  u16 words [ 256 ] ;  struct list_head smbus_blocks ;  u8 bank_reg ;  u8 bank_shift ;  u8 bank_mask ;  u8 bank_sel ;  u8 bank_start ;  u8 bank_end ;  u16 bank_size ;  u16 * bank_words ; } cocci_id@p ;
...
position p;
@@
 unsigned short cocci_id@p [ MAX_CHIPS ] ;
