...
position p;
@@
 struct dw2102_state cocci_id@p ;
...
position p;
@@
 struct dvb_usb_device_description * * cocci_id@p ;
...
position p;
@@
 struct mt312_config cocci_id@p ;
...
typedef u8;
@@
 struct dw2102_state {  u8 initialized ;  u8 last_lock ;  u8 data [ MAX_XFER_SIZE + 4 ] ;  struct i2c_client * i2c_client_demod ;  struct i2c_client * i2c_client_tuner ;  int ( * old_set_voltage ) ( struct dvb_frontend * f , enum fe_sec_voltage v ) ;  int ( * fe_read_status ) ( struct dvb_frontend * fe , enum fe_status * status ) ; } cocci_id@p ;
...
position p;
@@
 const struct dvb_usb_device_description cocci_id@p ;
