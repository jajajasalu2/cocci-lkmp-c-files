...
position p;
@@
 struct command_t3_entry * cocci_id@p ;
...
position p;
@@
 struct data_seg_a64 * cocci_id@p ;
...
position p;
@@
 struct qla4_marker_entry * cocci_id@p ;
...
position p;
@@
 struct continuation_t1_entry * cocci_id@p ;
