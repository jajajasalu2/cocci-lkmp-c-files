...
position p;
@@
 struct dccp_feat_entry * cocci_id@p ;
...
position p;
@@
 const struct ccid_dependency * cocci_id@p ;
...
position p;
@@
 const struct ccid_dependency cocci_id@p [ 2 ] [ 2 ] ;
...
position p;
@@
 const struct ccid_dependency cocci_id@p [ 2 ] [ 5 ] ;
...
position p;
@@
 const struct dccp_feat_entry * cocci_id@p ;
...
position p;
@@
 const dccp_feat_val * cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 * val ;  u8 len ; } cocci_id@p ;
...
position p;
@@
 dccp_feat_val * cocci_id@p [ DCCP_FEAT_SUPPORTED_MAX ] [ 2 ] ;
...
typedef u64,u8,bool;
@@
 const struct {  u8 feat_num ;  enum dccp_feat_type rxtx ;  enum dccp_feat_type reconciliation ;  u8 default_value ;  int ( * activation_hdlr ) ( struct sock * sk , u64 val , bool rx ) ; } cocci_id@p [ ] ;
