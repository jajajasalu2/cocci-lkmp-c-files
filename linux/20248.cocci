...
position p;
@@
 struct srmcons_private * cocci_id@p ;
...
position p;
@@
 struct srmcons_private {  struct tty_port port ;  struct timer_list timer ; } cocci_id@p ;
...
position p;
@@
 union _srmcons_result {  struct {  unsigned long c : 61 ;  unsigned long status : 3 ; } bits ;  long as_long ; } cocci_id@p ;
