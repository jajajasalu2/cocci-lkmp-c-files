...
position p;
@@
 struct sky2_status_le cocci_id@p ;
...
position p;
@@
 const struct net_device_ops cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct sky2_port * cocci_id@p ;
...
position p;
@@
 const struct sky2_tx_le * cocci_id@p ;
...
position p;
@@
 const struct vpd_tag {  char tag [ 2 ] ;  char * label ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct sky2_status_le * cocci_id@p ;
...
position p;
@@
 const struct rx_ring_info * cocci_id@p ;
...
typedef u16;
@@
 const struct {  u16 reg , val ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 const struct sky2_stat {  char name [ ETH_GSTRING_LEN ] ;  u16 offset ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct sky2_hw * cocci_id@p ;
