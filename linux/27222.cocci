...
position p;
@@
 struct ext4_fsmap cocci_id@p [ 2 ] ;
...
position p;
@@
 struct ext4_fsmap_head * cocci_id@p ;
...
position p;
@@
 struct ext4_getfsmap_info cocci_id@p ;
...
position p;
@@
 struct ext4_getfsmap_dev cocci_id@p [ EXT4_GETFSMAP_DEVS ] ;
...
symbol cocci_id;
position p;
typedef ext4_fsmap_format_t;
@@
 ext4_fsmap_format_t cocci_id@p ;
...
position p;
@@
 const struct ext4_getfsmap_dev * cocci_id@p ;
...
position p;
@@
 struct ext4_getfsmap_dev cocci_id@p ;
...
typedef u32;
@@
 struct ext4_getfsmap_dev {  int ( * gfd_fn ) ( struct super_block * sb , struct ext4_fsmap * keys , struct ext4_getfsmap_info * info ) ;  u32 gfd_dev ; } cocci_id@p ;
