...
position p;
@@
 const struct radiotap_align_size cocci_id@p [ ] ;
...
position p;
@@
 const struct ieee80211_radiotap_vendor_namespaces * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_radiotap_namespace cocci_id@p ;
