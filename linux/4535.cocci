...
position p;
@@
 struct hl_dma_fence cocci_id@p ;
...
position p;
@@
 struct hl_device_idle_busy_ts * cocci_id@p ;
...
position p;
@@
 union hl_wait_cs_args * cocci_id@p ;
...
position p;
@@
 struct hw_queue_properties * cocci_id@p ;
...
typedef u64;
@@
 long cocci_id@p ( struct hl_device * hdev , struct hl_ctx * ctx , u64 timeout_us , u64 seq ) ;
