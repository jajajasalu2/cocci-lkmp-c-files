...
position p;
@@
 enum intel_lpss_dev_type { LPSS_DEV_I2C = 0 , LPSS_DEV_UART , LPSS_DEV_SPI , } cocci_id@p ;
...
position p;
@@
 const struct intel_lpss_platform_info * cocci_id@p ;
...
position p;
@@
 const struct intel_lpss * cocci_id@p ;
...
typedef u32;
@@
 struct intel_lpss {  const struct intel_lpss_platform_info * info ;  enum intel_lpss_dev_type type ;  struct clk * clk ;  struct clk_lookup * clock ;  struct mfd_cell * cell ;  struct device * dev ;  void __iomem * priv ;  u32 priv_ctx [ LPSS_PRIV_REG_COUNT ] ;  int devid ;  u32 caps ;  u32 active_ltr ;  u32 idle_ltr ;  struct dentry * debugfs ; } cocci_id@p ;
