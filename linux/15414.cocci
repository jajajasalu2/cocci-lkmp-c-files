...
position p;
@@
 enum { SCU_WATCHDOG_START = 0 , SCU_WATCHDOG_STOP , SCU_WATCHDOG_KEEPALIVE , } cocci_id@p ;
...
typedef u32;
@@
 struct ipc_wd_start {  u32 pretimeout ;  u32 timeout ; } cocci_id@p ;
...
position p;
@@
 struct intel_mid_wdt_pdata * cocci_id@p ;
