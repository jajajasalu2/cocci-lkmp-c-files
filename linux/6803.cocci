...
position p;
@@
 struct clariion_dh_data {  unsigned flags ;  unsigned char buffer [ CLARIION_BUFFER_SIZE ] ;  int lun_state ;  int port ;  int default_sp ;  int current_sp ; } cocci_id@p ;
...
position p;
@@
 struct clariion_dh_data * cocci_id@p ;
