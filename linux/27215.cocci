...
position p;
@@
 struct dir_private_info * cocci_id@p ;
...
typedef __u32,__u8;
@@
 struct fname {  __u32 hash ;  __u32 minor_hash ;  struct rb_node rb_hash ;  struct fname * next ;  __u32 inode ;  __u8 name_len ;  __u8 file_type ;  char name [ 0 ] ; } cocci_id@p ;
