...
position p;
@@
 struct clk_pllv3_vf610_mf cocci_id@p ;
...
position p;
@@
 enum imx_pllv3_type cocci_id@p ;
...
typedef bool,u32;
@@
 struct clk_pllv3 {  struct clk_hw hw ;  void __iomem * base ;  u32 power_bit ;  bool powerup_set ;  u32 div_mask ;  u32 div_shift ;  unsigned long ref_clock ;  u32 num_offset ;  u32 denom_offset ; } cocci_id@p ;
...
typedef u32;
@@
 struct clk_pllv3_vf610_mf {  u32 mfi ;  u32 mfn ;  u32 mfd ; } cocci_id@p ;
