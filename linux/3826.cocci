...
position p;
@@
 struct p8_aes_ctr_ctx {  struct crypto_skcipher * fallback ;  struct aes_key enc_key ; } cocci_id@p ;
...
position p;
@@
 const struct p8_aes_ctr_ctx * cocci_id@p ;
...
position p;
@@
 struct p8_aes_ctr_ctx * cocci_id@p ;
