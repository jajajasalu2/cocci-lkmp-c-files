...
position p;
@@
 struct pvrdma_create_cq_resp cocci_id@p ;
...
position p;
@@
 struct pvrdma_create_cq cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_create_cq * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_create_cq_resp * cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_destroy_cq * cocci_id@p ;
