...
position p;
@@
 struct davinci_timer_info cocci_id@p ;
...
position p;
@@
 struct davinci_spi_platform_data cocci_id@p ;
...
position p;
@@
 enum vpbe_enc_timings_type cocci_id@p ;
...
position p;
@@
 struct emac_platform_data cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ DAVINCI_N_AINTC_IRQ ] ;
...
position p;
@@
 struct venc_platform_data cocci_id@p ;
...
position p;
@@
 const struct davinci_aintc_config cocci_id@p ;
