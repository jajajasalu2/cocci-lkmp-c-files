...
position p;
@@
 void cocci_id@p ( struct wacom * wacom , int button_count , int mask , int group ) ;
...
position p;
@@
 void cocci_id@p ( struct input_dev * input_dev , int button_count , int mask ) ;
...
position p;
@@
 unsigned char cocci_id@p [ WACOM_PKGLEN_MAX ] ;
...
position p;
@@
 const struct wacom_features cocci_id@p ;
