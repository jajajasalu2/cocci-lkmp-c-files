...
position p;
@@
 struct ipq806x_gmac * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef phy_interface_t,uint32_t;
@@
 struct ipq806x_gmac {  struct platform_device * pdev ;  struct regmap * nss_common ;  struct regmap * qsgmii_csr ;  uint32_t id ;  struct clk * core_clk ;  phy_interface_t phy_mode ; } cocci_id@p ;
