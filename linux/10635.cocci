...
position p;
@@
 struct intel_vgpu_creation_params * cocci_id@p ;
...
position p;
@@
 struct {  unsigned int low_mm ;  unsigned int high_mm ;  unsigned int fence ;  unsigned int weight ;  enum intel_vgpu_edid edid ;  char * name ; } cocci_id@p [ ] ;
