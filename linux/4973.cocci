...
position p;
@@
 struct usnic_uiom_reg * cocci_id@p ;
...
position p;
@@
 struct usnic_uiom_chunk * cocci_id@p ;
...
position p;
@@
 struct usnic_uiom_interval_node * cocci_id@p ;
...
position p;
@@
 struct usnic_uiom_pd * cocci_id@p ;
...
position p;
@@
 struct usnic_uiom_dev * cocci_id@p ;
