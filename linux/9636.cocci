...
position p;
@@
 int ( * cocci_id@p ) ( struct seq_file * seq , void * data ) ;
...
position p;
@@
 struct brcms_debugfs_entry * cocci_id@p ;
...
position p;
@@
 struct brcms_debugfs_entry {  int ( * read ) ( struct seq_file * seq , void * data ) ;  struct brcms_pub * drvr ; } cocci_id@p ;
