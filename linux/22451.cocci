...
position p;
@@
 volatile struct snd_ac97 * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ SUSPEND_REGISTERS ] ;
...
position p;
@@
 struct cs4281_dma {  struct snd_pcm_substream * substream ;  unsigned int regDBA ;  unsigned int regDCA ;  unsigned int regDBC ;  unsigned int regDCC ;  unsigned int regDMR ;  unsigned int regDCR ;  unsigned int regHDSR ;  unsigned int regFCR ;  unsigned int regFSIC ;  unsigned int valDMR ;  unsigned int valDCR ;  unsigned int valFCR ;  unsigned int fifo_offset ;  unsigned char left_slot ;  unsigned char right_slot ;  int frag ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cs4281 * chip ) ;
