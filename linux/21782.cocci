...
position p;
@@
 struct pg_state {  int level ;  unsigned int current_prot ;  unsigned long start_address ;  unsigned long current_address ;  const struct addr_marker * marker ; } cocci_id@p ;
