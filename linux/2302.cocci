...
position p;
@@
 struct tegra_bpmp_thermal_zone * cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_thermal * cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_thermal_zone {  struct tegra_bpmp_thermal * tegra ;  struct thermal_zone_device * tzd ;  struct work_struct tz_device_update_work ;  unsigned int idx ; } cocci_id@p ;
...
position p;
@@
 struct mrq_thermal_bpmp_to_host_request * cocci_id@p ;
...
position p;
@@
 union mrq_thermal_bpmp_to_host_response cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_thermal {  struct device * dev ;  struct tegra_bpmp * bpmp ;  unsigned int num_zones ;  struct tegra_bpmp_thermal_zone * * zones ; } cocci_id@p ;
...
position p;
@@
 struct mrq_thermal_host_to_bpmp_request cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_channel * cocci_id@p ;
