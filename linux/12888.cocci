...
position p;
@@
 struct cpc925_mc_pdata * cocci_id@p ;
...
position p;
@@
 struct cpc925_dev_info {  void __iomem * vbase ;  struct platform_device * pdev ;  char * ctl_name ;  int edac_idx ;  struct edac_device_ctl_info * edac_dev ;  void ( * init ) ( struct cpc925_dev_info * dev_info ) ;  void ( * exit ) ( struct cpc925_dev_info * dev_info ) ;  void ( * check ) ( struct edac_device_ctl_info * edac_dev ) ; } cocci_id@p ;
...
position p;
@@
 enum brgctrl_bits { BRGCTRL_DETSERR = CPC925_BIT ( 0 ) , BRGCTRL_SECBUSRESET = CPC925_BIT ( 9 ) , } cocci_id@p ;
...
position p;
@@
 struct cpc925_mc_pdata {  void __iomem * vbase ;  unsigned long total_mem ;  const char * name ;  int edac_idx ; } cocci_id@p ;
...
position p;
@@
 struct cpc925_dev_info cocci_id@p [ ] ;
...
position p;
@@
 enum linkerr_bits { LINKERR_EOC_ERR = CPC925_BIT ( 17 ) , LINKERR_OVF_ERR = CPC925_BIT ( 18 ) , LINKERR_PROT_ERR = CPC925_BIT ( 19 ) , HT_LINKERR_DETECTED = ( LINKERR_EOC_ERR | LINKERR_OVF_ERR | LINKERR_PROT_ERR ) , } cocci_id@p ;
...
position p;
@@
 enum mccr_bits { MCCR_ECC_EN = CPC925_BIT ( 0 ) , } cocci_id@p ;
...
position p;
@@
 enum mmcr_bits { MMCR_REG_DIMM_MODE = CPC925_BIT ( 3 ) , } cocci_id@p ;
...
position p;
@@
 enum linkctrl_bits { LINKCTRL_CRC_ERR = ( CPC925_BIT ( 22 ) | CPC925_BIT ( 23 ) ) , LINKCTRL_LINK_FAIL = CPC925_BIT ( 27 ) , HT_LINKCTRL_DETECTED = ( LINKCTRL_CRC_ERR | LINKCTRL_LINK_FAIL ) , } cocci_id@p ;
