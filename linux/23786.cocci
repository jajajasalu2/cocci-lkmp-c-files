...
position p;
@@
 const struct netlbl_dom_map * cocci_id@p ;
...
typedef u32;
@@
 struct netlbl_domhsh_tbl {  struct list_head * tbl ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct netlbl_dom_map * entry , void * arg ) ;
...
position p;
@@
 struct netlbl_domhsh_tbl * cocci_id@p ;
