...
position p;
@@
 struct ip_vs_sh_state {  struct rcu_head rcu_head ;  struct ip_vs_sh_bucket buckets [ IP_VS_SH_TAB_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_sh_state * cocci_id@p ;
...
position p;
@@
 struct ip_vs_sh_bucket * cocci_id@p ;
...
position p;
@@
 struct ip_vs_sh_bucket {  struct ip_vs_dest __rcu * dest ; } cocci_id@p ;
