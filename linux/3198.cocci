...
position p;
@@
 enum chips { tmp421 , tmp422 , tmp423 , tmp441 , tmp442 , } cocci_id@p ;
...
typedef u8,s16,u32;
@@
 struct tmp421_data {  struct i2c_client * client ;  struct mutex update_lock ;  u32 temp_config [ 5 ] ;  struct hwmon_channel_info temp_info ;  const struct hwmon_channel_info * info [ 2 ] ;  struct hwmon_chip_info chip ;  char valid ;  unsigned long last_updated ;  unsigned long channels ;  u8 config ;  s16 temp [ 4 ] ; } cocci_id@p ;
