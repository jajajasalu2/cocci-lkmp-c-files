...
position p;
@@
 const struct nfp_devlink_param_u8_arg * cocci_id@p ;
...
typedef u8;
@@
 struct nfp_devlink_param_u8_arg {  const char * hwinfo_name ;  const char * default_hi_val ;  int invalid_dl_val ;  u8 hi_to_dl [ 4 ] ;  u8 dl_to_hi [ 4 ] ;  u8 max_dl_val ;  u8 max_hi_val ; } cocci_id@p ;
