...
@@
 int 
 INIT 
  cocci_id@p ( ( unsigned * , unsigned , unsigned , 
...
@@
 int 
 INIT 
  cocci_id@p ( ( struct huft * , struct huft * , int , int ) ) ;
...
position p;
@@
 struct huft {  uch e ;  uch b ;  union {  ush n ;  struct huft * t ; } v ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned c [ BMAX + 1 ] ;  struct huft * u [ BMAX ] ;  unsigned v [ N_MAX ] ;  unsigned x [ BMAX + 1 ] ; } * cocci_id@p ;
