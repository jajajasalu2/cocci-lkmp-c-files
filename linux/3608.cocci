...
position p;
@@
 struct mrq_query_abi_request cocci_id@p ;
...
position p;
@@
 struct mrq_query_fw_tag_response cocci_id@p ;
...
position p;
@@
 const struct tegra_bpmp_soc cocci_id@p ;
...
position p;
@@
 const struct tegra_bpmp_ops * cocci_id@p ;
...
position p;
@@
 struct mrq_query_tag_request cocci_id@p ;
...
position p;
@@
 struct mrq_ping_request * cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_mrq * cocci_id@p ;
...
position p;
@@
 const struct tegra_bpmp_message * cocci_id@p ;
...
position p;
@@
 struct mrq_ping_response cocci_id@p ;
...
symbol cocci_id;
position p;
typedef tegra_bpmp_mrq_handler_t;
@@
 tegra_bpmp_mrq_handler_t cocci_id@p ;
...
position p;
@@
 struct mrq_query_abi_response cocci_id@p ;
