...
position p;
@@
 struct tx_policy_cache_entry cocci_id@p ;
...
position p;
@@
 const struct ieee80211_rate * cocci_id@p ( const struct cw1200_common * priv , const struct ieee80211_tx_rate * rate ) ;
...
position p;
@@
 struct wsm_map_link cocci_id@p ;
...
position p;
@@
 const struct cw1200_txpriv * cocci_id@p ;
...
position p;
@@
 struct wsm_tx_rate_retry_policy * cocci_id@p ;
...
position p;
@@
 struct wsm_set_tx_rate_retry_policy cocci_id@p ;
...
position p;
@@
 struct wsm_tx_confirm * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cw1200_common * priv , struct sk_buff * skb ) ;
...
position p;
@@
 const struct ieee80211_tx_rate * cocci_id@p ;
...
position p;
@@
 struct cw1200_txinfo * cocci_id@p ;
...
position p;
@@
 const struct cw1200_common * cocci_id@p ;
...
typedef u8;
@@
 struct cw1200_txinfo {  struct sk_buff * skb ;  unsigned queue ;  struct ieee80211_tx_info * tx_info ;  const struct ieee80211_rate * rate ;  struct ieee80211_hdr * hdr ;  size_t hdrlen ;  const u8 * da ;  struct cw1200_sta_priv * sta_priv ;  struct ieee80211_sta * sta ;  struct cw1200_txpriv txpriv ; } cocci_id@p ;
...
position p;
@@
 struct tx_policy_cache * cocci_id@p ;
...
position p;
@@
 const struct tx_policy * cocci_id@p ;
