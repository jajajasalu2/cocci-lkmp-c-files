...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( add_vxlan_udp_dport_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( delete_vxlan_udp_dport_out ) ] ;
...
@@
 struct mlx5_vxlan_port {  struct hlist_node hlist ;  refcount_t refcount ;  u16 udp_port ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( add_vxlan_udp_dport_in ) ] ;
...
position p;
@@
 struct mlx5_vxlan_port * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( delete_vxlan_udp_dport_in ) ] ;
