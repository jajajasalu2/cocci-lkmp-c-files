...
position p;
@@
 struct klp_find_arg * cocci_id@p ;
...
position p;
@@
 struct klp_find_arg {  const char * objname ;  const char * name ;  unsigned long addr ;  unsigned long count ;  unsigned long pos ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct klp_object * obj , struct klp_func * func ) ;
...
position p;
@@
 int cocci_id@p ( struct klp_patch * patch ) ;
...
position p;
@@
 void cocci_id@p ( struct klp_patch * patch , struct klp_object * obj ) ;
