...
position p;
@@
 const struct zx_pll_config * cocci_id@p ;
...
position p;
@@
 struct zx_clk_audio_div_table cocci_id@p ;
...
position p;
@@
 struct clk_zx_audio_divider cocci_id@p ;
...
position p;
@@
 struct clk_zx_audio * cocci_id@p ;
...
position p;
@@
 struct zx_clk_audio_div_table {  unsigned long rate ;  unsigned int int_reg ;  unsigned int frac_reg ; } cocci_id@p ;
