...
position p;
@@
 int cocci_id@p [ NUM_MIRRORED_REGS ] ;
...
position p;
@@
 struct ics932s401_data cocci_id@p ;
...
typedef u8;
@@
 struct ics932s401_data {  struct attribute_group attrs ;  struct mutex lock ;  char sensors_valid ;  unsigned long sensors_last_updated ;  u8 regs [ NUM_REGS ] ; } cocci_id@p ;
