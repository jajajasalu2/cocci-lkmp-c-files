...
position p;
@@
 struct tlv_type_patch * cocci_id@p ;
...
position p;
@@
 struct tlv_type_hdr * cocci_id@p ;
...
position p;
@@
 enum qca_tlv_dnld_mode cocci_id@p ;
...
position p;
@@
 struct tlv_type_nvm * cocci_id@p ;
...
position p;
@@
 struct edl_event_hdr * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_SIZE_PER_TLV_SEGMENT + 2 ] ;
...
position p;
@@
 struct tlv_seg_resp * cocci_id@p ;
...
position p;
@@
 struct qca_btsoc_version * cocci_id@p ;
...
position p;
@@
 struct qca_fw_config cocci_id@p ;
