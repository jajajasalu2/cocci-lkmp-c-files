...
position p;
@@
 struct tc90522_config cocci_id@p ;
...
typedef __le32;
@@
 struct pt1_table_page {  __le32 next_pfn ;  __le32 buf_pfns [ PT1_NR_BUFS ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct pt1_buffer_page {  __le32 upackets [ PT1_NR_UPACKETS ] ; } cocci_id@p ;
...
position p;
@@
 const struct i2c_board_info * cocci_id@p ;
...
position p;
@@
 struct pt1 {  struct pci_dev * pdev ;  void __iomem * regs ;  struct i2c_adapter i2c_adap ;  int i2c_running ;  struct pt1_adapter * adaps [ PT1_NR_ADAPS ] ;  struct pt1_table * tables ;  struct task_struct * kthread ;  int table_index ;  int buf_index ;  struct mutex lock ;  int power ;  int reset ;  enum pt1_fe_clk fe_clk ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct pt1_buffer {  struct pt1_buffer_page * page ;  dma_addr_t addr ; } cocci_id@p ;
...
position p;
@@
 struct pt1_table_page * cocci_id@p ;
...
position p;
@@
 union pt1_tuner_config {  struct qm1d1b0004_config qm1d1b0004 ;  struct dvb_pll_config tda6651 ; } cocci_id@p ;
...
position p;
@@
 struct pt1_buffer_page * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct pt1_table {  struct pt1_table_page * page ;  dma_addr_t addr ;  struct pt1_buffer bufs [ PT1_NR_BUFS ] ; } cocci_id@p ;
...
position p;
@@
 struct dvb_pll_config cocci_id@p ;
...
position p;
@@
 struct qm1d1b0004_config cocci_id@p ;
...
position p;
@@
 const struct pt1_config cocci_id@p [ PT1_NR_ADAPS ] ;
...
position p;
@@
 struct pt1_config {  struct i2c_board_info demod_info ;  struct tc90522_config demod_cfg ;  struct i2c_board_info tuner_info ;  union pt1_tuner_config tuner_cfg ; } cocci_id@p ;
...
position p;
@@
 enum pt1_fe_clk { PT1_FE_CLK_20MHZ , PT1_FE_CLK_25MHZ , } cocci_id@p ;
