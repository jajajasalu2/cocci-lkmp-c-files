...
position p;
@@
 struct tape_34xx_work * cocci_id@p ;
...
position p;
@@
 struct tape_34xx_block_id * cocci_id@p ;
...
position p;
@@
 struct tape_34xx_sbid {  struct list_head list ;  struct tape_34xx_block_id bid ; } cocci_id@p ;
...
position p;
@@
 struct tape_34xx_sbid cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tape_device * , int ) ;
...
position p;
@@
 struct tape_34xx_work {  struct tape_device * device ;  enum tape_op op ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct tape_34xx_block_id {  unsigned int wrap : 1 ;  unsigned int segment : 7 ;  unsigned int format : 2 ;  unsigned int block : 22 ; } cocci_id@p ;
