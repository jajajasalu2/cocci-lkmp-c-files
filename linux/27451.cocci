...
position p;
@@
 int cocci_id@p ( struct config_item * parent_item , struct config_item * item , struct dentry * dentry , struct configfs_fragment * frag ) ;
...
position p;
@@
 void cocci_id@p ( struct config_item * item ) ;
