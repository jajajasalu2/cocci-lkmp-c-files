...
position p;
@@
 struct omap_vout_device * cocci_id@p ;
...
position p;
@@
 struct omapvideo_info * cocci_id@p ;
...
position p;
@@
 struct omap_vout_buffer * cocci_id@p ;
...
position p;
@@
 enum omap_vout_channels { OMAP_VIDEO1 , OMAP_VIDEO2 , } cocci_id@p ;
...
position p;
@@
 struct omap2video_device * cocci_id@p ;
