...
position p;
@@
 const struct arm_smmu_match_data * cocci_id@p ;
...
position p;
@@
 struct arm_smmu_cfg * cocci_id@p ;
...
position p;
@@
 struct arm_smmu_s2cr * cocci_id@p ;
...
typedef u8;
@@
 struct arm_smmu_s2cr {  struct iommu_group * group ;  int count ;  enum arm_smmu_s2cr_type type ;  enum arm_smmu_s2cr_privcfg privcfg ;  u8 cbndx ; } cocci_id@p ;
...
position p;
@@
 struct arm_smmu_match_data {  enum arm_smmu_arch_version version ;  enum arm_smmu_implementation model ; } cocci_id@p ;
...
position p;
@@
 enum arm_smmu_s2cr_type cocci_id@p ;
...
position p;
@@
 struct arm_smmu_master_cfg * cocci_id@p ;
...
position p;
@@
 struct arm_smmu_smr * cocci_id@p ;
...
typedef bool,u16;
@@
 struct arm_smmu_smr {  u16 mask ;  u16 id ;  bool valid ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct arm_smmu_cb {  u64 ttbr [ 2 ] ;  u32 tcr [ 2 ] ;  u32 mair [ 2 ] ;  struct arm_smmu_cfg * cfg ; } cocci_id@p ;
...
typedef s16;
@@
 struct arm_smmu_master_cfg {  struct arm_smmu_device * smmu ;  s16 smendx [ ] ; } cocci_id@p ;
