...
position p;
@@
 struct sun5i_timer_clkevt {  struct sun5i_timer timer ;  struct clock_event_device clkevt ; } cocci_id@p ;
...
position p;
@@
 struct sun5i_timer_clkevt * cocci_id@p ;
...
position p;
@@
 struct sun5i_timer_clksrc cocci_id@p ;
...
position p;
@@
 struct sun5i_timer_clksrc {  struct sun5i_timer timer ;  struct clocksource clksrc ; } cocci_id@p ;
...
typedef u32;
@@
 struct sun5i_timer {  void __iomem * base ;  struct clk * clk ;  struct notifier_block clk_rate_cb ;  u32 ticks_per_jiffy ; } cocci_id@p ;
