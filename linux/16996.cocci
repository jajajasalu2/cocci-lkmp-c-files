...
typedef u8;
@@
 struct st1232_ts_data {  struct i2c_client * client ;  struct input_dev * input_dev ;  struct touchscreen_properties prop ;  struct dev_pm_qos_request low_latency_req ;  struct gpio_desc * reset_gpio ;  const struct st_chip_info * chip_info ;  int read_buf_len ;  u8 * read_buf ; } cocci_id@p ;
...
position p;
@@
 const struct st_chip_info * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct st_chip_info {  bool have_z ;  u16 max_x ;  u16 max_y ;  u16 max_area ;  u16 max_fingers ;  u8 start_reg ; } cocci_id@p ;
...
position p;
@@
 struct input_mt_pos cocci_id@p [ ST_TS_MAX_FINGERS ] ;
...
position p;
@@
 struct st1232_ts_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ST_TS_MAX_FINGERS ] ;
...
position p;
@@
 int cocci_id@p [ ST_TS_MAX_FINGERS ] ;
