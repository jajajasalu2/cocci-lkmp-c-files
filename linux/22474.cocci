...
position p;
@@
 struct lola_mixer_array cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct lola * chip , int dir , unsigned int idx , unsigned int val , bool external_call ) ;
