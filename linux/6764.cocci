...
@@
 struct scsi_dev_info_list {  struct list_head dev_info_list ;  char vendor [ 8 ] ;  char model [ 16 ] ;  blist_flags_t flags ;  unsigned compatible ; } cocci_id@p ;
...
position p;
@@
 struct scsi_dev_info_list * cocci_id@p ;
...
position p;
@@
 struct double_list {  struct list_head * top ;  struct list_head * bottom ; } cocci_id@p ;
...
position p;
@@
 struct scsi_dev_info_list_table {  struct list_head node ;  struct list_head scsi_dev_info_list ;  const char * name ;  int key ; } cocci_id@p ;
...
position p;
@@
 struct scsi_dev_info_list_table * cocci_id@p ;
...
position p;
@@
 enum scsi_devinfo_key cocci_id@p ;
