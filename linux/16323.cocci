...
position p;
@@
 struct imgu_abi_sp_group cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_stats_3a cocci_id@p ;
...
position p;
@@
 struct imgu_abi_buffer cocci_id@p ;
...
position p;
@@
 struct imgu_abi_isp_stage cocci_id@p ;
...
position p;
@@
 const struct {  enum imgu_abi_queue_id qid ;  size_t ptr_ofs ; } cocci_id@p [ IPU3_CSS_QUEUES ] ;
...
position p;
@@
 struct imgu_abi_sp_init_dmem_cfg cocci_id@p ;
...
position p;
@@
 struct imgu_abi_ddr_address_map cocci_id@p ;
...
position p;
@@
 struct imgu_abi_parameter_set_info * cocci_id@p ;
...
position p;
@@
 struct imgu_css_buffer cocci_id@p ;
...
position p;
@@
 struct imgu_css_queue cocci_id@p [ IPU3_CSS_QUEUES ] ;
...
position p;
@@
 const char * cocci_id@p [ IPU3_CSS_RECTS ] ;
...
position p;
@@
 struct imgu_abi_isp_ref_config * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_isp_ref_dmem_state * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_isp_iterator_config * cocci_id@p ;
...
position p;
@@
 struct v4l2_pix_format_mplane * cocci_id@p [ IPU3_CSS_QUEUES ] ;
...
position p;
@@
 struct v4l2_rect * constcocci_id ;
...
position p;
@@
 struct imgu_abi_sp_pipeline cocci_id@p ;
...
position p;
@@
 const struct imgu_css_format cocci_id@p [ ] ;
...
position p;
@@
 struct imgu_abi_bl_dma_cmd_entry cocci_id@p ;
...
position p;
@@
 const struct imgu_abi_buffer_sp cocci_id@p ;
...
position p;
@@
 struct imgu_abi_sp_stage * cocci_id@p ;
...
position p;
@@
 struct imgu_abi_isp_dvs_config * cocci_id@p ;
...
position p;
@@
 const struct imgu_css_map * cocci_id@p ;
...
position p;
@@
 struct imgu_fw_state_memory_offsets * cocci_id@p ;
...
position p;
@@
 struct ipu3_uapi_obgrid_param * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ IPU3_CSS_QUEUES ] ;
...
position p;
@@
 struct imgu_abi_isp_tnr3_dmem_state * cocci_id@p ;
...
position p;
@@
 struct v4l2_rect * cocci_id@p [ IPU3_CSS_RECTS ] ;
...
position p;
@@
 enum imgu_abi_param_class cocci_id@p ;
...
position p;
@@
 struct v4l2_pix_format_mplane * constcocci_id ;
...
position p;
@@
 struct imgu_abi_isp_tnr3_config * cocci_id@p ;
...
position p;
@@
 struct imgu_css_queue * cocci_id@p ;
...
typedef u32;
@@
 const struct {  u32 reg ;  u32 mask ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct v4l2_meta_format * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ IMGU_IRQCTRL_NUM ] ;
...
position p;
@@
 struct imgu_fw_config_memory_offsets * cocci_id@p ;
