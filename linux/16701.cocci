...
position p;
@@
 const struct adp5588_kpad_platform_data * cocci_id@p ;
...
position p;
@@
 const struct adp5588_gpio_platform_data * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ ADP5588_MAXGPIO ] ;
...
position p;
@@
 struct adp5588_kpad cocci_id@p ;
