...
position p;
@@
 struct adm1021_data * cocci_id@p ;
...
typedef u8;
@@
 struct adm1021_data {  struct i2c_client * client ;  enum chips type ;  const struct attribute_group * groups [ 3 ] ;  struct mutex update_lock ;  char valid ;  char low_power ;  unsigned long last_updated ;  int temp_max [ 2 ] ;  int temp_min [ 2 ] ;  int temp [ 2 ] ;  u8 alarms ;  u8 remote_temp_offset ;  u8 remote_temp_offset_prec ; } cocci_id@p ;
...
position p;
@@
 enum chips { adm1021 , adm1023 , max1617 , max1617a , thmc10 , lm84 , gl523sm , mc1066 , } cocci_id@p ;
