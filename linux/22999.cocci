...
position p;
@@
 enum rk_pdm_version { RK_PDM_RK3229 , RK_PDM_RK3308 , } cocci_id@p ;
...
position p;
@@
 struct rk_pdm_dev {  struct device * dev ;  struct clk * clk ;  struct clk * hclk ;  struct regmap * regmap ;  struct snd_dmaengine_dai_dma_data capture_dma_data ;  struct reset_control * reset ;  enum rk_pdm_version version ; } cocci_id@p ;
...
position p;
@@
 struct rk_pdm_clkref cocci_id@p [ ] ;
...
position p;
@@
 struct rk_pdm_ds_ratio cocci_id@p [ ] ;
...
position p;
@@
 struct rk_pdm_ds_ratio {  unsigned int ratio ;  unsigned int sr ; } cocci_id@p ;
...
position p;
@@
 struct rk_pdm_clkref {  unsigned int sr ;  unsigned int clk ;  unsigned int clk_out ; } cocci_id@p ;
...
position p;
@@
 enum rk_pdm_version cocci_id@p ;
