...
position p;
@@
 struct ti_sci_intr_irq_domain * cocci_id@p ;
...
typedef u32;
@@
 struct ti_sci_intr_irq_domain {  const struct ti_sci_handle * sci ;  struct ti_sci_resource * dst_irq ;  u32 dst_id ;  u32 type ; } cocci_id@p ;
