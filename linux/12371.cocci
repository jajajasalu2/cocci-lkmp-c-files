...
position p;
@@
 const struct scaler_format cocci_id@p [ ] ;
...
typedef u32;
@@
 struct scaler_format {  u32 drm_fmt ;  u32 internal_fmt ;  u32 chroma_tile_w ;  u32 chroma_tile_h ; } cocci_id@p ;
...
position p;
@@
 struct exynos_drm_ipp_funcs cocci_id@p ;
...
position p;
@@
 struct scaler_context * cocci_id@p ;
...
position p;
@@
 struct scaler_data {  const char * clk_name [ SCALER_MAX_CLK ] ;  unsigned int num_clk ;  const struct exynos_drm_ipp_formats * formats ;  unsigned int num_formats ; } cocci_id@p ;
...
position p;
@@
 struct scaler_context {  struct exynos_drm_ipp ipp ;  struct drm_device * drm_dev ;  struct device * dev ;  void __iomem * regs ;  struct clk * clock [ SCALER_MAX_CLK ] ;  struct exynos_drm_ipp_task * task ;  const struct scaler_data * scaler_data ; } cocci_id@p ;
