...
typedef spinlock_t;
@@
 struct xps2data {  int irq ;  spinlock_t lock ;  void __iomem * base_address ;  unsigned int flags ;  struct serio * serio ;  struct device * dev ; } cocci_id@p ;
