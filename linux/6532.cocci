...
position p;
@@
 void cocci_id@p ( AS_Host * host , unsigned char tag ) ;
...
position p;
@@
 struct sync_xfer_tbl {  unsigned int period_ns ;  unsigned char reg_value ; } cocci_id@p [ ] ;
...
position p;
@@
 enum res_abort { res_not_running , res_success , res_success_clear , res_snooze , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void __iomem * , char * buf , int len ) ;
...
position p;
@@
 void cocci_id@p ( AS_Host * host , struct scsi_cmnd * * SCpntp , unsigned int result ) ;
