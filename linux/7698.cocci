...
position p;
@@
 struct altera_jtaguart cocci_id@p ;
...
position p;
@@
 struct altera_jtaguart {  struct uart_port port ;  unsigned int sigs ;  unsigned long imr ; } cocci_id@p ;
...
position p;
@@
 struct altera_jtaguart cocci_id@p [ ALTERA_JTAGUART_MAXPORTS ] ;
...
position p;
@@
 struct altera_jtaguart_platform_uart * cocci_id@p ;
