...
position p;
@@
 struct arpc_cport_flush_req cocci_id@p ;
...
position p;
@@
 struct gb_apb_request_cport_flags * cocci_id@p ;
...
typedef bool;
@@
 struct arpc {  struct list_head list ;  struct arpc_request_message * req ;  struct arpc_response_message * resp ;  struct completion response_received ;  bool active ; } cocci_id@p ;
...
position p;
@@
 struct arpc_response_message * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct es2_ap_dev * es2 ) ;
...
position p;
@@
 struct arpc_cport_clear_req cocci_id@p ;
...
typedef u8,__u8;
@@
 struct es2_cport_in {  __u8 endpoint ;  struct urb * urb [ NUM_CPORT_IN_URB ] ;  u8 * buffer [ NUM_CPORT_IN_URB ] ; } cocci_id@p ;
...
position p;
@@
 struct arpc_cport_shutdown_req cocci_id@p ;
...
position p;
@@
 struct arpc_cport_quiesce_req cocci_id@p ;
...
position p;
@@
 struct gb_hd_driver cocci_id@p ;
...
position p;
@@
 struct es2_cport_in * cocci_id@p ;
...
position p;
@@
 struct arpc_cport_connected_req cocci_id@p ;
