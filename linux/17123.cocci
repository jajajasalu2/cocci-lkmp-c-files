...
symbol cocci_id;
position p;
typedef rtas_manage_flash_t;
@@
 struct rtas_manage_flash_t * const cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rtas_update_flash_t;
@@
 struct rtas_update_flash_t cocci_id@p ;
...
position p;
@@
 const struct rtas_flash_file cocci_id@p [ ] ;
...
position p;
@@
 struct flash_block_list {  unsigned long num_blocks ;  struct flash_block_list * next ;  struct flash_block blocks [ FLASH_BLOCKS_PER_NODE ] ; } cocci_id@p ;
...
typedef rtas_manage_flash_t;
@@
 struct rtas_manage_flash_t * cocci_id@p ;
...
typedef rtas_update_flash_t;
@@
 struct rtas_update_flash_t * const cocci_id@p ;
...
typedef rtas_update_flash_t;
@@
 struct rtas_update_flash_t {  int status ;  struct flash_block_list * flist ; } cocci_id@p ;
...
position p;
@@
 struct flash_block_list * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ RTAS_MSG_MAXLEN ] ;
...
typedef rtas_manage_flash_t;
@@
 struct rtas_manage_flash_t {  int status ; } cocci_id@p ;
...
position p;
@@
 struct rtas_flash_file {  const char * filename ;  const char * rtas_call_name ;  int * status ;  const struct file_operations fops ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rtas_validate_flash_t;
@@
 struct rtas_validate_flash_t cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ VALIDATE_MSG_LEN ] ;
...
typedef rtas_validate_flash_t;
@@
 struct rtas_validate_flash_t * const cocci_id@p ;
...
position p;
@@
 struct flash_block {  char * data ;  unsigned long length ; } cocci_id@p ;
...
typedef rtas_validate_flash_t;
@@
 struct rtas_validate_flash_t {  int status ;  char * buf ;  unsigned int buf_size ;  unsigned int update_results ; } cocci_id@p ;
