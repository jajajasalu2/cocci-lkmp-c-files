...
typedef bool;
@@
 struct uniphier_tm_dev {  struct regmap * regmap ;  struct device * dev ;  bool alert_en [ ALERT_CH_NUM ] ;  struct thermal_zone_device * tz_dev ;  const struct uniphier_tm_soc_data * data ; } cocci_id@p ;
...
typedef u32;
@@
 struct uniphier_tm_soc_data {  u32 map_base ;  u32 block_base ;  u32 tmod_setup_addr ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_tm_dev * cocci_id@p ;
...
position p;
@@
 const struct uniphier_tm_soc_data cocci_id@p ;
