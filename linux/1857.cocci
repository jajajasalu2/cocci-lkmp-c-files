...
position p;
@@
 struct ad7298_state {  struct spi_device * spi ;  struct regulator * reg ;  unsigned ext_ref ;  struct spi_transfer ring_xfer [ 10 ] ;  struct spi_transfer scan_single_xfer [ 3 ] ;  struct spi_message ring_msg ;  struct spi_message scan_single_msg ;  __be16 rx_buf [ 12 ] ____cacheline_aligned ;  __be16 tx_buf [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct ad7298_platform_data * cocci_id@p ;
...
position p;
@@
 struct ad7298_state * cocci_id@p ;
