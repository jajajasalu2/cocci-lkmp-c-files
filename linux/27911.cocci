...
position p;
@@
 struct f2fs_checkpoint * cocci_id@p ;
...
position p;
@@
 struct f2fs_super_block * cocci_id@p ;
...
typedef __u16;
@@
 const struct f2fs_sb_encodings {  __u16 magic ;  char * name ;  char * version ; } cocci_id@p [ ] ;
...
position p;
@@
 struct f2fs_fault_info cocci_id@p ;
...
position p;
@@
 const struct f2fs_sb_encodings * * cocci_id@p ;
...
position p;
@@
 struct f2fs_sm_info * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ FAULT_MAX ] ;
...
position p;
@@
 struct f2fs_mount_info cocci_id@p ;
...
position p;
@@
 struct f2fs_dev_info cocci_id@p ;
...
position p;
@@
 struct f2fs_xattr_header cocci_id@p ;
...
position p;
@@
 const struct f2fs_super_block * cocci_id@p ;
