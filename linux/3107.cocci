...
position p;
@@
 ssize_t ( * cocci_id@p ) ( struct loop_device * , char * ) ;
...
position p;
@@
 struct compat_loop_info cocci_id@p ;
...
position p;
@@
 const struct loop_info * cocci_id@p ;
...
position p;
@@
 struct loop_func_table * cocci_id@p [ MAX_LO_CRYPT ] ;
...
position p;
@@
 const struct loop_info64 * cocci_id@p ;
...
position p;
@@
 struct loop_func_table * cocci_id@p ;
