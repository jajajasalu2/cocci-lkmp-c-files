...
position p;
@@
 struct nxp_nci_i2c_phy * cocci_id@p ;
...
position p;
@@
 const struct nxp_nci_phy_ops cocci_id@p ;
...
position p;
@@
 struct nxp_nci_info * cocci_id@p ;
...
position p;
@@
 struct nxp_nci_i2c_phy {  struct i2c_client * i2c_dev ;  struct nci_dev * ndev ;  struct gpio_desc * gpiod_en ;  struct gpio_desc * gpiod_fw ;  int hard_fault ; } cocci_id@p ;
