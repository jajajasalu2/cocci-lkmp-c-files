...
position p;
@@
 struct tda665x_state cocci_id@p ;
...
position p;
@@
 const struct tda665x_config * cocci_id@p ;
...
typedef u32;
@@
 struct tda665x_state {  struct dvb_frontend * fe ;  struct i2c_adapter * i2c ;  const struct tda665x_config * config ;  u32 frequency ;  u32 bandwidth ; } cocci_id@p ;
...
position p;
@@
 struct dvb_tuner_info * cocci_id@p ;
