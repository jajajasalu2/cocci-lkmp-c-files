...
position p;
@@
 void ( * cocci_id@p ) ( void * private_data , int ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_kcontrol * vslave , struct snd_kcontrol * slave , void * arg ) ;
...
position p;
@@
 struct link_slave {  struct list_head list ;  struct link_master * master ;  struct link_ctl_info info ;  int vals [ 2 ] ;  unsigned int flags ;  struct snd_kcontrol * kctl ;  struct snd_kcontrol slave ; } cocci_id@p ;
