...
position p;
@@
 struct asd_ha_struct * cocci_id@p ;
...
position p;
@@
 const struct asd_pcidev_struct * cocci_id@p ;
...
position p;
@@
 struct bios_file_header cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * , unsigned long ) ;
...
typedef u8;
@@
 struct flash_command {  u8 command [ 8 ] ;  int code ; } cocci_id@p ;
...
position p;
@@
 struct asd_ha_addrspace * cocci_id@p ;
...
position p;
@@
 struct flash_command cocci_id@p [ ] ;
...
position p;
@@
 const struct asd_pcidev_struct {  const char * name ;  int ( * setup ) ( struct asd_ha_struct * asd_ha ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct error_bios {  char * reason ;  int err_code ; } cocci_id@p ;
...
position p;
@@
 struct asd_seq_data * cocci_id@p ;
