...
position p;
@@
 struct bfi_enet_set_pause_req cocci_id@p ;
...
position p;
@@
 struct bfi_enet_stats cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct bnad * , enum bna_cb_status ) ;
...
position p;
@@
 struct bfi_enet_stats_req cocci_id@p ;
...
position p;
@@
 struct bfi_enet_attr_req * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bna_enet * enet ) ;
...
position p;
@@
 struct bfi_enet_diag_lb_req cocci_id@p ;
...
position p;
@@
 enum bna_ioceth_event { IOCETH_E_ENABLE = 1 , IOCETH_E_DISABLE = 2 , IOCETH_E_IOC_RESET = 3 , IOCETH_E_IOC_FAILED = 4 , IOCETH_E_IOC_READY = 5 , IOCETH_E_ENET_ATTR_RESP = 6 , IOCETH_E_ENET_STOPPED = 7 , IOCETH_E_IOC_DISABLED = 8 , } cocci_id@p ;
...
position p;
@@
 enum bna_ethport_event { ETHPORT_E_START = 1 , ETHPORT_E_STOP = 2 , ETHPORT_E_FAIL = 3 , ETHPORT_E_UP = 4 , ETHPORT_E_DOWN = 5 , ETHPORT_E_FWRESP_UP_OK = 6 , ETHPORT_E_FWRESP_DOWN = 7 , ETHPORT_E_FWRESP_UP_FAIL = 8 , } cocci_id@p ;
...
position p;
@@
 struct bfi_enet_attr_rsp * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_stats_rxf cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bna_ioceth * ioceth ) ;
...
position p;
@@
 enum bna_enet_event { ENET_E_START = 1 , ENET_E_STOP = 2 , ENET_E_FAIL = 3 , ENET_E_PAUSE_CFG = 4 , ENET_E_MTU_CFG = 5 , ENET_E_FWRESP_PAUSE = 6 , ENET_E_CHLD_STOPPED = 7 , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct bna_enet * ) ;
...
position p;
@@
 enum bna_ioceth_event cocci_id@p ;
...
position p;
@@
 enum bna_enet_event cocci_id@p ;
...
position p;
@@
 enum bna_ethport_event cocci_id@p ;
...
position p;
@@
 struct bna_pause_config * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_stats_txf cocci_id@p ;
