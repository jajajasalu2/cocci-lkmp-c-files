...
position p;
@@
 const struct iwl_power_vec_entry * cocci_id@p ;
...
position p;
@@
 enum iwl_power_level cocci_id@p ;
...
typedef u8;
@@
 struct iwl_power_vec_entry {  struct iwl_powertable_cmd cmd ;  u8 no_dtim ; } cocci_id@p ;
...
position p;
@@
 const struct iwl_power_vec_entry cocci_id@p [ IWL_POWER_NUM ] ;
...
position p;
@@
 int cocci_id@p [ IWL_POWER_VEC_SIZE ] ;
