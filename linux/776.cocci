...
position p;
@@
 struct mtk_pcie_port * cocci_id@p ;
...
position p;
@@
 const struct mtk_pcie_soc cocci_id@p ;
...
position p;
@@
 struct mtk_pcie {  struct device * dev ;  void __iomem * base ;  struct clk * free_ck ;  struct list_head ports ;  const struct mtk_pcie_soc * soc ;  unsigned int busnr ; } cocci_id@p ;
