...
typedef spinlock_t;
@@
 struct sierra_port_private {  spinlock_t lock ;  int outstanding_urbs ;  struct usb_anchor active ;  struct usb_anchor delayed ;  int num_out_urbs ;  int num_in_urbs ;  struct urb * in_urbs [ N_IN_URB_HM ] ;  int rts_state ;  int dtr_state ;  int cts_state ;  int dsr_state ;  int dcd_state ;  int ri_state ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sierra_intf_private {  spinlock_t susp_lock ;  unsigned int suspended : 1 ;  int in_flight ;  unsigned int open_ports ; } cocci_id@p ;
...
position p;
@@
 struct sierra_intf_private * cocci_id@p ;
...
position p;
@@
 struct sierra_iface_info * cocci_id@p ;
...
position p;
@@
 const struct sierra_iface_info cocci_id@p ;
...
typedef u8,u32;
@@
 struct sierra_iface_info {  const u32 infolen ;  const u8 * ifaceinfo ; } cocci_id@p ;
...
position p;
@@
 struct sierra_port_private * cocci_id@p ;
