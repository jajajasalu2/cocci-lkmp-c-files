...
typedef u8;
@@
 u8 cocci_id@p [ IEEE802154_ADDR_LEN ] ;
...
position p;
@@
 struct sockaddr_ieee802154 * cocci_id@p ;
...
position p;
@@
 struct dgram_sock {  struct sock sk ;  struct ieee802154_addr src_addr ;  struct ieee802154_addr dst_addr ;  unsigned int bound : 1 ;  unsigned int connected : 1 ;  unsigned int want_ack : 1 ;  unsigned int want_lqi : 1 ;  unsigned int secen : 1 ;  unsigned int secen_override : 1 ;  unsigned int seclevel : 3 ;  unsigned int seclevel_override : 1 ; } cocci_id@p ;
...
position p;
@@
 struct ieee802154_mac_cb * cocci_id@p ;
