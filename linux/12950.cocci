...
position p;
@@
 struct dl_codeblock cocci_id@p ;
...
typedef u32;
@@
 struct dl_codeblock {  u32 npe_addr ;  u32 size ;  u32 data [ 0 ] ; } * cocci_id@p ;
...
position p;
@@
 struct npe cocci_id@p [ NPE_COUNT ] ;
...
typedef u32;
@@
 struct dl_block {  u32 type ;  u32 offset ; } * cocci_id@p ;
...
typedef u32;
@@
 struct dl_image {  u32 magic ;  u32 id ;  u32 size ;  union {  u32 data [ 0 ] ;  struct dl_block blocks [ 0 ] ; } ; } * cocci_id@p ;
