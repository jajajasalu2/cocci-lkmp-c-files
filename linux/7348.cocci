...
typedef u8,u32,u16;
@@
 struct cg14_regs {  u8 mcr ;  u8 ppr ;  u8 tms [ 2 ] ;  u8 msr ;  u8 fsr ;  u8 rev ;  u8 ccr ;  u32 tmr ;  u8 mod ;  u8 acr ;  u8 xxx0 [ 6 ] ;  u16 hct ;  u16 vct ;  u16 hbs ;  u16 hbc ;  u16 hss ;  u16 hsc ;  u16 csc ;  u16 vbs ;  u16 vbc ;  u16 vss ;  u16 vsc ;  u16 xcs ;  u16 xcc ;  u16 fsa ;  u16 adr ;  u8 xxx1 [ 0xce ] ;  u8 pcg [ 0x100 ] ;  u32 vbr ;  u32 vmcr ;  u32 vcr ;  u32 vca ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct cg14_cursor {  u32 cpl0 [ 32 ] ;  u32 cpl1 [ 32 ] ;  u8 ccr ;  u8 xxx0 [ 3 ] ;  u16 cursx ;  u16 cursy ;  u32 color0 ;  u32 color1 ;  u32 xxx1 [ 0x1bc ] ;  u32 cpl0i [ 32 ] ;  u32 cpl1i [ 32 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct cg14_clut {  u32 c_clut [ 256 ] ;  u32 c_clutd [ 256 ] ;  u32 c_clut_inc [ 256 ] ;  u32 c_clutd_inc [ 256 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct cg14_dac {  u8 addr ;  u8 xxx0 [ 255 ] ;  u8 glut ;  u8 xxx1 [ 255 ] ;  u8 select ;  u8 xxx2 [ 255 ] ;  u8 mode ; } cocci_id@p ;
...
position p;
@@
 struct sbus_mmap_map cocci_id@p [ CG14_MMAP_ENTRIES ] ;
...
typedef u8;
@@
 struct cg14_xlut {  u8 x_xlut [ 256 ] ;  u8 x_xlutd [ 256 ] ;  u8 xxx0 [ 0x600 ] ;  u8 x_xlut_inc [ 256 ] ;  u8 x_xlutd_inc [ 256 ] ; } cocci_id@p ;
