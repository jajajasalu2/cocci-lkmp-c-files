...
position p;
@@
 struct serial_state cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * tty , struct serial_state * info , struct ktermios * old ) ;
...
position p;
@@
 struct serial_state {  struct tty_port tport ;  struct circ_buf xmit ;  struct async_icount icount ;  unsigned long port ;  int baud_base ;  int xmit_fifo_size ;  int custom_divisor ;  int read_status_mask ;  int ignore_status_mask ;  int timeout ;  int quot ;  int IER ;  int MCR ;  int x_char ; } cocci_id@p ;
...
position p;
@@
 struct serial_state cocci_id@p [ 1 ] ;
