...
position p;
@@
 struct spi_imx_data cocci_id@p ;
...
position p;
@@
 enum spi_imx_devtype { IMX1_CSPI , IMX21_CSPI , IMX27_CSPI , IMX31_CSPI , IMX35_CSPI , IMX51_ECSPI , IMX53_ECSPI , } cocci_id@p ;
...
position p;
@@
 const struct spi_imx_devtype_data * cocci_id@p ;
...
position p;
@@
 struct spi_imx_master * cocci_id@p ;
...
position p;
@@
 struct spi_imx_devtype_data * cocci_id@p ;
