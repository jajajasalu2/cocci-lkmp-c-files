...
typedef u32;
@@
 struct ov7740_pixfmt {  u32 mbus_code ;  enum v4l2_colorspace colorspace ;  const struct reg_sequence * regs ;  u32 reg_num ; } cocci_id@p ;
...
position p;
@@
 const struct ov7740_pixfmt cocci_id@p [ ] ;
...
typedef bool;
@@
 struct ov7740 {  struct v4l2_subdev subdev ; #if defined(CONFIG_MEDIA_CONTROLLER)  struct media_pad pad ; #endif  struct v4l2_mbus_framefmt format ;  const struct ov7740_pixfmt * fmt ;  const struct ov7740_framesize * frmsize ;  struct regmap * regmap ;  struct clk * xvclk ;  struct v4l2_ctrl_handler ctrl_handler ;  struct {  struct v4l2_ctrl * auto_gain ;  struct v4l2_ctrl * gain ; } ;  struct {  struct v4l2_ctrl * auto_wb ;  struct v4l2_ctrl * blue_balance ;  struct v4l2_ctrl * red_balance ; } ;  struct {  struct v4l2_ctrl * hflip ;  struct v4l2_ctrl * vflip ; } ;  struct {  struct v4l2_ctrl * auto_exposure ;  struct v4l2_ctrl * exposure ; } ;  struct {  struct v4l2_ctrl * saturation ;  struct v4l2_ctrl * hue ; } ;  struct v4l2_ctrl * brightness ;  struct v4l2_ctrl * contrast ;  struct mutex mutex ;  bool streaming ;  struct gpio_desc * resetb_gpio ;  struct gpio_desc * pwdn_gpio ; } cocci_id@p ;
...
position p;
@@
 const struct ov7740_framesize * cocci_id@p ;
...
typedef u32,u16;
@@
 struct ov7740_framesize {  u16 width ;  u16 height ;  const struct reg_sequence * regs ;  u32 reg_num ; } cocci_id@p ;
