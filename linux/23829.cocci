...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_MPLS_MAX + 1 ] ;
...
position p;
@@
 struct tcf_mpls_params * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_MPLS_MAX + 1 ] ;
