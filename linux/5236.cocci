...
position p;
@@
 const struct via_isa_bridge * cocci_id@p ;
...
position p;
@@
 enum { VIA_IDFLAG_SINGLE = ( 1 << 0 ) , } cocci_id@p ;
...
typedef u8,u16;
@@
 const struct via_isa_bridge {  const char * name ;  u16 id ;  u8 rev_min ;  u8 rev_max ;  u8 udma_mask ;  u8 flags ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 struct via_port {  u8 cached_device ; } cocci_id@p ;
...
position p;
@@
 enum { VIA_BAD_PREQ = 0x01 , VIA_BAD_CLK66 = 0x02 , VIA_SET_FIFO = 0x04 , VIA_NO_UNMASK = 0x08 , VIA_BAD_ID = 0x10 , VIA_BAD_AST = 0x20 , VIA_NO_ENABLES = 0x40 , VIA_SATA_PATA = 0x80 , } cocci_id@p ;
