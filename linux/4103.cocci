...
typedef u8;
@@
 const u8 cocci_id@p [ MAX_A38X_COMPHY ] [ MAX_A38X_PORTS ] ;
...
position p;
@@
 struct a38x_comphy_lane {  void __iomem * base ;  struct a38x_comphy * priv ;  unsigned int n ;  int port ; } cocci_id@p ;
...
position p;
@@
 struct a38x_comphy_lane * cocci_id@p ;
...
position p;
@@
 struct a38x_comphy {  void __iomem * base ;  struct device * dev ;  struct a38x_comphy_lane lane [ MAX_A38X_COMPHY ] ; } cocci_id@p ;
