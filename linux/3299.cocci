...
position p;
@@
 enum g762_regs { G762_REG_SET_CNT = 0x00 , G762_REG_ACT_CNT = 0x01 , G762_REG_FAN_STA = 0x02 , G762_REG_SET_OUT = 0x03 , G762_REG_FAN_CMD1 = 0x04 , G762_REG_FAN_CMD2 = 0x05 , } cocci_id@p ;
...
position p;
@@
 struct g762_platform_data * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct g762_data {  struct i2c_client * client ;  struct clk * clk ;  struct mutex update_lock ;  u32 clk_freq ;  bool valid ;  unsigned long last_updated ;  u8 set_cnt ;  u8 act_cnt ;  u8 fan_sta ;  u8 set_out ;  u8 fan_cmd1 ;  u8 fan_cmd2 ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device * dev , unsigned long val ) ;
