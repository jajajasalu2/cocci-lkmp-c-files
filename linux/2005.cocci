...
typedef u8,u32,u16;
@@
 struct adxl372_state {  int irq ;  struct device * dev ;  struct regmap * regmap ;  struct iio_trigger * dready_trig ;  enum adxl372_fifo_mode fifo_mode ;  enum adxl372_fifo_format fifo_format ;  enum adxl372_op_mode op_mode ;  enum adxl372_act_proc_mode act_proc_mode ;  enum adxl372_odr odr ;  enum adxl372_bandwidth bw ;  u32 act_time_ms ;  u32 inact_time_ms ;  u8 fifo_set_size ;  u8 int1_bitmask ;  u8 int2_bitmask ;  u16 watermark ;  __be16 fifo_buf [ ADXL372_FIFO_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 enum adxl372_bandwidth { ADXL372_BW_200HZ , ADXL372_BW_400HZ , ADXL372_BW_800HZ , ADXL372_BW_1600HZ , ADXL372_BW_3200HZ , } cocci_id@p ;
...
position p;
@@
 enum adxl372_fifo_format { ADXL372_XYZ_FIFO , ADXL372_X_FIFO , ADXL372_Y_FIFO , ADXL372_XY_FIFO , ADXL372_Z_FIFO , ADXL372_XZ_FIFO , ADXL372_YZ_FIFO , ADXL372_XYZ_PEAK_FIFO , } cocci_id@p ;
...
position p;
@@
 enum adxl372_odr { ADXL372_ODR_400HZ , ADXL372_ODR_800HZ , ADXL372_ODR_1600HZ , ADXL372_ODR_3200HZ , ADXL372_ODR_6400HZ , } cocci_id@p ;
...
position p;
@@
 const struct adxl372_axis_lookup cocci_id@p [ ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ 3 ] ;
...
position p;
@@
 enum adxl372_act_proc_mode { ADXL372_DEFAULT , ADXL372_LINKED , ADXL372_LOOPED , } cocci_id@p ;
...
position p;
@@
 enum adxl372_act_proc_mode cocci_id@p ;
...
position p;
@@
 enum adxl372_bandwidth cocci_id@p ;
...
position p;
@@
 enum adxl372_th_activity cocci_id@p ;
...
position p;
@@
 struct adxl372_axis_lookup {  unsigned int bits ;  enum adxl372_fifo_format fifo_format ; } cocci_id@p ;
...
position p;
@@
 enum adxl372_op_mode { ADXL372_STANDBY , ADXL372_WAKE_UP , ADXL372_INSTANT_ON , ADXL372_FULL_BW_MEASUREMENT , } cocci_id@p ;
...
position p;
@@
 enum adxl372_fifo_mode { ADXL372_FIFO_BYPASSED , ADXL372_FIFO_STREAMED , ADXL372_FIFO_TRIGGERED , ADXL372_FIFO_OLD_SAVED , } cocci_id@p ;
...
position p;
@@
 struct adxl372_state * cocci_id@p ;
...
position p;
@@
 enum adxl372_op_mode cocci_id@p ;
...
position p;
@@
 enum adxl372_th_activity { ADXL372_ACTIVITY , ADXL372_ACTIVITY2 , ADXL372_INACTIVITY , } cocci_id@p ;
