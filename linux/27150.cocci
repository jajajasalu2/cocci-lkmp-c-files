...
typedef sysv_zone_t;
@@
 struct {  sysv_zone_t * p ;  sysv_zone_t key ;  struct buffer_head * bh ; } cocci_id@p ;
...
position p;
@@
 enum { DIRECT = 10 , DEPTH = 4 , } cocci_id@p ;
