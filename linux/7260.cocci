...
position p;
@@
 struct intel_data {  struct sk_buff * rx_skb ;  struct sk_buff_head txq ;  struct work_struct busy_work ;  struct hci_uart * hu ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 struct intel_device * cocci_id@p ;
...
position p;
@@
 struct intel_device {  struct list_head list ;  struct platform_device * pdev ;  struct gpio_desc * reset ;  struct hci_uart * hu ;  struct mutex hu_lock ;  int irq ; } cocci_id@p ;
