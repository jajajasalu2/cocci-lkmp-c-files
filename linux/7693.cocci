...
position p;
@@
 void cocci_id@p ( struct uart_state * state , enum uart_pm_state pm_state ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_port * port ) ;
...
position p;
@@
 struct uart_match {  struct uart_port * port ;  struct uart_driver * driver ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct uart_port * , int ) ;
...
position p;
@@
 struct serial_iso7816 cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * tty , struct uart_state * state , struct ktermios * old_termios ) ;
