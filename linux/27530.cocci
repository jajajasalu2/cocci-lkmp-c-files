...
position p;
@@
 struct desc_seq_scan_data * cocci_id@p ;
...
position p;
@@
 struct anchorVolDescPtr * cocci_id@p ;
...
position p;
@@
 struct udf_vds_record cocci_id@p ;
...
position p;
@@
 struct domainEntityIDSuffix * cocci_id@p ;
...
position p;
@@
 struct kernel_lb_addr cocci_id@p ;
...
position p;
@@
 const struct volStructDesc * cocci_id@p ;
...
position p;
@@
 struct unallocSpaceEntry cocci_id@p ;
...
position p;
@@
 struct spaceBitmapDesc * cocci_id@p ;
...
position p;
@@
 struct partitionDesc * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kuid_t,kgid_t,umode_t;
@@
 struct udf_options {  unsigned char novrs ;  unsigned int blocksize ;  unsigned int session ;  unsigned int lastblock ;  unsigned int anchor ;  unsigned int flags ;  umode_t umask ;  kgid_t gid ;  kuid_t uid ;  umode_t fmode ;  umode_t dmode ;  struct nls_table * nls_map ; } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct super_block * ) ;
...
position p;
@@
 struct logicalVolIntegrityDesc cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * , int * , char * ) ;
...
position p;
@@
 struct logicalVolHeaderDesc * cocci_id@p ;
...
position p;
@@
 struct metadataPartitionMap * cocci_id@p ;
...
position p;
@@
 enum { Opt_novrs , Opt_nostrict , Opt_bs , Opt_unhide , Opt_undelete , Opt_noadinicb , Opt_adinicb , Opt_shortad , Opt_longad , Opt_gid , Opt_uid , Opt_umask , Opt_session , Opt_lastblock , Opt_anchor , Opt_volume , Opt_partition , Opt_fileset , Opt_rootdir , Opt_utf8 , Opt_iocharset , Opt_err , Opt_uforget , Opt_uignore , Opt_gforget , Opt_gignore , Opt_fmode , Opt_dmode , } cocci_id@p ;
...
position p;
@@
 struct udf_sparing_data * cocci_id@p ;
...
position p;
@@
 struct volStructDesc cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * , int ) ;
...
position p;
@@
 struct udf_inode_info cocci_id@p ;
...
position p;
@@
 struct partitionHeaderDesc * cocci_id@p ;
...
position p;
@@
 struct primaryVolDesc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct seq_file * , struct dentry * ) ;
...
position p;
@@
 void cocci_id@p ( struct super_block * , struct kernel_extent_ad ) ;
...
position p;
@@
 struct generic_desc * cocci_id@p ;
...
position p;
@@
 struct desc_seq_scan_data {  struct udf_vds_record vds [ VDS_POS_LENGTH ] ;  unsigned int size_part_descs ;  unsigned int num_part_descs ;  struct part_desc_seq_scan_data * part_descs_loc ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct super_block * ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * , void * , int ) ;
...
position p;
@@
 enum { UDF_MAX_LINKS = 0xffff , } cocci_id@p ;
...
position p;
@@
 struct sparablePartitionMap * cocci_id@p ;
...
position p;
@@
 struct logicalVolIntegrityDescImpUse cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dentry * , struct kstatfs * ) ;
...
position p;
@@
 struct udf_meta_data * cocci_id@p ;
...
position p;
@@
 struct udf_part_map * cocci_id@p ;
...
position p;
@@
 struct udfPartitionMap2 * cocci_id@p ;
...
typedef u32;
@@
 struct part_desc_seq_scan_data {  struct udf_vds_record rec ;  u32 partnum ; } cocci_id@p ;
...
position p;
@@
 struct genericPartitionMap * cocci_id@p ;
...
position p;
@@
 enum { VDS_POS_PRIMARY_VOL_DESC , VDS_POS_UNALLOC_SPACE_DESC , VDS_POS_LOGICAL_VOL_DESC , VDS_POS_IMP_USE_VOL_DESC , VDS_POS_LENGTH , } cocci_id@p ;
...
position p;
@@
 struct logicalVolDesc * cocci_id@p ;
...
position p;
@@
 struct part_desc_seq_scan_data * cocci_id@p ;
...
position p;
@@
 struct kernel_extent_ad cocci_id@p ;
...
position p;
@@
 struct virtualAllocationTable20 * cocci_id@p ;
...
position p;
@@
 struct genericPartitionMap1 * cocci_id@p ;
...
position p;
@@
 struct extent_position cocci_id@p ;
...
position p;
@@
 struct sparingTable * cocci_id@p ;
