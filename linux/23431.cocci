...
position p;
@@
 struct rt5645_eq_param_s cocci_id@p ;
...
position p;
@@
 struct rt5645_eq_param_s_be16 * cocci_id@p ;
...
position p;
@@
 struct rt5645_eq_param_s_be16 {  __be16 reg ;  __be16 val ; } cocci_id@p ;
...
position p;
@@
 struct rt5645_platform_data * cocci_id@p ;
...
position p;
@@
 const struct rt5645_platform_data cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , 
								  void * data ) ;
...
position p;
@@
 struct rt5645_eq_param_s {  unsigned short reg ;  unsigned short val ; } cocci_id@p ;
