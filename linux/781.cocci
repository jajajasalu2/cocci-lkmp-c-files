...
position p;
@@
 struct nwl_msi {  struct irq_domain * msi_domain ;  unsigned long * bitmap ;  struct irq_domain * dev_domain ;  struct mutex lock ;  int irq_msi0 ;  int irq_msi1 ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,phys_addr_t,raw_spinlock_t;
@@
 struct nwl_pcie {  struct device * dev ;  void __iomem * breg_base ;  void __iomem * pcireg_base ;  void __iomem * ecam_base ;  phys_addr_t phys_breg_base ;  phys_addr_t phys_pcie_reg_base ;  phys_addr_t phys_ecam_base ;  u32 breg_size ;  u32 pcie_reg_size ;  u32 ecam_size ;  int irq_intx ;  int irq_misc ;  u32 ecam_value ;  u8 last_busno ;  u8 root_busno ;  struct nwl_msi msi ;  struct irq_domain * legacy_irq_domain ;  raw_spinlock_t leg_mask_lock ; } cocci_id@p ;
