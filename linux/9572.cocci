...
position p;
@@
 struct rtw_coex_stat * cocci_id@p ;
...
position p;
@@
 struct rtw_dpk_info * cocci_id@p ;
...
typedef u32;
@@
 struct dpk_cfg_pair {  u32 addr ;  u32 bitmask ;  u32 data ; } cocci_id@p ;
...
typedef u8,bool;
@@
 void cocci_id@p ( struct rtw_dev * rtwdev , u8 tx_path , u8 rx_path , bool is_tx2_path ) ;
...
typedef u8;
@@
 u8 ( * cocci_id@p [ ] ) ( struct rtw_dev * rtwdev , struct rtw8822c_dpk_data * data ) ;
...
position p;
@@
 struct dpk_cfg_pair cocci_id@p ;
...
position p;
@@
 struct rtw_coex_rfe * cocci_id@p ;
...
position p;
@@
 struct rtw_pwr_seq_cmd cocci_id@p [ ] ;
...
position p;
@@
 struct rtw_iqk_para cocci_id@p ;
...
position p;
@@
 struct rtw_backup_info cocci_id@p [ DACK_RF_8822C * DACK_PATH_8822C ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ DPK_RF_PATH_NUM ] ;
...
position p;
@@
 struct rtw_chip_ops cocci_id@p ;
...
position p;
@@
 struct rtw_swing_table cocci_id@p ;
...
position p;
@@
 struct rtw_backup_info * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ RTW_PWR_TRK_TBL_SZ ] ;
...
position p;
@@
 struct rtw_intf_phy_para_table cocci_id@p ;
...
position p;
@@
 struct rtw_chip_info cocci_id@p ;
...
position p;
@@
 const struct coex_5g_afh_map cocci_id@p [ ] ;
...
position p;
@@
 struct rtw8822c_dpk_data cocci_id@p ;
...
position p;
@@
 struct rtw_backup_info cocci_id@p [ DACK_REG_8822C ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ DPK_RF_REG_NUM ] [ DPK_RF_PATH_NUM ] ;
...
position p;
@@
 struct rtw_rx_pkt_stat * cocci_id@p ;
...
position p;
@@
 const struct rtw_table * cocci_id@p ;
...
position p;
@@
 const struct rtw_rfe_def cocci_id@p [ ] ;
...
position p;
@@
 struct rtw8822c_efuse * cocci_id@p ;
...
position p;
@@
 struct rtw_intf_phy_para cocci_id@p [ ] ;
...
position p;
@@
 const struct dpk_cfg_pair * cocci_id@p ;
...
position p;
@@
 const struct rtw_pwr_track_tbl cocci_id@p ;
...
position p;
@@
 const struct coex_table_para cocci_id@p [ ] ;
...
typedef u8,bool;
@@
 struct rtw8822c_dpk_data {  u8 txbb ;  u8 pga ;  u8 limited_pga ;  u8 agc_cnt ;  bool loss_only ;  bool gain_only ;  u8 path ; } cocci_id@p ;
...
position p;
@@
 const struct coex_rf_para cocci_id@p [ ] ;
...
position p;
@@
 struct rtw_page_table cocci_id@p [ ] ;
...
position p;
@@
 struct rtw_backup_info cocci_id@p [ DPK_BB_REG_NUM ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ RTW_PWR_TRK_5G_NUM ] [ RTW_PWR_TRK_TBL_SZ ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ DPK_RF_PATH_NUM ] ;
...
position p;
@@
 const struct rtw_phy_cck_pd_reg cocci_id@p [ RTW_CHANNEL_WIDTH_40 + 1 ] [ RTW_RF_PATH_MAX ] ;
...
position p;
@@
 const struct coex_tdma_para cocci_id@p [ ] ;
