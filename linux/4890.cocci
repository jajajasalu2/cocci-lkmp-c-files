...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_xrq_in ) ] ;
...
position p;
@@
 struct mlx5_srq_table cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( arm_rq_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_srq_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_xrc_srq_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_xrc_srq_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_xrc_srq_out ) ] ;
...
position p;
@@
 struct mlx5_srq_attr * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_srq_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_xrq_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( arm_xrc_srq_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_xrq_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_srq_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_xrq_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( arm_rq_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_xrc_srq_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_rmp_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( arm_xrc_srq_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_rmp_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_srq_out ) ] ;
