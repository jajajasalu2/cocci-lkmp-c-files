...
position p;
@@
 void cocci_id@p ( struct mon_bus * mbus ) ;
...
position p;
@@
 void cocci_id@p ( struct usb_bus * ubus ) ;
...
position p;
@@
 void cocci_id@p ( struct mon_bus * mbus , struct usb_bus * ubus ) ;
