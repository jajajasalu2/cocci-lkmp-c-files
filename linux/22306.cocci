...
position p;
@@
 const struct tomoyo_path_number_acl * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_mount_acl * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_path_acl * cocci_id@p ;
...
position p;
@@
 struct tomoyo_obj_info cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ TOMOYO_MAX_PATH_OPERATION ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ TOMOYO_MAX_MKDEV_OPERATION ] ;
...
position p;
@@
 const struct tomoyo_mkdev_acl * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ TOMOYO_MAX_PATH_NUMBER_OPERATION ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ TOMOYO_MAX_PATH2_OPERATION ] ;
...
position p;
@@
 const struct tomoyo_path2_acl * cocci_id@p ;
