...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct cros_ec_command ) + sizeof ( ec_dev -> event_data . data ) ] ;
...
position p;
@@
 struct ec_response_get_comms_status * cocci_id@p ;
...
position p;
@@
 struct ec_params_get_cmd_versions * cocci_id@p ;
...
position p;
@@
 struct ec_response_hello * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct cros_ec_device * ec , struct cros_ec_command * msg ) ;
...
position p;
@@
 struct ec_response_get_next_event cocci_id@p ;
...
position p;
@@
 struct ec_response_get_next_event_v1 * cocci_id@p ;
...
position p;
@@
 struct ec_params_hello * cocci_id@p ;
...
position p;
@@
 struct ec_params_motion_sense * cocci_id@p ;
...
position p;
@@
 struct ec_response_host_event_mask * cocci_id@p ;
...
position p;
@@
 struct ec_response_get_cmd_versions * cocci_id@p ;
...
position p;
@@
 struct ec_response_motion_sense * cocci_id@p ;
