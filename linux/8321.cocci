...
position p;
@@
 enum desc_state { AVE_DESC_RX_PERMIT , AVE_DESC_RX_SUSPEND , AVE_DESC_START , AVE_DESC_STOP , } cocci_id@p ;
...
position p;
@@
 enum desc_id { AVE_DESCID_RX , AVE_DESCID_TX , } cocci_id@p ;
...
typedef u32;
@@
 struct ave_desc_info {  u32 ndesc ;  u32 daddr ;  u32 proc_idx ;  u32 done_idx ;  struct ave_desc * desc ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct ave_desc {  struct sk_buff * skbs ;  dma_addr_t skbs_dma ;  size_t skbs_dmalen ; } cocci_id@p ;
...
position p;
@@
 const struct ave_soc_data cocci_id@p ;
...
typedef u64;
@@
 struct ave_stats {  struct u64_stats_sync syncp ;  u64 packets ;  u64 bytes ;  u64 errors ;  u64 dropped ;  u64 collisions ;  u64 fifo_errors ; } cocci_id@p ;
