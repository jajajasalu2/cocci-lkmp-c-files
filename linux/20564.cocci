...
position p;
@@
 struct quark_security_header * cocci_id@p ;
...
position p;
@@
 typeof ( quirk_handler ) cocci_id@p ;
...
position p;
@@
 struct efi_setup_data * cocci_id@p ;
...
typedef u32;
@@
 struct quark_security_header {  u32 csh_signature ;  u32 version ;  u32 modulesize ;  u32 security_version_number_index ;  u32 security_version_number ;  u32 rsvd_module_id ;  u32 rsvd_module_vendor ;  u32 rsvd_date ;  u32 headersize ;  u32 hash_algo ;  u32 cryp_algo ;  u32 keysize ;  u32 signaturesize ;  u32 rsvd_next_header ;  u32 rsvd [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct efi_mem_range cocci_id@p ;
...
position p;
@@
 struct capsule_info * cocci_id@p ;
