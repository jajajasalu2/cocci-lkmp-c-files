...
typedef u8;
@@
 u8 cocci_id@p [ 2 ] [ AES_BLOCK_SIZE ] ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 * out , const u8 * in , u32 * key_enc , u32 rounds , u32 bytes , u8 * iv ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ 3 ] [ AES_BLOCK_SIZE ] ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 * out , const u8 * in , u32 * key_dec , u32 rounds , u32 bytes ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 * out , const u8 * in , u32 * key_dec , u32 rounds , u32 bytes , u8 * iv , u32 * key_twk ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 * out , const u8 * in , u32 * key_enc , u32 rounds , u32 bytes , u8 * iv , u32 * key_twk ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u32 * key_enc , const u8 * key ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 * out , const u8 * in , u32 * key_dec , u32 rounds ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 * out , const u8 * in , u32 * key_enc , u32 rounds , u32 bytes ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 * out , const u8 * in , u32 * key_enc , u32 rounds ) ;
...
typedef u32;
@@
 void cocci_id@p ( u32 * key_dec , u32 * key_enc , unsigned int key_len ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 * out , const u8 * in , u32 * key_dec , u32 rounds , u32 bytes , u8 * iv ) ;
...
typedef u32;
@@
 struct ppc_aes_ctx {  u32 key_enc [ AES_MAX_KEYLENGTH_U32 ] ;  u32 key_dec [ AES_MAX_KEYLENGTH_U32 ] ;  u32 rounds ; } cocci_id@p ;
...
typedef u32;
@@
 struct ppc_xts_ctx {  u32 key_enc [ AES_MAX_KEYLENGTH_U32 ] ;  u32 key_dec [ AES_MAX_KEYLENGTH_U32 ] ;  u32 key_twk [ AES_MAX_KEYLENGTH_U32 ] ;  u32 rounds ; } cocci_id@p ;
