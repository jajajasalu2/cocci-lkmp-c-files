...
typedef bool;
@@
 struct pxa_spi_info {  enum pxa_ssp_type type ;  int port_id ;  int num_chipselect ;  unsigned long max_clk_rate ;  bool ( * dma_filter ) ( struct dma_chan * chan , void * param ) ;  void * tx_param ;  void * rx_param ;  int dma_burst_size ;  int ( * setup ) ( struct pci_dev * pdev , struct pxa_spi_info * c ) ; } cocci_id@p ;
...
position p;
@@
 enum { PORT_QUARK_X1000 , PORT_BYT , PORT_MRFLD , PORT_BSW0 , PORT_BSW1 , PORT_BSW2 , PORT_CE4100 , PORT_LPT , } cocci_id@p ;
...
position p;
@@
 struct pxa_spi_info cocci_id@p [ ] ;
