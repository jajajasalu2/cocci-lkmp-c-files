...
symbol cocci_id;
position p;
typedef i915_sw_fence_notify_t;
@@
 i915_sw_fence_notify_t cocci_id@p ;
...
position p;
@@
 struct i915_sw_dma_fence_cb_timer cocci_id@p ;
...
position p;
@@
 const struct i915_sw_fence * const cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dma_fence_func_t;
@@
 dma_fence_func_t cocci_id@p ;
...
position p;
@@
 struct i915_sw_dma_fence_cb * cocci_id@p ;
...
position p;
@@
 enum { DEBUG_FENCE_IDLE = 0 , DEBUG_FENCE_NOTIFY , } cocci_id@p ;
...
position p;
@@
 struct i915_sw_dma_fence_cb_timer {  struct i915_sw_dma_fence_cb base ;  struct dma_fence * dma ;  struct timer_list timer ;  struct irq_work work ;  struct rcu_head rcu ; } cocci_id@p ;
