...
@@
 struct pmb_entry {  unsigned long vpn ;  unsigned long ppn ;  unsigned long flags ;  unsigned long size ;  raw_spinlock_t lock ;  int entry ;  struct pmb_entry * link ; } cocci_id@p ;
...
position p;
@@
 struct pmb_entry cocci_id@p [ NR_PMB_ENTRIES ] ;
...
position p;
@@
 struct {  unsigned long size ;  int flag ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct pmb_entry * , int depth ) ;
