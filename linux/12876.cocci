...
position p;
@@
 struct i3200_error_info cocci_id@p ;
...
typedef u64,u16;
@@
 struct i3200_error_info {  u16 errsts ;  u16 errsts2 ;  u64 eccerrlog [ I3200_CHANNELS ] ; } cocci_id@p ;
...
position p;
@@
 struct i3200_dev_info {  const char * ctl_name ; } cocci_id@p ;
...
position p;
@@
 enum i3200_chips { I3200 = 0 , } cocci_id@p ;
...
position p;
@@
 const struct i3200_dev_info cocci_id@p [ ] ;
...
position p;
@@
 struct i3200_priv {  void __iomem * window ; } cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ I3200_CHANNELS ] [ I3200_RANKS_PER_CHANNEL ] ;
