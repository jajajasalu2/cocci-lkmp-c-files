...
position p;
@@
 void cocci_id@p ( struct nbu2ss_ep * , struct nbu2ss_req * , int ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct nbu2ss_udc * , u32 mode ) ;
...
position p;
@@
 union usb_reg_access * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct nbu2ss_udc * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct nbu2ss_udc * , struct nbu2ss_ep * ) ;
...
position p;
@@
 const struct {  const char * name ;  const struct usb_ep_caps caps ; } cocci_id@p [ NUM_ENDPOINTS ] ;
...
typedef u8;
@@
 void cocci_id@p ( struct nbu2ss_udc * udc , u8 ep_adrs ) ;
...
position p;
@@
 void cocci_id@p ( struct nbu2ss_udc * ) ;
