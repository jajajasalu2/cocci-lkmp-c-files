...
position p;
@@
 struct st21nfca_i2c_phy * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ST21NFCA_HCI_LLC_MAX_SIZE ] ;
...
position p;
@@
 struct st21nfca_i2c_phy {  struct i2c_client * i2c_dev ;  struct nfc_hci_dev * hdev ;  struct gpio_desc * gpiod_ena ;  struct st21nfca_se_status se_status ;  struct sk_buff * pending_skb ;  int current_read_len ;  int crc_trials ;  int powered ;  int run_mode ;  int hard_fault ;  struct mutex phy_lock ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ST21NFCA_HCI_LLC_MAX_SIZE * 2 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ ST21NFCA_HCI_LLC_MAX_PAYLOAD ] ;
