...
typedef u64,bool;
@@
 struct pg_state {  struct seq_file * seq ;  const struct addr_marker * marker ;  unsigned long start_address ;  unsigned level ;  u64 current_prot ;  bool check_wx ;  unsigned long wx_pages ;  const char * current_domain ; } cocci_id@p ;
...
position p;
@@
 const struct prot_bits cocci_id@p [ ] ;
...
typedef u64,bool;
@@
 struct prot_bits {  u64 mask ;  u64 val ;  const char * set ;  const char * clear ;  bool ro_bit ;  bool nx_bit ; } cocci_id@p ;
...
typedef u64;
@@
 struct pg_level {  const struct prot_bits * bits ;  size_t num ;  u64 mask ;  const struct prot_bits * ro_bit ;  const struct prot_bits * nx_bit ; } cocci_id@p ;
