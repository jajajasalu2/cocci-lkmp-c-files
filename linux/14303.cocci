...
position p;
@@
 struct dib0070_state * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct dib0070_tuning {  u32 max_freq ;  u8 switch_trim ;  u8 vco_band ;  u8 hfdiv ;  u8 vco_multi ;  u8 presc ;  u8 wbdmux ;  u16 tuner_enable ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct dib0070_lna_match {  u32 max_freq ;  u8 lna_band ; } cocci_id@p ;
...
@@
 struct dib0070_state {  struct i2c_adapter * i2c ;  struct dvb_frontend * fe ;  const struct dib0070_config * cfg ;  u16 wbd_ff_offset ;  u8 revision ;  enum frontend_tune_state tune_state ;  u32 current_rf ;  s8 step ;  u16 adc_diff ;  s8 captrim ;  s8 fcaptrim ;  u16 lo4 ;  const struct dib0070_tuning * current_tune_table_index ;  const struct dib0070_lna_match * lna_match ;  u8 wbd_gain_current ;  u16 wbd_offset_3_3 [ 2 ] ;  struct i2c_msg msg [ 2 ] ;  u8 i2c_write_buffer [ 3 ] ;  u8 i2c_read_buffer [ 2 ] ;  struct mutex i2c_buffer_lock ; } cocci_id@p ;
...
position p;
@@
 const struct dib0070_tuning * cocci_id@p ;
...
position p;
@@
 const struct dib0070_lna_match cocci_id@p [ ] ;
