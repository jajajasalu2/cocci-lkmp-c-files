...
typedef atomic_t;
@@
 struct meta_anchor {  int mp_count ;  atomic_t io_count ;  struct metapage * mp [ MPS_PER_PAGE ] ; } cocci_id@p ;
...
position p;
@@
 struct {  uint pagealloc ;  uint pagefree ;  uint lockwait ; } cocci_id@p ;
