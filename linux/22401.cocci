...
position p;
@@
 struct snd_bt87x_board cocci_id@p [ ] ;
...
position p;
@@
 enum snd_bt87x_boardid { SND_BT87X_BOARD_UNKNOWN , SND_BT87X_BOARD_GENERIC , SND_BT87X_BOARD_ANALOG , SND_BT87X_BOARD_OSPREY2x0 , SND_BT87X_BOARD_OSPREY440 , SND_BT87X_BOARD_AVPHONE98 , } cocci_id@p ;
...
position p;
@@
 enum snd_bt87x_boardid cocci_id@p ;
...
typedef u32;
@@
 struct snd_bt87x_board {  int dig_rate ;  u32 digital_fmt ;  unsigned no_analog : 1 ;  unsigned no_digital : 1 ; } cocci_id@p ;
...
position p;
@@
 enum { DEVICE_DIGITAL , DEVICE_ANALOG , } cocci_id@p ;
...
position p;
@@
 struct {  unsigned short subvendor , subdevice ; } cocci_id@p [ ] ;
