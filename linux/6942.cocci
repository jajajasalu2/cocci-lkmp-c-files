...
position p;
@@
 enum { CMD_READY = 0x01 , FIFO_READY = 0x02 , REG_DATA = 0x04 , DMA_DATA = 0x08 , } cocci_id@p ;
...
position p;
@@
 struct jmb38x_ms_host cocci_id@p ;
...
position p;
@@
 struct jmb38x_ms {  struct pci_dev * pdev ;  int host_cnt ;  struct memstick_host * hosts [ ] ; } cocci_id@p ;
