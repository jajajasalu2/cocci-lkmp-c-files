...
position p;
@@
 struct tracing_map_field * cocci_id@p ;
...
position p;
@@
 struct tracing_map_array * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const void * , const void * ) ;
...
position p;
@@
 const struct tracing_map_sort_entry * * cocci_id@p ;
...
position p;
@@
 const struct tracing_map_elt * cocci_id@p ;
...
position p;
@@
 struct tracing_map_entry cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const struct tracing_map_sort_entry * * , const struct tracing_map_sort_entry * * ) ;
