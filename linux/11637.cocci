...
position p;
@@
 struct gt215_clk_info cocci_id@p ;
...
position p;
@@
 struct gt215_ramfuc * cocci_id@p ;
...
typedef u32;
@@
 struct gt215_ltrain {  enum { NVA3_TRAIN_UNKNOWN , NVA3_TRAIN_UNSUPPORTED , NVA3_TRAIN_ONCE , NVA3_TRAIN_EXEC , NVA3_TRAIN_DONE , } state ;  u32 r_100720 ;  u32 r_1111e0 ;  u32 r_111400 ;  struct nvkm_memory * memory ; } cocci_id@p ;
...
position p;
@@
 struct gt215_ram {  struct nvkm_ram base ;  struct gt215_ramfuc fuc ;  struct gt215_ltrain ltrain ; } cocci_id@p ;
...
position p;
@@
 struct gt215_ltrain * cocci_id@p ;
...
position p;
@@
 struct nvbios_M0205T cocci_id@p ;
