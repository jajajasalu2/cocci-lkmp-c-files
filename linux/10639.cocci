...
position p;
@@
 struct mmio_diff_param {  struct intel_vgpu * vgpu ;  int total ;  int diff ;  struct list_head diff_mmio_list ; } cocci_id@p ;
...
position p;
@@
 struct mmio_diff_param * cocci_id@p ;
...
typedef u32;
@@
 struct diff_mmio {  struct list_head node ;  u32 offset ;  u32 preg ;  u32 vreg ; } cocci_id@p ;
