...
symbol cocci_id;
position p;
typedef utrap_entry_t;
@@
 utrap_entry_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef utrap_handler_t;
@@
 utrap_handler_t * cocci_id@p ;
