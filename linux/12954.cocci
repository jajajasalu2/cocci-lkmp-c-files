...
position p;
@@
 const struct xvcu_pll_cfg * cocci_id@p ;
...
typedef u32;
@@
 struct xvcu_pll_cfg {  u32 fbdiv ;  u32 cp ;  u32 res ;  u32 lfhf ;  u32 lock_dly ;  u32 lock_cnt ; } cocci_id@p ;
...
typedef u32;
@@
 struct xvcu_device {  struct device * dev ;  struct clk * pll_ref ;  struct clk * aclk ;  void __iomem * logicore_reg_ba ;  void __iomem * vcu_slcr_ba ;  u32 coreclk ; } cocci_id@p ;
