...
position p;
@@
 struct control_regs cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_info_control * p ) ;
...
position p;
@@
 void cocci_id@p ( struct fb_par_control * par , struct fb_var_screeninfo * var ) ;
...
position p;
@@
 void cocci_id@p ( unsigned char * params ) ;
...
position p;
@@
 void cocci_id@p ( struct fb_info_control * p , struct fb_par_control * par ) ;
...
position p;
@@
 struct fb_par_control cocci_id@p ;
...
position p;
@@
 struct fb_par_control {  int vmode , cmode ;  int xres , yres ;  int vxres , vyres ;  int xoffset , yoffset ;  int pitch ;  struct control_regvals regvals ;  unsigned long sync ;  unsigned char ctrl ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fb_info_control * p ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long clk , unsigned char * param ) ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * info , struct fb_info_control * p ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , struct fb_par_control * par , const struct fb_info * fb_info ) ;
...
position p;
@@
 struct control_regvals * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int blank_mode , struct fb_info * info ) ;
...
position p;
@@
 struct fb_info_control * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct device_node * dp ) ;
...
position p;
@@
 struct control_regints * cocci_id@p ;
...
typedef u32,__u8;
@@
 struct fb_info_control {  struct fb_info info ;  struct fb_par_control par ;  u32 pseudo_palette [ 16 ] ;  struct cmap_regs __iomem * cmap_regs ;  unsigned long cmap_regs_phys ;  struct control_regs __iomem * control_regs ;  unsigned long control_regs_phys ;  unsigned long control_regs_size ;  __u8 __iomem * frame_buffer ;  unsigned long frame_buffer_phys ;  unsigned long fb_orig_base ;  unsigned long fb_orig_size ;  int control_use_bank2 ;  unsigned long total_vram ;  unsigned char vram_attr ; } cocci_id@p ;
