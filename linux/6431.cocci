...
position p;
@@
 struct tps6507x_pmic {  struct regulator_desc desc [ TPS6507X_NUM_REGULATOR ] ;  struct tps6507x_dev * mfd ;  struct tps_info * info [ TPS6507X_NUM_REGULATOR ] ;  struct mutex io_lock ; } cocci_id@p ;
...
position p;
@@
 struct tps6507x_dev * cocci_id@p ;
...
typedef u8,bool;
@@
 struct tps_info {  const char * name ;  u8 table_len ;  const unsigned int * table ;  bool defdcdc_default ; } cocci_id@p ;
...
position p;
@@
 struct tps6507x_pmic * cocci_id@p ;
