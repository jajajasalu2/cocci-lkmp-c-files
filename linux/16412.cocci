...
typedef u32;
@@
 struct synthhid_msg_hdr {  enum synthhid_msg_type type ;  u32 size ; } cocci_id@p ;
...
typedef u32;
@@
 struct pipe_prt_msg {  enum pipe_prot_msg_type type ;  u32 size ;  char data [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct hv_input_dev_info cocci_id@p ;
...
typedef u32,u16;
@@
 union synthhid_version {  struct {  u16 minor_version ;  u16 major_version ; } ;  u32 version ; } cocci_id@p ;
...
position p;
@@
 struct synthhid_input_report {  struct synthhid_msg_hdr header ;  char buffer [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct synthhid_msg {  struct synthhid_msg_hdr header ;  char data [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct mousevsc_prt_msg cocci_id@p ;
...
position p;
@@
 struct synthhid_protocol_request cocci_id@p ;
...
position p;
@@
 struct synthhid_device_info_ack {  struct synthhid_msg_hdr header ;  unsigned char reserved ; } cocci_id@p ;
...
position p;
@@
 struct synthhid_input_report * cocci_id@p ;
...
position p;
@@
 struct synthhid_device_info {  struct synthhid_msg_hdr header ;  struct hv_input_dev_info hid_dev_info ;  struct hid_descriptor hid_descriptor ; } cocci_id@p ;
...
position p;
@@
 struct synthhid_protocol_request {  struct synthhid_msg_hdr header ;  union synthhid_version version_requested ; } cocci_id@p ;
...
position p;
@@
 struct synthhid_device_info * cocci_id@p ;
...
position p;
@@
 enum pipe_prot_msg_type { PIPE_MESSAGE_INVALID , PIPE_MESSAGE_DATA , PIPE_MESSAGE_MAXIMUM , } cocci_id@p ;
...
position p;
@@
 struct synthhid_device_info_ack cocci_id@p ;
...
position p;
@@
 struct hid_ll_driver cocci_id@p ;
...
position p;
@@
 enum synthhid_msg_type { SYNTH_HID_PROTOCOL_REQUEST , SYNTH_HID_PROTOCOL_RESPONSE , SYNTH_HID_INITIAL_DEVICE_INFO , SYNTH_HID_INITIAL_DEVICE_INFO_ACK , SYNTH_HID_INPUT_REPORT , SYNTH_HID_MAX , } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct mousevsc_dev {  struct hv_device * device ;  bool init_complete ;  bool connected ;  struct mousevsc_prt_msg protocol_req ;  struct mousevsc_prt_msg protocol_resp ;  struct completion wait_event ;  int dev_info_status ;  struct hid_descriptor * hid_desc ;  unsigned char * report_desc ;  u32 report_desc_size ;  struct hv_input_dev_info hid_dev_info ;  struct hid_device * hid_device ;  u8 input_buf [ HID_MAX_BUFFER_SIZE ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct mousevsc_prt_msg {  enum pipe_prot_msg_type type ;  u32 size ;  union {  struct synthhid_protocol_request request ;  struct synthhid_protocol_response response ;  struct synthhid_device_info_ack ack ; } ; } cocci_id@p ;
...
position p;
@@
 struct pipe_prt_msg cocci_id@p ;
...
position p;
@@
 struct mousevsc_dev cocci_id@p ;
...
position p;
@@
 struct synthhid_msg * cocci_id@p ;
...
position p;
@@
 struct hv_input_dev_info {  unsigned int size ;  unsigned short vendor ;  unsigned short product ;  unsigned short version ;  unsigned short reserved [ 11 ] ; } cocci_id@p ;
...
position p;
@@
 struct synthhid_protocol_response {  struct synthhid_msg_hdr header ;  union synthhid_version version_requested ;  unsigned char approved ; } cocci_id@p ;
