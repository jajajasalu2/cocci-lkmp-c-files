...
position p;
@@
 struct adf_user_cfg_section cocci_id@p ;
...
position p;
@@
 struct adf_hw_device_data * cocci_id@p ;
...
position p;
@@
 const struct adf_user_cfg_key_val * cocci_id@p ;
...
position p;
@@
 struct adf_ctl_drv_info {  unsigned int major ;  struct cdev drv_cdev ;  struct class * drv_class ; } cocci_id@p ;
...
position p;
@@
 struct adf_user_cfg_ctl_data * cocci_id@p ;
...
position p;
@@
 struct adf_user_cfg_key_val cocci_id@p ;
...
position p;
@@
 struct adf_ctl_drv_info cocci_id@p ;
...
position p;
@@
 struct adf_dev_status_info cocci_id@p ;
...
position p;
@@
 struct adf_accel_dev * cocci_id@p ;
