...
typedef u64,u32;
@@
 void cocci_id@p ( const u64 * key , const u32 * input , u32 * output , unsigned int key_len ) ;
...
typedef u64;
@@
 void cocci_id@p ( const u64 * key , unsigned int key_len ) ;
...
typedef u64;
@@
 void cocci_id@p ( const u64 * input , u64 * output , unsigned int len , const u64 * key , u64 * iv ) ;
...
position p;
@@
 struct camellia_sparc64_ctx * cocci_id@p ;
...
typedef u64,u32;
@@
 void cocci_id@p ( const u32 * in_key , u64 * encrypt_key , unsigned int key_len , u64 * decrypt_key ) ;
...
typedef u64;
@@
 void cocci_id@p ( const u64 * input , u64 * output , unsigned int len , const u64 * key ) ;
...
position p;
@@
 const struct camellia_sparc64_ctx * cocci_id@p ;
...
typedef u64;
@@
 struct camellia_sparc64_ctx {  u64 encrypt_key [ CAMELLIA_TABLE_BYTE_LEN / sizeof ( u64 ) ] ;  u64 decrypt_key [ CAMELLIA_TABLE_BYTE_LEN / sizeof ( u64 ) ] ;  int key_len ; } cocci_id@p ;
