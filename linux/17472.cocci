...
position p;
@@
 struct rtas_fadump_reg_entry * cocci_id@p ;
...
position p;
@@
 struct rtas_fadump_mem_struct cocci_id@p ;
...
position p;
@@
 struct rtas_fadump_reg_save_area_header * cocci_id@p ;
...
position p;
@@
 const struct rtas_fadump_section * cocci_id@p ;
...
position p;
@@
 const struct rtas_fadump_mem_struct * cocci_id@p ;
