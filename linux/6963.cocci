...
position p;
@@
 struct omap_mbox_device cocci_id@p ;
...
position p;
@@
 const struct omap_mbox_match_data cocci_id@p ;
...
typedef bool;
@@
 struct omap_mbox_fifo_info {  int tx_id ;  int tx_usr ;  int tx_irq ;  int rx_id ;  int rx_usr ;  int rx_irq ;  const char * name ;  bool send_no_irq ; } cocci_id@p ;
...
typedef u32;
@@
 struct omap_mbox_match_data {  u32 intr_type ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct omap_mbox {  const char * name ;  int irq ;  struct omap_mbox_queue * rxq ;  struct device * dev ;  struct omap_mbox_device * parent ;  struct omap_mbox_fifo tx_fifo ;  struct omap_mbox_fifo rx_fifo ;  u32 intr_type ;  struct mbox_chan * chan ;  bool send_no_irq ; } cocci_id@p ;
...
typedef u32;
@@
 struct omap_mbox_fifo {  unsigned long msg ;  unsigned long fifo_stat ;  unsigned long msg_stat ;  unsigned long irqenable ;  unsigned long irqstatus ;  unsigned long irqdisable ;  u32 intr_bit ; } cocci_id@p ;
...
position p;
@@
 struct omap_mbox_queue cocci_id@p ;
...
symbol cocci_id;
position p;
typedef omap_mbox_irq_t;
@@
 omap_mbox_irq_t cocci_id@p ;
...
typedef u32;
@@
 struct omap_mbox_device {  struct device * dev ;  struct mutex cfg_lock ;  void __iomem * mbox_base ;  u32 * irq_ctx ;  u32 num_users ;  u32 num_fifos ;  u32 intr_type ;  struct omap_mbox * * mboxes ;  struct mbox_controller controller ;  struct list_head elem ; } cocci_id@p ;
...
position p;
@@
 struct omap_mbox_fifo * cocci_id@p ;
...
position p;
@@
 struct omap_mbox_fifo_info * cocci_id@p ;
...
@@
 struct omap_mbox_queue {  spinlock_t lock ;  struct kfifo fifo ;  struct work_struct work ;  struct omap_mbox * mbox ;  bool full ; } cocci_id@p ;
