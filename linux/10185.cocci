...
typedef u_int;
@@
 struct _hfc_map {  u_int subtype ;  u_int flag ;  char * name ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_int,u_char,u_long,spinlock_t;
@@
 struct hfc_pci {  u_char subtype ;  u_char chanlimit ;  u_char initdone ;  u_long cfg ;  u_int irq ;  u_int irqcnt ;  struct pci_dev * pdev ;  struct hfcPCI_hw hw ;  spinlock_t lock ;  struct dchannel dch ;  struct bchannel bch [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct mISDNchannel * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MISDN_MAX_IDLEN ] ;
...
position p;
@@
 struct mISDN_ctrl_req * cocci_id@p ;
...
position p;
@@
 const struct _hfc_map cocci_id@p [ ] ;
...
position p;
@@
 enum { HFC_CCD_2BD0 , HFC_CCD_B000 , HFC_CCD_B006 , HFC_CCD_B007 , HFC_CCD_B008 , HFC_CCD_B009 , HFC_CCD_B00A , HFC_CCD_B00B , HFC_CCD_B00C , HFC_CCD_B100 , HFC_CCD_B700 , HFC_CCD_B701 , HFC_ASUS_0675 , HFC_BERKOM_A1T , HFC_BERKOM_TCONCEPT , HFC_ANIGMA_MC145575 , HFC_ZOLTRIX_2BD0 , HFC_DIGI_DF_M_IOM2_E , HFC_DIGI_DF_M_E , HFC_DIGI_DF_M_IOM2_A , HFC_DIGI_DF_M_A , HFC_ABOCOM_2BD1 , HFC_SITECOM_DC105V2 , } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct hfcPCI_hw {  unsigned char cirm ;  unsigned char ctmt ;  unsigned char clkdel ;  unsigned char states ;  unsigned char conn ;  unsigned char mst_m ;  unsigned char int_m1 ;  unsigned char int_m2 ;  unsigned char sctrl ;  unsigned char sctrl_r ;  unsigned char sctrl_e ;  unsigned char trm ;  unsigned char fifo_en ;  unsigned char bswapped ;  unsigned char protocol ;  int nt_timer ;  unsigned char __iomem * pci_io ;  dma_addr_t dmahandle ;  void * fifos ;  int last_bfifo_cnt [ 2 ] ;  struct timer_list timer ; } cocci_id@p ;
