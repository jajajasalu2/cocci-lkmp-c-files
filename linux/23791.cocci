...
position p;
@@
 struct netlbl_domaddr_map * cocci_id@p ;
...
position p;
@@
 struct netlbl_domaddr4_map * cocci_id@p ;
...
position p;
@@
 struct netlbl_dommap_def * cocci_id@p ;
...
position p;
@@
 NETLBL_CATMAP_MAPTYPE cocci_id@p ;
...
position p;
@@
 struct netlbl_domaddr6_map * cocci_id@p ;
