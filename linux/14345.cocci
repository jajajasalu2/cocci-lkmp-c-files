...
position p;
@@
 const struct isl6423_config * cocci_id@p ;
...
typedef u8;
@@
 struct isl6423_dev {  const struct isl6423_config * config ;  struct i2c_adapter * i2c ;  u8 reg_3 ;  u8 reg_4 ;  unsigned int verbose ; } cocci_id@p ;
