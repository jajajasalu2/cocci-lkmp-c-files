...
position p;
@@
 const enum led_brightness cocci_id@p [ ] ;
...
position p;
@@
 struct system76_data {  struct acpi_device * acpi_dev ;  struct led_classdev ap_led ;  struct led_classdev kb_led ;  enum led_brightness kb_brightness ;  enum led_brightness kb_toggle_brightness ;  int kb_color ; } cocci_id@p ;
...
position p;
@@
 struct system76_data * cocci_id@p ;
