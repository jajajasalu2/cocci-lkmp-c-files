...
typedef bool;
@@
 int cocci_id@p ( struct socket * , struct socket * , int , bool ) ;
...
position p;
@@
 int cocci_id@p ( struct socket * sock , unsigned int cmd , unsigned long arg ) ;
...
position p;
@@
 struct unix_stream_read_state {  int ( * recv_actor ) ( struct sk_buff * , int , int , struct unix_stream_read_state * ) ;  struct socket * socket ;  struct msghdr * msg ;  struct pipe_inode_info * pipe ;  size_t size ;  int flags ;  unsigned int splice_flags ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct socket * , int ) ;
...
position p;
@@
 int cocci_id@p ( struct socket * , struct sockaddr * , int ) ;
...
position p;
@@
 struct hlist_head cocci_id@p [ 2 * UNIX_HASH_SIZE ] ;
...
position p;
@@
 int cocci_id@p ( struct socket * , struct sockaddr * , int , int ) ;
...
position p;
@@
 int cocci_id@p ( struct socket * , struct socket * ) ;
...
position p;
@@
 int cocci_id@p ( struct socket * , struct sockaddr * , int addr_len , int flags ) ;
...
position p;
@@
 int cocci_id@p ( struct socket * , unsigned int , unsigned long ) ;
...
position p;
@@
 struct unix_address * cocci_id@p ;
...
position p;
@@
 struct unix_stream_read_state * cocci_id@p ;
...
position p;
@@
 const struct unix_skb_parms * cocci_id@p ;
...
position p;
@@
 struct unix_skb_parms cocci_id@p ;
