...
position p;
@@
 struct nfcmrvl_platform_data cocci_id@p ;
...
position p;
@@
 struct nfcmrvl_if_ops cocci_id@p ;
...
position p;
@@
 struct nfcmrvl_spi_drv_data * cocci_id@p ;
...
position p;
@@
 const struct nfcmrvl_fw_spi_config * cocci_id@p ;
...
position p;
@@
 struct nfcmrvl_spi_drv_data {  unsigned long flags ;  struct spi_device * spi ;  struct nci_spi * nci_spi ;  struct completion handshake_completion ;  struct nfcmrvl_private * priv ; } cocci_id@p ;
