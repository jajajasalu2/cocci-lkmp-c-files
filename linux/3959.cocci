...
typedef bool,u32;
@@
 struct reset_simple_devdata {  u32 reg_offset ;  u32 nr_resets ;  bool active_low ;  bool status_active_low ; } cocci_id@p ;
...
position p;
@@
 const struct reset_simple_devdata cocci_id@p ;
...
position p;
@@
 struct reset_simple_data cocci_id@p ;
