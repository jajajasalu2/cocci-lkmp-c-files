...
position p;
@@
 struct mchp23k256_flash {  struct spi_device * spi ;  struct mutex lock ;  struct mtd_info mtd ;  const struct mchp23_caps * caps ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_CMD_SIZE ] ;
...
typedef u8;
@@
 struct mchp23_caps {  u8 addr_width ;  unsigned int size ; } cocci_id@p ;
...
position p;
@@
 struct mchp23k256_flash * cocci_id@p ;
...
position p;
@@
 const struct mchp23_caps cocci_id@p ;
