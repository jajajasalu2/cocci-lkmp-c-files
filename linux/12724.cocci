...
position p;
@@
 const struct sysmmu_fault_info cocci_id@p [ ] ;
...
position p;
@@
 struct exynos_iommu_owner * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sysmmu_pte_t;
@@
 const sysmmu_pte_t * cocci_id@p ;
...
position p;
@@
 struct sysmmu_drvdata * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,phys_addr_t,spinlock_t;
@@
 struct sysmmu_drvdata {  struct device * sysmmu ;  struct device * master ;  struct device_link * link ;  void __iomem * sfrbase ;  struct clk * clk ;  struct clk * aclk ;  struct clk * pclk ;  struct clk * clk_master ;  spinlock_t lock ;  bool active ;  struct exynos_iommu_domain * domain ;  struct list_head domain_node ;  struct list_head owner_node ;  phys_addr_t pgtable ;  unsigned int version ;  struct iommu_device iommu ; } cocci_id@p ;
...
position p;
@@
 struct exynos_iommu_owner {  struct list_head controllers ;  struct iommu_domain * domain ;  struct mutex rpm_lock ; } cocci_id@p ;
...
position p;
@@
 struct sysmmu_fault_info {  unsigned int bit ;  unsigned short addr_reg ;  const char * name ;  unsigned int type ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef spinlock_t,sysmmu_pte_t;
@@
 struct exynos_iommu_domain {  struct list_head clients ;  sysmmu_pte_t * pgtable ;  short * lv2entcnt ;  spinlock_t lock ;  spinlock_t pgtablelock ;  struct iommu_domain domain ; } cocci_id@p ;
...
position p;
@@
 struct exynos_iommu_domain * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sysmmu_iova_t;
@@
 sysmmu_iova_t cocci_id@p ;
