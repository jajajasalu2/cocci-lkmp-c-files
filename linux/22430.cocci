...
position p;
@@
 const struct snd_akm4xxx cocci_id@p ;
...
position p;
@@
 const struct snd_akm4xxx_dac_channel cocci_id@p [ ] ;
...
position p;
@@
 struct qtet_kcontrol_private cocci_id@p [ ] ;
...
position p;
@@
 struct qtet_kcontrol_private {  unsigned int bit ;  void ( * set_register ) ( struct snd_ice1712 * ice , unsigned int val ) ;  unsigned int ( * get_register ) ( struct snd_ice1712 * ice ) ;  const char * const texts [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum { IN12_SEL = 0 , IN34_SEL , AIN34_SEL , COAX_OUT , IN12_MON12 , IN12_MON34 , IN34_MON12 , IN34_MON34 , OUT12_MON34 , OUT34_MON12 , } cocci_id@p ;
...
position p;
@@
 struct qtet_spec {  struct ak4113 * ak4113 ;  unsigned int scr ;  unsigned int mcr ;  unsigned int cpld ; } cocci_id@p ;
...
position p;
@@
 const struct snd_akm4xxx_adc_channel cocci_id@p [ ] ;
