...
position p;
@@
 enum { MLX5E_XDP_CHECK_OK = 1 , MLX5E_XDP_CHECK_START_MPWQE = 2 , } cocci_id@p ;
...
position p;
@@
 struct mlx5e_xdp_info * cocci_id@p ;
...
position p;
@@
 struct mlx5e_xdp_xmit_data * cocci_id@p ;
...
position p;
@@
 struct mlx5e_xdpsq_stats * cocci_id@p ;
...
position p;
@@
 struct mlx5e_xdp_mpwqe * cocci_id@p ;
