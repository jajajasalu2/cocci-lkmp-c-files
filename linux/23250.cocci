...
typedef u8,u32;
@@
 const struct {  u32 mclk ;  u32 rate ;  u8 usb ;  u8 sr ; } cocci_id@p [ ] ;
...
@@
 const  cocci_id@p ( micboost_tlv , 
							   ...
							   2 , 2 , 
							   TLV_DB_SCALE_ITEM ( 2800 , 0 , 0 ) , 
							   3 , 3 , 
							   TLV_DB_SCALE_ITEM ( 3300 , 0 , 0 ) ) ;
...
position p;
@@
 struct wm8737_priv {  struct regmap * regmap ;  struct regulator_bulk_data supplies [ WM8737_NUM_SUPPLIES ] ;  unsigned int mclk ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8737_NUM_SUPPLIES ] ;
