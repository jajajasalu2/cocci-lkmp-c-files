...
typedef u32;
@@
 struct {  u32 size ;  u32 pages ; } cocci_id@p [ ] ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( page_sizes ) ] ;
...
position p;
@@
 struct {  igt_create_fn fn ;  unsigned int flags ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct drm_i915_gem_object * ( * cocci_id@p ) ( struct drm_i915_private * i915 , u32 size , u32 flags ) ;
...
typedef u32;
@@
 struct {  igt_create_fn fn ;  u32 min ;  u32 max ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct object_info {  unsigned int size ;  unsigned int gtt ;  unsigned int offset ; } cocci_id@p [ ] ;
