...
typedef u32;
@@
 int cocci_id@p ( struct rc_dev * dev , u32 cycle ) ;
...
typedef ktime_t;
@@
 struct serial_ir {  ktime_t lastkt ;  struct rc_dev * rcdev ;  struct platform_device * pdev ;  struct timer_list timeout_timer ;  unsigned int carrier ;  unsigned int duty_cycle ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct rc_dev * dev , u32 carrier ) ;
...
position p;
@@
 int cocci_id@p ( struct rc_dev * dev , unsigned int * txbuf , unsigned int count ) ;
...
position p;
@@
 void cocci_id@p ( struct rc_dev * rcdev ) ;
...
position p;
@@
 struct serial_ir_hw cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct rc_dev * rcdev ) ;
