...
position p;
@@
 const struct pnpipehdr * cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 sb_type ;  u8 sb_len ; } * cocci_id@p ;
...
position p;
@@
 const struct phonet_protocol cocci_id@p ;
...
position p;
@@
 const struct sockaddr_pn * cocci_id@p ;
