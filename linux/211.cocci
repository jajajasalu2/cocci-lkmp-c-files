...
position p;
@@
 struct padata_serial_queue cocci_id@p ;
...
position p;
@@
 struct padata_sysfs_entry * cocci_id@p ;
...
position p;
@@
 struct padata_parallel_queue cocci_id@p ;
...
position p;
@@
 struct parallel_data * cocci_id@p ;
