...
symbol cocci_id;
position p;
typedef xfs_attr_list_context_t;
@@
 xfs_attr_list_context_t cocci_id@p ;
...
position p;
@@
 struct attrlist_cursor_kern * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_attr_sf_sort_t;
@@
 xfs_attr_sf_sort_t * cocci_id@p ;
...
position p;
@@
 struct attrlist_ent * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef attrlist_ent_t;
@@
 attrlist_ent_t * cocci_id@p ;
...
position p;
@@
 struct xfs_attr_list_context * cocci_id@p ;
...
position p;
@@
 struct xfs_attr_sf_sort * cocci_id@p ;
