...
position p;
@@
 const FILE_FULL_DIRECTORY_INFO * cocci_id@p ;
...
position p;
@@
 const FILE_UNIX_INFO * cocci_id@p ;
...
position p;
@@
 FIND_FILE_STANDARD_INFO * cocci_id@p ;
...
position p;
@@
 const FIND_FILE_STANDARD_INFO * cocci_id@p ;
...
position p;
@@
 const struct cifs_fattr * cocci_id@p ;
...
position p;
@@
 SEARCH_ID_FULL_DIR_INFO * cocci_id@p ;
...
position p;
@@
 const FILE_BOTH_DIRECTORY_INFO * cocci_id@p ;
...
position p;
@@
 const SEARCH_ID_FULL_DIR_INFO * cocci_id@p ;
...
typedef u64,u32;
@@
 struct cifs_dirent {  const char * name ;  size_t namelen ;  u32 resume_key ;  u64 ino ; } cocci_id@p ;
...
position p;
@@
 const FILE_DIRECTORY_INFO * cocci_id@p ;
