...
position p;
@@
 union device_service_irq cocci_id@p ;
...
position p;
@@
 union lane_adjust cocci_id@p [ LANE_COUNT_DP_MAX ] ;
...
position p;
@@
 const struct dc_link_training_overrides * cocci_id@p ;
...
position p;
@@
 struct link_training_settings * cocci_id@p ;
...
position p;
@@
 enum dpcd_training_patterns cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ( DP_TEST_80BIT_CUSTOM_PATTERN_79_72 - DP_TEST_80BIT_CUSTOM_PATTERN_7_0 ) + 1 ] ;
...
position p;
@@
 struct dc_link_settings cocci_id@p ;
...
position p;
@@
 union lane_status cocci_id@p [ LANE_COUNT_DP_MAX ] ;
...
position p;
@@
 struct dp_sink_hw_fw_revision cocci_id@p ;
...
position p;
@@
 union psr_sink_psr_status cocci_id@p ;
...
position p;
@@
 union edp_configuration_cap cocci_id@p ;
...
position p;
@@
 enum dc_pre_emphasis cocci_id@p ;
...
position p;
@@
 enum dc_dp_training_pattern cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DP_ADAPTER_CAP - DP_DPCD_REV + 1 ] ;
...
position p;
@@
 const struct link_training_settings * cocci_id@p ;
...
position p;
@@
 enum controller_dp_test_pattern cocci_id@p ;
...
position p;
@@
 struct dc_link_training_overrides cocci_id@p ;
...
position p;
@@
 union down_spread_ctrl cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ LANE_COUNT_DP_MAX ] ;
...
position p;
@@
 union dp_downstream_port_present cocci_id@p ;
...
position p;
@@
 struct bit_depth_reduction_params cocci_id@p ;
...
position p;
@@
 union dpcd_training_lane cocci_id@p [ LANE_COUNT_DP_MAX ] ;
...
position p;
@@
 struct dc_lane_settings cocci_id@p ;
...
position p;
@@
 union dwnstream_port_caps_byte0 * cocci_id@p ;
...
position p;
@@
 enum { LINK_TRAINING_MAX_RETRY_COUNT = 5 , LINK_TRAINING_MAX_CR_RETRY = 100 , } cocci_id@p ;
...
position p;
@@
 union dwnstream_port_caps_byte3_hdmi cocci_id@p ;
...
position p;
@@
 union lane_adjust cocci_id@p [ 2 ] ;
...
position p;
@@
 enum dc_voltage_swing cocci_id@p ;
...
position p;
@@
 union phy_test_pattern cocci_id@p ;
...
position p;
@@
 struct dp_device_vendor_id cocci_id@p ;
...
position p;
@@
 union down_stream_port_count cocci_id@p ;
...
position p;
@@
 union training_aux_rd_interval cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DP_SINK_STATUS_ESI - DP_SINK_COUNT_ESI + 1 ] ;
...
position p;
@@
 const struct dc_link_settings * cocci_id@p ;
...
position p;
@@
 union dpcd_training_pattern cocci_id@p ;
...
position p;
@@
 union lane_align_status_updated * cocci_id@p ;
...
position p;
@@
 struct dc_link_training_settings cocci_id@p ;
...
position p;
@@
 enum dc_post_cursor2 cocci_id@p ;
...
position p;
@@
 union psr_error_status cocci_id@p ;
...
position p;
@@
 union dpcd_psr_configuration cocci_id@p ;
...
position p;
@@
 union test_response cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct dc_link_settings initial_link_settings , struct dc_link_settings * current_link_setting , enum link_training_result training_result ) ;
...
position p;
@@
 enum dpcd_phy_test_patterns cocci_id@p ;
...
position p;
@@
 enum link_training_result cocci_id@p ;
...
position p;
@@
 enum { POST_LT_ADJ_REQ_LIMIT = 6 , POST_LT_ADJ_REQ_TIMEOUT = 200 , } cocci_id@p ;
...
position p;
@@
 struct dc_link_settings cocci_id@p ( struct dc_link_settings link_setting_a , struct dc_link_settings link_setting_b ) ;
...
position p;
@@
 const enum dc_pre_emphasis cocci_id@p [ ] ;
...
position p;
@@
 struct encoder_feature_support * cocci_id@p ;
...
position p;
@@
 union dpcd_edp_config cocci_id@p ;
...
position p;
@@
 enum dpcd_downstream_port_max_bpc cocci_id@p ;
...
position p;
@@
 union dwnstream_port_caps_byte2 cocci_id@p ;
...
position p;
@@
 union link_test_pattern cocci_id@p ;
...
position p;
@@
 union lane_count_set cocci_id@p ;
...
position p;
@@
 enum dp_test_pattern cocci_id@p ;
