...
typedef u16;
@@
 u16 cocci_id@p [ AR5416_NUM_PD_GAINS ] ;
...
position p;
@@
 struct base_eep_ar9287_header * cocci_id@p ;
...
position p;
@@
 struct cal_ctl_data_ar9287 * cocci_id@p ;
...
position p;
@@
 struct cal_data_per_freq_ar9287 * cocci_id@p ;
...
position p;
@@
 struct ar9287_eeprom cocci_id@p ;
...
position p;
@@
 struct cal_data_op_loop_ar9287 * cocci_id@p ;
...
position p;
@@
 struct modal_eep_ar9287_header * cocci_id@p ;
...
position p;
@@
 struct cal_ctl_edges * cocci_id@p ;
