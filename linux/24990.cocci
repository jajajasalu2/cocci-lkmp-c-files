...
position p;
@@
 const struct batadv_ogm2_packet * cocci_id@p ;
...
position p;
@@
 struct batadv_hard_iface_bat_v * cocci_id@p ;
...
position p;
@@
 struct batadv_priv_bat_v cocci_id@p ;
...
position p;
@@
 struct batadv_ogm2_packet * cocci_id@p ;
