...
position p;
@@
 struct stk1160_decimate_ctrl * cocci_id@p ;
...
position p;
@@
 struct stk1160_buffer * cocci_id@p ;
...
position p;
@@
 enum stk1160_decimate_mode cocci_id@p ;
...
position p;
@@
 enum stk1160_decimate_mode { STK1160_DECIMATE_MORE_THAN_HALF , STK1160_DECIMATE_LESS_THAN_HALF , } cocci_id@p ;
