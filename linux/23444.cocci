...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ ADAU17X1_WORD_SIZE ] ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ ADAU17X1_SAFELOAD_DATA_SIZE ] ;
...
position p;
@@
 enum adau17x1_micbias_voltage cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_soc_component * component , unsigned int rate ) ;
