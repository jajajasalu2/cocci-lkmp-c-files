...
position p;
@@
 struct sctp_ht_iter * cocci_id@p ;
...
position p;
@@
 struct sctp_ht_iter {  struct seq_net_private p ;  struct rhashtable_iter hti ; } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ SCTP_MIB_MAX ] ;
...
position p;
@@
 const struct snmp_mib cocci_id@p [ ] ;
