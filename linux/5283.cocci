...
position p;
@@
 ssize_t cocci_id@p ( struct ata_device * dev , char * buf ) ;
...
position p;
@@
 struct ahci_em_priv * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ata_link * link , unsigned int * class ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct ata_port * ap , bool sleep ) ;
...
position p;
@@
 void cocci_id@p ( struct ata_link * link ) ;
...
position p;
@@
 ssize_t cocci_id@p ( struct ata_port * ap , char * buf ) ;
...
position p;
@@
 int cocci_id@p ( struct ata_link * link , enum ata_lpm_policy policy , unsigned hints ) ;
...
position p;
@@
 struct ahci_port_priv * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ata_queued_cmd * qc ) ;
...
position p;
@@
 ssize_t cocci_id@p ( struct ata_device * dev , enum sw_activity val ) ;
