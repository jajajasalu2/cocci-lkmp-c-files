...
position p;
@@
 struct i915_request * cocci_id@p [ 5 ] ;
...
position p;
@@
 struct {  const char * name ;  unsigned int flags ; } * cocci_id@p ;
...
position p;
@@
 struct parallel_switch {  struct task_struct * tsk ;  struct intel_context * ce [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct parallel_switch * cocci_id@p ;
