...
position p;
@@
 struct frame_vector * cocci_id@p ;
...
position p;
@@
 struct vb2_dma_sg_attachment {  struct sg_table sgt ;  enum dma_data_direction dma_dir ; } cocci_id@p ;
...
position p;
@@
 const struct vb2_mem_ops cocci_id@p ;
...
position p;
@@
 struct vb2_dma_sg_buf * cocci_id@p ;
...
typedef refcount_t;
@@
 struct vb2_dma_sg_buf {  struct device * dev ;  void * vaddr ;  struct page * * pages ;  struct frame_vector * vec ;  int offset ;  enum dma_data_direction dma_dir ;  struct sg_table sg_table ;  struct sg_table * dma_sgt ;  size_t size ;  unsigned int num_pages ;  refcount_t refcount ;  struct vb2_vmarea_handler handler ;  struct dma_buf_attachment * db_attach ; } cocci_id@p ;
...
position p;
@@
 struct vb2_dma_sg_attachment * cocci_id@p ;
