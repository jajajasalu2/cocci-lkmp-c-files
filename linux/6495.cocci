...
position p;
@@
 struct gvp11_hostdata cocci_id@p ;
...
position p;
@@
 struct gvp11_scsiregs * cocci_id@p ;
...
position p;
@@
 struct gvp11_hostdata {  struct WD33C93_hostdata wh ;  struct gvp11_scsiregs * regs ; } cocci_id@p ;
