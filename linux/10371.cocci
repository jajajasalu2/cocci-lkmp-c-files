...
position p;
@@
 struct mtk_disp_ovl * cocci_id@p ;
...
position p;
@@
 struct mtk_disp_ovl {  struct mtk_ddp_comp ddp_comp ;  struct drm_crtc * crtc ;  const struct mtk_disp_ovl_data * data ; } cocci_id@p ;
...
typedef bool;
@@
 struct mtk_disp_ovl_data {  unsigned int addr ;  unsigned int gmc_bits ;  unsigned int layer_nr ;  bool fmt_rgb565_is_0 ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_disp_ovl_data cocci_id@p ;
...
position p;
@@
 struct mtk_plane_pending_state * cocci_id@p ;
