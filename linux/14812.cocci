...
@@
 struct mstp_clock_group {  struct clk_onecell_data data ;  void __iomem * smstpcr ;  void __iomem * mstpsr ;  spinlock_t lock ;  bool width_8bit ;  struct clk * clks [ ] ; } cocci_id@p ;
...
position p;
@@
 struct mstp_clock_group * cocci_id@p ;
...
typedef u32;
@@
 struct mstp_clock {  struct clk_hw hw ;  u32 bit_index ;  struct mstp_clock_group * group ; } cocci_id@p ;
