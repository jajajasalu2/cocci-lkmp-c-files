...
position p;
@@
 struct hns3_enet_ring * cocci_id@p ;
...
position p;
@@
 enum hns3_pkt_l2t_type cocci_id@p ;
...
position p;
@@
 struct hns3_enet_tqp_vector cocci_id@p ;
...
position p;
@@
 enum hns3_flow_level_range cocci_id@p ;
...
position p;
@@
 struct hns3_desc_cb cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ HNS3_MAX_TSO_BD_NUM + 1U ] ;
...
typedef bool;
@@
 void cocci_id@p ( struct hnae3_handle * h , bool force ) ;
...
position p;
@@
 struct hns3_nic_priv * cocci_id@p ;
...
position p;
@@
 struct hnae3_tc_info * cocci_id@p ;
...
position p;
@@
 struct hns3_enet_ring_group * cocci_id@p ;
...
position p;
@@
 struct hns3_enet_coalesce cocci_id@p ;
...
position p;
@@
 const struct hns3_hw_error_info cocci_id@p [ ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct hns3_enet_ring * , struct sk_buff * ) ;
