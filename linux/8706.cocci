...
position p;
@@
 enum { NETDEV_STATS , IXGBEVF_STATS , } cocci_id@p ;
...
position p;
@@
 const struct ixgbevf_reg_test cocci_id@p [ ] ;
...
typedef u8,u32,u16;
@@
 struct ixgbevf_reg_test {  u16 reg ;  u8 array_len ;  u8 test_type ;  u32 mask ;  u32 write ; } cocci_id@p ;
...
position p;
@@
 struct ixgbevf_stats cocci_id@p ;
