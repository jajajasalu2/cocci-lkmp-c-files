...
position p;
@@
 struct sys_t_policy_node * cocci_id@p ;
...
position p;
@@
 enum sys_t_message_string_subtype { MIPI_SYST_STRING_GENERIC = 1 , MIPI_SYST_STRING_FUNCTIONENTER , MIPI_SYST_STRING_FUNCTIONEXIT , MIPI_SYST_STRING_INVALIDPARAM = 5 , MIPI_SYST_STRING_ASSERT = 7 , MIPI_SYST_STRING_PRINTF_32 = 11 , MIPI_SYST_STRING_PRINTF_64 = 12 , } cocci_id@p ;
...
typedef bool,uuid_t;
@@
 struct sys_t_policy_node {  uuid_t uuid ;  bool do_len ;  unsigned long ts_interval ;  unsigned long clocksync_interval ; } cocci_id@p ;
...
position p;
@@
 struct sys_t_output * cocci_id@p ;
...
position p;
@@
 enum sys_t_message_clock_subtype { MIPI_SYST_CLOCK_TRANSPORT_SYNC = 1 , } cocci_id@p ;
...
position p;
@@
 enum sys_t_message_type { MIPI_SYST_TYPE_BUILD = 0 , MIPI_SYST_TYPE_SHORT32 , MIPI_SYST_TYPE_STRING , MIPI_SYST_TYPE_CATALOG , MIPI_SYST_TYPE_RAW = 6 , MIPI_SYST_TYPE_SHORT64 , MIPI_SYST_TYPE_CLOCK , } cocci_id@p ;
...
position p;
@@
 const struct stm_protocol_driver cocci_id@p ;
...
position p;
@@
 enum sys_t_message_severity { MIPI_SYST_SEVERITY_MAX = 0 , MIPI_SYST_SEVERITY_FATAL , MIPI_SYST_SEVERITY_ERROR , MIPI_SYST_SEVERITY_WARNING , MIPI_SYST_SEVERITY_INFO , MIPI_SYST_SEVERITY_USER1 , MIPI_SYST_SEVERITY_USER2 , MIPI_SYST_SEVERITY_DEBUG , } cocci_id@p ;
...
position p;
@@
 enum sys_t_message_build_subtype { MIPI_SYST_BUILD_ID_COMPACT32 = 0 , MIPI_SYST_BUILD_ID_COMPACT64 , MIPI_SYST_BUILD_ID_LONG , } cocci_id@p ;
...
position p;
@@
 struct sys_t_output {  struct sys_t_policy_node node ;  unsigned long ts_jiffies ;  unsigned long clocksync_jiffies ; } cocci_id@p ;
