...
position p;
@@
 struct ioctl_evtchn_bind_unbound_port cocci_id@p ;
...
position p;
@@
 struct ioctl_evtchn_unbind cocci_id@p ;
...
position p;
@@
 struct ioctl_evtchn_restrict_domid cocci_id@p ;
...
position p;
@@
 struct ioctl_evtchn_notify cocci_id@p ;
...
position p;
@@
 struct ioctl_evtchn_bind_virq cocci_id@p ;
...
position p;
@@
 struct per_user_data * cocci_id@p ;
...
typedef bool;
@@
 struct user_evtchn {  struct rb_node node ;  struct per_user_data * user ;  unsigned port ;  bool enabled ; } cocci_id@p ;
...
position p;
@@
 struct ioctl_evtchn_bind_interdomain cocci_id@p ;
