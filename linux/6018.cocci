...
position p;
@@
 const struct owl_gpio_port * cocci_id@p ;
...
position p;
@@
 struct owl_pinctrl_soc_data * cocci_id@p ;
...
position p;
@@
 const struct owl_pingroup * cocci_id@p ;
...
@@
 struct owl_pinctrl {  struct device * dev ;  struct pinctrl_dev * pctrldev ;  struct gpio_chip chip ;  raw_spinlock_t lock ;  struct clk * clk ;  const struct owl_pinctrl_soc_data * soc ;  void __iomem * base ;  struct irq_chip irq_chip ;  unsigned int num_irq ;  unsigned int * irq ; } cocci_id@p ;
...
position p;
@@
 const struct owl_padinfo * cocci_id@p ;
