...
position p;
@@
 struct st33zp24_platform_data * cocci_id@p ;
...
position p;
@@
 struct st33zp24_spi_phy cocci_id@p ;
...
typedef u8;
@@
 struct st33zp24_spi_phy {  struct spi_device * spi_device ;  u8 tx_buf [ ST33ZP24_SPI_BUFFER_SIZE ] ;  u8 rx_buf [ ST33ZP24_SPI_BUFFER_SIZE ] ;  int io_lpcpd ;  int latency ; } cocci_id@p ;
