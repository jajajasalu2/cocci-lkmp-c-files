...
typedef u16;
@@
 union ccp_function {  struct {  u16 size : 7 ;  u16 encrypt : 1 ;  u16 mode : 5 ;  u16 type : 2 ; } aes ;  struct {  u16 size : 7 ;  u16 encrypt : 1 ;  u16 rsvd : 5 ;  u16 type : 2 ; } aes_xts ;  struct {  u16 size : 7 ;  u16 encrypt : 1 ;  u16 mode : 5 ;  u16 type : 2 ; } des3 ;  struct {  u16 rsvd1 : 10 ;  u16 type : 4 ;  u16 rsvd2 : 1 ; } sha ;  struct {  u16 mode : 3 ;  u16 size : 12 ; } rsa ;  struct {  u16 byteswap : 2 ;  u16 bitwise : 3 ;  u16 reflect : 2 ;  u16 rsvd : 8 ; } pt ;  struct {  u16 rsvd : 13 ; } zlib ;  struct {  u16 size : 10 ;  u16 type : 2 ;  u16 mode : 3 ; } ecc ;  u16 raw ; } cocci_id@p ;
...
position p;
@@
 struct ccp_dma_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_DMAPOOL_NAME_LEN ] ;
...
position p;
@@
 const struct ccp_vdata cocci_id@p ;
...
position p;
@@
 const struct ccp_actions cocci_id@p ;
...
position p;
@@
 struct ccp_cmd_queue * cocci_id@p ;
