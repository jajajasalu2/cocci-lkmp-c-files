...
position p;
@@
 struct batadv_nc_node * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct batadv_priv * , struct batadv_nc_node * ) ;
...
position p;
@@
 struct batadv_priv_nc * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct batadv_priv * , struct batadv_nc_path * ) ;
...
position p;
@@
 struct batadv_nc_packet * cocci_id@p ;
...
position p;
@@
 struct batadv_neigh_ifinfo * cocci_id@p ;
...
position p;
@@
 const struct batadv_nc_path * cocci_id@p ;
...
position p;
@@
 struct batadv_orig_ifinfo * cocci_id@p ;
...
position p;
@@
 struct batadv_nc_path * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct batadv_priv * , struct batadv_nc_path * , struct batadv_nc_packet * ) ;
