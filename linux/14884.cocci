...
position p;
@@
 struct tegra_bpmp_clk * cocci_id@p ;
...
position p;
@@
 struct cmd_clk_get_max_clk_id_response cocci_id@p ;
...
position p;
@@
 struct cmd_clk_get_all_info_response cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_clk_message {  unsigned int cmd ;  unsigned int id ;  struct {  const void * data ;  size_t size ; } tx ;  struct {  void * data ;  size_t size ;  int ret ; } rx ; } cocci_id@p ;
...
position p;
@@
 struct cmd_clk_round_rate_request cocci_id@p ;
...
position p;
@@
 struct cmd_clk_get_rate_request cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_clk_message cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_clk_info * cocci_id@p ;
...
position p;
@@
 struct cmd_clk_round_rate_response cocci_id@p ;
...
position p;
@@
 struct cmd_clk_set_rate_request cocci_id@p ;
...
position p;
@@
 struct mrq_clk_request cocci_id@p ;
...
position p;
@@
 struct cmd_clk_set_rate_response cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_clk_info {  unsigned int id ;  char name [ MRQ_CLK_NAME_MAXLEN ] ;  unsigned int parents [ MRQ_CLK_MAX_PARENTS ] ;  unsigned int num_parents ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 struct cmd_clk_set_parent_request cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_clk {  struct clk_hw hw ;  struct tegra_bpmp * bpmp ;  unsigned int id ;  unsigned int num_parents ;  unsigned int * parents ; } cocci_id@p ;
...
position p;
@@
 struct cmd_clk_is_enabled_response cocci_id@p ;
...
position p;
@@
 struct cmd_clk_set_parent_response cocci_id@p ;
...
position p;
@@
 const struct tegra_bpmp_clk_message * cocci_id@p ;
...
position p;
@@
 struct cmd_clk_get_rate_response cocci_id@p ;
...
position p;
@@
 const struct tegra_bpmp_clk_info * cocci_id@p ;
...
position p;
@@
 struct cmd_clk_get_parent_response cocci_id@p ;
...
position p;
@@
 struct tegra_bpmp_message cocci_id@p ;
