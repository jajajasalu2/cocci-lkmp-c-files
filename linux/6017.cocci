...
position p;
@@
 const struct pin_config_item cocci_id@p [ ARRAY_SIZE ( zynq_dt_params ) ] ;
...
position p;
@@
 const struct zynq_pctrl_group * cocci_id@p ;
...
position p;
@@
 const struct zynq_pinmux_function cocci_id@p [ ] ;
...
position p;
@@
 enum zynq_io_standards { zynq_iostd_min , zynq_iostd_lvcmos18 , zynq_iostd_lvcmos25 , zynq_iostd_lvcmos33 , zynq_iostd_hstl , zynq_iostd_max , } cocci_id@p ;
...
position p;
@@
 struct zynq_pctrl_group {  const char * name ;  const unsigned int * pins ;  const unsigned int npins ; } cocci_id@p ;
...
typedef u32;
@@
 struct zynq_pinctrl {  struct pinctrl_dev * pctrl ;  struct regmap * syscon ;  u32 pctrl_offset ;  const struct zynq_pctrl_group * groups ;  unsigned int ngroups ;  const struct zynq_pinmux_function * funcs ;  unsigned int nfuncs ; } cocci_id@p ;
...
position p;
@@
 enum zynq_io_standards cocci_id@p ;
...
typedef u8,u32;
@@
 struct zynq_pinmux_function {  const char * name ;  const char * const * groups ;  unsigned int ngroups ;  unsigned int mux_val ;  u32 mux ;  u32 mux_mask ;  u8 mux_shift ; } cocci_id@p ;
...
position p;
@@
 struct zynq_pinctrl * cocci_id@p ;
