...
typedef u32;
@@
 struct cx88_IR {  struct cx88_core * core ;  struct rc_dev * dev ;  int users ;  char name [ 32 ] ;  char phys [ 32 ] ;  u32 sampling ;  int polling ;  struct hrtimer timer ;  u32 gpio_addr ;  u32 last_gpio ;  u32 mask_keycode ;  u32 mask_keydown ;  u32 mask_keyup ; } cocci_id@p ;
