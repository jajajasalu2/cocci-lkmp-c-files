...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_GRE_MAX + 1 ] ;
...
position p;
@@
 const struct ip6_tnl_parm2 * cocci_id@p ;
...
position p;
@@
 struct ip6_tnl_parm2 * cocci_id@p ;
...
position p;
@@
 struct ip6gre_net {  struct ip6_tnl __rcu * tunnels [ 4 ] [ IP6_GRE_HASH_SIZE ] ;  struct ip6_tnl __rcu * collect_md_tun ;  struct ip6_tnl __rcu * collect_md_tun_erspan ;  struct net_device * fb_tunnel_dev ; } cocci_id@p ;
...
position p;
@@
 struct tnl_ptk_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ip6gre_net * ign , struct ip6_tnl * t ) ;
...
position p;
@@
 void cocci_id@p ( struct ip6_tnl * t , int set_mtu ) ;
...
position p;
@@
 struct erspan_base_hdr * cocci_id@p ;
