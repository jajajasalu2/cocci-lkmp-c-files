...
position p;
@@
 struct nfsd3_getaclargs * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( nfsd_acl_procedures2 ) ] ;
...
position p;
@@
 struct nfsd3_setaclargs * cocci_id@p ;
...
position p;
@@
 struct nfsd3_getaclres * cocci_id@p ;
