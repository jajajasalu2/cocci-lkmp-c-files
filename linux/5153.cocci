...
position p;
@@
 void cocci_id@p ( struct gpio_chip * chip , unsigned offset , int value ) ;
...
position p;
@@
 struct f7188x_gpio_data {  struct f7188x_sio * sio ;  int nr_bank ;  struct f7188x_gpio_bank * bank ; } cocci_id@p ;
...
position p;
@@
 struct f7188x_gpio_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gpio_chip * chip , unsigned offset , unsigned long config ) ;
...
position p;
@@
 enum chips { f71869 , f71869a , f71882fg , f71889a , f71889f , f81866 , f81804 , } cocci_id@p ;
...
position p;
@@
 struct f7188x_gpio_bank {  struct gpio_chip chip ;  unsigned int regbase ;  struct f7188x_gpio_data * data ; } cocci_id@p ;
...
position p;
@@
 const struct f7188x_sio * cocci_id@p ;
...
position p;
@@
 struct f7188x_sio {  int addr ;  enum chips type ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gpio_chip * chip , unsigned offset , int value ) ;
...
position p;
@@
 struct f7188x_gpio_bank cocci_id@p [ ] ;
