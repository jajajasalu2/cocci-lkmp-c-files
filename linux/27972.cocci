...
position p;
@@
 struct mqueue_fs_context * cocci_id@p ;
...
position p;
@@
 const struct mq_attr * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ O_ACCMODE ] ;
...
position p;
@@
 struct mqueue_fs_context {  struct ipc_namespace * ipc_ns ; } cocci_id@p ;
...
position p;
@@
 struct posix_msg_tree_node {  struct rb_node rb_node ;  struct list_head msg_list ;  int priority ; } cocci_id@p ;
...
@@
 struct mqueue_inode_info {  spinlock_t lock ;  struct inode vfs_inode ;  wait_queue_head_t wait_q ;  struct rb_root msg_tree ;  struct rb_node * msg_tree_rightmost ;  struct posix_msg_tree_node * node_cache ;  struct mq_attr attr ;  struct sigevent notify ;  struct pid * notify_owner ;  struct user_namespace * notify_user_ns ;  struct user_struct * user ;  struct sock * notify_sock ;  struct sk_buff * notify_cookie ;  struct ext_wait_queue e_wait_q [ 2 ] ;  unsigned long qsize ; } cocci_id@p ;
...
position p;
@@
 struct posix_msg_tree_node * cocci_id@p ;
...
position p;
@@
 struct mqueue_inode_info * cocci_id@p ;
...
position p;
@@
 struct ext_wait_queue cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mqueue_inode_info * info ) ;
...
position p;
@@
 const struct sigevent * cocci_id@p ;
...
position p;
@@
 struct compat_mq_attr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_long_t;
@@
 struct compat_mq_attr {  compat_long_t mq_flags ;  compat_long_t mq_maxmsg ;  compat_long_t mq_msgsize ;  compat_long_t mq_curmsgs ;  compat_long_t __reserved [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct ext_wait_queue {  struct task_struct * task ;  struct list_head list ;  struct msg_msg * msg ;  int state ; } cocci_id@p ;
