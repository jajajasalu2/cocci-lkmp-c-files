...
position p;
@@
 void cocci_id@p ( struct scsi_disk * , unsigned int ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * SCpnt ) ;
...
position p;
@@
 void cocci_id@p ( struct device * cdev ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_disk * ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * , int ) ;
...
@@
 blk_status_t cocci_id@p ( struct scsi_cmnd * SCpnt ) ;
...
position p;
@@
 const struct scsi_disk * cocci_id@p ;
...
position p;
@@
 struct scsi_mode_data cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_disk * sdkp , unsigned char * buffer ) ;
