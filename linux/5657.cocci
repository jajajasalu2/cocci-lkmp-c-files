...
position p;
@@
 struct abb5zes3_rtc_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ABB5ZES3_MEM_MAP_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ ABB5ZES3_TIMA_SEC_LEN + 1 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ ABB5ZES3_REG_RTC_SC + ABB5ZES3_RTC_SEC_LEN ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ ABB5ZES3_MEM_MAP_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ ABB5ZES3_ALRM_SEC_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ ABB5ZES3_TIMA_SEC_LEN ] ;
...
typedef bool;
@@
 struct abb5zes3_rtc_data {  struct rtc_device * rtc ;  struct regmap * regmap ;  int irq ;  bool battery_low ;  bool timer_alarm ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ABB5ZES3_CTRL_SEC_LEN ] ;
