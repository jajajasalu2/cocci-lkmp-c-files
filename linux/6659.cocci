...
position p;
@@
 const char * cocci_id@p [ MAX_HWQ_MODE ] ;
...
position p;
@@
 struct ht_cxlflash_afu_debug cocci_id@p ;
...
position p;
@@
 struct ht_cxlflash_lun_provision cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CXLFLASH_VPD_LEN ] ;
...
position p;
@@
 struct dev_dependent_vals cocci_id@p ;
...
position p;
@@
 const struct asyc_intr_info cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( union cxlflash_ht_ioctls ) ] ;
...
position p;
@@
 const struct dev_dependent_vals * cocci_id@p ;
...
position p;
@@
 struct ht_cxlflash_hdr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct cxlflash_cfg * , void * ) ;
...
position p;
@@
 const char * cocci_id@p [ MAX_FC_PORTS ] ;
...
position p;
@@
 const struct {  size_t size ;  hioctl ioctl ; } cocci_id@p [ ] ;
