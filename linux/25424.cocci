...
position p;
@@
 struct intel_pt_snapshot_ref cocci_id@p ;
...
typedef bool;
@@
 struct intel_pt_snapshot_ref {  void * ref_buf ;  size_t ref_offset ;  bool wrapped ; } cocci_id@p ;
...
typedef bool;
@@
 struct intel_pt_recording {  struct auxtrace_record itr ;  struct perf_pmu * intel_pt_pmu ;  int have_sched_switch ;  struct evlist * evlist ;  bool snapshot_mode ;  bool snapshot_init_done ;  size_t snapshot_size ;  size_t snapshot_ref_buf_size ;  int snapshot_ref_cnt ;  struct intel_pt_snapshot_ref * snapshot_refs ;  size_t priv_size ; } cocci_id@p ;
...
position p;
@@
 const struct perf_cpu_map * cocci_id@p ;
...
position p;
@@
 struct intel_pt_recording * cocci_id@p ;
