...
position p;
@@
 struct sa1100_port cocci_id@p [ NR_PORTS ] ;
...
position p;
@@
 struct sa1100_port {  struct uart_port port ;  struct timer_list timer ;  unsigned int old_status ;  struct mctrl_gpios * gpios ; } cocci_id@p ;
