...
@@
 struct wait_page_queue {  struct page * page ;  int bit_nr ;  wait_queue_entry_t wait ; } cocci_id@p ;
...
position p;
@@
 struct wait_page_key * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * , struct page * ) ;
...
position p;
@@
 struct wait_page_queue cocci_id@p ;
...
position p;
@@
 enum behavior { EXCLUSIVE , SHARED , DROP , } cocci_id@p ;
...
position p;
@@
 struct wait_page_key {  struct page * page ;  int bit_nr ;  int page_match ; } cocci_id@p ;
