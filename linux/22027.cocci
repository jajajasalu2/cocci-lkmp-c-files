...
position p;
@@
 const struct hints_case * cocci_id@p ;
...
position p;
@@
 enum action { ACTION_GET , ACTION_PUT , } cocci_id@p ;
...
typedef bool;
@@
 struct expect_stats_info {  struct objagg_obj_stats stats ;  bool is_root ;  unsigned int key_id ; } cocci_id@p ;
...
position p;
@@
 struct root {  struct tokey key ;  char buf [ BUF_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct tokey {  unsigned int id ; } cocci_id@p ;
...
position p;
@@
 const struct expect_stats * cocci_id@p ;
...
position p;
@@
 const struct action_item * cocci_id@p ;
...
position p;
@@
 struct expect_stats {  unsigned int info_count ;  struct expect_stats_info info [ NUM_KEYS ] ; } cocci_id@p ;
...
position p;
@@
 struct delta {  unsigned int key_id_diff ; } cocci_id@p ;
...
position p;
@@
 struct action_item {  unsigned int key_id ;  enum action action ;  enum expect_delta expect_delta ;  enum expect_root expect_root ;  struct expect_stats expect_stats ; } cocci_id@p ;
...
position p;
@@
 struct hints_case {  const unsigned int * key_ids ;  size_t key_ids_count ;  struct expect_stats expect_stats ;  struct expect_stats expect_stats_hints ; } cocci_id@p ;
...
position p;
@@
 enum expect_delta { EXPECT_DELTA_SAME , EXPECT_DELTA_INC , EXPECT_DELTA_DEC , } cocci_id@p ;
...
position p;
@@
 enum expect_root { EXPECT_ROOT_SAME , EXPECT_ROOT_INC , EXPECT_ROOT_DEC , } cocci_id@p ;
...
position p;
@@
 struct world {  unsigned int root_count ;  unsigned int delta_count ;  char next_root_buf [ BUF_LEN ] ;  struct objagg_obj * objagg_objs [ NUM_KEYS ] ;  unsigned int key_refs [ NUM_KEYS ] ; } cocci_id@p ;
...
position p;
@@
 const struct expect_stats_info * cocci_id@p ;
