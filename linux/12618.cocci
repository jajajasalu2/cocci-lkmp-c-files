...
position p;
@@
 struct lcdc_platform_data * cocci_id@p ;
...
position p;
@@
 struct mdp4_lcdc_encoder * cocci_id@p ;
...
@@
 struct mdp4_lcdc_encoder {  struct drm_encoder base ;  struct device_node * panel_node ;  struct drm_panel * panel ;  struct clk * lcdc_clk ;  unsigned long int pixclock ;  struct regulator * regs [ 3 ] ;  bool enabled ;  uint32_t bsc ; } cocci_id@p ;
