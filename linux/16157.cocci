...
position p;
@@
 const struct das1800_board cocci_id@p [ ] ;
...
position p;
@@
 struct das1800_private * cocci_id@p ;
...
position p;
@@
 struct das1800_board {  const char * name ;  unsigned char id ;  unsigned int ai_speed ;  unsigned int is_01_series : 1 ; } cocci_id@p ;
...
position p;
@@
 struct das1800_board cocci_id@p ;
...
typedef bool;
@@
 struct das1800_private {  struct comedi_isadma * dma ;  int irq_dma_bits ;  int dma_bits ;  unsigned short * fifo_buf ;  unsigned long iobase2 ;  bool ai_is_unipolar ; } cocci_id@p ;
...
position p;
@@
 enum das1800_boardid { BOARD_DAS1701ST , BOARD_DAS1701ST_DA , BOARD_DAS1702ST , BOARD_DAS1702ST_DA , BOARD_DAS1702HR , BOARD_DAS1702HR_DA , BOARD_DAS1701AO , BOARD_DAS1702AO , BOARD_DAS1801ST , BOARD_DAS1801ST_DA , BOARD_DAS1802ST , BOARD_DAS1802ST_DA , BOARD_DAS1802HR , BOARD_DAS1802HR_DA , BOARD_DAS1801HC , BOARD_DAS1802HC , BOARD_DAS1801AO , BOARD_DAS1802AO , } cocci_id@p ;
