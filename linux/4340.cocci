...
position p;
@@
 struct sonypi_device * cocci_id@p ;
...
position p;
@@
 struct sonypi_keypress cocci_id@p ;
...
typedef u16;
@@
 struct sonypi_ioport_list {  u16 port1 ;  u16 port2 ; } cocci_id@p ;
...
typedef u8;
@@
 struct sonypi_eventtypes {  int model ;  u8 data ;  unsigned long mask ;  struct sonypi_event * events ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  int sonypiev ;  int inputev ; } cocci_id@p [ ] ;
...
position p;
@@
 struct sonypi_irq_list cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef u16,wait_queue_head_t,spinlock_t;
@@
 struct sonypi_device {  struct pci_dev * dev ;  u16 irq ;  u16 bits ;  u16 ioport1 ;  u16 ioport2 ;  u16 region_size ;  u16 evtype_offset ;  int camera_power ;  int bluetooth_power ;  struct mutex lock ;  struct kfifo fifo ;  spinlock_t fifo_lock ;  wait_queue_head_t fifo_proc_list ;  struct fasync_struct * fifo_async ;  int open_count ;  int model ;  struct input_dev * input_jog_dev ;  struct input_dev * input_key_dev ;  struct work_struct input_work ;  struct kfifo input_fifo ;  spinlock_t input_fifo_lock ; } cocci_id@p ;
...
position p;
@@
 struct sonypi_ioport_list cocci_id@p [ ] ;
...
position p;
@@
 const struct sonypi_ioport_list * cocci_id@p ;
...
position p;
@@
 struct sonypi_keypress {  struct input_dev * dev ;  int key ; } cocci_id@p ;
...
position p;
@@
 const struct sonypi_irq_list * cocci_id@p ;
...
typedef u16;
@@
 struct sonypi_irq_list {  u16 irq ;  u16 bits ; } cocci_id@p ;
