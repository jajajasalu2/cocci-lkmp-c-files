...
typedef dma_addr_t;
@@
 struct jz4740_i2s {  struct resource * mem ;  void __iomem * base ;  dma_addr_t phys_base ;  struct clk * clk_aic ;  struct clk * clk_i2s ;  struct snd_dmaengine_dai_dma_data playback_dma_data ;  struct snd_dmaengine_dai_dma_data capture_dma_data ;  enum jz47xx_i2s_version version ; } cocci_id@p ;
...
position p;
@@
 enum jz47xx_i2s_version cocci_id@p ;
...
position p;
@@
 enum jz47xx_i2s_version { JZ_I2S_JZ4740 , JZ_I2S_JZ4780 , } cocci_id@p ;
...
position p;
@@
 const struct jz4740_i2s * cocci_id@p ;
