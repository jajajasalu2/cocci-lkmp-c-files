...
position p;
@@
 const struct tegra_xtal_freq cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_usb_phy cocci_id@p ;
...
position p;
@@
 enum tegra_usb_phy_port_speed cocci_id@p ;
...
position p;
@@
 enum usb_phy_interface cocci_id@p ;
...
typedef u8,u16;
@@
 struct tegra_xtal_freq {  int freq ;  u8 enable_delay ;  u8 stable_count ;  u8 active_delay ;  u8 xtal_freq_count ;  u16 debounce ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_phy_soc_config cocci_id@p ;
...
position p;
@@
 struct tegra_utmip_config * cocci_id@p ;
