...
position p;
@@
 struct nb8800_rx_desc * cocci_id@p ;
...
position p;
@@
 const struct nb8800_ops * cocci_id@p ;
...
position p;
@@
 struct nb8800_tx_desc * cocci_id@p ;
...
position p;
@@
 struct nb8800_dma_desc * cocci_id@p ;
...
position p;
@@
 struct nb8800_tx_buf * cocci_id@p ;
...
position p;
@@
 struct nb8800_rx_buf * cocci_id@p ;
