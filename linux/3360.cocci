...
typedef spinlock_t;
@@
 struct tpu_device {  struct platform_device * pdev ;  struct pwm_chip chip ;  spinlock_t lock ;  void __iomem * base ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 struct tpu_pwm_device * cocci_id@p ;
...
typedef bool,u16;
@@
 struct tpu_pwm_device {  bool timer_on ;  struct tpu_device * tpu ;  unsigned int channel ;  enum pwm_polarity polarity ;  unsigned int prescaler ;  u16 period ;  u16 duty ; } cocci_id@p ;
...
position p;
@@
 enum tpu_pin_state { TPU_PIN_INACTIVE , TPU_PIN_PWM , TPU_PIN_ACTIVE , } cocci_id@p ;
