...
typedef u8,u32;
@@
 int cocci_id@p ( struct sk_buff * skb , u32 portid , u32 seq , int flags , struct l2tp_tunnel * tunnel , u8 cmd ) ;
...
position p;
@@
 const struct l2tp_nl_cmd_ops * cocci_id@p [ __L2TP_PWTYPE_MAX ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ L2TP_ATTR_MAX + 1 ] ;
...
typedef u8,u32;
@@
 int cocci_id@p ( struct sk_buff * skb , u32 portid , u32 seq , int flags , struct l2tp_session * session , u8 cmd ) ;
