...
position p;
@@
 enum hns_gmac_duplex_mdoe cocci_id@p ;
...
position p;
@@
 struct hns_gmac_port_mode_cfg * cocci_id@p ;
...
position p;
@@
 struct mac_hw_stats * cocci_id@p ;
...
position p;
@@
 const struct mac_stats_string cocci_id@p [ ] ;
