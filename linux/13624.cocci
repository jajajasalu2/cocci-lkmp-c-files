...
position p;
@@
 enum { EXPO_CHANGED , EXPO_DROP_FRAME , EXPO_NO_CHANGE , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct sd {  struct gspca_dev gspca_dev ;  struct {  struct v4l2_ctrl * exposure ;  struct v4l2_ctrl * freq ; } ;  bool has_brightness ;  struct v4l2_pix_format fmts [ MAX_MODES ] ;  int pixels_read ;  int packet_read ;  u8 packet [ PACKET_SIZE ] ;  u8 restart_stream ;  u8 button_state ;  u8 resetlevel ;  u8 resetlevel_frame_count ;  int resetlevel_adjust_dir ;  int expo_change_state ; } cocci_id@p ;
