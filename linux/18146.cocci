...
position p;
@@
 void cocci_id@p ( const void * , unsigned long ) ;
...
typedef Elf_Shdr;
@@
 struct mod_unwind_map {  const Elf_Shdr * unw_sec ;  const Elf_Shdr * txt_sec ; } cocci_id@p ;
...
position p;
@@
 struct mod_unwind_map cocci_id@p [ ARM_SEC_MAX ] ;
