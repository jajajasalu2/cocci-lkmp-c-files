...
position p;
@@
 const struct stmmac_tc_ops cocci_id@p ;
...
position p;
@@
 struct stmmac_flow_entry * cocci_id@p ;
...
position p;
@@
 struct dma_features * cocci_id@p ;
...
position p;
@@
 struct {  int ( * fn ) ( struct stmmac_priv * priv , struct flow_cls_offload * cls , struct stmmac_flow_entry * entry ) ; } cocci_id@p [ ] ;
