...
position p;
@@
 struct drm_mode_create_blob * cocci_id@p ;
...
position p;
@@
 struct drm_mode_destroy_blob * cocci_id@p ;
...
position p;
@@
 struct drm_property_enum cocci_id@p ;
...
position p;
@@
 struct drm_mode_get_property * cocci_id@p ;
...
position p;
@@
 struct drm_mode_get_blob * cocci_id@p ;
