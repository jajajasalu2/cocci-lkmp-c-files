...
position p;
@@
 struct smc_wr_rx_hdr * cocci_id@p ;
...
position p;
@@
 struct ib_wc cocci_id@p [ SMC_WR_MAX_POLL_CQE ] ;
...
position p;
@@
 struct smc_wr_tx_pend * cocci_id@p ;
...
position p;
@@
 smc_wr_tx_dismisser cocci_id@p ;
...
typedef u64,u32;
@@
 struct smc_wr_tx_pend {  u64 wr_id ;  smc_wr_tx_handler handler ;  enum ib_wc_status wc_status ;  struct smc_link * link ;  u32 idx ;  struct smc_wr_tx_pend_priv priv ; } cocci_id@p ;
