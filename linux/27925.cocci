...
position p;
@@
 const struct open_flags * cocci_id@p ;
...
position p;
@@
 const char * ( * cocci_id@p ) ( struct dentry * , struct inode * , struct delayed_call * ) ;
...
position p;
@@
 struct dentry * const cocci_id@p ;
...
position p;
@@
 const struct word_at_a_time cocci_id@p ;
...
position p;
@@
 enum { WALK_FOLLOW = 1 , WALK_MORE = 2 , } cocci_id@p ;
