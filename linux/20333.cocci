...
position p;
@@
 const struct idt_data * cocci_id@p ;
...
position p;
@@
 struct idt_data {  unsigned int vector ;  unsigned int segment ;  struct idt_bits bits ;  const void * addr ; } cocci_id@p ;
