...
position p;
@@
 struct component_clk {  int num_parents ;  const char * * parent_names ;  struct device_node * node ;  int type ;  struct clk_hw * hw ;  struct list_head link ; } cocci_id@p ;
...
position p;
@@
 struct clk_hw_omap_comp cocci_id@p ;
...
position p;
@@
 struct component_clk * cocci_id@p ;
...
position p;
@@
 struct clk_hw_omap_comp {  struct clk_hw hw ;  struct device_node * comp_nodes [ CLK_COMPONENT_TYPE_MAX ] ;  struct component_clk * comp_clks [ CLK_COMPONENT_TYPE_MAX ] ; } cocci_id@p ;
