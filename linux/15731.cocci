...
position p;
@@
 struct hif_ind_generic * cocci_id@p ;
...
position p;
@@
 struct hif_cnf_multi_transmit * cocci_id@p ;
...
position p;
@@
 struct hif_ind_scan_cmpl * cocci_id@p ;
...
position p;
@@
 struct hif_ind_startup cocci_id@p ;
...
position p;
@@
 struct hif_ind_sl_exchange_pub_keys * cocci_id@p ;
...
position p;
@@
 const struct {  int msg_id ;  int ( * handler ) ( struct wfx_dev * wdev , struct hif_msg * hif , void * buf ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct hif_ind_event cocci_id@p ;
...
position p;
@@
 struct hif_ind_error * cocci_id@p ;
