...
position p;
@@
 struct synproxy_stats * cocci_id@p ;
...
position p;
@@
 struct synproxy_net cocci_id@p ;
...
position p;
@@
 struct synproxy_options cocci_id@p ;
...
position p;
@@
 const struct ip_ct_tcp * cocci_id@p ;
...
position p;
@@
 const struct synproxy_options * cocci_id@p ;
...
position p;
@@
 const struct nf_synproxy_info * cocci_id@p ;
...
position p;
@@
 const struct nf_conn_synproxy * cocci_id@p ;
