...
position p;
@@
 enum scmi_reset_protocol_notify { RESET_ISSUED = 0x0 , } cocci_id@p ;
...
position p;
@@
 struct scmi_msg_reset_domain_reset * cocci_id@p ;
...
typedef bool,u32;
@@
 struct reset_dom_info {  bool async_reset ;  bool reset_notify ;  u32 latency_us ;  char name [ SCMI_MAX_STR_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct scmi_reset_info * cocci_id@p ;
...
position p;
@@
 struct scmi_reset_info {  int num_domains ;  struct reset_dom_info * dom_info ; } cocci_id@p ;
...
position p;
@@
 enum scmi_reset_protocol_cmd { RESET_DOMAIN_ATTRIBUTES = 0x3 , RESET = 0x4 , RESET_NOTIFY = 0x5 , } cocci_id@p ;
...
position p;
@@
 struct reset_dom_info * cocci_id@p ;
...
position p;
@@
 struct scmi_msg_resp_reset_domain_attributes * cocci_id@p ;
...
position p;
@@
 struct scmi_reset_ops cocci_id@p ;
