...
position p;
@@
 struct stmpe_variant_info * cocci_id@p [ STMPE_NBR_PARTS ] ;
...
position p;
@@
 struct stmpe_variant_block * cocci_id@p ;
...
typedef bool;
@@
 struct stmpe_platform_data {  int id ;  unsigned int blocks ;  unsigned int irq_trigger ;  bool autosleep ;  bool irq_over_gpio ;  int irq_gpio ;  int autosleep_timeout ; } cocci_id@p ;
...
position p;
@@
 struct stmpe_platform_data * cocci_id@p ;
...
position p;
@@
 struct stmpe_variant_info * cocci_id@p ;
...
position p;
@@
 struct stmpe_client_info * cocci_id@p ;
