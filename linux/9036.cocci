...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_monitor_counter_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( arm_monitor_counter_in ) ] ;
...
position p;
@@
 enum mlx5_monitor_counter_ppcnt cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_monitor_counter_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( arm_monitor_counter_out ) ] ;
