...
position p;
@@
 void cocci_id@p ( struct ahc_softc * , struct scsi_device * , struct scb * ) ;
...
position p;
@@
 struct ahc_linux_device cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct scsi_cmnd * cmd ) ;
...
typedef uint8_t;
@@
 struct {  uint8_t tag_commands [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahc_softc * , struct scb * ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * cmd , scb_flag flag ) ;
...
position p;
@@
 int cocci_id@p ( struct ahc_softc * , struct ahc_linux_device * , struct scsi_cmnd * ) ;
...
typedef u_int;
@@
 u_int cocci_id@p ( struct ahc_softc * ahc , struct ahc_devinfo * devinfo ) ;
...
position p;
@@
 struct ahc_platform_data cocci_id@p ;
...
position p;
@@
 struct ahc_linux_target * cocci_id@p ;
