...
position p;
@@
 enum bmi160_sensor_type { BMI160_ACCEL = 0 , BMI160_GYRO , BMI160_EXT_MAGN , BMI160_NUM_SENSORS , } cocci_id@p ;
...
position p;
@@
 const struct bmi160_scale cocci_id@p [ ] ;
...
typedef u8;
@@
 struct bmi160_odr {  u8 bits ;  int odr ;  int uodr ; } cocci_id@p ;
...
typedef u8;
@@
 struct bmi160_scale {  u8 bits ;  int uscale ; } cocci_id@p ;
...
position p;
@@
 const struct bmi160_odr_item cocci_id@p [ ] ;
...
position p;
@@
 enum bmi160_sensor_type cocci_id@p ;
...
position p;
@@
 enum bmi160_scan_axis { BMI160_SCAN_EXT_MAGN_X = 0 , BMI160_SCAN_EXT_MAGN_Y , BMI160_SCAN_EXT_MAGN_Z , BMI160_SCAN_RHALL , BMI160_SCAN_GYRO_X , BMI160_SCAN_GYRO_Y , BMI160_SCAN_GYRO_Z , BMI160_SCAN_ACCEL_X , BMI160_SCAN_ACCEL_Y , BMI160_SCAN_ACCEL_Z , BMI160_SCAN_TIMESTAMP , } cocci_id@p ;
...
position p;
@@
 struct bmi160_odr_item {  const struct bmi160_odr * tbl ;  int num ; } cocci_id@p ;
...
position p;
@@
 enum bmi160_int_pin cocci_id@p ;
...
position p;
@@
 const struct bmi160_odr cocci_id@p [ ] ;
...
position p;
@@
 const struct bmi160_scale_item cocci_id@p [ ] ;
...
typedef u8;
@@
 struct bmi160_regs {  u8 data ;  u8 config ;  u8 config_odr_mask ;  u8 config_bwp_mask ;  u8 range ;  u8 pmu_cmd_normal ;  u8 pmu_cmd_suspend ; } cocci_id@p ;
...
position p;
@@
 enum bmi160_int_pin { BMI160_PIN_INT1 , BMI160_PIN_INT2 , } cocci_id@p ;
...
position p;
@@
 struct bmi160_scale_item {  const struct bmi160_scale * tbl ;  int num ; } cocci_id@p ;
