...
position p;
@@
 struct ncsi_rsp_pkt_hdr * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_ev_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_gp_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_sl_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_channel * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_oem_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_dev_priv * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_ae_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_gpuuid_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_package * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_gcps_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_pkt_hdr * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_oem_mlx_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_handler * cocci_id@p ;
...
position p;
@@
 struct ncsi_channel_stats * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_gps_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_snfc_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_egmf_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_channel_mac_filter * cocci_id@p ;
...
position p;
@@
 struct ncsi_channel_vlan_filter * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_handler {  unsigned char type ;  int payload ;  int ( * handler ) ( struct ncsi_request * nr ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ncsi_channel_mode * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_gls_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_oem_handler * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_oem_handler {  unsigned int mfr_id ;  int ( * handler ) ( struct ncsi_request * nr ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ncsi_cmd_svf_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_gvi_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_channel_version * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_gnpts_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_gc_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_ebf_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_gns_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_cmd_sma_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_request * cocci_id@p ;
...
position p;
@@
 struct ncsi_rsp_oem_bcm_pkt * cocci_id@p ;
