...
position p;
@@
 struct maple_device_specify {  int port ;  int unit ; } cocci_id@p ;
...
position p;
@@
 struct maple_device * cocci_id@p [ MAPLE_PORTS ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct mapleq * mq ) ;
...
position p;
@@
 struct maple_device_specify cocci_id@p ;
