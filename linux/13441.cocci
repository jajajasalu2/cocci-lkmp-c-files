...
position p;
@@
 int cocci_id@p ( struct camera_data * cam , int reqwidth , int reqheight ) ;
...
position p;
@@
 int cocci_id@p ( struct camera_data * cam , int size ) ;
...
position p;
@@
 struct cpia2_reg_mask cocci_id@p ;
...
position p;
@@
 struct cpia2_register cocci_id@p ;
