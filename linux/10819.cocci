...
position p;
@@
 const struct hwmon_temp_label {  enum PP_HWMON_TEMP channel ;  const char * label ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ AMDGPU_MASK_BUF_MAX + 1 ] ;
...
position p;
@@
 const struct cg_flag_name cocci_id@p [ ] ;
