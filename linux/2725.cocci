...
symbol cocci_id;
position p;
typedef smbus_methods_t;
@@
 const struct smbus_methods_t cocci_id@p ;
...
typedef smbus_methods_t;
@@
 struct smbus_methods_t {  char * mt_info ;  char * mt_sbr ;  char * mt_sbw ; } cocci_id@p ;
...
typedef smbus_methods_t;
@@
 struct smbus_methods_t * cocci_id@p ;
...
position p;
@@
 struct acpi_smbus_cmi * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,acpi_handle,smbus_methods_t;
@@
 struct acpi_smbus_cmi {  acpi_handle handle ;  struct i2c_adapter adapter ;  u8 cap_info : 1 ;  u8 cap_read : 1 ;  u8 cap_write : 1 ;  struct smbus_methods_t * methods ; } cocci_id@p ;
