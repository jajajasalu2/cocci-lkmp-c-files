...
position p;
@@
 struct fimc_context * cocci_id@p ;
...
position p;
@@
 enum { FIMC_CLK_LCLK , FIMC_CLK_GATE , FIMC_CLK_WB_A , FIMC_CLK_WB_B , FIMC_CLKS_MAX , } cocci_id@p ;
...
typedef bool,u32;
@@
 struct fimc_scaler {  bool range ;  bool bypass ;  bool up_h ;  bool up_v ;  u32 hratio ;  u32 vratio ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fimc_context * ctx ) ;
