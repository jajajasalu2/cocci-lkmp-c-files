...
symbol cocci_id;
position p;
typedef ab_done_fn_t,ab_task_fn_t;
@@
 struct ab_task {  struct kmem_cache * cache ;  struct kref refcount ;  ab_task_fn_t task_fn ;  ab_done_fn_t done_fn ;  int result ;  struct completion done ;  unsigned long start_jiffies ;  union {  struct area_priv area_pd ;  struct mbox_priv mbox_pd ; } ; } cocci_id@p ;
...
position p;
@@
 struct anybuss_host * cocci_id@p ;
...
position p;
@@
 struct msg_anybus_init cocci_id@p ;
...
position p;
@@
 struct anybus_mbox_hdr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct anybuss_host * cd , struct ab_task * t ) ;
...
position p;
@@
 const struct anybuss_ops * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct area_priv {  bool is_write ;  u16 flags ;  u16 addr ;  size_t count ;  u8 buf [ MAX_DATA_AREA_SZ ] ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct anybuss_host * cd ) ;
...
position p;
@@
 struct anybuss_client * cocci_id@p ;
...
position p;
@@
 struct msg_anybus_init {  __be16 input_io_len ;  __be16 input_dpram_len ;  __be16 input_total_len ;  __be16 output_io_len ;  __be16 output_dpram_len ;  __be16 output_total_len ;  __be16 op_mode ;  __be16 notif_config ;  __be16 wd_val ; } cocci_id@p ;
...
typedef u8;
@@
 struct mbox_priv {  struct anybus_mbox_hdr hdr ;  size_t msg_out_sz ;  size_t msg_in_sz ;  u8 msg [ MAX_MBOX_MSG_SZ ] ; } cocci_id@p ;
...
position p;
@@
 struct anybus_mbox_hdr {  __be16 id ;  __be16 info ;  __be16 cmd_num ;  __be16 data_size ;  __be16 frame_count ;  __be16 frame_num ;  __be16 offset_high ;  __be16 offset_low ;  __be16 extended [ 8 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ab_task_fn_t;
@@
 ab_task_fn_t cocci_id@p ;
...
position p;
@@
 struct anybuss_client_driver * cocci_id@p ;
...
position p;
@@
 const struct anybuss_memcfg * cocci_id@p ;
