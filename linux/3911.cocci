...
position p;
@@
 struct race_thread cocci_id@p [ 2 ] ;
...
position p;
@@
 struct wait_cb {  struct dma_fence_cb cb ;  struct task_struct * task ; } cocci_id@p ;
...
position p;
@@
 struct dma_fence * cocci_id@p [ 64 ] ;
...
position p;
@@
 struct wait_timer {  struct timer_list timer ;  struct dma_fence * f ; } cocci_id@p ;
...
typedef bool;
@@
 struct simple_cb {  struct dma_fence_cb cb ;  bool seen ; } cocci_id@p ;
...
typedef bool;
@@
 struct race_thread {  struct dma_fence __rcu * * fences ;  struct task_struct * task ;  bool before ;  int id ; } cocci_id@p ;
...
position p;
@@
 const struct race_thread * cocci_id@p ;
...
position p;
@@
 const struct subtest cocci_id@p [ ] ;
...
position p;
@@
 struct mock_fence {  struct dma_fence base ;  struct spinlock lock ; } * cocci_id@p ;
