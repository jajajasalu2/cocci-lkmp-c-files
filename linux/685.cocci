...
position p;
@@
 enum enable_type { undefined = - 1 , user_disabled , auto_disabled , user_enabled , auto_enabled , } cocci_id@p ;
...
position p;
@@
 enum release_type { leaf_only , whole_subtree , } cocci_id@p ;
...
typedef resource_size_t;
@@
 struct pci_dev_resource {  struct list_head list ;  struct resource * res ;  struct pci_dev * dev ;  resource_size_t start ;  resource_size_t end ;  resource_size_t add_size ;  resource_size_t min_align ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 struct pci_dev_resource * cocci_id@p ;
