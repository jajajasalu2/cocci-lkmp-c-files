...
position p;
@@
 struct e4_ustorm_iscsi_task_ag_ctx * cocci_id@p ;
...
position p;
@@
 struct scsi_cached_sges * cocci_id@p ;
...
position p;
@@
 struct iscsi_dif_flags * cocci_id@p ;
...
position p;
@@
 struct iscsi_r2t_hdr * cocci_id@p ;
...
position p;
@@
 struct ustorm_iscsi_task_st_ctx * cocci_id@p ;
...
position p;
@@
 struct ystorm_iscsi_task_st_ctx * cocci_id@p ;
...
position p;
@@
 struct tdif_task_context * cocci_id@p ;
...
position p;
@@
 union iscsi_task_hdr * cocci_id@p ;
...
position p;
@@
 struct rdif_task_context * cocci_id@p ;
...
position p;
@@
 struct iscsi_common_hdr * cocci_id@p ;
...
position p;
@@
 struct scsi_sgl_params * cocci_id@p ;
...
position p;
@@
 struct scsi_dif_task_params * cocci_id@p ;
