...
position p;
@@
 void ( * cocci_id@p ) ( unsigned int bit , unsigned long * bmap ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned int bit , unsigned long * bitmap ) ;
...
typedef u64,u32,u16;
@@
 u32 cocci_id@p ( struct inode * inode , u64 bg_blkno , u16 bg_bit_off ) ;
...
typedef u64;
@@
 int cocci_id@p ( struct ocfs2_super * osb , struct inode * alloc_inode , struct buffer_head * bh , u64 max_block , u64 * last_alloc_group , int flags ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct ocfs2_group_desc * bg , u32 wanted ) ;
...
typedef u64,u16;
@@
 void cocci_id@p ( struct inode * inode , u64 data_blkno , u64 * bg_blkno , u16 * bg_bit_off ) ;
...
position p;
@@
 struct ocfs2_suballoc_result * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u16,handle_t;
@@
 int cocci_id@p ( handle_t * handle , struct inode * alloc_inode , struct buffer_head * bg_bh , u64 group_blkno , unsigned int group_clusters , u16 my_chain , struct ocfs2_chain_list * cl ) ;
...
position p;
@@
 struct journal_head * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct buffer_head * bg_bh , int nr ) ;
...
typedef u64,u32;
@@
 int cocci_id@p ( struct inode * inode , struct buffer_head * group_bh , u32 bits_wanted , u32 min_bits , u64 max_block , struct ocfs2_suballoc_result * res ) ;
...
@@
 int cocci_id@p ( handle_t * handle , struct inode * alloc_inode , struct buffer_head * fe_bh , struct buffer_head * bg_bh , struct buffer_head * prev_bg_bh , u16 chain ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct ocfs2_chain_list * cl ) ;
...
typedef u64,u32;
@@
 int cocci_id@p ( struct ocfs2_super * osb , u32 bits_wanted , u64 max_block , int flags , struct ocfs2_alloc_context * * ac ) ;
...
typedef u64;
@@
 struct ocfs2_suballoc_result {  u64 sr_bg_blkno ;  u64 sr_bg_stable_blkno ;  u64 sr_blkno ;  unsigned int sr_bit_offset ;  unsigned int sr_bits ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_chain_list * cocci_id@p ;
