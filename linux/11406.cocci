...
position p;
@@
 struct vmw_view_define cocci_id@p ;
...
position p;
@@
 struct vmw_view_define {  uint32 view_id ;  uint32 sid ; } cocci_id@p ;
...
position p;
@@
 union vmw_view_destroy cocci_id@p ;
...
typedef bool,u32;
@@
 struct vmw_view {  struct rcu_head rcu ;  struct vmw_resource res ;  struct vmw_resource * ctx ;  struct vmw_resource * srf ;  struct vmw_resource * cotable ;  struct list_head srf_head ;  struct list_head cotable_head ;  unsigned view_type ;  unsigned view_id ;  u32 cmd_size ;  bool committed ;  u32 cmd [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  struct vmw_view_define body ; } * cocci_id@p ;
