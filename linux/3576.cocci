...
symbol cocci_id;
position p;
typedef bool,u32,irqreturn_t;
@@
 struct mmc_gpio {  struct gpio_desc * ro_gpio ;  struct gpio_desc * cd_gpio ;  bool override_cd_active_level ;  irqreturn_t ( * cd_gpio_isr ) ( int irq , void * dev_id ) ;  char * ro_label ;  char * cd_label ;  u32 cd_debounce_delay_ms ; } cocci_id@p ;
