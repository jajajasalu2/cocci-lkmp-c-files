...
position p;
@@
 struct qeth_arp_entrytype * cocci_id@p ;
...
position p;
@@
 struct qeth_arp_qi_entry5 cocci_id@p ;
...
position p;
@@
 struct qeth_arp_qi_entry7_ipv6 cocci_id@p ;
...
position p;
@@
 enum qeth_arp_process_subcmds cocci_id@p ;
...
position p;
@@
 struct af_iucv_trans_hdr * cocci_id@p ;
...
position p;
@@
 enum qeth_routing_types * cocci_id@p ;
...
position p;
@@
 struct qeth_l3_ip_event_work cocci_id@p ;
...
position p;
@@
 struct qeth_l3_ip_event_work {  struct work_struct work ;  struct qeth_card * card ;  struct qeth_ipaddr addr ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qeth_card * , struct qeth_ipaddr * ) ;
...
position p;
@@
 struct qeth_arp_qi_entry5_ipv6 cocci_id@p ;
...
position p;
@@
 struct qeth_ipato_entry * cocci_id@p ;
...
position p;
@@
 struct qeth_arp_qi_entry7 cocci_id@p ;
...
position p;
@@
 struct qeth_arp_qi_entry5_short cocci_id@p ;
...
position p;
@@
 struct qeth_arp_cache_entry * cocci_id@p ;
...
position p;
@@
 struct qeth_arp_qi_entry7_short_ipv6 cocci_id@p ;
...
position p;
@@
 struct qeth_arp_query_data * cocci_id@p ;
...
position p;
@@
 enum qeth_diags_trace_cmds cocci_id@p ;
...
position p;
@@
 struct qeth_arp_qi_entry5_short_ipv6 cocci_id@p ;
...
position p;
@@
 struct qeth_arp_qi_entry7_short cocci_id@p ;
...
position p;
@@
 struct qeth_hdr_layer3 * cocci_id@p ;
