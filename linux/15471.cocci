...
position p;
@@
 struct vme_lm_resource cocci_id@p ;
...
position p;
@@
 struct vme_master_resource * cocci_id@p ;
...
position p;
@@
 struct vme_slave_resource * cocci_id@p ;
...
@@
 struct fake_driver {  struct vme_bridge * parent ;  struct fake_slave_window slaves [ FAKE_MAX_SLAVE ] ;  struct fake_master_window masters [ FAKE_MAX_MASTER ] ;  u32 lm_enabled ;  unsigned long long lm_base ;  u32 lm_aspace ;  u32 lm_cycle ;  void ( * lm_callback [ 4 ] ) ( void * ) ;  void * lm_data [ 4 ] ;  struct tasklet_struct int_tasklet ;  int int_level ;  int int_statid ;  void * crcsr_kernel ;  dma_addr_t crcsr_bus ;  struct mutex vme_int ; } cocci_id@p ;
...
typedef u32;
@@
 struct fake_slave_window {  int enabled ;  unsigned long long vme_base ;  unsigned long long size ;  void * buf_base ;  u32 aspace ;  u32 cycle ; } cocci_id@p ;
...
typedef u32;
@@
 struct fake_master_window {  int enabled ;  unsigned long long vme_base ;  unsigned long long size ;  u32 aspace ;  u32 cycle ;  u32 dwidth ; } cocci_id@p ;
