...
position p;
@@
 struct txx9_clock_event_device * cocci_id@p ;
...
position p;
@@
 struct txx9_clocksource cocci_id@p ;
...
position p;
@@
 struct txx9_clock_event_device {  struct clock_event_device cd ;  struct txx9_tmr_reg __iomem * tmrptr ; } cocci_id@p ;
...
position p;
@@
 struct txx9_clocksource {  struct clocksource cs ;  struct txx9_tmr_reg __iomem * tmrptr ; } cocci_id@p ;
