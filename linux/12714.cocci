...
position p;
@@
 struct qcom_icc_provider {  struct icc_provider provider ;  struct clk_bulk_data * bus_clks ;  int num_clks ; } cocci_id@p ;
...
typedef u64,u16;
@@
 struct qcom_icc_node {  unsigned char * name ;  u16 id ;  u16 links [ QCS404_MAX_LINKS ] ;  u16 num_links ;  u16 buswidth ;  int mas_rpm_id ;  int slv_rpm_id ;  u64 rate ; } cocci_id@p ;
...
position p;
@@
 struct qcom_icc_desc {  struct qcom_icc_node * * nodes ;  size_t num_nodes ; } cocci_id@p ;
