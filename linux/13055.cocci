...
typedef __le32,u8;
@@
 struct smem_info {  u8 magic [ 4 ] ;  __le32 size ;  __le32 base_addr ;  __le32 reserved ;  __le16 num_items ; } cocci_id@p ;
...
position p;
@@
 struct smem_private_entry * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct smem_ptable {  u8 magic [ 4 ] ;  __le32 version ;  __le32 num_entries ;  __le32 reserved [ 5 ] ;  struct smem_ptable_entry entry [ ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct smem_proc_comm {  __le32 command ;  __le32 status ;  __le32 params [ 2 ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct smem_ptable_entry {  __le32 offset ;  __le32 size ;  __le32 flags ;  __le16 host0 ;  __le16 host1 ;  __le32 cacheline ;  __le32 reserved [ 7 ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct smem_global_entry {  __le32 allocated ;  __le32 offset ;  __le32 size ;  __le32 aux_base ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct smem_partition_header {  u8 magic [ 4 ] ;  __le16 host0 ;  __le16 host1 ;  __le32 size ;  __le32 offset_free_uncached ;  __le32 offset_free_cached ;  __le32 reserved [ 3 ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct smem_header {  struct smem_proc_comm proc_comm [ 4 ] ;  __le32 version [ 32 ] ;  __le32 initialized ;  __le32 free_offset ;  __le32 available ;  __le32 reserved ;  struct smem_global_entry toc [ SMEM_ITEM_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct smem_ptable_entry * cocci_id@p ;
...
typedef __le32,u16;
@@
 struct smem_private_entry {  u16 canary ;  __le16 item ;  __le32 size ;  __le16 padding_data ;  __le16 padding_hdr ;  __le32 reserved ; } cocci_id@p ;
...
position p;
@@
 struct smem_global_entry * cocci_id@p ;
...
typedef u32;
@@
 struct smem_region {  u32 aux_base ;  void __iomem * virt_base ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 struct smem_partition_header * cocci_id@p ;
