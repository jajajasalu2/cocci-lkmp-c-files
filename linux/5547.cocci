...
position p;
@@
 struct pm8xxx_rtc_regs {  unsigned int ctrl ;  unsigned int write ;  unsigned int read ;  unsigned int alarm_ctrl ;  unsigned int alarm_ctrl2 ;  unsigned int alarm_rw ;  unsigned int alarm_en ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ NUM_8_BIT_RTC_REGS ] ;
...
position p;
@@
 const struct pm8xxx_rtc_regs * cocci_id@p ;
...
@@
 struct pm8xxx_rtc {  struct rtc_device * rtc ;  struct regmap * regmap ;  bool allow_set_time ;  int rtc_alarm_irq ;  const struct pm8xxx_rtc_regs * regs ;  struct device * rtc_dev ;  spinlock_t ctrl_reg_lock ; } cocci_id@p ;
