...
typedef bool,u32;
@@
 const struct igt_coherency_mode {  const char * name ;  int ( * set ) ( struct context * ctx , unsigned long offset , u32 v ) ;  int ( * get ) ( struct context * ctx , unsigned long offset , u32 * v ) ;  bool ( * valid ) ( struct context * ctx ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct context {  struct drm_i915_gem_object * obj ;  struct intel_engine_cs * engine ; } cocci_id@p ;
...
position p;
@@
 const struct igt_coherency_mode * cocci_id@p ;
