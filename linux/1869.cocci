...
typedef u8;
@@
 struct twl4030_madc_conversion_method {  u8 sel ;  u8 avg ;  u8 rbase ;  u8 ctrl ; } cocci_id@p ;
...
typedef bool,u16;
@@
 struct twl4030_madc_request {  unsigned long channels ;  bool do_avg ;  u16 method ;  u16 type ;  bool active ;  bool result_pending ;  bool raw ;  int rbuf [ TWL4030_MADC_MAX_CHANNELS ] ; } cocci_id@p ;
...
position p;
@@
 struct twl4030_madc_data * cocci_id@p ;
...
position p;
@@
 const struct twl4030_madc_conversion_method cocci_id@p [ ] ;
...
position p;
@@
 enum sample_type { TWL4030_MADC_WAIT , TWL4030_MADC_IRQ_ONESHOT , TWL4030_MADC_IRQ_REARM , } cocci_id@p ;
...
position p;
@@
 struct twl4030_madc_request * cocci_id@p ;
...
typedef u8,bool;
@@
 struct twl4030_madc_data {  struct device * dev ;  struct mutex lock ;  struct regulator * usb3v1 ;  struct twl4030_madc_request requests [ TWL4030_MADC_NUM_METHODS ] ;  bool use_second_irq ;  u8 imr ;  u8 isr ; } cocci_id@p ;
...
position p;
@@
 const struct twl4030_prescale_divider_ratios cocci_id@p [ 16 ] ;
...
position p;
@@
 struct twl4030_madc_platform_data * cocci_id@p ;
...
typedef s16;
@@
 struct twl4030_prescale_divider_ratios {  s16 numerator ;  s16 denominator ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct twl4030_madc_request * req ) ;
...
position p;
@@
 enum conversion_methods { TWL4030_MADC_RT , TWL4030_MADC_SW1 , TWL4030_MADC_SW2 , TWL4030_MADC_NUM_METHODS , } cocci_id@p ;
