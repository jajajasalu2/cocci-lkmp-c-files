...
position p;
@@
 enum garp_applicant_state cocci_id@p ;
...
position p;
@@
 struct garp_applicant * cocci_id@p ;
...
position p;
@@
 const struct garp_attr_hdr * cocci_id@p ;
...
position p;
@@
 const struct garp_msg_hdr * cocci_id@p ;
...
typedef u8;
@@
 const struct garp_state_trans {  u8 state ;  u8 action ; } cocci_id@p [ GARP_APPLICANT_MAX + 1 ] [ GARP_EVENT_MAX + 1 ] ;
...
position p;
@@
 struct garp_attr_hdr * cocci_id@p ;
...
position p;
@@
 struct garp_pdu_hdr * cocci_id@p ;
...
position p;
@@
 const struct garp_pdu_hdr * cocci_id@p ;
...
position p;
@@
 struct garp_application * cocci_id@p ;
...
position p;
@@
 const struct garp_application * cocci_id@p ;
...
position p;
@@
 enum garp_attr_event cocci_id@p ;
...
position p;
@@
 struct garp_msg_hdr * cocci_id@p ;
...
position p;
@@
 const struct garp_attr * cocci_id@p ;
...
position p;
@@
 const struct stp_proto * cocci_id@p ;
...
position p;
@@
 const struct garp_applicant * cocci_id@p ;
