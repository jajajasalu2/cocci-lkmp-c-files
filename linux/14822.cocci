...
position p;
@@
 struct berlin2_pll {  struct clk_hw hw ;  void __iomem * base ;  struct berlin2_pll_map map ; } cocci_id@p ;
...
position p;
@@
 struct berlin2_pll_map * cocci_id@p ;
