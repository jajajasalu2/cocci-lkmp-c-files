...
position p;
@@
 struct DeviceCtlBlk * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct AdapterCtlBlk * acb , struct ScsiReqBlk * srb ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct AdapterCtlBlk * acb , u8 did_code , struct scsi_cmnd * cmd , u8 force ) ;
...
position p;
@@
 void cocci_id@p ( struct AdapterCtlBlk * acb , struct DeviceCtlBlk * dcb ) ;
...
position p;
@@
 void cocci_id@p ( struct AdapterCtlBlk * acb , struct DeviceCtlBlk * dcb , struct ScsiReqBlk * srb ) ;
...
typedef u8,u16;
@@
 struct AdapterCtlBlk {  struct Scsi_Host * scsi_host ;  unsigned long io_port_base ;  unsigned long io_port_len ;  struct list_head dcb_list ;  struct DeviceCtlBlk * dcb_run_robin ;  struct DeviceCtlBlk * active_dcb ;  struct list_head srb_free_list ;  struct ScsiReqBlk * tmp_srb ;  struct timer_list waiting_timer ;  struct timer_list selto_timer ;  unsigned long last_reset ;  u16 srb_count ;  u8 sel_timeout ;  unsigned int irq_level ;  u8 tag_max_num ;  u8 acb_flag ;  u8 gmode2 ;  u8 config ;  u8 lun_chk ;  u8 scan_devices ;  u8 hostid_bit ;  u8 dcb_map [ DC395x_MAX_SCSI_ID ] ;  struct DeviceCtlBlk * children [ DC395x_MAX_SCSI_ID ] [ 32 ] ;  struct pci_dev * dev ;  u8 msg_len ;  struct ScsiReqBlk srb_array [ DC395x_MAX_SRB_CNT ] ;  struct ScsiReqBlk srb ;  struct NvRamType eeprom ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct AdapterCtlBlk * acb ) ;
...
@@
 struct ScsiReqBlk {  struct list_head list ;  struct DeviceCtlBlk * dcb ;  struct scsi_cmnd * cmd ;  struct SGentry * segment_x ;  dma_addr_t sg_bus_addr ;  u8 sg_count ;  u8 sg_index ;  size_t total_xfer_length ;  size_t request_length ;  size_t xferred ;  u16 state ;  u8 msgin_buf [ 6 ] ;  u8 msgout_buf [ 6 ] ;  u8 adapter_status ;  u8 target_status ;  u8 msg_count ;  u8 end_message ;  u8 tag_number ;  u8 status ;  u8 retry_count ;  u8 flag ;  u8 scsi_phase ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p ( struct AdapterCtlBlk * acb , struct DeviceCtlBlk * dcb , struct ScsiReqBlk * srb ) ;
...
position p;
@@
 struct ParameterData cocci_id@p [ ] ;
...
position p;
@@
 struct AdapterCtlBlk cocci_id@p ;
...
position p;
@@
 struct ParameterData {  int value ;  int min ;  int max ;  int def ;  int safe ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct NvRamType {  u8 sub_vendor_id [ 2 ] ;  u8 sub_sys_id [ 2 ] ;  u8 sub_class ;  u8 vendor_id [ 2 ] ;  u8 device_id [ 2 ] ;  u8 reserved ;  struct NVRamTarget target [ DC395x_MAX_SCSI_ID ] ;  u8 scsi_id ;  u8 channel_cfg ;  u8 delay_time ;  u8 max_tag ;  u8 reserved0 ;  u8 boot_target ;  u8 boot_lun ;  u8 reserved1 ;  u16 reserved2 [ 22 ] ;  u16 cksum ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct DeviceCtlBlk {  struct list_head list ;  struct AdapterCtlBlk * acb ;  struct list_head srb_going_list ;  struct list_head srb_waiting_list ;  struct ScsiReqBlk * active_srb ;  u32 tag_mask ;  u16 max_command ;  u8 target_id ;  u8 target_lun ;  u8 identify_msg ;  u8 dev_mode ;  u8 inquiry7 ;  u8 sync_mode ;  u8 min_nego_period ;  u8 sync_period ;  u8 sync_offset ;  u8 flag ;  u8 dev_type ;  u8 init_tcq_flag ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * cmd , struct DeviceCtlBlk * dcb , struct ScsiReqBlk * srb ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct AdapterCtlBlk * acb , struct ScsiReqBlk * srb , u16 * pscsi_status ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct AdapterCtlBlk * acb , struct ScsiReqBlk * srb , u16 io_dir ) ;
...
typedef u8;
@@
 struct NVRamTarget {  u8 cfg0 ;  u8 period ;  u8 cfg2 ;  u8 cfg3 ; } cocci_id@p ;
...
typedef u32;
@@
 struct SGentry {  u32 address ;  u32 length ; } cocci_id@p ;
...
typedef u16;
@@
 void ( * cocci_id@p ) ( struct AdapterCtlBlk * , struct ScsiReqBlk * , u16 * ) ;
