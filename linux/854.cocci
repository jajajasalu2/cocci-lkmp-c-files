...
position p;
@@
 struct nand_page_io_req cocci_id@p ;
...
position p;
@@
 const struct nand_page_io_req * cocci_id@p ;
...
position p;
@@
 const struct spinand_op_variants * cocci_id@p ;
...
position p;
@@
 struct spi_mem_dirmap_info cocci_id@p ;
...
position p;
@@
 const struct spinand_manufacturer * cocci_id@p [ ] ;
...
position p;
@@
 struct spinand_device * cocci_id@p ;
...
position p;
@@
 struct nand_io_iter cocci_id@p ;
...
position p;
@@
 const struct spinand_info * cocci_id@p ;
