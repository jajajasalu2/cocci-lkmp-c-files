...
position p;
@@
 enum { OMAP_MCBSP_WORD_8 = 0 , OMAP_MCBSP_WORD_12 , OMAP_MCBSP_WORD_16 , OMAP_MCBSP_WORD_20 , OMAP_MCBSP_WORD_24 , OMAP_MCBSP_WORD_32 , } cocci_id@p ;
...
position p;
@@
 struct omap_mcbsp_platform_data * cocci_id@p ;
...
position p;
@@
 const struct omap_mcbsp_reg_cfg * cocci_id@p ;
...
position p;
@@
 struct omap_mcbsp_reg_cfg * cocci_id@p ;
