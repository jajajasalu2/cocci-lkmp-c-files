...
position p;
@@
 struct stv0297_state * cocci_id@p ;
...
position p;
@@
 const struct stv0297_config * cocci_id@p ;
...
position p;
@@
 struct stv0297_state {  struct i2c_adapter * i2c ;  const struct stv0297_config * config ;  struct dvb_frontend frontend ;  unsigned long last_ber ;  unsigned long base_freq ; } cocci_id@p ;
