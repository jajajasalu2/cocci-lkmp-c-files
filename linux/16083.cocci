...
typedef u8,u32,u16;
@@
 struct s626_private {  u8 ai_cmd_running ;  unsigned int ai_sample_timer ;  int ai_convert_count ;  unsigned int ai_convert_timer ;  u16 counter_int_enabs ;  u8 adc_items ;  struct s626_buffer_dma rps_buf ;  struct s626_buffer_dma ana_buf ;  u32 * dac_wbuf ;  u16 dacpol ;  u8 trim_setpoint [ 12 ] ;  u32 i2c_adrs ; } cocci_id@p ;
...
position p;
@@
 enum { s626_send_dac_wait_not_mc1_a2out , s626_send_dac_wait_ssr_af2_out , s626_send_dac_wait_fb_buffer2_msb_00 , s626_send_dac_wait_fb_buffer2_msb_ff , } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct s626_buffer_dma {  dma_addr_t physical_base ;  void * logical_base ; } cocci_id@p ;
...
position p;
@@
 struct s626_private * cocci_id@p ;
