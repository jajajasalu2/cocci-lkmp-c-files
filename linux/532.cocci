...
position p;
@@
 struct cryptd_skcipher * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef crypto_completion_t;
@@
 crypto_completion_t cocci_id@p ;
...
position p;
@@
 struct cryptd_skcipher_ctx * cocci_id@p ;
...
position p;
@@
 struct crypto_skcipher_spawn * cocci_id@p ;
...
position p;
@@
 struct cryptd_aead_ctx cocci_id@p ;
...
position p;
@@
 struct cryptd_aead_request_ctx cocci_id@p ;
...
position p;
@@
 struct cryptd_cpu_queue {  struct crypto_queue queue ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct cryptd_cpu_queue cocci_id@p ;
...
position p;
@@
 struct crypto_instance * cocci_id@p ;
...
typedef crypto_completion_t;
@@
 struct cryptd_aead_request_ctx {  crypto_completion_t complete ; } cocci_id@p ;
...
position p;
@@
 struct crypto_shash_spawn * cocci_id@p ;
...
position p;
@@
 struct aead_instance * cocci_id@p ;
...
position p;
@@
 struct cryptd_ahash * cocci_id@p ;
...
position p;
@@
 struct hashd_instance_ctx {  struct crypto_shash_spawn spawn ;  struct cryptd_queue * queue ; } cocci_id@p ;
...
typedef refcount_t;
@@
 struct cryptd_aead_ctx {  refcount_t refcnt ;  struct crypto_aead * child ; } cocci_id@p ;
...
typedef refcount_t;
@@
 struct cryptd_hash_ctx {  refcount_t refcnt ;  struct crypto_shash * child ; } cocci_id@p ;
...
position p;
@@
 struct hashd_instance_ctx * cocci_id@p ;
...
typedef crypto_completion_t;
@@
 struct cryptd_hash_request_ctx {  crypto_completion_t complete ;  struct shash_desc desc ; } cocci_id@p ;
...
position p;
@@
 struct cryptd_instance_ctx {  struct crypto_spawn spawn ;  struct cryptd_queue * queue ; } cocci_id@p ;
...
position p;
@@
 struct cryptd_skcipher_request_ctx cocci_id@p ;
...
position p;
@@
 struct cryptd_queue * cocci_id@p ;
...
position p;
@@
 struct cryptd_queue {  struct cryptd_cpu_queue __percpu * cpu_queue ; } cocci_id@p ;
...
position p;
@@
 struct crypto_attr_type * cocci_id@p ;
...
typedef crypto_completion_t;
@@
 struct cryptd_skcipher_request_ctx {  crypto_completion_t complete ; } cocci_id@p ;
...
position p;
@@
 struct ahash_instance * cocci_id@p ;
...
position p;
@@
 struct skcipherd_instance_ctx * cocci_id@p ;
...
position p;
@@
 struct cryptd_hash_ctx cocci_id@p ;
...
position p;
@@
 struct skcipherd_instance_ctx {  struct crypto_skcipher_spawn spawn ;  struct cryptd_queue * queue ; } cocci_id@p ;
...
position p;
@@
 struct crypto_template * cocci_id@p ;
...
position p;
@@
 struct aead_instance_ctx {  struct crypto_aead_spawn aead_spawn ;  struct cryptd_queue * queue ; } cocci_id@p ;
...
position p;
@@
 struct cryptd_hash_request_ctx cocci_id@p ;
...
position p;
@@
 struct crypto_aead_spawn * cocci_id@p ;
...
typedef refcount_t;
@@
 struct cryptd_skcipher_ctx {  refcount_t refcnt ;  struct crypto_sync_skcipher * child ; } cocci_id@p ;
...
position p;
@@
 struct aead_instance_ctx * cocci_id@p ;
...
position p;
@@
 struct skcipher_instance * cocci_id@p ;
...
position p;
@@
 struct cryptd_instance_ctx * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct aead_request * req ) ;
