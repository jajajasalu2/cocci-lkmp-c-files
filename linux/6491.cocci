...
position p;
@@
 const struct regulator_consumer_supply cocci_id@p [ ] ;
...
position p;
@@
 struct wm8994_ldo {  struct regulator_dev * regulator ;  struct wm8994 * wm8994 ;  struct regulator_consumer_supply supply ;  struct regulator_init_data init_data ; } cocci_id@p ;
