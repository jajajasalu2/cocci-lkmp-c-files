...
position p;
@@
 struct dw_edma_desc cocci_id@p ;
...
position p;
@@
 struct dw_edma_transfer * cocci_id@p ;
...
position p;
@@
 struct dw_edma_chunk cocci_id@p ;
...
position p;
@@
 struct dw_edma_region * cocci_id@p ;
...
position p;
@@
 struct dw_edma_burst * cocci_id@p ;
...
position p;
@@
 struct dw_edma_chip * cocci_id@p ;
...
position p;
@@
 struct dw_edma_chan * cocci_id@p ;
