...
position p;
@@
 struct irq_sim_irq_ctx * cocci_id@p ;
...
position p;
@@
 struct irq_sim_work_ctx * cocci_id@p ;
...
position p;
@@
 struct irq_sim_devres * cocci_id@p ;
...
position p;
@@
 struct irq_sim_devres {  struct irq_sim * sim ; } cocci_id@p ;
