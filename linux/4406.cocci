...
position p;
@@
 struct tpm_nsc_priv {  unsigned long base ; } cocci_id@p ;
...
position p;
@@
 enum tpm_nsc_status_loc { NSC_STATUS = 0x01 , NSC_COMMAND = 0x01 , NSC_DATA = 0x00 , } cocci_id@p ;
...
position p;
@@
 enum tpm_nsc_index { NSC_LDN_INDEX = 0x07 , NSC_SID_INDEX = 0x20 , NSC_LDC_INDEX = 0x30 , NSC_DIO_INDEX = 0x60 , NSC_CIO_INDEX = 0x62 , NSC_IRQ_INDEX = 0x70 , NSC_ITS_INDEX = 0x71 , } cocci_id@p ;
...
position p;
@@
 struct tpm_nsc_priv * cocci_id@p ;
...
position p;
@@
 enum tpm_nsc_cmd_mode { NSC_COMMAND_NORMAL = 0x01 , NSC_COMMAND_EOC = 0x03 , NSC_COMMAND_CANCEL = 0x22 , } cocci_id@p ;
...
position p;
@@
 enum tpm_nsc_addr { TPM_NSC_IRQ = 0x07 , TPM_NSC_BASE0_HI = 0x60 , TPM_NSC_BASE0_LO = 0x61 , TPM_NSC_BASE1_HI = 0x62 , TPM_NSC_BASE1_LO = 0x63 , } cocci_id@p ;
...
position p;
@@
 enum tpm_nsc_status { NSC_STATUS_OBF = 0x01 , NSC_STATUS_IBF = 0x02 , NSC_STATUS_F0 = 0x04 , NSC_STATUS_A2 = 0x08 , NSC_STATUS_RDY = 0x10 , NSC_STATUS_IBR = 0x20 , } cocci_id@p ;
