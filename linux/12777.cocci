...
position p;
@@
 struct hv_per_cpu_context * cocci_id@p ;
...
position p;
@@
 const struct vmbus_chan_attribute * cocci_id@p ;
...
position p;
@@
 struct onmessage_work_context * cocci_id@p ;
...
position p;
@@
 struct vmbus_dynid {  struct list_head node ;  struct hv_vmbus_device_id id ; } cocci_id@p ;
...
position p;
@@
 const struct vmbus_channel * cocci_id@p ;
...
position p;
@@
 struct hv_vmbus_device_id * cocci_id@p ;
...
position p;
@@
 struct hv_ring_buffer_debug_info cocci_id@p ;
...
position p;
@@
 struct hv_ring_buffer_info * cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_rescind_offer * cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_msginfo * cocci_id@p ;
...
position p;
@@
 union hv_synic_event_flags * cocci_id@p ;
...
position p;
@@
 struct vmbus_chan_attribute cocci_id@p ;
...
position p;
@@
 struct onmessage_work_context {  struct work_struct work ;  struct hv_message msg ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ VMBUS_ALIAS_LEN + 1 ] ;
...
position p;
@@
 const struct hv_device * cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_message_header * cocci_id@p ;
...
position p;
@@
 const struct vmbus_channel_message_table_entry * cocci_id@p ;
...
position p;
@@
 struct hv_monitor_page * cocci_id@p ;
...
position p;
@@
 const struct hv_monitor_page * cocci_id@p ;
...
position p;
@@
 enum kmsg_dump_reason cocci_id@p ;
...
position p;
@@
 struct vmbus_channel_initiate_contact cocci_id@p ;
