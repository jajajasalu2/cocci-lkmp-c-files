...
position p;
@@
 struct clockgen_pll * cocci_id@p ;
...
typedef s8,u8,u32;
@@
 struct mux_hwclock {  struct clk_hw hw ;  struct clockgen * cg ;  const struct clockgen_muxinfo * info ;  u32 __iomem * reg ;  u8 parent_to_clksel [ NUM_MUX_PARENTS ] ;  s8 clksel_to_parent [ NUM_MUX_PARENTS ] ;  int num_parents ; } cocci_id@p ;
...
position p;
@@
 const struct clockgen_pll_div * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ NUM_MUX_PARENTS ] ;
...
position p;
@@
 struct clockgen_muxinfo {  struct clockgen_sourceinfo clksel [ NUM_MUX_PARENTS ] ; } cocci_id@p ;
...
position p;
@@
 struct clockgen_pll {  struct clockgen_pll_div div [ MAX_PLL_DIV ] ; } cocci_id@p ;
...
position p;
@@
 const struct clockgen_muxinfo cocci_id@p ;
...
position p;
@@
 const struct clockgen_chipinfo cocci_id@p [ ] ;
...
typedef u32;
@@
 struct clockgen_sourceinfo {  u32 flags ;  int pll ;  int div ; } cocci_id@p ;
...
position p;
@@
 struct clockgen_pll_div {  struct clk * clk ;  char name [ 32 ] ; } cocci_id@p ;
