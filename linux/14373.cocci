...
position p;
@@
 struct tda8083_state cocci_id@p ;
...
position p;
@@
 struct tda8083_state {  struct i2c_adapter * i2c ;  const struct tda8083_config * config ;  struct dvb_frontend frontend ; } cocci_id@p ;
...
position p;
@@
 const struct tda8083_config * cocci_id@p ;
