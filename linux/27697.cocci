...
typedef u64;
@@
 struct getdents_callback {  struct dir_context ctx ;  char * name ;  u64 ino ;  int found ;  int sequence ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * context , struct dentry * dentry ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * , struct dentry * ) ;
...
position p;
@@
 int cocci_id@p ( const struct path * path , char * name , struct dentry * child ) ;
