...
position p;
@@
 struct lpc18xx_cgu_src_clk_div cocci_id@p [ ] ;
...
position p;
@@
 enum { CLK_SRC_OSC32 , CLK_SRC_IRC , CLK_SRC_ENET_RX_CLK , CLK_SRC_ENET_TX_CLK , CLK_SRC_GP_CLKIN , CLK_SRC_RESERVED1 , CLK_SRC_OSC , CLK_SRC_PLL0USB , CLK_SRC_PLL0AUDIO , CLK_SRC_PLL1 , CLK_SRC_RESERVED2 , CLK_SRC_RESERVED3 , CLK_SRC_IDIVA , CLK_SRC_IDIVB , CLK_SRC_IDIVC , CLK_SRC_IDIVD , CLK_SRC_IDIVE , CLK_SRC_MAX , } cocci_id@p ;
...
position p;
@@
 struct lpc18xx_cgu_pll_clk cocci_id@p [ ] ;
...
position p;
@@
 struct lpc18xx_cgu_base_clk * cocci_id@p ;
...
@@
 struct lpc18xx_pll {  struct clk_hw hw ;  void __iomem * reg ;  spinlock_t * lock ;  u8 flags ; } cocci_id@p ;
...
typedef u8;
@@
 struct lpc18xx_cgu_base_clk {  u8 clk_id ;  u8 n_parents ;  struct clk_mux mux ;  struct clk_gate gate ; } cocci_id@p ;
...
typedef u8;
@@
 struct lpc18xx_cgu_src_clk_div {  u8 clk_id ;  u8 n_parents ;  struct clk_divider div ;  struct clk_mux mux ;  struct clk_gate gate ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ CLK_SRC_MAX ] ;
...
typedef u8;
@@
 struct lpc18xx_cgu_pll_clk {  u8 clk_id ;  u8 n_parents ;  u8 reg_offset ;  struct clk_mux mux ;  struct clk_gate gate ;  struct lpc18xx_pll pll ;  const struct clk_ops * pll_ops ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ BASE_CLK_MAX ] ;
...
position p;
@@
 struct clk * cocci_id@p [ BASE_CLK_MAX ] ;
