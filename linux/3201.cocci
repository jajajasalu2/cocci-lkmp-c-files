...
typedef s8,u16;
@@
 struct max1668_data {  struct i2c_client * client ;  const struct attribute_group * groups [ 3 ] ;  enum chips type ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  s8 temp_max [ 5 ] ;  s8 temp_min [ 5 ] ;  s8 temp [ 5 ] ;  u16 alarms ; } cocci_id@p ;
...
position p;
@@
 struct max1668_data * cocci_id@p ;
...
position p;
@@
 enum chips { max1668 , max1805 , max1989 , } cocci_id@p ;
