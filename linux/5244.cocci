...
position p;
@@
 struct s3c_ide_info {  struct clk * clk ;  void __iomem * ide_addr ;  void __iomem * sfr_addr ;  int irq ;  enum s3c_cpu_type cpu_type ;  unsigned int fifo_status_reg ; } cocci_id@p ;
...
position p;
@@
 enum s3c_cpu_type { TYPE_S3C64XX , TYPE_S5PV210 , } cocci_id@p ;
...
position p;
@@
 struct s3c_ide_info * cocci_id@p ;
