...
position p;
@@
 struct cfg {  struct list_head funcs ;  int func_num ; } cocci_id@p ;
...
position p;
@@
 struct edge_node {  struct list_head l ;  struct bb_node * src ;  struct bb_node * dst ;  int flags ; } cocci_id@p ;
...
position p;
@@
 struct func_node {  struct list_head l ;  struct list_head bbs ;  struct bpf_insn * start ;  struct bpf_insn * end ;  int idx ;  int bb_num ; } cocci_id@p ;
...
position p;
@@
 struct bb_node {  struct list_head l ;  struct list_head e_prevs ;  struct list_head e_succs ;  struct bpf_insn * head ;  struct bpf_insn * tail ;  int idx ; } cocci_id@p ;
