...
position p;
@@
 enum { DEVICE_VMK8055 , DEVICE_VMK8061 , } cocci_id@p ;
...
position p;
@@
 const struct vmk80xx_board * cocci_id@p ;
...
position p;
@@
 struct vmk80xx_board {  const char * name ;  enum vmk80xx_model model ;  const struct comedi_lrange * range ;  int ai_nchans ;  unsigned int ai_maxdata ;  int ao_nchans ;  int di_nchans ;  unsigned int cnt_maxdata ;  int pwm_nchans ;  unsigned int pwm_maxdata ; } cocci_id@p ;
...
position p;
@@
 struct vmk80xx_private {  struct usb_endpoint_descriptor * ep_rx ;  struct usb_endpoint_descriptor * ep_tx ;  struct semaphore limit_sem ;  unsigned char * usb_rx_buf ;  unsigned char * usb_tx_buf ;  enum vmk80xx_model model ; } cocci_id@p ;
...
position p;
@@
 enum vmk80xx_model { VMK8055_MODEL , VMK8061_MODEL , } cocci_id@p ;
...
position p;
@@
 struct vmk80xx_private * cocci_id@p ;
