...
position p;
@@
 char cocci_id@p [ TLS_HEADER_SIZE + MAX_IV_SIZE ] ;
...
position p;
@@
 struct tls_prot_info * cocci_id@p ;
...
position p;
@@
 struct tls_sw_context_tx * cocci_id@p ;
...
position p;
@@
 struct strp_callbacks cocci_id@p ;
...
position p;
@@
 struct tls12_crypto_info_aes_ccm_128 * cocci_id@p ;
...
position p;
@@
 struct cipher_context * cocci_id@p ;
...
position p;
@@
 struct tls12_crypto_info_aes_gcm_256 * cocci_id@p ;
...
position p;
@@
 struct tls_sw_context_rx * cocci_id@p ;
