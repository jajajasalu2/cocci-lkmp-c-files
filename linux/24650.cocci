...
position p;
@@
 struct xt_quota_priv * cocci_id@p ;
...
position p;
@@
 const struct xt_quota_info * cocci_id@p ;
...
@@
 struct xt_quota_priv {  spinlock_t lock ;  uint64_t quota ; } cocci_id@p ;
...
position p;
@@
 struct xt_quota_info * cocci_id@p ;
