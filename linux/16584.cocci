...
position p;
@@
 void cocci_id@p ( struct evbuf_header * evbuf ) ;
...
position p;
@@
 struct sclp_vt220_sccb * cocci_id@p ;
...
position p;
@@
 struct sclp_vt220_request {  struct list_head list ;  struct sclp_req sclp_req ;  int retry_count ; } cocci_id@p ;
...
position p;
@@
 struct sclp_vt220_sccb {  struct sccb_header header ;  struct evbuf_header evbuf ; } cocci_id@p ;
...
position p;
@@
 struct sclp_vt220_request cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sclp_vt220_request * request ) ;
...
position p;
@@
 void cocci_id@p ( struct sclp_register * reg , enum sclp_pm_event sclp_pm_event ) ;
