...
position p;
@@
 struct caam_drv_req * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct aead_edesc {  int src_nents ;  int dst_nents ;  dma_addr_t iv_dma ;  int qm_sg_bytes ;  dma_addr_t qm_sg_dma ;  unsigned int assoclen ;  dma_addr_t assoclen_dma ;  struct caam_drv_req drv_req ;  struct qm_sg_entry sgt [ 0 ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct caam_alg_entry {  int class1_alg_type ;  int class2_alg_type ;  bool rfc3686 ;  bool geniv ;  bool nodkp ; } cocci_id@p ;
...
position p;
@@
 struct caam_drv_ctx * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct skcipher_edesc {  int src_nents ;  int dst_nents ;  dma_addr_t iv_dma ;  int qm_sg_bytes ;  dma_addr_t qm_sg_dma ;  struct caam_drv_req drv_req ;  struct qm_sg_entry sgt [ 0 ] ; } cocci_id@p ;
