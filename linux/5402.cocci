...
position p;
@@
 struct acpi_spi_lookup cocci_id@p ;
...
position p;
@@
 struct spi_statistics * cocci_id@p ;
...
position p;
@@
 const struct spi_device * cocci_id@p ;
...
position p;
@@
 struct spi_controller * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef spi_replaced_release_t;
@@
 spi_replaced_release_t cocci_id@p ;
...
position p;
@@
 struct boardinfo {  struct list_head list ;  struct spi_board_info board_info ; } cocci_id@p ;
...
position p;
@@
 struct spi_replaced_transfers * cocci_id@p ;
...
position p;
@@
 const struct spi_driver * cocci_id@p ;
...
position p;
@@
 struct of_reconfig_data * cocci_id@p ;
...
position p;
@@
 const struct spi_board_info * cocci_id@p ;
...
typedef u8,u32;
@@
 struct acpi_spi_lookup {  struct spi_controller * ctlr ;  u32 max_speed_hz ;  u32 mode ;  int irq ;  u8 bits_per_word ;  u8 chip_select ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef spi_res_release_t;
@@
 spi_res_release_t cocci_id@p ;
