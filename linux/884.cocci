...
position p;
@@
 struct fsl_ifc_nand_ctrl * cocci_id@p ;
...
position p;
@@
 struct fsl_ifc_ctrl * cocci_id@p ;
...
typedef u8;
@@
 struct fsl_ifc_mtd {  struct nand_chip chip ;  struct fsl_ifc_ctrl * ctrl ;  struct device * dev ;  int bank ;  unsigned int bufnum_mask ;  u8 __iomem * vbase ; } cocci_id@p ;
...
position p;
@@
 struct fsl_ifc_nand_ctrl {  struct nand_controller controller ;  struct fsl_ifc_mtd * chips [ FSL_IFC_BANK_COUNT ] ;  void __iomem * addr ;  unsigned int page ;  unsigned int read_bytes ;  unsigned int column ;  unsigned int index ;  unsigned int oob ;  unsigned int eccread ;  unsigned int counter ;  unsigned int max_bitflips ; } cocci_id@p ;
