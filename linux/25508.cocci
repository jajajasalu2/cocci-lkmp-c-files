...
position p;
@@
 struct kvm_event_stats * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ decode_str_len ] ;
...
position p;
@@
 struct vcpu_event_record * cocci_id@p ;
...
position p;
@@
 struct child_event_ops * cocci_id@p ;
...
position p;
@@
 struct kvm_reg_events_ops * cocci_id@p ;
...
typedef u64;
@@
 struct vcpu_event_record {  int vcpu_id ;  u64 start_time ;  struct kvm_event * last_event ; } cocci_id@p ;
...
position p;
@@
 struct perf_kvm_stat * cocci_id@p ;
...
position p;
@@
 struct kvm_event_key cocci_id@p [ ] ;
...
position p;
@@
 struct exit_reasons_table * cocci_id@p ;
