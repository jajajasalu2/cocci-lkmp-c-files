...
position p;
@@
 struct ep_attribute cocci_id@p ;
...
position p;
@@
 struct ep_device {  struct usb_endpoint_descriptor * desc ;  struct usb_device * udev ;  struct device dev ; } cocci_id@p ;
...
position p;
@@
 struct ep_attribute {  struct attribute attr ;  ssize_t ( * show ) ( struct usb_device * , struct usb_endpoint_descriptor * , char * ) ; } cocci_id@p ;
