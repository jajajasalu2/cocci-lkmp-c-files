...
position p;
@@
 const struct reg_val_mask * cocci_id@p ;
...
position p;
@@
 struct cxd2820r_platform_data * cocci_id@p ;
...
position p;
@@
 struct cxd2820r_priv * cocci_id@p ;
...
position p;
@@
 const struct cxd2820r_config * cocci_id@p ;
