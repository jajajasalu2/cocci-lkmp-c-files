...
position p;
@@
 struct drm_vc4_get_tiling * cocci_id@p ;
...
position p;
@@
 struct drm_vc4_create_bo * cocci_id@p ;
...
position p;
@@
 struct drm_vc4_mmap_bo * cocci_id@p ;
...
position p;
@@
 struct drm_vc4_label_bo * cocci_id@p ;
...
position p;
@@
 struct drm_vc4_set_tiling * cocci_id@p ;
...
position p;
@@
 enum vc4_kernel_bo_type cocci_id@p ;
...
position p;
@@
 struct drm_vc4_create_shader_bo * cocci_id@p ;
