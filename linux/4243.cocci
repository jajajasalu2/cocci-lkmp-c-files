...
position p;
@@
 struct telemetry_evtconfig * cocci_id@p ;
...
position p;
@@
 const struct telemetry_core_ops cocci_id@p ;
...
position p;
@@
 struct telemetry_evtlog * cocci_id@p ;
...
position p;
@@
 struct telem_ssram_region cocci_id@p ;
...
position p;
@@
 struct telemetry_evtmap cocci_id@p [ TELEM_MAX_OS_ALLOCATED_EVENTS ] ;
...
position p;
@@
 enum telemetry_action { TELEM_UPDATE = 0 , TELEM_ADD , TELEM_RESET , TELEM_ACTION_NONE , } cocci_id@p ;
...
typedef u64;
@@
 struct telem_ssram_region {  u64 timestamp ;  u64 start_time ;  u64 events [ TELEM_MAX_EVENTS_SRAM ] ; } cocci_id@p ;
...
position p;
@@
 struct telemetry_plt_config cocci_id@p ;
...
position p;
@@
 enum telemetry_action cocci_id@p ;
...
position p;
@@
 struct telemetry_unit_config * * cocci_id@p ;
...
position p;
@@
 enum telemetry_unit cocci_id@p ;
...
position p;
@@
 struct telemetry_evtmap * cocci_id@p ;
