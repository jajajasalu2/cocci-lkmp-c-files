...
position p;
@@
 struct hinic_pfhwdev cocci_id@p ;
...
position p;
@@
 enum cmdq_scmd_type { CMDQ_SET_ARM_CMD = 2 , } cocci_id@p ;
...
position p;
@@
 struct hinic_func_to_io cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_pages * cocci_id@p ;
...
position p;
@@
 enum hinic_cmdq_type cocci_id@p ;
...
position p;
@@
 enum hinic_mod_type cocci_id@p ;
...
position p;
@@
 enum completion_format { COMPLETE_DIRECT = 0 , COMPLETE_SGE = 1 , } cocci_id@p ;
...
position p;
@@
 enum cmdq_wqe_type { WQE_LCMD_TYPE = 0 , WQE_SCMD_TYPE = 1 , } cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_wqe_scmd * cocci_id@p ;
...
position p;
@@
 enum completion_request { NO_CEQ = 0 , CEQ_SET = 1 , } cocci_id@p ;
...
position p;
@@
 enum ctrl_sect_len { CTRL_SECT_LEN = 1 , CTRL_DIRECT_SECT_LEN = 2 , } cocci_id@p ;
...
position p;
@@
 enum bufdesc_len { BUFDESC_LCMD_LEN = 2 , BUFDESC_SCMD_LEN = 3 , } cocci_id@p ;
...
position p;
@@
 struct hinic_sge_resp * cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_header * cocci_id@p ;
...
position p;
@@
 enum hinic_set_arm_qtype cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_ctxt * cocci_id@p ;
...
position p;
@@
 enum cmdq_cmd_type { CMDQ_CMD_SYNC_DIRECT_RESP = 0 , CMDQ_CMD_SYNC_SGE_RESP = 1 , } cocci_id@p ;
...
position p;
@@
 enum completion_format cocci_id@p ;
...
position p;
@@
 struct hinic_hw_wqe * cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_arm_bit cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_direct_wqe * cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_completion * cocci_id@p ;
...
position p;
@@
 enum data_format { DATA_SGE = 0 , DATA_DIRECT = 1 , } cocci_id@p ;
...
position p;
@@
 struct hinic_status * cocci_id@p ;
...
position p;
@@
 enum hinic_cmd_ack_type cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_ctxt_info * cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_wqe_lcmd * cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_buf * cocci_id@p ;
...
position p;
@@
 struct hinic_cmdq_wqe * cocci_id@p ;
