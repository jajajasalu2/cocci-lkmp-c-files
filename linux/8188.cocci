...
position p;
@@
 struct nix_aq_enq_req * cocci_id@p ;
...
position p;
@@
 struct nix_txsch_alloc_req * cocci_id@p ;
...
position p;
@@
 struct nix_txsch_free_req * cocci_id@p ;
...
position p;
@@
 struct nix_rx_flowkey_alg cocci_id@p ;
...
position p;
@@
 struct nix_mark_format_cfg * cocci_id@p ;
...
position p;
@@
 struct nix_vtag_config * cocci_id@p ;
...
position p;
@@
 struct nix_rss_flowkey_cfg * cocci_id@p ;
...
typedef u16;
@@
 struct mce {  struct hlist_node node ;  u16 pcifunc ; } cocci_id@p ;
...
position p;
@@
 enum mc_tbl_sz { MC_TBL_SZ_256 , MC_TBL_SZ_512 , MC_TBL_SZ_1K , MC_TBL_SZ_2K , MC_TBL_SZ_4K , MC_TBL_SZ_8K , MC_TBL_SZ_16K , MC_TBL_SZ_32K , MC_TBL_SZ_64K , } cocci_id@p ;
...
position p;
@@
 struct hwctx_disable_req * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_alloc_entry_req cocci_id@p ;
...
position p;
@@
 struct nix_aq_enq_rsp * cocci_id@p ;
...
position p;
@@
 struct nix_aq_res_s cocci_id@p ;
...
position p;
@@
 struct nix_txschq_config * cocci_id@p ;
...
position p;
@@
 struct nix_sq_ctx_s cocci_id@p ;
...
position p;
@@
 struct nix_lso_format_cfg_rsp * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_free_entry_req cocci_id@p ;
...
position p;
@@
 struct nix_aq_inst_s * cocci_id@p ;
...
position p;
@@
 struct nix_lf_alloc_rsp * cocci_id@p ;
...
position p;
@@
 struct nix_rq_ctx_s cocci_id@p ;
...
position p;
@@
 struct nix_txsch_alloc_rsp * cocci_id@p ;
...
position p;
@@
 struct nix_rx_mce_s cocci_id@p ;
...
position p;
@@
 struct npc_mcam_alloc_entry_rsp cocci_id@p ;
...
position p;
@@
 enum nix_makr_fmt_indexes { NIX_MARK_CFG_IP_DSCP_RED , NIX_MARK_CFG_IP_DSCP_YELLOW , NIX_MARK_CFG_IP_DSCP_YELLOW_RED , NIX_MARK_CFG_IP_ECN_RED , NIX_MARK_CFG_IP_ECN_YELLOW , NIX_MARK_CFG_IP_ECN_YELLOW_RED , NIX_MARK_CFG_VLAN_DEI_RED , NIX_MARK_CFG_VLAN_DEI_YELLOW , NIX_MARK_CFG_VLAN_DEI_YELLOW_RED , NIX_MARK_CFG_MAX , } cocci_id@p ;
...
typedef bool,u16;
@@
 int cocci_id@p ( struct rvu * rvu , u16 pcifunc , bool add ) ;
...
position p;
@@
 struct nix_cq_ctx_s cocci_id@p ;
...
position p;
@@
 struct nix_mark_format_cfg_rsp * cocci_id@p ;
...
position p;
@@
 enum mc_buf_cnt { MC_BUF_CNT_8 , MC_BUF_CNT_16 , MC_BUF_CNT_32 , MC_BUF_CNT_64 , MC_BUF_CNT_128 , MC_BUF_CNT_256 , MC_BUF_CNT_512 , MC_BUF_CNT_1024 , MC_BUF_CNT_2048 , } cocci_id@p ;
...
position p;
@@
 struct nix_lso_format_cfg * cocci_id@p ;
...
position p;
@@
 struct nix_lso_format cocci_id@p ;
...
position p;
@@
 struct nix_rss_flowkey_cfg_rsp * cocci_id@p ;
...
position p;
@@
 struct nix_set_mac_addr * cocci_id@p ;
...
position p;
@@
 struct nix_lf_alloc_req * cocci_id@p ;
...
position p;
@@
 struct nix_mce_list * cocci_id@p ;
