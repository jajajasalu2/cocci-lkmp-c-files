...
position p;
@@
 enum jz4780_cookie { COOKIE_UNMAPPED = 0 , COOKIE_PREMAPPED , COOKIE_MAPPED , } cocci_id@p ;
...
position p;
@@
 enum jz4740_mmc_version { JZ_MMC_JZ4740 , JZ_MMC_JZ4725B , JZ_MMC_JZ4760 , JZ_MMC_JZ4780 , JZ_MMC_X1000 , } cocci_id@p ;
...
position p;
@@
 struct jz4740_mmc_host * cocci_id@p ;
...
position p;
@@
 enum jz4740_mmc_version cocci_id@p ;
...
position p;
@@
 enum jz4740_mmc_state { JZ4740_MMC_STATE_READ_RESPONSE , JZ4740_MMC_STATE_TRANSFER_DATA , JZ4740_MMC_STATE_SEND_STOP , JZ4740_MMC_STATE_DONE , } cocci_id@p ;
