...
position p;
@@
 enum task_disposition cocci_id@p ;
...
position p;
@@
 enum task_disposition { TASK_IS_DONE , TASK_IS_ABORTED , TASK_IS_AT_LU , TASK_IS_NOT_AT_LU , TASK_ABORT_FAILED , } cocci_id@p ;
