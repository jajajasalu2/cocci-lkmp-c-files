...
position p;
@@
 const struct iio_channel * cocci_id@p ;
...
position p;
@@
 struct iio_map_internal {  struct iio_dev * indio_dev ;  struct iio_map * map ;  struct list_head l ; } cocci_id@p ;
...
position p;
@@
 enum iio_chan_info_enum cocci_id@p ;
...
position p;
@@
 struct iio_map_internal * cocci_id@p ;
