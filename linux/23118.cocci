...
position p;
@@
 struct samsung_spdif_info * cocci_id@p ;
...
@@
 struct samsung_spdif_info {  spinlock_t lock ;  struct device * dev ;  void __iomem * regs ;  unsigned long clk_rate ;  struct clk * pclk ;  struct clk * sclk ;  u32 saved_clkcon ;  u32 saved_con ;  u32 saved_cstas ;  struct snd_dmaengine_dai_dma_data * dma_playback ; } cocci_id@p ;
