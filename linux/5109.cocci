...
typedef spinlock_t;
@@
 struct amd_fch_gpio_priv {  struct gpio_chip gc ;  void __iomem * base ;  struct amd_fch_gpio_pdata * pdata ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct amd_fch_gpio_priv * cocci_id@p ;
