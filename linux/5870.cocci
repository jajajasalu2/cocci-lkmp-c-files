...
position p;
@@
 struct s3c24xx_eint_domain_data * cocci_id@p ;
...
position p;
@@
 struct s3c24xx_eint_data * cocci_id@p ;
...
typedef irq_flow_handler_t;
@@
 irq_flow_handler_t cocci_id@p [ NUM_EINT_IRQ ] ;
...
position p;
@@
 struct s3c24xx_eint_data {  struct samsung_pinctrl_drv_data * drvdata ;  struct irq_domain * domains [ NUM_EINT ] ;  int parents [ NUM_EINT_IRQ ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct s3c24xx_eint_domain_data {  struct samsung_pin_bank * bank ;  struct s3c24xx_eint_data * eint_data ;  bool eint0_3_parent_only ; } cocci_id@p ;
