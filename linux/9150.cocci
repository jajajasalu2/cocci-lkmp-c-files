...
position p;
@@
 struct mlxsw_sp_acl_atcam_lkey_id * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam_lkey_id_ht_key * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam_region_generic {  struct mlxsw_sp_acl_atcam_lkey_id dummy_lkey_id ; } cocci_id@p ;
...
@@
 struct mlxsw_sp_acl_atcam_lkey_id {  struct rhash_head ht_node ;  struct mlxsw_sp_acl_atcam_lkey_id_ht_key ht_key ;  refcount_t refcnt ;  u32 id ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam_chunk * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam_entry_ht_key cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam_region_generic * cocci_id@p ;
...
typedef u8;
@@
 struct mlxsw_sp_acl_atcam_lkey_id_ht_key {  char enc_key [ MLXSW_REG_PTCEX_FLEX_KEY_BLOCKS_LEN ] ;  u8 erp_id ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PERAR_LEN ] ;
...
position p;
@@
 const struct mlxsw_sp_acl_ctcam_region_ops * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_atcam_entry * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam_region_12kb {  struct rhashtable lkey_ht ;  unsigned int max_lkey_id ;  unsigned long * used_lkey_id ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_atcam_region_12kb * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_acl_atcam_region_ops * cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PTCE3_LEN ] ;
...
typedef u8;
@@
 struct mlxsw_sp_acl_atcam_region_ops {  int ( * init ) ( struct mlxsw_sp_acl_atcam_region * aregion ) ;  void ( * fini ) ( struct mlxsw_sp_acl_atcam_region * aregion ) ;  struct mlxsw_sp_acl_atcam_lkey_id * ( * lkey_id_get ) ( struct mlxsw_sp_acl_atcam_region * aregion , char * enc_key , u8 erp_id ) ;  void ( * lkey_id_put ) ( struct mlxsw_sp_acl_atcam_region * aregion , struct mlxsw_sp_acl_atcam_lkey_id * lkey_id ) ; } cocci_id@p ;
