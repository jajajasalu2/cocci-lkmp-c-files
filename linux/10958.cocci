...
typedef bool;
@@
 void cocci_id@p ( struct amdgpu_ring * ring , bool start ) ;
...
position p;
@@
 struct v10_compute_mqd * cocci_id@p ;
...
position p;
@@
 struct v10_ce_ib_state cocci_id@p ;
...
position p;
@@
 struct v10_gfx_meta_data cocci_id@p ;
...
position p;
@@
 RLC_TABLE_OF_CONTENT * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct amdgpu_ring * ring , bool resume ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct amdgpu_device * adev ) ;
...
position p;
@@
 enum amdgpu_unmap_queues_action cocci_id@p ;
...
position p;
@@
 const struct kiq_pm4_funcs cocci_id@p ;
...
position p;
@@
 struct v10_de_ib_state cocci_id@p ;
...
position p;
@@
 const struct sdma_firmware_header_v1_0 * cocci_id@p ;
...
position p;
@@
 struct {  FIRMWARE_ID id ;  unsigned int offset ;  unsigned int size ; } cocci_id@p [ FIRMWARE_ID_MAX ] ;
