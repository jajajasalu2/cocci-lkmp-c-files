...
position p;
@@
 enum wakeup_type { AT91_SHDW_WKMODE0_NONE = 0 , AT91_SHDW_WKMODE0_HIGH = 1 , AT91_SHDW_WKMODE0_LOW = 2 , AT91_SHDW_WKMODE0_ANYLEVEL = 3 , } cocci_id@p ;
...
position p;
@@
 struct shdwc {  struct clk * sclk ;  void __iomem * shdwc_base ;  void __iomem * mpddrc_base ; } cocci_id@p ;
