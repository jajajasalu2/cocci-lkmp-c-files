...
position p;
@@
 unsigned char cocci_id@p [ TIME_NUM ] ;
...
position p;
@@
 struct max8925_rtc_info {  struct rtc_device * rtc_dev ;  struct max8925_chip * chip ;  struct i2c_client * rtc ;  struct device * dev ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct max8925_rtc_info * cocci_id@p ;
