...
position p;
@@
 struct region {  unsigned int start ;  unsigned int off ;  unsigned int group_len ;  unsigned int end ; } cocci_id@p ;
...
position p;
@@
 enum { REG_OP_ISFREE , REG_OP_ALLOC , REG_OP_RELEASE , } cocci_id@p ;
