...
position p;
@@
 enum { DIV4_SIUA , DIV4_SIUB , DIV4_REPARENT_NR , } cocci_id@p ;
...
position p;
@@
 struct clk cocci_id@p [ DIV4_REPARENT_NR ] ;
...
position p;
@@
 enum { DIV4_IRDA , DIV4_ENABLE_NR , } cocci_id@p ;
...
position p;
@@
 enum { DIV6_V , DIV6_NR , } cocci_id@p ;
...
position p;
@@
 struct clk cocci_id@p [ HWBLK_NR ] ;
...
position p;
@@
 struct clk cocci_id@p [ DIV4_ENABLE_NR ] ;
...
position p;
@@
 enum { DIV4_I , DIV4_U , DIV4_SH , DIV4_B , DIV4_B3 , DIV4_P , DIV4_NR , } cocci_id@p ;
