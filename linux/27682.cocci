...
position p;
@@
 int cocci_id@p ( struct inode * inode , int do_sync ) ;
...
position p;
@@
 struct {  __le32 * p ;  __le32 key ;  struct buffer_head * bh ; } cocci_id@p ;
...
position p;
@@
 struct ext2_block_alloc_info * cocci_id@p ;
