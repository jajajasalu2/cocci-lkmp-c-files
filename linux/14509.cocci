...
position p;
@@
 struct composite_cfg * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,pclk_t;
@@
 struct pclk_t {  u32 gate_offset ;  u8 bit_idx ;  const char * name ;  const char * parent ;  u32 flags ; } cocci_id@p ;
...
typedef u8;
@@
 struct stm32_ready_gate {  struct clk_gate gate ;  u8 bit_rdy ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,composite_clk_gcfg_t;
@@
 struct composite_clk_gcfg_t {  u8 flags ;  const struct clk_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct composite_clk_gcfg cocci_id@p ;
...
position p;
@@
 const struct composite_clk_cfg cocci_id@p [ 3 ] [ 3 ] ;
...
position p;
@@
 struct stm32_fractional_divider * cocci_id@p ;
...
position p;
@@
 const struct composite_clk_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct stm32_ready_gate * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct stm32_pll_obj {  spinlock_t * lock ;  struct stm32_fractional_divider div ;  struct stm32_ready_gate rgate ;  struct clk_hw hw ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct muxdiv_cfg {  u32 offset ;  u8 shift ;  u8 width ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct st32h7_pll_cfg {  u8 bit_idx ;  u32 offset_divr ;  u8 bit_frac_en ;  u32 offset_frac ;  u8 divm ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct gate_cfg {  u32 offset ;  u8 bit_idx ; } cocci_id@p ;
...
position p;
@@
 struct composite_cfg {  struct clk_hw * mux_hw ;  struct clk_hw * div_hw ;  struct clk_hw * gate_hw ;  const struct clk_ops * mux_ops ;  const struct clk_ops * div_ops ;  const struct clk_ops * gate_ops ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct stm32_mux_clk {  const char * name ;  const char * const * parents ;  u8 num_parents ;  u32 offset ;  u8 shift ;  u8 width ;  u32 flags ; } cocci_id@p ;
...
@@
 struct timer_ker {  u8 dppre_shift ;  struct clk_hw hw ;  spinlock_t * lock ; } cocci_id@p ;
...
position p;
@@
 const struct st32h7_pll_cfg * cocci_id@p ;
...
typedef u8,u32;
@@
 struct stm32_osc_clk {  const char * name ;  const char * parent ;  u32 gate_offset ;  u8 bit_idx ;  u8 bit_rdy ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_pll_data cocci_id@p [ ] ;
...
position p;
@@
 struct stm32_pll_data {  const char * name ;  const char * parent_name ;  unsigned long flags ;  const struct st32h7_pll_cfg * cfg ; } cocci_id@p ;
...
position p;
@@
 const struct composite_clk_gcfg * cocci_id@p ;
...
typedef u32;
@@
 struct composite_clk_cfg {  struct gate_cfg * gate ;  struct muxdiv_cfg * mux ;  struct muxdiv_cfg * div ;  const char * name ;  const char * const * parent_name ;  int num_parents ;  u32 flags ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef composite_clk_gcfg_t;
@@
 struct composite_clk_gcfg {  struct composite_clk_gcfg_t * mux ;  struct composite_clk_gcfg_t * div ;  struct composite_clk_gcfg_t * gate ; } cocci_id@p ;
...
typedef pclk_t;
@@
 const struct pclk_t cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef u8,u32,spinlock_t;
@@
 struct stm32_fractional_divider {  void __iomem * mreg ;  u8 mshift ;  u8 mwidth ;  u32 mmask ;  void __iomem * nreg ;  u8 nshift ;  u8 nwidth ;  void __iomem * freg_status ;  u8 freg_bit ;  void __iomem * freg_value ;  u8 fshift ;  u8 fwidth ;  u8 flags ;  struct clk_hw hw ;  spinlock_t * lock ; } cocci_id@p ;
