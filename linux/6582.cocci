...
position p;
@@
 struct iscsi_ecdb_ahdr * cocci_id@p ;
...
position p;
@@
 enum { FAILURE_BAD_HOST = 1 , FAILURE_SESSION_FAILED , FAILURE_SESSION_FREED , FAILURE_WINDOW_CLOSED , FAILURE_OOM , FAILURE_SESSION_TERMINATE , FAILURE_SESSION_IN_RECOVERY , FAILURE_SESSION_RECOVERY_TIMEOUT , FAILURE_SESSION_LOGGING_OUT , FAILURE_SESSION_NOT_READY , } cocci_id@p ;
...
position p;
@@
 struct iscsi_r2t_info * cocci_id@p ;
