...
position p;
@@
 struct pstore_record * cocci_id@p ;
...
position p;
@@
 struct erst_record_id_cache cocci_id@p ;
...
position p;
@@
 struct acpi_table_erst * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pstore_info * psi ) ;
...
position p;
@@
 struct cper_record_header * cocci_id@p ;
...
typedef u64;
@@
 struct erst_record_id_cache {  struct mutex lock ;  u64 * entries ;  int len ;  int size ;  int refcount ; } cocci_id@p ;
...
position p;
@@
 struct acpi_erst_entry cocci_id@p ;
...
position p;
@@
 struct cper_pstore_record cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pstore_record * record ) ;
...
position p;
@@
 ssize_t cocci_id@p ( struct pstore_record * record ) ;
...
typedef u64,u32;
@@
 struct erst_erange {  u64 base ;  u64 size ;  void __iomem * vaddr ;  u32 attr ; } cocci_id@p ;
...
position p;
@@
 const struct cper_record_header * cocci_id@p ;
