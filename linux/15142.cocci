...
position p;
@@
 struct vfio_iommu_type1_dma_map cocci_id@p ;
...
position p;
@@
 struct vfio_iommu_type1_info_cap_iova_range * cocci_id@p ;
...
position p;
@@
 struct vfio_iommu_type1_dma_unmap cocci_id@p ;
...
symbol cocci_id;
position p;
typedef atomic_t,dma_addr_t;
@@
 struct vfio_pfn {  struct rb_node node ;  dma_addr_t iova ;  unsigned long pfn ;  atomic_t ref_count ; } cocci_id@p ;
...
@@
 struct vfio_dma {  struct rb_node node ;  dma_addr_t iova ;  unsigned long vaddr ;  size_t size ;  int prot ;  bool iommu_mapped ;  bool lock_cap ;  struct task_struct * task ;  struct rb_root pfn_list ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long pfn , int prot ) ;
...
typedef bool;
@@
 struct vfio_group {  struct iommu_group * iommu_group ;  struct list_head next ;  bool mdev_group ; } cocci_id@p ;
...
@@
 struct vfio_regions {  struct list_head list ;  dma_addr_t iova ;  phys_addr_t phys ;  size_t len ; } cocci_id@p ;
...
typedef bool;
@@
 struct vfio_domain {  struct iommu_domain * domain ;  struct list_head next ;  struct list_head group_list ;  int prot ;  bool fgsp ; } cocci_id@p ;
...
position p;
@@
 struct vm_area_struct * cocci_id@p [ 1 ] ;
...
typedef dma_addr_t;
@@
 struct vfio_iova {  struct list_head list ;  dma_addr_t start ;  dma_addr_t end ; } cocci_id@p ;
...
position p;
@@
 struct vfio_regions * cocci_id@p ;
...
position p;
@@
 struct vfio_iommu_type1_info cocci_id@p ;
...
position p;
@@
 struct device * ( * cocci_id@p ) ( struct device * dev ) ;
...
typedef bool;
@@
 struct vfio_iommu {  struct list_head domain_list ;  struct list_head iova_list ;  struct vfio_domain * external_domain ;  struct mutex lock ;  struct rb_root dma_list ;  struct blocking_notifier_head notifier ;  unsigned int dma_avail ;  bool v2 ;  bool nesting ; } cocci_id@p ;
