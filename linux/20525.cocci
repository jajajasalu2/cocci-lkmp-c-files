...
position p;
@@
 struct twofish_xts_ctx * cocci_id@p ;
...
typedef u8,le128;
@@
 void cocci_id@p ( struct twofish_ctx * ctx , u8 * dst , const u8 * src , le128 * iv ) ;
...
position p;
@@
 struct simd_skcipher_alg * cocci_id@p [ ARRAY_SIZE ( twofish_algs ) ] ;
...
position p;
@@
 struct twofish_xts_ctx {  struct twofish_ctx tweak_ctx ;  struct twofish_ctx crypt_ctx ; } cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct twofish_ctx * ctx , u8 * dst , const u8 * src ) ;
