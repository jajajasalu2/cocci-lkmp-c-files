...
position p;
@@
 struct hrtimer_cpu_base * cocci_id@p ;
...
position p;
@@
 struct hrtimer_clock_base * cocci_id@p ;
...
position p;
@@
 enum hrtimer_restart ( * cocci_id@p ) ( struct hrtimer * ) ;
...
position p;
@@
 const int cocci_id@p [ MAX_CLOCKS ] ;
...
position p;
@@
 const struct hrtimer * cocci_id@p ;
...
position p;
@@
 const enum hrtimer_mode cocci_id@p ;
