...
position p;
@@
 struct pci_ecam_ops cocci_id@p ;
...
position p;
@@
 struct al_pcie_acpi * cocci_id@p ;
...
@@
 struct al_pcie {  struct dw_pcie * pci ;  void __iomem * controller_base ;  struct device * dev ;  resource_size_t ecam_size ;  unsigned int controller_rev_id ;  struct al_pcie_reg_offsets reg_offsets ;  struct al_pcie_target_bus_cfg target_bus_cfg ; } cocci_id@p ;
...
position p;
@@
 struct al_pcie_reg_offsets {  unsigned int ob_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct al_pcie_acpi {  void __iomem * dbi_base ; } cocci_id@p ;
...
position p;
@@
 struct al_pcie_target_bus_cfg * cocci_id@p ;
...
typedef u8;
@@
 struct al_pcie_target_bus_cfg {  u8 reg_val ;  u8 reg_mask ;  u8 ecam_mask ; } cocci_id@p ;
...
position p;
@@
 struct pci_config_window * cocci_id@p ;
