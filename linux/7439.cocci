...
position p;
@@
 unsigned short SISIOMEMTYPE * cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 8 * 3 ] ;
...
position p;
@@
 struct SiS_VBVCLKData * cocci_id@p ;
...
position p;
@@
 unsigned char SISIOMEMTYPE * cocci_id@p ;
...
position p;
@@
 const unsigned short cocci_id@p [ 6 ] ;
