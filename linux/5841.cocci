...
position p;
@@
 const union vin_data cocci_id@p ;
...
position p;
@@
 const struct {  struct sh_pfc_pin_group common [ 247 ] ;  struct sh_pfc_pin_group automotive [ 21 ] ; } cocci_id@p ;
...
position p;
@@
 const struct pinmux_bias_reg * cocci_id@p ;
...
position p;
@@
 const union vin_data16 cocci_id@p ;
...
position p;
@@
 enum ioctrl_regs { POCCTRL0 , TDSELCTRL , } cocci_id@p ;
...
position p;
@@
 const struct pinmux_ioctrl_reg cocci_id@p [ ] ;
...
position p;
@@
 const struct {  struct sh_pfc_function common [ 47 ] ;  struct sh_pfc_function automotive [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct sh_pfc_soc_operations cocci_id@p ;
