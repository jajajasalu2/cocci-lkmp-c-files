...
position p;
@@
 struct sq_gather_subdesc * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rbdr_entry_t;
@@
 struct rbdr_entry_t cocci_id@p ;
...
position p;
@@
 struct sq_hdr_subdesc * cocci_id@p ;
...
position p;
@@
 struct sq_imm_subdesc * cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct snd_queue * sq , int qentry , int size , u64 data ) ;
