...
typedef region_t;
@@
 struct dm_raid1_bio_record {  struct mirror * m ;  struct dm_bio_details details ;  region_t write_region ; } cocci_id@p ;
...
position p;
@@
 enum dm_raid1_error { DM_RAID1_WRITE_ERROR , DM_RAID1_FLUSH_ERROR , DM_RAID1_SYNC_ERROR , DM_RAID1_READ_ERROR , } cocci_id@p ;
...
position p;
@@
 struct dm_dirty_log * cocci_id@p ;
...
@@
 struct mirror {  struct mirror_set * ms ;  atomic_t error_count ;  unsigned long error_type ;  struct dm_dev * dev ;  sector_t offset ; } cocci_id@p ;
...
position p;
@@
 enum dm_raid1_error cocci_id@p ;
...
position p;
@@
 struct dm_io_region cocci_id@p [ MAX_NR_MIRRORS ] ;
...
position p;
@@
 char cocci_id@p [ MAX_NR_MIRRORS + 1 ] ;
...
position p;
@@
 struct dm_raid1_bio_record * cocci_id@p ;
