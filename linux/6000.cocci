...
typedef u16;
@@
 u16 cocci_id@p [ ARRAY_SIZE ( lpc18xx_pins ) ] ;
...
position p;
@@
 const struct pin_config_item cocci_id@p [ ARRAY_SIZE ( lpc18xx_params ) ] ;
...
position p;
@@
 enum { TYPE_ND , TYPE_HD , TYPE_HS , TYPE_I2C0 , TYPE_USB1 , } cocci_id@p ;
...
position p;
@@
 struct lpc18xx_scu_data * cocci_id@p ;
...
position p;
@@
 struct lpc18xx_pin_caps {  unsigned int offset ;  unsigned char functions [ LPC18XX_SCU_FUNC_PER_PIN ] ;  unsigned char analog ;  unsigned char type ; } cocci_id@p ;
...
position p;
@@
 enum { PIN_CLK0 = 600 , PIN_CLK1 , PIN_CLK2 , PIN_CLK3 , PIN_USB1_DM , PIN_USB1_DP , PIN_I2C0_SCL , PIN_I2C0_SDA , } cocci_id@p ;
...
position p;
@@
 struct lpc18xx_scu_data {  struct pinctrl_dev * pctl ;  void __iomem * base ;  struct clk * clk ;  struct lpc18xx_pmx_func func [ FUNC_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct lpc18xx_pmx_func {  const char * * groups ;  unsigned ngroups ; } cocci_id@p ;
...
position p;
@@
 struct lpc18xx_pin_caps * cocci_id@p ;
