...
position p;
@@
 struct max6639_platform_data * cocci_id@p ;
...
position p;
@@
 struct max6639_data * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct max6639_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  u16 temp [ 2 ] ;  bool temp_fault [ 2 ] ;  u8 fan [ 2 ] ;  u8 status ;  u8 pwm [ 2 ] ;  u8 temp_therm [ 2 ] ;  u8 temp_alert [ 2 ] ;  u8 temp_ot [ 2 ] ;  u8 ppr ;  u8 rpm_range ; } cocci_id@p ;
