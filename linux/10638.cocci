...
position p;
@@
 struct intel_gvt_firmware * cocci_id@p ;
...
position p;
@@
 struct gvt_firmware_header * cocci_id@p ;
...
typedef u64,u32;
@@
 struct gvt_firmware_header {  u64 magic ;  u32 crc32 ;  u32 version ;  u64 cfg_space_size ;  u64 cfg_space_offset ;  u64 mmio_size ;  u64 mmio_offset ;  unsigned char data [ 1 ] ; } cocci_id@p ;
