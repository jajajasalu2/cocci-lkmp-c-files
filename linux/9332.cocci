...
position p;
@@
 struct wl1271_cmd_sched_scan_start * cocci_id@p ;
...
position p;
@@
 struct wl1271_cmd_trigger_scan_to * cocci_id@p ;
...
position p;
@@
 struct conf_scan_settings * cocci_id@p ;
...
position p;
@@
 struct basic_scan_channel_params * cocci_id@p ;
...
position p;
@@
 struct conf_sched_scan_settings * cocci_id@p ;
...
position p;
@@
 struct wl1271_cmd_sched_scan_config * cocci_id@p ;
...
position p;
@@
 struct wlcore_scan_channels * cocci_id@p ;
...
position p;
@@
 struct wl1271_cmd_scan * cocci_id@p ;
...
position p;
@@
 struct wl1271_cmd_sched_scan_stop * cocci_id@p ;
