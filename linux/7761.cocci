...
position p;
@@
 struct icom_adapter * cocci_id@p ;
...
position p;
@@
 struct xmit_status_area cocci_id@p ;
...
position p;
@@
 struct lookup_int_table cocci_id@p [ 4 ] ;
...
position p;
@@
 struct lookup_proc_table cocci_id@p [ 4 ] ;
