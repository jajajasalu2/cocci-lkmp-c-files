...
position p;
@@
 struct qxl_surface_create * cocci_id@p ;
...
@@
 struct qxl_ring {  struct ring * ring ;  int element_size ;  int n_elements ;  int prod_notify ;  wait_queue_head_t * push_event ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct qxl_surface_cmd * cocci_id@p ;
...
position p;
@@
 const struct qxl_rect * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qxl_device * qdev , int max_to_reap ) ;
...
typedef uint8_t;
@@
 struct ring {  struct qxl_ring_header header ;  uint8_t elements [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 volatile struct qxl_ring_header * cocci_id@p ;
...
position p;
@@
 struct qxl_ring_header * cocci_id@p ;
