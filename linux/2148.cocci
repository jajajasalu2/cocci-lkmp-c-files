...
position p;
@@
 struct lp8788_chg_param * cocci_id@p ;
...
position p;
@@
 struct lp8788_charger_platform_data * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ LP8788_MAX_CHG_STATE ] ;
...
position p;
@@
 enum lp8788_charger_input_state { LP8788_SYSTEM_SUPPLY = 1 , LP8788_FULL_FUNCTION , } cocci_id@p ;
...
position p;
@@
 enum lp8788_charger_event cocci_id@p ;
...
position p;
@@
 enum lp8788_charger_adc_sel { LP8788_VBATT , LP8788_BATT_TEMP , LP8788_NUM_CHG_ADC , } cocci_id@p ;
...
position p;
@@
 enum lp8788_charging_state { LP8788_OFF , LP8788_WARM_UP , LP8788_LOW_INPUT = 0x3 , LP8788_PRECHARGE , LP8788_CC , LP8788_CV , LP8788_MAINTENANCE , LP8788_BATTERY_FAULT , LP8788_SYSTEM_SUPPORT = 0xC , LP8788_HIGH_CURRENT = 0xF , LP8788_MAX_CHG_STATE , } cocci_id@p ;
...
position p;
@@
 struct lp8788_charger {  struct lp8788 * lp ;  struct power_supply * charger ;  struct power_supply * battery ;  struct work_struct charger_work ;  struct iio_channel * chan [ LP8788_NUM_CHG_ADC ] ;  struct lp8788_chg_irq irqs [ LP8788_MAX_CHG_IRQS ] ;  int num_irqs ;  struct lp8788_charger_platform_data * pdata ; } cocci_id@p ;
...
position p;
@@
 enum lp8788_charging_state cocci_id@p ;
...
position p;
@@
 struct lp8788_chg_irq {  enum lp8788_int_id which ;  int virq ; } cocci_id@p ;
...
position p;
@@
 struct lp8788_charger * cocci_id@p ;
