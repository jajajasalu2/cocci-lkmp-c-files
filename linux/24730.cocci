...
position p;
@@
 const struct nft_synproxy * cocci_id@p ;
...
position p;
@@
 struct nft_synproxy cocci_id@p ;
...
position p;
@@
 struct nf_synproxy_info * cocci_id@p ;
...
position p;
@@
 struct nft_synproxy {  struct nf_synproxy_info info ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_SYNPROXY_MAX + 1 ] ;
