...
position p;
@@
 struct owl_uart_port * cocci_id@p ;
...
position p;
@@
 struct owl_uart_port {  struct uart_port port ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 struct owl_uart_info {  unsigned int tx_fifosize ; } cocci_id@p ;
...
position p;
@@
 const struct owl_uart_info cocci_id@p ;
...
position p;
@@
 struct owl_uart_port * cocci_id@p [ OWL_UART_PORT_NUM ] ;
