...
typedef u8;
@@
 struct cnr {  u8 cn_reg ;  u8 cn_val ; } cocci_id@p ;
...
position p;
@@
 struct mb86a16_state cocci_id@p ;
...
position p;
@@
 struct mb86a16_state {  struct i2c_adapter * i2c_adap ;  const struct mb86a16_config * config ;  struct dvb_frontend frontend ;  int frequency ;  int srate ;  int master_clk ;  int deci ;  int csel ;  int rsel ; } cocci_id@p ;
