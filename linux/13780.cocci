...
position p;
@@
 struct tda7432 {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  struct {  struct v4l2_ctrl * bass ;  struct v4l2_ctrl * treble ; } ;  struct {  struct v4l2_ctrl * mute ;  struct v4l2_ctrl * balance ; } ; } cocci_id@p ;
