...
position p;
@@
 const struct ad799x_chip_info cocci_id@p [ ] ;
...
position p;
@@
 enum { ad7991 , ad7995 , ad7999 , ad7992 , ad7993 , ad7994 , ad7997 , ad7998 , } cocci_id@p ;
...
position p;
@@
 struct ad799x_chip_info {  int num_channels ;  const struct ad799x_chip_config noirq_config ;  const struct ad799x_chip_config irq_config ; } cocci_id@p ;
...
typedef u16;
@@
 struct ad799x_chip_config {  const struct iio_chan_spec channel [ 9 ] ;  u16 default_config ;  const struct iio_info * info ; } cocci_id@p ;
...
position p;
@@
 struct ad799x_state * cocci_id@p ;
...
typedef u8,u16;
@@
 struct ad799x_state {  struct i2c_client * client ;  const struct ad799x_chip_config * chip_config ;  struct regulator * reg ;  struct regulator * vref ;  unsigned id ;  u16 config ;  u8 * rx_buf ;  unsigned int transfer_size ; } cocci_id@p ;
