...
position p;
@@
 struct st_ahci_drv_data * cocci_id@p ;
...
position p;
@@
 struct st_ahci_drv_data {  struct platform_device * ahci ;  struct reset_control * pwr ;  struct reset_control * sw_rst ;  struct reset_control * pwr_rst ; } cocci_id@p ;
