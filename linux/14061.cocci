...
position p;
@@
 struct venc_vpu_ipi_msg_init * cocci_id@p ;
...
position p;
@@
 struct venc_ap_ipi_msg_enc cocci_id@p ;
...
position p;
@@
 struct venc_vpu_ipi_msg_enc * cocci_id@p ;
...
position p;
@@
 struct venc_ap_ipi_msg_init cocci_id@p ;
...
position p;
@@
 struct venc_ap_ipi_msg_set_param cocci_id@p ;
...
position p;
@@
 struct venc_vpu_ipi_msg_common * cocci_id@p ;
...
position p;
@@
 struct venc_vpu_inst * cocci_id@p ;
...
position p;
@@
 struct venc_ap_ipi_msg_deinit cocci_id@p ;
