...
typedef u8;
@@
 const u8 cocci_id@p [ CM36651_PS_REG_NUM ] ;
...
position p;
@@
 enum cm36651_light_channel_idx { CM36651_LIGHT_CHANNEL_IDX_RED , CM36651_LIGHT_CHANNEL_IDX_GREEN , CM36651_LIGHT_CHANNEL_IDX_BLUE , CM36651_LIGHT_CHANNEL_IDX_CLEAR , } cocci_id@p ;
...
position p;
@@
 enum cm36651_command { CM36651_CMD_READ_RAW_LIGHT , CM36651_CMD_READ_RAW_PROXIMITY , CM36651_CMD_PROX_EV_EN , CM36651_CMD_PROX_EV_DIS , } cocci_id@p ;
...
position p;
@@
 enum cm36651_operation_mode { CM36651_LIGHT_EN , CM36651_PROXIMITY_EN , CM36651_PROXIMITY_EV_EN , } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ CM36651_CS_CONF_REG_NUM ] ;
...
position p;
@@
 struct cm36651_data * cocci_id@p ;
