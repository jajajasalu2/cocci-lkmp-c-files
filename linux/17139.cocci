...
position p;
@@
 int cocci_id@p ( struct clock_event_device * evt ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long evt , struct clock_event_device * dev ) ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct clocksource * ) ;
...
typedef u64;
@@
 void ( * cocci_id@p ) ( struct dtl_entry * , u64 ) ;
...
position p;
@@
 struct cpu_accounting_data * cocci_id@p ;
