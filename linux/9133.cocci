...
position p;
@@
 struct mlx5_db_pgdir * cocci_id@p ;
...
position p;
@@
 struct mlx5_buf_list cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct mlx5_db_pgdir {  struct list_head list ;  unsigned long * bitmap ;  __be32 * db_page ;  dma_addr_t db_dma ; } cocci_id@p ;
