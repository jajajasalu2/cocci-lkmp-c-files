...
position p;
@@
 struct symbol * cocci_id@p [ HASH_BUCKETS ] ;
...
position p;
@@
 struct string_list * cocci_id@p ( struct string_list * start , ... ) ;
...
position p;
@@
 struct string_list * cocci_id@p ( const char * string ) ;
...
position p;
@@
 void cocci_id@p ( enum symbol_type type , const char * name ) ;
...
position p;
@@
 const struct {  int n ;  const char * name ; } cocci_id@p [ ] ;
...
typedef FILE;
@@
 void cocci_id@p ( FILE * f , struct string_list * list ) ;
...
position p;
@@
 int cocci_id@p ( struct string_list * a , struct string_list * b ) ;
