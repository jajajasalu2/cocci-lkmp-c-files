...
position p;
@@
 int cocci_id@p ( struct s5p_jpeg_buffer * buf , unsigned int * word ) ;
...
position p;
@@
 int cocci_id@p ( struct s5p_jpeg_ctx * ctx , struct v4l2_rect * r ) ;
...
position p;
@@
 const unsigned char cocci_id@p [ 12 ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ 162 ] ;
...
position p;
@@
 struct s5p_jpeg_q_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct s5p_jpeg_buffer * buf ) ;
...
position p;
@@
 struct s5p_jpeg_buffer * cocci_id@p ;
...
position p;
@@
 struct s5p_jpeg_variant * cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 4 ] [ 64 ] ;
...
position p;
@@
 int cocci_id@p ( struct s5p_jpeg_ctx * ctx ) ;
...
position p;
@@
 enum v4l2_jpeg_chroma_subsampling cocci_id@p ;
...
position p;
@@
 struct s5p_jpeg_addr cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ S5P_JPEG_MAX_MARKER ] ;
...
position p;
@@
 void cocci_id@p ( struct s5p_jpeg_buffer * buf , long len ) ;
...
position p;
@@
 struct v4l2_m2m_ops cocci_id@p ;
...
position p;
@@
 struct s5p_jpeg_ctx * cocci_id@p ;
...
position p;
@@
 struct s5p_jpeg_fmt * cocci_id@p ;
...
typedef __u32;
@@
 struct s5p_jpeg_fmt * cocci_id@p ( struct s5p_jpeg_ctx * ctx , __u32 pixelformat , unsigned int fmt_type ) ;
