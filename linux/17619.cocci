...
position p;
@@
 struct assoc_arrays * cocci_id@p ;
...
position p;
@@
 struct topology_update_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ NR_CPUS ] [ MAX_DISTANCE_REF_POINTS ] ;
...
@@
 cpumask_var_t cocci_id@p [ MAX_NUMNODES ] ;
...
typedef u32,__be32;
@@
 struct assoc_arrays {  u32 n_arrays ;  u32 array_sz ;  const __be32 * arrays ; } cocci_id@p ;
...
position p;
@@
 struct topology_update_data {  struct topology_update_data * next ;  unsigned int cpu ;  int old_nid ;  int new_nid ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MAX_NUMNODES ] [ MAX_DISTANCE_REF_POINTS ] ;
