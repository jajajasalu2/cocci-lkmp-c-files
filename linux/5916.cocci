...
position p;
@@
 struct pxa_pinctrl_function * cocci_id@p ;
...
position p;
@@
 const struct pxa_desc_pin * cocci_id@p ;
...
position p;
@@
 struct pxa_pinctrl_group * cocci_id@p ;
...
position p;
@@
 const struct pxa_pinctrl_function * cocci_id@p ;
...
position p;
@@
 struct pxa_desc_function * cocci_id@p ;
