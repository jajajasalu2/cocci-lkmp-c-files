...
position p;
@@
 struct hi6220_mbox_chan * cocci_id@p ;
...
typedef bool;
@@
 struct hi6220_mbox {  struct device * dev ;  int irq ;  bool tx_irq_mode ;  void __iomem * ipc ;  void __iomem * base ;  unsigned int chan_num ;  struct hi6220_mbox_chan * mchan ;  void * irq_map_chan [ MBOX_CHAN_MAX ] ;  struct mbox_chan * chan ;  struct mbox_controller controller ; } cocci_id@p ;
