...
position p;
@@
 struct ad5272_cfg {  int max_pos ;  int kohms ;  int shift ; } cocci_id@p ;
...
position p;
@@
 enum ad5272_type { AD5272_020 , AD5272_050 , AD5272_100 , AD5274_020 , AD5274_100 , } cocci_id@p ;
...
typedef u8;
@@
 struct ad5272_data {  struct i2c_client * client ;  struct mutex lock ;  const struct ad5272_cfg * cfg ;  u8 buf [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 const struct ad5272_cfg cocci_id@p [ ] ;
