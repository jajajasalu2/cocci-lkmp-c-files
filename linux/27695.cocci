...
position p;
@@
 struct char_device_struct cocci_id@p ;
...
position p;
@@
 struct char_device_struct {  struct char_device_struct * next ;  unsigned int major ;  unsigned int baseminor ;  int minorct ;  char name [ 64 ] ;  struct cdev * cdev ; } * cocci_id@p [ CHRDEV_MAJOR_HASH_SIZE ] ;
