...
position p;
@@
 struct rwrt_feature_desc * cocci_id@p ;
...
position p;
@@
 struct modesel_head cocci_id@p ;
...
position p;
@@
 struct mrw_feature_desc * cocci_id@p ;
...
position p;
@@
 enum cdrom_print_option cocci_id@p ;
...
position p;
@@
 struct media_event_desc * cocci_id@p ;
...
position p;
@@
 struct cdrom_read_audio cocci_id@p ;
...
position p;
@@
 struct cdrom_subchnl cocci_id@p ;
...
position p;
@@
 struct cdrom_sysctl_settings {  char info [ CDROM_STR_SIZE ] ;  int autoclose ;  int autoeject ;  int debug ;  int lock ;  int check ; } cocci_id@p ;
...
position p;
@@
 struct cdrom_changer_info * cocci_id@p ;
...
position p;
@@
 struct event_header * cocci_id@p ;
...
position p;
@@
 struct cdrom_volctrl cocci_id@p ;
...
position p;
@@
 struct cdrom_mechstat_header cocci_id@p ;
...
position p;
@@
 struct feature_header cocci_id@p ;
...
position p;
@@
 struct mode_page_header * cocci_id@p ;
...
position p;
@@
 enum cdrom_print_option { CTL_NAME , CTL_SPEED , CTL_SLOTS , CTL_CAPABILITY , } cocci_id@p ;
