...
typedef s32;
@@
 struct drm_out_fence_state {  s32 __user * out_fence_ptr ;  struct sync_file * sync_file ;  int fd ; } cocci_id@p ;
...
position p;
@@
 struct drm_writeback_connector * cocci_id@p ;
...
position p;
@@
 struct drm_out_fence_state * * cocci_id@p ;
...
position p;
@@
 struct drm_color_ctm cocci_id@p ;
...
position p;
@@
 struct drm_mode_atomic * cocci_id@p ;
