...
position p;
@@
 int cocci_id@p ( struct se_cmd * se_cmd ) ;
...
position p;
@@
 struct tcm_loop_cmd * cocci_id@p ;
...
position p;
@@
 struct tcm_loop_hba * cocci_id@p ;
...
position p;
@@
 struct tcm_loop_tpg cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ TL_WWN_ADDR_LEN ] ;
...
position p;
@@
 struct tcm_loop_nexus * cocci_id@p ;
