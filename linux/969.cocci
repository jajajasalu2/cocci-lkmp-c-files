...
typedef u_long;
@@
 int cocci_id@p ( struct mtd_blktrans_dev * dev , u_long sector , char * buf ) ;
...
symbol cocci_id;
position p;
typedef u_long,u_int,u16;
@@
 struct partition {  struct mtd_blktrans_dev mbd ;  u_int block_size ;  u_int total_blocks ;  u_int header_sectors_per_block ;  u_int data_sectors_per_block ;  u_int sector_count ;  u_int header_size ;  int reserved_block ;  int current_block ;  u16 * header_cache ;  int is_reclaiming ;  int cylinders ;  int errors ;  u_long * sector_map ;  struct block * blocks ; } cocci_id@p ;
...
typedef u_long;
@@
 struct block {  enum { BLOCK_OK , BLOCK_ERASING , BLOCK_ERASED , BLOCK_UNUSED , BLOCK_FAILED , } state ;  int free_sectors ;  int used_sectors ;  int erases ;  u_long offset ; } cocci_id@p ;
...
position p;
@@
 const struct partition * cocci_id@p ;
