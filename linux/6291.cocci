...
position p;
@@
 struct adp5520_platform_data * cocci_id@p ;
...
position p;
@@
 struct adp5520_chip * cocci_id@p ;
...
typedef uint8_t;
@@
 struct adp5520_chip {  struct i2c_client * client ;  struct device * dev ;  struct mutex lock ;  struct blocking_notifier_head notifier_list ;  int irq ;  unsigned long id ;  uint8_t mode ; } cocci_id@p ;
