...
position p;
@@
 enum { P_BI_TCXO , P_CORE_BI_PLL_TEST_SE , P_DISP_CC_PLL0_OUT_MAIN , P_DSI0_PHY_PLL_OUT_BYTECLK , P_DSI0_PHY_PLL_OUT_DSICLK , P_DSI1_PHY_PLL_OUT_BYTECLK , P_DSI1_PHY_PLL_OUT_DSICLK , P_GPLL0_OUT_MAIN , P_GPLL0_OUT_MAIN_DIV , } cocci_id@p ;
...
position p;
@@
 struct alpha_pll_config cocci_id@p ;
