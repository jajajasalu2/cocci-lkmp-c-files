...
typedef u8;
@@
 struct msdc_delay_phase {  u8 maxlen ;  u8 start ;  u8 final_phase ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,spinlock_t;
@@
 struct msdc_host {  struct device * dev ;  const struct mtk_mmc_compatible * dev_comp ;  struct mmc_host * mmc ;  int cmd_rsp ;  spinlock_t lock ;  struct mmc_request * mrq ;  struct mmc_command * cmd ;  struct mmc_data * data ;  int error ;  void __iomem * base ;  void __iomem * top_base ;  struct msdc_dma dma ;  u64 dma_mask ;  u32 timeout_ns ;  u32 timeout_clks ;  struct pinctrl * pinctrl ;  struct pinctrl_state * pins_default ;  struct pinctrl_state * pins_uhs ;  struct delayed_work req_timeout ;  int irq ;  struct clk * src_clk ;  struct clk * h_clk ;  struct clk * bus_clk ;  struct clk * src_clk_cg ;  u32 mclk ;  u32 src_clk_freq ;  unsigned char timing ;  bool vqmmc_enabled ;  u32 latch_ck ;  u32 hs400_ds_delay ;  u32 hs200_cmd_int_delay ;  u32 hs400_cmd_int_delay ;  bool hs400_cmd_resp_sel_rising ;  bool hs400_mode ;  bool internal_cd ;  struct msdc_save_para save_para ;  struct msdc_tune_para def_tune_para ;  struct msdc_tune_para saved_tune_para ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct mtk_mmc_compatible {  u8 clk_div_bits ;  bool hs400_tune ;  u32 pad_tune_reg ;  bool async_fifo ;  bool data_tune ;  bool busy_check ;  bool stop_clk_fix ;  bool enhance_rx ;  bool support_64g ;  bool use_internal_cd ; } cocci_id@p ;
...
typedef u32;
@@
 struct msdc_save_para {  u32 msdc_cfg ;  u32 iocon ;  u32 sdc_cfg ;  u32 pad_tune ;  u32 patch_bit0 ;  u32 patch_bit1 ;  u32 patch_bit2 ;  u32 pad_ds_tune ;  u32 pad_cmd_tune ;  u32 emmc50_cfg0 ;  u32 emmc50_cfg3 ;  u32 sdc_fifo_cfg ;  u32 emmc_top_control ;  u32 emmc_top_cmd ;  u32 emmc50_pad_ds_tune ; } cocci_id@p ;
...
position p;
@@
 struct msdc_delay_phase cocci_id@p ;
...
position p;
@@
 struct mt_bdma_desc cocci_id@p ;
...
typedef u32;
@@
 struct msdc_tune_para {  u32 iocon ;  u32 pad_tune ;  u32 pad_cmd_tune ;  u32 emmc_top_control ;  u32 emmc_top_cmd ; } cocci_id@p ;
...
position p;
@@
 struct mt_gpdma_desc cocci_id@p ;
...
position p;
@@
 const struct mmc_host_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct msdc_host * host , struct mmc_request * mrq , struct mmc_command * cmd ) ;
...
typedef dma_addr_t;
@@
 struct msdc_dma {  struct scatterlist * sg ;  struct mt_gpdma_desc * gpd ;  struct mt_bdma_desc * bd ;  dma_addr_t gpd_addr ;  dma_addr_t bd_addr ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_mmc_compatible cocci_id@p ;
