...
position p;
@@
 void cocci_id@p ( struct usbhid_device * usbhid ) ;
...
position p;
@@
 void cocci_id@p ( struct hid_device * hid ) ;
...
position p;
@@
 int cocci_id@p ( struct hid_device * hid ) ;
...
position p;
@@
 char * cocci_id@p [ MAX_USBHID_BOOT_QUIRKS ] ;
...
position p;
@@
 struct hid_class_descriptor cocci_id@p ;
