...
position p;
@@
 const struct clk_muxing_soc_desc * cocci_id@p ;
...
position p;
@@
 const struct coreclk_soc_desc cocci_id@p ;
...
position p;
@@
 struct clk_muxing_ctrl * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct clk_muxing_ctrl {  spinlock_t * lock ;  struct clk * * muxes ;  int num_muxes ; } cocci_id@p ;
...
position p;
@@
 struct clk_muxing_soc_desc {  const char * name ;  const char * * parents ;  int num_parents ;  int shift ;  int width ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 enum { KIRKWOOD_CPU_TO_L2 , KIRKWOOD_CPU_TO_DDR , } cocci_id@p ;
