...
position p;
@@
 struct lpc_driver_ops cocci_id@p ;
...
typedef u8;
@@
 struct lpc_driver_ops {  u8 ( * read ) ( unsigned int offset , unsigned int length , u8 * dest ) ;  u8 ( * write ) ( unsigned int offset , unsigned int length , const u8 * msg ) ; } cocci_id@p ;
...
position p;
@@
 struct ec_lpc_host_args cocci_id@p ;
