...
position p;
@@
 struct routing_scheme_item {  int vid ;  int aud ; } cocci_id@p ;
...
position p;
@@
 const struct routing_scheme * cocci_id@p ;
...
position p;
@@
 const struct routing_scheme_item cocci_id@p [ ] ;
...
position p;
@@
 struct routing_scheme {  const struct routing_scheme_item * def ;  unsigned int cnt ; } cocci_id@p ;
