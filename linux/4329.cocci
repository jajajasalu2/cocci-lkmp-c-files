...
position p;
@@
 const struct backlight_properties cocci_id@p ;
...
position p;
@@
 struct fujitsu_laptop * cocci_id@p ;
...
position p;
@@
 struct fujitsu_bl {  struct input_dev * input ;  char phys [ 32 ] ;  struct backlight_device * bl_device ;  unsigned int max_brightness ;  unsigned int brightness_level ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct fujitsu_laptop {  struct input_dev * input ;  char phys [ 32 ] ;  struct platform_device * pf_device ;  struct kfifo fifo ;  spinlock_t fifo_lock ;  int flags_supported ;  int flags_state ; } cocci_id@p ;
