...
typedef u32;
@@
 struct respQ_e {  u32 BufferLength ;  u32 GenerationBit : 1 ;  u32 Sop : 1 ;  u32 Eop : 1 ;  u32 Offload : 1 ;  u32 DataValid : 1 ;  u32 CreditValid : 1 ;  u32 FreelistQid : 2 ;  u32 Cmdq0DmaComplete : 5 ;  u32 Cmdq0CreditReturn : 5 ;  u32 Cmdq1DmaComplete : 5 ;  u32 Cmdq1CreditReturn : 5 ;  u32 Qsleeping : 4 ; } cocci_id@p ;
...
position p;
@@
 struct sched_port {  unsigned int avail ;  unsigned int drain_bits_per_1024ns ;  unsigned int speed ;  unsigned int mtu ;  struct sk_buff_head skbq ; } cocci_id@p ;
...
typedef ktime_t;
@@
 struct sched {  ktime_t last_updated ;  unsigned int max_avail ;  unsigned int port ;  unsigned int num ;  struct sched_port p [ MAX_NPORTS ] ;  struct tasklet_struct sched_tsk ; } cocci_id@p ;
...
position p;
@@
 const struct ethhdr * cocci_id@p ;
...
position p;
@@
 const struct respQ_e * cocci_id@p ;
...
position p;
@@
 const struct freelQ * cocci_id@p ;
...
position p;
@@
 struct cpl_tx_pkt_lso cocci_id@p ;
...
position p;
@@
 const struct cpl_rx_pkt * cocci_id@p ;
...
position p;
@@
 const struct sge_intr_counts * cocci_id@p ;
...
position p;
@@
 struct cmdQ_ce {  struct sk_buff * skb ;  DEFINE_DMA_UNMAP_ADDR ( dma_addr ) ;  DEFINE_DMA_UNMAP_LEN ( dma_len ) ; } cocci_id@p ;
...
position p;
@@
 const struct adapter * cocci_id@p ;
...
typedef u32;
@@
 struct cmdQ_e {  u32 addr_lo ;  u32 len_gen ;  u32 flags ;  u32 addr_hi ; } cocci_id@p ;
...
typedef u32;
@@
 struct freelQ_e {  u32 addr_lo ;  u32 len_gen ;  u32 gen2 ;  u32 addr_hi ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u16,spinlock_t,dma_addr_t;
@@
 struct cmdQ {  unsigned long status ;  unsigned int in_use ;  unsigned int size ;  unsigned int processed ;  unsigned int cleaned ;  unsigned int stop_thres ;  u16 pidx ;  u16 cidx ;  u8 genbit ;  u8 sop ;  struct cmdQ_e * entries ;  struct cmdQ_ce * centries ;  dma_addr_t dma_addr ;  spinlock_t lock ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u16,dma_addr_t;
@@
 struct respQ {  unsigned int credits ;  unsigned int size ;  u16 cidx ;  u8 genbit ;  struct respQ_e * entries ;  dma_addr_t dma_addr ; } cocci_id@p ;
...
typedef u32;
@@
 struct cmdQ_e {  u32 len_gen ;  u32 addr_lo ;  u32 addr_hi ;  u32 flags ; } cocci_id@p ;
...
typedef u32;
@@
 struct freelQ_e {  u32 len_gen ;  u32 addr_lo ;  u32 addr_hi ;  u32 gen2 ; } cocci_id@p ;
...
position p;
@@
 struct freelQ_ce {  struct sk_buff * skb ;  DEFINE_DMA_UNMAP_ADDR ( dma_addr ) ;  DEFINE_DMA_UNMAP_LEN ( dma_len ) ; } cocci_id@p ;
...
typedef u8,u16,dma_addr_t;
@@
 struct freelQ {  unsigned int credits ;  unsigned int size ;  u16 pidx ;  u16 cidx ;  u16 rx_buffer_size ;  u16 dma_offset ;  u16 recycleq_idx ;  u8 genbit ;  struct freelQ_e * entries ;  struct freelQ_ce * centries ;  dma_addr_t dma_addr ; } cocci_id@p ;
...
typedef u32;
@@
 struct respQ_e {  u32 Qsleeping : 4 ;  u32 Cmdq1CreditReturn : 5 ;  u32 Cmdq1DmaComplete : 5 ;  u32 Cmdq0CreditReturn : 5 ;  u32 Cmdq0DmaComplete : 5 ;  u32 FreelistQid : 2 ;  u32 CreditValid : 1 ;  u32 DataValid : 1 ;  u32 Offload : 1 ;  u32 Eop : 1 ;  u32 Sop : 1 ;  u32 GenerationBit : 1 ;  u32 BufferLength ; } cocci_id@p ;
...
position p;
@@
 enum { CMDQ_STAT_RUNNING = 1 , CMDQ_STAT_LAST_PKT_DB = 2 , } cocci_id@p ;
...
position p;
@@
 const struct freelQ_ce * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ SGE_CMDQ_N ] ;
...
position p;
@@
 struct sge_port_stats cocci_id@p ;
...
typedef u32;
@@
 struct sge {  struct adapter * adapter ;  struct net_device * netdev ;  struct freelQ freelQ [ SGE_FREELQ_N ] ;  struct respQ respQ ;  unsigned long stopped_tx_queues ;  unsigned int rx_pkt_pad ;  unsigned int jumbo_fl ;  unsigned int intrtimer_nres ;  unsigned int fixed_intrtimer ;  struct timer_list tx_reclaim_timer ;  struct timer_list espibug_timer ;  unsigned long espibug_timeout ;  struct sk_buff * espibug_skb [ MAX_NPORTS ] ;  u32 sge_control ;  struct sge_intr_counts stats ;  struct sge_port_stats __percpu * port_stats [ MAX_NPORTS ] ;  struct sched * tx_sched ;  struct cmdQ cmdQ [ SGE_CMDQ_N ] ____cacheline_aligned_in_smp ; } cocci_id@p ;
