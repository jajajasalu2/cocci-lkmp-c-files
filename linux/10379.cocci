...
position p;
@@
 enum mtk_dpi_out_bit_num { MTK_DPI_OUT_BIT_NUM_8BITS , MTK_DPI_OUT_BIT_NUM_10BITS , MTK_DPI_OUT_BIT_NUM_12BITS , MTK_DPI_OUT_BIT_NUM_16BITS , } cocci_id@p ;
...
typedef u16;
@@
 struct mtk_dpi_yc_limit {  u16 y_top ;  u16 y_bottom ;  u16 c_top ;  u16 c_bottom ; } cocci_id@p ;
...
position p;
@@
 struct mtk_dpi_yc_limit cocci_id@p ;
...
position p;
@@
 enum mtk_dpi_out_bit_num cocci_id@p ;
...
position p;
@@
 struct mtk_dpi_sync_param * cocci_id@p ;
...
position p;
@@
 enum mtk_dpi_out_yc_map { MTK_DPI_OUT_YC_MAP_RGB , MTK_DPI_OUT_YC_MAP_CYCY , MTK_DPI_OUT_YC_MAP_YCYC , MTK_DPI_OUT_YC_MAP_CY , MTK_DPI_OUT_YC_MAP_YC , } cocci_id@p ;
...
position p;
@@
 enum mtk_dpi_out_yc_map cocci_id@p ;
...
position p;
@@
 const struct mtk_dpi_conf cocci_id@p ;
...
position p;
@@
 struct mtk_ddp_comp * cocci_id@p ;
...
position p;
@@
 struct mtk_dpi_polarities cocci_id@p ;
...
position p;
@@
 enum mtk_dpi_out_channel_swap cocci_id@p ;
...
typedef bool,u32;
@@
 struct mtk_dpi_sync_param {  u32 sync_width ;  u32 front_porch ;  u32 back_porch ;  bool shift_half_line ; } cocci_id@p ;
...
position p;
@@
 struct mtk_dpi_polarities {  enum mtk_dpi_polarity de_pol ;  enum mtk_dpi_polarity ck_pol ;  enum mtk_dpi_polarity hsync_pol ;  enum mtk_dpi_polarity vsync_pol ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct mtk_dpi_conf {  unsigned int ( * cal_factor ) ( int clock ) ;  u32 reg_h_fre_con ;  bool edge_sel_en ; } cocci_id@p ;
...
position p;
@@
 struct mtk_dpi_conf * cocci_id@p ;
...
position p;
@@
 const struct mtk_ddp_comp_funcs cocci_id@p ;
...
position p;
@@
 enum mtk_dpi_out_color_format { MTK_DPI_COLOR_FORMAT_RGB , MTK_DPI_COLOR_FORMAT_RGB_FULL , MTK_DPI_COLOR_FORMAT_YCBCR_444 , MTK_DPI_COLOR_FORMAT_YCBCR_422 , MTK_DPI_COLOR_FORMAT_XV_YCC , MTK_DPI_COLOR_FORMAT_YCBCR_444_FULL , MTK_DPI_COLOR_FORMAT_YCBCR_422_FULL , } cocci_id@p ;
...
position p;
@@
 enum mtk_dpi_polarity { MTK_DPI_POLARITY_RISING , MTK_DPI_POLARITY_FALLING , } cocci_id@p ;
...
position p;
@@
 enum mtk_dpi_out_channel_swap { MTK_DPI_OUT_CHANNEL_SWAP_RGB , MTK_DPI_OUT_CHANNEL_SWAP_GBR , MTK_DPI_OUT_CHANNEL_SWAP_BRG , MTK_DPI_OUT_CHANNEL_SWAP_RBG , MTK_DPI_OUT_CHANNEL_SWAP_GRB , MTK_DPI_OUT_CHANNEL_SWAP_BGR , } cocci_id@p ;
...
position p;
@@
 enum mtk_dpi_out_color_format cocci_id@p ;
