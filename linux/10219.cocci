...
@@
 struct socket_info_t * cocci_id@p ( int slot , struct pccard_operations * vtable , int use_bus_pm ) ;
...
symbol cocci_id;
position p;
typedef socket_cap_t;
@@
 socket_cap_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef vrc4173_socket_t;
@@
 vrc4173_socket_t cocci_id@p [ CARDU_MAX_SOCKETS ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * , unsigned int ) ;
...
typedef socket_info_t;
@@
 void cocci_id@p ( struct socket_info_t * s ) ;
