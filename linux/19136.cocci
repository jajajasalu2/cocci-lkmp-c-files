...
position p;
@@
 struct nfeth_private {  int ethX ; } cocci_id@p ;
...
position p;
@@
 struct nfeth_private * cocci_id@p ;
...
position p;
@@
 enum { GET_VERSION = 0 , XIF_INTLEVEL , XIF_IRQ , XIF_START , XIF_STOP , XIF_READLENGTH , XIF_READBLOCK , XIF_WRITEBLOCK , XIF_GET_MAC , XIF_GET_IPHOST , XIF_GET_IPATARI , XIF_GET_NETMASK , } cocci_id@p ;
...
position p;
@@
 struct net_device * cocci_id@p [ MAX_UNIT ] ;
