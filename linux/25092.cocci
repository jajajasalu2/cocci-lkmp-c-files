...
position p;
@@
 int ( * cocci_id@p ) ( struct ieee80211_low_level_stats * stats , char * buf , int buflen ) ;
...
position p;
@@
 char cocci_id@p [ DEBUGFS_FORMAT_BUFFER_SIZE ] ;
...
position p;
@@
 char cocci_id@p [ IEEE80211_MAX_QUEUES * 20 ] ;
