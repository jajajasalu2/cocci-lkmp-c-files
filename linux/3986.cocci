...
position p;
@@
 struct fpga_irq_data cocci_id@p [ CONFIG_VERSATILE_FPGA_IRQ_NR ] ;
...
typedef u8,u32;
@@
 struct fpga_irq_data {  void __iomem * base ;  struct irq_chip chip ;  u32 valid ;  struct irq_domain * domain ;  u8 used_irqs ; } cocci_id@p ;
...
position p;
@@
 struct fpga_irq_data * cocci_id@p ;
