...
typedef bool,u32;
@@
 struct brcmstb_gisb_arb_device {  void __iomem * base ;  const int * gisb_offsets ;  bool big_endian ;  struct mutex lock ;  struct list_head next ;  u32 valid_mask ;  const char * master_names [ sizeof ( u32 ) * BITS_PER_BYTE ] ;  u32 saved_timeout ; } cocci_id@p ;
...
position p;
@@
 struct brcmstb_gisb_arb_device * cocci_id@p ;
...
position p;
@@
 enum { ARB_TIMER , ARB_ERR_CAP_CLR , ARB_ERR_CAP_HI_ADDR , ARB_ERR_CAP_ADDR , ARB_ERR_CAP_STATUS , ARB_ERR_CAP_MASTER , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * self , unsigned long v , void * p ) ;
