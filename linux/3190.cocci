...
position p;
@@
 const struct max31790_data * cocci_id@p ;
...
position p;
@@
 struct max31790_data cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct max31790_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  u8 fan_config [ NR_CHANNEL ] ;  u8 fan_dynamics [ NR_CHANNEL ] ;  u16 fault_status ;  u16 tach [ NR_CHANNEL * 2 ] ;  u16 pwm [ NR_CHANNEL ] ;  u16 target_count [ NR_CHANNEL ] ; } cocci_id@p ;
