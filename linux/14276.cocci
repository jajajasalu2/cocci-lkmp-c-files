...
typedef u32;
@@
 struct cx24110_state {  struct i2c_adapter * i2c ;  const struct cx24110_config * config ;  struct dvb_frontend frontend ;  u32 lastber ;  u32 lastbler ;  u32 lastesn0 ; } cocci_id@p ;
...
position p;
@@
 struct cx24110_state * cocci_id@p ;
...
position p;
@@
 const struct cx24110_config * cocci_id@p ;
