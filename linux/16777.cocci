...
position p;
@@
 struct rmi_smb_xport cocci_id@p ;
...
position p;
@@
 struct mapping_table_entry cocci_id@p ;
...
typedef u8;
@@
 struct rmi_smb_xport {  struct rmi_transport_dev xport ;  struct i2c_client * client ;  struct mutex page_mutex ;  int page ;  u8 table_index ;  struct mutex mappingtable_mutex ;  struct mapping_table_entry mapping_table [ RMI_SMB2_MAP_SIZE ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct mapping_table_entry {  __le16 rmiaddr ;  u8 readcount ;  u8 flags ; } cocci_id@p ;
