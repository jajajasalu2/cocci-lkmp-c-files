...
position p;
@@
 struct snd_dm_fm_note cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_opl3 * opl3 , struct snd_dm_fm_note * note ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_opl3 * opl3 , int mode ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_opl3 * opl3 , struct snd_dm_fm_params * params ) ;
...
position p;
@@
 char cocci_id@p [ MAX_OPL2_VOICES ] [ 4 ] ;
...
position p;
@@
 struct snd_dm_fm_params * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_opl3 * opl3 , int connection ) ;
...
position p;
@@
 struct snd_dm_fm_info cocci_id@p ;
...
position p;
@@
 struct snd_dm_fm_voice * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_opl3 * opl3 , struct snd_dm_fm_voice * voice ) ;
