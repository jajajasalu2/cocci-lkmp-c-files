...
position p;
@@
 struct xhci_hcd_histb {  struct device * dev ;  struct usb_hcd * hcd ;  void __iomem * ctrl ;  struct clk * bus_clk ;  struct clk * utmi_clk ;  struct clk * pipe_clk ;  struct clk * suspend_clk ;  struct reset_control * soft_reset ; } cocci_id@p ;
...
position p;
@@
 struct xhci_hcd_histb * cocci_id@p ;
