...
position p;
@@
 char cocci_id@p [ ASHMEM_NAME_LEN ] ;
...
position p;
@@
 struct ashmem_range * cocci_id@p ;
...
position p;
@@
 struct ashmem_area {  char name [ ASHMEM_FULL_NAME_LEN ] ;  struct list_head unpinned_list ;  struct file * file ;  size_t size ;  unsigned long prot_mask ; } cocci_id@p ;
...
position p;
@@
 struct ashmem_range {  struct list_head lru ;  struct list_head unpinned ;  struct ashmem_area * asma ;  size_t pgstart ;  size_t pgend ;  unsigned int purged ; } cocci_id@p ;
