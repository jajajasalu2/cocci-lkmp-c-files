...
position p;
@@
 struct soc_camera_async_client * cocci_id@p ;
...
position p;
@@
 struct soc_of_info {  struct soc_camera_async_subdev sasd ;  struct soc_camera_async_client sasc ;  struct v4l2_async_subdev * subdev ; } cocci_id@p ;
...
position p;
@@
 struct soc_camera_async_subdev cocci_id@p ;
...
position p;
@@
 struct soc_camera_host_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct soc_camera_device * icd ) ;
...
position p;
@@
 struct soc_camera_desc cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct soc_camera_host * ici , struct soc_camera_device * icd ) ;
...
position p;
@@
 struct soc_camera_device * cocci_id@p ;
...
position p;
@@
 struct soc_camera_format_xlate cocci_id@p ;
...
position p;
@@
 const struct soc_mbus_pixelfmt * cocci_id@p ;
...
position p;
@@
 struct soc_camera_subdev_desc * cocci_id@p ;
...
position p;
@@
 struct soc_camera_async_client {  struct v4l2_async_subdev * sensor ;  struct v4l2_async_notifier notifier ;  struct platform_device * pdev ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 const struct soc_camera_format_xlate * cocci_id@p ;
...
position p;
@@
 struct soc_camera_host * cocci_id@p ;
