...
position p;
@@
 union nilfs_bmap_ptr_req * cocci_id@p ;
...
position p;
@@
 const struct nilfs_btree_readahead_info * cocci_id@p ;
...
position p;
@@
 struct nilfs_btree_readahead_info {  struct nilfs_btree_node * node ;  int max_ra_blocks ;  int index ;  int ncmax ; } cocci_id@p ;
...
position p;
@@
 struct nilfs_bmap_stats cocci_id@p ;
...
position p;
@@
 const struct nilfs_bmap * cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ NILFS_BTREE_LEVEL_MAX ] ;
...
position p;
@@
 const struct nilfs_btree_node * cocci_id@p ;
...
position p;
@@
 struct nilfs_btree_node * cocci_id@p ;
...
position p;
@@
 struct nilfs_btree_readahead_info cocci_id@p ;
...
position p;
@@
 const struct nilfs_bmap_operations cocci_id@p ;
...
position p;
@@
 const struct nilfs_btree_path * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nilfs_bmap * bmap ) ;
