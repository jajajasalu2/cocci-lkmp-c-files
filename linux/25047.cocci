...
position p;
@@
 struct nci_core_conn_credit_ntf * cocci_id@p ;
...
position p;
@@
 struct rf_tech_specific_params_nfcb_poll * cocci_id@p ;
...
position p;
@@
 struct nci_rf_discover_ntf cocci_id@p ;
...
position p;
@@
 struct activation_params_nfcb_poll_iso_dep * cocci_id@p ;
...
position p;
@@
 struct nci_rf_deactivate_ntf * cocci_id@p ;
...
position p;
@@
 struct nci_rf_intf_activated_ntf * cocci_id@p ;
...
position p;
@@
 struct rf_tech_specific_params_nfcv_poll * cocci_id@p ;
...
position p;
@@
 struct activation_params_poll_nfc_dep * cocci_id@p ;
...
position p;
@@
 struct rf_tech_specific_params_nfcf_listen * cocci_id@p ;
...
position p;
@@
 struct nci_core_intf_error_ntf * cocci_id@p ;
...
position p;
@@
 struct rf_tech_specific_params_nfca_poll * cocci_id@p ;
...
position p;
@@
 struct nci_nfcee_discover_ntf * cocci_id@p ;
...
position p;
@@
 struct rf_tech_specific_params_nfcf_poll * cocci_id@p ;
...
position p;
@@
 struct activation_params_listen_nfc_dep * cocci_id@p ;
...
position p;
@@
 struct activation_params_nfca_poll_iso_dep * cocci_id@p ;
