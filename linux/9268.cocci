...
position p;
@@
 struct mwifiex_ie_types_auto_ds_param * cocci_id@p ;
...
position p;
@@
 struct mwifiex_opt_sleep_confirm cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_get_hw_spec * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mwifiex_adapter * adapter ) ;
...
position p;
@@
 struct mwifiex_rxinfo * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ps_param * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_ps_param * cocci_id@p ;
...
position p;
@@
 struct hw_spec_api_rev * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_pm_cfg * cocci_id@p ;
