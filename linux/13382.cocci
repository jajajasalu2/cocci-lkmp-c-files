...
typedef u8,u32;
@@
 const struct {  u32 freq ;  u8 filter_mode ; } cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 const struct {  u32 rf ;  u8 mode ;  u8 div_lo ; } cocci_id@p [ ] ;
...
position p;
@@
 struct msi001_dev {  struct spi_device * spi ;  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  struct v4l2_ctrl * bandwidth_auto ;  struct v4l2_ctrl * bandwidth ;  struct v4l2_ctrl * lna_gain ;  struct v4l2_ctrl * mixer_gain ;  struct v4l2_ctrl * if_gain ;  unsigned int f_tuner ; } cocci_id@p ;
...
typedef u8,u32;
@@
 const struct {  u32 freq ;  u8 val ; } cocci_id@p [ ] ;
