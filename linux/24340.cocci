...
position p;
@@
 struct smc_clc_msg_proposal_prefix * cocci_id@p ;
...
position p;
@@
 struct smc_clc_ipv6_prefix cocci_id@p [ SMC_CLC_MAX_V6_PREFIX ] ;
...
position p;
@@
 struct smc_clc_msg_decline * cocci_id@p ;
...
position p;
@@
 struct smc_clc_ipv6_prefix cocci_id@p ;
...
position p;
@@
 struct smc_init_info * cocci_id@p ;
...
position p;
@@
 struct smc_clc_msg_trail * cocci_id@p ;
...
position p;
@@
 struct smc_clc_msg_hdr * cocci_id@p ;
...
position p;
@@
 struct smc_clc_msg_proposal * cocci_id@p ;
...
position p;
@@
 struct smc_clc_msg_accept_confirm cocci_id@p ;
...
position p;
@@
 struct smc_connection * cocci_id@p ;
...
position p;
@@
 struct smc_clc_msg_smcd cocci_id@p ;
