...
position p;
@@
 struct lpfc_fcf_conn_hdr * cocci_id@p ;
...
@@
 union {  uint8_t pamap [ 16 ] ;  struct {  uint32_t wd1 ;  uint32_t wd2 ;  uint32_t wd3 ;  uint32_t wd4 ; } pa ; } cocci_id@p ;
...
position p;
@@
 struct lpfc_fip_param_hdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_vport * ) ;
...
position p;
@@
 struct lpfc_fcf_rec * cocci_id@p ;
...
position p;
@@
 struct lpfc_fcf_conn_rec cocci_id@p ;
...
position p;
@@
 struct lpfc_scsicmd_bkt cocci_id@p ;
...
position p;
@@
 struct lpfc_fcoe_params * cocci_id@p ;
