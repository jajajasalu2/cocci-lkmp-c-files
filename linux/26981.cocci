...
position p;
@@
 int ( * cocci_id@p ) ( struct xfs_inode * ip , int flags , void * args ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct xfs_mount * mp , struct xfs_eofblocks * eofb ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct xfs_mount * mp ) ;
...
position p;
@@
 struct xfs_inode * cocci_id@p [ XFS_LOOKUP_BATCH ] ;
