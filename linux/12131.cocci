...
position p;
@@
 union {  struct nvif_ioctl_wr_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_unmap none ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_mthd_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_ntfy_new_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_del none ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_ntfy_put_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_new_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_ntfy_get_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_rd_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_ntfy_del_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_map_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 enum nvkm_object_map cocci_id@p ;
...
typedef u32;
@@
 struct {  int version ;  int ( * func ) ( struct nvkm_client * , struct nvkm_object * , void * , u32 ) ; } cocci_id@p [ ] ;
...
position p;
@@
 union {  struct nvif_ioctl_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_nop_v0 v0 ; } * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 union {  u8 b08 ;  u16 b16 ;  u32 b32 ; } cocci_id@p ;
...
position p;
@@
 union {  struct nvif_ioctl_sclass_v0 v0 ; } * cocci_id@p ;
