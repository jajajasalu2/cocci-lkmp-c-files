...
position p;
@@
 struct drm_v3d_submit_tfu * cocci_id@p ;
...
position p;
@@
 struct drm_v3d_submit_cl * cocci_id@p ;
...
position p;
@@
 struct drm_v3d_submit_csd * cocci_id@p ;
...
position p;
@@
 struct v3d_render_job cocci_id@p ;
...
position p;
@@
 struct drm_v3d_wait_bo * cocci_id@p ;
...
position p;
@@
 struct v3d_file_priv * cocci_id@p ;
