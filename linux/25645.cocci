...
position p;
@@
 struct perf_pipe_file_header * cocci_id@p ;
...
position p;
@@
 struct cpu_cache_level * cocci_id@p ;
...
position p;
@@
 struct perf_file_section * cocci_id@p ;
...
position p;
@@
 struct perf_record_header_feature * cocci_id@p ;
...
position p;
@@
 struct memory_node cocci_id@p [ MAX_MEMORY_NODES ] ;
...
position p;
@@
 struct perf_record_header_build_id * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct perf_file_section * section , struct perf_header * ph , int feat , int fd , void * data ) ;
...
position p;
@@
 struct perf_file_attr cocci_id@p ;
...
position p;
@@
 struct perf_file_attr {  struct perf_event_attr attr ;  struct perf_file_section ids ; } cocci_id@p ;
...
position p;
@@
 const struct memory_node * cocci_id@p ;
...
position p;
@@
 struct header_print_data cocci_id@p ;
...
position p;
@@
 struct perf_file_header cocci_id@p ;
...
typedef u32;
@@
 struct group_desc {  char * name ;  u32 leader_idx ;  u32 nr_members ; } * cocci_id@p ;
...
position p;
@@
 struct perf_record_header_tracing_data cocci_id@p ;
...
typedef u8,u64;
@@
 struct {  struct perf_event_header header ;  u8 build_id [ PERF_ALIGN ( BUILD_ID_SIZE , sizeof ( u64 ) ) ] ;  char filename [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ NAME_ALIGN ] ;
...
position p;
@@
 const struct perf_header_feature_ops cocci_id@p [ HEADER_LAST_FEATURE ] ;
...
position p;
@@
 enum dso_kernel_type cocci_id@p ;
...
typedef bool,FILE;
@@
 struct header_print_data {  FILE * fp ;  bool full ; } cocci_id@p ;
...
position p;
@@
 struct numa_topology_node * cocci_id@p ;
...
position p;
@@
 struct perf_record_event_update_scale * cocci_id@p ;
...
position p;
@@
 struct perf_record_event_update_cpus * cocci_id@p ;
...
position p;
@@
 const struct perf_header * cocci_id@p ;
...
position p;
@@
 struct numa_topology * cocci_id@p ;
...
position p;
@@
 struct cpu_cache_level cocci_id@p [ max_caches ] ;
...
position p;
@@
 char cocci_id@p [ SBUILD_ID_SIZE ] ;
...
position p;
@@
 struct perf_record_event_update * cocci_id@p ;
