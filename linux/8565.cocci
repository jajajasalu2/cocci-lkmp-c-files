...
position p;
@@
 struct bnx2x_vf_queue cocci_id@p ;
...
position p;
@@
 enum bnx2x_iov_flag cocci_id@p ;
...
position p;
@@
 struct bnx2x_vf_mbx_msg * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct bnx2x * bp , int vfidx , struct bnx2x_virtf * * vf , struct pf_vf_bulletin_content * * bulletin , bool test_queue ) ;
...
position p;
@@
 struct bnx2x_vf_mac_vlan_filters * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bnx2x_mac_addr_t;
@@
 bnx2x_mac_addr_t * cocci_id@p ;
...
position p;
@@
 struct bnx2x_vf_mac_vlan_filter * cocci_id@p ;
...
position p;
@@
 struct pf_vf_bulletin_content * cocci_id@p ;
...
position p;
@@
 enum sample_bulletin_result cocci_id@p ;
...
position p;
@@
 struct bnx2x_vf_queue_construct_params * cocci_id@p ;
...
position p;
@@
 struct stats_query_entry * cocci_id@p ;
...
typedef u8;
@@
 struct set_vf_state_cookie {  struct bnx2x_virtf * vf ;  u8 state ; } cocci_id@p ;
...
position p;
@@
 struct set_vf_state_cookie * cocci_id@p ;
...
position p;
@@
 union pf_vf_bulletin cocci_id@p ;
...
position p;
@@
 struct vfpf_tpa_tlv * cocci_id@p ;
