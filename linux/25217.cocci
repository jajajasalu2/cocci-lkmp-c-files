...
position p;
@@
 void cocci_id@p ( struct ihex_binrec * record ) ;
...
@@
 struct ihex_binrec {  struct ihex_binrec * next ;  uint32_t addr ;  uint16_t len ;  uint8_t data [ ] ; } cocci_id@p ;
