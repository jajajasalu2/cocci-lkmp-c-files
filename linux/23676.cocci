...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_pcm_substream * substream , struct snd_pcm_hw_params * params , struct dma_slave_config * slave_config ) ;
...
position p;
@@
 struct dmaengine_pcm * cocci_id@p ;
...
position p;
@@
 struct dmaengine_pcm {  struct dma_chan * chan [ SNDRV_PCM_STREAM_LAST + 1 ] ;  const struct snd_dmaengine_pcm_config * config ;  struct snd_soc_component component ;  unsigned int flags ; } cocci_id@p ;
