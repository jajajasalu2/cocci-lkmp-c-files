...
position p;
@@
 enum temp_index { t_input , t_crit , t_min , t_max , t_hyst , t_num_regs , } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ t_num_regs ] ;
...
typedef s16;
@@
 struct lm92_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  s16 temp [ t_num_regs ] ; } cocci_id@p ;
...
position p;
@@
 enum chips { lm92 , max6635 , } cocci_id@p ;
