...
position p;
@@
 struct vf610_mscm_ir_chip_data * cocci_id@p ;
...
typedef bool,u16;
@@
 struct vf610_mscm_ir_chip_data {  void __iomem * mscm_ir_base ;  u16 cpu_mask ;  u16 saved_irsprc [ MSCM_IRSPRC_NUM ] ;  bool is_nvic ; } cocci_id@p ;
