...
position p;
@@
 const struct rockchip_tsadc_chip * cocci_id@p ;
...
position p;
@@
 struct rockchip_thermal_sensor * cocci_id@p ;
...
typedef u32;
@@
 struct chip_tsadc_table {  const struct tsadc_table * id ;  unsigned int length ;  u32 data_mask ;  enum adc_sort_mode mode ; } cocci_id@p ;
...
typedef u32;
@@
 struct tsadc_table {  u32 code ;  int temp ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_thermal_data cocci_id@p ;
...
position p;
@@
 const struct tsadc_table cocci_id@p [ ] ;
...
position p;
@@
 enum sensor_id { SENSOR_CPU = 0 , SENSOR_GPU , } cocci_id@p ;
...
position p;
@@
 struct rockchip_thermal_sensor {  struct rockchip_thermal_data * thermal ;  struct thermal_zone_device * tzd ;  int id ; } cocci_id@p ;
...
position p;
@@
 enum tshut_mode { TSHUT_MODE_CRU = 0 , TSHUT_MODE_GPIO , } cocci_id@p ;
...
position p;
@@
 enum tshut_polarity cocci_id@p ;
...
position p;
@@
 enum adc_sort_mode { ADC_DECREMENT = 0 , ADC_INCREMENT , } cocci_id@p ;
...
position p;
@@
 const struct chip_tsadc_table * cocci_id@p ;
...
position p;
@@
 enum tshut_polarity { TSHUT_LOW_ACTIVE = 0 , TSHUT_HIGH_ACTIVE , } cocci_id@p ;
