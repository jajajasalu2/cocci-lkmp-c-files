...
position p;
@@
 struct rocket_ports * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( CONTROLLER_T * CtlP , int chan , int on ) ;
...
symbol cocci_id;
position p;
typedef rocketModel_t;
@@
 rocketModel_t cocci_id@p [ NUM_BOARDS ] ;
...
position p;
@@
 unsigned char cocci_id@p ( int ctrl , int aiop , int ch ) ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_AIOPS_PER_BOARD ] ;
...
position p;
@@
 CONTROLLER_T cocci_id@p [ CTL_SIZE ] ;
...
position p;
@@
 struct rocket_config cocci_id@p ;
...
typedef Word_t;
@@
 Word_t cocci_id@p [ AIOP_CTL_SIZE ] ;
...
position p;
@@
 struct rocket_version cocci_id@p ;
...
typedef Byte_t;
@@
 Byte_t cocci_id@p [ RREGDATASIZE ] ;
...
position p;
@@
 struct r_port * cocci_id@p [ MAX_RP_PORTS ] ;
...
position p;
@@
 unsigned long cocci_id@p [ NUM_BOARDS ] ;
...
position p;
@@
 unsigned int cocci_id@p [ NUM_BOARDS ] ;
...
position p;
@@
 int cocci_id@p ( CONTROLLER_T * CtlP , CHANNEL_T * ChP , int AiopNum , int ChanNum ) ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_RP_PORTS ] ;
