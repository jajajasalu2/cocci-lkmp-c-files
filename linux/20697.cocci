...
position p;
@@
 enum pti_mode { PTI_AUTO = 0 , PTI_FORCE_OFF , PTI_FORCE_ON , } cocci_id@p ;
...
position p;
@@
 enum pti_clone_level { PTI_CLONE_PMD , PTI_CLONE_PTE , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long addr , int numpages ) ;
...
position p;
@@
 enum pti_clone_level cocci_id@p ;
