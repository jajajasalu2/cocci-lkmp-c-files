...
position p;
@@
 struct wf_smu_cpu_fans_state cocci_id@p ;
...
position p;
@@
 struct wf_smu_sys_fans_param cocci_id@p [ ] ;
...
position p;
@@
 struct wf_smu_sys_fans_state cocci_id@p ;
...
typedef u16,s16,s32;
@@
 struct wf_smu_sys_fans_state {  int ticks ;  s32 sys_setpoint ;  s32 hd_setpoint ;  s16 offset0 ;  u16 scale0 ;  s16 offset1 ;  u16 scale1 ;  struct wf_pid_state pid ; } cocci_id@p ;
...
typedef s32;
@@
 struct wf_smu_cpu_fans_state {  int ticks ;  s32 cpu_setpoint ;  s32 scale ;  s32 offset ;  struct wf_cpu_pid_state pid ; } cocci_id@p ;
