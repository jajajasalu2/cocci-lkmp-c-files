...
position p;
@@
 struct csio_eq_params * cocci_id@p ;
...
position p;
@@
 struct csio_iq_params * cocci_id@p ;
...
position p;
@@
 struct fw_fcoe_stats_cmd * cocci_id@p ;
...
position p;
@@
 enum csio_dev_master cocci_id@p ;
