...
position p;
@@
 const struct pnp_card_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct pnp_card_driver cocci_id@p ;
...
position p;
@@
 struct pnp_card_link * cocci_id@p ;
...
position p;
@@
 const struct snd_ratnum cocci_id@p [ 2 ] ;
