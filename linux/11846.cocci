...
typedef u64;
@@
 struct nv50_instmem {  struct nvkm_instmem base ;  u64 addr ;  struct list_head lru ; } cocci_id@p ;
...
position p;
@@
 struct nv50_instmem cocci_id@p ;
...
typedef refcount_t;
@@
 struct nv50_instobj {  struct nvkm_instobj base ;  struct nv50_instmem * imem ;  struct nvkm_memory * ram ;  struct nvkm_vma * bar ;  refcount_t maps ;  void * map ;  struct list_head lru ; } cocci_id@p ;
...
position p;
@@
 struct nv50_instobj cocci_id@p ;
