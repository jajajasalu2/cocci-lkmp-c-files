...
position p;
@@
 struct vif_counter_data * cocci_id@p ;
...
typedef bool;
@@
 struct wlcore_hw_queue_iter_data {  unsigned long hw_queue_map [ BITS_TO_LONGS ( WLCORE_NUM_MAC_ADDRESSES ) ] ;  struct ieee80211_vif * vif ;  bool cur_running ; } cocci_id@p ;
...
position p;
@@
 struct wl1271_ap_key * cocci_id@p ;
...
position p;
@@
 struct cfg80211_pkt_pattern * cocci_id@p ;
...
position p;
@@
 enum wl12xx_fw_type cocci_id@p ;
...
position p;
@@
 struct wl_fw_status * cocci_id@p ;
...
typedef u8,bool;
@@
 struct vif_counter_data {  u8 counter ;  struct ieee80211_vif * cur_vif ;  bool cur_vif_running ; } cocci_id@p ;
...
position p;
@@
 const enum plt_mode cocci_id@p ;
...
position p;
@@
 struct wlcore_hw_queue_iter_data * cocci_id@p ;
...
position p;
@@
 struct wl1271_station cocci_id@p ;
...
position p;
@@
 const struct ieee80211_channel_sw_ie * cocci_id@p ;
...
position p;
@@
 struct wl1271_tx_hw_descr cocci_id@p ;
...
position p;
@@
 struct wl12xx_rx_filter_field * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct wl1271 * wl , struct wl12xx_vif * wlvif ) ;
...
typedef u8,bool;
@@
 struct wl1271_filter_params {  bool enabled ;  int mc_list_length ;  u8 mc_list [ ACX_MC_ADDRESS_GROUP_MAX ] [ ETH_ALEN ] ; } cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct wl1271 * wl , struct ieee80211_vif * vif , bool reset_tx_queues ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ WL1271_CMD_TEMPL_MAX_SIZE ] ;
...
position p;
@@
 void cocci_id@p ( struct wl1271 * wl ) ;
...
position p;
@@
 struct wlcore_platdev_data * cocci_id@p ;
...
position p;
@@
 struct ieee80211_header cocci_id@p ;
...
position p;
@@
 struct wl1271_filter_params * cocci_id@p ;
