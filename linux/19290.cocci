...
position p;
@@
 struct tlb_args {  struct vm_area_struct * ta_vma ;  unsigned long ta_start ;  unsigned long ta_end ; } cocci_id@p ;
...
position p;
@@
 struct cpuinfo_arc_mmu * cocci_id@p ;
