...
typedef u32;
@@
 struct gpio_restart {  struct gpio_desc * reset_gpio ;  struct notifier_block restart_handler ;  u32 active_delay_ms ;  u32 inactive_delay_ms ;  u32 wait_delay_ms ; } cocci_id@p ;
...
position p;
@@
 struct gpio_restart * cocci_id@p ;
