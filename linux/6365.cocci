...
position p;
@@
 enum spmi_boost_byp_registers { SPMI_BOOST_BYP_REG_CURRENT_LIMIT = 0x4b , } cocci_id@p ;
...
position p;
@@
 struct regulator_ops cocci_id@p ;
...
typedef u16;
@@
 struct spmi_regulator_data {  const char * name ;  u16 base ;  const char * supply ;  const char * ocp ;  u16 force_type ; } cocci_id@p ;
...
position p;
@@
 const struct spmi_regulator_mapping * cocci_id@p ;
...
position p;
@@
 enum spmi_common_control_register_index { SPMI_COMMON_IDX_VOLTAGE_RANGE = 0 , SPMI_COMMON_IDX_VOLTAGE_SET = 1 , SPMI_COMMON_IDX_MODE = 5 , SPMI_COMMON_IDX_ENABLE = 6 , } cocci_id@p ;
...
position p;
@@
 struct spmi_voltage_range cocci_id@p [ ] ;
...
position p;
@@
 const struct spmi_regulator_data * cocci_id@p ;
...
position p;
@@
 struct regulator_dev * cocci_id@p ;
...
position p;
@@
 const struct spmi_regulator_init_data * cocci_id@p ;
...
position p;
@@
 enum spmi_regulator_type { SPMI_REGULATOR_TYPE_BUCK = 0x03 , SPMI_REGULATOR_TYPE_LDO = 0x04 , SPMI_REGULATOR_TYPE_VS = 0x05 , SPMI_REGULATOR_TYPE_BOOST = 0x1b , SPMI_REGULATOR_TYPE_FTS = 0x1c , SPMI_REGULATOR_TYPE_BOOST_BYP = 0x1f , SPMI_REGULATOR_TYPE_ULT_LDO = 0x21 , SPMI_REGULATOR_TYPE_ULT_BUCK = 0x22 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct regulator_dev * rdev , unsigned selector ) ;
...
position p;
@@
 enum spmi_ftsmps426_regulator_registers { SPMI_FTSMPS426_REG_VOLTAGE_LSB = 0x40 , SPMI_FTSMPS426_REG_VOLTAGE_MSB = 0x41 , SPMI_FTSMPS426_REG_VOLTAGE_ULS_LSB = 0x68 , SPMI_FTSMPS426_REG_VOLTAGE_ULS_MSB = 0x69 , } cocci_id@p ;
...
position p;
@@
 enum spmi_boost_registers { SPMI_BOOST_REG_CURRENT_LIMIT = 0x4a , } cocci_id@p ;
...
position p;
@@
 enum spmi_vs_registers { SPMI_VS_REG_OCP = 0x4a , SPMI_VS_REG_SOFT_START = 0x4c , } cocci_id@p ;
...
position p;
@@
 struct spmi_regulator_init_data * cocci_id@p ;
...
position p;
@@
 struct spmi_voltage_set_points * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SPMI_COMMON_REG_SUBTYPE - SPMI_COMMON_REG_DIG_MAJOR_REV + 1 ] ;
...
position p;
@@
 struct spmi_regulator cocci_id@p ;
...
position p;
@@
 struct spmi_voltage_set_points {  struct spmi_voltage_range * range ;  int count ;  unsigned n_voltages ; } cocci_id@p ;
...
position p;
@@
 const struct regulator_desc * cocci_id@p ;
...
position p;
@@
 enum spmi_regulator_logical_type cocci_id@p ;
...
position p;
@@
 enum spmi_vs_soft_start_str { SPMI_VS_SOFT_START_STR_0P05_UA = 0 , SPMI_VS_SOFT_START_STR_0P25_UA , SPMI_VS_SOFT_START_STR_0P55_UA , SPMI_VS_SOFT_START_STR_0P75_UA , SPMI_VS_SOFT_START_STR_HW_DEFAULT , } cocci_id@p ;
...
position p;
@@
 struct regulator_config * cocci_id@p ;
...
typedef u8;
@@
 struct spmi_voltage_range {  int min_uV ;  int max_uV ;  int step_uV ;  int set_point_min_uV ;  int set_point_max_uV ;  unsigned n_voltages ;  u8 range_sel ; } cocci_id@p ;
...
typedef u32;
@@
 struct spmi_regulator_mapping {  enum spmi_regulator_type type ;  enum spmi_regulator_subtype subtype ;  enum spmi_regulator_logical_type logical_type ;  u32 revision_min ;  u32 revision_max ;  struct regulator_ops * ops ;  struct spmi_voltage_set_points * set_points ;  int hpm_min_load ; } cocci_id@p ;
...
position p;
@@
 struct spmi_regulator_init_data {  unsigned pin_ctrl_enable ;  unsigned pin_ctrl_hpm ;  enum spmi_vs_soft_start_str vs_soft_start_strength ; } cocci_id@p ;
...
position p;
@@
 enum spmi_saw3_registers { SAW3_SECURE = 0x00 , SAW3_ID = 0x04 , SAW3_SPM_STS = 0x0C , SAW3_AVS_STS = 0x10 , SAW3_PMIC_STS = 0x14 , SAW3_RST = 0x18 , SAW3_VCTL = 0x1C , SAW3_AVS_CTL = 0x20 , SAW3_AVS_LIMIT = 0x24 , SAW3_AVS_DLY = 0x28 , SAW3_AVS_HYSTERESIS = 0x2C , SAW3_SPM_STS2 = 0x38 , SAW3_SPM_PMIC_DATA_3 = 0x4C , SAW3_VERSION = 0xFD0 , } cocci_id@p ;
...
position p;
@@
 const struct spmi_voltage_range * cocci_id@p ;
