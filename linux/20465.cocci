...
position p;
@@
 struct cpu_cacheinfo * cocci_id@p ;
...
position p;
@@
 union l1_cache {  struct {  unsigned line_size : 8 ;  unsigned lines_per_tag : 8 ;  unsigned assoc : 8 ;  unsigned size_in_kb : 8 ; } ;  unsigned val ; } cocci_id@p ;
...
typedef u32;
@@
 union _cpuid4_leaf_eax {  struct {  enum _cache_type type : 5 ;  unsigned int level : 3 ;  unsigned int is_self_initializing : 1 ;  unsigned int is_fully_associative : 1 ;  unsigned int reserved : 4 ;  unsigned int num_threads_sharing : 12 ;  unsigned int num_cores_on_die : 6 ; } split ;  u32 full ; } cocci_id@p ;
...
position p;
@@
 const enum cache_type cocci_id@p [ ] ;
...
position p;
@@
 union _cpuid4_leaf_ebx cocci_id@p ;
...
position p;
@@
 union _cpuid4_leaf_eax cocci_id@p ;
...
position p;
@@
 const struct _cache_table cocci_id@p [ ] ;
...
position p;
@@
 struct _cache_table {  unsigned char descriptor ;  char cache_type ;  short size ; } cocci_id@p ;
...
position p;
@@
 struct _cpuid4_info_regs cocci_id@p ;
...
position p;
@@
 union _cpuid4_leaf_ecx cocci_id@p ;
...
position p;
@@
 union l2_cache {  struct {  unsigned line_size : 8 ;  unsigned lines_per_tag : 4 ;  unsigned assoc : 4 ;  unsigned size_in_kb : 16 ; } ;  unsigned val ; } cocci_id@p ;
...
position p;
@@
 struct amd_northbridge * cocci_id@p ;
...
position p;
@@
 enum _cache_type { CTYPE_NULL = 0 , CTYPE_DATA = 1 , CTYPE_INST = 2 , CTYPE_UNIFIED = 3 , } cocci_id@p ;
...
position p;
@@
 struct _cpuid4_info_regs {  union _cpuid4_leaf_eax eax ;  union _cpuid4_leaf_ebx ebx ;  union _cpuid4_leaf_ecx ecx ;  unsigned int id ;  unsigned long size ;  struct amd_northbridge * nb ; } cocci_id@p ;
...
typedef u32;
@@
 union _cpuid4_leaf_ebx {  struct {  unsigned int coherency_line_size : 12 ;  unsigned int physical_line_partition : 10 ;  unsigned int ways_of_associativity : 10 ; } split ;  u32 full ; } cocci_id@p ;
...
typedef u32;
@@
 union _cpuid4_leaf_ecx {  struct {  unsigned int number_of_sets : 32 ; } split ;  u32 full ; } cocci_id@p ;
...
position p;
@@
 struct amd_l3_cache * cocci_id@p ;
...
position p;
@@
 union l3_cache {  struct {  unsigned line_size : 8 ;  unsigned lines_per_tag : 4 ;  unsigned assoc : 4 ;  unsigned res : 2 ;  unsigned size_encoded : 14 ; } ;  unsigned val ; } cocci_id@p ;
