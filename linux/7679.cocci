...
position p;
@@
 void cocci_id@p ( struct uart_amba_port * uap ) ;
...
position p;
@@
 struct pl011_dmatx_data * cocci_id@p ;
...
position p;
@@
 struct earlycon_device * cocci_id@p ;
...
typedef bool,u16;
@@
 struct vendor_data {  const u16 * reg_offset ;  unsigned int ifls ;  unsigned int fr_busy ;  unsigned int fr_dsr ;  unsigned int fr_cts ;  unsigned int fr_ri ;  unsigned int inv_fr ;  bool access_32b ;  bool oversampling ;  bool dma_threshold ;  bool cts_event_workaround ;  bool always_enabled ;  bool fixed_options ;  unsigned int ( * get_fifosize ) ( struct amba_device * dev ) ; } cocci_id@p ;
...
position p;
@@
 struct pl011_dmarx_data * cocci_id@p ;
...
position p;
@@
 const struct vendor_data cocci_id@p ;
...
position p;
@@
 struct amba_pl011_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,dma_cookie_t;
@@
 struct pl011_dmarx_data {  struct dma_chan * chan ;  struct completion complete ;  bool use_buf_b ;  struct pl011_sgbuf sgbuf_a ;  struct pl011_sgbuf sgbuf_b ;  dma_cookie_t cookie ;  bool running ;  struct timer_list timer ;  unsigned int last_residue ;  unsigned long last_jiffies ;  bool auto_poll_rate ;  unsigned int poll_rate ;  unsigned int poll_timeout ; } cocci_id@p ;
...
position p;
@@
 const struct uart_amba_port * cocci_id@p ;
...
position p;
@@
 struct dma_slave_caps cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ REG_ARRAY_SIZE ] ;
...
position p;
@@
 struct uart_amba_port * cocci_id@p [ UART_NR ] ;
...
position p;
@@
 int cocci_id@p ( struct uart_amba_port * uap ) ;
...
typedef bool;
@@
 struct pl011_dmatx_data {  struct dma_chan * chan ;  struct scatterlist sg ;  char * buf ;  bool queued ; } cocci_id@p ;
...
position p;
@@
 struct pl011_sgbuf {  struct scatterlist sg ;  char * buf ; } cocci_id@p ;
...
position p;
@@
 struct uart_amba_port * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct uart_amba_port * uap , bool from_irq ) ;
