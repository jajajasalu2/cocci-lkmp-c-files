...
position p;
@@
 const struct esdhc_soc_data cocci_id@p ;
...
typedef u32;
@@
 struct pltfm_imx_data {  u32 scratchpad ;  struct pinctrl * pinctrl ;  struct pinctrl_state * pins_default ;  struct pinctrl_state * pins_100mhz ;  struct pinctrl_state * pins_200mhz ;  const struct esdhc_soc_data * socdata ;  struct esdhc_platform_data boarddata ;  struct clk * clk_ipg ;  struct clk * clk_ahb ;  struct clk * clk_per ;  unsigned int actual_clock ;  enum { NO_CMD_PENDING , MULTIBLK_IN_PROCESS , WAIT_FOR_INT , } multiblock_status ;  u32 is_ddr ;  struct pm_qos_request pm_qos_req ; } cocci_id@p ;
...
position p;
@@
 struct esdhc_soc_data * cocci_id@p ;
...
position p;
@@
 struct esdhc_platform_data * cocci_id@p ;
...
position p;
@@
 struct pltfm_imx_data * cocci_id@p ;
...
typedef u32;
@@
 struct esdhc_soc_data {  u32 flags ; } cocci_id@p ;
