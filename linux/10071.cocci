...
position p;
@@
 void cocci_id@p ( struct scc_priv * priv , int t , int r15 ) ;
...
position p;
@@
 int cocci_id@p ( struct scc_priv * priv ) ;
...
position p;
@@
 void cocci_id@p ( struct scc_priv * priv , int reg , int val ) ;
...
position p;
@@
 int cocci_id@p ( struct scc_priv * priv , int reg ) ;
...
position p;
@@
 void cocci_id@p ( struct scc_priv * priv ) ;
...
position p;
@@
 struct scc_hardware cocci_id@p [ NUM_TYPES ] ;
...
position p;
@@
 void cocci_id@p ( struct scc_priv * priv , int val , int fast ) ;
...
typedef spinlock_t;
@@
 struct scc_info {  int irq_used ;  int twin_serial_cfg ;  struct net_device * dev [ 2 ] ;  struct scc_priv priv [ 2 ] ;  struct scc_info * next ;  spinlock_t register_lock ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scc_info * info ) ;
...
position p;
@@
 void cocci_id@p ( struct scc_priv * priv , int rc ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , void * sa ) ;
...
position p;
@@
 struct scc_param {  int pclk_hz ;  int brg_tc ;  int nrzi ;  int clocks ;  int txdelay ;  int txtimeout ;  int txtail ;  int waittime ;  int slottime ;  int persist ;  int dma ;  int txpause ;  int rtsoff ;  int dcdon ;  int dcdoff ; } cocci_id@p ;
...
position p;
@@
 struct scc_hardware {  char * name ;  int io_region ;  int io_delta ;  int io_size ;  int num_devs ;  int scc_offset ;  int tmr_offset ;  int tmr_hz ;  int pclk_hz ; } cocci_id@p ;
