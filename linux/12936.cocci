...
position p;
@@
 struct rio_id_table * cocci_id@p ;
...
@@
 struct rio_id_table {  u16 start ;  u32 max ;  spinlock_t lock ;  unsigned long table [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rio_dev * rdev ) ;
