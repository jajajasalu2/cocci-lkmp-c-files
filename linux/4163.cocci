...
position p;
@@
 struct ns2_phy_driver * cocci_id@p ;
...
position p;
@@
 struct ns2_phy_data * cocci_id@p ;
...
position p;
@@
 struct ns2_phy_data {  struct ns2_phy_driver * driver ;  struct phy * phy ;  int new_state ; } cocci_id@p ;
