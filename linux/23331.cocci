...
typedef u32,u16;
@@
 struct coeff_clk_div {  u32 mclk ;  u32 bclk ;  u32 rate ;  u16 reg_val ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct pll_div {  u32 pll_in ;  u32 pll_out ;  u16 reg_val ; } cocci_id@p ;
...
position p;
@@
 struct coeff_clk_div cocci_id@p [ ] ;
...
position p;
@@
 struct rt5631_priv {  struct regmap * regmap ;  int codec_version ;  int master ;  int sysclk ;  int rx_rate ;  int bclk_rate ;  int dmic_used_flag ; } cocci_id@p ;
