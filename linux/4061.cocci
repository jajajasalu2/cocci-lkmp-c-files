...
position p;
@@
 struct ti_sci_inta_vint_desc cocci_id@p ;
...
position p;
@@
 struct ti_sci_inta_event_desc * cocci_id@p ;
...
@@
 struct ti_sci_inta_vint_desc {  struct irq_domain * domain ;  struct list_head list ; 
	 DECLARE_BITMAP ( event_map , MAX_EVENTS_PER_VINT ) 
		 ;  struct ti_sci_inta_event_desc events [ MAX_EVENTS_PER_VINT ] ;  unsigned int parent_virq ;  u16 vint_id ; } cocci_id@p ;
...
position p;
@@
 struct ti_sci_inta_irq_domain * cocci_id@p ;
...
position p;
@@
 struct ti_sci_inta_irq_domain {  const struct ti_sci_handle * sci ;  struct ti_sci_resource * vint ;  struct ti_sci_resource * global_event ;  struct list_head vint_list ;  struct mutex vint_mutex ;  void __iomem * base ;  struct platform_device * pdev ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct ti_sci_inta_event_desc {  u16 global_event ;  u32 hwirq ;  u8 vint_bit ; } cocci_id@p ;
