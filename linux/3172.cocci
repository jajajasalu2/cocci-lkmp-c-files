...
typedef u8;
@@
 struct abituguru_data {  struct device * hwmon_dev ;  struct mutex update_lock ;  unsigned long last_updated ;  unsigned short addr ;  char uguru_ready ;  unsigned char update_timeouts ;  struct sensor_device_attribute_2 sysfs_attr [ ABIT_UGURU_MAX_BANK1_SENSORS * 9 + ABIT_UGURU_MAX_BANK2_SENSORS * 6 + ABIT_UGURU_MAX_PWMS * 6 ] ;  char sysfs_names [ ABITUGURU_SYSFS_NAMES_LENGTH ] ;  u8 bank1_sensors [ 2 ] ;  u8 bank1_address [ 2 ] [ ABIT_UGURU_MAX_BANK1_SENSORS ] ;  u8 bank1_value [ ABIT_UGURU_MAX_BANK1_SENSORS ] ;  u8 bank1_settings [ ABIT_UGURU_MAX_BANK1_SENSORS ] [ 3 ] ;  int bank1_max_value [ ABIT_UGURU_MAX_BANK1_SENSORS ] ;  u8 bank2_sensors ;  u8 bank2_value [ ABIT_UGURU_MAX_BANK2_SENSORS ] ;  u8 bank2_settings [ ABIT_UGURU_MAX_BANK2_SENSORS ] [ 2 ] ;  u8 alarms [ 3 ] ;  u8 pwms ;  u8 pwm_settings [ ABIT_UGURU_MAX_PWMS ] [ 5 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ ABIT_UGURU_MAX_BANK1_SENSORS ] ;
...
position p;
@@
 const struct sensor_device_attribute_2 cocci_id@p [ 6 ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ ABIT_UGURU_MAX_BANK1_SENSORS ] ;
...
position p;
@@
 struct abituguru_data * cocci_id@p ;
...
position p;
@@
 const struct sensor_device_attribute_2 cocci_id@p [ 2 ] [ 9 ] ;
...
position p;
@@
 struct abituguru_data * cocci_id@p ( struct device * dev ) ;
