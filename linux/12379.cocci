...
position p;
@@
 enum versatile_clcd { INTEGRATOR_CLCD_CM , VERSATILE_CLCD , REALVIEW_CLCD_EB , REALVIEW_CLCD_PB1176 , REALVIEW_CLCD_PB11MP , REALVIEW_CLCD_PBA8 , REALVIEW_CLCD_PBX , VEXPRESS_CLCD_V2M , } cocci_id@p ;
...
position p;
@@
 enum versatile_clcd cocci_id@p ;
