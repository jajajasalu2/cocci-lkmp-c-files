...
position p;
@@
 const struct board_info {  const char * name ;  const struct pch_dev_ops * ops ; } cocci_id@p [ ] ;
...
position p;
@@
 struct pch_thermal_device * cocci_id@p ;
...
typedef bool;
@@
 struct pch_thermal_device {  void __iomem * hw_base ;  const struct pch_dev_ops * ops ;  struct pci_dev * pdev ;  struct thermal_zone_device * tzd ;  int crt_trip_id ;  unsigned long crt_temp ;  int hot_trip_id ;  unsigned long hot_temp ;  int psv_trip_id ;  unsigned long psv_temp ;  bool bios_enabled ; } cocci_id@p ;
...
position p;
@@
 const struct pch_dev_ops cocci_id@p ;
...
position p;
@@
 enum board_ids { board_hsw , board_wpt , board_skl , board_cnl , } cocci_id@p ;
