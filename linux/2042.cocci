...
position p;
@@
 struct mma9551_mbox_request cocci_id@p ;
...
position p;
@@
 struct mma9551_version_info cocci_id@p ;
...
position p;
@@
 struct mma9551_mbox_response cocci_id@p ;
...
typedef u8,__be32;
@@
 struct mma9551_version_info {  __be32 device_id ;  u8 rom_version [ 2 ] ;  u8 fw_version [ 2 ] ;  u8 hw_version [ 2 ] ;  u8 fw_build [ 2 ] ; } cocci_id@p ;
