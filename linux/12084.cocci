...
position p;
@@
 const struct nvkm_fifo_func cocci_id@p ;
...
position p;
@@
 struct nvkm_fault_data * cocci_id@p ;
...
position p;
@@
 struct nvkm_fifo_cgrp * cocci_id@p ;
...
position p;
@@
 struct gk104_fifo_engine_status * cocci_id@p ;
...
position p;
@@
 const struct gk104_fifo_pbdma_func cocci_id@p ;
...
position p;
@@
 const struct gk104_fifo_chan_user * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gk104_fifo * fifo , int engn ) ;
...
position p;
@@
 const struct gk104_fifo_func cocci_id@p ;
...
position p;
@@
 struct gk104_fifo_chan * cocci_id@p ;
...
position p;
@@
 const struct gk104_fifo_runlist_func cocci_id@p ;
...
position p;
@@
 const struct gk104_fifo_user_user * cocci_id@p ;
