...
typedef u8;
@@
 struct mt9v02x_register {  u8 max_total_shutter_width ;  u8 pixclk_fv_lv ; } cocci_id@p ;
...
typedef u16;
@@
 struct mt9v022 {  struct v4l2_subdev subdev ;  struct v4l2_ctrl_handler hdl ;  struct {  struct v4l2_ctrl * autoexposure ;  struct v4l2_ctrl * exposure ; } ;  struct {  struct v4l2_ctrl * autogain ;  struct v4l2_ctrl * gain ; } ;  struct v4l2_ctrl * hblank ;  struct v4l2_ctrl * vblank ;  struct v4l2_rect rect ;  struct v4l2_clk * clk ;  const struct mt9v022_datafmt * fmt ;  const struct mt9v022_datafmt * fmts ;  const struct mt9v02x_register * reg ;  int num_fmts ;  enum mt9v022_model model ;  u16 chip_control ;  u16 chip_version ;  unsigned short y_skip_top ; } cocci_id@p ;
...
position p;
@@
 const struct mt9v022_datafmt cocci_id@p [ ] ;
...
position p;
@@
 enum mt9v022_model { MT9V022IX7ATM , MT9V022IX7ATC , } cocci_id@p ;
...
position p;
@@
 struct mt9v022_platform_data * cocci_id@p ;
...
typedef u32;
@@
 struct mt9v022_datafmt {  u32 code ;  enum v4l2_colorspace colorspace ; } cocci_id@p ;
...
position p;
@@
 const struct mt9v02x_register cocci_id@p ;
