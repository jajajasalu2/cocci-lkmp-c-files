...
typedef u32,s16;
@@
 struct disttable {  u32 size ;  s16 table [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct netem_sched_data cocci_id@p ;
...
position p;
@@
 const struct tc_netem_corr * cocci_id@p ;
...
position p;
@@
 struct tc_netem_corr cocci_id@p ;
...
position p;
@@
 const struct tc_netem_reorder * cocci_id@p ;
...
position p;
@@
 struct netem_skb_cb * cocci_id@p ;
...
position p;
@@
 struct tc_netem_gemodel cocci_id@p ;
...
position p;
@@
 const struct tc_netem_gemodel * cocci_id@p ;
...
position p;
@@
 const struct tc_netem_gimodel * cocci_id@p ;
...
position p;
@@
 struct tc_netem_qopt cocci_id@p ;
...
position p;
@@
 const struct netem_sched_data * cocci_id@p ;
...
typedef u64;
@@
 struct netem_skb_cb {  u64 time_to_send ; } cocci_id@p ;
...
position p;
@@
 struct tc_netem_slot cocci_id@p ;
...
position p;
@@
 struct tc_netem_corrupt cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_NETEM_MAX + 1 ] ;
...
position p;
@@
 const struct tc_netem_rate * cocci_id@p ;
...
position p;
@@
 const struct disttable * cocci_id@p ;
...
position p;
@@
 struct tc_netem_reorder cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_NETEM_MAX + 1 ] ;
...
position p;
@@
 const struct tc_netem_slot * cocci_id@p ;
...
position p;
@@
 struct tc_netem_gimodel cocci_id@p ;
...
position p;
@@
 const struct tc_netem_corrupt * cocci_id@p ;
...
position p;
@@
 struct tc_netem_rate cocci_id@p ;
