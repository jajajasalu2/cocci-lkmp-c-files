...
position p;
@@
 struct metronomefb_par * cocci_id@p ;
...
position p;
@@
 struct metronome_board * cocci_id@p ;
...
position p;
@@
 struct waveform_hdr * cocci_id@p ;
...
typedef u16;
@@
 struct epd_frame {  int fw ;  int fh ;  u16 config [ 4 ] ;  int wfm_size ; } cocci_id@p ;
