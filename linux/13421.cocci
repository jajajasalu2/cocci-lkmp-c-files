...
position p;
@@
 char cocci_id@p [ 2 * CEC_MAX_MSG_SIZE + 16 ] ;
...
@@
 struct rain {  struct device * dev ;  struct serio * serio ;  struct cec_adapter * adap ;  struct completion cmd_done ;  struct work_struct work ;  char buf [ DATA_SIZE ] ;  unsigned int buf_rd_idx ;  unsigned int buf_wr_idx ;  unsigned int buf_len ;  spinlock_t buf_lock ;  char cmd [ DATA_SIZE ] ;  unsigned int cmd_idx ;  bool cmd_started ;  char cmd_reply [ DATA_SIZE ] ;  struct mutex write_lock ; } cocci_id@p ;
