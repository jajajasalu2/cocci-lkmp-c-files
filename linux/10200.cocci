...
position p;
@@
 struct tcic_socket cocci_id@p [ 2 ] ;
...
@@
 struct tcic_socket {  u_short psock ;  u_char last_sstat ;  u_char id ;  struct pcmcia_socket socket ; } cocci_id@p ;
