...
position p;
@@
 struct mlx5_ib_create_qp_resp * cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_xrc_seg * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( enum ib_qp_type qp_type , struct ib_cq * ib_send_cq , struct ib_cq * ib_recv_cq , struct mlx5_ib_cq * * send_cq , struct mlx5_ib_cq * * recv_cq ) ;
...
position p;
@@
 enum { MLX5_IB_DEFAULT_SCHED_QUEUE = 0x83 , MLX5_IB_DEFAULT_QP0_SCHED_QUEUE = 0x3f , MLX5_IB_LINK_TYPE_IB = 0 , MLX5_IB_LINK_TYPE_ETH = 1 , } cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_eth_pad cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_drain_cqe {  struct ib_cqe cqe ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 struct ib_sig_domain * cocci_id@p ;
...
position p;
@@
 struct mlx5_stride_block_entry * cocci_id@p ;
...
position p;
@@
 struct mlx5_bsf_inl * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_create_qp_rss cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_modify_qp cocci_id@p ;
...
position p;
@@
 enum raw_qp_set_mask_map { MLX5_RAW_QP_MOD_SET_RQ_Q_CTR_ID = 1UL << 0 , MLX5_RAW_QP_RATE_LIMIT = 1UL << 1 , } cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_qp_base * cocci_id@p ;
...
position p;
@@
 enum { NUM_NON_BLUE_FLAME_BFREGS = 1 , } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ MLX5_RQ_NUM_STATE ] [ MLX5_SQ_NUM_STATE ] ;
...
position p;
@@
 enum { MLX5_PATH_FLAG_FL = 1 << 0 , MLX5_PATH_FLAG_FREE_AR = 1 << 1 , MLX5_PATH_FLAG_COUNTER = 1 << 2 , } cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_eth_seg cocci_id@p ;
...
position p;
@@
 const struct mlx5_ib_modify_qp * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_drain_cqe cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_create_qp cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_modify_qp_resp cocci_id@p ;
...
position p;
@@
 struct mlx5_core_sig_ctx * cocci_id@p ;
...
position p;
@@
 struct mlx5_rate_limit cocci_id@p ;
...
position p;
@@
 enum mlx5_qp_optpar cocci_id@p ;
...
position p;
@@
 struct mlx5_rwqe_sig * cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_signature_seg cocci_id@p ;
...
position p;
@@
 enum ib_signature_type cocci_id@p ;
...
position p;
@@
 enum { MLX5_IB_ACK_REQ_FREQ = 8 , } cocci_id@p ;
...
position p;
@@
 struct mlx5_qp_path * cocci_id@p ;
...
position p;
@@
 enum ib_qp_attr_mask cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_umr_ctrl_seg cocci_id@p ;
...
position p;
@@
 struct mlx5_stride_block_ctrl_seg * cocci_id@p ;
...
position p;
@@
 struct mlx5_modify_raw_qp_param cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_create_wq_resp cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_inline_seg cocci_id@p ;
...
position p;
@@
 struct mlx5_qp_context * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5_ib_cq * send_cq , struct mlx5_ib_cq * recv_cq ) ;
...
position p;
@@
 enum { MLX_QP_FLAGS = MLX5_QP_FLAG_TYPE_DCT | MLX5_QP_FLAG_TYPE_DCI , } cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_modify_wq cocci_id@p ;
...
position p;
@@
 struct mlx5_core_dct * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_tir_out ) ] ;
...
position p;
@@
 struct mlx5_wqe_atomic_seg cocci_id@p ;
...
position p;
@@
 const struct rdma_ah_attr * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_ubuffer * cocci_id@p ;
...
position p;
@@
 const struct mlx5_modify_raw_qp_param * cocci_id@p ;
...
typedef u8;
@@
 struct mlx5_wqe_eth_pad {  u8 rsvd0 [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_create_wq cocci_id@p ;
...
position p;
@@
 enum mlx5_qp_optpar cocci_id@p [ MLX5_QP_NUM_STATE ] [ MLX5_QP_NUM_STATE ] [ MLX5_QP_ST_MAX ] ;
...
position p;
@@
 const struct mlx5_umr_wr * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct mlx5_modify_raw_qp_param {  u16 operation ;  u32 set_mask ;  struct mlx5_rate_limit rl ;  u8 rq_q_ctr_id ;  u16 port ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_xrcd * cocci_id@p ;
...
position p;
@@
 const struct ib_qp_attr * cocci_id@p ;
...
position p;
@@
 const struct ib_reg_wr * cocci_id@p ;
...
position p;
@@
 struct mlx5_seg_set_psv * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_tis_in ) ] ;
...
position p;
@@
 struct mlx5_ib_raw_packet_qp * cocci_id@p ;
...
position p;
@@
 struct mlx5_bsf_basic * cocci_id@p ;
...
position p;
@@
 struct mlx5_wqe_datagram_seg * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct mlx5_ib_dev * dev , struct mlx5_ib_qp * qp , const struct mlx5_modify_raw_qp_param * raw_qp_param , u8 lag_tx_affinity ) ;
...
typedef u16;
@@
 const u16 cocci_id@p [ MLX5_QP_NUM_STATE ] [ MLX5_QP_NUM_STATE ] ;
...
position p;
@@
 struct mlx5_mkey_seg cocci_id@p ;
...
position p;
@@
 struct mlx5_core_qp * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_dct_out ) ] ;
...
position p;
@@
 struct ib_sig_attrs * cocci_id@p ;
...
position p;
@@
 enum { MLX5_IB_SQ_STRIDE = 6 , MLX5_IB_SQ_UMR_INLINE_THRESHOLD = 64 , } cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_create_rwq_ind_tbl_resp cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_rwq_ind_table * cocci_id@p ;
