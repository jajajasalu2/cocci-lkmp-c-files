...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( * fft_sample ) + SPECTRAL_ATH10K_MAX_NUM_BINS ] ;
...
position p;
@@
 const struct fft_sample_tlv * cocci_id@p ;
...
position p;
@@
 struct fft_sample_ath10k * cocci_id@p ;
...
position p;
@@
 enum ath10k_spectral_mode cocci_id@p ;
...
position p;
@@
 struct wmi_vdev_spectral_conf_arg cocci_id@p ;
