...
position p;
@@
 enum serio_event_type { SERIO_RESCAN_PORT , SERIO_RECONNECT_PORT , SERIO_RECONNECT_SUBTREE , SERIO_REGISTER_PORT , SERIO_ATTACH_DRIVER , } cocci_id@p ;
...
position p;
@@
 enum serio_event_type cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct serio * serio ) ;
...
position p;
@@
 int cocci_id@p ( struct serio * serio ) ;
...
position p;
@@
 struct serio_event {  enum serio_event_type type ;  void * object ;  struct module * owner ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct serio_driver * drv ) ;
