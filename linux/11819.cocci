...
typedef bool,u32;
@@
 bool ( * cocci_id@p ) ( struct nvkm_vmm_iter * , bool pfn , u32 , u32 ) ;
...
position p;
@@
 char cocci_id@p [ NVKM_VMM_LEVELS_MAX * 7 ] ;
...
position p;
@@
 struct nvkm_vmm_iter * cocci_id@p ;
