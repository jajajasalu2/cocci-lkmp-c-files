...
symbol cocci_id;
position p;
typedef vi_handler_t;
@@
 vi_handler_t cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct pt_regs * regs , int is_fixup ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( int irq , int regset ) ;
