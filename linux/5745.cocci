...
position p;
@@
 struct bcm2835_timer * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct clock_event_device * ) ;
...
position p;
@@
 struct bcm2835_timer {  void __iomem * control ;  void __iomem * compare ;  int match_mask ;  struct clock_event_device evt ;  struct irqaction act ; } cocci_id@p ;
