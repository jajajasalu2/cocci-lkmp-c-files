...
position p;
@@
 struct scpi_clk_data * cocci_id@p ;
...
position p;
@@
 struct scpi_clk_data {  struct scpi_clk * * clk ;  unsigned int clk_num ; } cocci_id@p ;
...
typedef u32;
@@
 struct scpi_clk {  u32 id ;  struct clk_hw hw ;  struct scpi_dvfs_info * info ;  struct scpi_ops * scpi_ops ; } cocci_id@p ;
