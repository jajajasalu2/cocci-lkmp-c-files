...
position p;
@@
 struct mmp_clk_factor_masks cocci_id@p ;
...
position p;
@@
 struct mmp_clk_reset_cell * cocci_id@p ;
...
position p;
@@
 struct mmp_param_fixed_factor_clk cocci_id@p [ ] ;
...
position p;
@@
 struct mmp_clk_mix_config cocci_id@p ;
...
position p;
@@
 struct mmp_clk_unit * cocci_id@p ;
...
position p;
@@
 struct mmp2_clk_unit {  struct mmp_clk_unit unit ;  void __iomem * mpmu_base ;  void __iomem * apmu_base ;  void __iomem * apbc_base ; } cocci_id@p ;
...
position p;
@@
 struct mmp_clk_factor_tbl cocci_id@p [ ] ;
...
position p;
@@
 struct mmp_param_gate_clk cocci_id@p [ ] ;
...
position p;
@@
 struct mmp2_clk_unit * cocci_id@p ;
...
position p;
@@
 struct mmp_param_fixed_rate_clk cocci_id@p [ ] ;
...
position p;
@@
 struct mmp_param_div_clk cocci_id@p [ ] ;
...
position p;
@@
 struct mmp_param_mux_clk cocci_id@p [ ] ;
