...
position p;
@@
 struct ata_show_ering_arg cocci_id@p ;
...
position p;
@@
 struct ata_internal cocci_id@p ;
...
position p;
@@
 struct ata_show_ering_arg {  char * buf ;  int written ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ata_device * dev ) ;
