...
typedef u16;
@@
 struct ov2659_framesize {  u16 width ;  u16 height ;  u16 max_exp_lines ;  const struct sensor_register * regs ; } cocci_id@p ;
...
position p;
@@
 const struct ov2659_framesize * * cocci_id@p ;
...
position p;
@@
 struct pll_ctrl_reg {  unsigned int div ;  unsigned char reg ; } cocci_id@p ;
...
position p;
@@
 const struct sensor_register cocci_id@p [ ] ;
...
position p;
@@
 const struct ov2659_pixfmt cocci_id@p [ ] ;
...
position p;
@@
 struct sensor_register cocci_id@p [ ] ;
...
position p;
@@
 const struct pll_ctrl_reg cocci_id@p [ ] ;
...
typedef u8;
@@
 struct ov2659_pll_ctrl {  u8 ctrl1 ;  u8 ctrl2 ;  u8 ctrl3 ; } cocci_id@p ;
...
typedef u32;
@@
 struct ov2659_pixfmt {  u32 code ;  struct sensor_register * format_ctrl_regs ; } cocci_id@p ;
...
position p;
@@
 const struct ov2659_platform_data * cocci_id@p ;
...
position p;
@@
 struct ov2659_platform_data * cocci_id@p ;
...
typedef u8,u16;
@@
 struct sensor_register {  u16 addr ;  u8 value ; } cocci_id@p ;
