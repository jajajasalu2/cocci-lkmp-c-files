...
position p;
@@
 struct drm_client_buffer * cocci_id@p ;
...
position p;
@@
 struct drm_fb_helper cocci_id@p ;
...
position p;
@@
 struct drm_fb_helper_surface_size cocci_id@p ;
...
position p;
@@
 const struct drm_fb_helper_funcs cocci_id@p ;
...
position p;
@@
 const struct drm_client_funcs cocci_id@p ;
...
position p;
@@
 struct drm_client_dev * cocci_id@p ;
