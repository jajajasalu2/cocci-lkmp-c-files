...
position p;
@@
 struct ms_bootblock_page0 {  struct ms_bootblock_header header ;  struct ms_bootblock_sysent sysent ;  struct ms_bootblock_sysinf sysinf ; } cocci_id@p ;
...
typedef u8;
@@
 struct SM_STATUS {  u8 Insert : 1 ;  u8 Ready : 1 ;  u8 MediaChange : 1 ;  u8 Reserved : 3 ;  u8 WtP : 1 ;  u8 IsMS : 1 ; } cocci_id@p ;
...
position p;
@@
 struct ms_bootblock_sysent * cocci_id@p ;
...
typedef u8,u16;
@@
 struct ms_lib_type_extdat {  u8 reserved ;  u8 intr ;  u8 status0 ;  u8 status1 ;  u8 ovrflg ;  u8 mngflg ;  u16 logadr ; } cocci_id@p ;
...
position p;
@@
 struct ms_lib_type_extdat cocci_id@p ;
...
position p;
@@
 struct bulk_cs_wrap * cocci_id@p ;
...
position p;
@@
 struct ene_ub6250_info cocci_id@p ;
...
typedef u8,u32;
@@
 struct ms_bootblock_sysent_rec {  u32 dwStart ;  u32 dwSize ;  u8 bType ;  u8 bReserved [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct ms_bootblock_sysinf * cocci_id@p ;
...
position p;
@@
 struct ms_bootblock_page0 * cocci_id@p ;
...
position p;
@@
 struct ms_bootblock_sysent {  struct ms_bootblock_sysent_rec entry [ MS_NUMBER_OF_SYSTEM_ENTRY ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct us_data * us , unsigned char flag ) ;
...
position p;
@@
 struct ms_bootblock_cis_idi * cocci_id@p ;
...
typedef u8,u16;
@@
 struct ms_bootblock_header {  u16 wBlockID ;  u16 wFormatVersion ;  u8 bReserved1 [ 184 ] ;  u8 bNumberOfDataEntry ;  u8 bReserved2 [ 179 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct MS_STATUS {  u8 Insert : 1 ;  u8 Ready : 1 ;  u8 MediaChange : 1 ;  u8 IsMSPro : 1 ;  u8 IsMSPHG : 1 ;  u8 Reserved1 : 1 ;  u8 WtP : 1 ;  u8 Reserved2 : 1 ; } cocci_id@p ;
...
typedef u8;
@@
 struct SD_STATUS {  u8 Insert : 1 ;  u8 Ready : 1 ;  u8 MediaChange : 1 ;  u8 IsMMC : 1 ;  u8 HiCapacity : 1 ;  u8 HiSpeed : 1 ;  u8 WtP : 1 ;  u8 Reserved : 1 ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct us_data * us ) ;
...
position p;
@@
 struct ms_bootblock_idi * cocci_id@p ;
...
position p;
@@
 struct bulk_cb_wrap * cocci_id@p ;
...
typedef u8;
@@
 struct ms_bootblock_cis {  u8 bCistplDEVICE [ 6 ] ;  u8 bCistplDEVICE0C [ 6 ] ;  u8 bCistplJEDECC [ 4 ] ;  u8 bCistplMANFID [ 6 ] ;  u8 bCistplVER1 [ 32 ] ;  u8 bCistplFUNCID [ 4 ] ;  u8 bCistplFUNCE0 [ 4 ] ;  u8 bCistplFUNCE1 [ 5 ] ;  u8 bCistplCONF [ 7 ] ;  u8 bCistplCFTBLENT0 [ 10 ] ;  u8 bCistplCFTBLENT1 [ 8 ] ;  u8 bCistplCFTBLENT2 [ 12 ] ;  u8 bCistplCFTBLENT3 [ 8 ] ;  u8 bCistplCFTBLENT4 [ 17 ] ;  u8 bCistplCFTBLENT5 [ 8 ] ;  u8 bCistplCFTBLENT6 [ 17 ] ;  u8 bCistplCFTBLENT7 [ 8 ] ;  u8 bCistplNOLINK [ 3 ] ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct ms_lib_ctrl {  u32 flags ;  u32 BytesPerSector ;  u32 NumberOfCylinder ;  u32 SectorsPerCylinder ;  u16 cardType ;  u16 blockSize ;  u16 PagesPerBlock ;  u16 NumberOfPhyBlock ;  u16 NumberOfLogBlock ;  u16 NumberOfSegment ;  u16 * Phy2LogMap ;  u16 * Log2PhyMap ;  u16 wrtblk ;  unsigned char * pagemap [ ( MS_MAX_PAGES_PER_BLOCK + ( MS_LIB_BITS_PER_BYTE - 1 ) ) / MS_LIB_BITS_PER_BYTE ] ;  unsigned char * blkpag ;  struct ms_lib_type_extdat * blkext ;  unsigned char copybuf [ 512 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct ms_bootblock_cis_idi {  union {  struct ms_bootblock_cis cis ;  u8 dmy [ 256 ] ; } cis ;  union {  struct ms_bootblock_idi idi ;  u8 dmy [ 256 ] ; } idi ; } cocci_id@p ;
