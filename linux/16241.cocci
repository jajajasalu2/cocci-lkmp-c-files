...
position p;
@@
 enum { SLOT_STATUS , VOLTAGE , TIME_REMAINING , CURRENT , AVERAGE_CURRENT , AVERAGING_TIME_INTERVAL , CAPACITY_REMAINING , LAST_FULL_CHARGE_CAPACITY , DESIGN_CAPACITY , CRITICAL_CAPACITY , TEMPERATURE , MANUFACTURER , MODEL , TYPE , } cocci_id@p ;
...
position p;
@@
 struct bat_response * cocci_id@p ;
...
typedef u8,s16,u16;
@@
 struct bat_response {  u8 event_type ;  u8 length ;  u8 sub_type ;  u8 status ;  union {  char plc [ 30 ] ;  u16 plu ;  s16 pls ; } ; } cocci_id@p ;
