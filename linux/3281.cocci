...
position p;
@@
 struct smsc47m1_sio_data * cocci_id@p ;
...
position p;
@@
 enum chips { smsc47m1 , smsc47m2 , } cocci_id@p ;
...
position p;
@@
 const struct smsc47m1_sio_data * cocci_id@p ;
...
position p;
@@
 struct smsc47m1_data * cocci_id@p ;
...
typedef u8;
@@
 struct smsc47m1_sio_data {  enum chips type ;  u8 activate ; } cocci_id@p ;
...
typedef u8;
@@
 struct smsc47m1_data {  unsigned short addr ;  const char * name ;  enum chips type ;  struct device * hwmon_dev ;  struct mutex update_lock ;  unsigned long last_updated ;  u8 fan [ 3 ] ;  u8 fan_preload [ 3 ] ;  u8 fan_div [ 3 ] ;  u8 alarms ;  u8 pwm [ 3 ] ; } cocci_id@p ;
