...
position p;
@@
 enum freezer_state_flags { CGROUP_FREEZER_ONLINE = ( 1 << 0 ) , CGROUP_FREEZING_SELF = ( 1 << 1 ) , CGROUP_FREEZING_PARENT = ( 1 << 2 ) , CGROUP_FROZEN = ( 1 << 3 ) , CGROUP_FREEZING = CGROUP_FREEZING_SELF | CGROUP_FREEZING_PARENT , } cocci_id@p ;
...
position p;
@@
 struct freezer {  struct cgroup_subsys_state css ;  unsigned int state ; } cocci_id@p ;
