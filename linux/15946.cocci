...
position p;
@@
 struct uwb_beacon_frame * cocci_id@p ;
...
position p;
@@
 const struct uwb_mac_addr * cocci_id@p ;
...
position p;
@@
 const struct uwb_dev_addr * cocci_id@p ;
...
position p;
@@
 struct uwb_rc_cmd_start_beacon * cocci_id@p ;
