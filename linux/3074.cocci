...
position p;
@@
 struct blkif_x86_64_sring * cocci_id@p ;
...
position p;
@@
 struct blkif_x86_32_sring * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xen_vbd * vbd ) ;
...
position p;
@@
 struct blkif_common_sring * cocci_id@p ;
...
position p;
@@
 struct backend_info * cocci_id@p ;
...
position p;
@@
 struct backend_info {  struct xenbus_device * dev ;  struct xen_blkif * blkif ;  struct xenbus_watch backend_watch ;  unsigned major ;  unsigned minor ;  char * mode ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef blkif_vdev_t;
@@
 blkif_vdev_t cocci_id@p ;
...
position p;
@@
 const struct blkif_common_sring * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ XENBUS_MAX_RING_GRANTS ] ;
...
position p;
@@
 void cocci_id@p ( struct xen_blkif * blkif ) ;
...
position p;
@@
 void cocci_id@p ( struct backend_info * ) ;
...
position p;
@@
 int cocci_id@p ( struct backend_info * ) ;
