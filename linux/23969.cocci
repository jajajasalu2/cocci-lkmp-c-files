...
position p;
@@
 const struct illinois * cocci_id@p ;
...
@@
 struct illinois {  u64 sum_rtt ;  u16 cnt_rtt ;  u32 base_rtt ;  u32 max_rtt ;  u32 end_seq ;  u32 alpha ;  u32 beta ;  u16 acked ;  u8 rtt_above ;  u8 rtt_low ; } cocci_id@p ;
