...
position p;
@@
 struct xgene_edac_dev_ctx {  struct list_head next ;  struct device ddev ;  char * name ;  struct xgene_edac * edac ;  struct edac_device_ctl_info * edac_dev ;  int edac_idx ;  void __iomem * dev_csr ;  int version ; } cocci_id@p ;
...
typedef u32;
@@
 struct xgene_edac_pmd_ctx {  struct list_head next ;  struct device ddev ;  char * name ;  struct xgene_edac * edac ;  struct edac_device_ctl_info * edac_dev ;  void __iomem * pmd_csr ;  u32 pmd ;  int version ; } cocci_id@p ;
...
position p;
@@
 struct xgene_edac_mc_ctx cocci_id@p ;
...
position p;
@@
 struct xgene_edac_dev_ctx * cocci_id@p ;
...
typedef u32;
@@
 struct xgene_edac_mc_ctx {  struct list_head next ;  char * name ;  struct mem_ctl_info * mci ;  struct xgene_edac * edac ;  void __iomem * mcu_csr ;  u32 mcu_id ; } cocci_id@p ;
...
position p;
@@
 struct xgene_edac_pmd_ctx * cocci_id@p ;
