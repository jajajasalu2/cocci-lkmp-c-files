...
position p;
@@
 void cocci_id@p ( struct ehci_hcd * ehci , struct ehci_qh * qh ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 budget_table [ EHCI_BANDWIDTH_SIZE ] , struct ehci_tt * tt ) ;
...
position p;
@@
 void cocci_id@p ( struct ehci_hcd * ehci ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct ehci_hcd * ehci , int portnum , bool enable ) ;
