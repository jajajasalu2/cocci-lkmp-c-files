...
position p;
@@
 struct mips_huge_tlb_info cocci_id@p ;
...
position p;
@@
 const enum label_id cocci_id@p ;
...
position p;
@@
 enum vmalloc64_mode { not_refill , refill_scratch , refill_noscratch , } cocci_id@p ;
...
position p;
@@
 struct work_registers cocci_id@p ;
...
position p;
@@
 enum vmalloc64_mode cocci_id@p ;
...
position p;
@@
 struct tlb_reg_save cocci_id@p ;
...
position p;
@@
 struct work_registers {  int r1 ;  int r2 ;  int r3 ; } cocci_id@p ;
...
position p;
@@
 enum tlb_write_entry cocci_id@p ;
...
typedef bool;
@@
 struct mips_huge_tlb_info {  int huge_pte ;  int restore_scratch ;  bool need_reload_pte ; } cocci_id@p ;
...
position p;
@@
 struct uasm_reloc cocci_id@p [ 128 ] ;
...
position p;
@@
 struct tlb_reg_save cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct uasm_label cocci_id@p [ 128 ] ;
