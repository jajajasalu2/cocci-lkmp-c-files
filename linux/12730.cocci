...
position p;
@@
 const struct tegra_smmu_group_soc * cocci_id@p ;
...
position p;
@@
 const struct tegra_smmu_soc * cocci_id@p ;
...
@@
 struct tegra_smmu_as {  struct iommu_domain domain ;  struct tegra_smmu * smmu ;  unsigned int use_count ;  u32 * count ;  struct page * * pts ;  struct page * pd ;  dma_addr_t pd_dma ;  unsigned id ;  u32 attr ; } cocci_id@p ;
...
position p;
@@
 struct tegra_smmu_as cocci_id@p ;
...
position p;
@@
 const struct tegra_smmu_swgroup * cocci_id@p ;
...
position p;
@@
 const struct tegra_mc_client * cocci_id@p ;
...
position p;
@@
 struct tegra_smmu {  void __iomem * regs ;  struct device * dev ;  struct tegra_mc * mc ;  const struct tegra_smmu_soc * soc ;  struct list_head groups ;  unsigned long pfn_mask ;  unsigned long tlb_mask ;  unsigned long * asids ;  struct mutex lock ;  struct list_head list ;  struct dentry * debugfs ;  struct iommu_device iommu ; } cocci_id@p ;
...
position p;
@@
 struct tegra_smmu_group {  struct list_head list ;  const struct tegra_smmu_group_soc * soc ;  struct iommu_group * group ; } cocci_id@p ;
...
position p;
@@
 struct tegra_smmu_group * cocci_id@p ;
