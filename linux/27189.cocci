...
position p;
@@
 void cocci_id@p ( struct dlm_ls * ls , int nodeid , int pid ) ;
...
position p;
@@
 void cocci_id@p ( struct dlm_lkb * lkb ) ;
...
position p;
@@
 int cocci_id@p ( struct dlm_message * ms ) ;
...
position p;
@@
 char cocci_id@p [ DLM_RESNAME_MAXLEN + 1 ] ;
...
position p;
@@
 int cocci_id@p ( struct dlm_rsb * r , struct dlm_lkb * lkb ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * astarg , int mode ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * astparam , int mode ) ;
...
position p;
@@
 void cocci_id@p ( struct dlm_rsb * r , struct dlm_lkb * lkb , struct dlm_message * ms ) ;
...
position p;
@@
 char cocci_id@p [ DLM_RESNAME_MAXLEN ] ;
...
position p;
@@
 int cocci_id@p ( struct dlm_rsb * r ) ;
...
position p;
@@
 int cocci_id@p ( struct dlm_rsb * r , struct dlm_lkb * lkb , int mode ) ;
