...
position p;
@@
 const char * const cocci_id@p [ CS53L30_NUM_SUPPLIES ] ;
...
typedef u8,u32;
@@
 struct cs53l30_mclkx_div {  u32 mclkx ;  u8 ratio ;  u8 mclkdiv ; } cocci_id@p ;
...
position p;
@@
 const struct cs53l30_mclkx_div cocci_id@p [ ] ;
...
position p;
@@
 struct cs53l30_private * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cs53l30_mclk_div {  u32 mclk_rate ;  u32 srate ;  u8 asp_rate ;  u8 internal_fs_ratio ;  u8 mclk_int_scale ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct cs53l30_private {  struct regulator_bulk_data supplies [ CS53L30_NUM_SUPPLIES ] ;  struct regmap * regmap ;  struct gpio_desc * reset_gpio ;  struct gpio_desc * mute_gpio ;  struct clk * mclk ;  bool use_sdout2 ;  u32 mclk_rate ; } cocci_id@p ;
...
position p;
@@
 const struct cs53l30_mclk_div cocci_id@p [ ] ;
...
position p;
@@
 unsigned int cocci_id@p [ CS53L30_TDM_SLOT_MAX ] ;
