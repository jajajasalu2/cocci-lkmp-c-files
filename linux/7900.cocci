...
position p;
@@
 const struct realtek_smi_ops cocci_id@p ;
...
position p;
@@
 struct rtl8366_vlan_4k cocci_id@p ;
...
position p;
@@
 const struct rtl8366_vlan_mc * cocci_id@p ;
...
position p;
@@
 struct rtl8366_vlan_mc cocci_id@p ;
...
position p;
@@
 struct rtl8366_mib_counter cocci_id@p [ ] ;
...
position p;
@@
 const struct rtl8366_vlan_4k * cocci_id@p ;
...
position p;
@@
 const struct realtek_smi_variant cocci_id@p ;
