...
position p;
@@
 int cocci_id@p ( struct snd_emux_port * port , struct snd_midi_channel * chan ) ;
...
position p;
@@
 struct snd_sf_zone * cocci_id@p [ SNDRV_EMUX_MAX_MULTI_VOICES ] ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux * emu , struct snd_emux_voice * vp , int update ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux * emu , int note , struct snd_midi_channel * chan , int free ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux * emu , struct snd_emux_port * port , int exclass ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux * emu , struct snd_emux_voice * vp , int free ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_emux * emu , struct snd_emux_port * port , int * notep , int vel , struct snd_midi_channel * chan , struct snd_sf_zone * * table ) ;
...
position p;
@@
 struct snd_emux_effect_table * cocci_id@p ;
