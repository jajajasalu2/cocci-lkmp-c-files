...
position p;
@@
 struct id_map_entry cocci_id@p ;
...
position p;
@@
 struct cm_req_msg {  unsigned char unused [ 0x60 ] ;  union ib_gid primary_path_sgid ; } cocci_id@p ;
...
typedef __be32;
@@
 struct cm_generic_msg {  struct ib_mad_hdr hdr ;  __be32 local_comm_id ;  __be32 remote_comm_id ; } cocci_id@p ;
...
typedef __be32;
@@
 struct cm_sidr_generic_msg {  struct ib_mad_hdr hdr ;  __be32 request_id ; } cocci_id@p ;
...
position p;
@@
 struct cm_generic_msg * cocci_id@p ;
...
typedef u32;
@@
 struct id_map_entry {  struct rb_node node ;  u32 sl_cm_id ;  u32 pv_cm_id ;  int slave_id ;  int scheduled_delete ;  struct mlx4_ib_dev * dev ;  struct list_head list ;  struct delayed_work timeout ; } cocci_id@p ;
...
position p;
@@
 struct cm_sidr_generic_msg * cocci_id@p ;
