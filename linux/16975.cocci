...
@@
 struct ad7877 {  struct input_dev * input ;  char phys [ 32 ] ;  struct spi_device * spi ;  u16 model ;  u16 vref_delay_usecs ;  u16 x_plate_ohms ;  u16 pressure_max ;  u16 cmd_crtl1 ;  u16 cmd_crtl2 ;  u16 cmd_dummy ;  u16 dac ;  u8 stopacq_polarity ;  u8 first_conversion_delay ;  u8 acquisition_time ;  u8 averaging ;  u8 pen_down_acc_interval ;  struct spi_transfer xfer [ AD7877_NR_SENSE + 2 ] ;  struct spi_message msg ;  struct mutex mutex ;  bool disabled ;  bool gpio3 ;  bool gpio4 ;  spinlock_t lock ;  struct timer_list timer ;  u16 conversion_data [ AD7877_NR_SENSE ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum { AD7877_SEQ_YPOS = 0 , AD7877_SEQ_XPOS = 1 , AD7877_SEQ_Z2 = 2 , AD7877_SEQ_AUX1 = 3 , AD7877_SEQ_AUX2 = 4 , AD7877_SEQ_AUX3 = 5 , AD7877_SEQ_BAT1 = 6 , AD7877_SEQ_BAT2 = 7 , AD7877_SEQ_TEMP1 = 8 , AD7877_SEQ_TEMP2 = 9 , AD7877_SEQ_Z1 = 10 , AD7877_NR_SENSE = 11 , } cocci_id@p ;
...
typedef u16;
@@
 struct ser_req {  u16 reset ;  u16 ref_on ;  u16 command ;  struct spi_message msg ;  struct spi_transfer xfer [ 6 ] ;  u16 sample ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ad7877_platform_data * cocci_id@p ;
