...
position p;
@@
 const struct s5c73m3_frame_size * * cocci_id@p ;
...
position p;
@@
 const struct s5c73m3_interval cocci_id@p [ ] ;
...
position p;
@@
 const char * const cocci_id@p [ S5C73M3_MAX_SUPPLIES ] ;
...
position p;
@@
 enum s5c73m3_resolution_types cocci_id@p ;
...
position p;
@@
 struct s5c73m3_gpio * cocci_id@p ;
...
position p;
@@
 const struct s5c73m3_platform_data * cocci_id@p ;
...
position p;
@@
 const struct s5c73m3_frame_size * const cocci_id@p [ ] ;
