...
position p;
@@
 const struct op_msrs * const cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ OP_MAX_COUNTER ] ;
...
typedef u64;
@@
 struct ibs_state {  u64 ibs_op_ctl ;  int branch_target ;  unsigned long sample_size ; } cocci_id@p ;
...
position p;
@@
 struct op_x86_model_spec cocci_id@p ;
...
position p;
@@
 const struct op_x86_model_spec * cocci_id@p ;
...
position p;
@@
 struct oprofile_operations * cocci_id@p ;
...
position p;
@@
 struct ibs_config {  unsigned long op_enabled ;  unsigned long fetch_enabled ;  unsigned long max_cnt_fetch ;  unsigned long max_cnt_op ;  unsigned long rand_en ;  unsigned long dispatched_ops ;  unsigned long branch_target ; } cocci_id@p ;
...
position p;
@@
 struct op_msrs * const cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct dentry * root ) ;
...
position p;
@@
 struct pt_regs * const cocci_id@p ;
