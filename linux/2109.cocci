...
position p;
@@
 struct xgene_reboot_context cocci_id@p ;
...
typedef u32;
@@
 struct xgene_reboot_context {  struct device * dev ;  void * csr ;  u32 mask ;  struct notifier_block restart_handler ; } cocci_id@p ;
