...
position p;
@@
 void cocci_id@p ( struct fb_info * info , const struct fb_copyarea * area ) ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * , const struct fb_fillrect * ) ;
...
typedef u32;
@@
 struct bt_regs {  u32 addr ;  u32 color_map ;  u32 control ;  u32 cursor ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * , const struct fb_image * ) ;
...
typedef u32;
@@
 struct cg6_thc {  u32 thc_pad0 [ 512 ] ;  u32 thc_hs ;  u32 thc_hsdvs ;  u32 thc_hd ;  u32 thc_vs ;  u32 thc_vd ;  u32 thc_refresh ;  u32 thc_misc ;  u32 thc_pad1 [ 56 ] ;  u32 thc_cursxy ;  u32 thc_cursmask [ 32 ] ;  u32 thc_cursbits [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct cg6_tec {  int tec_matrix ;  int tec_clip ;  int tec_vdc ; } cocci_id@p ;
