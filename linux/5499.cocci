...
position p;
@@
 struct lantiq_ssc_spi cocci_id@p ;
...
position p;
@@
 const struct lantiq_ssc_hwcfg * cocci_id@p ;
...
@@
 struct lantiq_ssc_spi {  struct spi_master * master ;  struct device * dev ;  void __iomem * regbase ;  struct clk * spi_clk ;  struct clk * fpi_clk ;  const struct lantiq_ssc_hwcfg * hwcfg ;  spinlock_t lock ;  struct workqueue_struct * wq ;  struct work_struct work ;  const u8 * tx ;  u8 * rx ;  unsigned int tx_todo ;  unsigned int rx_todo ;  unsigned int bits_per_word ;  unsigned int speed_hz ;  unsigned int tx_fifo_size ;  unsigned int rx_fifo_size ;  unsigned int base_cs ; } cocci_id@p ;
...
typedef irnen_t;
@@
 struct lantiq_ssc_hwcfg {  unsigned int irnen_r ;  unsigned int irnen_t ; } cocci_id@p ;
...
position p;
@@
 const struct lantiq_ssc_spi * cocci_id@p ;
