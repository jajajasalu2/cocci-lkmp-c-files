...
position p;
@@
 struct drm_modeset_ctl * cocci_id@p ;
...
position p;
@@
 struct drm_crtc_queue_sequence * cocci_id@p ;
...
position p;
@@
 struct drm_wait_vblank_reply * cocci_id@p ;
...
position p;
@@
 struct drm_crtc_get_sequence * cocci_id@p ;
