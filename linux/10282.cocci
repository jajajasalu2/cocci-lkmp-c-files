...
typedef bool;
@@
 struct hdmi_data_info {  int vic ;  bool sink_is_hdmi ;  bool sink_has_audio ;  unsigned int enc_in_format ;  unsigned int enc_out_format ;  unsigned int colorimetry ; } cocci_id@p ;
...
typedef u8;
@@
 struct inno_hdmi_i2c {  struct i2c_adapter adap ;  u8 ddc_addr ;  u8 segment_addr ;  struct mutex lock ;  struct completion cmp ; } cocci_id@p ;
...
position p;
@@
 struct inno_hdmi {  struct device * dev ;  struct drm_device * drm_dev ;  int irq ;  struct clk * pclk ;  void __iomem * regs ;  struct drm_connector connector ;  struct drm_encoder encoder ;  struct inno_hdmi_i2c * i2c ;  struct i2c_adapter * ddc ;  unsigned int tmds_rate ;  struct hdmi_data_info hdmi_data ;  struct drm_display_mode previous_mode ; } cocci_id@p ;
...
position p;
@@
 struct drm_encoder_funcs cocci_id@p ;
...
position p;
@@
 struct inno_hdmi_i2c * cocci_id@p ;
...
position p;
@@
 enum { CSC_ITU601_16_235_TO_RGB_0_255_8BIT , CSC_ITU601_0_255_TO_RGB_0_255_8BIT , CSC_ITU709_16_235_TO_RGB_0_255_8BIT , CSC_RGB_0_255_TO_ITU601_16_235_8BIT , CSC_RGB_0_255_TO_ITU709_16_235_8BIT , CSC_RGB_0_255_TO_RGB_16_235_8BIT , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HDMI_MAXIMUM_INFO_FRAME_SIZE ] ;
...
position p;
@@
 struct drm_encoder_helper_funcs cocci_id@p ;
...
position p;
@@
 struct drm_connector_helper_funcs cocci_id@p ;
