...
position p;
@@
 enum { STATUS0_IDLE = 0x00 , STATUS0_BUSY = 0x01 , STATUS0_COMPLETE = 0x02 , STATUS0_ERROR = 0x03 , } cocci_id@p ;
...
position p;
@@
 struct cp2112_xfer_status_report * cocci_id@p ;
...
position p;
@@
 struct cp2112_usb_config_report * cocci_id@p ;
...
position p;
@@
 struct cp2112_smbus_config_report cocci_id@p ;
...
position p;
@@
 struct cp2112_force_read_report cocci_id@p ;
...
position p;
@@
 struct cp2112_pstring_attribute * cocci_id@p ;
...
position p;
@@
 struct cp2112_write_req_report * cocci_id@p ;
...
position p;
@@
 struct cp2112_pstring_attribute {  struct device_attribute attr ;  unsigned char report ; } cocci_id@p ;
...
position p;
@@
 struct cp2112_write_read_req_report * cocci_id@p ;
...
position p;
@@
 enum { STATUS1_TIMEOUT_NACK = 0x00 , STATUS1_TIMEOUT_BUS = 0x01 , STATUS1_ARBITRATION_LOST = 0x02 , STATUS1_READ_INCOMPLETE = 0x03 , STATUS1_WRITE_INCOMPLETE = 0x04 , STATUS1_SUCCESS = 0x05 , } cocci_id@p ;
...
position p;
@@
 struct cp2112_read_req_report * cocci_id@p ;
...
@@
 struct cp2112_device {  struct i2c_adapter adap ;  struct hid_device * hdev ;  wait_queue_head_t wait ;  u8 read_data [ 61 ] ;  u8 read_length ;  u8 hwversion ;  int xfer_status ;  atomic_t read_avail ;  atomic_t xfer_avail ;  struct gpio_chip gc ;  u8 * in_out_buffer ;  struct mutex lock ;  struct gpio_desc * desc [ 8 ] ;  bool gpio_poll ;  struct delayed_work gpio_poll_worker ;  unsigned long irq_mask ;  u8 gpio_prev_state ; } cocci_id@p ;
...
position p;
@@
 struct cp2112_device * cocci_id@p ;
...
position p;
@@
 struct cp2112_string_report cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hid_device * hdev ) ;
