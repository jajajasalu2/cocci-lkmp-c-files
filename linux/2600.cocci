...
position p;
@@
 struct mxs_ocotp {  struct clk * clk ;  void __iomem * base ;  struct nvmem_device * nvmem ; } cocci_id@p ;
...
position p;
@@
 const struct mxs_data * cocci_id@p ;
...
position p;
@@
 struct mxs_data {  int size ; } cocci_id@p ;
