...
position p;
@@
 struct sco_conninfo cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sco_conn {  struct hci_conn * hcon ;  spinlock_t lock ;  struct sock * sk ;  unsigned int mtu ; } cocci_id@p ;
...
position p;
@@
 struct sockaddr_sco cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u16,__u32,bdaddr_t;
@@
 struct sco_pinfo {  struct bt_sock bt ;  bdaddr_t src ;  bdaddr_t dst ;  __u32 flags ;  __u16 setting ;  struct sco_conn * conn ; } cocci_id@p ;
