...
@@
 struct compat_nfs_string {  compat_uint_t len ;  compat_uptr_t data ; } cocci_id@p ;
...
position p;
@@
 struct compat_nfs_string * cocci_id@p ;
...
position p;
@@
 struct compat_nfs4_mount_data_v1 * cocci_id@p ;
