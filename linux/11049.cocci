...
position p;
@@
 struct pm4_mes_runlist * cocci_id@p ;
...
position p;
@@
 struct pm4_mes_map_process cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct kernel_queue * kq , struct kfd_dev * dev , enum kfd_queue_type type , unsigned int queue_size ) ;
...
position p;
@@
 struct packet_manager * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kernel_queue * kq ) ;
...
position p;
@@
 struct pm4_mes_unmap_queues * cocci_id@p ;
...
position p;
@@
 struct pm4_mes_map_queues cocci_id@p ;
...
position p;
@@
 struct pm4_mec_release_mem cocci_id@p ;
...
position p;
@@
 struct pm4_mes_set_resources cocci_id@p ;
...
position p;
@@
 struct kernel_queue_ops * cocci_id@p ;
...
position p;
@@
 union PM4_MES_TYPE_3_HEADER cocci_id@p ;
...
position p;
@@
 struct pm4_mes_query_status cocci_id@p ;
