...
typedef u32;
@@
 struct sony_btf_mpx {  struct v4l2_subdev sd ;  int mpxmode ;  u32 audmode ; } cocci_id@p ;
...
position p;
@@
 struct sony_btf_mpx * cocci_id@p ;
...
typedef u16;
@@
 const struct {  enum { AUD_MONO , AUD_A2 , AUD_NICAM , AUD_NICAM_L , } audio_mode ;  u16 modus ;  u16 source ;  u16 acb ;  u16 fm_prescale ;  u16 nicam_prescale ;  u16 scart_prescale ;  u16 system ;  u16 volume ; } cocci_id@p [ ] ;
