...
position p;
@@
 enum { NUM_WORDS_ELTFP25519 = 4 , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CURVE25519_KEY_SIZE ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ CURVE25519_KEY_SIZE ] ;
...
typedef u64;
@@
 u64 cocci_id@p [ 2 * NUM_WORDS_ELTFP25519 ] ;
...
typedef u64;
@@
 u64 cocci_id@p [ NUM_WORDS_ELTFP25519 ] ;
...
typedef u64;
@@
 const u64 cocci_id@p [ 252 * NUM_WORDS_ELTFP25519 ] ;
