...
position p;
@@
 struct {  const char * name ;  int args ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ NVDIMM_KEY_DESC_LEN + sizeof ( NVDIMM_PREFIX ) ] ;
...
position p;
@@
 enum nvdimmsec_op_ids { OPS , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SEC_CMD_SIZE + 1 ] ;
