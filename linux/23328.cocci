...
position p;
@@
 const struct cs42l73_mclkx_div cocci_id@p [ ] ;
...
position p;
@@
 struct cs42l73_platform_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cs42l73_mclk_div {  u32 mclk ;  u32 srate ;  u8 mmcc ; } cocci_id@p ;
...
position p;
@@
 struct cs42l73_private * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cs42l73_private {  struct cs42l73_platform_data pdata ;  struct sp_config config [ 3 ] ;  struct regmap * regmap ;  u32 sysclk ;  u8 mclksel ;  u32 mclk ;  int shutdwn_delay ; } cocci_id@p ;
...
position p;
@@
 const struct cs42l73_mclk_div cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct cs42l73_mclkx_div {  u32 mclkx ;  u8 ratio ;  u8 mclkdiv ; } cocci_id@p ;
