...
position p;
@@
 struct sh_mtu2_device cocci_id@p ;
...
@@
 struct sh_mtu2_device {  struct platform_device * pdev ;  void __iomem * mapbase ;  struct clk * clk ;  raw_spinlock_t lock ;  struct sh_mtu2_channel * channels ;  unsigned int num_channels ;  bool has_clockevent ; } cocci_id@p ;
...
position p;
@@
 struct sh_mtu2_channel cocci_id@p ;
...
position p;
@@
 struct sh_mtu2_channel {  struct sh_mtu2_device * mtu ;  unsigned int index ;  void __iomem * base ;  struct clock_event_device ced ; } cocci_id@p ;
