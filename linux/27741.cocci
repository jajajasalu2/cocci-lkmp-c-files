...
position p;
@@
 struct get_name_filldir * cocci_id@p ;
...
position p;
@@
 struct gfs2_inum_host cocci_id@p ;
...
position p;
@@
 struct get_name_filldir {  struct dir_context ctx ;  struct gfs2_inum_host inum ;  char * name ; } cocci_id@p ;
