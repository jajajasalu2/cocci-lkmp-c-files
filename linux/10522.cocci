...
position p;
@@
 struct radeon_atpx_functions * cocci_id@p ;
...
@@
 struct radeon_atpx {  acpi_handle handle ;  struct radeon_atpx_functions functions ;  bool is_hybrid ;  bool dgpu_req_power_for_displays ; } cocci_id@p ;
...
typedef acpi_handle,bool;
@@
 struct radeon_atpx_priv {  bool atpx_detected ;  bool bridge_pm_usable ;  acpi_handle dhandle ;  struct radeon_atpx atpx ; } cocci_id@p ;
...
typedef bool;
@@
 struct radeon_atpx_functions {  bool px_params ;  bool power_cntl ;  bool disp_mux_cntl ;  bool i2c_mux_cntl ;  bool switch_start ;  bool switch_end ;  bool disp_connectors_mapping ;  bool disp_detetion_ports ; } cocci_id@p ;
