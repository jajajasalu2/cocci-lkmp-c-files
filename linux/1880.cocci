...
typedef u32;
@@
 struct stm32_adc_priv_cfg {  const struct stm32_adc_common_regs * regs ;  int ( * clk_sel ) ( struct platform_device * , struct stm32_adc_priv * ) ;  u32 max_clk_rate_hz ;  unsigned int has_syscfg ; } cocci_id@p ;
...
typedef u32;
@@
 struct stm32h7_adc_ck_spec {  u32 ckmode ;  u32 presc ;  int div ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_adc_priv_cfg cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ STM32_ADC_MAX_ADCS ] ;
...
position p;
@@
 const struct stm32h7_adc_ck_spec cocci_id@p [ ] ;
...
position p;
@@
 const struct stm32_adc_common_regs cocci_id@p ;
...
typedef u32;
@@
 struct stm32_adc_common_regs {  u32 csr ;  u32 ccr ;  u32 eoc1_msk ;  u32 eoc2_msk ;  u32 eoc3_msk ;  u32 ier ;  u32 eocie_msk ; } cocci_id@p ;
...
position p;
@@
 struct stm32_adc_priv * cocci_id@p ;
...
typedef u32;
@@
 struct stm32_adc_priv {  int irq [ STM32_ADC_MAX_ADCS ] ;  struct irq_domain * domain ;  struct clk * aclk ;  struct clk * bclk ;  u32 max_clk_rate ;  struct regulator * booster ;  struct regulator * vdd ;  struct regulator * vdda ;  struct regulator * vref ;  int vdd_uv ;  int vdda_uv ;  const struct stm32_adc_priv_cfg * cfg ;  struct stm32_adc_common common ;  u32 ccr_bak ;  struct regmap * syscfg ; } cocci_id@p ;
...
position p;
@@
 struct stm32_adc_common * cocci_id@p ;
