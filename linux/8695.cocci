...
position p;
@@
 const struct igbvf_stats cocci_id@p [ ] ;
...
position p;
@@
 struct igbvf_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ;  int base_stat_offset ; } cocci_id@p ;
