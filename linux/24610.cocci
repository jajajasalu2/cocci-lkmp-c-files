...
position p;
@@
 enum pkt_flags { PKT_FLAGS , } cocci_id@p ;
...
typedef __be32;
@@
 struct pktgen_hdr {  __be32 pgh_magic ;  __be32 seq_num ;  __be32 tv_sec ;  __be32 tv_usec ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pktgen_thread * t ) ;
...
position p;
@@
 int cocci_id@p ( struct pktgen_thread * t , const char * ifname ) ;
...
position p;
@@
 const struct pktgen_net * cocci_id@p ;
...
typedef bool;
@@
 struct pktgen_net {  struct net * net ;  struct proc_dir_entry * proc_dir ;  struct list_head pktgen_threads ;  bool pktgen_exiting ; } cocci_id@p ;
...
position p;
@@
 struct pktgen_thread * cocci_id@p ;
...
typedef bool;
@@
 struct pktgen_dev * cocci_id@p ( struct pktgen_thread * t , const char * ifname , bool exact ) ;
...
position p;
@@
 void cocci_id@p ( struct pktgen_net * pn ) ;
...
position p;
@@
 void cocci_id@p ( struct pktgen_dev * pkt_dev ) ;
...
@@
 struct pktgen_thread {  struct mutex if_lock ;  struct list_head if_list ;  struct list_head th_list ;  struct task_struct * tsk ;  char result [ 512 ] ;  u32 control ;  int cpu ;  wait_queue_head_t queue ;  struct completion start_done ;  struct pktgen_net * net ; } cocci_id@p ;
...
position p;
@@
 const struct pktgen_dev * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pktgen_thread * t , struct pktgen_dev * i ) ;
...
position p;
@@
 const struct pktgen_thread * cocci_id@p ;
