...
position p;
@@
 struct a6xx_crashdumper cocci_id@p ;
...
position p;
@@
 struct a6xx_gpu_state cocci_id@p ;
...
typedef u64;
@@
 struct a6xx_crashdumper {  void * ptr ;  struct drm_gem_object * bo ;  u64 iova ; } cocci_id@p ;
...
position p;
@@
 struct a6xx_gpu_state {  struct msm_gpu_state base ;  struct a6xx_gpu_state_obj * gmu_registers ;  int nr_gmu_registers ;  struct a6xx_gpu_state_obj * registers ;  int nr_registers ;  struct a6xx_gpu_state_obj * shaders ;  int nr_shaders ;  struct a6xx_gpu_state_obj * clusters ;  int nr_clusters ;  struct a6xx_gpu_state_obj * dbgahb_clusters ;  int nr_dbgahb_clusters ;  struct a6xx_gpu_state_obj * indexed_regs ;  int nr_indexed_regs ;  struct a6xx_gpu_state_obj * debugbus ;  int nr_debugbus ;  struct a6xx_gpu_state_obj * vbif_debugbus ;  struct a6xx_gpu_state_obj * cx_debugbus ;  int nr_cx_debugbus ;  struct list_head objs ; } cocci_id@p ;
...
position p;
@@
 struct a6xx_gpu_state_obj * cocci_id@p ;
...
position p;
@@
 const struct a6xx_dbgahb_cluster * cocci_id@p ;
...
position p;
@@
 const struct a6xx_indexed_registers * cocci_id@p ;
...
typedef u32;
@@
 struct a6xx_gpu_state_obj {  const void * handle ;  u32 * data ; } cocci_id@p ;
...
position p;
@@
 const struct a6xx_registers * cocci_id@p ;
...
position p;
@@
 const struct a6xx_shader_block * cocci_id@p ;
...
position p;
@@
 const struct a6xx_debugbus_block * cocci_id@p ;
...
position p;
@@
 struct msm_gpu_state cocci_id@p ;
...
position p;
@@
 struct a6xx_state_memobj * cocci_id@p ;
...
position p;
@@
 struct a6xx_state_memobj {  struct list_head node ;  unsigned long long data [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct a6xx_cluster * cocci_id@p ;
