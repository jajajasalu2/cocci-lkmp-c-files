...
position p;
@@
 struct fsl_pq_mdio_priv {  void __iomem * map ;  struct fsl_pq_mii __iomem * regs ; } cocci_id@p ;
...
typedef uint32_t;
@@
 uint32_t __iomem * ( * cocci_id@p ) ( void __iomem * ) ;
...
position p;
@@
 struct fsl_pq_mdio_data cocci_id@p ;
...
typedef u32;
@@
 struct fsl_pq_mii {  u32 miimcfg ;  u32 miimcom ;  u32 miimadd ;  u32 miimcon ;  u32 miimstat ;  u32 miimind ; } cocci_id@p ;
...
position p;
@@
 struct fsl_pq_mdio_priv * cocci_id@p ;
...
position p;
@@
 const struct fsl_pq_mdio_data * cocci_id@p ;
