...
position p;
@@
 struct mlx5e_cq_param cocci_id@p ;
...
position p;
@@
 struct mlx5e_rq_param cocci_id@p ;
...
position p;
@@
 struct mlx5e_tx_wqe_info * cocci_id@p ;
...
position p;
@@
 struct mlx5e_channel_param * cocci_id@p ;
...
position p;
@@
 const struct mlx5e_profile * cocci_id@p ;
...
position p;
@@
 const struct mlx5e_tirc_config cocci_id@p [ MLX5E_NUM_INDIR_TIRS ] ;
...
position p;
@@
 struct mlx5e_channels * cocci_id@p ;
...
position p;
@@
 const struct mlx5e_tirc_config * cocci_id@p ;
...
position p;
@@
 mlx5e_feature_handler cocci_id@p ;
...
typedef u16;
@@
 struct mlx5e_vxlan_work {  struct work_struct work ;  struct mlx5e_priv * priv ;  u16 port ; } cocci_id@p ;
...
position p;
@@
 struct mlx5e_xdp_wqe_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * recover_work ) ;
...
position p;
@@
 struct dim_cq_moder cocci_id@p ;
...
position p;
@@
 struct mlx5e_modify_sq_param cocci_id@p ;
...
position p;
@@
 struct mlx5e_xdp_info_fifo * cocci_id@p ;
...
position p;
@@
 struct mlx5e_rq_stats * cocci_id@p ;
...
position p;
@@
 struct mlx5e_create_sq_param * cocci_id@p ;
...
position p;
@@
 struct mlx5e_xsk_param cocci_id@p ;
...
position p;
@@
 struct mlx5e_umr_wqe * cocci_id@p ;
...
position p;
@@
 struct mlx5e_sq_param * cocci_id@p ;
...
position p;
@@
 struct mlx5e_vxlan_work * cocci_id@p ;
...
position p;
@@
 struct mlx5e_channel * * cocci_id@p ;
...
position p;
@@
 struct mlx5e_tx_wqe * cocci_id@p ;
...
position p;
@@
 struct mlx5e_sq_stats * cocci_id@p ;
...
position p;
@@
 struct mlx5e_rq_frag_info * cocci_id@p ;
...
position p;
@@
 struct mlx5e_rx_wqe_cyc * cocci_id@p ;
...
position p;
@@
 struct mlx5e_vport_stats * cocci_id@p ;
...
position p;
@@
 struct mlx5e_rx_wqe_ll * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct net_device * dev , struct mlx5e_txqsq * sq , u32 rate ) ;
...
position p;
@@
 struct mlx5e_dma_info * cocci_id@p ;
...
position p;
@@
 struct mlx5e_wqe_frag_info * cocci_id@p ;
...
position p;
@@
 struct ifla_vf_stats * cocci_id@p ;
...
position p;
@@
 struct mlx5e_rq_frags_info * cocci_id@p ;
...
position p;
@@
 struct mlx5e_pport_stats * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_cq_out ) ] ;
...
typedef u8,u32;
@@
 struct mlx5e_create_sq_param {  struct mlx5_wq_ctrl * wq_ctrl ;  u32 cqn ;  u32 tisn ;  u8 tis_lst_sz ;  u8 min_inline_mode ; } cocci_id@p ;
...
typedef bool;
@@
 int ( * cocci_id@p ) ( struct net_device * netdev , bool enable ) ;
...
position p;
@@
 struct mlx5e_redirect_rqt_param cocci_id@p ;
...
position p;
@@
 struct mlx5e_rss_params * cocci_id@p ;
...
position p;
@@
 struct mlx5e_params * cocci_id@p ;
...
position p;
@@
 struct mlx5e_channel_stats * cocci_id@p ;
...
position p;
@@
 enum mlx5e_traffic_types cocci_id@p ;
