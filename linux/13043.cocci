...
position p;
@@
 struct owl_sps_domain * cocci_id@p ;
...
position p;
@@
 struct owl_sps_info {  unsigned num_domains ;  const struct owl_sps_domain_info * domains ; } cocci_id@p ;
...
position p;
@@
 const struct owl_sps_domain_info cocci_id@p [ ] ;
...
position p;
@@
 const struct owl_sps_info cocci_id@p ;
...
position p;
@@
 struct owl_sps {  struct device * dev ;  const struct owl_sps_info * info ;  void __iomem * base ;  struct genpd_onecell_data genpd_data ;  struct generic_pm_domain * domains [ ] ; } cocci_id@p ;
...
position p;
@@
 struct owl_sps_domain {  struct generic_pm_domain genpd ;  const struct owl_sps_domain_info * info ;  struct owl_sps * sps ; } cocci_id@p ;
...
position p;
@@
 struct owl_sps_domain_info {  const char * name ;  int pwr_bit ;  int ack_bit ;  unsigned int genpd_flags ; } cocci_id@p ;
