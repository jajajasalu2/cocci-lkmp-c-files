...
symbol cocci_id;
position p;
typedef u32,u16,phy_interface_t,spinlock_t;
@@
 struct emac_board_info {  struct clk * clk ;  struct device * dev ;  struct platform_device * pdev ;  spinlock_t lock ;  void __iomem * membase ;  u32 msg_enable ;  struct net_device * ndev ;  struct sk_buff * skb_last ;  u16 tx_fifo_stat ;  int emacrx_completed_flag ;  struct device_node * phy_node ;  unsigned int link ;  unsigned int speed ;  unsigned int duplex ;  phy_interface_t phy_interface ; } cocci_id@p ;
...
position p;
@@
 struct emac_board_info * cocci_id@p ;
