...
typedef u32;
@@
 struct mlxsw_sp2_acl_tcam {  struct mlxsw_sp_acl_atcam atcam ;  u32 kvdl_index ;  unsigned int kvdl_count ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_acl_tcam_region {  struct mlxsw_sp_acl_atcam_region aregion ;  struct mlxsw_sp_acl_tcam_region * region ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PGCR_LEN ] ;
...
position p;
@@
 struct mlxsw_sp2_acl_tcam_entry {  struct mlxsw_sp_acl_atcam_entry aentry ;  struct mlxsw_afa_block * act_block ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_acl_tcam cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_acl_tcam_region * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_acl_ctcam_region * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_acl_tcam_chunk cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_acl_tcam_entry cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp2_acl_tcam_chunk {  struct mlxsw_sp_acl_atcam_chunk achunk ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PEFA_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_acl_ctcam_entry * cocci_id@p ;
