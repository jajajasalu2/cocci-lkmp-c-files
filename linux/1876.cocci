...
position p;
@@
 struct iproc_adc_priv {  struct regmap * regmap ;  struct clk * adc_clk ;  struct mutex mutex ;  int irqno ;  int chan_val ;  int chan_id ;  struct completion completion ; } cocci_id@p ;
...
position p;
@@
 struct iproc_adc_priv * cocci_id@p ;
