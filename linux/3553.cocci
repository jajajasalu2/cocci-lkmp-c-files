...
position p;
@@
 void cocci_id@p ( struct sdhci_host * ) ;
...
position p;
@@
 struct mmc_request * cocci_id@p [ SDHCI_MAX_MRQS ] ;
...
position p;
@@
 struct sdhci_adma2_64_desc * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct sdhci_host * host , bool enable ) ;
