...
position p;
@@
 struct xt_socket_mtinfo1 * cocci_id@p ;
...
position p;
@@
 const struct xt_socket_mtinfo3 * cocci_id@p ;
...
position p;
@@
 struct xt_socket_mtinfo3 * cocci_id@p ;
...
position p;
@@
 const struct xt_socket_mtinfo2 * cocci_id@p ;
...
position p;
@@
 const struct xt_socket_mtinfo1 * cocci_id@p ;
...
position p;
@@
 struct xt_socket_mtinfo2 * cocci_id@p ;
