...
@@
 struct garmin_data {  __u8 state ;  __u16 flags ;  __u8 mode ;  __u8 count ;  __u8 pkt_id ;  __u32 serial_num ;  struct timer_list timer ;  struct usb_serial_port * port ;  int seq_counter ;  int insize ;  int outsize ;  __u8 inbuffer [ GPS_IN_BUFSIZ ] ;  __u8 outbuffer [ GPS_OUT_BUFSIZ ] ;  __u8 privpkt [ 4 * 6 ] ;  spinlock_t lock ;  struct list_head pktlist ;  struct usb_anchor write_urbs ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * port , const unsigned char * buf , int count , int dismiss_ack ) ;
...
position p;
@@
 int cocci_id@p ( struct garmin_data * garmin_data_p ) ;
...
position p;
@@
 struct garmin_packet cocci_id@p ;
...
typedef __u8;
@@
 struct garmin_packet {  struct list_head list ;  int seq ;  int size ;  __u8 data [ 1 ] ; } cocci_id@p ;
