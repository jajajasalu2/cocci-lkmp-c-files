...
position p;
@@
 struct audit_features * cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ AUDIT_INODE_BUCKETS ] ;
...
position p;
@@
 struct audit_sig_info * cocci_id@p ;
...
typedef u32;
@@
 struct auditd_connection {  struct pid * pid ;  u32 portid ;  struct net * net ;  struct rcu_head rcu ; } * cocci_id@p ;
...
position p;
@@
 struct audit_netlink_list * cocci_id@p ;
...
position p;
@@
 struct audit_net {  struct sock * sk ; } cocci_id@p ;
...
typedef gfp_t;
@@
 struct audit_buffer {  struct sk_buff * skb ;  struct audit_context * ctx ;  gfp_t gfp_mask ; } cocci_id@p ;
...
position p;
@@
 struct audit_tty_status cocci_id@p ;
...
position p;
@@
 struct audit_status cocci_id@p ;
...
position p;
@@
 struct audit_rule_data cocci_id@p ;
...
position p;
@@
 struct audit_ctl_mutex {  struct mutex lock ;  void * owner ; } cocci_id@p ;
...
position p;
@@
 const struct auditd_connection * cocci_id@p ;
...
position p;
@@
 struct auditd_connection cocci_id@p ;
...
typedef __u32;
@@
 struct audit_reply {  __u32 portid ;  struct net * net ;  struct sk_buff * skb ; } cocci_id@p ;
