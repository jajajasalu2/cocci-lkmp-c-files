...
position p;
@@
 enum { LEGACY_VEPA_PRIO = 0 , LEGACY_FDB_PRIO , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( modify_esw_vport_context_in ) ] ;
...
position p;
@@
 int cocci_id@p [ MLX5_ST_SZ_DW ( modify_nic_vport_context_in ) ] ;
...
position p;
@@
 enum mlx5_eswitch_vport_event cocci_id@p ;
...
position p;
@@
 enum { MLX5_ACTION_NONE = 0 , MLX5_ACTION_ADD = 1 , MLX5_ACTION_DEL = 2 , } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct mlx5_eswitch * esw , struct vport_addr * vaddr ) ;
...
position p;
@@
 int cocci_id@p [ MLX5_ST_SZ_DW ( modify_nic_vport_context_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_vport_counter_in ) ] ;
...
typedef u8,bool,u16;
@@
 struct vport_addr {  struct l2addr_node node ;  u8 action ;  u16 vport ;  struct mlx5_flow_handle * flow_rule ;  bool mpfs ;  bool mc_promisc ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5_eswitch * esw ) ;
...
position p;
@@
 struct mlx5_vport_drop_stats * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( scheduling_context ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( modify_esw_vport_context_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_esw_functions_in ) ] ;
