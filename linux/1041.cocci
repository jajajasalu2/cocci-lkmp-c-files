...
@@
 struct pcmciamtd_dev {  struct pcmcia_device * p_dev ;  void __iomem * win_base ;  unsigned int win_size ;  unsigned int offset ;  struct map_info pcmcia_map ;  struct mtd_info * mtd_info ;  int vpp ;  char mtd_name [ sizeof ( struct cistpl_vers_1_t ) ] ; } cocci_id@p ;
...
position p;
@@
 struct pcmciamtd_dev * cocci_id@p ;
