...
position p;
@@
 int cocci_id@p ( struct bq24190_dev_info * bdi , const union power_supply_propval * val ) ;
...
position p;
@@
 int cocci_id@p ( struct bq24190_dev_info * bdi , union power_supply_propval * val ) ;
...
position p;
@@
 struct bq24190_dev_info * cocci_id@p ;
...
position p;
@@
 struct power_supply_battery_info cocci_id@p ;
...
position p;
@@
 struct bq24190_platform_data * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct bq24190_dev_info {  struct i2c_client * client ;  struct device * dev ;  struct extcon_dev * edev ;  struct power_supply * charger ;  struct power_supply * battery ;  struct delayed_work input_current_limit_work ;  char model_name [ I2C_NAME_SIZE ] ;  bool initialized ;  bool irq_event ;  u16 sys_min ;  u16 iprechg ;  u16 iterm ;  struct mutex f_reg_lock ;  u8 f_reg ;  u8 ss_reg ;  u8 watchdog ; } cocci_id@p ;
...
position p;
@@
 struct bq24190_sysfs_field_info cocci_id@p [ ] ;
...
position p;
@@
 struct attribute * cocci_id@p [ ARRAY_SIZE ( bq24190_sysfs_field_tbl ) + 1 ] ;
...
typedef u8;
@@
 struct bq24190_sysfs_field_info {  struct device_attribute attr ;  u8 reg ;  u8 mask ;  u8 shift ; } cocci_id@p ;
