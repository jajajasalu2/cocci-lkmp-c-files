...
typedef bool;
@@
 const struct {  const char * act [ 2 ] ;  void ( * print ) ( struct trace_seq * s , const struct trace_entry * ent , bool has_cg ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct compat_blk_user_trace_setup cocci_id@p ;
...
position p;
@@
 struct blk_io_trace_remap cocci_id@p ;
...
position p;
@@
 const struct trace_entry * cocci_id@p ;
...
position p;
@@
 const struct {  int mask ;  const char * str ; } cocci_id@p [ ] ;
...
position p;
@@
 struct blk_io_trace cocci_id@p ;
...
position p;
@@
 const struct blk_io_trace * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef blk_log_action_t;
@@
 blk_log_action_t * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct trace_iterator * iter , const char * act , bool has_cg ) ;
...
position p;
@@
 struct blk_user_trace_setup * cocci_id@p ;
...
position p;
@@
 const struct blk_io_trace_remap * cocci_id@p ;
...
position p;
@@
 struct rchan_callbacks cocci_id@p ;
