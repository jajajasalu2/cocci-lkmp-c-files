...
position p;
@@
 struct hdcp_srm_header cocci_id@p ;
...
position p;
@@
 struct drm_prop_enum_list cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct hdcp_srm {  u32 revoked_ksv_cnt ;  u8 * revoked_ksv_list ;  struct mutex mutex ; } * cocci_id@p ;
