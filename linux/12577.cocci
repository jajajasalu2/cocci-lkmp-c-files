...
position p;
@@
 struct drm_mode_object * cocci_id@p ;
...
position p;
@@
 struct pixel_ext {  int left [ COMP_MAX ] ;  int right [ COMP_MAX ] ;  int top [ COMP_MAX ] ;  int bottom [ COMP_MAX ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_plane * plane , struct drm_crtc * crtc , struct drm_framebuffer * fb , struct drm_rect * src , struct drm_rect * dest ) ;
...
position p;
@@
 struct mdp5_plane_state * cocci_id@p ;
...
position p;
@@
 struct mdp5_pipeline * cocci_id@p ;
...
position p;
@@
 const struct mdp_format * cocci_id@p ;
...
position p;
@@
 struct mdp5_hw_pipe * cocci_id@p ;
...
typedef u32;
@@
 struct phase_step {  u32 x [ COMP_MAX ] ;  u32 y [ COMP_MAX ] ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct mdp5_plane {  struct drm_plane base ;  uint32_t nformats ;  uint32_t formats [ 32 ] ; } cocci_id@p ;
