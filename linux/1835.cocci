...
typedef atomic_t;
@@
 struct dfsdm_priv {  struct platform_device * pdev ;  struct stm32_dfsdm dfsdm ;  unsigned int spi_clk_out_div ;  atomic_t n_active_ch ;  struct clk * clk ;  struct clk * aclk ; } cocci_id@p ;
...
position p;
@@
 struct stm32_dfsdm_dev_data {  unsigned int num_filters ;  unsigned int num_channels ;  const struct regmap_config * regmap_cfg ; } cocci_id@p ;
