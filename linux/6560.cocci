...
position p;
@@
 struct fip_wwn_desc cocci_id@p ;
...
position p;
@@
 struct fip_fab_desc * cocci_id@p ;
...
position p;
@@
 struct fip_fc4_feat * cocci_id@p ;
...
position p;
@@
 struct fip_fka_desc * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct fc_lport * , enum fc_disc_event ) ;
...
position p;
@@
 struct fip_pri_desc * cocci_id@p ;
...
position p;
@@
 const struct fcoe_fcf * cocci_id@p ;
...
position p;
@@
 enum fip_vlan_subcode cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fcoe_ctlr * , struct sk_buff * ) ;
...
position p;
@@
 void cocci_id@p ( struct fcoe_ctlr * ) ;
...
typedef u8,u32;
@@
 int cocci_id@p ( struct fcoe_ctlr * , u32 , u8 * ) ;
...
position p;
@@
 struct fip_size_desc * cocci_id@p ;
...
position p;
@@
 struct fip_vlan_notify_frame * cocci_id@p ;
...
position p;
@@
 enum fip_vn2vn_subcode cocci_id@p ;
...
position p;
@@
 struct fip_mac_desc * cocci_id@p ;
...
position p;
@@
 struct fip_vn2vn_probe_frame * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fcoe_ctlr * ) ;
...
position p;
@@
 const struct libfc_function_template * cocci_id@p ;
