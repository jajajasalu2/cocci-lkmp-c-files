...
position p;
@@
 void * cocci_id@p ( struct packet_sock * po , struct packet_ring_buffer * rb , int status ) ;
...
position p;
@@
 int cocci_id@p ( struct sock * sk , union tpacket_req_u * req_u , int closing , int tx_ring ) ;
...
position p;
@@
 struct packet_mreq_max {  int mr_ifindex ;  unsigned short mr_type ;  unsigned short mr_alen ;  unsigned char mr_address [ MAX_ADDR_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct virtio_net_hdr cocci_id@p ;
...
position p;
@@
 union tpacket_req_u * cocci_id@p ;
...
position p;
@@
 struct tpacket_stats_v3 cocci_id@p ;
...
position p;
@@
 struct packet_skb_cb {  union {  struct sockaddr_pkt pkt ;  union {  unsigned int origlen ;  struct sockaddr_ll ll ; } ; } sa ; } cocci_id@p ;
...
position p;
@@
 struct tpacket_hdr_v1 * cocci_id@p ;
...
position p;
@@
 struct tpacket_auxdata cocci_id@p ;
...
position p;
@@
 struct sockaddr_pkt * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tpacket_block_desc * ) ;
...
position p;
@@
 union tpacket_stats_u cocci_id@p ;
...
position p;
@@
 void * cocci_id@p ( struct tpacket_kbdq_core * , struct packet_sock * ) ;
...
position p;
@@
 struct tpacket_stats cocci_id@p ;
...
position p;
@@
 struct tpacket2_hdr cocci_id@p ;
...
position p;
@@
 struct tpacket_block_desc cocci_id@p ;
...
position p;
@@
 struct tpacket_rollover_stats cocci_id@p ;
...
position p;
@@
 const struct packet_ring_buffer * cocci_id@p ;
...
position p;
@@
 struct tpacket3_hdr cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sock * sk , struct packet_sock * po ) ;
...
position p;
@@
 struct packet_rollover * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( uaddr -> sa_data ) + 1 ] ;
...
position p;
@@
 struct tpacket_req3 * cocci_id@p ;
...
position p;
@@
 struct tpacket_kbdq_core * cocci_id@p ;
...
position p;
@@
 struct sockcm_cookie cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tpacket_kbdq_core * ) ;
...
position p;
@@
 void cocci_id@p ( struct tpacket_kbdq_core * , struct packet_sock * , unsigned int status ) ;
...
position p;
@@
 int cocci_id@p ( struct tpacket_kbdq_core * ) ;
...
position p;
@@
 int cocci_id@p ( struct sk_buff * skb , struct net_device * dev , struct packet_type * pt , struct net_device * orig_dev ) ;
...
position p;
@@
 union tpacket_uhdr {  struct tpacket_hdr * h1 ;  struct tpacket2_hdr * h2 ;  struct tpacket3_hdr * h3 ;  void * raw ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tpacket_kbdq_core * , struct tpacket3_hdr * ) ;
...
position p;
@@
 struct packet_mreq_max * cocci_id@p ;
...
position p;
@@
 struct packet_fanout * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct packet_ring_buffer * buff ) ;
...
position p;
@@
 struct packet_skb_cb * cocci_id@p ;
...
position p;
@@
 const struct packet_sock * cocci_id@p ;
...
position p;
@@
 const struct sockcm_cookie * cocci_id@p ;
...
position p;
@@
 struct packet_mclist * * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tpacket_kbdq_core * , struct tpacket_block_desc * ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct sk_buff * skb ) ;
...
position p;
@@
 struct packet_ring_buffer * cocci_id@p ;
