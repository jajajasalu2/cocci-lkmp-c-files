...
position p;
@@
 unsigned short cocci_id@p [ NR_CONS_STACK ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ ASN1_OP__NR ] ;
...
position p;
@@
 unsigned char cocci_id@p [ NR_JUMP_STACK ] ;
...
symbol cocci_id;
position p;
typedef asn1_action_t;
@@
 const asn1_action_t * cocci_id@p ;
...
position p;
@@
 const struct asn1_decoder * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ NR_CONS_STACK ] ;
