...
position p;
@@
 enum counter_count_direction cocci_id@p ;
...
position p;
@@
 struct counter_signal_enum_ext cocci_id@p ;
...
position p;
@@
 const struct counter_ops cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ max_num_isa_dev ( QUAD8_EXTENT ) ] ;
...
position p;
@@
 struct counter_count_enum_ext cocci_id@p ;
...
position p;
@@
 enum quad8_count_function { QUAD8_COUNT_FUNCTION_PULSE_DIRECTION = 0 , QUAD8_COUNT_FUNCTION_QUADRATURE_X1 , QUAD8_COUNT_FUNCTION_QUADRATURE_X2 , QUAD8_COUNT_FUNCTION_QUADRATURE_X4 , } cocci_id@p ;
...
position p;
@@
 const struct quad8_iio * const cocci_id@p ;
...
position p;
@@
 struct counter_synapse cocci_id@p [ ] [ 3 ] ;
...
position p;
@@
 struct quad8_iio * const cocci_id@p ;
...
position p;
@@
 enum quad8_synapse_action { QUAD8_SYNAPSE_ACTION_NONE = 0 , QUAD8_SYNAPSE_ACTION_RISING_EDGE , QUAD8_SYNAPSE_ACTION_FALLING_EDGE , QUAD8_SYNAPSE_ACTION_BOTH_EDGES , } cocci_id@p ;
