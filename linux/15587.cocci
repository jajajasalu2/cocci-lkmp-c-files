...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * netdev ) ;
...
position p;
@@
 struct rtllib_hdr_1addr * cocci_id@p ;
...
position p;
@@
 struct rtllib_rx_stats cocci_id@p ;
...
position p;
@@
 enum rt_rf_power_state cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct r8192_priv * priv ) ;
...
position p;
@@
 struct rtllib_network * cocci_id@p ;
...
position p;
@@
 RT_RF_CHANGE_SOURCE cocci_id@p ;
...
position p;
@@
 short cocci_id@p ( struct net_device * dev ) ;
...
position p;
@@
 const struct rtllib_qos_parameters cocci_id@p ;
...
position p;
@@
 const struct rtl819x_ops cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct net_device * dev , bool is_silent_reset ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct net_device * dev , bool shutdownrf ) ;
...
position p;
@@
 struct log_int_8190 cocci_id@p ;
...
position p;
@@
 struct rtllib_assoc_response_frame * cocci_id@p ;
...
position p;
@@
 struct rtllib_device * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sk_buff * skb , struct net_device * dev , int rate ) ;
...
position p;
@@
 short cocci_id@p ( struct net_device * dev , struct sk_buff * skb ) ;
...
position p;
@@
 struct rtllib_qos_parameters cocci_id@p ;
...
position p;
@@
 struct rtllib_beacon * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , struct sk_buff * skb ) ;
...
position p;
@@
 struct tx_fwinfo_8190pci cocci_id@p ;
...
position p;
@@
 struct rt_pwr_save_ctrl * cocci_id@p ;
...
position p;
@@
 struct sw_cam_table cocci_id@p ;
