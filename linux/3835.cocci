...
typedef u8;
@@
 u8 cocci_id@p [ AES_BLOCK_SIZE * ( MAX_ECB_FETCH_BLOCKS - 1 ) + PADLOCK_ALIGNMENT - 1 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ AES_BLOCK_SIZE * ( MAX_CBC_FETCH_BLOCKS - 1 ) + PADLOCK_ALIGNMENT - 1 ] ;
