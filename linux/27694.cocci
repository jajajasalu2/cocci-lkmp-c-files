...
position p;
@@
 struct pts_fs_info {  struct ida allocated_ptys ;  struct pts_mount_opts mount_opts ;  struct super_block * sb ;  struct dentry * ptmx_dentry ; } cocci_id@p ;
...
@@
 struct pts_mount_opts {  int setuid ;  int setgid ;  kuid_t uid ;  kgid_t gid ;  umode_t mode ;  umode_t ptmxmode ;  int reserve ;  int max ; } cocci_id@p ;
...
position p;
@@
 struct pts_mount_opts * cocci_id@p ;
...
position p;
@@
 enum { Opt_uid , Opt_gid , Opt_mode , Opt_ptmxmode , Opt_newinstance , Opt_max , Opt_err , } cocci_id@p ;
