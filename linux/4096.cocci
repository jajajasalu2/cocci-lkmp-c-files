...
position p;
@@
 struct rockchip_pcie_phy cocci_id@p ;
...
position p;
@@
 struct rockchip_pcie_data {  unsigned int pcie_conf ;  unsigned int pcie_status ;  unsigned int pcie_laneoff ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_pcie_data * cocci_id@p ;
...
position p;
@@
 struct phy_pcie_instance * cocci_id@p ;
...
typedef u32;
@@
 struct rockchip_pcie_phy {  struct rockchip_pcie_data * phy_data ;  struct regmap * reg_base ;  struct phy_pcie_instance {  struct phy * phy ;  u32 index ; } phys [ PHY_MAX_LANE_NUM ] ;  struct mutex pcie_mutex ;  struct reset_control * phy_rst ;  struct clk * clk_pciephy_ref ;  int pwr_cnt ;  int init_cnt ; } cocci_id@p ;
...
position p;
@@
 const struct rockchip_pcie_data cocci_id@p ;
