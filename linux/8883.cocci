...
position p;
@@
 struct pch_gbe_stats {  char string [ ETH_GSTRING_LEN ] ;  size_t size ;  size_t offset ; } cocci_id@p ;
...
position p;
@@
 struct pch_gbe_regs cocci_id@p ;
...
position p;
@@
 const struct pch_gbe_stats * cocci_id@p ;
