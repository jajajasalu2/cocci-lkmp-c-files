...
position p;
@@
 struct phy_shim_info {  struct brcms_hardware * wlc_hw ;  struct brcms_c_info * wlc ;  struct brcms_info * wl ; } cocci_id@p ;
...
position p;
@@
 struct phy_shim_info cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct brcms_phy * pi ) ;
