...
position p;
@@
 struct fan53555_device_info * cocci_id@p ;
...
position p;
@@
 enum { FAN53555_CHIP_REV_00 = 0x3 , FAN53555_CHIP_REV_13 = 0xf , } cocci_id@p ;
...
position p;
@@
 enum { FAN53526_CHIP_ID_01 = 1 , } cocci_id@p ;
...
position p;
@@
 enum { SILERGY_SYR82X = 8 , SILERGY_SYR83X = 9 , } cocci_id@p ;
...
position p;
@@
 enum fan53555_vendor { FAN53526_VENDOR_FAIRCHILD = 0 , FAN53555_VENDOR_FAIRCHILD , FAN53555_VENDOR_SILERGY , } cocci_id@p ;
...
position p;
@@
 enum { FAN53555_CHIP_ID_00 = 0 , FAN53555_CHIP_ID_01 , FAN53555_CHIP_ID_02 , FAN53555_CHIP_ID_03 , FAN53555_CHIP_ID_04 , FAN53555_CHIP_ID_05 , FAN53555_CHIP_ID_08 = 8 , } cocci_id@p ;
...
position p;
@@
 struct fan53555_device_info {  enum fan53555_vendor vendor ;  struct device * dev ;  struct regulator_desc desc ;  struct regulator_init_data * regulator ;  int chip_id ;  int chip_rev ;  unsigned int vol_reg ;  unsigned int sleep_reg ;  unsigned int vsel_min ;  unsigned int vsel_step ;  unsigned int vsel_count ;  unsigned int mode_reg ;  unsigned int mode_mask ;  unsigned int sleep_vol_cache ; } cocci_id@p ;
...
position p;
@@
 struct fan53555_platform_data * cocci_id@p ;
...
position p;
@@
 enum { FAN53526_CHIP_REV_08 = 8 , } cocci_id@p ;
