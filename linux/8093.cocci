...
position p;
@@
 enum thunderbolt_ip_frame_pdf { TBIP_PDF_FRAME_START = 1 , TBIP_PDF_FRAME_END , } cocci_id@p ;
...
position p;
@@
 struct thunderbolt_ip_header * cocci_id@p ;
...
position p;
@@
 const struct tb_xdomain * cocci_id@p ;
...
position p;
@@
 struct thunderbolt_ip_frame_header cocci_id@p ;
...
position p;
@@
 struct tb_property_dir * cocci_id@p ;
...
position p;
@@
 const struct tb_service_id cocci_id@p [ ] ;
...
position p;
@@
 enum thunderbolt_ip_type { TBIP_LOGIN , TBIP_LOGIN_RESPONSE , TBIP_LOGOUT , TBIP_STATUS , } cocci_id@p ;
...
position p;
@@
 struct thunderbolt_ip_login_response cocci_id@p ;
...
typedef u32;
@@
 struct thunderbolt_ip_login {  struct thunderbolt_ip_header hdr ;  u32 proto_version ;  u32 transmit_path ;  u32 reserved [ 4 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct thunderbolt_ip_status {  struct thunderbolt_ip_header hdr ;  u32 status ; } cocci_id@p ;
...
typedef u64;
@@
 struct tbnet_stats {  u64 tx_packets ;  u64 rx_packets ;  u64 tx_bytes ;  u64 rx_bytes ;  u64 rx_errors ;  u64 tx_errors ;  u64 rx_length_errors ;  u64 rx_over_errors ;  u64 rx_crc_errors ;  u64 rx_missed_errors ; } cocci_id@p ;
...
position p;
@@
 struct tb_service_driver cocci_id@p ;
...
position p;
@@
 enum thunderbolt_ip_type cocci_id@p ;
...
position p;
@@
 struct tbnet_frame {  struct net_device * dev ;  struct page * page ;  struct ring_frame frame ; } cocci_id@p ;
...
position p;
@@
 struct tbnet_frame * cocci_id@p [ MAX_SKB_FRAGS ] ;
...
position p;
@@
 const struct thunderbolt_ip_frame_header * cocci_id@p ;
...
position p;
@@
 struct thunderbolt_ip_logout cocci_id@p ;
...
typedef u32;
@@
 struct thunderbolt_ip_login_response {  struct thunderbolt_ip_header hdr ;  u32 status ;  u32 receiver_mac [ 2 ] ;  u32 receiver_mac_len ;  u32 reserved [ 4 ] ; } cocci_id@p ;
...
typedef u32,uuid_t;
@@
 struct thunderbolt_ip_header {  u32 route_hi ;  u32 route_lo ;  u32 length_sn ;  uuid_t uuid ;  uuid_t initiator_uuid ;  uuid_t target_uuid ;  u32 type ;  u32 command_id ; } cocci_id@p ;
...
position p;
@@
 struct thunderbolt_ip_status cocci_id@p ;
...
position p;
@@
 const struct thunderbolt_ip_login * cocci_id@p ;
...
position p;
@@
 const struct tbnet_frame * cocci_id@p ;
...
position p;
@@
 struct thunderbolt_ip_login cocci_id@p ;
...
position p;
@@
 struct thunderbolt_ip_logout {  struct thunderbolt_ip_header hdr ; } cocci_id@p ;
...
position p;
@@
 const struct tbnet_ring * cocci_id@p ;
...
position p;
@@
 struct tbnet_ring {  struct tbnet_frame frames [ TBNET_RING_SIZE ] ;  unsigned int cons ;  unsigned int prod ;  struct tb_ring * ring ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct thunderbolt_ip_frame_header {  u32 frame_size ;  u16 frame_index ;  u16 frame_id ;  u32 frame_count ; } cocci_id@p ;
