...
position p;
@@
 struct ab8500_gpadc_cfg {  const struct abx500_res_to_temp * temp_tbl ;  int tbl_sz ;  int vcc ;  int r_up ; } cocci_id@p ;
...
position p;
@@
 struct ab8500_temp {  struct iio_channel * aux1 ;  struct iio_channel * aux2 ;  struct ab8500_btemp * btemp ;  struct delayed_work power_off_work ;  struct ab8500_gpadc_cfg cfg ;  struct abx500_temp * abx500_data ; } cocci_id@p ;
...
position p;
@@
 struct ab8500_gpadc_cfg * cocci_id@p ;
