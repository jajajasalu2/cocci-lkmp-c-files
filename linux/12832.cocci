...
position p;
@@
 struct gpmc_device_timings cocci_id@p ;
...
position p;
@@
 struct gpmc_timings * cocci_id@p ;
...
position p;
@@
 struct gpmc_bool_timings * cocci_id@p ;
...
position p;
@@
 enum gpmc_clk_domain cocci_id@p ;
...
position p;
@@
 struct gpmc_settings cocci_id@p ;
...
position p;
@@
 struct gpmc_nand_regs * cocci_id@p ;
...
position p;
@@
 struct gpmc_nand_ops cocci_id@p ;
...
position p;
@@
 struct gpmc_onenand_info * cocci_id@p ;
...
typedef u32;
@@
 struct gpmc_cs_config {  u32 config1 ;  u32 config2 ;  u32 config3 ;  u32 config4 ;  u32 config5 ;  u32 config6 ;  u32 config7 ;  int is_valid ; } cocci_id@p ;
...
position p;
@@
 const struct gpmc_settings * cocci_id@p ;
...
position p;
@@
 struct gpmc_cs_data * cocci_id@p ;
...
typedef u32;
@@
 struct omap3_gpmc_regs {  u32 sysconfig ;  u32 irqenable ;  u32 timeout_ctrl ;  u32 config ;  u32 prefetch_config1 ;  u32 prefetch_config2 ;  u32 prefetch_control ;  struct gpmc_cs_config cs_context [ GPMC_CS_NUM ] ; } cocci_id@p ;
...
position p;
@@
 enum gpmc_clk_domain { GPMC_CD_FCLK , GPMC_CD_CLK , } cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * dev ) ;
...
position p;
@@
 struct omap3_gpmc_regs cocci_id@p ;
...
position p;
@@
 const struct gpmc_timings * cocci_id@p ;
...
position p;
@@
 struct gpmc_device {  struct device * dev ;  int irq ;  struct irq_chip irq_chip ;  struct gpio_chip gpio_chip ;  int nirqs ; } cocci_id@p ;
...
position p;
@@
 struct gpmc_cs_data cocci_id@p [ GPMC_CS_NUM ] ;
...
position p;
@@
 const struct gpmc_bool_timings * cocci_id@p ;
...
position p;
@@
 const enum gpmc_clk_domain cocci_id@p ;
