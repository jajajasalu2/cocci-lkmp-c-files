...
position p;
@@
 int cocci_id@p ( struct s3c24xx_i2c * i2c , unsigned long iicstat ) ;
...
position p;
@@
 enum s3c24xx_i2c_state { STATE_IDLE , STATE_START , STATE_READ , STATE_WRITE , STATE_STOP , } cocci_id@p ;
