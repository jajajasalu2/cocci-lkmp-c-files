...
position p;
@@
 struct timing {  int hactive ;  int hdelay ;  int vactive ;  int vdelay ;  int hscale ;  int vscale ; } cocci_id@p ;
...
position p;
@@
 struct bt819 {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  unsigned char reg [ 32 ] ;  v4l2_std_id norm ;  int input ;  int enable ; } cocci_id@p ;
