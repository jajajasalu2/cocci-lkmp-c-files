...
position p;
@@
 struct ocfs2_disk_dqtrailer * cocci_id@p ;
...
position p;
@@
 struct ocfs2_orphan_scan cocci_id@p ;
...
position p;
@@
 struct ocfs2_triggers {  struct jbd2_buffer_trigger_type ot_triggers ;  int ot_offset ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_la_recovery_item cocci_id@p ;
...
position p;
@@
 enum ocfs2_orphan_reco_type cocci_id@p ;
...
position p;
@@
 struct ocfs2_replay_map cocci_id@p ;
...
position p;
@@
 struct ocfs2_dir_block_trailer * cocci_id@p ;
...
position p;
@@
 struct ocfs2_quota_recovery * cocci_id@p ;
...
position p;
@@
 struct ocfs2_la_recovery_item {  struct list_head lri_list ;  int lri_slot ;  struct ocfs2_dinode * lri_la_dinode ;  struct ocfs2_dinode * lri_tl_dinode ;  struct ocfs2_quota_recovery * lri_qrec ;  enum ocfs2_orphan_reco_type lri_orphan_reco_type ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_recovery_map * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ocfs2_journal * journal , int slot_num , struct ocfs2_dinode * la_dinode , struct ocfs2_dinode * tl_dinode , struct ocfs2_quota_recovery * qrec , enum ocfs2_orphan_reco_type orphan_reco_type ) ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , int node_num , int slot_num ) ;
...
position p;
@@
 struct ocfs2_orphan_filldir_priv cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , int quota ) ;
...
position p;
@@
 struct ocfs2_dx_leaf cocci_id@p ;
...
position p;
@@
 enum ocfs2_replay_state { REPLAY_UNNEEDED = 0 , REPLAY_NEEDED , REPLAY_DONE , } cocci_id@p ;
...
position p;
@@
 struct jbd2_buffer_trigger_type * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , int dirty , int replayed ) ;
...
position p;
@@
 struct ocfs2_triggers cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb ) ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , int slot , enum ocfs2_orphan_reco_type orphan_reco_type ) ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , int slot_num ) ;
...
position p;
@@
 struct ocfs2_replay_map {  unsigned int rm_slots ;  enum ocfs2_replay_state rm_state ;  unsigned char rm_replay_slots [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_orphan_filldir_priv {  struct dir_context ctx ;  struct inode * head ;  struct ocfs2_super * osb ;  enum ocfs2_orphan_reco_type orphan_reco_type ; } cocci_id@p ;
