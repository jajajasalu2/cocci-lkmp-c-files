...
position p;
@@
 struct snd_sgio2audio_chan * cocci_id@p ;
...
@@
 struct snd_sgio2audio {  struct snd_card * card ;  struct snd_ad1843 ad1843 ;  spinlock_t ad1843_lock ;  struct snd_sgio2audio_chan channel [ 3 ] ;  void * ring_base ;  dma_addr_t ring_base_dma ; } cocci_id@p ;
...
position p;
@@
 struct snd_sgio2audio * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_pcm_uframes_t,spinlock_t;
@@
 struct snd_sgio2audio_chan {  int idx ;  struct snd_pcm_substream * substream ;  int pos ;  snd_pcm_uframes_t size ;  spinlock_t lock ; } cocci_id@p ;
...
typedef irqreturn_t;
@@
 struct {  int idx ;  int irq ;  irqreturn_t ( * isr ) ( int , void * ) ;  const char * desc ; } cocci_id@p [ ] ;
