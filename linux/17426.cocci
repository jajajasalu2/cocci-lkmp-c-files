...
position p;
@@
 struct mpc52xx_suspend cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void __iomem * sram , void __iomem * sdram_regs , struct mpc52xx_cdm __iomem * , struct mpc52xx_intr __iomem * ) ;
