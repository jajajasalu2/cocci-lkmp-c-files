...
symbol cocci_id;
position p;
typedef dlm_astlockfunc_t;
@@
 dlm_astlockfunc_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dlm_lock * lock ) ;
...
position p;
@@
 enum dlm_status cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , struct dlm_lock * lock , int flags ) ;
...
symbol cocci_id;
position p;
typedef dlm_bastlockfunc_t;
@@
 dlm_bastlockfunc_t * cocci_id@p ;
...
typedef u8,u64;
@@
 void cocci_id@p ( struct dlm_lock * newlock , int type , u8 node , u64 cookie ) ;
