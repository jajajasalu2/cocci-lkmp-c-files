...
position p;
@@
 struct nlmclnt_initdata cocci_id@p ;
...
position p;
@@
 const struct rpc_version * cocci_id@p [ 5 ] ;
...
position p;
@@
 const struct nfs_client_initdata * cocci_id@p ;
...
position p;
@@
 const struct nfs_parsed_mount_data * cocci_id@p ;
...
position p;
@@
 struct nfs_client_initdata cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * p , void * v ) ;
