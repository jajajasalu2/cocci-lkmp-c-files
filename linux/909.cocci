...
position p;
@@
 struct ndfc_controller {  struct platform_device * ofdev ;  void __iomem * ndfcbase ;  struct nand_chip chip ;  int chip_select ;  struct nand_controller ndfc_control ; } cocci_id@p ;
...
position p;
@@
 struct ndfc_controller * cocci_id@p ;
...
position p;
@@
 struct ndfc_controller cocci_id@p [ NDFC_MAX_CS ] ;
