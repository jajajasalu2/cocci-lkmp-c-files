...
@@
 struct nspire_keypad {  void __iomem * reg_base ;  u32 int_mask ;  struct input_dev * input ;  struct clk * clk ;  struct matrix_keymap_data * keymap ;  int row_shift ;  u32 scan_interval ;  u32 row_delay ;  u16 state [ KEYPAD_BITMASK_ROWS ] ;  bool active_low ; } cocci_id@p ;
...
position p;
@@
 struct nspire_keypad cocci_id@p ;
