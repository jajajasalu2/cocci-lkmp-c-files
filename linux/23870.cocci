...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_DSMARK_MAX + 1 ] ;
...
position p;
@@
 struct dsmark_qdisc_data * cocci_id@p ;
...
typedef u8;
@@
 struct mask_value {  u8 mask ;  u8 value ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_DSMARK_MAX + 1 ] ;
