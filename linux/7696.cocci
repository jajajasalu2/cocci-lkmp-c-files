...
typedef bool;
@@
 struct msm_port {  struct uart_port uart ;  char name [ 16 ] ;  struct clk * clk ;  struct clk * pclk ;  unsigned int imr ;  int is_uartdm ;  unsigned int old_snap_state ;  bool break_detected ;  struct msm_dma tx_dma ;  struct msm_dma rx_dma ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct msm_baud_map {  u16 divisor ;  u8 code ;  u8 rxstale ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct msm_port * msm_port ) ;
...
symbol cocci_id;
position p;
typedef u32,dma_cookie_t,dma_addr_t;
@@
 struct msm_dma {  struct dma_chan * chan ;  enum dma_data_direction dir ;  dma_addr_t phys ;  unsigned char * virt ;  dma_cookie_t cookie ;  u32 enable_bit ;  unsigned int count ;  struct dma_async_tx_descriptor * desc ; } cocci_id@p ;
...
position p;
@@
 enum { UARTDM_1P1 = 1 , UARTDM_1P2 , UARTDM_1P3 , UARTDM_1P4 , } cocci_id@p ;
...
position p;
@@
 const struct msm_baud_map * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct uart_port * port ) ;
