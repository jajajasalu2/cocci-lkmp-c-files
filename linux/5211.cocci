...
position p;
@@
 struct rm_feature_desc * cocci_id@p ;
...
typedef bool;
@@
 struct zpodd {  enum odd_mech_type mech_type ;  struct ata_device * dev ;  bool from_notify ;  bool zp_ready ;  unsigned long last_ready ;  bool zp_sampled ;  bool powered_off ; } cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ ATAPI_CDB_LEN ] ;
...
position p;
@@
 enum odd_mech_type { ODD_MECH_TYPE_SLOT , ODD_MECH_TYPE_DRAWER , ODD_MECH_TYPE_UNSUPPORTED , } cocci_id@p ;
