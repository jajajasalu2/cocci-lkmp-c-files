...
position p;
@@
 void ( * cocci_id@p ) ( struct s3c_adc_client * client , unsigned int selected ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct s3c_adc_client * client , unsigned d0 , unsigned d1 , unsigned * samples_left ) ;
...
position p;
@@
 enum s3c_cpu_type { TYPE_ADCV1 , TYPE_ADCV11 , TYPE_ADCV12 , TYPE_ADCV2 , TYPE_ADCV3 , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct adc_device {  struct platform_device * pdev ;  struct platform_device * owner ;  struct clk * clk ;  struct s3c_adc_client * cur ;  struct s3c_adc_client * ts_pend ;  void __iomem * regs ;  spinlock_t lock ;  unsigned int prescale ;  int irq ;  struct regulator * vdd ; } cocci_id@p ;
