...
position p;
@@
 struct uasm_label cocci_id@p [ 32 ] ;
...
position p;
@@
 struct mips_static_suspend_state cocci_id@p ;
...
position p;
@@
 enum mips_reg { zero , at , v0 , v1 , a0 , a1 , a2 , a3 , t0 , t1 , t2 , t3 , t4 , t5 , t6 , t7 , s0 , s1 , s2 , s3 , s4 , s5 , s6 , s7 , t8 , t9 , k0 , k1 , gp , sp , fp , ra , } cocci_id@p ;
...
position p;
@@
 cps_nc_entry_fn cocci_id@p [ CPS_PM_STATE_COUNT ] ;
...
position p;
@@
 enum { lbl_incready = 1 , lbl_poll_cont , lbl_secondary_hang , lbl_disable_coherence , lbl_flush_fsb , lbl_invicache , lbl_flushdcache , lbl_hang , lbl_set_cont , lbl_secondary_cont , lbl_decready , } cocci_id@p ;
...
position p;
@@
 struct uasm_reloc cocci_id@p [ 32 ] ;
...
position p;
@@
 const struct cpuinfo_mips * cocci_id@p ;
...
position p;
@@
 struct core_boot_config * cocci_id@p ;
...
position p;
@@
 const struct cache_desc * cocci_id@p ;
...
position p;
@@
 struct vpe_boot_config * cocci_id@p ;
...
typedef u32;
@@
 unsigned ( * cocci_id@p ) ( unsigned online , u32 * nc_ready_count ) ;
