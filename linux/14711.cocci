...
position p;
@@
 const struct clk_slow_bits cocci_id@p ;
...
position p;
@@
 struct clk_slow_osc {  struct clk_hw hw ;  void __iomem * sckcr ;  const struct clk_slow_bits * bits ;  unsigned long startup_usec ; } cocci_id@p ;
...
position p;
@@
 struct clk_sam9x5_slow * cocci_id@p ;
...
position p;
@@
 struct clk_slow_rc_osc * cocci_id@p ;
...
position p;
@@
 struct clk_sama5d4_slow_osc * cocci_id@p ;
...
position p;
@@
 struct clk_slow_osc cocci_id@p ;
...
typedef bool;
@@
 struct clk_sama5d4_slow_osc {  struct clk_hw hw ;  void __iomem * sckcr ;  const struct clk_slow_bits * bits ;  unsigned long startup_usec ;  bool prepared ; } cocci_id@p ;
...
position p;
@@
 struct clk_slow_rc_osc {  struct clk_hw hw ;  void __iomem * sckcr ;  const struct clk_slow_bits * bits ;  unsigned long frequency ;  unsigned long accuracy ;  unsigned long startup_usec ; } cocci_id@p ;
...
typedef u8;
@@
 struct clk_sam9x5_slow {  struct clk_hw hw ;  void __iomem * sckcr ;  const struct clk_slow_bits * bits ;  u8 parent ; } cocci_id@p ;
...
typedef u32;
@@
 struct clk_slow_bits {  u32 cr_rcen ;  u32 cr_osc32en ;  u32 cr_osc32byp ;  u32 cr_oscsel ; } cocci_id@p ;
