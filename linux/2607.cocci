...
position p;
@@
 const struct meson_mx_efuse_platform_data * cocci_id@p ;
...
position p;
@@
 struct meson_mx_efuse * cocci_id@p ;
...
position p;
@@
 struct meson_mx_efuse_platform_data {  const char * name ;  unsigned int word_size ; } cocci_id@p ;
...
position p;
@@
 struct meson_mx_efuse {  void __iomem * base ;  struct clk * core_clk ;  struct nvmem_device * nvmem ;  struct nvmem_config config ; } cocci_id@p ;
