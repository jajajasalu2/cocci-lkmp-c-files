...
position p;
@@
 int cocci_id@p ( struct hp_sw_dh_data * ) ;
...
position p;
@@
 struct hp_sw_dh_data {  int path_state ;  int retries ;  int retry_cnt ;  struct scsi_device * sdev ; } cocci_id@p ;
...
position p;
@@
 struct hp_sw_dh_data * cocci_id@p ;
