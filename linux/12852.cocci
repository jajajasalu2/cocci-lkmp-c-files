...
position p;
@@
 int cocci_id@p ( struct notifier_block * nb ) ;
...
position p;
@@
 struct co_cache_error * cocci_id@p ;
...
position p;
@@
 unsigned long long cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct co_cache_error {  struct notifier_block notifier ;  struct edac_device_ctl_info * ed ; } cocci_id@p ;
