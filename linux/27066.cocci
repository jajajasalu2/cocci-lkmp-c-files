...
position p;
@@
 struct xchk_parent_ctx * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,xfs_nlink_t,xfs_ino_t;
@@
 struct xchk_parent_ctx {  struct dir_context dc ;  struct xfs_scrub * sc ;  xfs_ino_t ino ;  xfs_nlink_t nlink ;  bool cancelled ; } cocci_id@p ;
