...
position p;
@@
 const struct intel_spi * cocci_id@p ;
...
typedef u8,bool;
@@
 struct intel_spi {  struct device * dev ;  const struct intel_spi_boardinfo * info ;  struct spi_nor nor ;  void __iomem * base ;  void __iomem * pregs ;  void __iomem * sregs ;  size_t nregions ;  size_t pr_num ;  bool writeable ;  bool locked ;  bool swseq_reg ;  bool swseq_erase ;  bool erase_64k ;  u8 atomic_preopcode ;  u8 opcodes [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 const struct intel_spi_boardinfo * cocci_id@p ;
