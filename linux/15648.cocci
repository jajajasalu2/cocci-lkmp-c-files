...
position p;
@@
 struct gb_i2c_transfer_op * cocci_id@p ;
...
position p;
@@
 struct gb_i2c_device * cocci_id@p ;
...
position p;
@@
 struct gb_i2c_transfer_response * cocci_id@p ;
...
position p;
@@
 struct gb_i2c_transfer_request * cocci_id@p ;
...
position p;
@@
 struct gb_i2c_functionality_response cocci_id@p ;
...
typedef u32;
@@
 struct gb_i2c_device {  struct gb_connection * connection ;  struct gbphy_device * gbphy_dev ;  u32 functionality ;  struct i2c_adapter adapter ; } cocci_id@p ;
