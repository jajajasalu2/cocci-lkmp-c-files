...
position p;
@@
 struct intel_shared_regs * cocci_id@p ;
...
position p;
@@
 const unsigned long cocci_id@p [ 4 ] ;
...
position p;
@@
 struct intel_excl_states * cocci_id@p ;
...
position p;
@@
 struct intel_excl_cntrs * cocci_id@p ;
...
position p;
@@
 struct perf_guest_switch_msr * cocci_id@p ( int * nr ) ;
...
position p;
@@
 const struct x86_cpu_desc cocci_id@p [ ] ;
