...
position p;
@@
 struct nv44_mpeg_chan * cocci_id@p ;
...
position p;
@@
 struct nv44_mpeg {  struct nvkm_engine engine ;  struct list_head chan ; } cocci_id@p ;
...
typedef u32;
@@
 struct nv44_mpeg_chan {  struct nvkm_object object ;  struct nv44_mpeg * mpeg ;  struct nvkm_fifo_chan * fifo ;  struct list_head head ;  u32 inst ; } cocci_id@p ;
