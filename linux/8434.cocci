...
position p;
@@
 struct w840_tx_desc * cocci_id@p ;
...
position p;
@@
 enum rx_mode_bits { AcceptErr = 0x80 , RxAcceptBroadcast = 0x20 , AcceptMulticast = 0x10 , RxAcceptAllPhys = 0x08 , AcceptMyPhys = 0x02 , } cocci_id@p ;
...
position p;
@@
 enum EEPROM_Ctrl_Bits { EE_ShiftClk = 0x02 , EE_Write0 = 0x801 , EE_Write1 = 0x805 , EE_ChipSelect = 0x801 , EE_DataIn = 0x08 , } cocci_id@p ;
...
position p;
@@
 struct pci_id_info {  const char * name ;  int drv_flags ; } cocci_id@p ;
...
position p;
@@
 enum EEPROM_Cmds { EE_WriteCmd = ( 5 << 6 ) , EE_ReadCmd = ( 6 << 6 ) , EE_EraseCmd = ( 7 << 6 ) , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct netdev_private * np ) ;
...
position p;
@@
 enum { netdev_res_size = 128 , } cocci_id@p ;
...
position p;
@@
 enum mii_reg_bits { MDIO_ShiftClk = 0x10000 , MDIO_DataIn = 0x80000 , MDIO_DataOut = 0x20000 , MDIO_EnbOutput = 0x40000 , MDIO_EnbIn = 0x00000 , } cocci_id@p ;
...
position p;
@@
 struct w840_rx_desc * cocci_id@p ;
...
typedef u32,s32;
@@
 struct w840_rx_desc {  s32 status ;  s32 length ;  u32 buffer1 ;  u32 buffer2 ; } cocci_id@p ;
...
position p;
@@
 enum chip_capability_flags { CanHaveMII = 1 , HasBrokenTx = 2 , AlwaysFDX = 4 , FDXOnNoMII = 8 , } cocci_id@p ;
