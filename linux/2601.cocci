...
typedef bool,u32;
@@
 struct sprd_efuse_variant_data {  u32 blk_nums ;  u32 blk_offset ;  bool blk_double ; } cocci_id@p ;
...
position p;
@@
 const struct sprd_efuse_variant_data cocci_id@p ;
...
position p;
@@
 struct sprd_efuse {  struct device * dev ;  struct clk * clk ;  struct hwspinlock * hwlock ;  struct mutex mutex ;  void __iomem * base ;  const struct sprd_efuse_variant_data * data ; } cocci_id@p ;
