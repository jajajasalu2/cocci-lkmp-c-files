...
position p;
@@
 struct qed_iscsi_cb_ops * cocci_id@p ;
...
position p;
@@
 struct iscsi_slow_path_hdr * cocci_id@p ;
...
position p;
@@
 struct qed_iscsi_conn cocci_id@p ;
...
position p;
@@
 struct iscsi_spe_func_dstry * cocci_id@p ;
...
position p;
@@
 struct tstorm_iscsi_stats_drv cocci_id@p ;
...
position p;
@@
 struct qed_iscsi_tid * cocci_id@p ;
...
position p;
@@
 struct mstorm_iscsi_stats_drv cocci_id@p ;
...
position p;
@@
 struct ustorm_iscsi_stats_drv cocci_id@p ;
...
position p;
@@
 struct scsi_terminate_extra_params * cocci_id@p ;
...
position p;
@@
 struct iscsi_spe_func_init * cocci_id@p ;
...
position p;
@@
 struct iscsi_spe_conn_mac_update * cocci_id@p ;
...
position p;
@@
 struct iscsi_init_ramrod_params * cocci_id@p ;
...
position p;
@@
 const struct qed_iscsi_ops cocci_id@p ;
...
position p;
@@
 struct qed_hash_iscsi_con * cocci_id@p ;
...
position p;
@@
 struct ystorm_iscsi_stats_drv cocci_id@p ;
...
position p;
@@
 struct scsi_init_func_queues * cocci_id@p ;
...
position p;
@@
 struct qed_iscsi_pf_params * cocci_id@p ;
...
position p;
@@
 struct qed_iscsi_params_offload * cocci_id@p ;
...
position p;
@@
 struct iscsi_conn_update_ramrod_params * cocci_id@p ;
...
position p;
@@
 struct qed_iscsi_stats * cocci_id@p ;
...
position p;
@@
 struct tcp_offload_params * cocci_id@p ;
...
position p;
@@
 struct qed_iscsi_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef iscsi_event_cb_t;
@@
 iscsi_event_cb_t cocci_id@p ;
...
position p;
@@
 struct qed_hash_iscsi_con {  struct hlist_node node ;  struct qed_iscsi_conn * con ; } cocci_id@p ;
...
position p;
@@
 struct qed_mcp_iscsi_stats * cocci_id@p ;
...
position p;
@@
 struct qed_iscsi_params_update * cocci_id@p ;
...
position p;
@@
 struct iscsi_spe_conn_offload * cocci_id@p ;
...
position p;
@@
 struct iscsi_spe_conn_termination * cocci_id@p ;
...
position p;
@@
 struct iscsi_spe_conn_offload_option2 * cocci_id@p ;
...
position p;
@@
 struct pstorm_iscsi_stats_drv cocci_id@p ;
...
position p;
@@
 struct tcp_upload_params * cocci_id@p ;
...
position p;
@@
 struct xstorm_iscsi_stats_drv cocci_id@p ;
...
position p;
@@
 struct qed_dev_iscsi_info * cocci_id@p ;
