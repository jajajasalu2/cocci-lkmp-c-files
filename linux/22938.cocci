...
position p;
@@
 struct snd_rawmidi_status cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_rawmidi * rawmidi ) ;
...
position p;
@@
 struct snd_rawmidi_file * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_rawmidi * rmidi , struct snd_rawmidi_substream * substream , int cleanup ) ;
