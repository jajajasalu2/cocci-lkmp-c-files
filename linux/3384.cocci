...
typedef bool,u32;
@@
 struct rockchip_pwm_data {  struct rockchip_pwm_regs regs ;  unsigned int prescaler ;  bool supports_polarity ;  bool supports_lock ;  u32 enable_conf ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_pwm_chip * cocci_id@p ;
...
position p;
@@
 struct rockchip_pwm_chip {  struct pwm_chip chip ;  struct clk * clk ;  struct clk * pclk ;  const struct rockchip_pwm_data * data ;  void __iomem * base ; } cocci_id@p ;
...
position p;
@@
 const struct rockchip_pwm_data cocci_id@p ;
...
position p;
@@
 struct rockchip_pwm_regs {  unsigned long duty ;  unsigned long period ;  unsigned long cntr ;  unsigned long ctrl ; } cocci_id@p ;
