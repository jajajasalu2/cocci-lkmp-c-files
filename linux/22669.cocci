...
position p;
@@
 struct snd_i2c_device * * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_i2c_device * cs8427 ) ;
...
position p;
@@
 struct cs8427 {  unsigned char regmap [ 0x14 ] ;  unsigned int rate ;  unsigned int reset_timeout ;  struct cs8427_stream playback ;  struct cs8427_stream capture ; } cocci_id@p ;
...
position p;
@@
 struct cs8427_stream {  struct snd_pcm_substream * substream ;  char hw_status [ 24 ] ;  char def_status [ 24 ] ;  char pcm_status [ 24 ] ;  char hw_udata [ 32 ] ;  struct snd_kcontrol * pcm_ctl ; } cocci_id@p ;
