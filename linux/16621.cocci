...
position p;
@@
 struct smsg_callback {  struct list_head list ;  const char * prefix ;  int len ;  void ( * callback ) ( const char * from , char * str ) ; } cocci_id@p ;
...
position p;
@@
 struct smsg_callback cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( const char * from , char * str ) ;
