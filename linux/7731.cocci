...
position p;
@@
 struct aspeed_vuart {  struct device * dev ;  void __iomem * regs ;  struct clk * clk ;  int line ;  struct timer_list unthrottle_timer ;  struct uart_8250_port * port ; } cocci_id@p ;
...
position p;
@@
 struct aspeed_vuart * cocci_id@p ;
