...
typedef u32;
@@
 struct imx6_pcie_drvdata {  enum imx6_pcie_variants variant ;  u32 flags ;  int dbi_length ; } cocci_id@p ;
...
position p;
@@
 const struct imx6_pcie_drvdata cocci_id@p [ ] ;
...
position p;
@@
 const struct imx6_pcie * cocci_id@p ;
...
position p;
@@
 enum imx6_pcie_variants { IMX6Q , IMX6SX , IMX6QP , IMX7D , IMX8MQ , } cocci_id@p ;
