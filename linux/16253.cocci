...
position p;
@@
 int cocci_id@p ( struct rbsp * rbsp , int n , unsigned int * value ) ;
...
typedef u8;
@@
 struct rbsp {  u8 * data ;  size_t size ;  unsigned int pos ;  unsigned int num_consecutive_zeros ;  struct nal_h264_ops * ops ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct nal_h264_hrd_parameters * cocci_id@p ;
...
position p;
@@
 struct nal_h264_ops {  int ( * rbsp_bit ) ( struct rbsp * rbsp , int * val ) ;  int ( * rbsp_bits ) ( struct rbsp * rbsp , int n , unsigned int * val ) ;  int ( * rbsp_uev ) ( struct rbsp * rbsp , unsigned int * val ) ;  int ( * rbsp_sev ) ( struct rbsp * rbsp , int * val ) ; } cocci_id@p ;
...
position p;
@@
 struct nal_h264_ops * cocci_id@p ;
...
position p;
@@
 struct nal_h264_vui_parameters * cocci_id@p ;
...
position p;
@@
 enum nal_unit_type { SEQUENCE_PARAMETER_SET = 7 , PICTURE_PARAMETER_SET = 8 , FILLER_DATA = 12 , } cocci_id@p ;
