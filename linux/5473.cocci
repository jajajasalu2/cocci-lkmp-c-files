...
position p;
@@
 struct fsl_lpspi_data cocci_id@p ;
...
position p;
@@
 struct lpspi_config cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct lpspi_config {  u8 bpw ;  u8 chip_select ;  u8 prescale ;  u16 mode ;  u32 speed_hz ; } cocci_id@p ;
