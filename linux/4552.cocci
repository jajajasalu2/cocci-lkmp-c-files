...
position p;
@@
 struct hl_debug_params * cocci_id@p ;
...
position p;
@@
 struct hl_debug_params_spmu cocci_id@p ;
...
position p;
@@
 struct hl_info_reset_count cocci_id@p ;
...
position p;
@@
 struct hl_info_hw_idle cocci_id@p ;
...
position p;
@@
 struct hl_info_clk_rate cocci_id@p ;
...
position p;
@@
 struct hl_debug_params_etr cocci_id@p ;
...
position p;
@@
 const struct hl_ioctl_desc * cocci_id@p ;
...
position p;
@@
 struct hl_debug_args * cocci_id@p ;
...
position p;
@@
 struct hl_info_args * cocci_id@p ;
...
position p;
@@
 struct hl_info_dram_usage cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ HL_DEBUG_OP_TIMESTAMP + 1 ] ;
...
position p;
@@
 struct hl_info_device_utilization cocci_id@p ;
...
position p;
@@
 struct hl_info_hw_ip_info cocci_id@p ;
...
position p;
@@
 struct hl_debug_params_stm cocci_id@p ;
...
position p;
@@
 struct hl_debug_params_etf cocci_id@p ;
...
position p;
@@
 struct hl_info_device_status cocci_id@p ;
...
position p;
@@
 struct hl_debug_params_bmon cocci_id@p ;
