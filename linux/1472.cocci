...
position p;
@@
 struct usb_ms_endpoint_descriptor_16 cocci_id@p ;
...
position p;
@@
 struct usb_midi_out_jack_descriptor_1 cocci_id@p [ MAX_PORTS ] ;
...
position p;
@@
 struct uac1_ac_header_descriptor_1 cocci_id@p ;
...
typedef uint8_t;
@@
 struct gmidi_in_port {  struct snd_rawmidi_substream * substream ;  int active ;  uint8_t cable ;  uint8_t state ;  uint8_t data [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct f_midi * midi ) ;
...
position p;
@@
 enum { STATE_INITIAL = 0 , STATE_1PARAM , STATE_2PARAM_1 , STATE_2PARAM_2 , STATE_SYSEX_0 , STATE_SYSEX_1 , STATE_SYSEX_2 , STATE_REAL_TIME , STATE_FINISHED , } cocci_id@p ;
...
position p;
@@
 struct usb_midi_in_jack_descriptor * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_rawmidi * rmidi ) ;
...
position p;
@@
 struct gmidi_in_port * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usb_function_instance * f ) ;
...
position p;
@@
 struct usb_ms_header_descriptor cocci_id@p ;
...
position p;
@@
 struct usb_midi_in_jack_descriptor cocci_id@p [ MAX_PORTS ] ;
...
position p;
@@
 struct usb_midi_out_jack_descriptor_1 * cocci_id@p ;
