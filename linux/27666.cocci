...
position p;
@@
 void cocci_id@p ( struct file_lock * fl , struct nlm_host * host ) ;
...
position p;
@@
 int cocci_id@p ( struct nlm_host * , int , struct file_lock * ) ;
...
position p;
@@
 int cocci_id@p ( struct nlm_rqst * , struct file_lock * ) ;
