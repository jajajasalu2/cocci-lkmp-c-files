...
position p;
@@
 enum bcma_boot_dev { BCMA_BOOT_DEV_UNK = 0 , BCMA_BOOT_DEV_ROM , BCMA_BOOT_DEV_PARALLEL , BCMA_BOOT_DEV_SERIAL , BCMA_BOOT_DEV_NAND , } cocci_id@p ;
...
position p;
@@
 struct bcma_drv_mips * cocci_id@p ;
