...
position p;
@@
 const struct sja1105_table_ops * cocci_id@p ;
...
position p;
@@
 struct sja1105_schedule_entry_points_params_entry * cocci_id@p ;
...
position p;
@@
 struct sja1105_schedule_params_entry cocci_id@p ;
...
position p;
@@
 const struct sja1105_static_config * cocci_id@p ;
...
position p;
@@
 struct sja1105_schedule_entry * cocci_id@p ;
...
position p;
@@
 struct sja1105_schedule_entry_points_entry cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sja1105_config_valid_t;
@@
 sja1105_config_valid_t cocci_id@p ;
...
position p;
@@
 struct sja1105_avb_params_entry cocci_id@p ;
...
position p;
@@
 struct sja1105_table_header * cocci_id@p ;
...
position p;
@@
 struct sja1105_table_ops cocci_id@p [ BLK_IDX_MAX ] ;
...
position p;
@@
 struct sja1105_static_config * cocci_id@p ;
...
position p;
@@
 const struct sja1105_l2_forwarding_params_entry * cocci_id@p ;
...
position p;
@@
 const struct sja1105_table * cocci_id@p ;
...
position p;
@@
 enum sja1105_blk_idx cocci_id@p ;
