...
position p;
@@
 struct iwl_mvm_session_prot_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_time_event_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_session_prot_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_time_event_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_time_event_resp * cocci_id@p ;
