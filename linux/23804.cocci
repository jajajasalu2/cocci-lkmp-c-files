...
position p;
@@
 struct tcf_csum_params * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_CSUM_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_CSUM_MAX + 1 ] ;
