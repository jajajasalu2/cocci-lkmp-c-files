...
typedef u8;
@@
 const u8 cocci_id@p [ NETVSC_HASH_KEYLEN ] ;
...
position p;
@@
 struct hv_page_buffer cocci_id@p [ 2 ] ;
...
position p;
@@
 struct rndis_set_complete * cocci_id@p ;
...
position p;
@@
 struct net_device_context * cocci_id@p ;
...
position p;
@@
 const struct rndis_pktinfo_id * cocci_id@p ;
...
position p;
@@
 struct rndis_halt_request * cocci_id@p ;
...
typedef u8;
@@
 struct rndis_request {  struct list_head list_ent ;  struct completion wait_event ;  struct rndis_message response_msg ;  u8 response_ext [ RNDIS_EXT_LEN ] ;  struct hv_netvsc_packet pkt ;  struct rndis_message request_msg ;  u8 request_ext [ RNDIS_EXT_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct rndis_query_request cocci_id@p ;
...
position p;
@@
 struct netvsc_channel * cocci_id@p ;
...
position p;
@@
 struct netvsc_device * cocci_id@p ;
...
position p;
@@
 struct ndis_recv_scale_cap cocci_id@p ;
...
position p;
@@
 struct nvsp_message cocci_id@p ;
...
position p;
@@
 struct rndis_message * cocci_id@p ;
...
position p;
@@
 struct rndis_config_parameter_info cocci_id@p ;
...
position p;
@@
 struct ndis_offload_params * cocci_id@p ;
...
position p;
@@
 const struct netvsc_channel * cocci_id@p ;
...
position p;
@@
 struct netvsc_device_info * cocci_id@p ;
...
position p;
@@
 struct rndis_set_request cocci_id@p ;
...
position p;
@@
 struct rndis_query_complete * cocci_id@p ;
...
position p;
@@
 struct rndis_request cocci_id@p ;
...
position p;
@@
 struct ndis_recv_scale_param * cocci_id@p ;
...
position p;
@@
 const struct ndis_pkt_8021q_info * cocci_id@p ;
...
position p;
@@
 const struct rndis_message * cocci_id@p ;
...
position p;
@@
 struct ndis_offload * cocci_id@p ;
...
position p;
@@
 struct rndis_initialize_complete * cocci_id@p ;
...
position p;
@@
 struct rndis_initialize_request * cocci_id@p ;
...
position p;
@@
 struct rndis_per_packet_info * cocci_id@p ;
...
position p;
@@
 struct rndis_device cocci_id@p ;
...
position p;
@@
 struct hv_page_buffer * cocci_id@p ;
...
position p;
@@
 const struct netvsc_device * cocci_id@p ;
...
position p;
@@
 struct rndis_packet * cocci_id@p ;
...
position p;
@@
 const struct ndis_tcp_ip_checksum_info * cocci_id@p ;
...
position p;
@@
 struct hv_netvsc_packet * cocci_id@p ;
