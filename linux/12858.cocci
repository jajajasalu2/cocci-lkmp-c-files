...
position p;
@@
 struct bluefield_edac_priv * cocci_id@p ;
...
position p;
@@
 struct bluefield_edac_priv {  int dimm_ranks [ MLXBF_EDAC_MAX_DIMM_PER_MC ] ;  void __iomem * emi_base ;  int dimm_per_mc ; } cocci_id@p ;
