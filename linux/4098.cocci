...
position p;
@@
 struct rockchip_usb_phy * cocci_id@p ;
...
position p;
@@
 struct rockchip_usb_phy_base * cocci_id@p ;
...
position p;
@@
 const struct rockchip_usb_phy_pdata cocci_id@p ;
...
position p;
@@
 struct rockchip_usb_phy_pdata {  struct rockchip_usb_phys * phys ;  int ( * init_usb_uart ) ( struct regmap * grf , const struct rockchip_usb_phy_pdata * pdata ) ;  int usb_uart_phy ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_usb_phys cocci_id@p [ ] ;
...
position p;
@@
 struct rockchip_usb_phy_base {  struct device * dev ;  struct regmap * reg_base ;  const struct rockchip_usb_phy_pdata * pdata ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_usb_phys {  int reg ;  const char * pll_name ; } cocci_id@p ;
...
typedef bool;
@@
 struct rockchip_usb_phy {  struct rockchip_usb_phy_base * base ;  struct device_node * np ;  unsigned int reg_offset ;  struct clk * clk ;  struct clk * clk480m ;  struct clk_hw clk480m_hw ;  struct phy * phy ;  bool uart_enabled ;  struct reset_control * reset ;  struct regulator * vbus ; } cocci_id@p ;
