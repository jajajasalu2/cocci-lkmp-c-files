...
position p;
@@
 struct mlx4_ib_iov_sysfs_attr_ar cocci_id@p ;
...
typedef u8;
@@
 struct mlx4_port {  struct kobject kobj ;  struct mlx4_ib_dev * dev ;  struct attribute_group pkey_group ;  struct attribute_group gid_group ;  struct device_attribute enable_smi_admin ;  struct device_attribute smi_enabled ;  int slave ;  u8 port_num ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_iov_sysfs_attr * cocci_id@p ;
...
position p;
@@
 struct port_table_attribute {  struct port_attribute attr ;  char name [ 8 ] ;  int index ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_ib_iov_port * cocci_id@p ;
...
position p;
@@
 ssize_t ( * cocci_id@p ) ( struct mlx4_port * , struct port_attribute * , char * buf ) ;
