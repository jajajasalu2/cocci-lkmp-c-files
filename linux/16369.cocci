...
position p;
@@
 const struct isku_report_button * cocci_id@p ;
...
position p;
@@
 struct isku_actual_profile cocci_id@p ;
...
position p;
@@
 struct isku_roccat_report cocci_id@p ;
...
position p;
@@
 const struct isku_device * cocci_id@p ;
