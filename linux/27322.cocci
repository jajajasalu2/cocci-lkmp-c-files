...
position p;
@@
 const FILE_BASIC_INFO * cocci_id@p ;
...
position p;
@@
 FILE_SYSTEM_POSIX_INFO * cocci_id@p ;
...
position p;
@@
 struct {  int index ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 FILE_SYSTEM_ALLOC_INFO * cocci_id@p ;
...
position p;
@@
 FILE_SYSTEM_UNIX_INFO cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_spi_req cocci_id@p ;
...
position p;
@@
 struct cifs_posix_acl * cocci_id@p ;
...
position p;
@@
 struct posix_acl_xattr_entry * cocci_id@p ;
...
position p;
@@
 struct cifs_credits cocci_id@p ;
...
position p;
@@
 struct unlink_psx_rq cocci_id@p ;
...
position p;
@@
 FILE_SYSTEM_DEVICE_INFO cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_setfsi_req cocci_id@p ;
...
position p;
@@
 TRANSACTION2_FNEXT_RSP * cocci_id@p ;
...
position p;
@@
 TRANSACTION2_FFIRST_RSP * cocci_id@p ;
...
position p;
@@
 struct file_end_of_file_info * cocci_id@p ;
...
position p;
@@
 struct lanman_neg_rsp * cocci_id@p ;
...
position p;
@@
 FILE_UNIX_BASIC_INFO cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_sfi_rsp * cocci_id@p ;
...
position p;
@@
 struct smb_com_writex_req * cocci_id@p ;
...
position p;
@@
 struct cifs_io_parms * cocci_id@p ;
...
position p;
@@
 struct cifs_readdata * cocci_id@p ;
...
position p;
@@
 CREATE_DIRECTORY_REQ * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_ffirst_req cocci_id@p ;
...
position p;
@@
 struct set_file_rename * cocci_id@p ;
...
position p;
@@
 struct smb_com_ntransact_rsp * cocci_id@p ;
...
position p;
@@
 const struct nls_table * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_qpi_req cocci_id@p ;
...
position p;
@@
 struct dfs_info3_param * * cocci_id@p ;
...
position p;
@@
 struct dfs_cache_tgt_iterator * cocci_id@p ;
...
position p;
@@
 TRANSACTION2_GET_DFS_REFER_RSP * cocci_id@p ;
...
position p;
@@
 struct smb_t2_qfi_rsp * cocci_id@p ;
...
position p;
@@
 struct cifs_posix_ace * cocci_id@p ;
...
position p;
@@
 struct cifs_open_parms * cocci_id@p ;
...
position p;
@@
 struct smb_t2_qfi_req * cocci_id@p ;
...
position p;
@@
 struct reparse_symlink_data * cocci_id@p ;
...
position p;
@@
 struct cifsFileInfo * cocci_id@p ;
...
position p;
@@
 struct cifs_search_info * cocci_id@p ;
...
position p;
@@
 FILE_SYSTEM_ATTRIBUTE_INFO * cocci_id@p ;
...
position p;
@@
 struct smb_com_write_req cocci_id@p ;
...
position p;
@@
 struct TCP_Server_Info * cocci_id@p ;
...
position p;
@@
 struct reparse_posix_data * cocci_id@p ;
...
position p;
@@
 TRANSACTION2_FFIRST_REQ * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_qfsi_req cocci_id@p ;
...
position p;
@@
 TRANSACTION2_QPI_REQ * cocci_id@p ;
...
position p;
@@
 TRANSACTION2_FNEXT_REQ * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction_ioctl_rsp * cocci_id@p ;
...
position p;
@@
 QUERY_INFORMATION_REQ * cocci_id@p ;
...
position p;
@@
 const struct posix_acl_xattr_entry * cocci_id@p ;
...
position p;
@@
 QUERY_INFORMATION_RSP * cocci_id@p ;
...
position p;
@@
 struct cifs_posix_lock * cocci_id@p ;
...
position p;
@@
 struct cifs_writedata * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction_compr_ioctl_req cocci_id@p ;
...
position p;
@@
 TRANSACTION2_SETFSI_REQ * cocci_id@p ;
...
position p;
@@
 struct dfs_cache_tgt_list cocci_id@p ;
...
position p;
@@
 CREATE_DIRECTORY_RSP * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_get_dfs_refer_req cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_spi_rsp * cocci_id@p ;
...
position p;
@@
 struct smb_com_readx_req * cocci_id@p ;
...
position p;
@@
 struct smb_com_ntransact_req * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction_ioctl_req * cocci_id@p ;
...
position p;
@@
 struct posix_acl_xattr_header * cocci_id@p ;
...
position p;
@@
 TRANSACTION2_SPI_REQ * cocci_id@p ;
...
position p;
@@
 TRANSACTION2_QFSI_RSP * cocci_id@p ;
...
position p;
@@
 const struct cifs_unix_set_info_args * cocci_id@p ;
...
position p;
@@
 TRANSACTION2_SPI_RSP * cocci_id@p ;
...
position p;
@@
 T2_FFIRST_RSP_PARMS * cocci_id@p ;
...
position p;
@@
 TRANSACTION2_QPI_RSP * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_sfi_req cocci_id@p ;
...
position p;
@@
 TRANSACTION2_QFSI_REQ * cocci_id@p ;
...
position p;
@@
 DELETE_DIRECTORY_REQ * cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction_ssec_req cocci_id@p ;
...
position p;
@@
 struct smb_com_transaction2_fnext_req cocci_id@p ;
...
position p;
@@
 TRANSACTION2_GET_DFS_REFER_REQ * cocci_id@p ;
...
position p;
@@
 DELETE_DIRECTORY_RSP * cocci_id@p ;
...
position p;
@@
 TRANSACTION2_SETFSI_RSP * cocci_id@p ;
...
position p;
@@
 struct file_chattr_info * cocci_id@p ;
...
position p;
@@
 struct cifs_sb_info * cocci_id@p ;
...
position p;
@@
 struct file_internal_info * cocci_id@p ;
