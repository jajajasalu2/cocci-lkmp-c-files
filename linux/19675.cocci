...
position p;
@@
 struct system_loongson * cocci_id@p ;
...
position p;
@@
 struct loongson_params * cocci_id@p ;
...
position p;
@@
 struct efi_memory_map_loongson * cocci_id@p ;
...
position p;
@@
 struct irq_source_routing_table * cocci_id@p ;
...
position p;
@@
 struct loongson_system_configuration cocci_id@p ;
...
position p;
@@
 struct sensor_device cocci_id@p ;
...
position p;
@@
 unsigned long long cocci_id@p [ 4 ] ;
...
position p;
@@
 struct efi_cpuinfo_loongson * cocci_id@p ;
