...
position p;
@@
 char cocci_id@p [ BTRFS_CSUM_SIZE ] ;
...
symbol cocci_id;
position p;
typedef extent_submit_bio_start_t;
@@
 extent_submit_bio_start_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfs_root * root ) ;
...
symbol cocci_id;
position p;
typedef u64,extent_submit_bio_start_t,blk_status_t;
@@
 struct async_submit_bio {  void * private_data ;  struct bio * bio ;  extent_submit_bio_start_t * submit_bio_start ;  int mirror_num ;  u64 bio_offset ;  struct btrfs_work work ;  blk_status_t status ; } cocci_id@p ;
...
position p;
@@
 struct btrfs_delayed_root cocci_id@p ;
...
position p;
@@
 struct btrfs_end_io_wq cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_fs_info * fs_info ) ;
...
position p;
@@
 struct async_submit_bio cocci_id@p ;
...
position p;
@@
 struct btrfs_lockdep_keyset * cocci_id@p ;
...
position p;
@@
 struct btrfs_subvolume_writers * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_fs_info * fs_info , struct extent_io_tree * pinned_extents ) ;
...
position p;
@@
 struct btrfs_dev_item * cocci_id@p ;
...
position p;
@@
 struct btrfs_root * cocci_id@p [ 8 ] ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_fs_info * fs_info , struct extent_io_tree * dirty_pages , int mark ) ;
...
symbol cocci_id;
position p;
typedef bio_end_io_t,blk_status_t;
@@
 struct btrfs_end_io_wq {  struct bio * bio ;  bio_end_io_t * end_io ;  void * private ;  struct btrfs_fs_info * info ;  blk_status_t status ;  enum btrfs_wq_endio_type metadata ;  struct btrfs_work work ; } cocci_id@p ;
...
position p;
@@
 struct btrfs_root_backup * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_transaction * trans , struct btrfs_fs_info * fs_info ) ;
