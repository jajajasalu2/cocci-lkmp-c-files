...
position p;
@@
 const struct lpphy_rx_iq_comp * cocci_id@p ;
...
position p;
@@
 struct lpphy_iq_est cocci_id@p ;
...
typedef u8,u16;
@@
 struct b206x_channel {  u8 channel ;  u16 freq ;  u8 data [ 12 ] ; } cocci_id@p ;
...
position p;
@@
 const struct b206x_channel * cocci_id@p ;
...
typedef u16;
@@
 struct lpphy_stx_table_entry {  u16 phy_offset ;  u16 phy_shift ;  u16 rf_addr ;  u16 rf_shift ;  u16 mask ; } cocci_id@p ;
...
position p;
@@
 const struct lpphy_stx_table_entry * cocci_id@p ;
...
position p;
@@
 struct lpphy_tx_gains cocci_id@p ;
...
typedef u8,u16;
@@
 struct b2062_freqdata {  u16 freq ;  u8 data [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct b43_wldev * dev , unsigned int new_channel ) ;
...
position p;
@@
 const struct b2062_freqdata cocci_id@p [ ] ;
...
position p;
@@
 enum b43_lpphy_txpctl_mode cocci_id@p ;
