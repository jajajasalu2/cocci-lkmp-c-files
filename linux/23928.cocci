...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct mr_table * mrt , struct sk_buff * skb , u32 portid , u32 seq , struct mr_mfc * c , int cmd , int flags ) ;
...
position p;
@@
 struct mr_table * ( * cocci_id@p ) ( struct net * net , struct mr_table * mrt ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct mr_table * mrt , struct net * net ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net * net , struct notifier_block * nb , struct netlink_ext_ack * extack ) ;
