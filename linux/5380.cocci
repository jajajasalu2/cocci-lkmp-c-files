...
position p;
@@
 struct regmap_debugfs_node {  struct regmap * map ;  const char * name ;  struct list_head link ; } cocci_id@p ;
...
position p;
@@
 struct regmap_debugfs_off_cache * cocci_id@p ;
...
position p;
@@
 struct regmap_debugfs_node * cocci_id@p ;
