...
position p;
@@
 struct gb_gpio_direction_out_request cocci_id@p ;
...
position p;
@@
 struct gbphy_driver cocci_id@p ;
...
position p;
@@
 struct gb_gpio_controller * cocci_id@p ;
...
position p;
@@
 struct gb_gpio_set_value_request cocci_id@p ;
...
position p;
@@
 struct gb_gpio_line * cocci_id@p ;
...
position p;
@@
 struct gb_gpio_get_direction_response cocci_id@p ;
...
position p;
@@
 struct gbphy_device * cocci_id@p ;
...
position p;
@@
 struct gb_gpio_irq_type_request cocci_id@p ;
...
position p;
@@
 struct gb_gpio_irq_event_request * cocci_id@p ;
...
position p;
@@
 struct gb_gpio_get_value_response cocci_id@p ;
...
typedef u8;
@@
 struct gb_gpio_controller {  struct gbphy_device * gbphy_dev ;  struct gb_connection * connection ;  u8 line_max ;  struct gb_gpio_line * lines ;  struct gpio_chip chip ;  struct irq_chip irqc ;  struct mutex irq_lock ; } cocci_id@p ;
...
position p;
@@
 struct gb_gpio_get_direction_request cocci_id@p ;
...
position p;
@@
 struct gb_gpio_activate_request cocci_id@p ;
...
position p;
@@
 const struct gbphy_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct gb_gpio_direction_in_request cocci_id@p ;
...
position p;
@@
 struct gb_gpio_irq_mask_request cocci_id@p ;
...
position p;
@@
 struct gb_gpio_line_count_response cocci_id@p ;
...
position p;
@@
 struct gb_gpio_set_debounce_request cocci_id@p ;
...
position p;
@@
 struct gb_gpio_get_value_request cocci_id@p ;
...
position p;
@@
 struct gb_gpio_deactivate_request cocci_id@p ;
...
position p;
@@
 struct gb_gpio_irq_unmask_request cocci_id@p ;
