...
position p;
@@
 struct st21nfca_psl_req cocci_id@p ;
...
position p;
@@
 struct st21nfca_atr_res cocci_id@p ;
...
position p;
@@
 struct st21nfca_atr_req * cocci_id@p ;
...
position p;
@@
 struct st21nfca_psl_res * cocci_id@p ;
...
position p;
@@
 struct st21nfca_dep_req_res * cocci_id@p ;
