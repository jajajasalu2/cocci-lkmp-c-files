...
position p;
@@
 const struct mfc_cache * cocci_id@p ;
...
typedef u32;
@@
 struct mr_table * cocci_id@p ( struct net * net , u32 id ) ;
...
position p;
@@
 void cocci_id@p ( struct net * net , struct mr_table * mrt , struct net_device * dev , struct sk_buff * skb , struct mfc_cache * cache , int local ) ;
...
position p;
@@
 struct fib_notifier_ops * cocci_id@p ;
...
position p;
@@
 struct sioc_vif_req cocci_id@p ;
...
position p;
@@
 struct fib_rule_hdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mr_table * mrt , struct mfc_cache * mfc , int cmd ) ;
...
position p;
@@
 const struct vif_device * cocci_id@p ;
...
position p;
@@
 const struct mr_mfc_iter * cocci_id@p ;
...
position p;
@@
 struct compat_sioc_sg_req cocci_id@p ;
...
position p;
@@
 struct rta_mfc_stats cocci_id@p ;
...
position p;
@@
 const struct mfc_cache_cmp_arg * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ FRA_MAX + 1 ] ;
...
position p;
@@
 const struct mr_table * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mr_table * mrt , struct sk_buff * pkt ) ;
...
@@
 struct compat_sioc_sg_req {  struct in_addr src ;  struct in_addr grp ;  compat_ulong_t pktcnt ;  compat_ulong_t bytecnt ;  compat_ulong_t wrong_if ; } cocci_id@p ;
...
position p;
@@
 struct fib_rules_ops * cocci_id@p ;
...
position p;
@@
 struct ipmr_rule {  struct fib_rule common ; } cocci_id@p ;
...
position p;
@@
 struct mr_table_ops cocci_id@p ;
...
symbol cocci_id;
position p;
typedef vifi_t,compat_ulong_t;
@@
 struct compat_sioc_vif_req {  vifi_t vifi ;  compat_ulong_t icount ;  compat_ulong_t ocount ;  compat_ulong_t ibytes ;  compat_ulong_t obytes ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mr_table * mrt , int flags ) ;
...
position p;
@@
 struct compat_sioc_vif_req cocci_id@p ;
...
position p;
@@
 const struct fib_rule * cocci_id@p ;
...
position p;
@@
 struct ipmr_result {  struct mr_table * mrt ; } cocci_id@p ;
...
position p;
@@
 const struct fib_notifier_ops cocci_id@p ;
...
position p;
@@
 const struct net_protocol cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mr_table * mrt ) ;
...
position p;
@@
 struct mfc_cache_cmp_arg cocci_id@p ;
...
position p;
@@
 struct fib_lookup_arg cocci_id@p ;
