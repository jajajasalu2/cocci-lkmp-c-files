...
position p;
@@
 const struct aper_size_info_8 cocci_id@p [ 5 ] ;
...
typedef u32,off_t;
@@
 struct _nvidia_private {  struct pci_dev * dev_1 ;  struct pci_dev * dev_2 ;  struct pci_dev * dev_3 ;  volatile u32 __iomem * aperture ;  int num_active_entries ;  off_t pg_offset ;  u32 wbc_mask ; } cocci_id@p ;
