...
position p;
@@
 struct sof_ipc_comp_volume cocci_id@p ;
...
position p;
@@
 struct sof_ipc_pipe_ready cocci_id@p ;
...
position p;
@@
 struct snd_sof_control * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_ctl_hdr * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_comp_tone * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_dai_config * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_buffer cocci_id@p ;
...
position p;
@@
 const struct sof_abi_hdr cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_vendor_uuid_elem * cocci_id@p ;
...
position p;
@@
 struct snd_sof_route * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_fw_ready * cocci_id@p ;
...
position p;
@@
 const struct snd_soc_tplg_kcontrol_ops cocci_id@p [ ] ;
...
position p;
@@
 struct sof_ipc_free cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_link_config * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_comp_process cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_vendor_string_elem * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_fw_version * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_pipe_new * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_comp_src * cocci_id@p ;
...
position p;
@@
 struct sof_dai_types {  const char * name ;  enum sof_ipc_dai_type type ; } cocci_id@p ;
...
typedef u32;
@@
 struct sof_topology_token {  u32 token ;  u32 type ;  int ( * get_token ) ( void * elem , void * object , u32 offset , u32 size ) ;  u32 offset ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 struct sof_widget_data * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_bytes_control * cocci_id@p ;
...
position p;
@@
 const struct snd_soc_tplg_bytes_ext_ops cocci_id@p [ ] ;
...
position p;
@@
 struct sof_ipc_comp_config cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_ops cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_enum_control * cocci_id@p ;
...
position p;
@@
 const struct sof_dai_types cocci_id@p [ ] ;
...
position p;
@@
 struct snd_soc_tplg_stream_caps * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_comp_mixer * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_hw_config * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_comp_reply * cocci_id@p ;
...
position p;
@@
 struct sof_widget_data {  int ctrl_type ;  int ipc_cmd ;  struct sof_abi_hdr * pdata ;  struct snd_sof_control * control ; } cocci_id@p ;
...
position p;
@@
 struct sof_ipc_reply cocci_id@p ;
...
position p;
@@
 struct sof_ipc_ctrl_data cocci_id@p ;
...
position p;
@@
 enum sof_ipc_stream_direction cocci_id@p ;
...
position p;
@@
 struct sof_ipc_dai_hda_params cocci_id@p ;
...
position p;
@@
 struct sof_ipc_comp_host cocci_id@p ;
...
position p;
@@
 struct snd_sof_widget * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_manifest * cocci_id@p ;
...
position p;
@@
 struct snd_soc_dai_link * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_pcm_params_reply cocci_id@p ;
...
position p;
@@
 const struct snd_soc_tplg_widget_events cocci_id@p [ ] ;
...
position p;
@@
 struct sof_ipc_pipe_comp_connect * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_dai_dmic_params cocci_id@p ;
...
position p;
@@
 struct sof_ipc_pm_core_config cocci_id@p ;
...
position p;
@@
 struct snd_sof_led_control cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_private * cocci_id@p ;
...
position p;
@@
 enum sof_ipc_process_type cocci_id@p ;
...
position p;
@@
 struct sof_ipc_dai_ssp_params cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_vendor_array * cocci_id@p ;
...
position p;
@@
 const struct sof_topology_token * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_mixer_control cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_pcm * cocci_id@p ;
...
position p;
@@
 enum sof_ipc_dai_type cocci_id@p ;
...
position p;
@@
 struct sof_frame_types {  const char * name ;  enum sof_ipc_frame frame ; } cocci_id@p ;
...
position p;
@@
 struct sof_process_types {  const char * name ;  enum sof_ipc_process_type type ;  enum sof_comp_type comp_type ; } cocci_id@p ;
...
position p;
@@
 struct sof_ipc_stream cocci_id@p ;
...
position p;
@@
 struct sof_ipc_pcm_params cocci_id@p ;
...
position p;
@@
 const struct sof_process_types cocci_id@p [ ] ;
...
position p;
@@
 struct snd_soc_dai_driver * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_comp_mux * cocci_id@p ;
...
position p;
@@
 const struct sof_frame_types cocci_id@p [ ] ;
...
position p;
@@
 struct snd_soc_tplg_vendor_value_elem * cocci_id@p ;
...
position p;
@@
 struct snd_soc_dobj * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_dai_dmic_pdm_ctrl cocci_id@p ;
...
position p;
@@
 struct snd_soc_dapm_route * cocci_id@p ;
...
position p;
@@
 struct snd_soc_card * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_comp_dai cocci_id@p ;
...
position p;
@@
 struct sof_ipc_dai_esai_params cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_dapm_widget * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_comp * cocci_id@p ;
