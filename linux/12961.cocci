...
position p;
@@
 struct knav_qmgr_info * cocci_id@p ;
...
position p;
@@
 struct knav_range_info * cocci_id@p ;
...
position p;
@@
 struct knav_link_ram_block * cocci_id@p ;
...
position p;
@@
 struct knav_queue_inst * cocci_id@p ;
...
position p;
@@
 struct knav_range_ops cocci_id@p ;
...
position p;
@@
 enum knav_queue_ctrl_cmd cocci_id@p ;
...
position p;
@@
 struct knav_queue_stats cocci_id@p ;
...
position p;
@@
 knav_queue_notify_fn cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ KNAV_NAME_SIZE ] ;
...
position p;
@@
 struct knav_pdsp_info * cocci_id@p ;
