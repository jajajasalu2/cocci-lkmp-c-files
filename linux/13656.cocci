...
position p;
@@
 struct usb_fpix {  struct gspca_dev gspca_dev ;  struct work_struct work_struct ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_pix_format cocci_id@p [ 1 ] ;
