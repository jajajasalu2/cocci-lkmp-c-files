...
position p;
@@
 struct msm_gem_address_space * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,uint32_t;
@@
 struct dpu_plane {  struct drm_plane base ;  struct mutex lock ;  enum dpu_sspp pipe ;  uint32_t features ;  struct dpu_hw_pipe * pipe_hw ;  struct dpu_hw_pipe_cfg pipe_cfg ;  struct dpu_hw_pipe_qos_cfg pipe_qos_cfg ;  uint32_t color_fill ;  bool is_error ;  bool is_rt_pipe ;  bool is_virtual ;  struct list_head mplane_list ;  struct dpu_mdss_cfg * catalog ;  struct dpu_csc_cfg * csc_ptr ;  const struct dpu_sspp_sub_blks * pipe_sblk ;  char pipe_name [ DPU_NAME_SIZE ] ;  struct dentry * debugfs_root ;  struct dpu_debugfs_regset32 debugfs_src ;  struct dpu_debugfs_regset32 debugfs_scaler ;  struct dpu_debugfs_regset32 debugfs_csc ;  bool debugfs_default_scale ; } cocci_id@p ;
...
position p;
@@
 const struct dpu_format * cocci_id@p ;
...
position p;
@@
 struct dpu_vbif_set_ot_params cocci_id@p ;
...
position p;
@@
 struct dpu_hw_pipe_cdp_cfg cocci_id@p ;
...
position p;
@@
 struct dpu_plane * cocci_id@p [ R_MAX ] ;
...
position p;
@@
 struct drm_rect cocci_id@p [ R_MAX ] ;
...
position p;
@@
 struct dpu_multirect_plane_states * cocci_id@p ;
...
position p;
@@
 const struct dpu_qos_lut_tbl * cocci_id@p ;
...
position p;
@@
 struct dpu_hw_fmt_layout cocci_id@p ;
...
position p;
@@
 struct dpu_hw_pipe_cfg cocci_id@p ;
...
position p;
@@
 struct dpu_vbif_set_qos_params cocci_id@p ;
...
position p;
@@
 const struct dpu_sspp_cfg * cocci_id@p ;
...
position p;
@@
 enum dpu_plane_qos { DPU_PLANE_QOS_VBLANK_CTRL = BIT ( 0 ) , DPU_PLANE_QOS_VBLANK_AMORTIZE = BIT ( 1 ) , DPU_PLANE_QOS_PANIC_CTRL = BIT ( 2 ) , } cocci_id@p ;
...
position p;
@@
 struct dpu_hw_scaler3_cfg * cocci_id@p ;
...
position p;
@@
 const struct dpu_sspp_sub_blks * cocci_id@p ;
...
position p;
@@
 const struct drm_plane_state * cocci_id@p [ R_MAX ] ;
...
position p;
@@
 const struct dpu_csc_cfg cocci_id@p ;
...
position p;
@@
 const struct msm_format * cocci_id@p ;
...
position p;
@@
 const struct dpu_format * cocci_id@p [ R_MAX ] ;
...
position p;
@@
 const struct drm_crtc_state * cocci_id@p ;
...
position p;
@@
 struct dpu_plane_state * cocci_id@p [ R_MAX ] ;
...
position p;
@@
 struct dpu_plane_state * cocci_id@p ;
...
position p;
@@
 struct dpu_hw_pixel_ext cocci_id@p ;
