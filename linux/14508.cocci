...
typedef u32;
@@
 struct vc5_hw_data {  struct clk_hw hw ;  struct vc5_driver_data * vc5 ;  u32 div_int ;  u32 div_frc ;  unsigned int num ; } cocci_id@p ;
...
position p;
@@
 const struct vc5_chip_info cocci_id@p ;
...
position p;
@@
 struct vc5_driver_data * cocci_id@p ;
...
position p;
@@
 const enum vc5_model cocci_id@p ;
...
position p;
@@
 enum vc5_model { IDT_VC5_5P49V5923 , IDT_VC5_5P49V5925 , IDT_VC5_5P49V5933 , IDT_VC5_5P49V5935 , IDT_VC6_5P49V6901 , } cocci_id@p ;
...
typedef u32;
@@
 struct vc5_chip_info {  const enum vc5_model model ;  const unsigned int clk_fod_cnt ;  const unsigned int clk_out_cnt ;  const u32 flags ; } cocci_id@p ;
