...
position p;
@@
 struct iwl_rx_transfer_desc * cocci_id@p ;
...
position p;
@@
 const struct iwl_rxq * cocci_id@p ;
...
position p;
@@
 struct iwl_rb_allocator cocci_id@p ;
...
position p;
@@
 struct iwl_rb_status cocci_id@p ;
...
position p;
@@
 struct iwl_rx_completion_desc cocci_id@p ;
