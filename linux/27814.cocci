...
position p;
@@
 const struct quota_format_ops cocci_id@p ;
...
position p;
@@
 struct ocfs2_recovery_chunk * cocci_id@p ;
...
position p;
@@
 struct ocfs2_local_disk_chunk * cocci_id@p ;
...
position p;
@@
 struct ocfs2_local_disk_dqinfo * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct buffer_head * , void * ) ;
...
position p;
@@
 struct ocfs2_local_disk_dqblk * cocci_id@p ;
...
position p;
@@
 struct ocfs2_disk_dqheader * cocci_id@p ;
