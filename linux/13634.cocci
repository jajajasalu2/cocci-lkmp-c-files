...
position p;
@@
 struct ucbus_write_cmd cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct i2c_write_cmd cocci_id@p [ ] ;
...
position p;
@@
 enum sensors { SENSOR_ICX098BQ , SENSOR_LZ24BP , SENSOR_MI0360 , SENSOR_MT9V111 , SENSOR_OV7660 , SENSOR_OV9630 , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct i2c_write_cmd {  u8 reg ;  u16 val ; } cocci_id@p ;
...
typedef u8;
@@
 struct sensor_s {  const char * name ;  u8 i2c_addr ;  u8 i2c_dum ;  u8 gpio [ 5 ] ;  u8 cmd_len ;  const struct ucbus_write_cmd * cmd ; } cocci_id@p ;
...
position p;
@@
 const struct ucbus_write_cmd cocci_id@p ;
...
typedef u8,u16;
@@
 struct ucbus_write_cmd {  u16 bw_addr ;  u8 bw_data ; } cocci_id@p ;
...
position p;
@@
 const struct sensor_s cocci_id@p [ ] ;
...
typedef u8;
@@
 const struct cap_s {  u8 cc_sizeid ;  u8 cc_bytes [ 32 ] ; } cocci_id@p [ 4 ] [ 2 ] ;
