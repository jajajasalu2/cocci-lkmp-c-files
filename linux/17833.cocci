...
position p;
@@
 struct time_sn_spec cocci_id@p ;
...
symbol cocci_id;
position p;
typedef itc_jitter_data_t;
@@
 struct itc_jitter_data_t cocci_id@p ;
...
position p;
@@
 struct pal_min_state_area_s cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fsyscall_gtod_data_t;
@@
 struct fsyscall_gtod_data_t cocci_id@p ;
