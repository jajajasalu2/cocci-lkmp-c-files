...
position p;
@@
 enum hix5hd2_clk_type { TYPE_COMPLEX , TYPE_ETHER , } cocci_id@p ;
...
position p;
@@
 struct hix5hd2_clk_complex cocci_id@p ;
...
typedef u32;
@@
 struct hix5hd2_clk_complex {  struct clk_hw hw ;  u32 id ;  void __iomem * ctrl_reg ;  u32 ctrl_clk_mask ;  u32 ctrl_rst_mask ;  void __iomem * phy_reg ;  u32 phy_clk_mask ;  u32 phy_rst_mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct hix5hd2_complex_clock {  const char * name ;  const char * parent_name ;  u32 id ;  u32 ctrl_reg ;  u32 ctrl_clk_mask ;  u32 ctrl_rst_mask ;  u32 phy_reg ;  u32 phy_clk_mask ;  u32 phy_rst_mask ;  enum hix5hd2_clk_type type ; } cocci_id@p ;
...
position p;
@@
 struct hix5hd2_complex_clock * cocci_id@p ;
