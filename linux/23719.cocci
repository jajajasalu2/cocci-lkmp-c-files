...
position p;
@@
 const struct hdac_chmap_ops cocci_id@p ;
...
position p;
@@
 struct channel_map_table * cocci_id@p ;
...
position p;
@@
 enum cea_speaker_placement { FL = ( 1 << 0 ) , FC = ( 1 << 1 ) , FR = ( 1 << 2 ) , FLC = ( 1 << 3 ) , FRC = ( 1 << 4 ) , RL = ( 1 << 5 ) , RC = ( 1 << 6 ) , RR = ( 1 << 7 ) , RLC = ( 1 << 8 ) , RRC = ( 1 << 9 ) , LFE = ( 1 << 10 ) , FLW = ( 1 << 11 ) , FRW = ( 1 << 12 ) , FLH = ( 1 << 13 ) , FCH = ( 1 << 14 ) , FRH = ( 1 << 15 ) , TC = ( 1 << 16 ) , } cocci_id@p ;
...
position p;
@@
 struct channel_map_table {  unsigned char map ;  int spk_mask ; } cocci_id@p ;
