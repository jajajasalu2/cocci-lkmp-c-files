...
position p;
@@
 enum rt_ht_capability cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rtllib_device * ieee , enum ht_channel_width Bandwidth , enum ht_extchnl_offset Offset ) ;
