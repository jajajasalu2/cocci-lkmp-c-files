...
position p;
@@
 const struct pmu_res_depend_tab_entry * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct pmu0_plltab_entry {  u16 freq ;  u8 xf ;  u8 wb_int ;  u32 wb_frac ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct pmu_res_updown_tab_entry {  u8 resource ;  u16 updown ; } cocci_id@p ;
...
position p;
@@
 const struct pmu0_plltab_entry cocci_id@p [ ] ;
...
position p;
@@
 enum pmu_res_depend_tab_task { PMU_RES_DEP_SET = 1 , PMU_RES_DEP_ADD , PMU_RES_DEP_REMOVE , } cocci_id@p ;
...
position p;
@@
 enum ssb_pmu_ldo_volt_id cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct pmu1_plltab_entry {  u16 freq ;  u8 xf ;  u8 ndiv_int ;  u32 ndiv_frac ;  u8 p1div ;  u8 p2div ; } cocci_id@p ;
...
position p;
@@
 const struct pmu_res_updown_tab_entry * cocci_id@p ;
...
position p;
@@
 const struct pmu1_plltab_entry * cocci_id@p ;
...
typedef u8,u32;
@@
 struct pmu_res_depend_tab_entry {  u8 resource ;  u8 task ;  u32 depend ; } cocci_id@p ;
