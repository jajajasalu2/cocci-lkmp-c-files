...
position p;
@@
 const struct nvkm_mc_map cocci_id@p [ ] ;
...
position p;
@@
 const struct nvkm_mc_func * cocci_id@p ;
...
@@
 struct gp100_mc {  struct nvkm_mc base ;  spinlock_t lock ;  bool intr ;  u32 mask ; } cocci_id@p ;
