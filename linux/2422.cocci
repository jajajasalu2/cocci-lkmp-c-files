...
position p;
@@
 struct fsl_edma_chan * cocci_id@p ;
...
position p;
@@
 struct fsl_edma_desc * cocci_id@p ;
...
position p;
@@
 struct fsl_edma_hw_tcd * cocci_id@p ;
...
position p;
@@
 struct fsl_edma_engine * cocci_id@p ;
