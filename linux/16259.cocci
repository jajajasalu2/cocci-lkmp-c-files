...
position p;
@@
 const struct ov5642_datafmt * cocci_id@p ;
...
position p;
@@
 struct ov5642 {  struct v4l2_subdev subdev ;  const struct ov5642_datafmt * fmt ;  struct v4l2_rect crop_rect ;  struct v4l2_clk * clk ;  int total_width ;  int total_height ; } cocci_id@p ;
...
typedef u32;
@@
 struct ov5642_datafmt {  u32 code ;  enum v4l2_colorspace colorspace ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct regval_list {  u16 reg_num ;  u8 value ; } cocci_id@p ;
