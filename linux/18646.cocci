...
position p;
@@
 struct prm_reset_src_map * cocci_id@p ;
...
position p;
@@
 const struct omap_prcm_irq cocci_id@p [ ] ;
...
position p;
@@
 struct omap_prm_irq_context {  unsigned long irq_enable ;  unsigned long pm_ctrl ; } cocci_id@p ;
...
typedef u32;
@@
 struct omap4_vp {  u32 irqstatus_mpu ;  u32 tranxdone_status ; } cocci_id@p ;
...
position p;
@@
 struct omap_prcm_irq_setup cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( u32 * saved_mask ) ;
...
position p;
@@
 struct omap_prm_irq_context cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long * events ) ;
