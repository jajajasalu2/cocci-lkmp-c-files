...
position p;
@@
 struct mbox_controller * cocci_id@p ;
...
typedef u32;
@@
 struct pdc_globals {  u32 num_spu ; } cocci_id@p ;
...
position p;
@@
 struct brcm_message cocci_id@p ;
...
typedef u32;
@@
 struct dma64_regs {  u32 control ;  u32 ptr ;  u32 addrlow ;  u32 addrhigh ;  u32 status0 ;  u32 status1 ; } cocci_id@p ;
...
position p;
@@
 const struct mbox_chan_ops cocci_id@p ;
...
position p;
@@
 struct pdc_ring_alloc cocci_id@p ;
...
typedef u32;
@@
 struct dma64 {  struct dma64_regs dmaxmt ;  u32 PAD [ 2 ] ;  struct dma64_regs dmarcv ;  u32 PAD [ 2 ] ; } cocci_id@p ;
...
@@
 struct pdc_rx_ctx {  void * rxp_ctx ;  struct scatterlist * dst_sg ;  u32 rxin_numd ;  void * resp_hdr ;  dma_addr_t resp_hdr_daddr ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct pdc_state {  u8 pdc_idx ;  struct platform_device * pdev ;  struct mbox_controller mbc ;  unsigned int pdc_irq ;  struct tasklet_struct rx_tasklet ;  u32 rx_status_len ;  bool use_bcm_hdr ;  u32 pdc_resp_hdr_len ;  void __iomem * pdc_reg_vbase ;  struct dma_pool * ring_pool ;  struct dma_pool * rx_buf_pool ;  struct pdc_ring_alloc tx_ring_alloc ;  struct pdc_ring_alloc rx_ring_alloc ;  struct pdc_regs * regs ;  struct dma64_regs * txregs_64 ;  struct dma64_regs * rxregs_64 ;  struct dma64dd * txd_64 ;  struct dma64dd * rxd_64 ;  u32 ntxd ;  u32 nrxd ;  u32 nrxpost ;  u32 ntxpost ;  u32 txin ;  u32 tx_msg_start ;  u32 txout ;  u32 txin_numd [ PDC_RING_ENTRIES ] ;  u32 rxin ;  u32 rx_msg_start ;  u32 last_rx_curr ;  u32 rxout ;  struct pdc_rx_ctx rx_ctx [ PDC_RING_ENTRIES ] ;  struct scatterlist * src_sg [ PDC_RING_ENTRIES ] ;  u32 pdc_requests ;  u32 pdc_replies ;  u32 last_tx_not_done ;  u32 tx_ring_full ;  u32 rx_ring_full ;  u32 txnobuf ;  u32 rxnobuf ;  u32 rx_oflow ;  enum pdc_hw hw_type ; } cocci_id@p ;
...
position p;
@@
 struct pdc_dma_map {  void * ctx ; } cocci_id@p ;
...
typedef u32,dma_addr_t;
@@
 struct pdc_ring_alloc {  dma_addr_t dmabase ;  void * vbase ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 enum pdc_hw { FA_HW , PDC_HW , } cocci_id@p ;
...
typedef u32;
@@
 struct dma64dd {  u32 ctrl1 ;  u32 ctrl2 ;  u32 addrlow ;  u32 addrhigh ; } cocci_id@p ;
