...
position p;
@@
 struct zfcp_dbf_san * cocci_id@p ;
...
position p;
@@
 struct zfcp_dbf_scsi cocci_id@p ;
...
position p;
@@
 struct zfcp_dbf_pay * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ DEBUG_MAX_NAME_LEN ] ;
...
position p;
@@
 struct fsf_bit_error_payload cocci_id@p ;
...
position p;
@@
 struct zfcp_dbf_rec cocci_id@p ;
...
position p;
@@
 struct zfcp_dbf_hba * cocci_id@p ;
...
position p;
@@
 struct fsf_qtcb_prefix * cocci_id@p ;
