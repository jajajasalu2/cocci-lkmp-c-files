...
position p;
@@
 const struct ad193x_priv * cocci_id@p ;
...
position p;
@@
 struct ad193x_priv {  struct regmap * regmap ;  enum ad193x_type type ;  int sysclk ; } cocci_id@p ;
