...
position p;
@@
 const enum dss_clk_source cocci_id@p [ ] ;
...
position p;
@@
 struct dss_debugfs_entry * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct seq_file * s , void * data ) ;
...
position p;
@@
 const enum omap_dss_output_id cocci_id@p [ ] ;
...
position p;
@@
 struct dss_debugfs_entry {  struct dentry * dentry ;  int ( * show_fn ) ( struct seq_file * s , void * data ) ;  void * data ; } cocci_id@p ;
...
position p;
@@
 const struct dss_ops cocci_id@p ;
...
position p;
@@
 struct dss_ops {  int ( * dpi_select_source ) ( struct dss_device * dss , int port , enum omap_channel channel ) ;  int ( * select_lcd_source ) ( struct dss_device * dss , enum omap_channel channel , enum dss_clk_source clk_src ) ; } cocci_id@p ;
