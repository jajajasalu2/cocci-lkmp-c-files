...
position p;
@@
 const struct qlink_event_scan_complete * cocci_id@p ;
...
position p;
@@
 const struct qlink_event * cocci_id@p ;
...
position p;
@@
 enum cfg80211_bss_frame_type cocci_id@p ;
...
position p;
@@
 const struct qlink_tlv_ie_set * cocci_id@p ;
...
position p;
@@
 const struct qlink_event_mic_failure * cocci_id@p ;
...
position p;
@@
 const struct qlink_event_rxmgmt * cocci_id@p ;
...
position p;
@@
 struct qlink_event_bss_leave cocci_id@p ;
...
position p;
@@
 const struct qlink_event_scan_result * cocci_id@p ;
...
position p;
@@
 struct qlink_event_sta_deauth cocci_id@p ;
...
position p;
@@
 struct qlink_event_mic_failure cocci_id@p ;
...
position p;
@@
 struct qlink_event_bss_join cocci_id@p ;
...
position p;
@@
 const struct qlink_event_radar * cocci_id@p ;
...
position p;
@@
 const struct qlink_event_sta_deauth * cocci_id@p ;
...
position p;
@@
 const struct qlink_event_bss_leave * cocci_id@p ;
...
position p;
@@
 const struct qlink_event_bss_join * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_hdr_3addr * cocci_id@p ;
...
position p;
@@
 const struct qlink_event_sta_assoc * cocci_id@p ;
...
position p;
@@
 const struct qlink_event_external_auth * cocci_id@p ;
...
position p;
@@
 const struct qlink_event_freq_change * cocci_id@p ;
...
position p;
@@
 enum nl80211_rxmgmt_flags cocci_id@p ;
...
position p;
@@
 enum ieee80211_statuscode cocci_id@p ;
