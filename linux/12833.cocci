...
typedef bool;
@@
 struct ccf_info {  enum ccf_version version ;  int err_reg_offs ;  bool has_brr ; } cocci_id@p ;
...
position p;
@@
 enum ccf_version { CCF1 , CCF2 , } cocci_id@p ;
...
typedef bool;
@@
 struct ccf_private {  const struct ccf_info * info ;  struct device * dev ;  void __iomem * regs ;  struct ccf_err_regs __iomem * err_regs ;  bool t1040 ; } cocci_id@p ;
...
typedef u32;
@@
 struct ccf_err_regs {  u32 errdet ;  u32 errdis ;  u32 errinten ;  u32 cecar ;  u32 cecaddrh ;  u32 cecaddrl ;  u32 cecar2 ; } cocci_id@p ;
...
position p;
@@
 const struct ccf_info cocci_id@p ;
