...
position p;
@@
 struct syscall_metadata * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef syscall_tp_t;
@@
 struct syscall_tp_t {  unsigned long long regs ;  unsigned long syscall_nr ;  unsigned long ret ; } cocci_id@p ;
...
position p;
@@
 struct syscall_trace_exit cocci_id@p ;
...
position p;
@@
 struct syscall_trace_enter * cocci_id@p ;
...
typedef syscall_tp_t;
@@
 struct syscall_tp_t {  unsigned long long regs ;  unsigned long syscall_nr ;  unsigned long args [ SYSCALL_DEFINE_MAXARGS ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct trace_event_call * event , enum trace_reg type , void * data ) ;
