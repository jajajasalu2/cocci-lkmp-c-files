...
position p;
@@
 struct resource_node cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct bus_node * , struct resource_node * , struct resource_node * , struct resource_node * , u8 ) ;
...
typedef u8;
@@
 u8 cocci_id@p ( u8 primary_busno , u8 slotno ) ;
...
position p;
@@
 struct resource_node * cocci_id@p [ 6 ] ;
...
position p;
@@
 struct resource_node * cocci_id@p [ 2 ] ;
...
typedef u8;
@@
 int cocci_id@p ( struct pci_func * * , u8 ) ;
...
typedef u8;
@@
 struct res_needed * cocci_id@p ( struct pci_func * , u8 ) ;
...
position p;
@@
 int cocci_id@p ( struct pci_func * ) ;
