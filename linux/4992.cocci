...
position p;
@@
 void cocci_id@p ( struct i40iw_hw * hw , struct i40iw_chunk * chunk ) ;
...
position p;
@@
 enum i40iw_status_code cocci_id@p ( struct i40iw_sc_dev * dev , struct i40iw_hmc_pble_rsrc * pble_rsrc ) ;
...
position p;
@@
 struct i40iw_add_page_info * cocci_id@p ;
...
position p;
@@
 enum i40iw_sd_entry_type cocci_id@p ;
...
position p;
@@
 struct i40iw_pble_pool * cocci_id@p ;
...
position p;
@@
 struct i40iw_hmc_pd_entry * cocci_id@p ;
