...
symbol cocci_id;
position p;
typedef apei_exec_ins_func_t;
@@
 apei_exec_ins_func_t cocci_id@p ;
...
position p;
@@
 struct apei_res {  struct list_head list ;  unsigned long start ;  unsigned long end ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct apei_exec_context * ctx , struct acpi_whea_header * entry , void * data ) ;
...
symbol cocci_id;
position p;
typedef apei_exec_entry_func_t;
@@
 apei_exec_entry_func_t cocci_id@p ;
...
typedef __u64;
@@
 int ( * cocci_id@p ) ( int ( * func ) ( __u64 start , __u64 size , void * data ) , void * data ) ;
