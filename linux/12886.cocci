...
position p;
@@
 struct edacdev_attribute cocci_id@p ;
...
position p;
@@
 struct ctl_info_attribute * cocci_id@p ;
...
position p;
@@
 struct instance_attribute * cocci_id@p ;
...
position p;
@@
 struct edac_device_instance * cocci_id@p ;
...
position p;
@@
 struct edac_dev_sysfs_block_attribute cocci_id@p ;
...
position p;
@@
 struct edac_device_block cocci_id@p ;
...
position p;
@@
 struct edac_dev_sysfs_attribute * cocci_id@p ;
