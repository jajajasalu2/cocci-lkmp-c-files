...
position p;
@@
 struct ipoib_mcast_iter * cocci_id@p ;
...
position p;
@@
 struct ipoib_mcast_iter {  struct net_device * dev ;  union ib_gid mgid ;  unsigned long created ;  unsigned int queuelen ;  unsigned int complete ;  unsigned int send_only ; } cocci_id@p ;
