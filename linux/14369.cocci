...
position p;
@@
 struct lgs8gl5_state {  struct i2c_adapter * i2c ;  const struct lgs8gl5_config * config ;  struct dvb_frontend frontend ; } cocci_id@p ;
...
position p;
@@
 const struct lgs8gl5_config * cocci_id@p ;
...
position p;
@@
 struct lgs8gl5_state * cocci_id@p ;
