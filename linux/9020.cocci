...
typedef bool;
@@
 int cocci_id@p ( struct pci_dev * pdev , bool reload , struct devlink * devlink ) ;
...
position p;
@@
 enum { MLX4_DEV_CAP_CHECK_NUM_VFS_ABOVE_64 = - 1 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_func_cap * cocci_id@p ;
...
position p;
@@
 struct mlx4_steer_index * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ MLX4_MAX_PORTS + 1 ] [ MLX4_MAX_PORTS + 1 ] ;
...
position p;
@@
 struct mlx4_dev_cap * cocci_id@p ;
...
position p;
@@
 const struct mlx4_profile cocci_id@p ;
...
position p;
@@
 struct mlx4_port_config {  struct list_head list ;  enum mlx4_port_type port_type [ MLX4_MAX_PORTS + 1 ] ;  struct pci_dev * pdev ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_config_dev_params cocci_id@p ;
...
position p;
@@
 struct mlx4_port_info * cocci_id@p ;
...
position p;
@@
 struct mlx4_init_hca_param cocci_id@p ;
...
position p;
@@
 struct mlx4_fw_crdump * cocci_id@p ;
...
position p;
@@
 struct mlx4_port_cap cocci_id@p ;
...
position p;
@@
 enum mlx4_port_type cocci_id@p ;
...
position p;
@@
 enum mlx4_devlink_param_id { MLX4_DEVLINK_PARAM_ID_BASE = DEVLINK_PARAM_GENERIC_ID_MAX , MLX4_DEVLINK_PARAM_ID_ENABLE_64B_CQE_EQE , MLX4_DEVLINK_PARAM_ID_ENABLE_4K_UAR , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MLX4_MAX_PORTS + 1 ] ;
...
position p;
@@
 struct mlx4_port_map * cocci_id@p ;
...
position p;
@@
 enum mlx4_port_type cocci_id@p [ MLX4_MAX_PORTS ] ;
...
position p;
@@
 struct mlx4_dev_persistent * cocci_id@p ;
...
position p;
@@
 struct mlx4_adapter cocci_id@p ;
...
position p;
@@
 enum ibta_mtu { IB_MTU_256 = 1 , IB_MTU_512 = 2 , IB_MTU_1024 = 3 , IB_MTU_2048 = 4 , IB_MTU_4096 = 5 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_profile cocci_id@p ;
...
position p;
@@
 struct mlx4_mod_stat_cfg cocci_id@p ;
...
position p;
@@
 struct mlx4_promisc_qp * cocci_id@p ;
...
position p;
@@
 enum { MLX4_QUERY_FUNC_NUM_SYS_EQS = 1 << 0 , } cocci_id@p ;
