...
typedef bool;
@@
 struct synusb {  struct usb_device * udev ;  struct usb_interface * intf ;  struct urb * urb ;  unsigned char * data ;  struct mutex pm_mutex ;  bool is_open ;  struct input_dev * input ;  char name [ 128 ] ;  char phys [ 64 ] ;  unsigned long flags ; } cocci_id@p ;
