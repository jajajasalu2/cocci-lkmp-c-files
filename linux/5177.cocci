...
position p;
@@
 const struct {  const char * name ;  unsigned char flags ; } cocci_id@p [ ] ;
...
typedef bool;
@@
 struct gpiod_data {  struct gpio_desc * desc ;  struct mutex mutex ;  struct kernfs_node * value_kn ;  int irq ;  unsigned char irq_flags ;  bool direction_can_change ; } cocci_id@p ;
