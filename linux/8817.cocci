...
position p;
@@
 struct stmmac_pci_dmi_data {  const struct stmmac_pci_func_data * func ;  size_t nfuncs ; } cocci_id@p ;
...
position p;
@@
 const struct stmmac_pci_dmi_data * cocci_id@p ;
...
position p;
@@
 const struct stmmac_pci_func_data cocci_id@p [ ] ;
...
position p;
@@
 struct stmmac_pci_func_data {  unsigned int func ;  int phy_addr ; } cocci_id@p ;
...
position p;
@@
 struct stmmac_pci_info cocci_id@p ;
...
position p;
@@
 const struct stmmac_pci_info cocci_id@p ;
...
position p;
@@
 struct stmmac_pci_info {  int ( * setup ) ( struct pci_dev * pdev , struct plat_stmmacenet_data * plat ) ; } cocci_id@p ;
