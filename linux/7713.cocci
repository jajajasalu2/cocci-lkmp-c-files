...
position p;
@@
 struct rp2_uart_port * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct rp2_card {  struct pci_dev * pdev ;  struct rp2_uart_port * ports ;  int n_ports ;  int initialized_ports ;  int minor_start ;  int smpte ;  void __iomem * bar0 ;  void __iomem * bar1 ;  spinlock_t card_lock ;  struct completion fw_loaded ; } cocci_id@p ;
...
position p;
@@
 struct rp2_uart_port {  struct uart_port port ;  int idx ;  int ignore_rx ;  struct rp2_card * card ;  void __iomem * asic_base ;  void __iomem * base ;  void __iomem * ucode ; } cocci_id@p ;
