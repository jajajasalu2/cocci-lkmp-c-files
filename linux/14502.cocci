...
position p;
@@
 const struct i2s_pll_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct i2s_pll_clk {  void __iomem * base ;  struct clk_hw hw ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct i2s_pll_cfg {  unsigned int rate ;  unsigned int idiv ;  unsigned int fbdiv ;  unsigned int odiv0 ;  unsigned int odiv1 ; } cocci_id@p ;
