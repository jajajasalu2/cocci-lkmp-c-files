...
position p;
@@
 const struct cyapa_pip_report_data * cocci_id@p ;
...
position p;
@@
 struct pip_bl_packet_start cocci_id@p ;
...
position p;
@@
 struct cyapa_pip_report_data cocci_id@p ;
...
position p;
@@
 struct cyapa_tsg_bin_image_head * cocci_id@p ;
...
position p;
@@
 const struct cyapa_tsg_bin_image_data_record * cocci_id@p ;
...
position p;
@@
 struct pip_bl_initiate_cmd_data * cocci_id@p ;
...
position p;
@@
 enum cyapa_pm_stage cocci_id@p ;
...
position p;
@@
 struct gen5_app_get_parameter_data cocci_id@p ;
...
position p;
@@
 struct pip_bl_cmd_head cocci_id@p ;
...
position p;
@@
 struct tsg_bl_flash_row_head cocci_id@p ;
...
position p;
@@
 const struct cyapa_dev_ops cocci_id@p ;
...
position p;
@@
 struct gen5_app_set_parameter_data cocci_id@p ;
...
position p;
@@
 struct cyapa_tsg_bin_image_data_record * cocci_id@p ;
...
position p;
@@
 struct pip_bl_packet_end cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cyapa * cyapa , struct cyapa_pip_report_data * report_data ) ;
...
position p;
@@
 struct gen5_retrieve_panel_scan_data * cocci_id@p ;
...
position p;
@@
 struct pip_app_cmd_head cocci_id@p ;
...
position p;
@@
 const struct tsg_bl_metadata_row_params * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ PIP_HID_DESCRIPTOR_SIZE ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ PIP_BL_APP_INFO_RESP_LENGTH ] ;
...
position p;
@@
 const struct cyapa_pip_touch_record * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ PIP_READ_SYS_INFO_RESP_LENGTH ] ;
...
position p;
@@
 struct cyapa_pip_cmd_states * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CYAPA_TSG_MAX_CMD_SIZE ] ;
