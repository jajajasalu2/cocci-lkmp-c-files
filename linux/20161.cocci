...
position p;
@@
 struct dma_chan cocci_id@p [ NUM_AU1000_DMA_CHANNELS ] ;
...
position p;
@@
 const struct dma_dev * cocci_id@p ;
...
position p;
@@
 const struct dma_dev {  unsigned int fifo_addr ;  unsigned int dma_mode ; } cocci_id@p [ DMA_NUM_DEV ] ;
...
position p;
@@
 const struct dma_dev cocci_id@p [ DMA_NUM_DEV_BANK2 ] ;
