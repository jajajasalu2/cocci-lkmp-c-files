...
position p;
@@
 struct sensor_group * cocci_id@p ;
...
typedef u32;
@@
 struct sg_attr {  u32 handle ;  struct kobj_attribute attr ; } cocci_id@p ;
...
position p;
@@
 struct sensor_group {  char name [ 20 ] ;  struct attribute_group sg ;  struct sg_attr * sgattrs ; } * cocci_id@p ;
