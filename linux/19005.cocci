...
position p;
@@
 struct mvebu_system_controller * cocci_id@p ;
...
typedef u32;
@@
 struct mvebu_system_controller {  u32 rstoutn_mask_offset ;  u32 system_soft_reset_offset ;  u32 rstoutn_mask_reset_out_en ;  u32 system_soft_reset ;  u32 resume_boot_addr ;  u32 dev_id ;  u32 rev_id ; } cocci_id@p ;
...
position p;
@@
 const struct mvebu_system_controller cocci_id@p ;
