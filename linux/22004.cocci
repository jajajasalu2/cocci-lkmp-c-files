...
position p;
@@
 struct bcstat {  int rfail ;  int rsuccess ;  int noncw ;  int nwords ; } cocci_id@p ;
...
position p;
@@
 struct estat {  int dwrong ;  int irv ;  int wepos ;  int nwords ; } cocci_id@p ;
...
typedef uint16_t;
@@
 struct wspace {  uint16_t * c ;  uint16_t * r ;  uint16_t * s ;  uint16_t * corr ;  int * errlocs ;  int * derrlocs ; } cocci_id@p ;
...
position p;
@@
 enum method { CORR_BUFFER , CALLER_SYNDROME , IN_PLACE , } cocci_id@p ;
...
position p;
@@
 enum verbosity { V_SILENT , V_PROGRESS , V_CSUMMARY , } cocci_id@p ;
...
position p;
@@
 struct pad {  int mult ;  int shift ; } cocci_id@p ;
...
position p;
@@
 struct etab {  int symsize ;  int genpoly ;  int fcs ;  int prim ;  int nroots ;  int ntrials ; } cocci_id@p ;
