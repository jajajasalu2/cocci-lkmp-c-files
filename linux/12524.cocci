...
typedef bool;
@@
 struct sti_hda {  struct device dev ;  struct drm_device * drm_dev ;  struct drm_display_mode mode ;  void __iomem * regs ;  void __iomem * video_dacs_ctrl ;  struct clk * clk_pix ;  struct clk * clk_hddac ;  bool enabled ; } cocci_id@p ;
...
position p;
@@
 struct sti_hda_connector * cocci_id@p ;
...
typedef u32;
@@
 struct sti_hda_video_config {  struct drm_display_mode mode ;  u32 * awg_instr ;  int nb_instr ;  enum sti_hda_vid_cat vid_cat ; } cocci_id@p ;
...
position p;
@@
 enum sti_hda_vid_cat { VID_SD , VID_ED , VID_HD_74M , VID_HD_148M , } cocci_id@p ;
...
position p;
@@
 const struct sti_hda_video_config cocci_id@p [ ] ;
...
position p;
@@
 struct sti_hda_connector {  struct drm_connector drm_connector ;  struct drm_encoder * encoder ;  struct sti_hda * hda ; } cocci_id@p ;
