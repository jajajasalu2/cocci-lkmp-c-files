...
position p;
@@
 int cocci_id@p ( struct enetc_bdr * tx_ring , struct sk_buff * skb , int active_offloads ) ;
...
position p;
@@
 struct enetc_tx_swbd cocci_id@p ;
...
position p;
@@
 struct enetc_rx_swbd * cocci_id@p ;
...
position p;
@@
 struct enetc_ndev_priv * cocci_id@p ;
...
position p;
@@
 struct enetc_int_vector cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct enetc_bdr * rx_ring , struct napi_struct * napi , int work_limit ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct enetc_bdr * tx_ring , int napi_budget ) ;
