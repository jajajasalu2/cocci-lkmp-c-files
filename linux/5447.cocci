...
position p;
@@
 enum { state_init , state_command_prepare , state_write , state_read , state_disable_cs , state_end , } cocci_id@p ;
...
typedef u32;
@@
 struct falcon_sflash {  u32 sfcmd ;  struct spi_master * master ; } cocci_id@p ;
...
position p;
@@
 struct falcon_sflash * cocci_id@p ;
