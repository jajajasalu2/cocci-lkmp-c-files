...
typedef bool;
@@
 struct mce_derror_table {  unsigned long dsisr_value ;  bool dar_valid ;  unsigned int error_type ;  unsigned int error_subtype ;  unsigned int error_class ;  unsigned int initiator ;  unsigned int severity ;  bool sync_error ; } cocci_id@p ;
...
position p;
@@
 const struct mce_ierror_table cocci_id@p [ ] ;
...
position p;
@@
 struct mce_error_info * cocci_id@p ;
...
typedef bool;
@@
 struct mce_ierror_table {  unsigned long srr1_mask ;  unsigned long srr1_value ;  bool nip_valid ;  unsigned int error_type ;  unsigned int error_subtype ;  unsigned int error_class ;  unsigned int initiator ;  unsigned int severity ;  bool sync_error ; } cocci_id@p ;
...
position p;
@@
 const struct mce_derror_table cocci_id@p [ ] ;
