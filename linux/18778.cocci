...
position p;
@@
 struct i2c_pxa_platform_data cocci_id@p ;
...
position p;
@@
 struct pxamci_platform_data cocci_id@p ;
...
position p;
@@
 struct ads7846_platform_data cocci_id@p ;
...
position p;
@@
 struct pasic3_platform_data cocci_id@p ;
...
position p;
@@
 struct pxafb_mach_info cocci_id@p ;
...
position p;
@@
 struct pxafb_mode_info cocci_id@p [ ] ;
...
position p;
@@
 struct pxaohci_platform_data cocci_id@p ;
