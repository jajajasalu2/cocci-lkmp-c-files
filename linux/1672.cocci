...
position p;
@@
 enum mmc35240_axis { AXIS_X = 0 , AXIS_Y , AXIS_Z , } cocci_id@p ;
...
position p;
@@
 enum mmc35240_resolution { MMC35240_16_BITS_SLOW = 0 , MMC35240_16_BITS_FAST , MMC35240_14_BITS , MMC35240_12_BITS , } cocci_id@p ;
...
position p;
@@
 struct mmc35240_data * cocci_id@p ;
...
position p;
@@
 struct mmc35240_data {  struct i2c_client * client ;  struct mutex mutex ;  struct regmap * regmap ;  enum mmc35240_resolution res ;  int axis_coef [ 3 ] ;  int axis_scale [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 const struct {  int sens [ 3 ] ;  int nfo ; } cocci_id@p [ ] ;
