...
typedef __u64;
@@
 void cocci_id@p ( int , char * , __u64 * * ) ;
...
position p;
@@
 struct dev_mask_info_s cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ORANGEFS_MAX_DEBUG_STRING_LEN ] ;
...
position p;
@@
 struct client_debug_mask * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int , char * , struct client_debug_mask * * ) ;
...
typedef __u64;
@@
 struct client_debug_mask {  char * keyword ;  __u64 mask1 ;  __u64 mask2 ; } cocci_id@p ;
...
position p;
@@
 struct dev_mask2_info_s cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * , void * ) ;
