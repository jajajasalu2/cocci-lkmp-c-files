...
position p;
@@
 struct nvme_create_cq cocci_id@p ;
...
position p;
@@
 struct nvme_create_sq cocci_id@p ;
...
position p;
@@
 volatile struct nvme_completion * cocci_id@p ;
...
typedef u8,bool;
@@
 bool cocci_id@p ( struct nvme_dev * dev , u8 opcode ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct nvme_dev * dev , bool shutdown ) ;
...
position p;
@@
 struct nvme_delete_queue cocci_id@p ;
...
position p;
@@
 struct nvme_host_mem_buf_desc * cocci_id@p ;
...
@@
 struct nvme_iod {  struct nvme_request req ;  struct nvme_queue * nvmeq ;  bool use_sgl ;  int aborted ;  int npages ;  int nents ;  dma_addr_t first_dma ;  unsigned int dma_len ;  dma_addr_t meta_dma ;  struct scatterlist * sg ; } cocci_id@p ;
