...
position p;
@@
 enum svc_wakedetect_state cocci_id@p ;
...
position p;
@@
 enum svc_wakedetect_state { WD_STATE_IDLE , WD_STATE_BOOT_INIT , WD_STATE_COLDBOOT_TRIG , WD_STATE_STANDBYBOOT_TRIG , WD_STATE_COLDBOOT_START , WD_STATE_STANDBYBOOT_START , } cocci_id@p ;
...
@@
 struct arche_platform_drvdata {  struct gpio_desc * svc_reset ;  bool is_reset_act_hi ;  struct gpio_desc * svc_sysboot ;  struct gpio_desc * wake_detect ;  enum arche_platform_state state ;  struct gpio_desc * svc_refclk_req ;  struct clk * svc_ref_clk ;  struct pinctrl * pinctrl ;  struct pinctrl_state * pin_default ;  int num_apbs ;  enum svc_wakedetect_state wake_detect_state ;  int wake_detect_irq ;  spinlock_t wake_lock ;  struct mutex platform_state_mutex ;  unsigned long wake_detect_start ;  struct notifier_block pm_notifier ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct arche_platform_drvdata cocci_id@p ;
...
position p;
@@
 enum arche_platform_state cocci_id@p ;
