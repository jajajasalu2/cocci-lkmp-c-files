...
position p;
@@
 const struct nfs4_ff_layout_ds_err * cocci_id@p ;
...
position p;
@@
 struct nfs4_ff_layout_ds * cocci_id@p ;
...
position p;
@@
 struct nfs4_ff_layoutstat * cocci_id@p ;
...
position p;
@@
 const struct nfs4_xdr_opaque_data * cocci_id@p ;
...
position p;
@@
 struct nfs42_layoutstat_args * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ RPCBIND_MAXUADDRLEN ] ;
...
position p;
@@
 struct nfs4_xdr_opaque_data * cocci_id@p ;
...
position p;
@@
 struct pnfs_layoutdriver_type cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pnfs_layout_hdr * lo , struct nfs42_layoutstat_devinfo * devinfo , int dev_limit ) ;
...
position p;
@@
 struct nfs4_ff_layout_ds_err * cocci_id@p ;
...
position p;
@@
 struct pnfs_ds_commit_info * cocci_id@p ;
...
position p;
@@
 struct nfs42_layoutstat_devinfo cocci_id@p ;
...
position p;
@@
 const struct nfs42_layoutstat_devinfo * cocci_id@p ;
...
position p;
@@
 const struct nfs4_ff_layout_mirror * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ RPCBIND_MAXUADDRPLEN ] ;
...
position p;
@@
 struct nfs_pageio_descriptor * cocci_id@p ;
...
position p;
@@
 struct nfs4_layoutreturn_args * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xdr_stream * xdr , const struct nfs42_layoutstat_devinfo * devinfo , struct nfs4_ff_layout_mirror * mirror ) ;
...
position p;
@@
 struct pnfs_commit_bucket cocci_id@p ;
...
position p;
@@
 const struct nfs_pageio_ops cocci_id@p ;
...
position p;
@@
 struct nfs4_pnfs_ds_addr * cocci_id@p ;
...
position p;
@@
 enum pnfs_try_status cocci_id@p ;
...
position p;
@@
 struct nfs4_flexfile_layoutreturn_args * cocci_id@p ;
...
position p;
@@
 const struct nfs4_xdr_opaque_ops cocci_id@p ;
...
position p;
@@
 const struct nfs4_flexfile_layoutreturn_args * cocci_id@p ;
...
position p;
@@
 struct nfs4_deviceid * cocci_id@p ;
...
position p;
@@
 enum nfs3_stable_how cocci_id@p ;
...
position p;
@@
 struct nfs4_deviceid_node * cocci_id@p ;
...
position p;
@@
 struct nfs4_pnfs_ds * cocci_id@p ;
...
position p;
@@
 struct nfs4_ff_busy_timer * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rpc_task * task , struct nfs_pgio_header * hdr ) ;
...
position p;
@@
 struct nfs4_ff_io_stat * cocci_id@p ;
...
position p;
@@
 struct nfs_pgio_mirror * cocci_id@p ;
...
position p;
@@
 struct nfs_commit_info * cocci_id@p ;
...
position p;
@@
 struct nfs4_ff_layout_segment * cocci_id@p ;
...
position p;
@@
 struct nfs4_ff_layout_mirror * cocci_id@p ;
...
position p;
@@
 struct nfs4_flexfile_layout * cocci_id@p ;
...
position p;
@@
 const struct pnfs_layout_range * cocci_id@p ;
...
position p;
@@
 struct nfs42_layout_error * cocci_id@p ;
