...
position p;
@@
 struct as10x_tune_status cocci_id@p ;
...
@@
 struct as102_state {  struct dvb_frontend frontend ;  struct as10x_demod_stats demod_stats ;  const struct as102_fe_ops * ops ;  void * priv ;  uint8_t elna_cfg ;  uint16_t signal_strength ;  uint32_t ber ; } cocci_id@p ;
...
position p;
@@
 struct as10x_tune_args cocci_id@p ;
...
position p;
@@
 const struct as102_fe_ops * cocci_id@p ;
