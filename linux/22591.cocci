...
position p;
@@
 struct dsp_spdifoscb cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_cs46xx * chip , struct dsp_scb_descriptor * fg_entry ) ;
...
position p;
@@
 struct dsp_mix2_ostream_spb cocci_id@p ;
...
position p;
@@
 struct dsp_async_codec_input_scb cocci_id@p ;
...
position p;
@@
 struct dsp_task_tree_control_block cocci_id@p ;
...
position p;
@@
 struct dsp_spdifiscb cocci_id@p ;
...
position p;
@@
 struct dsp_task_descriptor * cocci_id@p ;
...
position p;
@@
 struct dsp_spos_control_block cocci_id@p ;
