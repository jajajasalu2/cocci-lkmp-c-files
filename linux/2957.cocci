...
position p;
@@
 struct acpi_object_info * cocci_id@p ;
...
position p;
@@
 struct acpi_region_walk_info cocci_id@p ;
...
position p;
@@
 struct acpi_integrity_info * cocci_id@p ;
...
position p;
@@
 struct acpi_walk_info * cocci_id@p ;
