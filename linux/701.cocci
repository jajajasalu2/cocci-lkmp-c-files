...
position p;
@@
 struct switchtec_ioctl_flash_part_info cocci_id@p ;
...
position p;
@@
 struct switchtec_user * cocci_id@p ;
...
position p;
@@
 struct switchtec_ioctl_event_ctl * cocci_id@p ;
...
position p;
@@
 struct switchtec_ioctl_pff_port cocci_id@p ;
...
position p;
@@
 struct switchtec_ioctl_event_summary cocci_id@p ;
...
position p;
@@
 struct switchtec_ioctl_event_summary_legacy cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct switchtec_dev * stdev ) ;
...
position p;
@@
 enum mrpc_state { MRPC_IDLE = 0 , MRPC_QUEUED , MRPC_RUNNING , MRPC_DONE , } cocci_id@p ;
...
position p;
@@
 struct part_cfg_regs * cocci_id@p ;
...
position p;
@@
 struct switchtec_ioctl_flash_info cocci_id@p ;
...
typedef u32;
@@
 struct switchtec_user {  struct switchtec_dev * stdev ;  enum mrpc_state state ;  struct completion comp ;  struct kref kref ;  struct list_head list ;  u32 cmd ;  u32 status ;  u32 return_code ;  size_t data_len ;  size_t read_len ;  unsigned char data [ SWITCHTEC_MRPC_PAYLOAD_SIZE ] ;  int event_cnt ; } cocci_id@p ;
