...
position p;
@@
 struct gb_svc_intf_refclk_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_deferred_request {  struct work_struct work ;  struct gb_operation * operation ; } cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_vsys_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_unipro_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_activate_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_route_destroy_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_set_pwrm_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_version_response * cocci_id@p ;
...
position p;
@@
 struct gb_interface * cocci_id@p ;
...
position p;
@@
 struct gb_svc_l2_timer_cfg * cocci_id@p ;
...
position p;
@@
 struct gb_svc_module_removed_request * cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_unipro_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_resume_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_set_pwrm_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_pwrmon_sample_get_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_pwrmon_intf_sample_get_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_eject_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_oops_request * cocci_id@p ;
...
position p;
@@
 struct gb_svc_dme_peer_set_response cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gb_operation * operation ) ;
...
position p;
@@
 struct gb_svc_dme_peer_get_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_dme_peer_get_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_reset_request * cocci_id@p ;
...
position p;
@@
 struct gb_svc_deferred_request cocci_id@p ;
...
position p;
@@
 struct gb_host_device * cocci_id@p ;
...
position p;
@@
 struct gb_svc_conn_destroy_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_activate_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_device_id_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_pwrmon_rail_names_get_response * cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_refclk_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_vsys_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_pwrmon_intf_sample_get_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_pwrmon_rail_count_get_response cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_resume_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_version_request * cocci_id@p ;
...
position p;
@@
 struct svc_debugfs_pwrmon_rail * cocci_id@p ;
...
position p;
@@
 struct gb_svc_dme_peer_set_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_intf_mailbox_event_request * cocci_id@p ;
...
position p;
@@
 struct gb_svc_hello_request * cocci_id@p ;
...
position p;
@@
 struct gb_svc_route_create_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_module_inserted_request * cocci_id@p ;
...
position p;
@@
 struct gb_svc_pwrmon_sample_get_request cocci_id@p ;
...
position p;
@@
 struct gb_svc_conn_create_request cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ GB_SVC_PWRMON_RAIL_NAME_BUFSIZE ] ;
