...
typedef bool;
@@
 const bool cocci_id@p [ IP_VS_TCP_S_LAST ] ;
...
position p;
@@
 const int cocci_id@p [ IP_VS_TCP_S_LAST + 1 ] ;
...
symbol cocci_id;
position p;
typedef tcp_states_t;
@@
 struct tcp_states_t {  int next_state [ IP_VS_TCP_S_LAST ] ; } cocci_id@p ;
...
typedef tcp_states_t;
@@
 struct tcp_states_t cocci_id@p [ ] ;
...
position p;
@@
 const char * const cocci_id@p [ IP_VS_TCP_S_LAST + 1 ] ;
...
position p;
@@
 const int cocci_id@p [ IP_VS_DIR_LAST ] ;
