...
position p;
@@
 struct nfsd42_write_res * cocci_id@p ;
...
position p;
@@
 struct nfsd4_change_info * cocci_id@p ;
...
position p;
@@
 struct nfsd4_offload_status * cocci_id@p ;
...
position p;
@@
 struct rpcsec_gss_info cocci_id@p ;
...
position p;
@@
 struct exp_flavor_info cocci_id@p [ 2 ] ;
...
position p;
@@
 struct nfsd4_layoutcommit * cocci_id@p ;
...
position p;
@@
 struct nfsd4_create * cocci_id@p ;
...
position p;
@@
 struct nfsd4_secinfo * cocci_id@p ;
...
position p;
@@
 struct exp_flavor_info * cocci_id@p ;
...
position p;
@@
 struct nfsd4_layoutreturn * cocci_id@p ;
...
position p;
@@
 struct nfsd4_lookup * cocci_id@p ;
...
position p;
@@
 struct nfsd4_remove * cocci_id@p ;
...
position p;
@@
 const struct nfsd4_layout_ops * cocci_id@p ;
...
position p;
@@
 struct nfsd4_secinfo_no_name * cocci_id@p ;
...
position p;
@@
 struct nfsd4_destroy_session * cocci_id@p ;
...
position p;
@@
 __be32 ( * cocci_id@p ) ( struct nfsd4_compoundres * , __be32 , void * ) ;
...
position p;
@@
 struct nfsd4_layoutget * cocci_id@p ;
...
position p;
@@
 struct nfsd4_getattr * cocci_id@p ;
...
position p;
@@
 struct svcxdr_tmpbuf * cocci_id@p ;
...
position p;
@@
 struct nfsd4_readdir cocci_id@p ;
...
position p;
@@
 struct nfsd4_fallocate * cocci_id@p ;
...
position p;
@@
 struct nfsd4_fs_location * cocci_id@p ;
...
position p;
@@
 struct nfsd4_readlink * cocci_id@p ;
...
position p;
@@
 const struct nfsd4_operation * cocci_id@p ;
...
position p;
@@
 __be32 ( * cocci_id@p ) ( struct nfsd4_compoundargs * argp , void * ) ;
...
position p;
@@
 struct nfsd4_getdeviceinfo * cocci_id@p ;
...
position p;
@@
 struct nfsd4_fs_locations * cocci_id@p ;
...
position p;
@@
 struct user_namespace * cocci_id@p ;
...
position p;
@@
 struct nfsd4_setattr * cocci_id@p ;
...
position p;
@@
 struct nfsd4_commit * cocci_id@p ;
...
position p;
@@
 struct nfsd4_rename * cocci_id@p ;
...
position p;
@@
 struct nfsd4_access * cocci_id@p ;
