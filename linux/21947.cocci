...
position p;
@@
 struct kunit_resource * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kunit_resource_match_t;
@@
 kunit_resource_match_t cocci_id@p ;
...
position p;
@@
 struct kunit_try_catch * cocci_id@p ;
...
position p;
@@
 struct kunit_assert * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kunit_resource_free_t;
@@
 kunit_resource_free_t cocci_id@p ;
...
position p;
@@
 struct kunit_kmalloc_params cocci_id@p ;
...
position p;
@@
 struct kunit_try_catch_context cocci_id@p ;
...
position p;
@@
 struct string_stream_fragment * cocci_id@p ;
...
position p;
@@
 struct kunit_try_catch_context {  struct kunit * test ;  struct kunit_suite * suite ;  struct kunit_case * test_case ; } cocci_id@p ;
...
position p;
@@
 const struct kunit_case * cocci_id@p ;
...
typedef gfp_t;
@@
 struct kunit_kmalloc_params {  size_t size ;  gfp_t gfp ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kunit_resource_init_t;
@@
 kunit_resource_init_t cocci_id@p ;
...
position p;
@@
 struct string_stream * cocci_id@p ;
