...
position p;
@@
 struct sas_host_attrs * cocci_id@p ;
...
typedef u32;
@@
 struct sas_host_attrs {  struct list_head rphy_list ;  struct mutex lock ;  struct request_queue * q ;  u32 next_target_id ;  u32 next_expander_id ;  int next_port_id ; } cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 value ;  char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct sas_end_device * cocci_id@p ;
