...
position p;
@@
 struct netfront_rx_info cocci_id@p ;
...
position p;
@@
 struct netfront_queue * cocci_id@p ;
...
position p;
@@
 struct xen_netif_extra_info * cocci_id@p ;
...
position p;
@@
 struct xennet_gnttab_make_txreq {  struct netfront_queue * queue ;  struct sk_buff * skb ;  struct page * page ;  struct xen_netif_tx_request * tx ;  unsigned int size ; } cocci_id@p ;
...
typedef atomic_t;
@@
 struct netfront_info {  struct list_head list ;  struct net_device * netdev ;  struct xenbus_device * xbdev ;  struct netfront_queue * queues ;  struct netfront_stats __percpu * rx_stats ;  struct netfront_stats __percpu * tx_stats ;  atomic_t rx_gso_checksum_fixup ; } cocci_id@p ;
...
typedef u16;
@@
 const struct xennet_stat {  char name [ ETH_GSTRING_LEN ] ;  u16 offset ; } cocci_id@p [ ] ;
...
position p;
@@
 struct xen_netif_tx_response * cocci_id@p ;
...
position p;
@@
 struct netfront_rx_info {  struct xen_netif_rx_response rx ;  struct xen_netif_extra_info extras [ XEN_NETIF_EXTRA_TYPE_MAX - 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct netfront_cb {  int pull_to ; } cocci_id@p ;
...
position p;
@@
 struct xen_netif_rx_response * cocci_id@p ;
...
position p;
@@
 struct xen_netif_rx_sring * cocci_id@p ;
...
position p;
@@
 struct netfront_stats * cocci_id@p ;
...
position p;
@@
 struct xen_netif_tx_sring * cocci_id@p ;
...
position p;
@@
 struct netfront_info * cocci_id@p ;
...
position p;
@@
 struct xennet_gnttab_make_txreq cocci_id@p ;
...
position p;
@@
 const union skb_entry * cocci_id@p ;
...
position p;
@@
 struct xen_netif_rx_request * cocci_id@p ;
...
position p;
@@
 struct xen_netif_tx_request * cocci_id@p ;
...
typedef u64;
@@
 struct netfront_stats {  u64 packets ;  u64 bytes ;  struct u64_stats_sync syncp ; } cocci_id@p ;
