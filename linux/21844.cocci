...
typedef u32;
@@
 u32 cocci_id@p [ EXP1_IN_BITS / 32 ] ;
...
position p;
@@
 struct test_bitmap_parselist {  const int errno ;  const char * in ;  const unsigned long * expected ;  const int nbits ;  const int flags ; } cocci_id@p ;
