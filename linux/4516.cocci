...
position p;
@@
 struct vmci_host_dev cocci_id@p ;
...
position p;
@@
 enum { VMCI_NOTIFY_RESOURCE_ACTION_NOTIFY = 0 , VMCI_NOTIFY_RESOURCE_ACTION_CREATE = 1 , VMCI_NOTIFY_RESOURCE_ACTION_DESTROY = 2 , } cocci_id@p ;
...
position p;
@@
 struct vmci_qp_alloc_info cocci_id@p ;
...
position p;
@@
 struct vmci_qp_dtch_info cocci_id@p ;
...
typedef u64,s32,u32;
@@
 struct vmci_qp_alloc_info_vmvm {  struct vmci_handle handle ;  u32 peer ;  u32 flags ;  u64 produce_size ;  u64 consume_size ;  u64 produce_page_file ;  u64 consume_page_file ;  u64 produce_page_file_size ;  u64 consume_page_file_size ;  s32 result ;  u32 _pad ; } cocci_id@p ;
...
position p;
@@
 struct vmci_handle_arr * cocci_id@p ;
...
position p;
@@
 struct vmci_init_blk cocci_id@p ;
...
position p;
@@
 struct vmci_host_dev {  struct vmci_ctx * context ;  int user_version ;  enum vmci_obj_type ct_type ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct vmci_qp_alloc_info_vmvm cocci_id@p ;
...
position p;
@@
 struct vmci_set_notify_info cocci_id@p ;
...
position p;
@@
 struct vmci_datagram * cocci_id@p ;
...
typedef u32;
@@
 struct vmci_init_blk {  u32 cid ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 enum { VMCI_NOTIFY_RESOURCE_QUEUE_PAIR = 0 , VMCI_NOTIFY_RESOURCE_DOOR_BELL = 1 , } cocci_id@p ;
...
position p;
@@
 struct vmci_qp_set_va_info cocci_id@p ;
...
typedef u64,s32,u32;
@@
 struct vmci_set_notify_info {  u64 notify_uva ;  s32 result ;  u32 _pad ; } cocci_id@p ;
...
position p;
@@
 struct vmci_dbell_notify_resource_info cocci_id@p ;
...
position p;
@@
 struct vmci_ctx_notify_recv_info cocci_id@p ;
...
position p;
@@
 struct vmci_ctx_chkpt_buf_info cocci_id@p ;
...
position p;
@@
 struct vmci_ctx_info cocci_id@p ;
...
position p;
@@
 struct vmci_qp_page_file_info cocci_id@p ;
...
position p;
@@
 struct vmci_datagram_snd_rcv_info cocci_id@p ;
