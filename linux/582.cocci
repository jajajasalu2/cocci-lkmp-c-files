...
typedef u32;
@@
 u32 cocci_id@p [ ANUBIS_MAX_ROUNDS + 1 ] [ 4 ] ;
...
typedef u32;
@@
 struct anubis_ctx {  int key_len ;  int R ;  u32 E [ ANUBIS_MAX_ROUNDS + 1 ] [ 4 ] ;  u32 D [ ANUBIS_MAX_ROUNDS + 1 ] [ 4 ] ; } cocci_id@p ;
