...
typedef u8,u16;
@@
 struct ad7949_adc_chip {  struct mutex lock ;  struct regulator * vref ;  struct iio_dev * indio_dev ;  struct spi_device * spi ;  u8 resolution ;  u16 cfg ;  unsigned int current_channel ;  u16 buffer ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ad7949_adc_chip * cocci_id@p ;
...
position p;
@@
 const struct ad7949_adc_spec * cocci_id@p ;
...
position p;
@@
 enum { ID_AD7949 = 0 , ID_AD7682 , ID_AD7689 , } cocci_id@p ;
...
typedef u8;
@@
 struct ad7949_adc_spec {  u8 num_channels ;  u8 resolution ; } cocci_id@p ;
