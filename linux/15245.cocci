...
typedef bool,u32;
@@
 struct aat1290_led_config_data {  u32 max_mm_current ;  u32 max_flash_current ;  u32 max_flash_tm ;  bool has_external_strobe ;  enum led_brightness max_brightness ; } cocci_id@p ;
...
typedef bool;
@@
 struct aat1290_led {  struct platform_device * pdev ;  struct mutex lock ;  struct led_classdev_flash fled_cdev ;  struct v4l2_flash * v4l2_flash ;  struct gpio_desc * gpio_fl_en ;  struct gpio_desc * gpio_en_set ;  int * mm_current_scale ;  bool movie_mode ;  unsigned int torch_brightness ; } cocci_id@p ;
...
position p;
@@
 struct aat1290_led_config_data * cocci_id@p ;
...
position p;
@@
 struct led_init_data cocci_id@p ;
