...
symbol cocci_id;
position p;
typedef octeon_irq_ip4_handler_t;
@@
 octeon_irq_ip4_handler_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,octeon_ciu3_intsn2hw_t;
@@
 struct octeon_ciu3_info {  u64 ciu3_addr ;  int node ;  struct irq_domain * domain [ MAX_CIU3_DOMAINS ] ;  octeon_ciu3_intsn2hw_t intsn2hw [ MAX_CIU3_DOMAINS ] ; } cocci_id@p ;
...
position p;
@@
 struct octeon_irq_cib_host_data * cocci_id@p ;
...
position p;
@@
 union cvmx_ciu3_iscx_w1c cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,raw_spinlock_t;
@@
 struct octeon_irq_cib_host_data {  raw_spinlock_t lock ;  u64 raw_reg ;  u64 en_reg ;  int max_bits ; } cocci_id@p ;
...
position p;
@@
 struct octeon_ciu3_info * cocci_id@p ;
...
position p;
@@
 union cvmx_ciu3_iscx_w1s cocci_id@p ;
...
position p;
@@
 struct octeon_irq_cib_chip_data * cocci_id@p ;
...
position p;
@@
 union cvmx_ciu3_const cocci_id@p ;
...
typedef u8,u64;
@@
 struct octeon_ciu_chip_data {  union {  struct {  u64 ciu3_addr ;  unsigned int intsn ; } ;  struct {  u8 line ;  u8 bit ; } ; } ;  int gpio_line ;  int current_cpu ;  int ciu_node ; } cocci_id@p ;
...
position p;
@@
 union cvmx_gpio_bit_cfgx cocci_id@p ;
...
typedef u8,bool;
@@
 struct octeon_core_chip_data {  struct mutex core_irq_mutex ;  bool current_en ;  bool desired_en ;  u8 bit ; } cocci_id@p ;
...
position p;
@@
 struct octeon_irq_ciu_domain_data * cocci_id@p ;
...
position p;
@@
 union cvmx_ciu3_iscx_ctl cocci_id@p ;
...
position p;
@@
 struct octeon_irq_ciu_domain_data {  int num_sum ; } cocci_id@p ;
...
position p;
@@
 struct octeon_irq_cib_chip_data {  struct octeon_irq_cib_host_data * host_data ;  int bit ; } cocci_id@p ;
...
position p;
@@
 struct octeon_core_chip_data * cocci_id@p ;
...
position p;
@@
 union cvmx_ciu3_destx_pp_int cocci_id@p ;
...
position p;
@@
 struct octeon_irq_gpio_domain_data * cocci_id@p ;
...
position p;
@@
 struct octeon_irq_gpio_domain_data {  unsigned int base_hwirq ; } cocci_id@p ;
...
typedef irq_hw_number_t;
@@
 irq_hw_number_t ( * cocci_id@p ) ( struct irq_domain * , unsigned int ) ;
...
position p;
@@
 struct octeon_ciu3_info * cocci_id@p [ 4 ] ;
...
position p;
@@
 struct octeon_ciu_chip_data * cocci_id@p ;
...
position p;
@@
 struct octeon_core_chip_data cocci_id@p [ MIPS_CORE_IRQ_LINES ] ;
...
position p;
@@
 struct irq_domain_ops cocci_id@p ;
