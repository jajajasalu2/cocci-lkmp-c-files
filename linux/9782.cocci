...
position p;
@@
 struct htt_msdu_ext_desc cocci_id@p ;
...
position p;
@@
 struct htt_rx_ring_setup_ring32 * cocci_id@p ;
...
position p;
@@
 struct htt_stats_req * cocci_id@p ;
...
position p;
@@
 struct htt_frag_desc_bank_cfg64 * cocci_id@p ;
...
position p;
@@
 struct htt_aggr_conf_v2 * cocci_id@p ;
...
position p;
@@
 struct ath10k_htt_txbuf_32 cocci_id@p ;
...
position p;
@@
 const struct ath10k_htt_tx_ops cocci_id@p ;
...
position p;
@@
 struct htt_aggr_conf * cocci_id@p ;
...
position p;
@@
 struct htt_frag_desc_bank_cfg32 * cocci_id@p ;
...
position p;
@@
 struct htt_msdu_ext_desc_64 cocci_id@p ;
...
position p;
@@
 struct ath10k_htt_txbuf_64 cocci_id@p ;
...
position p;
@@
 struct htt_data_tx_desc * cocci_id@p ;
...
position p;
@@
 struct htt_rx_ring_setup_ring64 * cocci_id@p ;
...
position p;
@@
 struct ath10k_hif_sg_item cocci_id@p [ 2 ] ;
...
position p;
@@
 struct htt_data_tx_desc_frag * cocci_id@p ;
