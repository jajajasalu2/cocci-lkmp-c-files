...
position p;
@@
 struct matroxioc_output_mode cocci_id@p ;
...
position p;
@@
 const struct matrox_fb_info * cocci_id@p ;
...
position p;
@@
 struct matroxfb_dh_fb_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct matrox_fb_info * minfo ) ;
...
position p;
@@
 struct video_board {  int maxvram ;  int maxdisplayable ;  int accelID ;  struct matrox_switch * lowlevel ; } cocci_id@p ;
...
position p;
@@
 struct matroxfb_driver * cocci_id@p ;
...
position p;
@@
 struct {  unsigned int vesa ;  unsigned int info ; } * cocci_id@p ;
...
position p;
@@
 struct {  struct fb_bitfield red , green , blue , transp ;  int bits_per_pixel ; } cocci_id@p [ ] ;
...
position p;
@@
 struct matrox_hw_state * cocci_id@p ;
...
position p;
@@
 struct matrox_vsync * cocci_id@p ;
...
position p;
@@
 const struct fb_ops cocci_id@p ;
