...
position p;
@@
 struct paging_config cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ TRAMPOLINE_32BIT_SIZE ] ;
...
position p;
@@
 int cocci_id@p ( const char * option ) ;
...
position p;
@@
 struct paging_config {  unsigned long trampoline_start ;  unsigned long l5_required ; } cocci_id@p ;
