...
position p;
@@
 struct reset_syscfg * cocci_id@p ;
...
position p;
@@
 struct reset_syscfg {  struct regmap * regmap ;  unsigned int offset_rst ;  unsigned int mask_rst ;  unsigned int offset_rst_msk ;  unsigned int mask_rst_msk ; } cocci_id@p ;
