...
@@
 struct cm4000_dev {  struct pcmcia_device * p_dev ;  unsigned char atr [ MAX_ATR ] ;  unsigned char rbuf [ 512 ] ;  unsigned char sbuf [ 512 ] ;  wait_queue_head_t devq ;  wait_queue_head_t ioq ;  wait_queue_head_t atrq ;  wait_queue_head_t readq ;  unsigned char atr_csum ;  unsigned char atr_len_retry ;  unsigned short atr_len ;  unsigned short rlen ;  unsigned short rpos ;  unsigned char procbyte ;  unsigned char mstate ;  unsigned char cwarn ;  unsigned char flags0 ;  unsigned char flags1 ;  unsigned int mdelay ;  unsigned int baudv ;  unsigned char ta1 ;  unsigned char proto ;  unsigned long flags ;  unsigned char pts [ 4 ] ;  struct timer_list timer ;  int monitor_running ; } cocci_id@p ;
...
typedef u_int8_t;
@@
 struct card_fixup {  char atr [ 12 ] ;  u_int8_t atr_len ;  u_int8_t stopbits ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ 10 ] [ 14 ] ;
...
position p;
@@
 struct pcmcia_device * cocci_id@p [ CM4000_MAX_DEV ] ;
