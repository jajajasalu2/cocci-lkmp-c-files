...
position p;
@@
 struct lpi_device_info cocci_id@p ;
...
position p;
@@
 struct lpi_device_constraint cocci_id@p ;
...
position p;
@@
 struct lpi_constraints * cocci_id@p ;
...
position p;
@@
 struct lpi_device_constraint {  int uid ;  int min_dstate ;  int function_states ; } cocci_id@p ;
...
position p;
@@
 const struct platform_s2idle_ops cocci_id@p ;
...
typedef acpi_handle;
@@
 struct lpi_constraints {  acpi_handle handle ;  int min_dstate ; } cocci_id@p ;
...
position p;
@@
 struct acpi_table_facs * cocci_id@p ;
...
position p;
@@
 const struct platform_hibernation_ops cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ACPI_S_STATE_COUNT ] ;
...
position p;
@@
 char cocci_id@p [ ACPI_S_STATE_COUNT * 3 + 1 ] ;
...
position p;
@@
 struct lpi_device_info {  char * name ;  int enabled ;  union acpi_object * package ; } cocci_id@p ;
