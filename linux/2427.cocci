...
position p;
@@
 struct at_xdmac_desc * cocci_id@p ;
...
position p;
@@
 struct at_xdmac_chan cocci_id@p ;
...
position p;
@@
 enum atc_status { AT_XDMAC_CHAN_IS_CYCLIC = 0 , AT_XDMAC_CHAN_IS_PAUSED , } cocci_id@p ;
...
@@
 struct at_xdmac_lld {  dma_addr_t mbr_nda ;  u32 mbr_ubc ;  dma_addr_t mbr_sa ;  dma_addr_t mbr_da ;  u32 mbr_cfg ;  u32 mbr_bc ;  u32 mbr_ds ;  u32 mbr_sus ;  u32 mbr_dus ; } cocci_id@p ;
...
@@
 struct at_xdmac_chan {  struct dma_chan chan ;  void __iomem * ch_regs ;  u32 mask ;  u32 cfg ;  u8 perid ;  u8 perif ;  u8 memif ;  u32 save_cc ;  u32 save_cim ;  u32 save_cnda ;  u32 save_cndc ;  u32 irq_status ;  unsigned long status ;  struct tasklet_struct tasklet ;  struct dma_slave_config sconfig ;  spinlock_t lock ;  struct list_head xfers_list ;  struct list_head free_descs_list ; } cocci_id@p ;
...
typedef u32;
@@
 struct at_xdmac {  struct dma_device dma ;  void __iomem * regs ;  int irq ;  struct clk * clk ;  u32 save_gim ;  struct dma_pool * at_xdmac_desc_pool ;  struct at_xdmac_chan chan [ 0 ] ; } cocci_id@p ;
