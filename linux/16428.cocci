...
position p;
@@
 struct wr_msg_ctl_info * cocci_id@p ;
...
position p;
@@
 struct ipc_rst_payload_type cocci_id@p ;
...
position p;
@@
 struct ipc_time_update_msg cocci_id@p ;
...
position p;
@@
 const struct ishtp_hw_ops cocci_id@p ;
...
position p;
@@
 struct time_sync_format cocci_id@p ;
...
position p;
@@
 const struct ishtp_device * cocci_id@p ;
