...
position p;
@@
 struct rn_clk_internal cocci_id@p ;
...
position p;
@@
 struct clk_log_info * cocci_id@p ;
...
position p;
@@
 struct clk_state_registers_and_bypass * cocci_id@p ;
