...
position p;
@@
 enum usb_gadgetfs_event_type cocci_id@p ;
...
position p;
@@
 struct usb_gadgetfs_event * cocci_id@p ;
...
position p;
@@
 enum ep_state { STATE_EP_DISABLED = 0 , STATE_EP_READY , STATE_EP_ENABLED , STATE_EP_UNBOUND , } cocci_id@p ;
...
position p;
@@
 enum ep0_state { STATE_DEV_DISABLED = 0 , STATE_DEV_OPENED , STATE_DEV_UNCONNECTED , STATE_DEV_CONNECTED , STATE_DEV_SETUP , STATE_DEV_UNBOUND , } cocci_id@p ;
...
position p;
@@
 struct kiocb_priv {  struct usb_request * req ;  struct ep_data * epdata ;  struct kiocb * iocb ;  struct mm_struct * mm ;  struct work_struct work ;  void * buf ;  struct iov_iter to ;  const void * to_free ;  unsigned actual ; } cocci_id@p ;
