...
position p;
@@
 struct msm_framebuffer * cocci_id@p ;
...
position p;
@@
 struct drm_framebuffer * cocci_id@p ( struct drm_device * dev , const struct drm_mode_fb_cmd2 * mode_cmd , struct drm_gem_object * * bos ) ;
...
position p;
@@
 struct drm_gem_object * cocci_id@p [ 4 ] ;
...
position p;
@@
 struct msm_framebuffer {  struct drm_framebuffer base ;  const struct msm_format * format ; } cocci_id@p ;
