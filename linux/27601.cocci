...
typedef u64;
@@
 struct tree_entry {  u64 start ;  u64 end ;  struct rb_node rb_node ; } cocci_id@p ;
...
position p;
@@
 struct fiemap_cache * cocci_id@p ;
...
position p;
@@
 struct extent_page_data {  struct bio * bio ;  struct extent_io_tree * tree ;  unsigned int extent_locked : 1 ;  unsigned int sync_io : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct extent_state * cocci_id@p ;
...
@@
 struct fiemap_cache {  u64 offset ;  u64 phys ;  u64 len ;  u32 flags ;  bool cached ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct extent_io_tree * tree , struct extent_state * state , unsigned * bits , struct extent_changeset * changeset ) ;
...
position p;
@@
 struct extent_page_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef get_extent_t;
@@
 get_extent_t * cocci_id@p ;
