...
position p;
@@
 void cocci_id@p ( struct w83791d_data * data , struct device * dev ) ;
...
position p;
@@
 struct w83791d_data * cocci_id@p ( struct device * dev ) ;
...
typedef u8;
@@
 const u8 cocci_id@p [ NUMBER_OF_PWM ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ NUMBER_OF_VIN ] ;
...
position p;
@@
 struct w83791d_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s8,u8,s16,u32;
@@
 struct w83791d_data {  struct device * hwmon_dev ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  struct i2c_client * lm75 [ 2 ] ;  u8 in [ NUMBER_OF_VIN ] ;  u8 in_max [ NUMBER_OF_VIN ] ;  u8 in_min [ NUMBER_OF_VIN ] ;  u8 fan [ NUMBER_OF_FANIN ] ;  u8 fan_min [ NUMBER_OF_FANIN ] ;  u8 fan_div [ NUMBER_OF_FANIN ] ;  s8 temp1 [ 3 ] ;  s16 temp_add [ 2 ] [ 3 ] ;  u8 pwm [ 5 ] ;  u8 pwm_enable [ 3 ] ;  u8 temp_target [ 3 ] ;  u8 temp_tolerance [ 3 ] ;  u32 alarms ;  u8 beep_enable ;  u32 beep_mask ;  u8 vid ;  u8 vrm ; } cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct i2c_client * client , u8 reg ) ;
...
typedef u8;
@@
 const u8 cocci_id@p [ NUMBER_OF_FANIN ] ;
...
typedef u8;
@@
 int cocci_id@p ( struct i2c_client * client , u8 reg , u8 value ) ;
