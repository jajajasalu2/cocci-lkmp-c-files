...
position p;
@@
 void cocci_id@p ( struct mtd_info * mtd ) ;
...
symbol cocci_id;
position p;
typedef uint,wait_queue_head_t;
@@
 struct mpc5121_nfc_prv {  struct nand_chip chip ;  int irq ;  void __iomem * regs ;  struct clk * clk ;  wait_queue_head_t irq_waitq ;  uint column ;  int spareonly ;  void __iomem * csreg ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct mpc512x_reset_module * cocci_id@p ;
...
position p;
@@
 struct mpc5121_nfc_prv * cocci_id@p ;
