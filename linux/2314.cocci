...
position p;
@@
 struct cpufreq_cooling_device * cocci_id@p ;
...
position p;
@@
 struct time_in_idle * cocci_id@p ;
...
typedef u64;
@@
 struct time_in_idle {  u64 time ;  u64 timestamp ; } cocci_id@p ;
...
typedef u32;
@@
 struct cpufreq_cooling_device {  int id ;  u32 last_load ;  unsigned int cpufreq_state ;  unsigned int max_level ;  struct em_perf_domain * em ;  struct cpufreq_policy * policy ;  struct list_head node ;  struct time_in_idle * idle_time ;  struct freq_qos_request qos_req ; } cocci_id@p ;
