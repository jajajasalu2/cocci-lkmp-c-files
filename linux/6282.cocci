...
position p;
@@
 enum sch_chipsets { LPC_SCH = 0 , LPC_ITC , LPC_CENTERTON , LPC_QUARK_X1000 , } cocci_id@p ;
...
position p;
@@
 struct lpc_sch_info * cocci_id@p ;
...
position p;
@@
 struct lpc_sch_info {  unsigned int io_size_smbus ;  unsigned int io_size_gpio ;  unsigned int io_size_wdt ;  int irq_gpio ; } cocci_id@p ;
