...
symbol cocci_id;
position p;
typedef src_node_conf_t;
@@
 struct src_node_conf_t cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct ct_atc cocci_id@p ;
...
typedef src_node_conf_t;
@@
 struct src_node_conf_t {  unsigned int pitch ;  unsigned int msr : 8 ;  unsigned int mix_msr : 8 ;  unsigned int imp_msr : 8 ;  unsigned int vo : 1 ; } cocci_id@p ;
...
position p;
@@
 struct {  int ( * create ) ( struct hw * hw , void * * rmgr ) ;  int ( * destroy ) ( void * mgr ) ; } cocci_id@p [ NUM_RSCTYP ] ;
...
position p;
@@
 struct {  int ( * create ) ( struct ct_atc * atc , enum CTALSADEVS device , const char * device_name ) ;  int ( * destroy ) ( void * alsa_dev ) ;  const char * public_name ; } cocci_id@p [ NUM_CTALSADEVS ] ;
...
typedef src_node_conf_t;
@@
 struct src_node_conf_t * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ NUM_CTCARDS ] ;
...
position p;
@@
 int cocci_id@p ( struct ct_atc * atc , struct ct_atc_pcm * apcm ) ;
