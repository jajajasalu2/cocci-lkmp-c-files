...
position p;
@@
 const struct tbg_def * cocci_id@p ;
...
position p;
@@
 const struct tbg_def cocci_id@p [ NUM_TBG ] ;
...
typedef u32;
@@
 struct tbg_def {  char * name ;  u32 refdiv_offset ;  u32 fbdiv_offset ;  u32 vcodiv_reg ;  u32 vcodiv_offset ; } cocci_id@p ;
