...
position p;
@@
 const struct media_device * cocci_id@p ;
...
position p;
@@
 struct media_pipeline * cocci_id@p ;
...
position p;
@@
 enum media_pad_signal_type cocci_id@p ;
...
position p;
@@
 enum media_gobj_type cocci_id@p ;
