...
typedef u32;
@@
 void cocci_id@p ( u32 * * buf , enum opcode opc , ... ) ;
...
typedef u32;
@@
 struct insn {  u32 match ;  enum fields fields ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct uasm_reloc * rel , struct uasm_label * lab ) ;
...
position p;
@@
 enum fields { RS = 0x001 , RT = 0x002 , RD = 0x004 , RE = 0x008 , SIMM = 0x010 , UIMM = 0x020 , BIMM = 0x040 , JIMM = 0x080 , FUNC = 0x100 , SET = 0x200 , SCIMM = 0x400 , SIMM9 = 0x800 , } cocci_id@p ;
