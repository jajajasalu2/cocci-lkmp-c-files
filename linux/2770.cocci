...
position p;
@@
 const struct gpiomux * cocci_id@p ;
...
position p;
@@
 struct gpiomux {  struct i2c_mux_gpio_platform_data data ;  int ngpios ;  struct gpio_desc * * gpios ; } cocci_id@p ;
