...
position p;
@@
 struct mtk_disp_color cocci_id@p ;
...
position p;
@@
 struct mtk_disp_color_data {  unsigned int color_offset ; } cocci_id@p ;
...
position p;
@@
 struct mtk_disp_color {  struct mtk_ddp_comp ddp_comp ;  struct drm_crtc * crtc ;  const struct mtk_disp_color_data * data ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_disp_color_data cocci_id@p ;
