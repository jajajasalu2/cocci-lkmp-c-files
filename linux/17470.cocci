...
position p;
@@
 struct pseries_hp_work * cocci_id@p ;
...
position p;
@@
 struct pseries_hp_work {  struct work_struct work ;  struct pseries_hp_errorlog * errlog ; } cocci_id@p ;
...
typedef __be32;
@@
 struct cc_workarea {  __be32 drc_index ;  __be32 zero ;  __be32 name_offset ;  __be32 prop_length ;  __be32 prop_offset ; } cocci_id@p ;
