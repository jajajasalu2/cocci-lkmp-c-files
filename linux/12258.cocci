...
position p;
@@
 struct ipu_crtc {  struct device * dev ;  struct drm_crtc base ;  struct ipu_plane * plane [ 2 ] ;  struct ipu_dc * dc ;  struct ipu_di * di ;  int irq ;  struct drm_pending_vblank_event * event ; } cocci_id@p ;
