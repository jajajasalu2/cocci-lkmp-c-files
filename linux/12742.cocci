...
position p;
@@
 struct mtk_iommu_suspend_reg * cocci_id@p ;
...
position p;
@@
 struct mtk_iommu_domain * cocci_id@p ;
...
position p;
@@
 const struct mtk_iommu_data * cocci_id@p ;
...
position p;
@@
 struct mtk_iommu_data * cocci_id@p ;
...
@@
 struct mtk_iommu_domain {  spinlock_t pgtlock ;  struct iommu_domain domain ;  u32 * pgt_va ;  dma_addr_t pgt_pa ;  struct mtk_iommu_data * data ; } cocci_id@p ;
