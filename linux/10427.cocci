...
position p;
@@
 struct rcar_du_plane_state cocci_id@p ;
...
position p;
@@
 struct vsp1_du_lif_config cocci_id@p ;
...
position p;
@@
 struct vsp1_du_atomic_pipe_config cocci_id@p ;
...
position p;
@@
 struct rcar_du_vsp_plane_state * cocci_id@p ;
...
position p;
@@
 struct vsp1_du_atomic_config cocci_id@p ;
...
position p;
@@
 struct rcar_du_vsp_plane * cocci_id@p ;
