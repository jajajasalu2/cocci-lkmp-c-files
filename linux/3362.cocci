...
position p;
@@
 struct sti_cpt_ddata * cocci_id@p ;
...
position p;
@@
 const struct reg_field cocci_id@p [ MAX_REGFIELDS ] ;
...
position p;
@@
 struct sti_pwm_chip cocci_id@p ;
...
@@
 struct sti_cpt_ddata {  u32 snapshot [ 3 ] ;  unsigned int index ;  struct mutex lock ;  wait_queue_head_t wait ; } cocci_id@p ;
...
position p;
@@
 struct sti_pwm_chip {  struct device * dev ;  struct clk * pwm_clk ;  struct clk * cpt_clk ;  struct regmap * regmap ;  struct sti_pwm_compat_data * cdata ;  struct regmap_field * prescale_low ;  struct regmap_field * prescale_high ;  struct regmap_field * pwm_out_en ;  struct regmap_field * pwm_cpt_en ;  struct regmap_field * pwm_cpt_int_en ;  struct regmap_field * pwm_cpt_int_stat ;  struct pwm_chip chip ;  struct pwm_device * cur ;  unsigned long configured ;  unsigned int en_count ;  struct mutex sti_pwm_lock ;  void __iomem * mmio ; } cocci_id@p ;
...
position p;
@@
 enum sti_cpt_edge { CPT_EDGE_DISABLED , CPT_EDGE_RISING , CPT_EDGE_FALLING , CPT_EDGE_BOTH , } cocci_id@p ;
...
position p;
@@
 struct sti_pwm_compat_data * cocci_id@p ;
...
position p;
@@
 struct sti_pwm_compat_data {  const struct reg_field * reg_fields ;  unsigned int pwm_num_devs ;  unsigned int cpt_num_devs ;  unsigned int max_pwm_cnt ;  unsigned int max_prescale ; } cocci_id@p ;
...
position p;
@@
 const struct pwm_ops cocci_id@p ;
...
position p;
@@
 enum { PWMCLK_PRESCALE_LOW , PWMCLK_PRESCALE_HIGH , CPTCLK_PRESCALE , PWM_OUT_EN , PWM_CPT_EN , PWM_CPT_INT_EN , PWM_CPT_INT_STAT , MAX_REGFIELDS , } cocci_id@p ;
