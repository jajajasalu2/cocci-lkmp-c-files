...
position p;
@@
 const struct uwb_rccb * cocci_id@p ;
...
position p;
@@
 const struct uwb_rceb * cocci_id@p ;
...
position p;
@@
 struct uwb_rc_control_intf_class_desc * cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_drp_avail * cocci_id@p ;
...
position p;
@@
 struct hwarc {  struct usb_device * usb_dev ;  struct usb_interface * usb_iface ;  struct uwb_rc * uwb_rc ;  struct urb * neep_urb ;  struct edc neep_edc ;  void * rd_buffer ; } cocci_id@p ;
...
position p;
@@
 struct uwb_rc_cmd_set_drp_ie * cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_beacon_WUSB_0100 cocci_id@p ;
...
position p;
@@
 struct uwb_rc_cmd_scan * cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_drp_WUSB_0100 cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_drp_avail_WUSB_0100 cocci_id@p ;
...
position p;
@@
 struct uwb_rc_cmd_set_drp_ie_WUSB_0100 * cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_bp_slot_change_WUSB_0100 cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_beacon * cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_drp * cocci_id@p ;
