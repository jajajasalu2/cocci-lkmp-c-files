...
position p;
@@
 struct rpi_touchscreen cocci_id@p ;
...
position p;
@@
 struct mipi_dsi_device_info cocci_id@p ;
...
position p;
@@
 enum REG_ADDR { REG_ID = 0x80 , REG_PORTA , REG_PORTB , REG_PORTC , REG_PORTD , REG_POWERON , REG_PWM , REG_DDRA , REG_DDRB , REG_DDRC , REG_DDRD , REG_TEST , REG_WR_ADDRL , REG_WR_ADDRH , REG_READH , REG_READL , REG_WRITEH , REG_WRITEL , REG_ID2 , } cocci_id@p ;
...
position p;
@@
 struct rpi_touchscreen {  struct drm_panel base ;  struct mipi_dsi_device * dsi ;  struct i2c_client * i2c ; } cocci_id@p ;
