...
position p;
@@
 int cocci_id@p ( struct orinoco_private * priv ) ;
...
position p;
@@
 struct orinoco_rx_data {  struct hermes_rx_descriptor * desc ;  struct sk_buff * skb ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct hermes_tallies_frame cocci_id@p ;
...
position p;
@@
 struct prism2_scan_apinfo * cocci_id@p ;
...
position p;
@@
 struct hermes_tx_descriptor cocci_id@p ;
...
position p;
@@
 struct hermes_linkstatus cocci_id@p ;
...
position p;
@@
 struct orinoco_rx_data * cocci_id@p ;
...
position p;
@@
 struct agere_ext_scan_info * cocci_id@p ;
...
position p;
@@
 struct orinoco_tkip_key * cocci_id@p ;
...
position p;
@@
 struct orinoco_scan_data * cocci_id@p ;
...
position p;
@@
 struct iw_michaelmicfailure cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct orinoco_private * , int ) ;
...
position p;
@@
 char cocci_id@p [ HERMES_802_3_OFFSET ] ;
...
position p;
@@
 struct hermes_rx_descriptor * cocci_id@p ;
...
position p;
@@
 struct orinoco_scan_data {  void * buf ;  size_t len ;  int type ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct orinoco_private * ) ;
...
position p;
@@
 struct hermes_txexc_data cocci_id@p ;
