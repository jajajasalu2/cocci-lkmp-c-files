...
position p;
@@
 struct stmp3xxx_wdt_pdata cocci_id@p ;
...
position p;
@@
 struct stmp3xxx_rtc_data {  struct rtc_device * rtc ;  void __iomem * io ;  int irq_alarm ; } cocci_id@p ;
...
position p;
@@
 struct stmp3xxx_rtc_data * cocci_id@p ;
