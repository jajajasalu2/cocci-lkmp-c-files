...
position p;
@@
 enum { AXIS_X , AXIS_Y , AXIS_Z , } cocci_id@p ;
...
position p;
@@
 struct udraw {  struct input_dev * joy_input_dev ;  struct input_dev * touch_input_dev ;  struct input_dev * pen_input_dev ;  struct input_dev * accel_input_dev ;  struct hid_device * hdev ;  int last_one_finger_x ;  int last_one_finger_y ;  int last_two_finger_x ;  int last_two_finger_y ; } cocci_id@p ;
...
position p;
@@
 enum { TOUCH_NONE , TOUCH_PEN , TOUCH_FINGER , TOUCH_TWOFINGER , } cocci_id@p ;
