...
position p;
@@
 int ( * cocci_id@p ) ( struct resource * , void * ) ;
...
position p;
@@
 struct kexec_sha_region * cocci_id@p ;
...
position p;
@@
 struct purgatory_info * cocci_id@p ;
...
position p;
@@
 const struct kexec_file_ops * const * cocci_id@p ;
...
position p;
@@
 struct crash_mem_range cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct kimage * image ) ;
...
position p;
@@
 struct kexec_segment * cocci_id@p ;
