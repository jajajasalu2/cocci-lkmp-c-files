...
typedef u8;
@@
 u8 cocci_id@p [ HOST_LINK_BUF_SIZE ] ;
...
symbol cocci_id;
position p;
typedef u8,u32,atomic_t;
@@
 struct dvb_ca_slot {  int slot_state ;  struct mutex slot_lock ;  atomic_t camchange_count ;  int camchange_type ;  u32 config_base ;  u8 config_option ;  u8 da_irq_supported : 1 ;  int link_buf_size ;  struct dvb_ringbuffer rx_buffer ;  unsigned long timeout ; } cocci_id@p ;
...
position p;
@@
 struct dvb_ca_private cocci_id@p ;
...
position p;
@@
 struct ca_slot_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dvb_ca_private * ca ) ;
...
@@
 struct dvb_ca_private {  struct kref refcount ;  struct dvb_ca_en50221 * pub ;  struct dvb_device * dvbdev ;  u32 flags ;  unsigned int slot_count ;  struct dvb_ca_slot * slot_info ;  wait_queue_head_t wait_queue ;  struct task_struct * thread ;  unsigned int open : 1 ;  unsigned int wakeup : 1 ;  unsigned long delay ;  int next_read_slot ;  struct mutex ioctl_mutex ; } cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct dvb_ca_private * ca , int slot , u8 * ebuf , int ecount ) ;
