...
position p;
@@
 struct tty_driver * cocci_id@p [ TTY_MAX_COUNT ] ;
...
position p;
@@
 struct gdm * cocci_id@p [ TTY_MAX_COUNT ] [ GDM_TTY_MINOR ] ;
...
position p;
@@
 const char * cocci_id@p [ TTY_MAX_COUNT ] ;
