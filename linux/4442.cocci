...
position p;
@@
 const struct bcm2835_rng_of_data * cocci_id@p ;
...
typedef bool;
@@
 struct bcm2835_rng_of_data {  bool mask_interrupts ; } cocci_id@p ;
...
position p;
@@
 struct bcm2835_rng_priv cocci_id@p ;
...
typedef bool;
@@
 struct bcm2835_rng_priv {  struct hwrng rng ;  void __iomem * base ;  bool mask_interrupts ;  struct clk * clk ; } cocci_id@p ;
