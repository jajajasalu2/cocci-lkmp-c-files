...
position p;
@@
 union cvmx_pow_wq_int cocci_id@p ;
...
position p;
@@
 struct oct_rx_group * cocci_id@p ;
...
position p;
@@
 struct oct_rx_group {  int irq ;  int group ;  struct napi_struct napi ; } cocci_id@p [ 16 ] ;
...
position p;
@@
 union cvmx_pow_wq_int_pc cocci_id@p ;
...
position p;
@@
 union cvmx_pow_wq_int_thrx cocci_id@p ;
...
position p;
@@
 union cvmx_sso_wq_int_thrx cocci_id@p ;
