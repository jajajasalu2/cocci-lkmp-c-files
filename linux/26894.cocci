...
typedef __be32;
@@
 struct {  struct {  __be32 nifs ;  __be32 uuid [ 11 ] ;  __be32 ifaddr [ 32 ] ;  __be32 netmask [ 32 ] ;  __be32 mtu [ 32 ] ; } ia ;  struct {  __be32 capcount ;  __be32 caps [ 1 ] ; } cap ; } cocci_id@p ;
...
position p;
@@
 struct afs_callback_break * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct afs_call * ) ;
