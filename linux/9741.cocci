...
position p;
@@
 struct iwl_mvm_alive_data * cocci_id@p ;
...
position p;
@@
 struct iwl_dev_tx_power_cmd_v4 cocci_id@p ;
...
position p;
@@
 struct iwl_card_state_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_nvm_access_complete_cmd cocci_id@p ;
...
position p;
@@
 struct mvm_alive_resp * cocci_id@p ;
...
position p;
@@
 struct iwl_mfu_assert_dump_notif * cocci_id@p ;
...
position p;
@@
 union geo_tx_power_profiles_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_nvm_data cocci_id@p ;
...
position p;
@@
 struct iwl_geo_tx_power_profiles_cmd_v1 cocci_id@p ;
...
position p;
@@
 struct iwl_fw_error_recovery_cmd cocci_id@p ;
...
position p;
@@
 struct mvm_alive_resp_v3 * cocci_id@p ;
...
typedef bool,u32;
@@
 struct iwl_mvm_alive_data {  bool valid ;  u32 scd_base_addr ; } cocci_id@p ;
...
position p;
@@
 struct iwl_lmac_alive * cocci_id@p ;
...
position p;
@@
 struct iwl_tx_ant_cfg_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_rfh_queue_config * cocci_id@p ;
...
position p;
@@
 struct iwl_umac_alive * cocci_id@p ;
...
position p;
@@
 struct iwl_dqa_enable_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mfuart_load_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_init_extended_cfg_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_phy_cfg_cmd cocci_id@p ;
