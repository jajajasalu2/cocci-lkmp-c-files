...
position p;
@@
 struct fsl_dma_link_descriptor cocci_id@p ;
...
@@
 struct dma_object {  struct snd_soc_component_driver dai ;  dma_addr_t ssi_stx_phys ;  dma_addr_t ssi_srx_phys ;  unsigned int ssi_fifo_depth ;  struct ccsr_dma_channel __iomem * channel ;  unsigned int irq ;  bool assigned ; } cocci_id@p ;
...
position p;
@@
 struct fsl_dma_private * cocci_id@p ;
