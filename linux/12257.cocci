...
@@
 struct imx_tve {  struct drm_connector connector ;  struct drm_encoder encoder ;  struct device * dev ;  spinlock_t lock ;  bool enabled ;  int mode ;  int di_hsync_pin ;  int di_vsync_pin ;  struct regmap * regmap ;  struct regulator * dac_reg ;  struct i2c_adapter * ddc ;  struct clk * clk ;  struct clk * di_sel_clk ;  struct clk_hw clk_hw_di ;  struct clk * di_clk ; } cocci_id@p ;
...
position p;
@@
 enum { TVE_MODE_TVOUT , TVE_MODE_VGA , } cocci_id@p ;
