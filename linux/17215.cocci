...
position p;
@@
 struct lpbfifo_data cocci_id@p ;
...
position p;
@@
 struct mpc512x_lpbfifo_request * cocci_id@p ;
...
position p;
@@
 struct mpc512x_lpbfifo cocci_id@p ;
...
typedef u32;
@@
 struct cs_range {  u32 csnum ;  u32 base ;  u32 addr ;  u32 size ; } cocci_id@p ;
