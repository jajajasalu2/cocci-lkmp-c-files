...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( modify_cq_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( query_cq_in ) ] ;
...
position p;
@@
 struct mlx5_eq_tasklet * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( modify_cq_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_cq_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_cq_out ) ] ;
