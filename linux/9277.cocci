...
position p;
@@
 struct host_cmd_ds_sta_list * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_sta_info * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_get_stats * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_ps_mode_enh * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_rssi_info_rsp * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11d_domain_info_rsp * cocci_id@p ;
...
position p;
@@
 struct mwifiex_power_group * cocci_id@p ;
...
position p;
@@
 struct mwifiex_band_config cocci_id@p ;
...
position p;
@@
 union reg {  struct host_cmd_ds_mac_reg_access * mac ;  struct host_cmd_ds_bbp_reg_access * bbp ;  struct host_cmd_ds_rf_reg_access * rf ;  struct host_cmd_ds_pmic_reg_access * pmic ;  struct host_cmd_ds_802_11_eeprom_access * eeprom ; } cocci_id@p ;
...
position p;
@@
 struct mwifiex_channel_band * cocci_id@p ;
...
position p;
@@
 struct mwifiex_sta_node * cocci_id@p ;
