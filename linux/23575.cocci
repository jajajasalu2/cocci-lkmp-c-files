...
position p;
@@
 struct snd_dmaengine_dai_dma_data * cocci_id@p ;
...
position p;
@@
 enum i2s_fifo_th { I2S_FIFO_TH_NONE , I2S_FIFO_TH_ONE_QUARTER , I2S_FIFO_TH_HALF , I2S_FIFO_TH_THREE_QUARTER , I2S_FIFO_TH_FULL , } cocci_id@p ;
...
position p;
@@
 struct stm32_i2s_data * cocci_id@p ;
...
position p;
@@
 enum i2s_master_mode { I2S_MS_NOT_SET , I2S_MS_MASTER , I2S_MS_SLAVE , } cocci_id@p ;
...
position p;
@@
 enum i2s_mode { I2S_I2SMOD_TX_SLAVE , I2S_I2SMOD_RX_SLAVE , I2S_I2SMOD_TX_MASTER , I2S_I2SMOD_RX_MASTER , I2S_I2SMOD_FD_SLAVE , I2S_I2SMOD_FD_MASTER , } cocci_id@p ;
...
position p;
@@
 enum i2s_std { I2S_STD_I2S , I2S_STD_LEFT_J , I2S_STD_RIGHT_J , I2S_STD_DSP , } cocci_id@p ;
...
@@
 struct stm32_i2s_data {  const struct regmap_config * regmap_conf ;  struct regmap * regmap ;  struct platform_device * pdev ;  struct snd_soc_dai_driver * dai_drv ;  struct snd_dmaengine_dai_dma_data dma_data_tx ;  struct snd_dmaengine_dai_dma_data dma_data_rx ;  struct snd_pcm_substream * substream ;  struct clk * i2sclk ;  struct clk * pclk ;  struct clk * x8kclk ;  struct clk * x11kclk ;  void __iomem * base ;  dma_addr_t phys_addr ;  spinlock_t lock_fd ;  spinlock_t irq_lock ;  unsigned int mclk_rate ;  unsigned int fmt ;  int refcount ;  int ms_flg ; } cocci_id@p ;
...
position p;
@@
 enum i2s_datlen { I2S_I2SMOD_DATLEN_16 , I2S_I2SMOD_DATLEN_24 , I2S_I2SMOD_DATLEN_32 , } cocci_id@p ;
