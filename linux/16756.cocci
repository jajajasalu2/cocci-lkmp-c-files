...
position p;
@@
 struct synth_kbd_protocol_response * cocci_id@p ;
...
position p;
@@
 struct synth_kbd_protocol_request cocci_id@p ;
...
typedef __le32;
@@
 struct synth_kbd_protocol_response {  struct synth_kbd_msg_hdr header ;  __le32 proto_status ; } cocci_id@p ;
...
position p;
@@
 enum synth_kbd_msg_type { SYNTH_KBD_PROTOCOL_REQUEST = 1 , SYNTH_KBD_PROTOCOL_RESPONSE = 2 , SYNTH_KBD_EVENT = 3 , SYNTH_KBD_LED_INDICATORS = 4 , } cocci_id@p ;
...
position p;
@@
 struct synth_kbd_protocol_request {  struct synth_kbd_msg_hdr header ;  union synth_kbd_version version_requested ; } cocci_id@p ;
...
position p;
@@
 struct synth_kbd_keystroke cocci_id@p ;
...
position p;
@@
 struct synth_kbd_msg {  struct synth_kbd_msg_hdr header ;  char data [ ] ; } cocci_id@p ;
...
@@
 struct hv_kbd_dev {  struct hv_device * hv_dev ;  struct serio * hv_serio ;  struct synth_kbd_protocol_request protocol_req ;  struct synth_kbd_protocol_response protocol_resp ;  struct completion wait_event ;  spinlock_t lock ;  bool started ; } cocci_id@p ;
...
typedef __le32;
@@
 union synth_kbd_version {  __le32 version ; } cocci_id@p ;
...
typedef __le32;
@@
 struct synth_kbd_msg_hdr {  __le32 type ; } cocci_id@p ;
...
typedef __le32;
@@
 struct synth_kbd_keystroke {  struct synth_kbd_msg_hdr header ;  __le16 make_code ;  __le16 reserved0 ;  __le32 info ; } cocci_id@p ;
...
position p;
@@
 struct synth_kbd_msg * cocci_id@p ;
...
position p;
@@
 struct synth_kbd_msg_hdr cocci_id@p ;
