...
position p;
@@
 struct pv88090_buck_voltage {  int min_uV ;  int max_uV ;  int uV_step ; } cocci_id@p ;
...
position p;
@@
 const struct pv88090_buck_voltage cocci_id@p [ 3 ] ;
...
position p;
@@
 struct pv88090 {  struct device * dev ;  struct regmap * regmap ;  struct regulator_dev * rdev [ PV88090_MAX_REGULATORS ] ; } cocci_id@p ;
...
position p;
@@
 struct pv88090_regulator {  struct regulator_desc desc ;  unsigned int conf ;  unsigned int conf2 ; } cocci_id@p ;
...
position p;
@@
 struct pv88090_regulator cocci_id@p [ ] ;
...
position p;
@@
 enum { PV88090_ID_BUCK1 , PV88090_ID_BUCK2 , PV88090_ID_BUCK3 , PV88090_ID_LDO1 , PV88090_ID_LDO2 , } cocci_id@p ;
