...
position p;
@@
 enum ahci_imx_type { AHCI_IMX53 , AHCI_IMX6Q , AHCI_IMX6QP , AHCI_IMX8QM , } cocci_id@p ;
...
position p;
@@
 struct ahci_host_priv * cocci_id@p ;
...
position p;
@@
 const struct reg_property cocci_id@p [ ] ;
...
position p;
@@
 enum { SATA_PHY_CR_CLOCK_CRCMP_LT_LIMIT = 0x0001 , SATA_PHY_CR_CLOCK_DAC_CTL = 0x0008 , SATA_PHY_CR_CLOCK_RTUNE_CTL = 0x0009 , SATA_PHY_CR_CLOCK_ADC_OUT = 0x000A , SATA_PHY_CR_CLOCK_MPLL_TST = 0x0017 , } cocci_id@p ;
...
typedef bool,u32;
@@
 struct imx_ahci_priv {  struct platform_device * ahci_pdev ;  enum ahci_imx_type type ;  struct clk * sata_clk ;  struct clk * sata_ref_clk ;  struct clk * ahb_clk ;  struct clk * epcs_tx_clk ;  struct clk * epcs_rx_clk ;  struct clk * phy_apbclk ;  struct clk * phy_pclk0 ;  struct clk * phy_pclk1 ;  void __iomem * phy_base ;  struct gpio_desc * clkreq_gpiod ;  struct regmap * gpr ;  bool no_device ;  bool first_time ;  u32 phy_params ;  u32 imped_ratio ; } cocci_id@p ;
...
typedef u32;
@@
 struct reg_property {  const char * name ;  const struct reg_value * values ;  size_t num_values ;  u32 def_value ;  u32 set_value ; } cocci_id@p ;
...
typedef u32;
@@
 struct reg_value {  u32 of_value ;  u32 reg_value ; } cocci_id@p ;
...
position p;
@@
 struct imx_ahci_priv * cocci_id@p ;
