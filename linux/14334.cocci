...
position p;
@@
 struct au8522_led_config * cocci_id@p ;
...
typedef u16;
@@
 struct mse2snr_tab {  u16 val ;  u16 data ; } cocci_id@p ;
...
typedef u16;
@@
 struct {  u16 reg ;  u16 data ; } cocci_id@p [ ] ;
...
position p;
@@
 enum au8522_if_freq cocci_id@p ;
...
position p;
@@
 const struct au8522_config * cocci_id@p ;
