...
position p;
@@
 struct st_retime_dedicated * cocci_id@p ;
...
position p;
@@
 struct st_gpio_bank * cocci_id@p ;
...
position p;
@@
 struct regmap_field * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct st_gpio_bank {  struct gpio_chip gpio_chip ;  struct pinctrl_gpio_range range ;  void __iomem * base ;  struct st_pio_control pc ;  unsigned long irq_edge_conf ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 const struct st_pctl_data * cocci_id@p ;
...
position p;
@@
 struct st_pinconf {  int pin ;  const char * name ;  unsigned long config ;  int altfunc ; } cocci_id@p ;
...
position p;
@@
 struct st_pinctrl {  struct device * dev ;  struct pinctrl_dev * pctl ;  struct st_gpio_bank * banks ;  int nbanks ;  struct st_pmx_func * functions ;  int nfunctions ;  struct st_pctl_group * groups ;  int ngroups ;  struct regmap * regmap ;  const struct st_pctl_data * data ;  void __iomem * irqmux_base ; } cocci_id@p ;
...
position p;
@@
 struct st_retime_dedicated {  struct regmap_field * rt [ ST_GPIO_PINS_PER_BANK ] ; } cocci_id@p ;
...
position p;
@@
 struct st_pmx_func {  const char * name ;  const char * * groups ;  unsigned ngroups ; } cocci_id@p ;
...
position p;
@@
 const struct st_pctl_group * cocci_id@p ;
...
position p;
@@
 struct st_pio_control cocci_id@p ;
...
position p;
@@
 struct st_retime_packed {  struct regmap_field * clk1notclk0 ;  struct regmap_field * delay_0 ;  struct regmap_field * delay_1 ;  struct regmap_field * invertclk ;  struct regmap_field * retime ;  struct regmap_field * clknotdata ;  struct regmap_field * double_edge ; } cocci_id@p ;
...
position p;
@@
 enum st_retime_style { st_retime_style_none , st_retime_style_packed , st_retime_style_dedicated , } cocci_id@p ;
...
position p;
@@
 const struct st_pinctrl * cocci_id@p ;
...
position p;
@@
 struct st_retime_packed * cocci_id@p ;
...
position p;
@@
 struct st_pctl_group * cocci_id@p ;
...
position p;
@@
 struct st_pctl_group {  const char * name ;  unsigned int * pins ;  unsigned npins ;  struct st_pinconf * pin_conf ; } cocci_id@p ;
