...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_MASQ_MAX + 1 ] ;
...
position p;
@@
 const struct nft_masq * cocci_id@p ;
...
typedef u32;
@@
 struct nft_masq {  u32 flags ;  enum nft_registers sreg_proto_min : 8 ;  enum nft_registers sreg_proto_max : 8 ; } cocci_id@p ;
