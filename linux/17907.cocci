...
position p;
@@
 struct schizo_irq_data cocci_id@p ;
...
position p;
@@
 struct sabre_irq_data cocci_id@p ;
...
typedef u32;
@@
 struct fire_irq_data {  unsigned long pbm_regs ;  u32 portid ; } cocci_id@p ;
...
position p;
@@
 struct fire_irq_data cocci_id@p ;
...
position p;
@@
 const struct linux_prom_pci_registers * cocci_id@p ;
...
position p;
@@
 struct irq_trans {  const char * name ;  void ( * init ) ( struct device_node * ) ; } cocci_id@p ;
...
position p;
@@
 struct of_irq_controller cocci_id@p ;
...
typedef u32;
@@
 struct schizo_irq_data {  unsigned long pbm_regs ;  unsigned long sync_reg ;  u32 portid ;  int chip_version ; } cocci_id@p ;
...
position p;
@@
 struct sabre_irq_data {  unsigned long controller_regs ;  unsigned int pci_first_busno ; } cocci_id@p ;
