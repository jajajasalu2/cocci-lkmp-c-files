...
position p;
@@
 struct alcor_pll_conf {  unsigned int clk_src_freq ;  unsigned int clk_src_reg ;  unsigned int min_div ;  unsigned int max_div ; } cocci_id@p ;
...
position p;
@@
 struct alcor_dev_cfg * cocci_id@p ;
...
position p;
@@
 const struct alcor_pll_conf cocci_id@p [ ] ;
...
position p;
@@
 struct alcor_sdmmc_host cocci_id@p ;
...
position p;
@@
 enum alcor_cookie { COOKIE_UNMAPPED , COOKIE_PRE_MAPPED , COOKIE_MAPPED , } cocci_id@p ;
...
position p;
@@
 struct alcor_pci_priv * cocci_id@p ;
