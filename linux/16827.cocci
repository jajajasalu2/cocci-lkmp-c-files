...
position p;
@@
 enum max77693_haptic_pwm_divisor { MAX77693_HAPTIC_PWM_DIVISOR_32 = 0 , MAX77693_HAPTIC_PWM_DIVISOR_64 , MAX77693_HAPTIC_PWM_DIVISOR_128 , MAX77693_HAPTIC_PWM_DIVISOR_256 , } cocci_id@p ;
...
typedef bool;
@@
 struct max77693_haptic {  enum max77693_types dev_type ;  struct regmap * regmap_pmic ;  struct regmap * regmap_haptic ;  struct device * dev ;  struct input_dev * input_dev ;  struct pwm_device * pwm_dev ;  struct regulator * motor_reg ;  bool enabled ;  bool suspend_state ;  unsigned int magnitude ;  unsigned int pwm_duty ;  enum max77693_haptic_motor_type type ;  enum max77693_haptic_pulse_mode mode ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 enum max77693_haptic_pulse_mode { MAX77693_HAPTIC_EXTERNAL_MODE = 0 , MAX77693_HAPTIC_INTERNAL_MODE , } cocci_id@p ;
...
position p;
@@
 struct max77693_haptic * cocci_id@p ;
...
position p;
@@
 enum max77693_haptic_motor_type { MAX77693_HAPTIC_ERM = 0 , MAX77693_HAPTIC_LRA , } cocci_id@p ;
