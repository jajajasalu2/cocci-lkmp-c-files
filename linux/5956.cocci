...
position p;
@@
 struct tegra_xusb_padctl_lane {  const char * name ;  unsigned int offset ;  unsigned int shift ;  unsigned int mask ;  unsigned int iddq ;  const unsigned int * funcs ;  unsigned int num_funcs ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_padctl_function {  const char * name ;  const char * const * groups ;  unsigned int num_groups ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_padctl {  struct device * dev ;  void __iomem * regs ;  struct mutex lock ;  struct reset_control * rst ;  const struct tegra_xusb_padctl_soc * soc ;  struct pinctrl_dev * pinctrl ;  struct pinctrl_desc desc ;  struct phy_provider * provider ;  struct phy * phys [ 2 ] ;  unsigned int enable ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_padctl_function cocci_id@p [ ] ;
...
position p;
@@
 enum tegra124_function { TEGRA124_FUNC_SNPS , TEGRA124_FUNC_XUSB , TEGRA124_FUNC_UART , TEGRA124_FUNC_PCIE , TEGRA124_FUNC_USB3 , TEGRA124_FUNC_SATA , TEGRA124_FUNC_RSVD , } cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_padctl_property {  const char * name ;  enum tegra_xusb_padctl_param param ; } cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_xusb_padctl * cocci_id@p ;
...
position p;
@@
 enum tegra_xusb_padctl_param { TEGRA_XUSB_PADCTL_IDDQ , } cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_padctl_soc {  const struct pinctrl_pin_desc * pins ;  unsigned int num_pins ;  const struct tegra_xusb_padctl_function * functions ;  unsigned int num_functions ;  const struct tegra_xusb_padctl_lane * lanes ;  unsigned int num_lanes ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_padctl_lane cocci_id@p [ ] ;
...
position p;
@@
 enum tegra_xusb_padctl_param cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct platform_device * pdev ) ;
...
position p;
@@
 const struct tegra_xusb_padctl_soc cocci_id@p ;
