...
position p;
@@
 struct gntdev_grant_copy_segment cocci_id@p ;
...
position p;
@@
 struct ioctl_gntdev_get_offset_for_vaddr cocci_id@p ;
...
position p;
@@
 struct ioctl_gntdev_unmap_grant_ref cocci_id@p ;
...
position p;
@@
 struct gntdev_copy_batch cocci_id@p ;
...
position p;
@@
 struct ioctl_gntdev_grant_copy cocci_id@p ;
...
position p;
@@
 struct ioctl_gntdev_map_grant_ref cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gntdev_grant_map * map , int offset , int pages ) ;
...
typedef s16;
@@
 struct gntdev_copy_batch {  struct gnttab_copy ops [ GNTDEV_COPY_BATCH ] ;  struct page * pages [ GNTDEV_COPY_BATCH ] ;  s16 __user * status [ GNTDEV_COPY_BATCH ] ;  unsigned int nr_ops ;  unsigned int nr_pages ; } cocci_id@p ;
...
position p;
@@
 struct ioctl_gntdev_unmap_notify cocci_id@p ;
