...
typedef u_short;
@@
 void cocci_id@p ( struct s_smc * smc , struct s_pcon * pcon , u_short para , int index , int local ) ;
...
typedef u_short;
@@
 const struct s_p_tab * cocci_id@p ( u_short para ) ;
...
position p;
@@
 int cocci_id@p ( struct s_smc * smc , int p ) ;
...
position p;
@@
 int cocci_id@p ( struct s_smc * smc , struct smt_header * sm ) ;
...
position p;
@@
 int cocci_id@p ( struct s_smc * smc , struct smt_para * pa , int index , int local , int set ) ;
...
position p;
@@
 const struct s_p_tab * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_short,u_char;
@@
 const struct s_p_tab {  u_short p_num ;  u_char p_access ;  u_short p_offset ;  char p_swap [ 3 ] ; } cocci_id@p [ ] ;
