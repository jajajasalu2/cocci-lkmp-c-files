...
position p;
@@
 struct ltc4151_data * cocci_id@p ;
...
typedef u8,bool;
@@
 struct ltc4151_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  unsigned int shunt ;  u8 regs [ 6 ] ; } cocci_id@p ;
