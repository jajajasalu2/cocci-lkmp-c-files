...
position p;
@@
 struct s5h1420_state * cocci_id@p ;
...
typedef u8,u32;
@@
 struct s5h1420_state {  struct i2c_adapter * i2c ;  const struct s5h1420_config * config ;  struct dvb_frontend frontend ;  struct i2c_adapter tuner_i2c_adapter ;  u8 CON_1_val ;  u8 postlocked : 1 ;  u32 fclk ;  u32 tunedfreq ;  enum fe_code_rate fec_inner ;  u32 symbol_rate ;  u8 shadow [ 256 ] ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct s5h1420_state * state ) ;
...
position p;
@@
 const struct s5h1420_config * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dvb_frontend * fe , struct dvb_frontend_tune_settings * fesettings ) ;
