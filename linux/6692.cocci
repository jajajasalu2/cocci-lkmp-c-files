...
position p;
@@
 struct qla_image_version_list * cocci_id@p ;
...
position p;
@@
 struct qla_bsg_a84_mgmt * cocci_id@p ;
...
position p;
@@
 struct qla_dport_diag * cocci_id@p ;
...
position p;
@@
 struct qla_image_version * cocci_id@p ;
...
position p;
@@
 struct qla_serdes_reg cocci_id@p ;
...
position p;
@@
 struct qla_flash_update_caps cocci_id@p ;
...
position p;
@@
 struct qla_fcp_prio_cfg * cocci_id@p ;
...
position p;
@@
 struct qla_active_regions cocci_id@p ;
...
position p;
@@
 struct qla_i2c_access * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DMA_POOL_SIZE ] ;
...
position p;
@@
 struct qla_serdes_reg_ex cocci_id@p ;
...
position p;
@@
 struct link_statistics * cocci_id@p ;
...
position p;
@@
 struct qla_port_param * cocci_id@p ;
...
position p;
@@
 struct qla_bbcr_data cocci_id@p ;
...
position p;
@@
 struct qla_status_reg * cocci_id@p ;
