...
position p;
@@
 struct pci_range cocci_id@p [ MAX_PROP_LEN / sizeof ( struct pci_range ) ] ;
...
typedef u32;
@@
 struct pci_range {  u32 flags ;  u32 pci_addr [ 2 ] ;  u32 phys_addr ;  u32 size [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct cs_range cocci_id@p [ MAX_PROP_LEN / sizeof ( struct cs_range ) ] ;
