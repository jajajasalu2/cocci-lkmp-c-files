...
position p;
@@
 enum clk_src { DA9055_CLKSRC_MCLK , } cocci_id@p ;
...
position p;
@@
 struct da9055_priv {  struct regmap * regmap ;  unsigned int mclk_rate ;  int master ;  struct da9055_platform_data * pdata ; } cocci_id@p ;
...
position p;
@@
 struct da9055_platform_data * cocci_id@p ;
...
typedef u8;
@@
 struct pll_div {  int fref ;  int fout ;  u8 frac_top ;  u8 frac_bot ;  u8 integer ;  u8 mode ; } cocci_id@p ;
