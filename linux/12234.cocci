...
symbol cocci_id;
position p;
typedef drm_dma_handle_t;
@@
 drm_dma_handle_t * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * , int , struct drm_buf_entry * ) ;
...
position p;
@@
 struct drm_local_map * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * , int , unsigned long , struct drm_buf * ) ;
...
position p;
@@
 struct drm_buf_info * cocci_id@p ;
