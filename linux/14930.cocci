...
@@
 struct st_clk_quadfs_fsynth {  struct clk_hw hw ;  void __iomem * regs_base ;  spinlock_t * lock ;  struct clkgen_quadfs_data * data ;  u32 chan ;  u32 md ;  u32 pe ;  u32 sdiv ;  u32 nsdiv ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long , const struct stm_fs * , unsigned long * ) ;
...
position p;
@@
 struct clkgen_quadfs_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long input , unsigned long output , struct stm_fs * fs ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long , unsigned long , struct stm_fs * ) ;
...
position p;
@@
 struct st_clk_quadfs_fsynth * cocci_id@p ;
...
position p;
@@
 struct st_clk_quadfs_pll * cocci_id@p ;
...
position p;
@@
 const struct clkgen_quadfs_data cocci_id@p ;
...
position p;
@@
 struct stm_fs {  unsigned long ndiv ;  unsigned long mdiv ;  unsigned long pe ;  unsigned long sdiv ;  unsigned long nsdiv ; } cocci_id@p ;
...
position p;
@@
 const struct stm_fs * cocci_id@p ;
...
typedef u32,spinlock_t;
@@
 struct st_clk_quadfs_pll {  struct clk_hw hw ;  void __iomem * regs_base ;  spinlock_t * lock ;  struct clkgen_quadfs_data * data ;  u32 ndiv ; } cocci_id@p ;
