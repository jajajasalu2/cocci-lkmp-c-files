...
position p;
@@
 enum { BASE_DATA = 0 , BASE_IFACE , BASE_MAX , } cocci_id@p ;
...
position p;
@@
 struct {  struct device * dev ;  struct mutex lock ;  int irq ;  struct completion cmd_complete ;  void __iomem * base [ RESERVED_IPC ] [ BASE_MAX ] ;  IPC_TYPE type ; } cocci_id@p ;
