...
position p;
@@
 struct ifla_vlan_qos_mapping cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_VLAN_QOS_MAX + 1 ] ;
...
position p;
@@
 struct ifla_vlan_flags cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_VLAN_MAX + 1 ] ;
