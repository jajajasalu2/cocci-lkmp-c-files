...
position p;
@@
 struct sp5100_tco {  struct watchdog_device wdd ;  void __iomem * tcobase ;  enum tco_reg_layout tco_reg_layout ; } cocci_id@p ;
...
position p;
@@
 enum tco_reg_layout { sp5100 , sb800 , efch , } cocci_id@p ;
...
position p;
@@
 enum tco_reg_layout cocci_id@p ;
