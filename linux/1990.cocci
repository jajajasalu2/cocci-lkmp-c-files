...
@@
 struct ad5761_state {  struct spi_device * spi ;  struct regulator * vref_reg ;  bool use_intref ;  int vref ;  enum ad5761_voltage_range range ;  union {  __be32 d32 ;  u8 d8 [ 4 ] ; } data [ 3 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ad5761_state * cocci_id@p ;
...
position p;
@@
 struct ad5761_range_params {  int m ;  int c ; } cocci_id@p ;
...
position p;
@@
 enum ad5761_voltage_range cocci_id@p ;
...
position p;
@@
 struct ad5761_chip_info {  unsigned long int_vref ;  const struct iio_chan_spec channel ; } cocci_id@p ;
...
position p;
@@
 enum ad5761_supported_device_ids { ID_AD5721 , ID_AD5721R , ID_AD5761 , ID_AD5761R , } cocci_id@p ;
...
position p;
@@
 const struct ad5761_chip_info * cocci_id@p ;
...
position p;
@@
 const struct ad5761_range_params cocci_id@p [ ] ;
...
position p;
@@
 struct ad5761_platform_data * cocci_id@p ;
