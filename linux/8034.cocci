...
position p;
@@
 struct iproc_mdiomux_desc * cocci_id@p ;
...
position p;
@@
 struct iproc_mdiomux_desc {  void * mux_handle ;  void __iomem * base ;  struct device * dev ;  struct mii_bus * mii_bus ;  struct clk * core_clk ; } cocci_id@p ;
