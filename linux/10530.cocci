...
position p;
@@
 RV770_SMC_HW_PERFORMANCE_LEVEL * cocci_id@p ;
...
position p;
@@
 RV7XX_SMC_MCLK_VALUE * cocci_id@p ;
...
position p;
@@
 RV770_SMC_SCLK_VALUE * cocci_id@p ;
...
position p;
@@
 RV770_SMC_VOLTAGE_VALUE * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RV770_SMC_PERFORMANCE_LEVELS_PER_SWSTATE ] ;
...
position p;
@@
 RV770_SMC_STATETABLE * cocci_id@p ;
