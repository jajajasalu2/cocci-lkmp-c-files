...
position p;
@@
 enum ibus_state { SYNC , COLLECT , PROCESS , } cocci_id@p ;
...
position p;
@@
 struct fsia6b {  struct input_dev * dev ;  struct ibus_packet packet ;  char phys [ 32 ] ; } cocci_id@p ;
...
typedef u16;
@@
 struct ibus_packet {  enum ibus_state state ;  int offset ;  u16 ibuf ;  u16 channel [ IBUS_SERVO_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ IBUS_SERVO_COUNT ] ;
