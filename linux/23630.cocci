...
position p;
@@
 const struct sun4i_codec_quirks * cocci_id@p ;
...
position p;
@@
 struct sun4i_codec {  struct device * dev ;  struct regmap * regmap ;  struct clk * clk_apb ;  struct clk * clk_module ;  struct reset_control * rst ;  struct gpio_desc * gpio_pa ;  struct regmap_field * reg_adc_fifoc ;  struct snd_dmaengine_dai_dma_data capture_dma_data ;  struct snd_dmaengine_dai_dma_data playback_dma_data ; } cocci_id@p ;
...
position p;
@@
 struct snd_soc_aux_dev cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( sun6i_codec_mic_gain_scale , 
								 0 , 0 , 
...
typedef bool;
@@
 struct sun4i_codec_quirks {  const struct regmap_config * regmap_config ;  const struct snd_soc_component_driver * codec ;  struct snd_soc_card * ( * create_card ) ( struct device * dev ) ;  struct reg_field reg_adc_fifoc ;  unsigned int reg_dac_txdata ;  unsigned int reg_adc_rxdata ;  bool has_reset ; } cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( sun6i_codec_out_mixer_pregain_scale , 
								 - 450 , 150 , 0 ) ;
...
position p;
@@
 const  cocci_id@p ( sun6i_codec_lineout_vol_scale , 
								 0 , 1 , 
