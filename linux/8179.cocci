...
position p;
@@
 struct sgiseeq_private cocci_id@p ;
...
position p;
@@
 struct sgiseeq_rx_desc cocci_id@p ;
...
position p;
@@
 struct sgiseeq_platform_data * cocci_id@p ;
...
typedef u8;
@@
 struct sgiseeq_tx_desc {  volatile struct hpc_dma_desc tdma ;  u8 padding [ PAD_SIZE ] ;  struct sk_buff * skb ; } cocci_id@p ;
...
position p;
@@
 struct sgiseeq_tx_desc * cocci_id@p ;
...
typedef u8;
@@
 struct sgiseeq_rx_desc {  volatile struct hpc_dma_desc rdma ;  u8 padding [ PAD_SIZE ] ;  struct sk_buff * skb ; } cocci_id@p ;
...
position p;
@@
 struct hpc3_ethregs * cocci_id@p ;
...
position p;
@@
 struct sgiseeq_init_block * cocci_id@p ;
...
position p;
@@
 struct sgiseeq_init_block {  struct sgiseeq_rx_desc rxvector [ SEEQ_RX_BUFFERS ] ;  struct sgiseeq_tx_desc txvector [ SEEQ_TX_BUFFERS ] ; } cocci_id@p ;
...
position p;
@@
 struct hpc_dma_desc cocci_id@p ;
...
position p;
@@
 struct sgiseeq_regs * cocci_id@p ;
