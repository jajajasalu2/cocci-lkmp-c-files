...
position p;
@@
 struct at91_pmx_func * cocci_id@p ;
...
position p;
@@
 const struct at91_pin_group * cocci_id@p ;
...
position p;
@@
 struct at91_pinctrl * cocci_id@p ;
...
position p;
@@
 struct platform_driver * constcocci_id [ ] ;
...
position p;
@@
 struct at91_pmx_func {  const char * name ;  const char * * groups ;  unsigned ngroups ; } cocci_id@p ;
...
position p;
@@
 struct at91_gpio_chip * cocci_id@p ;
...
position p;
@@
 struct at91_gpio_chip * cocci_id@p [ MAX_GPIO_BANKS ] ;
...
position p;
@@
 struct at91_pinctrl_mux_ops * cocci_id@p ;
...
typedef uint32_t;
@@
 struct at91_pinctrl {  struct device * dev ;  struct pinctrl_dev * pctl ;  int nactive_banks ;  uint32_t * mux_mask ;  int nmux ;  struct at91_pmx_func * functions ;  int nfunctions ;  struct at91_pin_group * groups ;  int ngroups ;  struct at91_pinctrl_mux_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct at91_pmx_pin * cocci_id@p ;
...
position p;
@@
 const struct at91_pmx_pin * cocci_id@p ;
...
position p;
@@
 struct at91_pin_group {  const char * name ;  struct at91_pmx_pin * pins_conf ;  unsigned int * pins ;  unsigned npins ; } cocci_id@p ;
...
position p;
@@
 struct at91_pin_group cocci_id@p ;
...
position p;
@@
 enum slewrate_bit { SLEWRATE_BIT_ENA , SLEWRATE_BIT_DIS , } cocci_id@p ;
...
position p;
@@
 enum at91_mux { AT91_MUX_GPIO = 0 , AT91_MUX_PERIPH_A = 1 , AT91_MUX_PERIPH_B = 2 , AT91_MUX_PERIPH_C = 3 , AT91_MUX_PERIPH_D = 4 , } cocci_id@p ;
...
position p;
@@
 const struct at91_pinctrl * cocci_id@p ;
...
typedef uint32_t;
@@
 struct at91_pmx_pin {  uint32_t bank ;  uint32_t pin ;  enum at91_mux mux ;  unsigned long conf ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct irq_data * d , unsigned type ) ;
...
position p;
@@
 struct at91_gpio_chip {  struct gpio_chip chip ;  struct pinctrl_gpio_range range ;  struct at91_gpio_chip * next ;  int pioc_hwirq ;  int pioc_virq ;  int pioc_idx ;  void __iomem * regbase ;  struct clk * clock ;  struct at91_pinctrl_mux_ops * ops ; } cocci_id@p ;
...
position p;
@@
 enum drive_strength_bit { DRIVE_STRENGTH_BIT_DEF , DRIVE_STRENGTH_BIT_LOW , DRIVE_STRENGTH_BIT_MED , DRIVE_STRENGTH_BIT_HI , } cocci_id@p ;
...
position p;
@@
 const struct at91_pinctrl_mux_ops cocci_id@p ;
