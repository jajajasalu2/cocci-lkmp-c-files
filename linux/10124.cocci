...
position p;
@@
 enum netdev_lag_hash cocci_id@p ;
...
position p;
@@
 const struct bond_opt_value * cocci_id@p ;
...
position p;
@@
 enum netdev_lag_tx_type cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * bond_dev , struct rtnl_link_stats64 * stats ) ;
...
position p;
@@
 struct bond_opt_value cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct bonding * bond , unsigned long last_act , int mod ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( const struct sk_buff * , struct bonding * , struct slave * ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * bond_dev ) ;
...
position p;
@@
 struct bond_up_slave cocci_id@p ;
...
position p;
@@
 struct ad_slave_info cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ BOND_MAX_ARP_TARGETS ] ;
...
position p;
@@
 struct reciprocal_value cocci_id@p ;
...
position p;
@@
 struct bond_vlan_tag * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * bond_dev ) ;
...
position p;
@@
 struct alb_bond_info * cocci_id@p ;
