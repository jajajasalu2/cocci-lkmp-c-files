...
position p;
@@
 struct ocfs2_filecheck_entry cocci_id@p ;
...
position p;
@@
 struct ocfs2_filecheck_args cocci_id@p ;
...
position p;
@@
 struct ocfs2_filecheck_sysfs_entry cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_filecheck_sysfs_entry * ent , unsigned int count ) ;
...
position p;
@@
 struct ocfs2_filecheck_args {  unsigned int fa_type ;  union {  unsigned long fa_ino ;  unsigned int fa_len ; } ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ OCFS2_FILECHECK_ARGS_LEN ] ;
...
position p;
@@
 struct ocfs2_filecheck_entry {  struct list_head fe_list ;  unsigned long fe_ino ;  unsigned int fe_type ;  unsigned int fe_done : 1 ;  unsigned int fe_status : 31 ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_filecheck * cocci_id@p ;
