...
position p;
@@
 struct snd_soc_tplg_stream cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_link_config_v4 * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_pcm_v4 cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct soc_enum * se ) ;
...
position p;
@@
 struct snd_soc_tplg_dapm_graph_elem cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_ctl_tlv * cocci_id@p ;
...
position p;
@@
 struct soc_tplg_map {  int uid ;  int kid ; } cocci_id@p ;
...
position p;
@@
 struct snd_soc_pcm_stream * cocci_id@p ;
...
position p;
@@
 const struct soc_tplg_map cocci_id@p [ ] ;
...
position p;
@@
 struct snd_soc_tplg_hdr * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_stream_caps_v4 * cocci_id@p ;
...
typedef u8,u32;
@@
 struct soc_tplg {  const struct firmware * fw ;  const u8 * pos ;  const u8 * hdr_pos ;  unsigned int pass ;  struct device * dev ;  struct snd_soc_component * comp ;  u32 index ;  u32 req_index ;  const struct snd_soc_tplg_kcontrol_ops * io_ops ;  int io_ops_count ;  const struct snd_soc_tplg_bytes_ext_ops * bytes_ext_ops ;  int bytes_ext_ops_count ;  struct snd_soc_tplg_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct snd_soc_dai_link_component * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct soc_tplg * tplg ) ;
...
position p;
@@
 void cocci_id@p ( struct soc_tplg * tplg ) ;
...
position p;
@@
 struct snd_soc_tplg_dai * cocci_id@p ;
...
position p;
@@
 const struct soc_tplg * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_tlv_dbscale * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_manifest_v4 * cocci_id@p ;
...
position p;
@@
 struct snd_soc_tplg_channel * cocci_id@p ;
