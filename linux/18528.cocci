...
position p;
@@
 enum omap_dma_channel_mode cocci_id@p ;
...
position p;
@@
 struct omap_dma_channel_params * cocci_id@p ;
...
position p;
@@
 enum { DMA_CH_ALLOC_DONE , DMA_CH_PARAMS_SET_DONE , DMA_CH_STARTED , DMA_CH_QUEUED , DMA_CH_NOTSTARTED , DMA_CH_PAUSED , DMA_CH_LINK_ENABLED , } cocci_id@p ;
...
position p;
@@
 enum omap_dma_burst_mode cocci_id@p ;
...
typedef u32;
@@
 struct omap_dma_global_context_registers {  u32 dma_irqenable_l0 ;  u32 dma_irqenable_l1 ;  u32 dma_ocp_sysconfig ;  u32 dma_gcr ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int lch , unsigned char read_prio , unsigned char write_prio ) ;
...
typedef u16;
@@
 void ( * cocci_id@p ) ( int lch , u16 ch_status , void * data ) ;
...
position p;
@@
 struct omap_dma_dev_attr * cocci_id@p ;
...
position p;
@@
 enum omap_dma_write_mode cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_LOGICAL_DMA_CH_COUNT ] ;
...
position p;
@@
 struct dma_link_info * cocci_id@p ;
...
position p;
@@
 struct omap_system_dma_plat_info * cocci_id@p ;
...
position p;
@@
 struct dma_link_info {  int * linked_dmach_q ;  int no_of_lchs_linked ;  int q_count ;  int q_tail ;  int q_head ;  int chain_state ;  int chain_mode ; } cocci_id@p ;
...
position p;
@@
 enum { DMA_CHAIN_STARTED , DMA_CHAIN_NOTSTARTED , } cocci_id@p ;
...
position p;
@@
 struct omap_dma_lch * cocci_id@p ;
