...
position p;
@@
 unsigned long long int cocci_id@p ;
...
position p;
@@
 struct max98095_cdata * cocci_id@p ;
...
typedef u8,u32;
@@
 const struct {  u32 rate ;  u8 sr ; } cocci_id@p [ ] ;
...
position p;
@@
 enum max98095_type { MAX98095 , } cocci_id@p ;
...
position p;
@@
 struct max98095_eq_cfg * cocci_id@p ;
...
position p;
@@
 struct max98095_biquad_cfg * cocci_id@p ;
...
position p;
@@
 struct max98095_pdata * cocci_id@p ;
...
position p;
@@
 struct max98095_priv cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( max98095_micboost_tlv , 
							      0 , 1 , 
...
position p;
@@
 const  cocci_id@p ( max98095_spk_tlv , 
							      0 , 10 , 
...
position p;
@@
 const  cocci_id@p ( max98095_lin_tlv , 
							      0 , 2 , 
...
position p;
@@
 const  cocci_id@p ( max98095_rcv_lout_tlv , 
							      0 , 6 , 
...
position p;
@@
 const  cocci_id@p ( max98095_hp_tlv , 
							      0 , 6 , 
...
position p;
@@
 struct max98095_cdata {  unsigned int rate ;  unsigned int fmt ;  int eq_sel ;  int bq_sel ; } cocci_id@p ;
...
typedef u8;
@@
 struct max98095_priv {  struct regmap * regmap ;  enum max98095_type devtype ;  struct max98095_pdata * pdata ;  struct clk * mclk ;  unsigned int sysclk ;  struct max98095_cdata dai [ 3 ] ;  const char * * eq_texts ;  const char * * bq_texts ;  struct soc_enum eq_enum ;  struct soc_enum bq_enum ;  int eq_textcnt ;  int bq_textcnt ;  u8 lin_state ;  unsigned int mic1pre ;  unsigned int mic2pre ;  struct snd_soc_jack * headphone_jack ;  struct snd_soc_jack * mic_jack ;  struct mutex lock ; } cocci_id@p ;
