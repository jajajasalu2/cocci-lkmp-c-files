...
position p;
@@
 struct hns_roce_ib_create_qp * cocci_id@p ;
...
position p;
@@
 struct hns_roce_buf_region * cocci_id@p ;
...
position p;
@@
 struct hns_roce_rinl_wqe * cocci_id@p ;
...
typedef dma_addr_t;
@@
 dma_addr_t * cocci_id@p [ ARRAY_SIZE ( hr_qp -> regions ) ] ;
...
position p;
@@
 struct hns_roce_qp_table * cocci_id@p ;
...
position p;
@@
 struct hns_roce_ib_create_qp_resp cocci_id@p ;
...
position p;
@@
 enum hns_roce_event cocci_id@p ;
