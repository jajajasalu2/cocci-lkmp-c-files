...
position p;
@@
 const struct reiserfs_key * cocci_id@p ;
...
typedef b_blocknr_t;
@@
 b_blocknr_t cocci_id@p [ SEARCH_BY_KEY_READA ] ;
...
position p;
@@
 const struct item_head * cocci_id@p ;
...
position p;
@@
 const struct treepath * cocci_id@p ;
...
position p;
@@
 struct path_element * cocci_id@p ;
...
position p;
@@
 struct buffer_head * cocci_id@p [ SEARCH_BY_KEY_READA ] ;
