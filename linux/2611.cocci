...
position p;
@@
 struct stm32_romem_priv * cocci_id@p ;
...
position p;
@@
 const struct stm32_romem_cfg * cocci_id@p ;
...
position p;
@@
 struct stm32_romem_cfg {  int size ; } cocci_id@p ;
...
position p;
@@
 struct stm32_romem_priv {  void __iomem * base ;  struct nvmem_config cfg ; } cocci_id@p ;
