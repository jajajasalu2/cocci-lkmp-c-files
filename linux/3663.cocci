...
typedef u8;
@@
 struct scmi_msg_resp_clock_protocol_attributes {  __le16 num_clocks ;  u8 max_async_req ;  u8 reserved ; } cocci_id@p ;
...
position p;
@@
 struct scmi_clk_ops cocci_id@p ;
...
position p;
@@
 struct scmi_msg_resp_clock_attributes * cocci_id@p ;
...
position p;
@@
 struct scmi_clock_set_rate * cocci_id@p ;
...
typedef atomic_t;
@@
 struct clock_info {  int num_clocks ;  int max_async_req ;  atomic_t cur_async_req ;  struct scmi_clock_info * clk ; } cocci_id@p ;
...
position p;
@@
 struct scmi_clock_set_config * cocci_id@p ;
...
position p;
@@
 const struct scmi_clock_info * cocci_id@p ;
...
position p;
@@
 struct scmi_msg_resp_clock_describe_rates * cocci_id@p ;
...
position p;
@@
 struct scmi_clock_info * cocci_id@p ;
...
position p;
@@
 enum scmi_clock_protocol_cmd { CLOCK_ATTRIBUTES = 0x3 , CLOCK_DESCRIBE_RATES = 0x4 , CLOCK_RATE_SET = 0x5 , CLOCK_RATE_GET = 0x6 , CLOCK_CONFIG_SET = 0x7 , } cocci_id@p ;
...
position p;
@@
 struct scmi_msg_clock_describe_rates * cocci_id@p ;
...
position p;
@@
 struct scmi_msg_resp_clock_protocol_attributes * cocci_id@p ;
...
typedef __le32;
@@
 struct scmi_msg_clock_describe_rates {  __le32 id ;  __le32 rate_index ; } cocci_id@p ;
...
typedef __le32;
@@
 struct scmi_clock_set_config {  __le32 id ;  __le32 attributes ; } cocci_id@p ;
