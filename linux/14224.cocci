...
position p;
@@
 struct hfi_uncompressed_format_supported * cocci_id@p ;
...
position p;
@@
 struct raw_formats cocci_id@p [ MAX_FMT_ENTRIES ] ;
...
position p;
@@
 const struct hfi_max_sessions_supported * cocci_id@p ;
...
position p;
@@
 struct hfi_capabilities * cocci_id@p ;
...
position p;
@@
 struct hfi_uncompressed_plane_constraints * cocci_id@p ;
...
position p;
@@
 struct hfi_uncompressed_plane_info * cocci_id@p ;
...
position p;
@@
 const struct raw_formats * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct venus_caps * cap , const void * data , unsigned int size ) ;
...
position p;
@@
 struct hfi_buffer_alloc_mode_supported * cocci_id@p ;
...
position p;
@@
 const struct hfi_profile_level * cocci_id@p ;
...
position p;
@@
 struct hfi_profile_level_supported * cocci_id@p ;
...
position p;
@@
 struct hfi_capability * cocci_id@p ;
...
position p;
@@
 struct hfi_codec_mask_supported * cocci_id@p ;
...
position p;
@@
 struct hfi_codec_supported * cocci_id@p ;
...
position p;
@@
 struct hfi_capability cocci_id@p [ MAX_CAP_ENTRIES ] ;
...
position p;
@@
 struct hfi_profile_level cocci_id@p [ HFI_MAX_PROFILE_COUNT ] ;
...
position p;
@@
 const struct hfi_capability * cocci_id@p ;
