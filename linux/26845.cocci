...
position p;
@@
 struct stat_data_v1 * cocci_id@p ;
...
position p;
@@
 struct reiserfs_security_handle * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct file * f , struct page * page , unsigned from , unsigned to ) ;
...
position p;
@@
 const struct cpu_key * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ EMPTY_DIR_SIZE ] ;
