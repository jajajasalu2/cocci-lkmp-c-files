...
position p;
@@
 void ( * cocci_id@p ) ( struct parisc_device * , void * ) ;
...
position p;
@@
 struct gsc_fixup_struct {  void ( * choose_irq ) ( struct parisc_device * , void * ) ;  void * ctrl ; } cocci_id@p ;
...
position p;
@@
 struct gsc_fixup_struct cocci_id@p ;
