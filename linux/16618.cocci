...
position p;
@@
 const struct zfcp_diag_adapter * const cocci_id@p ;
...
position p;
@@
 unsigned long * const cocci_id@p ;
...
position p;
@@
 const struct zfcp_diag_header * const cocci_id@p ;
...
position p;
@@
 struct zfcp_diag_adapter * cocci_id@p ;
...
position p;
@@
 zfcp_diag_update_buffer_func cocci_id@p ;
