...
position p;
@@
 void cocci_id@p ( struct hypfs_diag0c_entry * entry ) ;
...
position p;
@@
 int cocci_id@p ( struct diag210 * addr ) ;
...
position p;
@@
 int cocci_id@p ( void * req , void * resp , enum diag26c_sc subcode ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long rx , unsigned long ry1 , unsigned long subcode ) ;
