...
position p;
@@
 struct lp8788_rtc {  struct lp8788 * lp ;  struct rtc_device * rdev ;  enum lp8788_alarm_sel alarm ;  int irq ; } cocci_id@p ;
...
position p;
@@
 enum lp8788_time { LPTIME_SEC , LPTIME_MIN , LPTIME_HOUR , LPTIME_MDAY , LPTIME_MON , LPTIME_YEAR , LPTIME_WDAY , LPTIME_MAX , } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ LP8788_ALARM_MAX ] ;
