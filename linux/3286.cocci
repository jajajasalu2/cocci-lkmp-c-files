...
position p;
@@
 struct ltc4261_data * cocci_id@p ;
...
typedef u8,bool;
@@
 struct ltc4261_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  u8 regs [ 10 ] ; } cocci_id@p ;
