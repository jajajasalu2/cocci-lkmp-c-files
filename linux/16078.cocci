...
position p;
@@
 const struct dt282x_board cocci_id@p [ ] ;
...
position p;
@@
 struct dt282x_private * cocci_id@p ;
...
position p;
@@
 struct dt282x_private {  struct comedi_isadma * dma ;  unsigned int ad_2scomp : 1 ;  unsigned int divisor ;  int dacsr ;  int adcsr ;  int supcsr ;  int ntrig ;  int nread ;  int dma_dir ; } cocci_id@p ;
...
position p;
@@
 struct dt282x_board {  const char * name ;  unsigned int ai_maxdata ;  int adchan_se ;  int adchan_di ;  int ai_speed ;  int ispgl ;  int dachan ;  unsigned int ao_maxdata ; } cocci_id@p ;
...
position p;
@@
 struct dt282x_board cocci_id@p ;
