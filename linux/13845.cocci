...
position p;
@@
 const struct img_ir_symbol_timing * cocci_id@p ;
...
position p;
@@
 struct img_ir_decoder * cocci_id@p [ ] ;
...
position p;
@@
 struct img_ir_symbol_timing * cocci_id@p ;
...
position p;
@@
 const struct img_ir_timing_range * cocci_id@p ;
...
position p;
@@
 const struct img_ir_control * cocci_id@p ;
...
position p;
@@
 enum rc_filter_type cocci_id@p ;
...
position p;
@@
 struct img_ir_filter cocci_id@p ;
...
position p;
@@
 struct img_ir_priv_hw * cocci_id@p ;
...
position p;
@@
 struct img_ir_timing_regvals * cocci_id@p ;
...
position p;
@@
 struct img_ir_timing_range cocci_id@p ;
...
position p;
@@
 struct img_ir_timings * cocci_id@p ;
...
position p;
@@
 const struct img_ir_timings * cocci_id@p ;
...
position p;
@@
 struct img_ir_reg_timings * cocci_id@p ;
...
position p;
@@
 const struct img_ir_free_timing * cocci_id@p ;
...
position p;
@@
 const struct img_ir_decoder * cocci_id@p ;
...
position p;
@@
 struct img_ir_scancode_req cocci_id@p ;
