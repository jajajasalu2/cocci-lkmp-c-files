...
typedef __u32;
@@
 void cocci_id@p ( struct btf_dump * d , __u32 id , const struct btf_type * t ) ;
...
typedef __u8;
@@
 struct btf_dump_type_aux_state {  enum btf_dump_type_order_state order_state : 2 ;  enum btf_dump_type_emit_state emit_state : 2 ;  __u8 fwd_emitted : 1 ;  __u8 name_resolved : 1 ;  __u8 referenced : 1 ; } cocci_id@p ;
...
typedef __u32;
@@
 void cocci_id@p ( struct btf_dump * d , __u32 id , const struct btf_type * t , int lvl ) ;
...
position p;
@@
 const struct btf_dump * cocci_id@p ;
...
position p;
@@
 const struct btf_dump_opts * cocci_id@p ;
...
typedef bool,__u32;
@@
 int cocci_id@p ( struct btf_dump * d , __u32 id , bool through_ptr ) ;
...
position p;
@@
 size_t cocci_id@p ( struct btf_dump * d , struct hashmap * name_map , const char * orig_name ) ;
...
symbol cocci_id;
position p;
typedef btf_dump_printf_fn_t;
@@
 btf_dump_printf_fn_t cocci_id@p ;
...
typedef __u32;
@@
 struct id_stack {  const __u32 * ids ;  int cnt ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btf_dump * d , struct id_stack * decl_stack , const char * fname , int lvl ) ;
...
typedef __u32;
@@
 const char * cocci_id@p ( struct btf_dump * d , __u32 id ) ;
...
position p;
@@
 enum btf_dump_type_order_state { NOT_ORDERED , ORDERING , ORDERED , } cocci_id@p ;
...
typedef __u32;
@@
 void cocci_id@p ( struct btf_dump * d , __u32 id , __u32 cont_id ) ;
...
position p;
@@
 int cocci_id@p ( struct btf_dump * d ) ;
...
position p;
@@
 enum btf_dump_type_emit_state { NOT_EMITTED , EMITTING , EMITTED , } cocci_id@p ;
...
typedef __u32;
@@
 void cocci_id@p ( struct btf_dump * d , __u32 id , const char * fname , int lvl ) ;
...
symbol cocci_id;
position p;
typedef __u32,btf_dump_printf_fn_t;
@@
 struct btf_dump {  const struct btf * btf ;  const struct btf_ext * btf_ext ;  btf_dump_printf_fn_t printf_fn ;  struct btf_dump_opts opts ;  struct btf_dump_type_aux_state * type_states ;  const char * * cached_names ;  __u32 * emit_queue ;  int emit_queue_cap ;  int emit_queue_cnt ;  __u32 * decl_stack ;  int decl_stack_cap ;  int decl_stack_cnt ;  struct hashmap * type_names ;  struct hashmap * ident_names ; } cocci_id@p ;
...
position p;
@@
 struct btf_dump_type_aux_state * cocci_id@p ;
