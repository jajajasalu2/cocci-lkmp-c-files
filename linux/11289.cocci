...
position p;
@@
 const struct psb_offset * cocci_id@p ;
...
typedef gma_limit_t;
@@
 const struct gma_limit_t * cocci_id@p ;
...
position p;
@@
 struct psb_intel_crtc_state * cocci_id@p ;
...
position p;
@@
 const struct gma_clock_funcs * cocci_id@p ;
