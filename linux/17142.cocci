...
position p;
@@
 eeh_pe_traverse_func cocci_id@p ;
...
position p;
@@
 struct eeh_pe_get_flag * cocci_id@p ;
...
position p;
@@
 eeh_edev_traverse_func cocci_id@p ;
...
position p;
@@
 struct eeh_pe_get_flag {  int pe_no ;  int config_addr ; } cocci_id@p ;
