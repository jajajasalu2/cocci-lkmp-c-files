...
position p;
@@
 const struct l3cache_event_ops cocci_id@p ;
...
typedef cpumask_t;
@@
 struct l3cache_pmu {  struct pmu pmu ;  struct hlist_node node ;  void __iomem * regs ;  struct perf_event * events [ L3_NUM_COUNTERS ] ;  unsigned long used_mask [ BITS_TO_LONGS ( L3_NUM_COUNTERS ) ] ;  cpumask_t cpumask ; } cocci_id@p ;
