...
typedef u8;
@@
 void cocci_id@p ( struct at86rf230_local * lp , struct at86rf230_state_change * ctx , const u8 state , void ( * complete ) ( void * context ) ) ;
...
position p;
@@
 struct at86rf2xx_chip_data * cocci_id@p ;
...
typedef u8,s32,u16;
@@
 struct at86rf2xx_chip_data {  u16 t_sleep_cycle ;  u16 t_channel_switch ;  u16 t_reset_to_off ;  u16 t_off_to_aack ;  u16 t_off_to_tx_on ;  u16 t_off_to_sleep ;  u16 t_sleep_to_off ;  u16 t_frame ;  u16 t_p_ack ;  int rssi_base_val ;  int ( * set_channel ) ( struct at86rf230_local * , u8 , u8 ) ;  int ( * set_txpower ) ( struct at86rf230_local * , s32 ) ; } cocci_id@p ;
...
position p;
@@
 struct at86rf230_state_change cocci_id@p ;
...
position p;
@@
 struct at86rf230_platform_data * cocci_id@p ;
...
position p;
@@
 struct at86rf230_local cocci_id@p ;
...
typedef u8,bool;
@@
 struct at86rf230_state_change {  struct at86rf230_local * lp ;  int irq ;  struct hrtimer timer ;  struct spi_message msg ;  struct spi_transfer trx ;  u8 buf [ AT86RF2XX_MAX_BUF ] ;  void ( * complete ) ( void * context ) ;  u8 from_state ;  u8 to_state ;  bool free ; } cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ AT86RF2XX_MAX_ED_LEVELS + 1 ] ;
...
typedef u8,bool;
@@
 struct at86rf230_local {  struct spi_device * spi ;  struct ieee802154_hw * hw ;  struct at86rf2xx_chip_data * data ;  struct regmap * regmap ;  int slp_tr ;  bool sleep ;  struct completion state_complete ;  struct at86rf230_state_change state ;  unsigned long cal_timeout ;  bool is_tx ;  bool is_tx_from_off ;  u8 tx_retry ;  struct sk_buff * tx_skb ;  struct at86rf230_state_change tx ;  struct at86rf230_trac trac ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ DNAME_INLINE_LEN + 1 ] ;
...
typedef s32;
@@
 const s32 cocci_id@p [ AT86RF23X_MAX_TX_POWERS + 1 ] ;
...
position p;
@@
 struct at86rf230_trac cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ AT86RF212_MAX_TX_POWERS + 1 ] ;
...
typedef u64;
@@
 struct at86rf230_trac {  u64 success ;  u64 success_data_pending ;  u64 success_wait_for_ack ;  u64 channel_access_failure ;  u64 no_ack ;  u64 invalid ; } cocci_id@p ;
