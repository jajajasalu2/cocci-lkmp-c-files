...
position p;
@@
 struct btrfs_dir_list * cocci_id@p ;
...
position p;
@@
 enum { LOG_WALK_PIN_ONLY , LOG_WALK_REPLAY_INODES , LOG_WALK_REPLAY_DIR_INDEX , LOG_WALK_REPLAY_ALL , } cocci_id@p ;
...
typedef u64;
@@
 struct btrfs_dir_list {  u64 ino ;  struct list_head list ; } cocci_id@p ;
...
typedef loff_t;
@@
 int cocci_id@p ( struct btrfs_trans_handle * trans , struct btrfs_root * root , struct btrfs_inode * inode , int inode_only , const loff_t start , const loff_t end , struct btrfs_log_ctx * ctx ) ;
...
typedef u64;
@@
 int cocci_id@p ( struct btrfs_trans_handle * trans , struct btrfs_root * root , struct btrfs_path * path , u64 objectid ) ;
...
typedef u64;
@@
 struct btrfs_ino_list {  u64 ino ;  u64 parent ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct btrfs_dir_log_item cocci_id@p ;
...
position p;
@@
 struct btrfs_ino_list cocci_id@p ;
...
position p;
@@
 enum { LOG_INODE_ALL , LOG_INODE_EXISTS , LOG_OTHER_INODE , LOG_OTHER_INODE_ALL , } cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct btrfs_trans_handle * trans , struct btrfs_root * root , struct btrfs_root * log , struct btrfs_path * path , u64 dirid , int del_all ) ;
...
typedef u64,bool;
@@
 struct walk_control {  int free ;  int write ;  int wait ;  int pin ;  int stage ;  bool ignore_cur_inode ;  struct btrfs_root * replay_dest ;  struct btrfs_trans_handle * trans ;  int ( * process_func ) ( struct btrfs_root * log , struct extent_buffer * eb , struct walk_control * wc , u64 gen , int level ) ; } cocci_id@p ;
...
position p;
@@
 const struct extent_map * cocci_id@p ;
