...
position p;
@@
 struct dynapro {  struct input_dev * dev ;  struct serio * serio ;  int idx ;  unsigned char data [ DYNAPRO_FORMAT_LENGTH ] ;  char phys [ 32 ] ; } cocci_id@p ;
