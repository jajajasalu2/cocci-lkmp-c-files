...
position p;
@@
 struct ErrMsg {  short flags ;  short len ;  char * msg ; } cocci_id@p ;
...
position p;
@@
 enum { MINOR_ERR = 2 , MINOR_DISCOVER , MINOR_INTERFACES , MINOR_REVALIDATE , MINOR_FLUSH , MSGSZ = 2048 , NMSG = 100 , } cocci_id@p ;
...
position p;
@@
 struct aoe_chardev {  ulong minor ;  char name [ 32 ] ; } cocci_id@p ;
