...
position p;
@@
 struct task_move_callback * cocci_id@p ;
...
position p;
@@
 struct task_move_callback {  struct callback_head work ;  struct rdtgroup * rdtgrp ; } cocci_id@p ;
...
position p;
@@
 enum rdt_param { Opt_cdp , Opt_cdpl2 , Opt_mba_mbps , nr__rdt_params , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct kernfs_node * parent_kn , struct rdtgroup * prgrp , struct kernfs_node * * mon_data_kn ) ;
...
position p;
@@
 struct rdt_fs_context cocci_id@p ;
...
position p;
@@
 enum rdt_group_type cocci_id@p ;
...
position p;
@@
 union mon_data_bits cocci_id@p ;
...
position p;
@@
 struct rdt_resource * cocci_id@p ;
