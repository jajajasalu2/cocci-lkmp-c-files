...
position p;
@@
 struct tegra_dsi_state cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ NUM_PKT_SEQ ] ;
...
position p;
@@
 const struct mipi_dphy_timing * cocci_id@p ;
...
position p;
@@
 enum tegra_dsi_format * cocci_id@p ;
...
position p;
@@
 struct tegra_dsi_state {  struct drm_connector_state base ;  struct mipi_dphy_timing timing ;  unsigned long period ;  unsigned int vrefresh ;  unsigned int lanes ;  unsigned long pclk ;  unsigned long bclk ;  enum tegra_dsi_format format ;  unsigned int mul ;  unsigned int div ; } cocci_id@p ;
