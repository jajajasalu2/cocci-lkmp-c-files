...
position p;
@@
 struct printk_safe_seq_buf cocci_id@p ;
...
typedef atomic_t;
@@
 struct printk_safe_seq_buf {  atomic_t len ;  atomic_t message_lost ;  struct irq_work work ;  unsigned char buffer [ SAFE_LOG_BUF_LEN ] ; } cocci_id@p ;
