...
position p;
@@
 struct ti_msgmgr_valid_queue_desc cocci_id@p ;
...
position p;
@@
 const struct ti_msgmgr_desc * cocci_id@p ;
...
position p;
@@
 struct ti_msgmgr_inst cocci_id@p ;
...
typedef u8;
@@
 struct ti_msgmgr_inst {  struct device * dev ;  const struct ti_msgmgr_desc * desc ;  void __iomem * queue_proxy_region ;  void __iomem * queue_state_debug_region ;  void __iomem * queue_ctrl_region ;  u8 num_valid_queues ;  struct ti_queue_inst * qinsts ;  struct mbox_controller mbox ;  struct mbox_chan * chans ; } cocci_id@p ;
...
position p;
@@
 const struct ti_msgmgr_valid_queue_desc cocci_id@p [ ] ;
...
typedef u8,bool;
@@
 struct ti_msgmgr_valid_queue_desc {  u8 queue_id ;  u8 proxy_id ;  bool is_tx ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct ti_queue_inst {  char name [ 30 ] ;  u8 queue_id ;  u8 proxy_id ;  int irq ;  bool is_tx ;  void __iomem * queue_buff_start ;  void __iomem * queue_buff_end ;  void __iomem * queue_state ;  void __iomem * queue_ctrl ;  struct mbox_chan * chan ;  u32 * rx_buff ; } cocci_id@p ;
...
position p;
@@
 struct ti_queue_inst * cocci_id@p ;
