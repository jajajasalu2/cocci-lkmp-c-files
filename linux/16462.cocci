...
typedef u8,bool;
@@
 struct u2fzero_device {  struct hid_device * hdev ;  struct urb * urb ;  struct led_classdev ldev ;  struct hwrng hwrng ;  char * led_name ;  char * rng_name ;  u8 * buf_out ;  u8 * buf_in ;  struct mutex lock ;  bool present ; } cocci_id@p ;
...
position p;
@@
 struct u2f_hid_report * cocci_id@p ;
...
position p;
@@
 struct u2fzero_device cocci_id@p ;
...
position p;
@@
 struct u2fzero_transfer_context * cocci_id@p ;
...
position p;
@@
 struct u2fzero_transfer_context {  struct completion done ;  int status ; } cocci_id@p ;
