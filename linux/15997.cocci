...
position p;
@@
 struct lib80211_crypto_ops * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * ctr_preload , int a4_exists , int qc_exists , u8 * mpdu , u8 * pn_vector , int c ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * key , int round ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * mic_header1 , int header_length , u8 * mpdu ) ;
...
typedef u8;
@@
 void cocci_id@p ( u8 * mic_header2 , u8 * mpdu , int a4_exists , int qc_exists ) ;
...
typedef u8,uint;
@@
 void cocci_id@p ( u8 * mic_header1 , int qc_exists , int a4_exists , u8 * mpdu , uint payload_length , u8 * pn_vector ) ;
