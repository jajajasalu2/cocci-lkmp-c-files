...
position p;
@@
 void ( * cocci_id@p ) ( struct client * , struct client_resource * ) ;
...
position p;
@@
 struct fw_cdev_queue_iso * cocci_id@p ;
...
position p;
@@
 struct outbound_transaction_resource {  struct client_resource resource ;  struct fw_transaction transaction ; } cocci_id@p ;
...
position p;
@@
 struct fw_cdev_event_request * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef client_resource_release_fn_t;
@@
 client_resource_release_fn_t cocci_id@p ;
...
position p;
@@
 struct fw_cdev_send_phy_packet * cocci_id@p ;
...
typedef __u64;
@@
 struct address_handler_resource {  struct client_resource resource ;  struct fw_address_handler handler ;  __u64 closure ;  struct client * client ; } cocci_id@p ;
...
position p;
@@
 struct fw_cdev_event_bus_reset * cocci_id@p ;
...
position p;
@@
 struct iso_interrupt_mc_event {  struct event event ;  struct fw_cdev_event_iso_interrupt_mc interrupt ; } cocci_id@p ;
...
position p;
@@
 struct client_resource * * cocci_id@p ;
...
position p;
@@
 struct inbound_transaction_event {  struct event event ;  union {  struct fw_cdev_event_request request ;  struct fw_cdev_event_request2 request2 ; } req ; } cocci_id@p ;
...
position p;
@@
 struct outbound_phy_packet_event cocci_id@p ;
...
position p;
@@
 struct iso_resource * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct client * client ) ;
...
position p;
@@
 struct fw_cdev_event_response * cocci_id@p ;
...
position p;
@@
 struct event {  struct {  void * data ;  size_t size ; } v [ 2 ] ;  struct list_head link ; } cocci_id@p ;
...
position p;
@@
 struct fw_cdev_flush_iso * cocci_id@p ;
...
position p;
@@
 struct fw_cdev_add_descriptor * cocci_id@p ;
...
position p;
@@
 struct fw_cdev_receive_phy_packets * cocci_id@p ;
...
typedef client_resource_release_fn_t;
@@
 struct client_resource {  client_resource_release_fn_t release ;  int handle ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct client * , union ioctl_arg * ) ;
...
position p;
@@
 struct fw_cdev_start_iso * cocci_id@p ;
...
position p;
@@
 struct inbound_phy_packet_event * cocci_id@p ;
...
position p;
@@
 struct fw_address_region cocci_id@p ;
...
position p;
@@
 struct inbound_transaction_resource {  struct client_resource resource ;  struct fw_card * card ;  struct fw_request * request ;  void * data ;  size_t length ; } cocci_id@p ;
...
position p;
@@
 struct fw_cdev_create_iso_context * cocci_id@p ;
...
position p;
@@
 struct iso_interrupt_mc_event * cocci_id@p ;
...
position p;
@@
 struct iso_resource_event {  struct event event ;  struct fw_cdev_event_iso_resource iso_resource ; } cocci_id@p ;
...
position p;
@@
 struct fw_cdev_event_request2 * cocci_id@p ;
...
position p;
@@
 struct bus_reset_event {  struct event event ;  struct fw_cdev_event_bus_reset reset ; } cocci_id@p ;
...
position p;
@@
 struct fw_cdev_send_request * cocci_id@p ;
...
position p;
@@
 struct fw_iso_context * cocci_id@p ;
...
position p;
@@
 struct fw_cdev_get_info * cocci_id@p ;
...
position p;
@@
 struct address_handler_resource cocci_id@p ;
...
position p;
@@
 struct fw_cdev_send_stream_packet * cocci_id@p ;
...
position p;
@@
 struct bus_reset_event * cocci_id@p ;
...
position p;
@@
 struct iso_interrupt_event {  struct event event ;  struct fw_cdev_event_iso_interrupt interrupt ; } cocci_id@p ;
...
typedef u32;
@@
 struct descriptor_resource {  struct client_resource resource ;  struct fw_descriptor descriptor ;  u32 data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct iso_resource_event * cocci_id@p ;
...
position p;
@@
 struct inbound_phy_packet_event {  struct event event ;  struct fw_cdev_event_phy_packet phy_packet ; } cocci_id@p ;
...
position p;
@@
 struct outbound_transaction_event {  struct event event ;  struct client * client ;  struct outbound_transaction_resource r ;  struct fw_cdev_event_response response ; } cocci_id@p ;
...
position p;
@@
 struct inbound_transaction_resource * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,wait_queue_head_t,spinlock_t;
@@
 struct client {  u32 version ;  struct fw_device * device ;  spinlock_t lock ;  bool in_shutdown ;  struct idr resource_idr ;  struct list_head event_list ;  wait_queue_head_t wait ;  wait_queue_head_t tx_flush_wait ;  u64 bus_reset_closure ;  struct fw_iso_context * iso_context ;  u64 iso_closure ;  struct fw_iso_buffer buffer ;  unsigned long vm_start ;  bool buffer_is_mapped ;  struct list_head phy_receiver_link ;  u64 phy_receiver_closure ;  struct list_head link ;  struct kref kref ; } cocci_id@p ;
...
position p;
@@
 struct outbound_transaction_event * cocci_id@p ;
...
position p;
@@
 struct outbound_phy_packet_event {  struct event event ;  struct client * client ;  struct fw_packet p ;  struct fw_cdev_event_phy_packet phy_packet ; } cocci_id@p ;
...
position p;
@@
 struct fw_cdev_allocate_iso_resource * cocci_id@p ;
...
position p;
@@
 struct fw_cdev_set_iso_channels * cocci_id@p ;
...
typedef u8;
@@
 struct {  struct fw_iso_packet packet ;  u8 header [ 256 ] ; } cocci_id@p ;
...
position p;
@@
 struct fw_cdev_get_cycle_timer * cocci_id@p ;
...
position p;
@@
 struct descriptor_resource cocci_id@p ;
...
position p;
@@
 struct fw_cdev_allocate * cocci_id@p ;
...
position p;
@@
 struct iso_interrupt_event * cocci_id@p ;
...
position p;
@@
 struct fw_cdev_get_cycle_timer2 * cocci_id@p ;
...
typedef u64,s32;
@@
 struct iso_resource {  struct client_resource resource ;  struct client * client ;  struct delayed_work work ;  enum { ISO_RES_ALLOC , ISO_RES_REALLOC , ISO_RES_DEALLOC , ISO_RES_ALLOC_ONCE , ISO_RES_DEALLOC_ONCE , } todo ;  int generation ;  u64 channels ;  s32 bandwidth ;  struct iso_resource_event * e_alloc , * e_dealloc ; } cocci_id@p ;
...
position p;
@@
 struct fw_cdev_stop_iso * cocci_id@p ;
...
position p;
@@
 struct inbound_transaction_event * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fw_iso_callback_t;
@@
 fw_iso_callback_t cocci_id@p ;
...
position p;
@@
 struct fw_cdev_send_response * cocci_id@p ;
