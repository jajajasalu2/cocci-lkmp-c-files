...
position p;
@@
 const struct gp8psk_fe_ops * cocci_id@p ;
...
position p;
@@
 struct gp8psk_fe_state * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct gp8psk_fe_state {  struct dvb_frontend fe ;  void * priv ;  const struct gp8psk_fe_ops * ops ;  bool is_rev1 ;  u8 lock ;  u16 snr ;  unsigned long next_status_check ;  unsigned long status_check_interval ; } cocci_id@p ;
