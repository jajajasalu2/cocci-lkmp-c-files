...
position p;
@@
 const struct cs42l42_irq_params cocci_id@p [ ] ;
...
position p;
@@
 unsigned int cocci_id@p [ CS42L42_NUM_BIASES ] ;
...
typedef u8,u32;
@@
 struct cs42l42_pll_params {  u32 sclk ;  u8 mclk_div ;  u8 mclk_src_sel ;  u8 sclk_prediv ;  u8 pll_div_int ;  u32 pll_div_frac ;  u8 pll_mode ;  u8 pll_divout ;  u32 mclk_int ;  u8 pll_cal_ratio ; } cocci_id@p ;
...
position p;
@@
 const struct cs42l42_pll_params cocci_id@p [ ] ;
...
position p;
@@
 struct cs42l42_private * cocci_id@p ;
...
typedef u8,u16;
@@
 struct cs42l42_irq_params {  u16 status_addr ;  u16 mask_addr ;  u8 mask ; } cocci_id@p ;
