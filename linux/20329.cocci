...
position p;
@@
 struct acpi_processor_flags * cocci_id@p ;
...
position p;
@@
 short cocci_id@p [ ACPI_PROCESSOR_MAX_POWER ] ;
...
position p;
@@
 struct cstate_entry * cocci_id@p ;
...
position p;
@@
 struct cstate_entry {  struct {  unsigned int eax ;  unsigned int ecx ; } states [ ACPI_PROCESSOR_MAX_POWER ] ; } cocci_id@p ;
