...
position p;
@@
 struct qp_list {  struct list_head head ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 struct qp_guest_endpoint cocci_id@p ;
...
position p;
@@
 const struct vmci_qp * cocci_id@p ;
...
position p;
@@
 struct vmci_qp_alloc_msg * cocci_id@p ;
...
position p;
@@
 struct qp_broker_entry cocci_id@p ;
...
position p;
@@
 struct vmci_qp_page_store * cocci_id@p ;
...
position p;
@@
 struct vmci_qp_detach_msg cocci_id@p ;
...
position p;
@@
 struct vmci_queue_header * cocci_id@p ;
...
typedef u64,u32;
@@
 struct qp_entry {  struct list_head list_item ;  struct vmci_handle handle ;  u32 peer ;  u32 flags ;  u64 produce_size ;  u64 consume_size ;  u32 ref_count ; } cocci_id@p ;
...
position p;
@@
 const struct qp_guest_endpoint * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,wait_queue_head_t;
@@
 struct vmci_qp {  struct vmci_handle handle ;  struct vmci_queue * produce_q ;  struct vmci_queue * consume_q ;  u64 produce_q_size ;  u64 consume_q_size ;  u32 peer ;  u32 flags ;  u32 priv_flags ;  bool guest_endpoint ;  unsigned int blocked ;  unsigned int generation ;  wait_queue_head_t event ; } cocci_id@p ;
...
@@
 struct vmci_queue_kern_if {  struct mutex __mutex ;  struct mutex * mutex ;  size_t num_pages ;  bool host ;  union {  struct {  dma_addr_t * pas ;  void * * vas ; } g ;  struct {  struct page * * page ;  struct page * * header_page ; } h ; } u ; } cocci_id@p ;
...
position p;
@@
 struct vmci_event_qp cocci_id@p ;
...
position p;
@@
 const struct vmci_queue * cocci_id@p ;
...
position p;
@@
 enum qp_broker_state { VMCIQPB_NEW , VMCIQPB_CREATED_NO_MEM , VMCIQPB_CREATED_MEM , VMCIQPB_ATTACHED_NO_MEM , VMCIQPB_ATTACHED_MEM , VMCIQPB_SHUTDOWN_NO_MEM , VMCIQPB_SHUTDOWN_MEM , VMCIQPB_GONE , } cocci_id@p ;
...
position p;
@@
 vmci_event_release_cb cocci_id@p ;
...
typedef bool,u32;
@@
 struct qp_broker_entry {  struct vmci_resource resource ;  struct qp_entry qp ;  u32 create_id ;  u32 attach_id ;  enum qp_broker_state state ;  bool require_trusted_attach ;  bool created_by_trusted ;  bool vmci_page_files ;  struct vmci_queue * produce_q ;  struct vmci_queue * consume_q ;  struct vmci_queue_header saved_produce_q ;  struct vmci_queue_header saved_consume_q ;  vmci_event_release_cb wakeup_cb ;  void * client_data ;  void * local_mem ; } cocci_id@p ;
...
position p;
@@
 struct vmci_queue_kern_if * cocci_id@p ;
...
typedef u64;
@@
 struct qp_guest_endpoint {  struct vmci_resource resource ;  struct qp_entry qp ;  u64 num_ppns ;  void * produce_q ;  void * consume_q ;  struct ppn_set ppn_set ; } cocci_id@p ;
...
position p;
@@
 const struct ppn_set * cocci_id@p ;
