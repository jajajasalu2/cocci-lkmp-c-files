...
position p;
@@
 struct vmw_ctx_bindinfo_tex cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_bindinfo_view cocci_id@p ;
...
position p;
@@
 struct vmw_relocation * cocci_id@p ;
...
position p;
@@
 SVGAFifoCmdDefineGMRFB cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_bindinfo_cb cocci_id@p ;
...
typedef u32;
@@
 struct vmw_resource_relocation {  struct list_head head ;  const struct vmw_resource * res ;  u32 offset : 29 ;  enum vmw_resource_relocation_type rel_type : 3 ; } cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_bindinfo_shader cocci_id@p ;
...
position p;
@@
 struct vmw_sw_context * cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_bindinfo_vb cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_bindinfo * cocci_id@p ;
...
position p;
@@
 struct vmw_res_cache_entry * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  union {  SVGA3dCmdDXReadbackSubResource r_body ;  SVGA3dCmdDXInvalidateSubResource i_body ;  SVGA3dCmdDXUpdateSubResource u_body ;  SVGA3dSurfaceId sid ; } ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_cmdbuf_header * cocci_id@p ;
...
position p;
@@
 struct vmw_relocation {  struct list_head head ;  struct vmw_buffer_object * vbo ;  union {  SVGAMobId * mob_loc ;  SVGAGuestPtr * location ; } ; } cocci_id@p ;
...
position p;
@@
 enum vmw_resource_relocation_type cocci_id@p ;
...
typedef uint32_t;
@@
 struct {  uint32_t header ;  SVGAFifoCmdDefineGMRFB body ; } * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_execbuf_arg * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vmw_private * dev_priv , struct vmw_sw_context * sw_context , struct vmw_resource * ctx ) ;
...
position p;
@@
 SVGA3dPrimitiveRange * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vmw_private * dev_priv , struct vmw_sw_context * sw_context , SVGAMobId * id , struct vmw_buffer_object * * vmw_bo_p ) ;
...
position p;
@@
 const struct vmw_cmd_entry * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetVertexBuffers body ;  SVGA3dVertexBuffer buf [ ] ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_bindinfo_so cocci_id@p ;
...
position p;
@@
 const struct vmw_cmd_entry cocci_id@p [ SVGA_3D_CMD_MAX ] ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  union vmw_view_destroy body ; } * cocci_id@p ;
...
position p;
@@
 enum vmw_ctx_binding_type cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  uint32 defined_id ;  uint32 sid ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_resource_relocation * cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_validation_info {  struct list_head head ;  struct vmw_resource * ctx ;  struct vmw_ctx_binding_state * cur ;  struct vmw_ctx_binding_state * staged ; } cocci_id@p ;
...
position p;
@@
 struct drm_vmw_fence_rep cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  uint32 defined_id ; } * cocci_id@p ;
...
typedef bool;
@@
 struct vmw_cmd_entry {  int ( * func ) ( struct vmw_private * , struct vmw_sw_context * , SVGA3dCmdHeader * ) ;  bool user_allow ;  bool gb_disable ;  bool gb_enable ;  const char * cmd_name ; } cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXSetSOTargets body ;  SVGA3dSoTarget targets [ ] ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_bindinfo_ib cocci_id@p ;
...
position p;
@@
 enum vmw_resource_relocation_type { vmw_res_rel_normal , vmw_res_rel_nop , vmw_res_rel_cond_nop , vmw_res_rel_max , } cocci_id@p ;
...
position p;
@@
 struct vmw_ctx_validation_info * cocci_id@p ;
...
position p;
@@
 const struct vmw_resource * cocci_id@p ;
