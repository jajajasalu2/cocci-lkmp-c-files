...
position p;
@@
 struct ahash_request_priv * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ahash_request * ) ;
...
position p;
@@
 struct crypto_ahash_spawn * cocci_id@p ;
...
position p;
@@
 const struct hash_alg_common * cocci_id@p ;
...
position p;
@@
 struct crypto_report_hash cocci_id@p ;
