...
@@
 struct videobuf_dma_contig_memory {  u32 magic ;  void * vaddr ;  dma_addr_t dma_handle ;  unsigned long size ; } cocci_id@p ;
...
position p;
@@
 struct videobuf_dma_contig_memory * cocci_id@p ;
...
position p;
@@
 struct videobuf_qtype_ops cocci_id@p ;
...
position p;
@@
 struct videobuf_mapping cocci_id@p ;
