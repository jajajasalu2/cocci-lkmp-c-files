...
position p;
@@
 struct max8907_regulator {  struct regulator_desc desc [ MAX8907_NUM_REGULATORS ] ; } cocci_id@p ;
...
position p;
@@
 struct max8907_regulator * cocci_id@p ;
...
position p;
@@
 struct max8907_platform_data * cocci_id@p ;
