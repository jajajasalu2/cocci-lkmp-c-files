...
position p;
@@
 struct qcom_usb_extcon_info {  struct extcon_dev * edev ;  int irq ;  struct delayed_work wq_detcable ;  unsigned long debounce_jiffies ; } cocci_id@p ;
...
position p;
@@
 struct qcom_usb_extcon_info cocci_id@p ;
