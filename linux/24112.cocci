...
position p;
@@
 struct rpc_cred_cache * cocci_id@p ;
...
position p;
@@
 const struct auth_cred * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct rpc_cred_cache {  struct hlist_head * hashtable ;  unsigned int hashbits ;  spinlock_t lock ; } cocci_id@p ;
