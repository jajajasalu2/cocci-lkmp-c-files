...
position p;
@@
 int cocci_id@p ( struct stm_source_device * src , struct stm_device * stm ) ;
...
position p;
@@
 struct stm_source_device * cocci_id@p ;
...
position p;
@@
 struct stp_policy_id * cocci_id@p ;
...
position p;
@@
 const struct stm_pdrv_entry * cocci_id@p ;
...
position p;
@@
 struct stm_source_data * cocci_id@p ;
...
position p;
@@
 struct stm_pdrv_entry * cocci_id@p ;
...
position p;
@@
 struct stm_pdrv_entry {  struct list_head entry ;  const struct stm_protocol_driver * pdrv ;  const struct config_item_type * node_type ; } cocci_id@p ;
