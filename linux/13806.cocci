...
typedef u32,u16;
@@
 struct ov7251_mode_info {  u32 width ;  u32 height ;  const struct reg_value * data ;  u32 data_size ;  u32 pixel_clock ;  u32 link_freq ;  u16 exposure_max ;  u16 exposure_def ;  struct v4l2_fract timeperframe ; } cocci_id@p ;
...
position p;
@@
 const struct ov7251_mode_info * cocci_id@p ;
