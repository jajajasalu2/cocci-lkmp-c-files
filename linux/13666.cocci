...
position p;
@@
 struct zr364xx_framei * cocci_id@p ;
...
position p;
@@
 const struct zr364xx_fmt cocci_id@p [ ] ;
...
@@
 struct zr364xx_camera {  struct usb_device * udev ;  struct usb_interface * interface ;  struct v4l2_device v4l2_dev ;  struct v4l2_ctrl_handler ctrl_handler ;  struct video_device vdev ;  struct v4l2_fh * owner ;  int nb ;  struct zr364xx_bufferi buffer ;  int skip ;  int width ;  int height ;  int method ;  struct mutex lock ;  spinlock_t slock ;  struct zr364xx_dmaqueue vidq ;  int last_frame ;  int cur_frame ;  unsigned long frame_count ;  int b_acquire ;  struct zr364xx_pipeinfo pipe [ 1 ] ;  u8 read_endpoint ;  const struct zr364xx_fmt * fmt ;  struct videobuf_queue vb_vidq ;  bool was_streaming ; } cocci_id@p ;
...
position p;
@@
 struct zr364xx_buffer {  struct videobuf_buffer vb ;  const struct zr364xx_fmt * fmt ; } cocci_id@p ;
...
position p;
@@
 struct zr364xx_framei {  unsigned long ulState ;  void * lpvbits ;  unsigned long cur_size ; } cocci_id@p ;
...
position p;
@@
 struct zr364xx_camera cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct file * file , void * priv , enum v4l2_buf_type type ) ;
...
position p;
@@
 struct {  unsigned int value ;  unsigned int size ;  unsigned char * bytes ; } cocci_id@p ;
...
position p;
@@
 struct zr364xx_pipeinfo * cocci_id@p ;
...
position p;
@@
 struct zr364xx_buffer * cocci_id@p ;
...
position p;
@@
 struct zr364xx_dmaqueue * cocci_id@p ;
...
typedef u8,u32;
@@
 struct zr364xx_pipeinfo {  u32 transfer_size ;  u8 * transfer_buffer ;  u32 state ;  void * stream_urb ;  void * cam ;  u32 err_count ;  u32 idx ; } cocci_id@p ;
...
position p;
@@
 struct zr364xx_dmaqueue {  struct list_head active ;  struct zr364xx_camera * cam ; } cocci_id@p ;
...
position p;
@@
 struct zr364xx_bufferi {  unsigned long dwFrames ;  struct zr364xx_framei frame [ FRAMES ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct zr364xx_fmt {  u32 fourcc ;  int depth ; } cocci_id@p ;
