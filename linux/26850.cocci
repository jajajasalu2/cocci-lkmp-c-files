...
position p;
@@
 int cocci_id@p ( struct reiserfs_transaction_handle * , int flags ) ;
...
position p;
@@
 struct reiserfs_transaction_handle cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct reiserfs_journal_cnode * cn ) ;
...
position p;
@@
 void cocci_id@p ( struct buffer_chunk * ) ;
...
position p;
@@
 struct reiserfs_bitmap_node * cocci_id@p ;
...
position p;
@@
 struct reiserfs_journal_commit * cocci_id@p ;
...
position p;
@@
 struct reiserfs_journal cocci_id@p ;
...
position p;
@@
 struct reiserfs_journal_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct super_block * super , struct reiserfs_journal * journal ) ;
...
position p;
@@
 struct reiserfs_journal_list * cocci_id@p ;
...
position p;
@@
 struct tree_balance * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct reiserfs_transaction_handle * th , struct super_block * sb ) ;
...
position p;
@@
 void cocci_id@p ( struct super_block * s ) ;
...
position p;
@@
 void cocci_id@p ( struct super_block * , struct reiserfs_journal_cnode * * , struct reiserfs_journal_list * , unsigned long , int ) ;
...
position p;
@@
 struct buffer_chunk cocci_id@p ;
...
position p;
@@
 struct reiserfs_journal_cnode cocci_id@p ;
...
position p;
@@
 struct buffer_head * cocci_id@p [ BUFNR ] ;
...
position p;
@@
 int cocci_id@p ( struct reiserfs_transaction_handle * th , struct super_block * sb , unsigned long nblocks , int join ) ;
...
position p;
@@
 struct reiserfs_list_bitmap * cocci_id@p ;
...
position p;
@@
 enum { JBEGIN_REG = 0 , JBEGIN_JOIN = 1 , JBEGIN_ABORT = 2 , } cocci_id@p ;
...
position p;
@@
 struct buffer_chunk {  struct buffer_head * bh [ CHUNK_SIZE ] ;  int nr ; } cocci_id@p ;
...
position p;
@@
 struct reiserfs_super_block * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * s , struct reiserfs_journal_list * jl , int flushall ) ;
...
position p;
@@
 void cocci_id@p ( struct super_block * s , struct reiserfs_journal_list * jl ) ;
...
position p;
@@
 struct reiserfs_journal_header * cocci_id@p ;
