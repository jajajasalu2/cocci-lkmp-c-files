...
position p;
@@
 void ( * cocci_id@p ) ( unsigned int peer_cid ) ;
...
position p;
@@
 struct {  const char * name ;  void ( * run_client ) ( unsigned int peer_cid ) ;  void ( * run_server ) ( unsigned int peer_cid ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct vsock_stat {  struct list_head list ;  struct vsock_diag_msg msg ; } cocci_id@p ;
...
position p;
@@
 enum test_mode { TEST_MODE_UNSET , TEST_MODE_CLIENT , TEST_MODE_SERVER , } cocci_id@p ;
...
position p;
@@
 struct {  struct nlmsghdr nlh ;  struct vsock_diag_req vreq ; } cocci_id@p ;
...
position p;
@@
 const struct vsock_diag_msg * cocci_id@p ;
...
position p;
@@
 union {  struct sockaddr sa ;  struct sockaddr_vm svm ; } cocci_id@p ;
...
position p;
@@
 long cocci_id@p [ 8192 / sizeof ( long ) ] ;
...
position p;
@@
 const struct nlmsgerr * cocci_id@p ;
...
position p;
@@
 struct vsock_diag_msg cocci_id@p ;
