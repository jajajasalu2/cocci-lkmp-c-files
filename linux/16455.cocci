...
position p;
@@
 struct hid_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct cougar_shared cocci_id@p ;
...
typedef bool;
@@
 struct cougar_shared {  struct list_head list ;  struct kref kref ;  bool enabled ;  struct hid_device * dev ;  struct input_dev * input ; } cocci_id@p ;
...
typedef bool;
@@
 struct cougar {  bool special_intf ;  struct cougar_shared * shared ; } cocci_id@p ;
