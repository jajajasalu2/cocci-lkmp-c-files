...
typedef u32;
@@
 struct scmi_pm_domain {  struct generic_pm_domain genpd ;  const struct scmi_handle * handle ;  const char * name ;  u32 domain ; } cocci_id@p ;
...
position p;
@@
 struct scmi_pm_domain * cocci_id@p ;
...
position p;
@@
 const struct scmi_power_ops * cocci_id@p ;
