...
position p;
@@
 struct vm_guest_mode_params cocci_id@p ;
...
typedef uint64_t;
@@
 uint64_t cocci_id@p [ TEST_PAGES_PER_LOOP ] ;
...
position p;
@@
 struct vm_guest_mode_params cocci_id@p [ NUM_VM_MODES ] ;
...
typedef bool;
@@
 struct vm_guest_mode_params {  bool supported ;  bool enabled ; } cocci_id@p ;
