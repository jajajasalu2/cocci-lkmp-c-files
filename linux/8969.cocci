...
position p;
@@
 struct info_10gbt_phy_fw * cocci_id@p ;
...
position p;
@@
 enum cxgb4_bar2_qtype cocci_id@p ;
...
position p;
@@
 const struct cpl_set_tcb_rpl * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct adapter * adap ) ;
...
position p;
@@
 struct filter_entry * cocci_id@p ;
...
position p;
@@
 struct fw_caps_config_cmd * cocci_id@p ;
...
position p;
@@
 const struct cpl_abort_rpl_rss * cocci_id@p ;
...
position p;
@@
 const struct cpl_act_open_rpl * cocci_id@p ;
...
typedef __be32;
@@
 union {  __be32 word ;  char buf [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct cpl_smt_write_rpl * cocci_id@p ;
...
position p;
@@
 const struct cpl_fw6_msg * cocci_id@p ;
...
position p;
@@
 struct cpl_pass_open_req * cocci_id@p ;
...
position p;
@@
 struct sge_uld_rxq_info * cocci_id@p ;
...
position p;
@@
 const struct sge_eth_rxq * cocci_id@p ;
...
position p;
@@
 struct cpl_pass_open_req6 * cocci_id@p ;
...
position p;
@@
 struct cpl_tid_release cocci_id@p ;
...
position p;
@@
 const struct cpl_srq_table_rpl * cocci_id@p ;
...
position p;
@@
 struct ch_sched_queue cocci_id@p ;
...
position p;
@@
 const struct cpl_l2t_write_rpl * cocci_id@p ;
...
position p;
@@
 struct tc_cls_u32_offload * cocci_id@p ;
...
position p;
@@
 const struct cpl_sge_egr_update * cocci_id@p ;
...
position p;
@@
 struct ch_sched_params cocci_id@p ;
...
position p;
@@
 const struct link_config * cocci_id@p ;
...
position p;
@@
 struct ch_filter_specification cocci_id@p ;
...
position p;
@@
 struct hash_mac_addr * cocci_id@p ;
...
position p;
@@
 struct cpl_close_listsvr_req * cocci_id@p ;
