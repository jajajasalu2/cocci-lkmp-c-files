...
position p;
@@
 struct lpfc_io_buf * cocci_id@p ( struct lpfc_hba * phba , struct lpfc_nodelist * ndlp , int idx , int expedite ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct lpfc_hba * , struct lpfc_iocbq * , struct lpfc_wcqe_complete * ) ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_hba * , struct lpfc_io_buf * ) ;
...
position p;
@@
 struct lpfc_nvme_qhandle * cocci_id@p ;
...
position p;
@@
 struct lpfc_nvme_fcpreq_priv * cocci_id@p ;
