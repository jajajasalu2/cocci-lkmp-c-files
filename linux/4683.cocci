...
position p;
@@
 struct vexpress_config_bridge_ops cocci_id@p ;
...
position p;
@@
 struct vexpress_syscfg {  struct device * dev ;  void __iomem * base ;  struct list_head funcs ; } cocci_id@p ;
...
position p;
@@
 struct vexpress_syscfg_func * cocci_id@p ;
...
typedef u32;
@@
 struct vexpress_syscfg_func {  struct list_head list ;  struct vexpress_syscfg * syscfg ;  struct regmap * regmap ;  int num_templates ;  u32 template [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct vexpress_syscfg * cocci_id@p ;
