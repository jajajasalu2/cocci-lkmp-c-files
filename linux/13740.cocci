...
typedef u16;
@@
 struct i2c_regval {  u16 addr ;  u16 val ; } cocci_id@p ;
...
position p;
@@
 struct noon010_info cocci_id@p ;
...
position p;
@@
 const struct noon010_frmsize * * cocci_id@p ;
...
position p;
@@
 const struct noon010pc30_platform_data * cocci_id@p ;
...
position p;
@@
 const struct noon010_format * cocci_id@p ;
...
typedef u32,u16;
@@
 struct noon010_format {  u32 code ;  enum v4l2_colorspace colorspace ;  u16 ispctl1_reg ; } cocci_id@p ;
...
typedef u16;
@@
 struct noon010_frmsize {  u16 width ;  u16 height ;  int vid_ctl1 ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct noon010_info {  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler hdl ;  struct regulator_bulk_data supply [ NOON010_NUM_SUPPLIES ] ;  u32 gpio_nreset ;  u32 gpio_nstby ;  struct mutex lock ;  const struct noon010_format * curr_fmt ;  const struct noon010_frmsize * curr_win ;  unsigned int apply_new_cfg : 1 ;  unsigned int streaming : 1 ;  unsigned int hflip : 1 ;  unsigned int vflip : 1 ;  unsigned int power : 1 ;  u8 i2c_reg_page ; } cocci_id@p ;
...
position p;
@@
 const struct i2c_regval * cocci_id@p ;
