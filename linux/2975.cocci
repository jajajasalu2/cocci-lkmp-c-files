...
position p;
@@
 struct acpi_table_einj cocci_id@p ;
...
position p;
@@
 struct apei_exec_context cocci_id@p ;
...
position p;
@@
 struct acpi_whea_header * cocci_id@p ;
...
position p;
@@
 struct set_error_type_with_address cocci_id@p ;
...
position p;
@@
 struct apei_exec_ins_type cocci_id@p [ ] ;
...
typedef u64;
@@
 struct einj_parameter {  u64 type ;  u64 reserved1 ;  u64 reserved2 ;  u64 param1 ;  u64 param2 ; } cocci_id@p ;
...
position p;
@@
 struct acpi_einj_trigger cocci_id@p ;
...
position p;
@@
 struct apei_resources cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct vendor_error_type_extension {  u32 length ;  u32 pcie_sbdf ;  u16 vendor_id ;  u16 device_id ;  u8 rev_id ;  u8 reserved [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct vendor_error_type_extension * cocci_id@p ;
...
position p;
@@
 enum { SETWA_FLAGS_APICID = 1 , SETWA_FLAGS_MEM = 2 , SETWA_FLAGS_PCIE_SBDF = 4 , } cocci_id@p ;
...
position p;
@@
 struct einj_parameter * cocci_id@p ;
...
position p;
@@
 struct acpi_einj_entry cocci_id@p ;
...
typedef u64,u32;
@@
 struct set_error_type_with_address {  u32 type ;  u32 vendor_extension ;  u32 flags ;  u32 apicid ;  u64 memory_address ;  u64 memory_address_range ;  u32 pcie_sbdf ; } cocci_id@p ;
