...
position p;
@@
 struct ls037v7dw01_panel {  struct drm_panel panel ;  struct platform_device * pdev ;  struct regulator * vdd ;  struct gpio_desc * resb_gpio ;  struct gpio_desc * ini_gpio ;  struct gpio_desc * mo_gpio ;  struct gpio_desc * lr_gpio ;  struct gpio_desc * ud_gpio ; } cocci_id@p ;
...
position p;
@@
 struct ls037v7dw01_panel * cocci_id@p ;
