...
position p;
@@
 struct fcpio_host_req * cocci_id@p ;
...
position p;
@@
 struct fcpio_fw_req * cocci_id@p ;
...
position p;
@@
 enum fnic_ioreq_state cocci_id@p ;
...
position p;
@@
 struct terminate_stats * cocci_id@p ;
...
position p;
@@
 struct host_sg_desc * cocci_id@p ;
...
position p;
@@
 enum fcpio_flogi_reg_format_type cocci_id@p ;
...
position p;
@@
 struct vnic_wq_copy * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fnic * fnic , int exclude_id ) ;
...
position p;
@@
 struct fcpio_icmnd_cmpl * cocci_id@p ;
