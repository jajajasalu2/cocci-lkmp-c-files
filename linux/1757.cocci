...
position p;
@@
 struct iio_hrtimer_info * cocci_id@p ;
...
position p;
@@
 const struct iio_sw_trigger_ops cocci_id@p ;
...
position p;
@@
 struct iio_sw_trigger * cocci_id@p ;
...
position p;
@@
 struct iio_sw_trigger_type cocci_id@p ;
...
typedef ktime_t;
@@
 struct iio_hrtimer_info {  struct iio_sw_trigger swt ;  struct hrtimer timer ;  unsigned long sampling_frequency ;  ktime_t period ; } cocci_id@p ;
