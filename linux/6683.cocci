...
position p;
@@
 struct bnx2i_cleanup_response * cocci_id@p ;
...
position p;
@@
 struct bnx2i_text_request * cocci_id@p ;
...
position p;
@@
 struct bnx2i_endpoint * cocci_id@p ;
...
position p;
@@
 struct bnx2i_text_response * cocci_id@p ;
...
position p;
@@
 struct bnx2i_cleanup_request * cocci_id@p ;
...
position p;
@@
 struct bnx2i_async_msg * cocci_id@p ;
...
position p;
@@
 struct bnx2i_tmf_response * cocci_id@p ;
...
position p;
@@
 struct bnx2i_5771x_cq_db * cocci_id@p ;
...
position p;
@@
 struct bnx2i_cmd_response * cocci_id@p ;
...
position p;
@@
 struct bnx2i_logout_request * cocci_id@p ;
...
position p;
@@
 struct bnx2i_tmf_request * cocci_id@p ;
...
position p;
@@
 struct bnx2i_login_request * cocci_id@p ;
...
position p;
@@
 struct bnx2i_reject_msg * cocci_id@p ;
...
position p;
@@
 struct bnx2i_cmd_request * cocci_id@p ;
...
position p;
@@
 struct bnx2i_nop_in_msg * cocci_id@p ;
...
position p;
@@
 struct bnx2i_login_response * cocci_id@p ;
...
position p;
@@
 struct bnx2i_nop_out_request cocci_id@p ;
...
position p;
@@
 struct bnx2i_logout_response * cocci_id@p ;
...
position p;
@@
 struct bnx2i_percpu_s * cocci_id@p ;
...
position p;
@@
 struct bnx2i_5771x_dbell cocci_id@p ;
...
position p;
@@
 struct iscsi_kwqe_conn_offload3 cocci_id@p [ 1 ] ;
...
position p;
@@
 struct bnx2i_5771x_sq_rq_db * cocci_id@p ;
