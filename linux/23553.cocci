...
position p;
@@
 enum sst_hsw_module_id cocci_id@p ;
...
position p;
@@
 enum sst_hsw_stream_type cocci_id@p ;
...
position p;
@@
 struct hsw_pcm_module_map {  int dai_id ;  int stream ;  enum sst_hsw_module_id mod_id ; } cocci_id@p ;
...
position p;
@@
 enum sst_hsw_stream_path_id cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct sst_hsw_stream * stream , void * data ) ;
...
position p;
@@
 struct sst_hsw_stream * cocci_id@p ;
...
position p;
@@
 struct hsw_pcm_data * cocci_id@p ;
...
position p;
@@
 struct hsw_priv_data {  struct sst_hsw * hsw ;  struct device * dev ;  enum hsw_pm_state pm_state ;  struct snd_soc_card * soc_card ;  struct sst_module_runtime * runtime_waves ;  struct snd_dma_buffer dmab [ HSW_PCM_COUNT ] [ 2 ] ;  struct hsw_pcm_data pcm [ HSW_PCM_COUNT ] [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum hsw_pm_state { HSW_PM_STATE_D0 = 0 , HSW_PM_STATE_RTD3 = 1 , HSW_PM_STATE_D3 = 2 , } cocci_id@p ;
...
position p;
@@
 struct hsw_pcm_module_map cocci_id@p [ ] ;
...
position p;
@@
 struct hsw_priv_data * cocci_id@p ;
