...
position p;
@@
 struct nci_hcp_message * cocci_id@p ;
...
position p;
@@
 struct nci_hci_create_pipe_params cocci_id@p ;
...
position p;
@@
 struct nci_hci_create_pipe_resp * cocci_id@p ;
...
position p;
@@
 struct nci_hci_all_pipe_cleared_noti * cocci_id@p ;
...
position p;
@@
 struct nci_hcp_packet * cocci_id@p ;
...
position p;
@@
 struct nci_hci_delete_pipe_noti * cocci_id@p ;
