...
typedef u8;
@@
 struct lp855x_device_config {  int ( * pre_init_device ) ( struct lp855x * ) ;  u8 reg_brightness ;  u8 reg_devicectrl ;  int ( * post_init_device ) ( struct lp855x * ) ; } cocci_id@p ;
...
position p;
@@
 struct lp855x_rom_data * cocci_id@p ;
...
position p;
@@
 struct lp855x {  const char * chipname ;  enum lp855x_chip_id chip_id ;  enum lp855x_brightness_ctrl_mode mode ;  struct lp855x_device_config * cfg ;  struct i2c_client * client ;  struct backlight_device * bl ;  struct device * dev ;  struct lp855x_platform_data * pdata ;  struct pwm_device * pwm ;  struct regulator * supply ;  struct regulator * enable ; } cocci_id@p ;
...
position p;
@@
 struct lp855x_device_config cocci_id@p ;
...
position p;
@@
 struct lp855x_platform_data * cocci_id@p ;
...
position p;
@@
 enum lp855x_brightness_ctrl_mode { PWM_BASED = 1 , REGISTER_BASED , } cocci_id@p ;
