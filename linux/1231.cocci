...
position p;
@@
 struct xhci_container_ctx * cocci_id@p ;
...
position p;
@@
 struct xhci_run_regs cocci_id@p ;
...
position p;
@@
 struct xhci_doorbell_array cocci_id@p ;
...
position p;
@@
 struct xhci_virt_ep cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct xhci_hcd * xhci , struct usb_device * udev , struct xhci_command * command , bool ctx_change , bool must_succeed ) ;
...
position p;
@@
 struct xhci_command * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xhci_get_quirks_t;
@@
 xhci_get_quirks_t cocci_id@p ;
...
position p;
@@
 struct xhci_dequeue_state * cocci_id@p ;
...
position p;
@@
 enum xhci_setup_dev cocci_id@p ;
...
position p;
@@
 struct xhci_intr_reg cocci_id@p ;
...
position p;
@@
 struct xhci_virt_device * cocci_id@p ;
...
position p;
@@
 struct xhci_bw_info * cocci_id@p ;
...
position p;
@@
 struct xhci_slot_ctx * cocci_id@p ;
...
position p;
@@
 struct xhci_tt_bw_info * cocci_id@p ;
...
position p;
@@
 struct xhci_interval_bw * cocci_id@p ;
...
position p;
@@
 struct xhci_root_port_bw_info * cocci_id@p ;
...
position p;
@@
 struct xhci_erst_entry cocci_id@p ;
...
position p;
@@
 struct xhci_cap_regs cocci_id@p ;
...
position p;
@@
 struct xhci_input_control_ctx * cocci_id@p ;
...
position p;
@@
 struct xhci_segment * cocci_id@p ;
...
position p;
@@
 struct xhci_interval_bw_table * cocci_id@p ;
...
position p;
@@
 struct xhci_stream_ctx cocci_id@p ;
...
position p;
@@
 struct xhci_bw_info cocci_id@p [ 31 ] ;
...
position p;
@@
 const struct xhci_driver_overrides * cocci_id@p ;
