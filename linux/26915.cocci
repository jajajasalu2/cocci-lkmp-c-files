...
position p;
@@
 struct dns_server_list_v1_server cocci_id@p ;
...
position p;
@@
 const struct dns_server_list_v1_header * cocci_id@p ;
...
position p;
@@
 struct afs_vlserver_entry cocci_id@p ;
...
position p;
@@
 struct dns_server_list_v1_address cocci_id@p ;
