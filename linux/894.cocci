...
typedef u8;
@@
 struct fsmc_nand_timings {  u8 tclr ;  u8 tar ;  u8 thiz ;  u8 thold ;  u8 twait ;  u8 tset ; } cocci_id@p ;
...
position p;
@@
 struct fsmc_nand_data cocci_id@p ;
...
position p;
@@
 struct fsmc_nand_timings cocci_id@p ;
...
position p;
@@
 enum access_mode { USE_DMA_ACCESS = 1 , USE_WORD_ACCESS , } cocci_id@p ;
