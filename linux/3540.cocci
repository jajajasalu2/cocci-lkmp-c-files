...
typedef u32;
@@
 struct sdmmc_lli_desc {  u32 idmalar ;  u32 idmabase ;  u32 idmasize ; } cocci_id@p ;
...
position p;
@@
 struct sdmmc_lli_desc cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct sdmmc_priv {  dma_addr_t sg_dma ;  void * sg_cpu ; } cocci_id@p ;
