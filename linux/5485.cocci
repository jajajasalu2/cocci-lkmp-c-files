...
typedef u8;
@@
 struct rx_ranges {  struct list_head list ;  u8 * start ;  u8 * end ; } cocci_id@p ;
...
position p;
@@
 const struct spi_test * cocci_id@p ;
...
position p;
@@
 struct rx_ranges cocci_id@p [ SPI_TEST_MAX_TRANSFERS ] ;
