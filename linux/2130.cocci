...
position p;
@@
 struct max17040_chip {  struct i2c_client * client ;  struct delayed_work work ;  struct power_supply * battery ;  struct max17040_platform_data * pdata ;  int online ;  int vcell ;  int soc ;  int status ; } cocci_id@p ;
...
position p;
@@
 struct max17040_chip * cocci_id@p ;
