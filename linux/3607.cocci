...
position p;
@@
 struct mrq_debugfs_request cocci_id@p ;
...
position p;
@@
 struct mrq_debugfs_response cocci_id@p ;
...
position p;
@@
 struct seqbuf {  char * buf ;  size_t pos ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 const struct mrq_debugfs_request cocci_id@p ;
