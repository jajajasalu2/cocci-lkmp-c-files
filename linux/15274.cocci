...
position p;
@@
 struct tca6507_chip * cocci_id@p ;
...
position p;
@@
 struct tca6507_platform_data * cocci_id@p ;
...
position p;
@@
 enum { BANK0 , BANK1 , MASTER , } cocci_id@p ;
