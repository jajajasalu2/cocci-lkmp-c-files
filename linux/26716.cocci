...
typedef bool;
@@
 int cocci_id@p ( struct inomap * , int , bool , struct inode * ) ;
...
position p;
@@
 int cocci_id@p ( struct dinode * , struct inode * ) ;
...
position p;
@@
 int cocci_id@p ( struct inomap * , int * , int , struct metapage * * ) ;
...
typedef s64;
@@
 void cocci_id@p ( struct super_block * , s64 , int , s64 * ) ;
...
position p;
@@
 struct dinomap_disk * cocci_id@p ;
...
position p;
@@
 struct jfs_superblock * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inomap * imap , int , struct metapage * * ) ;
...
position p;
@@
 int cocci_id@p ( struct inomap * , int , struct inode * ) ;
...
position p;
@@
 int cocci_id@p ( struct inomap * , struct iag * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct dinode * , struct inode * ) ;
