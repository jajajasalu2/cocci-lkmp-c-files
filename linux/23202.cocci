...
typedef u32;
@@
 struct _pll_div {  u32 div2 : 1 ;  u32 n : 4 ;  u32 k : 24 ; } cocci_id@p ;
...
position p;
@@
 struct wm8753_priv {  struct regmap * regmap ;  unsigned int sysclk ;  unsigned int pcmclk ;  unsigned int voice_fmt ;  unsigned int hifi_fmt ;  int dai_func ;  struct delayed_work charge_work ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_soc_component * component , unsigned int fmt ) ;
...
typedef u8,u32;
@@
 struct _coeff_div {  u32 mclk ;  u32 rate ;  u8 sr : 5 ;  u8 usb : 1 ; } cocci_id@p ;
