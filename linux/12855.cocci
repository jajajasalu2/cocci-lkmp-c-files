...
position p;
@@
 struct ie31200_error_info * cocci_id@p ;
...
typedef u64,u32;
@@
 union {  u64 mchbar ;  struct {  u32 mchbar_low ;  u32 mchbar_high ; } ; } cocci_id@p ;
...
typedef u64,u16;
@@
 struct ie31200_error_info {  u16 errsts ;  u16 errsts2 ;  u64 eccerrlog [ IE31200_CHANNELS ] ; } cocci_id@p ;
...
position p;
@@
 struct dimm_data cocci_id@p [ IE31200_CHANNELS ] [ IE31200_DIMMS_PER_CHANNEL ] ;
...
position p;
@@
 struct ie31200_priv {  void __iomem * window ;  void __iomem * c0errlog ;  void __iomem * c1errlog ; } cocci_id@p ;
...
position p;
@@
 struct ie31200_priv cocci_id@p ;
...
position p;
@@
 enum ie31200_chips { IE31200 = 0 , } cocci_id@p ;
...
position p;
@@
 struct ie31200_dev_info {  const char * ctl_name ; } cocci_id@p ;
...
position p;
@@
 const struct ie31200_dev_info cocci_id@p [ ] ;
