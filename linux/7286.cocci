...
position p;
@@
 struct kb3886bl_machinfo cocci_id@p ;
...
position p;
@@
 struct kb3886bl_machinfo {  int max_intensity ;  int default_intensity ;  int limit_mask ;  void ( * set_bl_intensity ) ( int intensity ) ; } cocci_id@p ;
