...
position p;
@@
 const struct wm8741_platform_data * cocci_id@p ;
...
position p;
@@
 struct wm8741_priv {  struct wm8741_platform_data pdata ;  struct regmap * regmap ;  struct regulator_bulk_data supplies [ WM8741_NUM_SUPPLIES ] ;  unsigned int sysclk ;  const struct snd_pcm_hw_constraint_list * sysclk_constraints ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8741_NUM_SUPPLIES ] ;
