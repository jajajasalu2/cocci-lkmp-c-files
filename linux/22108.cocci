...
position p;
@@
 struct test_fail {  const char * str ;  unsigned int base ; } cocci_id@p ;
...
position p;
@@
 const struct test_fail * cocci_id@p ;
...
position p;
@@
 const typeof ( test [ 0 ] ) * cocci_id@p ;
