...
position p;
@@
 struct twl4030_script cocci_id@p ;
...
position p;
@@
 struct twl4030_resconfig cocci_id@p [ ] ;
...
position p;
@@
 const struct twl4030_power_data * cocci_id@p ;
...
position p;
@@
 enum { TWL_REMAP_OFF = 0 , TWL_REMAP_SLEEP = 8 , TWL_REMAP_ACTIVE = 9 , } cocci_id@p ;
...
position p;
@@
 struct twl4030_power_data cocci_id@p ;
