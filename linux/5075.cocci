...
position p;
@@
 unsigned int cocci_id@p [ MAX_NUM_WS16C48 ] ;
...
position p;
@@
 const char * cocci_id@p [ WS16C48_NGPIO ] ;
...
@@
 struct ws16c48_gpio {  struct gpio_chip chip ;  unsigned char io_state [ 6 ] ;  unsigned char out_state [ 6 ] ;  raw_spinlock_t lock ;  unsigned long irq_mask ;  unsigned long flow_mask ;  unsigned base ; } cocci_id@p ;
...
position p;
@@
 struct ws16c48_gpio * cocci_id@p ;
...
position p;
@@
 struct ws16c48_gpio * const cocci_id@p ;
