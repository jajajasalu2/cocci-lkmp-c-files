...
typedef DFX_board_t;
@@
 void cocci_id@p ( DFX_board_t * bp , PI_UINT32 type ) ;
...
typedef DFX_board_t;
@@
 int cocci_id@p ( DFX_board_t * bp , int get_buffers ) ;
...
typedef DFX_board_t;
@@
 void cocci_id@p ( DFX_board_t * bp ) ;
...
typedef DFX_board_t;
@@
 int cocci_id@p ( DFX_board_t * bp , PI_UINT32 command , PI_UINT32 data_a , PI_UINT32 data_b , PI_UINT32 * host_data ) ;
...
typedef DFX_board_t;
@@
 int cocci_id@p ( DFX_board_t * bp , PI_UINT32 type ) ;
