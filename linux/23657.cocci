...
position p;
@@
 struct avcs_svc_api_info * cocci_id@p ;
...
position p;
@@
 struct q6core_svc_api_info * cocci_id@p ;
...
position p;
@@
 struct avcs_cmdrsp_get_version * cocci_id@p ;
...
position p;
@@
 struct avcs_svc_info * cocci_id@p ;
...
position p;
@@
 struct avcs_cmdrsp_get_fwk_version * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,wait_queue_head_t,uint32_t;
@@
 struct q6core {  struct apr_device * adev ;  wait_queue_head_t wait ;  uint32_t avcs_state ;  struct mutex lock ;  bool resp_received ;  uint32_t num_services ;  struct avcs_cmdrsp_get_fwk_version * fwk_version ;  struct avcs_cmdrsp_get_version * svc_version ;  bool fwk_version_supported ;  bool get_state_supported ;  bool get_version_supported ;  bool is_version_requested ; } cocci_id@p ;
