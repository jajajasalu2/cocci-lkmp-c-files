...
position p;
@@
 struct cros_ec_baro_state * cocci_id@p ;
...
position p;
@@
 struct cros_ec_baro_state {  struct cros_ec_sensors_core_state core ;  struct iio_chan_spec channels [ CROS_EC_BARO_MAX_CHANNELS ] ; } cocci_id@p ;
