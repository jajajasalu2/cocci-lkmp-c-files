...
position p;
@@
 struct slave_init_arg {  struct hda_codec * codec ;  int step ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( sctl -> id . name ) ] ;
...
position p;
@@
 int cocci_id@p [ HDA_PCM_NTYPES ] [ 5 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct hda_codec * , void * , struct snd_kcontrol * ) ;
...
typedef hda_nid_t;
@@
 struct hda_conn_list {  struct list_head list ;  int len ;  hda_nid_t nid ;  hda_nid_t conns [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct slave_init_arg * cocci_id@p ;
...
position p;
@@
 struct hda_vmaster_mute_hook * cocci_id@p ;
...
position p;
@@
 struct hda_nid_item cocci_id@p ;
...
position p;
@@
 const struct hda_conn_list * cocci_id@p ;
...
position p;
@@
 struct hda_loopback_check * cocci_id@p ;
...
position p;
@@
 const struct hda_input_mux * cocci_id@p ;
...
position p;
@@
 struct hda_cvt_setup cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hda_codec * codec , struct hda_cvt_setup * q ) ;
...
position p;
@@
 struct hda_multi_out * cocci_id@p ;
...
position p;
@@
 struct hda_conn_list * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct hda_codec * codec , unsigned int power_state ) ;
...
symbol cocci_id;
position p;
typedef u8,u16,hda_nid_t;
@@
 struct hda_cvt_setup {  hda_nid_t nid ;  u8 stream_tag ;  u8 channel_id ;  u16 format_id ;  unsigned char active ;  unsigned char dirty ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef map_slave_func_t;
@@
 map_slave_func_t cocci_id@p ;
...
position p;
@@
 const struct hda_amp_list * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ HDA_PCM_NTYPES ] ;
