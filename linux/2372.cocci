...
position p;
@@
 struct ssctl_subsys_event_resp cocci_id@p ;
...
position p;
@@
 struct rproc_subdev * cocci_id@p ;
...
position p;
@@
 const struct rpmsg_device_id cocci_id@p [ ] ;
...
position p;
@@
 enum { SSCTL_SSR_EVENT_FORCED , SSCTL_SSR_EVENT_GRACEFUL , } cocci_id@p ;
...
position p;
@@
 enum { SSCTL_SSR_EVENT_BEFORE_POWERUP , SSCTL_SSR_EVENT_AFTER_POWERUP , SSCTL_SSR_EVENT_BEFORE_SHUTDOWN , SSCTL_SSR_EVENT_AFTER_SHUTDOWN , } cocci_id@p ;
...
position p;
@@
 const struct qmi_ops cocci_id@p ;
...
position p;
@@
 struct ssctl_subsys_event_req cocci_id@p ;
...
position p;
@@
 struct ssctl_subsys_event_resp {  struct qmi_response_type_v01 resp ; } cocci_id@p ;
...
position p;
@@
 struct ssctl_shutdown_resp {  struct qmi_response_type_v01 resp ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct ssctl_subsys_event_req {  u8 subsys_name_len ;  char subsys_name [ SSCTL_SUBSYS_NAME_LENGTH ] ;  u32 event ;  u8 evt_driven_valid ;  u32 evt_driven ; } cocci_id@p ;
...
position p;
@@
 struct ssctl_shutdown_resp cocci_id@p ;
