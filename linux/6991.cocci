...
position p;
@@
 struct idle_inject_device cocci_id@p ;
...
position p;
@@
 struct idle_inject_thread * cocci_id@p ;
...
position p;
@@
 struct idle_inject_device {  struct hrtimer timer ;  unsigned int idle_duration_us ;  unsigned int run_duration_us ;  unsigned long int cpumask [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct idle_inject_thread {  struct task_struct * tsk ;  int should_run ; } cocci_id@p ;
