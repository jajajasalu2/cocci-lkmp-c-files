...
position p;
@@
 struct powercap_attr cocci_id@p ;
...
typedef u32;
@@
 struct powercap_attr {  u32 handle ;  struct kobj_attribute attr ; } cocci_id@p ;
...
position p;
@@
 struct pcap {  struct attribute_group pg ;  struct powercap_attr * pattrs ; } * cocci_id@p ;
