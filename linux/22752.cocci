...
position p;
@@
 struct snd_msndmidi * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct snd_msndmidi {  struct snd_msnd * dev ;  unsigned long mode ;  struct snd_rawmidi_substream * substream_input ;  spinlock_t input_lock ; } cocci_id@p ;
