...
position p;
@@
 const struct crush_bucket_uniform * cocci_id@p ;
...
position p;
@@
 const struct crush_bucket_list * cocci_id@p ;
...
position p;
@@
 const struct crush_bucket_straw * cocci_id@p ;
...
position p;
@@
 const struct crush_map * cocci_id@p ;
...
position p;
@@
 const struct crush_bucket * cocci_id@p ;
...
position p;
@@
 const struct crush_choose_arg * cocci_id@p ;
...
position p;
@@
 const struct crush_bucket_straw2 * cocci_id@p ;
...
position p;
@@
 const struct crush_rule * cocci_id@p ;
...
position p;
@@
 const struct crush_rule_step * cocci_id@p ;
...
position p;
@@
 const struct crush_bucket_tree * cocci_id@p ;
