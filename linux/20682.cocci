...
position p;
@@
 struct pagerange_state * cocci_id@p ;
...
position p;
@@
 struct pagerange_state {  unsigned long cur_pfn ;  int ram ;  int not_ram ; } cocci_id@p ;
...
position p;
@@
 enum { PAT_UC = 0 , PAT_WC = 1 , PAT_WT = 4 , PAT_WP = 5 , PAT_WB = 6 , PAT_UC_MINUS = 7 , } cocci_id@p ;
