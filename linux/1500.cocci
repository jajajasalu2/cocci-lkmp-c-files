...
typedef __u16;
@@
 struct quirk_printer_struct {  __u16 vendorId ;  __u16 productId ;  unsigned int quirks ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usblp * usblp , int nonblock ) ;
...
position p;
@@
 int cocci_id@p ( struct usblp * usblp , int protocol ) ;
...
position p;
@@
 int cocci_id@p ( struct usblp * usblp ) ;
...
position p;
@@
 const struct quirk_printer_struct cocci_id@p [ ] ;
