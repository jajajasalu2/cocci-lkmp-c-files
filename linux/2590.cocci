...
position p;
@@
 struct closure_syncer * cocci_id@p ;
...
position p;
@@
 struct closure_syncer {  struct task_struct * task ;  int done ; } cocci_id@p ;
...
position p;
@@
 struct closure_waitlist * cocci_id@p ;
