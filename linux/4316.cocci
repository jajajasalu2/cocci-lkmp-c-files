...
typedef bool;
@@
 struct toshiba_bluetooth_dev {  struct acpi_device * acpi_dev ;  struct rfkill * rfk ;  bool killswitch ;  bool plugged ;  bool powered ; } cocci_id@p ;
...
position p;
@@
 struct toshiba_bluetooth_dev * cocci_id@p ;
