...
position p;
@@
 struct kvm_create_spapr_tce cocci_id@p ;
...
position p;
@@
 struct kvm_ppc_pvinfo cocci_id@p ;
...
position p;
@@
 enum emulation_result cocci_id@p ;
...
position p;
@@
 struct kvm_vcpu_arch_shared * cocci_id@p ;
...
position p;
@@
 struct h_cpu_char_result cocci_id@p ;
...
position p;
@@
 struct kvm_ppc_cpu_char * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ BITS_TO_LONGS ( KVMPPC_NR_LPIDS ) ] ;
...
position p;
@@
 struct kvm_create_spapr_tce_64 cocci_id@p ;
...
position p;
@@
 struct kvm_ppc_rmmu_info cocci_id@p ;
...
position p;
@@
 struct kvm_dirty_tlb cocci_id@p ;
...
position p;
@@
 struct kvm_config_tlb cocci_id@p ;
