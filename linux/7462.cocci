...
position p;
@@
 const struct riva_regs cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_CURS * MAX_CURS / 8 ] ;
...
position p;
@@
 struct {  int xres , yres ; } cocci_id@p [ ] ;
