...
typedef u8;
@@
 struct ushc_int_data {  u8 status ;  u8 reserved [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 enum ushc_request { USHC_GET_CAPS = 0x00 , USHC_HOST_CTRL = 0x01 , USHC_PWR_CTRL = 0x02 , USHC_CLK_FREQ = 0x03 , USHC_EXEC_CMD = 0x04 , USHC_READ_RESP = 0x05 , USHC_RESET = 0x06 , } cocci_id@p ;
...
position p;
@@
 struct ushc_int_data cocci_id@p ;
