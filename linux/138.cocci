...
position p;
@@
 struct dma_coherent_mem * * cocci_id@p ;
...
position p;
@@
 const struct reserved_mem_ops cocci_id@p ;
...
@@
 struct dma_coherent_mem {  void * virt_base ;  dma_addr_t device_base ;  unsigned long pfn_base ;  int size ;  unsigned long * bitmap ;  spinlock_t spinlock ;  bool use_dev_dma_pfn_offset ; } cocci_id@p ;
