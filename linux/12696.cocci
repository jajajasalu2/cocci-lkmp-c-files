...
position p;
@@
 struct da8xx_mstpri_descr {  int reg ;  int shift ;  int mask ; } cocci_id@p ;
...
position p;
@@
 const struct da8xx_mstpri_descr * cocci_id@p ;
...
position p;
@@
 struct da8xx_mstpri_board_priorities {  const char * board ;  const struct da8xx_mstpri_priority * priorities ;  size_t numprio ; } cocci_id@p ;
...
position p;
@@
 const struct da8xx_mstpri_board_priorities cocci_id@p [ ] ;
...
position p;
@@
 enum { DA8XX_MSTPRI_ARM_I = 0 , DA8XX_MSTPRI_ARM_D , DA8XX_MSTPRI_UPP , DA8XX_MSTPRI_SATA , DA8XX_MSTPRI_PRU0 , DA8XX_MSTPRI_PRU1 , DA8XX_MSTPRI_EDMA30TC0 , DA8XX_MSTPRI_EDMA30TC1 , DA8XX_MSTPRI_EDMA31TC0 , DA8XX_MSTPRI_VPIF_DMA_0 , DA8XX_MSTPRI_VPIF_DMA_1 , DA8XX_MSTPRI_EMAC , DA8XX_MSTPRI_USB0CFG , DA8XX_MSTPRI_USB0CDMA , DA8XX_MSTPRI_UHPI , DA8XX_MSTPRI_USB1 , DA8XX_MSTPRI_LCDC , } cocci_id@p ;
...
position p;
@@
 const struct da8xx_mstpri_priority cocci_id@p [ ] ;
...
typedef u32;
@@
 struct da8xx_mstpri_priority {  int which ;  u32 val ; } cocci_id@p ;
