...
typedef u8,u32;
@@
 struct leo_ld_ss0 {  u8 xxx0 [ 0xe00 ] ;  u32 csr ;  u32 wid ;  u32 wmask ;  u32 widclip ;  u32 vclipmin ;  u32 vclipmax ;  u32 pickmin ;  u32 pickmax ;  u32 fg ;  u32 bg ;  u32 src ;  u32 dst ;  u32 extent ;  u32 xxx1 [ 3 ] ;  u32 setsem ;  u32 clrsem ;  u32 clrpick ;  u32 clrdat ;  u32 alpha ;  u8 xxx2 [ 0x2c ] ;  u32 winbg ;  u32 planemask ;  u32 rop ;  u32 z ;  u32 dczf ;  u32 dczb ;  u32 dcs ;  u32 dczs ;  u32 pickfb ;  u32 pickbb ;  u32 dcfc ;  u32 forcecol ;  u32 door [ 8 ] ;  u32 pick [ 5 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct leo_lc_ss1_krn {  u8 unknown ; } cocci_id@p ;
...
typedef u32;
@@
 struct leo_lc_ss0_usr {  u32 csr ;  u32 addrspace ;  u32 fontmsk ;  u32 fontt ;  u32 extent ;  u32 src ;  u32 dst ;  u32 copy ;  u32 fill ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct leo_lc_ss0_krn {  u32 misc ;  u8 xxx0 [ 0x800 - 4 ] ;  u32 rev ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct leo_ld_ss1 {  u8 xxx0 [ 0xef4 ] ;  u32 ss1_misc ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int , struct fb_info * ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_info * , unsigned int , unsigned long ) ;
...
position p;
@@
 int cocci_id@p ( unsigned , unsigned , unsigned , unsigned , unsigned , struct fb_info * ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * , struct fb_info * ) ;
...
typedef u8;
@@
 struct leo_ld_gbl {  u8 unknown ; } cocci_id@p ;
...
position p;
@@
 struct sbus_mmap_map cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct leo_cursor {  u8 xxx0 [ 16 ] ;  u32 cur_type ;  u32 cur_misc ;  u32 cur_cursxy ;  u32 cur_data ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_info * , struct vm_area_struct * ) ;
...
typedef u8;
@@
 struct leo_lc_ss1_usr {  u8 unknown ; } cocci_id@p ;
...
typedef u32;
@@
 struct leo_lx_krn {  u32 krn_type ;  u32 krn_csr ;  u32 krn_value ; } cocci_id@p ;
