...
typedef u128,le128;
@@
 void cocci_id@p ( void * ctx , u128 * dst , const u128 * src , le128 * iv ) ;
...
position p;
@@
 struct serpent_xts_ctx * cocci_id@p ;
...
typedef u128;
@@
 void cocci_id@p ( void * ctx , u128 * dst , const u128 * src ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct serpent_ctx * ctx , u8 * dst , const u8 * src ) ;
...
typedef u8,le128;
@@
 void cocci_id@p ( struct serpent_ctx * ctx , u8 * dst , const u8 * src , le128 * iv ) ;
...
position p;
@@
 struct simd_skcipher_alg * cocci_id@p [ ARRAY_SIZE ( serpent_algs ) ] ;
