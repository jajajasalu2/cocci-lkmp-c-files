...
position p;
@@
 struct chachapoly_req_ctx * cocci_id@p ;
...
position p;
@@
 struct chachapoly_instance_ctx {  struct crypto_skcipher_spawn chacha ;  struct crypto_ahash_spawn poly ;  unsigned int saltlen ; } cocci_id@p ;
...
position p;
@@
 struct chachapoly_ctx cocci_id@p ;
...
typedef u8;
@@
 struct chachapoly_ctx {  struct crypto_skcipher * chacha ;  struct crypto_ahash * poly ;  unsigned int saltlen ;  u8 salt [ ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct chacha_req {  u8 iv [ CHACHA_IV_SIZE ] ;  struct scatterlist src [ 1 ] ;  struct skcipher_request req ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct aead_request * ) ;
...
typedef u8,u32;
@@
 struct chachapoly_req_ctx {  struct scatterlist src [ 2 ] ;  struct scatterlist dst [ 2 ] ;  u8 key [ POLY1305_KEY_SIZE ] ;  u8 tag [ POLY1305_DIGEST_SIZE ] ;  unsigned int cryptlen ;  unsigned int assoclen ;  u32 flags ;  union {  struct poly_req poly ;  struct chacha_req chacha ; } u ; } cocci_id@p ;
...
typedef u8,__le64;
@@
 struct poly_req {  u8 pad [ POLY1305_BLOCK_SIZE ] ;  struct {  __le64 assoclen ;  __le64 cryptlen ; } tail ;  struct scatterlist src [ 1 ] ;  struct ahash_request req ; } cocci_id@p ;
...
position p;
@@
 struct chachapoly_instance_ctx * cocci_id@p ;
