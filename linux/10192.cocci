...
position p;
@@
 struct hfcsusb_vdata * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hfcsusb * hw ) ;
...
position p;
@@
 void cocci_id@p ( struct bchannel * bch ) ;
...
position p;
@@
 void cocci_id@p ( struct hfcsusb * hw , int channel ) ;
...
typedef u_char;
@@
 void cocci_id@p ( struct hfcsusb * hw , u_char command ) ;
...
position p;
@@
 int cocci_id@p ( struct bchannel * bch , int protocol ) ;
