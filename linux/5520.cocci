...
position p;
@@
 struct ds2404 {  struct ds2404_gpio * gpio ;  struct rtc_device * rtc ; } cocci_id@p ;
...
position p;
@@
 struct ds2404_gpio {  const char * name ;  unsigned int gpio ; } cocci_id@p ;
...
position p;
@@
 struct ds2404_platform_data * cocci_id@p ;
