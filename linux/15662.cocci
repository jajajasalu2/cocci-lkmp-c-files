...
position p;
@@
 struct gb_uart_set_break_request cocci_id@p ;
...
position p;
@@
 struct gb_uart_set_line_coding_request cocci_id@p ;
...
position p;
@@
 struct gb_uart_receive_credits_request * cocci_id@p ;
...
position p;
@@
 struct gb_uart_recv_data_request * cocci_id@p ;
...
position p;
@@
 struct gb_tty_line_coding cocci_id@p ;
...
typedef __le32,__u8;
@@
 struct gb_tty_line_coding {  __le32 rate ;  __u8 format ;  __u8 parity ;  __u8 data_bits ;  __u8 flow_control ; } cocci_id@p ;
...
position p;
@@
 struct gb_uart_serial_flush_request cocci_id@p ;
...
position p;
@@
 struct gb_uart_send_data_request cocci_id@p ;
...
position p;
@@
 struct gb_uart_set_control_line_state_request cocci_id@p ;
...
position p;
@@
 struct gb_uart_serial_state_request * cocci_id@p ;
