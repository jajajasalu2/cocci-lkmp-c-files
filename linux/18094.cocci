...
position p;
@@
 struct vpbe_enc_mode_info cocci_id@p [ ] ;
...
position p;
@@
 struct amp_config_info cocci_id@p ;
...
typedef u8;
@@
 struct cpld_led {  struct led_classdev cdev ;  u8 mask ; } cocci_id@p ;
...
position p;
@@
 struct ths7303_platform_data cocci_id@p ;
...
position p;
@@
 struct davinci_ks_platform_data cocci_id@p ;
