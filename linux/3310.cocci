...
position p;
@@
 struct k10temp_data * cocci_id@p ;
...
position p;
@@
 const struct tctl_offset cocci_id@p [ ] ;
...
typedef bool,u32;
@@
 struct k10temp_data {  struct pci_dev * pdev ;  void ( * read_htcreg ) ( struct pci_dev * pdev , u32 * regval ) ;  void ( * read_tempreg ) ( struct pci_dev * pdev , u32 * regval ) ;  int temp_offset ;  u32 temp_adjust_mask ;  bool show_tdie ; } cocci_id@p ;
...
typedef u8;
@@
 struct tctl_offset {  u8 model ;  const char * id ;  int offset ; } cocci_id@p ;
