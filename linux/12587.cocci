...
position p;
@@
 const enum mdp5_pipe * cocci_id@p ;
...
position p;
@@
 struct drm_plane * cocci_id@p [ MAX_BASES ] ;
...
position p;
@@
 const struct mdp_kms_funcs cocci_id@p ;
...
position p;
@@
 struct mdp5_ctl_manager * cocci_id@p ;
...
position p;
@@
 struct mdp5_global_state * cocci_id@p ;
...
position p;
@@
 const enum mdp5_intf_type * cocci_id@p ;
