...
typedef atomic_t;
@@
 struct dz_mux {  struct dz_port dport [ DZ_NB_PORT ] ;  atomic_t map_guard ;  atomic_t irq_guard ;  int initialised ; } cocci_id@p ;
...
position p;
@@
 struct dz_port {  struct dz_mux * mux ;  struct uart_port port ;  unsigned int cflag ; } cocci_id@p ;
