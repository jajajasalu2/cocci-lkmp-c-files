...
position p;
@@
 const struct alps_nibble_commands cocci_id@p [ ] ;
...
position p;
@@
 const struct alps_model_info * cocci_id@p ;
...
position p;
@@
 struct alps_bitmap_point cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct alps_data * priv , struct input_dev * dev1 ) ;
...
position p;
@@
 struct input_mt_pos cocci_id@p [ 4 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ sizeof ( psmouse -> packet ) ] ;
...
position p;
@@
 const struct alps_protocol_info * cocci_id@p ;
