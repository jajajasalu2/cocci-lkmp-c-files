...
symbol cocci_id;
position p;
typedef cvmx_spi_callbacks_t;
@@
 cvmx_spi_callbacks_t cocci_id@p ;
...
position p;
@@
 union cvmx_gmxx_rxx_jabber cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cvmx_spi_mode_t;
@@
 cvmx_spi_mode_t cocci_id@p ;
...
position p;
@@
 union cvmx_spxx_clk_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_spxx_bist_stat cocci_id@p ;
...
position p;
@@
 union cvmx_stxx_spi4_dat cocci_id@p ;
...
position p;
@@
 union cvmx_spxx_trn4_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_srxx_spi4_calx cocci_id@p ;
...
position p;
@@
 union cvmx_gmxx_tx_spi_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_gmxx_rxx_frm_min cocci_id@p ;
...
position p;
@@
 union cvmx_stxx_arb_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_gmxx_rxx_frm_max cocci_id@p ;
...
position p;
@@
 union cvmx_stxx_com_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_stxx_spi4_stat cocci_id@p ;
...
position p;
@@
 union cvmx_spxx_dbg_deskew_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_spxx_int_msk cocci_id@p ;
...
position p;
@@
 union cvmx_srxx_spi4_stat cocci_id@p ;
...
position p;
@@
 union cvmx_stxx_int_msk cocci_id@p ;
...
position p;
@@
 union cvmx_gmxx_tx_spi_thresh cocci_id@p ;
...
position p;
@@
 union cvmx_stxx_spi4_calx cocci_id@p ;
...
position p;
@@
 union cvmx_srxx_com_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_gmxx_tx_spi_max cocci_id@p ;
...
position p;
@@
 union cvmx_spxx_clk_stat cocci_id@p ;
