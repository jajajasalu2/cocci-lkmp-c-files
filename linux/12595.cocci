...
position p;
@@
 void cocci_id@p ( struct dpu_kms * dpu_kms ) ;
...
position p;
@@
 struct dss_module_power * cocci_id@p ;
...
position p;
@@
 struct dpu_danger_safe_status cocci_id@p ;
...
position p;
@@
 const struct msm_kms_funcs cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct msm_kms * kms ) ;
...
position p;
@@
 struct drm_plane * cocci_id@p [ MAX_PLANES ] ;
...
position p;
@@
 struct dpu_debugfs_regset32 * cocci_id@p ;
