...
position p;
@@
 struct adc081c {  struct i2c_client * i2c ;  struct regulator * ref ;  int bits ; } cocci_id@p ;
...
position p;
@@
 struct adcxx1c_model cocci_id@p [ ] ;
...
position p;
@@
 struct adcxx1c_model {  const struct iio_chan_spec * channels ;  int bits ; } cocci_id@p ;
...
position p;
@@
 enum adcxx1c_model_id { ADC081C = 0 , ADC101C = 1 , ADC121C = 2 , } cocci_id@p ;
