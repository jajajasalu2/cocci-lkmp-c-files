...
position p;
@@
 struct iwl_rx_mpdu_res_start cocci_id@p ;
...
position p;
@@
 const struct iwl_hcmd_names cocci_id@p [ ] ;
...
position p;
@@
 const struct iwl_rx_handlers * cocci_id@p ;
...
position p;
@@
 const struct iwl_fw * cocci_id@p ;
...
position p;
@@
 struct mvm_statistics_rx cocci_id@p ;
...
position p;
@@
 enum iwl_amsdu_size cocci_id@p ;
...
position p;
@@
 const struct iwl_device_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_trans_config cocci_id@p ;
...
position p;
@@
 const struct iwl_fw_runtime_ops cocci_id@p ;
...
position p;
@@
 struct iwl_rx_mpdu_desc cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_mod_params cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * wk ) ;
...
position p;
@@
 struct mvm_statistics_rx_v3 cocci_id@p ;
...
position p;
@@
 struct iwl_async_handler_entry * cocci_id@p ;
...
typedef u16;
@@
 struct iwl_rx_handlers {  u16 cmd_id ;  enum iwl_rx_handler_context context ;  void ( * fn ) ( struct iwl_mvm * mvm , struct iwl_rx_cmd_buffer * rxb ) ; } cocci_id@p ;
...
position p;
@@
 union iwl_dbg_tlv_tp_data cocci_id@p ;
...
position p;
@@
 const struct iwl_pwr_tx_backoff * cocci_id@p ;
...
position p;
@@
 struct iwl_async_handler_entry {  struct list_head list ;  struct iwl_rx_cmd_buffer rxb ;  enum iwl_rx_handler_context context ;  void ( * fn ) ( struct iwl_mvm * mvm , struct iwl_rx_cmd_buffer * rxb ) ; } cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_reprobe * cocci_id@p ;
...
position p;
@@
 const struct iwl_fw_cmd_version * cocci_id@p ;
...
position p;
@@
 enum iwl_rx_handler_context { RX_HANDLER_SYNC , RX_HANDLER_ASYNC_LOCKED , RX_HANDLER_ASYNC_UNLOCKED , } cocci_id@p ;
...
position p;
@@
 const struct iwl_hcmd_arr cocci_id@p [ ] ;
...
position p;
@@
 struct iwl_mvm_reprobe {  struct device * dev ;  struct work_struct work ; } cocci_id@p ;
