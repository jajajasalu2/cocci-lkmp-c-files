...
position p;
@@
 struct ad9523_state * cocci_id@p ;
...
position p;
@@
 struct iio_dev_attr * cocci_id@p ;
...
position p;
@@
 enum { AD9523_VCO1 , AD9523_VCO2 , AD9523_VCXO , AD9523_NUM_CLK_SRC , } cocci_id@p ;
...
position p;
@@
 struct ad9523_platform_data * cocci_id@p ;
...
position p;
@@
 enum { AD9523_STAT_PLL1_LD , AD9523_STAT_PLL2_LD , AD9523_STAT_REFA , AD9523_STAT_REFB , AD9523_STAT_REF_TEST , AD9523_STAT_VCXO , AD9523_STAT_PLL2_FB_CLK , AD9523_STAT_PLL2_REF_CLK , AD9523_SYNC , AD9523_EEPROM , } cocci_id@p ;
...
typedef u8,__be32;
@@
 struct ad9523_state {  struct spi_device * spi ;  struct regulator * reg ;  struct ad9523_platform_data * pdata ;  struct iio_chan_spec ad9523_channels [ AD9523_NUM_CHAN ] ;  struct gpio_desc * pwrdown_gpio ;  struct gpio_desc * reset_gpio ;  struct gpio_desc * sync_gpio ;  unsigned long vcxo_freq ;  unsigned long vco_freq ;  unsigned long vco_out_freq [ AD9523_NUM_CLK_SRC ] ;  unsigned char vco_out_map [ AD9523_NUM_CHAN_ALT_CLK_SRC ] ;  struct mutex lock ;  union {  __be32 d32 ;  u8 d8 [ 4 ] ; } data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ad9523_channel_spec * cocci_id@p ;
