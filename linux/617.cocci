...
typedef u8,u64;
@@
 struct wp512_ctx {  u8 bitLength [ WP512_LENGTHBYTES ] ;  u8 buffer [ WP512_BLOCK_SIZE ] ;  int bufferBits ;  int bufferPos ;  u64 hash [ WP512_DIGEST_SIZE / 8 ] ; } cocci_id@p ;
...
typedef u64;
@@
 const u64 cocci_id@p [ WHIRLPOOL_ROUNDS ] ;
