...
typedef dma_addr_t;
@@
 struct grcan_dma_buffer {  size_t size ;  void * buf ;  dma_addr_t handle ; } cocci_id@p ;
...
position p;
@@
 struct grcan_device_config cocci_id@p ;
...
@@
 struct grcan_priv {  struct can_priv can ;  struct net_device * dev ;  struct napi_struct napi ;  struct grcan_registers __iomem * regs ;  struct grcan_device_config config ;  struct grcan_dma dma ;  struct sk_buff * * echo_skb ;  u8 * txdlc ;  u32 eskbp ;  spinlock_t lock ;  bool need_txbug_workaround ;  struct timer_list hang_timer ;  struct timer_list rr_timer ;  bool resetting ;  bool closing ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct grcan_dma {  size_t base_size ;  void * base_buf ;  dma_addr_t base_handle ;  struct grcan_dma_buffer tx ;  struct grcan_dma_buffer rx ; } cocci_id@p ;
...
position p;
@@
 struct grcan_dma_buffer * cocci_id@p ;
...
position p;
@@
 struct grcan_device_config {  unsigned short enable0 ;  unsigned short enable1 ;  unsigned short select ;  unsigned int txsize ;  unsigned int rxsize ; } cocci_id@p ;
...
position p;
@@
 const struct attribute * constcocci_id [ ] ;
