...
position p;
@@
 struct aegis_ctx {  struct aegis_block key ; } cocci_id@p ;
...
position p;
@@
 const struct aegis_block cocci_id@p ;
...
position p;
@@
 const struct aegis_crypt_ops cocci_id@p ;
...
position p;
@@
 struct simd_aead_alg * cocci_id@p ;
...
position p;
@@
 struct aegis_state {  struct aegis_block blocks [ AEGIS128_STATE_BLOCKS ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * state , unsigned int length , const void * src , void * dst ) ;
...
position p;
@@
 void cocci_id@p ( void * state , void * key , void * iv ) ;
...
position p;
@@
 void cocci_id@p ( void * state , unsigned int length , const void * data ) ;
...
position p;
@@
 void cocci_id@p ( void * state , void * tag_xor , unsigned int cryptlen , unsigned int assoclen ) ;
