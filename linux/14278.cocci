...
position p;
@@
 struct cx24123_state * cocci_id@p ;
...
position p;
@@
 const struct cx24123_config * cocci_id@p ;
...
position p;
@@
 struct cx24123_bandselect_val * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cx24123_state {  struct i2c_adapter * i2c ;  const struct cx24123_config * config ;  struct dvb_frontend frontend ;  u32 VCAarg ;  u32 VGAarg ;  u32 bandselectarg ;  u32 pllarg ;  u32 FILTune ;  struct i2c_adapter tuner_i2c_adapter ;  u8 demod_rev ;  u32 currentfreq ;  u32 currentsymbolrate ; } cocci_id@p ;
...
typedef u32;
@@
 struct cx24123_AGC_val {  u32 symbolrate_low ;  u32 symbolrate_high ;  u32 VCAprogdata ;  u32 VGAprogdata ;  u32 FILTune ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct cx24123_bandselect_val {  u32 freq_low ;  u32 freq_high ;  u32 VCOdivider ;  u32 progdata ; } cocci_id@p [ ] ;
...
position p;
@@
 struct cx24123_AGC_val * cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 reg ;  u8 data ; } cocci_id@p [ ] ;
