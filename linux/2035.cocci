...
position p;
@@
 enum bma180_chan { AXIS_X , AXIS_Y , AXIS_Z , TEMP , } cocci_id@p ;
...
position p;
@@
 const struct bma180_part_info cocci_id@p [ ] ;
...
position p;
@@
 enum chip_ids { BMA180 , BMA250 , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct bma180_data {  struct i2c_client * client ;  struct iio_trigger * trig ;  const struct bma180_part_info * part_info ;  struct iio_mount_matrix orientation ;  struct mutex mutex ;  bool sleep_state ;  int scale ;  int bw ;  bool pmode ;  u8 buff [ 16 ] ; } cocci_id@p ;
