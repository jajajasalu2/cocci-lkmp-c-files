...
typedef u32;
@@
 const u32 cocci_id@p [ ACCEL_3D_CHANNEL_MAX ] ;
...
position p;
@@
 enum accel_3d_channel { CHANNEL_SCAN_INDEX_X , CHANNEL_SCAN_INDEX_Y , CHANNEL_SCAN_INDEX_Z , ACCEL_3D_CHANNEL_MAX , } cocci_id@p ;
...
position p;
@@
 struct accel_3d_state * cocci_id@p ;
...
typedef u32,int64_t;
@@
 struct accel_3d_state {  struct hid_sensor_hub_callbacks callbacks ;  struct hid_sensor_common common_attributes ;  struct hid_sensor_hub_attribute_info accel [ ACCEL_3D_CHANNEL_MAX ] ;  u32 accel_val [ ACCEL_3D_CHANNEL_MAX + 3 ] ;  int scale_pre_decml ;  int scale_post_decml ;  int scale_precision ;  int value_offset ;  int64_t timestamp ; } cocci_id@p ;
