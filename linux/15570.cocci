...
typedef u8;
@@
 u8 cocci_id@p [ HFA384x_RID_NICSERIALNUMBER_LEN ] ;
...
position p;
@@
 struct hfa384x_assoc_status cocci_id@p ;
...
position p;
@@
 struct hfa384x_join_request_data cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct wlandevice * wlandev , struct sk_buff * skb , union p80211_hdr * p80211_hdr , struct p80211_metawep * p80211_wep ) ;
...
position p;
@@
 int cocci_id@p ( struct wlandevice * wlandev , struct net_device * dev ) ;
...
position p;
@@
 struct hfa384x_ch_info_result_sub * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct wlandevice * wlandev , struct p80211msg * msg ) ;
...
position p;
@@
 struct p80211msg_lnxreq_ifstate * cocci_id@p ;
...
position p;
@@
 struct wlandevice * cocci_id@p ( void ) ;
...
position p;
@@
 struct p80211item_uint32 * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct wlandevice * wlandev , struct hfa384x_inf_frame * inf ) ;
...
position p;
@@
 struct hfa384x_scan_result * cocci_id@p ;
...
position p;
@@
 struct hfa384x_authenticate_station_data cocci_id@p ;
...
position p;
@@
 struct hfa384x_scan_result_sub cocci_id@p ;
...
position p;
@@
 struct p80211msg_lnxreq_commsquality * cocci_id@p ;
...
position p;
@@
 struct hfa384x_comm_tallies_32 cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct wlandevice * wlandev ) ;
...
position p;
@@
 void cocci_id@p ( struct wlandevice * wlandev ) ;
...
position p;
@@
 struct hfa384x_bytestr * cocci_id@p ;
...
position p;
@@
 struct hfa384x_inf_frame * cocci_id@p ;
...
position p;
@@
 struct hfa384x_bytestr32 cocci_id@p ;
