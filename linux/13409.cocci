...
position p;
@@
 struct tda18271_map_layout {  struct tda18271_pll_map * main_pll ;  struct tda18271_pll_map * cal_pll ;  struct tda18271_map * rf_cal ;  struct tda18271_map * rf_cal_kmco ;  struct tda18271_map * rf_cal_dc_over_dt ;  struct tda18271_map * bp_filter ;  struct tda18271_map * rf_band ;  struct tda18271_map * gain_taper ;  struct tda18271_map * ir_measure ; } cocci_id@p ;
...
position p;
@@
 struct tda18271_pll_map * cocci_id@p ;
...
position p;
@@
 struct tda18271_rf_tracking_filter_cal cocci_id@p [ ] ;
...
position p;
@@
 struct tda18271_priv * cocci_id@p ;
...
position p;
@@
 const struct tda18271_std_map cocci_id@p ;
...
position p;
@@
 struct tda18271_map cocci_id@p [ ] ;
...
position p;
@@
 enum tda18271_map_type cocci_id@p ;
...
typedef u8,u32;
@@
 struct tda18271_map {  u32 rfmax ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 struct tda18271_thermo_map cocci_id@p [ ] ;
...
position p;
@@
 struct tda18271_map_layout cocci_id@p ;
...
position p;
@@
 struct tda18271_cid_target_map cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct tda18271_pll_map {  u32 lomax ;  u8 pd ;  u8 d ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct tda18271_cid_target_map {  u32 rfmax ;  u8 target ;  u16 limit ; } cocci_id@p ;
...
typedef u8;
@@
 struct tda18271_thermo_map {  u8 d ;  u8 r0 ;  u8 r1 ; } cocci_id@p ;
