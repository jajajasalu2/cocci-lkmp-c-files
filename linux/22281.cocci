...
position p;
@@
 struct ptrace_relation * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( agent -> comm ) ] ;
...
position p;
@@
 struct access_report_info * cocci_id@p ;
...
position p;
@@
 struct access_report_info {  struct callback_head work ;  const char * access ;  struct task_struct * target ;  struct task_struct * agent ; } cocci_id@p ;
...
typedef bool;
@@
 struct ptrace_relation {  struct task_struct * tracer ;  struct task_struct * tracee ;  bool invalid ;  struct list_head node ;  struct rcu_head rcu ; } cocci_id@p ;
