...
position p;
@@
 struct brcmf_pno_info * cocci_id@p ;
...
position p;
@@
 struct brcmf_pno_net_param_le cocci_id@p ;
...
position p;
@@
 struct brcmf_pno_config_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_pno_param_le cocci_id@p ;
...
position p;
@@
 struct brcmf_gscan_bucket_config * cocci_id@p ;
...
position p;
@@
 struct brcmf_pno_bssid_le cocci_id@p ;
...
position p;
@@
 struct brcmf_gscan_config * cocci_id@p ;
...
position p;
@@
 struct brcmf_pno_macaddr_le cocci_id@p ;
...
position p;
@@
 struct brcmf_pno_info {  int n_reqs ;  struct cfg80211_sched_scan_request * reqs [ BRCMF_PNO_MAX_BUCKETS ] ;  struct mutex req_lock ; } cocci_id@p ;
