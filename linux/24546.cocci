...
position p;
@@
 struct virtio_vsock_pkt_info * cocci_id@p ;
...
position p;
@@
 const struct virtio_transport * cocci_id@p ;
...
position p;
@@
 struct virtio_vsock_sock * cocci_id@p ;
...
position p;
@@
 struct af_vsockmon_hdr * cocci_id@p ;
...
position p;
@@
 struct virtio_vsock_hdr * cocci_id@p ;
