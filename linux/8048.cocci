...
typedef phys_addr_t;
@@
 struct mdio_mux_mmioreg_state {  void * mux_handle ;  phys_addr_t phys ;  unsigned int iosize ;  unsigned int mask ; } cocci_id@p ;
...
position p;
@@
 struct mdio_mux_mmioreg_state * cocci_id@p ;
