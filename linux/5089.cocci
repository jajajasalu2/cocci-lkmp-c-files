...
@@
 struct idi_48_gpio {  struct gpio_chip chip ;  raw_spinlock_t lock ;  spinlock_t ack_lock ;  unsigned char irq_mask [ 6 ] ;  unsigned base ;  unsigned char cos_enb ; } cocci_id@p ;
...
position p;
@@
 struct idi_48_gpio * const cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ IDI48_NGPIO ] ;
...
position p;
@@
 struct gpio_chip * const cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_NUM_IDI_48 ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ 6 ] ;
