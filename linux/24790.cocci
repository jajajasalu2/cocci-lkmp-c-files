...
position p;
@@
 enum sdp_header_types cocci_id@p ;
...
position p;
@@
 struct nf_ct_sip_master * cocci_id@p ;
...
position p;
@@
 const struct sip_header cocci_id@p [ ] ;
...
position p;
@@
 unsigned short cocci_id@p [ MAX_PORTS ] ;
...
position p;
@@
 const struct sdp_media_type cocci_id@p [ ] ;
...
position p;
@@
 const struct nf_conntrack_expect_policy cocci_id@p [ SIP_EXPECT_MAX + 1 ] ;
...
position p;
@@
 enum sip_expectation_classes cocci_id@p ;
...
position p;
@@
 const struct nf_nat_sip_hooks * cocci_id@p ;
...
position p;
@@
 enum sip_header_types cocci_id@p ;
...
position p;
@@
 const struct sip_handler cocci_id@p [ ] ;
