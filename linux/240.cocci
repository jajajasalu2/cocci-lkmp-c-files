...
position p;
@@
 struct ftrace_buffer_info {  struct trace_iterator iter ;  void * spare ;  unsigned int spare_cpu ;  unsigned int read ; } cocci_id@p ;
...
position p;
@@
 struct ring_buffer_iter * cocci_id@p ;
...
position p;
@@
 struct pipe_inode_info * cocci_id@p ;
...
position p;
@@
 struct tracing_log_err cocci_id@p ;
...
position p;
@@
 union trace_eval_map_item * cocci_id@p ;
...
position p;
@@
 struct tracer_flags * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_TRACER_SIZE + 1 ] ;
...
position p;
@@
 struct saved_cmdlines_buffer {  unsigned map_pid_to_cmdline [ PID_MAX_DEFAULT + 1 ] ;  unsigned * map_cmdline_to_pid ;  unsigned cmdline_num ;  int cmdline_idx ;  char * saved_cmdlines ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct trace_buffer * buf , unsigned long val ) ;
...
position p;
@@
 struct trace_eval_map_tail {  union trace_eval_map_item * next ;  const char * end ; } cocci_id@p ;
...
position p;
@@
 union trace_eval_map_item {  struct trace_eval_map map ;  struct trace_eval_map_head head ;  struct trace_eval_map_tail tail ; } cocci_id@p ;
...
position p;
@@
 struct splice_pipe_desc cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ring_buffer * buffer , unsigned long flags , int pc ) ;
...
position p;
@@
 void cocci_id@p ( struct trace_array * tr , struct tracer * t ) ;
...
position p;
@@
 struct trace_option_dentry * cocci_id@p ;
...
position p;
@@
 struct trace_eval_map_head {  struct module * mod ;  unsigned long length ; } cocci_id@p ;
...
position p;
@@
 struct trace_selftests * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ring_buffer * buffer , unsigned long flags , int skip , int pc , struct pt_regs * regs ) ;
...
position p;
@@
 struct tracing_log_err {  struct list_head list ;  struct err_info info ;  char loc [ TRACING_LOG_LOC_MAX ] ;  char cmd [ MAX_FILTER_STR_VAL ] ; } cocci_id@p ;
...
typedef refcount_t;
@@
 struct buffer_ref {  struct ring_buffer * buffer ;  void * page ;  int cpu ;  refcount_t refcount ; } cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p [ PIPE_DEF_BUFFERS ] ;
...
position p;
@@
 struct trace_export * * cocci_id@p ;
...
position p;
@@
 struct trace_buffer_struct * cocci_id@p ;
...
position p;
@@
 struct ftrace_stack {  unsigned long calls [ FTRACE_KSTACK_ENTRIES ] ; } cocci_id@p ;
...
typedef u64,u8;
@@
 struct err_info {  const char * * errs ;  u8 type ;  u8 pos ;  u64 ts ; } cocci_id@p ;
...
position p;
@@
 enum ring_buffer_flags cocci_id@p ;
...
position p;
@@
 struct trace_eval_map * cocci_id@p [ ] ;
...
position p;
@@
 struct bprint_entry * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_TRACER_SIZE + 2 ] ;
...
position p;
@@
 struct trace_array_cpu cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct trace_array * tr , struct dentry * d_tracer ) ;
...
position p;
@@
 struct trace_buffer * cocci_id@p ;
...
position p;
@@
 enum ftrace_dump_mode cocci_id@p ;
...
position p;
@@
 struct trace_selftests {  struct list_head list ;  struct tracer * type ; } cocci_id@p ;
...
position p;
@@
 struct cond_snapshot * cocci_id@p ;
...
typedef u64;
@@
 struct {  u64 ( * func ) ( void ) ;  const char * name ;  int in_ns ; } cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef cond_update_fn_t;
@@
 cond_update_fn_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * inode , struct file * filp ) ;
...
position p;
@@
 void cocci_id@p ( struct trace_array * tr , struct tracer * tracer ) ;
...
position p;
@@
 struct ftrace_entry * cocci_id@p ;
...
position p;
@@
 struct ftrace_stacks {  struct ftrace_stack stacks [ FTRACE_KSTACK_NESTING ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct trace_array * tr , struct ring_buffer * buffer , unsigned long flags , int skip , int pc , struct pt_regs * regs ) ;
...
position p;
@@
 struct ftrace_stack * cocci_id@p ;
...
position p;
@@
 struct userstack_entry * cocci_id@p ;
...
position p;
@@
 enum event_trigger_type cocci_id@p ;
...
position p;
@@
 struct saved_cmdlines_buffer * cocci_id@p ;
...
position p;
@@
 const struct pipe_buf_operations cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct trace_array * tr , const char * buf ) ;
...
position p;
@@
 int cocci_id@p ( struct trace_buffer * trace_buf , struct trace_buffer * size_buf , int cpu_id ) ;
...
symbol cocci_id;
position p;
typedef arch_spinlock_t;
@@
 arch_spinlock_t cocci_id@p ;
...
position p;
@@
 struct raw_data_entry * cocci_id@p ;
...
position p;
@@
 struct ftrace_buffer_info * cocci_id@p ;
...
position p;
@@
 struct trace_buffer_struct {  int nesting ;  char buffer [ 4 ] [ TRACE_BUF_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct partial_page cocci_id@p [ PIPE_DEF_BUFFERS ] ;
...
position p;
@@
 struct trace_options * cocci_id@p ;
