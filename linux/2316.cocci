...
position p;
@@
 struct armada_thermal_data * cocci_id@p ;
...
position p;
@@
 struct armada_drvdata {  enum drvtype { LEGACY , SYSCON , } type ;  union {  struct armada_thermal_priv * priv ;  struct thermal_zone_device * tz ; } data ; } cocci_id@p ;
...
position p;
@@
 const struct thermal_trip * cocci_id@p ;
...
position p;
@@
 struct armada_thermal_priv {  struct device * dev ;  struct regmap * syscon ;  char zone_name [ THERMAL_NAME_LENGTH ] ;  struct mutex update_lock ;  struct armada_thermal_data * data ;  struct thermal_zone_device * overheat_sensor ;  int interrupt_source ;  int current_channel ;  long current_threshold ;  long current_hysteresis ; } cocci_id@p ;
...
position p;
@@
 struct armada_thermal_sensor cocci_id@p ;
...
position p;
@@
 const struct armada_thermal_data cocci_id@p ;
...
position p;
@@
 struct armada_drvdata * cocci_id@p ;
...
position p;
@@
 struct armada_thermal_sensor {  struct armada_thermal_priv * priv ;  int id ; } cocci_id@p ;
...
position p;
@@
 struct armada_thermal_priv * cocci_id@p ;
