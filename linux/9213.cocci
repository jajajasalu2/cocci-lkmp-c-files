...
position p;
@@
 const struct fs_ops cocci_id@p ;
...
position p;
@@
 const struct fs_platform_info * cocci_id@p ;
...
position p;
@@
 struct fs_enet_private * cocci_id@p ;
