...
position p;
@@
 sock_result_map cocci_id@p ( ".maps" ) ;
...
position p;
@@
 sk_pkt_out_cnt cocci_id@p ( ".maps" ) ;
...
position p;
@@
 sk_pkt_out_cnt10 cocci_id@p ( ".maps" ) ;
...
position p;
@@
 tcp_sock_result_map cocci_id@p ( ".maps" ) ;
