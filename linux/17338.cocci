...
position p;
@@
 struct OpalIoPhb4ErrorData * cocci_id@p ;
...
position p;
@@
 struct OpalIoPhbErrorCommon * cocci_id@p ;
...
position p;
@@
 struct OpalIoP7IOCPhbErrorData * cocci_id@p ;
...
position p;
@@
 struct OpalIoPhb3ErrorData * cocci_id@p ;
