...
position p;
@@
 struct wl1271_cmd_set_keys * cocci_id@p ;
...
position p;
@@
 struct wlcore_cmd_generic_cfg * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_start_fwlog * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_role_disable * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_croc * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_roc * cocci_id@p ;
...
position p;
@@
 struct wl12xx_arp_rsp_template * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_stop_channel_switch * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_set_peer_state * cocci_id@p ;
...
position p;
@@
 struct wl1271_cmd_header cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_role_enable * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_role_stop * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_regdomain_dfs_config * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_config_fwlog * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_role_start * cocci_id@p ;
...
position p;
@@
 struct wl1271_cmd_ps_params * cocci_id@p ;
...
position p;
@@
 struct cmd_enabledisable_path * cocci_id@p ;
...
position p;
@@
 struct wl12xx_null_data_template cocci_id@p ;
...
position p;
@@
 struct wl1271_cmd_template_set * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_add_peer * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_remove_peer * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_stop_fwlog * cocci_id@p ;
