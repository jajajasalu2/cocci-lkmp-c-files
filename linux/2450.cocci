...
position p;
@@
 struct rcar_dmac_hw_desc * cocci_id@p ;
...
position p;
@@
 const enum dma_slave_buswidth cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct rcar_dmac_chan_map {  dma_addr_t addr ;  enum dma_data_direction dir ;  struct rcar_dmac_chan_slave slave ; } cocci_id@p ;
...
@@
 struct rcar_dmac_xfer_chunk {  struct list_head node ;  dma_addr_t src_addr ;  dma_addr_t dst_addr ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 struct rcar_dmac_chan * cocci_id@p ;
...
position p;
@@
 struct rcar_dmac_desc cocci_id@p ;
...
typedef spinlock_t;
@@
 struct rcar_dmac_chan {  struct dma_chan chan ;  void __iomem * iomem ;  unsigned int index ;  int irq ;  struct rcar_dmac_chan_slave src ;  struct rcar_dmac_chan_slave dst ;  struct rcar_dmac_chan_map map ;  int mid_rid ;  spinlock_t lock ;  struct {  struct list_head free ;  struct list_head pending ;  struct list_head active ;  struct list_head done ;  struct list_head wait ;  struct rcar_dmac_desc * running ;  struct list_head chunks_free ;  struct list_head pages ; } desc ; } cocci_id@p ;
...
position p;
@@
 struct rcar_dmac_xfer_chunk cocci_id@p ;
...
position p;
@@
 struct rcar_dmac_desc_page * cocci_id@p ;
...
typedef u32;
@@
 struct rcar_dmac {  struct dma_device engine ;  struct device * dev ;  void __iomem * iomem ;  struct device_dma_parameters parms ;  unsigned int n_channels ;  struct rcar_dmac_chan * channels ;  u32 channels_mask ; 
...
position p;
@@
 const struct rcar_dmac_of_data * cocci_id@p ;
...
position p;
@@
 struct rcar_dmac_desc_page {  struct list_head node ;  union {  struct rcar_dmac_desc descs [ 0 ] ;  struct rcar_dmac_xfer_chunk chunks [ 0 ] ; } ; } cocci_id@p ;
...
typedef u32;
@@
 struct rcar_dmac_of_data {  u32 chan_offset_base ;  u32 chan_offset_stride ; } cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct rcar_dmac_chan_slave {  phys_addr_t slave_addr ;  unsigned int xfer_size ; } cocci_id@p ;
...
position p;
@@
 struct rcar_dmac_chan_map * cocci_id@p ;
