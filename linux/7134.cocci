...
position p;
@@
 struct gntdev_grant_map * cocci_id@p ;
...
position p;
@@
 struct ioctl_gntdev_dmabuf_imp_release cocci_id@p ;
...
position p;
@@
 struct sg_page_iter cocci_id@p ;
...
position p;
@@
 struct gntdev_dmabuf cocci_id@p ;
...
position p;
@@
 struct ioctl_gntdev_dmabuf_exp_wait_released cocci_id@p ;
...
typedef u32;
@@
 struct gntdev_dmabuf_export_args {  struct gntdev_priv * priv ;  struct gntdev_grant_map * map ;  struct gntdev_dmabuf_priv * dmabuf_priv ;  struct device * dev ;  int count ;  struct page * * pages ;  u32 fd ; } cocci_id@p ;
...
position p;
@@
 struct gntdev_dmabuf_export_args cocci_id@p ;
...
position p;
@@
 struct gntdev_dmabuf_attachment {  struct sg_table * sgt ;  enum dma_data_direction dir ; } cocci_id@p ;
...
position p;
@@
 struct gntdev_dmabuf_priv * cocci_id@p ;
...
position p;
@@
 struct gntdev_dmabuf_wait_obj * cocci_id@p ;
...
position p;
@@
 struct gntdev_dmabuf_attachment * cocci_id@p ;
...
position p;
@@
 struct ioctl_gntdev_dmabuf_exp_from_refs cocci_id@p ;
...
position p;
@@
 struct gntdev_dmabuf_wait_obj {  struct list_head next ;  struct gntdev_dmabuf * gntdev_dmabuf ;  struct completion completion ; } cocci_id@p ;
...
position p;
@@
 struct gntdev_dmabuf_priv {  struct list_head exp_list ;  struct list_head exp_wait_list ;  struct list_head imp_list ;  struct mutex lock ;  struct file * filp ; } cocci_id@p ;
...
typedef grant_ref_t;
@@
 struct gntdev_dmabuf {  struct gntdev_dmabuf_priv * priv ;  struct dma_buf * dmabuf ;  struct list_head next ;  int fd ;  union {  struct {  struct kref refcount ;  struct gntdev_priv * priv ;  struct gntdev_grant_map * map ; } exp ;  struct {  grant_ref_t * refs ;  struct sg_table * sgt ;  struct dma_buf_attachment * attach ; } imp ; } u ;  int nr_pages ;  struct page * * pages ; } cocci_id@p ;
...
position p;
@@
 struct ioctl_gntdev_dmabuf_imp_to_refs cocci_id@p ;
