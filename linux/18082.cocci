...
typedef u8,u32;
@@
 struct factory_config {  u32 magic ;  u32 version ;  u8 mac [ 6 ] ;  u32 fpga_type ;  u32 spare ;  u32 serialnumber ;  char partnum [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct part_no_info cocci_id@p [ ] ;
...
position p;
@@
 struct factory_config cocci_id@p ;
...
position p;
@@
 struct part_no_info {  const char * part_no ;  int max_freq ; } cocci_id@p ;
