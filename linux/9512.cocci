...
position p;
@@
 struct rtl_tid_data * cocci_id@p ;
...
typedef u8,u16;
@@
 struct sk_buff * cocci_id@p ( struct ieee80211_hw * hw , u8 * sa , u8 * bssid , u16 tid ) ;
...
position p;
@@
 struct rtl_bssid_entry * cocci_id@p ;
...
position p;
@@
 struct octet_string cocci_id@p ;
...
position p;
@@
 struct rtl_sta_info cocci_id@p ;
...
position p;
@@
 struct rtl_tcb_desc cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , bool timeout ) ;
...
position p;
@@
 struct rtl_global_var cocci_id@p ;
...
position p;
@@
 struct rtlwifi_tx_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ieee80211_hw * hw , struct sk_buff * skb ) ;
...
position p;
@@
 const struct rtl_btc_ops * cocci_id@p ;
...
position p;
@@
 struct rtl_tx_report * cocci_id@p ;
