...
position p;
@@
 struct channel_path_desc_fmt3 * cocci_id@p ;
...
position p;
@@
 struct sclp_chp_info cocci_id@p ;
...
typedef cfg_task_t;
@@
 enum cfg_task_t { cfg_none , cfg_configure , cfg_deconfigure , } cocci_id@p ;
...
typedef cfg_task_t;
@@
 enum cfg_task_t cocci_id@p [ __MAX_CSSID + 1 ] [ __MAX_CHPID + 1 ] ;
