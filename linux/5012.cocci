...
position p;
@@
 struct sdma_map_elem * cocci_id@p ;
...
typedef u32,uint;
@@
 void cocci_id@p ( struct sdma_engine * , u32 , uint ) ;
...
position p;
@@
 void cocci_id@p ( struct sdma_state * ) ;
...
position p;
@@
 void cocci_id@p ( struct sdma_engine * sde , enum sdma_events event ) ;
...
position p;
@@
 void cocci_id@p ( struct sdma_engine * , unsigned ) ;
...
position p;
@@
 struct hw_sdma_desc * cocci_id@p ;
...
position p;
@@
 struct sdma_rht_map_elem cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sdma_engine * , enum sdma_states ) ;
...
typedef u64;
@@
 void cocci_id@p ( struct sdma_engine * sde , u64 status ) ;
...
position p;
@@
 struct sdma_rht_node * cocci_id@p ;
...
position p;
@@
 const struct sdma_set_state_action * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sdma_engine * sde ) ;
...
position p;
@@
 struct sdma_rht_node {  unsigned long cpu_id ;  struct sdma_rht_map_elem * map [ HFI1_MAX_VLS_SUPPORTED ] ;  struct rhash_head node ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct sdma_rht_map_elem {  u32 mask ;  u8 ctr ;  struct sdma_engine * sde [ 0 ] ; } cocci_id@p ;
...
typedef uint;
@@
 void cocci_id@p ( struct sdma_engine * sde , uint avail ) ;
...
position p;
@@
 void cocci_id@p ( struct sdma_engine * ) ;
...
position p;
@@
 struct iowait * cocci_id@p [ SDMA_WAIT_BATCH_SIZE ] ;
