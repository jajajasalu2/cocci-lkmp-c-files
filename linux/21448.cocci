...
symbol cocci_id;
position p;
typedef alternative_cb_t;
@@
 alternative_cb_t cocci_id@p ;
...
position p;
@@
 struct alt_region {  struct alt_instr * begin ;  struct alt_instr * end ; } cocci_id@p ;
