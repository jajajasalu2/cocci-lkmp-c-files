...
position p;
@@
 struct tpa6130a2_platform_data * cocci_id@p ;
...
position p;
@@
 struct tpa6130a2_data {  struct device * dev ;  struct regmap * regmap ;  struct regulator * supply ;  int power_gpio ;  enum tpa_model id ; } cocci_id@p ;
...
position p;
@@
 struct tpa6130a2_data * cocci_id@p ;
...
position p;
@@
 enum tpa_model { TPA6130A2 , TPA6140A2 , } cocci_id@p ;
