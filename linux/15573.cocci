...
position p;
@@
 void cocci_id@p ( struct wlandevice * wlandev , struct p80211msg * msg ) ;
...
position p;
@@
 struct p80211msg_lnxreq_hostwep * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct wlandevice * wlandev , struct p80211msg_dot11req_mibget * mib_msg , int isget ) ;
