...
position p;
@@
 const struct seg6_hmac_info * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SEG6_HMAC_FIELD_LEN ] ;
...
position p;
@@
 struct seg6_hmac_info cocci_id@p ;
...
position p;
@@
 struct seg6_hmac_algo cocci_id@p [ ] ;
...
position p;
@@
 struct sr6_tlv_hmac * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SEG6_HMAC_MAX_DIGESTSIZE ] ;
