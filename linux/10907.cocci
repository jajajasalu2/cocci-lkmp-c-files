...
position p;
@@
 const struct mes_firmware_header_v1_0 * cocci_id@p ;
...
position p;
@@
 struct mes_add_queue_input * cocci_id@p ;
...
position p;
@@
 struct mes_resume_gang_input * cocci_id@p ;
...
position p;
@@
 struct mes_remove_queue_input * cocci_id@p ;
...
position p;
@@
 const struct amdgpu_mes_funcs cocci_id@p ;
...
position p;
@@
 struct mes_suspend_gang_input * cocci_id@p ;
