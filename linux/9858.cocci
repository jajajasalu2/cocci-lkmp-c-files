...
position p;
@@
 struct register_rmw cocci_id@p ;
...
position p;
@@
 struct register_write cocci_id@p ;
...
position p;
@@
 struct tx_frame_hdr cocci_id@p ;
...
position p;
@@
 struct htc_service_connreq cocci_id@p ;
...
typedef bool;
@@
 void ( * cocci_id@p ) ( void * , struct sk_buff * , enum htc_endpoint_id , bool txok ) ;
...
position p;
@@
 struct wmi_fw_version cocci_id@p ;
