...
position p;
@@
 struct restore_data_record cocci_id@p ;
...
typedef u8;
@@
 struct restore_data_record {  unsigned long jump_address ;  unsigned long jump_address_phys ;  unsigned long cr3 ;  unsigned long magic ;  u8 e820_digest [ MD5_DIGEST_SIZE ] ; } cocci_id@p ;
