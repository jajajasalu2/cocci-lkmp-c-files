...
position p;
@@
 struct atao_private * cocci_id@p ;
...
position p;
@@
 struct atao_board {  const char * name ;  int n_ao_chans ; } cocci_id@p ;
...
position p;
@@
 struct atao_private {  unsigned short cfg1 ;  unsigned short cfg3 ;  unsigned char caldac [ 21 ] ; } cocci_id@p ;
...
position p;
@@
 const struct atao_board * cocci_id@p ;
