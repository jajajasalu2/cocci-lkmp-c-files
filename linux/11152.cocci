...
position p;
@@
 struct mcif_buf_params * cocci_id@p ;
...
position p;
@@
 const struct mcif_wb_funcs cocci_id@p ;
...
position p;
@@
 enum dwb_scaler_mode cocci_id@p ;
...
position p;
@@
 struct mcif_irq_params * cocci_id@p ;
...
position p;
@@
 struct mcif_wb_frame_dump_info * cocci_id@p ;
