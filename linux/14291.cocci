...
position p;
@@
 enum lgdt3306a_lock_check cocci_id@p ;
...
position p;
@@
 enum lgdt3306a_mpeg_mode cocci_id@p ;
...
position p;
@@
 struct lgdt3306a_state * cocci_id@p ;
...
position p;
@@
 enum lgdt3306a_modulation cocci_id@p ;
...
position p;
@@
 enum lgdt3306a_lock_status cocci_id@p ;
...
position p;
@@
 const struct lgdt3306a_config * cocci_id@p ;
...
position p;
@@
 enum lgdt3306a_lock_status { LG3306_UNLOCK = 0x00 , LG3306_LOCK = 0x01 , LG3306_UNKNOWN_LOCK = 0xff , } cocci_id@p ;
...
position p;
@@
 enum lgdt3306a_tp_clock_edge cocci_id@p ;
...
position p;
@@
 enum lgdt3306a_neverlock_status cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lgdt3306a_state * state ) ;
...
position p;
@@
 enum lgdt3306a_tp_valid_polarity cocci_id@p ;
...
position p;
@@
 enum lgdt3306a_neverlock_status { LG3306_NL_INIT = 0x00 , LG3306_NL_PROCESS = 0x01 , LG3306_NL_LOCK = 0x02 , LG3306_NL_FAIL = 0x03 , LG3306_NL_UNKNOWN = 0xff , } cocci_id@p ;
...
position p;
@@
 enum lgdt3306a_modulation { LG3306_VSB = 0x00 , LG3306_QAM64 = 0x01 , LG3306_QAM256 = 0x02 , LG3306_UNKNOWN_MODE = 0xff , } cocci_id@p ;
...
position p;
@@
 enum lgdt3306a_lock_check { LG3306_SYNC_LOCK , LG3306_FEC_LOCK , LG3306_TR_LOCK , LG3306_AGC_LOCK , } cocci_id@p ;
...
typedef u32;
@@
 struct lgdt3306a_state {  struct i2c_adapter * i2c_adap ;  const struct lgdt3306a_config * cfg ;  struct dvb_frontend frontend ;  enum fe_modulation current_modulation ;  u32 current_frequency ;  u32 snr ;  struct i2c_mux_core * muxc ; } cocci_id@p ;
...
position p;
@@
 struct i2c_mux_core * cocci_id@p ;
