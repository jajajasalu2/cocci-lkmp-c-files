...
position p;
@@
 enum { IPCC_IRQ_RX , IPCC_IRQ_TX , IPCC_IRQ_NUM , } cocci_id@p ;
...
@@
 struct stm32_ipcc {  struct mbox_controller controller ;  void __iomem * reg_base ;  void __iomem * reg_proc ;  struct clk * clk ;  spinlock_t lock ;  int irqs [ IPCC_IRQ_NUM ] ;  u32 proc_id ;  u32 n_chans ;  u32 xcr ;  u32 xmr ; } cocci_id@p ;
