...
@@
 struct smsc95xx_priv {  u32 chip_id ;  u32 mac_cr ;  u32 hash_hi ;  u32 hash_lo ;  u32 wolopts ;  spinlock_t mac_cr_lock ;  u8 features ;  u8 suspend_flags ;  u8 mdix_ctrl ;  bool link_ok ;  struct delayed_work carrier_check ;  struct usbnet * dev ; } cocci_id@p ;
...
position p;
@@
 struct smsc95xx_priv cocci_id@p ;
