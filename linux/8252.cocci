...
position p;
@@
 struct korina_private * cocci_id@p ;
...
position p;
@@
 struct korina_device * cocci_id@p ;
...
position p;
@@
 enum chain_status { desc_filled , desc_empty , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct korina_private {  struct eth_regs * eth_regs ;  struct dma_reg * rx_dma_regs ;  struct dma_reg * tx_dma_regs ;  struct dma_desc * td_ring ;  struct dma_desc * rd_ring ;  struct sk_buff * tx_skb [ KORINA_NUM_TDS ] ;  struct sk_buff * rx_skb [ KORINA_NUM_RDS ] ;  int rx_next_done ;  int rx_chain_head ;  int rx_chain_tail ;  enum chain_status rx_chain_status ;  int tx_next_done ;  int tx_chain_head ;  int tx_chain_tail ;  enum chain_status tx_chain_status ;  int tx_count ;  int tx_full ;  int rx_irq ;  int tx_irq ;  spinlock_t lock ;  int dma_halt_cnt ;  int dma_run_cnt ;  struct napi_struct napi ;  struct timer_list media_check_timer ;  struct mii_if_info mii_if ;  struct work_struct restart_task ;  struct net_device * dev ;  int phy_addr ; } cocci_id@p ;
