...
typedef u8,u32;
@@
 struct ipu3_cio2_fmt {  u32 mbus_code ;  u32 fourcc ;  u8 mipicode ; } cocci_id@p ;
...
position p;
@@
 struct sensor_async_subdev cocci_id@p ;
...
position p;
@@
 struct sensor_async_subdev {  struct v4l2_async_subdev asd ;  struct csi2_bus_info csi2 ; } cocci_id@p ;
...
position p;
@@
 const struct ipu3_cio2_fmt * cocci_id@p ;
...
position p;
@@
 struct {  size_t begin , end ; } cocci_id@p [ 2 ] ;
...
position p;
@@
 struct cio2_csi2_timing * cocci_id@p ;
...
position p;
@@
 struct cio2_fbpt_entry * constcocci_id ;
...
position p;
@@
 struct cio2_fbpt_entry * cocci_id@p ;
...
position p;
@@
 const struct v4l2_mbus_framefmt cocci_id@p ;
...
position p;
@@
 struct cio2_fbpt_entry cocci_id@p [ CIO2_MAX_LOPS ] ;
