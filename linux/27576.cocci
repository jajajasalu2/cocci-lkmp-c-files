...
typedef u64;
@@
 struct extent_inode_elem {  u64 inum ;  u64 offset ;  struct extent_inode_elem * next ; } cocci_id@p ;
...
position p;
@@
 struct preftree {  struct rb_root_cached root ;  unsigned int count ; } cocci_id@p ;
...
typedef u64,u32;
@@
 int cocci_id@p ( u64 parent , u32 name_len , unsigned long name_off , struct extent_buffer * eb , void * ctx ) ;
...
symbol cocci_id;
position p;
typedef iterate_extent_inodes_t;
@@
 iterate_extent_inodes_t * cocci_id@p ;
...
position p;
@@
 const struct btrfs_file_extent_item * cocci_id@p ;
...
position p;
@@
 const struct btrfs_extent_item * cocci_id@p ;
...
position p;
@@
 const struct btrfs_key * cocci_id@p ;
...
position p;
@@
 struct ulist_iterator cocci_id@p ;
...
position p;
@@
 const struct btrfs_fs_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef iterate_irefs_t;
@@
 iterate_irefs_t * cocci_id@p ;
...
position p;
@@
 struct extent_inode_elem * * cocci_id@p ;
...
typedef u64;
@@
 struct share_check {  u64 root_objectid ;  u64 inum ;  int share_count ; } cocci_id@p ;
...
position p;
@@
 struct preftrees {  struct preftree direct ;  struct preftree indirect ;  struct preftree indirect_missing_keys ; } cocci_id@p ;
