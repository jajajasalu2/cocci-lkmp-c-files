...
position p;
@@
 struct ath79_gpio_platform_data * cocci_id@p ;
...
position p;
@@
 struct ath79_gpio_ctrl * cocci_id@p ;
...
@@
 struct ath79_gpio_ctrl {  struct gpio_chip gc ;  void __iomem * base ;  raw_spinlock_t lock ;  unsigned long both_edges ; } cocci_id@p ;
