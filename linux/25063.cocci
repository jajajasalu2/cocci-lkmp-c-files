...
position p;
@@
 enum ieee80211_self_protected_actioncode cocci_id@p ;
...
position p;
@@
 enum plink_event { PLINK_UNDEFINED , OPN_ACPT , OPN_RJCT , OPN_IGNR , CNF_ACPT , CNF_RJCT , CNF_IGNR , CLS_ACPT , CLS_IGNR , } cocci_id@p ;
