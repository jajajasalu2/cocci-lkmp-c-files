...
typedef u32;
@@
 struct histb_combphy_mode {  int fixed ;  int select ;  u32 reg ;  u32 shift ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 struct histb_combphy_priv * cocci_id@p ;
...
position p;
@@
 struct histb_combphy_mode * cocci_id@p ;
...
position p;
@@
 struct histb_combphy_priv {  void __iomem * mmio ;  struct regmap * syscon ;  struct reset_control * por_rst ;  struct clk * ref_clk ;  struct phy * phy ;  struct histb_combphy_mode mode ; } cocci_id@p ;
