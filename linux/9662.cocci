...
typedef u8,u16;
@@
 struct b206x_init_tab_entry {  u16 offset ;  u16 value_a ;  u16 value_g ;  u8 flags ; } cocci_id@p ;
...
position p;
@@
 const struct b206x_init_tab_entry * cocci_id@p ;
...
position p;
@@
 struct lpphy_tx_gain_table_entry cocci_id@p ;
