...
typedef u8;
@@
 struct sdhci_cdns_phy_cfg {  const char * property ;  u8 addr ; } cocci_id@p ;
...
position p;
@@
 const struct sdhci_cdns_phy_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct sdhci_cdns_priv * cocci_id@p ;
...
typedef bool;
@@
 struct sdhci_cdns_priv {  void __iomem * hrs_addr ;  bool enhanced_strobe ;  unsigned int nr_phy_params ;  struct sdhci_cdns_phy_param phy_params [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct sdhci_cdns_phy_param * cocci_id@p ;
...
typedef u8;
@@
 struct sdhci_cdns_phy_param {  u8 addr ;  u8 data ; } cocci_id@p ;
