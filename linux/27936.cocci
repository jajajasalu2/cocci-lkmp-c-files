...
position p;
@@
 struct nilfs_mdt_info * cocci_id@p ;
...
typedef u64,__u64;
@@
 struct nilfs_iget_args {  u64 ino ;  __u64 cno ;  struct nilfs_root * root ;  int for_gc ; } cocci_id@p ;
...
position p;
@@
 struct nilfs_iget_args * cocci_id@p ;
