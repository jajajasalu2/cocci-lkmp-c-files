...
position p;
@@
 struct fw_module_header * cocci_id@p ;
...
position p;
@@
 const struct sst_sram_shift cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct sst_dsp * sst ) ;
...
typedef u32;
@@
 struct sst_sram_shift {  u32 dev_id ;  u32 iram_shift ;  u32 dram_shift ; } cocci_id@p ;
