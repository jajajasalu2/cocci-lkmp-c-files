...
typedef refcount_t;
@@
 struct audit_tree {  refcount_t count ;  int goner ;  struct audit_chunk * root ;  struct list_head chunks ;  struct list_head rules ;  struct list_head list ;  struct list_head same_root ;  struct rcu_head head ;  char pathname [ ] ; } cocci_id@p ;
...
position p;
@@
 struct fsnotify_group * cocci_id@p ;
...
position p;
@@
 struct fsnotify_mark * cocci_id@p ;
...
position p;
@@
 const struct fsnotify_ops cocci_id@p ;
...
@@
 struct audit_chunk {  struct list_head hash ;  unsigned long key ;  struct fsnotify_mark * mark ;  struct list_head trees ;  int count ;  atomic_long_t refs ;  struct rcu_head head ;  struct node {  struct list_head list ;  struct audit_tree * owner ;  unsigned index ; } owners [ ] ; } cocci_id@p ;
...
position p;
@@
 struct audit_tree_mark * cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ HASH_SIZE ] ;
...
position p;
@@
 struct fsnotify_iter_info * cocci_id@p ;
...
position p;
@@
 struct audit_tree_mark {  struct fsnotify_mark mark ;  struct audit_chunk * chunk ; } cocci_id@p ;
