...
position p;
@@
 void cocci_id@p ( unsigned char * buf , int nb ) ;
...
position p;
@@
 enum cuda_state { idle , sent_first_byte , sending , reading , read_done , awaiting_reply , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct adb_request * req , void ( * done ) ( struct adb_request * ) , int nbytes , ... ) ;
