...
position p;
@@
 struct camellia_xts_ctx * cocci_id@p ;
...
position p;
@@
 struct camellia_ctx cocci_id@p ;
...
position p;
@@
 struct simd_skcipher_alg * cocci_id@p [ ARRAY_SIZE ( camellia_algs ) ] ;
...
typedef u8,le128;
@@
 void cocci_id@p ( struct camellia_ctx * ctx , u8 * dst , const u8 * src , le128 * iv ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct camellia_ctx * ctx , u8 * dst , const u8 * src ) ;
