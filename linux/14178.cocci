...
position p;
@@
 struct vivid_buffer cocci_id@p ;
...
position p;
@@
 const struct v4l2_frmsize_discrete cocci_id@p [ VIVID_WEBCAM_SIZES ] ;
...
position p;
@@
 struct v4l2_timecode * cocci_id@p ;
...
position p;
@@
 const struct v4l2_fract cocci_id@p [ VIVID_WEBCAM_IVALS ] ;
...
position p;
@@
 enum tpg_pixel_aspect cocci_id@p ;
...
position p;
@@
 const struct vivid_fmt cocci_id@p [ ] ;
...
position p;
@@
 const struct vivid_dev * cocci_id@p ;
...
position p;
@@
 enum tpg_video_aspect cocci_id@p ;
