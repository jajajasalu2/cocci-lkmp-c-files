...
typedef u32;
@@
 struct chksum_desc_ctx {  u32 crc ; } cocci_id@p ;
...
position p;
@@
 enum crc_type { crc32 , crc32c , } cocci_id@p ;
...
position p;
@@
 enum crc_op_size { b , h , w , d , } cocci_id@p ;
...
position p;
@@
 struct chksum_desc_ctx * cocci_id@p ;
...
typedef u32;
@@
 struct chksum_ctx {  u32 key ; } cocci_id@p ;
