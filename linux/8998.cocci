...
position p;
@@
 struct fw_vi_stats_ctl cocci_id@p ;
...
position p;
@@
 struct fw_vi_stats_cmd cocci_id@p ;
...
position p;
@@
 const struct fw_cmd_hdr * cocci_id@p ;
...
position p;
@@
 struct fw_vi_stats_vf cocci_id@p ;
...
position p;
@@
 struct fw_params_param * cocci_id@p ;
