...
position p;
@@
 struct change_mapping_params cocci_id@p ;
...
typedef pte_t;
@@
 struct change_mapping_params {  pte_t * pte ;  unsigned long start ;  unsigned long end ;  unsigned long aligned_start ;  unsigned long aligned_end ; } cocci_id@p ;
