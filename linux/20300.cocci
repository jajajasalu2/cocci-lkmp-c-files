...
@@
 struct pcibios_fwaddrmap {  struct list_head list ;  struct pci_dev * dev ;  resource_size_t fw_addr [ DEVICE_COUNT_RESOURCE ] ; } cocci_id@p ;
...
position p;
@@
 struct pci_check_idx_range {  int start ;  int end ; } cocci_id@p ;
...
position p;
@@
 struct pcibios_fwaddrmap * cocci_id@p ;
...
position p;
@@
 struct pci_check_idx_range cocci_id@p [ ] ;
