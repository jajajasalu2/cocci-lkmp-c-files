...
position p;
@@
 struct s3c_irq_intc * cocci_id@p ;
...
position p;
@@
 struct s3c_irq_data cocci_id@p ;
...
position p;
@@
 struct s3c24xx_irq_of_ctrl cocci_id@p [ ] ;
...
position p;
@@
 struct s3c_irq_data cocci_id@p [ 32 ] ;
...
position p;
@@
 struct s3c_irq_intc * cocci_id@p [ 3 ] ;
...
position p;
@@
 struct s3c_irq_intc {  void __iomem * reg_pending ;  void __iomem * reg_intpnd ;  void __iomem * reg_mask ;  struct irq_domain * domain ;  struct s3c_irq_intc * parent ;  struct s3c_irq_data * irqs ; } cocci_id@p ;
...
position p;
@@
 struct s3c_irq_data {  unsigned int type ;  unsigned long offset ;  unsigned long parent_irq ;  struct s3c_irq_intc * intc ;  unsigned long sub_bits ;  struct s3c_irq_intc * sub_intc ; } cocci_id@p ;
...
position p;
@@
 struct s3c24xx_irq_of_ctrl {  char * name ;  unsigned long offset ;  struct s3c_irq_intc * * handle ;  struct s3c_irq_intc * * parent ;  struct irq_domain_ops * ops ; } cocci_id@p ;
