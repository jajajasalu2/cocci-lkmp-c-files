...
position p;
@@
 const struct tmds_config cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_hdmi_audio_config {  unsigned int n ;  unsigned int cts ;  unsigned int aval ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_hdmi_config cocci_id@p ;
...
typedef u32;
@@
 struct tmds_config {  unsigned int pclk ;  u32 pll0 ;  u32 pll1 ;  u32 pe_current ;  u32 drive_current ;  u32 peak_current ; } cocci_id@p ;
...
position p;
@@
 const struct {  unsigned int sample_rate ;  unsigned int offset ; } cocci_id@p [ ] ;
...
position p;
@@
 enum { AUTO = 0 , SPDIF , HDA , } cocci_id@p ;
...
position p;
@@
 struct tegra_hdmi_audio_config cocci_id@p ;
...
typedef bool,u32;
@@
 struct tegra_hdmi_config {  const struct tmds_config * tmds ;  unsigned int num_tmds ;  unsigned long fuse_override_offset ;  u32 fuse_override_value ;  bool has_sor_io_peak_current ;  bool has_hda ;  bool has_hbr ; } cocci_id@p ;
