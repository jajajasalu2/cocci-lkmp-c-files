...
position p;
@@
 struct mtk_hw_stats * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MTK_MAX_DEVS ] ;
...
position p;
@@
 const struct mtk_soc_data cocci_id@p ;
...
typedef u32;
@@
 const struct mtk_ethtool_stats {  char str [ ETH_GSTRING_LEN ] ;  u32 offset ; } cocci_id@p [ ] ;
