...
position p;
@@
 enum thc63_ports { THC63_LVDS_IN0 , THC63_LVDS_IN1 , THC63_RGB_OUT0 , THC63_RGB_OUT1 , } cocci_id@p ;
...
position p;
@@
 struct thc63_dev {  struct device * dev ;  struct regulator * vcc ;  struct gpio_desc * pdwn ;  struct gpio_desc * oe ;  struct drm_bridge bridge ;  struct drm_bridge * next ;  struct drm_bridge_timings timings ; } cocci_id@p ;
