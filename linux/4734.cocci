...
position p;
@@
 const int cocci_id@p [ IB_QPS_ERR + 1 ] ;
...
position p;
@@
 struct rvt_qpn_table * cocci_id@p ;
...
position p;
@@
 const struct rvt_operation_params * cocci_id@p ;
...
position p;
@@
 struct rvt_lkey_table * cocci_id@p ;
...
typedef u64;
@@
 void ( * cocci_id@p ) ( struct rvt_qp * qp , u64 v ) ;
