...
position p;
@@
 struct vimc_cap_device * cocci_id@p ;
...
@@
 struct vimc_cap_device {  struct vimc_ent_device ved ;  struct video_device vdev ;  struct v4l2_pix_format format ;  struct vb2_queue queue ;  struct list_head buf_list ;  spinlock_t qlock ;  struct mutex lock ;  u32 sequence ;  struct vimc_stream stream ;  struct media_pad pad ; } cocci_id@p ;
...
position p;
@@
 struct vimc_cap_buffer {  struct vb2_v4l2_buffer vb2 ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct vimc_cap_buffer cocci_id@p ;
