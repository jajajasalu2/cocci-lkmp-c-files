...
position p;
@@
 int ( * cocci_id@p ) ( struct vring_used_elem * dst , const struct vring_used_elem * src , unsigned num ) ;
...
typedef u64,bool;
@@
 bool ( * cocci_id@p ) ( struct vringh * vrh , u64 addr , struct vringh_range * r ) ;
...
position p;
@@
 const struct vring_used_elem * cocci_id@p ;
...
position p;
@@
 const struct vring_desc * cocci_id@p ;
...
position p;
@@
 const struct vringh * cocci_id@p ;
...
typedef u16;
@@
 int ( * cocci_id@p ) ( const struct vringh * vrh , u16 * val , const __virtio16 * p ) ;
...
position p;
@@
 struct vringh_range cocci_id@p ;
...
typedef u16;
@@
 int ( * cocci_id@p ) ( const struct vringh * vrh , __virtio16 * p , u16 val ) ;
...
typedef u64,bool;
@@
 bool ( * cocci_id@p ) ( struct vringh * , u64 , struct vringh_range * ) ;
