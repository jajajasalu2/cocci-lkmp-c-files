...
position p;
@@
 struct hmcdrv_ftp_cmdspec cocci_id@p ;
...
position p;
@@
 const struct hmcdrv_ftp_ops cocci_id@p ;
...
position p;
@@
 struct hmcdrv_ftp_cmd_desc {  const char * str ;  enum hmcdrv_ftp_cmdid cmd ; } cocci_id@p ;
...
position p;
@@
 const struct hmcdrv_ftp_cmd_desc cocci_id@p [ 7 ] ;
...
position p;
@@
 const struct hmcdrv_ftp_cmdspec * cocci_id@p ;
...
position p;
@@
 const struct hmcdrv_ftp_cmd_desc * cocci_id@p ;
...
position p;
@@
 enum hmcdrv_ftp_cmdid cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( char * cmd , struct hmcdrv_ftp_cmdspec * ftp ) ;
...
position p;
@@
 enum hmcdrv_ftp_cmdid cocci_id@p ( const char * cmd , int len ) ;
