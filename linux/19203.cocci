...
position p;
@@
 void cocci_id@p ( unsigned long baddr , int len ) ;
...
position p;
@@
 struct hole {  unsigned long start ;  unsigned long end ;  unsigned long size ;  struct list_head list ; } cocci_id@p ;
