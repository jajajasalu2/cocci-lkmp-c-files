...
position p;
@@
 struct pcm3168a_priv * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ PCM3168A_NUM_SUPPLIES ] ;
...
position p;
@@
 struct pcm3168a_io_params * cocci_id@p ;
...
position p;
@@
 struct pcm3168a_priv {  struct regulator_bulk_data supplies [ PCM3168A_NUM_SUPPLIES ] ;  struct regmap * regmap ;  struct clk * scki ;  struct gpio_desc * gpio_rst ;  unsigned long sysclk ;  struct pcm3168a_io_params io_params [ 2 ] ;  struct snd_soc_dai_driver dai_drv [ 2 ] ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct pcm3168a_io_params {  bool master_mode ;  unsigned int fmt ;  int tdm_slots ;  u32 tdm_mask ;  int slot_width ; } cocci_id@p ;
