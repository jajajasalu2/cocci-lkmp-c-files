...
position p;
@@
 struct mtk_mdp_addr * cocci_id@p ;
...
position p;
@@
 struct mtk_mdp_pix_align cocci_id@p ;
...
position p;
@@
 struct mtk_mdp_variant cocci_id@p ;
...
position p;
@@
 struct mtk_mdp_pix_limit cocci_id@p ;
...
typedef u16;
@@
 struct mtk_mdp_pix_limit {  u16 org_w ;  u16 org_h ;  u16 target_rot_dis_w ;  u16 target_rot_dis_h ;  u16 target_rot_en_w ;  u16 target_rot_en_h ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_mdp_fmt cocci_id@p [ ] ;
...
position p;
@@
 struct mtk_mdp_frame * cocci_id@p ;
