...
position p;
@@
 int cocci_id@p ( struct edgeport_port * edge_port ) ;
...
position p;
@@
 void cocci_id@p ( struct edgeport_port * edge_port ) ;
...
position p;
@@
 int cocci_id@p ( struct edgeport_serial * serial , const struct firmware * fw ) ;
...
position p;
@@
 void cocci_id@p ( struct usb_serial_port * port , struct tty_struct * tty ) ;
...
position p;
@@
 struct edge_ti_manuf_descriptor * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u16,__u32,__u8,spinlock_t;
@@
 struct edgeport_port {  __u16 uart_base ;  __u16 dma_address ;  __u8 shadow_msr ;  __u8 shadow_mcr ;  __u8 shadow_lsr ;  __u8 lsr_mask ;  __u32 ump_read_timeout ;  int baud_rate ;  int close_pending ;  int lsr_event ;  struct edgeport_serial * edge_serial ;  struct usb_serial_port * port ;  __u8 bUartMode ;  spinlock_t ep_lock ;  int ep_read_urb_state ;  int ep_write_urb_in_use ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct edgeport_serial {  struct product_info product_info ;  u8 TI_I2C_Type ;  u8 TiReadI2C ;  struct mutex es_lock ;  int num_ports_open ;  struct usb_serial * serial ;  struct delayed_work heartbeat_work ;  int fw_version ;  bool use_heartbeat ; } cocci_id@p ;
...
position p;
@@
 struct edgeport_fw_hdr cocci_id@p ;
...
position p;
@@
 struct ti_i2c_image_header * cocci_id@p ;
...
position p;
@@
 struct usb_serial_endpoints * cocci_id@p ;
...
position p;
@@
 struct ti_i2c_firmware_rec cocci_id@p ;
...
position p;
@@
 struct ump_uart_config * cocci_id@p ;
...
position p;
@@
 struct out_endpoint_desc_block * cocci_id@p ;
