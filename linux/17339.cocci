...
position p;
@@
 struct opal_async_token {  enum opal_async_token_state state ;  struct opal_msg response ; } cocci_id@p ;
...
position p;
@@
 struct opal_async_token * cocci_id@p ;
...
position p;
@@
 enum opal_async_token_state cocci_id@p ;
...
position p;
@@
 enum opal_async_token_state { ASYNC_TOKEN_UNALLOCATED = 0 , ASYNC_TOKEN_ALLOCATED , ASYNC_TOKEN_DISPATCHED , ASYNC_TOKEN_ABANDONED , ASYNC_TOKEN_COMPLETED , } cocci_id@p ;
