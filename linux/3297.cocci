...
symbol cocci_id;
position p;
typedef u8,s16,bool,u16;
@@
 struct adc128_data {  struct i2c_client * client ;  struct regulator * regulator ;  int vref ;  struct mutex update_lock ;  u8 mode ;  bool valid ;  unsigned long last_updated ;  u16 in [ 3 ] [ 8 ] ;  s16 temp [ 3 ] ;  u8 alarms ; } cocci_id@p ;
