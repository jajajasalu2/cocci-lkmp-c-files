...
position p;
@@
 struct itcw {  struct tcw * tcw ;  struct tcw * intrg_tcw ;  int num_tidaws ;  int max_tidaws ;  int intrg_num_tidaws ;  int intrg_max_tidaws ; } cocci_id@p ;
...
position p;
@@
 struct dcw_intrg_data cocci_id@p ;
