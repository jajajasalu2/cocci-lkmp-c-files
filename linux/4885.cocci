...
position p;
@@
 int cocci_id@p ( struct mlx5_ib_dev * dev ) ;
...
position p;
@@
 struct ib_dm_mr_attr * cocci_id@p ;
...
position p;
@@
 struct mlx5_mr_cache * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_alloc_mw cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_umr_context cocci_id@p ;
...
typedef __u32;
@@
 struct {  __u32 comp_mask ;  __u32 response_length ; } cocci_id@p ;
...
position p;
@@
 enum { MAX_PENDING_REG_MR = 8 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5_ib_dev * dev , struct mlx5_ib_mr * mr ) ;
