...
typedef u8;
@@
 struct hash_ipportnet6_elem {  union nf_inet_addr ip ;  union nf_inet_addr ip2 ;  __be16 port ;  u8 cidr : 7 ;  u8 nomatch : 1 ;  u8 proto ; } cocci_id@p ;
...
position p;
@@
 const struct hash_ipportnet6 * cocci_id@p ;
...
position p;
@@
 const struct hash_ipportnet4_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_ipportnet6_elem * cocci_id@p ;
...
position p;
@@
 struct hash_ipportnet6_elem cocci_id@p ;
...
position p;
@@
 struct hash_ipportnet4_elem cocci_id@p ;
...
position p;
@@
 const struct hash_ipportnet4 * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct hash_ipportnet4_elem {  __be32 ip ;  __be32 ip2 ;  __be16 port ;  u8 cidr : 7 ;  u8 nomatch : 1 ;  u8 proto ; } cocci_id@p ;
