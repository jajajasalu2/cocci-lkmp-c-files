...
position p;
@@
 struct ceph_readdir_cache_control * cocci_id@p ;
...
position p;
@@
 struct ceph_lease_walk_control * cocci_id@p ;
...
position p;
@@
 enum { KEEP = 0 , DELETE = 1 , TOUCH = 2 , STOP = 4 , } cocci_id@p ;
...
typedef bool;
@@
 struct ceph_lease_walk_control {  bool dir_lease ;  bool expire_dir_lease ;  unsigned long nr_to_scan ;  unsigned long dir_lease_ttl ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ceph_dentry_info * di ) ;
