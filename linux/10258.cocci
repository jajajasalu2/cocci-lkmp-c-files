...
position p;
@@
 struct host1x_waitlist cocci_id@p ;
...
position p;
@@
 struct host1x_syncpt_intr cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ HOST1X_INTR_ACTION_COUNT ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct host1x_waitlist * waiter ) ;
...
position p;
@@
 const action_handler cocci_id@p [ HOST1X_INTR_ACTION_COUNT ] ;
...
position p;
@@
 enum host1x_intr_action cocci_id@p ;
...
position p;
@@
 enum waitlist_state { WLS_PENDING , WLS_REMOVED , WLS_CANCELLED , WLS_HANDLED , } cocci_id@p ;
