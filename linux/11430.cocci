...
position p;
@@
 const struct dcb_output * cocci_id@p ;
...
position p;
@@
 struct moderec {  int hdisplay ;  int vdisplay ; } cocci_id@p ;
...
position p;
@@
 struct nvif_notify_conn_rep_v0 cocci_id@p ;
...
position p;
@@
 const struct nvif_notify_conn_rep_v0 * cocci_id@p ;
...
position p;
@@
 struct nvif_notify_conn_req_v0 cocci_id@p ;
...
position p;
@@
 enum dcb_connector_type cocci_id@p ;
...
position p;
@@
 typeof ( * nv_connector ) cocci_id@p ;
...
position p;
@@
 struct nouveau_display * cocci_id@p ;
