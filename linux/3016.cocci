...
typedef u8;
@@
 struct acpi_thermal_flags {  u8 cooling_mode : 1 ;  u8 devices : 1 ;  u8 reserved : 6 ; } cocci_id@p ;
...
position p;
@@
 struct acpi_handle_list cocci_id@p ;
...
typedef u8;
@@
 struct acpi_thermal {  struct acpi_device * device ;  acpi_bus_id name ;  unsigned long temperature ;  unsigned long last_temperature ;  unsigned long polling_frequency ;  volatile u8 zombie ;  struct acpi_thermal_flags flags ;  struct acpi_thermal_state state ;  struct acpi_thermal_trips trips ;  struct acpi_handle_list devices ;  struct thermal_zone_device * thermal_zone ;  int tz_enabled ;  int kelvin_offset ;  struct work_struct thermal_check_work ; } cocci_id@p ;
...
position p;
@@
 struct acpi_thermal_critical {  struct acpi_thermal_state_flags flags ;  unsigned long temperature ; } cocci_id@p ;
...
position p;
@@
 struct acpi_thermal_hot {  struct acpi_thermal_state_flags flags ;  unsigned long temperature ; } cocci_id@p ;
...
position p;
@@
 enum thermal_device_mode * cocci_id@p ;
...
typedef u8;
@@
 struct acpi_thermal_state {  u8 critical : 1 ;  u8 hot : 1 ;  u8 passive : 1 ;  u8 active : 1 ;  u8 reserved : 4 ;  int active_index ; } cocci_id@p ;
...
position p;
@@
 struct acpi_thermal_trips {  struct acpi_thermal_critical critical ;  struct acpi_thermal_hot hot ;  struct acpi_thermal_passive passive ;  struct acpi_thermal_active active [ ACPI_THERMAL_MAX_ACTIVE ] ; } cocci_id@p ;
...
position p;
@@
 struct acpi_thermal cocci_id@p ;
...
typedef u8;
@@
 struct acpi_thermal_state_flags {  u8 valid : 1 ;  u8 enabled : 1 ;  u8 reserved : 6 ; } cocci_id@p ;
...
position p;
@@
 struct thermal_zone_device_ops cocci_id@p ;
...
position p;
@@
 struct acpi_thermal_passive {  struct acpi_thermal_state_flags flags ;  unsigned long temperature ;  unsigned long tc1 ;  unsigned long tc2 ;  unsigned long tsp ;  struct acpi_handle_list devices ; } cocci_id@p ;
...
position p;
@@
 struct acpi_thermal_active {  struct acpi_thermal_state_flags flags ;  unsigned long temperature ;  struct acpi_handle_list devices ; } cocci_id@p ;
