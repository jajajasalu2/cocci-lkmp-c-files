...
position p;
@@
 const struct rpc_xprt_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rpc_xprt * xprt , struct socket * sock ) ;
...
position p;
@@
 void cocci_id@p ( struct rpc_xprt * xprt ) ;
