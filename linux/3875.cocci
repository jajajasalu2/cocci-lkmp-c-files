...
position p;
@@
 const struct qce_ahash_def cocci_id@p [ ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ SHA256_DIGEST_SIZE / sizeof ( u32 ) ] ;
...
position p;
@@
 struct qce_alg_template * cocci_id@p ;
...
position p;
@@
 struct qce_sha_reqctx * cocci_id@p ;
...
position p;
@@
 struct qce_result_dump * cocci_id@p ;
...
typedef u32;
@@
 struct qce_ahash_def {  unsigned long flags ;  const char * name ;  const char * drv_name ;  unsigned int digestsize ;  unsigned int blocksize ;  unsigned int statesize ;  const u32 * std_iv ; } cocci_id@p ;
...
position p;
@@
 const struct qce_algo_ops cocci_id@p ;
