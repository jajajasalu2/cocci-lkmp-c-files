...
position p;
@@
 struct pms7003_state * cocci_id@p ;
...
position p;
@@
 enum pms7003_cmd { CMD_WAKEUP , CMD_ENTER_PASSIVE_MODE , CMD_READ_PASSIVE , CMD_SLEEP , } cocci_id@p ;
...
position p;
@@
 struct pms7003_state {  struct serdev_device * serdev ;  struct pms7003_frame frame ;  struct completion frame_ready ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 enum { PM1 , PM2P5 , PM10 , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct pms7003_frame {  u8 data [ PMS7003_MAX_DATA_LENGTH ] ;  u16 expected_length ;  u16 length ; } cocci_id@p ;
...
position p;
@@
 struct pms7003_frame * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ ] [ PMS7003_CMD_LENGTH ] ;
