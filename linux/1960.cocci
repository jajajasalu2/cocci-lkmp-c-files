...
position p;
@@
 struct zpa2326_private cocci_id@p ;
...
typedef bool,s64;
@@
 struct zpa2326_private {  s64 timestamp ;  struct regmap * regmap ;  int result ;  struct completion data_ready ;  struct iio_trigger * trigger ;  bool waken ;  int irq ;  const struct zpa2326_frequency * frequency ;  struct regulator * vref ;  struct regulator * vdd ; } cocci_id@p ;
...
typedef u16;
@@
 struct zpa2326_frequency {  int hz ;  u16 odr ; } cocci_id@p ;
...
position p;
@@
 const struct zpa2326_frequency cocci_id@p [ ] ;
...
position p;
@@
 const struct zpa2326_private * cocci_id@p ;
...
typedef u64,u32,u16;
@@
 struct {  u32 pressure ;  u16 temperature ;  u64 timestamp ; } cocci_id@p ;
