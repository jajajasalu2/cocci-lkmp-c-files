...
typedef bool,u32;
@@
 struct bq24735 {  struct power_supply * charger ;  struct power_supply_desc charger_desc ;  struct i2c_client * client ;  struct bq24735_platform * pdata ;  struct mutex lock ;  struct gpio_desc * status_gpio ;  struct delayed_work poll ;  u32 poll_interval ;  bool charging ; } cocci_id@p ;
...
position p;
@@
 struct bq24735_platform * cocci_id@p ;
