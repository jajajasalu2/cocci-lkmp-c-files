...
position p;
@@
 union {  Elf_Mips_Rel * rel ;  Elf_Mips_Rela * rela ; } cocci_id@p ;
...
position p;
@@
 struct mips_hi16 {  struct mips_hi16 * next ;  Elf_Addr * addr ;  Elf_Addr value ; } cocci_id@p ;
...
typedef bool,u32;
@@
 int ( * cocci_id@p ) ( struct module * me , u32 * location , u32 base , Elf_Addr v , bool rela ) ;
...
position p;
@@
 struct mod_arch_specific * cocci_id@p ;
