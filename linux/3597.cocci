...
typedef u32;
@@
 struct nvram_header {  u32 magic ;  u32 len ;  u32 crc_ver_init ;  u32 config_refresh ;  u32 config_ncdl ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NVRAM_MAX_GPIO_VALUE_LEN ] ;
