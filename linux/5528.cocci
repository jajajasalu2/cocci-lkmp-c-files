...
position p;
@@
 struct ds1374 {  struct i2c_client * client ;  struct rtc_device * rtc ;  struct work_struct work ;  struct mutex mutex ;  int exiting ; } cocci_id@p ;
