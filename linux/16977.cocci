...
position p;
@@
 struct w8001_touch_query cocci_id@p ;
...
typedef u8,u16;
@@
 struct w8001_coord {  u8 rdy ;  u8 tsw ;  u8 f1 ;  u8 f2 ;  u16 x ;  u16 y ;  u16 pen_pressure ;  u8 tilt_x ;  u8 tilt_y ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct w8001_touch_query {  u16 x ;  u16 y ;  u8 panel_res ;  u8 capacity_res ;  u8 sensor_id ; } cocci_id@p ;
