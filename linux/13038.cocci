...
position p;
@@
 int ( * cocci_id@p ) ( void __iomem * aon_ctrl_base , void __iomem * ddr_phy_pll_status ) ;
...
position p;
@@
 struct ddr_phy_ofdata cocci_id@p ;
...
position p;
@@
 enum bsp_initiate_command { BSP_CLOCK_STOP = 0x00 , BSP_GEN_RANDOM_KEY = 0x4A , BSP_RESTORE_RANDOM_KEY = 0x55 , BSP_GEN_FIXED_KEY = 0x63 , } cocci_id@p ;
...
position p;
@@
 const struct ddr_seq_ofdata cocci_id@p ;
...
typedef bool,u32;
@@
 struct ddr_seq_ofdata {  bool needs_ddr_pad ;  u32 warm_boot_offset ; } cocci_id@p ;
...
position p;
@@
 const struct ddr_phy_ofdata * cocci_id@p ;
...
position p;
@@
 enum bsp_initiate_command cocci_id@p ;
...
typedef bool,u32;
@@
 struct ddr_phy_ofdata {  bool supports_warm_boot ;  size_t pll_status_offset ;  int s3entry_method ;  u32 warm_boot_offset ;  u32 phy_a_standby_ctrl_offs ;  u32 phy_b_standby_ctrl_offs ; } cocci_id@p ;
...
position p;
@@
 struct brcmstb_memc {  void __iomem * ddr_phy_base ;  void __iomem * ddr_shimphy_base ;  void __iomem * ddr_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct brcmstb_pm_control cocci_id@p ;
...
position p;
@@
 struct brcmstb_s3_params * cocci_id@p ;
