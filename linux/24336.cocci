...
position p;
@@
 void cocci_id@p ( struct smc_link_group * lgr ) ;
...
position p;
@@
 struct smc_clc_msg_local * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct smc_link_group * lgr , bool is_rmb , struct smc_buf_desc * buf_desc ) ;
...
position p;
@@
 struct smc_lgr_list cocci_id@p ;
