...
typedef bool,u32;
@@
 struct budget_ci_ir {  struct rc_dev * dev ;  struct tasklet_struct msp430_irq_tasklet ;  char name [ 72 ] ;  char phys [ 32 ] ;  int rc5_device ;  u32 ir_key ;  bool have_command ;  bool full_rc5 ; } cocci_id@p ;
...
typedef u8;
@@
 struct budget_ci {  struct budget budget ;  struct tasklet_struct ciintf_irq_tasklet ;  int slot_status ;  int ci_irq ;  struct dvb_ca_en50221 ca ;  struct budget_ci_ir ir ;  u8 tuner_pll_address ; } cocci_id@p ;
...
position p;
@@
 struct stv0297_config cocci_id@p ;
