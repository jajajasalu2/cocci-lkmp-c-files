...
position p;
@@
 struct gpio_config_data cocci_id@p ;
...
position p;
@@
 enum gpio_ddc_config_type cocci_id@p ;
...
position p;
@@
 const struct gpio_service * cocci_id@p ;
