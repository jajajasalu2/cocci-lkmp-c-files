...
position p;
@@
 struct counter_action_unit {  struct counter_synapse * synapse ;  struct counter_count * count ; } cocci_id@p ;
...
position p;
@@
 struct counter_signal * cocci_id@p ;
...
position p;
@@
 const struct counter_func_avail_unit * const cocci_id@p ;
...
position p;
@@
 const struct counter_count_ext * cocci_id@p ;
...
position p;
@@
 struct counter_device_state * const cocci_id@p ;
...
position p;
@@
 struct counter_size_unit * cocci_id@p ;
...
position p;
@@
 const struct counter_ext_unit * const cocci_id@p ;
...
position p;
@@
 struct counter_name_unit * cocci_id@p ;
...
position p;
@@
 struct counter_device_attr_group * cocci_id@p ;
...
position p;
@@
 struct counter_ext_unit * cocci_id@p ;
...
position p;
@@
 struct counter_size_unit {  size_t size ; } cocci_id@p ;
...
position p;
@@
 struct counter_device_attr * cocci_id@p ;
...
position p;
@@
 struct counter_signal_unit * cocci_id@p ;
...
position p;
@@
 struct counter_action_unit * cocci_id@p ;
...
position p;
@@
 const struct counter_signal_ext * cocci_id@p ;
...
position p;
@@
 struct counter_attr_parm cocci_id@p ;
...
position p;
@@
 struct counter_count_ext_unit * cocci_id@p ;
...
position p;
@@
 const struct counter_count_enum_ext * const cocci_id@p ;
...
position p;
@@
 struct counter_signal_ext_unit {  struct counter_signal * signal ;  const struct counter_signal_ext * ext ; } cocci_id@p ;
...
position p;
@@
 enum counter_count_function cocci_id@p ;
...
position p;
@@
 enum counter_synapse_action cocci_id@p ;
...
position p;
@@
 const struct counter_device_ext * const cocci_id@p ;
...
position p;
@@
 struct counter_device * cocci_id@p ;
...
position p;
@@
 struct counter_count_ext_unit {  struct counter_count * count ;  const struct counter_count_ext * ext ; } cocci_id@p ;
...
position p;
@@
 const struct counter_action_unit * const cocci_id@p ;
...
position p;
@@
 const struct counter_signal_unit * const cocci_id@p ;
...
position p;
@@
 struct counter_name_unit {  const char * name ; } cocci_id@p ;
...
position p;
@@
 const struct counter_device_enum_ext * const cocci_id@p ;
...
position p;
@@
 const struct counter_attr_parm * const cocci_id@p ;
...
position p;
@@
 struct counter_action_avail_unit * cocci_id@p ;
...
position p;
@@
 enum counter_signal_value cocci_id@p ;
...
position p;
@@
 struct counter_func_avail_unit {  const enum counter_count_function * functions_list ;  size_t num_functions ; } cocci_id@p ;
...
position p;
@@
 const struct counter_signal_ext_unit * const cocci_id@p ;
...
position p;
@@
 struct counter_signal * const cocci_id@p ;
...
position p;
@@
 struct counter_ext_unit {  const struct counter_device_ext * ext ; } cocci_id@p ;
...
position p;
@@
 const struct counter_count_ext * const cocci_id@p ;
...
position p;
@@
 struct counter_signal_unit {  struct counter_signal * signal ; } cocci_id@p ;
...
position p;
@@
 const struct counter_action_avail_unit * const cocci_id@p ;
...
position p;
@@
 struct counter_count_unit {  struct counter_count * count ; } cocci_id@p ;
...
position p;
@@
 const struct counter_count_unit * const cocci_id@p ;
...
position p;
@@
 struct counter_count * cocci_id@p ;
...
position p;
@@
 const struct counter_name_unit * const cocci_id@p ;
...
position p;
@@
 struct counter_device_attr_group * const cocci_id@p ;
...
position p;
@@
 struct counter_synapse * cocci_id@p ;
...
position p;
@@
 struct counter_device * const cocci_id@p ;
...
position p;
@@
 const enum counter_count_function * const cocci_id@p ;
...
position p;
@@
 const struct counter_device_attr * const cocci_id@p ;
...
position p;
@@
 struct counter_signal_ext_unit * cocci_id@p ;
...
position p;
@@
 struct counter_count * const cocci_id@p ;
...
position p;
@@
 struct counter_func_avail_unit * cocci_id@p ;
...
position p;
@@
 struct counter_device_attr {  struct device_attribute dev_attr ;  struct list_head l ;  void * component ; } cocci_id@p ;
...
position p;
@@
 const struct counter_count_ext_unit * const cocci_id@p ;
...
position p;
@@
 const struct counter_size_unit * const cocci_id@p ;
...
position p;
@@
 const struct counter_signal_ext * const cocci_id@p ;
...
position p;
@@
 struct counter_synapse * const cocci_id@p ;
...
position p;
@@
 const struct counter_signal_enum_ext * const cocci_id@p ;
...
position p;
@@
 struct counter_device_state * cocci_id@p ;
...
position p;
@@
 const struct counter_device * const cocci_id@p ;
...
position p;
@@
 struct counter_count_unit * cocci_id@p ;
...
position p;
@@
 struct counter_action_avail_unit {  const enum counter_synapse_action * actions_list ;  size_t num_actions ; } cocci_id@p ;
...
position p;
@@
 struct list_head * const cocci_id@p ;
