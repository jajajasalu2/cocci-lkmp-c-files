...
position p;
@@
 int ( * cocci_id@p [ 255 ] ) ( struct dvb_net_priv * p ) ;
...
position p;
@@
 struct dvb_net_priv cocci_id@p ;
...
position p;
@@
 struct dvb_net_ule_handle cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ 100 * TS_SZ ] ;
