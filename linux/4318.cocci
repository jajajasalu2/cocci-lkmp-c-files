...
typedef bool;
@@
 const struct {  const char * guid ;  bool quirk_last_pressed ; } * cocci_id@p ;
...
position p;
@@
 enum msi_scancodes { MSI_KEY_BRIGHTNESSUP = 0xD0 , MSI_KEY_BRIGHTNESSDOWN , MSI_KEY_VOLUMEUP , MSI_KEY_VOLUMEDOWN , MSI_KEY_MUTE , WIND_KEY_TOUCHPAD = 0x08 , WIND_KEY_BLUETOOTH = 0x56 , WIND_KEY_CAMERA , WIND_KEY_WLAN = 0x5f , WIND_KEY_TURBO , WIND_KEY_ECO = 0x69 , } cocci_id@p ;
