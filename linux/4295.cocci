...
typedef u16;
@@
 struct isst_cmd_set_req_type {  u16 cmd ;  u16 sub_cmd ;  u16 param ; } cocci_id@p ;
...
position p;
@@
 struct isst_if_msr_cmd cocci_id@p ;
...
typedef u16;
@@
 struct isst_valid_cmd_ranges {  u16 cmd ;  u16 sub_cmd_beg ;  u16 sub_cmd_end ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct isst_cmd {  struct hlist_node hnode ;  u64 data ;  u32 cmd ;  int cpu ;  int mbox_cmd_type ;  u32 param ; } cocci_id@p ;
...
position p;
@@
 struct isst_if_cmd_cb * cocci_id@p ;
...
position p;
@@
 struct isst_if_mbox_cmd cocci_id@p ;
...
position p;
@@
 struct isst_if_cmd_cb cocci_id@p [ ISST_IF_DEV_MAX ] ;
...
position p;
@@
 struct isst_if_cpu_map cocci_id@p ;
...
position p;
@@
 struct isst_if_cpu_info * cocci_id@p ;
...
position p;
@@
 const struct isst_cmd_set_req_type cocci_id@p [ ] ;
...
position p;
@@
 struct isst_if_cpu_info {  int bus_info [ 2 ] ;  int punit_cpu_id ; } cocci_id@p ;
...
position p;
@@
 const struct isst_valid_cmd_ranges cocci_id@p [ ] ;
