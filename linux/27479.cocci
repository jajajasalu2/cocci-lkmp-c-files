...
@@
 struct hugetlbfs_fs_context {  struct hstate * hstate ;  unsigned long long max_size_opt ;  unsigned long long min_size_opt ;  long max_hpages ;  long nr_inodes ;  long min_hpages ;  enum hugetlbfs_size_type max_val_type ;  enum hugetlbfs_size_type min_val_type ;  kuid_t uid ;  kgid_t gid ;  umode_t mode ; } cocci_id@p ;
...
position p;
@@
 struct hugetlbfs_inode_info cocci_id@p ;
...
position p;
@@
 struct hugetlbfs_sb_info * cocci_id@p ;
...
position p;
@@
 struct hugetlbfs_fs_context * cocci_id@p ;
...
position p;
@@
 enum hugetlbfs_size_type { NO_SIZE , SIZE_STD , SIZE_PERCENT , } cocci_id@p ;
...
position p;
@@
 enum hugetlb_param { Opt_gid , Opt_min_size , Opt_mode , Opt_nr_inodes , Opt_pagesize , Opt_size , Opt_uid , } cocci_id@p ;
...
position p;
@@
 enum hugetlbfs_size_type cocci_id@p ;
...
position p;
@@
 struct vfsmount * cocci_id@p [ HUGE_MAX_HSTATE ] ;
