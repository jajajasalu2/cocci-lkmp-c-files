...
position p;
@@
 const unittest_fptr cocci_id@p [ ] ;
...
position p;
@@
 struct ni_device_routes cocci_id@p ;
...
position p;
@@
 struct ni_board_struct cocci_id@p ;
...
position p;
@@
 const struct ni_device_routes * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ NI_NUM_NAMES ] [ NI_NUM_NAMES ] ;
...
position p;
@@
 struct ni_route_set cocci_id@p [ ] ;
