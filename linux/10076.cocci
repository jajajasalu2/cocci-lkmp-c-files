...
position p;
@@
 struct yamdrv_ioctl_mcs cocci_id@p ;
...
position p;
@@
 const struct yam_port * cocci_id@p ;
...
position p;
@@
 struct yamdrv_ioctl_cfg cocci_id@p ;
...
position p;
@@
 struct yam_mcs {  unsigned char bits [ YAM_FPGA_SIZE ] ;  int bitrate ;  struct yam_mcs * next ; } cocci_id@p ;
...
position p;
@@
 enum uart { c_uart_unknown , c_uart_8250 , c_uart_16450 , c_uart_16550 , c_uart_16550A , } cocci_id@p ;
...
position p;
@@
 struct net_device * cocci_id@p [ NR_PORTS ] ;
