...
typedef bool;
@@
 int cocci_id@p ( struct gve_priv * priv , bool was_up ) ;
...
position p;
@@
 struct gve_queue_config cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gve_priv * priv ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct gve_priv * priv , bool was_up ) ;
