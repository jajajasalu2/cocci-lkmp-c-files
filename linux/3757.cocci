...
position p;
@@
 struct ccp_crypto_akcipher_alg * cocci_id@p ;
...
position p;
@@
 struct ccp_crypto_queue cocci_id@p ;
...
position p;
@@
 struct ccp_crypto_cmd * * cocci_id@p ;
...
position p;
@@
 struct ccp_crypto_queue {  struct list_head cmds ;  struct list_head * backlog ;  unsigned int cmd_count ; } cocci_id@p ;
...
position p;
@@
 struct ccp_crypto_aead * cocci_id@p ;
...
position p;
@@
 struct ccp_crypto_ahash_alg * cocci_id@p ;
...
position p;
@@
 struct ccp_crypto_cpu {  struct work_struct work ;  struct completion completion ;  struct ccp_crypto_cmd * crypto_cmd ;  int err ; } cocci_id@p ;
...
position p;
@@
 struct ccp_crypto_cmd {  struct list_head entry ;  struct ccp_cmd * cmd ;  struct crypto_async_request * req ;  struct crypto_tfm * tfm ;  int ret ; } cocci_id@p ;
...
position p;
@@
 struct ccp_crypto_skcipher_alg * cocci_id@p ;
