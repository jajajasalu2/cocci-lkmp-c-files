...
position p;
@@
 struct scsi_eh_save * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct scsi_host_template * , struct scsi_cmnd * ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * scmd ) ;
...
position p;
@@
 int cocci_id@p ( struct scsi_cmnd * scmd ) ;
