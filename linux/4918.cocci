...
position p;
@@
 struct mthca_cq_context * cocci_id@p ;
...
position p;
@@
 struct mthca_cq_buf * cocci_id@p ;
...
position p;
@@
 enum { MTHCA_CQ_ENTRY_SIZE = 0x20 , } cocci_id@p ;
...
@@
 struct mthca_err_cqe {  __be32 my_qpn ;  u32 reserved1 [ 3 ] ;  u8 syndrome ;  u8 vendor_err ;  __be16 db_cnt ;  u32 reserved2 ;  __be32 wqe ;  u8 opcode ;  u8 reserved3 [ 2 ] ;  u8 owner ; } cocci_id@p ;
...
position p;
@@
 struct mthca_err_cqe * cocci_id@p ;
...
position p;
@@
 enum { MTHCA_MAX_DIRECT_CQ_SIZE = 4 * PAGE_SIZE , } cocci_id@p ;
...
position p;
@@
 enum { MTHCA_ATOMIC_BYTE_LEN = 8 , } cocci_id@p ;
...
typedef u8,__be32;
@@
 struct mthca_cqe {  __be32 my_qpn ;  __be32 my_ee ;  __be32 rqpn ;  u8 sl_ipok ;  u8 g_mlpath ;  __be16 rlid ;  __be32 imm_etype_pkey_eec ;  __be32 byte_cnt ;  __be32 wqe ;  u8 opcode ;  u8 is_send ;  u8 reserved ;  u8 owner ; } cocci_id@p ;
...
position p;
@@
 enum { MTHCA_ERROR_CQE_OPCODE_MASK = 0xfe , } cocci_id@p ;
