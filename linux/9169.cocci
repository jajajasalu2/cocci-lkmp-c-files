...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MTMP_LEN ] ;
...
position p;
@@
 struct mlxsw_thermal_trip * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_thermal_trip cocci_id@p [ ] ;
...
position p;
@@
 struct mlxsw_thermal_module {  struct mlxsw_thermal * parent ;  struct thermal_zone_device * tzdev ;  struct mlxsw_thermal_trip trips [ MLXSW_THERMAL_NUM_TRIPS ] ;  enum thermal_device_mode mode ;  int module ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_thermal_module * cocci_id@p ;
...
position p;
@@
 struct mlxsw_thermal_trip {  int type ;  int temp ;  int hyst ;  int min_state ;  int max_state ; } cocci_id@p ;
...
position p;
@@
 enum mlxsw_thermal_trips { MLXSW_THERMAL_TEMP_TRIP_NORM , MLXSW_THERMAL_TEMP_TRIP_HIGH , MLXSW_THERMAL_TEMP_TRIP_HOT , MLXSW_THERMAL_TEMP_TRIP_CRIT , } cocci_id@p ;
...
position p;
@@
 struct mlxsw_thermal * cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_mfcr_pwm_frequency cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MFCR_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MGPIR_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MFSC_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_THERMAL_ZONE_MAX_NAME ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MFSL_LEN ] ;
