...
typedef grant_ref_t;
@@
 struct xen_page_directory {  grant_ref_t gref_dir_next_page ;  grant_ref_t gref [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct xen_front_pgdir_shbuf * cocci_id@p ;
...
position p;
@@
 struct xen_page_directory cocci_id@p ;
...
position p;
@@
 const struct xen_front_pgdir_shbuf_ops cocci_id@p ;
