...
position p;
@@
 struct omap_prm {  const struct omap_prm_data * data ;  void __iomem * base ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct omap_prm_data {  u32 base ;  const char * name ;  const char * clkdm_name ;  u16 rstctrl ;  u16 rstst ;  const struct omap_rst_map * rstmap ;  u8 flags ; } cocci_id@p ;
...
typedef s8;
@@
 struct omap_rst_map {  s8 rst ;  s8 st ; } cocci_id@p ;
...
position p;
@@
 const struct omap_rst_map cocci_id@p [ ] ;
...
position p;
@@
 struct ti_prm_platform_data * cocci_id@p ;
...
position p;
@@
 const struct omap_prm_data * cocci_id@p ;
...
position p;
@@
 struct omap_reset_data * cocci_id@p ;
...
@@
 struct omap_reset_data {  struct reset_controller_dev rcdev ;  struct omap_prm * prm ;  u32 mask ;  spinlock_t lock ;  struct clockdomain * clkdm ;  struct device * dev ; } cocci_id@p ;
