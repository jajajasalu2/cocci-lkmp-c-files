...
position p;
@@
 enum scan_mode { MODE_SINGLE_CHAN , MODE_SINGLE_CHAN_INTERVAL , MODE_MULT_CHAN_UP , MODE_MULT_CHAN_DOWN , } cocci_id@p ;
...
position p;
@@
 const struct labpc_boardinfo * cocci_id@p ;
...
position p;
@@
 struct labpc_private * cocci_id@p ;
