...
position p;
@@
 void ( * cocci_id@p ) ( struct sk_buff * , const struct sk_buff * ) ;
...
position p;
@@
 struct nf_hook_entry cocci_id@p ;
...
position p;
@@
 struct nf_hook_entries_rcu_head * cocci_id@p ;
...
position p;
@@
 struct static_key cocci_id@p [ NFPROTO_NUMPROTO ] [ NF_MAX_HOOKS ] ;
