...
position p;
@@
 struct be_cmd_get_if_info_resp * * cocci_id@p ;
...
position p;
@@
 struct be_cmd_reopen_session_resp cocci_id@p ;
...
position p;
@@
 struct amap_beiscsi_offload_params cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_def_gateway_req * cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_boot_target_resp cocci_id@p ;
...
position p;
@@
 struct invldt_cmds_params_in * cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_boot_target_req * cocci_id@p ;
...
position p;
@@
 struct be_bsg_vendor_cmd * cocci_id@p ;
...
position p;
@@
 struct be_cmd_req_logout_fw_sess cocci_id@p ;
...
position p;
@@
 struct be_cmd_hba_name cocci_id@p ;
...
position p;
@@
 struct amap_iscsi_target_context_update_wrb_v2 cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_session_resp cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_if_info_req * cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_all_if_id_req * cocci_id@p ;
...
position p;
@@
 struct be_cmd_rel_dhcp_req * cocci_id@p ;
...
position p;
@@
 struct be_cmd_set_def_gateway_req * cocci_id@p ;
...
position p;
@@
 struct amap_iscsi_target_context_update_wrb cocci_id@p ;
...
position p;
@@
 struct be_tcp_upload_params_in * cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_def_gateway_resp cocci_id@p ;
...
position p;
@@
 struct be_cmd_reopen_session_req * cocci_id@p ;
...
position p;
@@
 union be_invalidate_connection_params cocci_id@p ;
...
position p;
@@
 struct be_cmd_resp_logout_fw_sess * cocci_id@p ;
...
position p;
@@
 struct be_cmd_set_dhcp_req * cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_nic_conf_resp * cocci_id@p ;
...
position p;
@@
 union be_invldt_cmds_params cocci_id@p ;
...
position p;
@@
 struct be_cmd_get_session_req * cocci_id@p ;
...
position p;
@@
 struct be_ip_addr_subnet_format cocci_id@p ;
...
position p;
@@
 struct be_cmd_set_ip_addr_req * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct beiscsi_hba * , unsigned int ) ;
...
position p;
@@
 struct tcp_connect_and_offload_in_v1 * cocci_id@p ;
...
position p;
@@
 struct be_invalidate_connection_params_in * cocci_id@p ;
...
position p;
@@
 union be_tcp_upload_params cocci_id@p ;
