...
position p;
@@
 struct oaktrail_hdmi_clock {  int np ;  int nr ;  int nf ;  int dot ; } cocci_id@p ;
...
position p;
@@
 struct oaktrail_hdmi_clock * cocci_id@p ;
...
position p;
@@
 struct oaktrail_hdmi_dev * cocci_id@p ;
...
position p;
@@
 const struct oaktrail_hdmi_limit cocci_id@p ;
