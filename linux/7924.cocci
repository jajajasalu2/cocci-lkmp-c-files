...
position p;
@@
 enum led_values { LEDFast = 0x01 , LEDSlow = 0x02 , LEDFlash = 0x03 , LEDPulse = 0x04 , LEDLink = 0x08 , } cocci_id@p ;
...
position p;
@@
 enum control_requests { ReadMem = 0xf1 , GetMac = 0xf2 , Reset = 0xf4 , SetMac = 0xf5 , SetRxMode = 0xf5 , WriteROM = 0xf8 , SetReg = 0xfa , GetReg = 0xfb , WriteMem = 0xfc , ReadROM = 0xfd , } cocci_id@p ;
...
position p;
@@
 enum rx_filter_bits { RxEnable = 0x01 , RxPolarity = 0x02 , RxForceOK = 0x04 , RxMultiCast = 0x08 , RxPromisc = 0x10 , AltRxPromisc = 0x20 , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct catc * catc , struct ctrl_queue * q ) ;
...
position p;
@@
 enum op_mode_bits { Op3MemWaits = 0x03 , OpLenInclude = 0x08 , OpRxMerge = 0x10 , OpTxMerge = 0x20 , OpWin95bugfix = 0x40 , OpLoopback = 0x80 , } cocci_id@p ;
...
position p;
@@
 enum link_status { LinkNoChange = 0 , LinkGood = 1 , LinkBad = 2 , } cocci_id@p ;
...
position p;
@@
 enum eth_stats { TxSingleColl = 0x00 , TxMultiColl = 0x02 , TxExcessColl = 0x04 , RxFramErr = 0x06 , } cocci_id@p ;
...
position p;
@@
 enum register_offsets { TxBufCount = 0x20 , RxBufCount = 0x21 , OpModes = 0x22 , TxQed = 0x23 , RxQed = 0x24 , MaxBurst = 0x25 , RxUnit = 0x60 , EthStatus = 0x61 , StationAddr0 = 0x67 , EthStats = 0x69 , LEDCtrl = 0x81 , } cocci_id@p ;
