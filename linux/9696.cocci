...
position p;
@@
 struct iwl_fw_dbg_trigger_txq_timer cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_trigger_time_event cocci_id@p ;
...
position p;
@@
 struct iwl_fw_cscheme_list * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_trigger_low_rssi cocci_id@p ;
...
position p;
@@
 const struct iwl_ucode_capa * cocci_id@p ;
...
position p;
@@
 struct fw_sec_parsing * cocci_id@p ;
...
position p;
@@
 struct iwl_ucode_api cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_dest_tlv_v1 cocci_id@p ;
...
position p;
@@
 const struct iwl_op_mode_ops * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_trigger_missed_bcon cocci_id@p ;
...
position p;
@@
 struct iwl_umac_debug_addrs * cocci_id@p ;
...
position p;
@@
 struct iwl_lmac_debug_addrs * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_cipher_scheme * cocci_id@p ;
...
position p;
@@
 struct iwl_ucode_header * cocci_id@p ;
...
position p;
@@
 struct iwl_tlv_calib_data * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_dest_tlv cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_mem_seg_tlv * cocci_id@p ;
...
position p;
@@
 size_t cocci_id@p [ FW_DBG_TRIGGER_MAX ] ;
...
position p;
@@
 struct iwl_ucode_capa cocci_id@p ;
...
position p;
@@
 struct iwl_ucode_tlv * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_conf_tlv * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_cmd_version cocci_id@p ;
...
position p;
@@
 struct iwl_firmware_pieces * cocci_id@p ;
...
position p;
@@
 struct iwl_tlv_ucode_header * cocci_id@p ;
...
position p;
@@
 const struct iwl_ucode_api * cocci_id@p ;
...
position p;
@@
 struct fw_img_parsing {  struct fw_sec * sec ;  int sec_counter ; } cocci_id@p ;
...
position p;
@@
 enum iwl_ucode_type cocci_id@p ;
...
position p;
@@
 struct iwl_ucode_capabilities * cocci_id@p ;
...
position p;
@@
 struct fw_img_parsing * cocci_id@p ;
...
position p;
@@
 struct iwl_mod_params cocci_id@p ;
...
typedef __le32;
@@
 struct {  __le32 buf_addr ;  __le32 buf_size ; } * cocci_id@p ;
...
position p;
@@
 enum { DVM_OP_MODE , MVM_OP_MODE , } cocci_id@p ;
...
typedef u32;
@@
 struct fw_sec {  const void * data ;  size_t size ;  u32 offset ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 version [ 32 ] ;  u8 sha1 [ 20 ] ; } * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_trigger_cmd cocci_id@p ;
...
position p;
@@
 struct iwlwifi_opmode_table {  const char * name ;  const struct iwl_op_mode_ops * ops ;  struct list_head drv ; } cocci_id@p [ ] ;
...
position p;
@@
 struct iwlwifi_opmode_table * cocci_id@p ;
...
position p;
@@
 enum iwl_ucode_tlv_type cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_trigger_stats cocci_id@p ;
