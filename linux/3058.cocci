...
position p;
@@
 struct vmmdev_hgcm_connect * cocci_id@p ;
...
position p;
@@
 struct vmmdev_hgcm_call * cocci_id@p ;
...
position p;
@@
 struct vmmdev_hgcm_pagelist cocci_id@p ;
...
position p;
@@
 const struct vmmdev_hgcm_call * cocci_id@p ;
...
position p;
@@
 struct vmmdev_request_header * cocci_id@p ;
...
position p;
@@
 struct vmmdev_hgcm_disconnect * cocci_id@p ;
...
position p;
@@
 struct vmmdev_hgcm_service_location * cocci_id@p ;
...
position p;
@@
 const struct vmmdev_hgcm_function_parameter * cocci_id@p ;
...
position p;
@@
 enum vmmdev_request_type cocci_id@p ;
...
position p;
@@
 struct vmmdev_hgcmreq_header * cocci_id@p ;
