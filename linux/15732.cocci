...
position p;
@@
 struct hif_rx_stats * cocci_id@p ;
...
position p;
@@
 struct hif_mib_extended_count_table cocci_id@p ;
...
typedef u8;
@@
 struct dbgfs_hif_msg {  struct wfx_dev * wdev ;  struct completion complete ;  u8 reply [ 1024 ] ;  int ret ; } cocci_id@p ;
...
position p;
@@
 struct dbgfs_hif_msg * cocci_id@p ;
