...
position p;
@@
 struct bcm2835aux_spi * cocci_id@p ;
...
typedef u64,u8,u32;
@@
 struct bcm2835aux_spi {  void __iomem * regs ;  struct clk * clk ;  int irq ;  u32 cntl [ 2 ] ;  const u8 * tx_buf ;  u8 * rx_buf ;  int tx_len ;  int rx_len ;  int pending ;  u64 count_transfer_polling ;  u64 count_transfer_irq ;  u64 count_transfer_irq_after_poll ;  struct dentry * debugfs_dir ; } cocci_id@p ;
