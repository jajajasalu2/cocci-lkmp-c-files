...
typedef uint32_t;
@@
 struct dump_obj {  struct kobject kobj ;  struct bin_attribute dump_attr ;  uint32_t id ;  uint32_t type ;  uint32_t size ;  char * buffer ; } cocci_id@p ;
...
position p;
@@
 struct dump_attribute * cocci_id@p ;
