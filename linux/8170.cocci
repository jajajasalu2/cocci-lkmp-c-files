...
position p;
@@
 struct mal_commac_ops cocci_id@p ;
...
position p;
@@
 struct mal_descriptor cocci_id@p ;
...
position p;
@@
 struct emac_instance cocci_id@p ;
...
typedef u32;
@@
 struct emac_depentry {  u32 phandle ;  struct device_node * node ;  struct platform_device * ofdev ;  void * drvdata ; } cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ EMAC_ETHTOOL_STATS_COUNT ] [ ETH_GSTRING_LEN ] ;
...
position p;
@@
 int cocci_id@p [ EMAC_BOOT_LIST_SIZE ] ;
...
position p;
@@
 const struct mii_phy_ops cocci_id@p ;
...
position p;
@@
 struct device_node * cocci_id@p [ EMAC_BOOT_LIST_SIZE ] ;
...
position p;
@@
 struct emac_depentry * cocci_id@p ;
...
position p;
@@
 struct emac_ethtool_regs_hdr * cocci_id@p ;
...
position p;
@@
 struct emac_ethtool_regs_subhdr cocci_id@p ;
...
position p;
@@
 struct emac_depentry cocci_id@p [ EMAC_DEP_COUNT ] ;
...
position p;
@@
 struct emac_error_stats * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ EMAC_XAHT_MAX_REGS ] ;
...
position p;
@@
 void cocci_id@p ( struct emac_instance * dev ) ;
