...
typedef u8,u16;
@@
 struct usb_action {  u8 req ;  u8 val ;  u16 idx ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 * cocci_id@p [ SENSOR_MAX ] ;
...
position p;
@@
 const struct sensor_by_chipset_revision cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct sd {  struct gspca_dev gspca_dev ;  struct {  struct v4l2_ctrl * gamma ;  struct v4l2_ctrl * brightness ;  struct v4l2_ctrl * contrast ; } ;  struct {  struct v4l2_ctrl * autogain ;  struct v4l2_ctrl * exposure ; } ;  struct v4l2_ctrl * plfreq ;  struct v4l2_ctrl * sharpness ;  struct v4l2_ctrl * jpegqual ;  struct work_struct work ;  u8 reg08 ;  u8 bridge ;  u8 sensor ;  u16 chip_revision ;  u8 jpeg_hdr [ JPEG_HDR_SZ ] ; } cocci_id@p ;
...
position p;
@@
 enum sensors { SENSOR_ADCM2700 , SENSOR_CS2102 , SENSOR_CS2102K , SENSOR_GC0303 , SENSOR_GC0305 , SENSOR_HDCS2020 , SENSOR_HV7131B , SENSOR_HV7131R , SENSOR_ICM105A , SENSOR_MC501CB , SENSOR_MT9V111_1 , SENSOR_MT9V111_3 , SENSOR_OV7620 , SENSOR_OV7630C , SENSOR_PAS106 , SENSOR_PAS202B , SENSOR_PB0330 , SENSOR_PO2030 , SENSOR_TAS5130C , SENSOR_MAX , } cocci_id@p ;
...
position p;
@@
 enum bridges { BRIDGE_ZC301 , BRIDGE_ZC303 , } cocci_id@p ;
...
position p;
@@
 const struct usb_action * cocci_id@p [ SENSOR_MAX ] [ 6 ] ;
...
position p;
@@
 const struct usb_action * cocci_id@p [ SENSOR_MAX ] [ 2 ] ;
...
typedef u8,u16;
@@
 struct sensor_by_chipset_revision {  u16 revision ;  u8 internal_sensor_id ; } cocci_id@p ;
...
position p;
@@
 const struct usb_action * cocci_id@p ;
