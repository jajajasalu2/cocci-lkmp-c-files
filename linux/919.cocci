...
symbol cocci_id;
position p;
typedef bool,uint32_t,dma_addr_t;
@@
 struct cafe_priv {  struct nand_chip nand ;  struct pci_dev * pdev ;  void __iomem * mmio ;  struct rs_control * rs ;  uint32_t ctl1 ;  uint32_t ctl2 ;  int datalen ;  int nr_data ;  int data_pos ;  int page_addr ;  bool usedma ;  dma_addr_t dmaaddr ;  unsigned char * dmabuf ; } cocci_id@p ;
