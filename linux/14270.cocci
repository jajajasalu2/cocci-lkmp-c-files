...
position p;
@@
 int cocci_id@p ( struct vpbe_display * disp_dev , struct vpbe_layer * layer ) ;
...
position p;
@@
 struct vpbe_disp_buffer cocci_id@p ;
...
position p;
@@
 struct osd_layer_config * cocci_id@p ;
...
position p;
@@
 enum vpbe_display_device_id cocci_id@p ;
...
position p;
@@
 struct vpbe_display * cocci_id@p ;
...
position p;
@@
 struct display_layer_info * cocci_id@p ;
