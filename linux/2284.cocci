...
position p;
@@
 enum proc_thermal_emum_mode_type { PROC_THERMAL_NONE , PROC_THERMAL_PCI , PROC_THERMAL_PLATFORM_DEV , } cocci_id@p ;
...
position p;
@@
 enum proc_thermal_emum_mode_type cocci_id@p ;
...
position p;
@@
 struct proc_thermal_device * * cocci_id@p ;
...
typedef u32;
@@
 struct power_config {  u32 index ;  u32 min_uw ;  u32 max_uw ;  u32 tmin_us ;  u32 tmax_us ;  u32 step_uw ; } cocci_id@p ;
...
position p;
@@
 struct proc_thermal_device {  struct device * dev ;  struct acpi_device * adev ;  struct power_config power_limits [ 2 ] ;  struct int34x_thermal_zone * int340x_zone ;  struct intel_soc_dts_sensors * soc_dts ;  void __iomem * mmio_base ; } cocci_id@p ;
...
position p;
@@
 struct rapl_mmio_regs * cocci_id@p ;
...
typedef u64;
@@
 struct rapl_mmio_regs {  u64 reg_unit ;  u64 regs [ RAPL_DOMAIN_MAX ] [ RAPL_DOMAIN_REG_MAX ] ;  int limits [ RAPL_DOMAIN_MAX ] ; } cocci_id@p ;
...
position p;
@@
 const struct rapl_mmio_regs cocci_id@p ;
