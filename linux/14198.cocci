...
position p;
@@
 enum csi_output_fmt cocci_id@p ;
...
position p;
@@
 struct sun6i_csi_dev cocci_id@p ;
...
position p;
@@
 struct sun6i_csi_dev {  struct sun6i_csi csi ;  struct device * dev ;  struct regmap * regmap ;  struct clk * clk_mod ;  struct clk * clk_ram ;  struct reset_control * rstc_bus ;  int planar_offset [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct sun6i_csi_config * cocci_id@p ;
