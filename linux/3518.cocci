...
position p;
@@
 const struct sdhci_iproc_data * cocci_id@p ;
...
typedef u32;
@@
 struct sdhci_iproc_data {  const struct sdhci_pltfm_data * pdata ;  u32 caps ;  u32 caps1 ;  u32 mmc_caps ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct sdhci_iproc_host {  const struct sdhci_iproc_data * data ;  u32 shadow_cmd ;  u32 shadow_blk ;  bool is_cmd_shadowed ;  bool is_blk_shadowed ; } cocci_id@p ;
...
position p;
@@
 struct sdhci_iproc_host * cocci_id@p ;
