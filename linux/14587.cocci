...
symbol cocci_id;
position p;
typedef ti_of_clk_init_cb_t;
@@
 ti_of_clk_init_cb_t cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct clk_hw_omap * hw ) ;
...
position p;
@@
 const struct clk_omap_reg * cocci_id@p ;
...
position p;
@@
 struct clk_iomap {  struct regmap * regmap ;  void __iomem * mem ; } cocci_id@p ;
...
position p;
@@
 struct clk_iomap * cocci_id@p [ CLK_MAX_MEMMAPS ] ;
...
position p;
@@
 struct clk_init_item * cocci_id@p ;
...
position p;
@@
 struct ti_clk_features cocci_id@p ;
...
position p;
@@
 const struct ti_clk_features * cocci_id@p ;
...
position p;
@@
 struct clk_omap_reg * cocci_id@p ;
...
position p;
@@
 struct ti_clk_ll_ops * cocci_id@p ;
...
typedef ti_of_clk_init_cb_t;
@@
 struct clk_init_item {  struct device_node * node ;  void * user ;  ti_of_clk_init_cb_t func ;  struct list_head link ; } cocci_id@p ;
...
position p;
@@
 struct device_node * cocci_id@p [ CLK_MAX_MEMMAPS ] ;
