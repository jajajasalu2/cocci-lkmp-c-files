...
position p;
@@
 const struct i8k_config_data * cocci_id@p ;
...
position p;
@@
 enum i8k_configs { DELL_LATITUDE_D520 , DELL_PRECISION_490 , DELL_STUDIO , DELL_XPS , } cocci_id@p ;
...
position p;
@@
 enum i8k_fan_controls { I8K_FAN_34A3_35A3 , } cocci_id@p ;
...
position p;
@@
 const struct i8k_fan_control_data * cocci_id@p ;
...
position p;
@@
 struct smm_regs {  unsigned int eax ;  unsigned int ebx __packed ;  unsigned int ecx __packed ;  unsigned int edx __packed ;  unsigned int esi __packed ;  unsigned int edi __packed ; } cocci_id@p ;
...
position p;
@@
 struct i8k_fan_control_data {  unsigned int manual_fan ;  unsigned int auto_fan ; } cocci_id@p ;
...
typedef uint;
@@
 struct i8k_config_data {  uint fan_mult ;  uint fan_max ; } cocci_id@p ;
