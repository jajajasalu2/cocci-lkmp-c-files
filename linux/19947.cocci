...
symbol cocci_id;
position p;
typedef wait_queue_head_t,tb_sample_t;
@@
 struct sbprof_tb {  wait_queue_head_t tb_sync ;  wait_queue_head_t tb_read ;  struct mutex lock ;  enum open_status open ;  tb_sample_t * sbprof_tbbuf ;  int next_tb_sample ;  volatile int tb_enable ;  volatile int tb_armed ; } cocci_id@p ;
...
position p;
@@
 enum open_status { SB_CLOSED , SB_OPENING , SB_OPEN , } cocci_id@p ;
