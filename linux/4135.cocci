...
position p;
@@
 struct phy_usb_instance cocci_id@p ;
...
typedef u32;
@@
 struct exynos5_usbdrd_phy {  struct device * dev ;  void __iomem * reg_phy ;  struct clk * clk ;  struct clk * pipeclk ;  struct clk * utmiclk ;  struct clk * itpclk ;  const struct exynos5_usbdrd_phy_drvdata * drv_data ;  struct phy_usb_instance {  struct phy * phy ;  u32 index ;  struct regmap * reg_pmu ;  u32 pmu_offset ;  const struct exynos5_usbdrd_phy_config * phy_cfg ; } phys [ EXYNOS5_DRDPHYS_NUM ] ;  u32 extrefclk ;  struct clk * ref_clk ;  struct regulator * vbus ;  struct regulator * vbus_boost ; } cocci_id@p ;
...
position p;
@@
 const struct exynos5_usbdrd_phy_drvdata cocci_id@p ;
...
position p;
@@
 const struct exynos5_usbdrd_phy_config cocci_id@p [ ] ;
...
typedef bool,u32;
@@
 struct exynos5_usbdrd_phy_drvdata {  const struct exynos5_usbdrd_phy_config * phy_cfg ;  u32 pmu_offset_usbdrd0_phy ;  u32 pmu_offset_usbdrd1_phy ;  bool has_common_clk_gate ; } cocci_id@p ;
...
position p;
@@
 enum exynos5_usbdrd_phy_id { EXYNOS5_DRDPHY_UTMI , EXYNOS5_DRDPHY_PIPE3 , EXYNOS5_DRDPHYS_NUM , } cocci_id@p ;
...
position p;
@@
 struct exynos5_usbdrd_phy * cocci_id@p ;
