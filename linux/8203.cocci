...
position p;
@@
 struct macb_dma_desc cocci_id@p ;
...
position p;
@@
 struct sifive_fu540_macb_mgmt * cocci_id@p ;
...
position p;
@@
 struct sifive_fu540_macb_mgmt {  void __iomem * reg ;  unsigned long rate ;  struct clk_hw hw ; } cocci_id@p ;
...
position p;
@@
 struct macb_dma_desc_ptp cocci_id@p ;
...
position p;
@@
 struct macb_dma_desc_64 cocci_id@p ;
...
position p;
@@
 struct macb_platform_data * cocci_id@p ;
...
position p;
@@
 const struct macb_config * cocci_id@p ;
...
position p;
@@
 struct ethtool_rx_fs_item * cocci_id@p ;
...
position p;
@@
 struct macb_ptp_info cocci_id@p ;
