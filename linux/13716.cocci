...
typedef u8;
@@
 struct i2c_reg_value {  u8 reg ;  u8 value ;  u8 type ; } cocci_id@p ;
...
position p;
@@
 struct tvp7002 {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  const struct tvp7002_config * pdata ;  int ver ;  int streaming ;  const struct tvp7002_timings_definition * current_timings ;  struct media_pad pad ; } cocci_id@p ;
...
position p;
@@
 const struct tvp7002_timings_definition * cocci_id@p ;
...
typedef u16;
@@
 struct tvp7002_timings_definition {  struct v4l2_dv_timings timings ;  const struct i2c_reg_value * p_settings ;  enum v4l2_colorspace color_space ;  enum v4l2_field scanmode ;  u16 progressive ;  u16 lines_per_frame ;  u16 cpl_min ;  u16 cpl_max ; } cocci_id@p ;
...
position p;
@@
 struct tvp7002_config * cocci_id@p ;
