...
position p;
@@
 struct drm_prime_member cocci_id@p ;
...
typedef uint32_t;
@@
 struct drm_prime_member {  struct dma_buf * dma_buf ;  uint32_t handle ;  struct rb_node dmabuf_rb ;  struct rb_node handle_rb ; } cocci_id@p ;
...
position p;
@@
 struct dma_buf_export_info * cocci_id@p ;
...
position p;
@@
 struct drm_prime_file_private * cocci_id@p ;
...
position p;
@@
 struct drm_prime_handle * cocci_id@p ;
