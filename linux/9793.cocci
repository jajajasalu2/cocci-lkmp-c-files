...
position p;
@@
 struct ath10k_htc_lookahead_report cocci_id@p ;
...
position p;
@@
 enum ath10k_htc_ep_id cocci_id@p ;
...
position p;
@@
 const struct ath10k_htc_lookahead_report * cocci_id@p ;
...
position p;
@@
 struct ath10k_htc_conn_svc * cocci_id@p ;
...
position p;
@@
 enum ath10k_htc_svc_id cocci_id@p ;
...
position p;
@@
 struct ath10k_htc_conn_svc_response cocci_id@p ;
...
position p;
@@
 struct ath10k_ath10k_htc_record_hdr cocci_id@p ;
...
position p;
@@
 struct ath10k_htc_record * cocci_id@p ;
...
position p;
@@
 const struct ath10k_htc_credit_report * cocci_id@p ;
...
position p;
@@
 struct ath10k_htc_credit_report cocci_id@p ;
...
position p;
@@
 struct ath10k_htc_ep * cocci_id@p ;
...
position p;
@@
 struct ath10k_htc_msg * cocci_id@p ;
...
position p;
@@
 const struct ath10k_htc_lookahead_bundle * cocci_id@p ;
...
position p;
@@
 struct ath10k_htc_lookahead_bundle * cocci_id@p ;
