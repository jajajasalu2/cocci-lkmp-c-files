...
position p;
@@
 struct acpi_hest_ia_machine_check * cocci_id@p ;
...
position p;
@@
 struct acpi_hest_ia_deferred_check * cocci_id@p ;
...
position p;
@@
 struct acpi_hest_aer cocci_id@p ;
...
position p;
@@
 struct acpi_hest_ia_corrected * cocci_id@p ;
...
position p;
@@
 struct acpi_hest_ia_error_bank cocci_id@p ;
...
symbol cocci_id;
position p;
typedef apei_hest_func_t;
@@
 apei_hest_func_t cocci_id@p ;
...
position p;
@@
 struct acpi_hest_aer_root cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ ACPI_HEST_TYPE_RESERVED ] ;
...
position p;
@@
 struct acpi_hest_ia_nmi cocci_id@p ;
...
position p;
@@
 struct acpi_hest_aer_bridge cocci_id@p ;
...
position p;
@@
 struct ghes_arr {  struct platform_device * * ghes_devs ;  unsigned int count ; } cocci_id@p ;
