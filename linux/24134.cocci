...
position p;
@@
 struct can_pkg_stats * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sk_buff * , void * ) ;
...
position p;
@@
 struct can_dev_rcv_lists * cocci_id@p ;
...
position p;
@@
 struct can_rcv_lists_stats * cocci_id@p ;
