...
typedef u32;
@@
 struct rpm_cc {  struct qcom_rpm * rpm ;  struct clk_rpm * * clks ;  size_t num_clks ;  u32 xo_buffer_value ;  struct mutex xo_lock ; } cocci_id@p ;
...
position p;
@@
 const struct rpm_clk_desc cocci_id@p ;
...
position p;
@@
 struct rpm_clk_desc {  struct clk_rpm * * clks ;  size_t num_clks ; } cocci_id@p ;
...
typedef bool;
@@
 struct clk_rpm {  const int rpm_clk_id ;  const int xo_offset ;  const bool active_only ;  unsigned long rate ;  bool enabled ;  bool branch ;  struct clk_rpm * peer ;  struct clk_hw hw ;  struct qcom_rpm * rpm ;  struct rpm_cc * rpm_cc ; } cocci_id@p ;
