...
position p;
@@
 enum help_format { HELP_FORMAT_NONE , HELP_FORMAT_MAN , HELP_FORMAT_INFO , HELP_FORMAT_WEB , } cocci_id@p ;
...
position p;
@@
 struct man_viewer_info_list {  struct man_viewer_info_list * next ;  const char * info ;  char name [ 0 ] ; } * cocci_id@p ;
...
position p;
@@
 struct man_viewer_list * * cocci_id@p ;
...
position p;
@@
 struct man_viewer_list {  struct man_viewer_list * next ;  char name [ 0 ] ; } * cocci_id@p ;
...
position p;
@@
 struct man_viewer_info_list * cocci_id@p ;
