...
position p;
@@
 enum bdisp_target_plan cocci_id@p ;
...
position p;
@@
 enum bdisp_target_plan { BDISP_RGB , BDISP_Y , BDISP_CBCR , } cocci_id@p ;
...
position p;
@@
 struct bdisp_filter_addr cocci_id@p [ NB_H_FILTER ] ;
...
position p;
@@
 struct bdisp_request * cocci_id@p ;
...
position p;
@@
 const struct bdisp_filter_h_spec cocci_id@p [ ] ;
...
position p;
@@
 struct bdisp_op_cfg cocci_id@p ;
...
position p;
@@
 struct bdisp_filter_addr cocci_id@p [ NB_V_FILTER ] ;
...
typedef u8,bool,u16;
@@
 struct bdisp_op_cfg {  bool cconv ;  bool hflip ;  bool vflip ;  bool wide ;  bool scale ;  u16 h_inc ;  u16 v_inc ;  bool src_interlaced ;  u8 src_nbp ;  bool src_yuv ;  bool src_420 ;  u8 dst_nbp ;  bool dst_yuv ;  bool dst_420 ; } cocci_id@p ;
...
@@
 struct bdisp_filter_addr {  u16 min ;  u16 max ;  void * virt ;  dma_addr_t paddr ; } cocci_id@p ;
...
position p;
@@
 const struct bdisp_filter_v_spec cocci_id@p [ ] ;
