...
position p;
@@
 void cocci_id@p ( struct st_buffer * ) ;
...
position p;
@@
 void cocci_id@p ( struct st_buffer * , int ) ;
...
position p;
@@
 int cocci_id@p ( struct st_buffer * , char __user * , int ) ;
...
position p;
@@
 int cocci_id@p ( struct st_buffer * , int , int ) ;
...
position p;
@@
 int cocci_id@p ( const char __user * , struct st_buffer * , int ) ;
...
position p;
@@
 struct st_reject_data cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct scsi_tape * , unsigned int , unsigned long ) ;
...
position p;
@@
 int cocci_id@p ( struct st_buffer * , const unsigned int , int ) ;
...
position p;
@@
 struct st_reject_data {  char * vendor ;  char * model ;  char * rev ;  char * driver_hint ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct scsi_tape * , int ) ;
...
position p;
@@
 struct st_cmdstatus * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct scsi_tape * ) ;
...
position p;
@@
 struct scsi_tape_stats cocci_id@p ;
