...
typedef u8,u32;
@@
 struct icp_ipl {  union {  u32 word ;  u8 bytes [ 4 ] ; } xirr_poll ;  union {  u32 word ;  u8 bytes [ 4 ] ; } xirr ;  u32 dummy ;  union {  u32 word ;  u8 bytes [ 4 ] ; } qirr ;  u32 link_a ;  u32 link_b ;  u32 link_c ; } cocci_id@p ;
