...
typedef u8;
@@
 struct serdes_macro {  u8 idx ;  int port ;  struct serdes_ctrl * ctrl ; } cocci_id@p ;
...
position p;
@@
 struct serdes_macro * cocci_id@p ;
...
position p;
@@
 struct serdes_ctrl {  struct regmap * regs ;  struct device * dev ;  struct phy * phys [ SERDES_MAX ] ; } cocci_id@p ;
...
position p;
@@
 const struct serdes_mux cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct serdes_mux {  u8 idx ;  u8 port ;  enum phy_mode mode ;  int submode ;  u32 mask ;  u32 mux ; } cocci_id@p ;
