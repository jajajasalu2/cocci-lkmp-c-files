...
position p;
@@
 struct drm_encoder_slave * cocci_id@p ;
...
position p;
@@
 struct drm_i2c_encoder_driver cocci_id@p ;
...
typedef uint8_t;
@@
 struct sil164_priv {  struct sil164_encoder_params config ;  struct i2c_client * duallink_slave ;  uint8_t saved_state [ 0x10 ] ;  uint8_t saved_slave_state [ 0x10 ] ; } cocci_id@p ;
