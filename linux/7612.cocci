...
@@
 struct ocfb_dev {  struct fb_info info ;  void __iomem * regs ;  int little_endian ;  dma_addr_t fb_phys ;  void __iomem * fb_virt ;  u32 pseudo_palette [ PALETTE_SIZE ] ; } cocci_id@p ;
