...
position p;
@@
 enum imx_fec_type { IMX25_FEC = 1 , IMX27_FEC , IMX28_FEC , IMX6Q_FEC , MVF600_FEC , IMX6SX_FEC , IMX6UL_FEC , } cocci_id@p ;
...
position p;
@@
 struct fec_enet_priv_tx_q * cocci_id@p ;
...
position p;
@@
 struct fec_enet_priv_rx_q * cocci_id@p ;
...
position p;
@@
 struct bufdesc_prop * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * ndev ) ;
...
position p;
@@
 struct fec_enet_private cocci_id@p ;
...
position p;
@@
 struct fec_platform_data * cocci_id@p ;
...
position p;
@@
 struct platform_device_id cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ MII_BUS_ID_SIZE ] ;
...
typedef u16;
@@
 const struct fec_stat {  char name [ ETH_GSTRING_LEN ] ;  u16 offset ; } cocci_id@p [ ] ;
