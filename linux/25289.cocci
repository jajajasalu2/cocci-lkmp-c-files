...
typedef pthread_rwlock_t;
@@
 int ( * cocci_id@p ) ( pthread_rwlock_t * rwlock ) ;
...
symbol cocci_id;
position p;
typedef pthread_rwlockattr_t,pthread_rwlock_t;
@@
 int ( * cocci_id@p ) ( pthread_rwlock_t * rwlock , const pthread_rwlockattr_t * attr ) ;
...
position p;
@@
 struct lock_lookup cocci_id@p [ LIBLOCKDEP_STATIC_ENTRIES ] ;
...
typedef pthread_mutex_t;
@@
 int cocci_id@p ( pthread_mutex_t * mutex ) ;
...
@@
 const pthread_mutexattr_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pthread_mutex_t,pthread_mutexattr_t;
@@
 int ( * cocci_id@p ) ( pthread_mutex_t * mutex , const pthread_mutexattr_t * attr ) ;
...
@@
 const pthread_rwlockattr_t * cocci_id@p ;
...
position p;
@@
 enum { none , prepare , done , } cocci_id@p ;
