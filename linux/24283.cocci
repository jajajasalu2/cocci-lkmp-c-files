...
position p;
@@
 const struct arppayload * cocci_id@p ;
...
position p;
@@
 struct arppayload {  unsigned char mac_src [ ETH_ALEN ] ;  unsigned char ip_src [ 4 ] ;  unsigned char mac_dst [ ETH_ALEN ] ;  unsigned char ip_dst [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct ebt_log_info cocci_id@p ;
...
position p;
@@
 const struct ebt_log_info * cocci_id@p ;
...
position p;
@@
 const struct tcpudphdr * cocci_id@p ;
...
position p;
@@
 struct tcpudphdr {  __be16 src ;  __be16 dst ; } cocci_id@p ;
