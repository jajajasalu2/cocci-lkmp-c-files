...
position p;
@@
 struct marvel_rtc_access_info cocci_id@p ;
...
position p;
@@
 struct marvel_rtc_access_info {  unsigned long function ;  unsigned long index ;  unsigned long data ; } cocci_id@p ;
...
position p;
@@
 struct marvel_agp_aperture * cocci_id@p ;
...
position p;
@@
 struct alpha_agp_ops cocci_id@p ;
...
position p;
@@
 struct marvel_agp_aperture {  struct pci_iommu_arena * arena ;  long pg_start ;  long pg_count ; } cocci_id@p ;
