...
position p;
@@
 enum { UIO_IRQ_DISABLED = 0 , } cocci_id@p ;
...
position p;
@@
 struct uio_pdrv_genirq_platdata * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct uio_pdrv_genirq_platdata {  struct uio_info * uioinfo ;  spinlock_t lock ;  unsigned long flags ;  struct platform_device * pdev ; } cocci_id@p ;
