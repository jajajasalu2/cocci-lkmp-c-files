...
typedef u8;
@@
 struct imx8qxp_ss_lpcg {  const struct imx8qxp_lpcg_data * lpcg ;  u8 num_lpcg ;  u8 num_max ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct imx8qxp_lpcg_data {  int id ;  char * name ;  char * parent ;  unsigned long flags ;  u32 offset ;  u8 bit_idx ;  bool hw_gate ; } cocci_id@p ;
...
position p;
@@
 const struct imx8qxp_lpcg_data cocci_id@p [ ] ;
...
position p;
@@
 const struct imx8qxp_ss_lpcg cocci_id@p ;
