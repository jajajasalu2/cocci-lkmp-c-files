...
position p;
@@
 struct lp3944_led_data cocci_id@p ;
...
position p;
@@
 struct lp3944_platform_data * cocci_id@p ;
...
typedef u8;
@@
 struct lp3944_led_data {  u8 id ;  enum lp3944_type type ;  struct led_classdev ldev ;  struct i2c_client * client ; } cocci_id@p ;
...
position p;
@@
 struct lp3944_data {  struct mutex lock ;  struct i2c_client * client ;  struct lp3944_led_data leds [ LP3944_LEDS_MAX ] ; } cocci_id@p ;
