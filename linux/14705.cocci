...
typedef u32;
@@
 struct clk_master {  struct clk_hw hw ;  struct regmap * regmap ;  const struct clk_master_layout * layout ;  const struct clk_master_characteristics * characteristics ;  u32 mckr ; } cocci_id@p ;
