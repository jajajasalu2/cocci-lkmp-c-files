...
position p;
@@
 int cocci_id@p ( struct qlcnic_adapter * , struct qlcnic_cmd_args * ) ;
...
position p;
@@
 struct qlcnic_bc_trans * cocci_id@p ;
...
position p;
@@
 struct qlcnic_sriov * cocci_id@p ;
...
position p;
@@
 struct qlcnic_async_cmd cocci_id@p ;
...
position p;
@@
 enum qlcnic_vlan_operations cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct qlcnic_cmd_args * , u32 ) ;
...
position p;
@@
 void cocci_id@p ( struct qlcnic_bc_trans * ) ;
...
position p;
@@
 struct qlcnic_back_channel * cocci_id@p ;
...
position p;
@@
 struct qlcnic_vport * cocci_id@p ;
...
position p;
@@
 struct qlcnic_vf_info cocci_id@p ;
...
position p;
@@
 struct qlcnic_bc_payload * cocci_id@p ;
...
position p;
@@
 enum qlcnic_mac_type cocci_id@p ;
...
position p;
@@
 struct qlcnic_trans_list * cocci_id@p ;
