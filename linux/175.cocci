...
position p;
@@
 struct irq_generic_chip_devres * cocci_id@p ;
...
position p;
@@
 struct irq_desc_devres * cocci_id@p ;
...
position p;
@@
 struct irq_desc_devres {  unsigned int from ;  unsigned int cnt ; } cocci_id@p ;
...
typedef u32;
@@
 struct irq_generic_chip_devres {  struct irq_chip_generic * gc ;  u32 msk ;  unsigned int clr ;  unsigned int set ; } cocci_id@p ;
...
position p;
@@
 struct irq_devres {  unsigned int irq ;  void * dev_id ; } cocci_id@p ;
