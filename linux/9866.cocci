...
position p;
@@
 struct htc_panic_bad_vaddr * cocci_id@p ;
...
position p;
@@
 struct htc_panic_bad_epid * cocci_id@p ;
...
position p;
@@
 struct htc_conn_svc_rspmsg * cocci_id@p ;
...
position p;
@@
 struct htc_comp_msg cocci_id@p ;
...
position p;
@@
 struct htc_conn_svc_msg cocci_id@p ;
...
position p;
@@
 struct htc_config_pipe_msg cocci_id@p ;
...
position p;
@@
 struct ath9k_htc_hif * cocci_id@p ;
