...
position p;
@@
 struct emu10k1x_voice {  struct emu10k1x * emu ;  int number ;  int use ;  struct emu10k1x_pcm * epcm ; } cocci_id@p ;
...
position p;
@@
 struct emu10k1x_pcm {  struct emu10k1x * emu ;  struct snd_pcm_substream * substream ;  struct emu10k1x_voice * voice ;  unsigned short running ; } cocci_id@p ;
...
position p;
@@
 struct emu10k1x_voice * cocci_id@p ;
...
position p;
@@
 struct emu10k1x_midi * cocci_id@p ;
...
@@
 struct emu10k1x {  struct snd_card * card ;  struct pci_dev * pci ;  unsigned long port ;  struct resource * res_port ;  int irq ;  unsigned char revision ;  unsigned int serial ;  unsigned short model ;  spinlock_t emu_lock ;  spinlock_t voice_lock ;  struct snd_ac97 * ac97 ;  struct snd_pcm * pcm ;  struct emu10k1x_voice voices [ 3 ] ;  struct emu10k1x_voice capture_voice ;  u32 spdif_bits [ 3 ] ;  struct snd_dma_buffer dma_buffer ;  struct emu10k1x_midi midi ; } cocci_id@p ;
...
position p;
@@
 struct emu10k1x_pcm * cocci_id@p ;
