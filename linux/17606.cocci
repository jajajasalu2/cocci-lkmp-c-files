...
position p;
@@
 struct hash_mm_context cocci_id@p ;
...
position p;
@@
 struct subpage_prot_table * cocci_id@p ;
...
position p;
@@
 struct mmu_psize_def cocci_id@p [ MMU_PAGE_COUNT ] ;
...
position p;
@@
 struct mmu_hash_ops cocci_id@p ;
