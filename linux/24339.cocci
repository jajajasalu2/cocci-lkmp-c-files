...
typedef u8;
@@
 struct smc_llc_msg_confirm_rkey {  struct smc_llc_hdr hd ;  struct smc_rmb_rtoken rtoken [ SMC_LLC_RKEYS_PER_MSG ] ;  u8 reserved ; } cocci_id@p ;
...
position p;
@@
 struct smc_wr_tx_pend_priv * * cocci_id@p ;
...
typedef u8;
@@
 struct smc_llc_msg_confirm_rkey_cont {  struct smc_llc_hdr hd ;  u8 num_rkeys ;  struct smc_rmb_rtoken rtoken [ SMC_LLC_RKEYS_PER_MSG ] ; } cocci_id@p ;
...
position p;
@@
 struct smc_wr_rx_handler * cocci_id@p ;
...
position p;
@@
 struct smc_llc_send_work {  struct work_struct work ;  struct smc_link * link ;  int llclen ;  union smc_llc_msg llcbuf ; } cocci_id@p ;
...
position p;
@@
 struct smc_llc_tx_pend { } cocci_id@p ;
...
position p;
@@
 struct smc_llc_msg_confirm_rkey * cocci_id@p ;
...
position p;
@@
 struct smc_llc_msg_confirm_rkey_cont * cocci_id@p ;
...
typedef u8;
@@
 struct smc_llc_msg_add_link {  struct smc_llc_hdr hd ;  u8 sender_mac [ ETH_ALEN ] ;  u8 reserved2 [ 2 ] ;  u8 sender_gid [ SMC_GID_SIZE ] ;  u8 sender_qp_num [ 3 ] ;  u8 link_num ;  u8 flags2 ;  u8 initial_psn [ 3 ] ;  u8 reserved [ 8 ] ; } cocci_id@p ;
...
typedef u8;
@@
 union smc_llc_msg {  struct smc_llc_msg_confirm_link confirm_link ;  struct smc_llc_msg_add_link add_link ;  struct smc_llc_msg_del_link delete_link ;  struct smc_llc_msg_confirm_rkey confirm_rkey ;  struct smc_llc_msg_confirm_rkey_cont confirm_rkey_cont ;  struct smc_llc_msg_delete_rkey delete_rkey ;  struct smc_llc_msg_test_link test_link ;  struct {  struct smc_llc_hdr hdr ;  u8 data [ SMC_LLC_DATA_LEN ] ; } raw ; } cocci_id@p ;
...
position p;
@@
 struct smc_llc_msg_add_link * cocci_id@p ;
...
position p;
@@
 struct smc_llc_msg_test_link cocci_id@p ;
...
typedef u8,__be32;
@@
 struct smc_llc_msg_delete_rkey {  struct smc_llc_hdr hd ;  u8 num_rkeys ;  u8 err_mask ;  u8 reserved [ 2 ] ;  __be32 rkey [ 8 ] ;  u8 reserved2 [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct smc_llc_send_work * cocci_id@p ;
...
position p;
@@
 struct smc_llc_msg_confirm_link cocci_id@p ;
...
typedef u8;
@@
 struct smc_llc_msg_test_link {  struct smc_llc_hdr hd ;  u8 user_data [ 16 ] ;  u8 reserved [ 24 ] ; } cocci_id@p ;
...
position p;
@@
 enum smc_llc_reqresp cocci_id@p ;
...
position p;
@@
 struct smc_llc_msg_delete_rkey * cocci_id@p ;
...
position p;
@@
 struct smc_llc_msg_del_link * cocci_id@p ;
...
position p;
@@
 struct smc_link_group * cocci_id@p ;
...
typedef u8;
@@
 struct smc_llc_msg_confirm_link {  struct smc_llc_hdr hd ;  u8 sender_mac [ ETH_ALEN ] ;  u8 sender_gid [ SMC_GID_SIZE ] ;  u8 sender_qp_num [ 3 ] ;  u8 link_num ;  u8 link_uid [ SMC_LGR_ID_SIZE ] ;  u8 max_links ;  u8 reserved [ 9 ] ; } cocci_id@p ;
...
position p;
@@
 struct smc_buf_desc * cocci_id@p ;
