...
position p;
@@
 const struct iwl_dbg_tlv_ver_data cocci_id@p [ IWL_DBG_TLV_TYPE_NUM ] ;
...
position p;
@@
 enum iwl_fw_ini_buffer_location * cocci_id@p ;
...
position p;
@@
 struct iwl_dbg_tlv_ver_data {  int min_ver ;  int max_ver ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct iwl_trans * trans , struct iwl_ucode_tlv * tlv ) ;
...
position p;
@@
 struct iwl_dbg_tlv_time_point_data * cocci_id@p ;
...
position p;
@@
 struct iwl_buf_alloc_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_buf_alloc_frag * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_ini_hcmd_tlv * cocci_id@p ;
...
typedef bool,u32;
@@
 bool ( * cocci_id@p ) ( struct iwl_fw_runtime * fwrt , struct iwl_fwrt_dump_data * dump_data , union iwl_dbg_tlv_tp_data * tp_data , u32 trig_data ) ;
...
position p;
@@
 enum iwl_ini_cfg_state * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_ini_hcmd * cocci_id@p ;
...
position p;
@@
 struct iwl_dbg_tlv_timer_node * cocci_id@p ;
...
position p;
@@
 enum iwl_fw_ini_allocation_id cocci_id@p ;
...
position p;
@@
 struct iwl_fw_ini_header * cocci_id@p ;
...
position p;
@@
 enum iwl_dbg_tlv_type { IWL_DBG_TLV_TYPE_DEBUG_INFO = IWL_UCODE_TLV_TYPE_DEBUG_INFO - IWL_UCODE_TLV_DEBUG_BASE , IWL_DBG_TLV_TYPE_BUF_ALLOC , IWL_DBG_TLV_TYPE_HCMD , IWL_DBG_TLV_TYPE_REGION , IWL_DBG_TLV_TYPE_TRIGGER , IWL_DBG_TLV_TYPE_NUM , } cocci_id@p ;
...
position p;
@@
 struct iwl_dbg_tlv_timer_node {  struct list_head list ;  struct timer_list timer ;  struct iwl_fw_runtime * fwrt ;  struct iwl_ucode_tlv * tlv ; } cocci_id@p ;
...
position p;
@@
 struct iwl_cmd_header * cocci_id@p ;
