...
position p;
@@
 struct kvm_s390_vm_cpu_machine * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_vm_cpu_feat cocci_id@p ;
...
position p;
@@
 struct kvm_s390_cpu_model * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_irq_state cocci_id@p ;
...
position p;
@@
 struct kvm_s390_crypto_cb * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_vm_tod_clock * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_mem_op * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_interrupt cocci_id@p ;
...
position p;
@@
 const struct kvm_s390_vm_tod_clock * cocci_id@p ;
...
position p;
@@
 struct mcck_volatile_info * cocci_id@p ;
...
position p;
@@
 struct ap_config_info cocci_id@p ;
...
position p;
@@
 struct runtime_instr_cb * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gmap * gmap , unsigned long start , unsigned long end ) ;
...
position p;
@@
 struct kvm_s390_skeys * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_ucas_mapping cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ SIZE_INTERNAL ] ;
...
position p;
@@
 struct gmap_notifier cocci_id@p ;
...
position p;
@@
 const struct kvm_s390_cmma_log * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_sie_block * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_vm_cpu_processor * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_irq cocci_id@p ;
...
position p;
@@
 struct kvm_s390_tod_clock_ext cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cpacf_mask_t;
@@
 cpacf_mask_t * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_vm_cpu_subfunc cocci_id@p ;
...
position p;
@@
 struct kvm_s390_cmma_log * cocci_id@p ;
