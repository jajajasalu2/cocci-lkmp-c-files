...
position p;
@@
 struct input_mt_pos cocci_id@p [ CYTP_MAX_MT_SLOTS ] ;
...
position p;
@@
 struct cytp_contact * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ CYTP_MAX_MT_SLOTS ] ;
...
position p;
@@
 struct cytp_report_data * cocci_id@p ;
