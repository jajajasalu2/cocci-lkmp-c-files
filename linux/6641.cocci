...
position p;
@@
 struct fcoe_cqe_rsp_info * cocci_id@p ;
...
position p;
@@
 struct fcoe_tx_mid_path_params cocci_id@p ;
...
position p;
@@
 struct fcoe_task_params cocci_id@p ;
...
position p;
@@
 struct qedf_cmd_mgr * cocci_id@p ;
...
position p;
@@
 struct fcoe_db_data cocci_id@p ;
...
position p;
@@
 enum fcoe_task_type cocci_id@p ;
