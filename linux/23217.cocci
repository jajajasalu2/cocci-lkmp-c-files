...
typedef u8;
@@
 u8 cocci_id@p [ DA7219_AAD_IRQ_REG_MAX ] ;
...
position p;
@@
 struct da7219_aad_priv cocci_id@p ;
...
position p;
@@
 struct da7219_aad_pdata * cocci_id@p ;
...
position p;
@@
 enum da7219_aad_adc_1bit_rpt cocci_id@p ;
...
position p;
@@
 enum da7219_aad_jack_rem_deb cocci_id@p ;
...
position p;
@@
 enum da7219_aad_btn_avg cocci_id@p ;
...
position p;
@@
 enum da7219_aad_btn_cfg cocci_id@p ;
...
position p;
@@
 enum da7219_aad_mic_det_thr cocci_id@p ;
...
position p;
@@
 enum da7219_aad_jack_ins_deb cocci_id@p ;
...
position p;
@@
 enum da7219_aad_jack_det_rate cocci_id@p ;
...
position p;
@@
 enum da7219_aad_micbias_pulse_lvl cocci_id@p ;
