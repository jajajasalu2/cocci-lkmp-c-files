...
position p;
@@
 struct l64781_state cocci_id@p ;
...
position p;
@@
 const struct l64781_config * cocci_id@p ;
...
position p;
@@
 struct l64781_state {  struct i2c_adapter * i2c ;  const struct l64781_config * config ;  struct dvb_frontend frontend ;  unsigned int first : 1 ; } cocci_id@p ;
