...
position p;
@@
 struct dw_plat_pcie_of_data * cocci_id@p ;
...
position p;
@@
 struct dw_plat_pcie * cocci_id@p ;
...
position p;
@@
 const struct dw_plat_pcie_of_data cocci_id@p ;
...
position p;
@@
 struct dw_plat_pcie {  struct dw_pcie * pci ;  struct regmap * regmap ;  enum dw_pcie_device_mode mode ; } cocci_id@p ;
...
position p;
@@
 struct dw_plat_pcie_of_data {  enum dw_pcie_device_mode mode ; } cocci_id@p ;
