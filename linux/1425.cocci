...
position p;
@@
 const struct usb_string cocci_id@p [ ] ;
...
position p;
@@
 enum { AST_VHUB_STR_MANUF = 3 , AST_VHUB_STR_PRODUCT = 2 , AST_VHUB_STR_SERIAL = 1 , } cocci_id@p ;
...
position p;
@@
 struct ast_vhub_port * cocci_id@p ;
