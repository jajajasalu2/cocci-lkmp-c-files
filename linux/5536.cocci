...
position p;
@@
 enum { RTC_SEC = 0 , RTC_MIN , RTC_HOUR , RTC_WEEKDAY , RTC_MONTH , RTC_YEAR , RTC_DATE , RTC_NR_TIME , } cocci_id@p ;
...
position p;
@@
 const struct max77686_rtc_driver_data * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ REG_RTC_END ] ;
...
position p;
@@
 enum MAX77686_RTC_OP cocci_id@p ;
...
position p;
@@
 struct max77686_rtc_info cocci_id@p ;
...
position p;
@@
 const struct rtc_class_ops cocci_id@p ;
...
typedef u8,bool;
@@
 struct max77686_rtc_driver_data {  unsigned long delay ;  u8 mask ;  const unsigned int * map ;  bool alarm_enable_reg ;  int rtc_i2c_addr ;  bool rtc_irq_from_platform ;  int alarm_pending_status_reg ;  const struct regmap_irq_chip * rtc_irq_chip ; } cocci_id@p ;
...
position p;
@@
 const struct regmap_irq cocci_id@p [ ] ;
...
position p;
@@
 const struct regmap_irq_chip cocci_id@p ;
...
position p;
@@
 struct max77686_rtc_info {  struct device * dev ;  struct i2c_client * rtc ;  struct rtc_device * rtc_dev ;  struct mutex lock ;  struct regmap * regmap ;  struct regmap * rtc_regmap ;  const struct max77686_rtc_driver_data * drv_data ;  struct regmap_irq_chip_data * rtc_irq_data ;  int rtc_irq ;  int virq ;  int rtc_24hr_mode ; } cocci_id@p ;
...
position p;
@@
 enum MAX77686_RTC_OP { MAX77686_RTC_WRITE , MAX77686_RTC_READ , } cocci_id@p ;
