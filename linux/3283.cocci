...
position p;
@@
 struct npcm7xx_pwm_fan_data * cocci_id@p ;
...
position p;
@@
 const struct npcm7xx_pwm_fan_data * cocci_id@p ;
...
position p;
@@
 struct npcm7xx_cooling_device * cocci_id@p ;
...
@@
 struct npcm7xx_pwm_fan_data {  void __iomem * pwm_base ;  void __iomem * fan_base ;  unsigned long pwm_clk_freq ;  unsigned long fan_clk_freq ;  struct clk * pwm_clk ;  struct clk * fan_clk ;  struct mutex pwm_lock [ NPCM7XX_PWM_MAX_MODULES ] ;  spinlock_t fan_lock [ NPCM7XX_FAN_MAX_MODULE ] ;  int fan_irq [ NPCM7XX_FAN_MAX_MODULE ] ;  bool pwm_present [ NPCM7XX_PWM_MAX_CHN_NUM ] ;  bool fan_present [ NPCM7XX_FAN_MAX_CHN_NUM ] ;  u32 input_clk_freq ;  struct timer_list fan_timer ;  struct npcm7xx_fan_dev fan_dev [ NPCM7XX_FAN_MAX_CHN_NUM ] ;  struct npcm7xx_cooling_device * cdev [ NPCM7XX_PWM_MAX_CHN_NUM ] ;  u8 fan_select ; } cocci_id@p ;
...
typedef u8;
@@
 struct npcm7xx_cooling_device {  char name [ THERMAL_NAME_LENGTH ] ;  struct npcm7xx_pwm_fan_data * data ;  struct thermal_cooling_device * tcdev ;  int pwm_port ;  u8 * cooling_levels ;  u8 max_state ;  u8 cur_state ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct npcm7xx_fan_dev {  u8 fan_st_flg ;  u8 fan_pls_per_rev ;  u16 fan_cnt ;  u32 fan_cnt_tmp ; } cocci_id@p ;
