...
typedef dma_addr_t;
@@
 struct vip_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ;  dma_addr_t dma ; } cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ AUX_COUNT ] ;
