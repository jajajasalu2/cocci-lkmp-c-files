...
position p;
@@
 struct cygnus_pcie_phy_core {  struct device * dev ;  void __iomem * base ;  struct mutex lock ;  struct cygnus_pcie_phy phys [ MAX_NUM_PHYS ] ; } cocci_id@p ;
...
position p;
@@
 enum cygnus_pcie_phy_id { CYGNUS_PHY_PCIE0 = 0 , CYGNUS_PHY_PCIE1 , MAX_NUM_PHYS , } cocci_id@p ;
...
position p;
@@
 struct cygnus_pcie_phy_core * cocci_id@p ;
...
position p;
@@
 struct cygnus_pcie_phy * cocci_id@p ;
...
position p;
@@
 struct cygnus_pcie_phy {  struct cygnus_pcie_phy_core * core ;  enum cygnus_pcie_phy_id id ;  struct phy * phy ; } cocci_id@p ;
