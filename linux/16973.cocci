...
position p;
@@
 enum { EVENT_INIT , EVENT_MIDDLE , EVENT_RELEASE , EVENT_FIFO_END , } cocci_id@p ;
...
position p;
@@
 struct max11801_data {  struct i2c_client * client ;  struct input_dev * input_dev ; } cocci_id@p ;
...
position p;
@@
 struct max11801_data * cocci_id@p ;
