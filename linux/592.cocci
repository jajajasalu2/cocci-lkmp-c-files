...
position p;
@@
 struct blake2b_state cocci_id@p ;
...
position p;
@@
 struct blake2b_tfm_ctx cocci_id@p ;
...
typedef u8;
@@
 struct blake2b_tfm_ctx {  u8 key [ BLAKE2B_KEYBYTES ] ;  unsigned int keylen ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ BLAKE2B_BLOCKBYTES ] ;
...
position p;
@@
 enum blake2b_constant { BLAKE2B_BLOCKBYTES = 128 , BLAKE2B_KEYBYTES = 64 , } cocci_id@p ;
...
typedef u8,u64;
@@
 struct blake2b_state {  u64 h [ 8 ] ;  u64 t [ 2 ] ;  u64 f [ 2 ] ;  u8 buf [ BLAKE2B_BLOCKBYTES ] ;  size_t buflen ; } cocci_id@p ;
