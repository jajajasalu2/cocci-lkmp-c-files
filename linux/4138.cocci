...
position p;
@@
 const struct mipi_phy_device_desc cocci_id@p ;
...
position p;
@@
 enum exynos_mipi_phy_id { EXYNOS_MIPI_PHY_ID_NONE = - 1 , EXYNOS_MIPI_PHY_ID_CSIS0 , EXYNOS_MIPI_PHY_ID_DSIM0 , EXYNOS_MIPI_PHY_ID_CSIS1 , EXYNOS_MIPI_PHY_ID_DSIM1 , EXYNOS_MIPI_PHY_ID_CSIS2 , EXYNOS_MIPI_PHYS_NUM , } cocci_id@p ;
...
position p;
@@
 struct exynos_mipi_video_phy * cocci_id@p ;
...
position p;
@@
 enum exynos_mipi_phy_regmap_id { EXYNOS_MIPI_REGMAP_PMU , EXYNOS_MIPI_REGMAP_DISP , EXYNOS_MIPI_REGMAP_CAM0 , EXYNOS_MIPI_REGMAP_CAM1 , EXYNOS_MIPI_REGMAPS_NUM , } cocci_id@p ;
...
position p;
@@
 const struct exynos_mipi_phy_desc * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct exynos_mipi_video_phy {  struct regmap * regmaps [ EXYNOS_MIPI_REGMAPS_NUM ] ;  int num_phys ;  struct video_phy_desc {  struct phy * phy ;  unsigned int index ;  const struct exynos_mipi_phy_desc * data ; } phys [ EXYNOS_MIPI_PHYS_NUM ] ;  spinlock_t slock ; } cocci_id@p ;
...
position p;
@@
 struct video_phy_desc * cocci_id@p ;
