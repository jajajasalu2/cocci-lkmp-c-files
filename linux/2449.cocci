...
position p;
@@
 struct usb_dmac_desc * cocci_id@p ;
...
position p;
@@
 struct usb_dmac_chan * cocci_id@p ;
...
@@
 struct usb_dmac_sg {  dma_addr_t mem_addr ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 struct usb_dmac_chan {  struct virt_dma_chan vc ;  void __iomem * iomem ;  unsigned int index ;  int irq ;  struct usb_dmac_desc * desc ;  int descs_allocated ;  struct list_head desc_got ;  struct list_head desc_freed ; } cocci_id@p ;
...
@@
 struct usb_dmac_desc {  struct virt_dma_desc vd ;  enum dma_transfer_direction direction ;  unsigned int sg_allocated_len ;  unsigned int sg_len ;  unsigned int sg_index ;  u32 residue ;  struct list_head node ;  dma_cookie_t done_cookie ;  struct usb_dmac_sg sg [ ] ; } cocci_id@p ;
...
position p;
@@
 struct usb_dmac {  struct dma_device engine ;  struct device * dev ;  void __iomem * iomem ;  unsigned int n_channels ;  struct usb_dmac_chan * channels ; } cocci_id@p ;
