...
position p;
@@
 struct nfqnl_msg_verdict_hdr * cocci_id@p ;
...
position p;
@@
 const struct nf_queue_handler cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,u_int8_t,u_int16_t,u_int32_t,spinlock_t;
@@
 struct nfqnl_instance {  struct hlist_node hlist ;  struct rcu_head rcu ;  u32 peer_portid ;  unsigned int queue_maxlen ;  unsigned int copy_range ;  unsigned int queue_dropped ;  unsigned int queue_user_dropped ;  u_int16_t queue_num ;  u_int8_t copy_mode ;  u_int32_t flags ;  spinlock_t lock ____cacheline_aligned_in_smp ;  unsigned int queue_total ;  unsigned int id_sequence ;  struct list_head queue_list ; } cocci_id@p ;
...
position p;
@@
 enum nfqnl_config_mode cocci_id@p ;
...
position p;
@@
 struct nfqnl_msg_packet_hdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nfqnl_instance * queue , nfqnl_cmpfn cmpfn , unsigned long data ) ;
...
position p;
@@
 struct nfqnl_msg_config_params * cocci_id@p ;
...
position p;
@@
 struct nfqnl_msg_packet_timestamp cocci_id@p ;
...
position p;
@@
 struct nfnl_queue_net * cocci_id@p ;
...
position p;
@@
 struct nfqnl_instance cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NFQA_VLAN_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFQA_CFG_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFQA_VLAN_MAX + 1 ] ;
...
typedef spinlock_t;
@@
 struct nfnl_queue_net {  spinlock_t instances_lock ;  struct hlist_head instance_table [ INSTANCE_BUCKETS ] ; } cocci_id@p ;
...
position p;
@@
 const struct nfnl_callback cocci_id@p [ NFQNL_MSG_MAX ] ;
...
position p;
@@
 struct nfqnl_msg_config_cmd cocci_id@p ;
...
position p;
@@
 struct nf_queue_entry * cocci_id@p ;
...
position p;
@@
 const struct nfqnl_instance * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFQA_MAX + 1 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct nf_queue_entry * , unsigned long ) ;
...
position p;
@@
 const struct nf_queue_entry * cocci_id@p ;
...
position p;
@@
 struct nfqnl_msg_packet_hw cocci_id@p ;
...
position p;
@@
 struct iter_state {  struct seq_net_private p ;  unsigned int bucket ; } cocci_id@p ;
