...
position p;
@@
 struct max8997_platform_data * cocci_id@p ;
...
position p;
@@
 struct max8997_data cocci_id@p ;
...
position p;
@@
 struct voltage_map_desc {  int min ;  int max ;  int step ; } cocci_id@p ;
...
position p;
@@
 const struct voltage_map_desc * cocci_id@p [ ] ;
...
typedef u8,bool;
@@
 struct max8997_data {  struct device * dev ;  struct max8997_dev * iodev ;  int num_regulators ;  int ramp_delay ;  bool buck1_gpiodvs ;  bool buck2_gpiodvs ;  bool buck5_gpiodvs ;  u8 buck1_vol [ 8 ] ;  u8 buck2_vol [ 8 ] ;  u8 buck5_vol [ 8 ] ;  int buck125_gpios [ 3 ] ;  int buck125_gpioindex ;  bool ignore_gpiodvs_side_effect ;  u8 saved_states [ MAX8997_REG_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct max8997_regulator_data * cocci_id@p ;
