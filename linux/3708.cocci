...
position p;
@@
 struct adf_reset_dev_data * cocci_id@p ;
...
position p;
@@
 struct adf_reset_dev_data {  int mode ;  struct adf_accel_dev * accel_dev ;  struct completion compl ;  struct work_struct reset_work ; } cocci_id@p ;
...
position p;
@@
 enum adf_dev_reset_mode cocci_id@p ;
