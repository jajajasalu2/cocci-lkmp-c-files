...
position p;
@@
 int ( * cocci_id@p ) ( void * data , void * state ) ;
...
position p;
@@
 struct privcmd_dm_op cocci_id@p ;
...
position p;
@@
 struct mmap_batch_state * cocci_id@p ;
...
position p;
@@
 struct privcmd_mmap_entry * cocci_id@p ;
...
position p;
@@
 struct privcmd_mmap_resource cocci_id@p ;
...
position p;
@@
 struct xen_mem_acquire_resource cocci_id@p ;
...
position p;
@@
 struct mmap_gfn_state cocci_id@p ;
...
position p;
@@
 struct privcmd_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vm_area_struct * vma , unsigned long addr , unsigned long nr_pages ) ;
...
position p;
@@
 struct privcmd_hypercall cocci_id@p ;
...
position p;
@@
 struct privcmd_dm_op_buf cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef xen_pfn_t,domid_t;
@@
 struct mmap_batch_state {  domid_t domain ;  unsigned long va ;  struct vm_area_struct * vma ;  int index ;  int global_error ;  int version ;  xen_pfn_t __user * user_gfn ;  int __user * user_err ; } cocci_id@p ;
...
position p;
@@
 struct privcmd_mmapbatch_v2 cocci_id@p ;
...
position p;
@@
 struct privcmd_mmap cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * data , int nr , void * state ) ;
...
position p;
@@
 struct privcmd_mmapbatch cocci_id@p ;
...
typedef domid_t;
@@
 struct mmap_gfn_state {  unsigned long va ;  struct vm_area_struct * vma ;  domid_t domain ; } cocci_id@p ;
...
typedef domid_t;
@@
 struct privcmd_data {  domid_t domid ; } cocci_id@p ;
...
position p;
@@
 struct xen_dm_op_buf * cocci_id@p ;
