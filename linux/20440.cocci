...
position p;
@@
 char cocci_id@p [ MAX_MCATYPE_NAME_LEN ] ;
...
position p;
@@
 struct smca_bank cocci_id@p [ MAX_NR_BANKS ] ;
...
position p;
@@
 const struct threshold_block * cocci_id@p ;
...
position p;
@@
 struct threshold_bank * * cocci_id@p ;
...
position p;
@@
 struct threshold_attr * cocci_id@p ;
...
position p;
@@
 struct threshold_block cocci_id@p ;
...
position p;
@@
 struct thresh_restart * cocci_id@p ;
...
typedef u16;
@@
 struct thresh_restart {  struct threshold_block * b ;  int reset ;  int set_lvt_off ;  int lvt_off ;  u16 old_limit ; } cocci_id@p ;
...
position p;
@@
 struct smca_bank_name cocci_id@p [ ] ;
...
position p;
@@
 struct smca_bank_name {  const char * name ;  const char * long_name ; } cocci_id@p ;
...
position p;
@@
 enum smca_bank_types cocci_id@p ;
