...
typedef u32;
@@
 struct pmagbbfb_par {  volatile void __iomem * mmio ;  volatile void __iomem * smem ;  volatile u32 __iomem * sfb ;  volatile u32 __iomem * dac ;  unsigned int osc0 ;  unsigned int osc1 ;  int slot ; } cocci_id@p ;
...
position p;
@@
 struct pmagbbfb_par cocci_id@p ;
