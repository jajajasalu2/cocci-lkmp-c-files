...
position p;
@@
 const struct typec_altmode_ops cocci_id@p ;
...
position p;
@@
 enum { DP_CONF_USB , DP_CONF_DFP_D , DP_CONF_UFP_D , DP_CONF_DUAL_D , } cocci_id@p ;
...
position p;
@@
 enum dp_state { DP_STATE_IDLE , DP_STATE_ENTER , DP_STATE_UPDATE , DP_STATE_CONFIGURE , DP_STATE_EXIT , } cocci_id@p ;
...
position p;
@@
 const struct typec_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct dp_altmode {  struct typec_displayport_data data ;  enum dp_state state ;  struct mutex lock ;  struct work_struct work ;  struct typec_altmode * alt ;  const struct typec_altmode * port ; } cocci_id@p ;
...
position p;
@@
 struct typec_altmode_driver cocci_id@p ;
