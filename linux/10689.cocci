...
position p;
@@
 struct gpio_desc * cocci_id@p [ U8_MAX + 1 ] ;
...
typedef u8;
@@
 const u8 * ( * cocci_id@p ) ( struct intel_dsi * intel_dsi , const u8 * data ) ;
...
typedef bool,u16;
@@
 struct gpio_map {  u16 base_offset ;  bool init ; } cocci_id@p ;
...
position p;
@@
 const fn_mipi_elem_exec cocci_id@p [ ] ;
