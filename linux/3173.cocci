...
typedef u16;
@@
 struct jc42_chips {  u16 manid ;  u16 devid ;  u16 devid_mask ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ t_num_temp ] ;
...
typedef bool,u16;
@@
 struct jc42_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool extended ;  bool valid ;  unsigned long last_updated ;  u16 orig_config ;  u16 config ;  u16 temp [ t_num_temp ] ; } cocci_id@p ;
...
position p;
@@
 const struct jc42_data * cocci_id@p ;
