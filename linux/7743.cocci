...
typedef u8;
@@
 struct lpss8250 {  struct dw8250_port_data data ;  struct lpss8250_board * board ;  struct dw_dma_chip dma_chip ;  struct dw_dma_slave dma_param ;  u8 dma_maxburst ; } cocci_id@p ;
...
position p;
@@
 const struct lpss8250_board cocci_id@p ;
...
position p;
@@
 struct dw8250_port_data * cocci_id@p ;
...
position p;
@@
 struct dw_dma_slave * cocci_id@p ;
...
position p;
@@
 const struct dw_dma_platform_data cocci_id@p ;
...
position p;
@@
 struct lpss8250_board {  unsigned long freq ;  unsigned int base_baud ;  int ( * setup ) ( struct lpss8250 * , struct uart_port * p ) ;  void ( * exit ) ( struct lpss8250 * ) ; } cocci_id@p ;
...
position p;
@@
 struct lpss8250_board * cocci_id@p ;
