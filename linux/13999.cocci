...
position p;
@@
 enum mtk_fields { MTK_CHK_PERIOD , MTK_HW_PERIOD , } cocci_id@p ;
...
position p;
@@
 enum mtk_regs { MTK_IRCLR_REG , MTK_CHKDATA_REG , MTK_IRINT_EN_REG , MTK_IRINT_CLR_REG , } cocci_id@p ;
...
position p;
@@
 const struct mtk_ir_data cocci_id@p ;
...
typedef u8,u32;
@@
 struct mtk_field_type {  u32 reg ;  u8 offset ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_field_type cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct mtk_ir_data {  const u32 * regs ;  const struct mtk_field_type * fields ;  u8 div ;  u8 ok_count ;  u32 hw_period ; } cocci_id@p ;
...
position p;
@@
 struct mtk_ir {  struct device * dev ;  struct rc_dev * rc ;  void __iomem * base ;  int irq ;  struct clk * clk ;  struct clk * bus ;  const struct mtk_ir_data * data ; } cocci_id@p ;
