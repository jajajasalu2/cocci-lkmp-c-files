...
position p;
@@
 const struct r820t_freq_range * cocci_id@p ;
...
typedef u8,u32;
@@
 struct r820t_freq_range {  u32 freq ;  u8 open_d ;  u8 rf_mux_ploy ;  u8 tf_c ;  u8 xtal_cap20p ;  u8 xtal_cap10p ;  u8 xtal_cap0p ;  u8 imr_mem ; } cocci_id@p ;
...
position p;
@@
 struct r820t_sect_type * cocci_id@p ;
...
@@
 struct r820t_priv {  struct list_head hybrid_tuner_instance_list ;  const struct r820t_config * cfg ;  struct tuner_i2c_props i2c_props ;  struct mutex lock ;  u8 regs [ NUM_REGS ] ;  u8 buf [ NUM_REGS + 1 ] ;  enum xtal_cap_value xtal_cap_sel ;  u16 pll ;  u32 int_freq ;  u8 fil_cal_code ;  bool imr_done ;  bool has_lock ;  bool init_done ;  struct r820t_sect_type imr_data [ NUM_IMR ] ;  u32 delsys ;  enum v4l2_tuner_type type ;  v4l2_std_id std ;  u32 bw ; } cocci_id@p ;
...
position p;
@@
 struct r820t_sect_type cocci_id@p [ 3 ] ;
...
typedef u8,u16;
@@
 struct r820t_sect_type {  u8 phase_y ;  u8 gain_x ;  u16 value ; } cocci_id@p ;
...
position p;
@@
 enum xtal_cap_value { XTAL_LOW_CAP_30P = 0 , XTAL_LOW_CAP_20P , XTAL_LOW_CAP_10P , XTAL_LOW_CAP_0P , XTAL_HIGH_CAP_0P , } cocci_id@p ;
...
position p;
@@
 struct r820t_sect_type cocci_id@p [ 5 ] ;
