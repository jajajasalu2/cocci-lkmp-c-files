...
position p;
@@
 struct oxnas_nand_ctrl * cocci_id@p ;
...
position p;
@@
 struct oxnas_nand_ctrl {  struct nand_controller base ;  void __iomem * io_base ;  struct clk * clk ;  struct nand_chip * chips [ OXNAS_NAND_MAX_CHIPS ] ; } cocci_id@p ;
