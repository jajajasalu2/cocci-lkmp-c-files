...
position p;
@@
 struct nv17_tv_norm_params cocci_id@p [ NUM_TV_NORMS ] ;
...
position p;
@@
 const char * const cocci_id@p [ NUM_TV_NORMS ] ;
...
typedef int64_t;
@@
 struct filter_params {  int64_t k1 ;  int64_t ki ;  int64_t ki2 ;  int64_t ki3 ;  int64_t kr ;  int64_t kir ;  int64_t ki2r ;  int64_t ki3r ;  int64_t kf ;  int64_t kif ;  int64_t ki2f ;  int64_t ki3f ;  int64_t krf ;  int64_t kirf ;  int64_t ki2rf ;  int64_t ki3rf ; } cocci_id@p [ 2 ] [ 4 ] ;
