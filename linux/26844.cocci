...
position p;
@@
 struct reiserfs_inode_info cocci_id@p ;
...
position p;
@@
 struct reiserfs_sb_info * cocci_id@p ;
...
typedef arg_desc_t;
@@
 struct {  char * option_name ;  int arg_required ;  const arg_desc_t * values ;  int setmask ;  int clrmask ; } cocci_id@p ;
...
position p;
@@
 const struct in_core_key cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * , int , int , const struct path * ) ;
...
position p;
@@
 struct {  char * value ;  int setmask ;  int clrmask ; } cocci_id@p ;
...
position p;
@@
 struct reiserfs_iget_args cocci_id@p ;
...
position p;
@@
 struct reiserfs_de_head * cocci_id@p ;
...
position p;
@@
 struct reiserfs_key cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ REISERFS_MAXQUOTAS ] ;
...
position p;
@@
 int cocci_id@p [ REISERFS_MAXQUOTAS ] ;
...
position p;
@@
 struct reiserfs_dir_entry cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct super_block * s , int * flags , char * data ) ;
