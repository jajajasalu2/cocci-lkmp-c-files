...
symbol cocci_id;
position p;
typedef osd_raw_window_t;
@@
 osd_raw_window_t cocci_id@p [ 8 ] ;
...
position p;
@@
 enum av7110_osd_palette_type cocci_id@p [ 8 ] ;
...
position p;
@@
 enum av7110_osd_palette_type cocci_id@p ;
