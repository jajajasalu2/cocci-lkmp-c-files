...
position p;
@@
 struct act8865_regulator_data * cocci_id@p ;
...
position p;
@@
 struct act8865 {  struct regmap * regmap ;  int off_reg ;  int off_mask ; } cocci_id@p ;
...
position p;
@@
 struct act8865_platform_data * cocci_id@p ;
