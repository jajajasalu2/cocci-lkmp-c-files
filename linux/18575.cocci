...
typedef dma_addr_t;
@@
 struct iomd_dma {  struct dma_struct dma ;  void __iomem * base ;  int irq ;  unsigned int state ;  dma_addr_t cur_addr ;  unsigned int cur_len ;  dma_addr_t dma_addr ;  unsigned int dma_len ; } cocci_id@p ;
...
position p;
@@
 struct floppy_dma {  struct dma_struct dma ;  unsigned int fiq ; } cocci_id@p ;
