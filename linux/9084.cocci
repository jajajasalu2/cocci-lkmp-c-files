...
@@
 struct mlx5_fc {  struct list_head list ;  struct llist_node addlist ;  struct llist_node dellist ;  u64 lastpackets ;  u64 lastbytes ;  struct mlx5_fc_bulk * bulk ;  u32 id ;  bool aging ;  struct mlx5_fc_cache cache ____cacheline_aligned_in_smp ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5_fc_pool * fc_pool ) ;
...
position p;
@@
 struct mlx5_fc_bulk cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5_fc_pool * fc_pool , struct mlx5_fc * fc ) ;
...
typedef u32;
@@
 struct mlx5_fc_bulk {  struct list_head pool_list ;  u32 base_id ;  int bulk_len ;  unsigned long * bitmask ;  struct mlx5_fc fcs [ 0 ] ; } cocci_id@p ;
...
typedef u64;
@@
 struct mlx5_fc_cache {  u64 packets ;  u64 bytes ;  u64 lastuse ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5_fc_pool * fc_pool , struct mlx5_core_dev * dev ) ;
...
position p;
@@
 struct mlx5_fc_cache cocci_id@p ;
...
position p;
@@
 struct mlx5_fc_pool * cocci_id@p ;
...
position p;
@@
 struct mlx5_fc * cocci_id@p ( struct mlx5_fc_pool * fc_pool ) ;
...
position p;
@@
 struct mlx5_fc_stats * cocci_id@p ;
