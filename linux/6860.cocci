...
position p;
@@
 void cocci_id@p ( struct fc_seq * seq , struct fc_frame * fp , void * arg ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct bnx2fc_els_cb_arg * cb_arg ) ;
...
position p;
@@
 struct bnx2fc_els_cb_arg * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct bnx2fc_rport * tgt , unsigned int op , void * data , u32 data_len , void ( * cb_func ) ( struct bnx2fc_els_cb_arg * cb_arg ) , struct bnx2fc_els_cb_arg * cb_arg , u32 timer_msec ) ;
