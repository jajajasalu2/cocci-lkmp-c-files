...
typedef u8;
@@
 struct {  u8 port ;  u8 cs ; } cocci_id@p ;
...
typedef __le32;
@@
 struct {  __le32 speed ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 count ;  u8 frame_sizes [ 36 ] ; } * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct dln2_spi {  struct platform_device * pdev ;  struct spi_master * master ;  u8 port ;  void * buf ;  u8 bpw ;  u32 speed ;  u16 mode ;  u8 cs ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 port ;  u8 bpw ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 port ;  u8 wait_for_completion ; } cocci_id@p ;
...
position p;
@@
 struct {  __le16 cs_count ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 port ;  u8 mode ; } cocci_id@p ;
