...
typedef u8,u16;
@@
 struct micro_battery {  struct ipaq_micro * micro ;  struct workqueue_struct * wq ;  struct delayed_work update ;  u8 ac ;  u8 chemistry ;  unsigned int voltage ;  u16 temperature ;  u8 flag ; } cocci_id@p ;
...
position p;
@@
 struct ipaq_micro_msg cocci_id@p ;
...
position p;
@@
 struct micro_battery cocci_id@p ;
