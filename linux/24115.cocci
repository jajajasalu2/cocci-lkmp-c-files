...
position p;
@@
 const struct rpc_xprt_iter_ops * cocci_id@p ;
...
position p;
@@
 struct rpc_xprt * ( * cocci_id@p ) ( struct rpc_xprt_switch * xps , const struct rpc_xprt * cur ) ;
...
position p;
@@
 struct rpc_xprt * ( * cocci_id@p ) ( struct rpc_xprt_iter * ) ;
...
symbol cocci_id;
position p;
typedef xprt_switch_find_xprt_t;
@@
 xprt_switch_find_xprt_t cocci_id@p ;
...
position p;
@@
 const struct rpc_xprt * cocci_id@p ;
...
position p;
@@
 const struct rpc_xprt_iter * cocci_id@p ;
