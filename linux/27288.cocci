...
position p;
@@
 int ( * cocci_id@p ) ( struct inode * , unsigned long , void * ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct inode * , struct timespec64 * , int ) ;
...
symbol cocci_id;
position p;
typedef inodes_stat_t;
@@
 struct inodes_stat_t cocci_id@p ;
...
position p;
@@
 const struct fsxattr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct inode * , void * ) ;
