...
position p;
@@
 enum cpm_clk_target cocci_id@p ;
...
@@
 struct cpm1_gpio16_chip {  struct of_mm_gpio_chip mm_gc ;  spinlock_t lock ;  u16 cpdata ;  int irq [ 16 ] ; } cocci_id@p ;
...
@@
 struct cpm1_gpio32_chip {  struct of_mm_gpio_chip mm_gc ;  spinlock_t lock ;  u32 cpdata ; } cocci_id@p ;
...
position p;
@@
 struct cpm1_gpio32_chip cocci_id@p ;
...
position p;
@@
 struct cpm1_gpio16_chip cocci_id@p ;
...
position p;
@@
 struct of_mm_gpio_chip * cocci_id@p ;
