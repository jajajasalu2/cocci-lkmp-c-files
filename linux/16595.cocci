...
position p;
@@
 struct raw3270_request * cocci_id@p ;
...
position p;
@@
 struct tty3270_line * cocci_id@p ;
...
position p;
@@
 struct tty3270_cell {  unsigned char character ;  unsigned char highlight ;  unsigned char f_color ; } cocci_id@p ;
...
position p;
@@
 struct tty3270_cell * cocci_id@p ;
...
position p;
@@
 struct tty3270_line {  struct tty3270_cell * cells ;  int len ; } cocci_id@p ;
...
position p;
@@
 struct raw3270_view * cocci_id@p ;
...
position p;
@@
 enum { ESnormal , ESesc , ESsquare , ESgetpars , } cocci_id@p ;
...
position p;
@@
 struct raw3270_notifier cocci_id@p ;
