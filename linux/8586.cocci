...
typedef u8,u32;
@@
 struct mace_frame {  u8 rcvcnt ;  u8 pad1 ;  u8 rcvsts ;  u8 pad2 ;  u8 rntpc ;  u8 pad3 ;  u8 rcvcc ;  u8 pad4 ;  u32 pad5 ;  u32 pad6 ;  u8 data [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 volatile struct mace * cocci_id@p ;
