...
position p;
@@
 int cocci_id@p ( struct fs_context * fc ) ;
...
position p;
@@
 struct afs_fs_context cocci_id@p ;
...
position p;
@@
 enum afs_param { Opt_autocell , Opt_dyn , Opt_flock , Opt_source , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct seq_file * m , struct dentry * root ) ;
