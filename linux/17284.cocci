...
position p;
@@
 struct ppc4xx_pciex_hwops cocci_id@p ;
...
position p;
@@
 struct ppc4xx_pciex_port cocci_id@p ;
...
typedef bool;
@@
 struct ppc4xx_pciex_hwops {  bool want_sdr ;  int ( * core_init ) ( struct device_node * np ) ;  int ( * port_init_hw ) ( struct ppc4xx_pciex_port * port ) ;  int ( * setup_utl ) ( struct ppc4xx_pciex_port * port ) ;  void ( * check_link ) ( struct ppc4xx_pciex_port * port ) ; } cocci_id@p ;
...
typedef dcr_host_t;
@@
 struct ppc4xx_pciex_port {  struct pci_controller * hose ;  struct device_node * node ;  unsigned int index ;  int endpoint ;  int link ;  int has_ibpre ;  unsigned int sdr_base ;  dcr_host_t dcrs ;  struct resource cfg_space ;  struct resource utl_regs ;  void __iomem * utl_base ; } cocci_id@p ;
