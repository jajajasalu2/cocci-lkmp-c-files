...
position p;
@@
 enum { EV_PH_ACTIVATE , EV_PH_DEACTIVATE , EV_RESET_IND , EV_DEACT_CNF , EV_DEACT_IND , EV_POWER_UP , EV_ANYSIG_IND , EV_INFO2_IND , EV_INFO4_IND , EV_TIMER_DEACT , EV_TIMER_ACT , EV_TIMER3 , } cocci_id@p ;
...
position p;
@@
 dchannel_l1callback * cocci_id@p ;
...
position p;
@@
 enum { ST_L1_F2 , ST_L1_F3 , ST_L1_F4 , ST_L1_F5 , ST_L1_F6 , ST_L1_F7 , ST_L1_F8 , } cocci_id@p ;
...
typedef u_long;
@@
 struct layer1 {  u_long Flags ;  struct FsmInst l1m ;  struct FsmTimer timer3 ;  struct FsmTimer timerX ;  int delay ;  int t3_value ;  struct dchannel * dch ;  dchannel_l1callback * dcb ; } cocci_id@p ;
