...
position p;
@@
 enum infineon_tpm_register { WRFIFO = 0x00 , RDFIFO = 0x01 , STAT = 0x02 , CMD = 0x03 , } cocci_id@p ;
...
position p;
@@
 enum infineon_tpm_command_bits { CMD_DIS = 0x00 , CMD_LP = 0x01 , CMD_RES = 0x02 , CMD_IRQC = 0x06 , } cocci_id@p ;
...
position p;
@@
 struct tpm_inf_dev {  int iotype ;  void __iomem * mem_base ;  unsigned long map_base ;  unsigned long map_size ;  unsigned int index_off ;  unsigned int data_regs ;  unsigned int data_size ;  unsigned int config_port ;  unsigned int config_size ; } cocci_id@p ;
...
position p;
@@
 enum infineon_tpm_values { CHIP_ID1 = 0x20 , CHIP_ID2 = 0x21 , TPM_DAR = 0x30 , RESET_LP_IRQC_DISABLE = 0x41 , ENABLE_REGISTER_PAIR = 0x55 , IOLIMH = 0x60 , IOLIML = 0x61 , DISABLE_REGISTER_PAIR = 0xAA , IDVENL = 0xF1 , IDVENH = 0xF2 , IDPDL = 0xF3 , IDPDH = 0xF4 , } cocci_id@p ;
...
position p;
@@
 enum infineon_tpm_status_bits { STAT_XFE = 0x00 , STAT_LPA = 0x01 , STAT_FOK = 0x02 , STAT_TOK = 0x03 , STAT_IRQA = 0x06 , STAT_RDA = 0x07 , } cocci_id@p ;
