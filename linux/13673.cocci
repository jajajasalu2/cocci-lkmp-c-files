...
position p;
@@
 struct vb2_threadio_data * cocci_id@p ;
...
position p;
@@
 unsigned cocci_id@p [ VB2_MAX_PLANES ] ;
...
position p;
@@
 struct vb2_plane cocci_id@p [ VB2_MAX_PLANES ] ;
...
position p;
@@
 const unsigned cocci_id@p [ VB2_MAX_PLANES ] ;
...
position p;
@@
 enum media_request_state cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vb2_queue * q ) ;
...
position p;
@@
 int cocci_id@p ( struct vb2_queue * q , unsigned int index , void * pb , struct media_request * req ) ;
...
position p;
@@
 void cocci_id@p ( struct vb2_queue * q ) ;
...
position p;
@@
 struct vb2_fileio_buf {  void * vaddr ;  unsigned int size ;  unsigned int pos ;  unsigned int queued : 1 ; } cocci_id@p ;
...
typedef bool;
@@
 struct vb2_threadio_data {  struct task_struct * thread ;  vb2_thread_fnc fnc ;  void * priv ;  bool stop ; } cocci_id@p ;
...
position p;
@@
 struct vb2_fileio_buf * cocci_id@p ;
...
position p;
@@
 struct vb2_fileio_data * cocci_id@p ;
...
position p;
@@
 struct vb2_fileio_data {  unsigned int count ;  unsigned int type ;  unsigned int memory ;  struct vb2_fileio_buf bufs [ VB2_MAX_FRAME ] ;  unsigned int cur_index ;  unsigned int initial_index ;  unsigned int q_count ;  unsigned int dq_count ;  unsigned read_once : 1 ;  unsigned write_immediately : 1 ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vb2_queue * q , int read ) ;
