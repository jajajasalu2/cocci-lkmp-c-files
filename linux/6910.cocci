...
typedef u8,bool;
@@
 struct ds1wm_data {  void __iomem * map ;  unsigned int bus_shift ;  bool is_hw_big_endian ;  struct platform_device * pdev ;  const struct mfd_cell * cell ;  int irq ;  int slave_present ;  void * reset_complete ;  void * read_complete ;  void * write_complete ;  int read_error ;  u8 read_byte ;  u8 int_en_reg_none ;  unsigned int reset_recover_delay ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned long freq ;  unsigned long divisor ; } cocci_id@p [ ] ;
