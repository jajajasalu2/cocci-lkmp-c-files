...
position p;
@@
 struct stp_task_context cocci_id@p ;
...
position p;
@@
 enum sas_open_rej_reason cocci_id@p ;
...
position p;
@@
 struct scu_sgl_element_pair * cocci_id@p ;
...
position p;
@@
 struct isci_stp_pio_sgl * cocci_id@p ;
...
position p;
@@
 struct sata_fis_data * cocci_id@p ;
...
position p;
@@
 struct scu_task_context * cocci_id@p ;
...
position p;
@@
 enum service_response cocci_id@p ;
...
position p;
@@
 struct isci_stp_request * cocci_id@p ;
...
position p;
@@
 struct isci_request * cocci_id@p ;
...
position p;
@@
 struct sci_base_state_machine * cocci_id@p ;
...
position p;
@@
 struct scu_sgl_element * cocci_id@p ;
...
position p;
@@
 enum sci_base_request_states cocci_id@p ;
...
position p;
@@
 const struct sci_base_state cocci_id@p [ ] ;
...
position p;
@@
 struct isci_remote_device * cocci_id@p ;
