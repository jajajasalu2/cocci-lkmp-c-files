...
@@
 struct zx_i2s_info {  struct snd_dmaengine_dai_dma_data dma_playback ;  struct snd_dmaengine_dai_dma_data dma_capture ;  struct clk * dai_wclk ;  struct clk * dai_pclk ;  void __iomem * reg_base ;  int master ;  resource_size_t mapbase ; } cocci_id@p ;
