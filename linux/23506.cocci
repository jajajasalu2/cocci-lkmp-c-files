...
position p;
@@
 const struct sst_adsp_memregion cocci_id@p [ ] ;
...
position p;
@@
 enum sst_ram_type { SST_BYT_IRAM = 1 , SST_BYT_DRAM = 2 , SST_BYT_CACHE = 3 , } cocci_id@p ;
...
typedef u32;
@@
 struct dma_block_info {  enum sst_ram_type type ;  u32 size ;  u32 ram_offset ;  u32 rsvd ; } cocci_id@p ;
...
typedef u32;
@@
 struct sst_adsp_memregion {  u32 start ;  u32 end ;  int blocks ;  enum sst_mem_type type ; } cocci_id@p ;
...
typedef u32;
@@
 struct sst_byt_fw_module_header {  unsigned char signature [ SST_BYT_FW_SIGNATURE_SIZE ] ;  u32 mod_size ;  u32 blocks ;  u32 type ;  u32 entry_point ; } cocci_id@p ;
...
typedef u32;
@@
 struct fw_header {  unsigned char signature [ SST_BYT_FW_SIGNATURE_SIZE ] ;  u32 file_size ;  u32 modules ;  u32 file_format ;  u32 reserved [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct sst_module_template cocci_id@p ;
...
position p;
@@
 struct sst_byt_fw_module_header * cocci_id@p ;
...
position p;
@@
 struct dma_block_info * cocci_id@p ;
