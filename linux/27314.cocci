...
position p;
@@
 const struct dfs_cache_entry * cocci_id@p ;
...
position p;
@@
 struct dfs_cache_vol_info * cocci_id@p ;
...
position p;
@@
 struct dfs_cache {  struct mutex dc_lock ;  struct nls_table * dc_nlsc ;  struct list_head dc_vol_list ;  int dc_ttl ;  struct delayed_work dc_refresh ; } cocci_id@p ;
...
position p;
@@
 const struct dfs_info3_param * cocci_id@p ;
...
position p;
@@
 struct hlist_head cocci_id@p [ DFS_CACHE_HTABLE_SIZE ] ;
...
position p;
@@
 struct dfs_cache_entry cocci_id@p ;
...
position p;
@@
 struct dfs_cache_vol_info {  char * vi_fullpath ;  struct smb_vol vi_vol ;  char * vi_mntdata ;  struct list_head vi_list ; } cocci_id@p ;
...
position p;
@@
 struct dfs_cache_entry {  struct hlist_node ce_hlist ;  const char * ce_path ;  int ce_ttl ;  int ce_srvtype ;  int ce_flags ;  struct timespec64 ce_etime ;  int ce_path_consumed ;  int ce_numtgts ;  struct list_head ce_tlist ;  struct dfs_cache_tgt * ce_tgthint ;  struct rcu_head ce_rcu ; } cocci_id@p ;
...
position p;
@@
 struct dfs_cache_tgt {  char * t_name ;  struct list_head t_list ; } cocci_id@p ;
...
position p;
@@
 struct dfs_cache_tgt * cocci_id@p ;
