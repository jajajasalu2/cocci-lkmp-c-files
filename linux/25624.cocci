...
position p;
@@
 struct intel_pt_params cocci_id@p ;
...
position p;
@@
 struct auxtrace_queues * cocci_id@p ;
...
position p;
@@
 struct perf_record_auxtrace_info * cocci_id@p ;
...
position p;
@@
 struct perf_synth_intel_pwrx cocci_id@p ;
...
position p;
@@
 struct branch_entry * cocci_id@p ;
...
position p;
@@
 struct intel_pt_insn * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ INTEL_PT_INSN_BUF_SZ ] ;
...
position p;
@@
 struct intel_pt_cache_entry * cocci_id@p ;
...
position p;
@@
 struct intel_pt_buffer * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ sizeof ( sample . intr_regs . mask ) ] ;
...
position p;
@@
 enum intel_pt_pkt_ctx cocci_id@p ;
...
position p;
@@
 struct perf_synth_intel_mwait cocci_id@p ;
...
position p;
@@
 struct branch_stack cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ INTEL_PT_PKT_DESC_MAX ] ;
...
typedef u64;
@@
 struct dummy_branch_stack {  u64 nr ;  struct branch_entry entries ; } cocci_id@p ;
...
position p;
@@
 struct intel_pt_pkt cocci_id@p ;
...
position p;
@@
 struct intel_pt_queue * cocci_id@p ;
...
position p;
@@
 enum switch_state { INTEL_PT_SS_NOT_TRACING , INTEL_PT_SS_UNKNOWN , INTEL_PT_SS_TRACING , INTEL_PT_SS_EXPECTING_SWITCH_EVENT , INTEL_PT_SS_EXPECTING_SWITCH_IP , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_AUXTRACE_ERROR_MSG ] ;
...
position p;
@@
 struct perf_synth_intel_pwre cocci_id@p ;
...
position p;
@@
 struct dummy_branch_stack cocci_id@p ;
...
typedef u64;
@@
 union {  struct branch_flags flags ;  u64 result ; } cocci_id@p ;
...
position p;
@@
 struct ip_callchain cocci_id@p ;
...
position p;
@@
 struct itrace_synth_opts * cocci_id@p ;
...
position p;
@@
 struct perf_synth_intel_cbr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef intel_pt_lookahead_cb_t;
@@
 intel_pt_lookahead_cb_t cocci_id@p ;
...
typedef u64,int32_t;
@@
 struct intel_pt_cache_entry {  struct auxtrace_cache_entry entry ;  u64 insn_cnt ;  u64 byte_cnt ;  enum intel_pt_insn_op op ;  enum intel_pt_insn_branch branch ;  int length ;  int32_t rel ;  char insn [ INTEL_PT_INSN_BUF_SZ ] ; } cocci_id@p ;
...
typedef u64;
@@
 struct range {  u64 start ;  u64 end ; } cocci_id@p ;
...
position p;
@@
 const struct intel_pt * cocci_id@p ;
...
position p;
@@
 struct {  struct branch_stack br_stack ;  struct branch_entry entries [ LBRS_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct intel_pt_synth cocci_id@p ;
...
position p;
@@
 const struct intel_pt_blk_items * cocci_id@p ;
...
position p;
@@
 struct auxtrace_queue * cocci_id@p ;
...
position p;
@@
 struct perf_synth_intel_ptwrite cocci_id@p ;
...
position p;
@@
 struct auxtrace_buffer * cocci_id@p ;
...
position p;
@@
 struct auxtrace_cache * cocci_id@p ;
...
position p;
@@
 struct intel_pt_synth {  struct perf_tool dummy_tool ;  struct perf_session * session ; } cocci_id@p ;
...
position p;
@@
 struct perf_synth_intel_exstop cocci_id@p ;
...
position p;
@@
 const struct intel_pt_state * cocci_id@p ;
...
@@
 struct intel_pt {  struct auxtrace auxtrace ;  struct auxtrace_queues queues ;  struct auxtrace_heap heap ;  u32 auxtrace_type ;  struct perf_session * session ;  struct machine * machine ;  struct evsel * switch_evsel ;  struct thread * unknown_thread ;  bool timeless_decoding ;  bool sampling_mode ;  bool snapshot_mode ;  bool per_cpu_mmaps ;  bool have_tsc ;  bool data_queued ;  bool est_tsc ;  bool sync_switch ;  bool mispred_all ;  int have_sched_switch ;  u32 pmu_type ;  u64 kernel_start ;  u64 switch_ip ;  u64 ptss_ip ;  struct perf_tsc_conversion tc ;  bool cap_user_time_zero ;  struct itrace_synth_opts synth_opts ;  bool sample_instructions ;  u64 instructions_sample_type ;  u64 instructions_id ;  bool sample_branches ;  u32 branches_filter ;  u64 branches_sample_type ;  u64 branches_id ;  bool sample_transactions ;  u64 transactions_sample_type ;  u64 transactions_id ;  bool sample_ptwrites ;  u64 ptwrites_sample_type ;  u64 ptwrites_id ;  bool sample_pwr_events ;  u64 pwr_events_sample_type ;  u64 mwait_id ;  u64 pwre_id ;  u64 exstop_id ;  u64 pwrx_id ;  u64 cbr_id ;  bool sample_pebs ;  struct evsel * pebs_evsel ;  u64 tsc_bit ;  u64 mtc_bit ;  u64 mtc_freq_bits ;  u32 tsc_ctc_ratio_n ;  u32 tsc_ctc_ratio_d ;  u64 cyc_bit ;  u64 noretcomp_bit ;  unsigned max_non_turbo_ratio ;  unsigned cbr2khz ;  unsigned long num_events ;  char * filter ;  struct addr_filters filts ;  struct range * time_ranges ;  unsigned int range_cnt ; } cocci_id@p ;
