...
position p;
@@
 const struct qce_skcipher_def cocci_id@p [ ] ;
...
position p;
@@
 struct qce_cipher_ctx cocci_id@p ;
...
position p;
@@
 struct qce_cipher_reqctx cocci_id@p ;
...
position p;
@@
 struct qce_skcipher_def {  unsigned long flags ;  const char * name ;  const char * drv_name ;  unsigned int blocksize ;  unsigned int ivsize ;  unsigned int min_keysize ;  unsigned int max_keysize ; } cocci_id@p ;
