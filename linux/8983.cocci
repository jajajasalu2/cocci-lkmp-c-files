...
position p;
@@
 struct reg_val {  unsigned short mmd_addr ;  unsigned short reg_addr ;  unsigned short clear_bits ;  unsigned short set_bits ; } cocci_id@p ;
...
position p;
@@
 const struct cphy_ops cocci_id@p ;
...
position p;
@@
 enum { MODULE_DEV_ADDR = 0xa0 , SFF_DEV_ADDR = 0xa2 , } cocci_id@p ;
