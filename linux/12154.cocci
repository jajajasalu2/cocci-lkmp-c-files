...
position p;
@@
 struct nv_sim_state * cocci_id@p ;
...
position p;
@@
 struct nv_fifo_info * cocci_id@p ;
...
position p;
@@
 struct nv_fifo_info {  int lwm ;  int burst ; } cocci_id@p ;
...
position p;
@@
 struct nv_sim_state {  int pclk_khz ;  int mclk_khz ;  int nvclk_khz ;  int bpp ;  int mem_page_miss ;  int mem_latency ;  int memory_type ;  int memory_width ;  int two_heads ; } cocci_id@p ;
