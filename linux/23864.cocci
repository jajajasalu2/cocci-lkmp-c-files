...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_QFQ_MAX + 1 ] ;
...
position p;
@@
 struct tc_qfq_stats cocci_id@p ;
...
position p;
@@
 const struct qfq_group * cocci_id@p ;
...
position p;
@@
 enum qfq_state { ER , IR , EB , IB , QFQ_MAX_STATE , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qfq_sched * , struct qfq_aggregate * ) ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_QFQ_MAX + 1 ] ;
...
position p;
@@
 void cocci_id@p ( struct qfq_sched * q , struct qfq_aggregate * agg ) ;
...
position p;
@@
 struct qfq_aggregate cocci_id@p ;
...
position p;
@@
 struct qfq_aggregate * cocci_id@p ( struct qfq_sched * ) ;
...
position p;
@@
 enum update_reason { enqueue , requeue , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qfq_sched * , struct qfq_aggregate * , enum update_reason ) ;
...
position p;
@@
 struct qfq_class {  struct Qdisc_class_common common ;  unsigned int filter_cnt ;  struct gnet_stats_basic_packed bstats ;  struct gnet_stats_queue qstats ;  struct net_rate_estimator __rcu * rate_est ;  struct Qdisc * qdisc ;  struct list_head alist ;  struct qfq_aggregate * agg ;  int deficit ; } cocci_id@p ;
