...
position p;
@@
 struct wm8350_data {  struct wm8350 * wm8350 ;  struct wm8350_output out1 ;  struct wm8350_output out2 ;  struct wm8350_jack_data hpl ;  struct wm8350_jack_data hpr ;  struct wm8350_jack_data mic ;  struct regulator_bulk_data supplies [ ARRAY_SIZE ( supply_names ) ] ;  int fll_freq_out ;  int fll_freq_in ;  struct delayed_work pga_work ; } cocci_id@p ;
...
position p;
@@
 struct _fll_div {  int div ;  int n ;  int k ;  int ratio ; } cocci_id@p ;
...
position p;
@@
 struct wm8350_audio_platform_data * cocci_id@p ;
...
position p;
@@
 struct wm8350_output * cocci_id@p ;
...
typedef u16;
@@
 struct wm8350_output {  u16 active ;  u16 left_vol ;  u16 right_vol ;  u16 ramp ;  u16 mute ; } cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( capture_sd_tlv , 
							    0 , 12 , 
...
position p;
@@
 struct wm8350_jack_data {  struct snd_soc_jack * jack ;  struct delayed_work work ;  int report ;  int short_report ; } cocci_id@p ;
...
position p;
@@
 struct wm8350_jack_data * cocci_id@p ;
