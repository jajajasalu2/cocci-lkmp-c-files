...
position p;
@@
 struct fcoe_rdev_entry * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct csio_rnode * , enum csio_rn_ev ) ;
...
position p;
@@
 void cocci_id@p ( struct csio_rnode * ) ;
...
position p;
@@
 int cocci_id@p ( struct csio_rnode * , struct csio_lnode * ) ;
