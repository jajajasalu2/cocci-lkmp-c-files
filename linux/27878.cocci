...
typedef bool;
@@
 struct lib_info {  struct {  unsigned long start_code ;  unsigned long start_data ;  unsigned long start_brk ;  unsigned long text_len ;  unsigned long entry ;  unsigned long build_date ;  bool loaded ; } lib_list [ MAX_SHARED_LIBS ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef flat_v2_reloc_t;
@@
 flat_v2_reloc_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int id , struct lib_info * p ) ;
