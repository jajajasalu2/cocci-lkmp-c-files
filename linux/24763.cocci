...
position p;
@@
 int ( * cocci_id@p ) ( struct sk_buff * skb , unsigned int protoff , struct nf_conn * ct , enum ip_conntrack_info ctinfo ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct nlattr * attr , struct nf_conn * ct ) ;
...
position p;
@@
 struct nf_conntrack_nat_helper * cocci_id@p ;
...
position p;
@@
 const struct nf_ct_ext_type cocci_id@p ;
...
position p;
@@
 struct nf_conntrack_tuple_mask cocci_id@p ;
