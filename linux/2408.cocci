...
typedef dma_addr_t;
@@
 struct mtk_uart_apdma_desc {  struct virt_dma_desc vd ;  dma_addr_t addr ;  unsigned int avail_len ; } cocci_id@p ;
...
position p;
@@
 struct mtk_uart_apdma_desc cocci_id@p ;
...
typedef bool;
@@
 struct mtk_uart_apdmadev {  struct dma_device ddev ;  struct clk * clk ;  bool support_33bits ;  unsigned int dma_requests ; } cocci_id@p ;
...
position p;
@@
 struct mtk_uart_apdmadev cocci_id@p ;
...
position p;
@@
 struct mtk_chan {  struct virt_dma_chan vc ;  struct dma_slave_config cfg ;  struct mtk_uart_apdma_desc * desc ;  enum dma_transfer_direction dir ;  void __iomem * base ;  unsigned int irq ;  unsigned int rx_status ; } cocci_id@p ;
