...
position p;
@@
 struct drm_amdgpu_bo_list_entry * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_cs_chunk_sem cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_bo_list_in cocci_id@p ;
...
position p;
@@
 struct amdgpu_cs_parser cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_fence cocci_id@p ;
...
position p;
@@
 struct amdgpu_cs_chunk cocci_id@p ;
...
position p;
@@
 union drm_amdgpu_fence_to_handle * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_cs_chunk_dep * cocci_id@p ;
...
position p;
@@
 struct drm_sched_entity * cocci_id@p ;
...
position p;
@@
 struct amdgpu_cs_post_dep * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_cs_chunk_syncobj cocci_id@p ;
...
position p;
@@
 union drm_amdgpu_cs * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_cs_chunk cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_cs_chunk_fence cocci_id@p ;
...
position p;
@@
 union drm_amdgpu_wait_cs * cocci_id@p ;
...
position p;
@@
 struct drm_sched_fence * cocci_id@p ;
...
position p;
@@
 union drm_amdgpu_wait_fences * cocci_id@p ;
...
position p;
@@
 struct drm_amdgpu_cs_chunk_ib * cocci_id@p ;
