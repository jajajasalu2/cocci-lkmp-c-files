...
position p;
@@
 struct padata_instance * * cocci_id@p ;
...
position p;
@@
 struct pcrypt_aead_ctx * cocci_id@p ;
...
position p;
@@
 struct pcrypt_instance_ctx * cocci_id@p ;
...
position p;
@@
 struct pcrypt_request * cocci_id@p ;
...
position p;
@@
 struct pcrypt_aead_ctx {  struct crypto_aead * child ;  unsigned int cb_cpu ; } cocci_id@p ;
...
typedef atomic_t;
@@
 struct pcrypt_instance_ctx {  struct crypto_aead_spawn spawn ;  atomic_t tfm_count ; } cocci_id@p ;
