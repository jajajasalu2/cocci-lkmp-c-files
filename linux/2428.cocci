...
position p;
@@
 struct bcom_fec_rx_var * cocci_id@p ;
...
position p;
@@
 struct bcom_fec_tx_inc * cocci_id@p ;
...
position p;
@@
 struct bcom_fec_rx_inc * cocci_id@p ;
...
typedef u32;
@@
 struct bcom_fec_tx_var {  u32 DRD ;  u32 fifo ;  u32 enable ;  u32 bd_base ;  u32 bd_last ;  u32 bd_start ;  u32 buffer_size ; } cocci_id@p ;
...
position p;
@@
 struct bcom_fec_priv * cocci_id@p ;
...
position p;
@@
 struct bcom_fec_tx_var * cocci_id@p ;
...
typedef s16,u16;
@@
 struct bcom_fec_tx_inc {  u16 pad0 ;  s16 incr_bytes ;  u16 pad1 ;  s16 incr_src ;  u16 pad2 ;  s16 incr_src_ma ; } cocci_id@p ;
...
typedef u32;
@@
 struct bcom_fec_rx_var {  u32 enable ;  u32 fifo ;  u32 bd_base ;  u32 bd_last ;  u32 bd_start ;  u32 buffer_size ; } cocci_id@p ;
...
typedef s16,u16;
@@
 struct bcom_fec_rx_inc {  u16 pad0 ;  s16 incr_bytes ;  u16 pad1 ;  s16 incr_dst ;  u16 pad2 ;  s16 incr_dst_ma ; } cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct bcom_fec_priv {  phys_addr_t fifo ;  int maxbufsize ; } cocci_id@p ;
