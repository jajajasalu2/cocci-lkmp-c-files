...
position p;
@@
 struct adis16080_chip_info {  int scale_val ;  int scale_val2 ; } cocci_id@p ;
...
position p;
@@
 enum { ID_ADIS16080 , ID_ADIS16100 , } cocci_id@p ;
...
position p;
@@
 struct adis16080_state {  struct spi_device * us ;  const struct adis16080_chip_info * info ;  struct mutex lock ;  __be16 buf ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct adis16080_state * cocci_id@p ;
...
position p;
@@
 const struct adis16080_chip_info cocci_id@p [ ] ;
