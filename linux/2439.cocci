...
position p;
@@
 struct sirfsoc_dma_desc cocci_id@p ;
...
typedef u32;
@@
 struct sirfsoc_dma_regs {  u32 ctrl [ SIRFSOC_DMA_CHANNELS ] ;  u32 interrupt_en ; } cocci_id@p ;
...
position p;
@@
 struct sirfsoc_dmadata cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sirfsoc_dma_chan {  struct dma_chan chan ;  struct list_head free ;  struct list_head prepared ;  struct list_head queued ;  struct list_head active ;  struct list_head completed ;  unsigned long happened_cyclic ;  unsigned long completed_cyclic ;  spinlock_t lock ;  int mode ; } cocci_id@p ;
...
@@
 struct sirfsoc_dma_desc {  struct dma_async_tx_descriptor desc ;  struct list_head node ;  int xlen ;  int ylen ;  int width ;  int dir ;  bool cyclic ;  bool chain ;  u32 addr ;  u64 chain_table [ SIRFSOC_DMA_TABLE_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct sirfsoc_dma_chan cocci_id@p ;
...
position p;
@@
 enum sirfsoc_dma_chain_flag { SIRFSOC_DMA_CHAIN_NORMAL = 0x01 , SIRFSOC_DMA_CHAIN_PAUSE = 0x02 , SIRFSOC_DMA_CHAIN_LOOP = 0x03 , SIRFSOC_DMA_CHAIN_END = 0x04 , } cocci_id@p ;
...
position p;
@@
 struct sirfsoc_dma_regs * cocci_id@p ;
