...
position p;
@@
 struct cpuidle_state cocci_id@p [ CPUIDLE_STATE_MAX ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct cpuidle_device * , struct cpuidle_driver * , int ) ;
...
typedef u64;
@@
 struct stop_psscr_table {  u64 val ;  u64 mask ; } cocci_id@p ;
