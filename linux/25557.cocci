...
position p;
@@
 struct hpp_dimension cocci_id@p [ ] ;
...
position p;
@@
 struct hpp_sort_entry cocci_id@p ;
...
position p;
@@
 struct hpp_dimension {  const char * name ;  struct perf_hpp_fmt * fmt ;  int taken ; } cocci_id@p ;
...
position p;
@@
 struct hpp_dynamic_entry * cocci_id@p ;
...
position p;
@@
 struct txbit {  unsigned flag ;  const char * name ;  int skip_for_len ; } cocci_id@p [ ] ;
...
position p;
@@
 struct hpp_sort_entry {  struct perf_hpp_fmt hpp ;  struct sort_entry * se ; } cocci_id@p ;
...
position p;
@@
 const struct thread * cocci_id@p ;
...
typedef bool;
@@
 struct hpp_dynamic_entry {  struct perf_hpp_fmt hpp ;  struct evsel * evsel ;  struct tep_format_field * field ;  unsigned dynamic_len ;  bool raw_trace ; } cocci_id@p ;
...
position p;
@@
 struct sort_dimension {  const char * name ;  struct sort_entry * entry ;  int taken ; } cocci_id@p ;
