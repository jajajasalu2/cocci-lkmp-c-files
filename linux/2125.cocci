...
position p;
@@
 struct isp1704_charger * cocci_id@p ;
...
position p;
@@
 struct isp1704_charger {  struct device * dev ;  struct power_supply * psy ;  struct power_supply_desc psy_desc ;  struct gpio_desc * enable_gpio ;  struct usb_phy * phy ;  struct notifier_block nb ;  struct work_struct work ;  char model [ 8 ] ;  unsigned present : 1 ;  unsigned online : 1 ;  unsigned current_max ; } cocci_id@p ;
