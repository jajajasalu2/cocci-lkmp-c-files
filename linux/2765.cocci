...
position p;
@@
 struct i2c_acpi_lookup * cocci_id@p ;
...
position p;
@@
 struct i2c_acpi_handler_data * cocci_id@p ;
...
@@
 struct i2c_acpi_lookup {  struct i2c_board_info * info ;  acpi_handle adapter_handle ;  acpi_handle device_handle ;  acpi_handle search_handle ;  int n ;  int index ;  u32 speed ;  u32 min_speed ;  u32 force_speed ; } cocci_id@p ;
...
position p;
@@
 struct i2c_acpi_handler_data {  struct acpi_connection_info info ;  struct i2c_adapter * adapter ; } cocci_id@p ;
