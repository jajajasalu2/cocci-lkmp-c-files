...
position p;
@@
 struct ravb_private cocci_id@p ;
...
position p;
@@
 struct ravb_tstamp_skb * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ NUM_TX_QUEUE ] ;
...
position p;
@@
 const char * cocci_id@p [ NUM_RX_QUEUE ] ;
...
position p;
@@
 struct ravb_ex_rx_desc cocci_id@p ;
...
position p;
@@
 struct ravb_tx_desc cocci_id@p ;
