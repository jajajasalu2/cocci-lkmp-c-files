...
position p;
@@
 struct i2c_multi_inst_data {  int num_clients ;  struct i2c_client * clients [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct i2c_inst_data * cocci_id@p ;
...
position p;
@@
 struct i2c_inst_data {  const char * type ;  unsigned int flags ;  int irq_idx ; } cocci_id@p ;
...
position p;
@@
 struct i2c_multi_inst_data * cocci_id@p ;
