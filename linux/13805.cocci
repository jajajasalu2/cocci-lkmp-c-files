...
position p;
@@
 const struct ov13858_reg cocci_id@p [ ] ;
...
typedef bool;
@@
 struct ov13858 {  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_ctrl * link_freq ;  struct v4l2_ctrl * pixel_rate ;  struct v4l2_ctrl * vblank ;  struct v4l2_ctrl * hblank ;  struct v4l2_ctrl * exposure ;  const struct ov13858_mode * cur_mode ;  struct mutex mutex ;  bool streaming ; } cocci_id@p ;
...
position p;
@@
 const struct ov13858_mode * cocci_id@p ;
...
position p;
@@
 const struct ov13858_reg_list * cocci_id@p ;
...
typedef u32;
@@
 struct ov13858_link_freq_config {  u32 pixels_per_line ;  struct ov13858_reg_list reg_list ; } cocci_id@p ;
...
position p;
@@
 const struct ov13858_link_freq_config cocci_id@p [ OV13858_NUM_OF_LINK_FREQS ] ;
...
typedef u32;
@@
 struct ov13858_reg_list {  u32 num_of_regs ;  const struct ov13858_reg * regs ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct ov13858_reg {  u16 address ;  u8 val ; } cocci_id@p ;
...
typedef s64;
@@
 const s64 cocci_id@p [ OV13858_NUM_OF_LINK_FREQS ] ;
...
typedef u32;
@@
 struct ov13858_mode {  u32 width ;  u32 height ;  u32 vts_def ;  u32 vts_min ;  u32 link_freq_index ;  struct ov13858_reg_list reg_list ; } cocci_id@p ;
