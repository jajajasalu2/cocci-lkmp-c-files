...
typedef u8,u64,bool;
@@
 struct mipid02_dev {  struct i2c_client * i2c_client ;  struct regulator_bulk_data supplies [ MIPID02_NUM_SUPPLIES ] ;  struct v4l2_subdev sd ;  struct media_pad pad [ MIPID02_PAD_NB ] ;  struct clk * xclk ;  struct gpio_desc * reset_gpio ;  struct v4l2_fwnode_endpoint rx ;  u64 link_frequency ;  struct v4l2_fwnode_endpoint tx ;  struct v4l2_async_subdev asd ;  struct v4l2_async_notifier notifier ;  struct v4l2_subdev * s_subdev ;  struct {  u8 clk_lane_reg1 ;  u8 data_lane0_reg1 ;  u8 data_lane1_reg1 ;  u8 mode_reg1 ;  u8 mode_reg2 ;  u8 data_selection_ctrl ;  u8 data_id_rreg ;  u8 pix_width_ctrl ;  u8 pix_width_ctrl_emb ; } r ;  struct mutex lock ;  bool streaming ;  struct v4l2_mbus_framefmt fmt ; } cocci_id@p ;
