...
position p;
@@
 const struct wm8958_micd_rate * cocci_id@p ;
...
typedef u16;
@@
 struct fll_div {  u16 outdiv ;  u16 n ;  u16 k ;  u16 lambda ;  u16 clk_ref_div ;  u16 fll_fratio ; } cocci_id@p ;
...
position p;
@@
 struct wm8994_fll_config cocci_id@p ;
...
position p;
@@
 enum wm8994_vmid_mode cocci_id@p ;
...
position p;
@@
 struct wm8994_micdet * cocci_id@p ;
...
position p;
@@
 struct wm8994_pdata * cocci_id@p ;
...
position p;
@@
 struct {  unsigned int reg ;  unsigned int mask ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  int val , rate ; } cocci_id@p [ ] ;
