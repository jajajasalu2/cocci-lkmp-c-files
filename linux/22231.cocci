...
position p;
@@
 struct vm_special_mapping * cocci_id@p ;
...
position p;
@@
 struct mmap_arg_struct cocci_id@p ;
...
position p;
@@
 struct anon_vma_chain * cocci_id@p ;
...
position p;
@@
 struct mmap_arg_struct {  unsigned long addr ;  unsigned long len ;  unsigned long prot ;  unsigned long flags ;  unsigned long fd ;  unsigned long offset ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long addr , unsigned long request , unsigned long flags , struct list_head * uf ) ;
...
position p;
@@
 const struct vm_special_mapping * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mm_struct * mm , struct vm_area_struct * vma , struct vm_area_struct * prev , unsigned long start , unsigned long end ) ;
