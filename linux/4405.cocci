...
position p;
@@
 struct cr50_spi_phy cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ TPM_CR50_MAX_FW_VER_LEN + 1 ] ;
...
position p;
@@
 struct tpm_tis_spi_phy * cocci_id@p ;
...
typedef bool;
@@
 struct cr50_spi_phy {  struct tpm_tis_spi_phy spi_phy ;  struct mutex time_track_mutex ;  unsigned long last_access ;  unsigned long access_delay ;  unsigned int irq_confirmation_attempt ;  bool irq_needs_confirmation ;  bool irq_confirmed ; } cocci_id@p ;
