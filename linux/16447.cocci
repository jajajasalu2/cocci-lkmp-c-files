...
position p;
@@
 unsigned short cocci_id@p [ K90_GKEY_COUNT ] ;
...
typedef bool;
@@
 struct k90_led {  struct led_classdev cdev ;  int brightness ;  struct work_struct work ;  bool removed ; } cocci_id@p ;
...
position p;
@@
 struct corsair_drvdata {  unsigned long quirks ;  struct k90_drvdata * k90 ;  struct k90_led * backlight ; } cocci_id@p ;
...
position p;
@@
 struct corsair_drvdata cocci_id@p ;
...
position p;
@@
 struct k90_drvdata {  struct k90_led record_led ; } cocci_id@p ;
