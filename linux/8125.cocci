...
position p;
@@
 const struct c_can_priv * cocci_id@p ;
...
position p;
@@
 enum c_can_bus_error_types cocci_id@p ;
...
position p;
@@
 enum c_can_lec_type cocci_id@p ;
...
position p;
@@
 enum c_can_lec_type { LEC_NO_ERROR = 0 , LEC_STUFF_ERROR , LEC_FORM_ERROR , LEC_ACK_ERROR , LEC_BIT1_ERROR , LEC_BIT0_ERROR , LEC_CRC_ERROR , LEC_UNUSED , LEC_MASK = LEC_UNUSED , } cocci_id@p ;
...
position p;
@@
 enum c_can_bus_error_types { C_CAN_NO_ERROR = 0 , C_CAN_BUS_OFF , C_CAN_ERROR_WARNING , C_CAN_ERROR_PASSIVE , } cocci_id@p ;
