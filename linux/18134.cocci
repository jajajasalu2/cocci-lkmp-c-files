...
position p;
@@
 const struct pmu_probe_info cocci_id@p [ ] ;
...
position p;
@@
 const unsigned cocci_id@p [ PERF_COUNT_HW_CACHE_MAX ] [ PERF_COUNT_HW_CACHE_OP_MAX ] [ PERF_COUNT_HW_CACHE_RESULT_MAX ] ;
...
position p;
@@
 enum xscale_counters cocci_id@p ;
...
position p;
@@
 const unsigned cocci_id@p [ PERF_COUNT_HW_MAX ] ;
...
position p;
@@
 enum xscale_counters { XSCALE_CYCLE_COUNTER = 0 , XSCALE_COUNTER0 , XSCALE_COUNTER1 , XSCALE_COUNTER2 , XSCALE_COUNTER3 , } cocci_id@p ;
