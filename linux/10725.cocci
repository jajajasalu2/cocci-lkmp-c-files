...
position p;
@@
 struct intel_css_header * cocci_id@p ;
...
position p;
@@
 const struct intel_fw_info * cocci_id@p ;
...
position p;
@@
 const struct stepping_info * cocci_id@p ;
...
position p;
@@
 struct intel_package_header cocci_id@p ;
...
position p;
@@
 struct intel_dmc_header_base * cocci_id@p ;
...
position p;
@@
 const struct intel_dmc_header_v3 * cocci_id@p ;
...
position p;
@@
 const struct intel_dmc_header_v1 * cocci_id@p ;
...
position p;
@@
 const struct intel_dmc_header_base * cocci_id@p ;
...
position p;
@@
 struct intel_dmc_header_v3 cocci_id@p ;
...
position p;
@@
 struct stepping_info {  char stepping ;  char substepping ; } cocci_id@p ;
...
position p;
@@
 struct intel_fw_info cocci_id@p ;
...
position p;
@@
 struct intel_dmc_header_v1 cocci_id@p ;
...
position p;
@@
 const struct intel_package_header * cocci_id@p ;
