...
typedef u8;
@@
 struct usbdux_private {  int n_ai_urbs ;  int n_ao_urbs ;  struct urb * * ai_urbs ;  struct urb * * ao_urbs ;  struct urb * pwm_urb ;  unsigned int pwm_period ;  u8 pwm_delay ;  int pwm_buf_sz ;  __le16 * in_buf ;  __le16 * insn_buf ;  unsigned int high_speed : 1 ;  unsigned int ai_cmd_running : 1 ;  unsigned int ao_cmd_running : 1 ;  unsigned int pwm_cmd_running : 1 ;  unsigned int ai_timer ;  unsigned int ao_timer ;  unsigned int ai_counter ;  unsigned int ao_counter ;  unsigned int ai_interval ;  u8 * dux_commands ;  struct mutex mut ; } cocci_id@p ;
...
position p;
@@
 struct usbdux_private * cocci_id@p ;
