...
position p;
@@
 const struct ingenic_tcu_clk_info cocci_id@p ;
...
typedef bool;
@@
 struct ingenic_soc_info {  unsigned int num_channels ;  bool has_ost ;  bool has_tcu_clk ; } cocci_id@p ;
...
position p;
@@
 struct ingenic_tcu_clk cocci_id@p ;
...
position p;
@@
 struct ingenic_tcu_clk {  struct clk_hw hw ;  unsigned int idx ;  struct ingenic_tcu * tcu ;  const struct ingenic_tcu_clk_info * info ; } cocci_id@p ;
...
position p;
@@
 enum tcu_clk_parent cocci_id@p ;
...
position p;
@@
 const struct ingenic_soc_info cocci_id@p ;
...
position p;
@@
 struct ingenic_tcu {  const struct ingenic_soc_info * soc_info ;  struct regmap * map ;  struct clk * clk ;  struct clk_hw_onecell_data * clocks ; } cocci_id@p ;
...
typedef u8;
@@
 struct ingenic_tcu_clk_info {  struct clk_init_data init_data ;  u8 gate_bit ;  u8 tcsr_reg ; } cocci_id@p ;
...
position p;
@@
 enum tcu_clk_parent { TCU_PARENT_PCLK , TCU_PARENT_RTC , TCU_PARENT_EXT , } cocci_id@p ;
