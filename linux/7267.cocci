...
position p;
@@
 void cocci_id@p ( struct vc_data * c , int lines ) ;
...
position p;
@@
 struct vgacon_scrollback_info {  void * data ;  int tail ;  int size ;  int rows ;  int cnt ;  int cur ;  int save ;  int restore ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * c , int init ) ;
...
position p;
@@
 int cocci_id@p ( struct vc_data * c , int blank , int mode_switch ) ;
...
position p;
@@
 struct vgacon_scrollback_info cocci_id@p [ MAX_NR_CONSOLES ] ;
...
position p;
@@
 int cocci_id@p ( struct vc_data * c ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * c , int mode ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct vc_data * c , u16 * p , int count ) ;
...
position p;
@@
 void cocci_id@p ( struct vc_data * c ) ;
...
position p;
@@
 struct vgacon_scrollback_info * cocci_id@p ;
