...
position p;
@@
 struct compat_dtv_property cocci_id@p ;
...
position p;
@@
 struct dvb_frontend_private cocci_id@p ;
...
typedef __u32;
@@
 struct dtv_cmds_h {  char * name ;  __u32 cmd ;  __u32 set : 1 ;  __u32 buffer : 1 ;  __u32 reserved : 30 ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dvb_frontend * fe ) ;
...
position p;
@@
 void cocci_id@p ( struct dvb_frontend * fe , void ( * release ) ( struct dvb_frontend * fe ) ) ;
...
position p;
@@
 struct dtv_cmds_h cocci_id@p [ DTV_MAX_COMMAND + 1 ] ;
...
position p;
@@
 struct dvb_diseqc_master_cmd * cocci_id@p ;
...
position p;
@@
 const struct dvb_frontend_parameters * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dvb_frontend * fe ) ;
...
position p;
@@
 struct dtv_property * cocci_id@p ;
...
position p;
@@
 const struct dvb_device cocci_id@p ;
...
position p;
@@
 struct dvb_frontend_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct file * file , unsigned int cmd , void * parg ) ;
...
position p;
@@
 enum fe_sec_voltage cocci_id@p ;
...
position p;
@@
 enum dvbv3_emulation_type { DVBV3_UNKNOWN , DVBV3_QPSK , DVBV3_QAM , DVBV3_OFDM , DVBV3_ATSC , } cocci_id@p ;
...
@@
 struct dvb_frontend_private {  struct dvb_device * dvbdev ;  struct dvb_frontend_parameters parameters_out ;  struct dvb_fe_events events ;  struct semaphore sem ;  struct list_head list_head ;  wait_queue_head_t wait_queue ;  struct task_struct * thread ;  unsigned long release_jiffies ;  unsigned int wakeup ;  enum fe_status status ;  unsigned long tune_mode_flags ;  unsigned int delay ;  unsigned int reinitialise ;  int tone ;  int voltage ;  unsigned int state ;  unsigned int bending ;  int lnb_drift ;  unsigned int inversion ;  unsigned int auto_step ;  unsigned int auto_sub_step ;  unsigned int started_auto_step ;  unsigned int min_delay ;  unsigned int max_drift ;  unsigned int step_size ;  int quality ;  unsigned int check_wrapped ;  enum dvbfe_search algo_status ; #if defined(CONFIG_MEDIA_CONTROLLER_DVB)  struct media_pipeline pipe ; #endif } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dvb_frontend * fe , const struct dtv_frontend_properties * c , struct dvb_frontend_parameters * p ) ;
...
position p;
@@
 struct dvb_frontend_parameters * cocci_id@p ;
...
position p;
@@
 struct compat_dtv_properties cocci_id@p ;
...
position p;
@@
 struct dtv_properties * cocci_id@p ;
...
position p;
@@
 const struct dtv_frontend_properties * cocci_id@p ;
...
position p;
@@
 struct dvb_frontend_event * cocci_id@p ;
...
position p;
@@
 enum fe_sec_tone_mode cocci_id@p ;
...
@@
 struct compat_dtv_properties {  __u32 num ;  compat_uptr_t props ; } cocci_id@p ;
...
position p;
@@
 struct dvb_fe_events * cocci_id@p ;
...
position p;
@@
 enum dvbv3_emulation_type cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dvb_frontend * fe , struct dtv_frontend_properties * c , struct dvb_frontend_parameters * p_out ) ;
...
position p;
@@
 enum fe_sec_mini_cmd cocci_id@p ;
