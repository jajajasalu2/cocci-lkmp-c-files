...
position p;
@@
 struct hwlat_sample cocci_id@p ;
...
typedef u64;
@@
 struct hwlat_sample {  u64 seqnum ;  u64 duration ;  u64 outer_duration ;  u64 nmi_total_ts ;  struct timespec64 timestamp ;  int nmi_count ; } cocci_id@p ;
...
typedef u64;
@@
 struct hwlat_data {  struct mutex lock ;  u64 count ;  u64 sample_window ;  u64 sample_width ; } cocci_id@p ;
