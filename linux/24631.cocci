...
position p;
@@
 enum nft_limit_type cocci_id@p ;
...
position p;
@@
 const struct nft_limit * cocci_id@p ;
...
position p;
@@
 struct nft_limit_pkts cocci_id@p ;
...
typedef u64;
@@
 struct nft_limit_pkts {  struct nft_limit limit ;  u64 cost ; } cocci_id@p ;
...
@@
 struct nft_limit {  spinlock_t lock ;  u64 last ;  u64 tokens ;  u64 tokens_max ;  u64 rate ;  u64 nsecs ;  u32 burst ;  bool invert ; } cocci_id@p ;
...
position p;
@@
 const struct nft_limit_pkts * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_LIMIT_MAX + 1 ] ;
