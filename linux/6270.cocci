...
position p;
@@
 struct regmap_irq_chip cocci_id@p [ CPCAP_NR_IRQ_CHIPS ] ;
...
position p;
@@
 struct cpcap_ddata {  struct spi_device * spi ;  struct regmap_irq * irqs ;  struct regmap_irq_chip_data * irqdata [ CPCAP_NR_IRQ_CHIPS ] ;  const struct regmap_config * regmap_conf ;  struct regmap * regmap ; } cocci_id@p ;
