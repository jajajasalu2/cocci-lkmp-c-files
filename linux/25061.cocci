...
position p;
@@
 struct ieee80211_ftm_responder_params * cocci_id@p ;
...
position p;
@@
 struct ieee80211_csa_settings cocci_id@p ;
...
position p;
@@
 const struct mesh_config * cocci_id@p ;
...
position p;
@@
 struct mac80211_qos_map * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_csa_settings * cocci_id@p ;
...
position p;
@@
 enum nl80211_meshconf_params cocci_id@p ;
...
position p;
@@
 const struct mesh_setup * cocci_id@p ;
