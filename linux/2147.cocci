...
position p;
@@
 struct ltc294x_info {  struct i2c_client * client ;  struct power_supply * supply ;  struct power_supply_desc supply_desc ;  struct delayed_work work ;  enum ltc294x_id id ;  int charge ;  int r_sense ;  int Qlsb ; } cocci_id@p ;
...
position p;
@@
 struct ltc294x_info cocci_id@p ;
...
position p;
@@
 enum ltc294x_id { LTC2941_ID , LTC2942_ID , LTC2943_ID , LTC2944_ID , } cocci_id@p ;
...
position p;
@@
 const struct ltc294x_info * cocci_id@p ;
