...
position p;
@@
 enum eeprom_nature { UNKNOWN , VAIO , } cocci_id@p ;
...
typedef u8;
@@
 struct eeprom_data {  struct mutex update_lock ;  u8 valid ;  unsigned long last_updated [ 8 ] ;  u8 data [ EEPROM_SIZE ] ;  enum eeprom_nature nature ; } cocci_id@p ;
