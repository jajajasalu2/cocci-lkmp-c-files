...
position p;
@@
 struct inode_defrag cocci_id@p ;
...
position p;
@@
 enum { RANGE_BOUNDARY_WRITTEN_EXTENT , RANGE_BOUNDARY_PREALLOC_EXTENT , RANGE_BOUNDARY_HOLE , } cocci_id@p ;
...
typedef u64;
@@
 struct falloc_range {  struct list_head list ;  u64 start ;  u64 len ; } cocci_id@p ;
...
typedef u64;
@@
 struct inode_defrag {  struct rb_node rb_node ;  u64 ino ;  u64 transid ;  u64 root ;  u64 last_offset ;  int cycled ; } cocci_id@p ;
...
position p;
@@
 struct falloc_range * cocci_id@p ;
