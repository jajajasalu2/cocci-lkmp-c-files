...
position p;
@@
 struct iio_mount_matrix * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ INDIO_MAX_RAW_ELEMENTS ] ;
...
position p;
@@
 const struct iio_event_interface * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef iio_get_mount_matrix_t;
@@
 iio_get_mount_matrix_t * cocci_id@p ;
