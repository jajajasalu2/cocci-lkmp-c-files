...
position p;
@@
 struct lpc18xx_clk_branch * cocci_id@p ;
...
position p;
@@
 struct lpc18xx_branch_clk_data * cocci_id@p ;
...
position p;
@@
 struct lpc18xx_branch_clk_data {  const char * * name ;  int num ; } cocci_id@p ;
...
typedef u16;
@@
 struct lpc18xx_clk_branch {  const char * base_name ;  const char * name ;  u16 offset ;  u16 flags ;  struct clk * clk ;  struct clk_gate gate ; } cocci_id@p ;
