...
position p;
@@
 struct scmi_msg_sensor_reading_get * cocci_id@p ;
...
position p;
@@
 struct scmi_msg_resp_sensor_description * cocci_id@p ;
...
position p;
@@
 struct scmi_sensor_ops cocci_id@p ;
...
position p;
@@
 struct sensors_info * cocci_id@p ;
...
position p;
@@
 const struct scmi_sensor_info * cocci_id@p ;
...
position p;
@@
 struct scmi_sensor_info * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct scmi_msg_resp_sensor_attributes {  __le16 num_sensors ;  u8 max_requests ;  u8 reserved ;  __le32 reg_addr_low ;  __le32 reg_addr_high ;  __le32 reg_size ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct sensors_info {  int num_sensors ;  int max_requests ;  u64 reg_addr ;  u32 reg_size ;  struct scmi_sensor_info * sensors ; } cocci_id@p ;
...
position p;
@@
 enum scmi_sensor_protocol_cmd { SENSOR_DESCRIPTION_GET = 0x3 , SENSOR_TRIP_POINT_NOTIFY = 0x4 , SENSOR_TRIP_POINT_CONFIG = 0x5 , SENSOR_READING_GET = 0x6 , } cocci_id@p ;
...
position p;
@@
 struct scmi_msg_resp_sensor_attributes * cocci_id@p ;
...
position p;
@@
 struct scmi_msg_sensor_trip_point_notify * cocci_id@p ;
...
position p;
@@
 struct scmi_msg_set_sensor_trip_point * cocci_id@p ;
