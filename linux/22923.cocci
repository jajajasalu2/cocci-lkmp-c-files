...
position p;
@@
 struct snd_pcm_mmap_control cocci_id@p ;
...
position p;
@@
 volatile struct snd_pcm_mmap_control * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_pcm_substream * substream , struct snd_pcm_hw_params_old __user * _oparams ) ;
...
position p;
@@
 unsigned int cocci_id@p [ SNDRV_PCM_HW_PARAM_LAST_INTERVAL + 1 ] ;
...
position p;
@@
 struct snd_pcm_info * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_hw_params_old cocci_id@p ;
...
position p;
@@
 struct snd_pcm_group * cocci_id@p ;
...
position p;
@@
 const struct file_operations cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct action_ops * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct file * file , struct snd_pcm * pcm , int stream ) ;
...
position p;
@@
 const struct snd_interval * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_hw_constraints * cocci_id@p ;
...
typedef snd_pcm_uframes_t;
@@
 struct snd_pcm_hw_params_old {  unsigned int flags ;  unsigned int masks [ SNDRV_PCM_HW_PARAM_SUBFORMAT - SNDRV_PCM_HW_PARAM_ACCESS + 1 ] ;  struct snd_interval intervals [ SNDRV_PCM_HW_PARAM_TICK_TIME - SNDRV_PCM_HW_PARAM_SAMPLE_BITS + 1 ] ;  unsigned int rmask ;  unsigned int cmask ;  unsigned int info ;  unsigned int msbits ;  unsigned int rate_num ;  unsigned int rate_den ;  snd_pcm_uframes_t fifo_size ;  unsigned char reserved [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 struct snd_pcm_file * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_mmap_status cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_pcm_sframes_t;
@@
 snd_pcm_sframes_t cocci_id@p ;
...
position p;
@@
 struct snd_pcm_status cocci_id@p ;
...
position p;
@@
 struct snd_pcm_sw_params cocci_id@p ;
...
position p;
@@
 const struct snd_mask * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_pcm_state_t;
@@
 snd_pcm_state_t cocci_id@p ;
...
position p;
@@
 volatile struct snd_pcm_mmap_status * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_sync_ptr cocci_id@p ;
