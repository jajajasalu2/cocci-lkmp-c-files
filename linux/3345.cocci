...
position p;
@@
 struct occ_attribute * cocci_id@p ;
...
position p;
@@
 struct occ_poll_response_header * cocci_id@p ;
...
position p;
@@
 struct power_sensor_a0 * cocci_id@p ;
...
position p;
@@
 struct temp_sensor_2 * cocci_id@p ;
...
position p;
@@
 struct occ_response * cocci_id@p ;
...
position p;
@@
 struct freq_sensor_1 * cocci_id@p ;
...
position p;
@@
 struct power_sensor_2 * cocci_id@p ;
...
position p;
@@
 struct temp_sensor_1 * cocci_id@p ;
...
position p;
@@
 struct extended_sensor * cocci_id@p ;
...
position p;
@@
 struct caps_sensor_3 * cocci_id@p ;
...
position p;
@@
 struct power_sensor_1 * cocci_id@p ;
...
position p;
@@
 struct occ_poll_response * cocci_id@p ;
...
position p;
@@
 struct freq_sensor_2 * cocci_id@p ;
...
position p;
@@
 struct caps_sensor_2 * cocci_id@p ;
...
position p;
@@
 struct occ_sensor_data_block * cocci_id@p ;
