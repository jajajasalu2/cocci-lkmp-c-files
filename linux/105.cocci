...
position p;
@@
 struct psi_group_cpu cocci_id@p ;
...
position p;
@@
 enum psi_aggregators cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ NR_PSI_STATES - 1 ] ;
