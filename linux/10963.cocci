...
position p;
@@
 struct atom_smc_dpm_info_v4_6 * cocci_id@p ;
...
position p;
@@
 struct amdgpu_hive_info * cocci_id@p ;
...
position p;
@@
 struct arcturus_single_dpm_table * cocci_id@p ;
...
position p;
@@
 struct arcturus_dpm_table * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SwI2cRequest_t;
@@
 SwI2cRequest_t cocci_id@p ;
...
position p;
@@
 struct arcturus_dpm_state * cocci_id@p ;
