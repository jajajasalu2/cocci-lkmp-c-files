...
position p;
@@
 ssize_t ( * cocci_id@p ) ( struct atkbd * , char * ) ;
...
position p;
@@
 const unsigned short cocci_id@p [ ATKBD_KEYMAP_SIZE ] ;
...
position p;
@@
 const unsigned short cocci_id@p [ 128 ] ;
...
typedef bool;
@@
 struct atkbd {  struct ps2dev ps2dev ;  struct input_dev * dev ;  char name [ 64 ] ;  char phys [ 32 ] ;  unsigned short id ;  unsigned short keycode [ ATKBD_KEYMAP_SIZE ] ; 
...
position p;
@@
 unsigned int ( * cocci_id@p ) ( struct atkbd * , unsigned int ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct atkbd * , const void * data ) ;
...
position p;
@@
 const struct {  unsigned short keycode ;  unsigned char set2 ; } cocci_id@p [ ] ;
