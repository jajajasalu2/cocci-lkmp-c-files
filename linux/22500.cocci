...
symbol cocci_id;
position p;
typedef a3d_ItdDline_t;
@@
 const a3d_ItdDline_t cocci_id@p ;
...
typedef vortex_t;
@@
 void cocci_id@p ( vortex_t * vortex ) ;
...
symbol cocci_id;
position p;
typedef a3d_LRGains_t;
@@
 a3d_LRGains_t cocci_id@p ;
...
typedef vortex_t;
@@
 int cocci_id@p ( vortex_t * vortex ) ;
