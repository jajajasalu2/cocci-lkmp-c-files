...
position p;
@@
 enum omap_dss_device_ops_flag cocci_id@p ;
...
typedef bool;
@@
 struct omap_connector {  struct drm_connector base ;  struct omap_dss_device * output ;  struct omap_dss_device * hpd ;  bool hdmi_mode ; } cocci_id@p ;
...
position p;
@@
 struct omap_connector * cocci_id@p ;
