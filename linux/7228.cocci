...
position p;
@@
 struct btmtkuart_dev cocci_id@p ;
...
position p;
@@
 const struct btmtkuart_data cocci_id@p ;
...
position p;
@@
 struct btmtkuart_data {  unsigned int flags ;  const char * fwname ; } cocci_id@p ;
