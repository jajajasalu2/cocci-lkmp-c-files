...
position p;
@@
 struct mv_xor_v2_sw_desc {  int idx ;  struct dma_async_tx_descriptor async_tx ;  struct mv_xor_v2_descriptor hw_desc ;  struct list_head free_list ; } cocci_id@p ;
...
position p;
@@
 struct mv_xor_v2_sw_desc cocci_id@p ;
...
position p;
@@
 struct mv_xor_v2_device * cocci_id@p ;
...
position p;
@@
 struct mv_xor_v2_descriptor * cocci_id@p ;
