...
position p;
@@
 struct nsp_sync_table cocci_id@p [ ] ;
...
position p;
@@
 struct nsp_sync_table {  unsigned int min_period ;  unsigned int max_period ;  unsigned int chip_period ;  unsigned int ack_width ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NSP_DEBUG_BUF_LEN ] ;
