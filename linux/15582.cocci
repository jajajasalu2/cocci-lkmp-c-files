...
@@
 const irq_handler_t cocci_id@p [ NUM_DIO ] ;
...
position p;
@@
 struct pi433_instance {  struct pi433_device * device ;  struct pi433_tx_cfg tx_cfg ; } cocci_id@p ;
...
position p;
@@
 struct pi433_device * cocci_id@p ;
...
position p;
@@
 struct pi433_instance * cocci_id@p ;
...
position p;
@@
 struct pi433_tx_cfg cocci_id@p ;
...
position p;
@@
 struct pi433_rx_cfg cocci_id@p ;
