...
position p;
@@
 unsigned long cocci_id@p [ AL2230_PWR_IDX_LEN ] ;
...
position p;
@@
 const unsigned long cocci_id@p [ CB_AL7230_INIT_SEQ ] ;
...
position p;
@@
 const unsigned long cocci_id@p [ CB_AL2230_INIT_SEQ ] ;
...
position p;
@@
 const unsigned long cocci_id@p [ CB_MAX_CHANNEL ] ;
