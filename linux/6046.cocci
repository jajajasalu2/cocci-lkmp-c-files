...
typedef u8;
@@
 struct u300_gpio_port {  struct u300_gpio * gpio ;  char name [ 8 ] ;  int irq ;  int number ;  u8 toggle_edge_mode ; } cocci_id@p ;
...
position p;
@@
 struct coh901_pinpair {  unsigned int offset ;  unsigned int pin_base ; } cocci_id@p ;
...
position p;
@@
 struct u300_gpio_port * cocci_id@p ;
...
position p;
@@
 struct coh901_pinpair cocci_id@p [ ] ;
...
typedef u32;
@@
 struct u300_gpio {  struct gpio_chip chip ;  struct u300_gpio_port ports [ U300_GPIO_NUM_PORTS ] ;  struct clk * clk ;  void __iomem * base ;  struct device * dev ;  u32 stride ;  u32 pcr ;  u32 dor ;  u32 dir ;  u32 per ;  u32 icr ;  u32 ien ;  u32 iev ; } cocci_id@p ;
...
position p;
@@
 const struct u300_gpio_confdata * cocci_id@p ;
...
typedef bool,u16;
@@
 struct u300_gpio_confdata {  u16 bias_mode ;  bool output ;  int outval ; } cocci_id@p ;
