...
position p;
@@
 enum srp_rport_state cocci_id@p ;
...
position p;
@@
 struct srp_internal {  struct scsi_transport_template t ;  struct srp_function_template * f ;  struct device_attribute * host_attrs [ SRP_HOST_ATTRS + 1 ] ;  struct device_attribute * rport_attrs [ SRP_RPORT_ATTRS + 1 ] ;  struct transport_container rport_attr_cont ; } cocci_id@p ;
...
position p;
@@
 struct srp_host_attrs cocci_id@p ;
...
position p;
@@
 struct srp_internal cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct device * dev ) ;
...
typedef atomic_t;
@@
 struct srp_host_attrs {  atomic_t next_port_id ; } cocci_id@p ;
