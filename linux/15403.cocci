...
position p;
@@
 struct wdat_instruction {  struct acpi_wdat_entry entry ;  void __iomem * reg ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct acpi_wdat_entry * cocci_id@p ;
...
position p;
@@
 struct wdat_instruction * cocci_id@p ;
...
typedef bool;
@@
 struct wdat_wdt {  struct platform_device * pdev ;  struct watchdog_device wdd ;  unsigned int period ;  bool stopped_in_sleep ;  bool stopped ;  struct list_head * instructions [ MAX_WDAT_ACTIONS ] ; } cocci_id@p ;
...
position p;
@@
 const struct watchdog_info cocci_id@p ;
...
position p;
@@
 const struct acpi_table_wdat * cocci_id@p ;
...
position p;
@@
 const struct acpi_generic_address * cocci_id@p ;
...
position p;
@@
 const struct wdat_instruction * cocci_id@p ;
...
position p;
@@
 const struct acpi_wdat_entry * cocci_id@p ;
