...
position p;
@@
 struct qcom_slim_ctrl * cocci_id@p ;
...
position p;
@@
 struct qcom_slim_ctrl {  struct slim_controller ctrl ;  struct slim_framer framer ;  struct device * dev ;  void __iomem * base ;  void __iomem * slew_reg ;  struct slim_ctrl_buf rx ;  struct slim_ctrl_buf tx ;  struct completion * * wr_comp ;  int irq ;  struct workqueue_struct * rxwq ;  struct work_struct wd ;  struct clk * rclk ;  struct clk * hclk ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct slim_ctrl_buf {  void * base ;  spinlock_t lock ;  int head ;  int tail ;  int sl_sz ;  int n ; } cocci_id@p ;
