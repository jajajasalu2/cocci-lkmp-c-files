...
position p;
@@
 enum rave_sp_eeprom_access_type cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RAVE_SP_EEPROM_HEADER_MAX + sizeof ( page -> data ) ] ;
...
position p;
@@
 struct rave_sp_eeprom_page cocci_id@p ;
...
typedef u8;
@@
 struct rave_sp_eeprom {  struct rave_sp * sp ;  struct mutex mutex ;  u8 address ;  unsigned int header_size ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct rave_sp_eeprom * cocci_id@p ;
...
position p;
@@
 enum rave_sp_eeprom_access_type { RAVE_SP_EEPROM_WRITE = 0 , RAVE_SP_EEPROM_READ = 1 , } cocci_id@p ;
...
position p;
@@
 enum rave_sp_eeprom_header_size { RAVE_SP_EEPROM_HEADER_SMALL = 4U , RAVE_SP_EEPROM_HEADER_BIG = 5U , } cocci_id@p ;
