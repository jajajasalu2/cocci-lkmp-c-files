...
typedef bool,u32;
@@
 struct vf610_nfc {  struct nand_controller base ;  struct nand_chip chip ;  struct device * dev ;  void __iomem * regs ;  struct completion cmd_done ;  enum vf610_nfc_variant variant ;  struct clk * clk ;  bool data_access ;  u32 ecc_mode ; } cocci_id@p ;
...
position p;
@@
 enum vf610_nfc_variant cocci_id@p ;
...
position p;
@@
 enum vf610_nfc_variant { NFC_VFC610 = 1 , } cocci_id@p ;
