...
position p;
@@
 union dce_dmcu_psr_config_data_reg3 cocci_id@p ;
...
position p;
@@
 union dce_dmcu_psr_config_data_reg1 cocci_id@p ;
...
position p;
@@
 const struct dc_config * cocci_id@p ;
...
position p;
@@
 const struct dmcu_funcs cocci_id@p ;
...
position p;
@@
 union dce_dmcu_psr_config_data_reg2 cocci_id@p ;
...
position p;
@@
 union dce_dmcu_psr_config_data_wait_loop_reg1 cocci_id@p ;
