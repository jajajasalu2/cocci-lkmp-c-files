...
position p;
@@
 struct snd_line6_midi cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_line6 * line6 , unsigned char * data , int length ) ;
...
position p;
@@
 unsigned char cocci_id@p [ LINE6_FALLBACK_MAXPACKETSIZE ] ;
