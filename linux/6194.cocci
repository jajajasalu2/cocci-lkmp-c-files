...
position p;
@@
 enum { T7L66XB_CELL_NAND , T7L66XB_CELL_MMC , } cocci_id@p ;
...
@@
 struct t7l66xb {  void __iomem * scr ;  raw_spinlock_t lock ;  struct resource rscr ;  struct clk * clk48m ;  struct clk * clk32k ;  int irq ;  int irq_base ; } cocci_id@p ;
