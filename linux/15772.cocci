...
position p;
@@
 struct mtk_hsdam_engine * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct mtk_hsdma_chan {  struct virt_dma_chan vchan ;  unsigned int id ;  dma_addr_t desc_addr ;  int tx_idx ;  int rx_idx ;  struct hsdma_desc * tx_ring ;  struct hsdma_desc * rx_ring ;  struct mtk_hsdma_desc * desc ;  unsigned int next_sg ; } cocci_id@p ;
...
position p;
@@
 struct mtk_hsdam_engine {  struct dma_device ddev ;  struct device_dma_parameters dma_parms ;  void __iomem * base ;  struct tasklet_struct task ;  volatile unsigned long chan_issued ;  struct mtk_hsdma_chan chan [ 1 ] ; } cocci_id@p ;
...
@@
 struct mtk_hsdma_sg {  dma_addr_t src_addr ;  dma_addr_t dst_addr ;  u32 len ; } cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_chan * cocci_id@p ;
...
typedef u32;
@@
 struct hsdma_desc {  u32 addr0 ;  u32 flags ;  u32 addr1 ;  u32 unused ; } cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_desc {  struct virt_dma_desc vdesc ;  unsigned int num_sgs ;  struct mtk_hsdma_sg sg [ 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_sg * cocci_id@p ;
...
position p;
@@
 struct mtk_hsdma_desc * cocci_id@p ;
