...
position p;
@@
 int cocci_id@p ( struct platform_device * pdev , int v ) ;
...
position p;
@@
 struct softing_platform_data * cocci_id@p ;
...
position p;
@@
 struct dev {  struct platform_device pdev ;  struct resource res [ 2 ] ; } * cocci_id@p ;
