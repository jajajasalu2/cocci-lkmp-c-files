...
position p;
@@
 struct acpi_platform_list cocci_id@p [ ] ;
...
position p;
@@
 struct ghes_edac_pvt * cocci_id@p ;
...
position p;
@@
 struct edac_raw_error_desc * cocci_id@p ;
...
position p;
@@
 struct ghes_edac_pvt {  struct list_head list ;  struct ghes * ghes ;  struct mem_ctl_info * mci ;  char other_detail [ 400 ] ;  char msg [ 80 ] ; } cocci_id@p ;
...
position p;
@@
 struct ghes_edac_dimm_fill * cocci_id@p ;
...
position p;
@@
 struct ghes_edac_dimm_fill {  struct mem_ctl_info * mci ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 struct edac_mc_layer cocci_id@p [ 1 ] ;
