...
position p;
@@
 char cocci_id@p [ FSCRYPT_MK_DESCRIPTION_SIZE ] ;
...
position p;
@@
 struct fscrypt_info * cocci_id@p ;
...
position p;
@@
 struct fscrypt_get_key_status_arg cocci_id@p ;
...
position p;
@@
 struct fscrypt_master_key_secret * cocci_id@p ;
...
position p;
@@
 struct fscrypt_key_specifier cocci_id@p ;
...
position p;
@@
 struct fscrypt_remove_key_arg cocci_id@p ;
...
position p;
@@
 const struct fscrypt_key_specifier * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ FSCRYPT_FS_KEYRING_DESCRIPTION_SIZE ] ;
...
position p;
@@
 struct fscrypt_add_key_arg cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ FSCRYPT_MK_USER_DESCRIPTION_SIZE ] ;
...
position p;
@@
 struct fscrypt_master_key * cocci_id@p ;
...
position p;
@@
 const struct fscrypt_master_key * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ FSCRYPT_KEY_IDENTIFIER_SIZE ] ;
...
position p;
@@
 char cocci_id@p [ FSCRYPT_MK_USERS_DESCRIPTION_SIZE ] ;
