...
position p;
@@
 stack_trace_consume_fn cocci_id@p ;
...
position p;
@@
 struct stack_frame_user cocci_id@p ;
...
position p;
@@
 struct stack_frame_user {  const void __user * next_fp ;  unsigned long ret_addr ; } cocci_id@p ;
