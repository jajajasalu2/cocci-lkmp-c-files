...
position p;
@@
 const struct ubi_rsvol_req * cocci_id@p ;
...
position p;
@@
 struct ubi_rsvol_req cocci_id@p ;
...
position p;
@@
 struct ubi_attach_req cocci_id@p ;
...
position p;
@@
 struct ubi_leb_change_req cocci_id@p ;
...
position p;
@@
 struct ubi_mkvol_req cocci_id@p ;
...
position p;
@@
 struct ubi_rnvol_req cocci_id@p ;
...
position p;
@@
 struct ubi_set_vol_prop_req cocci_id@p ;
...
position p;
@@
 const struct ubi_mkvol_req * cocci_id@p ;
