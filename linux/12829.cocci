...
position p;
@@
 struct exynos_srom {  struct device * dev ;  void __iomem * reg_base ;  struct exynos_srom_reg_dump * reg_offset ; } cocci_id@p ;
...
position p;
@@
 struct exynos_srom_reg_dump * cocci_id@p ;
...
position p;
@@
 const struct exynos_srom_reg_dump * cocci_id@p ;
...
typedef u32;
@@
 struct exynos_srom_reg_dump {  u32 offset ;  u32 value ; } cocci_id@p ;
