...
position p;
@@
 int cocci_id@p ( struct btrfs_trans_handle * trans ) ;
...
position p;
@@
 struct btrfs_stripe * cocci_id@p ;
...
position p;
@@
 const struct btrfs_device_info * cocci_id@p ;
...
position p;
@@
 struct btrfs_balance_item cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfs_device * dev ) ;
...
position p;
@@
 const struct btrfs_dev_stats_item * cocci_id@p ;
...
position p;
@@
 struct btrfs_device_info cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct btrfs_fs_info * fs_info , enum btrfs_map_op op , u64 logical , u64 * length , struct btrfs_bio * * bbio_ret , int mirror_num , int need_raid_map ) ;
...
position p;
@@
 const struct btrfs_raid_attr cocci_id@p [ BTRFS_NR_RAID_TYPES ] ;
...
position p;
@@
 struct btrfs_disk_balance_args cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfs_device * device ) ;
...
position p;
@@
 struct btrfs_balance_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_dev_stats_item cocci_id@p ;
