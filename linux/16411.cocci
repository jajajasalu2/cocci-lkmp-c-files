...
typedef u32,u16;
@@
 struct lg4ff_wheel {  const u32 product_id ;  const signed short * ff_effects ;  const u16 min_range ;  const u16 max_range ;  void ( * set_range ) ( struct hid_device * hid , u16 range ) ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct lg4ff_wheel_ident_info {  const u32 modes ;  const u16 mask ;  const u16 result ;  const u16 real_product_id ; } cocci_id@p ;
...
typedef u16;
@@
 struct lg4ff_alternate_mode {  const u16 product_id ;  const char * tag ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 const struct lg4ff_compat_mode_switch cocci_id@p ;
...
position p;
@@
 const struct lg4ff_wheel_ident_info cocci_id@p ;
...
position p;
@@
 const struct lg4ff_alternate_mode cocci_id@p [ ] ;
...
position p;
@@
 struct lg4ff_wheel_data cocci_id@p ;
...
position p;
@@
 struct lg4ff_device_entry * cocci_id@p ;
...
typedef u8;
@@
 struct lg4ff_compat_mode_switch {  const u8 cmd_count ;  const u8 cmd [ ] ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct lg4ff_device_entry {  spinlock_t report_lock ;  struct hid_report * report ;  struct lg4ff_wheel_data wdata ; } cocci_id@p ;
...
position p;
@@
 const struct lg4ff_multimode_wheel cocci_id@p [ ] ;
...
position p;
@@
 const struct lg4ff_wheel * cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct hid_device * hid , u16 range ) ;
...
position p;
@@
 struct lg4ff_wheel_data * const cocci_id@p ;
...
typedef u32,u16;
@@
 struct lg4ff_multimode_wheel {  const u16 product_id ;  const u32 alternate_modes ;  const char * real_tag ;  const char * real_name ; } cocci_id@p ;
