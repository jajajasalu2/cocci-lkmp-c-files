...
position p;
@@
 void cocci_id@p ( struct e1000_adapter * adapter , struct e1000_tx_ring * tx_ring ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct e1000_adapter * adapter , bool filter_on ) ;
...
position p;
@@
 struct e1000_rx_desc * cocci_id@p ;
...
position p;
@@
 struct e1000_tx_ring * cocci_id@p ;
...
position p;
@@
 const struct e1000_adapter * cocci_id@p ;
...
position p;
@@
 struct e1000_rx_buffer * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct e1000_adapter * adapter , struct e1000_rx_ring * rx_ring ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * netdev , struct ifreq * ifr , int cmd ) ;
...
position p;
@@
 struct e1000_rx_ring * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct e1000_adapter * adapter ) ;
...
position p;
@@
 struct e1000_tx_buffer cocci_id@p ;
...
position p;
@@
 struct e1000_context_desc * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct e1000_adapter * adapter ) ;
...
position p;
@@
 struct e1000_adapter cocci_id@p ;
...
position p;
@@
 struct e1000_tx_desc * cocci_id@p ;
...
position p;
@@
 struct e1000_hw_stats * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct e1000_adapter * adapter ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * netdev , void * p ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct net_device * netdev , __be16 proto , u16 vid ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct e1000_adapter * adapter , struct e1000_tx_ring * tx_ring ) ;
...
@@
 pci_ers_result_t cocci_id@p ( struct pci_dev * pdev ) ;
...
position p;
@@
 int cocci_id@p ( struct e1000_adapter * adapter , struct e1000_tx_ring * txdr ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * netdev , int new_mtu ) ;
...
position p;
@@
 int cocci_id@p ( struct e1000_adapter * adapter , struct sk_buff * skb ) ;
...
typedef netdev_tx_t;
@@
 netdev_tx_t cocci_id@p ( struct sk_buff * skb , struct net_device * netdev ) ;
...
position p;
@@
 void cocci_id@p ( struct e1000_adapter * adapter , struct e1000_rx_ring * rx_ring , int cleaned_count ) ;
...
position p;
@@
 int cocci_id@p ( struct e1000_adapter * adapter , struct e1000_rx_ring * rxdr ) ;
...
position p;
@@
 struct my_u {  __le64 a ;  __le64 b ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct e1000_adapter * adapter , struct e1000_rx_ring * rx_ring , int * work_done , int work_to_do ) ;
