...
position p;
@@
 const struct pre_pll_config cocci_id@p [ ] ;
...
position p;
@@
 const struct phy_config cocci_id@p [ ] ;
...
position p;
@@
 const struct post_pll_config * cocci_id@p ;
...
position p;
@@
 const struct inno_hdmi_phy_drv_data cocci_id@p ;
...
typedef u8,u16;
@@
 struct post_pll_config {  unsigned long tmdsclock ;  u8 prediv ;  u16 fbdiv ;  u8 postdiv ;  u8 version ; } cocci_id@p ;
...
position p;
@@
 const struct inno_hdmi_phy_ops cocci_id@p ;
...
position p;
@@
 struct inno_hdmi_phy_drv_data cocci_id@p ;
...
position p;
@@
 struct inno_hdmi_phy cocci_id@p ;
...
typedef u8;
@@
 struct phy_config {  unsigned long tmdsclock ;  u8 regs [ 14 ] ; } cocci_id@p ;
...
position p;
@@
 struct inno_hdmi_phy_ops {  int ( * init ) ( struct inno_hdmi_phy * inno ) ;  int ( * power_on ) ( struct inno_hdmi_phy * inno , const struct post_pll_config * cfg , const struct phy_config * phy_cfg ) ;  void ( * power_off ) ( struct inno_hdmi_phy * inno ) ; } cocci_id@p ;
...
position p;
@@
 struct inno_hdmi_phy_drv_data {  const struct inno_hdmi_phy_ops * ops ;  const struct clk_ops * clk_ops ;  const struct phy_config * phy_cfg_table ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct pre_pll_config {  unsigned long pixclock ;  unsigned long tmdsclock ;  u8 prediv ;  u16 fbdiv ;  u8 tmds_div_a ;  u8 tmds_div_b ;  u8 tmds_div_c ;  u8 pclk_div_a ;  u8 pclk_div_b ;  u8 pclk_div_c ;  u8 pclk_div_d ;  u8 vco_div_5_en ;  u32 fracdiv ; } cocci_id@p ;
...
position p;
@@
 struct inno_hdmi_phy {  struct device * dev ;  struct regmap * regmap ;  int irq ;  struct phy * phy ;  struct clk * sysclk ;  struct clk * refoclk ;  struct clk * refpclk ;  const struct inno_hdmi_phy_drv_data * plat_data ;  int chip_version ;  struct clk_hw hw ;  struct clk * phyclk ;  unsigned long pixclock ; } cocci_id@p ;
