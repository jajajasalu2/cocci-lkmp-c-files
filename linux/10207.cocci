...
symbol cocci_id;
position p;
typedef cistpl_vers_1_t;
@@
 cistpl_vers_1_t * cocci_id@p ;
...
position p;
@@
 const struct bin_attribute cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_device_geo_t;
@@
 cistpl_device_geo_t * cocci_id@p ;
...
position p;
@@
 struct pcmcia_socket * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_checksum_t;
@@
 cistpl_checksum_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_format_t;
@@
 cistpl_format_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_org_t;
@@
 cistpl_org_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_vers_2_t;
@@
 cistpl_vers_2_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_mem_t;
@@
 cistpl_mem_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_config_t;
@@
 cistpl_config_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_manfid_t;
@@
 cistpl_manfid_t * cocci_id@p ;
...
position p;
@@
 struct cis_cache_entry cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_cftable_entry_t;
@@
 cistpl_cftable_entry_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_funcid_t;
@@
 cistpl_funcid_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_power_t;
@@
 cistpl_power_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_device_t;
@@
 cistpl_device_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_altstr_t;
@@
 cistpl_altstr_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_funce_t;
@@
 cistpl_funce_t * cocci_id@p ;
...
typedef u_int;
@@
 struct tuple_flags {  u_int link_space : 4 ;  u_int has_link : 1 ;  u_int mfc_fn : 3 ;  u_int space : 4 ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_jedec_t;
@@
 cistpl_jedec_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_longlink_mfc_t;
@@
 cistpl_longlink_mfc_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_longlink_t;
@@
 cistpl_longlink_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cistpl_irq_t;
@@
 cistpl_irq_t * cocci_id@p ;
