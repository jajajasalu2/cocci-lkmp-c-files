...
position p;
@@
 enum rcutorture_type cocci_id@p ;
...
position p;
@@
 struct lock_class_key cocci_id@p [ RCU_NUM_LVLS ] ;
...
position p;
@@
 void cocci_id@p ( unsigned long mask , struct rcu_node * rnp , unsigned long gps , unsigned long flags ) ;
...
position p;
@@
 void cocci_id@p ( struct rcu_node * rnp , int outgoingcpu ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rcu_data * rdp ) ;
...
position p;
@@
 void cocci_id@p ( struct rcu_data * rdp ) ;
...
position p;
@@
 void cocci_id@p ( struct rcu_node * rnp_leaf ) ;
...
position p;
@@
 void cocci_id@p ( int ( * f ) ( struct rcu_data * rdp ) ) ;
