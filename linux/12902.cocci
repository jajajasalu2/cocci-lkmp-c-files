...
typedef u32;
@@
 struct ecc_error_info {  u32 row ;  u32 col ;  u32 bank ;  u32 bitpos ;  u32 data ;  u32 bankgrpnr ;  u32 blknr ; } cocci_id@p ;
...
position p;
@@
 struct synps_edac_priv cocci_id@p ;
...
typedef bool;
@@
 struct synps_platform_data {  int ( * get_error_info ) ( struct synps_edac_priv * priv ) ;  enum mem_type ( * get_mtype ) ( const void __iomem * base ) ;  enum dev_type ( * get_dtype ) ( const void __iomem * base ) ;  bool ( * get_ecc_state ) ( void __iomem * base ) ;  int quirks ; } cocci_id@p ;
...
position p;
@@
 const struct synps_platform_data * cocci_id@p ;
...
position p;
@@
 struct synps_ecc_status * cocci_id@p ;
...
position p;
@@
 struct ecc_error_info * cocci_id@p ;
...
typedef u32;
@@
 struct synps_ecc_status {  u32 ce_cnt ;  u32 ue_cnt ;  struct ecc_error_info ceinfo ;  struct ecc_error_info ueinfo ; } cocci_id@p ;
