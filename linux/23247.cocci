...
position p;
@@
 struct snd_pcm_hw_constraint_ratnums * cocci_id@p ;
...
position p;
@@
 struct pcm512x_priv * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ PCM512x_NUM_SUPPLIES ] ;
...
position p;
@@
 struct pcm512x_priv {  struct regmap * regmap ;  struct clk * sclk ;  struct regulator_bulk_data supplies [ PCM512x_NUM_SUPPLIES ] ;  struct notifier_block supply_nb [ PCM512x_NUM_SUPPLIES ] ;  int fmt ;  int pll_in ;  int pll_out ;  int pll_r ;  int pll_j ;  int pll_d ;  int pll_p ;  unsigned long real_pll ;  unsigned long overclock_pll ;  unsigned long overclock_dac ;  unsigned long overclock_dsp ;  int mute ;  struct mutex mutex ;  unsigned int bclk_ratio ; } cocci_id@p ;
...
position p;
@@
 struct snd_interval cocci_id@p [ 2 ] ;
