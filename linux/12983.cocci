...
position p;
@@
 struct meson_msr {  struct regmap * regmap ;  struct meson_msr_id msr_table [ CLK_MSR_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct meson_msr_id {  struct meson_msr * priv ;  unsigned int id ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct meson_msr_id * cocci_id@p ;
...
position p;
@@
 struct meson_msr_id cocci_id@p [ CLK_MSR_MAX ] ;
...
position p;
@@
 const struct meson_msr_id * cocci_id@p ;
