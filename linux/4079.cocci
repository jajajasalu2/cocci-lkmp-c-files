...
position p;
@@
 struct vhost_vring_addr cocci_id@p ;
...
position p;
@@
 struct vhost_attach_cgroups_struct * cocci_id@p ;
...
position p;
@@
 enum { VHOST_MEMORY_F_LOG = 0x1 , } cocci_id@p ;
...
position p;
@@
 struct vhost_iotlb_msg cocci_id@p ;
...
position p;
@@
 struct vhost_memory cocci_id@p ;
...
position p;
@@
 struct vhost_flush_struct {  struct vhost_work work ;  struct completion wait_event ; } cocci_id@p ;
...
position p;
@@
 struct vhost_umem_node * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef vhost_work_fn_t;
@@
 vhost_work_fn_t cocci_id@p ;
...
position p;
@@
 struct vhost_msg_v2 cocci_id@p ;
...
position p;
@@
 struct vhost_vring_state cocci_id@p ;
...
position p;
@@
 struct vhost_attach_cgroups_struct {  struct vhost_work work ;  struct task_struct * owner ;  int ret ; } cocci_id@p ;
...
position p;
@@
 struct vhost_flush_struct cocci_id@p ;
...
position p;
@@
 struct vhost_msg_node * cocci_id@p ;
...
position p;
@@
 struct vhost_memory_region * cocci_id@p ;
...
position p;
@@
 const struct vhost_umem_node * cocci_id@p ;
...
typedef u64,u32;
@@
 int cocci_id@p ( struct vhost_virtqueue * vq , u64 addr , u32 len , struct iovec iov [ ] , int iov_size , int access ) ;
