...
position p;
@@
 struct dfl_fpga_port_info cocci_id@p ;
...
position p;
@@
 struct dfl_fpga_port_region_info cocci_id@p ;
...
position p;
@@
 struct dfl_fpga_port_dma_unmap cocci_id@p ;
...
position p;
@@
 const struct dfl_feature_ops cocci_id@p ;
...
position p;
@@
 struct dfl_fpga_port_dma_map cocci_id@p ;
...
position p;
@@
 struct dfl_afu_mmio_region cocci_id@p ;
