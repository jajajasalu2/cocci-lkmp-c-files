...
typedef u8,u32,u16;
@@
 struct clk_si514_muldiv {  u32 m_frac ;  u8 m_int ;  u8 ls_div_bits ;  u16 hs_div ; } cocci_id@p ;
...
position p;
@@
 struct clk_si514_muldiv * cocci_id@p ;
...
position p;
@@
 struct clk_si514 {  struct clk_hw hw ;  struct regmap * regmap ;  struct i2c_client * i2c_client ; } cocci_id@p ;
