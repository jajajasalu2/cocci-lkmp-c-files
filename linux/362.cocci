...
position p;
@@
 const struct bpf_lru_node * cocci_id@p ;
...
position p;
@@
 struct bpf_lru_locallist cocci_id@p ;
...
position p;
@@
 enum bpf_lru_list_type cocci_id@p ;
...
position p;
@@
 struct bpf_common_lru * cocci_id@p ;
...
position p;
@@
 const struct bpf_lru_list * cocci_id@p ;
...
position p;
@@
 struct bpf_lru_list cocci_id@p ;
