...
@@
 struct pegasus {  unsigned char * data ;  u8 data_len ;  dma_addr_t data_dma ;  struct input_dev * dev ;  struct usb_device * usbdev ;  struct usb_interface * intf ;  struct urb * irq ;  struct mutex pm_mutex ;  bool is_open ;  char name [ 128 ] ;  char phys [ 64 ] ;  struct work_struct init ; } cocci_id@p ;
