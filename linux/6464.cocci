...
position p;
@@
 struct lp3972_regulator_subdev * cocci_id@p ;
...
position p;
@@
 struct lp3972_platform_data * cocci_id@p ;
...
position p;
@@
 struct lp3972 {  struct device * dev ;  struct mutex io_lock ;  struct i2c_client * i2c ; } cocci_id@p ;
