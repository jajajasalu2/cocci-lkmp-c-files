...
position p;
@@
 enum chips { TPS62360 , TPS62361 , TPS62362 , TPS62363 , } cocci_id@p ;
...
position p;
@@
 struct tps62360_regulator_platform_data * cocci_id@p ;
...
typedef u8,bool;
@@
 struct tps62360_chip {  struct device * dev ;  struct regulator_desc desc ;  struct regulator_dev * rdev ;  struct regmap * regmap ;  int vsel0_gpio ;  int vsel1_gpio ;  u8 voltage_reg_mask ;  bool en_internal_pulldn ;  bool en_discharge ;  bool valid_gpios ;  int lru_index [ 4 ] ;  int curr_vset_vsel [ 4 ] ;  int curr_vset_id ; } cocci_id@p ;
...
position p;
@@
 struct tps62360_chip * cocci_id@p ;
