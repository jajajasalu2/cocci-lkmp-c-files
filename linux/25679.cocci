...
typedef u64,bool;
@@
 struct a2l_data {  const char * input ;  u64 addr ;  bool found ;  const char * filename ;  const char * funcname ;  unsigned line ;  bfd * abfd ;  asymbol * * syms ; } cocci_id@p ;
...
position p;
@@
 struct srcline_node cocci_id@p ;
...
typedef u64;
@@
 struct srcline_node {  u64 addr ;  char * srcline ;  struct rb_node rb_node ; } cocci_id@p ;
