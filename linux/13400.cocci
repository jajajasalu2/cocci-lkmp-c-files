...
position p;
@@
 struct tda9887_priv * cocci_id@p ;
...
position p;
@@
 struct tvnorm {  v4l2_std_id std ;  char * name ;  unsigned char b ;  unsigned char c ;  unsigned char e ; } cocci_id@p ;
...
typedef bool;
@@
 struct tda9887_priv {  struct tuner_i2c_props i2c_props ;  struct list_head hybrid_tuner_instance_list ;  unsigned char data [ 4 ] ;  unsigned int config ;  unsigned int mode ;  unsigned int audmode ;  v4l2_std_id std ;  bool standby ; } cocci_id@p ;
