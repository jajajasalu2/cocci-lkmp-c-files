...
typedef lmc_softc_t;
@@
 void cocci_id@p ( lmc_softc_t * const ) ;
...
typedef lmc_softc_t;
@@
 void cocci_id@p ( lmc_softc_t * , int ) ;
...
typedef lmc_softc_t;
@@
 void cocci_id@p ( lmc_softc_t * const , int ) ;
...
typedef lmc_softc_t;
@@
 int cocci_id@p ( lmc_softc_t * const ) ;
...
symbol cocci_id;
position p;
typedef lmc_av9110_t;
@@
 lmc_av9110_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,lmc_softc_t;
@@
 void cocci_id@p ( lmc_softc_t * , u32 , u32 , u32 , u32 , u32 ) ;
