...
typedef u32;
@@
 void cocci_id@p ( int event , u32 label , struct mpls_route * rt , struct nlmsghdr * nlh , struct net * net , u32 portid , unsigned int nlm_flags ) ;
...
position p;
@@
 struct mpls_pcpu_stats * cocci_id@p ;
...
position p;
@@
 const struct mpls_nh * cocci_id@p ;
...
position p;
@@
 enum mpls_payload_type cocci_id@p ;
...
position p;
@@
 const struct ip_tunnel_encap_ops cocci_id@p ;
...
position p;
@@
 struct mpls_link_stats cocci_id@p ;
...
position p;
@@
 struct mpls_entry_decoded cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "net/mpls/conf/" ) + IFNAMSIZ ] ;
...
position p;
@@
 struct ip_tunnel_encap * cocci_id@p ;
...
position p;
@@
 struct mpls_route_config * cocci_id@p ;
...
position p;
@@
 const struct nl_info * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ NEIGH_NR_TABLES + 1 ] ;
...
position p;
@@
 const struct dn_fib_nh * cocci_id@p ;
...
typedef u8,u32;
@@
 struct mpls_route_config {  u32 rc_protocol ;  u32 rc_ifindex ;  u8 rc_via_table ;  u8 rc_via_alen ;  u8 rc_via [ MAX_VIA_ALEN ] ;  u32 rc_label ;  u8 rc_ttl_propagate ;  u8 rc_output_labels ;  u32 rc_output_label [ MAX_NEW_LABELS ] ;  u32 rc_nlflags ;  enum mpls_payload_type rc_payload_type ;  struct nl_info rc_nlinfo ;  struct rtnexthop * rc_mp ;  int rc_mp_len ; } cocci_id@p ;
...
position p;
@@
 const struct mpls_route * cocci_id@p ;
