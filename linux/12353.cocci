...
position p;
@@
 enum { FIMD_PORT_IN0 , FIMD_PORT_IN1 , FIMD_PORT_IN2 , FIMD_PORT_RGB , FIMD_PORT_WRB , } cocci_id@p ;
...
position p;
@@
 struct exynos_dpi {  struct drm_encoder encoder ;  struct device * dev ;  struct device_node * panel_node ;  struct drm_panel * panel ;  struct drm_connector connector ;  struct videomode * vm ; } cocci_id@p ;
