...
symbol cocci_id;
position p;
typedef efi_set_time_t;
@@
 efi_set_time_t * cocci_id@p ;
...
typedef u64;
@@
 struct kern_memdesc {  u64 attribute ;  u64 start ;  u64 num_pages ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_memory_desc_t;
@@
 efi_memory_desc_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kern_memdesc_t;
@@
 kern_memdesc_t * cocci_id@p ;
...
position p;
@@
 struct ia64_fpreg cocci_id@p [ 6 ] ;
...
symbol cocci_id;
position p;
typedef efi_get_time_t;
@@
 efi_get_time_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_config_table_type_t;
@@
 efi_config_table_type_t cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef efi_get_next_high_mono_count_t;
@@
 efi_get_next_high_mono_count_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_get_variable_t;
@@
 efi_get_variable_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_set_variable_t;
@@
 efi_set_variable_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_time_cap_t;
@@
 efi_time_cap_t * cocci_id@p ;
...
position p;
@@
 struct efi_generic_dev_path * cocci_id@p ;
...
@@
 efi_runtime_services_t * cocci_id@p ;
...
position p;
@@
 struct kern_memdesc * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_freemem_callback_t;
@@
 efi_freemem_callback_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_get_next_variable_t;
@@
 efi_get_next_variable_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_get_wakeup_time_t;
@@
 efi_get_wakeup_time_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_reset_system_t;
@@
 efi_reset_system_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_set_wakeup_time_t;
@@
 efi_set_wakeup_time_t * cocci_id@p ;
