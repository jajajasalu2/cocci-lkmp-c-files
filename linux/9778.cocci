...
position p;
@@
 struct il3945_sta_priv * cocci_id@p ;
...
position p;
@@
 struct il3945_scan_cmd * cocci_id@p ;
...
position p;
@@
 struct il3945_scan_channel * cocci_id@p ;
...
position p;
@@
 struct ieee80211_measurement_params * cocci_id@p ;
...
position p;
@@
 struct il_spectrum_cmd cocci_id@p ;
...
position p;
@@
 const struct il_ucode_header * cocci_id@p ;
...
position p;
@@
 struct il3945_beacon_notif * cocci_id@p ;
...
position p;
@@
 enum il3945_antenna cocci_id@p ;
