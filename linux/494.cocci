...
position p;
@@
 struct show_busy_params cocci_id@p ;
...
position p;
@@
 const struct blk_mq_ops * const cocci_id@p ;
...
position p;
@@
 struct show_busy_params {  struct seq_file * m ;  struct blk_mq_hw_ctx * hctx ; } cocci_id@p ;
...
position p;
@@
 const struct show_busy_params * cocci_id@p ;
