...
position p;
@@
 enum { SUPPLY_SEQ_APLL , SUPPLY_SEQ_TDM_MCK_EN , SUPPLY_SEQ_TDM_BCK_EN , } cocci_id@p ;
...
position p;
@@
 struct mtk_afe_tdm_priv cocci_id@p ;
...
position p;
@@
 enum { TDM_LCK_NON_INV = 0 , TDM_LCK_INV = 1 , } cocci_id@p ;
...
position p;
@@
 struct mtk_afe_tdm_priv {  int bck_id ;  int bck_rate ;  int tdm_out_mode ;  int bck_invert ;  int lck_invert ;  int mclk_id ;  int mclk_multiple ;  int mclk_rate ;  int mclk_apll ; } cocci_id@p ;
...
position p;
@@
 struct mt8183_afe_private * cocci_id@p ;
...
position p;
@@
 enum { TDM_WLEN_16_BIT = 1 , TDM_WLEN_32_BIT = 2 , } cocci_id@p ;
...
position p;
@@
 enum { TDM_CH_START_O30_O31 = 0 , TDM_CH_START_O32_O33 , TDM_CH_START_O34_O35 , TDM_CH_START_O36_O37 , TDM_CH_ZERO , } cocci_id@p ;
...
position p;
@@
 enum { HDMI_BIT_WIDTH_16_BIT = 0 , HDMI_BIT_WIDTH_32_BIT = 1 , } cocci_id@p ;
...
position p;
@@
 enum { TDM_BCK_NON_INV = 0 , TDM_BCK_INV = 1 , } cocci_id@p ;
...
position p;
@@
 enum { HDMI_CONN_CH0 = 0 , HDMI_CONN_CH1 , HDMI_CONN_CH2 , HDMI_CONN_CH3 , HDMI_CONN_CH4 , HDMI_CONN_CH5 , HDMI_CONN_CH6 , HDMI_CONN_CH7 , } cocci_id@p ;
...
position p;
@@
 enum { TDM_OUT_I2S = 0 , TDM_OUT_TDM = 1 , } cocci_id@p ;
...
position p;
@@
 enum { TDM_CHANNEL_BCK_16 = 0 , TDM_CHANNEL_BCK_24 = 1 , TDM_CHANNEL_BCK_32 = 2 , } cocci_id@p ;
...
position p;
@@
 enum { TDM_CHANNEL_NUM_2 = 0 , TDM_CHANNEL_NUM_4 = 1 , TDM_CHANNEL_NUM_8 = 2 , } cocci_id@p ;
