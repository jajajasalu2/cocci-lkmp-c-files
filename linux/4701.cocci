...
position p;
@@
 struct eeprom_93xx46_devtype_data {  unsigned int quirks ; } cocci_id@p ;
...
position p;
@@
 const struct eeprom_93xx46_devtype_data cocci_id@p ;
...
position p;
@@
 struct eeprom_93xx46_dev {  struct spi_device * spi ;  struct eeprom_93xx46_platform_data * pdata ;  struct mutex lock ;  struct nvmem_config nvmem_config ;  struct nvmem_device * nvmem ;  int addrlen ;  int size ; } cocci_id@p ;
...
position p;
@@
 struct eeprom_93xx46_platform_data * cocci_id@p ;
...
position p;
@@
 struct eeprom_93xx46_dev * cocci_id@p ;
