...
position p;
@@
 struct ti_adpll_dco_data {  struct clk_hw hw ; } cocci_id@p ;
...
position p;
@@
 struct ti_adpll_dco_data cocci_id@p ;
...
position p;
@@
 enum ti_adpll_inputs { TI_ADPLL_CLKINP , TI_ADPLL_CLKINPULOW , TI_ADPLL_CLKINPHIF , } cocci_id@p ;
...
position p;
@@
 struct ti_adpll_clock * cocci_id@p ;
...
position p;
@@
 struct ti_adpll_data * cocci_id@p ;
...
position p;
@@
 struct ti_adpll_clock {  struct clk * clk ;  struct clk_lookup * cl ;  void ( * unregister ) ( struct clk * clk ) ; } cocci_id@p ;
...
position p;
@@
 struct ti_adpll_clkout_data {  struct ti_adpll_data * adpll ;  struct clk_gate gate ;  struct clk_hw hw ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct clk * clk ) ;
...
position p;
@@
 const struct ti_adpll_platform_data * cocci_id@p ;
...
position p;
@@
 enum ti_adpll_lj_outputs { TI_ADPLL_LJ_CLKDCOLDO , TI_ADPLL_LJ_CLKOUT , TI_ADPLL_LJ_CLKOUTLDO , } cocci_id@p ;
...
position p;
@@
 enum ti_adpll_clocks cocci_id@p ;
...
position p;
@@
 enum ti_adpll_clocks { TI_ADPLL_DCO , TI_ADPLL_DCO_GATE , TI_ADPLL_N2 , TI_ADPLL_M2 , TI_ADPLL_M2_GATE , TI_ADPLL_BYPASS , TI_ADPLL_HIF , TI_ADPLL_DIV2 , TI_ADPLL_CLKOUT , TI_ADPLL_CLKOUT2 , TI_ADPLL_M3 , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ADPLL_MAX_CON_ID ] ;
...
typedef bool;
@@
 struct ti_adpll_platform_data {  const bool is_type_s ;  const int nr_max_inputs ;  const int nr_max_outputs ;  const int output_index ; } cocci_id@p ;
...
position p;
@@
 struct ti_adpll_clkout_data cocci_id@p ;
...
position p;
@@
 enum ti_adpll_s_outputs { TI_ADPLL_S_DCOCLKLDO , TI_ADPLL_S_CLKOUT , TI_ADPLL_S_CLKOUTX2 , TI_ADPLL_S_CLKOUTHIF , } cocci_id@p ;
