...
position p;
@@
 enum lm3533_boost_ovp cocci_id@p ;
...
position p;
@@
 struct lm3533_device_attribute * cocci_id@p ;
...
position p;
@@
 struct lm3533_platform_data * cocci_id@p ;
...
position p;
@@
 enum lm3533_boost_freq cocci_id@p ;
...
typedef u8;
@@
 struct lm3533_device_attribute {  struct device_attribute dev_attr ;  enum lm3533_attribute_type type ;  union {  struct {  u8 id ; } output ; } u ; } cocci_id@p ;
...
position p;
@@
 enum lm3533_attribute_type cocci_id@p ;
...
position p;
@@
 enum lm3533_attribute_type { LM3533_ATTR_TYPE_BACKLIGHT , LM3533_ATTR_TYPE_LED , } cocci_id@p ;
