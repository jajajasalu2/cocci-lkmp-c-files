...
typedef u8,bool,u32;
@@
 struct xlp_spi_priv {  struct device dev ;  void __iomem * base ;  const u8 * tx_buf ;  u8 * rx_buf ;  int tx_len ;  int rx_len ;  int txerrors ;  int rxerrors ;  int cs ;  u32 spi_clk ;  bool cmd_cont ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 struct xlp_spi_priv * cocci_id@p ;
