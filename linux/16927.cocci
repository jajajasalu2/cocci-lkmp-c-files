...
position p;
@@
 struct touchscreen_properties cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IQS5XX_BL_BLK_LEN_MAX ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ IQS5XX_REC_LEN_MAX ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( * dev_id_info ) + 1 ] ;
...
typedef u8;
@@
 struct iqs5xx_private {  struct i2c_client * client ;  struct input_dev * input ;  struct gpio_desc * reset_gpio ;  struct mutex lock ;  u8 bl_status ; } cocci_id@p ;
...
position p;
@@
 struct iqs5xx_touch_data cocci_id@p [ IQS5XX_NUM_CONTACTS ] ;
...
position p;
@@
 struct iqs5xx_dev_id_info * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IQS5XX_REC_HDR_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( bl_addr ) + IQS5XX_BL_BLK_LEN_MAX ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( reg ) + IQS5XX_WR_BYTES_MAX ] ;
...
position p;
@@
 struct iqs5xx_private * cocci_id@p ;
...
position p;
@@
 struct iqs5xx_ihex_rec * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( bl_cmd ) + sizeof ( bl_addr ) ] ;
...
position p;
@@
 char cocci_id@p [ IQS5XX_FW_FILE_LEN + 1 ] ;
