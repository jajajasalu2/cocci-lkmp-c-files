...
position p;
@@
 struct snd_sof_ipc_msg * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_cmd_hdr cocci_id@p ;
...
position p;
@@
 struct sof_ipc_ctrl_value_chan cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct snd_sof_dev * sdev , u32 msg_cmd ) ;
...
position p;
@@
 struct sof_ipc_dma_trace_posn cocci_id@p ;
...
position p;
@@
 struct sof_ipc_ctrl_data_params * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct snd_sof_dev * sdev , u32 msg_id ) ;
...
typedef u8,u32;
@@
 struct sof_ipc_ctrl_data_params {  size_t msg_bytes ;  size_t hdr_bytes ;  size_t pl_size ;  size_t elems ;  u32 num_msg ;  u8 * src ;  u8 * dst ; } cocci_id@p ;
...
position p;
@@
 enum sof_ipc_ctrl_type cocci_id@p ;
...
position p;
@@
 struct snd_sof_pcm_stream * cocci_id@p ;
...
position p;
@@
 struct sof_ipc_stream_posn cocci_id@p ;
...
typedef bool;
@@
 struct snd_sof_ipc {  struct snd_sof_dev * sdev ;  struct mutex tx_mutex ;  bool disable_ipc_tx ;  struct snd_sof_ipc_msg msg ; } cocci_id@p ;
...
position p;
@@
 enum sof_ipc_ctrl_cmd cocci_id@p ;
...
position p;
@@
 struct sof_ipc_ctrl_value_comp cocci_id@p ;
