...
position p;
@@
 int cocci_id@p ( struct bnx2fc_rport * tgt , struct fcoe_port * port , struct fc_rport_priv * rdata ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct bnx2fc_hba * hba , struct bnx2fc_rport * tgt ) ;
...
position p;
@@
 void cocci_id@p ( struct bnx2fc_hba * hba , struct bnx2fc_rport * tgt ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct bnx2fc_hba * hba , u32 conn_id ) ;
...
position p;
@@
 struct fcoe_conn_db cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct bnx2fc_hba * hba , struct bnx2fc_rport * tgt ) ;
