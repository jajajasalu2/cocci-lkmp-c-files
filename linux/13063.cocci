...
position p;
@@
 struct smem_image_version * cocci_id@p ;
...
position p;
@@
 struct soc_id {  unsigned int id ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 const struct soc_id cocci_id@p [ ] ;
...
typedef __le32;
@@
 struct socinfo {  __le32 fmt ;  __le32 id ;  __le32 ver ;  char build_id [ SMEM_SOCINFO_BUILD_ID_LENGTH ] ;  __le32 raw_id ;  __le32 raw_ver ;  __le32 hw_plat ;  __le32 plat_ver ;  __le32 accessory_chip ;  __le32 hw_plat_subtype ;  __le32 pmic_model ;  __le32 pmic_die_rev ;  __le32 pmic_model_1 ;  __le32 pmic_die_rev_1 ;  __le32 pmic_model_2 ;  __le32 pmic_die_rev_2 ;  __le32 foundry_id ;  __le32 serial_num ;  __le32 num_pmics ;  __le32 pmic_array_offset ;  __le32 chip_family ;  __le32 raw_device_family ;  __le32 raw_device_num ; } cocci_id@p ;
...
position p;
@@
 struct smem_image_version {  char name [ SMEM_IMAGE_VERSION_NAME_SIZE ] ;  char variant [ SMEM_IMAGE_VERSION_VARIANT_SIZE ] ;  char pad ;  char oem [ SMEM_IMAGE_VERSION_OEM_SIZE ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct socinfo_params {  u32 raw_device_family ;  u32 hw_plat_subtype ;  u32 accessory_chip ;  u32 raw_device_num ;  u32 chip_family ;  u32 foundry_id ;  u32 plat_ver ;  u32 raw_ver ;  u32 hw_plat ;  u32 fmt ; } cocci_id@p ;
...
position p;
@@
 struct qcom_socinfo * cocci_id@p ;
