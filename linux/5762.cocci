...
position p;
@@
 struct mct_clock_event_device {  struct clock_event_device evt ;  unsigned long base ;  char name [ 10 ] ; } cocci_id@p ;
...
position p;
@@
 struct mct_clock_event_device * cocci_id@p ;
...
position p;
@@
 enum { MCT_G0_IRQ , MCT_G1_IRQ , MCT_G2_IRQ , MCT_G3_IRQ , MCT_L0_IRQ , MCT_L1_IRQ , MCT_L2_IRQ , MCT_L3_IRQ , MCT_L4_IRQ , MCT_L5_IRQ , MCT_L6_IRQ , MCT_L7_IRQ , MCT_NR_IRQS , } cocci_id@p ;
...
position p;
@@
 enum { MCT_INT_SPI , MCT_INT_PPI , } cocci_id@p ;
