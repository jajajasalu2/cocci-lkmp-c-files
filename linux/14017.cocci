...
@@
 struct packet {  uint16_t start ;  uint8_t direction ;  uint8_t cmd ; } cocci_id@p ;
...
typedef uint8_t;
@@
 struct send_packet {  struct packet header ;  uint8_t length ;  uint8_t channels ;  uint8_t busy7 ;  uint8_t busy4 ;  uint8_t payload [ 0 ] ; } cocci_id@p ;
