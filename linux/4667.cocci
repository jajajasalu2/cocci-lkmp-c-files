...
position p;
@@
 enum prefault_modes cocci_id@p ;
...
typedef u32,u16;
@@
 struct afu_config_record {  struct kobject kobj ;  struct bin_attribute config_attr ;  struct list_head list ;  int cr ;  u16 device ;  u16 vendor ;  u32 class ; } cocci_id@p ;
...
position p;
@@
 struct afu_config_record cocci_id@p ;
