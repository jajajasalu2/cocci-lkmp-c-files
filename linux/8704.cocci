...
position p;
@@
 const struct iavf_priv_flags cocci_id@p [ ] ;
...
typedef bool,u32;
@@
 struct iavf_priv_flags {  char flag_string [ ETH_GSTRING_LEN ] ;  u32 flag ;  bool read_only ; } cocci_id@p ;
...
position p;
@@
 const struct iavf_stats cocci_id@p [ ] ;
...
position p;
@@
 struct iavf_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
