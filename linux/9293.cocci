...
position p;
@@
 struct cmd_ds_mesh_access * cocci_id@p ;
...
position p;
@@
 struct mrvl_mesh_defaults cocci_id@p ;
...
position p;
@@
 struct cmd_ds_mesh_config * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lbs_private * priv ) ;
...
position p;
@@
 struct mrvl_meshie_val cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ MESH_STATS_NUM ] [ ETH_GSTRING_LEN ] ;
