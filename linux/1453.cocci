...
position p;
@@
 const struct uvcg_config_group_type * cocci_id@p ;
...
position p;
@@
 struct configfs_group_operations cocci_id@p ;
...
position p;
@@
 struct uvc_descriptor_header * * * cocci_id@p ;
...
position p;
@@
 enum uvcg_format_type { UVCG_UNCOMPRESSED = 0 , UVCG_MJPEG , } cocci_id@p ;
...
position p;
@@
 struct uvc_input_header_descriptor * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct config_group * fmt ) ;
...
position p;
@@
 struct uvcg_control_class_group {  struct config_group group ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct uvcg_mjpeg {  struct uvcg_format fmt ;  struct uvc_format_mjpeg desc ; } cocci_id@p ;
...
position p;
@@
 struct uvcg_streaming_header * cocci_id@p ;
...
position p;
@@
 struct uvc_processing_unit_descriptor * cocci_id@p ;
...
position p;
@@
 struct uvcg_uncompressed * cocci_id@p ;
...
position p;
@@
 struct uvcg_streaming_class_group cocci_id@p ;
...
position p;
@@
 struct uvcg_uncompressed {  struct uvcg_format fmt ;  struct uvc_format_uncompressed desc ; } cocci_id@p ;
...
position p;
@@
 enum uvcg_strm_type { UVCG_HEADER = 0 , UVCG_FORMAT , UVCG_FRAME , } cocci_id@p ;
...
position p;
@@
 struct uvcg_config_group_type {  struct config_item_type type ;  const char * name ;  const struct uvcg_config_group_type * * children ;  int ( * create_children ) ( struct config_group * group ) ; } cocci_id@p ;
...
position p;
@@
 struct uvcg_streaming_class_group {  struct config_group group ;  const char * name ; } cocci_id@p ;
...
typedef u32;
@@
 char cocci_id@p [ 1 + sizeof ( u32 ) * 8 + 1 + 1 ] ;
...
typedef __u8;
@@
 struct uvcg_format {  struct config_group group ;  enum uvcg_format_type type ;  unsigned linked ;  unsigned num_frames ;  __u8 bmaControls [ UVCG_STREAMING_CONTROL_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct uvcg_control_class_group cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct config_group * parent , const struct uvcg_config_group_type * type ) ;
...
position p;
@@
 struct uvc_camera_terminal_descriptor * cocci_id@p ;
...
position p;
@@
 struct uvcg_streaming_header {  struct config_item item ;  struct uvc_input_header_descriptor desc ;  unsigned linked ;  struct list_head formats ;  unsigned num_fmt ; } cocci_id@p ;
...
position p;
@@
 struct uvcg_control_header cocci_id@p ;
...
position p;
@@
 struct uvcg_format_ptr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * , void * , void * , int , enum uvcg_strm_type type ) ;
...
position p;
@@
 enum uvcg_strm_type cocci_id@p ;
...
position p;
@@
 struct uvcg_format_ptr {  struct uvcg_format * fmt ;  struct list_head entry ; } cocci_id@p ;
