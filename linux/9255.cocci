...
position p;
@@
 struct host_cmd_ds_sta_deauth * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_dtim_period * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_frag_threshold * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_akmp cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_ageout_timer * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_wep_key * cocci_id@p ;
...
position p;
@@
 struct mwifiex_11ac_vht_cfg cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_retry_limit * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_rts_threshold cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_bcast_ssid cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_power_constraint * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_sys_config cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_pwk_cipher cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_wmmcap * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_ssid * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_auth_type cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_list * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_beacon_period * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_encrypt_protocol cocci_id@p ;
...
position p;
@@
 struct mwifiex_types_wmm_info cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_gwk_cipher * cocci_id@p ;
...
position p;
@@
 struct host_cmd_tlv_passphrase * cocci_id@p ;
