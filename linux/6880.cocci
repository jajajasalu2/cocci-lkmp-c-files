...
typedef dma_addr_t;
@@
 struct aha1542_cmd {  struct chain * chain ;  dma_addr_t chain_handle ; } cocci_id@p ;
...
position p;
@@
 struct aha1542_hostdata cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct aha1542_hostdata {  int bios_translation ;  int aha1542_last_mbi_used ;  int aha1542_last_mbo_used ;  struct scsi_cmnd * int_cmds [ AHA1542_MAILBOXES ] ;  struct mailbox * mb ;  dma_addr_t mb_handle ;  struct ccb * ccb ;  dma_addr_t ccb_handle ; } cocci_id@p ;
