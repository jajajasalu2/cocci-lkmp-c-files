...
position p;
@@
 enum adb_iop_state { idle , sending , awaiting_reply , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct adb_request * , int ) ;
...
position p;
@@
 int cocci_id@p ( struct adb_request * ) ;
