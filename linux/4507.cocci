...
position p;
@@
 struct ti_opp_supply_optimum_voltage_table * cocci_id@p ;
...
position p;
@@
 struct ti_opp_supply_data cocci_id@p ;
...
typedef u32;
@@
 struct ti_opp_supply_data {  struct ti_opp_supply_optimum_voltage_table * vdd_table ;  u32 num_vdd_table ;  u32 vdd_absolute_max_voltage_uv ; } cocci_id@p ;
...
position p;
@@
 const struct ti_opp_supply_of_data cocci_id@p ;
...
position p;
@@
 struct dev_pm_opp_supply * cocci_id@p ;
...
position p;
@@
 struct ti_opp_supply_optimum_voltage_table {  unsigned int reference_uv ;  unsigned int optimized_uv ; } cocci_id@p ;
...
position p;
@@
 struct dev_pm_set_opp_data * cocci_id@p ;
