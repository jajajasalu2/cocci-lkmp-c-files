...
symbol cocci_id;
position p;
typedef bool,u32,client_t,regmap_t;
@@
 struct mn88443x_priv {  const struct mn88443x_spec * spec ;  struct dvb_frontend fe ;  struct clk * mclk ;  struct gpio_desc * reset_gpio ;  u32 clk_freq ;  u32 if_freq ;  bool use_clkbuf ;  struct i2c_client * client_s ;  struct regmap * regmap_s ;  struct i2c_client * client_t ;  struct regmap * regmap_t ; } cocci_id@p ;
...
position p;
@@
 const struct mn88443x_spec cocci_id@p ;
...
typedef bool;
@@
 struct mn88443x_spec {  bool primary ; } cocci_id@p ;
...
position p;
@@
 struct mn88443x_spec * cocci_id@p ;
...
position p;
@@
 struct mn88443x_priv * cocci_id@p ;
...
position p;
@@
 struct mn88443x_config * cocci_id@p ;
