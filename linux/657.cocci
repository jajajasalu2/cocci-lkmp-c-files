...
position p;
@@
 struct simd_aead_ctx cocci_id@p ;
...
position p;
@@
 struct simd_aead_ctx {  struct cryptd_aead * cryptd_tfm ; } cocci_id@p ;
...
position p;
@@
 struct simd_skcipher_ctx cocci_id@p ;
...
position p;
@@
 struct simd_aead_alg {  const char * ialg_name ;  struct aead_alg alg ; } cocci_id@p ;
...
position p;
@@
 struct simd_skcipher_ctx {  struct cryptd_skcipher * cryptd_tfm ; } cocci_id@p ;
...
position p;
@@
 struct simd_skcipher_alg {  const char * ialg_name ;  struct skcipher_alg alg ; } cocci_id@p ;
