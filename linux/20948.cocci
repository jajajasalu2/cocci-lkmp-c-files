...
position p;
@@
 char cocci_id@p [ sizeof ( "nnn.nnn.nnn.nnn\0" ) ] ;
...
position p;
@@
 struct etap_pre_exec_data * cocci_id@p ;
...
position p;
@@
 struct ethertap_data * cocci_id@p ;
...
position p;
@@
 struct addr_change {  enum { ADD_ADDR , DEL_ADDR , } what ;  unsigned char addr [ 4 ] ;  unsigned char netmask [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct net_user_info cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "nnnnnn\0" ) ] ;
...
position p;
@@
 struct etap_pre_exec_data {  int control_remote ;  int control_me ;  int data_me ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "nnnnn\0" ) ] ;
