...
position p;
@@
 struct rdma_ucm_query_route_resp cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_migrate_id cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_ud_param * cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_get_event cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_qp_attr cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_conn_param * cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_create_id * cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_resolve_ip cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_join_mcast cocci_id@p ;
...
position p;
@@
 struct ib_client_nl_info * cocci_id@p ;
...
position p;
@@
 struct ucma_context cocci_id@p ;
...
typedef u64,u8,u32;
@@
 struct ucma_multicast {  struct ucma_context * ctx ;  u32 id ;  int events_reported ;  u64 uid ;  u8 join_state ;  struct list_head list ;  struct sockaddr_storage addr ; } cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_accept cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_cmd_hdr cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_query_path_resp * cocci_id@p ;
...
position p;
@@
 ssize_t ( * cocci_id@p [ ] ) ( struct ucma_file * file , const char __user * inbuf , int in_len , int out_len ) ;
...
position p;
@@
 struct rdma_ucm_disconnect cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_join_ip_mcast cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_create_id_resp cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_query_addr_resp cocci_id@p ;
...
@@
 struct ucma_file {  struct mutex mut ;  struct file * filp ;  struct list_head ctx_list ;  struct list_head event_list ;  wait_queue_head_t poll_wait ;  struct workqueue_struct * close_wq ; } cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_query cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_notify cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u32,atomic_t;
@@
 struct ucma_context {  u32 id ;  struct completion comp ;  atomic_t ref ;  int events_reported ;  int backlog ;  struct ucma_file * file ;  struct rdma_cm_id * cm_id ;  u64 uid ;  struct list_head list ;  struct list_head mc_list ;  int closing ;  int destroying ;  struct work_struct close_work ; } cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_migrate_resp cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_connect cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_reject cocci_id@p ;
...
position p;
@@
 struct rdma_ud_param * cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_bind_ip cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_init_qp_attr cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_bind cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_set_option cocci_id@p ;
...
position p;
@@
 struct ucma_event {  struct ucma_context * ctx ;  struct ucma_multicast * mc ;  struct list_head list ;  struct rdma_cm_id * cm_id ;  struct rdma_ucm_event_resp resp ;  struct work_struct close_work ; } cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_destroy_id_resp cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_resolve_addr cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_destroy_id cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_resolve_route cocci_id@p ;
...
position p;
@@
 struct ucma_multicast * cocci_id@p ;
...
position p;
@@
 struct rdma_ucm_listen cocci_id@p ;
