...
position p;
@@
 struct dtt200u_fe_state {  struct dvb_usb_device * d ;  enum fe_status stat ;  struct dtv_frontend_properties fep ;  struct dvb_frontend frontend ;  unsigned char data [ 80 ] ;  struct mutex data_mutex ; } cocci_id@p ;
...
position p;
@@
 struct dtt200u_fe_state * cocci_id@p ;
