...
position p;
@@
 struct qnx4_sb_info * cocci_id@p ;
...
position p;
@@
 struct qnx4_inode_info cocci_id@p ;
...
position p;
@@
 struct qnx4_inode_entry * cocci_id@p ;
...
position p;
@@
 struct qnx4_super_block * cocci_id@p ;
