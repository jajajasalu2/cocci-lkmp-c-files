...
@@
 struct qcom_smsm {  struct device * dev ;  u32 local_host ;  u32 num_hosts ;  u32 num_entries ;  u32 * local_state ;  u32 * subscription ;  struct qcom_smem_state * state ;  spinlock_t lock ;  struct smsm_entry * entries ;  struct smsm_host * hosts ; } cocci_id@p ;
...
typedef u32;
@@
 struct smsm_entry {  struct qcom_smsm * smsm ;  struct irq_domain * domain ; 
	 DECLARE_BITMAP ( irq_enabled , 32 ) 
		 ; 
	 DECLARE_BITMAP ( irq_rising , 32 ) 
		 ; 
	 DECLARE_BITMAP ( irq_falling , 32 ) 
		 ;  u32 last_value ;  u32 * remote_state ;  u32 * subscription ; } cocci_id@p ;
...
position p;
@@
 struct smsm_host {  struct regmap * ipc_regmap ;  int ipc_offset ;  int ipc_bit ; } cocci_id@p ;
...
position p;
@@
 const struct qcom_smem_state_ops cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 num_hosts ;  u32 num_entries ;  u32 reserved0 ;  u32 reserved1 ; } * cocci_id@p ;
