...
position p;
@@
 struct lb035q02_device {  struct drm_panel panel ;  struct spi_device * spi ;  struct gpio_desc * enable_gpio ; } cocci_id@p ;
...
typedef u16;
@@
 const struct {  u16 index ;  u16 value ; } cocci_id@p [ ] ;
...
position p;
@@
 struct lb035q02_device * cocci_id@p ;
