...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_CTINFO_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_CTINFO_MAX + 1 ] ;
...
position p;
@@
 struct tcf_ctinfo_params * cocci_id@p ;
