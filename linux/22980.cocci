...
position p;
@@
 enum snd_jack_types cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ SND_JACK_SWITCH_TYPES ] ;
...
position p;
@@
 struct snd_jack_kctl * cocci_id@p ;
...
position p;
@@
 struct snd_jack_kctl {  struct snd_kcontrol * kctl ;  struct list_head list ;  unsigned int mask_bits ; } cocci_id@p ;
