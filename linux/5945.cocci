...
position p;
@@
 const struct pistachio_function cocci_id@p [ ] ;
...
position p;
@@
 const struct pistachio_pin_group cocci_id@p [ ] ;
...
position p;
@@
 struct pistachio_pin_group {  const char * name ;  unsigned int pin ;  int mux_option [ 3 ] ;  int mux_reg ;  int mux_shift ;  int mux_mask ; } cocci_id@p ;
...
position p;
@@
 struct pistachio_gpio_bank cocci_id@p [ ] ;
...
position p;
@@
 struct pistachio_gpio_bank {  struct pistachio_pinctrl * pctl ;  void __iomem * base ;  unsigned int pin_base ;  unsigned int npins ;  struct gpio_chip gpio_chip ;  struct irq_chip irq_chip ; } cocci_id@p ;
...
position p;
@@
 struct pistachio_pinctrl * cocci_id@p ;
...
position p;
@@
 struct pistachio_function {  const char * name ;  const char * const * groups ;  unsigned int ngroups ;  const int * scenarios ;  unsigned int nscenarios ;  unsigned int scenario_reg ;  unsigned int scenario_shift ;  unsigned int scenario_mask ; } cocci_id@p ;
