...
position p;
@@
 const struct recent_table * cocci_id@p ;
...
position p;
@@
 struct recent_iter_state {  const struct recent_table * table ;  unsigned int bucket ; } cocci_id@p ;
...
position p;
@@
 struct recent_entry * cocci_id@p ;
...
typedef u8;
@@
 struct recent_table {  struct list_head list ;  char name [ XT_RECENT_NAME_LEN ] ;  union nf_inet_addr mask ;  unsigned int refcnt ;  unsigned int entries ;  u8 nstamps_max_mask ;  struct list_head lru_list ;  struct list_head iphash [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct recent_entry * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_int8_t,u_int16_t;
@@
 struct recent_entry {  struct list_head list ;  struct list_head lru_list ;  union nf_inet_addr addr ;  u_int16_t family ;  u_int8_t ttl ;  u_int8_t index ;  u_int16_t nstamps ;  unsigned long stamps [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct recent_table * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "+b335:1d35:1e55:dead:c0de:1715:5afe:c0de" ) ] ;
...
position p;
@@
 struct xt_recent_mtinfo_v1 cocci_id@p ;
...
position p;
@@
 struct recent_iter_state * cocci_id@p ;
...
position p;
@@
 struct xt_recent_mtinfo cocci_id@p ;
...
position p;
@@
 const struct xt_recent_mtinfo_v1 * cocci_id@p ;
...
position p;
@@
 const struct xt_recent_mtinfo_v0 * cocci_id@p ;
