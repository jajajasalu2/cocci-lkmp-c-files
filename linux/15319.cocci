...
position p;
@@
 enum { ASMTYPE_UNKNOWN , ASMTYPE_TOPAZ , ASMTYPE_JASPER , ASMTYPE_PEARL , ASMTYPE_JUNIPER , ASMTYPE_SPRUCE , } cocci_id@p ;
...
position p;
@@
 struct ibmasr_id {  const char * desc ;  int type ; } cocci_id@p ;
