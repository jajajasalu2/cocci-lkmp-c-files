...
position p;
@@
 struct saa7164_histogram cocci_id@p ;
...
position p;
@@
 struct tmComResBusInfo * cocci_id@p ;
...
position p;
@@
 struct tmComResInterfaceDescr cocci_id@p ;
...
position p;
@@
 struct tmComResHWDescr cocci_id@p ;
...
position p;
@@
 struct saa7164_fw_status * cocci_id@p ;
...
position p;
@@
 struct tmComResBusDescr cocci_id@p ;
