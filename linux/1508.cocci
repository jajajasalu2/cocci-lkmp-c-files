...
position p;
@@
 int cocci_id@p ( struct usb_ep * ep ) ;
...
position p;
@@
 struct dwc2_hsotg_ep cocci_id@p ;
...
position p;
@@
 struct dwc2_hsotg_req * cocci_id@p ;
...
position p;
@@
 struct dwc2_dregs_backup * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct usb_ep * ep , int value , bool now ) ;
