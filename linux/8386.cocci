...
position p;
@@
 struct cmsg_reply_map_free_tbl * cocci_id@p ;
...
position p;
@@
 struct cmsg_req_map_op cocci_id@p ;
...
position p;
@@
 struct cmsg_reply_map_op * cocci_id@p ;
...
position p;
@@
 struct cmsg_reply_map_alloc_tbl * cocci_id@p ;
...
position p;
@@
 struct cmsg_reply_map_simple * cocci_id@p ;
...
position p;
@@
 struct cmsg_req_map_alloc_tbl * cocci_id@p ;
...
position p;
@@
 struct cmsg_req_map_free_tbl * cocci_id@p ;
...
position p;
@@
 const struct nfp_ccm_hdr * cocci_id@p ;
