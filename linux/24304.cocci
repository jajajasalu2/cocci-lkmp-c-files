...
position p;
@@
 struct seq_net_private cocci_id@p ;
...
position p;
@@
 const struct sadb_address * cocci_id@p ;
...
position p;
@@
 struct sadb_supported cocci_id@p ;
...
position p;
@@
 const struct sadb_x_sec_ctx * cocci_id@p ;
...
position p;
@@
 struct sadb_spirange cocci_id@p ;
...
position p;
@@
 const struct sadb_ext * cocci_id@p ;
...
position p;
@@
 struct sadb_lifetime cocci_id@p ;
...
position p;
@@
 const struct proto_ops cocci_id@p ;
...
position p;
@@
 struct sadb_address cocci_id@p ;
...
position p;
@@
 const struct net_proto_family cocci_id@p ;
...
position p;
@@
 const struct sadb_key * cocci_id@p ;
...
position p;
@@
 const struct xfrm_mark cocci_id@p ;
...
position p;
@@
 struct sadb_x_kmaddress * cocci_id@p ;
...
@@
 struct pfkey_sock {  struct sock sk ;  int registered ;  int promisc ;  struct {  uint8_t msg_version ;  uint32_t msg_portid ;  int ( * dump ) ( struct pfkey_sock * sk ) ;  void ( * done ) ( struct pfkey_sock * sk ) ;  union {  struct xfrm_policy_walk policy ;  struct xfrm_state_walk state ; } u ;  struct sk_buff * skb ; } dump ;  struct mutex dump_lock ; } cocci_id@p ;
...
position p;
@@
 struct sadb_x_nat_t_type cocci_id@p ;
...
position p;
@@
 const struct xfrm_encap_tmpl * cocci_id@p ;
...
position p;
@@
 const struct sadb_sa * cocci_id@p ;
...
typedef atomic_t;
@@
 struct netns_pfkey {  struct hlist_head table ;  atomic_t socks_nr ; } cocci_id@p ;
...
position p;
@@
 struct sadb_x_policy * cocci_id@p ;
...
position p;
@@
 struct sadb_x_filter cocci_id@p ;
...
position p;
@@
 struct sadb_x_nat_t_port * cocci_id@p ;
...
position p;
@@
 struct sadb_x_sec_ctx * cocci_id@p ;
...
position p;
@@
 const struct km_event * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sock * sk , struct sk_buff * skb , const struct sadb_msg * hdr , void * const * ext_hdrs ) ;
...
position p;
@@
 struct xfrm_address_filter * cocci_id@p ;
...
position p;
@@
 struct sadb_x_ipsecrequest cocci_id@p ;
...
position p;
@@
 struct xfrm_algo_desc * cocci_id@p ;
...
position p;
@@
 struct xfrm_user_sec_ctx * cocci_id@p ;
...
position p;
@@
 const struct sadb_lifetime * cocci_id@p ;
...
position p;
@@
 const struct xfrm_algo_desc * cocci_id@p ;
...
position p;
@@
 const struct sadb_x_sa2 * cocci_id@p ;
...
position p;
@@
 const struct sadb_x_nat_t_type * cocci_id@p ;
...
position p;
@@
 struct sadb_x_kmprivate cocci_id@p ;
...
position p;
@@
 const struct sadb_msg * cocci_id@p ;
...
position p;
@@
 const struct sadb_x_nat_t_port * cocci_id@p ;
...
position p;
@@
 struct xfrm_migrate cocci_id@p [ XFRM_MAX_DEPTH ] ;
...
position p;
@@
 const pfkey_handler cocci_id@p [ SADB_MAX + 1 ] ;
...
position p;
@@
 const struct xfrm_kmaddress * cocci_id@p ;
