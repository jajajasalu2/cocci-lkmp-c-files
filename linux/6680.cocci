...
typedef uint8_t;
@@
 struct ahd_hard_error_entry {  uint8_t errno ;  const char * errmesg ; } cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct ahd_devinfo * devinfo , u_int period , u_int offset , u_int bus_width , u_int ppr_options ) ;
...
position p;
@@
 struct ahd_completion * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vpd_config * vpd ) ;
...
symbol cocci_id;
position p;
typedef bus_dmamap_callback_t;
@@
 bus_dmamap_callback_t cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct ahd_devinfo * devinfo , u_int lun , cam_status status , char * message , int verbose_level ) ;
...
position p;
@@
 struct ahd_tmode_tstate * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * ahd , int enable ) ;
...
position p;
@@
 struct scb_platform_data * cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , u_int intstat ) ;
...
position p;
@@
 struct ahd_tmode_lstate * * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ahd_softc * ahd , struct scb * scb ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , u_int lqistat1 ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , u_int targid_mask ) ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct ahd_devinfo * devinfo ) ;
...
position p;
@@
 int cocci_id@p ( struct ahd_softc * ahd ) ;
...
typedef u_int;
@@
 int cocci_id@p ( struct ahd_softc * ahd , const struct patch * * start_patch , u_int start_instr , u_int * skip_addr ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct ahd_tmode_lstate * lstate , u_int initiator_id , u_int event_type , u_int event_arg ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct ahd_devinfo * devinfo , u_int period , u_int offset ) ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * ahd , int paused ) ;
...
typedef u_int;
@@
 u_int cocci_id@p ( struct ahd_softc * ahd , u_int address ) ;
...
position p;
@@
 struct ahd_dma64_seg * cocci_id@p ;
...
position p;
@@
 struct seeprom_config * cocci_id@p ;
...
position p;
@@
 struct ccb_immed_notify * cocci_id@p ;
...
typedef u_int;
@@
 int cocci_id@p ( struct ahd_softc * ahd , ahd_msgtype type , u_int msgval , int full ) ;
...
position p;
@@
 struct initiator_status * cocci_id@p ;
...
typedef u_int;
@@
 u_int cocci_id@p ( struct ahd_softc * ahd ) ;
...
position p;
@@
 struct scsi_status_iu_header * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ sizeof ( ahd -> iocell_opts ) ] ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct scb * scb , u_int col_idx ) ;
...
position p;
@@
 struct ahd_transinfo * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * ahd ) ;
...
position p;
@@
 int cocci_id@p ( struct ahd_softc * ahd , struct target_cmd * cmd ) ;
...
position p;
@@
 struct ahd_tmode_event * cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , u_int timer , u_int maxcmds , u_int mincmds ) ;
...
typedef u_int;
@@
 u_int cocci_id@p ( struct ahd_softc * ahd , u_int scbid , u_int prev , u_int next , u_int tid ) ;
...
position p;
@@
 const struct ahd_phase_table_entry cocci_id@p [ ] ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DOWNLOAD_CONST_COUNT ] ;
...
position p;
@@
 const struct ahd_phase_table_entry * cocci_id@p ( int phase ) ;
...
position p;
@@
 struct ccb_accept_tio * cocci_id@p ;
...
position p;
@@
 struct ahd_initiator_tinfo * cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , u_int tcl , u_int scbid ) ;
...
position p;
@@
 const struct ahd_hard_error_entry cocci_id@p [ ] ;
...
position p;
@@
 struct cs cocci_id@p [ NUM_CRITICAL_SECTIONS ] ;
...
position p;
@@
 struct hardware_scb * cocci_id@p ;
...
position p;
@@
 enum { AHDMSG_1B , AHDMSG_2B , AHDMSG_EXT , } cocci_id@p ;
...
typedef u_int;
@@
 u_int cocci_id@p ( struct ahd_softc * ahd , u_int tcl ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , u_int scsi_id , char channel , int force ) ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct ahd_devinfo * devinfo , struct scb * scb ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , u_int scbid ) ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct ahd_devinfo * devinfo , u_int bus_width ) ;
...
typedef u_int;
@@
 int cocci_id@p ( struct ahd_softc * ahd , u_int busfreetime ) ;
...
position p;
@@
 int cocci_id@p ( struct ahd_softc * ahd , struct ahd_devinfo * devinfo ) ;
...
typedef u_int;
@@
 struct ahd_tmode_tstate * cocci_id@p ( struct ahd_softc * ahd , u_int scsi_id , char channel ) ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct scb * scb ) ;
...
symbol cocci_id;
position p;
typedef bus_dma_segment_t;
@@
 bus_dma_segment_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct scb * prev_scb , struct scb * scb ) ;
...
typedef u_int;
@@
 u_int cocci_id@p [ NUM_CRITICAL_SECTIONS ] ;
...
position p;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct ahd_devinfo * devinfo , struct ahd_transinfo * tinfo ) ;
...
symbol cocci_id;
position p;
typedef ahd_reg_parse_entry_t;
@@
 const ahd_reg_parse_entry_t * cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , u_int tid_prev , u_int tid_cur , u_int tid_next ) ;
