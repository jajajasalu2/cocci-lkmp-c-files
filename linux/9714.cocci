...
position p;
@@
 struct iwlagn_tx_power_dbm_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_bt_cmd_v2 cocci_id@p ;
...
position p;
@@
 struct iwlagn_d3_config_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_basic_bt_cmd cocci_id@p ;
...
position p;
@@
 struct iwlagn_p1k_cache * cocci_id@p ;
...
position p;
@@
 struct iwl_txfifo_flush_cmd_v3 cocci_id@p ;
...
position p;
@@
 struct iwl_bt_uart_msg * cocci_id@p ;
...
position p;
@@
 struct iwlagn_wowlan_wakeup_filter_cmd cocci_id@p ;
...
position p;
@@
 struct iwlagn_wowlan_kek_kck_material_cmd cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ IWLAGN_P1K_SIZE ] ;
...
position p;
@@
 struct iwlagn_wowlan_patterns_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_bt_cmd_v1 cocci_id@p ;
...
position p;
@@
 struct iwl_txfifo_flush_cmd_v2 cocci_id@p ;
...
position p;
@@
 struct iwlagn_wowlan_tkip_params_cmd cocci_id@p ;
