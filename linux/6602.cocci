...
position p;
@@
 void cocci_id@p ( struct bfa_ioc_s * ioc , enum bfi_ioc_state fwstate ) ;
...
position p;
@@
 struct bfa_ioc_hwif_s cocci_id@p ;
...
typedef bfa_boolean_t;
@@
 bfa_boolean_t cocci_id@p ( struct bfa_ioc_s * ioc ) ;
...
position p;
@@
 enum bfi_ioc_state cocci_id@p ( struct bfa_ioc_s * ioc ) ;
...
typedef u32;
@@
 struct {  u32 hfn_mbox , lpu_mbox , hfn_pgn ; } cocci_id@p [ ] ;
...
typedef uint32_t;
@@
 struct {  uint32_t hfn_mbox , lpu_mbox , hfn_pgn , hfn , lpu , lpu_read ; } cocci_id@p [ ] ;
