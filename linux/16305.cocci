...
position p;
@@
 const struct internal_subdev cocci_id@p [ NUM_IPU_SUBDEVS ] ;
...
position p;
@@
 struct internal_link {  int remote ;  int local_pad ;  int remote_pad ; } cocci_id@p ;
...
position p;
@@
 const struct internal_link * cocci_id@p ;
...
position p;
@@
 struct internal_pad {  int num_links ;  struct internal_link link [ MAX_INTERNAL_LINKS ] ; } cocci_id@p ;
...
position p;
@@
 const struct internal_pad * cocci_id@p ;
...
position p;
@@
 const struct internal_subdev * cocci_id@p ;
...
typedef u32;
@@
 struct internal_subdev {  u32 grp_id ;  struct internal_pad pad [ MAX_INTERNAL_PADS ] ;  struct v4l2_subdev * ( * sync_register ) ( struct v4l2_device * v4l2_dev , struct device * ipu_dev , struct ipu_soc * ipu , u32 grp_id ) ;  int ( * sync_unregister ) ( struct v4l2_subdev * sd ) ; } cocci_id@p ;
...
position p;
@@
 struct internal_subdev cocci_id@p ;
