...
position p;
@@
 struct cp210x_flow_ctl cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * ) ;
...
position p;
@@
 void cocci_id@p ( struct usb_serial_port * p , int on ) ;
...
position p;
@@
 const struct cp210x_rate cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial * ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct usb_serial_port * ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , struct usb_serial_port * ) ;
...
position p;
@@
 struct cp210x_pin_mode cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * , struct usb_serial_port * , struct ktermios * ) ;
...
position p;
@@
 struct cp210x_serial_private * cocci_id@p ;
...
typedef bool,__u8;
@@
 struct cp210x_port_private {  __u8 bInterfaceNumber ;  bool has_swapped_line_ctl ; } cocci_id@p ;
...
position p;
@@
 struct cp210x_comm_status * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * , unsigned int , unsigned int ) ;
...
position p;
@@
 struct cp210x_gpio_write cocci_id@p ;
...
position p;
@@
 struct cp210x_single_port_config cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usb_serial * ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * port , unsigned int , unsigned int ) ;
...
position p;
@@
 struct cp210x_dual_port_config cocci_id@p ;
...
typedef speed_t;
@@
 struct cp210x_rate {  speed_t rate ;  speed_t high ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * , struct usb_serial_port * ) ;
...
position p;
@@
 struct cp210x_port_private * cocci_id@p ;
