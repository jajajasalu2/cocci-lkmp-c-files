...
position p;
@@
 enum ssb_clksrc { SSB_CHIPCO_CLKSRC_PCI , SSB_CHIPCO_CLKSRC_XTALOS , SSB_CHIPCO_CLKSRC_LOPWROS , } cocci_id@p ;
...
position p;
@@
 struct ssb_serial_port * cocci_id@p ;
