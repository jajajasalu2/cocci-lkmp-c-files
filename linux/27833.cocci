...
position p;
@@
 struct o2nm_cluster cocci_id@p ;
...
position p;
@@
 struct o2nm_node_group {  struct config_group ns_group ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ O2NM_FENCE_METHODS ] ;
...
position p;
@@
 struct o2nm_cluster_group cocci_id@p ;
...
position p;
@@
 struct o2nm_node_group cocci_id@p ;
...
position p;
@@
 struct o2nm_cluster_group {  struct configfs_subsystem cs_subsys ; } cocci_id@p ;
...
position p;
@@
 enum { O2NM_NODE_ATTR_NUM = 0 , O2NM_NODE_ATTR_PORT , O2NM_NODE_ATTR_ADDRESS , } cocci_id@p ;
