...
position p;
@@
 struct nouveau_dmem {  struct nouveau_drm * drm ;  struct dev_pagemap pagemap ;  struct nouveau_dmem_migrate migrate ;  struct list_head chunk_free ;  struct list_head chunk_full ;  struct list_head chunk_empty ;  struct mutex mutex ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nouveau_migrate_copy_t;
@@
 struct nouveau_dmem_migrate {  nouveau_migrate_copy_t copy_func ;  struct nouveau_channel * chan ; } cocci_id@p ;
...
position p;
@@
 struct nouveau_dmem_chunk * cocci_id@p ;
...
position p;
@@
 const struct dev_pagemap_ops cocci_id@p ;
...
position p;
@@
 struct nouveau_dmem cocci_id@p ;
...
position p;
@@
 enum nouveau_aper { NOUVEAU_APER_VIRT , NOUVEAU_APER_VRAM , NOUVEAU_APER_HOST , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct nouveau_dmem_chunk {  struct list_head list ;  struct nouveau_bo * bo ;  struct nouveau_drm * drm ;  unsigned long pfn_first ;  unsigned long callocated ;  unsigned long bitmap [ BITS_TO_LONGS ( DMEM_CHUNK_NPAGES ) ] ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct nouveau_drm * drm , u64 npages , enum nouveau_aper , u64 dst_addr , enum nouveau_aper , u64 src_addr ) ;
