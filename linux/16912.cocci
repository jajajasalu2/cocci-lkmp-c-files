...
position p;
@@
 struct cyapa_reg_data * cocci_id@p ;
...
position p;
@@
 const struct cyapa_touch * cocci_id@p ;
...
position p;
@@
 const struct cyapa_cmd_len cocci_id@p [ ] ;
...
typedef u8;
@@
 struct cyapa_cmd_len {  u8 cmd ;  u8 len ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ CYAPA_CMD_LEN + 1 ] ;
...
position p;
@@
 struct gen3_write_block_cmd cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cyapa * cyapa ) ;
