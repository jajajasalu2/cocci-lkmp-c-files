...
typedef u32;
@@
 struct hsdk_pll_cfg {  u32 rate ;  u32 idiv ;  u32 fbdiv ;  u32 odiv ;  u32 band ; } cocci_id@p ;
...
position p;
@@
 struct hsdk_pll_clk cocci_id@p ;
...
position p;
@@
 struct hsdk_pll_clk {  struct clk_hw hw ;  void __iomem * regs ;  void __iomem * spec_regs ;  const struct hsdk_pll_devdata * pll_devdata ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 const struct hsdk_pll_devdata cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hsdk_pll_clk * , unsigned long , const struct hsdk_pll_cfg * ) ;
...
position p;
@@
 const struct hsdk_pll_cfg * cocci_id@p ;
