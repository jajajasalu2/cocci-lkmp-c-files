...
position p;
@@
 struct ubi_eba_entry {  int pnum ; } cocci_id@p ;
...
position p;
@@
 struct ubi_ltree_entry cocci_id@p ;
...
position p;
@@
 struct ubi_eba_table {  struct ubi_eba_entry * entries ; } cocci_id@p ;
...
position p;
@@
 struct ubi_eba_entry * cocci_id@p ;
...
position p;
@@
 struct ubi_eba_table * cocci_id@p ;
