...
position p;
@@
 struct drbd_connection * cocci_id@p ;
...
position p;
@@
 struct drbd_backing_dev * cocci_id@p ;
...
position p;
@@
 struct drbd_device * const cocci_id@p ;
...
position p;
@@
 struct one_flush_context {  struct drbd_device * device ;  struct issue_flush_context * ctx ; } cocci_id@p ;
...
position p;
@@
 struct p_block_desc cocci_id@p ;
...
position p;
@@
 enum determine_dev_size cocci_id@p ;
...
position p;
@@
 struct drbd_peer_device * cocci_id@p ;
...
position p;
@@
 struct drbd_device_work * cocci_id@p ;
...
position p;
@@
 struct meta_sock_cmd * cocci_id@p ;
...
position p;
@@
 struct drbd_resource * cocci_id@p ;
...
position p;
@@
 struct drbd_peer_device * const cocci_id@p ;
...
position p;
@@
 struct p_connection_features cocci_id@p ;
...
position p;
@@
 struct p_req_state_reply cocci_id@p ;
...
position p;
@@
 enum chg_state_flags cocci_id@p ;
...
position p;
@@
 struct packet_info {  enum drbd_packet cmd ;  unsigned int size ;  unsigned int vnr ;  void * data ; } cocci_id@p ;
...
position p;
@@
 struct drbd_interval * cocci_id@p ;
...
position p;
@@
 struct p_compressed_bm * cocci_id@p ;
...
position p;
@@
 struct p_rs_param_89 cocci_id@p ;
...
position p;
@@
 struct p_barrier_ack * cocci_id@p ;
...
position p;
@@
 struct one_flush_context * cocci_id@p ;
...
position p;
@@
 const struct drbd_device * cocci_id@p ;
...
position p;
@@
 struct issue_flush_context * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drbd_connection * connection ) ;
...
position p;
@@
 struct data_cmd {  int expect_payload ;  unsigned int pkt_size ;  int ( * fn ) ( struct drbd_connection * , struct packet_info * ) ; } cocci_id@p ;
...
position p;
@@
 enum drbd_bitmap_code cocci_id@p ;
...
position p;
@@
 struct drbd_peer_request cocci_id@p ;
...
position p;
@@
 struct drbd_connection * const cocci_id@p ;
...
position p;
@@
 struct meta_sock_cmd {  size_t pkt_size ;  int ( * fn ) ( struct drbd_connection * connection , struct packet_info * ) ; } cocci_id@p ;
...
position p;
@@
 enum drbd_req_event cocci_id@p ;
...
position p;
@@
 struct bio_and_error cocci_id@p ;
...
position p;
@@
 enum finish_epoch cocci_id@p ( struct drbd_connection * , struct drbd_epoch * , enum epoch_event ) ;
...
position p;
@@
 const struct data_cmd * cocci_id@p ;
...
position p;
@@
 struct p_rs_param_95 cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drbd_peer_device * ) ;
...
position p;
@@
 enum drbd_after_sb_p cocci_id@p ;
...
position p;
@@
 struct accept_wait_data {  struct drbd_connection * connection ;  struct socket * s_listen ;  struct completion door_bell ;  void ( * original_sk_state_change ) ( struct sock * sk ) ; } cocci_id@p ;
...
position p;
@@
 struct drbd_request cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drbd_connection * connection ) ;
...
position p;
@@
 struct p_delay_probe93 cocci_id@p ;
...
position p;
@@
 struct accept_wait_data * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SHARED_SECRET_MAX ] ;
...
position p;
@@
 int cocci_id@p ( struct drbd_work * , int ) ;
...
position p;
@@
 const enum drbd_role cocci_id@p ;
...
typedef atomic_t;
@@
 struct issue_flush_context {  atomic_t pending ;  int error ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 enum finish_epoch { FE_STILL_LIVE , FE_DESTROYED , FE_RECYCLED , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drbd_connection * , void * , struct packet_info * ) ;
...
position p;
@@
 enum drbd_disk_state cocci_id@p ;
...
position p;
@@
 enum write_ordering_e cocci_id@p ;
