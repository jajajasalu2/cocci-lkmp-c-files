...
position p;
@@
 enum saa711x_model { SAA7111A , SAA7111 , SAA7113 , GM7113C , SAA7114 , SAA7115 , SAA7118 , } cocci_id@p ;
...
position p;
@@
 struct saa711x_state cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CHIP_VER_SIZE + 1 ] ;
...
position p;
@@
 enum saa711x_pads { SAA711X_PAD_IF_INPUT , SAA711X_PAD_VID_OUT , SAA711X_NUM_PADS , } cocci_id@p ;
...
position p;
@@
 struct saa7115_platform_data * cocci_id@p ;
...
position p;
@@
 struct v4l2_decode_vbi_line * cocci_id@p ;
