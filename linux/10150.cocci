...
position p;
@@
 enum intel_pdi_type cocci_id@p ;
...
position p;
@@
 struct sdw_cdns_streams * cocci_id@p ;
...
position p;
@@
 struct sdw_intel_link_res * cocci_id@p ;
...
position p;
@@
 struct sdw_cdns_dma_data * cocci_id@p ;
...
position p;
@@
 struct sdw_cdns_stream_config * cocci_id@p ;
...
position p;
@@
 struct sdw_master_ops cocci_id@p ;
...
position p;
@@
 enum intel_pdi_type { INTEL_PDI_IN = 0 , INTEL_PDI_OUT = 1 , INTEL_PDI_BD = 2 , } cocci_id@p ;
...
position p;
@@
 struct sdw_cdns_pdi * cocci_id@p ;
