...
typedef bool,u16;
@@
 struct arizona_extcon_info {  struct device * dev ;  struct arizona * arizona ;  struct mutex lock ;  struct regulator * micvdd ;  struct input_dev * input ;  u16 last_jackdet ;  int micd_mode ;  const struct arizona_micd_config * micd_modes ;  int micd_num_modes ;  const struct arizona_micd_range * micd_ranges ;  int num_micd_ranges ;  int micd_timeout ;  bool micd_reva ;  bool micd_clamp ;  struct delayed_work hpdet_work ;  struct delayed_work micd_detect_work ;  struct delayed_work micd_timeout_work ;  bool hpdet_active ;  bool hpdet_done ;  bool hpdet_retried ;  int num_hpdet_res ;  unsigned int hpdet_res [ 3 ] ;  bool mic ;  bool detecting ;  int jack_flips ;  int hpdet_ip_version ;  struct extcon_dev * edev ;  struct gpio_desc * micd_pol_gpio ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct arizona_extcon_info * info ) ;
...
position p;
@@
 struct arizona_extcon_info cocci_id@p ;
...
position p;
@@
 struct {  int min ;  int max ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  unsigned int threshold ;  unsigned int factor_a ;  unsigned int factor_b ; } cocci_id@p [ ] ;
...
position p;
@@
 struct arizona_micd_config * cocci_id@p ;
...
position p;
@@
 const struct arizona_micd_config cocci_id@p [ ] ;
...
position p;
@@
 const struct arizona_micd_range cocci_id@p [ ] ;
