...
position p;
@@
 const struct denali_dt_data cocci_id@p ;
...
position p;
@@
 struct denali_dt {  struct denali_controller controller ;  struct clk * clk ;  struct clk * clk_x ;  struct clk * clk_ecc ; } cocci_id@p ;
...
position p;
@@
 struct denali_controller * cocci_id@p ;
...
position p;
@@
 struct denali_dt_data {  unsigned int revision ;  unsigned int caps ;  const struct nand_ecc_caps * ecc_caps ; } cocci_id@p ;
