...
typedef u16;
@@
 struct ds3000_state {  struct i2c_adapter * i2c ;  const struct ds3000_config * config ;  struct dvb_frontend frontend ;  u16 prevUCBS2 ; } cocci_id@p ;
...
position p;
@@
 const struct ds3000_config * cocci_id@p ;
...
position p;
@@
 struct ds3000_state * cocci_id@p ;
