...
position p;
@@
 const struct ivtv_card * cocci_id@p [ ] ;
...
position p;
@@
 const struct ivtv_card_video_input * cocci_id@p ;
...
position p;
@@
 const struct ivtv_card_audio_input * cocci_id@p ;
...
position p;
@@
 struct ivtv_card_tuner_i2c cocci_id@p ;
...
position p;
@@
 const struct ivtv_card_pci_info cocci_id@p [ ] ;
...
position p;
@@
 const struct ivtv_card_output * cocci_id@p ;
...
position p;
@@
 struct ivtv_card_output cocci_id@p [ ] ;
