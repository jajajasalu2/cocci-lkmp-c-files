...
position p;
@@
 struct ad9389b_state_edid * cocci_id@p ;
...
position p;
@@
 struct ad9389b_edid_detect cocci_id@p ;
...
typedef u8,u32;
@@
 struct ad9389b_state_edid {  u32 blocks ;  u32 segments ;  u8 data [ EDID_MAX_SEGM * 256 ] ;  unsigned read_retries ; } cocci_id@p ;
...
position p;
@@
 struct ad9389b_state cocci_id@p ;
...
position p;
@@
 struct ad9389b_monitor_detect cocci_id@p ;
...
position p;
@@
 struct ad9389b_platform_data * cocci_id@p ;
...
typedef bool;
@@
 struct ad9389b_state {  struct ad9389b_platform_data pdata ;  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler hdl ;  int chip_revision ;  bool power_on ;  bool have_monitor ;  struct v4l2_dv_timings dv_timings ;  struct v4l2_ctrl * hdmi_mode_ctrl ;  struct v4l2_ctrl * hotplug_ctrl ;  struct v4l2_ctrl * rx_sense_ctrl ;  struct v4l2_ctrl * have_edid0_ctrl ;  struct v4l2_ctrl * rgb_quantization_range_ctrl ;  struct i2c_client * edid_i2c_client ;  struct ad9389b_state_edid edid ;  unsigned edid_detect_counter ;  struct delayed_work edid_handler ; } cocci_id@p ;
