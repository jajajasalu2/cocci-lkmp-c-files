...
position p;
@@
 unsigned char cocci_id@p [ LCD_PORTS ] [ LCD_BITS ] [ BIT_STATES ] ;
...
position p;
@@
 struct logical_input * cocci_id@p ;
...
typedef bool;
@@
 struct {  bool enabled ; } cocci_id@p ;
...
position p;
@@
 const struct charlcd_ops cocci_id@p ;
...
typedef bool;
@@
 struct {  bool enabled ;  bool initialized ;  int charset ;  int proto ;  struct {  int e ;  int rs ;  int rw ;  int cl ;  int da ;  int bl ; } pins ;  struct charlcd * charlcd ; } cocci_id@p ;
...
position p;
@@
 enum input_state { INPUT_ST_LOW , INPUT_ST_RISING , INPUT_ST_HIGH , INPUT_ST_FALLING , } cocci_id@p ;
...
position p;
@@
 enum input_type { INPUT_TYPE_STD , INPUT_TYPE_KBD , } cocci_id@p ;
