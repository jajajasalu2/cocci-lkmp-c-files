...
position p;
@@
 struct mvpp2_cls_lookup_entry * cocci_id@p ;
...
position p;
@@
 struct mvpp2_rfs_rule * cocci_id@p ;
...
position p;
@@
 struct mvpp2_ethtool_fs * cocci_id@p ;
...
position p;
@@
 const struct mvpp2_cls_flow cocci_id@p [ MVPP2_N_PRS_FLOWS ] ;
...
position p;
@@
 struct mvpp2_rss_table * cocci_id@p ;
