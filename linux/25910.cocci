...
@@
 volatile sig_atomic_t cocci_id@p ;
...
position p;
@@
 long ( * cocci_id@p ) ( struct timeval * tv , struct timezone * tz ) ;
...
position p;
@@
 long ( * cocci_id@p ) ( unsigned * , unsigned * , void * ) ;
...
position p;
@@
 const struct timeval * cocci_id@p ;
...
typedef clockid_t;
@@
 int ( * cocci_id@p ) ( clockid_t , struct timespec * ) ;
