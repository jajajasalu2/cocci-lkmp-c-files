...
position p;
@@
 struct dw_mipi_dsi_rockchip cocci_id@p ;
...
position p;
@@
 const struct rockchip_dw_dsi_chip_data cocci_id@p [ ] ;
...
position p;
@@
 enum { BANDGAP_97_07 , BANDGAP_98_05 , BANDGAP_99_02 , BANDGAP_100_00 , BANDGAP_93_17 , BANDGAP_94_15 , BANDGAP_95_12 , BANDGAP_96_10 , } cocci_id@p ;
...
@@
 struct dw_mipi_dsi_rockchip {  struct device * dev ;  struct drm_encoder encoder ;  void __iomem * base ;  struct regmap * grf_regmap ;  struct clk * pllref_clk ;  struct clk * grf_clk ;  struct clk * phy_cfg_clk ;  bool is_slave ;  struct dw_mipi_dsi_rockchip * slave ;  unsigned int lane_mbps ;  u16 input_div ;  u16 feedback_div ;  u32 format ;  struct dw_mipi_dsi * dmd ;  const struct rockchip_dw_dsi_chip_data * cdata ;  struct dw_mipi_dsi_plat_data pdata ;  int devcnt ; } cocci_id@p ;
...
position p;
@@
 enum { BIASEXTR_87_1 , BIASEXTR_91_5 , BIASEXTR_95_9 , BIASEXTR_100 , BIASEXTR_105_94 , BIASEXTR_111_88 , BIASEXTR_118_8 , BIASEXTR_127_7 , } cocci_id@p ;
...
typedef u8;
@@
 struct dphy_pll_parameter_map {  unsigned int max_mbps ;  u8 hsfreqrange ;  u8 icpctrl ;  u8 lpfctrl ; } cocci_id@p ;
...
position p;
@@
 const struct dphy_pll_parameter_map cocci_id@p [ ] ;
...
position p;
@@
 const struct dw_mipi_dsi_phy_ops cocci_id@p ;
...
position p;
@@
 const struct dw_mipi_dsi_host_ops cocci_id@p ;
...
typedef u32;
@@
 struct rockchip_dw_dsi_chip_data {  u32 reg ;  u32 lcdsel_grf_reg ;  u32 lcdsel_big ;  u32 lcdsel_lit ;  u32 enable_grf_reg ;  u32 enable ;  u32 lanecfg1_grf_reg ;  u32 lanecfg1 ;  u32 lanecfg2_grf_reg ;  u32 lanecfg2 ;  unsigned int flags ;  unsigned int max_data_lanes ; } cocci_id@p ;
