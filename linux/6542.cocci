...
typedef u32;
@@
 struct sym_ccb * cocci_id@p ( struct sym_hcb * np , u32 dsa ) ;
...
position p;
@@
 void cocci_id@p ( struct sym_hcb * np ) ;
...
position p;
@@
 void cocci_id@p ( struct sym_hcb * np , struct sym_ccb * cp ) ;
...
position p;
@@
 int cocci_id@p ( struct sym_hcb * np , struct sym_ccb * cp ) ;
...
position p;
@@
 struct sym_ccb * cocci_id@p ( struct sym_hcb * np ) ;
...
position p;
@@
 void cocci_id@p ( struct sym_hcb * ) ;
...
typedef u_char;
@@
 void cocci_id@p ( struct sym_hcb * np , u_char tn , u_char ln ) ;
