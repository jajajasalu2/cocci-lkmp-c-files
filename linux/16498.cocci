...
position p;
@@
 struct cmhid {  struct input_dev * input_dev ;  struct hid_device * hid ;  unsigned short switch_map [ CM6533_JD_TYPE_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ CM6533_JD_TYPE_COUNT ] ;
