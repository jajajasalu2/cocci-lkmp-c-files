...
position p;
@@
 struct adapter_stats cocci_id@p ;
...
typedef u64;
@@
 struct queue_port_stats {  u64 tso ;  u64 uso ;  u64 tx_csum ;  u64 rx_csum ;  u64 vlan_ex ;  u64 vlan_ins ;  u64 gro_pkts ;  u64 gro_merged ; } cocci_id@p ;
...
typedef u64;
@@
 struct adapter_stats {  u64 db_drop ;  u64 db_full ;  u64 db_empty ;  u64 wc_success ;  u64 wc_fail ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ] [ ETH_GSTRING_LEN ] ;
