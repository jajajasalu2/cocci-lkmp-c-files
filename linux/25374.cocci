...
typedef bench_fn_t;
@@
 struct bench {  const char * name ;  const char * summary ;  bench_fn_t fn ; } cocci_id@p ;
...
position p;
@@
 struct collection {  const char * name ;  const char * summary ;  struct bench * benchmarks ; } cocci_id@p ;
