...
typedef u8;
@@
 const u8 cocci_id@p [ 2 ] [ NUM_FABRIC_SERDES ] ;
...
typedef u8,u32;
@@
 struct firmware_details {  const struct firmware * fw ;  struct css_header * css_header ;  u8 * firmware_ptr ;  u32 firmware_len ;  u8 * modulus ;  u8 * exponent ;  u8 * signature ;  u8 * r2 ;  u8 * mu ;  struct augmented_firmware_file dummy_header ; } cocci_id@p ;
...
typedef u8;
@@
 struct firmware_file {  struct css_header css_header ;  u8 modulus [ KEY_SIZE ] ;  u8 exponent [ EXPONENT_SIZE ] ;  u8 signature [ KEY_SIZE ] ;  u8 firmware [ ] ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ NUM_PCIE_SERDES ] ;
...
position p;
@@
 struct augmented_firmware_file * cocci_id@p ;
...
typedef u32;
@@
 struct css_header {  u32 module_type ;  u32 header_len ;  u32 header_version ;  u32 module_id ;  u32 module_vendor ;  u32 date ;  u32 size ;  u32 key_size ;  u32 modulus_size ;  u32 exponent_size ;  u32 reserved [ 22 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hfi1_devdata * dd , struct firmware_details * fdet ) ;
...
typedef u32;
@@
 u32 cocci_id@p [ NUM_FABRIC_SERDES ] ;
...
position p;
@@
 struct platform_config_cache * cocci_id@p ;
...
position p;
@@
 struct firmware_details * cocci_id@p ;
...
position p;
@@
 struct firmware_file cocci_id@p ;
...
typedef u8;
@@
 struct augmented_firmware_file {  struct css_header css_header ;  u8 modulus [ KEY_SIZE ] ;  u8 exponent [ EXPONENT_SIZE ] ;  u8 signature [ KEY_SIZE ] ;  u8 r2 [ KEY_SIZE ] ;  u8 mu [ MU_SIZE ] ;  u8 firmware [ ] ; } cocci_id@p ;
...
position p;
@@
 enum fw_state { FW_EMPTY , FW_TRY , FW_FINAL , FW_ERR , } cocci_id@p ;
...
position p;
@@
 enum platform_config_table_type_encoding cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ PLATFORM_CONFIG_TABLE_MAX ] ;
...
position p;
@@
 void cocci_id@p ( struct firmware_details * fdet ) ;
...
typedef u8;
@@
 const u8 cocci_id@p [ 2 ] [ NUM_PCIE_SERDES ] ;
