...
position p;
@@
 struct cx231xx_dvb {  struct dvb_frontend * frontend [ CX231XX_DVB_MAX_FRONTENDS ] ;  struct mutex lock ;  int nfeeds ;  struct dvb_adapter adapter ;  struct dvb_demux demux ;  struct dmxdev dmxdev ;  struct dmx_frontend fe_hw ;  struct dmx_frontend fe_mem ;  struct dvb_net net ;  struct i2c_client * i2c_client_demod [ 2 ] ;  struct i2c_client * i2c_client_tuner ; } cocci_id@p ;
...
position p;
@@
 struct s5h1432_config cocci_id@p ;
...
position p;
@@
 struct r820t_config cocci_id@p ;
