...
position p;
@@
 struct reply_tx_error_statistics cocci_id@p ;
...
position p;
@@
 struct iwl_tt_restriction * cocci_id@p ;
...
position p;
@@
 struct statistics_dbg * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ 256 * NUM_IWL_RXON_CTX ] ;
...
position p;
@@
 struct statistics_general cocci_id@p ;
...
position p;
@@
 struct iwl_powertable_cmd * cocci_id@p ;
...
position p;
@@
 struct reply_agg_tx_error_statistics cocci_id@p ;
...
position p;
@@
 struct statistics_div * cocci_id@p ;
