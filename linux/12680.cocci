...
position p;
@@
 struct sunxi_rsb_driver * cocci_id@p ;
...
position p;
@@
 struct sunxi_rsb_device * cocci_id@p ;
...
position p;
@@
 const struct sunxi_rsb_driver * cocci_id@p ;
...
position p;
@@
 struct sunxi_rsb {  struct device * dev ;  void __iomem * regs ;  struct clk * clk ;  struct reset_control * rstc ;  struct completion complete ;  struct mutex lock ;  unsigned int status ; } cocci_id@p ;
...
position p;
@@
 const struct sunxi_rsb_addr_map cocci_id@p [ ] ;
...
position p;
@@
 struct sunxi_rsb_ctx * cocci_id@p ;
...
position p;
@@
 struct sunxi_rsb_ctx {  struct sunxi_rsb_device * rdev ;  int size ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct sunxi_rsb_addr_map {  u16 hwaddr ;  u8 rtaddr ; } cocci_id@p ;
