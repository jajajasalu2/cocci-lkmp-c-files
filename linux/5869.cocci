...
position p;
@@
 struct s3c64xx_eint0_data * cocci_id@p ;
...
@@
 irq_flow_handler_t cocci_id@p [ NUM_EINT0_IRQ ] ;
...
typedef u8;
@@
 struct s3c64xx_eint0_domain_data {  struct samsung_pin_bank * bank ;  u8 eints [ ] ; } cocci_id@p ;
...
position p;
@@
 struct s3c64xx_eint_gpio_data {  struct samsung_pinctrl_drv_data * drvdata ;  struct irq_domain * domains [ ] ; } cocci_id@p ;
...
position p;
@@
 struct s3c64xx_eint0_domain_data * cocci_id@p ;
...
typedef u8;
@@
 struct s3c64xx_eint0_data {  struct samsung_pinctrl_drv_data * drvdata ;  struct irq_domain * domains [ NUM_EINT0 ] ;  u8 pins [ NUM_EINT0 ] ; } cocci_id@p ;
...
position p;
@@
 struct s3c64xx_eint_gpio_data * cocci_id@p ;
