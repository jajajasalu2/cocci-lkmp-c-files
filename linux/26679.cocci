...
position p;
@@
 const pre_test_func cocci_id@p [ ] ;
...
position p;
@@
 enum test_type { HASH_PREALLOC , PERCPU_HASH_PREALLOC , HASH_KMALLOC , PERCPU_HASH_KMALLOC , LRU_HASH_PREALLOC , NOCOMMON_LRU_HASH_PREALLOC , LPM_KMALLOC , HASH_LOOKUP , ARRAY_LOOKUP , INNER_LRU_HASH_PREALLOC , LRU_HASH_LOOKUP , NR_TESTS , } cocci_id@p ;
...
position p;
@@
 struct bpf_map_data * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ NR_TESTS ] ;
