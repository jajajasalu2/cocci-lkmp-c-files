...
position p;
@@
 const struct af9015_rc_setup cocci_id@p [ ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ AF9015_EEPROM_SIZE ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "ITE Technologies, Inc." ) ] ;
...
position p;
@@
 struct af9015_state * cocci_id@p ;
...
position p;
@@
 struct af9013_platform_data * cocci_id@p ;
...
position p;
@@
 struct af9015_rc_setup {  unsigned int id ;  char * rc_codes ; } cocci_id@p ;
...
position p;
@@
 struct tda18218_config cocci_id@p ;
...
position p;
@@
 struct mc44s803_config cocci_id@p ;
