...
position p;
@@
 enum ad9834_supported_device_ids { ID_AD9833 , ID_AD9834 , ID_AD9837 , ID_AD9838 , } cocci_id@p ;
...
position p;
@@
 struct ad9834_state * cocci_id@p ;
...
position p;
@@
 struct ad9834_state {  struct spi_device * spi ;  struct regulator * reg ;  struct clk * mclk ;  unsigned short control ;  unsigned short devid ;  struct spi_transfer xfer ;  struct spi_message msg ;  struct spi_transfer freq_xfer [ 2 ] ;  struct spi_message freq_msg ;  struct mutex lock ;  __be16 data ____cacheline_aligned ;  __be16 freq_data [ 2 ] ; } cocci_id@p ;
