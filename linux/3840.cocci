...
position p;
@@
 enum spu2_hash_type cocci_id@p ;
...
position p;
@@
 enum spu2_cipher_mode cocci_id@p ;
...
position p;
@@
 enum spu2_cipher_type cocci_id@p ;
...
position p;
@@
 enum spu_cipher_alg cocci_id@p ;
...
position p;
@@
 enum spu_cipher_type cocci_id@p ;
...
position p;
@@
 enum spu2_hash_mode cocci_id@p ;
...
position p;
@@
 enum spu_cipher_mode cocci_id@p ;
...
position p;
@@
 enum spu2_proto_sel cocci_id@p ;
...
position p;
@@
 enum spu2_proto_sel { SPU2_PROTO_RESV = 0 , SPU2_MACSEC_SECTAG8_ECB = 1 , SPU2_MACSEC_SECTAG8_SCB = 2 , SPU2_MACSEC_SECTAG16 = 3 , SPU2_MACSEC_SECTAG16_8_XPN = 4 , SPU2_IPSEC = 5 , SPU2_IPSEC_ESN = 6 , SPU2_TLS_CIPHER = 7 , SPU2_TLS_AEAD = 8 , SPU2_DTLS_CIPHER = 9 , SPU2_DTLS_AEAD = 10 , } cocci_id@p ;
