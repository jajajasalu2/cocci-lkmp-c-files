...
symbol cocci_id;
position p;
typedef phy_interface_t,sja1105_mii_role_t;
@@
 struct sja1105_dt_port {  phy_interface_t phy_mode ;  sja1105_mii_role_t role ; } cocci_id@p ;
...
position p;
@@
 struct sja1105_l2_forwarding_params_entry * cocci_id@p ;
...
position p;
@@
 struct sja1105_private cocci_id@p ;
...
position p;
@@
 struct sja1105_table * cocci_id@p ;
...
position p;
@@
 struct sja1105_l2_lookup_params_entry cocci_id@p ;
...
position p;
@@
 struct sja1105_xmii_params_entry * cocci_id@p ;
...
position p;
@@
 enum sja1105_reset_reason cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sja1105_phy_interface_t;
@@
 sja1105_phy_interface_t cocci_id@p ;
...
position p;
@@
 struct sja1105_tagger_data * cocci_id@p ;
...
position p;
@@
 struct sja1105_dt_port * cocci_id@p ;
...
position p;
@@
 struct sja1105_vlan_lookup_entry * cocci_id@p ;
...
position p;
@@
 struct sja1105_l2_lookup_entry * cocci_id@p ;
...
position p;
@@
 struct sja1105_dt_port cocci_id@p [ SJA1105_NUM_PORTS ] ;
...
position p;
@@
 const struct sja1105_l2_lookup_entry * cocci_id@p ;
...
position p;
@@
 struct sja1105_l2_policing_entry * cocci_id@p ;
...
position p;
@@
 const struct sja1105_regs * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SJA1105_SIZE_DEVICE_ID ] ;
...
position p;
@@
 struct sja1105_l2_forwarding_entry * cocci_id@p ;
...
position p;
@@
 struct sja1105_general_params_entry cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ SJA1105_NUM_PORTS ] ;
...
symbol cocci_id;
position p;
typedef sja1105_speed_t;
@@
 sja1105_speed_t cocci_id@p ;
...
position p;
@@
 struct sja1105_mgmt_entry cocci_id@p ;
...
position p;
@@
 struct sja1105_port * cocci_id@p ;
...
position p;
@@
 struct sja1105_mac_config_entry cocci_id@p ;
...
position p;
@@
 const struct sja1105_dt_port * cocci_id@p ;
