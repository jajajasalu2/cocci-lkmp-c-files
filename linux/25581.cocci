...
position p;
@@
 struct unwind_libunwind_ops * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef unw_regnum_t;
@@
 unw_regnum_t cocci_id@p ;
...
position p;
@@
 struct eh_frame_hdr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef unw_dyn_info_t;
@@
 unw_dyn_info_t cocci_id@p ;
...
position p;
@@
 struct unwind_info {  struct perf_sample * sample ;  struct machine * machine ;  struct thread * thread ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef unw_cursor_t;
@@
 unw_cursor_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef unw_accessors_t;
@@
 unw_accessors_t cocci_id@p ;
...
typedef u32;
@@
 struct table_entry {  u32 start_ip_offset ;  u32 fde_offset ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef unwind_entry_cb_t;
@@
 unwind_entry_cb_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef unw_proc_info_t;
@@
 unw_proc_info_t * cocci_id@p ;
...
typedef unw_word_t;
@@
 unw_word_t cocci_id@p [ max_stack ] ;
...
symbol cocci_id;
position p;
typedef unw_addr_space_t;
@@
 unw_addr_space_t cocci_id@p ;
