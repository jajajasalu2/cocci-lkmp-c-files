...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_pp_rate_limit_in ) ] ;
...
position p;
@@
 struct mlx5_rl_entry * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_scheduling_element_in ) ] ;
...
position p;
@@
 struct mlx5_rl_table * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_pp_rate_limit_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( modify_scheduling_element_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( destroy_scheduling_element_in ) ] ;
