...
typedef spinlock_t;
@@
 struct phonet_port {  struct f_phonet * usb ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct f_phonet_opts cocci_id@p ;
...
position p;
@@
 const struct usb_cdc_header_desc cocci_id@p ;
