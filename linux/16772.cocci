...
position p;
@@
 struct rmi_2d_sensor * cocci_id@p ;
...
position p;
@@
 struct rmi_driver_data * cocci_id@p ;
...
typedef bool,u16;
@@
 struct f12_data {  struct rmi_2d_sensor sensor ;  struct rmi_2d_sensor_platform_data sensor_pdata ;  bool has_dribble ;  u16 data_addr ;  struct rmi_register_descriptor query_reg_desc ;  struct rmi_register_descriptor control_reg_desc ;  struct rmi_register_descriptor data_reg_desc ;  const struct rmi_register_desc_item * data1 ;  u16 data1_offset ;  const struct rmi_register_desc_item * data5 ;  u16 data5_offset ;  const struct rmi_register_desc_item * data6 ;  u16 data6_offset ;  const struct rmi_register_desc_item * data9 ;  u16 data9_offset ;  const struct rmi_register_desc_item * data15 ;  u16 data15_offset ;  unsigned long * abs_mask ;  unsigned long * rel_mask ; } cocci_id@p ;
...
position p;
@@
 struct rmi_function_handler cocci_id@p ;
...
position p;
@@
 struct rmi_device_platform_data * cocci_id@p ;
...
position p;
@@
 struct rmi_2d_sensor_abs_object * cocci_id@p ;
...
position p;
@@
 struct input_mt_pos cocci_id@p ;
...
position p;
@@
 struct rmi_function * cocci_id@p ;
...
position p;
@@
 const struct rmi_register_desc_item * cocci_id@p ;
