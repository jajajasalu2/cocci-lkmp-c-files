...
position p;
@@
 struct tcp6_request_sock cocci_id@p ;
...
position p;
@@
 struct tcp6_pseudohdr * cocci_id@p ;
...
position p;
@@
 struct inet_protosw cocci_id@p ;
...
position p;
@@
 struct inet6_protocol cocci_id@p ;
...
position p;
@@
 const struct ipv6_pinfo * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct sock * sk , struct sk_buff * skb , struct request_sock * req ) ;
...
position p;
@@
 struct ip6_flowlabel * cocci_id@p ;
...
position p;
@@
 struct tcp6_timewait_sock cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct sock * sk , struct sk_buff * skb ) ;
