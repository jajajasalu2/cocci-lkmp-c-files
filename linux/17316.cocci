...
typedef u64,u32;
@@
 struct spa_data {  u64 phb_opal_id ;  u32 bdfn ; } cocci_id@p ;
...
typedef bool,u16;
@@
 struct npu_link {  struct list_head list ;  int domain ;  int bus ;  int dev ;  u16 fn_desired_actags [ 8 ] ;  struct actag_range fn_actags [ 8 ] ;  bool assignment_done ; } cocci_id@p ;
...
typedef u16;
@@
 struct actag_range {  u16 start ;  u16 count ; } cocci_id@p ;
