...
typedef bool;
@@
 struct emac_rockchip_soc_data {  unsigned int grf_offset ;  unsigned int grf_mode_offset ;  unsigned int grf_speed_offset ;  bool need_div_macclk ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_priv_data * cocci_id@p ;
...
position p;
@@
 struct rockchip_priv_data {  struct arc_emac_priv emac ;  struct regmap * grf ;  const struct emac_rockchip_soc_data * soc_data ;  struct regulator * regulator ;  struct clk * refclk ;  struct clk * macclk ; } cocci_id@p ;
...
position p;
@@
 const struct emac_rockchip_soc_data cocci_id@p ;
