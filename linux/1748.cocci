...
typedef u8,u32;
@@
 struct as3935_state {  struct spi_device * spi ;  struct iio_trigger * trig ;  struct mutex lock ;  struct delayed_work work ;  unsigned long noise_tripped ;  u32 tune_cap ;  u32 nflwdth_reg ;  u8 buffer [ 16 ] ;  u8 buf [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct as3935_state cocci_id@p ;
