...
position p;
@@
 struct pip_fixed_info * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ GEN6_MAX_RX_NUM + 10 ] ;
...
position p;
@@
 struct gen6_interval_setting * cocci_id@p ;
...
typedef u8;
@@
 struct pip_fixed_info {  u8 silicon_id_high ;  u8 silicon_id_low ;  u8 family_id ; } cocci_id@p ;
