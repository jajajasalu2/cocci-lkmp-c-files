...
position p;
@@
 enum lcnphy_papd_cal_type { LCNPHY_PAPD_CAL_CW , LCNPHY_PAPD_CAL_OFDM , } cocci_id@p ;
...
position p;
@@
 struct brcms_phy_lcnphy cocci_id@p ;
...
position p;
@@
 const struct lcnphy_radio_regs * cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ LCNPHY_NUM_TX_DIG_FILTERS_CCK ] [ LCNPHY_NUM_DIG_FILT_COEFFS + 1 ] ;
...
position p;
@@
 const struct phytbl_info * cocci_id@p ;
...
position p;
@@
 struct lcnphy_spb_tone cocci_id@p ;
...
position p;
@@
 enum lcnphy_cal_mode { LCNPHY_CAL_FULL , LCNPHY_CAL_RECAL , LCNPHY_CAL_CURRECAL , LCNPHY_CAL_DIGCAL , LCNPHY_CAL_GCTRL , } cocci_id@p ;
...
position p;
@@
 struct lcnphy_iq_est cocci_id@p ;
...
typedef s16;
@@
 struct lcnphy_spb_tone {  s16 re ;  s16 im ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ BRCMS_NUM_RATES_CCK + BRCMS_NUM_RATES_OFDM + BRCMS_NUM_RATES_MCS_1_STREAM ] ;
...
position p;
@@
 const struct chan_info_2064_lcnphy cocci_id@p [ ] ;
...
position p;
@@
 struct lcnphy_txgains cocci_id@p ;
...
position p;
@@
 const struct lcnphy_tx_gain_tbl_entry * cocci_id@p ;
...
position p;
@@
 enum lcnphy_cal_mode cocci_id@p ;
...
position p;
@@
 const iqcal_gain_params_lcnphy cocci_id@p [ ] ;
...
typedef u8,s16;
@@
 struct lcnphy_rx_iqcomp {  u8 chan ;  s16 a ;  s16 b ; } cocci_id@p ;
...
typedef u16;
@@
 struct lcnphy_sfo_cfg {  u16 ptcentreTs20 ;  u16 ptcentreFactor ; } cocci_id@p ;
...
position p;
@@
 enum lcnphy_tssi_mode { LCNPHY_TSSI_PRE_PA , LCNPHY_TSSI_POST_PA , LCNPHY_TSSI_EXT , } cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ LCNPHY_NUM_TX_DIG_FILTERS_OFDM ] [ LCNPHY_NUM_DIG_FILT_COEFFS + 1 ] ;
...
position p;
@@
 const struct lcnphy_spb_tone * cocci_id@p ;
...
typedef u8,uint;
@@
 struct chan_info_2064_lcnphy {  uint chan ;  uint freq ;  u8 logen_buftune ;  u8 logen_rccr_tx ;  u8 txrf_mix_tune_ctrl ;  u8 pa_input_tune_g ;  u8 logen_rccr_rx ;  u8 pa_rxrf_lna1_freq_tune ;  u8 pa_rxrf_lna2_freq_tune ;  u8 rxrf_rxrf_spare1 ; } cocci_id@p ;
...
position p;
@@
 struct lcnphy_unsign16_struct cocci_id@p ;
...
position p;
@@
 const struct lcnphy_sfo_cfg cocci_id@p [ ] ;
...
typedef u16;
@@
 struct lcnphy_txgains {  u16 gm_gain ;  u16 pga_gain ;  u16 pad_gain ;  u16 dac_gain ; } cocci_id@p ;
...
position p;
@@
 enum lcnphy_tssi_mode cocci_id@p ;
...
position p;
@@
 const struct lcnphy_rx_iqcomp cocci_id@p [ ] ;
...
typedef u32;
@@
 struct lcnphy_iq_est {  u32 iq_prod ;  u32 i_pwr ;  u32 q_pwr ; } cocci_id@p ;
...
position p;
@@
 const iqcal_gain_params_lcnphy * cocci_id@p [ 1 ] ;
...
typedef u16;
@@
 struct lcnphy_unsign16_struct {  u16 re ;  u16 im ; } cocci_id@p ;
