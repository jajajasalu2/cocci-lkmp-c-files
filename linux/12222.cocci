...
position p;
@@
 struct drm_etnaviv_gem_submit_pmr * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_gem_submit * cocci_id@p ;
...
position p;
@@
 struct etnaviv_vram_mapping * cocci_id@p ;
...
position p;
@@
 struct etnaviv_perfmon_request cocci_id@p ;
...
position p;
@@
 struct etnaviv_gem_submit_bo * * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_gem_submit_reloc * cocci_id@p ;
...
position p;
@@
 struct drm_etnaviv_gem_submit_bo * cocci_id@p ;
...
position p;
@@
 const struct drm_etnaviv_gem_submit_reloc * cocci_id@p ;
