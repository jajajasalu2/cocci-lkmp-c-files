...
@@
 struct pcie_port {  u8 index ;  u8 root_bus_nr ;  void __iomem * base ;  spinlock_t conf_lock ;  char mem_space_name [ 16 ] ;  struct resource res ; } cocci_id@p ;
