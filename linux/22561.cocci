...
position p;
@@
 enum { ATI_PCM_OUT , ATI_PCM_IN , NUM_ATI_PCMS , } cocci_id@p ;
...
position p;
@@
 struct atiixp_modem * cocci_id@p ;
...
position p;
@@
 enum { ATI_PCMDEV_ANALOG , NUM_ATI_PCMDEVS , } cocci_id@p ;
...
position p;
@@
 enum { ATI_DMA_PLAYBACK , ATI_DMA_CAPTURE , NUM_ATI_DMAS , } cocci_id@p ;
