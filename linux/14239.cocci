...
position p;
@@
 enum bdisp_dev_flags { ST_M2M_OPEN , ST_M2M_RUNNING , ST_M2M_SUSPENDED , ST_M2M_SUSPENDING , } cocci_id@p ;
...
position p;
@@
 const struct bdisp_fmt cocci_id@p [ ] ;
...
position p;
@@
 const struct bdisp_frame cocci_id@p ;
