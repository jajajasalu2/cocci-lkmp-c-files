...
position p;
@@
 void cocci_id@p ( struct mgsl_struct * info , char * buf , int size ) ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , int enable ) ;
...
position p;
@@
 void cocci_id@p ( char * TargetPtr , const char * SourcePtr , unsigned short count ) ;
...
position p;
@@
 void cocci_id@p ( struct mgsl_struct * info , int enable ) ;
...
position p;
@@
 void cocci_id@p ( struct mgsl_struct * info , const char * data , int count , int xmit ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct mgsl_struct * info , u16 Port ) ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , MGSL_PARAMS __user * user_params ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct mgsl_struct * info , u16 IrqMask ) ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , const char * Buffer , unsigned int BufferSize ) ;
...
position p;
@@
 struct tx_holding_buffer * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MAX_TOTAL_DEVICES ] ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , struct mgsl_icount 
						      __user * user_icount ) ;
...
position p;
@@
 int cocci_id@p [ MAX_ISA_DEVICES ] ;
...
position p;
@@
 struct tx_holding_buffer {  int buffer_size ;  unsigned char * buffer ; } cocci_id@p ;
...
position p;
@@
 volatile unsigned long * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info ) ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , int __user * idle_mode ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct mgsl_struct * info , u16 Cmd ) ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , int __user * mask ) ;
...
position p;
@@
 void cocci_id@p ( struct mgsl_struct * info ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct mgsl_struct * info ) ;
...
position p;
@@
 void cocci_id@p ( struct mgsl_struct * info , DMABUFFERENTRY * BufferList , int Buffercount ) ;
...
symbol cocci_id;
position p;
typedef u32,u16,dma_addr_t;
@@
 struct _DMABUFFERENTRY {  u32 phys_addr ;  volatile u16 count ;  volatile u16 status ;  volatile u16 rcc ;  u16 reserved ;  u32 link ;  char * virt_addr ;  u32 phys_entry ;  dma_addr_t dma_addr ; } cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct mgsl_struct * info , u16 Port , u16 Value ) ;
...
position p;
@@
 void cocci_id@p ( struct mgsl_struct * info , const char * Buffer , unsigned int BufferSize ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct mgsl_struct * ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct mgsl_struct * info , u32 DataRate ) ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , DMABUFFERENTRY * BufferList , int Buffercount ) ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , int idle_mode ) ;
...
position p;
@@
 isr_dispatch_func cocci_id@p [ 7 ] ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , unsigned int cmd , unsigned long arg ) ;
...
position p;
@@
 struct mgsl_struct * cocci_id@p ( void ) ;
...
position p;
@@
 int cocci_id@p ( struct mgsl_struct * info , MGSL_PARAMS __user * new_params ) ;
...
position p;
@@
 void cocci_id@p ( struct mgsl_struct * info , unsigned int StartIndex , unsigned int EndIndex ) ;
