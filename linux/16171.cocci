...
position p;
@@
 const struct ni6527_board cocci_id@p [ ] ;
...
position p;
@@
 enum ni6527_boardid { BOARD_PCI6527 , BOARD_PXI6527 , } cocci_id@p ;
...
position p;
@@
 struct ni6527_private * cocci_id@p ;
...
position p;
@@
 struct ni6527_private {  unsigned int filter_interval ;  unsigned int filter_enable ; } cocci_id@p ;
...
position p;
@@
 struct ni6527_board {  const char * name ; } cocci_id@p ;
