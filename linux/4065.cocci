...
position p;
@@
 struct mmp_intc_conf {  unsigned int conf_enable ;  unsigned int conf_disable ;  unsigned int conf_mask ;  unsigned int conf2_mask ; } cocci_id@p ;
...
position p;
@@
 struct mmp_intc_conf cocci_id@p ;
...
position p;
@@
 struct icu_chip_data cocci_id@p [ MAX_ICU_NR ] ;
...
position p;
@@
 struct icu_chip_data * cocci_id@p ;
...
position p;
@@
 const struct mmp_intc_conf cocci_id@p ;
