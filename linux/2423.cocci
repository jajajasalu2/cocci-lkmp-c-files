...
@@
 struct xgene_dma_ring {  struct xgene_dma * pdma ;  u8 buf_num ;  u16 id ;  u16 num ;  u16 head ;  u16 owner ;  u16 slots ;  u16 dst_ring_num ;  u32 size ;  void __iomem * cmd ;  void __iomem * cmd_base ;  dma_addr_t desc_paddr ;  u32 state [ XGENE_DMA_RING_NUM_CONFIG ] ;  enum xgene_dma_ring_cfgsize cfgsize ;  union {  void * desc_vaddr ;  struct xgene_dma_desc_hw * desc_hw ; } ; } cocci_id@p ;
...
position p;
@@
 struct xgene_dma_desc_sw cocci_id@p ;
...
typedef u32;
@@
 struct xgene_dma_desc_sw {  struct xgene_dma_desc_hw desc1 ;  struct xgene_dma_desc_hw desc2 ;  u32 flags ;  struct list_head node ;  struct list_head tx_list ;  struct dma_async_tx_descriptor tx ; } cocci_id@p ;
...
position p;
@@
 enum xgene_dma_ring_cfgsize { XGENE_DMA_RING_CFG_SIZE_512B , XGENE_DMA_RING_CFG_SIZE_2KB , XGENE_DMA_RING_CFG_SIZE_16KB , XGENE_DMA_RING_CFG_SIZE_64KB , XGENE_DMA_RING_CFG_SIZE_512KB , XGENE_DMA_RING_CFG_SIZE_INVALID , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ XGENE_DMA_MAX_XOR_SRC ] ;
...
position p;
@@
 enum xgene_dma_ring_cfgsize cocci_id@p ;
...
typedef spinlock_t;
@@
 struct xgene_dma_chan {  struct dma_chan dma_chan ;  struct xgene_dma * pdma ;  struct device * dev ;  int id ;  int rx_irq ;  char name [ 10 ] ;  spinlock_t lock ;  int pending ;  int max_outstanding ;  struct list_head ld_pending ;  struct list_head ld_running ;  struct list_head ld_completed ;  struct dma_pool * desc_pool ;  struct tasklet_struct tasklet ;  struct xgene_dma_ring tx_ring ;  struct xgene_dma_ring rx_ring ; } cocci_id@p ;
...
typedef __le64;
@@
 struct xgene_dma_desc_hw {  __le64 m0 ;  __le64 m1 ;  __le64 m2 ;  __le64 m3 ; } cocci_id@p ;
...
position p;
@@
 struct xgene_dma_ring * cocci_id@p ;
...
position p;
@@
 struct xgene_dma_chan * cocci_id@p ;
...
position p;
@@
 struct xgene_dma_desc_hw * cocci_id@p ;
...
position p;
@@
 struct xgene_dma {  struct device * dev ;  struct clk * clk ;  int err_irq ;  int ring_num ;  void __iomem * csr_dma ;  void __iomem * csr_ring ;  void __iomem * csr_ring_cmd ;  void __iomem * csr_efuse ;  struct dma_device dma_dev [ XGENE_DMA_MAX_CHANNEL ] ;  struct xgene_dma_chan chan [ XGENE_DMA_MAX_CHANNEL ] ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 dma_addr_t cocci_id@p [ XGENE_DMA_MAX_XOR_SRC ] ;
