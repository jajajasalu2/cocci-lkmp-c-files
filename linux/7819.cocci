...
position p;
@@
 void cocci_id@p ( struct scsi_target * , int ) ;
...
symbol cocci_id;
position p;
typedef MpiRaidActionRequest_t;
@@
 MpiRaidActionRequest_t * cocci_id@p ;
...
position p;
@@
 struct _CONFIG_PAGE_SCSI_DEVICE_1 * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct scsi_target * , struct _CONFIG_PAGE_SCSI_DEVICE_1 * ) ;
...
position p;
@@
 struct _CONFIG_PAGE_SCSI_DEVICE_0 * cocci_id@p ;
...
position p;
@@
 struct _CONFIG_PAGE_HEADER cocci_id@p ;
...
position p;
@@
 struct _MPT_SCSI_HOST * cocci_id@p ;
...
position p;
@@
 struct _CONFIG_PAGE_IOC_3 * cocci_id@p ;
...
position p;
@@
 struct _MPT_ADAPTER * cocci_id@p ;
...
position p;
@@
 struct work_queue_wrapper {  struct work_struct work ;  struct _MPT_SCSI_HOST * hd ;  int disk ; } cocci_id@p ;
...
position p;
@@
 struct _x_config_parms cocci_id@p ;
