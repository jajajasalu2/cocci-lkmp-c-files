...
position p;
@@
 const struct bpf_sock * cocci_id@p ;
...
position p;
@@
 enum bpf_result_array_idx { EGRESS_SRV_IDX , EGRESS_CLI_IDX , INGRESS_LISTEN_IDX , __NR_BPF_RESULT_ARRAY_IDX , } cocci_id@p ;
...
typedef __u32;
@@
 struct bpf_spinlock_cnt {  struct bpf_spin_lock lock ;  __u32 cnt ; } cocci_id@p ;
...
position p;
@@
 struct bpf_spinlock_cnt cocci_id@p ;
...
position p;
@@
 const struct bpf_tcp_sock * cocci_id@p ;
...
position p;
@@
 enum bpf_linum_array_idx { EGRESS_LINUM_IDX , INGRESS_LINUM_IDX , __NR_BPF_LINUM_ARRAY_IDX , } cocci_id@p ;
...
position p;
@@
 enum bpf_addr_array_idx { ADDR_SRV_IDX , ADDR_CLI_IDX , __NR_BPF_ADDR_ARRAY_IDX , } cocci_id@p ;
