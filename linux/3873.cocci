...
position p;
@@
 struct omap_sham_reqctx * cocci_id@p ;
...
typedef u8;
@@
 struct omap_sham_reqctx {  struct omap_sham_dev * dd ;  unsigned long flags ;  unsigned long op ;  u8 digest [ SHA512_DIGEST_SIZE ] ;  size_t digcnt ;  size_t bufcnt ;  size_t buflen ;  struct scatterlist * sg ;  struct scatterlist sgl [ 2 ] ;  int offset ;  int sg_len ;  unsigned int total ;  u8 buffer [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct omap_sham_algs_info cocci_id@p [ ] ;
...
position p;
@@
 struct omap_sham_ctx * cocci_id@p ;
...
position p;
@@
 struct omap_sham_dev * cocci_id@p ;
...
position p;
@@
 struct omap_sham_algs_info {  struct ahash_alg * algs_list ;  unsigned int size ;  unsigned int registered ; } cocci_id@p ;
...
typedef u8;
@@
 struct omap_sham_hmac_ctx {  struct crypto_shash * shash ;  u8 ipad [ SHA512_BLOCK_SIZE ] ;  u8 opad [ SHA512_BLOCK_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 const struct omap_sham_pdata cocci_id@p ;
...
position p;
@@
 struct omap_sham_drv cocci_id@p ;
...
position p;
@@
 struct omap_sham_ctx {  struct omap_sham_dev * dd ;  unsigned long flags ;  struct crypto_shash * fallback ;  struct omap_sham_hmac_ctx base [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct omap_sham_reqctx * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct omap_sham_drv {  struct list_head dev_list ;  spinlock_t lock ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 struct omap_sham_hmac_ctx cocci_id@p ;
