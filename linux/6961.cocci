...
typedef u8;
@@
 struct ipoctal {  struct ipack_device * dev ;  unsigned int board_id ;  struct ipoctal_channel channel [ NR_CHANNELS ] ;  struct tty_driver * tty_drv ;  u8 __iomem * mem8_space ;  u8 __iomem * int_space ; } cocci_id@p ;
...
position p;
@@
 const struct ipack_driver_ops cocci_id@p ;
...
position p;
@@
 struct ipack_driver cocci_id@p ;
...
position p;
@@
 struct ipoctal_stats * cocci_id@p ;
...
position p;
@@
 struct ipack_device * cocci_id@p ;
...
position p;
@@
 struct ipoctal_channel * cocci_id@p ;
...
position p;
@@
 struct ipack_region * cocci_id@p ;
