...
position p;
@@
 struct acpi_gpio_lookup * cocci_id@p ;
...
position p;
@@
 struct acpi_gpio_connection * cocci_id@p ;
...
position p;
@@
 struct acpi_gpio_chip * cocci_id@p ;
...
typedef bool;
@@
 struct acpi_gpio_lookup {  struct acpi_gpio_info info ;  int index ;  int pin_index ;  bool active_low ;  struct gpio_desc * desc ;  int n ; } cocci_id@p ;
...
position p;
@@
 struct acpi_gpio_chip {  struct acpi_connection_info conn_info ;  struct list_head conns ;  struct mutex conn_lock ;  struct gpio_chip * chip ;  struct list_head events ;  struct list_head deferred_req_irqs_list_entry ; } cocci_id@p ;
...
position p;
@@
 struct acpi_gpio_connection {  struct list_head node ;  unsigned int pin ;  struct gpio_desc * desc ; } cocci_id@p ;
...
position p;
@@
 struct acpi_gpio_event * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,acpi_handle,irq_handler_t;
@@
 struct acpi_gpio_event {  struct list_head node ;  acpi_handle handle ;  irq_handler_t handler ;  unsigned int pin ;  unsigned int irq ;  unsigned long irqflags ;  bool irq_is_wake ;  bool irq_requested ;  struct gpio_desc * desc ; } cocci_id@p ;
...
position p;
@@
 const enum gpiod_flags cocci_id@p ;
...
position p;
@@
 const struct acpi_resource_gpio * cocci_id@p ;
