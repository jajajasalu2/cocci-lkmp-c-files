...
position p;
@@
 struct sclp_sd_listener * cocci_id@p ;
...
position p;
@@
 struct sclp_sd_data {  size_t esize_bytes ;  size_t dsize_bytes ;  void * data ; } cocci_id@p ;
...
position p;
@@
 struct sclp_sd_data * cocci_id@p ;
...
position p;
@@
 struct sclp_sd_file cocci_id@p ;
...
typedef u8;
@@
 struct sclp_sd_file {  struct kobject kobj ;  struct bin_attribute data_attr ;  struct mutex data_mutex ;  struct sclp_sd_data data ;  u8 di ; } cocci_id@p ;
...
position p;
@@
 struct sclp_sd_sccb * cocci_id@p ;
...
position p;
@@
 struct sclp_sd_evbuf * cocci_id@p ;
...
typedef u32;
@@
 struct sclp_sd_listener {  struct list_head list ;  u32 id ;  struct completion completion ;  struct sclp_sd_evbuf evbuf ; } cocci_id@p ;
