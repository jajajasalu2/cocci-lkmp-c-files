...
position p;
@@
 struct dma_fence_chain * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_syncobj * syncobj , struct syncobj_wait_entry * wait ) ;
...
position p;
@@
 struct drm_syncobj_handle * cocci_id@p ;
...
position p;
@@
 struct drm_syncobj_array * cocci_id@p ;
...
position p;
@@
 struct drm_syncobj_destroy * cocci_id@p ;
...
position p;
@@
 struct drm_syncobj_timeline_array * cocci_id@p ;
...
position p;
@@
 struct drm_syncobj_create * cocci_id@p ;
...
position p;
@@
 struct drm_syncobj_transfer * cocci_id@p ;
...
position p;
@@
 struct drm_syncobj_wait * cocci_id@p ;
...
position p;
@@
 struct syncobj_wait_entry * cocci_id@p ;
...
typedef u64;
@@
 struct syncobj_wait_entry {  struct list_head node ;  struct task_struct * task ;  struct dma_fence * fence ;  struct dma_fence_cb fence_cb ;  u64 point ; } cocci_id@p ;
...
position p;
@@
 struct drm_syncobj_timeline_wait * cocci_id@p ;
