...
position p;
@@
 struct aq_nic_cfg_s * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct aq_hw_s * self , enum hal_atl_utils_fw_state_e state ) ;
...
position p;
@@
 struct aq_hw_link_status_s * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct aq_hw_s * self , u32 speed ) ;
...
position p;
@@
 enum hal_atl_utils_fw_state_e cocci_id@p ;
...
position p;
@@
 struct hw_atl_utils_fw_rpc cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct __packed fw2x_msg_wol {  u32 msg_id ;  u8 hw_addr [ ETH_ALEN ] ;  u8 magic_packet_enabled ;  u8 filter_count ;  struct fw2x_msg_wol_pattern filter [ HAL_ATLANTIC_WOL_FILTERS_COUNT ] ;  u8 link_up_enabled ;  u8 link_down_enabled ;  u16 reserved ;  u32 link_up_timeout ;  u32 link_down_timeout ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct __packed fw2x_msg_wol_pattern {  u8 mask [ 16 ] ;  u32 crc ; } cocci_id@p ;
...
position p;
@@
 enum hw_atl_fw2x_rate cocci_id@p ;
...
position p;
@@
 struct offload_info * cocci_id@p ;
...
position p;
@@
 const struct hw_fw_request_iface * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct aq_hw_s * self ) ;
...
position p;
@@
 const struct aq_fw_ops cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct aq_hw_s * self , u32 * addr ) ;
