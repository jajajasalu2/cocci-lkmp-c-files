...
position p;
@@
 const struct qmi_header * cocci_id@p ;
...
position p;
@@
 const struct qmi_msg_handler * cocci_id@p ;
...
position p;
@@
 struct socket * cocci_id@p ( struct qmi_handle * qmi , struct sockaddr_qrtr * sq ) ;
...
position p;
@@
 const struct qrtr_ctrl_pkt * cocci_id@p ;
