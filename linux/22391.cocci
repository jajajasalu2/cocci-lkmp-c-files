...
position p;
@@
 const struct srcimp_rsc_ops cocci_id@p ;
...
position p;
@@
 const struct src_desc * cocci_id@p ;
...
position p;
@@
 const struct srcimp_desc * cocci_id@p ;
...
position p;
@@
 const struct src_rsc_ops cocci_id@p ;
