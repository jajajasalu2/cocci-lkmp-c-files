...
position p;
@@
 enum iwl_antenna_ok cocci_id@p ;
...
position p;
@@
 struct iwl_tt_trans * cocci_id@p ;
...
position p;
@@
 const struct iwl_tt_trans cocci_id@p [ IWL_TI_STATE_MAX - 1 ] ;
...
position p;
@@
 const struct iwl_tt_restriction cocci_id@p [ IWL_TI_STATE_MAX ] ;
