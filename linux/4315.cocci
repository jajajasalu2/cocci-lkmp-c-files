...
typedef u32;
@@
 struct wmab_args {  u32 eax ;  u32 ebx ;  u32 ecx ;  u32 edx ; } cocci_id@p ;
...
position p;
@@
 struct event_return_value * cocci_id@p ;
...
position p;
@@
 enum acer_wmi_event_ids { WMID_HOTKEY_EVENT = 0x1 , WMID_ACCEL_EVENT = 0x5 , } cocci_id@p ;
...
position p;
@@
 struct acer_data {  int mailled ;  int threeg ;  int brightness ; } cocci_id@p ;
...
position p;
@@
 struct wmid3_gds_return_value * cocci_id@p ;
...
position p;
@@
 struct func_input_params * cocci_id@p ;
...
position p;
@@
 struct wmi_interface cocci_id@p ;
...
typedef s8,u8;
@@
 struct quirk_entry {  u8 wireless ;  u8 mailled ;  s8 brightness ;  u8 bluetooth ; } cocci_id@p ;
...
typedef u32;
@@
 struct acer_debug {  struct dentry * root ;  u32 wmid_devices ; } cocci_id@p ;
...
typedef u32;
@@
 struct wmi_interface {  u32 type ;  u32 capability ;  struct acer_data data ;  struct acer_debug debug ; } cocci_id@p ;
...
typedef u32;
@@
 struct wmab_ret {  u32 eax ;  u32 ebx ;  u32 ecx ;  u32 edx ;  u32 eex ; } cocci_id@p ;
...
position p;
@@
 struct wmid3_gds_get_input_param cocci_id@p ;
...
position p;
@@
 struct func_return_value * cocci_id@p ;
...
position p;
@@
 enum interface_flags { ACER_AMW0 , ACER_AMW0_V2 , ACER_WMID , ACER_WMID_v2 , } cocci_id@p ;
...
position p;
@@
 struct hotkey_function_type_aa * cocci_id@p ;
...
position p;
@@
 struct wmid3_gds_set_input_param cocci_id@p ;
...
position p;
@@
 union acpi_object cocci_id@p [ 5 ] ;
