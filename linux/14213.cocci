...
position p;
@@
 const struct vfe_line * cocci_id@p [ ] ;
...
position p;
@@
 const struct vfe_format cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct v4l2_subdev * sd , struct v4l2_subdev_pad_config * cfg , struct v4l2_subdev_selection * sel ) ;
...
typedef u32;
@@
 u32 cocci_id@p [ MSM_VFE_LINE_NUM ] ;
...
position p;
@@
 const struct vfe_hw_ops * cocci_id@p ;
...
typedef u8,u32;
@@
 struct vfe_format {  u32 code ;  u8 bpp ; } cocci_id@p ;
...
position p;
@@
 const struct resources * cocci_id@p ;
...
position p;
@@
 const struct camss_video_ops cocci_id@p ;
...
position p;
@@
 struct camss_buffer cocci_id@p ;
