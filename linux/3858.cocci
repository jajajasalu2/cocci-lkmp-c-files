...
typedef __le32;
@@
 struct qm_aeqc {  __le16 head ;  __le16 tail ;  __le32 base_l ;  __le32 base_h ;  __le32 dw3 ;  __le32 rsvd [ 2 ] ;  __le32 dw6 ; } cocci_id@p ;
...
typedef __le32;
@@
 struct qm_mailbox {  __le16 w0 ;  __le16 queue_num ;  __le32 base_l ;  __le32 base_h ;  __le32 rsvd ; } cocci_id@p ;
...
position p;
@@
 struct debugfs_file * cocci_id@p ;
...
position p;
@@
 struct qm_dfx_registers * cocci_id@p ;
...
position p;
@@
 const struct hisi_qm_hw_error cocci_id@p [ ] ;
...
typedef u32;
@@
 struct hisi_qm_hw_error {  u32 int_msk ;  const char * msg ; } cocci_id@p ;
...
position p;
@@
 struct hisi_qm_status * cocci_id@p ;
...
position p;
@@
 struct hisi_qp_status * cocci_id@p ;
...
typedef __le32;
@@
 struct qm_cqe {  __le32 rsvd0 ;  __le16 cmd_id ;  __le16 rsvd1 ;  __le16 sq_head ;  __le16 sq_num ;  __le16 rsvd2 ;  __le16 w7 ; } cocci_id@p ;
...
typedef __le32;
@@
 struct qm_cqc {  __le16 head ;  __le16 tail ;  __le32 base_l ;  __le32 base_h ;  __le32 dw3 ;  __le16 w8 ;  __le16 rsvd0 ;  __le16 pasid ;  __le16 w11 ;  __le32 dw6 ;  __le32 rsvd1 ; } cocci_id@p ;
...
typedef u64;
@@
 struct qm_dfx_registers {  char * reg_name ;  u64 reg_offset ; } cocci_id@p ;
...
typedef __le32;
@@
 struct qm_aeqe {  __le32 dw0 ; } cocci_id@p ;
...
position p;
@@
 const struct hisi_qm_hw_ops cocci_id@p ;
...
position p;
@@
 struct qm_doorbell {  __le16 queue_num ;  __le16 cmd ;  __le16 index ;  __le16 priority ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ QM_DBG_TMP_BUF_LEN ] ;
...
typedef __le32;
@@
 struct qm_eqc {  __le16 head ;  __le16 tail ;  __le32 base_l ;  __le32 base_h ;  __le32 dw3 ;  __le32 rsvd [ 2 ] ;  __le32 dw6 ; } cocci_id@p ;
...
typedef __le32;
@@
 struct qm_sqc {  __le16 head ;  __le16 tail ;  __le32 base_l ;  __le32 base_h ;  __le32 dw3 ;  __le16 w8 ;  __le16 rsvd0 ;  __le16 pasid ;  __le16 w11 ;  __le16 cq_num ;  __le16 w13 ;  __le32 rsvd1 ; } cocci_id@p ;
...
position p;
@@
 enum vft_type { SQC_VFT = 0 , CQC_VFT , } cocci_id@p ;
...
typedef __le32;
@@
 struct qm_eqe {  __le32 dw0 ; } cocci_id@p ;
