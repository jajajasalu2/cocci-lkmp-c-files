...
position p;
@@
 const struct npcm7xx_kcs_reg cocci_id@p [ KCS_CHANNEL_MAX ] ;
...
typedef u32;
@@
 struct npcm7xx_kcs_reg {  u32 sts ;  u32 dob ;  u32 dib ;  u32 ctl ;  u32 ie ; } cocci_id@p ;
...
position p;
@@
 struct npcm7xx_kcs_bmc {  struct regmap * map ;  const struct npcm7xx_kcs_reg * reg ; } cocci_id@p ;
...
position p;
@@
 struct npcm7xx_kcs_bmc * cocci_id@p ;
