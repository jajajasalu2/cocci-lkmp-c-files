...
position p;
@@
 struct cs42xx8_priv * cocci_id@p ;
...
position p;
@@
 const struct cs42xx8_driver_data cocci_id@p ;
...
position p;
@@
 struct cs42xx8_ratios {  unsigned int mfreq ;  unsigned int min_mclk ;  unsigned int max_mclk ;  unsigned int ratio [ 3 ] ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct cs42xx8_priv {  struct regulator_bulk_data supplies [ CS42XX8_NUM_SUPPLIES ] ;  const struct cs42xx8_driver_data * drvdata ;  struct regmap * regmap ;  struct clk * clk ;  bool slave_mode ;  unsigned long sysclk ;  u32 tx_channels ;  struct gpio_desc * gpiod_reset ;  u32 rate [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 const struct cs42xx8_ratios cocci_id@p [ ] ;
...
position p;
@@
 const char * const cocci_id@p [ CS42XX8_NUM_SUPPLIES ] ;
