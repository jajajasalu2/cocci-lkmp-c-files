...
typedef u32;
@@
 const u32 cocci_id@p [ CC_NUM_IDRS ] ;
...
position p;
@@
 const struct cc_hw_data cocci_id@p ;
...
typedef u32;
@@
 struct cc_hw_data {  char * name ;  enum cc_hw_rev rev ;  u32 sig ;  u32 cidr_0123 ;  u32 pidr_0124 ;  int std_bodies ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 union {  u8 regs [ CC_NUM_IDRS ] ;  __le32 val ; } cocci_id@p ;
