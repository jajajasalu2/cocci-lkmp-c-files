...
typedef u32;
@@
 struct bbc_beep_info {  u32 clock_freq ;  void __iomem * regs ; } cocci_id@p ;
...
position p;
@@
 struct sparcspkr_state * cocci_id@p ;
...
position p;
@@
 struct bbc_beep_info * cocci_id@p ;
...
position p;
@@
 struct grover_beep_info {  void __iomem * freq_regs ;  void __iomem * enable_reg ; } cocci_id@p ;
...
position p;
@@
 struct grover_beep_info * cocci_id@p ;
