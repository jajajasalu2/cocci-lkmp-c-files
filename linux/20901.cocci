...
position p;
@@
 struct io_thread_req {  struct request * req ;  int fds [ 2 ] ;  unsigned long offsets [ 2 ] ;  unsigned long long offset ;  unsigned long length ;  char * buffer ;  int sectorsize ;  unsigned long sector_mask ;  unsigned long long cow_offset ;  unsigned long bitmap_words [ 2 ] ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct cow {  char * file ;  int fd ;  unsigned long * bitmap ;  unsigned long bitmap_len ;  int bitmap_offset ;  int data_offset ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "ubd_nnn\0" ) ] ;
...
position p;
@@
 struct io_thread_req * * cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef __u64,spinlock_t;
@@
 struct ubd {  char * file ;  int count ;  int fd ;  __u64 size ;  struct openflags boot_openflags ;  struct openflags openflags ;  unsigned shared : 1 ;  unsigned no_cow : 1 ;  unsigned no_trim : 1 ;  struct cow cow ;  struct platform_device pdev ;  struct request_queue * queue ;  struct blk_mq_tag_set tag_set ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct gendisk * cocci_id@p [ MAX_DEV ] ;
