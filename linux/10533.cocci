...
typedef u32;
@@
 void cocci_id@p ( struct radeon_device * rdev , const u32 * seq , u32 count ) ;
...
position p;
@@
 struct trinity_power_info * cocci_id@p ;
...
position p;
@@
 union igp_info {  struct _ATOM_INTEGRATED_SYSTEM_INFO info ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V2 info_2 ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V5 info_5 ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V6 info_6 ;  struct _ATOM_INTEGRATED_SYSTEM_INFO_V1_7 info_7 ; } cocci_id@p ;
