...
position p;
@@
 struct ssb_init_invariants cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ssb_bus * bus , unsigned long data ) ;
...
symbol cocci_id;
position p;
typedef ssb_invariants_func_t;
@@
 ssb_invariants_func_t cocci_id@p ;
...
position p;
@@
 struct ssb_freeze_context * cocci_id@p ;
