...
typedef u16;
@@
 struct ec100_state {  struct i2c_adapter * i2c ;  struct dvb_frontend frontend ;  struct ec100_config config ;  u16 ber ; } cocci_id@p ;
...
position p;
@@
 const struct ec100_config * cocci_id@p ;
...
position p;
@@
 struct ec100_config cocci_id@p ;
