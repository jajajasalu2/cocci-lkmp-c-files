...
position p;
@@
 enum sctp_disposition cocci_id@p ;
...
position p;
@@
 struct sctp_datahdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net * net , const struct sctp_endpoint * ep , const struct sctp_association * asoc , const struct sctp_chunk * chunk , struct sctp_cmd_seq * commands , struct sctp_chunk * err_chunk ) ;
...
position p;
@@
 struct sctp_addip_chunk cocci_id@p ;
...
position p;
@@
 const struct sctp_association * cocci_id@p ;
...
position p;
@@
 struct sctp_fwdtsn_hdr * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct sctp_association * asoc , struct sctp_chunk * chunk , struct sctp_cmd_seq * commands ) ;
...
position p;
@@
 struct sctp_init_chunk * cocci_id@p ;
...
position p;
@@
 struct sctp_ecnehdr * cocci_id@p ;
...
position p;
@@
 struct sctp_sackhdr * cocci_id@p ( struct sctp_chunk * chunk ) ;
...
position p;
@@
 struct sctp_inithdr cocci_id@p ;
...
position p;
@@
 enum sctp_ierror cocci_id@p ( const struct sctp_association * asoc , struct sctp_chunk * chunk ) ;
...
position p;
@@
 struct sctp_shutdown_chunk cocci_id@p ;
...
position p;
@@
 struct sctp_abort_chunk cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( * errhdr ) + sizeof ( * addrparm ) ] ;
...
position p;
@@
 struct sctp_heartbeathdr * cocci_id@p ;
...
position p;
@@
 struct sctp_packet * cocci_id@p ( struct net * net , const struct sctp_association * asoc , const struct sctp_chunk * chunk ) ;
...
position p;
@@
 struct sctp_auth_chunk cocci_id@p ;
...
position p;
@@
 struct sctp_cmd_seq * cocci_id@p ;
...
position p;
@@
 enum sctp_disposition cocci_id@p ( struct net * net , const struct sctp_endpoint * ep , const struct sctp_association * asoc , const union sctp_subtype type , void * arg , struct sctp_cmd_seq * commands ) ;
...
position p;
@@
 struct sctp_sack_chunk cocci_id@p ;
...
position p;
@@
 struct sctp_ecne_chunk cocci_id@p ;
...
position p;
@@
 struct sctp_operr_chunk cocci_id@p ;
...
position p;
@@
 struct sctp_shutdownhdr * cocci_id@p ;
...
position p;
@@
 struct sctp_initack_chunk cocci_id@p ;
...
position p;
@@
 struct sctp_authhdr * cocci_id@p ;
...
position p;
@@
 const struct sctp_endpoint * cocci_id@p ;
...
position p;
@@
 struct sctp_chunkhdr cocci_id@p ;
...
position p;
@@
 const struct sctp_chunk * cocci_id@p ;
...
position p;
@@
 union sctp_addr_param * cocci_id@p ;
...
position p;
@@
 struct sctp_heartbeat_chunk cocci_id@p ;
...
position p;
@@
 const struct list_head * cocci_id@p ;
...
position p;
@@
 enum sctp_disposition cocci_id@p ( struct net * net , const struct sctp_endpoint * ep , const struct sctp_association * asoc , const union sctp_subtype type , void * arg , void * ext , struct sctp_cmd_seq * commands ) ;
...
position p;
@@
 struct sctp_sackhdr * cocci_id@p ;
...
position p;
@@
 enum sctp_disposition cocci_id@p ( struct net * net , struct sctp_cmd_seq * commands , __be16 error , int sk_err , const struct sctp_association * asoc , struct sctp_transport * transport ) ;
...
typedef __u8;
@@
 enum sctp_disposition cocci_id@p ( struct net * net , const struct sctp_endpoint * ep , const struct sctp_association * asoc , void * arg , struct sctp_cmd_seq * commands , const __u8 * payload , const size_t paylen ) ;
...
position p;
@@
 struct sctp_sender_hb_info * cocci_id@p ;
...
position p;
@@
 struct sctp_addiphdr * cocci_id@p ;
...
position p;
@@
 struct sctp_signed_cookie * cocci_id@p ;
...
position p;
@@
 const union sctp_subtype cocci_id@p ;
...
position p;
@@
 struct sctp_reconf_chunk * cocci_id@p ;
...
position p;
@@
 struct sctp_unrecognized_param * cocci_id@p ;
...
position p;
@@
 struct sctp_cookie_preserve_param cocci_id@p ;
