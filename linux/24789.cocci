...
position p;
@@
 const struct nft_rbtree_elem * cocci_id@p ;
...
position p;
@@
 struct nft_rbtree_elem {  struct rb_node node ;  struct nft_set_ext ext ; } cocci_id@p ;
...
position p;
@@
 struct nft_rbtree_elem * * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rwlock_t,seqcount_t;
@@
 struct nft_rbtree {  struct rb_root root ;  rwlock_t lock ;  seqcount_t count ;  struct delayed_work gc_work ; } cocci_id@p ;
...
position p;
@@
 const struct nft_rbtree * cocci_id@p ;
