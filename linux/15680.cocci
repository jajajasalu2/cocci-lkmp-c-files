...
position p;
@@
 struct gb_vibrator_device cocci_id@p ;
...
position p;
@@
 struct gb_vibrator_device {  struct gb_connection * connection ;  struct device * dev ;  int minor ;  struct delayed_work delayed_work ; } cocci_id@p ;
