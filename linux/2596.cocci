...
position p;
@@
 struct ocotp_devtype_data cocci_id@p ;
...
typedef u32;
@@
 struct ocotp_devtype_data {  int devtype ;  int nregs ;  u32 num_region ;  struct ocotp_region region [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct ocotp_devtype_data * cocci_id@p ;
...
position p;
@@
 struct ocotp_priv {  struct device * dev ;  const struct ocotp_devtype_data * data ;  struct imx_sc_ipc * nvmem_ipc ; } cocci_id@p ;
...
typedef u32;
@@
 struct ocotp_region {  u32 start ;  u32 end ;  u32 flag ; } cocci_id@p ;
...
position p;
@@
 enum ocotp_devtype { IMX8QXP , IMX8QM , } cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_misc_fuse_read cocci_id@p ;
