...
position p;
@@
 struct fsl_hv_ioctl_prop cocci_id@p ;
...
typedef uint32_t;
@@
 struct doorbell_isr {  struct list_head list ;  unsigned int irq ;  uint32_t doorbell ;  uint32_t partition ; } cocci_id@p ;
...
position p;
@@
 struct fsl_hv_ioctl_doorbell cocci_id@p ;
...
position p;
@@
 struct doorbell_isr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,uint32_t,spinlock_t;
@@
 struct doorbell_queue {  struct list_head list ;  spinlock_t lock ;  wait_queue_head_t wait ;  unsigned int head ;  unsigned int tail ;  uint32_t q [ QSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct doorbell_queue cocci_id@p ;
...
position p;
@@
 struct fsl_hv_ioctl_start cocci_id@p ;
...
position p;
@@
 struct fsl_hv_ioctl_memcpy cocci_id@p ;
...
position p;
@@
 struct fsl_hv_ioctl_restart cocci_id@p ;
...
position p;
@@
 struct fsl_hv_ioctl_stop cocci_id@p ;
...
position p;
@@
 struct fsl_hv_ioctl_status cocci_id@p ;
