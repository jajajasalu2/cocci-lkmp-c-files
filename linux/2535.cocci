...
position p;
@@
 struct arg_name_flag {  const unsigned long flag ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct arg_name_flag * cocci_id@p ;
...
position p;
@@
 struct {  const int mode ;  const char * param ; } cocci_id@p [ ] ;
...
position p;
@@
 struct dm_raid_superblock * cocci_id@p ;
...
position p;
@@
 enum sync_state { st_frozen , st_reshape , st_resync , st_check , st_repair , st_recover , st_idle , } cocci_id@p ;
...
position p;
@@
 struct raid_type {  const char * name ;  const char * descr ;  const unsigned int parity_devs ;  const unsigned int minimal_devs ;  const unsigned int level ;  const unsigned int algorithm ; } cocci_id@p [ ] ;
...
typedef uint64_t;
@@
 uint64_t cocci_id@p [ DISKS_ARRAY_ELEMS ] ;
...
position p;
@@
 struct raid_dev {  struct dm_dev * meta_dev ;  struct dm_dev * data_dev ;  struct md_rdev rdev ; } cocci_id@p ;
...
position p;
@@
 struct rs_layout {  int new_level ;  int new_layout ;  int new_chunk_sectors ; } cocci_id@p ;
