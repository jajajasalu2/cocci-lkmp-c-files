...
typedef spinlock_t;
@@
 struct davinci_gpio_controller {  struct gpio_chip chip ;  struct irq_domain * irq_domain ;  spinlock_t lock ;  void __iomem * regs [ MAX_REGS_BANKS ] ;  int gpio_unbanked ;  int irqs [ MAX_INT_PER_BANK ] ; } cocci_id@p ;
...
position p;
@@
 struct davinci_gpio_irq_data {  void __iomem * regs ;  struct davinci_gpio_controller * chip ;  int bank_num ; } cocci_id@p ;
...
position p;
@@
 struct davinci_gpio_platform_data * cocci_id@p ;
...
position p;
@@
 struct davinci_gpio_controller * cocci_id@p ;
...
position p;
@@
 struct irq_chip * ( * cocci_id@p ) ( unsigned int irq ) ;
...
symbol cocci_id;
position p;
typedef gpio_get_irq_chip_cb_t;
@@
 gpio_get_irq_chip_cb_t cocci_id@p ;
...
typedef u32;
@@
 struct davinci_gpio_regs {  u32 dir ;  u32 out_data ;  u32 set_data ;  u32 clr_data ;  u32 in_data ;  u32 set_rising ;  u32 clr_rising ;  u32 set_falling ;  u32 clr_falling ;  u32 intstat ; } cocci_id@p ;
...
position p;
@@
 struct davinci_gpio_irq_data cocci_id@p ;
