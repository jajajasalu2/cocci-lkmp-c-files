...
position p;
@@
 enum safexcel_cipher_alg { SAFEXCEL_DES , SAFEXCEL_3DES , SAFEXCEL_AES , SAFEXCEL_CHACHA20 , SAFEXCEL_SM4 , } cocci_id@p ;
...
position p;
@@
 struct safexcel_cipher_ctx * cocci_id@p ;
...
position p;
@@
 struct safexcel_cipher_req cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ AES_BLOCK_SIZE >> 2 ] ;
...
position p;
@@
 enum safexcel_cipher_direction { SAFEXCEL_ENCRYPT , SAFEXCEL_DECRYPT , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ CHACHA_KEY_SIZE / sizeof ( u32 ) + 1 ] ;
...
position p;
@@
 enum safexcel_cipher_direction cocci_id@p ;
