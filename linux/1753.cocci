...
position p;
@@
 struct srf08_chip_info {  const int * sensitivity_avail ;  int num_sensitivity_avail ;  int sensitivity_default ;  int range_default ; } cocci_id@p ;
...
typedef s16;
@@
 struct srf08_data {  struct i2c_client * client ;  int sensitivity ;  int range_mm ;  struct mutex lock ;  s16 buffer [ 8 ] ;  enum srf08_sensor_type sensor_type ;  const struct srf08_chip_info * chip_info ; } cocci_id@p ;
...
position p;
@@
 const struct srf08_chip_info cocci_id@p ;
...
position p;
@@
 enum srf08_sensor_type { SRF02 , SRF08 , SRF10 , SRF_MAX_TYPE , } cocci_id@p ;
...
position p;
@@
 enum srf08_sensor_type cocci_id@p ;
