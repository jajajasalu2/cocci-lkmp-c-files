...
position p;
@@
 struct em_data_callback cocci_id@p ;
...
position p;
@@
 struct scmi_perf_ops * cocci_id@p ;
...
position p;
@@
 struct scmi_data {  int domain_id ;  struct device * cpu_dev ; } cocci_id@p ;
