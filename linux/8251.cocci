...
position p;
@@
 struct ena_tx_buffer * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct ena_adapter * adapter , bool graceful ) ;
...
position p;
@@
 struct ena_com_rx_ctx * cocci_id@p ;
...
position p;
@@
 struct ena_eth_io_intr_reg cocci_id@p ;
...
position p;
@@
 struct ena_com_rx_buf_info * cocci_id@p ;
...
position p;
@@
 struct ena_com_tx_ctx * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ena_adapter * adapter ) ;
...
position p;
@@
 struct ena_calc_queue_size_ctx cocci_id@p ;
...
position p;
@@
 struct ena_rx_buffer * cocci_id@p ;
...
position p;
@@
 struct ena_admin_ena_hw_hints * cocci_id@p ;
...
position p;
@@
 struct ena_admin_aenq_link_change_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ena_adapter * adapter ) ;
...
position p;
@@
 struct ena_admin_aenq_keep_alive_desc * cocci_id@p ;
...
position p;
@@
 struct ena_admin_queue_ext_feature_fields * cocci_id@p ;
...
position p;
@@
 struct ena_admin_host_info * cocci_id@p ;
...
position p;
@@
 struct ena_com_tx_meta * cocci_id@p ;
...
position p;
@@
 struct ena_admin_queue_feature_desc * cocci_id@p ;
