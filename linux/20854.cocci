...
typedef u64;
@@
 void ( * cocci_id@p ) ( struct kvm_vcpu * vcpu , u64 * sptep , int level ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct kvm * kvm , struct kvm_mmu_page * sp ) ;
