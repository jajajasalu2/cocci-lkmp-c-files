...
position p;
@@
 enum psp_reg_prog_id cocci_id@p ;
...
position p;
@@
 const struct amdgpu_psp_funcs cocci_id@p ;
...
position p;
@@
 struct psp_gfx_cmd_resp cocci_id@p ;
...
position p;
@@
 enum psp_gfx_fw_type * cocci_id@p ;
...
position p;
@@
 struct common_firmware_header * cocci_id@p ;
