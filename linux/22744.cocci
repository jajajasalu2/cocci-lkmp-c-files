...
symbol cocci_id;
position p;
typedef snd_pcm_open_callback_t;
@@
 snd_pcm_open_callback_t cocci_id@p [ 2 ] ;
...
position p;
@@
 enum card_type { CMI8330 , CMI8329 , } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ( ( CMI8330_CDINGAIN ) - 16 ) + 1 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_pcm_substream * ) ;
