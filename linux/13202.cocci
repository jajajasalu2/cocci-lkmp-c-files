...
typedef u8;
@@
 struct cobalt_i2c_regs {  u8 prerlo ;  u8 dummy0 [ 3 ] ;  u8 prerhi ;  u8 dummy1 [ 3 ] ;  u8 ctr ;  u8 dummy2 [ 3 ] ;  u8 txr_rxr ;  u8 dummy3 [ 3 ] ;  u8 cr_sr ;  u8 dummy4 [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct cobalt_i2c_data * cocci_id@p ;
