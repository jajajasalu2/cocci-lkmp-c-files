...
typedef u32;
@@
 struct hibmc_dislay_pll_config {  unsigned long hdisplay ;  unsigned long vdisplay ;  u32 pll1_config_value ;  u32 pll2_config_value ; } cocci_id@p ;
...
position p;
@@
 const struct hibmc_dislay_pll_config cocci_id@p [ ] ;
...
position p;
@@
 struct hibmc_framebuffer * cocci_id@p ;
...
position p;
@@
 struct hibmc_drm_private * cocci_id@p ;
...
position p;
@@
 struct hibmc_display_panel_pll {  unsigned long M ;  unsigned long N ;  unsigned long OD ;  unsigned long POD ; } cocci_id@p ;
...
position p;
@@
 struct hibmc_display_panel_pll cocci_id@p ;
