...
position p;
@@
 struct snd_trident_voice * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_trident * trident , struct snd_trident_voice * voice , struct snd_pcm_substream * substream ) ;
...
position p;
@@
 struct snd_trident_memblk_arg cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_trident * trident ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_trident * trident , unsigned short v_min , unsigned short v_max ) ;
...
position p;
@@
 struct snd_trident_pcm_mixer * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct snd_trident_voice * ) ;
