...
typedef u8,u16;
@@
 struct smsc47b397_data {  unsigned short addr ;  struct mutex lock ;  struct mutex update_lock ;  unsigned long last_updated ;  int valid ;  u16 fan [ 4 ] ;  u8 temp [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct smsc47b397_data cocci_id@p ;
