...
position p;
@@
 struct azf3328_mixer_reg cocci_id@p ;
...
position p;
@@
 enum snd_azf3328_codec_type cocci_id@p ;
...
position p;
@@
 enum snd_azf3328_codec_type { AZF_CODEC_PLAYBACK = 0 , AZF_CODEC_CAPTURE = 1 , AZF_CODEC_I2S_OUT = 2 , } cocci_id@p ;
...
position p;
@@
 enum { AZF_PCMDEV_STD , AZF_PCMDEV_I2S_OUT , NUM_AZF_PCMDEVS , } cocci_id@p ;
...
@@
 struct snd_azf3328_codec_data {  unsigned long io_base ;  unsigned int dma_base ;  spinlock_t * lock ;  struct snd_pcm_substream * substream ;  bool running ;  enum snd_azf3328_codec_type type ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 const struct snd_azf3328_codec_data * cocci_id@p ;
...
position p;
@@
 const struct {  enum snd_azf3328_codec_type other1 ;  enum snd_azf3328_codec_type other2 ; } cocci_id@p [ 3 ] ;
...
position p;
@@
 const struct snd_azf3328 * cocci_id@p ;
...
position p;
@@
 struct snd_timer_hardware cocci_id@p ;
...
position p;
@@
 const struct {  unsigned short azf_reg ; } cocci_id@p [ ] ;
...
position p;
@@
 struct snd_azf3328_codec_data * cocci_id@p ;
