...
position p;
@@
 struct lance_init_block {  unsigned short mode ;  unsigned char hwaddr [ 6 ] ;  unsigned int filter [ 2 ] ;  unsigned short rdra ;  unsigned short rlen ;  unsigned short tdra ;  unsigned short tlen ;  unsigned short pad [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct lance_memory {  struct lance_init_block init ;  struct lance_tx_head tx_head [ TX_RING_SIZE ] ;  struct lance_rx_head rx_head [ RX_RING_SIZE ] ;  char rx_data [ RX_RING_SIZE ] [ PKT_BUF_SZ ] ;  char tx_data [ TX_RING_SIZE ] [ PKT_BUF_SZ ] ; } cocci_id@p ;
