...
position p;
@@
 const struct rpm_smd_clk_desc cocci_id@p ;
...
position p;
@@
 struct rpm_smd_clk_desc {  struct clk_smd_rpm * * clks ;  size_t num_clks ; } cocci_id@p ;
...
position p;
@@
 struct rpm_cc {  struct qcom_rpm * rpm ;  struct clk_smd_rpm * * clks ;  size_t num_clks ; } cocci_id@p ;
...
position p;
@@
 struct clk_smd_rpm_req cocci_id@p ;
...
typedef bool;
@@
 struct clk_smd_rpm {  const int rpm_res_type ;  const int rpm_key ;  const int rpm_clk_id ;  const int rpm_status_id ;  const bool active_only ;  bool enabled ;  bool branch ;  struct clk_smd_rpm * peer ;  struct clk_hw hw ;  unsigned long rate ;  struct qcom_smd_rpm * rpm ; } cocci_id@p ;
...
typedef __le32;
@@
 struct clk_smd_rpm_req {  __le32 key ;  __le32 nbytes ;  __le32 value ; } cocci_id@p ;
