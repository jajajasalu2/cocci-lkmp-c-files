...
position p;
@@
 struct atto_vda_ae_lu_tgt_lun_raid cocci_id@p ;
...
position p;
@@
 struct atto_vda_grp_info * cocci_id@p ;
...
position p;
@@
 struct esas2r_adapter * cocci_id@p [ MAX_ADAPTERS ] ;
...
position p;
@@
 struct atto_vda_devinfo * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pcid , const struct pci_device_id * id ) ;
...
position p;
@@
 struct atto_vda_dh_info * cocci_id@p ;
...
position p;
@@
 struct atto_vda_buzzer_info * cocci_id@p ;
...
position p;
@@
 struct atto_vda_metrics_info * cocci_id@p ;
...
position p;
@@
 struct atto_vda_ae_raid * cocci_id@p ;
...
position p;
@@
 struct atto_vda_ae_lu cocci_id@p ;
...
position p;
@@
 struct esas2r_fw_event_work * cocci_id@p ;
...
position p;
@@
 struct atto_vda_cfg_init * cocci_id@p ;
...
position p;
@@
 struct atto_vda_schedule_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pci_dev * pcid ) ;
...
position p;
@@
 struct esas2r_vda_ae * cocci_id@p ;
...
position p;
@@
 struct atto_vdapart_info * cocci_id@p ;
