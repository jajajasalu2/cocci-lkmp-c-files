...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int p ) ;
...
position p;
@@
 void cocci_id@p ( struct s_phy * phy ) ;
...
position p;
@@
 const struct plt {  int timer ;  int para ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , struct s_phy * phy , int cmd ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int bit , struct s_phy * phy ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int np , int threshold ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int phy , int ls ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int np ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , const int bit , struct s_phy * phy ) ;
