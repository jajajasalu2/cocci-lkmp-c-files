...
position p;
@@
 struct hv_start_fcopy cocci_id@p ;
...
typedef u64;
@@
 struct {  int state ;  int recv_len ;  struct hv_fcopy_hdr * fcopy_msg ;  struct vmbus_channel * recv_channel ;  u64 recv_req_id ; } cocci_id@p ;
...
position p;
@@
 struct hv_fcopy_hdr * cocci_id@p ;
