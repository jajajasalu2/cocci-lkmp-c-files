...
position p;
@@
 struct memory_block * cocci_id@p ;
...
position p;
@@
 struct acpi_memory_device cocci_id@p ;
...
typedef u64;
@@
 struct acpi_memory_info {  struct list_head list ;  u64 start_addr ;  u64 length ;  unsigned short caching ;  unsigned short write_protect ;  unsigned int enabled : 1 ; } cocci_id@p ;
...
position p;
@@
 struct acpi_memory_device {  struct acpi_device * device ;  unsigned int state ;  struct list_head res_list ; } cocci_id@p ;
...
position p;
@@
 struct acpi_memory_info cocci_id@p ;
