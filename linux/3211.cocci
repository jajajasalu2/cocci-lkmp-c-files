...
typedef s8,s16;
@@
 struct ad7414_data {  struct i2c_client * client ;  struct mutex lock ;  char valid ;  unsigned long next_update ;  s16 temp_input ;  s8 temps [ ARRAY_SIZE ( AD7414_REG_LIMIT ) ] ; } cocci_id@p ;
