...
typedef u32;
@@
 struct axg_dai_link_tdm_mask {  u32 tx ;  u32 rx ; } cocci_id@p ;
...
position p;
@@
 struct axg_card {  struct snd_soc_card card ;  void * * link_data ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_soc_card * c , const char * p ) ;
...
position p;
@@
 struct axg_dai_link_tdm_mask * cocci_id@p ;
...
typedef u32;
@@
 struct axg_dai_link_tdm_data {  unsigned int mclk_fs ;  unsigned int slots ;  unsigned int slot_width ;  u32 * tx_mask ;  u32 * rx_mask ;  struct axg_dai_link_tdm_mask * codec_masks ; } cocci_id@p ;
...
position p;
@@
 struct axg_dai_link_tdm_data * cocci_id@p ;
