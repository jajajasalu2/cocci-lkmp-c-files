...
position p;
@@
 enum gb_camera_state { GB_CAMERA_STATE_UNCONFIGURED , GB_CAMERA_STATE_CONFIGURED , } cocci_id@p ;
...
position p;
@@
 struct gb_camera_debugfs_buffer * cocci_id@p ;
...
position p;
@@
 struct gb_camera_capture_request * cocci_id@p ;
...
position p;
@@
 enum v4l2_mbus_pixelcode cocci_id@p ;
...
position p;
@@
 const struct gb_camera_debugfs_entry cocci_id@p [ ] ;
...
position p;
@@
 struct gb_camera_fmt_info {  enum v4l2_mbus_pixelcode mbus_code ;  unsigned int gb_format ;  unsigned int bpp ; } cocci_id@p ;
...
position p;
@@
 struct ap_csi_config_request cocci_id@p ;
...
position p;
@@
 struct gb_camera_csi_params * cocci_id@p ;
...
position p;
@@
 const struct gb_camera_ops cocci_id@p ;
...
position p;
@@
 const struct gb_camera_fmt_info cocci_id@p [ ] ;
...
position p;
@@
 struct gb_camera_stream_config_response * cocci_id@p ;
...
position p;
@@
 struct gb_camera_stream_config {  unsigned int width ;  unsigned int height ;  unsigned int format ;  unsigned int vc ;  unsigned int dt [ 2 ] ;  unsigned int max_size ; } cocci_id@p ;
...
position p;
@@
 struct gb_camera_metadata_request * cocci_id@p ;
...
position p;
@@
 enum gb_camera_debugs_buffer_id { GB_CAMERA_DEBUGFS_BUFFER_CAPABILITIES , GB_CAMERA_DEBUGFS_BUFFER_STREAMS , GB_CAMERA_DEBUGFS_BUFFER_CAPTURE , GB_CAMERA_DEBUGFS_BUFFER_FLUSH , GB_CAMERA_DEBUGFS_BUFFER_MAX , } cocci_id@p ;
...
position p;
@@
 struct gb_camera_configure_streams_response * cocci_id@p ;
...
position p;
@@
 struct gb_camera_stream_config * cocci_id@p ;
...
position p;
@@
 struct gb_camera_module * cocci_id@p ;
...
position p;
@@
 struct gb_camera_stream_config_request * cocci_id@p ;
...
position p;
@@
 struct gb_camera_flush_response cocci_id@p ;
...
position p;
@@
 struct gb_camera_stream * cocci_id@p ;
...
typedef u16;
@@
 struct gb_camera {  struct gb_bundle * bundle ;  struct gb_connection * connection ;  struct gb_connection * data_connection ;  u16 data_cport_id ;  struct mutex mutex ;  enum gb_camera_state state ;  struct {  struct dentry * root ;  struct gb_camera_debugfs_buffer * buffers ; } debugfs ;  struct gb_camera_module module ; } cocci_id@p ;
...
position p;
@@
 struct gb_camera_debugfs_buffer {  char data [ PAGE_SIZE ] ;  size_t length ; } cocci_id@p ;
...
position p;
@@
 struct gb_camera_configure_streams_request * cocci_id@p ;
