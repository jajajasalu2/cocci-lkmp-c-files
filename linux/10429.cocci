...
typedef u32;
@@
 struct du_clk_params {  struct clk * clk ;  unsigned long rate ;  unsigned long diff ;  u32 escr ; } cocci_id@p ;
...
position p;
@@
 struct dpll_info {  unsigned int output ;  unsigned int fdpll ;  unsigned int n ;  unsigned int m ; } cocci_id@p ;
...
position p;
@@
 const struct rcar_du_format_info * cocci_id@p ;
...
position p;
@@
 struct du_clk_params * cocci_id@p ;
...
position p;
@@
 struct rcar_du_crtc_state * cocci_id@p ;
...
position p;
@@
 struct rcar_du_crtc * cocci_id@p ;
...
position p;
@@
 struct rcar_du_group * cocci_id@p ;
...
position p;
@@
 struct rcar_du_plane * cocci_id@p ;
...
position p;
@@
 enum vsp1_du_crc_source cocci_id@p ;
...
position p;
@@
 struct rcar_du_encoder * cocci_id@p ;
...
position p;
@@
 struct rcar_du_device * cocci_id@p ;
...
position p;
@@
 struct rcar_du_plane * cocci_id@p [ RCAR_DU_NUM_HW_PLANES ] ;
