...
position p;
@@
 enum cpcap_dai { CPCAP_DAI_HIFI , CPCAP_DAI_VOICE , } cocci_id@p ;
...
typedef u16;
@@
 struct cpcap_audio {  struct snd_soc_component * component ;  struct regmap * regmap ;  u16 vendor ;  int codec_clk_id ;  int codec_freq ;  int codec_format ; } cocci_id@p ;
...
typedef u16;
@@
 struct cpcap_reg_info {  u16 reg ;  u16 mask ;  u16 val ; } cocci_id@p ;
...
position p;
@@
 const struct cpcap_reg_info cocci_id@p [ ] ;
