...
typedef u64;
@@
 struct range2trim {  u64 blkno ;  u64 nblocks ; } * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dmaptree * dtp ) ;
...
typedef dmtree_t;
@@
 int cocci_id@p ( dmtree_t * tp , int l2nb , int * leafidx ) ;
...
typedef dmtree_t;
@@
 void cocci_id@p ( dmtree_t * tp , int leafno , int newval ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct bmap * bmp , struct dmap * dp , s64 blkno , int nblocks , int l2nb , s64 * results ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct bmap * bmp , s64 nblocks , int l2nb , s64 blkno , s64 * results ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct inode * ip , s64 blkno , s64 nblocks , s64 addnblocks ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct dmap * dp , s64 blkno , int nblocks ) ;
...
typedef dmtree_t;
@@
 int cocci_id@p ( dmtree_t * tp , int leafno , int newval ) ;
...
typedef s64;
@@
 void cocci_id@p ( struct bmap * bmp , struct dmap * dp , s64 blkno , int nblocks ) ;
...
typedef dmtree_t;
@@
 int cocci_id@p ( dmtree_t * tp , int leafno ) ;
...
typedef u32;
@@
 int cocci_id@p ( u32 word , int l2nb ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct bmap * bmp , s64 blkno , int newval , int alloc , int level ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct bmap * bmp , struct dmap * dp , int nblocks , int l2nb , s64 * results ) ;
...
position p;
@@
 int cocci_id@p ( struct dmapctl * dcp , int level , int i ) ;
...
typedef dmtree_t;
@@
 void cocci_id@p ( dmtree_t * tp , int leafno , int splitsz , int newval ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct bmap * bmp , int l2nb , int level , s64 * blkno ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct bmap * bmp , int agno , s64 nblocks , int l2nb , s64 * results ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct bmap * bmp , struct dmap * dp , s64 blkno , int nblocks ) ;
...
typedef s64;
@@
 int cocci_id@p ( struct bmap * bmp , s64 nblocks , int l2nb , s64 * results ) ;
