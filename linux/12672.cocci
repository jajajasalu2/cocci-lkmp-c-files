...
position p;
@@
 struct moxtet_driver * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ TURRIS_MOX_MAX_MODULES * 2 + 1 ] ;
...
position p;
@@
 struct moxtet_irqpos * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ TURRIS_MOX_MAX_MODULES ] ;
...
position p;
@@
 int cocci_id@p [ TURRIS_MOX_MODULE_LAST ] ;
...
position p;
@@
 const struct {  const char * name ;  int hwirq_base ;  int nirqs ;  const char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 struct moxtet_device * cocci_id@p ;
...
position p;
@@
 const enum turris_mox_module_id * cocci_id@p ;
