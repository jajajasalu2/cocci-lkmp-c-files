...
position p;
@@
 struct qcom_rpm_message * cocci_id@p ;
...
typedef __le32;
@@
 struct qcom_rpm_header {  __le32 service_type ;  __le32 length ; } cocci_id@p ;
...
position p;
@@
 struct qcom_rpm_header cocci_id@p ;
...
position p;
@@
 struct qcom_smd_rpm * cocci_id@p ;
...
position p;
@@
 struct qcom_rpm_request cocci_id@p ;
...
typedef __le32;
@@
 struct qcom_rpm_request {  __le32 msg_id ;  __le32 flags ;  __le32 type ;  __le32 id ;  __le32 data_len ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  struct qcom_rpm_header hdr ;  struct qcom_rpm_request req ;  u8 payload [ ] ; } * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct qcom_rpm_message {  __le32 msg_type ;  __le32 length ;  union {  __le32 msg_id ;  u8 message [ 0 ] ; } ; } cocci_id@p ;
...
position p;
@@
 struct qcom_smd_rpm {  struct rpmsg_endpoint * rpm_channel ;  struct platform_device * icc ;  struct device * dev ;  struct completion ack ;  struct mutex lock ;  int ack_status ; } cocci_id@p ;
...
position p;
@@
 const struct qcom_rpm_message * cocci_id@p ;
...
position p;
@@
 const struct qcom_rpm_header * cocci_id@p ;
