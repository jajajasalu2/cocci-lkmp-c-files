...
position p;
@@
 struct broadsheet_board * cocci_id@p ;
...
position p;
@@
 struct broadsheetfb_par * cocci_id@p ;
...
typedef u16;
@@
 struct panel_info {  int w ;  int h ;  u16 sdcfg ;  u16 gdcfg ;  u16 lutfmt ;  u16 fsynclen ;  u16 fendfbegin ;  u16 lsynclen ;  u16 lendlbegin ;  u16 pixclk ; } cocci_id@p ;
