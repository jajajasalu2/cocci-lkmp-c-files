...
position p;
@@
 struct els_logo_payload cocci_id@p ;
...
position p;
@@
 struct fw_dif_context * cocci_id@p ;
...
position p;
@@
 struct tsk_mgmt_entry * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint16_t,uint8_t,uint32_t;
@@
 struct fw_dif_context {  uint32_t ref_tag ;  uint16_t app_tag ;  uint8_t ref_tag_mask [ 4 ] ;  uint8_t app_tag_mask [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct mrk_entry_24xx * cocci_id@p ;
