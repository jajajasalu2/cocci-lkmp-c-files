...
position p;
@@
 enum dvbs2_fectype { DVBS2_64K , DVBS2_16K , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct stv_base {  struct list_head stvlist ;  u8 adr ;  struct i2c_adapter * i2c ;  struct mutex i2c_lock ;  struct mutex reg_lock ;  int count ;  u32 extclk ;  u32 mclk ; } cocci_id@p ;
...
position p;
@@
 const enum fe_modulation cocci_id@p [ 0x20 ] ;
...
position p;
@@
 enum fe_stv0910_roll_off { FE_SAT_35 , FE_SAT_25 , FE_SAT_20 , FE_SAT_15 , } cocci_id@p ;
...
position p;
@@
 const struct slookup * cocci_id@p ;
...
position p;
@@
 const enum fe_code_rate cocci_id@p [ 0x20 ] ;
...
typedef s16,u32;
@@
 struct slookup {  s16 value ;  u32 reg_value ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct sinit_table {  u16 address ;  u8 data ; } cocci_id@p ;
...
position p;
@@
 enum fe_stv0910_mod_cod cocci_id@p ;
...
position p;
@@
 enum fe_stv0910_roll_off cocci_id@p ;
...
position p;
@@
 enum receive_mode { RCVMODE_NONE , RCVMODE_DVBS , RCVMODE_DVBS2 , RCVMODE_AUTO , } cocci_id@p ;
