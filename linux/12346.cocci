...
position p;
@@
 struct vc4_shader_state cocci_id@p ;
...
position p;
@@
 struct drm_vc4_submit_cl * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct vc4_seqno_cb * cb ) ;
...
typedef u32;
@@
 struct vc4_hang_state {  struct drm_vc4_get_hang_state user_state ;  u32 bo_count ;  struct drm_gem_object * * bo ; } cocci_id@p ;
...
position p;
@@
 struct vc4_hang_state * cocci_id@p ;
...
position p;
@@
 struct vc4_exec_info cocci_id@p ;
...
position p;
@@
 struct drm_vc4_get_hang_state_bo * cocci_id@p ;
...
position p;
@@
 struct drm_vc4_wait_bo * cocci_id@p ;
...
position p;
@@
 struct vc4_exec_info * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct drm_vc4_gem_madvise * cocci_id@p ;
...
position p;
@@
 struct drm_vc4_wait_seqno * cocci_id@p ;
...
position p;
@@
 struct drm_vc4_get_hang_state * cocci_id@p ;
