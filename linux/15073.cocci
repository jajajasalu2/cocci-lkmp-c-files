...
position p;
@@
 const struct pll_config cocci_id@p ;
...
position p;
@@
 enum { P_PXO , P_PLL8 , P_PLL2 , P_PLL3 , P_PLL15 , P_HDMI_PLL , P_DSI1_PLL_DSICLK , P_DSI2_PLL_DSICLK , P_DSI1_PLL_BYTECLK , P_DSI2_PLL_BYTECLK , } cocci_id@p ;
...
position p;
@@
 const struct parent_map cocci_id@p [ ] ;
...
typedef u32;
@@
 struct clk_pix_rdi {  u32 s_reg ;  u32 s_mask ;  u32 s2_reg ;  u32 s2_mask ;  struct clk_regmap clkr ; } cocci_id@p ;
