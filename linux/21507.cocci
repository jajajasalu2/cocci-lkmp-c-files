...
typedef u64,bool;
@@
 struct pg_state {  struct seq_file * seq ;  const struct addr_marker * marker ;  unsigned long start_address ;  unsigned level ;  u64 current_prot ;  bool check_wx ;  unsigned long wx_pages ;  unsigned long uxn_pages ; } cocci_id@p ;
...
typedef u64;
@@
 struct prot_bits {  u64 mask ;  u64 val ;  const char * set ;  const char * clear ; } cocci_id@p ;
...
typedef u64;
@@
 struct pg_level {  const struct prot_bits * bits ;  const char * name ;  size_t num ;  u64 mask ; } cocci_id@p ;
