...
position p;
@@
 struct ltpc_private {  struct atalk_addr my_addr ; } cocci_id@p ;
...
position p;
@@
 struct ltpc_private cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , void * cbuf , int cbuflen , void * dbuf , int dbuflen ) ;
...
position p;
@@
 struct xmitQel {  struct xmitQel * next ;  unsigned char * cbuf ;  short cbuflen ;  unsigned char * dbuf ;  short dbuflen ;  unsigned char QWrite ;  unsigned char mailbox ; } cocci_id@p ;
