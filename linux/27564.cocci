...
typedef u64;
@@
 int cocci_id@p ( struct inode * src , struct inode * inode , u64 off , u64 olen , u64 olen_aligned , u64 destoff , int no_time_update ) ;
...
position p;
@@
 struct btrfs_clone_extent_info cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_dev_info_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_qgroup_create_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_balance_control * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BTRFS_LABEL_SIZE ] ;
...
position p;
@@
 struct btrfs_ioctl_space_info * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_get_subvol_rootref_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_quota_ctl_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_search_key * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_quota_rescan_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_qgroup_assign_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_get_dev_stats * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_get_subvol_info_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_logical_ino_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_search_header cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_feature_flags cocci_id@p [ 2 ] ;
...
position p;
@@
 struct btrfs_ioctl_vol_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_received_subvol_args_32 cocci_id@p ;
...
position p;
@@
 struct btrfs_qgroup_inherit * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_received_subvol_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_scrub_args * cocci_id@p ;
...
position p;
@@
 const struct btrfs_ioctl_feature_flags cocci_id@p [ 3 ] ;
...
position p;
@@
 struct btrfs_ioctl_vol_args_v2 cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_search_args_v2 cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_ino_lookup_user_args * cocci_id@p ;
...
position p;
@@
 enum btrfs_feature_set cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_fs_info_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_space_info * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_balance_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_data_container * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_dev_replace_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_space_args cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_ino_lookup_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_qgroup_limit_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_defrag_range_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_ino_path_args * cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_feature_flags cocci_id@p ;
...
position p;
@@
 struct btrfs_ioctl_send_args_32 cocci_id@p ;
