...
position p;
@@
 char cocci_id@p [ IP_VS_PENAME_MAXLEN + IP_VS_PEDATA_MAXLEN + 3 ] ;
...
position p;
@@
 struct ip_vs_iter_state cocci_id@p ;
...
position p;
@@
 const struct ip_vs_conn_param * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ IP_VS_ADDRSTRLEN ] ;
...
position p;
@@
 struct ip_vs_iter_state {  struct seq_net_private p ;  struct hlist_head * l ; } cocci_id@p ;
