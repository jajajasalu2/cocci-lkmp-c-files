...
typedef __u64;
@@
 struct xdp_ring_offset_v1 {  __u64 producer ;  __u64 consumer ;  __u64 desc ; } cocci_id@p ;
...
position p;
@@
 struct xsk_socket_config * cocci_id@p ;
...
position p;
@@
 const struct xsk_umem * cocci_id@p ;
...
position p;
@@
 struct sockaddr_xdp cocci_id@p ;
...
position p;
@@
 const struct xsk_socket * cocci_id@p ;
...
position p;
@@
 const struct xsk_socket_config * cocci_id@p ;
...
typedef bool;
@@
 struct xsk_nl_info {  bool xdp_prog_attached ;  int ifindex ;  int fd ; } cocci_id@p ;
...
position p;
@@
 const struct xsk_umem_config * cocci_id@p ;
...
position p;
@@
 struct xdp_mmap_offsets cocci_id@p ;
...
position p;
@@
 struct xdp_mmap_offsets_v1 {  struct xdp_ring_offset_v1 rx ;  struct xdp_ring_offset_v1 tx ;  struct xdp_ring_offset_v1 fr ;  struct xdp_ring_offset_v1 cr ; } cocci_id@p ;
...
position p;
@@
 struct xsk_umem_config_v1 cocci_id@p ;
...
position p;
@@
 struct xsk_ring_cons * cocci_id@p ;
...
typedef __u32,__u64;
@@
 struct xsk_socket {  struct xsk_ring_cons * rx ;  struct xsk_ring_prod * tx ;  __u64 outstanding_tx ;  struct xsk_umem * umem ;  struct xsk_socket_config config ;  int fd ;  int ifindex ;  int prog_fd ;  int xsks_map_fd ;  __u32 queue_id ;  char ifname [ IFNAMSIZ ] ; } cocci_id@p ;
...
position p;
@@
 struct xsk_umem {  struct xsk_ring_prod * fill ;  struct xsk_ring_cons * comp ;  char * umem_area ;  struct xsk_umem_config config ;  int fd ;  int refcount ; } cocci_id@p ;
...
position p;
@@
 struct xsk_ring_prod * cocci_id@p ;
...
typedef __u32;
@@
 struct xsk_umem_config_v1 {  __u32 fill_size ;  __u32 comp_size ;  __u32 frame_size ;  __u32 frame_headroom ; } cocci_id@p ;
...
position p;
@@
 struct xdp_umem_reg cocci_id@p ;
...
position p;
@@
 struct xdp_mmap_offsets_v1 cocci_id@p ;
...
position p;
@@
 struct xsk_umem_config * cocci_id@p ;
