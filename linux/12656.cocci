...
position p;
@@
 enum ipu_color_space cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ IPU_NUM_IRQS / 32 ] ;
...
position p;
@@
 const struct ipu_devtype * cocci_id@p ;
...
position p;
@@
 struct ipu_platform_reg {  struct ipu_client_platformdata pdata ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct ipu_devtype {  const char * name ;  unsigned long cm_ofs ;  unsigned long cpmem_ofs ;  unsigned long srm_ofs ;  unsigned long tpm_ofs ;  unsigned long csi0_ofs ;  unsigned long csi1_ofs ;  unsigned long ic_ofs ;  unsigned long disp0_ofs ;  unsigned long disp1_ofs ;  unsigned long dc_tmpl_ofs ;  unsigned long vdi_ofs ;  enum ipuv3_type type ; } cocci_id@p ;
...
position p;
@@
 struct ipu_platform_reg cocci_id@p [ ] ;
...
position p;
@@
 const struct fsu_link_info cocci_id@p [ ] ;
...
position p;
@@
 struct fsu_link_info {  struct fsu_link_reg_info src ;  struct fsu_link_reg_info sink ; } cocci_id@p ;
...
position p;
@@
 enum ipu_channel_irq cocci_id@p ;
...
position p;
@@
 struct irq_chip_type * cocci_id@p ;
...
typedef u32;
@@
 struct fsu_link_reg_info {  int chno ;  u32 reg ;  u32 mask ;  u32 val ; } cocci_id@p ;
...
typedef u32;
@@
 const struct {  int chnum ;  u32 reg ;  int shift ; } cocci_id@p [ ] ;
