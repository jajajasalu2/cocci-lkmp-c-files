...
position p;
@@
 struct pmcmsptwi_data {  void __iomem * iobase ;  int irq ;  struct completion wait ;  struct mutex lock ;  enum pmcmsptwi_xfer_result last_result ; } cocci_id@p ;
...
position p;
@@
 struct pmcmsptwi_cfg * cocci_id@p ;
...
position p;
@@
 enum pmcmsptwi_xfer_result { MSP_TWI_XFER_OK = 0 , MSP_TWI_XFER_TIMEOUT , MSP_TWI_XFER_BUSY , MSP_TWI_XFER_DATA_COLLISION , MSP_TWI_XFER_NO_RESPONSE , MSP_TWI_XFER_LOST_ARBITRATION , } cocci_id@p ;
...
position p;
@@
 enum pmcmsptwi_cmd_type { MSP_TWI_CMD_WRITE = 0 , MSP_TWI_CMD_READ = 1 , MSP_TWI_CMD_WRITE_READ = 2 , } cocci_id@p ;
...
position p;
@@
 struct pmcmsptwi_clockcfg {  struct pmcmsptwi_clock standard ;  struct pmcmsptwi_clock highspeed ; } cocci_id@p ;
...
position p;
@@
 const struct pmcmsptwi_clock * cocci_id@p ;
...
position p;
@@
 const struct pmcmsptwi_clockcfg * cocci_id@p ;
...
position p;
@@
 struct pmcmsptwi_data * cocci_id@p ;
...
position p;
@@
 enum pmcmsptwi_xfer_result cocci_id@p ;
...
position p;
@@
 const struct pmcmsptwi_cfg * cocci_id@p ;
...
position p;
@@
 struct pmcmsptwi_cmd cocci_id@p ;
...
typedef u8,u16;
@@
 struct pmcmsptwi_cmd {  u16 addr ;  enum pmcmsptwi_cmd_type type ;  u8 write_len ;  u8 read_len ;  u8 * write_data ;  u8 * read_data ; } cocci_id@p ;
...
typedef u8;
@@
 struct pmcmsptwi_cfg {  u8 arbf ;  u8 nak ;  u8 add10 ;  u8 mst_code ;  u8 arb ;  u8 highspeed ; } cocci_id@p ;
...
position p;
@@
 const struct pmcmsptwi_cmd * cocci_id@p ;
...
typedef u8,u16;
@@
 struct pmcmsptwi_clock {  u8 filter ;  u16 clock ; } cocci_id@p ;
