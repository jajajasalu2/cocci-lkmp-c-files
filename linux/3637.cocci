...
position p;
@@
 struct efi_runtime_map_entry cocci_id@p ;
...
position p;
@@
 struct map_attribute * cocci_id@p ;
...
typedef efi_memory_desc_t;
@@
 struct efi_runtime_map_entry {  efi_memory_desc_t md ;  struct kobject kobj ; } cocci_id@p ;
...
position p;
@@
 struct map_attribute {  struct attribute attr ;  ssize_t ( * show ) ( struct efi_runtime_map_entry * entry , char * buf ) ; } cocci_id@p ;
