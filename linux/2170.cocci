...
typedef u8;
@@
 u8 cocci_id@p [ DA9150_QIF_LONG_SIZE ] ;
...
position p;
@@
 struct da9150_fg_pdata cocci_id@p ;
...
typedef u32;
@@
 struct da9150_fg {  struct da9150 * da9150 ;  struct device * dev ;  struct mutex io_lock ;  struct power_supply * battery ;  struct delayed_work work ;  u32 interval ;  int warn_soc ;  int crit_soc ;  int soc ; } cocci_id@p ;
