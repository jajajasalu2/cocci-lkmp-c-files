...
position p;
@@
 struct palmas_pmic_driver_data * cocci_id@p ;
...
position p;
@@
 struct palmas_regs_info * cocci_id@p ;
...
position p;
@@
 struct palmas_pmic_platform_data * cocci_id@p ;
...
position p;
@@
 struct palmas_sleep_requestor_info cocci_id@p [ ] ;
...
position p;
@@
 struct palmas_reg_init * cocci_id@p ;
