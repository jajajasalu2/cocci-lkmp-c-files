...
@@
 struct xircom_private {  __le32 * rx_buffer ;  __le32 * tx_buffer ;  dma_addr_t rx_dma_handle ;  dma_addr_t tx_dma_handle ;  struct sk_buff * tx_skb [ 4 ] ;  void __iomem * ioaddr ;  int open ;  int transmit_used ;  spinlock_t lock ;  struct pci_dev * pdev ;  struct net_device * dev ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , struct xircom_private * card , int descnr , unsigned int bufferoffset ) ;
...
position p;
@@
 int cocci_id@p ( struct xircom_private * card ) ;
...
position p;
@@
 void cocci_id@p ( struct xircom_private * card ) ;
...
position p;
@@
 struct xircom_private * cocci_id@p ;
