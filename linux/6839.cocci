...
position p;
@@
 struct atto_ioctl_vda_mgt_cmd cocci_id@p ;
...
position p;
@@
 struct atto_vda_ae_req * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct esas2r_request * rq ) ;
...
position p;
@@
 char cocci_id@p [ sizeof ( cfg -> data . init . fw_release ) + 1 ] ;
...
position p;
@@
 struct atto_vda_sge * cocci_id@p ;
...
position p;
@@
 struct atto_vda_ae_data cocci_id@p ;
...
position p;
@@
 struct atto_vda_mgmt_req cocci_id@p ;
...
position p;
@@
 struct atto_vda_flash_req * cocci_id@p ;
...
position p;
@@
 struct atto_vda_cfg_rsp * cocci_id@p ;
...
position p;
@@
 struct atto_vda_cli_req * cocci_id@p ;
...
position p;
@@
 struct atto_vda_cfg_req * cocci_id@p ;
...
position p;
@@
 struct atto_ioctl_vda_cfg_cmd * cocci_id@p ;
