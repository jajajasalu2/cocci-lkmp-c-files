...
position p;
@@
 const struct d0_geometry_features * cocci_id@p ;
...
position p;
@@
 enum opal_atom_width { OPAL_WIDTH_TINY , OPAL_WIDTH_SHORT , OPAL_WIDTH_MEDIUM , OPAL_WIDTH_LONG , OPAL_WIDTH_TOKEN , } cocci_id@p ;
...
position p;
@@
 struct opal_read_write_table * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ ] [ OPAL_METHOD_LENGTH ] ;
...
position p;
@@
 const struct opal_resp_tok * cocci_id@p ;
...
position p;
@@
 const struct d0_features * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ ] [ OPAL_UID_LENGTH ] ;
...
position p;
@@
 const struct parsed_resp * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct opal_dev * dev ) ;
...
position p;
@@
 const struct opal_step cocci_id@p [ ] ;
...
position p;
@@
 struct opal_mbr_data * cocci_id@p ;
...
position p;
@@
 struct opal_session_info * cocci_id@p ;
...
position p;
@@
 const struct d0_single_user_mode * cocci_id@p ;
...
position p;
@@
 struct opal_step {  int ( * fn ) ( struct opal_dev * dev , void * data ) ;  void * data ; } cocci_id@p ;
...
position p;
@@
 struct opal_shadow_mbr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u64,bool,u32,u16;
@@
 struct opal_dev {  bool supported ;  bool mbr_enabled ;  void * data ;  sec_send_recv * send_recv ;  struct mutex dev_lock ;  u16 comid ;  u32 hsn ;  u32 tsn ;  u64 align ;  u64 lowest_lba ;  size_t pos ;  u8 cmd [ IO_BUFFER_LENGTH ] ;  u8 resp [ IO_BUFFER_LENGTH ] ;  struct parsed_resp parsed ;  size_t prev_d_len ;  void * prev_data ;  struct list_head unlk_lst ; } cocci_id@p ;
...
position p;
@@
 struct opal_mbr_done * cocci_id@p ;
...
position p;
@@
 struct opal_lock_unlock * cocci_id@p ;
...
typedef u8,u64,s64;
@@
 struct opal_resp_tok {  const u8 * pos ;  size_t len ;  enum opal_response_token type ;  enum opal_atom_width width ;  union {  u64 u ;  s64 s ; } stored ; } cocci_id@p ;
...
position p;
@@
 struct opal_resp_tok * cocci_id@p ;
...
position p;
@@
 const struct opal_key * cocci_id@p ;
...
typedef u8;
@@
 struct opal_suspend_data {  struct opal_lock_unlock unlk ;  u8 lr ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 const struct d0_header * cocci_id@p ;
...
position p;
@@
 struct parsed_resp {  int num ;  struct opal_resp_tok toks [ MAX_TOKS ] ; } cocci_id@p ;
...
position p;
@@
 const struct d0_opal_v100 * cocci_id@p ;
...
position p;
@@
 const struct d0_opal_v200 * cocci_id@p ;
...
position p;
@@
 struct opal_suspend_data * cocci_id@p ;
...
position p;
@@
 const struct d0_tper_features * cocci_id@p ;
...
position p;
@@
 const struct opal_header * cocci_id@p ;
...
position p;
@@
 const struct d0_locking_features * cocci_id@p ;
...
position p;
@@
 struct opal_user_lr_setup * cocci_id@p ;
