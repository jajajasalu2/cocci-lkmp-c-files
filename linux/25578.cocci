...
position p;
@@
 enum match_result { MATCH_ERROR = - 1 , MATCH_EQ , MATCH_LT , MATCH_GT , } cocci_id@p ;
...
typedef u64;
@@
 enum match_result cocci_id@p ( struct callchain_node * root , struct callchain_cursor * cursor , u64 period ) ;
