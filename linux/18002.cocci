...
typedef u64;
@@
 void cocci_id@p ( const u64 * input , u64 * output , unsigned int len , u64 * iv ) ;
...
typedef u64;
@@
 void cocci_id@p ( const u64 * expkey , const u64 * input , u64 * output , unsigned int len , u64 * iv ) ;
...
position p;
@@
 struct des3_ede_sparc64_ctx * cocci_id@p ;
...
position p;
@@
 struct des_sparc64_ctx cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ DES_EXPKEY_WORDS / 2 ] ;
...
typedef u64;
@@
 struct des3_ede_sparc64_ctx {  u64 encrypt_expkey [ DES3_EDE_EXPKEY_WORDS / 2 ] ;  u64 decrypt_expkey [ DES3_EDE_EXPKEY_WORDS / 2 ] ; } cocci_id@p ;
...
typedef u64;
@@
 struct des_sparc64_ctx {  u64 encrypt_expkey [ DES_EXPKEY_WORDS / 2 ] ;  u64 decrypt_expkey [ DES_EXPKEY_WORDS / 2 ] ; } cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( const u64 * input , u64 * output , unsigned int len ) ;
...
position p;
@@
 const struct des_sparc64_ctx * cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( const u64 * key , const u64 * input , u64 * output ) ;
...
typedef u64;
@@
 void cocci_id@p ( const u64 * expkey , const u64 * input , u64 * output , unsigned int len ) ;
...
typedef u64,u32;
@@
 void cocci_id@p ( const u32 * input_key , u64 * key ) ;
...
position p;
@@
 const struct des3_ede_sparc64_ctx * cocci_id@p ;
