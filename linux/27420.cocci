...
position p;
@@
 struct proc_fs_context {  struct pid_namespace * pid_ns ;  unsigned int mask ;  int hidepid ;  int gid ; } cocci_id@p ;
...
position p;
@@
 enum proc_param { Opt_gid , Opt_hidepid , } cocci_id@p ;
...
position p;
@@
 struct proc_fs_context * cocci_id@p ;
