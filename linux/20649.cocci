...
position p;
@@
 enum perf_cstate_core_events { PERF_CSTATE_CORE_C1_RES = 0 , PERF_CSTATE_CORE_C3_RES , PERF_CSTATE_CORE_C6_RES , PERF_CSTATE_CORE_C7_RES , PERF_CSTATE_CORE_EVENT_MAX , } cocci_id@p ;
...
position p;
@@
 enum perf_cstate_pkg_events { PERF_CSTATE_PKG_C2_RES = 0 , PERF_CSTATE_PKG_C3_RES , PERF_CSTATE_PKG_C6_RES , PERF_CSTATE_PKG_C7_RES , PERF_CSTATE_PKG_C8_RES , PERF_CSTATE_PKG_C9_RES , PERF_CSTATE_PKG_C10_RES , PERF_CSTATE_PKG_EVENT_MAX , } cocci_id@p ;
...
typedef u64;
@@
 struct perf_cstate_msr {  u64 msr ;  struct perf_pmu_events_attr * attr ; } cocci_id@p ;
...
position p;
@@
 struct cstate_model {  unsigned long core_events ;  unsigned long pkg_events ;  unsigned long quirks ; } cocci_id@p ;
...
position p;
@@
 const struct cstate_model cocci_id@p ;
