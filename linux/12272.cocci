...
typedef u8,bool,u32;
@@
 struct ili9322_config {  u32 width_mm ;  u32 height_mm ;  bool flip_horizontal ;  bool flip_vertical ;  enum ili9322_input input ;  u32 vreg1out_mv ;  u32 vcom_high_percent ;  u32 vcom_amplitude_percent ;  bool dclk_active_high ;  bool de_active_high ;  bool hsync_active_high ;  bool vsync_active_high ;  u8 syncmode ;  u8 gamma_corr_pos [ 8 ] ;  u8 gamma_corr_neg [ 8 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct ili9322 {  struct device * dev ;  const struct ili9322_config * conf ;  struct drm_panel panel ;  struct regmap * regmap ;  struct regulator_bulk_data supplies [ 3 ] ;  struct gpio_desc * reset_gpio ;  enum ili9322_input input ;  struct videomode vm ;  u8 gamma [ 8 ] ;  u8 vreg1out ;  u8 vcom_high ;  u8 vcom_amplitude ; } cocci_id@p ;
...
position p;
@@
 const struct ili9322_config cocci_id@p ;
