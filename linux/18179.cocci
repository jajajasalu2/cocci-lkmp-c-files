...
position p;
@@
 struct unwind_ctrl_block {  unsigned long vrs [ 16 ] ;  const unsigned long * insn ;  unsigned long sp_high ;  int check_each_pop ;  int entries ;  int byte ; } cocci_id@p ;
...
position p;
@@
 const struct unwind_idx cocci_id@p [ ] ;
...
position p;
@@
 struct unwind_ctrl_block * cocci_id@p ;
