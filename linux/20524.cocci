...
typedef u8,u32;
@@
 struct ghash_desc_ctx {  u8 buffer [ GHASH_BLOCK_SIZE ] ;  u32 bytes ; } cocci_id@p ;
...
typedef u128;
@@
 void cocci_id@p ( char * dst , const u128 * shash ) ;
...
typedef u128;
@@
 void cocci_id@p ( char * dst , const char * src , unsigned int srclen , const u128 * shash ) ;
...
typedef u128;
@@
 struct ghash_ctx {  u128 shash ; } cocci_id@p ;
