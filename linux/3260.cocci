...
position p;
@@
 struct abituguru3_data * cocci_id@p ( struct device * dev ) ;
...
typedef u8;
@@
 struct abituguru3_data {  struct device * hwmon_dev ;  struct mutex update_lock ;  unsigned short addr ;  char valid ;  unsigned long last_updated ;  struct sensor_device_attribute_2 sysfs_attr [ ABIT_UGURU3_MAX_NO_SENSORS * 10 ] ;  char sysfs_names [ ABIT_UGURU3_SYSFS_NAMES_LENGTH ] ;  const struct abituguru3_sensor_info * sensors ;  u8 alarms [ 48 / 8 ] ;  u8 value [ 48 ] ;  u8 settings [ 48 ] [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct abituguru3_data cocci_id@p ;
...
position p;
@@
 const struct abituguru3_motherboard_info cocci_id@p [ ] ;
...
position p;
@@
 const struct sensor_device_attribute_2 cocci_id@p [ 3 ] [ 10 ] ;
...
typedef u16;
@@
 struct abituguru3_motherboard_info {  u16 id ;  const char * dmi_name [ ABIT_UGURU3_MAX_DMI_NAMES + 1 ] ;  struct abituguru3_sensor_info sensors [ ABIT_UGURU3_MAX_NO_SENSORS + 1 ] ; } cocci_id@p ;
...
position p;
@@
 const struct abituguru3_sensor_info * cocci_id@p ;
...
position p;
@@
 struct abituguru3_sensor_info {  const char * name ;  int port ;  int type ;  int multiplier ;  int divisor ;  int offset ; } cocci_id@p ;
