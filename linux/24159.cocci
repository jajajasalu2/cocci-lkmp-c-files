...
position p;
@@
 struct nlattr * cocci_id@p [ ILA_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct fib6_config * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ ILA_ATTR_MAX + 1 ] ;
...
typedef u32;
@@
 struct ila_lwt {  struct ila_params p ;  struct dst_cache dst_cache ;  u32 connected : 1 ;  u32 lwt_output : 1 ; } cocci_id@p ;
