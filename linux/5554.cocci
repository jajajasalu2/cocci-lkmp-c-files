...
typedef spinlock_t;
@@
 struct tx4939rtc_plat_data {  struct rtc_device * rtc ;  struct tx4939_rtc_reg __iomem * rtcreg ;  spinlock_t lock ; } cocci_id@p ;
...
typedef __u32;
@@
 struct tx4939_rtc_reg {  __u32 ctl ;  __u32 adr ;  __u32 dat ;  __u32 tbc ; } cocci_id@p ;
...
position p;
@@
 struct tx4939rtc_plat_data * cocci_id@p ;
