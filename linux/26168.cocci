...
position p;
@@
 struct core_reloc_test_case * cocci_id@p ;
...
typedef bool;
@@
 struct core_reloc_test_case {  const char * case_name ;  const char * bpf_obj_file ;  const char * btf_src_file ;  const char * input ;  int input_len ;  const char * output ;  int output_len ;  bool fails ;  bool relaxed_core_relocs ;  bool direct_raw_tp ; } cocci_id@p ;
...
typedef uint64_t;
@@
 struct data {  char in [ 256 ] ;  char out [ 256 ] ;  uint64_t my_pid_tgid ; } cocci_id@p ;
