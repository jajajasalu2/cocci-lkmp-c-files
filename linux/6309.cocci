...
position p;
@@
 struct max8925_irq_data * cocci_id@p ;
...
position p;
@@
 struct max8925_irq_data {  int reg ;  int mask_reg ;  int enable ;  int offs ;  int flags ;  int tsc_irq ; } cocci_id@p ;
...
position p;
@@
 struct max8925_backlight_pdata cocci_id@p ;
...
position p;
@@
 enum { FLAGS_ADC = 1 , FLAGS_RTC , } cocci_id@p ;
...
position p;
@@
 struct max8925_platform_data * cocci_id@p ;
