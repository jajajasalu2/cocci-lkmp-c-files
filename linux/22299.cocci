...
position p;
@@
 const struct tomoyo_addr_info * cocci_id@p ;
...
position p;
@@
 struct tomoyo_unix_addr_info * cocci_id@p ;
...
typedef u8;
@@
 struct tomoyo_addr_info {  u8 protocol ;  u8 operation ;  struct tomoyo_inet_addr_info inet ;  struct tomoyo_unix_addr_info unix0 ; } cocci_id@p ;
...
position p;
@@
 const struct tomoyo_ipaddr_union * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ TOMOYO_SOCK_MAX ] [ TOMOYO_MAX_NETWORK_OPERATION ] ;
...
position p;
@@
 struct tomoyo_ipaddr_union * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_inet_acl * cocci_id@p ;
...
position p;
@@
 const struct tomoyo_unix_acl * cocci_id@p ;
...
position p;
@@
 struct tomoyo_addr_info * cocci_id@p ;
...
position p;
@@
 struct tomoyo_inet_addr_info * cocci_id@p ;
...
typedef bool,__be32;
@@
 struct tomoyo_inet_addr_info {  __be16 port ;  const __be32 * address ;  bool is_ipv6 ; } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ TOMOYO_SOCK_MAX ] ;
...
typedef u8;
@@
 struct tomoyo_unix_addr_info {  u8 * addr ;  unsigned int addr_len ; } cocci_id@p ;
