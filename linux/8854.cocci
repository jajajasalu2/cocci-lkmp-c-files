...
position p;
@@
 struct dma_extended_desc cocci_id@p ;
...
position p;
@@
 struct stmmac_rx_buffer * cocci_id@p ;
...
position p;
@@
 struct stmmac_tx_queue * cocci_id@p ;
...
position p;
@@
 struct stmmac_rx_queue * cocci_id@p ;
...
typedef u32,max_t;
@@
 int cocci_id@p [ max_t ( u32 , MTL_MAX_TX_QUEUES , MTL_MAX_RX_QUEUES ) ] ;
