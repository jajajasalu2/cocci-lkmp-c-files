...
position p;
@@
 struct vdev_info {  struct virtio_device vdev ;  int control ;  struct pollfd fds [ 1 ] ;  struct vq_info vqs [ 1 ] ;  int nvqs ;  void * buf ;  size_t buf_size ;  struct vhost_memory * mem ; } cocci_id@p ;
...
position p;
@@
 struct vq_info {  int kick ;  int call ;  int num ;  int idx ;  void * ring ;  struct vring vring ;  struct virtqueue * vq ; } cocci_id@p ;
