...
position p;
@@
 int cocci_id@p [ MAX_NR_CONSOLES ] ;
...
position p;
@@
 unsigned char cocci_id@p [ E_TABSZ ] ;
...
position p;
@@
 unsigned short cocci_id@p [ E_TABSZ ] ;
...
typedef u16;
@@
 struct uni_pagedir {  u16 * * uni_pgdir [ 32 ] ;  unsigned long refcount ;  unsigned long sum ;  unsigned char * inverse_translations [ 4 ] ;  u16 * inverse_trans_unicode ; } cocci_id@p ;
