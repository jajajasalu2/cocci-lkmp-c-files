...
typedef u32;
@@
 struct hs_timing {  u32 drv_phase ;  u32 smpl_dly ;  u32 smpl_phase_max ;  u32 smpl_phase_min ; } cocci_id@p ;
...
position p;
@@
 struct hs_timing cocci_id@p [ TIMING_MODE ] [ TIMING_CFG_NUM ] ;
...
typedef u32;
@@
 struct k3_priv {  int ctrl_id ;  u32 cur_speed ;  struct regmap * reg ; } cocci_id@p ;
