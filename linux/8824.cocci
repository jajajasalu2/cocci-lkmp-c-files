...
position p;
@@
 struct stmmac_channel * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct stmmac_packet_attrs {  int vlan ;  int vlan_id_in ;  int vlan_id_out ;  unsigned char * src ;  unsigned char * dst ;  u32 ip_src ;  u32 ip_dst ;  int tcp ;  int sport ;  int dport ;  u32 exp_hash ;  int dont_wait ;  int timeout ;  int size ;  int max_size ;  int remove_sa ;  u8 id ;  int sarc ;  u16 queue_mapping ; } cocci_id@p ;
...
position p;
@@
 struct stmmac_counters cocci_id@p ;
...
position p;
@@
 struct stmmac_extra_stats * cocci_id@p ;
...
position p;
@@
 struct stmmac_test_priv * cocci_id@p ;
...
position p;
@@
 const struct stmmac_test {  char name [ ETH_GSTRING_LEN ] ;  int lb ;  int ( * fn ) ( struct stmmac_priv * priv ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct stmmac_test_priv {  struct stmmac_packet_attrs * packet ;  struct packet_type pt ;  struct completion comp ;  int double_vlan ;  int vlan_id ;  int ok ; } cocci_id@p ;
...
position p;
@@
 struct stmmac_packet_attrs cocci_id@p ;
