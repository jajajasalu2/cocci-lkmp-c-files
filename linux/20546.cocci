...
position p;
@@
 struct cast6_xts_ctx * cocci_id@p ;
...
position p;
@@
 struct cast6_xts_ctx {  struct cast6_ctx tweak_ctx ;  struct cast6_ctx crypt_ctx ; } cocci_id@p ;
...
position p;
@@
 struct simd_skcipher_alg * cocci_id@p [ ARRAY_SIZE ( cast6_algs ) ] ;
...
typedef u8;
@@
 void cocci_id@p ( struct cast6_ctx * ctx , u8 * dst , const u8 * src ) ;
...
typedef u8,le128;
@@
 void cocci_id@p ( struct cast6_ctx * ctx , u8 * dst , const u8 * src , le128 * iv ) ;
