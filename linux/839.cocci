...
position p;
@@
 struct escd_info_struc * cocci_id@p ;
...
position p;
@@
 union pnp_bios_install_struct * cocci_id@p ;
...
position p;
@@
 struct pnp_docking_station_info cocci_id@p ;
...
position p;
@@
 struct pnp_isa_config_struc cocci_id@p ;
...
position p;
@@
 struct pnp_dev_node_info * cocci_id@p ;
...
typedef u16;
@@
 struct {  u16 offset ;  u16 segment ; } cocci_id@p ;
...
position p;
@@
 struct pnp_bios_node * cocci_id@p ;
