...
position p;
@@
 struct rds_msg_zcopy_queue * cocci_id@p ;
...
position p;
@@
 struct rds_incoming * cocci_id@p ;
...
position p;
@@
 struct rds_cong_map * cocci_id@p ;
...
position p;
@@
 struct rds_notifier * cocci_id@p ;
...
position p;
@@
 struct rds_zcopy_cookies * cocci_id@p ;
...
position p;
@@
 union {  struct rds_ext_header_version version ;  struct rds_ext_header_rdma rdma ;  struct rds_ext_header_rdma_dest rdma_dest ; } cocci_id@p ;
...
position p;
@@
 struct rds_connection * cocci_id@p ;
...
position p;
@@
 struct rds_conn_path * cocci_id@p ;
...
position p;
@@
 struct rds_info_iterator * cocci_id@p ;
...
position p;
@@
 struct rds_cmsg_rx_trace cocci_id@p ;
...
typedef u32,u16;
@@
 union {  struct rds_ext_header_version version ;  u16 rds_npaths ;  u32 rds_gen_num ; } cocci_id@p ;
...
position p;
@@
 struct rds_msg_zcopy_info * cocci_id@p ;
...
position p;
@@
 struct rds_rdma_notify cocci_id@p ;
...
position p;
@@
 struct rds6_info_message cocci_id@p ;
...
position p;
@@
 struct rds_info_message cocci_id@p ;
