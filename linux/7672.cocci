...
position p;
@@
 unsigned int cocci_id@p ( struct uart_port * port ) ;
...
position p;
@@
 struct qcom_geni_serial_port cocci_id@p ;
...
position p;
@@
 struct qcom_geni_serial_port cocci_id@p [ GENI_UART_PORTS ] ;
...
typedef u32;
@@
 unsigned char cocci_id@p [ sizeof ( u32 ) ] ;
...
typedef bool,u32;
@@
 int cocci_id@p ( struct uart_port * uport , u32 bytes , bool drop ) ;
...
position p;
@@
 void cocci_id@p ( struct uart_port * uport ) ;
...
typedef bool,u32;
@@
 struct qcom_geni_serial_port {  struct uart_port uport ;  struct geni_se se ;  char name [ 20 ] ;  u32 tx_fifo_depth ;  u32 tx_fifo_width ;  u32 rx_fifo_depth ;  bool setup ;  int ( * handle_rx ) ( struct uart_port * uport , u32 bytes , bool drop ) ;  unsigned int baud ;  unsigned int tx_bytes_pw ;  unsigned int rx_bytes_pw ;  u32 * rx_fifo ;  u32 loopback ;  bool brk ;  unsigned int tx_remaining ;  int wakeup_irq ; } cocci_id@p ;
