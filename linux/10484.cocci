...
position p;
@@
 SISLANDS_SMC_STATETABLE cocci_id@p ;
...
position p;
@@
 struct si_power_info cocci_id@p ;
...
typedef u32,u16;
@@
 int cocci_id@p ( struct radeon_device * rdev , u16 reg_offset , u32 value ) ;
...
position p;
@@
 SMC_SISLANDS_SPLL_DIV_TABLE cocci_id@p ;
...
position p;
@@
 const struct ni_leakage_coeffients * cocci_id@p ;
...
position p;
@@
 struct ni_power_info * cocci_id@p ( struct radeon_device * rdev ) ;
...
position p;
@@
 struct si_mc_reg_table * cocci_id@p ;
...
position p;
@@
 const struct si_powertune_data cocci_id@p ;
...
position p;
@@
 struct evergreen_power_info * cocci_id@p ( struct radeon_device * rdev ) ;
...
position p;
@@
 SISLANDS_SMC_SWSTATE * cocci_id@p ;
...
position p;
@@
 PP_SIslands_CacConfig cocci_id@p ;
...
position p;
@@
 PP_SIslands_PAPMParameters * cocci_id@p ;
...
position p;
@@
 SISLANDS_SMC_MCLK_VALUE * cocci_id@p ;
...
position p;
@@
 const struct si_ulv_param * cocci_id@p ;
...
position p;
@@
 Smc_SIslands_DTE_Configuration cocci_id@p ;
...
position p;
@@
 struct ni_ps * cocci_id@p ( struct radeon_ps * rps ) ;
...
position p;
@@
 const struct si_cac_config_reg * cocci_id@p ;
...
position p;
@@
 const struct radeon_phase_shedding_limits_table * cocci_id@p ;
...
position p;
@@
 SMC_SIslands_MCRegisterSet cocci_id@p ;
...
position p;
@@
 SISLANDS_SMC_VOLTAGE_VALUE * cocci_id@p ;
...
position p;
@@
 struct SISLANDS_SMC_VOLTAGE_VALUE * cocci_id@p ;
...
position p;
@@
 struct radeon_ppm_table * cocci_id@p ;
...
position p;
@@
 union pplib_clock_info {  struct _ATOM_PPLIB_R600_CLOCK_INFO r600 ;  struct _ATOM_PPLIB_RS780_CLOCK_INFO rs780 ;  struct _ATOM_PPLIB_EVERGREEN_CLOCK_INFO evergreen ;  struct _ATOM_PPLIB_SUMO_CLOCK_INFO sumo ;  struct _ATOM_PPLIB_SI_CLOCK_INFO si ; } cocci_id@p ;
...
position p;
@@
 enum radeon_dpm_auto_throttle_src cocci_id@p ;
...
position p;
@@
 const struct si_power_info * cocci_id@p ;
...
position p;
@@
 struct ni_power_info * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct radeon_device * rdev , u32 engine_clock , SISLANDS_SMC_SCLK_VALUE * sclk ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct radeon_device * rdev , const struct atom_voltage_table * table , u16 value , SISLANDS_SMC_VOLTAGE_VALUE * voltage ) ;
...
position p;
@@
 enum radeon_dpm_event_src cocci_id@p ;
...
position p;
@@
 const struct si_dte_data cocci_id@p ;
...
position p;
@@
 SISLANDS_SMC_SCLK_VALUE * cocci_id@p ;
...
position p;
@@
 SISLANDS_SMC_HW_PERFORMANCE_LEVEL * cocci_id@p ;
...
position p;
@@
 enum radeon_dpm_forced_level cocci_id@p ;
...
position p;
@@
 SMC_SIslands_MCArbDramTimingRegisterSet * cocci_id@p ;
...
position p;
@@
 struct radeon_cac_leakage_table * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct radeon_device * rdev , struct rv7xx_pl * pl , SISLANDS_SMC_HW_PERFORMANCE_LEVEL * level ) ;
...
position p;
@@
 struct si_cac_config_reg cocci_id@p [ ] ;
...
position p;
@@
 struct radeon_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct si_ulv_param * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct radeon_device * rdev ) ;
...
position p;
@@
 struct rv7xx_power_info * cocci_id@p ;
...
position p;
@@
 struct evergreen_power_info * cocci_id@p ;
...
position p;
@@
 enum radeon_pcie_gen cocci_id@p ;
...
position p;
@@
 struct radeon_vce_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 const struct si_mc_reg_entry * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct radeon_device * rdev , bool enable ) ;
...
position p;
@@
 struct rv7xx_power_info * cocci_id@p ( struct radeon_device * rdev ) ;
...
position p;
@@
 struct radeon_clock_and_voltage_limits * cocci_id@p ;
...
position p;
@@
 SMC_SIslands_MCRegisters * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct radeon_device * rdev ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct radeon_device * rdev , SISLANDS_SMC_VOLTAGE_VALUE * voltage , u16 * std_voltage ) ;
...
position p;
@@
 PP_SIslands_FanTable cocci_id@p ;
...
position p;
@@
 struct radeon_clock_voltage_dependency_entry cocci_id@p ;
...
position p;
@@
 const struct atom_voltage_table * cocci_id@p ;
