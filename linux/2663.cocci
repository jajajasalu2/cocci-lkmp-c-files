...
position p;
@@
 struct synquacer_i2c * cocci_id@p ;
...
position p;
@@
 enum i2c_state { STATE_IDLE , STATE_START , STATE_READ , STATE_WRITE , } cocci_id@p ;
...
typedef u32;
@@
 struct synquacer_i2c {  struct completion completion ;  struct i2c_msg * msg ;  u32 msg_num ;  u32 msg_idx ;  u32 msg_ptr ;  int irq ;  struct device * dev ;  void __iomem * base ;  struct clk * pclk ;  u32 pclkrate ;  u32 speed_khz ;  u32 timeout_ms ;  enum i2c_state state ;  struct i2c_adapter adapter ; } cocci_id@p ;
