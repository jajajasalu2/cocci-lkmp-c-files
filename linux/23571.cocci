...
position p;
@@
 struct msp_multichannel_config * cocci_id@p ;
...
position p;
@@
 struct ux500_msp_config cocci_id@p ;
...
position p;
@@
 struct ux500_msp_i2s_drvdata * cocci_id@p ;
...
position p;
@@
 struct msp_i2s_platform_data * cocci_id@p ;
...
position p;
@@
 struct msp_protdesc * cocci_id@p ;
