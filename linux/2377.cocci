...
position p;
@@
 const struct adsp_pil_data * cocci_id@p ;
...
position p;
@@
 struct adsp_pil_data {  int crash_reason_smem ;  const char * firmware_name ;  const char * ssr_name ;  const char * sysmon_name ;  int ssctl_id ;  const char * * clk_ids ;  int num_clks ; } cocci_id@p ;
