...
position p;
@@
 enum ring_id { NETSEC_RING_TX = 0 , NETSEC_RING_RX , } cocci_id@p ;
...
position p;
@@
 struct netsec_desc_ring * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mii_bus * bus , int phy_addr , int reg_addr ) ;
...
position p;
@@
 struct netsec_rx_pkt_info cocci_id@p ;
...
typedef bool;
@@
 struct netsec_rx_pkt_info {  int rx_cksum_result ;  int err_code ;  bool err_flag ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,phy_interface_t,spinlock_t;
@@
 struct netsec_priv {  struct netsec_desc_ring desc_ring [ NETSEC_RING_MAX ] ;  struct ethtool_coalesce et_coalesce ;  struct bpf_prog * xdp_prog ;  spinlock_t reglock ;  struct napi_struct napi ;  phy_interface_t phy_interface ;  struct net_device * ndev ;  struct device_node * phy_np ;  struct phy_device * phydev ;  struct mii_bus * mii_bus ;  void __iomem * ioaddr ;  void __iomem * eeprom_base ;  struct device * dev ;  struct clk * clk ;  u32 msg_enable ;  u32 freq ;  u32 phy_addr ;  bool rx_cksum_offload_flag ; } cocci_id@p ;
...
position p;
@@
 const struct netsec_desc * cocci_id@p ;
...
position p;
@@
 const struct netsec_tx_pkt_ctrl * cocci_id@p ;
...
position p;
@@
 enum buf_type { TYPE_NETSEC_SKB = 0 , TYPE_NETSEC_XDP_TX , TYPE_NETSEC_XDP_NDO , } cocci_id@p ;
...
@@
 struct netsec_desc {  union {  struct sk_buff * skb ;  struct xdp_frame * xdpf ; } ;  dma_addr_t dma_addr ;  void * addr ;  u16 len ;  u8 buf_type ; } cocci_id@p ;
...
typedef bool,u16;
@@
 struct netsec_tx_pkt_ctrl {  u16 tcp_seg_len ;  bool tcp_seg_offload_flag ;  bool cksum_offload_flag ; } cocci_id@p ;
...
typedef u32;
@@
 struct netsec_de {  u32 attr ;  u32 data_buf_addr_up ;  u32 data_buf_addr_lw ;  u32 buf_len_info ; } cocci_id@p ;
...
position p;
@@
 struct netsec_tx_pkt_ctrl cocci_id@p ;
