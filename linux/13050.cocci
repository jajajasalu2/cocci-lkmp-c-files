...
position p;
@@
 struct ocmem_region * cocci_id@p ;
...
position p;
@@
 enum ocmem_macro_state { PASSTHROUGH = 0 , PERI_ON = 1 , CORE_ON = 2 , CLK_OFF = 4 , } cocci_id@p ;
...
position p;
@@
 const struct ocmem_config cocci_id@p ;
...
typedef bool;
@@
 struct ocmem_region {  bool interleaved ;  enum region_mode mode ;  unsigned int num_macros ;  enum ocmem_macro_state macro_state [ 4 ] ;  unsigned long macro_size ;  unsigned long region_size ; } cocci_id@p ;
...
typedef uint8_t;
@@
 struct ocmem_config {  uint8_t num_regions ;  unsigned long macro_size ; } cocci_id@p ;
...
position p;
@@
 enum region_mode { WIDE_MODE = 0x0 , THIN_MODE , MODE_DEFAULT = WIDE_MODE , } cocci_id@p ;
...
position p;
@@
 enum ocmem_macro_state cocci_id@p ;
...
typedef bool;
@@
 struct ocmem {  struct device * dev ;  const struct ocmem_config * config ;  struct resource * memory ;  void __iomem * mmio ;  unsigned int num_ports ;  unsigned int num_macros ;  bool interleaved ;  struct ocmem_region * regions ;  unsigned long active_allocations ; } cocci_id@p ;
