...
position p;
@@
 struct net_dm_drop_point cocci_id@p ;
...
position p;
@@
 const struct net_dm_alert_ops * cocci_id@p ;
...
position p;
@@
 const struct net_dm_hw_entry * cocci_id@p ;
...
position p;
@@
 struct dm_hw_stat_delta cocci_id@p ;
...
position p;
@@
 enum net_dm_alert_mode * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct per_cpu_dm_data {  spinlock_t lock ;  union {  struct sk_buff * skb ;  struct net_dm_hw_entries * hw_entries ; } ;  struct sk_buff_head drop_queue ;  struct work_struct dm_alert_work ;  struct timer_list send_timer ;  struct net_dm_stats stats ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NET_DM_MAX_SYMBOL_LEN ] ;
...
position p;
@@
 struct per_cpu_dm_data * cocci_id@p ;
...
position p;
@@
 struct net_dm_stats * cocci_id@p ;
...
typedef u64;
@@
 struct net_dm_stats {  u64 dropped ;  struct u64_stats_sync syncp ; } cocci_id@p ;
...
position p;
@@
 struct dm_hw_stat_delta {  struct net_device * dev ;  unsigned long last_rx ;  struct list_head list ;  struct rcu_head rcu ;  unsigned long last_drop_val ; } cocci_id@p ;
...
position p;
@@
 const struct net_dm_hw_entries * cocci_id@p ;
...
position p;
@@
 struct net_dm_alert_ops {  void ( * kfree_skb_probe ) ( void * ignore , struct sk_buff * skb , void * location ) ;  void ( * napi_poll_probe ) ( void * ignore , struct napi_struct * napi , int work , int budget ) ;  void ( * work_item_func ) ( struct work_struct * work ) ;  void ( * hw_work_item_func ) ( struct work_struct * work ) ;  void ( * hw_probe ) ( struct sk_buff * skb , const struct net_dm_hw_metadata * hw_metadata ) ; } cocci_id@p ;
...
position p;
@@
 struct net_dm_hw_entries * cocci_id@p ;
...
position p;
@@
 struct net_dm_alert_msg * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NET_DM_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct net_dm_hw_metadata * cocci_id@p ;
...
position p;
@@
 struct net_dm_skb_cb {  union {  struct net_dm_hw_metadata * hw_metadata ;  void * pc ; } ; } cocci_id@p ;
...
typedef u32;
@@
 struct net_dm_hw_entries {  u32 num_entries ;  struct net_dm_hw_entry entries [ 0 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct net_dm_hw_entry {  char trap_name [ NET_DM_MAX_HW_TRAP_NAME_LEN ] ;  u32 count ; } cocci_id@p ;
...
position p;
@@
 struct net_dm_skb_cb * cocci_id@p ;
...
position p;
@@
 struct net_dm_hw_entry * cocci_id@p ;
