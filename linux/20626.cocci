...
position p;
@@
 struct msr_regs_info * cocci_id@p ;
...
position p;
@@
 struct msr_info_completion * cocci_id@p ;
...
position p;
@@
 struct msr_info_completion {  struct msr_info msr ;  struct completion done ; } cocci_id@p ;
