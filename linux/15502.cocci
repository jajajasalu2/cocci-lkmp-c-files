...
position p;
@@
 struct st95_digital_cmd_complete_arg * cocci_id@p ;
...
position p;
@@
 struct cmd {  int cmd_len ;  unsigned char cmd_id ;  unsigned char no_cmd_params ;  unsigned char cmd_params [ MAX_CMD_PARAMS ] ;  enum req_type req ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct st95hf_context {  struct st95hf_spi_context spicontext ;  struct nfc_digital_dev * ddev ;  struct nfc_dev * nfcdev ;  unsigned int enable_gpio ;  struct st95_digital_cmd_complete_arg complete_cb_arg ;  struct regulator * st95hf_supply ;  unsigned char sendrcv_trflag ;  struct semaphore exchange_lock ;  struct mutex rm_lock ;  bool nfcdev_free ;  u8 current_protocol ;  u8 current_rf_tech ;  int fwi ; } cocci_id@p ;
...
position p;
@@
 struct st95hf_context * cocci_id@p ;
...
position p;
@@
 struct st95hf_spi_context * cocci_id@p ;
...
position p;
@@
 struct param_list cocci_id@p [ 1 ] ;
...
position p;
@@
 enum st95hf_cmd_list cocci_id@p ;
...
position p;
@@
 struct param_list cocci_id@p [ 2 ] ;
...
position p;
@@
 struct param_list {  int param_offset ;  int new_param_val ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_CMD_LEN ] ;
...
position p;
@@
 enum st95hf_cmd_list { CMD_ECHO , CMD_ISO14443A_CONFIG , CMD_ISO14443A_DEMOGAIN , CMD_ISO14443B_DEMOGAIN , CMD_ISO14443A_PROTOCOL_SELECT , CMD_ISO14443B_PROTOCOL_SELECT , CMD_WTX_RESPONSE , CMD_FIELD_OFF , CMD_ISO15693_PROTOCOL_SELECT , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,nfc_digital_cmd_complete_t;
@@
 struct st95_digital_cmd_complete_arg {  struct sk_buff * skb_resp ;  nfc_digital_cmd_complete_t complete_cb ;  void * cb_usrarg ;  bool rats ; } cocci_id@p ;
