...
position p;
@@
 struct ingress_sched_data cocci_id@p ;
...
position p;
@@
 struct mini_Qdisc_pair * cocci_id@p ;
...
position p;
@@
 struct clsact_sched_data cocci_id@p ;
...
position p;
@@
 struct clsact_sched_data {  struct tcf_block * ingress_block ;  struct tcf_block * egress_block ;  struct tcf_block_ext_info ingress_block_info ;  struct tcf_block_ext_info egress_block_info ;  struct mini_Qdisc_pair miniqp_ingress ;  struct mini_Qdisc_pair miniqp_egress ; } cocci_id@p ;
...
position p;
@@
 struct ingress_sched_data {  struct tcf_block * block ;  struct tcf_block_ext_info block_info ;  struct mini_Qdisc_pair miniqp ; } cocci_id@p ;
