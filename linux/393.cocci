...
position p;
@@
 void cocci_id@p ( struct bsd_acct_struct * acct ) ;
...
position p;
@@
 struct pacct_struct * cocci_id@p ;
...
@@
 struct bsd_acct_struct {  struct fs_pin pin ;  atomic_long_t count ;  struct rcu_head rcu ;  struct mutex lock ;  int active ;  unsigned long needcheck ;  struct file * file ;  struct pid_namespace * ns ;  struct work_struct work ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 struct bsd_acct_struct * cocci_id@p ;
