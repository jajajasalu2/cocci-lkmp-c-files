...
position p;
@@
 struct sh7760fb_par cocci_id@p ;
...
@@
 struct sh7760fb_par {  void __iomem * base ;  int irq ;  struct sh7760fb_platdata * pd ;  dma_addr_t fbdma ;  int rot ;  u32 pseudo_palette [ 16 ] ;  struct platform_device * dev ;  struct resource * ioarea ;  struct completion vsync ; } cocci_id@p ;
...
position p;
@@
 struct sh7760fb_platdata * cocci_id@p ;
