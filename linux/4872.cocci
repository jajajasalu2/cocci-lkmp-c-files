...
position p;
@@
 struct cxgb4_uld_info cocci_id@p ;
...
position p;
@@
 struct c4iw_qid_list cocci_id@p ;
...
position p;
@@
 struct c4iw_debugfs_data * cocci_id@p ;
...
position p;
@@
 struct qp_list {  unsigned idx ;  struct c4iw_qp * * qps ; } cocci_id@p ;
...
position p;
@@
 struct wr_log_entry cocci_id@p ;
...
position p;
@@
 struct t4_dev_status_page * cocci_id@p ;
...
position p;
@@
 struct c4iw_debugfs_data {  struct c4iw_dev * devp ;  char * buf ;  int bufsize ;  int pos ; } cocci_id@p ;
