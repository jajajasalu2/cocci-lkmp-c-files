...
position p;
@@
 struct drm_msm_gem_submit * cocci_id@p ;
...
position p;
@@
 struct drm_msm_gem_submit_bo cocci_id@p ;
...
position p;
@@
 struct drm_msm_gem_submit_cmd cocci_id@p ;
...
position p;
@@
 struct drm_msm_gem_submit_reloc cocci_id@p ;
