...
position p;
@@
 void cocci_id@p ( struct lvds_chip_information * plvds_chip_info , struct lvds_setting_information * plvds_setting_info ) ;
...
position p;
@@
 struct via_display_timing cocci_id@p ;
...
position p;
@@
 struct _lcd_scaling_factor cocci_id@p ;
...
position p;
@@
 struct lvds_chip_information * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lvds_setting_information * plvds_setting_info , struct lvds_chip_information * plvds_chip_info ) ;
...
position p;
@@
 void cocci_id@p ( int set_hres , int set_vres , int panel_hres , int panel_vres ) ;
...
position p;
@@
 struct lvds_setting_information * cocci_id@p ;
