...
position p;
@@
 enum { OVERRIDE_NONE = 0x0 , OVERRIDE_BASE = 0x1 , OVERRIDE_STRIDE = 0x2 , OVERRIDE_HEIGHT = 0x4 , OVERRIDE_WIDTH = 0x8 , } cocci_id@p ;
...
position p;
@@
 struct efifb_dmi_info * cocci_id@p ;
