...
position p;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm ) ;
...
position p;
@@
 struct dlm_finalize_reco cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dlm_workfunc_t;
@@
 dlm_workfunc_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , struct dlm_migratable_lockres * mres ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , u8 dead_node , u8 send_to ) ;
...
position p;
@@
 struct dlm_master_requery * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * astdata , int blocked_type ) ;
...
position p;
@@
 struct dlm_lockstatus cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , u8 dead_node ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct dlm_ctxt * dlm , u8 dead_node ) ;
...
position p;
@@
 struct dlm_reco_data_done * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , u8 * real_master ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , u8 request_from , u8 dead_node ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct dlm_ctxt * dlm , u8 dead_node , u8 new_master ) ;
...
position p;
@@
 struct dlm_lock_request cocci_id@p ;
...
position p;
@@
 struct dlm_reco_node_data * cocci_id@p ;
...
position p;
@@
 struct dlm_begin_reco * cocci_id@p ;
...
typedef u8,u64;
@@
 void cocci_id@p ( struct dlm_migratable_lockres * mres , const char * lockname , int namelen , int total_locks , u64 cookie , u8 flags , u8 master ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct dlm_ctxt * dlm , struct list_head * list , u8 dead_node ) ;
...
position p;
@@
 struct dlm_migratable_lock * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * astdata , enum dlm_status st ) ;
...
position p;
@@
 void cocci_id@p ( struct dlm_ctxt * dlm ) ;
...
position p;
@@
 int cocci_id@p ( struct dlm_lock_resource * res ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_migratable_lockres * mres , u8 send_to , struct dlm_lock_resource * res , int total_locks ) ;
