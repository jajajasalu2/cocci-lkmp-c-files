...
position p;
@@
 struct firmware_map_entry * cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct firmware_map_entry * entry , char * buf ) ;
...
position p;
@@
 struct memmap_attribute cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct kobject * kobj , struct attribute * attr , char * buf ) ;
...
typedef u64;
@@
 struct firmware_map_entry {  u64 start ;  u64 end ;  const char * type ;  struct list_head list ;  struct kobject kobj ; } cocci_id@p ;
...
position p;
@@
 struct memmap_attribute {  struct attribute attr ;  ssize_t ( * show ) ( struct firmware_map_entry * entry , char * buf ) ; } cocci_id@p ;
