...
position p;
@@
 struct crypto_alg cocci_id@p [ 3 ] ;
...
typedef u32;
@@
 struct tea_ctx {  u32 KEY [ 4 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct xtea_ctx {  u32 KEY [ 4 ] ; } cocci_id@p ;
