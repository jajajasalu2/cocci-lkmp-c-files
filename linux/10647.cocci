...
position p;
@@
 struct gvt_mmio_block cocci_id@p [ ] ;
...
position p;
@@
 struct intel_gvt_device_info * cocci_id@p ;
...
position p;
@@
 enum intel_gvt_event_type cocci_id@p ;
...
position p;
@@
 struct intel_gvt_mmio_info * cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_dpcd_data * cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct intel_gvt * gvt , u32 offset , void * data ) ;
...
position p;
@@
 struct intel_vgpu_display * cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_execlist * cocci_id@p ;
