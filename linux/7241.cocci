...
position p;
@@
 struct hci_mrvl_pkt * cocci_id@p ;
...
position p;
@@
 enum { STATE_CHIP_VER_PENDING , STATE_FW_REQ_PENDING , } cocci_id@p ;
...
position p;
@@
 struct mrvl_serdev {  struct hci_uart hu ; } cocci_id@p ;
