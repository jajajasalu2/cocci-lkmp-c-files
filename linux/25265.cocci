...
position p;
@@
 struct libbpf_nla_policy cocci_id@p [ NLMSGERR_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct libbpf_nla_policy * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NLMSGERR_ATTR_MAX + 1 ] ;
...
typedef uint16_t;
@@
 uint16_t cocci_id@p [ LIBBPF_NLA_TYPE_MAX + 1 ] ;
