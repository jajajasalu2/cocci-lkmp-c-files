...
position p;
@@
 struct switch_tracking * cocci_id@p ;
...
typedef u64;
@@
 struct event_node {  struct list_head list ;  union perf_event * event ;  u64 event_time ; } cocci_id@p ;
...
typedef pid_t;
@@
 struct switch_tracking {  struct evsel * switch_evsel ;  struct evsel * cycles_evsel ;  pid_t * tids ;  int nr_tids ;  int comm_seen [ 4 ] ;  int cycles_before_comm_1 ;  int cycles_between_comm_2_and_comm_3 ;  int cycles_after_comm_4 ; } cocci_id@p ;
...
position p;
@@
 const struct event_node * cocci_id@p ;
