...
position p;
@@
 struct iproc_gpio_chip cocci_id@p ;
...
typedef spinlock_t;
@@
 struct iproc_gpio_chip {  struct irq_chip irqchip ;  struct gpio_chip gc ;  spinlock_t lock ;  struct device * dev ;  void __iomem * base ;  void __iomem * intr ; } cocci_id@p ;
