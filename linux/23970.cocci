...
position p;
@@
 const struct {  const char * name ;  int index ; } cocci_id@p [ ] ;
...
position p;
@@
 unsigned long cocci_id@p [ TCPUDP_MIB_MAX ] ;
...
position p;
@@
 unsigned long cocci_id@p [ PERLINE ] ;
...
position p;
@@
 unsigned short cocci_id@p [ PERLINE ] ;
