...
position p;
@@
 struct clk_aic32x4 {  struct clk_hw hw ;  struct device * dev ;  struct regmap * regmap ;  unsigned int reg ; } cocci_id@p ;
...
position p;
@@
 struct clk_aic32x4_pll_muldiv * cocci_id@p ;
...
position p;
@@
 struct aic32x4_clkdesc * cocci_id@p ;
...
position p;
@@
 struct aic32x4_clkdesc {  const char * name ;  const char * const * parent_names ;  unsigned int num_parents ;  const struct clk_ops * ops ;  unsigned int reg ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct clk_aic32x4_pll_muldiv {  u8 p ;  u16 r ;  u8 j ;  u16 d ; } cocci_id@p ;
