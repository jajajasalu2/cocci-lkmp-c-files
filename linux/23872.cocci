...
position p;
@@
 struct xdp_diag_req cocci_id@p ;
...
position p;
@@
 struct xdp_diag_ring cocci_id@p ;
...
position p;
@@
 struct xdp_diag_umem cocci_id@p ;
...
position p;
@@
 const struct xdp_sock * cocci_id@p ;
...
position p;
@@
 struct xdp_diag_msg * cocci_id@p ;
...
position p;
@@
 struct xdp_diag_info cocci_id@p ;
...
position p;
@@
 const struct xsk_queue * cocci_id@p ;
