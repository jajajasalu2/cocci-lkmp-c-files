...
position p;
@@
 struct conf_data {  struct frad_conf config ;  short dlci [ CONFIG_DLCI_MAX ] ; } cocci_id@p ;
...
position p;
@@
 short cocci_id@p [ CONFIG_DLCI_MAX ] ;
...
position p;
@@
 struct _frad_stat {  char flags ;  struct _dlci_stat dlcis [ SDLA_MAX_DLCI ] ; } cocci_id@p ;
