...
position p;
@@
 struct menf21bmc_hwmon * cocci_id@p ;
...
typedef bool;
@@
 struct menf21bmc_hwmon {  bool valid ;  struct i2c_client * i2c_client ;  unsigned long last_update ;  int in_val [ BMC_VOLT_COUNT ] ;  int in_min [ BMC_VOLT_COUNT ] ;  int in_max [ BMC_VOLT_COUNT ] ; } cocci_id@p ;
