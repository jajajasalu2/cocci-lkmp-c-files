...
position p;
@@
 struct ksm_scan {  struct mm_slot * mm_slot ;  unsigned long address ;  struct rmap_item * * rmap_list ;  unsigned long seqnr ; } cocci_id@p ;
...
position p;
@@
 enum get_ksm_page_flags cocci_id@p ;
...
position p;
@@
 struct rmap_walk_control * cocci_id@p ;
...
position p;
@@
 enum get_ksm_page_flags { GET_KSM_PAGE_NOLOCK , GET_KSM_PAGE_LOCK , GET_KSM_PAGE_TRYLOCK , } cocci_id@p ;
...
position p;
@@
 struct mm_slot {  struct hlist_node link ;  struct list_head mm_list ;  struct rmap_item * rmap_list ;  struct mm_struct * mm ; } cocci_id@p ;
