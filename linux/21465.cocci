...
typedef u32;
@@
 const struct __ftr_reg_entry {  u32 sys_id ;  struct arm64_ftr_reg * reg ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct arm64_cpu_capabilities cocci_id@p [ ] ;
...
position p;
@@
 struct cpuinfo_arm64 * cocci_id@p ;
...
position p;
@@
 const struct midr_range cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( const struct arm64_cpu_capabilities * cap ) ;
...
position p;
@@
 const struct arm64_ftr_bits * cocci_id@p ;
