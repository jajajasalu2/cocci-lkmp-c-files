...
position p;
@@
 struct ti_sci_pm_domain * cocci_id@p ;
...
position p;
@@
 struct ti_sci_genpd_dev_data * cocci_id@p ;
...
typedef u8;
@@
 struct ti_sci_genpd_dev_data {  int idx ;  u8 exclusive ; } cocci_id@p ;
...
position p;
@@
 struct ti_sci_pm_domain {  const struct ti_sci_handle * ti_sci ;  struct device * dev ;  struct generic_pm_domain pd ; } cocci_id@p ;
