...
position p;
@@
 struct atmarp_entry * cocci_id@p ;
...
position p;
@@
 struct clip_seq_state cocci_id@p ;
...
position p;
@@
 enum atmarp_ctrl_type cocci_id@p ;
...
position p;
@@
 struct clip_seq_state {  struct neigh_seq_state ns ;  struct clip_vcc * vcc ; } cocci_id@p ;
...
position p;
@@
 struct sockaddr_atmsvc * cocci_id@p ;
