...
position p;
@@
 struct snd_ymfpci_voice * cocci_id@p ;
...
position p;
@@
 struct snd_ymfpci_capture_bank * cocci_id@p ;
...
position p;
@@
 enum snd_ymfpci_voice_type cocci_id@p ;
...
position p;
@@
 struct snd_ymfpci_pcm * cocci_id@p ;
...
position p;
@@
 struct snd_ymfpci_effect_bank * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_ymfpci * chip ) ;
...
position p;
@@
 struct snd_ymfpci_playback_bank * cocci_id@p ;
