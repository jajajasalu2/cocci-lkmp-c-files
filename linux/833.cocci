...
position p;
@@
 struct pnp_info_buffer cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pnp_info_buffer_t;
@@
 pnp_info_buffer_t cocci_id@p ;
...
position p;
@@
 struct pnp_resource * cocci_id@p ;
...
position p;
@@
 struct pnp_info_buffer {  char * buffer ;  char * curr ;  unsigned long size ;  unsigned long len ;  int stop ;  int error ; } cocci_id@p ;
