...
position p;
@@
 const struct fsl_gpio_soc_data cocci_id@p ;
...
position p;
@@
 struct vf610_gpio_port * cocci_id@p ;
...
typedef bool;
@@
 struct fsl_gpio_soc_data {  bool have_paddr ; } cocci_id@p ;
...
typedef u8;
@@
 struct vf610_gpio_port {  struct gpio_chip gc ;  struct irq_chip ic ;  void __iomem * base ;  void __iomem * gpio_base ;  const struct fsl_gpio_soc_data * sdata ;  u8 irqc [ VF610_GPIO_PER_PORT ] ;  struct clk * clk_port ;  struct clk * clk_gpio ;  int irq ; } cocci_id@p ;
