...
position p;
@@
 void cocci_id@p ( void * state , const void * msg ) ;
...
position p;
@@
 void cocci_id@p ( void * state , void * dst , const void * src , unsigned int size ) ;
...
position p;
@@
 void cocci_id@p ( void * state , const void * key , const void * iv ) ;
