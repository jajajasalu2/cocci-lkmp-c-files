...
position p;
@@
 const struct xgene_pmu_data cocci_id@p ;
...
typedef u32;
@@
 struct hw_pmu_info {  u32 type ;  u32 enable_mask ;  void __iomem * csr ; } cocci_id@p ;
...
typedef u32;
@@
 struct xgene_pmu_data {  int id ;  u32 data ; } cocci_id@p ;
...
typedef u64,u8;
@@
 struct xgene_pmu_dev {  struct hw_pmu_info * inf ;  struct xgene_pmu * parent ;  struct pmu pmu ;  u8 max_counters ; 
	 DECLARE_BITMAP ( cntr_assign_mask , PMU_MAX_COUNTERS ) 
		 ;  u64 max_period ;  const struct attribute_group * * attr_groups ;  struct perf_event * pmu_counter_event [ PMU_MAX_COUNTERS ] ; } cocci_id@p ;
...
position p;
@@
 struct xgene_pmu_dev_ctx * cocci_id@p ;
...
position p;
@@
 struct xgene_pmu_dev * cocci_id@p ;
...
position p;
@@
 struct xgene_pmu_dev_ctx {  char * name ;  struct list_head next ;  struct xgene_pmu_dev * pmu_dev ;  struct hw_pmu_info inf ; } cocci_id@p ;
...
position p;
@@
 const struct xgene_pmu_ops cocci_id@p ;
...
position p;
@@
 enum xgene_pmu_dev_type { PMU_TYPE_L3C = 0 , PMU_TYPE_IOB , PMU_TYPE_IOB_SLOW , PMU_TYPE_MCB , PMU_TYPE_MC , } cocci_id@p ;
...
position p;
@@
 enum xgene_pmu_version { PCP_PMU_V1 = 1 , PCP_PMU_V2 , PCP_PMU_V3 , } cocci_id@p ;
