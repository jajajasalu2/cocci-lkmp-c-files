...
position p;
@@
 const struct ce_attr * cocci_id@p ;
...
position p;
@@
 struct ath10k_ce_crash_data cocci_id@p ;
...
position p;
@@
 const struct ath10k_ce_ops cocci_id@p ;
