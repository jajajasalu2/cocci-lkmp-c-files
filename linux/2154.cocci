...
position p;
@@
 struct pm860x_charger_info {  struct pm860x_chip * chip ;  struct i2c_client * i2c ;  struct i2c_client * i2c_8606 ;  struct device * dev ;  struct power_supply * usb ;  struct mutex lock ;  int irq_nums ;  int irq [ 7 ] ;  unsigned state : 3 ;  unsigned online : 1 ;  unsigned present : 1 ;  unsigned allowed : 1 ; } cocci_id@p ;
...
typedef irqreturn_t;
@@
 struct pm860x_irq_desc {  const char * name ;  irqreturn_t ( * handler ) ( int irq , void * data ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct pm860x_charger_info * cocci_id@p ;
