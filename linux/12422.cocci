...
symbol cocci_id;
position p;
typedef pgoff_t,dma_addr_t;
@@
 struct omap_drm_usergart_entry {  struct tiler_block * block ;  dma_addr_t dma_addr ;  struct drm_gem_object * obj ;  pgoff_t obj_pgoff ; } cocci_id@p ;
...
position p;
@@
 struct omap_drm_usergart {  struct omap_drm_usergart_entry entry [ NUM_USERGART_ENTRIES ] ;  int height ;  int height_shift ;  int slot_shift ;  int stride_pfn ;  int last ; } cocci_id@p ;
...
position p;
@@
 union omap_gem_size cocci_id@p ;
...
position p;
@@
 struct omap_drm_usergart * cocci_id@p ;
...
position p;
@@
 struct omap_gem_object cocci_id@p ;
...
position p;
@@
 const enum tiler_fmt cocci_id@p [ ] ;
...
position p;
@@
 struct omap_drm_usergart_entry * cocci_id@p ;
