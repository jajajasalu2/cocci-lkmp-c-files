...
position p;
@@
 struct agp_segment32 * cocci_id@p ;
...
position p;
@@
 struct agp_allocate32 cocci_id@p ;
...
position p;
@@
 struct agp_unbind32 cocci_id@p ;
...
position p;
@@
 struct agp_region32 cocci_id@p ;
