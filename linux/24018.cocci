...
position p;
@@
 struct xfrm4_protocol cocci_id@p ;
...
position p;
@@
 struct esp_skb_cb {  struct xfrm_skb_cb xfrm ;  void * tmp ; } cocci_id@p ;
...
position p;
@@
 struct xfrm_offload * cocci_id@p ;
...
typedef u32,__be32;
@@
 struct esp_output_extra {  __be32 seqhi ;  u32 esphoff ; } cocci_id@p ;
...
position p;
@@
 struct esp_output_extra * cocci_id@p ;
