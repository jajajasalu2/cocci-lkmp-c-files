...
position p;
@@
 enum bfi_tskim_status cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BFA_SYMNAME_MAXLEN ] ;
...
position p;
@@
 struct bfad_im_port_pointer * cocci_id@p ;
...
position p;
@@
 struct bfad_itnim_data_s * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * h , struct scsi_cmnd * cmnd ) ;
...
position p;
@@
 enum bfi_ioim_status cocci_id@p ;
...
position p;
@@
 struct bfad_fcp_binding * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfad_im_port_s * im_port , struct bfad_itnim_s * itnim ) ;
...
typedef wwn_t;
@@
 wwn_t cocci_id@p [ BFA_PREBOOT_BOOTLUN_MAX ] ;
