...
position p;
@@
 enum { OUT_EP = 6 , IN_EP = 2 , MAX_BUFSIZE = 128 * 1024 , } cocci_id@p ;
...
position p;
@@
 struct control_runtime * cocci_id@p ;
...
position p;
@@
 enum { OUT_N_CHANNELS = 6 , IN_N_CHANNELS = 4 , } cocci_id@p ;
