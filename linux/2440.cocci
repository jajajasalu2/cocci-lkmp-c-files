...
position p;
@@
 struct tegra_adma_desc cocci_id@p ;
...
position p;
@@
 struct tegra_adma_chan * cocci_id@p ;
...
typedef bool;
@@
 struct tegra_adma_chip_data {  unsigned int ( * adma_get_burst_config ) ( unsigned int burst_size ) ;  unsigned int global_reg_offset ;  unsigned int global_int_clear ;  unsigned int ch_req_tx_shift ;  unsigned int ch_req_rx_shift ;  unsigned int ch_base_offset ;  unsigned int ch_fifo_ctrl ;  unsigned int ch_req_mask ;  unsigned int ch_req_max ;  unsigned int ch_reg_size ;  unsigned int nr_channels ;  bool has_outstanding_reqs ; } cocci_id@p ;
...
position p;
@@
 struct tegra_adma_chan_regs {  unsigned int ctrl ;  unsigned int config ;  unsigned int src_addr ;  unsigned int trg_addr ;  unsigned int fifo_ctrl ;  unsigned int cmd ;  unsigned int tc ; } cocci_id@p ;
...
position p;
@@
 struct tegra_adma_desc {  struct virt_dma_desc vd ;  struct tegra_adma_chan_regs ch_regs ;  size_t buf_len ;  size_t period_len ;  size_t num_periods ; } cocci_id@p ;
...
position p;
@@
 struct tegra_adma_chan_regs * cocci_id@p ;
...
position p;
@@
 const struct tegra_adma_chip_data * cocci_id@p ;
...
position p;
@@
 struct tegra_adma {  struct dma_device dma_dev ;  struct device * dev ;  void __iomem * base_addr ;  struct clk * ahub_clk ;  unsigned int nr_channels ;  unsigned long rx_requests_reserved ;  unsigned long tx_requests_reserved ;  unsigned int global_cmd ;  const struct tegra_adma_chip_data * cdata ;  struct tegra_adma_chan channels [ 0 ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct tegra_adma_chan {  struct virt_dma_chan vc ;  struct tegra_adma_desc * desc ;  struct tegra_adma * tdma ;  int irq ;  void __iomem * chan_addr ;  struct dma_slave_config sconfig ;  enum dma_transfer_direction sreq_dir ;  unsigned int sreq_index ;  bool sreq_reserved ;  struct tegra_adma_chan_regs ch_regs ;  unsigned int tx_buf_count ;  unsigned int tx_buf_pos ; } cocci_id@p ;
