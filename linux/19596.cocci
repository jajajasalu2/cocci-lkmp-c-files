...
typedef bool;
@@
 struct mode_req {  bool single ;  bool soft ;  bool fr1 ;  bool frdefault ;  bool fre ; } cocci_id@p ;
...
position p;
@@
 struct mips_elf_abiflags_v0 cocci_id@p ;
...
position p;
@@
 union {  struct elf32_hdr e32 ;  struct elf64_hdr e64 ; } * cocci_id@p ;
...
position p;
@@
 enum { FP_FRE , FP_FR0 , FP_FR1 , } cocci_id@p ;
...
position p;
@@
 const struct mode_req cocci_id@p [ ] ;
