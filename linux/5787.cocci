...
position p;
@@
 const struct dmtimer_platform_data * cocci_id@p ;
...
position p;
@@
 enum { REQUEST_ANY = 0 , REQUEST_BY_ID , REQUEST_BY_CAP , REQUEST_BY_NODE , } cocci_id@p ;
...
position p;
@@
 struct omap_dm_timer * cocci_id@p ;
