...
position p;
@@
 struct gk20a_pmu {  struct nvkm_pmu base ;  struct nvkm_alarm alarm ;  struct gk20a_pmu_dvfs_data * data ; } cocci_id@p ;
...
position p;
@@
 struct gk20a_pmu_dvfs_data cocci_id@p ;
...
typedef u32;
@@
 struct gk20a_pmu_dvfs_dev_status {  u32 total ;  u32 busy ; } cocci_id@p ;
...
position p;
@@
 struct gk20a_pmu_dvfs_dev_status * cocci_id@p ;
...
position p;
@@
 const struct nvkm_pmu_func cocci_id@p ;
...
position p;
@@
 struct gk20a_pmu_dvfs_data {  int p_load_target ;  int p_load_max ;  int p_smooth ;  unsigned int avg_load ; } cocci_id@p ;
