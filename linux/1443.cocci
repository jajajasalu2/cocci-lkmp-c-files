...
position p;
@@
 enum atx_type { ISP1301 , STOTG04 , } cocci_id@p ;
...
position p;
@@
 struct lpc32xx_usbd_cfg cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_gadget * , struct usb_gadget_driver * ) ;
...
position p;
@@
 struct lpc32xx_request cocci_id@p ;
...
typedef u32;
@@
 struct lpc32xx_usbd_dd_gad {  u32 dd_next_phy ;  u32 dd_setup ;  u32 dd_buffer_addr ;  u32 dd_status ;  u32 dd_iso_ps_mem_addr ;  u32 this_dma ;  u32 iso_status [ 6 ] ;  u32 dd_next_v ; } cocci_id@p ;
...
typedef u32;
@@
 struct lpc32xx_usbd_dd {  u32 * dd_next ;  u32 dd_setup ;  u32 dd_buffer_addr ;  u32 dd_status ;  u32 dd_iso_ps_mem_addr ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct lpc32xx_ep {  struct usb_ep ep ;  struct list_head queue ;  struct lpc32xx_udc * udc ;  u32 hwep_num_base ;  u32 hwep_num ;  u32 maxpacket ;  u32 lep ;  bool is_in ;  bool req_pending ;  u32 eptype ;  u32 totalints ;  bool wedge ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_gadget * ) ;
...
position p;
@@
 struct lpc32xx_usbd_dd_gad * cocci_id@p ;
...
position p;
@@
 const struct lpc32xx_udc cocci_id@p ;
...
typedef bool;
@@
 struct lpc32xx_request {  struct usb_request req ;  struct list_head queue ;  struct lpc32xx_usbd_dd_gad * dd_desc_ptr ;  bool mapped ;  bool send_zlp ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u32,wait_queue_head_t,atomic_t,spinlock_t;
@@
 struct lpc32xx_udc {  struct usb_gadget gadget ;  struct usb_gadget_driver * driver ;  struct platform_device * pdev ;  struct device * dev ;  struct dentry * pde ;  spinlock_t lock ;  struct i2c_client * isp1301_i2c_client ;  struct lpc32xx_usbd_cfg * board ;  void __iomem * udp_baseaddr ;  int udp_irq [ 4 ] ;  struct clk * usb_slv_clk ;  u32 * udca_v_base ;  u32 udca_p_base ;  struct dma_pool * dd_cache ;  u32 enabled_devints ;  u32 enabled_hwepints ;  u32 dev_status ;  u32 realized_eps ;  u8 vbus ;  u8 last_vbus ;  int pullup ;  int poweron ;  enum atx_type atx ;  struct work_struct pullup_job ;  struct work_struct power_job ;  struct lpc32xx_ep ep [ NUM_ENDPOINTS ] ;  bool enabled ;  bool clocked ;  bool suspended ;  int ep0state ;  atomic_t enabled_ep_cnt ;  wait_queue_head_t ep_disable_wait_queue ; } cocci_id@p ;
...
position p;
@@
 struct lpc32xx_usbd_cfg {  int vbus_drv_pol ;  usc_chg_event conn_chgb ;  usc_chg_event susp_chgb ;  usc_chg_event rmwk_chgb ; } cocci_id@p ;
