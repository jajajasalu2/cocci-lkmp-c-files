...
position p;
@@
 struct bnad_tx_unmap * cocci_id@p ;
...
position p;
@@
 enum bna_link_status cocci_id@p ;
...
position p;
@@
 struct bna_txq_entry * cocci_id@p ;
...
position p;
@@
 struct bnad_tx_info cocci_id@p ;
...
position p;
@@
 struct bna_pkt_rate * cocci_id@p ;
...
position p;
@@
 struct bna_rxq_entry * cocci_id@p ;
...
position p;
@@
 struct bnad_rx_unmap cocci_id@p ;
...
position p;
@@
 struct bnad_rx_unmap_q * cocci_id@p ;
...
position p;
@@
 struct bnad_rx_ctrl cocci_id@p ;
...
position p;
@@
 struct bnad_rx_info cocci_id@p ;
...
position p;
@@
 enum bnad_intr_source cocci_id@p ;
...
position p;
@@
 struct bna_intr_descr cocci_id@p ;
...
position p;
@@
 struct bna_cq_entry * cocci_id@p ;
...
position p;
@@
 struct bnad_iocmd_comp * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_stats_mac * cocci_id@p ;
