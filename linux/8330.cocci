...
position p;
@@
 struct oct_intrmod_cfg * cocci_id@p ;
...
position p;
@@
 struct octeon_cn6xxx * cocci_id@p ;
...
position p;
@@
 struct oct_mdio_cmd_resp * cocci_id@p ;
...
position p;
@@
 enum { INTERFACE_MODE_DISABLED , INTERFACE_MODE_RGMII , INTERFACE_MODE_GMII , INTERFACE_MODE_SPI , INTERFACE_MODE_PCIE , INTERFACE_MODE_XAUI , INTERFACE_MODE_SGMII , INTERFACE_MODE_PICMG , INTERFACE_MODE_NPI , INTERFACE_MODE_LOOP , INTERFACE_MODE_SRIO , INTERFACE_MODE_ILK , INTERFACE_MODE_RXAUI , INTERFACE_MODE_QSGMII , INTERFACE_MODE_AGL , INTERFACE_MODE_XLAUI , INTERFACE_MODE_XFI , INTERFACE_MODE_10G_KR , INTERFACE_MODE_40G_KR4 , INTERFACE_MODE_MIXED , } cocci_id@p ;
...
typedef u64;
@@
 struct oct_intrmod_resp {  u64 rh ;  struct oct_intrmod_cfg intrmod ;  u64 status ; } cocci_id@p ;
...
position p;
@@
 struct oct_mdio_cmd * cocci_id@p ;
...
position p;
@@
 struct octeon_config * cocci_id@p ;
...
position p;
@@
 struct oct_intrmod_resp cocci_id@p ;
...
typedef u64;
@@
 struct oct_mdio_cmd_resp {  u64 rh ;  struct oct_mdio_cmd resp ;  u64 status ; } cocci_id@p ;
...
position p;
@@
 struct octeon_board_info * cocci_id@p ;
