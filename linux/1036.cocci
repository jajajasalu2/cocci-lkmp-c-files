...
symbol cocci_id;
position p;
typedef u8,u32,u16,phys_addr_t;
@@
 struct pismo_mem {  phys_addr_t base ;  u32 size ;  u16 access ;  u8 width ;  u8 type ; } cocci_id@p ;
...
position p;
@@
 struct pismo_eeprom cocci_id@p ;
...
position p;
@@
 const struct pismo_cs_block * cocci_id@p ;
...
position p;
@@
 struct pismo_cs_block cocci_id@p ;
...
position p;
@@
 struct pismo_data {  struct i2c_client * client ;  void ( * vpp ) ( void * , int ) ;  void * vpp_data ;  struct platform_device * dev [ PISMO_NUM_CS ] ; } cocci_id@p ;
