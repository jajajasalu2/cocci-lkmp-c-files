...
typedef u8,u32;
@@
 struct iwl_mvm_active_iface_iterator_data {  struct ieee80211_vif * ignore_vif ;  u8 sta_vif_ap_sta_id ;  enum iwl_sf_state sta_vif_state ;  u32 num_active_macs ; } cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_active_iface_iterator_data cocci_id@p ;
...
position p;
@@
 struct iwl_sf_cfg_cmd * cocci_id@p ;
