...
position p;
@@
 int cocci_id@p [ M9206_MAX_ADAPTERS ] ;
...
position p;
@@
 int cocci_id@p ( struct dvb_usb_device * d , int type , int idx , int pid ) ;
