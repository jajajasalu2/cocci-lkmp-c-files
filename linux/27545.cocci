...
position p;
@@
 void cocci_id@p ( struct __btrfs_workqueue * wq ) ;
...
position p;
@@
 struct btrfs_workqueue {  struct __btrfs_workqueue * normal ;  struct __btrfs_workqueue * high ; } cocci_id@p ;
...
@@
 struct __btrfs_workqueue {  struct workqueue_struct * normal_wq ;  struct btrfs_fs_info * fs_info ;  struct list_head ordered_list ;  spinlock_t list_lock ;  atomic_t pending ;  int limit_active ;  int current_active ;  int thresh ;  unsigned int count ;  spinlock_t thres_lock ; } cocci_id@p ;
...
position p;
@@
 enum { WORK_DONE_BIT , WORK_ORDER_DONE_BIT , WORK_HIGH_PRIO_BIT , } cocci_id@p ;
...
position p;
@@
 const struct btrfs_work * cocci_id@p ;
...
position p;
@@
 const struct btrfs_workqueue * cocci_id@p ;
