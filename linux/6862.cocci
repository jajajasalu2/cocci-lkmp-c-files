...
position p;
@@
 struct fc_els_rnid_gen cocci_id@p ;
...
position p;
@@
 enum bnx2fc_create_link_state cocci_id@p ;
...
position p;
@@
 struct bnx2fc_interface * cocci_id@p ( struct net_device * phys_dev ) ;
...
position p;
@@
 struct bnx2fc_percpu_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bnx2fc_hba * hba ) ;
...
position p;
@@
 struct fc_lport * cocci_id@p ( struct bnx2fc_interface * interface , struct device * parent , int npiv ) ;
...
position p;
@@
 struct fc_rport_priv * cocci_id@p ;
...
position p;
@@
 struct bnx2fc_rport cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fc_lport * lport , struct device * dev ) ;
...
position p;
@@
 void cocci_id@p ( struct fc_lport * lport ) ;
...
position p;
@@
 int cocci_id@p ( struct fc_lport * lport , struct bnx2fc_hba * hba ) ;
...
position p;
@@
 struct fc_vport_identifiers cocci_id@p ;
...
position p;
@@
 struct fc_host_statistics * cocci_id@p ;
...
position p;
@@
 struct bnx2fc_interface * cocci_id@p ;
...
position p;
@@
 struct bnx2fc_lport cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fc_lport * lport ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * net_device ) ;
...
position p;
@@
 void cocci_id@p ( struct bnx2fc_interface * interface ) ;
...
position p;
@@
 struct bnx2fc_hba * cocci_id@p ( struct net_device * phys_dev ) ;
...
position p;
@@
 int cocci_id@p ( struct bnx2fc_hba * hba ) ;
...
position p;
@@
 enum bnx2fc_create_link_state { BNX2FC_CREATE_LINK_DOWN , BNX2FC_CREATE_LINK_UP , } cocci_id@p ;
...
position p;
@@
 struct bnx2fc_hba * cocci_id@p ( struct cnic_dev * cnic ) ;
