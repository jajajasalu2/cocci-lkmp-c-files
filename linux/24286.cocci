...
position p;
@@
 struct nf_bridge_frag_data cocci_id@p ;
...
position p;
@@
 struct br_input_skb_cb cocci_id@p ;
...
position p;
@@
 const struct nf_bridge_frag_data * cocci_id@p ;
...
position p;
@@
 const struct br_input_skb_cb * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net * , struct sock * sk , const struct nf_bridge_frag_data * data , struct sk_buff * ) ;
