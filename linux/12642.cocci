...
position p;
@@
 struct hdmi_pll_8996 {  struct platform_device * pdev ;  struct clk_hw clk_hw ;  void __iomem * mmio_qserdes_com ;  void __iomem * mmio_qserdes_tx [ HDMI_NUM_TX_CHANNEL ] ; } cocci_id@p ;
...
position p;
@@
 struct hdmi_8996_post_divider * cocci_id@p ;
...
position p;
@@
 const struct hdmi_phy_cfg cocci_id@p ;
...
position p;
@@
 struct hdmi_pll_8996 * cocci_id@p ;
...
position p;
@@
 struct hdmi_8996_phy_pll_reg_cfg * cocci_id@p ;
...
typedef u64;
@@
 struct hdmi_8996_post_divider {  u64 vco_freq ;  int hsclk_divsel ;  int vco_ratio ;  int tx_band_sel ;  int half_rate_mode ; } cocci_id@p ;
