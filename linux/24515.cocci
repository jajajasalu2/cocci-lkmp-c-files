...
typedef __u16;
@@
 void cocci_id@p ( unsigned long * map , __u16 off , __u16 len , __u16 * start , __u16 * end ) ;
...
position p;
@@
 struct sctp_tsnmap_iter * cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct sctp_tsnmap * map , u16 size ) ;
...
position p;
@@
 void cocci_id@p ( struct sctp_tsnmap * map ) ;
...
position p;
@@
 const struct sctp_tsnmap * cocci_id@p ;
