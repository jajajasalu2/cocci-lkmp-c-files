...
position p;
@@
 struct igbvf_buffer * cocci_id@p ;
...
position p;
@@
 struct igbvf_adapter * cocci_id@p ;
...
position p;
@@
 const struct igbvf_info * cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct igbvf_adapter * ) ;
