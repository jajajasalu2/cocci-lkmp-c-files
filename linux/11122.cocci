...
position p;
@@
 struct dm_pp_display_configuration * cocci_id@p ;
...
position p;
@@
 const struct clk_mgr_funcs cocci_id@p ;
...
position p;
@@
 const struct clk_mgr_registers * cocci_id@p ;
...
position p;
@@
 const struct clk_mgr_mask * cocci_id@p ;
...
position p;
@@
 const struct state_dependent_clocks cocci_id@p [ ] ;
...
position p;
@@
 const struct clk_mgr_shift * cocci_id@p ;
...
position p;
@@
 struct dm_pp_single_disp_config * cocci_id@p ;
