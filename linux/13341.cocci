...
position p;
@@
 struct cx25821_audio_buffer {  unsigned int bpl ;  struct cx25821_riscmem risc ;  void * vaddr ;  struct scatterlist * sglist ;  int sglen ;  int nr_pages ; } cocci_id@p ;
...
@@
 struct cx25821_audio_dev {  struct cx25821_dev * dev ;  struct cx25821_dmaqueue q ;  struct pci_dev * pci ;  int irq ;  struct snd_card * card ;  unsigned long iobase ;  spinlock_t reg_lock ;  atomic_t count ;  unsigned int dma_size ;  unsigned int period_size ;  unsigned int num_periods ;  struct cx25821_audio_buffer * buf ;  struct snd_pcm_substream * substream ; } cocci_id@p ;
...
position p;
@@
 struct cx25821_audio_dev cocci_id@p ;
...
position p;
@@
 struct cx25821_audio_buffer * cocci_id@p ;
...
position p;
@@
 struct cx25821_riscmem * cocci_id@p ;
