...
position p;
@@
 struct msa_control_regs {  unsigned int fir ;  unsigned int fcsr ;  unsigned int msair ;  unsigned int msacsr ; } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ NUM_WATCH_REGS ] ;
...
position p;
@@
 enum pt_watch_style cocci_id@p ;
...
position p;
@@
 const struct msa_control_regs cocci_id@p ;
...
position p;
@@
 struct msa_control_regs cocci_id@p ;
...
position p;
@@
 struct pt_watch_regs cocci_id@p ;
