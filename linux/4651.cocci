...
position p;
@@
 const struct crashtype * cocci_id@p ;
...
position p;
@@
 struct crashpoint {  const char * name ;  const struct file_operations fops ;  struct kprobe kprobe ; } cocci_id@p ;
...
position p;
@@
 struct crashtype {  const char * name ;  void ( * func ) ( void ) ; } cocci_id@p ;
