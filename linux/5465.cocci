...
position p;
@@
 const struct xtfpga_spi * cocci_id@p ;
...
typedef u32;
@@
 struct xtfpga_spi {  struct spi_bitbang bitbang ;  void __iomem * regs ;  u32 data ;  unsigned data_sz ; } cocci_id@p ;
