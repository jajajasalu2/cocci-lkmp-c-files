...
position p;
@@
 struct intel_dvo_device * cocci_id@p ;
...
position p;
@@
 const struct ns2501_configuration * cocci_id@p ;
...
position p;
@@
 const struct ns2501_reg cocci_id@p [ ] ;
...
position p;
@@
 const struct intel_dvo_dev_ops cocci_id@p ;
...
typedef u8,u16;
@@
 struct ns2501_configuration {  u8 sync ;  u8 conf ;  u8 syncb ;  u8 dither ;  u8 pll_a ;  u16 pll_b ;  u16 hstart ;  u16 hstop ;  u16 vstart ;  u16 vstop ;  u16 vsync ;  u16 vtotal ;  u16 hpos ;  u16 vpos ;  u16 voffs ;  u16 hscale ;  u16 vscale ; } cocci_id@p ;
...
position p;
@@
 enum { MODE_640x480 , MODE_800x600 , MODE_1024x768 , } cocci_id@p ;
...
typedef u8;
@@
 struct ns2501_reg {  u8 offset ;  u8 value ; } cocci_id@p ;
...
typedef bool;
@@
 struct ns2501_priv {  bool quiet ;  const struct ns2501_configuration * conf ; } cocci_id@p ;
