...
position p;
@@
 void * cocci_id@p [ GUEST_MAPPINGS_TRIES ] ;
...
position p;
@@
 struct vmmdev_guest_info * cocci_id@p ;
...
position p;
@@
 struct vmmdev_heartbeat * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_driver_version_info * cocci_id@p ;
...
position p;
@@
 struct vmmdev_hgcm_function_parameter cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_wait_for_events * cocci_id@p ;
...
position p;
@@
 struct vmmdev_hypervisorinfo * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_set_guest_caps * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_hgcm_call cocci_id@p ;
...
position p;
@@
 struct vmmdev_host_version * cocci_id@p ;
...
position p;
@@
 struct vmmdev_guest_status * cocci_id@p ;
...
position p;
@@
 struct vmmdev_memballoon_info * cocci_id@p ;
...
position p;
@@
 struct vbg_bit_usage_tracker * cocci_id@p ;
...
position p;
@@
 struct vmmdev_guest_info2 * cocci_id@p ;
...
position p;
@@
 struct vmmdev_mouse_status * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_hdr * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_change_filter * cocci_id@p ;
...
position p;
@@
 struct vmmdev_write_core_dump * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_log * cocci_id@p ;
...
position p;
@@
 const struct vmmdev_guest_status * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_write_coredump * cocci_id@p ;
...
position p;
@@
 struct vmmdev_hgcm_function_parameter32 * cocci_id@p ;
...
position p;
@@
 enum vmmdev_hgcm_function_parameter_type cocci_id@p ;
...
position p;
@@
 struct vmmdev_events * cocci_id@p ;
...
position p;
@@
 struct vmmdev_memballoon_change * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_hgcm_connect * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_hgcm_disconnect * cocci_id@p ;
...
position p;
@@
 const struct vmmdev_request_header * cocci_id@p ;
...
position p;
@@
 struct vbg_ioctl_check_balloon * cocci_id@p ;
