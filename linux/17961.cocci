...
position p;
@@
 volatile unsigned long cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct leon_ipi_work {  int single ;  int msk ;  int resched ; } cocci_id@p ;
...
position p;
@@
 struct linux_prom_registers cocci_id@p ;
...
position p;
@@
 struct leon_ipi_work cocci_id@p ;
...
position p;
@@
 const struct sparc32_ipi_ops cocci_id@p ;
...
typedef smpfunc_t;
@@
 struct smp_funcall {  smpfunc_t func ;  unsigned long arg1 ;  unsigned long arg2 ;  unsigned long arg3 ;  unsigned long arg4 ;  unsigned long arg5 ;  unsigned long processors_in [ NR_CPUS ] ;  unsigned long processors_out [ NR_CPUS ] ; } cocci_id@p ;
