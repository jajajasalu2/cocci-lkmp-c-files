...
position p;
@@
 void cocci_id@p ( struct usb_hcd * hcd ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct usb_hcd * hcd , u16 typeReq , u16 wValue , u16 wIndex , char * buff , u16 wLength ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_hcd * hcd , char * buff ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_hcd * vhci_hcd ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_hcd * hcd , struct urb * urb , int status ) ;
...
position p;
@@
 struct usbip_device * cocci_id@p ;
