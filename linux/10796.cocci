...
position p;
@@
 struct i915_global_scheduler {  struct i915_global base ;  struct kmem_cache * slab_dependencies ;  struct kmem_cache * slab_priorities ; } cocci_id@p ;
...
position p;
@@
 const struct i915_priolist * cocci_id@p ;
...
position p;
@@
 struct sched_cache {  struct list_head * priolist ; } cocci_id@p ;
...
position p;
@@
 struct i915_global_scheduler cocci_id@p ;
...
position p;
@@
 const struct i915_sched_node * cocci_id@p ;
