...
typedef bool;
@@
 struct msm_dsi_manager {  struct msm_dsi * dsi [ DSI_MAX ] ;  bool is_dual_dsi ;  bool is_sync_needed ;  int master_dsi_link_id ; } cocci_id@p ;
...
position p;
@@
 struct dsi_connector {  struct drm_connector base ;  int id ; } cocci_id@p ;
...
position p;
@@
 struct msm_dsi_manager * cocci_id@p ;
...
position p;
@@
 struct dsi_bridge {  struct drm_bridge base ;  int id ; } cocci_id@p ;
...
position p;
@@
 struct msm_dsi_phy_shared_timings cocci_id@p [ DSI_MAX ] ;
...
position p;
@@
 struct dsi_connector * cocci_id@p ;
