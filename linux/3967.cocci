...
position p;
@@
 struct mtk_cirq_chip_data {  void __iomem * base ;  unsigned int ext_irq_start ;  unsigned int ext_irq_end ;  struct irq_domain * domain ; } cocci_id@p ;
...
position p;
@@
 struct mtk_cirq_chip_data * cocci_id@p ;
