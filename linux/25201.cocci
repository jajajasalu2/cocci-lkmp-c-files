...
position p;
@@
 struct objtool_file * cocci_id@p ;
...
typedef bool;
@@
 struct alternative {  struct list_head list ;  struct instruction * insn ;  bool skip_orig ; } cocci_id@p ;
