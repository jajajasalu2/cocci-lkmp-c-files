...
position p;
@@
 struct lm3533_led_platform_data * cocci_id@p ;
...
position p;
@@
 struct lm3533_led {  struct lm3533 * lm3533 ;  struct lm3533_ctrlbank cb ;  struct led_classdev cdev ;  int id ;  struct mutex mutex ;  unsigned long flags ; } cocci_id@p ;
