...
position p;
@@
 struct lcd_olinuxino * cocci_id@p ;
...
typedef u32;
@@
 struct lcd_olinuxino_mode {  u32 pixelclock ;  u32 hactive ;  u32 hfp ;  u32 hbp ;  u32 hpw ;  u32 vactive ;  u32 vfp ;  u32 vbp ;  u32 vpw ;  u32 refresh ;  u32 flags ; } cocci_id@p ;
...
position p;
@@
 struct lcd_olinuxino_info * cocci_id@p ;
...
position p;
@@
 struct lcd_olinuxino_mode * cocci_id@p ;
...
typedef bool;
@@
 struct lcd_olinuxino {  struct drm_panel panel ;  struct device * dev ;  struct i2c_client * client ;  struct mutex mutex ;  bool prepared ;  bool enabled ;  struct backlight_device * backlight ;  struct regulator * supply ;  struct gpio_desc * enable_gpio ;  struct lcd_olinuxino_eeprom eeprom ; } cocci_id@p ;
