...
position p;
@@
 struct sun4i_dma_promise cocci_id@p ;
...
position p;
@@
 struct sun4i_dma_pchan {  void __iomem * base ;  struct sun4i_dma_vchan * vchan ;  int is_dedicated ; } cocci_id@p ;
...
position p;
@@
 struct sun4i_dma_pchan cocci_id@p ;
...
position p;
@@
 struct sun4i_dma_contract cocci_id@p ;
...
@@
 struct sun4i_dma_promise {  u32 cfg ;  u32 para ;  dma_addr_t src ;  dma_addr_t dst ;  size_t len ;  struct list_head list ; } cocci_id@p ;
...
typedef u8;
@@
 struct sun4i_dma_vchan {  struct virt_dma_chan vc ;  struct dma_slave_config cfg ;  struct sun4i_dma_pchan * pchan ;  struct sun4i_dma_promise * processing ;  struct sun4i_dma_contract * contract ;  u8 endpoint ;  int is_dedicated ; } cocci_id@p ;
...
position p;
@@
 struct sun4i_dma_dev * cocci_id@p ;
...
position p;
@@
 struct sun4i_dma_vchan cocci_id@p ;
...
position p;
@@
 struct sun4i_dma_contract {  struct virt_dma_desc vd ;  struct list_head demands ;  struct list_head completed_demands ;  int is_cyclic ; } cocci_id@p ;
...
@@
 struct sun4i_dma_dev { 
	 DECLARE_BITMAP ( pchans_used , SUN4I_DMA_NR_MAX_CHANNELS ) 
		 ;  struct dma_device slave ;  struct sun4i_dma_pchan * pchans ;  struct sun4i_dma_vchan * vchans ;  void __iomem * base ;  struct clk * clk ;  int irq ;  spinlock_t lock ; } cocci_id@p ;
