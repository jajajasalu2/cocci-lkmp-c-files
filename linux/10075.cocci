...
position p;
@@
 struct baycom_state cocci_id@p ;
...
position p;
@@
 const struct hdlcdrv_ops cocci_id@p ;
...
position p;
@@
 struct hdlcdrv_ioctl cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , struct ifreq * ifr , struct hdlcdrv_ioctl * hi , int cmd ) ;
...
position p;
@@
 struct baycom_ioctl cocci_id@p ;
