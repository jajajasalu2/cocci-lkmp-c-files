...
position p;
@@
 struct tegra_hsp_doorbell * cocci_id@p ;
...
position p;
@@
 struct tegra_hsp_channel * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct tegra_hsp {  struct device * dev ;  const struct tegra_hsp_soc * soc ;  struct mbox_controller mbox_db ;  struct mbox_controller mbox_sm ;  void __iomem * regs ;  unsigned int doorbell_irq ;  unsigned int * shared_irqs ;  unsigned int shared_irq ;  unsigned int num_sm ;  unsigned int num_as ;  unsigned int num_ss ;  unsigned int num_db ;  unsigned int num_si ;  spinlock_t lock ;  struct list_head doorbells ;  struct tegra_hsp_mailbox * mailboxes ;  unsigned long mask ; } cocci_id@p ;
...
typedef bool;
@@
 struct tegra_hsp_mailbox {  struct tegra_hsp_channel channel ;  unsigned int index ;  bool producer ; } cocci_id@p ;
...
position p;
@@
 struct tegra_hsp_channel {  struct tegra_hsp * hsp ;  struct mbox_chan * chan ;  void __iomem * regs ; } cocci_id@p ;
...
typedef bool;
@@
 struct tegra_hsp_soc {  const struct tegra_hsp_db_map * map ;  bool has_per_mb_ie ; } cocci_id@p ;
...
position p;
@@
 struct tegra_hsp_db_map {  const char * name ;  unsigned int master ;  unsigned int index ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_hsp_db_map * cocci_id@p ;
...
position p;
@@
 struct tegra_hsp_doorbell {  struct tegra_hsp_channel channel ;  struct list_head list ;  const char * name ;  unsigned int master ;  unsigned int index ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_hsp_soc cocci_id@p ;
...
position p;
@@
 struct tegra_hsp_mailbox * cocci_id@p ;
