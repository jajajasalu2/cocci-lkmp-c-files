...
position p;
@@
 struct sit_net {  struct ip_tunnel __rcu * tunnels_r_l [ IP6_SIT_HASH_SIZE ] ;  struct ip_tunnel __rcu * tunnels_r [ IP6_SIT_HASH_SIZE ] ;  struct ip_tunnel __rcu * tunnels_l [ IP6_SIT_HASH_SIZE ] ;  struct ip_tunnel __rcu * tunnels_wc [ 1 ] ;  struct ip_tunnel __rcu * * tunnels [ 4 ] ;  struct net_device * fb_tunnel_dev ; } cocci_id@p ;
...
position p;
@@
 struct ip_tunnel_6rd cocci_id@p ;
...
position p;
@@
 struct ip_tunnel_prl_entry * cocci_id@p ;
...
typedef bool,__be32;
@@
 bool cocci_id@p ( struct ip_tunnel * tunnel , const struct in6_addr * v6dst , __be32 * v4dst ) ;
...
position p;
@@
 struct ip_tunnel_prl cocci_id@p ;
...
position p;
@@
 const struct ip_tunnel * cocci_id@p ;
