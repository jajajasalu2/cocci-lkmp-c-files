...
position p;
@@
 struct clk_programmable cocci_id@p ;
...
typedef u8;
@@
 struct clk_programmable {  struct clk_hw hw ;  struct regmap * regmap ;  u8 id ;  const struct clk_programmable_layout * layout ; } cocci_id@p ;
