...
position p;
@@
 struct arizona_fll_cfg cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ ARIZONA_SAMPLE_RATE_ENUM_SIZE ] ;
...
position p;
@@
 struct arizona_pdata * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARIZONA_MAX_PDM_SPK ] ;
...
position p;
@@
 const  cocci_id@p ( arizona_mixer_tlv , 
							     - 3200 , 100 , 0 ) ;
...
position p;
@@
 struct arizona_priv * cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ ARIZONA_RATE_ENUM_SIZE ] ;
...
position p;
@@
 struct arizona_dai_priv * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ ARIZONA_SAMPLE_RATE_ENUM_SIZE ] ;
...
position p;
@@
 const char * constcocci_id [ ARIZONA_NUM_MIXER_INPUTS ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ ARIZONA_FLL_MAX_FRATIO ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ ARIZONA_RATE_ENUM_SIZE ] ;
...
position p;
@@
 unsigned int cocci_id@p [ ARIZONA_NUM_MIXER_INPUTS ] ;
...
position p;
@@
 const struct arizona_priv * cocci_id@p ;
...
typedef u16;
@@
 struct {  unsigned int min ;  unsigned int max ;  u16 fratio ;  int ratio ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 struct {  unsigned int min ;  unsigned int max ;  u16 gain ; } cocci_id@p [ ] ;
...
position p;
@@
 struct arizona_fll_cfg {  int n ;  unsigned int theta ;  unsigned int lambda ;  int refdiv ;  int outdiv ;  int fratio ;  int gain ; } cocci_id@p ;
