...
typedef u_long;
@@
 int cocci_id@p ( int ioaddr , int airq , u_long shmem , void __iomem * ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int really_reset ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int mask ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int bufnum , int offset , void * buf , int count ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int command ) ;
...
position p;
@@
 struct net_device * cocci_id@p [ 16 ] ;
