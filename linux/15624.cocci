...
position p;
@@
 struct usb_wireless_ep_comp_descriptor cocci_id@p ;
...
position p;
@@
 const struct usb_host_endpoint * cocci_id@p ;
...
position p;
@@
 const struct wa_rpipe * cocci_id@p ;
...
position p;
@@
 struct usb_rpipe_descriptor * cocci_id@p ;
