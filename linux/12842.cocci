...
position p;
@@
 struct tegra_mc {  struct device * dev ;  void __iomem * regs ; } cocci_id@p ;
...
position p;
@@
 struct tegra_mc_client {  const char * name ;  unsigned int sid ;  struct {  unsigned int override ;  unsigned int security ; } regs ; } cocci_id@p ;
