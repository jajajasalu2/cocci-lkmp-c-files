...
position p;
@@
 enum ps2_subcmds { SEND_COMMAND = 1 , RECEIVE_N , AUTO_RECEIVE_N , CANCEL_AUTO_RECEIVE , } cocci_id@p ;
...
position p;
@@
 struct nvec_ps2 {  struct serio * ser_dev ;  struct notifier_block notifier ;  struct nvec_chip * nvec ; } cocci_id@p ;
