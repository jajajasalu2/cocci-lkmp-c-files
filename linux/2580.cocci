...
position p;
@@
 struct bset_stats_op * cocci_id@p ;
...
position p;
@@
 struct bset_stats_op {  struct btree_op op ;  size_t nodes ;  struct bset_stats stats ; } cocci_id@p ;
...
position p;
@@
 bch_cache_set_internal cocci_id@p ;
