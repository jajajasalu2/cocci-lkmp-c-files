...
position p;
@@
 struct drm_mode_fb_cmd * cocci_id@p ;
...
position p;
@@
 struct drm_mode_rmfb_work cocci_id@p ;
...
position p;
@@
 struct drm_mode_fb_dirty_cmd * cocci_id@p ;
...
position p;
@@
 struct drm_mode_rmfb_work {  struct work_struct work ;  struct list_head fbs ; } cocci_id@p ;
