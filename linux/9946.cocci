...
position p;
@@
 struct wcn36xx_hal_supported_rates * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ WCN36XX_HAL_PNO_MAX_NETW_CHANNELS_EX ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ WCN36XX_HAL_NUM_OFDM_RATES ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ WLAN_MAX_KEY_LEN ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ WCN36XX_HAL_NUM_DSSS_RATES ] ;
