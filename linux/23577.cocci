...
position p;
@@
 struct stm32_adfsdm_priv * cocci_id@p ;
...
typedef bool;
@@
 struct stm32_adfsdm_priv {  struct snd_soc_dai_driver dai_drv ;  struct snd_pcm_substream * substream ;  struct device * dev ;  struct iio_channel * iio_ch ;  struct iio_cb_buffer * iio_cb ;  bool iio_active ;  unsigned char * pcm_buff ;  unsigned int pos ;  struct mutex lock ; } cocci_id@p ;
