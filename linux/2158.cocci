...
position p;
@@
 const struct max14656_chg_type_props {  enum power_supply_type type ; } cocci_id@p [ ] ;
...
position p;
@@
 enum max14656_chg_type { MAX14656_NO_CHARGER = 0 , MAX14656_SDP_CHARGER , MAX14656_CDP_CHARGER , MAX14656_DCP_CHARGER , MAX14656_APPLE_500MA_CHARGER , MAX14656_APPLE_1A_CHARGER , MAX14656_APPLE_2A_CHARGER , MAX14656_SPECIAL_500MA_CHARGER , MAX14656_APPLE_12W , MAX14656_CHARGER_LAST , } cocci_id@p ;
...
position p;
@@
 struct max14656_chip {  struct i2c_client * client ;  struct power_supply * detect_psy ;  struct power_supply_desc psy_desc ;  struct delayed_work irq_work ;  int irq ;  int online ; } cocci_id@p ;
...
position p;
@@
 struct max14656_chip cocci_id@p ;
