...
position p;
@@
 struct dmfc_channel {  unsigned slots ;  struct ipu_soc * ipu ;  struct ipu_dmfc_priv * priv ;  const struct dmfc_channel_data * data ; } cocci_id@p ;
...
position p;
@@
 struct dmfc_channel_data {  int ipu_channel ;  unsigned long channel_reg ;  unsigned long shift ;  unsigned eot_shift ;  unsigned max_fifo_lines ; } cocci_id@p ;
...
position p;
@@
 struct dmfc_channel * cocci_id@p ;
...
position p;
@@
 const struct dmfc_channel_data cocci_id@p [ ] ;
...
position p;
@@
 struct ipu_dmfc_priv {  struct ipu_soc * ipu ;  struct device * dev ;  struct dmfc_channel channels [ DMFC_NUM_CHANNELS ] ;  struct mutex mutex ;  void __iomem * base ;  int use_count ; } cocci_id@p ;
...
position p;
@@
 struct ipu_dmfc_priv * cocci_id@p ;
