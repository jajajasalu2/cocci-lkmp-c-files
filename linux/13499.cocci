...
typedef u8,u16;
@@
 struct pctv452e_state {  struct dvb_ca_en50221 ca ;  struct mutex ca_mutex ;  u8 c ;  u8 initialized ;  u16 last_rc_key ; } cocci_id@p ;
...
position p;
@@
 struct pctv452e_state cocci_id@p ;
...
position p;
@@
 enum { TT3650_CMD_CI_TEST = 0x40 , TT3650_CMD_CI_RD_CTRL , TT3650_CMD_CI_WR_CTRL , TT3650_CMD_CI_RD_ATTR , TT3650_CMD_CI_WR_ATTR , TT3650_CMD_CI_RESET , TT3650_CMD_CI_SET_VIDEO_PORT , } cocci_id@p ;
...
position p;
@@
 struct stb0899_postproc cocci_id@p [ ] ;
