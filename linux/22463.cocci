...
position p;
@@
 struct hpi_adapters_list cocci_id@p ;
...
position p;
@@
 const struct pad_ofs_size cocci_id@p [ ] ;
...
position p;
@@
 struct pad_ofs_size {  unsigned int offset ;  unsigned int field_size ; } cocci_id@p ;
...
position p;
@@
 struct hpi_control_cache_info * * cocci_id@p ;
...
position p;
@@
 struct hpi_control_cache * cocci_id@p ;
...
typedef u16;
@@
 struct hpi_adapters_list {  struct hpios_spinlock list_lock ;  struct hpi_adapter_obj adapter [ HPI_MAX_ADAPTERS ] ;  u16 gw_num_adapters ; } cocci_id@p ;
...
position p;
@@
 struct hpi_control_res cocci_id@p ;
...
position p;
@@
 struct hpi_control_cache_pad * cocci_id@p ;
