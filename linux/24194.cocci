...
position p;
@@
 void cocci_id@p ( struct neighbour * neigh , struct sk_buff * skb ) ;
...
typedef u32,__u32;
@@
 u32 cocci_id@p ( const void * pkey , const struct net_device * dev , __u32 * hash_rnd ) ;
...
position p;
@@
 void cocci_id@p ( struct pneigh_entry * n ) ;
...
position p;
@@
 const struct neigh_ops cocci_id@p ;
...
position p;
@@
 struct neighbour_cb cocci_id@p ;
...
position p;
@@
 struct nduseroptmsg cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pneigh_entry * n ) ;
...
position p;
@@
 int cocci_id@p ( struct neighbour * neigh ) ;
...
typedef bool;
@@
 bool cocci_id@p ( const struct net_device * dev , struct netlink_ext_ack * extack ) ;
...
typedef bool;
@@
 bool cocci_id@p ( const struct neighbour * neigh , const void * pkey ) ;
