...
@@
 struct altera_msi { 
	 DECLARE_BITMAP ( used , MAX_MSI_VECTORS ) 
		 ;  struct mutex lock ;  struct platform_device * pdev ;  struct irq_domain * msi_domain ;  struct irq_domain * inner_domain ;  void __iomem * csr_base ;  void __iomem * vector_base ;  phys_addr_t vector_phy ;  u32 num_of_vectors ;  int irq ; } cocci_id@p ;
