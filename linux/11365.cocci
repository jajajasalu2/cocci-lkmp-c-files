...
position p;
@@
 struct sii9234 {  struct i2c_client * client [ 4 ] ;  struct drm_bridge bridge ;  struct device * dev ;  struct gpio_desc * gpio_reset ;  int i2c_error ;  struct regulator_bulk_data supplies [ 4 ] ;  struct mutex lock ;  enum sii9234_state state ; } cocci_id@p ;
...
position p;
@@
 enum sii9234_state { ST_OFF , ST_D3 , ST_RGND_INIT , ST_RGND_1K , ST_RSEN_HIGH , ST_MHL_ESTABLISHED , ST_FAILURE_DISCOVERY , ST_FAILURE , } cocci_id@p ;
...
position p;
@@
 enum sii9234_client_id { I2C_MHL , I2C_TPI , I2C_HDMI , I2C_CBUS , } cocci_id@p ;
