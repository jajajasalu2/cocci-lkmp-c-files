...
position p;
@@
 struct snd_usb_midi_out_endpoint cocci_id@p ;
...
position p;
@@
 struct out_urb_context * cocci_id@p ;
...
position p;
@@
 const struct usb_protocol_ops cocci_id@p ;
...
position p;
@@
 struct usb_ms_endpoint_descriptor * cocci_id@p ;
...
typedef u32;
@@
 struct port_info {  u32 id ;  short int port ;  short int voices ;  const char * name ;  unsigned int seq_flags ; } cocci_id@p [ ] ;
...
position p;
@@
 struct snd_usb_midi_endpoint_info * cocci_id@p ;
...
position p;
@@
 const struct snd_usb_audio_quirk * cocci_id@p ;
...
position p;
@@
 struct snd_usb_midi_in_endpoint cocci_id@p ;
...
position p;
@@
 struct snd_usb_midi_endpoint_info cocci_id@p [ MIDI_MAX_ENDPOINTS ] ;
...
typedef u8,bool;
@@
 struct snd_usb_midi_in_endpoint {  struct snd_usb_midi * umidi ;  struct urb * urbs [ INPUT_URBS ] ;  struct usbmidi_in_port {  struct snd_rawmidi_substream * substream ;  u8 running_status_length ; } ports [ 0x10 ] ;  u8 seen_f5 ;  bool in_sysex ;  u8 last_cin ;  u8 error_resubmit ;  int current_port ; } cocci_id@p ;
...
position p;
@@
 struct usbmidi_out_port * cocci_id@p ;
...
position p;
@@
 struct usbmidi_in_port * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_usb_midi_out_endpoint * ep ) ;
...
position p;
@@
 struct snd_usb_midi_endpoint * cocci_id@p ;
...
position p;
@@
 const struct snd_rawmidi_global_ops cocci_id@p ;
...
position p;
@@
 struct snd_usb_midi * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ MAX_AKAI_SYSEX_LEN ] ;
