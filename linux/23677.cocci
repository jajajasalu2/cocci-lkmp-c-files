...
position p;
@@
 struct sti_uniperiph_dai * cocci_id@p ;
...
position p;
@@
 struct sti_uniperiph_dev_data {  unsigned int id ;  unsigned int version ;  unsigned int stream ;  const char * dai_names ;  enum uniperif_type type ; } cocci_id@p ;
...
position p;
@@
 const struct sti_uniperiph_dev_data cocci_id@p ;
...
position p;
@@
 struct sti_uniperiph_dev_data * cocci_id@p ;
...
position p;
@@
 struct sti_uniperiph_data * cocci_id@p ;
