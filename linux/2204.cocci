...
position p;
@@
 struct ab8500_charger_interrupts cocci_id@p [ ] ;
...
typedef spinlock_t;
@@
 struct ab8500_charger_usb_state {  int usb_current ;  int usb_current_tmp ;  enum ab8500_usb_state state ;  enum ab8500_usb_state state_tmp ;  spinlock_t usb_lock ; } cocci_id@p ;
...
position p;
@@
 enum ab8500_charger_link_status cocci_id@p ;
...
typedef bool;
@@
 struct ab8500_charger_info {  int charger_connected ;  int charger_online ;  int charger_voltage ;  int cv_active ;  bool wd_expired ;  int charger_current ; } cocci_id@p ;
...
position p;
@@
 struct ab8500_charger_max_usb_in_curr {  int usb_type_max ;  int set_max ;  int calculated_max ; } cocci_id@p ;
...
typedef bool;
@@
 struct ab8500_charger_event_flags {  bool mainextchnotok ;  bool main_thermal_prot ;  bool usb_thermal_prot ;  bool vbus_ovv ;  bool usbchargernotok ;  bool chgwdexp ;  bool vbus_collapse ;  bool vbus_drop_end ; } cocci_id@p ;
...
position p;
@@
 struct ab8500_charger cocci_id@p ;
...
position p;
@@
 struct ux500_charger * cocci_id@p ;
...
position p;
@@
 enum ab8500_usb_state cocci_id@p ;
...
position p;
@@
 enum ab8500_usb_state { AB8500_BM_USB_STATE_RESET_HS , AB8500_BM_USB_STATE_RESET_FS , AB8500_BM_USB_STATE_CONFIGURED , AB8500_BM_USB_STATE_SUSPEND , AB8500_BM_USB_STATE_RESUME , AB8500_BM_USB_STATE_MAX , } cocci_id@p ;
