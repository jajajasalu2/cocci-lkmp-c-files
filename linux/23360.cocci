...
position p;
@@
 const char * cocci_id@p [ RT5682_NUM_SUPPLIES ] ;
...
position p;
@@
 struct rt5682_platform_data * cocci_id@p ;
...
position p;
@@
 const struct rt5682_platform_data cocci_id@p ;
...
position p;
@@
 struct rt5682_priv {  struct snd_soc_component * component ;  struct rt5682_platform_data pdata ;  struct regmap * regmap ;  struct snd_soc_jack * hs_jack ;  struct regulator_bulk_data supplies [ RT5682_NUM_SUPPLIES ] ;  struct delayed_work jack_detect_work ;  struct delayed_work jd_check_work ;  struct mutex calibrate_mutex ;  int sysclk ;  int sysclk_src ;  int lrck [ RT5682_AIFS ] ;  int bclk [ RT5682_AIFS ] ;  int master [ RT5682_AIFS ] ;  int pll_src ;  int pll_in ;  int pll_out ;  int jack_type ; } cocci_id@p ;
