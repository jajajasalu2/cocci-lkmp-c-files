...
position p;
@@
 int cocci_id@p ( MPT_ADAPTER * ioc , struct scsi_cmnd * scmd ) ;
...
position p;
@@
 int cocci_id@p ( MPT_ADAPTER * ioc , MPT_FRAME_HDR * mf , MPT_FRAME_HDR * r ) ;
...
symbol cocci_id;
position p;
typedef MpiRaidActionReply_t;
@@
 MpiRaidActionReply_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SCSIIOReply_t;
@@
 SCSIIOReply_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SEPRequest_t;
@@
 SEPRequest_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( MPT_ADAPTER * ioc , int post_reset ) ;
...
typedef u64,u8;
@@
 int cocci_id@p ( MPT_SCSI_HOST * hd , u8 type , u8 channel , u8 id , u64 lun , int ctx2abort , ulong timeout ) ;
...
typedef u8;
@@
 void cocci_id@p ( MPT_ADAPTER * ioc , u8 response_code ) ;
...
position p;
@@
 void cocci_id@p ( MPT_ADAPTER * ioc , int req_idx ) ;
...
position p;
@@
 void cocci_id@p ( MPT_ADAPTER * ioc , int i , struct scsi_cmnd * scmd ) ;
...
position p;
@@
 int cocci_id@p ( MPT_SCSI_HOST * hd , INTERNAL_CMD * iocmd ) ;
...
position p;
@@
 struct scsi_cmnd * cocci_id@p ( MPT_ADAPTER * ioc , int i ) ;
...
position p;
@@
 void cocci_id@p ( MPT_SCSI_HOST * hd , VirtDevice * vdevice ) ;
