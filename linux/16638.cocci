...
position p;
@@
 void cocci_id@p ( fsm_instance * fsm , int event , void * arg ) ;
...
position p;
@@
 void cocci_id@p ( fsm_instance * fi , int event , void * arg ) ;
...
position p;
@@
 const struct th_header cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct channel * ch , struct sk_buff * pskb ) ;
...
position p;
@@
 int cocci_id@p ( struct mpcg_info * mpcginfo ) ;
