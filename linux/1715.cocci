...
position p;
@@
 struct ad2s1200_state {  struct mutex lock ;  struct spi_device * sdev ;  struct gpio_desc * sample ;  struct gpio_desc * rdvel ;  __be16 rx ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ad2s1200_state * cocci_id@p ;
