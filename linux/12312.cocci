...
position p;
@@
 struct atmel_hlcdc_dc * cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_plane_state cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_dma_channel_dscr cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_plane * cocci_id@p ;
...
position p;
@@
 const struct atmel_hlcdc_layer_cfg_layout * cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_formats cocci_id@p ;
...
typedef uint32_t;
@@
 struct atmel_hlcdc_plane_state {  struct drm_plane_state base ;  int crtc_x ;  int crtc_y ;  unsigned int crtc_w ;  unsigned int crtc_h ;  uint32_t src_x ;  uint32_t src_y ;  uint32_t src_w ;  uint32_t src_h ;  int disc_x ;  int disc_y ;  int disc_w ;  int disc_h ;  int ahb_id ;  int bpp [ ATMEL_HLCDC_LAYER_MAX_PLANES ] ;  unsigned int offsets [ ATMEL_HLCDC_LAYER_MAX_PLANES ] ;  int xstride [ ATMEL_HLCDC_LAYER_MAX_PLANES ] ;  int pstride [ ATMEL_HLCDC_LAYER_MAX_PLANES ] ;  int nplanes ;  struct atmel_hlcdc_dma_channel_dscr * dscrs [ ATMEL_HLCDC_LAYER_MAX_PLANES ] ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_hlcdc_layer_desc * cocci_id@p ;
