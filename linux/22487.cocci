...
position p;
@@
 struct mixart_audio_info_req * cocci_id@p ;
...
position p;
@@
 struct snd_mixart_elf32_ehdr * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct snd_mixart_elf32_ehdr {  u8 e_ident [ 16 ] ;  __be16 e_type ;  __be16 e_machine ;  __be32 e_version ;  __be32 e_entry ;  __be32 e_phoff ;  __be32 e_shoff ;  __be32 e_flags ;  __be16 e_ehsize ;  __be16 e_phentsize ;  __be16 e_phnum ;  __be16 e_shentsize ;  __be16 e_shnum ;  __be16 e_shstrndx ; } cocci_id@p ;
...
position p;
@@
 struct mixart_audio_info_resp * cocci_id@p ;
...
position p;
@@
 struct mixart_uid_enumeration cocci_id@p ;
...
position p;
@@
 struct mixart_enum_connector_resp * cocci_id@p ;
...
typedef __be32;
@@
 struct snd_mixart_elf32_phdr {  __be32 p_type ;  __be32 p_offset ;  __be32 p_vaddr ;  __be32 p_paddr ;  __be32 p_filesz ;  __be32 p_memsz ;  __be32 p_flags ;  __be32 p_align ; } cocci_id@p ;
...
position p;
@@
 struct snd_mixart_elf32_phdr cocci_id@p ;
