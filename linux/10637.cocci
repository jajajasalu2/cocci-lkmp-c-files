...
position p;
@@
 struct intel_vgpu_i2c_gmbus cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_i2c_edid * cocci_id@p ;
...
position p;
@@
 enum { AUX_CH_CTL = 0 , AUX_CH_DATA1 , AUX_CH_DATA2 , AUX_CH_DATA3 , AUX_CH_DATA4 , AUX_CH_DATA5 , } cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_edid_data * cocci_id@p ;
