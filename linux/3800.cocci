...
position p;
@@
 struct caam_qi_priv * cocci_id@p ;
...
position p;
@@
 struct caam_napi {  struct napi_struct irqtask ;  struct qman_portal * p ; } cocci_id@p ;
...
position p;
@@
 struct caam_qi_pcpu_priv * cocci_id@p ;
...
position p;
@@
 struct caam_qi_priv {  struct qman_cgr cgr ; } cocci_id@p ;
