...
position p;
@@
 struct rt6_exception * cocci_id@p ;
...
position p;
@@
 struct fib6_nh_age_excptn_arg {  struct fib6_gc_args * gc_args ;  unsigned long now ; } cocci_id@p ;
...
position p;
@@
 struct rt6_nh {  struct fib6_info * fib6_info ;  struct fib6_config r_cfg ;  struct list_head next ; } cocci_id@p ;
...
position p;
@@
 struct fib6_nh_del_cached_rt_arg * cocci_id@p ;
...
position p;
@@
 const struct arg_netdev_event * cocci_id@p ;
...
position p;
@@
 struct fib6_nh_rd_arg {  struct fib6_result * res ;  struct flowi6 * fl6 ;  const struct in6_addr * gw ;  struct rt6_info * * ret ; } cocci_id@p ;
...
position p;
@@
 enum fib_event_type cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct net * net , struct sk_buff * skb , struct fib6_info * rt , struct dst_entry * dst , struct in6_addr * dest , struct in6_addr * src , int iif , int type , u32 portid , u32 seq , unsigned int flags ) ;
...
position p;
@@
 struct rt6_mtu_change_arg * cocci_id@p ;
...
position p;
@@
 struct ipv6_route_iter cocci_id@p ;
...
position p;
@@
 struct rt6_mtu_change_arg {  struct net_device * dev ;  unsigned int mtu ;  struct fib6_info * f6i ; } cocci_id@p ;
...
position p;
@@
 struct fib6_gc_args * cocci_id@p ;
...
position p;
@@
 struct fib6_nh_exception_dump_walker cocci_id@p ;
...
position p;
@@
 struct fib6_nh_del_cached_rt_arg {  struct fib6_config * cfg ;  struct fib6_info * f6i ; } cocci_id@p ;
...
position p;
@@
 struct fib6_nh_frl_arg * cocci_id@p ;
...
position p;
@@
 struct rta_cacheinfo cocci_id@p ;
...
position p;
@@
 struct rt6_info * cocci_id@p ( const struct fib6_result * res , const struct in6_addr * daddr , const struct in6_addr * saddr ) ;
...
position p;
@@
 struct fib6_nh_excptn_arg cocci_id@p ;
...
position p;
@@
 size_t cocci_id@p ( struct fib6_info * f6i ) ;
...
position p;
@@
 const struct ipv6hdr * cocci_id@p ;
...
typedef bool,u32;
@@
 struct fib6_nh_frl_arg {  u32 flags ;  int oif ;  int strict ;  int * mpri ;  bool * do_rr ;  struct fib6_nh * nh ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ RTA_MAX + 1 ] ;
...
position p;
@@
 struct fib6_info * cocci_id@p ( struct net * net , const struct in6_addr * prefix , int prefixlen , const struct in6_addr * gwaddr , struct net_device * dev ) ;
...
position p;
@@
 void cocci_id@p ( struct dst_entry * dst , struct sock * sk , struct sk_buff * skb ) ;
...
position p;
@@
 const int cocci_id@p [ RTN_MAX + 1 ] ;
...
position p;
@@
 struct dst_entry * cocci_id@p ( struct dst_entry * ) ;
...
position p;
@@
 struct ip6rd_flowi {  struct flowi6 fl6 ;  struct in6_addr gateway ; } cocci_id@p ;
...
position p;
@@
 struct arg_dev_net_ip {  struct net_device * dev ;  struct net * net ;  struct in6_addr * addr ; } cocci_id@p ;
...
position p;
@@
 struct rt6_exception_bucket * cocci_id@p ;
...
position p;
@@
 struct arg_dev_net_ip cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( const struct fib6_nh * nh , u32 fib6_flags , int oif , int strict ) ;
...
position p;
@@
 struct fib6_nh_dm_arg cocci_id@p ;
...
position p;
@@
 struct fib6_nh_dm_arg {  struct net * net ;  const struct in6_addr * saddr ;  int oif ;  int flags ;  struct fib6_nh * nh ; } cocci_id@p ;
...
position p;
@@
 struct fib6_nh_match_arg cocci_id@p ;
...
position p;
@@
 struct fib6_nh_rd_arg * cocci_id@p ;
...
position p;
@@
 struct __rt6_probe_work {  struct work_struct work ;  struct in6_addr target ;  struct net_device * dev ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sk_buff * skb ) ;
...
position p;
@@
 int cocci_id@p ( struct dst_ops * ops ) ;
...
position p;
@@
 void cocci_id@p ( struct dst_entry * ) ;
...
position p;
@@
 int cocci_id@p ( struct net * net , struct sock * sk , struct sk_buff * skb ) ;
...
position p;
@@
 struct fib6_info * cocci_id@p ( struct net * net , const struct in6_addr * prefix , int prefixlen , const struct in6_addr * gwaddr , struct net_device * dev , unsigned int pref ) ;
...
position p;
@@
 struct arg_netdev_event {  const struct net_device * dev ;  union {  unsigned char nh_flags ;  unsigned long event ; } ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct uncached_list {  spinlock_t lock ;  struct list_head head ; } cocci_id@p ;
...
position p;
@@
 const struct rd_msg * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct dst_entry * dst , struct sock * sk , struct sk_buff * skb , u32 mtu ) ;
...
position p;
@@
 struct fib6_nh_age_excptn_arg * cocci_id@p ;
...
position p;
@@
 const struct fib6_nh * cocci_id@p ;
...
position p;
@@
 struct uncached_list * cocci_id@p ;
...
position p;
@@
 const struct rt6_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dst_entry * , struct net_device * dev , int how ) ;
...
position p;
@@
 struct fib6_nh_exception_dump_walker {  struct rt6_rtnl_dump_arg * dump ;  struct fib6_info * rt ;  unsigned int flags ;  unsigned int skip ;  unsigned int count ; } cocci_id@p ;
...
position p;
@@
 struct inet_peer_base * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ RTA_MAX + 1 ] ;
...
position p;
@@
 struct fib_dump_filter * cocci_id@p ;
...
position p;
@@
 const struct dst_entry * cocci_id@p ;
...
position p;
@@
 struct arg_netdev_event cocci_id@p ;
...
position p;
@@
 const struct fib6_result * cocci_id@p ;
...
position p;
@@
 struct fib6_nh_excptn_arg {  struct rt6_info * rt ;  int plen ; } cocci_id@p ;
...
position p;
@@
 const struct flowi6 * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sk_buff * skb ) ;
...
position p;
@@
 struct rt6_rtnl_dump_arg * cocci_id@p ;
...
position p;
@@
 struct fib6_nh_match_arg {  const struct net_device * dev ;  const struct in6_addr * gw ;  struct fib6_nh * match ; } cocci_id@p ;
...
position p;
@@
 struct ndisc_options cocci_id@p ;
...
position p;
@@
 enum rt6_nud_state { RT6_NUD_FAIL_HARD = - 3 , RT6_NUD_FAIL_PROBE = - 2 , RT6_NUD_FAIL_DO_RR = - 1 , RT6_NUD_SUCCEED = 1 , } cocci_id@p ;
...
position p;
@@
 struct netevent_redirect cocci_id@p ;
...
typedef u32;
@@
 struct dst_entry * cocci_id@p ( struct dst_entry * dst , u32 cookie ) ;
...
position p;
@@
 const struct icmp6hdr * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( const struct dst_entry * dst ) ;
