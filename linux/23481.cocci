...
position p;
@@
 struct uda1334_priv {  struct gpio_desc * mute ;  struct gpio_desc * deemph ;  unsigned int sysclk ;  unsigned int rate_constraint_list [ UDA1334_NUM_RATES ] ;  struct snd_pcm_hw_constraint_list rate_constraint ; } cocci_id@p ;
...
position p;
@@
 struct uda1334_priv cocci_id@p ;
...
position p;
@@
 const struct {  int value ;  int ratio ; } cocci_id@p [ UDA1334_NUM_RATES ] ;
