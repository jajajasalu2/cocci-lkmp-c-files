...
position p;
@@
 struct cq_fcp_rq_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fnic * fnic , struct sk_buff * skb ) ;
...
position p;
@@
 struct fip_vlan_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fnic * fnic , struct sk_buff * ) ;
...
position p;
@@
 void cocci_id@p ( struct fnic * fnic ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct fnic * fnic , u16 flag ) ;
...
position p;
@@
 struct cq_enet_rq_desc * cocci_id@p ;
