...
position p;
@@
 struct cpt_request_info * cocci_id@p ;
...
position p;
@@
 struct sglist_component cocci_id@p ;
...
position p;
@@
 struct cpt_vq_command cocci_id@p ;
...
position p;
@@
 struct cptvf_request * cocci_id@p ;
...
position p;
@@
 struct cpt_info_buffer * cocci_id@p ;
