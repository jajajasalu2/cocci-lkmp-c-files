...
position p;
@@
 enum variable_flavor cocci_id@p ;
...
position p;
@@
 const struct function * cocci_id@p ;
...
position p;
@@
 struct variable {  char * name ;  char * value ;  enum variable_flavor flavor ;  int exp_count ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 char * cocci_id@p ( const char * in , int argc , char * argv [ ] ) ;
...
position p;
@@
 char * cocci_id@p [ FUNCTION_MAX_ARGS ] ;
...
position p;
@@
 struct function {  const char * name ;  unsigned int min_args ;  unsigned int max_args ;  char * ( * func ) ( int argc , char * argv [ ] ) ; } cocci_id@p ;
...
position p;
@@
 struct env {  char * name ;  char * value ;  struct list_head node ; } cocci_id@p ;
