...
typedef u16;
@@
 struct multiq_sched_data {  u16 bands ;  u16 max_bands ;  u16 curband ;  struct tcf_proto __rcu * filter_list ;  struct tcf_block * block ;  struct Qdisc * * queues ; } cocci_id@p ;
...
position p;
@@
 struct multiq_sched_data cocci_id@p ;
...
position p;
@@
 struct tc_multiq_qopt cocci_id@p ;
