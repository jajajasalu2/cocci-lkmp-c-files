...
position p;
@@
 int cocci_id@p ( struct rbd_device * rbd_dev ) ;
...
position p;
@@
 struct ceph_bio_iter cocci_id@p ;
...
position p;
@@
 struct ceph_entity_addr * cocci_id@p ;
...
position p;
@@
 enum obj_request_type { OBJ_REQUEST_NODATA = 1 , OBJ_REQUEST_BIO , OBJ_REQUEST_BVECS , OBJ_REQUEST_OWN_BVECS , } cocci_id@p ;
...
position p;
@@
 struct rbd_obj_request * cocci_id@p ;
...
position p;
@@
 struct ceph_watch_item * cocci_id@p ;
...
position p;
@@
 struct fs_parameter * cocci_id@p ;
...
position p;
@@
 enum rbd_obj_read_state { RBD_OBJ_READ_START = 1 , RBD_OBJ_READ_OBJECT , RBD_OBJ_READ_PARENT , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ 4 + 8 + 8 + CEPH_ENCODING_START_BLK_LEN ] ;
...
position p;
@@
 struct ceph_osd_data * cocci_id@p ;
...
position p;
@@
 struct ceph_osd_request * cocci_id@p ;
...
position p;
@@
 const struct rbd_client_id * cocci_id@p ;
...
position p;
@@
 struct parent_image_info * cocci_id@p ;
...
position p;
@@
 struct ceph_object_locator * cocci_id@p ;
...
position p;
@@
 enum rbd_img_state { RBD_IMG_START = 1 , RBD_IMG_EXCLUSIVE_LOCK , __RBD_IMG_OBJECT_REQUESTS , RBD_IMG_OBJECT_REQUESTS , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rbd_device * rbd_dev ) ;
...
position p;
@@
 void cocci_id@p ( struct rbd_img_request * img_req , int result ) ;
...
position p;
@@
 char cocci_id@p [ 4 + CEPH_ENCODING_START_BLK_LEN ] ;
...
position p;
@@
 int cocci_id@p ( struct rbd_device * rbd_dev , int depth ) ;
...
position p;
@@
 struct rbd_img_request cocci_id@p ;
...
position p;
@@
 enum rbd_dev_flags { RBD_DEV_FLAG_EXISTS , RBD_DEV_FLAG_REMOVING , RBD_DEV_FLAG_READONLY , } cocci_id@p ;
...
position p;
@@
 struct rbd_image_header_ondisk * cocci_id@p ;
...
position p;
@@
 struct pending_result {  int result ;  int num_pending ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct device * dev ) ;
...
position p;
@@
 struct fs_parse_result cocci_id@p ;
...
position p;
@@
 union rbd_img_fill_iter cocci_id@p ;
...
position p;
@@
 struct pending_result * cocci_id@p ;
...
position p;
@@
 struct ceph_osd_client * cocci_id@p ;
...
position p;
@@
 struct rbd_img_fill_ctx * cocci_id@p ;
...
typedef u64,bool;
@@
 struct parent_image_info {  u64 pool_id ;  const char * pool_ns ;  const char * image_id ;  u64 snap_id ;  bool has_overlap ;  u64 overlap ; } cocci_id@p ;
...
position p;
@@
 struct rbd_client {  struct ceph_client * client ;  struct kref kref ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct blk_mq_hw_ctx * cocci_id@p ;
...
position p;
@@
 struct ceph_file_extent * cocci_id@p ;
...
position p;
@@
 const struct blk_mq_queue_data * cocci_id@p ;
...
position p;
@@
 struct ceph_osd_linger_request * cocci_id@p ;
...
position p;
@@
 enum obj_operation_type { OBJ_OP_READ = 1 , OBJ_OP_WRITE , OBJ_OP_DISCARD , OBJ_OP_ZEROOUT , } cocci_id@p ;
...
typedef bool;
@@
 struct rbd_options {  int queue_depth ;  int alloc_size ;  unsigned long lock_timeout ;  bool read_only ;  bool lock_on_read ;  bool exclusive ;  bool trim ; } cocci_id@p ;
...
position p;
@@
 struct ceph_snap_context * cocci_id@p ;
...
position p;
@@
 enum obj_operation_type cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rbd_spec * spec ) ;
...
position p;
@@
 struct ceph_file_layout * cocci_id@p ;
...
position p;
@@
 struct rbd_client_id cocci_id@p ;
...
position p;
@@
 struct rbd_image_snap_ondisk * cocci_id@p ;
...
position p;
@@
 struct blk_mq_tag_set * cocci_id@p ;
...
typedef u64;
@@
 struct rbd_client_id {  u64 gid ;  u64 handle ; } cocci_id@p ;
...
typedef u64;
@@
 const char * cocci_id@p ( struct rbd_device * rbd_dev , u64 snap_id ) ;
...
position p;
@@
 const struct device_type cocci_id@p ;
...
position p;
@@
 struct rbd_parse_opts_ctx * cocci_id@p ;
...
position p;
@@
 struct rbd_parse_opts_ctx {  struct rbd_spec * spec ;  struct ceph_options * copts ;  struct rbd_options * opts ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rbd_obj_request * obj_req , int result ) ;
...
typedef u64;
@@
 struct rbd_spec {  u64 pool_id ;  const char * pool_name ;  const char * pool_ns ;  const char * image_id ;  const char * image_name ;  u64 snap_id ;  const char * snap_name ;  struct kref kref ; } cocci_id@p ;
...
typedef u32;
@@
 struct rbd_obj_request {  struct ceph_object_extent ex ;  unsigned int flags ;  union {  enum rbd_obj_read_state read_state ;  enum rbd_obj_write_state write_state ; } ;  struct rbd_img_request * img_request ;  struct ceph_file_extent * img_extents ;  u32 num_img_extents ;  union {  struct ceph_bio_iter bio_pos ;  struct {  struct ceph_bvec_iter bvec_pos ;  u32 bvec_count ;  u32 bvec_idx ; } ; } ;  enum rbd_obj_copyup_state copyup_state ;  struct bio_vec * copyup_bvecs ;  u32 copyup_bvec_count ;  struct list_head osd_reqs ;  struct mutex state_mutex ;  struct pending_result pending ;  struct kref kref ; } cocci_id@p ;
...
position p;
@@
 struct ceph_object_extent * cocci_id@p ;
...
position p;
@@
 struct ceph_object_id * cocci_id@p ;
...
typedef u64;
@@
 struct rbd_mapping {  u64 size ; } cocci_id@p ;
...
typedef u64;
@@
 struct rbd_img_request {  struct rbd_device * rbd_dev ;  enum obj_operation_type op_type ;  enum obj_request_type data_type ;  unsigned long flags ;  enum rbd_img_state state ;  union {  u64 snap_id ;  struct ceph_snap_context * snapc ; } ;  union {  struct request * rq ;  struct rbd_obj_request * obj_request ; } ;  struct list_head lock_item ;  struct list_head object_extents ;  struct mutex state_mutex ;  struct pending_result pending ;  struct work_struct work ;  int work_result ;  struct kref kref ; } cocci_id@p ;
...
position p;
@@
 enum rbd_lock_state { RBD_LOCK_STATE_UNLOCKED , RBD_LOCK_STATE_LOCKED , RBD_LOCK_STATE_RELEASING , } cocci_id@p ;
...
position p;
@@
 const struct ceph_locker * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,__u8,s64;
@@
 struct rbd_image_header {  char * object_prefix ;  __u8 obj_order ;  u64 stripe_unit ;  u64 stripe_count ;  s64 data_pool_id ;  u64 features ;  u64 image_size ;  struct ceph_snap_context * snapc ;  char * snap_names ;  u64 * snap_sizes ; } cocci_id@p ;
...
position p;
@@
 enum rbd_obj_write_state { RBD_OBJ_WRITE_START = 1 , RBD_OBJ_WRITE_PRE_OBJECT_MAP , RBD_OBJ_WRITE_OBJECT , __RBD_OBJ_WRITE_COPYUP , RBD_OBJ_WRITE_COPYUP , RBD_OBJ_WRITE_POST_OBJECT_MAP , } cocci_id@p ;
...
position p;
@@
 struct ceph_options * cocci_id@p ;
...
position p;
@@
 const struct blk_mq_ops cocci_id@p ;
...
position p;
@@
 enum rbd_obj_copyup_state { RBD_OBJ_COPYUP_START = 1 , RBD_OBJ_COPYUP_READ_PARENT , __RBD_OBJ_COPYUP_OBJECT_MAPS , RBD_OBJ_COPYUP_OBJECT_MAPS , __RBD_OBJ_COPYUP_WRITE_OBJECT , RBD_OBJ_COPYUP_WRITE_OBJECT , } cocci_id@p ;
...
position p;
@@
 const struct block_device_operations cocci_id@p ;
...
position p;
@@
 struct ceph_timespec cocci_id@p ;
...
position p;
@@
 enum img_req_flags { IMG_REQ_CHILD , IMG_REQ_LAYERED , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,u32,atomic_t,spinlock_t;
@@
 struct rbd_device {  int dev_id ;  int major ;  int minor ;  struct gendisk * disk ;  u32 image_format ;  struct rbd_client * rbd_client ;  char name [ DEV_NAME_LEN ] ;  spinlock_t lock ;  struct rbd_image_header header ;  unsigned long flags ;  struct rbd_spec * spec ;  struct rbd_options * opts ;  char * config_info ;  struct ceph_object_id header_oid ;  struct ceph_object_locator header_oloc ;  struct ceph_file_layout layout ;  struct mutex watch_mutex ;  enum rbd_watch_state watch_state ;  struct ceph_osd_linger_request * watch_handle ;  u64 watch_cookie ;  struct delayed_work watch_dwork ;  struct rw_semaphore lock_rwsem ;  enum rbd_lock_state lock_state ;  char lock_cookie [ 32 ] ;  struct rbd_client_id owner_cid ;  struct work_struct acquired_lock_work ;  struct work_struct released_lock_work ;  struct delayed_work lock_dwork ;  struct work_struct unlock_work ;  spinlock_t lock_lists_lock ;  struct list_head acquiring_list ;  struct list_head running_list ;  struct completion acquire_wait ;  int acquire_err ;  struct completion releasing_wait ;  spinlock_t object_map_lock ;  u8 * object_map ;  u64 object_map_size ;  u64 object_map_flags ;  struct workqueue_struct * task_wq ;  struct rbd_spec * parent_spec ;  u64 parent_overlap ;  atomic_t parent_ref ;  struct rbd_device * parent ;  struct blk_mq_tag_set tag_set ;  struct rw_semaphore header_rwsem ;  struct rbd_mapping mapping ;  struct list_head node ;  struct device dev ;  unsigned long open_count ; } cocci_id@p ;
...
typedef u8,__le64;
@@
 struct {  __le64 snap_id ;  u8 read_only ; } cocci_id@p ;
...
position p;
@@
 struct ceph_bvec_iter cocci_id@p ;
...
position p;
@@
 const struct fs_parameter_spec cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct kref * kref ) ;
...
position p;
@@
 enum rbd_watch_state { RBD_WATCH_STATE_UNREGISTERED , RBD_WATCH_STATE_REGISTERED , RBD_WATCH_STATE_ERROR , } cocci_id@p ;
...
position p;
@@
 const struct fs_parameter_description cocci_id@p ;
...
position p;
@@
 struct rbd_image_header * cocci_id@p ;
...
typedef u64,u8;
@@
 int cocci_id@p ( struct rbd_device * rbd_dev , u64 snap_id , u8 * order , u64 * snap_size ) ;
...
symbol cocci_id;
position p;
typedef ceph_object_extent_fn_t;
@@
 struct rbd_img_fill_ctx {  enum obj_request_type pos_type ;  union rbd_img_fill_iter * pos ;  union rbd_img_fill_iter iter ;  ceph_object_extent_fn_t set_pos_fn ;  ceph_object_extent_fn_t count_fn ;  ceph_object_extent_fn_t copy_fn ; } cocci_id@p ;
...
position p;
@@
 union rbd_img_fill_iter {  struct ceph_bio_iter bio_iter ;  struct ceph_bvec_iter bvec_iter ; } cocci_id@p ;
