...
position p;
@@
 struct fixup_entry {  unsigned long mask ;  unsigned long value ;  long start_off ;  long end_off ;  long alt_start_off ;  long alt_end_off ; } cocci_id@p ;
...
position p;
@@
 enum stf_barrier_type cocci_id@p ;
