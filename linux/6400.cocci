...
position p;
@@
 struct regulator_bulk_devres {  struct regulator_bulk_data * consumers ;  int num_consumers ; } cocci_id@p ;
...
position p;
@@
 struct regulator_bulk_devres * cocci_id@p ;
...
position p;
@@
 struct regulator_supply_alias_match * cocci_id@p ;
...
position p;
@@
 struct regulator_notifier_match cocci_id@p ;
...
position p;
@@
 struct regulator_supply_alias_match {  struct device * dev ;  const char * id ; } cocci_id@p ;
...
position p;
@@
 struct regulator_notifier_match {  struct regulator * regulator ;  struct notifier_block * nb ; } cocci_id@p ;
