...
position p;
@@
 struct ocfs2_slot_info {  int si_extended ;  int si_slots_per_block ;  struct inode * si_inode ;  unsigned int si_blocks ;  struct buffer_head * * si_bh ;  unsigned int si_num_slots ;  struct ocfs2_slot si_slots [ ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_slot_info * si , unsigned int node_num ) ;
...
position p;
@@
 struct ocfs2_slot_info * cocci_id@p ;
...
position p;
@@
 struct ocfs2_slot_map_extended * cocci_id@p ;
...
position p;
@@
 struct ocfs2_extended_slot cocci_id@p ;
...
position p;
@@
 struct ocfs2_slot {  int sl_valid ;  unsigned int sl_node_num ; } cocci_id@p ;
...
position p;
@@
 struct ocfs2_slot_map * cocci_id@p ;
