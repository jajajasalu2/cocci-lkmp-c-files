...
typedef FILE;
@@
 acpi_physical_address cocci_id@p ( FILE * file , const char * keyword ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( acpi_status default_status ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( char * directory ) ;
...
typedef u32;
@@
 struct osl_table_info {  struct osl_table_info * next ;  u32 instance ;  char signature [ ACPI_NAMESEG_SIZE ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef acpi_status,u32;
@@
 acpi_status cocci_id@p ( char * signature , u32 instance ) ;
...
typedef acpi_status,u32;
@@
 acpi_status cocci_id@p ( char * pathname , char * signature , u32 instance , struct acpi_table_header * * table , acpi_physical_address * address ) ;
...
position p;
@@
 struct osl_table_info cocci_id@p ;
...
position p;
@@
 struct acpi_table_rsdp cocci_id@p ;
...
typedef acpi_status,u32;
@@
 acpi_status cocci_id@p ( char * signature , u32 instance , struct acpi_table_header * * table , acpi_physical_address * address ) ;
...
position p;
@@
 void cocci_id@p ( struct acpi_table_header * table ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( acpi_size address , char * signature , struct acpi_table_header * * table ) ;
...
position p;
@@
 acpi_physical_address cocci_id@p ( void ) ;
...
position p;
@@
 char cocci_id@p [ ACPI_NAMESEG_SIZE ] ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( char * filename , acpi_size file_offset , char * signature , struct acpi_table_header * * table ) ;
...
position p;
@@
 struct acpi_table_xsdt * cocci_id@p ;
...
position p;
@@
 struct acpi_table_fadt * cocci_id@p ;
...
typedef acpi_status,u32;
@@
 acpi_status cocci_id@p ( char * filename , char * signature , u32 * instance ) ;
...
position p;
@@
 struct acpi_table_rsdt * cocci_id@p ;
