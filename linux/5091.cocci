...
typedef spinlock_t;
@@
 struct sprd_eic {  struct gpio_chip chip ;  struct irq_chip intc ;  void __iomem * base [ SPRD_EIC_MAX_BANK ] ;  enum sprd_eic_type type ;  spinlock_t lock ;  int irq ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ SPRD_EIC_MAX ] ;
...
position p;
@@
 const struct sprd_eic_variant_data * cocci_id@p ;
...
typedef u32;
@@
 struct sprd_eic_variant_data {  enum sprd_eic_type type ;  u32 num_eics ; } cocci_id@p ;
...
position p;
@@
 enum sprd_eic_type { SPRD_EIC_DEBOUNCE , SPRD_EIC_LATCH , SPRD_EIC_ASYNC , SPRD_EIC_SYNC , SPRD_EIC_MAX , } cocci_id@p ;
