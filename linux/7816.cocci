...
typedef u64,u32;
@@
 struct shared_mw {  u32 magic ;  u32 link_sta ;  u32 partition_id ;  u64 mw_sizes [ MAX_MWS ] ;  u32 spad [ 128 ] ; } cocci_id@p ;
...
position p;
@@
 struct switchtec_dev * cocci_id@p ;
...
position p;
@@
 enum switchtec_msg { LINK_MESSAGE = 0 , MSG_LINK_UP = 1 , MSG_LINK_DOWN = 2 , MSG_CHECK_LINK = 3 , MSG_LINK_FORCE_DOWN = 4 , } cocci_id@p ;
...
position p;
@@
 struct ntb_dbmsg_regs cocci_id@p ;
...
position p;
@@
 struct switchtec_ntb * cocci_id@p ;
...
position p;
@@
 struct ntb_ctrl_regs * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct switchtec_ntb * sndev ) ;
...
position p;
@@
 const struct ntb_dev_ops cocci_id@p ;
