...
position p;
@@
 struct lt3651_charger * cocci_id@p ;
...
position p;
@@
 struct lt3651_charger {  struct power_supply * charger ;  struct power_supply_desc charger_desc ;  struct gpio_desc * acpr_gpio ;  struct gpio_desc * fault_gpio ;  struct gpio_desc * chrg_gpio ; } cocci_id@p ;
