...
position p;
@@
 struct cdns_pcie_ep * cocci_id@p ;
...
position p;
@@
 const struct cdns_plat_pcie_of_data cocci_id@p ;
...
position p;
@@
 struct cdns_plat_pcie * cocci_id@p ;
...
typedef bool;
@@
 struct cdns_plat_pcie {  struct cdns_pcie * pcie ;  bool is_rc ; } cocci_id@p ;
...
position p;
@@
 struct cdns_plat_pcie_of_data * cocci_id@p ;
...
typedef bool;
@@
 struct cdns_plat_pcie_of_data {  bool is_rc ; } cocci_id@p ;
...
position p;
@@
 struct cdns_pcie_rc * cocci_id@p ;
