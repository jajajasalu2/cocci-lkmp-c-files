...
position p;
@@
 struct uniphier_reset_priv {  struct reset_controller_dev rcdev ;  struct device * dev ;  struct regmap * regmap ;  const struct uniphier_reset_data * data ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_reset_priv * cocci_id@p ;
...
position p;
@@
 const struct uniphier_reset_data cocci_id@p [ ] ;
