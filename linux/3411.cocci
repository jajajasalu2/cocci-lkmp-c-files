...
position p;
@@
 struct virtio_balloon cocci_id@p ;
...
position p;
@@
 enum virtio_balloon_config_read { VIRTIO_BALLOON_CONFIG_READ_CMD_ID = 0 , } cocci_id@p ;
...
position p;
@@
 struct virtio_balloon_config cocci_id@p ;
...
position p;
@@
 struct virtqueue * cocci_id@p [ VIRTIO_BALLOON_VQ_MAX ] ;
...
position p;
@@
 enum virtio_balloon_vq { VIRTIO_BALLOON_VQ_INFLATE , VIRTIO_BALLOON_VQ_DEFLATE , VIRTIO_BALLOON_VQ_STATS , VIRTIO_BALLOON_VQ_FREE_PAGE , VIRTIO_BALLOON_VQ_MAX , } cocci_id@p ;
...
@@
 vq_callback_t * cocci_id@p [ VIRTIO_BALLOON_VQ_MAX ] ;
...
position p;
@@
 const char * cocci_id@p [ VIRTIO_BALLOON_VQ_MAX ] ;
