...
position p;
@@
 const struct pic32_pin_group cocci_id@p [ ] ;
...
position p;
@@
 struct pic32_pinctrl * cocci_id@p ;
...
position p;
@@
 struct pic32_desc_function * cocci_id@p ;
...
position p;
@@
 struct pic32_gpio_bank * cocci_id@p ;
...
position p;
@@
 struct pic32_gpio_bank {  void __iomem * reg_base ;  struct gpio_chip gpio_chip ;  struct irq_chip irq_chip ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 const struct pic32_function cocci_id@p [ ] ;
...
position p;
@@
 struct pic32_pin_group {  const char * name ;  unsigned int pin ;  struct pic32_desc_function * functions ; } cocci_id@p ;
...
position p;
@@
 struct pic32_function {  const char * name ;  const char * const * groups ;  unsigned int ngroups ; } cocci_id@p ;
...
typedef u32;
@@
 struct pic32_desc_function {  const char * name ;  u32 muxreg ;  u32 muxval ; } cocci_id@p ;
