...
position p;
@@
 struct creg_completion * cocci_id@p ;
...
position p;
@@
 struct creg_cmd {  struct list_head list ;  creg_cmd_cb cb ;  void * cb_private ;  unsigned int op ;  unsigned int addr ;  int cnt8 ;  void * buf ;  unsigned int stream ;  unsigned int status ; } cocci_id@p ;
...
position p;
@@
 struct rsxx_reg_access * cocci_id@p ;
...
typedef u32;
@@
 struct creg_completion {  struct completion * cmd_done ;  int st ;  u32 creg_status ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct rsxx_cardinfo * card , struct creg_cmd * cmd , int st ) ;
