...
typedef u8;
@@
 struct max5481_data {  struct spi_device * spi ;  const struct max5481_cfg * cfg ;  u8 msg [ 3 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct max5481_data * cocci_id@p ;
...
position p;
@@
 struct max5481_cfg {  int kohms ; } cocci_id@p ;
...
position p;
@@
 enum max5481_variant { max5481 , max5482 , max5483 , max5484 , } cocci_id@p ;
...
position p;
@@
 const struct max5481_cfg cocci_id@p [ ] ;
