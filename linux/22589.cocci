...
position p;
@@
 struct dsp_asynch_fg_rx_scb cocci_id@p ;
...
position p;
@@
 struct dsp_mix_only_scb cocci_id@p ;
...
position p;
@@
 struct dsp_pcm_channel_descriptor * cocci_id@p ;
...
position p;
@@
 struct dsp_spio_write_scb cocci_id@p ;
...
position p;
@@
 struct dsp_codec_input_scb cocci_id@p ;
...
position p;
@@
 struct dsp_asynch_fg_tx_scb cocci_id@p ;
...
position p;
@@
 struct dsp_codec_output_scb cocci_id@p ;
...
position p;
@@
 struct proc_scb_info cocci_id@p ;
...
position p;
@@
 struct dsp_scb_descriptor * cocci_id@p ;
...
position p;
@@
 struct dsp_timing_master_scb cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ DSP_MAX_PCM_CHANNELS ] ;
...
position p;
@@
 char cocci_id@p [ DSP_MAX_SCB_NAME ] ;
...
position p;
@@
 struct dsp_vari_decimate_scb cocci_id@p ;
...
position p;
@@
 struct dsp_generic_scb cocci_id@p ;
...
position p;
@@
 struct dsp_pcm_serial_input_scb cocci_id@p ;
...
position p;
@@
 struct dsp_magic_snoop_task cocci_id@p ;
...
position p;
@@
 struct proc_scb_info {  struct dsp_scb_descriptor * scb_desc ;  struct snd_cs46xx * chip ; } cocci_id@p ;
...
position p;
@@
 struct dsp_src_task_scb cocci_id@p ;
...
position p;
@@
 struct dsp_mix2_ostream_scb cocci_id@p ;
