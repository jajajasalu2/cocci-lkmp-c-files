...
position p;
@@
 struct kvm_s390_ext_info cocci_id@p ;
...
position p;
@@
 struct kvm_s390_interrupt_info cocci_id@p ;
...
position p;
@@
 struct kvm_s390_gib * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_io_adapter cocci_id@p ;
...
position p;
@@
 struct kvm_s390_gisa * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_gisa_interrupt cocci_id@p ;
...
position p;
@@
 struct s390_map_info * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_prefix_info cocci_id@p ;
...
position p;
@@
 union bsca_sigp_ctrl * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_mchk_info * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_stop_info * cocci_id@p ;
...
position p;
@@
 struct s390_io_adapter * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_local_interrupt * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_io_info cocci_id@p ;
...
position p;
@@
 union esca_sigp_ctrl * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_ais_all cocci_id@p ;
...
position p;
@@
 struct kvm_s390_extcall_info * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_ais_req cocci_id@p ;
...
position p;
@@
 struct kvm_s390_adapter_int * cocci_id@p ;
...
position p;
@@
 struct kvm_s390_io_adapter_req cocci_id@p ;
...
position p;
@@
 struct kvm_s390_float_interrupt * cocci_id@p ;
