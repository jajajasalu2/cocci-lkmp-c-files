...
position p;
@@
 enum lm75_type { adt75 , ds1775 , ds75 , ds7505 , g751 , lm75 , lm75a , lm75b , max6625 , max6626 , max31725 , mcp980x , pct2075 , stds75 , stlm75 , tcn75 , tmp100 , tmp101 , tmp105 , tmp112 , tmp175 , tmp275 , tmp75 , tmp75b , tmp75c , } cocci_id@p ;
...
position p;
@@
 const struct lm75_params cocci_id@p [ ] ;
...
typedef u8;
@@
 struct lm75_params {  u8 set_mask ;  u8 clr_mask ;  u8 default_resolution ;  u8 resolution_limits ;  const u8 * resolutions ;  unsigned int default_sample_time ;  u8 num_sample_times ;  const unsigned int * sample_times ; } cocci_id@p ;
...
typedef u8;
@@
 struct lm75_data {  struct i2c_client * client ;  struct regmap * regmap ;  u8 orig_conf ;  u8 current_conf ;  u8 resolution ;  unsigned int sample_time ;  enum lm75_type kind ;  const struct lm75_params * params ; } cocci_id@p ;
...
position p;
@@
 const struct lm75_data * cocci_id@p ;
