...
position p;
@@
 enum helene_state { STATE_UNKNOWN , STATE_SLEEP , STATE_ACTIVE , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef helene_terr_adjust_param_t;
@@
 const struct helene_terr_adjust_param_t cocci_id@p [ SONY_HELENE_TERR_TV_SYSTEM_NUM ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_WRITE_REGSIZE ] ;
...
symbol cocci_id;
position p;
typedef uint8_t,helene_terr_adjust_param_t;
@@
 struct helene_terr_adjust_param_t {  uint8_t RF_GAIN ;  uint8_t IF_BPF_GC ;  uint8_t RFOVLD_DET_LV1_VL ;  uint8_t RFOVLD_DET_LV1_VH ;  uint8_t RFOVLD_DET_LV1_U ;  uint8_t IFOVLD_DET_LV_VL ;  uint8_t IFOVLD_DET_LV_VH ;  uint8_t IFOVLD_DET_LV_U ;  uint8_t IF_BPF_F0 ;  uint8_t BW ;  uint8_t FIF_OFFSET ;  uint8_t BW_OFFSET ;  uint8_t IS_LOWERLOCAL ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_WRITE_REGSIZE + 1 ] ;
...
position p;
@@
 struct helene_config * cocci_id@p ;
...
position p;
@@
 const struct helene_config * cocci_id@p ;
...
typedef helene_tv_system_t;
@@
 enum helene_tv_system_t cocci_id@p ;
