...
position p;
@@
 enum { V_ARMADA_7K = BIT ( 0 ) , V_ARMADA_8K_CPM = BIT ( 1 ) , V_ARMADA_8K_CPS = BIT ( 2 ) , V_CP115_STANDALONE = BIT ( 3 ) , V_ARMADA_7K_8K_CPM = ( V_ARMADA_7K | V_ARMADA_8K_CPM ) , V_ARMADA_7K_8K_CPS = ( V_ARMADA_7K | V_ARMADA_8K_CPS ) , } cocci_id@p ;
