...
position p;
@@
 struct samsung_pwm_clocksource {  void __iomem * base ;  void __iomem * source_reg ;  unsigned int irq [ SAMSUNG_PWM_NUM ] ;  struct samsung_pwm_variant variant ;  struct clk * timerclk ;  unsigned int event_id ;  unsigned int source_id ;  unsigned int tcnt_max ;  unsigned int tscaler_div ;  unsigned int tdiv ;  unsigned long clock_count_per_tick ; } cocci_id@p ;
...
position p;
@@
 struct samsung_pwm_clocksource cocci_id@p ;
