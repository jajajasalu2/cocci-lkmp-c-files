...
position p;
@@
 struct otpc_priv {  struct device * dev ;  void __iomem * base ;  const struct otpc_map * map ;  struct nvmem_config * config ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct otpc_map {  u32 otpc_row_size ;  u16 data_r_offset [ 4 ] ;  u16 data_w_offset [ 4 ] ; } cocci_id@p ;
