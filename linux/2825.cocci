...
position p;
@@
 struct acpi_debug_mem_block cocci_id@p ;
...
position p;
@@
 struct acpi_debug_mem_header cocci_id@p ;
...
position p;
@@
 union acpi_descriptor * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef acpi_status,u8,u32;
@@
 acpi_status cocci_id@p ( struct acpi_debug_mem_block * address , acpi_size size , u8 alloc_type , u32 component , const char * module , u32 line ) ;
...
position p;
@@
 struct acpi_common_descriptor cocci_id@p ;
...
@@
 acpi_status cocci_id@p ( struct acpi_debug_mem_block * address , u32 component , const char * module , u32 line ) ;
...
position p;
@@
 struct acpi_debug_mem_block * cocci_id@p ( struct acpi_debug_mem_block * allocation ) ;
