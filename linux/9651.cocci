...
position p;
@@
 struct b43legacy_hwtxstatus * cocci_id@p ;
...
position p;
@@
 struct b43legacy_dma * cocci_id@p ;
...
position p;
@@
 struct b43legacy_dmaring * cocci_id@p ;
...
position p;
@@
 struct b43legacy_rxhdr_fw3 * cocci_id@p ;
...
position p;
@@
 struct b43legacy_dmadesc32 * cocci_id@p ;
...
position p;
@@
 struct b43legacy_dmadesc_meta cocci_id@p ;
...
position p;
@@
 enum b43legacy_dmatype cocci_id@p ;
