...
position p;
@@
 struct brport_attribute {  struct attribute attr ;  ssize_t ( * show ) ( struct net_bridge_port * , char * ) ;  int ( * store ) ( struct net_bridge_port * , unsigned long ) ;  int ( * store_raw ) ( struct net_bridge_port * , char * ) ; } cocci_id@p ;
...
position p;
@@
 const struct brport_attribute * * cocci_id@p ;
...
position p;
@@
 struct brport_attribute cocci_id@p ;
