...
position p;
@@
 struct wcd_iir_filter_ctl {  unsigned int iir_idx ;  unsigned int band_idx ;  struct soc_bytes_ext bytes_ext ; } cocci_id@p ;
...
position p;
@@
 enum { IIR1 = 0 , IIR2 , IIR_MAX , } cocci_id@p ;
...
position p;
@@
 struct wcd_iir_filter_ctl * cocci_id@p ;
...
position p;
@@
 struct msm8916_wcd_digital_priv * cocci_id@p ;
...
position p;
@@
 enum { BAND1 = 0 , BAND2 , BAND3 , BAND4 , BAND5 , BAND_MAX , } cocci_id@p ;
