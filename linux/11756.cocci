...
position p;
@@
 const struct nvkm_therm_func * cocci_id@p ;
...
position p;
@@
 enum nvkm_therm_attr_type cocci_id@p ;
...
position p;
@@
 const struct nvkm_therm_clkgate_pack * cocci_id@p ;
...
position p;
@@
 struct nvbios_therm_trip_point * cocci_id@p ;
