...
position p;
@@
 struct drv2667_data * cocci_id@p ;
...
typedef u32;
@@
 struct drv2667_data {  struct input_dev * input_dev ;  struct i2c_client * client ;  struct regmap * regmap ;  struct work_struct work ;  struct regulator * regulator ;  u32 page ;  u32 magnitude ;  u32 frequency ; } cocci_id@p ;
