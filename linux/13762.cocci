...
position p;
@@
 struct saa7127_state * cocci_id@p ;
...
position p;
@@
 enum saa712x_model { SAA7127 , SAA7129 , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct saa7127_state {  struct v4l2_subdev sd ;  v4l2_std_id std ;  enum saa712x_model ident ;  enum saa7127_input_type input_type ;  enum saa7127_output_type output_type ;  int video_enable ;  int wss_enable ;  u16 wss_mode ;  int cc_enable ;  u16 cc_data ;  int xds_enable ;  u16 xds_data ;  int vps_enable ;  u8 vps_data [ 5 ] ;  u8 reg_2d ;  u8 reg_3a ;  u8 reg_3a_cb ;  u8 reg_61 ; } cocci_id@p ;
...
position p;
@@
 struct i2c_reg_value cocci_id@p [ ] ;
...
position p;
@@
 const struct v4l2_sliced_vbi_data * cocci_id@p ;
