...
position p;
@@
 struct core_rx_fast_path_cqe * cocci_id@p ;
...
position p;
@@
 struct core_rx_stop_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_ll2_buffer * cocci_id@p ;
...
position p;
@@
 struct qed_ll2_info cocci_id@p ;
...
position p;
@@
 struct core_ll2_port_stats cocci_id@p ;
...
@@
 struct qed_cb_ll2_info {  int rx_cnt ;  u32 rx_size ;  u8 handle ;  spinlock_t lock ;  struct list_head list ;  const struct qed_ll2_cb_ops * cbs ;  void * cb_cookie ; } cocci_id@p ;
...
position p;
@@
 struct core_ll2_pstorm_per_queue_stat cocci_id@p ;
...
position p;
@@
 struct core_rx_bd_with_buff_len * cocci_id@p ;
...
position p;
@@
 union core_rx_cqe_union * cocci_id@p ;
...
position p;
@@
 struct qed_ll2_stats * cocci_id@p ;
...
position p;
@@
 const struct qed_ll2_cb_ops * cocci_id@p ;
...
position p;
@@
 struct core_ll2_tstorm_per_queue_stat cocci_id@p ;
...
position p;
@@
 struct qed_ll2_rx_packet * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct qed_ll2_buffer {  struct list_head list ;  void * data ;  dma_addr_t phys_addr ; } cocci_id@p ;
...
position p;
@@
 struct qed_ll2_tx_queue * cocci_id@p ;
...
position p;
@@
 struct core_tx_start_ramrod_data * cocci_id@p ;
...
position p;
@@
 enum qed_ll2_conn_type cocci_id@p ;
...
position p;
@@
 struct qed_ll2_tx_packet * cocci_id@p ;
...
position p;
@@
 struct core_ll2_rx_prod cocci_id@p ;
...
position p;
@@
 struct core_rx_start_ramrod_data * cocci_id@p ;
...
position p;
@@
 enum qed_ll2_error_handle cocci_id@p ;
...
position p;
@@
 struct core_rx_slow_path_cqe * cocci_id@p ;
...
position p;
@@
 const struct qed_ll2_cbs * cocci_id@p ;
...
position p;
@@
 struct qed_ll2_params * cocci_id@p ;
...
position p;
@@
 enum core_roce_flavor_type cocci_id@p ;
...
position p;
@@
 struct qed_ooo_buffer * cocci_id@p ;
...
position p;
@@
 struct core_ll2_ustorm_per_queue_stat cocci_id@p ;
...
position p;
@@
 struct qed_ll2_rx_queue * cocci_id@p ;
...
position p;
@@
 enum core_error_handle cocci_id@p ;
...
position p;
@@
 const struct qed_ll2_ops cocci_id@p ;
