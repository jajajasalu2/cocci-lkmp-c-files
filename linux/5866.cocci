...
position p;
@@
 struct rk805_pctrl_info {  struct rk808 * rk808 ;  struct device * dev ;  struct pinctrl_dev * pctl ;  struct gpio_chip gpio_chip ;  struct pinctrl_desc pinctrl_desc ;  const struct rk805_pin_function * functions ;  unsigned int num_functions ;  const struct rk805_pin_group * groups ;  int num_pin_groups ;  const struct pinctrl_pin_desc * pins ;  unsigned int num_pins ;  struct rk805_pin_config * pin_cfg ; } cocci_id@p ;
...
position p;
@@
 struct rk805_pin_group {  const char * name ;  const unsigned int pins [ 1 ] ;  unsigned int npins ; } cocci_id@p ;
...
position p;
@@
 const struct rk805_pin_function cocci_id@p [ ] ;
...
position p;
@@
 struct rk805_pin_function {  const char * name ;  const char * const * groups ;  unsigned int ngroups ;  int mux_option ; } cocci_id@p ;
...
position p;
@@
 struct rk805_pctrl_info * cocci_id@p ;
...
position p;
@@
 const struct rk805_pin_group cocci_id@p [ ] ;
...
position p;
@@
 struct rk805_pin_config cocci_id@p [ ] ;
...
typedef u8;
@@
 struct rk805_pin_config {  u8 reg ;  u8 fun_msk ;  u8 dir_msk ;  u8 val_msk ; } cocci_id@p ;
...
position p;
@@
 enum { RK805_GPIO0 , RK805_GPIO1 , } cocci_id@p ;
...
position p;
@@
 enum rk805_pinmux_option { RK805_PINMUX_GPIO , } cocci_id@p ;
