...
position p;
@@
 struct iwl_rx_phy_info * cocci_id@p ;
...
position p;
@@
 struct iwl_notif_statistics_v11 * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_stat_data cocci_id@p ;
...
position p;
@@
 struct mvm_statistics_general_v8 * cocci_id@p ;
...
position p;
@@
 struct mvm_statistics_general * cocci_id@p ;
...
position p;
@@
 struct iwl_ba_window_status_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_notif_statistics_v10 cocci_id@p ;
...
typedef __le32,u8;
@@
 struct iwl_mvm_stat_data {  struct iwl_mvm * mvm ;  __le32 mac_id ;  u8 beacon_filter_average_energy ;  void * general ; } cocci_id@p ;
