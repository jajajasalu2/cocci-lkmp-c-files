...
position p;
@@
 const struct tegra_ahci_soc cocci_id@p ;
...
position p;
@@
 struct tegra_ahci_priv * cocci_id@p ;
...
position p;
@@
 const struct tegra_ahci_ops cocci_id@p ;
...
typedef u8;
@@
 struct sata_pad_calibration {  u8 gen1_tx_amp ;  u8 gen1_tx_peak ;  u8 gen2_tx_amp ;  u8 gen2_tx_peak ; } cocci_id@p ;
...
position p;
@@
 struct sata_pad_calibration cocci_id@p ;
...
position p;
@@
 struct tegra_ahci_priv {  struct platform_device * pdev ;  void __iomem * sata_regs ;  void __iomem * sata_aux_regs ;  struct reset_control * sata_rst ;  struct reset_control * sata_oob_rst ;  struct reset_control * sata_cold_rst ;  struct clk * sata_clk ;  struct regulator_bulk_data * supplies ;  const struct tegra_ahci_soc * soc ; } cocci_id@p ;
...
position p;
@@
 const struct sata_pad_calibration cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_ahci_ops {  int ( * init ) ( struct ahci_host_priv * hpriv ) ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct tegra_ahci_soc {  const char * const * supply_names ;  u32 num_supplies ;  bool supports_devslp ;  const struct tegra_ahci_ops * ops ; } cocci_id@p ;
