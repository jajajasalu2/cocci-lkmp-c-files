...
position p;
@@
 struct mdp_ipi_comm cocci_id@p ;
...
position p;
@@
 struct mdp_process_vsi * cocci_id@p ;
...
position p;
@@
 struct mdp_ipi_init cocci_id@p ;
...
position p;
@@
 struct mdp_ipi_comm_ack * cocci_id@p ;
