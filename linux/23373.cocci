...
position p;
@@
 const char * const cocci_id@p [ TSCS42XX_PLL_SRC_CNT ] ;
...
typedef u8,bool;
@@
 struct tscs42xx {  int bclk_ratio ;  int samplerate ;  struct mutex audio_params_lock ;  u8 coeff_ram [ COEFF_RAM_SIZE ] ;  bool coeff_ram_synced ;  struct mutex coeff_ram_lock ;  struct mutex pll_lock ;  struct regmap * regmap ;  struct clk * sysclk ;  int sysclk_src_id ; } cocci_id@p ;
...
position p;
@@
 struct pll_ctl {  int input_freq ;  struct reg_setting settings [ PLL_REG_SETTINGS_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct reg_setting {  unsigned int addr ;  unsigned int val ;  unsigned int mask ; } cocci_id@p ;
