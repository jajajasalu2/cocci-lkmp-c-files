...
typedef u8,u16;
@@
 struct regval_list {  u16 addr ;  u8 data ; } cocci_id@p ;
...
position p;
@@
 struct ov5647 {  struct v4l2_subdev sd ;  struct media_pad pad ;  struct mutex lock ;  struct v4l2_mbus_framefmt format ;  unsigned int width ;  unsigned int height ;  int power_count ;  struct clk * xclk ; } cocci_id@p ;
