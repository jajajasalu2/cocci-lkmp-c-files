...
position p;
@@
 struct pwm_regulator_data * cocci_id@p ;
...
position p;
@@
 struct pwm_regulator_data {  struct pwm_device * pwm ;  struct pwm_voltages * duty_cycle_table ;  struct pwm_continuous_reg_data continuous ;  struct regulator_desc desc ;  int state ;  struct gpio_desc * enb_gpio ; } cocci_id@p ;
...
position p;
@@
 struct pwm_continuous_reg_data {  unsigned int min_uV_dutycycle ;  unsigned int max_uV_dutycycle ;  unsigned int dutycycle_unit ; } cocci_id@p ;
...
position p;
@@
 struct pwm_voltages * cocci_id@p ;
...
position p;
@@
 struct pwm_voltages {  unsigned int uV ;  unsigned int dutycycle ; } cocci_id@p ;
