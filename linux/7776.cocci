...
typedef u8;
@@
 struct sc16is7xx_one {  struct uart_port port ;  u8 line ;  struct kthread_work tx_work ;  struct kthread_work reg_work ;  struct sc16is7xx_one_config config ; } cocci_id@p ;
...
position p;
@@
 struct sc16is7xx_one cocci_id@p ;
...
position p;
@@
 struct sc16is7xx_port * cocci_id@p ;
...
position p;
@@
 const struct sc16is7xx_devtype cocci_id@p ;
...
position p;
@@
 struct sc16is7xx_devtype * cocci_id@p ;
...
position p;
@@
 struct sc16is7xx_one_config cocci_id@p ;
...
position p;
@@
 struct sc16is7xx_devtype {  char name [ 10 ] ;  int nr_gpio ;  int nr_uart ; } cocci_id@p ;
...
typedef u8;
@@
 struct sc16is7xx_one_config {  unsigned int flags ;  u8 ier_clear ; } cocci_id@p ;
