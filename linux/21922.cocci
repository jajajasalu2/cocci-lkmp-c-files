...
typedef u8,__le64;
@@
 union {  u8 block0 [ POLY1305_KEY_SIZE ] ;  u8 mac [ POLY1305_DIGEST_SIZE ] ;  __le64 lens [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct poly1305_desc_ctx cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ CHACHA20POLY1305_KEY_SIZE ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ CHACHA_KEY_WORDS ] ;
...
typedef u8,__le64;
@@
 union {  u8 block0 [ POLY1305_KEY_SIZE ] ;  __le64 lens [ 2 ] ; } cocci_id@p ;
...
@@
 union {  struct {  u32 k [ CHACHA_KEY_WORDS ] ;  __le64 iv [ 2 ] ; } ;  u8 block0 [ POLY1305_KEY_SIZE ] ;  u8 chacha_stream [ CHACHA_BLOCK_SIZE ] ;  struct {  u8 mac [ 2 ] [ POLY1305_DIGEST_SIZE ] ; } ;  __le64 lens [ 2 ] ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ XCHACHA20POLY1305_NONCE_SIZE ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ CHACHA_STATE_WORDS ] ;
