...
typedef u8;
@@
 struct grgpio_uirq {  u8 refcnt ;  u8 uirq ; } cocci_id@p ;
...
typedef s8,u8;
@@
 struct grgpio_lirq {  s8 index ;  u8 irq ; } cocci_id@p ;
...
typedef u32;
@@
 struct grgpio_priv {  struct gpio_chip gc ;  void __iomem * regs ;  struct device * dev ;  u32 imask ;  struct irq_domain * domain ;  struct grgpio_uirq uirqs [ GRGPIO_MAX_NGPIO ] ;  struct grgpio_lirq lirqs [ GRGPIO_MAX_NGPIO ] ; } cocci_id@p ;
