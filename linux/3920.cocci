...
position p;
@@
 struct gb_svc_watchdog cocci_id@p ;
...
typedef bool;
@@
 struct gb_svc_watchdog {  struct delayed_work work ;  struct gb_svc * svc ;  bool enabled ;  struct notifier_block pm_notifier ; } cocci_id@p ;
