...
typedef bool;
@@
 struct fw_sysfs {  bool nowait ;  struct device dev ;  struct fw_priv * fw_priv ;  struct firmware * fw ; } cocci_id@p ;
...
position p;
@@
 struct firmware_fallback_config cocci_id@p ;
