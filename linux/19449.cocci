...
position p;
@@
 struct ar71xx_pci_controller cocci_id@p ;
...
position p;
@@
 struct ar71xx_pci_controller {  void __iomem * cfg_base ;  int irq ;  int irq_base ;  struct pci_controller pci_ctrl ;  struct resource io_res ;  struct resource mem_res ; } cocci_id@p ;
