...
position p;
@@
 void cocci_id@p ( struct bio_post_read_ctx * ctx ) ;
...
position p;
@@
 struct bio_post_read_ctx * cocci_id@p ;
...
position p;
@@
 struct bio_post_read_ctx {  struct bio * bio ;  struct work_struct work ;  unsigned int cur_step ;  unsigned int enabled_steps ; } cocci_id@p ;
...
position p;
@@
 struct f2fs_io_info * cocci_id@p ;
...
position p;
@@
 enum bio_post_read_step { STEP_INITIAL = 0 , STEP_DECRYPT , STEP_VERITY , } cocci_id@p ;
...
position p;
@@
 struct f2fs_sb_info * cocci_id@p ;
...
position p;
@@
 struct dnode_of_data * cocci_id@p ;
...
position p;
@@
 struct f2fs_map_blocks cocci_id@p ;
...
position p;
@@
 struct f2fs_private_dio * cocci_id@p ;
...
position p;
@@
 struct f2fs_bio_info * cocci_id@p ;
...
position p;
@@
 struct f2fs_summary cocci_id@p ;
...
position p;
@@
 struct f2fs_inode_info * cocci_id@p ;
