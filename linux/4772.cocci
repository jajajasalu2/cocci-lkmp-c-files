...
position p;
@@
 struct ipoib_walk_data {  const struct sockaddr * addr ;  struct net_device * result ; } cocci_id@p ;
...
position p;
@@
 struct ipoib_dev_priv cocci_id@p ;
...
position p;
@@
 struct ipoib_neigh_hash * cocci_id@p ;
...
position p;
@@
 struct ipoib_walk_data * cocci_id@p ;
...
position p;
@@
 struct ipoib_path_iter {  struct net_device * dev ;  struct ipoib_path path ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct net_device * cocci_id@p ( struct ib_device * dev , u8 port , u16 pkey , const union ib_gid * gid , const struct sockaddr * addr , void * client_data ) ;
...
position p;
@@
 struct ipoib_neigh_table * cocci_id@p ;
...
position p;
@@
 struct ipoib_path_iter * cocci_id@p ;
...
position p;
@@
 struct ipoib_pseudo_header * cocci_id@p ;
...
position p;
@@
 struct ipoib_header * cocci_id@p ;
