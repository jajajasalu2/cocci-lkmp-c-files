...
position p;
@@
 struct streebog_uint512 * cocci_id@p ;
...
position p;
@@
 const struct streebog_uint512 cocci_id@p [ 12 ] ;
...
position p;
@@
 struct streebog_state cocci_id@p ;
...
position p;
@@
 const unsigned long long cocci_id@p [ 8 ] [ 256 ] ;
...
position p;
@@
 const struct streebog_uint512 * cocci_id@p ;
