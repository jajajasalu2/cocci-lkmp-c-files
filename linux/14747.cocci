...
position p;
@@
 struct g12a_sys_pll_nb_data * cocci_id@p ;
...
position p;
@@
 struct clk_regmap * const cocci_id@p [ ] ;
...
position p;
@@
 const struct pll_params_table cocci_id@p [ ] ;
...
position p;
@@
 struct g12a_sys_pll_nb_data {  struct notifier_block nb ;  struct clk_hw * sys_pll ;  struct clk_hw * cpu_clk ;  struct clk_hw * cpu_clk_dyn ; } cocci_id@p ;
...
position p;
@@
 struct meson_g12a_data {  const struct meson_eeclkc_data eeclkc_data ;  int ( * dvfs_setup ) ( struct platform_device * pdev ) ; } cocci_id@p ;
...
position p;
@@
 struct g12a_cpu_clk_postmux_nb_data {  struct notifier_block nb ;  struct clk_hw * xtal ;  struct clk_hw * cpu_clk_dyn ;  struct clk_hw * cpu_clk_postmux0 ;  struct clk_hw * cpu_clk_postmux1 ;  struct clk_hw * cpu_clk_premux1 ; } cocci_id@p ;
...
position p;
@@
 struct meson_clk_cpu_dyndiv_data cocci_id@p ;
...
position p;
@@
 const struct clk_parent_data cocci_id@p [ ] ;
...
position p;
@@
 struct meson_clk_pll_data cocci_id@p ;
...
position p;
@@
 struct clk_regmap_mux_data cocci_id@p ;
...
position p;
@@
 const struct meson_eeclkc_data * cocci_id@p ;
...
position p;
@@
 struct meson_clk_mpll_data cocci_id@p ;
...
position p;
@@
 struct g12a_cpu_clk_postmux_nb_data cocci_id@p ;
...
position p;
@@
 const struct meson_g12a_data * cocci_id@p ;
...
position p;
@@
 struct clk_regmap_div_data cocci_id@p ;
...
position p;
@@
 const struct pll_mult_range cocci_id@p ;
...
position p;
@@
 struct clk_fixed_factor cocci_id@p ;
...
position p;
@@
 struct meson_vid_pll_div_data cocci_id@p ;
...
position p;
@@
 struct meson_g12a_data cocci_id@p ;
...
position p;
@@
 struct clk_regmap_gate_data cocci_id@p ;
...
position p;
@@
 const struct clk_hw * cocci_id@p [ ] ;
