...
position p;
@@
 enum pipe3_mode { PIPE3_MODE_PCIE = 1 , PIPE3_MODE_SATA , PIPE3_MODE_USBSS , } cocci_id@p ;
...
position p;
@@
 struct pipe3_dpll_params * cocci_id@p ;
...
typedef u8;
@@
 struct pipe3_settings {  u8 ana_interface ;  u8 ana_losd ;  u8 dig_fastlock ;  u8 dig_lbw ;  u8 dig_stepcnt ;  u8 dig_stl ;  u8 dig_thr ;  u8 dig_thr_mode ;  u8 dig_2ndo_sdm_mode ;  u8 dig_hs_rate ;  u8 dig_ovrd_hs_rate ;  u8 dll_trim_sel ;  u8 dll_phint_rate ;  u8 eq_lev ;  u8 eq_ftc ;  u8 eq_ctl ;  u8 eq_ovrd_lev ;  u8 eq_ovrd_ftc ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct pipe3_dpll_params {  u16 m ;  u8 n ;  u8 freq : 3 ;  u8 sd ;  u32 mf ; } cocci_id@p ;
...
position p;
@@
 struct pipe3_data {  enum pipe3_mode mode ;  struct pipe3_dpll_map * dpll_map ;  struct pipe3_settings settings ; } cocci_id@p ;
...
position p;
@@
 struct pipe3_dpll_map * cocci_id@p ;
...
typedef bool;
@@
 struct ti_pipe3 {  void __iomem * pll_ctrl_base ;  void __iomem * phy_rx ;  void __iomem * phy_tx ;  struct device * dev ;  struct device * control_dev ;  struct clk * wkupclk ;  struct clk * sys_clk ;  struct clk * refclk ;  struct clk * div_clk ;  struct pipe3_dpll_map * dpll_map ;  struct regmap * phy_power_syscon ;  struct regmap * pcs_syscon ;  struct regmap * dpll_reset_syscon ;  unsigned int dpll_reset_reg ;  unsigned int power_reg ;  unsigned int pcie_pcs_reg ;  bool sata_refclk_enabled ;  enum pipe3_mode mode ;  struct pipe3_settings settings ; } cocci_id@p ;
...
position p;
@@
 struct pipe3_settings * cocci_id@p ;
...
position p;
@@
 struct pipe3_dpll_map {  unsigned long rate ;  struct pipe3_dpll_params params ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ti_pipe3 * phy ) ;
...
position p;
@@
 void cocci_id@p ( struct ti_pipe3 * phy ) ;
