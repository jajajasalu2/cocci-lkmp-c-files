...
position p;
@@
 enum sirf_spi_type { SIRF_REAL_SPI , SIRF_USP_SPI_P2 , SIRF_USP_SPI_A7 , } cocci_id@p ;
...
position p;
@@
 struct sirf_spi_comp_data {  const struct sirf_spi_register * regs ;  enum sirf_spi_type type ;  unsigned int dat_max_frm_len ;  unsigned int fifo_size ;  void ( * hwinit ) ( struct sirfsoc_spi * sspi ) ; } cocci_id@p ;
...
position p;
@@
 const struct sirf_spi_register cocci_id@p ;
...
position p;
@@
 const struct sirf_spi_comp_data cocci_id@p ;
...
@@
 struct sirfsoc_spi {  struct spi_bitbang bitbang ;  struct completion rx_done ;  struct completion tx_done ;  void __iomem * base ;  u32 ctrl_freq ;  struct clk * clk ;  const void * tx ;  void * rx ;  void ( * rx_word ) ( struct sirfsoc_spi * ) ;  void ( * tx_word ) ( struct sirfsoc_spi * ) ;  unsigned int left_tx_word ;  unsigned int left_rx_word ;  struct dma_chan * rx_chan ;  struct dma_chan * tx_chan ;  dma_addr_t src_start ;  dma_addr_t dst_start ;  int word_width ;  bool tx_by_cmd ;  bool hw_cs ;  enum sirf_spi_type type ;  const struct sirf_spi_register * regs ;  unsigned int fifo_size ;  unsigned int fifo_full_offset ;  unsigned int fifo_level_chk_mask ;  unsigned int dat_max_frm_len ; } cocci_id@p ;
