...
position p;
@@
 struct wl1271_tx_hw_res_if cocci_id@p ;
...
position p;
@@
 enum wlcore_queue_stop_reason cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ BITS_TO_LONGS ( WLCORE_MAX_LINKS ) ] ;
...
position p;
@@
 struct wl1271_tx_hw_res_descr * cocci_id@p ;
