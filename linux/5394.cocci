...
position p;
@@
 const struct optee_msg_param * cocci_id@p ;
...
position p;
@@
 union {  struct arm_smccc_res smccc ;  struct optee_smc_calls_revision_result result ; } cocci_id@p ;
...
position p;
@@
 union {  struct arm_smccc_res smccc ;  struct optee_smc_get_shm_config_result result ; } cocci_id@p ;
...
position p;
@@
 const struct tee_param * cocci_id@p ;
...
position p;
@@
 struct optee_context_data * cocci_id@p ;
...
position p;
@@
 struct optee_msg_arg * cocci_id@p ;
...
position p;
@@
 struct optee_session * cocci_id@p ;
...
position p;
@@
 struct optee_msg_param * cocci_id@p ;
...
position p;
@@
 union {  struct arm_smccc_res smccc ;  struct optee_smc_exchange_capabilities_result result ; } cocci_id@p ;
...
position p;
@@
 const struct tee_driver_ops cocci_id@p ;
...
position p;
@@
 struct tee_shm_pool_mgr * cocci_id@p ;
...
position p;
@@
 union {  struct arm_smccc_res smccc ;  struct optee_smc_call_get_os_revision_result result ; } cocci_id@p ;
