...
position p;
@@
 struct default_adjustment cocci_id@p ;
...
position p;
@@
 struct ipp_prescale_params cocci_id@p ;
...
position p;
@@
 struct audio_output * cocci_id@p ;
...
position p;
@@
 struct out_csc_color_matrix cocci_id@p ;
...
position p;
@@
 struct compr_addr_and_pitch_params cocci_id@p ;
...
position p;
@@
 struct xfm_grph_csc_adjustment cocci_id@p ;
...
position p;
@@
 struct dce_watermarks cocci_id@p ;
...
position p;
@@
 const struct dce110_hw_seq_reg_offsets cocci_id@p [ ] ;
...
position p;
@@
 enum audio_dto_source cocci_id@p ;
...
position p;
@@
 struct pwl_result_data * cocci_id@p ;
...
position p;
@@
 struct dcp_gsl_params cocci_id@p ;
...
position p;
@@
 struct curve_points * cocci_id@p ;
...
position p;
@@
 const struct fixed31_32 cocci_id@p ;
...
typedef uint32_t;
@@
 struct dce110_hw_seq_reg_offsets {  uint32_t crtc ; } cocci_id@p ;
