...
position p;
@@
 enum { ptr_explicit , ptr_ext4_sb_info_offset , ptr_ext4_super_block_offset , } cocci_id@p ;
...
position p;
@@
 struct ext4_attr {  struct attribute attr ;  short attr_id ;  short attr_ptr ;  union {  int offset ;  void * explicit_ptr ; } u ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct kobject * ) ;
