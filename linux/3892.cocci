...
position p;
@@
 int ( * cocci_id@p ) ( struct ssb_bus * bus , struct ssb_sprom * out ) ;
...
typedef u16;
@@
 int ( * cocci_id@p ) ( struct ssb_bus * bus , u16 * sprom ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ssb_bus * dev , struct ssb_sprom * out ) ;
...
typedef u16;
@@
 int ( * cocci_id@p ) ( struct ssb_bus * bus , const u16 * sprom ) ;
