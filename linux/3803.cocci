...
typedef u8;
@@
 int cocci_id@p ( struct atmel_sha_dev * dd , const u8 * key , unsigned int keylen ) ;
...
symbol cocci_id;
position p;
typedef atmel_sha_fn_t;
@@
 atmel_sha_fn_t cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct atmel_sha_dev * ) ;
...
typedef atmel_sha_fn_t;
@@
 struct atmel_sha_ctx {  struct atmel_sha_dev * dd ;  atmel_sha_fn_t start ;  unsigned long flags ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct atmel_sha_hmac_key {  bool valid ;  unsigned int keylen ;  u8 buffer [ SHA512_BLOCK_SIZE ] ;  u8 * keydup ; } cocci_id@p ;
...
position p;
@@
 struct atmel_sha_dev * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,atmel_aes_authenc_fn_t;
@@
 struct atmel_sha_authenc_reqctx {  struct atmel_sha_reqctx base ;  atmel_aes_authenc_fn_t cb ;  struct atmel_aes_dev * aes_dev ;  struct scatterlist * assoc ;  u32 assoclen ;  u32 textlen ;  u32 * digest ;  unsigned int digestlen ; } cocci_id@p ;
...
position p;
@@
 struct atmel_sha_authenc_reqctx cocci_id@p ;
...
position p;
@@
 struct atmel_sha_authenc_ctx * cocci_id@p ;
...
position p;
@@
 const struct atmel_sha_hmac_key * cocci_id@p ;
...
position p;
@@
 struct atmel_sha_ctx cocci_id@p ;
...
position p;
@@
 const struct atmel_sha_reqctx * cocci_id@p ;
...
position p;
@@
 struct atmel_sha_hmac_key * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef atmel_aes_authenc_fn_t;
@@
 atmel_aes_authenc_fn_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct atmel_sha_dev * dd ) ;
...
typedef spinlock_t;
@@
 struct atmel_sha_drv {  struct list_head dev_list ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct atmel_sha_authenc_ctx {  struct crypto_ahash * tfm ; } cocci_id@p ;
...
position p;
@@
 struct atmel_sha_reqctx * cocci_id@p ;
...
position p;
@@
 struct atmel_sha_hmac_ctx cocci_id@p ;
...
position p;
@@
 struct atmel_sha_dma * cocci_id@p ;
...
position p;
@@
 struct atmel_sha_dma {  struct dma_chan * chan ;  struct dma_slave_config dma_conf ;  struct scatterlist * sg ;  int nents ;  unsigned int last_sg_length ; } cocci_id@p ;
...
position p;
@@
 struct atmel_sha_drv cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,atmel_sha_fn_t;
@@
 struct atmel_sha_hmac_ctx {  struct atmel_sha_ctx base ;  struct atmel_sha_hmac_key hkey ;  u32 ipad [ SHA512_BLOCK_SIZE / sizeof ( u32 ) ] ;  u32 opad [ SHA512_BLOCK_SIZE / sizeof ( u32 ) ] ;  atmel_sha_fn_t resume ; } cocci_id@p ;
...
typedef bool;
@@
 struct atmel_sha_caps {  bool has_dma ;  bool has_dualbuff ;  bool has_sha224 ;  bool has_sha_384_512 ;  bool has_uihv ;  bool has_hmac ; } cocci_id@p ;
