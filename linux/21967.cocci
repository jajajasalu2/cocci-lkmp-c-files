...
position p;
@@
 struct test_parman_item * * cocci_id@p ;
...
position p;
@@
 struct test_parman_prio * cocci_id@p ;
...
typedef bool;
@@
 struct test_parman_item {  struct parman_item parman_item ;  struct test_parman_prio * prio ;  bool used ; } cocci_id@p ;
...
position p;
@@
 struct test_parman_prio {  struct parman_prio parman_prio ;  unsigned long priority ; } cocci_id@p ;
