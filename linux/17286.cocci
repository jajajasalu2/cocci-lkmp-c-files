...
position p;
@@
 struct cpm_idle_mode {  unsigned int enabled ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct cpm_idle_mode cocci_id@p [ ] ;
...
typedef dcr_host_t;
@@
 struct cpm {  dcr_host_t dcr_host ;  unsigned int dcr_offset [ 3 ] ;  unsigned int powersave_off ;  unsigned int unused ;  unsigned int idle_doze ;  unsigned int standby ;  unsigned int suspend ; } cocci_id@p ;
