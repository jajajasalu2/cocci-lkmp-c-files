...
position p;
@@
 union hv_x64_msr_hypercall_contents cocci_id@p ;
...
position p;
@@
 struct hv_tsc_emulation_status cocci_id@p ;
...
position p;
@@
 struct hv_reenlightenment_control cocci_id@p ;
...
position p;
@@
 struct hv_tsc_emulation_control cocci_id@p ;
