...
typedef u32;
@@
 struct mipi_csis_event {  u32 mask ;  const char * const name ;  unsigned int counter ; } cocci_id@p ;
...
typedef u8;
@@
 struct csis_hw_reset {  struct regmap * src ;  u8 req_src ;  u8 rst_bit ; } cocci_id@p ;
...
position p;
@@
 const struct mipi_csis_event cocci_id@p [ ] ;
...
typedef u32;
@@
 const struct {  u32 offset ;  const char * const name ; } cocci_id@p [ ] ;
