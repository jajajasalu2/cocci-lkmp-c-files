...
position p;
@@
 const enum snd_soc_bias_level cocci_id@p ;
...
position p;
@@
 union cx2072x_reg_i2spcm_ctrl_reg6 cocci_id@p ;
...
position p;
@@
 struct cx2072x_priv cocci_id@p ;
...
position p;
@@
 struct acpi_device_id cocci_id@p [ ] ;
...
position p;
@@
 union cx2072x_reg_i2spcm_ctrl_reg2 cocci_id@p ;
...
position p;
@@
 union cx2072x_reg_i2spcm_ctrl_reg1 cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ 2 + CX2072X_MAX_EQ_COEFF ] ;
...
position p;
@@
 const struct {  unsigned int mclk ;  unsigned int div ; } cocci_id@p [ ] ;
...
position p;
@@
 union cx2072x_reg_digital_bios_test2 cocci_id@p ;
...
position p;
@@
 const struct snd_soc_jack_gpio cocci_id@p ;
...
typedef u8;
@@
 struct cx2072x_eq_ctrl {  u8 ch ;  u8 band ; } cocci_id@p ;
...
position p;
@@
 union cx2072x_reg_i2spcm_ctrl_reg3 cocci_id@p ;
...
position p;
@@
 struct snd_soc_dai_ops cocci_id@p ;
...
position p;
@@
 union cx2072x_reg_i2spcm_ctrl_reg4 cocci_id@p ;
...
position p;
@@
 union cx2072x_reg_i2spcm_ctrl_reg5 cocci_id@p ;
