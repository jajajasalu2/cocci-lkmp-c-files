...
position p;
@@
 void ( * cocci_id@p ) ( struct snd_opl4 * opl4 , struct opl4_voice * voice ) ;
...
position p;
@@
 const struct opl4_region_ptr * cocci_id@p ;
...
position p;
@@
 const struct opl4_sound * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct opl4_voice * cocci_id@p [ 2 ] ;
