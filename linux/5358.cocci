...
position p;
@@
 struct for_each_memory_block_cb_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef walk_memory_blocks_func_t;
@@
 struct for_each_memory_block_cb_data {  walk_memory_blocks_func_t func ;  void * arg ; } cocci_id@p ;
...
typedef walk_memory_blocks_func_t;
@@
 walk_memory_blocks_func_t cocci_id@p ;
