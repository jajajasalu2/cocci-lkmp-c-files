...
typedef u32;
@@
 struct atmel_qspi {  void __iomem * regs ;  void __iomem * mem ;  struct clk * pclk ;  struct clk * qspick ;  struct platform_device * pdev ;  const struct atmel_qspi_caps * caps ;  u32 pending ;  u32 mr ;  u32 scr ;  struct completion cmd_completion ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_qspi_mode * cocci_id@p ;
...
typedef u8,u32;
@@
 struct atmel_qspi_mode {  u8 cmd_buswidth ;  u8 addr_buswidth ;  u8 data_buswidth ;  u32 config ; } cocci_id@p ;
...
typedef bool;
@@
 struct atmel_qspi_caps {  bool has_qspick ;  bool has_ricr ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_qspi_caps cocci_id@p ;
