...
position p;
@@
 const struct tw9910_scale_ctrl cocci_id@p [ ] ;
...
position p;
@@
 struct tw9910_video_info * cocci_id@p ;
...
typedef u16;
@@
 struct tw9910_scale_ctrl {  char * name ;  unsigned short width ;  unsigned short height ;  u16 hscale ;  u16 vscale ; } cocci_id@p ;
...
typedef u32;
@@
 struct tw9910_priv {  struct v4l2_subdev subdev ;  struct clk * clk ;  struct tw9910_video_info * info ;  struct gpio_desc * pdn_gpio ;  struct gpio_desc * rstb_gpio ;  const struct tw9910_scale_ctrl * scale ;  v4l2_std_id norm ;  u32 revision ; } cocci_id@p ;
