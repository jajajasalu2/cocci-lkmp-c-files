...
position p;
@@
 struct adv7511_link_config * cocci_id@p ;
...
position p;
@@
 const struct adv7511_link_config * cocci_id@p ;
...
position p;
@@
 enum adv7511_sync_polarity cocci_id@p ;
...
position p;
@@
 struct adv7511_video_config cocci_id@p ;
