...
position p;
@@
 struct conn_timeout cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct iscsi_conn * , struct iscsi_login * ) ;
...
position p;
@@
 struct conn_timeout {  struct timer_list timer ;  struct iscsi_conn * conn ; } cocci_id@p ;
