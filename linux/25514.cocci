...
position p;
@@
 char cocci_id@p [ MAX_HEADER_NAME ] ;
...
position p;
@@
 struct diff_hpp_fmt cocci_id@p ;
...
position p;
@@
 struct data__file {  struct perf_session * session ;  struct perf_data data ;  int idx ;  struct hists * hists ;  struct diff_hpp_fmt fmt [ PERF_HPP_DIFF__MAX_INDEX ] ; } cocci_id@p ;
...
position p;
@@
 struct diff_hpp_fmt {  struct perf_hpp_fmt fmt ;  int idx ;  char * header ;  int header_width ; } cocci_id@p ;
...
position p;
@@
 enum { COMPUTE_DELTA , COMPUTE_RATIO , COMPUTE_WEIGHTED_DIFF , COMPUTE_DELTA_ABS , COMPUTE_CYCLES , COMPUTE_MAX , } cocci_id@p ;
...
typedef bool;
@@
 struct perf_diff {  struct perf_tool tool ;  const char * time_str ;  struct perf_time_interval * ptime_range ;  int range_size ;  int range_num ;  bool has_br_stack ; } cocci_id@p ;
...
position p;
@@
 struct header_column {  const char * name ;  int width ; } cocci_id@p [ PERF_HPP_DIFF__MAX_INDEX ] ;
...
position p;
@@
 const char * cocci_id@p [ COMPUTE_MAX ] ;
...
position p;
@@
 enum { PERF_HPP_DIFF__BASELINE , PERF_HPP_DIFF__PERIOD , PERF_HPP_DIFF__PERIOD_BASELINE , PERF_HPP_DIFF__DELTA , PERF_HPP_DIFF__RATIO , PERF_HPP_DIFF__WEIGHTED_DIFF , PERF_HPP_DIFF__FORMULA , PERF_HPP_DIFF__DELTA_ABS , PERF_HPP_DIFF__CYCLES , PERF_HPP_DIFF__CYCLES_HIST , PERF_HPP_DIFF__MAX_INDEX , } cocci_id@p ;
