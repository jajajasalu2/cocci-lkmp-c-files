...
position p;
@@
 struct da9052_regulator {  struct da9052 * da9052 ;  struct da9052_regulator_info * info ;  struct regulator_dev * rdev ; } cocci_id@p ;
...
position p;
@@
 struct da9052_regulator_info cocci_id@p [ ] ;
...
position p;
@@
 struct da9052_regulator_info {  struct regulator_desc reg_desc ;  int step_uV ;  int min_uV ;  int max_uV ;  unsigned char activate_bit ; } cocci_id@p ;
...
position p;
@@
 struct da9052_regulator * cocci_id@p ;
