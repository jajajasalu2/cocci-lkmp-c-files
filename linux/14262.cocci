...
position p;
@@
 struct isif_gain_offsets_adj * cocci_id@p ;
...
position p;
@@
 enum vpss_ccdc_source_sel cocci_id@p ;
...
position p;
@@
 struct isif_params_raw * cocci_id@p ;
...
position p;
@@
 struct isif_linearize * cocci_id@p ;
...
position p;
@@
 struct isif_config_params_raw * cocci_id@p ;
...
position p;
@@
 struct isif_black_clamp * cocci_id@p ;
...
position p;
@@
 struct isif_oper_config {  struct device * dev ;  enum vpfe_hw_if_type if_type ;  struct isif_ycbcr_config ycbcr ;  struct isif_params_raw bayer ;  enum isif_data_pack data_pack ;  void __iomem * base_addr ;  void __iomem * linear_tbl0_addr ;  void __iomem * linear_tbl1_addr ; } cocci_id@p ;
...
position p;
@@
 struct vpss_sync_pol cocci_id@p ;
...
position p;
@@
 struct vpss_pg_frame_size cocci_id@p ;
...
position p;
@@
 struct isif_ycbcr_config * cocci_id@p ;
