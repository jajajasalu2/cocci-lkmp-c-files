...
position p;
@@
 struct sh_fpu_hard_struct * cocci_id@p ;
...
position p;
@@
 unsigned long long cocci_id@p ( unsigned long long a , unsigned long long b ) ;
...
position p;
@@
 unsigned long int cocci_id@p ( unsigned long int a , unsigned long int b ) ;
...
position p;
@@
 unsigned long int cocci_id@p ( unsigned long long a ) ;
