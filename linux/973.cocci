...
position p;
@@
 const struct mtd_part_parser * cocci_id@p ;
...
typedef uint64_t;
@@
 struct mtd_part {  struct mtd_info mtd ;  struct mtd_info * parent ;  uint64_t offset ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct mtd_partitions * cocci_id@p ;
...
position p;
@@
 struct mtd_part_parser * cocci_id@p ;
...
position p;
@@
 struct mtd_part_parser_data * cocci_id@p ;
...
position p;
@@
 const struct mtd_info * cocci_id@p ;
...
position p;
@@
 const struct mtd_partition * cocci_id@p ;
