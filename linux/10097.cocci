...
position p;
@@
 int cocci_id@p ( const int ioaddr [ ] , const char * name , unsigned char in [ ] ) ;
...
position p;
@@
 void cocci_id@p ( const int ioaddr [ ] , const char * name , const unsigned char out [ ] ) ;
...
position p;
@@
 int cocci_id@p ( const int ioaddr [ ] , const char * name , int * frequency ) ;
...
position p;
@@
 int cocci_id@p ( const int ioaddr [ ] , const char * name , const unsigned char out [ ] , unsigned char in [ ] ) ;
...
position p;
@@
 struct sb1000_private cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const int ioaddr [ ] , const char * name ) ;
...
position p;
@@
 int cocci_id@p ( const int ioaddr [ ] , const char * name , short PID [ ] ) ;
...
position p;
@@
 int cocci_id@p ( const int ioaddr [ ] , const char * name , unsigned char version [ ] , int do_end ) ;
...
position p;
@@
 struct sb1000_private {  struct sk_buff * rx_skb [ NPIDS ] ;  short rx_dlen [ NPIDS ] ;  unsigned int rx_frames ;  short rx_error_count ;  short rx_error_dpc_count ;  unsigned char rx_session_id [ NPIDS ] ;  unsigned char rx_frame_id [ NPIDS ] ;  unsigned char rx_pkt_type [ NPIDS ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const int ioaddr [ ] , unsigned char in [ ] ) ;
...
position p;
@@
 const unsigned char cocci_id@p [ 6 ] ;
...
position p;
@@
 int cocci_id@p ( const int ioaddr [ ] , const char * name , const short PID [ ] ) ;
...
position p;
@@
 void cocci_id@p ( const int ioaddr [ ] , const char * name ) ;
