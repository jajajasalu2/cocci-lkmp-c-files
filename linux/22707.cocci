...
typedef u8;
@@
 struct mtpav_port {  u8 number ;  u8 hwport ;  u8 mode ;  u8 running_status ;  struct snd_rawmidi_substream * input ;  struct snd_rawmidi_substream * output ; } cocci_id@p ;
...
@@
 struct mtpav {  struct snd_card * card ;  unsigned long port ;  struct resource * res_port ;  int irq ;  spinlock_t spinlock ;  int share_irq ;  int istimer ;  struct timer_list timer ;  struct snd_rawmidi * rmidi ;  int num_ports ;  struct mtpav_port ports [ NUMPORTS ] ;  u32 inmidiport ;  u32 inmidistate ;  u32 outmidihwport ; } cocci_id@p ;
