...
position p;
@@
 struct pci_mmcfg_region * cocci_id@p ;
...
position p;
@@
 struct acpi_mcfg_allocation cocci_id@p ;
...
position p;
@@
 const struct pci_mmcfg_region * cocci_id@p ;
...
typedef u64,bool;
@@
 bool ( * cocci_id@p ) ( u64 start , u64 end , unsigned type ) ;
...
typedef u32;
@@
 struct pci_mmcfg_hostbridge_probe {  u32 bus ;  u32 devfn ;  u32 vendor ;  u32 device ;  const char * ( * probe ) ( void ) ; } cocci_id@p ;
...
position p;
@@
 struct acpi_table_mcfg cocci_id@p ;
...
symbol cocci_id;
position p;
typedef check_reserved_t;
@@
 check_reserved_t cocci_id@p ;
...
typedef __u64;
@@
 int ( * cocci_id@p ) ( __u64 start , __u64 size , void * data ) ;
