...
position p;
@@
 struct aa_sfs_entry * cocci_id@p ;
...
position p;
@@
 struct multi_transaction cocci_id@p ;
...
position p;
@@
 struct rawdata_f_data {  struct aa_loaddata * loaddata ; } cocci_id@p ;
...
position p;
@@
 struct rawdata_f_data * cocci_id@p ;
...
position p;
@@
 struct multi_transaction {  struct kref count ;  ssize_t size ;  char data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct aa_revision {  struct aa_ns * ns ;  long last_read ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct seq_file * , void * ) ;
