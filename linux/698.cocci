...
position p;
@@
 struct pci_dynid {  struct list_head node ;  struct pci_device_id id ; } cocci_id@p ;
...
position p;
@@
 struct drv_dev_and_id {  struct pci_driver * drv ;  struct pci_dev * dev ;  const struct pci_device_id * id ; } cocci_id@p ;
...
position p;
@@
 enum pci_ers_result cocci_id@p ;
...
position p;
@@
 struct drv_dev_and_id * cocci_id@p ;
