...
position p;
@@
 struct bpf_tunnel_key cocci_id@p ;
...
typedef __u64;
@@
 struct vip_stats {  __u64 bytes ;  __u64 pkts ; } cocci_id@p ;
...
@@
 struct packet_description {  union {  __be32 src ;  __be32 srcv6 [ 4 ] ; } ;  union {  __be32 dst ;  __be32 dstv6 [ 4 ] ; } ;  union {  __u32 ports ;  __u16 port16 [ 2 ] ; } ;  __u8 proto ;  __u8 flags ; } cocci_id@p ;
...
position p;
@@
 struct eth_hdr {  unsigned char eth_dest [ ETH_ALEN ] ;  unsigned char eth_source [ ETH_ALEN ] ;  unsigned short eth_proto ; } cocci_id@p ;
