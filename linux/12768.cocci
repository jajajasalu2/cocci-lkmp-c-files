...
position p;
@@
 struct smd_channel_info_pair cocci_id@p ;
...
@@
 struct qcom_smd_edge {  struct device dev ;  const char * name ;  struct device_node * of_node ;  unsigned edge_id ;  unsigned remote_pid ;  int irq ;  struct regmap * ipc_regmap ;  int ipc_offset ;  int ipc_bit ;  struct mbox_client mbox_client ;  struct mbox_chan * mbox_chan ;  struct list_head channels ;  spinlock_t channels_lock ; 
	 DECLARE_BITMAP ( allocated [ SMD_ALLOC_TBL_COUNT ] , SMD_ALLOC_TBL_SIZE ) 
		 ;  unsigned smem_available ;  wait_queue_head_t new_channel_event ;  struct work_struct scan_work ;  struct work_struct state_work ; } cocci_id@p ;
...
position p;
@@
 struct smd_channel_info_word cocci_id@p ;
...
position p;
@@
 struct smd_channel_info_word_pair cocci_id@p ;
...
position p;
@@
 struct qcom_smd_endpoint {  struct rpmsg_endpoint ept ;  struct qcom_smd_channel * qsch ; } cocci_id@p ;
...
position p;
@@
 enum smd_channel_state { SMD_CHANNEL_CLOSED , SMD_CHANNEL_OPENING , SMD_CHANNEL_OPENED , SMD_CHANNEL_FLUSHING , SMD_CHANNEL_CLOSING , SMD_CHANNEL_RESET , SMD_CHANNEL_RESET_OPENING , } cocci_id@p ;
...
position p;
@@
 struct qcom_smd_alloc_entry * cocci_id@p ;
...
position p;
@@
 struct smd_channel_info_word_pair {  struct smd_channel_info_word tx ;  struct smd_channel_info_word rx ; } cocci_id@p ;
...
position p;
@@
 const struct rpmsg_endpoint_ops cocci_id@p ;
...
position p;
@@
 struct rpmsg_channel_info cocci_id@p ;
...
position p;
@@
 struct rpmsg_endpoint * cocci_id@p ;
...
position p;
@@
 struct qcom_smd_edge * cocci_id@p ;
...
position p;
@@
 const struct {  unsigned alloc_tbl_id ;  unsigned info_base_id ;  unsigned fifo_base_id ; } cocci_id@p [ SMD_ALLOC_TBL_COUNT ] ;
...
position p;
@@
 struct qcom_smd_channel * cocci_id@p ;
...
position p;
@@
 struct smd_channel_info_pair {  struct smd_channel_info tx ;  struct smd_channel_info rx ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,wait_queue_head_t,spinlock_t;
@@
 struct qcom_smd_channel {  struct qcom_smd_edge * edge ;  struct qcom_smd_endpoint * qsept ;  bool registered ;  char * name ;  enum smd_channel_state state ;  enum smd_channel_state remote_state ;  wait_queue_head_t state_change_event ;  struct smd_channel_info_pair * info ;  struct smd_channel_info_word_pair * info_word ;  spinlock_t tx_lock ;  wait_queue_head_t fblockread_event ;  void * tx_fifo ;  void * rx_fifo ;  int fifo_size ;  void * bounce_buffer ;  spinlock_t recv_lock ;  int pkt_size ;  void * drvdata ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct qcom_smd_device {  struct rpmsg_device rpdev ;  struct qcom_smd_edge * edge ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rpmsg_rx_cb_t;
@@
 rpmsg_rx_cb_t cocci_id@p ;
...
position p;
@@
 struct qcom_smd_endpoint cocci_id@p ;
...
position p;
@@
 struct qcom_smd_device * cocci_id@p ;
...
typedef __le32;
@@
 struct smd_channel_info_word {  __le32 state ;  __le32 fDSR ;  __le32 fCTS ;  __le32 fCD ;  __le32 fRI ;  __le32 fHEAD ;  __le32 fTAIL ;  __le32 fSTATE ;  __le32 fBLOCKREADINTR ;  __le32 tail ;  __le32 head ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct smd_channel_info {  __le32 state ;  u8 fDSR ;  u8 fCTS ;  u8 fCD ;  u8 fRI ;  u8 fHEAD ;  u8 fTAIL ;  u8 fSTATE ;  u8 fBLOCKREADINTR ;  __le32 tail ;  __le32 head ; } cocci_id@p ;
...
position p;
@@
 struct smd_channel_info cocci_id@p ;
...
position p;
@@
 const struct rpmsg_device_ops cocci_id@p ;
