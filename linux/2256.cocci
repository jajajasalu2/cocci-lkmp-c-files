...
position p;
@@
 struct power_allocator_params * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s32,bool,s64;
@@
 struct power_allocator_params {  bool allocated_tzp ;  s64 err_integral ;  s32 prev_err ;  int trip_switch_on ;  int trip_max_desired_temperature ; } cocci_id@p ;
