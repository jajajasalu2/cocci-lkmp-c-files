...
position p;
@@
 const struct regamma_lut * cocci_id@p ;
...
position p;
@@
 const struct gamma_pixel * cocci_id@p ;
...
position p;
@@
 const struct pwl_float_data_ex * cocci_id@p ;
...
position p;
@@
 struct fixed31_32 cocci_id@p [ MAX_HW_POINTS + 2 ] ;
...
position p;
@@
 const struct pixel_gamma_point * cocci_id@p ;
...
position p;
@@
 enum hw_point_position cocci_id@p ;
...
position p;
@@
 const struct regamma_ramp * cocci_id@p ;
...
position p;
@@
 const struct gamma_point * cocci_id@p ;
...
position p;
@@
 struct translate_from_linear_space_args cocci_id@p ;
...
position p;
@@
 struct dividers {  struct fixed31_32 divider1 ;  struct fixed31_32 divider2 ;  struct fixed31_32 divider3 ; } cocci_id@p ;
...
position p;
@@
 const struct hw_x_point * cocci_id@p ;
...
position p;
@@
 struct hw_x_point cocci_id@p [ MAX_HW_POINTS + 2 ] ;
...
position p;
@@
 struct fixed31_32 cocci_id@p [ NUM_PTS_IN_REGION ] ;
...
position p;
@@
 const struct freesync_hdr_tf_params * cocci_id@p ;
...
position p;
@@
 struct gamma_coefficients * cocci_id@p ;
...
position p;
@@
 struct pixel_gamma_point * cocci_id@p ;
...
position p;
@@
 enum dc_transfer_func_predefined cocci_id@p ;
...
position p;
@@
 struct pwl_float_data * cocci_id@p ;
...
position p;
@@
 struct pwl_float_data_ex * cocci_id@p ;
