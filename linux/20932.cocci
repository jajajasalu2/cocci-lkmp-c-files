...
position p;
@@
 struct hostaudio_state * cocci_id@p ;
...
position p;
@@
 struct hostmixer_state cocci_id@p ;
...
position p;
@@
 struct hostmixer_state {  int fd ; } cocci_id@p ;
...
position p;
@@
 struct {  int dev_audio ;  int dev_mixer ; } cocci_id@p ;
...
position p;
@@
 struct hostaudio_state {  int fd ; } cocci_id@p ;
