...
position p;
@@
 struct wdt87xx_data * cocci_id@p ;
...
position p;
@@
 struct wdt87xx_sys_param * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ WDT_V1_RAW_BUF_COUNT ] ;
...
typedef u32,u16;
@@
 struct wdt87xx_sys_param {  u16 fw_id ;  u16 plat_id ;  u16 xmls_id1 ;  u16 xmls_id2 ;  u16 phy_ch_x ;  u16 phy_ch_y ;  u16 phy_w ;  u16 phy_h ;  u16 scaling_factor ;  u32 max_x ;  u32 max_y ;  u16 vendor_id ;  u16 product_id ; } cocci_id@p ;
...
typedef u8;
@@
 struct wdt87xx_data {  struct i2c_client * client ;  struct input_dev * input ;  struct mutex fw_mutex ;  struct wdt87xx_sys_param param ;  u8 phys [ 32 ] ; } cocci_id@p ;
