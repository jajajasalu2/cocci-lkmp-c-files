...
position p;
@@
 struct bd28623_priv * cocci_id@p ;
...
position p;
@@
 struct bd28623_priv {  struct device * dev ;  struct regulator_bulk_data supplies [ BD28623_NUM_SUPPLIES ] ;  struct gpio_desc * reset_gpio ;  struct gpio_desc * mute_gpio ;  int switch_spk ; } cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ BD28623_NUM_SUPPLIES ] ;
