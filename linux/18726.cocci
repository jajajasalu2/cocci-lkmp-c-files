...
typedef bool;
@@
 struct l2x0_event_attribute {  struct device_attribute attr ;  unsigned int config ;  bool pl310_only ; } cocci_id@p ;
...
position p;
@@
 struct l2x0_event_attribute cocci_id@p [ ] ;
...
position p;
@@
 struct perf_event * cocci_id@p [ PMU_NR_COUNTERS ] ;
