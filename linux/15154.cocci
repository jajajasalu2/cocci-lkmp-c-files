...
@@
 struct cs_char {  unsigned int opened ;  struct hsi_client * cl ;  struct cs_hsi_iface * hi ;  struct list_head chardev_queue ;  struct list_head dataind_queue ;  int dataind_pending ;  unsigned long mmap_base ;  unsigned long mmap_size ;  spinlock_t lock ;  struct fasync_struct * async_queue ;  wait_queue_head_t wait ;  int channel_id_cmd ;  int channel_id_data ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cs_hsi_iface * hi ) ;
...
typedef wait_queue_head_t,spinlock_t;
@@
 struct cs_hsi_iface {  struct hsi_client * cl ;  struct hsi_client * master ;  unsigned int iface_state ;  unsigned int wakeline_state ;  unsigned int control_state ;  unsigned int data_state ;  struct cs_mmap_config_block * mmap_cfg ;  unsigned long mmap_base ;  unsigned long mmap_size ;  unsigned int rx_slot ;  unsigned int tx_slot ;  unsigned int buf_size ;  unsigned int rx_bufs ;  unsigned int tx_bufs ;  unsigned int rx_ptr_boundary ;  unsigned int rx_offsets [ CS_MAX_BUFFERS ] ;  unsigned int tx_offsets [ CS_MAX_BUFFERS ] ;  unsigned int slot_size ;  unsigned int flags ;  struct list_head cmdqueue ;  struct hsi_msg * data_rx_msg ;  struct hsi_msg * data_tx_msg ;  wait_queue_head_t datawait ;  struct pm_qos_request pm_qos_req ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct cs_hsi_iface * * cocci_id@p ;
...
position p;
@@
 struct cs_mmap_config_block * cocci_id@p ;
...
position p;
@@
 struct cs_timestamp * cocci_id@p ;
...
position p;
@@
 struct cs_buffer_config * cocci_id@p ;
...
position p;
@@
 struct hsi_client_driver cocci_id@p ;
...
position p;
@@
 const struct cs_buffer_config * cocci_id@p ;
...
typedef u32;
@@
 struct char_queue {  struct list_head list ;  u32 msg ; } cocci_id@p ;
