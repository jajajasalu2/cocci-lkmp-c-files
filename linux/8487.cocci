...
position p;
@@
 struct lance_private * cocci_id@p ;
...
position p;
@@
 struct lance_tx_head * cocci_id@p ;
...
position p;
@@
 struct lance_addr {  unsigned long memaddr ;  unsigned long ioaddr ;  int slow_flag ; } cocci_id@p [ ] ;
...
position p;
@@
 struct lance_rx_head {  unsigned short base ;  volatile unsigned char flag ;  unsigned char base_hi ;  short buf_length ;  volatile short msg_length ; } cocci_id@p ;
...
position p;
@@
 enum lance_type { OLD_RIEBL , NEW_RIEBL , PAM_CARD , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , void * addr ) ;
...
position p;
@@
 unsigned long cocci_id@p ( struct net_device * dev , struct lance_addr * init_rec ) ;
...
position p;
@@
 struct lance_init_block {  unsigned short mode ;  unsigned char hwaddr [ 6 ] ;  unsigned filter [ 2 ] ;  struct ringdesc rx_ring ;  struct ringdesc tx_ring ; } cocci_id@p ;
...
position p;
@@
 struct ringdesc {  unsigned short adr_lo ;  unsigned char len ;  unsigned char adr_hi ; } cocci_id@p ;
...
position p;
@@
 volatile unsigned short * cocci_id@p ;
...
position p;
@@
 struct lance_tx_head {  unsigned short base ;  volatile unsigned char flag ;  unsigned char base_hi ;  short length ;  volatile short misc ; } cocci_id@p ;
...
position p;
@@
 struct lance_memory * cocci_id@p ;
...
position p;
@@
 struct lance_ioreg {  volatile unsigned short data ;  volatile unsigned short addr ;  unsigned char _dummy1 [ 3 ] ;  volatile unsigned char ivec ;  unsigned char _dummy2 [ 5 ] ;  volatile unsigned char eeprom ;  unsigned char _dummy3 ;  volatile unsigned char mem ; } cocci_id@p ;
...
position p;
@@
 struct lance_rx_head * cocci_id@p ;
...
position p;
@@
 struct lance_memory {  struct lance_init_block init ;  struct lance_tx_head tx_head [ TX_RING_SIZE ] ;  struct lance_rx_head rx_head [ RX_RING_SIZE ] ;  char packet_area [ 0 ] ; } cocci_id@p ;
