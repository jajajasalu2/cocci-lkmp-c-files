...
position p;
@@
 struct msic_gpio {  struct platform_device * pdev ;  struct mutex buslock ;  struct gpio_chip chip ;  int irq ;  unsigned irq_base ;  unsigned long trig_change_mask ;  unsigned trig_type ; } cocci_id@p ;
...
position p;
@@
 struct intel_msic_gpio_pdata * cocci_id@p ;
