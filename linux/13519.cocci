...
position p;
@@
 unsigned char cocci_id@p [ 16 ] [ 256 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ 16 ] [ 1024 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ 256 + 2 * MAX_OUTER_CROP_VALUE ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ 64 * 4 ] ;
...
position p;
@@
 struct pwc_dec23_private * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ 12 ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ 16 ] [ 8 ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ 16 ] [ 16 ] ;
