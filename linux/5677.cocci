...
position p;
@@
 unsigned char cocci_id@p [ NUM_TIME_REGS ] ;
...
typedef u32;
@@
 struct rc5t583_rtc {  struct rtc_device * rtc ;  u32 irqen ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ NUM_YAL_REGS ] ;
