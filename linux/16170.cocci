...
position p;
@@
 struct apci3120_board {  const char * name ;  unsigned int ai_is_16bit : 1 ;  unsigned int has_ao : 1 ; } cocci_id@p ;
...
position p;
@@
 struct apci3120_private * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct apci3120_dmabuf {  unsigned short * virt ;  dma_addr_t hw ;  unsigned int size ;  unsigned int use_size ; } cocci_id@p ;
...
position p;
@@
 const struct apci3120_board * cocci_id@p ;
...
position p;
@@
 struct apci3120_dmabuf * cocci_id@p ;
...
position p;
@@
 struct apci3120_private {  unsigned long amcc ;  unsigned long addon ;  unsigned int osc_base ;  unsigned int use_dma : 1 ;  unsigned int use_double_buffer : 1 ;  unsigned int cur_dmabuf : 1 ;  struct apci3120_dmabuf dmabuf [ 2 ] ;  unsigned char do_bits ;  unsigned char timer_mode ;  unsigned char mode ;  unsigned short ctrl ; } cocci_id@p ;
...
position p;
@@
 enum apci3120_boardid { BOARD_APCI3120 , BOARD_APCI3001 , } cocci_id@p ;
