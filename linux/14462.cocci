...
position p;
@@
 struct dmxdev_filter cocci_id@p ;
...
position p;
@@
 struct dmx_pes_filter_params * cocci_id@p ;
...
position p;
@@
 struct dmx_sct_filter_params cocci_id@p ;
...
position p;
@@
 struct dmx_section_feed * * cocci_id@p ;
