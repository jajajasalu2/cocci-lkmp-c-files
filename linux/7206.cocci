...
position p;
@@
 int cocci_id@p ( struct nvmet_fc_tgt_assoc * assoc ) ;
...
position p;
@@
 struct nvmet_fc_fcp_iod cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct nvmet_fc_tgtport * tgtport ) ;
...
position p;
@@
 struct nvmet_fc_ls_iod cocci_id@p ;
...
position p;
@@
 struct nvmet_fc_port_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvmet_fc_tgt_assoc * assoc ) ;
...
position p;
@@
 void cocci_id@p ( struct nvmet_fc_tgt_queue * queue ) ;
...
position p;
@@
 void cocci_id@p ( struct nvmet_req * nvme_req ) ;
...
@@
 struct nvmet_fc_tgtport {  struct nvmet_fc_target_port fc_target_port ;  struct list_head tgt_list ;  struct device * dev ;  struct nvmet_fc_target_template * ops ;  struct nvmet_fc_ls_iod * iod ;  spinlock_t lock ;  struct list_head ls_list ;  struct list_head ls_busylist ;  struct list_head assoc_list ;  struct ida assoc_cnt ;  struct nvmet_fc_port_entry * pe ;  struct kref ref ;  u32 max_sg_cnt ; } cocci_id@p ;
...
position p;
@@
 struct nvmet_fc_tgt_queue * cocci_id@p ;
...
position p;
@@
 struct nvme_common_command * cocci_id@p ;
...
position p;
@@
 struct nvmet_fc_tgtport * cocci_id@p ;
...
position p;
@@
 struct nvmet_fc_target_template * cocci_id@p ;
...
position p;
@@
 struct fcnvme_ls_acc_hdr * cocci_id@p ;
...
typedef u64,u32;
@@
 struct nvmet_fc_tgt_assoc {  u64 association_id ;  u32 a_id ;  struct nvmet_fc_tgtport * tgtport ;  struct list_head a_list ;  struct nvmet_fc_tgt_queue * queues [ NVMET_NR_QUEUES + 1 ] ;  struct kref ref ;  struct work_struct del_work ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvmet_fc_tgtport * tgtport , struct nvmet_fc_fcp_iod * fod ) ;
...
position p;
@@
 struct nvmet_fc_tgt_assoc cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvmefc_tgt_fcp_req * fcpreq ) ;
...
position p;
@@
 struct nvmefc_tgt_ls_req * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvmet_fc_tgtport * tgtport ) ;
...
position p;
@@
 struct fcnvme_lsdesc_rjt cocci_id@p ;
...
position p;
@@
 struct fcnvme_ls_rqst_w0 * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct nvmet_fc_tgt_queue * queue ) ;
...
position p;
@@
 struct nvmet_fc_defer_fcp_req * cocci_id@p ;
...
position p;
@@
 enum nvmet_fcp_datadir { NVMET_FCP_NODATA , NVMET_FCP_WRITE , NVMET_FCP_READ , NVMET_FCP_ABORTED , } cocci_id@p ;
...
position p;
@@
 struct nvmet_fc_defer_fcp_req {  struct list_head req_list ;  struct nvmefc_tgt_fcp_req * fcp_req ; } cocci_id@p ;
...
position p;
@@
 struct nvmet_fc_target_port * cocci_id@p ;
...
typedef u64;
@@
 struct nvmet_fc_port_entry {  struct nvmet_fc_tgtport * tgtport ;  struct nvmet_port * port ;  u64 node_name ;  u64 port_name ;  struct list_head pe_list ; } cocci_id@p ;
...
position p;
@@
 struct nvmefc_tgt_fcp_req * cocci_id@p ;
...
position p;
@@
 struct nvmet_fc_port_entry * cocci_id@p ;
...
position p;
@@
 const struct nvmet_fabrics_ops cocci_id@p ;
