...
typedef u8,u16;
@@
 struct bcsp_struct {  struct sk_buff_head unack ;  struct sk_buff_head rel ;  struct sk_buff_head unrel ;  unsigned long rx_count ;  struct sk_buff * rx_skb ;  u8 rxseq_txack ;  u8 rxack ;  struct timer_list tbcsp ;  struct hci_uart * hu ;  enum { BCSP_W4_PKT_DELIMITER , BCSP_W4_PKT_START , BCSP_W4_BCSP_HDR , BCSP_W4_DATA , BCSP_W4_CRC , } rx_state ;  enum { BCSP_ESCSTATE_NOESC , BCSP_ESCSTATE_ESC , } rx_esc_state ;  u8 use_crc ;  u16 message_crc ;  u8 txack_req ;  u8 msgq_txseq ; } cocci_id@p ;
