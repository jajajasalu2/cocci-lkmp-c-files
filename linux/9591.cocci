...
position p;
@@
 struct qtnf_shm_ipc_int cocci_id@p ;
...
position p;
@@
 struct qtnf_extra_bd_params cocci_id@p ;
...
position p;
@@
 struct qtnf_topaz_rx_bd * cocci_id@p ;
...
position p;
@@
 struct qtnf_pcie_topaz_state * cocci_id@p ;
...
typedef __le32;
@@
 struct vmac_pkt_info {  __le32 addr ;  __le32 info ; } cocci_id@p ;
...
position p;
@@
 struct qtnf_bus_ops cocci_id@p ;
...
@@
 struct qtnf_pcie_topaz_state {  struct qtnf_pcie_bus_priv base ;  struct qtnf_topaz_bda __iomem * bda ;  dma_addr_t dma_msi_dummy ;  u32 dma_msi_imwr ;  struct qtnf_topaz_tx_bd * tx_bd_vbase ;  struct qtnf_topaz_rx_bd * rx_bd_vbase ;  __le32 __iomem * ep_next_rx_pkt ;  __le32 __iomem * txqueue_wake ;  __le32 __iomem * ep_pmstate ;  unsigned long rx_pkt_count ; } cocci_id@p ;
...
position p;
@@
 struct qtnf_pcie_bus_priv * cocci_id@p ;
...
position p;
@@
 struct qtnf_topaz_tx_bd * cocci_id@p ;
