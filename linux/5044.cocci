...
typedef u8,bool;
@@
 struct ts5500_dio {  const u8 value_addr ;  const u8 value_mask ;  const u8 control_addr ;  const u8 control_mask ;  const bool no_input ;  const bool no_output ;  const u8 irq ; } cocci_id@p ;
...
@@
 struct ts5500_priv {  const struct ts5500_dio * pinout ;  struct gpio_chip gpio_chip ;  spinlock_t lock ;  bool strap ;  u8 hwirq ; } cocci_id@p ;
...
position p;
@@
 const struct ts5500_dio cocci_id@p ;
...
position p;
@@
 enum ts5500_blocks { TS5500_DIO1 , TS5500_DIO2 , TS5500_LCD , TS5600_LCD , } cocci_id@p ;
