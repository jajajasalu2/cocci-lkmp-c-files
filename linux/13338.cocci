...
position p;
@@
 enum { TUNER , AUX1 , AUX3 , AUX3_YC , } cocci_id@p ;
...
position p;
@@
 struct v4l2_audio cocci_id@p [ MXB_AUDIOS ] ;
...
position p;
@@
 struct saa7146_pci_extension_data cocci_id@p ;
...
position p;
@@
 struct saa7146_extension cocci_id@p ;
...
typedef u32;
@@
 struct mxb_routing {  u32 input ;  u32 output ; } cocci_id@p ;
...
position p;
@@
 struct mxb {  struct video_device video_dev ;  struct video_device vbi_dev ;  struct i2c_adapter i2c_adapter ;  struct v4l2_subdev * saa7111a ;  struct v4l2_subdev * tda9840 ;  struct v4l2_subdev * tea6415c ;  struct v4l2_subdev * tuner ;  struct v4l2_subdev * tea6420_1 ;  struct v4l2_subdev * tea6420_2 ;  int cur_mode ;  int cur_input ;  int cur_audinput ;  int cur_mute ;  struct v4l2_frequency cur_freq ; } cocci_id@p ;
...
position p;
@@
 struct {  int length ;  char data [ 9 ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct v4l2_input cocci_id@p [ MXB_INPUTS ] ;
...
position p;
@@
 struct saa7146_ext_vv cocci_id@p ;
...
position p;
@@
 struct saa7146_standard * cocci_id@p ;
...
position p;
@@
 struct {  int hps_source ;  int hps_sync ; } cocci_id@p [ MXB_INPUTS ] ;
...
position p;
@@
 struct mxb_routing cocci_id@p [ MXB_AUDIOS + 1 ] [ 2 ] ;
