...
position p;
@@
 struct snd_emu10k1_fx8010_ctl * cocci_id@p ;
...
position p;
@@
 struct snd_emu10k1_fx8010_code * cocci_id@p ;
...
position p;
@@
 struct snd_emu10k1_fx8010_pcm_rec * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_fx8010_irq_handler_t;
@@
 snd_fx8010_irq_handler_t * cocci_id@p ;
...
position p;
@@
 struct snd_emu10k1_fx8010_control_gpr cocci_id@p ;
...
position p;
@@
 struct snd_emu10k1_fx8010_irq * cocci_id@p ;
...
position p;
@@
 struct snd_emu10k1_fx8010_info * cocci_id@p ;
