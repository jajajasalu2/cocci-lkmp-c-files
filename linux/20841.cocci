...
position p;
@@
 struct kvm_memory_slot * cocci_id@p ;
...
position p;
@@
 struct kvm_reinject_control * cocci_id@p ;
...
position p;
@@
 struct kvm_debugregs cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( msrs_to_save_all ) ] ;
...
position p;
@@
 struct kvm_kpit_state * cocci_id@p ;
...
position p;
@@
 struct kvm_steal_time cocci_id@p ;
...
position p;
@@
 struct kvm_vapic_addr cocci_id@p ;
...
position p;
@@
 struct kvm_host_map cocci_id@p ;
...
position p;
@@
 struct kvm_pit_state * cocci_id@p ;
...
position p;
@@
 struct kvm_tpr_access_ctl * cocci_id@p ;
...
position p;
@@
 struct kvm_apic_map * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ ARRAY_SIZE ( vcpu -> arch . walk_mmu -> pdptrs ) ] ;
...
position p;
@@
 struct cpufreq_policy cocci_id@p ;
...
typedef u64,bool;
@@
 struct kvm_shared_msrs {  struct user_return_notifier urn ;  bool registered ;  struct kvm_shared_msr_values {  u64 host ;  u64 curr ; } values [ KVM_NR_SHARED_MSRS ] ; } cocci_id@p ;
...
position p;
@@
 struct kvm_vcpu_events * cocci_id@p ;
...
position p;
@@
 struct kvm_shared_msr_values * cocci_id@p ;
...
position p;
@@
 struct kvm_pit_state2 * cocci_id@p ;
...
position p;
@@
 struct kvm_hyperv_eventfd cocci_id@p ;
...
position p;
@@
 struct kvm_shared_msrs cocci_id@p ;
...
position p;
@@
 struct kvm_kernel_irqfd * cocci_id@p ;
...
position p;
@@
 union {  struct kvm_pit_state ps ;  struct kvm_pit_state2 ps2 ;  struct kvm_pit_config pit_config ; } cocci_id@p ;
...
position p;
@@
 struct irq_bypass_producer * cocci_id@p ;
...
position p;
@@
 struct x86_exception cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kvm_vcpu * vcpu ) ;
...
typedef u32;
@@
 struct kvm_shared_msrs_global {  int nr ;  u32 msrs [ KVM_NR_SHARED_MSRS ] ; } cocci_id@p ;
...
position p;
@@
 struct kvm_mmio_fragment * cocci_id@p ;
...
position p;
@@
 struct pvclock_wall_clock cocci_id@p ;
...
position p;
@@
 struct kvm_lapic_state cocci_id@p ;
...
position p;
@@
 struct x86_emulate_ctxt * cocci_id@p ;
...
position p;
@@
 struct irq_bypass_consumer * cocci_id@p ;
...
position p;
@@
 const struct kvm_userspace_memory_region * cocci_id@p ;
...
position p;
@@
 struct kvm_stats_debugfs_item cocci_id@p [ ] ;
...
position p;
@@
 enum x86_intercept_stage cocci_id@p ;
...
position p;
@@
 struct kvm_enable_cap * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ ARRAY_SIZE ( mmu -> pdptrs ) ] ;
...
position p;
@@
 struct fxregs_state cocci_id@p ;
...
position p;
@@
 struct kvm_enc_region cocci_id@p ;
...
typedef u64,u32;
@@
 struct pvclock_clock {  int vclock_mode ;  u64 cycle_last ;  u64 mask ;  u32 mult ;  u32 shift ; } cocci_id@p ;
...
position p;
@@
 struct kvm_userspace_memory_region cocci_id@p ;
...
position p;
@@
 struct pvclock_gtod_data cocci_id@p ;
...
position p;
@@
 const struct kvm_memory_slot * cocci_id@p ;
...
position p;
@@
 struct kvm_msr_list cocci_id@p ;
...
position p;
@@
 struct kvm_msr_entry cocci_id@p ;
...
position p;
@@
 struct kvm_clear_dirty_log * cocci_id@p ;
...
position p;
@@
 struct kvm_clock_data cocci_id@p ;
...
position p;
@@
 struct kvm_pit_config cocci_id@p ;
...
position p;
@@
 struct kvm_lapic_irq cocci_id@p ;
...
position p;
@@
 struct pvclock_clock * cocci_id@p ;
...
position p;
@@
 struct kvm_lpage_info * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( emulated_msrs_all ) ] ;
...
position p;
@@
 struct kvm_memslots * cocci_id@p ;
...
position p;
@@
 struct kvm_irq_level * cocci_id@p ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct kvm_vcpu * vcpu , unsigned index , u64 * data ) ;
...
position p;
@@
 struct kvm_guest_debug * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kvm_vcpu * vcpu , unsigned long rflags ) ;
...
position p;
@@
 struct pvclock_vcpu_time_info cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( msr_based_features_all ) ] ;
...
position p;
@@
 struct kvm_nested_state cocci_id@p ;
...
position p;
@@
 struct kvm_clock_pairing cocci_id@p ;
...
position p;
@@
 struct kvm_interrupt cocci_id@p ;
...
position p;
@@
 struct kvm_translation * cocci_id@p ;
...
position p;
@@
 struct delayed_work * cocci_id@p ;
...
position p;
@@
 struct kvm_vcpu_arch * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct x86_emulate_ctxt * ctxt ) ;
...
position p;
@@
 struct mpx_bndreg_state cocci_id@p ;
...
position p;
@@
 struct x86_pmu_capability cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,seqcount_t;
@@
 struct pvclock_gtod_data {  seqcount_t seq ;  struct pvclock_clock clock ;  struct pvclock_clock raw_clock ;  u64 boot_ns_raw ;  u64 boot_ns ;  u64 nsec_base ;  u64 wall_time_sec ;  u64 monotonic_raw_nsec ; } cocci_id@p ;
...
position p;
@@
 const struct read_write_emulator_ops * cocci_id@p ;
...
position p;
@@
 struct cpufreq_freqs * cocci_id@p ;
...
position p;
@@
 struct kvm_pic_state cocci_id@p ;
...
position p;
@@
 struct kvm_async_pf * cocci_id@p ;
...
position p;
@@
 struct user_return_notifier * cocci_id@p ;
...
position p;
@@
 struct kvm_dirty_log * cocci_id@p ;
...
position p;
@@
 struct kvm_mp_state * cocci_id@p ;
...
position p;
@@
 union {  struct kvm_lapic_state * lapic ;  struct kvm_xsave * xsave ;  struct kvm_xcrs * xcrs ;  void * buffer ; } cocci_id@p ;
...
position p;
@@
 struct kvm_xen_hvm_config cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct kvm_vcpu * ) ;
...
position p;
@@
 struct kvm_sync_regs cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct kvm_vcpu * vcpu ) ;
...
position p;
@@
 const struct x86_emulate_ops cocci_id@p ;
...
position p;
@@
 struct x86_instruction_info * cocci_id@p ;
