...
typedef ips_ha_t;
@@
 ips_ha_t * cocci_id@p [ IPS_MAX_ADAPTERS ] ;
...
symbol cocci_id;
position p;
typedef ips_wait_queue_entry_t;
@@
 ips_wait_queue_entry_t * cocci_id@p ;
...
typedef ips_wait_queue_entry_t;
@@
 struct scsi_cmnd * cocci_id@p ( ips_wait_queue_entry_t * , struct scsi_cmnd * ) ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * scmd , void * data , unsigned int count ) ;
...
symbol cocci_id;
position p;
typedef ips_copp_wait_item_t;
@@
 ips_copp_wait_item_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pci_dev , const struct pci_device_id * ent ) ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ IPS_MAX_CONFIG_BYTES ] ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * , struct scsi_cmnd * ) ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * nb , ulong event , void * buf ) ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * , char * , int ) ;
...
position p;
@@
 IPS_SCSI_MODE_PAGE_DATA cocci_id@p ;
...
typedef ips_ha_t;
@@
 int cocci_id@p ( ips_ha_t * , int , int ) ;
...
position p;
@@
 struct Scsi_Host * cocci_id@p [ IPS_MAX_ADAPTERS ] ;
...
position p;
@@
 IPS_DCDB_TABLE_TAPE * cocci_id@p ;
...
typedef ips_ha_t;
@@
 void cocci_id@p ( ips_ha_t * , IPS_STATUS * ) ;
...
position p;
@@
 const char * cocci_id@p ( struct Scsi_Host * ) ;
...
typedef ips_ha_t;
@@
 int cocci_id@p ( ips_ha_t * , struct seq_file * ) ;
...
position p;
@@
 void cocci_id@p ( struct pci_dev * pci_dev ) ;
...
symbol cocci_id;
position p;
typedef ips_passthru_t;
@@
 ips_passthru_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ips_copp_wait_item_t,ips_copp_queue_t;
@@
 ips_copp_wait_item_t * cocci_id@p ( ips_copp_queue_t * ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_file * , struct Scsi_Host * ) ;
...
symbol cocci_id;
position p;
typedef ips_ha_t,uint32_t;
@@
 uint32_t cocci_id@p ( ips_ha_t * ) ;
...
symbol cocci_id;
position p;
typedef ips_ha_t,ips_scb_t;
@@
 ips_scb_t * cocci_id@p ( ips_ha_t * ) ;
...
symbol cocci_id;
position p;
typedef ips_copp_queue_t;
@@
 ips_copp_queue_t * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ IPS_MAX_POST_BYTES ] ;
...
typedef ips_ha_t;
@@
 void cocci_id@p ( ips_ha_t * , struct ips_scb * ) ;
...
symbol cocci_id;
position p;
typedef ips_scb_queue_t,ips_scb_t;
@@
 ips_scb_t * cocci_id@p ( ips_scb_queue_t * ) ;
...
symbol cocci_id;
position p;
typedef ips_scb_queue_t;
@@
 ips_scb_queue_t * cocci_id@p ;
...
typedef ips_wait_queue_entry_t;
@@
 struct scsi_cmnd * cocci_id@p ( ips_wait_queue_entry_t * ) ;
...
typedef ips_ha_t;
@@
 int cocci_id@p ( ips_ha_t * ha , int index ) ;
...
typedef ips_wait_queue_entry_t;
@@
 void cocci_id@p ( ips_wait_queue_entry_t * , struct scsi_cmnd * ) ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pci_dev , int * indexPtr ) ;
