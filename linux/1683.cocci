...
position p;
@@
 struct cros_ec_sensor_platform * cocci_id@p ;
...
position p;
@@
 enum motionsensor_type cocci_id@p ;
...
position p;
@@
 struct cros_ec_sensors_core_state * cocci_id@p ;
...
position p;
@@
 struct cros_ec_sensorhub * cocci_id@p ;
