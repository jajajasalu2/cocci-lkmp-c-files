...
position p;
@@
 struct soc_pcmcia_socket * cocci_id@p ;
...
position p;
@@
 struct pcmcia_state cocci_id@p ;
...
position p;
@@
 struct soc_pcmcia_regulator * cocci_id@p ;
...
position p;
@@
 const struct pcmcia_low_level * cocci_id@p ;
...
position p;
@@
 struct soc_pcmcia_timing * cocci_id@p ;
...
position p;
@@
 struct bittbl {  unsigned int mask ;  const char * name ; } cocci_id@p ;
