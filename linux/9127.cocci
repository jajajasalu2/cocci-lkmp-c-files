...
position p;
@@
 struct ptys2ethtool_config cocci_id@p [ MLX5E_LINK_MODES_NUMBER ] ;
...
position p;
@@
 int cocci_id@p [ MLX5E_CONNECTOR_TYPE_NUMBER ] ;
...
position p;
@@
 struct mlx5e_port_eth_proto cocci_id@p ;
...
position p;
@@
 struct pflag_desc {  char name [ ETH_GSTRING_LEN ] ;  mlx5e_pflag_handler handler ; } cocci_id@p ;
...
typedef u32;
@@
 u32 ( * cocci_id@p ) ( const unsigned long * adver ) ;
...
position p;
@@
 enum mlx5e_priv_flag cocci_id@p ;
...
position p;
@@
 struct ptys2ethtool_config * * cocci_id@p ;
...
position p;
@@
 struct ptys2ethtool_config cocci_id@p [ MLX5E_EXT_LINK_MODES_NUMBER ] ;
...
position p;
@@
 struct ptys2ethtool_config {  __ETHTOOL_DECLARE_LINK_MODE_MASK ( supported ) ;  __ETHTOOL_DECLARE_LINK_MODE_MASK ( advertised ) ; } cocci_id@p ;
...
position p;
@@
 const struct pflag_desc cocci_id@p [ MLX5E_NUM_PFLAGS ] ;
