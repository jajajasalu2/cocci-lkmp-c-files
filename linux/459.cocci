...
typedef label_t;
@@
 union label_t {  struct vtoc_volume_label_cdl vol ;  struct vtoc_volume_label_ldl lnx ;  struct vtoc_cms_label cms ; } cocci_id@p ;
...
@@
 dasd_information2_t * cocci_id@p ;
...
position p;
@@
 struct vtoc_format1_label cocci_id@p ;
