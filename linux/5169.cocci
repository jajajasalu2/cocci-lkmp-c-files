...
position p;
@@
 struct kempld_gpio_data {  struct gpio_chip chip ;  struct kempld_device_data * pld ; } cocci_id@p ;
...
position p;
@@
 struct kempld_platform_data * cocci_id@p ;
...
position p;
@@
 struct kempld_gpio_data * cocci_id@p ;
