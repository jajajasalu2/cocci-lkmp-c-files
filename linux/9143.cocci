...
position p;
@@
 struct mlx5e_mpw_info * cocci_id@p ;
...
position p;
@@
 struct mlx5_mini_cqe8 * cocci_id@p ;
...
position p;
@@
 struct mlx5e_cq_decomp * cocci_id@p ;
...
position p;
@@
 struct mlx5e_page_cache * cocci_id@p ;
...
position p;
@@
 struct mlx5e_sq_wqe_info * cocci_id@p ;
