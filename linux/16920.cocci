...
position p;
@@
 const struct hideep_event * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct pgm_packet {  struct {  u8 unused [ 3 ] ;  u8 len ;  __be32 addr ; } header ;  __be32 payload [ HIDEEP_NVM_PAGE_SIZE / sizeof ( __be32 ) ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct hideep_event {  __le16 x ;  __le16 y ;  __le16 z ;  u8 w ;  u8 flag ;  u8 type ;  u8 index ; } cocci_id@p ;
