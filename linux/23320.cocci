...
position p;
@@
 struct twl6040_jack_data {  struct snd_soc_jack * jack ;  struct delayed_work work ;  int report ; } cocci_id@p ;
...
position p;
@@
 enum twl6040_dai_id cocci_id@p ;
...
position p;
@@
 struct twl6040_data cocci_id@p ;
...
position p;
@@
 enum twl6040_dai_id { TWL6040_DAI_LEGACY = 0 , TWL6040_DAI_UL , TWL6040_DAI_DL1 , TWL6040_DAI_DL2 , TWL6040_DAI_VIB , } cocci_id@p ;
...
position p;
@@
 struct twl6040_jack_data * cocci_id@p ;
