...
position p;
@@
 const struct sh_pfc_pin_range * cocci_id@p ;
...
typedef u8;
@@
 struct sh_pfc_gpio_pin {  u8 dbit ;  u8 dreg ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sh_pfc_chip * ) ;
...
position p;
@@
 struct sh_pfc_chip {  struct sh_pfc * pfc ;  struct gpio_chip gpio_chip ;  struct sh_pfc_window * mem ;  struct sh_pfc_gpio_data_reg * regs ;  struct sh_pfc_gpio_pin * pins ; } cocci_id@p ;
...
position p;
@@
 struct sh_pfc_gpio_data_reg * cocci_id@p ;
...
position p;
@@
 struct sh_pfc_gpio_pin * cocci_id@p ;
...
typedef u32;
@@
 struct sh_pfc_gpio_data_reg {  const struct pinmux_data_reg * info ;  u32 shadow ; } cocci_id@p ;
...
position p;
@@
 struct sh_pfc_window * cocci_id@p ;
