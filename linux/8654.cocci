...
position p;
@@
 struct virtchnl_queue_select * cocci_id@p ;
...
position p;
@@
 struct virtchnl_rss_hena * cocci_id@p ;
...
position p;
@@
 struct virtchnl_vsi_queue_config_info * cocci_id@p ;
...
position p;
@@
 struct virtchnl_version_info * cocci_id@p ;
...
position p;
@@
 struct virtchnl_queue_pair_info * cocci_id@p ;
...
position p;
@@
 struct virtchnl_ether_addr_list * cocci_id@p ;
...
position p;
@@
 struct virtchnl_l4_spec cocci_id@p ;
...
position p;
@@
 struct virtchnl_iwarp_qvlist_info * cocci_id@p ;
...
position p;
@@
 struct virtchnl_rss_lut * cocci_id@p ;
...
position p;
@@
 struct virtchnl_irq_map_info * cocci_id@p ;
...
position p;
@@
 struct virtchnl_tc_info * cocci_id@p ;
...
position p;
@@
 struct virtchnl_promisc_info * cocci_id@p ;
...
position p;
@@
 enum i40e_queue_type cocci_id@p ;
...
position p;
@@
 struct virtchnl_txq_info * cocci_id@p ;
...
position p;
@@
 struct virtchnl_rss_key * cocci_id@p ;
...
position p;
@@
 struct virtchnl_vector_map * cocci_id@p ;
...
position p;
@@
 struct virtchnl_iwarp_qv_info * cocci_id@p ;
...
position p;
@@
 struct virtchnl_pf_event cocci_id@p ;
...
position p;
@@
 struct virtchnl_vf_res_request * cocci_id@p ;
...
position p;
@@
 enum virtchnl_link_speed cocci_id@p ;
...
position p;
@@
 struct virtchnl_vf_resource * cocci_id@p ;
...
position p;
@@
 struct virtchnl_filter * cocci_id@p ;
...
position p;
@@
 struct virtchnl_rxq_info * cocci_id@p ;
...
position p;
@@
 struct virtchnl_vlan_filter_list * cocci_id@p ;
