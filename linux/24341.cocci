...
position p;
@@
 struct smc_user_pnetentry * cocci_id@p ;
...
position p;
@@
 struct smc_pnetentry {  struct list_head list ;  char pnet_name [ SMC_MAX_PNETID_LEN + 1 ] ;  struct net_device * ndev ; } cocci_id@p ;
...
position p;
@@
 struct nla_policy cocci_id@p [ SMC_PNETID_MAX + 1 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ SMC_MAX_PNETID_LEN ] ;
...
typedef u8;
@@
 struct smc_user_pnetentry {  struct list_head list ;  char pnet_name [ SMC_MAX_PNETID_LEN + 1 ] ;  struct net_device * ndev ;  struct smc_ib_device * smcibdev ;  u8 ib_port ;  struct smcd_dev * smcd_dev ; } cocci_id@p ;
...
position p;
@@
 struct net_device * cocci_id@p ( struct net_device * ndev ) ;
...
position p;
@@
 struct smc_pnettable * cocci_id@p ;
...
position p;
@@
 struct smc_pnetentry * cocci_id@p ;
...
position p;
@@
 struct smc_ib_device * cocci_id@p ;
