...
position p;
@@
 const struct zx_tvenc_mode * cocci_id@p ;
...
position p;
@@
 struct zx_tvenc_pwrctrl * cocci_id@p ;
...
typedef u32;
@@
 struct zx_tvenc_pwrctrl {  struct regmap * regmap ;  u32 reg ;  u32 mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct zx_tvenc_mode {  struct drm_display_mode mode ;  u32 video_info ;  u32 video_res ;  u32 field1_param ;  u32 field2_param ;  u32 burst_line_odd1 ;  u32 burst_line_even1 ;  u32 burst_line_odd2 ;  u32 burst_line_even2 ;  u32 line_timing_param ;  u32 weight_value ;  u32 blank_black_level ;  u32 burst_level ;  u32 control_param ;  u32 sub_carrier_phase1 ;  u32 phase_line_incr_cvbs ; } cocci_id@p ;
...
position p;
@@
 struct zx_tvenc {  struct drm_connector connector ;  struct drm_encoder encoder ;  struct device * dev ;  void __iomem * mmio ;  const struct vou_inf * inf ;  struct zx_tvenc_pwrctrl pwrctrl ; } cocci_id@p ;
