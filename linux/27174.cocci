...
position p;
@@
 char cocci_id@p [ DLM_DEBUG_BUF_LEN ] ;
...
position p;
@@
 char cocci_id@p [ DLM_LOCKSPACE_LEN + 8 ] ;
...
position p;
@@
 struct rsbtbl_iter {  struct dlm_rsb * rsb ;  unsigned bucket ;  int format ;  int header ; } cocci_id@p ;
