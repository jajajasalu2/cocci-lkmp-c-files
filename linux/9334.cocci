...
position p;
@@
 struct wl128x_ini_fem_params_2 cocci_id@p ;
...
position p;
@@
 struct wl128x_radio_parms_cmd * cocci_id@p ;
...
position p;
@@
 struct wl12xx_conf_rf * cocci_id@p ;
...
position p;
@@
 struct wl1271_ini_fem_params_2 cocci_id@p ;
...
position p;
@@
 struct wl128x_general_parms_cmd * cocci_id@p ;
...
position p;
@@
 struct wl1271_ini_band_params_5 cocci_id@p ;
...
position p;
@@
 struct wl1271_ini_general_params * cocci_id@p ;
...
position p;
@@
 struct wl1271_ext_radio_parms_cmd * cocci_id@p ;
...
position p;
@@
 struct wl12xx_cmd_channel_switch * cocci_id@p ;
...
position p;
@@
 struct wl128x_ini_general_params * cocci_id@p ;
...
position p;
@@
 struct wl128x_nvs_file * cocci_id@p ;
...
position p;
@@
 struct wl1271_radio_parms_cmd * cocci_id@p ;
...
position p;
@@
 struct wl1271_ini_fem_params_5 cocci_id@p ;
...
position p;
@@
 struct wl128x_ini_band_params_5 cocci_id@p ;
...
position p;
@@
 struct wl128x_ini_band_params_2 cocci_id@p ;
...
position p;
@@
 struct wl1271_nvs_file * cocci_id@p ;
...
position p;
@@
 struct wl1271_ini_band_params_2 cocci_id@p ;
...
position p;
@@
 struct wl1271_general_parms_cmd * cocci_id@p ;
...
position p;
@@
 struct wl128x_ini_fem_params_5 cocci_id@p ;
