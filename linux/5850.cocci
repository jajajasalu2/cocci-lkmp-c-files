...
position p;
@@
 const struct platform_driver * cocci_id@p ;
...
position p;
@@
 const struct pinmux_range * cocci_id@p ;
...
position p;
@@
 struct sh_pfc_pin_range * cocci_id@p ;
...
position p;
@@
 const struct sh_pfc * cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct sh_pfc * pfc , u32 reg , unsigned int idx ) ;
...
position p;
@@
 const struct sh_pfc_function * cocci_id@p ;
