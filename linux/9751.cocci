...
position p;
@@
 struct ct_kill_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_dts_measurement_notif_v2 * cocci_id@p ;
...
position p;
@@
 const struct iwl_tt_params cocci_id@p ;
...
position p;
@@
 struct iwl_tt_params * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_ctdp_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_thermal_device * cocci_id@p ;
...
position p;
@@
 struct iwl_ext_dts_measurement_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_dts_measurement_notif_v1 * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_tt_mgmt * cocci_id@p ;
...
position p;
@@
 struct temp_report_ths_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_dts_measurement_cmd cocci_id@p ;
