...
typedef u32;
@@
 int cocci_id@p ( struct sis_video_info * ivideo , int modeindex , u32 vbflags ) ;
...
position p;
@@
 struct sisfb_monitor * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_var_screeninfo * var , int isactive , struct fb_info * info ) ;
...
typedef u8;
@@
 u8 cocci_id@p ( struct sis_video_info * ivideo , unsigned int rate , int index ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_info * info , unsigned int cmd , unsigned long arg ) ;
...
position p;
@@
 void cocci_id@p ( struct SIS_OH * pohList , struct SIS_OH * poh ) ;
...
position p;
@@
 void cocci_id@p ( struct SIS_OH * poh ) ;
...
typedef bool;
@@
 void cocci_id@p ( char * name , bool quiet ) ;
...
position p;
@@
 void cocci_id@p ( struct sis_video_info * ivideo , int val ) ;
...
position p;
@@
 int cocci_id@p ( struct fb_fix_screeninfo * fix , int con , struct fb_info * info ) ;
...
position p;
@@
 struct fb_fix_screeninfo * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int blank , struct fb_info * info ) ;
...
position p;
@@
 void cocci_id@p ( struct sis_video_info * ivideo , struct sisfb_cmd * sisfb_command ) ;
...
position p;
@@
 struct SIS_OH * cocci_id@p ( struct SIS_HEAP * memheap ) ;
...
position p;
@@
 const unsigned short cocci_id@p [ 17 ] [ 5 ] ;
...
typedef bool;
@@
 bool cocci_id@p ( struct sis_video_info * ivideo ) ;
...
typedef u32;
@@
 struct SIS_OH * cocci_id@p ( struct SIS_HEAP * memheap , u32 base ) ;
...
position p;
@@
 int cocci_id@p ( unsigned regno , unsigned red , unsigned green , unsigned blue , unsigned transp , struct fb_info * fb_info ) ;
...
position p;
@@
 void cocci_id@p ( struct SIS_HEAP * memheap , struct SIS_OH * poh ) ;
...
position p;
@@
 struct sisfb_chip_info * cocci_id@p ;
...
position p;
@@
 struct sis_video_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_info * info ) ;
...
position p;
@@
 void cocci_id@p ( struct sis_video_info * ivideo ) ;
...
position p;
@@
 int cocci_id@p ( struct sis_video_info * ivideo ) ;
...
typedef u32;
@@
 struct SIS_OH * cocci_id@p ( struct SIS_HEAP * memheap , u32 size ) ;
