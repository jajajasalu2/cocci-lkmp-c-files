...
typedef spinlock_t;
@@
 struct gsta_gpio {  spinlock_t lock ;  struct device * dev ;  void __iomem * reg_base ;  struct gsta_regs __iomem * regs [ GSTA_NR_BLOCKS ] ;  struct gpio_chip gpio ;  int irq_base ;  unsigned irq_type [ GSTA_NR_GPIO ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct gsta_regs {  u32 dat ;  u32 dats ;  u32 datc ;  u32 pdis ;  u32 dir ;  u32 dirs ;  u32 dirc ;  u32 unused_1c ;  u32 afsela ;  u32 unused_24 [ 7 ] ;  u32 rimsc ;  u32 fimsc ;  u32 is ;  u32 ic ; } cocci_id@p ;
...
position p;
@@
 struct sta2x11_gpio_pdata * cocci_id@p ;
