...
position p;
@@
 enum smbb_attr { ATTR_BAT_ISAFE , ATTR_BAT_IMAX , ATTR_USBIN_IMAX , ATTR_DCIN_IMAX , ATTR_BAT_VSAFE , ATTR_BAT_VMAX , ATTR_BAT_VMIN , ATTR_CHG_VDET , ATTR_VIN_MIN , _ATTR_CNT , } cocci_id@p ;
...
position p;
@@
 const struct smbb_charger_attr {  const char * name ;  unsigned int reg ;  unsigned int safe_reg ;  unsigned int max ;  unsigned int min ;  unsigned int fail_ok ;  int ( * hw_fn ) ( unsigned int ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct smbb_charger * cocci_id@p ;
...
position p;
@@
 const struct smbb_charger_attr * cocci_id@p ;
...
typedef irqreturn_t;
@@
 const struct smbb_irq {  const char * name ;  irqreturn_t ( * handler ) ( int , void * ) ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct reg_off_mask_default {  unsigned int offset ;  unsigned int mask ;  unsigned int value ;  unsigned int rev_mask ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct reg_off_mask_default * cocci_id@p ;
