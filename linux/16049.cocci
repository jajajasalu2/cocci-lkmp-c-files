...
position p;
@@
 struct pcl711_board {  const char * name ;  int n_aichan ;  int n_aochan ;  int maxirq ;  const struct comedi_lrange * ai_range_type ; } cocci_id@p ;
...
position p;
@@
 const struct pcl711_board * cocci_id@p ;
...
position p;
@@
 struct pcl711_board cocci_id@p ;
