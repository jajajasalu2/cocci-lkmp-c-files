...
position p;
@@
 struct tle62x0_state cocci_id@p ;
...
position p;
@@
 struct tle62x0_state {  struct spi_device * us ;  struct mutex lock ;  unsigned int nr_gpio ;  unsigned int gpio_state ;  unsigned char tx_buff [ 4 ] ;  unsigned char rx_buff [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct device_attribute * attr ) ;
...
position p;
@@
 struct tle62x0_pdata * cocci_id@p ;
