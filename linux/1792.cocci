...
typedef u16;
@@
 struct adjd_s311_data {  struct i2c_client * client ;  u16 * buffer ; } cocci_id@p ;
...
position p;
@@
 enum adjd_s311_channel_idx { IDX_RED , IDX_GREEN , IDX_BLUE , IDX_CLEAR , } cocci_id@p ;
...
position p;
@@
 struct adjd_s311_data * cocci_id@p ;
