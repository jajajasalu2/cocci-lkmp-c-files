...
position p;
@@
 const char * const cocci_id@p [ SCH5627_NO_IN ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ SCH5627_NO_FANS ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ SCH5627_NO_TEMPS ] ;
...
position p;
@@
 struct sch5627_data * cocci_id@p ;
...
typedef u8,u16;
@@
 struct sch5627_data {  unsigned short addr ;  struct device * hwmon_dev ;  struct sch56xx_watchdog_data * watchdog ;  u8 control ;  u8 temp_max [ SCH5627_NO_TEMPS ] ;  u8 temp_crit [ SCH5627_NO_TEMPS ] ;  u16 fan_min [ SCH5627_NO_FANS ] ;  struct mutex update_lock ;  unsigned long last_battery ;  char valid ;  unsigned long last_updated ;  u16 temp [ SCH5627_NO_TEMPS ] ;  u16 fan [ SCH5627_NO_FANS ] ;  u16 in [ SCH5627_NO_IN ] ; } cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ SCH5627_NO_IN ] ;
