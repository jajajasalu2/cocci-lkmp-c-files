...
position p;
@@
 enum mcp251x_model { CAN_MCP251X_MCP2510 = 0x2510 , CAN_MCP251X_MCP2515 = 0x2515 , CAN_MCP251X_MCP25625 = 0x25625 , } cocci_id@p ;
...
position p;
@@
 struct mcp251x_priv * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SPI_TRANSFER_BUF_LEN ] ;
