...
typedef u16;
@@
 struct mlxsw_sp_nve_mc_list_key {  u16 fid_index ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_TNQCR_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_nve_config cocci_id@p ;
...
typedef u32;
@@
 struct mlxsw_sp_nve_mc_record {  struct list_head list ;  enum mlxsw_sp_l3proto proto ;  unsigned int num_entries ;  struct mlxsw_sp * mlxsw_sp ;  struct mlxsw_sp_nve_mc_list * mc_list ;  const struct mlxsw_sp_nve_mc_record_ops * ops ;  u32 kvdl_index ;  struct mlxsw_sp_nve_mc_entry entries [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_TNDEM_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_nve_mc_list cocci_id@p ;
...
typedef u8,__be32;
@@
 struct mlxsw_sp_nve_mc_entry {  union {  __be32 addr4 ;  struct mlxsw_sp_nve_mc_ipv6_entry ipv6_entry ; } ;  u8 valid : 1 ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_TNEEM_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_TNQDR_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_TNUMT_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_nve_mc_list_key cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_nve_mc_record * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_nve_ops * cocci_id@p [ ] ;
...
position p;
@@
 enum mlxsw_sp_nve_type cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_nve_mc_list_key * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_nve_mc_record * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_nve_mc_record_ops cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_nve_mc_list {  struct list_head records_list ;  struct rhash_head ht_node ;  struct mlxsw_sp_nve_mc_list_key key ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_nve_mc_entry cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_nve * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_nve_mc_entry * cocci_id@p ;
...
typedef u32;
@@
 struct mlxsw_sp_nve_mc_ipv6_entry {  struct in6_addr addr6 ;  u32 addr6_kvdl_index ; } cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_tnumt_record_type cocci_id@p ;
