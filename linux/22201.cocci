...
position p;
@@
 enum hmm_pfn_value_e cocci_id@p ;
...
position p;
@@
 struct hmm_vma_walk {  struct hmm_range * range ;  struct dev_pagemap * pgmap ;  unsigned long last ;  unsigned int flags ; } cocci_id@p ;
...
position p;
@@
 struct hmm_vma_walk * cocci_id@p ;
...
position p;
@@
 const struct hmm_vma_walk * cocci_id@p ;
