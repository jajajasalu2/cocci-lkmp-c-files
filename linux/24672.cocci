...
position p;
@@
 const struct hash_netport4_elem * cocci_id@p ;
...
position p;
@@
 struct hash_netport6_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_netport6 * cocci_id@p ;
...
position p;
@@
 const struct hash_netport4 * cocci_id@p ;
...
position p;
@@
 struct hash_netport4_elem * cocci_id@p ;
...
typedef u8;
@@
 struct hash_netport6_elem {  union nf_inet_addr ip ;  __be16 port ;  u8 proto ;  u8 cidr : 7 ;  u8 nomatch : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct hash_netport6_elem * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct hash_netport4_elem {  __be32 ip ;  __be16 port ;  u8 proto ;  u8 cidr : 7 ;  u8 nomatch : 1 ; } cocci_id@p ;
