...
typedef u8;
@@
 struct fm3130 {  u8 reg_addr_time ;  u8 reg_addr_alarm ;  u8 regs [ 15 ] ;  struct i2c_msg msg [ 4 ] ;  struct i2c_client * client ;  struct rtc_device * rtc ;  int alarm_valid ;  int data_valid ; } cocci_id@p ;
