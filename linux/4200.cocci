...
position p;
@@
 struct hisi_inno_phy_port * cocci_id@p ;
...
position p;
@@
 struct hisi_inno_phy_port {  struct reset_control * utmi_rst ;  struct hisi_inno_phy_priv * priv ; } cocci_id@p ;
...
position p;
@@
 struct hisi_inno_phy_priv {  void __iomem * mmio ;  struct clk * ref_clk ;  struct reset_control * por_rst ;  struct hisi_inno_phy_port ports [ INNO_PHY_PORT_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct hisi_inno_phy_priv * cocci_id@p ;
