...
position p;
@@
 struct ip_vs_mh_dest_setup cocci_id@p ;
...
position p;
@@
 struct ip_vs_mh_lookup * cocci_id@p ;
...
position p;
@@
 struct ip_vs_mh_state cocci_id@p ;
...
position p;
@@
 struct ip_vs_mh_lookup {  struct ip_vs_dest __rcu * dest ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_mh_dest_setup {  unsigned int offset ;  unsigned int skip ;  unsigned int perm ;  int turns ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef hsiphash_key_t;
@@
 hsiphash_key_t * cocci_id@p ;
