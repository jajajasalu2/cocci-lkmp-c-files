...
position p;
@@
 struct aem_find_instance_req cocci_id@p ;
...
position p;
@@
 struct aem_find_instance_resp * cocci_id@p ;
...
position p;
@@
 struct aem_read_sensor_req cocci_id@p ;
...
position p;
@@
 const struct aem_rw_sensor_template * cocci_id@p ;
...
position p;
@@
 struct aem_read_sensor_resp * cocci_id@p ;
...
position p;
@@
 struct aem_driver_data cocci_id@p ;
...
position p;
@@
 const struct aem_ro_sensor_template * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct aem_data * data ) ;
...
position p;
@@
 void cocci_id@p ( struct ipmi_recv_msg * msg , void * user_msg_data ) ;
...
position p;
@@
 void cocci_id@p ( int iface , struct device * dev ) ;
...
position p;
@@
 void cocci_id@p ( struct aem_data * data ) ;
...
position p;
@@
 struct aem_find_firmware_resp cocci_id@p ;
...
typedef u8;
@@
 struct aem_iana_id {  u8 bytes [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct aem_ipmi_data cocci_id@p ;
...
position p;
@@
 struct aem_find_firmware_req cocci_id@p ;
...
position p;
@@
 struct aem_driver_data {  struct list_head aem_devices ;  struct ipmi_smi_watcher bmc_events ;  struct ipmi_user_hndl ipmi_hndlrs ; } cocci_id@p ;
...
position p;
@@
 struct aem_ipmi_data {  struct completion read_complete ;  struct ipmi_addr address ;  struct ipmi_user * user ;  int interface ;  struct kernel_ipmi_msg tx_message ;  long tx_msgid ;  void * rx_msg_data ;  unsigned short rx_msg_len ;  unsigned char rx_result ;  int rx_recv_type ;  struct device * bmc_device ; } cocci_id@p ;
...
position p;
@@
 struct aem_ro_sensor_template {  char * label ;  ssize_t ( * show ) ( struct device * dev , struct device_attribute * devattr , char * buf ) ;  int index ; } cocci_id@p ;
