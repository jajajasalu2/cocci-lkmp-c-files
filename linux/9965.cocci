...
position p;
@@
 struct cw1200_txpriv cocci_id@p ;
...
position p;
@@
 struct cw1200_queue_item * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cw1200_queue_skb_dtor_t;
@@
 cw1200_queue_skb_dtor_t cocci_id@p ;
...
position p;
@@
 struct cw1200_queue_stats * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cw1200_queue_item {  struct list_head head ;  struct sk_buff * skb ;  u32 packet_id ;  unsigned long queue_timestamp ;  unsigned long xmit_timestamp ;  struct cw1200_txpriv txpriv ;  u8 generation ; } cocci_id@p ;
