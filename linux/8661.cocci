...
typedef s32,u16;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , u16 offset , u16 words , u16 * data ) ;
...
position p;
@@
 enum ixgbe_bus_speed cocci_id@p ;
...
position p;
@@
 struct ixgbe_bus_info * cocci_id@p ;
...
typedef u32;
@@
 union {  struct ixgbe_hic_hdr hdr ;  u32 u32arr [ 1 ] ; } * cocci_id@p ;
...
position p;
@@
 struct ixgbe_addr_filter_info * cocci_id@p ;
...
position p;
@@
 struct ixgbe_hic_hdr cocci_id@p ;
...
position p;
@@
 struct ixgbe_thermal_sensor_data cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct ixgbe_hw * hw , u16 count ) ;
...
typedef s32,u16;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , u16 offset ) ;
...
position p;
@@
 struct ixgbe_hic_drv_info cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct ixgbe_hw * hw , u16 data , u16 count ) ;
...
position p;
@@
 enum ixgbe_bus_width cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ IXGBE_MVALS_IDX_LIMIT ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ IXGBE_EEPROM_PAGE_SIZE_MAX ] ;
...
position p;
@@
 void cocci_id@p ( struct ixgbe_hw * hw ) ;
...
position p;
@@
 struct ixgbe_eeprom_info * cocci_id@p ;
...
typedef s32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw ) ;
...
typedef u8,s32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , u8 * mc_addr ) ;
...
typedef s32,u32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , u32 ee_reg ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct ixgbe_hw * hw , u32 * eec ) ;
