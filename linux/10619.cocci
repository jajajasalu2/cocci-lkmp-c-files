...
position p;
@@
 struct i915_wa_list * cocci_id@p ;
...
typedef i915_reg_t;
@@
 struct regmask {  i915_reg_t reg ;  unsigned long gen_mask ; } cocci_id@p ;
...
position p;
@@
 struct wa_lists {  struct i915_wa_list gt_wa_list ;  struct {  struct i915_wa_list wa_list ;  struct i915_wa_list ctx_wa_list ; } engine [ I915_NUM_ENGINES ] ; } cocci_id@p ;
...
position p;
@@
 struct {  struct i915_gem_context * ctx ;  struct i915_vma * scratch [ 2 ] ; } cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct regmask * cocci_id@p ;
...
position p;
@@
 enum intel_platform cocci_id@p ;
...
typedef u32;
@@
 const struct wo_register {  enum intel_platform platform ;  u32 reg ; } cocci_id@p [ ] ;
