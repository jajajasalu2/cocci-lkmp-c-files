...
position p;
@@
 struct lp8860_led {  struct mutex lock ;  struct i2c_client * client ;  struct led_classdev led_dev ;  struct regmap * regmap ;  struct regmap * eeprom_regmap ;  struct gpio_desc * enable_gpio ;  struct regulator * regulator ; } cocci_id@p ;
...
typedef uint8_t;
@@
 struct lp8860_eeprom_reg {  uint8_t reg ;  uint8_t value ; } cocci_id@p ;
...
position p;
@@
 struct lp8860_eeprom_reg cocci_id@p [ ] ;
