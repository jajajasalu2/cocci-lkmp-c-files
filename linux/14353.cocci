...
position p;
@@
 enum atscmh_rs_frame_ensemble * cocci_id@p ;
...
position p;
@@
 struct lg216x_state * cocci_id@p ;
...
position p;
@@
 enum atscmh_rs_frame_mode * cocci_id@p ;
...
position p;
@@
 enum atscmh_rs_code_mode cocci_id@p ;
...
typedef u8,u32;
@@
 struct lg216x_state {  struct i2c_adapter * i2c_adap ;  const struct lg2160_config * cfg ;  struct dvb_frontend frontend ;  u32 current_frequency ;  u8 parade_id ;  u8 fic_ver ;  unsigned int last_reset ; } cocci_id@p ;
...
position p;
@@
 enum atscmh_sccc_block_mode * cocci_id@p ;
...
position p;
@@
 enum atscmh_sccc_code_mode * cocci_id@p ;
...
typedef u8,u16;
@@
 struct lg216x_reg {  u16 reg ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 const struct lg2160_config * cocci_id@p ;
