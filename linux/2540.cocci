...
position p;
@@
 struct log_write_entry cocci_id@p ;
...
position p;
@@
 struct pending_block cocci_id@p ;
...
position p;
@@
 struct log_writes_c cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,wait_queue_head_t,sector_t,spinlock_t,atomic_t;
@@
 struct log_writes_c {  struct dm_dev * dev ;  struct dm_dev * logdev ;  u64 logged_entries ;  u32 sectorsize ;  u32 sectorshift ;  atomic_t io_blocks ;  atomic_t pending_blocks ;  sector_t next_sector ;  sector_t end_sector ;  bool logging_enabled ;  bool device_supports_discard ;  spinlock_t blocks_lock ;  struct list_head unflushed_blocks ;  struct list_head logging_blocks ;  wait_queue_head_t wait ;  struct task_struct * log_kthread ;  struct completion super_done ; } cocci_id@p ;
...
position p;
@@
 struct log_write_super cocci_id@p ;
...
typedef __le64;
@@
 struct log_write_entry {  __le64 sector ;  __le64 nr_sectors ;  __le64 flags ;  __le64 data_len ; } cocci_id@p ;
...
@@
 struct log_write_super {  __le64 magic ;  __le64 version ;  __le64 nr_entries ;  __le32 sectorsize ; } cocci_id@p ;
...
position p;
@@
 struct per_bio_data {  struct pending_block * block ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u32,sector_t;
@@
 struct pending_block {  int vec_cnt ;  u64 flags ;  sector_t sector ;  sector_t nr_sectors ;  char * data ;  u32 datalen ;  struct list_head list ;  struct bio_vec vecs [ 0 ] ; } cocci_id@p ;
