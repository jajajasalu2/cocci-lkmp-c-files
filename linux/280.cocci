...
typedef ktime_t;
@@
 ktime_t * cocci_id@p [ TK_OFFS_MAX ] ;
...
position p;
@@
 struct system_time_snapshot * cocci_id@p ;
...
position p;
@@
 struct tk_read_base * cocci_id@p ;
...
position p;
@@
 const struct timekeeper * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef system_counterval_t,ktime_t;
@@
 int ( * cocci_id@p ) ( ktime_t * device_time , struct system_counterval_t * sys_counterval , void * ctx ) ;
...
typedef seqcount_t;
@@
 struct {  seqcount_t seq ;  struct timekeeper timekeeper ; } cocci_id@p ;
...
position p;
@@
 struct system_device_crosststamp * cocci_id@p ;
...
position p;
@@
 const struct tk_read_base * cocci_id@p ;
...
position p;
@@
 enum timekeeping_adv_mode { TK_ADV_TICK , TK_ADV_FREQ , } cocci_id@p ;
...
position p;
@@
 struct audit_ntp_data cocci_id@p ;
...
position p;
@@
 enum timekeeping_adv_mode cocci_id@p ;
...
symbol cocci_id;
position p;
typedef system_counterval_t;
@@
 struct system_counterval_t cocci_id@p ;
...
typedef seqcount_t;
@@
 struct tk_fast {  seqcount_t seq ;  struct tk_read_base base [ 2 ] ; } cocci_id@p ;
