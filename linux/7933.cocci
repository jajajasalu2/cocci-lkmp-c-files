...
@@
 struct usb_api_data {  wait_queue_head_t wqh ;  int done ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_device * usb_dev , unsigned int pipe , struct usb_ctrlrequest * cmd , void * data , int len , int timeout ) ;
...
typedef __u16;
@@
 struct usb_eth_dev {  char * name ;  __u16 vendor ;  __u16 device ;  void * pdata ; } cocci_id@p ;
...
position p;
@@
 struct kaweth_device * cocci_id@p ;
...
position p;
@@
 struct usb_api_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kaweth_device * kaweth ) ;
...
symbol cocci_id;
position p;
typedef __u16,__u32,__u8,wait_queue_head_t,spinlock_t,dma_addr_t;
@@
 struct kaweth_device {  spinlock_t device_lock ;  __u32 status ;  int end ;  int suspend_lowmem_rx ;  int suspend_lowmem_ctrl ;  int linkstate ;  int opened ;  struct delayed_work lowmem_work ;  struct usb_device * dev ;  struct usb_interface * intf ;  struct net_device * net ;  wait_queue_head_t term_wait ;  struct urb * rx_urb ;  struct urb * tx_urb ;  struct urb * irq_urb ;  dma_addr_t intbufferhandle ;  __u8 * intbuffer ;  dma_addr_t rxbufferhandle ;  __u8 * rx_buf ;  struct sk_buff * tx_skb ;  __u8 * firmware_buf ;  __u8 scratch [ KAWETH_SCRATCH_SIZE ] ;  __u16 packet_filter_bitmap ;  struct kaweth_ethernet_configuration configuration ; } cocci_id@p ;
