...
position p;
@@
 const struct tb_property_entry * cocci_id@p ;
...
position p;
@@
 enum tb_property_type cocci_id@p ;
...
position p;
@@
 struct tb_property_rootdir_entry cocci_id@p ;
...
position p;
@@
 struct tb_property_entry * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ TB_PROPERTY_KEY_SIZE + 1 ] ;
...
typedef u8,u32,u16;
@@
 struct tb_property_entry {  u32 key_hi ;  u32 key_lo ;  u16 length ;  u8 reserved ;  u8 type ;  u32 value ; } cocci_id@p ;
...
typedef u32;
@@
 struct tb_property_dir_entry {  u32 uuid [ 4 ] ;  struct tb_property_entry entries [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct tb_property_rootdir_entry * cocci_id@p ;
...
typedef u32;
@@
 struct tb_property_rootdir_entry {  u32 magic ;  u32 length ;  struct tb_property_entry entries [ ] ; } cocci_id@p ;
...
position p;
@@
 struct tb_property_dir_entry * cocci_id@p ;
