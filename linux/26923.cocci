...
position p;
@@
 const struct nfs3_readlinkargs * cocci_id@p ;
...
position p;
@@
 struct nfs3_getaclres * cocci_id@p ;
...
position p;
@@
 const struct nfs3_mkdirargs * cocci_id@p ;
...
position p;
@@
 const struct nfs3_linkargs * cocci_id@p ;
...
position p;
@@
 struct nfs3_accessres * cocci_id@p ;
...
position p;
@@
 struct nfs3_readdirres * cocci_id@p ;
...
position p;
@@
 struct nfs3_linkres * cocci_id@p ;
...
position p;
@@
 const struct nfs3_sattrargs * cocci_id@p ;
...
position p;
@@
 const struct nfs3_readdirargs * cocci_id@p ;
...
position p;
@@
 const struct nfs3_getaclargs * cocci_id@p ;
...
position p;
@@
 const struct nfs3_diropargs * cocci_id@p ;
...
position p;
@@
 const struct nfs3_setaclargs * cocci_id@p ;
...
position p;
@@
 const struct nfs3_mknodargs * cocci_id@p ;
...
position p;
@@
 struct nfs3_diropres * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( nfs3_acl_procedures ) ] ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( nfs3_procedures ) ] ;
...
position p;
@@
 const struct nfs3_symlinkargs * cocci_id@p ;
...
position p;
@@
 const struct nfs3_accessargs * cocci_id@p ;
...
position p;
@@
 const struct nfs3_createargs * cocci_id@p ;
