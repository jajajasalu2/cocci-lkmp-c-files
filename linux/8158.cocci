...
position p;
@@
 enum nsim_resource_id cocci_id@p [ ] ;
...
position p;
@@
 struct nsim_per_fib_data {  struct nsim_fib_entry fib ;  struct nsim_fib_entry rules ; } cocci_id@p ;
...
position p;
@@
 struct nsim_fib_data {  struct notifier_block fib_nb ;  struct nsim_per_fib_data ipv4 ;  struct nsim_per_fib_data ipv6 ; } cocci_id@p ;
...
position p;
@@
 struct nsim_fib_entry * cocci_id@p ;
...
position p;
@@
 struct nsim_fib_data * cocci_id@p ;
...
typedef u64;
@@
 struct nsim_fib_entry {  u64 max ;  u64 num ; } cocci_id@p ;
