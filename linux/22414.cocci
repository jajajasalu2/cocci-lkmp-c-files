...
position p;
@@
 const char * const cocci_id@p [ 11 ] ;
...
position p;
@@
 const char * const cocci_id@p [ 16 ] ;
...
typedef u16;
@@
 struct xonar_wm87x6 {  struct xonar_generic generic ;  u16 wm8776_regs [ 0x17 ] ;  u16 wm8766_regs [ 0x10 ] ;  struct snd_kcontrol * line_adcmux_control ;  struct snd_kcontrol * mic_adcmux_control ;  struct snd_kcontrol * lc_controls [ 13 ] ;  struct snd_jack * hp_jack ;  struct xonar_hdmi hdmi ; } cocci_id@p ;
...
position p;
@@
 struct xonar_wm87x6 cocci_id@p ;
