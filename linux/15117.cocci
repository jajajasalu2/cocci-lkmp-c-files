...
position p;
@@
 void cocci_id@p ( struct clk_hw * hw , struct dentry * dentry ) ;
...
position p;
@@
 struct davinci_pll_platform_data * cocci_id@p ;
...
position p;
@@
 struct davinci_pllen_clk * cocci_id@p ;
...
typedef u32;
@@
 struct davinci_pll_clk {  struct clk_hw hw ;  void __iomem * base ;  u32 pllm_min ;  u32 pllm_max ;  u32 pllm_mask ; } cocci_id@p ;
...
position p;
@@
 struct davinci_pll_clk cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device * dev , void __iomem * base , struct regmap * cfgchip ) ;
...
position p;
@@
 const struct davinci_pll_sysclk_info * cocci_id@p ;
...
position p;
@@
 struct davinci_pllen_clk {  struct clk_hw hw ;  void __iomem * base ; } cocci_id@p ;
...
position p;
@@
 const struct davinci_pll_obsclk_info * cocci_id@p ;
...
position p;
@@
 const struct davinci_pll_clk_info * cocci_id@p ;
