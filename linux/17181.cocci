...
typedef u32;
@@
 struct mpc83xx_pcie_priv {  void __iomem * cfg_type0 ;  void __iomem * cfg_type1 ;  u32 dev_base ; } cocci_id@p ;
...
position p;
@@
 struct mpc83xx_pcie_priv * cocci_id@p ;
...
typedef u32;
@@
 struct pex_inbound_window {  u32 ar ;  u32 tar ;  u32 barl ;  u32 barh ; } cocci_id@p ;
...
position p;
@@
 struct mpc85xx_edac_pci_plat_data cocci_id@p ;
...
position p;
@@
 struct pex_inbound_window * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct pci_bus * , unsigned int , int , int , u32 * ) ;
