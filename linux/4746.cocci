...
position p;
@@
 struct page * cocci_id@p [ MAX_ARRAY ] ;
...
position p;
@@
 struct kvec cocci_id@p [ MAX_ARRAY ] ;
...
position p;
@@
 struct siw_rreq_pkt cocci_id@p ;
...
symbol cocci_id;
position p;
typedef tx_task_t,wait_queue_head_t;
@@
 struct tx_task_t {  struct llist_head active ;  wait_queue_head_t waiting ; } cocci_id@p ;
