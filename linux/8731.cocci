...
position p;
@@
 struct iwarp_modify_qp_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_ep cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_info * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_ll2_buff * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_send_rtr_in * cocci_id@p ;
...
position p;
@@
 enum qed_iwarp_mpa_pkt_type { QED_IWARP_MPA_PKT_PACKED , QED_IWARP_MPA_PKT_PARTIAL , QED_IWARP_MPA_PKT_UNALIGNED , } cocci_id@p ;
...
position p;
@@
 struct qed_rdma_events cocci_id@p ;
...
position p;
@@
 struct qed_ll2_tx_pkt_info cocci_id@p ;
...
position p;
@@
 struct iwarp_mpa_offload_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct mpa_v2_hdr {  __be16 ird ;  __be16 ord ; } cocci_id@p ;
...
position p;
@@
 struct qed_ll2_comp_rx_data * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_listen_in * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_ll2_mpa_buf * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_fpdu * cocci_id@p ;
...
position p;
@@
 struct iwarp_create_qp_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_rdma_start_in_params * cocci_id@p ;
...
position p;
@@
 enum qed_iwarp_qp_state cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_connect_out * cocci_id@p ;
...
position p;
@@
 struct qed_rdma_device * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_accept_in * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qed_hwfn * p_hwfn , struct qed_iwarp_fpdu * fpdu , struct qed_iwarp_ll2_buff * buf ) ;
...
position p;
@@
 struct unaligned_opaque_data cocci_id@p ;
...
position p;
@@
 struct tcp_offload_params_opt2 * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_cm_info * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_listen_out * cocci_id@p ;
...
position p;
@@
 struct iwarp_tcp_offload_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_cm_event_params cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_reject_in * cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 two_ports ;  u32 four_ports ; } cocci_id@p [ MAX_CHIP_IDS ] ;
...
position p;
@@
 struct qed_iwarp_listener * cocci_id@p ;
...
typedef u8,u16;
@@
 int cocci_id@p ( struct qed_hwfn * p_hwfn , u8 fw_event_code , u16 echo , union event_ring_data * data , u8 fw_return_code ) ;
...
position p;
@@
 enum qed_iwarp_mpa_pkt_type cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_ep_memory cocci_id@p ;
...
position p;
@@
 struct iwarp_init_func_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_iwarp_connect_in * cocci_id@p ;
...
position p;
@@
 struct qed_ll2_acquire_data cocci_id@p ;
