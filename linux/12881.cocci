...
typedef bool;
@@
 struct axp_mc_drvdata {  void __iomem * base ;  unsigned int width ;  bool cs_addr_sel [ SDRAM_NUM_CS ] ;  char msg [ 128 ] ; } cocci_id@p ;
...
@@
 struct aurora_l2_drvdata {  void __iomem * base ;  char msg [ 128 ] ;  uint32_t inject_addr ;  uint32_t inject_mask ;  uint8_t inject_ctl ;  struct dentry * debugfs ; } cocci_id@p ;
...
position p;
@@
 struct axp_mc_drvdata * cocci_id@p ;
...
position p;
@@
 struct aurora_l2_drvdata * cocci_id@p ;
