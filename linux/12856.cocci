...
position p;
@@
 enum e752x_chips { E7520 = 0 , E7525 = 1 , E7320 = 2 , I3100 = 3 , } cocci_id@p ;
...
typedef u32,u16;
@@
 struct scrubrate {  u32 bandwidth ;  u16 scrubval ; } cocci_id@p ;
...
typedef u16;
@@
 struct e752x_dev_info {  u16 err_dev ;  u16 ctl_dev ;  const char * ctl_name ; } cocci_id@p ;
...
position p;
@@
 const struct e752x_dev_info cocci_id@p [ ] ;
...
position p;
@@
 struct e752x_error_info cocci_id@p ;
...
position p;
@@
 const struct scrubrate cocci_id@p [ ] ;
...
position p;
@@
 struct edac_pci_ctl_info * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct e752x_error_info {  u32 ferr_global ;  u32 nerr_global ;  u32 nsi_ferr ;  u32 nsi_nerr ;  u8 hi_ferr ;  u8 hi_nerr ;  u16 sysbus_ferr ;  u16 sysbus_nerr ;  u8 buf_ferr ;  u8 buf_nerr ;  u16 dram_ferr ;  u16 dram_nerr ;  u32 dram_sec1_add ;  u32 dram_sec2_add ;  u16 dram_sec1_syndrome ;  u16 dram_sec2_syndrome ;  u32 dram_ded_add ;  u32 dram_scrb_add ;  u32 dram_retr_add ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct e752x_pvt {  struct pci_dev * dev_d0f0 ;  struct pci_dev * dev_d0f1 ;  u32 tolm ;  u32 remapbase ;  u32 remaplimit ;  int mc_symmetric ;  u8 map [ 8 ] ;  int map_type ;  const struct e752x_dev_info * dev_info ; } cocci_id@p ;
