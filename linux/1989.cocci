...
@@
 struct ad5449 {  struct spi_device * spi ;  const struct ad5449_chip_info * chip_info ;  struct regulator_bulk_data vref_reg [ AD5449_MAX_VREFS ] ;  bool has_sdo ;  uint16_t dac_cache [ AD5449_MAX_CHANNELS ] ;  __be16 data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum ad5449_type { ID_AD5426 , ID_AD5429 , ID_AD5432 , ID_AD5439 , ID_AD5443 , ID_AD5449 , } cocci_id@p ;
...
position p;
@@
 const struct ad5449_chip_info cocci_id@p [ ] ;
...
typedef bool;
@@
 struct ad5449_chip_info {  const struct iio_chan_spec * channels ;  unsigned int num_channels ;  bool has_ctrl ; } cocci_id@p ;
...
position p;
@@
 struct ad5449_platform_data * cocci_id@p ;
