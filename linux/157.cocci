...
position p;
@@
 struct reorder_lock {  struct list_head link ;  struct ww_mutex * lock ; } cocci_id@p ;
...
typedef bool;
@@
 struct test_abba {  struct work_struct work ;  struct ww_mutex a_mutex ;  struct ww_mutex b_mutex ;  struct completion a_ready ;  struct completion b_ready ;  bool resolve ;  int result ; } cocci_id@p ;
...
position p;
@@
 struct test_cycle {  struct work_struct work ;  struct ww_mutex a_mutex ;  struct ww_mutex * b_mutex ;  struct completion * a_signal ;  struct completion b_signal ;  int result ; } cocci_id@p ;
...
position p;
@@
 struct reorder_lock * cocci_id@p ;
...
position p;
@@
 struct stress {  struct work_struct work ;  struct ww_mutex * locks ;  unsigned long timeout ;  int nlocks ; } cocci_id@p ;
