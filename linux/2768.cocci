...
typedef u8;
@@
 struct chip_desc {  u8 nchans ;  u8 num_gpios ; } cocci_id@p ;
...
position p;
@@
 enum ltc_type { ltc_4305 , ltc_4306 , } cocci_id@p ;
...
position p;
@@
 struct ltc4306 {  struct regmap * regmap ;  struct gpio_chip gpiochip ;  const struct chip_desc * chip ; } cocci_id@p ;
