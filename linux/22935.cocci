...
position p;
@@
 struct pcm_format_data {  unsigned char width ;  unsigned char phys ;  signed char le ;  signed char signd ;  unsigned char silence [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct pcm_format_data cocci_id@p [ ( INT ) SNDRV_PCM_FORMAT_LAST + 1 ] ;
