...
position p;
@@
 const struct acpi_db_command_info cocci_id@p [ ] ;
...
typedef u32;
@@
 u32 cocci_id@p ( char * input_buffer ) ;
...
position p;
@@
 struct acpi_new_table_desc * cocci_id@p ;
...
position p;
@@
 const struct acpi_db_command_help cocci_id@p [ ] ;
...
typedef u8;
@@
 u8 cocci_id@p ( const char * command , const struct acpi_db_command_help * help ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( char * user_command ) ;
...
typedef u8;
@@
 void cocci_id@p ( const char * command , u8 display_all ) ;
