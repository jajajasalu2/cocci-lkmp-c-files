...
position p;
@@
 enum tis_status { TPM_STS_VALID = 0x80 , TPM_STS_COMMAND_READY = 0x40 , TPM_STS_GO = 0x20 , TPM_STS_DATA_AVAIL = 0x10 , TPM_STS_DATA_EXPECT = 0x08 , } cocci_id@p ;
...
position p;
@@
 enum tis_access { TPM_ACCESS_VALID = 0x80 , TPM_ACCESS_ACTIVE_LOCALITY = 0x20 , TPM_ACCESS_REQUEST_PENDING = 0x04 , TPM_ACCESS_REQUEST_USE = 0x02 , } cocci_id@p ;
...
typedef u8;
@@
 struct tpm_inf_dev {  struct i2c_client * client ;  int locality ;  u8 buf [ TPM_I2C_INFINEON_BUFSIZE + 1 ] ;  struct tpm_chip * chip ;  enum i2c_chip_type chip_type ;  unsigned int adapterlimit ; } cocci_id@p ;
...
position p;
@@
 enum i2c_chip_type { SLB9635 , SLB9645 , UNKNOWN , } cocci_id@p ;
...
position p;
@@
 enum tis_defaults { TIS_SHORT_TIMEOUT = 750 , TIS_LONG_TIMEOUT = 2000 , } cocci_id@p ;
