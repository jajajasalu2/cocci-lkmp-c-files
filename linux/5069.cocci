...
position p;
@@
 struct rpi_exp_gpio {  struct gpio_chip gc ;  struct rpi_firmware * fw ; } cocci_id@p ;
...
typedef u32;
@@
 struct gpio_get_config {  u32 gpio ;  u32 direction ;  u32 polarity ;  u32 term_en ;  u32 term_pull_up ; } cocci_id@p ;
...
typedef u32;
@@
 struct gpio_get_set_state {  u32 gpio ;  u32 state ; } cocci_id@p ;
...
position p;
@@
 struct gpio_set_config cocci_id@p ;
...
position p;
@@
 struct gpio_get_config cocci_id@p ;
...
position p;
@@
 struct rpi_exp_gpio * cocci_id@p ;
...
typedef u32;
@@
 struct gpio_set_config {  u32 gpio ;  u32 direction ;  u32 polarity ;  u32 term_en ;  u32 term_pull_up ;  u32 state ; } cocci_id@p ;
...
position p;
@@
 struct gpio_get_set_state cocci_id@p ;
