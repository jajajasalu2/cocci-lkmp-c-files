...
position p;
@@
 struct spmi_pmic_div_clk_cc {  int nclks ;  struct clkdiv clks [ ] ; } cocci_id@p ;
...
@@
 struct clkdiv {  struct regmap * regmap ;  u16 base ;  spinlock_t lock ;  struct clk_hw hw ;  unsigned int cxo_period_ns ; } cocci_id@p ;
...
position p;
@@
 struct spmi_pmic_div_clk_cc * cocci_id@p ;
