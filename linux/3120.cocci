...
position p;
@@
 struct meta_data_on_disk cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct drbd_device * , int ) ;
...
position p;
@@
 struct completion_work {  struct drbd_work w ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 struct fault_random_state * cocci_id@p ;
...
position p;
@@
 struct completion_work cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct drbd_thread * ) ;
...
position p;
@@
 struct retry_worker cocci_id@p ;
...
position p;
@@
 enum drbd_thread_state cocci_id@p ;
...
position p;
@@
 struct fault_random_state {  unsigned long state ;  unsigned long count ; } cocci_id@p ;
...
position p;
@@
 struct drbd_work_queue * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct retry_worker {  struct workqueue_struct * wq ;  struct work_struct worker ;  spinlock_t lock ;  struct list_head writes ; } cocci_id@p ;
