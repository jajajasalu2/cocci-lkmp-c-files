...
position p;
@@
 int cocci_id@p ( deflate_state * s ) ;
...
position p;
@@
 void cocci_id@p ( deflate_state * s , ct_data * tree , int max_code ) ;
...
position p;
@@
 const int cocci_id@p [ LENGTH_CODES ] ;
...
position p;
@@
 uch cocci_id@p [ MAX_MATCH - MIN_MATCH + 1 ] ;
...
position p;
@@
 void cocci_id@p ( deflate_state * s , ct_data * ltree , ct_data * dtree ) ;
...
position p;
@@
 void cocci_id@p ( deflate_state * s , tree_desc * desc ) ;
...
position p;
@@
 struct static_tree_desc_s {  const ct_data * static_tree ;  const int * extra_bits ;  int extra_base ;  int elems ;  int max_length ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( deflate_state * s , char * buf , unsigned len , int header ) ;
...
position p;
@@
 void cocci_id@p ( deflate_state * s , int lcodes , int dcodes , int blcodes ) ;
...
position p;
@@
 void cocci_id@p ( deflate_state * s ) ;
...
position p;
@@
 void cocci_id@p ( deflate_state * s , ct_data * tree , int k ) ;
...
position p;
@@
 void cocci_id@p ( ct_data * tree , int max_code , ush * bl_count ) ;
...
position p;
@@
 void cocci_id@p ( deflate_state * s , int value , int length ) ;
