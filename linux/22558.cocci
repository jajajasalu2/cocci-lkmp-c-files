...
position p;
@@
 struct best_voice cocci_id@p [ V_END ] ;
...
position p;
@@
 struct snd_emux_voice * cocci_id@p ( struct snd_emux * emux , struct snd_emux_port * port ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_emu10k1 * hw , struct snd_emux_voice * vp ) ;
...
position p;
@@
 struct snd_emu10k1_voice * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_emux * emux , struct snd_emu10k1 * hw , struct best_voice * best , int active_only ) ;
...
position p;
@@
 struct best_voice {  unsigned int time ;  int voice ; } cocci_id@p ;
...
position p;
@@
 struct snd_emu10k1_memblk * cocci_id@p ;
...
position p;
@@
 enum { V_FREE = 0 , V_OFF , V_RELEASED , V_PLAYING , V_END , } cocci_id@p ;
