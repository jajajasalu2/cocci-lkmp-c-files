...
position p;
@@
 enum bfqg_stats_flags { BFQG_stats_waiting = 0 , BFQG_stats_idling , BFQG_stats_empty , } cocci_id@p ;
...
position p;
@@
 struct bfq_group_data cocci_id@p ;
...
position p;
@@
 struct bfq_service_tree * cocci_id@p ;
