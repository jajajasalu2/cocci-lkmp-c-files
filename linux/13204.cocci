...
position p;
@@
 struct cobalt_buffer * cocci_id@p ;
...
position p;
@@
 struct sg_dma_desc_info * cocci_id@p [ NR_BUFS ] ;
...
position p;
@@
 struct cobalt_stream * cocci_id@p ;
...
position p;
@@
 struct sg_dma_desc_info * cocci_id@p ;
