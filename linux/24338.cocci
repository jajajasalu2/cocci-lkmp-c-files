...
position p;
@@
 int ( * cocci_id@p ) ( struct smc_connection * conn ) ;
...
position p;
@@
 struct smc_spd_priv {  struct smc_sock * smc ;  size_t len ; } cocci_id@p ;
...
position p;
@@
 struct smc_spd_priv * cocci_id@p ;
...
position p;
@@
 struct smc_cdc_conn_state_flags * cocci_id@p ;
