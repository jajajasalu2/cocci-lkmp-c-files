...
@@
 struct atmel_spi {  spinlock_t lock ;  unsigned long flags ;  phys_addr_t phybase ;  void __iomem * regs ;  int irq ;  struct clk * clk ;  struct platform_device * pdev ;  unsigned long spi_clk ;  struct spi_transfer * current_transfer ;  int current_remaining_bytes ;  int done_status ;  dma_addr_t dma_addr_rx_bbuf ;  dma_addr_t dma_addr_tx_bbuf ;  void * addr_rx_bbuf ;  void * addr_tx_bbuf ;  struct completion xfer_completion ;  struct atmel_spi_caps caps ;  bool use_dma ;  bool use_pdc ;  bool keep_cs ;  u32 fifo_size ;  u8 native_cs_free ;  u8 native_cs_for_gpio ; } cocci_id@p ;
...
typedef bool;
@@
 struct atmel_spi_caps {  bool is_spi2 ;  bool has_wdrbt ;  bool has_dma_support ;  bool has_pdc_support ; } cocci_id@p ;
...
typedef u32;
@@
 struct atmel_spi_device {  u32 csr ; } cocci_id@p ;
...
position p;
@@
 struct atmel_spi_device cocci_id@p ;
