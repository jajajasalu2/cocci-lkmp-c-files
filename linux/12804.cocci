...
position p;
@@
 const struct etr_buf_operations * cocci_id@p [ ] ;
...
typedef dma_addr_t;
@@
 struct etr_flat_buf {  struct device * dev ;  dma_addr_t daddr ;  void * vaddr ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 struct etr_sg_table * cocci_id@p ;
...
typedef bool,pid_t;
@@
 struct etr_perf_buffer {  struct tmc_drvdata * drvdata ;  struct etr_buf * etr_buf ;  pid_t pid ;  bool snapshot ;  unsigned long head ;  int nr_pages ;  void * * pages ; } cocci_id@p ;
...
position p;
@@
 struct etr_flat_buf * cocci_id@p ;
...
position p;
@@
 struct etr_perf_buffer * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct etr_sg_table {  struct tmc_sg_table * sg_table ;  dma_addr_t hwaddr ; } cocci_id@p ;
...
position p;
@@
 struct tmc_sg_table * cocci_id@p ;
...
position p;
@@
 const struct coresight_ops_sink cocci_id@p ;
