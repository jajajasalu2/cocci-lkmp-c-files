...
position p;
@@
 struct netlink_compare_arg * cocci_id@p ;
...
position p;
@@
 struct netlink_sock cocci_id@p ;
...
position p;
@@
 struct netlink_broadcast_data cocci_id@p ;
...
position p;
@@
 struct netlink_tap_net cocci_id@p ;
...
position p;
@@
 struct netlink_skb_parms cocci_id@p ;
...
position p;
@@
 struct netlink_table * cocci_id@p ;
...
typedef u32;
@@
 struct netlink_set_err_data {  struct sock * exclude_sk ;  u32 portid ;  u32 group ;  int code ; } cocci_id@p ;
...
position p;
@@
 struct listeners {  struct rcu_head rcu ;  unsigned long masks [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct netlink_skb_parms * cocci_id@p ;
...
position p;
@@
 const struct socket * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sk_buff * , struct nlmsghdr * , struct netlink_ext_ack * ) ;
...
position p;
@@
 struct netlink_set_err_data * cocci_id@p ;
...
position p;
@@
 struct lock_class_key cocci_id@p [ MAX_LINKS ] ;
...
position p;
@@
 struct netlink_tap_net {  struct list_head netlink_tap_all ;  struct mutex netlink_tap_lock ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct net * net , int group ) ;
...
position p;
@@
 const struct netlink_sock * cocci_id@p ;
...
position p;
@@
 struct nl_seq_iter {  struct seq_net_private p ;  struct rhashtable_iter hti ;  int link ; } cocci_id@p ;
...
position p;
@@
 const struct netlink_compare_arg * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ MAX_LINKS + 1 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sock * dsk , struct sk_buff * skb , void * data ) ;
...
position p;
@@
 const struct netlink_ext_ack * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,possible_net_t;
@@
 struct netlink_compare_arg {  possible_net_t pnet ;  u32 portid ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net * net , int group ) ;
