...
position p;
@@
 struct rockchip_dfi cocci_id@p ;
...
position p;
@@
 struct rockchip_dfi {  struct devfreq_event_dev * edev ;  struct devfreq_event_desc * desc ;  struct dmc_usage ch_usage [ RK3399_DMC_NUM_CH ] ;  struct device * dev ;  void __iomem * regs ;  struct regmap * regmap_pmu ;  struct clk * clk ; } cocci_id@p ;
...
typedef u32;
@@
 struct dmc_usage {  u32 access ;  u32 total ; } cocci_id@p ;
