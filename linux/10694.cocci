...
position p;
@@
 const struct gmbus_pin * cocci_id@p ;
...
position p;
@@
 struct gmbus_pin {  const char * name ;  enum i915_gpio gpio ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ DRM_HDCP_KSV_LEN ] ;
