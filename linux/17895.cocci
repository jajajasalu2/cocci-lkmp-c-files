...
position p;
@@
 int cocci_id@p ( unsigned long * dst_addr , int size , unsigned long src_val , int asi ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long * dest_reg , int size , unsigned long * saddr , int is_signed , int asi ) ;
...
position p;
@@
 enum direction { load , store , both , fpld , fpst , invalid , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pt_regs * regs , unsigned long addr , unsigned long type_ctx ) ;
