...
position p;
@@
 struct sun9i_usb_phy {  struct phy * phy ;  void __iomem * pmu ;  struct reset_control * reset ;  struct clk * clk ;  struct clk * hsic_clk ;  enum usb_phy_interface type ; } cocci_id@p ;
...
position p;
@@
 struct sun9i_usb_phy * cocci_id@p ;
