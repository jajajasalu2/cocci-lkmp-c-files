...
position p;
@@
 struct evtchn_expand_array cocci_id@p ;
...
position p;
@@
 struct evtchn_fifo_queue * cocci_id@p ;
...
position p;
@@
 struct evtchn_fifo_control_block * cocci_id@p ;
...
typedef event_word_t;
@@
 volatile event_word_t * cocci_id@p ;
...
position p;
@@
 struct evtchn_unmask cocci_id@p ;
...
position p;
@@
 struct evtchn_init_control cocci_id@p ;
...
typedef uint32_t;
@@
 struct evtchn_fifo_queue {  uint32_t head [ EVTCHN_FIFO_MAX_QUEUES ] ; } cocci_id@p ;
