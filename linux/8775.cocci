...
position p;
@@
 struct gelic_descr_chain * cocci_id@p ;
...
position p;
@@
 struct {  int tx ;  int rx ; } cocci_id@p [ 2 ] ;
...
position p;
@@
 enum gelic_descr_dma_status cocci_id@p ;
...
position p;
@@
 enum gelic_port_type cocci_id@p ;
