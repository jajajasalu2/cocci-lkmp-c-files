...
position p;
@@
 struct omap_aes_algs_info cocci_id@p [ ] ;
...
position p;
@@
 struct omap_aes_reqctx cocci_id@p ;
...
position p;
@@
 struct omap_aes_aead_algs cocci_id@p ;
...
position p;
@@
 struct omap_aes_dev * cocci_id@p ;
...
position p;
@@
 const struct omap_aes_pdata cocci_id@p ;
...
position p;
@@
 struct omap_aes_ctx cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct crypto_engine * engine , void * req ) ;
