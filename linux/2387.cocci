...
position p;
@@
 struct xilinx_axidma_tx_segment * cocci_id@p ;
...
position p;
@@
 enum xdma_ip_type { XDMA_TYPE_AXIDMA = 0 , XDMA_TYPE_CDMA , XDMA_TYPE_VDMA , XDMA_TYPE_AXIMCDMA , } cocci_id@p ;
...
position p;
@@
 struct xilinx_axidma_desc_hw cocci_id@p ;
...
position p;
@@
 struct xilinx_dma_tx_descriptor * cocci_id@p ;
...
position p;
@@
 struct xilinx_dma_chan * cocci_id@p ;
...
position p;
@@
 struct xilinx_cdma_tx_segment * cocci_id@p ;
...
position p;
@@
 struct xilinx_vdma_tx_segment cocci_id@p ;
...
position p;
@@
 struct xilinx_cdma_desc_hw * cocci_id@p ;
...
position p;
@@
 struct xilinx_aximcdma_desc_hw * cocci_id@p ;
...
typedef bool,u32;
@@
 struct xilinx_dma_tx_descriptor {  struct dma_async_tx_descriptor async_tx ;  struct list_head segments ;  struct list_head node ;  bool cyclic ;  bool err ;  u32 residue ; } cocci_id@p ;
...
position p;
@@
 struct xilinx_aximcdma_tx_segment cocci_id@p ;
...
position p;
@@
 struct dma_interleaved_template * cocci_id@p ;
...
typedef bool,u32;
@@
 struct xilinx_dma_device {  void __iomem * regs ;  struct device * dev ;  struct dma_device common ;  struct xilinx_dma_chan * chan [ XILINX_DMA_MAX_CHANS_PER_DEVICE ] ;  u32 flush_on_fsync ;  bool ext_addr ;  struct platform_device * pdev ;  const struct xilinx_dma_config * dma_config ;  struct clk * axi_clk ;  struct clk * tx_clk ;  struct clk * txs_clk ;  struct clk * rx_clk ;  struct clk * rxs_clk ;  u32 nr_channels ;  u32 chan_id ;  u32 max_buffer_len ;  u32 s2mm_index ; } cocci_id@p ;
...
position p;
@@
 struct xilinx_vdma_desc_hw * cocci_id@p ;
...
position p;
@@
 struct xilinx_dma_device * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,u16,spinlock_t,dma_addr_t;
@@
 struct xilinx_dma_chan {  struct xilinx_dma_device * xdev ;  u32 ctrl_offset ;  u32 desc_offset ;  spinlock_t lock ;  struct list_head pending_list ;  struct list_head active_list ;  struct list_head done_list ;  struct list_head free_seg_list ;  struct dma_chan common ;  struct dma_pool * desc_pool ;  struct device * dev ;  int irq ;  int id ;  enum dma_transfer_direction direction ;  int num_frms ;  bool has_sg ;  bool cyclic ;  bool genlock ;  bool err ;  bool idle ;  struct tasklet_struct tasklet ;  struct xilinx_vdma_config config ;  bool flush_on_fsync ;  u32 desc_pendingcount ;  bool ext_addr ;  u32 desc_submitcount ;  struct xilinx_axidma_tx_segment * seg_v ;  struct xilinx_aximcdma_tx_segment * seg_mv ;  dma_addr_t seg_p ;  struct xilinx_axidma_tx_segment * cyclic_seg_v ;  dma_addr_t cyclic_seg_p ;  void ( * start_transfer ) ( struct xilinx_dma_chan * chan ) ;  int ( * stop_transfer ) ( struct xilinx_dma_chan * chan ) ;  u16 tdest ;  bool has_vflip ; } cocci_id@p ;
...
position p;
@@
 const struct xilinx_dma_config cocci_id@p ;
...
position p;
@@
 struct dmaengine_result cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct platform_device * , struct clk * * , struct clk * * , struct clk * * , struct clk * * , struct clk * * ) ;
...
position p;
@@
 struct xilinx_vdma_config * cocci_id@p ;
