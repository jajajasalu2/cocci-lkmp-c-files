...
position p;
@@
 struct dasd_profile_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dasd_device * , struct dasd_ccw_req * ) ;
...
position p;
@@
 void cocci_id@p ( struct dentry * , struct dasd_device * ) ;
...
position p;
@@
 struct dasd_profile cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ccw_device * , unsigned long , struct irb * ) ;
...
position p;
@@
 void cocci_id@p ( struct dasd_block * ) ;
...
position p;
@@
 struct disk_part_iter cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dasd_ccw_req * , void * ) ;
...
position p;
@@
 int cocci_id@p ( struct dasd_block * ) ;
...
position p;
@@
 void cocci_id@p ( struct dasd_profile * ) ;
...
position p;
@@
 void cocci_id@p ( struct dasd_profile * , struct dentry * ) ;
...
position p;
@@
 void cocci_id@p ( struct dasd_device * ) ;
