...
position p;
@@
 struct fieldbus_dev * cocci_id@p ;
...
position p;
@@
 struct msg_mac_addr cocci_id@p ;
...
typedef bool;
@@
 struct profi_priv {  struct fieldbus_dev fbdev ;  struct anybuss_client * client ;  struct mutex enable_lock ;  bool power_on ; } cocci_id@p ;
...
typedef u8;
@@
 struct msg_mac_addr {  u8 addr [ 6 ] ; } cocci_id@p ;
