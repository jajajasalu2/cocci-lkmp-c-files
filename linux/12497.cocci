...
position p;
@@
 struct hgsmi_buffer_header cocci_id@p ;
...
position p;
@@
 struct hgsmi_buffer_tail cocci_id@p ;
...
position p;
@@
 const struct hgsmi_buffer_header * cocci_id@p ;
...
position p;
@@
 const struct hgsmi_buffer_tail * cocci_id@p ;
