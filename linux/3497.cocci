...
typedef u8,u32;
@@
 struct sdhci_omap_data {  u32 offset ;  u8 flags ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sdhci_omap_host * omap_host ) ;
...
position p;
@@
 struct sdhci_omap_data * cocci_id@p ;
...
position p;
@@
 struct sdhci_omap_host * cocci_id@p ;
...
position p;
@@
 const struct sdhci_omap_data cocci_id@p ;
...
typedef u8,bool;
@@
 struct sdhci_omap_host {  char * version ;  void __iomem * base ;  struct device * dev ;  struct regulator * pbias ;  bool pbias_enabled ;  struct sdhci_host * host ;  u8 bus_mode ;  u8 power_mode ;  u8 timing ;  u8 flags ;  struct pinctrl * pinctrl ;  struct pinctrl_state * * pinctrl_state ;  bool is_tuning ; } cocci_id@p ;
