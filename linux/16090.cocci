...
position p;
@@
 struct aio12_8_boardtype {  const char * name ;  unsigned int has_ai : 1 ;  unsigned int has_ao : 1 ; } cocci_id@p ;
...
position p;
@@
 struct aio12_8_boardtype cocci_id@p ;
...
position p;
@@
 const struct aio12_8_boardtype cocci_id@p [ ] ;
