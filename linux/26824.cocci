...
@@
 struct ORANGEFS_dev_map_desc32 {  compat_uptr_t ptr ;  __s32 total_size ;  __s32 size ;  __s32 count ; } cocci_id@p ;
...
position p;
@@
 struct ORANGEFS_dev_map_desc32 cocci_id@p ;
...
position p;
@@
 struct orangefs_downcall_s cocci_id@p ;
...
position p;
@@
 struct ORANGEFS_dev_map_desc cocci_id@p ;
...
typedef __u32,__u64;
@@
 struct {  __u32 version ;  __u32 magic ;  __u64 tag ; } cocci_id@p ;
...
position p;
@@
 struct orangefs_upcall_s cocci_id@p ;
