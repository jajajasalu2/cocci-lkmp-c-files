...
position p;
@@
 const struct bmp280_chip_info cocci_id@p ;
...
position p;
@@
 struct bmp180_calib * cocci_id@p ;
...
position p;
@@
 enum { P1 , P2 , P3 , P4 , P5 , P6 , P7 , P8 , P9 , } cocci_id@p ;
...
position p;
@@
 struct bmp280_calib * cocci_id@p ;
...
position p;
@@
 enum { AC1 , AC2 , AC3 , AC4 , AC5 , AC6 , B1 , B2 , MB , MC , MD , } cocci_id@p ;
...
typedef s16,u16;
@@
 struct bmp180_calib {  s16 AC1 ;  s16 AC2 ;  s16 AC3 ;  u16 AC4 ;  u16 AC5 ;  u16 AC6 ;  s16 B1 ;  s16 B2 ;  s16 MB ;  s16 MC ;  s16 MD ; } cocci_id@p ;
...
position p;
@@
 struct bmp280_chip_info {  const int * oversampling_temp_avail ;  int num_oversampling_temp_avail ;  const int * oversampling_press_avail ;  int num_oversampling_press_avail ;  const int * oversampling_humid_avail ;  int num_oversampling_humid_avail ;  int ( * chip_config ) ( struct bmp280_data * ) ;  int ( * read_temp ) ( struct bmp280_data * , int * ) ;  int ( * read_press ) ( struct bmp280_data * , int * , int * ) ;  int ( * read_humid ) ( struct bmp280_data * , int * , int * ) ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s8,u8,s16,u16;
@@
 struct bmp280_calib {  u16 T1 ;  s16 T2 ;  s16 T3 ;  u16 P1 ;  s16 P2 ;  s16 P3 ;  s16 P4 ;  s16 P5 ;  s16 P6 ;  s16 P7 ;  s16 P8 ;  s16 P9 ;  u8 H1 ;  s16 H2 ;  u8 H3 ;  s16 H4 ;  s16 H5 ;  s8 H6 ; } cocci_id@p ;
