...
position p;
@@
 void cocci_id@p ( unsigned long head , unsigned long start , unsigned long phys ) ;
...
position p;
@@
 const struct kimage * cocci_id@p ;
