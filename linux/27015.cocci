...
position p;
@@
 enum xfs_refcount_intent_type cocci_id@p ;
...
position p;
@@
 enum xfs_refc_adjust_op { XFS_REFCOUNT_ADJUST_INCREASE = 1 , XFS_REFCOUNT_ADJUST_DECREASE = - 1 , XFS_REFCOUNT_ADJUST_COW_ALLOC = 0 , XFS_REFCOUNT_ADJUST_COW_FREE = - 1 , } cocci_id@p ;
...
position p;
@@
 struct xfs_refcount_recovery {  struct list_head rr_list ;  struct xfs_refcount_irec rr_rrec ; } cocci_id@p ;
...
position p;
@@
 struct xfs_refcount_recovery cocci_id@p ;
...
position p;
@@
 enum xfs_refc_adjust_op cocci_id@p ;
...
position p;
@@
 struct xfs_refcount_irec * cocci_id@p ;
...
position p;
@@
 struct xfs_refcount_intent * cocci_id@p ;
