...
position p;
@@
 char cocci_id@p [ TIPC_MAX_BEARER_NAME ] ;
...
position p;
@@
 struct tipc_mon_domain cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct tipc_peer {  u32 addr ;  struct tipc_mon_domain * domain ;  struct hlist_node hash ;  struct list_head list ;  u8 applied ;  u8 down_cnt ;  bool is_up ;  bool is_head ;  bool is_local ; } cocci_id@p ;
...
typedef u64,u32,u16;
@@
 struct tipc_mon_domain {  u16 len ;  u16 gen ;  u16 ack_gen ;  u16 member_cnt ;  u64 up_map ;  u32 members [ MAX_MON_DOMAIN ] ; } cocci_id@p ;
...
@@
 struct tipc_monitor {  struct hlist_head peers [ NODE_HTABLE_SIZE ] ;  int peer_cnt ;  struct tipc_peer * self ;  rwlock_t lock ;  struct tipc_mon_domain cache ;  u16 list_gen ;  u16 dom_gen ;  struct net * net ;  struct timer_list timer ;  unsigned long timer_intv ; } cocci_id@p ;
...
position p;
@@
 struct tipc_monitor * cocci_id@p ;
