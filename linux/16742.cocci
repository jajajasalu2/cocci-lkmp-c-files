...
typedef bool;
@@
 bool ( * cocci_id@p ) ( unsigned char data , unsigned char str , struct serio * serio ) ;
...
position p;
@@
 struct i8042_port cocci_id@p [ I8042_NUM_PORTS ] ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( unsigned char data , unsigned char str , struct serio * port ) ;
...
typedef bool;
@@
 struct i8042_port {  struct serio * serio ;  int irq ;  bool exists ;  bool driver_bound ;  signed char mux ; } cocci_id@p ;
