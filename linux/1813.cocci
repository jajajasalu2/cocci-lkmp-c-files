...
typedef u16;
@@
 struct tsl2772_als_info {  u16 als_ch0 ;  u16 als_ch1 ;  u16 lux ; } cocci_id@p ;
...
position p;
@@
 const struct tsl2772_lux cocci_id@p [ TSL2772_DEF_LUX_TABLE_SZ ] ;
...
position p;
@@
 int cocci_id@p [ MAX_SAMPLES_CAL + 1 ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ TSL2772_MAX_PROX_LEDS ] ;
...
position p;
@@
 enum { ALS , PRX , ALSPRX , PRX2 , ALSPRX2 , } cocci_id@p ;
...
position p;
@@
 enum { tsl2571 , tsl2671 , tmd2671 , tsl2771 , tmd2771 , tsl2572 , tsl2672 , tmd2672 , tsl2772 , tmd2772 , apds9930 , } cocci_id@p ;
...
position p;
@@
 const struct tsl2772_lux * cocci_id@p [ ] ;
...
position p;
@@
 struct tsl2772_chip_info {  int chan_table_elements ;  struct iio_chan_spec channel_with_events [ 4 ] ;  struct iio_chan_spec channel_without_events [ 4 ] ;  const struct iio_info * info ; } cocci_id@p ;
...
position p;
@@
 const struct tsl2772_settings cocci_id@p ;
...
position p;
@@
 enum { TSL2772_SUPPLY_VDD = 0 , TSL2772_SUPPLY_VDDIO = 1 , TSL2772_NUM_SUPPLIES = 2 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ ARRAY_SIZE ( chip -> tsl2772_device_lux ) * 2 + 1 ] ;
...
position p;
@@
 struct tsl2772_chip * cocci_id@p ;
...
position p;
@@
 enum { TSL2772_CHIP_UNKNOWN = 0 , TSL2772_CHIP_WORKING = 1 , TSL2772_CHIP_SUSPENDED = 2 , } cocci_id@p ;
...
position p;
@@
 const struct tsl2772_chip_info cocci_id@p [ ] ;
