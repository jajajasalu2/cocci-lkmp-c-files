...
position p;
@@
 struct idmac_desc_64addr cocci_id@p ;
...
position p;
@@
 const struct dw_mci_dma_ops cocci_id@p ;
...
position p;
@@
 struct dw_mci_board * cocci_id@p ;
...
position p;
@@
 struct dw_mci_dma_slave cocci_id@p ;
