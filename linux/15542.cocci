...
position p;
@@
 struct ad5933_state {  struct i2c_client * client ;  struct regulator * reg ;  struct clk * mclk ;  struct delayed_work work ;  struct mutex lock ;  unsigned long mclk_hz ;  unsigned char ctrl_hb ;  unsigned char ctrl_lb ;  unsigned int range_avail [ 4 ] ;  unsigned short vref_mv ;  unsigned short settling_cycles ;  unsigned short freq_points ;  unsigned int freq_start ;  unsigned int freq_inc ;  unsigned int state ;  unsigned int poll_time_jiffies ; } cocci_id@p ;
...
position p;
@@
 struct ad5933_state cocci_id@p ;
...
typedef u8,__be32;
@@
 union {  __be32 d32 ;  u8 d8 [ 4 ] ; } cocci_id@p ;
