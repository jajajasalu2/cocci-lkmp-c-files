...
position p;
@@
 struct stp_policy_node {  struct config_group group ;  struct stp_policy * policy ;  unsigned int first_master ;  unsigned int last_master ;  unsigned int first_channel ;  unsigned int last_channel ;  unsigned char priv [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct stp_policy_node cocci_id@p ;
...
position p;
@@
 struct stp_policy {  struct config_group group ;  struct stm_device * stm ; } cocci_id@p ;
