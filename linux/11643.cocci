...
position p;
@@
 struct nvbios_M0209S * cocci_id@p ;
...
position p;
@@
 struct gk104_ram_train * cocci_id@p ;
...
position p;
@@
 struct nvbios_M0205S cocci_id@p ;
...
position p;
@@
 const struct nvkm_ram_func cocci_id@p ;
...
typedef u16;
@@
 struct gk104_ram_train {  u16 mask ;  struct nvbios_M0209S remap ;  struct nvbios_M0209S type00 ;  struct nvbios_M0209S type01 ;  struct nvbios_M0209S type04 ;  struct nvbios_M0209S type06 ;  struct nvbios_M0209S type07 ;  struct nvbios_M0209S type08 ;  struct nvbios_M0209S type09 ; } cocci_id@p ;
...
position p;
@@
 struct dcb_gpio_func cocci_id@p ;
...
position p;
@@
 struct nvbios_ramcfg * cocci_id@p ;
...
position p;
@@
 struct nvkm_ram_data * cocci_id@p ;
...
position p;
@@
 struct nvbios_M0205E cocci_id@p ;
...
position p;
@@
 struct nvbios_M0209E cocci_id@p ;
...
position p;
@@
 struct gk104_ramfuc * cocci_id@p ;
