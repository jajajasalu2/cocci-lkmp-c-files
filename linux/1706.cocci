...
position p;
@@
 enum ds1803_type { DS1803_010 , DS1803_050 , DS1803_100 , } cocci_id@p ;
...
position p;
@@
 struct ds1803_cfg {  int kohms ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ARRAY_SIZE ( ds1803_channels ) ] ;
...
position p;
@@
 struct ds1803_data {  struct i2c_client * client ;  const struct ds1803_cfg * cfg ; } cocci_id@p ;
...
position p;
@@
 const struct ds1803_cfg cocci_id@p [ ] ;
