...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_SOCKET_MAX + 1 ] ;
...
position p;
@@
 struct nft_socket {  enum nft_socket_keys key : 8 ;  union {  enum nft_registers dreg : 8 ; } ; } cocci_id@p ;
...
position p;
@@
 const struct nft_socket * cocci_id@p ;
