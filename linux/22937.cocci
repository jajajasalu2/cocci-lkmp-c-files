...
position p;
@@
 struct snd_compr_file * cocci_id@p ;
...
position p;
@@
 struct snd_compr_metadata cocci_id@p ;
...
position p;
@@
 enum snd_compr_direction cocci_id@p ;
...
position p;
@@
 struct snd_compr_file {  unsigned long caps ;  struct snd_compr_stream stream ; } cocci_id@p ;
...
position p;
@@
 struct snd_compr_avail * cocci_id@p ;
