...
position p;
@@
 const struct sof_dev_desc * cocci_id@p ;
...
position p;
@@
 struct snd_soc_acpi_mach_params * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ HDA_DSP_STACK_DUMP_SIZE ] ;
...
typedef u32;
@@
 struct hda_dsp_msg_code {  u32 code ;  const char * msg ; } cocci_id@p ;
...
position p;
@@
 struct sof_ipc_dsp_oops_xtensa cocci_id@p ;
...
position p;
@@
 struct sof_ipc_panic_info cocci_id@p ;
...
position p;
@@
 struct nhlt_acpi_table * cocci_id@p ;
...
position p;
@@
 struct sof_intel_hda_dev * cocci_id@p ;
...
position p;
@@
 const struct hda_dsp_msg_code cocci_id@p [ ] ;
...
position p;
@@
 const struct sof_intel_dsp_desc * cocci_id@p ;
