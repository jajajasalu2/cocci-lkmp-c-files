...
position p;
@@
 struct vchiq_2835_state * cocci_id@p ;
...
position p;
@@
 struct rpi_firmware * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vchiq_pagelist_info * pagelistinfo , int actual ) ;
...
typedef dma_addr_t;
@@
 struct vchiq_pagelist_info {  struct pagelist * pagelist ;  size_t pagelist_buffer_size ;  dma_addr_t dma_addr ;  enum dma_data_direction dma_dir ;  unsigned int num_pages ;  unsigned int pages_need_release ;  struct page * * pages ;  struct scatterlist * scatterlist ;  unsigned int scatterlist_mapped ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_pagelist_info cocci_id@p ;
...
position p;
@@
 struct vchiq_2835_state {  int inited ;  struct vchiq_arm_state arm_state ; } cocci_id@p ;
