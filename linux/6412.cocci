...
position p;
@@
 enum { R0 = 0 , R1 , R2 , REG_MAX , } cocci_id@p ;
...
position p;
@@
 struct slg51000 {  struct device * dev ;  struct regmap * regmap ;  struct regulator_desc * rdesc [ SLG51000_MAX_REGULATORS ] ;  struct regulator_dev * rdev [ SLG51000_MAX_REGULATORS ] ;  struct gpio_desc * cs_gpiod ;  int chip_irq ; } cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ SLG51000_MAX_REGULATORS ] ;
...
position p;
@@
 struct slg51000_evt_sta {  unsigned int ereg ;  unsigned int sreg ; } cocci_id@p ;
...
position p;
@@
 enum slg51000_regulators { SLG51000_REGULATOR_LDO1 = 0 , SLG51000_REGULATOR_LDO2 , SLG51000_REGULATOR_LDO3 , SLG51000_REGULATOR_LDO4 , SLG51000_REGULATOR_LDO5 , SLG51000_REGULATOR_LDO6 , SLG51000_REGULATOR_LDO7 , SLG51000_MAX_REGULATORS , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SLG51000_MAX_EVT_REGISTER ] [ REG_MAX ] ;
...
position p;
@@
 struct regulator_desc cocci_id@p [ SLG51000_MAX_REGULATORS ] ;
...
position p;
@@
 const struct slg51000_evt_sta cocci_id@p [ SLG51000_MAX_EVT_REGISTER ] ;
