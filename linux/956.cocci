...
typedef uint16_t;
@@
 struct flash_info {  const char * name ;  uint16_t device_id ;  unsigned page_size ;  unsigned nr_pages ;  unsigned erase_size ; } cocci_id@p ;
...
position p;
@@
 struct sst25l_flash cocci_id@p ;
...
position p;
@@
 struct sst25l_flash {  struct spi_device * spi ;  struct mutex lock ;  struct mtd_info mtd ; } cocci_id@p ;
