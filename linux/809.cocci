...
position p;
@@
 enum acpi_attr_enum cocci_id@p ;
...
position p;
@@
 enum smbios_attr_enum { SMBIOS_ATTR_NONE = 0 , SMBIOS_ATTR_LABEL_SHOW , SMBIOS_ATTR_INSTANCE_SHOW , } cocci_id@p ;
...
position p;
@@
 enum acpi_attr_enum { ACPI_ATTR_LABEL_SHOW , ACPI_ATTR_INDEX_SHOW , } cocci_id@p ;
...
position p;
@@
 enum smbios_attr_enum cocci_id@p ;
