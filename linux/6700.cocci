...
position p;
@@
 struct els_plogi_payload cocci_id@p ;
...
position p;
@@
 struct qla27xx_image_status * cocci_id@p ;
...
@@
 void cocci_id@p ( scsi_qla_host_t * , struct event_arg * ) ;
...
position p;
@@
 struct qla2300_fw_dump cocci_id@p ;
...
position p;
@@
 struct get_name_list_extended * cocci_id@p ;
...
position p;
@@
 struct qla_chip_state_84xx * cocci_id@p ( struct scsi_qla_host * ) ;
...
position p;
@@
 struct qla25xx_fw_dump cocci_id@p ;
...
position p;
@@
 struct qla24xx_fw_dump cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qla_hw_data * ) ;
...
position p;
@@
 struct qla83xx_fw_dump cocci_id@p ;
...
position p;
@@
 struct qla_chip_state_84xx cocci_id@p ;
...
position p;
@@
 struct qla2xxx_mq_chain cocci_id@p ;
...
position p;
@@
 struct qla2xxx_offld_chain cocci_id@p ;
...
typedef scsi_qla_host_t;
@@
 void cocci_id@p ( scsi_qla_host_t * vha , struct event_arg * ea ) ;
...
position p;
@@
 struct qla_fcp_prio_entry * cocci_id@p ;
...
position p;
@@
 struct qla2xxx_fw_dump * cocci_id@p ;
...
position p;
@@
 struct mid_init_cb_24xx * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef device_reg_t;
@@
 device_reg_t * cocci_id@p ;
...
position p;
@@
 struct active_regions cocci_id@p ;
...
position p;
@@
 struct port_database_24xx * cocci_id@p ;
...
position p;
@@
 struct qla2100_fw_dump cocci_id@p ;
...
typedef scsi_qla_host_t;
@@
 int cocci_id@p ( scsi_qla_host_t * ) ;
...
position p;
@@
 struct qla81xx_fw_dump cocci_id@p ;
...
position p;
@@
 struct qla2xxx_fce_chain cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_qla_host * , struct event_arg * ) ;
