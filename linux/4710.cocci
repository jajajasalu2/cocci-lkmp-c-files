...
position p;
@@
 struct mei_cl_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct wired_cmd_ake_send_pairing_info_out cocci_id@p ;
...
position p;
@@
 struct wired_cmd_verify_receiver_cert_out cocci_id@p ;
...
position p;
@@
 struct hdcp2_rep_send_ack * cocci_id@p ;
...
position p;
@@
 struct wired_cmd_validate_locality_in cocci_id@p ;
...
position p;
@@
 struct hdcp2_ake_send_pairing_info * cocci_id@p ;
...
position p;
@@
 struct wired_cmd_get_session_key_out cocci_id@p ;
...
position p;
@@
 const struct mei_cl_device_id * cocci_id@p ;
...
position p;
@@
 const struct i915_hdcp_component_ops cocci_id@p ;
...
position p;
@@
 struct hdcp_port_data * cocci_id@p ;
...
position p;
@@
 struct wired_cmd_ake_send_hprime_out cocci_id@p ;
...
position p;
@@
 struct mei_cl_device * cocci_id@p ;
...
position p;
@@
 struct mei_cl_driver cocci_id@p ;
...
position p;
@@
 struct wired_cmd_ake_send_pairing_info_in cocci_id@p ;
...
position p;
@@
 struct hdcp2_rep_stream_ready * cocci_id@p ;
...
position p;
@@
 struct hdcp2_ake_send_cert * cocci_id@p ;
...
position p;
@@
 struct hdcp2_ake_init * cocci_id@p ;
...
position p;
@@
 struct hdcp2_ske_send_eks * cocci_id@p ;
...
position p;
@@
 struct wired_cmd_enable_auth_out cocci_id@p ;
...
position p;
@@
 struct i915_hdcp_comp_master * cocci_id@p ;
...
position p;
@@
 struct wired_cmd_verify_receiver_cert_in cocci_id@p ;
...
position p;
@@
 struct wired_cmd_initiate_hdcp2_session_out cocci_id@p ;
...
position p;
@@
 struct wired_cmd_enable_auth_in cocci_id@p ;
...
position p;
@@
 struct wired_cmd_init_locality_check_out cocci_id@p ;
...
position p;
@@
 struct wired_cmd_verify_repeater_out cocci_id@p ;
...
position p;
@@
 struct wired_cmd_validate_locality_out cocci_id@p ;
...
position p;
@@
 struct wired_cmd_ake_send_hprime_in cocci_id@p ;
...
position p;
@@
 struct hdcp2_streamid_type cocci_id@p ;
...
position p;
@@
 struct hdcp2_ake_stored_km cocci_id@p ;
...
position p;
@@
 struct wired_cmd_repeater_auth_stream_req_in cocci_id@p ;
...
position p;
@@
 struct wired_cmd_close_session_out cocci_id@p ;
...
position p;
@@
 struct wired_cmd_repeater_auth_stream_req_out cocci_id@p ;
...
position p;
@@
 struct wired_cmd_verify_repeater_in cocci_id@p ;
...
position p;
@@
 struct hdcp2_ake_send_hprime * cocci_id@p ;
...
position p;
@@
 struct hdcp2_ake_no_stored_km * cocci_id@p ;
...
position p;
@@
 struct wired_cmd_init_locality_check_in cocci_id@p ;
...
position p;
@@
 struct hdcp2_lc_send_lprime * cocci_id@p ;
...
position p;
@@
 struct wired_cmd_get_session_key_in cocci_id@p ;
...
position p;
@@
 struct hdcp2_lc_init * cocci_id@p ;
...
position p;
@@
 struct wired_cmd_initiate_hdcp2_session_in cocci_id@p ;
...
position p;
@@
 struct wired_cmd_close_session_in cocci_id@p ;
