...
position p;
@@
 struct xendispl_req * cocci_id@p ;
...
position p;
@@
 struct xen_drm_front_drm_pipeline * cocci_id@p ;
...
position p;
@@
 struct xen_drm_front_drm_info * cocci_id@p ;
...
typedef u64;
@@
 struct xen_drm_front_dbuf {  struct list_head list ;  u64 dbuf_cookie ;  u64 fb_cookie ;  struct xen_front_pgdir_shbuf shbuf ; } cocci_id@p ;
...
position p;
@@
 struct xen_drm_front_cfg * cocci_id@p ;
...
position p;
@@
 struct xen_drm_front_evtchnl * cocci_id@p ;
...
position p;
@@
 struct xen_drm_front_dbuf * cocci_id@p ;
...
position p;
@@
 struct xen_drm_front_info * cocci_id@p ;
