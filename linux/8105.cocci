...
typedef u32;
@@
 struct esd_usb2 {  struct usb_device * udev ;  struct esd_usb2_net_priv * nets [ ESD_USB2_MAX_NETS ] ;  struct usb_anchor rx_submitted ;  int net_count ;  u32 version ;  int rxinitdone ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct version_msg {  u8 len ;  u8 cmd ;  u8 rsvd ;  u8 flags ;  __le32 drv_version ; } cocci_id@p ;
...
position p;
@@
 struct esd_tx_urb_context * cocci_id@p ;
...
position p;
@@
 struct esd_usb2_msg cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,u8,u32;
@@
 struct tx_msg {  u8 len ;  u8 cmd ;  u8 net ;  u8 dlc ;  u32 hnd ;  __le32 id ;  u8 data [ 8 ] ; } cocci_id@p ;
...
typedef __le32,u8,u32;
@@
 struct tx_done_msg {  u8 len ;  u8 cmd ;  u8 net ;  u8 status ;  u32 hnd ;  __le32 ts ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct id_filter_msg {  u8 len ;  u8 cmd ;  u8 net ;  u8 option ;  __le32 mask [ ESD_MAX_ID_SEGMENT + 1 ] ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct set_baudrate_msg {  u8 len ;  u8 cmd ;  u8 net ;  u8 rsvd ;  __le32 baud ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct rx_msg {  u8 len ;  u8 cmd ;  u8 net ;  u8 dlc ;  __le32 ts ;  __le32 id ;  u8 data [ 8 ] ; } cocci_id@p ;
...
typedef u8,atomic_t;
@@
 struct esd_usb2_net_priv {  struct can_priv can ;  atomic_t active_tx_jobs ;  struct usb_anchor tx_submitted ;  struct esd_tx_urb_context tx_contexts [ MAX_TX_URBS ] ;  struct esd_usb2 * usb2 ;  struct net_device * netdev ;  int index ;  u8 old_state ;  struct can_berr_counter bec ; } cocci_id@p ;
...
position p;
@@
 struct esd_usb2_net_priv * cocci_id@p ;
...
typedef u32;
@@
 struct esd_tx_urb_context {  struct esd_usb2_net_priv * priv ;  u32 echo_index ;  int dlc ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct version_reply_msg {  u8 len ;  u8 cmd ;  u8 nets ;  u8 features ;  __le32 version ;  u8 name [ 16 ] ;  __le32 rsvd ;  __le32 ts ; } cocci_id@p ;
...
typedef u8;
@@
 struct header_msg {  u8 len ;  u8 cmd ;  u8 rsvd [ 2 ] ; } cocci_id@p ;
