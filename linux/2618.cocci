...
position p;
@@
 const struct idle_cpu * cocci_id@p ;
...
typedef bool;
@@
 struct idle_cpu {  struct cpuidle_state * state_table ;  unsigned long auto_demotion_disable_flags ;  bool byt_auto_demotion_disable_flag ;  bool disable_promotion_to_c1e ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cpuidle_device * dev , struct cpuidle_driver * drv , int index ) ;
