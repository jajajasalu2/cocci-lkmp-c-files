...
position p;
@@
 enum s5pv210_mem_type { LPDDR = 0x1 , LPDDR2 = 0x2 , DDR2 = 0x4 , } cocci_id@p ;
...
position p;
@@
 struct s5pv210_dvs_conf cocci_id@p [ ] ;
...
position p;
@@
 enum perf_level { L0 , L1 , L2 , L3 , L4 , } cocci_id@p ;
...
position p;
@@
 struct dram_conf {  unsigned long freq ;  unsigned long refresh ; } cocci_id@p ;
...
position p;
@@
 struct s5pv210_dvs_conf {  int arm_volt ;  int int_volt ; } cocci_id@p ;
...
position p;
@@
 enum s5pv210_dmc_port { DMC0 = 0 , DMC1 , } cocci_id@p ;
...
position p;
@@
 enum s5pv210_dmc_port cocci_id@p ;
