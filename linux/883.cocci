...
typedef s8,u8;
@@
 struct sunxi_nand_chip_sel {  u8 cs ;  s8 rb ; } cocci_id@p ;
...
position p;
@@
 struct sunxi_nfc {  struct nand_controller controller ;  struct device * dev ;  void __iomem * regs ;  struct clk * ahb_clk ;  struct clk * mod_clk ;  struct reset_control * reset ;  unsigned long assigned_cs ;  unsigned long clk_rate ;  struct list_head chips ;  struct completion complete ;  struct dma_chan * dmac ;  const struct sunxi_nfc_caps * caps ; } cocci_id@p ;
...
position p;
@@
 struct sunxi_nand_chip * cocci_id@p ;
...
position p;
@@
 const struct sunxi_nfc_caps cocci_id@p ;
...
position p;
@@
 struct sunxi_nand_hw_ecc {  int mode ; } cocci_id@p ;
...
typedef bool;
@@
 struct sunxi_nfc_caps {  bool extra_mbus_conf ;  unsigned int reg_io_data ;  unsigned int dma_maxburst ; } cocci_id@p ;
...
position p;
@@
 struct sunxi_nand_chip_sel * cocci_id@p ;
...
position p;
@@
 struct sunxi_nand_hw_ecc * cocci_id@p ;
...
typedef u32;
@@
 struct sunxi_nand_chip {  struct list_head node ;  struct nand_chip nand ;  unsigned long clk_rate ;  u32 timing_cfg ;  u32 timing_ctl ;  int nsels ;  struct sunxi_nand_chip_sel sels [ 0 ] ; } cocci_id@p ;
