...
position p;
@@
 enum devcg_behavior cocci_id@p ;
...
position p;
@@
 enum devcg_behavior { DEVCG_DEFAULT_NONE , DEVCG_DEFAULT_ALLOW , DEVCG_DEFAULT_DENY , } cocci_id@p ;
...
position p;
@@
 struct dev_exception_item cocci_id@p ;
...
position p;
@@
 struct dev_cgroup {  struct cgroup_subsys_state css ;  struct list_head exceptions ;  enum devcg_behavior behavior ; } cocci_id@p ;
...
position p;
@@
 const struct dev_cgroup * cocci_id@p ;
