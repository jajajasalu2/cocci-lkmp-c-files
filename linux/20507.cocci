...
position p;
@@
 struct avx_512_opmask_state cocci_id@p ;
...
position p;
@@
 struct avx_512_zmm_uppers_state cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ XFEATURE_MAX ] ;
...
position p;
@@
 struct avx_512_hi16_state cocci_id@p ;
...
position p;
@@
 struct mpx_bndcsr_state cocci_id@p ;
...
position p;
@@
 const struct xstate_header * cocci_id@p ;
...
position p;
@@
 struct xstate_header cocci_id@p ;
