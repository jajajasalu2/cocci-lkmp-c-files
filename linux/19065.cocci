...
symbol cocci_id;
position p;
typedef samsung_gpio_pull_t;
@@
 samsung_gpio_pull_t cocci_id@p ;
...
position p;
@@
 struct samsung_gpio_cfg * cocci_id@p ;
...
position p;
@@
 struct samsung_gpio_chip cocci_id@p [ ] ;
...
position p;
@@
 struct samsung_gpio_chip * cocci_id@p [ S3C_GPIO_END ] ;
