...
@@
 struct chardev_priv {  struct cros_ec_dev * ec_dev ;  struct notifier_block notifier ;  wait_queue_head_t wait_event ;  unsigned long event_mask ;  struct list_head events ;  size_t event_len ; } cocci_id@p ;
...
position p;
@@
 struct chardev_data {  struct cros_ec_dev * ec_dev ;  struct miscdevice misc ; } cocci_id@p ;
...
position p;
@@
 struct cros_ec_readmem cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( struct ec_response_get_version ) + sizeof ( CROS_EC_DEV_VERSION ) ] ;
...
position p;
@@
 struct ec_response_get_version * cocci_id@p ;
...
position p;
@@
 struct cros_ec_platform * cocci_id@p ;
...
position p;
@@
 struct chardev_data * cocci_id@p ;
...
typedef u8;
@@
 struct ec_event {  struct list_head node ;  size_t size ;  u8 event_type ;  u8 data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct chardev_priv cocci_id@p ;
