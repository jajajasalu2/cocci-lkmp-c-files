...
position p;
@@
 struct iwl_nvm_get_info cocci_id@p ;
...
position p;
@@
 struct iwl_nvm_section * cocci_id@p ;
...
position p;
@@
 enum nvm_offsets { SUBSYSTEM_ID = 0x0A , HW_ADDR = 0x15 , NVM_SW_SECTION = 0x1C0 , NVM_VERSION = 0 , RADIO_CFG = 1 , SKU = 2 , N_HW_ADDRS = 3 , NVM_CHANNELS = 0x1E0 - NVM_SW_SECTION , NVM_CALIB_SECTION = 0x2B8 , XTAL_CALIB = 0x316 - NVM_CALIB_SECTION , NVM_CHANNELS_SDP = 0 , } cocci_id@p ;
...
position p;
@@
 struct iwl_nvm_get_info_rsp * cocci_id@p ;
...
position p;
@@
 enum nvm_sku_bits { NVM_SKU_CAP_BAND_24GHZ = BIT ( 0 ) , NVM_SKU_CAP_BAND_52GHZ = BIT ( 1 ) , NVM_SKU_CAP_11N_ENABLE = BIT ( 2 ) , NVM_SKU_CAP_11AC_ENABLE = BIT ( 3 ) , NVM_SKU_CAP_MIMO_DISABLE = BIT ( 5 ) , } cocci_id@p ;
...
typedef u8;
@@
 const struct {  __le16 word1 ;  __le16 word2 ;  u8 data [ ] ; } * cocci_id@p ;
...
position p;
@@
 struct iwl_nvm_get_info_rsp_v3 * cocci_id@p ;
...
position p;
@@
 enum ext_nvm_offsets { MAC_ADDRESS_OVERRIDE_EXT_NVM = 1 , NVM_VERSION_EXT_NVM = 0 , RADIO_CFG_FAMILY_EXT_NVM = 0 , SKU_FAMILY_8000 = 2 , N_HW_ADDRS_FAMILY_8000 = 3 , NVM_CHANNELS_EXTENDED = 0 , NVM_LAR_OFFSET_OLD = 0x4C7 , NVM_LAR_OFFSET = 0x507 , NVM_LAR_ENABLED = 0x7 , } cocci_id@p ;
