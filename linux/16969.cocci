...
position p;
@@
 unsigned char cocci_id@p [ MEAS_LEN ] ;
...
position p;
@@
 struct pm860x_touch cocci_id@p ;
...
position p;
@@
 struct pm860x_touch {  struct input_dev * idev ;  struct i2c_client * i2c ;  struct pm860x_chip * chip ;  int irq ;  int res_x ; } cocci_id@p ;
