...
position p;
@@
 struct xencons_info cocci_id@p ;
...
typedef grant_ref_t;
@@
 struct xencons_info {  struct list_head list ;  struct xenbus_device * xbdev ;  struct xencons_interface * intf ;  unsigned int evtchn ;  struct hvc_struct * hvc ;  int irq ;  int vtermno ;  grant_ref_t gntref ; } cocci_id@p ;
...
position p;
@@
 struct xencons_interface * cocci_id@p ;
