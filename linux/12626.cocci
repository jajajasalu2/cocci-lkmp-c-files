...
position p;
@@
 struct a6xx_hfi_msg_gmu_init_cmd cocci_id@p ;
...
position p;
@@
 struct a6xx_hfi_queue_table_header * cocci_id@p ;
...
position p;
@@
 struct a6xx_hfi_queue * cocci_id@p ;
...
position p;
@@
 struct a6xx_hfi_msg_fw_version cocci_id@p ;
...
position p;
@@
 struct a6xx_hfi_msg_response cocci_id@p ;
...
position p;
@@
 struct a6xx_hfi_msg_bw_table cocci_id@p ;
...
position p;
@@
 struct a6xx_hfi_queue_header cocci_id@p ;
...
position p;
@@
 struct a6xx_hfi_msg_test cocci_id@p ;
...
position p;
@@
 struct a6xx_hfi_msg_perf_table cocci_id@p ;
...
position p;
@@
 struct a6xx_hfi_msg_error * cocci_id@p ;
