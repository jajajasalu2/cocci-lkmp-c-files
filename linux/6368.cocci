...
position p;
@@
 struct tps65132_regulator {  struct device * dev ;  struct tps65132_reg_pdata reg_pdata [ TPS65132_MAX_REGULATORS ] ; } cocci_id@p ;
...
position p;
@@
 struct tps65132_reg_pdata {  struct gpio_desc * en_gpiod ;  struct gpio_desc * act_dis_gpiod ;  unsigned int act_dis_time_us ;  int ena_gpio_state ; } cocci_id@p ;
...
position p;
@@
 struct tps65132_reg_pdata * cocci_id@p ;
...
position p;
@@
 const struct regulator_desc cocci_id@p [ TPS65132_MAX_REGULATORS ] ;
...
position p;
@@
 struct tps65132_regulator * cocci_id@p ;
