...
position p;
@@
 const struct p54_channel_entry * cocci_id@p ;
...
position p;
@@
 struct pda_channel_output_limit_longbow * cocci_id@p ;
...
position p;
@@
 struct p54_cal_database * cocci_id@p ;
...
position p;
@@
 struct p54_pa_curve_data_sample * cocci_id@p ;
...
position p;
@@
 struct pda_iq_autocal_entry cocci_id@p ;
...
position p;
@@
 struct p54_channel_list {  struct p54_channel_entry * channels ;  size_t entries ;  size_t max_entries ;  size_t band_channel_num [ NUM_NL80211_BANDS ] ; } cocci_id@p ;
...
position p;
@@
 struct pda_pa_curve_data_sample_rev0 * cocci_id@p ;
...
position p;
@@
 struct pda_channel_output_limit * cocci_id@p ;
...
typedef u16;
@@
 struct p54_channel_entry {  u16 freq ;  u16 data ;  int index ;  int max_power ;  enum nl80211_band band ; } cocci_id@p ;
...
position p;
@@
 struct pda_custom_wrapper * cocci_id@p ;
...
position p;
@@
 struct pda_rssi_cal_entry cocci_id@p ;
...
position p;
@@
 struct p54_channel_entry cocci_id@p ;
...
position p;
@@
 struct pda_pa_curve_data cocci_id@p ;
...
position p;
@@
 struct pda_rssi_cal_ext_entry cocci_id@p ;
...
position p;
@@
 struct p54_rssi_db_entry * cocci_id@p ;
...
position p;
@@
 const struct p54_rssi_db_entry * cocci_id@p ;
...
position p;
@@
 struct p54_channel_list * cocci_id@p ;
...
position p;
@@
 struct pda_channel_output_limit_point_longbow * cocci_id@p ;
...
position p;
@@
 struct eeprom_pda_wrap * cocci_id@p ;
...
position p;
@@
 struct pda_pa_curve_data_sample_rev1 * cocci_id@p ;
