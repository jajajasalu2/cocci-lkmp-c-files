...
position p;
@@
 struct uvc_meta_buf * cocci_id@p ;
...
position p;
@@
 struct uvc_stats_frame * cocci_id@p ;
...
position p;
@@
 const struct uvc_clock_sample * cocci_id@p ;
...
position p;
@@
 struct uvc_clock_sample * cocci_id@p ;
...
position p;
@@
 const struct uvc_streaming * cocci_id@p ;
...
position p;
@@
 struct uvc_video_queue * cocci_id@p ;
