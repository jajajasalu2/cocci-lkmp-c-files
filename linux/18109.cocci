...
position p;
@@
 struct sa1111_driver * cocci_id@p ;
...
position p;
@@
 enum { SA1111_GPIO_PXDDR = ( SA1111_GPIO_PADDR - SA1111_GPIO_PADDR ) , SA1111_GPIO_PXDRR = ( SA1111_GPIO_PADRR - SA1111_GPIO_PADDR ) , SA1111_GPIO_PXDWR = ( SA1111_GPIO_PADWR - SA1111_GPIO_PADDR ) , SA1111_GPIO_PXSDR = ( SA1111_GPIO_PASDR - SA1111_GPIO_PADDR ) , SA1111_GPIO_PXSSR = ( SA1111_GPIO_PASSR - SA1111_GPIO_PADDR ) , } cocci_id@p ;
...
position p;
@@
 struct sa1111_dev_info * cocci_id@p ;
...
position p;
@@
 struct sa1111_save_data {  unsigned int skcr ;  unsigned int skpcr ;  unsigned int skcdr ;  unsigned char skaud ;  unsigned char skpwm0 ;  unsigned char skpwm1 ;  unsigned int intpol0 ;  unsigned int intpol1 ;  unsigned int inten0 ;  unsigned int inten1 ;  unsigned int wakepol0 ;  unsigned int wakepol1 ;  unsigned int wakeen0 ;  unsigned int wakeen1 ; } cocci_id@p ;
...
typedef bool;
@@
 struct sa1111_dev_info {  unsigned long offset ;  unsigned long skpcr_mask ;  bool dma ;  unsigned int devid ;  unsigned int hwirq [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 struct sa1111_platform_data * cocci_id@p ;
...
position p;
@@
 struct sa1111_save_data cocci_id@p ;
