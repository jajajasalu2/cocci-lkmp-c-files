...
typedef u64,bool;
@@
 struct wmi_block {  struct wmi_device dev ;  struct list_head list ;  struct guid_block gblock ;  struct miscdevice char_dev ;  struct mutex char_mutex ;  struct acpi_device * acpi_device ;  wmi_notify_handler handler ;  void * handler_data ;  u64 req_buf_size ;  bool read_takes_no_args ; } cocci_id@p ;
...
position p;
@@
 const struct wmi_device_id * cocci_id@p ;
...
position p;
@@
 union acpi_object cocci_id@p [ 1 ] ;
...
typedef u8;
@@
 struct guid_block {  char guid [ 16 ] ;  union {  char object_id [ 2 ] ;  struct {  unsigned char notify_id ;  unsigned char reserved ; } ; } ;  u8 instance_count ;  u8 flags ; } cocci_id@p ;
...
position p;
@@
 struct wmi_ioctl_buffer * cocci_id@p ;
...
position p;
@@
 const struct guid_block * cocci_id@p ;
...
position p;
@@
 union acpi_object cocci_id@p [ 3 ] ;
...
position p;
@@
 int cocci_id@p ( struct platform_device * device ) ;
