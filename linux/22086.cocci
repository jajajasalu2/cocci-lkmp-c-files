...
position p;
@@
 struct objagg_hints_node * cocci_id@p ;
...
position p;
@@
 enum objagg_opt_algo_type cocci_id@p ;
...
position p;
@@
 const struct objagg_opt_algo * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct objagg * objagg , struct objagg_obj * objagg_obj ) ;
...
typedef bool;
@@
 struct objagg_tmp_node {  struct objagg_obj * objagg_obj ;  bool crossed_out ; } cocci_id@p ;
...
position p;
@@
 struct objagg_tmp_graph {  struct objagg_tmp_node * nodes ;  unsigned long nodes_count ;  unsigned long * edges ; } cocci_id@p ;
...
position p;
@@
 struct objagg_hints {  struct rhashtable node_ht ;  struct rhashtable_params ht_params ;  struct list_head node_list ;  unsigned int node_count ;  unsigned int root_count ;  unsigned int refcount ;  const struct objagg_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct objagg_obj * cocci_id@p ( struct objagg * objagg , void * obj ) ;
...
position p;
@@
 struct objagg_tmp_graph * cocci_id@p ;
...
position p;
@@
 struct objagg_tmp_node * cocci_id@p ;
...
position p;
@@
 struct objagg_opt_algo {  int ( * fillup_hints ) ( struct objagg_hints * objagg_hints , struct objagg * objagg ) ; } cocci_id@p ;
...
position p;
@@
 const struct objagg_obj * cocci_id@p ;
...
position p;
@@
 const struct objagg_obj_stats_info * cocci_id@p ;
...
position p;
@@
 struct objagg_obj_stats_info cocci_id@p ;
...
position p;
@@
 struct objagg_obj {  struct rhash_head ht_node ;  struct list_head list ;  struct objagg_obj * parent ;  union {  void * delta_priv ;  void * root_priv ; } ;  unsigned int root_id ;  unsigned int refcount ;  struct objagg_obj_stats stats ;  unsigned long obj [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct objagg {  const struct objagg_ops * ops ;  void * priv ;  struct rhashtable obj_ht ;  struct rhashtable_params ht_params ;  struct list_head obj_list ;  unsigned int obj_count ;  struct ida root_ida ;  struct objagg_hints * hints ; } cocci_id@p ;
...
position p;
@@
 struct objagg_stats * cocci_id@p ;
...
position p;
@@
 struct objagg_hints_node {  struct rhash_head ht_node ;  struct list_head list ;  struct objagg_hints_node * parent ;  unsigned int root_id ;  struct objagg_obj_stats_info stats_info ;  unsigned long obj [ 0 ] ; } cocci_id@p ;
