...
position p;
@@
 struct reg_sequences {  struct reg_sequence * seq ;  int size ;  unsigned int msk ; } cocci_id@p ;
...
position p;
@@
 const struct cs43130_pll_params cocci_id@p [ ] ;
...
position p;
@@
 const struct reg_sequence cocci_id@p [ ] [ 2 ] ;
...
position p;
@@
 const struct cs43130_bitwidth_map cocci_id@p [ ] ;
...
position p;
@@
 const struct cs43130_rate_map cocci_id@p [ ] ;
...
position p;
@@
 struct cs43130_private cocci_id@p ;
...
position p;
@@
 struct snd_soc_dapm_route cocci_id@p [ ARRAY_SIZE ( digital_hp_routes ) + ARRAY_SIZE ( analog_hp_routes ) ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ CS43130_AC_FREQ ] ;
...
position p;
@@
 enum cs43130_mclk_src_sel cocci_id@p ;
...
position p;
@@
 struct reg_sequences cocci_id@p [ ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ CS43130_DC_THRESHOLD ] ;
...
typedef u8,u32;
@@
 struct cs43130_pll_params {  unsigned int pll_in ;  u8 sclk_prediv ;  u8 pll_div_int ;  u32 pll_div_frac ;  u8 pll_mode ;  u8 pll_divout ;  unsigned int pll_out ;  u8 pll_cal_ratio ; } cocci_id@p ;
...
position p;
@@
 struct snd_soc_dapm_widget cocci_id@p [ ARRAY_SIZE ( digital_hp_widgets ) + ARRAY_SIZE ( analog_hp_widgets ) ] ;
...
position p;
@@
 unsigned int cocci_id@p [ CS43130_NUM_INT ] ;
...
position p;
@@
 const struct cs43130_clk_gen * cocci_id@p ;
