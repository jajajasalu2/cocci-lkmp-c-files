...
typedef zsau_resp_t;
@@
 const struct zsau_resp_t * cocci_id@p ;
...
typedef zsau_resp_t;
@@
 const struct zsau_resp_t {  char * str ;  int code ; } cocci_id@p [ ] ;
...
typedef resp_type_t;
@@
 const struct resp_type_t * cocci_id@p ;
...
typedef resp_type_t;
@@
 const struct resp_type_t {  char * response ;  int resp_code ;  int type ; } cocci_id@p [ ] ;
