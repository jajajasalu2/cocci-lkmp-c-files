...
position p;
@@
 struct ipu_csc_scaler_ctx * cocci_id@p ;
...
position p;
@@
 struct ipu_csc_scaler_q_data {  struct v4l2_pix_format cur_fmt ;  struct v4l2_rect rect ; } cocci_id@p ;
...
typedef bool;
@@
 struct ipu_csc_scaler_ctx {  struct ipu_csc_scaler_priv * priv ;  struct v4l2_fh fh ;  struct ipu_csc_scaler_q_data q_data [ 2 ] ;  struct ipu_image_convert_ctx * icc ;  struct v4l2_ctrl_handler ctrl_hdlr ;  int rotate ;  bool hflip ;  bool vflip ;  enum ipu_rotate_mode rot_mode ;  unsigned int sequence ; } cocci_id@p ;
...
position p;
@@
 const struct ipu_csc_scaler_q_data cocci_id@p ;
...
position p;
@@
 struct ipu_csc_scaler_priv {  struct imx_media_video_dev vdev ;  struct v4l2_m2m_dev * m2m_dev ;  struct device * dev ;  struct imx_media_dev * md ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 struct ipu_csc_scaler_priv * cocci_id@p ;
...
position p;
@@
 const enum ipu_ic_task cocci_id@p ;
...
position p;
@@
 struct ipu_csc_scaler_q_data * cocci_id@p ;
