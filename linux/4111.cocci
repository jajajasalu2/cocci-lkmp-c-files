...
position p;
@@
 struct pxa_usb_phy {  struct phy * phy ;  void __iomem * base ;  enum pxa_usb_phy_version version ; } cocci_id@p ;
...
position p;
@@
 enum pxa_usb_phy_version cocci_id@p ;
...
position p;
@@
 enum pxa_usb_phy_version { PXA_USB_PHY_MMP2 , PXA_USB_PHY_PXA910 , PXA_USB_PHY_PXA168 , } cocci_id@p ;
