...
position p;
@@
 struct bp_cpuinfo {  unsigned int cpu_pinned ;  unsigned int * tsk_pinned ;  unsigned int flexible ; } cocci_id@p ;
...
position p;
@@
 struct bp_busy_slots * cocci_id@p ;
...
position p;
@@
 struct bp_busy_slots {  unsigned int pinned ;  unsigned int flexible ; } cocci_id@p ;
