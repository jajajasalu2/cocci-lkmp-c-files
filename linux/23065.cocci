...
position p;
@@
 struct mt8173_rt5650_platform_data cocci_id@p ;
...
position p;
@@
 enum { DAI_LINK_PLAYBACK , DAI_LINK_CAPTURE , DAI_LINK_HDMI , DAI_LINK_CODEC_I2S , DAI_LINK_HDMI_I2S , } cocci_id@p ;
...
position p;
@@
 enum mt8173_rt5650_mclk { MT8173_RT5650_MCLK_EXTERNAL = 0 , MT8173_RT5650_MCLK_INTERNAL , } cocci_id@p ;
...
position p;
@@
 struct mt8173_rt5650_platform_data {  enum mt8173_rt5650_mclk pll_from ; } cocci_id@p ;
