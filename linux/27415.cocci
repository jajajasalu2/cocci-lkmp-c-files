...
position p;
@@
 struct simple_transaction_argresp * cocci_id@p ;
...
typedef u64,u32;
@@
 struct inode * ( * cocci_id@p ) ( struct super_block * sb , u64 ino , u32 gen ) ;
...
typedef u64;
@@
 struct simple_attr {  int ( * get ) ( void * , u64 * ) ;  int ( * set ) ( void * , u64 ) ;  char get_buf [ 24 ] ;  char set_buf [ 24 ] ;  void * data ;  const char * fmt ;  struct mutex mutex ; } cocci_id@p ;
