...
position p;
@@
 struct cs42l52_private * cocci_id@p ;
...
position p;
@@
 const struct cs42l52_clk_para cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct cs42l52_private {  struct regmap * regmap ;  struct snd_soc_component * component ;  struct device * dev ;  struct sp_config config ;  struct cs42l52_platform_data pdata ;  u32 sysclk ;  u8 mclksel ;  u32 mclk ;  u8 flags ;  struct input_dev * beep ;  struct work_struct beep_work ;  int beep_rate ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct cs42l52_clk_para {  u32 mclk ;  u32 rate ;  u8 speed ;  u8 group ;  u8 videoclk ;  u8 ratio ;  u8 mclkdiv2 ; } cocci_id@p ;
...
position p;
@@
 struct cs42l52_platform_data * cocci_id@p ;
