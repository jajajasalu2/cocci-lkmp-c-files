...
position p;
@@
 const struct ib_uverbs_flow_ipv4_filter cocci_id@p ;
...
position p;
@@
 const struct ib_uverbs_flow_ipv6_filter cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct ib_flow_action_attrs_esp_keymats * keymat ) ;
...
position p;
@@
 struct ib_flow_action_esp_attr {  struct ib_flow_action_attrs_esp hdr ;  struct ib_flow_action_attrs_esp_keymats keymat ;  struct ib_flow_action_attrs_esp_replays replay ;  struct ib_flow_spec_list encap ; } cocci_id@p ;
...
position p;
@@
 const struct uverbs_attr_spec cocci_id@p [ ] ;
...
typedef bool;
@@
 int ( * cocci_id@p [ ] ) ( struct ib_flow_action_attrs_esp_replays * replay , bool is_modify ) ;
...
position p;
@@
 struct ib_flow_action_attrs_esp_replays * cocci_id@p ;
...
position p;
@@
 union {  struct ib_uverbs_flow_ipv4_filter ipv4 ;  struct ib_uverbs_flow_ipv6_filter ipv6 ; } cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_flow_action_esp cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_flow_action_esp_replay_bmp cocci_id@p ;
...
position p;
@@
 struct ib_flow_action_esp_attr * cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_flow_action_esp_encap cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_flow_ipv4_filter cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_flow_ipv6_filter cocci_id@p ;
...
position p;
@@
 struct ib_flow_spec_list * cocci_id@p ;
...
position p;
@@
 struct ib_flow_action_attrs_esp_keymats * cocci_id@p ;
