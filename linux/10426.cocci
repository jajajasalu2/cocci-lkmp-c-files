...
position p;
@@
 struct rcar_du_wb_job * cocci_id@p ;
...
position p;
@@
 struct rcar_du_wb_conn_state cocci_id@p ;
...
position p;
@@
 struct rcar_du_wb_conn_state {  struct drm_connector_state state ;  const struct rcar_du_format_info * format ; } cocci_id@p ;
...
position p;
@@
 struct rcar_du_wb_job {  struct sg_table sg_tables [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct vsp1_du_writeback_config * cocci_id@p ;
