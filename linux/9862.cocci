...
typedef bool;
@@
 bool cocci_id@p [ ATH_AIC_MAX_BT_CHANNEL ] ;
...
position p;
@@
 struct ath_aic_sram_info cocci_id@p ;
...
position p;
@@
 struct ath9k_hw_aic * cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ ATH_AIC_MAX_AIC_LIN_TABLE ] ;
...
position p;
@@
 struct ath_aic_out_info cocci_id@p [ ATH_AIC_MAX_BT_CHANNEL ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ ATH_AIC_MAX_COM_ATT_DB_TABLE ] ;
