...
position p;
@@
 struct _mace_statistics {  int xmtsv ;  int uflo ;  int lcol ;  int more ;  int one ;  int defer ;  int lcar ;  int rtry ;  int exdef ;  int xmtrc ;  int oflo ;  int clsn ;  int fram ;  int fcs ;  int rfs_rntpc ;  int rfs_rcvcc ;  int jab ;  int babl ;  int cerr ;  int rcvcco ;  int rntpco ;  int mpco ;  int mpc ;  int rntpc ;  int rcvcc ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , unsigned char RxCnt ) ;
...
typedef spinlock_t;
@@
 struct _mace_private {  struct pcmcia_device * p_dev ;  mace_statistics mace_stats ;  int multicast_ladrf [ MACE_LADRF_LEN ] ;  int multicast_num_addrs ;  char tx_free_frames ;  char tx_irq_disabled ;  spinlock_t bank_lock ; } cocci_id@p ;
