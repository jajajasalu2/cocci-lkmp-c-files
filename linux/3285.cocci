...
typedef u8,u32;
@@
 struct nct7904_data {  struct i2c_client * client ;  struct mutex bank_lock ;  int bank_sel ;  u32 fanin_mask ;  u32 vsen_mask ;  u32 tcpu_mask ;  u8 fan_mode [ FANCTL_MAX ] ;  u8 enable_dts ;  u8 has_dts ;  u8 temp_mode ;  u8 fan_alarm [ 2 ] ;  u8 vsen_alarm [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct nct7904_data * cocci_id@p ;
...
position p;
@@
 const struct nct7904_data * cocci_id@p ;
