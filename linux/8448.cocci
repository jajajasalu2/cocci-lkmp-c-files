...
position p;
@@
 struct ionic_rxq_sg_elem * cocci_id@p ;
...
position p;
@@
 struct ionic_txq_sg_elem * cocci_id@p ;
...
position p;
@@
 struct ionic_desc_info * cocci_id@p ;
...
position p;
@@
 struct ionic_page_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ionic_queue * q , struct ionic_desc_info * desc_info , struct ionic_cq_info * cq_info , void * cb_arg ) ;
...
position p;
@@
 struct ionic_rx_stats * cocci_id@p ;
...
position p;
@@
 struct ionic_tx_stats * cocci_id@p ;
