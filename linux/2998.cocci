...
position p;
@@
 struct acpi_srat_gicc_affinity * cocci_id@p ;
...
position p;
@@
 struct acpi_srat_x2apic_cpu_affinity * cocci_id@p ;
...
position p;
@@
 struct acpi_subtable_proc cocci_id@p [ 3 ] ;
...
position p;
@@
 int cocci_id@p [ MAX_PXM_DOMAINS ] ;
...
position p;
@@
 enum acpi_srat_type cocci_id@p ;
