...
position p;
@@
 struct raremono_device * cocci_id@p ;
...
typedef u8,u32;
@@
 struct raremono_device {  struct usb_device * usbdev ;  struct usb_interface * intf ;  struct video_device vdev ;  struct v4l2_device v4l2_dev ;  struct mutex lock ;  u8 * buffer ;  u32 band ;  unsigned curfreq ; } cocci_id@p ;
...
position p;
@@
 enum { BAND_FM , BAND_AM , BAND_SW , } cocci_id@p ;
