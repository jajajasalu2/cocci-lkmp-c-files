...
position p;
@@
 struct brcmstb_l2_intc_data * cocci_id@p ;
...
typedef bool,u32;
@@
 struct brcmstb_l2_intc_data {  struct irq_domain * domain ;  struct irq_chip_generic * gc ;  int status_offset ;  int mask_offset ;  bool can_wake ;  u32 saved_mask ; } cocci_id@p ;
...
position p;
@@
 const struct brcmstb_intc_init_params cocci_id@p ;
...
@@
 struct brcmstb_intc_init_params {  irq_flow_handler_t handler ;  int cpu_status ;  int cpu_clear ;  int cpu_mask_status ;  int cpu_mask_set ;  int cpu_mask_clear ; } cocci_id@p ;
