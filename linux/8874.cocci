...
position p;
@@
 struct hinic_rss_template_key cocci_id@p ;
...
position p;
@@
 struct hinic_port_stats * cocci_id@p ;
...
position p;
@@
 struct hinic_port_cap * cocci_id@p ;
...
position p;
@@
 struct hinic_cmd_vport_stats cocci_id@p ;
...
position p;
@@
 struct hinic_lro_timer cocci_id@p ;
...
position p;
@@
 enum hinic_port_state cocci_id@p ;
...
position p;
@@
 enum hinic_port_cmd cocci_id@p ;
...
position p;
@@
 enum hinic_tso_state cocci_id@p ;
...
position p;
@@
 struct hinic_rss_key cocci_id@p ;
...
position p;
@@
 enum mac_op { MAC_DEL , MAC_SET , } cocci_id@p ;
...
position p;
@@
 struct hinic_rss_context_table cocci_id@p ;
...
position p;
@@
 struct hinic_rss_indirect_tbl * cocci_id@p ;
...
position p;
@@
 struct hinic_rss_type cocci_id@p ;
...
position p;
@@
 struct hinic_rq_num cocci_id@p ;
...
position p;
@@
 struct hinic_version_info cocci_id@p ;
...
position p;
@@
 struct hinic_lro_config cocci_id@p ;
...
position p;
@@
 struct hinic_vlan_cfg cocci_id@p ;
...
position p;
@@
 struct hinic_port_func_state_cmd cocci_id@p ;
...
position p;
@@
 struct hinic_rss_context_tbl cocci_id@p ;
...
position p;
@@
 struct hinic_phy_port_stats * cocci_id@p ;
...
position p;
@@
 enum hinic_func_port_state cocci_id@p ;
...
position p;
@@
 struct hinic_rss_config cocci_id@p ;
...
position p;
@@
 struct hinic_port_rx_mode_cmd cocci_id@p ;
...
position p;
@@
 struct hinic_port_state_cmd cocci_id@p ;
...
position p;
@@
 struct hinic_port_mtu_cmd cocci_id@p ;
...
position p;
@@
 struct hinic_port_mac_cmd cocci_id@p ;
...
position p;
@@
 struct hinic_port_link_cmd cocci_id@p ;
...
position p;
@@
 struct hinic_tso_config cocci_id@p ;
...
position p;
@@
 struct hinic_rss_engine_type cocci_id@p ;
...
position p;
@@
 enum hinic_port_link_state * cocci_id@p ;
...
position p;
@@
 struct hinic_checksum_offload cocci_id@p ;
...
position p;
@@
 struct hinic_port_vlan_cmd cocci_id@p ;
...
position p;
@@
 struct hinic_rss_template_mgmt cocci_id@p ;
...
position p;
@@
 struct hinic_rss_indir_table cocci_id@p ;
...
position p;
@@
 struct hinic_vport_stats * cocci_id@p ;
...
position p;
@@
 struct hinic_port_stats_info cocci_id@p ;
