...
position p;
@@
 struct berlin_pwm_channel * cocci_id@p ;
...
position p;
@@
 struct berlin_pwm_chip * cocci_id@p ;
...
position p;
@@
 struct berlin_pwm_chip {  struct pwm_chip chip ;  struct clk * clk ;  void __iomem * base ; } cocci_id@p ;
...
typedef u32;
@@
 struct berlin_pwm_channel {  u32 enable ;  u32 ctrl ;  u32 duty ;  u32 tcnt ; } cocci_id@p ;
