...
position p;
@@
 enum vpss_clock_sel cocci_id@p ;
...
position p;
@@
 struct vpss_oper_config cocci_id@p ;
...
position p;
@@
 enum vpss_platform_type { DM644X , DM355 , DM365 , } cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( u32 val , u32 offset ) ;
...
@@
 struct vpss_oper_config { 
	 ...
	 __iomem 
		  void * vpss_regs_base2 ;  enum vpss_platform_type platform ;  spinlock_t vpss_lock ;  struct vpss_hw_ops hw_ops ; } cocci_id@p ;
