...
position p;
@@
 const struct fpu_info * cocci_id@p ;
...
position p;
@@
 struct cpu_info {  int psr_vers ;  const char * name ;  const char * pmu_name ; } cocci_id@p ;
...
position p;
@@
 const struct manufacturer_info * cocci_id@p ;
...
position p;
@@
 const struct cpu_info * cocci_id@p ;
...
position p;
@@
 struct fpu_info {  int fp_vers ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct manufacturer_info {  int psr_impl ;  struct cpu_info cpu_info [ NOCPU ] ;  struct fpu_info fpu_info [ NOFPU ] ; } cocci_id@p ;
