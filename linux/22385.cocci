...
@@
 struct sis7019 {  unsigned long ioport ;  void __iomem * ioaddr ;  int irq ;  int codecs_present ;  struct pci_dev * pci ;  struct snd_pcm * pcm ;  struct snd_card * card ;  struct snd_ac97 * ac97 [ 3 ] ;  struct mutex ac97_mutex ;  spinlock_t voice_lock ;  struct voice voices [ 64 ] ;  struct voice capture_voice ;  void * suspend_state [ SIS_SUSPEND_PAGES ] ;  int silence_users ;  dma_addr_t silence_dma_addr ; } cocci_id@p ;
