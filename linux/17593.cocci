...
position p;
@@
 struct tlbiel_va {  unsigned long pid ;  unsigned long va ;  unsigned long psize ;  unsigned long ric ; } cocci_id@p ;
...
typedef bool;
@@
 struct tlbiel_va_range {  unsigned long pid ;  unsigned long start ;  unsigned long end ;  unsigned long page_size ;  unsigned long psize ;  bool also_pwc ; } cocci_id@p ;
...
position p;
@@
 struct tlbiel_va_range cocci_id@p ;
...
position p;
@@
 struct tlbiel_pid {  unsigned long pid ;  unsigned long ric ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mm_struct * mm , unsigned long start , unsigned long end , int psize ) ;
