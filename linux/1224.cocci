...
position p;
@@
 int ( * cocci_id@p ) ( struct usb_hcd * hcd , char * buf ) ;
...
position p;
@@
 struct da8xx_ohci_hcd cocci_id@p ;
...
position p;
@@
 struct da8xx_ohci_hcd {  struct usb_hcd * hcd ;  struct clk * usb11_clk ;  struct phy * usb11_phy ;  struct regulator * vbus_reg ;  struct notifier_block nb ;  struct gpio_desc * oc_gpio ; } cocci_id@p ;
