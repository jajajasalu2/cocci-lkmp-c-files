...
position p;
@@
 int ( * cocci_id@p ) ( struct device * , const struct device_attribute * ) ;
...
position p;
@@
 enum chip_types { w83795g , w83795adg , } cocci_id@p ;
...
position p;
@@
 const struct sensor_device_attribute_2 cocci_id@p [ ] [ 28 ] ;
...
position p;
@@
 const struct sensor_device_attribute_2 cocci_id@p [ ] [ 8 ] ;
...
position p;
@@
 struct sensor_device_attribute_2 cocci_id@p [ ] [ 5 ] ;
...
position p;
@@
 const struct sensor_device_attribute_2 cocci_id@p [ ] ;
...
position p;
@@
 const struct w83795_data * cocci_id@p ;
...
position p;
@@
 const struct sensor_device_attribute_2 cocci_id@p [ ] [ 4 ] ;
