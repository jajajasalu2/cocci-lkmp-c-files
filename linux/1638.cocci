...
position p;
@@
 const struct dwc3_acpi_pdata cocci_id@p ;
...
typedef u32;
@@
 struct dwc3_acpi_pdata {  u32 qscratch_base_offset ;  u32 qscratch_base_size ;  u32 dwc3_core_base_size ;  int hs_phy_irq_index ;  int dp_hs_phy_irq_index ;  int dm_hs_phy_irq_index ;  int ss_phy_irq_index ; } cocci_id@p ;
