...
position p;
@@
 struct cache_index_dir * cocci_id@p ;
...
position p;
@@
 struct cache_index_dir {  struct kobject kobj ;  struct cache_index_dir * next ;  struct cache * cache ; } cocci_id@p ;
...
position p;
@@
 struct cache_type_info {  const char * name ;  const char * size_prop ;  const char * line_size_props [ 2 ] ;  const char * nr_sets_prop ; } cocci_id@p ;
...
position p;
@@
 const struct cache_type_info cocci_id@p [ ] ;
...
position p;
@@
 struct cache {  struct device_node * ofnode ;  struct cpumask shared_cpu_map ;  int type ;  int level ;  struct list_head list ;  struct cache * next_local ; } cocci_id@p ;
...
position p;
@@
 struct cache_dir {  struct kobject * kobj ;  struct cache_index_dir * index ; } cocci_id@p ;
