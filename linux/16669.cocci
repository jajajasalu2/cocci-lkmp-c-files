...
position p;
@@
 struct chsc_sync_area * cocci_id@p ;
...
position p;
@@
 struct chsc_private * cocci_id@p ;
...
position p;
@@
 struct chsc_cpd_info * cocci_id@p ;
...
position p;
@@
 struct chsc_request * cocci_id@p ;
...
position p;
@@
 struct chsc_async_area * cocci_id@p ;
