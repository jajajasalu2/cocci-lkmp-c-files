...
typedef u32;
@@
 u32 cocci_id@p [ NUM_PRCMU_WAKEUPS ] ;
...
position p;
@@
 struct regulator_init_data cocci_id@p [ DB8500_NUM_REGULATORS ] ;
...
position p;
@@
 struct clk_mgt cocci_id@p [ PRCMU_NUM_REG_CLOCKS ] ;
...
@@
 struct {  spinlock_t lock ;  spinlock_t dbb_irqs_lock ;  struct work_struct mask_work ;  struct mutex ac_wake_lock ;  struct completion ac_wake_work ;  struct {  u32 dbb_irqs ;  u32 dbb_wakeups ;  u32 abb_events ; } req ; } cocci_id@p ;
...
position p;
@@
 struct ux500_wdt_data cocci_id@p ;
...
position p;
@@
 enum { PLL_RAW , PLL_FIX , PLL_DIV , } cocci_id@p ;
...
position p;
@@
 const struct mfd_cell cocci_id@p ;
...
position p;
@@
 struct {  struct mutex lock ;  struct completion work ; } cocci_id@p ;
...
position p;
@@
 struct regulator_consumer_supply cocci_id@p [ ] ;
...
typedef u8;
@@
 struct {  struct mutex lock ;  struct completion work ;  u8 ape_opp ;  struct {  u8 header ;  u8 arm_opp ;  u8 ape_opp ;  u8 ape_voltage_status ; } ack ; } cocci_id@p ;
...
position p;
@@
 struct prcmu_auto_pm_config * cocci_id@p ;
...
typedef bool;
@@
 struct {  bool valid ;  struct prcmu_fw_version version ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  struct mutex lock ;  struct completion work ;  struct {  u8 status ;  u8 value ; } ack ; } cocci_id@p ;
...
typedef u32;
@@
 struct dsiescclk {  u32 en ;  u32 div_mask ;  u32 div_shift ; } cocci_id@p ;
...
typedef u32;
@@
 struct dsiclk {  u32 divsel_mask ;  u32 divsel_shift ;  u32 divsel ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct {  spinlock_t lock ;  struct mutex sysclk_lock ;  struct completion sysclk_work ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct clk_mgt {  u32 offset ;  u32 pllsw ;  int branch ;  bool clk38div ; } cocci_id@p ;
...
position p;
@@
 struct prcmu_fw_version * cocci_id@p ;
...
@@
 struct {  struct mutex lock ;  struct completion work ;  spinlock_t auto_pm_lock ;  bool auto_pm_enabled ;  struct {  u8 status ; } ack ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ NUM_PRCMU_WAKEUP_INDICES ] ;
