...
position p;
@@
 struct da9211_pdata * cocci_id@p ;
...
position p;
@@
 struct da9211 {  struct device * dev ;  struct regmap * regmap ;  struct da9211_pdata * pdata ;  struct regulator_dev * rdev [ DA9211_MAX_REGULATORS ] ;  int num_regulator ;  int chip_irq ;  int chip_id ; } cocci_id@p ;
