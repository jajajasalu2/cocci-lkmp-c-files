...
position p;
@@
 struct reset_control_array cocci_id@p ;
...
position p;
@@
 struct reset_control_lookup * cocci_id@p ;
...
position p;
@@
 const struct reset_control_lookup * cocci_id@p ;
...
position p;
@@
 struct reset_control_array {  struct reset_control base ;  unsigned int num_rstcs ;  struct reset_control * rstc [ ] ; } cocci_id@p ;
...
@@
 struct reset_control {  struct reset_controller_dev * rcdev ;  struct list_head list ;  unsigned int id ;  struct kref refcnt ;  bool acquired ;  bool shared ;  bool array ;  atomic_t deassert_count ;  atomic_t triggered_count ; } cocci_id@p ;
