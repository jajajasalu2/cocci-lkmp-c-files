...
position p;
@@
 const struct hantro_reg cocci_id@p ;
...
position p;
@@
 const struct v4l2_vp8_loopfilter_header * cocci_id@p ;
...
position p;
@@
 const struct v4l2_vp8_quantization_header * cocci_id@p ;
...
position p;
@@
 const struct v4l2_vp8_segment_header * cocci_id@p ;
...
position p;
@@
 const struct hantro_reg cocci_id@p [ 8 ] ;
...
position p;
@@
 const struct hantro_reg cocci_id@p [ 5 ] ;
...
position p;
@@
 const struct hantro_reg cocci_id@p [ 8 ] [ 6 ] ;
...
position p;
@@
 const struct hantro_reg cocci_id@p [ 4 ] ;
