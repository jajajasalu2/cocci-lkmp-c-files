...
position p;
@@
 enum { RV_CTX_F_SEEN_TAIL_CALL = 0 , RV_CTX_F_SEEN_CALL = RV_REG_RA , RV_CTX_F_SEEN_S1 = RV_REG_S1 , RV_CTX_F_SEEN_S2 = RV_REG_S2 , RV_CTX_F_SEEN_S3 = RV_REG_S3 , RV_CTX_F_SEEN_S4 = RV_REG_S4 , RV_CTX_F_SEEN_S5 = RV_REG_S5 , RV_CTX_F_SEEN_S6 = RV_REG_S6 , } cocci_id@p ;
...
position p;
@@
 struct rv_jit_context * cocci_id@p ;
...
typedef u32;
@@
 struct rv_jit_context {  struct bpf_prog * prog ;  u32 * insns ;  int ninsns ;  int epilogue_offset ;  int * offset ;  unsigned long flags ;  int stack_size ; } cocci_id@p ;
...
typedef u8;
@@
 struct rv_jit_data {  struct bpf_binary_header * header ;  u8 * image ;  struct rv_jit_context ctx ; } cocci_id@p ;
