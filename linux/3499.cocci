...
typedef u8,bool,u32;
@@
 struct usdhi6_host {  struct mmc_host * mmc ;  struct mmc_request * mrq ;  void __iomem * base ;  struct clk * clk ;  struct usdhi6_page pg ;  void * blk_page ;  size_t offset ;  size_t head_len ;  struct usdhi6_page head_pg ;  struct scatterlist bounce_sg ;  u8 bounce_buf [ 512 ] ;  struct scatterlist * sg ;  int page_idx ;  enum usdhi6_wait_for wait ;  u32 status_mask ;  u32 status2_mask ;  u32 sdio_mask ;  u32 io_error ;  u32 irq_status ;  unsigned long imclk ;  unsigned long rate ;  bool app_cmd ;  struct delayed_work timeout_work ;  unsigned long timeout ;  struct dma_chan * chan_rx ;  struct dma_chan * chan_tx ;  bool dma_active ;  struct pinctrl * pinctrl ;  struct pinctrl_state * pins_default ;  struct pinctrl_state * pins_uhs ; } cocci_id@p ;
...
position p;
@@
 struct usdhi6_page {  struct page * page ;  void * mapped ; } cocci_id@p ;
...
position p;
@@
 enum usdhi6_wait_for { USDHI6_WAIT_FOR_REQUEST , USDHI6_WAIT_FOR_CMD , USDHI6_WAIT_FOR_MREAD , USDHI6_WAIT_FOR_MWRITE , USDHI6_WAIT_FOR_READ , USDHI6_WAIT_FOR_WRITE , USDHI6_WAIT_FOR_DATA_END , USDHI6_WAIT_FOR_STOP , USDHI6_WAIT_FOR_DMA , } cocci_id@p ;
