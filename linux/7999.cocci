...
position p;
@@
 int cocci_id@p ( struct s_smc * smc ) ;
...
typedef u_char;
@@
 int cocci_id@p ( struct s_smc * smc , u_char fc , int frag_count , int frame_len , int frame_status ) ;
...
position p;
@@
 int cocci_id@p ( struct s_smc * smc , int len , int fc , char * look_ahead , int la_len ) ;
...
position p;
@@
 void * cocci_id@p ( struct s_smc * smc , unsigned int size ) ;
...
position p;
@@
 struct s_smt_rx_queue * cocci_id@p ;
...
typedef u_long;
@@
 u_long cocci_id@p ( struct s_smc * smc , void * virt ) ;
...
typedef u_long;
@@
 void cocci_id@p ( struct s_smc * smc , char far * virt , u_long phys , int len , int frame_status ) ;
...
typedef u_char;
@@
 void cocci_id@p ( struct s_smc * smc , u_char * mac_addr ) ;
...
typedef u_long;
@@
 u_long cocci_id@p ( struct s_smc * smc , struct s_smt_rx_queue * queue ) ;
...
typedef u_long;
@@
 u_long cocci_id@p ( struct s_smc * smc , void * virt , int len , int flag ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , volatile struct s_smt_fp_rxd * rxd , int frag_count , int len ) ;
...
position p;
@@
 volatile union s_fp_descr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int mode ) ;
...
position p;
@@
 struct s_smt_fp_rxd cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , volatile struct s_smt_fp_txd * txd ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , volatile struct s_smt_fp_rxd * rxd , int frag_count ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , volatile union s_fp_descr * descr , int flag ) ;
...
position p;
@@
 volatile struct s_smt_fp_txd * cocci_id@p ;
...
typedef u_long;
@@
 u_long cocci_id@p ( struct s_smc * smc , volatile union s_fp_descr * start , int count ) ;
...
typedef u_long;
@@
 u_long cocci_id@p ( struct s_smc * smc , struct s_smt_tx_queue * queue ) ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , SMbuf * mb ) ;
...
position p;
@@
 volatile struct s_smt_fp_rxd * cocci_id@p ;
...
position p;
@@
 struct s_smt_tx_queue * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct s_smc * smc , int flag , int lev ) ;
...
position p;
@@
 struct s_smt_fp_txd cocci_id@p ;
