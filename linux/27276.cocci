...
position p;
@@
 struct svc_export * cocci_id@p ( struct svc_export * new , struct svc_export * old ) ;
...
position p;
@@
 struct svc_export * cocci_id@p ( struct svc_export * ) ;
...
position p;
@@
 struct svc_expkey * cocci_id@p ( struct cache_detail * cd , struct svc_expkey * new , struct svc_expkey * old ) ;
...
position p;
@@
 struct flags {  int flag ;  char * name [ 2 ] ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * m , struct svc_export * exp ) ;
...
position p;
@@
 struct svc_expkey * cocci_id@p ( struct cache_detail * cd , struct svc_expkey * ) ;
