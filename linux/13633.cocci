...
position p;
@@
 const struct sensor_data cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef __u8,sensor_init_t;
@@
 struct sensor_data {  const __u8 * bridge_init ;  sensor_init_t * sensor_init ;  int sensor_init_size ;  int flags ;  __u8 sensor_addr ; } cocci_id@p ;
