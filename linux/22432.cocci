...
position p;
@@
 struct snd_ak4xxx_private * cocci_id@p ;
...
position p;
@@
 enum { EWS_I2C_CS8404 = 0 , EWS_I2C_PCF1 , EWS_I2C_PCF2 , EWS_I2C_88D = 0 , EWS_I2C_6FIRE = 0 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_ice1712 * ice , unsigned char reg , unsigned char data ) ;
...
position p;
@@
 const struct snd_ak4xxx_private cocci_id@p ;
...
position p;
@@
 struct ews_spec {  struct snd_i2c_device * i2cdevs [ 3 ] ; } cocci_id@p ;
