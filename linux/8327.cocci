...
position p;
@@
 struct octeon_mbox_cmd cocci_id@p ;
...
symbol cocci_id;
position p;
typedef octeon_mbox_callback_t;
@@
 octeon_mbox_callback_t cocci_id@p ;
...
position p;
@@
 struct oct_vf_stats_ctx * cocci_id@p ;
