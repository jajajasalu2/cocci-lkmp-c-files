...
position p;
@@
 int cocci_id@p ( struct seq_oss_devinfo * dp ) ;
...
position p;
@@
 struct seq_oss_devinfo * cocci_id@p [ SNDRV_SEQ_OSS_MAX_CLIENTS ] ;
...
position p;
@@
 int cocci_id@p ( struct file * file ) ;
