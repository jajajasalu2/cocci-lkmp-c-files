...
position p;
@@
 struct libertas_spi_platform_data cocci_id@p ;
...
position p;
@@
 struct da9030_battery_info cocci_id@p ;
...
position p;
@@
 struct platform_nand_data cocci_id@p ;
...
position p;
@@
 struct da903x_platform_data cocci_id@p ;
...
position p;
@@
 struct dm9000_plat_data cocci_id@p ;
...
position p;
@@
 struct matrix_keymap_data cocci_id@p ;
...
position p;
@@
 struct pxacamera_platform_data cocci_id@p ;
...
position p;
@@
 struct power_supply_info cocci_id@p ;
...
position p;
@@
 struct regulator_userspace_consumer_data cocci_id@p ;
...
position p;
@@
 struct da903x_subdev_info cocci_id@p [ ] ;
...
position p;
@@
 struct pxa27x_keypad_platform_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pxa2xx_audio_ops_t;
@@
 pxa2xx_audio_ops_t cocci_id@p ;
...
position p;
@@
 struct v3020_platform_data cocci_id@p ;
...
position p;
@@
 struct tdo24m_platform_data cocci_id@p ;
