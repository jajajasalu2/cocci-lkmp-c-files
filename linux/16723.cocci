...
typedef u8;
@@
 struct lradc_variant {  u8 divisor_numerator ;  u8 divisor_denominator ; } cocci_id@p ;
...
position p;
@@
 struct sun4i_lradc_keymap cocci_id@p ;
...
typedef u32;
@@
 struct sun4i_lradc_keymap {  u32 voltage ;  u32 keycode ; } cocci_id@p ;
...
position p;
@@
 struct sun4i_lradc_data cocci_id@p ;
...
typedef u32;
@@
 struct sun4i_lradc_data {  struct device * dev ;  struct input_dev * input ;  void __iomem * base ;  struct regulator * vref_supply ;  struct sun4i_lradc_keymap * chan0_map ;  const struct lradc_variant * variant ;  u32 chan0_map_count ;  u32 chan0_keycode ;  u32 vref ; } cocci_id@p ;
...
position p;
@@
 const struct lradc_variant cocci_id@p ;
