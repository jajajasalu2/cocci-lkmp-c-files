...
position p;
@@
 const struct pmc_data * cocci_id@p ;
...
position p;
@@
 const struct pmc_reg_map * cocci_id@p ;
...
position p;
@@
 const struct pmc_bit_map * cocci_id@p ;
...
position p;
@@
 struct pmc_clk_data * cocci_id@p ;
...
position p;
@@
 struct pmc_data {  const struct pmc_reg_map * map ;  const struct pmc_clk * clks ; } cocci_id@p ;
...
typedef u32;
@@
 struct pmc_bit_map {  const char * name ;  u32 bit_mask ; } cocci_id@p ;
...
position p;
@@
 struct pmc_reg_map {  const struct pmc_bit_map * d3_sts_0 ;  const struct pmc_bit_map * d3_sts_1 ;  const struct pmc_bit_map * func_dis ;  const struct pmc_bit_map * func_dis_2 ;  const struct pmc_bit_map * pss ; } cocci_id@p ;
