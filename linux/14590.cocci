...
position p;
@@
 struct pic32mzda_clk_data cocci_id@p ;
...
position p;
@@
 struct pic32mzda_clk_data {  struct clk * clks [ MAXCLKS ] ;  struct pic32_clk_common core ;  struct clk_onecell_data onecell_data ;  struct notifier_block failsafe_notifier ; } cocci_id@p ;
