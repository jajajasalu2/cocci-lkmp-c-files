...
position p;
@@
 struct guest_virtio_device {  struct virtio_device vdev ;  int to_host_fd ;  unsigned long notifies ; } cocci_id@p ;
...
position p;
@@
 struct vring_used_elem cocci_id@p [ RINGSIZE ] ;
...
position p;
@@
 struct scatterlist cocci_id@p [ RINGSIZE ] ;
...
position p;
@@
 struct guest_virtio_device cocci_id@p ;
