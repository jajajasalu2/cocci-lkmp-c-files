...
position p;
@@
 struct sockaddr_atmpvc cocci_id@p ;
...
position p;
@@
 struct atm_flow_data cocci_id@p ;
...
position p;
@@
 struct atm_qdisc_data {  struct atm_flow_data link ;  struct list_head flows ;  struct tasklet_struct task ; } cocci_id@p ;
...
position p;
@@
 struct atm_qdisc_data * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_ATM_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_ATM_MAX + 1 ] ;
