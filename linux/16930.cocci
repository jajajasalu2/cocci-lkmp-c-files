...
position p;
@@
 enum stmfts_regulators { STMFTS_REGULATOR_VDD , STMFTS_REGULATOR_AVDD , } cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct stmfts_data {  struct i2c_client * client ;  struct input_dev * input ;  struct led_classdev led_cdev ;  struct mutex mutex ;  struct touchscreen_properties prop ;  struct regulator_bulk_data regulators [ 2 ] ;  struct regulator * ledvdd ;  u16 chip_id ;  u8 chip_ver ;  u16 fw_ver ;  u8 config_id ;  u8 config_ver ;  u8 data [ STMFTS_DATA_MAX_SIZE ] ;  struct completion cmd_done ;  bool use_key ;  bool led_status ;  bool hover_enabled ;  bool running ; } cocci_id@p ;
