...
position p;
@@
 struct xen_pcibk_dev_data * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct pcistub_device {  struct kref kref ;  struct list_head dev_list ;  spinlock_t lock ;  struct pci_dev * dev ;  struct xen_pcibk_device * pdev ; } cocci_id@p ;
...
position p;
@@
 struct physdev_pci_device cocci_id@p ;
...
position p;
@@
 struct pcistub_device cocci_id@p ;
...
position p;
@@
 struct xen_pcibk_config_quirk * cocci_id@p ;
...
position p;
@@
 struct xen_pcie_aer_op * cocci_id@p ;
...
position p;
@@
 struct pcistub_device_id * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PCI_NODENAME_MAX ] ;
...
position p;
@@
 const struct config_field_entry * cocci_id@p ;
...
position p;
@@
 struct xen_pcibk_device * cocci_id@p ;
...
position p;
@@
 struct pcistub_device_id {  struct list_head slot_list ;  int domain ;  unsigned char bus ;  unsigned int devfn ; } cocci_id@p ;
...
position p;
@@
 const struct config_field * cocci_id@p ;
...
position p;
@@
 struct config_field * cocci_id@p ;
