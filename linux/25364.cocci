...
position p;
@@
 enum { OUTPUT_TYPE_SYNTH = PERF_TYPE_MAX , OUTPUT_TYPE_MAX , } cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 flags ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct script_spec {  struct list_head node ;  struct scripting_ops * ops ;  char spec [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 enum { DEFAULT , SET , ADD , REMOVE , } cocci_id@p ;
...
typedef u64,bool;
@@
 struct {  bool user_set ;  bool wildcard_set ;  unsigned int print_ip_opts ;  u64 fields ;  u64 invalid_fields ;  u64 user_set_fields ; } cocci_id@p [ OUTPUT_TYPE_MAX ] ;
...
typedef FILE;
@@
 struct metric_ctx {  struct perf_sample * sample ;  struct thread * thread ;  struct evsel * evsel ;  FILE * fp ; } cocci_id@p ;
...
position p;
@@
 enum binary_printer_ops cocci_id@p ;
...
position p;
@@
 struct printer_data * cocci_id@p ;
...
position p;
@@
 struct evsel_script * cocci_id@p ;
...
position p;
@@
 struct perf_stat_output_ctx cocci_id@p ;
...
position p;
@@
 struct output_option {  const char * str ;  enum perf_output_field field ; } cocci_id@p [ ] ;
...
position p;
@@
 struct perf_counts_values * cocci_id@p ;
...
typedef bool;
@@
 struct printer_data {  int line_no ;  bool hit_nul ;  bool is_printable ; } cocci_id@p ;
...
position p;
@@
 struct script_desc {  struct list_head node ;  char * name ;  char * half_liner ;  char * args ; } cocci_id@p ;
...
position p;
@@
 enum perf_output_field cocci_id@p ;
...
position p;
@@
 struct perf_record_stat_round * cocci_id@p ;
...
position p;
@@
 struct srccode_state * cocci_id@p ;
...
position p;
@@
 struct ordered_events * cocci_id@p ;
...
typedef u64,FILE;
@@
 struct evsel_script {  char * filename ;  FILE * fp ;  u64 samples ;  u64 val ;  int gnum ; } cocci_id@p ;
...
position p;
@@
 struct scripting_ops * cocci_id@p ;
...
position p;
@@
 struct perf_stat_config * cocci_id@p ;
