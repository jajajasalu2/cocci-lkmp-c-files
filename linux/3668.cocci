...
position p;
@@
 struct stratix10_svc * cocci_id@p ;
...
position p;
@@
 struct stratix10_svc_client_msg * cocci_id@p ;
...
position p;
@@
 struct stratix10_svc_data_mem * cocci_id@p ;
...
position p;
@@
 struct stratix10_svc_controller * cocci_id@p ;
...
position p;
@@
 struct stratix10_svc_chan * cocci_id@p ;
...
position p;
@@
 struct stratix10_svc_cb_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u32,phys_addr_t;
@@
 struct stratix10_svc_data {  struct stratix10_svc_chan * chan ;  phys_addr_t paddr ;  size_t size ;  u32 command ;  u32 flag ;  u64 arg [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct stratix10_svc {  struct platform_device * stratix10_svc_rsu ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long , unsigned long , unsigned long , unsigned long , unsigned long , unsigned long , unsigned long , unsigned long , struct arm_smccc_res * ) ;
...
position p;
@@
 struct stratix10_svc_data * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct stratix10_svc_chan {  struct stratix10_svc_controller * ctrl ;  struct stratix10_svc_client * scl ;  char * name ;  spinlock_t lock ; } cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct stratix10_svc_data_mem {  void * vaddr ;  phys_addr_t paddr ;  size_t size ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct stratix10_svc_command_config_type * cocci_id@p ;
...
position p;
@@
 struct stratix10_svc_sh_memory {  struct completion sync_complete ;  unsigned long addr ;  unsigned long size ;  svc_invoke_fn * invoke_fn ; } cocci_id@p ;
...
position p;
@@
 struct stratix10_svc_client * cocci_id@p ;
...
position p;
@@
 struct stratix10_svc_sh_memory * cocci_id@p ;
