...
position p;
@@
 struct lowpan_802154_cb * cocci_id@p ;
...
position p;
@@
 const struct inet_frag_queue * cocci_id@p ;
...
position p;
@@
 struct lowpan_frag_queue * cocci_id@p ;
...
position p;
@@
 struct netns_ieee802154_lowpan * cocci_id@p ;
...
position p;
@@
 struct inet_frag_queue cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lowpan_frag_queue * fq , struct sk_buff * skb , struct sk_buff * prev , struct net_device * ldev ) ;
...
position p;
@@
 const struct lowpan_802154_cb * cocci_id@p ;
...
position p;
@@
 struct frag_lowpan_compare_key cocci_id@p ;
...
position p;
@@
 const struct frag_lowpan_compare_key * cocci_id@p ;
