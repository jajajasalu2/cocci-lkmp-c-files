...
position p;
@@
 struct hostap_radiotap_rx cocci_id@p ;
...
position p;
@@
 struct linux_wlan_ng_cap_hdr * cocci_id@p ;
...
position p;
@@
 struct linux_wlan_ng_prism_hdr * cocci_id@p ;
...
position p;
@@
 struct prism2_frag_entry * cocci_id@p ;
