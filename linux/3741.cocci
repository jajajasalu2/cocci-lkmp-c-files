...
position p;
@@
 union zip_quex_sbuf_ctl cocci_id@p ;
...
position p;
@@
 struct zip_device * cocci_id@p [ MAX_ZIP_DEVICES ] ;
...
position p;
@@
 union zip_quex_sbuf_addr cocci_id@p ;
...
position p;
@@
 struct zip_registers cocci_id@p [ 64 ] ;
...
position p;
@@
 struct zip_kernel_ctx cocci_id@p ;
...
position p;
@@
 union zip_constants cocci_id@p ;
