...
position p;
@@
 struct xt_time_info cocci_id@p ;
...
position p;
@@
 const struct xt_time_info * cocci_id@p ;
...
position p;
@@
 enum { DSE_FIRST = 2039 , SECONDS_PER_DAY = 86400 , } cocci_id@p ;
...
typedef u_int8_t;
@@
 struct xtm {  u_int8_t month ;  u_int8_t monthday ;  u_int8_t weekday ;  u_int8_t hour ;  u_int8_t minute ;  u_int8_t second ;  unsigned int dse ; } cocci_id@p ;
