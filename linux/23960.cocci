...
position p;
@@
 const struct fib_nh_common * cocci_id@p ;
...
position p;
@@
 struct fib_route_iter cocci_id@p ;
...
position p;
@@
 struct fib_trie_iter * cocci_id@p ;
...
position p;
@@
 struct trie_use_stats {  unsigned int gets ;  unsigned int backtrack ;  unsigned int semantic_match_passed ;  unsigned int semantic_match_miss ;  unsigned int null_node_hit ;  unsigned int resize_node_skipped ; } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ __RTN_MAX ] ;
...
position p;
@@
 struct key_vector * cocci_id@p ( struct trie * t , struct key_vector * tn ) ;
...
position p;
@@
 struct trie_stat {  unsigned int totdepth ;  unsigned int maxdepth ;  unsigned int tnodes ;  unsigned int leaves ;  unsigned int nullpointers ;  unsigned int prefixes ;  unsigned int nodesizes [ MAX_STAT_DEPTH ] ; } cocci_id@p ;
...
position p;
@@
 const struct key_vector * cocci_id@p ;
...
position p;
@@
 struct fib_trie_iter {  struct seq_net_private p ;  struct fib_table * tb ;  struct key_vector * tnode ;  unsigned int index ;  unsigned int depth ; } cocci_id@p ;
...
position p;
@@
 struct trie_use_stats cocci_id@p ;
...
position p;
@@
 const struct trie_use_stats * cocci_id@p ;
...
position p;
@@
 const struct fib_trie_iter * cocci_id@p ;
...
position p;
@@
 struct key_vector {  t_key key ;  unsigned char pos ;  unsigned char bits ;  unsigned char slen ;  union {  struct hlist_head leaf ;  struct key_vector __rcu * tnode [ 0 ] ; } ; } cocci_id@p ;
...
typedef loff_t;
@@
 struct fib_route_iter {  struct seq_net_private p ;  struct fib_table * main_tb ;  struct key_vector * tnode ;  loff_t pos ;  t_key key ; } cocci_id@p ;
