...
position p;
@@
 struct st_ohci_platform_priv {  struct clk * clks [ USB_MAX_CLKS ] ;  struct clk * clk48 ;  struct reset_control * rst ;  struct reset_control * pwr ;  struct phy * phy ; } cocci_id@p ;
...
position p;
@@
 struct st_ohci_platform_priv * cocci_id@p ;
