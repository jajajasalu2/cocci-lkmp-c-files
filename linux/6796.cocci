...
position p;
@@
 struct menlo_command * cocci_id@p ;
...
position p;
@@
 struct menlo_response * cocci_id@p ;
...
position p;
@@
 struct lpfc_bsg_iocb * cocci_id@p ;
...
position p;
@@
 enum ELX_LOOPBACK_CMD { ELX_LOOPBACK_XRI_SETUP , ELX_LOOPBACK_DATA , } cocci_id@p ;
...
position p;
@@
 struct sli4_link_diag * cocci_id@p ;
...
position p;
@@
 struct get_mgmt_rev cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_run_link_diag_test * cocci_id@p ;
...
position p;
@@
 struct lpfc_sli_ct_request * cocci_id@p ;
...
position p;
@@
 struct dfc_mbox_req cocci_id@p ;
...
position p;
@@
 struct set_ct_event * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_set_link_diag_state * cocci_id@p ;
...
position p;
@@
 struct lpfc_trunk_info * cocci_id@p ;
...
typedef uint32_t;
@@
 struct bsg_job_data {  uint32_t type ;  struct bsg_job * set_job ;  union {  struct lpfc_bsg_event * evt ;  struct lpfc_bsg_iocb iocb ;  struct lpfc_bsg_mbox mbox ;  struct lpfc_bsg_menlo menlo ; } context_un ; } cocci_id@p ;
...
position p;
@@
 struct get_trunk_info_req cocci_id@p ;
...
position p;
@@
 struct diag_mode_test cocci_id@p ;
...
position p;
@@
 struct READ_EVENT_LOG_VAR * cocci_id@p ;
...
position p;
@@
 struct forced_link_speed_support_reply cocci_id@p ;
...
position p;
@@
 struct get_ct_event cocci_id@p ;
...
symbol cocci_id;
position p;
typedef MAILBOX_t,LPFC_MBOXQ_t,uint32_t,uint8_t;
@@
 struct lpfc_bsg_mbox {  LPFC_MBOXQ_t * pmboxq ;  MAILBOX_t * mb ;  struct lpfc_dmabuf * dmabuffers ;  uint8_t * ext ;  uint32_t mbOffset ;  uint32_t inExtWLen ;  uint32_t outExtWLen ; } cocci_id@p ;
...
position p;
@@
 struct get_forced_link_speed_support cocci_id@p ;
...
position p;
@@
 struct lpfc_dmabuf * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct lpfc_bsg_menlo {  struct lpfc_iocbq * cmdiocbq ;  struct lpfc_dmabuf * rmp ; } cocci_id@p ;
...
position p;
@@
 struct lpfc_mbox_ext_buf_ctx cocci_id@p ;
...
position p;
@@
 struct lpfc_bsg_get_fwlog_req * cocci_id@p ;
...
position p;
@@
 struct sg_mapping_iter cocci_id@p ;
...
position p;
@@
 struct bsg_job_data * cocci_id@p ;
...
position p;
@@
 struct lpfc_dmabufext cocci_id@p ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,uint32_t;
@@
 struct lpfc_bsg_event {  struct list_head node ;  struct kref kref ;  wait_queue_head_t wq ;  uint32_t type_mask ;  uint32_t req_id ;  uint32_t reg_id ;  unsigned long wait_time_stamp ;  int waiting ;  struct list_head events_to_get ;  struct list_head events_to_see ;  void * dd_data ; } cocci_id@p ;
...
position p;
@@
 struct lpfc_bsg_ras_req cocci_id@p ;
...
position p;
@@
 struct get_mgmt_rev_reply * cocci_id@p ;
...
position p;
@@
 struct lpfc_bsg_event cocci_id@p ;
...
typedef uint32_t;
@@
 struct lpfc_dmabufext {  struct lpfc_dmabuf dma ;  uint32_t size ;  uint32_t flag ; } cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_set_link_diag_loopback * cocci_id@p ;
...
position p;
@@
 struct lpfc_rport_data * cocci_id@p ;
...
position p;
@@
 struct lpfc_bsg_get_ras_lwpd * cocci_id@p ;
...
position p;
@@
 struct get_ct_event_reply * cocci_id@p ;
...
position p;
@@
 struct lpfc_bsg_set_ras_config_req cocci_id@p ;
...
typedef uint32_t;
@@
 struct event_data {  struct list_head node ;  uint32_t type ;  uint32_t immed_dat ;  void * data ;  uint32_t len ; } cocci_id@p ;
...
position p;
@@
 struct lpfc_bsg_get_ras_config_reply * cocci_id@p ;
...
position p;
@@
 struct lpfc_bsg_menlo * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_nembed_cmd * cocci_id@p ;
...
position p;
@@
 struct lpfc_bsg_iocb {  struct lpfc_iocbq * cmdiocbq ;  struct lpfc_dmabuf * rmp ;  struct lpfc_nodelist * ndlp ; } cocci_id@p ;
...
position p;
@@
 struct diag_mode_set cocci_id@p ;
...
position p;
@@
 struct lpfc_sli_config_mbox * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_sli4_config * cocci_id@p ;
...
position p;
@@
 typeof ( struct event_data ) cocci_id@p ;
...
position p;
@@
 struct send_mgmt_resp * cocci_id@p ;
