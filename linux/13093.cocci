...
position p;
@@
 struct hp_cpu {  unsigned int processor_id ;  struct list_head handlers ;  struct list_head node ;  struct hp_handler * iterator ; } cocci_id@p ;
...
typedef atomic_t;
@@
 struct bstrap {  int ( * fn ) ( void ) ;  atomic_t started ; } cocci_id@p ;
