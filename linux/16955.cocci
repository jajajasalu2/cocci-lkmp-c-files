...
position p;
@@
 struct icn8505_data * cocci_id@p ;
...
position p;
@@
 struct icn8505_data {  struct i2c_client * client ;  struct input_dev * input ;  struct gpio_desc * wake_gpio ;  struct touchscreen_properties prop ;  char firmware_name [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct icn8505_touch * cocci_id@p ;
...
position p;
@@
 struct icn8505_touch_data cocci_id@p ;
