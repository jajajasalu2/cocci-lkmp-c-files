...
position p;
@@
 int cocci_id@p ( int unit , struct console_font * op ) ;
...
position p;
@@
 const struct gio_device_id * cocci_id@p ;
...
position p;
@@
 unsigned char * cocci_id@p [ MAX_NR_CONSOLES ] ;
...
position p;
@@
 struct newport_regs cocci_id@p ;
...
position p;
@@
 struct gio_device_id cocci_id@p [ ] ;
