...
typedef spinlock_t;
@@
 struct zynq_fpga_priv {  int irq ;  struct clk * clk ;  void __iomem * io_base ;  struct regmap * slcr ;  spinlock_t dma_lock ;  unsigned int dma_elm ;  unsigned int dma_nelms ;  struct scatterlist * cur_sg ;  struct completion dma_done ; } cocci_id@p ;
...
position p;
@@
 const struct zynq_fpga_priv * cocci_id@p ;
...
position p;
@@
 struct zynq_fpga_priv * cocci_id@p ;
