...
position p;
@@
 enum adux1020_op_modes cocci_id@p ;
...
typedef u8,u16;
@@
 struct adux1020_mode_data {  u8 bytes ;  u8 buf_len ;  u16 int_en ; } cocci_id@p ;
...
position p;
@@
 struct adux1020_data {  struct i2c_client * client ;  struct iio_dev * indio_dev ;  struct mutex lock ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 enum adux1020_op_modes { ADUX1020_MODE_STANDBY , ADUX1020_MODE_PROX_I , ADUX1020_MODE_PROX_XY , ADUX1020_MODE_GEST , ADUX1020_MODE_SAMPLE , ADUX1020_MODE_FORCE = 0x0e , ADUX1020_MODE_IDLE = 0x0f , } cocci_id@p ;
...
position p;
@@
 struct adux1020_data * cocci_id@p ;
...
position p;
@@
 const struct adux1020_mode_data cocci_id@p [ ] ;
