...
position p;
@@
 struct mlx4_ib_sriov cocci_id@p ;
...
position p;
@@
 enum slave_port_gen_event cocci_id@p ;
...
position p;
@@
 struct mlx4_alias_guid_work_context cocci_id@p ;
...
position p;
@@
 struct mlx4_sriov_alias_guid_port_rec_det cocci_id@p ;
...
position p;
@@
 struct mlx4_sriov_alias_guid * cocci_id@p ;
...
position p;
@@
 struct mlx4_next_alias_guid_work * cocci_id@p ;
...
position p;
@@
 enum slave_port_state cocci_id@p ;
...
position p;
@@
 struct mlx4_sriov_alias_guid_info_rec_det cocci_id@p ;
...
typedef u8;
@@
 struct mlx4_next_alias_guid_work {  u8 port ;  u8 block_num ;  u8 method ;  struct mlx4_sriov_alias_guid_info_rec_det rec_det ; } cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct mlx4_ib_dev * dev , u8 port , int * resched_delay_sec ) ;
...
typedef u8;
@@
 struct mlx4_alias_guid_work_context {  u8 port ;  struct mlx4_ib_dev * dev ;  struct ib_sa_query * sa_query ;  struct completion done ;  int query_id ;  struct list_head list ;  int block_num ;  ib_sa_comp_mask guid_indexes ;  u8 method ; } cocci_id@p ;
