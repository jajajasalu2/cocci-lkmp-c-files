...
typedef s32;
@@
 struct wf_smu_slots_fans_state {  int ticks ;  s32 setpoint ;  struct wf_pid_state pid ; } cocci_id@p ;
...
position p;
@@
 struct wf_smu_drive_fans_state * cocci_id@p ;
...
position p;
@@
 struct wf_smu_slots_fans_state cocci_id@p ;
...
typedef s32;
@@
 struct wf_smu_cpu_fans_state {  int ticks ;  s32 cpu_setpoint ;  struct wf_cpu_pid_state pid ; } cocci_id@p ;
...
typedef s32;
@@
 struct wf_smu_drive_fans_state {  int ticks ;  s32 setpoint ;  struct wf_pid_state pid ; } cocci_id@p ;
