...
position p;
@@
 struct intel_scu_ipc_dev * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef intel_scu_ipc_pdata_t;
@@
 const struct intel_scu_ipc_pdata_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,intel_scu_ipc_pdata_t;
@@
 struct intel_scu_ipc_pdata_t {  u32 i2c_base ;  u32 i2c_len ;  u8 irq_mode ; } cocci_id@p ;
...
typedef u8;
@@
 struct intel_scu_ipc_dev {  struct device * dev ;  void __iomem * ipc_base ;  void __iomem * i2c_base ;  struct completion cmd_complete ;  u8 irq_mode ; } cocci_id@p ;
...
typedef intel_scu_ipc_pdata_t;
@@
 struct intel_scu_ipc_pdata_t * cocci_id@p ;
