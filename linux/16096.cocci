...
position p;
@@
 struct apci1516_boardinfo {  const char * name ;  int di_nchan ;  int do_nchan ;  int has_wdog ; } cocci_id@p ;
...
position p;
@@
 const struct apci1516_boardinfo cocci_id@p [ ] ;
...
position p;
@@
 struct apci1516_private * cocci_id@p ;
...
position p;
@@
 struct apci1516_private {  unsigned long wdog_iobase ; } cocci_id@p ;
...
position p;
@@
 enum apci1516_boardid { BOARD_APCI1016 , BOARD_APCI1516 , BOARD_APCI2016 , } cocci_id@p ;
