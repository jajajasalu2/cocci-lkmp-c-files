...
position p;
@@
 struct am33xx_pm_platform_data * cocci_id@p ;
...
position p;
@@
 struct am33xx_pm_ro_sram_data cocci_id@p ;
...
position p;
@@
 struct wkup_m3_wakeup_src cocci_id@p ;
...
position p;
@@
 struct am33xx_pm_sram_addr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long unused ) ;
