...
position p;
@@
 struct abx500_pinctrl * cocci_id@p ;
...
position p;
@@
 struct abx500_gpio_irq_cluster * cocci_id@p ;
...
position p;
@@
 struct alternate_functions cocci_id@p ;
...
position p;
@@
 struct abx500_pinctrl_soc_data * cocci_id@p ;
...
position p;
@@
 const struct abx500_pingroup * cocci_id@p ;
...
position p;
@@
 const struct abx500_pinrange * cocci_id@p ;
...
position p;
@@
 struct abx500_pinctrl {  struct device * dev ;  struct pinctrl_dev * pctldev ;  struct abx500_pinctrl_soc_data * soc ;  struct gpio_chip chip ;  struct ab8500 * parent ;  struct abx500_gpio_irq_cluster * irq_cluster ;  int irq_cluster_size ; } cocci_id@p ;
