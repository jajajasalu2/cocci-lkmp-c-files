...
position p;
@@
 int cocci_id@p ( struct fw_dump * fadump_conf ) ;
...
position p;
@@
 const struct opal_fadump_mem_struct * cocci_id@p ;
...
position p;
@@
 struct opal_fadump_mem_struct * cocci_id@p ;
