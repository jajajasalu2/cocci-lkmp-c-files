...
position p;
@@
 const struct idt_ntb_part cocci_id@p [ IDT_MAX_NR_PARTS ] ;
...
position p;
@@
 const struct idt_ntb_port cocci_id@p [ IDT_MAX_NR_PORTS ] ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * devid ) ;
...
position p;
@@
 struct idt_89hpes_cfg * cocci_id@p ;
...
position p;
@@
 const struct idt_ntb_bar * cocci_id@p ;
...
position p;
@@
 const struct idt_ntb_regs cocci_id@p ;
...
position p;
@@
 const enum idt_temp_val cocci_id@p ;
...
position p;
@@
 struct idt_ntb_peer * cocci_id@p ;
...
position p;
@@
 struct idt_mw_cfg cocci_id@p [ IDT_MAX_NR_MWS ] ;
...
position p;
@@
 void cocci_id@p ( struct idt_ntb_dev * ndev ) ;
...
position p;
@@
 const struct idt_89hpes_cfg cocci_id@p ;
