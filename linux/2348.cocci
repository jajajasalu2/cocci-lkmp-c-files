...
position p;
@@
 struct of_bus * cocci_id@p ( struct device_node * np ) ;
...
typedef u64,__be32;
@@
 int cocci_id@p ( struct device_node * dev , const __be32 * addrp , u64 size , unsigned int flags , const char * name , struct resource * r ) ;
...
position p;
@@
 struct device_node * ( * cocci_id@p ) ( const struct device_node * ) ;
