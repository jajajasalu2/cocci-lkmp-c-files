...
position p;
@@
 struct hclge_priority_weight_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_pg_shapping_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_pri_shapping_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_tqp_tx_queue_tc_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_desc cocci_id@p [ HCLGE_GET_DFX_REG_TYPE_CNT ] ;
...
position p;
@@
 struct hclge_port_shapping_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_dbg_reg_common_msg * cocci_id@p ;
...
position p;
@@
 struct hclge_dbg_bitmap_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_get_m7_bd_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_dbg_reg_type_info cocci_id@p [ ] ;
...
position p;
@@
 struct hclge_nq_to_qs_link_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_pg_to_pri_link_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_mac_ethertype_idx_rd_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_desc cocci_id@p [ HCLGE_CMD_NCL_CONFIG_BD_NUM ] ;
...
position p;
@@
 struct hclge_qos_pri_map_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_bp_to_qs_map_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_dbg_dfx_message * cocci_id@p ;
...
position p;
@@
 struct hclge_pg_weight_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_cfg_pause_param_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_mac_tnl_stats cocci_id@p ;
...
position p;
@@
 struct hclge_ets_tc_weight_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_qs_shapping_cmd * cocci_id@p ;
...
position p;
@@
 struct hclge_qs_to_pri_link_cmd * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ HCLGE_DBG_BUF_LEN ] ;
...
position p;
@@
 struct hclge_qs_weight_cmd * cocci_id@p ;
