...
position p;
@@
 int cocci_id@p [ MAX_DBG_GRC_PARAMS ] ;
...
position p;
@@
 const struct dbg_idle_chk_cond_reg * cocci_id@p ;
...
position p;
@@
 enum debug_print_features { OLD_MODE = 0 , IDLE_CHK = 1 , GRC_DUMP = 2 , MCP_TRACE = 3 , REG_FIFO = 4 , PROTECTION_OVERRIDE = 5 , IGU_FIFO = 6 , PHY = 7 , FW_ASSERTS = 8 , NVM_CFG1 = 9 , DEFAULT_CFG = 10 , NVM_META = 11 , } cocci_id@p ;
...
position p;
@@
 enum qed_dbg_features cocci_id@p ;
...
position p;
@@
 const struct dbg_dump_split_hdr * cocci_id@p ;
...
typedef u32;
@@
 struct platform_defs {  const char * name ;  u32 delay_factor ;  u32 dmae_thresh ;  u32 log_thresh ; } cocci_id@p ;
...
position p;
@@
 const struct dbg_attn_block_type_data * cocci_id@p ;
...
typedef u32;
@@
 struct dbg_array {  const u32 * ptr ;  u32 size_in_dwords ; } cocci_id@p ;
...
position p;
@@
 const struct dbg_dump_mem * cocci_id@p ;
...
position p;
@@
 struct mcp_file_att cocci_id@p ;
...
position p;
@@
 enum dbg_bus_frame_modes cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ VFC_RAM_ADDR_DWORDS ] ;
...
position p;
@@
 struct big_ram_defs * cocci_id@p ;
...
position p;
@@
 const struct dbg_dump_cond_hdr * cocci_id@p ;
...
position p;
@@
 struct dbg_tools_user_data cocci_id@p ;
...
position p;
@@
 struct qed_dbg_feature * cocci_id@p ;
...
position p;
@@
 struct dbg_idle_chk_result_hdr cocci_id@p ;
...
typedef u32;
@@
 struct phy_defs {  const char * phy_name ;  u32 base_addr ;  u32 tbus_addr_lo_addr ;  u32 tbus_addr_hi_addr ;  u32 tbus_data_lo_addr ;  u32 tbus_data_hi_addr ; } cocci_id@p ;
...
position p;
@@
 struct dbg_array cocci_id@p [ MAX_BIN_DBG_BUFFER_TYPE ] ;
...
typedef u8,bool,u32;
@@
 struct block_defs {  const char * name ;  bool exists [ MAX_CHIP_IDS ] ;  bool associated_to_storm ;  u32 storm_id ;  enum dbg_bus_clients dbg_client_id [ MAX_CHIP_IDS ] ;  u32 dbg_select_addr ;  u32 dbg_enable_addr ;  u32 dbg_shift_addr ;  u32 dbg_force_valid_addr ;  u32 dbg_force_frame_addr ;  bool has_reset_bit ;  bool unreset ;  enum dbg_reset_regs reset_reg ;  u8 reset_bit_offset ; } cocci_id@p ;
...
typedef u32;
@@
 struct user_dbg_array {  const u32 * ptr ;  u32 size_in_dwords ; } cocci_id@p ;
...
position p;
@@
 struct reset_reg_defs cocci_id@p [ ] ;
...
position p;
@@
 struct split_type_defs cocci_id@p [ ] ;
...
position p;
@@
 const struct dbg_attn_block * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ VFC_CAM_CMD_DWORDS ] ;
...
position p;
@@
 struct dbg_idle_chk_rule cocci_id@p ;
...
typedef u32;
@@
 struct rss_mem_defs {  const char * mem_name ;  const char * type_name ;  u32 addr ;  u32 entry_width ;  u32 num_entries [ MAX_CHIP_IDS ] ; } cocci_id@p ;
...
position p;
@@
 struct mcp_trace_meta * cocci_id@p ;
...
position p;
@@
 struct user_dbg_array * cocci_id@p ;
...
position p;
@@
 const union dbg_idle_chk_reg * cocci_id@p ;
...
position p;
@@
 struct dbg_idle_chk_result_reg_hdr * cocci_id@p ;
...
typedef bool,u32;
@@
 struct reset_reg_defs {  u32 addr ;  bool exists [ MAX_CHIP_IDS ] ;  u32 unreset_val [ MAX_CHIP_IDS ] ; } cocci_id@p ;
...
position p;
@@
 struct dbg_attn_bit_mapping * cocci_id@p ;
...
typedef u32;
@@
 struct dbg_tools_user_data {  struct mcp_trace_meta mcp_trace_meta ;  const u32 * mcp_trace_user_meta_buf ; } cocci_id@p ;
...
position p;
@@
 enum platform_ids { PLATFORM_ASIC , PLATFORM_RESERVED , PLATFORM_RESERVED2 , PLATFORM_RESERVED3 , MAX_PLATFORM_IDS , } cocci_id@p ;
...
position p;
@@
 struct reg_fifo_element * cocci_id@p ;
...
position p;
@@
 struct igu_fifo_element * cocci_id@p ;
...
position p;
@@
 enum igu_fifo_addr_types { IGU_ADDR_TYPE_MSIX_MEM , IGU_ADDR_TYPE_WRITE_PBA , IGU_ADDR_TYPE_WRITE_INT_ACK , IGU_ADDR_TYPE_WRITE_ATTN_BITS , IGU_ADDR_TYPE_READ_INT , IGU_ADDR_TYPE_WRITE_PROD_UPDATE , IGU_ADDR_TYPE_RESERVED , } cocci_id@p ;
...
position p;
@@
 enum debug_print_features cocci_id@p ;
...
position p;
@@
 struct split_type_defs {  const char * name ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct mcp_trace_meta {  u32 modules_num ;  char * * modules ;  u32 formats_num ;  struct mcp_trace_format * formats ;  bool is_allocated ; } cocci_id@p ;
...
typedef u32;
@@
 struct big_ram_defs {  const char * instance_name ;  enum mem_groups mem_group_id ;  enum mem_groups ram_mem_group_id ;  enum dbg_grc_params grc_param ;  u32 addr_reg_addr ;  u32 data_reg_addr ;  u32 is_256b_reg_addr ;  u32 is_256b_bit_offset [ MAX_CHIP_IDS ] ;  u32 ram_size [ MAX_CHIP_IDS ] ; } cocci_id@p ;
...
position p;
@@
 struct vfc_ram_defs * cocci_id@p ;
...
position p;
@@
 struct chip_defs cocci_id@p [ MAX_CHIP_IDS ] ;
...
position p;
@@
 struct user_dbg_array cocci_id@p [ MAX_BIN_DBG_BUFFER_TYPE ] ;
...
position p;
@@
 struct dbg_attn_reg_result * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MAX_DBG_RESET_REGS ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ IDLE_CHK_MAX_ENTRIES_SIZE ] ;
...
position p;
@@
 const struct igu_fifo_addr_data * cocci_id@p ;
...
position p;
@@
 struct block_defs * cocci_id@p [ MAX_BLOCK_ID ] ;
...
position p;
@@
 const struct dbg_idle_chk_rule * cocci_id@p ;
...
position p;
@@
 struct dbg_tools_data * cocci_id@p ;
...
position p;
@@
 enum qed_nvm_images cocci_id@p ;
...
position p;
@@
 struct qed_nvm_image_att cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ VFC_RAM_CMD_DWORDS ] ;
...
position p;
@@
 const struct dbg_dump_reg * cocci_id@p ;
...
position p;
@@
 struct platform_defs cocci_id@p [ ] ;
...
position p;
@@
 struct mcp_trace_format * cocci_id@p ;
...
typedef bool,u32;
@@
 struct storm_defs {  char letter ;  enum block_id block_id ;  enum dbg_bus_clients dbg_client_id [ MAX_CHIP_IDS ] ;  bool has_vfc ;  u32 sem_fast_mem_addr ;  u32 sem_frame_mode_addr ;  u32 sem_slow_enable_addr ;  u32 sem_slow_mode_addr ;  u32 sem_slow_mode1_conf_addr ;  u32 sem_sync_dbg_empty_addr ;  u32 sem_slow_dbg_empty_addr ;  u32 cm_ctx_wr_addr ;  u32 cm_conn_ag_ctx_lid_size ;  u32 cm_conn_ag_ctx_rd_addr ;  u32 cm_conn_st_ctx_lid_size ;  u32 cm_conn_st_ctx_rd_addr ;  u32 cm_task_ag_ctx_lid_size ;  u32 cm_task_ag_ctx_rd_addr ;  u32 cm_task_st_ctx_lid_size ;  u32 cm_task_st_ctx_rd_addr ; } cocci_id@p ;
...
position p;
@@
 const struct dbg_attn_reg * cocci_id@p ;
...
typedef u16;
@@
 struct igu_fifo_addr_data {  u16 start_addr ;  u16 end_addr ;  char * desc ;  char * vf_desc ;  enum igu_fifo_addr_types type ; } cocci_id@p ;
...
position p;
@@
 const struct dbg_idle_chk_rule_parsing_data * cocci_id@p ;
...
position p;
@@
 struct fw_asserts_ram_section * cocci_id@p ;
...
position p;
@@
 enum dbg_grc_params cocci_id@p ;
...
position p;
@@
 struct fw_info_location cocci_id@p ;
...
position p;
@@
 struct chip_defs {  const char * name ; } cocci_id@p ;
...
position p;
@@
 const struct dbg_idle_chk_cond_hdr * cocci_id@p ;
...
position p;
@@
 struct grc_param_defs cocci_id@p [ ] ;
...
position p;
@@
 struct dbg_dump_mem cocci_id@p ;
...
position p;
@@
 struct dbg_attn_block_result * cocci_id@p ;
...
typedef bool,u32;
@@
 struct grc_param_defs {  u32 default_val [ MAX_CHIP_IDS ] ;  u32 min ;  u32 max ;  bool is_preset ;  bool is_persistent ;  u32 exclude_all_preset_val ;  u32 crash_preset_val ; } cocci_id@p ;
...
typedef u32;
@@
 u32 ( * cocci_id@p [ ] ) ( const u32 * r , const u32 * imm ) ;
...
position p;
@@
 struct block_info {  const char * name ;  enum block_id id ; } cocci_id@p ;
...
position p;
@@
 struct bin_buffer_hdr * cocci_id@p ;
...
position p;
@@
 struct dbg_bus_block * cocci_id@p ;
...
position p;
@@
 enum init_split_types cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ VFC_CAM_ADDR_DWORDS ] ;
...
position p;
@@
 enum igu_fifo_sources { IGU_SRC_PXP0 , IGU_SRC_PXP1 , IGU_SRC_PXP2 , IGU_SRC_PXP3 , IGU_SRC_PXP4 , IGU_SRC_PXP5 , IGU_SRC_PXP6 , IGU_SRC_PXP7 , IGU_SRC_CAU , IGU_SRC_ATTN , IGU_SRC_GRC , } cocci_id@p ;
...
typedef u32;
@@
 struct vfc_ram_defs {  const char * mem_name ;  const char * type_name ;  u32 base_row ;  u32 num_rows ; } cocci_id@p ;
...
position p;
@@
 struct idle_chk_data * cocci_id@p ;
...
position p;
@@
 struct rss_mem_defs cocci_id@p [ ] ;
...
position p;
@@
 struct public_global cocci_id@p ;
...
position p;
@@
 const struct dbg_idle_chk_info_reg * cocci_id@p ;
...
position p;
@@
 struct protection_override_element * cocci_id@p ;
...
position p;
@@
 struct mcp_public_data cocci_id@p ;
