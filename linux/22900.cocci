...
position p;
@@
 const struct snd_bebob_spec cocci_id@p ;
...
position p;
@@
 struct special_params * cocci_id@p ;
...
position p;
@@
 const struct snd_bebob_clock_spec cocci_id@p ;
...
typedef bool;
@@
 struct special_params {  bool is1814 ;  unsigned int clk_src ;  unsigned int dig_in_fmt ;  unsigned int dig_out_fmt ;  unsigned int clk_lock ;  struct snd_ctl_elem_id * ctl_id_sync ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct snd_bebob * bebob ) ;
...
position p;
@@
 const struct snd_bebob_meter_spec cocci_id@p ;
...
position p;
@@
 const struct snd_bebob_rate_spec cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ 2 ] [ 2 ] [ 3 ] ;
...
position p;
@@
 const enum snd_bebob_clock_type cocci_id@p [ ] ;
