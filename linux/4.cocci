...
position p;
@@
 enum compound { NOT_COMPOUND , SET , SET_OF , SEQUENCE , SEQUENCE_OF , CHOICE , ANY , TYPE_REF , TAG_OVERRIDE , } cocci_id@p ;
...
position p;
@@
 struct token {  unsigned short line ;  enum token_type token_type : 8 ;  unsigned char size ;  struct action * action ;  char * content ;  struct type * type ; } cocci_id@p ;
...
typedef FILE;
@@
 void cocci_id@p ( FILE * out , FILE * hdr ) ;
...
typedef FILE;
@@
 void cocci_id@p ( FILE * out , struct element * e , struct element * tag ) ;
...
position p;
@@
 struct element * cocci_id@p ( struct token * * _cursor , struct token * end , int alternates ) ;
...
position p;
@@
 const unsigned char cocci_id@p [ NR__TOKENS ] ;
...
position p;
@@
 struct action {  struct action * next ;  char * name ;  unsigned char index ; } cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ NR__DIRECTIVES ] ;
...
position p;
@@
 const struct type * const * cocci_id@p ;
...
position p;
@@
 struct element * cocci_id@p ( struct token * * _cursor , struct token * stop , struct token * name ) ;
