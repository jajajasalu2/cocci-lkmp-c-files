...
position p;
@@
 struct extcon_cable * cocci_id@p ;
...
position p;
@@
 const struct __extcon_info {  unsigned int type ;  unsigned int id ;  const char * name ; } cocci_id@p [ ] ;
