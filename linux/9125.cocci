...
position p;
@@
 struct mlx5_fpga_tls_command_context * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct mlx5_fpga_conn * conn , struct mlx5_fpga_device * fdev , struct mlx5_fpga_tls_command_context * ctx , struct mlx5_fpga_dma_buf * resp ) ;
...
position p;
@@
 struct mlx5_fpga_tls * cocci_id@p ;
...
position p;
@@
 struct mlx5_setup_stream_context * cocci_id@p ;
...
position p;
@@
 struct tls_crypto_info * cocci_id@p ;
...
position p;
@@
 enum mlx5_fpga_setup_stream_status { MLX5_FPGA_CMD_PENDING , MLX5_FPGA_CMD_SEND_FAILED , MLX5_FPGA_CMD_RESPONSE_RECEIVED , MLX5_FPGA_CMD_ABANDONED , } cocci_id@p ;
...
@@
 struct mlx5_setup_stream_context {  struct mlx5_fpga_tls_command_context cmd ;  atomic_t status ;  u32 syndrome ;  struct completion comp ; } cocci_id@p ;
...
position p;
@@
 mlx5_fpga_tls_command_complete cocci_id@p ;
...
typedef refcount_t;
@@
 struct mlx5_fpga_tls_command_context {  struct list_head list ;  refcount_t ref ;  struct mlx5_fpga_dma_buf buf ;  mlx5_fpga_tls_command_complete complete ; } cocci_id@p ;
