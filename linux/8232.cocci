...
typedef bool,u16;
@@
 bool cocci_id@p ( struct net_device * , u16 , u16 , u16 * ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct net_device * , u16 , u16 , u16 ) ;
...
position p;
@@
 const struct tlan_list * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * , int areg , char * mac ) ;
...
position p;
@@
 int cocci_id@p [ MAX_TLAN_BOARDS ] ;
...
typedef u8;
@@
 int cocci_id@p ( struct net_device * , u8 , u8 * ) ;
...
typedef u32,u16;
@@
 struct board {  const char * device_label ;  u32 flags ;  u16 addr_ofs ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct tlan_list * , char * , int ) ;
...
typedef u32,u16;
@@
 u32 cocci_id@p ( struct net_device * , u16 ) ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pdev , long ioaddr , int irq , int rev , const struct pci_device_id * ent ) ;
...
typedef u32,u16;
@@
 u32 ( * cocci_id@p [ TLAN_INT_NUMBER_OF_INTS ] ) ( struct net_device * , u16 ) ;
...
typedef u32,u16;
@@
 void cocci_id@p ( u16 , u32 , unsigned ) ;
