...
symbol cocci_id;
position p;
typedef drm_via_blitsync_t;
@@
 drm_via_blitsync_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_dmablit_t;
@@
 const drm_via_dmablit_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_descriptor_t;
@@
 drm_via_descriptor_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_sg_info_t;
@@
 drm_via_sg_info_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_via_blitq_t;
@@
 drm_via_blitq_t * cocci_id@p ;
...
typedef uint32_t;
@@
 struct _drm_via_descriptor {  uint32_t mem_addr ;  uint32_t dev_addr ;  uint32_t size ;  uint32_t next ; } cocci_id@p ;
