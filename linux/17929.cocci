...
position p;
@@
 struct pci_sun4v_msiq_entry * cocci_id@p ;
...
position p;
@@
 struct vpci_version {  unsigned long major ;  unsigned long minor ; } cocci_id@p ;
...
position p;
@@
 struct pci_pbm_info * cocci_id@p ;
...
position p;
@@
 struct vpci_version cocci_id@p [ ] ;
...
typedef u64;
@@
 struct iommu_batch {  struct device * dev ;  unsigned long prot ;  unsigned long entry ;  u64 * pglist ;  unsigned long npages ; } cocci_id@p ;
...
position p;
@@
 const struct sparc64_msiq_ops cocci_id@p ;
