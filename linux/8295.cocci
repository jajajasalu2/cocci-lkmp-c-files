...
symbol cocci_id;
position p;
typedef rtl_fw_read_t;
@@
 rtl_fw_read_t cocci_id@p ;
...
position p;
@@
 enum rtl_fw_opcode { PHY_READ = 0x0 , PHY_DATA_OR = 0x1 , PHY_DATA_AND = 0x2 , PHY_BJMPN = 0x3 , PHY_MDIO_CHG = 0x4 , PHY_CLEAR_READCOUNT = 0x7 , PHY_WRITE = 0x8 , PHY_READCOUNT_EQ_SKIP = 0x9 , PHY_COMP_EQ_SKIPN = 0xa , PHY_COMP_NEQ_SKIPN = 0xb , PHY_WRITE_PREVIOUS = 0xc , PHY_SKIPN = 0xd , PHY_DELAY_MS = 0xe , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rtl_fw_write_t;
@@
 rtl_fw_write_t cocci_id@p ;
...
position p;
@@
 struct rtl_fw_phy_action cocci_id@p ;
...
position p;
@@
 struct rtl8169_private * cocci_id@p ;
