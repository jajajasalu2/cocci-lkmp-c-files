...
position p;
@@
 enum sgtl5000_regulator_supplies { DVDD , AVDD , PVDD , HPVDD , ES8328_SUPPLY_NUM , } cocci_id@p ;
...
typedef bool;
@@
 struct es8328_priv {  struct regmap * regmap ;  struct clk * clk ;  int playback_fs ;  bool deemph ;  int mclkdiv2 ;  const struct snd_pcm_hw_constraint_list * sysclk_constraints ;  const int * mclk_ratios ;  bool master ;  struct regulator_bulk_data supplies [ ES8328_SUPPLY_NUM ] ; } cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ ES8328_SUPPLY_NUM ] ;
...
position p;
@@
 const struct {  int rate ;  unsigned int val ; } cocci_id@p [ ] ;
