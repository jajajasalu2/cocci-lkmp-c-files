...
position p;
@@
 enum { MTK_JPEG_BUF_FLAGS_INIT = 0 , MTK_JPEG_BUF_FLAGS_LAST_FRAME = 1 , } cocci_id@p ;
...
position p;
@@
 struct mtk_jpeg_ctx * cocci_id@p ;
...
position p;
@@
 struct mtk_jpeg_fmt cocci_id@p [ ] ;
...
position p;
@@
 struct mtk_jpeg_src_buf cocci_id@p ;
...
position p;
@@
 struct mtk_jpeg_src_buf {  struct vb2_v4l2_buffer b ;  struct list_head list ;  int flags ;  struct mtk_jpeg_dec_param dec_param ; } cocci_id@p ;
...
position p;
@@
 struct mtk_jpeg_q_data * cocci_id@p ;
...
position p;
@@
 struct mtk_jpeg_dec_param * cocci_id@p ;
...
position p;
@@
 struct mtk_jpeg_dev * cocci_id@p ;
