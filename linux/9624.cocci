...
position p;
@@
 const struct brcms_mcs_info cocci_id@p [ MCS_TABLE_SIZE ] ;
...
position p;
@@
 const struct legacy_phycfg cocci_id@p [ LEGACY_PHYCFG_TABLE_SIZE ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ BRCM_MAXRATE + 1 ] ;
...
typedef u8,u32;
@@
 struct legacy_phycfg {  u32 rate_ofdm ;  u8 tx_phy_ctl3 ; } cocci_id@p ;
