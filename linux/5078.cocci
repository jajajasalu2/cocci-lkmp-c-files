...
position p;
@@
 struct mpc52xx_gpiochip {  struct of_mm_gpio_chip mmchip ;  unsigned int shadow_dvo ;  unsigned int shadow_gpioe ;  unsigned int shadow_ddr ; } cocci_id@p ;
...
position p;
@@
 struct mpc52xx_gpiochip * cocci_id@p ;
