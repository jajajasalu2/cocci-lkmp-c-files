...
position p;
@@
 enum ctrl_register { CTRL_IN , CTRL_OUT , } cocci_id@p ;
...
typedef bool;
@@
 struct wcove_gpio {  struct mutex buslock ;  struct gpio_chip chip ;  struct device * dev ;  struct regmap * regmap ;  struct regmap_irq_chip_data * regmap_irq_chip ;  int update ;  int intcnt ;  bool set_irq_mask ; } cocci_id@p ;
