...
typedef u32;
@@
 struct sunxi_sc_nmi_reg_offs {  u32 ctrl ;  u32 pend ;  u32 enable ; } cocci_id@p ;
...
position p;
@@
 enum { SUNXI_SRC_TYPE_LEVEL_LOW = 0 , SUNXI_SRC_TYPE_EDGE_FALLING , SUNXI_SRC_TYPE_LEVEL_HIGH , SUNXI_SRC_TYPE_EDGE_RISING , } cocci_id@p ;
...
position p;
@@
 const struct sunxi_sc_nmi_reg_offs * cocci_id@p ;
