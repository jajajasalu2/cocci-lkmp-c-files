...
position p;
@@
 struct hamachi_private cocci_id@p ;
...
position p;
@@
 enum capability_flags { CanHaveMII = 1 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,u32,__le64;
@@
 struct hamachi_desc {  __le32 status_n_length ; #if ADDRLEN == 64  u32 pad ;  __le64 addr ; #else  __le32 addr ; #endif } cocci_id@p ;
...
position p;
@@
 enum MII_offsets { MII_Cmd = 0xA6 , MII_Addr = 0xA8 , MII_Wr_Data = 0xAA , MII_Rd_Data = 0xAC , MII_Status = 0xAE , } cocci_id@p ;
...
position p;
@@
 enum desc_status_bits { DescOwn = 0x80000000 , DescEndPacket = 0x40000000 , DescEndRing = 0x20000000 , DescIntr = 0x10000000 , } cocci_id@p ;
...
position p;
@@
 struct hamachi_desc * cocci_id@p ;
...
position p;
@@
 enum intr_status_bits { IntrRxDone = 0x01 , IntrRxPCIFault = 0x02 , IntrRxPCIErr = 0x04 , IntrTxDone = 0x100 , IntrTxPCIFault = 0x200 , IntrTxPCIErr = 0x400 , LinkChange = 0x10000 , NegotiationChange = 0x20000 , StatsMax = 0x40000 , } cocci_id@p ;
