...
position p;
@@
 struct input_devres * cocci_id@p ;
...
position p;
@@
 struct input_absinfo * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct input_handle * , void * ) ;
...
position p;
@@
 const struct input_device_id * cocci_id@p ;
...
position p;
@@
 struct input_handler cocci_id@p ;
...
position p;
@@
 const struct input_dev * cocci_id@p ;
...
position p;
@@
 union input_seq_state * cocci_id@p ;
...
typedef bool;
@@
 union input_seq_state {  struct {  unsigned short pos ;  bool mutex_acquired ; } ;  void * p ; } cocci_id@p ;
...
position p;
@@
 struct input_devres {  struct input_dev * input ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( char * buf , int buf_size , unsigned long * bitmap , int max , int add_cr ) ;
...
position p;
@@
 struct input_handle * cocci_id@p ;
...
position p;
@@
 const struct input_value cocci_id@p ;
