...
position p;
@@
 const struct omap3_dpll5_settings cocci_id@p [ ] ;
...
position p;
@@
 const struct dpll_data * cocci_id@p ;
...
position p;
@@
 const struct clk_hw_omap_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct clk_hw_omap * clk ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct clk_hw_omap * clk ) ;
