...
position p;
@@
 struct wacom_sysfs_group_devres {  struct attribute_group * group ;  struct kobject * root ; } cocci_id@p ;
...
position p;
@@
 struct wacom_sysfs_group_devres * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ WACOM_NAME_MAX - 20 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ WACOM_PKGLEN_MAX ] ;
...
position p;
@@
 struct wacom_remote * cocci_id@p ;
...
position p;
@@
 struct kfifo_rec_ptr_2 * cocci_id@p ;
...
position p;
@@
 struct wacom_hdev_data * cocci_id@p ;
...
position p;
@@
 struct wacom_shared * cocci_id@p ;
...
position p;
@@
 struct wacom_hdev_data {  struct list_head list ;  struct kref kref ;  struct hid_device * dev ;  struct wacom_shared shared ; } cocci_id@p ;
...
position p;
@@
 struct wacom_group_leds * cocci_id@p ;
...
position p;
@@
 struct wacom_features * cocci_id@p ;
...
position p;
@@
 struct wacom_battery * cocci_id@p ;
...
position p;
@@
 struct wacom_remote_data cocci_id@p ;
