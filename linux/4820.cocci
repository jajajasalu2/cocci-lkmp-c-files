...
position p;
@@
 enum cm_msg_response cocci_id@p ;
...
position p;
@@
 enum ib_cm_rej_reason cocci_id@p ;
...
position p;
@@
 struct ib_cm_sidr_req_param * cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ CM_COUNTER_GROUPS ] [ sizeof ( "cm_rx_duplicates" ) ] ;
...
position p;
@@
 void cocci_id@p ( struct ib_device * device , void * client_data ) ;
...
position p;
@@
 struct ib_cm_sidr_rep_event_param * cocci_id@p ;
...
position p;
@@
 struct cm_id_private * cocci_id@p ;
...
@@
 struct cm_counter_group {  struct kobject obj ;  atomic_long_t counter [ CM_ATTR_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct ib_cm_sidr_rep_param cocci_id@p ;
...
position p;
@@
 struct ib_mad_recv_wc * cocci_id@p ;
...
position p;
@@
 struct ib_cm_req_param * cocci_id@p ;
...
typedef __be32;
@@
 struct cm_work {  struct delayed_work work ;  struct list_head list ;  struct cm_port * port ;  struct ib_mad_recv_wc * mad_recv_wc ;  __be32 local_id ;  __be32 remote_id ;  struct ib_cm_event cm_event ;  struct sa_path_rec path [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 enum ib_cm_sidr_status cocci_id@p ;
...
position p;
@@
 enum { CM_REQ_COUNTER , CM_MRA_COUNTER , CM_REJ_COUNTER , CM_REP_COUNTER , CM_RTU_COUNTER , CM_DREQ_COUNTER , CM_DREP_COUNTER , CM_SIDR_REQ_COUNTER , CM_SIDR_REP_COUNTER , CM_LAP_COUNTER , CM_APR_COUNTER , CM_ATTR_COUNT , CM_ATTR_ID_OFFSET = 0x0010 , } cocci_id@p ;
...
position p;
@@
 struct cm_counter_group cocci_id@p ;
...
@@
 struct cm_timewait_info {  struct cm_work work ;  struct list_head list ;  struct rb_node remote_qp_node ;  struct rb_node remote_id_node ;  __be64 remote_ca_guid ;  __be32 remote_qpn ;  u8 inserted_remote_qp ;  u8 inserted_remote_id ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct cm_av {  struct cm_port * port ;  union ib_gid dgid ;  struct rdma_ah_attr ah_attr ;  u16 pkey_index ;  u8 timeout ; } cocci_id@p ;
...
position p;
@@
 const struct cm_id_private * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ib_device * device ) ;
...
symbol cocci_id;
position p;
typedef u64,u32,__be32,rwlock_t,spinlock_t;
@@
 struct ib_cm {  spinlock_t lock ;  struct list_head device_list ;  rwlock_t device_lock ;  struct rb_root listen_service_table ;  u64 listen_service_id ;  struct rb_root remote_qp_table ;  struct rb_root remote_id_table ;  struct rb_root remote_sidr_table ;  struct xarray local_id_table ;  u32 local_id_next ;  __be32 random_id_operand ;  struct list_head timewait_list ;  struct workqueue_struct * wq ;  spinlock_t state_lock ; } cocci_id@p ;
...
position p;
@@
 enum ib_cm_lap_state cocci_id@p ;
...
typedef u8;
@@
 struct cm_port {  struct cm_device * cm_dev ;  struct ib_mad_agent * mad_agent ;  struct kobject port_obj ;  u8 port_num ;  struct list_head cm_priv_prim_list ;  struct list_head cm_priv_altr_list ;  struct cm_counter_group counter_group [ CM_COUNTER_GROUPS ] ; } cocci_id@p ;
...
position p;
@@
 struct cm_sidr_req_msg * cocci_id@p ;
...
position p;
@@
 struct cm_timewait_info cocci_id@p ;
...
position p;
@@
 struct ib_mad_reg_req cocci_id@p ;
...
position p;
@@
 struct ib_cm_req_event_param * cocci_id@p ;
...
position p;
@@
 struct cm_counter_attribute cocci_id@p ;
...
position p;
@@
 struct cm_counter_attribute {  struct attribute attr ;  int index ; } cocci_id@p ;
...
position p;
@@
 enum ib_cm_apr_status cocci_id@p ;
...
position p;
@@
 enum ib_cm_event_type cocci_id@p ;
...
typedef u8;
@@
 struct cm_device {  struct list_head list ;  struct ib_device * ib_device ;  u8 ack_delay ;  int going_down ;  struct cm_port * port [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct ib_cm_lap_event_param * cocci_id@p ;
...
position p;
@@
 struct ib_cm_rep_param * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,__be32,__be64,atomic_t,spinlock_t,refcount_t;
@@
 struct cm_id_private {  struct ib_cm_id id ;  struct rb_node service_node ;  struct rb_node sidr_id_node ;  spinlock_t lock ;  struct completion comp ;  refcount_t refcount ;  int listen_sharecount ;  struct ib_mad_send_buf * msg ;  struct cm_timewait_info * timewait_info ;  struct cm_av av ;  struct cm_av alt_av ;  void * private_data ;  __be64 tid ;  __be32 local_qpn ;  __be32 remote_qpn ;  enum ib_qp_type qp_type ;  __be32 sq_psn ;  __be32 rq_psn ;  int timeout_ms ;  enum ib_mtu path_mtu ;  __be16 pkey ;  u8 private_data_len ;  u8 max_cm_retries ;  u8 peer_to_peer ;  u8 responder_resources ;  u8 initiator_depth ;  u8 retry_count ;  u8 rnr_retry_count ;  u8 service_timeout ;  u8 target_ack_delay ;  struct list_head prim_list ;  struct list_head altr_list ;  int prim_send_port_not_ready ;  int altr_send_port_not_ready ;  struct list_head work_list ;  atomic_t work_count ; } cocci_id@p ;
...
position p;
@@
 struct cm_sidr_rep_msg * cocci_id@p ;
...
position p;
@@
 struct ib_cm_rej_event_param * cocci_id@p ;
...
position p;
@@
 struct ib_mad_send_wc * cocci_id@p ;
...
position p;
@@
 const struct sysfs_ops cocci_id@p ;
...
position p;
@@
 struct ib_cm_sidr_req_event_param * cocci_id@p ;
...
position p;
@@
 enum { CM_XMIT , CM_XMIT_RETRIES , CM_RECV , CM_RECV_DUPLICATES , CM_COUNTER_GROUPS , } cocci_id@p ;
...
position p;
@@
 struct ib_cm_rep_event_param * cocci_id@p ;
