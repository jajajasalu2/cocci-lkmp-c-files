...
position p;
@@
 struct ntc_data {  struct ntc_thermistor_platform_data * pdata ;  const struct ntc_compensation * comp ;  int n_comp ; } cocci_id@p ;
...
position p;
@@
 struct ntc_thermistor_platform_data * cocci_id@p ;
...
position p;
@@
 const struct ntc_compensation cocci_id@p [ ] ;
...
position p;
@@
 struct ntc_compensation {  int temp_c ;  unsigned int ohm ; } cocci_id@p ;
...
position p;
@@
 const struct ntc_type cocci_id@p [ ] ;
...
position p;
@@
 struct ntc_type {  const struct ntc_compensation * comp ;  int n_comp ; } cocci_id@p ;
...
position p;
@@
 enum { NTC_B57330V2103 , NTC_B57891S0103 , NTC_NCP03WB473 , NTC_NCP03WF104 , NTC_NCP15WB473 , NTC_NCP15WL333 , NTC_NCP15XH103 , NTC_NCP18WB473 , NTC_NCP21WB473 , NTC_LAST , } cocci_id@p ;
