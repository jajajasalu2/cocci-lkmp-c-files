...
position p;
@@
 struct pwm_sifive_ddata {  struct pwm_chip chip ;  struct mutex lock ;  struct notifier_block notifier ;  struct clk * clk ;  void __iomem * regs ;  unsigned int real_period ;  unsigned int approx_period ;  int user_count ; } cocci_id@p ;
...
position p;
@@
 struct pwm_sifive_ddata cocci_id@p ;
