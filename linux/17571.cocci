...
position p;
@@
 struct vmemmap_backing * cocci_id@p ;
...
position p;
@@
 const struct flag_info * cocci_id@p ;
...
typedef u64;
@@
 struct pg_state {  struct seq_file * seq ;  const struct addr_marker * marker ;  unsigned long start_address ;  unsigned int level ;  u64 current_flags ; } cocci_id@p ;
...
position p;
@@
 struct addr_marker {  unsigned long start_address ;  const char * name ; } cocci_id@p ;
...
typedef u64,bool;
@@
 struct flag_info {  u64 mask ;  u64 val ;  const char * set ;  const char * clear ;  bool is_val ;  int shift ; } cocci_id@p ;
