...
position p;
@@
 struct mxc_nand_platform_data * cocci_id@p ;
...
position p;
@@
 struct mxc_nand_host cocci_id@p ;
...
position p;
@@
 struct mxc_nand_devtype_data * cocci_id@p ;
...
position p;
@@
 const struct mxc_nand_devtype_data cocci_id@p ;
