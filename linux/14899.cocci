...
position p;
@@
 struct stm32_pll_obj * cocci_id@p ;
...
position p;
@@
 enum { M_SDMMC12 , M_SDMMC3 , M_FMC , M_QSPI , M_RNG1 , M_RNG2 , M_USBPHY , M_USBO , M_STGEN , M_SPDIF , M_SPI1 , M_SPI23 , M_SPI45 , M_SPI6 , M_CEC , M_I2C12 , M_I2C35 , M_I2C46 , M_LPTIM1 , M_LPTIM23 , M_LPTIM45 , M_USART1 , M_UART24 , M_UART35 , M_USART6 , M_UART78 , M_SAI1 , M_SAI2 , M_SAI3 , M_SAI4 , M_DSI , M_FDCAN , M_ADC12 , M_ETHCK , M_CKPER , M_LAST , } cocci_id@p ;
...
position p;
@@
 struct stm32_composite_cfg {  const struct stm32_gate_cfg * gate ;  const struct stm32_div_cfg * div ;  const struct stm32_mux_cfg * mux ; } cocci_id@p ;
...
position p;
@@
 struct stm32_gate_cfg {  struct gate_cfg * gate ;  struct stm32_mgate * mgate ;  const struct clk_ops * ops ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct stm32_mgate {  u8 nbr_clk ;  u32 flag ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_mux_cfg * cocci_id@p ;
...
position p;
@@
 const struct clk_ops cocci_id@p ;
...
typedef u8;
@@
 struct stm32_mmux {  u8 nbr_clk ;  struct clk_hw * hws [ MAX_MUX_CLK ] ; } cocci_id@p ;
...
position p;
@@
 const struct clock_config * cocci_id@p ;
...
position p;
@@
 struct stm32_div_cfg {  struct div_cfg * div ;  const struct clk_ops * ops ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_mux_cfg cocci_id@p [ M_LAST ] ;
...
typedef u8,u32;
@@
 struct div_cfg {  u32 reg_off ;  u8 shift ;  u8 width ;  u8 div_flags ;  const struct clk_div_table * table ; } cocci_id@p ;
...
position p;
@@
 struct clk_hw_onecell_data * cocci_id@p ;
...
position p;
@@
 struct stm32_clk_mmux {  struct clk_mux mux ;  struct stm32_mmux * mmux ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_composite_cfg * cocci_id@p ;
...
position p;
@@
 struct stm32_gate_cfg * cocci_id@p ;
...
position p;
@@
 const struct stm32_gate_cfg * cocci_id@p ;
...
position p;
@@
 struct stm32_clk_mmux cocci_id@p ;
...
typedef spinlock_t;
@@
 struct stm32_pll_obj {  spinlock_t * lock ;  void __iomem * reg ;  struct clk_hw hw ; } cocci_id@p ;
...
position p;
@@
 struct fixed_factor_cfg {  unsigned int mult ;  unsigned int div ; } cocci_id@p ;
...
position p;
@@
 struct stm32_mux_cfg {  struct mux_cfg * mux ;  struct stm32_mmux * mmux ;  const struct clk_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct stm32_clock_match_data {  const struct clock_config * cfg ;  unsigned int num ;  unsigned int maxbinding ; } cocci_id@p ;
...
position p;
@@
 struct stm32_cktim_cfg cocci_id@p ;
...
position p;
@@
 struct stm32_mgate cocci_id@p [ G_LAST ] ;
...
position p;
@@
 const struct stm32_div_cfg * cocci_id@p ;
...
position p;
@@
 struct clk_init_data cocci_id@p ;
...
position p;
@@
 struct stm32_gate_cfg cocci_id@p [ G_LAST ] ;
...
position p;
@@
 struct stm32_pll_cfg * cocci_id@p ;
...
position p;
@@
 struct fixed_factor_cfg cocci_id@p ;
...
position p;
@@
 struct stm32_clock_match_data cocci_id@p ;
...
typedef spinlock_t;
@@
 struct timer_cker {  spinlock_t * lock ;  void __iomem * apbdiv ;  void __iomem * timpre ;  struct clk_hw hw ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct mux_cfg {  u32 reg_off ;  u8 shift ;  u8 width ;  u8 mux_flags ;  u32 * table ; } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_cktim_cfg {  u32 offset_apbdiv ;  u32 offset_timpre ; } cocci_id@p ;
...
position p;
@@
 struct stm32_clk_mgate cocci_id@p ;
...
position p;
@@
 const struct stm32_clock_match_data * cocci_id@p ;
...
typedef u32;
@@
 struct stm32_clk_mgate {  struct clk_gate gate ;  struct stm32_mgate * mgate ;  u32 mask ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct gate_cfg {  u32 reg_off ;  u8 bit_idx ;  u8 gate_flags ; } cocci_id@p ;
...
position p;
@@
 struct stm32_mmux cocci_id@p [ M_LAST ] ;
...
typedef u32;
@@
 struct stm32_pll_cfg {  u32 offset ; } cocci_id@p ;
...
position p;
@@
 struct stm32_composite_cfg cocci_id@p ;
...
position p;
@@
 const struct clk_div_table cocci_id@p [ ] ;
