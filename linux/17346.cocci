...
typedef u64;
@@
 struct mcheck_recoverable_range {  u64 start_addr ;  u64 end_addr ;  u64 recover_addr ; } cocci_id@p ;
...
typedef u64;
@@
 struct opal {  u64 base ;  u64 entry ;  u64 size ; } cocci_id@p ;
...
position p;
@@
 struct opal_msg_node * cocci_id@p ;
...
position p;
@@
 struct opal_msg_node {  struct list_head list ;  struct opal_msg msg ; } cocci_id@p ;
...
position p;
@@
 struct mcheck_recoverable_range cocci_id@p ;
...
position p;
@@
 struct machine_check_event cocci_id@p ;
...
position p;
@@
 struct opal_sg_entry cocci_id@p ;
...
position p;
@@
 struct atomic_notifier_head cocci_id@p [ OPAL_MSG_TYPE_MAX ] ;
