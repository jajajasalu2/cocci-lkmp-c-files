...
position p;
@@
 struct mlx5dr_icm_bucket * cocci_id@p ;
...
position p;
@@
 enum mlx5_sw_icm_type cocci_id@p ;
...
@@
 struct mlx5dr_icm_dm {  u32 obj_id ;  enum mlx5_sw_icm_type type ;  phys_addr_t addr ;  size_t length ; } cocci_id@p ;
...
typedef u32;
@@
 struct mlx5dr_icm_bucket {  struct mlx5dr_icm_pool * pool ;  struct list_head free_list ;  unsigned int free_list_count ;  struct list_head used_list ;  unsigned int used_list_count ;  struct list_head hot_list ;  unsigned int hot_list_count ;  struct list_head sync_list ;  unsigned int sync_list_count ;  u32 total_chunks ;  u32 num_of_entries ;  u32 entry_size ;  struct mutex mutex ; } cocci_id@p ;
...
typedef u64;
@@
 struct mlx5dr_icm_mr {  struct mlx5dr_icm_pool * pool ;  struct mlx5_core_mkey mkey ;  struct mlx5dr_icm_dm dm ;  size_t used_length ;  size_t length ;  u64 icm_start_addr ;  struct list_head mr_list ; } cocci_id@p ;
...
position p;
@@
 struct mlx5dr_icm_dm * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_icm_pool {  struct mlx5dr_icm_bucket * buckets ;  enum mlx5dr_icm_type icm_type ;  enum mlx5dr_icm_chunk_size max_log_chunk_sz ;  enum mlx5dr_icm_chunk_size num_of_buckets ;  struct list_head icm_mr_list ;  struct mutex mr_mutex ;  struct mlx5dr_domain * dmn ; } cocci_id@p ;
...
position p;
@@
 struct mlx5dr_icm_pool * cocci_id@p ;
...
position p;
@@
 enum mlx5dr_icm_chunk_size cocci_id@p ;
...
position p;
@@
 enum mlx5dr_icm_type cocci_id@p ;
...
position p;
@@
 struct mlx5dr_icm_mr * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ DR_CHUNK_SIZE_MAX ] ;
