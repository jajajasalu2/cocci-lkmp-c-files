...
@@
 struct usb_pcwd_private {  struct usb_device * udev ;  struct usb_interface * interface ;  unsigned int interface_number ;  unsigned char * intr_buffer ;  dma_addr_t intr_dma ;  size_t intr_size ;  struct urb * intr_urb ;  unsigned char cmd_command ;  unsigned char cmd_data_msb ;  unsigned char cmd_data_lsb ;  atomic_t cmd_received ;  int exists ;  struct mutex mtx ; } cocci_id@p ;
...
position p;
@@
 struct usb_pcwd_private cocci_id@p ;
