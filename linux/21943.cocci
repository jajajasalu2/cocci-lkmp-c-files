...
typedef u64,u8;
@@
 struct sw842_hlist_node8 {  struct hlist_node node ;  u64 data ;  u8 index ; } cocci_id@p ;
...
typedef u64,u8;
@@
 int cocci_id@p ( struct sw842_param * p , u64 d , u8 n ) ;
...
typedef u32,u16;
@@
 struct sw842_hlist_node4 {  struct hlist_node node ;  u32 data ;  u16 index ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct sw842_hlist_node2 {  struct hlist_node node ;  u16 data ;  u8 index ; } cocci_id@p ;
