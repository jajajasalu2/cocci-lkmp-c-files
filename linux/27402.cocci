...
position p;
@@
 void cocci_id@p ( struct adfs_dir * dir ) ;
...
position p;
@@
 struct adfs_direntry * cocci_id@p ;
...
position p;
@@
 const struct adfs_dir_ops cocci_id@p ;
...
position p;
@@
 struct buffer_head * const * cocci_id@p ;
...
typedef u8;
@@
 union {  __le32 * ptr32 ;  u8 * ptr8 ; } cocci_id@p ;
...
position p;
@@
 const struct adfs_dir * cocci_id@p ;
