...
position p;
@@
 enum kempld_cells { KEMPLD_I2C = 0 , KEMPLD_WDT , KEMPLD_GPIO , KEMPLD_UART , } cocci_id@p ;
...
position p;
@@
 const struct kempld_platform_data * cocci_id@p ;
...
position p;
@@
 struct mfd_cell cocci_id@p [ KEMPLD_MAX_DEVS ] ;
