...
position p;
@@
 union pptp_ctrl_union cocci_id@p ;
...
position p;
@@
 struct PptpStartSessionReply cocci_id@p ;
...
position p;
@@
 struct PptpStartSessionRequest cocci_id@p ;
...
position p;
@@
 struct PptpWanErrorNotify cocci_id@p ;
...
position p;
@@
 struct nf_ct_pptp_master * cocci_id@p ;
...
position p;
@@
 struct PptpControlHeader * cocci_id@p ;
...
position p;
@@
 typeof ( nf_nat_pptp_hook_exp_gre ) cocci_id@p ;
...
position p;
@@
 typeof ( nf_nat_pptp_hook_inbound ) cocci_id@p ;
...
position p;
@@
 const struct pptp_pkt_hdr * cocci_id@p ;
...
position p;
@@
 struct PptpStopSessionRequest cocci_id@p ;
...
position p;
@@
 const struct nf_ct_pptp_master * cocci_id@p ;
...
position p;
@@
 struct PptpInCallConnected cocci_id@p ;
...
position p;
@@
 struct PptpCallDisconnectNotify cocci_id@p ;
...
position p;
@@
 typeof ( nf_nat_pptp_hook_expectfn ) cocci_id@p ;
...
position p;
@@
 struct PptpOutCallReply cocci_id@p ;
...
position p;
@@
 struct PptpInCallRequest cocci_id@p ;
...
position p;
@@
 struct PptpSetLinkInfo cocci_id@p ;
...
position p;
@@
 typeof ( nf_nat_pptp_hook_outbound ) cocci_id@p ;
...
position p;
@@
 struct PptpOutCallRequest cocci_id@p ;
...
position p;
@@
 struct PptpClearCallRequest cocci_id@p ;
...
position p;
@@
 struct PptpStopSessionReply cocci_id@p ;
...
position p;
@@
 struct PptpInCallReply cocci_id@p ;
...
position p;
@@
 struct pptp_pkt_hdr cocci_id@p ;
