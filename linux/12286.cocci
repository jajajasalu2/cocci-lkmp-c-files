...
position p;
@@
 const s6e8aa0_gamma_table cocci_id@p [ GAMMA_LEVEL_NUM ] ;
...
typedef u8,bool,u32;
@@
 struct s6e8aa0 {  struct device * dev ;  struct drm_panel panel ;  struct regulator_bulk_data supplies [ 2 ] ;  struct gpio_desc * reset_gpio ;  u32 power_on_delay ;  u32 reset_delay ;  u32 init_delay ;  bool flip_horizontal ;  bool flip_vertical ;  struct videomode vm ;  u32 width_mm ;  u32 height_mm ;  u8 version ;  u8 id ;  const struct s6e8aa0_variant * variant ;  int brightness ;  int error ; } cocci_id@p ;
...
typedef u8;
@@
 struct s6e8aa0_variant {  u8 version ;  const s6e8aa0_gamma_table * gamma_tables ; } cocci_id@p ;
...
position p;
@@
 const struct s6e8aa0_variant cocci_id@p [ ] ;
