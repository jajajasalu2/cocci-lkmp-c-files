...
position p;
@@
 struct sprd_dma_desc * cocci_id@p ;
...
position p;
@@
 enum sprd_dma_datawidth cocci_id@p ;
...
position p;
@@
 enum sprd_dma_chn_mode cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct virt_dma_desc * vd ) ;
...
typedef u32;
@@
 struct sprd_dma_dev {  struct dma_device dma_dev ;  void __iomem * glb_base ;  struct clk * clk ;  struct clk * ashb_clk ;  int irq ;  u32 total_chns ;  struct sprd_dma_chn channels [ 0 ] ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct dma_chan * chan , void * param ) ;
...
position p;
@@
 struct sprd_dma_chn * cocci_id@p ;
...
position p;
@@
 struct sprd_dma_linklist * cocci_id@p ;
...
typedef u32;
@@
 struct sprd_dma_chn_hw {  u32 pause ;  u32 req ;  u32 cfg ;  u32 intc ;  u32 src_addr ;  u32 des_addr ;  u32 frg_len ;  u32 blk_len ;  u32 trsc_len ;  u32 trsf_step ;  u32 wrap_ptr ;  u32 wrap_to ;  u32 llist_ptr ;  u32 frg_step ;  u32 src_blk_step ;  u32 des_blk_step ; } cocci_id@p ;
...
position p;
@@
 enum sprd_dma_req_mode cocci_id@p ;
...
position p;
@@
 enum sprd_dma_datawidth { SPRD_DMA_DATAWIDTH_1_BYTE , SPRD_DMA_DATAWIDTH_2_BYTES , SPRD_DMA_DATAWIDTH_4_BYTES , SPRD_DMA_DATAWIDTH_8_BYTES , } cocci_id@p ;
...
typedef u32;
@@
 struct sprd_dma_chn {  struct virt_dma_chan vc ;  void __iomem * chn_base ;  struct sprd_dma_linklist linklist ;  struct dma_slave_config slave_cfg ;  u32 chn_num ;  u32 dev_id ;  enum sprd_dma_chn_mode chn_mode ;  enum sprd_dma_trg_mode trg_mode ;  enum sprd_dma_int_type int_type ;  struct sprd_dma_desc * cur_desc ; } cocci_id@p ;
...
position p;
@@
 struct sprd_dma_desc {  struct virt_dma_desc vd ;  struct sprd_dma_chn_hw chn_hw ;  enum dma_transfer_direction dir ; } cocci_id@p ;
...
position p;
@@
 struct of_dma_filter_info cocci_id@p ;
...
position p;
@@
 enum sprd_dma_int_type cocci_id@p ;
...
position p;
@@
 struct sprd_dma_dev * cocci_id@p ;
...
position p;
@@
 struct sprd_dma_chn_hw * cocci_id@p ;
