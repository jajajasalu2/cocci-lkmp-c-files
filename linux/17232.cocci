...
position p;
@@
 const struct pmc_type * cocci_id@p ;
...
typedef __be32;
@@
 struct mpc83xx_syscr {  __be32 sgprl ;  __be32 sgprh ;  __be32 spridr ;  __be32 : 32 ;  __be32 spcr ;  __be32 sicrl ;  __be32 sicrh ; } cocci_id@p ;
...
typedef u32;
@@
 struct mpc83xx_rcw {  u32 rcwlr ;  u32 rcwhr ; } cocci_id@p ;
...
typedef u32;
@@
 struct mpc83xx_saved {  u32 sicrl ;  u32 sicrh ;  u32 sccr ; } cocci_id@p ;
...
position p;
@@
 struct pmc_type {  int has_deep_sleep ; } cocci_id@p ;
...
typedef u32;
@@
 struct mpc83xx_clock {  u32 spmr ;  u32 occr ;  u32 sccr ; } cocci_id@p ;
...
position p;
@@
 struct mpc83xx_saved cocci_id@p ;
...
typedef phys_addr_t;
@@
 void cocci_id@p ( phys_addr_t immrbase ) ;
