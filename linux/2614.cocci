...
typedef u32;
@@
 struct sunxi_sid {  void __iomem * base ;  u32 value_offset ; } cocci_id@p ;
...
position p;
@@
 const struct sunxi_sid_cfg * cocci_id@p ;
...
position p;
@@
 const struct sunxi_sid * cocci_id@p ;
...
typedef bool,u32;
@@
 struct sunxi_sid_cfg {  u32 value_offset ;  u32 size ;  bool need_register_readout ; } cocci_id@p ;
