...
position p;
@@
 struct inno_dsidphy * cocci_id@p ;
...
position p;
@@
 struct mipi_dphy_timing * cocci_id@p ;
...
position p;
@@
 enum { REGISTER_PART_ANALOG , REGISTER_PART_DIGITAL , REGISTER_PART_CLOCK_LANE , REGISTER_PART_DATA0_LANE , REGISTER_PART_DATA1_LANE , REGISTER_PART_DATA2_LANE , REGISTER_PART_DATA3_LANE , REGISTER_PART_LVDS , } cocci_id@p ;
...
typedef u8;
@@
 const struct {  unsigned long rate ;  u8 hs_prepare ;  u8 clk_lane_hs_zero ;  u8 data_lane_hs_zero ;  u8 hs_trail ; } cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct inno_dsidphy {  struct device * dev ;  struct clk * ref_clk ;  struct clk * pclk_phy ;  struct clk * pclk_host ;  void __iomem * phy_base ;  void __iomem * host_base ;  struct reset_control * rst ;  enum phy_mode mode ;  struct {  struct clk_hw hw ;  u8 prediv ;  u16 fbdiv ;  unsigned long rate ; } pll ; } cocci_id@p ;
