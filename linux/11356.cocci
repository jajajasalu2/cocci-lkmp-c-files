...
position p;
@@
 struct cdns_dsi_output * cocci_id@p ;
...
position p;
@@
 struct cdns_dsi_cfg {  unsigned int hfp ;  unsigned int hsa ;  unsigned int hbp ;  unsigned int hact ;  unsigned int htotal ; } cocci_id@p ;
...
position p;
@@
 struct cdns_dsi_cfg * cocci_id@p ;
...
position p;
@@
 enum cdns_dsi_input_id { CDNS_SDI_INPUT , CDNS_DPI_INPUT , CDNS_DSC_INPUT , } cocci_id@p ;
...
position p;
@@
 struct cdns_dsi_input * cocci_id@p ;
...
typedef bool;
@@
 struct cdns_dsi {  struct mipi_dsi_host base ;  void __iomem * regs ;  struct cdns_dsi_input input ;  struct cdns_dsi_output output ;  unsigned int direct_cmd_fifo_depth ;  unsigned int rx_fifo_depth ;  struct completion direct_cmd_comp ;  struct clk * dsi_p_clk ;  struct reset_control * dsi_p_rst ;  struct clk * dsi_sys_clk ;  bool link_initialized ;  struct phy * dphy ; } cocci_id@p ;
...
position p;
@@
 struct cdns_dsi_input {  enum cdns_dsi_input_id id ;  struct drm_bridge bridge ; } cocci_id@p ;
...
position p;
@@
 struct cdns_dsi_output {  struct mipi_dsi_device * dev ;  struct drm_panel * panel ;  struct drm_bridge * bridge ;  union phy_configure_opts phy_opts ; } cocci_id@p ;
