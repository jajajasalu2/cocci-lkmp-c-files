...
position p;
@@
 struct signature {  const char * signature ;  int offset ;  int length ;  int this_id ;  int base_offset ; } cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p [ MAXBOARDS_PARAM ] ;
