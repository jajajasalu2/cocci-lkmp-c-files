...
position p;
@@
 unsigned char cocci_id@p [ sizeof ( struct ip_options ) + 40 ] ;
...
position p;
@@
 struct cipso_v4_map_cache_entry * cocci_id@p ;
...
position p;
@@
 const struct cipso_v4_doi * cocci_id@p ;
...
position p;
@@
 struct cipso_v4_doi * cocci_id@p ;
...
position p;
@@
 struct cipso_v4_map_cache_bkt * cocci_id@p ;
...
position p;
@@
 struct cipso_v4_std_map_tbl * cocci_id@p ;
...
typedef u32;
@@
 struct cipso_v4_map_cache_entry {  u32 hash ;  unsigned char * key ;  size_t key_len ;  struct netlbl_lsm_cache * lsm_data ;  u32 activity ;  struct list_head list ; } cocci_id@p ;
...
@@
 struct cipso_v4_map_cache_bkt {  spinlock_t lock ;  u32 size ;  struct list_head list ; } cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ CIPSO_V4_TAG_RNG_CAT_MAX * 2 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct cipso_v4_doi * doi_def , void * arg ) ;
...
position p;
@@
 unsigned char cocci_id@p [ CIPSO_V4_OPT_LEN_MAX ] ;
