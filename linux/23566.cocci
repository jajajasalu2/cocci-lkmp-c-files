...
position p;
@@
 struct skl_module_pin_fmt * cocci_id@p ;
...
position p;
@@
 struct skl_kpb_params * cocci_id@p ;
...
position p;
@@
 struct skl_module_pin_resources * cocci_id@p ;
...
position p;
@@
 struct skl_module_cfg * cocci_id@p ;
...
position p;
@@
 struct skl_module_iface * cocci_id@p ;
...
position p;
@@
 struct skl_pipe_params * cocci_id@p ;
...
position p;
@@
 struct skl_specific_cfg * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ ] [ SKL_CH_QUATRO ] ;
...
position p;
@@
 struct skl_module_res * cocci_id@p ;
...
position p;
@@
 struct skl_module_deferred_bind * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ ] [ SKL_CH_TRIO ] ;
...
position p;
@@
 struct skl_dfw_v4_pipe * cocci_id@p ;
...
position p;
@@
 struct skl_dfw_v4_module_pin * cocci_id@p ;
...
position p;
@@
 struct skl_astate_param * cocci_id@p ;
...
position p;
@@
 struct skl_module_pin * cocci_id@p ;
...
position p;
@@
 struct skl_path_config * cocci_id@p ;
...
position p;
@@
 struct skl_mic_sel_config * cocci_id@p ;
...
position p;
@@
 struct skl_pipe_fmt * cocci_id@p ;
...
position p;
@@
 struct skl_pipeline * cocci_id@p ;
...
position p;
@@
 struct skl_dfw_v4_module_fmt * cocci_id@p ;
...
position p;
@@
 struct skl_d0i3_data * cocci_id@p ;
...
position p;
@@
 struct skl_mod_inst_map * cocci_id@p ;
...
position p;
@@
 struct skl_algo_data * cocci_id@p ;
...
position p;
@@
 enum d0i3_capability cocci_id@p ;
...
position p;
@@
 struct skl_pipe_module * cocci_id@p ;
...
position p;
@@
 struct skl_dfw_v4_module * cocci_id@p ;
...
position p;
@@
 struct snd_soc_dapm_path * cocci_id@p ;
...
position p;
@@
 struct skl_module_fmt * cocci_id@p ;
...
position p;
@@
 struct skl_dfw_algo_data * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ ] [ SKL_CH_STEREO ] ;
...
position p;
@@
 struct nhlt_specific_cfg * cocci_id@p ;
