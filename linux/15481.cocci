...
position p;
@@
 struct port100_in_rf_setting cocci_id@p ;
...
position p;
@@
 struct port100_ack_frame * cocci_id@p ;
...
position p;
@@
 struct port100_tg_comm_rf_cmd cocci_id@p ;
...
position p;
@@
 struct port100_tg_rf_setting cocci_id@p ;
...
position p;
@@
 struct port100_tg_comm_rf_res cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nfc_digital_cmd_complete_t;
@@
 nfc_digital_cmd_complete_t cocci_id@p ;
...
position p;
@@
 struct port100_protocol cocci_id@p [ ] [ PORT100_TG_MAX_NUM_PROTOCOLS + 1 ] ;
...
position p;
@@
 struct port100_frame * cocci_id@p ;
...
position p;
@@
 struct nfc_digital_ops cocci_id@p ;
...
position p;
@@
 struct port100_sync_cmd_response {  struct sk_buff * resp ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 const struct port100_tg_rf_setting cocci_id@p [ ] ;
...
position p;
@@
 struct digital_tg_mdaa_params * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef port100_send_async_complete_t;
@@
 port100_send_async_complete_t cocci_id@p ;
...
typedef u8,bool;
@@
 struct port100 {  struct nfc_digital_dev * nfc_digital_dev ;  int skb_headroom ;  int skb_tailroom ;  struct usb_device * udev ;  struct usb_interface * interface ;  struct urb * out_urb ;  struct urb * in_urb ;  struct mutex out_urb_lock ;  struct work_struct cmd_complete_work ;  u8 cmd_type ;  struct port100_cmd * cmd ;  bool cmd_cancel ;  struct completion cmd_cancel_done ; } cocci_id@p ;
...
position p;
@@
 struct port100_protocol cocci_id@p [ ] [ PORT100_IN_MAX_NUM_PROTOCOLS + 1 ] ;
...
position p;
@@
 struct nfc_digital_dev * cocci_id@p ;
...
position p;
@@
 struct port100_sync_cmd_response cocci_id@p ;
...
position p;
@@
 struct port100_protocol cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ PORT100_FRAME_ACK_SIZE ] ;
...
position p;
@@
 const struct port100_in_rf_setting cocci_id@p [ ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct port100 * dev , void * arg , struct sk_buff * resp ) ;
...
position p;
@@
 struct port100_cb_arg cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,nfc_digital_cmd_complete_t;
@@
 struct port100_cb_arg {  nfc_digital_cmd_complete_t complete_cb ;  void * complete_arg ;  u8 mdaa ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,port100_send_async_complete_t;
@@
 struct port100_cmd {  u8 code ;  int status ;  struct sk_buff * req ;  struct sk_buff * resp ;  int resp_len ;  port100_send_async_complete_t complete_cb ;  void * complete_cb_context ; } cocci_id@p ;
