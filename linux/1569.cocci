...
position p;
@@
 struct mct_u232_private * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct mct_u232_private {  struct urb * read_urb ;  spinlock_t lock ;  unsigned int control_state ;  unsigned char last_lcr ;  unsigned char last_lsr ;  unsigned char last_msr ;  unsigned int rx_flags ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_serial_port * remove ) ;
