...
position p;
@@
 struct s3inforec cocci_id@p [ S3INFO_MAX ] ;
...
position p;
@@
 struct s3crcrec cocci_id@p [ S3CRC_MAX ] ;
...
typedef u32;
@@
 struct s3plugrec {  u32 itemcode ;  u32 addr ;  u32 len ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct imgchunk {  u32 addr ;  u32 len ;  u16 crc ;  u8 * data ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct imgchunk * clist , unsigned int * ccnt ) ;
...
typedef u16;
@@
 struct s3inforec {  u16 len ;  u16 type ;  union {  struct hfa384x_compident version ;  struct hfa384x_caplevel compat ;  u16 buildseq ;  struct hfa384x_compident platform ; } info ; } cocci_id@p ;
...
typedef u32;
@@
 struct s3crcrec {  u32 addr ;  u32 len ;  unsigned int dowrite ; } cocci_id@p ;
...
typedef u8;
@@
 struct pda {  u8 buf [ HFA384x_PDA_LEN_MAX ] ;  struct hfa384x_pdrec * rec [ HFA384x_PDA_RECS_MAX ] ;  unsigned int nrec ; } cocci_id@p ;
...
position p;
@@
 struct hfa384x_pdrec * cocci_id@p ;
...
position p;
@@
 struct hfa384x_compident cocci_id@p ;
...
typedef u8,u32;
@@
 struct s3datarec {  u32 len ;  u32 addr ;  u8 checksum ;  u8 * data ; } cocci_id@p ;
...
position p;
@@
 struct hfa384x_caplevel cocci_id@p ;
...
position p;
@@
 struct p80211msg_p2req_ramdl_write * cocci_id@p ;
...
position p;
@@
 struct p80211msg_dot11req_mibget cocci_id@p ;
...
position p;
@@
 struct s3plugrec cocci_id@p [ S3PLUG_MAX ] ;
...
position p;
@@
 struct imgchunk cocci_id@p [ CHUNKS_MAX ] ;
...
position p;
@@
 struct p80211msg_p2req_ramdl_state * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pda * pda , struct wlandevice * wlandev ) ;
...
position p;
@@
 struct p80211msg_p2req_readpda * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct ihex_binrec * rfptr , struct wlandevice * wlandev ) ;
...
position p;
@@
 int cocci_id@p ( const struct ihex_binrec * rfptr ) ;
...
position p;
@@
 void cocci_id@p ( struct imgchunk * fchunk , unsigned int * nfchunks ) ;
...
position p;
@@
 int cocci_id@p ( struct wlandevice * wlandev , struct imgchunk * fchunk , unsigned int nfchunks ) ;
...
position p;
@@
 int cocci_id@p ( struct imgchunk * fchunk , unsigned int nfchunks , struct s3crcrec * s3crc , unsigned int ns3crc ) ;
...
position p;
@@
 int cocci_id@p ( struct imgchunk * fchunk , unsigned int nfchunks , struct s3plugrec * s3plug , unsigned int ns3plug , struct pda * pda ) ;
