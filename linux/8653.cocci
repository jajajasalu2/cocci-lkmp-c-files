...
position p;
@@
 struct i40e_ring_container * cocci_id@p ;
...
position p;
@@
 struct i40e_tx_context_desc * cocci_id@p ;
...
position p;
@@
 struct i40e_rx_buffer cocci_id@p ;
...
position p;
@@
 union i40e_32byte_rx_desc cocci_id@p ;
...
position p;
@@
 struct i40e_filter_program_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xdp_frame * xdpf , struct i40e_ring * xdp_ring ) ;
