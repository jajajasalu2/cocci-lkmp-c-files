...
position p;
@@
 unsigned long ( * cocci_id@p ) ( struct kvm_vcpu * vcpu , unsigned long server ) ;
...
position p;
@@
 unsigned long ( * cocci_id@p ) ( struct kvm_vcpu * vcpu ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct kvm_vcpu * vcpu , unsigned long xirr ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct kvm_vcpu * vcpu , unsigned long server , unsigned long mfrr ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct kvm_vcpu * vcpu , unsigned long cppr ) ;
