...
position p;
@@
 struct plx_pci_card {  int channels ;  struct net_device * net_dev [ PLX_PCI_MAX_CHAN ] ;  void __iomem * conf_addr ;  void ( * reset_func ) ( struct pci_dev * pdev ) ; } cocci_id@p ;
...
typedef u32;
@@
 struct plx_pci_channel_map {  u32 bar ;  u32 offset ;  u32 size ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct plx_pci_card_info {  const char * name ;  int channel_count ;  u32 can_clock ;  u8 ocr ;  u8 cdr ;  struct plx_pci_channel_map conf_map ;  struct plx_pci_channel_map chan_map_tbl [ PLX_PCI_MAX_CHAN ] ;  void ( * reset_func ) ( struct pci_dev * pdev ) ; } cocci_id@p ;
...
position p;
@@
 struct plx_pci_card_info * cocci_id@p ;
...
position p;
@@
 struct plx_pci_card * cocci_id@p ;
...
position p;
@@
 struct plx_pci_channel_map * cocci_id@p ;
