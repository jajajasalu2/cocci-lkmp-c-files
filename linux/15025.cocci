...
position p;
@@
 struct clk_factor_table cocci_id@p [ ] ;
...
position p;
@@
 struct clk_pll_table cocci_id@p [ ] ;
...
position p;
@@
 struct owl_clk_desc cocci_id@p ;
...
position p;
@@
 const struct owl_reset_map cocci_id@p [ ] ;
