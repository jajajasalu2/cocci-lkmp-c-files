...
position p;
@@
 struct ziirave_wdt_rev * cocci_id@p ;
...
position p;
@@
 struct ziirave_wdt_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ZIIRAVE_FIRM_PKT_DATA_SIZE ] ;
...
position p;
@@
 struct ziirave_wdt_rev {  unsigned char major ;  unsigned char minor ; } cocci_id@p ;
...
position p;
@@
 struct ziirave_wdt_data {  struct mutex sysfs_mutex ;  struct watchdog_device wdd ;  struct ziirave_wdt_rev bootloader_rev ;  struct ziirave_wdt_rev firmware_rev ;  int reset_reason ; } cocci_id@p ;
