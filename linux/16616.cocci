...
position p;
@@
 const struct zfcp_port * const cocci_id@p ;
...
position p;
@@
 const struct zfcp_scsi_dev * cocci_id@p ;
...
position p;
@@
 struct fsf_statistics_info * cocci_id@p ;
...
position p;
@@
 struct zfcp_port * const cocci_id@p ;
...
position p;
@@
 struct zfcp_diag_header * cocci_id@p ;
...
position p;
@@
 struct zfcp_adapter * const cocci_id@p ;
