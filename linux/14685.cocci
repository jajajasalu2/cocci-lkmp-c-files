...
position p;
@@
 const struct exynos_audss_clk_drvdata cocci_id@p ;
...
position p;
@@
 struct exynos_audss_clk_drvdata {  unsigned int has_adma_clk : 1 ;  unsigned int has_mst_clk : 1 ;  unsigned int enable_epll : 1 ;  unsigned int num_clks ; } cocci_id@p ;
