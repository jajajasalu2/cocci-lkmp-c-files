...
position p;
@@
 struct rps_dev_flow_table * cocci_id@p ;
...
position p;
@@
 struct rps_dev_flow cocci_id@p ;
...
position p;
@@
 const struct netdev_queue_attribute * cocci_id@p ;
...
position p;
@@
 const struct rx_queue_attribute * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net_device * , unsigned long ) ;
...
position p;
@@
 struct xps_dev_maps * cocci_id@p ;
...
position p;
@@
 struct netdev_queue_attribute cocci_id@p ;
...
position p;
@@
 ssize_t ( * cocci_id@p ) ( const struct net_device * , char * ) ;
