...
position p;
@@
 const struct plt_entry cocci_id@p ;
...
position p;
@@
 enum reloc_value_formula cocci_id@p ;
...
position p;
@@
 enum reloc_target_format { RF_NONE = 0 , RF_INSN14 = 1 , RF_INSN22 = 2 , RF_INSN64 = 3 , RF_32MSB = 4 , RF_32LSB = 5 , RF_64MSB = 6 , RF_64LSB = 7 , RF_INSN60 , RF_INSN21B , RF_INSN21M , RF_INSN21F , } cocci_id@p ;
...
position p;
@@
 enum reloc_target_format cocci_id@p ;
...
position p;
@@
 struct plt_entry {  unsigned char bundle [ 3 ] [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 struct plt_entry {  unsigned char bundle [ 2 ] [ 16 ] ; } cocci_id@p ;
