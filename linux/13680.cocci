...
position p;
@@
 struct smsdvb_debugfs cocci_id@p ;
...
@@
 struct smsdvb_debugfs {  struct kref refcount ;  spinlock_t lock ;  char stats_data [ PAGE_SIZE ] ;  unsigned stats_count ;  bool stats_was_read ;  wait_queue_head_t stats_queue ; } cocci_id@p ;
