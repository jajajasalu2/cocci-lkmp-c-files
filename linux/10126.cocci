...
position p;
@@
 void cocci_id@p ( struct port * port , int lacp_fast ) ;
...
position p;
@@
 void cocci_id@p ( struct bond_marker * marker , struct port * port ) ;
...
symbol cocci_id;
position p;
typedef mux_states_t;
@@
 mux_states_t cocci_id@p ;
...
position p;
@@
 struct lacpdu_header * cocci_id@p ;
...
position p;
@@
 const struct bonding * cocci_id@p ;
...
position p;
@@
 struct bond_marker_header * cocci_id@p ;
...
position p;
@@
 enum ad_link_speed_type { AD_LINK_SPEED_1MBPS = 1 , AD_LINK_SPEED_10MBPS , AD_LINK_SPEED_100MBPS , AD_LINK_SPEED_1000MBPS , AD_LINK_SPEED_2500MBPS , AD_LINK_SPEED_5000MBPS , AD_LINK_SPEED_10000MBPS , AD_LINK_SPEED_14000MBPS , AD_LINK_SPEED_20000MBPS , AD_LINK_SPEED_25000MBPS , AD_LINK_SPEED_40000MBPS , AD_LINK_SPEED_50000MBPS , AD_LINK_SPEED_56000MBPS , AD_LINK_SPEED_100000MBPS , } cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct aggregator * aggregator , bool * update_slave_arr ) ;
...
position p;
@@
 const struct lacpdu cocci_id@p ;
...
symbol cocci_id;
position p;
typedef periodic_states_t;
@@
 periodic_states_t cocci_id@p ;
...
position p;
@@
 struct bond_3ad_stats * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct port * port ) ;
...
position p;
@@
 void cocci_id@p ( struct bond_marker * marker_info , struct port * port ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct port * port , bool reset ) ;
...
position p;
@@
 const struct port_params cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lacpdu * lacpdu , struct port * port ) ;
...
position p;
@@
 int cocci_id@p ( struct port * port ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct port * port , bool * update_slave_arr ) ;
...
position p;
@@
 const struct aggregator * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct aggregator * aggregator ) ;
...
position p;
@@
 int cocci_id@p ( struct port * port , struct bond_marker * marker ) ;
