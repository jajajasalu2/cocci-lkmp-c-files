...
position p;
@@
 struct exynos_drm_plane_state * cocci_id@p ;
...
position p;
@@
 const struct exynos_drm_crtc_ops cocci_id@p ;
...
position p;
@@
 struct exynos_drm_plane * cocci_id@p ;
...
position p;
@@
 struct fimd_driver_data cocci_id@p ;
...
position p;
@@
 struct fimd_context cocci_id@p ;
...
position p;
@@
 const enum drm_plane_type cocci_id@p [ WINDOWS_NR ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ WINDOWS_NR ] ;
...
position p;
@@
 struct fimd_driver_data {  unsigned int timing_base ;  unsigned int lcdblk_offset ;  unsigned int lcdblk_vt_shift ;  unsigned int lcdblk_bypass_shift ;  unsigned int lcdblk_mic_bypass_shift ;  unsigned int trg_type ;  unsigned int has_shadowcon : 1 ;  unsigned int has_clksel : 1 ;  unsigned int has_limited_fmt : 1 ;  unsigned int has_vidoutcon : 1 ;  unsigned int has_vtsel : 1 ;  unsigned int has_mic_bypass : 1 ;  unsigned int has_dp_clk : 1 ;  unsigned int has_hw_trigger : 1 ;  unsigned int has_trigger_per_te : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct fimd_driver_data * cocci_id@p ;
