...
position p;
@@
 struct wilco_ec_property_msg cocci_id@p ;
...
position p;
@@
 enum ec_property_op { EC_OP_GET = 0 , EC_OP_SET = 1 , } cocci_id@p ;
...
position p;
@@
 struct ec_property_response * cocci_id@p ;
...
position p;
@@
 struct ec_property_request cocci_id@p ;
