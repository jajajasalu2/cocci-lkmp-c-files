...
position p;
@@
 struct hns_roce_wqe_raddr_seg * cocci_id@p ;
...
position p;
@@
 struct hns_roce_raq_table * cocci_id@p ;
...
position p;
@@
 struct hns_roce_cq_context * cocci_id@p ;
...
position p;
@@
 struct hns_roce_sq_db cocci_id@p ;
...
position p;
@@
 struct hns_roce_wqe_data_seg * cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ HNS_ROCE_QP_NUM_STATE ] [ HNS_ROCE_QP_NUM_STATE ] ;
...
position p;
@@
 struct hns_roce_v1_priv * cocci_id@p ;
...
position p;
@@
 struct hns_roce_qp_context * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HNS_ROCE_V1_RESV_QP ] ;
...
position p;
@@
 struct hns_roce_wqe_ctrl_seg * cocci_id@p ;
...
position p;
@@
 struct ib_wc cocci_id@p [ HNS_ROCE_V1_RESV_QP ] ;
...
position p;
@@
 struct fwnode_reference_args cocci_id@p ;
...
position p;
@@
 struct hns_roce_sqp_context cocci_id@p ;
...
position p;
@@
 struct hns_roce_rq_db cocci_id@p ;
...
position p;
@@
 struct hns_roce_free_mr * cocci_id@p ;
...
position p;
@@
 struct hns_roce_mr_free_work * cocci_id@p ;
...
position p;
@@
 struct hns_roce_ud_send_wqe * cocci_id@p ;
...
position p;
@@
 struct hns_roce_recreate_lp_qp_work cocci_id@p ;
...
position p;
@@
 enum hns_roce_qp_state cocci_id@p ;
...
position p;
@@
 struct hns_roce_db_table * cocci_id@p ;
...
position p;
@@
 struct hns_roce_cqe * cocci_id@p ;
...
position p;
@@
 struct hns_roce_v1_mpt_entry * cocci_id@p ;
...
position p;
@@
 struct hns_roce_mtt * cocci_id@p ;
...
position p;
@@
 struct hns_roce_rq_wqe_ctrl * cocci_id@p ;
