...
position p;
@@
 int cocci_id@p [ SPE_PMU_CAP_FEAT_MAX ] ;
...
position p;
@@
 struct arm_spe_pmu_buf * cocci_id@p ;
...
position p;
@@
 enum arm_spe_pmu_buf_fault_action cocci_id@p ;
...
typedef bool;
@@
 struct arm_spe_pmu_buf {  int nr_pages ;  bool snapshot ;  void * base ; } cocci_id@p ;
...
position p;
@@
 enum arm_spe_pmu_buf_fault_action { SPE_PMU_BUF_FAULT_ACT_SPURIOUS , SPE_PMU_BUF_FAULT_ACT_FATAL , SPE_PMU_BUF_FAULT_ACT_OK , } cocci_id@p ;
...
position p;
@@
 enum arm_spe_pmu_capabilities { SPE_PMU_CAP_ARCH_INST = 0 , SPE_PMU_CAP_ERND , SPE_PMU_CAP_FEAT_MAX , SPE_PMU_CAP_CNT_SZ = SPE_PMU_CAP_FEAT_MAX , SPE_PMU_CAP_MIN_IVAL , } cocci_id@p ;
...
position p;
@@
 typeof ( * spe_pmu -> handle ) cocci_id@p ;
