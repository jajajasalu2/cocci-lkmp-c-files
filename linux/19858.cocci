...
position p;
@@
 struct nlm_pic_irq {  void ( * extra_ack ) ( struct irq_data * ) ;  struct nlm_soc_info * node ;  int picirq ;  int irt ;  int flags ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct irq_data * ) ;
