...
symbol cocci_id;
position p;
typedef alr_loop_cb_t;
@@
 alr_loop_cb_t * cocci_id@p ;
...
position p;
@@
 struct lan9303_mib_desc {  unsigned int offset ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct del_port_learned_ctx {  int port ; } cocci_id@p ;
...
typedef dsa_fdb_dump_cb_t;
@@
 struct port_fdb_dump_ctx {  int port ;  void * data ;  dsa_fdb_dump_cb_t * cb ; } cocci_id@p ;
...
position p;
@@
 const struct lan9303_mib_desc cocci_id@p [ ] ;
...
position p;
@@
 struct lan9303_alr_cache_entry * cocci_id@p ;
...
position p;
@@
 struct del_port_learned_ctx * cocci_id@p ;
...
position p;
@@
 const struct lan9303_phy_ops cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct lan9303 * chip , u32 dat0 , u32 dat1 , int portmap , void * ctx ) ;
...
position p;
@@
 struct port_fdb_dump_ctx * cocci_id@p ;
