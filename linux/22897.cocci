...
position p;
@@
 struct snd_motu_packet_format * cocci_id@p ;
...
position p;
@@
 const struct {  unsigned int quotient_ticks_per_event ;  unsigned int remainder_ticks_per_event ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct snd_motu_protocol * const cocci_id@p ;
