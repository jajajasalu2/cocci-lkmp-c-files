...
position p;
@@
 struct nfp_rtsym_table {  struct nfp_cpp * cpp ;  int num ;  char * strtab ;  struct nfp_rtsym symtab [ ] ; } cocci_id@p ;
...
position p;
@@
 struct nfp_rtsym_entry * cocci_id@p ;
...
position p;
@@
 const struct nfp_mip * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct nfp_rtsym_entry {  u8 type ;  u8 target ;  u8 island ;  u8 addr_hi ;  __le32 addr_lo ;  __le16 name ;  u8 menum ;  u8 size_hi ;  __le32 size_lo ; } cocci_id@p ;
