...
position p;
@@
 const enum omap_control_phy_type cocci_id@p ;
...
position p;
@@
 struct omap_control_phy * cocci_id@p ;
...
position p;
@@
 enum omap_control_usb_mode cocci_id@p ;
...
position p;
@@
 enum omap_control_phy_type * cocci_id@p ;
