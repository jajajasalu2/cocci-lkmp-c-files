...
position p;
@@
 struct pp_states_info cocci_id@p ;
...
position p;
@@
 struct smu_performance_level cocci_id@p ;
...
position p;
@@
 enum smu_feature_mask cocci_id@p ;
...
position p;
@@
 struct smu_clock_info cocci_id@p ;
...
position p;
@@
 enum smu_perf_level_designation cocci_id@p ;
...
position p;
@@
 enum amd_pm_state_type cocci_id@p ;
...
position p;
@@
 const struct amd_pp_display_configuration * cocci_id@p ;
...
position p;
@@
 enum smu_message_type cocci_id@p ;
...
typedef uint32_t;
@@
 uint32_t cocci_id@p [ SMU_FEATURE_MAX / 32 ] ;
...
position p;
@@
 enum smu_baco_state * cocci_id@p ;
...
position p;
@@
 struct amd_pp_clock_info * cocci_id@p ;
...
typedef uint32_t;
@@
 uint32_t cocci_id@p [ SMU_FEATURE_COUNT ] ;
