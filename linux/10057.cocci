...
position p;
@@
 const struct nla_policy cocci_id@p [ NUM_MACSEC_SA_ATTR ] ;
...
position p;
@@
 struct macsec_rx_sa * cocci_id@p ;
...
position p;
@@
 const struct pcpu_rx_sc_stats * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,u16,sci_t;
@@
 struct macsec_secy {  struct net_device * netdev ;  unsigned int n_rx_sc ;  sci_t sci ;  u16 key_len ;  u16 icv_len ;  enum macsec_validation_type validate_frames ;  bool operational ;  bool protect_frames ;  bool replay_protect ;  u32 replay_window ;  struct macsec_tx_sc tx_sc ;  struct macsec_rx_sc __rcu * rx_sc ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct macsec_tx_sc {  bool active ;  u8 encoding_sa ;  bool encrypt ;  bool send_sci ;  bool end_station ;  bool scb ;  struct macsec_tx_sa __rcu * sa [ MACSEC_NUM_AN ] ;  struct pcpu_tx_sc_stats __percpu * stats ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rx_handler_result_t;
@@
 rx_handler_result_t cocci_id@p ;
...
position p;
@@
 struct macsec_tx_sa cocci_id@p ;
...
position p;
@@
 const struct pcpu_tx_sc_stats * cocci_id@p ;
...
position p;
@@
 struct aead_request * cocci_id@p ;
...
position p;
@@
 struct pcpu_rx_sc_stats * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,spinlock_t,refcount_t;
@@
 struct macsec_tx_sa {  struct macsec_key key ;  spinlock_t lock ;  u32 next_pn ;  refcount_t refcnt ;  bool active ;  struct macsec_tx_sa_stats __percpu * stats ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct macsec_rxh_data * cocci_id@p ;
...
position p;
@@
 struct macsec_dev_stats cocci_id@p ;
...
position p;
@@
 struct rtnl_link_ops cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ MACSEC_SA_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct macsec_tx_sa_stats * cocci_id@p ;
...
position p;
@@
 const struct macsec_secy * cocci_id@p ;
...
typedef __u64;
@@
 struct macsec_dev_stats {  __u64 OutPktsUntagged ;  __u64 InPktsUntagged ;  __u64 OutPktsTooLong ;  __u64 InPktsNoTag ;  __u64 InPktsBadTag ;  __u64 InPktsUnknownSCI ;  __u64 InPktsNoSCI ;  __u64 InPktsOverrun ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NUM_MACSEC_RXSC_ATTR ] ;
...
symbol cocci_id;
position p;
typedef bool,refcount_t,sci_t;
@@
 struct macsec_rx_sc {  struct macsec_rx_sc __rcu * next ;  sci_t sci ;  bool active ;  struct macsec_rx_sa __rcu * sa [ MACSEC_NUM_AN ] ;  struct pcpu_rx_sc_stats __percpu * stats ;  refcount_t refcnt ;  struct rcu_head rcu_head ; } cocci_id@p ;
...
position p;
@@
 struct pcpu_rx_sc_stats {  struct macsec_rx_sc_stats stats ;  struct u64_stats_sync syncp ; } cocci_id@p ;
...
typedef __u64;
@@
 struct macsec_tx_sc_stats {  __u64 OutPktsProtected ;  __u64 OutPktsEncrypted ;  __u64 OutOctetsProtected ;  __u64 OutOctetsEncrypted ; } cocci_id@p ;
...
position p;
@@
 struct pcpu_sw_netstats cocci_id@p ;
...
typedef u8,bool;
@@
 struct macsec_cb {  struct aead_request * req ;  union {  struct macsec_tx_sa * tx_sa ;  struct macsec_rx_sa * rx_sa ; } ;  u8 assoc_num ;  bool valid ;  bool has_sci ; } cocci_id@p ;
...
position p;
@@
 struct macsec_tx_sc_stats cocci_id@p ;
...
position p;
@@
 struct macsec_rx_sc * * cocci_id@p ;
...
position p;
@@
 const struct macsec_rx_sa_stats * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_MACSEC_MAX + 1 ] ;
...
position p;
@@
 char cocci_id@p [ DEFAULT_SAK_LEN ] ;
...
position p;
@@
 struct pcpu_secy_stats * cocci_id@p ;
...
typedef __u64;
@@
 struct macsec_rx_sc_stats {  __u64 InOctetsValidated ;  __u64 InOctetsDecrypted ;  __u64 InPktsUnchecked ;  __u64 InPktsDelayed ;  __u64 InPktsOK ;  __u64 InPktsInvalid ;  __u64 InPktsLate ;  __u64 InPktsNotValid ;  __u64 InPktsNotUsingSA ;  __u64 InPktsUnusedSA ; } cocci_id@p ;
...
position p;
@@
 struct pcpu_secy_stats {  struct macsec_dev_stats stats ;  struct u64_stats_sync syncp ; } cocci_id@p ;
...
typedef bool,u32,spinlock_t,refcount_t;
@@
 struct macsec_rx_sa {  struct macsec_key key ;  spinlock_t lock ;  u32 next_pn ;  refcount_t refcnt ;  bool active ;  struct macsec_rx_sa_stats __percpu * stats ;  struct macsec_rx_sc * sc ;  struct rcu_head rcu ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,__be32,sci_t;
@@
 struct gcm_iv {  union {  u8 secure_channel_id [ 8 ] ;  sci_t sci ; } ;  __be32 pn ; } cocci_id@p ;
...
position p;
@@
 struct macsec_dev {  struct macsec_secy secy ;  struct net_device * real_dev ;  struct pcpu_secy_stats __percpu * stats ;  struct list_head secys ;  struct gro_cells gro_cells ; } cocci_id@p ;
...
typedef __u32;
@@
 struct macsec_rx_sa_stats {  __u32 InPktsOK ;  __u32 InPktsInvalid ;  __u32 InPktsNotValid ;  __u32 InPktsNotUsingSA ;  __u32 InPktsUnusedSA ; } cocci_id@p ;
...
position p;
@@
 struct macsec_rx_sc_stats cocci_id@p ;
...
position p;
@@
 struct crypto_async_request * cocci_id@p ;
...
position p;
@@
 struct macsec_eth_header * cocci_id@p ;
...
position p;
@@
 const struct macsec_tx_sc * cocci_id@p ;
...
typedef u8;
@@
 struct macsec_key {  u8 id [ MACSEC_KEYID_LEN ] ;  struct crypto_aead * tfm ; } cocci_id@p ;
...
typedef __u32;
@@
 struct macsec_tx_sa_stats {  __u32 OutPktsProtected ;  __u32 OutPktsEncrypted ; } cocci_id@p ;
...
position p;
@@
 struct macsec_rxh_data {  struct list_head secys ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rx_handler_func_t;
@@
 rx_handler_func_t * cocci_id@p ;
...
position p;
@@
 struct pcpu_tx_sc_stats {  struct macsec_tx_sc_stats stats ;  struct u64_stats_sync syncp ; } cocci_id@p ;
...
position p;
@@
 const struct pcpu_secy_stats * cocci_id@p ;
...
position p;
@@
 struct macsec_rx_sa_stats cocci_id@p ;
...
position p;
@@
 struct pcpu_tx_sc_stats * cocci_id@p ;
...
position p;
@@
 struct macsec_tx_sc * * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ MACSEC_RXSC_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct macsec_tx_sa_stats cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NUM_MACSEC_ATTR ] ;
