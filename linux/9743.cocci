...
position p;
@@
 struct iwl_tof_responder_config_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_tof_responder_dyn_config_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_ftm_responder_stats * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IWL_LCI_CIVIC_IE_MAX_SIZE ] ;
