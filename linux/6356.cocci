...
position p;
@@
 struct sy8824_config {  unsigned int vol_reg ;  unsigned int mode_reg ;  unsigned int enable_reg ;  unsigned int vsel_min ;  unsigned int vsel_step ;  unsigned int vsel_count ; } cocci_id@p ;
...
position p;
@@
 const struct sy8824_config * cocci_id@p ;
...
position p;
@@
 struct sy8824_device_info * cocci_id@p ;
...
position p;
@@
 struct sy8824_device_info {  struct device * dev ;  struct regulator_desc desc ;  struct regulator_init_data * regulator ;  const struct sy8824_config * cfg ; } cocci_id@p ;
