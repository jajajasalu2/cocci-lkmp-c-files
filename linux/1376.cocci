...
position p;
@@
 struct typec_capability cocci_id@p ;
...
position p;
@@
 const struct typec_operations cocci_id@p ;
...
position p;
@@
 enum { TPS_PORTINFO_SINK , TPS_PORTINFO_SINK_ACCESSORY , TPS_PORTINFO_DRP_UFP , TPS_PORTINFO_DRP_UFP_DRD , TPS_PORTINFO_DRP_DFP , TPS_PORTINFO_DRP_DFP_DRD , TPS_PORTINFO_SOURCE , } cocci_id@p ;
...
position p;
@@
 enum { TPS_MODE_APP , TPS_MODE_BOOT , TPS_MODE_BIST , TPS_MODE_DISC , } cocci_id@p ;
...
position p;
@@
 struct tps6598x_rx_identity_reg cocci_id@p ;
...
typedef u8;
@@
 struct tps6598x {  struct device * dev ;  struct regmap * regmap ;  struct mutex lock ;  u8 i2c_protocol : 1 ;  struct typec_port * port ;  struct typec_partner * partner ;  struct usb_pd_identity partner_identity ; } cocci_id@p ;
