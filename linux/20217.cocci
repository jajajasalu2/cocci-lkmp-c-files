...
position p;
@@
 struct sigframe {  struct sigcontext sc ;  unsigned int retcode [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct rt_sigframe {  struct siginfo info ;  struct ucontext uc ;  unsigned int retcode [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ offsetof ( struct rt_sigframe , uc . uc_mcontext ) == 176 ? 1 : - 1 ] ;
...
position p;
@@
 const struct osf_sigaction * cocci_id@p ;
...
position p;
@@
 struct osf_sigaction * cocci_id@p ;
