...
@@
 struct vfio_pci_nvgpu_data {  unsigned long gpu_hpa ;  unsigned long gpu_tgt ;  unsigned long useraddr ;  unsigned long size ;  struct mm_struct * mm ;  struct mm_iommu_table_group_mem_t * mem ;  struct pci_dev * gpdev ;  struct notifier_block group_notifier ; } cocci_id@p ;
...
position p;
@@
 struct vfio_pci_npu2_data * cocci_id@p ;
...
position p;
@@
 struct vfio_pci_nvgpu_data * cocci_id@p ;
...
position p;
@@
 struct vfio_region_info_cap_nvlink2_lnkspd cocci_id@p ;
...
position p;
@@
 struct vfio_region_info_cap_nvlink2_ssatgt cocci_id@p ;
...
position p;
@@
 struct vfio_pci_npu2_data {  void * base ;  unsigned long mmio_atsd ;  unsigned long gpu_tgt ;  unsigned int link_speed ; } cocci_id@p ;
