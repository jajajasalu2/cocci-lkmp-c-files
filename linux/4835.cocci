...
position p;
@@
 struct bundle_alloc_head * cocci_id@p ;
...
position p;
@@
 struct uverbs_objs_arr_attr * cocci_id@p ;
...
position p;
@@
 const struct ib_uverbs_attr * cocci_id@p ;
...
typedef u8;
@@
 struct bundle_alloc_head {  struct bundle_alloc_head * next ;  u8 data [ ] ; } cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_ioctl_hdr cocci_id@p ;
...
position p;
@@
 struct uverbs_api_ioctl_method * cocci_id@p ;
...
position p;
@@
 const struct uverbs_attr * cocci_id@p ;
...
position p;
@@
 const struct uverbs_api_ioctl_method * cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_attr * cocci_id@p ;
...
position p;
@@
 struct uverbs_obj_attr * cocci_id@p ;
...
position p;
@@
 const struct uverbs_api_attr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct uverbs_attr_bundle * attrs ) ;
