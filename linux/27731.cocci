...
typedef u8,bool,u32;
@@
 int cocci_id@p ( struct gfs2_rbm * rbm , u8 state , u32 * minext , const struct gfs2_inode * ip , bool nowrap ) ;
...
position p;
@@
 const struct gfs2_blkreserv * cocci_id@p ;
...
position p;
@@
 struct gfs2_blkreserv * cocci_id@p ;
...
position p;
@@
 const struct gfs2_sbd * cocci_id@p ;
...
position p;
@@
 const struct gfs2_rbm * cocci_id@p ;
...
position p;
@@
 struct gfs2_lkstats * cocci_id@p ;
...
position p;
@@
 const struct gfs2_rgrpd * cocci_id@p ;
...
position p;
@@
 struct gfs2_rgrp_list * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( struct gfs2_rindex ) ] ;
...
position p;
@@
 const struct gfs2_bitmap * cocci_id@p ;
...
position p;
@@
 const struct gfs2_alloc_parms * cocci_id@p ;
...
typedef u32;
@@
 struct gfs2_extent {  struct gfs2_rbm rbm ;  u32 len ; } cocci_id@p ;
...
position p;
@@
 const struct gfs2_glock * cocci_id@p ;
...
position p;
@@
 const struct gfs2_rgrp * cocci_id@p ;
...
position p;
@@
 struct gfs2_rgrp_lvb * cocci_id@p ;
...
position p;
@@
 struct gfs2_alloc_parms * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( sdp -> sd_fsname ) + 7 ] ;
...
position p;
@@
 const struct gfs2_inode * cocci_id@p ;
