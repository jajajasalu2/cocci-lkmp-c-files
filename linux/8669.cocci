...
typedef u8,s32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , u8 data ) ;
...
symbol cocci_id;
position p;
typedef s32,bool,u32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , u32 * i2cctl , bool data ) ;
...
position p;
@@
 enum ixgbe_sfp_type cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct ixgbe_hw * hw , u32 * i2cctl ) ;
...
typedef s32,bool;
@@
 s32 cocci_id@p ( struct ixgbe_hw * hw , bool data ) ;
...
position p;
@@
 enum ixgbe_phy_type cocci_id@p ;
...
typedef u32;
@@
 enum ixgbe_phy_type cocci_id@p ( u32 phy_id ) ;
...
typedef bool,u32;
@@
 bool cocci_id@p ( struct ixgbe_hw * hw , u32 * i2cctl ) ;
