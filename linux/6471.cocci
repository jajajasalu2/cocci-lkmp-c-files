...
position p;
@@
 struct tps6586x_regulator cocci_id@p [ ] ;
...
position p;
@@
 struct tps6586x_settings * cocci_id@p ;
...
position p;
@@
 struct tps6586x_regulator {  struct regulator_desc desc ;  int enable_bit [ 2 ] ;  int enable_reg [ 2 ] ; } cocci_id@p ;
