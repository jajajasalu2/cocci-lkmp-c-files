...
position p;
@@
 void cocci_id@p ( struct clk_hw * hw ) ;
...
position p;
@@
 int cocci_id@p ( struct clk_hw * hw ) ;
...
position p;
@@
 struct clk_pll {  struct clk_hw hw ;  unsigned short regofs ; } cocci_id@p ;
...
position p;
@@
 struct clk_std {  struct clk_hw hw ;  signed char enable_bit ; } cocci_id@p ;
...
position p;
@@
 struct clk_dmn {  struct clk_hw hw ;  signed char enable_bit ;  unsigned short regofs ; } cocci_id@p ;
