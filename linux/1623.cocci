...
position p;
@@
 const struct usbmisc_ops cocci_id@p ;
...
typedef spinlock_t;
@@
 struct imx_usbmisc {  void __iomem * base ;  spinlock_t lock ;  const struct usbmisc_ops * ops ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct imx_usbmisc_data * data ) ;
