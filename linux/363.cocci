...
position p;
@@
 struct bpf_prog_array * * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bpf_jit_fill_hole_t;
@@
 bpf_jit_fill_hole_t cocci_id@p ;
...
position p;
@@
 struct bpf_prog_stats * cocci_id@p ;
...
position p;
@@
 struct bpf_prog_dummy {  struct bpf_prog prog ; } cocci_id@p ;
...
position p;
@@
 const struct bpf_prog_aux * cocci_id@p ;
...
position p;
@@
 enum bpf_cgroup_storage_type cocci_id@p ;
...
position p;
@@
 struct bpf_prog_array_item cocci_id@p ;
...
position p;
@@
 const struct bpf_binary_header * cocci_id@p ;
...
position p;
@@
 enum bpf_text_poke_type cocci_id@p ;
...
position p;
@@
 struct bpf_binary_header * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ SHA_DIGEST_WORDS ] ;
...
position p;
@@
 struct {  struct bpf_prog_array hdr ;  struct bpf_prog * null_prog ; } cocci_id@p ;
...
position p;
@@
 struct latch_tree_root cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ SHA_WORKSPACE_WORDS ] ;
...
symbol cocci_id;
position p;
typedef bpf_ctx_copy_t;
@@
 bpf_ctx_copy_t cocci_id@p ;
