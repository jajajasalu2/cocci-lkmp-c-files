...
position p;
@@
 struct ipi_data_struct {  unsigned long bits ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum ipi_message_type { IPI_EMPTY , IPI_RESCHEDULE , IPI_CALL_FUNC , IPI_MAX , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( const struct cpumask * mask ) ;
