...
position p;
@@
 struct iwl_trans_pcie_removal {  struct pci_dev * pdev ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct iwl_trans_pcie_removal * cocci_id@p ;
...
position p;
@@
 const struct iwl_trans_config * cocci_id@p ;
...
position p;
@@
 struct iwl_causes_list cocci_id@p [ ] ;
...
position p;
@@
 struct iwl_fw_error_dump_fw_mon cocci_id@p ;
...
position p;
@@
 struct isr_statistics * cocci_id@p ;
...
position p;
@@
 const struct iwl_cfg_trans_params * cocci_id@p ;
...
position p;
@@
 const struct iwl_fw_dbg_dest_tlv_v1 * cocci_id@p ;
...
position p;
@@
 struct iwl_tso_hdr_page cocci_id@p ;
...
position p;
@@
 struct iwl_rx_mem_buffer * cocci_id@p ;
...
position p;
@@
 const struct fw_desc * cocci_id@p ;
...
position p;
@@
 struct iwl_trans_rxq_dma_data * cocci_id@p ;
...
position p;
@@
 struct iwl_trans_dump_data * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_error_dump_rb cocci_id@p ;
...
typedef u8,u32;
@@
 struct iwl_causes_list {  u32 cause_num ;  u32 mask_reg ;  u8 addr ; } cocci_id@p ;
...
position p;
@@
 struct iwl_trans_pcie cocci_id@p ;
...
position p;
@@
 const struct iwl_dram_data * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_error_dump_txcmd * cocci_id@p ;
...
position p;
@@
 const struct iwl_trans_ops cocci_id@p ;
