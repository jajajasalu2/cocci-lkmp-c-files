...
position p;
@@
 struct wm8940_setup_data * cocci_id@p ;
...
position p;
@@
 struct wm8940_priv {  unsigned int sysclk ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct pll_ {  unsigned int pre_scale : 2 ;  unsigned int n : 4 ;  unsigned int k ; } cocci_id@p ;
