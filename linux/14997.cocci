...
typedef u8;
@@
 struct max9485_clk {  const char * name ;  int parent_index ;  const struct clk_ops ops ;  u8 enable_bit ; } cocci_id@p ;
...
position p;
@@
 struct max9485_driver_data cocci_id@p ;
...
typedef u8;
@@
 struct max9485_driver_data {  struct clk * xclk ;  struct i2c_client * client ;  u8 reg_value ;  struct regulator * supply ;  struct gpio_desc * reset_gpio ;  struct max9485_clk_hw hw [ MAX9485_NUM_CLKS ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct max9485_clk_hw {  struct clk_hw hw ;  struct clk_init_data init ;  u8 enable_bit ;  struct max9485_driver_data * drvdata ; } cocci_id@p ;
...
position p;
@@
 struct max9485_clk_hw * cocci_id@p ;
...
position p;
@@
 const struct max9485_rate * cocci_id@p ;
...
typedef u8;
@@
 struct max9485_rate {  unsigned long out ;  u8 reg_value ; } cocci_id@p ;
...
position p;
@@
 const struct max9485_clk cocci_id@p [ MAX9485_NUM_CLKS ] ;
