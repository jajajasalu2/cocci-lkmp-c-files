...
position p;
@@
 void cocci_id@p ( struct amdgpu_device * adev , int crtc , enum amdgpu_interrupt_state state ) ;
...
position p;
@@
 int cocci_id@p ( struct amdgpu_device * adev , int index ) ;
...
position p;
@@
 const struct mode_size {  int w ;  int h ; } cocci_id@p [ 17 ] ;
