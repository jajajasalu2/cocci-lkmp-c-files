...
position p;
@@
 struct rtnl_link_ifmap cocci_id@p ;
...
position p;
@@
 struct ifla_vf_spoofchk cocci_id@p ;
...
position p;
@@
 struct ifla_vf_guid * cocci_id@p ;
...
position p;
@@
 struct ifla_vf_broadcast cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IFLA_INFO_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IFLA_MAX + 1 ] ;
...
position p;
@@
 struct ifla_vf_vlan_info cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ RTNL_SLAVE_MAX_TYPE + 1 ] ;
...
position p;
@@
 struct ifla_vf_link_state * cocci_id@p ;
...
position p;
@@
 struct ifla_vf_rate * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_PORT_MAX + 1 ] ;
...
position p;
@@
 struct ifla_vf_vlan * cocci_id@p ;
...
position p;
@@
 struct ifla_vf_tx_rate cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IFLA_PORT_MAX + 1 ] ;
...
position p;
@@
 struct ifla_vf_rss_query_en * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_MAX + 1 ] ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct sk_buff * skb , struct net_device * dev , u32 filter_mask ) ;
...
position p;
@@
 struct rtnl_link_stats cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ NDA_MAX + 1 ] ;
...
position p;
@@
 struct netdev_name_node * cocci_id@p ;
...
position p;
@@
 const struct ifinfomsg * cocci_id@p ;
...
position p;
@@
 struct rtnl_link {  rtnl_doit_func doit ;  rtnl_dumpit_func dumpit ;  struct module * owner ;  unsigned int flags ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IFLA_XDP_MAX + 1 ] ;
...
position p;
@@
 const struct rtnl_link_ops * cocci_id@p ;
...
position p;
@@
 struct ifla_port_vsi cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ TCP_CA_NAME_MAX ] ;
...
position p;
@@
 struct if_stats_msg * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_INFO_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_VF_MAX + 1 ] ;
...
position p;
@@
 struct ifla_vf_vlan_info * cocci_id@p [ MAX_VLAN_LIST_LEN ] ;
...
position p;
@@
 const struct rtnl_link_stats64 * cocci_id@p ;
...
typedef u32;
@@
 u32 ( * cocci_id@p ) ( struct net_device * dev ) ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IFLA_VF_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_XDP_MAX + 1 ] ;
...
position p;
@@
 struct ifla_vf_trust cocci_id@p ;
...
position p;
@@
 const struct rtnl_af_ops * cocci_id@p ;
