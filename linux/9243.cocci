...
position p;
@@
 struct mpc52xx_fec_priv cocci_id@p ;
...
typedef spinlock_t;
@@
 struct mpc52xx_fec_priv {  struct net_device * ndev ;  int duplex ;  int speed ;  int r_irq ;  int t_irq ;  struct mpc52xx_fec __iomem * fec ;  struct bcom_task * rx_dmatsk ;  struct bcom_task * tx_dmatsk ;  spinlock_t lock ;  int msg_enable ;  unsigned int mdio_speed ;  struct device_node * phy_node ;  enum phy_state link ;  int seven_wire_mode ; } cocci_id@p ;
