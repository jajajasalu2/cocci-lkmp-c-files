...
position p;
@@
 const struct virtual_engine * cocci_id@p ;
...
position p;
@@
 struct intel_engine_execlists * cocci_id@p ;
...
position p;
@@
 struct intel_engine_cs * * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef intel_engine_mask_t;
@@
 struct virtual_engine {  struct intel_engine_cs base ;  struct intel_context context ;  struct i915_request * request ;  struct ve_node {  struct rb_node rb ;  int prio ; } nodes [ I915_NUM_ENGINES ] ;  struct ve_bond {  const struct intel_engine_cs * master ;  intel_engine_mask_t sibling_mask ; } * bonds ;  unsigned int num_bonds ;  unsigned int num_siblings ;  struct intel_engine_cs * siblings [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct i915_sched_node * cocci_id@p ;
...
position p;
@@
 const struct intel_engine_execlists * cocci_id@p ;
...
position p;
@@
 const struct intel_engine_cs * const cocci_id@p ;
...
position p;
@@
 struct intel_context * const cocci_id@p ;
...
position p;
@@
 struct i915_ctx_workarounds * cocci_id@p ;
...
position p;
@@
 struct virtual_engine * const cocci_id@p ;
...
position p;
@@
 struct intel_engine_cs * const cocci_id@p ;
...
position p;
@@
 struct i915_gem_context * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef wa_bb_func_t;
@@
 wa_bb_func_t cocci_id@p [ 2 ] ;
...
position p;
@@
 struct virtual_engine * cocci_id@p ;
...
position p;
@@
 struct i915_priolist * cocci_id@p ;
...
typedef intel_engine_mask_t;
@@
 intel_engine_mask_t cocci_id@p ;
...
typedef bool,u32;
@@
 void cocci_id@p ( u32 * reg_state , const struct intel_context * ce , const struct intel_engine_cs * engine , const struct intel_ring * ring , bool close ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct drm_printer * m , struct i915_request * rq , const char * prefix ) ;
...
position p;
@@
 const struct intel_ring * cocci_id@p ;
...
position p;
@@
 const struct i915_request * cocci_id@p ;
...
position p;
@@
 struct i915_request * const * cocci_id@p ;
...
position p;
@@
 const struct timer_list * cocci_id@p ;
...
position p;
@@
 struct intel_engine_execlists * const cocci_id@p ;
...
position p;
@@
 const struct intel_context_ops cocci_id@p ;
...
position p;
@@
 const struct intel_engine_cs * cocci_id@p ;
...
position p;
@@
 struct i915_dependency * cocci_id@p ;
...
position p;
@@
 struct intel_timeline * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,i915_reg_t;
@@
 struct lri {  i915_reg_t reg ;  u32 value ; } cocci_id@p ;
...
position p;
@@
 const struct intel_timeline * const cocci_id@p ;
...
position p;
@@
 struct ve_node * const cocci_id@p ;
...
position p;
@@
 const struct intel_context * cocci_id@p ;
...
position p;
@@
 const struct i915_ppgtt * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct intel_context * ce , struct intel_engine_cs * engine ) ;
...
typedef u32;
@@
 u32 * ( * cocci_id@p ) ( struct intel_engine_cs * engine , u32 * batch ) ;
...
position p;
@@
 const struct i915_ctx_workarounds * const cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct intel_context * ce , const struct intel_engine_cs * engine ) ;
...
position p;
@@
 struct i915_wa_ctx_bb * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct i915_address_space * cocci_id@p ;
...
position p;
@@
 struct intel_context * cocci_id@p ;
