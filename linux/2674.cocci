...
position p;
@@
 struct stm32f4_i2c_dev {  struct i2c_adapter adap ;  struct device * dev ;  void __iomem * base ;  struct completion complete ;  struct clk * clk ;  int speed ;  int parent_rate ;  struct stm32f4_i2c_msg msg ; } cocci_id@p ;
...
position p;
@@
 struct stm32f4_i2c_dev * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct stm32f4_i2c_msg {  u8 addr ;  u32 count ;  u8 * buf ;  int result ;  bool stop ; } cocci_id@p ;
...
position p;
@@
 struct stm32f4_i2c_msg * cocci_id@p ;
