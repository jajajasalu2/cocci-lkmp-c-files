...
position p;
@@
 struct synaptics_i2c {  struct i2c_client * client ;  struct input_dev * input ;  struct delayed_work dwork ;  int no_data_count ;  int no_decel_param ;  int reduce_report_param ;  int no_filter_param ;  int scan_rate_param ;  int scan_ms ; } cocci_id@p ;
...
position p;
@@
 struct synaptics_i2c cocci_id@p ;
