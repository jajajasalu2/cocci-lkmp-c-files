...
position p;
@@
 const struct id_to_str cocci_id@p [ ] ;
...
position p;
@@
 struct bcr_iccm_arcompact cocci_id@p ;
...
position p;
@@
 struct bcr_iccm_arcv2 cocci_id@p ;
...
position p;
@@
 struct bcr_fp_arcompact cocci_id@p ;
...
position p;
@@
 struct cpuinfo_arc cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct bcr_dccm_arcompact cocci_id@p ;
...
position p;
@@
 struct bcr_dccm_arcv2 cocci_id@p ;
...
position p;
@@
 struct bcr_actionpoint cocci_id@p ;
...
position p;
@@
 struct bcr_identity * cocci_id@p ;
...
position p;
@@
 struct bcr_isa_arcv2 cocci_id@p ;
...
position p;
@@
 struct bcr_uarch_build_arcv2 cocci_id@p ;
...
position p;
@@
 struct bcr_fp_arcv2 cocci_id@p ;
...
position p;
@@
 struct bcr_bpu_arcv2 cocci_id@p ;
...
position p;
@@
 struct bcr_bpu_arcompact cocci_id@p ;
