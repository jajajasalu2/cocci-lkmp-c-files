...
position p;
@@
 struct marvell_priv * cocci_id@p ;
...
typedef u64;
@@
 struct marvell_priv {  u64 stats [ ARRAY_SIZE ( marvell_hw_stats ) ] ;  char * hwmon_name ;  struct device * hwmon_dev ; } cocci_id@p ;
...
position p;
@@
 struct marvell_hw_stat cocci_id@p [ ] ;
...
typedef u8;
@@
 struct marvell_hw_stat {  const char * string ;  u8 page ;  u8 reg ;  u8 bits ; } cocci_id@p ;
