...
@@
 struct transaction_queue {  struct list_head list ;  struct fw_unit * unit ;  void * buf ;  unsigned int size ;  u32 seqnum ;  enum transaction_queue_state state ;  wait_queue_head_t wait ; } cocci_id@p ;
...
position p;
@@
 struct snd_efw * cocci_id@p [ SNDRV_CARDS ] ;
...
position p;
@@
 enum transaction_queue_state { STATE_PENDING , STATE_BUS_RESET , STATE_COMPLETE , } cocci_id@p ;
...
position p;
@@
 struct transaction_queue * cocci_id@p ;
