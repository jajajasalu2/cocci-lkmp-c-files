...
position p;
@@
 struct recovery_info * cocci_id@p ;
...
position p;
@@
 enum passtype { PASS_SCAN , PASS_REVOKE , PASS_REPLAY , } cocci_id@p ;
...
position p;
@@
 struct buffer_head * cocci_id@p [ MAXBUF ] ;
...
symbol cocci_id;
position p;
typedef journal_block_tag_t;
@@
 journal_block_tag_t * cocci_id@p ;
...
position p;
@@
 struct jbd2_journal_block_tail cocci_id@p ;
...
symbol cocci_id;
position p;
typedef journal_block_tag3_t;
@@
 journal_block_tag3_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef journal_superblock_t;
@@
 journal_superblock_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef jbd2_journal_revoke_header_t;
@@
 jbd2_journal_revoke_header_t * cocci_id@p ;
...
typedef journal_t;
@@
 int cocci_id@p ( journal_t * journal , struct recovery_info * info , enum passtype pass ) ;
...
symbol cocci_id;
position p;
typedef journal_header_t;
@@
 journal_header_t cocci_id@p ;
...
typedef tid_t;
@@
 struct recovery_info {  tid_t start_transaction ;  tid_t end_transaction ;  int nr_replays ;  int nr_revokes ;  int nr_revoke_hits ; } cocci_id@p ;
...
position p;
@@
 struct commit_header * cocci_id@p ;
