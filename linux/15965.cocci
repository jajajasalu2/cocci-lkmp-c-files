...
position p;
@@
 struct ieee80211_network cocci_id@p ;
...
position p;
@@
 struct ieee80211_assoc_response_frame * cocci_id@p ;
...
position p;
@@
 struct ieee80211_crypt_data * cocci_id@p ;
...
position p;
@@
 struct rx_drvinfo_819x_usb * cocci_id@p ;
...
position p;
@@
 struct ieee80211_qos_parameters * cocci_id@p ;
...
position p;
@@
 struct tx_desc_819x_usb cocci_id@p ;
...
position p;
@@
 struct ieee80211_device * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_interface * intf , const struct usb_device_id * id ) ;
...
position p;
@@
 struct rx_desc_819x_usb * cocci_id@p ;
...
position p;
@@
 struct rtl_80211_hdr_3addr * cocci_id@p ;
...
position p;
@@
 struct ieee80211_rx_stats cocci_id@p ;
...
position p;
@@
 struct rtl8192_rx_info * cocci_id@p ;
...
position p;
@@
 struct tx_fwinfo_819x_usb cocci_id@p ;
...
position p;
@@
 struct ieee80211_beacon * cocci_id@p ;
...
position p;
@@
 struct rtl_80211_hdr_1addr * cocci_id@p ;
...
position p;
@@
 struct tx_desc_cmd_819x_usb * cocci_id@p ;
...
position p;
@@
 struct phy_ofdm_rx_status_rxsc_sgien_exintfflag * cocci_id@p ;
...
typedef u8;
@@
 struct CHANNEL_LIST {  u8 Channel [ 32 ] ;  u8 Len ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef phy_sts_ofdm_819xusb_t;
@@
 phy_sts_ofdm_819xusb_t * cocci_id@p ;
...
position p;
@@
 struct CHANNEL_LIST cocci_id@p [ ] ;
...
position p;
@@
 const struct ieee80211_qos_parameters cocci_id@p ;
...
symbol cocci_id;
position p;
typedef phy_sts_cck_819xusb_t;
@@
 phy_sts_cck_819xusb_t * cocci_id@p ;
