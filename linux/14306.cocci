...
position p;
@@
 const struct rtl2832_reg_value * cocci_id@p ;
...
position p;
@@
 struct rtl2832_reg_value cocci_id@p [ ] ;
...
position p;
@@
 const struct rtl2832_reg_entry cocci_id@p [ ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ CONSTELLATION_NUM ] [ HIERARCHY_NUM ] ;
