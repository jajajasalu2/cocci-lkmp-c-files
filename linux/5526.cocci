...
position p;
@@
 struct rtc_time * const cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ISL1208_USR_SECTION_LEN ] ;
...
position p;
@@
 struct isl1208_state * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ISL1208_RTC_SECTION_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ ISL1219_EVT_SECTION_LEN ] ;
...
position p;
@@
 struct i2c_client * const cocci_id@p ;
...
position p;
@@
 const struct isl1208_config {  const char name [ 8 ] ;  unsigned int nvmem_length ;  unsigned has_tamper : 1 ;  unsigned has_timestamp : 1 ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct nvmem_config cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ISL1208_ALARM_SECTION_LEN ] ;
...
position p;
@@
 enum isl1208_id { TYPE_ISL1208 = 0 , TYPE_ISL1209 , TYPE_ISL1218 , TYPE_ISL1219 , ISL_LAST_ID , } cocci_id@p ;
...
position p;
@@
 struct isl1208_state {  struct nvmem_config nvmem_config ;  struct rtc_device * rtc ;  const struct isl1208_config * config ; } cocci_id@p ;
