...
position p;
@@
 struct svga_fifo_cmd_fence * cocci_id@p ;
...
position p;
@@
 struct vmw_temp_set_context cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdWaitForGBQuery body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_fifo_state * cocci_id@p ;
...
position p;
@@
 struct vmw_temp_set_context {  SVGA3dCmdHeader header ;  SVGA3dCmdDXTempSetContext body ; } cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdWaitForQuery body ; } * cocci_id@p ;
