...
position p;
@@
 struct hash_ip6_elem * cocci_id@p ;
...
position p;
@@
 struct hash_ip4_elem cocci_id@p ;
...
position p;
@@
 const struct hash_ip6_elem * cocci_id@p ;
...
position p;
@@
 struct hash_ip6_elem {  union nf_inet_addr ip ; } cocci_id@p ;
...
position p;
@@
 const struct hash_ip4 * cocci_id@p ;
...
position p;
@@
 const struct hash_ip6 * cocci_id@p ;
...
position p;
@@
 const struct hash_ip4_elem * cocci_id@p ;
...
typedef __be32;
@@
 struct hash_ip4_elem {  __be32 ip ; } cocci_id@p ;
