...
position p;
@@
 enum { RTC_SEC = 0 , RTC_MIN , RTC_HOUR , RTC_WEEKDAY , RTC_DATE , RTC_MONTH , RTC_YEAR1 , RTC_YEAR2 , } cocci_id@p ;
...
position p;
@@
 struct max8998_rtc_info cocci_id@p ;
...
typedef bool;
@@
 struct max8998_rtc_info {  struct device * dev ;  struct max8998_dev * max8998 ;  struct i2c_client * rtc ;  struct rtc_device * rtc_dev ;  int irq ;  bool lp3974_bug_workaround ; } cocci_id@p ;
