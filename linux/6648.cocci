...
position p;
@@
 enum hisi_sas_debugfs_cache_type cocci_id@p ;
...
typedef __le32;
@@
 struct hisi_sas_err_record_v3 {  __le32 trans_tx_fail_type ;  __le32 trans_rx_fail_type ;  __le16 dma_tx_err_type ;  __le16 sipc_rx_err_type ;  __le32 dma_rx_err_type ; } cocci_id@p ;
...
position p;
@@
 struct hisi_sas_complete_v3_hdr cocci_id@p ;
...
position p;
@@
 enum { DSM_FUNC_ERR_HANDLE_MSI = 0 , } cocci_id@p ;
...
position p;
@@
 struct hisi_sas_protect_iu_v3_hw * cocci_id@p ;
...
typedef u32;
@@
 struct hisi_sas_protect_iu_v3_hw {  u32 dw0 ;  u32 lbrtcv ;  u32 lbrtgv ;  u32 dw3 ;  u32 dw4 ;  u32 dw5 ;  u32 rsv ; } cocci_id@p ;
...
typedef __le32;
@@
 struct hisi_sas_complete_v3_hdr {  __le32 dw0 ;  __le32 dw1 ;  __le32 act ;  __le32 dw3 ; } cocci_id@p ;
...
position p;
@@
 struct hisi_sas_sge_dif_page * cocci_id@p ;
...
position p;
@@
 struct hisi_sas_err_record_v3 * cocci_id@p ;
