...
position p;
@@
 struct test_obj_rhl cocci_id@p ;
...
position p;
@@
 const struct test_obj_val * cocci_id@p ;
...
position p;
@@
 struct test_obj {  struct test_obj_val value ;  struct rhash_head node ; } cocci_id@p ;
...
position p;
@@
 struct test_obj_rhl {  struct test_obj_val value ;  struct rhlist_head list_node ; } cocci_id@p ;
...
position p;
@@
 struct test_obj_rhl cocci_id@p [ 3 ] ;
...
position p;
@@
 struct thread_data {  unsigned int entries ;  int id ;  struct task_struct * task ;  struct test_obj * objs ; } cocci_id@p ;
...
position p;
@@
 const struct bucket_table * cocci_id@p ;
...
position p;
@@
 struct test_obj_val cocci_id@p ;
...
position p;
@@
 const struct test_obj_rhl * cocci_id@p ;
...
position p;
@@
 struct test_obj_val {  int id ;  int tid ; } cocci_id@p ;
