...
position p;
@@
 struct mwifiex_ie_types_chan_list_param_set * * cocci_id@p ;
...
typedef u8;
@@
 union mwifiex_scan_cmd_config_tlv {  struct mwifiex_scan_cmd_config config ;  u8 config_alloc_buf [ MAX_SCAN_CFG_ALLOC ] ; } cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_num_probes * cocci_id@p ;
...
position p;
@@
 struct mwifiex_bss_priv * cocci_id@p ;
...
position p;
@@
 struct chan_band_param_set * cocci_id@p ;
...
position p;
@@
 struct mwifiex_chan_scan_param_set cocci_id@p ;
...
position p;
@@
 struct ieee_types_ds_param_set * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_bssid_list * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_wildcard_ssid_params * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_tsf_timestamp * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_bgscan_start_later * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_bss_mode * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_bss_scan_info cocci_id@p ;
...
position p;
@@
 struct mwifiex_fixed_bcn_param cocci_id@p ;
...
position p;
@@
 struct ieee_types_vendor_specific * cocci_id@p ;
...
position p;
@@
 struct ieee_types_cf_param_set * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_rates_param_set cocci_id@p ;
...
position p;
@@
 struct mwifiex_fw_chan_stats * cocci_id@p ;
...
position p;
@@
 struct mwifiex_user_scan_chan cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_chan_band_list_param_set * cocci_id@p ;
...
position p;
@@
 struct mwifiex_user_scan_cfg * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_data * * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_bg_scan_config * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_vendor_param_set * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_repeat_count * cocci_id@p ;
...
position p;
@@
 struct mwifiex_bssdescriptor * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_scan_ext * cocci_id@p ;
...
position p;
@@
 struct ieee_types_wmm_info cocci_id@p ;
...
position p;
@@
 struct mwifiex_ietypes_chanstats * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CIPHER_SUITE_MAX ] [ 4 ] ;
...
position p;
@@
 struct cmd_ctrl_node * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_bg_scan_query * cocci_id@p ;
...
position p;
@@
 struct mwifiex_bg_scan_cfg * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_scan_chan_gap cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_bss_scan_rsp * cocci_id@p ;
...
position p;
@@
 struct mwifiex_scan_cmd_config * cocci_id@p ;
...
position p;
@@
 struct ieee_types_ibss_param_set cocci_id@p ;
...
position p;
@@
 struct mwifiex_chan_stats cocci_id@p ;
...
position p;
@@
 enum cipher_suite { CIPHER_SUITE_TKIP , CIPHER_SUITE_CCMP , CIPHER_SUITE_MAX , } cocci_id@p ;
...
position p;
@@
 struct ieee_types_fh_param_set * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_random_mac cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_scan_rsp * cocci_id@p ;
...
position p;
@@
 const struct mwifiex_bg_scan_cfg * cocci_id@p ;
...
position p;
@@
 union mwifiex_scan_cmd_config_tlv * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_min_rssi_threshold * cocci_id@p ;
...
position p;
@@
 struct ieee80211_ht_operation * cocci_id@p ;
...
position p;
@@
 struct ieee_types_header cocci_id@p ;
...
position p;
@@
 const struct mwifiex_user_scan_cfg * cocci_id@p ;
...
position p;
@@
 struct ieee_types_wmm_parameter cocci_id@p ;
...
position p;
@@
 struct ieee_types_generic * cocci_id@p ;
...
position p;
@@
 struct mwifiex_event_scan_result * cocci_id@p ;
...
position p;
@@
 struct host_cmd_ds_802_11_scan * cocci_id@p ;
...
position p;
@@
 struct mwifiex_chan_freq_power * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MWIFIEX_SUPPORTED_RATES ] ;
