...
position p;
@@
 int cocci_id@p ( struct key_preparsed_payload * ) ;
...
position p;
@@
 const struct rxrpc_key_data_v1 * cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 kver ;  struct rxrpc_key_data_v1 v1 ; } cocci_id@p ;
...
position p;
@@
 struct krb5_tagged_data * cocci_id@p ;
...
position p;
@@
 struct krb5_principal * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct key * , struct seq_file * ) ;
...
position p;
@@
 void cocci_id@p ( struct key_preparsed_payload * ) ;
...
position p;
@@
 const struct krb5_principal * cocci_id@p ;
