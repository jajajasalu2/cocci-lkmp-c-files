...
typedef spinlock_t;
@@
 struct dc_i2c {  struct i2c_adapter adap ;  struct device * dev ;  void __iomem * regs ;  struct clk * clk ;  unsigned int frequency ;  struct i2c_msg * msg ;  unsigned int msgbuf_ptr ;  int last ;  spinlock_t lock ;  struct completion done ;  int state ;  int error ; } cocci_id@p ;
...
position p;
@@
 enum { STATE_IDLE , STATE_START , STATE_ADDR , STATE_WRITE , STATE_READ , STATE_STOP , } cocci_id@p ;
