...
position p;
@@
 struct apci3xxx_private {  unsigned int ai_timer ;  unsigned char ai_time_base ; } cocci_id@p ;
...
position p;
@@
 struct apci3xxx_private * cocci_id@p ;
...
position p;
@@
 struct apci3xxx_boardinfo {  const char * name ;  int ai_subdev_flags ;  int ai_n_chan ;  unsigned int ai_maxdata ;  unsigned char ai_conv_units ;  unsigned int ai_min_acq_ns ;  unsigned int has_ao : 1 ;  unsigned int has_dig_in : 1 ;  unsigned int has_dig_out : 1 ;  unsigned int has_ttl_io : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct apci3xxx_boardinfo cocci_id@p [ ] ;
...
position p;
@@
 enum apci3xxx_boardid { BOARD_APCI3000_16 , BOARD_APCI3000_8 , BOARD_APCI3000_4 , BOARD_APCI3006_16 , BOARD_APCI3006_8 , BOARD_APCI3006_4 , BOARD_APCI3010_16 , BOARD_APCI3010_8 , BOARD_APCI3010_4 , BOARD_APCI3016_16 , BOARD_APCI3016_8 , BOARD_APCI3016_4 , BOARD_APCI3100_16_4 , BOARD_APCI3100_8_4 , BOARD_APCI3106_16_4 , BOARD_APCI3106_8_4 , BOARD_APCI3110_16_4 , BOARD_APCI3110_8_4 , BOARD_APCI3116_16_4 , BOARD_APCI3116_8_4 , BOARD_APCI3003 , BOARD_APCI3002_16 , BOARD_APCI3002_8 , BOARD_APCI3002_4 , BOARD_APCI3500 , } cocci_id@p ;
