...
position p;
@@
 struct master_attribute {  struct device_attribute attr ;  struct gth_device * gth ;  unsigned int master ; } cocci_id@p ;
...
position p;
@@
 struct master_attribute cocci_id@p ;
...
typedef spinlock_t;
@@
 struct gth_device {  struct device * dev ;  void __iomem * base ;  struct attribute_group output_group ;  struct attribute_group master_group ;  struct gth_output output [ TH_POSSIBLE_OUTPUTS ] ;  signed char master [ TH_CONFIGURABLE_MASTERS + 1 ] ;  spinlock_t gth_lock ; } cocci_id@p ;
...
position p;
@@
 struct output_attribute {  struct device_attribute attr ;  struct gth_device * gth ;  unsigned int port ;  unsigned int parm ; } cocci_id@p ;
...
position p;
@@
 struct output_attribute cocci_id@p ;
...
position p;
@@
 struct gth_output {  struct gth_device * gth ;  struct intel_th_output * output ;  unsigned int index ;  unsigned int port_type ; 
...
position p;
@@
 struct intel_th_output * cocci_id@p ;
