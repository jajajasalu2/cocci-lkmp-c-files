...
position p;
@@
 struct viafb_gpio_cfg {  struct gpio_chip gpio_chip ;  struct viafb_dev * vdev ;  struct viafb_gpio * active_gpios [ VIAFB_NUM_GPIOS ] ;  const char * gpio_names [ VIAFB_NUM_GPIOS ] ; } cocci_id@p ;
...
position p;
@@
 struct via_port_cfg * cocci_id@p ;
...
position p;
@@
 struct viafb_gpio_cfg cocci_id@p ;
...
typedef u8,u16;
@@
 struct viafb_gpio {  char * vg_name ;  u16 vg_io_port ;  u8 vg_port_index ;  int vg_mask_shift ; } cocci_id@p ;
