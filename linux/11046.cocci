...
position p;
@@
 void cocci_id@p ( struct kfd_dev * kfd ) ;
...
position p;
@@
 const struct kfd_device_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct kfd_dev * kfd ) ;
...
position p;
@@
 int cocci_id@p ( struct kfd_dev * kfd , unsigned int buf_size , unsigned int chunk_size ) ;
...
position p;
@@
 const struct kgd2kfd_shared_resources * cocci_id@p ;
...
position p;
@@
 const struct kfd_device_info * cocci_id@p [ ] [ 2 ] ;
...
typedef uint32_t;
@@
 uint32_t cocci_id@p [ KFD_MAX_RING_ENTRY_SIZE ] ;
