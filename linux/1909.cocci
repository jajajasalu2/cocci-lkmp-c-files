...
typedef u8;
@@
 struct max1118 {  struct spi_device * spi ;  struct mutex lock ;  struct regulator * reg ;  u8 data ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum max1118_id { max1117 , max1118 , max1119 , } cocci_id@p ;
