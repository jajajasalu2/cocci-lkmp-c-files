...
position p;
@@
 const struct v4l2_ctrl_hevc_slice_params * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_hevc_pps * cocci_id@p ;
...
position p;
@@
 const struct v4l2_hevc_pred_weight_table * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_hevc_sps * cocci_id@p ;
...
position p;
@@
 struct cedrus_h265_sram_pred_weight cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct v4l2_hevc_dpb_entry * cocci_id@p ;
...
position p;
@@
 struct cedrus_h265_sram_frame_info cocci_id@p ;
