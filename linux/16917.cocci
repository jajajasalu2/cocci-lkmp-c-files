...
typedef u8;
@@
 struct {  u8 reg ;  u8 value ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct bu21029_ts_data {  struct i2c_client * client ;  struct input_dev * in_dev ;  struct timer_list timer ;  struct regulator * vdd ;  struct gpio_desc * reset_gpios ;  u32 x_plate_ohms ;  struct touchscreen_properties prop ; } cocci_id@p ;
...
position p;
@@
 struct bu21029_ts_data * cocci_id@p ;
