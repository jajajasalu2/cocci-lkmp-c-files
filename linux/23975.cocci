...
position p;
@@
 struct igmpv3_query cocci_id@p ;
...
position p;
@@
 struct ip_sf_socklist * cocci_id@p ;
...
position p;
@@
 struct igmp_mc_iter_state {  struct seq_net_private p ;  struct net_device * dev ;  struct in_device * in_dev ; } cocci_id@p ;
...
position p;
@@
 struct ip_mc_socklist __rcu * * cocci_id@p ;
...
position p;
@@
 struct igmpv3_report cocci_id@p ;
...
position p;
@@
 struct ip_mc_socklist * cocci_id@p ;
...
position p;
@@
 struct igmp_mcf_iter_state * cocci_id@p ;
...
position p;
@@
 struct ip_mreq_source * cocci_id@p ;
...
position p;
@@
 const struct ip_mc_list * cocci_id@p ;
...
position p;
@@
 struct igmp_mc_iter_state * cocci_id@p ;
...
position p;
@@
 struct ip_mc_list __rcu * * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ip_mc_list * pmc ) ;
...
position p;
@@
 void cocci_id@p ( struct in_device * in_dev ) ;
...
position p;
@@
 struct igmp_mcf_iter_state {  struct seq_net_private p ;  struct net_device * dev ;  struct in_device * idev ;  struct ip_mc_list * im ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct in_device * in_dev , __be32 * pmca , int sfmode , int sfcount , __be32 * psfsrc , int delta ) ;
...
position p;
@@
 void cocci_id@p ( struct in_device * in_dev , struct ip_mc_list * im ) ;
...
position p;
@@
 int cocci_id@p ( struct ip_mc_list * pmc ) ;
