...
position p;
@@
 struct uniphier_pcie_priv {  void __iomem * base ;  struct dw_pcie pci ;  struct clk * clk ;  struct reset_control * rst ;  struct phy * phy ;  struct irq_domain * legacy_irq_domain ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_pcie_priv * cocci_id@p ;
