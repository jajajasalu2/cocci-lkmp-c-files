...
position p;
@@
 int cocci_id@p ( struct dao * dao , const struct dao_desc * desc ) ;
...
position p;
@@
 struct daio_rsc_idx {  unsigned short left ;  unsigned short right ; } cocci_id@p ;
...
position p;
@@
 struct daio_usage {  unsigned short data ; } cocci_id@p ;
...
position p;
@@
 const struct dai_rsc_ops cocci_id@p ;
...
position p;
@@
 const struct dao_desc * cocci_id@p ;
...
position p;
@@
 struct daio_rsc_idx cocci_id@p [ NUM_DAIOTYP ] ;
...
position p;
@@
 const struct daio_desc * cocci_id@p ;
...
position p;
@@
 const struct dao_rsc_ops cocci_id@p ;
...
position p;
@@
 const struct rsc_ops cocci_id@p ;
