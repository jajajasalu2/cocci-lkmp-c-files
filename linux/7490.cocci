...
position p;
@@
 struct ics5342_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dac_write_regs_t;
@@
 dac_write_regs_t cocci_id@p ;
...
position p;
@@
 const struct svga_timing_regs cocci_id@p ;
...
position p;
@@
 struct fb_tilecursor * cocci_id@p ;
...
position p;
@@
 struct pci_bus_region cocci_id@p ;
...
typedef u32;
@@
 struct dac_ops {  int ( * dac_get_mode ) ( struct dac_info * info ) ;  int ( * dac_set_mode ) ( struct dac_info * info , int mode ) ;  int ( * dac_get_freq ) ( struct dac_info * info , int channel ) ;  int ( * dac_set_freq ) ( struct dac_info * info , int channel , u32 freq ) ;  void ( * dac_release ) ( struct dac_info * info ) ; } cocci_id@p ;
...
typedef u8;
@@
 struct ics5342_info {  struct dac_info dac ;  u8 mode ; } cocci_id@p ;
...
position p;
@@
 const struct svga_fb_format cocci_id@p [ ] ;
...
typedef u32;
@@
 struct arkfb_info {  int mclk_freq ;  int wc_cookie ;  struct dac_info * dac ;  struct vgastate state ;  struct mutex open_lock ;  unsigned int ref_count ;  u32 pseudo_palette [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 const struct vga_regset cocci_id@p [ ] ;
...
position p;
@@
 enum { DAC_PSEUDO8_8 , DAC_RGB1555_8 , DAC_RGB0565_8 , DAC_RGB0888_8 , DAC_RGB8888_8 , DAC_PSEUDO8_16 , DAC_RGB1555_16 , DAC_RGB0565_16 , DAC_RGB0888_16 , DAC_RGB8888_16 , DAC_MAX , } cocci_id@p ;
...
position p;
@@
 const struct svga_pll cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dac_read_regs_t;
@@
 dac_read_regs_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dac_read_regs_t,dac_write_regs_t;
@@
 struct dac_info {  struct dac_ops * dacops ;  dac_read_regs_t dac_read_regs ;  dac_write_regs_t dac_write_regs ;  void * data ; } cocci_id@p ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( void * data , u8 * code , int count ) ;
