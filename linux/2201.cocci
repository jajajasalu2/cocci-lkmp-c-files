...
position p;
@@
 const struct batres_vs_temp * cocci_id@p ;
...
typedef bool;
@@
 struct ab8500_fg_cap_scaling {  bool enable ;  int cap_to_scale [ 2 ] ;  int disable_cap_level ;  int scaled_cap ; } cocci_id@p ;
...
typedef bool;
@@
 struct ab8500_fg_flags {  bool fg_enabled ;  bool conv_done ;  bool charging ;  bool fully_charged ;  bool force_full ;  bool low_bat_delay ;  bool low_bat ;  bool bat_ovv ;  bool batt_unknown ;  bool calibrate ;  bool user_cap ;  bool batt_id_received ; } cocci_id@p ;
...
position p;
@@
 struct inst_curr_result_list {  struct list_head list ;  int * result ; } cocci_id@p ;
...
position p;
@@
 enum ab8500_fg_discharge_state cocci_id@p ;
...
position p;
@@
 enum ab8500_fg_calibration_state { AB8500_FG_CALIB_INIT , AB8500_FG_CALIB_WAIT , AB8500_FG_CALIB_END , } cocci_id@p ;
...
position p;
@@
 struct ab8500_fg_cap_scaling * cocci_id@p ;
...
typedef irqreturn_t;
@@
 struct ab8500_fg_interrupts {  char * name ;  irqreturn_t ( * isr ) ( int irq , void * data ) ; } cocci_id@p ;
...
position p;
@@
 enum ab8500_fg_charge_state cocci_id@p ;
...
position p;
@@
 const struct abx500_v_to_cap * cocci_id@p ;
...
position p;
@@
 struct ab8500_fg_battery_capacity {  int max_mah_design ;  int max_mah ;  int mah ;  int permille ;  int level ;  int prev_mah ;  int prev_percent ;  int prev_level ;  int user_mah ;  struct ab8500_fg_cap_scaling cap_scale ; } cocci_id@p ;
...
position p;
@@
 enum ab8500_fg_charge_state { AB8500_FG_CHARGE_INIT , AB8500_FG_CHARGE_READOUT , } cocci_id@p ;
...
position p;
@@
 struct ab8500_fg_sysfs_entry * cocci_id@p ;
...
typedef time64_t;
@@
 struct ab8500_fg_avg_cap {  int avg ;  int samples [ NBR_AVG_SAMPLES ] ;  time64_t time_stamps [ NBR_AVG_SAMPLES ] ;  int pos ;  int nbr_samples ;  int sum ; } cocci_id@p ;
...
position p;
@@
 struct ab8500_fg_avg_cap * cocci_id@p ;
...
position p;
@@
 const struct abx500_battery_type * cocci_id@p ;
...
position p;
@@
 struct abx500_bm_data * cocci_id@p ;
...
position p;
@@
 struct ab8500_fg_interrupts cocci_id@p [ ] ;
...
position p;
@@
 const struct power_supply_desc cocci_id@p ;
...
position p;
@@
 enum ab8500_fg_discharge_state { AB8500_FG_DISCHARGE_INIT , AB8500_FG_DISCHARGE_INITMEASURING , AB8500_FG_DISCHARGE_INIT_RECOVERY , AB8500_FG_DISCHARGE_RECOVERY , AB8500_FG_DISCHARGE_READOUT_INIT , AB8500_FG_DISCHARGE_READOUT , AB8500_FG_DISCHARGE_WAKEUP , } cocci_id@p ;
