...
position p;
@@
 struct uverbs_api_attr * cocci_id@p ;
...
position p;
@@
 enum uapi_definition_kind cocci_id@p ;
...
position p;
@@
 struct uverbs_api_object * cocci_id@p ;
...
position p;
@@
 const struct uverbs_api_object * cocci_id@p ;
...
position p;
@@
 const struct uverbs_method_def * cocci_id@p ;
...
position p;
@@
 struct uverbs_api_write_method * cocci_id@p ;
...
position p;
@@
 struct uverbs_attr_spec * cocci_id@p ;
...
position p;
@@
 const struct uverbs_attr_def * cocci_id@p ;
...
position p;
@@
 const struct uverbs_object_def * cocci_id@p ;
