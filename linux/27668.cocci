...
typedef u32;
@@
 struct nsm_res {  u32 status ;  u32 state ; } cocci_id@p ;
...
position p;
@@
 const struct nlm_reboot * cocci_id@p ;
...
position p;
@@
 const struct nlm_host * cocci_id@p ;
...
position p;
@@
 const struct nsm_private * cocci_id@p ;
...
position p;
@@
 const struct nsm_handle * cocci_id@p ;
...
position p;
@@
 const struct nsm_args * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( nsm_procedures ) ] ;
...
typedef u32;
@@
 struct nsm_args {  struct nsm_private * priv ;  u32 prog ;  u32 vers ;  u32 proc ;  char * mon_name ;  const char * nodename ; } cocci_id@p ;
...
position p;
@@
 enum { NSMPROC_NULL , NSMPROC_STAT , NSMPROC_MON , NSMPROC_UNMON , NSMPROC_UNMON_ALL , NSMPROC_SIMU_CRASH , NSMPROC_NOTIFY , } cocci_id@p ;
