...
typedef bool,u32;
@@
 struct stm32_rproc {  struct reset_control * rst ;  struct stm32_syscon hold_boot ;  struct stm32_syscon pdds ;  int wdg_irq ;  u32 nb_rmems ;  struct stm32_rproc_mem * rmems ;  struct stm32_mbox mb [ MBOX_NB_MBX ] ;  struct workqueue_struct * workqueue ;  bool secured_soc ; } cocci_id@p ;
...
position p;
@@
 struct stm32_mbox {  const unsigned char name [ 10 ] ;  struct mbox_chan * chan ;  struct mbox_client client ;  struct work_struct vq_work ;  int vq_id ; } cocci_id@p ;
...
position p;
@@
 struct stm32_syscon * cocci_id@p ;
...
position p;
@@
 struct of_phandle_iterator cocci_id@p ;
...
position p;
@@
 struct stm32_rproc_mem_ranges * cocci_id@p ;
...
typedef u32;
@@
 struct stm32_syscon {  struct regmap * map ;  u32 reg ;  u32 mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_rproc_mem_ranges {  u32 dev_addr ;  u32 bus_addr ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 struct stm32_rproc_mem * cocci_id@p ;
...
position p;
@@
 const struct stm32_mbox cocci_id@p [ MBOX_NB_MBX ] ;
...
position p;
@@
 struct rproc_debug_trace * cocci_id@p ;
...
@@
 struct stm32_rproc_mem {  char name [ 20 ] ;  void __iomem * cpu_addr ;  phys_addr_t bus_addr ;  u32 dev_addr ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 struct reserved_mem * cocci_id@p ;
...
position p;
@@
 struct rproc_mem_entry * cocci_id@p ;
