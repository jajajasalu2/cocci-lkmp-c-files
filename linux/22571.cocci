...
@@
 struct conexant_spec {  struct hda_gen_spec gen ;  unsigned int num_eapds ;  hda_nid_t eapds [ 4 ] ;  bool dynamic_eapd ;  hda_nid_t mute_led_eapd ;  unsigned int parse_flags ;  bool recording ;  bool dc_enable ;  unsigned int dc_input_bias ;  struct nid_path * dc_mode_path ;  int mute_led_polarity ;  unsigned int gpio_led ;  unsigned int gpio_mute_led_mask ;  unsigned int gpio_mic_led_mask ; } cocci_id@p ;
...
position p;
@@
 struct conexant_spec * cocci_id@p ;
