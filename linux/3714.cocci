...
position p;
@@
 struct adf_accel_pci * cocci_id@p ;
...
position p;
@@
 struct adf_etr_bank_data * cocci_id@p ;
...
position p;
@@
 struct adf_vf_stop_data cocci_id@p ;
...
position p;
@@
 struct adf_vf_stop_data {  struct adf_accel_dev * accel_dev ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct adf_etr_data * cocci_id@p ;
