...
position p;
@@
 struct p54_keycache * cocci_id@p ;
...
position p;
@@
 struct p54_setup_mac * cocci_id@p ;
...
position p;
@@
 struct p54_scan_tail_rate * cocci_id@p ;
...
position p;
@@
 struct p54_scan_body * cocci_id@p ;
...
position p;
@@
 union p54_scan_body_union * cocci_id@p ;
...
position p;
@@
 struct p54_txcancel * cocci_id@p ;
...
position p;
@@
 struct p54_group_address_table * cocci_id@p ;
...
position p;
@@
 struct p54_statistics cocci_id@p ;
...
position p;
@@
 struct p54_scan_head * cocci_id@p ;
...
position p;
@@
 struct p54_iq_autocal_entry cocci_id@p ;
...
position p;
@@
 struct bootrec_desc * cocci_id@p ;
...
position p;
@@
 struct p54_sta_unlock * cocci_id@p ;
...
position p;
@@
 struct p54_xbow_synth * cocci_id@p ;
...
position p;
@@
 struct p54_eeprom_lm86 * cocci_id@p ;
