...
position p;
@@
 struct pxa168_eth_private * cocci_id@p ;
...
typedef __le32;
@@
 struct addr_table_entry {  __le32 lo ;  __le32 hi ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct tx_desc {  u32 cmd_sts ;  u16 reserved ;  u16 byte_cnt ;  u32 buf_ptr ;  u32 next_desc_ptr ; } cocci_id@p ;
...
position p;
@@
 enum hash_table_entry { HASH_ENTRY_VALID = 1 , SKIP = 2 , HASH_ENTRY_RECEIVE_DISCARD = 4 , HASH_ENTRY_RECEIVE_DISCARD_BIT = 2 , } cocci_id@p ;
...
typedef u32,u16;
@@
 struct rx_desc {  u32 cmd_sts ;  u16 byte_cnt ;  u16 buf_size ;  u32 buf_ptr ;  u32 next_desc_ptr ; } cocci_id@p ;
...
position p;
@@
 struct addr_table_entry * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pxa168_eth_private * pep ) ;
