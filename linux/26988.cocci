...
symbol cocci_id;
position p;
typedef xfs_error_injection_t;
@@
 xfs_error_injection_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_extlen_t;
@@
 xfs_extlen_t cocci_id@p ;
...
position p;
@@
 struct xfs_fs_eofblocks cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_attr_multiop_t;
@@
 xfs_attr_multiop_t cocci_id@p ;
...
position p;
@@
 struct xfs_fsop_geom_v4 cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_growfs_log_t;
@@
 xfs_growfs_log_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_fsop_resblks_t;
@@
 xfs_fsop_resblks_t cocci_id@p ;
...
position p;
@@
 struct xfs_inumbers cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_flock64_t;
@@
 xfs_flock64_t cocci_id@p ;
...
position p;
@@
 struct xfs_bulk_ireq cocci_id@p ;
...
symbol cocci_id;
position p;
typedef attrlist_cursor_kern_t;
@@
 attrlist_cursor_kern_t * cocci_id@p ;
...
position p;
@@
 struct xfs_fsop_geom_v1 cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_fsop_attrlist_handlereq_t;
@@
 xfs_fsop_attrlist_handlereq_t cocci_id@p ;
...
position p;
@@
 const struct xfs_inumbers * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_handle_t;
@@
 xfs_handle_t cocci_id@p ;
...
typedef __u32;
@@
 struct getfsmap_info {  struct xfs_mount * mp ;  struct fsmap_head __user * data ;  unsigned int idx ;  __u32 last_flags ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ XFSLABEL_MAX + 1 ] ;
...
symbol cocci_id;
position p;
typedef xfs_growfs_data_t;
@@
 xfs_growfs_data_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_swapext_t;
@@
 xfs_swapext_t * cocci_id@p ;
...
position p;
@@
 struct xfs_fsop_bulkreq cocci_id@p ;
...
position p;
@@
 struct xfs_scrub_metadata cocci_id@p ;
...
position p;
@@
 struct getfsmap_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_fsop_handlereq_t;
@@
 xfs_fsop_handlereq_t cocci_id@p ;
...
position p;
@@
 const struct xfs_bulkstat * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_fsop_attrmulti_handlereq_t;
@@
 xfs_fsop_attrmulti_handlereq_t cocci_id@p ;
...
position p;
@@
 struct xfs_ag_geometry cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_fsop_counts_t;
@@
 xfs_fsop_counts_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_fsblock_t;
@@
 xfs_fsblock_t cocci_id@p ;
...
position p;
@@
 struct xfs_bulkstat cocci_id@p ;
...
position p;
@@
 struct xfs_fsop_geom cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_growfs_rt_t;
@@
 xfs_growfs_rt_t cocci_id@p ;
...
position p;
@@
 struct xfs_fsmap_head cocci_id@p ;
...
position p;
@@
 enum xfs_prealloc_flags cocci_id@p ;
...
position p;
@@
 struct xfs_eofblocks cocci_id@p ;
