...
position p;
@@
 const struct perf_session * cocci_id@p ;
...
position p;
@@
 struct ref_reloc_sym * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef peek_events_cb_t;
@@
 peek_events_cb_t cocci_id@p ;
...
typedef u64,s64;
@@
 s64 ( * cocci_id@p ) ( struct perf_session * session , union perf_event * event , u64 file_offset ) ;
...
position p;
@@
 struct perf_record_read * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,reader_cb_t;
@@
 struct reader {  int fd ;  u64 data_size ;  u64 data_offset ;  reader_cb_t process ; } cocci_id@p ;
...
position p;
@@
 const struct ordered_events * cocci_id@p ;
...
typedef bool;
@@
 void ( * cocci_id@p ) ( union perf_event * event , bool sample_id_all ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct dso * dso , int parm ) ;
...
typedef u64;
@@
 int cocci_id@p ( struct perf_session * session , union perf_event * event , struct perf_tool * tool , u64 file_offset ) ;
...
position p;
@@
 int cocci_id@p ( struct perf_tool * tool , union perf_event * event , struct ordered_events * oe ) ;
...
position p;
@@
 int cocci_id@p ( struct perf_session * session ) ;
