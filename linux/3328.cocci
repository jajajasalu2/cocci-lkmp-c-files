...
position p;
@@
 struct rpi_hwmon_data * cocci_id@p ;
...
typedef u32;
@@
 struct rpi_hwmon_data {  struct device * hwmon_dev ;  struct rpi_firmware * fw ;  u32 last_throttled ;  struct delayed_work get_values_poll_work ; } cocci_id@p ;
