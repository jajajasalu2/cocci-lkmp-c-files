...
position p;
@@
 struct dpu_encoder_phys_ops * cocci_id@p ;
...
position p;
@@
 struct intf_timing_params * cocci_id@p ;
...
position p;
@@
 struct dpu_encoder_phys_vid cocci_id@p ;
...
position p;
@@
 const struct dpu_encoder_phys * cocci_id@p ;
...
position p;
@@
 const struct intf_timing_params * cocci_id@p ;
...
position p;
@@
 struct intf_prog_fetch cocci_id@p ;
...
position p;
@@
 struct dpu_hw_intf_cfg cocci_id@p ;
