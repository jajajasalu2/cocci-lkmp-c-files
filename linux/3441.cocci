...
position p;
@@
 struct wf_ad7417_priv * cocci_id@p ;
...
typedef u8;
@@
 struct wf_ad7417_priv {  struct kref ref ;  struct i2c_client * i2c ;  u8 config ;  u8 cpu ;  const struct mpu_data * mpu ;  struct wf_sensor sensors [ 5 ] ;  struct mutex lock ; } cocci_id@p ;
