...
position p;
@@
 struct tc_hfsc_qopt cocci_id@p ;
...
position p;
@@
 struct tc_hfsc_stats cocci_id@p ;
...
typedef u64;
@@
 struct internal_sc {  u64 sm1 ;  u64 ism1 ;  u64 dx ;  u64 dy ;  u64 sm2 ;  u64 ism2 ; } cocci_id@p ;
...
position p;
@@
 struct tc_service_curve cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_HFSC_MAX + 1 ] ;
...
typedef u64;
@@
 struct runtime_sc {  u64 x ;  u64 y ;  u64 sm1 ;  u64 ism1 ;  u64 dx ;  u64 dy ;  u64 sm2 ;  u64 ism2 ; } cocci_id@p ;
...
typedef u16;
@@
 struct hfsc_sched {  u16 defcls ;  struct hfsc_class root ;  struct Qdisc_class_hash clhash ;  struct rb_root eligible ;  struct qdisc_watchdog watchdog ; } cocci_id@p ;
...
position p;
@@
 enum hfsc_class_flags { HFSC_RSC = 0x1 , HFSC_FSC = 0x2 , HFSC_USC = 0x4 , } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_HFSC_MAX + 1 ] ;
