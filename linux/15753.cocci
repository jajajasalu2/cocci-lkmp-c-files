...
typedef u8;
@@
 u8 cocci_id@p [ CB_VT3342_INIT_SEQ ] [ 3 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ CB_AL7230_INIT_SEQ ] [ 3 ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ AL2230_PWR_IDX_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ CB_VT3226_INIT_SEQ ] [ 3 ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ CB_MAX_CHANNEL_24G ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ CB_MAX_CHANNEL ] [ 3 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ CB_MAX_CHANNEL_24G ] [ 3 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ CB_AL2230_INIT_SEQ ] [ 3 ] ;
