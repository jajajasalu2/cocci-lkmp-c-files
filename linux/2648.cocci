...
position p;
@@
 enum { STATE_DONE = 0 , STATE_INIT , STATE_ADDR , STATE_ADDR10 , STATE_START , STATE_WRITE , STATE_READ , STATE_ERROR , } cocci_id@p ;
...
position p;
@@
 struct kempld_i2c_data * cocci_id@p ;
...
typedef bool;
@@
 struct kempld_i2c_data {  struct device * dev ;  struct kempld_device_data * pld ;  struct i2c_adapter adap ;  struct i2c_msg * msg ;  int pos ;  int nmsgs ;  int state ;  bool was_active ; } cocci_id@p ;
