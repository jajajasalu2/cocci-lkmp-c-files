...
position p;
@@
 int cocci_id@p ( struct net_device * , const unsigned char * ) ;
...
position p;
@@
 struct igb_tx_buffer cocci_id@p ;
...
position p;
@@
 union {  struct tcphdr * tcp ;  struct udphdr * udp ;  unsigned char * hdr ; } cocci_id@p ;
...
position p;
@@
 struct igb_reg_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * , int ) ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * dev ) ;
...
position p;
@@
 struct ptp_clock_event cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct igb_q_vector * , int ) ;
...
position p;
@@
 struct vf_mac_filter cocci_id@p ;
...
position p;
@@
 struct e1000_fc_info * cocci_id@p ;
...
position p;
@@
 const struct igb_reg_info cocci_id@p [ ] ;
...
typedef u8;
@@
 int cocci_id@p ( struct igb_adapter * , u8 ) ;
...
position p;
@@
 struct igb_nfc_filter * cocci_id@p ;
...
position p;
@@
 struct igb_rx_buffer cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct igb_adapter * adapter , int vf ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , struct rtnl_link_stats64 * stats ) ;
...
position p;
@@
 struct e1000_phy_info * cocci_id@p ;
...
position p;
@@
 struct e1000_mac_info * cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct net_device * , __be16 , u16 ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct igb_adapter * adapter , bool set ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * , int , int , int ) ;
...
position p;
@@
 int cocci_id@p ( struct igb_q_vector * , int ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ E1000_PBANUM_LENGTH ] ;
...
position p;
@@
 struct igb_mac_addr cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ E1000_VFMAILBOX_SIZE ] ;
...
typedef u8;
@@
 int cocci_id@p ( struct net_device * netdev , int vf , u8 * mac ) ;
...
position p;
@@
 struct vf_data_storage * cocci_id@p ;
...
position p;
@@
 enum queue_mode { QUEUE_MODE_STRICT_PRIORITY , QUEUE_MODE_STREAM_RESERVATION , } cocci_id@p ;
...
position p;
@@
 const struct e1000_info * cocci_id@p [ ] ;
...
position p;
@@
 struct e1000_fw_version cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct net_device * netdev , int vf , bool setting ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct igb_adapter * , u32 ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * ) ;
...
position p;
@@
 union e1000_adv_tx_desc * cocci_id@p ;
...
typedef u32;
@@
 struct igb_reg_info {  u32 ofs ;  char * name ; } cocci_id@p ;
...
position p;
@@
 enum tx_queue_prio { TX_QUEUE_PRIO_HIGH , TX_QUEUE_PRIO_LOW , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ VFTA_BLOCK_SIZE ] ;
...
position p;
@@
 void cocci_id@p ( struct igb_q_vector * ) ;
...
position p;
@@
 void cocci_id@p ( struct igb_adapter * ) ;
...
position p;
@@
 struct igb_q_vector cocci_id@p ;
...
@@
 pci_ers_result_t cocci_id@p ( struct pci_dev * ) ;
...
position p;
@@
 union e1000_adv_rx_desc * cocci_id@p ;
...
typedef netdev_tx_t;
@@
 netdev_tx_t cocci_id@p ( struct sk_buff * skb , struct net_device * ) ;
...
position p;
@@
 int cocci_id@p ( struct igb_adapter * , int , unsigned char * ) ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * dev , int num_vfs ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct igb_adapter * adapter , u32 pba ) ;
...
position p;
@@
 const struct i2c_algo_bit_data cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct igb_adapter * adapter ) ;
...
position p;
@@
 union {  struct iphdr * v4 ;  struct ipv6hdr * v6 ;  unsigned char * hdr ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * , void * ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * , struct ifreq * , int cmd ) ;
...
position p;
@@
 int cocci_id@p ( struct device * dev ) ;
...
position p;
@@
 const struct igb_mac_addr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct igb_ring * ) ;
...
position p;
@@
 struct tc_etf_qopt_offload * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * , unsigned long , void * ) ;
...
typedef u8,u16;
@@
 int cocci_id@p ( struct net_device * netdev , int vf , u16 vlan , u8 qos , __be16 vlan_proto ) ;
...
position p;
@@
 struct e1000_adv_tx_context_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct igb_adapter * ) ;
...
typedef u64;
@@
 struct my_u0 {  u64 a ;  u64 b ; } * cocci_id@p ;
...
position p;
@@
 enum latency_range { lowest_latency = 0 , low_latency = 1 , bulk_latency = 2 , latency_invalid = 255 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * netdev , int vf , struct ifla_vf_info * ivi ) ;
...
position p;
@@
 struct igb_ring_container * cocci_id@p ;
...
position p;
@@
 struct tc_cbs_qopt_offload * cocci_id@p ;
