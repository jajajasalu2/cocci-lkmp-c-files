...
position p;
@@
 struct cfg80211_disassoc_request * cocci_id@p ;
...
position p;
@@
 struct ieee80211_he_cap_elem cocci_id@p ;
...
position p;
@@
 struct ieee80211_mgd_assoc_data * cocci_id@p ;
...
position p;
@@
 struct ieee80211_sta_tx_tspec * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_mu_edca_param_set * cocci_id@p ;
...
position p;
@@
 struct cfg80211_deauth_request cocci_id@p ;
...
position p;
@@
 const struct ieee802_11_elems * cocci_id@p ;
...
position p;
@@
 struct cfg80211_auth_request * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_bssid_index * cocci_id@p ;
...
position p;
@@
 struct ieee80211_p2p_noa_attr cocci_id@p ;
...
position p;
@@
 const struct sta_info * cocci_id@p ;
...
position p;
@@
 struct ieee80211_event cocci_id@p ;
...
position p;
@@
 const struct ieee80211_he_mcs_nss_supp * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_he_operation * cocci_id@p ;
...
position p;
@@
 enum ieee80211_sta_rx_bandwidth cocci_id@p ;
...
position p;
@@
 struct ieee80211_bss * cocci_id@p ;
...
position p;
@@
 struct ieee80211_mgd_auth_data * cocci_id@p ;
...
position p;
@@
 struct ieee80211_tx_queue_params cocci_id@p [ IEEE80211_NUM_ACS ] ;
...
position p;
@@
 struct ieee80211_he_mcs_nss_supp cocci_id@p ;
...
position p;
@@
 struct ieee80211_csa_ie cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IEEE80211_DEAUTH_FRAME_LEN ] ;
