...
position p;
@@
 struct xresource cocci_id@p [ XNRES ] ;
...
position p;
@@
 void cocci_id@p ( struct resource * res ) ;
...
position p;
@@
 struct xresource {  struct resource xres ;  int xflag ;  char xname [ XNMLN + 1 ] ; } cocci_id@p ;
