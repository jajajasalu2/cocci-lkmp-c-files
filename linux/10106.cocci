...
position p;
@@
 struct i2400m_reset_ctx {  struct completion completion ;  int result ; } cocci_id@p ;
...
position p;
@@
 enum i2400m_reset_type cocci_id@p ;
...
position p;
@@
 const struct genl_info * cocci_id@p ;
...
position p;
@@
 struct i2400m_reset_ctx * cocci_id@p ;
