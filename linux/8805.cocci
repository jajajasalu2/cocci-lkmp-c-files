...
position p;
@@
 struct nv_txrx_stats cocci_id@p ;
...
position p;
@@
 const struct nv_ethtool_str cocci_id@p [ ] ;
...
position p;
@@
 struct ring_desc_ex * cocci_id@p ;
...
position p;
@@
 enum { NV_DMA_64BIT_DISABLED , NV_DMA_64BIT_ENABLED , } cocci_id@p ;
...
position p;
@@
 union ring_type {  struct ring_desc * orig ;  struct ring_desc_ex * ex ; } cocci_id@p ;
...
position p;
@@
 const struct register_test cocci_id@p [ ] ;
...
typedef __le32;
@@
 struct ring_desc {  __le32 buf ;  __le32 flaglen ; } cocci_id@p ;
...
position p;
@@
 enum { NV_MSIX_INT_DISABLED , NV_MSIX_INT_ENABLED , } cocci_id@p ;
...
position p;
@@
 const struct {  int reg ;  int init ; } cocci_id@p [ ] ;
...
typedef u64;
@@
 struct nv_txrx_stats {  u64 stat_rx_packets ;  u64 stat_rx_bytes ;  u64 stat_rx_missed_errors ;  u64 stat_rx_dropped ;  u64 stat_tx_packets ;  u64 stat_tx_bytes ;  u64 stat_tx_dropped ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct nv_skb_map {  struct sk_buff * skb ;  dma_addr_t dma ;  unsigned int dma_len : 31 ;  unsigned int dma_single : 1 ;  struct ring_desc_ex * first_tx_desc ;  struct nv_skb_map * next_tx_ctx ; } cocci_id@p ;
...
position p;
@@
 enum { NV_CROSSOVER_DETECTION_DISABLED , NV_CROSSOVER_DETECTION_ENABLED , } cocci_id@p ;
...
typedef __u32;
@@
 struct register_test {  __u32 reg ;  __u32 mask ; } cocci_id@p ;
...
typedef __le32;
@@
 struct ring_desc_ex {  __le32 bufhigh ;  __le32 buflow ;  __le32 txvlan ;  __le32 flaglen ; } cocci_id@p ;
...
position p;
@@
 struct nv_ethtool_str cocci_id@p ;
...
position p;
@@
 struct nv_ethtool_stats cocci_id@p ;
...
position p;
@@
 enum { NV_MSI_INT_DISABLED , NV_MSI_INT_ENABLED , } cocci_id@p ;
...
position p;
@@
 struct nv_ethtool_str {  char name [ ETH_GSTRING_LEN ] ; } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ BACKOFF_SEEDSET_ROWS ] [ BACKOFF_SEEDSET_LFSRS ] ;
...
typedef irqreturn_t;
@@
 irqreturn_t ( * cocci_id@p ) ( int foo , void * data ) ;
...
position p;
@@
 enum { NV_OPTIMIZATION_MODE_THROUGHPUT , NV_OPTIMIZATION_MODE_CPU , NV_OPTIMIZATION_MODE_DYNAMIC , } cocci_id@p ;
