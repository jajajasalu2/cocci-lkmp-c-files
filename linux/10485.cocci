...
@@
 struct radeon_tv_mode_constants {  uint16_t hor_resolution ;  uint16_t ver_resolution ;  enum radeon_tv_std standard ;  uint16_t hor_total ;  uint16_t ver_total ;  uint16_t hor_start ;  uint16_t hor_syncstart ;  uint16_t ver_syncstart ;  unsigned def_restart ;  uint16_t crtcPLL_N ;  uint8_t crtcPLL_M ;  uint8_t crtcPLL_post_div ;  unsigned pix_to_tv ; } cocci_id@p ;
...
typedef uint16_t;
@@
 const uint16_t cocci_id@p [ MAX_V_CODE_TIMING_LEN ] ;
...
typedef uint16_t;
@@
 const uint16_t cocci_id@p [ MAX_H_CODE_TIMING_LEN ] ;
...
position p;
@@
 const struct radeon_tv_mode_constants cocci_id@p [ ] ;
