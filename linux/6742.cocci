...
symbol cocci_id;
position p;
typedef opcode_info_t;
@@
 const struct opcode_info_t cocci_id@p [ SDEB_I_LAST_ELEMENT + 1 ] ;
...
@@
 struct sdebug_queue {  struct sdebug_queued_cmd qc_arr [ SDEBUG_CANQUEUE ] ;  unsigned long in_use_bm [ SDEBUG_CANQUEUE_WORDS ] ;  spinlock_t qc_lock ;  atomic_t blocked ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,defer_t;
@@
 struct sdebug_defer {  struct hrtimer hrt ;  struct execute_work ew ;  int sqa_idx ;  int qc_idx ;  int issuing_cpu ;  bool init_hrt ;  bool init_wq ;  bool aborted ;  enum sdeb_defer_type defer_t ; } cocci_id@p ;
...
position p;
@@
 struct scsi_data_buffer * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ SDEBUG_MAX_LSENSE_SZ ] ;
...
position p;
@@
 struct sdebug_defer * cocci_id@p ;
...
position p;
@@
 struct sdebug_host_info cocci_id@p ;
...
typedef opcode_info_t;
@@
 const struct opcode_info_t cocci_id@p [ ] ;
...
position p;
@@
 struct t10_pi_tuple * cocci_id@p ;
...
@@
 struct unmap_block_desc {  __be64 lba ;  __be32 blocks ;  __be32 __reserved ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct scsi_cmnd * , struct sdebug_dev_info * ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ SDEBUG_GET_LBA_STATUS_LEN ] ;
...
position p;
@@
 unsigned char cocci_id@p [ SDEBUG_READCAP16_ARR_SZ ] ;
...
position p;
@@
 unsigned char cocci_id@p [ SDEBUG_READCAP_ARR_SZ ] ;
...
position p;
@@
 char cocci_id@p [ SDEBUG_INFO_LEN ] ;
...
position p;
@@
 unsigned char cocci_id@p [ SCSI_SENSE_BUFFERSIZE ] ;
...
position p;
@@
 enum sdeb_defer_type cocci_id@p ;
...
position p;
@@
 struct sdebug_queue * cocci_id@p ;
...
position p;
@@
 enum sdeb_cmd_data { SDEB_IN_DATA = 0 , SDEB_IN_CDB = 1 , } cocci_id@p ;
...
position p;
@@
 struct sdebug_host_info {  struct list_head host_list ;  struct Scsi_Host * shost ;  struct device dev ;  struct list_head dev_info_list ; } cocci_id@p ;
...
position p;
@@
 const unsigned char cocci_id@p [ 256 ] ;
...
position p;
@@
 struct sdebug_queued_cmd {  struct sdebug_defer * sd_dp ;  struct scsi_cmnd * a_cmnd ;  unsigned int inj_recovered : 1 ;  unsigned int inj_transport : 1 ;  unsigned int inj_dif : 1 ;  unsigned int inj_dix : 1 ;  unsigned int inj_short : 1 ;  unsigned int inj_host_busy : 1 ;  unsigned int inj_cmd_abort : 1 ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RL_BUCKET_ELEMS * sizeof ( struct scsi_lun ) ] ;
...
position p;
@@
 enum sdeb_defer_type { SDEB_DEFER_NONE = 0 , SDEB_DEFER_HRT = 1 , SDEB_DEFER_WQ = 2 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ SDEBUG_MAX_PARTS + 2 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ SDEBUG_MAX_MSELECT_SZ ] ;
...
position p;
@@
 struct unmap_block_desc * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ SDEBUG_MAX_MSENSE_SZ ] ;
...
position p;
@@
 struct sdebug_queued_cmd * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,atomic_t,uuid_t;
@@
 struct sdebug_dev_info {  struct list_head dev_list ;  unsigned int channel ;  unsigned int target ;  u64 lun ;  uuid_t lu_name ;  struct sdebug_host_info * sdbg_host ;  unsigned long uas_bm [ 1 ] ;  atomic_t num_in_q ;  atomic_t stopped ;  bool used ; } cocci_id@p ;
...
position p;
@@
 struct sdebug_dev_info * cocci_id@p ;
