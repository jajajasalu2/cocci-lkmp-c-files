...
@@
 struct clk_generated {  struct clk_hw hw ;  struct regmap * regmap ;  struct clk_range range ;  spinlock_t * lock ;  u32 id ;  u32 gckdiv ;  const struct clk_pcr_layout * layout ;  u8 parent_id ;  bool audio_pll_allowed ; } cocci_id@p ;
...
position p;
@@
 struct clk_generated * cocci_id@p ;
