...
typedef u16;
@@
 u16 cocci_id@p [ VXGE_HW_MAX_VIRTUAL_PATHS ] ;
...
position p;
@@
 struct vxge_mac_addrs * cocci_id@p ;
...
position p;
@@
 enum vxge_hw_vpath_mac_addr_add_mode cocci_id@p ;
...
position p;
@@
 struct vxge_drv_config * cocci_id@p ;
...
position p;
@@
 struct vxge_tx_priv * cocci_id@p ;
...
position p;
@@
 struct vxge_hw_ring_rxd_info cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ VXGE_HW_MAX_VIRTUAL_PATHS ] ;
...
position p;
@@
 const struct vxge_hw_uld_cbs cocci_id@p ;
...
position p;
@@
 enum vxge_hw_status cocci_id@p ( struct vxgedev * vdev ) ;
...
position p;
@@
 enum vxge_hw_fifo_tcode cocci_id@p ;
...
position p;
@@
 struct vxge_fifo_stats * cocci_id@p ;
...
position p;
@@
 struct vxge_ring_stats * cocci_id@p ;
...
position p;
@@
 struct vxge_rx_priv cocci_id@p ;
...
position p;
@@
 struct vxge_msix_entry cocci_id@p ;
...
position p;
@@
 enum vxge_hw_rxd_state cocci_id@p ;
...
position p;
@@
 struct sk_buff * cocci_id@p [ NR_SKB_COMPLETED ] ;
...
position p;
@@
 enum vxge_hw_txdl_state cocci_id@p ;
...
position p;
@@
 struct eprom_image cocci_id@p [ VXGE_HW_MAX_ROM_IMAGES ] ;
