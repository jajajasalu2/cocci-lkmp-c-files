...
position p;
@@
 struct il_calib_diff_gain_cmd cocci_id@p ;
...
position p;
@@
 struct il_eeprom_calib_ch_info * cocci_id@p ;
...
position p;
@@
 struct il_eeprom_calib_info * cocci_id@p ;
...
position p;
@@
 struct il4965_addsta_cmd * cocci_id@p ;
...
position p;
@@
 struct il_chain_noise_data * cocci_id@p ;
...
position p;
@@
 struct il4965_txpowertable_cmd cocci_id@p ;
...
position p;
@@
 struct il4965_rxon_assoc_cmd cocci_id@p ;
...
position p;
@@
 const struct gain_entry cocci_id@p [ 2 ] [ 108 ] ;
...
position p;
@@
 struct il4965_channel_switch_cmd cocci_id@p ;
...
position p;
@@
 const struct il_eeprom_calib_measure * cocci_id@p ;
...
typedef s32;
@@
 struct il4965_txpower_comp_entry {  s32 degrees_per_05db_a ;  s32 degrees_per_05db_a_denom ; } cocci_id@p [ CALIB_CH_GROUP_MAX ] ;
...
position p;
@@
 struct il_eeprom_calib_measure * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct il_priv * il ) ;
...
position p;
@@
 struct il4965_rxon_cmd cocci_id@p ;
...
position p;
@@
 union il4965_tx_power_dual_stream cocci_id@p ;
...
typedef u8;
@@
 struct gain_entry {  u8 dsp ;  u8 radio ; } cocci_id@p ;
...
position p;
@@
 struct il4965_tx_power_db * cocci_id@p ;
