...
position p;
@@
 struct readdir_data cocci_id@p ;
...
typedef u32;
@@
 struct accessmap {  u32 access ;  int how ; } cocci_id@p ;
...
position p;
@@
 struct buffered_dirent cocci_id@p ;
...
symbol cocci_id;
position p;
typedef nfsd_filldir_t;
@@
 nfsd_filldir_t cocci_id@p ;
...
position p;
@@
 struct readdir_data {  struct dir_context ctx ;  char * dirent ;  size_t used ;  int full ; } cocci_id@p ;
...
typedef u64,loff_t;
@@
 struct buffered_dirent {  u64 ino ;  loff_t offset ;  int namlen ;  unsigned int d_type ;  char name [ ] ; } cocci_id@p ;
