...
typedef bool;
@@
 struct dwxgmac3_error_desc {  bool valid ;  const char * desc ;  const char * detailed_desc ; } cocci_id@p ;
...
position p;
@@
 struct stmmac_safety_stats * cocci_id@p ;
...
position p;
@@
 const struct dwxgmac3_error_desc * cocci_id@p ;
...
position p;
@@
 struct stmmac_pps_cfg * cocci_id@p ;
...
position p;
@@
 struct stmmac_tc_entry * cocci_id@p ;
...
position p;
@@
 const struct dwxgmac3_error {  const struct dwxgmac3_error_desc * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct dwxgmac3_error_desc cocci_id@p [ 32 ] ;
