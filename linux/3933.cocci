...
typedef spinlock_t;
@@
 struct meson_reset {  void __iomem * reg_base ;  const struct meson_reset_param * param ;  struct reset_controller_dev rcdev ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 const struct meson_reset_param cocci_id@p ;
...
position p;
@@
 struct meson_reset_param {  int reg_count ;  int level_offset ; } cocci_id@p ;
