...
position p;
@@
 struct ssfdcr_record cocci_id@p ;
...
position p;
@@
 struct ssfdcr_record {  struct mtd_blktrans_dev mbd ;  int usecount ;  unsigned char heads ;  unsigned char sectors ;  unsigned short cylinders ;  int cis_block ;  int erase_size ;  unsigned short * logic_block_map ;  int map_len ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned long size ;  unsigned short cyl ;  unsigned char head ;  unsigned char sec ; } cocci_id@p ;
