...
position p;
@@
 struct bnxt_qplib_crsq * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct bnxt_qplib_rcfw * , void * , void * ) ;
...
position p;
@@
 struct bnxt_qplib_qp_node cocci_id@p ;
...
position p;
@@
 struct bnxt_qplib_cmdqe * cocci_id@p ;
...
position p;
@@
 struct creq_deinitialize_fw_resp cocci_id@p ;
...
position p;
@@
 struct cmdq_initialize_fw cocci_id@p ;
...
position p;
@@
 struct cmdq_deinitialize_fw cocci_id@p ;
...
position p;
@@
 struct creq_initialize_fw_resp cocci_id@p ;
...
position p;
@@
 struct creq_qp_error_notification * cocci_id@p ;
