...
typedef u32;
@@
 u32 cocci_id@p [ ATH10K_SDIO_MAX_RX_MSGS ] ;
...
position p;
@@
 struct ath10k_sdio_irq_data * cocci_id@p ;
...
position p;
@@
 struct ath10k_sdio_bus_request * cocci_id@p ;
...
position p;
@@
 struct ath10k_sdio_irq_enable_regs * cocci_id@p ;
...
position p;
@@
 struct ath10k_sdio_irq_proc_regs cocci_id@p ;
...
position p;
@@
 struct ath10k_sdio_rx_data * cocci_id@p ;
...
position p;
@@
 struct ath10k_mbox_info * cocci_id@p ;
