...
position p;
@@
 enum { TLSV4 , TLSV6 , TLS_NUM_PROTS , } cocci_id@p ;
...
position p;
@@
 union tls_crypto_context cocci_id@p ;
...
position p;
@@
 struct proto cocci_id@p [ TLS_NUM_PROTS ] [ TLS_NUM_CONFIG ] [ TLS_NUM_CONFIG ] ;
...
position p;
@@
 struct linux_tls_mib cocci_id@p ;
...
position p;
@@
 struct proto cocci_id@p [ TLS_NUM_CONFIG ] [ TLS_NUM_CONFIG ] ;
...
position p;
@@
 void cocci_id@p ( struct proto prot [ TLS_NUM_CONFIG ] [ TLS_NUM_CONFIG ] , struct proto * base ) ;
