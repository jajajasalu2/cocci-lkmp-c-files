...
position p;
@@
 struct rx51_device_info * cocci_id@p ;
...
position p;
@@
 struct rx51_device_info {  struct device * dev ;  struct power_supply * bat ;  struct power_supply_desc bat_desc ;  struct iio_channel * channel_temp ;  struct iio_channel * channel_bsi ;  struct iio_channel * channel_vbat ; } cocci_id@p ;
