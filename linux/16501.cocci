...
position p;
@@
 struct kone_roccat_report cocci_id@p ;
...
position p;
@@
 struct kone_settings cocci_id@p ;
...
position p;
@@
 struct kone_mouse_event * cocci_id@p ;
...
position p;
@@
 const struct kone_profile * cocci_id@p ;
...
position p;
@@
 struct kone_profile * cocci_id@p ;
...
position p;
@@
 const struct kone_device * cocci_id@p ;
...
position p;
@@
 const struct kone_settings * cocci_id@p ;
...
position p;
@@
 const struct kone_mouse_event * cocci_id@p ;
