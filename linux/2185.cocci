...
position p;
@@
 struct ds2781_device_info * cocci_id@p ;
...
position p;
@@
 enum current_types { CURRENT_NOW , CURRENT_AVG , } cocci_id@p ;
...
position p;
@@
 struct ds2781_device_info {  struct device * dev ;  struct power_supply * bat ;  struct power_supply_desc bat_desc ;  struct device * w1_dev ; } cocci_id@p ;
