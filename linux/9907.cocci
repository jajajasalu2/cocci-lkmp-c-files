...
position p;
@@
 struct ath_mci_profile_info cocci_id@p ;
...
position p;
@@
 struct ath_mci_coex * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ATH_BTCOEX_STOMP_MAX ] ;
...
position p;
@@
 struct ath_mci_profile_status * cocci_id@p ;
...
position p;
@@
 struct ath_mci_profile * cocci_id@p ;
