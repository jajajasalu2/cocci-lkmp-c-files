...
position p;
@@
 struct usb4604 {  enum usb4604_mode mode ;  struct device * dev ;  struct gpio_desc * gpio_reset ; } cocci_id@p ;
...
position p;
@@
 enum usb4604_mode { USB4604_MODE_UNKNOWN , USB4604_MODE_HUB , USB4604_MODE_STANDBY , } cocci_id@p ;
