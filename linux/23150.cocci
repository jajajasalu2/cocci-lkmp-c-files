...
position p;
@@
 struct axg_spdifin_cfg {  const unsigned int * mode_rates ;  unsigned int ref_rate ; } cocci_id@p ;
...
position p;
@@
 struct axg_spdifin {  const struct axg_spdifin_cfg * conf ;  struct regmap * map ;  struct clk * refclk ;  struct clk * pclk ; } cocci_id@p ;
...
position p;
@@
 const struct axg_spdifin_cfg cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ SPDIFIN_MODE_NUM ] ;
