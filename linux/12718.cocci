...
position p;
@@
 struct eisa_device_info {  struct eisa_device_id id ;  char name [ 50 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ EISA_MAX_FORCED_DEV ] ;
...
position p;
@@
 struct eisa_root_device * cocci_id@p ;
...
position p;
@@
 struct eisa_device_info cocci_id@p ;
