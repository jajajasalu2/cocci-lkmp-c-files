...
position p;
@@
 enum { MLX4_IRQNAME_SIZE = 32 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_slave_event_eq * cocci_id@p ;
...
position p;
@@
 struct mlx4_eq_table * cocci_id@p ;
...
position p;
@@
 enum { MLX4_NUM_ASYNC_EQE = 0x100 , MLX4_NUM_SPARE_EQE = 0x80 , MLX4_EQ_ENTRY_SIZE = 0x20 , } cocci_id@p ;
