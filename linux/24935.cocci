...
position p;
@@
 struct tipc_media_addr * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct tipc_crypto * c , u8 new_passive , u8 new_active , u8 new_pending ) ;
...
position p;
@@
 struct crypto_aead * cocci_id@p ( struct tipc_aead * aead ) ;
...
position p;
@@
 int cocci_id@p ( struct tipc_aead * aead , struct sk_buff * skb , struct tipc_bearer * b , struct tipc_media_addr * dst , struct tipc_node * __dnode ) ;
...
position p;
@@
 char * cocci_id@p ( struct tipc_key old , struct tipc_key new , char * buf ) ;
...
position p;
@@
 int cocci_id@p ( struct tipc_aead * * dst , struct tipc_aead * src ) ;
...
typedef u8;
@@
 void * cocci_id@p ( struct crypto_aead * tfm , unsigned int crypto_ctx_size , u8 * * iv , struct aead_request * * req , struct scatterlist * * sg , int nsg ) ;
...
position p;
@@
 struct tipc_crypto_tx_ctx {  struct tipc_aead * aead ;  struct tipc_bearer * bearer ;  struct tipc_media_addr dst ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rcu_head * rp ) ;
...
position p;
@@
 struct tipc_aead_key * cocci_id@p ;
...
position p;
@@
 struct tipc_aead * cocci_id@p ( struct tipc_crypto * tx , struct tipc_crypto * rx , struct sk_buff * skb ) ;
...
position p;
@@
 void cocci_id@p ( struct tipc_aead __rcu * aead , int lim ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct tipc_aead * * aead , struct tipc_aead_key * ukey , u8 mode ) ;
...
position p;
@@
 void cocci_id@p ( struct net * net , int cmd ) ;
...
position p;
@@
 struct tipc_crypto_stats cocci_id@p ;
...
position p;
@@
 char * cocci_id@p ( struct tipc_crypto * c , char * buf ) ;
...
position p;
@@
 const char * cocci_id@p [ MAX_STATS ] ;
...
position p;
@@
 void cocci_id@p ( struct tipc_aead __rcu * aead , int val ) ;
...
position p;
@@
 void cocci_id@p ( struct tipc_aead * aead ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct tipc_crypto * rx , u8 new_rx_active , struct tipc_msg * hdr ) ;
...
position p;
@@
 struct tipc_aead * cocci_id@p ( struct tipc_aead __rcu * aead ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct net * net , u8 tx_key ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct tipc_crypto * c , struct tipc_aead * aead , u8 pos ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct net * net , struct tipc_aead * aead , u8 tx_key , struct sk_buff * skb , struct tipc_crypto * __rx ) ;
...
position p;
@@
 int cocci_id@p ( struct tipc_aead __rcu * aead ) ;
...
position p;
@@
 int cocci_id@p ( struct tipc_ehdr * ehdr ) ;
...
position p;
@@
 struct tipc_crypto_tx_ctx * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct crypto_async_request * base , int err ) ;
...
position p;
@@
 void cocci_id@p ( struct net * net , struct tipc_aead * aead , struct tipc_bearer * b , struct sk_buff * * skb , int err ) ;
...
typedef u8,bool;
@@
 bool cocci_id@p ( struct tipc_crypto * rx , u8 new_pending ) ;
...
position p;
@@
 enum { KEY_UNUSED = 0 , KEY_MIN , KEY_1 = KEY_MIN , KEY_2 , KEY_3 , KEY_MAX = KEY_3 , } cocci_id@p ;
...
position p;
@@
 struct tipc_tfm {  struct crypto_aead * tfm ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net * net , struct tipc_aead * aead , struct sk_buff * skb , struct tipc_bearer * b ) ;
...
position p;
@@
 struct tipc_crypto_rx_ctx {  struct tipc_aead * aead ;  struct tipc_bearer * bearer ; } cocci_id@p ;
...
position p;
@@
 enum { STAT_OK , STAT_NOK , STAT_ASYNC , STAT_ASYNC_OK , STAT_ASYNC_NOK , STAT_BADKEYS , STAT_BADMSGS = STAT_BADKEYS , STAT_NOKEYS , STAT_SWITCHES , MAX_STATS , } cocci_id@p ;
...
position p;
@@
 struct tipc_crypto_rx_ctx * cocci_id@p ;
...
position p;
@@
 struct tipc_crypto_stats {  unsigned int stat [ MAX_STATS ] ; } cocci_id@p ;
