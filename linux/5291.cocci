...
typedef bool;
@@
 bool cocci_id@p ( struct pci_dev * pdev ) ;
...
position p;
@@
 enum board_ids { board_ahci , board_ahci_ign_iferr , board_ahci_mobile , board_ahci_nomsi , board_ahci_noncq , board_ahci_nosntf , board_ahci_yes_fbs , board_ahci_al , board_ahci_avn , board_ahci_mcp65 , board_ahci_mcp77 , board_ahci_mcp89 , board_ahci_mv , board_ahci_sb600 , board_ahci_sb700 , board_ahci_vt8251 , board_ahci_pcs7 , board_ahci_mcp_linux = board_ahci_mcp65 , board_ahci_mcp67 = board_ahci_mcp65 , board_ahci_mcp73 = board_ahci_mcp65 , board_ahci_mcp79 = board_ahci_mcp77 , } cocci_id@p ;
...
position p;
@@
 enum { AHCI_PCI_BAR_STA2X11 = 0 , AHCI_PCI_BAR_CAVIUM = 0 , AHCI_PCI_BAR_ENMOTUS = 2 , AHCI_PCI_BAR_CAVIUM_GEN5 = 4 , AHCI_PCI_BAR_STANDARD = 5 , } cocci_id@p ;
