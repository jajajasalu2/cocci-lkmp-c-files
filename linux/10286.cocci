...
position p;
@@
 struct rk3066_hdmi_i2c * cocci_id@p ;
...
typedef u8;
@@
 struct rk3066_hdmi_i2c {  struct i2c_adapter adap ;  u8 ddc_addr ;  u8 segment_addr ;  u8 stat ;  struct mutex i2c_lock ;  struct completion cmpltn ; } cocci_id@p ;
...
typedef bool;
@@
 struct hdmi_data_info {  int vic ;  bool sink_is_hdmi ;  unsigned int enc_out_format ;  unsigned int colorimetry ; } cocci_id@p ;
