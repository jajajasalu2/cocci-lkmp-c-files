...
position p;
@@
 const struct fimc_drvdata cocci_id@p ;
...
position p;
@@
 const struct fimc_pix_limit cocci_id@p [ 4 ] ;
...
position p;
@@
 char * cocci_id@p [ MAX_FIMC_CLOCKS ] ;
...
position p;
@@
 struct fimc_variant * cocci_id@p ;
...
position p;
@@
 struct fimc_pix_limit * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ FIMC_PIX_LIMITS_MAX ] ;
