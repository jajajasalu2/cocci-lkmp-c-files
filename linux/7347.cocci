...
position p;
@@
 void cocci_id@p ( struct xenfb_info * , struct fb_info * ) ;
...
position p;
@@
 enum { KPARAM_MEM , KPARAM_WIDTH , KPARAM_HEIGHT , KPARAM_CNT , } cocci_id@p ;
...
position p;
@@
 union xenfb_out_event * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xenfb_info * ) ;
...
position p;
@@
 int cocci_id@p ( struct xenbus_device * , struct xenfb_info * ) ;
