...
position p;
@@
 enum ht_rssi_type { HT_RSSI_W1 = 0 , HT_RSSI_W2 = 1 , HT_RSSI_NB = 2 , HT_RSSI_IQ = 3 , HT_RSSI_TSSI_2G = 4 , HT_RSSI_TSSI_5G = 5 , HT_RSSI_TBD = 6 , } cocci_id@p ;
...
position p;
@@
 const struct b43_phy_ht_channeltab_e_phy * cocci_id@p ;
...
position p;
@@
 const struct b43_phy_ht_channeltab_e_radio2059 * cocci_id@p ;
