...
typedef u32;
@@
 struct rt_sigframe_n32 {  u32 rs_ass [ 4 ] ;  u32 rs_pad [ 2 ] ;  struct compat_siginfo rs_info ;  struct ucontextn32 rs_uc ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,s32,compat_stack_t,compat_sigset_t;
@@
 struct ucontextn32 {  u32 uc_flags ;  s32 uc_link ;  compat_stack_t uc_stack ;  struct sigcontext uc_mcontext ;  compat_sigset_t uc_sigmask ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pt_regs * , struct sigcontext __user * ) ;
