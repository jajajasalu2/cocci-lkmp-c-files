...
position p;
@@
 const struct mtk_iommu_plat_data cocci_id@p ;
...
position p;
@@
 struct mtk_iommu_domain {  struct io_pgtable_cfg cfg ;  struct io_pgtable_ops * iop ;  struct iommu_domain domain ; } cocci_id@p ;
