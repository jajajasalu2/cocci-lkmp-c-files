...
position p;
@@
 const struct si21xx_config * cocci_id@p ;
...
position p;
@@
 enum { BYTE_WIDE , BIT_WIDE , } cocci_id@p ;
...
position p;
@@
 struct si21xx_state cocci_id@p ;
...
position p;
@@
 enum { ACTIVE_HIGH , ACTIVE_LOW , } cocci_id@p ;
...
typedef u8;
@@
 struct si21xx_state {  struct i2c_adapter * i2c ;  const struct si21xx_config * config ;  struct dvb_frontend frontend ;  u8 initialised : 1 ;  int errmode ;  int fs ; } cocci_id@p ;
...
position p;
@@
 enum { SERIAL , PARALLEL , } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ ALLOWABLE_FS_COUNT ] ;
...
position p;
@@
 enum { CLK_GAPPED_MODE , CLK_CONTINUOUS_MODE , } cocci_id@p ;
...
position p;
@@
 enum { RISING_EDGE , FALLING_EDGE , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ ALLOWABLE_FS_COUNT ] ;
...
position p;
@@
 enum { MSB_FIRST , LSB_FIRST , } cocci_id@p ;
