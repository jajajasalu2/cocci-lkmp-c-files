...
@@
 struct pci_io_addr_range {  struct rb_node rb_node ;  resource_size_t addr_lo ;  resource_size_t addr_hi ;  struct eeh_dev * edev ;  struct pci_dev * pcidev ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 struct pci_io_addr_cache * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct pci_io_addr_cache {  struct rb_root rb_root ;  spinlock_t piar_lock ; } cocci_id@p ;
...
position p;
@@
 struct pci_io_addr_range cocci_id@p ;
