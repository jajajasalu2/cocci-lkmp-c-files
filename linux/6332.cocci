...
position p;
@@
 struct twl4030_audio cocci_id@p ;
...
position p;
@@
 enum twl4030_audio_res cocci_id@p ;
...
position p;
@@
 struct twl4030_audio {  unsigned int audio_mclk ;  struct mutex mutex ;  struct twl4030_audio_resource resource [ TWL4030_AUDIO_RES_MAX ] ;  struct mfd_cell cells [ TWL4030_AUDIO_CELLS ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct twl4030_audio_resource {  int request_count ;  u8 reg ;  u8 mask ; } cocci_id@p ;
...
position p;
@@
 struct twl4030_audio_data * cocci_id@p ;
