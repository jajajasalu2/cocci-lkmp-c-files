...
position p;
@@
 struct phy_g12a_usb3_pcie_priv * cocci_id@p ;
...
position p;
@@
 struct phy_g12a_usb3_pcie_priv {  struct regmap * regmap ;  struct regmap * regmap_cr ;  struct clk * clk_ref ;  struct reset_control * reset ;  struct phy * phy ;  unsigned int mode ; } cocci_id@p ;
