...
position p;
@@
 struct radeon_encoder_lvds * cocci_id@p ;
...
position p;
@@
 struct radeon_atif_functions * cocci_id@p ;
...
position p;
@@
 struct radeon_atif_notification_cfg * cocci_id@p ;
...
position p;
@@
 struct radeon_atif_notifications * cocci_id@p ;
...
position p;
@@
 struct radeon_atcs_functions * cocci_id@p ;
