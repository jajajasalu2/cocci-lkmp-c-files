...
symbol cocci_id;
position p;
typedef bool,u32,__u32;
@@
 struct mcam_format_struct {  __u32 pixelformat ;  int bpp ;  bool planar ;  u32 mbus_code ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct mcam_dma_desc {  u32 dma_addr ;  u32 segment_len ; } cocci_id@p ;
...
position p;
@@
 struct mcam_vb_buffer cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct mcam_vb_buffer {  struct vb2_v4l2_buffer vb_buf ;  struct list_head queue ;  struct mcam_dma_desc * dma_desc ;  dma_addr_t dma_desc_pa ; } cocci_id@p ;
...
position p;
@@
 struct mcam_format_struct * cocci_id@p ;
...
position p;
@@
 struct mcam_dma_desc cocci_id@p ;
