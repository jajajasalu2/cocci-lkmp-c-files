...
position p;
@@
 struct ps3_system_bus_driver cocci_id@p ;
...
position p;
@@
 struct ps3disk_private * cocci_id@p ;
...
@@
 struct lv1_ata_cmnd_block {  u16 features ;  u16 sector_count ;  u16 LBA_low ;  u16 LBA_mid ;  u16 LBA_high ;  u8 device ;  u8 command ;  u32 is_ext ;  u32 proto ;  u32 in_out ;  u32 size ;  u64 buffer ;  u32 arglen ; } cocci_id@p ;
...
position p;
@@
 enum lv1_ata_in_out { DIR_WRITE = 0 , DIR_READ = 1 , } cocci_id@p ;
...
position p;
@@
 enum lv1_ata_proto { NON_DATA_PROTO = 0 , PIO_DATA_IN_PROTO = 1 , PIO_DATA_OUT_PROTO = 2 , DMA_PROTO = 3 , } cocci_id@p ;
...
position p;
@@
 struct lv1_ata_cmnd_block cocci_id@p ;
...
@@
 struct ps3disk_private {  spinlock_t lock ;  struct request_queue * queue ;  struct blk_mq_tag_set tag_set ;  struct gendisk * gendisk ;  unsigned int blocking_factor ;  struct request * req ;  u64 raw_capacity ;  unsigned char model [ ATA_ID_PROD_LEN + 1 ] ; } cocci_id@p ;
