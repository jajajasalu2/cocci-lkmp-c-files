...
typedef u8,u16;
@@
 struct wep_key {  u16 len ;  u8 key [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ RSN_IE_BODY_MAX * 2 + 30 ] ;
...
position p;
@@
 struct iw_quality cocci_id@p [ LOCAL_APLIST_MAX ] ;
