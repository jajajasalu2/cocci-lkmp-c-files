...
position p;
@@
 struct rts51x_status * cocci_id@p ;
...
position p;
@@
 enum RTS51X_STAT { RTS51X_STAT_INIT , RTS51X_STAT_IDLE , RTS51X_STAT_RUN , RTS51X_STAT_SS , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct rts51x_status {  u16 vid ;  u16 pid ;  u8 cur_lun ;  u8 card_type ;  u8 total_lun ;  u16 fw_ver ;  u8 phy_exist ;  u8 multi_flag ;  u8 multi_card ;  u8 log_exist ;  union {  u8 detailed_type1 ;  u8 detailed_type2 ; } detailed_type ;  u8 function [ 2 ] ; } cocci_id@p ;
