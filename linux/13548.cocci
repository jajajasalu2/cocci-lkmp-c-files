...
position p;
@@
 const struct uvc_control_mapping * cocci_id@p ;
...
position p;
@@
 struct uvc_ctrl_work * cocci_id@p ;
...
typedef u8;
@@
 struct uvc_ctrl_fixup {  struct usb_device_id id ;  u8 entity ;  u8 selector ;  u8 flags ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct uvc_device * dev , struct uvc_control * ctrl , const struct uvc_control_info * info ) ;
...
position p;
@@
 const struct uvc_menu_info * cocci_id@p ;
...
position p;
@@
 const struct uvc_control_info cocci_id@p [ ] ;
...
position p;
@@
 const struct uvc_ctrl_blacklist * cocci_id@p ;
...
position p;
@@
 const struct uvc_control * cocci_id@p ;
...
position p;
@@
 const struct uvc_ctrl_fixup cocci_id@p [ ] ;
...
position p;
@@
 struct uvc_control_info * cocci_id@p ;
...
typedef u8;
@@
 struct uvc_ctrl_blacklist {  struct usb_device_id id ;  u8 index ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_ext_control * cocci_id@p ;
