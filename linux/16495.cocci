...
position p;
@@
 const struct apple_key_translation cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct apple_key_translation {  u16 from ;  u16 to ;  u8 flags ; } cocci_id@p ;
...
position p;
@@
 struct apple_sc {  unsigned long quirks ;  unsigned int fn_on ; 
