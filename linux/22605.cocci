...
position p;
@@
 enum pcxhr_async_err_src { PCXHR_ERR_PIPE , PCXHR_ERR_STREAM , PCXHR_ERR_AUDIO , } cocci_id@p ;
...
position p;
@@
 struct pcxhr_cmd_info cocci_id@p [ ] ;
...
position p;
@@
 enum { RMH_SSIZE_FIXED = 0 , RMH_SSIZE_ARG = 1 , RMH_SSIZE_MASK = 2 , } cocci_id@p ;
...
typedef u32,u16;
@@
 struct pcxhr_cmd_info {  u32 opcode ;  u16 st_length ;  u16 st_type ; } cocci_id@p ;
...
position p;
@@
 enum pcxhr_async_err_src cocci_id@p ;
