...
position p;
@@
 struct wm8962_pdata * cocci_id@p ;
...
typedef u16;
@@
 struct _fll_div {  u16 fll_fratio ;  u16 fll_outdiv ;  u16 fll_refclk_div ;  u16 n ;  u16 theta ;  u16 lambda ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8962_NUM_SUPPLIES ] ;
...
position p;
@@
 const struct {  int rate ;  int reg ; } cocci_id@p [ ] ;
