...
typedef u32;
@@
 struct sx8 {  struct mci mci ;  int first_time_lock ;  int started ;  struct mci_result signal_info ;  u32 bb_mode ;  u32 local_frequency ; } cocci_id@p ;
...
position p;
@@
 const struct mci_cfg cocci_id@p ;
...
typedef u8,u32;
@@
 struct sx8_base {  struct mci_base mci_base ;  u8 tuner_use_count [ SX8_TUNER_NUM ] ;  u32 gain_mode [ SX8_TUNER_NUM ] ;  u32 used_ldpc_bitrate [ SX8_DEMOD_NUM ] ;  u8 demod_in_use [ SX8_DEMOD_NUM ] ;  u32 iq_mode ;  u32 burst_size ;  u32 direct_mode ; } cocci_id@p ;
