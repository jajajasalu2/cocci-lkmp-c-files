...
position p;
@@
 struct il_sensitivity_data cocci_id@p ;
...
position p;
@@
 struct stats_general_data cocci_id@p ;
...
position p;
@@
 struct il_sensitivity_cmd cocci_id@p ;
...
position p;
@@
 struct stats_rx_phy * cocci_id@p ;
...
typedef u32;
@@
 struct stats_general_data {  u32 beacon_silence_rssi_a ;  u32 beacon_silence_rssi_b ;  u32 beacon_silence_rssi_c ;  u32 beacon_energy_a ;  u32 beacon_energy_b ;  u32 beacon_energy_c ; } cocci_id@p ;
