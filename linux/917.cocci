...
position p;
@@
 enum stm32_fmc2_irq_state { FMC2_IRQ_UNKNOWN = 0 , FMC2_IRQ_BCH , FMC2_IRQ_SEQ , } cocci_id@p ;
...
@@
 struct stm32_fmc2_nfc {  struct nand_controller base ;  struct stm32_fmc2_nand nand ;  struct device * dev ;  void __iomem * io_base ;  void __iomem * data_base [ FMC2_MAX_CE ] ;  void __iomem * cmd_base [ FMC2_MAX_CE ] ;  void __iomem * addr_base [ FMC2_MAX_CE ] ;  phys_addr_t io_phys_addr ;  phys_addr_t data_phys_addr [ FMC2_MAX_CE ] ;  struct clk * clk ;  u8 irq_state ;  struct dma_chan * dma_tx_ch ;  struct dma_chan * dma_rx_ch ;  struct dma_chan * dma_ecc_ch ;  struct sg_table dma_data_sg ;  struct sg_table dma_ecc_sg ;  u8 * ecc_buf ;  int dma_ecc_len ;  struct completion complete ;  struct completion dma_data_complete ;  struct completion dma_ecc_complete ;  u8 cs_assigned ;  int cs_sel ; } cocci_id@p ;
...
position p;
@@
 struct stm32_fmc2_nand cocci_id@p ;
...
position p;
@@
 struct stm32_fmc2_nfc cocci_id@p ;
...
position p;
@@
 enum stm32_fmc2_ecc { FMC2_ECC_HAM = 1 , FMC2_ECC_BCH4 = 4 , FMC2_ECC_BCH8 = 8 , } cocci_id@p ;
...
position p;
@@
 struct stm32_fmc2_nand {  struct nand_chip chip ;  struct stm32_fmc2_timings timings ;  int ncs ;  int cs_used [ FMC2_MAX_CE ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct stm32_fmc2_timings {  u8 tclr ;  u8 tar ;  u8 thiz ;  u8 twait ;  u8 thold_mem ;  u8 tset_mem ;  u8 thold_att ;  u8 tset_att ; } cocci_id@p ;
...
position p;
@@
 struct stm32_fmc2_timings * cocci_id@p ;
