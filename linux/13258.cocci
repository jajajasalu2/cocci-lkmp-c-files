...
position p;
@@
 enum blackbird_capture_type { BLACKBIRD_MPEG_CAPTURE , BLACKBIRD_RAW_CAPTURE , BLACKBIRD_RAW_PASSTHRU_CAPTURE , } cocci_id@p ;
...
position p;
@@
 enum blackbird_data_xfer_status { BLACKBIRD_MORE_BUFFERS_FOLLOW , BLACKBIRD_LAST_BUFFER , } cocci_id@p ;
...
position p;
@@
 enum blackbird_custom_data_type { BLACKBIRD_CUSTOM_EXTENSION_USR_DATA , BLACKBIRD_CUSTOM_PRIVATE_PACKET , } cocci_id@p ;
...
position p;
@@
 struct cx8802_driver * cocci_id@p ;
...
position p;
@@
 enum blackbird_notification_mailbox { BLACKBIRD_NOTIFICATION_NO_MAILBOX = - 1 , } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ CX2341X_MBOX_MAX_DATA ] ;
...
position p;
@@
 enum blackbird_copyright { BLACKBIRD_COPYRIGHT_OFF , BLACKBIRD_COPYRIGHT_ON , } cocci_id@p ;
...
position p;
@@
 enum blackbird_vbi_insertion_bits { BLACKBIRD_VBI_BITS_INSERT_IN_XTENSION_USR_DATA , BLACKBIRD_VBI_BITS_INSERT_IN_PRIVATE_PACKETS = 0x1 << 1 , BLACKBIRD_VBI_BITS_SEPARATE_STREAM = 0x2 << 1 , BLACKBIRD_VBI_BITS_SEPARATE_STREAM_USR_DATA = 0x4 << 1 , BLACKBIRD_VBI_BITS_SEPARATE_STREAM_PRV_DATA = 0x5 << 1 , } cocci_id@p ;
...
position p;
@@
 enum blackbird_notification_status { BLACKBIRD_NOTIFICATION_OFF , BLACKBIRD_NOTIFICATION_ON , } cocci_id@p ;
...
position p;
@@
 enum blackbird_mute_video_shift { BLACKBIRD_MUTE_VIDEO_V_SHIFT = 8 , BLACKBIRD_MUTE_VIDEO_U_SHIFT = 16 , BLACKBIRD_MUTE_VIDEO_Y_SHIFT = 24 , } cocci_id@p ;
...
position p;
@@
 enum blackbird_notification_type { BLACKBIRD_NOTIFICATION_REFRESH , } cocci_id@p ;
...
position p;
@@
 enum blackbird_stream_port { BLACKBIRD_OUTPUT_PORT_MEMORY , BLACKBIRD_OUTPUT_PORT_STREAMING , BLACKBIRD_OUTPUT_PORT_SERIAL , } cocci_id@p ;
...
position p;
@@
 enum blackbird_mute_video_mask { BLACKBIRD_MUTE_VIDEO_V_MASK = 0x0000FF00 , BLACKBIRD_MUTE_VIDEO_U_MASK = 0x00FF0000 , BLACKBIRD_MUTE_VIDEO_Y_MASK = 0xFF000000 , } cocci_id@p ;
...
position p;
@@
 enum blackbird_dma_unit { BLACKBIRD_DMA_BYTES , BLACKBIRD_DMA_FRAMES , } cocci_id@p ;
...
position p;
@@
 enum blackbird_capture_end { BLACKBIRD_END_AT_GOP , BLACKBIRD_END_NOW , } cocci_id@p ;
...
position p;
@@
 struct cx88_dmaqueue * cocci_id@p ;
...
position p;
@@
 enum blackbird_field2_lines { BLACKBIRD_FIELD2_SAA7114 = 0x00EF , BLACKBIRD_FIELD2_SAA7115 = 0x00F0 , BLACKBIRD_FIELD2_MICRONAS = 0x0106 , } cocci_id@p ;
...
position p;
@@
 struct cx88_riscmem * cocci_id@p ;
...
position p;
@@
 enum blackbird_dma_transfer_status_bits { BLACKBIRD_DMA_TRANSFER_BITS_DONE = 0x01 , BLACKBIRD_DMA_TRANSFER_BITS_ERROR = 0x04 , BLACKBIRD_DMA_TRANSFER_BITS_LL_ERROR = 0x10 , } cocci_id@p ;
...
position p;
@@
 enum blackbird_capture_bits { BLACKBIRD_RAW_BITS_NONE = 0x00 , BLACKBIRD_RAW_BITS_YUV_CAPTURE = 0x01 , BLACKBIRD_RAW_BITS_PCM_CAPTURE = 0x02 , BLACKBIRD_RAW_BITS_VBI_CAPTURE = 0x04 , BLACKBIRD_RAW_BITS_PASSTHRU_CAPTURE = 0x08 , BLACKBIRD_RAW_BITS_TO_HOST_CAPTURE = 0x10 , } cocci_id@p ;
...
position p;
@@
 enum blackbird_framerate { BLACKBIRD_FRAMERATE_NTSC_30 , BLACKBIRD_FRAMERATE_PAL_25 , } cocci_id@p ;
...
position p;
@@
 enum blackbird_field1_lines { BLACKBIRD_FIELD1_SAA7114 = 0x00EF , BLACKBIRD_FIELD1_SAA7115 = 0x00F0 , BLACKBIRD_FIELD1_MICRONAS = 0x0105 , } cocci_id@p ;
...
position p;
@@
 enum blackbird_mute { BLACKBIRD_UNMUTE , BLACKBIRD_MUTE , } cocci_id@p ;
...
position p;
@@
 enum blackbird_vbi_mode_bits { BLACKBIRD_VBI_BITS_SLICED , BLACKBIRD_VBI_BITS_RAW , } cocci_id@p ;
...
position p;
@@
 enum blackbird_pause { BLACKBIRD_PAUSE_ENCODING , BLACKBIRD_RESUME_ENCODING , } cocci_id@p ;
...
position p;
@@
 enum blackbird_picture_mask { BLACKBIRD_PICTURE_MASK_NONE , BLACKBIRD_PICTURE_MASK_I_FRAMES , BLACKBIRD_PICTURE_MASK_I_P_FRAMES = 0x3 , BLACKBIRD_PICTURE_MASK_ALL_FRAMES = 0x7 , } cocci_id@p ;
