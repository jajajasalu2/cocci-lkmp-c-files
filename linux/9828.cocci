...
position p;
@@
 struct ar5523_cmd_create_connection cocci_id@p ;
...
position p;
@@
 struct ar5523_fwblock cocci_id@p ;
...
position p;
@@
 struct ar5523_cmd_reset cocci_id@p ;
...
position p;
@@
 struct ar5523_chunk cocci_id@p ;
...
position p;
@@
 struct ar5523_tx_desc * cocci_id@p ;
...
position p;
@@
 struct ar5523_cmd_set_associd cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ar5523 * ar ) ;
...
position p;
@@
 struct ar5523_cmd_rateset cocci_id@p ;
...
position p;
@@
 struct ar5523_tx_cmd * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ar5523 * ar ) ;
...
position p;
@@
 struct ar5523_cmd_hdr * cocci_id@p ;
...
position p;
@@
 struct ar5523_cmd_txq_setup cocci_id@p ;
...
position p;
@@
 struct ar5523_cmd_host_available cocci_id@p ;
...
position p;
@@
 struct ar5523_rx_desc * cocci_id@p ;
...
position p;
@@
 struct ar5523_cmd_rates cocci_id@p ;
...
position p;
@@
 struct ar5523_write_mac cocci_id@p ;
...
position p;
@@
 struct ar5523_rx_data * cocci_id@p ;
...
position p;
@@
 struct ar5523_cmd_ledsteady cocci_id@p ;
...
position p;
@@
 struct ar5523_tx_data * cocci_id@p ;
...
position p;
@@
 struct ar5523_cmd_rx_filter cocci_id@p ;
