...
position p;
@@
 struct qcom_scm_desc cocci_id@p ;
...
position p;
@@
 const struct qcom_scm_desc * cocci_id@p ;
...
position p;
@@
 enum qcom_scm_arg_types { QCOM_SCM_VAL , QCOM_SCM_RO , QCOM_SCM_RW , QCOM_SCM_BUFVAL , } cocci_id@p ;
...
typedef u64,u32;
@@
 struct qcom_scm_desc {  u32 arginfo ;  u64 args [ MAX_QCOM_SCM_ARGS ] ; } cocci_id@p ;
