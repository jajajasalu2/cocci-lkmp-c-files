...
position p;
@@
 struct dsa_device_ops cocci_id@p ;
...
position p;
@@
 struct sja1105_meta * cocci_id@p ;
...
typedef u64;
@@
 struct sja1105_meta {  u64 tstamp ;  u64 dmac_byte_4 ;  u64 dmac_byte_3 ;  u64 source_port ;  u64 switch_id ; } cocci_id@p ;
...
position p;
@@
 const struct sja1105_meta * cocci_id@p ;
