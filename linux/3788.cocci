...
position p;
@@
 struct dpseci_cmd_congestion_notification * cocci_id@p ;
...
position p;
@@
 struct dpseci_rsp_get_sec_attr * cocci_id@p ;
...
position p;
@@
 struct dpseci_cmd_queue * cocci_id@p ;
...
position p;
@@
 struct dpseci_rsp_get_attributes * cocci_id@p ;
...
position p;
@@
 struct dpseci_rsp_is_enabled * cocci_id@p ;
...
position p;
@@
 const struct dpseci_rx_queue_cfg * cocci_id@p ;
...
position p;
@@
 struct dpseci_rsp_get_tx_queue * cocci_id@p ;
...
position p;
@@
 struct dpseci_tx_queue_attr * cocci_id@p ;
...
position p;
@@
 struct dpseci_cmd_open * cocci_id@p ;
...
position p;
@@
 const struct dpseci_congestion_notification_cfg * cocci_id@p ;
...
position p;
@@
 struct dpseci_rx_queue_attr * cocci_id@p ;
...
position p;
@@
 struct dpseci_rsp_get_api_version * cocci_id@p ;
...
position p;
@@
 struct dpseci_sec_attr * cocci_id@p ;
