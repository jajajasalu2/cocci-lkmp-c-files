...
position p;
@@
 struct aspeed_lpc_ctrl cocci_id@p ;
...
@@
 struct aspeed_lpc_ctrl {  struct miscdevice miscdev ;  struct regmap * regmap ;  struct clk * clk ;  phys_addr_t mem_base ;  resource_size_t mem_size ;  u32 pnor_size ;  u32 pnor_base ; } cocci_id@p ;
...
position p;
@@
 struct aspeed_lpc_ctrl_mapping cocci_id@p ;
