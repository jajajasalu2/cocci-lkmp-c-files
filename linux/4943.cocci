...
position p;
@@
 struct qib_sdma_txreq * cocci_id@p ;
...
position p;
@@
 struct qib_verbs_counters cocci_id@p ;
...
position p;
@@
 struct qib_pio_header cocci_id@p ;
...
position p;
@@
 struct qib_verbs_txreq * cocci_id@p ;
