...
position p;
@@
 void cocci_id@p ( struct hw_xmit * phwxmit , sint entry ) ;
...
position p;
@@
 struct sta_xmit_priv cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct _adapter * padapter ) ;
...
typedef u8;
@@
 const u8 cocci_id@p [ P80211_OUI_LEN ] ;
