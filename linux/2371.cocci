...
position p;
@@
 const struct imx_rproc_dcfg cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct imx_rproc_mem {  void __iomem * cpu_addr ;  phys_addr_t sys_addr ;  size_t size ; } cocci_id@p ;
...
typedef u32;
@@
 struct imx_rproc_att {  u32 da ;  u32 sa ;  u32 size ;  int flags ; } cocci_id@p ;
...
position p;
@@
 const struct imx_rproc_att cocci_id@p [ ] ;
...
typedef u32;
@@
 struct imx_rproc_dcfg {  u32 src_reg ;  u32 src_mask ;  u32 src_start ;  u32 src_stop ;  const struct imx_rproc_att * att ;  size_t att_size ; } cocci_id@p ;
...
position p;
@@
 struct imx_rproc {  struct device * dev ;  struct regmap * regmap ;  struct rproc * rproc ;  const struct imx_rproc_dcfg * dcfg ;  struct imx_rproc_mem mem [ IMX7D_RPROC_MEM_MAX ] ;  struct clk * clk ; } cocci_id@p ;
