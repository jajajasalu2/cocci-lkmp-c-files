...
position p;
@@
 struct bdw_rt5677_priv {  struct gpio_desc * gpio_hp_en ;  struct snd_soc_component * component ; } cocci_id@p ;
...
position p;
@@
 struct bdw_rt5677_priv cocci_id@p ;
...
position p;
@@
 enum { RT5677_GPIO_PLUG_DET = 0 , RT5677_GPIO_MIC_PRESENT_L = 1 , RT5677_GPIO_HOTWORD_DET_L = 2 , RT5677_GPIO_DSP_INT = 3 , RT5677_GPIO_HP_AMP_SHDN_L = 4 , } cocci_id@p ;
