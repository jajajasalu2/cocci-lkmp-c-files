...
position p;
@@
 struct adm9240_data * cocci_id@p ;
...
@@
 struct adm9240_data {  struct i2c_client * client ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated_measure ;  unsigned long last_updated_config ;  u8 in [ 6 ] ;  u8 in_max [ 6 ] ;  u8 in_min [ 6 ] ;  u8 fan [ 2 ] ;  u8 fan_min [ 2 ] ;  u8 fan_div [ 2 ] ;  s16 temp ;  s8 temp_max [ 2 ] ;  u16 alarms ;  u8 aout ;  u8 vid ;  u8 vrm ; } cocci_id@p ;
...
position p;
@@
 enum chips { adm9240 , ds1780 , lm81 , } cocci_id@p ;
