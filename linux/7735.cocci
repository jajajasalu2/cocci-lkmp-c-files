...
position p;
@@
 struct serial_quirk {  unsigned int manfid ;  unsigned int prodid ;  int multi ;  void ( * config ) ( struct pcmcia_device * ) ;  void ( * setup ) ( struct pcmcia_device * , struct uart_8250_port * ) ;  void ( * wakeup ) ( struct pcmcia_device * ) ;  int ( * post ) ( struct pcmcia_device * ) ; } cocci_id@p ;
...
position p;
@@
 struct serial_info {  struct pcmcia_device * p_dev ;  int ndev ;  int multi ;  int slave ;  int manfid ;  int prodid ;  int c950ctrl ;  int line [ 4 ] ;  const struct serial_quirk * quirk ; } cocci_id@p ;
...
position p;
@@
 const struct serial_quirk cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef u_char,tuple_t,cisparse_t;
@@
 struct serial_cfg_mem {  tuple_t tuple ;  cisparse_t parse ;  u_char buf [ 256 ] ; } cocci_id@p ;
