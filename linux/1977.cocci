...
position p;
@@
 int ( * cocci_id@p ) ( struct ad5064_state * st , unsigned int cmd , unsigned int addr , unsigned int val ) ;
...
symbol cocci_id;
position p;
typedef u8,bool,__be32;
@@
 struct ad5064_state {  struct device * dev ;  const struct ad5064_chip_info * chip_info ;  struct regulator_bulk_data vref_reg [ AD5064_MAX_VREFS ] ;  bool pwr_down [ AD5064_MAX_DAC_CHANNELS ] ;  u8 pwr_down_mode [ AD5064_MAX_DAC_CHANNELS ] ;  unsigned int dac_cache [ AD5064_MAX_DAC_CHANNELS ] ;  bool use_internal_vref ;  ad5064_write_func write ;  struct mutex lock ;  union {  u8 i2c [ 3 ] ;  __be32 spi ; } data ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ad5064_state cocci_id@p ;
...
position p;
@@
 enum ad5064_regmap_type { AD5064_REGMAP_ADI , AD5064_REGMAP_ADI2 , AD5064_REGMAP_LTC , } cocci_id@p ;
...
typedef bool;
@@
 struct ad5064_chip_info {  bool shared_vref ;  unsigned long internal_vref ;  const struct iio_chan_spec * channels ;  unsigned int num_channels ;  enum ad5064_regmap_type regmap_type ; } cocci_id@p ;
...
position p;
@@
 const struct ad5064_chip_info cocci_id@p [ ] ;
