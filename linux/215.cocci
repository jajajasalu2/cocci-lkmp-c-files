...
position p;
@@
 enum { TRACE_FUNC_OPT_STACK = 0x1 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long ip , unsigned long parent_ip , struct ftrace_ops * op , struct pt_regs * pt_regs ) ;
...
position p;
@@
 void cocci_id@p ( struct trace_array * tr ) ;
