...
position p;
@@
 struct mdp5_hw_pipe_state * cocci_id@p ;
...
position p;
@@
 const struct mdp5_smp_block * cocci_id@p ;
...
typedef u32,uint8_t;
@@
 struct mdp5_smp {  struct drm_device * dev ;  uint8_t reserved [ MAX_CLIENTS ] ;  int blk_cnt ;  int blk_size ;  u32 alloc_w [ 22 ] ;  u32 alloc_r [ 22 ] ;  u32 pipe_reqprio_fifo_wm0 [ SSPP_MAX ] ;  u32 pipe_reqprio_fifo_wm1 [ SSPP_MAX ] ;  u32 pipe_reqprio_fifo_wm2 [ SSPP_MAX ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mdp5_smp_state_t;
@@
 mdp5_smp_state_t * cocci_id@p ;
...
position p;
@@
 struct mdp5_smp_state * cocci_id@p ;
