...
position p;
@@
 struct sata_completion_resp * cocci_id@p ;
...
position p;
@@
 struct outbound_queue_table * cocci_id@p ;
...
position p;
@@
 struct local_phy_ctl_req cocci_id@p ;
...
position p;
@@
 struct ssp_completion_resp * cocci_id@p ;
...
position p;
@@
 struct pm8001_device * cocci_id@p ;
...
position p;
@@
 struct inbound_queue_table * cocci_id@p ;
...
position p;
@@
 struct fw_flash_Update_req cocci_id@p ;
...
position p;
@@
 const struct pm8001_dispatch cocci_id@p ;
...
position p;
@@
 struct fw_control_info * cocci_id@p ;
...
position p;
@@
 struct pm8001_ccb_info cocci_id@p ;
...
position p;
@@
 struct fw_flash_updata_info cocci_id@p ;
...
position p;
@@
 struct sata_event_resp * cocci_id@p ;
...
position p;
@@
 struct phy_stop_req cocci_id@p ;
...
position p;
@@
 struct set_dev_bits_fis cocci_id@p ;
...
position p;
@@
 struct sata_start_req cocci_id@p ;
...
position p;
@@
 struct hw_event_ack_req cocci_id@p ;
...
position p;
@@
 struct fw_control_ex cocci_id@p ;
...
position p;
@@
 struct pm8001_tmf_task * cocci_id@p ;
...
position p;
@@
 struct ssp_event_resp * cocci_id@p ;
...
position p;
@@
 struct local_phy_ctl_resp * cocci_id@p ;
...
position p;
@@
 struct pm8001_hba_info * cocci_id@p ;
...
position p;
@@
 struct pm8001_ioctl_payload * cocci_id@p ;
...
position p;
@@
 struct sas_re_initialization_req cocci_id@p ;
...
position p;
@@
 struct set_dev_state_resp * cocci_id@p ;
...
position p;
@@
 struct task_abort_resp * cocci_id@p ;
...
position p;
@@
 struct hw_event_resp * cocci_id@p ;
...
position p;
@@
 struct ssp_ini_tm_start_req cocci_id@p ;
...
position p;
@@
 struct get_nvm_data_req cocci_id@p ;
...
position p;
@@
 struct set_dev_state_req cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct pm8001_hba_info * pm8001_ha , u32 phyId , u32 phy_op ) ;
...
position p;
@@
 struct general_event_resp * cocci_id@p ;
...
position p;
@@
 struct set_nvm_data_req cocci_id@p ;
...
position p;
@@
 struct dev_reg_resp * cocci_id@p ;
...
position p;
@@
 struct task_abort_req cocci_id@p ;
...
position p;
@@
 struct phy_start_req cocci_id@p ;
...
position p;
@@
 struct get_nvm_data_resp * cocci_id@p ;
...
position p;
@@
 struct fw_flash_Update_resp * cocci_id@p ;
...
position p;
@@
 struct smp_completion_resp * cocci_id@p ;
...
position p;
@@
 struct ssp_ini_io_start_req cocci_id@p ;
...
position p;
@@
 struct pio_setup_fis cocci_id@p ;
...
position p;
@@
 struct dereg_dev_req cocci_id@p ;
