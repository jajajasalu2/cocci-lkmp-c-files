...
position p;
@@
 struct gpio_wdt_priv * cocci_id@p ;
...
typedef bool;
@@
 struct gpio_wdt_priv {  struct gpio_desc * gpiod ;  bool state ;  bool always_running ;  unsigned int hw_algo ;  struct watchdog_device wdd ; } cocci_id@p ;
...
position p;
@@
 enum { HW_ALGO_TOGGLE , HW_ALGO_LEVEL , } cocci_id@p ;
