...
position p;
@@
 struct pcnet32_rx_head cocci_id@p ;
...
position p;
@@
 const struct pcnet32_access cocci_id@p ;
...
typedef __le32;
@@
 struct pcnet32_rx_head {  __le32 base ;  __le16 buf_length ;  __le16 status ;  __le32 msg_length ;  __le32 reserved ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int phy_id , int reg_num , int val ) ;
...
position p;
@@
 struct pcnet32_private * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , const char * name ) ;
...
typedef u64;
@@
 void cocci_id@p ( struct net_device * dev , struct ethtool_test * eth_test , u64 * data ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int phy_id , int reg_num ) ;
...
position p;
@@
 struct pcnet32_tx_head cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , struct ethtool_regs * regs , void * ptr ) ;
...
position p;
@@
 struct net_device_stats * cocci_id@p ( struct net_device * ) ;
...
typedef __le32,u8;
@@
 struct pcnet32_init_block {  __le16 mode ;  __le16 tlen_rlen ;  u8 phys_addr [ 6 ] ;  __le16 reserved ;  __le32 filter [ 2 ] ;  __le32 rx_ring ;  __le32 tx_ring ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int verbose ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long , int , struct pci_dev * ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , unsigned int csr0_bits ) ;
...
position p;
@@
 volatile struct pcnet32_init_block * cocci_id@p ;
...
typedef __le32;
@@
 struct pcnet32_tx_head {  __le32 base ;  __le16 length ;  __le16 status ;  __le32 misc ;  __le32 reserved ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * , struct ifreq * , int ) ;
