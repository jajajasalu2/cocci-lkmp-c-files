...
position p;
@@
 struct dlm_convert_lock * cocci_id@p ;
...
position p;
@@
 enum dlm_status cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , struct dlm_lock * lock , int flags , int type , int * call_ast , int * kick_thread ) ;
...
position p;
@@
 enum dlm_status cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , struct dlm_lock * lock , int flags , int type ) ;
