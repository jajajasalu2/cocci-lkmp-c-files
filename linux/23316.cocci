...
position p;
@@
 struct rt286_priv {  struct reg_default * index_cache ;  int index_cache_size ;  struct regmap * regmap ;  struct snd_soc_component * component ;  struct rt286_platform_data pdata ;  struct i2c_client * i2c ;  struct snd_soc_jack * jack ;  struct delayed_work jack_detect_work ;  int sys_clk ;  int clk_id ; } cocci_id@p ;
...
position p;
@@
 struct rt286_platform_data * cocci_id@p ;
