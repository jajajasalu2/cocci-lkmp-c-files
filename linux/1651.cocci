...
position p;
@@
 int cocci_id@p ( struct mon_pgmap * map , int npages ) ;
...
position p;
@@
 void cocci_id@p ( const struct mon_reader_bin * rp , unsigned int offset , unsigned int size ) ;
...
typedef u32;
@@
 struct mon_bin_isodesc {  int iso_status ;  unsigned int iso_off ;  unsigned int iso_len ;  u32 _pad ; } cocci_id@p ;
...
position p;
@@
 struct mon_bin_mfetch32 cocci_id@p ;
...
position p;
@@
 struct mon_bin_get32 cocci_id@p ;
...
typedef u32;
@@
 struct mon_bin_stats {  u32 queued ;  u32 dropped ; } cocci_id@p ;
...
position p;
@@
 const struct usb_bus * cocci_id@p ;
...
position p;
@@
 struct mon_bin_get {  struct mon_bin_hdr __user * hdr ;  void __user * data ;  size_t alloc ; } cocci_id@p ;
...
position p;
@@
 struct mon_bin_mfetch cocci_id@p ;
...
position p;
@@
 struct mon_pgmap {  struct page * pg ;  unsigned char * ptr ; } cocci_id@p ;
...
position p;
@@
 struct mon_reader_bin * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mon_pgmap * map , int npages ) ;
...
typedef u32;
@@
 struct mon_bin_mfetch {  u32 __user * offvec ;  u32 nfetch ;  u32 nflush ; } cocci_id@p ;
...
position p;
@@
 const struct mon_reader_bin * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct file * file , struct mon_reader_bin * rp ) ;
...
position p;
@@
 struct mon_bin_isodesc * cocci_id@p ;
...
typedef u32;
@@
 struct mon_bin_mfetch32 {  u32 offvec32 ;  u32 nfetch32 ;  u32 nflush32 ; } cocci_id@p ;
...
typedef u32;
@@
 struct mon_bin_get32 {  u32 hdr32 ;  u32 data32 ;  u32 alloc32 ; } cocci_id@p ;
...
position p;
@@
 struct mon_bin_stats cocci_id@p ;
...
typedef u64,s32,s64;
@@
 struct mon_bin_hdr {  u64 id ;  unsigned char type ;  unsigned char xfer_type ;  unsigned char epnum ;  unsigned char devnum ;  unsigned short busnum ;  char flag_setup ;  char flag_data ;  s64 ts_sec ;  s32 ts_usec ;  int status ;  unsigned int len_urb ;  unsigned int len_cap ;  union {  unsigned char setup [ SETUP_LEN ] ;  struct iso_rec {  int error_count ;  int numdesc ; } iso ; } s ;  int interval ;  int start_frame ;  unsigned int xfer_flags ;  unsigned int ndesc ; } cocci_id@p ;
