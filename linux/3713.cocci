...
position p;
@@
 struct adf_cfg_section * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct list_head * head ) ;
...
position p;
@@
 struct adf_cfg_key_val * cocci_id@p ;
...
position p;
@@
 struct adf_cfg_device_data * cocci_id@p ;
...
position p;
@@
 enum adf_cfg_val_type cocci_id@p ;
