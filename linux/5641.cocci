...
position p;
@@
 const struct s5m_rtc_reg_config cocci_id@p ;
...
position p;
@@
 struct sec_pmic_dev * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RTC_MAX_NUM_TIME_REGS ] ;
...
position p;
@@
 struct s5m_rtc_info {  struct device * dev ;  struct i2c_client * i2c ;  struct sec_pmic_dev * s5m87xx ;  struct regmap * regmap ;  struct rtc_device * rtc_dev ;  int irq ;  enum sec_device_type device_type ;  int rtc_24hr_mode ;  const struct s5m_rtc_reg_config * regs ; } cocci_id@p ;
...
position p;
@@
 struct sec_platform_data * cocci_id@p ;
...
position p;
@@
 enum { RTC_SEC = 0 , RTC_MIN , RTC_HOUR , RTC_WEEKDAY , RTC_DATE , RTC_MONTH , RTC_YEAR1 , RTC_YEAR2 , RTC_MAX_NUM_TIME_REGS , } cocci_id@p ;
...
position p;
@@
 struct s5m_rtc_info * cocci_id@p ;
...
position p;
@@
 struct s5m_rtc_reg_config {  unsigned int regs_count ;  unsigned int time ;  unsigned int ctrl ;  unsigned int alarm0 ;  unsigned int alarm1 ;  unsigned int udr_update ;  unsigned int autoclear_udr_mask ;  unsigned int read_time_udr_mask ;  unsigned int write_time_udr_mask ;  unsigned int write_alarm_udr_mask ; } cocci_id@p ;
