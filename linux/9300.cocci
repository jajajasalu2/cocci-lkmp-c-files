...
position p;
@@
 struct adm8211_desc * cocci_id@p ;
...
position p;
@@
 struct ieee80211_chan_range cocci_id@p ;
...
position p;
@@
 struct adm8211_tx_ring_info * cocci_id@p ;
...
position p;
@@
 struct adm8211_tx_hdr cocci_id@p ;
...
position p;
@@
 struct adm8211_rx_ring_info * cocci_id@p ;
...
position p;
@@
 struct adm8211_priv * cocci_id@p ;
