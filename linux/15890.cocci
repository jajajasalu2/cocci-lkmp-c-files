...
position p;
@@
 struct boot_data {  unsigned short Cryptor ;  unsigned short Nrecs ;  unsigned char pof_state ;  unsigned char is_crypted ;  int BufSize ;  int last_error ;  unsigned short pof_recid ;  unsigned long pof_reclen ;  unsigned long pof_recoffset ;  union {  unsigned char BootBuf [ BOOT_BUF_SIZE ] ;  tPofRecHdr PofRecHdr ;  tPofFileHdr PofFileHdr ;  tPofTimeStamp PofTime ; } buf ; } cocci_id@p ;
