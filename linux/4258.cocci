...
position p;
@@
 struct surface3_button_data * cocci_id@p ;
...
typedef bool;
@@
 struct surface3_button_info {  const char * name ;  int acpi_index ;  unsigned int event_type ;  unsigned int event_code ;  bool autorepeat ;  bool wakeup ;  bool active_low ; } cocci_id@p ;
...
position p;
@@
 const struct surface3_button_info * cocci_id@p ;
...
position p;
@@
 struct surface3_button_info cocci_id@p [ ] ;
...
position p;
@@
 struct surface3_button_data {  struct platform_device * children [ BUTTON_TYPES ] ; } cocci_id@p ;
