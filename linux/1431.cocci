...
position p;
@@
 void cocci_id@p ( struct qe_udc * udc , struct usb_ctrlrequest * setup ) ;
...
position p;
@@
 int cocci_id@p ( struct qe_ep * ep ) ;
...
position p;
@@
 void cocci_id@p ( struct qe_udc * udc , struct qe_req * req ) ;
