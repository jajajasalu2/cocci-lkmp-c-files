...
@@
 struct imx_mu_priv {  struct device * dev ;  void __iomem * base ;  spinlock_t xcr_lock ;  struct mbox_controller mbox ;  struct mbox_chan mbox_chans [ IMX_MU_CHANS ] ;  struct imx_mu_con_priv con_priv [ IMX_MU_CHANS ] ;  const struct imx_mu_dcfg * dcfg ;  struct clk * clk ;  int irq ;  bool side_b ; } cocci_id@p ;
...
position p;
@@
 struct imx_mu_con_priv * cocci_id@p ;
...
position p;
@@
 struct imx_mu_con_priv {  unsigned int idx ;  char irq_desc [ IMX_MU_CHAN_NAME_SIZE ] ;  enum imx_mu_chan_type type ;  struct mbox_chan * chan ;  struct tasklet_struct txdb_tasklet ; } cocci_id@p ;
...
position p;
@@
 const struct imx_mu_dcfg cocci_id@p ;
...
typedef u32;
@@
 struct imx_mu_dcfg {  u32 xTR [ 4 ] ;  u32 xRR [ 4 ] ;  u32 xSR ;  u32 xCR ; } cocci_id@p ;
...
position p;
@@
 enum imx_mu_chan_type { IMX_MU_TYPE_TX , IMX_MU_TYPE_RX , IMX_MU_TYPE_TXDB , IMX_MU_TYPE_RXDB , } cocci_id@p ;
