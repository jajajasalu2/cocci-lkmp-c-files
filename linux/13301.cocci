...
position p;
@@
 struct tda1002x_config cocci_id@p ;
...
position p;
@@
 struct stb0899_config cocci_id@p ;
...
position p;
@@
 struct tda1004x_config cocci_id@p ;
...
position p;
@@
 const struct stb0899_s1_reg cocci_id@p [ ] ;
...
typedef u8;
@@
 struct budget_av {  struct budget budget ;  struct video_device vd ;  int cur_input ;  int has_saa7113 ;  struct tasklet_struct ciintf_irq_tasklet ;  int slot_status ;  struct dvb_ca_en50221 ca ;  u8 reinitialise_demod : 1 ; } cocci_id@p ;
...
position p;
@@
 struct dvb_ca_en50221 cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dvb_ca_en50221 * ca , int slot ) ;
...
position p;
@@
 struct v4l2_input cocci_id@p [ KNC1_INPUTS ] ;
...
position p;
@@
 const struct tda8261_config cocci_id@p ;
