...
position p;
@@
 struct smp_call_on_cpu_struct {  struct work_struct work ;  struct completion done ;  int ( * func ) ( void * ) ;  void * data ;  int ret ;  int cpu ; } cocci_id@p ;
...
position p;
@@
 struct call_function_data * cocci_id@p ;
...
position p;
@@
 enum { CSD_FLAG_LOCK = 0x01 , CSD_FLAG_SYNCHRONOUS = 0x02 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cpumask_var_t,call_single_data_t;
@@
 struct call_function_data {  call_single_data_t __percpu * csd ;  cpumask_var_t cpumask ;  cpumask_var_t cpumask_ipi ; } cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( bool warn_cpu_offline ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( int cpu , void * info ) ;
...
symbol cocci_id;
position p;
typedef smp_call_func_t;
@@
 smp_call_func_t cocci_id@p ;
...
position p;
@@
 struct smp_call_on_cpu_struct * cocci_id@p ;
