...
position p;
@@
 struct ubi_device * cocci_id@p [ UBI_MAX_DEVICES ] ;
...
position p;
@@
 char cocci_id@p [ MTD_PARAM_LEN_MAX ] ;
...
position p;
@@
 struct ubi_ainf_peb cocci_id@p ;
...
position p;
@@
 struct mtd_dev_param * cocci_id@p ;
...
position p;
@@
 struct mtd_dev_param {  char name [ MTD_PARAM_LEN_MAX ] ;  int ubi_num ;  int vid_hdr_offs ;  int max_beb_per1024 ; } cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ MTD_PARAM_MAX_COUNT ] ;
...
position p;
@@
 const struct ubi_device * cocci_id@p ;
...
position p;
@@
 struct ubi_wl_entry cocci_id@p ;
...
position p;
@@
 struct mtd_dev_param cocci_id@p [ UBI_MAX_DEVICES ] ;
...
position p;
@@
 struct ubi_vtbl_record cocci_id@p ;
