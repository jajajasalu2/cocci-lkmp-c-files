...
position p;
@@
 struct hisi_zip_ctx cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ HZIP_GZIP_HEAD_BUF ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ HZIP_ZLIB_HEAD_SIZE ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ HZIP_GZIP_HEAD_SIZE ] ;
...
position p;
@@
 struct hisi_zip_sqe cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct hisi_zip_req {  struct acomp_req * req ;  struct scatterlist * src ;  struct scatterlist * dst ;  size_t slen ;  size_t dlen ;  struct hisi_acc_hw_sgl * hw_src ;  struct hisi_acc_hw_sgl * hw_dst ;  dma_addr_t dma_src ;  dma_addr_t dma_dst ;  int req_id ; } cocci_id@p ;
...
position p;
@@
 struct hisi_zip_req * cocci_id@p ;
...
position p;
@@
 struct hisi_acc_sgl_pool * cocci_id@p ;
...
position p;
@@
 struct hisi_zip_qp_ctx * cocci_id@p ;
...
position p;
@@
 enum hisi_zip_alg_type { HZIP_ALG_TYPE_COMP = 0 , HZIP_ALG_TYPE_DECOMP = 1 , } cocci_id@p ;
...
position p;
@@
 struct hisi_zip_req_q * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u16,rwlock_t;
@@
 struct hisi_zip_req_q {  struct hisi_zip_req * q ;  unsigned long * req_bitmap ;  rwlock_t req_lock ;  u16 size ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct hisi_qp * , void * ) ;
...
position p;
@@
 struct hisi_zip_qp_ctx {  struct hisi_qp * qp ;  struct hisi_zip_sqe zip_sqe ;  struct hisi_zip_req_q req_q ;  struct hisi_acc_sgl_pool * sgl_pool ;  struct hisi_zip * zip_dev ;  struct hisi_zip_ctx * ctx ; } cocci_id@p ;
