...
position p;
@@
 void cocci_id@p ( struct sock * , int ) ;
...
position p;
@@
 struct iucv_sock_list * cocci_id@p ;
...
position p;
@@
 struct sockaddr_iucv * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sk_buff * , enum iucv_tx_notify ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct iucv_message * imsg , struct sock * sock , struct sk_buff * skb , u8 flags ) ;
...
position p;
@@
 struct iucv_interface * cocci_id@p ;
