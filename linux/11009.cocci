...
position p;
@@
 struct SMU73_Discrete_MCArbDramTimingTableEntry * cocci_id@p ;
...
position p;
@@
 const struct fiji_pt_defaults * cocci_id@p ;
...
position p;
@@
 struct SMU73_Discrete_Ulv * cocci_id@p ;
...
position p;
@@
 const struct fiji_pt_defaults cocci_id@p [ POWERTUNE_DEFAULT_SET_MAX ] ;
...
position p;
@@
 SMU73_Discrete_DpmTable * cocci_id@p ;
...
position p;
@@
 struct pp_atomctrl_memory_clock_param cocci_id@p ;
...
position p;
@@
 struct SMU73_Discrete_GraphicsLevel * cocci_id@p ;
...
position p;
@@
 struct SMU73_Discrete_MemoryLevel * cocci_id@p ;
...
position p;
@@
 struct SMU73_Discrete_MCArbDramTimingTable cocci_id@p ;
...
position p;
@@
 struct SMU73_Discrete_DpmTable * cocci_id@p ;
...
position p;
@@
 SMU73_Discrete_FanTable cocci_id@p ;
...
position p;
@@
 struct SMU73_Discrete_PmFuses cocci_id@p ;
...
position p;
@@
 const struct SMU73_Discrete_GraphicsLevel cocci_id@p [ 8 ] ;
