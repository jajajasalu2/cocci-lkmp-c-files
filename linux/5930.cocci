...
typedef u32;
@@
 struct gemini_pin_conf {  unsigned int pin ;  u32 reg ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 const struct gemini_pin_group cocci_id@p [ ] ;
...
position p;
@@
 const struct gemini_pmx_func cocci_id@p [ ] ;
...
typedef u32;
@@
 struct gemini_pin_group {  const char * name ;  const unsigned int * pins ;  const unsigned int num_pins ;  u32 mask ;  u32 value ;  u32 driving_mask ; } cocci_id@p ;
...
position p;
@@
 struct gemini_pmx_func {  const char * name ;  const char * const * groups ;  const unsigned int num_groups ; } cocci_id@p ;
...
position p;
@@
 const struct gemini_pin_conf cocci_id@p [ ] ;
...
typedef bool;
@@
 struct gemini_pmx {  struct device * dev ;  struct pinctrl_dev * pctl ;  struct regmap * map ;  bool is_3512 ;  bool is_3516 ;  bool flash_pin ;  const struct gemini_pin_conf * confs ;  unsigned int nconfs ; } cocci_id@p ;
