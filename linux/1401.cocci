...
position p;
@@
 struct fusb300_ep_info cocci_id@p ;
...
position p;
@@
 struct fusb300_request * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fusb300_ep * ep , struct fusb300_request * req , int status ) ;
...
position p;
@@
 struct fusb300_ep * cocci_id@p [ FUSB300_MAX_NUM_EP ] ;
