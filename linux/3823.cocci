...
position p;
@@
 struct p8_ghash_desc_ctx cocci_id@p ;
...
typedef u64,u128;
@@
 void cocci_id@p ( u128 htable [ 16 ] , const u64 Xi [ 2 ] ) ;
...
typedef u64,u128;
@@
 void cocci_id@p ( u64 Xi [ 2 ] , const u128 htable [ 16 ] ) ;
...
typedef u128;
@@
 struct p8_ghash_ctx {  u128 htable [ 16 ] ;  be128 key ; } cocci_id@p ;
...
typedef u64,u8;
@@
 struct p8_ghash_desc_ctx {  u64 shash [ 2 ] ;  u8 buffer [ GHASH_DIGEST_SIZE ] ;  int bytes ; } cocci_id@p ;
...
position p;
@@
 struct p8_ghash_ctx cocci_id@p ;
