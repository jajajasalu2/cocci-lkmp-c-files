...
symbol cocci_id;
position p;
typedef ia64_backtrace_t;
@@
 ia64_backtrace_t cocci_id@p ;
...
position p;
@@
 struct {  unsigned int depth ;  struct pt_regs * regs ;  struct unw_frame_info frame ;  unsigned long * prev_pfs_loc ; } cocci_id@p ;
