...
position p;
@@
 void cocci_id@p ( struct lbuf * bp ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct address_space * ) ;
...
position p;
@@
 struct lmStat {  uint commit ;  uint pagedone ;  uint submitted ;  uint full_page ;  uint partial_page ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct jfs_log * log ) ;
...
position p;
@@
 int cocci_id@p ( struct jfs_log * log , struct jfs_sb_info * sbi , int activate ) ;
...
position p;
@@
 int cocci_id@p ( struct lbuf * bp , int flag ) ;
...
position p;
@@
 struct lbuf * cocci_id@p ( struct jfs_log * log , int ) ;
...
position p;
@@
 void cocci_id@p ( struct jfs_log * log , int cant_block ) ;
...
position p;
@@
 void cocci_id@p ( struct jfs_log * log , struct lbuf * bp , int flag ) ;
...
position p;
@@
 int cocci_id@p ( struct jfs_log * log , int hard_sync ) ;
...
position p;
@@
 void cocci_id@p ( struct jfs_log * log , struct lbuf * bp , int flag , int cant_block ) ;
...
position p;
@@
 int cocci_id@p ( struct jfs_log * log , int pn , struct lbuf * * bpp ) ;
...
position p;
@@
 int cocci_id@p ( struct jfs_log * log ) ;
