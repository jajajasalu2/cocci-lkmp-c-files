...
position p;
@@
 struct drm_bridge_funcs cocci_id@p ;
...
position p;
@@
 struct lvds_encoder cocci_id@p ;
...
position p;
@@
 struct lvds_encoder {  struct drm_bridge bridge ;  struct drm_bridge * panel_bridge ;  struct gpio_desc * powerdown_gpio ; } cocci_id@p ;
