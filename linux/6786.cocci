...
position p;
@@
 struct lpfc_vector_map_info cocci_id@p ;
...
position p;
@@
 struct lpfc_acqe_dcbx * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_hba * , struct Scsi_Host * ) ;
...
position p;
@@
 struct lpfc_acqe_grp5 * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_read_config * cocci_id@p ;
...
position p;
@@
 struct lpfc_acqe_fc_la * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_query_fw_config cocci_id@p ;
...
position p;
@@
 struct lpfc_fcf_conn_entry * cocci_id@p ;
...
position p;
@@
 struct lpfc_adapter_event_header cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ FW_REV_STR_SIZE ] ;
...
position p;
@@
 struct lpfc_grp_hdr * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lpfc_hba * phba ) ;
...
position p;
@@
 struct lpfc_sli_intf cocci_id@p ;
...
position p;
@@
 struct {  char * name ;  char * bus ;  char * function ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_hba * ) ;
...
position p;
@@
 struct lpfc_acqe_fip * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lpfc_hba * ) ;
...
position p;
@@
 struct lpfc_mbx_get_func_cfg cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_get_sli4_parameters cocci_id@p ;
...
position p;
@@
 struct lpfc_sli4_parameters * cocci_id@p ;
...
position p;
@@
 struct lpfc_sli2_slim cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ ELX_MODEL_NAME_SIZE ] ;
...
position p;
@@
 struct lpfc_acqe_sli * cocci_id@p ;
...
position p;
@@
 struct lpfc_pc_sli4_params * cocci_id@p ;
...
position p;
@@
 struct lpfc_board_event_header cocci_id@p ;
...
position p;
@@
 struct lpfc_rsrc_desc_fcfcoe * cocci_id@p ;
...
position p;
@@
 struct lpfc_acqe_link * cocci_id@p ;
...
position p;
@@
 struct lpfc_acqe_misconfigured_event * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ LPFC_MAX_SUPPORTED_PAGES ] ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_hba * phba ) ;
...
position p;
@@
 struct lpfc_mbx_read_top * cocci_id@p ;
