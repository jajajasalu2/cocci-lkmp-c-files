...
position p;
@@
 struct acpi_table_gtdt cocci_id@p ;
...
position p;
@@
 struct acpi_gtdt_descriptor {  struct acpi_table_gtdt * gtdt ;  void * gtdt_end ;  void * platform_timer ; } cocci_id@p ;
...
position p;
@@
 struct acpi_gtdt_timer_entry * cocci_id@p ;
...
position p;
@@
 struct acpi_gtdt_watchdog * cocci_id@p ;
...
position p;
@@
 struct acpi_gtdt_header * cocci_id@p ;
...
position p;
@@
 struct acpi_gtdt_timer_block * cocci_id@p ;
...
position p;
@@
 struct acpi_gtdt_descriptor cocci_id@p ;
