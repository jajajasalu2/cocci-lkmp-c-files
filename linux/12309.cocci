...
position p;
@@
 const struct shmob_drm_interface_data * cocci_id@p ;
...
position p;
@@
 struct shmob_drm_crtc cocci_id@p ;
...
position p;
@@
 struct shmob_drm_encoder * cocci_id@p ;
...
position p;
@@
 struct shmob_drm_device * cocci_id@p ;
...
position p;
@@
 const struct shmob_drm_format_info * cocci_id@p ;
...
position p;
@@
 struct shmob_drm_connector cocci_id@p ;
