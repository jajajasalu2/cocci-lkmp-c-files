...
position p;
@@
 struct gpio_twl4030_priv * cocci_id@p ;
...
position p;
@@
 struct gpio_twl4030_priv {  struct gpio_chip gpio_chip ;  struct mutex mutex ;  int irq_base ;  unsigned int usage_count ;  unsigned int direction ;  unsigned int out_state ; } cocci_id@p ;
