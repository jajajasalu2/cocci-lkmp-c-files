...
position p;
@@
 struct mei_nfc_if_version cocci_id@p ;
...
position p;
@@
 struct mei_fixup {  const uuid_le uuid ;  void ( * hook ) ( struct mei_cl_device * cldev ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct mei_nfc_reply * cocci_id@p ;
...
position p;
@@
 struct mkhi_msg_hdr cocci_id@p ;
...
position p;
@@
 struct mkhi_fw_ver_block cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MKHI_FWVER_BUF_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MKHI_OSVER_BUF_LEN ] ;
