...
position p;
@@
 struct nvmet_async_event * cocci_id@p ;
...
position p;
@@
 struct nvmet_subsys cocci_id@p ;
...
position p;
@@
 struct nvmf_disc_rsp_page_hdr cocci_id@p ;
...
position p;
@@
 const struct nvmet_fabrics_ops * cocci_id@p [ NVMF_TRTYPE_MAX ] ;
...
position p;
@@
 struct nvmet_host_link * cocci_id@p ;
...
position p;
@@
 struct nvmf_disc_rsp_page_entry cocci_id@p ;
...
position p;
@@
 enum nvme_subsys_type cocci_id@p ;
...
position p;
@@
 struct nvmet_subsys * cocci_id@p ( struct nvmet_port * port , const char * subsysnqn ) ;
...
typedef u32;
@@
 u32 cocci_id@p [ NVMET_MAX_ANAGRPS + 1 ] ;
...
position p;
@@
 enum nvme_ana_state cocci_id@p ;
...
position p;
@@
 struct nvme_error_slot * cocci_id@p ;
...
position p;
@@
 struct nvmet_subsys_link * cocci_id@p ;
