...
position p;
@@
 enum nvec_msg_category cocci_id@p ;
...
position p;
@@
 enum nvec_sleep_subcmds { GLOBAL_EVENTS , AP_PWR_DOWN , AP_SUSPEND , } cocci_id@p ;
...
position p;
@@
 enum nvec_msg_category { NVEC_MSG_RX , NVEC_MSG_TX , } cocci_id@p ;
