...
position p;
@@
 struct max517_data {  struct i2c_client * client ;  unsigned short vref_mv [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 enum max517_device_ids { ID_MAX517 , ID_MAX518 , ID_MAX519 , ID_MAX520 , ID_MAX521 , } cocci_id@p ;
...
position p;
@@
 struct max517_platform_data * cocci_id@p ;
