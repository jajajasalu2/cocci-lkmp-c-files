...
position p;
@@
 struct ppc_hw_breakpoint cocci_id@p ;
...
position p;
@@
 struct thread_fp_state cocci_id@p ;
...
position p;
@@
 struct ppc_debug_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,elf_vrreg_t;
@@
 union {  elf_vrreg_t reg ;  u32 word ; } cocci_id@p ;
...
position p;
@@
 struct thread_vr_state cocci_id@p ;
