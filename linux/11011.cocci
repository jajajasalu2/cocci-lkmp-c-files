...
position p;
@@
 struct SMU8_MultimediaPowerLogData cocci_id@p ;
...
position p;
@@
 struct SMU8_Firmware_Header cocci_id@p ;
...
position p;
@@
 const enum smu8_scratch_entry cocci_id@p [ ] ;
...
position p;
@@
 struct smu8_buffer_entry * cocci_id@p ;
...
position p;
@@
 struct smu8_ih_meta_data * cocci_id@p ;
...
position p;
@@
 enum smu8_scratch_entry cocci_id@p ;
