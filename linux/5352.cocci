...
symbol cocci_id;
position p;
typedef irq_write_msi_msg_t,msi_alloc_info_t;
@@
 struct platform_msi_priv_data {  struct device * dev ;  void * host_data ;  msi_alloc_info_t arg ;  irq_write_msi_msg_t write_msg ;  int devid ; } cocci_id@p ;
...
position p;
@@
 struct platform_msi_priv_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef irq_write_msi_msg_t;
@@
 irq_write_msi_msg_t cocci_id@p ;
