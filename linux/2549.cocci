...
typedef sector_t;
@@
 struct dm_verity_prefetch_work {  struct work_struct work ;  struct dm_verity * v ;  sector_t block ;  unsigned n_blocks ; } cocci_id@p ;
...
position p;
@@
 struct dm_verity_io * cocci_id@p ;
...
position p;
@@
 enum verity_block_type cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ DM_VERITY_ENV_LENGTH ] ;
...
position p;
@@
 struct dm_verity_sig_opts cocci_id@p ;
...
position p;
@@
 struct dm_verity_prefetch_work * cocci_id@p ;
...
position p;
@@
 struct buffer_aux {  int hash_verified ; } cocci_id@p ;
