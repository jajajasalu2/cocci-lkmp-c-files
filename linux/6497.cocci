...
position p;
@@
 struct mvumi_ob_data cocci_id@p ;
...
position p;
@@
 struct mvumi_rsp_frame * cocci_id@p ;
...
position p;
@@
 struct mvumi_events_wq cocci_id@p ;
...
position p;
@@
 struct mvumi_msg_frame * cocci_id@p ;
...
position p;
@@
 struct mvumi_hs_page2 * cocci_id@p ;
...
position p;
@@
 struct mvumi_event_req * cocci_id@p ;
...
position p;
@@
 struct mvumi_device * cocci_id@p ;
...
position p;
@@
 struct mvumi_hs_page3 * cocci_id@p ;
...
position p;
@@
 struct mvumi_dyn_list_entry cocci_id@p ;
...
position p;
@@
 struct mvumi_driver_event * cocci_id@p ;
...
position p;
@@
 struct mvumi_hw_regs * cocci_id@p ;
...
position p;
@@
 enum mvumi_qc_result cocci_id@p ;
...
position p;
@@
 struct mvumi_hs_header * cocci_id@p ;
...
position p;
@@
 struct mvumi_sense_data cocci_id@p ;
...
position p;
@@
 struct mvumi_instance_template cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p ( struct mvumi_hba * mhba ) ;
...
position p;
@@
 struct mvumi_hotplug_event * cocci_id@p ;
...
position p;
@@
 struct mvumi_hs_page1 * cocci_id@p ;
...
position p;
@@
 struct mvumi_hs_page4 * cocci_id@p ;
