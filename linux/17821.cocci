...
position p;
@@
 enum vector_domain_type { VECTOR_DOMAIN_NONE , VECTOR_DOMAIN_PERCPU , } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ NR_IRQS ] ;
...
typedef cpumask_t;
@@
 cpumask_t cocci_id@p [ IA64_NUM_VECTORS ] ;
