...
position p;
@@
 struct inotify_inode_mark cocci_id@p ;
...
position p;
@@
 struct inotify_event_info * cocci_id@p ;
...
position p;
@@
 struct inotify_event cocci_id@p ;
...
position p;
@@
 struct inotify_group_private_data * cocci_id@p ;
