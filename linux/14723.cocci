...
position p;
@@
 const struct clk_master_layout cocci_id@p ;
...
typedef u8;
@@
 const struct {  char * n ;  u8 id ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 const struct {  char * n ;  char * p ;  u8 id ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct clk_programmable_layout cocci_id@p ;
...
typedef u8,bool;
@@
 const struct {  char * n ;  u8 id ;  struct clk_range r ;  bool pll ; } cocci_id@p [ ] ;
