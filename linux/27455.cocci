...
position p;
@@
 struct persistent_ram_zone * cocci_id@p [ ] ;
...
position p;
@@
 struct ramoops_context cocci_id@p ;
...
position p;
@@
 struct ramoops_platform_data * cocci_id@p ;
