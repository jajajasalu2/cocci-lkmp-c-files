...
position p;
@@
 struct xfs_fstrm_item cocci_id@p ;
...
position p;
@@
 struct xfs_mru_cache_elem * cocci_id@p ;
...
position p;
@@
 enum xfs_fstrm_alloc { XFS_PICK_USERDATA = 1 , XFS_PICK_LOWSPACE = 2 , } cocci_id@p ;
...
typedef xfs_agnumber_t;
@@
 struct xfs_fstrm_item {  struct xfs_mru_cache_elem mru ;  xfs_agnumber_t ag ; } cocci_id@p ;
