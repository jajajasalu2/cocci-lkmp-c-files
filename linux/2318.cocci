...
position p;
@@
 struct amlogic_thermal * cocci_id@p ;
...
typedef u32;
@@
 struct amlogic_thermal {  struct platform_device * pdev ;  const struct amlogic_thermal_data * data ;  struct regmap * regmap ;  struct regmap * sec_ao_map ;  struct clk * clk ;  struct thermal_zone_device * tzd ;  u32 trim_info ; } cocci_id@p ;
...
position p;
@@
 const struct amlogic_thermal_data cocci_id@p ;
...
position p;
@@
 struct amlogic_thermal_data {  int u_efuse_off ;  const struct amlogic_thermal_soc_calib_data * calibration_parameters ;  const struct regmap_config * regmap_config ; } cocci_id@p ;
...
position p;
@@
 const struct amlogic_thermal_soc_calib_data cocci_id@p ;
...
position p;
@@
 struct amlogic_thermal_soc_calib_data {  int A ;  int B ;  int m ;  int n ; } cocci_id@p ;
