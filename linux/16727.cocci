...
position p;
@@
 struct qt2160_led {  struct qt2160_data * qt2160 ;  struct led_classdev cdev ;  char name [ 32 ] ;  int id ;  enum led_brightness brightness ; } cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct i2c_client * client , u8 reg , u8 data ) ;
