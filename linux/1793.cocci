...
position p;
@@
 const struct si1133_coeff * cocci_id@p ;
...
typedef s16,u16;
@@
 struct si1133_coeff {  s16 info ;  u16 mag ; } cocci_id@p ;
...
position p;
@@
 enum si1133_int_time { _24_4_us = 0 , _48_8_us = 1 , _97_5_us = 2 , _195_0_us = 3 , _390_0_us = 4 , _780_0_us = 5 , _1_560_0_us = 6 , _3_120_0_us = 7 , _6_240_0_us = 8 , _12_480_0_us = 9 , _25_ms = 10 , _50_ms = 11 , } cocci_id@p ;
...
typedef u8;
@@
 struct si1133_data {  struct regmap * regmap ;  struct i2c_client * client ;  struct mutex mutex ;  int rsp_seq ;  u8 scan_mask ;  u8 adc_sens [ 6 ] ;  u8 adc_config [ 6 ] ;  struct completion completion ; } cocci_id@p ;
...
position p;
@@
 struct si1133_lux_coeff {  struct si1133_coeff coeff_high [ 4 ] ;  struct si1133_coeff coeff_low [ 9 ] ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SI1133_LUX_BUFFER_SIZE ] ;
...
position p;
@@
 const struct si1133_lux_coeff cocci_id@p ;
