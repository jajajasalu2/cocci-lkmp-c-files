...
position p;
@@
 struct xfs_rmap_key_state cocci_id@p ;
...
position p;
@@
 struct xfs_rmap_query_range_info {  xfs_rmap_query_range_fn fn ;  void * priv ; } cocci_id@p ;
...
position p;
@@
 enum xfs_rmap_intent_type cocci_id@p ;
...
position p;
@@
 struct xfs_rmap_intent * cocci_id@p ;
...
position p;
@@
 xfs_rmap_query_range_fn cocci_id@p ;
...
position p;
@@
 struct xfs_rmap_query_range_info * cocci_id@p ;
...
@@
 struct xfs_rmap_key_state {  uint64_t owner ;  uint64_t offset ;  unsigned int flags ;  bool has_rmap ; } cocci_id@p ;
...
position p;
@@
 struct xfs_find_left_neighbor_info cocci_id@p ;
...
position p;
@@
 const struct xfs_rmap_irec * cocci_id@p ;
...
position p;
@@
 struct xfs_rmap_irec cocci_id@p [ 4 ] ;
...
position p;
@@
 struct xfs_find_left_neighbor_info {  struct xfs_rmap_irec high ;  struct xfs_rmap_irec * irec ;  int * stat ; } cocci_id@p ;
