...
position p;
@@
 union REG_OWNER_EPID cocci_id@p ;
...
position p;
@@
 enum fjes_dev_command_request_type cocci_id@p ;
...
position p;
@@
 union fjes_device_command_req * cocci_id@p ;
...
position p;
@@
 struct fjes_device_shared_info cocci_id@p ;
...
typedef u8;
@@
 struct my_s {  u8 es_status ;  u8 zone ; } * cocci_id@p ;
...
position p;
@@
 struct epbuf_handler * cocci_id@p ;
...
position p;
@@
 enum fjes_dev_command_response_e cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ EP_BUFFER_SUPPORT_VLAN_MAX ] ;
...
position p;
@@
 union fjes_device_command_res * cocci_id@p ;
