...
position p;
@@
 enum commands { READ_PORT , WRITE_PORT , SET_PORT_DIR , START_COUNTER , STOP_COUNTER , READ_COUNTER , WRITE_COUNTER , } cocci_id@p ;
...
position p;
@@
 struct ni6501_private * cocci_id@p ;
...
typedef u8;
@@
 struct ni6501_private {  struct usb_endpoint_descriptor * ep_rx ;  struct usb_endpoint_descriptor * ep_tx ;  struct mutex mut ;  u8 * usb_rx_buf ;  u8 * usb_tx_buf ; } cocci_id@p ;
