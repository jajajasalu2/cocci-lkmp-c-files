...
position p;
@@
 struct pcf857x {  struct gpio_chip chip ;  struct irq_chip irqchip ;  struct i2c_client * client ;  struct mutex lock ;  unsigned out ;  unsigned status ;  unsigned irq_enabled ;  int ( * write ) ( struct i2c_client * client , unsigned data ) ;  int ( * read ) ( struct i2c_client * client ) ; } cocci_id@p ;
