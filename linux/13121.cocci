...
position p;
@@
 struct altera_ps_data cocci_id@p ;
...
position p;
@@
 struct altera_ps_conf * cocci_id@p ;
...
position p;
@@
 const struct altera_ps_data * cocci_id@p ;
...
typedef u32;
@@
 struct altera_ps_conf {  struct gpio_desc * config ;  struct gpio_desc * confd ;  struct gpio_desc * status ;  struct spi_device * spi ;  const struct altera_ps_data * data ;  u32 info_flags ;  char mgr_name [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 struct altera_ps_data {  enum altera_ps_devtype devtype ;  int status_wait_min_us ;  int status_wait_max_us ;  int t_cfg_us ;  int t_st2ck_us ; } cocci_id@p ;
...
position p;
@@
 enum altera_ps_devtype { CYCLONE5 , ARRIA10 , } cocci_id@p ;
