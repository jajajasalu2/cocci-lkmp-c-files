...
typedef u8,u32;
@@
 struct {  u32 data ;  u8 size ; } cocci_id@p ;
...
position p;
@@
 struct gf100_ramfuc * cocci_id@p ;
...
position p;
@@
 struct gf100_ram {  struct nvkm_ram base ;  struct gf100_ramfuc fuc ;  struct nvbios_pll refpll ;  struct nvbios_pll mempll ; } cocci_id@p ;
