...
typedef spinlock_t;
@@
 struct creg_gpio {  struct gpio_chip gc ;  void __iomem * regs ;  spinlock_t lock ;  const struct creg_layout * layout ; } cocci_id@p ;
...
position p;
@@
 const struct creg_layout * cocci_id@p ;
...
typedef u8;
@@
 struct creg_layout {  u8 ngpio ;  u8 shift [ MAX_GPIO ] ;  u8 on [ MAX_GPIO ] ;  u8 off [ MAX_GPIO ] ;  u8 bit_per_gpio [ MAX_GPIO ] ; } cocci_id@p ;
