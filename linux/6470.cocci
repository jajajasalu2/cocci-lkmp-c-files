...
position p;
@@
 struct ad5398_chip_info * cocci_id@p ;
...
position p;
@@
 struct ad5398_chip_info {  struct i2c_client * client ;  int min_uA ;  int max_uA ;  unsigned int current_level ;  unsigned int current_mask ;  unsigned int current_offset ;  struct regulator_dev * rdev ; } cocci_id@p ;
...
position p;
@@
 const struct ad5398_current_data_format * cocci_id@p ;
...
position p;
@@
 struct ad5398_current_data_format {  int current_bits ;  int current_offset ;  int min_uA ;  int max_uA ; } cocci_id@p ;
...
position p;
@@
 struct ad5398_current_data_format * cocci_id@p ;
