...
typedef bool;
@@
 struct bfq_queue * cocci_id@p ( struct bfq_data * bfqd , struct bio * bio , bool is_sync , struct bfq_io_cq * bic ) ;
...
position p;
@@
 struct bfq_sched_data * cocci_id@p ;
...
position p;
@@
 enum bfqq_expiration cocci_id@p ;
...
position p;
@@
 struct bfq_queue * cocci_id@p ( struct request * rq ) ;
...
position p;
@@
 struct bfq_weight_counter cocci_id@p ;
