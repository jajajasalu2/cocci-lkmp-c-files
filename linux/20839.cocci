...
position p;
@@
 struct kvm_cpuid_entry cocci_id@p ;
...
typedef bool,u32;
@@
 struct kvm_cpuid_param {  u32 func ;  bool ( * qualifier ) ( const struct kvm_cpuid_param * param ) ; } cocci_id@p ;
...
position p;
@@
 const struct kvm_cpuid_param cocci_id@p [ ] ;
