...
typedef bool;
@@
 bool cocci_id@p ( struct ixgb_hw * hw ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct ixgb_hw * hw , u32 hash_value ) ;
...
typedef u32,u16;
@@
 u16 cocci_id@p ( struct ixgb_hw * hw , u32 reg_address , u32 phy_address , u32 device_type ) ;
...
typedef u8,u32;
@@
 u32 cocci_id@p ( struct ixgb_hw * hw , u8 * mc_addr ) ;
...
position p;
@@
 ixgb_phy_type cocci_id@p ( struct ixgb_hw * hw ) ;
...
position p;
@@
 void cocci_id@p ( struct ixgb_hw * hw ) ;
