...
position p;
@@
 struct snd_uac_chip * cocci_id@p ;
...
position p;
@@
 struct snd_uac_chip {  struct g_audio * audio_dev ;  struct uac_rtd_params p_prm ;  struct uac_rtd_params c_prm ;  struct snd_card * card ;  struct snd_pcm * pcm ;  unsigned int p_interval ;  unsigned int p_residue ;  unsigned int p_pktsize ;  unsigned int p_pktsize_residue ;  unsigned int p_framesize ; } cocci_id@p ;
...
@@
 struct uac_rtd_params {  struct snd_uac_chip * uac ;  bool ep_enabled ;  struct snd_pcm_substream * ss ;  ssize_t hw_ptr ;  void * rbuf ;  unsigned int max_psize ;  struct uac_req * ureq ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct uac_rtd_params * cocci_id@p ;
...
position p;
@@
 struct uac_req {  struct uac_rtd_params * pp ;  struct usb_request * req ; } cocci_id@p ;
