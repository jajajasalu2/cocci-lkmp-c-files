...
position p;
@@
 struct wcnss_download_nv_req * cocci_id@p ;
...
position p;
@@
 const struct wcnss_version_resp * cocci_id@p ;
...
position p;
@@
 struct wcnss_msg_hdr cocci_id@p ;
...
position p;
@@
 const struct wcnss_download_nv_resp * cocci_id@p ;
...
position p;
@@
 enum { WCNSS_VERSION_REQ = 0x01000000 , WCNSS_VERSION_RESP , WCNSS_DOWNLOAD_NV_REQ , WCNSS_DOWNLOAD_NV_RESP , WCNSS_UPLOAD_CAL_REQ , WCNSS_UPLOAD_CAL_RESP , WCNSS_DOWNLOAD_CAL_REQ , WCNSS_DOWNLOAD_CAL_RESP , WCNSS_VBAT_LEVEL_IND , WCNSS_BUILD_VERSION_REQ , WCNSS_BUILD_VERSION_RESP , WCNSS_PM_CONFIG_REQ , WCNSS_CBC_COMPLETE_IND , } cocci_id@p ;
...
position p;
@@
 const struct wcnss_msg_hdr * cocci_id@p ;
...
position p;
@@
 struct wcnss_ctrl {  struct device * dev ;  struct rpmsg_endpoint * channel ;  struct completion ack ;  struct completion cbc ;  int ack_status ;  struct work_struct probe_work ; } cocci_id@p ;
