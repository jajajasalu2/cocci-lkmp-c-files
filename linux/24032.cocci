...
position p;
@@
 struct tcp_sack_block * cocci_id@p ;
...
position p;
@@
 const struct tcp_options_received * cocci_id@p ;
...
position p;
@@
 struct tcp_sack_block_wire * cocci_id@p ;
...
typedef u64,u32;
@@
 struct tcp_sacktag_state {  u32 reord ;  u64 first_sackt ;  u64 last_sackt ;  struct rate_sample * rate ;  int flag ;  unsigned int mss_now ; } cocci_id@p ;
...
position p;
@@
 const struct tcp_sack_block * cocci_id@p ;
...
position p;
@@
 const struct rate_sample * cocci_id@p ;
...
position p;
@@
 struct tcp_sacktag_state * cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct sock * sk , u32 ack_seq ) ;
...
position p;
@@
 const struct request_sock_ops * cocci_id@p ;
...
position p;
@@
 struct tcp_sack_block cocci_id@p [ TCP_NUM_SACKS ] ;
