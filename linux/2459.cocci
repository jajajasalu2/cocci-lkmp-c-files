...
position p;
@@
 struct owl_dma_lli_hw * cocci_id@p ;
...
position p;
@@
 struct owl_dma_pchan cocci_id@p ;
...
@@
 struct owl_dma_pchan {  u32 id ;  void __iomem * base ;  struct owl_dma_vchan * vchan ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u8;
@@
 struct owl_dma_vchan {  struct virt_dma_chan vc ;  struct owl_dma_pchan * pchan ;  struct owl_dma_txd * txd ;  struct dma_slave_config cfg ;  u8 drq ; } cocci_id@p ;
...
typedef u32;
@@
 struct owl_dma_lli_hw {  u32 next_lli ;  u32 saddr ;  u32 daddr ;  u32 flen : 20 ;  u32 fcnt : 12 ;  u32 src_stride ;  u32 dst_stride ;  u32 ctrla ;  u32 ctrlb ;  u32 const_num ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct owl_dma_lli {  struct owl_dma_lli_hw hw ;  dma_addr_t phys ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct owl_dma_vchan cocci_id@p ;
...
typedef bool;
@@
 struct owl_dma_txd {  struct virt_dma_desc vd ;  struct list_head lli_list ;  bool cyclic ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct owl_dma {  struct dma_device dma ;  void __iomem * base ;  struct clk * clk ;  spinlock_t lock ;  struct dma_pool * lli_pool ;  int irq ;  unsigned int nr_pchans ;  struct owl_dma_pchan * pchans ;  unsigned int nr_vchans ;  struct owl_dma_vchan * vchans ; } cocci_id@p ;
