...
position p;
@@
 void cocci_id@p ( struct rfcomm_session * s ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct sk_buff * skb , u8 addr ) ;
...
position p;
@@
 struct rfcomm_session * cocci_id@p ( struct rfcomm_session * s ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct rfcomm_session * s , int cr , u8 dlci , u8 v24_sig ) ;
...
position p;
@@
 int cocci_id@p ( struct rfcomm_dlc * d ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct rfcomm_session * s , u8 * data , int len ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct rfcomm_session * s , u8 dlci ) ;
...
position p;
@@
 int cocci_id@p ( struct rfcomm_session * s , int cr , struct rfcomm_dlc * d ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct rfcomm_session * s , int cr , u8 type ) ;
...
position p;
@@
 struct rfcomm_session * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct rfcomm_session * s , int cr , u8 * pattern , int len ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct rfcomm_session * s , u8 addr , u8 credits ) ;
