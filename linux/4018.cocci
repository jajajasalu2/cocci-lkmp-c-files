...
position p;
@@
 struct gpcv2_irqchip_data * cocci_id@p ;
...
typedef u32;
@@
 struct gpcv2_irqchip_data {  struct raw_spinlock rlock ;  void __iomem * gpc_base ;  u32 wakeup_sources [ IMR_NUM ] ;  u32 saved_irq_mask [ IMR_NUM ] ;  u32 cpu2wakeup ; } cocci_id@p ;
