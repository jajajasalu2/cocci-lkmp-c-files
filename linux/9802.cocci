...
position p;
@@
 struct htt_rx_offload_msdu * cocci_id@p ;
...
position p;
@@
 struct htt_resp_hdr cocci_id@p ;
...
position p;
@@
 enum htt_rx_tkip_demic_type cocci_id@p ;
...
position p;
@@
 enum htt_security_types cocci_id@p ;
...
position p;
@@
 struct ath10k_pktlog_hdr * cocci_id@p ;
...
position p;
@@
 const struct ath10k_htt_rx_ops cocci_id@p ;
...
position p;
@@
 const struct htt_resp * cocci_id@p ;
...
position p;
@@
 struct htt_rx_indication_mpdu_range cocci_id@p ;
...
position p;
@@
 struct htt_rx_in_ord_msdu_desc * cocci_id@p ;
...
position p;
@@
 enum htt_tx_mode_switch_mode cocci_id@p ;
...
position p;
@@
 struct htt_rx_in_ord_ind * cocci_id@p ;
...
position p;
@@
 const struct htt_tx_mode_switch_record * cocci_id@p ;
...
position p;
@@
 struct ath10k_htt_tx_stats * cocci_id@p ;
...
position p;
@@
 struct htt_peer_map_event cocci_id@p ;
...
position p;
@@
 enum rx_msdu_decap_format cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RX_HTT_HDR_STATUS_LEN ] ;
...
position p;
@@
 struct htt_rx_indication_hl * cocci_id@p ;
...
position p;
@@
 struct htt_rx_fragment_indication * cocci_id@p ;
...
position p;
@@
 enum ath10k_pkt_rx_err * cocci_id@p ;
...
position p;
@@
 struct fw_rx_desc_hl * cocci_id@p ;
...
position p;
@@
 enum htt_t2h_msg_type cocci_id@p ;
...
position p;
@@
 enum htt_rx_pn_check_type cocci_id@p ;
...
position p;
@@
 struct htt_rx_in_ord_msdu_desc_ext * cocci_id@p ;
...
position p;
@@
 struct htt_data_tx_compl_ppdu_dur * cocci_id@p ;
...
position p;
@@
 struct htt_security_indication * cocci_id@p ;
...
position p;
@@
 struct htt_data_tx_ppdu_dur * cocci_id@p ;
...
position p;
@@
 struct htt_rx_delba * cocci_id@p ;
...
position p;
@@
 struct ath10k_skb_rxcb * cocci_id@p ;
...
position p;
@@
 struct amsdu_subframe_hdr cocci_id@p ;
...
position p;
@@
 struct ath10k_10_2_peer_tx_stats * cocci_id@p ;
...
position p;
@@
 struct htt_rx_addba * cocci_id@p ;
...
position p;
@@
 struct htt_tx_fetch_record * cocci_id@p ;
...
position p;
@@
 struct htt_rx_indication * cocci_id@p ;
...
position p;
@@
 struct ath10k_per_peer_tx_stats * cocci_id@p ;
...
position p;
@@
 struct htt_hl_rx_desc * cocci_id@p ;
...
position p;
@@
 struct htt_peer_unmap_event cocci_id@p ;
...
position p;
@@
 enum htt_rx_mpdu_encrypt_type cocci_id@p ;
...
position p;
@@
 struct htt_per_peer_tx_stats_ind * cocci_id@p ;
...
position p;
@@
 enum htt_txrx_sec_cast_type cocci_id@p ;
