...
position p;
@@
 struct pvrdma_netdevice_work cocci_id@p ;
...
position p;
@@
 struct pvrdma_cmd_create_bind * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct ib_gid_attr * attr , void * * context ) ;
...
position p;
@@
 struct pvrdma_cmd_destroy_bind * cocci_id@p ;
