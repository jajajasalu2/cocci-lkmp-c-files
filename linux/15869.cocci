...
typedef u32;
@@
 u32 cocci_id@p [ TXSCALE_TABLE_SIZE ] ;
...
typedef u8,bool;
@@
 void cocci_id@p ( PDM_ODM_T pDM_Odm , u8 Ant , bool bDualPath ) ;
...
position p;
@@
 void cocci_id@p ( PDM_ODM_T pDM_Odm ) ;
...
position p;
@@
 void cocci_id@p ( void * FunctionContext ) ;
...
typedef u32;
@@
 u32 cocci_id@p [ OFDM_TABLE_SIZE ] ;
...
typedef u8,bool,u32;
@@
 bool cocci_id@p ( PDM_ODM_T pDM_Odm , u32 OFDM_Ant1_Cnt , u32 OFDM_Ant2_Cnt , u32 CCK_Ant1_Cnt , u32 CCK_Ant2_Cnt , u8 * pDefAnt ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ CCK_TABLE_SIZE ] [ 8 ] ;
