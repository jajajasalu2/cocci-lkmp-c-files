...
position p;
@@
 struct drm_qxl_execbuffer * cocci_id@p ;
...
position p;
@@
 union qxl_release_info cocci_id@p ;
...
position p;
@@
 struct drm_qxl_reloc cocci_id@p ;
...
position p;
@@
 struct drm_qxl_alloc * cocci_id@p ;
...
position p;
@@
 struct drm_qxl_getparam * cocci_id@p ;
...
position p;
@@
 struct qxl_drawable * cocci_id@p ;
...
position p;
@@
 struct drm_qxl_command * cocci_id@p ;
...
typedef uint32_t;
@@
 struct qxl_reloc_info {  int type ;  struct qxl_bo * dst_bo ;  uint32_t dst_offset ;  struct qxl_bo * src_bo ;  int src_offset ; } cocci_id@p ;
...
position p;
@@
 struct drm_qxl_alloc_surf * cocci_id@p ;
...
position p;
@@
 struct drm_qxl_update_area * cocci_id@p ;
...
position p;
@@
 struct qxl_reloc_info cocci_id@p ;
...
position p;
@@
 struct drm_qxl_clientcap * cocci_id@p ;
