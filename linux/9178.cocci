...
position p;
@@
 enum mlxsw_hwmon_attr_type cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_FORE_LEN ] ;
...
position p;
@@
 struct mlxsw_hwmon_attr cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MTBR_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MTCAP_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MFSM_LEN ] ;
...
position p;
@@
 struct mlxsw_hwmon_attr {  struct device_attribute dev_attr ;  struct mlxsw_hwmon * hwmon ;  unsigned int type_index ;  char name [ 32 ] ; } cocci_id@p ;
