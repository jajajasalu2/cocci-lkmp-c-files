...
position p;
@@
 struct epoll_mtcontext cocci_id@p ;
...
typedef pthread_t;
@@
 struct epoll_mtcontext {  int efd [ 3 ] ;  int sfd [ 4 ] ;  int count ;  pthread_t main ;  pthread_t waiter ; } cocci_id@p ;
...
position p;
@@
 struct epoll_event cocci_id@p [ 2 ] ;
