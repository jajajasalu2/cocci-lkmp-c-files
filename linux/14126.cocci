...
position p;
@@
 struct isp_interface_lcx_config * cocci_id@p ;
...
position p;
@@
 struct isp_ccp2_device * cocci_id@p ;
...
position p;
@@
 struct isp_interface_mem_config * cocci_id@p ;
...
position p;
@@
 const struct isp_ccp2_cfg * cocci_id@p ;
