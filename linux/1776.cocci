...
typedef bool;
@@
 struct isl29018_chip {  struct regmap * regmap ;  struct mutex lock ;  int type ;  unsigned int calibscale ;  unsigned int ucalibscale ;  unsigned int int_time ;  struct isl29018_scale scale ;  int prox_scheme ;  bool suspended ;  struct regulator * vcc_reg ; } cocci_id@p ;
...
position p;
@@
 const struct isl29018_chip_info cocci_id@p [ ] ;
...
position p;
@@
 struct isl29018_chip * cocci_id@p ;
...
position p;
@@
 enum isl29018_int_time { ISL29018_INT_TIME_16 , ISL29018_INT_TIME_12 , ISL29018_INT_TIME_8 , ISL29018_INT_TIME_4 , } cocci_id@p ;
...
position p;
@@
 enum { isl29018 , isl29023 , isl29035 , } cocci_id@p ;
...
position p;
@@
 struct isl29018_chip_info {  const struct iio_chan_spec * channels ;  int num_channels ;  const struct iio_info * indio_info ;  const struct regmap_config * regmap_cfg ; } cocci_id@p ;
...
position p;
@@
 struct isl29018_scale cocci_id@p ;
...
position p;
@@
 const struct isl29018_scale {  unsigned int scale ;  unsigned int uscale ; } cocci_id@p [ 4 ] [ 4 ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ 3 ] [ 4 ] ;
