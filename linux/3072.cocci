...
position p;
@@
 struct cdrom_multisession cocci_id@p ;
...
position p;
@@
 struct blkfront_info * cocci_id@p ;
...
position p;
@@
 struct blkfront_ring_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct blkfront_info * info ) ;
...
typedef grant_ref_t;
@@
 struct grant {  grant_ref_t gref ;  struct page * page ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 enum blk_req_status cocci_id@p ;
...
position p;
@@
 enum blk_req_status { REQ_WAITING , REQ_DONE , REQ_ERROR , REQ_EOPNOTSUPP , } cocci_id@p ;
...
typedef grant_ref_t;
@@
 grant_ref_t cocci_id@p [ XENBUS_MAX_RING_GRANTS ] ;
...
position p;
@@
 enum blkif_state { BLKIF_STATE_DISCONNECTED , BLKIF_STATE_CONNECTED , BLKIF_STATE_SUSPENDED , } cocci_id@p ;
...
position p;
@@
 const struct blkfront_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct blkfront_info * info ) ;
...
position p;
@@
 const struct blk_shadow * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct blkfront_ring_info * rinfo ) ;
...
typedef blk_status_t;
@@
 struct blkif_req {  blk_status_t error ; } cocci_id@p ;
...
position p;
@@
 struct xenbus_transaction cocci_id@p ;
...
@@
 struct blkfront_info {  struct mutex mutex ;  struct xenbus_device * xbdev ;  struct gendisk * gd ;  u16 sector_size ;  unsigned int physical_sector_size ;  int vdevice ;  blkif_vdev_t handle ;  enum blkif_state connected ;  unsigned int nr_ring_pages ;  struct request_queue * rq ;  unsigned int feature_flush : 1 ;  unsigned int feature_fua : 1 ;  unsigned int feature_discard : 1 ;  unsigned int feature_secdiscard : 1 ;  unsigned int feature_persistent : 1 ;  unsigned int discard_granularity ;  unsigned int discard_alignment ;  unsigned int max_indirect_segments ;  int is_ready ;  struct blk_mq_tag_set tag_set ;  struct blkfront_ring_info * rinfo ;  unsigned int nr_rings ;  struct list_head requests ;  struct bio_list bio_list ;  struct list_head info_list ; } cocci_id@p ;
...
position p;
@@
 struct blkif_request_segment cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ RINGREF_NAME_LEN ] ;
...
position p;
@@
 struct copy_from_grant {  const struct blk_shadow * s ;  unsigned int grant_idx ;  unsigned int bvec_offset ;  char * bvec_data ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef blkif_sector_t;
@@
 blkif_sector_t cocci_id@p ;
...
position p;
@@
 struct setup_rw_req cocci_id@p ;
...
position p;
@@
 struct copy_from_grant * cocci_id@p ;
...
position p;
@@
 struct blkif_request * * cocci_id@p ;
...
position p;
@@
 struct blkif_response * cocci_id@p ;
