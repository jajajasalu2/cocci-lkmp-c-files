...
position p;
@@
 enum controller { BIOS = 0 , SNOOP = 1 , PDC20230 = 2 , HT6560A = 3 , HT6560B = 4 , OPTI611A = 5 , OPTI46X = 6 , QDI6500 = 7 , QDI6580 = 8 , QDI6580DP = 9 , W83759A = 10 , UNKNOWN = - 1 , } cocci_id@p ;
...
position p;
@@
 struct legacy_controller cocci_id@p [ ] ;
...
position p;
@@
 struct ata_host * cocci_id@p [ NR_HOST ] ;
...
position p;
@@
 struct legacy_probe cocci_id@p [ NR_HOST ] ;
...
typedef u8;
@@
 struct legacy_data {  unsigned long timing ;  u8 clock [ 2 ] ;  u8 last ;  int fast ;  enum controller type ;  struct platform_device * platform_dev ; } cocci_id@p ;
...
position p;
@@
 struct legacy_probe * cocci_id@p ;
...
position p;
@@
 struct legacy_data cocci_id@p [ NR_HOST ] ;
...
position p;
@@
 struct legacy_probe {  unsigned char * name ;  unsigned long port ;  unsigned int irq ;  unsigned int slot ;  enum controller type ;  unsigned long private ; } cocci_id@p ;
