...
position p;
@@
 const struct vsock_transport * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sock * sk , struct sockaddr_vm * addr ) ;
...
position p;
@@
 struct list_head cocci_id@p [ VSOCK_HASH_SIZE ] ;
...
position p;
@@
 struct list_head cocci_id@p [ VSOCK_HASH_SIZE + 1 ] ;
