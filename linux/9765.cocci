...
typedef s32;
@@
 const s32 cocci_id@p [ POWER_MODES ] ;
...
position p;
@@
 struct ipw2100_status cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 index ;  const char * name ;  const char * desc ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ IW_ESSID_MAX_SIZE + 1 ] ;
...
position p;
@@
 struct ipw2100_ordinals * cocci_id@p ;
...
position p;
@@
 struct host_command cocci_id@p ;
...
position p;
@@
 struct symbol_alive_response cocci_id@p ;
...
typedef u32;
@@
 struct ipw2100_status_indicator {  int status ;  void ( * cb ) ( struct ipw2100_priv * priv , u32 status ) ;  char * name ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ IW_ESSID_MAX_SIZE ] ;
...
position p;
@@
 struct ipw2100_fw_header cocci_id@p ;
...
typedef u32;
@@
 const struct {  u32 addr ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ipw2100_bd_queue * cocci_id@p ;
...
position p;
@@
 struct ipw2100_tx_packet cocci_id@p ;
...
position p;
@@
 struct security_info_params * cocci_id@p ;
...
typedef u8;
@@
 struct ipw2100_wep_key {  u8 idx ;  u8 len ;  u8 key [ 13 ] ; } cocci_id@p ;
...
position p;
@@
 struct ipw2100_status_queue * cocci_id@p ;
...
position p;
@@
 struct ipw2100_wpa_assoc_frame * cocci_id@p ;
...
position p;
@@
 struct ipw2100_data_header cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ipw2100_priv * priv ) ;
...
position p;
@@
 struct ipw2100_rx_packet * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_FW_VERSION_LEN ] ;
...
position p;
@@
 struct ipw2100_cmd_header cocci_id@p ;
...
position p;
@@
 struct ipw2100_wep_key cocci_id@p ;
...
position p;
@@
 struct pm_qos_request cocci_id@p ;
...
typedef u8,u16;
@@
 struct symbol_alive_response {  u8 cmd_id ;  u8 seq_num ;  u8 ucode_rev ;  u8 eeprom_valid ;  u16 valid_flags ;  u8 IEEE_addr [ 6 ] ;  u16 flags ;  u16 pcb_rev ;  u16 clock_settle_time ;  u16 powerup_settle_time ;  u16 hop_settle_time ;  u8 date [ 3 ] ;  u8 time [ 2 ] ;  u8 ucode_valid ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ipw2100_priv * priv ) ;
...
position p;
@@
 struct libipw_hdr_3addr cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ipw2100_priv * priv , struct ipw2100_fw * fw ) ;
...
position p;
@@
 int cocci_id@p ( struct ipw2100_priv * priv , struct ipw2100_fw * fw ) ;
...
position p;
@@
 struct ipw2100_priv * cocci_id@p ;
...
typedef u32;
@@
 const struct {  u32 addr ;  const char * name ;  size_t size ; } cocci_id@p [ ] ;
...
typedef s8;
@@
 struct ipw_rt_hdr {  struct ieee80211_radiotap_header rt_hdr ;  s8 rt_dbmsignal ; } * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IPW_RX_NIC_BUFFER_LENGTH ] ;
...
position p;
@@
 enum { POOR = 30 , FAIR = 60 , GOOD = 80 , VERY_GOOD = 90 , EXCELLENT = 95 , PERFECT = 100 , } cocci_id@p ;
...
typedef u32;
@@
 struct ipw2100_status_indicator {  int status ;  void ( * cb ) ( struct ipw2100_priv * priv , u32 status ) ; } cocci_id@p ;
...
position p;
@@
 const struct ipw2100_status_indicator cocci_id@p [ ] ;
