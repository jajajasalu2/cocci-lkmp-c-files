...
position p;
@@
 struct rxrpc_channel * cocci_id@p ;
...
position p;
@@
 struct rxrpc_jumbo_header cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rxrpc_serial_t;
@@
 rxrpc_serial_t cocci_id@p ;
...
position p;
@@
 struct rxrpc_ack_summary cocci_id@p ;
...
position p;
@@
 struct rxrpc_ackinfo * cocci_id@p ;
...
typedef u8;
@@
 union {  struct rxrpc_ackpacket ack ;  struct rxrpc_ackinfo info ;  u8 acks [ RXRPC_MAXACKS ] ; } cocci_id@p ;
...
position p;
@@
 enum rxrpc_congest_change cocci_id@p ;
...
position p;
@@
 enum rxrpc_call_state cocci_id@p ;
