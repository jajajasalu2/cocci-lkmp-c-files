...
position p;
@@
 struct ewma_psr_time * cocci_id@p ;
...
position p;
@@
 struct drm_self_refresh_data * cocci_id@p ;
...
position p;
@@
 struct drm_self_refresh_data {  struct drm_crtc * crtc ;  struct delayed_work entry_work ;  struct mutex avg_mutex ;  struct ewma_psr_time entry_avg_ms ;  struct ewma_psr_time exit_avg_ms ; } cocci_id@p ;
