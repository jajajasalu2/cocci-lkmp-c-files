...
typedef u8,u32,u16;
@@
 struct i3000_error_info {  u16 errsts ;  u8 derrsyn ;  u8 edeap ;  u32 deap ;  u16 errsts2 ; } cocci_id@p ;
...
position p;
@@
 struct i3000_dev_info {  const char * ctl_name ; } cocci_id@p ;
...
position p;
@@
 struct i3000_error_info * cocci_id@p ;
...
position p;
@@
 enum i3000p_chips { I3000 = 0 , } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ I3000_RANKS / 2 ] ;
...
position p;
@@
 const struct i3000_dev_info cocci_id@p [ ] ;
