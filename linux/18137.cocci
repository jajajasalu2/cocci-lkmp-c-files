...
position p;
@@
 enum armv6_counters { ARMV6_CYCLE_COUNTER = 0 , ARMV6_COUNTER0 , ARMV6_COUNTER1 , } cocci_id@p ;
...
position p;
@@
 enum armv6_counters cocci_id@p ;
