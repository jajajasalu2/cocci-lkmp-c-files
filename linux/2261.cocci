...
position p;
@@
 struct thermal_mmio * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct platform_device * pdev , struct thermal_mmio * sensor ) ;
...
position p;
@@
 struct thermal_zone_of_device_ops cocci_id@p ;
...
typedef u32;
@@
 struct thermal_mmio {  void __iomem * mmio_base ;  u32 ( * read_mmio ) ( void __iomem * mmio_base ) ;  u32 mask ;  int factor ; } cocci_id@p ;
