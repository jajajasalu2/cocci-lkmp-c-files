...
typedef u8;
@@
 u8 cocci_id@p [ RT5677_SPI_BURST_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ RT5677_SPI_HEADER + RT5677_SPI_BURST_LEN + 1 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ RT5677_SPI_HEADER + 4 ] ;
...
typedef bool,u32;
@@
 struct rt5677_dsp {  struct device * dev ;  struct delayed_work copy_work ;  struct mutex dma_lock ;  struct snd_pcm_substream * substream ;  size_t dma_offset ;  size_t avail_bytes ;  u32 mic_read_offset ;  bool new_hotword ; } cocci_id@p ;
