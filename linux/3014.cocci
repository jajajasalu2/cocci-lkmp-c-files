...
position p;
@@
 void cocci_id@p ( struct acpi_device * device ) ;
...
position p;
@@
 struct acpi_pci_link {  struct list_head list ;  struct acpi_device * device ;  struct acpi_pci_link_irq irq ;  int refcnt ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct acpi_pci_link_irq {  u32 active ;  u8 triggering ;  u8 polarity ;  u8 resource_type ;  u8 possible_count ;  u32 possible [ ACPI_PCI_LINK_MAX_POSSIBLE ] ;  u8 initialized : 1 ;  u8 reserved : 7 ; } cocci_id@p ;
...
position p;
@@
 struct acpi_pci_link cocci_id@p ;
...
position p;
@@
 struct {  struct acpi_resource res ;  struct acpi_resource end ; } * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct acpi_device * device , const struct acpi_device_id * not_used ) ;
...
position p;
@@
 int cocci_id@p [ ACPI_MAX_ISA_IRQS ] ;
