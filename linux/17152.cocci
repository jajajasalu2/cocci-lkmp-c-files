...
position p;
@@
 void cocci_id@p ( unsigned long offset , struct cpu_spec * spec ) ;
...
position p;
@@
 struct static_key_true cocci_id@p [ NUM_MMU_FTR_KEYS ] ;
...
position p;
@@
 struct static_key_true cocci_id@p [ NUM_CPU_FTR_KEYS ] ;
