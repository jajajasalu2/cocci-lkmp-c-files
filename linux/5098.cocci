...
position p;
@@
 struct rdc321x_gpio cocci_id@p ;
...
position p;
@@
 struct rdc321x_gpio_pdata * cocci_id@p ;
...
@@
 struct rdc321x_gpio {  spinlock_t lock ;  struct pci_dev * sb_pdev ;  u32 data_reg [ 2 ] ;  int reg1_ctrl_base ;  int reg1_data_base ;  int reg2_ctrl_base ;  int reg2_data_base ;  struct gpio_chip chip ; } cocci_id@p ;
