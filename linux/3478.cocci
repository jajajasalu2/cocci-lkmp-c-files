...
position p;
@@
 const struct sunxi_mmc_clk_delay cocci_id@p [ ] ;
...
@@
 struct sunxi_mmc_host {  struct device * dev ;  struct mmc_host * mmc ;  struct reset_control * reset ;  const struct sunxi_mmc_cfg * cfg ;  void __iomem * reg_base ;  struct clk * clk_ahb ;  struct clk * clk_mmc ;  struct clk * clk_sample ;  struct clk * clk_output ;  spinlock_t lock ;  int irq ;  u32 int_sum ;  u32 sdio_imask ;  dma_addr_t sg_dma ;  void * sg_cpu ;  bool wait_dma ;  struct mmc_request * mrq ;  struct mmc_request * manual_stop_mrq ;  int ferror ;  bool vqmmc_enabled ;  bool use_new_timings ; } cocci_id@p ;
...
position p;
@@
 struct sunxi_idma_des cocci_id@p ;
...
typedef bool,u32;
@@
 struct sunxi_mmc_cfg {  u32 idma_des_size_bits ;  const struct sunxi_mmc_clk_delay * clk_delays ;  bool can_calibrate ;  bool mask_data0 ;  bool needs_new_timings ;  bool ccu_has_timings_switch ; } cocci_id@p ;
...
position p;
@@
 struct sunxi_mmc_host * cocci_id@p ;
...
typedef __le32;
@@
 struct sunxi_idma_des {  __le32 config ;  __le32 buf_size ;  __le32 buf_addr_ptr1 ;  __le32 buf_addr_ptr2 ; } cocci_id@p ;
...
typedef u32;
@@
 struct sunxi_mmc_clk_delay {  u32 output ;  u32 sample ; } cocci_id@p ;
...
position p;
@@
 const struct sunxi_mmc_cfg cocci_id@p ;
