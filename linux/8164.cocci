...
position p;
@@
 enum mii_reg_bits { MDIO_ShiftClk = 0x0001 , MDIO_Data = 0x0002 , MDIO_EnbOutput = 0x0004 , } cocci_id@p ;
...
position p;
@@
 enum wake_event_bits { WakePktEnable = 0x01 , MagicPktEnable = 0x02 , LinkEventEnable = 0x04 , WolEnable = 0x80 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int wait ) ;
...
position p;
@@
 const struct {  const char name [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 enum mac_ctrl1_bits { StatsEnable = 0x0020 , StatsDisable = 0x0040 , StatsEnabled = 0x0080 , TxEnable = 0x0100 , TxDisable = 0x0200 , TxEnabled = 0x0400 , RxEnable = 0x0800 , RxDisable = 0x1000 , RxEnabled = 0x2000 , } cocci_id@p ;
...
position p;
@@
 enum mac_ctrl0_bits { EnbFullDuplex = 0x20 , EnbRcvLargeFrame = 0x40 , EnbFlowCtrl = 0x100 , EnbPassRxCRC = 0x200 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int intr_status ) ;
...
position p;
@@
 struct pci_id_info {  const char * name ; } cocci_id@p ;
...
position p;
@@
 enum ASICCtrl_HiWord_bit { GlobalReset = 0x0001 , RxReset = 0x0002 , TxReset = 0x0004 , DMAReset = 0x0008 , FIFOReset = 0x0010 , NetworkReset = 0x0020 , HostReset = 0x0040 , ResetBusy = 0x0400 , } cocci_id@p ;
...
position p;
@@
 enum intr_status_bits { IntrSummary = 0x0001 , IntrPCIErr = 0x0002 , IntrMACCtrl = 0x0008 , IntrTxDone = 0x0004 , IntrRxDone = 0x0010 , IntrRxStart = 0x0020 , IntrDrvRqst = 0x0040 , StatsMax = 0x0080 , LinkChange = 0x0100 , IntrTxDMADone = 0x0200 , IntrRxDMADone = 0x0400 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int new_mtu ) ;
...
position p;
@@
 enum { netdev_io_size = 128 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void __iomem * ioaddr , int location ) ;
...
position p;
@@
 const struct pci_id_info cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , void * data ) ;
...
position p;
@@
 enum desc_status_bits { DescOwn = 0x8000 , DescEndPacket = 0x4000 , DescEndRing = 0x2000 , LastFrag = 0x80000000 , DescIntrOnTx = 0x8000 , DescIntrOnDMADone = 0x80000000 , DisableAlign = 0x00000001 , } cocci_id@p ;
...
position p;
@@
 enum rx_mode_bits { AcceptAllIPMulti = 0x20 , AcceptMultiHash = 0x10 , AcceptAll = 0x08 , AcceptBroadcast = 0x04 , AcceptMulticast = 0x02 , AcceptMyPhys = 0x01 , } cocci_id@p ;
