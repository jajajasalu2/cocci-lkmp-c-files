...
position p;
@@
 const struct orion_spi_dev cocci_id@p ;
...
position p;
@@
 enum orion_spi_type { ORION_SPI , ARMADA_SPI , } cocci_id@p ;
...
position p;
@@
 struct orion_direct_acc * cocci_id@p ;
...
typedef bool,u32;
@@
 struct orion_spi_dev {  enum orion_spi_type typ ;  unsigned long max_hz ;  unsigned int min_divisor ;  unsigned int max_divisor ;  u32 prescale_mask ;  bool is_errata_50mhz_ac ; } cocci_id@p ;
...
position p;
@@
 struct orion_spi {  struct spi_master * master ;  void __iomem * base ;  struct clk * clk ;  struct clk * axi_clk ;  const struct orion_spi_dev * devdata ;  int unused_hw_gpio ;  struct orion_child_options child [ ORION_NUM_CHIPSELECTS ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct orion_direct_acc {  void __iomem * vaddr ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 struct orion_child_options {  struct orion_direct_acc direct_access ; } cocci_id@p ;
