...
typedef u8;
@@
 const u8 cocci_id@p [ NUM_GAMMA_LEVELS ] [ GAMMA_TABLE_COUNT ] ;
...
typedef bool;
@@
 struct s6e63m0 {  struct device * dev ;  struct drm_panel panel ;  struct backlight_device * bl_dev ;  struct regulator_bulk_data supplies [ 2 ] ;  struct gpio_desc * reset_gpio ;  bool prepared ;  bool enabled ;  int error ; } cocci_id@p ;
