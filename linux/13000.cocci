...
typedef u32;
@@
 struct renesas_family {  const char name [ 16 ] ;  u32 reg ; } cocci_id@p ;
...
position p;
@@
 const struct renesas_soc cocci_id@p ;
...
position p;
@@
 const struct renesas_family cocci_id@p ;
...
typedef u8;
@@
 struct renesas_soc {  const struct renesas_family * family ;  u8 id ; } cocci_id@p ;
