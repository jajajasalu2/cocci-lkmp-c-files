...
position p;
@@
 struct socrates_fpga_irq_info * cocci_id@p ;
...
position p;
@@
 struct socrates_fpga_irq_info {  unsigned int irq_line ;  int type ; } cocci_id@p ;
...
position p;
@@
 struct socrates_fpga_irq_info cocci_id@p [ SOCRATES_FPGA_NUM_IRQS ] ;
