...
symbol cocci_id;
position p;
typedef xfs_attr_sf_entry_t;
@@
 xfs_attr_sf_entry_t * cocci_id@p ;
...
position p;
@@
 struct xfs_attr_sf_hdr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_da_args_t;
@@
 xfs_da_args_t * cocci_id@p ;
...
position p;
@@
 struct xfs_da_intnode * cocci_id@p ;
...
position p;
@@
 struct xfs_attr_leaf_name_local * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xfs_da_args * args , struct xfs_attr3_icleaf_hdr * ichdr , struct xfs_buf * leaf_buffer ) ;
...
symbol cocci_id;
position p;
typedef xfs_attr_leaf_name_remote_t;
@@
 xfs_attr_leaf_name_remote_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_attr_leaf_name_local_t;
@@
 xfs_attr_leaf_name_local_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_attr_sf_hdr_t;
@@
 xfs_attr_sf_hdr_t cocci_id@p ;
...
position p;
@@
 struct xfs_attr_leaf_entry * cocci_id@p ;
...
position p;
@@
 struct xfs_attr_shortform * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_attr_leafblock_t;
@@
 int cocci_id@p ( xfs_attr_leafblock_t * leaf , int index ) ;
...
position p;
@@
 struct xfs_attr3_leaf_hdr cocci_id@p ;
...
position p;
@@
 struct xfs_attr_sf_entry cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xfs_da_args * args , struct xfs_attr_leafblock * src_leaf , struct xfs_attr3_icleaf_hdr * src_ichdr , int src_start , struct xfs_attr_leafblock * dst_leaf , struct xfs_attr3_icleaf_hdr * dst_ichdr , int dst_start , int move_count ) ;
...
symbol cocci_id;
position p;
typedef xfs_attr_shortform_t;
@@
 xfs_attr_shortform_t * cocci_id@p ;
...
position p;
@@
 struct xfs_attr_leafblock * cocci_id@p ;
...
position p;
@@
 const struct xfs_buf_ops cocci_id@p ;
...
position p;
@@
 struct xfs_da3_icnode_hdr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dahash_t;
@@
 xfs_dahash_t cocci_id@p ;
...
position p;
@@
 struct xfs_da_geometry * cocci_id@p ;
...
position p;
@@
 struct xfs_attr_leaf_name_remote * cocci_id@p ;
...
typedef xfs_attr_leafblock_t;
@@
 xfs_attr_leafblock_t * cocci_id@p ;
...
position p;
@@
 struct xfs_attr3_icleaf_hdr * cocci_id@p ;
...
position p;
@@
 struct xfs_da_state_blk * cocci_id@p ;
...
position p;
@@
 struct xfs_da_state * cocci_id@p ;
...
position p;
@@
 struct xfs_attr_leaf_hdr cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xfs_buf * leaf_buffer , struct xfs_attr3_icleaf_hdr * ichdr , struct xfs_da_args * args , int freemap_index ) ;
