...
position p;
@@
 struct vub300_mmc_host cocci_id@p ;
...
position p;
@@
 struct sdio_register {  unsigned func_num : 3 ;  unsigned sdio_reg : 17 ;  unsigned activate : 1 ;  unsigned prepared : 1 ;  unsigned regvalue : 8 ;  unsigned response : 8 ;  unsigned sparebit : 26 ; } cocci_id@p ;
...
position p;
@@
 struct offload_registers_access cocci_id@p ;
...
position p;
@@
 struct sd_register_header cocci_id@p ;
...
position p;
@@
 enum SD_RESPONSE_TYPE { SDRT_UNSPECIFIED = 0 , SDRT_NONE , SDRT_1 , SDRT_1B , SDRT_2 , SDRT_3 , SDRT_4 , SDRT_5 , SDRT_5B , SDRT_6 , SDRT_7 , } cocci_id@p ;
