...
typedef u32;
@@
 struct acpi_table {  struct config_item cfg ;  struct acpi_table_header * header ;  u32 index ; } cocci_id@p ;
...
position p;
@@
 struct configfs_bin_attribute * cocci_id@p [ ] ;
