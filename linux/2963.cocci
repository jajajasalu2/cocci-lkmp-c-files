...
position p;
@@
 struct acpi_power_dependent_device {  struct device * dev ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct acpi_power_resource_entry * cocci_id@p ;
...
position p;
@@
 struct acpi_power_resource cocci_id@p ;
...
position p;
@@
 struct acpi_power_dependent_device * cocci_id@p ;
...
typedef bool,u32;
@@
 struct acpi_power_resource {  struct acpi_device device ;  struct list_head list_node ;  char * name ;  u32 system_level ;  u32 order ;  unsigned int ref_count ;  bool wakeup_enabled ;  struct mutex resource_lock ;  struct list_head dependents ; } cocci_id@p ;
...
position p;
@@
 struct acpi_power_resource_entry {  struct list_head node ;  struct acpi_power_resource * resource ; } cocci_id@p ;
