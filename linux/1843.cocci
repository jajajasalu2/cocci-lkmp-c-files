...
position p;
@@
 const struct rockchip_saradc_data cocci_id@p ;
...
typedef u16;
@@
 struct rockchip_saradc {  void __iomem * regs ;  struct clk * pclk ;  struct clk * clk ;  struct completion completion ;  struct regulator * vref ;  struct reset_control * reset ;  const struct rockchip_saradc_data * data ;  u16 last_val ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_saradc * cocci_id@p ;
...
position p;
@@
 struct rockchip_saradc_data {  int num_bits ;  const struct iio_chan_spec * channels ;  int num_channels ;  unsigned long clk_rate ; } cocci_id@p ;
