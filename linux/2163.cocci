...
position p;
@@
 struct pm860x_battery_info {  struct pm860x_chip * chip ;  struct i2c_client * i2c ;  struct device * dev ;  struct power_supply * battery ;  struct mutex lock ;  int status ;  int irq_cc ;  int irq_batt ;  int max_capacity ;  int resistor ;  int last_capacity ;  int start_soc ;  unsigned present : 1 ;  unsigned temp_type : 1 ; } cocci_id@p ;
...
position p;
@@
 struct ccnt {  unsigned long long int pos ;  unsigned long long int neg ;  unsigned int spos ;  unsigned int sneg ;  int total_chg ;  int total_dischg ; } cocci_id@p ;
...
position p;
@@
 struct pm860x_battery_info * cocci_id@p ;
