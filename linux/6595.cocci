...
position p;
@@
 struct isci_pci_info * cocci_id@p ;
...
position p;
@@
 struct sci_oem_params * cocci_id@p ;
...
position p;
@@
 struct sci_phy_proto * cocci_id@p ;
...
position p;
@@
 enum sci_phy_states cocci_id@p ;
...
position p;
@@
 struct sci_phy_oem_params * cocci_id@p ;
...
position p;
@@
 struct sci_phy_user_params * cocci_id@p ;
...
position p;
@@
 struct sci_sas_address * cocci_id@p ;
