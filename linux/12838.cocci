...
position p;
@@
 struct tegra_emc {  struct device * dev ;  struct completion clk_handshake_complete ;  struct notifier_block clk_nb ;  struct clk * clk ;  void __iomem * regs ;  struct emc_timing * timings ;  unsigned int num_timings ; } cocci_id@p ;
...
typedef u32;
@@
 struct emc_timing {  unsigned long rate ;  u32 data [ ARRAY_SIZE ( emc_timing_registers ) ] ; } cocci_id@p ;
