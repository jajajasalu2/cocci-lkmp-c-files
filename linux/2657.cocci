...
typedef u8,u32;
@@
 struct bcm2835_i2c_dev {  struct device * dev ;  void __iomem * regs ;  int irq ;  struct i2c_adapter adapter ;  struct completion completion ;  struct i2c_msg * curr_msg ;  int num_msgs ;  u32 msg_err ;  u8 * msg_buf ;  size_t msg_buf_remaining ; } cocci_id@p ;
...
position p;
@@
 struct bcm2835_i2c_dev * cocci_id@p ;
...
position p;
@@
 struct clk_bcm2835_i2c {  struct clk_hw hw ;  struct bcm2835_i2c_dev * i2c_dev ; } cocci_id@p ;
...
position p;
@@
 struct clk_bcm2835_i2c cocci_id@p ;
