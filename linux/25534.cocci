...
position p;
@@
 struct perf_hpp_list_node cocci_id@p ;
...
position p;
@@
 const struct hist_entry * cocci_id@p ;
...
position p;
@@
 check_output_full_fn cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct hist_browser * browser , unsigned short row ) ;
...
position p;
@@
 const struct callchain_list * cocci_id@p ;
...
position p;
@@
 struct callchain_print_arg * cocci_id@p ;
...
position p;
@@
 struct popup_action * cocci_id@p ;
...
typedef bool;
@@
 struct hpp_arg {  struct ui_browser * b ;  char folded_sign ;  bool current_entry ; } cocci_id@p ;
...
position p;
@@
 struct hist_browser_timer * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef FILE,bool,off_t;
@@
 struct callchain_print_arg {  off_t row_offset ;  bool is_current_entry ;  FILE * fp ;  int printed ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hist_browser * hb ) ;
...
position p;
@@
 struct popup_action cocci_id@p [ MAX_OPTIONS ] ;
...
position p;
@@
 print_callchain_entry_fn cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct hist_browser * browser , struct callchain_list * chain , const char * str , int offset , unsigned short row , struct callchain_print_arg * arg ) ;
...
position p;
@@
 struct rb_node * cocci_id@p ( struct rb_node * nd , float min_pcnt ) ;
