...
position p;
@@
 enum { MCR20A_CCA_ED , MCR20A_CCA_MODE1 , MCR20A_CCA_MODE2 , MCR20A_CCA_MODE3 , } cocci_id@p ;
...
typedef s32;
@@
 const s32 cocci_id@p [ MCR20A_MAX_TX_POWERS + 1 ] ;
...
position p;
@@
 struct mcr20a_local * cocci_id@p ;
...
position p;
@@
 enum { MCR20A_XCVSEQ_IDLE = 0x00 , MCR20A_XCVSEQ_RX = 0x01 , MCR20A_XCVSEQ_TX = 0x02 , MCR20A_XCVSEQ_CCA = 0x03 , MCR20A_XCVSEQ_TR = 0x04 , MCR20A_XCVSEQ_CCCA = 0x05 , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct mcr20a_local {  struct spi_device * spi ;  struct ieee802154_hw * hw ;  struct regmap * regmap_dar ;  struct regmap * regmap_iar ;  u8 * buf ;  bool is_tx ;  struct spi_message tx_buf_msg ;  u8 tx_header [ 1 ] ;  struct spi_transfer tx_xfer_header ;  u8 tx_len [ 1 ] ;  struct spi_transfer tx_xfer_len ;  struct spi_transfer tx_xfer_buf ;  struct sk_buff * tx_skb ;  struct spi_message reg_msg ;  u8 reg_cmd [ 1 ] ;  u8 reg_data [ MCR20A_IRQSTS_NUM ] ;  struct spi_transfer reg_xfer_cmd ;  struct spi_transfer reg_xfer_data ;  struct spi_message rx_buf_msg ;  u8 rx_header [ 1 ] ;  struct spi_transfer rx_xfer_header ;  u8 rx_lqi [ 1 ] ;  struct spi_transfer rx_xfer_lqi ;  u8 rx_buf [ MCR20A_MAX_BUF ] ;  struct spi_transfer rx_xfer_buf ;  struct spi_message irq_msg ;  u8 irq_header [ 1 ] ;  u8 irq_data [ MCR20A_IRQSTS_NUM ] ;  struct spi_transfer irq_xfer_data ;  struct spi_transfer irq_xfer_header ; } cocci_id@p ;
...
typedef s32;
@@
 s32 cocci_id@p [ MCR20A_MAX_ED_LEVELS + 1 ] ;
