...
symbol cocci_id;
position p;
typedef relocate_new_kernel_t;
@@
 relocate_new_kernel_t cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned long indirection_page , unsigned long reboot_code_buffer , unsigned long start_address ) ;
