...
typedef hda_nid_t;
@@
 struct cs_spec {  struct hda_gen_spec gen ;  unsigned int gpio_mask ;  unsigned int gpio_dir ;  unsigned int gpio_data ;  unsigned int gpio_eapd_hp ;  unsigned int gpio_eapd_speaker ;  unsigned int spdif_detect : 1 ;  unsigned int spdif_present : 1 ;  unsigned int sense_b : 1 ;  hda_nid_t vendor_nid ;  int ( * spdif_sw_put ) ( struct snd_kcontrol * kcontrol , struct snd_ctl_elem_value * ucontrol ) ; } cocci_id@p ;
...
position p;
@@
 enum { CS421X_CDB4210 , CS421X_SENSE_B , CS421X_STUMPY , } cocci_id@p ;
...
position p;
@@
 enum { CS420X_MBP53 , CS420X_MBP55 , CS420X_IMAC27 , CS420X_GPIO_13 , CS420X_GPIO_23 , CS420X_MBP101 , CS420X_MBP81 , CS420X_MBA42 , CS420X_AUTO , CS420X_IMAC27_122 = CS420X_GPIO_23 , CS420X_APPLE = CS420X_GPIO_13 , } cocci_id@p ;
...
position p;
@@
 enum { CS4208_MAC_AUTO , CS4208_MBA6 , CS4208_MBP11 , CS4208_MACMINI , CS4208_GPIO0 , } cocci_id@p ;
