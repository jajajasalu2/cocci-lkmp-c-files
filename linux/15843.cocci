...
position p;
@@
 void cocci_id@p ( _workitem * work ) ;
...
position p;
@@
 struct pwrctrl_priv * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cmd_priv * pcmdpriv , struct cmd_obj * cmd_obj ) ;
...
position p;
@@
 struct _cmd_callback cocci_id@p [ ] ;
...
position p;
@@
 struct set_stakey_rsp cocci_id@p ;
...
position p;
@@
 struct setdatarate_parm cocci_id@p ;
...
position p;
@@
 struct drvextra_cmd_parm cocci_id@p ;
...
position p;
@@
 struct set_assocsta_rsp * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct adapter * padapter , u8 lps_ctrl_type ) ;
...
typedef u8;
@@
 u8 ( * cocci_id@p ) ( struct adapter * padapter , u8 * pbuf ) ;
...
position p;
@@
 struct set_assocsta_parm * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct adapter * dev , struct cmd_obj * pcmd ) ;
...
position p;
@@
 enum NDIS_802_11_NETWORK_INFRASTRUCTURE cocci_id@p ;
