...
position p;
@@
 void cocci_id@p ( struct bttv * btv , unsigned char eeprom_data [ 256 ] ) ;
...
position p;
@@
 void cocci_id@p ( struct bttv * btv ) ;
...
position p;
@@
 void cocci_id@p ( struct bttv * btv , unsigned int input ) ;
...
position p;
@@
 struct bttv_tea575x_gpio cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct bttv * btv ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct bttv * btv , const u8 ee [ 256 ] ) ;
...
position p;
@@
 void cocci_id@p ( struct bttv * btv , int pin ) ;
...
position p;
@@
 struct CARD {  unsigned id ;  int cardnr ;  char * name ; } cocci_id@p [ ] ;
