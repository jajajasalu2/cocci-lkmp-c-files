...
position p;
@@
 struct a2150_private {  struct comedi_isadma * dma ;  unsigned int count ;  int irq_dma_bits ;  int config_bits ; } cocci_id@p ;
...
position p;
@@
 const struct a2150_board cocci_id@p [ ] ;
...
position p;
@@
 enum { a2150_c , a2150_s , } cocci_id@p ;
...
position p;
@@
 struct a2150_board {  const char * name ;  int clock [ 4 ] ;  int num_clocks ;  int ai_speed ; } cocci_id@p ;
...
position p;
@@
 struct a2150_private * cocci_id@p ;
