...
position p;
@@
 struct hdat_fadump_thread_hdr cocci_id@p ;
...
position p;
@@
 struct opalcore_config * cocci_id@p ;
...
typedef u64,loff_t;
@@
 struct opalcore {  struct list_head list ;  u64 paddr ;  size_t size ;  loff_t offset ; } cocci_id@p ;
...
typedef u64,u32;
@@
 struct opalcore_config {  u32 num_cpus ;  u32 crashing_cpu ;  u64 cpu_state_destination_vaddr ;  u64 cpu_state_data_size ;  u64 cpu_state_entry_size ;  u64 ptload_addr [ MAX_PT_LOAD_CNT ] ;  u64 ptload_size [ MAX_PT_LOAD_CNT ] ;  u64 ptload_cnt ;  Elf64_Phdr * ptload_phdr ;  size_t opalcore_size ;  size_t opalcorebuf_sz ;  char * opalcorebuf ;  char auxv_buf [ AUXV_DESC_SZ ] ; } cocci_id@p ;
...
position p;
@@
 const struct opal_mpipl_fadump * cocci_id@p ;
