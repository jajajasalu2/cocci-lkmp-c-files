...
position p;
@@
 enum rt8973a_event_type { RT8973A_EVENT_ATTACH = 1 , RT8973A_EVENT_DETACH , RT8973A_EVENT_OVP , RT8973A_EVENT_OTP , } cocci_id@p ;
...
position p;
@@
 enum rt8973a_event_type cocci_id@p ;
...
position p;
@@
 struct muic_irq {  unsigned int irq ;  const char * name ;  unsigned int virq ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct reg_data {  u8 reg ;  u8 mask ;  u8 val ;  bool invert ; } cocci_id@p ;
...
position p;
@@
 struct rt8973a_muic_info cocci_id@p ;
