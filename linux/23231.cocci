...
typedef u32;
@@
 struct _pll_div {  u32 pre_div : 1 ;  u32 n : 4 ;  u32 k : 24 ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( unsigned int source , unsigned int target ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_soc_component * component , unsigned int freq_in , unsigned int freq_out ) ;
...
position p;
@@
 struct {  int rate ;  unsigned int val ; } cocci_id@p [ ] ;
