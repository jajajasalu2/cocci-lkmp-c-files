...
position p;
@@
 struct hisi_mmc_clock * cocci_id@p ;
...
typedef u32;
@@
 struct clk_mmc {  struct clk_hw hw ;  u32 id ;  void __iomem * clken_reg ;  u32 clken_bit ;  void __iomem * div_reg ;  u32 div_off ;  u32 div_bits ;  void __iomem * drv_reg ;  u32 drv_off ;  u32 drv_bits ;  void __iomem * sam_reg ;  u32 sam_off ;  u32 sam_bits ; } cocci_id@p ;
...
position p;
@@
 struct hisi_clock_data * cocci_id@p ;
...
typedef u32;
@@
 struct hisi_mmc_clock {  unsigned int id ;  const char * name ;  const char * parent_name ;  unsigned long flags ;  u32 clken_reg ;  u32 clken_bit ;  u32 div_reg ;  u32 div_off ;  u32 div_bits ;  u32 drv_reg ;  u32 drv_off ;  u32 drv_bits ;  u32 sam_reg ;  u32 sam_off ;  u32 sam_bits ; } cocci_id@p ;
