...
typedef u8;
@@
 u8 cocci_id@p [ MLXSW_I2C_READ_SEMA_SIZE ] ;
...
typedef u32,u16;
@@
 struct mlxsw_i2c {  struct {  u32 mb_size_in ;  u32 mb_off_in ;  u32 mb_size_out ;  u32 mb_off_out ;  struct mutex lock ; } cmd ;  struct device * dev ;  struct mlxsw_core * core ;  struct mlxsw_bus_info bus_info ;  u16 block_size ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLXSW_I2C_ADDR_BUF_SIZE ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MLXSW_I2C_MBOX_SIZE ] ;
