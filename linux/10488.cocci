...
position p;
@@
 int cocci_id@p ( struct drm_device * dev , struct drm_file * file_priv ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_device * dev , struct drm_file * file_priv ) ;
...
position p;
@@
 struct dma_buf * cocci_id@p ( struct drm_gem_object * gobj , int flags ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct drm_device * dev , bool resume , bool fbcon ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * arg ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_gem_object * obj , void * vaddr ) ;
...
position p;
@@
 struct sg_table * cocci_id@p ( struct drm_gem_object * obj ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct drm_device * dev , unsigned int pipe ) ;
...
position p;
@@
 int cocci_id@p ( struct drm_file * file_priv , struct drm_device * dev , struct drm_mode_create_dumb * args ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct drm_device * dev ) ;
...
position p;
@@
 int cocci_id@p ( struct drm_device * dev , unsigned int pipe ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_device * dev ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct drm_device * dev , bool suspend , bool fbcon , bool freeze ) ;
...
position p;
@@
 int cocci_id@p ( struct drm_gem_object * obj ) ;
...
position p;
@@
 int cocci_id@p ( struct file * filp , struct vm_area_struct * vma ) ;
...
position p;
@@
 void * cocci_id@p ( struct drm_gem_object * obj ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_gem_object * obj , struct drm_file * file_priv ) ;
...
position p;
@@
 int cocci_id@p ( struct drm_gem_object * obj , struct drm_file * file_priv ) ;
...
position p;
@@
 struct drm_gem_object * cocci_id@p ( struct drm_device * dev , struct dma_buf_attachment * , struct sg_table * sg ) ;
...
position p;
@@
 int cocci_id@p ( struct drm_device * dev ) ;
...
position p;
@@
 int cocci_id@p ( struct drm_device * dev , unsigned long flags ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_device * dev , unsigned int pipe ) ;
