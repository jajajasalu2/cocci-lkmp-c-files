...
position p;
@@
 struct atlx_adapter * cocci_id@p ;
...
typedef s32,u16;
@@
 s32 cocci_id@p ( struct atl1_hw * hw , u16 reg_addr , u16 * phy_data ) ;
...
position p;
@@
 struct atlx_spi_flash_dev cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct atl1_hw * hw ) ;
...
typedef u8,u32;
@@
 u32 cocci_id@p ( struct atl1_hw * hw , u8 * mc_addr ) ;
