...
position p;
@@
 int cocci_id@p ( struct pcmcia_device * link , int start_pg , int stop_pg ) ;
...
position p;
@@
 int cocci_id@p ( struct pcmcia_device * link , int start_pg , int stop_pg , int cm_offset ) ;
