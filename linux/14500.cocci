...
typedef u32;
@@
 struct rockchip_muxgrf_clock {  struct clk_hw hw ;  struct regmap * regmap ;  u32 reg ;  u32 shift ;  u32 width ;  int flags ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_muxgrf_clock cocci_id@p ;
