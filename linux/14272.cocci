...
typedef u8,u16;
@@
 struct cxd2880_ts_buf_info {  u8 read_ready : 1 ;  u8 almost_full : 1 ;  u8 almost_empty : 1 ;  u8 overflow : 1 ;  u8 underflow : 1 ;  u16 pkt_num ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ BURST_WRITE_MAX + 4 ] ;
...
position p;
@@
 struct cxd2880_ts_buf_info * cocci_id@p ;
...
position p;
@@
 struct cxd2880_dvb_spi * cocci_id@p ;
...
typedef u8;
@@
 struct cxd2880_dvb_spi {  struct dvb_frontend dvb_fe ;  struct dvb_adapter adapter ;  struct dvb_demux demux ;  struct dmxdev dmxdev ;  struct dmx_frontend dmx_fe ;  struct task_struct * cxd2880_ts_read_thread ;  struct spi_device * spi ;  struct mutex spi_mutex ;  int feed_count ;  int all_pid_feed_count ;  struct regulator * vcc_supply ;  u8 * ts_buf ;  struct cxd2880_pid_filter_config filter_config ; } cocci_id@p ;
...
position p;
@@
 struct cxd2880_pid_filter_config cocci_id@p ;
...
typedef u8;
@@
 struct cxd2880_pid_filter_config {  u8 is_negative ;  struct cxd2880_pid_config pid_config [ CXD2880_MAX_FILTER_SIZE ] ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct cxd2880_pid_config {  u8 is_enable ;  u16 pid ; } cocci_id@p ;
