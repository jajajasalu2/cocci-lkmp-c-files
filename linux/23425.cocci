...
position p;
@@
 struct aic3x_disable_nb * cocci_id@p ;
...
position p;
@@
 struct aic3x_setup_data * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ AIC3X_NUM_SUPPLIES ] ;
...
position p;
@@
 struct aic3x_disable_nb {  struct notifier_block nb ;  struct aic3x_priv * aic3x ; } cocci_id@p ;
