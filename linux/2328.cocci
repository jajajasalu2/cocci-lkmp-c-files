...
position p;
@@
 struct db8500_thermal_zone * cocci_id@p ;
...
position p;
@@
 struct db8500_thermal_zone {  struct thermal_zone_device * tz ;  enum thermal_trend trend ;  unsigned long interpolated_temp ;  unsigned int cur_index ; } cocci_id@p ;
