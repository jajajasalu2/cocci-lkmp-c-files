...
position p;
@@
 struct clp_fh_list_entry * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct clp_fh_list_entry * , void * ) ;
...
typedef u32;
@@
 struct clp_state_data {  u32 fid ;  enum zpci_state state ; } cocci_id@p ;
...
position p;
@@
 struct clp_req_rsp_set_pci * cocci_id@p ;
...
position p;
@@
 struct clp_state_data cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 _ [ CLP_BLK_SIZE ] ; } * cocci_id@p ;
...
position p;
@@
 struct clp_rsp_query_pci * cocci_id@p ;
...
position p;
@@
 struct clp_req_rsp_slpc * cocci_id@p ;
...
position p;
@@
 struct clp_rsp_query_pci_grp * cocci_id@p ;
...
position p;
@@
 struct clp_req_rsp_list_pci * cocci_id@p ;
...
position p;
@@
 struct clp_req_rsp_query_pci_grp * cocci_id@p ;
...
position p;
@@
 struct clp_req_rsp_query_pci * cocci_id@p ;
