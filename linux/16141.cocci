...
position p;
@@
 struct jr3_pci_dev_private {  struct timer_list timer ;  struct comedi_device * dev ; } cocci_id@p ;
...
position p;
@@
 enum jr3_pci_boardid { BOARD_JR3_1 , BOARD_JR3_2 , BOARD_JR3_3 , BOARD_JR3_4 , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ARRAY_SIZE ( sensor0 -> copyright ) + 1 ] ;
...
position p;
@@
 const struct jr3_pci_transform * cocci_id@p ;
...
position p;
@@
 struct jr3_pci_subdev_private * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s16,six_axis_t;
@@
 struct six_axis_t {  s16 fx ;  s16 fy ;  s16 fz ;  s16 mx ;  s16 my ;  s16 mz ; } cocci_id@p ;
...
typedef u16;
@@
 struct jr3_pci_subdev_private {  struct jr3_sensor __iomem * sensor ;  unsigned long next_time_min ;  enum jr3_pci_poll_state state ;  int serial_no ;  int model_no ;  union jr3_pci_single_range range [ 9 ] ;  const struct comedi_lrange * range_table_list [ 8 * 7 + 2 ] ;  unsigned int maxdata_list [ 8 * 7 + 2 ] ;  u16 errors ;  int retries ; } cocci_id@p ;
...
typedef u16,s16;
@@
 struct jr3_pci_transform {  struct {  u16 link_type ;  s16 link_amount ; } link [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct jr3_pci_poll_delay {  int min ;  int max ; } cocci_id@p ;
...
position p;
@@
 const struct jr3_pci_board cocci_id@p [ ] ;
...
position p;
@@
 struct jr3_pci_transform cocci_id@p ;
...
position p;
@@
 union jr3_pci_single_range {  struct comedi_lrange l ;  char _reserved [ offsetof ( struct comedi_lrange , range [ 1 ] ) ] ; } cocci_id@p ;
...
position p;
@@
 struct jr3_pci_dev_private * cocci_id@p ;
...
position p;
@@
 struct jr3_pci_board {  const char * name ;  int n_subdevs ; } cocci_id@p ;
...
position p;
@@
 struct jr3_pci_poll_delay cocci_id@p ;
...
position p;
@@
 union jr3_pci_single_range * cocci_id@p ;
