...
position p;
@@
 struct sg_proc_deviter * cocci_id@p ;
...
position p;
@@
 struct class_interface cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sg_req_info_t;
@@
 sg_req_info_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,wait_queue_head_t,rwlock_t,atomic_t;
@@
 struct sg_device {  struct scsi_device * device ;  wait_queue_head_t open_wait ;  struct mutex open_rel_lock ;  int sg_tablesize ;  u32 index ;  struct list_head sfds ;  rwlock_t sfd_lock ;  atomic_t detaching ;  bool exclude ;  int open_cnt ;  char sgdebug ;  struct gendisk * disk ;  struct cdev * cdev ;  struct kref d_ref ; } cocci_id@p ;
...
@@
 struct compat_sg_req_info {  char req_state ;  char orphan ;  char sg_io_owned ;  char problem ;  int pack_id ;  compat_uptr_t usr_ptr ;  unsigned int duration ;  int unused ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( Sg_request * srp , unsigned char * cmd ) ;
...
typedef sg_io_hdr_t;
@@
 struct sg_request {  struct list_head entry ;  struct sg_fd * parentfp ;  Sg_scatter_hold data ;  sg_io_hdr_t header ;  unsigned char sense_b [ SCSI_SENSE_BUFFERSIZE ] ;  char res_used ;  char orphan ;  char sg_io_owned ;  char done ;  struct request * rq ;  struct bio * bio ;  struct execute_work ew ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( Sg_fd * sfp , Sg_request * srp , unsigned char * cmnd , int timeout , int blocking ) ;
...
position p;
@@
 int cocci_id@p ( struct device * , struct class_interface * ) ;
...
position p;
@@
 int cocci_id@p ( Sg_request * srp , char __user * outp , int num_read_xfer ) ;
...
position p;
@@
 Sg_fd * cocci_id@p ( Sg_device * sdp ) ;
...
typedef loff_t;
@@
 struct sg_proc_deviter {  loff_t index ;  size_t max ; } cocci_id@p ;
...
position p;
@@
 Sg_request * cocci_id@p ( Sg_fd * sfp , int pack_id ) ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * s , void * v ) ;
...
position p;
@@
 struct scsi_request * cocci_id@p ;
...
position p;
@@
 struct sg_scatter_hold {  unsigned short k_use_sg ;  unsigned sglist_len ;  unsigned bufflen ;  struct page * * pages ;  int page_order ;  char dio_in_use ;  unsigned char cmd_opcode ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( Sg_fd * sfp , Sg_request * srp ) ;
...
position p;
@@
 Sg_request * cocci_id@p ( Sg_fd * sfp ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_file * s , void * v ) ;
...
symbol cocci_id;
position p;
typedef sg_scsi_id_t;
@@
 sg_scsi_id_t cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ SG_MAX_CDB_SIZE ] ;
...
position p;
@@
 void cocci_id@p ( Sg_fd * sfp , int req_size ) ;
...
position p;
@@
 void cocci_id@p ( Sg_fd * sfp , Sg_request * srp , int size ) ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,rwlock_t;
@@
 struct sg_fd {  struct list_head sfd_siblings ;  struct sg_device * parentdp ;  wait_queue_head_t read_wait ;  rwlock_t rq_list_lock ;  struct mutex f_mutex ;  int timeout ;  int timeout_user ;  Sg_scatter_hold reserve ;  struct list_head rq_list ;  struct fasync_struct * async_qp ;  Sg_request req_arr [ SG_MAX_QUEUE ] ;  char force_packid ;  char cmd_q ;  unsigned char next_cmd_len ;  char keep_orphan ;  char mmap_called ;  char res_in_use ;  struct kref f_ref ;  struct execute_work ew ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( Sg_fd * sfp , Sg_request * srp ) ;
...
position p;
@@
 void cocci_id@p ( struct device * , struct class_interface * ) ;
...
position p;
@@
 void cocci_id@p ( Sg_fd * sfp , Sg_scatter_hold * schp ) ;
...
position p;
@@
 int cocci_id@p ( Sg_scatter_hold * schp , Sg_fd * sfp , int buff_size ) ;
