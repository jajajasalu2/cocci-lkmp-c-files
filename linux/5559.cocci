...
position p;
@@
 struct rtc_test_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,time64_t;
@@
 struct rtc_test_data {  struct rtc_device * rtc ;  time64_t offset ;  struct timer_list alarm ;  bool alarm_en ; } cocci_id@p ;
...
position p;
@@
 struct platform_device * cocci_id@p [ MAX_RTC_TEST ] ;
