...
position p;
@@
 struct zorro_esp_priv * cocci_id@p ;
...
position p;
@@
 struct zorro_driver_data {  const char * name ;  unsigned long offset ;  unsigned long dma_offset ;  int absolute ;  int scsi_option ;  const struct esp_driver_ops * esp_ops ; } cocci_id@p ;
...
position p;
@@
 struct blz1230II_dma_registers {  unsigned char dma_addr ;  unsigned char dmapad2 [ 0xf ] ;  unsigned char dma_latch ; } cocci_id@p ;
...
position p;
@@
 const struct esp_driver_ops cocci_id@p ;
...
position p;
@@
 const struct zorro_driver_data * cocci_id@p ;
...
position p;
@@
 struct zorro_esp_priv {  struct esp * esp ;  void __iomem * board_base ;  int zorro3 ;  unsigned char ctrl_data ; } cocci_id@p ;
...
position p;
@@
 struct blz1230_dma_registers {  unsigned char dma_addr ;  unsigned char dmapad2 [ 0x7fff ] ;  unsigned char dma_latch ; } cocci_id@p ;
...
position p;
@@
 enum { ZORRO_BLZ1230 , ZORRO_BLZ1230II , ZORRO_BLZ2060 , ZORRO_CYBER , ZORRO_CYBERII , ZORRO_FASTLANE , } cocci_id@p ;
...
position p;
@@
 struct fastlane_dma_registers cocci_id@p ;
...
position p;
@@
 struct blz2060_dma_registers {  unsigned char dma_led_ctrl ;  unsigned char dmapad1 [ 0x0f ] ;  unsigned char dma_addr0 ;  unsigned char dmapad2 [ 0x03 ] ;  unsigned char dma_addr1 ;  unsigned char dmapad3 [ 0x03 ] ;  unsigned char dma_addr2 ;  unsigned char dmapad4 [ 0x03 ] ;  unsigned char dma_addr3 ; } cocci_id@p ;
