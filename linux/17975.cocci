...
position p;
@@
 struct rt_signal_frame cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sigset_t,siginfo_t,__siginfo_fpu_t,stack_t,__siginfo_rwin_t;
@@
 struct rt_signal_frame {  struct sparc_stackf ss ;  siginfo_t info ;  struct pt_regs regs ;  __siginfo_fpu_t __user * fpu_save ;  stack_t stack ;  sigset_t mask ;  __siginfo_rwin_t * rwin_save ; } cocci_id@p ;
