...
position p;
@@
 int cocci_id@p ( struct rsnd_mod * mod ) ;
...
typedef u32;
@@
 struct rsnd_ssi {  struct rsnd_mod mod ;  u32 flags ;  u32 cr_own ;  u32 cr_clk ;  u32 cr_mode ;  u32 cr_en ;  u32 wsr ;  int chan ;  int rate ;  int irq ;  unsigned int usrcnt ;  int byte_pos ;  int byte_per_period ;  int next_period_byte ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct rsnd_mod * mod , struct rsnd_dai_stream * io ) ;
...
position p;
@@
 char cocci_id@p [ RSND_SSI_NAME_SIZE ] ;
