...
position p;
@@
 struct xd_delay_write_tag * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 int cocci_id@p ( struct rtsx_chip * chip , u32 phy_blk , u16 logoff , u8 start_page , u8 end_page ) ;
...
position p;
@@
 int cocci_id@p ( struct rtsx_chip * chip , int zone_no ) ;
