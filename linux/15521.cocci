...
position p;
@@
 struct stm32_timer_cnt * cocci_id@p ;
...
position p;
@@
 enum stm32_synapse_action { STM32_SYNAPSE_ACTION_NONE , STM32_SYNAPSE_ACTION_BOTH_EDGES , } cocci_id@p ;
...
position p;
@@
 struct stm32_timer_cnt * constcocci_id ;
...
position p;
@@
 enum stm32_count_function { STM32_COUNT_SLAVE_MODE_DISABLED = - 1 , STM32_COUNT_ENCODER_MODE_1 , STM32_COUNT_ENCODER_MODE_2 , STM32_COUNT_ENCODER_MODE_3 , } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_timer_cnt {  struct counter_device counter ;  struct regmap * regmap ;  struct clk * clk ;  u32 ceiling ; } cocci_id@p ;
