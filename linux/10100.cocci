...
position p;
@@
 const struct i2400m_tlv_hdr * cocci_id@p [ 9 ] ;
...
position p;
@@
 const struct {  char * msg ;  int errno ; } cocci_id@p [ I2400M_MS_MAX ] ;
...
position p;
@@
 const struct i2400m_tlv_hdr * * cocci_id@p ;
...
position p;
@@
 struct i2400m_l3l4_hdr * cocci_id@p ;
...
position p;
@@
 enum { I2400M_WAKEUP_ENABLED = 0x01 , I2400M_WAKEUP_DISABLED = 0x02 , I2400M_TLV_TYPE_WAKEUP_MODE = 144 , } cocci_id@p ;
...
position p;
@@
 const struct i2400m_l3l4_hdr * cocci_id@p ;
...
position p;
@@
 struct i2400m_tlv_config_idle_timeout cocci_id@p ;
...
position p;
@@
 const struct i2400m_tlv_rf_switches_status * cocci_id@p ;
...
position p;
@@
 const struct i2400m_tlv_media_status * cocci_id@p ;
...
position p;
@@
 struct i2400m_tlv_config_idle_parameters cocci_id@p ;
...
position p;
@@
 enum { I2400M_HDIv_MAJOR = 9 , I2400M_HDIv_MINOR = 1 , I2400M_HDIv_MINOR_2 = 2 , } cocci_id@p ;
...
position p;
@@
 const struct i2400m_tlv_l4_message_versions * cocci_id@p ;
...
position p;
@@
 const struct i2400m_tlv_system_state * cocci_id@p ;
...
position p;
@@
 struct {  struct i2400m_l3l4_hdr hdr ;  struct i2400m_tlv_config_idle_timeout cit ; } * cocci_id@p ;
...
position p;
@@
 struct i2400m_tlv_config_d2h_data_format cocci_id@p ;
...
position p;
@@
 const struct i2400m_tlv_detailed_device_info * cocci_id@p ;
...
position p;
@@
 struct i2400m_tlv_config_dl_host_reorder cocci_id@p ;
...
position p;
@@
 enum i2400m_system_state cocci_id@p ;
...
position p;
@@
 enum i2400m_media_status cocci_id@p ;
...
position p;
@@
 enum { I2400M_TLV_DETAILED_DEVICE_INFO = 140 , } cocci_id@p ;
...
position p;
@@
 struct i2400m_cmd_enter_power_save * cocci_id@p ;
