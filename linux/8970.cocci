...
position p;
@@
 const struct seq_tab * cocci_id@p ;
...
position p;
@@
 struct port_dcb_info * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ 2 * CIM_NUM_OBQ_T5 ] ;
...
position p;
@@
 struct devlog_info {  unsigned int nentries ;  unsigned int first ;  struct fw_devlog_e log [ 0 ] ; } cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ CIM_NUM_IBQ + CIM_NUM_OBQ_T5 ] ;
...
position p;
@@
 const struct sge_ctrl_txq * cocci_id@p ;
...
position p;
@@
 struct app_priority * cocci_id@p ;
...
position p;
@@
 struct t4_debugfs_entry * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ ( 4 * ( CIM_NUM_IBQ + CIM_NUM_OBQ_T5 ) ) ] ;
...
position p;
@@
 unsigned long long cocci_id@p [ 8 ] ;
...
position p;
@@
 const struct sge_eth_txq * cocci_id@p ;
...
position p;
@@
 const struct tid_info * cocci_id@p ;
...
position p;
@@
 struct fw_ldst_mps_rplc cocci_id@p ;
...
position p;
@@
 const struct sge_ofld_rxq * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct seq_file * seq , void * v , int i ) ;
...
typedef u32;
@@
 struct rss_pf_conf {  u32 rss_pf_map ;  u32 rss_pf_mask ;  u32 rss_pf_config ; } cocci_id@p ;
...
position p;
@@
 struct field_desc {  const char * name ;  unsigned int start ;  unsigned int width ; } cocci_id@p ;
...
position p;
@@
 struct tp_fcoe_stats cocci_id@p [ NCHAN ] ;
...
position p;
@@
 const struct sge_eohw_txq * cocci_id@p ;
...
position p;
@@
 const struct sge_uld_rxq_info * cocci_id@p ;
...
position p;
@@
 struct cudbg_meminfo cocci_id@p ;
...
typedef u32;
@@
 struct rss_vf_conf {  u32 rss_vf_vfl ;  u32 rss_vf_vfh ; } cocci_id@p ;
...
position p;
@@
 const struct field_desc * cocci_id@p ;
...
position p;
@@
 const struct sge_uld_txq_info * cocci_id@p ;
...
position p;
@@
 const struct sge_uld_txq * cocci_id@p ;
