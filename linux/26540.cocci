...
position p;
@@
 struct map_replace {  int idx ;  int fd ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct bpf_prog_test_run_attr cocci_id@p ;
...
position p;
@@
 enum { DUMP_JITED , DUMP_XLATED , } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ BPF_TAG_SIZE ] ;
...
position p;
@@
 const struct map_replace * cocci_id@p ;
