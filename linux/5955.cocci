...
position p;
@@
 enum pin_id { TEGRA_PIN_PEX_L5_CLKREQ_N_PGG0 = 256 , TEGRA_PIN_PEX_L5_RST_N_PGG1 = 257 , TEGRA_PIN_NUM_GPIOS = 258 , } cocci_id@p ;
...
position p;
@@
 enum tegra_mux_dt { TEGRA_MUX_RSVD0 , TEGRA_MUX_RSVD1 , TEGRA_MUX_RSVD2 , TEGRA_MUX_RSVD3 , TEGRA_MUX_PE5 , } cocci_id@p ;
