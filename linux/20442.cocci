...
typedef u64,bool;
@@
 struct mce_bank {  u64 ctl ;  bool init ; } cocci_id@p ;
...
position p;
@@
 unsigned long ( * cocci_id@p ) ( unsigned long interval ) ;
...
position p;
@@
 struct mce_bank_dev * cocci_id@p ;
...
position p;
@@
 struct mce_evt_llist * cocci_id@p ;
...
position p;
@@
 struct mce_bank cocci_id@p [ MAX_NR_BANKS ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct pt_regs * , long error_code ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( int bank , struct mce * m , struct pt_regs * regs ) ;
...
position p;
@@
 struct mce_bank_dev cocci_id@p [ MAX_NR_BANKS ] ;
...
position p;
@@
 struct mce_vendor_flags cocci_id@p ;
...
position p;
@@
 struct mca_msr_regs cocci_id@p ;
...
typedef u8;
@@
 struct mce_bank_dev {  struct device_attribute attr ;  char attrname [ ATTR_LEN ] ;  u8 bank ; } cocci_id@p ;
