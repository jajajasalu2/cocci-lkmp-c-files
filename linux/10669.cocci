...
position p;
@@
 const struct intel_dpll_hw_state * cocci_id@p ;
...
position p;
@@
 const struct ddi_buf_trans cocci_id@p [ ] ;
...
position p;
@@
 const struct bxt_ddi_buf_trans cocci_id@p [ ] ;
...
position p;
@@
 enum intel_output_type cocci_id@p ;
...
typedef u32;
@@
 struct tgl_dkl_phy_ddi_buf_trans {  u32 dkl_vswing_control ;  u32 dkl_preshoot_control ;  u32 dkl_de_emphasis_control ; } cocci_id@p ;
...
position p;
@@
 const struct cnl_ddi_buf_trans * cocci_id@p ;
...
typedef u8;
@@
 struct cnl_ddi_buf_trans {  u8 dw2_swing_sel ;  u8 dw7_n_scalar ;  u8 dw4_cursor_coeff ;  u8 dw4_post_cursor_2 ;  u8 dw4_post_cursor_1 ; } cocci_id@p ;
...
position p;
@@
 struct ddi_vbt_port_info * cocci_id@p ;
...
position p;
@@
 const struct icl_mg_phy_ddi_buf_trans cocci_id@p [ ] ;
...
position p;
@@
 const enum transcoder cocci_id@p [ ] ;
...
position p;
@@
 const struct intel_shared_dpll * cocci_id@p ;
...
typedef u32;
@@
 struct icl_mg_phy_ddi_buf_trans {  u32 cri_txdeemph_override_5_0 ;  u32 cri_txdeemph_override_11_6 ;  u32 cri_txdeemph_override_17_12 ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct ddi_buf_trans {  u32 trans1 ;  u32 trans2 ;  u8 i_boost ; } cocci_id@p ;
...
position p;
@@
 const struct tgl_dkl_phy_ddi_buf_trans * cocci_id@p ;
...
typedef u8;
@@
 struct bxt_ddi_buf_trans {  u8 margin ;  u8 scale ;  u8 enable ;  u8 deemphasis ; } cocci_id@p ;
...
position p;
@@
 const enum intel_dpll_id cocci_id@p ;
