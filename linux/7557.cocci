...
typedef bool,u32;
@@
 struct simplefb_par {  u32 palette [ PSEUDO_PALETTE_SIZE ] ; #if defined CONFIG_OF && defined CONFIG_COMMON_CLK  bool clks_enabled ;  unsigned int clk_count ;  struct clk * * clks ; #endif #if defined CONFIG_OF && defined CONFIG_REGULATOR  bool regulators_enabled ;  u32 regulator_count ;  struct regulator * * regulators ; #endif } cocci_id@p ;
...
position p;
@@
 struct simplefb_params cocci_id@p ;
...
position p;
@@
 struct simplefb_par * cocci_id@p ;
...
typedef u32;
@@
 struct simplefb_params {  u32 width ;  u32 height ;  u32 stride ;  struct simplefb_format * format ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct simplefb_par * par ) ;
...
position p;
@@
 struct simplefb_platform_data * cocci_id@p ;
...
position p;
@@
 struct simplefb_format cocci_id@p [ ] ;
