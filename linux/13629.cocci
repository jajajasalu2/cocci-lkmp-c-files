...
position p;
@@
 enum ov361x { ov361x_2048 = 0 , ov361x_1600 , ov361x_1024 , ov361x_640 , ov361x_320 , ov361x_160 , ov361x_last , } cocci_id@p ;
...
typedef u8,__u32;
@@
 struct sd {  struct gspca_dev gspca_dev ;  __u32 last_pts ;  u8 last_fid ;  u8 sensor ; } cocci_id@p ;
...
position p;
@@
 enum sensors { SENSOR_OV965x , SENSOR_OV971x , SENSOR_OV562x , SENSOR_OV361x , NSENSORS , } cocci_id@p ;
