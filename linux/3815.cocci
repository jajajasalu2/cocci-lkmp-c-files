...
position p;
@@
 struct nx842_crypto_header * cocci_id@p ;
...
position p;
@@
 struct nx842_crypto_header_group cocci_id@p ;
...
typedef u8;
@@
 struct nx842_crypto_param {  u8 * in ;  unsigned int iremain ;  u8 * out ;  unsigned int oremain ;  unsigned int ototal ; } cocci_id@p ;
...
position p;
@@
 struct nx842_crypto_param * cocci_id@p ;
