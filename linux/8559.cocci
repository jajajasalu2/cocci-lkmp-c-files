...
position p;
@@
 struct bnxt_dl_nvm_param cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_get_variable_input cocci_id@p ;
...
position p;
@@
 struct bnxt_fw_reporter_ctx * cocci_id@p ;
...
position p;
@@
 enum bnxt_dl_param_id { BNXT_DEVLINK_PARAM_ID_BASE = DEVLINK_PARAM_GENERIC_ID_MAX , BNXT_DEVLINK_PARAM_ID_GRE_VER_CHECK , } cocci_id@p ;
...
typedef __le32,u8;
@@
 union bnxt_nvm_data {  u8 val8 ;  __le32 val32 ; } cocci_id@p ;
...
position p;
@@
 union bnxt_nvm_data * cocci_id@p ;
...
position p;
@@
 struct hwrm_nvm_set_variable_input cocci_id@p ;
...
position p;
@@
 const struct bnxt_dl_nvm_param cocci_id@p [ ] ;
