...
position p;
@@
 struct ima_kexec_hdr * cocci_id@p ;
...
position p;
@@
 const struct ima_template_field * cocci_id@p [ IMA_TEMPLATE_NUM_FIELDS_MAX ] ;
...
position p;
@@
 enum header_fields { HDR_PCR , HDR_DIGEST , HDR_TEMPLATE_NAME , HDR_TEMPLATE_DATA , HDR__LAST , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ IMA_TEMPLATE_FIELD_ID_MAX_LEN + 1 ] ;
...
position p;
@@
 struct ima_field_data cocci_id@p [ HDR__LAST ] ;
...
position p;
@@
 struct ima_field_data * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_TEMPLATE_NAME_LEN ] ;
