...
symbol cocci_id;
position p;
typedef auto_chan_table_t;
@@
 const auto_chan_table_t cocci_id@p ;
...
position p;
@@
 struct adm1031_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s8,u8,u16,auto_chan_table_t;
@@
 struct adm1031_data {  struct i2c_client * client ;  const struct attribute_group * groups [ 3 ] ;  struct mutex update_lock ;  int chip_type ;  char valid ;  unsigned long last_updated ;  unsigned int update_interval ;  const auto_chan_table_t * chan_select_table ;  u16 alarm ;  u8 conf1 ;  u8 conf2 ;  u8 fan [ 2 ] ;  u8 fan_div [ 2 ] ;  u8 fan_min [ 2 ] ;  u8 pwm [ 2 ] ;  u8 old_pwm [ 2 ] ;  s8 temp [ 3 ] ;  u8 ext_temp [ 3 ] ;  u8 auto_temp [ 3 ] ;  u8 auto_temp_min [ 3 ] ;  u8 auto_temp_off [ 3 ] ;  u8 auto_temp_max [ 3 ] ;  s8 temp_offset [ 3 ] ;  s8 temp_min [ 3 ] ;  s8 temp_max [ 3 ] ;  s8 temp_crit [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 enum chips { adm1030 , adm1031 , } cocci_id@p ;
