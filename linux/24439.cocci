...
typedef u8,u32;
@@
 struct cfg80211_mgmt_registration {  struct list_head list ;  struct wireless_dev * wdev ;  u32 nlportid ;  int match_len ;  __le16 frame_type ;  u8 match [ ] ; } cocci_id@p ;
...
position p;
@@
 struct cfg80211_mgmt_registration cocci_id@p ;
