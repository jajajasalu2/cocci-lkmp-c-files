...
position p;
@@
 struct o2hb_bio_wait_ctxt cocci_id@p ;
...
position p;
@@
 struct o2hb_disk_slot cocci_id@p ;
...
position p;
@@
 struct o2hb_heartbeat_group {  struct config_group hs_group ; } cocci_id@p ;
...
position p;
@@
 struct o2hb_heartbeat_group cocci_id@p ;
...
position p;
@@
 struct o2hb_node_event cocci_id@p ;
...
position p;
@@
 enum o2hb_callback_type cocci_id@p ;
...
position p;
@@
 struct o2hb_disk_heartbeat_block * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const char * region_uuid ) ;
...
position p;
@@
 enum { O2HB_NEGO_TIMEOUT_MSG = 1 , O2HB_NEGO_APPROVE_MSG = 2 , } cocci_id@p ;
...
typedef u8;
@@
 struct o2hb_nego_msg {  u8 node_num ; } cocci_id@p ;
...
position p;
@@
 struct o2hb_callback * cocci_id@p ( enum o2hb_callback_type type ) ;
...
position p;
@@
 enum o2hb_heartbeat_modes { O2HB_HEARTBEAT_LOCAL = 0 , O2HB_HEARTBEAT_GLOBAL , O2HB_HEARTBEAT_NUM_MODES , } cocci_id@p ;
...
typedef u64,u8,u16;
@@
 struct o2hb_disk_slot {  struct o2hb_disk_heartbeat_block * ds_raw_block ;  u8 ds_node_num ;  u64 ds_last_time ;  u64 ds_last_generation ;  u16 ds_equal_samples ;  u16 ds_changed_samples ;  struct list_head ds_live_item ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ O2HB_HEARTBEAT_NUM_MODES ] ;
...
position p;
@@
 struct o2hb_debug_buf * cocci_id@p ;
...
position p;
@@
 struct o2hb_nego_msg cocci_id@p ;
...
typedef atomic_t;
@@
 struct o2hb_bio_wait_ctxt {  atomic_t wc_num_reqs ;  struct completion wc_io_complete ;  int wc_error ; } cocci_id@p ;
...
position p;
@@
 struct o2hb_callback {  struct list_head list ; } cocci_id@p [ O2HB_NUM_CB ] ;
...
position p;
@@
 struct o2hb_node_event {  struct list_head hn_item ;  enum o2hb_callback_type hn_event_type ;  struct o2nm_node * hn_node ;  int hn_node_num ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const char * region_uuid ) ;
...
position p;
@@
 struct list_head cocci_id@p [ O2NM_MAX_NODES ] ;
...
position p;
@@
 unsigned long cocci_id@p [ BITS_TO_LONGS ( O2NM_MAX_REGIONS ) ] ;
...
position p;
@@
 struct o2hb_callback * cocci_id@p ;
...
position p;
@@
 struct o2hb_debug_buf {  int db_type ;  int db_size ;  int db_len ;  void * db_data ; } cocci_id@p ;
...
position p;
@@
 struct o2hb_callback_func * cocci_id@p ;
