...
position p;
@@
 struct sctp_sndrcvinfo cocci_id@p ;
...
position p;
@@
 struct sctp_association * cocci_id@p ;
...
position p;
@@
 struct sctp_endpoint * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sock * sk , long timeo ) ;
...
position p;
@@
 struct sctp_sndinfo cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sock * sk ) ;
...
position p;
@@
 struct sctp_paramhdr cocci_id@p ;
...
position p;
@@
 const struct sctp_initmsg * cocci_id@p ;
...
position p;
@@
 const struct msghdr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sctp_transport * , void * ) ;
...
position p;
@@
 enum sctp_socket_type cocci_id@p ;
...
position p;
@@
 struct sctp_ep_common * cocci_id@p ;
...
position p;
@@
 struct rhashtable_iter cocci_id@p ;
...
position p;
@@
 struct sctp_authchunks cocci_id@p ;
...
position p;
@@
 struct sctp_setpeerprim cocci_id@p ;
...
position p;
@@
 struct sctp_prstatus cocci_id@p ;
...
position p;
@@
 struct sctp_hmacalgo * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sk_buff * , struct sock * ) ;
...
position p;
@@
 struct sctp_af * cocci_id@p ( struct sctp_sock * opt , union sctp_addr * addr , int len ) ;
...
position p;
@@
 struct sctp_rtoinfo cocci_id@p ;
...
position p;
@@
 struct sctp_event_subscribe cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sctp_assoc_t;
@@
 sctp_assoc_t cocci_id@p ;
...
position p;
@@
 struct sctp_authkeyid cocci_id@p ;
...
position p;
@@
 struct sctp_transport * * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sock * sk , long timeo ) ;
...
position p;
@@
 struct percpu_counter cocci_id@p ;
...
position p;
@@
 struct sctp_sack_info * cocci_id@p ;
...
position p;
@@
 struct sctp_assoc_ids cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct msghdr * msg , struct sctp_cmsgs * cmsgs ) ;
...
position p;
@@
 int cocci_id@p ( struct sock * oldsk , struct sock * newsk , struct sctp_association * assoc , enum sctp_socket_type type ) ;
...
position p;
@@
 struct sctp_paddrparams cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sock * , struct sockaddr * , int ) ;
...
position p;
@@
 struct sctp_bind_bucket * cocci_id@p ( struct sctp_bind_hashbucket * head , struct net * , unsigned short snum ) ;
...
position p;
@@
 struct sctp_assoc_value cocci_id@p ;
...
position p;
@@
 struct sctp_default_prinfo cocci_id@p ;
...
position p;
@@
 struct sctp_hmac_algo_param * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s32,compat_uptr_t,sctp_assoc_t;
@@
 struct compat_sctp_getaddrs_old {  sctp_assoc_t assoc_id ;  s32 addr_num ;  compat_uptr_t addrs ; } cocci_id@p ;
...
position p;
@@
 struct sctp_bind_addr * cocci_id@p ;
...
position p;
@@
 struct sctp_setadaptation cocci_id@p ;
...
position p;
@@
 struct sctp_initmsg cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sctp_association * asoc , struct sctp_chunk * chunk ) ;
...
position p;
@@
 struct sctp_paddrinfo cocci_id@p ;
...
position p;
@@
 struct sctp_data_chunk cocci_id@p ;
...
position p;
@@
 struct sctp_authinfo cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sctp_chunk * ) ;
...
position p;
@@
 struct sctp_hashbucket * cocci_id@p ;
...
position p;
@@
 struct sctp_authchunk cocci_id@p ;
...
position p;
@@
 struct sctp_paddrthlds cocci_id@p ;
...
position p;
@@
 struct sctp_ulpevent * cocci_id@p ;
...
position p;
@@
 struct sctp_authkey * cocci_id@p ;
...
position p;
@@
 struct sctp_chunks_param * cocci_id@p ;
...
position p;
@@
 struct sctp_stream_out_ext * cocci_id@p ;
...
position p;
@@
 struct sctp_sockaddr_entry cocci_id@p ;
...
position p;
@@
 struct sctp_bind_bucket * cocci_id@p ;
...
position p;
@@
 struct compat_sctp_getaddrs_old cocci_id@p ;
...
position p;
@@
 struct sctp_getaddrs cocci_id@p ;
...
position p;
@@
 struct sctp_assocparams cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sctp_endpoint * , void * ) ;
...
symbol cocci_id;
position p;
typedef sctp_peeloff_arg_t;
@@
 sctp_peeloff_arg_t cocci_id@p ;
...
position p;
@@
 struct sctp_bind_hashbucket * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct sock * sk ) ;
...
position p;
@@
 struct sctp_shared_key * cocci_id@p ;
...
position p;
@@
 struct sctp_stream_value cocci_id@p ;
...
position p;
@@
 struct sctp_reset_streams * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sock * , union sctp_addr * ) ;
...
symbol cocci_id;
position p;
typedef sctp_peeloff_flags_arg_t;
@@
 sctp_peeloff_flags_arg_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sock * , union sctp_addr * , int ) ;
...
position p;
@@
 struct sctp_paddrthlds_v2 cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sctp_association * , long * timeo_p ) ;
...
position p;
@@
 struct sctp_getaddrs_old cocci_id@p ;
...
position p;
@@
 const union sctp_addr * cocci_id@p ;
...
position p;
@@
 struct sctp_datamsg * cocci_id@p ;
...
position p;
@@
 struct sctp_add_streams cocci_id@p ;
...
position p;
@@
 struct sctp_assoc_stats cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct sock * sk , int * err , long * timeo_p ) ;
