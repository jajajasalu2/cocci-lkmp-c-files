...
position p;
@@
 struct rds_ib_connection * cocci_id@p ;
...
position p;
@@
 struct rds_ib_recv_work cocci_id@p ;
...
position p;
@@
 const union rds_ib_conn_priv * cocci_id@p ;
...
position p;
@@
 struct rds_ib_ack_state cocci_id@p ;
...
position p;
@@
 struct rds6_ib_connect_private cocci_id@p ;
...
position p;
@@
 struct rds_ib_send_work cocci_id@p ;
...
position p;
@@
 const struct rds_ib_conn_priv_cmn * cocci_id@p ;
...
position p;
@@
 struct rds_ib_device * cocci_id@p ;
...
position p;
@@
 union rds_ib_conn_priv * cocci_id@p ;
...
position p;
@@
 struct rds_ib_connect_private cocci_id@p ;
