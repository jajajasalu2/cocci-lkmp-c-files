...
typedef bool,u16;
@@
 struct quatech_feature {  u16 devid ;  bool amcc ; } cocci_id@p ;
...
position p;
@@
 struct serial_private {  struct pci_dev * dev ;  unsigned int nr ;  struct pci_serial_quirk * quirk ;  const struct pciserial_board * board ;  int line [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct uart_8250_port cocci_id@p ;
...
position p;
@@
 const struct pciserial_board * cocci_id@p ;
...
position p;
@@
 struct quatech_feature cocci_id@p [ ] ;
...
position p;
@@
 struct pciserial_board cocci_id@p [ ] ;
...
typedef u32;
@@
 struct pci_serial_quirk {  u32 vendor ;  u32 device ;  u32 subvendor ;  u32 subdevice ;  int ( * probe ) ( struct pci_dev * dev ) ;  int ( * init ) ( struct pci_dev * dev ) ;  int ( * setup ) ( struct serial_private * , const struct pciserial_board * , struct uart_8250_port * , int ) ;  void ( * exit ) ( struct pci_dev * dev ) ; } cocci_id@p ;
...
position p;
@@
 struct pci_serial_quirk * cocci_id@p ;
...
position p;
@@
 struct serial_rs485 * cocci_id@p ;
...
position p;
@@
 struct f815xxa_data * cocci_id@p ;
...
position p;
@@
 const struct timedia_struct {  int num ;  const unsigned short * ids ; } cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct serial_private * , const struct pciserial_board * , struct uart_8250_port * , int ) ;
...
position p;
@@
 struct serial_private * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct f815xxa_data {  spinlock_t lock ;  int idx ; } cocci_id@p ;
