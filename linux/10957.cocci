...
position p;
@@
 struct atcs_verify_interface cocci_id@p ;
...
position p;
@@
 struct atif_system_params cocci_id@p ;
...
position p;
@@
 struct atif_verify_interface cocci_id@p ;
...
typedef acpi_handle;
@@
 struct amdgpu_atif {  acpi_handle handle ;  struct amdgpu_atif_notifications notifications ;  struct amdgpu_atif_functions functions ;  struct amdgpu_atif_notification_cfg notification_cfg ;  struct amdgpu_encoder * encoder_for_bl ;  struct amdgpu_dm_backlight_caps backlight_caps ; } cocci_id@p ;
...
typedef bool;
@@
 struct amdgpu_atif_functions {  bool system_params ;  bool sbios_requests ;  bool temperature_change ;  bool query_backlight_transfer_characteristics ;  bool ready_to_undock ;  bool external_gpu_information ; } cocci_id@p ;
...
typedef bool;
@@
 struct amdgpu_atif_notifications {  bool thermal_state ;  bool forced_power_state ;  bool system_power_state ;  bool brightness_change ;  bool dgpu_display_event ;  bool gpu_package_power_limit ; } cocci_id@p ;
...
position p;
@@
 union acpi_object cocci_id@p [ 2 ] ;
...
position p;
@@
 struct atcs_pref_req_input cocci_id@p ;
...
position p;
@@
 struct atif_qbtc_arguments cocci_id@p ;
...
position p;
@@
 struct amdgpu_atif_functions * cocci_id@p ;
...
position p;
@@
 struct atcs_pref_req_output cocci_id@p ;
...
position p;
@@
 struct atif_qbtc_output cocci_id@p ;
...
position p;
@@
 struct acpi_bus_event * cocci_id@p ;
...
position p;
@@
 struct atif_sbios_requests * cocci_id@p ;
...
position p;
@@
 struct amdgpu_atif_notifications * cocci_id@p ;
...
typedef bool;
@@
 struct amdgpu_atif_notification_cfg {  bool enabled ;  int command_code ; } cocci_id@p ;
...
position p;
@@
 struct amdgpu_atcs_functions * cocci_id@p ;
...
position p;
@@
 struct amdgpu_atif_notification_cfg * cocci_id@p ;
