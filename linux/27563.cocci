...
position p;
@@
 struct btrfs_plug_cb cocci_id@p ;
...
symbol cocci_id;
position p;
typedef btrfs_func_t;
@@
 btrfs_func_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfs_raid_bio * rbio ) ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_raid_bio * rbio ) ;
...
symbol cocci_id;
position p;
typedef atomic_t,spinlock_t,refcount_t;
@@
 struct btrfs_raid_bio {  struct btrfs_fs_info * fs_info ;  struct btrfs_bio * bbio ;  struct list_head hash_list ;  struct list_head stripe_cache ;  struct btrfs_work work ;  struct bio_list bio_list ;  spinlock_t bio_list_lock ;  struct list_head plug_list ;  unsigned long flags ;  int stripe_len ;  int nr_data ;  int real_stripes ;  int stripe_npages ;  enum btrfs_rbio_ops operation ;  int faila ;  int failb ;  int scrubp ;  int nr_pages ;  int bio_list_bytes ;  int generic_bio_cnt ;  refcount_t refs ;  atomic_t stripes_pending ;  atomic_t error ;  struct page * * stripe_pages ;  struct page * * bio_pages ;  unsigned long * dbitmap ;  void * * finish_pointers ;  unsigned long * finish_pbitmap ; } cocci_id@p ;
...
position p;
@@
 enum btrfs_rbio_ops { BTRFS_RBIO_WRITE , BTRFS_RBIO_READ_REBUILD , BTRFS_RBIO_PARITY_SCRUB , BTRFS_RBIO_REBUILD_MISSING , } cocci_id@p ;
...
position p;
@@
 struct btrfs_plug_cb {  struct blk_plug_cb cb ;  struct btrfs_fs_info * info ;  struct list_head rbio_list ;  struct btrfs_work work ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct btrfs_stripe_hash {  struct list_head hash_list ;  spinlock_t lock ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct btrfs_stripe_hash_table {  struct list_head stripe_cache ;  spinlock_t cache_lock ;  int cache_size ;  struct btrfs_stripe_hash table [ ] ; } cocci_id@p ;
...
position p;
@@
 struct btrfs_stripe_hash_table * cocci_id@p ;
...
position p;
@@
 struct btrfs_stripe_hash * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_raid_bio * rbio , int failed ) ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_raid_bio * rbio , struct bio * bio ) ;
...
position p;
@@
 void cocci_id@p ( struct btrfs_raid_bio * rbio , int need_check ) ;
