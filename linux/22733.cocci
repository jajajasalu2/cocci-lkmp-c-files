...
position p;
@@
 struct wavefront_command * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ WF_DRUM_BYTES ] ;
...
position p;
@@
 unsigned char cocci_id@p [ WF_ALIAS_BYTES ] ;
...
position p;
@@
 struct {  int errno ;  const char * errstr ; } cocci_id@p [ ] ;
...
position p;
@@
 unsigned char cocci_id@p [ WF_PATCH_BYTES ] ;
...
symbol cocci_id;
position p;
typedef snd_wavefront_t;
@@
 snd_wavefront_t * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ WF_PROGRAM_BYTES + 1 ] ;
...
position p;
@@
 wavefront_patch_info cocci_id@p ;
...
position p;
@@
 struct wavefront_command {  int cmd ;  char * action ;  unsigned int read_cnt ;  unsigned int write_cnt ;  int need_ack ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_wavefront_card_t;
@@
 snd_wavefront_card_t * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ WF_PROGRAM_BYTES ] ;
...
typedef snd_wavefront_t;
@@
 int cocci_id@p ( snd_wavefront_t * ) ;
...
position p;
@@
 unsigned char cocci_id@p [ WF_SAMPLE_HDR_BYTES ] ;
...
position p;
@@
 unsigned char cocci_id@p [ WF_PATCH_BYTES + 2 ] ;
...
typedef snd_wavefront_t;
@@
 int cocci_id@p ( snd_wavefront_t * , int sampnum ) ;
