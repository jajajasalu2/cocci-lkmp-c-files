...
position p;
@@
 struct qcom_rng_ctx {  struct qcom_rng * rng ; } cocci_id@p ;
...
position p;
@@
 struct qcom_rng_ctx cocci_id@p ;
...
position p;
@@
 struct qcom_rng {  struct mutex lock ;  void __iomem * base ;  struct clk * clk ;  unsigned int skip_init ; } cocci_id@p ;
