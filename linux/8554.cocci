...
position p;
@@
 struct hwrm_cfa_vfr_alloc_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_vfr_alloc_input cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_vfr_free_input cocci_id@p ;
