...
position p;
@@
 struct sockaddr_caif cocci_id@p ;
...
position p;
@@
 enum caif_states { CAIF_CONNECTED = TCP_ESTABLISHED , CAIF_CONNECTING = TCP_SYN_SENT , CAIF_DISCONNECTED = TCP_CLOSE , } cocci_id@p ;
