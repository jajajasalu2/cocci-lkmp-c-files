...
typedef u8;
@@
 u8 cocci_id@p [ ETP_CALIBRATE_MAX_LEN ] ;
...
position p;
@@
 const struct elan_transport_ops * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ETP_MAX_REPORT_LEN ] ;
...
position p;
@@
 struct elan_tp_data * cocci_id@p ;
