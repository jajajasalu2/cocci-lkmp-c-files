...
position p;
@@
 struct orangefs_sb_info_s cocci_id@p ;
...
position p;
@@
 enum { Opt_intr , Opt_acl , Opt_local_lock , Opt_err , } cocci_id@p ;
...
position p;
@@
 struct orangefs_fs_mount_response * cocci_id@p ;
...
position p;
@@
 struct orangefs_cached_xattr * cocci_id@p ;
