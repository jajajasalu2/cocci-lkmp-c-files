...
position p;
@@
 struct IRQ_TABLE {  unsigned mask ;  int irq ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned int , struct pt_regs * fp ) ;
