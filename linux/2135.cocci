...
position p;
@@
 struct max17211_device_info {  char name [ PSY_MAX_NAME_LEN ] ;  struct power_supply * bat ;  struct power_supply_desc bat_desc ;  struct device * w1_dev ;  struct regmap * regmap ;  unsigned int rsense ;  char DeviceName [ 2 * MAX1721X_REG_DEV_NUMB + 1 ] ;  char ManufacturerName [ 2 * MAX1721X_REG_MFG_NUMB + 1 ] ;  char SerialNumber [ 13 ] ; } cocci_id@p ;
...
position p;
@@
 struct max17211_device_info * cocci_id@p ;
