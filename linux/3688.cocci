...
position p;
@@
 struct mv_cesa_aes_ctx {  struct mv_cesa_ctx base ;  struct crypto_aes_ctx aes ; } cocci_id@p ;
...
position p;
@@
 struct mv_cesa_des3_ctx * cocci_id@p ;
...
position p;
@@
 const struct mv_cesa_op_ctx * cocci_id@p ;
...
position p;
@@
 struct mv_cesa_skcipher_req cocci_id@p ;
...
position p;
@@
 struct mv_cesa_des_ctx * cocci_id@p ;
...
position p;
@@
 struct mv_cesa_aes_ctx cocci_id@p ;
...
typedef u8;
@@
 struct mv_cesa_des_ctx {  struct mv_cesa_ctx base ;  u8 key [ DES_KEY_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct mv_cesa_skcipher_std_req * cocci_id@p ;
...
position p;
@@
 struct mv_cesa_skcipher_dma_iter {  struct mv_cesa_dma_iter base ;  struct mv_cesa_sg_dma_iter src ;  struct mv_cesa_sg_dma_iter dst ; } cocci_id@p ;
...
position p;
@@
 struct mv_cesa_skcipher_dma_iter cocci_id@p ;
...
typedef u8;
@@
 struct mv_cesa_des3_ctx {  struct mv_cesa_ctx base ;  u8 key [ DES3_EDE_KEY_SIZE ] ; } cocci_id@p ;
