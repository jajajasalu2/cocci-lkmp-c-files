...
position p;
@@
 enum ath5k_pkt_type cocci_id@p ;
...
position p;
@@
 const struct ath5k_srev_name cocci_id@p [ ] ;
...
position p;
@@
 const struct ath5k_hw * cocci_id@p ;
...
position p;
@@
 struct ath5k_rx_status * cocci_id@p ;
...
position p;
@@
 struct ath5k_vif_iter_data * cocci_id@p ;
...
position p;
@@
 const struct ath_bus_ops * cocci_id@p ;
...
position p;
@@
 struct ath5k_tx_status cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ieee80211_hw * hw ) ;
...
position p;
@@
 const struct ath_ops cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct ath5k_hw * ah , struct ieee80211_channel * chan , bool skip_pcu ) ;
...
position p;
@@
 struct ath5k_txq_info cocci_id@p ;
...
position p;
@@
 const struct ieee80211_hw * cocci_id@p ;
...
position p;
@@
 enum ath5k_srev_type cocci_id@p ;
