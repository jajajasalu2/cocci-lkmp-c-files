...
position p;
@@
 struct rpcrdma_xprt cocci_id@p ;
...
position p;
@@
 struct rpcrdma_buffer * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rpcrdma_xprt * r_xprt , struct rpcrdma_sendctx * sc ) ;
...
position p;
@@
 void cocci_id@p ( struct rpcrdma_regbuf * rb ) ;
...
position p;
@@
 void cocci_id@p ( struct rpcrdma_buffer * buf ) ;
...
position p;
@@
 struct rpcrdma_connect_private * cocci_id@p ;
...
position p;
@@
 const struct rpcrdma_connect_private * cocci_id@p ;
...
position p;
@@
 struct rpcrdma_sendctx cocci_id@p ;
...
position p;
@@
 struct rpcrdma_regbuf * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rpcrdma_xprt * r_xprt ) ;
