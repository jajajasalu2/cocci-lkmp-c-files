...
position p;
@@
 union cvmx_gmxx_inf_mode cocci_id@p ;
...
position p;
@@
 union cvmx_pip_prt_cfgx cocci_id@p ;
...
position p;
@@
 union cvmx_iob_fau_timeout cocci_id@p ;
...
@@
 cvmx_pko_command_word0_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cvmx_helper_link_info_t;
@@
 cvmx_helper_link_info_t cocci_id@p ;
...
position p;
@@
 union cvmx_pko_reg_min_pkt cocci_id@p ;
