...
position p;
@@
 struct ring_pair_cb cocci_id@p ;
...
position p;
@@
 struct ppe_common_cb * cocci_id@p ;
...
position p;
@@
 struct rcb_common_cb * cocci_id@p ;
