...
position p;
@@
 struct mtk_aes_info * cocci_id@p ;
...
typedef u64;
@@
 struct mtk_aes_reqctx {  u64 mode ; } cocci_id@p ;
...
position p;
@@
 struct mtk_aes_ctr_ctx * cocci_id@p ;
...
position p;
@@
 struct mtk_aes_reqctx * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct mtk_aes_drv {  struct list_head dev_list ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct mtk_aes_gcm_ctx cocci_id@p ;
...
typedef u8,u32;
@@
 struct {  u32 hash [ 4 ] ;  u8 iv [ 8 ] ;  struct crypto_wait wait ;  struct scatterlist sg [ 1 ] ;  struct skcipher_request req ; } * cocci_id@p ;
...
typedef u32;
@@
 struct mtk_aes_ctr_ctx {  struct mtk_aes_base_ctx base ;  u32 iv [ AES_BLOCK_SIZE / sizeof ( u32 ) ] ;  size_t offset ;  struct scatterlist src [ 2 ] ;  struct scatterlist dst [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 const struct mtk_aes_reqctx * cocci_id@p ;
...
position p;
@@
 struct mtk_aes_base_ctx * cocci_id@p ;
...
position p;
@@
 const struct mtk_aes_dma * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,u32,dma_addr_t;
@@
 struct mtk_aes_base_ctx {  struct mtk_cryp * cryp ;  u32 keylen ;  __le32 key [ 12 ] ;  __le32 keymode ;  mtk_aes_fn start ;  struct mtk_aes_info info ;  dma_addr_t ct_dma ;  dma_addr_t tfm_dma ;  __le32 ct_hdr ;  u32 ct_size ; } cocci_id@p ;
...
typedef u32;
@@
 struct mtk_aes_gcm_ctx {  struct mtk_aes_base_ctx base ;  u32 authsize ;  size_t textlen ;  struct crypto_skcipher * ctr ; } cocci_id@p ;
...
typedef __le32;
@@
 struct mtk_aes_info {  __le32 cmd [ AES_MAX_CT_SIZE ] ;  __le32 tfm [ 2 ] ;  __le32 state [ AES_MAX_STATE_BUF_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct mtk_aes_ctx {  struct mtk_aes_base_ctx base ; } cocci_id@p ;
