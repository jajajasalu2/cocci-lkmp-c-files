...
position p;
@@
 struct b43legacy_txhdr_fw3 * cocci_id@p ;
...
position p;
@@
 struct b43legacy_key * cocci_id@p ;
...
position p;
@@
 const struct b43legacy_rxhdr_fw3 * cocci_id@p ;
...
position p;
@@
 const struct b43legacy_hwtxstatus * cocci_id@p ;
...
position p;
@@
 const struct b43legacy_txstatus * cocci_id@p ;
