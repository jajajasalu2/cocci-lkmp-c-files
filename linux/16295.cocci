...
position p;
@@
 const struct v4l2_mpeg2_sequence * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_mpeg2_slice_params * cocci_id@p ;
...
position p;
@@
 const struct v4l2_mpeg2_picture * cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_mpeg2_quantization * cocci_id@p ;
