...
position p;
@@
 struct intel_renderstate cocci_id@p ;
...
typedef u32;
@@
 struct intel_renderstate {  const struct intel_renderstate_rodata * rodata ;  struct drm_i915_gem_object * obj ;  struct i915_vma * vma ;  u32 batch_offset ;  u32 batch_size ;  u32 aux_offset ;  u32 aux_size ; } cocci_id@p ;
...
position p;
@@
 const struct intel_renderstate_rodata * cocci_id@p ;
