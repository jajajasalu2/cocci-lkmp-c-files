...
position p;
@@
 struct psb_intel_lvds_priv cocci_id@p ;
...
position p;
@@
 struct psb_intel_i2c_chan * cocci_id@p ;
...
typedef uint32_t;
@@
 struct psb_intel_lvds_priv {  uint32_t savePP_ON ;  uint32_t savePP_OFF ;  uint32_t saveLVDS ;  uint32_t savePP_CONTROL ;  uint32_t savePP_CYCLE ;  uint32_t savePFIT_CONTROL ;  uint32_t savePFIT_PGM_RATIOS ;  uint32_t saveBLC_PWM_CTL ;  struct psb_intel_i2c_chan * i2c_bus ;  struct psb_intel_i2c_chan * ddc_bus ; } cocci_id@p ;
