...
position p;
@@
 struct gemini_ethernet_port cocci_id@p ;
...
position p;
@@
 union gmac_ahb_weight cocci_id@p ;
...
position p;
@@
 union gmac_txdesc_0 cocci_id@p ;
...
position p;
@@
 union gmac_txdesc_1 cocci_id@p ;
...
position p;
@@
 const struct gmac_max_framelen * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct gmac_queue_page {  struct page * page ;  dma_addr_t mapping ; } cocci_id@p ;
...
position p;
@@
 struct gmac_queue_page * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,__le32,u8,spinlock_t,dma_addr_t;
@@
 struct gemini_ethernet_port {  u8 id ;  struct gemini_ethernet * geth ;  struct net_device * netdev ;  struct device * dev ;  void __iomem * dma_base ;  void __iomem * gmac_base ;  struct clk * pclk ;  struct reset_control * reset ;  int irq ;  __le32 mac_addr [ 3 ] ;  void __iomem * rxq_rwptr ;  struct gmac_rxdesc * rxq_ring ;  unsigned int rxq_order ;  struct napi_struct napi ;  struct hrtimer rx_coalesce_timer ;  unsigned int rx_coalesce_nsecs ;  unsigned int freeq_refill ;  struct gmac_txq txq [ TX_QUEUE_NUM ] ;  unsigned int txq_order ;  unsigned int irq_every_tx_packets ;  dma_addr_t rxq_dma_base ;  dma_addr_t txq_dma_base ;  unsigned int msg_enable ;  spinlock_t config_lock ;  struct u64_stats_sync tx_stats_syncp ;  struct u64_stats_sync rx_stats_syncp ;  struct u64_stats_sync ir_stats_syncp ;  struct rtnl_link_stats64 stats ;  u64 hw_stats [ RX_STATS_NUM ] ;  u64 rx_stats [ RX_STATUS_NUM ] ;  u64 rx_csum_stats [ RX_CHKSUM_NUM ] ;  u64 rx_napi_exits ;  u64 tx_frag_stats [ TX_MAX_FRAGS ] ;  u64 tx_frags_linearized ;  u64 tx_hw_csummed ; } cocci_id@p ;
...
position p;
@@
 union gmac_dma_ctrl cocci_id@p ;
...
position p;
@@
 struct gmac_txq {  struct gmac_txdesc * ring ;  struct sk_buff * * skb ;  unsigned int cptr ;  unsigned int noirq_packets ; } cocci_id@p ;
...
typedef u8;
@@
 struct gmac_max_framelen {  unsigned int max_l3_len ;  u8 val ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,spinlock_t,dma_addr_t;
@@
 struct gemini_ethernet {  struct device * dev ;  void __iomem * base ;  struct gemini_ethernet_port * port0 ;  struct gemini_ethernet_port * port1 ;  bool initialized ;  spinlock_t irq_lock ;  unsigned int freeq_order ;  unsigned int freeq_frag_order ;  struct gmac_rxdesc * freeq_ring ;  dma_addr_t freeq_dma_base ;  struct gmac_queue_page * freeq_pages ;  unsigned int num_freeq_pages ;  spinlock_t freeq_lock ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * netdev ) ;
...
position p;
@@
 const char cocci_id@p [ GMAC_STATS_NUM ] [ ETH_GSTRING_LEN ] ;
...
position p;
@@
 struct gemini_ethernet * cocci_id@p ;
...
position p;
@@
 union queue_threshold cocci_id@p ;
...
position p;
@@
 union gmac_rxdesc_1 cocci_id@p ;
...
position p;
@@
 union gmac_rxdesc_0 cocci_id@p ;
...
position p;
@@
 union gmac_rxdesc_3 cocci_id@p ;
