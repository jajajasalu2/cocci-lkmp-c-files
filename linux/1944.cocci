...
position p;
@@
 struct hp206c_data {  struct mutex mutex ;  struct i2c_client * client ;  int temp_osr_index ;  int pres_osr_index ; } cocci_id@p ;
...
typedef u8;
@@
 struct hp206c_osr_setting {  u8 osr_mask ;  unsigned int temp_conv_time_us ;  unsigned int pres_conv_time_us ; } cocci_id@p ;
...
position p;
@@
 const struct hp206c_osr_setting cocci_id@p [ ] ;
