...
position p;
@@
 enum dlm_lockres_list cocci_id@p ;
...
position p;
@@
 struct dlm_bitmap_diff_iter cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dlm_master_list_entry * mle ) ;
...
position p;
@@
 struct dlm_master_list_entry cocci_id@p ;
...
position p;
@@
 struct dlm_node_iter cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , struct dlm_master_list_entry * mle , int * blocked ) ;
...
position p;
@@
 void cocci_id@p ( struct dlm_master_list_entry * mle , enum dlm_mle_type type , struct dlm_ctxt * dlm , struct dlm_lock_resource * res , const char * name , unsigned int namelen ) ;
...
position p;
@@
 struct dlm_migrate_request cocci_id@p ;
...
position p;
@@
 struct dlm_master_request * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , void * nodemap , u32 flags ) ;
...
position p;
@@
 struct dlm_assert_master cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dlm_lock_resource * res , struct dlm_master_list_entry * mle , int to ) ;
...
position p;
@@
 struct dlm_work_item * cocci_id@p ;
...
position p;
@@
 enum dlm_node_state_change { NODE_DOWN = - 1 , NODE_NO_CHANGE = 0 , NODE_UP , } cocci_id@p ;
...
position p;
@@
 struct dlm_deref_lockres_done cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res ) ;
...
position p;
@@
 struct dlm_lock_resource * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_master_list_entry * mle , struct o2nm_node * node , int idx ) ;
...
position p;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res ) ;
...
position p;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_master_list_entry * * mle , char * name , unsigned int namelen ) ;
...
position p;
@@
 struct dlm_deref_lockres * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , struct dlm_master_list_entry * mle , struct dlm_master_list_entry * * oldmle , const char * name , unsigned int namelen , u8 new_master , u8 master ) ;
...
position p;
@@
 void cocci_id@p ( struct dlm_work_item * item , void * data ) ;
...
position p;
@@
 enum dlm_node_state_change * cocci_id@p ;
...
position p;
@@
 struct dlm_migratable_lockres * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res ) ;
...
position p;
@@
 unsigned long cocci_id@p [ BITS_TO_LONGS ( O2NM_MAX_NODES ) ] ;
...
typedef u8;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , u8 target ) ;
...
position p;
@@
 struct dlm_bitmap_diff_iter {  int curnode ;  unsigned long * orig_bm ;  unsigned long * cur_bm ;  unsigned long diff_bm [ BITS_TO_LONGS ( O2NM_MAX_NODES ) ] ; } cocci_id@p ;
