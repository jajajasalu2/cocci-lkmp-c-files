...
position p;
@@
 enum ni_660x_boardid { BOARD_PCI6601 , BOARD_PCI6602 , BOARD_PXI6602 , BOARD_PCI6608 , BOARD_PXI6608 , BOARD_PCI6624 , BOARD_PXI6624 , } cocci_id@p ;
...
position p;
@@
 const struct ni_660x_register_data cocci_id@p [ NI660X_NUM_REGS ] ;
...
position p;
@@
 const struct ni_660x_board cocci_id@p [ ] ;
...
position p;
@@
 struct ni_gpct_device * cocci_id@p ;
...
position p;
@@
 struct ni_660x_register_data {  int offset ;  char size ; } cocci_id@p ;
...
@@
 struct ni_660x_private {  struct mite * mite ;  struct ni_gpct_device * counter_dev ;  struct mite_ring * ring [ NI660X_MAX_CHIPS ] [ NI660X_COUNTERS_PER_CHIP ] ;  spinlock_t mite_channel_lock ;  spinlock_t interrupt_lock ;  unsigned int dma_cfg [ NI660X_MAX_CHIPS ] ;  unsigned int io_cfg [ NI660X_NUM_PFI_CHANNELS ] ;  u64 io_dir ;  struct ni_route_tables routing_tables ; } cocci_id@p ;
...
position p;
@@
 struct ni_660x_private * cocci_id@p ;
...
position p;
@@
 struct ni_660x_board {  const char * name ;  unsigned int n_chips ; } cocci_id@p ;
