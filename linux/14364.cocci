...
typedef u8;
@@
 u8 cocci_id@p [ MXL_HYDRA_REG_WRITE_LEN ] ;
...
position p;
@@
 struct MXL_HYDRA_MPEGOUT_PARAM_T cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MXL_HYDRA_DEMOD_MAX ] ;
...
position p;
@@
 enum MXL_HYDRA_MODULATION_E cocci_id@p ;
...
position p;
@@
 enum MXL_HYDRA_ROLLOFF_E cocci_id@p ;
...
position p;
@@
 struct MXL_HYDRA_DEMOD_PARAM_T cocci_id@p ;
...
position p;
@@
 enum MXL_HYDRA_FEC_E cocci_id@p ;
...
position p;
@@
 struct MXL_HYDRA_DEMOD_ABORT_TUNE_T cocci_id@p ;
...
position p;
@@
 enum MXL_HYDRA_TS_DRIVE_STRENGTH_E cocci_id@p ;
...
position p;
@@
 struct MBIN_FILE_HEADER_T * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MXL_HYDRA_OEM_MAX_BLOCK_WRITE_LENGTH - ( MXL_HYDRA_I2C_HDR_SIZE + MXL_HYDRA_REG_SIZE_IN_BYTES ) ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MXL_HYDRA_REG_SIZE_IN_BYTES + MXL_HYDRA_I2C_HDR_SIZE ] ;
...
position p;
@@
 enum MXL_HYDRA_PILOTS_E cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct mxl * state , u32 tuner , u32 enable ) ;
...
position p;
@@
 struct MXL_HYDRA_TUNER_CMD cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MXL_DEMOD_CHAN_PARAMS_BUFF_SIZE ] ;
...
position p;
@@
 struct MXL_REG_FIELD_T cocci_id@p [ MXL_HYDRA_DEMOD_MAX ] ;
...
position p;
@@
 struct MXL_HYDRA_SKU_COMMAND_T cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct MXL_HYDRA_SKU_COMMAND_T ) + 6 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MXL_HYDRA_OEM_MAX_CMD_BUFF_LEN ] ;
...
position p;
@@
 enum fe_code_rate cocci_id@p [ 11 ] ;
...
position p;
@@
 int * * cocci_id@p ( struct dvb_frontend * , int ) ;
...
position p;
@@
 struct MBIN_SEGMENT_T * cocci_id@p ;
...
position p;
@@
 enum MXL_HYDRA_DEMOD_ID_E cocci_id@p ;
...
typedef u8,u32;
@@
 struct mxl {  struct list_head mxl ;  struct mxl_base * base ;  struct dvb_frontend fe ;  struct device * i2cdev ;  u32 demod ;  u32 tuner ;  u32 tuner_in_use ;  u8 xbar [ 3 ] ;  unsigned long tune_time ; } cocci_id@p ;
