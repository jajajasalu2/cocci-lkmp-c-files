...
position p;
@@
 struct vf610_dac {  struct clk * clk ;  struct device * dev ;  enum vf610_conversion_mode_sel conv_mode ;  void __iomem * regs ; } cocci_id@p ;
...
position p;
@@
 enum vf610_conversion_mode_sel { VF610_DAC_CONV_HIGH_POWER , VF610_DAC_CONV_LOW_POWER , } cocci_id@p ;
