...
typedef u8;
@@
 i40e_status cocci_id@p ( struct i40e_hw * hw , struct i40e_nvm_access * cmd , u8 * bytes , int * errno ) ;
...
position p;
@@
 i40e_status cocci_id@p ( struct i40e_hw * hw , struct i40e_nvm_access * cmd , int * perrno ) ;
...
typedef u8;
@@
 i40e_status cocci_id@p ( struct i40e_hw * hw , struct i40e_nvm_access * cmd , u8 * bytes , int * perrno ) ;
...
position p;
@@
 enum i40e_nvmupd_cmd cocci_id@p ;
...
position p;
@@
 struct i40e_nvm_info * cocci_id@p ;
...
position p;
@@
 enum i40e_nvmupd_cmd cocci_id@p ( struct i40e_hw * hw , struct i40e_nvm_access * cmd , int * perrno ) ;
