...
position p;
@@
 struct ips_mcp_limits cocci_id@p ;
...
position p;
@@
 struct ips_mcp_limits {  int mcp_power_limit ;  int core_power_limit ;  int mch_power_limit ;  int core_temp_limit ;  int mch_temp_limit ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ips_driver * ips ) ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,u16,spinlock_t;
@@
 struct ips_driver {  struct device * dev ;  void __iomem * regmap ;  int irq ;  struct task_struct * monitor ;  struct task_struct * adjust ;  struct dentry * debug_root ;  struct timer_list timer ;  u16 ctv1_avg_temp ;  u16 ctv2_avg_temp ;  u16 mch_avg_temp ;  u16 mcp_avg_temp ;  u32 cpu_avg_power ;  u32 mch_avg_power ;  u16 cta_val ;  u16 pta_val ;  u16 mgta_val ;  spinlock_t turbo_status_lock ;  u16 mcp_temp_limit ;  u16 mcp_power_limit ;  u16 core_power_limit ;  u16 mch_power_limit ;  bool cpu_turbo_enabled ;  bool __cpu_turbo_on ;  bool gpu_turbo_enabled ;  bool __gpu_turbo_on ;  bool gpu_preferred ;  bool poll_turbo_status ;  bool second_cpu ;  bool turbo_toggle_allowed ;  struct ips_mcp_limits * limits ;  unsigned long ( * read_mch_val ) ( void ) ;  bool ( * gpu_raise ) ( void ) ;  bool ( * gpu_lower ) ( void ) ;  bool ( * gpu_busy ) ( void ) ;  bool ( * gpu_turbo_disable ) ( void ) ;  u64 orig_turbo_limit ;  u64 orig_turbo_ratios ; } cocci_id@p ;
