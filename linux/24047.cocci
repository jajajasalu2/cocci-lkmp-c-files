...
position p;
@@
 const struct datapath * cocci_id@p ;
...
position p;
@@
 struct ovs_vport_stats cocci_id@p ;
...
position p;
@@
 struct genl_family * const cocci_id@p [ ] ;
...
position p;
@@
 const struct sw_flow_mask * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ ] ;
...
position p;
@@
 const struct ovs_header * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ OVS_VPORT_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ovs_dp_stats * cocci_id@p ;
...
position p;
@@
 struct ovs_dp_megaflow_stats * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ OVS_DP_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ovs_flow_stats cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ OVS_VPORT_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ OVS_PACKET_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct table_instance * cocci_id@p ;
...
position p;
@@
 const struct sw_flow_id * cocci_id@p ;
...
position p;
@@
 struct vport * cocci_id@p ( const struct vport_parms * ) ;
...
position p;
@@
 struct nlattr * cocci_id@p [ __OVS_FLOW_ATTR_MAX ] ;
...
position p;
@@
 const struct dp_upcall_info * cocci_id@p ;
...
position p;
@@
 struct dp_stats_percpu cocci_id@p ;
...
position p;
@@
 const struct vport_parms * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ OVS_FLOW_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct dp_stats_percpu * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ OVS_DP_ATTR_MAX + 1 ] ;
