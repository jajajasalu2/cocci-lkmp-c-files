...
position p;
@@
 int ( * cocci_id@p ) ( struct ceph_osd_request * req , void * arg ) ;
...
position p;
@@
 struct ceph_hobject_id cocci_id@p ;
...
position p;
@@
 const struct ceph_osd_backoff * cocci_id@p ;
...
position p;
@@
 struct ceph_msg_data * cocci_id@p ;
...
position p;
@@
 const struct ceph_spg * cocci_id@p ;
...
position p;
@@
 struct ceph_osd_reqid cocci_id@p ;
...
position p;
@@
 struct ceph_msg_header * cocci_id@p ;
...
position p;
@@
 struct ceph_osd_req_op * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ceph_osd * osd , struct ceph_osd_request * req ) ;
...
position p;
@@
 struct ceph_pg_pool_info * cocci_id@p ;
...
position p;
@@
 struct ceph_request_redirect * cocci_id@p ;
...
position p;
@@
 const struct ceph_msg * cocci_id@p ;
...
position p;
@@
 const struct ceph_hobject_id * cocci_id@p ;
...
position p;
@@
 enum calc_target_result { CALC_TARGET_NO_ACTION = 0 , CALC_TARGET_NEED_RESEND , CALC_TARGET_POOL_DNE , } cocci_id@p ;
...
position p;
@@
 struct ceph_spg_mapping * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ceph_osd_request * req , int err ) ;
...
position p;
@@
 const struct ceph_connection_operations cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ceph_osd_linger_request * lreq ) ;
...
position p;
@@
 struct ceph_auth_client * cocci_id@p ;
...
position p;
@@
 const struct ceph_object_locator * cocci_id@p ;
...
position p;
@@
 struct ceph_osd_request_target * cocci_id@p ;
...
position p;
@@
 struct ceph_mon_generic_request * cocci_id@p ;
...
position p;
@@
 struct ceph_pagelist * cocci_id@p ;
...
position p;
@@
 struct ceph_auth_handshake * cocci_id@p ;
...
position p;
@@
 struct ceph_osd_backoff * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ceph_osd * osd , struct ceph_osd_linger_request * lreq ) ;
...
position p;
@@
 const struct ceph_osd_req_op * cocci_id@p ;
...
position p;
@@
 const struct ceph_osd_request_target * cocci_id@p ;
...
position p;
@@
 struct rw_semaphore * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ceph_osd * osd ) ;
...
position p;
@@
 void cocci_id@p ( struct ceph_osd_request * req ) ;
...
position p;
@@
 struct ceph_blkin_trace_info cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct MOSDBackoff {  struct ceph_spg spgid ;  u32 map_epoch ;  u8 op ;  u64 id ;  struct ceph_hobject_id * begin ;  struct ceph_hobject_id * end ; } cocci_id@p ;
...
position p;
@@
 const struct ceph_pg * cocci_id@p ;
...
position p;
@@
 const struct MOSDBackoff * cocci_id@p ;
...
typedef u64,s32,u32;
@@
 struct MOSDOpReply {  struct ceph_pg pgid ;  u64 flags ;  int result ;  u32 epoch ;  int num_ops ;  u32 outdata_len [ CEPH_OSD_MAX_OPS ] ;  s32 rval [ CEPH_OSD_MAX_OPS ] ;  int retry_attempt ;  struct ceph_eversion replay_version ;  u64 user_version ;  struct ceph_request_redirect redirect ; } cocci_id@p ;
...
position p;
@@
 struct ceph_connection * cocci_id@p ;
...
position p;
@@
 enum calc_target_result cocci_id@p ;
...
position p;
@@
 struct ceph_eversion cocci_id@p ;
...
typedef u64;
@@
 struct linger_work {  struct work_struct work ;  struct ceph_osd_linger_request * lreq ;  struct list_head pending_item ;  unsigned long queued_stamp ;  union {  struct {  u64 notify_id ;  u64 notifier_id ;  void * payload ;  size_t payload_len ;  struct ceph_msg * msg ; } notify ;  struct {  int err ; } error ; } ; } cocci_id@p ;
