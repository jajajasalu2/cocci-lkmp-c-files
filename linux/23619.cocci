...
@@
 struct rsnd_dmaen {  struct dma_chan * chan ;  dma_cookie_t cookie ;  unsigned int dma_len ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct dma_addr {  dma_addr_t out_addr ;  dma_addr_t in_addr ; } cocci_id@p [ 3 ] [ 2 ] [ 3 ] ;
...
typedef dma_addr_t;
@@
 struct rsnd_dma {  struct rsnd_mod mod ;  struct rsnd_mod * mod_from ;  struct rsnd_mod * mod_to ;  dma_addr_t src_addr ;  dma_addr_t dst_addr ;  union {  struct rsnd_dmaen en ;  struct rsnd_dmapp pp ; } dma ; } cocci_id@p ;
...
position p;
@@
 struct rsnd_dma_ctrl {  void __iomem * base ;  int dmaen_num ;  int dmapp_num ; } cocci_id@p ;
...
typedef u32;
@@
 struct rsnd_dmapp {  int dmapp_id ;  u32 chcr ; } cocci_id@p ;
...
position p;
@@
 struct rsnd_dma_ctrl * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rsnd_dai_stream * io , struct rsnd_dma * dma , struct rsnd_mod * mod_from , struct rsnd_mod * mod_to ) ;
...
position p;
@@
 struct rsnd_mod * cocci_id@p [ MOD_MAX ] ;
