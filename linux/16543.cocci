...
position p;
@@
 struct dasd_fba_private {  struct dasd_fba_characteristics rdc_data ; } cocci_id@p ;
...
position p;
@@
 struct dasd_fba_private * cocci_id@p ;
