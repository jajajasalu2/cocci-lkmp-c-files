...
position p;
@@
 const unsigned char cocci_id@p [ 162 + 2 ] ;
...
position p;
@@
 const struct coda_memcpy_desc cocci_id@p [ 8 ] ;
...
position p;
@@
 const struct coda_memcpy_desc * cocci_id@p ;
...
position p;
@@
 struct coda_memcpy_desc cocci_id@p [ 3 ] ;
...
position p;
@@
 struct coda_memcpy_desc {  int offset ;  const void * src ;  size_t len ; } cocci_id@p ;
