...
position p;
@@
 struct kcm_psock_stats cocci_id@p ;
...
position p;
@@
 struct kcm_proc_mux_state cocci_id@p ;
...
position p;
@@
 struct strp_aggr_stats cocci_id@p ;
...
position p;
@@
 struct kcm_mux_stats cocci_id@p ;
...
position p;
@@
 struct kcm_proc_mux_state {  struct seq_net_private p ;  int idx ; } cocci_id@p ;
