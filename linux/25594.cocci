...
position p;
@@
 struct local_vars_finder cocci_id@p ;
...
position p;
@@
 struct find_scope_param cocci_id@p ;
...
position p;
@@
 enum dso_binary_type cocci_id@p [ ] ;
...
position p;
@@
 struct variable_list * * cocci_id@p ;
...
position p;
@@
 struct probe_trace_point * cocci_id@p ;
...
position p;
@@
 struct dwarf_callback_param * cocci_id@p ;
...
position p;
@@
 struct trace_event_finder * cocci_id@p ;
...
position p;
@@
 struct perf_probe_arg cocci_id@p ;
...
position p;
@@
 struct perf_probe_arg_field * cocci_id@p ;
...
typedef bool;
@@
 struct find_scope_param {  const char * function ;  const char * file ;  int line ;  int diff ;  Dwarf_Die * die_mem ;  bool found ; } cocci_id@p ;
...
position p;
@@
 struct probe_finder * cocci_id@p ;
...
position p;
@@
 struct perf_probe_point * cocci_id@p ;
...
position p;
@@
 struct pubname_callback_param cocci_id@p ;
...
position p;
@@
 struct pubname_callback_param {  char * function ;  char * file ;  Dwarf_Die * cu_die ;  Dwarf_Die * sp_die ;  int found ; } cocci_id@p ;
...
position p;
@@
 struct dwarf_callback_param {  void * data ;  int retval ; } cocci_id@p ;
...
position p;
@@
 const Dwfl_Callbacks cocci_id@p ;
...
position p;
@@
 struct available_var_finder * cocci_id@p ;
...
typedef bool;
@@
 struct local_vars_finder {  struct probe_finder * pf ;  struct perf_probe_arg * args ;  bool vars ;  int max_args ;  int nargs ;  int ret ; } cocci_id@p ;
