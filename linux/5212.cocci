...
typedef u64,bool;
@@
 struct octeon_cf_port {  struct hrtimer delayed_finish ;  struct ata_port * ap ;  int dma_finished ;  void * c0 ;  unsigned int cs0 ;  unsigned int cs1 ;  bool is_true_ide ;  u64 dma_base ; } cocci_id@p ;
...
position p;
@@
 union cvmx_mio_boot_dma_cfgx cocci_id@p ;
...
position p;
@@
 union cvmx_mio_boot_dma_intx cocci_id@p ;
...
position p;
@@
 union cvmx_mio_boot_dma_timx cocci_id@p ;
...
position p;
@@
 struct octeon_cf_port cocci_id@p ;
...
position p;
@@
 union cvmx_mio_boot_reg_timx cocci_id@p ;
...
position p;
@@
 union cvmx_mio_boot_pin_defs cocci_id@p ;
...
position p;
@@
 union cvmx_mio_boot_reg_cfgx cocci_id@p ;
