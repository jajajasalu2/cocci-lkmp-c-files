...
position p;
@@
 struct pxa_gpio_platform_data * cocci_id@p ;
...
position p;
@@
 struct pxa_gpio_chip * cocci_id@p ;
...
position p;
@@
 struct pxa_gpio_bank * cocci_id@p ;
...
position p;
@@
 struct pxa_gpio_id {  enum pxa_gpio_type type ;  int gpio_nums ; } cocci_id@p ;
...
position p;
@@
 enum pxa_gpio_type { PXA25X_GPIO = 0 , PXA26X_GPIO , PXA27X_GPIO , PXA3XX_GPIO , PXA93X_GPIO , MMP_GPIO = 0x10 , MMP2_GPIO , PXA1928_GPIO , } cocci_id@p ;
...
position p;
@@
 struct pxa_gpio_chip {  struct device * dev ;  struct gpio_chip chip ;  struct pxa_gpio_bank * banks ;  struct irq_domain * irqdomain ;  int irq0 ;  int irq1 ;  int ( * set_wake ) ( unsigned int gpio , unsigned int on ) ; } cocci_id@p ;
...
position p;
@@
 const struct pxa_gpio_id * cocci_id@p ;
