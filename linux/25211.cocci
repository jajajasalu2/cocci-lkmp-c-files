...
position p;
@@
 struct guest {  unsigned avail_idx ;  unsigned last_used_idx ;  unsigned num_free ;  unsigned kicked_avail_idx ;  unsigned char reserved [ HOST_GUEST_PADDING - 12 ] ; } cocci_id@p ;
...
position p;
@@
 struct data {  void * buf ;  void * data ; } * cocci_id@p ;
...
position p;
@@
 struct host {  unsigned used_idx ;  unsigned called_used_idx ;  unsigned char reserved [ HOST_GUEST_PADDING - 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct desc {  unsigned short flags ;  unsigned short index ;  unsigned len ;  unsigned long long addr ; } cocci_id@p ;
...
position p;
@@
 struct event {  unsigned short kick_index ;  unsigned char reserved0 [ HOST_GUEST_PADDING - 2 ] ;  unsigned short call_index ;  unsigned char reserved1 [ HOST_GUEST_PADDING - 2 ] ; } cocci_id@p ;
