...
position p;
@@
 union nested_table {  union nested_table __rcu * table ;  struct rhash_lock_head * bucket ; } cocci_id@p ;
...
position p;
@@
 struct bucket_table cocci_id@p ;
...
position p;
@@
 struct rhash_lock_head * * cocci_id@p ;
...
position p;
@@
 struct rhashtable_walker * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * ptr , void * arg ) ;
...
position p;
@@
 const struct rhash_head * cocci_id@p ;
