...
position p;
@@
 struct svga_3d_compat_cap * cocci_id@p ;
...
position p;
@@
 struct svga_3d_compat_cap {  SVGA3dCapsRecordHeader header ;  SVGA3dCapPair pairs [ SVGA3D_DEVCAP_MAX ] ; } cocci_id@p ;
...
position p;
@@
 const struct vmw_fifo_state * cocci_id@p ;
