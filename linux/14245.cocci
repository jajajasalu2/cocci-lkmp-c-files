...
symbol cocci_id;
position p;
typedef jpeg_decode_params_t;
@@
 struct jpeg_decode_params_t cocci_id@p ;
...
position p;
@@
 const struct delta_dec cocci_id@p ;
...
symbol cocci_id;
position p;
typedef jpeg_decode_return_params_t;
@@
 struct jpeg_decode_return_params_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef jpeg_display_buffer_address_t;
@@
 struct jpeg_display_buffer_address_t cocci_id@p ;
...
position p;
@@
 struct mjpeg_header * cocci_id@p ;
...
position p;
@@
 struct delta_mjpeg_ctx * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef jpeg_decoding_error_t;
@@
 enum jpeg_decoding_error_t cocci_id@p ;
...
position p;
@@
 struct delta_mjpeg_ctx {  struct mjpeg_header header_struct ;  struct mjpeg_header * header ;  void * ipc_hdl ;  struct delta_buf * ipc_buf ;  struct delta_frame * out_frame ;  unsigned char str [ 3000 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef jpeg_video_decode_init_params_t;
@@
 struct jpeg_video_decode_init_params_t * cocci_id@p ;
...
position p;
@@
 struct delta_streaminfo * cocci_id@p ;
