...
position p;
@@
 struct gb_audio_widget cocci_id@p ;
...
position p;
@@
 struct snd_soc_codec * cocci_id@p ;
...
position p;
@@
 struct gb_audio_enumerated cocci_id@p ;
...
position p;
@@
 struct gbaudio_ctl_pvt * cocci_id@p ;
...
position p;
@@
 struct gb_audio_ctl_elem_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_ctl_elem_type_t;
@@
 snd_ctl_elem_type_t cocci_id@p ;
...
position p;
@@
 struct gb_audio_control cocci_id@p ;
...
position p;
@@
 struct gb_audio_topology * cocci_id@p ;
...
position p;
@@
 struct gbaudio_control * cocci_id@p ;
...
position p;
@@
 struct gbaudio_ctl_pvt {  unsigned int ctl_id ;  unsigned int data_cport ;  unsigned int access ;  unsigned int vcount ;  struct gb_audio_ctl_elem_info * info ; } cocci_id@p ;
...
position p;
@@
 struct gbaudio_widget cocci_id@p ;
...
position p;
@@
 struct gb_audio_route * cocci_id@p ;
...
position p;
@@
 struct gbaudio_codec_info * cocci_id@p ;
...
position p;
@@
 struct gb_audio_ctl_elem_value cocci_id@p ;
...
position p;
@@
 struct gbaudio_module_info * cocci_id@p ;
