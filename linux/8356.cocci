...
typedef u8,u32;
@@
 struct nfp_abm_u32_match {  u32 handle ;  u32 band ;  u8 mask ;  u8 val ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct nfp_abm_u32_match * cocci_id@p ;
...
position p;
@@
 struct tc_cls_u32_knode * cocci_id@p ;
