...
position p;
@@
 struct ioc3_ethregs * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ioc3_private * ip ) ;
...
position p;
@@
 unsigned int cocci_id@p ( const unsigned char * addr ) ;
...
position p;
@@
 int cocci_id@p ( struct ioc3_private * ip ) ;
...
position p;
@@
 struct ioc3_private cocci_id@p ;
