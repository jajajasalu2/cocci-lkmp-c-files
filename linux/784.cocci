...
position p;
@@
 enum altera_pcie_version { ALTERA_PCIE_V1 = 0 , ALTERA_PCIE_V2 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef tlp_rp_regpair_t;
@@
 struct tlp_rp_regpair_t * cocci_id@p ;
...
typedef u32;
@@
 struct altera_pcie_data {  const struct altera_pcie_ops * ops ;  enum altera_pcie_version version ;  u32 cap_offset ;  u32 cfgrd0 ;  u32 cfgrd1 ;  u32 cfgwr0 ;  u32 cfgwr1 ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,tlp_rp_regpair_t;
@@
 struct tlp_rp_regpair_t {  u32 ctrl ;  u32 reg0 ;  u32 reg1 ; } cocci_id@p ;
...
position p;
@@
 const struct altera_pcie_data cocci_id@p ;
...
position p;
@@
 const struct altera_pcie_ops cocci_id@p ;
...
typedef u8;
@@
 struct altera_pcie {  struct platform_device * pdev ;  void __iomem * cra_base ;  void __iomem * hip_base ;  int irq ;  u8 root_bus_nr ;  struct irq_domain * irq_domain ;  struct resource bus_range ;  const struct altera_pcie_data * pcie_data ; } cocci_id@p ;
