...
position p;
@@
 const struct iris_data cocci_id@p ;
...
position p;
@@
 struct qcom_iris {  struct device * dev ;  struct clk * xo_clk ;  struct regulator_bulk_data * vregs ;  size_t num_vregs ; } cocci_id@p ;
...
typedef bool;
@@
 struct iris_data {  const struct wcnss_vreg_info * vregs ;  size_t num_vregs ;  bool use_48mhz_xo ; } cocci_id@p ;
