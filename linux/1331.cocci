...
position p;
@@
 const struct omap_usb_config * cocci_id@p ;
...
typedef bool;
@@
 struct otg_device {  void __iomem * base ;  bool id ;  bool vbus ;  struct extcon_dev * extcon ;  struct notifier_block vbus_nb ;  struct notifier_block id_nb ; } cocci_id@p ;
