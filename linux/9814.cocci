...
position p;
@@
 int ( * cocci_id@p ) ( struct ath5k_hw * hw , int mode ) ;
...
position p;
@@
 struct ath5k_chan_pcal_info_rf2413 * cocci_id@p ;
...
position p;
@@
 struct ath5k_chan_pcal_info_rf5112 * cocci_id@p ;
...
position p;
@@
 struct ath5k_chan_pcal_info_rf5111 * cocci_id@p ;
