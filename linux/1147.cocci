...
position p;
@@
 struct pcc_memory_resource * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct pcc_header {  u32 signature ;  u16 length ;  u8 major ;  u8 minor ;  u32 features ;  u16 command ;  u16 status ;  u32 latency ;  u32 minimum_time ;  u32 maximum_time ;  u32 nominal ;  u32 throttled_frequency ;  u32 minimum_frequency ; } cocci_id@p ;
...
typedef u32;
@@
 struct pcc_cpu {  u32 input_offset ;  u32 output_offset ; } cocci_id@p ;
...
position p;
@@
 struct pcc_register_resource * cocci_id@p ;
