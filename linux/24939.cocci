...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_NET_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_UDP_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_PROP_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_MON_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_NAME_TABLE_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_SOCK_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_BEARER_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_LINK_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_MEDIA_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TIPC_NLA_NODE_MAX + 1 ] ;
