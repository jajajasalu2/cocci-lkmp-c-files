...
position p;
@@
 struct dev_pm_domain cocci_id@p ;
...
position p;
@@
 const struct lpss_device_desc cocci_id@p ;
...
typedef bool;
@@
 struct lpss_device_desc {  unsigned int flags ;  const char * clk_con_id ;  unsigned int prv_offset ;  size_t prv_size_override ;  struct property_entry * properties ;  void ( * setup ) ( struct lpss_private_data * pdata ) ;  bool resume_from_noirq ; } cocci_id@p ;
...
position p;
@@
 const struct lpss_device_links * cocci_id@p ;
...
position p;
@@
 struct lpss_private_data cocci_id@p ;
...
typedef u32;
@@
 struct lpss_device_links {  const char * supplier_hid ;  const char * supplier_uid ;  const char * consumer_hid ;  const char * consumer_uid ;  u32 flags ;  const struct dmi_system_id * dep_missing_ids ; } cocci_id@p ;
...
position p;
@@
 struct hid_uid {  const char * hid ;  const char * uid ; } cocci_id@p ;
...
position p;
@@
 const struct hid_uid * cocci_id@p ;
...
position p;
@@
 struct lpss_clk_data * cocci_id@p ;
...
@@
 struct lpss_private_data {  struct acpi_device * adev ;  void __iomem * mmio_base ;  resource_size_t mmio_size ;  unsigned int fixed_clk_rate ;  struct clk * clk ;  const struct lpss_device_desc * dev_desc ;  u32 prv_reg_ctx [ LPSS_PRV_REG_COUNT ] ; } cocci_id@p ;
