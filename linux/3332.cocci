...
position p;
@@
 struct adt7462_data * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ NUM_TRANGE_VALUES ] ;
...
typedef u8,u16;
@@
 struct adt7462_data {  struct i2c_client * client ;  struct mutex lock ;  char sensors_valid ;  char limits_valid ;  unsigned long sensors_last_updated ;  unsigned long limits_last_updated ;  u8 temp [ ADT7462_TEMP_COUNT ] ;  u8 temp_frac [ ADT7462_TEMP_COUNT ] ;  u8 temp_min [ ADT7462_TEMP_COUNT ] ;  u8 temp_max [ ADT7462_TEMP_COUNT ] ;  u16 fan [ ADT7462_FAN_COUNT ] ;  u8 fan_enabled ;  u8 fan_min [ ADT7462_FAN_COUNT ] ;  u8 cfg2 ;  u8 pwm [ ADT7462_PWM_COUNT ] ;  u8 pin_cfg [ ADT7462_PIN_CFG_REG_COUNT ] ;  u8 voltages [ ADT7462_VOLT_COUNT ] ;  u8 volt_max [ ADT7462_VOLT_COUNT ] ;  u8 volt_min [ ADT7462_VOLT_COUNT ] ;  u8 pwm_min [ ADT7462_PWM_COUNT ] ;  u8 pwm_tmin [ ADT7462_PWM_COUNT ] ;  u8 pwm_trange [ ADT7462_PWM_COUNT ] ;  u8 pwm_max ;  u8 pwm_cfg [ ADT7462_PWM_COUNT ] ;  u8 alarms [ ADT7462_ALARM_REG_COUNT ] ; } cocci_id@p ;
