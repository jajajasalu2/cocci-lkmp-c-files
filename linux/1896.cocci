...
position p;
@@
 struct ad7292_state * cocci_id@p ;
...
typedef u8;
@@
 struct ad7292_state {  struct spi_device * spi ;  struct regulator * reg ;  unsigned short vref_mv ;  __be16 d16 ____cacheline_aligned ;  u8 d8 [ 2 ] ; } cocci_id@p ;
