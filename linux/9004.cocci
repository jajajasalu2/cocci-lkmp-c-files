...
position p;
@@
 struct mlx4_set_port_scheduler_context {  struct mlx4_port_scheduler_tc_cfg_be tc [ MLX4_NUM_TC ] ; } cocci_id@p ;
...
typedef __be32;
@@
 struct mlx4_alloc_vpp_param {  __be32 available_vpp ;  __be32 vpp_p_up [ MLX4_NUM_UP ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct mlx4_set_port_prio2tc_context {  u8 prio2tc [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_set_port_prio2tc_context * cocci_id@p ;
...
position p;
@@
 enum { MLX4_SET_VPORT_QOS_SET = 0x0 , MLX4_SET_VPORT_QOS_QUERY = 0x1 , } cocci_id@p ;
...
position p;
@@
 enum { MLX4_ALLOCATE_VPP_ALLOCATE = 0x0 , MLX4_ALLOCATE_VPP_QUERY = 0x1 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_alloc_vpp_param * cocci_id@p ;
...
position p;
@@
 struct mlx4_port_scheduler_tc_cfg_be * cocci_id@p ;
...
typedef __be32;
@@
 struct mlx4_set_vport_context {  __be32 reserved [ 8 ] ;  struct mlx4_prio_qos_param qos_p_up [ MLX4_NUM_UP ] ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_port_scheduler_tc_cfg_be {  __be16 pg ;  __be16 bw_precentage ;  __be16 max_bw_units ;  __be16 max_bw_value ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_set_vport_context * cocci_id@p ;
...
position p;
@@
 struct mlx4_set_port_scheduler_context * cocci_id@p ;
...
typedef __be32;
@@
 struct mlx4_prio_qos_param {  __be32 bw_share ;  __be32 max_avg_bw ;  __be32 reserved ;  __be32 enable ;  __be32 reserved1 [ 4 ] ; } cocci_id@p ;
