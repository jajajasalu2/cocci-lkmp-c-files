...
position p;
@@
 struct mid_sd_board_info cocci_id@p ;
...
position p;
@@
 struct sfi_rtc_table_entry * cocci_id@p ;
...
position p;
@@
 struct sfi_gpio_table_entry cocci_id@p ;
...
position p;
@@
 struct sfi_device_table_entry * cocci_id@p ;
...
position p;
@@
 struct devs_id * const cocci_id@p [ ] ;
...
position p;
@@
 struct sfi_rtc_table_entry cocci_id@p [ SFI_MRTC_MAX ] ;
...
position p;
@@
 struct sfi_timer_table_entry * cocci_id@p ;
...
position p;
@@
 struct spi_board_info * cocci_id@p [ MAX_SCU_SPI ] ;
...
position p;
@@
 struct sfi_table_simple * cocci_id@p ;
...
position p;
@@
 struct sfi_timer_table_entry cocci_id@p [ SFI_MTMR_MAX_NUM ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ SFI_MTMR_MAX_NUM ] ;
...
position p;
@@
 struct i2c_board_info * cocci_id@p [ MAX_SCU_I2C ] ;
...
position p;
@@
 struct platform_device * cocci_id@p [ MAX_IPCDEVS ] ;
...
position p;
@@
 struct sfi_table_header * cocci_id@p ;
