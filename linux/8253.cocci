...
position p;
@@
 struct lan743x_tx_buffer_info * cocci_id@p ;
...
position p;
@@
 struct lan743x_tx_descriptor cocci_id@p ;
...
position p;
@@
 struct lan743x_intr * cocci_id@p ;
...
position p;
@@
 struct lan743x_rx_descriptor cocci_id@p ;
...
position p;
@@
 struct lan743x_rx_buffer_info * cocci_id@p ;
...
position p;
@@
 struct msix_entry cocci_id@p [ LAN743X_MAX_VECTOR_COUNT ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ DP_SEL_VHF_HASH_LEN ] ;
...
position p;
@@
 struct lan743x_vector * cocci_id@p ;
...
position p;
@@
 lan743x_vector_handler cocci_id@p ;
