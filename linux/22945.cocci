...
position p;
@@
 int cocci_id@p ( struct seq_oss_devinfo * dp , int dev , int ch , int note , int vel , struct snd_seq_event * ev ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_oss_devinfo * dp , int dev , int type , int ch , int note , int vel , struct snd_seq_event * ev ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_oss_devinfo * dp , int dev , int type , int ch , int param , int val , struct snd_seq_event * ev ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_oss_devinfo * dp , union evrec * rec , struct snd_seq_event * ev ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_oss_devinfo * dp , union evrec * event_rec , struct snd_seq_event * ev ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_oss_devinfo * dp , union evrec * q , struct snd_seq_event * ev ) ;
