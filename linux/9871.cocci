...
position p;
@@
 ath_cmn_fft_idx_validator * cocci_id@p ;
...
position p;
@@
 struct ath_ht20_mag_info * cocci_id@p ;
...
position p;
@@
 struct ath_radar_info * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SPECTRAL_SAMPLE_MAX_LEN ] ;
...
typedef u8;
@@
 int cocci_id@p ( u8 * sample_end , int bytes_read ) ;
...
position p;
@@
 struct fft_sample_tlv cocci_id@p ;
...
position p;
@@
 struct fft_sample_ht20_40 cocci_id@p ;
...
typedef u8,u64,u16;
@@
 int cocci_id@p ( struct ath_rx_status * rs , struct ath_spec_scan_priv * spec_priv , u8 * sample_buf , u64 tsf , u16 freq , int chan_type ) ;
...
position p;
@@
 struct fft_sample_ht20 cocci_id@p ;
...
position p;
@@
 ath_cmn_fft_sample_handler * cocci_id@p ;
...
position p;
@@
 struct ath_spec_scan_priv * cocci_id@p ;
...
position p;
@@
 struct ath_ht20_40_mag_info * cocci_id@p ;
