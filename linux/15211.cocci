...
position p;
@@
 struct netxbig_gpio_ext {  unsigned int * addr ;  int num_addr ;  unsigned int * data ;  int num_data ;  unsigned int enable ; } cocci_id@p ;
...
position p;
@@
 enum netxbig_led_mode { NETXBIG_LED_OFF , NETXBIG_LED_ON , NETXBIG_LED_SATA , NETXBIG_LED_TIMER1 , NETXBIG_LED_TIMER2 , NETXBIG_LED_MODE_NUM , } cocci_id@p ;
...
position p;
@@
 struct netxbig_gpio_ext * cocci_id@p ;
...
position p;
@@
 struct netxbig_led_data * cocci_id@p ;
...
position p;
@@
 const struct netxbig_led * cocci_id@p ;
...
position p;
@@
 struct netxbig_led_timer * cocci_id@p ;
...
position p;
@@
 struct netxbig_led_platform_data {  struct netxbig_gpio_ext * gpio_ext ;  struct netxbig_led_timer * timer ;  int num_timer ;  struct netxbig_led * leds ;  int num_leds ; } cocci_id@p ;
...
position p;
@@
 enum netxbig_led_mode * cocci_id@p ;
...
position p;
@@
 struct netxbig_led {  const char * name ;  const char * default_trigger ;  int mode_addr ;  int * mode_val ;  int bright_addr ;  int bright_max ; } cocci_id@p ;
...
position p;
@@
 struct netxbig_led_platform_data * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct netxbig_led_data {  struct netxbig_gpio_ext * gpio_ext ;  struct led_classdev cdev ;  int mode_addr ;  int * mode_val ;  int bright_addr ;  struct netxbig_led_timer * timer ;  int num_timer ;  enum netxbig_led_mode mode ;  int sata ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct netxbig_led_timer {  unsigned long delay_on ;  unsigned long delay_off ;  enum netxbig_led_mode mode ; } cocci_id@p ;
