...
symbol cocci_id;
position p;
typedef phys_addr_t,spinlock_t;
@@
 struct img_hash_dev {  struct list_head list ;  struct device * dev ;  struct clk * hash_clk ;  struct clk * sys_clk ;  void __iomem * io_base ;  phys_addr_t bus_addr ;  void __iomem * cpu_addr ;  spinlock_t lock ;  int err ;  struct tasklet_struct done_task ;  struct tasklet_struct dma_task ;  unsigned long flags ;  struct crypto_queue queue ;  struct ahash_request * req ;  struct dma_chan * dma_lch ; } cocci_id@p ;
...
position p;
@@
 struct img_hash_ctx {  struct img_hash_dev * hdev ;  unsigned long flags ;  struct crypto_ahash * fallback ; } cocci_id@p ;
...
position p;
@@
 struct img_hash_ctx * cocci_id@p ;
...
position p;
@@
 struct img_hash_request_ctx * cocci_id@p ;
...
position p;
@@
 struct img_hash_drv cocci_id@p ;
...
position p;
@@
 struct img_hash_dev * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct img_hash_drv {  struct list_head dev_list ;  spinlock_t lock ; } cocci_id@p ;
