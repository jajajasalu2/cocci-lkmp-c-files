...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_CBQ_MAX + 1 ] ;
...
position p;
@@
 struct cbq_sched_data cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_CBQ_MAX + 1 ] ;
...
position p;
@@
 const struct tc_cbq_wrropt * cocci_id@p ;
...
position p;
@@
 struct tc_cbq_lssopt * cocci_id@p ;
...
position p;
@@
 struct tc_cbq_police cocci_id@p ;
...
symbol cocci_id;
position p;
typedef psched_time_t;
@@
 psched_time_t cocci_id@p ;
...
position p;
@@
 struct tc_cbq_wrropt cocci_id@p ;
...
symbol cocci_id;
position p;
typedef psched_tdiff_t;
@@
 psched_tdiff_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,psched_time_t;
@@
 struct cbq_class {  struct Qdisc_class_common common ;  struct cbq_class * next_alive ;  unsigned char priority ;  unsigned char priority2 ;  unsigned char ewma_log ;  u32 defmap ;  long maxidle ;  long offtime ;  long minidle ;  u32 avpkt ;  struct qdisc_rate_table * R_tab ;  long allot ;  long quantum ;  long weight ;  struct Qdisc * qdisc ;  struct cbq_class * split ;  struct cbq_class * share ;  struct cbq_class * tparent ;  struct cbq_class * borrow ;  struct cbq_class * sibling ;  struct cbq_class * children ;  struct Qdisc * q ;  unsigned char cpriority ;  unsigned char delayed ;  unsigned char level ;  psched_time_t last ;  psched_time_t undertime ;  long avgidle ;  long deficit ;  psched_time_t penalized ;  struct gnet_stats_basic_packed bstats ;  struct gnet_stats_queue qstats ;  struct net_rate_estimator __rcu * rate_est ;  struct tc_cbq_xstats xstats ;  struct tcf_proto __rcu * filter_list ;  struct tcf_block * block ;  int filters ;  struct cbq_class * defaults [ TC_PRIO_MAX + 1 ] ; } cocci_id@p ;
