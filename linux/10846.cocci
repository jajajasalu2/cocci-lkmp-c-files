...
position p;
@@
 struct amdgpu_cgs_device {  struct cgs_device base ;  struct amdgpu_device * adev ; } cocci_id@p ;
...
position p;
@@
 const struct cgs_ops cocci_id@p ;
...
position p;
@@
 struct amdgpu_cgs_device * cocci_id@p ;
