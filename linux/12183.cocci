...
position p;
@@
 struct drm_dp_link_train_set * cocci_id@p ;
...
position p;
@@
 const struct drm_dp_link_train * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ DP_RECEIVER_CAP_SIZE ] ;
...
position p;
@@
 const struct drm_dp_link_caps * cocci_id@p ;
...
position p;
@@
 struct drm_dp_link_caps * cocci_id@p ;
...
position p;
@@
 struct drm_dp_link_train * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ DP_MAX_SUPPORTED_RATES * 2 ] ;
