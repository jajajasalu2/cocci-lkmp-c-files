...
position p;
@@
 struct intel_ntb_dev cocci_id@p ;
...
position p;
@@
 const struct intel_ntb_reg cocci_id@p ;
...
position p;
@@
 struct intel_b2b_addr cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct intel_ntb_dev * ndev ) ;
...
position p;
@@
 const struct intel_ntb_xlat_reg cocci_id@p ;
...
position p;
@@
 struct intel_ntb_vec * cocci_id@p ;
...
position p;
@@
 const struct intel_ntb_alt_reg cocci_id@p ;
...
@@
 union {  u64 v64 ;  u32 v32 ;  u16 v16 ;  u8 v8 ; } cocci_id@p ;
...
position p;
@@
 const struct intel_b2b_addr * cocci_id@p ;
