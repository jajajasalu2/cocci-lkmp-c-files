...
position p;
@@
 struct ds4_calibration_data * cocci_id@p ;
...
position p;
@@
 struct motion_output_report_02 * cocci_id@p ;
...
position p;
@@
 const union sixaxis_output_report_01 cocci_id@p ;
...
position p;
@@
 enum ds4_dongle_state cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sony_sc * ) ;
...
position p;
@@
 enum ds4_dongle_state { DONGLE_DISCONNECTED , DONGLE_CALIBRATING , DONGLE_CONNECTED , DONGLE_DISABLED , } cocci_id@p ;
...
position p;
@@
 union sixaxis_output_report_01 cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sony_sc * sc ) ;
...
position p;
@@
 struct sixaxis_output_report cocci_id@p ;
...
position p;
@@
 enum sony_worker { SONY_WORKER_STATE , SONY_WORKER_HOTPLUG , } cocci_id@p ;
...
position p;
@@
 const struct {  int x ;  int y ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ds4_calibration_data {  int abs_code ;  short bias ;  int sens_numer ;  int sens_denom ; } cocci_id@p ;
...
typedef u8;
@@
 union sixaxis_output_report_01 {  struct sixaxis_output_report data ;  u8 buf [ 36 ] ; } cocci_id@p ;
