...
typedef dma_addr_t;
@@
 struct atmel_runtime_data {  struct atmel_pcm_dma_params * params ;  dma_addr_t dma_buffer ;  dma_addr_t dma_buffer_end ;  size_t period_size ;  dma_addr_t period_ptr ; } cocci_id@p ;
...
position p;
@@
 struct atmel_pcm_dma_params * cocci_id@p ;
...
position p;
@@
 struct atmel_runtime_data cocci_id@p ;
