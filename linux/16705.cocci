...
position p;
@@
 struct lpc32xx_kscan_drv * cocci_id@p ;
...
typedef u8,u32;
@@
 struct lpc32xx_kscan_drv {  struct input_dev * input ;  struct clk * clk ;  void __iomem * kscan_base ;  unsigned int irq ;  u32 matrix_sz ;  u32 deb_clks ;  u32 scan_delay ;  unsigned short * keymap ;  unsigned int row_shift ;  u8 lastkeystates [ 8 ] ; } cocci_id@p ;
