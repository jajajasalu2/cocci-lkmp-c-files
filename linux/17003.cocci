...
typedef u8,u16;
@@
 struct ser_req {  u8 ref_on ;  u8 command ;  u8 ref_off ;  u16 scratch ;  struct spi_message msg ;  struct spi_transfer xfer [ 6 ] ;  __be16 sample ____cacheline_aligned ; } cocci_id@p ;
...
typedef u8;
@@
 struct ads7845_ser_req {  u8 command [ 3 ] ;  struct spi_message msg ;  struct spi_transfer xfer [ 2 ] ;  u8 sample [ 3 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ads7845_ser_req * cocci_id@p ;
...
position p;
@@
 struct ads7846_packet * cocci_id@p ;
