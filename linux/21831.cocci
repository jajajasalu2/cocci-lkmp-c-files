...
typedef uint32_t;
@@
 struct xz_dec_hash {  vli_type unpadded ;  vli_type uncompressed ;  uint32_t crc32 ; } cocci_id@p ;
...
position p;
@@
 const struct xz_buf * cocci_id@p ;
