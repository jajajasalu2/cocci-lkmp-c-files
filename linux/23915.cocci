...
position p;
@@
 struct raw_frag_vec cocci_id@p ;
...
position p;
@@
 struct raw_frag_vec {  struct msghdr * msg ;  union {  struct icmphdr icmph ;  char c [ 1 ] ; } hdr ;  int hlen ; } cocci_id@p ;
