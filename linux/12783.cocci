...
position p;
@@
 enum hv_message_type cocci_id@p ;
...
position p;
@@
 union hv_synic_scontrol cocci_id@p ;
...
position p;
@@
 union hv_synic_siefp cocci_id@p ;
...
position p;
@@
 union hv_connection_id cocci_id@p ;
...
position p;
@@
 union hv_synic_sint cocci_id@p ;
...
position p;
@@
 struct hv_input_post_message * cocci_id@p ;
...
position p;
@@
 union hv_synic_simp cocci_id@p ;
