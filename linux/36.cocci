...
position p;
@@
 const struct addr_range * cocci_id@p ;
...
position p;
@@
 const struct sym_entry * cocci_id@p ;
...
position p;
@@
 struct sym_entry {  unsigned long long addr ;  unsigned int len ;  unsigned int start_pos ;  unsigned char * sym ;  unsigned int percpu_absolute ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ 256 ] [ 2 ] ;
