...
position p;
@@
 enum cdc_mbim_flags { FLAG_IPS0_VLAN = 1 << 0 , } cocci_id@p ;
...
position p;
@@
 struct cdc_mbim_state * cocci_id@p ;
...
typedef atomic_t;
@@
 struct cdc_mbim_state {  struct cdc_ncm_ctx * ctx ;  atomic_t pmcount ;  struct usb_driver * subdriver ;  unsigned long _unused ;  unsigned long flags ; } cocci_id@p ;
