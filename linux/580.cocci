...
typedef __be64;
@@
 union {  unsigned char req [ 8 ] ;  __be64 req_int ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drbg_state * drbg , unsigned char * outval , const struct list_head * in ) ;
...
position p;
@@
 void cocci_id@p ( struct drbg_state * drbg , const unsigned char * key ) ;
...
position p;
@@
 unsigned char cocci_id@p [ ( ( 32 + 16 ) * 2 ) ] ;
...
position p;
@@
 const struct drbg_state_ops cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drbg_state * drbg , unsigned char * outval , const struct drbg_string * in ) ;
...
position p;
@@
 const struct drbg_string * cocci_id@p ;
...
position p;
@@
 struct sdesc {  struct shash_desc shash ;  char ctx [ ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drbg_state * drbg ) ;
...
typedef __be32;
@@
 struct s {  __be32 conv ; } cocci_id@p ;
...
typedef u8,u32;
@@
 int cocci_id@p ( struct drbg_state * drbg , u8 * inbuf , u32 inbuflen , u8 * outbuf , u32 outlen ) ;
...
position p;
@@
 unsigned char cocci_id@p [ OUTBUFLEN ] ;
...
position p;
@@
 const struct drbg_core * cocci_id@p ;
