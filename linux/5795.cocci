...
typedef u32;
@@
 struct pit_data {  struct clock_event_device clkevt ;  struct clocksource clksrc ;  void __iomem * base ;  u32 cycle ;  u32 cnt ;  unsigned int irq ;  struct clk * mck ; } cocci_id@p ;
