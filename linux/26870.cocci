...
position p;
@@
 int cocci_id@p ( struct inode * inode , int type ) ;
...
typedef qsize_t;
@@
 qsize_t cocci_id@p ( struct inode * inode ) ;
...
position p;
@@
 struct quota_format_type * * cocci_id@p ;
...
position p;
@@
 struct qc_type_state * cocci_id@p ;
...
position p;
@@
 struct dquot_warn {  struct super_block * w_sb ;  struct kqid w_dq_id ;  short w_type ; } cocci_id@p ;
...
position p;
@@
 struct quota_module_name cocci_id@p [ ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct dquot * dquot , unsigned long priv ) ;
...
position p;
@@
 struct dquot_warn cocci_id@p [ MAXQUOTAS ] ;
...
position p;
@@
 struct dquot * cocci_id@p [ MAXQUOTAS ] ;
