...
position p;
@@
 int ( * cocci_id@p ) ( struct file_lock * fl , int result ) ;
...
position p;
@@
 struct dlm_plock_info cocci_id@p ;
...
position p;
@@
 struct plock_xop {  struct plock_op xop ;  int ( * callback ) ( struct file_lock * fl , int result ) ;  void * fl ;  void * file ;  struct file_lock flc ; } cocci_id@p ;
...
position p;
@@
 struct plock_op {  struct list_head list ;  int done ;  struct dlm_plock_info info ; } cocci_id@p ;
