...
position p;
@@
 struct dvb_diseqc_slave_reply * cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_modcode cocci_id@p ;
...
position p;
@@
 struct stv0900_signal_info cocci_id@p ;
...
position p;
@@
 const struct stv0900_short_frames_car_loop_optim * cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_error cocci_id@p ;
...
position p;
@@
 struct stv0900_search_params cocci_id@p ;
...
position p;
@@
 struct stv0900_internal * cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_clock_type cocci_id@p ;
...
position p;
@@
 struct stv0900_inode cocci_id@p ;
...
position p;
@@
 struct stv0900_state * cocci_id@p ;
...
position p;
@@
 struct stv0900_inode {  struct stv0900_internal * internal ;  struct stv0900_inode * next_inode ; } cocci_id@p ;
...
position p;
@@
 struct stv0900_init_params cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_modulation cocci_id@p ;
...
position p;
@@
 const struct stv0900_car_loop_optim * cocci_id@p ;
...
position p;
@@
 const struct stv0900_short_frames_car_loop_optim_vs_mod * cocci_id@p ;
...
position p;
@@
 const struct stv0900_table * cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_demod_num cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_demod_mode cocci_id@p ;
...
position p;
@@
 enum fe_stv0900_search_state cocci_id@p ;
