...
position p;
@@
 struct ext4_free_data cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ NR_GRPINFO_CACHES ] ;
...
symbol cocci_id;
position p;
typedef ext4_grpblk_t;
@@
 ext4_grpblk_t cocci_id@p ;
...
typedef ext4_grpblk_t;
@@
 struct sg {  struct ext4_group_info info ;  ext4_grpblk_t counters [ EXT4_MAX_BLOCK_LOG_SIZE + 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct ext4_prealloc_space * cocci_id@p ;
...
position p;
@@
 struct ext4_allocation_context * cocci_id@p ;
...
position p;
@@
 struct ext4_allocation_request * cocci_id@p ;
...
position p;
@@
 ext4_mballoc_query_range_fn cocci_id@p ;
...
position p;
@@
 struct ext4_locality_group * cocci_id@p ;
...
position p;
@@
 struct ext4_free_extent cocci_id@p ;
...
position p;
@@
 struct kmem_cache * cocci_id@p [ NR_GRPINFO_CACHES ] ;
