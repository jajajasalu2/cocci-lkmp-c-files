...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( struct uart_port * port ) ;
...
position p;
@@
 struct clk * cocci_id@p [ MPC52xx_PSC_MAXNUM ] ;
...
position p;
@@
 const struct psc_ops cocci_id@p ;
...
typedef u32;
@@
 struct psc_fifoc {  u32 fifoc_cmd ;  u32 fifoc_int ;  u32 fifoc_dma ;  u32 fifoc_axe ;  u32 fifoc_debug ; } cocci_id@p ;
...
position p;
@@
 struct device_node * cocci_id@p [ MPC52xx_PSC_MAXNUM ] ;
...
position p;
@@
 struct uart_port cocci_id@p [ MPC52xx_PSC_MAXNUM ] ;
