...
position p;
@@
 struct gasket_sysfs_mapping {  struct device * device ;  struct gasket_dev * gasket_dev ;  struct gasket_sysfs_attribute * attributes ;  int attribute_count ;  struct mutex mutex ;  struct kref refcount ; } cocci_id@p ;
...
position p;
@@
 struct gasket_sysfs_mapping * cocci_id@p ;
...
position p;
@@
 struct gasket_sysfs_mapping cocci_id@p [ GASKET_SYSFS_NUM_MAPPINGS ] ;
