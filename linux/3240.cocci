...
position p;
@@
 void ( * cocci_id@p ) ( struct lm93_data * , struct i2c_client * ) ;
...
typedef u8;
@@
 const struct {  u8 cmd ;  u8 len ; } cocci_id@p [ 12 ] ;
...
position p;
@@
 enum pwm_freq { LM93_PWM_MAP_HI_FREQ , LM93_PWM_MAP_LO_FREQ , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ I2C_SMBUS_BLOCK_MAX ] ;
...
position p;
@@
 const unsigned long cocci_id@p [ 16 ] ;
...
symbol cocci_id;
position p;
typedef u8,u16,block1_t;
@@
 struct lm93_data {  struct i2c_client * client ;  struct mutex update_lock ;  unsigned long last_updated ;  void ( * update ) ( struct lm93_data * , struct i2c_client * ) ;  char valid ;  struct block1_t block1 ;  u8 block2 [ 6 ] ;  u8 block3 [ 16 ] ;  struct {  u8 cur ;  u8 avg ; } block4 [ 2 ] ;  u16 block5 [ 4 ] ;  struct {  u8 min ;  u8 max ; } temp_lim [ 4 ] ;  struct {  u8 min ;  u8 max ; } block7 [ 16 ] ;  u16 block8 [ 4 ] ;  u8 block9 [ 2 ] [ 4 ] ;  struct {  u8 base [ 4 ] ;  u8 offset [ 12 ] ; } block10 ;  u8 config ;  u8 vid [ 2 ] ;  u8 prochot_max [ 2 ] ;  u8 vccp_limits [ 2 ] ;  u8 gpi ;  u8 prochot_override ;  u8 prochot_interval ;  u8 boost [ 4 ] ;  u8 boost_hyst [ 2 ] ;  u8 auto_pwm_min_hyst [ 2 ] ;  u8 pwm_ramp_ctl ;  u8 sfc1 ;  u8 sfc2 ;  u8 sf_tach_to_pwm ;  u8 pwm_override [ 2 ] ; } cocci_id@p ;
...
typedef u8,block1_t;
@@
 struct block1_t {  u8 host_status_1 ;  u8 host_status_2 ;  u8 host_status_3 ;  u8 host_status_4 ;  u8 p1_prochot_status ;  u8 p2_prochot_status ;  u8 gpi_status ;  u8 fan_status ; } cocci_id@p ;
