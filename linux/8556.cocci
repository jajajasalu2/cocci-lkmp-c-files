...
position p;
@@
 struct hwrm_cfa_encap_record_alloc_input cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_l2_node cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_decap_filter_alloc_output * cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_flow_stats * cocci_id@p ;
...
position p;
@@
 struct bnxt_flower_indr_block_cb_priv * cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_decap_filter_alloc_input cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_actions * cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_tunnel_node cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_flow_node cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_l2_key cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_flow_alloc_input cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_encap_record_free_input cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_l3_key * cocci_id@p ;
...
position p;
@@
 struct flow_match_icmp cocci_id@p ;
...
position p;
@@
 struct hwrm_vxlan_ipv4_hdr * cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_flow_stats_input cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_flow * cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_info * cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_encap_data_vxlan * cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_encap_record_alloc_output * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( void * mask , int len ) ;
...
position p;
@@
 struct hwrm_cfa_flow_stats_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_decap_filter_free_input cocci_id@p ;
...
position p;
@@
 struct bnxt_tc_stats_batch cocci_id@p [ ] ;
...
position p;
@@
 struct vlan_dev_priv * cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_flow_alloc_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_cfa_flow_free_input cocci_id@p ;
