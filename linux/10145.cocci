...
position p;
@@
 struct intc_virq_list {  unsigned int irq ;  struct intc_virq_list * next ; } cocci_id@p ;
...
position p;
@@
 struct intc_virq_list * * cocci_id@p ;
...
position p;
@@
 struct intc_subgroup_entry * cocci_id@p ;
...
position p;
@@
 struct intc_subgroup * cocci_id@p ;
...
position p;
@@
 struct intc_map_entry * cocci_id@p ;
...
position p;
@@
 struct intc_desc_int * cocci_id@p ;
...
position p;
@@
 struct intc_map_entry cocci_id@p [ INTC_NR_IRQS ] ;
...
position p;
@@
 struct intc_subgroup_entry * cocci_id@p [ 32 ] ;
