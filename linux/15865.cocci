...
typedef u8;
@@
 u8 cocci_id@p [ H2C_REMOTE_WAKE_CTRL_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_AOAC_GLOBAL_INFO_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_PSTUNEPARAM_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_DISCON_DECISION_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_MEDIA_STATUS_RPT_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_AOAC_RSVDPAGE_LOC_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_RSVDPAGE_LOC_LEN ] ;
...
position p;
@@
 struct hal_com_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_KEEP_ALIVE_CTRL_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_RSSI_SETTING_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_SCAN_OFFLOAD_CTRL_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_MACID_CFG_LEN ] ;
