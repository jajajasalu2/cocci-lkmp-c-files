...
position p;
@@
 struct nat_entry_set * cocci_id@p ;
...
position p;
@@
 struct f2fs_nat_entry * cocci_id@p ;
...
position p;
@@
 struct f2fs_nm_info cocci_id@p ;
...
position p;
@@
 struct fsync_node_entry cocci_id@p ;
...
position p;
@@
 struct f2fs_journal * cocci_id@p ;
...
position p;
@@
 struct f2fs_summary_block * cocci_id@p ;
...
position p;
@@
 struct nat_entry * cocci_id@p [ NATVEC_SIZE ] ;
...
position p;
@@
 struct nat_entry_set * cocci_id@p [ SETVEC_SIZE ] ;
...
position p;
@@
 struct f2fs_nat_block * cocci_id@p ;
