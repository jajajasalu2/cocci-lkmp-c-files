...
position p;
@@
 struct intelfb_hwstate * cocci_id@p ;
...
position p;
@@
 struct intelfb_info cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct intelfb_info * dinfo ) ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * info , const struct fb_fillrect * rect ) ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * info , const struct fb_image * image ) ;
...
position p;
@@
 void cocci_id@p ( struct intelfb_info * dinfo ) ;
...
position p;
@@
 struct agp_bridge_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fb_info * info , struct fb_cursor * cursor ) ;
...
position p;
@@
 int cocci_id@p ( unsigned regno , unsigned red , unsigned green , unsigned blue , unsigned transp , struct fb_info * info ) ;
...
position p;
@@
 struct agp_kern_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fb_info * info , const struct fb_copyarea * region ) ;
...
position p;
@@
 void cocci_id@p ( struct intelfb_info * dinfo , struct fb_var_screeninfo * var ) ;
