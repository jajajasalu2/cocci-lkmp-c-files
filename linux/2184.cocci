...
position p;
@@
 struct charger_desc * cocci_id@p ;
...
position p;
@@
 struct charger_manager cocci_id@p ;
...
position p;
@@
 enum cm_event_types cocci_id@p ;
...
position p;
@@
 struct charger_cable * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ UEVENT_BUF_SIZE + 1 ] ;
