...
position p;
@@
 void cocci_id@p ( struct sis5595_data * data ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct sis5595_data * data , u8 reg ) ;
...
position p;
@@
 struct sis5595_data * cocci_id@p ;
...
typedef s8,u8,u16;
@@
 struct sis5595_data {  unsigned short addr ;  const char * name ;  struct device * hwmon_dev ;  struct mutex lock ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  char maxins ;  u8 revision ;  u8 in [ 5 ] ;  u8 in_max [ 5 ] ;  u8 in_min [ 5 ] ;  u8 fan [ 2 ] ;  u8 fan_min [ 2 ] ;  s8 temp ;  s8 temp_over ;  s8 temp_hyst ;  u8 fan_div [ 2 ] ;  u16 alarms ; } cocci_id@p ;
...
position p;
@@
 struct sis5595_data * cocci_id@p ( struct device * dev ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct sis5595_data * data , u8 reg , u8 value ) ;
