...
typedef u8,bool;
@@
 struct ucan_urb_context {  struct ucan_priv * up ;  u8 dlc ;  bool allocated ; } cocci_id@p ;
...
position p;
@@
 struct ucan_message_out * cocci_id@p ;
...
position p;
@@
 struct ucan_urb_context * cocci_id@p ;
...
position p;
@@
 enum { UCAN_IN_TX_COMPLETE = 1 , UCAN_IN_RX = 2 , } cocci_id@p ;
...
position p;
@@
 struct ucan_ctl_cmd_set_bittiming * cocci_id@p ;
...
position p;
@@
 struct can_bittiming_const * cocci_id@p ;
...
position p;
@@
 struct usb_device_id cocci_id@p [ ] ;
...
@@
 struct ucan_priv {  struct can_priv can ;  struct usb_device * udev ;  struct usb_interface * intf ;  struct net_device * netdev ;  spinlock_t echo_skb_lock ;  u8 intf_index ;  u8 in_ep_addr ;  u8 out_ep_addr ;  u16 in_ep_size ;  struct usb_anchor rx_urbs ;  struct usb_anchor tx_urbs ;  union ucan_ctl_payload * ctl_msg_buffer ;  struct ucan_device_info device_info ;  spinlock_t context_lock ;  unsigned int available_tx_urbs ;  struct ucan_urb_context * context_array ; } cocci_id@p ;
...
position p;
@@
 struct ucan_can_msg * cocci_id@p ;
...
typedef u8;
@@
 struct ucan_device_info {  struct can_bittiming_const bittiming_const ;  u8 tx_fifo ; } cocci_id@p ;
...
position p;
@@
 enum { UCAN_COMMAND_GET_INFO = 0 , UCAN_COMMAND_GET_PROTOCOL_VERSION = 1 , } cocci_id@p ;
...
position p;
@@
 enum { UCAN_DEVICE_GET_FW_STRING = 0 , } cocci_id@p ;
...
position p;
@@
 enum { UCAN_MODE_LOOPBACK = BIT ( 0 ) , UCAN_MODE_SILENT = BIT ( 1 ) , UCAN_MODE_3_SAMPLES = BIT ( 2 ) , UCAN_MODE_ONE_SHOT = BIT ( 3 ) , UCAN_MODE_BERR_REPORT = BIT ( 4 ) , } cocci_id@p ;
...
position p;
@@
 union ucan_ctl_payload cocci_id@p ;
...
position p;
@@
 struct can_device_stats * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( union ucan_ctl_payload ) + 1 ] ;
...
position p;
@@
 struct urb * cocci_id@p [ UCAN_MAX_RX_URBS ] ;
...
position p;
@@
 struct ucan_message_in cocci_id@p ;
...
position p;
@@
 enum { UCAN_FILTER_CLEAR = 0 , UCAN_FILTER_DISABLE = 1 , UCAN_FILTER_ENABLE = 2 , } cocci_id@p ;
...
position p;
@@
 enum { UCAN_COMMAND_START = 0 , UCAN_COMMAND_STOP = 1 , UCAN_COMMAND_SLEEP = 2 , UCAN_COMMAND_WAKEUP = 3 , UCAN_COMMAND_RESET = 4 , UCAN_COMMAND_GET = 5 , UCAN_COMMAND_FILTER = 6 , UCAN_COMMAND_SET_BITTIMING = 7 , UCAN_COMMAND_RESTART = 8 , } cocci_id@p ;
...
position p;
@@
 enum { UCAN_TX_COMPLETE_SUCCESS = BIT ( 0 ) , } cocci_id@p ;
...
position p;
@@
 struct ucan_ctl_cmd_device_info * cocci_id@p ;
