...
position p;
@@
 struct tls_descs {  struct desc_struct desc [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct physdev_set_iopl cocci_id@p ;
...
position p;
@@
 const struct pv_info cocci_id@p ;
...
position p;
@@
 struct xen_platform_op cocci_id@p ;
...
position p;
@@
 const struct desc_ptr * cocci_id@p ;
...
position p;
@@
 struct trap_array_entry * cocci_id@p ;
...
position p;
@@
 const struct dom0_vga_console_info * cocci_id@p ;
...
position p;
@@
 const struct pv_cpu_ops cocci_id@p ;
...
position p;
@@
 const struct machine_ops cocci_id@p ;
...
position p;
@@
 struct trap_info cocci_id@p [ 257 ] ;
...
position p;
@@
 struct xen_extraversion cocci_id@p ;
...
typedef bool;
@@
 struct trap_array_entry {  void ( * orig ) ( void ) ;  void ( * xen ) ( void ) ;  bool ist_okay ; } cocci_id@p ;
