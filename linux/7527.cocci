...
position p;
@@
 struct ssd1307fb_array cocci_id@p ;
...
typedef u8;
@@
 struct ssd1307fb_array {  u8 type ;  u8 data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct ssd1307fb_par cocci_id@p ;
...
typedef u8,u32;
@@
 struct ssd1307fb_par {  unsigned area_color_enable : 1 ;  unsigned com_invdir : 1 ;  unsigned com_lrremap : 1 ;  unsigned com_seq : 1 ;  unsigned lookup_table_set : 1 ;  unsigned low_power : 1 ;  unsigned seg_remap : 1 ;  u32 com_offset ;  u32 contrast ;  u32 dclk_div ;  u32 dclk_frq ;  const struct ssd1307fb_deviceinfo * device_info ;  struct i2c_client * client ;  u32 height ;  struct fb_info * info ;  u8 lookup_table [ 4 ] ;  u32 page_offset ;  u32 prechargep1 ;  u32 prechargep2 ;  struct pwm_device * pwm ;  u32 pwm_period ;  struct gpio_desc * reset ;  struct regulator * vbat_reg ;  u32 vcomh ;  u32 width ; } cocci_id@p ;
...
typedef u32;
@@
 struct ssd1307fb_deviceinfo {  u32 default_vcomh ;  u32 default_dclk_div ;  u32 default_dclk_frq ;  int need_pwm ;  int need_chargepump ; } cocci_id@p ;
...
position p;
@@
 struct ssd1307fb_deviceinfo cocci_id@p ;
