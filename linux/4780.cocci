...
position p;
@@
 struct srp_login_rsp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct se_cmd * se_cmd ) ;
...
position p;
@@
 struct srpt_rdma_ch * cocci_id@p ;
...
position p;
@@
 struct srpt_device * constcocci_id ;
...
position p;
@@
 int cocci_id@p ( struct se_cmd * cmd ) ;
...
position p;
@@
 const struct srp_login_req_rdma * cocci_id@p ;
...
position p;
@@
 struct ib_dm_svc_entries * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct srpt_rdma_ch * ch ) ;
...
position p;
@@
 struct srpt_send_ioctx * cocci_id@p ;
...
position p;
@@
 union {  struct rdma_conn_param rdma_cm ;  struct ib_cm_rep_param ib_cm ; } * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ib_event * , void * ) ;
...
position p;
@@
 struct srpt_recv_ioctx * cocci_id@p ;
...
position p;
@@
 enum srpt_command_state cocci_id@p ;
...
position p;
@@
 struct ib_dm_ioc_profile * cocci_id@p ;
...
position p;
@@
 struct ib_dm_iou_info * cocci_id@p ;
...
position p;
@@
 const struct srp_login_req * cocci_id@p ;
...
position p;
@@
 struct srpt_port_id * cocci_id@p ;
