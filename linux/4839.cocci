...
position p;
@@
 struct ib_mad_local_private cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ib_mad_agent_private * mad_agent_priv ) ;
...
position p;
@@
 int cocci_id@p ( struct ib_mad_reg_req * mad_reg_req , struct ib_mad_agent_private * agent_priv ) ;
...
position p;
@@
 struct ib_mad_qp_info * cocci_id@p ;
...
position p;
@@
 struct ib_mad_send_wr_private cocci_id@p ;
...
position p;
@@
 struct ib_mad_queue * cocci_id@p ;
...
position p;
@@
 struct ib_rmpp_segment cocci_id@p ;
...
position p;
@@
 struct ib_mad_mgmt_vendor_class_table * * cocci_id@p ;
...
position p;
@@
 struct ib_mad_agent_private * cocci_id@p ( struct ib_mad_port_private * port_priv , const struct ib_mad_hdr * mad ) ;
...
position p;
@@
 const struct ib_vendor_mad * cocci_id@p ;
...
position p;
@@
 struct ib_mad_private_header * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ib_mad_qp_info * qp_info , struct ib_mad_private * mad ) ;
...
position p;
@@
 struct ib_mad_snoop_private cocci_id@p ;
...
position p;
@@
 ib_mad_send_handler cocci_id@p ;
...
position p;
@@
 struct ib_mad_private * cocci_id@p ;
...
position p;
@@
 struct ib_mad_recv_buf * cocci_id@p ;
...
position p;
@@
 struct ib_mad_list_head cocci_id@p ;
...
position p;
@@
 const struct ib_mad_send_wr_private * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct ib_mad_reg_req * mad_reg_req , struct ib_mad_agent_private * agent_priv , u8 mgmt_class ) ;
...
position p;
@@
 const struct ib_mad_recv_wc * cocci_id@p ;
...
position p;
@@
 const struct ib_mad_port_private * cocci_id@p ;
...
position p;
@@
 ib_mad_snoop_handler cocci_id@p ;
...
position p;
@@
 struct ib_mad_mgmt_vendor_class * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof "ib_mad123" ] ;
...
position p;
@@
 struct ib_mad_port_private * cocci_id@p ;
...
position p;
@@
 struct ib_mad_mgmt_method_table * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ib_mad_mgmt_method_table * * method , struct ib_mad_reg_req * mad_reg_req ) ;
...
position p;
@@
 const struct ib_mad_agent_private * cocci_id@p ;
...
position p;
@@
 struct ib_mad_agent_private * cocci_id@p ;
...
position p;
@@
 const struct ib_mad_private * cocci_id@p ;
...
position p;
@@
 struct trace_event_raw_ib_mad_send_template * cocci_id@p ;
...
position p;
@@
 enum smi_forward_action cocci_id@p ;
...
position p;
@@
 const struct ib_mad_hdr * cocci_id@p ;
...
position p;
@@
 struct ib_mad_mgmt_class_table * * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ib_mad_agent_private * priv ) ;
...
position p;
@@
 const struct ib_mad_agent * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct ib_mad_port_private * port_priv , struct ib_wc * wc ) ;
...
position p;
@@
 ib_mad_recv_handler cocci_id@p ;
...
position p;
@@
 const struct ib_mad_qp_info * cocci_id@p ;
