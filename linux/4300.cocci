...
typedef u8,u64;
@@
 union hwmi_arg {  u64 cmd ;  u8 args [ 8 ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct quirk_entry {  bool battery_reset ;  bool ec_micmute ;  bool report_brightness ; } cocci_id@p ;
...
typedef bool;
@@
 struct huawei_wmi {  bool battery_available ;  bool fn_lock_available ;  struct huawei_wmi_debug debug ;  struct input_dev * idev [ 2 ] ;  struct led_classdev cdev ;  struct device * dev ;  struct mutex wmi_lock ; } cocci_id@p ;
...
typedef u64;
@@
 struct huawei_wmi_debug {  struct dentry * root ;  u64 arg ; } cocci_id@p ;
...
position p;
@@
 enum { BATTERY_THRESH_GET = 0x00001103 , BATTERY_THRESH_SET = 0x00001003 , FN_LOCK_GET = 0x00000604 , FN_LOCK_SET = 0x00000704 , MICMUTE_LED_SET = 0x00000b04 , } cocci_id@p ;
