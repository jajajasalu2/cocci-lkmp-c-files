...
position p;
@@
 enum ch_command { HIDMA_CH_DISABLE = 0 , HIDMA_CH_ENABLE = 1 , HIDMA_CH_SUSPEND = 2 , HIDMA_CH_RESET = 9 , } cocci_id@p ;
...
position p;
@@
 enum ch_state { HIDMA_CH_DISABLED = 0 , HIDMA_CH_ENABLED = 1 , HIDMA_CH_RUNNING = 2 , HIDMA_CH_SUSPENDED = 3 , HIDMA_CH_STOPPED = 4 , } cocci_id@p ;
...
position p;
@@
 enum err_code { HIDMA_EVRE_STATUS_COMPLETE = 1 , HIDMA_EVRE_STATUS_ERROR = 4 , } cocci_id@p ;
