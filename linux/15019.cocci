...
position p;
@@
 struct owl_clk_common * cocci_id@p ;
...
position p;
@@
 const struct clk_factor_table * cocci_id@p ;
...
position p;
@@
 struct owl_factor_hw * cocci_id@p ;
...
position p;
@@
 const struct owl_clk_common * cocci_id@p ;
...
position p;
@@
 const struct owl_factor_hw * cocci_id@p ;
