...
position p;
@@
 const struct mtk_pll_div_table * cocci_id@p ;
...
position p;
@@
 const struct mtk_pll_data * cocci_id@p ;
...
position p;
@@
 struct mtk_clk_pll {  struct clk_hw hw ;  void __iomem * base_addr ;  void __iomem * pd_addr ;  void __iomem * pwr_addr ;  void __iomem * tuner_addr ;  void __iomem * tuner_en_addr ;  void __iomem * pcw_addr ;  void __iomem * pcw_chg_addr ;  const struct mtk_pll_data * data ; } cocci_id@p ;
