...
position p;
@@
 struct cxusb_medion_vbuffer cocci_id@p ;
...
position p;
@@
 struct cxusb_medion_auxbuf * cocci_id@p ;
...
position p;
@@
 struct cxusb_bt656_params * cocci_id@p ;
...
typedef u32;
@@
 const struct {  struct v4l2_input input ;  u32 inputcfg ; } cocci_id@p [ ] ;
