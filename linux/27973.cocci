...
position p;
@@
 enum generic_types { GT_DIR , GT_PIPE , GT_SOCK , } cocci_id@p ;
...
typedef mode_t;
@@
 struct generic_type {  const char * type ;  mode_t mode ; } cocci_id@p ;
...
position p;
@@
 struct generic_type cocci_id@p [ ] ;
...
position p;
@@
 struct file_handler cocci_id@p [ ] ;
...
position p;
@@
 struct file_handler {  const char * type ;  int ( * handler ) ( const char * line ) ; } cocci_id@p ;
