...
symbol cocci_id;
position p;
typedef rproc_handle_resource_t;
@@
 rproc_handle_resource_t cocci_id@p ;
...
position p;
@@
 struct fw_rsc_vdev_vring cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct rproc * rproc , struct rproc_dump_segment * segment , void * dest ) ;
...
position p;
@@
 struct fw_rsc_carveout * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rproc * rproc , void * , int offset , int avail ) ;
...
typedef rproc_handle_resource_t;
@@
 rproc_handle_resource_t cocci_id@p [ RSC_LAST ] ;
...
position p;
@@
 enum rproc_crash_type cocci_id@p ;
...
position p;
@@
 struct fw_rsc_devmem * cocci_id@p ;
...
position p;
@@
 struct fw_rsc_trace * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct rproc * rproc , struct rproc_mem_entry * mem ) ;
...
position p;
@@
 struct resource_table * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rproc * , struct rproc_mem_entry * ) ;
