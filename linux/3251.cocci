...
position p;
@@
 struct ltc4215_data * cocci_id@p ;
...
position p;
@@
 enum ltc4215_cmd { LTC4215_CONTROL = 0x00 , LTC4215_ALERT = 0x01 , LTC4215_STATUS = 0x02 , LTC4215_FAULT = 0x03 , LTC4215_SENSE = 0x04 , LTC4215_SOURCE = 0x05 , LTC4215_ADIN = 0x06 , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct ltc4215_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  u8 regs [ 7 ] ; } cocci_id@p ;
