...
position p;
@@
 const struct wf_control_ops cocci_id@p ;
...
position p;
@@
 struct wf_fcu_priv {  struct kref ref ;  struct i2c_client * i2c ;  struct mutex lock ;  struct list_head fan_list ;  int rpm_shift ; } cocci_id@p ;
...
position p;
@@
 const struct {  const char * dt_name ;  const char * ct_name ; } cocci_id@p [ ] ;
