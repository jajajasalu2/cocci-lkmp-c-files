...
position p;
@@
 const struct nf_mttg_trav * cocci_id@p ;
...
position p;
@@
 struct compat_delta {  unsigned int offset ;  int delta ; } cocci_id@p ;
...
position p;
@@
 struct compat_delta cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ XT_FUNCTION_MAXNAMELEN ] ;
...
position p;
@@
 struct nf_mttg_trav * cocci_id@p ;
...
position p;
@@
 const struct compat_xt_standard_target * cocci_id@p ;
...
position p;
@@
 struct compat_xt_entry_match * cocci_id@p ;
...
position p;
@@
 enum { MTTG_TRAV_INIT , MTTG_TRAV_NFP_UNSPEC , MTTG_TRAV_NFP_SPEC , MTTG_TRAV_DONE , } cocci_id@p ;
...
position p;
@@
 const struct xt_error_target * cocci_id@p ;
...
position p;
@@
 const struct compat_xt_error_target * cocci_id@p ;
...
@@
 struct compat_xt_standard_target {  struct compat_xt_entry_target t ;  compat_uint_t verdict ; } cocci_id@p ;
...
position p;
@@
 struct compat_xt_error_target {  struct compat_xt_entry_target t ;  char errorname [ XT_FUNCTION_MAXNAMELEN ] ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( m -> u . user . name ) ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( t -> u . user . name ) ] ;
...
position p;
@@
 struct compat_xt_counters_info cocci_id@p ;
...
position p;
@@
 const struct compat_xt_entry_target * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ NFPROTO_NUMPROTO ] ;
