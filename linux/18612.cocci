...
position p;
@@
 unsigned long cocci_id@p [ OMAP_PRCM_MAX_NR_PENDING_REG ] ;
...
position p;
@@
 struct omap_prcm_init_data * cocci_id@p ;
...
position p;
@@
 struct omap_domain_base cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ OMAP_PRCM_MAX_NR_PENDING_REG ] ;
