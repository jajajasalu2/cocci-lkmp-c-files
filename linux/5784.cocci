...
position p;
@@
 struct sh_tmu_channel * cocci_id@p ;
...
position p;
@@
 struct sh_tmu_device * cocci_id@p ;
...
@@
 struct sh_tmu_device {  struct platform_device * pdev ;  void __iomem * mapbase ;  struct clk * clk ;  unsigned long rate ;  enum sh_tmu_model model ;  raw_spinlock_t lock ;  struct sh_tmu_channel * channels ;  unsigned int num_channels ;  bool has_clockevent ;  bool has_clocksource ; } cocci_id@p ;
...
typedef bool;
@@
 struct sh_tmu_channel {  struct sh_tmu_device * tmu ;  unsigned int index ;  void __iomem * base ;  int irq ;  unsigned long periodic ;  struct clock_event_device ced ;  struct clocksource cs ;  bool cs_enabled ;  unsigned int enable_count ; } cocci_id@p ;
...
position p;
@@
 enum sh_tmu_model { SH_TMU , SH_TMU_SH3 , } cocci_id@p ;
