...
position p;
@@
 struct bnx2x_eth_stats_old * cocci_id@p ;
...
position p;
@@
 struct host_func_stats * cocci_id@p ;
...
position p;
@@
 const struct {  void ( * action ) ( struct bnx2x * bp ) ;  enum bnx2x_stats_state next_state ; } cocci_id@p [ STATS_STATE_MAX ] [ STATS_EVENT_MAX ] ;
...
position p;
@@
 struct ustorm_per_queue_stats * cocci_id@p ;
...
position p;
@@
 enum bnx2x_stats_state cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 lo ;  u32 hi ; } cocci_id@p ;
...
position p;
@@
 struct bnx2x_fw_port_stats_old * cocci_id@p ;
...
position p;
@@
 struct bnx2x_eth_q_stats_old * cocci_id@p ;
...
position p;
@@
 struct tstorm_per_port_stats * cocci_id@p ;
...
position p;
@@
 struct tstorm_per_pf_stats * cocci_id@p ;
...
position p;
@@
 struct bnx2x_eth_stats * cocci_id@p ;
...
position p;
@@
 enum bnx2x_stats_event cocci_id@p ;
