...
position p;
@@
 struct brcm_pm_s3_context * cocci_id@p ;
...
position p;
@@
 struct brcmstb_pm_control {  void __iomem * aon_ctrl_base ;  void __iomem * aon_sram_base ;  void __iomem * timers_base ;  struct brcmstb_memc memcs [ MAX_NUM_MEMC ] ;  int num_memc ; } cocci_id@p ;
...
position p;
@@
 struct brcmstb_memc {  void __iomem * ddr_phy_base ;  void __iomem * arb_base ; } cocci_id@p ;
...
typedef u32;
@@
 struct brcm_pm_s3_context {  u32 cp0_regs [ MAX_CP0_REGS ] ;  u32 memc0_rts [ NUM_MEMC_CLIENTS ] ;  u32 sc_boot_vec ; } cocci_id@p ;
...
@@
 struct brcmstb_mem_transfer {  struct brcmstb_mem_transfer * next ;  void * src ;  void * dst ;  dma_addr_t pa_src ;  dma_addr_t pa_dst ;  u32 len ;  u8 key ;  u8 mode ;  u8 src_remapped ;  u8 dst_remapped ;  u8 src_dst_remapped ; } cocci_id@p ;
...
position p;
@@
 struct brcmstb_mem_transfer cocci_id@p ;
