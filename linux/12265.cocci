...
position p;
@@
 struct drm_mode_list_lessees * cocci_id@p ;
...
position p;
@@
 struct drm_mode_create_lease * cocci_id@p ;
...
position p;
@@
 struct drm_mode_get_lease * cocci_id@p ;
...
position p;
@@
 struct drm_mode_revoke_lease * cocci_id@p ;
