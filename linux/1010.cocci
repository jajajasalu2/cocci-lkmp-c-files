...
position p;
@@
 struct cmdline_mtd_partition {  struct cmdline_mtd_partition * next ;  char * mtd_id ;  int num_parts ;  struct mtd_partition * parts ; } cocci_id@p ;
...
position p;
@@
 struct cmdline_mtd_partition * cocci_id@p ;
