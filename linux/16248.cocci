...
position p;
@@
 int ( * cocci_id@p ) ( void * cb_data , void * data , int len , int context ) ;
...
position p;
@@
 int cocci_id@p ( void * priv_dev , int ( * cb ) ( void * cb_data , void * data , int len , int context ) , void * cb_data , int context ) ;
