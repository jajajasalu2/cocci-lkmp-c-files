...
position p;
@@
 TW_Ioctl_Buf_Apache cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( TW_Device_Extension * tw_dev ) ;
...
position p;
@@
 TW_Compatibility_Info cocci_id@p ;
...
position p;
@@
 TW_Command_Apache_Header * cocci_id@p ;
...
position p;
@@
 char * cocci_id@p ( twa_message_type * table , unsigned int aen_code ) ;
...
position p;
@@
 TW_Device_Extension cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( TW_Device_Extension * tw_dev , int request_id , int copy_sense , int print_host ) ;
...
position p;
@@
 int cocci_id@p ( TW_Device_Extension * tw_dev , int request_id ) ;
...
position p;
@@
 void cocci_id@p ( TW_Device_Extension * tw_dev , TW_Command_Apache_Header * header ) ;
...
typedef u32;
@@
 int cocci_id@p ( TW_Device_Extension * tw_dev , u32 flag , int seconds ) ;
...
position p;
@@
 int cocci_id@p ( TW_Device_Extension * tw_dev , int request_id , int seconds ) ;
...
position p;
@@
 int cocci_id@p ( TW_Device_Extension * tw_dev , int soft_reset ) ;
...
position p;
@@
 void cocci_id@p ( TW_Device_Extension * tw_dev , int request_id ) ;
...
position p;
@@
 char * cocci_id@p ( unsigned char severity_code ) ;
...
position p;
@@
 TW_Device_Extension * cocci_id@p [ TW_MAX_SLOT ] ;
...
position p;
@@
 unsigned char cocci_id@p [ TW_MAX_CDB_LEN ] ;
...
position p;
@@
 TW_Ioctl_Driver_Command cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( TW_Device_Extension * tw_dev , int request_id , char internal ) ;
...
position p;
@@
 int cocci_id@p ( TW_Device_Extension * tw_dev , int request_id , unsigned char * cdb , int use_sg , TW_SG_Entry * sglistarg ) ;
