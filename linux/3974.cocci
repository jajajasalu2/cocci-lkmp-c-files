...
typedef spinlock_t;
@@
 struct mvebu_gicp {  struct mvebu_gicp_spi_range * spi_ranges ;  unsigned int spi_ranges_cnt ;  unsigned int spi_cnt ;  unsigned long * spi_bitmap ;  spinlock_t spi_lock ;  struct resource * res ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_gicp_spi_range * cocci_id@p ;
...
position p;
@@
 struct mvebu_gicp_spi_range {  unsigned int start ;  unsigned int count ; } cocci_id@p ;
