...
typedef u32;
@@
 struct stm32f7_i2c_spec {  u32 rate ;  u32 rate_min ;  u32 rate_max ;  u32 fall_max ;  u32 rise_max ;  u32 hddat_min ;  u32 vddat_max ;  u32 sudat_min ;  u32 l_min ;  u32 h_min ; } cocci_id@p ;
...
position p;
@@
 struct stm32f7_i2c_timings * cocci_id@p ;
...
position p;
@@
 const struct stm32f7_i2c_setup cocci_id@p ;
...
position p;
@@
 struct stm32f7_i2c_dev * cocci_id@p ;
...
typedef u8;
@@
 struct stm32f7_i2c_timings {  struct list_head node ;  u8 presc ;  u8 scldel ;  u8 sdadel ;  u8 sclh ;  u8 scll ; } cocci_id@p ;
...
position p;
@@
 struct stm32f7_i2c_msg * cocci_id@p ;
...
position p;
@@
 struct stm32f7_i2c_setup * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct stm32f7_i2c_setup {  enum stm32_i2c_speed speed ;  u32 speed_freq ;  u32 clock_src ;  u32 rise_time ;  u32 fall_time ;  u8 dnf ;  bool analog_filter ; } cocci_id@p ;
...
position p;
@@
 struct stm32f7_i2c_spec cocci_id@p [ ] ;
...
position p;
@@
 struct stm32_i2c_dma * cocci_id@p ;
