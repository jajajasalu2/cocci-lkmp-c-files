...
position p;
@@
 struct iwl_prph_scratch * cocci_id@p ;
...
position p;
@@
 struct iwl_prph_info * cocci_id@p ;
...
position p;
@@
 struct iwl_prph_scratch_ctrl_cfg * cocci_id@p ;
...
position p;
@@
 struct iwl_context_info_gen3 * cocci_id@p ;
...
position p;
@@
 struct iwl_prph_scratch_hwm_cfg * cocci_id@p ;
