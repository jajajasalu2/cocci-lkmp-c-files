...
typedef u16;
@@
 const u16 cocci_id@p [ B43_NTAB_TX_IQLO_CAL_STARTCOEFS ] ;
...
position p;
@@
 struct nphy_gain_ctl_workaround_entry cocci_id@p [ 2 ] [ 4 ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ B43_NTAB_TX_IQLO_CAL_STARTCOEFS_REV3 ] ;
