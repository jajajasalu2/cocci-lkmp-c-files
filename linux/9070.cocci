...
position p;
@@
 struct l2table_node * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( delete_l2_table_entry_out ) ] ;
...
typedef u32;
@@
 struct l2table_node {  struct l2addr_node node ;  u32 index ;  int ref_count ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_l2_table_entry_out ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( set_l2_table_entry_in ) ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( delete_l2_table_entry_in ) ] ;
...
typedef u32;
@@
 struct mlx5_mpfs {  struct hlist_head hash [ MLX5_L2_ADDR_HASH_SIZE ] ;  struct mutex lock ;  u32 size ;  unsigned long * bitmap ; } cocci_id@p ;
