...
typedef u8,bool;
@@
 struct max5821_data {  struct i2c_client * client ;  struct regulator * vref_reg ;  unsigned short vref_mv ;  bool powerdown [ MAX5821_MAX_DAC_CHANNELS ] ;  u8 powerdown_mode [ MAX5821_MAX_DAC_CHANNELS ] ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 enum { MAX5821_THREE_STATE , MAX5821_1KOHM_TO_GND , MAX5821_100KOHM_TO_GND , } cocci_id@p ;
...
position p;
@@
 struct max5821_data * cocci_id@p ;
...
position p;
@@
 enum max5821_device_ids { ID_MAX5821 , } cocci_id@p ;
