...
position p;
@@
 const struct mlx4_en_frag_info * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_rx_alloc * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_rss_map * cocci_id@p ;
...
position p;
@@
 struct mlx4_err_cqe * cocci_id@p ;
...
position p;
@@
 const struct mlx4_en_rx_ring * cocci_id@p ;
...
position p;
@@
 struct mlx4_en_page_cache * cocci_id@p ;
