...
position p;
@@
 void cocci_id@p ( struct hdspm * hdspm , struct snd_pcm_substream * substream , unsigned int reg , int channels ) ;
...
position p;
@@
 struct hdspm_version cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct snd_info_entry * , struct snd_info_buffer * ) ;
...
position p;
@@
 char cocci_id@p [ HDSPM_MAX_CHANNELS ] ;
...
position p;
@@
 struct hdspm_peak_rms * cocci_id@p ;
...
position p;
@@
 struct hdspm_status cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct hdspm * hdspm , u32 regmask , int out ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_card * card , struct hdspm * hdspm ) ;
...
position p;
@@
 struct hdspm_tco {  int input ;  int framerate ;  int wordclock ;  int samplerate ;  int pull ;  int term ; } cocci_id@p ;
...
position p;
@@
 struct hdspm_mixer_ioctl cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hdspm * hdspm , int idx ) ;
...
position p;
@@
 int cocci_id@p ( struct hdspm * hdspm , int index ) ;
...
typedef spinlock_t;
@@
 struct hdspm_midi {  struct hdspm * hdspm ;  int id ;  struct snd_rawmidi * rmidi ;  struct snd_rawmidi_substream * input ;  struct snd_rawmidi_substream * output ;  char istimer ;  struct timer_list timer ;  spinlock_t lock ;  int pending ;  int dataIn ;  int statusIn ;  int dataOut ;  int statusOut ;  int ie ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct hdspm_config cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hdspm * hdspm ) ;
...
position p;
@@
 void cocci_id@p ( struct hdspm * hdspm ) ;
