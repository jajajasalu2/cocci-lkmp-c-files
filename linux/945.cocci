...
position p;
@@
 struct powernv_flash * cocci_id@p ;
...
typedef u32;
@@
 struct powernv_flash {  struct mtd_info mtd ;  u32 id ; } cocci_id@p ;
...
position p;
@@
 enum flash_op { FLASH_OP_READ , FLASH_OP_WRITE , FLASH_OP_ERASE , } cocci_id@p ;
