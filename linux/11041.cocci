...
position p;
@@
 enum HSA_DBG_WATCH_MODE cocci_id@p ;
...
position p;
@@
 struct kfd_local_mem_info cocci_id@p ;
...
position p;
@@
 enum HSA_DBG_WAVEMODE * cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( struct file * , unsigned int , unsigned long ) ;
...
position p;
@@
 const struct amdkfd_ioctl_desc cocci_id@p [ ] ;
...
position p;
@@
 struct kfd_ioctl_create_queue_args * cocci_id@p ;
...
position p;
@@
 enum HSA_DBG_WAVEOP * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_destroy_queue_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_reset_event_args * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * , struct file * ) ;
...
position p;
@@
 struct kfd_ioctl_get_dmabuf_info_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_dbg_wave_control_args * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct file * , struct vm_area_struct * ) ;
...
position p;
@@
 struct kfd_ioctl_wait_events_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_unmap_memory_from_gpu_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_get_process_apertures_new_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_dbg_address_watch_args * cocci_id@p ;
...
position p;
@@
 struct kfd_process_device_apertures * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_get_clock_counters_args * cocci_id@p ;
...
position p;
@@
 struct queue_properties cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_set_memory_policy_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_get_process_apertures_args * cocci_id@p ;
...
position p;
@@
 struct kfd_process_device * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_get_tile_config_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_set_cu_mask_args * cocci_id@p ;
...
position p;
@@
 struct dbg_wave_control_info cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_create_event_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_get_version_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_set_scratch_backing_va_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_dbg_register_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_alloc_memory_of_gpu_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_acquire_vm_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_map_memory_to_gpu_args * cocci_id@p ;
...
position p;
@@
 struct dbg_address_watch_info cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_destroy_event_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_set_trap_handler_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_free_memory_of_gpu_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_dbg_unregister_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_update_queue_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_import_dmabuf_args * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_set_event_args * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef amdkfd_ioctl_t;
@@
 amdkfd_ioctl_t * cocci_id@p ;
...
position p;
@@
 struct kfd_ioctl_get_queue_wave_state_args * cocci_id@p ;
