...
position p;
@@
 int ( * cocci_id@p ) ( struct nfs_commit_data * data , int how ) ;
...
position p;
@@
 struct nfs_client * ( * cocci_id@p ) ( struct nfs_server * mds_srv , const struct sockaddr * ds_addr , int ds_addrlen , int ds_proto , unsigned int ds_timeo , unsigned int ds_retrans ) ;
