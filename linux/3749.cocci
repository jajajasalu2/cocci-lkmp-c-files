...
position p;
@@
 struct nitrox_vfdev * cocci_id@p ;
...
position p;
@@
 enum mbx_msg_opcode { MSG_OP_VF_MODE = 1 , MSG_OP_VF_UP , MSG_OP_VF_DOWN , MSG_OP_CHIPID_VFID , MSG_OP_MCODE_INFO = 11 , } cocci_id@p ;
...
position p;
@@
 struct pf2vf_work {  struct nitrox_vfdev * vfdev ;  struct nitrox_device * ndev ;  struct work_struct pf2vf_resp ; } cocci_id@p ;
...
position p;
@@
 enum mbx_msg_type { MBX_MSG_TYPE_NOP , MBX_MSG_TYPE_REQ , MBX_MSG_TYPE_ACK , MBX_MSG_TYPE_NACK , } cocci_id@p ;
