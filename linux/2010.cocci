...
position p;
@@
 enum mma9551_gpio_pin cocci_id@p ;
...
position p;
@@
 enum mma9551_tilt_axis { mma9551_x = 0 , mma9551_y , mma9551_z , } cocci_id@p ;
...
position p;
@@
 struct mma9551_data {  struct i2c_client * client ;  struct mutex mutex ;  int event_enabled [ 3 ] ;  int irqs [ MMA9551_GPIO_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 enum mma9551_tilt_axis cocci_id@p ;
...
position p;
@@
 struct mma9551_data * cocci_id@p ;
