...
position p;
@@
 struct mISDNtimer {  struct list_head list ;  struct mISDNtimerdev * dev ;  struct timer_list tl ;  int id ; } cocci_id@p ;
...
position p;
@@
 struct mISDNtimerdev cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_int,wait_queue_head_t,spinlock_t;
@@
 struct mISDNtimerdev {  int next_id ;  struct list_head pending ;  struct list_head expired ;  wait_queue_head_t wait ;  u_int work ;  spinlock_t lock ; } cocci_id@p ;
