...
position p;
@@
 enum qbman_pull_type_e cocci_id@p ;
...
typedef u8,__le64;
@@
 struct qbman_cdan_ctrl_desc {  u8 verb ;  u8 reserved ;  __le16 ch ;  u8 we ;  u8 ctrl ;  __le16 reserved2 ;  __le64 cdan_ctx ;  u8 reserved3 [ 48 ] ; } cocci_id@p ;
...
position p;
@@
 struct qbman_bp_query_desc * cocci_id@p ;
...
position p;
@@
 struct qbman_cdan_ctrl_rslt * cocci_id@p ;
...
position p;
@@
 const struct qbman_release_desc * cocci_id@p ;
...
position p;
@@
 const struct dpaa2_dq * cocci_id@p ;
...
position p;
@@
 const struct qbman_fq_query_np_rslt * cocci_id@p ;
...
position p;
@@
 enum qb_pull_dt_e { qb_pull_dt_channel , qb_pull_dt_workqueue , qb_pull_dt_framequeue , } cocci_id@p ;
...
position p;
@@
 struct qbman_fq_query_desc * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct qbman_fq_query_desc {  u8 verb ;  u8 reserved [ 3 ] ;  __le32 fqid ;  u8 reserved2 [ 56 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct qbman_bp_query_desc {  u8 verb ;  u8 reserved ;  __le16 bpid ;  u8 reserved2 [ 60 ] ; } cocci_id@p ;
...
position p;
@@
 const struct qbman_eq_desc * cocci_id@p ;
...
position p;
@@
 struct qbman_acquire_desc * cocci_id@p ;
...
position p;
@@
 struct qbman_release_desc * cocci_id@p ;
...
typedef u8;
@@
 struct qbman_acquire_desc {  u8 verb ;  u8 reserved ;  __le16 bpid ;  u8 num ;  u8 reserved2 [ 59 ] ; } cocci_id@p ;
...
position p;
@@
 struct qbman_pull_desc * cocci_id@p ;
...
position p;
@@
 struct qbman_cdan_ctrl_desc * cocci_id@p ;
...
position p;
@@
 const struct qbman_swp_desc * cocci_id@p ;
...
typedef u8;
@@
 struct qbman_alt_fq_state_rslt {  u8 verb ;  u8 rslt ;  u8 reserved [ 62 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct qbman_cdan_ctrl_rslt {  u8 verb ;  u8 rslt ;  __le16 ch ;  u8 reserved [ 60 ] ; } cocci_id@p ;
...
typedef u8,__le64;
@@
 struct qbman_acquire_rslt {  u8 verb ;  u8 rslt ;  __le16 reserved ;  u8 num ;  u8 reserved2 [ 3 ] ;  __le64 buf [ 7 ] ; } cocci_id@p ;
...
position p;
@@
 enum qbman_sdqcr_dct { qbman_sdqcr_dct_null = 0 , qbman_sdqcr_dct_prio_ics , qbman_sdqcr_dct_active_ics , qbman_sdqcr_dct_active , } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct qbman_alt_fq_state_desc {  u8 verb ;  u8 reserved [ 3 ] ;  __le32 fqid ;  u8 reserved2 [ 56 ] ; } cocci_id@p ;
...
position p;
@@
 struct qbman_alt_fq_state_desc * cocci_id@p ;
...
position p;
@@
 struct qbman_alt_fq_state_rslt * cocci_id@p ;
...
position p;
@@
 struct qbman_fq_query_np_rslt * cocci_id@p ;
...
position p;
@@
 struct qbman_acquire_rslt * cocci_id@p ;
...
position p;
@@
 struct qbman_eq_desc * cocci_id@p ;
...
position p;
@@
 struct qbman_bp_query_rslt * cocci_id@p ;
