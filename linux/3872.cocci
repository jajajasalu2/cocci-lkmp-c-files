...
position p;
@@
 void cocci_id@p ( struct xfrm_state * x ) ;
...
position p;
@@
 struct ipsec_sa_entry * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct sk_buff * skb , struct xfrm_state * x ) ;
...
position p;
@@
 const struct xfrmdev_ops cocci_id@p ;
...
position p;
@@
 struct chcr_ipsec_aadiv * cocci_id@p ;
...
position p;
@@
 struct chcr_ipsec_wr * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ AEAD_H_SIZE ] ;
...
position p;
@@
 struct chcr_ipsec_req cocci_id@p ;
