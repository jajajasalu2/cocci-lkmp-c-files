...
position p;
@@
 struct panfrost_perfcnt * cocci_id@p ;
...
position p;
@@
 struct panfrost_perfcnt {  struct panfrost_gem_object * bo ;  size_t bosize ;  void * buf ;  struct panfrost_file_priv * user ;  struct mutex lock ;  struct completion dump_comp ; } cocci_id@p ;
...
position p;
@@
 struct drm_gem_shmem_object * cocci_id@p ;
...
position p;
@@
 struct drm_panfrost_perfcnt_dump * cocci_id@p ;
...
position p;
@@
 struct drm_panfrost_perfcnt_enable * cocci_id@p ;
