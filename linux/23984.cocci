...
position p;
@@
 struct {  struct sock_extended_err ee ;  struct sockaddr_in offender ; } cocci_id@p ;
...
position p;
@@
 struct sock_extended_err cocci_id@p ;
