...
position p;
@@
 struct sa_subdev_info {  char name [ 16 ] ;  struct map_info map ;  struct mtd_info * mtd ;  struct flash_platform_data * plat ; } cocci_id@p ;
...
position p;
@@
 struct sa_subdev_info * cocci_id@p ;
...
position p;
@@
 struct sa_info {  struct mtd_info * mtd ;  int num_subdev ;  struct sa_subdev_info subdev [ 0 ] ; } cocci_id@p ;
