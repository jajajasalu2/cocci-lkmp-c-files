...
position p;
@@
 char cocci_id@p [ CMSG_SPACE ( sizeof ( cookie ) ) ] ;
...
position p;
@@
 char cocci_id@p [ CMSG_SPACE ( sizeof ( struct rds_zcopy_cookies ) ) ] ;
...
position p;
@@
 union {  struct ipv6hdr ip6h ;  struct iphdr iph ; } cocci_id@p ;
