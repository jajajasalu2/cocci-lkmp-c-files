...
position p;
@@
 struct lgdt3305_config cocci_id@p ;
...
position p;
@@
 struct tda18271_config cocci_id@p ;
...
position p;
@@
 struct a8293_platform_data cocci_id@p ;
...
position p;
@@
 struct s5h1409_config cocci_id@p ;
...
position p;
@@
 struct xc2028_config cocci_id@p ;
...
position p;
@@
 struct si2165_platform_data cocci_id@p ;
...
position p;
@@
 struct stv6110_config cocci_id@p ;
...
position p;
@@
 struct stv0900_config cocci_id@p ;
...
position p;
@@
 struct mt2131_config cocci_id@p ;
...
position p;
@@
 struct dibx000_agc_config cocci_id@p ;
...
position p;
@@
 struct stv090x_config cocci_id@p ;
...
position p;
@@
 struct tda18271_std_map cocci_id@p ;
...
position p;
@@
 struct xc5000_config cocci_id@p ;
...
position p;
@@
 struct altera_ci_config cocci_id@p ;
...
position p;
@@
 struct mt2063_config cocci_id@p [ ] ;
...
position p;
@@
 struct atbm8830_config cocci_id@p ;
...
position p;
@@
 struct ds3000_config cocci_id@p ;
...
position p;
@@
 const struct m88ds3103_config cocci_id@p ;
...
position p;
@@
 struct m88rs6000t_config cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct dvb_frontend * fe , enum fe_sec_voltage voltage ) ;
...
position p;
@@
 struct lgdt330x_config cocci_id@p ;
...
position p;
@@
 struct si2157_config cocci_id@p ;
...
position p;
@@
 struct si2168_config cocci_id@p ;
...
position p;
@@
 struct tda10071_platform_data cocci_id@p ;
...
position p;
@@
 struct mb86a20s_config cocci_id@p ;
...
position p;
@@
 struct ts2020_config cocci_id@p ;
...
position p;
@@
 struct dibx000_bandwidth_config cocci_id@p ;
...
position p;
@@
 struct cx24117_config cocci_id@p ;
...
position p;
@@
 struct vb2_dvb_frontend * cocci_id@p ;
...
position p;
@@
 struct cx24116_config cocci_id@p ;
...
position p;
@@
 const struct tda10071_platform_data cocci_id@p ;
...
position p;
@@
 struct s5h1411_config cocci_id@p ;
...
position p;
@@
 struct zl10353_config cocci_id@p ;
...
position p;
@@
 struct lgdt3306a_config cocci_id@p ;
...
position p;
@@
 struct tda829x_config cocci_id@p ;
...
position p;
@@
 struct dib0070_config cocci_id@p ;
...
position p;
@@
 struct dib7000p_ops cocci_id@p ;
...
position p;
@@
 struct netup_card_info cocci_id@p ;
...
position p;
@@
 struct dib7000p_config cocci_id@p ;
...
position p;
@@
 struct max2165_config cocci_id@p ;
...
position p;
@@
 struct m88ds3103_platform_data cocci_id@p ;
...
position p;
@@
 struct xc4000_config cocci_id@p ;
...
position p;
@@
 struct tda10048_config cocci_id@p ;
...
position p;
@@
 struct lgs8gxx_config cocci_id@p ;
...
position p;
@@
 struct stv0367_config cocci_id@p [ ] ;
...
position p;
@@
 struct vb2_dvb_frontends * cocci_id@p ;
...
position p;
@@
 struct stb6100_config cocci_id@p ;
