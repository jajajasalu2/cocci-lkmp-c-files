...
typedef u8;
@@
 struct {  u8 key [ MAXPROTKEYSIZE ] ;  u8 tweak [ 16 ] ;  u8 block [ 16 ] ;  u8 bit [ 16 ] ;  u8 xts [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 struct s390_pxts_ctx {  struct key_blob kb [ 2 ] ;  struct pkey_protkey pk [ 2 ] ;  unsigned long fc ; } cocci_id@p ;
...
position p;
@@
 struct s390_paes_ctx * cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 key [ MAXPROTKEYSIZE ] ;  u8 init [ 16 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct key_blob {  u8 * key ;  u8 keybuf [ 128 ] ;  unsigned int keylen ; } cocci_id@p ;
...
position p;
@@
 struct s390_paes_ctx {  struct key_blob kb ;  struct pkey_protkey pk ;  unsigned long fc ; } cocci_id@p ;
...
position p;
@@
 struct s390_pxts_ctx cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ 2 * AES_MAX_KEY_SIZE ] ;
