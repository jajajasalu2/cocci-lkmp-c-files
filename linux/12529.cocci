...
typedef dma_addr_t;
@@
 struct dma_pixmap {  dma_addr_t paddr ;  size_t size ;  void * base ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct sti_cursor {  struct sti_plane plane ;  struct device * dev ;  void __iomem * regs ;  unsigned int width ;  unsigned int height ;  unsigned short * clut ;  dma_addr_t clut_paddr ;  struct dma_pixmap pixmap ; } cocci_id@p ;
