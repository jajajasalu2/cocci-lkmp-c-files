...
symbol cocci_id;
position p;
typedef dio_submit_t;
@@
 dio_submit_t cocci_id@p ;
...
@@
 blk_status_t cocci_id@p ( struct dio * dio , struct bio * bio ) ;
...
symbol cocci_id;
position p;
typedef dio_iodone_t;
@@
 dio_iodone_t cocci_id@p ;
