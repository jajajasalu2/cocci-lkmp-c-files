...
position p;
@@
 struct mpc8xxx_wdt_type cocci_id@p ;
...
position p;
@@
 const struct mpc8xxx_wdt_type * cocci_id@p ;
...
typedef bool,u32;
@@
 struct mpc8xxx_wdt_type {  int prescaler ;  bool hw_enabled ;  u32 rsr_mask ; } cocci_id@p ;
...
position p;
@@
 struct mpc8xxx_wdt_ddata * cocci_id@p ;
...
@@
 struct mpc8xxx_wdt_ddata {  struct mpc8xxx_wdt __iomem * base ;  struct watchdog_device wdd ;  spinlock_t lock ;  u16 swtc ; } cocci_id@p ;
...
position p;
@@
 struct watchdog_ops cocci_id@p ;
