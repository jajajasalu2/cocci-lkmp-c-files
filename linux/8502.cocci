...
position p;
@@
 struct bfi_enet_mcast_add_req * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_rss_cfg_req cocci_id@p ;
...
position p;
@@
 struct bfi_enet_tx_cfg_req * cocci_id@p ;
...
position p;
@@
 struct bna_res_info * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct bnad * , struct bna_rx * ) ;
...
position p;
@@
 struct bfi_enet_mcast_add_rsp cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bna_rxf * rxf ) ;
...
position p;
@@
 struct bfi_msgq_mhdr * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_rit_req * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_ucast_req * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_rx_vlan_req cocci_id@p ;
...
position p;
@@
 struct bna_ucam_mod * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_mcast_del_req cocci_id@p ;
...
position p;
@@
 struct bfi_enet_tx_cfg_rsp cocci_id@p ;
...
position p;
@@
 struct bfi_enet_rx_cfg_req * cocci_id@p ;
...
position p;
@@
 struct bna_intr_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct bna_rxf * rxf , enum bna_cleanup_type cleanup ) ;
...
position p;
@@
 enum bfi_enet_h2i_msgs cocci_id@p ;
...
position p;
@@
 struct bna_mem_descr * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_req cocci_id@p ;
...
position p;
@@
 struct bna_rx_config * cocci_id@p ;
...
position p;
@@
 struct bna_mcam_mod * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ ] [ BNA_BIAS_T_MAX ] ;
...
position p;
@@
 void cocci_id@p ( struct bna_tx * tx ) ;
...
position p;
@@
 struct bfi_enet_enable_req * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_rx_cfg_rsp * cocci_id@p ;
...
position p;
@@
 struct bna_dma_addr cocci_id@p ;
...
position p;
@@
 const struct bna_rx_event_cbfn * cocci_id@p ;
...
position p;
@@
 struct bna_mcam_handle * cocci_id@p ;
...
position p;
@@
 struct bna_tx_config * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ BNA_LOAD_T_MAX ] [ BNA_BIAS_T_MAX ] ;
...
position p;
@@
 struct bna_mem_info * cocci_id@p ;
...
position p;
@@
 const struct bna_tx_event_cbfn * cocci_id@p ;
...
position p;
@@
 struct bfi_enet_rsp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * arg , struct bna_rx * rx ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * , struct bna_tx * ) ;
...
position p;
@@
 int cocci_id@p ( struct bna_rxf * rxf ) ;
...
position p;
@@
 enum bna_tx_event { TX_E_START = 1 , TX_E_STOP = 2 , TX_E_FAIL = 3 , TX_E_STARTED = 4 , TX_E_STOPPED = 5 , TX_E_CLEANUP_DONE = 7 , TX_E_BW_UPDATE = 8 , } cocci_id@p ;
...
position p;
@@
 enum bna_cleanup_type cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * tx_mod , struct bna_tx * tx ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * , struct bna_rx * ) ;
...
position p;
@@
 void cocci_id@p ( struct bna_rx * rx ) ;
