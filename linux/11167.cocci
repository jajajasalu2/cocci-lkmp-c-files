...
position p;
@@
 struct atom_display_controller_info_v4_2 * cocci_id@p ;
...
position p;
@@
 struct atom_firmware_info_v3_2 * cocci_id@p ;
...
position p;
@@
 struct object_info_table * cocci_id@p ;
...
position p;
@@
 enum connector_layout_type cocci_id@p ;
...
position p;
@@
 struct atom_display_controller_info_v4_1 cocci_id@p ;
...
position p;
@@
 struct atom_smu_info_v3_2 cocci_id@p ;
...
position p;
@@
 struct atom_hpd_int_record * cocci_id@p ;
...
position p;
@@
 struct embedded_panel_info * cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct dc_bios * dcb , struct graphics_object_id object_id , struct bp_encoder_cap_info * info ) ;
...
position p;
@@
 struct atom_gpio_pin_lut_v2_1 cocci_id@p ;
...
position p;
@@
 struct atom_gpio_pin_assignment cocci_id@p [ 8 ] ;
...
position p;
@@
 struct atom_display_object_path_v2 * cocci_id@p ;
...
position p;
@@
 struct atom_gpio_pin_assignment cocci_id@p ;
...
position p;
@@
 struct atom_master_data_table_v2_1 cocci_id@p ;
...
position p;
@@
 struct atom_smu_info_v3_1 cocci_id@p ;
...
position p;
@@
 struct atom_integrated_system_info_v1_11 * cocci_id@p ;
...
position p;
@@
 struct connector_device_tag_info * cocci_id@p ;
...
position p;
@@
 struct bp_encoder_cap_info * cocci_id@p ;
...
position p;
@@
 struct dc_firmware_info * cocci_id@p ;
...
position p;
@@
 enum dal_device_type cocci_id@p ;
...
position p;
@@
 enum as_signal_type cocci_id@p ;
...
position p;
@@
 struct atom_encoder_caps_record cocci_id@p ;
...
position p;
@@
 struct atom_rom_header_v2_2 * cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct atom_i2c_record * record , struct graphics_object_i2c_info * info ) ;
...
position p;
@@
 struct atom_firmware_info_v3_1 cocci_id@p ;
...
position p;
@@
 struct integrated_info cocci_id@p ;
...
position p;
@@
 struct lcd_info_v2_1 cocci_id@p ;
...
position p;
@@
 struct gpio_pin_info * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ MAX_BOARD_SLOTS ] ;
...
position p;
@@
 struct bp_init_data * cocci_id@p ;
...
position p;
@@
 struct atom_encoder_caps_record * cocci_id@p ( struct bios_parser * bp , struct atom_display_object_path_v2 * object ) ;
...
position p;
@@
 struct atom_common_record_header * cocci_id@p ;
...
position p;
@@
 struct display_object_info_table_v1_4 * cocci_id@p ;
...
position p;
@@
 struct spread_spectrum_info * cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct dc_bios * dcb , struct dc_firmware_info * info ) ;
...
position p;
@@
 struct atom_common_table_header cocci_id@p ;
...
position p;
@@
 struct atom_data_revision * cocci_id@p ;
...
position p;
@@
 struct graphics_object_i2c_info * cocci_id@p ;
...
position p;
@@
 struct atom_smu_info_v3_3 cocci_id@p ;
...
position p;
@@
 struct atom_i2c_record cocci_id@p ;
...
position p;
@@
 struct board_layout_info * cocci_id@p ;
...
position p;
@@
 struct atom_hpd_int_record * cocci_id@p ( struct bios_parser * bp , struct atom_display_object_path_v2 * object ) ;
...
position p;
@@
 struct graphics_object_hpd_info * cocci_id@p ;
...
position p;
@@
 const struct dc_vbios_funcs cocci_id@p ;
...
position p;
@@
 struct atom_bracket_layout_record * cocci_id@p ;
...
position p;
@@
 struct slot_layout_info * cocci_id@p ;
...
position p;
@@
 enum bp_result cocci_id@p ( struct bios_parser * bp , struct dc_firmware_info * info ) ;
...
typedef uint8_t;
@@
 struct i2c_id_config_access {  uint8_t bfI2C_LineMux : 4 ;  uint8_t bfHW_EngineID : 3 ;  uint8_t bfHW_Capable : 1 ;  uint8_t ucAccess ; } cocci_id@p ;
