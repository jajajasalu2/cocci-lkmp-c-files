...
position p;
@@
 struct R_ANTENNA_SELECT_CCK * cocci_id@p ;
...
position p;
@@
 struct SetChannel_parm * cocci_id@p ;
...
position p;
@@
 struct IOCMD_STRUCT cocci_id@p ;
...
typedef u8;
@@
 struct R_ANTENNA_SELECT_CCK {  u8 r_cckrx_enable_2 : 2 ;  u8 r_cckrx_enable : 2 ;  u8 r_ccktx_enable : 4 ; } cocci_id@p ;
...
position p;
@@
 struct mp_xmit_frame cocci_id@p ;
...
typedef u32;
@@
 struct R_ANTENNA_SELECT_OFDM {  u32 r_tx_antenna : 4 ;  u32 r_ant_l : 4 ;  u32 r_ant_non_ht : 4 ;  u32 r_ant_ht1 : 4 ;  u32 r_ant_ht2 : 4 ;  u32 r_ant_ht_s1 : 4 ;  u32 r_ant_non_ht_s1 : 4 ;  u32 OFDM_TXSC : 2 ;  u32 Reserved : 2 ; } cocci_id@p ;
