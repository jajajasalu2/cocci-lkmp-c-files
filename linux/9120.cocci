...
position p;
@@
 enum dr_action_domain { DR_ACTION_DOMAIN_NIC_INGRESS , DR_ACTION_DOMAIN_NIC_EGRESS , DR_ACTION_DOMAIN_FDB_INGRESS , DR_ACTION_DOMAIN_FDB_EGRESS , DR_ACTION_DOMAIN_MAX , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ DR_ACTION_TYP_MAX ] ;
...
position p;
@@
 struct mlx5dr_table * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_cmd_query_flow_table_details cocci_id@p ;
...
position p;
@@
 struct mlx5dr_domain_rx_tx * cocci_id@p ;
...
position p;
@@
 enum mlx5dr_domain_type cocci_id@p ;
...
position p;
@@
 const struct dr_action_modify_field_conv cocci_id@p [ ] ;
...
position p;
@@
 enum mlx5dr_action_type * cocci_id@p ;
...
@@
 struct dr_action_apply_attr {  u32 modify_index ;  u16 modify_actions ;  u32 decap_index ;  u16 decap_actions ;  u8 decap_with_vlan : 1 ;  u64 final_icm_addr ;  u32 flow_tag ;  u32 ctr_id ;  u16 gvmi ;  u16 hit_gvmi ;  u32 reformat_id ;  u32 reformat_size ;  struct dr_action_vlan_info vlans ; } cocci_id@p ;
...
position p;
@@
 struct dr_action_apply_attr * cocci_id@p ;
...
position p;
@@
 struct mlx5_ifc_l2_hdr_bits * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ REWRITE_HW_ACTION_NUM ] ;
...
typedef u32;
@@
 struct dr_action_vlan_info {  int count ;  u32 headers [ MAX_VLANS ] ; } cocci_id@p ;
...
position p;
@@
 struct mlx5dr_matcher * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_icm_chunk * cocci_id@p ;
...
position p;
@@
 enum mlx5dr_action_reformat_type cocci_id@p ;
...
position p;
@@
 struct mlx5dr_matcher_rx_tx * cocci_id@p ;
...
position p;
@@
 struct mlx5dr_cmd_vport_cap * cocci_id@p ;
...
position p;
@@
 enum mlx5_reformat_ctx_type cocci_id@p ;
...
position p;
@@
 enum dr_action_valid_state { DR_ACTION_STATE_ERR , DR_ACTION_STATE_NO_ACTION , DR_ACTION_STATE_REFORMAT , DR_ACTION_STATE_MODIFY_HDR , DR_ACTION_STATE_MODIFY_VLAN , DR_ACTION_STATE_NON_TERM , DR_ACTION_STATE_TERM , DR_ACTION_STATE_MAX , } cocci_id@p ;
...
position p;
@@
 enum mlx5dr_ste_entry_type cocci_id@p ;
...
position p;
@@
 enum dr_action_domain cocci_id@p ;
...
position p;
@@
 const enum dr_action_valid_state cocci_id@p [ DR_ACTION_DOMAIN_MAX ] [ DR_ACTION_STATE_MAX ] [ DR_ACTION_TYP_MAX ] ;
...
typedef u8,u16;
@@
 struct dr_action_modify_field_conv {  u16 hw_field ;  u8 start ;  u8 end ;  u8 l3_type ;  u8 l4_type ; } cocci_id@p ;
