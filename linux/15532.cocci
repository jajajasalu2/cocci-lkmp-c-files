...
typedef u32;
@@
 struct cdns_i3c_master_caps {  u32 cmdfifodepth ;  u32 cmdrfifodepth ;  u32 txfifodepth ;  u32 rxfifodepth ;  u32 ibirfifodepth ; } cocci_id@p ;
...
position p;
@@
 struct cdns_i3c_xfer cocci_id@p ;
...
position p;
@@
 const struct i3c_ccc_cmd * cocci_id@p ;
...
@@
 struct cdns_i3c_master {  struct work_struct hj_work ;  struct i3c_master_controller base ;  u32 free_rr_slots ;  unsigned int maxdevs ;  struct {  unsigned int num_slots ;  struct i3c_dev_desc * * slots ;  spinlock_t lock ; } ibi ;  struct {  struct list_head list ;  struct cdns_i3c_xfer * cur ;  spinlock_t lock ; } xferqueue ;  void __iomem * regs ;  struct clk * sysclk ;  struct clk * pclk ;  struct cdns_i3c_master_caps caps ;  unsigned long i3c_scl_lim ; } cocci_id@p ;
...
position p;
@@
 struct cdns_i3c_master cocci_id@p ;
...
position p;
@@
 struct cdns_i3c_xfer {  struct list_head node ;  struct completion comp ;  int ret ;  unsigned int ncmds ;  struct cdns_i3c_cmd cmds [ 0 ] ; } cocci_id@p ;
...
typedef u16,s16;
@@
 struct cdns_i3c_i2c_dev_data {  u16 id ;  s16 ibi ;  struct i3c_generic_ibi_pool * ibi_pool ; } cocci_id@p ;
...
position p;
@@
 enum i3c_error_code cocci_id@p ;
...
position p;
@@
 struct cdns_i3c_cmd * cocci_id@p ;
...
typedef u32;
@@
 struct cdns_i3c_cmd {  u32 cmd0 ;  u32 cmd1 ;  u32 tx_len ;  const void * tx_buf ;  u32 rx_len ;  void * rx_buf ;  u32 error ; } cocci_id@p ;
...
position p;
@@
 struct cdns_i3c_i2c_dev_data * cocci_id@p ;
