...
position p;
@@
 struct dtlk_settings * cocci_id@p ;
...
position p;
@@
 struct dtlk_settings * cocci_id@p ( void ) ;
...
position p;
@@
 char cocci_id@p [ sizeof ( struct dtlk_settings ) + 1 ] ;
...
position p;
@@
 char cocci_id@p ( const char * buf , int n ) ;
