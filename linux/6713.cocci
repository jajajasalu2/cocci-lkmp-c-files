...
position p;
@@
 int cocci_id@p ( struct iscsi_tcp_conn * tcp_conn , struct iscsi_segment * segment ) ;
...
position p;
@@
 struct iscsi_segment * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef iscsi_segment_done_fn_t;
@@
 iscsi_segment_done_fn_t * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ISCSI_DIGEST_SIZE ] ;
