...
position p;
@@
 struct mxs_dma_filter_param {  unsigned int chan_id ; } cocci_id@p ;
...
position p;
@@
 enum mxs_dma_id { IMX23_DMA , IMX28_DMA , } cocci_id@p ;
...
position p;
@@
 enum mxs_dma_devtype { MXS_DMA_APBH , MXS_DMA_APBX , } cocci_id@p ;
...
position p;
@@
 struct mxs_dma_type {  enum mxs_dma_id id ;  enum mxs_dma_devtype type ; } cocci_id@p ;
...
position p;
@@
 struct mxs_dma_chan * cocci_id@p ;
...
position p;
@@
 struct mxs_dma_engine {  enum mxs_dma_id dev_id ;  enum mxs_dma_devtype type ;  void __iomem * base ;  struct clk * clk ;  struct dma_device dma_device ;  struct device_dma_parameters dma_parms ;  struct mxs_dma_chan mxs_chans [ MXS_DMA_CHANNELS ] ;  struct platform_device * pdev ;  unsigned int nr_channels ; } cocci_id@p ;
...
position p;
@@
 struct mxs_dma_filter_param * cocci_id@p ;
...
position p;
@@
 struct mxs_dma_type cocci_id@p [ ] ;
...
position p;
@@
 struct mxs_dma_engine * cocci_id@p ;
...
position p;
@@
 const struct mxs_dma_type * cocci_id@p ;
