...
typedef u8,bool,u32;
@@
 struct dpcd_quirk {  u8 oui [ 3 ] ;  u8 device_id [ 6 ] ;  bool is_branch ;  u32 quirks ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ DP_DSC_RECEIVER_CAP_SIZE ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ DP_RECEIVER_CAP_SIZE ] ;
...
position p;
@@
 const struct drm_dp_aux * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ EDP_PSR_RECEIVER_CAP_SIZE ] ;
...
position p;
@@
 struct drm_dp_dpcd_ident * cocci_id@p ;
...
position p;
@@
 const struct drm_dp_dpcd_ident * cocci_id@p ;
...
position p;
@@
 const struct dpcd_quirk * cocci_id@p ;
