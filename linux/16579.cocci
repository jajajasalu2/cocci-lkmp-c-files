...
position p;
@@
 struct raw3215_info * cocci_id@p ;
...
position p;
@@
 struct raw3215_info * cocci_id@p [ NR_3215 ] ;
...
@@
 struct raw3215_info {  struct tty_port port ;  struct ccw_device * cdev ;  spinlock_t * lock ;  int flags ;  char * buffer ;  char * inbuf ;  int head ;  int count ;  int written ;  struct raw3215_req * queued_read ;  struct raw3215_req * queued_write ;  struct tasklet_struct tlet ;  wait_queue_head_t empty_wait ;  struct timer_list timer ;  int line_pos ;  char ubuffer [ 80 ] ; } cocci_id@p ;
...
position p;
@@
 enum raw3215_type { RAW3215_FREE , RAW3215_READ , RAW3215_WRITE , } cocci_id@p ;
