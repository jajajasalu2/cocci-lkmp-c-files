...
position p;
@@
 struct path_info {  struct list_head list ;  struct dm_path * path ;  unsigned repeat_count ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct selector {  struct list_head valid_paths ;  struct list_head invalid_paths ;  spinlock_t lock ; } cocci_id@p ;
