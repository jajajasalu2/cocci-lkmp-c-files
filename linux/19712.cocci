...
position p;
@@
 union cvmx_npei_dmax_counts cocci_id@p ;
...
position p;
@@
 union cvmx_pko_mem_debug8 cocci_id@p ;
...
@@
 cvmx_cmd_queue_id_t cocci_id@p ;
...
position p;
@@
 union cvmx_pko_mem_debug9 cocci_id@p ;
...
position p;
@@
 union cvmx_fpa_ctl_status cocci_id@p ;
