...
position p;
@@
 struct {  struct list_head list ;  unsigned long flags ;  int offset ;  int size ;  char * magic ;  char * mask ;  const char * interpreter ;  char * name ;  struct dentry * dentry ;  struct file * interp_file ; } cocci_id@p ;
...
position p;
@@
 enum { VERBOSE_STATUS = 1 , } cocci_id@p ;
