...
position p;
@@
 struct perf_annotate * cocci_id@p ;
...
typedef bool;
@@
 struct perf_annotate {  struct perf_tool tool ;  struct perf_session * session ;  struct annotation_options opts ;  bool use_tui , use_stdio , use_stdio2 , use_gtk ;  bool skip_missing ;  bool has_br_stack ;  bool group_set ;  const char * sym_hist_filter ;  const char * cpu_list ; 
...
position p;
@@
 int ( * cocci_id@p ) ( struct hist_entry * he , struct evsel * evsel , struct hist_browser_timer * hbt ) ;
...
position p;
@@
 struct block_range_iter cocci_id@p ;
