...
@@
 struct encx24j600_priv {  struct net_device * ndev ;  struct mutex lock ;  struct encx24j600_context ctx ;  struct sk_buff * tx_skb ;  struct task_struct * kworker_task ;  struct kthread_worker kworker ;  struct kthread_work tx_work ;  struct kthread_work setrx_work ;  u16 next_packet ;  bool hw_enabled ;  bool full_duplex ;  bool autoneg ;  u16 speed ;  int rxfilter ;  u32 msg_enable ; } cocci_id@p ;
...
position p;
@@
 struct encx24j600_priv * cocci_id@p ;
...
position p;
@@
 enum { RXFILTER_NORMAL , RXFILTER_MULTI , RXFILTER_PROMISC , } cocci_id@p ;
