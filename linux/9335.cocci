...
position p;
@@
 struct wl12xx_event_mailbox cocci_id@p ;
...
position p;
@@
 struct wlcore_partition_set cocci_id@p [ PART_TABLE_LEN ] ;
...
position p;
@@
 const struct wl12xx_clock cocci_id@p [ ] ;
...
position p;
@@
 struct wl12xx_acx_statistics cocci_id@p ;
...
position p;
@@
 struct wl12xx_fw_status * cocci_id@p ;
...
position p;
@@
 struct wl12xx_priv_conf cocci_id@p ;
