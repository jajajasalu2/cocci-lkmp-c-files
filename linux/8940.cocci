...
position p;
@@
 const struct {  enum hnae_media_type value ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 const enum mac_mode cocci_id@p [ ] ;
...
position p;
@@
 const struct hns_mac_cb * cocci_id@p ;
...
position p;
@@
 struct mac_entry_idx * cocci_id@p ;
...
position p;
@@
 enum mac_commom_mode cocci_id@p ;
