...
position p;
@@
 struct caam_drv_private * cocci_id@p ;
...
position p;
@@
 struct sec4_sg_entry * cocci_id@p ;
...
position p;
@@
 struct caam_hash_alg {  struct list_head entry ;  int alg_type ;  struct ahash_alg ahash_alg ; } cocci_id@p ;
...
@@
 struct ahash_edesc {  dma_addr_t sec4_sg_dma ;  int src_nents ;  int sec4_sg_bytes ;  u32 hw_desc [ DESC_JOB_IO_LEN_MAX / sizeof ( u32 ) ] ____cacheline_aligned ;  struct sec4_sg_entry sec4_sg [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct split_key_result cocci_id@p ;
