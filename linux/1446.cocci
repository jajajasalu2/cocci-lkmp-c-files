...
position p;
@@
 struct usb_os_desc * cocci_id@p [ 1 ] ;
...
position p;
@@
 struct usb_cdc_ncm_ntb_parameters cocci_id@p ;
...
position p;
@@
 struct usb_cdc_notification * cocci_id@p ;
...
position p;
@@
 struct usb_cdc_ncm_desc cocci_id@p ;
...
position p;
@@
 enum ncm_notify_state { NCM_NOTIFY_NONE , NCM_NOTIFY_CONNECT , NCM_NOTIFY_SPEED , } cocci_id@p ;
...
position p;
@@
 struct usb_cdc_ether_desc cocci_id@p ;
...
position p;
@@
 const struct ndp_parser_opts * cocci_id@p ;
...
typedef u32;
@@
 struct ndp_parser_opts {  u32 nth_sign ;  u32 ndp_sign ;  unsigned nth_size ;  unsigned ndp_size ;  unsigned dpe_size ;  unsigned ndplen_align ;  unsigned dgram_item_len ;  unsigned block_length ;  unsigned ndp_index ;  unsigned reserved1 ;  unsigned reserved2 ;  unsigned next_ndp_index ; } cocci_id@p ;
...
position p;
@@
 struct usb_cdc_header_desc cocci_id@p ;
