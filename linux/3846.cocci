...
position p;
@@
 struct cc_hash_handle * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cc_sram_addr_t;
@@
 struct cc_hash_handle {  cc_sram_addr_t digest_len_sram_addr ;  cc_sram_addr_t larval_digest_sram_addr ;  struct list_head hash_list ; } cocci_id@p ;
...
position p;
@@
 struct cc_hw_desc cocci_id@p [ CC_MAX_HASH_SEQ_LEN ] ;
...
position p;
@@
 struct cc_crypto_req cocci_id@p ;
...
@@
 struct hash_key_req_ctx {  u32 keylen ;  dma_addr_t key_dma_addr ;  u8 * key ; } cocci_id@p ;
...
position p;
@@
 struct cc_hash_template * cocci_id@p ;
...
typedef u32;
@@
 const void * cocci_id@p ( struct device * dev , u32 mode ) ;
...
typedef u32;
@@
 struct cc_hw_desc cocci_id@p [ CC_DIGEST_SIZE_MAX / sizeof ( u32 ) ] ;
...
position p;
@@
 void cocci_id@p ( struct ahash_request * areq , struct cc_hw_desc desc [ ] , unsigned int * seq_size ) ;
...
symbol cocci_id;
position p;
typedef u8,bool,dma_addr_t;
@@
 struct cc_hash_ctx {  struct cc_drvdata * drvdata ;  u8 digest_buff [ CC_MAX_HASH_DIGEST_SIZE ] ____cacheline_aligned ;  u8 opad_tmp_keys_buff [ CC_MAX_OPAD_KEYS_SIZE ] ____cacheline_aligned ;  dma_addr_t opad_tmp_keys_dma_addr ____cacheline_aligned ;  dma_addr_t digest_buff_dma_addr ;  struct hash_key_req_ctx key_params ;  int hash_mode ;  int hw_mode ;  int inter_digestsize ;  unsigned int hash_len ;  struct completion setkey_comp ;  bool is_hmac ; } cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct ahash_req_ctx * areq_ctx , struct cc_hash_ctx * ctx , unsigned int flow_mode , struct cc_hw_desc desc [ ] , bool is_not_last_data , unsigned int * seq_size ) ;
...
position p;
@@
 struct cc_hash_alg {  struct list_head entry ;  int hash_mode ;  int hw_mode ;  int inter_digestsize ;  struct cc_drvdata * drvdata ;  struct ahash_alg ahash_alg ; } cocci_id@p ;
...
position p;
@@
 struct ahash_req_ctx cocci_id@p ;
