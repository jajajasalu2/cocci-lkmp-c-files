...
position p;
@@
 struct rtw_debugfs_priv * cocci_id@p ;
...
position p;
@@
 enum rtw_debug_mask cocci_id@p ;
...
position p;
@@
 struct rtw_pkt_count * cocci_id@p ;
