...
position p;
@@
 struct MR_FW_RAID_MAP_DYNAMIC * cocci_id@p ;
...
@@
 u8 cocci_id@p ( struct megasas_instance * instance , u32 ld , u64 stripRow , u16 stripRef , struct IO_REQUEST_INFO * io_info , struct RAID_CONTEXT * pRAID_Context , struct MR_DRV_RAID_MAP_ALL * map ) ;
...
position p;
@@
 void cocci_id@p ( struct MR_DRV_RAID_MAP_ALL * map , PLD_SPAN_INFO ldSpanInfo ) ;
...
position p;
@@
 struct MR_FW_RAID_MAP_ALL * cocci_id@p ;
...
position p;
@@
 struct MR_RAID_MAP_DESC_TABLE * cocci_id@p ;
...
typedef u64,u32;
@@
 u64 cocci_id@p ( struct megasas_instance * instance , u32 ld , u64 strip , struct MR_DRV_RAID_MAP_ALL * map ) ;
...
position p;
@@
 struct MR_QUAD_ELEMENT * cocci_id@p ;
...
position p;
@@
 struct MR_DRV_RAID_MAP * cocci_id@p ;
...
position p;
@@
 struct MR_DEV_HANDLE_INFO cocci_id@p ;
...
position p;
@@
 struct MR_ARRAY_INFO cocci_id@p ;
...
position p;
@@
 struct MR_SPAN_BLOCK_INFO * cocci_id@p ;
