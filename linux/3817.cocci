...
position p;
@@
 int cocci_id@p ( struct spacc_req * req ) ;
...
position p;
@@
 struct spacc_aead_ctx * cocci_id@p ;
...
position p;
@@
 struct spacc_generic_ctx {  struct spacc_engine * engine ;  int flags ;  int key_offs ;  int iv_offs ; } cocci_id@p ;
...
position p;
@@
 struct spacc_alg {  unsigned long ctrl_default ;  unsigned long type ;  struct skcipher_alg alg ;  struct spacc_engine * engine ;  struct list_head entry ;  int key_offs ;  int iv_offs ; } cocci_id@p ;
...
position p;
@@
 struct spacc_ablk_ctx cocci_id@p ;
...
position p;
@@
 struct spacc_aead {  unsigned long ctrl_default ;  unsigned long type ;  struct aead_alg alg ;  struct spacc_engine * engine ;  struct list_head entry ;  int key_offs ;  int iv_offs ; } cocci_id@p ;
...
position p;
@@
 struct spacc_engine * cocci_id@p ;
...
@@
 struct spacc_ddt {  dma_addr_t p ;  u32 len ; } cocci_id@p ;
...
typedef u8;
@@
 struct spacc_aead_ctx {  struct spacc_generic_ctx generic ;  u8 cipher_key [ AES_MAX_KEY_SIZE ] ;  u8 hash_ctx [ SPACC_CRYPTO_IPSEC_HASH_PG_SZ ] ;  u8 cipher_key_len ;  u8 hash_key_len ;  struct crypto_aead * sw_cipher ; } cocci_id@p ;
...
typedef u8;
@@
 struct spacc_ablk_ctx {  struct spacc_generic_ctx generic ;  u8 key [ AES_MAX_KEY_SIZE ] ;  u8 key_len ;  struct crypto_sync_skcipher * sw_cipher ; } cocci_id@p ;
...
@@
 struct spacc_req {  struct list_head list ;  struct spacc_engine * engine ;  struct crypto_async_request * req ;  int result ;  bool is_encrypt ;  unsigned ctx_id ;  dma_addr_t src_addr , dst_addr ;  struct spacc_ddt * src_ddt , * dst_ddt ;  void ( * complete ) ( struct spacc_req * req ) ; } cocci_id@p ;
...
position p;
@@
 struct spacc_generic_ctx * cocci_id@p ;
