...
position p;
@@
 struct gpio_keys_drvdata * cocci_id@p ;
...
position p;
@@
 struct gpio_button_data cocci_id@p ;
...
position p;
@@
 const struct gpio_keys_button * cocci_id@p ;
...
position p;
@@
 struct gpio_keys_drvdata {  const struct gpio_keys_platform_data * pdata ;  struct input_dev * input ;  struct mutex disable_lock ;  unsigned short * keymap ;  struct gpio_button_data data [ 0 ] ; } cocci_id@p ;
...
@@
 struct gpio_button_data {  const struct gpio_keys_button * button ;  struct input_dev * input ;  struct gpio_desc * gpiod ;  unsigned short * code ;  struct timer_list release_timer ;  unsigned int release_delay ;  struct delayed_work work ;  unsigned int software_debounce ;  unsigned int irq ;  unsigned int wakeup_trigger_type ;  spinlock_t lock ;  bool disabled ;  bool key_pressed ;  bool suspended ; } cocci_id@p ;
