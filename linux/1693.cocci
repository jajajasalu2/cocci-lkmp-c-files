...
position p;
@@
 struct max30100_data {  struct i2c_client * client ;  struct iio_dev * indio_dev ;  struct mutex lock ;  struct regmap * regmap ;  __be16 buffer [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct max30100_data * cocci_id@p ;
