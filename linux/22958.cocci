...
position p;
@@
 void cocci_id@p ( struct snd_midi_op * ops , void * drv , struct snd_midi_channel * chan , int note , int vel ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_midi_channel_set * chset ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_midi_op * ops , void * private , struct snd_midi_channel_set * chset , struct snd_midi_channel * chan , int control , int value ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_midi_channel * chan ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_midi_op * ops , void * private , struct snd_midi_channel * chan ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_midi_op * ops , void * private , unsigned char * sysex , int len , struct snd_midi_channel_set * chset ) ;
...
position p;
@@
 void cocci_id@p ( struct snd_midi_op * ops , void * drv , struct snd_midi_channel * chan , struct snd_midi_channel_set * chset ) ;
