...
typedef spinlock_t;
@@
 struct jz4780_i2c {  void __iomem * iomem ;  int irq ;  struct clk * clk ;  struct i2c_adapter adap ;  spinlock_t lock ;  unsigned char * rbuf ;  int rd_total_len ;  int rd_data_xfered ;  int rd_cmd_xfered ;  unsigned char * wbuf ;  int wt_len ;  int is_write ;  int stop_hold ;  int speed ;  int data_buf [ BUFSIZE ] ;  int cmd_buf [ BUFSIZE ] ;  int cmd ;  struct completion trans_waitq ; } cocci_id@p ;
