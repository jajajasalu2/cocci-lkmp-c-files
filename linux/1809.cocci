...
position p;
@@
 const struct {  unsigned int gain ;  unsigned int scale ; } cocci_id@p [ ] ;
...
position p;
@@
 struct zopt2201_data * cocci_id@p ;
...
typedef u8;
@@
 const struct {  unsigned int scale , uscale ;  u8 gain ;  u8 res ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 struct zopt2201_data {  struct i2c_client * client ;  struct mutex lock ;  u8 gain ;  u8 res ;  u8 rate ; } cocci_id@p ;
...
position p;
@@
 const struct {  unsigned int bits ;  unsigned long us ; } cocci_id@p [ ] ;
