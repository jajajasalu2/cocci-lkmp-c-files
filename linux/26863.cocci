...
position p;
@@
 struct poll_table_page {  struct poll_table_page * next ;  struct poll_table_entry * entry ;  struct poll_table_entry entries [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct poll_wqueues * cocci_id@p ;
...
position p;
@@
 struct poll_list * const cocci_id@p ;
...
position p;
@@
 struct poll_table_page * cocci_id@p ;
...
position p;
@@
 enum poll_time_type cocci_id@p ;
...
position p;
@@
 struct poll_list {  struct poll_list * next ;  int len ;  struct pollfd entries [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 long cocci_id@p [ POLL_STACK_ALLOC / sizeof ( long ) ] ;
...
@@
 struct compat_sel_arg_struct {  compat_ulong_t n ;  compat_uptr_t inp ;  compat_uptr_t outp ;  compat_uptr_t exp ;  compat_uptr_t tvp ; } cocci_id@p ;
...
position p;
@@
 struct poll_table_entry * cocci_id@p ;
...
position p;
@@
 long cocci_id@p [ SELECT_STACK_ALLOC / sizeof ( long ) ] ;
...
position p;
@@
 struct sel_arg_struct * cocci_id@p ;
...
position p;
@@
 struct {  unsigned long * in , * out , * ex ;  unsigned long * res_in , * res_out , * res_ex ; } cocci_id@p ;
...
position p;
@@
 enum poll_time_type { PT_TIMEVAL = 0 , PT_OLD_TIMEVAL = 1 , PT_TIMESPEC = 2 , PT_OLD_TIMESPEC = 3 , } cocci_id@p ;
