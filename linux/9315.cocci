...
position p;
@@
 struct wl1271_command cocci_id@p ;
...
position p;
@@
 enum wl1271_tm_commands { WL1271_TM_CMD_UNSPEC , WL1271_TM_CMD_TEST , WL1271_TM_CMD_INTERROGATE , WL1271_TM_CMD_CONFIGURE , WL1271_TM_CMD_NVS_PUSH , WL1271_TM_CMD_SET_PLT_MODE , WL1271_TM_CMD_RECOVER , WL1271_TM_CMD_GET_MAC , __WL1271_TM_CMD_AFTER_LAST , } cocci_id@p ;
...
position p;
@@
 struct wl1271_cmd_cal_p2g * cocci_id@p ;
...
position p;
@@
 enum wl1271_tm_attrs { WL1271_TM_ATTR_UNSPEC , WL1271_TM_ATTR_CMD_ID , WL1271_TM_ATTR_ANSWER , WL1271_TM_ATTR_DATA , WL1271_TM_ATTR_IE_ID , WL1271_TM_ATTR_PLT_MODE , __WL1271_TM_ATTR_AFTER_LAST , } cocci_id@p ;
...
position p;
@@
 struct nla_policy cocci_id@p [ WL1271_TM_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ WL1271_TM_ATTR_MAX + 1 ] ;
