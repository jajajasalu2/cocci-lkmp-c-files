...
typedef bool;
@@
 struct st_nci_i2c_phy {  struct i2c_client * i2c_dev ;  struct llt_ndlc * ndlc ;  bool irq_active ;  struct gpio_desc * gpiod_reset ;  struct st_nci_se_status se_status ; } cocci_id@p ;
...
position p;
@@
 struct st_nci_i2c_phy * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ST_NCI_I2C_MAX_SIZE ] ;
