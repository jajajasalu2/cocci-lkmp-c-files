...
position p;
@@
 void cocci_id@p ( struct bdx_priv * priv ) ;
...
typedef u32,u16;
@@
 void cocci_id@p ( struct rxd_desc * rxdd , u32 rxd_val1 , u16 len , u16 rxd_vlan ) ;
...
position p;
@@
 int cocci_id@p ( struct bdx_priv * priv , struct rxd_fifo * f , int budget ) ;
...
position p;
@@
 void cocci_id@p ( struct bdx_priv * priv , struct rxf_fifo * f ) ;
...
typedef u16;
@@
 struct {  u16 bytes ;  u16 qwords ; } cocci_id@p [ MAX_SKB_FRAGS + 1 ] ;
...
position p;
@@
 void cocci_id@p ( struct bdx_priv * priv , void * data , int size ) ;
...
position p;
@@
 int cocci_id@p ( struct bdx_priv * priv ) ;
...
position p;
@@
 void cocci_id@p ( struct rxf_desc * rxfd ) ;
