...
position p;
@@
 struct kvm_vcpu_init cocci_id@p ;
...
position p;
@@
 struct kvm_arm_device_addr * cocci_id@p ;
...
position p;
@@
 const struct kvm_vcpu_init * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kvm_host_data_t;
@@
 kvm_host_data_t * cocci_id@p ;
