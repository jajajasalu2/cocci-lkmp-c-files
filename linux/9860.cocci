...
position p;
@@
 struct ath_radar_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ FFT_NUM_SAMPLES ] ;
...
position p;
@@
 struct ath9k_dfs_fft_20 * cocci_id@p ;
...
typedef u8;
@@
 struct ath_radar_data {  u8 pulse_bw_info ;  u8 rssi ;  u8 ext_rssi ;  u8 pulse_length_ext ;  u8 pulse_length_pri ; } cocci_id@p ;
...
position p;
@@
 struct ath9k_dfs_fft_40 * cocci_id@p ;
