...
position p;
@@
 struct mpu_rgn_info cocci_id@p ;
...
position p;
@@
 struct machine_desc cocci_id@p ;
...
position p;
@@
 union vdso_data_store cocci_id@p ;
...
position p;
@@
 struct sleep_save_sp cocci_id@p ;
...
position p;
@@
 struct kvm_cpu_context cocci_id@p ;
