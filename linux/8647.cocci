...
typedef u32;
@@
 void cocci_id@p ( struct i40e_info * ldev , struct i40e_client * client , u32 reset_level ) ;
...
position p;
@@
 int cocci_id@p ( struct i40e_info * ldev , struct i40e_client * client , struct i40e_qvlist_info * qvlist_info ) ;
...
typedef bool,u32;
@@
 int cocci_id@p ( struct i40e_info * ldev , struct i40e_client * client , bool is_vf , u32 vf_id , u32 flag , u32 valid_flag ) ;
...
position p;
@@
 struct i40e_client_instance * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 int cocci_id@p ( struct i40e_info * ldev , struct i40e_client * client , u32 vf_id , u8 * msg , u16 len ) ;
