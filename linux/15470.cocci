...
position p;
@@
 struct tsi148_dma_descriptor cocci_id@p ;
...
position p;
@@
 struct vme_dma_pattern * cocci_id@p ;
...
position p;
@@
 struct tsi148_driver * cocci_id@p ;
...
position p;
@@
 struct vme_error_handler * cocci_id@p ;
...
position p;
@@
 struct tsi148_dma_entry cocci_id@p ;
