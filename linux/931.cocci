...
position p;
@@
 struct jz_soc_info {  unsigned long data_offset ;  unsigned long addr_offset ;  unsigned long cmd_offset ;  const struct mtd_ooblayout_ops * oob_layout ; } cocci_id@p ;
...
position p;
@@
 struct ingenic_ecc_params cocci_id@p ;
...
position p;
@@
 struct ingenic_nand_cs {  unsigned int bank ;  void __iomem * base ; } cocci_id@p ;
...
position p;
@@
 struct ingenic_nand cocci_id@p ;
...
position p;
@@
 struct ingenic_nand_cs * cocci_id@p ;
...
position p;
@@
 struct ingenic_nfc {  struct device * dev ;  struct ingenic_ecc * ecc ;  const struct jz_soc_info * soc_info ;  struct nand_controller controller ;  unsigned int num_banks ;  struct list_head chips ;  int selected ;  struct ingenic_nand_cs cs [ ] ; } cocci_id@p ;
...
position p;
@@
 struct ingenic_nand {  struct nand_chip chip ;  struct list_head chip_list ;  struct gpio_desc * busy_gpio ;  struct gpio_desc * wp_gpio ;  unsigned int reading : 1 ; } cocci_id@p ;
