...
position p;
@@
 struct xt_connmark_mtinfo1 cocci_id@p ;
...
position p;
@@
 const struct xt_connmark_tginfo2 cocci_id@p ;
...
position p;
@@
 const struct xt_connmark_tginfo1 * cocci_id@p ;
...
position p;
@@
 struct xt_connmark_tginfo2 cocci_id@p ;
...
position p;
@@
 struct xt_connmark_tginfo1 cocci_id@p ;
...
position p;
@@
 const struct xt_connmark_mtinfo1 * cocci_id@p ;
