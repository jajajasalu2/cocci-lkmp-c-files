...
typedef u8,bool;
@@
 struct bigben_device {  struct hid_device * hid ;  struct hid_report * report ;  u8 led_state ;  u8 right_motor_on ;  u8 left_motor_force ;  struct led_classdev * leds [ NUM_LEDS ] ;  bool work_led ;  bool work_ff ;  struct work_struct worker ; } cocci_id@p ;
...
position p;
@@
 struct bigben_device cocci_id@p ;
