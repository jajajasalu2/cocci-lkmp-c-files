...
typedef u16;
@@
 struct lm4550_reg {  u16 value ;  u16 flag ;  u16 wmask ;  u16 def ; } cocci_id@p ;
...
position p;
@@
 struct snd_pcm_indirect2 * cocci_id@p ;
...
position p;
@@
 struct lm4550_reg cocci_id@p [ 64 ] ;
...
position p;
@@
 struct snd_ml403_ac97cr * cocci_id@p ;
