...
position p;
@@
 struct bcm_sysport_priv cocci_id@p ;
...
position p;
@@
 struct bcm_sysport_net_dim cocci_id@p ;
...
position p;
@@
 struct bcm_sysport_stats64 * cocci_id@p ;
...
position p;
@@
 enum bcm_sysport_stat_type cocci_id@p ;
...
position p;
@@
 struct bcm_sysport_tx_ring * cocci_id@p ;
...
position p;
@@
 const struct bcm_sysport_stats * cocci_id@p ;
...
position p;
@@
 struct bcm_sysport_cb * cocci_id@p ;
...
position p;
@@
 const struct bcm_sysport_hw_params cocci_id@p [ ] ;
