...
typedef u8,u32;
@@
 struct zx2967_i2c {  struct i2c_adapter adap ;  struct clk * clk ;  struct completion complete ;  u32 clk_freq ;  void __iomem * reg_base ;  size_t residue ;  int irq ;  int msg_rd ;  u8 * cur_trans ;  u8 access_cnt ;  int error ; } cocci_id@p ;
