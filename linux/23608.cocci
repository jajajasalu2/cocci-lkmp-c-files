...
typedef u32;
@@
 struct format_flag {  u32 i2s ;  u32 pcm ;  u32 spdif ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 struct port_flag cocci_id@p [ SIU_PORT_NUM ] ;
...
position p;
@@
 struct port_flag {  struct format_flag playback ;  struct format_flag capture ; } cocci_id@p ;
...
position p;
@@
 struct siu_firmware * cocci_id@p ;
