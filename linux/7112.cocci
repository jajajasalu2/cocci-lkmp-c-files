...
position p;
@@
 struct pdc_chassis_lcd_info_ret_block cocci_id@p ;
...
position p;
@@
 struct pdc_chassis_lcd_info_ret_block {  unsigned long model : 16 ;  unsigned long lcd_width : 16 ;  unsigned long lcd_cmd_reg_addr ;  unsigned long lcd_data_reg_addr ;  unsigned int min_cmd_delay ;  unsigned char reset_cmd1 ;  unsigned char reset_cmd2 ;  unsigned char act_enable ;  struct lcd_block heartbeat ;  struct lcd_block disk_io ;  struct lcd_block lan_rcv ;  struct lcd_block lan_tx ;  char _pad ; } cocci_id@p ;
...
position p;
@@
 struct lcd_block {  unsigned char command ;  unsigned char on ;  unsigned char off ; } cocci_id@p ;
