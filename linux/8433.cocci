...
typedef u8,u16;
@@
 u16 cocci_id@p ( struct uli526x_board_info * , u8 , u8 ) ;
...
position p;
@@
 enum uli526x_CR6_bits { CR6_RXSC = 0x2 , CR6_PBF = 0x8 , CR6_PM = 0x40 , CR6_PAM = 0x80 , CR6_FDM = 0x200 , CR6_TXSC = 0x2000 , CR6_STI = 0x100000 , CR6_SFT = 0x200000 , CR6_RXA = 0x40000000 , CR6_NO_PURGE = 0x20000000 , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p ( struct uli526x_board_info * ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct uli526x_board_info * db ) ;
...
position p;
@@
 void cocci_id@p ( struct uli526x_board_info * , struct sk_buff * ) ;
...
position p;
@@
 void cocci_id@p ( struct uli526x_board_info * ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * , struct uli526x_board_info * ) ;
...
position p;
@@
 enum uli526x_offsets { DCR0 = 0x00 , DCR1 = 0x08 , DCR2 = 0x10 , DCR3 = 0x18 , DCR4 = 0x20 , DCR5 = 0x28 , DCR6 = 0x30 , DCR7 = 0x38 , DCR8 = 0x40 , DCR9 = 0x48 , DCR10 = 0x50 , DCR11 = 0x58 , DCR12 = 0x60 , DCR13 = 0x68 , DCR14 = 0x70 , DCR15 = 0x78 , } cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct uli526x_board_info * db , u32 ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct uli526x_board_info * , int ) ;
...
typedef u8,u16;
@@
 void cocci_id@p ( struct uli526x_board_info * , u8 , u8 , u16 ) ;
...
position p;
@@
 struct uli526x_board_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * , void __iomem * ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * , int ) ;
