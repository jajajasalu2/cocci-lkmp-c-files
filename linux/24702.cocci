...
position p;
@@
 struct ip_vs_conn_param cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_mesg cocci_id@p ;
...
position p;
@@
 struct ip_vs_protocol * cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_thread_data * cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_v6 cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ IP_VS_PENAME_MAXLEN + 1 ] ;
...
position p;
@@
 union ipvs_sockaddr * cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_conn_options {  struct ip_vs_seq in_seq ;  struct ip_vs_seq out_seq ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_conn_v0 cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_v4 cocci_id@p ;
...
typedef __be32,__u8;
@@
 struct ip_vs_sync_v4 {  __u8 type ;  __u8 protocol ;  __be16 ver_size ;  __be32 flags ;  __be16 state ;  __be16 cport ;  __be16 vport ;  __be16 dport ;  __be32 fwmark ;  __be32 timeout ;  __be32 caddr ;  __be32 vaddr ;  __be32 daddr ; } cocci_id@p ;
...
position p;
@@
 union ip_vs_sync_conn {  struct ip_vs_sync_v4 v4 ;  struct ip_vs_sync_v6 v6 ; } cocci_id@p ;
...
typedef __be32,__u8;
@@
 struct ip_vs_sync_v6 {  __u8 type ;  __u8 protocol ;  __be16 ver_size ;  __be32 flags ;  __be16 state ;  __be16 cport ;  __be16 vport ;  __be16 dport ;  __be32 fwmark ;  __be32 timeout ;  struct in6_addr caddr ;  struct in6_addr vaddr ;  struct in6_addr daddr ; } cocci_id@p ;
...
position p;
@@
 struct ipvs_master_sync_state cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_conn_options cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_buff cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_thread_data {  struct task_struct * task ;  struct netns_ipvs * ipvs ;  struct socket * sock ;  char * buf ;  int id ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_mesg_v0 * cocci_id@p ;
...
typedef __be32,__u8;
@@
 struct ip_vs_sync_conn_v0 {  __u8 reserved ;  __u8 protocol ;  __be16 cport ;  __be16 vport ;  __be16 dport ;  __be32 caddr ;  __be32 vaddr ;  __be32 daddr ;  __be16 flags ;  __be16 state ; } cocci_id@p ;
...
typedef __u8;
@@
 struct ip_vs_sync_mesg_v0 {  __u8 nr_conns ;  __u8 syncid ;  __be16 size ; } cocci_id@p ;
...
position p;
@@
 union ip_vs_sync_conn * cocci_id@p ;
...
position p;
@@
 union ipvs_sockaddr {  struct sockaddr_in in ;  struct sockaddr_in6 in6 ; } cocci_id@p ;
...
typedef __u16,__u8;
@@
 struct ip_vs_sync_mesg {  __u8 reserved ;  __u8 syncid ;  __be16 size ;  __u8 nr_conns ;  __s8 version ;  __u16 spare ; } cocci_id@p ;
...
position p;
@@
 struct ip_vs_sync_buff {  struct list_head list ;  unsigned long firstuse ;  struct ip_vs_sync_mesg * mesg ;  unsigned char * head ;  unsigned char * end ; } cocci_id@p ;
