...
position p;
@@
 struct acpi_dma_parser_data cocci_id@p ;
...
position p;
@@
 struct acpi_dma_parser_data {  struct acpi_dma_spec dma_spec ;  size_t index ;  size_t n ; } cocci_id@p ;
...
position p;
@@
 struct acpi_csrt_group * cocci_id@p ;
...
position p;
@@
 struct acpi_dma_spec * cocci_id@p ;
...
position p;
@@
 const struct acpi_csrt_shared_info * cocci_id@p ;
...
position p;
@@
 struct acpi_table_csrt * cocci_id@p ;
...
position p;
@@
 struct acpi_dma_filter_info * cocci_id@p ;
...
position p;
@@
 struct dma_chan * ( * cocci_id@p ) ( struct acpi_dma_spec * , struct acpi_dma * ) ;
...
position p;
@@
 struct acpi_csrt_shared_info cocci_id@p ;
...
position p;
@@
 const struct acpi_csrt_group * cocci_id@p ;
