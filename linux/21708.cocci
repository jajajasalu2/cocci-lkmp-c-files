...
position p;
@@
 struct compat_per_struct_kernel * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ NUM_GPRS ] ;
...
position p;
@@
 struct per_struct_kernel * cocci_id@p ;
