...
symbol cocci_id;
position p;
typedef get_stack_trace_t;
@@
 struct get_stack_trace_t cocci_id@p ;
...
position p;
@@
 struct perf_buffer_opts cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u64,get_stack_trace_t;
@@
 struct get_stack_trace_t {  int pid ;  int kern_stack_size ;  int user_stack_size ;  int user_stack_buildid_size ;  __u64 kern_stack [ MAX_STACK_RAWTP ] ;  __u64 user_stack [ MAX_STACK_RAWTP ] ;  struct bpf_stack_build_id user_stack_buildid [ MAX_STACK_RAWTP ] ; } cocci_id@p ;
