...
typedef u32,u16;
@@
 u16 ( * cocci_id@p ) ( struct intf_hdl * pintfhdl , u32 addr ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct adapter * padapter , struct _io_ops * pops ) ;
...
typedef u32;
@@
 u32 ( * cocci_id@p ) ( struct intf_hdl * pintfhdl , u32 addr ) ;
...
typedef u8,u32;
@@
 int ( * cocci_id@p ) ( struct intf_hdl * pintfhdl , u32 addr , u8 val ) ;
...
typedef u8,u32;
@@
 u32 ( * cocci_id@p ) ( struct intf_hdl * pintfhdl , u32 addr , u32 cnt , u8 * pmem ) ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct intf_hdl * pintfhdl , u32 addr , u32 val ) ;
...
typedef u8,u32;
@@
 u8 ( * cocci_id@p ) ( struct intf_hdl * pintfhdl , u32 addr ) ;
...
typedef u32,u16;
@@
 int ( * cocci_id@p ) ( struct intf_hdl * pintfhdl , u32 addr , u16 val ) ;
