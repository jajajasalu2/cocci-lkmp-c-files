...
position p;
@@
 void cocci_id@p ( struct csio_mgmtm * ) ;
...
typedef u8;
@@
 struct t4_vpd_hdr {  u8 id_tag ;  u8 id_len [ 2 ] ;  u8 id_data [ ID_LEN ] ;  u8 vpdr_tag ;  u8 vpdr_len [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct csio_evt_msg cocci_id@p ;
...
position p;
@@
 enum csio_dev_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct csio_hw * hw ) ;
...
position p;
@@
 void cocci_id@p ( struct csio_hw * , enum csio_hw_ev ) ;
...
position p;
@@
 void cocci_id@p ( struct csio_hw * ) ;
...
position p;
@@
 struct csio_fcoe_res_info * cocci_id@p ;
...
position p;
@@
 const struct t4_vpd_hdr * cocci_id@p ;
...
position p;
@@
 const struct csio_adap_desc cocci_id@p [ ] ;
...
position p;
@@
 struct csio_fl_dma_buf * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ SF_PAGE_SIZE ] ;
...
typedef u32;
@@
 union {  u32 word ;  char buf [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct fw_fcoe_res_info_cmd * cocci_id@p ;
