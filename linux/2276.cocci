...
position p;
@@
 struct avs_tmon_trip cocci_id@p [ ] ;
...
position p;
@@
 enum avs_tmon_trip_type cocci_id@p ;
...
position p;
@@
 struct brcmstb_thermal_priv * cocci_id@p ;
...
typedef u32;
@@
 struct avs_tmon_trip {  u32 enable_offs ;  u32 enable_mask ;  u32 reg_offs ;  u32 reg_msk ;  int reg_shift ; } cocci_id@p ;
...
position p;
@@
 enum avs_tmon_trip_type { TMON_TRIP_TYPE_LOW = 0 , TMON_TRIP_TYPE_HIGH , TMON_TRIP_TYPE_RESET , TMON_TRIP_TYPE_MAX , } cocci_id@p ;
...
position p;
@@
 struct brcmstb_thermal_priv {  void __iomem * tmon_base ;  struct device * dev ;  struct thermal_zone_device * thermal ; } cocci_id@p ;
