...
position p;
@@
 const struct reg_entry * cocci_id@p ;
...
position p;
@@
 struct reg_entry {  unsigned long offset ;  unsigned long value ; } cocci_id@p ;
...
position p;
@@
 struct tegra_rgb {  struct tegra_output output ;  struct tegra_dc * dc ;  struct clk * clk_parent ;  struct clk * clk ; } cocci_id@p ;
