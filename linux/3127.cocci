...
position p;
@@
 struct drbd_plug_cb {  struct blk_plug_cb cb ;  struct drbd_request * most_recent_req ; } cocci_id@p ;
...
position p;
@@
 enum drbd_on_congestion cocci_id@p ;
...
position p;
@@
 const union drbd_dev_state cocci_id@p ;
...
position p;
@@
 struct drbd_plug_cb cocci_id@p ;
...
position p;
@@
 enum drbd_read_balancing cocci_id@p ;
