...
@@
 struct iuu_private {  spinlock_t lock ;  u8 line_status ;  int tiostatus ;  u8 reset ;  int poll ;  u8 * writebuf ;  int writelen ;  u8 * buf ;  u8 len ;  int vcc ;  u32 boost ;  u32 clk ; } cocci_id@p ;
