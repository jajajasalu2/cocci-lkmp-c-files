...
position p;
@@
 unsigned int cocci_id@p ( struct bitstr * bs , int b ) ;
...
typedef field_t;
@@
 const struct field_t * cocci_id@p ;
...
typedef field_t;
@@
 int cocci_id@p ( struct bitstr * bs , const struct field_t * f , char * base , int level ) ;
...
position p;
@@
 unsigned int cocci_id@p ( struct bitstr * bs , unsigned int b ) ;
...
typedef field_t;
@@
 struct field_t { #if H323_TRACE  char * name ; #endif  unsigned char type ;  unsigned char sz ;  unsigned char lb ;  unsigned char ub ;  unsigned short attr ;  unsigned short offset ;  const struct field_t * fields ; } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct bitstr * bs ) ;
...
position p;
@@
 H323_UserInformation * cocci_id@p ;
...
position p;
@@
 struct bitstr {  unsigned char * buf ;  unsigned char * beg ;  unsigned char * end ;  unsigned char * cur ;  unsigned int bit ; } cocci_id@p ;
...
typedef field_t;
@@
 int ( * cocci_id@p ) ( struct bitstr * , const struct field_t * , char * , int ) ;
