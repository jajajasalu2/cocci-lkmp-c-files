...
typedef u32;
@@
 u32 cocci_id@p [ DP_AUX_MAX_PAYLOAD_BYTES / sizeof ( u32 ) ] ;
...
typedef u8,bool;
@@
 struct tc_edp_link {  u8 dpcd [ DP_RECEIVER_CAP_SIZE ] ;  unsigned int rate ;  u8 num_lanes ;  u8 assr ;  bool scrambler_dis ;  bool spread ; } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct tc_data {  struct device * dev ;  struct regmap * regmap ;  struct drm_dp_aux aux ;  struct drm_bridge bridge ;  struct drm_connector connector ;  struct drm_panel * panel ;  struct tc_edp_link link ;  struct edid * edid ;  struct drm_display_mode mode ;  u32 rev ;  u8 assr ;  struct gpio_desc * sd_gpio ;  struct gpio_desc * reset_gpio ;  struct clk * refclk ;  bool have_irq ;  int hpd_pin ; } cocci_id@p ;
