...
position p;
@@
 struct mxs_auart_port * cocci_id@p ;
...
typedef u16;
@@
 struct vendor_data {  const u16 * reg_offset ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mxs_auart_port * s ) ;
...
position p;
@@
 enum mxs_auart_type { IMX23_AUART , IMX28_AUART , ASM9260_AUART , } cocci_id@p ;
...
position p;
@@
 enum { REG_CTRL0 , REG_CTRL1 , REG_CTRL2 , REG_LINECTRL , REG_LINECTRL2 , REG_INTR , REG_DATA , REG_STAT , REG_DEBUG , REG_VERSION , REG_AUTOBAUD , REG_ARRAY_SIZE , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mxs_auart_port * s ) ;
...
position p;
@@
 const struct mxs_auart_port * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct uart_port * u ) ;
...
position p;
@@
 struct mxs_auart_port * cocci_id@p [ MXS_AUART_PORTS ] ;
...
position p;
@@
 enum mctrl_gpio_idx cocci_id@p ;
