...
position p;
@@
 struct cs4270_mode_ratios cocci_id@p [ ] ;
...
position p;
@@
 struct cs4270_private {  struct regmap * regmap ;  unsigned int mclk ;  unsigned int mode ;  unsigned int slave_mode ;  unsigned int manual_mute ;  struct regulator_bulk_data supplies [ ARRAY_SIZE ( supply_names ) ] ; } cocci_id@p ;
...
position p;
@@
 struct cs4270_private cocci_id@p ;
...
typedef u8;
@@
 struct cs4270_mode_ratios {  unsigned int ratio ;  u8 speed_mode ;  u8 mclk ; } cocci_id@p ;
