...
position p;
@@
 struct drm_i915_mocs_table cocci_id@p ;
...
position p;
@@
 struct drm_i915_mocs_table {  unsigned int size ;  unsigned int n_entries ;  const struct drm_i915_mocs_entry * table ; } cocci_id@p ;
...
position p;
@@
 const struct drm_i915_mocs_entry cocci_id@p [ ] ;
...
position p;
@@
 const struct drm_i915_mocs_table * cocci_id@p ;
...
typedef u32,u16;
@@
 struct drm_i915_mocs_entry {  u32 control_value ;  u16 l3cc_value ;  u16 used ; } cocci_id@p ;
