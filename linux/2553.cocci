...
position p;
@@
 struct dm_deferred_set * cocci_id@p ;
...
@@
 struct dm_bio_prison {  spinlock_t lock ;  struct rb_root cells ;  mempool_t cell_pool ; } cocci_id@p ;
...
position p;
@@
 struct dm_deferred_entry * cocci_id@p ;
...
position p;
@@
 struct dm_bio_prison * cocci_id@p ;
...
position p;
@@
 struct dm_deferred_entry {  struct dm_deferred_set * ds ;  unsigned count ;  struct list_head work_items ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct dm_deferred_set {  spinlock_t lock ;  unsigned current_entry ;  unsigned sweeper ;  struct dm_deferred_entry entries [ DEFERRED_SET_SIZE ] ; } cocci_id@p ;
