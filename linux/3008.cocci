...
position p;
@@
 struct acpi_video_bus cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct acpi_video_bus * video ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct acpi_video_device * device , u32 level_current , u32 event ) ;
...
position p;
@@
 void cocci_id@p ( struct acpi_video_bus * video , struct acpi_video_device * device ) ;
...
typedef u8;
@@
 struct acpi_video_device_flags {  u8 crt : 1 ;  u8 lcd : 1 ;  u8 tvout : 1 ;  u8 dvi : 1 ;  u8 bios : 1 ;  u8 unknown : 1 ;  u8 notify : 1 ;  u8 reserved : 1 ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct acpi_video_bus * video ) ;
...
symbol cocci_id;
position p;
typedef u32,acpi_handle;
@@
 void cocci_id@p ( acpi_handle handle , u32 event , void * data ) ;
...
typedef u32;
@@
 struct acpi_video_enumerated_device {  union {  u32 int_val ;  struct acpi_video_device_attrib attrib ; } value ;  struct acpi_video_device * bind_info ; } cocci_id@p ;
...
typedef u8;
@@
 struct acpi_video_bus_cap {  u8 _DOS : 1 ;  u8 _DOD : 1 ;  u8 _ROM : 1 ;  u8 _GPD : 1 ;  u8 _SPD : 1 ;  u8 _VPO : 1 ;  u8 reserved : 2 ; } cocci_id@p ;
...
position p;
@@
 struct acpi_video_enumerated_device cocci_id@p ;
...
position p;
@@
 struct acpi_video_device_brightness * * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct acpi_device * device ) ;
...
typedef u8;
@@
 struct acpi_video_device_cap {  u8 _ADR : 1 ;  u8 _BCL : 1 ;  u8 _BCM : 1 ;  u8 _BQC : 1 ;  u8 _BCQ : 1 ;  u8 _DDC : 1 ; } cocci_id@p ;
...
position p;
@@
 struct acpi_video_device * cocci_id@p ;
...
position p;
@@
 enum acpi_video_level_idx { ACPI_VIDEO_AC_LEVEL , ACPI_VIDEO_BATTERY_LEVEL , ACPI_VIDEO_FIRST_LEVEL , } cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct acpi_device * device , u32 event ) ;
...
position p;
@@
 struct thermal_cooling_device * cocci_id@p ;
...
position p;
@@
 struct acpi_video_device_attrib * cocci_id@p ;
...
typedef u32;
@@
 struct acpi_video_device_attrib {  u32 display_index : 4 ;  u32 display_port_attachment : 4 ;  u32 display_type : 4 ;  u32 vendor_specific : 4 ;  u32 bios_can_detect : 1 ;  u32 depend_on_vga : 1 ;  u32 pipe_id : 3 ;  u32 reserved : 10 ;  u32 device_id_scheme : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct thermal_cooling_device_ops cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct acpi_video_device * device , unsigned long long * level , bool raw ) ;
...
position p;
@@
 int cocci_id@p ( struct acpi_video_device * device , int level ) ;
...
typedef u8;
@@
 struct acpi_video_bus_flags {  u8 multihead : 1 ;  u8 rom : 1 ;  u8 post : 1 ;  u8 reserved : 5 ; } cocci_id@p ;
