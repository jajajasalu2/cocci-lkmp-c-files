...
position p;
@@
 struct compressor_entry * cocci_id@p ;
...
@@
 struct sock_fprog32 {  unsigned short len ;  compat_caddr_t filter ; } cocci_id@p ;
...
position p;
@@
 struct compressor * cocci_id@p ( int type ) ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,refcount_t;
@@
 struct ppp_file {  enum { INTERFACE = 1 , CHANNEL , } kind ;  struct sk_buff_head xq ;  struct sk_buff_head rq ;  wait_queue_head_t rwait ;  refcount_t refcnt ;  int hdrlen ;  int index ;  int dead ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,compat_uptr_t,compat_int_t;
@@
 struct ppp_option_data32 {  compat_uptr_t ptr ;  u32 length ;  compat_int_t transmit ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct idr * p , int n ) ;
...
position p;
@@
 void cocci_id@p ( struct ppp * ppp , struct sk_buff * skb , struct channel * pch ) ;
...
position p;
@@
 int cocci_id@p ( struct ppp * ppp , struct sk_buff * skb ) ;
...
position p;
@@
 struct sk_buff * cocci_id@p ( struct ppp * ppp , struct sk_buff * skb ) ;
...
position p;
@@
 void cocci_id@p ( struct ppp * ppp , struct ppp_stats * st ) ;
...
position p;
@@
 const struct ppp_config * cocci_id@p ;
...
typedef u8,u32;
@@
 struct ppp_mp_skb_parm {  u32 sequence ;  u8 BEbits ; } cocci_id@p ;
...
position p;
@@
 struct ppp_mp_skb_parm * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net * net , struct ppp_file * pf , struct file * file , unsigned int cmd , unsigned long arg ) ;
...
position p;
@@
 struct ppp * cocci_id@p ( struct ppp_net * pn , int unit ) ;
...
position p;
@@
 struct ppp_option_data cocci_id@p ;
...
typedef spinlock_t;
@@
 struct ppp_net {  struct idr units_idr ;  struct mutex all_ppp_mutex ;  struct list_head all_channels ;  struct list_head new_channels ;  int last_channel_index ;  spinlock_t all_channels_lock ; } cocci_id@p ;
...
position p;
@@
 struct sk_buff * cocci_id@p ( struct ppp * ppp ) ;
...
position p;
@@
 int cocci_id@p ( struct ppp * ppp , struct ppp_option_data * data ) ;
...
position p;
@@
 int cocci_id@p ( struct idr * p , void * ptr , int n ) ;
...
position p;
@@
 void cocci_id@p ( struct channel * pch ) ;
...
position p;
@@
 struct ppp_option_data32 cocci_id@p ;
...
position p;
@@
 struct sock_fprog32 cocci_id@p ;
...
typedef u64;
@@
 struct ppp_link_stats {  u64 rx_packets ;  u64 tx_packets ;  u64 rx_bytes ;  u64 tx_bytes ; } cocci_id@p ;
...
position p;
@@
 struct ppp_comp_stats cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ppp * ppp , struct sk_buff * skb ) ;
...
position p;
@@
 struct compressor_entry {  struct list_head list ;  struct compressor * comp ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net * net , struct file * file , int * unit ) ;
...
position p;
@@
 void cocci_id@p ( struct ppp * ppp , struct sk_buff * skb , int inbound ) ;
...
position p;
@@
 void cocci_id@p ( struct ppp_file * pf , int kind ) ;
...
position p;
@@
 struct channel * cocci_id@p ( struct ppp_net * pn , int unit ) ;
...
position p;
@@
 int cocci_id@p ( struct channel * pch , int unit ) ;
...
position p;
@@
 void cocci_id@p ( struct ppp * ppp ) ;
...
position p;
@@
 struct sock_fprog_kern cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct channel * pch ) ;
...
position p;
@@
 int cocci_id@p ( struct idr * p , void * ptr ) ;
...
typedef s32,bool;
@@
 struct ppp_config {  struct file * file ;  s32 unit ;  bool ifname_is_set ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ CCP_MAX_OPTION_LENGTH ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_PPP_MAX + 1 ] ;
