...
typedef __be32;
@@
 union l2tp_val {  __be16 val16 [ 2 ] ;  __be32 val32 ; } cocci_id@p ;
...
position p;
@@
 struct xt_l2tp_info cocci_id@p ;
...
position p;
@@
 const struct xt_l2tp_info * cocci_id@p ;
...
typedef u8,u32;
@@
 struct l2tp_data {  u32 tid ;  u32 sid ;  u8 type ;  u8 version ; } cocci_id@p ;
