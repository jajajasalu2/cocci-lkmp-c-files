...
symbol cocci_id;
position p;
typedef trace_func_graph_ret_t;
@@
 trace_func_graph_ret_t cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p ( unsigned long frame_pointer ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned long , unsigned long , struct ftrace_ops * , struct pt_regs * ) ;
