...
position p;
@@
 struct adv7343_state * cocci_id@p ;
...
typedef u8,u32;
@@
 struct adv7343_state {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  const struct adv7343_platform_data * pdata ;  u8 reg00 ;  u8 reg01 ;  u8 reg02 ;  u8 reg35 ;  u8 reg80 ;  u8 reg82 ;  u32 output ;  v4l2_std_id std ; } cocci_id@p ;
...
position p;
@@
 struct adv7343_std_info * cocci_id@p ;
...
position p;
@@
 const struct adv7343_std_info cocci_id@p [ ] ;
