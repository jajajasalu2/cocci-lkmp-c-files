...
position p;
@@
 enum { CT_VGA , CT_NONE , CT_RGB , CT_COMPOSITE , } cocci_id@p ;
...
position p;
@@
 enum { PAL_ARGB1555 , PAL_RGB565 , PAL_ARGB4444 , PAL_ARGB8888 , } cocci_id@p ;
...
typedef u32;
@@
 struct pvr2fb_par {  unsigned int hsync_total ;  unsigned int vsync_total ;  unsigned int borderstart_h ;  unsigned int borderstop_h ;  unsigned int borderstart_v ;  unsigned int borderstop_v ;  unsigned int diwstart_h ;  unsigned int diwstart_v ;  unsigned long disp_start ;  unsigned char is_interlaced ;  unsigned char is_doublescan ;  unsigned char is_lowres ;  void __iomem * mmio_base ;  u32 palette [ 16 ] ; } * cocci_id@p ;
...
position p;
@@
 enum { VO_PAL , VO_NTSC , VO_VGA , } cocci_id@p ;
...
position p;
@@
 const struct pvr2_params * cocci_id@p ;
...
position p;
@@
 struct pvr2_params {  unsigned int val ;  char * name ; } cocci_id@p ;
