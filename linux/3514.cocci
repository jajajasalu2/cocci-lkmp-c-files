...
position p;
@@
 struct variant_data cocci_id@p ;
...
position p;
@@
 struct mmci_dmae_next {  struct dma_async_tx_descriptor * desc ;  struct dma_chan * chan ; } cocci_id@p ;
...
position p;
@@
 struct mmci_host_ops cocci_id@p ;
...
position p;
@@
 struct mmci_dmae_priv {  struct dma_chan * cur ;  struct dma_chan * rx_channel ;  struct dma_chan * tx_channel ;  struct dma_async_tx_descriptor * desc_current ;  struct mmci_dmae_next next_data ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mmci_host * host ) ;
...
position p;
@@
 struct mmci_platform_data * cocci_id@p ;
...
position p;
@@
 struct mmci_dmae_next * cocci_id@p ;
...
position p;
@@
 struct mmci_dmae_priv * cocci_id@p ;
