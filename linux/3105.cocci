...
position p;
@@
 struct virtio_blk_vq * cocci_id@p ;
...
position p;
@@
 struct virtio_blk {  struct virtio_device * vdev ;  struct gendisk * disk ;  struct blk_mq_tag_set tag_set ;  struct work_struct config_work ;  unsigned int sg_elems ;  int index ;  int num_vqs ;  struct virtio_blk_vq * vqs ; } cocci_id@p ;
...
position p;
@@
 struct virtio_blk_config cocci_id@p ;
...
position p;
@@
 struct virtio_blk_discard_write_zeroes * cocci_id@p ;
