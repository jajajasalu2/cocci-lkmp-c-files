...
position p;
@@
 struct npc_kpu_action1 cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ NPC_MAX_NONCONTIG_ENTRIES ] ;
...
position p;
@@
 struct npc_mcam_alloc_counter_rsp cocci_id@p ;
...
position p;
@@
 struct npc_kpu_action0 cocci_id@p ;
...
position p;
@@
 struct npc_mcam_ena_dis_entry_req * cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct rvu * rvu , struct npc_mcam * mcam , u16 pcifunc ) ;
...
position p;
@@
 struct npc_kpu_profile_action * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_unmap_counter_req * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_shift_entry_rsp * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_oper_counter_rsp * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_shift_entry_req * cocci_id@p ;
...
position p;
@@
 struct npc_get_kex_cfg_rsp * cocci_id@p ;
...
position p;
@@
 struct npc_kpu_profile * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_alloc_and_write_entry_req * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_oper_counter_req * cocci_id@p ;
...
position p;
@@
 struct nix_rx_action cocci_id@p ;
...
position p;
@@
 struct npc_mcam_kex cocci_id@p ;
...
position p;
@@
 struct npc_mcam_alloc_counter_req * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_alloc_and_write_entry_rsp * cocci_id@p ;
...
position p;
@@
 struct npc_kpu_profile_cam * cocci_id@p ;
...
position p;
@@
 struct npc_mcam_write_entry_req * cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct rvu * rvu , struct npc_mcam * mcam , int blkaddr , u16 pcifunc ) ;
