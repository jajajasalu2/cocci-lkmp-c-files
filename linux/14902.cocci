...
position p;
@@
 enum xgene_pll_type { PLL_TYPE_PCP = 0 , PLL_TYPE_SOC = 1 , } cocci_id@p ;
...
position p;
@@
 struct xgene_clk_pll cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,u32,spinlock_t;
@@
 struct xgene_clk_pmd {  struct clk_hw hw ;  void __iomem * reg ;  u8 shift ;  u32 mask ;  u64 denom ;  u32 flags ;  spinlock_t * lock ; } cocci_id@p ;
...
position p;
@@
 struct xgene_clk_pmd cocci_id@p ;
...
position p;
@@
 struct xgene_dev_parameters cocci_id@p ;
...
@@
 struct xgene_clk_pll {  struct clk_hw hw ;  void __iomem * reg ;  spinlock_t * lock ;  u32 pll_offset ;  enum xgene_pll_type type ;  int version ; } cocci_id@p ;
...
typedef u32;
@@
 struct xgene_dev_parameters {  void __iomem * csr_reg ;  u32 reg_clk_offset ;  u32 reg_clk_mask ;  u32 reg_csr_offset ;  u32 reg_csr_mask ;  void __iomem * divider_reg ;  u32 reg_divider_offset ;  u32 reg_divider_shift ;  u32 reg_divider_width ; } cocci_id@p ;
...
position p;
@@
 enum xgene_pll_type cocci_id@p ;
...
typedef spinlock_t;
@@
 struct xgene_clk {  struct clk_hw hw ;  spinlock_t * lock ;  struct xgene_dev_parameters param ; } cocci_id@p ;
