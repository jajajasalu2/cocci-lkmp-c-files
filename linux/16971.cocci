...
position p;
@@
 struct cy8ctmg110 {  struct input_dev * input ;  char phys [ 32 ] ;  struct i2c_client * client ;  int reset_pin ;  int irq_pin ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ CY8CTMG110_REG_MAX ] ;
...
position p;
@@
 const struct cy8ctmg110_pdata * cocci_id@p ;
