...
position p;
@@
 struct sms_version_res * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smscore_idlist_t;
@@
 struct smscore_idlist_t * cocci_id@p ;
...
typedef smscore_idlist_t;
@@
 struct smscore_idlist_t {  struct list_head entry ;  int id ;  int data_type ; } cocci_id@p ;
...
position p;
@@
 struct sms_msg_data * cocci_id@p ;
...
position p;
@@
 struct smscore_config_gpio * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smscore_client_t;
@@
 struct smscore_client_t * * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smsclient_params_t;
@@
 struct smsclient_params_t * cocci_id@p ;
...
position p;
@@
 struct sms_msg_data4 * cocci_id@p ;
...
position p;
@@
 struct sms_firmware * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smscore_buffer_t;
@@
 struct smscore_buffer_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smscore_device_notifyee_t;
@@
 struct smscore_device_notifyee_t * cocci_id@p ;
...
position p;
@@
 enum sms_device_type_st cocci_id@p ;
...
position p;
@@
 struct sms_msg_data2 * cocci_id@p ;
...
typedef u32;
@@
 struct set_gpio_msg {  struct sms_msg_hdr x_msg_header ;  u32 msg_data [ 6 ] ; } * cocci_id@p ;
...
typedef u32;
@@
 struct set_gpio_msg {  struct sms_msg_hdr x_msg_header ;  u32 msg_data [ 3 ] ; } * cocci_id@p ;
...
position p;
@@
 struct set_gpio_msg * cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ ] [ DEVICE_MODE_MAX ] ;
...
typedef u32;
@@
 struct {  struct sms_msg_hdr hdr ;  u32 data [ 3 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smsdevice_params_t;
@@
 struct smsdevice_params_t * cocci_id@p ;
...
typedef u32;
@@
 struct set_gpio_msg {  struct sms_msg_hdr x_msg_header ;  u32 msg_data [ 2 ] ; } * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef loadfirmware_t;
@@
 loadfirmware_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef hotplug_t,smscore_device_notifyee_t;
@@
 struct smscore_device_notifyee_t {  struct list_head entry ;  hotplug_t hotplug ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smscore_device_t;
@@
 struct smscore_device_t * * cocci_id@p ;
...
position p;
@@
 struct sms_data_download * cocci_id@p ;
...
typedef u32;
@@
 struct {  struct sms_msg_hdr hdr ;  u32 data [ 6 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef onremove_t,smscore_client_t,smscore_device_t,onresponse_t;
@@
 struct smscore_client_t {  struct list_head entry ;  struct smscore_device_t * coredev ;  void * context ;  struct list_head idlist ;  onresponse_t onresponse_handler ;  onremove_t onremove_handler ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smscore_registry_entry_t;
@@
 struct smscore_registry_entry_t {  struct list_head entry ;  char devpath [ 32 ] ;  int mode ;  enum sms_device_type_st type ; } cocci_id@p ;
...
typedef smscore_registry_entry_t;
@@
 struct smscore_registry_entry_t * cocci_id@p ;
