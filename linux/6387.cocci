...
position p;
@@
 const struct chg_reg_data * cocci_id@p ;
...
position p;
@@
 struct chg_reg_data {  unsigned int linear_reg ;  unsigned int linear_mask ;  unsigned int uA_step ;  unsigned int min_sel ; } cocci_id@p ;
...
position p;
@@
 enum max77693_types cocci_id@p ;
...
position p;
@@
 enum max77843_regulator_type { MAX77843_SAFEOUT1 = 0 , MAX77843_SAFEOUT2 , MAX77843_CHARGER , MAX77843_NUM , } cocci_id@p ;
