...
position p;
@@
 struct enic_intr_mod_table cocci_id@p [ ENIC_MAX_COALESCE_TIMERS + 1 ] ;
...
position p;
@@
 struct enic_rx_coal * cocci_id@p ;
...
position p;
@@
 struct enic_intr_mod_range cocci_id@p [ ENIC_MAX_LINK_SPEEDS ] ;
...
position p;
@@
 struct enic_port_profile cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct vnic_dev * , int * ) ;
...
position p;
@@
 struct vnic_rx_bytes_counter * cocci_id@p ;
