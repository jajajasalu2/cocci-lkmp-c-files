...
position p;
@@
 int cocci_id@p ( struct pcmcia_device * ) ;
...
position p;
@@
 void cocci_id@p ( struct pcmcia_device * ) ;
...
typedef ide_info_t;
@@
 struct ide_info_t {  struct pcmcia_device * p_dev ;  struct ide_host * host ;  int ndev ; } cocci_id@p ;
