...
position p;
@@
 const enum irq_type cocci_id@p ;
...
position p;
@@
 struct irq_list_head cocci_id@p ;
...
position p;
@@
 struct amdgpu_dm_irq_handler_data cocci_id@p ;
...
position p;
@@
 const struct dc_interrupt_params * cocci_id@p ;
...
position p;
@@
 struct amdgpu_dm_irq_handler_data {  struct list_head list ;  interrupt_handler handler ;  void * handler_arg ;  struct amdgpu_display_manager * dm ;  enum dc_irq_source irq_source ; } cocci_id@p ;
