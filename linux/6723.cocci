...
position p;
@@
 struct amap_pdu_base cocci_id@p ;
...
position p;
@@
 struct beiscsi_session * cocci_id@p ;
...
position p;
@@
 struct mgmt_conn_info * cocci_id@p ;
...
position p;
@@
 struct amap_sol_cqe_v2 cocci_id@p ;
...
position p;
@@
 struct hd_async_handle cocci_id@p ;
...
position p;
@@
 struct common_sol_cqe cocci_id@p ;
...
position p;
@@
 struct be_set_eqd cocci_id@p [ MAX_CPUS ] ;
...
position p;
@@
 struct beiscsi_offload_params * cocci_id@p ;
...
position p;
@@
 struct amap_eq_entry cocci_id@p ;
...
position p;
@@
 struct beiscsi_endpoint * cocci_id@p ;
...
position p;
@@
 struct hwi_controller cocci_id@p ;
...
position p;
@@
 struct i_t_dpdu_cqe * cocci_id@p ;
...
position p;
@@
 struct iscsi_bsg_reply * cocci_id@p ;
...
position p;
@@
 struct be_mem_descriptor * cocci_id@p ;
...
position p;
@@
 struct hwi_context_memory cocci_id@p ;
...
position p;
@@
 struct pdu_data_out * cocci_id@p ;
...
position p;
@@
 struct iscsi_bsg_request * cocci_id@p ;
...
position p;
@@
 struct amap_pdu_data_out cocci_id@p ;
...
position p;
@@
 struct iscsi_target_context_update_wrb cocci_id@p ;
...
position p;
@@
 struct be_status_bhs * cocci_id@p ;
...
position p;
@@
 struct iscsi_logout_rsp * cocci_id@p ;
...
typedef uint16_t;
@@
 uint16_t cocci_id@p [ BEISCSI_ULP_COUNT ] ;
...
position p;
@@
 struct mgmt_session_info * cocci_id@p ;
...
position p;
@@
 struct beiscsi_conn * cocci_id@p ;
...
position p;
@@
 struct be_bus_address cocci_id@p ;
...
position p;
@@
 struct be_nonio_bhs cocci_id@p ;
...
position p;
@@
 struct hwi_wrb_context * * cocci_id@p ;
...
position p;
@@
 struct beiscsi_io_task * cocci_id@p ;
...
position p;
@@
 struct amap_i_t_dpdu_cqe cocci_id@p ;
...
position p;
@@
 struct amap_it_dmsg_cqe cocci_id@p ;
...
position p;
@@
 struct amap_iscsi_wrb_v2 cocci_id@p ;
...
position p;
@@
 struct amap_i_t_dpdu_cqe_v2 cocci_id@p ;
...
position p;
@@
 struct amap_iscsi_sge cocci_id@p ;
...
position p;
@@
 struct amap_pdu_nop_out cocci_id@p ;
...
position p;
@@
 struct amap_it_dmsg_cqe_v2 cocci_id@p ;
...
position p;
@@
 struct hd_async_entry cocci_id@p ;
...
position p;
@@
 struct amap_iscsi_wrb cocci_id@p ;
...
position p;
@@
 struct hd_async_context cocci_id@p ;
...
position p;
@@
 struct ulp_cid_info * cocci_id@p ;
...
position p;
@@
 struct invldt_cmd_tbl cocci_id@p ;
...
position p;
@@
 struct beiscsi_invldt_cmd_tbl {  struct invldt_cmd_tbl tbl [ BE_INVLDT_CMD_TBL_SZ ] ;  struct iscsi_task * task [ BE_INVLDT_CMD_TBL_SZ ] ; } * cocci_id@p ;
...
position p;
@@
 struct iscsi_tm_rsp * cocci_id@p ;
...
position p;
@@
 struct cri_wait_queue * cocci_id@p ;
...
position p;
@@
 struct be_ctrl_info * cocci_id@p ;
...
position p;
@@
 struct amap_sol_cqe cocci_id@p ;
...
position p;
@@
 struct hba_parameters * cocci_id@p ;
