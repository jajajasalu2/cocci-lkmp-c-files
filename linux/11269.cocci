...
symbol cocci_id;
position p;
typedef mrst_clock_t;
@@
 struct mrst_clock_t {  int dot ;  int m ;  int p1 ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mrst_limit_t;
@@
 const struct mrst_limit_t * cocci_id@p ;
...
typedef mrst_clock_t;
@@
 struct mrst_clock_t cocci_id@p ;
