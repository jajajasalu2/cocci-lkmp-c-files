...
position p;
@@
 struct static_key_deferred cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ KVM_APIC_LVT_NUM ] ;
...
position p;
@@
 int cocci_id@p ( struct kvm_lapic * apic , int delivery_mode , int vector , int level , int trig_mode , struct dest_map * dest_map ) ;
