...
position p;
@@
 void cocci_id@p ( char * , struct pt_regs * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct frame * fp ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long , int , int ) ;
...
position p;
@@
 int cocci_id@p ( struct pt_regs * regs , unsigned long address , unsigned long error_code ) ;
