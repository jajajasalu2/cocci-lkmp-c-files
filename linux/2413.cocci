...
position p;
@@
 struct page * cocci_id@p [ MV_XOR_NUM_SRC_TEST ] ;
...
position p;
@@
 struct mv_xor_channel_data * cocci_id@p ;
...
position p;
@@
 struct mv_xor_desc_slot cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dma_chan * chan ) ;
...
typedef dma_addr_t;
@@
 dma_addr_t cocci_id@p [ MV_XOR_NUM_SRC_TEST ] ;
...
position p;
@@
 enum mv_xor_mode { XOR_MODE_IN_REG , XOR_MODE_IN_DESC , } cocci_id@p ;
...
position p;
@@
 enum mv_xor_type { XOR_ORION , XOR_ARMADA_38X , XOR_ARMADA_37XX , } cocci_id@p ;
...
position p;
@@
 struct mv_xor_device * cocci_id@p ;
...
position p;
@@
 struct mv_xor_platform_data * cocci_id@p ;
