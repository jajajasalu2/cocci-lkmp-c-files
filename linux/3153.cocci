...
position p;
@@
 enum chips { max16065 , max16066 , max16067 , max16068 , max16070 , max16071 , } cocci_id@p ;
...
position p;
@@
 struct max16065_data * cocci_id@p ;
...
typedef bool;
@@
 struct max16065_data {  enum chips type ;  struct i2c_client * client ;  const struct attribute_group * groups [ 4 ] ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  int num_adc ;  bool have_current ;  int curr_gain ;  int limit [ MAX16065_NUM_LIMIT ] [ MAX16065_NUM_ADC ] ;  int range [ MAX16065_NUM_ADC + 1 ] ;  int adc [ MAX16065_NUM_ADC + 1 ] ;  int curr_sense ;  int fault [ 2 ] ; } cocci_id@p ;
