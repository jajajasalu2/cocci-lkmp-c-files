...
position p;
@@
 struct fcnvme_lsdesc_cr_assoc_cmd cocci_id@p ;
...
position p;
@@
 struct nvme_fc_queue * cocci_id@p ;
...
position p;
@@
 struct nvme_fc_fcp_op cocci_id@p ;
...
position p;
@@
 struct nvmefc_ls_req * cocci_id@p ;
...
position p;
@@
 struct nvme_fc_local_port * cocci_id@p ;
...
position p;
@@
 struct fcnvme_ls_cr_conn_acc cocci_id@p ;
...
typedef bool,u32;
@@
 struct nvmefc_ls_req_op {  struct nvmefc_ls_req ls_req ;  struct nvme_fc_rport * rport ;  struct nvme_fc_queue * queue ;  struct request * rq ;  u32 flags ;  int ls_error ;  struct completion ls_done ;  struct list_head lsreq_list ;  bool req_queued ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ 2 + NVME_FC_TRADDR_HEXNAMELEN + 1 ] ;
...
position p;
@@
 struct nvme_fc_port_template * cocci_id@p ;
...
position p;
@@
 struct fcnvme_lsdesc_rqst cocci_id@p ;
...
position p;
@@
 struct nvmet_fc_traddr cocci_id@p ;
...
position p;
@@
 struct nvme_command cocci_id@p ;
...
position p;
@@
 struct nvme_fcp_op_w_sgl * cocci_id@p ;
...
position p;
@@
 struct nvme_fc_remote_port * * cocci_id@p ;
...
position p;
@@
 enum { VERR_NO_ERROR = 0 , VERR_LSACC = 1 , VERR_LSDESC_RQST = 2 , VERR_LSDESC_RQST_LEN = 3 , VERR_ASSOC_ID = 4 , VERR_ASSOC_ID_LEN = 5 , VERR_CONN_ID = 6 , VERR_CONN_ID_LEN = 7 , VERR_CR_ASSOC = 8 , VERR_CR_ASSOC_ACC_LEN = 9 , VERR_CR_CONN = 10 , VERR_CR_CONN_ACC_LEN = 11 , VERR_DISCONN = 12 , VERR_DISCONN_ACC_LEN = 13 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvme_fc_ctrl * ) ;
...
typedef uint8_t;
@@
 struct nvme_fcp_op_w_sgl {  struct nvme_fc_fcp_op op ;  struct scatterlist sgl [ NVME_INLINE_SG_CNT ] ;  uint8_t priv [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 enum nvmefc_fcp_datadir cocci_id@p ;
...
position p;
@@
 struct nvmefc_fcp_req * cocci_id@p ;
...
position p;
@@
 struct nvme_fc_ctrl * cocci_id@p ;
...
@@
 struct nvme_fc_fcp_op {  struct nvme_request nreq ;  struct nvmefc_fcp_req fcp_req ;  struct nvme_fc_ctrl * ctrl ;  struct nvme_fc_queue * queue ;  struct request * rq ;  atomic_t state ;  u32 flags ;  u32 rqno ;  u32 nents ;  struct nvme_fc_cmd_iu cmd_iu ;  struct nvme_fc_ersp_iu rsp_iu ; } cocci_id@p ;
...
position p;
@@
 struct fcnvme_ls_disconnect_assoc_rqst * cocci_id@p ;
...
position p;
@@
 struct fcnvme_lsdesc_cr_conn_cmd cocci_id@p ;
...
position p;
@@
 struct fcnvme_ls_disconnect_assoc_acc * cocci_id@p ;
...
position p;
@@
 struct nvme_fc_port_info * cocci_id@p ;
...
position p;
@@
 enum nvme_fcctrl_flags { FCCTRL_TERMIO = ( 1 << 0 ) , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct nvme_fc_ctrl * ) ;
...
position p;
@@
 enum nvme_fcpop_state { FCPOP_STATE_UNINIT = 0 , FCPOP_STATE_IDLE = 1 , FCPOP_STATE_ACTIVE = 2 , FCPOP_STATE_ABORTED = 3 , FCPOP_STATE_COMPLETE = 4 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvme_fc_ctrl * ctrl , char * errmsg ) ;
...
position p;
@@
 const struct nvme_ctrl_ops cocci_id@p ;
...
position p;
@@
 struct nvmf_transport_ops cocci_id@p ;
...
position p;
@@
 struct fcnvme_ls_cr_assoc_acc cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,wait_queue_head_t,atomic_t,spinlock_t;
@@
 struct nvme_fc_ctrl {  spinlock_t lock ;  struct nvme_fc_queue * queues ;  struct device * dev ;  struct nvme_fc_lport * lport ;  struct nvme_fc_rport * rport ;  u32 cnum ;  bool ioq_live ;  bool assoc_active ;  atomic_t err_work_active ;  u64 association_id ;  struct list_head ctrl_list ;  struct blk_mq_tag_set admin_tag_set ;  struct blk_mq_tag_set tag_set ;  struct delayed_work connect_work ;  struct work_struct err_work ;  struct kref ref ;  u32 flags ;  u32 iocnt ;  wait_queue_head_t ioabort_wait ;  struct nvme_fc_fcp_op aen_ops [ NVME_NR_AEN_COMMANDS ] ;  struct nvme_ctrl ctrl ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ FCNVME_TRADDR_LENGTH ] ;
...
position p;
@@
 struct fcnvme_ls_rjt * cocci_id@p ;
...
position p;
@@
 enum nvme_fc_queue_flags { NVME_FC_Q_CONNECTED = 0 , NVME_FC_Q_LIVE , } cocci_id@p ;
...
position p;
@@
 struct fcnvme_lsdesc_disconn_cmd cocci_id@p ;
...
position p;
@@
 enum nvme_fcop_flags { FCOP_FLAGS_TERMIO = ( 1 << 0 ) , FCOP_FLAGS_AEN = ( 1 << 1 ) , } cocci_id@p ;
...
position p;
@@
 struct fcnvme_lsdesc_assoc_id cocci_id@p ;
...
position p;
@@
 struct nvmefc_ls_req_op * cocci_id@p ;
...
position p;
@@
 struct fcnvme_ls_cr_conn_rqst * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nvme_fc_ctrl * , struct nvme_fc_queue * , unsigned int ) ;
...
position p;
@@
 struct nvme_fc_lport * cocci_id@p ;
...
position p;
@@
 struct nvme_fc_cmd_iu * cocci_id@p ;
...
position p;
@@
 struct nvmf_ctrl_options * cocci_id@p ;
...
position p;
@@
 struct fcnvme_ls_cr_assoc_rqst * cocci_id@p ;
...
typedef u64;
@@
 struct nvmet_fc_traddr {  u64 nn ;  u64 pn ; } cocci_id@p ;
...
position p;
@@
 struct nvme_completion * cocci_id@p ;
...
position p;
@@
 struct nvme_fc_rport * cocci_id@p ;
...
position p;
@@
 struct fcnvme_lsdesc_conn_id cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct nvmefc_ls_req * req , int status ) ;
...
position p;
@@
 struct nvme_fc_ersp_iu cocci_id@p ;
