...
position p;
@@
 enum event_status { EVENT_FOUND , EVENT_DROPPED , } cocci_id@p ;
...
typedef u64,local_t;
@@
 struct rb_page {  u64 ts ;  local_t commit ;  char data [ 4080 ] ; } cocci_id@p ;
