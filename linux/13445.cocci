...
position p;
@@
 struct em28xx_buffer cocci_id@p ;
...
position p;
@@
 enum v4l2_i2c_tuner_type cocci_id@p ;
...
position p;
@@
 struct em28xx_dmaqueue * cocci_id@p ;
