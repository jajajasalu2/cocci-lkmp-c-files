...
position p;
@@
 struct usbduxfast_private * cocci_id@p ;
...
typedef s8,u8;
@@
 struct usbduxfast_private {  struct urb * urb ;  u8 * duxbuf ;  s8 * inbuf ;  short int ai_cmd_running ;  int ignore ;  struct mutex mut ; } cocci_id@p ;
