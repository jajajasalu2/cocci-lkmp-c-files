...
position p;
@@
 struct adt7475_data * cocci_id@p ( struct device * dev ) ;
...
position p;
@@
 struct adt7475_data * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ ADT7475_VOLTAGE_COUNT + 1 ] [ 2 ] ;
...
position p;
@@
 enum chips { adt7473 , adt7475 , adt7476 , adt7490 , } cocci_id@p ;
...
@@
 struct adt7475_data {  struct i2c_client * client ;  struct mutex lock ;  unsigned long measure_updated ;  bool valid ;  u8 config4 ;  u8 config5 ;  u8 has_voltage ;  u8 bypass_attn ;  u8 has_pwm2 : 1 ;  u8 has_fan4 : 1 ;  u8 has_vid : 1 ;  u32 alarms ;  u16 voltage [ 3 ] [ 6 ] ;  u16 temp [ 7 ] [ 3 ] ;  u16 tach [ 2 ] [ 4 ] ;  u8 pwm [ 4 ] [ 3 ] ;  u8 range [ 3 ] ;  u8 pwmctl [ 3 ] ;  u8 pwmchan [ 3 ] ;  u8 enh_acoustics [ 2 ] ;  u8 vid ;  u8 vrm ;  const struct attribute_group * groups [ 9 ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct i2c_client * client , int index ) ;
