...
position p;
@@
 struct tx_aggr_tmr_cnxt * cocci_id@p ;
...
position p;
@@
 struct usb_card_rec * cocci_id@p ;
...
position p;
@@
 struct mwifiex_if_ops cocci_id@p ;
...
position p;
@@
 struct fw_sync_header cocci_id@p ;
...
position p;
@@
 struct usb_tx_data_port * cocci_id@p ;
...
position p;
@@
 struct mwifiex_fw_image * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct urb_context * ctx , int size ) ;
