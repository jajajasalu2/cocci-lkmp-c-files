...
position p;
@@
 const struct bcm_db * cocci_id@p ;
...
position p;
@@
 struct tcs_cmd cocci_id@p [ SDM845_MAX_BCMS ] ;
...
position p;
@@
 struct qcom_icc_bcm * cocci_id@p ;
...
position p;
@@
 struct tcs_cmd cocci_id@p [ SDM845_MAX_VCD ] ;
...
position p;
@@
 struct qcom_icc_desc cocci_id@p ;
...
typedef u64,u16;
@@
 struct qcom_icc_node {  const char * name ;  u16 links [ SDM845_MAX_LINKS ] ;  u16 id ;  u16 num_links ;  u16 channels ;  u16 buswidth ;  u64 sum_avg [ QCOM_ICC_NUM_BUCKETS ] ;  u64 max_peak [ QCOM_ICC_NUM_BUCKETS ] ;  struct qcom_icc_bcm * bcms [ SDM845_MAX_BCM_PER_NODE ] ;  size_t num_bcms ; } cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ QCOM_ICC_NUM_BUCKETS ] ;
...
@@
 struct qcom_icc_bcm {  const char * name ;  u32 type ;  u32 addr ;  u64 vote_x [ QCOM_ICC_NUM_BUCKETS ] ;  u64 vote_y [ QCOM_ICC_NUM_BUCKETS ] ;  bool dirty ;  bool keepalive ;  struct bcm_db aux_data ;  struct list_head list ;  size_t num_nodes ;  struct qcom_icc_node * nodes [ ] ; } cocci_id@p ;
...
position p;
@@
 struct qcom_icc_desc {  struct qcom_icc_node * * nodes ;  size_t num_nodes ;  struct qcom_icc_bcm * * bcms ;  size_t num_bcms ; } cocci_id@p ;
...
typedef __le32,u8;
@@
 struct bcm_db {  __le32 unit ;  __le16 width ;  u8 vcd ;  u8 reserved ; } cocci_id@p ;
...
position p;
@@
 struct qcom_icc_node * * cocci_id@p ;
...
position p;
@@
 struct qcom_icc_provider * cocci_id@p ;
...
position p;
@@
 const struct qcom_icc_bcm * * cocci_id@p ;
...
position p;
@@
 struct qcom_icc_fabric {  struct qcom_icc_node * * nodes ;  size_t num_nodes ; } cocci_id@p ;
...
position p;
@@
 const struct qcom_icc_desc * cocci_id@p ;
...
position p;
@@
 struct qcom_icc_provider {  struct icc_provider provider ;  struct device * dev ;  struct qcom_icc_bcm * * bcms ;  size_t num_bcms ; } cocci_id@p ;
