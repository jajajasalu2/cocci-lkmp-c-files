...
position p;
@@
 struct s3c_hwmon_pdata * cocci_id@p ;
...
position p;
@@
 struct s3c64xx_spi_info cocci_id@p ;
...
position p;
@@
 struct s3c2410_hcd_info cocci_id@p ;
...
position p;
@@
 struct s3c2410_platform_nand * cocci_id@p ;
...
position p;
@@
 struct s3c2410_nand_set * cocci_id@p ;
...
position p;
@@
 struct samsung_pwm_variant * cocci_id@p ;
