...
position p;
@@
 struct gf100_gr_object cocci_id@p ;
...
position p;
@@
 const struct nvkm_gr_func cocci_id@p ;
...
position p;
@@
 union {  struct fermi_a_zbc_color_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_enum cocci_id@p [ ] ;
...
position p;
@@
 const struct gf100_gr_pack * cocci_id@p ;
...
position p;
@@
 const struct gf100_grctx_func * cocci_id@p ;
...
position p;
@@
 struct gf100_gr_data * cocci_id@p ;
...
position p;
@@
 const struct gf100_gr_init * cocci_id@p ;
...
position p;
@@
 const struct gf100_gr_func_zbc cocci_id@p ;
...
position p;
@@
 struct gf100_gr_chan * cocci_id@p ;
...
position p;
@@
 struct gf100_gr_ucode cocci_id@p ;
...
position p;
@@
 const struct nvkm_bitfield cocci_id@p [ ] ;
...
position p;
@@
 const struct gf100_gr_func cocci_id@p ;
...
position p;
@@
 struct gf100_gr_mmio * cocci_id@p ;
...
position p;
@@
 struct gf100_gr_fuc * cocci_id@p ;
...
position p;
@@
 struct gf100_vmm_map_v0 cocci_id@p ;
...
position p;
@@
 struct nvkm_fifo_chan * cocci_id@p ;
...
position p;
@@
 struct gf100_gr_pack * cocci_id@p ;
...
position p;
@@
 struct gf100_gr_object {  struct nvkm_object object ;  struct gf100_gr_chan * chan ; } cocci_id@p ;
...
position p;
@@
 union {  struct fermi_a_zbc_depth_v0 v0 ; } * cocci_id@p ;
