...
position p;
@@
 struct pmu_battery_dev {  struct power_supply * bat ;  struct power_supply_desc bat_desc ;  struct pmu_battery_info * pbi ;  char name [ 16 ] ;  int propval ; } * cocci_id@p [ PMU_MAX_BATTERIES ] ;
...
position p;
@@
 struct pmu_battery_info * cocci_id@p ;
...
position p;
@@
 struct pmu_battery_dev * cocci_id@p ;
