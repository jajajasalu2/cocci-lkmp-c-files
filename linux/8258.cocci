...
position p;
@@
 struct lan743x_adapter * cocci_id@p ;
...
position p;
@@
 struct lan743x_ptp_perout * cocci_id@p ;
...
position p;
@@
 struct lan743x_gpio * cocci_id@p ;
...
position p;
@@
 struct ptp_perout_request * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct lan743x_adapter * adapter , u32 seconds , u32 nano_seconds , u32 sub_nano_seconds ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct lan743x_adapter * adapter ) ;
...
position p;
@@
 void cocci_id@p ( struct lan743x_adapter * adapter ) ;
...
typedef s64;
@@
 void cocci_id@p ( struct lan743x_adapter * adapter , s64 time_step_ns ) ;
