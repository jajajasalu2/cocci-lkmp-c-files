...
symbol cocci_id;
position p;
typedef u64,u32,hda_nid_t;
@@
 struct hdmi_spec_per_cvt {  hda_nid_t cvt_nid ;  int assigned ;  unsigned int channels_min ;  unsigned int channels_max ;  u32 rates ;  u64 formats ;  unsigned int maxbps ; } cocci_id@p ;
...
position p;
@@
 const struct hdmi_ops cocci_id@p ;
...
@@
 struct hdmi_spec {  struct hda_codec * codec ;  int num_cvts ;  struct snd_array cvts ;  hda_nid_t cvt_nids [ 4 ] ;  int num_pins ;  int num_nids ;  int dev_num ;  struct snd_array pins ;  struct hdmi_pcm pcm_rec [ 16 ] ;  struct mutex pcm_lock ;  struct mutex bind_lock ;  unsigned long pcm_bitmap ;  int pcm_used ;  unsigned long pcm_in_use ;  struct hdmi_eld temp_eld ;  struct hdmi_ops ops ;  bool dyn_pin_out ;  bool dyn_pcm_assign ;  bool intel_hsw_fixup ;  struct hda_multi_out multiout ;  struct hda_pcm_stream pcm_playback ;  bool use_jack_detect ;  bool use_acomp_notifier ;  bool acomp_registered ;  struct drm_audio_component_audio_ops drm_audio_ops ;  int ( * port2pin ) ( struct hda_codec * , int ) ;  struct hdac_chmap chmap ;  hda_nid_t vendor_nid ;  const int * port_map ;  int port_num ; } cocci_id@p ;
...
position p;
@@
 struct hdac_cea_channel_speaker_allocation * cocci_id@p ;
...
position p;
@@
 struct hdmi_pcm {  struct hda_pcm * pcm ;  struct snd_jack * jack ;  struct snd_kcontrol * eld_ctl ; } cocci_id@p ;
...
position p;
@@
 const struct hda_pcm_ops cocci_id@p ;
...
position p;
@@
 union audio_infoframe cocci_id@p ;
...
position p;
@@
 struct hda_pcm_stream * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct hda_codec * , int ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct hdmi_spec_per_pin * per_pin , int repoll ) ;
...
position p;
@@
 struct hdmi_spec_per_cvt cocci_id@p ;
...
position p;
@@
 struct hdmi_spec_per_pin * cocci_id@p ;
...
position p;
@@
 struct hda_jack_tbl * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_chmap * cocci_id@p ;
...
typedef u8;
@@
 union audio_infoframe {  struct hdmi_audio_infoframe hdmi ;  struct dp_audio_infoframe dp ;  u8 bytes [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct drm_audio_component_audio_ops * cocci_id@p ;
...
position p;
@@
 struct hda_spdif_out * cocci_id@p ;
...
typedef u8;
@@
 struct hdmi_audio_infoframe {  u8 type ;  u8 ver ;  u8 len ;  u8 checksum ;  u8 CC02_CT47 ;  u8 SS01_SF24 ;  u8 CXT04 ;  u8 CA ;  u8 LFEPBL01_LSV36_DM_INH7 ; } cocci_id@p ;
