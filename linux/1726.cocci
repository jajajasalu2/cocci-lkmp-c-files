...
position p;
@@
 enum fxos8700_int_pin { FXOS8700_PIN_INT1 , FXOS8700_PIN_INT2 , } cocci_id@p ;
...
typedef u8;
@@
 struct fxos8700_odr {  u8 bits ;  int odr ;  int uodr ; } cocci_id@p ;
...
position p;
@@
 enum fxos8700_accel_scale_bits { MODE_2G = 0 , MODE_4G , MODE_8G , } cocci_id@p ;
...
typedef u8;
@@
 struct fxos8700_scale {  u8 bits ;  int uscale ; } cocci_id@p ;
...
position p;
@@
 const struct fxos8700_scale cocci_id@p [ ] ;
...
position p;
@@
 struct fxos8700_data * cocci_id@p ;
...
position p;
@@
 enum fxos8700_sensor { FXOS8700_ACCEL = 0 , FXOS8700_MAGN , FXOS8700_NUM_SENSORS , } cocci_id@p ;
...
position p;
@@
 enum fxos8700_scan_axis { FXOS8700_SCAN_ACCEL_X = 0 , FXOS8700_SCAN_ACCEL_Y , FXOS8700_SCAN_ACCEL_Z , FXOS8700_SCAN_MAGN_X , FXOS8700_SCAN_MAGN_Y , FXOS8700_SCAN_MAGN_Z , FXOS8700_SCAN_RHALL , FXOS8700_SCAN_TIMESTAMP , } cocci_id@p ;
...
position p;
@@
 struct fxos8700_data {  struct regmap * regmap ;  struct iio_trigger * trig ;  __be16 buf [ FXOS8700_DATA_BUF_SIZE ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 const struct fxos8700_odr cocci_id@p [ ] ;
...
position p;
@@
 enum fxos8700_sensor cocci_id@p ;
