...
position p;
@@
 const struct vop_intr cocci_id@p ;
...
position p;
@@
 const struct vop_win_phy cocci_id@p ;
...
position p;
@@
 const struct vop_common cocci_id@p ;
...
position p;
@@
 const struct vop_yuv2yuv_phy cocci_id@p ;
...
position p;
@@
 const struct vop_scl_extension cocci_id@p ;
...
position p;
@@
 const struct vop_output cocci_id@p ;
...
position p;
@@
 const struct vop_modeset cocci_id@p ;
...
position p;
@@
 const struct vop_misc cocci_id@p ;
...
position p;
@@
 const struct vop_scl_regs cocci_id@p ;
