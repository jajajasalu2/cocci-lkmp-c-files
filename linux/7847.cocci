...
position p;
@@
 struct slvl_board {  struct slvl_device dev [ 2 ] ;  struct z8530_dev board ;  int iobase ; } cocci_id@p ;
...
position p;
@@
 struct slvl_device {  struct z8530_channel * chan ;  int channel ; } cocci_id@p ;
...
position p;
@@
 struct z8530_channel * cocci_id@p ;
