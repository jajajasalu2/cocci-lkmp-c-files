...
position p;
@@
 struct vrc4171_socket cocci_id@p [ CARD_MAX_SLOTS ] ;
...
typedef spinlock_t;
@@
 struct vrc4171_socket {  enum vrc4171_slot slot ;  struct pcmcia_socket pcmcia_socket ;  char name [ 24 ] ;  int csc_irq ;  int io_irq ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 enum vrc4171_slot { SLOT_PROBE = 0 , SLOT_NOPROBE_IO , SLOT_NOPROBE_MEM , SLOT_NOPROBE_ALL , SLOT_INITIALIZED , } cocci_id@p ;
...
position p;
@@
 struct vrc4171_socket * cocci_id@p ;
...
position p;
@@
 enum vrc4171_slotb { SLOTB_IS_NONE , SLOTB_IS_PCCARD , SLOTB_IS_CF , SLOTB_IS_FLASHROM , } cocci_id@p ;
