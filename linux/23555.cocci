...
position p;
@@
 struct skl_i2s_config_blob_legacy * cocci_id@p ;
...
position p;
@@
 struct skl_i2s_config_blob_ext * cocci_id@p ;
...
position p;
@@
 struct nhlt_endpoint * cocci_id@p ;
