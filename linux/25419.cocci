...
position p;
@@
 struct sdt_name_reg {  const char * sdt_name ;  const char * uprobe_name ; } cocci_id@p ;
...
position p;
@@
 const struct sample_reg cocci_id@p [ ] ;
...
position p;
@@
 const struct sdt_name_reg cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ SDT_REG_NAME_SIZE ] ;
