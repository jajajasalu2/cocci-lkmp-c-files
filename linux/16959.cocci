...
position p;
@@
 enum mms_type { TYPE_MMS114 = 114 , TYPE_MMS152 = 152 , } cocci_id@p ;
...
typedef u8;
@@
 struct mms114_data {  struct i2c_client * client ;  struct input_dev * input_dev ;  struct regulator * core_reg ;  struct regulator * io_reg ;  struct touchscreen_properties props ;  enum mms_type type ;  unsigned int contact_threshold ;  unsigned int moving_threshold ;  u8 cache_mode_control ; } cocci_id@p ;
...
position p;
@@
 struct mms114_touch cocci_id@p [ MMS114_MAX_TOUCH ] ;
...
position p;
@@
 const struct touchscreen_properties * cocci_id@p ;
...
position p;
@@
 struct mms114_touch * cocci_id@p ;
