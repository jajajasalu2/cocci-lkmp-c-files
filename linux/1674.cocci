...
position p;
@@
 struct mag3110_data * cocci_id@p ;
...
typedef u8;
@@
 struct mag3110_data {  struct i2c_client * client ;  struct mutex lock ;  u8 ctrl_reg1 ;  int sleep_val ;  struct regulator * vdd_reg ;  struct regulator * vddio_reg ; } cocci_id@p ;
