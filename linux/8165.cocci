...
position p;
@@
 enum phy_ctrl_bits { MII_READ = 0x00 , MII_CLK = 0x01 , MII_DATA1 = 0x02 , MII_WRITE = 0x04 , MII_DUPLEX = 0x08 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int int_status ) ;
...
typedef u16;
@@
 int cocci_id@p ( struct net_device * dev , int phy_addr , int reg_num , u16 data ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int tx_status ) ;
...
position p;
@@
 int cocci_id@p ( struct netdev_private * , int eep_addr ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int irq ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int phy_addr , int reg_num ) ;
