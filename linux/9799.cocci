...
position p;
@@
 char cocci_id@p [ UUID_STRING_LEN + 1 ] ;
...
position p;
@@
 struct ath10k_fw_crash_data * cocci_id@p ;
...
position p;
@@
 const struct ath10k_hw_mem_layout * cocci_id@p ;
...
position p;
@@
 const struct ath10k_mem_region * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ath10k * ar ) ;
...
position p;
@@
 struct ath10k_ce_pipe * cocci_id@p ;
...
position p;
@@
 enum ath10k_pci_reset_mode { ATH10K_PCI_RESET_AUTO = 0 , ATH10K_PCI_RESET_WARM_ONLY = 1 , } cocci_id@p ;
...
position p;
@@
 enum ath10k_firmware_mode cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ath10k_ce_pipe * ce_state ) ;
...
position p;
@@
 struct ath10k_htc_hdr cocci_id@p ;
...
position p;
@@
 struct service_to_pipe cocci_id@p [ ] ;
...
position p;
@@
 struct ath10k_bus_params cocci_id@p ;
...
position p;
@@
 struct ath10k_dump_ram_data_hdr * cocci_id@p ;
...
position p;
@@
 const struct ath10k_bus_ops cocci_id@p ;
...
position p;
@@
 const struct ath10k_pci_supp_chip cocci_id@p [ ] ;
...
position p;
@@
 struct ce_pipe_config * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ath10k * ar , struct sk_buff * skb ) ;
...
position p;
@@
 struct ath10k_ce_ring * cocci_id@p ;
...
position p;
@@
 struct ath10k_pci_pipe * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ath10k * ar , struct ath10k_ce_pipe * tx_pipe , struct ath10k_ce_pipe * rx_pipe , struct bmi_xfer * xfer ) ;
...
position p;
@@
 void cocci_id@p ( struct ath10k * ar ) ;
...
position p;
@@
 const struct service_to_pipe * cocci_id@p ;
...
position p;
@@
 const struct ath10k_mem_section * cocci_id@p ;
...
typedef u32;
@@
 u32 ( * cocci_id@p ) ( struct ath10k * ar , u32 addr ) ;
...
position p;
@@
 const struct ath10k_hif_ops cocci_id@p ;
...
position p;
@@
 struct ath10k_hif_sg_item * cocci_id@p ;
