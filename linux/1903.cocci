...
position p;
@@
 struct ads1015_platform_data * cocci_id@p ;
...
position p;
@@
 enum chip_ids { ADS1015 , ADS1115 , } cocci_id@p ;
...
typedef bool;
@@
 struct ads1015_data {  struct regmap * regmap ;  struct mutex lock ;  struct ads1015_channel_data channel_data [ ADS1015_CHANNELS ] ;  unsigned int event_channel ;  unsigned int comp_mode ;  struct ads1015_thresh_data thresh_data [ ADS1015_CHANNELS ] ;  unsigned int * data_rate ;  bool conv_invalid ; } cocci_id@p ;
...
position p;
@@
 struct ads1015_data * cocci_id@p ;
...
position p;
@@
 enum ads1015_channels { ADS1015_AIN0_AIN1 = 0 , ADS1015_AIN0_AIN3 , ADS1015_AIN1_AIN3 , ADS1015_AIN2_AIN3 , ADS1015_AIN0 , ADS1015_AIN1 , ADS1015_AIN2 , ADS1015_AIN3 , ADS1015_TIMESTAMP , } cocci_id@p ;
...
position p;
@@
 struct ads1015_thresh_data {  unsigned int comp_queue ;  int high_thresh ;  int low_thresh ; } cocci_id@p ;
