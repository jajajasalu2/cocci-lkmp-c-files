...
position p;
@@
 struct mt_application * cocci_id@p ;
...
position p;
@@
 struct input_mt_slot * cocci_id@p ;
...
position p;
@@
 const struct mt_class * cocci_id@p ;
...
typedef bool,__u8;
@@
 struct mt_device {  struct mt_class mtclass ;  struct timer_list release_timer ;  struct hid_device * hdev ;  unsigned long mt_io_flags ;  __u8 inputmode_value ;  __u8 maxcontacts ;  bool is_buttonpad ;  bool serial_maybe ;  struct list_head applications ;  struct list_head reports ; } cocci_id@p ;
...
typedef bool,__u8;
@@
 struct mt_application {  struct list_head list ;  unsigned int application ;  unsigned int report_id ;  struct list_head mt_usages ;  __s32 quirks ;  __s32 * scantime ;  __s32 scantime_logical_max ;  __s32 * raw_cc ;  int left_button_state ;  unsigned int mt_flags ;  unsigned long * pending_palm_slots ;  __u8 num_received ;  __u8 num_expected ;  __u8 buttons_count ;  __u8 touches_by_report ;  __s32 dev_time ;  unsigned long jiffies ;  int timestamp ;  int prev_scantime ;  bool have_contact_count ; } cocci_id@p ;
...
position p;
@@
 enum latency_mode { HID_LATENCY_NORMAL = 0 , HID_LATENCY_HIGH = 1 , } cocci_id@p ;
...
typedef bool;
@@
 struct mt_report_data {  struct list_head list ;  struct hid_report * report ;  struct mt_application * application ;  bool is_mt_collection ; } cocci_id@p ;
...
typedef bool,__u8;
@@
 struct mt_class {  __s32 name ;  __s32 quirks ;  __s32 sn_move ;  __s32 sn_width ;  __s32 sn_height ;  __s32 sn_pressure ;  __u8 maxcontacts ;  bool is_indirect ;  bool export_all_inputs ; } cocci_id@p ;
...
position p;
@@
 struct mt_report_data * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mt_device * td , struct mt_application * app ) ;
