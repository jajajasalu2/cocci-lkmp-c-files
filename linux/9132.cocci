...
position p;
@@
 enum { MLX5E_UC = 0 , MLX5E_MC_IPV4 = 1 , MLX5E_MC_IPV6 = 2 , MLX5E_MC_OTHER = 3 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mlx5e_priv * priv , struct mlx5e_l2_rule * ai , int type ) ;
...
position p;
@@
 enum { MLX5E_FULLMATCH = 0 , MLX5E_ALLMULTI = 1 , MLX5E_PROMISC = 2 , } cocci_id@p ;
...
position p;
@@
 struct mlx5e_l2_rule * cocci_id@p ;
...
position p;
@@
 enum mlx5e_vlan_rule_type cocci_id@p ;
...
position p;
@@
 struct mlx5e_flow_table * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5e_priv * priv , struct mlx5e_l2_rule * ai ) ;
...
position p;
@@
 struct mlx5e_ttc_table * cocci_id@p ;
...
position p;
@@
 struct mlx5e_l2_hash_node * cocci_id@p ;
...
position p;
@@
 enum mlx5e_vlan_rule_type { MLX5E_VLAN_RULE_TYPE_UNTAGGED , MLX5E_VLAN_RULE_TYPE_ANY_CTAG_VID , MLX5E_VLAN_RULE_TYPE_ANY_STAG_VID , MLX5E_VLAN_RULE_TYPE_MATCH_CTAG_VID , MLX5E_VLAN_RULE_TYPE_MATCH_STAG_VID , } cocci_id@p ;
...
position p;
@@
 enum { MLX5E_ACTION_NONE = 0 , MLX5E_ACTION_ADD = 1 , MLX5E_ACTION_DEL = 2 , } cocci_id@p ;
...
position p;
@@
 struct mlx5e_l2_table * cocci_id@p ;
...
typedef u8,u16;
@@
 struct mlx5e_etype_proto {  u16 etype ;  u8 proto ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct mlx5e_l2_hash_node {  struct hlist_node hlist ;  u8 action ;  struct mlx5e_l2_rule ai ;  bool mpfs ; } cocci_id@p ;
...
position p;
@@
 struct mlx5e_etype_proto cocci_id@p [ ] ;
