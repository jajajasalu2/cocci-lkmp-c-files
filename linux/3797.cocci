...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct device * dev , u32 * desc , u32 status , void * areq ) ;
...
position p;
@@
 struct caam_drv_private_jr * cocci_id@p ;
...
position p;
@@
 struct jr_driver_data cocci_id@p ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( struct device * dev , u32 * desc , u32 status , void * arg ) ;
...
position p;
@@
 struct caam_jrentry_info * cocci_id@p ;
