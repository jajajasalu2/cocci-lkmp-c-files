...
position p;
@@
 struct async_scan_data cocci_id@p ;
...
position p;
@@
 struct async_scan_data {  struct list_head list ;  struct Scsi_Host * shost ;  struct completion prev_finished ; } cocci_id@p ;
...
position p;
@@
 enum scsi_scan_mode cocci_id@p ;
