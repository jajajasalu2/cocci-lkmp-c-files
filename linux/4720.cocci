...
position p;
@@
 void ( * cocci_id@p ) ( struct xpc_partition * ) ;
...
position p;
@@
 void cocci_id@p ( struct xpc_partition * , struct xpc_channel * ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct xpc_channel * ) ;
...
position p;
@@
 struct xpc_arch_operations cocci_id@p ;
