...
typedef u32;
@@
 const struct {  u32 firmware_revision ;  u32 model ;  unsigned int workarounds ; } cocci_id@p [ ] ;
...
position p;
@@
 struct sbp2_command_orb cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fw_unit * unit ) ;
...
position p;
@@
 struct sbp2_management_orb * cocci_id@p ;
...
position p;
@@
 struct sbp2_logical_unit cocci_id@p ;
...
position p;
@@
 struct fw_csr_iterator cocci_id@p ;
...
typedef __be32;
@@
 struct sbp2_login_response {  __be32 misc ;  struct sbp2_pointer command_block_agent ;  __be32 reconnect_hold ; } cocci_id@p ;
...
position p;
@@
 struct fw_transaction * cocci_id@p ;
...
@@
 struct sbp2_target {  struct fw_unit * unit ;  struct list_head lu_list ;  u64 management_agent_address ;  u64 guid ;  int directory_id ;  int node_id ;  int address_high ;  unsigned int workarounds ;  unsigned int mgt_orb_timeout ;  unsigned int max_payload ;  spinlock_t lock ;  int dont_block ;  int blocked ; } cocci_id@p ;
...
position p;
@@
 struct sbp2_login_response cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __be32,dma_addr_t;
@@
 struct sbp2_management_orb {  struct sbp2_orb base ;  struct {  struct sbp2_pointer password ;  struct sbp2_pointer response ;  __be32 misc ;  __be32 length ;  struct sbp2_pointer status_fifo ; } request ;  __be32 response [ 4 ] ;  dma_addr_t response_bus ;  struct completion done ;  struct sbp2_status status ; } cocci_id@p ;
...
position p;
@@
 const struct sbp2_target * cocci_id@p ;
...
typedef u8,u32;
@@
 struct sbp2_status {  u32 status ;  u32 orb_low ;  u8 data [ 24 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u16,work_func_t;
@@
 struct sbp2_logical_unit {  struct sbp2_target * tgt ;  struct list_head link ;  struct fw_address_handler address_handler ;  struct list_head orb_list ;  u64 command_block_agent_address ;  u16 lun ;  int login_id ;  int generation ;  int retries ;  work_func_t workfn ;  struct delayed_work work ;  bool has_sdev ;  bool blocked ; } cocci_id@p ;
...
position p;
@@
 const struct sbp2_logical_unit * cocci_id@p ;
...
typedef __be32;
@@
 struct sbp2_pointer {  __be32 high ;  __be32 low ; } cocci_id@p ;
...
position p;
@@
 struct sbp2_pointer cocci_id@p ;
