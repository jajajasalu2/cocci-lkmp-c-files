...
position p;
@@
 struct gf100_clk_info * cocci_id@p ;
...
position p;
@@
 struct {  void ( * exec ) ( struct gf100_clk * , int ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct gf100_clk {  struct nvkm_clk base ;  struct gf100_clk_info eng [ 16 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct gf100_clk_info {  u32 freq ;  u32 ssel ;  u32 mdiv ;  u32 dsrc ;  u32 ddiv ;  u32 coef ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct gf100_clk * , int , u32 , u32 ) ;
