...
typedef u32;
@@
 u32 cocci_id@p [ MLX5_ST_SZ_DW ( create_sw_icm_in ) ] ;
...
typedef spinlock_t;
@@
 struct mlx5_dm {  spinlock_t lock ;  unsigned long * steering_sw_icm_alloc_blocks ;  unsigned long * header_modify_sw_icm_alloc_blocks ; } cocci_id@p ;
