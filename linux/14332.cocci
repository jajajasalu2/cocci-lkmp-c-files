...
typedef u8;
@@
 struct dib0090_identity {  u8 version ;  u8 product ;  u8 p1g ;  u8 in_soc ; } cocci_id@p ;
...
position p;
@@
 const struct dib0090_pll * cocci_id@p ;
...
position p;
@@
 const struct dc_calibration cocci_id@p [ ] ;
...
position p;
@@
 const struct dib0090_tuning * cocci_id@p ;
...
position p;
@@
 const struct slope cocci_id@p [ 3 ] ;
...
typedef s16;
@@
 struct slope {  s16 range ;  s16 slope ; } cocci_id@p ;
...
position p;
@@
 struct dib0090_identity * cocci_id@p ;
...
position p;
@@
 const struct dib0090_wbd_slope cocci_id@p [ ] ;
...
typedef u8;
@@
 struct dib0090_fw_state {  struct i2c_adapter * i2c ;  struct dvb_frontend * fe ;  struct dib0090_identity identity ;  const struct dib0090_config * config ;  struct i2c_msg msg ;  u8 i2c_write_buffer [ 2 ] ;  u8 i2c_read_buffer [ 2 ] ;  struct mutex i2c_buffer_lock ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct dib0090_pll {  u32 max_freq ;  u8 vco_band ;  u8 hfdiv_code ;  u8 hfdiv ;  u8 topresc ; } cocci_id@p ;
...
position p;
@@
 const struct dib0090_config * cocci_id@p ;
...
typedef u8,u16;
@@
 struct dc_calibration {  u8 addr ;  u8 offset ;  u8 pga : 1 ;  u16 bb1 ;  u8 i : 1 ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct dib0090_tuning {  u32 max_freq ;  u8 switch_trim ;  u8 lna_tune ;  u16 lna_bias ;  u16 v2i ;  u16 mix ;  u16 load ;  u16 tuner_enable ; } cocci_id@p ;
...
position p;
@@
 struct dib0090_fw_state * cocci_id@p ;
...
position p;
@@
 struct dib0090_state * cocci_id@p ;
...
position p;
@@
 struct dc_calibration cocci_id@p ;
...
position p;
@@
 const struct dib0090_low_if_offset_table * cocci_id@p ;
