...
position p;
@@
 union fsf_status_qual * cocci_id@p ;
...
position p;
@@
 struct fsf_link_down_info * cocci_id@p ;
...
position p;
@@
 struct fsf_qtcb_bottom_io * cocci_id@p ;
...
position p;
@@
 struct fcp_resp_with_ext * cocci_id@p ;
...
position p;
@@
 struct fsf_qtcb_bottom_port * cocci_id@p ;
...
position p;
@@
 union fsf_prot_status_qual * cocci_id@p ;
...
position p;
@@
 struct zfcp_latency_record * cocci_id@p ;
...
position p;
@@
 struct zfcp_scsi_dev * cocci_id@p ;
...
position p;
@@
 struct fsf_qtcb_bottom_config * cocci_id@p ;
...
position p;
@@
 struct zfcp_qdio_req * cocci_id@p ;
...
position p;
@@
 struct zfcp_latency_cont * cocci_id@p ;
...
position p;
@@
 struct fsf_qual_latency_info * cocci_id@p ;
...
position p;
@@
 struct zfcp_diag_header * const cocci_id@p ;
...
position p;
@@
 struct zfcp_erp_action * cocci_id@p ;
...
position p;
@@
 struct fsf_qtcb_header * cocci_id@p ;
...
position p;
@@
 struct zfcp_blk_drv_data cocci_id@p ;
