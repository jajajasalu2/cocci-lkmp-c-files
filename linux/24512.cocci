...
position p;
@@
 struct rds_znotifier * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ __RDS_EXTHDR_MAX ] ;
...
position p;
@@
 struct rds_ext_header_rdma_dest cocci_id@p ;
...
position p;
@@
 struct rds_ext_header_version cocci_id@p ;
