...
position p;
@@
 struct rt_sigframe {  struct siginfo info ;  struct ucontext uc ;  unsigned long tramp [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct sigframe {  struct sigcontext sc ;  unsigned long extramask [ _NSIG_WORDS - 1 ] ;  unsigned long tramp [ 2 ] ; } cocci_id@p ;
