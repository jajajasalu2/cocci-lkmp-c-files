...
typedef u16;
@@
 struct rt_sigframe {  struct siginfo info ;  struct ucontext uc ;  u16 retcode [ 8 ] ; } cocci_id@p ;
...
typedef u16;
@@
 struct sigframe {  struct sigcontext sc ;  unsigned long extramask [ _NSIG_WORDS - 1 ] ;  u16 retcode [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct fdpic_func_descriptor {  unsigned long text ;  unsigned long GOT ; } cocci_id@p ;
