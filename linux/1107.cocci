...
position p;
@@
 struct s3c_cpufreq_config cocci_id@p ;
...
position p;
@@
 struct s3c_cpufreq_info * cocci_id@p ;
...
position p;
@@
 struct s3c_iotimings cocci_id@p ;
...
position p;
@@
 struct s3c_cpufreq_freqs cocci_id@p ;
...
position p;
@@
 struct s3c_cpufreq_board * cocci_id@p ;
