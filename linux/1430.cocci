...
position p;
@@
 void cocci_id@p ( struct m66592_ep * ep , struct m66592_request * req ) ;
...
position p;
@@
 void cocci_id@p ( struct m66592 * m66592 ) ;
...
position p;
@@
 struct m66592_pipe_info cocci_id@p ;
...
position p;
@@
 struct m66592_request * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct m66592_ep * ep , struct m66592_request * req , int status ) ;
