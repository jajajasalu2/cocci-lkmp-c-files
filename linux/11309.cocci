...
position p;
@@
 struct meson_venc_cvbs {  struct drm_encoder encoder ;  struct drm_connector connector ;  struct meson_drm * priv ; } cocci_id@p ;
...
position p;
@@
 struct meson_cvbs_mode * cocci_id@p ;
...
position p;
@@
 const struct meson_cvbs_mode * cocci_id@p ;
...
position p;
@@
 struct meson_venc_cvbs * cocci_id@p ;
...
position p;
@@
 struct meson_cvbs_mode cocci_id@p [ MESON_CVBS_MODES_COUNT ] ;
