...
position p;
@@
 struct apds9960_data * cocci_id@p ;
...
position p;
@@
 enum apds9960_gesture_channel_idx { IDX_DIR_UP , IDX_DIR_DOWN , IDX_DIR_LEFT , IDX_DIR_RIGHT , } cocci_id@p ;
...
typedef u8;
@@
 struct apds9960_data {  struct i2c_client * client ;  struct iio_dev * indio_dev ;  struct mutex lock ;  struct regmap * regmap ;  struct regmap_field * reg_int_als ;  struct regmap_field * reg_int_ges ;  struct regmap_field * reg_int_pxs ;  struct regmap_field * reg_enable_als ;  struct regmap_field * reg_enable_ges ;  struct regmap_field * reg_enable_pxs ;  int als_int ;  int pxs_int ;  int gesture_mode_running ;  int als_gain ;  int pxs_gain ;  int als_adc_int_us ;  u8 buffer [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 enum apds9960_als_channel_idx { IDX_ALS_CLEAR , IDX_ALS_RED , IDX_ALS_GREEN , IDX_ALS_BLUE , } cocci_id@p ;
