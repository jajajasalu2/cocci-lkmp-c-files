...
position p;
@@
 struct resolve_cb_context cocci_id@p ;
...
typedef bool,u32;
@@
 struct addr_req {  struct list_head list ;  struct sockaddr_storage src_addr ;  struct sockaddr_storage dst_addr ;  struct rdma_dev_addr * addr ;  void * context ;  void ( * callback ) ( int status , struct sockaddr * src_addr , struct rdma_dev_addr * addr , void * context ) ;  unsigned long timeout ;  struct delayed_work work ;  bool resolve_by_gid_attr ;  int status ;  u32 seq ; } cocci_id@p ;
...
position p;
@@
 struct rdma_ls_ip_resolve_header * cocci_id@p ;
...
position p;
@@
 union {  struct sockaddr _sockaddr ;  struct sockaddr_in _sockaddr_in ;  struct sockaddr_in6 _sockaddr_in6 ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( int status , struct sockaddr * src_addr , struct rdma_dev_addr * addr , void * context ) ;
...
position p;
@@
 struct resolve_cb_context {  struct completion comp ;  int status ; } cocci_id@p ;
