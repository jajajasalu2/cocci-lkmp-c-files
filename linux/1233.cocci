...
typedef bool;
@@
 struct exynos_ehci_hcd {  struct clk * clk ;  struct device_node * of_node ;  struct phy * phy [ PHY_NUMBER ] ;  bool legacy_phy ; } cocci_id@p ;
...
position p;
@@
 struct exynos_ehci_hcd * cocci_id@p ;
