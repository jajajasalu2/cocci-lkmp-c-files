...
position p;
@@
 struct gred_sched_data * * cocci_id@p ;
...
position p;
@@
 struct tc_gred_qopt cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_GRED_VQ_ENTRY_MAX + 1 ] ;
...
position p;
@@
 struct tc_gred_qopt_offload cocci_id@p ;
...
position p;
@@
 enum { GRED_WRED_MODE = 1 , GRED_RIO_MODE , } cocci_id@p ;
...
typedef u32;
@@
 struct gred_sched {  struct gred_sched_data * tab [ MAX_DPs ] ;  unsigned long flags ;  u32 red_flags ;  u32 DPs ;  u32 def ;  struct red_vars wred_set ; } cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct gred_sched_data {  u32 limit ;  u32 DP ;  u32 red_flags ;  u64 bytesin ;  u32 packetsin ;  u32 backlog ;  u8 prio ;  struct red_parms parms ;  struct red_vars vars ;  struct red_stats stats ; } cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_GRED_MAX + 1 ] ;
...
position p;
@@
 enum tc_gred_command cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_GRED_VQ_MAX + 1 ] ;
...
position p;
@@
 const struct gred_sched * cocci_id@p ;
...
position p;
@@
 struct tc_gred_sopt cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_GRED_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_GRED_VQ_MAX + 1 ] ;
