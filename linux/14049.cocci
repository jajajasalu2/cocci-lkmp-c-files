...
position p;
@@
 const struct mtk_video_fmt * cocci_id@p ;
...
position p;
@@
 struct mtk_enc_params * cocci_id@p ;
...
position p;
@@
 struct mtk_video_enc_buf * cocci_id@p ;
...
position p;
@@
 const struct mtk_codec_framesizes cocci_id@p [ ] ;
...
position p;
@@
 struct mtk_vcodec_dev * cocci_id@p ;
