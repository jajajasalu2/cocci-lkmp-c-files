...
position p;
@@
 int cocci_id@p ( struct kvm_vcpu * vcpu , ulong fac ) ;
...
position p;
@@
 int cocci_id@p ( struct kvm_vcpu * vcpu , unsigned int exit_nr , ulong msr ) ;
...
position p;
@@
 struct kvmppc_book3s_shadow_vcpu * cocci_id@p ;
...
position p;
@@
 struct kvmppc_vcpu_book3s * cocci_id@p ;
