...
position p;
@@
 int cocci_id@p ( char * line , const char * * namep , char * * rawp ) ;
...
position p;
@@
 struct disassemble_info cocci_id@p ;
...
position p;
@@
 struct ins_ops * cocci_id@p ( struct arch * arch , const char * name ) ;
...
position p;
@@
 const struct annotation_config * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ KMOD_DECOMP_LEN ] ;
...
position p;
@@
 struct annotation_options cocci_id@p ;
...
position p;
@@
 struct annotate_args * cocci_id@p ;
...
position p;
@@
 struct annotation_line * cocci_id@p ;
...
position p;
@@
 struct addr_map_symbol cocci_id@p ;
...
position p;
@@
 struct annotated_source * cocci_id@p ;
...
position p;
@@
 struct ins_operands * cocci_id@p ;
...
typedef bool;
@@
 int ( * cocci_id@p ) ( void * obj , int nr , bool current ) ;
...
position p;
@@
 struct annotation_write_ops cocci_id@p ;
...
position p;
@@
 struct child_process cocci_id@p ;
...
position p;
@@
 struct bpf_prog_linfo * cocci_id@p ;
...
position p;
@@
 struct sym_hist_entry cocci_id@p ;
...
typedef bool;
@@
 void ( * cocci_id@p ) ( void * obj , double percent , bool current ) ;
...
position p;
@@
 void cocci_id@p ( struct arch * arch ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * obj , const char * fmt , ... ) ;
...
position p;
@@
 struct bpf_prog_info_node * cocci_id@p ;
...
position p;
@@
 struct annotation_config cocci_id@p ;
...
position p;
@@
 struct annotation_data * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * obj , int color ) ;
...
position p;
@@
 struct annotation_config {  const char * name ;  void * value ; } cocci_id@p [ ] ;
...
typedef s64;
@@
 struct annotate_args {  size_t privsize ;  struct arch * arch ;  struct map_symbol ms ;  struct evsel * evsel ;  struct annotation_options * options ;  s64 offset ;  char * line ;  int line_nr ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * obj , int graph ) ;
...
position p;
@@
 struct kcore_extract cocci_id@p ;
...
typedef bool;
@@
 struct arch {  const char * name ;  struct ins * instructions ;  size_t nr_instructions ;  size_t nr_instructions_allocated ;  struct ins_ops * ( * associate_instruction_ops ) ( struct arch * arch , const char * name ) ;  bool sorted_instructions ;  bool initialized ;  void * priv ;  unsigned int model ;  unsigned int family ;  int ( * init ) ( struct arch * arch , char * cpuid ) ;  bool ( * ins_is_fused ) ( struct arch * arch , const char * ins1 , const char * ins2 ) ;  struct {  char comment_char ;  char skip_functions_char ; } objdump ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SBUILD_ID_SIZE + 15 ] ;
