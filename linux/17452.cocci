...
position p;
@@
 struct spider_pic cocci_id@p [ SPIDER_CHIP_COUNT ] ;
...
position p;
@@
 struct spider_pic {  struct irq_domain * host ;  void __iomem * regs ;  unsigned int node_id ; } cocci_id@p ;
