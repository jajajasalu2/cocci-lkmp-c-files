...
position p;
@@
 struct fb_bitfield cocci_id@p [ ] [ 4 ] ;
...
position p;
@@
 struct window_settings * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef au1200_lcd_global_regs_t;
@@
 struct au1200_lcd_global_regs_t * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct au1200fb_device {  struct fb_info * fb_info ;  struct au1200fb_platdata * pd ;  struct device * dev ;  int plane ;  unsigned char * fb_mem ;  unsigned int fb_len ;  dma_addr_t fb_phys ; } cocci_id@p ;
...
position p;
@@
 struct au1200fb_platdata * cocci_id@p ;
...
typedef au1200_lcd_global_regs_t;
@@
 struct au1200_lcd_global_regs_t {  unsigned int flags ;  unsigned int xsize ;  unsigned int ysize ;  unsigned int backcolor ;  unsigned int brightness ;  unsigned int colorkey ;  unsigned int mask ;  unsigned int panel_choice ;  char panel_desc [ 80 ] ; } cocci_id@p ;
...
typedef au1200_lcd_window_regs_t;
@@
 struct au1200_lcd_window_regs_t * cocci_id@p ;
...
position p;
@@
 struct fb_info * cocci_id@p [ MAX_DEVICE_COUNT ] ;
...
position p;
@@
 struct au1200fb_device cocci_id@p ;
...
position p;
@@
 struct window_settings {  unsigned char name [ 64 ] ;  uint32 mode_backcolor ;  uint32 mode_colorkey ;  uint32 mode_colorkeymsk ;  struct {  int xres ;  int yres ;  int xpos ;  int ypos ;  uint32 mode_winctrl1 ;  uint32 mode_winenable ; } w [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct panel_settings * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef au1200_lcd_window_regs_t,au1200_lcd_iodata_t,au1200_lcd_global_regs_t;
@@
 struct au1200_lcd_iodata_t {  unsigned int subcmd ;  struct au1200_lcd_global_regs_t global ;  struct au1200_lcd_window_regs_t window ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef au1200_lcd_iodata_t;
@@
 struct au1200_lcd_iodata_t cocci_id@p ;
