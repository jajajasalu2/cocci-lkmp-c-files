...
position p;
@@
 struct at24_client {  struct i2c_client * client ;  struct regmap * regmap ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct at24_chip_data {  u32 byte_len ;  u8 flags ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct at24_data {  struct mutex lock ;  unsigned int write_max ;  unsigned int num_addresses ;  unsigned int offset_adj ;  u32 byte_len ;  u16 page_size ;  u8 flags ;  struct nvmem_device * nvmem ;  struct gpio_desc * wp_gpio ;  struct at24_client client [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct at24_chip_data * cocci_id@p ;
