...
position p;
@@
 void cocci_id@p ( struct snd_seq_event * ev , unsigned char * buf ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_midi_event * dev , unsigned char * buf , int len , struct snd_seq_event * ev ) ;
...
position p;
@@
 int cocci_id@p ( struct snd_midi_event * dev , unsigned char * buf , int count , struct snd_seq_event * ev ) ;
...
position p;
@@
 struct extra_event_list {  int event ;  int ( * decode ) ( struct snd_midi_event * dev , unsigned char * buf , int len , struct snd_seq_event * ev ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct status_event_list {  int event ;  int qlen ;  void ( * encode ) ( struct snd_midi_event * dev , struct snd_seq_event * ev ) ;  void ( * decode ) ( struct snd_seq_event * ev , unsigned char * buf ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct snd_midi_event * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_midi_event * dev , struct snd_seq_event * ev ) ;
