...
position p;
@@
 struct fw_cache_entry * cocci_id@p ;
...
position p;
@@
 struct firmware_work {  struct work_struct work ;  struct module * module ;  const char * name ;  struct device * device ;  void * context ;  void ( * cont ) ( const struct firmware * fw , void * context ) ;  enum fw_opt opt_flags ; } cocci_id@p ;
...
position p;
@@
 struct firmware_work cocci_id@p ;
...
position p;
@@
 struct firmware_cache cocci_id@p ;
...
position p;
@@
 struct fw_name_devm * cocci_id@p ;
...
position p;
@@
 struct fw_cache_entry {  struct list_head list ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct fw_name_devm {  unsigned long magic ;  const char * name ; } cocci_id@p ;
