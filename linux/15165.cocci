...
position p;
@@
 struct pps_client_pp cocci_id@p ;
...
position p;
@@
 struct pps_client_pp {  struct pardevice * pardev ;  struct pps_device * pps ;  unsigned int cw ;  unsigned int cw_err ;  int index ; } cocci_id@p ;
