...
position p;
@@
 struct scif_remote_fence_info * cocci_id@p ;
...
position p;
@@
 enum scif_window_type cocci_id@p ;
...
position p;
@@
 struct scif_fence_info * cocci_id@p ;
