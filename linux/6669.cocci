...
position p;
@@
 const struct ahd_pci_identity * cocci_id@p ;
...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , u_int adapter_control ) ;
...
symbol cocci_id;
position p;
typedef ahd_device_setup_t;
@@
 ahd_device_setup_t cocci_id@p ;
