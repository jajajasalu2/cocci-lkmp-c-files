...
typedef spinlock_t;
@@
 struct rtc_plat_data {  struct rtc_device * rtc ;  void __iomem * ioaddr ;  int irq ;  unsigned int irqen ;  int alrm_sec ;  int alrm_min ;  int alrm_hour ;  int alrm_mday ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct rtc_plat_data * cocci_id@p ;
