...
position p;
@@
 const struct ipvl_dev * cocci_id@p ;
...
position p;
@@
 const struct ipvl_port * cocci_id@p ;
...
position p;
@@
 struct ipvl_pcpu_stats * cocci_id@p ;
