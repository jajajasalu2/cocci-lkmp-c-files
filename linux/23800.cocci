...
position p;
@@
 const struct can_filter * cocci_id@p ;
...
@@
 struct canid_match { 
	 DECLARE_BITMAP ( match_sff , ( 1 << CAN_SFF_ID_BITS ) ) 
		 ;  int rules_count ;  int sff_rules_count ;  int eff_rules_count ;  struct can_filter rules_raw [ ] ; } cocci_id@p ;
