...
position p;
@@
 void cocci_id@p ( struct thermostat * th , int speed , int fan ) ;
...
typedef u8;
@@
 struct thermostat {  struct i2c_client * clt ;  u8 temps [ 3 ] ;  u8 cached_temp [ 3 ] ;  u8 initial_limits [ 3 ] ;  u8 limits [ 3 ] ;  int last_speed [ 2 ] ;  int last_var [ 2 ] ;  int pwm_inv [ 2 ] ;  struct task_struct * thread ;  struct platform_device * pdev ;  enum { ADT7460 , ADT7467 , } type ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct thermostat * th , int speed ) ;
