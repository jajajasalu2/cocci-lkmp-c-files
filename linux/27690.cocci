...
position p;
@@
 enum ramfs_param { Opt_mode , } cocci_id@p ;
...
position p;
@@
 struct ramfs_fs_info {  struct ramfs_mount_opts mount_opts ; } cocci_id@p ;
...
position p;
@@
 struct ramfs_fs_info * cocci_id@p ;
...
typedef umode_t;
@@
 struct ramfs_mount_opts {  umode_t mode ; } cocci_id@p ;
