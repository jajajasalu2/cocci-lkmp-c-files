...
typedef u16;
@@
 int cocci_id@p ( struct net_bridge * br , struct net_bridge_port * source , const unsigned char * addr , u16 vid ) ;
...
position p;
@@
 struct net_bridge_fdb_entry cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct net_bridge * br , const struct net_bridge_fdb_entry * , int , bool ) ;
...
position p;
@@
 const struct net_bridge_fdb_entry * cocci_id@p ;
...
position p;
@@
 struct net_bridge_fdb_key cocci_id@p ;
