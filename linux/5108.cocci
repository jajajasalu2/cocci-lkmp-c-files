...
@@
 struct uniphier_gpio_priv {  struct gpio_chip chip ;  struct irq_chip irq_chip ;  struct irq_domain * domain ;  void __iomem * regs ;  spinlock_t lock ;  u32 saved_vals [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct uniphier_gpio_priv * cocci_id@p ;
