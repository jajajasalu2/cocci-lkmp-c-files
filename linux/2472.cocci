...
position p;
@@
 struct ioat_raw_descriptor * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct ioat_raw_descriptor * cocci_id@p [ 3 ] ;
...
position p;
@@
 struct ioat_pq16a_descriptor * cocci_id@p ;
...
position p;
@@
 struct ioat_dma_descriptor * cocci_id@p ;
...
position p;
@@
 struct ioat_raw_descriptor * cocci_id@p [ ] ;
...
position p;
@@
 struct ioat_xor_descriptor * cocci_id@p ;
...
position p;
@@
 struct ioat_pq_descriptor * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_SCF ] ;
...
position p;
@@
 struct ioat_xor_ext_descriptor * cocci_id@p ;
...
position p;
@@
 struct ioat_pq_ext_descriptor * cocci_id@p ;
...
position p;
@@
 struct ioat_sed_ent * cocci_id@p ;
...
position p;
@@
 struct ioat_raw_descriptor * cocci_id@p [ 4 ] ;
