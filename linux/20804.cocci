...
position p;
@@
 struct apm_bios_info * cocci_id@p ;
...
position p;
@@
 struct pci_setup_rom * * cocci_id@p ;
...
position p;
@@
 struct boot_e820_entry * cocci_id@p ;
...
position p;
@@
 struct efi_boot_memmap * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_pci_io_protocol_t;
@@
 efi_pci_io_protocol_t * cocci_id@p ;
...
position p;
@@
 struct setup_header * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_loaded_image_t;
@@
 efi_loaded_image_t * cocci_id@p ;
...
position p;
@@
 struct exit_boot_struct {  struct boot_params * boot_params ;  struct efi_info * efi ; } cocci_id@p ;
...
position p;
@@
 const struct efi_config * cocci_id@p ;
...
position p;
@@
 struct exit_boot_struct cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_uga_draw_protocol_t;
@@
 efi_uga_draw_protocol_t * cocci_id@p ;
