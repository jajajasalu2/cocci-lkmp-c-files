...
position p;
@@
 struct ice_aqc_lldp_set_mib_change * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_cee_dcb_cfg_resp cocci_id@p ;
...
position p;
@@
 struct ice_cee_app_prio * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_lldp_set_local_mib * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_lldp_stop * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_lldp_start * cocci_id@p ;
...
position p;
@@
 struct ice_lldp_org_tlv * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_lldp_stop_start_specific_agent * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_port_ets_elem * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_lldp_get_mib * cocci_id@p ;
...
position p;
@@
 struct ice_cee_feat_tlv * cocci_id@p ;
...
position p;
@@
 struct ice_dcb_ets_cfg * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_query_port_ets * cocci_id@p ;
...
position p;
@@
 struct ice_cee_ctrl_tlv cocci_id@p ;
