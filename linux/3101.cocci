...
position p;
@@
 struct gendisk * cocci_id@p [ N_DRIVE ] ;
...
position p;
@@
 struct timer_list cocci_id@p [ N_DRIVE ] ;
...
position p;
@@
 struct floppy_raw_cmd cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int fdc , char mask , char data ) ;
...
position p;
@@
 struct compat_floppy_drive_struct cocci_id@p ;
...
position p;
@@
 struct floppy_write_errors cocci_id@p [ N_DRIVE ] ;
...
position p;
@@
 struct floppy_drive_params * cocci_id@p ;
...
position p;
@@
 struct compat_floppy_struct cocci_id@p ;
...
position p;
@@
 struct floppy_drive_struct cocci_id@p [ N_DRIVE ] ;
...
position p;
@@
 struct compat_floppy_drive_params cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uint_t,compat_int_t,compat_ulong_t;
@@
 struct compat_floppy_write_errors {  unsigned int write_errors ;  compat_ulong_t first_error_sector ;  compat_int_t first_error_generation ;  compat_ulong_t last_error_sector ;  compat_int_t last_error_generation ;  compat_uint_t badness ; } cocci_id@p ;
...
position p;
@@
 struct format_descr cocci_id@p ;
...
position p;
@@
 union inparam {  struct floppy_struct g ;  struct format_descr f ;  struct floppy_max_errors max_errors ;  struct floppy_drive_params dp ; } cocci_id@p ;
...
position p;
@@
 struct floppy_write_errors cocci_id@p ;
...
typedef cont_t;
@@
 const struct cont_t cocci_id@p ;
...
position p;
@@
 struct floppy_fdc_state cocci_id@p [ N_FDC ] ;
...
typedef cont_t;
@@
 const struct cont_t {  void ( * interrupt ) ( void ) ;  void ( * redo ) ( void ) ;  void ( * error ) ( void ) ;  done_f done ; } * cocci_id@p ;
...
position p;
@@
 struct floppy_struct cocci_id@p ;
...
position p;
@@
 struct rb0_cbdata {  int drive ;  struct completion complete ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MAX_REPLIES ] ;
...
position p;
@@
 struct floppy_fdc_state cocci_id@p ;
...
position p;
@@
 struct floppy_struct * cocci_id@p [ N_DRIVE ] ;
...
position p;
@@
 const struct io_region * cocci_id@p ;
...
position p;
@@
 const struct pnp_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct output_log {  unsigned char data ;  unsigned char status ;  unsigned long jiffies ; } cocci_id@p [ OLOGSIZE ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "request done " ) + sizeof ( int ) * 3 ] ;
...
position p;
@@
 struct platform_device cocci_id@p [ N_DRIVE ] ;
...
position p;
@@
 const struct io_region {  int offset ;  int size ; } cocci_id@p [ ] ;
...
position p;
@@
 struct block_device * cocci_id@p [ N_DRIVE ] ;
...
position p;
@@
 struct blk_mq_tag_set cocci_id@p [ N_DRIVE ] ;
...
symbol cocci_id;
position p;
typedef compat_int_t,compat_ulong_t;
@@
...
position p;
@@
 struct compat_floppy_write_errors cocci_id@p ;
...
position p;
@@
 struct floppy_struct cocci_id@p [ 32 ] ;
...
position p;
@@
 struct {  struct floppy_drive_params params ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct floppy_drive_params cocci_id@p [ N_DRIVE ] ;
...
position p;
@@
 struct compat_floppy_fdc_state cocci_id@p ;
