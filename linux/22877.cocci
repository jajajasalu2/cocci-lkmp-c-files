...
typedef u32;
@@
 const struct {  char * const label ;  u32 mask ; } * cocci_id@p ;
...
typedef u32;
@@
 const struct {  enum snd_ff_clock_src src ;  u32 mask ; } * cocci_id@p ;
...
typedef u32;
@@
 const struct {  unsigned int rate ;  u32 mask ; } * cocci_id@p ;
...
position p;
@@
 const struct snd_ff_protocol cocci_id@p ;
...
typedef u32;
@@
 const struct {  char * const label ;  u32 locked_mask ;  u32 synced_mask ; } * cocci_id@p ;
