...
@@
 struct cx88_audio_dev {  struct cx88_core * core ;  struct cx88_dmaqueue q ;  struct pci_dev * pci ;  int irq ;  struct snd_card * card ;  spinlock_t reg_lock ;  atomic_t count ;  unsigned int dma_size ;  unsigned int period_size ;  unsigned int num_periods ;  struct cx88_audio_buffer * buf ;  struct snd_pcm_substream * substream ; } cocci_id@p ;
...
position p;
@@
 struct cx88_audio_dev * cocci_id@p ;
...
position p;
@@
 struct cx88_audio_buffer {  unsigned int bpl ;  struct cx88_riscmem risc ;  void * vaddr ;  struct scatterlist * sglist ;  int sglen ;  int nr_pages ; } cocci_id@p ;
...
position p;
@@
 struct cx88_audio_buffer * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ SNDRV_CARDS ] ;
...
position p;
@@
 const struct sram_channel * cocci_id@p ;
