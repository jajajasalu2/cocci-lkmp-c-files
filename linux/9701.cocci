...
typedef u8;
@@
 const u8 cocci_id@p [ BT_COEX_PRIO_TBL_EVT_MAX ] ;
...
typedef u8,bool;
@@
 struct iwl_alive_data {  bool valid ;  u8 subtype ; } cocci_id@p ;
...
position p;
@@
 struct iwl_calib_xtal_freq_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_wimax_coex_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_calib_temperature_offset_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_calib_temperature_offset_v2_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_bt_coex_prio_table_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_alive_data cocci_id@p ;
...
position p;
@@
 struct iwl_alive_resp * cocci_id@p ;
...
position p;
@@
 struct iwl_bt_coex_prot_env_cmd cocci_id@p ;
