...
position p;
@@
 enum gameport_event_type cocci_id@p ;
...
position p;
@@
 enum gameport_event_type { GAMEPORT_REGISTER_PORT , GAMEPORT_ATTACH_DRIVER , } cocci_id@p ;
...
position p;
@@
 struct gameport_event * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gameport_driver * drv ) ;
...
position p;
@@
 struct gameport_event {  enum gameport_event_type type ;  void * object ;  struct module * owner ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gameport * gameport ) ;
