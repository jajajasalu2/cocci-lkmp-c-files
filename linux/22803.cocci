...
typedef dma_addr_t;
@@
 struct pmac_beep {  int running ;  int volume ;  int volume_play ;  int hz ;  int nsamples ;  short * buf ;  dma_addr_t addr ;  struct input_dev * dev ; } cocci_id@p ;
