...
position p;
@@
 struct platform_mhu {  void __iomem * base ;  struct platform_mhu_link mlink [ MHU_CHANS ] ;  struct mbox_chan chan [ MHU_CHANS ] ;  struct mbox_controller mbox ; } cocci_id@p ;
...
position p;
@@
 struct platform_mhu_link * cocci_id@p ;
...
position p;
@@
 struct platform_mhu * cocci_id@p ;
...
position p;
@@
 struct platform_mhu_link {  int irq ;  void __iomem * tx_reg ;  void __iomem * rx_reg ; } cocci_id@p ;
