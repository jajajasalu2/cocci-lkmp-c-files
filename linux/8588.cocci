...
position p;
@@
 void cocci_id@p ( volatile struct dbdma_regs __iomem * dma ) ;
...
position p;
@@
 void cocci_id@p ( struct mace_data * mp ) ;
...
typedef spinlock_t;
@@
 struct mace_data {  volatile struct mace __iomem * mace ;  volatile struct dbdma_regs __iomem * tx_dma ;  int tx_dma_intr ;  volatile struct dbdma_regs __iomem * rx_dma ;  int rx_dma_intr ;  volatile struct dbdma_cmd * tx_cmds ;  volatile struct dbdma_cmd * rx_cmds ;  struct sk_buff * rx_bufs [ N_RX_RING ] ;  int rx_fill ;  int rx_empty ;  struct sk_buff * tx_bufs [ N_TX_RING ] ;  int tx_fill ;  int tx_empty ;  unsigned char maccc ;  unsigned char tx_fullup ;  unsigned char tx_active ;  unsigned char tx_bad_runt ;  struct timer_list tx_timeout ;  int timeout_active ;  int port_aaui ;  int chipid ;  struct macio_dev * mdev ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , void * addr ) ;
