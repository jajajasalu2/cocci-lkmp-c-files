...
position p;
@@
 struct ulptx_sc_memrd * cocci_id@p ;
...
position p;
@@
 struct fw_tlstx_data_wr cocci_id@p ;
...
position p;
@@
 struct cpl_tx_tls_sfo * cocci_id@p ;
