...
position p;
@@
 const struct mdiobb_ops cocci_id@p ;
...
typedef u8,u32;
@@
 struct ax_device {  struct mii_bus * mii_bus ;  struct mdiobb_ctrl bb_ctrl ;  void __iomem * addr_memr ;  u8 reg_memr ;  int link ;  int speed ;  int duplex ;  void __iomem * map2 ;  const struct ax_plat_data * plat ;  unsigned char running ;  unsigned char resume_open ;  unsigned int irqflags ;  u32 reg_offsets [ 0x20 ] ; } cocci_id@p ;
