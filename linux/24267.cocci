...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_BRPORT_MAX + 1 ] ;
...
position p;
@@
 struct br_boolopt_multi * cocci_id@p ;
...
position p;
@@
 struct net_bridge_vlan_group * cocci_id@p ;
...
position p;
@@
 struct net_bridge_vlan * cocci_id@p ;
...
position p;
@@
 struct vtunnel_info cocci_id@p ;
...
position p;
@@
 struct bridge_vlan_xstats cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IFLA_BRPORT_MAX + 1 ] ;
...
position p;
@@
 struct br_vlan_stats cocci_id@p ;
...
position p;
@@
 struct ifla_bridge_id cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_BR_MAX + 1 ] ;
