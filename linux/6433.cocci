...
position p;
@@
 enum chips { PFUZE100 , PFUZE200 , PFUZE3000 = 3 , PFUZE3001 = 0x31 , } cocci_id@p ;
...
position p;
@@
 struct pfuze_regulator cocci_id@p [ ] ;
...
position p;
@@
 struct pfuze_chip {  int chip_id ;  int flags ;  struct regmap * regmap ;  struct device * dev ;  struct pfuze_regulator regulator_descs [ PFUZE100_MAX_REGULATOR ] ;  struct regulator_dev * regulators [ PFUZE100_MAX_REGULATOR ] ;  struct pfuze_regulator * pfuze_regulators ; } cocci_id@p ;
...
position p;
@@
 struct pfuze_regulator_platform_data * cocci_id@p ;
...
typedef bool;
@@
 struct pfuze_regulator {  struct regulator_desc desc ;  unsigned char stby_reg ;  unsigned char stby_mask ;  bool sw_reg ; } cocci_id@p ;
