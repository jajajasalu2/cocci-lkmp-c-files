...
typedef u64;
@@
 struct teo_cpu {  u64 time_span_ns ;  u64 sleep_length_ns ;  struct teo_idle_state states [ CPUIDLE_STATE_MAX ] ;  int interval_idx ;  u64 intervals [ INTERVALS ] ; } cocci_id@p ;
...
position p;
@@
 struct teo_idle_state {  unsigned int early_hits ;  unsigned int hits ;  unsigned int misses ; } cocci_id@p ;
