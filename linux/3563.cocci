...
position p;
@@
 struct mmc_pwrseq_emmc * cocci_id@p ;
...
position p;
@@
 struct mmc_pwrseq_emmc {  struct mmc_pwrseq pwrseq ;  struct notifier_block reset_nb ;  struct gpio_desc * reset_gpio ; } cocci_id@p ;
