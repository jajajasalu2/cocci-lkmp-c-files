...
position p;
@@
 struct rockchip_ddrclk * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct rockchip_ddrclk {  struct clk_hw hw ;  void __iomem * reg_base ;  int mux_offset ;  int mux_shift ;  int mux_width ;  int div_shift ;  int div_width ;  int ddr_flag ;  spinlock_t * lock ; } cocci_id@p ;
