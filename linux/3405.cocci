...
position p;
@@
 const struct mtk_pwm_data cocci_id@p ;
...
typedef bool,u32;
@@
 struct mtk_pwm_data {  u32 enable_mask ;  unsigned int con0 ;  u32 con0_sel ;  unsigned int con1 ;  bool has_commit ;  unsigned int commit ;  unsigned int commit_mask ;  unsigned int bls_debug ;  u32 bls_debug_mask ; } cocci_id@p ;
...
position p;
@@
 struct mtk_disp_pwm {  struct pwm_chip chip ;  const struct mtk_pwm_data * data ;  struct clk * clk_main ;  struct clk * clk_mm ;  void __iomem * base ; } cocci_id@p ;
...
position p;
@@
 struct mtk_disp_pwm * cocci_id@p ;
