...
position p;
@@
 enum iss_subclk_resource cocci_id@p ;
...
position p;
@@
 enum iss_isp_subclk_resource cocci_id@p ;
...
position p;
@@
 enum iss_mem_resources cocci_id@p ;
...
position p;
@@
 struct iss_platform_data * cocci_id@p ;
...
position p;
@@
 struct iss_v4l2_subdevs_group * cocci_id@p ;
...
position p;
@@
 struct iss_subdev_i2c_board_info * cocci_id@p ;
...
position p;
@@
 enum ipipeif_input_entity cocci_id@p ;
...
position p;
@@
 enum iss_pipeline_stream_state cocci_id@p ;
