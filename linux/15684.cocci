...
position p;
@@
 struct dpsw_vlan_if_cfg cocci_id@p ;
...
position p;
@@
 struct fsl_mc_device_irq * cocci_id@p ;
...
position p;
@@
 struct ethsw_switchdev_event_work cocci_id@p ;
...
position p;
@@
 struct ethsw_dump_ctx cocci_id@p ;
...
position p;
@@
 struct dpsw_fdb_multicast_cfg cocci_id@p ;
...
position p;
@@
 struct ethsw_port_priv * cocci_id@p ;
...
position p;
@@
 struct dpsw_vlan_cfg cocci_id@p ;
...
position p;
@@
 struct dpsw_stp_cfg cocci_id@p ;
...
position p;
@@
 struct ethsw_dump_ctx {  struct net_device * dev ;  struct sk_buff * skb ;  struct netlink_callback * cb ;  int idx ; } cocci_id@p ;
...
position p;
@@
 struct dpsw_fdb_unicast_cfg cocci_id@p ;
...
position p;
@@
 struct ethsw_switchdev_event_work {  struct work_struct work ;  struct switchdev_notifier_fdb_info fdb_info ;  struct net_device * dev ;  unsigned long event ; } cocci_id@p ;
...
position p;
@@
 struct fdb_dump_entry cocci_id@p ;
