...
position p;
@@
 const struct pvrdma_qp_cap * cocci_id@p ;
...
position p;
@@
 const struct pvrdma_global_route * cocci_id@p ;
...
position p;
@@
 struct pvrdma_qp_cap * cocci_id@p ;
...
position p;
@@
 struct pvrdma_page_dir * cocci_id@p ;
...
position p;
@@
 const union pvrdma_gid * cocci_id@p ;
...
position p;
@@
 const struct pvrdma_ah_attr * cocci_id@p ;
...
position p;
@@
 const struct ib_qp_cap * cocci_id@p ;
...
position p;
@@
 struct pvrdma_global_route * cocci_id@p ;
...
position p;
@@
 struct pvrdma_ah_attr * cocci_id@p ;
