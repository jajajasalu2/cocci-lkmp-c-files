...
position p;
@@
 struct ieee80211_mesh_chansw_params_ie cocci_id@p ;
...
position p;
@@
 struct mesh_csa_settings * cocci_id@p ;
...
position p;
@@
 struct ieee80211_wide_bw_chansw_ie cocci_id@p ;
