...
typedef u32;
@@
 struct qm_ecir2 {  u32 info ; } cocci_id@p ;
...
typedef u32;
@@
 struct qman_hwerr_txt {  u32 mask ;  const char * txt ; } cocci_id@p ;
...
position p;
@@
 const struct qman_error_info_mdata cocci_id@p [ ] ;
...
position p;
@@
 enum qm_memory { qm_memory_fqd , qm_memory_pfdr , } cocci_id@p ;
...
typedef u32;
@@
 struct qm_ecir {  u32 info ; } cocci_id@p ;
...
position p;
@@
 enum qm_wq_class { qm_wq_portal = 0 , qm_wq_pool = 1 , qm_wq_fman0 = 2 , qm_wq_fman1 = 3 , qm_wq_caam = 4 , qm_wq_pme = 5 , qm_wq_first = qm_wq_portal , qm_wq_last = qm_wq_pme , } cocci_id@p ;
...
typedef u16;
@@
 struct qman_error_info_mdata {  u16 addr_mask ;  u16 bits ;  const char * txt ; } cocci_id@p ;
...
typedef u32;
@@
 struct qm_eadr {  u32 info ; } cocci_id@p ;
...
position p;
@@
 const struct qman_hwerr_txt cocci_id@p [ ] ;
...
position p;
@@
 enum qm_dc_portal { qm_dc_portal_fman0 = 0 , qm_dc_portal_fman1 = 1 , } cocci_id@p ;
...
position p;
@@
 const struct qm_ecir * cocci_id@p ;
...
position p;
@@
 const struct qm_ecir2 * cocci_id@p ;
...
position p;
@@
 const struct qm_eadr * cocci_id@p ;
