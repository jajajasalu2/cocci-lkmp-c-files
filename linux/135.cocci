...
typedef u64;
@@
 void cocci_id@p ( struct device * dev , u64 mask ) ;
...
typedef dma_addr_t;
@@
 struct dma_devres {  size_t size ;  void * vaddr ;  dma_addr_t dma_handle ;  unsigned long attrs ; } cocci_id@p ;
