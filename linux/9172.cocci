...
position p;
@@
 char cocci_id@p [ MLXSW_REG_CWTP_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_qdisc_ops cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_qdisc_type cocci_id@p ;
...
position p;
@@
 struct tc_prio_qopt_offload_params * cocci_id@p ;
...
position p;
@@
 struct tc_prio_qopt_offload * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_qdisc_stats * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_qdisc * cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_qdisc_type { MLXSW_SP_QDISC_NO_QDISC , MLXSW_SP_QDISC_RED , MLXSW_SP_QDISC_PRIO , } cocci_id@p ;
...
position p;
@@
 struct tc_red_qopt_offload * cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct mlxsw_sp_qdisc {  u32 handle ;  u8 tclass_num ;  u8 prio_bitmap ;  union {  struct red_stats red ; } xstats_base ;  struct mlxsw_sp_qdisc_stats {  u64 tx_bytes ;  u64 tx_packets ;  u64 drops ;  u64 overlimits ;  u64 backlog ; } stats_base ;  struct mlxsw_sp_qdisc_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct tc_red_qopt_offload_params * cocci_id@p ;
...
position p;
@@
 struct tc_prio_qopt_offload_graft_params * cocci_id@p ;
...
position p;
@@
 struct tc_qopt_offload_stats * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_CWTPM_LEN ] ;
