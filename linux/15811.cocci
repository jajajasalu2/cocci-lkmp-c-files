...
position p;
@@
 struct vchiq_queue_message cocci_id@p ;
...
position p;
@@
 struct vchiq_header * cocci_id@p ;
...
position p;
@@
 struct vchiq_service_params cocci_id@p ;
...
position p;
@@
 enum vc_suspend_status cocci_id@p ;
...
position p;
@@
 struct bulk_waiter_node cocci_id@p ;
...
position p;
@@
 const enum vchiq_bulk_mode cocci_id@p ;
...
position p;
@@
 struct vchiq_get_config32 cocci_id@p ;
...
position p;
@@
 struct vchiq_await_completion * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uptr_t;
@@
 compat_uptr_t cocci_id@p ;
...
position p;
@@
 struct vchiq_get_config cocci_id@p ;
...
position p;
@@
 struct vchiq_io_copy_callback_context {  struct vchiq_element * element ;  size_t element_offset ;  unsigned long elements_to_go ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_completion_data32 cocci_id@p ;
...
position p;
@@
 struct bulk_waiter_node {  struct bulk_waiter bulk_waiter ;  int pid ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_element * cocci_id@p ;
...
position p;
@@
 struct vchiq_arm_state * cocci_id@p ;
...
position p;
@@
 struct vchiq_create_service cocci_id@p ;
...
typedef compat_uptr_t;
@@
 struct vchiq_queue_bulk_transfer32 {  unsigned int handle ;  compat_uptr_t data ;  unsigned int size ;  compat_uptr_t userdata ;  enum vchiq_bulk_mode mode ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_element32 cocci_id@p [ MAX_ELEMENTS ] ;
...
position p;
@@
 enum vchiq_bulk_mode cocci_id@p ;
...
typedef compat_uptr_t;
@@
 struct vchiq_dequeue_message32 {  unsigned int handle ;  int blocking ;  unsigned int bufsize ;  compat_uptr_t buf ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_dequeue_message cocci_id@p ;
...
position p;
@@
 struct vchiq_config cocci_id@p ;
...
position p;
@@
 enum vchiq_bulk_dir cocci_id@p ;
...
position p;
@@
 struct vchiq_completion_data cocci_id@p ;
...
position p;
@@
 struct vchiq_instance * * cocci_id@p ;
...
position p;
@@
 struct vchiq_create_service32 cocci_id@p ;
...
position p;
@@
 struct vchiq_await_completion32 cocci_id@p ;
...
typedef compat_uptr_t;
@@
 struct vchiq_service_params32 {  int fourcc ;  compat_uptr_t callback ;  compat_uptr_t userdata ;  short version ;  short version_min ; } cocci_id@p ;
...
position p;
@@
 struct dump_context * cocci_id@p ;
...
position p;
@@
 struct vchiq_create_service32 {  struct vchiq_service_params32 params ;  int is_open ;  int is_vchi ;  unsigned int handle ; } cocci_id@p ;
...
typedef compat_uptr_t;
@@
 struct vchiq_await_completion32 {  unsigned int count ;  compat_uptr_t buf ;  unsigned int msgbufsize ;  unsigned int msgbufcount ;  compat_uptr_t msgbufs ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_instance {  struct vchiq_state * state ;  struct vchiq_completion_data completions [ MAX_COMPLETIONS ] ;  int completion_insert ;  int completion_remove ;  struct completion insert_event ;  struct completion remove_event ;  struct mutex completion_mutex ;  int connected ;  int closing ;  int pid ;  int mark ;  int use_close_delivered ;  int trace ;  struct list_head bulk_waiter_list ;  struct mutex bulk_waiter_list_mutex ;  struct vchiq_debugfs_node debugfs_node ; } cocci_id@p ;
...
position p;
@@
 enum vchiq_connstate cocci_id@p ;
...
position p;
@@
 struct user_service {  struct vchiq_service * service ;  void * userdata ;  struct vchiq_instance * instance ;  char is_vchi ;  char dequeue_pending ;  char close_pending ;  int message_available_pos ;  int msg_insert ;  int msg_remove ;  struct completion insert_event ;  struct completion remove_event ;  struct completion close_event ;  struct vchiq_header * msg_queue [ MSG_QUEUE_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_queue_message32 cocci_id@p ;
...
position p;
@@
 struct vchiq_debugfs_node * cocci_id@p ;
...
position p;
@@
 struct vchiq_io_copy_callback_context * cocci_id@p ;
...
position p;
@@
 struct vchiq_set_service_option cocci_id@p ;
...
position p;
@@
 struct user_service * cocci_id@p ;
...
position p;
@@
 struct vchiq_dequeue_message32 cocci_id@p ;
...
position p;
@@
 struct vchiq_drvdata * cocci_id@p ;
...
position p;
@@
 const struct vchiq_service_params * cocci_id@p ;
...
position p;
@@
 struct service_data_struct * cocci_id@p ;
...
position p;
@@
 struct vchiq_queue_bulk_transfer cocci_id@p ;
...
position p;
@@
 struct platform_device_info cocci_id@p ;
...
position p;
@@
 struct vchiq_element cocci_id@p [ MAX_ELEMENTS ] ;
...
typedef loff_t;
@@
 struct dump_context {  char __user * buf ;  size_t actual ;  size_t space ;  loff_t offset ; } cocci_id@p ;
...
typedef compat_uptr_t;
@@
 struct vchiq_completion_data32 {  enum vchiq_reason reason ;  compat_uptr_t header ;  compat_uptr_t service_userdata ;  compat_uptr_t bulk_userdata ; } cocci_id@p ;
...
position p;
@@
 enum vc_resume_status cocci_id@p ;
...
typedef compat_uptr_t;
@@
 struct vchiq_element32 {  compat_uptr_t data ;  unsigned int size ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_service * cocci_id@p ;
...
position p;
@@
 enum vchiq_status cocci_id@p ( unsigned int handle , void * data , unsigned int size , enum vchiq_bulk_dir dir ) ;
...
position p;
@@
 struct vchiq_queue_bulk_transfer32 cocci_id@p ;
...
typedef compat_uptr_t;
@@
 struct vchiq_get_config32 {  unsigned int config_size ;  compat_uptr_t pconfig ; } cocci_id@p ;
...
typedef compat_uptr_t;
@@
 struct vchiq_queue_message32 {  unsigned int handle ;  unsigned int count ;  compat_uptr_t elements ; } cocci_id@p ;
...
position p;
@@
 struct service_data_struct {  int fourcc ;  int clientid ;  int use_count ; } cocci_id@p ;
