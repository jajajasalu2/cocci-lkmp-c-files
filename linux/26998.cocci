...
position p;
@@
 struct xfs_rui_log_format * cocci_id@p ;
...
position p;
@@
 struct xfs_bud_log_format cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_efi_log_item_t;
@@
 xfs_efi_log_item_t * cocci_id@p ;
...
position p;
@@
 struct xfs_rud_log_format * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xlog_rec_header_t;
@@
 xlog_rec_header_t * cocci_id@p ;
...
position p;
@@
 struct xfs_buf_cancel * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xlog_recover_item_t;
@@
 xlog_recover_item_t * cocci_id@p ;
...
position p;
@@
 struct xfs_btree_block * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xlog_in_core_2_t;
@@
 xlog_in_core_2_t * cocci_id@p ;
...
position p;
@@
 struct xfs_cui_log_item * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dq_logformat_t;
@@
 xfs_dq_logformat_t * cocci_id@p ;
...
position p;
@@
 struct xfs_da_blkinfo * cocci_id@p ;
...
position p;
@@
 struct xfs_rui_log_item * cocci_id@p ;
...
position p;
@@
 struct xfs_efi_log_item * cocci_id@p ;
...
position p;
@@
 struct xfs_log_item * cocci_id@p ;
...
position p;
@@
 struct xfs_trans_header cocci_id@p ;
...
position p;
@@
 struct xfs_cui_log_format * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_failaddr_t;
@@
 xfs_failaddr_t cocci_id@p ;
...
position p;
@@
 struct xfs_bui_log_item cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_agnumber_t;
@@
 xfs_agnumber_t cocci_id@p ;
...
position p;
@@
 struct xfs_inode_log_format * cocci_id@p ;
...
position p;
@@
 struct xfs_disk_dquot cocci_id@p ;
...
position p;
@@
 struct xfs_dir3_blk_hdr * cocci_id@p ;
...
position p;
@@
 struct xfs_da3_blkinfo * cocci_id@p ;
...
typedef xfs_daddr_t;
@@
 struct xfs_buf_cancel {  xfs_daddr_t bc_blkno ;  uint bc_len ;  int bc_refcount ;  struct list_head bc_list ; } cocci_id@p ;
...
position p;
@@
 struct xfs_cud_log_format * cocci_id@p ;
...
position p;
@@
 struct xfs_buf_log_format * cocci_id@p ;
...
position p;
@@
 struct xfs_log_dinode * cocci_id@p ;
...
position p;
@@
 struct xfs_efi_log_format * cocci_id@p ;
...
position p;
@@
 struct xfs_ino_geometry * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_qoff_logformat_t;
@@
 xfs_qoff_logformat_t * cocci_id@p ;
...
position p;
@@
 struct xfs_dq_logformat * cocci_id@p ;
...
position p;
@@
 struct xfs_bui_log_format * cocci_id@p ;
...
position p;
@@
 struct xfs_log_iovec * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_bmdr_block_t;
@@
 xfs_bmdr_block_t * cocci_id@p ;
...
position p;
@@
 struct xfs_icreate_log * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dinode_t;
@@
 xfs_dinode_t * cocci_id@p ;
...
position p;
@@
 struct hlist_head cocci_id@p [ XLOG_RHASH_SIZE ] ;
...
symbol cocci_id;
position p;
typedef xfs_efd_log_format_t;
@@
 xfs_efd_log_format_t * cocci_id@p ;
...
position p;
@@
 struct xlog_op_header * cocci_id@p ;
...
position p;
@@
 struct xlog_rec_header * cocci_id@p ;
...
position p;
@@
 struct xfs_buf_log_item * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_agblock_t;
@@
 xfs_agblock_t cocci_id@p ;
...
position p;
@@
 struct xlog_recover cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_buf_log_format_t;
@@
 xfs_buf_log_format_t * cocci_id@p ;
...
position p;
@@
 struct xfs_ail_cursor cocci_id@p ;
...
position p;
@@
 struct xfs_dsymlink_hdr * cocci_id@p ;
...
position p;
@@
 struct xlog_recover_item * cocci_id@p ;
