...
position p;
@@
 const struct cec_dmi_match * cocci_id@p ;
...
position p;
@@
 struct secocec_data {  struct device * dev ;  struct platform_device * pdev ;  struct cec_adapter * cec_adap ;  struct cec_notifier * notifier ;  struct rc_dev * ir ;  char ir_input_phys [ 32 ] ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct secocec_data * cocci_id@p ;
...
position p;
@@
 struct cec_dmi_match {  const char * sys_vendor ;  const char * product_name ;  const char * devname ;  const char * conn ; } cocci_id@p ;
