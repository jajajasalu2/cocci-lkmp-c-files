...
typedef u8;
@@
 const u8 cocci_id@p [ QM1D1C0042_NUM_REG_ROWS ] [ QM1D1C0042_NUM_REGS ] ;
...
position p;
@@
 struct qm1d1c0042_state cocci_id@p ;
...
position p;
@@
 const struct qm1d1c0042_config cocci_id@p ;
...
typedef u8;
@@
 struct qm1d1c0042_state {  struct qm1d1c0042_config cfg ;  struct i2c_client * i2c ;  u8 regs [ QM1D1C0042_NUM_REGS ] ; } cocci_id@p ;
