...
symbol cocci_id;
position p;
typedef u16,ext_int_handler_t;
@@
 struct ext_int_info {  ext_int_handler_t handler ;  struct hlist_node entry ;  struct rcu_head rcu ;  u16 code ; } cocci_id@p ;
...
position p;
@@
 struct ext_int_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ext_int_handler_t;
@@
 ext_int_handler_t cocci_id@p ;
...
position p;
@@
 const struct irq_class cocci_id@p [ NR_IRQS_BASE ] ;
...
position p;
@@
 struct irq_class {  int irq ;  char * name ;  char * desc ; } cocci_id@p ;
...
position p;
@@
 const struct irq_class cocci_id@p [ ] ;
