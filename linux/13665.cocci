...
position p;
@@
 enum hdcs_power_state cocci_id@p ;
...
position p;
@@
 enum hdcs_power_state { HDCS_STATE_SLEEP , HDCS_STATE_IDLE , HDCS_STATE_RUN , } cocci_id@p ;
