...
position p;
@@
 const struct ar9300_eeprom cocci_id@p ;
...
typedef s32;
@@
 s32 cocci_id@p [ AR9300_NUM_2G_CCK_TARGET_POWERS ] ;
...
position p;
@@
 const struct eeprom_ops cocci_id@p ;
...
position p;
@@
 struct ar9300_eeprom cocci_id@p ;
...
typedef s32;
@@
 s32 cocci_id@p [ AR9300_NUM_5G_40_TARGET_POWERS ] ;
...
position p;
@@
 struct cal_ctl_data_2g * cocci_id@p ;
...
position p;
@@
 struct ath9k_hw_capabilities * cocci_id@p ;
...
position p;
@@
 struct ar9300_modal_eep_header * cocci_id@p ;
...
position p;
@@
 struct cal_ctl_data_5g * cocci_id@p ;
...
position p;
@@
 struct ar9300_base_eep_hdr * cocci_id@p ;
...
position p;
@@
 struct chan_centers cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ AR9300_MAX_CHAINS ] ;
...
position p;
@@
 struct cal_tgt_pow_ht * cocci_id@p ;
...
position p;
@@
 struct cal_tgt_pow_legacy * cocci_id@p ;
...
position p;
@@
 struct ar9300_cal_data_per_freq_op_loop * cocci_id@p ;
...
typedef u8,bool;
@@
 bool ( * cocci_id@p ) ( struct ath_hw * ah , int address , u8 * buffer , int count ) ;
...
typedef u_int32_t;
@@
 const u_int32_t cocci_id@p [ AR9300_MAX_CHAINS ] ;
...
typedef s32;
@@
 s32 cocci_id@p [ AR9300_NUM_5G_20_TARGET_POWERS ] ;
...
position p;
@@
 int cocci_id@p [ AR9300_MAX_CHAINS ] ;
