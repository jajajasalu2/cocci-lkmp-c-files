...
position p;
@@
 enum cpuacct_stat_index { CPUACCT_STAT_USER , CPUACCT_STAT_SYSTEM , CPUACCT_STAT_NSTATS , } cocci_id@p ;
...
position p;
@@
 struct cpuacct_usage cocci_id@p ;
...
position p;
@@
 enum cpuacct_stat_index cocci_id@p ;
...
typedef u64;
@@
 struct cpuacct_usage {  u64 usages [ CPUACCT_STAT_NSTATS ] ; } cocci_id@p ;
...
position p;
@@
 struct cpuacct {  struct cgroup_subsys_state css ;  struct cpuacct_usage __percpu * cpuusage ;  struct kernel_cpustat __percpu * cpustat ; } cocci_id@p ;
...
typedef s64;
@@
 s64 cocci_id@p [ CPUACCT_STAT_NSTATS ] ;
