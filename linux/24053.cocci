...
position p;
@@
 struct meta_tlvhdr {  __be16 type ;  __be16 len ; } cocci_id@p ;
...
position p;
@@
 const struct meta_tlvhdr * cocci_id@p ;
...
typedef u8;
@@
 struct ifeheadr {  __be16 metalen ;  u8 tlv_data [ ] ; } cocci_id@p ;
