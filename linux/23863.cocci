...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_VLAN_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_VLAN_MAX + 1 ] ;
...
position p;
@@
 struct tcf_vlan_params * cocci_id@p ;
