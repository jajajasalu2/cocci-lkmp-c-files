...
position p;
@@
 struct xen_snd_front_evtchnl_pair cocci_id@p ;
...
position p;
@@
 enum xen_snd_front_evtchnl_state cocci_id@p ;
...
position p;
@@
 struct xensnd_event_page * cocci_id@p ;
...
position p;
@@
 enum xen_snd_front_evtchnl_type cocci_id@p ;
...
position p;
@@
 struct xen_sndif_sring * cocci_id@p ;
