...
position p;
@@
 struct ceph_mds_client cocci_id@p ;
...
position p;
@@
 struct ceph_mds_info * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_reply_head * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_request_head * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_session_head * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_lease * cocci_id@p ;
...
position p;
@@
 struct ceph_cap_snap * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_reply_info_in * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_reply_info_parsed * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_request * cocci_id@p ;
...
position p;
@@
 struct ceph_mount_options * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_reply_dirfrag * * cocci_id@p ;
...
position p;
@@
 struct ceph_filelock * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_reply_dir_entry cocci_id@p ;
...
position p;
@@
 struct ceph_mds_cap_item * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_session * cocci_id@p ;
...
position p;
@@
 union {  struct ceph_mds_cap_reconnect v2 ;  struct ceph_mds_cap_reconnect_v1 v1 ; } cocci_id@p ;
...
position p;
@@
 struct ceph_cap_flush * cocci_id@p ;
...
position p;
@@
 struct ceph_snap_realm cocci_id@p ;
...
position p;
@@
 struct ceph_mds_cap_release * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct inode * , struct ceph_cap * , void * ) ;
...
position p;
@@
 struct ceph_mds_request_release cocci_id@p ;
...
position p;
@@
 struct ceph_fs_client * cocci_id@p ;
...
position p;
@@
 enum { RECONNECT , RENEWCAPS , FORCE_RO , } cocci_id@p ;
...
position p;
@@
 struct ceph_inode_frag cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ceph_mds_client * mdsc , struct list_head * head ) ;
...
position p;
@@
 struct ceph_mds_reply_lease * * cocci_id@p ;
...
position p;
@@
 struct ceph_dentry_info * cocci_id@p ;
...
position p;
@@
 struct ceph_reconnect_state cocci_id@p ;
...
position p;
@@
 struct ceph_mds_reply_inode cocci_id@p ;
...
position p;
@@
 struct ceph_mds_snaprealm_reconnect cocci_id@p ;
...
position p;
@@
 struct ceph_inode_info * cocci_id@p ;
