...
position p;
@@
 struct kbl_codec_private * cocci_id@p ;
...
position p;
@@
 struct kbl_codec_private {  struct snd_soc_jack kabylake_headset ;  struct list_head hdmi_pcm_list ; } cocci_id@p ;
...
position p;
@@
 enum { KBL_DPCM_AUDIO_PB = 0 , KBL_DPCM_AUDIO_ECHO_REF_CP , KBL_DPCM_AUDIO_REF_CP , KBL_DPCM_AUDIO_DMIC_CP , KBL_DPCM_AUDIO_HDMI1_PB , KBL_DPCM_AUDIO_HDMI2_PB , KBL_DPCM_AUDIO_HDMI3_PB , KBL_DPCM_AUDIO_HS_PB , KBL_DPCM_AUDIO_CP , } cocci_id@p ;
