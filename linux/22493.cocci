...
position p;
@@
 struct ali_pcm_description cocci_id@p [ ] ;
...
position p;
@@
 struct snd_ali_voice * cocci_id@p ;
...
typedef u32;
@@
 struct snd_ali_image {  u32 regs [ ALI_GLOBAL_REGS ] ;  u32 channel_regs [ ALI_CHANNELS ] [ ALI_CHANNEL_REGS ] ; } cocci_id@p ;
...
position p;
@@
 unsigned short cocci_id@p ( struct snd_ali * , int , unsigned short ) ;
...
position p;
@@
 struct snd_alidev {  struct snd_ali_voice voices [ ALI_CHANNELS ] ;  unsigned int chcnt ;  unsigned int chmap ;  unsigned int synthcount ; } cocci_id@p ;
...
position p;
@@
 struct snd_ali_channel_control {  struct REGDATA {  unsigned int start ;  unsigned int stop ;  unsigned int aint ;  unsigned int ainten ; } data ;  struct REGS {  unsigned int start ;  unsigned int stop ;  unsigned int aint ;  unsigned int ainten ;  unsigned int ac97read ;  unsigned int ac97write ; } regs ; } cocci_id@p ;
...
position p;
@@
 struct ali_pcm_description {  char * name ;  unsigned int playback_num ;  unsigned int capture_num ;  const struct snd_pcm_ops * playback_ops ;  const struct snd_pcm_ops * capture_ops ;  unsigned short class ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_ali * , int , unsigned short , unsigned short ) ;
...
position p;
@@
 struct snd_ali_image * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snd_ali * , unsigned int , unsigned int ) ;
...
position p;
@@
 struct snd_ali_channel_control * cocci_id@p ;
