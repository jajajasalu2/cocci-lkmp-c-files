...
position p;
@@
 void cocci_id@p ( struct snd_ac97 * ac97 ) ;
...
position p;
@@
 const struct snd_kcontrol_new cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct ac97_codec_id * cocci_id@p ;
...
position p;
@@
 struct ac97_power_reg cocci_id@p [ PWIDX_SIZE ] ;
...
position p;
@@
 const struct snd_ac97_build_ops cocci_id@p ;
...
position p;
@@
 enum { AC97_GENERAL_PCM_OUT = 0 , AC97_GENERAL_STEREO_ENHANCEMENT , AC97_GENERAL_3D , AC97_GENERAL_LOUDNESS , AC97_GENERAL_MONO , AC97_GENERAL_MIC , AC97_GENERAL_LOOPBACK , } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct snd_ac97 * ac97 ) ;
...
position p;
@@
 const struct ac97_enum cocci_id@p [ ] ;
...
position p;
@@
 const struct snd_kcontrol_new cocci_id@p [ 7 ] ;
...
position p;
@@
 struct ac97_codec_id {  unsigned int id ;  unsigned int mask ;  const char * name ;  int ( * patch ) ( struct snd_ac97 * ac97 ) ;  int ( * mpatch ) ( struct snd_ac97 * ac97 ) ;  unsigned int flags ; } cocci_id@p ;
...
position p;
@@
 enum { PWIDX_ADC , PWIDX_FRONT , PWIDX_CLFE , PWIDX_SURR , PWIDX_MIC , PWIDX_SIZE , } cocci_id@p ;
...
position p;
@@
 struct ac97_power_reg {  unsigned short reg ;  unsigned short power_reg ;  unsigned short mask ; } cocci_id@p ;
...
position p;
@@
 struct quirk_table {  const char * name ;  int ( * func ) ( struct snd_ac97 * ) ; } cocci_id@p ;
...
position p;
@@
 const struct snd_kcontrol_new cocci_id@p [ 5 ] ;
