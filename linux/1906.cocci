...
typedef u32;
@@
 struct hx711_data {  struct device * dev ;  struct gpio_desc * gpiod_pd_sck ;  struct gpio_desc * gpiod_dout ;  struct regulator * reg_avdd ;  int gain_set ;  int gain_chan_a ;  struct mutex lock ;  u32 buffer [ 4 ] ;  u32 data_ready_delay_ns ;  u32 clock_frequency ; } cocci_id@p ;
...
position p;
@@
 struct hx711_gain_to_scale {  int gain ;  int gain_pulse ;  int scale ;  int channel ; } cocci_id@p ;
...
position p;
@@
 struct hx711_gain_to_scale cocci_id@p [ HX711_GAIN_MAX ] ;
