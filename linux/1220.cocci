...
position p;
@@
 struct fsl_usb2_dev_data * cocci_id@p ;
...
position p;
@@
 enum fsl_usb2_phy_modes cocci_id@p ;
...
position p;
@@
 enum fsl_usb2_controller_ver cocci_id@p ;
...
position p;
@@
 struct fsl_usb2_dev_data {  char * dr_mode ;  char * drivers [ 3 ] ;  enum fsl_usb2_operating_modes op_mode ; } cocci_id@p ;
