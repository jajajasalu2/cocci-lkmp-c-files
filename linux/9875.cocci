...
position p;
@@
 struct ath9k_eeprom_ctx * cocci_id@p ;
...
position p;
@@
 struct ath9k_platform_data * cocci_id@p ;
...
position p;
@@
 const struct ath_ps_ops cocci_id@p ;
...
position p;
@@
 struct ath9k_eeprom_ctx {  struct completion complete ;  struct ath_hw * ah ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ath_softc * sc ) ;
