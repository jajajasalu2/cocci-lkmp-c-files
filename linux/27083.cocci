...
position p;
@@
 struct xchk_dir_ctx {  struct dir_context dir_iter ;  struct xfs_scrub * sc ; } cocci_id@p ;
...
position p;
@@
 struct xchk_dir_ctx * cocci_id@p ;
...
position p;
@@
 struct xchk_da_btree * cocci_id@p ;
