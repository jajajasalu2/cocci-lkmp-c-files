...
typedef bool;
@@
 void cocci_id@p ( struct radeon_device * rdev , bool gate ) ;
...
position p;
@@
 void cocci_id@p ( struct radeon_device * rdev , struct radeon_ps * new_rps , struct radeon_ps * old_rps ) ;
...
position p;
@@
 int cocci_id@p ( struct radeon_device * rdev , int min_temp , int max_temp ) ;
...
position p;
@@
 void cocci_id@p ( struct radeon_device * rdev , struct radeon_ps * new_rps ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct radeon_device * rdev , u32 level ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct radeon_device * rdev , bool enable ) ;
...
position p;
@@
 const struct kv_lcac_config_reg cocci_id@p [ ] ;
...
position p;
@@
 const struct kv_lcac_config_values cocci_id@p [ ] ;
