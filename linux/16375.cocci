...
position p;
@@
 const struct kovaplus_device * cocci_id@p ;
...
position p;
@@
 enum kovaplus_control_requests cocci_id@p ;
...
position p;
@@
 struct roccat_common2_control cocci_id@p ;
...
position p;
@@
 struct kovaplus_device * cocci_id@p ;
...
position p;
@@
 const struct kovaplus_mouse_report_button * cocci_id@p ;
...
position p;
@@
 struct kovaplus_profile_settings * cocci_id@p ;
...
position p;
@@
 struct kovaplus_info cocci_id@p ;
...
position p;
@@
 struct kovaplus_actual_profile cocci_id@p ;
...
position p;
@@
 struct kovaplus_profile_buttons * cocci_id@p ;
...
position p;
@@
 struct kovaplus_roccat_report cocci_id@p ;
