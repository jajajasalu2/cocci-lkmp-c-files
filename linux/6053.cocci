...
position p;
@@
 struct spear_modemux cocci_id@p [ ] [ 1 ] ;
...
position p;
@@
 struct spear_function * cocci_id@p [ ] ;
...
position p;
@@
 struct spear_modemux cocci_id@p [ ] [ 3 ] ;
...
position p;
@@
 struct spear_modemux cocci_id@p [ ] [ 2 ] ;
