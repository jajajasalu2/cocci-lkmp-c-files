...
position p;
@@
 struct snd_card_asihpi * cocci_id@p ;
...
position p;
@@
 short cocci_id@p [ HPI_MAX_CHANNELS ] ;
...
position p;
@@
 struct clk_source {  int source ;  int index ;  const char * name ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct snd_card_asihpi {  struct snd_card * card ;  struct pci_dev * pci ;  struct hpi_adapter * hpi ;  struct snd_card_asihpi_pcm * llmode_streampriv ;  struct tasklet_struct t ;  void ( * pcm_start ) ( struct snd_pcm_substream * substream ) ;  void ( * pcm_stop ) ( struct snd_pcm_substream * substream ) ;  u32 h_mixer ;  struct clk_cache cc ;  u16 can_dma ;  u16 support_grouping ;  u16 support_mrx ;  u16 update_interval_frames ;  u16 in_max_chans ;  u16 out_max_chans ;  u16 in_min_chans ;  u16 out_min_chans ; } cocci_id@p ;
...
typedef u32;
@@
 struct snd_card_asihpi_pcm {  struct timer_list timer ;  unsigned int respawn_timer ;  unsigned int hpi_buffer_attached ;  unsigned int buffer_bytes ;  unsigned int period_bytes ;  unsigned int bytes_per_sec ;  unsigned int pcm_buf_host_rw_ofs ;  unsigned int pcm_buf_dma_ofs ;  unsigned int pcm_buf_elapsed_dma_ofs ;  unsigned int drained_count ;  struct snd_pcm_substream * substream ;  u32 h_stream ;  struct hpi_format format ; } cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ HPI_CHANNEL_MODE_LAST + 1 ] ;
...
typedef u16;
@@
 u16 cocci_id@p [ HPI_TUNER_BAND_LAST ] ;
...
typedef u32,u16;
@@
 struct hpi_control {  u32 h_control ;  u16 control_type ;  u16 src_node_type ;  u16 src_node_index ;  u16 dst_node_type ;  u16 dst_node_index ;  u16 band ;  char name [ SNDRV_CTL_ELEM_ID_NAME_MAXLEN ] ; } cocci_id@p ;
...
position p;
@@
 struct hpi_response cocci_id@p ;
...
position p;
@@
 struct snd_card_asihpi_pcm * cocci_id@p ;
...
position p;
@@
 struct clk_cache {  int count ;  int has_local ;  struct clk_source s [ MAX_CLOCKSOURCES ] ; } cocci_id@p ;
