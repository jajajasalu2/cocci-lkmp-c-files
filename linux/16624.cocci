...
position p;
@@
 int cocci_id@p ( struct lcs_card * , struct lcs_ipm_list * ) ;
...
position p;
@@
 struct lcs_ip_mac_pair cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct lcs_card * , struct lcs_cmd * ) ;
...
position p;
@@
 struct lcs_ipm_list cocci_id@p ;
...
position p;
@@
 enum lcs_dev_states cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lcs_channel * , struct lcs_buffer * ) ;
