...
position p;
@@
 struct fcloop_ini_fcpreq cocci_id@p ;
...
position p;
@@
 struct fcloop_ctrl_options * cocci_id@p ;
...
position p;
@@
 struct fcloop_tport {  struct nvmet_fc_target_port * targetport ;  struct nvme_fc_remote_port * remoteport ;  struct fcloop_nport * nport ;  struct fcloop_lport * lport ; } cocci_id@p ;
...
position p;
@@
 struct fcloop_rport {  struct nvme_fc_remote_port * remoteport ;  struct nvmet_fc_target_port * targetport ;  struct fcloop_nport * nport ;  struct fcloop_lport * lport ; } cocci_id@p ;
...
position p;
@@
 struct fcloop_tport cocci_id@p ;
...
position p;
@@
 struct fcloop_nport * cocci_id@p ;
...
position p;
@@
 struct fcloop_fcpreq cocci_id@p ;
...
position p;
@@
 struct fcloop_lsreq cocci_id@p ;
...
typedef u64,u32;
@@
 struct fcloop_ctrl_options {  int mask ;  u64 wwnn ;  u64 wwpn ;  u32 roles ;  u32 fcaddr ;  u64 lpwwnn ;  u64 lpwwpn ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct fcloop_ini_fcpreq {  struct nvmefc_fcp_req * fcpreq ;  struct fcloop_fcpreq * tfcp_req ;  spinlock_t inilock ; } cocci_id@p ;
...
position p;
@@
 struct fcloop_lport {  struct nvme_fc_local_port * localport ;  struct list_head lport_list ;  struct completion unreg_done ; } cocci_id@p ;
...
position p;
@@
 struct fcloop_lsreq {  struct fcloop_tport * tport ;  struct nvmefc_ls_req * lsreq ;  struct work_struct work ;  struct nvmefc_tgt_ls_req tgt_ls_req ;  int status ; } cocci_id@p ;
...
position p;
@@
 struct fcloop_lport * cocci_id@p ;
...
position p;
@@
 struct fcloop_lport_priv {  struct fcloop_lport * lport ; } cocci_id@p ;
...
position p;
@@
 enum { INI_IO_START = 0 , INI_IO_ACTIVE = 1 , INI_IO_ABORTED = 2 , INI_IO_COMPLETED = 3 , } cocci_id@p ;
...
position p;
@@
 struct fcloop_lport_priv * cocci_id@p ;
...
position p;
@@
 enum { NVMF_OPT_ERR = 0 , NVMF_OPT_WWNN = 1 << 0 , NVMF_OPT_WWPN = 1 << 1 , NVMF_OPT_ROLES = 1 << 2 , NVMF_OPT_FCADDR = 1 << 3 , NVMF_OPT_LPWWNN = 1 << 4 , NVMF_OPT_LPWWPN = 1 << 5 , } cocci_id@p ;
...
position p;
@@
 struct fcloop_rscn {  struct fcloop_tport * tport ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct fcloop_rport cocci_id@p ;
...
typedef u64,u32;
@@
 struct fcloop_nport {  struct fcloop_rport * rport ;  struct fcloop_tport * tport ;  struct fcloop_lport * lport ;  struct list_head nport_list ;  struct kref ref ;  u64 node_name ;  u64 port_name ;  u32 port_role ;  u32 port_id ; } cocci_id@p ;
