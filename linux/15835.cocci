...
typedef u8;
@@
 u8 cocci_id@p [ EFUSE_MAX_MAP_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ EFUSE_BT_MAX_MAP_LEN ] ;
...
typedef u8,bool;
@@
 void cocci_id@p ( struct adapter * padapter , u8 efuseType , u8 * Efuse , bool bPseudoTest ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ EFUSE_MAX_HW_SIZE ] ;
...
typedef u8,bool,u16;
@@
 bool cocci_id@p ( struct adapter * padapter , u16 Offset , u8 * Value ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ EFUSE_MAX_BT_BANK ] [ EFUSE_MAX_HW_SIZE ] ;
...
typedef u8,bool,u16;
@@
 void cocci_id@p ( struct adapter * Adapter , u8 efuseType , u16 _offset , u16 _size_byte , u8 * pbuf , bool bPseudoTest ) ;
