...
position p;
@@
 struct xgbe_ring_desc * cocci_id@p ;
...
position p;
@@
 struct xgbe_hw_features * cocci_id@p ;
...
position p;
@@
 struct xgbe_desc_if * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xgbe_prv_data * ) ;
...
position p;
@@
 struct xgbe_channel * cocci_id@p ;
...
position p;
@@
 struct xgbe_packet_data * cocci_id@p ;
...
position p;
@@
 struct xgbe_mmc_stats * cocci_id@p ;
...
position p;
@@
 struct xgbe_vxlan_data * cocci_id@p ;
...
position p;
@@
 struct xgbe_ring_data * cocci_id@p ;
