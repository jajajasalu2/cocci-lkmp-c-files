...
position p;
@@
 struct uniphier_system_bus_priv * cocci_id@p ;
...
typedef u32;
@@
 struct uniphier_system_bus_bank {  u32 base ;  u32 end ; } cocci_id@p ;
...
position p;
@@
 const struct uniphier_system_bus_priv * cocci_id@p ;
...
position p;
@@
 struct uniphier_system_bus_priv {  struct device * dev ;  void __iomem * membase ;  struct uniphier_system_bus_bank bank [ UNIPHIER_SBC_NR_BANKS ] ; } cocci_id@p ;
