...
position p;
@@
 struct meson8b_dwmac cocci_id@p ;
...
position p;
@@
 const struct meson8b_dwmac_data cocci_id@p ;
...
position p;
@@
 struct meson8b_dwmac_clk_configs {  struct clk_mux m250_mux ;  struct clk_divider m250_div ;  struct clk_fixed_factor fixed_div2 ;  struct clk_gate rgmii_tx_en ; } cocci_id@p ;
...
position p;
@@
 struct meson8b_dwmac_data {  int ( * set_phy_mode ) ( struct meson8b_dwmac * dwmac ) ; } cocci_id@p ;
...
position p;
@@
 struct meson8b_dwmac_clk_configs * cocci_id@p ;
...
@@
 struct meson8b_dwmac {  struct device * dev ;  void __iomem * regs ;  const struct meson8b_dwmac_data * data ;  phy_interface_t phy_mode ;  struct clk * rgmii_tx_clk ;  u32 tx_delay_ns ; } cocci_id@p ;
