...
position p;
@@
 struct erase_info_user cocci_id@p ;
...
position p;
@@
 struct mtd_oob_buf64 cocci_id@p ;
...
position p;
@@
 struct nand_ecclayout_user * cocci_id@p ;
...
position p;
@@
 struct nand_oobinfo * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_caddr_t,u_int32_t;
@@
 struct mtd_oob_buf32 {  u_int32_t start ;  u_int32_t length ;  compat_caddr_t ptr ; } cocci_id@p ;
...
position p;
@@
 struct blkpg_ioctl_arg * cocci_id@p ;
...
position p;
@@
 struct mtd_info_user cocci_id@p ;
...
position p;
@@
 struct blkpg_partition cocci_id@p ;
...
position p;
@@
 struct mtd_write_req cocci_id@p ;
...
position p;
@@
 struct mtd_file_info {  struct mtd_info * mtd ;  enum mtd_file_modes mode ; } cocci_id@p ;
...
position p;
@@
 struct mtd_file_info * cocci_id@p ;
...
position p;
@@
 struct blkpg_compat_ioctl_arg cocci_id@p ;
...
position p;
@@
 struct mtd_oob_buf32 cocci_id@p ;
...
position p;
@@
 struct erase_info_user64 cocci_id@p ;
