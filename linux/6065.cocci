...
position p;
@@
 struct imx_sc_msg_req_pad_get cocci_id@p ;
...
position p;
@@
 enum pad_func_e { IMX_SC_PAD_FUNC_SET = 15 , IMX_SC_PAD_FUNC_GET = 16 , } cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_req_pad_set cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_resp_pad_get * cocci_id@p ;
