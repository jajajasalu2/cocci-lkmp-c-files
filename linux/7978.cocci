...
position p;
@@
 struct xenvif_stats cocci_id@p ;
...
typedef u16;
@@
 const struct xenvif_stat {  char name [ ETH_GSTRING_LEN ] ;  u16 offset ; } cocci_id@p [ ] ;
...
position p;
@@
 struct xenvif_rx_cb * cocci_id@p ;
...
position p;
@@
 struct xen_netif_ctrl_sring * cocci_id@p ;
