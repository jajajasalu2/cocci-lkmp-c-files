...
position p;
@@
 const struct irq_name_pair cocci_id@p [ ] ;
...
position p;
@@
 struct linear_range {  int min ;  int step ;  int vals ;  int low_sel ; } cocci_id@p ;
...
position p;
@@
 struct bd70528_psy {  struct regmap * regmap ;  struct device * dev ;  struct power_supply * psy ; } cocci_id@p ;
...
position p;
@@
 const struct linear_range cocci_id@p [ ] ;
...
typedef irqreturn_t;
@@
 struct irq_name_pair {  const char * n ;  irqreturn_t ( * h ) ( int irq , void * arg ) ; } cocci_id@p ;
