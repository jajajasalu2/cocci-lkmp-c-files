...
position p;
@@
 struct drm_virtgpu_map * cocci_id@p ;
...
position p;
@@
 struct drm_virtgpu_getparam * cocci_id@p ;
...
position p;
@@
 struct drm_virtgpu_3d_transfer_to_host * cocci_id@p ;
...
position p;
@@
 struct drm_ioctl_desc cocci_id@p [ DRM_VIRTIO_NUM_IOCTLS ] ;
...
position p;
@@
 struct virtio_gpu_fpriv * cocci_id@p ;
...
position p;
@@
 const struct drm_virtgpu_3d_box * cocci_id@p ;
...
position p;
@@
 struct drm_virtgpu_resource_create * cocci_id@p ;
...
position p;
@@
 struct drm_virtgpu_get_caps * cocci_id@p ;
...
position p;
@@
 struct drm_virtgpu_execbuffer * cocci_id@p ;
...
position p;
@@
 struct drm_virtgpu_3d_transfer_from_host * cocci_id@p ;
...
position p;
@@
 struct drm_virtgpu_3d_wait * cocci_id@p ;
...
position p;
@@
 struct drm_virtgpu_resource_info * cocci_id@p ;
