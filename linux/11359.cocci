...
position p;
@@
 struct panel_bridge cocci_id@p ;
...
typedef u32;
@@
 struct panel_bridge {  struct drm_bridge bridge ;  struct drm_connector connector ;  struct drm_panel * panel ;  u32 connector_type ; } cocci_id@p ;
