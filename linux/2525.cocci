...
position p;
@@
 struct bitmap_storage * cocci_id@p ;
...
position p;
@@
 enum bitmap_page_attr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bitmap_counter_t;
@@
 bitmap_counter_t * cocci_id@p ;
...
position p;
@@
 enum bitmap_page_attr { BITMAP_PAGE_DIRTY = 0 , BITMAP_PAGE_PENDING = 1 , BITMAP_PAGE_NEEDWRITE = 2 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bitmap * bitmap ) ;
