...
position p;
@@
 struct wbt_wait_data * cocci_id@p ;
...
position p;
@@
 enum { RWB_DEF_DEPTH = 16 , RWB_WINDOW_NSEC = 100 * 1000 * 1000ULL , RWB_MIN_WRITE_SAMPLES = 3 , RWB_UNKNOWN_BUMP = 5 , } cocci_id@p ;
...
position p;
@@
 struct wbt_wait_data {  struct rq_wb * rwb ;  enum wbt_flags wb_acct ;  unsigned long rw ; } cocci_id@p ;
...
position p;
@@
 enum { LAT_OK = 1 , LAT_UNKNOWN , LAT_UNKNOWN_WRITES , LAT_EXCEEDED , } cocci_id@p ;
