...
position p;
@@
 enum mt7530_fdb_cmd cocci_id@p ;
...
position p;
@@
 const struct mt7530_mib_desc * cocci_id@p ;
...
position p;
@@
 struct mt7530_hw_vlan_entry cocci_id@p ;
...
position p;
@@
 enum mt7530_vlan_cmd cocci_id@p ;
...
position p;
@@
 struct mt7530_dummy_poll cocci_id@p ;
