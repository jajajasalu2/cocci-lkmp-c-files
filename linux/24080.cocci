...
position p;
@@
 const struct gss_auth * cocci_id@p ;
...
position p;
@@
 const struct rpc_pipe_dir_object_ops cocci_id@p ;
...
position p;
@@
 const struct rpc_pipe_ops cocci_id@p ;
...
position p;
@@
 const struct rpc_authops cocci_id@p ;
...
position p;
@@
 struct rpc_wait_queue cocci_id@p ;
...
position p;
@@
 struct gss_alloc_pdo cocci_id@p ;
...
position p;
@@
 const struct rpc_credops cocci_id@p ;
...
position p;
@@
 struct rpc_pipe_dir_object * cocci_id@p ;
...
position p;
@@
 struct rpc_xprt_switch * cocci_id@p ;
...
position p;
@@
 struct gss_upcall_msg cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gss_auth * gss_auth ) ;
...
position p;
@@
 struct gss_api_mech * cocci_id@p ;
...
position p;
@@
 struct rpc_pipe_msg * cocci_id@p ;
...
position p;
@@
 struct gss_auth {  struct kref kref ;  struct hlist_node hash ;  struct rpc_auth rpc_auth ;  struct gss_api_mech * mech ;  enum rpc_gss_svc service ;  struct rpc_clnt * client ;  struct net * net ;  struct gss_pipe * gss_pipe [ 2 ] ;  const char * target_name ; } cocci_id@p ;
...
position p;
@@
 struct gss_pipe {  struct rpc_pipe_dir_object pdo ;  struct rpc_pipe * pipe ;  struct rpc_clnt * clnt ;  const char * name ;  struct kref kref ; } cocci_id@p ;
...
position p;
@@
 const struct rpc_auth_create_args * cocci_id@p ;
...
position p;
@@
 struct gss_alloc_pdo {  struct rpc_clnt * clnt ;  const char * name ;  const struct rpc_pipe_ops * upcall_ops ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef kuid_t,wait_queue_head_t,refcount_t;
@@
 struct gss_upcall_msg {  refcount_t count ;  kuid_t uid ;  const char * service_name ;  struct rpc_pipe_msg msg ;  struct list_head list ;  struct gss_auth * auth ;  struct rpc_pipe * pipe ;  struct rpc_wait_queue rpc_waitqueue ;  wait_queue_head_t waitqueue ;  struct gss_cl_ctx * ctx ;  char databuf [ UPCALL_BUF_LEN ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gss_cl_ctx * ) ;
