...
position p;
@@
 const struct _wm8350_audio cocci_id@p [ ] ;
...
typedef snd_pcm_format_t;
@@
 struct _wm8350_audio {  unsigned int channels ;  snd_pcm_format_t format ;  unsigned int rate ;  unsigned int sysclk ;  unsigned int bclkdiv ;  unsigned int clkdiv ;  unsigned int lr_rate ; } cocci_id@p ;
