...
position p;
@@
 enum hdac_ext_stream_type cocci_id@p ;
...
position p;
@@
 struct snd_pcm_audio_tstamp_config * cocci_id@p ;
...
position p;
@@
 struct skl_dma_params * cocci_id@p ;
...
position p;
@@
 struct snd_pcm_audio_tstamp_report * cocci_id@p ;
