...
position p;
@@
 union {  struct nvif_control_pstate_info_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 struct nvkm_control * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_control_pstate_user_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_control_pstate_attr_v0 v0 ; } * cocci_id@p ;
