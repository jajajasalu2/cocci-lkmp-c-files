...
position p;
@@
 struct rmobile_pm_domain * cocci_id@p ;
...
position p;
@@
 struct rmobile_pm_domain {  struct generic_pm_domain genpd ;  struct dev_power_governor * gov ;  int ( * suspend ) ( void ) ;  void __iomem * base ;  unsigned int bit_shift ; } cocci_id@p ;
...
position p;
@@
 enum pd_types { PD_NORMAL , PD_CPU , PD_CONSOLE , PD_DEBUG , PD_MEMCTL , } cocci_id@p ;
