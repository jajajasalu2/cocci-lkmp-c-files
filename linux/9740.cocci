...
position p;
@@
 struct iwl_tdls_channel_switch_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_tdls_channel_switch_notif * cocci_id@p ;
...
position p;
@@
 enum iwl_tdls_channel_switch_type cocci_id@p ;
...
position p;
@@
 struct iwl_tdls_config_cmd cocci_id@p ;
...
position p;
@@
 enum iwl_mvm_tdls_cs_state cocci_id@p ;
...
position p;
@@
 struct iwl_tdls_channel_switch_cmd_tail * cocci_id@p ;
...
position p;
@@
 struct iwl_tdls_config_res * cocci_id@p ;
