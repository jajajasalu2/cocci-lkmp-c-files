...
position p;
@@
 void cocci_id@p ( int vsr , void * p ) ;
...
typedef u8;
@@
 union {  unsigned int u ;  float f ;  double d [ 2 ] ;  unsigned long l [ 2 ] ;  u8 b [ 2 * sizeof ( double ) ] ; } cocci_id@p ;
...
position p;
@@
 const struct pt_regs * cocci_id@p ;
...
position p;
@@
 struct instruction_op * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const double * dp , float * sp ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long ea , unsigned long val0 , unsigned long val1 , unsigned int * crp ) ;
...
position p;
@@
 void cocci_id@p ( int rn , __vector128 * p ) ;
...
typedef u8;
@@
 union {  unsigned long ul ;  u8 b [ sizeof ( unsigned long ) ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int vsr , const void * p ) ;
...
typedef u8;
@@
 union {  __vector128 v ;  u8 b [ sizeof ( __vector128 ) ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const float * sp , double * dp ) ;
...
position p;
@@
 void cocci_id@p ( int rn , double * p ) ;
...
position p;
@@
 const union vsx_reg * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long ea , unsigned long * regs ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long ea , unsigned long val0 , unsigned long val1 ) ;
...
typedef u8;
@@
 union {  int i ;  unsigned int u ;  float f ;  double d [ 2 ] ;  unsigned long l [ 2 ] ;  u8 b [ 2 * sizeof ( double ) ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int rn , const double * p ) ;
