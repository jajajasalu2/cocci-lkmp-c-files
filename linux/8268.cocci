...
position p;
@@
 enum ef4_farch_filter_index { EF4_FARCH_FILTER_INDEX_UC_DEF , EF4_FARCH_FILTER_INDEX_MC_DEF , EF4_FARCH_FILTER_SIZE_RX_DEF , } cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct ef4_channel * channel , u32 magic ) ;
...
position p;
@@
 enum ef4_farch_filter_table_id cocci_id@p ;
...
position p;
@@
 struct ef4_farch_filter_table * cocci_id@p ;
...
position p;
@@
 enum ef4_farch_filter_type { EF4_FARCH_FILTER_TCP_FULL = 0 , EF4_FARCH_FILTER_TCP_WILD , EF4_FARCH_FILTER_UDP_FULL , EF4_FARCH_FILTER_UDP_WILD , EF4_FARCH_FILTER_MAC_FULL = 4 , EF4_FARCH_FILTER_MAC_WILD , EF4_FARCH_FILTER_UC_DEF = 8 , EF4_FARCH_FILTER_MC_DEF , EF4_FARCH_FILTER_TYPE_COUNT , } cocci_id@p ;
...
position p;
@@
 struct falcon_nic_data * cocci_id@p ;
...
position p;
@@
 struct ef4_tx_buffer * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct ef4_farch_filter_spec {  u8 type : 4 ;  u8 priority : 4 ;  u8 flags ;  u16 dmaq_id ;  u32 data [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 const struct ef4_farch_register_test * cocci_id@p ;
...
position p;
@@
 union ef4_multicast_hash * cocci_id@p ;
...
position p;
@@
 enum ef4_farch_filter_table_id { EF4_FARCH_FILTER_TABLE_RX_IP = 0 , EF4_FARCH_FILTER_TABLE_RX_MAC , EF4_FARCH_FILTER_TABLE_RX_DEF , EF4_FARCH_FILTER_TABLE_TX_MAC , EF4_FARCH_FILTER_TABLE_COUNT , } cocci_id@p ;
...
position p;
@@
 struct ef4_filter_spec * cocci_id@p ;
...
position p;
@@
 struct ef4_special_buffer * cocci_id@p ;
...
position p;
@@
 struct ef4_farch_filter_state * cocci_id@p ;
...
position p;
@@
 struct ef4_rx_queue * cocci_id@p ;
...
position p;
@@
 const struct ef4_farch_filter_spec * cocci_id@p ;
...
position p;
@@
 struct ef4_farch_filter_spec * cocci_id@p ;
...
position p;
@@
 enum ef4_filter_priority cocci_id@p ;
...
position p;
@@
 const struct ef4_filter_spec * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ EF4_FARCH_FILTER_TYPE_COUNT ] ;
...
position p;
@@
 struct ef4_tx_queue * cocci_id@p ;
...
position p;
@@
 struct ef4_farch_filter_state {  struct ef4_farch_filter_table table [ EF4_FARCH_FILTER_TABLE_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct ef4_msi_context * cocci_id@p ;
...
position p;
@@
 struct ef4_rx_buffer * cocci_id@p ;
...
typedef u32;
@@
 struct ef4_farch_filter_table {  enum ef4_farch_filter_table_id id ;  u32 offset ;  unsigned size ;  unsigned step ;  unsigned used ;  unsigned long * used_bitmap ;  struct ef4_farch_filter_spec * spec ;  unsigned search_limit [ EF4_FARCH_FILTER_TYPE_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 const enum ef4_farch_filter_table_id cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct ef4_nic * efx , struct ef4_farch_filter_table * table , unsigned int filter_idx ) ;
