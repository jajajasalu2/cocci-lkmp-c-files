...
position p;
@@
 enum ipu_csi_data_width { IPU_CSI_DATA_WIDTH_4 = 0 , IPU_CSI_DATA_WIDTH_8 = 1 , IPU_CSI_DATA_WIDTH_10 = 3 , IPU_CSI_DATA_WIDTH_12 = 5 , IPU_CSI_DATA_WIDTH_16 = 9 , } cocci_id@p ;
...
position p;
@@
 enum ipu_csi_clk_mode { IPU_CSI_CLK_MODE_GATED_CLK , IPU_CSI_CLK_MODE_NONGATED_CLK , IPU_CSI_CLK_MODE_CCIR656_PROGRESSIVE , IPU_CSI_CLK_MODE_CCIR656_INTERLACED , IPU_CSI_CLK_MODE_CCIR1120_PROGRESSIVE_DDR , IPU_CSI_CLK_MODE_CCIR1120_PROGRESSIVE_SDR , IPU_CSI_CLK_MODE_CCIR1120_INTERLACED_DDR , IPU_CSI_CLK_MODE_CCIR1120_INTERLACED_SDR , } cocci_id@p ;
...
position p;
@@
 struct ipu_csi_bus_config cocci_id@p ;
...
@@
 struct ipu_csi {  void __iomem * base ;  int id ;  u32 module ;  struct clk * clk_ipu ;  spinlock_t lock ;  bool inuse ;  struct ipu_soc * ipu ; } cocci_id@p ;
...
position p;
@@
 struct ipu_csi_bus_config {  unsigned data_width : 4 ;  unsigned clk_mode : 3 ;  unsigned ext_vsync : 1 ;  unsigned vsync_pol : 1 ;  unsigned hsync_pol : 1 ;  unsigned pixclk_pol : 1 ;  unsigned data_pol : 1 ;  unsigned sens_clksrc : 1 ;  unsigned pack_tight : 1 ;  unsigned force_eof : 1 ;  unsigned data_en_pol : 1 ;  unsigned data_fmt ;  unsigned mipi_dt ; } cocci_id@p ;
