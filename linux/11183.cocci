...
position p;
@@
 struct xfer_func_reg * cocci_id@p ;
...
position p;
@@
 struct fixed31_32 cocci_id@p [ 12 ] ;
...
position p;
@@
 const struct dc_gamma * cocci_id@p ;
...
position p;
@@
 const struct dpp_grph_csc_adjustment * cocci_id@p ;
...
position p;
@@
 struct dpp_input_csc_matrix cocci_id@p ;
...
position p;
@@
 enum gamut_remap_select cocci_id@p ;
...
position p;
@@
 const struct dpp_input_csc_matrix cocci_id@p [ ] ;
...
position p;
@@
 struct color_matrices_reg cocci_id@p ;
...
position p;
@@
 enum ipp_degamma_mode cocci_id@p ;
