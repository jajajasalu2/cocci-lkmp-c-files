...
typedef u8;
@@
 const u8 cocci_id@p [ CACHE_NR_REGS ] [ CACHE_NR_BANKS ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ DIV_ROUND_UP ( MAX_GPIOS , 8 ) ] ;
...
position p;
@@
 enum { REG_RE , REG_FE , REG_IE , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct stmpe_gpio {  struct gpio_chip chip ;  struct stmpe * stmpe ;  struct device * dev ;  struct mutex irq_lock ;  u32 norequest_mask ;  u8 regs [ CACHE_NR_REGS ] [ CACHE_NR_BANKS ] ;  u8 oldregs [ CACHE_NR_REGS ] [ CACHE_NR_BANKS ] ; } cocci_id@p ;
