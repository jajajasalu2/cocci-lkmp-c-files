...
position p;
@@
 struct csio_iqwr_footer * cocci_id@p ;
...
position p;
@@
 struct csio_qstatus_page * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef iq_handler_t;
@@
 iq_handler_t cocci_id@p ;
