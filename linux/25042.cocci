...
position p;
@@
 struct digital_dep_req_res cocci_id@p ;
...
position p;
@@
 struct digital_psl_req cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct nfc_digital_dev * ddev , struct digital_data_exch * data_exch ) ;
...
position p;
@@
 struct digital_atr_res cocci_id@p ;
...
position p;
@@
 struct digital_psl_res cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nfc_digital_dev * ddev , void * arg , struct sk_buff * resp ) ;
...
position p;
@@
 struct digital_atr_req cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ DIGITAL_NFC_DEP_IN_MAX_WT + 1 ] ;
