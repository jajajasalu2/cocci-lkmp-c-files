...
position p;
@@
 struct ionic_deferred * cocci_id@p ;
...
position p;
@@
 union ionic_notifyq_comp * cocci_id@p ;
...
position p;
@@
 struct ionic_txq_comp cocci_id@p ;
...
position p;
@@
 struct ionic_notifyq_cmd cocci_id@p ;
...
position p;
@@
 struct ionic_deferred_work * cocci_id@p ;
...
position p;
@@
 union ionic_lif_identity * cocci_id@p ;
...
position p;
@@
 union ionic_dev_cmd_comp * cocci_id@p ;
...
position p;
@@
 struct ionic_admin_ctx cocci_id@p ;
...
position p;
@@
 struct ionic_admin_comp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ionic_lif * lif ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct ionic_lif * lif , const u8 * addr ) ;
...
position p;
@@
 struct ionic_lif_stats * cocci_id@p ;
...
position p;
@@
 struct ionic_rxq_desc cocci_id@p ;
...
position p;
@@
 struct ionic_identity * cocci_id@p ;
...
position p;
@@
 struct ionic_rxq_sg_desc cocci_id@p ;
...
position p;
@@
 struct ionic_q_stats cocci_id@p ;
...
position p;
@@
 struct ionic_txq_sg_desc cocci_id@p ;
...
position p;
@@
 struct ionic_intr_info * cocci_id@p ;
...
position p;
@@
 struct ionic_cq_info * cocci_id@p ;
...
position p;
@@
 struct ionic_admin_cmd cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ionic_lif * lif , unsigned int rx_mode ) ;
...
position p;
@@
 struct ionic_rx_filter * cocci_id@p ;
...
position p;
@@
 struct ionic_q_init_comp cocci_id@p ;
...
position p;
@@
 union ionic_lif_config * cocci_id@p ;
...
position p;
@@
 struct ionic_rxq_comp cocci_id@p ;
...
position p;
@@
 struct ionic_lif_init_comp cocci_id@p ;
...
position p;
@@
 struct ionic_txq_desc cocci_id@p ;
