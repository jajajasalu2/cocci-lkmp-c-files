...
position p;
@@
 enum hinic_l3_offload_type cocci_id@p ;
...
position p;
@@
 enum hinic_qp_ctxt_type cocci_id@p ;
...
position p;
@@
 struct hinic_sq_bufdesc cocci_id@p ;
...
position p;
@@
 enum rq_completion_fmt { RQ_COMPLETE_SGE = 1 , } cocci_id@p ;
...
position p;
@@
 struct hinic_sq_wqe * cocci_id@p ;
...
position p;
@@
 struct hinic_sq_ctrl * cocci_id@p ;
...
position p;
@@
 struct hinic_sq_task * cocci_id@p ;
...
position p;
@@
 struct hinic_rq_cqe_sect * cocci_id@p ;
...
position p;
@@
 struct hinic_rq_wqe * cocci_id@p ;
...
position p;
@@
 struct hinic_qp_ctxt_header * cocci_id@p ;
...
position p;
@@
 struct hinic_rq_ctrl * cocci_id@p ;
...
position p;
@@
 struct hinic_sq_ctxt * cocci_id@p ;
...
position p;
@@
 enum sq_wqe_type { SQ_NORMAL_WQE = 0 , } cocci_id@p ;
...
position p;
@@
 struct hinic_rq_bufdesc * cocci_id@p ;
...
position p;
@@
 struct hinic_rq_cqe * cocci_id@p ;
...
position p;
@@
 enum hinic_l4_offload_type cocci_id@p ;
...
position p;
@@
 enum hinic_l4_tunnel_type cocci_id@p ;
...
position p;
@@
 struct hinic_rq_ctxt * cocci_id@p ;
