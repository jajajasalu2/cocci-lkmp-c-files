...
position p;
@@
 const struct spi_byte_chipdef cocci_id@p ;
...
position p;
@@
 struct spi_byte_led {  struct led_classdev ldev ;  struct spi_device * spi ;  char name [ LED_MAX_NAME_SIZE ] ;  struct mutex mutex ;  const struct spi_byte_chipdef * cdef ; } cocci_id@p ;
...
typedef u8;
@@
 struct spi_byte_chipdef {  u8 off_value ;  u8 max_value ; } cocci_id@p ;
...
position p;
@@
 struct spi_byte_led * cocci_id@p ;
