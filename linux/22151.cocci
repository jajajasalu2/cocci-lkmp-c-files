...
position p;
@@
 struct page_address_slot * cocci_id@p ;
...
position p;
@@
 struct page_address_map cocci_id@p [ LAST_PKMAP ] ;
...
position p;
@@
 struct page_address_map * cocci_id@p ;
...
position p;
@@
 struct page_address_map {  struct page * page ;  void * virtual ;  struct list_head list ; } cocci_id@p ;
