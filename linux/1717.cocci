...
position p;
@@
 struct adis16460_chip_info {  unsigned int num_channels ;  const struct iio_chan_spec * channels ;  unsigned int gyro_max_val ;  unsigned int gyro_max_scale ;  unsigned int accel_max_val ;  unsigned int accel_max_scale ; } cocci_id@p ;
...
position p;
@@
 const struct adis16460_chip_info cocci_id@p ;
...
position p;
@@
 enum { ADIS16460_SCAN_GYRO_X , ADIS16460_SCAN_GYRO_Y , ADIS16460_SCAN_GYRO_Z , ADIS16460_SCAN_ACCEL_X , ADIS16460_SCAN_ACCEL_Y , ADIS16460_SCAN_ACCEL_Z , ADIS16460_SCAN_TEMP , } cocci_id@p ;
...
position p;
@@
 struct adis16460 {  const struct adis16460_chip_info * chip_info ;  struct adis adis ; } cocci_id@p ;
