...
position p;
@@
 struct ebt_mark_m_info cocci_id@p ;
...
position p;
@@
 const struct ebt_mark_m_info * cocci_id@p ;
...
position p;
@@
 const struct compat_ebt_mark_m_info * cocci_id@p ;
...
position p;
@@
 struct compat_ebt_mark_m_info cocci_id@p ;
