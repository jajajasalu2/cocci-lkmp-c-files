...
typedef u8,__be32;
@@
 struct arfs_tuple {  __be16 etype ;  u8 ip_proto ;  union {  __be32 src_ipv4 ;  struct in6_addr src_ipv6 ; } ;  union {  __be32 dst_ipv4 ;  struct in6_addr dst_ipv6 ; } ;  __be16 src_port ;  __be16 dst_port ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx5e_priv * priv ) ;
...
position p;
@@
 struct arfs_rule {  struct mlx5e_priv * priv ;  struct work_struct arfs_work ;  struct mlx5_flow_handle * rule ;  struct hlist_node hlist ;  int rxq ;  int flow_id ;  int filter_id ;  struct arfs_tuple tuple ; } cocci_id@p ;
...
position p;
@@
 const struct arfs_tuple * cocci_id@p ;
...
position p;
@@
 struct mlx5e_arfs_tables * cocci_id@p ;
