...
typedef u8;
@@
 u8 cocci_id@p [ H2C_8821AE_PWEMODE_LENGTH ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_8821AE_REMOTE_WAKE_CTRL_LEN ] ;
...
position p;
@@
 struct rtl_security * cocci_id@p ;
...
position p;
@@
 enum version_8821ae cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ TOTAL_RESERVED_PKT_LEN_8812 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_8821AE_AP_OFFLOAD_LENGTH ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ TOTAL_RESERVED_PKT_LEN_8821 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_8821AE_DISCONNECT_DECISION_CTRL_LEN ] ;
...
symbol cocci_id;
position p;
typedef p2p_ps_offload_t;
@@
 struct p2p_ps_offload_t * cocci_id@p ;
...
position p;
@@
 struct rtlwifi_firmware_header * cocci_id@p ;
...
position p;
@@
 struct rtl_p2p_ps_info * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_8821AE_AOAC_GLOBAL_INFO_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_8821AE_WOWLAN_LENGTH ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ H2C_8821AE_KEEP_ALIVE_CTRL_LENGTH ] ;
