...
position p;
@@
 struct digicolor_timer cocci_id@p ;
...
position p;
@@
 enum { TIMER_A , TIMER_B , TIMER_C , TIMER_D , TIMER_E , TIMER_F , TIMER_G , TIMER_H , } cocci_id@p ;
...
typedef u32;
@@
 struct digicolor_timer {  struct clock_event_device ce ;  void __iomem * base ;  u32 ticks_per_jiffy ;  int timer_id ; } cocci_id@p ;
