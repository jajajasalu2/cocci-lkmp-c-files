...
position p;
@@
 const struct berlin2_div_data * cocci_id@p ;
...
position p;
@@
 enum { REFCLK , VIDEO_EXT0 , SYSPLL , MEMPLL , CPUPLL , AVPLL_A1 , AVPLL_A2 , AVPLL_A3 , AVPLL_A4 , AVPLL_A5 , AVPLL_A6 , AVPLL_A7 , AVPLL_A8 , AVPLL_B1 , AVPLL_B2 , AVPLL_B3 , AVPLL_B4 , AVPLL_B5 , AVPLL_B6 , AVPLL_B7 , AVPLL_B8 , AUDIO1_PLL , AUDIO_FAST_PLL , VIDEO0_PLL , VIDEO0_IN , VIDEO1_PLL , VIDEO1_IN , VIDEO2_PLL , VIDEO2_IN , } cocci_id@p ;
...
position p;
@@
 const struct berlin2_gate_data * cocci_id@p ;
...
position p;
@@
 const struct berlin2_pll_map cocci_id@p ;
