...
position p;
@@
 struct fsl_elbc_mtd * cocci_id@p ;
...
typedef u8;
@@
 struct fsl_elbc_fcm_ctrl {  struct nand_controller controller ;  struct fsl_elbc_mtd * chips [ MAX_BANKS ] ;  u8 __iomem * addr ;  unsigned int page ;  unsigned int read_bytes ;  unsigned int column ;  unsigned int index ;  unsigned int status ;  unsigned int mdr ;  unsigned int use_mdr ;  unsigned int oob ;  unsigned int counter ;  unsigned int max_bitflips ; } cocci_id@p ;
...
typedef u8;
@@
 struct fsl_elbc_mtd {  struct nand_chip chip ;  struct fsl_lbc_ctrl * ctrl ;  struct device * dev ;  int bank ;  u8 __iomem * vbase ;  int page_size ;  unsigned int fmr ; } cocci_id@p ;
...
position p;
@@
 struct fsl_lbc_ctrl * cocci_id@p ;
...
position p;
@@
 struct fsl_elbc_fcm_ctrl * cocci_id@p ;
