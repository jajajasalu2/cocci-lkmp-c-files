...
typedef u8;
@@
 u8 cocci_id@p [ SJA1105_SIZE_RESET_CMD ] ;
...
typedef u8,u64;
@@
 struct sja1105_chunk {  u8 * buf ;  size_t len ;  u64 reg_addr ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sja1105_spi_rw_mode_t;
@@
 sja1105_spi_rw_mode_t cocci_id@p ;
...
position p;
@@
 struct sja1105_regs cocci_id@p ;
...
position p;
@@
 struct sja1105_spi_message cocci_id@p ;
...
typedef u64;
@@
 struct sja1105_status {  u64 configs ;  u64 crcchkl ;  u64 ids ;  u64 crcchkg ; } cocci_id@p ;
...
position p;
@@
 struct sja1105_info cocci_id@p ;
...
position p;
@@
 struct sja1105_status * cocci_id@p ;
...
position p;
@@
 const struct sja1105_spi_message * cocci_id@p ;
...
position p;
@@
 struct sja1105_chunk cocci_id@p ;
