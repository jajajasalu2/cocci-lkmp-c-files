...
position p;
@@
 enum xhci_ring_type cocci_id@p ;
...
position p;
@@
 struct xhci_stream_info * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct {  dma_addr_t input_dma ;  struct xhci_segment * result_seg ; } cocci_id@p [ ] ;
...
typedef dma_addr_t;
@@
 struct {  struct xhci_segment * input_seg ;  union xhci_trb * start_trb ;  union xhci_trb * end_trb ;  dma_addr_t input_dma ;  struct xhci_segment * result_seg ; } cocci_id@p [ ] ;
