...
position p;
@@
 void cocci_id@p ( struct module * mod , int end ) ;
...
position p;
@@
 struct module_sect_attrs {  struct attribute_group grp ;  unsigned int nsections ;  struct module_sect_attr attrs [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct tracepoint * const * cocci_id@p ;
...
position p;
@@
 struct module_sect_attrs * cocci_id@p ;
...
position p;
@@
 struct module_layout * cocci_id@p ;
...
position p;
@@
 struct kernel_param * cocci_id@p ;
...
position p;
@@
 struct modversion_info * cocci_id@p ;
...
position p;
@@
 struct mod_initfree * cocci_id@p ;
...
position p;
@@
 struct module_notes_attrs * cocci_id@p ;
...
position p;
@@
 struct module_sect_attr * cocci_id@p ;
...
position p;
@@
 struct mod_kallsyms cocci_id@p ;
...
position p;
@@
 struct kernel_symbol cocci_id@p ;
...
position p;
@@
 const unsigned long cocci_id@p [ ] [ 2 ] ;
...
position p;
@@
 const struct exception_table_entry * cocci_id@p ;
...
position p;
@@
 struct find_symbol_arg * cocci_id@p ;
...
position p;
@@
 const struct load_info * cocci_id@p ;
...
position p;
@@
 char * cocci_id@p ( const struct load_info * info , const char * tag , char * prev ) ;
...
position p;
@@
 const struct kernel_symbol * cocci_id@p ;
...
position p;
@@
 struct {  const struct kernel_symbol * sym ;  unsigned int num ; } cocci_id@p [ ] ;
...
position p;
@@
 struct mod_initfree {  struct llist_node node ;  void * module_init ; } cocci_id@p ;
...
position p;
@@
 struct module_sect_attr {  struct module_attribute mattr ;  char * name ;  unsigned long address ; } cocci_id@p ;
...
position p;
@@
 struct mod_tree_root {  struct latch_tree_root root ;  unsigned long addr_min ;  unsigned long addr_max ; } cocci_id@p ;
...
position p;
@@
 const struct latch_tree_ops cocci_id@p ;
...
position p;
@@
 struct module_notes_attrs {  struct kobject * dir ;  unsigned int notes ;  struct bin_attribute attrs [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct symsearch cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ MODULE_FLAGS_BUF_SIZE ] ;
...
position p;
@@
 struct mod_tree_node cocci_id@p ;
...
position p;
@@
 const struct module * cocci_id@p ;
...
typedef bool,s32;
@@
 struct find_symbol_arg {  const char * name ;  bool gplok ;  bool warn ;  struct module * owner ;  const s32 * crc ;  const struct kernel_symbol * sym ; } cocci_id@p ;
...
position p;
@@
 struct module_kobject * cocci_id@p ;
...
position p;
@@
 const struct module_layout * cocci_id@p ;
...
position p;
@@
 struct module_attribute cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( unsigned long start , int num_pages ) ;
...
position p;
@@
 void cocci_id@p ( struct module * mod ) ;
...
position p;
@@
 char * cocci_id@p ( const struct load_info * info , const char * tag ) ;
...
position p;
@@
 char cocci_id@p [ MODULE_NAME_LEN + 1 ] ;
...
position p;
@@
 struct latch_tree_node * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * , const char * , struct module * , unsigned long ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct symsearch * arr , struct module * owner , void * data ) ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( const struct symsearch * syms , struct module * owner , void * data ) ;
