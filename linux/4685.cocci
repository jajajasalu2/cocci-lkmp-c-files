...
position p;
@@
 int ( * cocci_id@p ) ( struct enclosure_device * , void * ) ;
...
position p;
@@
 char cocci_id@p [ COMPONENT_NAME_SIZE ] ;
...
position p;
@@
 char cocci_id@p [ ENCLOSURE_NAME_SIZE ] ;
...
position p;
@@
 enum enclosure_component_type cocci_id@p ;
