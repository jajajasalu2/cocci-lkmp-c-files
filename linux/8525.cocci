...
typedef spinlock_t;
@@
 struct qcauart {  struct net_device * net_dev ;  spinlock_t lock ;  struct work_struct tx_work ;  struct serdev_device * serdev ;  struct qcafrm_handle frm_handle ;  struct sk_buff * rx_skb ;  unsigned char * tx_head ;  int tx_left ;  unsigned char * tx_buffer ; } cocci_id@p ;
