...
position p;
@@
 struct opa_veswport_iface_macs * cocci_id@p ;
...
position p;
@@
 struct opa_vnic_vema_mad_trap * cocci_id@p ;
...
position p;
@@
 struct opa_vnic_ctrl_port * cocci_id@p ;
...
typedef u8,u64;
@@
 struct opa_vnic_vema_port {  struct opa_vnic_ctrl_port * cport ;  struct ib_mad_agent * mad_agent ;  struct opa_class_port_info class_port_info ;  u64 tid ;  u8 port_num ;  struct xarray vports ;  struct ib_event_handler event_handler ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct opa_veswport_info * cocci_id@p ;
...
position p;
@@
 struct opa_veswport_mactable * cocci_id@p ;
...
position p;
@@
 struct opa_vnic_adapter * cocci_id@p ;
...
position p;
@@
 struct opa_vnic_vema_port cocci_id@p ;
...
position p;
@@
 struct opa_vnic_vema_mad * cocci_id@p ;
...
position p;
@@
 struct opa_veswport_trap * cocci_id@p ;
...
position p;
@@
 struct opa_veswport_error_counters * cocci_id@p ;
...
position p;
@@
 struct opa_veswport_summary_counters * cocci_id@p ;
