...
position p;
@@
 enum jsa1212_op_mode { JSA1212_OPMODE_ALS_EN , JSA1212_OPMODE_PXS_EN , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct jsa1212_data {  struct i2c_client * client ;  struct mutex lock ;  u8 als_rng_idx ;  bool als_en ;  bool pxs_en ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 struct jsa1212_data * cocci_id@p ;
