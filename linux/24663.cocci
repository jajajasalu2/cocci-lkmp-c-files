...
position p;
@@
 struct hash_netiface6_elem * cocci_id@p ;
...
position p;
@@
 const struct hash_netiface6_elem * cocci_id@p ;
...
position p;
@@
 struct hash_netiface6 * cocci_id@p ;
...
position p;
@@
 struct hash_netiface4_elem cocci_id@p ;
...
typedef u8,__be32;
@@
 struct hash_netiface4_elem_hashed {  __be32 ip ;  u8 physdev ;  u8 cidr ;  u8 nomatch ;  u8 elem ; } cocci_id@p ;
...
typedef u8;
@@
 struct hash_netiface6_elem_hashed {  union nf_inet_addr ip ;  u8 physdev ;  u8 cidr ;  u8 nomatch ;  u8 elem ; } cocci_id@p ;
...
typedef u8,__be32;
@@
 struct hash_netiface4_elem {  __be32 ip ;  u8 physdev ;  u8 cidr ;  u8 nomatch ;  u8 elem ;  u8 wildcard ;  char iface [ IFNAMSIZ ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct hash_netiface6_elem {  union nf_inet_addr ip ;  u8 physdev ;  u8 cidr ;  u8 nomatch ;  u8 elem ;  u8 wildcard ;  char iface [ IFNAMSIZ ] ; } cocci_id@p ;
...
position p;
@@
 struct hash_netiface4 * cocci_id@p ;
...
position p;
@@
 struct hash_netiface4_elem_hashed cocci_id@p ;
...
position p;
@@
 const struct hash_netiface4_elem * cocci_id@p ;
...
position p;
@@
 struct hash_netiface6_elem_hashed cocci_id@p ;
