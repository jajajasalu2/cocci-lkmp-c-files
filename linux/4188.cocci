...
position p;
@@
 enum spear1310_miphy_mode { SATA , PCIE , } cocci_id@p ;
...
typedef u32;
@@
 struct spear1310_miphy_priv {  u32 id ;  enum spear1310_miphy_mode mode ;  struct regmap * misc ;  struct phy * phy ; } cocci_id@p ;
...
position p;
@@
 struct spear1310_miphy_priv * cocci_id@p ;
