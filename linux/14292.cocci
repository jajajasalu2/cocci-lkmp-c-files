...
typedef u8;
@@
 struct tda10021_state {  struct i2c_adapter * i2c ;  const struct tda1002x_config * config ;  struct dvb_frontend frontend ;  u8 pwm ;  u8 reg0 ; } cocci_id@p ;
...
position p;
@@
 const struct tda1002x_config * cocci_id@p ;
...
position p;
@@
 struct tda10021_state cocci_id@p ;
