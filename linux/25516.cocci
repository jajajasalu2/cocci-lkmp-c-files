...
position p;
@@
 struct jr_code_debug_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef jvmti_line_info_t;
@@
 jvmti_line_info_t * cocci_id@p ;
...
position p;
@@
 struct jr_code_load cocci_id@p ;
...
position p;
@@
 const struct timespec * cocci_id@p ;
...
position p;
@@
 struct jr_code_close cocci_id@p ;
...
typedef uint16_t;
@@
 struct {  uint16_t e_type ;  uint16_t e_machine ; } cocci_id@p ;
