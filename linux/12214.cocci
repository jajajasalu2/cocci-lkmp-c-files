...
position p;
@@
 struct etnaviv_gem_object * cocci_id@p ;
...
position p;
@@
 struct etnaviv_fence {  struct etnaviv_gpu * gpu ;  struct dma_fence base ; } cocci_id@p ;
...
position p;
@@
 const struct etnaviv_perfmon_request * cocci_id@p ;
...
position p;
@@
 struct etnaviv_gem_submit * cocci_id@p ;
...
position p;
@@
 struct etnaviv_fence cocci_id@p ;
...
position p;
@@
 const struct etnaviv_gem_submit * cocci_id@p ;
...
position p;
@@
 struct etnaviv_event * cocci_id@p ;
...
typedef u32;
@@
 struct dma_debug {  u32 address [ 2 ] ;  u32 state [ 2 ] ; } cocci_id@p ;
