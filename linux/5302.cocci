...
typedef bool,u32;
@@
 struct ceva_ahci_priv {  struct platform_device * ahci_pdev ;  u32 pp2c [ NR_PORTS ] ;  u32 pp3c [ NR_PORTS ] ;  u32 pp4c [ NR_PORTS ] ;  u32 pp5c [ NR_PORTS ] ;  u32 axicc ;  bool is_cci_enabled ;  int flags ; } cocci_id@p ;
...
position p;
@@
 struct ceva_ahci_priv * cocci_id@p ;
