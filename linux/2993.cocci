...
position p;
@@
 struct acpi_pci_ioapic * cocci_id@p ;
...
@@
 struct acpi_pci_ioapic {  acpi_handle root_handle ;  acpi_handle handle ;  u32 gsi_base ;  struct resource res ;  struct pci_dev * pdev ;  struct list_head list ; } cocci_id@p ;
