...
position p;
@@
 struct telemetry_core_config {  struct telemetry_plt_config * plt_config ;  const struct telemetry_core_ops * telem_ops ; } cocci_id@p ;
...
position p;
@@
 struct telemetry_core_config cocci_id@p ;
