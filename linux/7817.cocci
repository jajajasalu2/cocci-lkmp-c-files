...
position p;
@@
 int cocci_id@p ( struct scsi_target * starget ) ;
...
position p;
@@
 struct mptfc_rport_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef FCPortPage0_t;
@@
 FCPortPage0_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef FCPortPage1_t;
@@
 FCPortPage1_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef FCDevicePage0_t;
@@
 FCDevicePage0_t * * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct scsi_target * starget ) ;
...
position p;
@@
 int cocci_id@p ( struct Scsi_Host * shost , struct scsi_cmnd * SCpnt ) ;
