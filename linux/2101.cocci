...
typedef u8;
@@
 struct shdwc_config {  u8 wkup_pin_input ;  u8 mr_rtcwk_shift ;  u8 mr_rttwk_shift ;  u8 sr_rtcwk_shift ;  u8 sr_rttwk_shift ; } cocci_id@p ;
...
position p;
@@
 struct shdwc {  const struct shdwc_config * cfg ;  struct clk * sclk ;  void __iomem * shdwc_base ;  void __iomem * mpddrc_base ;  void __iomem * pmc_base ; } cocci_id@p ;
...
position p;
@@
 const struct shdwc_config cocci_id@p ;
