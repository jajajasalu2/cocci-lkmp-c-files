...
position p;
@@
 const struct nvbios_therm_threshold * cocci_id@p ;
...
position p;
@@
 enum nvkm_therm_thrs cocci_id@p ;
...
position p;
@@
 enum nvkm_therm_thrs_state cocci_id@p ;
...
position p;
@@
 enum nvkm_therm_thrs_direction cocci_id@p ;
...
position p;
@@
 struct nvbios_therm_sensor * cocci_id@p ;
