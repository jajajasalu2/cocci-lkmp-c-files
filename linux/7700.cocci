...
position p;
@@
 int cocci_id@p ( struct ifx_spi_device * ifx_dev ) ;
...
position p;
@@
 void cocci_id@p ( struct ifx_spi_device * ifx_dev ) ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * nfb , unsigned long event , void * data ) ;
...
position p;
@@
 struct ifx_modem_platform_data * cocci_id@p ;
...
position p;
@@
 struct ifx_spi_device cocci_id@p ;
