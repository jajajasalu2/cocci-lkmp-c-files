...
position p;
@@
 struct c67x00_ep_data * cocci_id@p ;
...
typedef u16;
@@
 struct c67x00_ep_data {  struct list_head queue ;  struct list_head node ;  struct usb_host_endpoint * hep ;  struct usb_device * dev ;  u16 next_frame ; } cocci_id@p ;
...
position p;
@@
 struct c67x00_urb_priv * cocci_id@p ;
...
position p;
@@
 struct c67x00_urb_priv {  struct list_head hep_node ;  struct urb * urb ;  int port ;  int cnt ;  int status ;  struct c67x00_ep_data * ep_data ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct c67x00_hcd * , struct urb * ) ;
