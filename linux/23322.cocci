...
position p;
@@
 const unsigned int cocci_id@p [ MADERA_DFC_TYPE_ENUM_SIZE ] ;
...
position p;
@@
 const struct madera_codec_pdata * cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ MADERA_RATE_ENUM_SIZE ] ;
...
position p;
@@
 const int cocci_id@p [ MADERA_MAX_ADSP ] ;
...
position p;
@@
 const char * constcocci_id [ MADERA_RATE_ENUM_SIZE ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ MADERA_FLL_MAX_FRATIO ] ;
...
position p;
@@
 const  cocci_id@p ( madera_mixer_tlv , 
							     - 3200 , 100 , 0 ) ;
...
position p;
@@
 struct madera_fll_cfg cocci_id@p ;
...
position p;
@@
 const struct madera_fll_gains cocci_id@p [ ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ MADERA_OSR_ENUM_SIZE ] ;
...
position p;
@@
 const struct reg_sequence cocci_id@p [ ] ;
...
typedef u32;
@@
 u32 cocci_id@p [ MADERA_MAX_INPUT * MADERA_MAX_MUXED_CHANNELS ] ;
...
typedef u16;
@@
 const struct {  unsigned int min ;  unsigned int max ;  u16 fratio ;  int ratio ; } cocci_id@p [ ] ;
...
position p;
@@
 struct snd_soc_dapm_route cocci_id@p [ 2 ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ MADERA_DFC_WIDTH_ENUM_SIZE ] ;
...
position p;
@@
 const struct madera_fllao_patch cocci_id@p [ ] ;
...
position p;
@@
 const char * constcocci_id [ MADERA_DFC_TYPE_ENUM_SIZE ] ;
...
position p;
@@
 const  cocci_id@p ( madera_digital_tlv , 
							     - 6400 , 50 , 0 ) ;
...
position p;
@@
 const char * constcocci_id [ MADERA_OSR_ENUM_SIZE ] ;
...
position p;
@@
 const char * constcocci_id [ MADERA_DFC_WIDTH_ENUM_SIZE ] ;
...
position p;
@@
 const  cocci_id@p ( madera_ng_tlv , 
							     - 12000 , 600 , 0 ) ;
...
position p;
@@
 const  cocci_id@p ( madera_noise_tlv , 
							     - 13200 , 600 , 0 ) ;
...
position p;
@@
 const struct madera_priv * cocci_id@p ;
...
position p;
@@
 struct madera_codec_pdata * cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( madera_eq_tlv , 
							     - 1200 , 100 , 0 ) ;
...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( pdata -> out_mono ) ] ;
...
position p;
@@
 const  cocci_id@p ( madera_ana_tlv , 0 , 
							     100 , 0 ) ;
...
position p;
@@
 struct madera_fll_gains {  unsigned int min ;  unsigned int max ;  int gain ;  int alt_gain ; } cocci_id@p ;
...
position p;
@@
 struct madera_fllao_patch {  unsigned int fin ;  unsigned int fout ;  const struct reg_sequence * patch ;  unsigned int patch_size ; } cocci_id@p ;
...
position p;
@@
 struct madera_dai_priv * cocci_id@p ;
