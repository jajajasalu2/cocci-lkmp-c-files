...
symbol cocci_id;
position p;
typedef snd_switch_t;
@@
 snd_switch_t * cocci_id@p ;
...
@@
 struct snd_rme9652 {  int dev ;  spinlock_t lock ;  int irq ;  unsigned long port ;  void __iomem * iobase ;  int precise_ptr ;  u32 control_register ;  u32 thru_bits ;  u32 creg_spdif ;  u32 creg_spdif_stream ;  char * card_name ;  size_t hw_offsetmask ;  size_t prev_hw_offset ;  size_t max_jitter ;  size_t period_bytes ;  unsigned char ds_channels ;  unsigned char ss_channels ;  struct snd_dma_buffer playback_dma_buf ;  struct snd_dma_buffer capture_dma_buf ;  unsigned char * capture_buffer ;  unsigned char * playback_buffer ;  pid_t capture_pid ;  pid_t playback_pid ;  struct snd_pcm_substream * capture_substream ;  struct snd_pcm_substream * playback_substream ;  int running ;  int passthru ;  int hw_rev ;  int last_spdif_sample_rate ;  int last_adat_sample_rate ;  char * channel_map ;  struct snd_card * card ;  struct snd_pcm * pcm ;  struct pci_dev * pci ;  struct snd_kcontrol * spdif_ctl ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_kswitch_t;
@@
 snd_kswitch_t * cocci_id@p ;
