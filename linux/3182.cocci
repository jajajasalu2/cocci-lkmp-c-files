...
position p;
@@
 struct hwmon_channel_info * cocci_id@p ;
...
position p;
@@
 const struct lm90_params cocci_id@p [ ] ;
...
typedef u8,u32,u16;
@@
 struct lm90_params {  u32 flags ;  u16 alert_alarms ;  u8 max_convrate ;  u8 reg_local_ext ; } cocci_id@p ;
...
position p;
@@
 enum lm90_temp8_reg_index { LOCAL_LOW = 0 , LOCAL_HIGH , LOCAL_CRIT , REMOTE_CRIT , LOCAL_EMERG , REMOTE_EMERG , REMOTE2_CRIT , REMOTE2_EMERG , TEMP8_REG_NUM , } cocci_id@p ;
...
typedef u8;
@@
 struct reg {  u8 high ;  u8 low ; } cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef s8,u8,s16,bool,u32,u16;
@@
 struct lm90_data {  struct i2c_client * client ;  u32 channel_config [ 4 ] ;  struct hwmon_channel_info temp_info ;  const struct hwmon_channel_info * info [ 3 ] ;  struct hwmon_chip_info chip ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  int kind ;  u32 flags ;  unsigned int update_interval ;  u8 config ;  u8 config_orig ;  u8 convrate_orig ;  u16 alert_alarms ;  u8 max_convrate ;  u8 reg_local_ext ;  s8 temp8 [ TEMP8_REG_NUM ] ;  s16 temp11 [ TEMP11_REG_NUM ] ;  u8 temp_hyst ;  u16 alarms ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ TEMP8_REG_NUM ] ;
...
position p;
@@
 enum chips { lm90 , adm1032 , lm99 , lm86 , max6657 , max6659 , adt7461 , max6680 , max6646 , w83l771 , max6696 , sa56004 , g781 , tmp451 , } cocci_id@p ;
...
position p;
@@
 enum lm90_temp11_reg_index { REMOTE_TEMP = 0 , REMOTE_LOW , REMOTE_HIGH , REMOTE_OFFSET , LOCAL_TEMP , REMOTE2_TEMP , REMOTE2_LOW , REMOTE2_HIGH , TEMP11_REG_NUM , } cocci_id@p ;
