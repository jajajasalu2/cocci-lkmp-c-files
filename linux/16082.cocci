...
position p;
@@
 struct dio200_subdev_8255 * cocci_id@p ;
...
position p;
@@
 const struct dio200_board * cocci_id@p ;
...
position p;
@@
 struct dio200_subdev_8255 {  unsigned int ofs ; } cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ 32 ] ;
...
position p;
@@
 struct dio200_subdev_intr * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct dio200_subdev_intr {  spinlock_t spinlock ;  unsigned int ofs ;  unsigned int valid_isns ;  unsigned int enabled_isns ;  unsigned int active : 1 ; } cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ TS_CONFIG_MAX_CLK_SRC + 1 ] ;
