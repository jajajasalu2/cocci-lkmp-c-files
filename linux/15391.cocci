...
typedef u8;
@@
 struct sunxi_wdt_reg {  u8 wdt_ctrl ;  u8 wdt_cfg ;  u8 wdt_mode ;  u8 wdt_timeout_shift ;  u8 wdt_reset_mask ;  u8 wdt_reset_val ; } cocci_id@p ;
...
position p;
@@
 const struct sunxi_wdt_reg * cocci_id@p ;
...
position p;
@@
 struct sunxi_wdt_dev {  struct watchdog_device wdt_dev ;  void __iomem * wdt_base ;  const struct sunxi_wdt_reg * wdt_regs ; } cocci_id@p ;
...
position p;
@@
 struct sunxi_wdt_dev * cocci_id@p ;
