...
position p;
@@
 const struct atmel_pdmic_pdata * cocci_id@p ;
...
position p;
@@
 struct atmel_pdmic_pdata * cocci_id@p ;
...
position p;
@@
 struct mic_gain {  unsigned int dgain ;  unsigned int scale ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct atmel_pdmic {  dma_addr_t phy_base ;  struct regmap * regmap ;  struct clk * pclk ;  struct clk * gclk ;  struct device * dev ;  int irq ;  struct snd_pcm_substream * substream ;  const struct atmel_pdmic_pdata * pdata ; } cocci_id@p ;
...
position p;
@@
 const struct mic_gain cocci_id@p [ ] ;
...
typedef u32,s32;
@@
 struct atmel_pdmic_pdata {  u32 mic_min_freq ;  u32 mic_max_freq ;  s32 mic_offset ;  const char * card_name ; } cocci_id@p ;
