...
typedef u8,u32;
@@
 struct hpt_clock {  u8 xfer_speed ;  u32 timing ; } cocci_id@p ;
...
position p;
@@
 const struct hpt_chip * cocci_id@p ;
...
position p;
@@
 struct hpt_chip {  const char * name ;  unsigned int base ;  const struct hpt_clock * clocks [ 4 ] ; } cocci_id@p ;
