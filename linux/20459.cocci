...
position p;
@@
 union cpuid_0x10_3_eax cocci_id@p ;
...
position p;
@@
 struct resctrl_pqr_state * cocci_id@p ;
...
position p;
@@
 union cpuid_0x10_1_eax cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rdt_domain * d , struct msr_param * m , struct rdt_resource * r ) ;
...
position p;
@@
 union cpuid_0x10_x_edx cocci_id@p ;
...
position p;
@@
 enum { RDT_FLAG_CMT , RDT_FLAG_MBM_TOTAL , RDT_FLAG_MBM_LOCAL , RDT_FLAG_L3_CAT , RDT_FLAG_L3_CDP , RDT_FLAG_L2_CAT , RDT_FLAG_L2_CDP , RDT_FLAG_MBA , } cocci_id@p ;
