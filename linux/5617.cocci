...
position p;
@@
 enum sprd_rtc_reg_types cocci_id@p ;
...
typedef bool,u32;
@@
 struct sprd_rtc {  struct rtc_device * rtc ;  struct regmap * regmap ;  struct device * dev ;  u32 base ;  int irq ;  bool valid ; } cocci_id@p ;
...
position p;
@@
 enum sprd_rtc_reg_types { SPRD_RTC_TIME , SPRD_RTC_ALARM , SPRD_RTC_AUX_ALARM , } cocci_id@p ;
