...
position p;
@@
 struct xen_9pfs_header cocci_id@p ;
...
position p;
@@
 struct xen_9pfs_dataring cocci_id@p ;
...
@@
 struct xen_9pfs_dataring {  struct xen_9pfs_front_priv * priv ;  struct xen_9pfs_data_intf * intf ;  grant_ref_t ref ;  int evtchn ;  int irq ;  spinlock_t lock ;  struct xen_9pfs_data data ;  wait_queue_head_t wq ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct xen_9pfs_front_priv * cocci_id@p ;
...
position p;
@@
 struct xen_9pfs_front_priv {  struct list_head list ;  struct xenbus_device * dev ;  char * tag ;  struct p9_client * client ;  int num_rings ;  struct xen_9pfs_dataring * rings ; } cocci_id@p ;
...
position p;
@@
 struct xen_9pfs_data_intf * cocci_id@p ;
