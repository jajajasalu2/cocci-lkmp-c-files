...
position p;
@@
 struct llsec_dump_data cocci_id@p ;
...
position p;
@@
 struct ieee802154_mlme_ops * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct llsec_dump_data * ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct net_device * , struct genl_info * ) ;
...
position p;
@@
 struct ieee802154_mac_params cocci_id@p ;
