...
position p;
@@
 struct am2315_sensor_data cocci_id@p ;
...
typedef s16;
@@
 struct am2315_data {  struct i2c_client * client ;  struct mutex lock ;  s16 buffer [ 8 ] ; } cocci_id@p ;
...
typedef s16;
@@
 struct am2315_sensor_data {  s16 hum_data ;  s16 temp_data ; } cocci_id@p ;
