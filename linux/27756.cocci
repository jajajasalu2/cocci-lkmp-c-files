...
position p;
@@
 int cocci_id@p ( struct inode * vi ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * base_vi , struct inode * vi ) ;
...
position p;
@@
 STANDARD_INFORMATION * cocci_id@p ;
