...
typedef u16;
@@
 struct tega_xusb_mbox_regs {  u16 cmd ;  u16 data_in ;  u16 data_out ;  u16 owner ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_mbox_msg * cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_soc cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_phy_type {  const char * name ;  unsigned int num ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_xusb_phy_type cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_xusb_mbox_msg * cocci_id@p ;
...
position p;
@@
 struct tegra_xusb_fw_header cocci_id@p ;
...
position p;
@@
 enum tegra_xusb_mbox_cmd cocci_id@p ;
...
typedef u32;
@@
 struct tegra_xusb_mbox_msg {  u32 cmd ;  u32 data ; } cocci_id@p ;
