...
position p;
@@
 const struct type_params cocci_id@p [ ] ;
...
position p;
@@
 enum type { TYPEM , TYPEN , TYPEO , } cocci_id@p ;
...
typedef u32;
@@
 struct pwm_port_params {  u32 pwm_en ;  u32 ctrl_reg ;  u32 type_part1 ;  u32 type_part2 ;  u32 type_mask ;  u32 duty_ctrl_rise_point ;  u32 duty_ctrl_fall_point ;  u32 duty_ctrl_reg ;  u32 duty_ctrl_rise_fall_mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct type_params {  u32 l_value ;  u32 h_value ;  u32 unit_value ;  u32 clk_ctrl_mask ;  u32 clk_ctrl_reg ;  u32 ctrl_reg ;  u32 ctrl_reg1 ; } cocci_id@p ;
...
position p;
@@
 const struct pwm_port_params cocci_id@p [ ] ;
...
position p;
@@
 enum pwm_port { PWMA , PWMB , PWMC , PWMD , PWME , PWMF , PWMG , PWMH , } cocci_id@p ;
...
position p;
@@
 struct aspeed_cooling_device * cocci_id@p ;
...
typedef u8;
@@
 struct aspeed_cooling_device {  char name [ 16 ] ;  struct aspeed_pwm_tacho_data * priv ;  struct thermal_cooling_device * tcdev ;  int pwm_port ;  u8 * cooling_levels ;  u8 max_state ;  u8 cur_state ; } cocci_id@p ;
...
position p;
@@
 struct aspeed_pwm_tacho_data * cocci_id@p ;
