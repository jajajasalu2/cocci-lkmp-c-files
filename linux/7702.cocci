...
position p;
@@
 struct digicolor_port {  struct uart_port port ;  struct delayed_work rx_poll_work ; } cocci_id@p ;
...
position p;
@@
 struct uart_port * cocci_id@p [ DIGICOLOR_USART_NR ] ;
...
position p;
@@
 struct digicolor_port * cocci_id@p ;
