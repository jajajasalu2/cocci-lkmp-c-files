...
typedef u8,u32;
@@
 int cocci_id@p ( struct e1000_hw * hw , u8 * addr , u32 index ) ;
...
typedef s32,bool;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , bool d0_state ) ;
...
typedef u8,s32,u32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 offset , u8 * data ) ;
...
typedef u32,u16;
@@
 union ich8_hws_flash_regacc {  struct ich8_flracc {  u32 grra : 8 ;  u32 grwa : 8 ;  u32 gmrag : 8 ;  u32 gmwag : 8 ; } hsf_flregacc ;  u16 regval ; } cocci_id@p ;
...
position p;
@@
 const struct e1000_mac_operations cocci_id@p ;
...
position p;
@@
 union ich8_hws_flash_status cocci_id@p ;
...
typedef s32,bool;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , bool active ) ;
...
symbol cocci_id;
position p;
typedef u8,s32,u32,u16;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 offset , u8 size , u16 * data ) ;
...
typedef s32,u32,u16;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 offset , u16 * data ) ;
...
typedef s32,u32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 offset , u32 dword ) ;
...
position p;
@@
 union ich8_hws_flash_ctrl cocci_id@p ;
...
position p;
@@
 const struct e1000_phy_operations cocci_id@p ;
...
typedef s32,u32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 offset , u32 * data ) ;
...
position p;
@@
 struct e1000_dev_spec_ich8lan * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct e1000_hw * hw ) ;
...
position p;
@@
 struct e1000_nvm_info * cocci_id@p ;
...
typedef s32,bool;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , bool link ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct e1000_hw * hw ) ;
...
typedef u8,s32,u32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 offset , u8 byte ) ;
...
typedef s32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw ) ;
...
typedef u16;
@@
 union ich8_hws_flash_ctrl {  struct ich8_hsflctl {  u16 flcgo : 1 ;  u16 flcycle : 2 ;  u16 reserved : 5 ;  u16 fldbcount : 2 ;  u16 flockdn : 6 ; } hsf_ctrl ;  u16 regval ; } cocci_id@p ;
...
typedef s32,u32;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 bank ) ;
...
typedef u16;
@@
 union ich8_hws_flash_status {  struct ich8_hsfsts {  u16 flcdone : 1 ;  u16 flcerr : 1 ;  u16 dael : 1 ;  u16 berasesz : 2 ;  u16 flcinprog : 1 ;  u16 reserved1 : 2 ;  u16 reserved2 : 6 ;  u16 fldesvalid : 1 ;  u16 flockdn : 1 ; } hsf_status ;  u16 regval ; } cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct e1000_hw * hw , bool gate ) ;
...
position p;
@@
 struct e1000_bus_info * cocci_id@p ;
...
position p;
@@
 const struct e1000_nvm_operations cocci_id@p ;
...
position p;
@@
 union ich8_flash_protected_range cocci_id@p ;
...
typedef s32,bool;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , bool force ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct e1000_hw * hw ) ;
...
typedef u32;
@@
 union ich8_flash_protected_range {  struct ich8_pr {  u32 base : 13 ;  u32 reserved1 : 2 ;  u32 rpe : 1 ;  u32 limit : 13 ;  u32 reserved2 : 2 ;  u32 wpe : 1 ; } range ;  u32 regval ; } cocci_id@p ;
