...
position p;
@@
 struct i596_private cocci_id@p ;
...
position p;
@@
 struct i596_tbd {  unsigned short size ;  unsigned short pad ;  struct i596_tbd * next ;  char * data ; } cocci_id@p ;
...
position p;
@@
 struct tdr_cmd {  struct i596_cmd cmd ;  unsigned short status ;  unsigned short pad ; } cocci_id@p ;
...
position p;
@@
 volatile unsigned char * cocci_id@p ;
...
position p;
@@
 struct mc_cmd {  struct i596_cmd cmd ;  short mc_cnt ;  char mc_addrs [ MAX_MC_CNT * 6 ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned char * buf , char * str ) ;
...
position p;
@@
 struct i596_iscp {  unsigned long stat ;  struct i596_scb * scb ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , struct i596_cmd * cmd ) ;
...
position p;
@@
 struct cf_cmd {  struct i596_cmd cmd ;  char i596_config [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 enum commands { CmdNOp = 0 , CmdSASetup = 1 , CmdConfigure = 2 , CmdMulticastList = 3 , CmdTx = 4 , CmdTDR = 5 , CmdDump = 6 , CmdDiagnose = 7 , } cocci_id@p ;
...
position p;
@@
 struct i596_rbd {  unsigned short count ;  unsigned short zero1 ;  struct i596_rbd * b_next ;  unsigned char * b_data ;  unsigned short size ;  unsigned short zero2 ;  struct sk_buff * skb ;  struct i596_rbd * v_next ;  struct i596_rbd * b_addr ;  unsigned char * v_data ; } cocci_id@p ;
...
position p;
@@
 struct tx_cmd {  struct i596_cmd cmd ;  struct i596_tbd * tbd ;  unsigned short size ;  unsigned short pad ;  struct sk_buff * skb ; } cocci_id@p ;
...
position p;
@@
 struct sa_cmd {  struct i596_cmd cmd ;  char eth_addr [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct i596_cmd {  struct i596_cmd * v_next ;  unsigned short status ;  unsigned short command ;  struct i596_cmd * b_next ; } cocci_id@p ;
...
position p;
@@
 struct i596_rfd {  unsigned short stat ;  unsigned short cmd ;  struct i596_rfd * b_next ;  struct i596_rbd * rbd ;  unsigned short count ;  unsigned short size ;  struct i596_rfd * v_next ;  struct i596_rfd * v_prev ; } cocci_id@p ;
...
position p;
@@
 struct i596_scp {  unsigned long sysbus ;  unsigned long pad ;  struct i596_iscp * iscp ; } cocci_id@p ;
...
position p;
@@
 struct i596_reg {  unsigned short porthi ;  unsigned short portlo ;  unsigned long ca ; } cocci_id@p ;
...
position p;
@@
 volatile struct i596_cmd * cocci_id@p ;
...
position p;
@@
 struct i596_scb {  unsigned short status ;  unsigned short command ;  struct i596_cmd * cmd ;  struct i596_rfd * rfd ;  unsigned long crc_err ;  unsigned long align_err ;  unsigned long resource_err ;  unsigned long over_err ;  unsigned long rcvdt_err ;  unsigned long short_err ;  unsigned short t_on ;  unsigned short t_off ; } cocci_id@p ;
