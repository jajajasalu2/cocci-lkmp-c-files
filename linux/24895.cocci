...
position p;
@@
 struct sockaddr_l2tpip6 cocci_id@p ;
...
position p;
@@
 struct sockaddr_l2tpip cocci_id@p ;
...
position p;
@@
 enum l2tp_encap_type cocci_id@p ;
...
typedef u32,u16;
@@
 struct l2tp_skb_cb {  u32 ns ;  u16 has_seq ;  u16 length ;  unsigned long expires ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct l2tp_net {  struct list_head l2tp_tunnel_list ;  spinlock_t l2tp_tunnel_list_lock ;  struct hlist_head l2tp_session_hlist [ L2TP_HASH_SIZE_2 ] ;  spinlock_t l2tp_session_hlist_lock ; } cocci_id@p ;
...
position p;
@@
 const struct l2tp_net * cocci_id@p ;
