...
typedef u32;
@@
 struct g2d_cmdlist {  u32 head ;  unsigned long data [ G2D_CMDLIST_DATA_NUM ] ;  u32 last ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,atomic_t,dma_addr_t;
@@
 struct g2d_cmdlist_userptr {  struct list_head list ;  dma_addr_t dma_addr ;  unsigned long userptr ;  unsigned long size ;  struct frame_vector * vec ;  struct sg_table * sgt ;  atomic_t refcount ;  bool in_pool ;  bool out_of_list ; } cocci_id@p ;
...
position p;
@@
 struct drm_exynos_g2d_userptr cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct g2d_data {  struct device * dev ;  struct clk * gate_clk ;  void __iomem * regs ;  int irq ;  struct workqueue_struct * g2d_workq ;  struct work_struct runqueue_work ;  struct drm_device * drm_dev ;  unsigned long flags ;  struct g2d_cmdlist_node * cmdlist_node ;  struct list_head free_cmdlist ;  struct mutex cmdlist_mutex ;  dma_addr_t cmdlist_pool ;  void * cmdlist_pool_virt ;  unsigned long cmdlist_dma_attrs ;  struct g2d_runqueue_node * runqueue_node ;  struct list_head runqueue ;  struct mutex runqueue_mutex ;  struct kmem_cache * runqueue_slab ;  unsigned long current_pool ;  unsigned long max_pool ; } cocci_id@p ;
...
position p;
@@
 struct drm_exynos_g2d_exec * cocci_id@p ;
...
position p;
@@
 struct g2d_cmdlist_node cocci_id@p ;
...
position p;
@@
 struct drm_exynos_g2d_get_ver * cocci_id@p ;
...
position p;
@@
 struct g2d_buf_info * cocci_id@p ;
...
position p;
@@
 struct drm_exynos_pending_g2d_event cocci_id@p ;
...
position p;
@@
 struct g2d_buf_desc {  unsigned int format ;  unsigned int stride ;  unsigned int left_x ;  unsigned int top_y ;  unsigned int right_x ;  unsigned int bottom_y ; } cocci_id@p ;
...
position p;
@@
 enum g2d_flag_bits { G2D_BIT_SUSPEND_RUNQUEUE , G2D_BIT_ENGINE_BUSY , } cocci_id@p ;
...
position p;
@@
 struct drm_exynos_pending_g2d_event {  struct drm_pending_event base ;  struct drm_exynos_g2d_event event ; } cocci_id@p ;
...
position p;
@@
 enum g2d_reg_type { REG_TYPE_NONE = - 1 , REG_TYPE_SRC , REG_TYPE_SRC_PLANE2 , REG_TYPE_DST , REG_TYPE_DST_PLANE2 , REG_TYPE_PAT , REG_TYPE_MSK , MAX_REG_TYPE_NR , } cocci_id@p ;
...
position p;
@@
 struct exynos_drm_gem * cocci_id@p ;
...
position p;
@@
 struct g2d_runqueue_node cocci_id@p ;
...
position p;
@@
 enum { BUF_TYPE_GEM = 1 , BUF_TYPE_USERPTR , } cocci_id@p ;
...
position p;
@@
 struct drm_exynos_file_private * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct g2d_cmdlist_node {  struct list_head list ;  struct g2d_cmdlist * cmdlist ;  dma_addr_t dma_addr ;  struct g2d_buf_info buf_info ;  struct drm_exynos_pending_g2d_event * event ; } cocci_id@p ;
...
position p;
@@
 struct g2d_cmdlist_userptr * cocci_id@p ;
...
position p;
@@
 struct g2d_buf_info {  unsigned int map_nr ;  enum g2d_reg_type reg_types [ MAX_REG_TYPE_NR ] ;  void * obj [ MAX_REG_TYPE_NR ] ;  unsigned int types [ MAX_REG_TYPE_NR ] ;  struct g2d_buf_desc descs [ MAX_REG_TYPE_NR ] ; } cocci_id@p ;
...
position p;
@@
 struct exynos_drm_private * cocci_id@p ;
...
typedef pid_t;
@@
 struct g2d_runqueue_node {  struct list_head list ;  struct list_head run_cmdlist ;  struct list_head event_list ;  struct drm_file * filp ;  pid_t pid ;  struct completion complete ;  int async ; } cocci_id@p ;
...
position p;
@@
 struct g2d_buf_desc * cocci_id@p ;
...
position p;
@@
 struct drm_exynos_g2d_cmd * cocci_id@p ;
...
position p;
@@
 struct drm_exynos_g2d_set_cmdlist * cocci_id@p ;
