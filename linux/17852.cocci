...
position p;
@@
 struct ia64_tr_entry * cocci_id@p [ NR_CPUS ] ;
...
typedef u64;
@@
 struct {  u64 mask ;  unsigned long max_bits ; } cocci_id@p ;
...
position p;
@@
 struct spinaphore {  unsigned long ticket ;  unsigned long serve ; } cocci_id@p ;
