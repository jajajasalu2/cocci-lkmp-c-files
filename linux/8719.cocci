...
position p;
@@
 struct config_param * cocci_id@p ;
...
position p;
@@
 struct list_info_hold cocci_id@p ;
...
position p;
@@
 const struct s2io_nic * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_RX_RINGS ] ;
...
position p;
@@
 struct rx_curr_get_info cocci_id@p ;
...
position p;
@@
 struct rx_block_info * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_TX_FIFOS ] ;
...
position p;
@@
 struct tx_fifo_config * cocci_id@p ;
...
position p;
@@
 struct tx_curr_get_info cocci_id@p ;
...
position p;
@@
 struct s2io_msix_entry cocci_id@p ;
...
position p;
@@
 struct rx_ring_config * cocci_id@p ;
