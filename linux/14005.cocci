...
@@
 struct ir_rx51 {  struct rc_dev * rcdev ;  struct pwm_device * pwm ;  struct hrtimer timer ;  struct device * dev ;  wait_queue_head_t wqueue ;  unsigned int freq ;  unsigned int duty_cycle ;  int wbuf [ WBUF_LEN ] ;  int wbuf_index ;  unsigned long device_is_open ; } cocci_id@p ;
