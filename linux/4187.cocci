...
position p;
@@
 struct spear1340_miphy_priv * cocci_id@p ;
...
position p;
@@
 enum spear1340_miphy_mode { SATA , PCIE , } cocci_id@p ;
...
position p;
@@
 struct spear1340_miphy_priv {  enum spear1340_miphy_mode mode ;  struct regmap * misc ;  struct phy * phy ; } cocci_id@p ;
