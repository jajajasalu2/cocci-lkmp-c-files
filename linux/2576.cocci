...
typedef bool;
@@
 bool cocci_id@p ( struct btree_iter_set , struct btree_iter_set ) ;
...
position p;
@@
 struct bset_search_iter cocci_id@p ;
...
position p;
@@
 const struct btree_keys_ops * cocci_id@p ;
...
position p;
@@
 struct bset_sort_state * cocci_id@p ;
