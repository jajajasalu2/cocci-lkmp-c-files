...
position p;
@@
 int cocci_id@p ( struct map_info * map , struct flchip * chip , int mode ) ;
...
position p;
@@
 void cocci_id@p ( struct map_info * map , struct flchip * chip ) ;
...
position p;
@@
 struct lpddr_private * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mtd_info * mtd , struct erase_info * instr ) ;
