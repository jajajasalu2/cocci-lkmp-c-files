...
position p;
@@
 struct xfs_bmbt_key * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_bmbt_irec_t;
@@
 xfs_bmbt_irec_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_extnum_t;
@@
 xfs_extnum_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_btree_cur_t;
@@
 xfs_btree_cur_t * cocci_id@p ;
...
position p;
@@
 struct xfs_alloc_arg cocci_id@p ;
...
position p;
@@
 struct xfs_bmalloca cocci_id@p ;
...
position p;
@@
 struct xfs_iread_state cocci_id@p ;
...
position p;
@@
 struct xfs_owner_info cocci_id@p ;
...
position p;
@@
 union xfs_btree_rec cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_filblks_t;
@@
 xfs_filblks_t * cocci_id@p ;
...
position p;
@@
 struct xfs_bmbt_rec * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_exntst_t;
@@
 xfs_exntst_t cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct xfs_trans * tp , struct xfs_buf * bp , struct xfs_inode * ip , struct xfs_ifork * ifp ) ;
...
symbol cocci_id;
position p;
typedef xfs_alloc_arg_t;
@@
 xfs_alloc_arg_t cocci_id@p ;
...
position p;
@@
 struct xfs_bmap_intent cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_bmbt_key_t;
@@
 xfs_bmbt_key_t * cocci_id@p ;
...
position p;
@@
 enum xfs_bmap_intent_type cocci_id@p ;
...
position p;
@@
 const struct xfs_owner_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_bmbt_ptr_t;
@@
 xfs_bmbt_ptr_t * cocci_id@p ;
...
typedef xfs_extnum_t;
@@
 struct xfs_iread_state {  struct xfs_iext_cursor icur ;  xfs_extnum_t loaded ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_alloctype_t;
@@
 xfs_alloctype_t cocci_id@p ;
