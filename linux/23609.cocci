...
typedef u32;
@@
 struct fsi_core {  int ver ;  u32 int_st ;  u32 iemsk ;  u32 imsk ;  u32 a_mclk ;  u32 b_mclk ; } cocci_id@p ;
...
position p;
@@
 struct {  char * name ;  unsigned int val ; } cocci_id@p [ ] ;
...
@@
 struct fsi_priv {  void __iomem * base ;  phys_addr_t phys ;  struct fsi_master * master ;  struct fsi_stream playback ;  struct fsi_stream capture ;  struct fsi_clk clock ;  u32 fmt ;  int chan_num : 16 ;  unsigned int clk_master : 1 ;  unsigned int clk_cpg : 1 ;  unsigned int spdif : 1 ;  unsigned int enable_stream : 1 ;  unsigned int bit_clk_inv : 1 ;  unsigned int lr_clk_inv : 1 ; } cocci_id@p ;
...
position p;
@@
 struct fsi_stream_handler cocci_id@p ;
...
typedef u32;
@@
 struct fsi_stream {  struct snd_pcm_substream * substream ;  int fifo_sample_capa ;  int buff_sample_capa ;  int buff_sample_pos ;  int period_samples ;  int period_pos ;  int sample_width ;  int uerr_num ;  int oerr_num ;  u32 bus_option ;  struct fsi_stream_handler * handler ;  struct fsi_priv * priv ;  struct dma_chan * chan ;  int dma_id ; } cocci_id@p ;
...
position p;
@@
 struct sh_fsi_port_info * cocci_id@p ;
...
position p;
@@
 const struct fsi_core cocci_id@p ;
...
typedef spinlock_t;
@@
 struct fsi_master {  void __iomem * base ;  struct fsi_priv fsia ;  struct fsi_priv fsib ;  const struct fsi_core * core ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( struct fsi_priv * fsi , u8 * buf , int samples ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device * dev , struct fsi_priv * fsi ) ;
...
position p;
@@
 struct sh_fsi_platform_info cocci_id@p ;
