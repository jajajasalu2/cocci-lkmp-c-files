...
position p;
@@
 const struct dsi_phy_range cocci_id@p [ ] ;
...
typedef u32;
@@
 struct dsi_phy_range {  u32 min_range_kHz ;  u32 max_range_kHz ;  u32 pll_vco_750M ;  u32 hstx_ckg_sel ; } cocci_id@p ;
...
position p;
@@
 struct dsi_data {  struct dw_dsi dsi ;  struct dsi_hw_ctx ctx ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct dw_dsi {  struct drm_encoder encoder ;  struct drm_bridge * bridge ;  struct mipi_dsi_host host ;  struct drm_display_mode cur_mode ;  struct dsi_hw_ctx * ctx ;  struct mipi_phy_params phy ;  u32 lanes ;  enum mipi_dsi_pixel_format format ;  unsigned long mode_flags ;  bool enable ; } cocci_id@p ;
...
position p;
@@
 struct mipi_phy_params cocci_id@p ;
...
typedef u32;
@@
 struct mipi_phy_params {  u32 clk_t_lpx ;  u32 clk_t_hs_prepare ;  u32 clk_t_hs_zero ;  u32 clk_t_hs_trial ;  u32 clk_t_wakeup ;  u32 data_t_lpx ;  u32 data_t_hs_prepare ;  u32 data_t_hs_zero ;  u32 data_t_hs_trial ;  u32 data_t_ta_go ;  u32 data_t_ta_get ;  u32 data_t_wakeup ;  u32 hstx_ckg_sel ;  u32 pll_fbd_div5f ;  u32 pll_fbd_div1f ;  u32 pll_fbd_2p ;  u32 pll_enbwt ;  u32 pll_fbd_p ;  u32 pll_fbd_s ;  u32 pll_pre_div1p ;  u32 pll_pre_p ;  u32 pll_vco_750M ;  u32 pll_lpf_rs ;  u32 pll_lpf_cs ;  u32 clklp2hs_time ;  u32 clkhs2lp_time ;  u32 lp2hs_time ;  u32 hs2lp_time ;  u32 clk_to_data_delay ;  u32 data_to_clk_delay ;  u32 lane_byte_clk_kHz ;  u32 clk_division ; } cocci_id@p ;
...
position p;
@@
 struct dsi_hw_ctx {  void __iomem * base ;  struct clk * pclk ; } cocci_id@p ;
