...
position p;
@@
 const struct lv0104cs_mapping cocci_id@p [ ] ;
...
typedef u8;
@@
 struct lv0104cs_mapping {  int val ;  int val2 ;  u8 regval ; } cocci_id@p ;
...
typedef u8;
@@
 struct lv0104cs_private {  struct i2c_client * client ;  struct mutex lock ;  u8 calibscale ;  u8 scale ;  u8 int_time ; } cocci_id@p ;
...
position p;
@@
 struct lv0104cs_private * cocci_id@p ;
