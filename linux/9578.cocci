...
typedef ray_dev_t;
@@
 int cocci_id@p ( ray_dev_t * local , UCHAR * dest , int auth_type ) ;
...
position p;
@@
 struct b5_startup_params cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned char * data , int len , struct net_device * dev , UCHAR type ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , struct rcs __iomem * prcs , unsigned int pkt_addr , int rx_len ) ;
...
position p;
@@
 UCHAR cocci_id@p [ IW_ESSID_MAX_SIZE + 1 ] ;
...
typedef ray_dev_t;
@@
 int cocci_id@p ( ray_dev_t * local , struct tx_msg __iomem * ptx , unsigned char * data , int len ) ;
...
typedef ray_dev_t;
@@
 int cocci_id@p ( ray_dev_t * local , int ccs ) ;
...
typedef ray_dev_t;
@@
 void cocci_id@p ( ray_dev_t * local , struct rcs __iomem * prcs ) ;
...
typedef ray_dev_t;
@@
 void cocci_id@p ( ray_dev_t * local ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int reg , void * dev_id ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int all ) ;
...
typedef ray_dev_t;
@@
 void cocci_id@p ( ray_dev_t * local , struct sk_buff * skb , int len ) ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , UCHAR objid , UCHAR * value , int len ) ;
...
typedef ray_dev_t;
@@
 void cocci_id@p ( ray_dev_t * local , struct rcs __iomem * prcs , unsigned int pkt_addr , int rx_len ) ;
...
typedef ray_dev_t;
@@
 void cocci_id@p ( ray_dev_t * local , struct tx_msg __iomem * ptx , UCHAR msg_type , unsigned char * data ) ;
...
typedef ray_dev_t;
@@
 int cocci_id@p ( ray_dev_t * local , UCHAR * dest , int pkt_addr , int len ) ;
...
position p;
@@
 int cocci_id@p ( char * in_str , UCHAR * out ) ;
...
position p;
@@
 struct startup_res_6 cocci_id@p ;
...
position p;
@@
 struct freq_hop_element * cocci_id@p ;
...
typedef ray_dev_t;
@@
 int cocci_id@p ( ray_dev_t * local ) ;
...
position p;
@@
 struct b4_startup_params cocci_id@p ;
