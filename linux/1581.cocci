...
typedef spinlock_t;
@@
 struct cyberjack_private {  spinlock_t lock ;  short rdtodo ;  unsigned char wrbuf [ 5 * 64 ] ;  short wrfilled ;  short wrsent ; } cocci_id@p ;
...
position p;
@@
 struct cyberjack_private cocci_id@p ;
