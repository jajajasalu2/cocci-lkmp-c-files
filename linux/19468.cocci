...
typedef nasid_t;
@@
 struct bridge_irq_chip_data {  struct bridge_controller * bc ;  nasid_t nasid ; } cocci_id@p ;
...
position p;
@@
 struct xtalk_bridge_platform_data * cocci_id@p ;
...
position p;
@@
 struct bridge_controller * cocci_id@p ;
...
position p;
@@
 const struct {  char * match ;  void ( * setup ) ( struct bridge_controller * bc ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct bridge_irq_chip_data * cocci_id@p ;
