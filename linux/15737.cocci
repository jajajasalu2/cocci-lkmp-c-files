...
position p;
@@
 const struct wfx_tx_priv * cocci_id@p ;
...
position p;
@@
 struct hif_mib_set_tx_rate_retry_policy * cocci_id@p ;
...
position p;
@@
 struct hif_ht_tx_parameters cocci_id@p ;
...
position p;
@@
 struct hif_mib_tx_rate_retry_policy * cocci_id@p ;
