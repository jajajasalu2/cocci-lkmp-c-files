...
position p;
@@
 struct imx6_cpu_pm_info * cocci_id@p ;
...
position p;
@@
 struct imx6_pm_base * cocci_id@p ;
...
typedef u32;
@@
 struct imx6_pm_socdata {  u32 ddr_type ;  const char * mmdc_compat ;  const char * src_compat ;  const char * iomuxc_compat ;  const char * gpc_compat ;  const char * pl310_compat ;  const u32 mmdc_io_num ;  const u32 * mmdc_io_offset ; } cocci_id@p ;
...
typedef phys_addr_t;
@@
 struct imx6_pm_base {  phys_addr_t pbase ;  void __iomem * vbase ; } cocci_id@p ;
...
position p;
@@
 const struct imx6_pm_socdata * cocci_id@p ;
