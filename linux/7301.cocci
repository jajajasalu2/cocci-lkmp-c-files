...
position p;
@@
 struct lm3533_bl_platform_data * cocci_id@p ;
...
position p;
@@
 struct lm3533_bl {  struct lm3533 * lm3533 ;  struct lm3533_ctrlbank cb ;  struct backlight_device * bd ;  int id ; } cocci_id@p ;
