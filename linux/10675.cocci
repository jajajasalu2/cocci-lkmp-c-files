...
position p;
@@
 const struct bdb_header * cocci_id@p ;
...
position p;
@@
 const struct bdb_mipi_sequence * cocci_id@p ;
...
position p;
@@
 struct lvds_fp_timing cocci_id@p ;
...
position p;
@@
 const struct bdb_psr * cocci_id@p ;
...
position p;
@@
 const struct bdb_mipi_config * cocci_id@p ;
...
position p;
@@
 const struct psr_table * cocci_id@p ;
...
position p;
@@
 const struct bdb_driver_features * cocci_id@p ;
...
position p;
@@
 const struct bdb_lvds_options * cocci_id@p ;
...
position p;
@@
 const struct bdb_lvds_lfp_data * cocci_id@p ;
...
position p;
@@
 const struct mipi_pps_data * cocci_id@p ;
...
position p;
@@
 const struct child_device_config * cocci_id@p ;
...
position p;
@@
 const struct mipi_config * cocci_id@p ;
...
position p;
@@
 const struct bdb_edp * cocci_id@p ;
...
position p;
@@
 struct lvds_dvo_timing * cocci_id@p ;
...
position p;
@@
 const struct edp_fast_link_params * cocci_id@p ;
...
position p;
@@
 const struct lfp_backlight_data_entry * cocci_id@p ;
...
position p;
@@
 struct mipi_pps_data cocci_id@p ;
...
position p;
@@
 const struct bdb_sdvo_lvds_options * cocci_id@p ;
...
position p;
@@
 const struct bdb_lfp_backlight_data * cocci_id@p ;
...
position p;
@@
 const struct lfp_backlight_control_method * cocci_id@p ;
...
position p;
@@
 const struct lvds_dvo_timing * cocci_id@p ;
...
position p;
@@
 const struct bdb_lvds_lfp_data_ptrs * cocci_id@p ;
...
position p;
@@
 const struct bdb_general_features * cocci_id@p ;
...
position p;
@@
 const struct vbt_header * cocci_id@p ;
...
typedef u16;
@@
 const struct {  u16 dp , hdmi ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct bdb_general_definitions * cocci_id@p ;
...
position p;
@@
 const struct lvds_fp_timing * cocci_id@p ;
...
position p;
@@
 const struct bdb_sdvo_panel_dtds * cocci_id@p ;
