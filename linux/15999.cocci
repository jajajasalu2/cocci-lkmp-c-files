...
position p;
@@
 struct p2p_oper_class_map cocci_id@p [ ] ;
...
position p;
@@
 struct rt_channel_plan cocci_id@p ;
...
position p;
@@
 struct rt_channel_plan_map cocci_id@p [ RT_CHANNEL_DOMAIN_MAX ] ;
...
position p;
@@
 struct rt_channel_plan_2g cocci_id@p [ RT_CHANNEL_DOMAIN_2G_MAX ] ;
...
position p;
@@
 struct rt_channel_info * cocci_id@p ;
...
position p;
@@
 const struct rt_channel_plan_map cocci_id@p ;
...
position p;
@@
 struct ndis_802_11_fixed_ie cocci_id@p ;
...
position p;
@@
 struct rt_channel_info cocci_id@p [ MAX_CHANNEL_NUM ] ;
...
position p;
@@
 struct ndis_802_11_var_ie * cocci_id@p ;
