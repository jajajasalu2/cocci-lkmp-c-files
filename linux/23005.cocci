...
position p;
@@
 struct sprd_pcm_dma_private {  struct snd_pcm_substream * substream ;  struct sprd_pcm_dma_params * params ;  struct sprd_pcm_dma_data data [ SPRD_PCM_CHANNEL_MAX ] ;  int hw_chan ;  int dma_addr_offset ; } cocci_id@p ;
...
position p;
@@
 struct sprd_pcm_dma_data * cocci_id@p ;
...
@@
 struct sprd_pcm_dma_data {  struct dma_chan * chan ;  struct dma_async_tx_descriptor * desc ;  dma_cookie_t cookie ;  dma_addr_t phys ;  void * virt ;  int pre_pointer ; } cocci_id@p ;
...
position p;
@@
 struct sprd_pcm_dma_private * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ SPRD_PCM_CHANNEL_MAX ] ;
