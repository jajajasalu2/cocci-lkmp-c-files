...
position p;
@@
 const struct cfg_hw_sample_format cocci_id@p [ ] ;
...
position p;
@@
 struct cfg_hw_sample_rate {  const char * name ;  unsigned int mask ;  unsigned int value ; } cocci_id@p ;
...
position p;
@@
 struct xen_front_cfg_stream cocci_id@p ;
...
position p;
@@
 const struct cfg_hw_sample_rate cocci_id@p [ ] ;
...
typedef u64;
@@
 struct cfg_hw_sample_format {  const char * name ;  u64 mask ; } cocci_id@p ;
