...
position p;
@@
 struct hi6421_regulator_pdata * cocci_id@p ;
...
position p;
@@
 struct hi6421_regulator_pdata {  struct mutex lock ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct hi6421_regulator_info {  struct regulator_desc desc ;  u8 mode_mask ;  u32 eco_microamp ; } cocci_id@p ;
...
position p;
@@
 struct hi6421_regulator_info cocci_id@p [ HI6421_NUM_REGULATORS ] ;
...
position p;
@@
 struct hi6421_regulator_info * cocci_id@p ;
