...
position p;
@@
 struct rsi_wlan_9116_features cocci_id@p ;
...
position p;
@@
 struct rsi_mac_frame * cocci_id@p ;
...
position p;
@@
 struct rsi_chan_config * cocci_id@p ;
...
position p;
@@
 struct rsi_bb_rf_prog * cocci_id@p ;
...
position p;
@@
 struct rsi_boot_params * cocci_id@p ;
...
position p;
@@
 struct rsi_ant_sel_frame * cocci_id@p ;
...
position p;
@@
 struct rsi_peer_notify cocci_id@p ;
...
position p;
@@
 struct bootup_params_9116 cocci_id@p ;
...
position p;
@@
 struct rsi_auto_rate * cocci_id@p ;
...
position p;
@@
 struct rsi_eeprom_read_frame * cocci_id@p ;
...
position p;
@@
 struct rsi_bgscan_config * cocci_id@p ;
...
position p;
@@
 struct rsi_boot_params_9116 cocci_id@p ;
...
position p;
@@
 struct rsi_radio_caps cocci_id@p ;
...
position p;
@@
 struct rsi_bgscan_probe * cocci_id@p ;
...
position p;
@@
 struct rsi_aggr_params * cocci_id@p ;
...
position p;
@@
 struct rsi_wowlan_req * cocci_id@p ;
...
position p;
@@
 struct rsi_block_unblock_data * cocci_id@p ;
...
position p;
@@
 struct rsi_dynamic_s * cocci_id@p ;
...
position p;
@@
 struct rsi_bgscan_params cocci_id@p ;
...
position p;
@@
 struct rsi_vap_caps * cocci_id@p ;
...
position p;
@@
 struct rsi_config_vals * cocci_id@p ;
...
position p;
@@
 struct rsi_request_ps * cocci_id@p ;
...
position p;
@@
 struct bootup_params cocci_id@p ;
...
position p;
@@
 struct rsi_cmd_desc * cocci_id@p ;
