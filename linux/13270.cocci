...
position p;
@@
 enum i2c_attr { NOP = 0 , STOP = 1 , CONTINUE = 2 , START = 3 , } cocci_id@p ;
...
position p;
@@
 enum i2c_status { IDLE = 0 , DONE_STOP = 1 , BUSY = 2 , TO_SCL = 3 , TO_ARB = 4 , DONE_WRITE = 5 , DONE_READ = 6 , DONE_WRITE_TO = 7 , DONE_READ_TO = 8 , NO_DEVICE = 9 , NO_ACKN = 10 , BUS_ERR = 11 , ARB_LOST = 12 , SEQ_ERR = 13 , ST_ERR = 14 , SW_ERR = 15 , } cocci_id@p ;
