...
position p;
@@
 enum mlxfw_fsm_state_err * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_port_type_speed_ops * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PSPA_LEN ] ;
...
position p;
@@
 enum mlxsw_reg_pude_oper_status cocci_id@p ;
...
position p;
@@
 const enum ethtool_link_mode_bit_indices cocci_id@p [ ] ;
...
position p;
@@
 const struct mlxfw_dev_ops cocci_id@p ;
...
position p;
@@
 const struct mlxsw_listener cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SPVID_LEN ] ;
...
position p;
@@
 const struct mlxsw_reg_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PPAD_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PBMC_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_acl_block * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp2_port_link_mode cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PPLR_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SSPR_LEN ] ;
...
position p;
@@
 enum mlxsw_reg_qeec_hr cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_htgt_trap_group cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_port_mapping * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MCQI_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_port_hw_stats * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SPAFT_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SLDR_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_mlxfw_dev * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_tx_info cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_span_type cocci_id@p ;
...
typedef u32;
@@
 struct mlxsw_sp1_port_link_mode {  enum ethtool_link_mode_bit_indices mask_ethtool ;  u32 mask ;  u32 speed ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IEEE_8021QAZ_MAX_TCS ] ;
...
typedef u8,u32;
@@
 struct mlxsw_sp2_port_link_mode {  const enum ethtool_link_mode_bit_indices * mask_ethtool ;  int m_ethtool_len ;  u32 mask ;  u32 speed ;  u8 mask_width ; } cocci_id@p ;
...
position p;
@@
 mlxsw_sp_feature_handler cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_port_pcpu_stats * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MLCR_LEN ] ;
...
position p;
@@
 enum mlxsw_reg_ppcnt_grp cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MCDA_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_span_entry * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PMLP_LEN ] ;
...
symbol cocci_id;
position p;
typedef flow_setup_cb_t;
@@
 flow_setup_cb_t * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_config_profile * cocci_id@p ;
...
position p;
@@
 struct netdev_lag_lower_state_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_QTCTM_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_port_xstats * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PFCC_LEN ] ;
...
position p;
@@
 struct mlxsw_driver cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MPSC_LEN ] ;
...
position p;
@@
 struct psample_group * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SLCOR_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_port_mall_mirror_tc_entry * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_fw_rev * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MCC_LEN ] ;
...
position p;
@@
 enum mlxsw_reg_qpcr_ir_units cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SPAD_LEN ] ;
...
position p;
@@
 enum mlxsw_reg_spms_state cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp1_port_link_mode cocci_id@p [ ] ;
...
position p;
@@
 struct mlxsw_sp_port_mall_tc_entry * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_HTGT_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PTYS_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_mlxfw_dev {  struct mlxfw_dev mlxfw_dev ;  struct mlxsw_sp * mlxsw_sp ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_upper * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct notifier_block * unused , unsigned long event , void * ptr ) ;
...
position p;
@@
 struct ethtool_modinfo * cocci_id@p ;
...
position p;
@@
 struct flow_block_offload * cocci_id@p ;
...
position p;
@@
 struct mlxsw_skb_cb cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_QPCR_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SLCR_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_QEEC_LEN ] ;
...
typedef bool;
@@
 int ( * cocci_id@p ) ( struct net_device * dev , bool enable ) ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PAOS_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_QTCT_LEN ] ;
...
position p;
@@
 struct flow_block_cb * cocci_id@p ;
...
position p;
@@
 struct netdev_notifier_changelowerstate_info * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_bus_info * cocci_id@p ;
...
position p;
@@
 enum mlxfw_fsm_state * cocci_id@p ;
...
position p;
@@
 struct netdev_lag_upper_info * cocci_id@p ;
...
typedef u64,bool;
@@
 struct mlxsw_sp_port_hw_stats {  char str [ ETH_GSTRING_LEN ] ;  u64 ( * getter ) ( const char * payload ) ;  bool cells_bytes ; } cocci_id@p ;
...
position p;
@@
 enum mlxsw_reg_ptys_connector_type cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PPCNT_LEN ] ;
...
position p;
@@
 const struct mlxsw_sp_ptp_ops cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MGPC_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SVPE_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_PMTU_LEN ] ;
