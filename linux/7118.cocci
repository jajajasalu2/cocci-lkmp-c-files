...
position p;
@@
 struct pci_port_ops cocci_id@p ;
...
position p;
@@
 struct pci_bios_ops cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct parisc_device * dev , u32 iovp ) ;
