...
typedef u32;
@@
 struct rk_i2s_pins {  u32 reg_offset ;  u32 shift ; } cocci_id@p ;
...
typedef bool;
@@
 struct rk_i2s_dev {  struct device * dev ;  struct clk * hclk ;  struct clk * mclk ;  struct snd_dmaengine_dai_dma_data capture_dma_data ;  struct snd_dmaengine_dai_dma_data playback_dma_data ;  struct regmap * regmap ;  struct regmap * grf ;  bool tx_start ;  bool rx_start ;  bool is_master_mode ;  const struct rk_i2s_pins * pins ; } cocci_id@p ;
...
position p;
@@
 const struct rk_i2s_pins cocci_id@p ;
