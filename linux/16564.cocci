...
position p;
@@
 struct pkey_clr2seck2 cocci_id@p ;
...
position p;
@@
 struct pkey_findcard cocci_id@p ;
...
position p;
@@
 struct pkey_kblob2pkey2 cocci_id@p ;
...
position p;
@@
 const struct pkey_protkey * cocci_id@p ;
...
position p;
@@
 struct pkey_protkey * cocci_id@p ;
...
position p;
@@
 struct protaeskeytoken cocci_id@p ;
...
position p;
@@
 struct pkey_apqns4key cocci_id@p ;
...
position p;
@@
 const struct pkey_apqn * cocci_id@p ;
...
position p;
@@
 struct pkey_clr2seck cocci_id@p ;
...
position p;
@@
 struct pkey_genseck cocci_id@p ;
...
position p;
@@
 struct pkey_verifyprotk cocci_id@p ;
...
position p;
@@
 struct pkey_verifykey2 cocci_id@p ;
...
position p;
@@
 struct pkey_verifykey cocci_id@p ;
...
position p;
@@
 const struct pkey_seckey * cocci_id@p ;
...
position p;
@@
 struct pkey_genseck2 cocci_id@p ;
...
position p;
@@
 const struct pkey_clrkey * cocci_id@p ;
...
position p;
@@
 struct pkey_sec2protk cocci_id@p ;
...
position p;
@@
 struct pkey_clr2protk cocci_id@p ;
...
typedef u8;
@@
 struct {  u8 iv [ AES_BLOCK_SIZE ] ;  u8 key [ MAXPROTKEYSIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct pkey_skey2pkey cocci_id@p ;
...
position p;
@@
 struct pkey_apqns4keytype cocci_id@p ;
...
position p;
@@
 struct pkey_genprotk cocci_id@p ;
...
position p;
@@
 struct pkey_kblob2pkey cocci_id@p ;
