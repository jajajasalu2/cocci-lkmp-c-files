...
position p;
@@
 int cocci_id@p ( void * handle , enum amd_powergating_state state ) ;
...
position p;
@@
 int cocci_id@p ( struct amdgpu_device * adev , struct dpg_pause_state * new_state ) ;
...
position p;
@@
 struct dpg_pause_state * cocci_id@p ;
