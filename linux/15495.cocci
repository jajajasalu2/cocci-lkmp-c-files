...
position p;
@@
 struct serdev_device_ops cocci_id@p ;
...
position p;
@@
 enum send_wakeup { PN532_SEND_NO_WAKEUP = 0 , PN532_SEND_WAKEUP , PN532_SEND_LAST_WAKEUP , } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ PN533_STD_FRAME_ACK_SIZE ] ;
...
position p;
@@
 struct pn532_uart_phy {  struct serdev_device * serdev ;  struct sk_buff * recv_skb ;  struct pn533 * priv ;  enum send_wakeup send_wakeup ;  struct timer_list cmd_timeout ;  struct sk_buff * cur_out_buf ; } cocci_id@p ;
...
position p;
@@
 struct pn532_uart_phy * cocci_id@p ;
