...
position p;
@@
 const struct edp_power_seq * cocci_id@p ;
...
position p;
@@
 const struct dp_link_dpll * cocci_id@p ;
...
position p;
@@
 struct intel_digital_connector_state * cocci_id@p ;
...
position p;
@@
 struct link_config_limits * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ HDMI_INFOFRAME_HEADER_SIZE + HDMI_DRM_INFOFRAME_SIZE ] ;
...
position p;
@@
 const struct hdcp2_dp_msg_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HDCP_2_2_RXINFO_LEN ] ;
...
position p;
@@
 void cocci_id@p ( struct intel_dp * intel_dp ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ HEADER_SIZE + DRM_HDCP_KSV_LEN ] ;
...
typedef u8,bool,u32;
@@
 struct hdcp2_dp_msg_data {  u8 msg_id ;  u32 offset ;  bool msg_detectable ;  u32 timeout ;  u32 timeout2 ; } cocci_id@p ;
...
position p;
@@
 struct pps_registers * cocci_id@p ;
...
typedef i915_reg_t;
@@
 struct pps_registers {  i915_reg_t pp_ctrl ;  i915_reg_t pp_stat ;  i915_reg_t pp_on ;  i915_reg_t pp_off ;  i915_reg_t pp_div ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct intel_encoder * encoder , const struct intel_crtc_state * crtc_state ) ;
...
position p;
@@
 void cocci_id@p ( struct intel_encoder * encoder , const struct intel_crtc_state * old_crtc_state ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct intel_dp * intel_dp ) ;
...
position p;
@@
 const struct link_config_limits * cocci_id@p ;
...
position p;
@@
 enum intel_hotplug_state cocci_id@p ;
...
position p;
@@
 struct dp_sdp_header cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct intel_dp * intel_dp , bool sync ) ;
...
position p;
@@
 const struct intel_hdcp_shim cocci_id@p ;
...
position p;
@@
 struct hdcp2_dp_errata_stream_type cocci_id@p ;
...
position p;
@@
 struct intel_uncore * cocci_id@p ;
...
position p;
@@
 struct drm_dp_aux_msg * cocci_id@p ;
...
position p;
@@
 typeof ( * intel_connector ) cocci_id@p ;
...
position p;
@@
 enum drrs_refresh_rate_type cocci_id@p ;
...
position p;
@@
 struct dp_link_dpll {  int clock ;  struct dpll dpll ; } cocci_id@p ;
...
position p;
@@
 struct intel_lspcon * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct drm_i915_private * dev_priv , enum pipe pipe ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_i915_private * dev_priv , enum pipe pipe ) ;
...
position p;
@@
 const struct drm_dp_aux_msg * cocci_id@p ;
...
position p;
@@
 const struct intel_digital_connector_state * cocci_id@p ;
...
position p;
@@
 const struct intel_dp * cocci_id@p ;
...
position p;
@@
 struct edp_power_seq cocci_id@p ;
...
position p;
@@
 const struct ddi_vbt_port_info * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct intel_dp * intel_dp , bool force_disable_vdd ) ;
...
position p;
@@
 struct hdcp2_rep_send_receiverid_list cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ DP_LINK_STATUS_SIZE ] ;
