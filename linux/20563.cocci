...
symbol cocci_id;
position p;
typedef efi_runtime_services_64_t;
@@
 efi_runtime_services_64_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_system_table_64_t;
@@
 efi_system_table_64_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_system_table_32_t;
@@
 efi_system_table_32_t * cocci_id@p ;
...
position p;
@@
 struct efi_memory_map_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_runtime_services_32_t;
@@
 efi_runtime_services_32_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_set_virtual_address_map_t;
@@
 efi_set_virtual_address_map_t * cocci_id@p ;
...
position p;
@@
 const unsigned long * const cocci_id@p [ ] ;
