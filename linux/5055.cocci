...
position p;
@@
 struct mtk {  struct device * dev ;  void __iomem * base ;  int gpio_irq ;  struct mtk_gc gc_map [ MTK_BANK_CNT ] ; } cocci_id@p ;
...
@@
 struct mtk_gc {  struct irq_chip irq_chip ;  struct gpio_chip chip ;  spinlock_t lock ;  int bank ;  u32 rising ;  u32 falling ;  u32 hlevel ;  u32 llevel ; } cocci_id@p ;
