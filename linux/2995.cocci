...
typedef acpi_handle;
@@
 struct acpi_ged_event {  struct list_head node ;  struct device * dev ;  unsigned int gsi ;  unsigned int irq ;  acpi_handle handle ; } cocci_id@p ;
...
position p;
@@
 struct acpi_ged_device * cocci_id@p ;
...
position p;
@@
 struct acpi_ged_event * cocci_id@p ;
...
position p;
@@
 struct acpi_ged_device {  struct device * dev ;  struct list_head event_list ; } cocci_id@p ;
