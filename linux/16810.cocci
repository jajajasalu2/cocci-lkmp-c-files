...
symbol cocci_id;
position p;
typedef ad714x_write_t;
@@
 ad714x_write_t cocci_id@p ;
...
position p;
@@
 struct ad714x_touchpad_drv {  int x_highest_stage ;  int x_flt_pos ;  int x_abs_pos ;  int y_highest_stage ;  int y_flt_pos ;  int y_abs_pos ;  int left_ep ;  int left_ep_val ;  int right_ep ;  int right_ep_val ;  int top_ep ;  int top_ep_val ;  int bottom_ep ;  int bottom_ep_val ;  enum ad714x_device_state state ;  struct input_dev * input ; } cocci_id@p ;
...
position p;
@@
 struct ad714x_wheel_plat * cocci_id@p ;
...
position p;
@@
 struct ad714x_slider_plat * cocci_id@p ;
...
position p;
@@
 struct ad714x_slider_drv {  int highest_stage ;  int abs_pos ;  int flt_pos ;  enum ad714x_device_state state ;  struct input_dev * input ; } cocci_id@p ;
...
position p;
@@
 struct ad714x_button_drv * cocci_id@p ;
...
position p;
@@
 struct ad714x_wheel_drv {  int abs_pos ;  int flt_pos ;  int pre_highest_stage ;  int highest_stage ;  enum ad714x_device_state state ;  struct input_dev * input ; } cocci_id@p ;
...
position p;
@@
 struct ad714x_button_plat * cocci_id@p ;
...
position p;
@@
 struct ad714x_platform_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ad714x_read_t;
@@
 ad714x_read_t cocci_id@p ;
...
position p;
@@
 struct ad714x_touchpad_plat * cocci_id@p ;
...
position p;
@@
 struct ad714x_driver_data {  struct ad714x_slider_drv * slider ;  struct ad714x_wheel_drv * wheel ;  struct ad714x_touchpad_drv * touchpad ;  struct ad714x_button_drv * button ; } cocci_id@p ;
...
position p;
@@
 struct ad714x_touchpad_drv * cocci_id@p ;
...
position p;
@@
 struct ad714x_button_drv {  enum ad714x_device_state state ;  struct input_dev * input ; } cocci_id@p ;
...
position p;
@@
 struct ad714x_wheel_drv * cocci_id@p ;
...
position p;
@@
 enum ad714x_device_state { IDLE , JITTER , ACTIVE , SPACE , } cocci_id@p ;
...
position p;
@@
 struct ad714x_slider_drv * cocci_id@p ;
