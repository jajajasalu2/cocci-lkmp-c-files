...
position p;
@@
 struct smb_to_posix_error cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u16,__u32,__u8;
@@
 const struct {  __u8 dos_class ;  __u16 dos_code ;  __u32 ntstatus ; } cocci_id@p [ ] ;
...
position p;
@@
 const unsigned short int cocci_id@p ;
...
typedef __u16;
@@
 struct smb_to_posix_error {  __u16 smb_err ;  int posix_code ; } cocci_id@p ;
...
position p;
@@
 const struct smb_to_posix_error cocci_id@p [ ] ;
