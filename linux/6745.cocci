...
typedef scsi_info_t;
@@
 struct scsi_info_t {  struct pcmcia_device * p_dev ;  struct Scsi_Host * host ;  unsigned short manf_id ; } cocci_id@p ;
...
position p;
@@
 enum Phase { idle , data_out , data_in , command_ph , status_ph , message_out , message_in , } cocci_id@p ;
...
position p;
@@
 struct sym53c500_data * cocci_id@p ;
...
position p;
@@
 struct sym53c500_data {  struct scsi_cmnd * current_SC ;  int fast_pio ; } cocci_id@p ;
