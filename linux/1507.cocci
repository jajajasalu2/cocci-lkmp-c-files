...
position p;
@@
 struct dwc2_gregs_backup * cocci_id@p ;
...
position p;
@@
 struct dwc2_hregs_backup * cocci_id@p ;
...
position p;
@@
 struct dwc2_core_params * cocci_id@p ;
...
position p;
@@
 struct dwc2_dma_desc cocci_id@p ;
...
position p;
@@
 struct dwc2_hcd_iso_packet_desc * cocci_id@p ;
...
position p;
@@
 struct wrapper_priv_data * cocci_id@p ;
...
position p;
@@
 struct dwc2_host_chan cocci_id@p ;
...
position p;
@@
 enum dwc2_transaction_type cocci_id@p ;
...
position p;
@@
 struct wrapper_priv_data {  struct dwc2_hsotg * hsotg ; } cocci_id@p ;
...
position p;
@@
 struct dwc2_hcd_urb * cocci_id@p ;
...
position p;
@@
 enum dwc2_halt_status cocci_id@p ;
...
position p;
@@
 struct dwc2_hw_params * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dwc2_hsotg * hsotg ) ;
