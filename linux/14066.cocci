...
position p;
@@
 struct rvin_parallel_entity cocci_id@p ;
...
position p;
@@
 const struct rvin_group_route cocci_id@p [ ] ;
...
position p;
@@
 const struct rvin_info cocci_id@p ;
