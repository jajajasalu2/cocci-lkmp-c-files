...
position p;
@@
 enum veml6030_chan { CH_ALS , CH_WHITE , } cocci_id@p ;
...
position p;
@@
 struct veml6030_data * cocci_id@p ;
...
position p;
@@
 struct veml6030_data {  struct i2c_client * client ;  struct regmap * regmap ;  int cur_resolution ;  int cur_gain ;  int cur_integration_time ; } cocci_id@p ;
