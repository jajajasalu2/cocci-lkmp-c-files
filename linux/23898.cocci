...
position p;
@@
 struct compat_cmsghdr cocci_id@p ;
...
position p;
@@
 struct compat_group_filter cocci_id@p ;
...
position p;
@@
 struct compat_msghdr cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sock * , int , int , char __user * , unsigned int ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sock * , int , int , char __user * , int __user * ) ;
...
position p;
@@
 struct old_timespec32 cocci_id@p [ 3 ] ;
