...
position p;
@@
 char cocci_id@p [ MAX_LINELENGTH ] ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * m , struct individual_sensor * s , const char * loc ) ;
...
position p;
@@
 struct rtas_sensors cocci_id@p ;
...
position p;
@@
 struct individual_sensor * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * m , struct individual_sensor * s , int state , int error , const char * loc ) ;
...
position p;
@@
 struct rtas_sensors {  struct individual_sensor sensor [ MAX_SENSORS ] ;  unsigned int quant ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * m , const char * c ) ;
...
position p;
@@
 struct individual_sensor {  unsigned int token ;  unsigned int quant ; } cocci_id@p ;
