...
position p;
@@
 int cocci_id@p ( struct idt77252_dev * , struct sk_buff * , int queue ) ;
...
position p;
@@
 int cocci_id@p ( struct atm_vcc * vcc , struct atm_qos * qos , int flags ) ;
...
position p;
@@
 struct idt77252_dev * * cocci_id@p ;
...
position p;
@@
 struct rate_estimator * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct idt77252_dev * , struct scq_info * ) ;
...
position p;
@@
 void cocci_id@p ( struct idt77252_dev * ) ;
...
position p;
@@
 void cocci_id@p ( struct idt77252_dev * , struct rx_pool * ) ;
...
position p;
@@
 int cocci_id@p ( struct atm_vcc * vcc , void * cell , int flags ) ;
...
position p;
@@
 int cocci_id@p ( struct idt77252_dev * ) ;
...
position p;
@@
 struct scq_info * cocci_id@p ( struct idt77252_dev * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct idt77252_dev * , int queue , unsigned int size , unsigned int count ) ;
...
position p;
@@
 struct idt77252_skb_prv cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct idt77252_dev * , struct scq_info * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct atm_dev * dev ) ;
...
position p;
@@
 void cocci_id@p ( struct idt77252_dev * , struct sk_buff * ) ;
...
position p;
@@
 unsigned long cocci_id@p ( struct idt77252_dev * , struct vc_map * ) ;
...
position p;
@@
 void cocci_id@p ( struct idt77252_dev * , struct vc_map * ) ;
...
position p;
@@
 int cocci_id@p ( struct idt77252_dev * , struct vc_map * , struct sk_buff * , int oam ) ;
