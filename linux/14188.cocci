...
position p;
@@
 struct cc_data {  void __iomem * base ;  struct resource * res ;  struct platform_device * pdev ; } cocci_id@p ;
...
position p;
@@
 struct cal_dmaqueue {  struct list_head active ;  int frame ;  int ini_jiffies ; } cocci_id@p ;
...
position p;
@@
 struct cal_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ;  const struct cal_fmt * fmt ; } cocci_id@p ;
...
position p;
@@
 struct cm_data {  void __iomem * base ;  struct resource * res ;  unsigned int camerrx_control ;  struct platform_device * pdev ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cal_ctx * ctx ) ;
...
position p;
@@
 const struct v4l2_fract cocci_id@p ;
...
typedef spinlock_t;
@@
 struct cal_ctx {  struct v4l2_device v4l2_dev ;  struct v4l2_ctrl_handler ctrl_handler ;  struct video_device vdev ;  struct v4l2_async_notifier notifier ;  struct v4l2_subdev * sensor ;  struct v4l2_fwnode_endpoint endpoint ;  struct v4l2_async_subdev asd ;  struct v4l2_fh fh ;  struct cal_dev * dev ;  struct cc_data * cc ;  struct mutex mutex ;  spinlock_t slock ;  unsigned long jiffies ;  struct cal_dmaqueue vidq ;  int input ;  const struct cal_fmt * fmt ;  struct v4l2_format v_fmt ;  struct v4l2_mbus_framefmt m_fmt ;  struct cal_fmt * active_fmt [ ARRAY_SIZE ( cal_formats ) ] ;  int num_active_fmt ;  struct v4l2_fract timeperframe ;  unsigned int sequence ;  unsigned int external_rate ;  struct vb2_queue vb_vidq ;  unsigned int seq_count ;  unsigned int csi2_port ;  unsigned int virtual_channel ;  struct cal_buffer * cur_frm ;  struct cal_buffer * next_frm ; } cocci_id@p ;
...
position p;
@@
 struct cal_dev {  int irq ;  void __iomem * base ;  struct resource * res ;  struct platform_device * pdev ;  struct v4l2_device v4l2_dev ;  struct cm_data * cm ;  struct cc_data * cc [ CAL_NUM_CSI2_PORTS ] ;  struct cal_ctx * ctx [ CAL_NUM_CONTEXT ] ; } cocci_id@p ;
...
position p;
@@
 struct v4l2_fwnode_bus_mipi_csi2 * cocci_id@p ;
...
position p;
@@
 const struct cal_fmt * cocci_id@p ;
...
position p;
@@
 struct cal_dmaqueue * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cal_fmt {  u32 fourcc ;  u32 code ;  u8 depth ; } cocci_id@p ;
