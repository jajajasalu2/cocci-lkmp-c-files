...
position p;
@@
 struct venc_vp8_vpu_buf * cocci_id@p ;
...
position p;
@@
 struct venc_vp8_vsi * cocci_id@p ;
...
typedef bool;
@@
 struct venc_vp8_inst {  void __iomem * hw_base ;  struct mtk_vcodec_mem work_bufs [ VENC_VP8_VPU_WORK_BUF_MAX ] ;  bool work_buf_allocated ;  unsigned int frm_cnt ;  unsigned int ts_mode ;  struct venc_vpu_inst vpu_inst ;  struct venc_vp8_vsi * vsi ;  struct mtk_vcodec_ctx * ctx ; } cocci_id@p ;
...
position p;
@@
 struct venc_vp8_vsi {  struct venc_vp8_vpu_config config ;  struct venc_vp8_vpu_buf work_bufs [ VENC_VP8_VPU_WORK_BUF_MAX ] ; } cocci_id@p ;
...
position p;
@@
 struct venc_vp8_inst * cocci_id@p ;
...
typedef u32;
@@
 struct venc_vp8_vpu_config {  u32 input_fourcc ;  u32 bitrate ;  u32 pic_w ;  u32 pic_h ;  u32 buf_w ;  u32 buf_h ;  u32 gop_size ;  u32 framerate ;  u32 ts_mode ; } cocci_id@p ;
...
typedef u32;
@@
 struct venc_vp8_vpu_buf {  u32 iova ;  u32 vpua ;  u32 size ; } cocci_id@p ;
