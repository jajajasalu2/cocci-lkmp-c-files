...
position p;
@@
 struct vc4_crtc_state cocci_id@p ;
...
position p;
@@
 struct vc4_plane_state * cocci_id@p ;
...
position p;
@@
 struct vc4_async_flip_state {  struct drm_crtc * crtc ;  struct drm_framebuffer * fb ;  struct drm_framebuffer * old_fb ;  struct drm_pending_vblank_event * event ;  struct vc4_seqno_cb cb ; } cocci_id@p ;
...
position p;
@@
 struct vc4_async_flip_state cocci_id@p ;
...
position p;
@@
 const struct vc4_crtc_data cocci_id@p ;
...
position p;
@@
 struct vc4_seqno_cb * cocci_id@p ;
...
position p;
@@
 const enum vc4_encoder_type * cocci_id@p ;
...
typedef bool;
@@
 struct vc4_crtc_state {  struct drm_crtc_state base ;  struct drm_mm_node mm ;  bool feed_txp ;  bool txp_armed ;  struct {  unsigned int left ;  unsigned int right ;  unsigned int top ;  unsigned int bottom ; } margins ; } cocci_id@p ;
