...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( rpcb_procedures3 ) ] ;
...
typedef u32;
@@
 struct rpcb_info {  u32 rpc_vers ;  const struct rpc_procinfo * rpc_proc ; } cocci_id@p ;
...
position p;
@@
 enum { RPCBPROC_NULL , RPCBPROC_SET , RPCBPROC_UNSET , RPCBPROC_GETPORT , RPCBPROC_GETADDR = 3 , RPCBPROC_DUMP , RPCBPROC_CALLIT , RPCBPROC_BCAST = 5 , RPCBPROC_GETTIME , RPCBPROC_UADDR2TADDR , RPCBPROC_TADDR2UADDR , RPCBPROC_GETVERSADDR , RPCBPROC_INDIRECT , RPCBPROC_GETADDRLIST , RPCBPROC_GETSTAT , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct rpc_task * , void * ) ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( rpcb_procedures2 ) ] ;
...
position p;
@@
 const struct rpcb_info cocci_id@p [ ] ;
...
position p;
@@
 struct rpcbind_args * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( rpcb_procedures4 ) ] ;
...
position p;
@@
 const struct rpcbind_args * cocci_id@p ;
...
position p;
@@
 const struct sockaddr_un cocci_id@p ;
...
typedef u32;
@@
 struct rpcbind_args {  struct rpc_xprt * r_xprt ;  u32 r_prog ;  u32 r_vers ;  u32 r_prot ;  unsigned short r_port ;  const char * r_netid ;  const char * r_addr ;  const char * r_owner ;  int r_status ; } cocci_id@p ;
