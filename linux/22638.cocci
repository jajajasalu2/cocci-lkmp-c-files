...
position p;
@@
 char cocci_id@p [ sizeof ( eqs_msq ) ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( route_msg ) ] ;
...
position p;
@@
 struct snd_us16x08_comp_store * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( mix_init_msg1 ) ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( mix_init_msg2 ) ] ;
...
position p;
@@
 const struct snd_us16x08_control_params cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( mix_msg_out ) ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( mix_msg_in ) ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( comp_msg ) ] ;
...
position p;
@@
 struct snd_us16x08_eq_store * cocci_id@p ;
...
position p;
@@
 struct snd_us16x08_meter_store * cocci_id@p ;
