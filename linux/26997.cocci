...
position p;
@@
 struct xlog_in_core cocci_id@p ;
...
position p;
@@
 const struct xfs_item_ops * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xlog * log , struct xlog_ticket * ticket ) ;
...
position p;
@@
 union xlog_in_core2 * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xlog * log ) ;
...
position p;
@@
 void cocci_id@p ( struct xlog * log , struct xlog_in_core * iclog , int eventual_size ) ;
...
symbol cocci_id;
position p;
typedef xlog_op_header_t;
@@
 xlog_op_header_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xlog * log , int len , struct xlog_in_core * * iclog , struct xlog_ticket * ticket , int * continued_write , int * logoffsetp ) ;
...
position p;
@@
 void cocci_id@p ( struct xlog * log , struct xlog_in_core * iclog ) ;
...
position p;
@@
 void cocci_id@p ( struct xlog * log , void * ptr ) ;
...
position p;
@@
 struct xlog_rec_ext_header cocci_id@p ;
...
position p;
@@
 struct xfs_unmount_log_format cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xlog_ticket_t;
@@
 xlog_ticket_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xlog * log ) ;
...
symbol cocci_id;
position p;
typedef xlog_in_core_t;
@@
 xlog_in_core_t * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct xlog_in_core * iclog , bool aborted ) ;
...
symbol cocci_id;
position p;
typedef xfs_km_flags_t;
@@
 xfs_km_flags_t cocci_id@p ;
...
position p;
@@
 struct xlog_grant_head * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xlog * log , struct xlog_in_core * iclog , int count ) ;
...
position p;
@@
 void cocci_id@p ( struct xlog * log , int need_bytes ) ;
