...
typedef u8;
@@
 const u8 cocci_id@p [ ICE40_SPI_NUM_ACTIVATION_BYTES ] ;
...
position p;
@@
 struct ice40_fpga_priv * cocci_id@p ;
...
position p;
@@
 struct ice40_fpga_priv {  struct spi_device * dev ;  struct gpio_desc * reset ;  struct gpio_desc * cdone ; } cocci_id@p ;
