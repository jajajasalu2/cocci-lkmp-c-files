...
typedef u32;
@@
 struct rk_timer {  void __iomem * base ;  void __iomem * ctrl ;  struct clk * clk ;  struct clk * pclk ;  u32 freq ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct rk_clkevt {  struct clock_event_device ce ;  struct rk_timer timer ; } cocci_id@p ;
