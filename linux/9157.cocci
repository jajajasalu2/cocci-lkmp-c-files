...
position p;
@@
 enum mlxsw_sp_dpipe_header_id { MLXSW_SP_DPIPE_HEADER_METADATA , } cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_dpipe_table_adj_action { MLXSW_SP_DPIPE_TABLE_ADJ_ACTION_DST_MAC , MLXSW_SP_DPIPE_TABLE_ADJ_ACTION_ERIF_PORT , MLXSW_SP_DPIPE_TABLE_ADJ_ACTION_COUNT , } cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_match cocci_id@p [ MLXSW_SP_DPIPE_TABLE_ADJ_MATCH_COUNT ] ;
...
position p;
@@
 struct devlink_dpipe_action cocci_id@p [ MLXSW_SP_DPIPE_TABLE_ADJ_ACTION_COUNT ] ;
...
position p;
@@
 enum mlxsw_sp_dpipe_table_adj_match { MLXSW_SP_DPIPE_TABLE_ADJ_MATCH_INDEX , MLXSW_SP_DPIPE_TABLE_ADJ_MATCH_SIZE , MLXSW_SP_DPIPE_TABLE_ADJ_MATCH_HASH_INDEX , MLXSW_SP_DPIPE_TABLE_ADJ_MATCH_COUNT , } cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_match cocci_id@p [ MLXSW_SP_DPIPE_TABLE_HOST_MATCH_COUNT ] ;
...
position p;
@@
 struct devlink_dpipe_value cocci_id@p [ MLXSW_SP_DPIPE_TABLE_ADJ_ACTION_COUNT ] ;
...
position p;
@@
 struct devlink_dpipe_value cocci_id@p [ MLXSW_SP_DPIPE_TABLE_ADJ_MATCH_COUNT ] ;
...
position p;
@@
 enum mlxsw_sp_dpipe_table_host_match { MLXSW_SP_DPIPE_TABLE_HOST_MATCH_RIF , MLXSW_SP_DPIPE_TABLE_HOST_MATCH_DIP , MLXSW_SP_DPIPE_TABLE_HOST_MATCH_COUNT , } cocci_id@p ;
...
position p;
@@
 struct devlink_dpipe_value cocci_id@p [ MLXSW_SP_DPIPE_TABLE_HOST_MATCH_COUNT ] ;
...
position p;
@@
 enum mlxsw_sp_field_metadata_id { MLXSW_SP_DPIPE_FIELD_METADATA_ERIF_PORT , MLXSW_SP_DPIPE_FIELD_METADATA_L3_FORWARD , MLXSW_SP_DPIPE_FIELD_METADATA_L3_DROP , MLXSW_SP_DPIPE_FIELD_METADATA_ADJ_INDEX , MLXSW_SP_DPIPE_FIELD_METADATA_ADJ_SIZE , MLXSW_SP_DPIPE_FIELD_METADATA_ADJ_HASH_INDEX , } cocci_id@p ;
