...
@@
 struct vhost_vsock {  struct vhost_dev dev ;  struct vhost_virtqueue vqs [ 2 ] ;  struct hlist_node hash ;  struct vhost_work send_pkt_work ;  spinlock_t send_pkt_list_lock ;  struct list_head send_pkt_list ;  atomic_t queued_replies ;  u32 guest_cid ; } cocci_id@p ;
...
position p;
@@
 enum { VHOST_VSOCK_FEATURES = VHOST_FEATURES , } cocci_id@p ;
