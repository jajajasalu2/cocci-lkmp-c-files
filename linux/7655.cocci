...
position p;
@@
 enum { ERASE , WERASE , KILL , } cocci_id@p ;
...
typedef bool;
@@
 struct n_tty_data {  size_t read_head ;  size_t commit_head ;  size_t canon_head ;  size_t echo_head ;  size_t echo_commit ;  size_t echo_mark ; 
	 DECLARE_BITMAP ( char_map , 256 ) 
		 ;  unsigned long overrun_time ;  int num_overrun ;  bool no_room ;  unsigned char lnext : 1 , erasing : 1 , raw : 1 , real_raw : 1 , icanon : 1 ;  unsigned char push : 1 ;  char read_buf [ N_TTY_BUF_SIZE ] ; 
	 DECLARE_BITMAP ( read_flags , N_TTY_BUF_SIZE ) 
		 ;  unsigned char echo_buf [ N_TTY_BUF_SIZE ] ;  size_t read_tail ;  size_t line_start ;  unsigned int column ;  unsigned int canon_column ;  size_t echo_tail ;  struct mutex atomic_read_lock ;  struct mutex output_lock ; } cocci_id@p ;
