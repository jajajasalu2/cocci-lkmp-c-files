...
position p;
@@
 struct hi6220_stub_clk cocci_id@p ;
...
typedef u32;
@@
 struct hi6220_stub_clk {  u32 id ;  struct device * dev ;  struct clk_hw hw ;  struct regmap * dfs_map ;  struct mbox_client cl ;  struct mbox_chan * mbox ; } cocci_id@p ;
...
position p;
@@
 union hi6220_mbox_data {  unsigned int data [ HI6220_MBOX_MSG_LEN ] ;  struct hi6220_mbox_msg msg ; } cocci_id@p ;
...
position p;
@@
 union hi6220_mbox_data cocci_id@p ;
...
position p;
@@
 struct hi6220_mbox_msg {  unsigned char type ;  unsigned char cmd ;  unsigned char obj ;  unsigned char src ;  unsigned char para [ 4 ] ; } cocci_id@p ;
