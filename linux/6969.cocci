...
position p;
@@
 struct arm_mhu {  void __iomem * base ;  struct mhu_link mlink [ MHU_CHANS ] ;  struct mbox_chan chan [ MHU_CHANS ] ;  struct mbox_controller mbox ; } cocci_id@p ;
...
position p;
@@
 struct mhu_link {  unsigned irq ;  void __iomem * tx_reg ;  void __iomem * rx_reg ; } cocci_id@p ;
