...
typedef bool;
@@
 struct dsps_glue {  struct device * dev ;  struct platform_device * musb ;  const struct dsps_musb_wrapper * wrp ;  int vbus_irq ;  unsigned long last_timer ;  bool sw_babble_enabled ;  void __iomem * usbss_base ;  struct dsps_context context ;  struct debugfs_regset32 regset ;  struct dentry * dbgfs_root ; } cocci_id@p ;
...
position p;
@@
 struct musb_hdrc_platform_data cocci_id@p ;
...
position p;
@@
 struct musb_platform_ops cocci_id@p ;
...
typedef u32,u16;
@@
 struct dsps_musb_wrapper {  u16 revision ;  u16 control ;  u16 status ;  u16 epintr_set ;  u16 epintr_clear ;  u16 epintr_status ;  u16 coreintr_set ;  u16 coreintr_clear ;  u16 coreintr_status ;  u16 phy_utmi ;  u16 mode ;  u16 tx_mode ;  u16 rx_mode ;  unsigned reset : 5 ;  unsigned usb_shift : 5 ;  u32 usb_mask ;  u32 usb_bitmap ;  unsigned drvvbus : 5 ;  unsigned txep_shift : 5 ;  u32 txep_mask ;  u32 txep_bitmap ;  unsigned rxep_shift : 5 ;  u32 rxep_mask ;  u32 rxep_bitmap ;  unsigned otg_disable : 5 ;  unsigned iddig : 5 ;  unsigned iddig_mux : 5 ;  unsigned poll_timeout ; } cocci_id@p ;
...
position p;
@@
 struct musb_hdrc_config * cocci_id@p ;
...
typedef u32;
@@
 struct dsps_context {  u32 control ;  u32 epintr ;  u32 coreintr ;  u32 phy_utmi ;  u32 mode ;  u32 tx_mode ;  u32 rx_mode ; } cocci_id@p ;
...
position p;
@@
 const struct dsps_musb_wrapper * cocci_id@p ;
...
position p;
@@
 struct dma_controller * cocci_id@p ;
