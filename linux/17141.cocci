...
position p;
@@
 struct ppc64_stub_entry * cocci_id@p ;
...
position p;
@@
 struct ppc64_opd_entry * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,func_desc_t;
@@
 struct ppc64_stub_entry {  u32 jump [ 7 ] ;  u32 magic ;  func_desc_t funcdata ; } cocci_id@p ;
