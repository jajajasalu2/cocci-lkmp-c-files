...
position p;
@@
 const struct nfp_devlink_versions {  enum nfp_nsp_versions id ;  const char * key ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct nfp_devlink_versions * cocci_id@p ;
...
position p;
@@
 const struct nfp_devlink_versions_simple * cocci_id@p ;
...
position p;
@@
 const struct nfp_devlink_versions_simple {  const char * key ;  const char * hwinfo ; } cocci_id@p [ ] ;
