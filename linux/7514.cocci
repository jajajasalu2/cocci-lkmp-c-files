...
position p;
@@
 struct viafb_shared cocci_id@p ;
...
position p;
@@
 struct viafb_ioctl_setting * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct viafb_ioctl_setting * setting_info ) ;
...
typedef u8,u32;
@@
 struct {  u8 data [ CURSOR_SIZE ] ;  u32 bak [ CURSOR_SIZE / 4 ] ; } * cocci_id@p ;
...
position p;
@@
 struct viafb_ioctl_info cocci_id@p ;
...
position p;
@@
 struct chip_information cocci_id@p ;
...
typedef device_t;
@@
 union {  struct viafb_ioctl_mode viamode ;  struct viafb_ioctl_samm viasamm ;  struct viafb_driver_version driver_version ;  struct fb_var_screeninfo sec_var ;  struct _panel_size_pos_info panel_pos_size_para ;  struct viafb_ioctl_setting viafb_setting ;  struct device_t active_dev ; } cocci_id@p ;
