...
position p;
@@
 const struct st_rproc_config cocci_id@p ;
...
position p;
@@
 struct st_rproc_config * cocci_id@p ;
...
typedef u32;
@@
 struct st_rproc {  struct st_rproc_config * config ;  struct reset_control * sw_reset ;  struct reset_control * pwr_reset ;  struct clk * clk ;  u32 clk_rate ;  struct regmap * boot_base ;  u32 boot_offset ;  struct mbox_chan * mbox_chan [ ST_RPROC_MAX_VRING * MBOX_MAX ] ;  struct mbox_client mbox_client_vq0 ;  struct mbox_client mbox_client_vq1 ; } cocci_id@p ;
...
typedef bool;
@@
 struct st_rproc_config {  bool sw_reset ;  bool pwr_reset ;  unsigned long bootaddr_mask ; } cocci_id@p ;
