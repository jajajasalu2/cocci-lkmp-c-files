...
typedef u32;
@@
 struct isst_if_device {  void __iomem * punit_mmio ;  u32 range_0 [ 5 ] ;  u32 range_1 [ 45 ] ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 struct isst_if_device * cocci_id@p ;
...
position p;
@@
 struct isst_mmio_range cocci_id@p [ ] ;
...
position p;
@@
 struct isst_if_io_reg * cocci_id@p ;
...
position p;
@@
 struct isst_mmio_range {  int beg ;  int end ; } cocci_id@p ;
