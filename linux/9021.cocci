...
position p;
@@
 struct mlx4_bitmap * cocci_id@p [ MLX4_QP_TABLE_ZONE_NUM ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ MLX4_QP_NUM_STATE ] [ MLX4_QP_NUM_STATE ] ;
...
position p;
@@
 int cocci_id@p [ MLX4_NUM_QP_REGION ] ;
...
position p;
@@
 enum mlx4_update_qp_attr cocci_id@p ;
...
position p;
@@
 struct mlx4_qp_table * cocci_id@p ;
