...
position p;
@@
 struct adin_clause45_mmd_map cocci_id@p [ ] ;
...
typedef u64;
@@
 struct adin_priv {  u64 stats [ ARRAY_SIZE ( adin_hw_stats ) ] ; } cocci_id@p ;
...
position p;
@@
 struct adin_cfg_reg_map {  int cfg ;  int reg ; } cocci_id@p ;
...
typedef u16;
@@
 struct adin_clause45_mmd_map {  int devad ;  u16 cl45_regnum ;  u16 adin_regnum ; } cocci_id@p ;
...
typedef u16;
@@
 struct adin_hw_stat {  const char * string ;  u16 reg1 ;  u16 reg2 ; } cocci_id@p ;
...
position p;
@@
 const struct adin_cfg_reg_map * cocci_id@p ;
...
position p;
@@
 struct adin_hw_stat * cocci_id@p ;
