...
typedef spinlock_t;
@@
 struct usnic_vnic {  struct vnic_dev * vdev ;  struct vnic_dev_bar bar [ PCI_NUM_RESOURCES ] ;  struct usnic_vnic_res_chunk chunks [ USNIC_VNIC_RES_TYPE_MAX ] ;  spinlock_t res_lock ; } cocci_id@p ;
...
position p;
@@
 const struct usnic_vnic_res_spec * cocci_id@p ;
