...
typedef u16;
@@
 u16 cocci_id@p ( unsigned int ioaddr , int index ) ;
...
position p;
@@
 enum c509status { IntLatch = 0x0001 , AdapterFailure = 0x0002 , TxComplete = 0x0004 , TxAvailable = 0x0008 , RxComplete = 0x0010 , RxEarly = 0x0020 , IntReq = 0x0040 , StatsFull = 0x0080 , CmdBusy = 0x1000 , } cocci_id@p ;
...
@@
 struct el3_private {  struct pcmcia_device * p_dev ;  struct timer_list media ;  u16 media_status ;  u16 fast_poll ;  unsigned long last_irq ;  spinlock_t lock ; } cocci_id@p ;
