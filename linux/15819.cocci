...
typedef u8;
@@
 int cocci_id@p ( struct net_device * pnetdev , u8 bnormal ) ;
...
position p;
@@
 struct sdio_drv_priv cocci_id@p ;
...
position p;
@@
 struct sdio_drv_priv {  struct sdio_driver r871xs_drv ;  int drv_registered ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sdio_func * func ) ;
...
position p;
@@
 int cocci_id@p ( struct sdio_func * func , const struct sdio_device_id * id ) ;
