...
symbol cocci_id;
position p;
typedef compat_siginfo_t;
@@
 struct rt_signal_frame_32 {  char dummy [ __SIGNAL_FRAMESIZE32 + 16 ] ;  compat_siginfo_t info ;  struct ucontext32 uc ;  int abigap [ 56 ] ; } cocci_id@p ;
...
position p;
@@
 struct signal_frame_32 cocci_id@p ;
...
position p;
@@
 struct signal_frame_64 cocci_id@p ;
...
position p;
@@
 struct signal_frame_32 {  char dummy [ __SIGNAL_FRAMESIZE32 ] ;  struct sigcontext32 sctx ;  struct mcontext32 mctx ;  int abigap [ 56 ] ; } cocci_id@p ;
...
position p;
@@
 struct signal_frame_64 {  char dummy [ __SIGNAL_FRAMESIZE ] ;  struct ucontext uc ;  unsigned long unused [ 2 ] ;  unsigned int tramp [ 6 ] ;  struct siginfo * pinfo ;  void * puc ;  struct siginfo info ;  char abigap [ 288 ] ; } cocci_id@p ;
...
position p;
@@
 struct rt_signal_frame_32 cocci_id@p ;
