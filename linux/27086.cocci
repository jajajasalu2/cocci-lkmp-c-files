...
position p;
@@
 struct xchk_bmap_check_rmap_info cocci_id@p ;
...
position p;
@@
 struct xchk_bmap_info cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,xfs_fileoff_t;
@@
 struct xchk_bmap_info {  struct xfs_scrub * sc ;  xfs_fileoff_t lastoff ;  bool is_rt ;  bool is_shared ;  bool was_loaded ;  int whichfork ; } cocci_id@p ;
...
position p;
@@
 struct xchk_bmap_check_rmap_info {  struct xfs_scrub * sc ;  int whichfork ;  struct xfs_iext_cursor icur ; } cocci_id@p ;
