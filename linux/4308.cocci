...
position p;
@@
 struct itco_wdt_platform_data cocci_id@p ;
...
position p;
@@
 struct intel_pmc_ipc_dev * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,spinlock_t,resource_size_t;
@@
 struct intel_pmc_ipc_dev {  struct device * dev ;  void __iomem * ipc_base ;  bool irq_mode ;  int irq ;  int cmd ;  struct completion cmd_complete ;  resource_size_t acpi_io_base ;  int acpi_io_size ;  struct platform_device * tco_dev ;  void __iomem * gcr_mem_base ;  bool has_gcr_regs ;  spinlock_t gcr_lock ;  struct platform_device * punit_dev ;  unsigned int punit_res_count ;  resource_size_t telem_pmc_ssram_base ;  resource_size_t telem_punit_ssram_base ;  int telem_pmc_ssram_size ;  int telem_punit_ssram_size ;  u8 telem_res_inval ;  struct platform_device * telemetry_dev ; } cocci_id@p ;
