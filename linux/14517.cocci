...
position p;
@@
 struct cs2000_priv {  struct clk_hw hw ;  struct i2c_client * client ;  struct clk * clk_in ;  struct clk * ref_clk ;  unsigned long saved_rate ;  unsigned long saved_parent_rate ; } cocci_id@p ;
