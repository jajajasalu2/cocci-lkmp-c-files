...
typedef u8;
@@
 u8 cocci_id@p [ DOC_LAYOUT_OOB_SIZE ] ;
...
position p;
@@
 struct device_attribute cocci_id@p [ DOC_MAX_NBFLOORS ] [ 4 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ DOC_ECC_BCH_SIZE ] ;
...
position p;
@@
 struct docg3_cascade * cocci_id@p ;
