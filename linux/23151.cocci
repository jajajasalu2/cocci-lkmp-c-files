...
position p;
@@
 struct axg_tdm_formatter * cocci_id@p ;
...
typedef bool;
@@
 struct axg_tdm_formatter {  struct list_head list ;  struct axg_tdm_stream * stream ;  const struct axg_tdm_formatter_driver * drv ;  struct clk * pclk ;  struct clk * sclk ;  struct clk * lrclk ;  struct clk * sclk_sel ;  struct clk * lrclk_sel ;  struct reset_control * reset ;  bool enabled ;  struct regmap * map ; } cocci_id@p ;
...
position p;
@@
 const struct axg_tdm_formatter_driver * cocci_id@p ;
...
position p;
@@
 struct axg_tdm_iface * cocci_id@p ;
...
position p;
@@
 struct axg_tdm_stream * cocci_id@p ;
