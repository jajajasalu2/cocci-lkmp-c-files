...
typedef u32,u16;
@@
 u16 cocci_id@p ( struct hpi_adapter_obj * pao , u32 * pos_error_code ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct hpi_adapter_obj * pao , int dsp_index ) ;
...
typedef u16;
@@
 u16 cocci_id@p [ HPI6205_MAX_FILES_TO_LOAD ] ;
...
typedef u32,u16;
@@
 u16 cocci_id@p ( struct hpi_adapter_obj * pao , int dsp_index , u32 address , u32 length ) ;
...
position p;
@@
 int cocci_id@p ( struct hpi_hw_obj * phw , int state , int timeout_us ) ;
...
position p;
@@
 struct bus_master_interface cocci_id@p ;
...
position p;
@@
 struct hpi_hostbuffer_status * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct hpi_adapter_obj * pao , int dsp_index , u32 address , u32 data ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct hpi_adapter_obj * pao , u32 message ) ;
...
position p;
@@
 void cocci_id@p ( struct hpi_hw_obj * phw , int cmd ) ;
...
typedef u16;
@@
 u16 cocci_id@p ( struct hpi_adapter_obj * pao , struct hpi_message * phm , struct hpi_response * phr ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct hpi_adapter_obj * pao , int dsp_index , u32 address ) ;
...
@@
 struct hpi_hw_obj { 
	 ...
	 __iomem 
		  u32 * prHDCR ; 
	 __iomem 
		  u32 * prDSPP ;  u32 dsp_page ;  struct consistent_dma_area h_locked_mem ;  struct bus_master_interface * p_interface_buffer ;  u16 flag_outstream_just_reset [ HPI_MAX_STREAMS ] ;  struct consistent_dma_area instream_host_buffers [ HPI_MAX_STREAMS ] ;  struct consistent_dma_area outstream_host_buffers [ HPI_MAX_STREAMS ] ;  u32 instream_host_buffer_size [ HPI_MAX_STREAMS ] ;  u32 outstream_host_buffer_size [ HPI_MAX_STREAMS ] ;  struct consistent_dma_area h_control_cache ;  struct hpi_control_cache * p_cache ; } cocci_id@p ;
