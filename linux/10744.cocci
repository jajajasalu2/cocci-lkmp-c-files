...
position p;
@@
 const struct intel_gt * cocci_id@p ;
...
position p;
@@
 const struct drm_i915_gem_context_param_sseu * cocci_id@p ;
...
position p;
@@
 const struct sseu_dev_info * cocci_id@p ;
...
position p;
@@
 struct i915_gem_contexts * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct i915_gem_context * dst , struct i915_gem_context * src ) ;
...
position p;
@@
 struct drm_i915_gem_context_destroy * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_context_param * cocci_id@p ;
...
position p;
@@
 struct create_ext {  struct i915_gem_context * ctx ;  struct drm_i915_file_private * fpriv ; } cocci_id@p ;
...
position p;
@@
 struct set_engines {  struct i915_gem_context * ctx ;  struct i915_gem_engines * engines ; } cocci_id@p ;
...
position p;
@@
 struct i915_global_gem_context cocci_id@p ;
...
position p;
@@
 const struct create_ext * cocci_id@p ;
...
position p;
@@
 struct drm_i915_file_private * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct i915_request * rq , void * data ) ;
...
position p;
@@
 struct i915_gem_engines * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_context_create_ext_setparam cocci_id@p ;
...
position p;
@@
 struct intel_engine_cs * cocci_id@p [ 16 ] ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct intel_context * ce , void * data ) ;
...
position p;
@@
 enum intel_engine_id cocci_id@p ;
...
position p;
@@
 struct context_barrier_task * cocci_id@p ;
...
position p;
@@
 struct i915_gem_engines_iter * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_context_param_sseu cocci_id@p ;
...
position p;
@@
 struct radix_tree_iter cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_context_create_ext * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct intel_context * ce , void * data ) ;
...
position p;
@@
 struct drm_i915_reset_stats * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_context_create_ext_clone cocci_id@p ;
...
position p;
@@
 struct context_barrier_task {  struct i915_active base ;  void ( * task ) ( void * data ) ;  void * data ; } cocci_id@p ;
...
position p;
@@
 const struct i915_gem_context * cocci_id@p ;
...
position p;
@@
 const i915_user_extension_fn cocci_id@p [ ] ;
...
position p;
@@
 const struct drm_i915_gem_context_param * cocci_id@p ;
...
position p;
@@
 struct i915_engine_class_instance cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_vm_control * cocci_id@p ;
...
position p;
@@
 const struct i915_gem_engines * cocci_id@p ;
...
position p;
@@
 struct i915_lut_handle * cocci_id@p ;
...
position p;
@@
 const struct set_engines * cocci_id@p ;
...
position p;
@@
 struct i915_global_gem_context {  struct i915_global base ;  struct kmem_cache * slab_luts ; } cocci_id@p ;
