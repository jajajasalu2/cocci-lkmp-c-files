...
position p;
@@
 enum master_or_slave cocci_id@p ;
...
position p;
@@
 enum master_or_slave { CHImaster , CHIslave , } cocci_id@p ;
...
typedef s32;
@@
 struct dbri_dma {  s32 cmd [ DBRI_NO_CMDS ] ;  volatile s32 intr [ DBRI_INT_BLK ] ;  struct dbri_mem desc [ DBRI_NO_DESCS ] ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned short freq ;  unsigned char xtal ;  unsigned char csval ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct snd_dbri * dbri ) ;
...
position p;
@@
 enum in_or_out { PIPEinput , PIPEoutput , } cocci_id@p ;
...
position p;
@@
 struct dbri_streaminfo * cocci_id@p ;
...
typedef __u32,__u8;
@@
 struct cs4215 {  __u8 data [ 4 ] ;  __u8 ctrl [ 4 ] ;  __u8 onboard ;  __u8 offset ;  volatile __u32 status ;  volatile __u32 version ;  __u8 precision ;  __u8 channels ; } cocci_id@p ;
...
typedef u32,__u32;
@@
 struct dbri_pipe {  u32 sdp ;  int nextpipe ;  int length ;  int first_desc ;  int desc ;  volatile __u32 * recv_fixed_ptr ; } cocci_id@p ;
...
typedef __u32;
@@
 struct dbri_mem {  volatile __u32 word1 ;  __u32 ba ;  __u32 nda ;  volatile __u32 word4 ; } cocci_id@p ;
...
typedef u32;
@@
 struct dbri_streaminfo {  struct snd_pcm_substream * substream ;  u32 dvma_buffer ;  int size ;  size_t offset ;  int pipe ;  int left_gain ;  int right_gain ; } cocci_id@p ;
