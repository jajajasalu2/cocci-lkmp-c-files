...
position p;
@@
 struct mantis_uart_params cocci_id@p ;
...
position p;
@@
 struct mantis_hwconfig * cocci_id@p ;
...
position p;
@@
 struct {  char string [ 7 ] ; } cocci_id@p [ 5 ] ;
...
position p;
@@
 struct {  char string [ 5 ] ; } cocci_id@p [ 3 ] ;
...
position p;
@@
 struct mantis_uart_params {  enum mantis_baud baud_rate ;  enum mantis_parity parity ; } cocci_id@p ;
