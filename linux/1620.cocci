...
position p;
@@
 const struct ci_hdrc_imx_platform_flag cocci_id@p ;
...
position p;
@@
 struct imx_usbmisc_data * cocci_id@p ;
...
position p;
@@
 struct ci_hdrc_imx_data * cocci_id@p ;
...
position p;
@@
 struct ci_hdrc_imx_platform_flag {  unsigned int flags ; } cocci_id@p ;
