...
position p;
@@
 struct da9062_thermal * cocci_id@p ;
...
position p;
@@
 struct da9062_thermal_config {  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct da9062_thermal {  struct da9062 * hw ;  struct delayed_work work ;  struct thermal_zone_device * zone ;  enum thermal_device_mode mode ;  struct mutex lock ;  int temperature ;  int irq ;  const struct da9062_thermal_config * config ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 const struct da9062_thermal_config cocci_id@p ;
