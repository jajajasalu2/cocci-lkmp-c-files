...
position p;
@@
 const struct brcms_c_rateset * cocci_id@p ;
...
position p;
@@
 struct brcms_bss_info * cocci_id@p ;
...
position p;
@@
 struct bcma_chipinfo * cocci_id@p ;
...
position p;
@@
 struct brcms_bss_cfg * cocci_id@p ;
...
position p;
@@
 struct brcms_c_info * cocci_id@p ;
...
position p;
@@
 struct shm_acparams cocci_id@p ;
...
position p;
@@
 struct shared_phy_params cocci_id@p ;
...
position p;
@@
 struct brcms_c_rateset cocci_id@p ;
...
position p;
@@
 struct brcm_rateset * cocci_id@p ;
...
typedef u8;
@@
 struct plcp_signal_rate_lookup {  u8 rate ;  u8 signal_rate ; } cocci_id@p ;
...
position p;
@@
 struct brcms_protection cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IEEE80211_MAX_SSID_LEN ] ;
...
position p;
@@
 struct ofdm_phy_hdr * cocci_id@p ;
...
typedef u32;
@@
 struct brcms_c_bit_desc {  u32 bit ;  const char * name ; } cocci_id@p ;
...
typedef __le32;
@@
 struct d11init {  __le16 addr ;  __le16 size ;  __le32 value ; } cocci_id@p ;
...
position p;
@@
 struct brcms_hardware cocci_id@p ;
...
position p;
@@
 const struct plcp_signal_rate_lookup cocci_id@p [ ] ;
...
position p;
@@
 const struct d11init * cocci_id@p ;
...
position p;
@@
 struct brcms_hw_band * cocci_id@p ;
...
position p;
@@
 struct txpwr_limits * cocci_id@p ;
...
position p;
@@
 const struct edcf_acparam * cocci_id@p ;
