...
typedef u16;
@@
 struct bcmgenet_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int stat_sizeof ;  int stat_offset ;  enum bcmgenet_stat_type type ;  u16 reg_offset ; } cocci_id@p ;
...
position p;
@@
 struct bcmgenet_hw_params cocci_id@p [ ] ;
...
position p;
@@
 struct bcmgenet_priv * cocci_id@p ;
...
position p;
@@
 struct bcmgenet_net_dim * cocci_id@p ;
...
position p;
@@
 struct bcmgenet_platform_data * cocci_id@p ;
...
position p;
@@
 struct bcmgenet_tx_ring cocci_id@p ;
...
typedef u32;
@@
 struct bcmgenet_plat_data {  enum bcmgenet_version version ;  u32 dma_max_burst_length ; } cocci_id@p ;
...
position p;
@@
 struct bcmgenet_rx_ring * cocci_id@p ;
...
position p;
@@
 const struct bcmgenet_stats * cocci_id@p ;
...
position p;
@@
 enum dma_ring_reg { TDMA_READ_PTR = 0 , RDMA_WRITE_PTR = TDMA_READ_PTR , TDMA_READ_PTR_HI , RDMA_WRITE_PTR_HI = TDMA_READ_PTR_HI , TDMA_CONS_INDEX , RDMA_PROD_INDEX = TDMA_CONS_INDEX , TDMA_PROD_INDEX , RDMA_CONS_INDEX = TDMA_PROD_INDEX , DMA_RING_BUF_SIZE , DMA_START_ADDR , DMA_START_ADDR_HI , DMA_END_ADDR , DMA_END_ADDR_HI , DMA_MBUF_DONE_THRESH , TDMA_FLOW_PERIOD , RDMA_XON_XOFF_THRESH = TDMA_FLOW_PERIOD , TDMA_WRITE_PTR , RDMA_READ_PTR = TDMA_WRITE_PTR , TDMA_WRITE_PTR_HI , RDMA_READ_PTR_HI = TDMA_WRITE_PTR_HI , } cocci_id@p ;
...
position p;
@@
 const struct bcmgenet_plat_data * cocci_id@p ;
...
position p;
@@
 enum bcmgenet_power_mode cocci_id@p ;
...
position p;
@@
 enum bcmgenet_stat_type { BCMGENET_STAT_NETDEV = - 1 , BCMGENET_STAT_MIB_RX , BCMGENET_STAT_MIB_TX , BCMGENET_STAT_RUNT , BCMGENET_STAT_MISC , BCMGENET_STAT_SOFT , } cocci_id@p ;
