...
@@
 struct aspeed_lpc_snoop_channel {  struct kfifo fifo ;  wait_queue_head_t wq ;  struct miscdevice miscdev ; } cocci_id@p ;
...
position p;
@@
 struct aspeed_lpc_snoop_model_data {  unsigned int has_hicrb_ensnp ; } cocci_id@p ;
...
position p;
@@
 const struct aspeed_lpc_snoop_model_data * cocci_id@p ;
...
position p;
@@
 struct aspeed_lpc_snoop_channel * cocci_id@p ;
...
position p;
@@
 struct aspeed_lpc_snoop * cocci_id@p ;
...
position p;
@@
 struct aspeed_lpc_snoop {  struct regmap * regmap ;  int irq ;  struct aspeed_lpc_snoop_channel chan [ NUM_SNOOP_CHANNELS ] ; } cocci_id@p ;
