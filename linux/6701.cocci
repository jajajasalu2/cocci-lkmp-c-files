...
symbol cocci_id;
position p;
typedef port_database_t;
@@
 port_database_t * cocci_id@p ;
...
position p;
@@
 struct tsk_mgmt_cmd * cocci_id@p ;
...
position p;
@@
 struct cs84xx_mgmt_cmd {  union {  struct verify_chip_entry_84xx req ;  struct verify_chip_rsp_84xx rsp ; } p ; } cocci_id@p ;
...
position p;
@@
 struct tsk_mgmt_cmd {  union {  struct tsk_mgmt_entry tsk ;  struct sts_entry_24xx sts ; } p ; } cocci_id@p ;
...
typedef uint16_t;
@@
 struct rom_cmd {  uint16_t cmd ; } cocci_id@p [ ] ;
...
typedef uint16_t;
@@
 struct mb_cmd_name {  uint16_t cmd ;  const char * str ; } cocci_id@p [ ] ;
...
position p;
@@
 struct cs84xx_mgmt_cmd * cocci_id@p ;
