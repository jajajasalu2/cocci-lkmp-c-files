...
position p;
@@
 struct pfn_array {  unsigned long pa_iova ;  unsigned long * pa_iova_pfn ;  unsigned long * pa_pfn ;  int pa_nr ; } cocci_id@p ;
...
typedef u64;
@@
 struct ccwchain {  struct list_head next ;  struct ccw1 * ch_ccw ;  u64 ch_iova ;  int ch_len ;  struct pfn_array * ch_pa ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ccwchain * chain , struct channel_program * cp ) ;
...
position p;
@@
 struct channel_program * cocci_id@p ;
