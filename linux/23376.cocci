...
typedef bool;
@@
 struct rt5665_priv {  struct snd_soc_component * component ;  struct rt5665_platform_data pdata ;  struct regmap * regmap ;  struct gpio_desc * gpiod_ldo1_en ;  struct gpio_desc * gpiod_reset ;  struct snd_soc_jack * hs_jack ;  struct regulator_bulk_data supplies [ RT5665_NUM_SUPPLIES ] ;  struct delayed_work jack_detect_work ;  struct delayed_work calibrate_work ;  struct delayed_work jd_check_work ;  struct mutex calibrate_mutex ;  int sysclk ;  int sysclk_src ;  int lrck [ RT5665_AIFS ] ;  int bclk [ RT5665_AIFS ] ;  int master [ RT5665_AIFS ] ;  int id ;  int pll_src ;  int pll_in ;  int pll_out ;  int jack_type ;  int irq_work_delay_time ;  unsigned int sar_adc_value ;  bool calibration_done ; } cocci_id@p ;
...
position p;
@@
 struct rt5665_platform_data * cocci_id@p ;
...
position p;
@@
 struct rl6231_pll_code cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ RT5665_NUM_SUPPLIES ] ;
