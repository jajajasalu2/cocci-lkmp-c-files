...
typedef spinlock_t;
@@
 struct bt3c_info {  struct pcmcia_device * p_dev ;  struct hci_dev * hdev ;  spinlock_t lock ;  struct sk_buff_head txq ;  unsigned long tx_state ;  unsigned long rx_state ;  unsigned long rx_count ;  struct sk_buff * rx_skb ; } cocci_id@p ;
