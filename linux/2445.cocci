...
position p;
@@
 struct ep93xx_dma_chan cocci_id@p ;
...
position p;
@@
 struct ep93xx_dma_data * cocci_id@p ;
...
position p;
@@
 const struct ep93xx_dma_chan_data * cocci_id@p ;
...
position p;
@@
 const struct ep93xx_dma_data * cocci_id@p ;
...
position p;
@@
 struct ep93xx_dma_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dma_chan * chan , enum dma_transfer_direction dir , struct dma_slave_config * config ) ;
...
position p;
@@
 struct ep93xx_dma_engine cocci_id@p ;
...
typedef bool,u32;
@@
 struct ep93xx_dma_desc {  u32 src_addr ;  u32 dst_addr ;  size_t size ;  bool complete ;  struct dma_async_tx_descriptor txd ;  struct list_head tx_list ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 struct ep93xx_dma_platform_data * cocci_id@p ;
