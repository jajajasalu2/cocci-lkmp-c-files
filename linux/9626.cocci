...
position p;
@@
 const char * constcocci_id [ MAX_FW_IMAGES ] ;
...
position p;
@@
 struct firmware_hdr * cocci_id@p ;
...
position p;
@@
 struct brcms_firmware cocci_id@p ;
...
typedef __le32;
@@
 struct firmware_hdr {  __le32 offset ;  __le32 len ;  __le32 idx ; } cocci_id@p ;
...
position p;
@@
 struct bcma_device_id cocci_id@p [ ] ;
