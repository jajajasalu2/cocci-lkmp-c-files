...
typedef uint32_t;
@@
 struct {  uint32_t header ;  SVGAFifoCmdUpdate body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_legacy_display_unit cocci_id@p ;
...
position p;
@@
 struct vmw_legacy_display_unit {  struct vmw_display_unit base ;  struct list_head active ; } cocci_id@p ;
...
position p;
@@
 struct vmw_legacy_display {  struct list_head active ;  unsigned num_active ;  unsigned last_num_active ;  struct vmw_framebuffer * fb ; } cocci_id@p ;
...
position p;
@@
 struct vmw_legacy_display * cocci_id@p ;
