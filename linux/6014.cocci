...
position p;
@@
 struct as3722_pctrl_info * cocci_id@p ;
...
position p;
@@
 struct as3722_pctrl_info {  struct device * dev ;  struct pinctrl_dev * pctl ;  struct as3722 * as3722 ;  struct gpio_chip gpio_chip ;  int pins_current_opt [ AS3722_PIN_NUM ] ;  const struct as3722_pin_function * functions ;  unsigned num_functions ;  const struct as3722_pingroup * pin_groups ;  int num_pin_groups ;  const struct pinctrl_pin_desc * pins ;  unsigned num_pins ;  struct as3722_gpio_pin_control gpio_control [ AS3722_PIN_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct as3722_gpio_pin_control {  unsigned mode_prop ;  int io_function ; } cocci_id@p ;
...
position p;
@@
 const struct as3722_pin_function cocci_id@p [ ] ;
...
position p;
@@
 struct as3722_pin_function {  const char * name ;  const char * const * groups ;  unsigned ngroups ;  int mux_option ; } cocci_id@p ;
...
position p;
@@
 const struct as3722_pingroup cocci_id@p [ ] ;
...
position p;
@@
 struct as3722_pingroup {  const char * name ;  const unsigned pins [ 1 ] ;  unsigned npins ; } cocci_id@p ;
