...
position p;
@@
 struct iwl_calib_result {  struct list_head list ;  size_t cmd_len ;  struct iwl_calib_hdr hdr ; } cocci_id@p ;
...
position p;
@@
 struct statistics_general_data * cocci_id@p ;
...
position p;
@@
 const struct iwl_calib_hdr * cocci_id@p ;
...
position p;
@@
 struct iwl_calib_result * cocci_id@p ;
...
typedef u32;
@@
 struct statistics_general_data {  u32 beacon_silence_rssi_a ;  u32 beacon_silence_rssi_b ;  u32 beacon_silence_rssi_c ;  u32 beacon_energy_a ;  u32 beacon_energy_b ;  u32 beacon_energy_c ; } cocci_id@p ;
...
position p;
@@
 struct iwl_enhance_sensitivity_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_chain_noise_data * cocci_id@p ;
...
position p;
@@
 struct iwl_calib_hdr cocci_id@p ;
...
position p;
@@
 struct iwl_sensitivity_data * cocci_id@p ;
...
position p;
@@
 struct iwl_calib_chain_noise_gain_cmd cocci_id@p ;
...
position p;
@@
 const struct iwl_sensitivity_ranges * cocci_id@p ;
...
position p;
@@
 struct iwl_sensitivity_cmd cocci_id@p ;
