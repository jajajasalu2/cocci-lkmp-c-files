...
position p;
@@
 union ibmveth_buf_desc * cocci_id@p ;
...
position p;
@@
 struct ibmveth_stat {  char name [ ETH_GSTRING_LEN ] ;  int offset ; } cocci_id@p ;
...
position p;
@@
 union ibmveth_buf_desc cocci_id@p [ 6 ] ;
...
position p;
@@
 struct ibmveth_adapter cocci_id@p ;
...
position p;
@@
 struct ibmveth_buff_pool cocci_id@p ;
...
position p;
@@
 struct ibmveth_stat cocci_id@p [ ] ;
...
position p;
@@
 struct ibmveth_rx_q_entry cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ibmveth_adapter * adapter ) ;
...
position p;
@@
 unsigned long cocci_id@p ( struct vio_dev * vdev ) ;
