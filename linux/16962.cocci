...
typedef bool;
@@
 struct ts4800_ts {  struct input_dev * input ;  struct device * dev ;  char phys [ 32 ] ;  void __iomem * base ;  struct regmap * regmap ;  unsigned int reg ;  unsigned int bit ;  bool pendown ;  int debounce ; } cocci_id@p ;
