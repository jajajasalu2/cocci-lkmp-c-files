...
position p;
@@
 struct nf_conncount_rb * cocci_id@p [ CONNCOUNT_GC_MAX_NODES ] ;
...
typedef u32;
@@
 struct nf_conncount_rb {  struct rb_node node ;  struct nf_conncount_list list ;  u32 key [ MAX_KEYLEN ] ;  struct rcu_head rcu_head ; } cocci_id@p ;
...
typedef u32;
@@
 struct nf_conncount_tuple {  struct list_head node ;  struct nf_conntrack_tuple tuple ;  struct nf_conntrack_zone zone ;  int cpu ;  u32 jiffies32 ; } cocci_id@p ;
...
position p;
@@
 struct nf_conncount_rb * cocci_id@p [ ] ;
...
position p;
@@
 struct nf_conncount_list * cocci_id@p ;
...
position p;
@@
 struct nf_conncount_tuple cocci_id@p ;
...
position p;
@@
 struct nf_conncount_data {  unsigned int keylen ;  struct rb_root root [ CONNCOUNT_SLOTS ] ;  struct net * net ;  struct work_struct gc_work ;  unsigned long pending_trees [ BITS_TO_LONGS ( CONNCOUNT_SLOTS ) ] ;  unsigned int gc_tree ; } cocci_id@p ;
