...
position p;
@@
 enum rcar_du_output cocci_id@p ;
...
position p;
@@
 struct {  struct device_node * np ;  unsigned int crtcs_mask ; } cocci_id@p [ RCAR_DU_MAX_VSPS ] ;
...
position p;
@@
 const struct rcar_du_output_routing * cocci_id@p ;
