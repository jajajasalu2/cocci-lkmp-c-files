...
position p;
@@
 int ( * cocci_id@p ) ( struct mlx5_flow_root_namespace * ns , struct mlx5_flow_table * ft , struct mlx5_flow_group * fg , struct fs_fte * fte ) ;
...
position p;
@@
 const struct mlx5_accel_esp_xfrm_attrs * cocci_id@p ;
...
position p;
@@
 const struct mlx5_flow_cmds * cocci_id@p ;
...
position p;
@@
 struct mlx5_accel_esp_xfrm * cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_ipsec_cmd_context cocci_id@p ;
...
position p;
@@
 struct mlx5_ifc_fpga_ipsec_cmd_cap cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct mlx5_flow_root_namespace * ns , struct mlx5_flow_table * ft , struct mlx5_flow_group * fg , int modify_mask , struct fs_fte * fte ) ;
...
position p;
@@
 struct mlx5_ifc_fpga_ipsec_sa * cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_ipsec_sa_ctx * cocci_id@p ;
...
position p;
@@
 enum mlx5_fpga_ipsec_cmd_status { MLX5_FPGA_IPSEC_CMD_PENDING , MLX5_FPGA_IPSEC_CMD_SEND_FAIL , MLX5_FPGA_IPSEC_CMD_COMPLETE , } cocci_id@p ;
...
@@
 struct mailbox_mod {  uintptr_t saved_esp_id ;  u32 saved_action ;  u32 saved_outer_esp_spi_value ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_dma_buf * cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_ipsec_sa_ctx {  struct rhash_head hash ;  struct mlx5_ifc_fpga_ipsec_sa hw_sa ;  struct mlx5_core_dev * dev ;  struct mlx5_fpga_esp_xfrm * fpga_xfrm ; } cocci_id@p ;
...
position p;
@@
 const struct aes_gcm_keymat * cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_ipsec_rule * cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_conn_attr cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct mlx5_flow_root_namespace * ns , struct mlx5_flow_table * ft , u32 * in , struct mlx5_flow_group * fg ) ;
...
@@
 struct mlx5_fpga_ipsec {  struct mlx5_fpga_device * fdev ;  struct list_head pending_cmds ;  spinlock_t pending_cmds_lock ;  u32 caps [ MLX5_ST_SZ_DW ( ipsec_extended_cap ) ] ;  struct mlx5_fpga_conn * conn ;  struct notifier_block fs_notifier_ingress_bypass ;  struct notifier_block fs_notifier_egress ;  struct rhashtable sa_hash ;  struct mutex sa_hash_lock ;  struct rb_root rules_rb ;  struct mutex rules_rb_lock ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_device * cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_ipsec * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct mlx5_flow_root_namespace * ns , struct mlx5_flow_table * ft , struct fs_fte * fte ) ;
...
position p;
@@
 struct mlx5_ifc_fpga_ipsec_cmd_resp * cocci_id@p ;
...
position p;
@@
 struct mlx5_ifc_fpga_ipsec_sa_v1 cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_conn * cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_esp_xfrm {  unsigned int num_rules ;  struct mlx5_fpga_ipsec_sa_ctx * sa_ctx ;  struct mutex lock ;  struct mlx5_accel_esp_xfrm accel_xfrm ; } cocci_id@p ;
...
position p;
@@
 enum fs_flow_table_type cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_esp_xfrm * cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_group * cocci_id@p ;
...
position p;
@@
 enum mlx5_ifc_fpga_ipsec_response_syndrome cocci_id@p ;
...
position p;
@@
 struct mlx5_fpga_ipsec_rule {  struct rb_node node ;  struct fs_fte * fte ;  struct mlx5_fpga_ipsec_sa_ctx * ctx ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_root_namespace * cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_cmds cocci_id@p ;
...
typedef u8;
@@
 struct mlx5_fpga_ipsec_cmd_context {  struct mlx5_fpga_dma_buf buf ;  enum mlx5_fpga_ipsec_cmd_status status ;  struct mlx5_ifc_fpga_ipsec_cmd_resp resp ;  int status_code ;  struct completion complete ;  struct mlx5_fpga_device * dev ;  struct list_head list ;  u8 command [ 0 ] ; } cocci_id@p ;
