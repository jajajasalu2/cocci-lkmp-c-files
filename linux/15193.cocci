...
position p;
@@
 struct mc13xxx_leds * cocci_id@p ;
...
position p;
@@
 struct mc13xxx_led {  struct led_classdev cdev ;  int id ;  struct mc13xxx_leds * leds ; } cocci_id@p ;
...
position p;
@@
 struct mc13xxx_leds {  struct mc13xxx * master ;  struct mc13xxx_led_devtype * devtype ;  int num_leds ;  struct mc13xxx_led * led ; } cocci_id@p ;
...
typedef u32;
@@
 struct mc13xxx_led_devtype {  int led_min ;  int led_max ;  int num_regs ;  u32 ledctrl_base ; } cocci_id@p ;
...
position p;
@@
 const struct mc13xxx_led_devtype cocci_id@p ;
...
position p;
@@
 struct mc13xxx_led_devtype * cocci_id@p ;
