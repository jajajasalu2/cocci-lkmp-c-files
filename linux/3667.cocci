...
position p;
@@
 struct qcom_scm_entry cocci_id@p [ ] ;
...
typedef __le32;
@@
 struct {  __le32 proc ;  __le32 addr ;  __le32 len ; } cocci_id@p ;
...
position p;
@@
 struct qcom_scm_response * cocci_id@p ;
...
position p;
@@
 struct qcom_scm_hdcp_req * cocci_id@p ;
...
position p;
@@
 const struct qcom_scm_command * cocci_id@p ;
...
typedef __le32;
@@
 struct msm_scm_sec_cfg {  __le32 id ;  __le32 ctx_bank_num ; } cocci_id@p ;
...
typedef __le32;
@@
 struct {  __le32 proc ;  __le32 image_addr ; } cocci_id@p ;
...
typedef __le32;
@@
 struct qcom_scm_response {  __le32 len ;  __le32 buf_offset ;  __le32 is_complete ; } cocci_id@p ;
...
typedef __le32;
@@
 struct qcom_scm_command {  __le32 len ;  __le32 buf_offset ;  __le32 resp_hdr_offset ;  __le32 id ;  __le32 buf [ 0 ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct {  __le32 flags ;  __le32 addr ; } cocci_id@p ;
...
position p;
@@
 struct qcom_scm_entry {  int flag ;  void * entry ; } cocci_id@p ;
...
position p;
@@
 const struct qcom_scm_response * cocci_id@p ;
...
typedef __le32;
@@
 struct ocmem_tz_lock {  __le32 id ;  __le32 offset ;  __le32 size ;  __le32 mode ; } cocci_id@p ;
...
typedef __le32;
@@
 struct ocmem_tz_unlock {  __le32 id ;  __le32 offset ;  __le32 size ; } cocci_id@p ;
...
position p;
@@
 struct qcom_scm_command * cocci_id@p ;
...
typedef __le32;
@@
 struct {  __le32 state ;  __le32 id ; } cocci_id@p ;
