...
position p;
@@
 enum ican3_fwtype { ICAN3_FWTYPE_ICANOS , ICAN3_FWTYPE_CAL_CANOPEN , } cocci_id@p ;
...
typedef u8;
@@
 struct ican3_dpm_control {  u8 window_address ;  u8 unused1 ;  u8 interrupt ;  u8 unused2 ;  u8 hwreset ;  u8 unused3 ;  u8 tpuinterrupt ; } cocci_id@p ;
...
position p;
@@
 struct janz_platform_data * cocci_id@p ;
...
@@
 struct ican3_dev {  struct can_priv can ;  struct net_device * ndev ;  struct napi_struct napi ;  unsigned int num ;  struct janz_cmodio_onboard_regs __iomem * ctrl ;  struct ican3_dpm_control __iomem * dpmctrl ;  void __iomem * dpm ;  int irq ;  struct completion termination_comp ;  bool termination_enabled ;  struct completion buserror_comp ;  struct can_berr_counter bec ;  enum ican3_fwtype fwtype ;  char fwinfo [ 32 ] ;  unsigned int iftype ;  struct sk_buff_head echoq ;  spinlock_t lock ;  unsigned int rx_int ;  unsigned int rx_num ;  unsigned int tx_num ;  unsigned int fastrx_start ;  unsigned int fastrx_num ;  unsigned int fasttx_start ;  unsigned int fasttx_num ;  unsigned int free_page ; } cocci_id@p ;
...
position p;
@@
 struct ican3_fast_desc cocci_id@p ;
...
typedef u8;
@@
 struct ican3_msg {  u8 control ;  u8 spec ;  __le16 len ;  u8 data [ 252 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct ican3_new_desc {  u8 control ;  u8 pointer ; } cocci_id@p ;
...
typedef u8;
@@
 struct ican3_fast_desc {  u8 control ;  u8 command ;  u8 data [ 14 ] ; } cocci_id@p ;
...
position p;
@@
 struct ican3_new_desc cocci_id@p ;
