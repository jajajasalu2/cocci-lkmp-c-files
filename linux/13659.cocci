...
position p;
@@
 const struct {  unsigned short cv1 ;  unsigned short cv2 ;  unsigned short cv3 ; } cocci_id@p [ 7 ] ;
...
position p;
@@
 const struct {  unsigned short sv1 ;  unsigned short sv2 ;  unsigned short sv3 ;  unsigned short sv4 ; } cocci_id@p [ 7 ] ;
