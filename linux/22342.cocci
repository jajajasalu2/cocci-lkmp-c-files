...
position p;
@@
 enum data_formats { DATA_FMT_DIGEST = 0 , DATA_FMT_DIGEST_WITH_ALGO , DATA_FMT_STRING , DATA_FMT_HEX , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CRYPTO_MAX_ALG_NAME + 2 + IMA_MAX_DIGEST_SIZE ] ;
