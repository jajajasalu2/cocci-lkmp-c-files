...
@@
 struct odroid_priv {  struct snd_soc_card card ;  struct clk * clk_i2s_bus ;  struct clk * sclk_i2s ;  spinlock_t lock ;  unsigned int be_sample_rate ;  bool be_active ; } cocci_id@p ;
