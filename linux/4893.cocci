...
position p;
@@
 enum mlx5_ib_uapi_flow_action_packet_reformat_type cocci_id@p ;
...
position p;
@@
 enum mlx5_ib_uapi_flow_table_type cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_match_params cocci_id@p ;
