...
position p;
@@
 union cvm_usbdrd_uctl_ctl cocci_id@p ;
...
position p;
@@
 union cvm_usbdrd_uctl_host_cfg cocci_id@p ;
...
position p;
@@
 union cvm_usbdrd_uctl_shim_cfg cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ OCTEON_H_CLKDIV_SEL ] ;
