...
position p;
@@
 struct alx_tx_queue * cocci_id@p ;
...
position p;
@@
 struct alx_rx_queue * cocci_id@p ;
...
position p;
@@
 struct alx_hw_stats * cocci_id@p ;
...
position p;
@@
 const struct alx_tx_queue * cocci_id@p ;
