...
typedef u16;
@@
 struct ehrpwm_context {  u16 tbctl ;  u16 tbprd ;  u16 cmpa ;  u16 cmpb ;  u16 aqctla ;  u16 aqctlb ;  u16 aqsfrc ;  u16 aqcsfrc ; } cocci_id@p ;
...
position p;
@@
 struct ehrpwm_pwm_chip cocci_id@p ;
...
position p;
@@
 struct ehrpwm_pwm_chip {  struct pwm_chip chip ;  unsigned long clk_rate ;  void __iomem * mmio_base ;  unsigned long period_cycles [ NUM_PWM_CHANNEL ] ;  enum pwm_polarity polarity [ NUM_PWM_CHANNEL ] ;  struct clk * tbclk ;  struct ehrpwm_context ctx ; } cocci_id@p ;
