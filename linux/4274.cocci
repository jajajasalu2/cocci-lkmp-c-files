...
position p;
@@
 struct asus_wmi_debugfs_node {  struct asus_wmi * asus ;  char * name ;  int ( * show ) ( struct seq_file * m , void * data ) ; } cocci_id@p ;
...
position p;
@@
 struct asus_wmi_driver cocci_id@p ;
...
typedef u32;
@@
 struct asus_wmi_debug {  struct dentry * root ;  u32 method_id ;  u32 dev_id ;  u32 ctrl_param ; } cocci_id@p ;
...
position p;
@@
 struct agfn_fan_args cocci_id@p ;
...
typedef u32;
@@
 struct asus_rfkill {  struct asus_wmi * asus ;  struct rfkill * rfkill ;  u32 dev_id ; } cocci_id@p ;
...
position p;
@@
 struct asus_wmi_debugfs_node cocci_id@p [ ] ;
...
position p;
@@
 enum fan_type { FAN_TYPE_NONE = 0 , FAN_TYPE_AGFN , FAN_TYPE_SPEC83 , } cocci_id@p ;
...
position p;
@@
 const struct acpi_buffer cocci_id@p ;
