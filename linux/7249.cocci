...
position p;
@@
 struct rsi_hci_adapter * cocci_id@p ;
...
position p;
@@
 const struct rsi_mod_ops cocci_id@p ;
...
position p;
@@
 struct rsi_proto_ops * cocci_id@p ;
...
position p;
@@
 struct rsi_hci_adapter {  void * priv ;  struct rsi_proto_ops * proto_ops ;  struct hci_dev * hdev ; } cocci_id@p ;
