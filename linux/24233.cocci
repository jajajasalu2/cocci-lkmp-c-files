...
position p;
@@
 struct ifaddrlblmsg cocci_id@p ;
...
position p;
@@
 struct ip6addrlbl_entry * cocci_id@p ;
...
@@
 const 
 __net_initconst 
 struct ip6addrlbl_init_table {  const struct in6_addr * prefix ;  int prefixlen ;  u32 label ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IFAL_MAX + 1 ] ;
...
position p;
@@
 const struct ip6addrlbl_entry * cocci_id@p ;
...
typedef u32;
@@
 struct ip6addrlbl_entry {  struct in6_addr prefix ;  int prefixlen ;  int ifindex ;  int addrtype ;  u32 label ;  struct hlist_node list ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFAL_MAX + 1 ] ;
