...
position p;
@@
 struct lpddr2_min_tck * cocci_id@p ;
...
position p;
@@
 struct lpddr3_timings * cocci_id@p ;
...
position p;
@@
 const struct lpddr3_timings * cocci_id@p ;
...
position p;
@@
 const struct lpddr3_min_tck * cocci_id@p ;
...
position p;
@@
 struct lpddr3_min_tck * cocci_id@p ;
