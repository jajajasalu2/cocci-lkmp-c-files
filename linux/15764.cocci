...
position p;
@@
 struct wilc_cfg_cmd_hdr cocci_id@p ;
...
position p;
@@
 struct wilc_cfg_frame * cocci_id@p ;
...
position p;
@@
 struct wilc_cfg_rsp cocci_id@p ;
...
position p;
@@
 struct tcp_ack_filter * cocci_id@p ;
