...
position p;
@@
 int cocci_id@p ( struct cardstate * ) ;
...
symbol cocci_id;
position p;
typedef isow_urbctx_t;
@@
 struct isow_urbctx_t * cocci_id@p ;
...
position p;
@@
 const struct gigaset_ops cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct bc_state * , int , int , int ) ;
...
position p;
@@
 int cocci_id@p ( struct cardstate * , int ) ;
...
position p;
@@
 int cocci_id@p ( struct cardstate * , unsigned char * , int ) ;
...
position p;
@@
 struct bas_cardstate cocci_id@p ;
...
position p;
@@
 struct gigaset_driver * cocci_id@p ;
...
@@
 struct bas_cardstate {  struct usb_device * udev ;  struct cardstate * cs ;  struct usb_interface * interface ;  unsigned char minor ;  struct urb * urb_ctrl ;  struct usb_ctrlrequest dr_ctrl ;  struct timer_list timer_ctrl ;  int retry_ctrl ;  struct timer_list timer_atrdy ;  struct urb * urb_cmd_out ;  struct usb_ctrlrequest dr_cmd_out ;  int retry_cmd_out ;  struct urb * urb_cmd_in ;  struct usb_ctrlrequest dr_cmd_in ;  struct timer_list timer_cmd_in ;  unsigned char * rcvbuf ;  struct urb * urb_int_in ;  unsigned char * int_in_buf ;  struct work_struct int_in_wq ;  struct timer_list timer_int_in ;  int retry_int_in ;  spinlock_t lock ;  int basstate ;  int pending ;  wait_queue_head_t waitqueue ;  int rcvbuf_size ;  int retry_cmd_in ; } cocci_id@p ;
...
position p;
@@
 struct bas_bc_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bas_bc_state * ) ;
