...
position p;
@@
 struct pci9118_boardinfo {  const char * name ;  unsigned int ai_is_16bit : 1 ;  unsigned int is_hg : 1 ; } cocci_id@p ;
...
position p;
@@
 struct pci9118_private {  unsigned long iobase_a ;  unsigned int master : 1 ;  unsigned int dma_doublebuf : 1 ;  unsigned int ai_neverending : 1 ;  unsigned int usedma : 1 ;  unsigned int usemux : 1 ;  unsigned char ai_ctrl ;  unsigned char int_ctrl ;  unsigned char ai_cfg ;  unsigned int ai_do ;  unsigned int ai_n_realscanlen ;  unsigned int ai_act_dmapos ;  unsigned int ai_add_front ;  unsigned int ai_add_back ;  unsigned int ai_flags ;  char ai12_startstop ;  unsigned int dma_actbuf ;  struct pci9118_dmabuf dmabuf [ 2 ] ;  int softsshdelay ;  unsigned char softsshsample ;  unsigned char softsshhold ;  unsigned int ai_ns_min ; } cocci_id@p ;
...
position p;
@@
 struct pci9118_dmabuf * cocci_id@p ;
...
position p;
@@
 struct pci9118_boardinfo cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct pci9118_dmabuf {  unsigned short * virt ;  dma_addr_t hw ;  unsigned int size ;  unsigned int use_size ; } cocci_id@p ;
...
position p;
@@
 const struct pci9118_boardinfo cocci_id@p [ ] ;
...
position p;
@@
 struct comedi_devconfig * cocci_id@p ;
...
position p;
@@
 struct pci9118_private * cocci_id@p ;
...
position p;
@@
 enum pci9118_boardid { BOARD_PCI9118DG , BOARD_PCI9118HG , BOARD_PCI9118HR , } cocci_id@p ;
