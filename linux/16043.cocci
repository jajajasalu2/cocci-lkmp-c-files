...
position p;
@@
 struct apci16xx_boardinfo {  const char * name ;  int n_chan ; } cocci_id@p ;
...
position p;
@@
 const struct apci16xx_boardinfo * cocci_id@p ;
...
position p;
@@
 enum apci16xx_boardid { BOARD_APCI1648 , BOARD_APCI1696 , } cocci_id@p ;
