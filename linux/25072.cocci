...
position p;
@@
 ieee80211_tx_result debug_noinline cocci_id@p ;
...
position p;
@@
 struct ieee80211_fast_tx * cocci_id@p ;
...
position p;
@@
 struct ieee80211_radiotap_iterator cocci_id@p ;
...
position p;
@@
 struct ieee80211_rts * cocci_id@p ;
...
position p;
@@
 struct codel_params * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef codel_time_t;
@@
 codel_time_t cocci_id@p ;
...
position p;
@@
 struct tid_ampdu_tx * cocci_id@p ;
...
position p;
@@
 ieee80211_tx_result cocci_id@p ;
...
position p;
@@
 struct ieee80211_sta_rates * cocci_id@p ;
...
position p;
@@
 struct ieee80211_if_ap * cocci_id@p ;
...
position p;
@@
 const struct vlan_ethhdr * cocci_id@p ;
