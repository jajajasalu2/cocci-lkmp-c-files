...
position p;
@@
 struct bpf_storage_buffer * cocci_id@p ;
...
position p;
@@
 struct bpf_cgroup_storage_map cocci_id@p ;
...
position p;
@@
 const struct bpf_cgroup_storage_key * cocci_id@p ;
...
position p;
@@
 struct bpf_cgroup_storage cocci_id@p ;
...
typedef spinlock_t;
@@
 struct bpf_cgroup_storage_map {  struct bpf_map map ;  spinlock_t lock ;  struct bpf_prog_aux * aux ;  struct rb_root root ;  struct list_head list ; } cocci_id@p ;
