...
position p;
@@
 struct axp20x_adc_iio {  struct regmap * regmap ;  struct axp_data * data ; } cocci_id@p ;
...
position p;
@@
 enum axp813_adc_channel_v { AXP813_TS_IN = 0 , AXP813_GPIO0_V , AXP813_BATT_V , } cocci_id@p ;
...
position p;
@@
 enum axp22x_adc_channel_v { AXP22X_TS_IN = 0 , AXP22X_BATT_V , } cocci_id@p ;
...
typedef bool;
@@
 struct axp_data {  const struct iio_info * iio_info ;  int num_channels ;  const struct iio_chan_spec * channels ;  unsigned long adc_en1_mask ;  int ( * adc_rate ) ( struct axp20x_adc_iio * info , int rate ) ;  bool adc_en2 ;  struct iio_map * maps ; } cocci_id@p ;
...
position p;
@@
 enum axp20x_adc_channel_v { AXP20X_ACIN_V = 0 , AXP20X_VBUS_V , AXP20X_TS_IN , AXP20X_GPIO0_V , AXP20X_GPIO1_V , AXP20X_IPSOUT_V , AXP20X_BATT_V , } cocci_id@p ;
...
position p;
@@
 enum axp22x_adc_channel_i { AXP22X_BATT_CHRG_I = 1 , AXP22X_BATT_DISCHRG_I , } cocci_id@p ;
...
position p;
@@
 const struct axp_data cocci_id@p ;
...
position p;
@@
 struct axp20x_adc_iio * cocci_id@p ;
...
position p;
@@
 enum axp20x_adc_channel_i { AXP20X_ACIN_I = 0 , AXP20X_VBUS_I , AXP20X_BATT_CHRG_I , AXP20X_BATT_DISCHRG_I , } cocci_id@p ;
