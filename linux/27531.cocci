...
position p;
@@
 struct kernel_long_ad cocci_id@p [ EXTENT_MERGE_SIZE ] ;
...
position p;
@@
 void cocci_id@p ( struct inode * , int , int , struct kernel_long_ad * , int * ) ;
...
position p;
@@
 struct fileIdentDesc cocci_id@p ;
...
position p;
@@
 struct allocExtDesc * cocci_id@p ;
...
position p;
@@
 struct extendedFileEntry * cocci_id@p ;
...
position p;
@@
 struct indirectEntry * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct inode * , struct kernel_long_ad * , int , int , struct extent_position * ) ;
...
position p;
@@
 void cocci_id@p ( struct inode * , struct kernel_long_ad * , int * ) ;
...
position p;
@@
 struct udf_fileident_bh cocci_id@p ;
...
typedef umode_t;
@@
 umode_t cocci_id@p ( struct fileEntry * ) ;
...
position p;
@@
 int cocci_id@p ( struct inode * , int ) ;
...
position p;
@@
 struct kernel_long_ad * cocci_id@p ;
