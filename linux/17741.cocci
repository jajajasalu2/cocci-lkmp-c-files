...
position p;
@@
 struct id {  unsigned long val ;  struct id * * pentry ; } cocci_id@p ;
...
position p;
@@
 struct pcpu_id_table {  struct id * entry [ NUM_TIDS ] ; } cocci_id@p ;
...
position p;
@@
 struct kvm_book3e_206_tlb_entry * cocci_id@p ;
...
position p;
@@
 struct vcpu_id_table {  struct id id [ 2 ] [ NUM_TIDS ] [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct vcpu_id_table cocci_id@p ;
...
position p;
@@
 struct kvmppc_vcpu_e500 * cocci_id@p ;
