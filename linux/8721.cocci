...
position p;
@@
 const struct qed_common_ops * cocci_id@p ;
...
position p;
@@
 struct qed_generic_tlvs * cocci_id@p ;
...
position p;
@@
 struct qed_link_params cocci_id@p ;
...
position p;
@@
 struct qede_reload_args * cocci_id@p ;
...
position p;
@@
 enum qede_remove_mode { QEDE_REMOVE_NORMAL , QEDE_REMOVE_RECOVERY , } cocci_id@p ;
...
position p;
@@
 enum qede_probe_mode { QEDE_PROBE_NORMAL , QEDE_PROBE_RECOVERY , } cocci_id@p ;
...
position p;
@@
 struct status_block_e4 * cocci_id@p ;
...
position p;
@@
 enum qede_pci_private cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * dev , struct qed_link_output * link ) ;
...
position p;
@@
 struct qede_stats_bb * cocci_id@p ;
...
position p;
@@
 enum qede_probe_mode cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * ndev ) ;
...
position p;
@@
 struct qede_agg_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * edev , void * data ) ;
...
position p;
@@
 struct qede_stats_common * cocci_id@p ;
...
position p;
@@
 struct qed_dev_info * cocci_id@p ;
...
position p;
@@
 enum qede_remove_mode cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pci_dev * pdev , const struct pci_device_id * id ) ;
...
position p;
@@
 enum qede_load_mode { QEDE_LOAD_NORMAL , QEDE_LOAD_RELOAD , QEDE_LOAD_RECOVERY , } cocci_id@p ;
...
position p;
@@
 struct qede_fastpath * cocci_id@p ;
...
position p;
@@
 struct qede_rx_queue * cocci_id@p ;
...
position p;
@@
 struct qed_slowpath_params cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ QEDE_FW_VER_STR_SIZE ] ;
...
position p;
@@
 struct qed_probe_params cocci_id@p ;
...
position p;
@@
 enum qede_load_mode cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * edev , struct qed_generic_tlvs * data ) ;
...
position p;
@@
 struct qed_link_output * cocci_id@p ;
...
position p;
@@
 struct qed_int_info cocci_id@p ;
...
position p;
@@
 struct qede_tx_queue * cocci_id@p ;
...
position p;
@@
 struct qed_mfw_tlv_eth * cocci_id@p ;
...
position p;
@@
 struct qed_pf_params cocci_id@p ;
...
position p;
@@
 enum qede_unload_mode cocci_id@p ;
...
position p;
@@
 struct qede_stats_ah * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qede_dev * edev ) ;
...
position p;
@@
 enum qede_pci_private { QEDE_PRIVATE_PF , QEDE_PRIVATE_VF , } cocci_id@p ;
...
position p;
@@
 enum qede_unload_mode { QEDE_UNLOAD_NORMAL , QEDE_UNLOAD_RECOVERY , } cocci_id@p ;
