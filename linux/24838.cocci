...
position p;
@@
 const struct nft_log * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_LOG_MAX + 1 ] ;
...
position p;
@@
 struct nft_log {  struct nf_loginfo loginfo ;  char * prefix ; } cocci_id@p ;
