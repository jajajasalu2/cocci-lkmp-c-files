...
position p;
@@
 enum { ATLAS_PH_SM , ATLAS_EC_SM , ATLAS_ORP_SM , } cocci_id@p ;
...
position p;
@@
 struct atlas_device * cocci_id@p ;
...
position p;
@@
 struct atlas_device {  const struct iio_chan_spec * channels ;  int num_channels ;  int data_reg ;  int ( * calibration ) ( struct atlas_data * data ) ;  int delay ; } cocci_id@p ;
...
typedef __be32;
@@
 struct atlas_data {  struct i2c_client * client ;  struct iio_trigger * trig ;  struct atlas_device * chip ;  struct regmap * regmap ;  struct irq_work work ;  __be32 buffer [ 6 ] ; } cocci_id@p ;
