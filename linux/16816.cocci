...
typedef bool;
@@
 struct pwm_beeper {  struct input_dev * input ;  struct pwm_device * pwm ;  struct regulator * amplifier ;  struct work_struct work ;  unsigned long period ;  unsigned int bell_frequency ;  bool suspended ;  bool amplifier_on ; } cocci_id@p ;
