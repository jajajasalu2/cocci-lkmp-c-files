...
position p;
@@
 struct rom_hdr {  unsigned char iwave [ 8 ] ;  unsigned char rom_hdr_revision ;  unsigned char series_number ;  unsigned char series_name [ 16 ] ;  unsigned char date [ 10 ] ;  unsigned short vendor_revision_major ;  unsigned short vendor_revision_minor ;  unsigned int rom_size ;  unsigned char copyright [ 128 ] ;  unsigned char vendor_name [ 64 ] ;  unsigned char rom_description [ 128 ] ;  unsigned char pad [ 147 ] ;  unsigned char csum ; } cocci_id@p ;
...
position p;
@@
 struct snd_gus_card * cocci_id@p ;
...
position p;
@@
 struct snd_interwave cocci_id@p ;
...
position p;
@@
 struct snd_i2c_bit_ops cocci_id@p ;
