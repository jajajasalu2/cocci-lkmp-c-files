...
position p;
@@
 struct dsa_notifier_mdb_info cocci_id@p ;
...
position p;
@@
 struct dsa_notifier_vlan_info cocci_id@p ;
...
position p;
@@
 struct dsa_notifier_fdb_info cocci_id@p ;
...
position p;
@@
 struct dsa_notifier_ageing_time_info cocci_id@p ;
...
position p;
@@
 struct dsa_notifier_bridge_info cocci_id@p ;
