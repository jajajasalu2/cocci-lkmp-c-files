...
position p;
@@
 SMU74_Discrete_GraphicsLevel cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sclkFcwRange_t;
@@
 const sclkFcwRange_t cocci_id@p [ NUM_SCLK_RANGE ] ;
...
position p;
@@
 SMU74_Discrete_MemoryLevel cocci_id@p ;
...
position p;
@@
 struct SMU74_Discrete_Ulv * cocci_id@p ;
...
position p;
@@
 SMU74_Discrete_FanTable cocci_id@p ;
...
symbol cocci_id;
position p;
typedef AVFS_meanNsigma_t;
@@
 AVFS_meanNsigma_t cocci_id@p ;
...
position p;
@@
 const struct polaris10_pt_defaults cocci_id@p [ POWERTUNE_DEFAULT_SET_MAX ] ;
...
position p;
@@
 struct SMU74_Discrete_MCArbDramTimingTable cocci_id@p ;
...
position p;
@@
 SMU74_Discrete_MCArbDramTimingTableEntry * cocci_id@p ;
...
position p;
@@
 struct SMU74_Discrete_PmFuses cocci_id@p ;
...
position p;
@@
 struct pp_advance_fan_control_parameters * cocci_id@p ;
...
position p;
@@
 struct SMU74_Discrete_MemoryLevel * cocci_id@p ;
...
position p;
@@
 const struct polaris10_pt_defaults * cocci_id@p ;
...
position p;
@@
 struct pp_atom_ctrl_sclk_range_table cocci_id@p ;
...
position p;
@@
 const SMU74_Discrete_DpmTable * cocci_id@p ;
...
position p;
@@
 const SMU74_Discrete_MemoryLevel cocci_id@p ;
...
position p;
@@
 SMU74_Discrete_DpmTable cocci_id@p ;
...
position p;
@@
 struct SMU74_Discrete_GraphicsLevel cocci_id@p ;
...
position p;
@@
 struct SMU74_Discrete_DpmTable * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef AVFS_Sclk_Offset_t;
@@
 AVFS_Sclk_Offset_t cocci_id@p ;
...
position p;
@@
 struct polaris10_smumgr cocci_id@p ;
...
position p;
@@
 struct pp_atomctrl_clock_dividers_ai cocci_id@p ;
...
position p;
@@
 const SMU74_Discrete_GraphicsLevel cocci_id@p [ 8 ] ;
