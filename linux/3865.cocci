...
symbol cocci_id;
position p;
typedef __le32,dma_addr_t;
@@
 struct acc_hw_sge {  dma_addr_t buf ;  void * page_ctrl ;  __le32 len ;  __le32 pad ;  __le32 pad0 ;  __le32 pad1 ; } cocci_id@p ;
...
position p;
@@
 struct hisi_acc_hw_sgl * cocci_id@p ;
...
@@
 struct hisi_acc_sgl_pool {  struct mem_block {  struct hisi_acc_hw_sgl * sgl ;  dma_addr_t sgl_dma ;  size_t size ; } mem_block [ HISI_ACC_MEM_BLOCK_NR ] ;  u32 sgl_num_per_block ;  u32 block_num ;  u32 count ;  u32 sge_nr ;  size_t sgl_size ; } cocci_id@p ;
