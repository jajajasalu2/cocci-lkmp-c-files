...
@@
 struct flow_key_record {  __be32 src ;  __be32 dst ;  union {  __be32 ports ;  __be16 port16 [ 2 ] ; } ;  __u32 ip_proto ; } cocci_id@p ;
...
position p;
@@
 struct globals {  struct flow_key_record flow ; } cocci_id@p ;
...
typedef __u64;
@@
 struct pair {  __u64 packets ;  __u64 bytes ; } cocci_id@p ;
