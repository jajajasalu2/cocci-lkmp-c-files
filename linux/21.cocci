...
position p;
@@
 struct display_info cocci_id@p ;
...
position p;
@@
 enum display_mode { MODE_SHOW_VALUE , MODE_LIST_PROPS , MODE_LIST_SUBNODES , } cocci_id@p ;
...
position p;
@@
 struct display_info {  int type ;  int size ;  enum display_mode mode ;  const char * default_val ; } cocci_id@p ;
