...
typedef u32;
@@
 struct dst_cache_pcpu {  unsigned long refresh_ts ;  struct dst_entry * dst ;  u32 cookie ;  union {  struct in_addr in_saddr ;  struct in6_addr in6_saddr ; } ; } cocci_id@p ;
...
position p;
@@
 struct dst_cache_pcpu cocci_id@p ;
