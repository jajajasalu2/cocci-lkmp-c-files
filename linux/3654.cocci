...
position p;
@@
 struct imx_sc_msg_irq_enable cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_irq_get_status cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct imx_sc_msg_irq_get_status {  struct imx_sc_rpc_msg hdr ;  union {  struct {  u16 resource ;  u8 group ;  u8 reserved ; } __packed req ;  struct {  u32 status ; } resp ; } data ; } cocci_id@p ;
