...
position p;
@@
 struct software_node_ref_args cocci_id@p ;
...
position p;
@@
 const struct software_node_ref_args cocci_id@p ;
...
position p;
@@
 enum { INT33FE_NODE_FUSB302 , INT33FE_NODE_MAX17047 , INT33FE_NODE_PI3USB30532 , INT33FE_NODE_DISPLAYPORT , INT33FE_NODE_USB_CONNECTOR , INT33FE_NODE_MAX , } cocci_id@p ;
...
position p;
@@
 struct cht_int33fe_data * cocci_id@p ;
