...
position p;
@@
 struct nvmf_connect_data * cocci_id@p ;
...
position p;
@@
 struct nvmf_property_set_command cocci_id@p ;
...
position p;
@@
 struct nvmf_property_get_command cocci_id@p ;
...
position p;
@@
 struct nvmf_connect_command cocci_id@p ;
...
position p;
@@
 struct nvme_request * cocci_id@p ;
...
position p;
@@
 struct nvmf_common_command cocci_id@p ;
