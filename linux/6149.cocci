...
position p;
@@
 struct syscon_platform_data * cocci_id@p ;
...
position p;
@@
 struct syscon {  struct device_node * np ;  struct regmap * regmap ;  struct list_head list ; } cocci_id@p ;
