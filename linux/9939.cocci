...
typedef u32;
@@
 u32 cocci_id@p [ ARRAY_SIZE ( phy_regs ) ] ;
...
position p;
@@
 struct ar9170_eeprom_modal * cocci_id@p ;
...
position p;
@@
 struct ar9170_calibration_target_power_legacy * cocci_id@p ;
...
position p;
@@
 struct ar9170_calibration_data_per_freq * cocci_id@p ;
...
position p;
@@
 const struct carl9170_phy_freq_entry cocci_id@p [ ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ 2 ] [ AR5416_PD_GAIN_ICEPTS ] ;
...
position p;
@@
 struct ar9170_calctl_edges cocci_id@p [ ] ;
...
position p;
@@
 struct carl9170_rf_init cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ AR5416_MAX_NUM_TGT_PWRS ] ;
...
position p;
@@
 const struct carl9170_phy_freq_params * cocci_id@p ;
...
typedef u16;
@@
 struct carl9170_phy_freq_entry {  u16 freq ;  struct carl9170_phy_freq_params params [ __CARL9170_NUM_BW ] ; } cocci_id@p ;
...
position p;
@@
 struct carl9170_rf_init_result cocci_id@p ;
...
position p;
@@
 enum carl9170_bw { CARL9170_BW_20 , CARL9170_BW_40_BELOW , CARL9170_BW_40_ABOVE , __CARL9170_NUM_BW , } cocci_id@p ;
...
position p;
@@
 struct carl9170_phy_init cocci_id@p [ ] ;
...
position p;
@@
 struct carl9170_rf_initvals cocci_id@p [ ] ;
...
typedef u8,u16;
@@
 struct carl9170_phy_freq_params {  u8 coeff_exp ;  u16 coeff_man ;  u8 coeff_exp_shgi ;  u16 coeff_man_shgi ; } cocci_id@p ;
...
typedef u8;
@@
 struct ctl_modes {  u8 ctl_mode ;  u8 max_power ;  u8 * pwr_cal_data ;  int pwr_cal_len ; } * cocci_id@p ;
...
position p;
@@
 struct ar9170_calibration_target_power_ht * cocci_id@p ;
