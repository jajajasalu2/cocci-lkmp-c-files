...
position p;
@@
 void cocci_id@p ( struct media_entity * new , void * notify_data ) ;
...
typedef u32,u16;
@@
 int cocci_id@p ( struct au0828_dev * dev , u16 request , u32 value , u16 index , unsigned char * cp , u16 size ) ;
...
typedef u32,u16;
@@
 int cocci_id@p ( struct au0828_dev * dev , u16 request , u32 value , u16 index ) ;
