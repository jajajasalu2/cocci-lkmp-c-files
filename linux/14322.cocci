...
position p;
@@
 struct tda8261_state cocci_id@p ;
...
typedef u32;
@@
 struct tda8261_state {  struct dvb_frontend * fe ;  struct i2c_adapter * i2c ;  const struct tda8261_config * config ;  u32 frequency ;  u32 bandwidth ; } cocci_id@p ;
