...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_EXTHDR_MAX + 1 ] ;
...
typedef u8;
@@
 struct nft_exthdr {  u8 type ;  u8 offset ;  u8 len ;  u8 op ;  enum nft_registers dreg : 8 ;  enum nft_registers sreg : 8 ;  u8 flags ; } cocci_id@p ;
...
position p;
@@
 const struct nft_exthdr * cocci_id@p ;
...
typedef u8,__be32;
@@
 union {  u8 octet ;  __be16 v16 ;  __be32 v32 ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct tcphdr ) + MAX_TCP_OPTION_SPACE ] ;
