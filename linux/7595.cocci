...
position p;
@@
 struct pipe_msg_hdr cocci_id@p ;
...
position p;
@@
 struct synthvid_msg cocci_id@p ;
...
position p;
@@
 enum synthvid_msg_type { SYNTHVID_ERROR = 0 , SYNTHVID_VERSION_REQUEST = 1 , SYNTHVID_VERSION_RESPONSE = 2 , SYNTHVID_VRAM_LOCATION = 3 , SYNTHVID_VRAM_LOCATION_ACK = 4 , SYNTHVID_SITUATION_UPDATE = 5 , SYNTHVID_SITUATION_UPDATE_ACK = 6 , SYNTHVID_POINTER_POSITION = 7 , SYNTHVID_POINTER_SHAPE = 8 , SYNTHVID_FEATURE_CHANGE = 9 , SYNTHVID_DIRT = 10 , SYNTHVID_RESOLUTION_REQUEST = 13 , SYNTHVID_RESOLUTION_RESPONSE = 14 , SYNTHVID_MAX = 15 , } cocci_id@p ;
...
position p;
@@
 struct synthvid_pointer_position cocci_id@p ;
...
position p;
@@
 struct synthvid_situation_update cocci_id@p ;
...
position p;
@@
 struct synthvid_pointer_shape cocci_id@p ;
...
position p;
@@
 struct synthvid_msg_hdr cocci_id@p ;
...
position p;
@@
 struct synthvid_supported_resolution_req cocci_id@p ;
...
position p;
@@
 struct synthvid_version_req cocci_id@p ;
...
position p;
@@
 struct synthvid_dirt cocci_id@p ;
...
position p;
@@
 struct synthvid_vram_location cocci_id@p ;
...
position p;
@@
 enum pipe_msg_type { PIPE_MSG_INVALID , PIPE_MSG_DATA , PIPE_MSG_MAX , } cocci_id@p ;
