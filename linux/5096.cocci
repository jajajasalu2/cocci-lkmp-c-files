...
position p;
@@
 unsigned int cocci_id@p [ MAX_NUM_IDIO_16 ] ;
...
position p;
@@
 struct idio_16_gpio * const cocci_id@p ;
...
@@
 struct idio_16_gpio {  struct gpio_chip chip ;  raw_spinlock_t lock ;  unsigned long irq_mask ;  unsigned base ;  unsigned out_state ; } cocci_id@p ;
