...
position p;
@@
 struct tegra_i2c_dev * cocci_id@p ;
...
position p;
@@
 const struct tegra_i2c_hw_feature cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u32,u16,phys_addr_t,spinlock_t,dma_addr_t;
@@
 struct tegra_i2c_dev {  struct device * dev ;  const struct tegra_i2c_hw_feature * hw ;  struct i2c_adapter adapter ;  struct clk * div_clk ;  struct clk * fast_clk ;  struct reset_control * rst ;  void __iomem * base ;  phys_addr_t base_phys ;  int cont_id ;  int irq ;  bool irq_disabled ;  int is_dvc ;  struct completion msg_complete ;  int msg_err ;  u8 * msg_buf ;  size_t msg_buf_remaining ;  int msg_read ;  u32 bus_clk_rate ;  u16 clk_divisor_non_hs_mode ;  bool is_multimaster_mode ;  spinlock_t xfer_lock ;  struct dma_chan * tx_dma_chan ;  struct dma_chan * rx_dma_chan ;  dma_addr_t dma_phys ;  u32 * dma_buf ;  unsigned int dma_buf_size ;  bool is_curr_dma_xfer ;  struct completion dma_complete ; } cocci_id@p ;
...
position p;
@@
 enum msg_end_type { MSG_END_STOP , MSG_END_REPEAT_START , MSG_END_CONTINUE , } cocci_id@p ;
