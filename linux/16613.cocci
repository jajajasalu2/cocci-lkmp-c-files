...
position p;
@@
 struct zfcp_fc_gspn_rsp * cocci_id@p ;
...
position p;
@@
 struct fsf_status_read_buffer * cocci_id@p ;
...
position p;
@@
 struct zfcp_fc_gpn_ft_req cocci_id@p ;
...
position p;
@@
 struct zfcp_fc_wka_port * cocci_id@p ;
...
position p;
@@
 struct zfcp_adapter * cocci_id@p ;
...
position p;
@@
 struct zfcp_fc_rspn_req * cocci_id@p ;
...
position p;
@@
 struct zfcp_fc_events * cocci_id@p ;
...
position p;
@@
 struct zfcp_fc_gid_pn_req * cocci_id@p ;
...
position p;
@@
 struct zfcp_fc_wka_ports * cocci_id@p ;
...
position p;
@@
 struct zfcp_fc_gspn_req * cocci_id@p ;
...
position p;
@@
 struct zfcp_fsf_req * cocci_id@p ;
...
position p;
@@
 struct zfcp_fc_event cocci_id@p ;
...
position p;
@@
 struct zfcp_fc_gid_pn_rsp * cocci_id@p ;
...
position p;
@@
 struct fc_gpn_ft_resp * cocci_id@p ;
...
position p;
@@
 struct zfcp_fsf_ct_els * cocci_id@p ;
