...
position p;
@@
 enum rx_states { HCI_IBS_RX_ASLEEP , HCI_IBS_RX_AWAKE , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qca_serdev * qcadev ) ;
...
position p;
@@
 enum tx_ibs_states { HCI_IBS_TX_ASLEEP , HCI_IBS_TX_WAKING , HCI_IBS_TX_AWAKE , } cocci_id@p ;
...
position p;
@@
 const struct qca_vreg_data * cocci_id@p ;
...
position p;
@@
 enum qca_btsoc_type cocci_id@p ;
...
position p;
@@
 enum qca_speed_type cocci_id@p ;
...
position p;
@@
 const struct qca_vreg * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qca_serdev * qcadev ) ;
...
position p;
@@
 void cocci_id@p ( struct hci_uart * hu ) ;
...
symbol cocci_id;
position p;
typedef u8,u64,bool,u32,wait_queue_head_t,spinlock_t;
@@
 struct qca_data {  struct hci_uart * hu ;  struct sk_buff * rx_skb ;  struct sk_buff_head txq ;  struct sk_buff_head tx_wait_q ;  spinlock_t hci_ibs_lock ;  u8 tx_ibs_state ;  u8 rx_ibs_state ;  bool tx_vote ;  bool rx_vote ;  struct timer_list tx_idle_timer ;  u32 tx_idle_delay ;  struct timer_list wake_retrans_timer ;  u32 wake_retrans ;  struct workqueue_struct * workqueue ;  struct work_struct ws_awake_rx ;  struct work_struct ws_awake_device ;  struct work_struct ws_rx_vote_off ;  struct work_struct ws_tx_vote_off ;  unsigned long flags ;  struct completion drop_ev_comp ;  wait_queue_head_t suspend_wait_q ;  u64 ibs_sent_wacks ;  u64 ibs_sent_slps ;  u64 ibs_sent_wakes ;  u64 ibs_recv_wacks ;  u64 ibs_recv_slps ;  u64 ibs_recv_wakes ;  u64 vote_last_jif ;  u32 vote_on_ms ;  u32 vote_off_ms ;  u64 tx_votes_on ;  u64 rx_votes_on ;  u64 tx_votes_off ;  u64 rx_votes_off ;  u64 votes_on ;  u64 votes_off ; } cocci_id@p ;
...
position p;
@@
 struct qca_vreg_data {  enum qca_btsoc_type soc_type ;  struct qca_vreg * vregs ;  size_t num_vregs ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hci_dev * hdev ) ;
...
position p;
@@
 struct serdev_device * cocci_id@p ;
...
position p;
@@
 struct qca_vreg {  const char * name ;  unsigned int load_uA ; } cocci_id@p ;
...
position p;
@@
 const struct hci_uart_proto cocci_id@p ;
...
position p;
@@
 const struct h4_recv_pkt cocci_id@p [ ] ;
...
typedef bool;
@@
 struct qca_power {  struct device * dev ;  struct regulator_bulk_data * vreg_bulk ;  int num_vregs ;  bool vregs_on ; } cocci_id@p ;
...
typedef u32;
@@
 struct qca_serdev {  struct hci_uart serdev_hu ;  struct gpio_desc * bt_en ;  struct clk * susclk ;  enum qca_btsoc_type btsoc_type ;  struct qca_power * bt_power ;  u32 init_speed ;  u32 oper_speed ;  const char * firmware_name ; } cocci_id@p ;
...
position p;
@@
 enum hci_ibs_clock_state_vote { HCI_IBS_VOTE_STATS_UPDATE , HCI_IBS_TX_VOTE_CLOCK_ON , HCI_IBS_TX_VOTE_CLOCK_OFF , HCI_IBS_RX_VOTE_CLOCK_ON , HCI_IBS_RX_VOTE_CLOCK_OFF , } cocci_id@p ;
...
position p;
@@
 enum qca_flags { QCA_IBS_ENABLED , QCA_DROP_VENDOR_EVENT , QCA_SUSPENDING , } cocci_id@p ;
...
position p;
@@
 struct regulator_bulk_data * cocci_id@p ;
...
position p;
@@
 struct serdev_device_driver cocci_id@p ;
...
position p;
@@
 enum qca_speed_type { QCA_INIT_SPEED = 1 , QCA_OPER_SPEED , } cocci_id@p ;
