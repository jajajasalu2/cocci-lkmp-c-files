...
position p;
@@
 struct oxnas_rps_timer * cocci_id@p ;
...
position p;
@@
 struct oxnas_rps_timer {  struct clock_event_device clkevent ;  void __iomem * clksrc_base ;  void __iomem * clkevt_base ;  unsigned long timer_period ;  unsigned int timer_prescaler ;  struct clk * clk ;  int irq ; } cocci_id@p ;
