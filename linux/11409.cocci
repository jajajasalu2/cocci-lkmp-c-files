...
position p;
@@
 int cocci_id@p ( struct drm_device * dev , struct drm_vmw_gb_surface_create_ext_req * req , struct drm_vmw_gb_surface_create_rep * rep , struct drm_file * file_priv ) ;
...
position p;
@@
 struct vmw_surface_define {  SVGA3dCmdHeader header ;  SVGA3dCmdDefineSurface body ; } cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDestroyGBSurface body ; } * cocci_id@p ;
...
position p;
@@
 struct ttm_object_file * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_gb_surface_ref_ext_rep cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdBindGBSurface body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_surface_dma * cocci_id@p ;
...
position p;
@@
 const struct svga3dsurface_loc * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_gb_surface_ref_rep * cocci_id@p ;
...
position p;
@@
 struct vmw_resource * cocci_id@p ( struct ttm_base_object * base ) ;
...
position p;
@@
 const struct vmw_surface * cocci_id@p ;
...
position p;
@@
 struct ttm_buffer_object * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDefineGBSurface_v3 body ; } * cocci_id@p ;
...
position p;
@@
 SVGA3dCmdSurfaceDMASuffix * cocci_id@p ;
...
position p;
@@
 struct ttm_base_object * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_size cocci_id@p ;
...
position p;
@@
 struct drm_vmw_surface_create_req * cocci_id@p ;
...
typedef u32;
@@
 struct vmw_surface_dirty {  struct svga3dsurface_cache cache ;  size_t size ;  u32 num_subres ;  SVGA3dBox boxes [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDefineGBSurface body ; } * cocci_id@p ;
...
position p;
@@
 enum drm_vmw_handle_type cocci_id@p ;
...
position p;
@@
 union drm_vmw_gb_surface_create_arg * cocci_id@p ;
...
position p;
@@
 struct svga3dsurface_loc cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vmw_resource * res ) ;
...
position p;
@@
 struct ttm_operation_ctx cocci_id@p ;
...
position p;
@@
 union drm_vmw_gb_surface_reference_ext_arg * cocci_id@p ;
...
position p;
@@
 union drm_vmw_gb_surface_reference_arg * cocci_id@p ;
...
position p;
@@
 struct vmw_surface_offset * cocci_id@p ;
...
position p;
@@
 struct vmw_buffer_object * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_surface_arg * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDXUpdateSubResource body ; } * cocci_id@p ;
...
position p;
@@
 const struct vmw_user_resource_conv * cocci_id@p ;
...
position p;
@@
 union drm_vmw_gb_surface_create_ext_arg * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_gb_surface_create_ext_req cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct vmw_resource * res , bool readback , struct ttm_validate_buffer * val_buf ) ;
...
position p;
@@
 SVGA3dSurfaceAllFlags cocci_id@p ;
...
position p;
@@
 struct vmw_surface_destroy cocci_id@p ;
...
position p;
@@
 struct vmw_user_surface * cocci_id@p ;
...
position p;
@@
 const struct svga3d_surface_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vmw_resource * res , struct ttm_validate_buffer * val_buf ) ;
...
position p;
@@
 struct vmw_surface_define * cocci_id@p ;
...
position p;
@@
 struct vmw_surface_dma {  SVGA3dCmdHeader header ;  SVGA3dCmdSurfaceDMA body ;  SVGA3dCopyBox cb ;  SVGA3dCmdSurfaceDMASuffix suffix ; } cocci_id@p ;
...
position p;
@@
 const struct vmw_res_func cocci_id@p ;
...
position p;
@@
 SVGA3dCmdSurfaceDMA * cocci_id@p ;
...
position p;
@@
 SVGA3dMSQualityLevel cocci_id@p ;
...
position p;
@@
 const struct drm_vmw_size * cocci_id@p ;
...
position p;
@@
 const struct vmw_surface_offset * cocci_id@p ;
...
position p;
@@
 union drm_vmw_surface_reference_arg * cocci_id@p ;
...
position p;
@@
 struct vmw_surface_dirty * cocci_id@p ;
...
position p;
@@
 struct vmw_fence_obj * cocci_id@p ;
...
typedef uint32_t;
@@
 struct vmw_user_surface {  struct ttm_prime_object prime ;  struct vmw_surface srf ;  uint32_t size ;  struct drm_master * master ;  struct ttm_base_object * backup_base ; } cocci_id@p ;
...
position p;
@@
 union drm_vmw_surface_create_arg * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_device * dev , struct drm_vmw_surface_arg * req , struct drm_vmw_gb_surface_ref_ext_rep * rep , struct drm_file * file_priv ) ;
...
position p;
@@
 const struct svga3dsurface_cache * cocci_id@p ;
...
position p;
@@
 SVGA3dSurfaceFormat cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdUpdateGBImage body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdUpdateGBSurface body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_surface_destroy {  SVGA3dCmdHeader header ;  SVGA3dCmdDestroySurface body ; } cocci_id@p ;
...
position p;
@@
 struct drm_vmw_gb_surface_create_rep * cocci_id@p ;
...
position p;
@@
 struct vmw_resource_dirty * cocci_id@p ;
...
position p;
@@
 struct vmw_resource * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct vmw_resource * res ) ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdInvalidateGBSurface body ; } * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdReadbackGBSurface body ; } * cocci_id@p ;
...
typedef uint32_t;
@@
 struct vmw_surface_offset {  uint32_t face ;  uint32_t mip ;  uint32_t bo_offset ; } cocci_id@p ;
...
position p;
@@
 SVGA3dSurface1Flags cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDefineGBSurface_v2 body ; } * cocci_id@p ;
