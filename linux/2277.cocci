...
position p;
@@
 struct sr_thermal {  void __iomem * regs ;  unsigned int max_crit_temp ;  struct sr_tmon tmon [ SR_TMON_MAX_LIST ] ; } cocci_id@p ;
...
position p;
@@
 struct sr_tmon {  struct thermal_zone_device * tz ;  unsigned int crit_temp ;  unsigned int tmon_id ;  struct sr_thermal * priv ; } cocci_id@p ;
