...
position p;
@@
 const struct coda_video_device cocci_id@p ;
...
position p;
@@
 const struct coda_devtype cocci_id@p [ ] ;
...
position p;
@@
 struct coda_buffer_meta cocci_id@p ;
...
typedef bool,u32;
@@
 struct coda_video_device {  const char * name ;  enum coda_inst_type type ;  const struct coda_context_ops * ops ;  bool direct ;  u32 src_formats [ CODA_MAX_FORMATS ] ;  u32 dst_formats [ CODA_MAX_FORMATS ] ; } cocci_id@p ;
...
position p;
@@
 enum coda_inst_type cocci_id@p ;
...
position p;
@@
 const struct coda_codec * cocci_id@p ;
...
position p;
@@
 struct coda_aux_buf * cocci_id@p ;
...
position p;
@@
 const struct coda_q_data * cocci_id@p ;
...
position p;
@@
 struct coda_platform_data * cocci_id@p ;
...
position p;
@@
 enum coda_platform { CODA_IMX27 , CODA_IMX51 , CODA_IMX53 , CODA_IMX6Q , CODA_IMX6DL , } cocci_id@p ;
