...
typedef bool;
@@
 struct usb_udc {  struct usb_gadget_driver * driver ;  struct usb_gadget * gadget ;  struct device dev ;  struct list_head list ;  bool vbus ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_udc * udc , struct usb_gadget_driver * driver ) ;
