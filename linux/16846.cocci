...
typedef u8;
@@
 u8 cocci_id@p [ BMA150_XYZ_DATA_SIZE ] ;
...
position p;
@@
 const struct bma150_cfg cocci_id@p ;
...
typedef u8;
@@
 struct bma150_data {  struct i2c_client * client ;  struct input_dev * input ;  u8 mode ; } cocci_id@p ;
...
position p;
@@
 const struct bma150_platform_data * cocci_id@p ;
