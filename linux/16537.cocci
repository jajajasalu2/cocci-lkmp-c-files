...
position p;
@@
 struct dasd_diag_bio * cocci_id@p ;
...
position p;
@@
 union {  struct dasd_diag_init_io init_io ;  struct dasd_diag_rw_io rw_io ; } cocci_id@p ;
...
position p;
@@
 struct dasd_diag_req {  unsigned int block_count ;  struct dasd_diag_bio bio [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct dasd_diag_private * cocci_id@p ;
...
position p;
@@
 struct vtoc_cms_label * cocci_id@p ;
...
position p;
@@
 struct dasd_diag_req cocci_id@p ;
...
position p;
@@
 struct dasd_diag_characteristics * cocci_id@p ;
...
position p;
@@
 struct dasd_diag_init_io * cocci_id@p ;
...
position p;
@@
 struct dasd_diag_rw_io cocci_id@p ;
...
typedef blocknum_t;
@@
 struct dasd_diag_private {  struct dasd_diag_characteristics rdc_data ;  struct dasd_diag_rw_io iob ;  struct dasd_diag_init_io iib ;  blocknum_t pt_block ;  struct ccw_dev_id dev_id ; } cocci_id@p ;
