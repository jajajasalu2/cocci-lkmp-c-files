...
position p;
@@
 struct intel_sdvo_enhancements_reply cocci_id@p ;
...
position p;
@@
 const struct i2c_lock_operations cocci_id@p ;
...
position p;
@@
 struct intel_sdvo_connector_state cocci_id@p ;
...
position p;
@@
 const struct intel_sdvo_connector_state * cocci_id@p ;
...
position p;
@@
 struct intel_sdvo_preferred_input_timing_args cocci_id@p ;
...
position p;
@@
 struct intel_sdvo_dtd cocci_id@p ;
...
position p;
@@
 struct intel_sdvo_connector cocci_id@p ;
...
position p;
@@
 struct intel_sdvo_in_out_map cocci_id@p ;
...
position p;
@@
 const struct intel_sdvo_connector * cocci_id@p ;
...
position p;
@@
 struct intel_sdvo_sdtv_resolution_request cocci_id@p ;
...
typedef u16;
@@
 union {  struct intel_sdvo_enhancements_reply reply ;  u16 response ; } cocci_id@p ;
...
position p;
@@
 const struct intel_sdvo_dtd * cocci_id@p ;
...
position p;
@@
 struct intel_sdvo_caps * cocci_id@p ;
...
typedef bool,u16;
@@
 bool cocci_id@p ( struct intel_sdvo * intel_sdvo , u16 flags ) ;
...
position p;
@@
 struct intel_sdvo_tv_format cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct intel_sdvo * intel_sdvo , struct intel_sdvo_connector * intel_sdvo_connector , int type ) ;
...
position p;
@@
 struct intel_sdvo_encode cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct intel_sdvo * intel_sdvo , struct intel_sdvo_connector * intel_sdvo_connector ) ;
...
position p;
@@
 struct intel_sdvo_set_target_input_args cocci_id@p ;
...
position p;
@@
 struct sdvo_device_mapping * cocci_id@p ;
...
position p;
@@
 struct intel_sdvo_get_trained_inputs_response cocci_id@p ;
...
position p;
@@
 struct intel_sdvo_pixel_clock_range cocci_id@p ;
