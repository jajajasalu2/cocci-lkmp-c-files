...
position p;
@@
 struct fdt_reserve_entry cocci_id@p ;
...
position p;
@@
 struct version_info {  int version ;  int last_comp_version ;  int hdr_size ;  int flags ; } cocci_id@p [ ] ;
