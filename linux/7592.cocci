...
position p;
@@
 const struct aty_dac_ops cocci_id@p ;
...
position p;
@@
 const union aty_pll * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( const struct fb_info * info , u32 vclk_per , u32 bpp , union aty_pll * pll ) ;
...
position p;
@@
 const struct aty_pll_ops cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( const struct fb_info * info , u32 vclk_per , struct pll_ct * pll ) ;
...
typedef u32;
@@
 int cocci_id@p ( const struct fb_info * info , u32 bpp , struct pll_ct * pll ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( const struct fb_info * info , const union aty_pll * pll ) ;
