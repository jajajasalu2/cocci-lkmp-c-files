...
position p;
@@
 enum netup_spi_state { SPI_STATE_START , SPI_STATE_DONE , } cocci_id@p ;
...
@@
 struct netup_spi {  struct device * dev ;  struct spi_master * master ;  struct netup_spi_regs __iomem * regs ;  u8 __iomem * mmio ;  spinlock_t lock ;  wait_queue_head_t waitq ;  enum netup_spi_state state ; } cocci_id@p ;
...
position p;
@@
 struct netup_unidvb_dev * cocci_id@p ;
