...
typedef u32;
@@
 void cocci_id@p ( struct drm_encoder * encoder , u32 offset , int bpc ) ;
...
position p;
@@
 const struct radeon_hdmi_acr cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct drm_encoder * encoder ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct drm_encoder * encoder , u32 offset ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_encoder * encoder , long offset , const struct radeon_hdmi_acr * acr ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_encoder * encoder , struct drm_connector * connector , struct drm_display_mode * mode ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_encoder * encoder , struct cea_sad * sads , int sad_count ) ;
...
position p;
@@
 struct radeon_audio_basic_funcs cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct radeon_device * rdev , u32 offset , u32 reg ) ;
...
position p;
@@
 void cocci_id@p ( struct radeon_device * rdev , struct radeon_crtc * crtc , unsigned int clock ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct radeon_device * rdev , struct r600_audio_pin * pin , u8 enable_mask ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct radeon_device * rdev , u32 offset , u32 reg , u32 v ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct drm_encoder * encoder , u8 * sadb , int sad_count ) ;
...
position p;
@@
 void cocci_id@p ( struct drm_encoder * encoder , struct drm_display_mode * mode ) ;
...
position p;
@@
 struct radeon_audio_funcs cocci_id@p ;
...
position p;
@@
 struct r600_audio_pin * cocci_id@p ( struct radeon_device * rdev ) ;
...
position p;
@@
 struct r600_audio_pin * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct drm_encoder * encoder , bool enable ) ;
...
typedef bool,u32;
@@
 void cocci_id@p ( struct drm_encoder * encoder , u32 offset , bool mute ) ;
...
position p;
@@
 struct radeon_hdmi_acr cocci_id@p ;
