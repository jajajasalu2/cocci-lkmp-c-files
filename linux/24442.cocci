...
position p;
@@
 void cocci_id@p ( struct lib80211_crypt_info * info ) ;
...
position p;
@@
 struct lib80211_crypto_alg * cocci_id@p ;
...
position p;
@@
 struct lib80211_crypto_alg {  struct list_head list ;  struct lib80211_crypto_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct lib80211_crypt_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lib80211_crypt_info * info , int force ) ;
