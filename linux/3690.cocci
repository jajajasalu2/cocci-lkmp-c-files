...
position p;
@@
 struct mv_cesa_ahash_result cocci_id@p ;
...
position p;
@@
 struct mv_cesa_op_ctx * cocci_id@p ;
...
position p;
@@
 const struct sha256_state * cocci_id@p ;
...
position p;
@@
 struct mv_cesa_ahash_dma_req * cocci_id@p ;
...
position p;
@@
 struct mv_cesa_ahash_req * cocci_id@p ;
...
position p;
@@
 struct mv_cesa_ahash_std_req * cocci_id@p ;
...
position p;
@@
 struct mv_cesa_hash_ctx cocci_id@p ;
...
position p;
@@
 struct mv_cesa_hmac_ctx * cocci_id@p ;
...
position p;
@@
 struct mv_cesa_ahash_dma_iter cocci_id@p ;
...
position p;
@@
 struct mv_cesa_ahash_dma_iter {  struct mv_cesa_dma_iter base ;  struct mv_cesa_sg_dma_iter src ; } cocci_id@p ;
...
position p;
@@
 struct mv_cesa_engine * cocci_id@p ;
...
position p;
@@
 const struct mv_cesa_req_ops cocci_id@p ;
...
position p;
@@
 struct mv_cesa_tdma_chain * cocci_id@p ;
...
position p;
@@
 struct mv_cesa_ahash_result {  struct completion completion ;  int error ; } cocci_id@p ;
...
position p;
@@
 const struct md5_state * cocci_id@p ;
...
position p;
@@
 const struct sha1_state * cocci_id@p ;
