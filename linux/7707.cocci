...
position p;
@@
 struct clps711x_port {  struct uart_port port ;  unsigned int tx_enabled ;  int rx_irq ;  struct regmap * syscon ;  struct mctrl_gpios * gpios ; } cocci_id@p ;
...
position p;
@@
 struct clps711x_port * cocci_id@p ;
