...
position p;
@@
 struct redir_addr {  unsigned long redirect ;  unsigned long alias ; } cocci_id@p ;
...
position p;
@@
 union uvh_si_addr_map_config_u cocci_id@p ;
...
position p;
@@
 union uvh_si_alias0_overlay_config_u cocci_id@p ;
