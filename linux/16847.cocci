...
position p;
@@
 const struct pm8xxx_regs * cocci_id@p ;
...
position p;
@@
 struct pm8xxx_regs {  unsigned int enable_addr ;  unsigned int enable_mask ;  unsigned int drv_addr ;  unsigned int drv_mask ;  unsigned int drv_shift ;  unsigned int drv_en_manual_mask ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct pm8xxx_vib {  struct input_dev * vib_input_dev ;  struct work_struct work ;  struct regmap * regmap ;  const struct pm8xxx_regs * regs ;  int speed ;  int level ;  bool active ;  u8 reg_vib_drv ; } cocci_id@p ;
