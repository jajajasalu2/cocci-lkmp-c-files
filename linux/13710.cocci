...
position p;
@@
 struct tvp514x_decoder cocci_id@p ;
...
position p;
@@
 const struct tvp514x_decoder cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct v4l2_subdev * sd , int enable ) ;
...
position p;
@@
 struct tvp514x_reg cocci_id@p [ 0x40 ] ;
...
position p;
@@
 const struct tvp514x_reg cocci_id@p [ ] ;
...
position p;
@@
 const struct tvp514x_std_info cocci_id@p [ ] ;
...
position p;
@@
 enum tvp514x_std { STD_NTSC_MJ = 0 , STD_PAL_BDGHIN , STD_INVALID , } cocci_id@p ;
...
typedef u8;
@@
 struct tvp514x_std_info {  unsigned long width ;  unsigned long height ;  u8 video_std ;  struct v4l2_standard standard ; } cocci_id@p ;
...
typedef u32;
@@
 struct tvp514x_decoder {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  struct tvp514x_reg tvp514x_regs [ ARRAY_SIZE ( tvp514x_reg_list_default ) ] ;  const struct tvp514x_platform_data * pdata ;  int ver ;  int streaming ;  struct v4l2_pix_format pix ;  int num_fmts ;  const struct v4l2_fmtdesc * fmt_list ;  enum tvp514x_std current_std ;  int num_stds ;  const struct tvp514x_std_info * std_list ;  u32 input ;  u32 output ;  struct media_pad pad ;  struct v4l2_mbus_framefmt format ;  struct tvp514x_reg * int_seq ; } cocci_id@p ;
...
position p;
@@
 enum tvp514x_output cocci_id@p ;
