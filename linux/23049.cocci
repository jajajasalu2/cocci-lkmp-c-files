...
position p;
@@
 struct rx51_audio_pdata {  struct gpio_desc * tvout_selection_gpio ;  struct gpio_desc * jack_detection_gpio ;  struct gpio_desc * eci_sw_gpio ;  struct gpio_desc * speaker_amp_gpio ; } cocci_id@p ;
...
position p;
@@
 struct rx51_audio_pdata * cocci_id@p ;
...
position p;
@@
 enum { RX51_JACK_DISABLED , RX51_JACK_TVOUT , RX51_JACK_HP , RX51_JACK_HS , } cocci_id@p ;
