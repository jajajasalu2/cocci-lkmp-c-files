...
position p;
@@
 enum aarch64_insn_movw_imm_type cocci_id@p ;
...
position p;
@@
 enum aarch64_insn_movw_imm_type { AARCH64_INSN_IMM_MOVNZ , AARCH64_INSN_IMM_MOVKZ , } cocci_id@p ;
...
position p;
@@
 enum aarch64_reloc_op cocci_id@p ;
...
position p;
@@
 enum aarch64_reloc_op { RELOC_OP_NONE , RELOC_OP_ABS , RELOC_OP_PREL , RELOC_OP_PAGE , } cocci_id@p ;
