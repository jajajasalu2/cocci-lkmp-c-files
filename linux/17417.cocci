...
typedef u8,u16;
@@
 struct chrp_header {  u8 signature ;  u8 cksum ;  u16 len ;  char name [ 12 ] ;  u8 data [ 0 ] ; } cocci_id@p ;
...
typedef u8;
@@
 int ( * cocci_id@p ) ( int bank , u8 * datas ) ;
...
position p;
@@
 struct core99_header * cocci_id@p ;
...
typedef u32;
@@
 struct core99_header {  struct chrp_header hdr ;  u32 adler ;  u32 generation ;  u32 reserved [ 2 ] ; } cocci_id@p ;
