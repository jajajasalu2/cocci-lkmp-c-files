...
position p;
@@
 char cocci_id@p [ DEBUGFS_WRITE_BUF_SIZE + 1 ] ;
...
position p;
@@
 struct vchiq_debugfs_log_entry {  const char * name ;  void * plevel ; } cocci_id@p ;
...
position p;
@@
 struct vchiq_debugfs_log_entry cocci_id@p [ ] ;
