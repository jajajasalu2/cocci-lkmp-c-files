...
position p;
@@
 const struct mb86a16_config cocci_id@p ;
...
position p;
@@
 const struct xc5000_config cocci_id@p ;
...
position p;
@@
 const struct stv0288_config cocci_id@p ;
...
position p;
@@
 const struct stv0900_config cocci_id@p ;
...
position p;
@@
 const struct zl10353_config cocci_id@p ;
...
position p;
@@
 const struct s5h1409_config cocci_id@p ;
...
position p;
@@
 const struct lgdt330x_config cocci_id@p ;
...
position p;
@@
 const struct mt352_config cocci_id@p ;
...
position p;
@@
 const struct s5h1411_config cocci_id@p ;
...
position p;
@@
 const struct stb6100_config cocci_id@p ;
...
position p;
@@
 const struct nxt200x_config cocci_id@p ;
...
position p;
@@
 const struct cx22702_config cocci_id@p ;
...
position p;
@@
 const struct or51132_config cocci_id@p ;
