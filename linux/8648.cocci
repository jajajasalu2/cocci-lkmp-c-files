...
position p;
@@
 struct i40e_lldp_variables * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_cee_dcb_cfg_resp * cocci_id@p ;
...
position p;
@@
 struct i40e_cee_feat_tlv * cocci_id@p ;
...
position p;
@@
 struct i40e_lldp_org_tlv * cocci_id@p ;
...
position p;
@@
 struct i40e_aqc_get_cee_dcb_cfg_v1_resp cocci_id@p ;
...
position p;
@@
 struct i40e_cee_app_prio * cocci_id@p ;
...
position p;
@@
 struct i40e_cee_ctrl_tlv cocci_id@p ;
...
position p;
@@
 struct i40e_dcb_ets_config * cocci_id@p ;
