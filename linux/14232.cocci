...
position p;
@@
 struct isc_subdev_entity cocci_id@p ;
...
position p;
@@
 const struct isc_format cocci_id@p [ ] ;
...
typedef u32;
@@
 const u32 cocci_id@p [ GAMMA_MAX + 1 ] [ GAMMA_ENTRIES ] ;
...
position p;
@@
 const struct reg_field cocci_id@p [ ISC_PIPE_LINE_NODE_NUM ] ;
