...
position p;
@@
 struct psb_intel_sdvo_tv_format cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct psb_intel_sdvo * psb_intel_sdvo , struct psb_intel_sdvo_connector * psb_intel_sdvo_connector ) ;
...
position p;
@@
 struct drm_psb_private * cocci_id@p ;
...
position p;
@@
 struct psb_intel_sdvo_preferred_input_timing_args cocci_id@p ;
...
position p;
@@
 struct psb_intel_sdvo_get_trained_inputs_response cocci_id@p ;
...
typedef uint16_t;
@@
 union {  struct psb_intel_sdvo_enhancements_reply reply ;  uint16_t response ; } cocci_id@p ;
...
position p;
@@
 struct i2c_msg cocci_id@p [ MAX_ARG_LEN + 3 ] ;
...
position p;
@@
 struct psb_intel_sdvo_in_out_map cocci_id@p ;
...
position p;
@@
 struct psb_intel_sdvo_pixel_clock_range cocci_id@p ;
...
position p;
@@
 struct psb_intel_sdvo * cocci_id@p ;
...
position p;
@@
 struct psb_intel_sdvo_caps * cocci_id@p ;
...
position p;
@@
 struct psb_intel_sdvo_encode cocci_id@p ;
...
position p;
@@
 struct psb_intel_sdvo_dtd * cocci_id@p ;
...
typedef u8;
@@
 const struct _sdvo_cmd_name {  u8 cmd ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct psb_intel_sdvo_sdtv_resolution_request cocci_id@p ;
...
position p;
@@
 struct psb_intel_sdvo_enhancements_reply cocci_id@p ;
...
position p;
@@
 struct gma_connector * cocci_id@p ;
...
position p;
@@
 const struct psb_intel_sdvo_dtd * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct psb_intel_sdvo * psb_intel_sdvo , struct psb_intel_sdvo_connector * psb_intel_sdvo_connector , int type ) ;
...
position p;
@@
 struct psb_intel_sdvo_set_target_input_args cocci_id@p ;
...
position p;
@@
 struct psb_intel_sdvo_connector cocci_id@p ;
