...
symbol cocci_id;
position p;
typedef dev_t,spinlock_t;
@@
 struct major_info {  struct rcu_head rcu ;  dev_t major ;  struct idr minor_idr ;  spinlock_t minor_lock ;  const char * device_name ;  struct list_head next ; } cocci_id@p ;
...
position p;
@@
 struct {  __be16 h_vlan_proto ;  __be16 h_vlan_TCI ; } cocci_id@p ;
