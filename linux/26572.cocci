...
typedef u8,u32;
@@
 struct mdev_state {  u8 * vconfig ;  u32 bar_mask ;  struct mutex ops_lock ;  struct mdev_device * mdev ;  struct vfio_device_info dev_info ;  const struct mdpy_type * type ;  u32 memsize ;  void * memblk ; } cocci_id@p ;
...
typedef u32;
@@
 const struct mdpy_type {  const char * name ;  u32 format ;  u32 bytepp ;  u32 width ;  u32 height ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct mdpy_type * cocci_id@p ;
