...
position p;
@@
 struct ti_eqep_cnt {  struct counter_device counter ;  struct regmap * regmap32 ;  struct regmap * regmap16 ; } cocci_id@p ;
...
position p;
@@
 const enum counter_synapse_action cocci_id@p [ ] ;
...
position p;
@@
 const enum counter_count_function cocci_id@p [ ] ;
...
position p;
@@
 enum { TI_EQEP_SIGNAL_QEPA , TI_EQEP_SIGNAL_QEPB , } cocci_id@p ;
...
position p;
@@
 struct counter_count_ext cocci_id@p [ ] ;
...
position p;
@@
 enum { TI_EQEP_SYNAPSE_ACTION_BOTH_EDGES , TI_EQEP_SYNAPSE_ACTION_RISING_EDGE , TI_EQEP_SYNAPSE_ACTION_NONE , } cocci_id@p ;
...
position p;
@@
 enum { TI_EQEP_COUNT_FUNC_QUAD_COUNT , TI_EQEP_COUNT_FUNC_DIR_COUNT , TI_EQEP_COUNT_FUNC_UP_COUNT , TI_EQEP_COUNT_FUNC_DOWN_COUNT , } cocci_id@p ;
