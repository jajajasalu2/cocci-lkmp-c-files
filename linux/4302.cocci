...
position p;
@@
 struct topstar_laptop * cocci_id@p ;
...
position p;
@@
 struct topstar_laptop {  struct acpi_device * device ;  struct platform_device * platform ;  struct input_dev * input ;  struct led_classdev led ; } cocci_id@p ;
