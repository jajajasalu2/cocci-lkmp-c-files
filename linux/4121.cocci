...
typedef u32;
@@
 struct phy_gmii_sel_phy_priv {  struct phy_gmii_sel_priv * priv ;  u32 id ;  struct phy * if_phy ;  int rmii_clock_external ;  int phy_if_mode ;  struct regmap_field * fields [ PHY_GMII_SEL_LAST ] ; } cocci_id@p ;
...
position p;
@@
 const struct phy_gmii_sel_soc_data cocci_id@p ;
...
position p;
@@
 struct phy_gmii_sel_priv {  struct device * dev ;  const struct phy_gmii_sel_soc_data * soc_data ;  struct regmap * regmap ;  struct phy_provider * phy_provider ;  struct phy_gmii_sel_phy_priv * if_phys ; } cocci_id@p ;
...
position p;
@@
 struct phy_gmii_sel_priv * cocci_id@p ;
...
typedef u32;
@@
 struct phy_gmii_sel_soc_data {  u32 num_ports ;  u32 features ;  const struct reg_field * regfields [ PHY_GMII_SEL_LAST ] ; } cocci_id@p ;
...
position p;
@@
 struct phy_gmii_sel_phy_priv * cocci_id@p ;
...
position p;
@@
 const struct reg_field cocci_id@p [ ] [ PHY_GMII_SEL_LAST ] ;
...
position p;
@@
 enum { PHY_GMII_SEL_PORT_MODE , PHY_GMII_SEL_RGMII_ID_MODE , PHY_GMII_SEL_RMII_IO_CLK_EN , PHY_GMII_SEL_LAST , } cocci_id@p ;
