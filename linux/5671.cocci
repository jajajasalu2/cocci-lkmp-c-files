...
typedef u8,u32;
@@
 const struct rv3029_trickle_tab_elem {  u32 r ;  u8 conf ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ RV3029_WATCH_SECTION_LEN ] ;
...
position p;
@@
 struct rv3029_data {  struct device * dev ;  struct rtc_device * rtc ;  struct regmap * regmap ;  int irq ; } cocci_id@p ;
...
position p;
@@
 struct rtc_class_ops cocci_id@p ;
...
position p;
@@
 const struct rv3029_trickle_tab_elem * cocci_id@p ;
