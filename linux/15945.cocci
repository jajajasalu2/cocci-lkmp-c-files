...
position p;
@@
 struct uwb_rc_evt_cmd_frame_rcv cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_beacon_size cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_set_daa_energy_mask cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_dev_addr_conflict cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_bp_slot_change cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_dev_addr_mgmt cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_set_drp_ie cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_bpoie_change cocci_id@p ;
...
position p;
@@
 struct uwb_est_entry cocci_id@p [ ] ;
...
position p;
@@
 struct uwb_rc_evt_confirm cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_daa_energy_detected cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_bp_switch_status cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_get_ie cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_ie_rcv cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_channel_change_ie_rcv cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_bp_switch_ie_rcv cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_set_notification_filter_ex cocci_id@p ;
...
position p;
@@
 const struct uwb_est_entry * cocci_id@p ;
...
position p;
@@
 struct uwb_rc_evt_set_ie cocci_id@p ;
