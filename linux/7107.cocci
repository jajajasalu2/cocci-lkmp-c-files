...
@@
 struct ioa_registers {  int32_t unused1 [ 12 ] ;  uint32_t io_command ;  uint32_t io_status ;  uint32_t io_control ;  int32_t unused2 [ 1 ] ;  uint32_t io_err_resp ;  uint32_t io_err_info ;  uint32_t io_err_req ;  uint32_t io_err_resp_hi ;  uint32_t io_tlb_entry_m ;  uint32_t io_tlb_entry_l ;  uint32_t unused3 [ 1 ] ;  uint32_t io_pdir_base ;  uint32_t io_io_low_hv ;  uint32_t io_io_high_hv ;  uint32_t unused4 [ 1 ] ;  uint32_t io_chain_id_mask ;  uint32_t unused5 [ 2 ] ;  uint32_t io_io_low ;  uint32_t io_io_high ; } cocci_id@p ;
...
position p;
@@
 struct pci_hba_data * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct parisc_device * dev ) ;
