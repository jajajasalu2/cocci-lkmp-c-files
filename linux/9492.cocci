...
position p;
@@
 struct fast_ant_training * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef phy_sts_cck_8192s_t;
@@
 struct phy_sts_cck_8192s_t * cocci_id@p ;
...
position p;
@@
 struct rx_fwinfo_88e * cocci_id@p ;
...
position p;
@@
 struct phy_status_rpt * cocci_id@p ;
