...
position p;
@@
 struct vfio_platform_device * cocci_id@p ;
...
position p;
@@
 struct vfio_platform_region cocci_id@p ;
...
position p;
@@
 struct vfio_platform_reset_node * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef vfio_platform_reset_fn_t;
@@
 vfio_platform_reset_fn_t cocci_id@p ;
