...
position p;
@@
 const struct usb_role_switch_desc * cocci_id@p ;
...
position p;
@@
 struct usb_role_switch * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,usb_role_switch_get_t,usb_role_switch_set_t;
@@
 struct usb_role_switch {  struct device dev ;  struct mutex lock ;  enum usb_role role ;  struct device * usb2_port ;  struct device * usb3_port ;  struct device * udc ;  usb_role_switch_set_t set ;  usb_role_switch_get_t get ;  bool allow_userspace_control ; } cocci_id@p ;
