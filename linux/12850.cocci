...
position p;
@@
 void ( * cocci_id@p ) ( struct amba_device * adev , struct device_node * nand_node ) ;
...
position p;
@@
 struct pl353_smc_data {  struct clk * memclk ;  struct clk * aclk ; } cocci_id@p ;
...
position p;
@@
 enum pl353_smc_ecc_mode cocci_id@p ;
...
position p;
@@
 struct pl353_smc_data * cocci_id@p ;
