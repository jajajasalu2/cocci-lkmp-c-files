...
position p;
@@
 const struct parisc_device * cocci_id@p ;
...
position p;
@@
 struct parisc_driver * cocci_id@p ;
...
position p;
@@
 struct match_count {  struct parisc_driver * driver ;  int count ; } cocci_id@p ;
...
position p;
@@
 struct parse_tree_data cocci_id@p ;
...
position p;
@@
 struct find_data {  unsigned long hpa ;  struct parisc_device * dev ; } cocci_id@p ;
...
position p;
@@
 struct recurse_struct cocci_id@p ;
...
position p;
@@
 struct device * cocci_id@p ( struct device * parent , int index , struct hardware_path * modpath ) ;
...
position p;
@@
 struct match_id_data {  char id ;  struct parisc_device * dev ; } cocci_id@p ;
...
position p;
@@
 struct parisc_device * cocci_id@p ;
...
position p;
@@
 struct match_id_data cocci_id@p ;
...
position p;
@@
 struct parse_tree_data {  int index ;  struct hardware_path * modpath ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct recurse_struct {  void * obj ;  int ( * fn ) ( struct device * , void * ) ; } cocci_id@p ;
...
position p;
@@
 const struct parisc_device_id * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long io_io_low , unsigned long io_io_high , struct device * parent ) ;
