...
position p;
@@
 struct exynos_pmu_context {  struct device * dev ;  const struct exynos_pmu_data * pmu_data ; } cocci_id@p ;
...
position p;
@@
 const struct exynos_pmu_data * cocci_id@p ;
...
position p;
@@
 struct exynos_pmu_context * cocci_id@p ;
