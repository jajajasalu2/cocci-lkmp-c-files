...
position p;
@@
 struct arc_ps2_data {  struct arc_ps2_port port [ ARC_PS2_PORTS ] ;  void __iomem * addr ;  unsigned int frame_error ;  unsigned int buf_overflow ;  unsigned int total_int ; } cocci_id@p ;
...
position p;
@@
 struct arc_ps2_data * cocci_id@p ;
...
position p;
@@
 struct arc_ps2_port {  void __iomem * data_addr ;  void __iomem * status_addr ;  struct serio * io ; } cocci_id@p ;
...
position p;
@@
 struct arc_ps2_port * cocci_id@p ;
