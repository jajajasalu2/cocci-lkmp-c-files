...
position p;
@@
 struct arizona_haptics * cocci_id@p ;
...
typedef u8;
@@
 struct arizona_haptics {  struct arizona * arizona ;  struct input_dev * input_dev ;  struct work_struct work ;  struct mutex mutex ;  u8 intensity ; } cocci_id@p ;
