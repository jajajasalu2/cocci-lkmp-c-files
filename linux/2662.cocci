...
typedef u8,bool,u32;
@@
 struct xlp9xx_i2c_dev {  struct device * dev ;  struct i2c_adapter adapter ;  struct completion msg_complete ;  struct i2c_smbus_alert_setup alert_data ;  struct i2c_client * ara ;  int irq ;  bool msg_read ;  bool len_recv ;  bool client_pec ;  u32 __iomem * base ;  u32 msg_buf_remaining ;  u32 msg_len ;  u32 ip_clk_hz ;  u32 clk_hz ;  u32 msg_err ;  u8 * msg_buf ; } cocci_id@p ;
...
position p;
@@
 struct xlp9xx_i2c_dev * cocci_id@p ;
