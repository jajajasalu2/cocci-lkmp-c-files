...
position p;
@@
 struct s3c24xx_dclk_drv_data * cocci_id@p ;
...
position p;
@@
 struct s3c24xx_dclk_drv_data {  const char * * clkout0_parent_names ;  int clkout0_num_parents ;  const char * * clkout1_parent_names ;  int clkout1_num_parents ;  const char * * mux_parent_names ;  int mux_num_parents ; } cocci_id@p ;
...
position p;
@@
 struct s3c24xx_clkout * cocci_id@p ;
...
position p;
@@
 enum supported_socs { S3C2410 , S3C2412 , S3C2440 , S3C2443 , } cocci_id@p ;
...
position p;
@@
 struct s3c24xx_dclk * cocci_id@p ;
...
typedef u8,u32;
@@
 struct s3c24xx_clkout {  struct clk_hw hw ;  u32 mask ;  u8 shift ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct s3c24xx_dclk {  struct device * dev ;  void __iomem * base ;  struct notifier_block dclk0_div_change_nb ;  struct notifier_block dclk1_div_change_nb ;  spinlock_t dclk_lock ;  unsigned long reg_save ;  struct clk_hw_onecell_data clk_data ; } cocci_id@p ;
