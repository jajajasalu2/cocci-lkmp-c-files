...
position p;
@@
 enum webcams { Generic800 , SpaceCam , SpaceCam2 , Cvideopro , Dlink350c , DS3303u , Kr651us , Kritter , Mustek300 , Proscope , Twinkle , DvcV6 , P35u , Generic802 , NWEBCAMS , } cocci_id@p ;
...
position p;
@@
 enum bridges { BRIDGE_NW800 , BRIDGE_NW801 , BRIDGE_NW802 , } cocci_id@p ;
