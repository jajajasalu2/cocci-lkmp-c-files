...
typedef u8,bool,u16;
@@
 struct ov9740_priv {  struct v4l2_subdev subdev ;  struct v4l2_ctrl_handler hdl ;  struct v4l2_clk * clk ;  u16 model ;  u8 revision ;  u8 manid ;  u8 smiaver ;  bool flag_vflip ;  bool flag_hflip ;  struct v4l2_mbus_framefmt current_mf ;  bool current_enable ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct ov9740_reg {  u16 reg ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 const struct ov9740_reg cocci_id@p [ ] ;
