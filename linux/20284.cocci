...
position p;
@@
 unsigned long cocci_id@p ( unsigned long nr , struct pcb_struct * pcb_va , struct pcb_struct * pcb_pa , unsigned long * vptb ) ;
...
position p;
@@
 struct pcb_struct cocci_id@p [ 1 ] ;
...
position p;
@@
 void cocci_id@p ( unsigned long new_stack ) ;
