...
typedef u8,u32,u16;
@@
 struct nft_ct_expect_obj {  u16 l3num ;  __be16 dport ;  u8 l4proto ;  u8 size ;  u32 timeout ; } cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_CT_MAX + 1 ] ;
...
position p;
@@
 struct nf_ct_timeout cocci_id@p ;
...
position p;
@@
 struct nft_ct_timeout_obj cocci_id@p ;
...
typedef u8;
@@
 struct nft_ct_timeout_obj {  struct nf_ct_timeout * timeout ;  u8 l4proto ; } cocci_id@p ;
...
position p;
@@
 const struct nft_ct_timeout_obj * cocci_id@p ;
...
position p;
@@
 const struct nf_conn_acct * cocci_id@p ;
...
position p;
@@
 struct nft_ct_expect_obj * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_CT_HELPER_MAX + 1 ] ;
...
position p;
@@
 const struct nft_ct_expect_obj * cocci_id@p ;
...
position p;
@@
 struct nft_ct_helper_obj cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_CT_EXPECT_MAX + 1 ] ;
...
position p;
@@
 const struct nf_conn_counter * cocci_id@p ;
...
position p;
@@
 const struct nft_ct * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_CT_TIMEOUT_MAX + 1 ] ;
...
position p;
@@
 const struct nft_pktinfo * cocci_id@p ;
...
typedef u8;
@@
 struct nft_ct_helper_obj {  struct nf_conntrack_helper * helper4 ;  struct nf_conntrack_helper * helper6 ;  u8 l4proto ; } cocci_id@p ;
...
position p;
@@
 struct nft_ct {  enum nft_ct_keys key : 8 ;  enum ip_conntrack_dir dir : 8 ;  union {  enum nft_registers dreg : 8 ;  enum nft_registers sreg : 8 ; } ; } cocci_id@p ;
...
position p;
@@
 const struct nft_ct_helper_obj * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NF_CT_HELPER_NAME_LEN ] ;
...
position p;
@@
 const struct nf_ct_timeout * cocci_id@p ;
