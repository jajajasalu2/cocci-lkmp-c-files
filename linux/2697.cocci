...
position p;
@@
 struct pxa_reg_layout cocci_id@p [ ] ;
...
typedef u32;
@@
 struct bits {  u32 mask ;  const char * set ;  const char * unset ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pxa_i2c * i2c , int ret ) ;
...
typedef u32;
@@
 struct pxa_reg_layout {  u32 ibmr ;  u32 idbr ;  u32 icr ;  u32 isr ;  u32 isar ;  u32 ilcr ;  u32 iwcr ;  u32 fm ;  u32 hs ; } cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int this_irq , void * dev_id ) ;
...
position p;
@@
 enum pxa_i2c_types { REGS_PXA2XX , REGS_PXA3XX , REGS_CE4100 , REGS_PXA910 , REGS_A3700 , } cocci_id@p ;
