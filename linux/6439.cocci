...
position p;
@@
 struct lp87565_regulator {  struct regulator_desc desc ;  unsigned int ctrl2_reg ; } cocci_id@p ;
...
position p;
@@
 const struct lp87565_regulator cocci_id@p [ ] ;
