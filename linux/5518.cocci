...
position p;
@@
 struct stm32_rtc_registers cocci_id@p ;
...
typedef u32;
@@
 struct stm32_rtc_events {  u32 alra ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_rtc_events * cocci_id@p ;
...
typedef u16;
@@
 struct stm32_rtc_registers {  u16 tr ;  u16 dr ;  u16 cr ;  u16 isr ;  u16 prer ;  u16 alrmar ;  u16 wpr ;  u16 sr ;  u16 scr ;  u16 verr ; } cocci_id@p ;
...
position p;
@@
 struct stm32_rtc {  struct rtc_device * rtc_dev ;  void __iomem * base ;  struct regmap * dbp ;  unsigned int dbp_reg ;  unsigned int dbp_mask ;  struct clk * pclk ;  struct clk * rtc_ck ;  const struct stm32_rtc_data * data ;  int irq_alarm ;  int wakeirq_alarm ; } cocci_id@p ;
...
position p;
@@
 struct stm32_rtc_data * cocci_id@p ;
...
position p;
@@
 const struct stm32_rtc_data cocci_id@p ;
...
position p;
@@
 const struct stm32_rtc_registers * cocci_id@p ;
