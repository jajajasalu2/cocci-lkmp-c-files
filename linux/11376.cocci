...
typedef u8;
@@
 struct sii8620_mt_msg {  struct list_head node ;  u8 reg [ 4 ] ;  u8 ret ;  sii8620_mt_msg_cb send ;  sii8620_mt_msg_cb recv ;  sii8620_cb continuation ; } cocci_id@p ;
...
position p;
@@
 struct sii8620_mt_msg cocci_id@p ;
...
typedef u8;
@@
 const struct {  unsigned int rate ;  u8 div ;  u8 tp1 ; } cocci_id@p [ ] ;
...
position p;
@@
 struct mhl3_infoframe cocci_id@p ;
...
position p;
@@
 const struct {  int bit ;  void ( * handler ) ( struct sii8620 * ctx ) ; } cocci_id@p [ ] ;
...
position p;
@@
 enum sii8620_mt_state { MT_STATE_READY , MT_STATE_BUSY , MT_STATE_DONE , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ LEN_FAST_INTR_STAT ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ MHL_XDC_SIZE ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ MHL_DCAP_SIZE ] ;
...
position p;
@@
 enum sii8620_mode { CM_DISCONNECTED , CM_DISCOVERY , CM_MHL1 , CM_MHL3 , CM_ECBUS_S , } cocci_id@p ;
...
position p;
@@
 struct mhl3_burst_header * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sii8620 * ctx , struct sii8620_mt_msg * msg ) ;
...
position p;
@@
 struct mhl_burst_bits_per_pixel_fmt * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sii8620 * ctx ) ;
...
position p;
@@
 struct mhl_burst_emsc_support * cocci_id@p ;
...
typedef u8;
@@
 const struct {  int max_clk ;  u8 zone ;  u8 link_rate ;  u8 rrp_decode ; } cocci_id@p [ ] ;
...
position p;
@@
 struct mhl_burst_blk_rcv_buffer_info * cocci_id@p ;
...
position p;
@@
 enum sii8620_sink_type { SINK_NONE , SINK_HDMI , SINK_DVI , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct sii8620 * ctx , int ret ) ;
