...
position p;
@@
 const struct cs_data * cocci_id@p ;
...
position p;
@@
 const struct ebi2_xmem_prop cocci_id@p [ ] ;
...
@@
 struct ebi2_xmem_prop {  const char * prop ;  u32 max ;  bool slowreg ;  u16 shift ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct cs_data {  u32 enable_mask ;  u16 slow_cfg ;  u16 fast_cfg ; } cocci_id@p ;
