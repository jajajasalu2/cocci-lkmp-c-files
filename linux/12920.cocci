...
typedef u32;
@@
 struct rx_buffer_head {  u32 buffer ;  u32 link ;  struct sk_buff * skb ; } cocci_id@p ;
...
position p;
@@
 struct rx_buffer_head cocci_id@p ;
...
position p;
@@
 struct zatm_pool_info cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ZEPROM_SIZE ] ;
