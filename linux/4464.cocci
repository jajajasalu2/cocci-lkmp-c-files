...
position p;
@@
 struct intel_rng_hw * cocci_id@p ;
...
typedef u8;
@@
 struct intel_rng_hw {  struct pci_dev * dev ;  void __iomem * mem ;  u8 bios_cntl_off ;  u8 bios_cntl_val ;  u8 fwh_dec_en1_off ;  u8 fwh_dec_en1_val ; } cocci_id@p ;
