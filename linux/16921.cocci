...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( bl_command ) ] ;
...
position p;
@@
 const struct cyttsp_bus_ops * cocci_id@p ;
...
position p;
@@
 struct cyttsp_xydata cocci_id@p ;
...
position p;
@@
 const struct cyttsp_tch * cocci_id@p ;
