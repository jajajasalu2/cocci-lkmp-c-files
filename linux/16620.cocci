...
typedef u8;
@@
 void cocci_id@p ( struct iucv_path * , u8 * ) ;
...
position p;
@@
 struct netiucv_priv cocci_id@p ;
...
position p;
@@
 struct netiucv_priv {  struct net_device_stats stats ;  unsigned long tbusy ;  fsm_instance * fsm ;  struct iucv_connection * conn ;  struct device * dev ;  int pm_state ; } cocci_id@p ;
...
position p;
@@
 struct iucv_connection * cocci_id@p ;
...
position p;
@@
 enum dev_states { DEV_STATE_STOPPED , DEV_STATE_STARTWAIT , DEV_STATE_STOPWAIT , DEV_STATE_RUNNING , NR_DEV_STATES , } cocci_id@p ;
...
position p;
@@
 enum conn_states { CONN_STATE_INVALID , CONN_STATE_STOPPED , CONN_STATE_STARTWAIT , CONN_STATE_SETUPWAIT , CONN_STATE_IDLE , CONN_STATE_TX , CONN_STATE_REGERR , CONN_STATE_CONNERR , NR_CONN_STATES , } cocci_id@p ;
...
position p;
@@
 struct iucv_event {  struct iucv_connection * conn ;  void * data ; } cocci_id@p ;
...
position p;
@@
 struct iucv_handler cocci_id@p ;
...
position p;
@@
 enum dev_events { DEV_EVENT_START , DEV_EVENT_STOP , DEV_EVENT_CONUP , DEV_EVENT_CONDOWN , NR_DEV_EVENTS , } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct iucv_connection {  struct list_head list ;  struct iucv_path * path ;  struct sk_buff * rx_buff ;  struct sk_buff * tx_buff ;  struct sk_buff_head collect_queue ;  struct sk_buff_head commit_queue ;  spinlock_t collect_lock ;  int collect_len ;  int max_buffsize ;  fsm_timer timer ;  fsm_instance * fsm ;  struct net_device * netdev ;  struct connection_profile prof ;  char userid [ 9 ] ;  char userdata [ 17 ] ; } cocci_id@p ;
...
position p;
@@
 struct iucv_message cocci_id@p ;
...
typedef u16;
@@
 struct ll_header {  u16 next ; } cocci_id@p ;
...
position p;
@@
 struct connection_profile {  unsigned long maxmulti ;  unsigned long maxcqueue ;  unsigned long doios_single ;  unsigned long doios_multi ;  unsigned long txlen ;  unsigned long tx_time ;  unsigned long send_stamp ;  unsigned long tx_pending ;  unsigned long tx_max_pending ; } cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct iucv_path * , u8 * , u8 * ) ;
...
position p;
@@
 void cocci_id@p ( struct iucv_path * , struct iucv_message * ) ;
...
position p;
@@
 enum conn_events { CONN_EVENT_CONN_REQ , CONN_EVENT_CONN_ACK , CONN_EVENT_CONN_REJ , CONN_EVENT_CONN_SUS , CONN_EVENT_CONN_RES , CONN_EVENT_RX , CONN_EVENT_TXDONE , CONN_EVENT_TIMER , CONN_EVENT_START , CONN_EVENT_STOP , NR_CONN_EVENTS , } cocci_id@p ;
