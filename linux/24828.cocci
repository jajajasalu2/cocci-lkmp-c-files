...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_XFRM_MAX + 1 ] ;
...
typedef u8;
@@
 struct nft_xfrm {  enum nft_xfrm_keys key : 8 ;  enum nft_registers dreg : 8 ;  u8 dir ;  u8 spnum ; } cocci_id@p ;
...
position p;
@@
 const struct xfrm_dst * cocci_id@p ;
...
position p;
@@
 const struct nft_xfrm * cocci_id@p ;
