...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DP_AUX_MAX_PAYLOAD_BYTES ] ;
...
position p;
@@
 struct drm_dp_aux_dev * cocci_id@p ;
...
typedef atomic_t;
@@
 struct drm_dp_aux_dev {  unsigned index ;  struct drm_dp_aux * aux ;  struct device * dev ;  struct kref refcount ;  atomic_t usecount ; } cocci_id@p ;
