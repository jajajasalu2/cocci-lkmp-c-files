...
position p;
@@
 const struct stm32f4_pll_data cocci_id@p [ MAX_PLL_DIV ] ;
...
position p;
@@
 const struct stm32f4_pll_post_div_data * cocci_id@p ;
...
typedef u64;
@@
 const u64 cocci_id@p [ MAX_GATE_MAP ] ;
...
position p;
@@
 const struct stm32f4_clk_data cocci_id@p ;
...
position p;
@@
 const struct stm32f4_pll_data * cocci_id@p ;
...
position p;
@@
 const struct stm32f4_vco_data cocci_id@p [ ] ;
...
position p;
@@
 const struct stm32f4_div_data cocci_id@p [ MAX_PLL_DIV ] ;
...
typedef u8;
@@
 struct stm32f4_gate_data {  u8 offset ;  u8 bit_idx ;  const char * name ;  const char * parent_name ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 struct stm32f4_pll_div cocci_id@p ;
...
typedef u64;
@@
 struct stm32f4_clk_data {  const struct stm32f4_gate_data * gates_data ;  const u64 * gates_map ;  int gates_num ;  const struct stm32f4_pll_data * pll_data ;  const struct stm32_aux_clk * aux_clk ;  int aux_clk_num ;  int end_primary ; } cocci_id@p ;
...
position p;
@@
 struct stm32f4_pll_div {  struct clk_divider div ;  struct clk_hw * hw_pll ; } cocci_id@p ;
...
position p;
@@
 const struct stm32f4_pll_post_div_data cocci_id@p [ MAX_POST_DIV ] ;
...
typedef u8;
@@
 struct stm32_rgate {  struct clk_gate gate ;  u8 bit_rdy_idx ; } cocci_id@p ;
...
@@
 struct stm32f4_pll {  spinlock_t * lock ;  struct clk_gate gate ;  u8 offset ;  u8 bit_rdy_idx ;  u8 status ;  u8 n_start ; } cocci_id@p ;
...
typedef u8;
@@
 struct clk_apb_mul {  struct clk_hw hw ;  u8 bit_idx ; } cocci_id@p ;
...
position p;
@@
 enum { PLL , PLL_I2S , PLL_SAI , } cocci_id@p ;
...
typedef u8;
@@
 struct stm32_aux_clk {  int idx ;  const char * name ;  const char * const * parent_names ;  int num_parents ;  int offset_mux ;  u8 shift ;  u8 mask ;  int offset_gate ;  u8 bit_idx ;  unsigned long flags ; } cocci_id@p ;
...
position p;
@@
 const struct stm32f4_gate_data * cocci_id@p ;
...
typedef u8;
@@
 struct stm32f4_div_data {  u8 shift ;  u8 width ;  u8 flag_div ;  const struct clk_div_table * div_table ; } cocci_id@p ;
...
typedef u8;
@@
 struct stm32f4_pll_data {  u8 pll_num ;  u8 n_start ;  const char * div_name [ MAX_PLL_DIV ] ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_aux_clk cocci_id@p [ ] ;
...
typedef u8;
@@
 struct stm32f4_pll_post_div_data {  int idx ;  u8 pll_num ;  const char * name ;  const char * parent ;  u8 flag ;  u8 offset ;  u8 shift ;  u8 width ;  u8 flag_div ;  const struct clk_div_table * div_table ; } cocci_id@p ;
...
typedef u8;
@@
 struct stm32f4_vco_data {  const char * vco_name ;  u8 offset ;  u8 bit_idx ;  u8 bit_rdy_idx ; } cocci_id@p ;
