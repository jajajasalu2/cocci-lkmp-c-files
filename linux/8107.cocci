...
position p;
@@
 struct mcba_usb_msg_change_bitrate cocci_id@p ;
...
typedef u8;
@@
 struct __packed mcba_usb_msg_ka_can {  u8 cmd_id ;  u8 tx_err_cnt ;  u8 rx_err_cnt ;  u8 rx_buff_ovfl ;  u8 tx_bus_off ;  __be16 can_bitrate ;  __le16 rx_lost ;  u8 can_stat ;  u8 soft_ver_major ;  u8 soft_ver_minor ;  u8 debug_mode ;  u8 test_complete ;  u8 test_result ;  u8 unused [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct mcba_usb_msg_ka_usb * cocci_id@p ;
...
typedef u8;
@@
 struct __packed mcba_usb_msg_termination {  u8 cmd_id ;  u8 termination ;  u8 unused [ 17 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct __packed mcba_usb_msg_ka_usb {  u8 cmd_id ;  u8 termination_state ;  u8 soft_ver_major ;  u8 soft_ver_minor ;  u8 unused [ 15 ] ; } cocci_id@p ;
...
position p;
@@
 struct mcba_usb_msg cocci_id@p ;
...
typedef u8;
@@
 struct __packed mcba_usb_msg_can {  u8 cmd_id ;  __be16 eid ;  __be16 sid ;  u8 dlc ;  u8 data [ 8 ] ;  u8 timestamp [ 4 ] ;  u8 checksum ; } cocci_id@p ;
...
position p;
@@
 struct mcba_usb_ctx * cocci_id@p ;
...
typedef u8;
@@
 struct __packed mcba_usb_msg {  u8 cmd_id ;  u8 unused [ 18 ] ; } cocci_id@p ;
...
position p;
@@
 struct mcba_usb_msg_fw_ver cocci_id@p ;
...
position p;
@@
 struct mcba_usb_msg_can cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct mcba_usb_ctx {  struct mcba_priv * priv ;  u32 ndx ;  u8 dlc ;  bool can ; } cocci_id@p ;
...
position p;
@@
 struct mcba_usb_msg_termination cocci_id@p ;
...
@@
 struct mcba_priv {  struct can_priv can ;  struct sk_buff * echo_skb [ MCBA_MAX_TX_URBS ] ;  struct mcba_usb_ctx tx_context [ MCBA_MAX_TX_URBS ] ;  struct usb_device * udev ;  struct net_device * netdev ;  struct usb_anchor tx_submitted ;  struct usb_anchor rx_submitted ;  struct can_berr_counter bec ;  bool usb_ka_first_pass ;  bool can_ka_first_pass ;  bool can_speed_check ;  atomic_t free_ctx_cnt ; } cocci_id@p ;
...
position p;
@@
 struct mcba_usb_msg_ka_can * cocci_id@p ;
...
typedef u8;
@@
 struct __packed mcba_usb_msg_change_bitrate {  u8 cmd_id ;  __be16 bitrate ;  u8 unused [ 16 ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct __packed mcba_usb_msg_fw_ver {  u8 cmd_id ;  u8 pic ;  u8 unused [ 17 ] ; } cocci_id@p ;
