...
position p;
@@
 struct dmar_res_callback * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ BITS_TO_LONGS ( DMAR_UNITS_SUPPORTED ) ] ;
...
position p;
@@
 struct acpi_dmar_andd * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,dmar_res_handler_t;
@@
 struct dmar_res_callback {  dmar_res_handler_t cb [ ACPI_DMAR_TYPE_RESERVED ] ;  void * arg [ ACPI_DMAR_TYPE_RESERVED ] ;  bool ignore_unhandled ;  bool print_entry ; } cocci_id@p ;
...
position p;
@@
 struct dmar_dev_scope cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dmar_drhd_unit * drhd ) ;
...
position p;
@@
 struct acpi_dmar_rhsa * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dmar_res_handler_t;
@@
 dmar_res_handler_t cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct acpi_dmar_header * , void * ) ;
...
position p;
@@
 enum faulttype { DMA_REMAP , INTR_REMAP , UNKNOWN , } cocci_id@p ;
