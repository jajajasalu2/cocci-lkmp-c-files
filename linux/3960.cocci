...
typedef bool;
@@
 struct syscfg_reset_controller {  struct reset_controller_dev rst ;  bool active_low ;  struct syscfg_reset_channel * channels ; } cocci_id@p ;
...
position p;
@@
 struct syscfg_reset_controller cocci_id@p ;
...
position p;
@@
 struct syscfg_reset_channel {  struct regmap_field * reset ;  struct regmap_field * ack ; } cocci_id@p ;
...
position p;
@@
 const struct syscfg_reset_controller_data * cocci_id@p ;
...
position p;
@@
 const struct syscfg_reset_channel * cocci_id@p ;
