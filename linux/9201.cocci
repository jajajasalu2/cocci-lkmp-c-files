...
position p;
@@
 const struct dpaa2_eth_priv * cocci_id@p ;
...
position p;
@@
 struct dpaa2_eth_fq * * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ DPAA2_ETH_BUFS_PER_CMD ] ;
...
position p;
@@
 struct dpni_pools_cfg cocci_id@p ;
...
position p;
@@
 enum dpaa2_eth_rx_dist cocci_id@p ;
...
position p;
@@
 struct dpkg_profile_cfg cocci_id@p ;
...
position p;
@@
 struct dpaa2_eth_cls_rule cocci_id@p ;
...
position p;
@@
 struct dpaa2_eth_channel * cocci_id@p ;
...
position p;
@@
 struct dpcon_notification_cfg cocci_id@p ;
...
position p;
@@
 struct dpaa2_eth_drv_stats * cocci_id@p ;
...
position p;
@@
 struct dpni_rx_dist_cfg cocci_id@p ;
...
position p;
@@
 const struct dpaa2_eth_dist_fields cocci_id@p [ ] ;
...
position p;
@@
 struct dpaa2_eth_swa * cocci_id@p ;
...
position p;
@@
 struct dpkg_extract * cocci_id@p ;
...
position p;
@@
 struct dpaa2_eth_priv * cocci_id@p ;
...
position p;
@@
 struct dpni_rx_tc_dist_cfg cocci_id@p ;
