...
typedef dcr_host_t;
@@
 struct ppc4xx_edac_pdata {  dcr_host_t dcr_host ;  struct {  int sec ;  int ded ; } irqs ; } cocci_id@p ;
...
position p;
@@
 const struct ppc4xx_edac_pdata * cocci_id@p ;
...
position p;
@@
 struct ppc4xx_edac_pdata * cocci_id@p ;
...
position p;
@@
 const struct ppc4xx_ecc_status * cocci_id@p ;
...
typedef u32;
@@
 struct ppc4xx_ecc_status {  u32 ecces ;  u32 besr ;  u32 bearh ;  u32 bearl ;  u32 wmirq ; } cocci_id@p ;
...
position p;
@@
 struct ppc4xx_ecc_status * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PPC4XX_EDAC_MESSAGE_SIZE ] ;
