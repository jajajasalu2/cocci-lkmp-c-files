...
position p;
@@
 struct ocfs2_cow_context * cocci_id@p ;
...
position p;
@@
 const struct ocfs2_caching_operations cocci_id@p ;
...
position p;
@@
 const struct ocfs2_refcount_rec * cocci_id@p ;
...
position p;
@@
 struct ocfs2_refcount_list * cocci_id@p ;
...
position p;
@@
 struct ocfs2_refcount_rec * cocci_id@p ;
...
position p;
@@
 enum ocfs2_ref_rec_contig cocci_id@p ;
...
position p;
@@
 enum ocfs2_ref_rec_contig { REF_CONTIG_NONE = 0 , REF_CONTIG_LEFT , REF_CONTIG_RIGHT , REF_CONTIG_LEFTRIGHT , } cocci_id@p ;
