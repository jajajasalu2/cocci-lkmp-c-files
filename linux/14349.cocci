...
typedef u32;
@@
 struct or51132_state {  struct i2c_adapter * i2c ;  const struct or51132_config * config ;  struct dvb_frontend frontend ;  enum fe_modulation current_modulation ;  u32 snr ;  u32 current_frequency ; } cocci_id@p ;
...
position p;
@@
 struct or51132_state cocci_id@p ;
