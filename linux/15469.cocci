...
position p;
@@
 struct ca91cx42_dma_entry cocci_id@p ;
...
position p;
@@
 struct vme_dma_resource cocci_id@p ;
...
position p;
@@
 struct vme_dma_list * cocci_id@p ;
...
position p;
@@
 struct ca91cx42_driver * cocci_id@p ;
...
position p;
@@
 struct vme_dma_attr * cocci_id@p ;
