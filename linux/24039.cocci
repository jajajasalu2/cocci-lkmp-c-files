...
position p;
@@
 const struct ovs_len_tbl cocci_id@p [ OVS_VXLAN_EXT_MAX + 1 ] ;
...
position p;
@@
 struct vxlan_metadata cocci_id@p ;
...
position p;
@@
 struct ovs_key_ipv6 cocci_id@p ;
...
position p;
@@
 struct ovs_tunnel_info * cocci_id@p ;
...
position p;
@@
 struct ovs_action_hash cocci_id@p ;
...
position p;
@@
 struct ovs_key_ethernet cocci_id@p ;
...
position p;
@@
 struct ovs_key_ct_tuple_ipv6 cocci_id@p ;
...
position p;
@@
 struct ovs_nsh_key_md1 cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ OVS_USERSPACE_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ovs_key_sctp cocci_id@p ;
...
position p;
@@
 const struct ovs_key_mpls * cocci_id@p ;
...
position p;
@@
 const struct sw_flow_key * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_icmpv6 * cocci_id@p ;
...
position p;
@@
 const struct ovs_action_hash * cocci_id@p ;
...
position p;
@@
 struct ovs_nsh_key_base cocci_id@p ;
...
position p;
@@
 const struct ovs_len_tbl cocci_id@p [ OVS_KEY_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct ovs_nsh_key_base * cocci_id@p ;
...
position p;
@@
 const struct ovs_action_push_vlan * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ OVS_ACTION_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ovs_key_icmp * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_ct_labels * cocci_id@p ;
...
position p;
@@
 struct ovs_key_icmpv6 * cocci_id@p ;
...
position p;
@@
 struct sw_flow_key_range * cocci_id@p ;
...
position p;
@@
 const struct ovs_action_push_mpls * cocci_id@p ;
...
position p;
@@
 const struct sample_arg * cocci_id@p ;
...
position p;
@@
 struct ovs_action_trunc cocci_id@p ;
...
position p;
@@
 const struct vlan_head * cocci_id@p ;
...
position p;
@@
 const struct check_pkt_len_arg * cocci_id@p ;
...
position p;
@@
 struct ovs_key_mpls cocci_id@p ;
...
position p;
@@
 struct ovs_len_tbl {  int len ;  const struct ovs_len_tbl * next ; } cocci_id@p ;
...
position p;
@@
 const struct ovs_key_ipv6 * cocci_id@p ;
...
position p;
@@
 const struct vxlan_metadata * cocci_id@p ;
...
position p;
@@
 const struct nlattr * cocci_id@p [ OVS_SAMPLE_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nlattr * cocci_id@p [ OVS_KEY_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ OVS_CHECK_PKT_LEN_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct ovs_key_nsh * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_ipv4 * cocci_id@p ;
...
position p;
@@
 struct check_pkt_len_arg cocci_id@p ;
...
position p;
@@
 struct sw_flow_match cocci_id@p ;
...
position p;
@@
 struct erspan_metadata cocci_id@p ;
...
position p;
@@
 struct ovs_action_push_vlan cocci_id@p ;
...
position p;
@@
 const struct ovs_key_ct_tuple_ipv6 * cocci_id@p ;
...
position p;
@@
 struct ovs_action_push_mpls cocci_id@p ;
...
position p;
@@
 struct ovs_action_push_eth cocci_id@p ;
...
typedef bool,u32;
@@
 int cocci_id@p ( struct net * net , const struct nlattr * attr , const struct sw_flow_key * key , struct sw_flow_actions * * sfa , __be16 eth_type , __be16 vlan_tci , u32 mpls_label_count , bool log ) ;
...
position p;
@@
 const struct ovs_key_sctp * cocci_id@p ;
...
position p;
@@
 const struct ovs_len_tbl cocci_id@p [ OVS_TUNNEL_KEY_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct ovs_key_ct_labels cocci_id@p ;
...
position p;
@@
 struct ovs_key_ipv4 cocci_id@p ;
...
position p;
@@
 const struct ovs_len_tbl cocci_id@p [ OVS_NSH_KEY_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct sw_flow_match * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_udp * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_nd * cocci_id@p ;
...
position p;
@@
 const struct ovs_nsh_key_md1 * cocci_id@p ;
...
position p;
@@
 struct ovs_key_ct_tuple_ipv4 cocci_id@p ;
...
position p;
@@
 const struct sw_flow * cocci_id@p ;
...
position p;
@@
 struct sw_flow_actions * * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_arp * cocci_id@p ;
...
position p;
@@
 const struct ovs_len_tbl * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_ethernet * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_tcp * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_ct_tuple_ipv4 * cocci_id@p ;
...
position p;
@@
 const struct ovs_key_icmp * cocci_id@p ;
...
position p;
@@
 struct sw_flow_mask * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ OVS_CHECK_PKT_LEN_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct ovs_action_trunc * cocci_id@p ;
...
position p;
@@
 const struct ip_tunnel_key * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ OVS_USERSPACE_ATTR_MAX + 1 ] ;
