...
typedef __be32;
@@
 struct __packed al_transaction_on_disk {  __be32 magic ;  __be32 tr_number ;  __be32 crc32c ;  __be16 transaction_type ;  __be16 n_updates ;  __be16 context_size ;  __be16 context_start_slot_nr ;  __be32 __reserved [ 4 ] ;  __be16 update_slot_nr [ AL_UPDATES_PER_TRANSACTION ] ;  __be32 update_extent_nr [ AL_UPDATES_PER_TRANSACTION ] ;  __be32 context [ AL_CONTEXT_PER_TRANSACTION ] ; } cocci_id@p ;
...
position p;
@@
 enum update_sync_bits_mode cocci_id@p ;
...
position p;
@@
 enum al_transaction_types { AL_TR_UPDATE = 0 , AL_TR_INITIALIZED = 0xffff , } cocci_id@p ;
...
position p;
@@
 struct al_transaction_on_disk * cocci_id@p ;
