...
position p;
@@
 int ( * cocci_id@p ) ( struct rt2x00_dev * rt2x00dev , struct rt2x00lib_crypto * crypto , struct ieee80211_key_conf * key ) ;
...
position p;
@@
 enum data_queue_qid cocci_id@p ;
