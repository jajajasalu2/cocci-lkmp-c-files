...
typedef xfs_da_args_t;
@@
 int cocci_id@p ( xfs_da_args_t * args , struct xfs_buf * * lbpp , int * indexp , struct xfs_buf * * dbpp , struct xfs_dir3_icleaf_hdr * leafhdr ) ;
...
symbol cocci_id;
position p;
typedef xfs_fileoff_t;
@@
 xfs_fileoff_t cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_leaf_hdr cocci_id@p ;
...
position p;
@@
 struct xfs_dir3_leaf * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xfs_da_args * args , struct xfs_buf * bp , int first , int last ) ;
...
symbol cocci_id;
position p;
typedef xfs_da_state_t;
@@
 xfs_da_state_t * cocci_id@p ;
...
position p;
@@
 struct xfs_dir3_leaf_hdr cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xfs_da_args * args , struct xfs_buf * bp ) ;
...
position p;
@@
 struct xfs_dir2_leaf_tail * cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_data_entry * cocci_id@p ;
...
position p;
@@
 struct xfs_dir3_icfree_hdr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_data_off_t;
@@
 xfs_dir2_data_off_t cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_leaf * cocci_id@p ;
