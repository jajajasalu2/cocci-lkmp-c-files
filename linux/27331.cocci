...
position p;
@@
 struct cifsLockInfo * * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cifs_aio_ctx * ctx ) ;
...
position p;
@@
 int cocci_id@p ( struct cifsFileInfo * cfile ) ;
...
position p;
@@
 struct cifs_fid_locks cocci_id@p ;
...
position p;
@@
 struct lock_to_push cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u16,__u32,__u8,__u64;
@@
 struct lock_to_push {  struct list_head llist ;  __u64 offset ;  __u64 length ;  __u32 pid ;  __u16 netfid ;  __u8 type ; } cocci_id@p ;
...
position p;
@@
 struct cifs_aio_ctx * cocci_id@p ;
...
position p;
@@
 struct cifs_pending_open cocci_id@p ;
...
position p;
@@
 struct cifs_unix_set_info_args cocci_id@p ;
