...
position p;
@@
 struct aspeed_video cocci_id@p ;
...
position p;
@@
 struct aspeed_video_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head link ; } cocci_id@p ;
...
position p;
@@
 struct aspeed_video_buffer * cocci_id@p ;
...
position p;
@@
 enum { VIDEO_MODE_DETECT_DONE , VIDEO_RES_CHANGE , VIDEO_RES_DETECT , VIDEO_STREAMING , VIDEO_FRAME_INPRG , VIDEO_STOPPED , VIDEO_CLOCKS_ON , } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ ASPEED_VIDEO_JPEG_QUANT_SIZE ] ;
...
typedef dma_addr_t;
@@
 struct aspeed_video_addr {  unsigned int size ;  dma_addr_t dma ;  void * virt ; } cocci_id@p ;
...
@@
 struct aspeed_video {  void __iomem * base ;  struct clk * eclk ;  struct clk * vclk ;  struct device * dev ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_device v4l2_dev ;  struct v4l2_pix_format pix_fmt ;  struct v4l2_bt_timings active_timings ;  struct v4l2_bt_timings detected_timings ;  u32 v4l2_input_status ;  struct vb2_queue queue ;  struct video_device vdev ;  struct mutex video_lock ;  wait_queue_head_t wait ;  spinlock_t lock ;  struct delayed_work res_work ;  struct list_head buffers ;  unsigned long flags ;  unsigned int sequence ;  unsigned int max_compressed_size ;  struct aspeed_video_addr srcs [ 2 ] ;  struct aspeed_video_addr jpeg ;  bool yuv420 ;  unsigned int frame_rate ;  unsigned int jpeg_quality ;  unsigned int frame_bottom ;  unsigned int frame_left ;  unsigned int frame_right ;  unsigned int frame_top ; } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ ASPEED_VIDEO_JPEG_NUM_QUALITIES ] [ ASPEED_VIDEO_JPEG_DCT_SIZE ] ;
...
position p;
@@
 struct aspeed_video_addr * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ ASPEED_VIDEO_JPEG_HEADER_SIZE ] ;
