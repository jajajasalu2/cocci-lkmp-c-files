...
position p;
@@
 char cocci_id@p [ WUSB_CKHDID_STRSIZE ] ;
...
position p;
@@
 struct wusb_dn_connect * cocci_id@p ;
...
position p;
@@
 struct wuie_disconnect * cocci_id@p ;
...
position p;
@@
 struct wuie_keep_alive * cocci_id@p ;
...
position p;
@@
 struct wuie_connect_ack * cocci_id@p ;
...
position p;
@@
 struct wuie_host_info * cocci_id@p ;
