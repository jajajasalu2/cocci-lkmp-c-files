...
position p;
@@
 struct netlbl_audit cocci_id@p ;
...
typedef u32;
@@
 struct netlbl_unlhsh_tbl {  struct list_head * tbl ;  u32 size ; } cocci_id@p ;
...
position p;
@@
 const struct netlbl_unlhsh_iface * cocci_id@p ;
...
position p;
@@
 struct netlbl_unlhsh_addr6 * cocci_id@p ;
...
position p;
@@
 struct netlbl_unlhsh_walk_arg * cocci_id@p ;
...
position p;
@@
 struct netlbl_unlhsh_iface cocci_id@p ;
...
typedef u32;
@@
 struct netlbl_unlhsh_addr6 {  u32 secid ;  struct netlbl_af6list list ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct netlbl_unlhsh_addr4 * cocci_id@p ;
...
position p;
@@
 struct netlbl_af6list * cocci_id@p ;
...
position p;
@@
 struct netlbl_af4list * cocci_id@p ;
...
position p;
@@
 const struct netlbl_unlhsh_addr6 * cocci_id@p ;
...
typedef u32;
@@
 struct netlbl_unlhsh_iface {  int ifindex ;  struct list_head addr4_list ;  struct list_head addr6_list ;  u32 valid ;  struct list_head list ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct netlbl_dom_map * cocci_id@p ;
...
position p;
@@
 struct netlbl_unlhsh_tbl * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NLBL_UNLABEL_A_MAX + 1 ] ;
...
typedef u32;
@@
 struct netlbl_unlhsh_walk_arg {  struct netlink_callback * nl_cb ;  struct sk_buff * skb ;  u32 seq ; } cocci_id@p ;
...
position p;
@@
 const struct in_addr * cocci_id@p ;
...
position p;
@@
 const struct netlbl_unlhsh_addr4 * cocci_id@p ;
...
typedef u32;
@@
 struct netlbl_unlhsh_addr4 {  u32 secid ;  struct netlbl_af4list list ;  struct rcu_head rcu ; } cocci_id@p ;
