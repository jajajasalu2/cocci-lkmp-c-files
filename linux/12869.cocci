...
position p;
@@
 const struct i82860_dev_info cocci_id@p [ ] ;
...
position p;
@@
 struct i82860_dev_info {  const char * ctl_name ; } cocci_id@p ;
...
position p;
@@
 enum i82860_chips { I82860 = 0 , } cocci_id@p ;
...
position p;
@@
 struct i82860_error_info * cocci_id@p ;
...
typedef u32,u16;
@@
 struct i82860_error_info {  u16 errsts ;  u32 eap ;  u16 derrsyn ;  u16 errsts2 ; } cocci_id@p ;
