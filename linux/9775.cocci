...
position p;
@@
 struct il_scale_tbl_info cocci_id@p ;
...
position p;
@@
 struct il_rate_scale_data cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct il_lq_sta * lq_sta , u32 * rate_n_flags , int idx ) ;
...
position p;
@@
 void cocci_id@p ( struct il_priv * il , struct sk_buff * skb , struct ieee80211_sta * sta , struct il_lq_sta * lq_sta ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct il_lq_sta * lq_sta , bool force_search ) ;
...
position p;
@@
 const struct il_rate_info cocci_id@p [ RATE_COUNT ] ;
...
position p;
@@
 struct il_traffic_load * cocci_id@p ;
...
position p;
@@
 const struct il_rate_mcs_info cocci_id@p [ RATE_COUNT ] ;
...
typedef u32;
@@
 void cocci_id@p ( struct il_priv * il , struct il_lq_sta * lq_sta , u32 rate_n_flags ) ;
