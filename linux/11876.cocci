...
position p;
@@
 struct gf100_dmaobj * cocci_id@p ;
...
typedef u32;
@@
 struct gf100_dmaobj {  struct nvkm_dmaobj base ;  u32 flags0 ;  u32 flags5 ; } cocci_id@p ;
...
position p;
@@
 union {  struct gf100_dma_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 const struct nvkm_dmaobj_func cocci_id@p ;
