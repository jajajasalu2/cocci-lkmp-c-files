...
position p;
@@
 struct value_name_pair {  int value ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct sa_name_list {  int opcode ;  const struct value_name_pair * arr ;  int arr_sz ; } cocci_id@p ;
...
position p;
@@
 struct sa_name_list cocci_id@p [ ] ;
...
position p;
@@
 const struct value_name_pair * cocci_id@p ;
...
position p;
@@
 struct error_info {  unsigned short code12 ;  unsigned short size ; } cocci_id@p ;
...
position p;
@@
 const struct error_info cocci_id@p [ ] ;
...
position p;
@@
 const struct error_info2 cocci_id@p [ ] ;
