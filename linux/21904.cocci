...
position p;
@@
 struct btree_geo {  int keylen ;  int no_pairs ;  int no_longs ; } cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_KEYLEN ] ;
...
position p;
@@
 void * cocci_id@p ( struct btree_head * head , struct btree_geo * geo , unsigned long * key , int level ) ;
...
symbol cocci_id;
position p;
typedef visitor128_t;
@@
 visitor128_t cocci_id@p ;
