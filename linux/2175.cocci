...
position p;
@@
 enum power_supply_usb_type cocci_id@p [ ] ;
...
position p;
@@
 struct ec_response_charge_port_count cocci_id@p ;
...
position p;
@@
 struct charger_data {  struct device * dev ;  struct cros_ec_dev * ec_dev ;  struct cros_ec_device * ec_device ;  int num_charger_ports ;  int num_usbpd_ports ;  int num_registered_psy ;  struct port_data * ports [ EC_USB_PD_MAX_PORTS ] ;  struct notifier_block notifier ; } cocci_id@p ;
...
position p;
@@
 struct ec_params_usb_pd_power_info cocci_id@p ;
...
position p;
@@
 struct charger_data cocci_id@p ;
...
position p;
@@
 struct ec_response_usb_pd_ports cocci_id@p ;
...
position p;
@@
 struct ec_params_usb_pd_discovery_entry cocci_id@p ;
...
position p;
@@
 struct ec_params_external_power_limit_v1 cocci_id@p ;
...
position p;
@@
 struct ec_response_usb_pd_power_info cocci_id@p ;
...
position p;
@@
 struct ec_params_usb_pd_info_request cocci_id@p ;
