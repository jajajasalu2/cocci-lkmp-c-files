...
position p;
@@
 struct safexcel_ahash_ctx * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SHA3_224_BLOCK_SIZE ] ;
...
position p;
@@
 struct safexcel_ahash_result {  struct completion completion ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct safexcel_command_desc * cocci_id@p ;
...
position p;
@@
 struct safexcel_ahash_export_state cocci_id@p ;
...
position p;
@@
 const struct safexcel_ahash_export_state * cocci_id@p ;
...
position p;
@@
 struct safexcel_alg_template * cocci_id@p ;
...
position p;
@@
 struct safexcel_result_desc * cocci_id@p ;
...
position p;
@@
 struct safexcel_token * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __le32,u8,bool,u32;
@@
 struct safexcel_ahash_ctx {  struct safexcel_context base ;  struct safexcel_crypto_priv * priv ;  u32 alg ;  u8 key_sz ;  bool cbcmac ;  bool do_fallback ;  bool fb_init_done ;  bool fb_do_setkey ;  __le32 ipad [ SHA3_512_BLOCK_SIZE / sizeof ( __le32 ) ] ;  __le32 opad [ SHA3_512_BLOCK_SIZE / sizeof ( __le32 ) ] ;  struct crypto_cipher * kaes ;  struct crypto_ahash * fback ;  struct crypto_shash * shpre ;  struct shash_desc * shdesc ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ 3 * AES_BLOCK_SIZE / sizeof ( u32 ) ] ;
...
position p;
@@
 struct safexcel_ahash_result * cocci_id@p ;
...
position p;
@@
 struct safexcel_ahash_req * cocci_id@p ;
...
position p;
@@
 struct safexcel_crypto_priv * cocci_id@p ;
...
position p;
@@
 struct safexcel_inv_result cocci_id@p ;
