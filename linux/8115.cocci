...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DPRAM_TX_SIZE ] ;
...
position p;
@@
 const struct attribute * const cocci_id@p [ ] ;
...
position p;
@@
 unsigned char cocci_id@p [ sizeof ( stream ) ] ;
...
position p;
@@
 struct softing_priv * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DPRAM_RX_SIZE ] ;
...
position p;
@@
 const struct softing_platform_data * cocci_id@p ;
...
position p;
@@
 const struct can_frame * cocci_id@p ;
