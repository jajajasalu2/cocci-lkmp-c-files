...
position p;
@@
 struct xrep_findroot cocci_id@p ;
...
position p;
@@
 struct xrep_findroot {  struct xfs_scrub * sc ;  struct xfs_buf * agfl_bp ;  struct xfs_agf * agf ;  struct xrep_find_ag_btree * btree_info ; } cocci_id@p ;
