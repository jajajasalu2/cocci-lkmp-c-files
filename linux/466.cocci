...
position p;
@@
 const struct ics_part * cocci_id@p ;
...
position p;
@@
 struct adfs_discrecord * cocci_id@p ;
...
typedef __le32;
@@
 struct eesox_part {  char magic [ 6 ] ;  char name [ 10 ] ;  __le32 start ;  __le32 unused6 ;  __le32 unused7 ;  __le32 unused8 ; } cocci_id@p ;
...
typedef __le32;
@@
 struct ptec_part {  __le32 unused1 ;  __le32 unused2 ;  __le32 start ;  __le32 size ;  __le32 unused5 ;  char type [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct riscix_record * cocci_id@p ;
...
position p;
@@
 const struct ptec_part * cocci_id@p ;
...
typedef __le32;
@@
 struct linux_part {  __le32 magic ;  __le32 start_sect ;  __le32 nr_sects ; } cocci_id@p ;
...
typedef __le32;
@@
 struct ics_part {  __le32 start ;  __le32 size ; } cocci_id@p ;
...
typedef __le32;
@@
 struct riscix_part {  __le32 start ;  __le32 length ;  __le32 one ;  char name [ 16 ] ; } cocci_id@p ;
