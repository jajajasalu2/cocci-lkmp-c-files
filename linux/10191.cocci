...
position p;
@@
 const struct hm_map cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct dchannel * ) ;
...
position p;
@@
 struct dsp_features * cocci_id@p ;
