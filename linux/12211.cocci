...
position p;
@@
 struct etnaviv_dump_object_header * cocci_id@p ;
...
position p;
@@
 struct core_dump_iterator {  void * start ;  struct etnaviv_dump_object_header * hdr ;  void * data ; } cocci_id@p ;
...
position p;
@@
 struct core_dump_iterator * cocci_id@p ;
...
position p;
@@
 struct etnaviv_dump_registers cocci_id@p ;
