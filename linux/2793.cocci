...
@@
 acpi_status cocci_id@p ( u32 * value , struct acpi_generic_address * register_a , struct acpi_generic_address * register_b ) ;
...
typedef u8,u64;
@@
 u8 cocci_id@p ( u64 address , struct acpi_generic_address * reg , u8 max_bit_width ) ;
...
position p;
@@
 struct acpi_bit_register_info * cocci_id@p ;
