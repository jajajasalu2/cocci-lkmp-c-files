...
position p;
@@
 struct exc3000_data * cocci_id@p ;
...
typedef u8;
@@
 struct exc3000_data {  struct i2c_client * client ;  struct input_dev * input ;  struct touchscreen_properties prop ;  struct timer_list timer ;  u8 buf [ 2 * EXC3000_LEN_FRAME ] ; } cocci_id@p ;
