...
position p;
@@
 enum hifmc_iftype { IF_TYPE_STD , IF_TYPE_DUAL , IF_TYPE_DIO , IF_TYPE_QUAD , IF_TYPE_QIO , } cocci_id@p ;
...
typedef u32;
@@
 struct hifmc_priv {  u32 chipselect ;  u32 clkrate ;  struct hifmc_host * host ; } cocci_id@p ;
...
@@
 struct hifmc_host {  struct device * dev ;  struct mutex lock ;  void __iomem * regbase ;  void __iomem * iobase ;  struct clk * clk ;  void * buffer ;  dma_addr_t dma_buffer ;  struct spi_nor * nor [ HIFMC_MAX_CHIP_NUM ] ;  u32 num_chip ; } cocci_id@p ;
