...
typedef bool;
@@
 struct da9052_hwmon {  struct da9052 * da9052 ;  struct mutex hwmon_lock ;  bool tsi_as_adc ;  int tsiref_mv ;  struct regulator * tsiref ;  struct completion tsidone ; } cocci_id@p ;
...
position p;
@@
 struct da9052_hwmon * cocci_id@p ;
