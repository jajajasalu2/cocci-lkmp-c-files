...
position p;
@@
 const struct sock_fprog * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bpf_aux_classic_check_t;
@@
 bpf_aux_classic_check_t cocci_id@p ;
...
position p;
@@
 struct seg6_bpf_srh_state * cocci_id@p ;
...
position p;
@@
 struct bpf_redirect_info * cocci_id@p ;
...
position p;
@@
 struct bpf_skb_data_end cocci_id@p ;
...
position p;
@@
 struct bpf_tcp_sock cocci_id@p ;
...
position p;
@@
 const struct xdp_buff * cocci_id@p ;
...
position p;
@@
 struct sk_reuseport_kern cocci_id@p ;
...
position p;
@@
 const struct sock_filter * cocci_id@p ;
...
position p;
@@
 struct sock_reuseport * cocci_id@p ;
...
position p;
@@
 struct bpf_sock_ops_kern cocci_id@p ;
...
position p;
@@
 struct qdisc_skb_cb cocci_id@p ;
...
position p;
@@
 struct bpf_sock_tuple * cocci_id@p ;
...
position p;
@@
 struct bpf_sock_ops cocci_id@p ;
...
position p;
@@
 struct bpf_xdp_sock cocci_id@p ;
...
position p;
@@
 struct bpf_dtab_netdev * cocci_id@p ;
...
position p;
@@
 const struct bpf_prog_ops cocci_id@p ;
...
position p;
@@
 const struct ipv6_bpf_stub * cocci_id@p ;
...
position p;
@@
 struct bpf_sock_addr cocci_id@p ;
...
position p;
@@
 struct bpf_cpu_map_entry * cocci_id@p ;
...
position p;
@@
 struct minmax_sample cocci_id@p ;
...
position p;
@@
 struct xdp_rxq_info cocci_id@p ;
...
position p;
@@
 struct sk_reuseport_md cocci_id@p ;
...
position p;
@@
 struct bpf_fib_lookup * cocci_id@p ;
...
position p;
@@
 struct fib_nh_common * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct bpf_scratchpad {  union {  __be32 diff [ MAX_BPF_STACK / sizeof ( __be32 ) ] ;  u8 buff [ MAX_BPF_STACK ] ; } ; } cocci_id@p ;
...
position p;
@@
 struct bpf_sock_addr_kern cocci_id@p ;
