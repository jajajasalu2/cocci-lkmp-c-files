...
position p;
@@
 const struct qe_header * cocci_id@p ;
...
position p;
@@
 const struct qe_microcode * cocci_id@p ;
...
position p;
@@
 struct qe_microcode cocci_id@p ;
...
position p;
@@
 const struct qe_firmware * cocci_id@p ;
