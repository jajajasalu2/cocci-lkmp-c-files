...
position p;
@@
 struct dib9000_state cocci_id@p ;
...
typedef u8;
@@
 struct i2c_device {  struct i2c_adapter * i2c_adap ;  u8 i2c_addr ;  u8 * i2c_read_buffer ;  u8 * i2c_write_buffer ; } cocci_id@p ;
...
position p;
@@
 struct dvb_frontend_parametersContext cocci_id@p ;
...
position p;
@@
 struct dibDVBTChannel * cocci_id@p ;
...
position p;
@@
 struct dibGPIOFunction * cocci_id@p ;
...
position p;
@@
 struct dib9000_fe_memory_map * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 int cocci_id@p ( struct dib9000_state * state , u32 address , u16 attribute , const u8 * tx , u32 txlen , u8 * b , u32 len ) ;
...
position p;
@@
 enum dib9000_power_mode { DIB9000_POWER_ALL = 0 , DIB9000_POWER_NO , DIB9000_POWER_INTERF_ANALOG_AGC , DIB9000_POWER_COR4_DINTLV_ICIRM_EQUAL_CFROD , DIB9000_POWER_COR4_CRY_ESRAM_MOUT_NUD , DIB9000_POWER_INTERFACE_ONLY , } cocci_id@p ;
...
typedef s8;
@@
 struct dibDVBTChannel {  s8 spectrum_inversion ;  s8 nfft ;  s8 guard ;  s8 constellation ;  s8 hrch ;  s8 alpha ;  s8 code_rate_hp ;  s8 code_rate_lp ;  s8 select_hp ;  s8 intlv_native ; } cocci_id@p ;
...
position p;
@@
 const struct dib9000_config * cocci_id@p ;
...
position p;
@@
 enum dib9000_power_mode cocci_id@p ;
...
typedef u8,u32,u16;
@@
 int cocci_id@p ( struct dib9000_state * state , u32 address , u16 attribute , const u8 * b , u32 len ) ;
