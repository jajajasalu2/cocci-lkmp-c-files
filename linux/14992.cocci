...
position p;
@@
 struct iproc_arm_pll * cocci_id@p ;
...
position p;
@@
 enum iproc_arm_pll_fid { ARM_PLL_FID_CRYSTAL_CLK = 0 , ARM_PLL_FID_SYS_CLK = 2 , ARM_PLL_FID_CH0_SLOW_CLK = 6 , ARM_PLL_FID_CH1_FAST_CLK = 7 , } cocci_id@p ;
...
position p;
@@
 struct iproc_arm_pll {  struct clk_hw hw ;  void __iomem * base ;  unsigned long rate ; } cocci_id@p ;
