...
typedef s32;
@@
 s32 cocci_id@p ( struct e1000_hw * ) ;
...
position p;
@@
 struct e1000_thermal_sensor_data * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct e1000_hw * ) ;
...
typedef s32,u32,u16;
@@
 s32 cocci_id@p ( struct e1000_hw * , u32 , u16 * ) ;
...
position p;
@@
 void cocci_id@p ( struct e1000_hw * ) ;
...
typedef s32,bool;
@@
 s32 cocci_id@p ( struct e1000_hw * , bool ) ;
...
typedef s32,u16;
@@
 s32 cocci_id@p ( struct e1000_hw * , u16 * , u16 * ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct e1000_hw * , u16 ) ;
...
typedef s32,u16;
@@
 s32 cocci_id@p ( struct e1000_hw * , u16 ) ;
...
position p;
@@
 struct e1000_mac_operations cocci_id@p ;
...
position p;
@@
 struct e1000_nvm_operations cocci_id@p ;
