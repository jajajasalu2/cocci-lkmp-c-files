...
position p;
@@
 struct phm_set_power_state_input * cocci_id@p ;
...
position p;
@@
 const struct smu8_power_state * cocci_id@p ;
...
position p;
@@
 struct SMU8_Fusion_ClkTable * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_CZ_CLOCK_INFO * cocci_id@p ;
...
position p;
@@
 const struct cc6_settings * cocci_id@p ;
...
position p;
@@
 struct pp_clock_info * cocci_id@p ;
...
position p;
@@
 ATOM_CLK_VOLT_CAPABILITY * cocci_id@p ;
...
position p;
@@
 struct smu8_power_state cocci_id@p ;
...
position p;
@@
 struct smu8_sys_info * cocci_id@p ;
