...
position p;
@@
 struct ltc2947_data * cocci_id@p ;
...
position p;
@@
 const struct ltc2947_data * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ LTC2947_ALERTS_SIZE + 1 ] ;
...
typedef bool,u32;
@@
 struct ltc2947_data {  struct regmap * map ;  struct device * dev ;  struct mutex lock ;  u32 lsb_energy ;  bool gpio_out ; } cocci_id@p ;
