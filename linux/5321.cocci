...
position p;
@@
 int ( * cocci_id@p ) ( struct attribute_container * , struct device * ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct attribute_container * , struct device * , struct device * ) ;
...
position p;
@@
 struct internal_container {  struct klist_node node ;  struct attribute_container * cont ;  struct device classdev ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct attribute_container * , struct device * , struct device * ) ;
...
position p;
@@
 struct internal_container cocci_id@p ;
