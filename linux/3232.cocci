...
typedef s16;
@@
 struct coefficients {  s16 m ;  s16 b ;  s16 R ; } cocci_id@p ;
...
position p;
@@
 const struct coefficients cocci_id@p [ ] ;
...
typedef bool;
@@
 struct adm1275_data {  int id ;  bool have_oc_fault ;  bool have_uc_fault ;  bool have_vout ;  bool have_vaux_status ;  bool have_mfr_vaux_status ;  bool have_iout_min ;  bool have_pin_min ;  bool have_pin_max ;  bool have_temp_max ;  bool have_power_sampling ;  struct pmbus_driver_info info ; } cocci_id@p ;
...
position p;
@@
 struct adm1275_data * cocci_id@p ;
...
position p;
@@
 const struct adm1275_data * cocci_id@p ;
...
position p;
@@
 enum chips { adm1075 , adm1272 , adm1275 , adm1276 , adm1278 , adm1293 , adm1294 , } cocci_id@p ;
