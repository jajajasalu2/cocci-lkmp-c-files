...
position p;
@@
 struct table {  struct list_head offsets ;  unsigned offset_max ;  unsigned nentry ;  unsigned * table ;  char * gpu_prefix ; } cocci_id@p ;
...
position p;
@@
 struct offset {  struct list_head list ;  unsigned offset ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct list_head * new , struct list_head * prev , struct list_head * next ) ;
