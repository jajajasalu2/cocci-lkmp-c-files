...
position p;
@@
 const struct opp_table * cocci_id@p ;
...
position p;
@@
 struct {  unsigned long min ;  unsigned long max ; } * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct dev_pm_set_opp_data * data ) ;
