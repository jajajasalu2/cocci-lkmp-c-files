...
position p;
@@
 struct tpm_tis_tcg_phy cocci_id@p ;
...
position p;
@@
 struct pnp_device_id cocci_id@p [ ] ;
...
position p;
@@
 const struct tpm_tis_phy_ops cocci_id@p ;
...
position p;
@@
 struct tpm_tis_tcg_phy {  struct tpm_tis_data priv ;  void __iomem * iobase ; } cocci_id@p ;
...
position p;
@@
 struct tpm_tis_data * cocci_id@p ;
...
position p;
@@
 struct tpm_info {  struct resource res ;  int irq ; } cocci_id@p ;
