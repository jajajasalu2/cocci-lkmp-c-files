...
position p;
@@
 union cvmx_agl_gmx_rxx_adr_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_agl_gmx_txx_clk cocci_id@p ;
...
position p;
@@
 union cvmx_agl_gmx_bist cocci_id@p ;
...
position p;
@@
 union cvmx_agl_prtx_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_mio_ptp_clock_cfg cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_irhwm cocci_id@p ;
...
position p;
@@
 struct octeon_mgmt_cam_state * cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_isr cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_bist cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_orcnt cocci_id@p ;
...
position p;
@@
 union cvmx_agl_gmx_txx_stat1 cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_orhwm cocci_id@p ;
...
position p;
@@
 union cvmx_agl_gmx_prtx_cfg cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_ircnt cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_iring1 cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_oring1 cocci_id@p ;
...
position p;
@@
 union mgmt_port_ring_entry cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_intena cocci_id@p ;
...
typedef u64;
@@
 struct octeon_mgmt_cam_state {  u64 cam [ 6 ] ;  u64 cam_mask ;  int cam_index ; } cocci_id@p ;
...
position p;
@@
 union cvmx_agl_gmx_inf_mode cocci_id@p ;
...
position p;
@@
 union cvmx_agl_gmx_txx_stat0 cocci_id@p ;
...
position p;
@@
 union cvmx_agl_gmx_drv_ctl cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,resource_size_t,spinlock_t,dma_addr_t;
@@
 struct octeon_mgmt {  struct net_device * netdev ;  u64 mix ;  u64 agl ;  u64 agl_prt_ctl ;  int port ;  int irq ;  bool has_rx_tstamp ;  u64 * tx_ring ;  dma_addr_t tx_ring_handle ;  unsigned int tx_next ;  unsigned int tx_next_clean ;  unsigned int tx_current_fill ;  struct sk_buff_head tx_list ;  u64 * rx_ring ;  dma_addr_t rx_ring_handle ;  unsigned int rx_next ;  unsigned int rx_next_fill ;  unsigned int rx_current_fill ;  struct sk_buff_head rx_list ;  spinlock_t lock ;  unsigned int last_duplex ;  unsigned int last_link ;  unsigned int last_speed ;  struct device * dev ;  struct napi_struct napi ;  struct tasklet_struct tx_clean_tasklet ;  struct device_node * phy_np ;  resource_size_t mix_phys ;  resource_size_t mix_size ;  resource_size_t agl_phys ;  resource_size_t agl_size ;  resource_size_t agl_prt_ctl_phys ;  resource_size_t agl_prt_ctl_size ; } cocci_id@p ;
...
position p;
@@
 union cvmx_agl_gmx_rxx_frm_ctl cocci_id@p ;
...
position p;
@@
 union cvmx_mixx_ctl cocci_id@p ;
