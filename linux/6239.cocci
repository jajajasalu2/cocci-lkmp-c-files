...
position p;
@@
 const struct si476x_property_range cocci_id@p [ ] ;
...
typedef bool,u16;
@@
 bool ( * cocci_id@p ) ( struct si476x_core * , u16 ) ;
...
symbol cocci_id;
position p;
typedef valid_property_pred_t;
@@
 const valid_property_pred_t cocci_id@p [ ] ;
