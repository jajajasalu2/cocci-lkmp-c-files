...
position p;
@@
 struct cos_entry_help_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_nig_brb_pfc_port_params cocci_id@p ;
...
position p;
@@
 struct bnx2x_config_dcbx_params * cocci_id@p ;
...
position p;
@@
 struct dcbx_ets_feature * cocci_id@p ;
...
position p;
@@
 struct bnx2x_admin_priority_app_table * cocci_id@p ;
...
position p;
@@
 struct bnx2x_dcbx_pg_params * cocci_id@p ;
...
position p;
@@
 struct bnx2x_dcbx_cos_params * cocci_id@p ;
...
position p;
@@
 struct lldp_remote_mib * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ DCBX_MAX_NUM_PG_BW_ENTRIES ] ;
...
typedef u32;
@@
 void cocci_id@p ( struct bnx2x * bp , struct pg_help_data * help_data , struct dcbx_ets_feature * ets , u32 * pg_pri_orginal_spread ) ;
...
position p;
@@
 struct lldp_local_mib cocci_id@p ;
...
position p;
@@
 struct cos_help_data * cocci_id@p ;
...
position p;
@@
 struct bnx2x_ets_params cocci_id@p ;
...
position p;
@@
 struct dcbx_pfc_feature * cocci_id@p ;
...
position p;
@@
 struct dcbx_features * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bnx2x * bp , struct bnx2x_func_tx_start_params * ) ;
...
position p;
@@
 struct dcbx_app_priority_feature * cocci_id@p ;
...
position p;
@@
 struct pg_entry_help_data * cocci_id@p ;
...
position p;
@@
 struct lldp_admin_mib cocci_id@p ;
...
position p;
@@
 struct priority_cos * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct bnx2x * bp , u32 * set_configuration_ets_pg , u32 * pri_pg_tbl ) ;
...
position p;
@@
 struct dcbx_app_priority_entry * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct bnx2x * bp , u32 * pg_pri_orginal_spread , struct pg_help_data * help_data ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ DCBX_COS_MAX_NUM_E2 ] ;
...
position p;
@@
 struct pg_help_data * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct bnx2x * bp , struct cos_help_data * cos_data , u32 * pg_pri_orginal_spread , struct dcbx_ets_feature * ets ) ;
