...
position p;
@@
 const struct radar_detector_specs cocci_id@p [ ] ;
...
typedef u32;
@@
 struct radar_types {  enum nl80211_dfs_regions region ;  u32 num_radar_types ;  const struct radar_detector_specs * radar_types ; } cocci_id@p ;
...
position p;
@@
 const struct radar_types cocci_id@p ;
...
position p;
@@
 struct pri_sequence * cocci_id@p ;
...
position p;
@@
 struct pri_detector * cocci_id@p ;
...
position p;
@@
 struct dfs_pattern_detector * cocci_id@p ;
...
position p;
@@
 struct ath_dfs_pool_stats cocci_id@p ;
...
position p;
@@
 const struct dfs_pattern_detector cocci_id@p ;
...
position p;
@@
 struct channel_detector * cocci_id@p ;
...
typedef u16;
@@
 struct channel_detector {  struct list_head head ;  u16 freq ;  struct pri_detector * * detectors ; } cocci_id@p ;
