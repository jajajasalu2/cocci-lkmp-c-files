...
position p;
@@
 void cocci_id@p ( struct qib_pportdata * ) ;
...
typedef u8;
@@
 struct vendor_txdds_ent {  u8 oui [ QSFP_VOUI_LEN ] ;  u8 * partnum ;  struct txdds_ent sdr ;  struct txdds_ent ddr ;  struct txdds_ent qdr ; } cocci_id@p ;
...
position p;
@@
 const struct qib_pportdata * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qib_pportdata * ) ;
...
typedef u8,u32;
@@
 u32 cocci_id@p ( struct qib_pportdata * , u32 , u8 , u8 ) ;
...
typedef u32;
@@
 void cocci_id@p ( struct qib_devdata * , u32 , u32 , u32 , struct qib_ctxtdata * rcd ) ;
...
position p;
@@
 struct kparam_string cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qib_pportdata * ppd , int override ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ BIT2BYTE ( LEN_PORT_SEL ) ] ;
...
position p;
@@
 struct qib_irq_notify * cocci_id@p ;
...
position p;
@@
 const struct txdds_ent * * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,u32,wait_queue_head_t;
@@
 struct qib_chippport_specific {  u64 __iomem * kpregbase ;  u64 __iomem * cpregbase ;  u64 * portcntrs ;  struct qib_pportdata * ppd ;  wait_queue_head_t autoneg_wait ;  struct delayed_work autoneg_work ;  struct delayed_work ipg_work ;  struct timer_list chase_timer ;  u64 ibdeltainprog ;  u64 ibsymdelta ;  u64 ibsymsnap ;  u64 iblnkerrdelta ;  u64 iblnkerrsnap ;  u64 iblnkdownsnap ;  u64 iblnkdowndelta ;  u64 ibmalfdelta ;  u64 ibmalfsnap ;  u64 ibcctrl_a ;  u64 ibcctrl_b ;  unsigned long qdr_dfe_time ;  unsigned long chase_end ;  u32 autoneg_tries ;  u32 recovery_init ;  u32 qdr_dfe_on ;  u32 qdr_reforce ;  u8 h1_val ;  u8 no_eep ;  u8 ipg_tries ;  u8 ibmalfusesnap ;  struct qib_qsfp_data qsfp_data ;  char epmsgbuf [ 192 ] ;  char sdmamsgbuf [ 192 ] ; } cocci_id@p ;
...
typedef u16;
@@
 void cocci_id@p ( struct qib_pportdata * ppd , u16 linkcmd , u16 linitcmd ) ;
...
position p;
@@
 const struct dca_reg_map * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct qib_pportdata * , u32 ) ;
...
position p;
@@
 void cocci_id@p ( struct qib_pportdata * , int , unsigned , unsigned ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct qib_pportdata * , int , u32 ) ;
...
position p;
@@
 struct qib_chip_specific * cocci_id@p ;
...
typedef u8;
@@
 struct txdds_ent {  u8 amp ;  u8 pre ;  u8 main ;  u8 post ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( const struct qib_devdata * , const u32 ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ IB_RATE_120_GBPS + 1 ] ;
...
position p;
@@
 struct qib_chippport_specific cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct qib_pportdata * ppd , u32 op ) ;
...
position p;
@@
 const struct qib_devdata * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qib_pportdata * , struct txdds_ent * ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * data ) ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct qib_devdata * , int , int , int , u32 , u32 ) ;
...
position p;
@@
 const struct qib_hwerror_msgs cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct qib_pportdata * , int ) ;
...
position p;
@@
 struct qib_message_header * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qib_devdata * dd , int msixnum ) ;
...
position p;
@@
 int cocci_id@p ( struct qib_pportdata * ppd ) ;
...
position p;
@@
 const struct txdds_ent cocci_id@p [ TXDDS_EXTRA_SZ ] ;
...
position p;
@@
 void cocci_id@p ( struct qib_devdata * dd ) ;
...
position p;
@@
 const struct diag_observer * cocci_id@p ;
...
position p;
@@
 struct qib_msix_entry * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ BIT2BYTE ( LEN_ETM ) ] ;
...
@@
 struct {  const char * name ;  irq_handler_t handler ;  int lsb ;  int port ;  int dca ; } cocci_id@p [ ] ;
...
position p;
@@
 struct qib_qsfp_data * cocci_id@p ;
...
position p;
@@
 struct qib_pportdata * cocci_id@p ;
...
typedef u64,u32;
@@
 void cocci_id@p ( const struct qib_devdata * dd , const u32 regno , u64 value ) ;
...
position p;
@@
 struct qib_ctxtdata * cocci_id@p ;
...
position p;
@@
 const struct vendor_txdds_ent cocci_id@p [ ] ;
...
position p;
@@
 const struct txdds_ent cocci_id@p [ TXDDS_TABLE_SZ ] ;
...
position p;
@@
 const struct txdds_ent cocci_id@p [ TXDDS_MFG_SZ ] ;
...
position p;
@@
 int cocci_id@p ( const char * , const struct kernel_param * ) ;
...
position p;
@@
 struct qib_qsfp_cache * cocci_id@p ;
...
position p;
@@
 struct sdma_set_state_action cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct qib_devdata * ) ;
...
position p;
@@
 struct qib_irq_notify {  int rcv ;  void * arg ;  struct irq_affinity_notify notify ; } cocci_id@p ;
...
typedef u64,u16;
@@
 const struct dca_reg_map {  int shadow_inx ;  int lsb ;  u64 mask ;  u16 regno ; } cocci_id@p [ ] ;
...
position p;
@@
 struct qib_base_info * cocci_id@p ;
