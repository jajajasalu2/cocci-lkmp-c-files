...
position p;
@@
 const struct xc5000_fw_cfg cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct xc5000_priv * priv , u16 reg , u16 * val ) ;
...
position p;
@@
 int cocci_id@p ( struct dvb_frontend * fe , int force ) ;
...
typedef u16;
@@
 struct XC_TV_STANDARD {  char * name ;  u16 audio_mode ;  u16 video_mode ; } cocci_id@p ;
...
typedef u8,u16;
@@
 struct xc5000_fw_cfg {  char * name ;  u16 size ;  u16 pll_reg ;  u8 init_status_supported ;  u8 fw_checksum_supported ; } cocci_id@p ;
