...
symbol cocci_id;
position p;
typedef smsusb_urb_t;
@@
 struct smsusb_urb_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smsusb_device_t;
@@
 struct smsusb_device_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smsusb_device_t,smsusb_urb_t,smscore_device_t;
@@
 struct smsusb_device_t {  struct usb_device * udev ;  struct smscore_device_t * coredev ;  struct smsusb_urb_t surbs [ MAX_URBS ] ;  int response_alignment ;  int buffer_size ;  unsigned char in_ep ;  unsigned char out_ep ;  enum smsusb_state state ; } cocci_id@p ;
...
position p;
@@
 enum smsusb_state { SMSUSB_DISCONNECTED , SMSUSB_SUSPENDED , SMSUSB_ACTIVE , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smsusb_device_t,smscore_buffer_t,smsusb_urb_t;
@@
 struct smsusb_urb_t {  struct list_head entry ;  struct smscore_buffer_t * cb ;  struct smsusb_device_t * dev ;  struct urb urb ;  struct work_struct wq ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef smsusb_device_t,smsusb_urb_t;
@@
 int cocci_id@p ( struct smsusb_device_t * dev , struct smsusb_urb_t * surb ) ;
