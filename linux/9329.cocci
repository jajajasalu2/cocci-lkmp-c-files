...
typedef u32;
@@
 struct wl1251_sdio {  struct sdio_func * func ;  u32 elp_val ; } cocci_id@p ;
...
position p;
@@
 struct wl1251_if_operations cocci_id@p ;
...
position p;
@@
 const struct wl1251_platform_data * cocci_id@p ;
