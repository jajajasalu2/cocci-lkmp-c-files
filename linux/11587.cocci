...
symbol cocci_id;
position p;
typedef pwr_rail_resistor_t;
@@
 struct pwr_rail_resistor_t * cocci_id@p ;
...
position p;
@@
 struct nvkm_iccsense_sensor * cocci_id@p ;
...
position p;
@@
 struct nvkm_iccsense * cocci_id@p ;
...
position p;
@@
 struct nvkm_iccsense_rail * cocci_id@p ;
...
position p;
@@
 struct nvbios_power_budget_entry cocci_id@p ;
...
position p;
@@
 enum nvbios_extdev_type cocci_id@p ;
...
position p;
@@
 struct nvbios_power_budget cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct nvkm_iccsense * , struct nvkm_iccsense_rail * ) ;
...
position p;
@@
 struct nvbios_iccsense cocci_id@p ;
...
position p;
@@
 struct nvbios_extdev_func cocci_id@p ;
