...
position p;
@@
 const struct adp5589_kpad_platform_data * cocci_id@p ;
...
position p;
@@
 struct adp5589_kpad * cocci_id@p ;
...
position p;
@@
 enum { ADP5589 , ADP5585_01 , ADP5585_02 , } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ ADP5589_MAXGPIO ] ;
...
position p;
@@
 const struct adp5589_gpio_platform_data * cocci_id@p ;
...
position p;
@@
 const struct adp_constants cocci_id@p ;
...
typedef u8;
@@
 struct adp_constants {  u8 maxgpio ;  u8 keymapsize ;  u8 gpi_pin_row_base ;  u8 gpi_pin_row_end ;  u8 gpi_pin_col_base ;  u8 gpi_pin_base ;  u8 gpi_pin_end ;  u8 gpimapsize_max ;  u8 max_row_num ;  u8 max_col_num ;  u8 row_mask ;  u8 col_mask ;  u8 col_shift ;  u8 c4_extend_cfg ;  u8 ( * bank ) ( u8 offset ) ;  u8 ( * bit ) ( u8 offset ) ;  u8 ( * reg ) ( u8 reg ) ; } cocci_id@p ;
