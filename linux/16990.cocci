...
position p;
@@
 struct hampshire {  struct input_dev * dev ;  struct serio * serio ;  int idx ;  unsigned char data [ HAMPSHIRE_FORMAT_LENGTH ] ;  char phys [ 32 ] ; } cocci_id@p ;
