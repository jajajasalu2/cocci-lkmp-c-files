...
position p;
@@
 enum ti_ads7950_id { TI_ADS7950 , TI_ADS7951 , TI_ADS7952 , TI_ADS7953 , TI_ADS7954 , TI_ADS7955 , TI_ADS7956 , TI_ADS7957 , TI_ADS7958 , TI_ADS7959 , TI_ADS7960 , TI_ADS7961 , } cocci_id@p ;
...
typedef u16;
@@
 struct ti_ads7950_state {  struct spi_device * spi ;  struct spi_transfer ring_xfer ;  struct spi_transfer scan_single_xfer [ 3 ] ;  struct spi_message ring_msg ;  struct spi_message scan_single_msg ;  struct mutex slock ;  struct gpio_chip chip ;  struct regulator * reg ;  unsigned int vref_mv ;  unsigned int cmd_settings_bitmask ;  unsigned int gpio_cmd_settings_bitmask ;  u16 rx_buf [ TI_ADS7950_MAX_CHAN + 2 + TI_ADS7950_TIMESTAMP_SIZE ] 
							 ____cacheline_aligned ;  u16 tx_buf [ TI_ADS7950_MAX_CHAN + 2 ] ;  u16 single_tx ;  u16 single_rx ; } cocci_id@p ;
...
position p;
@@
 const struct ti_ads7950_chip_info * cocci_id@p ;
...
position p;
@@
 struct ti_ads7950_state * cocci_id@p ;
...
position p;
@@
 struct ti_ads7950_chip_info {  const struct iio_chan_spec * channels ;  unsigned int num_channels ; } cocci_id@p ;
