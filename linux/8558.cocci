...
position p;
@@
 struct hwrm_reject_fwd_resp_input cocci_id@p ;
...
position p;
@@
 struct hwrm_func_buf_rgtr_input cocci_id@p ;
...
position p;
@@
 struct hwrm_fwd_resp_input cocci_id@p ;
...
position p;
@@
 struct hwrm_fwd_async_event_cmpl_input cocci_id@p ;
...
position p;
@@
 struct hwrm_exec_fwd_resp_input cocci_id@p ;
...
position p;
@@
 struct hwrm_func_vf_resc_free_input cocci_id@p ;
...
position p;
@@
 struct hwrm_func_vf_resource_cfg_input cocci_id@p ;
