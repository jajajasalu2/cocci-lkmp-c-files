...
position p;
@@
 struct pinctrl_xway_soc cocci_id@p ;
...
position p;
@@
 const struct ltq_pin_group cocci_id@p [ ] ;
...
position p;
@@
 const struct ltq_pmx_func cocci_id@p [ ] ;
...
position p;
@@
 struct pinctrl_xway_soc {  int pin_count ;  const struct ltq_mfp_pin * mfp ;  const struct ltq_pin_group * grps ;  unsigned int num_grps ;  const struct ltq_pmx_func * funcs ;  unsigned int num_funcs ;  const unsigned * exin ;  unsigned int num_exin ; } cocci_id@p ;
...
position p;
@@
 struct ltq_pinmux_info * cocci_id@p ;
...
position p;
@@
 enum ltq_pinconf_param cocci_id@p ;
...
position p;
@@
 const struct ltq_cfg_param cocci_id@p [ ] ;
...
position p;
@@
 const struct pinctrl_xway_soc * cocci_id@p ;
...
position p;
@@
 const struct ltq_mfp_pin cocci_id@p [ ] ;
