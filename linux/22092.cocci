...
position p;
@@
 const struct trace_print_flags * cocci_id@p ;
...
position p;
@@
 const struct printf_spec cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:255.255.255.255" ) ] ;
...
position p;
@@
 char cocci_id@p [ max ( 2 * RSRC_BUF_SIZE + DECODED_BUF_SIZE , 2 * RSRC_BUF_SIZE + FLAG_BUF_SIZE + RAW_BUF_SIZE ) ] ;
...
@@
 const netdev_features_t * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "255.255.255.255" ) ] ;
...
position p;
@@
 const struct rtc_time * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "xx:xx:xx:xx:xx:xx" ) ] ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "[xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:255.255.255.255]" ) + sizeof ( ":12345" ) + sizeof ( "/123456789" ) + sizeof ( "%1234567890" ) ] ;
...
position p;
@@
 const union {  struct sockaddr raw ;  struct sockaddr_in v4 ;  struct sockaddr_in6 v6 ; } * cocci_id@p ;
