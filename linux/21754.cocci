...
position p;
@@
 struct skcipher_alg * cocci_id@p [ 6 ] ;
...
typedef u8;
@@
 struct s390_des_ctx {  u8 iv [ DES_BLOCK_SIZE ] ;  u8 key [ DES3_KEY_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct s390_des_ctx * cocci_id@p ;
...
position p;
@@
 struct crypto_alg * cocci_id@p [ 2 ] ;
...
typedef u8;
@@
 struct {  u8 iv [ DES_BLOCK_SIZE ] ;  u8 key [ DES3_KEY_SIZE ] ; } cocci_id@p ;
