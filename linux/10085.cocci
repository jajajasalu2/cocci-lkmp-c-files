...
symbol cocci_id;
position p;
typedef vrh_callback_t;
@@
 vrh_callback_t * cocci_id@p ;
...
position p;
@@
 struct virtio_caif_transf_config cocci_id@p ;
...
typedef u32;
@@
 struct cfv_stats {  u32 rx_napi_complete ;  u32 rx_napi_resched ;  u32 rx_nomem ;  u32 rx_kicks ;  u32 tx_full_ring ;  u32 tx_no_mem ;  u32 tx_flow_on ;  u32 tx_kicks ; } cocci_id@p ;
...
typedef u8;
@@
 struct buf_info {  size_t size ;  u8 * vaddr ; } cocci_id@p ;
...
position p;
@@
 struct cfv_napi_context {  struct vringh_kiov riov ;  unsigned short head ; } cocci_id@p ;
...
@@
 struct cfv_info {  struct caif_dev_common cfdev ;  struct virtio_device * vdev ;  struct vringh * vr_rx ;  struct virtqueue * vq_tx ;  struct net_device * ndev ;  unsigned int watermark_tx ;  spinlock_t tx_lock ;  struct tasklet_struct tx_release_tasklet ;  struct napi_struct napi ;  struct cfv_napi_context ctx ;  u16 tx_hr ;  u16 rx_hr ;  u16 tx_tr ;  u16 rx_tr ;  u32 mtu ;  u32 mru ;  size_t allocsz ;  void * alloc_addr ;  dma_addr_t alloc_dma ;  struct gen_pool * genpool ;  unsigned long reserved_mem ;  size_t reserved_size ;  struct cfv_stats stats ;  struct dentry * debugfs ; } cocci_id@p ;
...
position p;
@@
 struct caif_payload_info * cocci_id@p ;
