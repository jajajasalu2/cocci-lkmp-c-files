...
position p;
@@
 enum { CPSW_STATS , CPDMA_RX_STATS , CPDMA_TX_STATS , } cocci_id@p ;
...
position p;
@@
 struct cpsw_hw_stats cocci_id@p ;
...
position p;
@@
 const struct cpsw_stats cocci_id@p [ ] ;
...
position p;
@@
 struct cpsw_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int type ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
