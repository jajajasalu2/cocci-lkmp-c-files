...
position p;
@@
 struct dwc3_request * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dwc3 * dwc ) ;
...
position p;
@@
 const struct dwc3_event_depevt * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct dwc3_ep * dep , bool force , bool interrupt ) ;
...
position p;
@@
 const struct dwc3_event_devt * cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * _dwc ) ;
...
position p;
@@
 enum dwc3_link_state cocci_id@p ;
...
position p;
@@
 const union dwc3_event * cocci_id@p ;
...
position p;
@@
 struct dwc3_gadget_ep_cmd_params * cocci_id@p ;
...
position p;
@@
 struct dwc3_event_buffer * cocci_id@p ;
