...
position p;
@@
 struct keystone_irq_device * cocci_id@p ;
...
@@
 struct keystone_irq_device {  struct device * dev ;  struct irq_chip chip ;  u32 mask ;  int irq ;  struct irq_domain * irqd ;  struct regmap * devctrl_regs ;  u32 devctrl_offset ;  raw_spinlock_t wa_lock ; } cocci_id@p ;
