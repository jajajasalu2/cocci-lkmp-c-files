...
symbol cocci_id;
position p;
typedef dn_fib_idx_t;
@@
 dn_fib_idx_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dn_fib_key_t;
@@
 dn_fib_key_t cocci_id@p ;
...
position p;
@@
 struct dn_hash {  struct dn_zone * dh_zones [ 17 ] ;  struct dn_zone * dh_zone_list ; } cocci_id@p ;
...
position p;
@@
 struct hlist_head cocci_id@p [ DN_FIB_TABLE_HASHSZ ] ;
