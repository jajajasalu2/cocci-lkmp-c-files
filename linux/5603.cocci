...
position p;
@@
 enum rv8803_type { rv_8803 , rx_8900 , } cocci_id@p ;
...
typedef u8;
@@
 struct rv8803_data {  struct i2c_client * client ;  struct rtc_device * rtc ;  struct mutex flags_lock ;  u8 ctrl ;  enum rv8803_type type ; } cocci_id@p ;
