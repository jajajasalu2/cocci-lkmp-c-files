...
position p;
@@
 struct rule_array_block * cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ SECKEYBLOBSIZE ] ;
...
position p;
@@
 struct secaeskeytoken * cocci_id@p ;
...
position p;
@@
 const struct keytoken_header * cocci_id@p ;
...
position p;
@@
 struct cca_info_list_entry * cocci_id@p ;
...
position p;
@@
 struct cipherkeytoken * cocci_id@p ;
...
position p;
@@
 const struct cca_info * cocci_id@p ;
...
typedef u16;
@@
 struct cca_info_list_entry {  struct list_head list ;  u16 cardnr ;  u16 domain ;  struct cca_info info ; } cocci_id@p ;
...
position p;
@@
 struct keytoken_header * cocci_id@p ;
