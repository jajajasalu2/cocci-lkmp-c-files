...
position p;
@@
 enum scx200_acb_state { state_idle , state_address , state_command , state_repeat_start , state_quick , state_read , state_write , } cocci_id@p ;
...
position p;
@@
 struct scx200_acb_iface * cocci_id@p ;
...
typedef u8;
@@
 struct scx200_acb_iface {  struct scx200_acb_iface * next ;  struct i2c_adapter adapter ;  unsigned base ;  struct mutex mutex ;  enum scx200_acb_state state ;  int result ;  u8 address_byte ;  u8 command ;  u8 * ptr ;  char needs_reset ;  unsigned len ; } cocci_id@p ;
