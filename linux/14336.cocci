...
typedef u8,u32;
@@
 struct stb6100_lkup {  u32 val_low ;  u32 val_high ;  u8 reg ; } cocci_id@p ;
...
position p;
@@
 struct stb6100_state * cocci_id@p ;
...
position p;
@@
 const struct stb6100_lkup * cocci_id@p ;
...
typedef u8;
@@
 struct stb6100_regmask {  u8 mask ;  u8 set ; } cocci_id@p ;
...
position p;
@@
 const struct stb6100_regmask cocci_id@p [ ] ;
