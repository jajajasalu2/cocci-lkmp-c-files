...
position p;
@@
 const struct gre_base_hdr * cocci_id@p ;
...
position p;
@@
 struct {  struct icmphdr icmp ;  struct iphdr ip ; } * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sk_buff * skb , unsigned int iphdroff , __sum16 * check , const struct nf_conntrack_tuple * t , enum nf_nat_manip_type maniptype ) ;
...
position p;
@@
 struct {  struct icmp6hdr icmp6 ;  struct ipv6hdr ip6 ; } * cocci_id@p ;
