...
symbol cocci_id;
position p;
typedef bcm_kona_cmd_t;
@@
 enum bcm_kona_cmd_t cocci_id@p ;
...
position p;
@@
 const struct bus_speed_cfg cocci_id@p [ ] ;
...
typedef bcm_kona_cmd_t;
@@
 enum bcm_kona_cmd_t { BCM_CMD_NOACTION = 0 , BCM_CMD_START , BCM_CMD_RESTART , BCM_CMD_STOP , } cocci_id@p ;
...
position p;
@@
 struct bcm_kona_i2c_dev {  struct device * device ;  void __iomem * base ;  int irq ;  struct clk * external_clk ;  struct i2c_adapter adapter ;  struct completion done ;  const struct bus_speed_cfg * std_cfg ;  const struct hs_bus_speed_cfg * hs_cfg ; } cocci_id@p ;
...
position p;
@@
 const struct hs_bus_speed_cfg cocci_id@p [ ] ;
...
position p;
@@
 enum hs_bus_speed_index { BCM_SPD_3P4MHZ = 0 , } cocci_id@p ;
...
typedef uint8_t;
@@
 struct hs_bus_speed_cfg {  uint8_t hs_hold ;  uint8_t hs_high_phase ;  uint8_t hs_setup ;  uint8_t prescale ;  uint8_t time_p ;  uint8_t no_div ;  uint8_t time_div ; } cocci_id@p ;
...
typedef uint8_t;
@@
 struct bus_speed_cfg {  uint8_t time_m ;  uint8_t time_n ;  uint8_t prescale ;  uint8_t time_p ;  uint8_t no_div ;  uint8_t time_div ; } cocci_id@p ;
...
position p;
@@
 enum bus_speed_index { BCM_SPD_100K = 0 , BCM_SPD_400K , BCM_SPD_1MHZ , } cocci_id@p ;
...
position p;
@@
 struct bcm_kona_i2c_dev * cocci_id@p ;
