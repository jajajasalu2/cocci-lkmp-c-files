...
position p;
@@
 struct omap2_onenand {  struct platform_device * pdev ;  int gpmc_cs ;  unsigned long phys_base ;  struct gpio_desc * int_gpiod ;  struct mtd_info mtd ;  struct onenand_chip onenand ;  struct completion irq_done ;  struct completion dma_done ;  struct dma_chan * dma_chan ; } cocci_id@p ;
...
position p;
@@
 struct omap2_onenand * cocci_id@p ;
...
position p;
@@
 struct onenand_chip * cocci_id@p ;
