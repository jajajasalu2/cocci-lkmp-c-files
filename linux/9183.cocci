...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MPRS_LEN ] ;
...
position p;
@@
 const struct mlxsw_sp_nve_config * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_TNPC_LEN ] ;
...
position p;
@@
 const struct mlxsw_sp_nve * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_TNGCR_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_RTDP_LEN ] ;
