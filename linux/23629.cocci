...
position p;
@@
 const  cocci_id@p ( sun50i_codec_out_mixer_pregain_scale , 
								        - 450 , 
								        150 , 0 ) ;
...
position p;
@@
 const  cocci_id@p ( sun50i_codec_mic_gain_scale , 
								        0 , 0 , 
...
position p;
@@
 const  cocci_id@p ( sun50i_codec_lineout_vol_scale , 
								        0 , 1 , 
...
position p;
@@
 const  cocci_id@p ( sun50i_codec_earpiece_vol_scale , 
								        0 , 1 , 
								        TLV_DB_SCALE_ITEM ( TLV_DB_GAIN_MUTE , 0 , 1 ) , 
								        2 , 31 , 
								        TLV_DB_SCALE_ITEM ( - 4350 , 150 , 0 ) ) ;
