...
position p;
@@
 struct bitmap_ipmac * cocci_id@p ;
...
position p;
@@
 const struct bitmap_ipmac * cocci_id@p ;
...
position p;
@@
 const struct bitmap_ipmac_elem * cocci_id@p ;
...
position p;
@@
 struct bitmap_ipmac_elem cocci_id@p ;
...
position p;
@@
 struct bitmap_ipmac_adt_elem cocci_id@p ;
...
position p;
@@
 const struct bitmap_ipmac_adt_elem * cocci_id@p ;
...
position p;
@@
 enum { MAC_UNSET , MAC_FILLED , } cocci_id@p ;
