...
position p;
@@
 struct eeepc_cpufv {  int num ;  int cur ; } cocci_id@p ;
...
position p;
@@
 const struct hotplug_slot_ops cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,acpi_handle,u16;
@@
 struct eeepc_laptop {  acpi_handle handle ;  u32 cm_supported ;  bool cpufv_disabled ;  bool hotplug_disabled ;  u16 event_count [ 128 ] ;  struct platform_device * platform_device ;  struct acpi_device * device ;  struct backlight_device * backlight_device ;  struct input_dev * inputdev ;  struct rfkill * wlan_rfkill ;  struct rfkill * bluetooth_rfkill ;  struct rfkill * wwan3g_rfkill ;  struct rfkill * wimax_rfkill ;  struct hotplug_slot hotplug_slot ;  struct mutex hotplug_lock ;  struct led_classdev tpd_led ;  int tpd_led_wk ;  struct workqueue_struct * led_workqueue ;  struct work_struct tpd_led_work ; } cocci_id@p ;
...
position p;
@@
 struct eeepc_laptop * cocci_id@p ;
...
position p;
@@
 struct hotplug_slot * cocci_id@p ;
