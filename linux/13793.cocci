...
position p;
@@
 struct cx25840_ir_state * cocci_id@p ;
...
position p;
@@
 union cx25840_ir_fifo_rec * cocci_id@p ;
...
typedef u32;
@@
 union cx25840_ir_fifo_rec {  u32 hw_fifo_data ;  struct ir_raw_event ir_core_data ; } cocci_id@p ;
...
position p;
@@
 union cx25840_ir_fifo_rec cocci_id@p [ FIFO_RX_DEPTH ] ;
