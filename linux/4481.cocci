...
position p;
@@
 DSP_HBRIDGE_CONTROL cocci_id@p ;
...
position p;
@@
 DSP_BUSMASTER_CFG_1 cocci_id@p ;
...
position p;
@@
 DSP_3780I_CONFIG_SETTINGS * cocci_id@p ;
...
position p;
@@
 DSP_ISA_SLAVE_CONTROL cocci_id@p ;
...
position p;
@@
 DSP_CLOCK_CONTROL_2 cocci_id@p ;
...
position p;
@@
 DSP_CLOCK_CONTROL_1 cocci_id@p ;
...
position p;
@@
 DSP_BUSMASTER_CFG_2 cocci_id@p ;
...
position p;
@@
 DSP_LBUS_TIMEOUT_DISABLE cocci_id@p ;
