...
position p;
@@
 enum mlxsw_sp1_kvdl_part_id { MLXSW_SP1_KVDL_PART_ID_SINGLE , MLXSW_SP1_KVDL_PART_ID_CHUNKS , MLXSW_SP1_KVDL_PART_ID_LARGE_CHUNKS , } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp1_kvdl_part_info cocci_id@p [ ] ;
...
position p;
@@
 const struct mlxsw_sp_kvdl_ops cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_kvdl * cocci_id@p ;
...
position p;
@@
 enum mlxsw_sp_kvdl_entry_type cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_kvdl_part_info {  unsigned int part_index ;  unsigned int start_index ;  unsigned int end_index ;  unsigned int alloc_size ;  enum mlxsw_sp_resource_id resource_id ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_kvdl_part {  struct mlxsw_sp1_kvdl_part_info info ;  unsigned long usage [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_kvdl {  struct mlxsw_sp1_kvdl_part * parts [ MLXSW_SP1_KVDL_PARTS_INFO_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_kvdl_part * cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp1_kvdl * cocci_id@p ;
