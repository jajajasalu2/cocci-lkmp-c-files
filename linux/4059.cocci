...
position p;
@@
 struct bcm7120_l2_intc_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,__be32;
@@
 struct bcm7120_l2_intc_data {  unsigned int n_words ;  void __iomem * map_base [ MAX_MAPPINGS ] ;  void __iomem * pair_base [ MAX_WORDS ] ;  int en_offset [ MAX_WORDS ] ;  int stat_offset [ MAX_WORDS ] ;  struct irq_domain * domain ;  bool can_wake ;  u32 irq_fwd_mask [ MAX_WORDS ] ;  struct bcm7120_l1_intc_data * l1_data ;  int num_parent_irqs ;  const __be32 * map_mask_prop ; } cocci_id@p ;
...
typedef u32;
@@
 struct bcm7120_l1_intc_data {  struct bcm7120_l2_intc_data * b ;  u32 irq_map_mask [ MAX_WORDS ] ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device_node * , struct bcm7120_l2_intc_data * ) ;
...
position p;
@@
 struct bcm7120_l1_intc_data * cocci_id@p ;
