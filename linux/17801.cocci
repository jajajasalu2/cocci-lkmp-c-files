...
position p;
@@
 struct iosapic_rte_info * cocci_id@p ;
...
position p;
@@
 struct iosapic_intr_info * cocci_id@p ;
...
typedef u32;
@@
 struct iosapic_intr_info {  struct list_head rtes ;  int count ;  u32 low32 ;  unsigned int dest ;  unsigned char dmode : 3 ;  unsigned char polarity : 1 ;  unsigned char trigger : 1 ; } cocci_id@p [ NR_IRQS ] ;
