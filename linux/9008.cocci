...
position p;
@@
 enum res_srq_states cocci_id@p ;
...
position p;
@@
 enum { RES_ANY_BUSY = 1 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_slave_state * cocci_id@p ;
...
position p;
@@
 struct res_counter {  struct res_common com ;  int port ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_cmd_info * cocci_id@p ;
...
position p;
@@
 enum mlx4_qp_optpar cocci_id@p ;
...
position p;
@@
 struct mlx4_cmd_mailbox * cocci_id@p ;
...
typedef u64,u8;
@@
 struct res_gid {  struct list_head list ;  u8 gid [ 16 ] ;  enum mlx4_protocol prot ;  enum mlx4_steer_type steer ;  u64 reg_id ; } cocci_id@p ;
...
position p;
@@
 enum res_eq_states { RES_EQ_BUSY = RES_ANY_BUSY , RES_EQ_RESERVED , RES_EQ_HW , } cocci_id@p ;
...
position p;
@@
 struct mlx4_net_trans_rule_hw_eth cocci_id@p ;
...
position p;
@@
 enum res_xrcdn_states { RES_XRCD_BUSY = RES_ANY_BUSY , RES_XRCD_ALLOCATED , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mlx4_dev * dev , int slave ) ;
...
position p;
@@
 struct resource_allocator * cocci_id@p ;
...
position p;
@@
 struct mlx4_net_trans_rule_hw_ipv4 * cocci_id@p ;
...
position p;
@@
 enum res_mpt_states cocci_id@p ;
...
position p;
@@
 struct mlx4_slaves_pport cocci_id@p ;
...
position p;
@@
 struct mlx4_qp_context * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mlx4_dev * dev , int slave , struct mlx4_qp_context * qpc , struct mlx4_cmd_mailbox * inbox ) ;
...
typedef atomic_t;
@@
 struct res_cq {  struct res_common com ;  struct res_mtt * mtt ;  atomic_t ref_count ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_net_trans_rule_hw_ctrl * cocci_id@p ;
...
position p;
@@
 struct mlx4_eq_context * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mlx4_dev * dev , struct res_fs_rule * fs_rule ) ;
...
position p;
@@
 enum res_mtt_states { RES_MTT_BUSY = RES_ANY_BUSY , RES_MTT_ALLOCATED , } cocci_id@p ;
...
position p;
@@
 enum res_srq_states { RES_SRQ_BUSY = RES_ANY_BUSY , RES_SRQ_ALLOCATED , RES_SRQ_HW , } cocci_id@p ;
...
position p;
@@
 enum res_mpt_states { RES_MPT_BUSY = RES_ANY_BUSY , RES_MPT_RESERVED , RES_MPT_MAPPED , RES_MPT_HW , } cocci_id@p ;
...
position p;
@@
 struct mlx4_net_trans_rule_hw_tcp_udp * cocci_id@p ;
...
position p;
@@
 struct res_eq {  struct res_common com ;  struct res_mtt * mtt ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_counter * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct mlx4_dev * dev , struct mlx4_qp_context * qpc , u8 slave , int port ) ;
...
position p;
@@
 struct mlx4_active_ports cocci_id@p ;
...
position p;
@@
 enum { BUSY_MAX_RETRIES = 10 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_cq_context * cocci_id@p ;
...
position p;
@@
 struct mlx4_mpt_entry * cocci_id@p ;
...
typedef atomic_t;
@@
 struct res_srq {  struct res_common com ;  struct res_mtt * mtt ;  struct res_cq * cq ;  atomic_t ref_count ; } cocci_id@p ;
...
position p;
@@
 enum mlx4_steer_type cocci_id@p ;
...
position p;
@@
 struct mlx4_resource_tracker * cocci_id@p ;
...
position p;
@@
 struct mlx4_vf_immed_vlan_work cocci_id@p ;
...
position p;
@@
 struct mlx4_update_qp_context * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,__be32,atomic_t,spinlock_t;
@@
 struct res_qp {  struct res_common com ;  struct res_mtt * mtt ;  struct res_cq * rcq ;  struct res_cq * scq ;  struct res_srq * srq ;  struct list_head mcg_list ;  spinlock_t mcg_spl ;  int local_qpn ;  atomic_t ref_count ;  u32 qpc_flags ;  u8 sched_queue ;  __be32 param3 ;  u8 vlan_control ;  u8 fvl_rx ;  u8 pri_path_fl ;  u8 vlan_index ;  u8 feup ; } cocci_id@p ;
...
position p;
@@
 enum res_counter_states { RES_COUNTER_BUSY = RES_ANY_BUSY , RES_COUNTER_ALLOCATED , } cocci_id@p ;
...
position p;
@@
 enum qp_transition { QP_TRANS_INIT2RTR , QP_TRANS_RTR2RTS , QP_TRANS_RTS2RTS , QP_TRANS_SQERR2RTS , QP_TRANS_SQD2SQD , QP_TRANS_SQD2RTS , } cocci_id@p ;
...
position p;
@@
 struct mlx4_srq_context * cocci_id@p ;
...
position p;
@@
 enum res_mtt_states cocci_id@p ;
...
typedef u8,u16;
@@
 struct vlan_res {  struct list_head list ;  u16 vlan ;  int ref_count ;  int vlan_index ;  u8 port ; } cocci_id@p ;
...
typedef u64,u8;
@@
 struct mac_res {  struct list_head list ;  u64 mac ;  int ref_count ;  u8 smac_index ;  u8 port ; } cocci_id@p ;
...
position p;
@@
 enum res_fs_rule_states { RES_FS_RULE_BUSY = RES_ANY_BUSY , RES_FS_RULE_ALLOCATED , } cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct mlx4_dev * dev , int slave , int op , int cmd , u64 in_param , u64 * out_param , int port ) ;
...
position p;
@@
 struct res_xrcdn {  struct res_common com ;  int port ; } cocci_id@p ;
...
position p;
@@
 enum res_cq_states { RES_CQ_BUSY = RES_ANY_BUSY , RES_CQ_ALLOCATED , RES_CQ_HW , } cocci_id@p ;
...
typedef u64;
@@
 struct res_common {  struct list_head list ;  struct rb_node node ;  u64 res_id ;  int owner ;  int state ;  int from_state ;  int to_state ;  int removing ;  const char * func_name ; } cocci_id@p ;
...
position p;
@@
 enum res_qp_states { RES_QP_BUSY = RES_ANY_BUSY , RES_QP_RESERVED , RES_QP_MAPPED , RES_QP_HW , } cocci_id@p ;
...
position p;
@@
 struct res_mpt {  struct res_common com ;  struct res_mtt * mtt ;  int key ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_slave_event_eq_info * cocci_id@p ;
...
position p;
@@
 enum mlx4_res_tracker_free_type cocci_id@p ;
...
typedef u64,u32;
@@
 struct res_fs_rule {  struct res_common com ;  int qpn ;  void * mirr_mbox ;  u32 mirr_mbox_size ;  struct list_head mirr_list ;  u64 mirr_rule_id ; } cocci_id@p ;
...
typedef atomic_t;
@@
 struct res_mtt {  struct res_common com ;  int order ;  atomic_t ref_count ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_update_qp_params cocci_id@p ;
...
position p;
@@
 struct mlx4_vport_oper_state * cocci_id@p ;
