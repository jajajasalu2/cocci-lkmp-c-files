...
position p;
@@
 enum { RING_BUFFER_INSTRUCTION , BATCH_BUFFER_INSTRUCTION , BATCH_BUFFER_2ND_LEVEL , } cocci_id@p ;
...
position p;
@@
 const struct sub_op_bits cocci_id@p [ ] ;
...
position p;
@@
 struct intel_vgpu_workload * cocci_id@p ;
...
position p;
@@
 struct cmd_interrupt_event {  int pipe_control_notify ;  int mi_flush_dw ;  int mi_user_interrupt ; } cocci_id@p ;
...
position p;
@@
 const struct cmd_info * cocci_id@p ;
...
position p;
@@
 struct cmd_entry {  struct hlist_node hlist ;  const struct cmd_info * info ; } cocci_id@p ;
...
typedef bool;
@@
 struct parser_exec_state {  struct intel_vgpu * vgpu ;  int ring_id ;  int buf_type ;  int buf_addr_type ;  unsigned long ring_start ;  unsigned long ring_size ;  unsigned long ring_head ;  unsigned long ring_tail ;  unsigned long ip_gma ;  void * ip_va ;  void * rb_va ;  void * ret_bb_va ;  unsigned long ret_ip_gma_ring ;  unsigned long ret_ip_gma_bb ;  int saved_buf_addr_type ;  bool is_ctx_wa ;  const struct cmd_info * info ;  struct intel_vgpu_workload * workload ; } cocci_id@p ;
...
position p;
@@
 struct parser_exec_state cocci_id@p ;
...
position p;
@@
 struct intel_shadow_wa_ctx * cocci_id@p ;
...
position p;
@@
 struct plane_code_mapping cocci_id@p [ ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct parser_exec_state * s ) ;
...
position p;
@@
 struct plane_code_mapping {  int pipe ;  int plane ;  int event ; } cocci_id@p ;
...
position p;
@@
 const struct decode_info * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct parser_exec_state * s , unsigned long guest_gma , int op_size , bool index_mode ) ;
...
position p;
@@
 struct intel_vgpu_submission * cocci_id@p ;
...
position p;
@@
 struct cmd_interrupt_event cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef u64,bool,i915_reg_t;
@@
 struct mi_display_flip_command_info {  int pipe ;  int plane ;  int event ;  i915_reg_t stride_reg ;  i915_reg_t ctrl_reg ;  i915_reg_t surf_reg ;  u64 stride_val ;  u64 tile_val ;  u64 surf_val ;  bool async_flip ; } cocci_id@p ;
...
position p;
@@
 struct mi_display_flip_command_info * cocci_id@p ;
...
position p;
@@
 struct intel_vgpu_shadow_bb * cocci_id@p ;
...
position p;
@@
 struct sub_op_bits {  int hi ;  int low ; } cocci_id@p ;
...
position p;
@@
 const struct decode_info * cocci_id@p [ I915_NUM_ENGINES ] [ 8 ] ;
...
position p;
@@
 struct intel_vgpu_mm * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ CACHELINE_DWORDS ] ;
...
position p;
@@
 enum { GTT_BUFFER , PPGTT_BUFFER , } cocci_id@p ;
...
position p;
@@
 struct decode_info {  const char * name ;  int op_len ;  int nr_sub_op ;  const struct sub_op_bits * sub_op ; } cocci_id@p ;
