...
position p;
@@
 struct icside_state * cocci_id@p ;
...
position p;
@@
 struct icside_state {  unsigned int channel ;  unsigned int enabled ;  void __iomem * irq_port ;  void __iomem * ioc_base ;  unsigned int sel ;  unsigned int type ;  struct ide_host * host ; } cocci_id@p ;
...
position p;
@@
 struct cardinfo {  unsigned int dataoffset ;  unsigned int ctrloffset ;  unsigned int stepping ; } cocci_id@p ;
