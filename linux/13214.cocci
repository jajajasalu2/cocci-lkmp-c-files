...
position p;
@@
 enum cx18_av_video_input cocci_id@p ;
...
position p;
@@
 enum analog_signal_type { NONE , CVBS , Y , C , SIF , Pb , Pr , } cocci_id@p [ 3 ] ;
...
position p;
@@
 enum cx18_av_audio_input cocci_id@p ;
...
position p;
@@
 struct cx18_av_state * cocci_id@p ;
