...
position p;
@@
 struct xt_addrtype_info cocci_id@p ;
...
position p;
@@
 const struct xt_addrtype_info_v1 * cocci_id@p ;
...
position p;
@@
 struct xt_addrtype_info_v1 cocci_id@p ;
...
position p;
@@
 const struct xt_addrtype_info * cocci_id@p ;
