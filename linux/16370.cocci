...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct hid_parser * parser , struct hid_item * item ) ;
...
position p;
@@
 const struct hid_report_id * cocci_id@p ;
...
position p;
@@
 const struct hid_device * cocci_id@p ;
...
position p;
@@
 struct hid_dynid {  struct list_head list ;  struct hid_device_id id ; } cocci_id@p ;
