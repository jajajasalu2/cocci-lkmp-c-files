...
position p;
@@
 struct sta350_platform_data * cocci_id@p ;
...
typedef u32;
@@
 struct sta350_priv {  struct regmap * regmap ;  struct regulator_bulk_data supplies [ ARRAY_SIZE ( sta350_supply_names ) ] ;  struct sta350_platform_data * pdata ;  unsigned int mclk ;  unsigned int format ;  u32 coef_shadow [ STA350_COEF_COUNT ] ;  int shutdown ;  struct gpio_desc * gpiod_nreset ;  struct gpio_desc * gpiod_power_down ;  struct mutex coeff_lock ; } cocci_id@p ;
