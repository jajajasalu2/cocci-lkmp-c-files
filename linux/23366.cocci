...
position p;
@@
 const struct nau8824_fll_attr cocci_id@p [ ] ;
...
typedef bool;
@@
 bool cocci_id@p ( struct nau8824 * nau8824 ) ;
...
position p;
@@
 const struct nau8824_osr_attr cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct nau8824 * nau8824 , int clk_id , unsigned int freq ) ;
