...
typedef s32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * , ixgbe_link_speed ) ;
...
position p;
@@
 struct ixgbe_hic_drv_info2 cocci_id@p ;
...
position p;
@@
 struct ixgbe_hic_read_shadow_ram cocci_id@p ;
...
position p;
@@
 const struct ixgbe_mac_operations cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ IXGBE_EEPROM_LAST_WORD + 1 ] ;
...
position p;
@@
 union {  struct ixgbe_hic_phy_activity_req cmd ;  struct ixgbe_hic_phy_activity_resp rsp ; } cocci_id@p ;
...
position p;
@@
 const struct ixgbe_eeprom_operations cocci_id@p ;
...
typedef u16;
@@
 const struct {  u16 fw_speed ;  ixgbe_link_speed phy_speed ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ixgbe_hic_internal_phy_req cocci_id@p ;
...
position p;
@@
 struct ixgbe_hic_phy_token_req cocci_id@p ;
...
position p;
@@
 const struct ixgbe_phy_operations cocci_id@p ;
...
position p;
@@
 enum ixgbe_media_type cocci_id@p ;
...
position p;
@@
 union {  struct ixgbe_hic_internal_phy_req cmd ;  struct ixgbe_hic_internal_phy_resp rsp ; } cocci_id@p ;
...
typedef s32;
@@
 s32 cocci_id@p ( struct ixgbe_hw * ) ;
...
position p;
@@
 struct ixgbe_hic_disable_rxen cocci_id@p ;
...
position p;
@@
 struct ixgbe_link_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ixgbe_hw * ) ;
...
position p;
@@
 struct ixgbe_hic_write_shadow_ram cocci_id@p ;
...
position p;
@@
 union ixgbe_hic_hdr2 cocci_id@p ;
...
position p;
@@
 struct ixgbe_phy_info * cocci_id@p ;
...
position p;
@@
 const struct ixgbe_link_operations cocci_id@p ;
