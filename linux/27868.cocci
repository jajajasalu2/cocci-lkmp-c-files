...
position p;
@@
 const befs_block_run * cocci_id@p ;
...
position p;
@@
 befs_disk_block_run * cocci_id@p ;
...
position p;
@@
 const befs_inode_addr cocci_id@p ;
...
position p;
@@
 befs_disk_inode_addr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef befs_blocknr_t;
@@
 befs_blocknr_t cocci_id@p ;
