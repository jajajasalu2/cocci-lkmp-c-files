...
position p;
@@
 enum bxtwc_irqs { BXTWC_PWRBTN_LVL1_IRQ = 0 , BXTWC_TMU_LVL1_IRQ , BXTWC_THRM_LVL1_IRQ , BXTWC_BCU_LVL1_IRQ , BXTWC_ADC_LVL1_IRQ , BXTWC_CHGR_LVL1_IRQ , BXTWC_GPIO_LVL1_IRQ , BXTWC_CRIT_LVL1_IRQ , } cocci_id@p ;
...
position p;
@@
 enum bxtwc_irqs_chgr { BXTWC_USBC_IRQ = 0 , BXTWC_CHGR0_IRQ , BXTWC_CHGR1_IRQ , } cocci_id@p ;
...
position p;
@@
 enum bxtwc_irqs_bcu { BXTWC_BCU_IRQ = 0 , } cocci_id@p ;
...
position p;
@@
 struct regmap_irq_chip cocci_id@p ;
...
position p;
@@
 enum bxtwc_irqs_tmu { BXTWC_TMU_IRQ = 0 , } cocci_id@p ;
...
position p;
@@
 struct regmap_irq_chip_data * * cocci_id@p ;
...
position p;
@@
 enum bxtwc_irqs_adc { BXTWC_ADC_IRQ = 0 , } cocci_id@p ;
...
position p;
@@
 enum bxtwc_irqs_pwrbtn { BXTWC_PWRBTN_IRQ = 0 , BXTWC_UIBTN_IRQ , } cocci_id@p ;
...
position p;
@@
 enum bxtwc_irqs_crit { BXTWC_CRIT_IRQ = 0 , } cocci_id@p ;
