...
position p;
@@
 enum intr_status_bits { IntrRxDone = 0x01 , IntrRxInvalid = 0x02 , IntrRxPCIFault = 0x04 , IntrRxPCIErr = 0x08 , IntrTxDone = 0x10 , IntrTxInvalid = 0x20 , IntrTxPCIFault = 0x40 , IntrTxPCIErr = 0x80 , IntrEarlyRx = 0x100 , IntrWakeup = 0x200 , } cocci_id@p ;
...
position p;
@@
 enum desc_cmd_bits { CMD_TX_PKT = 0x10000000 , CMD_RX_BUF = 0x20000000 , CMD_TXSTATUS = 0x30000000 , CMD_NOP = 0x60000000 , CMD_STOP = 0x70000000 , BRANCH_ALWAYS = 0x0C0000 , INTR_ALWAYS = 0x300000 , WAIT_ALWAYS = 0x030000 , BRANCH_IFTRUE = 0x040000 , } cocci_id@p ;
...
typedef __le32;
@@
 struct yellowfin_desc {  __le32 dbdma_cmd ;  __le32 addr ;  __le32 branch_addr ;  __le32 result_status ; } cocci_id@p ;
...
position p;
@@
 struct tx_status_words cocci_id@p ;
...
position p;
@@
 struct yellowfin_desc cocci_id@p ;
...
position p;
@@
 enum capability_flags { HasMII = 1 , FullTxStatus = 2 , IsGigabit = 4 , HasMulticastBug = 8 , FullRxStatus = 16 , HasMACAddrBug = 32 , DontUseEeprom = 64 , } cocci_id@p ;
...
position p;
@@
 enum desc_status_bits { RX_EOP = 0x0040 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void __iomem * ioaddr , int phy_id , int location , int value ) ;
...
position p;
@@
 int cocci_id@p ( void __iomem * ioaddr , int phy_id , int location ) ;
...
position p;
@@
 struct yellowfin_private * cocci_id@p ;
...
position p;
@@
 enum { YELLOWFIN_SIZE = 0x100 , } cocci_id@p ;
