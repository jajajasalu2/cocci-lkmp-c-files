...
typedef bool;
@@
 struct meson_ao_cec_g12a_data {  bool ctrl2_setup ; } cocci_id@p ;
...
position p;
@@
 struct meson_ao_cec_g12a_dualdiv_clk * cocci_id@p ;
...
position p;
@@
 struct meson_ao_cec_g12a_device * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct meson_ao_cec_g12a_device {  struct platform_device * pdev ;  struct regmap * regmap ;  struct regmap * regmap_cec ;  spinlock_t cec_reg_lock ;  struct cec_notifier * notify ;  struct cec_adapter * adap ;  struct cec_msg rx_msg ;  struct clk * oscin ;  struct clk * core ;  const struct meson_ao_cec_g12a_data * data ; } cocci_id@p ;
...
position p;
@@
 const struct meson_ao_cec_g12a_data cocci_id@p ;
...
position p;
@@
 struct meson_ao_cec_g12a_dualdiv_clk {  struct clk_hw hw ;  struct regmap * regmap ; } cocci_id@p ;
