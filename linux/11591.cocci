...
position p;
@@
 struct nvkm_gpio_ntfy_rep cocci_id@p ;
...
position p;
@@
 enum dcb_gpio_func_name cocci_id@p [ ] ;
...
position p;
@@
 struct nvkm_gpio_ntfy_req * cocci_id@p ;
...
position p;
@@
 const struct nvkm_gpio_func * cocci_id@p ;
