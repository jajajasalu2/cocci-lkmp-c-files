...
symbol cocci_id;
position p;
typedef xfs_dir2_block_tail_t;
@@
 xfs_dir2_block_tail_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_sf_hdr_t;
@@
 xfs_dir2_sf_hdr_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_leaf_entry_t;
@@
 const xfs_dir2_leaf_entry_t * cocci_id@p ;
...
typedef xfs_da_args_t;
@@
 int cocci_id@p ( xfs_da_args_t * args , struct xfs_buf * * bpp , int * entno ) ;
...
position p;
@@
 struct xfs_dir2_data_unused * * cocci_id@p ;
...
position p;
@@
 struct xfs_dir3_icleaf_hdr cocci_id@p ;
...
typedef xfs_dir2_leaf_entry_t;
@@
 xfs_dir2_leaf_entry_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_leaf_t;
@@
 xfs_dir2_leaf_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_db_t;
@@
 xfs_dir2_db_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_dataptr_t;
@@
 xfs_dir2_dataptr_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_leaf_tail_t;
@@
 xfs_dir2_leaf_tail_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_data_hdr_t;
@@
 xfs_dir2_data_hdr_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_data_aoff_t;
@@
 xfs_dir2_data_aoff_t cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_sf_hdr cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_leaf_entry * cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_data_free * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_sf_entry_t;
@@
 xfs_dir2_sf_entry_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_data_entry_t;
@@
 xfs_dir2_data_entry_t * cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_block_tail * cocci_id@p ;
...
position p;
@@
 struct xfs_dir2_data_hdr * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_dir2_data_unused_t;
@@
 xfs_dir2_data_unused_t * cocci_id@p ;
...
typedef xfs_trans_t;
@@
 void cocci_id@p ( xfs_trans_t * tp , struct xfs_buf * bp , int first , int last ) ;
...
typedef xfs_trans_t;
@@
 void cocci_id@p ( xfs_trans_t * tp , struct xfs_buf * bp ) ;
