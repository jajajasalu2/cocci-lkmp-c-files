...
position p;
@@
 struct qeth_arp_query_info cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_setassparms_hdr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qeth_card * card ) ;
...
position p;
@@
 struct qeth_ipa_cmd * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qeth_qdio_out_q * queue , struct qeth_qdio_out_buffer * buf , enum iucv_tx_notify notification ) ;
...
position p;
@@
 enum qeth_diags_trap_action cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qeth_card * card , struct qeth_cmd_buffer * iob , unsigned int data_length ) ;
...
position p;
@@
 enum qeth_prot_versions cocci_id@p ;
...
symbol cocci_id;
position p;
typedef debug_info_t;
@@
 debug_info_t * cocci_id@p ;
...
position p;
@@
 struct qeth_dbf_info cocci_id@p [ QETH_DBF_INFOS ] ;
...
position p;
@@
 struct qeth_trap_id cocci_id@p ;
...
position p;
@@
 struct qdio_buffer_element * cocci_id@p ;
...
position p;
@@
 struct qeth_query_oat_data cocci_id@p ;
...
position p;
@@
 enum qeth_diags_cmds cocci_id@p ;
...
position p;
@@
 struct sysinfo_2_2_2 * cocci_id@p ;
...
position p;
@@
 struct service_level * cocci_id@p ;
...
position p;
@@
 struct qeth_hdr_ext_tso * cocci_id@p ;
...
position p;
@@
 struct qeth_buffer_pool_entry * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct qeth_card * ) ;
...
position p;
@@
 struct qeth_ipacmd_setadpparms cocci_id@p ;
...
position p;
@@
 struct ccwgroup_device * cocci_id@p ;
...
position p;
@@
 enum qeth_discipline_id cocci_id@p ;
...
position p;
@@
 struct channel_path_desc_fmt0 * cocci_id@p ;
...
position p;
@@
 enum qeth_ipa_isolation_modes cocci_id@p ;
...
position p;
@@
 enum iucv_tx_notify cocci_id@p ;
...
position p;
@@
 struct qeth_cmd_buffer * cocci_id@p ;
...
position p;
@@
 struct qeth_node_desc * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qeth_card * ) ;
...
position p;
@@
 struct qeth_snmp_ureq_hdr cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_setassparms * cocci_id@p ;
...
position p;
@@
 struct qeth_dbf_entry cocci_id@p ;
...
position p;
@@
 struct carrier_info * cocci_id@p ;
...
position p;
@@
 struct qeth_tso_start_data cocci_id@p ;
...
position p;
@@
 struct qeth_query_card_info * cocci_id@p ;
...
position p;
@@
 enum qeth_link_types cocci_id@p ;
...
position p;
@@
 struct qeth_qdio_out_q * cocci_id@p ;
...
position p;
@@
 struct diag26c_vnic_resp * cocci_id@p ;
...
position p;
@@
 enum qeth_ipa_funcs cocci_id@p ;
...
position p;
@@
 struct qeth_ipa_caps * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct qeth_card * , struct qeth_reply * , unsigned long ) ;
...
position p;
@@
 struct qeth_hdr_tso * cocci_id@p ;
...
position p;
@@
 struct qeth_qdio_buffer * cocci_id@p ;
...
position p;
@@
 enum qeth_ipa_setadp_cmd cocci_id@p ;
...
position p;
@@
 struct ccw_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct sysinfo_3_2_2 * cocci_id@p ;
...
position p;
@@
 struct qeth_node_desc {  struct node_descriptor nd1 ;  struct node_descriptor nd2 ;  struct node_descriptor nd3 ; } cocci_id@p ;
...
typedef debug_info_t;
@@
 struct qeth_dbf_entry {  char dbf_name [ DBF_NAME_LEN ] ;  debug_info_t * dbf_info ;  struct list_head dbf_list ; } cocci_id@p ;
...
position p;
@@
 struct qeth_query_switch_attributes * cocci_id@p ;
...
position p;
@@
 struct ccwgroup_driver cocci_id@p ;
...
position p;
@@
 struct qeth_qoat_priv * cocci_id@p ;
...
position p;
@@
 struct qdio_initialize cocci_id@p ;
...
position p;
@@
 struct qeth_set_access_ctrl * cocci_id@p ;
...
position p;
@@
 void * * cocci_id@p ( struct ccw_device * , int , unsigned long ) ;
...
position p;
@@
 struct qdio_outbuf_state cocci_id@p ;
...
position p;
@@
 struct qeth_channel * cocci_id@p ;
...
position p;
@@
 enum qeth_ipa_promisc_modes cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct qeth_qdio_out_q * queue , struct qeth_hdr * hdr , struct sk_buff * skb , int ipv , unsigned int data_len ) ;
...
position p;
@@
 struct qeth_qdio_out_buffer * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qeth_qdio_out_q * , int ) ;
...
position p;
@@
 struct qeth_snmp_cmd cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct qeth_card * cb_card , struct qeth_reply * cb_reply , unsigned long cb_cmd ) ;
...
position p;
@@
 struct qeth_ipacmd_setadpparms_hdr * cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_diagass * cocci_id@p ;
...
position p;
@@
 struct diag26c_mac_resp * cocci_id@p ;
...
position p;
@@
 struct qeth_query_oat * cocci_id@p ;
...
position p;
@@
 struct qeth_switch_info * cocci_id@p ;
...
position p;
@@
 struct diag26c_vnic_req * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct qeth_qdio_out_buffer * buf , bool error , int budget ) ;
...
position p;
@@
 struct diag26c_mac_req * cocci_id@p ;
...
position p;
@@
 struct qeth_ipacmd_hdr * cocci_id@p ;
