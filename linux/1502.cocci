...
position p;
@@
 struct usbtmc_file_data * cocci_id@p ;
...
position p;
@@
 struct usbtmc_ctrlrequest cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct usbtmc_file_data * file_data ) ;
...
position p;
@@
 struct usbtmc_message cocci_id@p ;
...
position p;
@@
 struct usbtmc_termchar cocci_id@p ;
...
position p;
@@
 struct usbtmc_device_data cocci_id@p ;
...
typedef __u8;
@@
 struct usbtmc_dev_capabilities {  __u8 interface_capabilities ;  __u8 device_capabilities ;  __u8 usb488_interface_capabilities ;  __u8 usb488_device_capabilities ; } cocci_id@p ;
