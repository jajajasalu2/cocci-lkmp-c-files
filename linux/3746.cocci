...
position p;
@@
 union nps_core_gbl_vfcfg cocci_id@p ;
...
position p;
@@
 union emu_ae_enable cocci_id@p ;
...
position p;
@@
 union pom_int_ena_w1s cocci_id@p ;
...
position p;
@@
 union lbc_inval_status cocci_id@p ;
...
position p;
@@
 union bmi_int_ena_w1s cocci_id@p ;
...
position p;
@@
 union efl_core_int_ena_w1s cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ IFNAMSIZ * 2 ] ;
...
position p;
@@
 union emu_se_enable cocci_id@p ;
...
position p;
@@
 union nps_pkt_slc_ctl cocci_id@p ;
...
position p;
@@
 struct nitrox_device * cocci_id@p ;
...
position p;
@@
 union nps_pkt_slc_cnts cocci_id@p ;
...
position p;
@@
 union nps_pkt_in_instr_baoff_dbell cocci_id@p ;
...
position p;
@@
 union efl_rnm_ctl_status cocci_id@p ;
...
position p;
@@
 union nps_pkt_slc_int_levels cocci_id@p ;
...
position p;
@@
 union nps_pkt_in_done_cnts cocci_id@p ;
...
position p;
@@
 union lbc_inval_ctl cocci_id@p ;
...
position p;
@@
 union aqmq_activity_stat cocci_id@p ;
...
position p;
@@
 union emu_ge_int_ena_w1s cocci_id@p ;
...
position p;
@@
 union nps_pkt_in_instr_rsize cocci_id@p ;
...
position p;
@@
 union emu_wd_int_ena_w1s cocci_id@p ;
...
position p;
@@
 union nps_core_int_ena_w1s cocci_id@p ;
...
position p;
@@
 union nps_pkt_in_instr_ctl cocci_id@p ;
...
position p;
@@
 union lbc_int_ena_w1s cocci_id@p ;
