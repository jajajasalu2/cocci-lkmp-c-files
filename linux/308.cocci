...
typedef loff_t;
@@
 struct gcov_iterator {  struct gcov_info * info ;  void * buffer ;  size_t size ;  loff_t pos ; } cocci_id@p ;
...
typedef u32;
@@
 struct gcov_info {  struct list_head head ;  const char * filename ;  unsigned int version ;  u32 checksum ;  struct list_head functions ; } cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct gcov_fn_info {  struct list_head head ;  u32 ident ;  u32 checksum ;  u8 use_extra_checksum ;  u32 cfg_checksum ;  u32 num_counters ;  u64 * counters ;  const char * function_name ; } cocci_id@p ;
