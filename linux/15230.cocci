...
typedef u64;
@@
 struct activity_data {  struct timer_list timer ;  struct led_classdev * led_cdev ;  u64 last_used ;  u64 last_boot ;  int time_left ;  int state ;  int invert ; } cocci_id@p ;
...
position p;
@@
 struct activity_data * cocci_id@p ;
