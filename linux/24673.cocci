...
typedef __be32;
@@
 struct hash_mac4_elem {  union {  unsigned char ether [ ETH_ALEN ] ;  __be32 foo [ 2 ] ; } ; } cocci_id@p ;
...
position p;
@@
 const struct hash_mac4_elem * cocci_id@p ;
...
position p;
@@
 struct hash_mac4_elem * cocci_id@p ;
