...
position p;
@@
 const struct phy_setting * cocci_id@p ;
...
position p;
@@
 enum { PHYLINK_DISABLE_STOPPED , PHYLINK_DISABLE_LINK , } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct net_device * dev , struct phylink_link_state * state ) ;
