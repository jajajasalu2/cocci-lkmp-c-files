...
position p;
@@
 struct alert_data {  unsigned short addr ;  enum i2c_alert_protocol type ;  unsigned int data ; } cocci_id@p ;
...
position p;
@@
 struct i2c_smbus_alert cocci_id@p ;
...
position p;
@@
 struct i2c_smbus_alert {  struct work_struct alert ;  struct i2c_client * ara ; } cocci_id@p ;
