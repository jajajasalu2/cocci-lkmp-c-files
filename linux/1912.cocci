...
typedef u8,u16;
@@
 struct ads8344 {  struct spi_device * spi ;  struct regulator * reg ;  struct mutex lock ;  u8 tx_buf ____cacheline_aligned ;  u16 rx_buf ; } cocci_id@p ;
