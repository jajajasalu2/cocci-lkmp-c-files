...
position p;
@@
 struct pyra_settings cocci_id@p ;
...
position p;
@@
 const struct pyra_device * cocci_id@p ;
...
position p;
@@
 const struct pyra_mouse_event_button * cocci_id@p ;
...
position p;
@@
 const struct pyra_settings * cocci_id@p ;
...
position p;
@@
 enum pyra_control_requests cocci_id@p ;
...
position p;
@@
 struct pyra_profile_settings * cocci_id@p ;
...
position p;
@@
 struct pyra_roccat_report cocci_id@p ;
