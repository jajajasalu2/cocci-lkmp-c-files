...
symbol cocci_id;
position p;
typedef debug_entry_t;
@@
 debug_entry_t * * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef file_private_info_t;
@@
 file_private_info_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef loff_t,debug_info_t;
@@
 struct file_private_info {  loff_t offset ;  int act_area ;  int act_page ;  int act_entry ;  size_t act_entry_offset ;  char temp_buf [ 2048 ] ;  debug_info_t * debug_info_org ;  debug_info_t * debug_info_snap ;  struct debug_view * view ; } cocci_id@p ;
...
position p;
@@
 struct {  char * string ;  long args [ 0 ] ; } cocci_id@p ;
...
typedef debug_info_t;
@@
 int cocci_id@p ( debug_info_t * id , struct debug_view * view , char * out_buf , const char * in_buf ) ;
...
symbol cocci_id;
position p;
typedef debug_format_proc_t;
@@
 debug_format_proc_t * cocci_id@p ;
...
typedef debug_info_t;
@@
 int cocci_id@p ( debug_info_t * id , struct debug_view * view , char * out_buf ) ;
...
position p;
@@
 int cocci_id@p [ DEBUG_SPRINTF_MAX_ARGS ] ;
...
symbol cocci_id;
position p;
typedef debug_sprintf_entry_t;
@@
 debug_sprintf_entry_t * cocci_id@p ;
