...
position p;
@@
 struct gpioevent_request cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gpio_chip * chip ) ;
...
position p;
@@
 struct gpiohandle_request cocci_id@p ;
...
typedef u32;
@@
 struct linehandle_state {  struct gpio_device * gdev ;  const char * label ;  struct gpio_desc * descs [ GPIOHANDLES_MAX ] ;  u32 numdescs ; } cocci_id@p ;
...
position p;
@@
 struct gpioevent_data cocci_id@p ;
...
position p;
@@
 struct gpiohandle_config cocci_id@p ;
...
position p;
@@
 struct acpi_gpio_info cocci_id@p ;
...
position p;
@@
 struct gpiohandle_data cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct gpio_chip * gpiochip , struct lock_class_key * lock_key , struct lock_class_key * request_key ) ;
...
position p;
@@
 struct gpiochip_info cocci_id@p ;
...
position p;
@@
 struct lineevent_state * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ 2 * BITS_TO_LONGS ( FASTPATH_NGPIO ) ] ;
...
position p;
@@
 int cocci_id@p ( struct gpio_chip * gpiochip ) ;
...
position p;
@@
 struct gpioline_info cocci_id@p ;
...
position p;
@@
 struct gpiod_lookup * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct gpio_chip * gpiochip ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct gpio_chip * chip , void * data ) ;
...
position p;
@@
 struct gpio_pin_range * cocci_id@p ;
...
position p;
@@
 struct linehandle_state * cocci_id@p ;
...
position p;
@@
 enum gpio_lookup_flags cocci_id@p ;
...
position p;
@@
 const struct gpio_desc * cocci_id@p ;
