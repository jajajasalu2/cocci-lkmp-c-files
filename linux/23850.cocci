...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_EMATCH_TREE_MAX + 1 ] ;
...
position p;
@@
 struct tcf_ematch_tree_hdr * cocci_id@p ;
...
position p;
@@
 struct tcf_ematch_hdr cocci_id@p ;
...
position p;
@@
 struct tcf_ematch_tree * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_EMATCH_TREE_MAX + 1 ] ;
...
position p;
@@
 int cocci_id@p [ CONFIG_NET_EMATCH_STACK ] ;
