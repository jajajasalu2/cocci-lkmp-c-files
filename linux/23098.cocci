...
position p;
@@
 struct s3c_pcm_info cocci_id@p [ 2 ] ;
...
position p;
@@
 struct s3c_pcm_info * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct s3c_pcm_info {  spinlock_t lock ;  struct device * dev ;  void __iomem * regs ;  unsigned int sclk_per_fs ;  unsigned int idleclk ;  struct clk * pclk ;  struct clk * cclk ;  struct snd_dmaengine_dai_dma_data * dma_playback ;  struct snd_dmaengine_dai_dma_data * dma_capture ; } cocci_id@p ;
