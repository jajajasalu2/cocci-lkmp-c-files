...
position p;
@@
 struct dme1737_data * cocci_id@p ;
...
position p;
@@
 enum chips { dme1737 , sch5027 , sch311x , sch5127 , } cocci_id@p ;
...
position p;
@@
 const struct dme1737_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef s8,u8,s16,u32,u16;
@@
 struct dme1737_data {  struct i2c_client * client ;  struct device * hwmon_dev ;  const char * name ;  unsigned int addr ;  struct mutex update_lock ;  int valid ;  unsigned long last_update ;  unsigned long last_vbat ;  enum chips type ;  const int * in_nominal ;  u8 vid ;  u8 pwm_rr_en ;  u32 has_features ;  u16 in [ 8 ] ;  u8 in_min [ 8 ] ;  u8 in_max [ 8 ] ;  s16 temp [ 3 ] ;  s8 temp_min [ 3 ] ;  s8 temp_max [ 3 ] ;  s8 temp_offset [ 3 ] ;  u8 config ;  u8 config2 ;  u8 vrm ;  u16 fan [ 6 ] ;  u16 fan_min [ 6 ] ;  u8 fan_max [ 2 ] ;  u8 fan_opt [ 6 ] ;  u8 pwm [ 6 ] ;  u8 pwm_min [ 3 ] ;  u8 pwm_config [ 3 ] ;  u8 pwm_acz [ 3 ] ;  u8 pwm_freq [ 6 ] ;  u8 pwm_rr [ 2 ] ;  s8 zone_low [ 3 ] ;  s8 zone_abs [ 3 ] ;  u8 zone_hyst [ 2 ] ;  u32 alarms ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( int , struct dme1737_data * ) ;
