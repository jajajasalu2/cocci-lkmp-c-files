...
position p;
@@
 struct savagefb_par cocci_id@p ;
...
position p;
@@
 enum ACTIVE_DISPLAYS { ActiveCRT = 0x01 , ActiveLCD = 0x02 , ActiveTV = 0x04 , ActiveCRT2 = 0x20 , ActiveDUO = 0x80 , } cocci_id@p ;
