...
position p;
@@
 enum mlx4_zone_alloc_flags cocci_id@p ;
...
position p;
@@
 struct mlx4_db_pgdir * cocci_id@p ;
...
position p;
@@
 struct mlx4_hwq_resources * cocci_id@p ;
...
position p;
@@
 struct mlx4_zone_entry * cocci_id@p ;
...
position p;
@@
 struct mlx4_zone_allocator * cocci_id@p ;
...
@@
 struct mlx4_zone_allocator {  struct list_head entries ;  struct list_head prios ;  u32 last_uid ;  u32 mask ;  spinlock_t lock ;  enum mlx4_zone_alloc_flags flags ; } cocci_id@p ;
...
typedef u32;
@@
 struct mlx4_zone_entry {  struct list_head list ;  struct list_head prio_list ;  u32 uid ;  struct mlx4_zone_allocator * allocator ;  struct mlx4_bitmap * bitmap ;  int use_rr ;  int priority ;  int offset ;  enum mlx4_zone_flags flags ; } cocci_id@p ;
