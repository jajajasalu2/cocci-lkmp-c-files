...
position p;
@@
 struct sst_acpi_priv {  struct platform_device * pdev_mach ;  struct platform_device * pdev_pcm ;  struct sst_pdata sst_pdata ;  struct sst_acpi_desc * desc ;  struct snd_soc_acpi_mach * mach ; } cocci_id@p ;
...
position p;
@@
 struct sst_acpi_priv * cocci_id@p ;
...
position p;
@@
 struct sst_acpi_desc * cocci_id@p ;
...
position p;
@@
 struct sst_acpi_desc {  const char * drv_name ;  struct snd_soc_acpi_mach * machines ;  int resindex_lpe_base ;  int resindex_pcicfg_base ;  int resindex_fw_base ;  int irqindex_host_ipc ;  int resindex_dma_base ;  int sst_id ;  int dma_engine ;  int dma_size ; } cocci_id@p ;
