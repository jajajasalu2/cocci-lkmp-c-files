...
position p;
@@
 struct palmas_clock_info {  struct device * dev ;  struct clk_hw hw ;  struct palmas * palmas ;  const struct palmas_clk32k_desc * clk_desc ;  int ext_control_pin ; } cocci_id@p ;
...
position p;
@@
 const struct palmas_clks_of_match_data cocci_id@p ;
...
position p;
@@
 struct palmas_clock_info * cocci_id@p ;
...
position p;
@@
 struct palmas_clk32k_desc {  const char * clk_name ;  unsigned int control_reg ;  unsigned int enable_mask ;  unsigned int sleep_mask ;  unsigned int sleep_reqstr_id ;  int delay ; } cocci_id@p ;
...
position p;
@@
 struct palmas_clks_of_match_data {  struct clk_init_data init ;  const struct palmas_clk32k_desc desc ; } cocci_id@p ;
