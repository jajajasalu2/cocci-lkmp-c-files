...
@@
 struct iTCO_wdt_private {  struct watchdog_device wddev ;  unsigned int iTCO_version ;  struct resource * tco_res ;  struct resource * smi_res ;  struct resource * gcs_pmc_res ;  unsigned long __iomem * gcs_pmc ;  spinlock_t io_lock ;  struct pci_dev * pci_dev ;  bool suspended ;  void * no_reboot_priv ;  int ( * update_no_reboot_bit ) ( void * p , bool set ) ; } cocci_id@p ;
...
position p;
@@
 struct iTCO_wdt_private * cocci_id@p ;
