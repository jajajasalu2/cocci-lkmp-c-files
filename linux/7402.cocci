...
position p;
@@
 const struct hdmi_phy_features cocci_id@p ;
...
typedef bool;
@@
 struct hdmi_phy_features {  bool bist_ctrl ;  bool ldo_voltage ;  unsigned long max_phy ; } cocci_id@p ;
...
position p;
@@
 struct hdmi_phy_data * cocci_id@p ;
