...
position p;
@@
 struct rsi_mgmt_desc * cocci_id@p ;
...
position p;
@@
 struct rsi_data_desc * cocci_id@p ;
...
position p;
@@
 struct rsi_xtended_desc cocci_id@p ;
...
position p;
@@
 struct rsi_host_intf_ops * cocci_id@p ;
