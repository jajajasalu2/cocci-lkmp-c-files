...
position p;
@@
 struct i915_global_vma cocci_id@p ;
...
position p;
@@
 struct i915_vma_work * cocci_id@p ;
...
position p;
@@
 struct i915_global_vma {  struct i915_global base ;  struct kmem_cache * slab_vmas ; } cocci_id@p ;
...
position p;
@@
 const struct dma_fence_work_ops cocci_id@p ;
...
position p;
@@
 struct drm_vma_offset_node * cocci_id@p ;
...
position p;
@@
 struct dma_fence_work * cocci_id@p ;
...
position p;
@@
 typeof ( struct i915_vma ) cocci_id@p ;
...
position p;
@@
 struct i915_vma_work {  struct dma_fence_work base ;  struct i915_vma * vma ;  enum i915_cache_level cache_level ;  unsigned int flags ; } cocci_id@p ;
