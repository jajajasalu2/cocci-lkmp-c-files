...
position p;
@@
 struct get_tick_patch * cocci_id@p ;
...
position p;
@@
 struct sparc64_tick_ops * cocci_id@p ;
...
position p;
@@
 struct m48t59_plat_data cocci_id@p ;
...
position p;
@@
 struct freq_table {  unsigned long clock_tick_ref ;  unsigned int ref_freq ; } cocci_id@p ;
