...
typedef bool,u32;
@@
 struct wled_config {  u32 boost_i_limit ;  u32 ovp ;  u32 switch_freq ;  u32 num_strings ;  u32 string_i_limit ;  u32 enabled_strings [ WLED_MAX_STRINGS ] ;  bool cs_out_en ;  bool ext_gen ;  bool cabc ;  bool external_pfet ;  bool auto_detection_enabled ; } cocci_id@p ;
...
position p;
@@
 const struct wled_var_cfg cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,u16,ktime_t;
@@
 struct wled {  const char * name ;  struct device * dev ;  struct regmap * regmap ;  struct mutex lock ;  ktime_t last_short_event ;  ktime_t start_ovp_fault_time ;  u16 ctrl_addr ;  u16 sink_addr ;  u16 max_string_count ;  u16 auto_detection_ovp_count ;  u32 brightness ;  u32 max_brightness ;  u32 short_count ;  u32 auto_detect_count ;  bool disabled_by_short ;  bool has_short_detect ;  int short_irq ;  int ovp_irq ;  struct wled_config cfg ;  struct delayed_work ovp_work ;  int ( * wled_set_brightness ) ( struct wled * wled , u16 brightness ) ; } cocci_id@p ;
...
position p;
@@
 const struct wled_config cocci_id@p ;
...
position p;
@@
 const struct wled_u32_opts cocci_id@p [ ] ;
...
position p;
@@
 const struct wled_bool_opts cocci_id@p [ ] ;
...
typedef u32;
@@
 struct wled_u32_opts {  const char * name ;  u32 * val_ptr ;  const struct wled_var_cfg * cfg ; } cocci_id@p ;
...
typedef bool;
@@
 struct wled_bool_opts {  const char * name ;  bool * val_ptr ; } cocci_id@p ;
...
typedef u32;
@@
 struct wled_var_cfg {  const u32 * values ;  u32 ( * fn ) ( u32 ) ;  int size ; } cocci_id@p ;
