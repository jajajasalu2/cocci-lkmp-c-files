...
position p;
@@
 enum x86_hypervisor_type cocci_id@p [ ] ;
...
position p;
@@
 struct vmmouse_data * cocci_id@p ;
...
position p;
@@
 struct vmmouse_data {  struct input_dev * abs_dev ;  char phys [ 32 ] ;  char dev_name [ 128 ] ; } cocci_id@p ;
