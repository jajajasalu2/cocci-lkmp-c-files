...
position p;
@@
 struct lpc18xx_dmamux * cocci_id@p ;
...
position p;
@@
 struct lpc18xx_dmamux_data * cocci_id@p ;
...
@@
 struct lpc18xx_dmamux_data {  struct dma_router dmarouter ;  struct lpc18xx_dmamux * muxes ;  u32 dma_master_requests ;  u32 dma_mux_requests ;  struct regmap * reg ;  spinlock_t lock ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct lpc18xx_dmamux {  u32 value ;  bool busy ; } cocci_id@p ;
