...
position p;
@@
 const struct drx_demod_instance * cocci_id@p ;
...
position p;
@@
 struct drx39xxj_state * cocci_id@p ;
...
typedef u32,u16;
@@
 struct drxu_code_block_hdr {  u32 addr ;  u16 size ;  u16 flags ;  u16 CRC ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct i2c_device_addr * dev_addr , u32 addr , u32 data , u32 flags ) ;
...
typedef u16;
@@
 struct drxj_hi_cmd {  u16 cmd ;  u16 param1 ;  u16 param2 ;  u16 param3 ;  u16 param4 ;  u16 param5 ;  u16 param6 ; } cocci_id@p ;
...
position p;
@@
 struct drx_cfg_mpeg_output * cocci_id@p ;
...
position p;
@@
 struct drx_common_attr cocci_id@p ;
...
position p;
@@
 struct drxu_code_block_hdr cocci_id@p ;
...
position p;
@@
 struct drx_demod_instance * cocci_id@p ;
...
position p;
@@
 const struct drx_channel cocci_id@p ;
...
position p;
@@
 enum drx_power_mode * cocci_id@p ;
...
typedef s16;
@@
 s16 cocci_id@p [ 4 ] [ ( NYQFILTERLEN + 1 ) / 2 ] ;
...
position p;
@@
 struct dvb_frontend_ops cocci_id@p ;
...
position p;
@@
 enum drxu_code_action cocci_id@p ;
...
position p;
@@
 enum drx_lock_status cocci_id@p ;
...
position p;
@@
 struct i2c_device_addr cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drx_demod_instance * demod , struct drxj_cfg_afe_gain * afe_gain ) ;
...
position p;
@@
 int cocci_id@p ( struct drx_demod_instance * demod , enum drx_lock_status * lock_stat ) ;
...
position p;
@@
 struct drxj_cfg_agc * cocci_id@p ;
...
typedef u32,u16;
@@
 int cocci_id@p ( struct i2c_device_addr * dev_addr , u32 addr , u16 data , u32 flags ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ DRXDAP_MAX_WCHUNKSIZE ] ;
...
position p;
@@
 const struct drxj_hi_cmd * cocci_id@p ;
...
position p;
@@
 struct drxjrs_errors cocci_id@p ;
...
position p;
@@
 struct drxu_code_info cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ DRX_UCODE_MAX_BUF_SIZE ] ;
...
symbol cocci_id;
position p;
typedef drx_write_reg16func_t;
@@
 drx_write_reg16func_t cocci_id@p ;
...
typedef u8,u16;
@@
 struct drxjeq_stat {  u16 eq_mse ;  u8 eq_mode ;  u8 eq_ctrl ;  u8 eq_stat ; } cocci_id@p ;
...
position p;
@@
 struct drx_version_list * cocci_id@p ;
...
position p;
@@
 struct drxj_cfg_pre_saw * cocci_id@p ;
...
position p;
@@
 struct drxj_cfg_afe_gain * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct drx_demod_instance * demod , bool state ) ;
...
position p;
@@
 int cocci_id@p ( struct drx_demod_instance * demod , enum drx_power_mode * mode ) ;
...
symbol cocci_id;
position p;
typedef drx_read_reg16func_t;
@@
 drx_read_reg16func_t cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct i2c_device_addr * dev_addr , const struct drxj_hi_cmd * cmd , u16 * result ) ;
...
typedef u8,u32,u16;
@@
 int cocci_id@p ( struct i2c_device_addr * dev_addr , u32 addr , u16 datasize , u8 * data , u32 flags ) ;
...
position p;
@@
 struct drx_aud_data cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drx_demod_instance * demod , struct drxj_cfg_pre_saw * pre_saw ) ;
...
position p;
@@
 int cocci_id@p ( struct drx_demod_instance * demod , struct drxu_code_info * mc_info , enum drxu_code_action action ) ;
...
position p;
@@
 int cocci_id@p ( struct drx_demod_instance * demod ) ;
...
typedef u32,u16;
@@
 int cocci_id@p ( struct i2c_device_addr * dev_addr , u32 waddr , u32 raddr , u16 wdata , u16 * rdata ) ;
...
position p;
@@
 enum drx_modulation cocci_id@p ;
