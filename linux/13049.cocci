...
position p;
@@
 struct rpmh_request cocci_id@p ;
...
position p;
@@
 const struct tcs_cmd * cocci_id@p ;
...
position p;
@@
 const struct rpmh_request * cocci_id@p ;
...
position p;
@@
 struct batch_cache_req * cocci_id@p ;
...
typedef u32;
@@
 struct cache_req {  u32 addr ;  u32 sleep_val ;  u32 wake_val ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 const struct tcs_request * cocci_id@p ;
...
position p;
@@
 struct batch_cache_req {  struct list_head list ;  int count ;  struct rpmh_request rpm_msgs [ ] ; } cocci_id@p ;
