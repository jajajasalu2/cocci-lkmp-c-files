...
position p;
@@
 struct drm_bridge * cocci_id@p [ MAX_ENDPOINTS ] ;
...
position p;
@@
 struct drm_panel * cocci_id@p [ MAX_ENDPOINTS ] ;
...
position p;
@@
 const enum ltdc_pix_fmt cocci_id@p [ NB_PF ] ;
...
position p;
@@
 enum ltdc_pix_fmt { PF_NONE , PF_ARGB8888 , PF_RGBA8888 , PF_RGB888 , PF_RGB565 , PF_ARGB1555 , PF_ARGB4444 , PF_L8 , PF_AL44 , PF_AL88 , } cocci_id@p ;
