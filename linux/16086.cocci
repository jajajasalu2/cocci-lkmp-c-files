...
position p;
@@
 char cocci_id@p [ sizeof ( "/dev/comediXXXXXX" ) ] ;
...
position p;
@@
 struct comedi_bond_private {  char name [ 256 ] ;  struct bonded_device * * devs ;  unsigned int ndevs ;  unsigned int nchans ; } cocci_id@p ;
...
position p;
@@
 struct comedi_bond_private * cocci_id@p ;
...
position p;
@@
 struct bonded_device * * cocci_id@p ;
...
position p;
@@
 struct bonded_device {  struct comedi_device * dev ;  unsigned int minor ;  unsigned int subdev ;  unsigned int nchans ; } cocci_id@p ;
