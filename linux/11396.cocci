...
position p;
@@
 struct drm_pending_event * cocci_id@p ;
...
position p;
@@
 struct vmw_fence_action * cocci_id@p ;
...
position p;
@@
 struct ttm_mem_global * cocci_id@p ;
...
position p;
@@
 struct dma_fence_array * cocci_id@p ;
...
position p;
@@
 struct vmwgfx_wait_cb * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_fence_signaled_arg * cocci_id@p ;
...
position p;
@@
 struct vmw_user_fence {  struct ttm_base_object base ;  struct vmw_fence_obj fence ; } cocci_id@p ;
...
position p;
@@
 struct vmw_fence_manager * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_fence_event_arg * cocci_id@p ;
...
position p;
@@
 struct vmwgfx_wait_cb {  struct dma_fence_cb base ;  struct task_struct * task ; } cocci_id@p ;
...
position p;
@@
 struct drm_vmw_fence_arg * cocci_id@p ;
...
position p;
@@
 struct vmw_user_fence * cocci_id@p ;
...
position p;
@@
 struct vmw_event_fence_action * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,uint32_t,spinlock_t;
@@
 struct vmw_fence_manager {  int num_fence_objects ;  struct vmw_private * dev_priv ;  spinlock_t lock ;  struct list_head fence_list ;  struct work_struct work ;  u32 user_fence_size ;  u32 fence_size ;  u32 event_fence_action_size ;  bool fifo_down ;  struct list_head cleanup_list ;  uint32_t pending_actions [ VMW_ACTION_MAX ] ;  struct mutex goal_irq_mutex ;  bool goal_irq_on ;  bool seqno_valid ;  u64 ctx ; } cocci_id@p ;
...
position p;
@@
 const struct dma_fence_ops cocci_id@p ;
...
position p;
@@
 struct drm_vmw_fence_wait_arg * cocci_id@p ;
...
position p;
@@
 struct vmw_event_fence_pending * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vmw_fence_manager * fman ) ;
...
position p;
@@
 struct vmw_event_fence_pending {  struct drm_pending_event base ;  struct drm_vmw_event_fence event ; } cocci_id@p ;
...
position p;
@@
 struct dma_fence_cb * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct vmw_fence_obj * fence ) ;
...
typedef uint32_t;
@@
 struct vmw_event_fence_action {  struct vmw_fence_action action ;  struct drm_pending_event * event ;  struct vmw_fence_obj * fence ;  struct drm_device * dev ;  uint32_t * tv_sec ;  uint32_t * tv_usec ; } cocci_id@p ;
