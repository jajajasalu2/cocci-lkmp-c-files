...
typedef bool;
@@
 struct clkgen_data {  unsigned long flags ;  bool mode ; } cocci_id@p ;
...
position p;
@@
 const struct clkgen_data cocci_id@p ;
...
typedef bool;
@@
 struct flexgen {  struct clk_hw hw ;  struct clk_mux mux ;  struct clk_gate pgate ;  struct clk_divider pdiv ;  struct clk_gate fgate ;  struct clk_divider fdiv ;  struct clk_gate sync ;  bool control_mode ; } cocci_id@p ;
