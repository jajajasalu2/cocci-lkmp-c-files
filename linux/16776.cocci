...
position p;
@@
 struct f34v7_query_1_7 cocci_id@p ;
...
position p;
@@
 struct f34v7_data_1_5 cocci_id@p ;
...
position p;
@@
 struct physical_address * cocci_id@p ;
...
position p;
@@
 const struct container_descriptor * cocci_id@p ;
...
position p;
@@
 struct partition_table cocci_id@p ;
...
position p;
@@
 const struct image_header_10 * cocci_id@p ;
...
position p;
@@
 const struct partition_table * cocci_id@p ;
