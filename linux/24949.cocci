...
position p;
@@
 struct llc_sap_state_trans * cocci_id@p ;
...
position p;
@@
 struct sockaddr_llc * cocci_id@p ;
...
position p;
@@
 struct sock * cocci_id@p [ 256 / sizeof ( struct sock * ) ] ;
...
symbol cocci_id;
position p;
typedef llc_sap_action_t;
@@
 const llc_sap_action_t * cocci_id@p ;
...
position p;
@@
 struct llc_sap_state_ev * cocci_id@p ;
...
position p;
@@
 struct llc_sap_state * cocci_id@p ;
