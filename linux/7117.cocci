...
position p;
@@
 struct pdcspath_entry * cocci_id@p [ ] ;
...
typedef rwlock_t;
@@
 struct pdcspath_entry {  rwlock_t rw_lock ;  short ready ;  unsigned long addr ;  char * name ;  struct device_path devpath ;  struct device * dev ;  struct kobject kobj ; } cocci_id@p ;
...
position p;
@@
 struct pdcspath_attribute * cocci_id@p ;
