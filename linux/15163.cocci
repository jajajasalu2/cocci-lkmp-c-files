...
position p;
@@
 struct pps_gpio_device_data * cocci_id@p ;
...
position p;
@@
 const struct pps_gpio_device_data * cocci_id@p ;
...
position p;
@@
 const struct pps_gpio_platform_data * cocci_id@p ;
...
typedef bool;
@@
 struct pps_gpio_device_data {  int irq ;  struct pps_device * pps ;  struct pps_source_info info ;  struct gpio_desc * gpio_pin ;  struct gpio_desc * echo_pin ;  struct timer_list echo_timer ;  bool assert_falling_edge ;  bool capture_clear ;  unsigned int echo_active_ms ;  unsigned long echo_timeout ; } cocci_id@p ;
