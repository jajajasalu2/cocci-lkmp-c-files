...
position p;
@@
 struct soctherm_oc_cfg * cocci_id@p ;
...
position p;
@@
 const struct tegra_tsensor_group * * cocci_id@p ;
...
position p;
@@
 struct soctherm_oc_irq_chip_data cocci_id@p ;
...
position p;
@@
 enum thermal_trip_type cocci_id@p ;
...
position p;
@@
 struct tsensor_shared_calib cocci_id@p ;
...
position p;
@@
 struct soctherm_oc_irq_chip_data {  struct mutex irq_lock ;  struct irq_chip irq_chip ;  struct irq_domain * domain ;  int irq_enable ; } cocci_id@p ;
...
position p;
@@
 struct soctherm_throt_cfg cocci_id@p ;
...
position p;
@@
 struct tegra_thermctl_zone * cocci_id@p ;
...
position p;
@@
 enum soctherm_throttle_dev_id { THROTTLE_DEV_CPU = 0 , THROTTLE_DEV_GPU , THROTTLE_DEV_SIZE , } cocci_id@p ;
...
position p;
@@
 struct tsensor_group_thermtrips * cocci_id@p ;
...
position p;
@@
 struct tegra_soctherm_soc * cocci_id@p ;
...
typedef bool,u32;
@@
 struct soctherm_oc_cfg {  u32 active_low ;  u32 throt_period ;  u32 alarm_cnt_thresh ;  u32 alarm_filter ;  u32 mode ;  bool intr_en ; } cocci_id@p ;
...
position p;
@@
 struct tegra_thermctl_zone {  void __iomem * reg ;  struct device * dev ;  struct tegra_soctherm * ts ;  struct thermal_zone_device * tz ;  const struct tegra_tsensor_group * sg ; } cocci_id@p ;
...
position p;
@@
 const struct tegra_tsensor * cocci_id@p ;
...
position p;
@@
 enum soctherm_throttle_id cocci_id@p ;
...
position p;
@@
 struct tegra_soctherm cocci_id@p ;
...
position p;
@@
 struct thermal_zone_device * cocci_id@p ;
...
position p;
@@
 enum soctherm_oc_irq_id { TEGRA_SOC_OC_IRQ_1 , TEGRA_SOC_OC_IRQ_2 , TEGRA_SOC_OC_IRQ_3 , TEGRA_SOC_OC_IRQ_4 , TEGRA_SOC_OC_IRQ_5 , TEGRA_SOC_OC_IRQ_MAX , } cocci_id@p ;
...
position p;
@@
 enum soctherm_throttle_id { THROTTLE_LIGHT = 0 , THROTTLE_HEAVY , THROTTLE_OC1 , THROTTLE_OC2 , THROTTLE_OC3 , THROTTLE_OC4 , THROTTLE_OC5 , THROTTLE_SIZE , } cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct soctherm_throt_cfg {  const char * name ;  unsigned int id ;  u8 priority ;  u8 cpu_throt_level ;  u32 cpu_throt_depth ;  u32 gpu_throt_level ;  struct soctherm_oc_cfg oc_cfg ;  struct thermal_cooling_device * cdev ;  bool init ; } cocci_id@p ;
