...
position p;
@@
 struct pinctrl_dt_map {  struct list_head node ;  struct pinctrl_dev * pctldev ;  struct pinctrl_map * map ;  unsigned num_maps ; } cocci_id@p ;
...
position p;
@@
 struct pinctrl_dt_map * cocci_id@p ;
