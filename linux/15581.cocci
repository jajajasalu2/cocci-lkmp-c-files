...
position p;
@@
 enum address_filtering cocci_id@p ;
...
position p;
@@
 enum tx_start_condition cocci_id@p ;
...
position p;
@@
 enum antenna_impedance cocci_id@p ;
...
position p;
@@
 enum fifo_fill_condition cocci_id@p ;
...
position p;
@@
 enum threshold_decrement cocci_id@p ;
