...
position p;
@@
 const struct mtk_fixed_factor cocci_id@p [ ] ;
...
position p;
@@
 const struct mtk_gate cocci_id@p [ ] ;
...
position p;
@@
 const struct mtk_clk_divider cocci_id@p [ ] ;
...
position p;
@@
 const struct mtk_fixed_clk cocci_id@p [ ] ;
...
position p;
@@
 const struct mtk_gate_regs cocci_id@p ;
...
position p;
@@
 struct mtk_composite cocci_id@p [ ] ;
