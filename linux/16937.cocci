...
typedef u8;
@@
 u8 cocci_id@p [ WACOM_QUERY_SIZE ] ;
...
position p;
@@
 struct wacom_features {  int x_max ;  int y_max ;  int pressure_max ;  char fw_version ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct wacom_i2c {  struct i2c_client * client ;  struct input_dev * input ;  u8 data [ WACOM_QUERY_SIZE ] ;  bool prox ;  int tool ; } cocci_id@p ;
