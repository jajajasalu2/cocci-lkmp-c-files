...
position p;
@@
 struct stm32_usbphyc * cocci_id@p ;
...
typedef u8,u16;
@@
 struct pll_params {  u8 ndiv ;  u16 frac ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct stm32_usbphyc_phy {  struct phy * phy ;  struct stm32_usbphyc * usbphyc ;  struct regulator_bulk_data supplies [ NUM_SUPPLIES ] ;  u32 index ;  bool active ; } cocci_id@p ;
...
position p;
@@
 struct stm32_usbphyc_phy * cocci_id@p ;
...
position p;
@@
 struct stm32_usbphyc {  struct device * dev ;  void __iomem * base ;  struct clk * clk ;  struct reset_control * rst ;  struct stm32_usbphyc_phy * * phys ;  int nphys ;  int switch_setup ; } cocci_id@p ;
