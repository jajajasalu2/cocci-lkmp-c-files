...
position p;
@@
 const struct dpdmai_rx_queue_cfg * cocci_id@p ;
...
position p;
@@
 struct dpdmai_cmd_queue * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct dpdmai_rsp_get_attributes {  __le32 id ;  u8 num_of_priorities ;  u8 pad0 [ 3 ] ;  __le16 major ;  __le16 minor ; } cocci_id@p ;
...
position p;
@@
 const struct dpdmai_cfg * cocci_id@p ;
...
@@
 struct dpdmai_rsp_get_tx_queue {  __le64 pad ;  __le32 fqid ; } cocci_id@p ;
...
position p;
@@
 struct dpdmai_rx_queue_attr * cocci_id@p ;
...
@@
 struct dpdmai_cmd_queue {  __le32 dest_id ;  u8 priority ;  u8 queue ;  u8 dest_type ;  u8 pad ;  __le64 user_ctx ;  union {  __le32 options ;  __le32 fqid ; } ; } cocci_id@p ;
...
position p;
@@
 struct dpdmai_rsp_get_attributes * cocci_id@p ;
...
position p;
@@
 struct dpdmai_rsp_get_tx_queue * cocci_id@p ;
