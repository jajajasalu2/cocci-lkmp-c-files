...
position p;
@@
 struct subsys_dev_iter * cocci_id@p ;
...
position p;
@@
 struct driver_private * cocci_id@p ;
...
position p;
@@
 struct subsys_private cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device * dev , const void * data ) ;
...
position p;
@@
 struct bus_attribute cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const struct device * a , const struct device * b ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct device_driver * , void * ) ;
