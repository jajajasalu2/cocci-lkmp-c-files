...
typedef __le32;
@@
 struct msgbuf_ioctl_resp_hdr {  struct msgbuf_common_hdr msg ;  struct msgbuf_completion_hdr compl_hdr ;  __le16 resp_len ;  __le16 trans_id ;  __le32 cmd ;  __le32 rsvd0 ; } cocci_id@p ;
...
position p;
@@
 struct msgbuf_tx_msghdr * cocci_id@p ;
...
position p;
@@
 struct brcmf_msgbuf_work_item cocci_id@p ;
...
position p;
@@
 struct msgbuf_flowring_create_resp * cocci_id@p ;
...
position p;
@@
 struct msgbuf_ring_status {  struct msgbuf_common_hdr msg ;  struct msgbuf_completion_hdr compl_hdr ;  __le16 write_idx ;  __le16 rsvd0 [ 5 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct brcmf_msgbuf_pktids {  u32 array_size ;  u32 last_allocated_idx ;  enum dma_data_direction direction ;  struct brcmf_msgbuf_pktid * array ; } cocci_id@p ;
...
typedef __le32;
@@
 struct msgbuf_rx_bufpost {  struct msgbuf_common_hdr msg ;  __le16 metadata_buf_len ;  __le16 data_buf_len ;  __le32 rsvd0 ;  struct msgbuf_buf_addr metadata_buf_addr ;  struct msgbuf_buf_addr data_buf_addr ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_flowring_hash * cocci_id@p ;
...
position p;
@@
 struct brcmf_flowring * cocci_id@p ;
...
position p;
@@
 struct brcmf_msgbuf_pktids * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct msgbuf_common_hdr {  u8 msgtype ;  u8 ifidx ;  u8 flags ;  u8 rsvd0 ;  __le32 request_id ; } cocci_id@p ;
...
typedef __le32;
@@
 struct msgbuf_gen_status {  struct msgbuf_common_hdr msg ;  struct msgbuf_completion_hdr compl_hdr ;  __le16 write_idx ;  __le32 rsvd0 [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct msgbuf_ioctl_req_hdr * cocci_id@p ;
...
position p;
@@
 struct brcmf_commonring * * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u16,atomic_t,dma_addr_t;
@@
 struct brcmf_msgbuf_pktid {  atomic_t allocated ;  u16 data_offset ;  struct sk_buff * skb ;  dma_addr_t physaddr ; } cocci_id@p ;
...
position p;
@@
 struct msgbuf_rx_ioctl_resp_or_event * cocci_id@p ;
...
position p;
@@
 struct msgbuf_rx_event * cocci_id@p ;
...
typedef __le32;
@@
 struct msgbuf_flowring_create_resp {  struct msgbuf_common_hdr msg ;  struct msgbuf_completion_hdr compl_hdr ;  __le32 rsvd0 [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_msgbuf * cocci_id@p ;
...
position p;
@@
 struct brcmf_bus_msgbuf * cocci_id@p ;
...
position p;
@@
 struct brcmf_msgbuf_pktid * cocci_id@p ;
...
position p;
@@
 struct msgbuf_flowring_delete_resp * cocci_id@p ;
...
position p;
@@
 struct msgbuf_tx_status * cocci_id@p ;
...
typedef __le32;
@@
 struct msgbuf_flowring_delete_resp {  struct msgbuf_common_hdr msg ;  struct msgbuf_completion_hdr compl_hdr ;  __le32 rsvd0 [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_flowring_ring * cocci_id@p ;
...
typedef __le32;
@@
 struct msgbuf_flowring_flush_resp {  struct msgbuf_common_hdr msg ;  struct msgbuf_completion_hdr compl_hdr ;  __le32 rsvd0 [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 struct msgbuf_gen_status * cocci_id@p ;
...
position p;
@@
 struct msgbuf_common_hdr * cocci_id@p ;
...
typedef u8;
@@
 struct msgbuf_tx_flowring_create_req {  struct msgbuf_common_hdr msg ;  u8 da [ ETH_ALEN ] ;  u8 sa [ ETH_ALEN ] ;  u8 tid ;  u8 if_flags ;  __le16 flow_ring_id ;  u8 tc ;  u8 priority ;  __le16 int_vector ;  __le16 max_items ;  __le16 len_item ;  struct msgbuf_buf_addr flow_ring_addr ; } cocci_id@p ;
...
position p;
@@
 struct msgbuf_rx_event {  struct msgbuf_common_hdr msg ;  struct msgbuf_completion_hdr compl_hdr ;  __le16 event_data_len ;  __le16 seqnum ;  __le16 rsvd0 [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct msgbuf_tx_flowring_create_req * cocci_id@p ;
...
position p;
@@
 struct msgbuf_tx_flowring_delete_req * cocci_id@p ;
...
position p;
@@
 struct msgbuf_ring_status * cocci_id@p ;
...
typedef __le32;
@@
 struct msgbuf_ioctl_req_hdr {  struct msgbuf_common_hdr msg ;  __le32 cmd ;  __le16 trans_id ;  __le16 input_buf_len ;  __le16 output_buf_len ;  __le16 rsvd0 [ 3 ] ;  struct msgbuf_buf_addr req_buf_addr ;  __le32 rsvd1 [ 2 ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct msgbuf_tx_flowring_delete_req {  struct msgbuf_common_hdr msg ;  __le16 flow_ring_id ;  __le16 reason ;  __le32 rsvd0 [ 7 ] ; } cocci_id@p ;
...
position p;
@@
 struct msgbuf_rx_complete * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct msgbuf_tx_msghdr {  struct msgbuf_common_hdr msg ;  u8 txhdr [ ETH_HLEN ] ;  u8 flags ;  u8 seg_cnt ;  struct msgbuf_buf_addr metadata_buf_addr ;  struct msgbuf_buf_addr data_buf_addr ;  __le16 metadata_buf_len ;  __le16 data_len ;  __le32 rsvd0 ; } cocci_id@p ;
...
position p;
@@
 struct msgbuf_completion_hdr {  __le16 status ;  __le16 flow_ring_id ; } cocci_id@p ;
...
typedef __le32;
@@
 struct msgbuf_rx_ioctl_resp_or_event {  struct msgbuf_common_hdr msg ;  __le16 host_buf_len ;  __le16 rsvd0 [ 3 ] ;  struct msgbuf_buf_addr host_buf_addr ;  __le32 rsvd1 [ 4 ] ; } cocci_id@p ;
...
typedef __le32;
@@
 struct msgbuf_rx_complete {  struct msgbuf_common_hdr msg ;  struct msgbuf_completion_hdr compl_hdr ;  __le16 metadata_len ;  __le16 data_len ;  __le16 data_offset ;  __le16 flags ;  __le32 rx_status_0 ;  __le32 rx_status_1 ;  __le32 rsvd0 ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct brcmf_msgbuf_work_item {  struct list_head queue ;  u32 flowid ;  int ifidx ;  u8 sa [ ETH_ALEN ] ;  u8 da [ ETH_ALEN ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,u16,wait_queue_head_t,spinlock_t,dma_addr_t;
@@
...
position p;
@@
 struct msgbuf_tx_status {  struct msgbuf_common_hdr msg ;  struct msgbuf_completion_hdr compl_hdr ;  __le16 metadata_len ;  __le16 tx_status ; } cocci_id@p ;
...
position p;
@@
 enum proto_addr_mode cocci_id@p ;
...
position p;
@@
 struct msgbuf_rx_bufpost * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct brcmf_msgbuf * msgbuf ) ;
...
position p;
@@
 struct msgbuf_ioctl_resp_hdr * cocci_id@p ;
