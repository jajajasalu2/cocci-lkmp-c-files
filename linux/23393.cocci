...
position p;
@@
 const struct wm8580_driver_data cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM8580_NUM_SUPPLIES ] ;
...
position p;
@@
 struct wm8580_priv {  struct regmap * regmap ;  struct regulator_bulk_data supplies [ WM8580_NUM_SUPPLIES ] ;  struct pll_state a ;  struct pll_state b ;  const struct wm8580_driver_data * drvdata ;  int sysclk [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct {  unsigned int div ;  unsigned int freqmode ;  unsigned int postscale ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct _pll_div {  u32 prescale : 1 ;  u32 postscale : 1 ;  u32 freqmode : 2 ;  u32 n : 4 ;  u32 k : 24 ; } cocci_id@p ;
...
position p;
@@
 struct pll_state {  unsigned int in ;  unsigned int out ; } cocci_id@p ;
...
position p;
@@
 struct wm8580_driver_data {  int num_dacs ; } cocci_id@p ;
