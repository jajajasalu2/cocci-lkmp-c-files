...
position p;
@@
 struct efa_comp_ctx * cocci_id@p ;
...
typedef u8,u32;
@@
 struct efa_comp_ctx {  struct completion wait_event ;  struct efa_admin_acq_entry * user_cqe ;  u32 comp_size ;  enum efa_cmd_status status ;  u8 comp_status ;  u8 cmd_opcode ;  u8 occupied ; } cocci_id@p ;
...
position p;
@@
 enum efa_cmd_status { EFA_CMD_SUBMITTED , EFA_CMD_COMPLETED , } cocci_id@p ;
...
position p;
@@
 struct efa_com_aenq * cocci_id@p ;
...
position p;
@@
 struct efa_admin_mmio_req_read_less_resp * cocci_id@p ;
...
position p;
@@
 struct efa_admin_aenq_entry cocci_id@p ;
...
position p;
@@
 struct efa_com_mmio_read * cocci_id@p ;
...
position p;
@@
 struct efa_aenq_handlers * cocci_id@p ;
...
position p;
@@
 struct efa_admin_aenq_common_desc * cocci_id@p ;
...
position p;
@@
 struct efa_com_admin_sq * cocci_id@p ;
...
position p;
@@
 enum efa_regs_reset_reason_types cocci_id@p ;
...
position p;
@@
 struct efa_com_admin_cq * cocci_id@p ;
