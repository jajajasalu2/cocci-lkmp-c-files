...
position p;
@@
 enum mlxsw_reg_mpar_i_e cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MPAT_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_SBIB_LEN ] ;
...
position p;
@@
 enum mlxsw_reg_mpat_span_type cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_span_parms cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_span_entry_ops * const cocci_id@p [ ] ;
...
position p;
@@
 const struct mlxsw_sp_span_entry_ops * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_span_inspected_port * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MPAR_LEN ] ;
