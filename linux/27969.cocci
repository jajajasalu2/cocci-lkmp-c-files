...
symbol cocci_id;
position p;
typedef compat_uptr_t,old_time32_t;
@@
 struct compat_semid_ds {  struct compat_ipc_perm sem_perm ;  old_time32_t sem_otime ;  old_time32_t sem_ctime ;  compat_uptr_t sem_base ;  compat_uptr_t sem_pending ;  compat_uptr_t sem_pending_last ;  compat_uptr_t undo ;  unsigned short sem_nsems ; } cocci_id@p ;
...
position p;
@@
 struct compat_semid64_ds cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ipc_namespace * , struct kern_ipc_perm * ) ;
...
position p;
@@
 struct compat_semid_ds cocci_id@p ;
...
position p;
@@
 const struct old_timespec32 * cocci_id@p ;
...
position p;
@@
 struct sem_undo_list * cocci_id@p ;
...
typedef time64_t;
@@
 struct sem_array {  struct kern_ipc_perm sem_perm ;  time64_t sem_ctime ;  struct list_head pending_alter ;  struct list_head pending_const ;  struct list_head list_id ;  int sem_nsems ;  int complex_count ;  unsigned int use_global_lock ;  struct sem sems [ ] ; } cocci_id@p ;
...
typedef bool;
@@
 struct sem_queue {  struct list_head list ;  struct task_struct * sleeper ;  struct sem_undo * undo ;  struct pid * pid ;  int status ;  struct sembuf * sops ;  struct sembuf * blocking ;  int nsops ;  bool alter ;  bool dupsop ; } cocci_id@p ;
...
@@
 struct sem_undo_list {  refcount_t refcnt ;  spinlock_t lock ;  struct list_head list_proc ; } cocci_id@p ;
...
position p;
@@
 struct sem_undo {  struct list_head list_proc ;  struct rcu_head rcu ;  struct sem_undo_list * ulp ;  struct list_head list_id ;  int semid ;  short * semadj ; } cocci_id@p ;
...
position p;
@@
 struct sembuf cocci_id@p [ SEMOPM_FAST ] ;
