...
position p;
@@
 struct samsung_keypad_platdata cocci_id@p ;
...
position p;
@@
 struct wm831x_backup_pdata cocci_id@p ;
...
position p;
@@
 struct s3c_sdhci_platdata cocci_id@p ;
...
position p;
@@
 struct wm831x_buckv_pdata cocci_id@p ;
...
position p;
@@
 struct wm1250_ev1_pdata cocci_id@p ;
...
position p;
@@
 const struct gpio_led cocci_id@p [ ] ;
...
position p;
@@
 struct wm831x_touch_pdata cocci_id@p ;
...
position p;
@@
 struct wm831x_pdata cocci_id@p ;
...
position p;
@@
 struct dwc2_hsotg_plat cocci_id@p ;
...
position p;
@@
 struct wm831x_status_pdata cocci_id@p ;
...
position p;
@@
 struct s3c2410_platform_i2c cocci_id@p ;
