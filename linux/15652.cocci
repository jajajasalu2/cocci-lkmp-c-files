...
position p;
@@
 struct fw_mgmt_ioc_get_intf_version * cocci_id@p ;
...
position p;
@@
 struct fw_mgmt_ioc_get_backend_version * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u16,dev_t;
@@
 struct fw_mgmt {  struct device * parent ;  struct gb_connection * connection ;  struct kref kref ;  struct list_head node ;  struct ida id_map ;  struct mutex mutex ;  struct completion completion ;  struct cdev cdev ;  struct device * class_device ;  dev_t dev_num ;  unsigned int timeout_jiffies ;  bool disabled ;  bool mode_switch_started ;  bool intf_fw_loaded ;  u8 intf_fw_request_id ;  u8 intf_fw_status ;  u16 intf_fw_major ;  u16 intf_fw_minor ;  u8 backend_fw_request_id ;  u8 backend_fw_status ; } cocci_id@p ;
...
position p;
@@
 struct gb_fw_mgmt_loaded_fw_request * cocci_id@p ;
...
position p;
@@
 struct gb_fw_mgmt_backend_fw_version_request cocci_id@p ;
...
position p;
@@
 struct gb_fw_mgmt_backend_fw_updated_request * cocci_id@p ;
...
position p;
@@
 struct gb_fw_mgmt_backend_fw_update_request cocci_id@p ;
...
position p;
@@
 struct gb_fw_mgmt_interface_fw_version_response cocci_id@p ;
...
position p;
@@
 struct fw_mgmt_ioc_backend_fw_update cocci_id@p ;
...
position p;
@@
 struct gb_fw_mgmt_load_and_validate_fw_request cocci_id@p ;
...
position p;
@@
 struct gb_fw_mgmt_backend_fw_version_response cocci_id@p ;
...
position p;
@@
 struct fw_mgmt_ioc_intf_load_and_validate cocci_id@p ;
