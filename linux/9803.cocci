...
position p;
@@
 struct ath10k_hw_ce_ctrl1_upd cocci_id@p ;
...
position p;
@@
 const struct ath10k_hw_ops cocci_id@p ;
...
position p;
@@
 const struct ath10k_hw_ce_regs cocci_id@p ;
...
position p;
@@
 struct ath10k_hw_ce_ctrl1 cocci_id@p ;
...
position p;
@@
 struct bmi_segmented_metadata * cocci_id@p ;
...
position p;
@@
 const struct ath10k_hw_values cocci_id@p ;
...
position p;
@@
 struct ath10k_hw_ce_misc_regs cocci_id@p ;
...
position p;
@@
 const struct ath10k_hw_clk_params cocci_id@p [ ATH10K_HW_REFCLK_COUNT ] ;
...
position p;
@@
 enum ath10k_hw_cc_wraparound_type cocci_id@p ;
...
position p;
@@
 struct ath10k_hw_ce_host_ie cocci_id@p ;
...
position p;
@@
 const struct ath10k_hw_regs cocci_id@p ;
...
position p;
@@
 struct bmi_segmented_file_header * cocci_id@p ;
...
position p;
@@
 struct ath10k_hw_ce_cmd_halt cocci_id@p ;
...
position p;
@@
 struct ath10k_hw_ce_host_wm_regs cocci_id@p ;
...
position p;
@@
 struct htt_data_tx_completion_ext cocci_id@p ;
...
position p;
@@
 struct ath10k_hw_ce_regs_addr_map cocci_id@p ;
...
position p;
@@
 struct ath10k_hw_ce_dst_src_wm_regs cocci_id@p ;
...
position p;
@@
 const struct ath10k_hw_clk_params * cocci_id@p ;
