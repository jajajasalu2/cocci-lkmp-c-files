...
position p;
@@
 struct max8973_chip * cocci_id@p ;
...
position p;
@@
 struct max8973_regulator_platform_data * cocci_id@p ;
...
position p;
@@
 enum device_id { MAX8973 , MAX77621 , } cocci_id@p ;
