...
position p;
@@
 struct agp_file_private * cocci_id@p ;
...
position p;
@@
 struct agp_segment_priv * cocci_id@p ;
...
position p;
@@
 const struct agp_client * cocci_id@p ;
...
position p;
@@
 struct agp_controller * cocci_id@p ;
...
position p;
@@
 struct agp_allocate cocci_id@p ;
...
position p;
@@
 struct agp_front_data cocci_id@p ;
