...
typedef bool,pid_t;
@@
 struct arm_spe_queue {  struct arm_spe * spe ;  unsigned int queue_nr ;  struct auxtrace_buffer * buffer ;  bool on_heap ;  bool done ;  pid_t pid ;  pid_t tid ;  int cpu ; } cocci_id@p ;
...
position p;
@@
 struct arm_spe_queue * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ARM_SPE_PKT_DESC_MAX ] ;
...
typedef u32;
@@
 struct arm_spe {  struct auxtrace auxtrace ;  struct auxtrace_queues queues ;  struct auxtrace_heap heap ;  u32 auxtrace_type ;  struct perf_session * session ;  struct machine * machine ;  u32 pmu_type ; } cocci_id@p ;
