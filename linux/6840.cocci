...
position p;
@@
 struct esas2r_disc_context * cocci_id@p ;
...
typedef u64,u32;
@@
 u32 cocci_id@p ( struct esas2r_sg_context * sgc , u64 * addr ) ;
...
position p;
@@
 void cocci_id@p ( struct esas2r_adapter * a , struct esas2r_request * rq ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct esas2r_adapter * a , struct esas2r_request * rq ) ;
...
position p;
@@
 void cocci_id@p ( struct esas2r_adapter * a ) ;
