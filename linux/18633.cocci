...
position p;
@@
 struct idle_statedata cocci_id@p [ ] ;
...
typedef u32;
@@
 struct idle_statedata {  u32 cpu_state ;  u32 mpu_logic_state ;  u32 mpu_state ;  u32 mpu_state_vote ; } cocci_id@p ;
...
position p;
@@
 struct clockdomain * cocci_id@p [ MAX_CPUS ] ;
