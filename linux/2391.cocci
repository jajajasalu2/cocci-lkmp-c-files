...
position p;
@@
 const struct txx9dmac_chan * cocci_id@p ;
...
position p;
@@
 struct txx9dmac_platform_data * cocci_id@p ;
...
position p;
@@
 struct txx9dmac_chan cocci_id@p ;
...
position p;
@@
 struct txx9dmac_slave * cocci_id@p ;
...
position p;
@@
 struct txx9dmac_desc * cocci_id@p ;
...
position p;
@@
 struct txx9dmac_hwdesc cocci_id@p ;
...
position p;
@@
 struct txx9dmac_hwdesc32 * cocci_id@p ;
...
position p;
@@
 struct txx9dmac_dev * cocci_id@p ;
...
position p;
@@
 const struct txx9dmac_desc * cocci_id@p ;
...
position p;
@@
 const struct txx9dmac_dev * cocci_id@p ;
