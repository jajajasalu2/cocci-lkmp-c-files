...
position p;
@@
 struct path_verification_work_data * cocci_id@p ;
...
position p;
@@
 struct subchannel_id cocci_id@p ;
...
symbol cocci_id;
position p;
typedef attrib_data_t;
@@
 struct attrib_data_t cocci_id@p ;
...
position p;
@@
 struct dasd_ccw_req * cocci_id@p ;
...
position p;
@@
 struct req_iterator cocci_id@p ;
...
position p;
@@
 struct dasd_cuir_message * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dasd_rssd_perf_stats_t;
@@
 struct dasd_rssd_perf_stats_t cocci_id@p ;
...
position p;
@@
 struct dasd_psf_prssd_data * cocci_id@p ;
...
position p;
@@
 struct dasd_snid_ioctl_data cocci_id@p ;
...
position p;
@@
 struct dasd_snid_data cocci_id@p ;
...
position p;
@@
 struct dasd_oos_message * cocci_id@p ;
...
position p;
@@
 struct dasd_ext_pool_sum cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct itcw * , unsigned int , unsigned int , int , struct dasd_device * , struct dasd_device * , unsigned int , int , unsigned int , unsigned int , unsigned int , unsigned int ) ;
...
position p;
@@
 struct dasd_ckd_host_information * cocci_id@p ;
...
position p;
@@
 struct LRE_eckd_data * cocci_id@p ;
...
position p;
@@
 struct dasd_eckd_private cocci_id@p ;
...
position p;
@@
 struct dasd_dso_ras_ext_range * cocci_id@p ;
...
position p;
@@
 struct dasd_psf_query_host_access * cocci_id@p ;
...
position p;
@@
 struct PFX_eckd_data * cocci_id@p ;
...
position p;
@@
 struct dasd_discipline cocci_id@p ;
...
position p;
@@
 struct dasd_symmio_parms cocci_id@p ;
...
position p;
@@
 struct dasd_rssd_messages cocci_id@p ;
...
position p;
@@
 struct dasd_psf_cuir_response cocci_id@p ;
...
position p;
@@
 struct LO_eckd_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef format_data_t;
@@
 struct format_data_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dasd_information2_t;
@@
 struct dasd_information2_t * cocci_id@p ;
...
position p;
@@
 struct dasd_rssd_features * cocci_id@p ;
...
position p;
@@
 struct dasd_eckd_characteristics cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dasd_device * ) ;
...
position p;
@@
 struct dasd_rssd_lcq * cocci_id@p ;
...
position p;
@@
 struct dasd_dso_ras_data * cocci_id@p ;
...
position p;
@@
 struct {  struct dasd_ccw_req cqr ;  struct ccw1 ccw [ 2 ] ;  char data [ 40 ] ; } * cocci_id@p ;
...
position p;
@@
 struct alias_pav_group * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef format_check_t;
@@
 struct format_check_t * cocci_id@p ;
...
position p;
@@
 struct dasd_ckd_path_group_entry * cocci_id@p ;
...
position p;
@@
 struct DE_eckd_data * cocci_id@p ;
...
position p;
@@
 struct {  struct dasd_ccw_req cqr ;  struct ccw1 ccw ;  char data [ 32 ] ; } * cocci_id@p ;
...
position p;
@@
 struct ext_pool_exhaust_work_data {  struct work_struct worker ;  struct dasd_device * device ;  struct dasd_device * base ; } cocci_id@p ;
...
position p;
@@
 struct ext_pool_exhaust_work_data * cocci_id@p ;
...
position p;
@@
 struct dasd_rssd_vsq * cocci_id@p ;
...
position p;
@@
 struct check_attention_work_data * cocci_id@p ;
...
position p;
@@
 struct dasd_conf_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dasd_erp_fn_t;
@@
 dasd_erp_fn_t cocci_id@p ;
...
position p;
@@
 struct dasd_psf_ssc_data * cocci_id@p ;
...
typedef __u8;
@@
 struct path_verification_work_data {  struct work_struct worker ;  struct dasd_device * device ;  struct dasd_ccw_req cqr ;  struct ccw1 ccw ;  __u8 rcd_buffer [ DASD_ECKD_RCD_DATA_SIZE ] ;  int isglobal ;  __u8 tbvpm ; } cocci_id@p ;
...
typedef __u8;
@@
 struct check_attention_work_data {  struct work_struct worker ;  struct dasd_device * device ;  __u8 lpum ; } cocci_id@p ;
