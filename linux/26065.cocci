...
position p;
@@
 struct msg_stats {  size_t bytes_sent ;  size_t bytes_recvd ;  struct timespec start ;  struct timespec end ; } cocci_id@p ;
...
position p;
@@
 struct sockmap_options cocci_id@p ;
...
typedef bool;
@@
 struct sockmap_options {  int verbose ;  bool base ;  bool sendpage ;  bool data_test ;  bool drop_expected ;  int iov_count ;  int iov_length ;  int rate ; } cocci_id@p ;
...
position p;
@@
 enum { PING_PONG , SENDMSG , BASE , BASE_SENDPAGE , SENDPAGE , } cocci_id@p ;
