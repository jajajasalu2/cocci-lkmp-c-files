...
position p;
@@
 struct da9034_touch * cocci_id@p ;
...
position p;
@@
 enum { EVENT_PEN_DOWN , EVENT_PEN_UP , EVENT_TSI_READY , EVENT_TIMEDOUT , } cocci_id@p ;
...
position p;
@@
 enum { STATE_IDLE , STATE_BUSY , STATE_STOP , STATE_WAIT , } cocci_id@p ;
...
position p;
@@
 struct da9034_touch {  struct device * da9034_dev ;  struct input_dev * input_dev ;  struct delayed_work tsi_work ;  struct notifier_block notifier ;  int state ;  int interval_ms ;  int x_inverted ;  int y_inverted ;  int last_x ;  int last_y ; } cocci_id@p ;
