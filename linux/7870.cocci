...
@@
 struct card_s {  u8 __iomem * winbase ;  u32 phy_winbase ;  u32 ram_size ;  u16 io ;  u16 buff_offset ;  u16 rx_ring_buffers ;  u16 tx_ring_buffers ;  u8 irq ;  port_t ports [ 2 ] ;  struct card_s * next_card ; } cocci_id@p ;
