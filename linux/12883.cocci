...
position p;
@@
 struct e7xxx_error_info cocci_id@p ;
...
typedef u16;
@@
 struct e7xxx_dev_info {  u16 err_dev ;  const char * ctl_name ; } cocci_id@p ;
...
typedef u32;
@@
 struct e7xxx_pvt {  struct pci_dev * bridge_ck ;  u32 tolm ;  u32 remapbase ;  u32 remaplimit ;  const struct e7xxx_dev_info * dev_info ; } cocci_id@p ;
...
position p;
@@
 enum e7xxx_chips { E7500 = 0 , E7501 , E7505 , E7205 , } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct e7xxx_error_info {  u8 dram_ferr ;  u8 dram_nerr ;  u32 dram_celog_add ;  u16 dram_celog_syndrome ;  u32 dram_uelog_add ; } cocci_id@p ;
...
position p;
@@
 const struct e7xxx_dev_info cocci_id@p [ ] ;
