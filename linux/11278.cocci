...
position p;
@@
 const char * cocci_id@p [ GMBUS_NUM_PORTS ] ;
...
typedef u32;
@@
 struct intel_gpio {  struct i2c_adapter adapter ;  struct i2c_algo_bit_data algo ;  struct drm_psb_private * dev_priv ;  u32 reg ; } cocci_id@p ;
