...
typedef u32;
@@
 struct als_state {  struct hid_sensor_hub_callbacks callbacks ;  struct hid_sensor_common common_attributes ;  struct hid_sensor_hub_attribute_info als_illum ;  u32 illum [ CHANNEL_SCAN_INDEX_MAX ] ;  int scale_pre_decml ;  int scale_post_decml ;  int scale_precision ;  int value_offset ; } cocci_id@p ;
...
position p;
@@
 enum { CHANNEL_SCAN_INDEX_INTENSITY = 0 , CHANNEL_SCAN_INDEX_ILLUM = 1 , CHANNEL_SCAN_INDEX_MAX , } cocci_id@p ;
