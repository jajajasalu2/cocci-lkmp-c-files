...
position p;
@@
 const struct tas571x_chip cocci_id@p ;
...
position p;
@@
 struct tas571x_private * cocci_id@p ;
...
position p;
@@
 struct tas571x_private {  const struct tas571x_chip * chip ;  struct regmap * regmap ;  struct regulator_bulk_data supplies [ TAS571X_MAX_SUPPLIES ] ;  struct clk * mclk ;  unsigned int format ;  struct gpio_desc * reset_gpio ;  struct gpio_desc * pdn_gpio ;  struct snd_soc_component_driver component_driver ; } cocci_id@p ;
...
position p;
@@
 struct tas571x_chip {  const char * const * supply_names ;  int num_supply_names ;  const struct snd_kcontrol_new * controls ;  int num_controls ;  const struct regmap_config * regmap_config ;  int vol_reg_size ; } cocci_id@p ;
