...
position p;
@@
 struct uio_dmem_genirq_platdata * cocci_id@p ;
...
position p;
@@
 struct uio_dmem_genirq_pdata * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct uio_dmem_genirq_platdata {  struct uio_info * uioinfo ;  spinlock_t lock ;  unsigned long flags ;  struct platform_device * pdev ;  unsigned int dmem_region_start ;  unsigned int num_dmem_regions ;  void * dmem_region_vaddr [ MAX_UIO_MAPS ] ;  struct mutex alloc_lock ;  unsigned int refcnt ; } cocci_id@p ;
