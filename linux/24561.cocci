...
position p;
@@
 enum caif_direction cocci_id@p ;
...
position p;
@@
 struct cfpkt {  struct sk_buff skb ; } cocci_id@p ;
...
@@
 struct cfpktq {  struct sk_buff_head head ;  atomic_t count ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct cfpkt_priv_data * cocci_id@p ;
...
typedef bool;
@@
 struct cfpkt_priv_data {  struct dev_info dev_info ;  bool erronous ; } cocci_id@p ;
