...
position p;
@@
 struct pcmcia_dynid cocci_id@p ;
...
position p;
@@
 struct pcmcia_dynid {  struct list_head node ;  struct pcmcia_device_id id ; } cocci_id@p ;
...
position p;
@@
 struct pcmcia_callback cocci_id@p ;
