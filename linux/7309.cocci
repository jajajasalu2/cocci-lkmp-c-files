...
position p;
@@
 struct tosa_lcd_data cocci_id@p ;
...
typedef bool;
@@
 struct tosa_lcd_data {  struct spi_device * spi ;  struct lcd_device * lcd ;  struct i2c_client * i2c ;  struct gpio_desc * gpiod_tg ;  int lcd_power ;  bool is_vga ; } cocci_id@p ;
