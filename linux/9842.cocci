...
position p;
@@
 enum { WIL_BOOT_ERR , WIL_BOOT_VANILLA , WIL_BOOT_PRODUCTION , WIL_BOOT_DEVELOPMENT , } cocci_id@p ;
...
position p;
@@
 struct bl_dedicated_registers_v1 cocci_id@p ;
...
position p;
@@
 struct bl_dedicated_registers_v0 cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ WIL_BOARD_FILE_MAX_NAMELEN ] ;
...
position p;
@@
 union {  struct bl_dedicated_registers_v0 bl0 ;  struct bl_dedicated_registers_v1 bl1 ; } cocci_id@p ;
...
position p;
@@
 enum { WIL_SIG_STATUS_VANILLA = 0x0 , WIL_SIG_STATUS_DEVELOPMENT = 0x1 , WIL_SIG_STATUS_PRODUCTION = 0x2 , WIL_SIG_STATUS_CORRUPTED_PRODUCTION = 0x3 , } cocci_id@p ;
