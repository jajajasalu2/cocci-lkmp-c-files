...
position p;
@@
 void cocci_id@p ( struct nfs_commit_info * cinfo , struct inode * inode ) ;
...
position p;
@@
 const struct nfs_commit_completion_ops cocci_id@p ;
...
position p;
@@
 const struct nfs_pgio_completion_ops * cocci_id@p ;
...
position p;
@@
 struct nfs_page * cocci_id@p ( struct nfs_inode * nfsi , struct page * page ) ;
...
position p;
@@
 struct nfs_io_completion cocci_id@p ;
...
position p;
@@
 struct nfs_io_completion {  void ( * complete ) ( void * data ) ;  void * data ;  struct kref refcount ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nfs_page * req ) ;
...
position p;
@@
 struct nfs_direct_req * cocci_id@p ;
...
position p;
@@
 const struct nfs_rw_ops cocci_id@p ;
...
position p;
@@
 struct nfs_mds_commit_info * cocci_id@p ;
