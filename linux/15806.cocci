...
position p;
@@
 struct bcm2835_audio_driver {  struct device_driver driver ;  const char * shortname ;  const char * longname ;  int minchannels ;  bcm2835_audio_newpcm_func newpcm ;  bcm2835_audio_newctl_func newctl ;  enum snd_bcm2835_route route ; } cocci_id@p ;
...
position p;
@@
 enum snd_bcm2835_route cocci_id@p ;
...
position p;
@@
 struct bcm2835_audio_driver * cocci_id@p ;
...
typedef bool;
@@
 struct bcm2835_audio_drivers {  struct bcm2835_audio_driver * audio_driver ;  const bool * is_enabled ; } cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( struct bcm2835_chip * chip , const char * name , enum snd_bcm2835_route route , u32 numchannels ) ;
...
position p;
@@
 struct bcm2835_chip * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct bcm2835_chip * chip ) ;
...
position p;
@@
 struct bcm2835_audio_drivers cocci_id@p [ ] ;
...
position p;
@@
 struct bcm2835_vchi_ctx * cocci_id@p ;
