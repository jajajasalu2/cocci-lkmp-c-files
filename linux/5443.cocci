...
position p;
@@
 struct rockchip_spi * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u32,atomic_t,dma_addr_t;
@@
 struct rockchip_spi {  struct device * dev ;  struct clk * spiclk ;  struct clk * apb_pclk ;  void __iomem * regs ;  dma_addr_t dma_addr_rx ;  dma_addr_t dma_addr_tx ;  const void * tx ;  void * rx ;  unsigned int tx_left ;  unsigned int rx_left ;  atomic_t state ;  u32 fifo_len ;  u32 freq ;  u8 n_bytes ;  u8 rsd ;  bool cs_asserted [ ROCKCHIP_SPI_MAX_CS_NUM ] ; } cocci_id@p ;
