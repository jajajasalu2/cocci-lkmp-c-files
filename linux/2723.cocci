...
position p;
@@
 struct i2c_tiny_usb * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct i2c_adapter * adapter , int cmd , int value , int index , void * data , int len ) ;
...
position p;
@@
 struct i2c_tiny_usb {  struct usb_device * usb_dev ;  struct usb_interface * interface ;  struct i2c_adapter adapter ; } cocci_id@p ;
