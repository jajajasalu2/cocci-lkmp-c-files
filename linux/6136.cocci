...
position p;
@@
 struct intel_quark_mfd * cocci_id@p ;
...
position p;
@@
 struct dw_i2c_platform_data * cocci_id@p ;
...
position p;
@@
 struct intel_quark_mfd {  struct device * dev ;  struct clk * i2c_clk ;  struct clk_lookup * i2c_clk_lookup ; } cocci_id@p ;
...
position p;
@@
 struct mfd_cell_acpi_match cocci_id@p ;
