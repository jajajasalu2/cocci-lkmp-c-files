...
position p;
@@
 struct work_handler_data * cocci_id@p ;
...
position p;
@@
 struct tape3592_kekl_query_order * cocci_id@p ;
...
position p;
@@
 struct tape390_kekl * cocci_id@p ;
...
position p;
@@
 struct tape390_crypt_info * cocci_id@p ;
...
position p;
@@
 struct tape_3590_rdc_data * cocci_id@p ;
...
position p;
@@
 struct tape_3590_sense * cocci_id@p ;
...
position p;
@@
 struct tape3592_kekl_pair * cocci_id@p ;
...
position p;
@@
 struct tape3592_kekl_query_data * cocci_id@p ;
...
position p;
@@
 struct tape390_kekl_pair * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct tape_device * device ) ;
...
position p;
@@
 int cocci_id@p ( struct tape_device * device , int mt_count ) ;
...
position p;
@@
 tape_mtop_fn cocci_id@p [ TAPE_NR_MTOPS ] ;
...
position p;
@@
 struct tape3592_kekl * cocci_id@p ;
...
position p;
@@
 struct tape_request * cocci_id@p ;
...
position p;
@@
 struct tape3592_kekl_set_order * cocci_id@p ;
...
position p;
@@
 struct work_handler_data {  struct tape_device * device ;  enum tape_op op ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct display_struct cocci_id@p ;
...
position p;
@@
 struct tape_3590_disc_data cocci_id@p ;
...
position p;
@@
 struct tape_3590_med_sense * cocci_id@p ;
...
position p;
@@
 struct tape_discipline cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ TAPE_3590_MAX_MSG ] ;
