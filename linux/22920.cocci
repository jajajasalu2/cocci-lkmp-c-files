...
position p;
@@
 void cocci_id@p ( struct snd_info_entry * entry ) ;
...
position p;
@@
 struct snd_info_entry * cocci_id@p ( const char * name , struct snd_info_entry * parent , struct module * module ) ;
...
position p;
@@
 struct snd_info_private_data {  struct snd_info_buffer * rbuffer ;  struct snd_info_buffer * wbuffer ;  struct snd_info_entry * entry ;  void * file_private_data ; } cocci_id@p ;
...
position p;
@@
 struct snd_info_private_data * * cocci_id@p ;
