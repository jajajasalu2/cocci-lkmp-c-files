...
position p;
@@
 struct lpc_ich_priv cocci_id@p ;
...
position p;
@@
 struct lpc_ich_priv {  int chipset ;  int abase ;  int actrl_pbase ;  int gbase ;  int gctrl ;  int abase_save ;  int actrl_pbase_save ;  int gctrl_save ; } cocci_id@p ;
...
position p;
@@
 struct intel_spi_boardinfo * cocci_id@p ;
