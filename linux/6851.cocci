...
symbol cocci_id;
position p;
typedef u16,mempool_t,atomic_t;
@@
 struct fc_exch_mgr {  struct fc_exch_pool __percpu * pool ;  mempool_t * ep_pool ;  struct fc_lport * lport ;  enum fc_class class ;  struct kref kref ;  u16 min_xid ;  u16 max_xid ;  u16 pool_max_index ;  struct {  atomic_t no_free_exch ;  atomic_t no_free_exch_xid ;  atomic_t xid_not_found ;  atomic_t xid_busy ;  atomic_t seq_not_found ;  atomic_t non_bls_resp ; } stats ; } cocci_id@p ;
...
position p;
@@
 struct fc_exch_pool cocci_id@p ;
...
position p;
@@
 const struct fc_frame * cocci_id@p ;
...
position p;
@@
 struct fc_els_ls_rjt * cocci_id@p ;
...
position p;
@@
 enum fc_ba_rjt_explan cocci_id@p ;
...
position p;
@@
 enum fc_els_rjt_explan cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct fc_frame * ) ;
...
typedef bool;
@@
 struct fc_exch_mgr_anchor {  struct list_head ema_list ;  struct fc_exch_mgr * mp ;  bool ( * match ) ( struct fc_frame * ) ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_frame * ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct fc_seq * , void * ) ;
...
position p;
@@
 struct fc_els_ls_acc * cocci_id@p ;
...
position p;
@@
 struct fc_exch_mgr_anchor * cocci_id@p ;
...
position p;
@@
 enum fc_ba_rjt_reason cocci_id@p ;
...
position p;
@@
 enum fc_els_rjt_reason cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct fc_seq * , struct fc_frame * fp , void * arg ) ;
...
position p;
@@
 struct fc_els_rec_acc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_exch * ) ;
...
position p;
@@
 enum fc_pf_rjt_reason cocci_id@p ;
...
position p;
@@
 const struct fc_seq * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_frame * , enum fc_els_rjt_reason , enum fc_els_rjt_explan ) ;
