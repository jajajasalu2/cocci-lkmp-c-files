...
position p;
@@
 struct perf_event * cocci_id@p [ MAX_HWEVENTS ] ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_HWEVENTS ] ;
...
position p;
@@
 void cocci_id@p ( struct pt_regs * regs ) ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_HWEVENTS ] ;
...
typedef u8,u64;
@@
 struct cpu_hw_events {  int n_events ;  int n_percpu ;  int disabled ;  int n_added ;  int n_limited ;  u8 pmcs_enabled ;  struct perf_event * event [ MAX_HWEVENTS ] ;  u64 events [ MAX_HWEVENTS ] ;  unsigned int flags [ MAX_HWEVENTS ] ;  unsigned long mmcr [ 4 ] ;  struct perf_event * limited_counter [ MAX_LIMITED_HWCOUNTERS ] ;  u8 limited_hwidx [ MAX_LIMITED_HWCOUNTERS ] ;  u64 alternatives [ MAX_HWEVENTS ] [ MAX_EVENT_ALTERNATIVES ] ;  unsigned long amasks [ MAX_HWEVENTS ] [ MAX_EVENT_ALTERNATIVES ] ;  unsigned long avalues [ MAX_HWEVENTS ] [ MAX_EVENT_ALTERNATIVES ] ;  unsigned int txn_flags ;  int n_txn_start ;  u64 bhrb_filter ;  unsigned int bhrb_users ;  void * bhrb_context ;  struct perf_branch_stack bhrb_stack ;  struct perf_branch_entry bhrb_entries [ BHRB_MAX_ENTRIES ] ;  u64 ic_init ; } cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ MAX_EVENT_ALTERNATIVES ] ;
