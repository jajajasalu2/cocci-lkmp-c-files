...
position p;
@@
 struct ar5416_eeprom_4k cocci_id@p ;
...
position p;
@@
 struct cal_ctl_data_4k * cocci_id@p ;
...
position p;
@@
 struct modal_eep_4k_header * cocci_id@p ;
...
position p;
@@
 struct cal_data_per_freq_4k * cocci_id@p ;
...
position p;
@@
 struct base_eep_header_4k * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ AR5416_EEP4K_NUM_PD_GAINS ] ;
...
position p;
@@
 struct cal_target_power_ht cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ AR5416_PD_GAINS_IN_MASK ] ;
...
position p;
@@
 struct cal_target_power_leg cocci_id@p ;
...
typedef int16_t;
@@
 int16_t cocci_id@p [ Ar5416RateSize ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ AR5416_NUM_PDADC_VALUES ] ;
