...
position p;
@@
 struct omap_overlay_manager_info cocci_id@p ;
...
position p;
@@
 struct omap_drm_private * cocci_id@p ;
...
position p;
@@
 const struct omap_dss_driver * cocci_id@p ;
...
typedef bool;
@@
 struct omap_crtc_state {  struct drm_crtc_state base ;  unsigned int rotation ;  unsigned int zpos ;  bool manually_updated ; } cocci_id@p ;
...
position p;
@@
 struct omap_irq_wait * cocci_id@p ;
...
position p;
@@
 struct omap_crtc_state cocci_id@p ;
...
@@
 struct omap_crtc {  struct drm_crtc base ;  const char * name ;  struct omap_drm_pipeline * pipe ;  enum omap_channel channel ;  struct videomode vm ;  bool ignore_digit_sync_lost ;  bool enabled ;  bool pending ;  wait_queue_head_t pending_wait ;  struct drm_pending_vblank_event * event ;  struct delayed_work update_work ;  void ( * framedone_handler ) ( void * ) ;  void * framedone_handler_data ; } cocci_id@p ;
...
position p;
@@
 const struct dss_mgr_ops cocci_id@p ;
...
position p;
@@
 struct omap_drm_pipeline * cocci_id@p ;
