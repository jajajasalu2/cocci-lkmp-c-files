...
typedef u8;
@@
 struct ds2482_data {  struct i2c_client * client ;  struct mutex access_lock ;  int w1_count ;  struct ds2482_w1_chan w1_ch [ 8 ] ;  u8 channel ;  u8 read_prt ;  u8 reg_config ; } cocci_id@p ;
...
position p;
@@
 struct ds2482_w1_chan * cocci_id@p ;
...
typedef u8;
@@
 struct ds2482_w1_chan {  struct ds2482_data * pdev ;  u8 channel ;  struct w1_bus_master w1_bm ; } cocci_id@p ;
