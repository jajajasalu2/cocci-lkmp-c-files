...
position p;
@@
 struct xfs_iwalk_ag cocci_id@p ;
...
position p;
@@
 struct xfs_pwork_ctl cocci_id@p ;
...
typedef xfs_ino_t;
@@
 struct xfs_iwalk_ag {  struct xfs_pwork pwork ;  struct xfs_mount * mp ;  struct xfs_trans * tp ;  xfs_ino_t startino ;  struct xfs_inobt_rec_incore * recs ;  unsigned int sz_recs ;  unsigned int nr_recs ;  xfs_iwalk_fn iwalk_fn ;  xfs_inobt_walk_fn inobt_walk_fn ;  void * data ;  unsigned int trim_start : 1 ;  unsigned int skip_empty : 1 ; } cocci_id@p ;
