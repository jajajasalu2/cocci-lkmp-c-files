...
position p;
@@
 struct batadv_attribute * cocci_id@p [ ] ;
...
position p;
@@
 struct batadv_store_mesh_work * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( BATADV_SYSFS_VLAN_SUBDIR_PREFIX ) + 5 ] ;
