...
position p;
@@
 unsigned char cocci_id@p [ DT_MONTH_ALM1 - DT_SECOND_ALM1 + 1 ] ;
...
position p;
@@
 const struct pcf85x63_config * cocci_id@p ;
...
position p;
@@
 struct pcf85x63_config {  struct regmap_config regmap ;  unsigned int num_nvram ; } cocci_id@p ;
...
position p;
@@
 struct pcf85363 {  struct rtc_device * rtc ;  struct regmap * regmap ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ DT_YEARS + 1 ] ;
