...
position p;
@@
 struct epic_rx_desc cocci_id@p ;
...
position p;
@@
 struct epic_private cocci_id@p ;
...
position p;
@@
 struct epic_chip_info {  const char * name ;  int drv_flags ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct epic_private * , int ) ;
...
typedef u32;
@@
 struct epic_rx_desc {  u32 rxstatus ;  u32 bufaddr ;  u32 buflength ;  u32 next ; } cocci_id@p ;
...
position p;
@@
 enum desc_status_bits { DescOwn = 0x8000 , } cocci_id@p ;
...
position p;
@@
 struct epic_tx_desc cocci_id@p ;
...
position p;
@@
 enum chip_capability_flags { MII_PWRDWN = 1 , TYPE2_INTR = 2 , NO_MII = 4 , } cocci_id@p ;
...
position p;
@@
 const struct epic_chip_info cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int phy_id , int loc , int val ) ;
...
typedef u32;
@@
 struct epic_tx_desc {  u32 txstatus ;  u32 bufaddr ;  u32 buflength ;  u32 next ; } cocci_id@p ;
...
position p;
@@
 enum CommandBits { StopRx = 1 , StartRx = 2 , TxQueued = 4 , RxQueued = 8 , StopTxDMA = 0x20 , StopRxDMA = 0x40 , RestartTx = 0x80 , } cocci_id@p ;
...
position p;
@@
 enum IntrStatus { TxIdle = 0x40000 , RxIdle = 0x20000 , IntrSummary = 0x010000 , PCIBusErr170 = 0x7000 , PCIBusErr175 = 0x1000 , PhyEvent175 = 0x8000 , RxStarted = 0x0800 , RxEarlyWarn = 0x0400 , CntFull = 0x0200 , TxUnderrun = 0x0100 , TxEmpty = 0x0080 , TxDone = 0x0020 , RxError = 0x0010 , RxOverflow = 0x0008 , RxFull = 0x0004 , RxHeader = 0x0002 , RxDone = 0x0001 , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int budget ) ;
...
position p;
@@
 enum { SMSC_83C170_0 , SMSC_83C170 , SMSC_83C175 , } cocci_id@p ;
