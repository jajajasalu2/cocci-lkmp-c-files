...
position p;
@@
 struct cma_dev_group cocci_id@p ;
...
position p;
@@
 struct cma_dev_port_group {  unsigned int port_num ;  struct cma_dev_group * cma_dev_group ;  struct config_group group ; } cocci_id@p ;
...
position p;
@@
 struct cma_dev_port_group cocci_id@p ;
...
position p;
@@
 struct cma_dev_group {  char name [ IB_DEVICE_NAME_MAX ] ;  struct config_group device_group ;  struct config_group ports_group ;  struct cma_dev_port_group * ports ; } cocci_id@p ;
