...
position p;
@@
 struct pci_osc_bit_struct * cocci_id@p ;
...
typedef u32;
@@
 struct pci_osc_bit_struct {  u32 bit ;  char * desc ; } cocci_id@p ;
...
typedef acpi_handle;
@@
 struct acpi_handle_node {  struct list_head node ;  acpi_handle handle ; } cocci_id@p ;
...
position p;
@@
 struct acpi_pci_root_info * cocci_id@p ;
...
position p;
@@
 struct acpi_pci_root_ops * cocci_id@p ;
...
position p;
@@
 struct acpi_handle_node cocci_id@p ;
