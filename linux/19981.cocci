...
position p;
@@
 union {  union ieee754sp ( * b ) ( union ieee754sp , union ieee754sp ) ;  union ieee754sp ( * u ) ( union ieee754sp ) ; } cocci_id@p ;
...
position p;
@@
 union mips_instruction * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pt_regs * , struct mips_fpu_struct * , mips_instruction , void __user * * ) ;
...
position p;
@@
 struct mips_fpu_struct * cocci_id@p ;
...
position p;
@@
 union {  union ieee754dp ( * b ) ( union ieee754dp , union ieee754dp ) ;  union ieee754dp ( * u ) ( union ieee754dp ) ; } cocci_id@p ;
...
position p;
@@
 union ieee754sp ( * cocci_id@p ) ( union ieee754sp , union ieee754sp , union ieee754sp ) ;
...
position p;
@@
 union ieee754dp ( * cocci_id@p ) ( union ieee754dp , union ieee754dp , union ieee754dp ) ;
...
position p;
@@
 int cocci_id@p ( struct pt_regs * , struct mips_fpu_struct * , mips_instruction ) ;
...
position p;
@@
 struct mm_decoded_insn cocci_id@p ;
...
typedef s64;
@@
 union {  union ieee754dp d ;  union ieee754sp s ;  int w ;  s64 l ; } cocci_id@p ;
