...
position p;
@@
 vchiq_mmal_buffer_cb cocci_id@p ;
...
position p;
@@
 struct vchiq_mmal_instance * * cocci_id@p ;
...
position p;
@@
 struct mmal_msg_context * cocci_id@p ;
...
position p;
@@
 union mmal_es_specific_format cocci_id@p ;
...
position p;
@@
 struct mmal_msg_header cocci_id@p ;
...
position p;
@@
 struct vchiq_mmal_instance {  struct vchi_service_handle * handle ;  struct mutex vchiq_mutex ;  void * bulk_scratch ;  struct idr context_map ;  struct mutex context_map_lock ;  int component_idx ;  struct vchiq_mmal_component component [ VCHIQ_MMAL_MAX_COMPONENTS ] ;  struct workqueue_struct * bulk_wq ; } cocci_id@p ;
...
position p;
@@
 const enum vchi_callback_reason cocci_id@p ;
...
position p;
@@
 struct vchi_held_msg * cocci_id@p ;
...
typedef u32,s64;
@@
 struct mmal_msg_context {  struct vchiq_mmal_instance * instance ;  int handle ;  union {  struct {  struct work_struct work ;  struct work_struct buffer_to_host_work ;  struct vchiq_mmal_instance * instance ;  struct vchiq_mmal_port * port ;  struct mmal_buffer * buffer ;  unsigned long buffer_used ;  u32 mmal_flags ;  s64 pts ;  s64 dts ;  int status ; } bulk ;  struct {  struct vchi_held_msg msg_handle ;  struct mmal_msg * msg ;  u32 msg_len ;  struct completion cmplt ; } sync ; } u ; } cocci_id@p ;
...
position p;
@@
 struct mmal_msg_port_parameter_get cocci_id@p ;
...
position p;
@@
 enum mmal_msg_port_action_type cocci_id@p ;
...
position p;
@@
 struct vchi_instance_handle * cocci_id@p ;
...
position p;
@@
 struct service_creation cocci_id@p ;
