...
position p;
@@
 struct vmxnet3_intr * cocci_id@p ;
...
position p;
@@
 struct vmxnet3_rx_buf_info cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_RxCompDescExt * cocci_id@p ;
...
position p;
@@
 struct vmxnet3_tx_ctx * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_TxCompDesc cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_TxDataDesc * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_PMConf * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_RxQueueDesc * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_RxDesc * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_CoalesceScheme cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_DSDevRead * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_TxQueueConf * cocci_id@p ;
...
position p;
@@
 const struct Vmxnet3_RxCompDesc * cocci_id@p ;
...
position p;
@@
 struct vmxnet3_adapter cocci_id@p ;
...
position p;
@@
 union Vmxnet3_GenericDesc cocci_id@p ;
...
position p;
@@
 const struct Vmxnet3_RxDesc * cocci_id@p ;
...
position p;
@@
 struct UPT1_RSSConf cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct vmxnet3_adapter * adapter , u8 * mac ) ;
...
position p;
@@
 struct vmxnet3_cmd_ring * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_TxQueueDesc cocci_id@p ;
...
position p;
@@
 struct vmxnet3_rx_queue * cocci_id@p ;
...
position p;
@@
 const struct Vmxnet3_TxDesc * cocci_id@p ;
...
position p;
@@
 struct vmxnet3_tx_buf_info * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_DriverShared cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_RxCompDesc * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_TxDesc cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_RxFilterConf * cocci_id@p ;
...
position p;
@@
 struct Vmxnet3_RxQueueConf * cocci_id@p ;
...
position p;
@@
 struct vmxnet3_rx_ctx * cocci_id@p ;
...
position p;
@@
 union Vmxnet3_CmdInfo * cocci_id@p ;
...
position p;
@@
 struct vmxnet3_tx_queue * cocci_id@p ;
...
position p;
@@
 union {  void * ptr ;  struct ethhdr * eth ;  struct vlan_ethhdr * veth ;  struct iphdr * ipv4 ;  struct ipv6hdr * ipv6 ;  struct tcphdr * tcp ; } cocci_id@p ;
