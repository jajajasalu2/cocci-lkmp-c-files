...
position p;
@@
 int ( * cocci_id@p ) ( struct platform_device * pdev , struct dw_spi_mmio * dwsmmio ) ;
...
position p;
@@
 struct dw_spi_mmio {  struct dw_spi dws ;  struct clk * clk ;  struct clk * pclk ;  void * priv ; } cocci_id@p ;
...
position p;
@@
 struct dw_spi_mscc {  struct regmap * syscon ;  void __iomem * spi_mst ; } cocci_id@p ;
