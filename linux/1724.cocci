...
position p;
@@
 struct adis16400_chip_info {  const struct iio_chan_spec * channels ;  const int num_channels ;  const long flags ;  unsigned int gyro_scale_micro ;  unsigned int accel_scale_micro ;  int temp_scale_nano ;  int temp_offset ;  int ( * set_freq ) ( struct adis16400_state * st , unsigned int freq ) ;  int ( * get_freq ) ( struct adis16400_state * st ) ; } cocci_id@p ;
...
position p;
@@
 struct adis16400_chip_info cocci_id@p [ ] ;
...
position p;
@@
 const struct adis16400_chip_info * cocci_id@p ;
...
position p;
@@
 struct adis16400_state * cocci_id@p ;
...
position p;
@@
 enum adis16400_chip_variant { ADIS16300 , ADIS16334 , ADIS16350 , ADIS16360 , ADIS16362 , ADIS16364 , ADIS16367 , ADIS16400 , ADIS16445 , ADIS16448 , } cocci_id@p ;
...
position p;
@@
 struct adis16400_state {  struct adis16400_chip_info * variant ;  int filt_int ;  struct adis adis ;  unsigned long avail_scan_mask [ 2 ] ; } cocci_id@p ;
