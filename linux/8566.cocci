...
position p;
@@
 const struct crc_pair cocci_id@p [ ] ;
...
position p;
@@
 const struct reg_addr * cocci_id@p ;
...
position p;
@@
 struct crc_pair {  int offset ;  int size ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ETHTOOL_FWVERS_LEN ] ;
...
typedef u32;
@@
 const struct {  u32 offset ;  int size ; } cocci_id@p [ ] ;
...
position p;
@@
 const char cocci_id@p [ BNX2X_PRI_FLAG_LEN ] [ ETH_GSTRING_LEN ] ;
...
position p;
@@
 const char cocci_id@p [ BNX2X_NUM_TESTS_SF ] [ ETH_GSTRING_LEN ] ;
...
position p;
@@
 const struct wreg_addr * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ T_ETH_INDIRECTION_TABLE_SIZE ] ;
...
typedef u32;
@@
 const struct {  char * name ;  u32 offset ;  u32 hw_mask [ BNX2X_CHIP_MAX_OFST ] ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 const struct {  u32 hw ;  u32 offset0 ;  u32 offset1 ;  u32 mask ; } cocci_id@p [ ] ;
...
typedef bool;
@@
 const struct {  long offset ;  int size ;  bool is_port_stat ;  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 char cocci_id@p [ MAX_QUEUE_NAME_LEN + 1 ] ;
...
position p;
@@
 enum { BNX2X_CHIP_E1_OFST = 0 , BNX2X_CHIP_E1H_OFST , BNX2X_CHIP_E2_OFST , BNX2X_CHIP_E3_OFST , BNX2X_CHIP_E3B0_OFST , BNX2X_CHIP_MAX_OFST , } cocci_id@p ;
...
position p;
@@
 const struct {  long offset ;  int size ;  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct extended_dev_info_shared_cfg cocci_id@p ;
...
position p;
@@
 enum { BNX2X_PRI_FLAG_ISCSI , BNX2X_PRI_FLAG_FCOE , BNX2X_PRI_FLAG_STORAGE , BNX2X_PRI_FLAG_LEN , } cocci_id@p ;
