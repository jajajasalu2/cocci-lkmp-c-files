...
position p;
@@
 struct bfa_mbox_cmd * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioc * ioc ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioc * ioc , char * serial_num ) ;
...
position p;
@@
 union bfa_flash_cmd_reg cocci_id@p ;
...
position p;
@@
 struct bfi_ioc_image_hdr cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct bfa_ioc * ioc , u32 fmaddr ) ;
...
position p;
@@
 struct bfi_ioc_getattr_req cocci_id@p ;
...
typedef u32;
@@
 enum bfa_status cocci_id@p ( struct bfa_ioc * ioc , enum bfi_fwboot_type boot_type , u32 boot_param ) ;
...
position p;
@@
 struct bfa_ioc_attr * cocci_id@p ;
...
position p;
@@
 union bfa_flash_addr_reg cocci_id@p ;
...
position p;
@@
 struct bfa_ioc_mbox_mod * cocci_id@p ;
...
position p;
@@
 union bfa_flash_dev_status_reg cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioc * , enum bfa_ioc_event ) ;
...
position p;
@@
 enum bfi_ioc_img_ver_cmp cocci_id@p ;
...
position p;
@@
 struct bfa_mfg_block cocci_id@p ;
...
position p;
@@
 struct bfi_flash_read_req * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_mbox_cmd_cbfn_t;
@@
 bfa_mbox_cmd_cbfn_t cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioc * ioc , char * optrom_ver ) ;
...
position p;
@@
 struct bfi_ioc_attr * cocci_id@p ;
...
position p;
@@
 struct bfa_flash_attr cocci_id@p ;
...
position p;
@@
 struct bfa_ioc_cbfn * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioc * ioc , char * chip_rev ) ;
...
position p;
@@
 struct bfi_flash_query_req * cocci_id@p ;
...
position p;
@@
 struct bfa_adapter_attr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioc * ioc , char * fw_ver ) ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct bfa_ioc * ioc ) ;
...
position p;
@@
 struct bfi_ioc_ctrl_req cocci_id@p ;
...
position p;
@@
 enum bfi_fwboot_type cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioc * ioc , char * manufacturer ) ;
...
position p;
@@
 enum bfa_flash_cmd { BFA_FLASH_FAST_READ = 0x0b , BFA_FLASH_WRITE_ENABLE = 0x06 , BFA_FLASH_SECTOR_ERASE = 0xd8 , BFA_FLASH_WRITE = 0x02 , BFA_FLASH_READ_STATUS = 0x05 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_ioc * ioc , char * model ) ;
...
position p;
@@
 struct bfa_ioc_notify * cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct bfa_ioc * ioc , bool force ) ;
...
position p;
@@
 struct bfi_flash_write_req * cocci_id@p ;
...
position p;
@@
 union {  struct bfi_flash_query_rsp * query ;  struct bfi_flash_write_rsp * write ;  struct bfi_flash_read_rsp * read ;  struct bfi_mbmsg * msg ; } cocci_id@p ;
...
position p;
@@
 struct bfa_sm_table cocci_id@p [ ] ;
