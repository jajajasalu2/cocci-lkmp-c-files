...
position p;
@@
 int cocci_id@p ( struct svc_rqst * rqstp ) ;
...
position p;
@@
 const struct svc_xprt * cocci_id@p ;
...
position p;
@@
 struct svc_deferred_req * cocci_id@p ;
...
position p;
@@
 struct cache_deferred_req * cocci_id@p ( struct cache_req * req ) ;
...
position p;
@@
 struct svc_deferred_req * cocci_id@p ( struct svc_xprt * xprt ) ;
