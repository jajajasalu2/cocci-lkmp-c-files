...
position p;
@@
 struct rt_sigframe {  struct siginfo __user * pinfo ;  void * puc ;  struct siginfo info ;  struct ucontext uc ;  long long retcode [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct sigframe {  struct sigcontext sc ;  unsigned long extramask [ _NSIG_WORDS - 1 ] ;  long long retcode [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ksignal * ksig , struct pt_regs * regs ) ;
