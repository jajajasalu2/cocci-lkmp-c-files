...
position p;
@@
 struct ps3av_info_monitor * cocci_id@p ;
...
position p;
@@
 const struct ps3av_send_hdr * cocci_id@p ;
...
typedef u32;
@@
 const struct ps3av_monitor_quirk {  const char * monitor_name ;  u32 clear_60 ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct avset_video_mode * cocci_id@p ;
...
position p;
@@
 const struct ps3av_pkt_av_get_monitor_info * cocci_id@p ;
...
position p;
@@
 struct ps3av_send_hdr * cocci_id@p ;
...
typedef u32;
@@
 const struct avset_video_mode {  u32 cs ;  u32 fmt ;  u32 vid ;  u32 aspect ;  u32 x ;  u32 y ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct ps3av_reply_hdr * cocci_id@p ;
...
position p;
@@
 const struct ps3av_info_monitor * cocci_id@p ;
...
position p;
@@
 const struct ps3av_monitor_quirk * cocci_id@p ;
...
position p;
@@
 const struct {  unsigned mask : 19 ;  unsigned id : 4 ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ps3av_reply_hdr * cocci_id@p ;
...
position p;
@@
 enum ps3av_mode_num cocci_id@p ;
...
position p;
@@
 const struct ps3av_info_audio * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( info -> monitor_id ) * 3 + 1 ] ;
...
position p;
@@
 const struct ps3av_pkt_av_get_hw_conf * cocci_id@p ;
