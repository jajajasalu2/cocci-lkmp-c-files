...
position p;
@@
 struct skl_base_cfg * cocci_id@p ;
...
position p;
@@
 struct skl_dsp_cores * cocci_id@p ;
...
position p;
@@
 struct skl_algo_cfg * cocci_id@p ;
...
position p;
@@
 union skl_ssp_dma_node cocci_id@p ;
...
position p;
@@
 const struct skl_dsp_ops cocci_id@p [ ] ;
...
position p;
@@
 struct skl_dma_control cocci_id@p ;
...
position p;
@@
 struct skl_cpr_pin_fmt cocci_id@p ;
...
position p;
@@
 struct skl_up_down_mixer_cfg * cocci_id@p ;
...
position p;
@@
 enum skl_ipc_pipeline_state cocci_id@p ;
...
position p;
@@
 struct skl_src_module_cfg * cocci_id@p ;
...
position p;
@@
 struct skl_dsp_loader_ops cocci_id@p ;
...
position p;
@@
 struct skl_base_outfmt_cfg cocci_id@p ;
...
position p;
@@
 union skl_connector_node_id cocci_id@p ;
...
position p;
@@
 struct skl_ipc_init_instance_msg cocci_id@p ;
...
position p;
@@
 struct skl_ipc_bind_unbind_msg cocci_id@p ;
...
position p;
@@
 struct hdac_ext_stream * cocci_id@p ;
...
position p;
@@
 struct skl_audio_data_format * cocci_id@p ;
...
position p;
@@
 struct skl_module_inst_id cocci_id@p ;
...
position p;
@@
 struct skl_ipc_large_config_msg cocci_id@p ;
