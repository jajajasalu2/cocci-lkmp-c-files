...
position p;
@@
 struct nfs4_layoutcommit_args * cocci_id@p ;
...
position p;
@@
 struct parallel_io {  struct kref refcnt ;  void ( * pnfs_callback ) ( void * data ) ;  void * data ; } cocci_id@p ;
...
position p;
@@
 struct pnfs_block_dev_map * cocci_id@p ;
...
position p;
@@
 struct layout_verification * cocci_id@p ;
...
position p;
@@
 struct pnfs_block_extent cocci_id@p ;
...
position p;
@@
 struct pnfs_block_dev cocci_id@p ;
...
position p;
@@
 struct pnfs_block_layout * cocci_id@p ;
...
typedef u64,u32;
@@
 struct layout_verification {  u32 mode ;  u64 start ;  u64 inval ;  u64 cowread ; } cocci_id@p ;
...
position p;
@@
 const struct nfs4_deviceid * cocci_id@p ;
