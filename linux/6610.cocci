...
position p;
@@
 struct bfa_cee_lldp_cfg_s * cocci_id@p ;
...
position p;
@@
 union bfi_cee_i2h_msg_u * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_port_endis_cbfn_t;
@@
 bfa_port_endis_cbfn_t cocci_id@p ;
...
position p;
@@
 struct bfi_cee_get_rsp_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_cee_reset_stats_cbfn_t;
@@
 bfa_cee_reset_stats_cbfn_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_cee_get_stats_cbfn_t;
@@
 bfa_cee_get_stats_cbfn_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_port_stats_cbfn_t;
@@
 bfa_port_stats_cbfn_t cocci_id@p ;
...
position p;
@@
 struct bfi_port_generic_req_s * cocci_id@p ;
...
position p;
@@
 struct bfi_cee_reset_stats_s * cocci_id@p ;
...
position p;
@@
 struct bfi_port_get_stats_req_s * cocci_id@p ;
...
position p;
@@
 struct bfi_cee_get_req_s * cocci_id@p ;
...
position p;
@@
 union bfi_port_i2h_msg_u * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_cee_get_attr_cbfn_t;
@@
 bfa_cee_get_attr_cbfn_t cocci_id@p ;
