...
position p;
@@
 struct amdtp_dot {  unsigned int pcm_channels ;  struct dot_state state ;  struct snd_rawmidi_substream * midi [ MAX_MIDI_PORTS ] ;  int midi_fifo_used [ MAX_MIDI_PORTS ] ;  int midi_fifo_limit ; } cocci_id@p ;
...
typedef u8;
@@
 struct dot_state {  u8 carry ;  u8 idx ;  unsigned int off ; } cocci_id@p ;
