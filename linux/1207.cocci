...
position p;
@@
 void cocci_id@p ( struct uhci_hcd * uhci ) ;
...
position p;
@@
 void cocci_id@p ( struct uhci_hcd * uhci , enum uhci_rh_state new_state ) ;
