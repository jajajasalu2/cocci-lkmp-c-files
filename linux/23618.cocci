...
position p;
@@
 char cocci_id@p [ RSND_DVC_NAME_SIZE ] ;
...
position p;
@@
 struct rsnd_dvc {  struct rsnd_mod mod ;  struct rsnd_kctrl_cfg_m volume ;  struct rsnd_kctrl_cfg_m mute ;  struct rsnd_kctrl_cfg_s ren ;  struct rsnd_kctrl_cfg_s rup ;  struct rsnd_kctrl_cfg_s rdown ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ RSND_MAX_CHANNELS ] ;
