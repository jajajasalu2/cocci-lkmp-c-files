...
position p;
@@
 struct atmel_trng {  struct clk * clk ;  void __iomem * base ;  struct hwrng rng ; } cocci_id@p ;
...
position p;
@@
 const struct atmel_trng_data * cocci_id@p ;
...
typedef bool;
@@
 struct atmel_trng_data {  bool has_half_rate ; } cocci_id@p ;
