...
symbol cocci_id;
position p;
typedef flexcop_dma_addr_index_t;
@@
 flexcop_dma_addr_index_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef flexcop_dma_index_t;
@@
 flexcop_dma_index_t cocci_id@p ;
