...
position p;
@@
 struct vnt_usb_send_context * cocci_id@p ;
...
position p;
@@
 union vnt_tx_data_head * cocci_id@p ;
...
position p;
@@
 struct vnt_tx_buffer * cocci_id@p ;
...
typedef u16;
@@
 const u16 cocci_id@p [ 2 ] [ MAX_RATE ] ;
...
position p;
@@
 struct vnt_beacon_buffer * cocci_id@p ;
