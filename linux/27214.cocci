...
position p;
@@
 struct ext4_system_blocks cocci_id@p ;
...
position p;
@@
 struct ext4_system_zone cocci_id@p ;
...
typedef ext4_fsblk_t;
@@
 struct ext4_system_zone {  struct rb_node node ;  ext4_fsblk_t start_blk ;  unsigned int count ; } cocci_id@p ;
