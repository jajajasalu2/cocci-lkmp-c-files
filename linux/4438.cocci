...
position p;
@@
 struct hwicap_driver_config cocci_id@p ;
...
position p;
@@
 const struct config_registers cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p [ HWICAP_DEVICES ] ;
...
position p;
@@
 struct hwicap_drvdata cocci_id@p ;
...
position p;
@@
 const struct hwicap_driver_config * cocci_id@p ;
