...
symbol cocci_id;
position p;
typedef bool,line_walk_callback_t;
@@
 struct __line_walk_param {  bool recursive ;  line_walk_callback_t callback ;  void * data ;  int retval ; } cocci_id@p ;
...
position p;
@@
 struct __find_variable_param {  const char * name ;  Dwarf_Addr addr ; } cocci_id@p ;
...
position p;
@@
 struct __addr_die_search_param {  Dwarf_Addr addr ;  Dwarf_Die * die_mem ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef line_walk_callback_t;
@@
 line_walk_callback_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( Dwarf_Die * die_mem , void * data ) ;
