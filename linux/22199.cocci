...
symbol cocci_id;
position p;
typedef freelist_idx_t;
@@
 freelist_idx_t cocci_id@p ;
...
position p;
@@
 union freelist_init_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * unused ) ;
...
position p;
@@
 void cocci_id@p ( struct kmem_cache * cachep , struct kmem_cache_node * n , struct page * page , void * * list ) ;
...
position p;
@@
 int cocci_id@p ( struct kmem_cache * cache , struct kmem_cache_node * n , int tofree ) ;
...
position p;
@@
 struct array_cache {  unsigned int avail ;  unsigned int limit ;  unsigned int batchcount ;  unsigned int touched ;  void * entry [ ] ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct alien_cache {  spinlock_t lock ;  struct array_cache ac ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kmem_cache * cachep , void * * objpp , int len , int node , struct list_head * list ) ;
...
position p;
@@
 void cocci_id@p ( struct kmem_cache * cachep , void * * list ) ;
...
position p;
@@
 char cocci_id@p [ MAX_SLABINFO_WRITE + 1 ] ;
...
position p;
@@
 union freelist_init_state {  struct {  unsigned int pos ;  unsigned int * list ;  unsigned int count ; } ;  struct rnd_state rnd_state ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kmem_cache * cachep , struct list_head * list ) ;
