...
position p;
@@
 enum irq_mode { IRQ_REMAPPING , IRQ_POSTING , } cocci_id@p ;
...
position p;
@@
 struct acpi_dmar_device_scope cocci_id@p ;
...
position p;
@@
 struct acpi_dmar_hardware_unit * cocci_id@p ;
...
position p;
@@
 struct hpet_scope cocci_id@p [ MAX_HPET_TBS ] ;
...
position p;
@@
 struct irq_remap_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct intel_iommu * iommu ) ;
...
position p;
@@
 struct acpi_table_dmar * cocci_id@p ;
...
typedef u16;
@@
 struct set_msi_sid_data {  struct pci_dev * pdev ;  u16 alias ;  int count ;  int busmatch_count ; } cocci_id@p ;
...
typedef u8;
@@
 struct hpet_scope {  struct intel_iommu * iommu ;  u8 id ;  unsigned int bus ;  unsigned int devfn ; } cocci_id@p ;
...
position p;
@@
 struct set_msi_sid_data * cocci_id@p ;
...
position p;
@@
 struct ioapic_scope {  struct intel_iommu * iommu ;  unsigned int id ;  unsigned int bus ;  unsigned int devfn ; } cocci_id@p ;
...
position p;
@@
 struct acpi_dmar_pci_path cocci_id@p ;
...
position p;
@@
 struct ioapic_scope cocci_id@p [ MAX_IO_APICS ] ;
...
position p;
@@
 struct intel_ir_data * cocci_id@p ;
...
typedef u8,u16;
@@
 struct irq_2_iommu {  struct intel_iommu * iommu ;  u16 irte_index ;  u16 sub_handle ;  u8 irte_mask ;  enum irq_mode mode ; } cocci_id@p ;
...
position p;
@@
 struct intel_ir_data {  struct irq_2_iommu irq_2_iommu ;  struct irte irte_entry ;  union {  struct msi_msg msi_entry ; } ; } cocci_id@p ;
