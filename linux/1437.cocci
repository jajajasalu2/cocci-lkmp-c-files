...
position p;
@@
 const struct renesas_usb3_priv * cocci_id@p ;
...
@@
 struct renesas_usb3_dma {  struct renesas_usb3_prd * prd ;  dma_addr_t prd_dma ;  int num ;  bool used ; } cocci_id@p ;
...
position p;
@@
 struct renesas_usb3_ep cocci_id@p ;
...
position p;
@@
 struct renesas_usb3_request * cocci_id@p ;
...
position p;
@@
 struct renesas_usb3_request {  struct usb_request req ;  struct list_head queue ; } cocci_id@p ;
...
position p;
@@
 struct renesas_usb3_dma * cocci_id@p ;
...
position p;
@@
 struct renesas_usb3 cocci_id@p ;
...
position p;
@@
 struct renesas_usb3_prd cocci_id@p ;
...
typedef bool;
@@
 struct renesas_usb3_priv {  int ramsize_per_ramif ;  int num_ramif ;  int ramsize_per_pipe ;  bool workaround_for_vbus ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u16,spinlock_t;
@@
 struct renesas_usb3 {  void __iomem * reg ;  struct usb_gadget gadget ;  struct usb_gadget_driver * driver ;  struct extcon_dev * extcon ;  struct work_struct extcon_work ;  struct phy * phy ;  struct dentry * dentry ;  struct usb_role_switch * role_sw ;  struct device * host_dev ;  struct work_struct role_work ;  enum usb_role role ;  struct renesas_usb3_ep * usb3_ep ;  int num_usb3_eps ;  struct renesas_usb3_dma dma [ USB3_DMA_NUM_SETTING_AREA ] ;  spinlock_t lock ;  int disabled_count ;  struct usb_request * ep0_req ;  enum usb_role connection_state ;  u16 test_mode ;  u8 ep0_buf [ USB3_EP0_BUF_SIZE ] ;  bool softconnect ;  bool workaround_for_vbus ;  bool extcon_host ;  bool extcon_usb ;  bool forced_b_device ;  bool start_to_connect ;  bool role_sw_by_connector ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct renesas_usb3_ep {  struct usb_ep ep ;  struct renesas_usb3 * usb3 ;  struct renesas_usb3_dma * dma ;  int num ;  char ep_name [ USB3_EP_NAME_SIZE ] ;  struct list_head queue ;  u32 rammap_val ;  bool dir_in ;  bool halt ;  bool wedge ;  bool started ; } cocci_id@p ;
