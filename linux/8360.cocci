...
typedef bool;
@@
 struct nfp_ccm_mbox_cmsg_cb {  enum nfp_net_mbox_cmsg_state state ;  int err ;  unsigned int max_len ;  unsigned int exp_reply ;  bool posted ; } cocci_id@p ;
...
position p;
@@
 enum nfp_net_mbox_cmsg_state { NFP_NET_MBOX_CMSG_STATE_QUEUED , NFP_NET_MBOX_CMSG_STATE_NEXT , NFP_NET_MBOX_CMSG_STATE_BUSY , NFP_NET_MBOX_CMSG_STATE_REPLY_FOUND , NFP_NET_MBOX_CMSG_STATE_DONE , } cocci_id@p ;
...
position p;
@@
 struct nfp_ccm_mbox_cmsg_cb * cocci_id@p ;
