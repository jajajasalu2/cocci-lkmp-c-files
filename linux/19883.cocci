...
position p;
@@
 struct dc_state {  unsigned char val ;  char * name ; } cocci_id@p ;
...
typedef uint32_t;
@@
 uint32_t cocci_id@p ( unsigned short addr , int data ) ;
