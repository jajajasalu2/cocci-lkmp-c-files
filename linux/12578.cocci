...
position p;
@@
 const struct mdp5_cfg_handler * cocci_id@p ;
...
position p;
@@
 struct mdp5_cfg_platform * cocci_id@p ( struct platform_device * dev ) ;
...
position p;
@@
 struct mdp5_cfg_handler {  int revision ;  struct mdp5_cfg config ; } cocci_id@p ;
...
position p;
@@
 struct mdp5_cfg_platform * cocci_id@p ;
