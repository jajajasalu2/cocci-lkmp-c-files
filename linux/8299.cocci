...
position p;
@@
 unsigned short cocci_id@p ( long ioaddr , unsigned int cmd ) ;
...
position p;
@@
 void cocci_id@p ( long ioaddr , int length ) ;
...
position p;
@@
 void cocci_id@p ( long ioaddr , int length , unsigned char * packet , int pad , int mode ) ;
...
position p;
@@
 void cocci_id@p ( long ioaddr , int length , unsigned char * buffer , int data_mode ) ;
