...
position p;
@@
 struct radeon_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct radeon_device_id {  const char * ident ;  const unsigned short subsystem_vendor ;  const unsigned short subsystem_device ;  const enum radeon_pm_mode pm_mode_modifier ;  const reinit_function_ptr new_reinit_func ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct radeonfb_info * rinfo ) ;
