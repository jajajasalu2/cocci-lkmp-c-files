...
typedef bool;
@@
 struct hdmi_vmode {  bool mdataenablepolarity ;  unsigned int mpixelclock ;  unsigned int mpixelrepetitioninput ;  unsigned int mpixelrepetitionoutput ;  unsigned int mtmdsclock ; } cocci_id@p ;
...
position p;
@@
 struct dw_hdmi_i2s_audio_data cocci_id@p ;
...
position p;
@@
 struct hdmi_data_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,spinlock_t;
@@
 struct dw_hdmi {  struct drm_connector connector ;  struct drm_bridge bridge ;  unsigned int version ;  struct platform_device * audio ;  struct platform_device * cec ;  struct device * dev ;  struct clk * isfr_clk ;  struct clk * iahb_clk ;  struct clk * cec_clk ;  struct dw_hdmi_i2c * i2c ;  struct hdmi_data_info hdmi_data ;  const struct dw_hdmi_plat_data * plat_data ;  int vic ;  u8 edid [ HDMI_EDID_LEN ] ;  struct {  const struct dw_hdmi_phy_ops * ops ;  const char * name ;  void * data ;  bool enabled ; } phy ;  struct drm_display_mode previous_mode ;  struct i2c_adapter * ddc ;  void __iomem * regs ;  bool sink_is_hdmi ;  bool sink_has_audio ;  struct pinctrl * pinctrl ;  struct pinctrl_state * default_state ;  struct pinctrl_state * unwedge_state ;  struct mutex mutex ;  enum drm_connector_force force ;  bool disabled ;  bool bridge_is_on ;  bool rxsense ;  u8 phy_mask ;  u8 mc_clkdis ;  spinlock_t audio_lock ;  struct mutex audio_mutex ;  unsigned int sample_rate ;  unsigned int audio_cts ;  unsigned int audio_n ;  bool audio_enable ;  unsigned int reg_shift ;  struct regmap * regm ;  void ( * enable_audio ) ( struct dw_hdmi * hdmi ) ;  void ( * disable_audio ) ( struct dw_hdmi * hdmi ) ;  struct mutex cec_notifier_mutex ;  struct cec_notifier * cec_notifier ;  hdmi_codec_plugged_cb plugged_cb ;  struct device * codec_dev ;  enum drm_connector_status last_connector_result ; } cocci_id@p ;
...
position p;
@@
 const struct dw_hdmi_plat_data * cocci_id@p ;
...
position p;
@@
 const struct dw_hdmi_phy_ops cocci_id@p ;
...
position p;
@@
 struct dw_hdmi_audio_data cocci_id@p ;
...
position p;
@@
 struct cec_notifier * cocci_id@p ;
...
position p;
@@
 const struct dw_hdmi_phy_config * cocci_id@p ;
...
position p;
@@
 struct cec_connector_info cocci_id@p ;
...
position p;
@@
 const struct dw_hdmi_phy_data * cocci_id@p ;
...
typedef u8,bool;
@@
 struct dw_hdmi_i2c {  struct i2c_adapter adap ;  struct mutex lock ;  struct completion cmp ;  u8 stat ;  u8 slave_reg ;  bool is_regaddr ;  bool is_segment ; } cocci_id@p ;
...
position p;
@@
 struct hdmi_data_info {  unsigned int enc_in_bus_format ;  unsigned int enc_out_bus_format ;  unsigned int enc_in_encoding ;  unsigned int enc_out_encoding ;  unsigned int pix_repet_factor ;  unsigned int hdcp_enable ;  struct hdmi_vmode video_mode ; } cocci_id@p ;
...
position p;
@@
 const struct dw_hdmi_cec_ops cocci_id@p ;
...
position p;
@@
 const struct drm_bridge_funcs cocci_id@p ;
...
position p;
@@
 hdmi_codec_plugged_cb cocci_id@p ;
...
position p;
@@
 const struct dw_hdmi_mpll_config * cocci_id@p ;
...
position p;
@@
 enum hdmi_datamap { RGB444_8B = 0x01 , RGB444_10B = 0x03 , RGB444_12B = 0x05 , RGB444_16B = 0x07 , YCbCr444_8B = 0x09 , YCbCr444_10B = 0x0B , YCbCr444_12B = 0x0D , YCbCr444_16B = 0x0F , YCbCr422_8B = 0x16 , YCbCr422_10B = 0x14 , YCbCr422_12B = 0x12 , } cocci_id@p ;
...
position p;
@@
 const struct dw_hdmi_curr_ctrl * cocci_id@p ;
