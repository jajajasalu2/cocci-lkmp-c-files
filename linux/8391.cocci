...
typedef __be32;
@@
 struct nfp_police_cfg_head {  __be32 flags_opts ;  __be32 port ; } cocci_id@p ;
...
position p;
@@
 struct nfp_police_config cocci_id@p ;
...
position p;
@@
 struct nfp_police_cfg_head cocci_id@p ;
...
position p;
@@
 struct nfp_stat_pair * cocci_id@p ;
...
typedef __be64;
@@
 struct nfp_police_stats_reply {  struct nfp_police_cfg_head head ;  __be64 pass_bytes ;  __be64 pass_pkts ;  __be64 drop_bytes ;  __be64 drop_pkts ; } cocci_id@p ;
...
typedef __be32;
@@
 struct nfp_police_config {  struct nfp_police_cfg_head head ;  __be32 bkt_tkn_p ;  __be32 bkt_tkn_c ;  __be32 pbs ;  __be32 cbs ;  __be32 pir ;  __be32 cir ; } cocci_id@p ;
...
position p;
@@
 struct nfp_police_stats_reply * cocci_id@p ;
