...
position p;
@@
 enum zram_pageflags cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct zram * zram , struct bio_vec * bvec , u32 index , int offset , struct bio * bio ) ;
...
position p;
@@
 struct zram_work {  struct work_struct work ;  struct zram * zram ;  unsigned long entry ;  struct bio * bio ;  struct bio_vec bvec ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ ARRAY_SIZE ( zram -> compressor ) ] ;
