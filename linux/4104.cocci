...
position p;
@@
 struct mvebu_a3700_comphy_lane {  struct device * dev ;  unsigned int id ;  enum phy_mode mode ;  int submode ;  int port ; } cocci_id@p ;
...
typedef u32;
@@
 struct mvebu_a3700_comphy_conf {  unsigned int lane ;  enum phy_mode mode ;  int submode ;  unsigned int port ;  u32 fw_mode ; } cocci_id@p ;
...
position p;
@@
 const struct mvebu_a3700_comphy_conf cocci_id@p [ ] ;
...
position p;
@@
 struct mvebu_a3700_comphy_lane * cocci_id@p ;
