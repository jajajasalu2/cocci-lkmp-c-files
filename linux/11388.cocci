...
position p;
@@
 struct vmw_stdu_update_gb_image * cocci_id@p ;
...
position p;
@@
 struct vmw_stdu_surface_copy {  SVGA3dCmdHeader header ;  SVGA3dCmdSurfaceCopy body ; } cocci_id@p ;
...
position p;
@@
 struct vmw_stdu_dirty cocci_id@p ;
...
position p;
@@
 SVGA3dSurfaceImageId cocci_id@p ;
...
position p;
@@
 enum stdu_content_type cocci_id@p ;
...
position p;
@@
 struct vmw_stdu_update cocci_id@p ;
...
position p;
@@
 struct vmw_framebuffer * cocci_id@p ;
...
position p;
@@
 struct vmw_du_update_plane_buffer * cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdBindGBScreenTarget body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_kms_dirty * cocci_id@p ;
...
position p;
@@
 struct vmw_stdu_dma {  SVGA3dCmdHeader header ;  SVGA3dCmdSurfaceDMA body ; } cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDestroyGBScreenTarget body ; } * cocci_id@p ;
...
position p;
@@
 struct vmw_connector_state * cocci_id@p ;
...
position p;
@@
 struct vmw_stdu_update_gb_image {  SVGA3dCmdHeader header ;  SVGA3dCmdUpdateGBImage body ; } cocci_id@p ;
...
position p;
@@
 struct vmw_diff_cpy cocci_id@p ;
...
position p;
@@
 struct SVGA3dCopyBox * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vmw_screen_target_display_unit * stdu ) ;
...
position p;
@@
 struct vmw_screen_target_display_unit * cocci_id@p ;
...
position p;
@@
 struct vmw_du_update_plane cocci_id@p ;
...
position p;
@@
 enum stdu_content_type { SAME_AS_DISPLAY = 0 , SEPARATE_SURFACE , SEPARATE_BO , } cocci_id@p ;
...
position p;
@@
 struct vmw_plane_state * cocci_id@p ;
...
position p;
@@
 struct vmw_framebuffer_bo * cocci_id@p ;
...
position p;
@@
 struct vmw_stdu_update {  SVGA3dCmdHeader header ;  SVGA3dCmdUpdateGBScreenTarget body ; } cocci_id@p ;
...
position p;
@@
 struct drm_atomic_helper_damage_iter cocci_id@p ;
...
position p;
@@
 struct vmw_stdu_dma * cocci_id@p ;
...
position p;
@@
 struct vmw_stdu_surface_copy cocci_id@p ;
...
position p;
@@
 struct {  SVGA3dCmdHeader header ;  SVGA3dCmdDefineGBScreenTarget body ; } * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_rect * cocci_id@p ;
...
position p;
@@
 struct vmw_framebuffer_surface * cocci_id@p ;
