...
position p;
@@
 struct wm_hubs_dcs_cache * * cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( wm_hubs_spkmix_tlv , 
							    - 300 , 300 , 0 ) ;
...
typedef u16;
@@
 struct wm_hubs_dcs_cache {  struct list_head list ;  unsigned int left ;  unsigned int right ;  u16 dcs_cfg ; } cocci_id@p ;
...
position p;
@@
 struct wm_hubs_data * cocci_id@p ;
