...
position p;
@@
 const struct sunxi_desc_pin * cocci_id@p ;
...
position p;
@@
 struct sunxi_pinctrl_regulator * cocci_id@p ;
...
position p;
@@
 const struct sunxi_pinctrl_desc * cocci_id@p ;
...
position p;
@@
 struct sunxi_pinctrl_group * cocci_id@p ;
...
position p;
@@
 struct sunxi_desc_function * cocci_id@p ;
...
position p;
@@
 struct sunxi_pinctrl * cocci_id@p ;
...
position p;
@@
 struct sunxi_pinctrl_function * cocci_id@p ;
