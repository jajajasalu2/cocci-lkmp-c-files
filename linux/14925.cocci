...
position p;
@@
 struct sun9i_mmc_clk_data * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sun9i_mmc_clk_data {  spinlock_t lock ;  void __iomem * membase ;  struct clk * clk ;  struct reset_control * reset ;  struct clk_onecell_data clk_data ;  struct reset_controller_dev rcdev ; } cocci_id@p ;
