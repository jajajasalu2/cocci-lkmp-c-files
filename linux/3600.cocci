...
position p;
@@
 void ( * cocci_id@p ) ( struct stratix10_svc_client * client , struct stratix10_svc_cb_data * data ) ;
...
position p;
@@
 struct stratix10_rsu_priv * cocci_id@p ;
...
position p;
@@
 struct stratix10_rsu_priv {  struct stratix10_svc_chan * chan ;  struct stratix10_svc_client client ;  struct completion completion ;  struct mutex lock ;  struct {  unsigned long current_image ;  unsigned long fail_image ;  unsigned int version ;  unsigned int state ;  unsigned int error_details ;  unsigned int error_location ; } status ;  unsigned int retry_counter ; } cocci_id@p ;
