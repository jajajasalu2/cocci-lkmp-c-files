...
position p;
@@
 struct ieee_types_oper_mode_ntf * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_oper_mode_ntf * cocci_id@p ;
...
position p;
@@
 struct host_cmd_11ac_vht_cfg * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_vht_oper * cocci_id@p ;
