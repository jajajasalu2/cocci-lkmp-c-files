...
position p;
@@
 struct crypto4xx_alg * cocci_id@p ;
...
position p;
@@
 union shadow_sa_buf cocci_id@p ;
...
position p;
@@
 const struct dynamic_sa_ctl * cocci_id@p ;
...
position p;
@@
 union ce_part_ring_size cocci_id@p ;
...
position p;
@@
 struct crypto4xx_core_device cocci_id@p ;
...
position p;
@@
 struct crypto4xx_device * cocci_id@p ;
...
position p;
@@
 union ce_pe_dma_cfg cocci_id@p ;
...
position p;
@@
 struct sa_state_record cocci_id@p ;
...
position p;
@@
 union ce_io_threshold cocci_id@p ;
...
position p;
@@
 union ce_ring_control cocci_id@p ;
...
position p;
@@
 struct dynamic_sa_ctl * cocci_id@p ;
...
position p;
@@
 struct crypto4xx_ctx cocci_id@p ;
...
position p;
@@
 struct crypto4xx_aead_reqctx cocci_id@p ;
...
position p;
@@
 struct crypto4xx_alg_common cocci_id@p [ ] ;
