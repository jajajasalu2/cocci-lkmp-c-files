...
position p;
@@
 enum sprd_spi_dma_channel { SPRD_SPI_RX , SPRD_SPI_TX , SPRD_SPI_MAX , } cocci_id@p ;
...
typedef bool,u32;
@@
 struct sprd_spi_dma {  bool enable ;  struct dma_chan * dma_chan [ SPRD_SPI_MAX ] ;  enum dma_slave_buswidth width ;  u32 fragmens_len ;  u32 rx_len ; } cocci_id@p ;
