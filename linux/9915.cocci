...
position p;
@@
 enum htc_send_queue_result cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct htc_target * handle , struct htc_packet * packet ) ;
...
position p;
@@
 void cocci_id@p ( struct htc_target * handle ) ;
...
position p;
@@
 struct htc_pipe_txcredit_alloc * cocci_id@p ;
...
position p;
@@
 enum htc_send_full_action cocci_id@p ;
