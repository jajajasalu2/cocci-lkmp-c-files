...
@@
 struct kszphy_type {  u32 led_mode_reg ;  u16 interrupt_level_mask ;  bool has_broadcast_disable ;  bool has_nand_tree_disable ;  bool has_rmii_ref_clk_sel ; } cocci_id@p ;
...
position p;
@@
 const struct kszphy_type cocci_id@p ;
...
position p;
@@
 struct kszphy_hw_stat cocci_id@p [ ] ;
...
typedef u64,bool;
@@
 struct kszphy_priv {  const struct kszphy_type * type ;  int led_mode ;  bool rmii_ref_clk_sel ;  bool rmii_ref_clk_sel_val ;  u64 stats [ ARRAY_SIZE ( kszphy_hw_stats ) ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct kszphy_hw_stat {  const char * string ;  u8 reg ;  u8 bits ; } cocci_id@p ;
