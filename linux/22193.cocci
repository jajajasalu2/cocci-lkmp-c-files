...
position p;
@@
 struct swap_cgroup_ctrl * cocci_id@p ;
...
position p;
@@
 struct swap_cgroup {  unsigned short id ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct swap_cgroup_ctrl {  struct page * * map ;  unsigned long length ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct swap_cgroup_ctrl cocci_id@p [ MAX_SWAPFILES ] ;
