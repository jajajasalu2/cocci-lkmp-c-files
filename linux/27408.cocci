...
position p;
@@
 struct hostfs_inode_info cocci_id@p ;
...
typedef fmode_t;
@@
 struct hostfs_inode_info {  int fd ;  fmode_t mode ;  struct inode vfs_inode ;  struct mutex open_mutex ; } cocci_id@p ;
...
position p;
@@
 struct hostfs_iattr cocci_id@p ;
