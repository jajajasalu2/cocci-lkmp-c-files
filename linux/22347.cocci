...
position p;
@@
 struct ima_rule_entry cocci_id@p [ ] ;
...
position p;
@@
 struct ima_template_desc * cocci_id@p ;
...
position p;
@@
 enum policy_types { ORIGINAL_TCB = 1 , DEFAULT_TCB , } cocci_id@p ;
...
position p;
@@
 enum lsm_rule_types { LSM_OBJ_USER , LSM_OBJ_ROLE , LSM_OBJ_TYPE , LSM_SUBJ_USER , LSM_SUBJ_ROLE , LSM_SUBJ_TYPE , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( char * rule , struct ima_rule_entry * entry ) ;
...
position p;
@@
 const struct ima_template_desc * cocci_id@p ;
...
position p;
@@
 enum { mask_exec = 0 , mask_write , mask_read , mask_append , } cocci_id@p ;
...
position p;
@@
 enum policy_rule_list { IMA_DEFAULT_POLICY = 1 , IMA_CUSTOM_POLICY , } cocci_id@p ;
...
position p;
@@
 enum policy_rule_list cocci_id@p ;
...
position p;
@@
 struct integrity_iint_cache cocci_id@p ;
