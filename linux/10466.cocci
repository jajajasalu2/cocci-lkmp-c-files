...
position p;
@@
 struct radeon_dp_link_train_info cocci_id@p ;
...
typedef u8,bool;
@@
 struct radeon_dp_link_train_info {  struct radeon_device * rdev ;  struct drm_encoder * encoder ;  struct drm_connector * connector ;  int enc_id ;  int dp_clock ;  int dp_lane_count ;  bool tp3_supported ;  u8 dpcd [ DP_RECEIVER_CAP_SIZE ] ;  u8 train_set [ 4 ] ;  u8 link_status [ DP_LINK_STATUS_SIZE ] ;  u8 tries ;  bool use_dpencoder ;  struct drm_dp_aux * aux ; } cocci_id@p ;
...
position p;
@@
 struct radeon_i2c_chan cocci_id@p ;
