...
position p;
@@
 const struct samsung_pwm_variant cocci_id@p ;
...
typedef u8;
@@
 struct samsung_pwm_chip {  struct pwm_chip chip ;  struct samsung_pwm_variant variant ;  u8 inverter_mask ;  u8 disabled_mask ;  void __iomem * base ;  struct clk * base_clk ;  struct clk * tclk0 ;  struct clk * tclk1 ; } cocci_id@p ;
...
position p;
@@
 struct samsung_pwm_chip * cocci_id@p ;
...
typedef u32;
@@
 struct samsung_pwm_channel {  u32 period_ns ;  u32 duty_ns ;  u32 tin_ns ; } cocci_id@p ;
...
position p;
@@
 struct samsung_pwm_channel * cocci_id@p ;
