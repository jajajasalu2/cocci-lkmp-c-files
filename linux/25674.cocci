...
position p;
@@
 struct debug_line_header * cocci_id@p ;
...
position p;
@@
 struct compilation_unit_header * cocci_id@p ;
...
position p;
@@
 struct buffer_ext {  size_t cur_pos ;  size_t max_sz ;  void * data ; } cocci_id@p ;
...
position p;
@@
 const struct debug_line_header cocci_id@p ;
