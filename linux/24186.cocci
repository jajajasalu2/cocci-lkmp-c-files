...
position p;
@@
 int cocci_id@p ( struct sock * sk , struct ipv6_mc_socklist * iml , struct inet6_dev * idev ) ;
...
typedef bool;
@@
 bool cocci_id@p ( const struct inet6_dev * idev ) ;
...
position p;
@@
 int cocci_id@p ( struct ifmcaddr6 * pmc ) ;
...
position p;
@@
 void cocci_id@p ( struct ifmcaddr6 * pmc ) ;
...
position p;
@@
 void cocci_id@p ( struct inet6_dev * idev , struct ifmcaddr6 * pmc ) ;
...
position p;
@@
 struct igmp6_mcf_iter_state {  struct seq_net_private p ;  struct net_device * dev ;  struct inet6_dev * idev ;  struct ifmcaddr6 * im ; } cocci_id@p ;
...
position p;
@@
 struct igmp6_mc_iter_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ifmcaddr6 * ma ) ;
...
position p;
@@
 struct ip6_sf_socklist * cocci_id@p ;
...
position p;
@@
 struct ipv6_mc_socklist __rcu * * cocci_id@p ;
...
position p;
@@
 struct group_source_req * cocci_id@p ;
...
position p;
@@
 const struct mld2_query * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , const struct in6_addr * addr , unsigned int mode ) ;
...
position p;
@@
 struct igmp6_mcf_iter_state cocci_id@p ;
...
position p;
@@
 struct group_filter * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inet6_dev * idev , const struct in6_addr * pmca , int sfmode , int sfcount , const struct in6_addr * psfsrc , int delta ) ;
...
position p;
@@
 struct ipv6_mc_socklist cocci_id@p ;
...
position p;
@@
 struct igmp6_mc_iter_state {  struct seq_net_private p ;  struct net_device * dev ;  struct inet6_dev * idev ; } cocci_id@p ;
