...
position p;
@@
 struct mask_cache_entry * cocci_id@p ;
...
position p;
@@
 const struct sw_flow_key_range * cocci_id@p ;
...
position p;
@@
 const struct flow_table * cocci_id@p ;
