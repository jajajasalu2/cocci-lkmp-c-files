...
typedef u64;
@@
 struct eeh_stats {  u64 no_device ;  u64 no_dn ;  u64 no_cfg_addr ;  u64 ignored_check ;  u64 total_mmio_ffs ;  u64 false_positives ;  u64 slot_resets ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ EEH_PCI_REGS_LOG_LEN ] ;
