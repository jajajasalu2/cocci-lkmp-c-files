...
typedef __le32;
@@
 struct resp_get_clock_rate {  __le32 rate ; } cocci_id@p ;
...
typedef u8;
@@
 struct imx_sc_msg_get_clock_parent {  struct imx_sc_rpc_msg hdr ;  union {  struct req_get_clock_parent {  __le16 resource ;  u8 clk ; } __packed req ;  struct resp_get_clock_parent {  u8 parent ; } resp ; } data ; } cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_get_clock_rate cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_get_clock_parent cocci_id@p ;
...
typedef u8,u16;
@@
 struct clk_scu {  struct clk_hw hw ;  u16 rsrc_id ;  u8 clk_type ; } cocci_id@p ;
...
position p;
@@
 struct imx_sc_rpc_msg * cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_req_clock_enable cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_req_set_clock_rate cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_get_clock_rate {  struct imx_sc_rpc_msg hdr ;  union {  struct req_get_clock_rate req ;  struct resp_get_clock_rate resp ; } data ; } cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_set_clock_parent cocci_id@p ;
