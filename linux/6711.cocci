...
position p;
@@
 char cocci_id@p [ SETUP_BUFFER_SIZE ] ;
...
position p;
@@
 struct WD33C93_hostdata * cocci_id@p ;
...
position p;
@@
 const struct sx_period * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_SETUP_ARGS ] ;
...
position p;
@@
 void cocci_id@p ( struct Scsi_Host * instance ) ;
