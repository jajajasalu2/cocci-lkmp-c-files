...
position p;
@@
 struct fsl_qdma_chan {  struct virt_dma_chan vchan ;  struct virt_dma_desc vdesc ;  enum dma_status status ;  struct fsl_qdma_engine * qdma ;  struct fsl_qdma_queue * queue ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct fsl_qdma_comp {  dma_addr_t bus_addr ;  dma_addr_t desc_bus_addr ;  struct fsl_qdma_format * virt_addr ;  struct fsl_qdma_format * desc_virt_addr ;  struct fsl_qdma_chan * qchan ;  struct virt_dma_desc vdesc ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct fsl_qdma_comp * cocci_id@p ;
...
@@
 struct fsl_qdma_queue {  struct fsl_qdma_format * virt_head ;  struct fsl_qdma_format * virt_tail ;  struct list_head comp_used ;  struct list_head comp_free ;  struct dma_pool * comp_pool ;  struct dma_pool * desc_pool ;  spinlock_t queue_lock ;  dma_addr_t bus_addr ;  u32 n_cq ;  u32 id ;  struct fsl_qdma_format * cq ;  void __iomem * block_base ; } cocci_id@p ;
...
position p;
@@
 const struct fsl_qdma_format * cocci_id@p ;
...
position p;
@@
 struct fsl_qdma_queue * cocci_id@p ;
...
position p;
@@
 struct fsl_qdma_format * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ FSL_QDMA_QUEUE_MAX ] ;
...
typedef u64,u8;
@@
 struct fsl_pre_status {  u64 addr ;  u8 queue ; } cocci_id@p ;
...
position p;
@@
 struct fsl_qdma_chan cocci_id@p ;
...
position p;
@@
 struct fsl_qdma_engine * cocci_id@p ;
