...
symbol cocci_id;
position p;
typedef sparsebit_num_t,mask_t,sparsebit_idx_t;
@@
 struct node {  struct node * parent ;  struct node * left ;  struct node * right ;  sparsebit_idx_t idx ;  sparsebit_num_t num_after ;  mask_t mask ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sparsebit_num_t;
@@
 sparsebit_num_t cocci_id@p ;
...
typedef sparsebit_num_t;
@@
 struct sparsebit {  struct node * root ;  sparsebit_num_t num_set ; } cocci_id@p ;
