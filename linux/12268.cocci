...
position p;
@@
 const struct nt35597_config cocci_id@p ;
...
position p;
@@
 struct truly_nt35597 * cocci_id@p ;
...
typedef u8;
@@
 struct cmd_set {  u8 commands [ 4 ] ;  u8 size ; } cocci_id@p ;
...
position p;
@@
 const struct cmd_set cocci_id@p [ ] ;
...
typedef u32;
@@
 struct nt35597_config {  u32 width_mm ;  u32 height_mm ;  const char * panel_name ;  const struct cmd_set * panel_on_cmds ;  u32 num_on_cmds ;  const struct drm_display_mode * dm ; } cocci_id@p ;
