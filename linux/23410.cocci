...
position p;
@@
 struct cs4271_platform_data * cocci_id@p ;
...
position p;
@@
 struct cs4271_private * * cocci_id@p ;
...
typedef u8,bool;
@@
 struct cs4271_clk_cfg {  bool master ;  u8 speed_mode ;  unsigned short ratio ;  u8 ratio_mask ; } cocci_id@p ;
...
position p;
@@
 struct cs4271_clk_cfg cocci_id@p [ ] ;
...
typedef bool;
@@
 struct cs4271_private {  unsigned int mclk ;  bool master ;  bool deemph ;  struct regmap * regmap ;  int rate ;  int gpio_nreset ;  int gpio_disable ;  bool enable_soft_reset ;  struct regulator_bulk_data supplies [ ARRAY_SIZE ( supply_names ) ] ; } cocci_id@p ;
