...
position p;
@@
 struct idletimer_tg_info cocci_id@p ;
...
position p;
@@
 struct idletimer_tg cocci_id@p ;
...
position p;
@@
 struct idletimer_tg {  struct list_head entry ;  struct timer_list timer ;  struct work_struct work ;  struct kobject * kobj ;  struct device_attribute attr ;  unsigned int refcnt ; } cocci_id@p ;
...
position p;
@@
 const struct idletimer_tg_info * cocci_id@p ;
