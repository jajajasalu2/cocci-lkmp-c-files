...
position p;
@@
 struct dsaf_tbl_tcam_mcast_cfg cocci_id@p ;
...
position p;
@@
 struct dsaf_drv_priv cocci_id@p ;
...
position p;
@@
 struct dsaf_drv_mac_single_dest_entry cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ DSAF_MODE_MAX ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ sizeof ( mac_data . tbl_mcast_port_msk ) ] ;
...
position p;
@@
 struct dsaf_tbl_line_cfg * cocci_id@p ;
...
position p;
@@
 struct dsaf_tbl_tcam_data cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ DSAF_ROCE_CREDIT_CHN ] [ DSAF_ROCE_CHAN_MODE_NUM ] ;
...
position p;
@@
 enum dsaf_stp_port_type cocci_id@p ;
...
position p;
@@
 enum dsaf_sw_port_type cocci_id@p ;
...
position p;
@@
 struct dsaf_tbl_tcam_ucast_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct dsaf_hw_stats * cocci_id@p ;
...
position p;
@@
 struct dsaf_drv_tbl_tcam_key * cocci_id@p ;
...
position p;
@@
 enum dsaf_port_rate_mode cocci_id@p ;
...
position p;
@@
 struct dsaf_drv_soft_mac_tbl * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ DSAF_PORT_MSK_NUM ] ;
