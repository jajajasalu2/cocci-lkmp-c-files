...
position p;
@@
 struct lenovo_drvdata_cptkbd * cocci_id@p ;
...
position p;
@@
 struct lenovo_drvdata_tpkbd * cocci_id@p ;
...
typedef u8,bool;
@@
 struct lenovo_drvdata_cptkbd {  u8 middlebutton_state ;  bool fn_lock ;  int sensitivity ; } cocci_id@p ;
...
position p;
@@
 struct lenovo_drvdata_tpkbd {  int led_state ;  struct led_classdev led_mute ;  struct led_classdev led_micmute ;  int press_to_select ;  int dragging ;  int release_to_select ;  int select_right ;  int sensitivity ;  int press_speed ; } cocci_id@p ;
