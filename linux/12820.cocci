...
position p;
@@
 const struct amba_cs_uci_id cocci_id@p [ ] ;
...
position p;
@@
 struct debug_drvdata * cocci_id@p ;
...
typedef bool,u32;
@@
 struct debug_drvdata {  void __iomem * base ;  struct device * dev ;  int cpu ;  bool edpcsr_present ;  bool edcidsr_present ;  bool edvidsr_present ;  bool pc_has_offset ;  u32 edpcsr ;  u32 edpcsr_hi ;  u32 edprsr ;  u32 edvidsr ;  u32 edcidsr ; } cocci_id@p ;
