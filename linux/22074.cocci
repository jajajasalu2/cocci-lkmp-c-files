...
position p;
@@
 struct parman_algo {  int ( * item_add ) ( struct parman * parman , struct parman_prio * prio , struct parman_item * item ) ;  void ( * item_remove ) ( struct parman * parman , struct parman_prio * prio , struct parman_item * item ) ; } cocci_id@p ;
...
position p;
@@
 const struct parman_algo cocci_id@p ;
...
position p;
@@
 typeof ( struct parman_item ) cocci_id@p ;
...
position p;
@@
 struct parman {  const struct parman_ops * ops ;  void * priv ;  const struct parman_algo * algo ;  unsigned long count ;  unsigned long limit_count ;  struct list_head prio_list ; } cocci_id@p ;
