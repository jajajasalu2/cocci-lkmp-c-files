...
position p;
@@
 const struct mt2701_i2s_data cocci_id@p [ ] [ 2 ] ;
...
position p;
@@
 const struct mt2701_afe_rate cocci_id@p [ ] ;
...
position p;
@@
 const struct mtk_base_irq_data cocci_id@p [ MT2701_IRQ_ASYS_END ] ;
...
position p;
@@
 const struct mtk_base_memif_data cocci_id@p [ MT2701_MEMIF_NUM ] ;
...
position p;
@@
 const struct mt2701_soc_variants cocci_id@p ;
...
position p;
@@
 struct mt2701_afe_rate {  unsigned int rate ;  unsigned int regvalue ; } cocci_id@p ;
...
position p;
@@
 struct mt2701_afe_private * cocci_id@p ;
...
position p;
@@
 struct mt2701_i2s_path * cocci_id@p ;
...
position p;
@@
 const struct mt2701_i2s_data * cocci_id@p ;
...
position p;
@@
 const struct mtk_base_memif_data * cocci_id@p ;
