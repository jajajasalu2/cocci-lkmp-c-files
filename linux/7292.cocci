...
position p;
@@
 enum lm3630a_pwm_ctrl cocci_id@p ;
...
position p;
@@
 struct lm3630a_platform_data * cocci_id@p ;
...
position p;
@@
 struct lm3630a_chip cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ LM3630A_NUM_SINKS ] ;
...
position p;
@@
 struct lm3630a_chip {  struct device * dev ;  struct delayed_work work ;  int irq ;  struct workqueue_struct * irqthread ;  struct lm3630a_platform_data * pdata ;  struct backlight_device * bleda ;  struct backlight_device * bledb ;  struct gpio_desc * enable_gpio ;  struct regmap * regmap ;  struct pwm_device * pwmd ; } cocci_id@p ;
