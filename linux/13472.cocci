...
position p;
@@
 struct pvr2_std_hack {  v4l2_std_id pat ;  v4l2_std_id msk ;  v4l2_std_id std ; } cocci_id@p ;
...
position p;
@@
 struct hdw_timer {  struct timer_list timer ;  struct pvr2_hdw * hdw ; } cocci_id@p ;
...
position p;
@@
 pvr2_subdev_update_func cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct pvr2_hdw * , struct v4l2_subdev * ) ;
...
position p;
@@
 const struct pvr2_mpeg_ids cocci_id@p [ ] ;
...
position p;
@@
 const pvr2_subdev_update_func cocci_id@p [ ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct pvr2_hdw * , int ) ;
...
position p;
@@
 const struct pvr2_device_client_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pvr2_hdw * ) ;
...
position p;
@@
 const struct pvr2_device_client_table * cocci_id@p ;
...
position p;
@@
 struct pvr2_ctl_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pvr2_hdw * hdw ) ;
...
position p;
@@
 const struct pvr2_fx2cmd_descdef cocci_id@p [ ] ;
...
position p;
@@
 v4l2_std_id cocci_id@p ( struct pvr2_hdw * hdw ) ;
...
position p;
@@
 int cocci_id@p ( struct pvr2_hdw * hdw , int v ) ;
...
position p;
@@
 const state_eval_func cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct pvr2_hdw * , unsigned long ) ;
...
position p;
@@
 struct pvr2_mpeg_ids {  const char * strid ;  int id ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pvr2_hdw * ) ;
...
position p;
@@
 struct pvr2_stream_stats cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pvr2_hdw * hdw , unsigned int timeout , int probe_fl , void * write_data , unsigned int write_len , void * read_data , unsigned int read_len ) ;
...
position p;
@@
 const struct pvr2_device_desc * cocci_id@p ;
...
position p;
@@
 struct pvr2_hdw * cocci_id@p [ PVR_NUM ] ;
...
position p;
@@
 const struct pvr2_string_table * cocci_id@p ;
...
position p;
@@
 const struct pvr2_std_hack cocci_id@p [ ] ;
...
typedef u32;
@@
 int cocci_id@p ( struct pvr2_hdw * , u32 ) ;
...
position p;
@@
 int cocci_id@p ( struct pvr2_hdw * hdw , int runFl ) ;
...
position p;
@@
 int cocci_id@p ( struct pvr2_hdw * , int state ) ;
...
position p;
@@
 const struct pvr2_ctl_info cocci_id@p [ ] ;
...
position p;
@@
 struct pvr2_fx2cmd_descdef {  unsigned char id ;  unsigned char * desc ; } cocci_id@p ;
