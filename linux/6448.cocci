...
position p;
@@
 struct devm_of_regulator_matches {  struct of_regulator_match * matches ;  unsigned int num_matches ; } cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ PM_SUSPEND_MAX + 1 ] ;
...
position p;
@@
 struct devm_of_regulator_matches * cocci_id@p ;
