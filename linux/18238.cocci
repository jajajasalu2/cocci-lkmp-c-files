...
position p;
@@
 struct s3c2410fb_display cocci_id@p ;
...
position p;
@@
 struct uda1380_platform_data cocci_id@p ;
...
position p;
@@
 struct s3c24xx_mci_pdata cocci_id@p ;
...
position p;
@@
 struct s3c2410_ts_mach_info cocci_id@p ;
...
position p;
@@
 struct s3c2410fb_mach_info cocci_id@p ;
...
position p;
@@
 struct s3c_adc_bat_pdata cocci_id@p ;
...
position p;
@@
 const struct s3c_adc_bat_thresh cocci_id@p [ ] ;
...
position p;
@@
 struct s3c2410_udc_mach_info cocci_id@p ;
