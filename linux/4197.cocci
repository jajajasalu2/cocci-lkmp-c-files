...
position p;
@@
 struct ralink_usb_phy * cocci_id@p ;
...
typedef u32;
@@
 struct ralink_usb_phy {  struct reset_control * rstdev ;  struct reset_control * rsthost ;  u32 clk ;  struct phy * phy ;  void __iomem * base ;  struct regmap * sysctl ; } cocci_id@p ;
