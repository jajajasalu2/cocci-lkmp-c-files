...
position p;
@@
 struct lpfc_mbx_pc_sli4_params * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_supp_pages * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_reg_fcfi_mrq * cocci_id@p ;
...
position p;
@@
 struct static_vport_info cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_resume_rpi * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_nembed_sge_virt cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_reg_vfi * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_init_vfi * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_read_fcf_tbl * cocci_id@p ;
...
position p;
@@
 struct config_hbq_var * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_reg_fcfi * cocci_id@p ;
