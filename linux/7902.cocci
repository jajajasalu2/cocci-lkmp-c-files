...
position p;
@@
 const struct b53_mib_desc * cocci_id@p ;
...
position p;
@@
 const struct b53_chip_data * cocci_id@p ;
...
position p;
@@
 const struct b53_arl_entry * cocci_id@p ;
...
position p;
@@
 const struct b53_io_ops * cocci_id@p ;
...
position p;
@@
 struct b53_arl_entry * cocci_id@p ;
...
typedef u8;
@@
 struct b53_mib_desc {  u8 size ;  u8 offset ;  const char * name ; } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct b53_chip_data {  u32 chip_id ;  const char * dev_name ;  u16 vlans ;  u16 enabled_ports ;  u8 cpu_port ;  u8 vta_regs [ 3 ] ;  u8 arl_entries ;  u8 duplex_reg ;  u8 jumbo_pm_reg ;  u8 jumbo_size_reg ; } cocci_id@p ;
...
position p;
@@
 struct b53_arl_entry cocci_id@p [ 2 ] ;
