...
position p;
@@
 struct e1000_option {  enum { enable_option , range_option , list_option , } type ;  const char * name ;  const char * err ;  int def ;  union {  struct {  int min ;  int max ; } r ;  struct {  int nr ;  const struct e1000_opt_list {  int i ;  char * str ; } * p ; } l ; } arg ; } cocci_id@p ;
...
position p;
@@
 const struct e1000_opt_list cocci_id@p [ ] ;
...
position p;
@@
 struct e1000_option cocci_id@p ;
...
position p;
@@
 const struct e1000_option * cocci_id@p ;
