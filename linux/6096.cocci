...
position p;
@@
 struct tx2_uncore_pmu * cocci_id@p ;
...
position p;
@@
 enum tx2_uncore_type { PMU_TYPE_L3C , PMU_TYPE_DMC , PMU_TYPE_CCPI2 , PMU_TYPE_INVALID , } cocci_id@p ;
...
position p;
@@
 enum tx2_uncore_type cocci_id@p ;
...
typedef u64,u32;
@@
 struct tx2_uncore_pmu {  struct hlist_node hpnode ;  struct list_head entry ;  struct pmu pmu ;  char * name ;  int node ;  int cpu ;  u32 max_counters ;  u32 counters_mask ;  u32 prorate_factor ;  u32 max_events ;  u32 events_mask ;  u64 hrtimer_interval ;  void __iomem * base ; 
...
typedef __u8;
@@
 struct acpi_tx2_pmu_device {  __u8 id [ ACPI_ID_LEN ] ;  enum tx2_uncore_type type ; } cocci_id@p [ ] ;
