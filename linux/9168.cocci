...
position p;
@@
 char cocci_id@p [ MLXSW_REG_QPDSM_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_QRWE_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_QPDPM_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_QPTS_LEN ] ;
...
position p;
@@
 enum mlxsw_reg_qpts_trust_state cocci_id@p ;
