...
position p;
@@
 enum qlink_hidden_ssid cocci_id@p ;
...
position p;
@@
 enum nl80211_hidden_ssid cocci_id@p ;
...
position p;
@@
 enum qlink_dfs_state cocci_id@p ;
...
position p;
@@
 struct qlink_chandef * cocci_id@p ;
...
position p;
@@
 const struct qlink_chandef * cocci_id@p ;
