...
symbol cocci_id;
position p;
typedef xfs_dir2_data_free_t;
@@
 xfs_dir2_data_free_t cocci_id@p ;
...
position p;
@@
 struct xfs_dir3_data_hdr * cocci_id@p ;
...
typedef xfs_failaddr_t;
@@
 xfs_failaddr_t cocci_id@p ( struct xfs_dir2_data_hdr * hdr , struct xfs_dir2_data_free * bf , struct xfs_dir2_data_unused * dup , struct xfs_dir2_data_free * * bf_ent ) ;
