...
position p;
@@
 int cocci_id@p ( unsigned long addr , struct pt_regs * regs ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long entry , unsigned long addr , unsigned int error_code , struct pt_regs * regs ) ;
