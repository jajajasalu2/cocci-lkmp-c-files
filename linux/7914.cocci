...
position p;
@@
 struct sja1105_dyn_cmd cocci_id@p ;
...
position p;
@@
 enum sja1105_hostcmd { SJA1105_HOSTCMD_SEARCH = 1 , SJA1105_HOSTCMD_READ = 2 , SJA1105_HOSTCMD_WRITE = 3 , SJA1105_HOSTCMD_INVALIDATE = 4 , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SJA1105_MAX_DYN_CMD_SIZE ] ;
...
position p;
@@
 struct sja1105_dynamic_table_ops cocci_id@p [ BLK_IDX_MAX_DYN ] ;
...
position p;
@@
 const struct sja1105_dynamic_table_ops * cocci_id@p ;
...
typedef u64,bool;
@@
 struct sja1105_dyn_cmd {  bool search ;  u64 valid ;  u64 rdwrset ;  u64 errors ;  u64 valident ;  u64 index ; } cocci_id@p ;
