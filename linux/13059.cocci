...
typedef __le32,u8;
@@
 struct cmd_db_header {  __le32 version ;  u8 magic [ 4 ] ;  struct rsc_hdr header [ MAX_SLV_ID ] ;  __le32 checksum ;  __le32 reserved ;  u8 data [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct rsc_hdr * * cocci_id@p ;
...
typedef __le32,u8;
@@
 struct entry_header {  u8 id [ 8 ] ;  __le32 priority [ NUM_PRIORITY ] ;  __le32 addr ;  __le16 len ;  __le16 offset ; } cocci_id@p ;
...
position p;
@@
 const struct entry_header * * cocci_id@p ;
...
position p;
@@
 struct cmd_db_header * cocci_id@p ;
...
position p;
@@
 enum cmd_db_hw_type cocci_id@p ;
...
position p;
@@
 struct rsc_hdr {  __le16 slv_id ;  __le16 header_offset ;  __le16 data_offset ;  __le16 cnt ;  __le16 version ;  __le16 reserved [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 const struct cmd_db_header * cocci_id@p ;
