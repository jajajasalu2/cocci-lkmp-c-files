...
position p;
@@
 const struct reg_field * cocci_id@p ;
...
position p;
@@
 struct bq24257_device * cocci_id@p ;
...
position p;
@@
 enum bq24257_loop_status { LOOP_STATUS_NONE , LOOP_STATUS_IN_DPM , LOOP_STATUS_IN_CURRENT_LIMIT , LOOP_STATUS_THERMAL , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct bq24257_state {  u8 status ;  u8 fault ;  bool power_good ; } cocci_id@p ;
...
typedef u32;
@@
 const struct {  int field ;  u32 value ; } cocci_id@p [ ] ;
...
position p;
@@
 enum bq24257_status { STATUS_READY , STATUS_CHARGE_IN_PROGRESS , STATUS_CHARGE_DONE , STATUS_FAULT , } cocci_id@p ;
...
position p;
@@
 enum bq24257_vindpm { VINDPM_4200 , VINDPM_4280 , VINDPM_4360 , VINDPM_4440 , VINDPM_4520 , VINDPM_4600 , VINDPM_4680 , VINDPM_4760 , } cocci_id@p ;
...
position p;
@@
 struct bq24257_state cocci_id@p ;
...
position p;
@@
 enum bq24257_safety_timer { SAFETY_TIMER_45 , SAFETY_TIMER_360 , SAFETY_TIMER_540 , SAFETY_TIMER_NONE , } cocci_id@p ;
...
typedef u8;
@@
 struct bq24257_init_data {  u8 ichg ;  u8 vbat ;  u8 iterm ;  u8 iilimit ;  u8 vovp ;  u8 vindpm ; } cocci_id@p ;
...
position p;
@@
 enum bq2425x_chip { BQ24250 , BQ24251 , BQ24257 , } cocci_id@p ;
...
position p;
@@
 enum bq24257_vovp { VOVP_6000 , VOVP_6500 , VOVP_7000 , VOVP_8000 , VOVP_9000 , VOVP_9500 , VOVP_10000 , VOVP_10500 , } cocci_id@p ;
...
position p;
@@
 enum bq24257_fields cocci_id@p ;
...
position p;
@@
 enum bq24257_fault { FAULT_NORMAL , FAULT_INPUT_OVP , FAULT_INPUT_UVLO , FAULT_SLEEP , FAULT_BAT_TS , FAULT_BAT_OVP , FAULT_TS , FAULT_TIMER , FAULT_NO_BAT , FAULT_ISET , FAULT_INPUT_LDO_LOW , } cocci_id@p ;
...
typedef bool;
@@
 struct bq24257_device {  struct i2c_client * client ;  struct device * dev ;  struct power_supply * charger ;  enum bq2425x_chip chip ;  struct regmap * rmap ;  struct regmap_field * rmap_fields [ F_MAX_FIELDS ] ;  struct gpio_desc * pg ;  struct delayed_work iilimit_setup_work ;  struct bq24257_init_data init_data ;  struct bq24257_state state ;  struct mutex lock ;  bool iilimit_autoset_enable ; } cocci_id@p ;
...
position p;
@@
 enum bq24257_port_type { PORT_TYPE_DCP , PORT_TYPE_CDP , PORT_TYPE_SDP , PORT_TYPE_NON_STANDARD , } cocci_id@p ;
...
position p;
@@
 enum bq24257_in_ilimit { IILIMIT_100 , IILIMIT_150 , IILIMIT_500 , IILIMIT_900 , IILIMIT_1500 , IILIMIT_2000 , IILIMIT_EXT , IILIMIT_NONE , } cocci_id@p ;
