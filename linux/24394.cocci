...
position p;
@@
 struct hci_inquiry_req cocci_id@p ;
...
position p;
@@
 struct bdaddr_list_with_irk * cocci_id@p ;
...
position p;
@@
 struct hci_dev_info cocci_id@p ;
...
position p;
@@
 struct hci_dev_list_req * cocci_id@p ;
...
position p;
@@
 struct hci_cp_write_def_link_policy cocci_id@p ;
...
position p;
@@
 struct hci_conn_hash * cocci_id@p ;
...
position p;
@@
 struct hci_dev_stats cocci_id@p ;
...
position p;
@@
 struct hci_cp_delete_stored_link_key cocci_id@p ;
...
position p;
@@
 struct hci_cp_read_local_ext_features cocci_id@p ;
