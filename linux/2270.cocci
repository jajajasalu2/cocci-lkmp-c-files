...
position p;
@@
 struct __thermal_cooling_bind_param {  struct device_node * cooling_device ;  unsigned long min ;  unsigned long max ; } cocci_id@p ;
...
position p;
@@
 struct thermal_trip * cocci_id@p ;
...
position p;
@@
 struct __thermal_zone {  enum thermal_device_mode mode ;  int passive_delay ;  int polling_delay ;  int slope ;  int offset ;  int ntrips ;  struct thermal_trip * trips ;  int num_tbps ;  struct __thermal_bind_params * tbps ;  void * sensor_data ;  const struct thermal_zone_of_device_ops * ops ; } cocci_id@p ;
...
position p;
@@
 struct __thermal_bind_params {  struct __thermal_cooling_bind_param * tcbp ;  unsigned int count ;  unsigned int trip_id ;  unsigned int usage ; } cocci_id@p ;
