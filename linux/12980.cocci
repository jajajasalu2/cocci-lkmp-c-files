...
@@
 struct meson_canvas {  struct device * dev ;  void __iomem * reg_base ;  spinlock_t lock ;  u8 used [ NUM_CANVAS ] ;  bool supports_endianness ; } cocci_id@p ;
...
position p;
@@
 struct meson_canvas * cocci_id@p ;
