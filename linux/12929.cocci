...
position p;
@@
 void cocci_id@p ( struct atm_dev * , unsigned char , unsigned long ) ;
...
position p;
@@
 unsigned char cocci_id@p ( struct atm_dev * , unsigned long ) ;
...
position p;
@@
 struct he_ioctl_reg cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct he_dev * dev ) ;
...
position p;
@@
 int cocci_id@p ( struct atm_dev * dev ) ;
...
typedef u8;
@@
 u8 cocci_id@p ( struct he_dev * he_dev , int addr ) ;
