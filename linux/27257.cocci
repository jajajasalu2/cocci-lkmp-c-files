...
position p;
@@
 struct nfsdfs_client cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nfsd_net * nn ) ;
...
typedef time_t;
@@
 struct bloom_pair {  int entries , old_entries ;  time_t swap_time ;  int new ; 
...
position p;
@@
 struct nfsd4_destroy_clientid * cocci_id@p ;
...
position p;
@@
 struct nfsd4_test_stateid * cocci_id@p ;
...
position p;
@@
 struct nfs4_client_reclaim cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct nfs4_stid * ) ;
...
position p;
@@
 const struct nfs4_stateowner_operations cocci_id@p ;
...
position p;
@@
 struct nfs4_openowner cocci_id@p ;
...
position p;
@@
 struct nfsd4_setclientid * cocci_id@p ;
...
position p;
@@
 const struct xdr_netobj * cocci_id@p ;
...
position p;
@@
 struct nfs4_delegation cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ INET6_ADDRSTRLEN ] ;
...
position p;
@@
 struct nfsd4_compoundres * cocci_id@p ;
...
position p;
@@
 struct nfsd4_open_confirm * cocci_id@p ;
...
position p;
@@
 struct nfsd4_backchannel_ctl * cocci_id@p ;
...
position p;
@@
 struct file_lock_context * cocci_id@p ;
...
position p;
@@
 struct nfsd4_channel_attrs cocci_id@p ;
...
position p;
@@
 struct nfsd4_callback * cocci_id@p ;
...
position p;
@@
 struct nfsd4_session * cocci_id@p ;
...
position p;
@@
 struct nfsd4_sessionid * cocci_id@p ;
...
typedef bool;
@@
 bool ( * cocci_id@p ) ( struct nfs4_ol_stateid * ) ;
...
position p;
@@
 struct nfs4_layout_stateid * cocci_id@p ;
...
position p;
@@
 struct nfs4_lockowner * cocci_id@p ;
...
position p;
@@
 struct nfs4_clnt_odstate cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nfs4_stid * stid ) ;
...
position p;
@@
 struct seq_operations cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct nfsd4_session * ) ;
...
position p;
@@
 struct nfs4_ol_stateid cocci_id@p ;
...
position p;
@@
 struct nfsd4_compoundargs * cocci_id@p ;
...
position p;
@@
 struct nfsd4_release_lockowner * cocci_id@p ;
...
position p;
@@
 struct nfsd4_clid_slot * cocci_id@p ;
...
position p;
@@
 struct nfsd4_blocked_lock * cocci_id@p ;
...
position p;
@@
 const struct nfsd4_callback_ops cocci_id@p ;
...
position p;
@@
 struct nfs4_cb_conn * cocci_id@p ;
...
position p;
@@
 struct nfsd4_reclaim_complete * cocci_id@p ;
...
position p;
@@
 struct nfsd4_delegreturn * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct nfs4_openowner * ) ;
...
position p;
@@
 struct nfsd4_setclientid_confirm * cocci_id@p ;
...
position p;
@@
 struct nfsd4_sequence * cocci_id@p ;
...
position p;
@@
 const struct lock_manager_operations cocci_id@p ;
...
position p;
@@
 struct nfsd4_compound_state * cocci_id@p ;
...
position p;
@@
 const struct tree_descr cocci_id@p [ ] ;
...
position p;
@@
 struct nfsd4_create_session * cocci_id@p ;
...
position p;
@@
 struct nfsd4_free_stateid * cocci_id@p ;
...
position p;
@@
 struct nfsd4_exchange_id * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct nfs4_file * fp , struct nfs4_lockowner * lowner ) ;
...
position p;
@@
 struct nfsd4_lock_denied * cocci_id@p ;
...
position p;
@@
 struct nfsd4_bind_conn_to_session * cocci_id@p ;
...
position p;
@@
 struct nfs4_stateowner * cocci_id@p ;
...
position p;
@@
 struct svc_xpt_user * cocci_id@p ;
...
position p;
@@
 struct hlist_head cocci_id@p [ FILE_HASH_SIZE ] ;
...
position p;
@@
 enum nfsd4_st_mutex_lock_subclass { OPEN_STATEID_MUTEX = 0 , LOCK_STATEID_MUTEX = 1 , } cocci_id@p ;
...
position p;
@@
 struct nfsd4_open_downgrade * cocci_id@p ;
...
position p;
@@
 struct nfsd4_cb_sec * cocci_id@p ;
...
position p;
@@
 struct nfsd4_test_stateid_id * cocci_id@p ;
