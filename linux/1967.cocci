...
position p;
@@
 struct ad5421_platform_data * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct ad5421_state {  struct spi_device * spi ;  unsigned int ctrl ;  enum ad5421_current_range current_range ;  unsigned int fault_mask ;  union {  __be32 d32 ;  u8 d8 [ 4 ] ; } data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct ad5421_state * cocci_id@p ;
