...
position p;
@@
 struct mlx5_hv_vhca_data_block cocci_id@p ;
...
position p;
@@
 struct mlx5_hv_vhca_work * cocci_id@p ;
...
position p;
@@
 struct mlx5_hv_vhca_control_block * cocci_id@p ;
...
typedef u8,u64,u16;
@@
 struct mlx5_hv_vhca_data_block {  u16 sequence ;  u16 offset ;  u8 reserved [ 4 ] ;  u64 data [ 15 ] ; } cocci_id@p ;
...
typedef u64,u16;
@@
 struct mlx5_hv_vhca_agent {  enum mlx5_hv_vhca_agent_type type ;  struct mlx5_hv_vhca * hv_vhca ;  void * priv ;  u16 seq ;  void ( * control ) ( struct mlx5_hv_vhca_agent * agent , struct mlx5_hv_vhca_control_block * block ) ;  void ( * invalidate ) ( struct mlx5_hv_vhca_agent * agent , u64 block_mask ) ;  void ( * cleanup ) ( struct mlx5_hv_vhca_agent * agent ) ; } cocci_id@p ;
...
position p;
@@
 enum mlx5_hv_vhca_agent_type cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct mlx5_hv_vhca_agent * agent ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct mlx5_hv_vhca_agent * , struct mlx5_hv_vhca_control_block * block ) ;
...
typedef u64;
@@
 void ( * cocci_id@p ) ( struct mlx5_hv_vhca_agent * , u64 block_mask ) ;
...
position p;
@@
 struct mlx5_hv_vhca * cocci_id@p ;
...
position p;
@@
 struct mlx5_hv_vhca {  struct mlx5_core_dev * dev ;  struct workqueue_struct * work_queue ;  struct mlx5_hv_vhca_agent * agents [ MLX5_HV_VHCA_AGENT_MAX ] ;  struct mutex agents_lock ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_hv_vhca_agent * cocci_id@p ;
...
typedef u64;
@@
 struct mlx5_hv_vhca_work {  struct work_struct invalidate_work ;  struct mlx5_hv_vhca * hv_vhca ;  u64 block_mask ; } cocci_id@p ;
