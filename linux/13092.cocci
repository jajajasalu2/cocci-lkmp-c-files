...
position p;
@@
 struct qm_mcr_querycgr cocci_id@p ;
...
position p;
@@
 union qm_mc_command * cocci_id@p ;
...
position p;
@@
 enum qm_mr_cmode { qm_mr_cci = 0 , qm_mr_cce = 1 , } cocci_id@p ;
...
typedef u8;
@@
 struct qm_mcr_alterfq {  u8 verb ;  u8 result ;  u8 fqs ;  u8 __reserved1 [ 61 ] ; } cocci_id@p ;
...
position p;
@@
 struct qm_dqrr_entry cocci_id@p ;
...
position p;
@@
 const struct qman_cgrs * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct qman_portal * p , u32 is ) ;
...
position p;
@@
 struct qm_mcc_initcgr cocci_id@p ;
...
position p;
@@
 struct cgr_comp {  struct qman_cgr * cgr ;  struct completion completion ; } cocci_id@p ;
...
position p;
@@
 enum qm_dqrr_dmode { qm_dqrr_dpush = 0 , qm_dqrr_dpull = 1 , } cocci_id@p ;
...
typedef u8;
@@
 union qm_mc_result {  struct {  u8 verb ;  u8 result ;  u8 __reserved1 [ 62 ] ; } ;  struct qm_mcr_queryfq queryfq ;  struct qm_mcr_alterfq alterfq ;  struct qm_mcr_querycgr querycgr ;  struct qm_mcr_querycongestion querycongestion ;  struct qm_mcr_querywq querywq ;  struct qm_mcr_queryfq_np queryfq_np ; } cocci_id@p ;
...
typedef u8;
@@
 struct qm_mcc_cgr {  u8 _ncw_verb ;  u8 __reserved1 [ 30 ] ;  u8 cgid ;  u8 __reserved2 [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct qm_mcr_queryfq_np * cocci_id@p ;
...
position p;
@@
 enum qm_eqcr_pmode { qm_eqcr_pci = 0 , qm_eqcr_pce = 1 , qm_eqcr_pvb = 2 , } cocci_id@p ;
...
position p;
@@
 enum qm_dqrr_cmode { qm_dqrr_cci = 0 , qm_dqrr_cce = 1 , qm_dqrr_cdc = 2 , } cocci_id@p ;
...
position p;
@@
 struct qm_addr {  void * ce ;  __be32 * ce_be ;  void __iomem * ci ; } cocci_id@p ;
...
position p;
@@
 enum qman_cb_dqrr_result cocci_id@p ;
...
position p;
@@
 enum qm_dqrr_pmode { qm_dqrr_pci , qm_dqrr_pce , qm_dqrr_pvb , } cocci_id@p ;
...
position p;
@@
 const struct qm_portal_config * cocci_id@p ;
...
position p;
@@
 struct qman_portal * cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 unsigned int cocci_id@p ( struct qman_portal * p , unsigned int poll_limit ) ;
...
position p;
@@
 struct qm_eqcr_entry cocci_id@p ;
...
position p;
@@
 const struct qm_dqrr_entry * cocci_id@p ;
...
typedef u8;
@@
 union qm_mc_command {  struct {  u8 _ncw_verb ;  u8 __reserved [ 63 ] ; } ;  struct qm_mcc_initfq initfq ;  struct qm_mcc_initcgr initcgr ;  struct qm_mcc_fq fq ;  struct qm_mcc_cgr cgr ; } cocci_id@p ;
...
position p;
@@
 const union qm_mr_entry * cocci_id@p ;
...
position p;
@@
 enum qm_mr_pmode { qm_mr_pci , qm_mr_pce , qm_mr_pvb , } cocci_id@p ;
...
position p;
@@
 struct qm_mcc_initfq * cocci_id@p ;
