...
position p;
@@
 struct atmel_tcb_pwm_device * cocci_id@p ;
...
position p;
@@
 struct atmel_tcb_pwm_chip cocci_id@p ;
...
typedef spinlock_t;
@@
 struct atmel_tcb_pwm_chip {  struct pwm_chip chip ;  spinlock_t lock ;  struct atmel_tc * tc ;  struct atmel_tcb_pwm_device * pwms [ NPWM ] ;  struct atmel_tcb_channel bkup [ NPWM / 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct atmel_tcb_pwm_device {  enum pwm_polarity polarity ;  unsigned div ;  unsigned duty ;  unsigned period ; } cocci_id@p ;
...
typedef u32;
@@
 struct atmel_tcb_channel {  u32 enabled ;  u32 cmr ;  u32 ra ;  u32 rb ;  u32 rc ; } cocci_id@p ;
...
position p;
@@
 struct atmel_tcb_channel * cocci_id@p ;
