...
position p;
@@
 void * cocci_id@p ( const char * version , const char * name ) ;
...
typedef uintptr_t;
@@
 void cocci_id@p ( uintptr_t base ) ;
...
position p;
@@
 ElfELF_BITS_Verdaux * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ElfELF_BITS_auxv_t;
@@
 ElfELF_BITS_auxv_t * cocci_id@p ;
