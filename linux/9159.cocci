...
position p;
@@
 struct mlxsw_sp1_ptp_unmatched cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_ptp_state * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp1_ptp_key cocci_id@p ;
...
typedef u64,u32;
@@
 struct mlxsw_sp1_ptp_unmatched {  struct mlxsw_sp1_ptp_key key ;  struct rhlist_head ht_node ;  struct rcu_head rcu ;  struct sk_buff * skb ;  u64 timestamp ;  u32 gc_cycle ; } cocci_id@p ;
...
position p;
@@
 const struct ptp_clock_info cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_ptp_port_stats cocci_id@p ;
...
position p;
@@
 enum hwtstamp_tx_types cocci_id@p ;
...
position p;
@@
 enum hwtstamp_rx_filters * cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_ptp_port_stat {  char str [ ETH_GSTRING_LEN ] ;  ptrdiff_t offset ; } cocci_id@p ;
...
position p;
@@
 struct mlxsw_sp_ptp_port_dir_stats * cocci_id@p ;
...
@@
 struct mlxsw_sp_ptp_clock {  struct mlxsw_core * core ;  spinlock_t lock ;  struct cyclecounter cycles ;  struct timecounter tc ;  u32 nominal_c_mult ;  struct ptp_clock * ptp ;  struct ptp_clock_info ptp_info ;  unsigned long overflow_period ;  struct delayed_work overflow_work ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MTPTPT_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_QPSC_LEN ] ;
...
typedef u8,u32;
@@
 struct mlxsw_sp1_ptp_shaper_params {  u32 ethtool_speed ;  enum mlxsw_reg_qpsc_port_speed port_speed ;  u8 shaper_time_exp ;  u8 shaper_time_mantissa ;  u8 shaper_inc ;  u8 shaper_bs ;  u8 port_to_shaper_credits ;  int ing_timestamp_inc ;  int egr_timestamp_inc ; } cocci_id@p ;
...
position p;
@@
 const struct mlxsw_sp_ptp_port_stat cocci_id@p [ ] ;
...
position p;
@@
 enum mlxsw_reg_mtptpt_trap_id cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MTPPS_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MTUTC_LEN ] ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MOGCR_LEN ] ;
...
position p;
@@
 const struct mlxsw_sp1_ptp_shaper_params cocci_id@p [ ] ;
...
position p;
@@
 struct ptp_system_timestamp * cocci_id@p ;
...
position p;
@@
 const struct hwtstamp_config * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MLXSW_REG_MTPPPC_LEN ] ;
...
position p;
@@
 struct mlxsw_sp_ptp_clock cocci_id@p ;
...
typedef u32,spinlock_t;
@@
 struct mlxsw_sp_ptp_state {  struct mlxsw_sp * mlxsw_sp ;  struct rhltable unmatched_ht ;  spinlock_t unmatched_lock ;  struct delayed_work ht_gc_dw ;  u32 gc_cycle ; } cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct mlxsw_sp1_ptp_key {  u8 local_port ;  u8 message_type ;  u16 sequence_id ;  u8 domain_number ;  bool ingress ; } cocci_id@p ;
...
position p;
@@
 const struct timecounter * cocci_id@p ;
