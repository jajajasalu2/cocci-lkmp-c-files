...
position p;
@@
 struct parport_pc_pci {  int numports ;  struct {  int lo ;  int hi ; } addr [ 4 ] ;  int ( * preinit_hook ) ( struct pci_dev * pdev , struct parport_pc_pci * card , int autoirq , int autodma ) ;  void ( * postinit_hook ) ( struct pci_dev * pdev , struct parport_pc_pci * card , int failed ) ; } cocci_id@p ;
...
position p;
@@
 struct parport_serial_private {  struct serial_private * serial ;  int num_par ;  struct parport * port [ PARPORT_MAX ] ;  struct parport_pc_pci par ; } cocci_id@p ;
...
position p;
@@
 struct parport_serial_private * cocci_id@p ;
...
position p;
@@
 struct parport_pc_pci * cocci_id@p ;
