...
position p;
@@
 struct usb_key_descriptor * cocci_id@p ;
...
position p;
@@
 struct hwa_dev_info * cocci_id@p ;
...
position p;
@@
 struct usb_encryption_descriptor * cocci_id@p ;
...
position p;
@@
 struct hwahc {  struct wusbhc wusbhc ;  struct wahc wa ; } cocci_id@p ;
...
position p;
@@
 struct usb_wa_descriptor * cocci_id@p ;
...
position p;
@@
 const struct uwb_mas_bm * cocci_id@p ;
...
position p;
@@
 struct usb_security_descriptor * cocci_id@p ;
