...
typedef u8;
@@
 int ( * cocci_id@p ) ( struct drm_device * , void * , int idx , u8 * outp ) ;
...
position p;
@@
 struct lvdstableheader cocci_id@p ;
...
typedef bool;
@@
 struct init_exec {  bool execute ;  bool repeat ; } cocci_id@p ;
