...
position p;
@@
 struct sun4m_handler_data * cocci_id@p ;
...
typedef u32;
@@
 struct sun4m_timer_global {  u32 l10_limit ;  u32 l10_count ;  u32 l10_limit_noclear ;  u32 reserved ;  u32 timer_config ; } cocci_id@p ;
...
typedef u32;
@@
 struct sun4m_timer_percpu {  u32 l14_limit ;  u32 l14_count ;  u32 l14_limit_noclear ;  u32 user_timer_start_stop ; } cocci_id@p ;
...
typedef bool;
@@
 struct sun4m_handler_data {  bool percpu ;  long mask ; } cocci_id@p ;
