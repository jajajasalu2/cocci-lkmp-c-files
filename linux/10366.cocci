...
position p;
@@
 struct panel_module {  struct tilcdc_module base ;  struct tilcdc_panel_info * info ;  struct display_timings * timings ;  struct backlight_device * backlight ;  struct gpio_desc * enable_gpio ; } cocci_id@p ;
...
position p;
@@
 struct panel_connector cocci_id@p ;
...
position p;
@@
 struct display_timings * cocci_id@p ;
...
position p;
@@
 const struct tilcdc_module_ops cocci_id@p ;
...
position p;
@@
 struct tilcdc_panel_info * cocci_id@p ;
...
position p;
@@
 struct panel_encoder cocci_id@p ;
...
position p;
@@
 struct tilcdc_module * cocci_id@p ;
...
position p;
@@
 struct panel_encoder {  struct drm_encoder base ;  struct panel_module * mod ; } cocci_id@p ;
...
position p;
@@
 struct panel_module cocci_id@p ;
...
position p;
@@
 struct panel_connector {  struct drm_connector base ;  struct drm_encoder * encoder ;  struct panel_module * mod ; } cocci_id@p ;
