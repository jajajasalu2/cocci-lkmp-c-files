...
position p;
@@
 struct ti_am335x_xbar_map * cocci_id@p ;
...
typedef u8,u16;
@@
 struct ti_am335x_xbar_map {  u16 dma_line ;  u8 mux_val ; } cocci_id@p ;
...
typedef u32;
@@
 struct ti_am335x_xbar_data {  void __iomem * iomem ;  struct dma_router dmarouter ;  u32 xbar_events ;  u32 dma_requests ; } cocci_id@p ;
...
typedef u16;
@@
 struct ti_dra7_xbar_map {  u16 xbar_in ;  int xbar_out ; } cocci_id@p ;
...
position p;
@@
 struct ti_am335x_xbar_data * cocci_id@p ;
...
typedef u32,u16;
@@
 struct ti_dra7_xbar_data {  void __iomem * iomem ;  struct dma_router dmarouter ;  struct mutex mutex ;  unsigned long * dma_inuse ;  u16 safe_val ;  u32 xbar_requests ;  u32 dma_requests ;  u32 dma_offset ; } cocci_id@p ;
...
position p;
@@
 struct ti_dra7_xbar_data * cocci_id@p ;
...
position p;
@@
 struct ti_dra7_xbar_map * cocci_id@p ;
