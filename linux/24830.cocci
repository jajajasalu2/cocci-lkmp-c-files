...
position p;
@@
 const struct udphdr * cocci_id@p ;
...
position p;
@@
 RegistrationConfirm * cocci_id@p ;
...
position p;
@@
 UnregistrationRequest * cocci_id@p ;
...
position p;
@@
 struct nf_ct_h323_master * cocci_id@p ;
...
position p;
@@
 MultimediaSystemControlMessage cocci_id@p ;
...
position p;
@@
 RegistrationRequest * cocci_id@p ;
...
position p;
@@
 typeof ( nat_t120_hook ) cocci_id@p ;
...
position p;
@@
 typeof ( nat_q931_hook ) cocci_id@p ;
...
position p;
@@
 H2250LogicalChannelParameters * cocci_id@p ;
...
position p;
@@
 typeof ( nat_h245_hook ) cocci_id@p ;
...
position p;
@@
 const struct nf_conntrack_expect_policy cocci_id@p ;
...
position p;
@@
 typeof ( nat_callforwarding_hook ) cocci_id@p ;
...
position p;
@@
 H245_TransportAddress * cocci_id@p ;
...
position p;
@@
 typeof ( set_ras_addr_hook ) cocci_id@p ;
...
position p;
@@
 typeof ( set_sig_addr_hook ) cocci_id@p ;
...
position p;
@@
 H2250LogicalChannelAckParameters * cocci_id@p ;
...
position p;
@@
 const struct nf_ct_h323_master * cocci_id@p ;
...
position p;
@@
 typeof ( set_h225_addr_hook ) cocci_id@p ;
...
position p;
@@
 typeof ( nat_rtp_rtcp_hook ) cocci_id@p ;
...
position p;
@@
 InfoRequestResponse * cocci_id@p ;
...
position p;
@@
 CallProceeding_UUIE * cocci_id@p ;
...
position p;
@@
 OpenLogicalChannelAck * cocci_id@p ;
