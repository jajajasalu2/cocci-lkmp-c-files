...
position p;
@@
 const struct mcp4531_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct mcp4531_data {  struct i2c_client * client ;  const struct mcp4531_cfg * cfg ; } cocci_id@p ;
...
position p;
@@
 struct mcp4531_cfg {  int wipers ;  int avail [ 3 ] ;  int kohms ; } cocci_id@p ;
...
position p;
@@
 struct mcp4531_data * cocci_id@p ;
