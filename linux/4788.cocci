...
position p;
@@
 struct iser_data_buf * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct iscsi_iser_task * iser_task , struct iser_data_buf * mem , struct iser_reg_resources * rsc , struct iser_mem_reg * mem_reg ) ;
...
position p;
@@
 const struct iser_reg_ops cocci_id@p ;
