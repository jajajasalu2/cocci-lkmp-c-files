...
position p;
@@
 struct bttv_sub_driver cocci_id@p ;
...
position p;
@@
 const struct or51211_config cocci_id@p ;
...
position p;
@@
 struct cx24110_config cocci_id@p ;
...
position p;
@@
 const struct dst_config cocci_id@p ;
...
position p;
@@
 struct nxt6000_config cocci_id@p ;
...
position p;
@@
 struct bttv_sub_device * cocci_id@p ;
...
position p;
@@
 const struct sp887x_config cocci_id@p ;
...
position p;
@@
 struct dvb_bt8xx_card cocci_id@p ;
