...
position p;
@@
 struct atl2_spi_flash_dev cocci_id@p [ ] ;
...
position p;
@@
 struct tx_pkt_header cocci_id@p ;
...
position p;
@@
 struct atl2_opt_list * cocci_id@p ;
...
position p;
@@
 struct atl2_adapter * cocci_id@p ;
...
position p;
@@
 struct atl2_option {  enum { enable_option , range_option , list_option , } type ;  char * name ;  char * err ;  int def ;  union {  struct {  int min ;  int max ; } r ;  struct {  int nr ;  struct atl2_opt_list {  int i ;  char * str ; } * p ; } l ; } arg ; } cocci_id@p ;
...
position p;
@@
 struct tx_pkt_status * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct atl2_adapter * adapter ) ;
