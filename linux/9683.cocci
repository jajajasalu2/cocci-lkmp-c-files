...
position p;
@@
 struct iwl_phy_db_entry * cocci_id@p ;
...
position p;
@@
 struct iwl_calib_res_notif_phy_db * cocci_id@p ;
...
position p;
@@
 enum iwl_phy_db_section_type { IWL_PHY_DB_CFG = 1 , IWL_PHY_DB_CALIB_NCH , IWL_PHY_DB_UNUSED , IWL_PHY_DB_CALIB_CHG_PAPD , IWL_PHY_DB_CALIB_CHG_TXP , IWL_PHY_DB_MAX , } cocci_id@p ;
...
position p;
@@
 struct iwl_phy_db_cmd cocci_id@p ;
...
position p;
@@
 enum iwl_phy_db_section_type cocci_id@p ;
...
typedef u8,u16;
@@
 struct iwl_phy_db_entry {  u16 size ;  u8 * data ; } cocci_id@p ;
...
position p;
@@
 struct iwl_phy_db {  struct iwl_phy_db_entry cfg ;  struct iwl_phy_db_entry calib_nch ;  int n_group_papd ;  struct iwl_phy_db_entry * calib_ch_group_papd ;  int n_group_txp ;  struct iwl_phy_db_entry * calib_ch_group_txp ;  struct iwl_trans * trans ; } cocci_id@p ;
...
position p;
@@
 struct iwl_phy_db_chg_txp * cocci_id@p ;
