...
position p;
@@
 struct widget_attribute * cocci_id@p ;
...
position p;
@@
 struct hdac_widget_tree * cocci_id@p ;
...
position p;
@@
 struct hdac_widget_tree {  struct kobject * root ;  struct kobject * afg ;  struct kobject * * nodes ; } cocci_id@p ;
