...
position p;
@@
 void cocci_id@p ( struct usba_udc * udc ) ;
...
position p;
@@
 const struct usba_udc_errata cocci_id@p ;
...
position p;
@@
 struct usba_request * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usba_udc * udc ) ;
...
position p;
@@
 struct usba_fifo_cfg cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct usb_gadget * gadget , struct usb_gadget_driver * driver ) ;
...
position p;
@@
 int cocci_id@p ( struct usb_gadget * gadget ) ;
...
position p;
@@
 union {  struct usb_ctrlrequest crq ;  unsigned long data [ 2 ] ; } cocci_id@p ;
