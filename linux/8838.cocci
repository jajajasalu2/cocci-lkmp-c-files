...
position p;
@@
 const struct stm32_ops * cocci_id@p ;
...
typedef u32;
@@
 struct stm32_dwmac {  struct clk * clk_tx ;  struct clk * clk_rx ;  struct clk * clk_eth_ck ;  struct clk * clk_ethstp ;  struct clk * syscfg_clk ;  int eth_clk_sel_reg ;  int eth_ref_clk_sel_reg ;  int irq_pwr_wakeup ;  u32 mode_reg ;  struct regmap * regmap ;  u32 speed ;  const struct stm32_ops * ops ;  struct device * dev ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct stm32_ops {  int ( * set_mode ) ( struct plat_stmmacenet_data * plat_dat ) ;  int ( * clk_prepare ) ( struct stm32_dwmac * dwmac , bool prepare ) ;  int ( * suspend ) ( struct stm32_dwmac * dwmac ) ;  void ( * resume ) ( struct stm32_dwmac * dwmac ) ;  int ( * parse_data ) ( struct stm32_dwmac * dwmac , struct device * dev ) ;  u32 syscfg_eth_mask ; } cocci_id@p ;
