...
position p;
@@
 enum { PM1 , PM2P5 , PM4 , PM10 , } cocci_id@p ;
...
position p;
@@
 struct sps30_state {  struct i2c_client * client ;  struct mutex lock ;  int state ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SPS30_MAX_READ_SIZE ] ;
...
position p;
@@
 enum { RESET , MEASURING , } cocci_id@p ;
