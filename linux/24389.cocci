...
position p;
@@
 struct hidp_session * cocci_id@p ;
...
position p;
@@
 struct hidp_conninfo cocci_id@p ;
...
position p;
@@
 const struct hidp_connadd_req * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hidp_session * s ) ;
...
position p;
@@
 struct hidp_conndel_req * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct l2cap_conn * conn , struct l2cap_user * user ) ;
...
position p;
@@
 int cocci_id@p ( struct l2cap_conn * conn , struct l2cap_user * user ) ;
...
position p;
@@
 struct hidp_connlist_req * cocci_id@p ;
