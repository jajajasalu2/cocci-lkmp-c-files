...
typedef u8;
@@
 struct iic {  struct cbe_iic_thread_regs __iomem * regs ;  u8 target_id ;  u8 eoi_stack [ 16 ] ;  int eoi_ptr ;  struct device_node * node ; } cocci_id@p ;
...
position p;
@@
 struct cbe_iic_thread_regs cocci_id@p ;
...
position p;
@@
 struct cbe_iic_pending_bits cocci_id@p ;
