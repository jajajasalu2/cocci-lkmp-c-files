...
position p;
@@
 struct tmComResAFeatureDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResProcDescrHeader cocci_id@p ;
...
position p;
@@
 struct tmComResTSFormatDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResTunerDescrHeader cocci_id@p ;
...
position p;
@@
 struct tmFwInfoStruct cocci_id@p ;
...
position p;
@@
 struct tmComResEncoderDescrHeader cocci_id@p ;
...
position p;
@@
 struct tmComResEncAudioBitRate cocci_id@p ;
...
position p;
@@
 struct tmComResAntTermDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResAudioDefaults cocci_id@p ;
...
position p;
@@
 struct tmComResDebugSetLevel cocci_id@p ;
...
position p;
@@
 struct tmComResProbeCommit cocci_id@p ;
...
position p;
@@
 struct tmComResExtDevDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResEncVideoGopStructure cocci_id@p ;
...
position p;
@@
 struct tmComResTunerStandardAuto cocci_id@p ;
...
position p;
@@
 struct tmComResSelDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResVBIFormatDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResDMATermDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResEncVideoBitRate cocci_id@p ;
...
position p;
@@
 struct tmComResDebugGetData cocci_id@p ;
...
position p;
@@
 struct tmComResPathDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResEncVideoInputAspectRatio cocci_id@p ;
...
position p;
@@
 struct tmComResPSFormatDescrHeader * cocci_id@p ;
...
position p;
@@
 struct tmComResTunerStandard cocci_id@p ;
...
position p;
@@
 struct tmComResGPIO cocci_id@p ;
...
position p;
@@
 struct saa7164_port * cocci_id@p ;
