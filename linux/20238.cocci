...
position p;
@@
 struct {  struct {  unsigned long wbase ;  unsigned long wmask ;  unsigned long tbase ; } window [ 2 ] ;  unsigned long hae_1 ;  unsigned long hae_2 ;  unsigned long hae_3 ;  unsigned long hae_4 ;  unsigned long hbase ; } cocci_id@p ;
...
position p;
@@
 struct sable_cpu_csr * cocci_id@p ;
