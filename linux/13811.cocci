...
position p;
@@
 const struct ov5640_mode_info cocci_id@p [ OV5640_NUM_MODES ] ;
...
position p;
@@
 enum ov5640_frame_rate { OV5640_15_FPS = 0 , OV5640_30_FPS , OV5640_60_FPS , OV5640_NUM_FRAMERATES , } cocci_id@p ;
...
position p;
@@
 const struct ov5640_mode_info cocci_id@p ;
...
position p;
@@
 struct v4l2_subdev_frame_interval_enum * cocci_id@p ;
...
position p;
@@
 enum v4l2_exposure_auto_type cocci_id@p ;
...
position p;
@@
 enum ov5640_format_mux { OV5640_FMT_MUX_YUV422 = 0 , OV5640_FMT_MUX_RGB , OV5640_FMT_MUX_DITHER , OV5640_FMT_MUX_RAW_DPC , OV5640_FMT_MUX_SNR_RAW , OV5640_FMT_MUX_RAW_CIP , } cocci_id@p ;
...
position p;
@@
 enum ov5640_mode_id { OV5640_MODE_QCIF_176_144 = 0 , OV5640_MODE_QVGA_320_240 , OV5640_MODE_VGA_640_480 , OV5640_MODE_NTSC_720_480 , OV5640_MODE_PAL_720_576 , OV5640_MODE_XGA_1024_768 , OV5640_MODE_720P_1280_720 , OV5640_MODE_1080P_1920_1080 , OV5640_MODE_QSXGA_2592_1944 , OV5640_NUM_MODES , } cocci_id@p ;
...
position p;
@@
 struct ov5640_ctrls {  struct v4l2_ctrl_handler handler ;  struct v4l2_ctrl * pixel_rate ;  struct {  struct v4l2_ctrl * auto_exp ;  struct v4l2_ctrl * exposure ; } ;  struct {  struct v4l2_ctrl * auto_wb ;  struct v4l2_ctrl * blue_balance ;  struct v4l2_ctrl * red_balance ; } ;  struct {  struct v4l2_ctrl * auto_gain ;  struct v4l2_ctrl * gain ; } ;  struct v4l2_ctrl * brightness ;  struct v4l2_ctrl * light_freq ;  struct v4l2_ctrl * saturation ;  struct v4l2_ctrl * contrast ;  struct v4l2_ctrl * hue ;  struct v4l2_ctrl * test_pattern ;  struct v4l2_ctrl * hflip ;  struct v4l2_ctrl * vflip ; } cocci_id@p ;
...
position p;
@@
 struct v4l2_subdev_frame_interval * cocci_id@p ;
...
position p;
@@
 struct ov5640_ctrls * cocci_id@p ;
...
typedef u32;
@@
 struct ov5640_pixfmt {  u32 code ;  u32 colorspace ; } cocci_id@p ;
...
position p;
@@
 enum ov5640_frame_rate cocci_id@p ;
...
position p;
@@
 struct v4l2_subdev_frame_size_enum * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct reg_value {  u16 reg_addr ;  u8 val ;  u8 mask ;  u32 delay_ms ; } cocci_id@p ;
...
typedef u32;
@@
 struct ov5640_mode_info {  enum ov5640_mode_id id ;  enum ov5640_downsize_mode dn_mode ;  u32 hact ;  u32 htot ;  u32 vact ;  u32 vtot ;  const struct reg_value * reg_data ;  u32 reg_data_size ; } cocci_id@p ;
...
position p;
@@
 const struct ov5640_pixfmt cocci_id@p [ ] ;
...
position p;
@@
 const struct reg_value * cocci_id@p ;
...
position p;
@@
 enum ov5640_downsize_mode cocci_id@p ;
...
position p;
@@
 enum ov5640_downsize_mode { SUBSAMPLING , SCALING , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ov5640_dev * sensor , struct v4l2_mbus_framefmt * format ) ;
