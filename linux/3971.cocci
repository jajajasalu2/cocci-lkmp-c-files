...
position p;
@@
 struct gic_all_vpes_chip_data * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ GIC_MAX_LONGS ] ;
...
typedef bool,u32;
@@
 struct gic_all_vpes_chip_data {  u32 map ;  bool mask ; } cocci_id@p [ GIC_NUM_LOCAL_INTRS ] ;
