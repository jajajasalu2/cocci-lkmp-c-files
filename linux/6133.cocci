...
position p;
@@
 enum { TC6393XB_CELL_NAND , TC6393XB_CELL_MMC , TC6393XB_CELL_OHCI , TC6393XB_CELL_FB , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u16,raw_spinlock_t;
@@
 struct tc6393xb {  void __iomem * scr ;  struct gpio_chip gpio ;  struct clk * clk ;  raw_spinlock_t lock ;  struct {  u8 fer ;  u16 ccr ;  u8 gpi_bcr [ 3 ] ;  u8 gpo_dsr [ 3 ] ;  u8 gpo_doecr [ 3 ] ; } suspend_state ;  struct resource rscr ;  struct resource * iomem ;  int irq ;  int irq_base ; } cocci_id@p ;
