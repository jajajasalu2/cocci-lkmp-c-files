...
position p;
@@
 struct capi_register_params cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,spinlock_t,atomic_t;
@@
 struct capiminor {  unsigned int minor ;  struct capi20_appl * ap ;  u32 ncci ;  atomic_t datahandle ;  atomic_t msgid ;  struct tty_port port ;  int ttyinstop ;  int ttyoutstop ;  struct sk_buff_head inqueue ;  struct sk_buff_head outqueue ;  int outbytes ;  struct sk_buff * outskb ;  spinlock_t outlock ;  struct list_head ackqueue ;  int nack ;  spinlock_t ackqlock ; } cocci_id@p ;
...
position p;
@@
 struct capi_manufacturer_cmd cocci_id@p ;
...
@@
 struct capidev {  struct list_head list ;  struct capi20_appl ap ;  u16 errcode ;  unsigned userflags ;  struct sk_buff_head recvqueue ;  wait_queue_head_t recvwait ;  struct list_head nccis ;  struct mutex lock ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uptr_t,compat_ulong_t;
@@
 struct {  compat_ulong_t cmd ;  compat_uptr_t data ; } cocci_id@p ;
...
position p;
@@
 struct ackqueue_entry * cocci_id@p ;
...
typedef u16;
@@
 struct ackqueue_entry {  struct list_head list ;  u16 datahandle ; } cocci_id@p ;
