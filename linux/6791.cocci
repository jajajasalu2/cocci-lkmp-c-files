...
position p;
@@
 struct fc_rdp_nport_desc cocci_id@p ;
...
position p;
@@
 struct lpfc_logo_event cocci_id@p ;
...
position p;
@@
 struct lpfc_rscn_event_header cocci_id@p ;
...
position p;
@@
 struct fc_rdp_link_service_desc cocci_id@p ;
...
position p;
@@
 struct fc_els_rscn_page cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lpfc_hba * , struct lpfc_iocbq * , struct lpfc_iocbq * ) ;
...
position p;
@@
 struct fc_rdp_link_error_status_desc cocci_id@p ;
...
position p;
@@
 struct fc_rdp_res_frame * cocci_id@p ;
...
position p;
@@
 struct fc_lcb_res_frame cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ sizeof ( struct lpfc_name ) ] ;
...
position p;
@@
 struct lpfc_lsrjt_event cocci_id@p ;
...
position p;
@@
 struct lpfc_fabric_event_header cocci_id@p ;
...
position p;
@@
 struct lpfc_work_evt * cocci_id@p ;
...
position p;
@@
 struct fc_rdp_port_speed_desc cocci_id@p ;
...
position p;
@@
 struct fc_rdp_opd_sfp_desc * cocci_id@p ;
...
position p;
@@
 struct fc_fec_rdp_desc * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_vport * vport ) ;
...
position p;
@@
 struct fc_rdp_req_frame * cocci_id@p ;
...
position p;
@@
 struct fc_lcb_request_frame * cocci_id@p ;
...
position p;
@@
 struct lpfc_mbx_set_beacon_config cocci_id@p ;
...
position p;
@@
 struct lpfc_lcb_context * cocci_id@p ;
...
position p;
@@
 struct sff_trasnceiver_codes_byte5 * cocci_id@p ;
...
position p;
@@
 struct fc_rdp_port_name_desc cocci_id@p ;
...
position p;
@@
 struct sff_trasnceiver_codes_byte4 * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct lpfc_hba * , struct lpfc_iocbq * , struct lpfc_iocbq * ) ;
...
position p;
@@
 struct lpfc_nvme_rport * cocci_id@p ;
...
position p;
@@
 struct lpfc_rdp_context cocci_id@p ;
...
position p;
@@
 struct lpfc_nvme_prli * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lpfc_hba * phba , struct lpfc_iocbq * iocb ) ;
...
position p;
@@
 struct fc_rdp_sfp_desc cocci_id@p ;
...
position p;
@@
 struct lpfc_els_event_header * cocci_id@p ;
...
position p;
@@
 struct fc_rdp_oed_sfp_desc * cocci_id@p ;
...
position p;
@@
 struct {  struct fc_els_rscn rscn ;  struct fc_els_rscn_page portid ; } * cocci_id@p ;
...
position p;
@@
 struct fc_rdp_bbc_desc * cocci_id@p ;
