...
typedef u32;
@@
 struct ov7670_format_struct {  u32 mbus_code ;  enum v4l2_colorspace colorspace ;  struct regval_list * regs ;  int cmatrix [ CMATRIX_LEN ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct regval_list {  unsigned char reg_num ;  unsigned char value ; } cocci_id@p ;
...
position p;
@@
 struct ov7670_format_struct * * cocci_id@p ;
...
position p;
@@
 const struct ov7670_devtype cocci_id@p [ ] ;
...
position p;
@@
 struct ov7670_win_size cocci_id@p [ ] ;
...
position p;
@@
 struct ov7670_win_size {  int width ;  int height ;  unsigned char com7_bit ;  int hstart ;  int hstop ;  int vstart ;  int vstop ;  struct regval_list * regs ; } cocci_id@p ;
...
position p;
@@
 struct ov7670_devtype {  struct ov7670_win_size * win_sizes ;  unsigned int n_win_sizes ;  int ( * set_framerate ) ( struct v4l2_subdev * , struct v4l2_fract * ) ;  void ( * get_framerate ) ( struct v4l2_subdev * , struct v4l2_fract * ) ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct ov7670_info {  struct v4l2_subdev sd ; #if defined(CONFIG_MEDIA_CONTROLLER)  struct media_pad pad ; #endif  struct v4l2_ctrl_handler hdl ;  struct {  struct v4l2_ctrl * auto_gain ;  struct v4l2_ctrl * gain ; } ;  struct {  struct v4l2_ctrl * auto_exposure ;  struct v4l2_ctrl * exposure ; } ;  struct {  struct v4l2_ctrl * saturation ;  struct v4l2_ctrl * hue ; } ;  struct v4l2_mbus_framefmt format ;  struct ov7670_format_struct * fmt ;  struct ov7670_win_size * wsize ;  struct clk * clk ;  int on ;  struct gpio_desc * resetb_gpio ;  struct gpio_desc * pwdn_gpio ;  unsigned int mbus_config ;  int min_width ;  int min_height ;  int clock_speed ;  u8 clkrc ;  bool use_smbus ;  bool pll_bypass ;  bool pclk_hb_disable ;  const struct ov7670_devtype * devtype ; } cocci_id@p ;
...
position p;
@@
 enum ov7670_model { MODEL_OV7670 = 0 , MODEL_OV7675 , } cocci_id@p ;
...
position p;
@@
 struct ov7670_config * cocci_id@p ;
