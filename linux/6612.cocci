...
position p;
@@
 struct bfa_itnim_stats_s cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcs_itnim_s * itnim , enum bfa_itnim_aen_event event ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcs_itnim_s * itnim ) ;
...
position p;
@@
 struct fc_prli_params_s * cocci_id@p ;
...
position p;
@@
 struct bfa_itnim_attr_s * cocci_id@p ;
...
position p;
@@
 enum bfa_fcs_itnim_event cocci_id@p ;
...
position p;
@@
 enum bfa_itnim_aen_event cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * itnim_cbarg , struct bfa_fcxp_s * fcxp_alloced ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcs_itnim_s * itnim , enum bfa_fcs_itnim_event event ) ;
