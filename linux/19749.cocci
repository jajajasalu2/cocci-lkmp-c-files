...
position p;
@@
 const struct bcm47xx_board_type_list2 * cocci_id@p ;
...
position p;
@@
 struct bcm47xx_board_type {  const enum bcm47xx_board board ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct bcm47xx_board_type_list3 {  struct bcm47xx_board_type board ;  const char * value1 ;  const char * value2 ;  const char * value3 ; } cocci_id@p ;
...
position p;
@@
 struct bcm47xx_board_type_list1 {  struct bcm47xx_board_type board ;  const char * value1 ; } cocci_id@p ;
...
position p;
@@
 struct bcm47xx_board_store cocci_id@p ;
...
position p;
@@
 const struct bcm47xx_board_type * cocci_id@p ;
...
position p;
@@
 struct bcm47xx_board_type_list2 {  struct bcm47xx_board_type board ;  const char * value1 ;  const char * value2 ; } cocci_id@p ;
...
position p;
@@
 struct bcm47xx_board_store {  enum bcm47xx_board board ;  char name [ BCM47XX_BOARD_MAX_NAME ] ; } cocci_id@p ;
...
position p;
@@
 const struct bcm47xx_board_type_list3 * cocci_id@p ;
...
position p;
@@
 const struct bcm47xx_board_type_list1 * cocci_id@p ;
