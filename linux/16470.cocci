...
position p;
@@
 struct uhid_create_req_compat * cocci_id@p ;
...
position p;
@@
 struct uhid_create_req cocci_id@p ;
...
position p;
@@
 const struct uhid_event * cocci_id@p ;
...
position p;
@@
 struct uhid_get_report_reply_req * cocci_id@p ;
