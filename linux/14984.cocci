...
position p;
@@
 struct iproc_asiu_clk * cocci_id@p ;
...
position p;
@@
 const struct iproc_asiu_gate * cocci_id@p ;
...
position p;
@@
 struct iproc_asiu {  void __iomem * div_base ;  void __iomem * gate_base ;  struct clk_hw_onecell_data * clk_data ;  struct iproc_asiu_clk * clks ; } cocci_id@p ;
...
position p;
@@
 const struct iproc_asiu_div * cocci_id@p ;
...
position p;
@@
 struct iproc_asiu_clk {  struct clk_hw hw ;  const char * name ;  struct iproc_asiu * asiu ;  unsigned long rate ;  struct iproc_asiu_div div ;  struct iproc_asiu_gate gate ; } cocci_id@p ;
