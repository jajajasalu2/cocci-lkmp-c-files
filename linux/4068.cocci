...
symbol cocci_id;
position p;
typedef u32,raw_spinlock_t;
@@
 struct irqsteer_data {  void __iomem * regs ;  struct clk * ipg_clk ;  int irq [ CHAN_MAX_OUTPUT_INT ] ;  int irq_count ;  raw_spinlock_t lock ;  int reg_num ;  int channel ;  struct irq_domain * domain ;  u32 * saved_reg ; } cocci_id@p ;
...
position p;
@@
 struct irqsteer_data * cocci_id@p ;
