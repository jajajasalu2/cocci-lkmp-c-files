...
position p;
@@
 struct ceph_quotarealm_inode * cocci_id@p ;
...
position p;
@@
 struct ceph_mds_quota * cocci_id@p ;
...
position p;
@@
 enum quota_check_op { QUOTA_CHECK_MAX_FILES_OP , QUOTA_CHECK_MAX_BYTES_OP , QUOTA_CHECK_MAX_BYTES_APPROACHING_OP , } cocci_id@p ;
...
position p;
@@
 enum quota_check_op cocci_id@p ;
