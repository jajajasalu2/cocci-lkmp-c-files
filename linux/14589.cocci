...
position p;
@@
 struct pic32_periph_clk cocci_id@p ;
...
position p;
@@
 struct pic32_periph_clk {  struct clk_hw hw ;  void __iomem * ctrl_reg ;  struct pic32_clk_common * core ; } cocci_id@p ;
...
position p;
@@
 struct pic32_sec_osc cocci_id@p ;
...
position p;
@@
 const struct pic32_periph_clk_data * cocci_id@p ;
...
typedef u32;
@@
 struct pic32_sys_clk {  struct clk_hw hw ;  void __iomem * mux_reg ;  void __iomem * slew_reg ;  u32 slew_div ;  const u32 * parent_map ;  struct pic32_clk_common * core ; } cocci_id@p ;
...
position p;
@@
 const struct pic32_sys_clk_data * cocci_id@p ;
...
position p;
@@
 const struct pic32_sec_osc_data * cocci_id@p ;
...
position p;
@@
 struct pic32_sys_pll * cocci_id@p ;
...
position p;
@@
 struct pic32_ref_osc cocci_id@p ;
...
typedef u32;
@@
 struct pic32_ref_osc {  struct clk_hw hw ;  void __iomem * ctrl_reg ;  const u32 * parent_map ;  struct pic32_clk_common * core ; } cocci_id@p ;
...
position p;
@@
 struct pic32_sys_clk cocci_id@p ;
...
position p;
@@
 const struct pic32_sys_pll_data * cocci_id@p ;
...
position p;
@@
 const struct pic32_ref_osc_data * cocci_id@p ;
...
position p;
@@
 struct pic32_clk_common * cocci_id@p ;
...
typedef u32;
@@
 struct pic32_sys_pll {  struct clk_hw hw ;  void __iomem * ctrl_reg ;  void __iomem * status_reg ;  u32 lock_mask ;  u32 idiv ;  struct pic32_clk_common * core ; } cocci_id@p ;
...
typedef u32;
@@
 struct pic32_sec_osc {  struct clk_hw hw ;  void __iomem * enable_reg ;  void __iomem * status_reg ;  u32 enable_mask ;  u32 status_mask ;  unsigned long fixed_rate ;  struct pic32_clk_common * core ; } cocci_id@p ;
