...
position p;
@@
 struct td043mtea1_panel cocci_id@p ;
...
typedef bool,u16;
@@
 struct td043mtea1_panel {  struct drm_panel panel ;  struct spi_device * spi ;  struct regulator * vcc_reg ;  struct gpio_desc * reset_gpio ;  unsigned int mode ;  u16 gamma [ 12 ] ;  bool vmirror ;  bool powered_on ;  bool spi_suspended ;  bool power_on_resume ; } cocci_id@p ;
