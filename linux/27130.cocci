...
position p;
@@
 struct ubifs_auth_node * cocci_id@p ;
...
position p;
@@
 const struct ubifs_cs_node * cocci_id@p ;
...
position p;
@@
 struct replay_entry * cocci_id@p ;
...
typedef u8,loff_t;
@@
 struct replay_entry {  int lnum ;  int offs ;  int len ;  u8 hash [ UBIFS_HASH_ARR_SZ ] ;  unsigned int deletion : 1 ;  unsigned long long sqnum ;  struct list_head list ;  union ubifs_key key ;  union {  struct fscrypt_name nm ;  struct {  loff_t old_size ;  loff_t new_size ; } ; } ; } cocci_id@p ;
...
position p;
@@
 struct ubifs_trun_node * cocci_id@p ;
...
position p;
@@
 struct bud_entry {  struct list_head list ;  struct ubifs_bud * bud ;  unsigned long long sqnum ;  int free ;  int dirty ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ UBIFS_HASH_ARR_SZ ] ;
