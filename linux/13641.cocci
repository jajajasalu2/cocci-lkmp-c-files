...
@@
 struct sd {  struct gspca_dev gspca_dev ;  uint16_t cam_tag ;  uint8_t stream_flag ;  uint8_t obuf [ 0x400 ] ;  uint8_t ibuf [ 0x200 ] ; } cocci_id@p ;
...
typedef uint8_t;
@@
 struct cam_hdr {  uint8_t magic [ 2 ] ;  __le16 len ;  __le16 cmd ;  __le16 tag ; } cocci_id@p ;
...
@@
 struct pkt_hdr {  uint8_t magic [ 2 ] ;  uint8_t pad ;  uint8_t flag ;  uint8_t unk1 ;  uint8_t seq ;  uint8_t unk2 ;  uint8_t unk3 ;  uint32_t timestamp ; } cocci_id@p ;
