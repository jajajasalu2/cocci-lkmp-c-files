...
typedef atomic_t;
@@
 struct irqc_priv {  void __iomem * iomem ;  void __iomem * cpu_int_base ;  struct irqc_irq irq [ IRQC_IRQ_MAX ] ;  unsigned int number_of_irqs ;  struct device * dev ;  struct irq_chip_generic * gc ;  struct irq_domain * irq_domain ;  atomic_t wakeup_path ; } cocci_id@p ;
...
position p;
@@
 struct irqc_irq {  int hw_irq ;  int requested_irq ;  struct irqc_priv * p ; } cocci_id@p ;
