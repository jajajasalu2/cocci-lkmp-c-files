...
position p;
@@
 void cocci_id@p ( struct qlcnic_adapter * adapter ) ;
...
position p;
@@
 struct qlcnic_host_sds_ring cocci_id@p ;
...
position p;
@@
 struct qlcnic_host_rds_ring * cocci_id@p ;
...
position p;
@@
 struct qlcnic_host_tx_ring * cocci_id@p ;
...
position p;
@@
 struct qlcnic_npar_info * cocci_id@p ;
...
position p;
@@
 const struct qlcnic_legacy_intr_set * cocci_id@p ;
...
position p;
@@
 struct qlcnic_recv_context * cocci_id@p ;
...
position p;
@@
 struct qlcnic_mac_vlan_list * cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct qlcnic_adapter * , u32 ) ;
...
position p;
@@
 struct qlcnic_cmd_buffer * cocci_id@p ;
...
position p;
@@
 struct qlcnic_intrpt_config cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qlcnic_adapter * adapter ) ;
...
position p;
@@
 struct qlcnic_esw_func_cfg cocci_id@p ;
...
position p;
@@
 struct cmd_desc_type0 cocci_id@p ;
...
position p;
@@
 struct qlcnic_hardware_context cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ QLCNIC_MAX_BOARD_NAME_LEN + 19 ] ;
...
position p;
@@
 const struct qlcnic_board_info cocci_id@p [ ] ;
...
position p;
@@
 struct net_device_stats * cocci_id@p ( struct net_device * netdev ) ;
...
position p;
@@
 struct qlcnic_hardware_ops cocci_id@p ;
...
position p;
@@
 struct qlcnic_eswitch cocci_id@p ;
...
position p;
@@
 struct qlcnic_fw_dump * cocci_id@p ;
...
position p;
@@
 struct qlcnic_pci_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct qlcnic_adapter * ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( struct qlcnic_adapter * ) ;
...
position p;
@@
 struct qlcnic_nic_template cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct qlcnic_adapter * adapter , u8 encoding ) ;
