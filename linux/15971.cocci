...
position p;
@@
 struct sw_chnl_cmd cocci_id@p [ MAX_POSTCMD_CNT ] ;
...
position p;
@@
 enum rf90_radio_path_e cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct net_device * dev , enum rf90_radio_path_e e_rfpath , u32 offset , u32 data ) ;
...
position p;
@@
 enum switch_chan_cmd_id cocci_id@p ;
...
position p;
@@
 struct sw_chnl_cmd cocci_id@p [ MAX_RFDEPENDCMD_CNT ] ;
...
position p;
@@
 enum ht_extension_chan_offset cocci_id@p ;
...
position p;
@@
 BB_REGISTER_DEFINITION_T * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct net_device * dev , enum rf90_radio_path_e e_rfpath , u32 offset ) ;
...
position p;
@@
 enum baseband_config_type cocci_id@p ;
...
position p;
@@
 struct sw_chnl_cmd cocci_id@p [ MAX_PRECMD_CNT ] ;
