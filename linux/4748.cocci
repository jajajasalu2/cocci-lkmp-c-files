...
position p;
@@
 struct iwarp_terminate cocci_id@p ;
...
position p;
@@
 struct iwarp_rdma_write cocci_id@p ;
...
position p;
@@
 struct iwarp_ctrl_untagged cocci_id@p ;
...
position p;
@@
 struct iwarp_rdma_rresp cocci_id@p ;
...
position p;
@@
 struct iwarp_rdma_rreq cocci_id@p ;
...
position p;
@@
 struct iwarp_ctrl_tagged cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SIW_QP_STATE_COUNT ] [ sizeof "TERMINATE" ] ;
...
position p;
@@
 struct siw_rx_stream * cocci_id@p ;
...
position p;
@@
 enum siw_access_state cocci_id@p ;
...
position p;
@@
 struct iwarp_msg_info cocci_id@p [ RDMAP_TERMINATE + 1 ] ;
...
position p;
@@
 struct iwarp_send_inv cocci_id@p ;
...
position p;
@@
 struct siw_iwarp_tx * cocci_id@p ;
