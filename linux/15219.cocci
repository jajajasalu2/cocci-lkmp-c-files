...
typedef u32;
@@
 struct lm3601x_led {  struct led_classdev_flash fled_cdev ;  struct i2c_client * client ;  struct regmap * regmap ;  struct mutex lock ;  unsigned int flash_timeout ;  unsigned int last_flag ;  u32 torch_current_max ;  u32 flash_current_max ;  u32 max_flash_timeout ;  u32 led_mode ; } cocci_id@p ;
...
position p;
@@
 enum lm3601x_type { CHIP_LM36010 = 0 , CHIP_LM36011 , } cocci_id@p ;
