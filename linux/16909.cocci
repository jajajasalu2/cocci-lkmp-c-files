...
position p;
@@
 struct focaltech_data cocci_id@p ;
...
position p;
@@
 struct focaltech_finger_state * cocci_id@p ;
...
typedef bool;
@@
 struct focaltech_hw_state {  struct focaltech_finger_state fingers [ FOC_MAX_FINGERS ] ;  unsigned int width ;  bool pressed ; } cocci_id@p ;
...
typedef bool;
@@
 struct focaltech_finger_state {  bool active ;  bool valid ;  unsigned int x ;  unsigned int y ; } cocci_id@p ;
...
position p;
@@
 struct focaltech_hw_state * cocci_id@p ;
