...
position p;
@@
 struct btrfs_dev_replace_item * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_fs_info * fs_info , int scrub_ret ) ;
...
position p;
@@
 void cocci_id@p ( struct btrfs_fs_info * fs_info , struct btrfs_device * srcdev , struct btrfs_device * tgtdev ) ;
