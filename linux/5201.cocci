...
position p;
@@
 struct dln2_gpio_pin_val cocci_id@p ;
...
position p;
@@
 struct dln2_gpio {  struct platform_device * pdev ;  struct gpio_chip gpio ; 
	 DECLARE_BITMAP ( output_enabled , DLN2_GPIO_MAX_PINS ) 
		 ; 
	 DECLARE_BITMAP ( unmasked_irqs , DLN2_GPIO_MAX_PINS ) 
		 ; 
	 DECLARE_BITMAP ( enabled_irqs , DLN2_GPIO_MAX_PINS ) 
		 ;  int irq_type [ DLN2_GPIO_MAX_PINS ] ;  struct mutex irq_lock ; } cocci_id@p ;
...
position p;
@@
 struct dln2_gpio_pin {  __le16 pin ; } cocci_id@p ;
...
position p;
@@
 struct dln2_gpio_pin cocci_id@p ;
...
typedef u8;
@@
 struct dln2_gpio_pin_val {  __le16 pin __packed ;  u8 value ; } cocci_id@p ;
