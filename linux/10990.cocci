...
position p;
@@
 PHM_PerformanceLevelDesignation cocci_id@p ;
...
position p;
@@
 struct smu7_single_dpm_table * cocci_id@p ;
...
position p;
@@
 struct smu7_odn_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct amdgpu_irq_src * cocci_id@p ;
...
position p;
@@
 const struct pp_hwmgr * cocci_id@p ;
...
position p;
@@
 PPTable_Generic_SubTable_Header * cocci_id@p ;
...
position p;
@@
 phm_ppt_v1_voltage_lookup_table * cocci_id@p ;
...
position p;
@@
 struct smu7_performance_level * cocci_id@p ;
...
position p;
@@
 struct amd_pp_clocks * cocci_id@p ;
...
position p;
@@
 struct pp_power_state * cocci_id@p ;
...
position p;
@@
 struct pp_atomctrl_gpio_pin_assignment cocci_id@p ;
...
position p;
@@
 phm_ppt_v1_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 enum PP_OD_DPM_TABLE_COMMAND cocci_id@p ;
...
position p;
@@
 struct phm_odn_clock_levels * cocci_id@p ;
...
position p;
@@
 const struct smu7_hwmgr * cocci_id@p ;
...
position p;
@@
 const struct phm_clock_and_voltage_limits * cocci_id@p ;
...
position p;
@@
 struct profile_mode_setting cocci_id@p [ 7 ] ;
...
position p;
@@
 struct phm_uvd_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v1_mm_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v1_voltage_lookup_record cocci_id@p ;
...
position p;
@@
 ATOM_Tonga_MCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 ATOM_Polaris_SCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 struct profile_mode_setting cocci_id@p ;
...
position p;
@@
 struct phm_samu_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v1_information * cocci_id@p ;
...
position p;
@@
 enum amd_pp_clock_type cocci_id@p ;
...
position p;
@@
 struct pp_hw_power_state cocci_id@p ;
...
position p;
@@
 struct phm_odn_performance_level * cocci_id@p ;
...
position p;
@@
 const struct pp_hwmgr_func cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v1_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 const struct phm_set_power_state_input * cocci_id@p ;
...
position p;
@@
 struct phm_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 ATOM_FIRMWARE_INFO_V2_2 * cocci_id@p ;
...
position p;
@@
 ATOM_Tonga_POWERPLAYTABLE * cocci_id@p ;
...
position p;
@@
 struct PP_TemperatureRange * cocci_id@p ;
...
position p;
@@
 phm_ppt_v1_mm_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 pp_atomctrl_voltage_table * cocci_id@p ;
...
position p;
@@
 const struct smu7_power_state * cocci_id@p ;
...
position p;
@@
 struct smu7_dpm_table * cocci_id@p ;
...
position p;
@@
 struct phm_acp_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct phm_cac_leakage_table * cocci_id@p ;
...
position p;
@@
 const ATOM_PPLIB_CI_CLOCK_INFO * cocci_id@p ;
...
position p;
@@
 const struct pp_hw_power_state * cocci_id@p ;
...
position p;
@@
 phm_ppt_v1_voltage_lookup_record * cocci_id@p ;
...
position p;
@@
 struct phm_phase_shedding_limits_table * cocci_id@p ;
...
position p;
@@
 PHM_AutoThrottleSource cocci_id@p ;
...
position p;
@@
 struct phm_clock_and_voltage_limits * cocci_id@p ;
...
position p;
@@
 enum PP_SMC_POWER_PROFILE cocci_id@p ;
...
position p;
@@
 const struct smu7_performance_level * cocci_id@p ;
...
position p;
@@
 struct phm_vce_clock_voltage_dependency_table * cocci_id@p ;
...
position p;
@@
 struct smu7_odn_dpm_table * cocci_id@p ;
...
position p;
@@
 struct smu7_leakage_voltage * cocci_id@p ;
...
position p;
@@
 PHM_PerformanceLevel * cocci_id@p ;
...
position p;
@@
 struct smu7_power_state cocci_id@p ;
...
position p;
@@
 struct amd_pp_simple_clock_info * cocci_id@p ;
...
position p;
@@
 ATOM_Tonga_SCLK_Dependency_Table * cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v1_voltage_lookup_table * cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v1_pcie_table * cocci_id@p ;
...
position p;
@@
 const struct amdgpu_irq_src_funcs cocci_id@p ;
...
position p;
@@
 enum amd_dpm_forced_level cocci_id@p ;
...
position p;
@@
 enum DPM_EVENT_SRC { DPM_EVENT_SRC_ANALOG = 0 , DPM_EVENT_SRC_EXTERNAL = 1 , DPM_EVENT_SRC_DIGITAL = 2 , DPM_EVENT_SRC_ANALOG_OR_EXTERNAL = 3 , DPM_EVENT_SRC_DIGITAL_OR_EXTERNAL = 4 , } cocci_id@p ;
...
position p;
@@
 const struct pp_power_state * cocci_id@p ;
