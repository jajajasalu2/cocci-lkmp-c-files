...
position p;
@@
 struct rpm_toc_entry cocci_id@p ;
...
position p;
@@
 struct glink_rpm_pipe * cocci_id@p ;
...
position p;
@@
 struct glink_rpm_pipe {  struct qcom_glink_pipe native ;  void __iomem * tail ;  void __iomem * head ;  void __iomem * fifo ; } cocci_id@p ;
