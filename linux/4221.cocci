...
position p;
@@
 struct ec_response_pd_log * cocci_id@p ;
...
typedef u8;
@@
 struct logger_data {  struct device * dev ;  struct cros_ec_dev * ec_dev ;  u8 ec_buffer [ CROS_USBPD_BUFFER_SIZE ] ;  struct delayed_work log_work ;  struct workqueue_struct * log_workqueue ; } cocci_id@p ;
...
position p;
@@
 struct usb_chg_measures * cocci_id@p ;
