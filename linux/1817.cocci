...
position p;
@@
 enum gp2ap020a00f_thresh_val_id { GP2AP020A00F_THRESH_TL , GP2AP020A00F_THRESH_TH , GP2AP020A00F_THRESH_PL , GP2AP020A00F_THRESH_PH , } cocci_id@p ;
...
position p;
@@
 struct gp2ap020a00f_data * cocci_id@p ;
...
position p;
@@
 enum gp2ap020a00f_cmd cocci_id@p ;
...
typedef u8;
@@
 const struct gp2ap020a00f_mutable_config_regs {  u8 op_reg ;  u8 als_reg ;  u8 ps_reg ;  u8 led_reg ; } cocci_id@p [ GP2AP020A00F_NUM_OPMODES ] ;
...
position p;
@@
 enum gp2ap020a00f_thresh_val_id cocci_id@p ;
...
position p;
@@
 enum gp2ap020a00f_opmode cocci_id@p ;
