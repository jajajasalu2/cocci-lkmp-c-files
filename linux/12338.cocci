...
position p;
@@
 enum hdmi_infoframe_type cocci_id@p ;
...
typedef bool;
@@
 struct vc4_hdmi {  struct platform_device * pdev ;  struct drm_encoder * encoder ;  struct drm_connector * connector ;  struct vc4_hdmi_audio audio ;  struct i2c_adapter * ddc ;  void __iomem * hdmicore_regs ;  void __iomem * hd_regs ;  int hpd_gpio ;  bool hpd_active_low ;  struct cec_adapter * cec_adap ;  struct cec_msg cec_rx_msg ;  bool cec_tx_ok ;  bool cec_irq_was_rx ;  struct clk * pixel_clock ;  struct clk * hsm_clock ;  struct debugfs_regset32 hdmi_regset ;  struct debugfs_regset32 hd_regset ; } cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ VC4_HDMI_PACKET_STRIDE ] ;
...
position p;
@@
 struct vc4_hdmi_encoder * cocci_id@p ;
...
position p;
@@
 struct vc4_hdmi_connector {  struct drm_connector base ;  struct drm_encoder * encoder ; } cocci_id@p ;
...
position p;
@@
 struct vc4_hdmi_audio {  struct snd_soc_card card ;  struct snd_soc_dai_link link ;  struct snd_soc_dai_link_component cpu ;  struct snd_soc_dai_link_component codec ;  struct snd_soc_dai_link_component platform ;  int samplerate ;  int channels ;  struct snd_dmaengine_dai_dma_data dma_data ;  struct snd_pcm_substream * substream ; } cocci_id@p ;
...
position p;
@@
 const struct snd_dmaengine_pcm_config cocci_id@p ;
...
typedef bool;
@@
 struct vc4_hdmi_encoder {  struct vc4_encoder base ;  bool hdmi_monitor ;  bool limited_rgb_range ; } cocci_id@p ;
...
position p;
@@
 struct vc4_hdmi_connector * cocci_id@p ;
