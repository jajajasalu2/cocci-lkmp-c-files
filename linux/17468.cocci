...
position p;
@@
 struct epow_errorlog {  unsigned char sensor_value ;  unsigned char event_modifier ;  unsigned char extended_modifier ;  unsigned char reserved ;  unsigned char platform_reason ; } cocci_id@p ;
...
position p;
@@
 struct pseries_hp_errorlog * cocci_id@p ;
...
position p;
@@
 struct pseries_mc_errorlog * cocci_id@p ;
...
position p;
@@
 struct epow_errorlog * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ RTAS_ERROR_LOG_MAX ] ;
...
position p;
@@
 void cocci_id@p ( struct irq_work * work ) ;
...
position p;
@@
 const struct pseries_mc_errorlog * cocci_id@p ;
