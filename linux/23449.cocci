...
position p;
@@
 enum { HP_GAIN_SET_ZERO , HP_GAIN_RESTORE , } cocci_id@p ;
...
position p;
@@
 struct mt6351_priv {  struct device * dev ;  struct regmap * regmap ;  unsigned int dl_rate ;  unsigned int ul_rate ;  int ana_gain [ AUDIO_ANALOG_VOLUME_TYPE_MAX ] ;  int hp_en_counter ; } cocci_id@p ;
...
position p;
@@
 enum { SUPPLY_SUBSEQ_SETTING , SUPPLY_SUBSEQ_ENABLE , SUPPLY_SUBSEQ_MICBIAS , } cocci_id@p ;
