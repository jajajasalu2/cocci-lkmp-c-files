...
position p;
@@
 struct is_share_region * cocci_id@p ;
...
position p;
@@
 struct sensor_open_extended * cocci_id@p ;
...
position p;
@@
 struct fimc_is_sensor * cocci_id@p ;
