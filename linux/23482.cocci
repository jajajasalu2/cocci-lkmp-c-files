...
position p;
@@
 struct {  int div ;  int bclk_div ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 struct {  unsigned int min ;  unsigned int max ;  u16 fll_fratio ;  int ratio ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wm8993_retune_mobile_setting * cocci_id@p ;
...
position p;
@@
 struct {  int rate ;  int sample_rate ; } cocci_id@p [ ] ;
...
position p;
@@
 struct {  int ratio ;  int clk_sys_rate ; } cocci_id@p [ ] ;
...
position p;
@@
 const char * cocci_id@p [ WM8993_NUM_SUPPLIES ] ;
...
typedef u16;
@@
 struct _fll_div {  u16 fll_fratio ;  u16 fll_outdiv ;  u16 fll_clk_ref_div ;  u16 n ;  u16 k ; } cocci_id@p ;
...
position p;
@@
 struct wm8993_priv {  struct wm_hubs_data hubs_data ;  struct device * dev ;  struct regmap * regmap ;  struct regulator_bulk_data supplies [ WM8993_NUM_SUPPLIES ] ;  struct wm8993_platform_data pdata ;  struct completion fll_lock ;  int master ;  int sysclk_source ;  int tdm_slots ;  int tdm_width ;  unsigned int mclk_rate ;  unsigned int sysclk_rate ;  unsigned int fs ;  unsigned int bclk ;  unsigned int fll_fref ;  unsigned int fll_fout ;  int fll_src ; } cocci_id@p ;
