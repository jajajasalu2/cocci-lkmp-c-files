...
position p;
@@
 struct cmdq_flush_completion cocci_id@p ;
...
typedef bool;
@@
 struct cmdq_flush_completion {  struct completion cmplt ;  bool err ; } cocci_id@p ;
