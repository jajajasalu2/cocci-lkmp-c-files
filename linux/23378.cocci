...
position p;
@@
 const struct cs42l56_clk_para cocci_id@p [ ] ;
...
position p;
@@
 struct cs42l56_private cocci_id@p ;
...
typedef u8,u32;
@@
 struct cs42l56_private {  struct regmap * regmap ;  struct snd_soc_component * component ;  struct device * dev ;  struct cs42l56_platform_data pdata ;  struct regulator_bulk_data supplies [ CS42L56_NUM_SUPPLIES ] ;  u32 mclk ;  u8 mclk_prediv ;  u8 mclk_div2 ;  u8 mclk_ratio ;  u8 iface ;  u8 iface_fmt ;  u8 iface_inv ; 
 #if IS_ENABLED(CONFIG_INPUT) 
		  struct input_dev * beep ;  struct work_struct beep_work ;  int beep_rate ; 
 #endif 
	 } cocci_id@p ;
...
position p;
@@
 struct cs42l56_platform_data * cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ CS42L56_NUM_SUPPLIES ] ;
...
typedef u8,u32;
@@
 struct cs42l56_clk_para {  u32 mclk ;  u32 srate ;  u8 ratio ; } cocci_id@p ;
