...
position p;
@@
 const struct vc4_vec_tv_mode * cocci_id@p ;
...
position p;
@@
 struct vc4_vec {  struct platform_device * pdev ;  struct drm_encoder * encoder ;  struct drm_connector * connector ;  void __iomem * regs ;  struct clk * clock ;  const struct vc4_vec_tv_mode * tv_mode ;  struct debugfs_regset32 regset ; } cocci_id@p ;
...
position p;
@@
 struct vc4_vec_connector * cocci_id@p ;
...
position p;
@@
 struct vc4_vec_encoder cocci_id@p ;
...
position p;
@@
 struct vc4_vec_encoder {  struct vc4_encoder base ;  struct vc4_vec * vec ; } cocci_id@p ;
...
position p;
@@
 struct vc4_vec_tv_mode {  const struct drm_display_mode * mode ;  void ( * mode_set ) ( struct vc4_vec * vec ) ; } cocci_id@p ;
...
position p;
@@
 enum vc4_vec_tv_mode_id { VC4_VEC_TV_MODE_NTSC , VC4_VEC_TV_MODE_NTSC_J , VC4_VEC_TV_MODE_PAL , VC4_VEC_TV_MODE_PAL_M , } cocci_id@p ;
...
position p;
@@
 struct vc4_vec_connector {  struct drm_connector base ;  struct vc4_vec * vec ;  struct drm_encoder * encoder ; } cocci_id@p ;
