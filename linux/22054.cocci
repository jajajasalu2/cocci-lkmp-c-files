...
position p;
@@
 struct overflow_data * cocci_id@p ;
...
position p;
@@
 struct unreachable_data * cocci_id@p ;
...
position p;
@@
 struct type_mismatch_data_common * cocci_id@p ;
...
position p;
@@
 struct shift_out_of_bounds_data * cocci_id@p ;
...
position p;
@@
 struct type_descriptor * cocci_id@p ;
...
position p;
@@
 struct invalid_value_data * cocci_id@p ;
...
position p;
@@
 struct out_of_bounds_data * cocci_id@p ;
...
position p;
@@
 struct type_mismatch_data_v1 * cocci_id@p ;
...
position p;
@@
 struct source_location * cocci_id@p ;
...
position p;
@@
 struct type_mismatch_data * cocci_id@p ;
