...
position p;
@@
 struct MR_LD_TARGET_SYNC * cocci_id@p ;
...
position p;
@@
 struct RAID_CONTEXT * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct megasas_instance * instance , const volatile void __iomem * addr ) ;
...
position p;
@@
 union RAID_CONTEXT_UNION * cocci_id@p ;
...
position p;
@@
 struct MPI2_SCSI_TASK_MANAGE_REQUEST * cocci_id@p ;
...
position p;
@@
 struct MPI2_IOC_INIT_RDPQ_ARRAY_ENTRY cocci_id@p ;
...
position p;
@@
 struct MPI25_IEEE_SGE_CHAIN64 * cocci_id@p ;
...
position p;
@@
 union MPI2_REPLY_DESCRIPTORS_UNION * cocci_id@p [ RDPQ_MAX_CHUNK_COUNT ] ;
...
typedef dma_addr_t;
@@
 dma_addr_t cocci_id@p [ RDPQ_MAX_CHUNK_COUNT ] ;
...
position p;
@@
 struct LD_LOAD_BALANCE_INFO cocci_id@p ;
...
position p;
@@
 struct IO_REQUEST_INFO cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct megasas_instance * instance , struct megasas_cmd * cmd ) ;
...
position p;
@@
 struct MPI2_SCSI_IO_SUCCESS_REPLY_DESCRIPTOR * cocci_id@p ;
...
position p;
@@
 struct MR_TASK_MANAGE_REQUEST * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct megasas_instance * instance , struct megasas_cmd * cmd ) ;
...
position p;
@@
 struct MPI2_SCSI_TASK_MANAGE_REPLY * cocci_id@p ;
...
position p;
@@
 struct MPI2_RAID_SCSI_IO_REQUEST * cocci_id@p ;
...
position p;
@@
 union MPI2_SGE_IO_UNION cocci_id@p ;
...
position p;
@@
 union MPI2_REPLY_DESCRIPTORS_UNION * cocci_id@p ;
...
position p;
@@
 struct STREAM_DETECT * cocci_id@p ;
...
position p;
@@
 struct megasas_cmd * cocci_id@p ( struct megasas_instance * instance ) ;
...
position p;
@@
 struct RAID_CONTEXT_G35 * cocci_id@p ;
