...
position p;
@@
 struct vt8500_irq_data * cocci_id@p ;
...
position p;
@@
 struct vt8500_irq_data {  void __iomem * base ;  struct irq_domain * domain ; } cocci_id@p ;
...
position p;
@@
 struct vt8500_irq_data cocci_id@p [ VT8500_INTC_MAX ] ;
