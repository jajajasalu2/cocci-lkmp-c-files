...
position p;
@@
 struct mvebu_uart_driver_data * cocci_id@p ;
...
position p;
@@
 struct uart_regs_layout {  unsigned int rbr ;  unsigned int tsh ;  unsigned int ctrl ;  unsigned int intr ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_uart_pm_regs {  unsigned int rbr ;  unsigned int tsh ;  unsigned int ctrl ;  unsigned int intr ;  unsigned int stat ;  unsigned int brdv ;  unsigned int osamp ; } cocci_id@p ;
...
position p;
@@
 enum { UART_IRQ_SUM = 0 , UART_RX_IRQ = 0 , UART_TX_IRQ , UART_IRQ_COUNT , } cocci_id@p ;
...
typedef bool;
@@
 struct mvebu_uart_driver_data {  bool is_ext ;  struct uart_regs_layout regs ;  struct uart_flags flags ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_uart {  struct uart_port * port ;  struct clk * clk ;  int irq [ UART_IRQ_COUNT ] ;  unsigned char __iomem * nb ;  struct mvebu_uart_driver_data * data ; #if defined(CONFIG_PM)  struct mvebu_uart_pm_regs pm_regs ; #endif } cocci_id@p ;
...
position p;
@@
 struct uart_flags {  unsigned int ctrl_tx_rdy_int ;  unsigned int ctrl_rx_rdy_int ;  unsigned int stat_tx_rdy ;  unsigned int stat_rx_rdy ; } cocci_id@p ;
...
position p;
@@
 struct uart_port cocci_id@p [ MVEBU_NR_UARTS ] ;
