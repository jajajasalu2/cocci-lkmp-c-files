...
position p;
@@
 unsigned long cocci_id@p [ CMC_HISTORY_LENGTH ] ;
...
symbol cocci_id;
position p;
typedef ia64_state_log_t;
@@
 ia64_state_log_t cocci_id@p [ IA64_MAX_LOG_TYPES ] ;
...
position p;
@@
 char cocci_id@p [ MLOGBUF_MSGMAX ] ;
...
symbol cocci_id;
position p;
typedef ia64_err_rec_t,spinlock_t;
@@
 struct ia64_state_log_s {  spinlock_t isl_lock ;  int isl_index ;  unsigned long isl_count ;  ia64_err_rec_t * isl_log [ IA64_MAX_LOGS ] ; } cocci_id@p ;
...
position p;
@@
 struct switch_stack cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( void * , struct ia64_sal_os_state * ) ;
...
symbol cocci_id;
position p;
typedef ia64_mc_info_t;
@@
 ia64_mc_info_t cocci_id@p ;
...
position p;
@@
 const struct mca_table_entry * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ NR_CPUS ] ;
...
typedef u8,u64;
@@
 void cocci_id@p ( int type , u8 * buffer , u64 size , int irqsafe ) ;
...
position p;
@@
 struct ia64_mca_cpu cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ CPE_HISTORY_LENGTH ] ;
...
position p;
@@
 struct ia64_mca_notify_die cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pal_min_state_area_t;
@@
 const pal_min_state_area_t * cocci_id@p ;
...
position p;
@@
 struct ia64_sal_retval cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sal_log_record_header_t;
@@
 sal_log_record_header_t * cocci_id@p ;
...
position p;
@@
 struct ia64_tr_entry * cocci_id@p ;
...
position p;
@@
 const struct switch_stack * cocci_id@p ;
...
position p;
@@
 struct mca_table_entry cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef ia64_err_rec_t;
@@
 ia64_err_rec_t * cocci_id@p ;
...
position p;
@@
 struct ia64_sal_os_state * cocci_id@p ;
