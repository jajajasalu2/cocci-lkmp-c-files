...
position p;
@@
 struct plug_sched_data * cocci_id@p ;
...
typedef bool,u32;
@@
 struct plug_sched_data {  bool unplug_indefinite ;  bool throttled ;  u32 limit ;  u32 pkts_current_epoch ;  u32 pkts_last_epoch ;  u32 pkts_to_release ; } cocci_id@p ;
...
position p;
@@
 struct tc_plug_qopt * cocci_id@p ;
