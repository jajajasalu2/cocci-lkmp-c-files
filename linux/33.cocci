...
@@
 struct module_signature {  uint8_t algo ;  uint8_t hash ;  uint8_t id_type ;  uint8_t signer_len ;  uint8_t key_id_len ;  uint8_t __pad [ 3 ] ;  uint32_t sig_len ; } cocci_id@p ;
