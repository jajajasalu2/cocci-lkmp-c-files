...
typedef u16;
@@
 struct {  int ratio ;  u16 val ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 struct {  int rate ;  u16 val ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wm8961_priv {  struct regmap * regmap ;  int sysclk ; } cocci_id@p ;
