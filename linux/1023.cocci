...
position p;
@@
 int cocci_id@p ( struct map_info * map , struct flchip * chip , unsigned long adr , int mode ) ;
...
position p;
@@
 int cocci_id@p ( struct mtd_info * , struct cfi_private * * ) ;
...
position p;
@@
 int cocci_id@p ( struct mtd_info * ) ;
...
position p;
@@
 struct cfi_intelext_regioninfo * cocci_id@p ;
...
position p;
@@
 struct cfi_intelext_programming_regioninfo * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_long,u_int,u_char;
@@
 int ( * cocci_id@p ) ( struct map_info * map , struct flchip * chip , u_long data_offset , u_char * buf , u_int size , u_long prot_offset , u_int groupno , u_int groupsize ) ;
...
position p;
@@
 struct cfi_pri_atmel cocci_id@p ;
...
position p;
@@
 struct mtd_chip_driver cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mtd_info * , struct erase_info * ) ;
...
position p;
@@
 struct mtd_erase_region_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct map_info * map , struct flchip * chip , unsigned long adr ) ;
...
position p;
@@
 struct flchip_shared * cocci_id@p ;
...
position p;
@@
 struct cfi_intelext_blockinfo cocci_id@p ;
...
position p;
@@
 struct mtd_info * cocci_id@p ( struct mtd_info * ) ;
...
position p;
@@
 struct cfi_intelext_otpinfo * cocci_id@p ;
...
position p;
@@
 struct cfi_pri_intelext * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mtd_info * ) ;
...
position p;
@@
 struct mtd_info * cocci_id@p ( struct map_info * , int ) ;
