...
position p;
@@
 char cocci_id@p [ PARTITION_NAMELEN ] ;
...
position p;
@@
 void cocci_id@p ( struct scsi_info * vscsi ) ;
...
position p;
@@
 struct viosrp_adapter_info * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SYS_ID_NAME_LEN ] ;
...
position p;
@@
 struct srp_i_logout * cocci_id@p ;
...
position p;
@@
 struct ibmvscsis_tport cocci_id@p ;
...
position p;
@@
 long cocci_id@p ( struct scsi_info * vscsi , struct viosrp_crq * crq ) ;
...
position p;
@@
 struct mad_adapter_info_data * cocci_id@p ;
...
position p;
@@
 struct mad_capability_common * cocci_id@p ;
...
position p;
@@
 struct ibmvscsis_nexus * cocci_id@p ;
...
typedef __be64;
@@
 struct port_id {  __be64 id_extension ;  __be64 io_guid ; } * cocci_id@p ;
...
position p;
@@
 struct ibmvscsis_cmd * cocci_id@p ;
...
position p;
@@
 struct viosrp_capabilities * cocci_id@p ;
...
position p;
@@
 struct viosrp_empty_iu * cocci_id@p ;
