...
position p;
@@
 struct drm_modeset_acquire_ctx * cocci_id@p ;
...
position p;
@@
 const struct drm_format_info cocci_id@p [ ] ;
...
position p;
@@
 struct intel_bw_state * cocci_id@p ;
...
position p;
@@
 struct intel_display_error_state * cocci_id@p ;
...
position p;
@@
 enum icl_port_dpll_id cocci_id@p ;
...
position p;
@@
 struct drm_mode_fb_cmd2 cocci_id@p ;
...
position p;
@@
 const struct i915_ggtt_view * cocci_id@p ;
...
position p;
@@
 struct skl_ddb_entry * cocci_id@p ;
...
position p;
@@
 const struct drm_intel_sprite_colorkey * cocci_id@p ;
...
position p;
@@
 struct intel_connector * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_crtc * crtc ) ;
...
position p;
@@
 enum intel_output_format cocci_id@p ;
...
position p;
@@
 struct intel_atomic_state cocci_id@p ;
...
position p;
@@
 const struct drm_mode_config * cocci_id@p ;
...
position p;
@@
 struct intel_initial_plane_config cocci_id@p ;
...
symbol cocci_id;
position p;
typedef intel_wakeref_t;
@@
 intel_wakeref_t cocci_id@p ;
...
position p;
@@
 struct drm_i915_private * cocci_id@p ;
...
position p;
@@
 struct skl_hw_state {  struct skl_ddb_entry ddb_y [ I915_MAX_PLANES ] ;  struct skl_ddb_entry ddb_uv [ I915_MAX_PLANES ] ;  struct skl_ddb_allocation ddb ;  struct skl_pipe_wm wm ; } * cocci_id@p ;
...
position p;
@@
 struct intel_scaler * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_device * dev , struct drm_modeset_acquire_ctx * ctx ) ;
...
position p;
@@
 const struct drm_i915_private * cocci_id@p ;
...
position p;
@@
 struct intel_dpll_hw_state cocci_id@p ;
...
position p;
@@
 struct i915_sw_fence * cocci_id@p ;
...
position p;
@@
 struct intel_load_detect_pipe * cocci_id@p ;
...
position p;
@@
 enum intel_display_power_domain cocci_id@p ;
...
position p;
@@
 struct intel_shared_dpll * cocci_id@p ;
...
position p;
@@
 struct skl_ddb_allocation * cocci_id@p ;
...
position p;
@@
 struct skl_ddb_entry cocci_id@p [ I915_MAX_PIPES ] ;
...
position p;
@@
 enum i915_sw_fence_notify cocci_id@p ;
...
position p;
@@
 struct i915_sched_attr cocci_id@p ;
...
position p;
@@
 struct wait_queue_entry * cocci_id@p ;
...
position p;
@@
 const struct intel_plane_state * cocci_id@p ;
...
position p;
@@
 struct wait_rps_boost * cocci_id@p ;
...
position p;
@@
 struct drm_i915_gem_object * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct intel_crtc * crtc , struct intel_crtc_state * pipe_config ) ;
...
position p;
@@
 struct drm_vblank_crtc * cocci_id@p ;
...
position p;
@@
 const struct drm_mode_fb_cmd2 * cocci_id@p ;
...
position p;
@@
 const union hdmi_infoframe * cocci_id@p ;
...
position p;
@@
 const struct intel_limit * cocci_id@p ;
...
position p;
@@
 struct intel_plane_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct intel_crtc * crtc , struct intel_crtc_state * crtc_state ) ;
...
position p;
@@
 struct drm_clip_rect * cocci_id@p ;
...
position p;
@@
 struct drm_mode_config * cocci_id@p ;
...
position p;
@@
 struct intel_crtc_scaler_state * cocci_id@p ;
...
position p;
@@
 const struct intel_crtc_state * cocci_id@p ;
...
position p;
@@
 struct drm_i915_get_pipe_from_crtc_id * cocci_id@p ;
...
position p;
@@
 struct i915_ggtt_view * cocci_id@p ;
...
position p;
@@
 const struct intel_crtc * cocci_id@p ;
...
position p;
@@
 const struct intel_framebuffer * cocci_id@p ;
...
position p;
@@
 struct intel_framebuffer * cocci_id@p ;
...
position p;
@@
 const struct intel_atomic_state * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct intel_framebuffer * ifb , struct drm_i915_gem_object * obj , struct drm_mode_fb_cmd2 * mode_cmd ) ;
...
position p;
@@
 void cocci_id@p ( struct intel_crtc * crtc , const struct intel_crtc_state * pipe_config ) ;
...
position p;
@@
 void cocci_id@p ( const struct intel_crtc_state * old_crtc_state ) ;
...
position p;
@@
 struct skl_plane_wm * cocci_id@p ;
...
position p;
@@
 const struct intel_rotation_info * cocci_id@p ;
...
position p;
@@
 struct intel_digital_port * cocci_id@p ;
...
position p;
@@
 struct intel_crtc_state * cocci_id@p ;
...
position p;
@@
 const struct intel_crtc_scaler_state * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct intel_crtc_state * crtc_state ) ;
...
position p;
@@
 const struct drm_i915_gem_object * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct intel_crtc_state * crtc_state , const struct intel_link_m_n * m_n , const struct intel_link_m_n * m2_n2 ) ;
...
position p;
@@
 const struct intel_remapped_info * cocci_id@p ;
...
position p;
@@
 struct intel_link_m_n * cocci_id@p ;
...
position p;
@@
 const struct intel_link_m_n * cocci_id@p ;
...
position p;
@@
 const struct drm_framebuffer_funcs cocci_id@p ;
...
position p;
@@
 struct intel_frontbuffer * cocci_id@p ;
...
position p;
@@
 struct wait_rps_boost {  struct wait_queue_entry wait ;  struct drm_crtc * crtc ;  struct i915_request * request ; } cocci_id@p ;
...
position p;
@@
 struct i915_request * cocci_id@p ;
...
position p;
@@
 const struct intel_encoder * cocci_id@p ;
...
position p;
@@
 struct intel_atomic_helper * cocci_id@p ;
...
typedef bool,u32;
@@
 struct intel_display_error_state {  u32 power_well_driver ;  struct intel_cursor_error_state {  u32 control ;  u32 position ;  u32 base ;  u32 size ; } cursor [ I915_MAX_PIPES ] ;  struct intel_pipe_error_state {  bool power_domain_on ;  u32 source ;  u32 stat ; } pipe [ I915_MAX_PIPES ] ;  struct intel_plane_error_state {  u32 control ;  u32 stride ;  u32 size ;  u32 pos ;  u32 addr ;  u32 surface ;  u32 tile_offset ; } plane [ I915_MAX_PIPES ] ;  struct intel_transcoder_error_state {  bool available ;  bool power_domain_on ;  enum transcoder cpu_transcoder ;  u32 conf ;  u32 htotal ;  u32 hblank ;  u32 hsync ;  u32 vtotal ;  u32 vblank ;  u32 vsync ; } transcoder [ 5 ] ; } cocci_id@p ;
...
typedef intel_wakeref_t;
@@
 intel_wakeref_t cocci_id@p [ POWER_DOMAIN_NUM ] ;
...
position p;
@@
 struct intel_encoder * cocci_id@p ;
...
position p;
@@
 struct intel_rotation_info * cocci_id@p ;
...
position p;
@@
 struct drm_i915_error_state_buf * cocci_id@p ;
