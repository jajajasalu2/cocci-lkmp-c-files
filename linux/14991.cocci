...
position p;
@@
 struct raspberrypi_clk {  struct device * dev ;  struct rpi_firmware * firmware ;  struct platform_device * cpufreq ;  unsigned long min_rate ;  unsigned long max_rate ;  struct clk_hw pllb ;  struct clk_hw * pllb_arm ;  struct clk_lookup * pllb_arm_lookup ; } cocci_id@p ;
...
position p;
@@
 struct raspberrypi_clk cocci_id@p ;
...
position p;
@@
 struct raspberrypi_firmware_prop cocci_id@p ;
