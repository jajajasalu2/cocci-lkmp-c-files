...
position p;
@@
 const struct v4l2_format_info * cocci_id@p ;
...
position p;
@@
 struct v4l2_plane_pix_format * cocci_id@p ;
...
position p;
@@
 const struct vpe_port_data * cocci_id@p ;
...
typedef u32;
@@
 struct vpe_mmr_adb {  struct vpdma_adb_hdr out_fmt_hdr ;  u32 out_fmt_reg [ 1 ] ;  u32 out_fmt_pad [ 3 ] ;  struct vpdma_adb_hdr us1_hdr ;  u32 us1_regs [ 8 ] ;  struct vpdma_adb_hdr us2_hdr ;  u32 us2_regs [ 8 ] ;  struct vpdma_adb_hdr us3_hdr ;  u32 us3_regs [ 8 ] ;  struct vpdma_adb_hdr dei_hdr ;  u32 dei_regs [ 8 ] ;  struct vpdma_adb_hdr sc_hdr0 ;  u32 sc_regs0 [ 7 ] ;  u32 sc_pad0 [ 1 ] ;  struct vpdma_adb_hdr sc_hdr8 ;  u32 sc_regs8 [ 6 ] ;  u32 sc_pad8 [ 2 ] ;  struct vpdma_adb_hdr sc_hdr17 ;  u32 sc_regs17 [ 9 ] ;  u32 sc_pad17 [ 3 ] ;  struct vpdma_adb_hdr csc_hdr ;  u32 csc_regs [ 6 ] ;  u32 csc_pad [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct vpdma_data_format * cocci_id@p ;
...
position p;
@@
 const struct vpe_dei_regs * cocci_id@p ;
...
position p;
@@
 struct vpe_us_coeffs {  unsigned short anchor_fid0_c0 ;  unsigned short anchor_fid0_c1 ;  unsigned short anchor_fid0_c2 ;  unsigned short anchor_fid0_c3 ;  unsigned short interp_fid0_c0 ;  unsigned short interp_fid0_c1 ;  unsigned short interp_fid0_c2 ;  unsigned short interp_fid0_c3 ;  unsigned short anchor_fid1_c0 ;  unsigned short anchor_fid1_c1 ;  unsigned short anchor_fid1_c2 ;  unsigned short anchor_fid1_c3 ;  unsigned short interp_fid1_c0 ;  unsigned short interp_fid1_c1 ;  unsigned short interp_fid1_c2 ;  unsigned short interp_fid1_c3 ; } cocci_id@p ;
...
position p;
@@
 const struct vpdma_data_format * cocci_id@p ;
...
@@
 struct vpe_ctx {  struct v4l2_fh fh ;  struct vpe_dev * dev ;  struct v4l2_ctrl_handler hdl ;  unsigned int field ;  unsigned int sequence ;  unsigned int aborting ;  unsigned int bufs_per_job ;  unsigned int bufs_completed ;  struct vpe_q_data q_data [ 2 ] ;  struct vb2_v4l2_buffer * src_vbs [ VPE_MAX_SRC_BUFS ] ;  struct vb2_v4l2_buffer * dst_vb ;  dma_addr_t mv_buf_dma [ 2 ] ;  void * mv_buf [ 2 ] ;  size_t mv_buf_size ;  struct vpdma_buf mmr_adb ;  struct vpdma_buf sc_coeff_h ;  struct vpdma_buf sc_coeff_v ;  struct vpdma_desc_list desc_list ;  bool deinterlacing ;  bool load_mmrs ;  unsigned int src_mv_buf_selector ; } cocci_id@p ;
...
position p;
@@
 const struct v4l2_ctrl_config cocci_id@p ;
...
position p;
@@
 const struct video_device cocci_id@p ;
...
typedef u8;
@@
 struct vpe_port_data {  enum vpdma_channel channel ;  u8 vb_index ;  u8 vb_part ; } cocci_id@p ;
...
position p;
@@
 enum { Q_DATA_SRC = 0 , Q_DATA_DST = 1 , } cocci_id@p ;
...
position p;
@@
 struct vpe_dei_regs {  unsigned long mdt_spacial_freq_thr_reg ;  unsigned long edi_config_reg ;  unsigned long edi_lut_reg0 ;  unsigned long edi_lut_reg1 ;  unsigned long edi_lut_reg2 ;  unsigned long edi_lut_reg3 ; } cocci_id@p ;
...
position p;
@@
 struct v4l2_pix_format_mplane * cocci_id@p ;
...
position p;
@@
 struct vpe_q_data {  struct v4l2_format format ;  unsigned int flags ;  struct v4l2_rect c_rect ;  struct vpe_fmt * fmt ; } cocci_id@p ;
...
position p;
@@
 const struct vpe_port_data cocci_id@p [ 11 ] ;
...
typedef u8,u32;
@@
 struct vpe_fmt {  u32 fourcc ;  u8 types ;  u8 coplanar ;  const struct vpdma_data_format * vpdma_fmt [ VPE_MAX_PLANES ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef spinlock_t,atomic_t,dma_addr_t;
@@
 struct vpe_dev {  struct v4l2_device v4l2_dev ;  struct video_device vfd ;  struct v4l2_m2m_dev * m2m_dev ;  atomic_t num_instances ;  dma_addr_t loaded_mmrs ;  struct mutex dev_mutex ;  spinlock_t lock ;  int irq ;  void __iomem * base ;  struct resource * res ;  struct vpdma_data vpdma_data ;  struct vpdma_data * vpdma ;  struct sc_data * sc ;  struct csc_data * csc ; } cocci_id@p ;
...
position p;
@@
 const struct vpe_us_coeffs cocci_id@p [ ] ;
