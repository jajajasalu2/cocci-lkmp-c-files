...
position p;
@@
 enum xc2028_state { XC2028_NO_FIRMWARE = 0 , XC2028_WAITING_FIRMWARE , XC2028_ACTIVE , XC2028_SLEEP , XC2028_NODEV , } cocci_id@p ;
...
typedef __u16,__u32;
@@
 struct xc2028_data {  struct list_head hybrid_tuner_instance_list ;  struct tuner_i2c_props i2c_props ;  __u32 frequency ;  enum xc2028_state state ;  const char * fname ;  struct firmware_description * firm ;  int firm_size ;  __u16 firm_version ;  __u16 hwmodel ;  __u16 hwvers ;  struct xc2028_ctrl ctrl ;  struct firmware_properties cur_fw ;  struct mutex lock ; } cocci_id@p ;
...
typedef __u16;
@@
 struct firmware_description {  unsigned int type ;  v4l2_std_id id ;  __u16 int_freq ;  unsigned char * ptr ;  unsigned int size ; } cocci_id@p ;
...
position p;
@@
 struct firmware_properties cocci_id@p ;
...
typedef __u16;
@@
 struct firmware_properties {  unsigned int type ;  v4l2_std_id id ;  v4l2_std_id std_req ;  __u16 int_freq ;  unsigned int scode_table ;  int scode_nr ; } cocci_id@p ;
