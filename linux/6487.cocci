...
typedef u8,bool;
@@
 struct bd9571mwv_reg {  struct bd9571mwv * bd ;  u8 bkup_mode_cnt_keepon ;  u8 bkup_mode_cnt_saved ;  bool bkup_mode_enabled ;  bool rstbmode_level ;  bool rstbmode_pulse ; } cocci_id@p ;
...
position p;
@@
 struct bd9571mwv_reg * cocci_id@p ;
...
position p;
@@
 enum bd9571mwv_regulators { VD09 , VD18 , VD25 , VD33 , DVFS , } cocci_id@p ;
