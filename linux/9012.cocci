...
position p;
@@
 enum { MLX4_COMMAND_INTERFACE_MIN_REV = 2 , MLX4_COMMAND_INTERFACE_MAX_REV = 3 , MLX4_COMMAND_INTERFACE_NEW_PORT_CMDS = 3 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_rate_limit_caps * cocci_id@p ;
...
position p;
@@
 struct mlx4_config_dev cocci_id@p ;
...
position p;
@@
 struct mlx4_icm_iter cocci_id@p ;
...
position p;
@@
 enum mlx4_reg_id { MLX4_REG_ID_PTYS = 0x5004 , } cocci_id@p ;
...
position p;
@@
 struct mlx4_access_reg * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct mlx4_config_dev {  __be32 update_flags ;  __be32 rsvd1 [ 3 ] ;  __be16 vxlan_udp_dport ;  __be16 rsvd2 ;  __be16 roce_v2_entropy ;  __be16 roce_v2_udp_dport ;  __be32 roce_flags ;  __be32 rsvd4 [ 25 ] ;  __be16 rsvd5 ;  u8 rsvd6 ;  u8 rx_checksum_val ; } cocci_id@p ;
...
typedef __be32;
@@
 struct {  __be32 v_port1 ;  __be32 v_port2 ; } * cocci_id@p ;
...
position p;
@@
 enum mlx4_access_reg_masks { MLX4_ACCESS_REG_STATUS_MASK = 0x7f , MLX4_ACCESS_REG_METHOD_MASK = 0x7f , MLX4_ACCESS_REG_LEN_MASK = 0x7ff , } cocci_id@p ;
...
position p;
@@
 struct mlx4_ptys_reg * cocci_id@p ;
...
position p;
@@
 enum mlx4_access_reg_method cocci_id@p ;
...
position p;
@@
 struct mlx4_set_port_general_context * cocci_id@p ;
...
position p;
@@
 enum { ADD_TO_MCG = 0x26 , } cocci_id@p ;
