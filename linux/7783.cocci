...
typedef refcount_t;
@@
 struct sbd_duart {  struct sbd_port sport [ 2 ] ;  unsigned long mapctrl ;  refcount_t map_guard ; } cocci_id@p ;
...
position p;
@@
 struct sbd_duart cocci_id@p [ DUART_MAX_CHIP ] ;
...
position p;
@@
 struct sbd_port {  struct sbd_duart * duart ;  struct uart_port port ;  unsigned char __iomem * memctrl ;  int tx_stopped ;  int initialised ; } cocci_id@p ;
