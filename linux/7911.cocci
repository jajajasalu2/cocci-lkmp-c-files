...
position p;
@@
 struct gswip_hw_info {  int max_ports ;  int cpu_port ; } cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct gswip_pce_table_entry {  u16 index ;  u16 table ;  u16 key [ 8 ] ;  u16 val [ 5 ] ;  u16 mask ;  u8 gmap ;  bool type ;  bool valid ;  bool key_mode ; } cocci_id@p ;
...
position p;
@@
 struct gswip_pce_table_entry cocci_id@p ;
...
position p;
@@
 struct gswip_gphy_fw * cocci_id@p ;
...
position p;
@@
 const struct gswip_hw_info cocci_id@p ;
...
typedef u8,u16;
@@
 struct gswip_vlan {  struct net_device * bridge ;  u16 vid ;  u8 fid ; } cocci_id@p ;
...
position p;
@@
 struct xway_gphy_match_data {  char * fe_firmware_name ;  char * ge_firmware_name ; } cocci_id@p ;
...
position p;
@@
 const struct gswip_rmon_cnt_desc cocci_id@p [ ] ;
...
position p;
@@
 struct gswip_rmon_cnt_desc {  unsigned int size ;  unsigned int offset ;  const char * name ; } cocci_id@p ;
...
typedef u32;
@@
 struct gswip_gphy_fw {  struct clk * clk_gate ;  struct reset_control * reset ;  u32 fw_addr_offset ;  char * fw_name ; } cocci_id@p ;
...
position p;
@@
 const struct xway_gphy_match_data cocci_id@p ;
...
@@
 struct gswip_priv { 
	 ...
	 __iomem 
		  void * mdio ; 
	 __iomem 
		  void * mii ;  const struct gswip_hw_info * hw_info ;  const struct xway_gphy_match_data * gphy_fw_name_cfg ;  struct dsa_switch * ds ;  struct device * dev ;  struct regmap * rcu_regmap ;  struct gswip_vlan vlans [ 64 ] ;  int num_gphy_fw ;  struct gswip_gphy_fw * gphy_fw ;  u32 port_vlan_filter ; } cocci_id@p ;
