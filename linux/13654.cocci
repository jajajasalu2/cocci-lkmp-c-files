...
typedef u8;
@@
 struct sd {  struct gspca_dev gspca_dev ;  unsigned char firmware_id [ 6 ] ;  const struct v4l2_pix_format * cap_mode ;  struct work_struct work_struct ;  u8 frame_brightness ;  int block_size ;  int vga ; } cocci_id@p ;
