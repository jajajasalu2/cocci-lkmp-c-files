...
position p;
@@
 struct mousedev_motion cocci_id@p ;
...
position p;
@@
 enum mousedev_emul { MOUSEDEV_EMUL_PS2 , MOUSEDEV_EMUL_IMPS , MOUSEDEV_EMUL_EXPS , } cocci_id@p ;
...
position p;
@@
 struct mousedev_hw_data * cocci_id@p ;
...
position p;
@@
 enum { FRACTION_DENOM = 128 , } cocci_id@p ;
...
position p;
@@
 struct mousedev_client * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( client -> ps2 ) ] ;
