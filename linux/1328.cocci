...
position p;
@@
 struct tahvo_usb {  struct platform_device * pt_dev ;  struct usb_phy phy ;  int vbus_state ;  struct mutex serialize ;  struct clk * ick ;  int irq ;  int tahvo_mode ;  struct extcon_dev * extcon ; } cocci_id@p ;
