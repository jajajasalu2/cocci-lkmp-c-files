...
typedef u8,u32;
@@
 struct dvb_pll_desc {  const char * name ;  u32 min ;  u32 max ;  u32 iffreq ;  void ( * set ) ( struct dvb_frontend * fe , u8 * buf ) ;  u8 * initdata ;  u8 * initdata2 ;  u8 * sleepdata ;  int count ;  struct {  u32 limit ;  u32 stepsize ;  u8 config ;  u8 cb ; } entries [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct dvb_pll_desc * cocci_id@p ;
...
typedef u32;
@@
 struct dvb_pll_priv {  int nr ;  int pll_i2c_address ;  struct i2c_adapter * i2c ;  const struct dvb_pll_desc * pll_desc ;  u32 frequency ;  u32 bandwidth ; } cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ DVB_PLL_MAX ] ;
...
position p;
@@
 struct dvb_pll_priv cocci_id@p ;
