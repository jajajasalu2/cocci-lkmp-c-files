...
position p;
@@
 struct vlynq_device * cocci_id@p ;
...
position p;
@@
 struct vlynq_mapping * cocci_id@p ;
...
position p;
@@
 struct vlynq_driver * cocci_id@p ;
...
typedef u32;
@@
 struct vlynq_regs {  u32 revision ;  u32 control ;  u32 status ;  u32 int_prio ;  u32 int_status ;  u32 int_pending ;  u32 int_ptr ;  u32 tx_offset ;  struct vlynq_mapping rx_mapping [ 4 ] ;  u32 chip ;  u32 autonego ;  u32 unused [ 6 ] ;  u32 int_device [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct vlynq_device_id * cocci_id@p ;
...
position p;
@@
 struct plat_vlynq_ops * cocci_id@p ;
