...
position p;
@@
 char * cocci_id@p [ CMODIO_MAX_MODULES ] ;
...
position p;
@@
 struct cmodio_device * cocci_id@p ;
...
typedef u8;
@@
 struct cmodio_device {  struct pci_dev * pdev ;  struct janz_cmodio_onboard_regs __iomem * ctrl ;  u8 hex ;  struct mfd_cell cells [ CMODIO_MAX_MODULES ] ;  struct resource resources [ 3 * CMODIO_MAX_MODULES ] ;  struct janz_platform_data pdata [ CMODIO_MAX_MODULES ] ; } cocci_id@p ;
