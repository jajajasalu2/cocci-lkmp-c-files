...
position p;
@@
 struct caif_net {  struct cfcnfg * cfg ;  struct caif_device_entry_list caifdevs ; } cocci_id@p ;
...
position p;
@@
 struct caif_device_entry * cocci_id@p ;
...
position p;
@@
 struct caif_device_entry_list {  struct list_head list ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct caif_dev_common * cocci_id@p ;
...
@@
 struct caif_device_entry {  struct cflayer layer ;  struct list_head list ;  struct net_device * netdev ;  int __percpu * pcpu_refcnt ;  spinlock_t flow_lock ;  struct sk_buff * xoff_skb ;  void ( * xoff_skb_dtor ) ( struct sk_buff * skb ) ;  bool xoff ; } cocci_id@p ;
...
position p;
@@
 struct caif_device_entry_list * cocci_id@p ;
