...
position p;
@@
 const unsigned char cocci_id@p [ LOCOMOKBD_NUMKEYS ] ;
...
typedef spinlock_t;
@@
 struct locomokbd {  unsigned char keycode [ LOCOMOKBD_NUMKEYS ] ;  struct input_dev * input ;  char phys [ 32 ] ;  unsigned long base ;  spinlock_t lock ;  struct timer_list timer ;  unsigned long suspend_jiffies ;  unsigned int count_cancel ; } cocci_id@p ;
