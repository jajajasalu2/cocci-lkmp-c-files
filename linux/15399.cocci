...
position p;
@@
 struct rave_sp_wdt {  struct watchdog_device wdd ;  struct rave_sp * sp ;  const struct rave_sp_wdt_variant * variant ;  struct notifier_block reboot_notifier ; } cocci_id@p ;
...
position p;
@@
 const struct rave_sp_wdt_variant cocci_id@p ;
...
typedef bool;
@@
 struct rave_sp_wdt_variant {  unsigned int max_timeout ;  unsigned int min_timeout ;  int ( * configure ) ( struct watchdog_device * , bool ) ;  int ( * restart ) ( struct watchdog_device * ) ; } cocci_id@p ;
...
position p;
@@
 enum { RAVE_SP_RESET_BYTE = 1 , RAVE_SP_RESET_REASON_NORMAL = 0 , RAVE_SP_RESET_DELAY_MS = 500 , } cocci_id@p ;
