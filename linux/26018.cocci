...
position p;
@@
 struct kvm_x86_state * cocci_id@p ;
...
position p;
@@
 struct {  struct kvm_msrs header ;  struct kvm_msr_entry entry ; } cocci_id@p ;
...
position p;
@@
 struct pageMapL4Entry * cocci_id@p ;
...
position p;
@@
 struct pageDirectoryPointerEntry * cocci_id@p ;
...
typedef uint64_t;
@@
 struct pageTableEntry {  uint64_t present : 1 ;  uint64_t writable : 1 ;  uint64_t user : 1 ;  uint64_t write_through : 1 ;  uint64_t cache_disable : 1 ;  uint64_t accessed : 1 ;  uint64_t dirty : 1 ;  uint64_t reserved_07 : 1 ;  uint64_t global : 1 ;  uint64_t ignored_11_09 : 3 ;  uint64_t address : 40 ;  uint64_t ignored_62_52 : 11 ;  uint64_t execute_disable : 1 ; } cocci_id@p ;
...
position p;
@@
 struct kvm_x86_state {  struct kvm_vcpu_events events ;  struct kvm_mp_state mp_state ;  struct kvm_regs regs ;  struct kvm_xsave xsave ;  struct kvm_xcrs xcrs ;  struct kvm_sregs sregs ;  struct kvm_debugregs debugregs ;  union {  struct kvm_nested_state nested ;  char nested_ [ 16384 ] ; } ;  struct kvm_msrs msrs ; } cocci_id@p ;
...
position p;
@@
 struct pageTableEntry * cocci_id@p ;
...
position p;
@@
 struct pageDirectoryEntry * cocci_id@p ;
...
typedef uint64_t;
@@
 struct pageMapL4Entry {  uint64_t present : 1 ;  uint64_t writable : 1 ;  uint64_t user : 1 ;  uint64_t write_through : 1 ;  uint64_t cache_disable : 1 ;  uint64_t accessed : 1 ;  uint64_t ignored_06 : 1 ;  uint64_t page_size : 1 ;  uint64_t ignored_11_08 : 4 ;  uint64_t address : 40 ;  uint64_t ignored_62_52 : 11 ;  uint64_t execute_disable : 1 ; } cocci_id@p ;
