...
position p;
@@
 struct xen_bus_type * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ XEN_BUS_ID_SIZE ] ;
...
position p;
@@
 struct xb_find_info cocci_id@p ;
...
position p;
@@
 struct xenstore_domain_interface * cocci_id@p ;
...
position p;
@@
 struct xb_find_info {  struct xenbus_device * dev ;  const char * nodename ; } cocci_id@p ;
