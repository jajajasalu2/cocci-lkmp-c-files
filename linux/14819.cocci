...
typedef u8;
@@
 struct berlin2_avpll_vco {  struct clk_hw hw ;  void __iomem * base ;  u8 flags ; } cocci_id@p ;
...
position p;
@@
 struct berlin2_avpll_channel cocci_id@p ;
...
position p;
@@
 struct berlin2_avpll_vco * cocci_id@p ;
...
typedef u8;
@@
 struct berlin2_avpll_channel {  struct clk_hw hw ;  void __iomem * base ;  u8 flags ;  u8 index ; } cocci_id@p ;
