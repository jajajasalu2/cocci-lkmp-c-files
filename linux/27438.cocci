...
position p;
@@
 struct ctl_table_poll * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ctl_table_header * head ) ;
...
position p;
@@
 struct ctl_table_set * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ctl_table_header * * phead , struct ctl_table * * pentry ) ;
...
position p;
@@
 const struct ctl_path cocci_id@p [ ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ctl_table_set * ) ;
...
position p;
@@
 struct ctl_table_root * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ctl_table_header * header ) ;
