...
position p;
@@
 struct cs_etm_synth * cocci_id@p ;
...
position p;
@@
 const struct cs_etm_packet * cocci_id@p ;
...
position p;
@@
 enum cs_etm_decoder_operation cocci_id@p ;
...
position p;
@@
 struct cs_etm_auxtrace cocci_id@p ;
...
position p;
@@
 struct cs_etm_decoder_params cocci_id@p ;
...
position p;
@@
 struct cs_etm_packet_queue * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cs_etm_auxtrace * etm ) ;
...
position p;
@@
 struct cs_etm_queue * cocci_id@p ;
...
position p;
@@
 struct cs_etm_decoder * cocci_id@p ;
...
position p;
@@
 struct cs_etm_trace_params * cocci_id@p ;
...
position p;
@@
 struct cs_etm_synth {  struct perf_tool dummy_tool ;  struct perf_session * session ; } cocci_id@p ;
...
position p;
@@
 struct cs_etm_packet * cocci_id@p ;
...
position p;
@@
 struct cs_etm_traceid_queue * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cs_etm_queue * etmq ) ;
