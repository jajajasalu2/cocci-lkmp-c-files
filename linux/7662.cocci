...
position p;
@@
 struct ipw_tty {  struct tty_port port ;  int index ;  struct ipw_hardware * hardware ;  unsigned int channel_idx ;  unsigned int secondary_channel_idx ;  int tty_type ;  struct ipw_network * network ;  unsigned int control_lines ;  struct mutex ipw_tty_mutex ;  int tx_bytes_queued ;  int closing ; } cocci_id@p ;
...
position p;
@@
 struct ipw_hardware * cocci_id@p ;
...
position p;
@@
 struct ipw_tty * cocci_id@p [ IPWIRELESS_PCMCIA_MINORS ] ;
