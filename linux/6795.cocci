...
position p;
@@
 struct lpfc_debugfs_nvmeio_trc cocci_id@p ;
...
position p;
@@
 struct lpfc_debugfs_trc * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ LPFC_MBX_ACC_LBUF_SZ ] ;
...
position p;
@@
 struct lpfc_idiag_cmd * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ LPFC_MAX_SCSI_INFO_TMP_LEN ] ;
...
position p;
@@
 struct lpfc_fc4_ctrl_stat * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ LPFC_DEBUG_OUT_LINE_SZ ] ;
...
position p;
@@
 struct lpfc_nvme_lport * cocci_id@p ;
