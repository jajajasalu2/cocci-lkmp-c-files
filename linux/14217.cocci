...
position p;
@@
 const struct camss_format_info * cocci_id@p ;
...
typedef u8;
@@
 struct fract {  u8 numerator ;  u8 denominator ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct camss_format_info {  u32 code ;  u32 pixelformat ;  u8 planes ;  struct fract hsub [ 3 ] ;  struct fract vsub [ 3 ] ;  unsigned int bpp [ 3 ] ; } cocci_id@p ;
