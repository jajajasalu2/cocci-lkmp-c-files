...
position p;
@@
 struct ocrdma_qp_hwq_info * cocci_id@p ;
...
position p;
@@
 struct ocrdma_ewqe_fr * cocci_id@p ;
...
position p;
@@
 struct ocrdma_ucontext cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_srq_uresp cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_qp_uresp cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_cq_ureq cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_qp_ureq cocci_id@p ;
...
position p;
@@
 struct ocrdma_alloc_ucontext_resp cocci_id@p ;
...
position p;
@@
 struct ocrdma_ewqe_ud_hdr * cocci_id@p ;
...
position p;
@@
 struct ocrdma_create_cq_uresp cocci_id@p ;
...
position p;
@@
 struct ocrdma_alloc_pd_uresp cocci_id@p ;
