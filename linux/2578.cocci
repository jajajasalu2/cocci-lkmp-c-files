...
position p;
@@
 struct gc_merge_info cocci_id@p [ GC_MERGE_NODES ] ;
...
position p;
@@
 struct gc_merge_info * cocci_id@p ;
...
position p;
@@
 struct btree_insert_op cocci_id@p ;
...
position p;
@@
 struct bcache_device * cocci_id@p ;
...
position p;
@@
 struct btree * cocci_id@p [ GC_MERGE_NODES ] ;
...
typedef atomic_t;
@@
 struct btree_insert_op {  struct btree_op op ;  struct keylist * keys ;  atomic_t * journal_ref ;  struct bkey * replace_key ; } cocci_id@p ;
...
position p;
@@
 struct gc_merge_info {  struct btree * b ;  unsigned int keys ; } cocci_id@p ;
...
position p;
@@
 struct refill {  struct btree_op op ;  unsigned int nr_found ;  struct keybuf * buf ;  struct bkey * end ;  keybuf_pred_fn * pred ; } cocci_id@p ;
