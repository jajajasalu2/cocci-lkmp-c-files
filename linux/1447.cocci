...
position p;
@@
 enum { STR_AC_IF , STR_USB_OUT_IT , STR_USB_OUT_IT_CH_NAMES , STR_IO_OUT_OT , STR_IO_IN_IT , STR_IO_IN_IT_CH_NAMES , STR_USB_IN_OT , STR_AS_OUT_IF_ALT0 , STR_AS_OUT_IF_ALT1 , STR_AS_IN_IF_ALT0 , STR_AS_IN_IF_ALT1 , } cocci_id@p ;
...
position p;
@@
 struct uac1_ac_header_descriptor_2 cocci_id@p ;
