...
position p;
@@
 struct imx_key_drv_data * cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_key cocci_id@p ;
...
typedef u32;
@@
 struct imx_sc_msg_key {  struct imx_sc_rpc_msg hdr ;  u32 state ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct imx_key_drv_data {  u32 keycode ;  bool keystate ;  struct delayed_work check_work ;  struct input_dev * input ;  struct imx_sc_ipc * key_ipc_handle ;  struct notifier_block key_notifier ; } cocci_id@p ;
