...
position p;
@@
 struct af9005_fe_state * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct af9005_fe_state {  struct dvb_usb_device * d ;  enum fe_status stat ;  u32 original_fcw ;  u16 original_rf_top ;  u16 original_if_top ;  u16 original_if_min ;  u16 original_aci0_if_top ;  u16 original_aci1_if_top ;  u16 original_aci0_if_min ;  u8 original_if_unplug_th ;  u8 original_rf_unplug_th ;  u8 original_dtop_if_unplug_th ;  u8 original_dtop_rf_unplug_th ;  u32 pre_vit_error_count ;  u32 pre_vit_bit_count ;  u32 ber ;  u32 post_vit_error_count ;  u32 post_vit_bit_count ;  u32 unc ;  u16 abort_count ;  int opened ;  int strong ;  unsigned long next_status_check ;  struct dvb_frontend frontend ; } cocci_id@p ;
