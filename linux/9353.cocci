...
position p;
@@
 struct mt76_reg_pair cocci_id@p [ FREQ_PLAN_REGS ] ;
...
position p;
@@
 struct mt76_reg_pair cocci_id@p [ 3 ] ;
...
position p;
@@
 void cocci_id@p ( struct mt7601u_dev * dev ) ;
...
typedef u8;
@@
 const u8 cocci_id@p [ 14 ] [ FREQ_PLAN_REGS ] ;
...
position p;
@@
 const struct reg_table * cocci_id@p ;
...
position p;
@@
 struct power_per_rate * cocci_id@p ;
...
position p;
@@
 struct mt7601u_rate_power * cocci_id@p ;
...
position p;
@@
 struct mt7601u_tssi_params cocci_id@p ;
