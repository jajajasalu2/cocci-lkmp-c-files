...
typedef u8,u32;
@@
 struct tones_samples {  u32 * len ;  u8 * data ; } cocci_id@p ;
...
position p;
@@
 struct tones_samples cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct pattern {  int tone ;  u8 * data [ 10 ] ;  u32 * siz [ 10 ] ;  u32 seq [ 10 ] ; } cocci_id@p [ ] ;
