...
position p;
@@
 enum { PXA_MEM_13Mhz = 0 , PXA_MEM_SYSTEM_BUS , PXA_MEM_RUN , } cocci_id@p ;
...
position p;
@@
 enum { PXA_LCD_13Mhz = 0 , PXA_LCD_RUN , } cocci_id@p ;
...
position p;
@@
 enum { PXA_BUS_13Mhz = 0 , PXA_BUS_RUN , } cocci_id@p ;
...
position p;
@@
 struct dummy_clk {  const char * con_id ;  const char * dev_id ;  const char * parent ; } cocci_id@p ;
...
position p;
@@
 enum { PXA_CORE_13Mhz = 0 , PXA_CORE_RUN , PXA_CORE_TURBO , } cocci_id@p ;
