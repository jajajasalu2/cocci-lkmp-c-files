...
position p;
@@
 const struct omap_dm_timer_ops * cocci_id@p ;
...
position p;
@@
 struct pwm_omap_dmtimer_chip {  struct pwm_chip chip ;  struct mutex mutex ;  pwm_omap_dmtimer * dm_timer ;  const struct omap_dm_timer_ops * pdata ;  struct platform_device * dm_timer_pdev ; } cocci_id@p ;
...
position p;
@@
 struct pwm_omap_dmtimer_chip cocci_id@p ;
...
position p;
@@
 struct dmtimer_platform_data * cocci_id@p ;
