...
typedef pid_t;
@@
 pid_t cocci_id@p [ MAX_PID_NS_LEVEL ] ;
...
position p;
@@
 const struct kernel_clone_args * cocci_id@p ;
...
position p;
@@
 struct kernel_clone_args cocci_id@p ;
