...
position p;
@@
 struct ipu_irq_map {  unsigned int irq ;  int source ;  struct ipu_irq_bank * bank ;  struct ipu * ipu ; } cocci_id@p ;
...
position p;
@@
 struct ipu_irq_bank {  unsigned int control ;  unsigned int status ;  struct ipu * ipu ; } cocci_id@p ;
...
position p;
@@
 struct ipu_irq_map cocci_id@p [ CONFIG_MX3_IPU_IRQS ] ;
...
position p;
@@
 struct ipu_irq_bank cocci_id@p [ IPU_IRQ_NR_BANKS ] ;
...
position p;
@@
 struct ipu_irq_bank * cocci_id@p ;
