...
position p;
@@
 struct mainscan {  char * name ;  v4l2_std_id std ;  int carr ; } cocci_id@p [ ] ;
...
position p;
@@
 struct saa7134_tvaudio cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p [ ARRAY_SIZE ( mainscan ) ] ;
