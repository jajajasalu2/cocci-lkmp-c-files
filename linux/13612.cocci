...
position p;
@@
 int cocci_id@p ( struct gspca_dev * gspca_dev , __s32 vflip , __s32 hflip ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct sd * sd , u8 * reg_data ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct sd * sd , u8 val ) ;
