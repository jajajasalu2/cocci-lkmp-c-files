...
position p;
@@
 struct iser_rx_desc cocci_id@p ;
...
position p;
@@
 struct rdma_cm_id * cocci_id@p ( struct isert_np * isert_np ) ;
...
position p;
@@
 struct iser_tx_desc * cocci_id@p ;
...
position p;
@@
 struct isert_device * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct isert_conn * isert_conn ) ;
...
position p;
@@
 int cocci_id@p ( struct iscsi_conn * conn , struct iscsi_cmd * cmd ) ;
