...
position p;
@@
 struct axp20x_ac_power * cocci_id@p ;
...
typedef bool;
@@
 struct axp_data {  const struct power_supply_desc * power_desc ;  bool acin_adc ; } cocci_id@p ;
...
position p;
@@
 struct axp20x_ac_power {  struct regmap * regmap ;  struct power_supply * supply ;  struct iio_channel * acin_v ;  struct iio_channel * acin_i ; } cocci_id@p ;
