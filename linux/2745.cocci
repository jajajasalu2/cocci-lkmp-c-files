...
position p;
@@
 struct hix5hd2_i2c_priv * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct hix5hd2_i2c_priv {  struct i2c_adapter adap ;  struct i2c_msg * msg ;  struct completion msg_complete ;  unsigned int msg_idx ;  unsigned int msg_len ;  int stop ;  void __iomem * regs ;  struct clk * clk ;  struct device * dev ;  spinlock_t lock ;  int err ;  unsigned int freq ;  enum hix5hd2_i2c_state state ; } cocci_id@p ;
...
position p;
@@
 enum hix5hd2_i2c_state { HIX5I2C_STAT_RW_ERR = - 1 , HIX5I2C_STAT_INIT , HIX5I2C_STAT_RW , HIX5I2C_STAT_SND_STOP , HIX5I2C_STAT_RW_SUCCESS , } cocci_id@p ;
