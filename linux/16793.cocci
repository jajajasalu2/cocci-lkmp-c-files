...
position p;
@@
 struct uinput_ff_upload_compat cocci_id@p ;
...
position p;
@@
 struct uinput_user_dev * cocci_id@p ;
...
position p;
@@
 struct uinput_setup cocci_id@p ;
...
position p;
@@
 struct uinput_device cocci_id@p ;
...
position p;
@@
 enum uinput_state { UIST_NEW_DEVICE , UIST_SETUP_COMPLETE , UIST_CREATED , } cocci_id@p ;
...
position p;
@@
 const struct input_absinfo * cocci_id@p ;
...
position p;
@@
 struct ff_effect_compat cocci_id@p ;
...
typedef __u32;
@@
 struct uinput_ff_upload_compat {  __u32 request_id ;  __s32 retval ;  struct ff_effect_compat effect ;  struct ff_effect_compat old ; } cocci_id@p ;
...
position p;
@@
 struct uinput_request {  unsigned int id ;  unsigned int code ;  int retval ;  struct completion done ;  union {  unsigned int effect_id ;  struct {  struct ff_effect * effect ;  struct ff_effect * old ; } upload ; } u ; } cocci_id@p ;
...
position p;
@@
 struct uinput_request * cocci_id@p ;
...
position p;
@@
 struct uinput_ff_upload * cocci_id@p ;
...
position p;
@@
 struct uinput_ff_erase cocci_id@p ;
...
position p;
@@
 struct uinput_abs_setup cocci_id@p ;
...
position p;
@@
 const struct uinput_ff_upload * cocci_id@p ;
