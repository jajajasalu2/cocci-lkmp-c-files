...
position p;
@@
 struct xgene_gpio_sb * cocci_id@p ;
...
typedef u16;
@@
 struct xgene_gpio_sb {  struct gpio_chip gc ;  void __iomem * regs ;  struct irq_domain * irq_domain ;  u16 irq_start ;  u16 nirq ;  u16 parent_irq_base ; } cocci_id@p ;
