...
position p;
@@
 struct axp288_adc_info * cocci_id@p ;
...
position p;
@@
 enum axp288_adc_id { AXP288_ADC_TS , AXP288_ADC_PMIC , AXP288_ADC_GP , AXP288_ADC_BATT_CHRG_I , AXP288_ADC_BATT_DISCHRG_I , AXP288_ADC_BATT_V , AXP288_ADC_NR_CHAN , } cocci_id@p ;
...
typedef bool;
@@
 struct axp288_adc_info {  int irq ;  struct regmap * regmap ;  bool ts_enabled ; } cocci_id@p ;
