...
symbol cocci_id;
position p;
typedef bpf_map_clear_priv_t;
@@
 bpf_map_clear_priv_t cocci_id@p ;
...
position p;
@@
 struct bpf_create_map_attr cocci_id@p ;
...
position p;
@@
 struct bpf_prog_info_array_desc cocci_id@p [ ] ;
...
typedef bool;
@@
 const struct {  const char * sec ;  size_t len ;  enum bpf_prog_type prog_type ;  enum bpf_attach_type expected_attach_type ;  bool is_attachable ;  bool is_attach_btf ;  enum bpf_attach_type attach_type ; } cocci_id@p [ ] ;
...
position p;
@@
 struct bpf_map_info cocci_id@p ;
...
position p;
@@
 enum bpf_attach_type cocci_id@p ;
...
position p;
@@
 const struct bpf_prog_load_attr * cocci_id@p ;
...
position p;
@@
 struct bpf_object_open_attr * cocci_id@p ;
...
position p;
@@
 struct perf_cpu_buf {  struct perf_buffer * pb ;  void * base ;  void * buf ;  size_t buf_size ;  int fd ;  int cpu ;  int map_key ; } cocci_id@p ;
...
typedef __u32;
@@
 int cocci_id@p ( const char * name , enum bpf_attach_type attach_type , __u32 attach_prog_fd ) ;
...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct bpf_object * obj ) ;
...
position p;
@@
 const struct bpf_map * cocci_id@p ;
...
position p;
@@
 struct bpf_link {  int ( * destroy ) ( struct bpf_link * link ) ; } cocci_id@p ;
...
position p;
@@
 const struct perf_buffer_opts * cocci_id@p ;
...
typedef uint32_t;
@@
 struct perf_sample_raw {  struct perf_event_header header ;  uint32_t size ;  char data [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 const struct bpf_core_spec * cocci_id@p ;
...
position p;
@@
 enum libbpf_print_level cocci_id@p ;
...
position p;
@@
 struct bpf_prog_load_attr cocci_id@p ;
...
position p;
@@
 struct bpf_prog_info cocci_id@p ;
...
position p;
@@
 const struct bpf_field_reloc * cocci_id@p ;
...
position p;
@@
 enum libbpf_map_type { LIBBPF_MAP_UNSPEC , LIBBPF_MAP_DATA , LIBBPF_MAP_BSS , LIBBPF_MAP_RODATA , } cocci_id@p ;
...
position p;
@@
 const struct bpf_program * cocci_id@p ;
...
position p;
@@
 const struct btf_array * cocci_id@p ;
...
typedef __u32;
@@
 struct ids_vec {  __u32 * data ;  int len ; } cocci_id@p ;
...
position p;
@@
 struct hashmap_entry * cocci_id@p ;
...
position p;
@@
 struct bpf_link_fd {  struct bpf_link link ;  int fd ; } cocci_id@p ;
...
position p;
@@
 struct perf_sample_lost * cocci_id@p ;
...
position p;
@@
 struct bpf_prog_info_linear cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bpf_perf_event_print_t;
@@
 bpf_perf_event_print_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef libbpf_print_fn_t;
@@
 libbpf_print_fn_t cocci_id@p ;
...
position p;
@@
 const struct btf_var_secinfo * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,__u32,bpf_map_clear_priv_t;
@@
 struct bpf_map {  int fd ;  char * name ;  int sec_idx ;  size_t sec_offset ;  int map_ifindex ;  int inner_map_fd ;  struct bpf_map_def def ;  __u32 btf_key_type_id ;  __u32 btf_value_type_id ;  void * priv ;  bpf_map_clear_priv_t clear_priv ;  enum libbpf_map_type libbpf_type ;  char * pin_path ;  bool pinned ;  bool reused ; } cocci_id@p ;
...
position p;
@@
 struct bpf_core_accessor * cocci_id@p ;
...
position p;
@@
 struct bpf_object_load_attr cocci_id@p ;
...
typedef __u32;
@@
 struct bpf_capabilities {  __u32 name : 1 ;  __u32 global_data : 1 ;  __u32 btf_func : 1 ;  __u32 btf_datasec : 1 ;  __u32 array_mmap : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct btf_type * cocci_id@p ;
...
position p;
@@
 enum bpf_perf_event_ret cocci_id@p ;
...
position p;
@@
 struct perf_cpu_buf * cocci_id@p ;
...
position p;
@@
 struct perf_buffer_params {  struct perf_event_attr * attr ;  perf_buffer_event_fn event_cb ;  perf_buffer_sample_fn sample_cb ;  perf_buffer_lost_fn lost_cb ;  void * ctx ;  int cpu_cnt ;  int * cpus ;  int * map_keys ; } cocci_id@p ;
...
typedef __u32;
@@
 struct bpf_core_spec {  const struct btf * btf ;  struct bpf_core_accessor spec [ BPF_CORE_SPEC_MAX_LEN ] ;  int len ;  int raw_spec [ BPF_CORE_SPEC_MAX_LEN ] ;  int raw_len ;  __u32 bit_offset ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bpf_object_clear_priv_t;
@@
 bpf_object_clear_priv_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,__u32,bpf_object_clear_priv_t;
@@
 struct bpf_object {  char name [ BPF_OBJ_NAME_LEN ] ;  char license [ 64 ] ;  __u32 kern_version ;  struct bpf_program * programs ;  size_t nr_programs ;  struct bpf_map * maps ;  size_t nr_maps ;  size_t maps_cap ;  struct bpf_secdata sections ;  bool loaded ;  bool has_pseudo_calls ;  bool relaxed_core_relocs ;  struct {  int fd ;  const void * obj_buf ;  size_t obj_buf_sz ;  Elf * elf ;  GElf_Ehdr ehdr ;  Elf_Data * symbols ;  Elf_Data * data ;  Elf_Data * rodata ;  Elf_Data * bss ;  size_t strtabidx ;  struct {  GElf_Shdr shdr ;  Elf_Data * data ; } * reloc_sects ;  int nr_reloc_sects ;  int maps_shndx ;  int btf_maps_shndx ;  int text_shndx ;  int data_shndx ;  int rodata_shndx ;  int bss_shndx ; } efile ;  struct list_head list ;  struct btf * btf ;  struct btf_ext * btf_ext ;  void * priv ;  bpf_object_clear_priv_t clear_priv ;  struct bpf_capabilities caps ;  char path [ ] ; } cocci_id@p ;
...
position p;
@@
 enum libbpf_map_type cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bpf_program_prep_t;
@@
 bpf_program_prep_t cocci_id@p ;
...
position p;
@@
 struct perf_buffer_params * cocci_id@p ;
...
position p;
@@
 struct bpf_core_spec * cocci_id@p ;
...
position p;
@@
 const struct btf_member * cocci_id@p ;
...
position p;
@@
 const struct bpf_map_def * cocci_id@p ;
...
position p;
@@
 const struct bpf_core_accessor * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bpf_program_clear_priv_t;
@@
 bpf_program_clear_priv_t cocci_id@p ;
...
position p;
@@
 struct bpf_load_program_attr cocci_id@p ;
...
position p;
@@
 const struct btf_var * cocci_id@p ;
...
typedef uint64_t;
@@
 struct perf_sample_lost {  struct perf_event_header header ;  uint64_t id ;  uint64_t lost ;  uint64_t sample_id ; } cocci_id@p ;
...
position p;
@@
 const struct btf_ext_info_sec * cocci_id@p ;
...
position p;
@@
 struct perf_buffer {  perf_buffer_event_fn event_cb ;  perf_buffer_sample_fn sample_cb ;  perf_buffer_lost_fn lost_cb ;  void * ctx ;  size_t page_size ;  size_t mmap_size ;  struct perf_cpu_buf * * cpu_bufs ;  struct epoll_event * events ;  int cpu_cnt ;  int epoll_fd ;  int map_fd ; } cocci_id@p ;
...
position p;
@@
 const struct bpf_object * cocci_id@p ;
...
position p;
@@
 struct perf_sample_raw * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ STRERR_BUFSIZE ] ;
...
position p;
@@
 struct bpf_secdata {  void * rodata ;  void * data ; } cocci_id@p ;
...
typedef bool;
@@
 struct {  const char * path_fmt ;  bool raw_btf ; } cocci_id@p [ ] ;
...
position p;
@@
 struct bpf_prog_prep_result cocci_id@p ;
...
position p;
@@
 const struct btf_ext_info * cocci_id@p ;
...
position p;
@@
 struct bpf_prog_info_array_desc {  int array_offset ;  int count_offset ;  int size_offset ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BPF_OBJ_NAME_LEN ] ;
...
typedef __u32;
@@
 struct bpf_core_accessor {  __u32 type_id ;  __u32 idx ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct bpf_object_open_opts * cocci_id@p ;
...
position p;
@@
 const struct perf_buffer_raw_opts * cocci_id@p ;
