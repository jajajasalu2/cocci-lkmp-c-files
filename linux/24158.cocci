...
position p;
@@
 struct ila_xlat_params * cocci_id@p ;
...
position p;
@@
 struct ila_map {  struct ila_xlat_params xp ;  struct rhash_head node ;  struct ila_map __rcu * next ;  struct rcu_head rcu ; } cocci_id@p ;
...
position p;
@@
 struct ila_dump_iter {  struct rhashtable_iter rhiter ;  int skip ; } cocci_id@p ;
...
position p;
@@
 const struct ila_map * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct sk_buff * skb , bool sir2ila ) ;
...
position p;
@@
 struct ila_dump_iter * cocci_id@p ;
...
position p;
@@
 struct ila_xlat_params {  struct ila_params ip ;  int ifindex ; } cocci_id@p ;
