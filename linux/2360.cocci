...
position p;
@@
 const char * cocci_id@p [ WKUPM3_MEM_MAX ] ;
...
position p;
@@
 struct wkup_m3_rproc * cocci_id@p ;
...
@@
 struct wkup_m3_mem {  void __iomem * cpu_addr ;  phys_addr_t bus_addr ;  u32 dev_addr ;  size_t size ; } cocci_id@p ;
...
position p;
@@
 struct wkup_m3_rproc {  struct rproc * rproc ;  struct platform_device * pdev ;  struct wkup_m3_mem mem [ WKUPM3_MEM_MAX ] ; } cocci_id@p ;
