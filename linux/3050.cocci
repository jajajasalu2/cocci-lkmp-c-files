...
position p;
@@
 struct res_proc_context * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct acpi_resource * , void * ) ;
...
position p;
@@
 struct acpi_address64_attribute * cocci_id@p ;
...
position p;
@@
 struct res_proc_context {  struct list_head * list ;  int ( * preproc ) ( struct acpi_resource * , void * ) ;  void * preproc_data ;  int count ;  int error ; } cocci_id@p ;
...
position p;
@@
 struct acpi_resource_address * cocci_id@p ;
