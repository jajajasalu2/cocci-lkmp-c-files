...
position p;
@@
 const struct xgene_cle_ptree_ewdn * cocci_id@p ;
...
position p;
@@
 enum xgene_cle_parser cocci_id@p ;
...
position p;
@@
 struct xgene_cle_dbptr cocci_id@p [ DB_MAX_PTRS ] ;
...
position p;
@@
 enum xgene_cle_prot_version cocci_id@p ;
...
position p;
@@
 struct xgene_cle_ptree * cocci_id@p ;
...
position p;
@@
 enum xgene_cle_dram_type cocci_id@p ;
...
position p;
@@
 const struct xgene_cle_ptree_branch * cocci_id@p ;
...
position p;
@@
 enum xgene_cle_prot_type cocci_id@p ;
...
position p;
@@
 struct xgene_cle_dbptr * cocci_id@p ;
...
position p;
@@
 struct xgene_cle_ptree_kn * cocci_id@p ;
...
position p;
@@
 enum xgene_cle_cmd_type cocci_id@p ;
...
position p;
@@
 struct xgene_cle_ptree_key * cocci_id@p ;
...
position p;
@@
 const struct xgene_cle_ops cocci_id@p ;
