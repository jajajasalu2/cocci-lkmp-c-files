...
position p;
@@
 struct tda827x_priv * cocci_id@p ;
...
position p;
@@
 const struct tda827x_data cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct tda827x_data {  u32 lomax ;  u8 spd ;  u8 bs ;  u8 bp ;  u8 cp ;  u8 gc3 ;  u8 div1p5 ; } cocci_id@p ;
...
position p;
@@
 struct tda827xa_data * cocci_id@p ;
...
typedef u32;
@@
 struct tda827x_priv {  int i2c_addr ;  struct i2c_adapter * i2c_adap ;  struct tda827x_config * cfg ;  unsigned int sgIF ;  unsigned char lpsel ;  u32 frequency ;  u32 bandwidth ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct tda827xa_data {  u32 lomax ;  u8 svco ;  u8 spd ;  u8 scr ;  u8 sbs ;  u8 gc3 ; } cocci_id@p ;
