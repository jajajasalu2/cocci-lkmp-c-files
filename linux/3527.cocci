...
position p;
@@
 struct wmt_mci_caps cocci_id@p ;
...
position p;
@@
 struct wmt_mci_priv * cocci_id@p ;
...
position p;
@@
 const struct wmt_mci_caps * cocci_id@p ;
...
position p;
@@
 struct wmt_dma_descriptor * cocci_id@p ;
...
typedef u32;
@@
 struct wmt_dma_descriptor {  u32 flags ;  u32 data_buffer_addr ;  u32 branch_addr ;  u32 reserved1 ; } cocci_id@p ;
...
@@
 struct wmt_mci_priv {  struct mmc_host * mmc ;  void __iomem * sdmmc_base ;  int irq_regular ;  int irq_dma ;  void * dma_desc_buffer ;  dma_addr_t dma_desc_device_addr ;  struct completion cmdcomp ;  struct completion datacomp ;  struct completion * comp_cmd ;  struct completion * comp_dma ;  struct mmc_request * req ;  struct mmc_command * cmd ;  struct clk * clk_sdmmc ;  struct device * dev ;  u8 power_inverted ;  u8 cd_inverted ; } cocci_id@p ;
...
typedef u32;
@@
 struct wmt_mci_caps {  unsigned int f_min ;  unsigned int f_max ;  u32 ocr_avail ;  u32 caps ;  u32 max_seg_size ;  u32 max_segs ;  u32 max_blk_size ; } cocci_id@p ;
