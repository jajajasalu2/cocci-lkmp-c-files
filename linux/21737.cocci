...
position p;
@@
 enum diag_stat_enum cocci_id@p ;
...
position p;
@@
 struct diag_stat {  unsigned int counter [ NR_DIAG_STAT ] ; } cocci_id@p ;
...
position p;
@@
 struct diag_desc {  int code ;  char * name ; } cocci_id@p ;
...
position p;
@@
 const struct diag_desc cocci_id@p [ NR_DIAG_STAT ] ;
