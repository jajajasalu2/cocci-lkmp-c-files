...
position p;
@@
 struct nfc_llcp_local * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFC_ATTR_MAX + 1 ] ;
...
typedef u32;
@@
 struct se_io_ctx {  u32 dev_idx ;  u32 se_idx ; } cocci_id@p ;
...
position p;
@@
 struct urelease_work cocci_id@p ;
...
position p;
@@
 struct nfc_vendor_cmd * cocci_id@p ;
...
position p;
@@
 struct nfc_genl_data * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ NFC_SDP_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct nfc_evt_transaction * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ NFC_FIRMWARE_NAME_MAXSIZE + 1 ] ;
...
typedef u32;
@@
 struct urelease_work {  struct work_struct w ;  u32 portid ; } cocci_id@p ;
...
position p;
@@
 struct nfc_llcp_sdp_tlv * cocci_id@p ;
