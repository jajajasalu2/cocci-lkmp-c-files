...
position p;
@@
 int cocci_id@p ( struct kfd_process * p , struct file * filep ) ;
...
position p;
@@
 const struct mm_struct * cocci_id@p ;
...
position p;
@@
 struct kfd_procfs_tree {  struct kobject * kobj ; } cocci_id@p ;
...
position p;
@@
 struct kfd_procfs_tree cocci_id@p ;
...
position p;
@@
 struct kfd_process * cocci_id@p ( const struct task_struct * thread ) ;
