...
position p;
@@
 struct bio_vec cocci_id@p [ AFS_BVEC_MAX ] ;
...
position p;
@@
 enum afs_eproto_cause cocci_id@p ;
...
position p;
@@
 enum afs_call_state cocci_id@p ;
...
position p;
@@
 enum afs_call_trace cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p [ AFS_BVEC_MAX ] ;
...
position p;
@@
 int cocci_id@p ( struct afs_call * ) ;
...
position p;
@@
 struct afs_addr_cursor * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sock * , struct rxrpc_call * , unsigned long ) ;
...
position p;
@@
 void cocci_id@p ( struct rxrpc_call * , unsigned long ) ;
