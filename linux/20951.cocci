...
position p;
@@
 struct openpty_arg {  int master ;  int slave ;  int err ; } cocci_id@p ;
...
position p;
@@
 struct pollfds {  struct pollfd * poll ;  int size ;  int used ; } cocci_id@p ;
