...
position p;
@@
 const struct acr_r352_func cocci_id@p ;
...
position p;
@@
 struct hsf_load_header * cocci_id@p ;
...
position p;
@@
 struct hsflcn_acr_desc * cocci_id@p ;
...
position p;
@@
 struct ls_ucode_img_r352 cocci_id@p ;
...
position p;
@@
 const struct acr_r352_ls_func * cocci_id@p ;
...
position p;
@@
 const struct nvkm_acr_func cocci_id@p ;
...
position p;
@@
 const struct nvkm_acr * cocci_id@p ;
...
position p;
@@
 struct ls_ucode_img_r352 {  struct ls_ucode_img base ;  const struct acr_r352_lsf_func * func ;  struct acr_r352_lsf_wpr_header wpr_header ;  struct acr_r352_lsf_lsb_header lsb_header ; } cocci_id@p ;
...
position p;
@@
 const struct nvkm_pmu * cocci_id@p ;
...
position p;
@@
 const struct acr_r352_lsf_func * cocci_id@p ;
...
position p;
@@
 struct ls_ucode_img * cocci_id@p ;
...
position p;
@@
 const struct acr_r352 * cocci_id@p ;
...
typedef u32;
@@
 struct acr_r352_flcn_bl_desc {  u32 reserved [ 4 ] ;  u32 signature [ 4 ] ;  u32 ctx_dma ;  u32 code_dma_base ;  u32 non_sec_code_off ;  u32 non_sec_code_size ;  u32 sec_code_off ;  u32 sec_code_size ;  u32 code_entry_point ;  u32 data_dma_base ;  u32 data_size ;  u32 code_dma_base1 ;  u32 data_dma_base1 ; } cocci_id@p ;
...
position p;
@@
 struct fw_bin_header * cocci_id@p ;
...
typedef u32,u16;
@@
 struct acr_r352_pmu_bl_desc {  u32 dma_idx ;  u32 code_dma_base ;  u32 code_size_total ;  u32 code_size_to_load ;  u32 code_entry_point ;  u32 data_dma_base ;  u32 data_size ;  u32 overlay_dma_base ;  u32 argc ;  u32 argv ;  u16 code_dma_base1 ;  u16 data_dma_base1 ;  u16 overlay_dma_base1 ; } cocci_id@p ;
...
position p;
@@
 const struct ls_ucode_img * cocci_id@p ;
...
position p;
@@
 struct hsf_fw_header * cocci_id@p ;
...
position p;
@@
 struct acr_r352_pmu_bl_desc * cocci_id@p ;
...
position p;
@@
 struct ls_ucode_img_desc * cocci_id@p ;
...
position p;
@@
 const struct ls_ucode_img_desc * cocci_id@p ;
...
position p;
@@
 const struct hsf_load_header * cocci_id@p ;
...
position p;
@@
 struct nvkm_secboot * cocci_id@p ;
...
position p;
@@
 const struct nvkm_device * cocci_id@p ;
...
position p;
@@
 struct acr_r352_flcn_bl_desc * cocci_id@p ;
...
position p;
@@
 struct acr_r352_lsf_lsb_header * cocci_id@p ;
...
position p;
@@
 struct acr_r352_lsf_wpr_header * cocci_id@p ;
