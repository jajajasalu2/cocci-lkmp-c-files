...
position p;
@@
 const struct svc_fh * cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ DEVID_HASH_SIZE ] ;
...
position p;
@@
 struct nfs4_layout {  struct list_head lo_perstate ;  struct nfs4_layout_stateid * lo_state ;  struct nfsd4_layout_seg lo_seg ; } cocci_id@p ;
...
position p;
@@
 const struct nfsd4_layout_ops * cocci_id@p [ LAYOUT_TYPE_MAX ] ;
...
position p;
@@
 struct nfsd4_layout_seg * cocci_id@p ;
...
position p;
@@
 struct nfsd4_deviceid * cocci_id@p ;
