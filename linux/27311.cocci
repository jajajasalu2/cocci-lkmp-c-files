...
position p;
@@
 struct smb2_read_plain_req cocci_id@p ;
...
position p;
@@
 struct smb2_ioctl_req cocci_id@p ;
...
position p;
@@
 struct durable_context_v2 cocci_id@p ;
...
position p;
@@
 struct smb2_sync_hdr cocci_id@p ;
...
position p;
@@
 struct crt_query_id_ctxt cocci_id@p ;
...
position p;
@@
 struct smb2_set_info_req cocci_id@p ;
...
position p;
@@
 struct _NEGOTIATE_MESSAGE cocci_id@p ;
...
position p;
@@
 struct create_context * cocci_id@p ;
...
position p;
@@
 struct smb2_query_info_rsp cocci_id@p ;
...
position p;
@@
 struct smb2_lock_element * cocci_id@p ;
...
position p;
@@
 struct smb2_tree_connect_req cocci_id@p ;
...
position p;
@@
 struct smb2_neg_context * cocci_id@p ;
...
position p;
@@
 struct create_durable_v2 cocci_id@p ;
...
position p;
@@
 struct create_durable_handle_reconnect_v2 cocci_id@p ;
...
position p;
@@
 struct create_on_disk_id * cocci_id@p ;
...
position p;
@@
 struct smb2_negotiate_req * cocci_id@p ;
...
position p;
@@
 struct smb2_create_req * cocci_id@p ;
...
position p;
@@
 struct smb2_file_all_info * cocci_id@p ;
...
position p;
@@
 struct smb2_tree_disconnect_req * cocci_id@p ;
...
position p;
@@
 struct create_posix * cocci_id@p ;
...
position p;
@@
 FILE_DIRECTORY_INFO cocci_id@p ;
...
position p;
@@
 struct smb2_read_rsp * cocci_id@p ;
...
position p;
@@
 struct ntlmssp_auth cocci_id@p ;
...
position p;
@@
 struct smb2_negotiate_rsp * cocci_id@p ;
...
position p;
@@
 struct smb2_ioctl_rsp * cocci_id@p ;
...
position p;
@@
 struct smb2_file_network_open_info * cocci_id@p ;
...
position p;
@@
 struct smb2_sess_setup_rsp * cocci_id@p ;
...
position p;
@@
 struct smb2_file_eof_info cocci_id@p ;
...
position p;
@@
 struct smb3_fs_vol_info * cocci_id@p ;
...
position p;
@@
 struct smb2_preauth_neg_context cocci_id@p ;
...
position p;
@@
 struct smb2_echo_req * cocci_id@p ;
...
position p;
@@
 struct smbd_buffer_descriptor_v1 * cocci_id@p ;
...
position p;
@@
 struct smb2_oplock_break * cocci_id@p ;
...
position p;
@@
 struct crt_twarp_ctxt cocci_id@p ;
...
position p;
@@
 struct create_durable cocci_id@p ;
...
position p;
@@
 struct smb2_logoff_req * cocci_id@p ;
...
position p;
@@
 const int cocci_id@p [ NUMBER_OF_SMB2_COMMANDS ] ;
...
position p;
@@
 struct smb2_sess_setup_req * cocci_id@p ;
...
position p;
@@
 struct smb2_write_req * cocci_id@p ;
...
position p;
@@
 struct smb3_fs_ss_info cocci_id@p ;
...
position p;
@@
 struct smb2_create_rsp * cocci_id@p ;
...
position p;
@@
 struct smb2_lease_ack * cocci_id@p ;
...
position p;
@@
 struct validate_negotiate_info_rsp * cocci_id@p ;
...
position p;
@@
 struct smb2_encryption_neg_context cocci_id@p ;
...
position p;
@@
 struct smb2_lock_req * cocci_id@p ;
...
position p;
@@
 struct smb2_query_info_req * cocci_id@p ;
...
position p;
@@
 struct smb2_echo_rsp * cocci_id@p ;
...
position p;
@@
 struct smb2_set_info_rsp * cocci_id@p ;
...
position p;
@@
 struct smb2_tree_connect_rsp * cocci_id@p ;
...
position p;
@@
 struct validate_negotiate_info_req * cocci_id@p ;
...
position p;
@@
 struct smb2_compression_capabilities_context * cocci_id@p ;
...
position p;
@@
 struct smb2_write_rsp * cocci_id@p ;
...
position p;
@@
 struct durable_reconnect_context_v2 cocci_id@p ;
...
position p;
@@
 struct SMB2_sess_data cocci_id@p ;
...
position p;
@@
 struct kvec cocci_id@p [ SMB2_CREATE_IOV_SIZE ] ;
...
typedef u64;
@@
 struct SMB2_sess_data {  unsigned int xid ;  struct cifs_ses * ses ;  struct nls_table * nls_cp ;  void ( * func ) ( struct SMB2_sess_data * ) ;  int result ;  u64 previous_session ;  int buf0_type ;  struct kvec iov [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct smb2_sync_pdu * cocci_id@p ;
...
position p;
@@
 struct cifs_spnego_msg * cocci_id@p ;
...
position p;
@@
 struct smb2_close_rsp * cocci_id@p ;
...
position p;
@@
 struct smb2_fs_full_size_info cocci_id@p ;
...
position p;
@@
 struct smb2_posix_neg_context * cocci_id@p ;
...
position p;
@@
 const struct cifs_tcon * cocci_id@p ;
...
position p;
@@
 struct smb2_file_internal_info cocci_id@p ;
...
position p;
@@
 struct kvec cocci_id@p [ SMB2_IOCTL_IOV_SIZE ] ;
...
position p;
@@
 struct smb2_close_req * cocci_id@p ;
...
position p;
@@
 struct smb2_query_directory_req cocci_id@p ;
...
position p;
@@
 struct smb2_query_directory_rsp * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct SMB2_sess_data * sess_data ) ;
...
position p;
@@
 struct smb2_change_notify_req * cocci_id@p ;
...
position p;
@@
 struct smb2_netname_neg_context * cocci_id@p ;
...
position p;
@@
 struct smb2_file_full_ea_info * cocci_id@p ;
...
position p;
@@
 struct compress_ioctl cocci_id@p ;
...
position p;
@@
 struct smb2_flush_req * cocci_id@p ;
