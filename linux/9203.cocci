...
position p;
@@
 struct dpni_cmd_remove_mac_addr * cocci_id@p ;
...
position p;
@@
 enum dpni_congestion_point cocci_id@p ;
...
position p;
@@
 const struct dpni_pools_cfg * cocci_id@p ;
...
position p;
@@
 const struct dpni_rx_tc_dist_cfg * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_irq_status * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_is_enabled * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_max_frame_length * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_rx_hash_dist * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_irq_mask * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_max_frame_length * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_open * cocci_id@p ;
...
position p;
@@
 const struct dpni_link_cfg * cocci_id@p ;
...
position p;
@@
 const struct dpni_rule_cfg * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_get_irq_mask * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_queue * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_primary_mac_addr * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_link_state * cocci_id@p ;
...
position p;
@@
 const struct dpni_queue * cocci_id@p ;
...
position p;
@@
 struct dpni_taildrop * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_irq_enable * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_add_fs_entry * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_pools * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_multicast_promisc * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_add_mac_addr * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_get_statistics * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_get_irq_enable * cocci_id@p ;
...
position p;
@@
 struct dpni_link_cfg * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_offload * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_rx_fs_dist * cocci_id@p ;
...
position p;
@@
 enum dpni_queue_type cocci_id@p ;
...
position p;
@@
 const struct dpni_rx_dist_cfg * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_get_queue * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_statistics * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_get_offload * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_port_mac_addr * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_unicast_promisc * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_link_cfg * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_errors_behavior * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_tx_data_offset * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_qdid * cocci_id@p ;
...
position p;
@@
 struct dpni_queue_id * cocci_id@p ;
...
position p;
@@
 union dpni_statistics * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_irq_enable * cocci_id@p ;
...
position p;
@@
 const struct dpni_fs_action_cfg * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_clear_irq_status * cocci_id@p ;
...
position p;
@@
 struct dpni_ext_set_rx_tc_dist * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_primary_mac_addr * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_offload * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_attr * cocci_id@p ;
...
position p;
@@
 struct dpni_buffer_layout * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_get_irq_status * cocci_id@p ;
...
position p;
@@
 const struct dpkg_profile_cfg * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_get_taildrop * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_buffer_layout * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_api_version * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_buffer_layout * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_rx_tc_dist * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_irq_mask * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_remove_fs_entry * cocci_id@p ;
...
position p;
@@
 struct fsl_mc_command cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_multicast_promisc * cocci_id@p ;
...
position p;
@@
 struct dpni_dist_extract * cocci_id@p ;
...
position p;
@@
 struct dpni_link_state * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_unicast_promisc * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_queue * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_clear_mac_filters * cocci_id@p ;
...
position p;
@@
 struct dpni_rsp_get_taildrop * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_set_taildrop * cocci_id@p ;
...
position p;
@@
 struct dpni_error_cfg * cocci_id@p ;
...
position p;
@@
 const struct dpni_buffer_layout * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_get_qdid * cocci_id@p ;
...
position p;
@@
 struct dpni_cmd_get_buffer_layout * cocci_id@p ;
