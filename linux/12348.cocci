...
position p;
@@
 struct vc4_dsi_encoder cocci_id@p ;
...
position p;
@@
 const struct {  const char * dsi0_name , * dsi1_name ;  int div ; } cocci_id@p [ ] ;
...
@@
 struct vc4_dsi {  struct platform_device * pdev ;  struct mipi_dsi_host dsi_host ;  struct drm_encoder * encoder ;  struct drm_bridge * bridge ;  void __iomem * regs ;  struct dma_chan * reg_dma_chan ;  dma_addr_t reg_dma_paddr ;  u32 * reg_dma_mem ;  dma_addr_t reg_paddr ;  int port ;  u32 channel ;  u32 lanes ;  u32 format ;  u32 divider ;  u32 mode_flags ;  struct clk * escape_clock ;  struct clk * pll_phy_clock ;  struct clk_fixed_factor phy_clocks [ 3 ] ;  struct clk_hw_onecell_data * clk_onecell ;  struct clk * pixel_clock ;  struct completion xfer_completion ;  int xfer_result ;  struct debugfs_regset32 regset ; } cocci_id@p ;
...
position p;
@@
 struct vc4_dsi_encoder {  struct vc4_encoder base ;  struct vc4_dsi * dsi ; } cocci_id@p ;
