...
position p;
@@
 struct armctrl_ic {  void __iomem * base ;  void __iomem * pending [ NR_BANKS ] ;  void __iomem * enable [ NR_BANKS ] ;  void __iomem * disable [ NR_BANKS ] ;  struct irq_domain * domain ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct irq_desc * desc ) ;
