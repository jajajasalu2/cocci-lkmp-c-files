...
position p;
@@
 struct orangefs_bufmap_desc * cocci_id@p ;
...
position p;
@@
 struct orangefs_bufmap * cocci_id@p ;
...
@@
 struct slot_map {  int c ;  wait_queue_head_t q ;  int count ;  unsigned long * map ; } cocci_id@p ;
...
position p;
@@
 struct orangefs_bufmap_desc {  void __user * uaddr ;  struct page * * page_array ;  int array_count ;  struct list_head list_link ; } cocci_id@p ;
