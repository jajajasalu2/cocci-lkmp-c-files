...
symbol cocci_id;
position p;
typedef u8,bool,u32,acpi_handle,u16;
@@
 struct asus_laptop {  char * name ;  struct acpi_table_header * dsdt_info ;  struct platform_device * platform_device ;  struct acpi_device * device ;  struct backlight_device * backlight_device ;  struct input_dev * inputdev ;  struct key_entry * keymap ;  struct input_dev * pega_accel_poll ;  struct asus_led wled ;  struct asus_led bled ;  struct asus_led mled ;  struct asus_led tled ;  struct asus_led rled ;  struct asus_led pled ;  struct asus_led gled ;  struct asus_led kled ;  struct workqueue_struct * led_workqueue ;  int wled_type ;  int bled_type ;  int wireless_status ;  bool have_rsts ;  bool is_pega_lucid ;  bool pega_acc_live ;  int pega_acc_x ;  int pega_acc_y ;  int pega_acc_z ;  struct asus_rfkill wlan ;  struct asus_rfkill bluetooth ;  struct asus_rfkill wwan ;  struct asus_rfkill wimax ;  struct asus_rfkill gps ;  acpi_handle handle ;  u32 ledd_status ;  u8 light_level ;  u8 light_switch ;  u16 event_count [ 128 ] ; } cocci_id@p ;
...
position p;
@@
 struct asus_rfkill {  int control_id ;  struct rfkill * rfkill ;  struct asus_laptop * asus ; } cocci_id@p ;
...
position p;
@@
 struct asus_led {  int wk ;  struct work_struct work ;  struct led_classdev led ;  struct asus_laptop * asus ;  const char * method ; } cocci_id@p ;
