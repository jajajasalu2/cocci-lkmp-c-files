...
position p;
@@
 const struct qcom_cpufreq_match_data cocci_id@p ;
...
typedef u32;
@@
 struct qcom_cpufreq_drv {  struct opp_table * * opp_tables ;  struct opp_table * * genpd_opp_tables ;  u32 versions ;  const struct qcom_cpufreq_match_data * data ; } cocci_id@p ;
...
position p;
@@
 enum _msm_id { MSM8996V3 = 0xF6ul , APQ8096V3 = 0x123ul , MSM8996SG = 0x131ul , APQ8096SG = 0x138ul , } cocci_id@p ;
...
position p;
@@
 struct qcom_cpufreq_drv cocci_id@p ;
...
position p;
@@
 struct qcom_cpufreq_match_data {  int ( * get_version ) ( struct device * cpu_dev , struct nvmem_cell * speedbin_nvmem , struct qcom_cpufreq_drv * drv ) ;  const char * * genpd_names ; } cocci_id@p ;
...
position p;
@@
 enum _msm8996_version cocci_id@p ;
...
position p;
@@
 enum _msm8996_version { MSM8996_V3 , MSM8996_SG , NUM_OF_MSM8996_VERSIONS , } cocci_id@p ;
