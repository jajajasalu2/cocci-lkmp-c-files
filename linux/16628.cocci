...
position p;
@@
 struct qeth_stats {  char name [ ETH_GSTRING_LEN ] ;  unsigned int offset ; } cocci_id@p ;
...
position p;
@@
 struct qeth_out_q_stats cocci_id@p ;
...
position p;
@@
 struct qeth_card_stats cocci_id@p ;
...
position p;
@@
 const struct qeth_stats cocci_id@p [ ] ;
