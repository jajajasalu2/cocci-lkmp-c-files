...
position p;
@@
 struct max14577_charger * cocci_id@p ;
...
position p;
@@
 struct max14577_charger_platform_data * cocci_id@p ;
...
position p;
@@
 enum maxim_device_type cocci_id@p ;
...
position p;
@@
 struct max14577_charger {  struct device * dev ;  struct max14577 * max14577 ;  struct power_supply * charger ;  struct max14577_charger_platform_data * pdata ; } cocci_id@p ;
...
position p;
@@
 const struct maxim_charger_current * cocci_id@p ;
...
position p;
@@
 enum max14577_muic_charger_type cocci_id@p ;
