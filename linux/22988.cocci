...
position p;
@@
 const struct snd_pcm_chmap * cocci_id@p ;
...
position p;
@@
 const struct snd_pcm_hw_params * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct snd_pcm_substream * substream , int channel , unsigned long hwoff , void * buf , unsigned long bytes ) ;
...
position p;
@@
 struct snd_pcm_hw_constraint_ranges * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_pcm_hw_param_t;
@@
 snd_pcm_hw_param_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_pcm_hw_rule_func_t;
@@
 snd_pcm_hw_rule_func_t cocci_id@p ;
...
position p;
@@
 const struct snd_pcm_hw_constraint_ranges * cocci_id@p ;
