...
position p;
@@
 struct meson_sm_firmware {  const struct meson_sm_chip * chip ;  void __iomem * sm_shmem_in_base ;  void __iomem * sm_shmem_out_base ; } cocci_id@p ;
...
position p;
@@
 const struct meson_sm_chip * cocci_id@p ;
...
position p;
@@
 const struct meson_sm_cmd * cocci_id@p ;
...
typedef u32;
@@
 struct meson_sm_chip {  unsigned int shmem_size ;  u32 cmd_shmem_in_base ;  u32 cmd_shmem_out_base ;  struct meson_sm_cmd cmd [ ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct meson_sm_cmd {  unsigned int index ;  u32 smc_id ; } cocci_id@p ;
...
position p;
@@
 struct meson_sm_firmware * cocci_id@p ;
