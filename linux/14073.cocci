...
position p;
@@
 const struct vimc_deb_pix_map cocci_id@p [ ] ;
...
position p;
@@
 struct vimc_deb_device cocci_id@p ;
...
position p;
@@
 enum vimc_deb_rgb_colors { VIMC_DEB_RED = 0 , VIMC_DEB_GREEN = 1 , VIMC_DEB_BLUE = 2 , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct vimc_deb_device {  struct vimc_ent_device ved ;  struct v4l2_subdev sd ;  struct v4l2_mbus_framefmt sink_fmt ;  u32 src_code ;  void ( * set_rgb_src ) ( struct vimc_deb_device * vdeb , unsigned int lin , unsigned int col , unsigned int rgb [ 3 ] ) ;  u8 * src_frame ;  const struct vimc_deb_pix_map * sink_pix_map ;  unsigned int sink_bpp ;  unsigned int mean_win_size ;  struct v4l2_ctrl_handler hdl ;  struct media_pad pads [ 2 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct vimc_deb_pix_map {  u32 code ;  enum vimc_deb_rgb_colors order [ 2 ] [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum vimc_deb_rgb_colors cocci_id@p ;
...
position p;
@@
 struct vimc_ent_device * cocci_id@p ;
...
position p;
@@
 const struct vimc_pix_map * cocci_id@p ;
