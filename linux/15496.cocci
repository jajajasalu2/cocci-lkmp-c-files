...
position p;
@@
 struct sk_buff * cocci_id@p ( struct pn533 * dev ) ;
...
typedef u8;
@@
 union pn533_cmd_poll_initdata {  struct {  u8 afi ;  u8 polling_method ; } __packed type_b ;  struct {  u8 opcode ;  __be16 sc ;  u8 rc ;  u8 tsn ; } __packed felica ; } cocci_id@p ;
...
position p;
@@
 struct pn533_target_type_a * cocci_id@p ;
...
position p;
@@
 struct pn533_ext_frame * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct pn533 * dev , void * arg , struct sk_buff * resp ) ;
...
position p;
@@
 enum pn533_protocol_type cocci_id@p ;
...
position p;
@@
 struct pn533_frame_ops * cocci_id@p ;
...
position p;
@@
 struct pn533_std_frame cocci_id@p ;
...
position p;
@@
 struct pn533_cmd_jump_dep_response * cocci_id@p ;
...
position p;
@@
 struct pn533_fw_version cocci_id@p ;
...
position p;
@@
 struct pn533_sync_cmd_response cocci_id@p ;
...
position p;
@@
 struct pn533_data_exchange_arg * cocci_id@p ;
...
typedef u8;
@@
 struct pn533_poll_modulations {  struct {  u8 maxtg ;  u8 brty ;  union pn533_cmd_poll_initdata initiator_data ; } __packed data ;  u8 len ; } cocci_id@p ;
...
position p;
@@
 struct pn533_config_max_retries cocci_id@p ;
...
position p;
@@
 struct pn533_target_type_b cocci_id@p ;
...
position p;
@@
 struct pn533_cmd_activate_response * cocci_id@p ;
...
position p;
@@
 struct pn533_target_felica * cocci_id@p ;
...
position p;
@@
 struct pn532_autopoll_resp * cocci_id@p ;
...
position p;
@@
 struct pn533_target_jewel cocci_id@p ;
...
position p;
@@
 const struct pn533_poll_modulations cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef data_exchange_cb_t;
@@
 struct pn533_data_exchange_arg {  data_exchange_cb_t cb ;  void * cb_context ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ PASSIVE_DATA_LEN ] ;
...
symbol cocci_id;
position p;
typedef pn533_send_async_complete_t;
@@
 pn533_send_async_complete_t cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct nfc_dev * nfc_dev , u8 rf ) ;
...
position p;
@@
 struct pn533_poll_modulations * cocci_id@p ;
...
position p;
@@
 struct pn533_sync_cmd_response {  struct sk_buff * resp ;  struct completion done ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pn533 * dev ) ;
...
position p;
@@
 struct pn533_phy_ops * cocci_id@p ;
...
position p;
@@
 struct pn533_config_timing cocci_id@p ;
...
typedef u8;
@@
 struct pn533_fw_version {  u8 ic ;  u8 ver ;  u8 rev ;  u8 support ; } cocci_id@p ;
...
typedef u8;
@@
 struct pn532_autopoll_resp {  u8 type ;  u8 ln ;  u8 tg ;  u8 tgdata [ ] ; } cocci_id@p ;
