...
position p;
@@
 struct smsc9420_pdata * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct smsc9420_ring_info {  struct sk_buff * skb ;  dma_addr_t mapping ; } cocci_id@p ;
...
position p;
@@
 struct smsc9420_ring_info cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SMSC9420_EEPROM_SIZE ] ;
...
position p;
@@
 struct smsc9420_dma_desc cocci_id@p ;
...
typedef u32;
@@
 struct smsc9420_dma_desc {  u32 status ;  u32 length ;  u32 buffer1 ;  u32 buffer2 ; } cocci_id@p ;
