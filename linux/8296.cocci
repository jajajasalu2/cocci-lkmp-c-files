...
typedef u32;
@@
 struct rtl_coalesce_scale {  u32 nsecs [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 const struct phy_reg cocci_id@p [ ] ;
...
typedef u8,u32,u16;
@@
 const struct {  u32 opt ;  u16 reg ;  u8 mask ; } cocci_id@p [ ] ;
...
position p;
@@
 struct rtl8169_counters * cocci_id@p ;
...
position p;
@@
 rtl_ep_ocp_read_cond cocci_id@p ;
...
typedef u32;
@@
 struct {  u32 * max_frames ;  u32 * usecs ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 struct phy_reg {  u16 reg ;  u16 val ; } cocci_id@p ;
...
position p;
@@
 const struct rtl_coalesce_info cocci_id@p [ ] ;
...
typedef u32;
@@
 struct {  u32 frames ;  u32 usecs ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 struct rtl_coalesce_info {  u32 speed ;  struct rtl_coalesce_scale scalev [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct {  const char * name ;  const char * fw_name ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct rtl_mac_info * cocci_id@p ;
...
position p;
@@
 const struct rtl_coalesce_scale * cocci_id@p ;
...
position p;
@@
 rtl_dp_ocp_read_cond cocci_id@p ;
...
typedef u16;
@@
 const struct rtl_mac_info {  u16 mask ;  u16 val ;  u16 mac_version ; } cocci_id@p [ ] ;
