...
position p;
@@
 struct mpc52xx_gpt_priv cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,raw_spinlock_t;
@@
 struct mpc52xx_gpt_priv {  struct list_head list ;  struct device * dev ;  struct mpc52xx_gpt __iomem * regs ;  raw_spinlock_t lock ;  struct irq_domain * irqhost ;  u32 ipb_freq ;  u8 wdt_mode ; #if defined(CONFIG_GPIOLIB)  struct gpio_chip gc ; #endif } cocci_id@p ;
