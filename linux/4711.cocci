...
position p;
@@
 const struct mei_device * cocci_id@p ;
...
position p;
@@
 const struct mei_cfg cocci_id@p ;
...
position p;
@@
 const struct mei_cfg * const cocci_id@p [ ] ;
...
position p;
@@
 const struct mei_me_hw * cocci_id@p ;
...
position p;
@@
 const struct mei_hw_ops cocci_id@p ;
...
position p;
@@
 struct mei_fw_status * cocci_id@p ;
...
position p;
@@
 const struct mei_fw_status * cocci_id@p ;
