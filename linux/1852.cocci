...
position p;
@@
 enum { AD7766_SUPPLY_AVDD = 0 , AD7766_SUPPLY_DVDD = 1 , AD7766_SUPPLY_VREF = 2 , AD7766_NUM_SUPPLIES = 3 , } cocci_id@p ;
...
position p;
@@
 struct ad7766_chip_info {  unsigned int decimation_factor ; } cocci_id@p ;
...
position p;
@@
 enum ad7766_device_ids { ID_AD7766 , ID_AD7766_1 , ID_AD7766_2 , } cocci_id@p ;
...
position p;
@@
 const struct ad7766_chip_info cocci_id@p [ ] ;
...
typedef s64;
@@
 struct ad7766 {  const struct ad7766_chip_info * chip_info ;  struct spi_device * spi ;  struct clk * mclk ;  struct gpio_desc * pd_gpio ;  struct regulator_bulk_data reg [ AD7766_NUM_SUPPLIES ] ;  struct iio_trigger * trig ;  struct spi_transfer xfer ;  struct spi_message msg ;  unsigned char data [ ALIGN ( 3 , sizeof ( s64 ) ) + sizeof ( s64 ) ] 
			 ____cacheline_aligned ; } cocci_id@p ;
