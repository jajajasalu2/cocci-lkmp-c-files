...
position p;
@@
 struct ramc_info {  void ( * idle ) ( void ) ;  unsigned int memctrl ; } cocci_id@p ;
...
position p;
@@
 const struct ramc_info * cocci_id@p ;
...
position p;
@@
 struct pmc_info {  unsigned long uhp_udp_mask ; } cocci_id@p ;
...
position p;
@@
 const struct wakeup_source_info cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct at91_pm_data * pm_data ) ;
...
typedef phys_addr_t;
@@
 struct at91_pm_bu {  int suspended ;  unsigned long reserved ;  phys_addr_t canary ;  phys_addr_t resume ; } * cocci_id@p ;
...
typedef bool;
@@
 struct wakeup_source_info {  unsigned int pmc_fsmr_bit ;  unsigned int shdwc_mr_bit ;  bool set_polarity ; } cocci_id@p ;
...
position p;
@@
 const struct pmc_info * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct at91_pm_data * ) ;
