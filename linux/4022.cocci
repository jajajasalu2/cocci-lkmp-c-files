...
position p;
@@
 const struct mvebu_icu_subset_data * cocci_id@p ;
...
typedef atomic_t;
@@
 struct mvebu_icu_msi_data {  struct mvebu_icu * icu ;  atomic_t initialized ;  const struct mvebu_icu_subset_data * subset_data ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_icu_irq_data {  struct mvebu_icu * icu ;  unsigned int icu_group ;  unsigned int type ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_icu_msi_data * cocci_id@p ;
...
position p;
@@
 struct mvebu_icu_irq_data * cocci_id@p ;
...
position p;
@@
 struct mvebu_icu_subset_data {  unsigned int icu_group ;  unsigned int offset_set_ah ;  unsigned int offset_set_al ;  unsigned int offset_clr_ah ;  unsigned int offset_clr_al ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_icu {  void __iomem * base ;  struct device * dev ; } cocci_id@p ;
