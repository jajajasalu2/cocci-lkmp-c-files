...
position p;
@@
 struct hinic_rx_mode_work cocci_id@p ;
...
position p;
@@
 struct hinic_port_link_status * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HINIC_RSS_KEY_SIZE ] ;
...
typedef u8;
@@
 int cocci_id@p ( struct net_device * netdev , const u8 * addr ) ;
