...
position p;
@@
 struct nv04_disp_root {  struct nvkm_object object ;  struct nvkm_disp * disp ; } cocci_id@p ;
...
position p;
@@
 struct nv04_disp_root cocci_id@p ;
...
position p;
@@
 union {  struct nv04_disp_mthd_v0 v0 ; } * cocci_id@p ;
