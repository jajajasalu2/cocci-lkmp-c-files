...
position p;
@@
 struct klsi_105_private * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct klsi_105_private {  struct klsi_105_port_settings cfg ;  unsigned long line_state ;  spinlock_t lock ; } cocci_id@p ;
...
typedef u8;
@@
 struct klsi_105_port_settings {  u8 pktlen ;  u8 baudrate ;  u8 databits ;  u8 unknown1 ;  u8 unknown2 ; } cocci_id@p ;
...
position p;
@@
 struct klsi_105_port_settings * cocci_id@p ;
