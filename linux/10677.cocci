...
typedef u8;
@@
 struct ch7xxx_id_struct {  u8 vid ;  char * name ; } cocci_id@p [ ] ;
...
typedef bool;
@@
 struct ch7xxx_priv {  bool quiet ; } cocci_id@p ;
...
typedef u8;
@@
 struct ch7xxx_did_struct {  u8 did ;  char * name ; } cocci_id@p [ ] ;
