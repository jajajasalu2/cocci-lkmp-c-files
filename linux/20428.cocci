...
position p;
@@
 struct mtrr_var_range * cocci_id@p ;
...
position p;
@@
 struct fixed_range_block cocci_id@p [ ] ;
...
position p;
@@
 struct fixed_range_block {  int base_msr ;  int ranges ; } cocci_id@p ;
...
position p;
@@
 struct mtrr_state_type cocci_id@p ;
