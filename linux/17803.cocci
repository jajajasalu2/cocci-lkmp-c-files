...
position p;
@@
 struct ia64_pal_retval cocci_id@p ;
...
position p;
@@
 struct {  unsigned long mask ;  const char * feature_name ; } cocci_id@p [ ] ;
...
position p;
@@
 struct cpuinfo_ia64 * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned long , unsigned long , int ) ;
...
symbol cocci_id;
position p;
typedef pal_status_t;
@@
 pal_status_t cocci_id@p ;
...
position p;
@@
 struct ia64_boot_param * cocci_id@p ;
...
position p;
@@
 struct io_space cocci_id@p [ MAX_IO_SPACES ] ;
...
typedef u64;
@@
 union {  unsigned long bits [ 5 ] ;  struct {  char vendor [ 16 ] ;  u64 ppn ;  unsigned number : 8 ;  unsigned revision : 8 ;  unsigned model : 8 ;  unsigned family : 8 ;  unsigned archrev : 8 ;  unsigned reserved : 24 ;  u64 features ; } field ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_BRANDS ] [ 128 ] ;
