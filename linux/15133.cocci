...
position p;
@@
 struct perm_bits cocci_id@p [ PCI_EXT_CAP_ID_MAX + 1 ] ;
...
position p;
@@
 struct perm_bits cocci_id@p [ PCI_CAP_ID_MAX + 1 ] ;
...
typedef u16;
@@
 const u16 cocci_id@p [ PCI_EXT_CAP_ID_MAX + 1 ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ PCI_CAP_ID_MAX + 1 ] ;
