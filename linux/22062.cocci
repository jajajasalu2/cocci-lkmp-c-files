...
position p;
@@
 void cocci_id@p ( deflate_state * s , uInt b ) ;
...
position p;
@@
 enum { need_more , block_done , finish_started , finish_done , } cocci_id@p ;
...
position p;
@@
 block_state cocci_id@p ( deflate_state * s , int flush ) ;
...
position p;
@@
 struct internal_state * cocci_id@p ;
...
position p;
@@
 uInt cocci_id@p ( deflate_state * s , IPos cur_match ) ;
...
position p;
@@
 void cocci_id@p ( z_streamp strm ) ;
...
position p;
@@
 void cocci_id@p ( deflate_state * s , IPos start , IPos match , int length ) ;
...
position p;
@@
 int cocci_id@p ( z_streamp strm , Byte * buf , unsigned size ) ;
...
position p;
@@
 struct config_s {  ush good_length ;  ush max_lazy ;  ush nice_length ;  ush max_chain ;  compress_func func ; } cocci_id@p ;
