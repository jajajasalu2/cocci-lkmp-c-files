...
position p;
@@
 struct timeriomem_rng_private cocci_id@p ;
...
typedef ktime_t;
@@
 struct timeriomem_rng_private {  void __iomem * io_base ;  ktime_t period ;  unsigned int present : 1 ;  struct hrtimer timer ;  struct completion completion ;  struct hwrng rng_ops ; } cocci_id@p ;
