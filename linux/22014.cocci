...
position p;
@@
 const ZSTD_blockCompressor cocci_id@p ;
...
position p;
@@
 struct ZSTD_CDict_s {  void * dictBuffer ;  const void * dictContent ;  size_t dictContentSize ;  ZSTD_CCtx * refContext ; } cocci_id@p ;
...
position p;
@@
 ZSTD_compressionParameters cocci_id@p ;
...
position p;
@@
 enum { ZSTDcs_created = 0 , ZSTDcs_init , ZSTDcs_ongoing , ZSTDcs_ending , } cocci_id@p ;
...
position p;
@@
 const ZSTD_blockCompressor cocci_id@p [ 2 ] [ 8 ] ;
...
position p;
@@
 enum { ZSTDcrp_continue , ZSTDcrp_noMemset , ZSTDcrp_fullReset , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef BIT_CStream_t;
@@
 BIT_CStream_t cocci_id@p ;
...
position p;
@@
 const ZSTD_compResetPolicy_e cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ZSTD_optimal_t;
@@
 ZSTD_optimal_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ZSTD_match_t;
@@
 ZSTD_match_t * cocci_id@p ;
...
position p;
@@
 const ZSTD_parameters cocci_id@p ;
...
position p;
@@
 const ZSTD_compressionParameters cocci_id@p [ 4 ] [ ZSTD_MAX_CLEVEL + 1 ] ;
...
position p;
@@
 ZSTD_blockCompressor cocci_id@p ;
...
symbol cocci_id;
position p;
typedef FSE_CState_t;
@@
 FSE_CState_t cocci_id@p ;
...
position p;
@@
 enum { zcss_init , zcss_load , zcss_flush , zcss_final , } cocci_id@p ;
...
position p;
@@
 enum { zsf_gather , zsf_flush , zsf_end , } cocci_id@p ;
...
position p;
@@
 const ZSTD_compressionParameters cocci_id@p ;
