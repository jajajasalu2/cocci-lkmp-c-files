...
position p;
@@
 const struct sdhci_msm_offset cocci_id@p ;
...
typedef bool;
@@
 struct sdhci_msm_variant_info {  bool mci_removed ;  bool restore_dll_config ;  const struct sdhci_msm_variant_ops * var_ops ;  const struct sdhci_msm_offset * offset ; } cocci_id@p ;
...
position p;
@@
 const struct sdhci_msm_variant_info cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_PHASES ] [ MAX_PHASES ] ;
...
position p;
@@
 struct sdhci_msm_host * cocci_id@p ;
...
position p;
@@
 const struct sdhci_msm_variant_ops cocci_id@p ;
