...
typedef u8;
@@
 struct _serverworks_private {  struct pci_dev * svrwrks_dev ;  volatile u8 __iomem * registers ;  struct serverworks_page_map * * gatt_pages ;  int num_tables ;  struct serverworks_page_map scratch_dir ;  int gart_addr_ofs ;  int mm_addr_ofs ; } cocci_id@p ;
...
position p;
@@
 struct serverworks_page_map * cocci_id@p ;
...
position p;
@@
 const struct gatt_mask cocci_id@p [ ] ;
...
position p;
@@
 struct aper_size_info_lvl2 * cocci_id@p ;
...
position p;
@@
 const struct aper_size_info_lvl2 cocci_id@p [ 7 ] ;
...
position p;
@@
 struct serverworks_page_map {  unsigned long * real ;  unsigned long __iomem * remapped ; } cocci_id@p ;
