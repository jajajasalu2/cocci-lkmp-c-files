...
position p;
@@
 struct env_var cocci_id@p [ MAX_ENTRY ] ;
...
position p;
@@
 const struct psp_var_map_entry cocci_id@p [ ] ;
...
position p;
@@
 struct psp_env_chunk * cocci_id@p ;
...
typedef u32;
@@
 struct psbl_rec {  u32 psbl_size ;  u32 env_base ;  u32 env_size ;  u32 ffs_base ;  u32 ffs_size ; } cocci_id@p ;
...
typedef u8;
@@
 struct psp_var_map_entry {  u8 num ;  char * value ; } cocci_id@p ;
...
position p;
@@
 struct env_var {  char * name ;  char * value ; } cocci_id@p ;
