...
position p;
@@
 enum ionic_cmd_opcode cocci_id@p ;
...
position p;
@@
 union ionic_dev_cmd_regs * cocci_id@p ;
...
position p;
@@
 enum ionic_status_code cocci_id@p ;
...
position p;
@@
 union ionic_adminq_cmd cocci_id@p ;
