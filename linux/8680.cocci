...
position p;
@@
 struct fm10k_iov_data * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ FM10K_RSSRK_SIZE ] ;
...
position p;
@@
 struct fm10k_vf_info * cocci_id@p ;
...
position p;
@@
 struct fm10k_mbx_info * cocci_id@p ;
...
position p;
@@
 union fm10k_rx_desc cocci_id@p ;
...
position p;
@@
 struct fm10k_macvlan_request cocci_id@p ;
...
position p;
@@
 struct fm10k_hw_stats_q * cocci_id@p ;
...
position p;
@@
 struct fm10k_q_vector * cocci_id@p ;
...
position p;
@@
 struct fm10k_tx_desc cocci_id@p ;
...
position p;
@@
 const struct fm10k_info * cocci_id@p [ ] ;
...
position p;
@@
 const struct fm10k_msg_data cocci_id@p [ ] ;
...
position p;
@@
 struct fm10k_dglort_cfg cocci_id@p ;
