...
position p;
@@
 struct adp5061_state {  struct i2c_client * client ;  struct regmap * regmap ;  struct power_supply * psy ; } cocci_id@p ;
...
position p;
@@
 struct adp5061_state * cocci_id@p ;
...
position p;
@@
 enum adp5061_chg_status { ADP5061_CHG_OFF , ADP5061_CHG_TRICKLE , ADP5061_CHG_FAST_CC , ADP5061_CHG_FAST_CV , ADP5061_CHG_COMPLETE , ADP5061_CHG_LDO_MODE , ADP5061_CHG_TIMER_EXP , ADP5061_CHG_BAT_DET , } cocci_id@p ;
