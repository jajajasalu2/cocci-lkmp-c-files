...
position p;
@@
 char cocci_id@p [ SCMI_MAX_STR_SIZE ] ;
...
typedef u8;
@@
 struct scmi_msg_resp_base_attributes {  u8 num_protocols ;  u8 num_agents ;  __le16 reserved ; } cocci_id@p ;
...
position p;
@@
 enum scmi_base_protocol_cmd { BASE_DISCOVER_VENDOR = 0x3 , BASE_DISCOVER_SUB_VENDOR = 0x4 , BASE_DISCOVER_IMPLEMENT_VERSION = 0x5 , BASE_DISCOVER_LIST_PROTOCOLS = 0x6 , BASE_DISCOVER_AGENT = 0x7 , BASE_NOTIFY_ERRORS = 0x8 , } cocci_id@p ;
...
position p;
@@
 struct scmi_revision_info * cocci_id@p ;
...
position p;
@@
 struct scmi_msg_resp_base_attributes * cocci_id@p ;
