...
symbol cocci_id;
position p;
typedef region_table_slot_t;
@@
 struct switch_ctx {  struct dm_target * ti ;  unsigned nr_paths ;  unsigned region_size ;  unsigned long nr_regions ;  signed char region_size_bits ;  unsigned char region_table_entry_bits ;  unsigned char region_entries_per_slot ;  signed char region_entries_per_slot_bits ;  region_table_slot_t * region_table ;  struct switch_path path_list [ 0 ] ; } cocci_id@p ;
...
typedef region_table_slot_t;
@@
 region_table_slot_t cocci_id@p ;
...
typedef sector_t;
@@
 struct switch_path {  struct dm_dev * dmdev ;  sector_t start ; } cocci_id@p ;
