...
position p;
@@
 struct cs5535_gpio_chip * cocci_id@p ;
...
@@
 struct cs5535_gpio_chip {  struct gpio_chip chip ;  resource_size_t base ;  struct platform_device * pdev ;  spinlock_t lock ; } cocci_id@p ;
