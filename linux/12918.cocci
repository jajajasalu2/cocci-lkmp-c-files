...
position p;
@@
 struct reginit_item cocci_id@p [ ] ;
...
position p;
@@
 struct fs_transmit_config * cocci_id@p ;
...
position p;
@@
 struct FS_QENTRY cocci_id@p [ 60 ] ;
...
position p;
@@
 struct FS_BPENTRY cocci_id@p [ 60 ] ;
