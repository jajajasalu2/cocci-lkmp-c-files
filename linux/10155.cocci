...
position p;
@@
 struct sdw_link_data * cocci_id@p ;
...
position p;
@@
 struct sdw_intel_ctx * cocci_id@p ;
...
position p;
@@
 struct sdw_link_data {  struct sdw_intel_link_res res ;  struct platform_device * pdev ; } cocci_id@p ;
...
position p;
@@
 struct sdw_intel_ctx {  int count ;  struct sdw_link_data * links ; } cocci_id@p ;
...
position p;
@@
 struct sdw_intel_res * cocci_id@p ;
