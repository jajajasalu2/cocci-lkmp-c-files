...
position p;
@@
 struct ieee_types_bss_co_2040 * cocci_id@p ;
...
position p;
@@
 struct tdls_peer_info * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ra_list_tbl cocci_id@p ;
...
position p;
@@
 struct mwifiex_auto_tdls_peer * cocci_id@p ;
...
position p;
@@
 struct ieee_types_vht_oper cocci_id@p ;
...
position p;
@@
 struct ieee_types_aid cocci_id@p ;
...
position p;
@@
 struct ieee_types_vht_cap cocci_id@p ;
...
position p;
@@
 struct ieee_types_extcap * cocci_id@p ;
