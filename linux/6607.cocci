...
position p;
@@
 struct bfa_faa_attr_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfi_faa_query_rsp_t;
@@
 bfi_faa_query_rsp_t * cocci_id@p ;
...
position p;
@@
 struct bfi_iocfc_set_intr_req_s * cocci_id@p ;
...
position p;
@@
 struct bfa_iocfc_regs_s * cocci_id@p ;
...
position p;
@@
 struct bfa_iocfc_attr_s * cocci_id@p ;
...
position p;
@@
 struct bfi_iocfc_cfg_req_s cocci_id@p ;
...
position p;
@@
 struct bfi_iocfc_qreg_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_isr_func_t;
@@
 bfa_isr_func_t cocci_id@p [ BFI_MC_MAX ] ;
...
position p;
@@
 struct bfa_reqq_wait_s * cocci_id@p ;
...
position p;
@@
 struct bfi_iocfc_cfg_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_cb_iocfc_t;
@@
 bfa_cb_iocfc_t cocci_id@p ;
...
position p;
@@
 struct bfi_pbc_vport_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( void * bfa_arg , enum bfa_status status ) ;
...
position p;
@@
 struct bfa_iocfc_intr_attr_s * cocci_id@p ;
...
position p;
@@
 enum { BFA_IOCFC_ACT_NONE = 0 , BFA_IOCFC_ACT_INIT = 1 , BFA_IOCFC_ACT_STOP = 2 , BFA_IOCFC_ACT_DISABLE = 3 , BFA_IOCFC_ACT_ENABLE = 4 , } cocci_id@p ;
...
position p;
@@
 struct bfa_iocfc_fwcfg_s * cocci_id@p ;
...
position p;
@@
 union bfi_iocfc_i2h_msg_u * cocci_id@p ;
...
position p;
@@
 struct bfi_faa_addr_msg_s * cocci_id@p ;
...
@@
 bfa_ioc_mbox_mcfunc_t cocci_id@p [ BFI_MC_MAX ] ;
...
position p;
@@
 struct bfi_faa_query_s cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_cb_cbfn_status_t;
@@
 bfa_cb_cbfn_status_t cocci_id@p ;
