...
position p;
@@
 struct bcm2835_chan * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct bcm2835_dmadev {  struct dma_device ddev ;  void __iomem * base ;  struct device_dma_parameters dma_parms ;  dma_addr_t zero_page ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct bcm2835_dma_cb {  uint32_t info ;  uint32_t src ;  uint32_t dst ;  uint32_t length ;  uint32_t stride ;  uint32_t next ;  uint32_t pad [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct bcm2835_desc cocci_id@p ;
...
position p;
@@
 struct bcm2835_cb_entry * cocci_id@p ;
...
typedef bool;
@@
 struct bcm2835_chan {  struct virt_dma_chan vc ;  struct dma_slave_config cfg ;  unsigned int dreq ;  int ch ;  struct bcm2835_desc * desc ;  struct dma_pool * cb_pool ;  void __iomem * chan_base ;  int irq_number ;  unsigned int irq_flags ;  bool is_lite_channel ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ BCM2835_DMA_MAX_DMA_CHAN_SUPPORTED + 1 ] ;
...
position p;
@@
 struct bcm2835_dma_cb * cocci_id@p ;
...
position p;
@@
 struct bcm2835_dmadev * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct bcm2835_cb_entry {  struct bcm2835_dma_cb * cb ;  dma_addr_t paddr ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ BCM2835_DMA_CHAN_NAME_SIZE ] ;
...
typedef bool;
@@
 struct bcm2835_desc {  struct bcm2835_chan * c ;  struct virt_dma_desc vd ;  enum dma_transfer_direction dir ;  unsigned int frames ;  size_t size ;  bool cyclic ;  struct bcm2835_cb_entry cb_list [ ] ; } cocci_id@p ;
