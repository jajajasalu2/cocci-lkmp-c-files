...
typedef u8,bool;
@@
 struct i2c_piix4_adapdata {  unsigned short smba ;  bool sb800_main ;  bool notify_imc ;  u8 port ; } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ PIIX4_MAX_ADAPTERS ] ;
...
position p;
@@
 struct i2c_piix4_adapdata * cocci_id@p ;
...
position p;
@@
 struct i2c_adapter * cocci_id@p [ PIIX4_MAX_ADAPTERS ] ;
