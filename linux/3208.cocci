...
typedef u16;
@@
 struct ad7314_data {  struct spi_device * spi_dev ;  u16 rx ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum ad7314_variant { adt7301 , adt7302 , ad7314 , } cocci_id@p ;
