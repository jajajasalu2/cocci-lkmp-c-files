...
position p;
@@
 struct rio_pw_filter cocci_id@p ;
...
position p;
@@
 struct rio_mport_mapping * * cocci_id@p ;
...
position p;
@@
 struct rio_doorbell_filter cocci_id@p ;
...
position p;
@@
 struct mport_cdev_priv * cocci_id@p ;
...
position p;
@@
 enum rio_transfer_sync cocci_id@p ;
...
position p;
@@
 enum dma_ctrl_flags cocci_id@p ;
...
position p;
@@
 struct rio_mport_maint_io cocci_id@p ;
...
position p;
@@
 struct rio_transaction cocci_id@p ;
...
position p;
@@
 struct mport_dma_req cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u16,dma_addr_t;
@@
 struct rio_mport_mapping {  struct list_head node ;  struct mport_dev * md ;  enum rio_mport_map_dir dir ;  u16 rioid ;  u64 rio_addr ;  dma_addr_t phys_addr ;  void * virt_addr ;  u64 size ;  struct kref ref ;  struct file * filp ; } cocci_id@p ;
...
position p;
@@
 struct rio_mport_attr cocci_id@p ;
...
position p;
@@
 struct rio_transfer_io * cocci_id@p ;
...
position p;
@@
 enum rio_mport_map_dir { MAP_INBOUND , MAP_OUTBOUND , MAP_DMA , } cocci_id@p ;
...
position p;
@@
 struct rio_mport_db_filter {  struct list_head data_node ;  struct list_head priv_node ;  struct mport_cdev_priv * priv ;  struct rio_doorbell_filter filter ; } cocci_id@p ;
...
position p;
@@
 struct rio_mport_pw_filter {  struct list_head md_node ;  struct list_head priv_node ;  struct mport_cdev_priv * priv ;  struct rio_pw_filter filter ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,dma_addr_t;
@@
 struct mport_dma_buf {  void * ib_base ;  dma_addr_t ib_phys ;  u32 ib_size ;  u64 ib_rio_base ;  bool ib_map ;  struct file * filp ; } cocci_id@p ;
...
position p;
@@
 enum { DBG_NONE = 0 , DBG_INIT = BIT ( 0 ) , DBG_EXIT = BIT ( 1 ) , DBG_MPORT = BIT ( 2 ) , DBG_RDEV = BIT ( 3 ) , DBG_DMA = BIT ( 4 ) , DBG_MMAP = BIT ( 5 ) , DBG_IBW = BIT ( 6 ) , DBG_EVENT = BIT ( 7 ) , DBG_OBW = BIT ( 8 ) , DBG_DBELL = BIT ( 9 ) , DBG_ALL = ~ 0 , } cocci_id@p ;
...
position p;
@@
 struct rio_mport_pw_filter * cocci_id@p ;
...
position p;
@@
 struct rio_mport_db_filter * cocci_id@p ;
...
position p;
@@
 struct rio_async_tx_wait cocci_id@p ;
...
@@
 struct rio_mport_dma_map {  int valid ;  u64 length ;  void * vaddr ;  dma_addr_t paddr ; } cocci_id@p ;
...
position p;
@@
 struct rio_rdev_info cocci_id@p ;
...
position p;
@@
 struct rio_dma_data cocci_id@p ;
