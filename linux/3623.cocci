...
symbol cocci_id;
position p;
typedef efi_file_handle_t;
@@
 efi_file_handle_t * cocci_id@p ;
...
position p;
@@
 struct efi_memory_map cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,efi_file_handle_t;
@@
 struct file_info {  efi_file_handle_t * handle ;  u64 size ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_file_io_interface_t;
@@
 efi_file_io_interface_t * cocci_id@p ;
...
position p;
@@
 efi_exit_boot_map_processing cocci_id@p ;
...
symbol cocci_id;
position p;
typedef efi_physical_addr_t;
@@
 efi_physical_addr_t cocci_id@p ;
