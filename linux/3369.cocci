...
typedef u8;
@@
 struct meson_pwm_channel {  unsigned int hi ;  unsigned int lo ;  u8 pre_div ;  struct clk * clk_parent ;  struct clk_mux mux ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 struct meson_pwm_channel * cocci_id@p ;
...
position p;
@@
 const struct meson_pwm_data cocci_id@p ;
...
typedef spinlock_t;
@@
 struct meson_pwm {  struct pwm_chip chip ;  const struct meson_pwm_data * data ;  struct meson_pwm_channel channels [ MESON_NUM_PWMS ] ;  void __iomem * base ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct meson_pwm_data {  const char * const * parent_names ;  unsigned int num_parents ; } cocci_id@p ;
...
position p;
@@
 struct meson_pwm_channel_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct meson_pwm_channel_data {  u8 reg_offset ;  u8 clk_sel_shift ;  u8 clk_div_shift ;  u32 clk_en_mask ;  u32 pwm_en_mask ; } cocci_id@p [ MESON_NUM_PWMS ] ;
