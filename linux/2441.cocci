...
position p;
@@
 struct jz4780_dma_soc_data {  unsigned int nb_channels ;  unsigned int transfer_ord_max ;  unsigned long flags ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct jz4780_dma_hwdesc {  uint32_t dcm ;  uint32_t dsa ;  uint32_t dta ;  uint32_t dtc ; } cocci_id@p ;
...
position p;
@@
 struct jz4780_dma_desc * cocci_id@p ;
...
position p;
@@
 struct jz4780_dma_hwdesc cocci_id@p ;
...
position p;
@@
 struct jz4780_dma_chan * cocci_id@p ;
...
position p;
@@
 const struct jz4780_dma_soc_data * cocci_id@p ;
...
position p;
@@
 struct jz4780_dma_filter_data cocci_id@p ;
...
typedef uint32_t;
@@
 struct jz4780_dma_chan {  struct virt_dma_chan vchan ;  unsigned int id ;  struct dma_pool * desc_pool ;  uint32_t transfer_type ;  uint32_t transfer_shift ;  struct dma_slave_config config ;  struct jz4780_dma_desc * desc ;  unsigned int curr_hwdesc ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct jz4780_dma_filter_data {  uint32_t transfer_type ;  int channel ; } cocci_id@p ;
...
position p;
@@
 struct jz4780_dma_dev cocci_id@p ;
...
@@
 struct jz4780_dma_desc {  struct virt_dma_desc vdesc ;  struct jz4780_dma_hwdesc * desc ;  dma_addr_t desc_phys ;  unsigned int count ;  enum dma_transaction_type type ;  uint32_t status ; } cocci_id@p ;
...
typedef uint32_t;
@@
 struct jz4780_dma_dev {  struct dma_device dma_device ;  void __iomem * chn_base ;  void __iomem * ctrl_base ;  struct clk * clk ;  unsigned int irq ;  const struct jz4780_dma_soc_data * soc_data ;  uint32_t chan_reserved ;  struct jz4780_dma_chan chan [ ] ; } cocci_id@p ;
