...
@@
 struct aead_edesc {  int src_nents ;  int dst_nents ;  int mapped_src_nents ;  int mapped_dst_nents ;  int sec4_sg_bytes ;  dma_addr_t sec4_sg_dma ;  struct sec4_sg_entry * sec4_sg ;  u32 hw_desc [ ] ; } cocci_id@p ;
...
typedef u32,dma_addr_t;
@@
 struct skcipher_edesc {  int src_nents ;  int dst_nents ;  int mapped_src_nents ;  int mapped_dst_nents ;  dma_addr_t iv_dma ;  int sec4_sg_bytes ;  dma_addr_t sec4_sg_dma ;  struct sec4_sg_entry * sec4_sg ;  u32 hw_desc [ 0 ] ; } cocci_id@p ;
