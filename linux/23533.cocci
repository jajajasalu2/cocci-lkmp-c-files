...
position p;
@@
 struct sof_hdmi_pcm cocci_id@p ;
...
position p;
@@
 struct sof_hdmi_pcm {  struct list_head head ;  struct snd_soc_dai * codec_dai ;  int device ; } cocci_id@p ;
...
typedef bool;
@@
 struct sof_card_private {  struct clk * mclk ;  struct snd_soc_jack sof_headset ;  struct list_head hdmi_pcm_list ;  bool common_hdmi_codec_drv ; } cocci_id@p ;
...
position p;
@@
 struct sof_card_private * cocci_id@p ;
