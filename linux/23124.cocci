...
position p;
@@
 struct acp3x_dev_data * cocci_id@p ;
...
typedef bool;
@@
 struct acp3x_dev_data {  void __iomem * acp3x_base ;  bool acp3x_audio_mode ;  struct resource * res ;  struct platform_device * pdev ; } cocci_id@p ;
