...
position p;
@@
 struct iommu_dma_cookie * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct iommu_dma_cookie {  enum iommu_dma_cookie_type type ;  union {  struct iova_domain iovad ;  dma_addr_t msi_iova ; } ;  struct list_head msi_page_list ;  struct iommu_domain * fq_domain ; } cocci_id@p ;
...
@@
 struct iommu_dma_msi_page {  struct list_head list ;  dma_addr_t iova ;  phys_addr_t phys ; } cocci_id@p ;
...
position p;
@@
 enum iommu_dma_cookie_type cocci_id@p ;
...
position p;
@@
 enum iommu_dma_cookie_type { IOMMU_DMA_IOVA_COOKIE , IOMMU_DMA_MSI_COOKIE , } cocci_id@p ;
...
position p;
@@
 const struct iommu_domain * cocci_id@p ;
...
position p;
@@
 struct iommu_dma_msi_page * cocci_id@p ;
...
position p;
@@
 const struct iommu_dma_msi_page * cocci_id@p ;
