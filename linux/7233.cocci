...
position p;
@@
 struct rtl_rom_version_evt * cocci_id@p ;
...
position p;
@@
 struct rtl_vendor_config_entry * cocci_id@p ;
...
position p;
@@
 struct rtl_download_cmd cocci_id@p ;
...
position p;
@@
 const struct id_table * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u16,bool,__u8;
@@
 struct id_table {  __u16 match_flags ;  __u16 lmp_subver ;  __u16 hci_rev ;  __u8 hci_ver ;  __u8 hci_bus ;  bool config_needed ;  bool has_rom_version ;  char * fw_name ;  char * cfg_name ; } cocci_id@p ;
...
position p;
@@
 struct rtl_download_response cocci_id@p ;
...
position p;
@@
 struct rtl_epatch_header * cocci_id@p ;
...
typedef __u16,__u8;
@@
 const struct {  __u16 lmp_subver ;  __u8 id ; } cocci_id@p [ ] ;
...
typedef u8;
@@
 struct btrtl_device_info {  const struct id_table * ic_info ;  u8 rom_version ;  u8 * fw_data ;  int fw_len ;  u8 * cfg_data ;  int cfg_len ; } cocci_id@p ;
...
position p;
@@
 struct rtl_vendor_config * cocci_id@p ;
