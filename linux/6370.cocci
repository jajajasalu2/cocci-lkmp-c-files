...
position p;
@@
 struct pv88080_buck_voltage {  int min_uV ;  int max_uV ;  int uV_step ; } cocci_id@p ;
...
position p;
@@
 struct pv88080_regulator {  struct regulator_desc desc ;  unsigned int mode_reg ;  unsigned int conf2 ;  unsigned int conf5 ; } cocci_id@p ;
...
position p;
@@
 const struct pv88080_compatible_regmap * cocci_id@p ;
...
position p;
@@
 enum { PV88080_ID_BUCK1 , PV88080_ID_BUCK2 , PV88080_ID_BUCK3 , PV88080_ID_HVBUCK , } cocci_id@p ;
...
position p;
@@
 const struct pv88080_buck_voltage cocci_id@p [ 2 ] ;
...
position p;
@@
 struct pv88080_regulator cocci_id@p [ ] ;
...
position p;
@@
 enum pv88080_types { TYPE_PV88080_AA , TYPE_PV88080_BA , } cocci_id@p ;
...
position p;
@@
 struct pv88080_buck_regmap {  int buck_enable_reg ;  int buck_vsel_reg ;  int buck_mode_reg ;  int buck_limit_reg ;  int buck_vdac_range_reg ;  int buck_vrange_gain_reg ;  int buck_enable_mask ;  int buck_vsel_mask ;  int buck_limit_mask ; } cocci_id@p ;
...
position p;
@@
 struct pv88080 {  struct device * dev ;  struct regmap * regmap ;  struct regulator_dev * rdev [ PV88080_MAX_REGULATORS ] ;  unsigned long type ;  const struct pv88080_compatible_regmap * regmap_config ; } cocci_id@p ;
...
position p;
@@
 struct pv88080_compatible_regmap {  struct pv88080_buck_regmap buck_regmap [ PV88080_MAX_REGULATORS - 1 ] ;  int hvbuck_enable_reg ;  int hvbuck_vsel_reg ;  int hvbuck_enable_mask ;  int hvbuck_vsel_mask ; } cocci_id@p ;
