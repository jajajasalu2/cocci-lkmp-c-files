...
position p;
@@
 struct rtw_pci_tx_data * cocci_id@p ;
...
position p;
@@
 struct rtw_pci_rx_buffer_desc * cocci_id@p ;
...
position p;
@@
 struct rtw_pci_tx_ring * cocci_id@p ;
...
position p;
@@
 struct rtw_pci_rx_ring * cocci_id@p ;
...
position p;
@@
 struct rtw_pci_tx_buffer_desc * cocci_id@p ;
