...
position p;
@@
 char cocci_id@p [ ERRLOG_TEXT_SIZE + 40 ] ;
...
position p;
@@
 struct log_data {  struct log_data * next ;  unsigned long usage_cnt ;  void * proc_ctrl ;  char log_start [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( hysdn_card * card , char * cp ) ;
