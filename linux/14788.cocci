...
position p;
@@
 struct div4_clk {  const char * name ;  unsigned int reg ;  unsigned int shift ;  int flags ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct r8a7740_cpg {  struct clk_onecell_data data ;  spinlock_t lock ;  void __iomem * reg ; } cocci_id@p ;
