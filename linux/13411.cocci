...
position p;
@@
 struct tda18212_dev * cocci_id@p ;
...
typedef u32;
@@
 struct tda18212_dev {  struct tda18212_config cfg ;  struct i2c_client * client ;  struct regmap * regmap ;  u32 if_frequency ; } cocci_id@p ;
