...
position p;
@@
 struct xiocb_cpuctl cocci_id@p ;
...
position p;
@@
 struct xiocb_inpstat cocci_id@p ;
...
position p;
@@
 struct xiocb_envbuf cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cfe_xiocb * xiocb ) ;
...
position p;
@@
 struct xiocb_meminfo cocci_id@p ;
...
position p;
@@
 struct xiocb_exitstat cocci_id@p ;
...
position p;
@@
 struct xiocb_buffer cocci_id@p ;
...
position p;
@@
 struct xiocb_fwinfo cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cfe_fwinfo_t;
@@
 cfe_fwinfo_t * cocci_id@p ;
