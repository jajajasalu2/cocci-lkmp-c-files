...
position p;
@@
 enum max77693_led_mode { FLASH , TORCH , } cocci_id@p ;
...
position p;
@@
 struct max77693_sub_led * cocci_id@p ;
...
position p;
@@
 struct max77693_dev * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct max77693_led_device {  struct regmap * regmap ;  struct platform_device * pdev ;  struct mutex lock ;  struct max77693_sub_led sub_leds [ 2 ] ;  u32 iout_torch_max [ 2 ] ;  u32 iout_flash_max [ 2 ] ;  unsigned int current_flash_timeout ;  u8 torch_iout_reg ;  unsigned int mode_flags ;  int strobing_sub_led_id ;  u8 fled_mask ;  u8 allowed_modes ;  bool iout_joint ; } cocci_id@p ;
...
typedef u32;
@@
 struct max77693_sub_led {  int fled_id ;  struct led_classdev_flash fled_cdev ;  struct v4l2_flash * v4l2_flash ;  unsigned int torch_brightness ;  unsigned int flash_timeout ;  u32 flash_faults ; } cocci_id@p ;
...
typedef u32;
@@
 struct max77693_led_config_data {  const char * label [ 2 ] ;  u32 iout_torch_max [ 2 ] ;  u32 iout_flash_max [ 2 ] ;  u32 flash_timeout_max [ 2 ] ;  u32 num_leds ;  u32 boost_mode ;  u32 boost_vout ;  u32 low_vsys ; } cocci_id@p ;
...
position p;
@@
 struct max77693_led_config_data * cocci_id@p ;
...
position p;
@@
 struct device_node * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct max77693_led_device * cocci_id@p ;
...
position p;
@@
 enum max77693_led_mode cocci_id@p ;
...
position p;
@@
 enum max77693_fled { FLED1 , FLED2 , } cocci_id@p ;
