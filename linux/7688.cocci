...
position p;
@@
 struct sci_port_params {  const struct plat_sci_reg regs [ SCIx_NR_REGS ] ;  unsigned int fifosize ;  unsigned int overrun_reg ;  unsigned int overrun_mask ;  unsigned int sampling_rate_mask ;  unsigned int error_mask ;  unsigned int error_clear ; } cocci_id@p ;
...
position p;
@@
 const struct plat_sci_reg * cocci_id@p ;
...
position p;
@@
 const struct sci_irq_desc * cocci_id@p ;
...
position p;
@@
 struct sci_port cocci_id@p [ SCI_NPORTS ] ;
...
position p;
@@
 enum { SCIx_ERI_IRQ , SCIx_RXI_IRQ , SCIx_TXI_IRQ , SCIx_BRI_IRQ , SCIx_DRI_IRQ , SCIx_TEI_IRQ , SCIx_NR_IRQS , SCIx_MUX_IRQ = SCIx_NR_IRQS , } cocci_id@p ;
...
@@
 const struct sci_irq_desc {  const char * desc ;  irq_handler_t handler ; } cocci_id@p [ ] ;
...
position p;
@@
 enum SCI_CLKS { SCI_FCK , SCI_SCK , SCI_BRG_INT , SCI_SCIF_CLK , SCI_NUM_CLKS , } cocci_id@p ;
...
position p;
@@
 const struct plat_sci_port * cocci_id@p ;
...
position p;
@@
 const struct sci_port_params * cocci_id@p ;
...
position p;
@@
 const struct sci_port_params cocci_id@p [ SCIx_NR_REGTYPES ] ;
