...
position p;
@@
 const struct sequencer_file_header * cocci_id@p ;
...
position p;
@@
 struct sequencer_file_header cocci_id@p ;
...
position p;
@@
 struct asd_ddb_seq_shared cocci_id@p ;
