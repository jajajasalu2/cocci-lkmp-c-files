...
position p;
@@
 struct s5h1432_state * cocci_id@p ;
...
typedef u8,u32;
@@
 struct s5h1432_state {  struct i2c_adapter * i2c ;  const struct s5h1432_config * config ;  struct dvb_frontend frontend ;  enum fe_modulation current_modulation ;  unsigned int first_tune : 1 ;  u32 current_frequency ;  int if_freq ;  u8 inversion ; } cocci_id@p ;
...
position p;
@@
 const struct s5h1432_config * cocci_id@p ;
