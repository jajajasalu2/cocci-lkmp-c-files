...
position p;
@@
 struct da903x_regulator_info * cocci_id@p ;
...
position p;
@@
 struct da903x_regulator_info {  struct regulator_desc desc ;  int max_uV ;  int vol_reg ;  int vol_shift ;  int vol_nbits ;  int update_reg ;  int update_bit ;  int enable_reg ;  int enable_bit ; } cocci_id@p ;
