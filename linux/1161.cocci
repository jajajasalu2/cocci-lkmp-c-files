...
typedef spinlock_t;
@@
 struct usbhsg_uep {  struct usb_ep ep ;  struct usbhs_pipe * pipe ;  spinlock_t lock ;  char ep_name [ EP_NAME_SIZE ] ;  struct usbhsg_gpriv * gpriv ; } cocci_id@p ;
...
position p;
@@
 struct usbhsg_request {  struct usb_request req ;  struct usbhs_pkt pkt ; } cocci_id@p ;
...
position p;
@@
 struct usbhsg_gpriv cocci_id@p ;
...
position p;
@@
 struct usbhsg_request cocci_id@p ;
...
position p;
@@
 struct usbhs_mod_info * cocci_id@p ;
...
position p;
@@
 struct usbhsg_recip_handle * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct usbhs_priv * priv , struct usbhsg_uep * uep , struct usb_ctrlrequest * ctrl ) ;
