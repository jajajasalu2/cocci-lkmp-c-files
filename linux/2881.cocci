...
symbol cocci_id;
position p;
typedef u8,acpi_status,acpi_handle,u16;
@@
 acpi_status cocci_id@p ( struct acpi_pci_id * pci_id , acpi_handle pci_device , u16 * bus_number , u8 * is_bridge ) ;
...
typedef acpi_handle;
@@
 struct acpi_pci_device {  acpi_handle device ;  struct acpi_pci_device * next ; } cocci_id@p ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_pci_id * pci_id , struct acpi_pci_device * list_head ) ;
...
position p;
@@
 struct acpi_pci_device cocci_id@p ;
...
@@
 acpi_status cocci_id@p ( acpi_handle root_pci_device , acpi_handle pci_region , struct acpi_pci_device * * return_list_head ) ;
...
position p;
@@
 void cocci_id@p ( struct acpi_pci_device * list_head ) ;
