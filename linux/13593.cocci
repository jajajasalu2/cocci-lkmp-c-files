...
position p;
@@
 struct lme2510_state cocci_id@p ;
...
position p;
@@
 struct usb_data_stream_properties * cocci_id@p ;
...
position p;
@@
 struct usb_data_stream * cocci_id@p ;
...
position p;
@@
 struct stv0299_config cocci_id@p ;
...
position p;
@@
 struct tda10086_config cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct lme2510_state {  unsigned long int_urb_due ;  enum fe_status lock_status ;  u8 id ;  u8 tuner_config ;  u8 signal_level ;  u8 signal_sn ;  u8 time_key ;  u8 i2c_talk_onoff ;  u8 i2c_gate ;  u8 i2c_tuner_gate_w ;  u8 i2c_tuner_gate_r ;  u8 i2c_tuner_addr ;  u8 stream_on ;  u8 pid_size ;  u8 pid_off ;  u8 int_buffer [ 128 ] ;  struct urb * lme_urb ;  u8 usb_buffer [ 64 ] ;  int ( * fe_read_status ) ( struct dvb_frontend * , enum fe_status * ) ;  int ( * fe_read_signal_strength ) ( struct dvb_frontend * , u16 * ) ;  int ( * fe_read_snr ) ( struct dvb_frontend * , u16 * ) ;  int ( * fe_read_ber ) ( struct dvb_frontend * , u32 * ) ;  int ( * fe_read_ucblocks ) ( struct dvb_frontend * , u32 * ) ;  int ( * fe_set_voltage ) ( struct dvb_frontend * , enum fe_sec_voltage ) ;  u8 dvb_usb_lme2510_firmware ; } cocci_id@p ;
...
position p;
@@
 struct i2c_algorithm cocci_id@p ;
...
position p;
@@
 struct ix2505v_config cocci_id@p ;
...
position p;
@@
 struct m88rs2000_config cocci_id@p ;
