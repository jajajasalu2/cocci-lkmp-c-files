...
position p;
@@
 struct ishtp_cl_data {  struct ishtp_cl * cros_ish_cl ;  struct ishtp_cl_device * cl_device ;  struct response_info response ;  struct work_struct work_ishtp_reset ;  struct work_struct work_ec_evt ;  struct cros_ec_device * ec_dev ; } cocci_id@p ;
...
position p;
@@
 struct cros_ish_out_msg cocci_id@p ;
...
position p;
@@
 struct cros_ish_in_msg * cocci_id@p ;
...
position p;
@@
 enum cros_ec_ish_channel { CROS_EC_COMMAND = 1 , CROS_MKBP_EVENT = 2 , } cocci_id@p ;
...
position p;
@@
 const struct cros_ish_in_msg * cocci_id@p ;
