...
position p;
@@
 enum bq27xxx_dm_reg_id { BQ27XXX_DM_DESIGN_CAPACITY = 0 , BQ27XXX_DM_DESIGN_ENERGY , BQ27XXX_DM_TERMINATE_VOLTAGE , } cocci_id@p ;
...
position p;
@@
 struct bq27xxx_dm_reg cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct {  u32 opts ;  u32 unseal_key ;  u8 * regs ;  struct bq27xxx_dm_reg * dm_regs ;  enum power_supply_property * props ;  size_t props_size ; } cocci_id@p [ ] ;
...
position p;
@@
 struct bq27xxx_device_info * cocci_id@p ;
...
position p;
@@
 struct bq27xxx_dm_buf * cocci_id@p ;
...
position p;
@@
 struct bq27xxx_reg_cache cocci_id@p ;
...
position p;
@@
 enum bq27xxx_dm_reg_id cocci_id@p ;
