...
typedef u8,bool;
@@
 struct tc654_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  u8 rpm_output [ 2 ] ;  u8 fan_fault [ 2 ] ;  u8 config ;  u8 status ;  u8 duty_cycle ; } cocci_id@p ;
...
position p;
@@
 enum tc654_regs { TC654_REG_RPM1 = 0x00 , TC654_REG_RPM2 = 0x01 , TC654_REG_FAN_FAULT1 = 0x02 , TC654_REG_FAN_FAULT2 = 0x03 , TC654_REG_CONFIG = 0x04 , TC654_REG_STATUS = 0x05 , TC654_REG_DUTY_CYCLE = 0x06 , TC654_REG_MFR_ID = 0x07 , TC654_REG_VER_ID = 0x08 , } cocci_id@p ;
