...
position p;
@@
 struct ip_set_req_get_set * cocci_id@p ;
...
position p;
@@
 const struct ip_set_skbinfo * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IPSET_ATTR_CMD_MAX + 1 ] ;
...
position p;
@@
 char cocci_id@p [ IPSET_MAXNAMELEN ] ;
...
position p;
@@
 struct ip_set_skbinfo cocci_id@p ;
...
position p;
@@
 struct ip_set_comment cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IPSET_ATTR_IPADDR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IPSET_ATTR_IPADDR_MAX + 1 ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IPSET_ATTR_ADT_MAX + 1 ] ;
...
position p;
@@
 struct ip_set_req_version * cocci_id@p ;
...
position p;
@@
 const struct ip_set_counter * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ip_set * , void * ) ;
...
position p;
@@
 struct ip_set_counter cocci_id@p ;
...
position p;
@@
 const struct ip_set * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,ip_set_id_t;
@@
 struct ip_set_net {  struct ip_set * __rcu * ip_set_list ;  ip_set_id_t ip_set_max ;  bool is_deleted ;  bool is_destroyed ; } cocci_id@p ;
...
position p;
@@
 const struct ip_set_comment * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IPSET_ATTR_CREATE_MAX + 1 ] ;
...
position p;
@@
 struct ip_set_req_get_set_family cocci_id@p ;
...
position p;
@@
 const struct ip_set_ext * cocci_id@p ;
...
position p;
@@
 struct ip_set_adt_opt * cocci_id@p ;
...
position p;
@@
 struct nfnetlink_subsystem cocci_id@p ;
...
position p;
@@
 const struct nfnl_callback cocci_id@p [ IPSET_MSG_MAX ] ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IPSET_ATTR_CMD_MAX + 1 ] ;
...
position p;
@@
 const struct ip_set_ext_type cocci_id@p [ ] ;
...
position p;
@@
 struct ip_set_comment_rcu * cocci_id@p ;
