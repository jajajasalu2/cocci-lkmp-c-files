...
position p;
@@
 struct delta_sigma_data * cocci_id@p ;
...
position p;
@@
 struct calc_pll_clock_source * cocci_id@p ;
...
position p;
@@
 struct pll_settings * cocci_id@p ;
...
position p;
@@
 const struct pixel_rate_range_table_entry cocci_id@p [ ] ;
...
position p;
@@
 struct spread_spectrum_data * cocci_id@p [ ] ;
...
position p;
@@
 const struct clock_source_funcs cocci_id@p ;
...
position p;
@@
 struct pixel_rate_range_table_entry {  unsigned int range_min_khz ;  unsigned int range_max_khz ;  unsigned int target_pixel_rate_khz ;  unsigned short mult_factor ;  unsigned short div_factor ; } cocci_id@p ;
...
position p;
@@
 const struct spread_spectrum_data * cocci_id@p ;
...
position p;
@@
 struct calc_pll_clock_source_init_data * cocci_id@p ;
...
position p;
@@
 const struct clock_source * cocci_id@p ;
...
position p;
@@
 const struct pll_settings * cocci_id@p ;
