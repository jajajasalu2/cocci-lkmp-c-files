...
position p;
@@
 enum { FPGA_BUFSIZE = 512 , FPGA_EP = 2 , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct ihex_record {  u16 address ;  u8 len ;  u8 data [ 256 ] ;  char error ;  u8 max_len ;  const char * txt_data ;  unsigned int txt_length ;  unsigned int txt_offset ; } cocci_id@p ;
