...
position p;
@@
 const char * cocci_id@p [ WM2200_NUM_CORE_SUPPLIES ] ;
...
position p;
@@
 struct wm2200_pdata * cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ WM2200_NUM_BCLK_RATES ] ;
...
position p;
@@
 struct wm2200_fll {  int fref ;  int fout ;  int src ;  struct completion lock ; } cocci_id@p ;
