...
typedef __u32;
@@
 struct tc35815_regs {  __u32 DMA_Ctl ;  __u32 TxFrmPtr ;  __u32 TxThrsh ;  __u32 TxPollCtr ;  __u32 BLFrmPtr ;  __u32 RxFragSize ;  __u32 Int_En ;  __u32 FDA_Bas ;  __u32 FDA_Lim ;  __u32 Int_Src ;  __u32 unused0 [ 2 ] ;  __u32 PauseCnt ;  __u32 RemPauCnt ;  __u32 TxCtlFrmStat ;  __u32 unused1 ;  __u32 MAC_Ctl ;  __u32 CAM_Ctl ;  __u32 Tx_Ctl ;  __u32 Tx_Stat ;  __u32 Rx_Ctl ;  __u32 Rx_Stat ;  __u32 MD_Data ;  __u32 MD_CA ;  __u32 CAM_Adr ;  __u32 CAM_Data ;  __u32 CAM_Ena ;  __u32 PROM_Ctl ;  __u32 PROM_Data ;  __u32 Algn_Cnt ;  __u32 CRC_Cnt ;  __u32 Miss_Cnt ; } cocci_id@p ;
...
position p;
@@
 struct tc35815_local cocci_id@p ;
...
position p;
@@
 struct tc35815_options {  int speed ;  int duplex ; } cocci_id@p ;
...
position p;
@@
 enum tc35815_chiptype { TC35815CF = 0 , TC35815_NWU , TC35815_TX4939 , } cocci_id@p ;
...
typedef __u32;
@@
 struct BDesc {  volatile __u32 BuffData ;  volatile __u32 BDCtl ; } cocci_id@p ;
...
typedef __u32;
@@
 struct FDesc {  volatile __u32 FDNext ;  volatile __u32 FDSystem ;  volatile __u32 FDStat ;  volatile __u32 FDCtl ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int limit ) ;
...
position p;
@@
 struct FrFD {  struct FDesc fd ;  struct BDesc bd [ RX_BUF_NUM ] ; } cocci_id@p ;
...
position p;
@@
 struct TxFD {  struct FDesc fd ;  struct BDesc bd ;  struct BDesc unused ; } cocci_id@p ;
...
position p;
@@
 struct RxFD {  struct FDesc fd ;  struct BDesc bd [ 0 ] ; } cocci_id@p ;
