...
position p;
@@
 struct pxp_q_data {  unsigned int width ;  unsigned int height ;  unsigned int bytesperline ;  unsigned int sizeimage ;  unsigned int sequence ;  struct pxp_fmt * fmt ;  enum v4l2_ycbcr_encoding ycbcr_enc ;  enum v4l2_quantization quant ; } cocci_id@p ;
...
typedef u8;
@@
 struct pxp_ctx {  struct v4l2_fh fh ;  struct pxp_dev * dev ;  struct v4l2_ctrl_handler hdl ;  int aborting ;  int mode ;  u8 alpha_component ;  enum v4l2_colorspace colorspace ;  enum v4l2_xfer_func xfer_func ;  struct pxp_q_data q_data [ 2 ] ; } cocci_id@p ;
...
@@
 struct pxp_dev {  struct v4l2_device v4l2_dev ;  struct video_device vfd ;  struct clk * clk ;  void __iomem * mmio ;  atomic_t num_inst ;  struct mutex dev_mutex ;  spinlock_t irqlock ;  struct v4l2_m2m_dev * m2m_dev ; } cocci_id@p ;
...
typedef u32;
@@
 struct pxp_fmt {  u32 fourcc ;  int depth ;  u32 types ; } cocci_id@p ;
