...
position p;
@@
 struct real_definition * * cocci_id@p ;
...
typedef __be32,__u8;
@@
 struct real_definition {  union {  __be32 dst ;  __be32 dstv6 [ 4 ] ; } ;  __u8 flags ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u32,__u8,__u64;
@@
 struct ctl_value {  union {  __u64 value ;  __u32 ifindex ;  __u8 mac [ 6 ] ; } ; } cocci_id@p ;
...
typedef __u8;
@@
 struct packet_description {  struct flow_key flow ;  __u8 flags ; } cocci_id@p ;
...
typedef __u32;
@@
 struct vip_meta {  __u32 flags ;  __u32 vip_num ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u32,__u16,__be32,__u8;
@@
 struct flow_key {  union {  __be32 src ;  __be32 srcv6 [ 4 ] ; } ;  union {  __be32 dst ;  __be32 dstv6 [ 4 ] ; } ;  union {  __u32 ports ;  __u16 port16 [ 2 ] ; } ;  __u8 proto ; } cocci_id@p ;
...
position p;
@@
 struct real_pos_lru * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u16,__be32,__u8;
@@
 struct vip_definition {  union {  __be32 vip ;  __be32 vipv6 [ 4 ] ; } ;  __u16 port ;  __u16 family ;  __u8 proto ; } cocci_id@p ;
...
position p;
@@
 struct packet_description * cocci_id@p ;
...
position p;
@@
 struct eth_hdr {  unsigned char eth_dest [ 6 ] ;  unsigned char eth_source [ 6 ] ;  unsigned short eth_proto ; } cocci_id@p ;
...
typedef __u32,__u64;
@@
 struct real_pos_lru {  __u32 pos ;  __u64 atime ; } cocci_id@p ;
...
typedef __u64;
@@
 struct lb_stats {  __u64 v2 ;  __u64 v1 ; } cocci_id@p ;
