...
position p;
@@
 struct psmouse_smbus_removal_work {  struct work_struct work ;  struct i2c_client * client ; } cocci_id@p ;
...
typedef bool;
@@
 struct psmouse_smbus_dev {  struct i2c_board_info board ;  struct psmouse * psmouse ;  struct i2c_client * client ;  struct list_head node ;  bool dead ;  bool need_deactivate ; } cocci_id@p ;
...
position p;
@@
 struct psmouse_smbus_removal_work cocci_id@p ;
...
position p;
@@
 struct psmouse_smbus_dev * cocci_id@p ;
