...
position p;
@@
 enum { NON_BLOCKING = 1 , CHECK_FILELOCK = 2 , } cocci_id@p ;
...
position p;
@@
 struct cap_msg_args cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct ceph_mds_client * mdsc ) ;
...
position p;
@@
 struct ceph_cap_reservation * cocci_id@p ;
...
position p;
@@
 struct cap_extra_info cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MAX_CAP_STR ] [ 40 ] ;
...
position p;
@@
 struct ceph_mds_cap_peer * cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct ceph_mds_client * mdsc , struct ceph_mds_session * session , struct ceph_inode_info * ci , u64 oldest_flush_tid ) ;
...
@@
 struct cap_extra_info {  struct ceph_string * pool_ns ;  u64 inline_version ;  void * inline_data ;  u32 inline_len ;  bool dirstat_valid ;  u64 nfiles ;  u64 nsubdirs ;  u64 change_attr ;  int issued ;  struct timespec64 btime ; } cocci_id@p ;
...
position p;
@@
 struct ceph_mds_caps * cocci_id@p ;
...
position p;
@@
 struct ceph_file_info * cocci_id@p ;
