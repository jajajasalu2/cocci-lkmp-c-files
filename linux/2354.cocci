...
position p;
@@
 enum { PS3_LPM_DEFAULT_TB_CACHE_SIZE = 0x4000 , } cocci_id@p ;
...
position p;
@@
 enum ps3_lpm_tb_type cocci_id@p ;
...
position p;
@@
 enum { use_start_stop_bookmark = 1 , } cocci_id@p ;
...
@@
 struct ps3_lpm_priv {  atomic_t open ;  u64 rights ;  u64 node_id ;  u64 pu_id ;  u64 lpm_id ;  u64 outlet_id ;  u64 tb_count ;  void * tb_cache ;  u64 tb_cache_size ;  void * tb_cache_internal ;  struct ps3_lpm_shadow_regs shadow ;  struct ps3_system_bus_device * sbd ; } cocci_id@p ;
...
typedef u64;
@@
 struct ps3_lpm_shadow_regs {  u64 pm_control ;  u64 pm_start_stop ;  u64 group_control ;  u64 debug_bus_control ; } cocci_id@p ;
...
position p;
@@
 struct ps3_lpm_priv * cocci_id@p ;
