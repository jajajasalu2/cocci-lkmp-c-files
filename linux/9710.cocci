...
position p;
@@
 struct iwl_vif_priv * cocci_id@p ;
...
position p;
@@
 enum { NONE , ADD , REMOVE , HT_RATE_INIT , ADD_RATE_INIT , } cocci_id@p ;
...
position p;
@@
 struct iwl_addsta_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_resume_data * cocci_id@p ;
...
position p;
@@
 struct iwlagn_wowlan_status cocci_id@p ;
...
position p;
@@
 struct iwl_ht_config * cocci_id@p ;
...
typedef bool;
@@
 struct iwl_resume_data {  struct iwl_priv * priv ;  struct iwlagn_wowlan_status * cmd ;  bool valid ; } cocci_id@p ;
