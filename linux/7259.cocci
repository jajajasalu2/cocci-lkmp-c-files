...
position p;
@@
 struct ath_vendor_cmd cocci_id@p ;
...
position p;
@@
 struct ath_struct {  struct hci_uart * hu ;  unsigned int cur_sleep ;  struct sk_buff * rx_skb ;  struct sk_buff_head txq ;  struct work_struct ctxtsw ; } cocci_id@p ;
