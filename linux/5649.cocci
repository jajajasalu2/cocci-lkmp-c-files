...
position p;
@@
 struct pl031_local {  struct pl031_vendor_data * vendor ;  struct rtc_device * rtc ;  void __iomem * base ; } cocci_id@p ;
...
typedef bool;
@@
 struct pl031_vendor_data {  struct rtc_class_ops ops ;  bool clockwatch ;  bool st_weekday ;  unsigned long irqflags ; } cocci_id@p ;
...
position p;
@@
 struct pl031_vendor_data * cocci_id@p ;
