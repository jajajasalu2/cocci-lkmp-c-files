...
position p;
@@
 struct tool_peer {  int pidx ;  struct tool_ctx * tc ;  int inmw_cnt ;  struct tool_mw * inmws ;  int outmw_cnt ;  struct tool_mw_wrap * outmws ;  int outmsg_cnt ;  struct tool_msg * outmsgs ;  int outspad_cnt ;  struct tool_spad * outspads ;  struct dentry * dbgfs_dir ; } cocci_id@p ;
...
@@
 struct tool_ctx {  struct ntb_dev * ntb ;  wait_queue_head_t link_wq ;  wait_queue_head_t db_wq ;  wait_queue_head_t msg_wq ;  int outmw_cnt ;  struct tool_mw * outmws ;  int peer_cnt ;  struct tool_peer * peers ;  int inmsg_cnt ;  struct tool_msg * inmsgs ;  int inspad_cnt ;  struct tool_spad * inspads ;  struct dentry * dbgfs_dir ; } cocci_id@p ;
...
position p;
@@
 struct tool_spad {  int sidx ;  int pidx ;  struct tool_ctx * tc ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u8,resource_size_t,dma_addr_t;
@@
 struct tool_mw {  int widx ;  int pidx ;  struct tool_ctx * tc ;  union {  u8 * mm_base ;  u8 __iomem * io_base ; } ;  union {  dma_addr_t dma_base ;  u64 tr_base ; } ;  resource_size_t size ;  struct dentry * dbgfs_file ; } cocci_id@p ;
...
position p;
@@
 struct tool_mw_wrap {  int pidx ;  struct tool_mw * mw ; } cocci_id@p ;
...
position p;
@@
 struct tool_msg {  int midx ;  int pidx ;  struct tool_ctx * tc ; } cocci_id@p ;
...
typedef u64;
@@
 int ( * cocci_id@p ) ( struct ntb_dev * , u64 ) ;
...
position p;
@@
 struct tool_mw_wrap * cocci_id@p ;
