...
typedef dma_addr_t;
@@
 struct aha1740_sg {  struct aha1740_chain sg_chain [ AHA1740_SCATTER ] ;  dma_addr_t sg_dma_addr ;  dma_addr_t buf_dma_addr ; } cocci_id@p ;
...
position p;
@@
 struct aha1740_chain * cocci_id@p ;
...
position p;
@@
 struct aha1740_hostdata cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct aha1740_hostdata {  struct eisa_device * edev ;  unsigned int translation ;  unsigned int last_ecb_used ;  dma_addr_t ecb_dma_addr ;  struct ecb ecb [ AHA1740_ECBS ] ; } cocci_id@p ;
