...
symbol cocci_id;
position p;
typedef SmuMetrics_t;
@@
 SmuMetrics_t * cocci_id@p ;
...
position p;
@@
 struct smu_11_0_dpm_context * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef DpmDescriptor_t;
@@
 DpmDescriptor_t * cocci_id@p ;
...
position p;
@@
 const struct pptable_funcs cocci_id@p ;
...
position p;
@@
 struct smu_table_context * cocci_id@p ;
...
position p;
@@
 enum SMU_11_0_ODSETTING_ID cocci_id@p ;
...
position p;
@@
 struct smu_power_gate * cocci_id@p ;
...
position p;
@@
 enum amd_pp_sensors cocci_id@p ;
...
position p;
@@
 struct smu_11_0_cmn2aisc_mapping cocci_id@p [ SMU_MSG_MAX_COUNT ] ;
...
position p;
@@
 struct smu_11_0_cmn2aisc_mapping cocci_id@p [ PP_SMC_POWER_PROFILE_COUNT ] ;
...
position p;
@@
 struct smu_11_0_cmn2aisc_mapping cocci_id@p [ SMU_TABLE_COUNT ] ;
...
symbol cocci_id;
position p;
typedef DpmActivityMonitorCoeffInt_t;
@@
 DpmActivityMonitorCoeffInt_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef OverDriveTable_t;
@@
 OverDriveTable_t cocci_id@p ;
...
position p;
@@
 struct atom_smc_dpm_info_v4_5 * cocci_id@p ;
...
position p;
@@
 struct smu_11_0_cmn2aisc_mapping cocci_id@p [ SMU_CLK_COUNT ] ;
...
position p;
@@
 struct smu_11_0_cmn2aisc_mapping cocci_id@p ;
...
position p;
@@
 struct smu_dpm_context * cocci_id@p ;
...
position p;
@@
 struct smu_11_0_powerplay_table * cocci_id@p ;
...
position p;
@@
 struct smu_11_0_cmn2aisc_mapping cocci_id@p [ SMU_POWER_SOURCE_COUNT ] ;
...
position p;
@@
 struct smu_11_0_overdrive_table cocci_id@p ;
...
position p;
@@
 struct smu_temperature_range * cocci_id@p ;
...
position p;
@@
 struct smu_11_0_max_sustainable_clocks * cocci_id@p ;
...
position p;
@@
 struct smu_power_context * cocci_id@p ;
...
position p;
@@
 struct smu_11_0_cmn2aisc_mapping cocci_id@p [ SMU_FEATURE_COUNT ] ;
...
position p;
@@
 struct smu_baco_context * cocci_id@p ;
...
position p;
@@
 enum SMU_11_0_ODFEATURE_ID cocci_id@p ;
