...
position p;
@@
 struct iop_adma_platform_data * cocci_id@p ;
...
position p;
@@
 struct iop_adma_desc_slot cocci_id@p ;
...
position p;
@@
 struct iop_adma_device cocci_id@p ;
...
position p;
@@
 void * cocci_id@p [ IOP_ADMA_NUM_SRC_TEST + 2 ] ;
...
position p;
@@
 struct page * cocci_id@p [ IOP_ADMA_NUM_SRC_TEST + 1 ] ;
...
typedef dma_addr_t;
@@
 dma_addr_t cocci_id@p [ IOP_ADMA_NUM_SRC_TEST + 2 ] ;
...
@@
 const irq_handler_t cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct iop_adma_chan * iop_chan ) ;
...
position p;
@@
 struct iop_adma_chan cocci_id@p ;
...
position p;
@@
 struct page * cocci_id@p [ IOP_ADMA_NUM_SRC_TEST + 2 + 2 ] ;
...
position p;
@@
 struct page * cocci_id@p [ IOP_ADMA_NUM_SRC_TEST ] ;
...
typedef dma_addr_t;
@@
 dma_addr_t cocci_id@p [ IOP_ADMA_NUM_SRC_TEST + 1 ] ;
