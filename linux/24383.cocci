...
position p;
@@
 struct ceph_mon_request_header cocci_id@p ;
...
position p;
@@
 struct ceph_mon_subscribe_ack * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef ceph_monc_callback_t;
@@
 ceph_monc_callback_t cocci_id@p ;
...
position p;
@@
 struct ceph_mon_statfs * cocci_id@p ;
...
position p;
@@
 struct ceph_mon_command * cocci_id@p ;
...
position p;
@@
 struct ceph_entity_inst * cocci_id@p ;
...
position p;
@@
 struct ceph_mon_statfs_reply * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ceph_mon_client * monc ) ;
