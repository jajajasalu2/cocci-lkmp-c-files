...
position p;
@@
 enum mperf_id { C0 = 0 , Cx , AVG_FREQ , MPERF_CSTATE_COUNT , } cocci_id@p ;
...
position p;
@@
 enum MAX_FREQ_MODE { MAX_FREQ_SYSFS , MAX_FREQ_TSC_REF , } cocci_id@p ;
...
typedef cstate_t;
@@
 cstate_t cocci_id@p [ MPERF_CSTATE_COUNT ] ;
