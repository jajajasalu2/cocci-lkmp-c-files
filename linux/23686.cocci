...
typedef u32;
@@
 struct cpu_priv {  unsigned long sysclk_freq [ 2 ] ;  u32 sysclk_dir [ 2 ] ;  u32 sysclk_id [ 2 ] ;  u32 slot_width ; } cocci_id@p ;
...
position p;
@@
 struct fsl_asoc_card_priv * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,snd_pcm_format_t;
@@
 struct fsl_asoc_card_priv {  struct snd_soc_dai_link dai_link [ 3 ] ;  struct platform_device * pdev ;  struct codec_priv codec_priv ;  struct cpu_priv cpu_priv ;  struct snd_soc_card card ;  u32 sample_rate ;  snd_pcm_format_t sample_format ;  u32 asrc_rate ;  snd_pcm_format_t asrc_format ;  u32 dai_fmt ;  char name [ 32 ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct codec_priv {  unsigned long mclk_freq ;  u32 mclk_id ;  u32 fll_id ;  u32 pll_id ; } cocci_id@p ;
