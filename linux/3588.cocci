...
position p;
@@
 const enum zynqmp_pm_reset_action cocci_id@p ;
...
position p;
@@
 const enum zynqmp_pm_reset cocci_id@p ;
...
position p;
@@
 const enum zynqmp_pm_request_ack cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( , , , u32 * ret_payload ) ;
