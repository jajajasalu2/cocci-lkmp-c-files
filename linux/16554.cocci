...
position p;
@@
 struct response_type {  struct completion work ;  int type ; } cocci_id@p ;
...
position p;
@@
 struct type86_fmt2_msg cocci_id@p ;
...
position p;
@@
 struct type86_ep11_reply * cocci_id@p ;
...
position p;
@@
 struct type86x_reply cocci_id@p ;
...
position p;
@@
 struct response_type * cocci_id@p ;
...
position p;
@@
 struct function_and_rules_block cocci_id@p ;
