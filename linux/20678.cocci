...
position p;
@@
 struct cpu_entry_area * cocci_id@p ;
...
position p;
@@
 struct exception_stacks * cocci_id@p ;
...
position p;
@@
 struct entry_stack_page cocci_id@p ;
...
position p;
@@
 struct debug_store_buffers cocci_id@p ;
...
position p;
@@
 struct doublefault_stack cocci_id@p ;
