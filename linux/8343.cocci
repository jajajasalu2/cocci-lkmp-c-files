...
typedef u8,bool,u16;
@@
 struct hw_info {  u8 bgx_cnt ;  u8 chans_per_lmac ;  u8 chans_per_bgx ;  u8 chans_per_rgx ;  u8 chans_per_lbk ;  u16 cpi_cnt ;  u16 rssi_cnt ;  u16 rss_ind_tbl_size ;  u16 tl4_cnt ;  u16 tl3_cnt ;  u8 tl2_cnt ;  u8 tl1_cnt ;  bool tl1_per_bgx ; } cocci_id@p ;
...
position p;
@@
 struct reset_stat_cfg * cocci_id@p ;
...
position p;
@@
 struct set_loopback * cocci_id@p ;
