...
typedef u8,u16;
@@
 struct mt9m001_reg {  u8 reg ;  u16 data ; } cocci_id@p ;
...
position p;
@@
 const struct mt9m001_reg * cocci_id@p ;
...
typedef u32;
@@
 struct mt9m001_datafmt {  u32 code ;  enum v4l2_colorspace colorspace ; } cocci_id@p ;
...
typedef bool;
@@
 struct mt9m001 {  struct v4l2_subdev subdev ;  struct v4l2_ctrl_handler hdl ;  struct {  struct v4l2_ctrl * autoexposure ;  struct v4l2_ctrl * exposure ; } ;  bool streaming ;  struct mutex mutex ;  struct v4l2_rect rect ;  struct clk * clk ;  struct gpio_desc * standby_gpio ;  struct gpio_desc * reset_gpio ;  const struct mt9m001_datafmt * fmt ;  const struct mt9m001_datafmt * fmts ;  int num_fmts ;  unsigned int total_h ;  unsigned short y_skip_top ;  struct media_pad pad ; } cocci_id@p ;
...
position p;
@@
 const struct mt9m001_datafmt cocci_id@p [ ] ;
