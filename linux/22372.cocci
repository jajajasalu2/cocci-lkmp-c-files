...
position p;
@@
 enum derived_key_type cocci_id@p ;
...
position p;
@@
 enum { Opt_default , Opt_ecryptfs , Opt_enc32 , Opt_error , } cocci_id@p ;
...
position p;
@@
 struct encrypted_key_payload cocci_id@p ;
...
position p;
@@
 enum { Opt_new , Opt_load , Opt_update , Opt_err , } cocci_id@p ;
...
position p;
@@
 enum derived_key_type { ENC_KEY , AUTH_KEY , } cocci_id@p ;
