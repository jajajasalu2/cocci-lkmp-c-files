...
position p;
@@
 struct ar5416AniState * cocci_id@p ;
...
typedef int16_t;
@@
 int16_t cocci_id@p [ NUM_NF_READINGS ] ;
...
position p;
@@
 struct ath9k_ani_default * cocci_id@p ;
...
position p;
@@
 struct ath_spec_scan * cocci_id@p ;
...
position p;
@@
 struct ar5416IniArray * cocci_id@p ;
...
position p;
@@
 struct ath_hw_radar_conf * cocci_id@p ;
