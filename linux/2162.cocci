...
position p;
@@
 struct da9030_battery_thresholds {  int tbat_low ;  int tbat_high ;  int tbat_restart ;  int vbat_low ;  int vbat_crit ;  int vbat_charge_start ;  int vbat_charge_stop ;  int vbat_charge_restart ;  int vcharge_min ;  int vcharge_max ; } cocci_id@p ;
...
position p;
@@
 struct da9030_charger cocci_id@p ;
...
typedef uint8_t;
@@
 struct da9030_adc_res {  uint8_t vbat_res ;  uint8_t vbatmin_res ;  uint8_t vbatmintxon ;  uint8_t ichmax_res ;  uint8_t ichmin_res ;  uint8_t ichaverage_res ;  uint8_t vchmax_res ;  uint8_t vchmin_res ;  uint8_t tbat_res ;  uint8_t adc_in4_res ;  uint8_t adc_in5_res ; } cocci_id@p ;
...
@@
 struct da9030_charger {  struct power_supply * psy ;  struct power_supply_desc psy_desc ;  struct device * master ;  struct da9030_adc_res adc ;  struct delayed_work work ;  unsigned int interval ;  struct power_supply_info * battery_info ;  struct da9030_battery_thresholds thresholds ;  unsigned int charge_milliamp ;  unsigned int charge_millivolt ;  bool chdet ;  uint8_t fault ;  int mA ;  int mV ;  bool is_on ;  struct notifier_block nb ;  void ( * battery_low ) ( void ) ;  void ( * battery_critical ) ( void ) ;  struct dentry * debug_file ; } cocci_id@p ;
...
position p;
@@
 struct da9030_adc_res * cocci_id@p ;
