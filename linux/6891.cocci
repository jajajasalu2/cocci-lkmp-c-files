...
symbol cocci_id;
position p;
typedef mraid_mmadp_t,uioc_t;
@@
 uioc_t * cocci_id@p ( mraid_mmadp_t * ) ;
...
typedef uint;
@@
 long cocci_id@p ( struct file * , uint , unsigned long ) ;
...
symbol cocci_id;
position p;
typedef mraid_mmadp_t,mimd_t;
@@
 mraid_mmadp_t * cocci_id@p ( mimd_t __user * , int * ) ;
...
position p;
@@
 char cocci_id@p [ EXT_IOCTL_SIGN_SZ ] ;
