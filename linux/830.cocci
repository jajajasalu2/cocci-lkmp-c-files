...
position p;
@@
 struct acpipnp_parse_option_s {  struct pnp_dev * dev ;  unsigned int option_flags ; } cocci_id@p ;
...
position p;
@@
 struct acpi_resource_vendor_typed * cocci_id@p ;
...
position p;
@@
 struct acpi_vendor_uuid * cocci_id@p ;
...
position p;
@@
 struct acpipnp_parse_option_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pnp_irq_mask_t;
@@
 pnp_irq_mask_t cocci_id@p ;
