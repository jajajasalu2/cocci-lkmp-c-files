...
typedef u8,u32;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u32 rk [ ] , int rounds , int blocks , u8 iv [ ] ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u32 rk [ ] , int rounds , int blocks , u8 ctr [ ] ) ;
...
position p;
@@
 const struct crypto_aes_ctx * cocci_id@p ;
...
position p;
@@
 struct simd_skcipher_alg * cocci_id@p [ ARRAY_SIZE ( aes_algs ) ] ;
...
position p;
@@
 struct mac_desc_ctx cocci_id@p ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u32 rk1 [ ] , int rounds , int bytes , const u32 rk2 [ ] , u8 iv [ ] , int first ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u32 rk1 [ ] , int rounds , int blocks , u8 iv [ ] , const u32 rk2 [ ] ) ;
...
position p;
@@
 struct crypto_aes_xts_ctx cocci_id@p ;
...
position p;
@@
 struct simd_skcipher_alg * cocci_id@p ;
...
typedef u8;
@@
 struct mac_desc_ctx {  unsigned int len ;  u8 dg [ AES_BLOCK_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct crypto_aes_essiv_cbc_ctx cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ 3 ] [ AES_BLOCK_SIZE ] ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u32 rk [ ] , int rounds , int blocks ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( const u8 in [ ] , const u32 rk [ ] , int rounds , int blocks , u8 dg [ ] , int enc_before , int enc_after ) ;
...
typedef u8,u32;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u32 rk [ ] , int rounds , int bytes , const u8 iv [ ] ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ SHA256_DIGEST_SIZE ] ;
