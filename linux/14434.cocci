...
position p;
@@
 struct tea5764_regs * cocci_id@p ;
...
position p;
@@
 struct tea5764_device cocci_id@p ;
...
position p;
@@
 struct tea5764_write_regs cocci_id@p ;
...
position p;
@@
 struct tea5764_device {  struct v4l2_device v4l2_dev ;  struct v4l2_ctrl_handler ctrl_handler ;  struct i2c_client * i2c_client ;  struct video_device vdev ;  struct tea5764_regs regs ;  struct mutex mutex ; } cocci_id@p ;
