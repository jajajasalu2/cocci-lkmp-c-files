...
position p;
@@
 struct node_vectors cocci_id@p ;
...
position p;
@@
 const struct node_vectors * cocci_id@p ;
...
position p;
@@
 struct node_vectors {  unsigned id ;  union {  unsigned nvectors ;  unsigned ncpus ; } ; } cocci_id@p ;
...
position p;
@@
 const struct irq_affinity * cocci_id@p ;
