...
position p;
@@
 const struct mpu_data * cocci_id@p [ NR_CHIPS ] ;
...
position p;
@@
 const struct mpu_data * cocci_id@p ;
...
position p;
@@
 struct wf_control * cocci_id@p [ NR_CHIPS ] ;
...
position p;
@@
 struct wf_cpu_pid_state cocci_id@p [ NR_CHIPS ] ;
...
position p;
@@
 struct wf_sensor * cocci_id@p [ NR_CHIPS ] ;
...
position p;
@@
 const struct wf_pid_param cocci_id@p ;
