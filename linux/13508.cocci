...
position p;
@@
 enum technisat_usb2_led_state cocci_id@p ;
...
typedef u8,u16;
@@
 struct technisat_usb2_state {  struct dvb_usb_device * dev ;  struct delayed_work green_led_work ;  u8 power_state ;  u16 last_scan_code ;  u8 buf [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 struct technisat_usb2_state * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ EEPROM_MAC_TOTAL ] ;
...
position p;
@@
 enum technisat_usb2_led_state { TECH_LED_OFF , TECH_LED_BLINK , TECH_LED_ON , TECH_LED_UNDEFINED , } cocci_id@p ;
