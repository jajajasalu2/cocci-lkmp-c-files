...
typedef tpl_parse_t;
@@
 struct cis_tpl {  unsigned char code ;  unsigned char min_size ;  tpl_parse_t * parse ; } cocci_id@p ;
...
position p;
@@
 const struct cis_tpl cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p ( struct mmc_card * , struct sdio_func * , const unsigned char * , unsigned ) ;
