...
position p;
@@
 enum shmem_param { Opt_gid , Opt_huge , Opt_mode , Opt_mpol , Opt_nr_blocks , Opt_nr_inodes , Opt_size , Opt_uid , } cocci_id@p ;
...
position p;
@@
 struct shmem_falloc cocci_id@p ;
...
position p;
@@
 unsigned long ( * cocci_id@p ) ( struct file * , unsigned long , unsigned long , unsigned long , unsigned long ) ;
...
position p;
@@
 struct shmem_sb_info * cocci_id@p ;
...
typedef pgoff_t;
@@
 pgoff_t cocci_id@p [ PAGEVEC_SIZE ] ;
...
symbol cocci_id;
position p;
typedef wait_queue_head_t,pgoff_t;
@@
 struct shmem_falloc {  wait_queue_head_t * waitq ;  pgoff_t start ;  pgoff_t next ;  pgoff_t nr_falloced ;  pgoff_t nr_unswapped ; } cocci_id@p ;
...
position p;
@@
 struct simple_xattr * cocci_id@p ;
...
position p;
@@
 struct shmem_options * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * , const struct xattr * , void * ) ;
