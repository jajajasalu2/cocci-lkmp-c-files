...
position p;
@@
 void cocci_id@p ( struct xenkbd_info * ) ;
...
position p;
@@
 struct xenkbd_info {  struct input_dev * kbd ;  struct input_dev * ptr ;  struct input_dev * mtouch ;  struct xenkbd_page * page ;  int gref ;  int irq ;  struct xenbus_device * xbdev ;  char phys [ 32 ] ;  int mtouch_cur_contact_id ; } cocci_id@p ;
...
position p;
@@
 struct xenkbd_motion * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xenbus_device * ) ;
...
position p;
@@
 int cocci_id@p ( struct xenbus_device * , struct xenkbd_info * ) ;
...
position p;
@@
 enum { KPARAM_X , KPARAM_Y , KPARAM_CNT , } cocci_id@p ;
...
position p;
@@
 union xenkbd_in_event * cocci_id@p ;
...
position p;
@@
 struct xenkbd_position * cocci_id@p ;
...
position p;
@@
 struct xenkbd_mtouch * cocci_id@p ;
