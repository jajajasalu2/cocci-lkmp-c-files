...
position p;
@@
 void cocci_id@p ( const char * , struct pt_regs * , long ) ;
...
position p;
@@
 void cocci_id@p ( int , struct pt_regs * ) ;
...
position p;
@@
 void cocci_id@p ( struct pt_regs * , unsigned long ) ;
...
position p;
@@
 struct {  int cause ;  int fast ;  void * handler ; } cocci_id@p ;
