...
position p;
@@
 enum sht15_chips { sht10 , sht11 , sht15 , sht71 , sht75 , } cocci_id@p ;
...
position p;
@@
 enum sht15_state { SHT15_READING_NOTHING , SHT15_READING_TEMP , SHT15_READING_HUMID , } cocci_id@p ;
...
position p;
@@
 struct sht15_temppair {  int vdd ;  int d1 ; } cocci_id@p ;
...
position p;
@@
 const struct sht15_temppair cocci_id@p [ ] ;
