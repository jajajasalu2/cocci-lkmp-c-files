...
position p;
@@
 struct ath6kl_fw_ie * cocci_id@p ;
...
position p;
@@
 const struct ath6kl_hw cocci_id@p [ ] ;
...
position p;
@@
 struct host_app_area cocci_id@p ;
...
position p;
@@
 const struct fw_capa_str_map {  int id ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 enum ath6kl_hif_type cocci_id@p ;
