...
position p;
@@
 struct signal_frame cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long * fpregs , unsigned long * fsr , void * fpqueue , unsigned long * fpqdepth ) ;
...
position p;
@@
 void cocci_id@p ( unsigned long * fpregs , unsigned long * fsr ) ;
