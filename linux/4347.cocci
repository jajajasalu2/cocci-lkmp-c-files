...
position p;
@@
 struct compat_ipmi_req_settime * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uint_t,compat_long_t,compat_uptr_t;
@@
 struct compat_ipmi_req {  compat_uptr_t addr ;  compat_uint_t addr_len ;  compat_long_t msgid ;  struct compat_ipmi_msg msg ; } cocci_id@p ;
...
typedef dev_t;
@@
 struct ipmi_reg_list {  dev_t dev ;  struct list_head link ; } cocci_id@p ;
...
position p;
@@
 struct ipmi_req_settime cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uint_t,compat_long_t,compat_uptr_t,compat_int_t;
@@
 struct compat_ipmi_recv {  compat_int_t recv_type ;  compat_uptr_t addr ;  compat_uint_t addr_len ;  compat_long_t msgid ;  struct compat_ipmi_msg msg ; } cocci_id@p ;
...
position p;
@@
 struct ipmi_cmdspec_chans cocci_id@p ;
...
position p;
@@
 struct ipmi_file_private * cocci_id@p ;
...
position p;
@@
 struct ipmi_timing_parms cocci_id@p ;
...
position p;
@@
 struct compat_ipmi_recv * cocci_id@p ;
...
position p;
@@
 struct compat_ipmi_msg * cocci_id@p ;
...
position p;
@@
 struct ipmi_cmdspec cocci_id@p ;
...
position p;
@@
 struct ipmi_channel_lun_address_set cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct ipmi_recv * , void __user * ) ;
...
position p;
@@
 struct compat_ipmi_req cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u16,compat_uptr_t;
@@
 struct compat_ipmi_msg {  u8 netfn ;  u8 cmd ;  u16 data_len ;  compat_uptr_t data ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uint_t,compat_int_t;
@@
 struct compat_ipmi_req_settime {  struct compat_ipmi_req req ;  compat_int_t retries ;  compat_uint_t retry_time_ms ; } cocci_id@p ;
...
position p;
@@
 struct ipmi_reg_list * cocci_id@p ;
...
@@
 struct ipmi_file_private {  struct ipmi_user * user ;  spinlock_t recv_msg_lock ;  struct list_head recv_msgs ;  struct fasync_struct * fasync_queue ;  wait_queue_head_t wait ;  struct mutex recv_mutex ;  int default_retries ;  unsigned int default_retry_time_ms ; } cocci_id@p ;
