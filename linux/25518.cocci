...
position p;
@@
 const struct mem_mode * cocci_id@p ;
...
position p;
@@
 struct perf_mem_event * cocci_id@p ;
...
typedef bool;
@@
 struct perf_mem {  struct perf_tool tool ;  const char * input_name ;  bool hide_unresolved ;  bool dump_raw ;  bool force ;  bool phys_addr ;  int operation ;  const char * cpu_list ; 
...
position p;
@@
 struct mem_mode {  const char * name ;  int mode ; } cocci_id@p ;
