...
position p;
@@
 const struct ad7280_platform_data * cocci_id@p ;
...
position p;
@@
 struct ad7280_state * cocci_id@p ;
...
typedef __be32;
@@
 struct ad7280_state {  struct spi_device * spi ;  struct iio_chan_spec * channels ;  struct iio_dev_attr * iio_attr ;  int slave_num ;  int scan_cnt ;  int readback_delay_us ;  unsigned char crc_tab [ CRC8_TABLE_SIZE ] ;  unsigned char ctrl_hb ;  unsigned char ctrl_lb ;  unsigned char cell_threshhigh ;  unsigned char cell_threshlow ;  unsigned char aux_threshhigh ;  unsigned char aux_threshlow ;  unsigned char cb_mask [ AD7280A_MAX_CHAIN ] ;  struct mutex lock ;  __be32 buf [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 const unsigned short cocci_id@p [ 4 ] ;
...
position p;
@@
 struct attribute * cocci_id@p [ AD7280A_MAX_CHAIN * AD7280A_CELLS_PER_DEV * 2 + 1 ] ;
