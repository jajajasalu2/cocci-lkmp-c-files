...
position p;
@@
 struct max6642_data cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct max6642_data {  struct i2c_client * client ;  struct mutex update_lock ;  bool valid ;  unsigned long last_updated ;  u16 temp_input [ 2 ] ;  u16 temp_high [ 2 ] ;  u8 alarms ; } cocci_id@p ;
