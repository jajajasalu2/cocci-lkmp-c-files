...
position p;
@@
 const struct btmrvl_sdio_card_reg cocci_id@p ;
...
position p;
@@
 struct btmrvl_adapter * cocci_id@p ;
...
position p;
@@
 struct btmrvl_plt_wake_cfg * cocci_id@p ;
...
position p;
@@
 struct btmrvl_sdio_device * cocci_id@p ;
...
position p;
@@
 struct btmrvl_sdio_card * cocci_id@p ;
...
position p;
@@
 const struct btmrvl_sdio_device cocci_id@p ;
...
position p;
@@
 struct btmrvl_private * cocci_id@p ;
