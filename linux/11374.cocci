...
typedef u32;
@@
 struct tfp410 {  struct drm_bridge bridge ;  struct drm_connector connector ;  unsigned int connector_type ;  u32 bus_format ;  struct i2c_adapter * ddc ;  struct gpio_desc * hpd ;  int hpd_irq ;  struct delayed_work hpd_work ;  struct gpio_desc * powerdown ;  struct drm_bridge_timings timings ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct drm_bridge_timings * cocci_id@p ;
...
position p;
@@
 struct {  uint i2c : 1 ;  uint platform : 1 ; } cocci_id@p ;
