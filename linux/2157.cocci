...
position p;
@@
 struct max8903_pdata * cocci_id@p ;
...
typedef bool;
@@
 struct max8903_data {  struct max8903_pdata * pdata ;  struct device * dev ;  struct power_supply * psy ;  struct power_supply_desc psy_desc ;  bool fault ;  bool usb_in ;  bool ta_in ; } cocci_id@p ;
...
position p;
@@
 struct max8903_data cocci_id@p ;
