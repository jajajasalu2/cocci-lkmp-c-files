...
position p;
@@
 struct hplance_private cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , struct dio_dev * d ) ;
...
position p;
@@
 void cocci_id@p ( struct dio_dev * d ) ;
...
position p;
@@
 struct dio_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct hplance_private {  struct lance_private lance ; } cocci_id@p ;
...
position p;
@@
 const struct dio_device_id * cocci_id@p ;
...
position p;
@@
 unsigned short cocci_id@p ( void * priv ) ;
...
position p;
@@
 void cocci_id@p ( void * priv , unsigned short value ) ;
...
position p;
@@
 int cocci_id@p ( struct dio_dev * d , const struct dio_device_id * ent ) ;
