...
position p;
@@
 struct rti802_private {  enum { dac_2comp , dac_straight , } dac_coding [ 8 ] ;  const struct comedi_lrange * range_type_list [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct rti802_private * cocci_id@p ;
