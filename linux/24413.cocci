...
position p;
@@
 struct hci_cp_remote_name_req_cancel cocci_id@p ;
...
position p;
@@
 struct hci_cp_ext_adv_set * cocci_id@p ;
...
position p;
@@
 struct hci_cp_inquiry cocci_id@p ;
...
position p;
@@
 struct hci_cp_le_set_scan_rsp_data cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HCI_MAX_SHORT_NAME_LENGTH + 1 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( * ext_param_cp ) + sizeof ( * phy_params ) * 2 ] ;
...
position p;
@@
 struct hci_cp_disconn_phy_link cocci_id@p ;
...
position p;
@@
 struct hci_cp_le_set_ext_scan_rsp_data cocci_id@p ;
...
position p;
@@
 struct hci_cp_write_current_iac_lap cocci_id@p ;
...
position p;
@@
 struct hci_cp_reject_sync_conn_req cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( * cp ) + sizeof ( * adv_set ) * 1 ] ;
...
position p;
@@
 struct hci_cp_le_set_adv_data cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct hci_request * req , unsigned long opt ) ;
...
position p;
@@
 struct hci_cp_le_set_ext_adv_data cocci_id@p ;
...
position p;
@@
 struct hci_cp_write_local_name cocci_id@p ;
