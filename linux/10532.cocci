...
position p;
@@
 struct r100_mc_save cocci_id@p ;
...
symbol cocci_id;
position p;
typedef radeon_packet0_check_t;
@@
 radeon_packet0_check_t cocci_id@p ;
...
position p;
@@
 struct r100_cs_track_texture * cocci_id@p ;
...
position p;
@@
 struct r100_cs_track * cocci_id@p ;
