...
position p;
@@
 const struct cdns_sierra_data cocci_id@p ;
...
position p;
@@
 struct cdns_sierra_inst * cocci_id@p ;
...
position p;
@@
 struct cdns_sierra_phy * cocci_id@p ;
...
position p;
@@
 struct cdns_reg_pairs * cocci_id@p ;
...
typedef u32,u16;
@@
 struct cdns_reg_pairs {  u16 val ;  u32 off ; } cocci_id@p ;
...
position p;
@@
 struct cdns_sierra_data * cocci_id@p ;
...
typedef u32;
@@
 struct cdns_sierra_inst {  struct phy * phy ;  u32 phy_type ;  u32 num_lanes ;  u32 mlane ;  struct reset_control * lnk_rst ; } cocci_id@p ;
...
typedef u32;
@@
 struct cdns_sierra_data {  u32 id_value ;  u32 pcie_regs ;  u32 usb_regs ;  struct cdns_reg_pairs * pcie_vals ;  struct cdns_reg_pairs * usb_vals ; } cocci_id@p ;
...
typedef bool;
@@
 struct cdns_sierra_phy {  struct device * dev ;  void __iomem * base ;  struct cdns_sierra_data * init_data ;  struct cdns_sierra_inst phys [ SIERRA_MAX_LANES ] ;  struct reset_control * phy_rst ;  struct reset_control * apb_rst ;  struct clk * clk ;  int nsubnodes ;  bool autoconf ; } cocci_id@p ;
