...
position p;
@@
 struct pvr2_channel * cocci_id@p ;
...
position p;
@@
 struct pvr2_v4l2_dev cocci_id@p ;
...
position p;
@@
 struct pvr2_v4l2_fh * cocci_id@p ;
...
@@
 struct pvr2_v4l2_fh {  struct v4l2_fh fh ;  struct pvr2_channel channel ;  struct pvr2_v4l2_dev * pdi ;  struct pvr2_ioread * rhp ;  struct file * file ;  wait_queue_head_t wait_data ;  int fw_mode_flag ;  unsigned char * input_map ;  unsigned int input_cnt ; } cocci_id@p ;
...
position p;
@@
 struct pvr2_context * cocci_id@p ;
...
position p;
@@
 struct pvr2_v4l2 {  struct pvr2_channel channel ;  struct pvr2_v4l2_dev * dev_video ;  struct pvr2_v4l2_dev * dev_radio ; } cocci_id@p ;
...
position p;
@@
 pvr2_stream_callback cocci_id@p ;
...
position p;
@@
 struct pvr2_v4l2_dev {  struct video_device devbase ;  struct pvr2_v4l2 * v4lp ;  struct pvr2_context_stream * stream ;  enum pvr2_config config ;  int v4l_type ;  enum pvr2_v4l_type minor_type ; } cocci_id@p ;
