...
position p;
@@
 struct ec_response_get_chip_info * cocci_id@p ;
...
position p;
@@
 struct ec_response_flash_info * cocci_id@p ;
...
typedef uint8_t;
@@
 const struct {  const char * const str ;  uint8_t cmd ;  uint8_t flags ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ec_params_reboot_ec * cocci_id@p ;
...
position p;
@@
 struct ec_response_board_version * cocci_id@p ;
