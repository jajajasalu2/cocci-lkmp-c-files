...
typedef u_int;
@@
 void cocci_id@p ( struct ahc_softc * ahc , struct seq_file * m , u_int our_id , char channel , u_int target_id , u_int target_offset ) ;
...
typedef u_int;
@@
 const struct {  u_int period_factor ;  u_int period ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * m , struct scsi_device * dev ) ;
