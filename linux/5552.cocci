...
position p;
@@
 struct sunxi_rtc_data_year {  unsigned int min ;  unsigned int max ;  unsigned int mask ;  unsigned char leap_shift ; } cocci_id@p ;
...
position p;
@@
 const struct sunxi_rtc_data_year cocci_id@p [ ] ;
...
position p;
@@
 struct sunxi_rtc_dev * cocci_id@p ;
...
position p;
@@
 struct sunxi_rtc_dev {  struct rtc_device * rtc ;  struct device * dev ;  const struct sunxi_rtc_data_year * data_year ;  void __iomem * base ;  int irq ; } cocci_id@p ;
