...
position p;
@@
 struct spdif_mixer_control * cocci_id@p ;
...
@@
 struct spdif_mixer_control {  spinlock_t ctl_lock ;  unsigned char ch_status [ 4 ] ;  unsigned char subcode [ 2 * SPDIF_UBITS_SIZE ] ;  unsigned char qsub [ 2 * SPDIF_QSUB_SIZE ] ;  u32 upos ;  u32 qpos ;  u32 ready_buf ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ GAINSEL_MULTI_MAX ] ;
...
position p;
@@
 struct fsl_spdif_priv * cocci_id@p ;
