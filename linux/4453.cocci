...
position p;
@@
 struct stm32_rng_private * cocci_id@p ;
...
typedef bool;
@@
 struct stm32_rng_private {  struct hwrng rng ;  void __iomem * base ;  struct clk * clk ;  struct reset_control * rst ;  bool ced ; } cocci_id@p ;
