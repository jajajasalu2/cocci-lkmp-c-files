...
position p;
@@
 struct aer_error_inj * cocci_id@p ;
...
typedef u8,u32;
@@
 struct aer_error_inj {  u8 bus ;  u8 dev ;  u8 fn ;  u32 uncor_status ;  u32 cor_status ;  u32 header_log0 ;  u32 header_log1 ;  u32 header_log2 ;  u32 header_log3 ;  u32 domain ; } cocci_id@p ;
...
position p;
@@
 struct pci_bus_ops {  struct list_head list ;  struct pci_bus * bus ;  struct pci_ops * ops ; } cocci_id@p ;
...
typedef u32;
@@
 struct aer_error {  struct list_head list ;  u32 domain ;  unsigned int bus ;  unsigned int devfn ;  int pos_cap_err ;  u32 uncor_status ;  u32 cor_status ;  u32 header_log0 ;  u32 header_log1 ;  u32 header_log2 ;  u32 header_log3 ;  u32 root_status ;  u32 source_id ; } cocci_id@p ;
