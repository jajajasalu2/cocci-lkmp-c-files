...
position p;
@@
 struct nvkm_fifo_chan_object {  struct nvkm_oproxy oproxy ;  struct nvkm_fifo_chan * chan ;  int hash ; } cocci_id@p ;
...
position p;
@@
 struct nvkm_fifo_chan_object * cocci_id@p ;
...
position p;
@@
 struct nvkm_fifo_engn * cocci_id@p ;
...
position p;
@@
 const struct nvkm_fifo_chan_func * cocci_id@p ;
