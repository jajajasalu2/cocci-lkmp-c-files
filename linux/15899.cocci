...
position p;
@@
 struct usb_cardstate {  struct usb_device * udev ;  struct usb_interface * interface ;  int busy ;  unsigned char * bulk_out_buffer ;  int bulk_out_size ;  int bulk_out_epnum ;  struct urb * bulk_out_urb ;  unsigned char * rcvbuf ;  int rcvbuf_size ;  struct urb * read_urb ;  char bchars [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct cardstate * cs ) ;
...
position p;
@@
 struct usb_cardstate * cocci_id@p ;
