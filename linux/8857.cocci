...
position p;
@@
 int cocci_id@p [ TX_CLEAN_BATCHSIZE ] ;
...
position p;
@@
 struct pasemi_mac_csring * cocci_id@p ;
...
typedef dma_addr_t;
@@
 dma_addr_t cocci_id@p [ TX_CLEAN_BATCHSIZE ] [ MAX_SKB_FRAGS + 1 ] ;
...
position p;
@@
 const struct pasemi_mac_rxring * cocci_id@p ;
...
position p;
@@
 const struct pasemi_dmachan * cocci_id@p ;
...
position p;
@@
 struct pasemi_mac_rxring * cocci_id@p ;
...
position p;
@@
 struct pasemi_mac_buffer * cocci_id@p ;
...
position p;
@@
 struct pasemi_mac_txring cocci_id@p ;
...
position p;
@@
 const struct pasemi_mac * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_SKB_FRAGS + 1 ] ;
...
position p;
@@
 struct sk_buff * cocci_id@p [ TX_CLEAN_BATCHSIZE ] ;
...
position p;
@@
 struct pasemi_mac * const cocci_id@p ;
...
position p;
@@
 struct pasemi_mac_txring * const cocci_id@p ;
...
position p;
@@
 struct pasemi_dmachan * cocci_id@p ;
