...
position p;
@@
 struct dra7_atl_clock_info * cocci_id@p ;
...
typedef bool,u32;
@@
 struct dra7_atl_desc {  struct clk * clk ;  struct clk_hw hw ;  struct dra7_atl_clock_info * cinfo ;  int id ;  bool probed ;  bool valid ;  bool enabled ;  u32 bws ;  u32 aws ;  u32 divider ; } cocci_id@p ;
...
position p;
@@
 struct dra7_atl_desc cocci_id@p ;
...
position p;
@@
 struct dra7_atl_clock_info {  struct device * dev ;  void __iomem * iobase ;  struct dra7_atl_desc * cdesc ; } cocci_id@p ;
