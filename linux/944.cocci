...
typedef u8,u32;
@@
 struct spear_snor_flash {  u32 bank ;  u32 dev_id ;  struct mutex lock ;  struct mtd_info mtd ;  u32 num_parts ;  struct mtd_partition * parts ;  u32 page_size ;  void __iomem * base_addr ;  u8 erase_cmd ;  u8 fast_mode ; } cocci_id@p ;
...
position p;
@@
 struct spear_snor_flash * cocci_id@p ;
...
position p;
@@
 struct spear_smi_flash_info * cocci_id@p ;
...
position p;
@@
 struct spear_smi_plat_data * cocci_id@p ;
...
typedef u8,u32;
@@
 struct flash_device {  char * name ;  u8 erase_cmd ;  u32 device_id ;  u32 pagesize ;  unsigned long sectorsize ;  unsigned long size_in_bytes ; } cocci_id@p ;
...
@@
 struct spear_smi {  struct clk * clk ;  u32 status ;  unsigned long clk_rate ;  struct mutex lock ;  void __iomem * io_base ;  struct platform_device * pdev ;  wait_queue_head_t cmd_complete ;  u32 num_flashes ;  struct spear_snor_flash * flash [ MAX_NUM_FLASH_CHIP ] ; } cocci_id@p ;
...
position p;
@@
 struct flash_device cocci_id@p [ ] ;
