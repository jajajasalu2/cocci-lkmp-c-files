...
position p;
@@
 void cocci_id@p ( struct fs_prio * prio , int acc_level ) ;
...
position p;
@@
 const struct mlx5_flow_context * cocci_id@p ;
...
position p;
@@
 struct init_tree_node cocci_id@p ;
...
position p;
@@
 struct match_list_head * cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_rule * cocci_id@p ( struct fs_fte * fte , struct mlx5_flow_destination * dest ) ;
...
position p;
@@
 void cocci_id@p ( struct fs_node * node ) ;
...
position p;
@@
 enum mlx5_flow_steering_mode cocci_id@p ;
...
position p;
@@
 enum fs_i_lock_class { FS_LOCK_GRANDPARENT , FS_LOCK_PARENT , FS_LOCK_CHILD , } cocci_id@p ;
...
position p;
@@
 struct init_tree_node {  enum fs_node_type type ;  struct init_tree_node * children ;  int ar_size ;  struct node_caps caps ;  int min_ft_level ;  int num_leaf_prios ;  int prio ;  int num_levels ;  enum mlx5_flow_table_miss_action def_miss_action ; } cocci_id@p ;
...
position p;
@@
 struct match_list {  struct list_head list ;  struct mlx5_flow_group * g ; } cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_rule * cocci_id@p ;
...
position p;
@@
 struct node_caps {  size_t arr_sz ;  long * caps ; } cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct mlx5_flow_destination * d1 , struct mlx5_flow_destination * d2 ) ;
...
position p;
@@
 struct mlx5_pkt_reformat * cocci_id@p ;
...
position p;
@@
 struct mlx5_flow_steering * cocci_id@p ;
...
position p;
@@
 struct mlx5_ft_underlay_qp * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct fs_node * ) ;
...
position p;
@@
 void cocci_id@p ( struct mlx5_flow_root_namespace * root_ns ) ;
...
position p;
@@
 enum fs_flow_table_op_mod cocci_id@p ;
...
position p;
@@
 struct match_list_head {  struct list_head list ;  struct match_list first ; } cocci_id@p ;
...
position p;
@@
 enum fs_i_lock_class cocci_id@p ;
...
position p;
@@
 struct mlx5_modify_hdr * cocci_id@p ;
