...
position p;
@@
 struct bitmap_ip_adt_elem cocci_id@p ;
...
position p;
@@
 struct bitmap_ip_elem { } cocci_id@p ;
...
position p;
@@
 const struct bitmap_ip * cocci_id@p ;
...
typedef u16;
@@
 struct bitmap_ip_adt_elem {  u16 id ; } cocci_id@p ;
...
position p;
@@
 const struct bitmap_ip_adt_elem * cocci_id@p ;
