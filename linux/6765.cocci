...
position p;
@@
 void cocci_id@p ( struct Scsi_Host * shpnt , char * msg ) ;
...
position p;
@@
 struct aha152x_hostdata cocci_id@p ;
...
position p;
@@
 struct aha152x_setup cocci_id@p [ 2 ] ;
...
position p;
@@
 void cocci_id@p ( struct scsi_cmnd * ptr ) ;
...
position p;
@@
 enum aha152x_state { idle = 0 , unknown , seldo , seldi , selto , busfree , msgo , cmd , msgi , status , datai , datao , parerr , rsti , maxstate , } cocci_id@p ;
...
position p;
@@
 struct aha152x_setup * cocci_id@p ;
...
position p;
@@
 struct {  char * name ;  void ( * init ) ( struct Scsi_Host * ) ;  void ( * run ) ( struct Scsi_Host * ) ;  void ( * end ) ( struct Scsi_Host * ) ;  int spio ; } cocci_id@p [ ] ;
...
position p;
@@
 struct aha152x_scdata cocci_id@p ;
...
position p;
@@
 enum { not_issued = 0x0001 , selecting = 0x0002 , identified = 0x0004 , disconnected = 0x0008 , completed = 0x0010 , aborted = 0x0020 , resetted = 0x0040 , spiordy = 0x0080 , syncneg = 0x0100 , aborting = 0x0200 , resetting = 0x0400 , check_condition = 0x0800 , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct Scsi_Host * shpnt , int error ) ;
...
position p;
@@
 struct aha152x_scdata {  struct scsi_cmnd * next ;  struct completion * done ;  struct scsi_eh_save ses ; } cocci_id@p ;
...
position p;
@@
 struct signature {  unsigned char * signature ;  int sig_offset ;  int sig_length ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct Scsi_Host * shpnt ) ;
