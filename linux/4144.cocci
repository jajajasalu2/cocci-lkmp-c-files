...
position p;
@@
 struct phy_meson_g12a_usb2_priv {  struct device * dev ;  struct regmap * regmap ;  struct clk * clk ;  struct reset_control * reset ; } cocci_id@p ;
...
position p;
@@
 struct phy_meson_g12a_usb2_priv * cocci_id@p ;
