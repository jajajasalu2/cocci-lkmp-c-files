...
position p;
@@
 struct iwl_uapsd_misbehaving_ap_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_beacon_filter_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_power_vifs * cocci_id@p ;
...
position p;
@@
 struct iwl_dbgfs_bf * cocci_id@p ;
...
typedef bool;
@@
 struct iwl_power_vifs {  struct iwl_mvm * mvm ;  struct ieee80211_vif * bss_vif ;  struct ieee80211_vif * p2p_vif ;  struct ieee80211_vif * ap_vif ;  struct ieee80211_vif * monitor_vif ;  bool p2p_active ;  bool bss_active ;  bool ap_active ;  bool monitor_active ; } cocci_id@p ;
...
position p;
@@
 struct iwl_mac_power_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_device_power_cmd cocci_id@p ;
