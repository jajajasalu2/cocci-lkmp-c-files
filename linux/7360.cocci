...
position p;
@@
 enum { cop_wait , cop_bplcon0 , cop_spr0ptrh , cop_spr0ptrl , cop_diwstrt , cop_diwstop , cop_diwhigh , } cocci_id@p ;
...
typedef __u16;
@@
 struct fb_cursorstate {  __s16 xoffset ;  __s16 yoffset ;  __u16 mode ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u_short,u_long;
@@
 union {  u_long l ;  u_short w [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 enum { TAG_FMODE_1 , TAG_FMODE_2 , TAG_FMODE_4 , } cocci_id@p ;
...
position p;
@@
 enum { TAG_OCS , TAG_ECS , TAG_AGA , } cocci_id@p ;
...
position p;
@@
 struct fb_fix_cursorinfo * cocci_id@p ;
...
position p;
@@
 const struct amifb_par * cocci_id@p ;
...
position p;
@@
 struct fb_var_cursorinfo * cocci_id@p ;
...
typedef __u16;
@@
 struct fb_fix_cursorinfo {  __u16 crsr_width ;  __u16 crsr_height ;  __u16 crsr_xsize ;  __u16 crsr_ysize ;  __u16 crsr_color1 ;  __u16 crsr_color2 ; } cocci_id@p ;
...
position p;
@@
 struct copdisplay {  copins * init ;  copins * wait ;  copins * list [ 2 ] [ 2 ] ;  copins * rebuild [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct fb_cursorstate * cocci_id@p ;
...
position p;
@@
 union {  struct fb_fix_cursorinfo fix ;  struct fb_var_cursorinfo var ;  struct fb_cursorstate state ; } cocci_id@p ;
...
position p;
@@
 enum { TAG_SHRES , TAG_HIRES , TAG_LORES , } cocci_id@p ;
...
typedef __u16,__u8;
@@
 struct fb_var_cursorinfo {  __u16 width ;  __u16 height ;  __u16 xspot ;  __u16 yspot ;  __u8 data [ 1 ] ; } cocci_id@p ;
...
typedef u_short,u_long;
@@
 struct amifb_par {  int xres ;  int yres ;  int vxres ;  int vyres ;  int xoffset ;  int yoffset ;  u_short bpp ;  u_short clk_shift ;  u_short line_shift ;  int vmode ;  u_short diwstrt_h ;  u_short diwstop_h ;  u_short diwstrt_v ;  u_short diwstop_v ;  u_long next_line ;  u_long next_plane ;  struct {  short crsr_x ;  short crsr_y ;  short spot_x ;  short spot_y ;  u_short height ;  u_short width ;  u_short fmode ; } crsr ;  u_long bplpt0 ;  u_long bplpt0wrap ;  u_short ddfstrt ;  u_short ddfstop ;  u_short bpl1mod ;  u_short bpl2mod ;  u_short bplcon0 ;  u_short bplcon1 ;  u_short htotal ;  u_short vtotal ;  u_short bplcon3 ;  u_short beamcon0 ;  u_short hsstrt ;  u_short hsstop ;  u_short hbstrt ;  u_short hbstop ;  u_short vsstrt ;  u_short vsstop ;  u_short vbstrt ;  u_short vbstop ;  u_short hcenter ;  u_short fmode ; } cocci_id@p ;
