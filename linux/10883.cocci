...
position p;
@@
 struct ta_xgmi_shared_memory * cocci_id@p ;
...
position p;
@@
 struct psp_xgmi_topology_info * cocci_id@p ;
...
position p;
@@
 enum AMDGPU_UCODE_ID cocci_id@p ;
...
position p;
@@
 struct ta_xgmi_cmd_get_topology_info_output * cocci_id@p ;
...
position p;
@@
 const struct ta_firmware_header_v1_0 * cocci_id@p ;
...
position p;
@@
 struct ta_ras_shared_memory cocci_id@p ;
...
position p;
@@
 const struct psp_funcs cocci_id@p ;
...
position p;
@@
 struct psp_gfx_rb_frame * cocci_id@p ;
...
position p;
@@
 struct ta_xgmi_cmd_get_topology_info_input * cocci_id@p ;
