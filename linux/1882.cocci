...
position p;
@@
 struct da9150_gpadc {  struct da9150 * da9150 ;  struct device * dev ;  struct mutex lock ;  struct completion complete ; } cocci_id@p ;
...
position p;
@@
 struct da9150_gpadc * cocci_id@p ;
