...
position p;
@@
 struct battery_thresh * cocci_id@p ;
...
position p;
@@
 struct sharpsl_pm_status cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ SHARPSL_CNV_VALUE_NUM + 1 ] ;
...
position p;
@@
 void cocci_id@p ( struct work_struct * private_ ) ;
