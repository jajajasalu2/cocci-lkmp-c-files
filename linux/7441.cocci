...
position p;
@@
 unsigned short cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned short tempax ) ;
...
typedef bool;
@@
 unsigned short cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned int VBFlags , int VGAEngine , unsigned short adaptnum , unsigned short DDCdatatype , bool checkcr32 , unsigned int VBFlags2 ) ;
...
position p;
@@
 void cocci_id@p ( struct SiS_Private * , unsigned short , unsigned short ) ;
...
position p;
@@
 unsigned char cocci_id@p [ 14 ] [ 80 ] ;
...
position p;
@@
 const struct SiS_Part2PortTbl * cocci_id@p ;
...
position p;
@@
 unsigned short cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned short DDCdatatype , unsigned char * buffer ) ;
...
position p;
@@
 void cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned short ModeNo , unsigned short ModeIdIndex , unsigned short RRTI ) ;
...
position p;
@@
 void cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned short ModeNo , unsigned short ModeIdIndex , unsigned short RefTableIndex ) ;
...
position p;
@@
 const struct SiS_TVData * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct SiS_Private * SiS_Pr ) ;
...
position p;
@@
 const struct SiS_CHTVRegData * cocci_id@p ;
...
position p;
@@
 const struct SiS_LVDSCRT1Data * cocci_id@p ;
...
position p;
@@
 const struct SiS_LCDData * cocci_id@p ;
...
position p;
@@
 const struct SiS_LVDSData * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned short reg , unsigned char val ) ;
...
position p;
@@
 unsigned short cocci_id@p ( struct SiS_Private * SiS_Pr ) ;
...
position p;
@@
 void cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned short yesno ) ;
...
position p;
@@
 void cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned short ModeNo , unsigned short ModeIdIndex , unsigned short RefTabindex ) ;
...
position p;
@@
 const struct SiS_LVDSDes * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct SiS_Private * SiS_Pr , unsigned char * dataptr ) ;
...
position p;
@@
 const unsigned char cocci_id@p [ 3 ] [ 64 ] ;
