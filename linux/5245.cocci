...
position p;
@@
 enum sata_rcar_type { RCAR_GEN1_SATA , RCAR_GEN2_SATA , RCAR_GEN3_SATA , RCAR_R8A7790_ES1_SATA , } cocci_id@p ;
...
position p;
@@
 enum sata_rcar_type cocci_id@p ;
...
typedef u32;
@@
 struct sata_rcar_priv {  void __iomem * base ;  u32 sataint_mask ;  enum sata_rcar_type type ; } cocci_id@p ;
...
position p;
@@
 struct sata_rcar_priv cocci_id@p ;
