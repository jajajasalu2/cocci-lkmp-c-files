...
position p;
@@
 enum { MTK_AFE_ADDA_UL_RATE_8K = 0 , MTK_AFE_ADDA_UL_RATE_16K = 1 , MTK_AFE_ADDA_UL_RATE_32K = 2 , MTK_AFE_ADDA_UL_RATE_48K = 3 , MTK_AFE_ADDA_UL_RATE_96K = 4 , MTK_AFE_ADDA_UL_RATE_192K = 5 , MTK_AFE_ADDA_UL_RATE_48K_HD = 6 , } cocci_id@p ;
...
position p;
@@
 enum { AUDIO_SDM_LEVEL_MUTE = 0 , AUDIO_SDM_LEVEL_NORMAL = 0x1d , } cocci_id@p ;
...
position p;
@@
 enum { DELAY_DATA_MISO1 = 0 , DELAY_DATA_MISO2 , } cocci_id@p ;
...
position p;
@@
 enum { SUPPLY_SEQ_ADDA_AFE_ON , SUPPLY_SEQ_ADDA_DL_ON , SUPPLY_SEQ_ADDA_UL_ON , } cocci_id@p ;
