...
typedef u32;
@@
 struct segment_desc {  union seg_flags flags ;  u32 v_base_addr ;  u32 file_offset ; } cocci_id@p ;
...
position p;
@@
 struct skl_lib_info * cocci_id@p ;
...
position p;
@@
 struct skl_ext_manifest_hdr * cocci_id@p ;
...
typedef u32,u16;
@@
 struct skl_ext_manifest_hdr {  u32 id ;  u32 len ;  u16 version_major ;  u16 version_minor ;  u32 entries ; } cocci_id@p ;
...
position p;
@@
 struct adsp_module_entry * cocci_id@p ;
