...
position p;
@@
 struct sve_state_reg_region cocci_id@p ;
...
position p;
@@
 struct sve_state_reg_region {  unsigned int koffset ;  unsigned int klen ;  unsigned int upad ; } cocci_id@p ;
...
position p;
@@
 const struct kvm_vcpu * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ KVM_ARM64_SVE_VLS_WORDS ] ;
