...
position p;
@@
 struct b43_dmadesc64 cocci_id@p ;
...
position p;
@@
 struct b43_rxhdr_fw4 * cocci_id@p ;
...
position p;
@@
 struct b43_dmadesc_meta cocci_id@p ;
...
position p;
@@
 const struct b43_dma_ops cocci_id@p ;
...
position p;
@@
 struct b43_dmadesc_generic * cocci_id@p ;
...
position p;
@@
 struct b43_private_tx_info * cocci_id@p ;
...
position p;
@@
 struct b43_dmadesc32 cocci_id@p ;
