...
typedef u32;
@@
 struct mdc_hw_list_desc {  u32 gen_conf ;  u32 readport_conf ;  u32 read_addr ;  u32 write_addr ;  u32 xfer_size ;  u32 node_addr ;  u32 cmds_done ;  u32 ctrl_status ;  struct mdc_hw_list_desc * next_desc ; } cocci_id@p ;
...
position p;
@@
 struct mdc_chan {  struct mdc_dma * mdma ;  struct virt_dma_chan vc ;  struct dma_slave_config config ;  struct mdc_tx_desc * desc ;  int irq ;  unsigned int periph ;  unsigned int thread ;  unsigned int chan_nr ; } cocci_id@p ;
...
position p;
@@
 struct mdc_hw_list_desc cocci_id@p ;
...
@@
 struct mdc_tx_desc {  struct mdc_chan * chan ;  struct virt_dma_desc vd ;  dma_addr_t list_phys ;  struct mdc_hw_list_desc * list ;  bool cyclic ;  bool cmd_loaded ;  unsigned int list_len ;  unsigned int list_period_len ;  size_t list_xfer_size ;  unsigned int list_cmds_done ; } cocci_id@p ;
...
position p;
@@
 const struct mdc_dma_soc_data cocci_id@p ;
...
position p;
@@
 struct mdc_dma_soc_data {  void ( * enable_chan ) ( struct mdc_chan * mchan ) ;  void ( * disable_chan ) ( struct mdc_chan * mchan ) ; } cocci_id@p ;
