...
typedef u8;
@@
 struct davinci_spi_of_data {  u8 version ;  u8 prescaler_limit ; } cocci_id@p ;
...
position p;
@@
 const struct davinci_spi_of_data cocci_id@p ;
...
position p;
@@
 struct davinci_spi_of_data * cocci_id@p ;
