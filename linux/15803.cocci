...
position p;
@@
 const struct v4l2_frmsize_stepwise cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ MAX_BCM2835_CAMERAS ] [ 2 ] ;
...
position p;
@@
 struct bm2835_mmal_dev * cocci_id@p [ MAX_BCM2835_CAMERAS ] ;
...
position p;
@@
 struct mmal_parameter_displayregion cocci_id@p ;
...
position p;
@@
 struct mmal_es_format_local * cocci_id@p ;
...
position p;
@@
 struct mmal_parameter_camera_config cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mmal_parameter_camera_info_t;
@@
 struct mmal_parameter_camera_info_t cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MAX_SUPPORTED_ENCODINGS ] ;
