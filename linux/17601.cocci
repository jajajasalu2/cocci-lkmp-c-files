...
position p;
@@
 long cocci_id@p ( struct mm_struct * mm , unsigned long ea ) ;
...
position p;
@@
 enum slb_index { LINEAR_INDEX = 0 , KSTACK_INDEX = 1 , } cocci_id@p ;
