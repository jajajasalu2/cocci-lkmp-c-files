...
position p;
@@
 struct rmi_function_descriptor * cocci_id@p ;
...
position p;
@@
 struct rmi_register_desc_item * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rmi_device * rmi_dev , void * ctx , const struct pdt_entry * entry ) ;
...
position p;
@@
 const struct pdt_entry * cocci_id@p ;
...
position p;
@@
 struct rmi_register_descriptor * cocci_id@p ;
...
position p;
@@
 struct rmi4_attn_data cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ RMI_PDT_ENTRY_SIZE ] ;
