...
position p;
@@
 void cocci_id@p ( struct mpt_lan_priv * priv ) ;
...
symbol cocci_id;
position p;
typedef LANReceivePostRequest_t;
@@
 LANReceivePostRequest_t * cocci_id@p ;
...
position p;
@@
 unsigned short cocci_id@p ( struct sk_buff * skb , struct net_device * dev ) ;
...
symbol cocci_id;
position p;
typedef SGETransaction32_t;
@@
 SGETransaction32_t cocci_id@p ;
...
position p;
@@
 struct mpt_lan_ohdr cocci_id@p ;
...
symbol cocci_id;
position p;
typedef LANSendReply_t;
@@
 LANSendReply_t * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( MPT_ADAPTER * ioc , MPT_FRAME_HDR * mf , MPT_FRAME_HDR * reply ) ;
...
typedef dma_addr_t;
@@
 struct BufferControl {  struct sk_buff * skb ;  dma_addr_t dma ;  unsigned int len ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * dev , int priority ) ;
...
position p;
@@
 struct mpt_lan_priv * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,spinlock_t,atomic_t;
@@
 struct mpt_lan_priv {  MPT_ADAPTER * mpt_dev ;  u8 pnum ;  atomic_t buckets_out ;  int bucketthresh ;  int * mpt_txfidx ;  int mpt_txfidx_tail ;  spinlock_t txfidx_lock ;  int * mpt_rxfidx ;  int mpt_rxfidx_tail ;  spinlock_t rxfidx_lock ;  struct BufferControl * RcvCtl ;  struct BufferControl * SendCtl ;  int max_buckets_out ;  int tx_max_out ;  u32 total_posted ;  u32 total_received ;  struct delayed_work post_buckets_task ;  struct net_device * dev ;  unsigned long post_buckets_active ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct net_device * dev , u32 tmsg ) ;
...
position p;
@@
 struct BufferControl cocci_id@p ;
...
symbol cocci_id;
position p;
typedef LANResetRequest_t;
@@
 LANResetRequest_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef LANReceivePostReply_t;
@@
 LANReceivePostReply_t * cocci_id@p ;
...
typedef u8,u16;
@@
 struct mpt_lan_ohdr {  u16 dtype ;  u8 daddr [ FC_ALEN ] ;  u16 stype ;  u8 saddr [ FC_ALEN ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef LANSendRequest_t;
@@
 LANSendRequest_t * cocci_id@p ;
