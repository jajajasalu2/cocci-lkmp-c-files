...
typedef bool;
@@
 struct fmr2 {  int io ;  struct v4l2_device v4l2_dev ;  struct snd_tea575x tea ;  struct v4l2_ctrl * volume ;  struct v4l2_ctrl * balance ;  bool is_fmd2 ; } cocci_id@p ;
...
position p;
@@
 struct fmr2 * cocci_id@p [ FMR2_MAX ] ;
