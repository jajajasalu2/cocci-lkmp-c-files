...
position p;
@@
 enum { PRIMARY_DIC = 0 , USER_DIC , COMMAND_DIC , ABBREV_DIC , } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p ( struct spk_synth * synth , const char * buf ) ;
...
position p;
@@
 void cocci_id@p ( struct spk_synth * synth ) ;
...
position p;
@@
 int cocci_id@p ( struct spk_synth * synth ) ;
