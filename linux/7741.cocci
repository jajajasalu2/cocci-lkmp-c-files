...
position p;
@@
 int cocci_id@p ( struct uart_8250_port * p ) ;
...
position p;
@@
 struct uart_8250_dma * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct uart_8250_port * p ) ;
...
symbol cocci_id;
position p;
typedef u8,bool,u32,u16,spinlock_t;
@@
 struct omap8250_priv {  int line ;  u8 habit ;  u8 mdr1 ;  u8 efr ;  u8 scr ;  u8 wer ;  u8 xon ;  u8 xoff ;  u8 delayed_restore ;  u16 quot ;  bool is_suspending ;  int wakeirq ;  int wakeups_enabled ;  u32 latency ;  u32 calc_latency ;  struct pm_qos_request pm_qos_request ;  struct work_struct qos_work ;  struct uart_8250_dma omap8250_dma ;  spinlock_t rx_dma_lock ;  bool rx_dma_broken ;  bool throttled ; } cocci_id@p ;
...
position p;
@@
 struct omap8250_priv * cocci_id@p ;
