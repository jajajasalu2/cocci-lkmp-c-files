...
position p;
@@
 enum { BYT_CHT_ES8316_INTMIC_IN1_MAP , BYT_CHT_ES8316_INTMIC_IN2_MAP , } cocci_id@p ;
...
position p;
@@
 struct byt_cht_es8316_private * cocci_id@p ;
...
typedef bool;
@@
 struct byt_cht_es8316_private {  struct clk * mclk ;  struct snd_soc_jack jack ;  struct gpio_desc * speaker_en_gpio ;  bool speaker_en ; } cocci_id@p ;
