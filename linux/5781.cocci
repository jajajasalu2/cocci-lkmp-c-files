...
position p;
@@
 struct davinci_clockevent {  struct clock_event_device dev ;  void __iomem * base ;  unsigned int cmp_off ; } cocci_id@p ;
...
position p;
@@
 struct {  struct clocksource dev ;  void __iomem * base ;  unsigned int tim_off ; } cocci_id@p ;
...
position p;
@@
 struct davinci_clockevent cocci_id@p ;
...
position p;
@@
 struct davinci_timer_cfg cocci_id@p ;
