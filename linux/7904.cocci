...
position p;
@@
 struct b53_srab_priv * cocci_id@p ;
...
position p;
@@
 struct b53_srab_port_priv * cocci_id@p ;
...
@@
 struct b53_srab_port_priv {  int irq ;  bool irq_enabled ;  struct b53_device * dev ;  unsigned int num ;  phy_interface_t mode ; } cocci_id@p ;
...
position p;
@@
 struct b53_platform_data * cocci_id@p ;
...
position p;
@@
 struct b53_srab_priv {  void __iomem * regs ;  void __iomem * mux_config ;  struct b53_srab_port_priv port_intrs [ B53_N_PORTS ] ; } cocci_id@p ;
