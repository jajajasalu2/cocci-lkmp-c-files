...
position p;
@@
 struct sti_blkmv_inptr cocci_id@p ;
...
position p;
@@
 const struct sti_init_flags cocci_id@p ;
...
position p;
@@
 struct sti_font_inptr * cocci_id@p ;
...
position p;
@@
 const struct sti_struct * cocci_id@p ;
...
position p;
@@
 struct sti_init_outptr * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct sti_cooked_rom * , int , int ) ;
...
position p;
@@
 struct sti_init_inptr * cocci_id@p ;
...
position p;
@@
 struct sti_init_inptr_ext * cocci_id@p ;
...
position p;
@@
 struct sti_all_data cocci_id@p ;
...
position p;
@@
 struct sti_conf_outptr * cocci_id@p ;
...
position p;
@@
 struct sti_cooked_rom * cocci_id@p ;
...
position p;
@@
 const struct sti_conf_flags cocci_id@p ;
...
position p;
@@
 const struct sti_blkmv_flags cocci_id@p ;
...
position p;
@@
 struct sti_conf_inptr * cocci_id@p ;
...
position p;
@@
 struct sti_rom_font cocci_id@p ;
...
position p;
@@
 const struct sti_font_flags cocci_id@p ;
...
position p;
@@
 struct sti_font_outptr * cocci_id@p ;
...
position p;
@@
 struct sti_glob_cfg * cocci_id@p ;
...
position p;
@@
 struct sti_cooked_font * cocci_id@p ;
...
position p;
@@
 struct sti_glob_cfg_ext * cocci_id@p ;
...
position p;
@@
 struct parisc_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct sti_blkmv_outptr * cocci_id@p ;
