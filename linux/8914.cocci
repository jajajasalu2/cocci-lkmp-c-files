...
position p;
@@
 struct xlgmac_pdata cocci_id@p ;
...
position p;
@@
 struct xlgmac_dma_desc * cocci_id@p ;
...
position p;
@@
 struct xlgmac_channel cocci_id@p ;
...
position p;
@@
 struct xlgmac_pkt_info * cocci_id@p ;
...
position p;
@@
 struct xlgmac_desc_data * cocci_id@p ;
...
position p;
@@
 struct xlgmac_desc_ops * cocci_id@p ;
...
position p;
@@
 struct xlgmac_stats * cocci_id@p ;
...
position p;
@@
 struct xlgmac_hw_ops * cocci_id@p ;
