...
position p;
@@
 struct snic_itmf_cmpl * cocci_id@p ;
...
position p;
@@
 struct snic_host_req * cocci_id@p ;
...
position p;
@@
 struct snic_sg_desc * cocci_id@p ;
...
position p;
@@
 struct snic_async_evnotify * cocci_id@p ;
...
position p;
@@
 struct snic_internal_io_state cocci_id@p ;
...
position p;
@@
 struct snic_misc_stats * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct snic * , int ) ;
...
position p;
@@
 struct snic_req_info * cocci_id@p ;
...
position p;
@@
 struct snic_io_stats * cocci_id@p ;
...
position p;
@@
 struct snic_icmnd_cmpl * cocci_id@p ;
...
position p;
@@
 enum snic_ioreq_state cocci_id@p ;
...
position p;
@@
 struct snic_abort_stats * cocci_id@p ;
