...
position p;
@@
 struct calling_interface_buffer * cocci_id@p ;
...
position p;
@@
 enum kbd_timeout_unit { KBD_TIMEOUT_SECONDS = 0 , KBD_TIMEOUT_MINUTES , KBD_TIMEOUT_HOURS , KBD_TIMEOUT_DAYS , } cocci_id@p ;
...
typedef u8;
@@
 struct kbd_state {  u8 mode_bit ;  u8 triggers ;  u8 timeout_value ;  u8 timeout_unit ;  u8 timeout_value_ac ;  u8 timeout_unit_ac ;  u8 als_setting ;  u8 als_value ;  u8 level ; } cocci_id@p ;
...
typedef bool;
@@
 struct quirk_entry {  bool touchpad_led ;  bool kbd_led_not_present ;  bool kbd_led_levels_off_1 ;  bool kbd_missing_ac_tag ;  bool needs_kbd_timeouts ;  int kbd_timeouts [ ] ; } cocci_id@p ;
...
position p;
@@
 enum kbd_mode_bit { KBD_MODE_BIT_OFF = 0 , KBD_MODE_BIT_ON , KBD_MODE_BIT_ALS , KBD_MODE_BIT_TRIGGER_ALS , KBD_MODE_BIT_TRIGGER , KBD_MODE_BIT_TRIGGER_25 , KBD_MODE_BIT_TRIGGER_50 , KBD_MODE_BIT_TRIGGER_75 , KBD_MODE_BIT_TRIGGER_100 , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct kbd_info {  u16 modes ;  u8 type ;  u8 triggers ;  u8 levels ;  u8 seconds ;  u8 minutes ;  u8 hours ;  u8 days ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct notifier_block * ) ;
...
position p;
@@
 struct calling_interface_token * cocci_id@p ;
