...
position p;
@@
 struct qed_queue_cid * cocci_id@p [ QED_MAX_VF_CHAINS_PER_PF ] ;
...
position p;
@@
 const struct qed_iov_hv_ops cocci_id@p ;
...
position p;
@@
 struct qed_tunn_update_type * cocci_id@p ;
...
position p;
@@
 struct qed_vf_queue_cid * cocci_id@p ;
...
position p;
@@
 struct vfpf_vport_update_activate_tlv * cocci_id@p ;
...
position p;
@@
 struct qed_iov_vf_init_params * cocci_id@p ;
...
position p;
@@
 struct tlv_buffer_size cocci_id@p ;
...
position p;
@@
 struct qed_mcp_link_params cocci_id@p ;
...
position p;
@@
 struct vfpf_ucast_filter_tlv * cocci_id@p ;
...
position p;
@@
 struct eth_mstorm_per_queue_stat cocci_id@p ;
...
position p;
@@
 struct vf_stop_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct eth_pstorm_per_queue_stat cocci_id@p ;
...
position p;
@@
 struct vf_pf_resc_request * cocci_id@p ;
...
position p;
@@
 struct qed_tunnel_info * cocci_id@p ;
...
position p;
@@
 struct qed_sp_vport_update_params * cocci_id@p ;
...
position p;
@@
 struct vfpf_update_coalesce * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ QED_VF_ARRAY_LENGTH ] ;
...
position p;
@@
 union event_ring_data * cocci_id@p ;
...
position p;
@@
 struct qed_bulletin_content * cocci_id@p ;
...
position p;
@@
 struct pfvf_read_coal_resp_tlv * cocci_id@p ;
...
position p;
@@
 struct pfvf_acquire_resp_tlv * cocci_id@p ;
...
position p;
@@
 struct qed_mcp_link_state * cocci_id@p ;
...
position p;
@@
 struct qed_vf_queue * cocci_id@p ;
...
position p;
@@
 struct vfpf_stop_txqs_tlv * cocci_id@p ;
...
position p;
@@
 struct qed_rss_params cocci_id@p ;
...
position p;
@@
 struct vf_start_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_sge_tpa_params cocci_id@p ;
...
position p;
@@
 enum qed_filter_opcode cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ MAX_NUM_VOQS_E4 ] ;
...
position p;
@@
 struct vfpf_vport_update_sge_tpa_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_vport_update_accept_param_tlv * cocci_id@p ;
...
position p;
@@
 struct mstorm_vf_zone cocci_id@p ;
...
position p;
@@
 struct vfpf_vport_update_vlan_strip_tlv * cocci_id@p ;
...
position p;
@@
 struct eth_ustorm_per_queue_stat cocci_id@p ;
...
position p;
@@
 struct vfpf_read_coal_req_tlv * cocci_id@p ;
...
position p;
@@
 struct qed_public_vf_info * cocci_id@p ;
...
position p;
@@
 struct qed_sp_init_data cocci_id@p ;
...
position p;
@@
 struct eth_rx_prod_data cocci_id@p ;
...
position p;
@@
 struct malicious_vf_eqe_data * cocci_id@p ;
...
position p;
@@
 struct qed_dmae_params cocci_id@p ;
...
position p;
@@
 struct qed_mcp_link_capabilities * cocci_id@p ;
...
position p;
@@
 enum qed_iov_vport_update_flag cocci_id@p ;
...
position p;
@@
 struct vfpf_bulletin_update_mac_tlv * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct qed_hwfn * p_hwfn , u8 * mac , int vfid ) ;
...
position p;
@@
 struct vfpf_vport_update_accept_any_vlan_tlv * cocci_id@p ;
...
position p;
@@
 enum qed_iov_validate_q_mode cocci_id@p ;
...
position p;
@@
 enum qed_iov_wq_flag cocci_id@p ;
...
position p;
@@
 struct pfvf_start_queue_resp_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_vport_update_rss_tlv * cocci_id@p ;
...
position p;
@@
 struct qed_sp_vport_start_params cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct qed_hwfn * p_hwfn , u8 opcode , __le16 echo , union event_ring_data * data , u8 fw_return_code ) ;
...
position p;
@@
 struct vfpf_vport_start_tlv * cocci_id@p ;
...
position p;
@@
 struct vf_pf_vfdev_info * cocci_id@p ;
...
position p;
@@
 struct vfpf_start_rxq_tlv * cocci_id@p ;
...
position p;
@@
 struct qed_queue_start_common_params cocci_id@p ;
...
position p;
@@
 struct vfpf_acquire_tlv * cocci_id@p ;
...
position p;
@@
 struct qed_spq_entry * cocci_id@p ;
...
position p;
@@
 struct pfvf_def_resp_tlv * cocci_id@p ;
...
position p;
@@
 struct pfvf_update_tunn_param_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_stop_rxqs_tlv * cocci_id@p ;
...
position p;
@@
 struct ustorm_vf_zone cocci_id@p ;
...
position p;
@@
 struct qed_igu_info * cocci_id@p ;
...
position p;
@@
 struct qed_hw_sriov_info * cocci_id@p ;
...
position p;
@@
 struct channel_list_end_tlv cocci_id@p ;
...
position p;
@@
 struct vfpf_qid_tlv * cocci_id@p ;
...
position p;
@@
 struct pstorm_vf_zone cocci_id@p ;
...
position p;
@@
 struct qed_filter_ucast * cocci_id@p ;
...
position p;
@@
 enum qed_filter_ucast_type cocci_id@p ;
...
position p;
@@
 struct qed_igu_block * cocci_id@p ;
...
position p;
@@
 struct vfpf_vport_update_tx_switch_tlv * cocci_id@p ;
...
position p;
@@
 struct qed_filter_accept_flags * cocci_id@p ;
...
position p;
@@
 struct cau_sb_entry cocci_id@p ;
...
position p;
@@
 enum qed_iov_validate_q_mode { QED_IOV_VALIDATE_Q_NA , QED_IOV_VALIDATE_Q_ENABLE , QED_IOV_VALIDATE_Q_DISABLE , } cocci_id@p ;
...
position p;
@@
 struct qed_wfq_data * cocci_id@p ;
...
position p;
@@
 struct qed_queue_cid * cocci_id@p ;
...
position p;
@@
 struct qed_eth_cb_ops * cocci_id@p ;
...
position p;
@@
 struct vfpf_start_txq_tlv * cocci_id@p ;
...
position p;
@@
 struct vfpf_vport_update_mcast_bin_tlv * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ VF_MAX_STATIC / 32 ] ;
...
position p;
@@
 struct pfvf_stats_info * cocci_id@p ;
...
position p;
@@
 struct vfpf_update_tunn_param_tlv * cocci_id@p ;
...
position p;
@@
 struct pf_vf_pfdev_info * cocci_id@p ;
...
position p;
@@
 struct qed_queue_cid_vf_params cocci_id@p ;
...
position p;
@@
 struct vfpf_update_rxq_tlv * cocci_id@p ;
...
position p;
@@
 struct qed_iov_vf_mbx * cocci_id@p ;
...
position p;
@@
 struct qed_tunn_update_udp_port * cocci_id@p ;
