...
position p;
@@
 enum in_index { i_input = 0 , i_max , i_min , i_num_in , } cocci_id@p ;
...
position p;
@@
 enum fan_index { f_input , f_min , f_num_fan , } cocci_id@p ;
...
typedef u8,s16,u16;
@@
 struct lm80_data {  struct i2c_client * client ;  struct mutex update_lock ;  char error ;  char valid ;  unsigned long last_updated ;  u8 in [ i_num_in ] [ 7 ] ;  u8 fan [ f_num_fan ] [ 2 ] ;  u8 fan_div [ 2 ] ;  s16 temp [ t_num_temp ] ;  u16 alarms ; } cocci_id@p ;
