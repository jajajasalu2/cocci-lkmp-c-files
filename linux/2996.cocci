...
position p;
@@
 struct extlog_l1_head * cocci_id@p ;
...
typedef u8,u64,u32;
@@
 struct extlog_l1_head {  u32 ver ;  u32 hdr_len ;  u64 total_len ;  u64 elog_base ;  u64 elog_len ;  u32 flags ;  u8 rev0 [ 12 ] ;  u32 entries ;  u8 rev1 [ 12 ] ; } cocci_id@p ;
