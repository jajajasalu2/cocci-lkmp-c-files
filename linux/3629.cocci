...
position p;
@@
 struct efi_resetsystem cocci_id@p ;
...
position p;
@@
 struct efi_queryvariableinfo cocci_id@p ;
...
@@
 efi_capsule_header_t cocci_id@p ;
...
position p;
@@
 struct efi_querycapsulecapabilities cocci_id@p ;
...
position p;
@@
 struct efi_setwakeuptime cocci_id@p ;
...
position p;
@@
 struct efi_getvariable cocci_id@p ;
...
position p;
@@
 struct efi_getnextvariablename cocci_id@p ;
...
position p;
@@
 struct efi_getwakeuptime cocci_id@p ;
...
position p;
@@
 struct efi_setvariable cocci_id@p ;
...
position p;
@@
 struct efi_getnexthighmonotoniccount cocci_id@p ;
