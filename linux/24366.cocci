...
position p;
@@
 struct crush_bucket_tree cocci_id@p ;
...
position p;
@@
 struct crush_bucket_straw2 cocci_id@p ;
...
position p;
@@
 struct ceph_pg_mapping * cocci_id@p ;
...
position p;
@@
 const struct ceph_osds * cocci_id@p ;
...
typedef bool;
@@
 struct ceph_pg_mapping * ( * cocci_id@p ) ( void * * , void * , bool ) ;
...
position p;
@@
 struct crush_choose_arg_map * cocci_id@p ;
...
position p;
@@
 struct crush_work_bucket cocci_id@p ;
...
position p;
@@
 struct crush_bucket_list * cocci_id@p ;
...
position p;
@@
 struct crush_choose_arg * cocci_id@p ;
...
position p;
@@
 struct crush_rule_step cocci_id@p ;
...
position p;
@@
 struct crush_weight_set * cocci_id@p ;
...
position p;
@@
 const struct ceph_object_id * cocci_id@p ;
...
position p;
@@
 struct crush_bucket_straw * cocci_id@p ;
...
position p;
@@
 struct crush_bucket * cocci_id@p ;
...
position p;
@@
 struct crush_bucket_uniform * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef decode_mapping_fn_t;
@@
 decode_mapping_fn_t cocci_id@p ;
