...
position p;
@@
 struct wm8739_state * cocci_id@p ;
...
position p;
@@
 enum { R0 = 0 , R1 , R5 = 5 , R6 , R7 , R8 , R9 , R15 = 15 , TOT_REGS , } cocci_id@p ;
...
typedef u32;
@@
 struct wm8739_state {  struct v4l2_subdev sd ;  struct v4l2_ctrl_handler hdl ;  struct {  struct v4l2_ctrl * volume ;  struct v4l2_ctrl * mute ;  struct v4l2_ctrl * balance ; } ;  u32 clock_freq ; } cocci_id@p ;
