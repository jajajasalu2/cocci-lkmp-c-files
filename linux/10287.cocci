...
position p;
@@
 struct rockchip_lvds * cocci_id@p ;
...
typedef bool,u32;
@@
 struct rockchip_lvds_soc_data {  u32 ch1_offset ;  int grf_soc_con6 ;  int grf_soc_con7 ;  bool has_vop_sel ; } cocci_id@p ;
...
position p;
@@
 const struct rockchip_lvds_soc_data cocci_id@p ;
...
position p;
@@
 struct rockchip_lvds {  struct device * dev ;  void __iomem * regs ;  struct regmap * grf ;  struct clk * pclk ;  const struct rockchip_lvds_soc_data * soc_data ;  int output ;  int format ;  struct drm_device * drm_dev ;  struct drm_panel * panel ;  struct drm_bridge * bridge ;  struct drm_connector connector ;  struct drm_encoder encoder ;  struct dev_pin_info * pins ; } cocci_id@p ;
