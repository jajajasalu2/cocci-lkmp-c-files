...
position p;
@@
 struct iwl_p1k_cache * cocci_id@p ;
...
position p;
@@
 struct iwl_scan_offload_profile_match_v1 cocci_id@p ;
...
position p;
@@
 struct iwl_wowlan_status * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_d3_gtk_iter_data * cocci_id@p ;
...
position p;
@@
 struct iwl_wowlan_kek_kck_material_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_wowlan_pattern_v2 cocci_id@p ;
...
typedef u8;
@@
 struct {  struct ieee80211_key_conf conf ;  u8 key [ 32 ] ; } cocci_id@p ;
...
position p;
@@
 struct iwl_scan_offload_profiles_query * cocci_id@p ;
...
position p;
@@
 struct iwl_wowlan_config_cmd cocci_id@p ;
...
position p;
@@
 union iwl_all_tsc_rsc * cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct iwl_wowlan_status_data {  u16 pattern_number ;  u16 qos_seq_ctr [ 8 ] ;  u32 wakeup_reasons ;  u32 wake_packet_length ;  u32 wake_packet_bufsize ;  const u8 * wake_packet ; } cocci_id@p ;
...
position p;
@@
 struct wowlan_key_data cocci_id@p ;
...
position p;
@@
 struct iwl_nonqos_seq_query_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_wowlan_status_data cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_nd_query_results cocci_id@p ;
...
position p;
@@
 struct iwl_scan_offload_profile_match * cocci_id@p ;
...
typedef u8,u32;
@@
 struct iwl_mvm_nd_query_results {  u32 matched_profiles ;  u8 matches [ ND_QUERY_BUF_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct iwl_wowlan_patterns_cmd_v1 * cocci_id@p ;
...
typedef u32;
@@
 struct error_table_start {  u32 valid ;  u32 error_id ; } cocci_id@p ;
...
position p;
@@
 struct iwl_scan_offload_profiles_query_v1 cocci_id@p ;
...
position p;
@@
 struct iwl_wowlan_status_v6 * cocci_id@p ;
...
position p;
@@
 struct iwl_d3_manager_config cocci_id@p ;
...
position p;
@@
 struct iwl_wowlan_patterns_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_wowlan_tkip_params_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_binding_cmd_v1 cocci_id@p ;
...
position p;
@@
 struct iwl_time_quota_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_time_quota_data * cocci_id@p ;
