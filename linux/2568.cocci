...
position p;
@@
 struct dm_block_validator cocci_id@p ;
...
position p;
@@
 struct dm_btree_value_type * cocci_id@p ;
...
position p;
@@
 struct writeset {  struct writeset_metadata md ;  unsigned long * bits ; } cocci_id@p ;
...
position p;
@@
 const struct writeset_metadata * cocci_id@p ;
...
position p;
@@
 const struct writeset_disk * cocci_id@p ;
...
position p;
@@
 struct era_metadata * cocci_id@p ;
...
position p;
@@
 struct writeset_metadata * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct era_metadata * md , struct digest * d ) ;
...
position p;
@@
 struct dm_disk_bitset * cocci_id@p ;
...
position p;
@@
 struct writeset_disk cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct era_metadata * , void * ) ;
...
symbol cocci_id;
position p;
typedef bool,__u8,dm_block_t,uint32_t;
@@
 struct era_metadata {  struct block_device * bdev ;  struct dm_block_manager * bm ;  struct dm_space_map * sm ;  struct dm_transaction_manager * tm ;  dm_block_t block_size ;  uint32_t nr_blocks ;  uint32_t current_era ;  struct writeset writesets [ 2 ] ;  struct writeset * current_writeset ;  dm_block_t writeset_tree_root ;  dm_block_t era_array_root ;  struct dm_disk_bitset bitset_info ;  struct dm_btree_info writeset_tree_info ;  struct dm_array_info era_array_info ;  dm_block_t metadata_snap ;  bool archived_writesets ;  __u8 metadata_space_map_root [ SPACE_MAP_ROOT_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct superblock_disk * cocci_id@p ;
...
position p;
@@
 struct metadata_stats cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dm_block_t,uint32_t;
@@
 struct writeset_metadata {  uint32_t nr_bits ;  dm_block_t root ; } cocci_id@p ;
...
position p;
@@
 struct dm_block_manager * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct era_metadata * ) ;
...
typedef dm_block_t,uint32_t;
@@
 struct metadata_stats {  dm_block_t used ;  dm_block_t total ;  dm_block_t snap ;  uint32_t era ; } cocci_id@p ;
