...
position p;
@@
 struct ucc_uart_pram * cocci_id@p ;
...
position p;
@@
 struct qe_firmware_info * cocci_id@p ;
...
position p;
@@
 struct ucc_slow_private * cocci_id@p ;
...
position p;
@@
 struct ucc_slow_info * cocci_id@p ;
...
position p;
@@
 struct uart_qe_port cocci_id@p ;
...
@@
 struct uart_qe_port {  struct uart_port port ;  struct ucc_slow __iomem * uccp ;  struct ucc_uart_pram __iomem * uccup ;  struct ucc_slow_info us_info ;  struct ucc_slow_private * us_private ;  struct device_node * np ;  unsigned int ucc_num ;  u16 rx_nrfifos ;  u16 rx_fifosize ;  u16 tx_nrfifos ;  u16 tx_fifosize ;  int wait_closing ;  u32 flags ;  struct qe_bd * rx_bd_base ;  struct qe_bd * rx_cur ;  struct qe_bd * tx_bd_base ;  struct qe_bd * tx_cur ;  unsigned char * tx_buf ;  unsigned char * rx_buf ;  void * bd_virt ;  dma_addr_t bd_dma_addr ;  unsigned int bd_size ; } cocci_id@p ;
