...
position p;
@@
 struct gb_fw_download_fetch_firmware_response * cocci_id@p ;
...
position p;
@@
 struct gb_fw_download_find_firmware_response * cocci_id@p ;
...
typedef u8,bool;
@@
 struct fw_request {  u8 firmware_id ;  bool disabled ;  bool timedout ;  char name [ FW_NAME_SIZE ] ;  const struct firmware * fw ;  struct list_head node ;  struct delayed_work dwork ;  unsigned long release_timeout_j ;  struct kref kref ;  struct fw_download * fw_download ; } cocci_id@p ;
...
position p;
@@
 struct gb_fw_download_release_firmware_request * cocci_id@p ;
...
position p;
@@
 struct gb_fw_download_find_firmware_request * cocci_id@p ;
...
position p;
@@
 struct gb_fw_download_fetch_firmware_request * cocci_id@p ;
...
position p;
@@
 struct fw_download {  struct device * parent ;  struct gb_connection * connection ;  struct list_head fw_requests ;  struct ida id_map ;  struct mutex mutex ; } cocci_id@p ;
