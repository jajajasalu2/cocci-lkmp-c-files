...
position p;
@@
 struct cper_ia_err_info * cocci_id@p ;
...
position p;
@@
 struct cper_ia_proc_ctx * cocci_id@p ;
...
position p;
@@
 const struct cper_sec_proc_ia * cocci_id@p ;
...
position p;
@@
 enum err_types { ERR_TYPE_CACHE = 0 , ERR_TYPE_TLB , ERR_TYPE_BUS , ERR_TYPE_MS , N_ERR_TYPES , } cocci_id@p ;
