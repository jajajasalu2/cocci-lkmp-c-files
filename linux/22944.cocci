...
symbol cocci_id;
position p;
typedef snd_use_lock_t;
@@
 struct seq_oss_midi {  int seq_device ;  int client ;  int port ;  unsigned int flags ;  int opened ;  unsigned char name [ SNDRV_SEQ_OSS_MAX_MIDI_NAME ] ;  struct snd_midi_event * coder ;  struct seq_oss_devinfo * devinfo ;  snd_use_lock_t use_lock ; } cocci_id@p ;
...
position p;
@@
 struct seq_oss_midi * cocci_id@p ;
...
position p;
@@
 struct seq_oss_midi * cocci_id@p [ SNDRV_SEQ_OSS_MAX_MIDI_DEVS ] ;
...
position p;
@@
 struct seq_oss_devinfo * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct seq_oss_devinfo * dp , struct snd_seq_event * ev , struct seq_oss_midi * mdev ) ;
...
position p;
@@
 struct seq_oss_midi * cocci_id@p ( int dev ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_oss_devinfo * dp , struct snd_seq_event * ev , int dev ) ;
...
position p;
@@
 struct seq_oss_midi * cocci_id@p ( struct seq_oss_devinfo * dp , int dev ) ;
