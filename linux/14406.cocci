...
typedef u32,u16;
@@
 struct lgdt330x_state {  struct i2c_client * client ;  struct lgdt330x_config config ;  struct dvb_frontend frontend ;  enum fe_modulation current_modulation ;  u32 snr ;  u16 ucblocks ;  unsigned long last_stats_time ;  u32 current_frequency ; } cocci_id@p ;
...
position p;
@@
 struct lgdt330x_state * cocci_id@p ;
