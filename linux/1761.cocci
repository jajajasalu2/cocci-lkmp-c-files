...
position p;
@@
 const struct {  int shift ;  int mask ; } cocci_id@p [ 2 ] ;
...
typedef u16;
@@
 struct hdc100x_data {  struct i2c_client * client ;  struct mutex lock ;  u16 config ;  int adc_int_us [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct hdc100x_data * cocci_id@p ;
