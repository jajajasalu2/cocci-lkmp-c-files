...
position p;
@@
 struct ax25_ctl_struct cocci_id@p ;
...
position p;
@@
 struct ax25_info_struct_deprecated cocci_id@p ;
...
position p;
@@
 struct full_sockaddr_ax25 * cocci_id@p ;
...
position p;
@@
 struct ax25_info_struct cocci_id@p ;
...
position p;
@@
 struct ax25_fwd_struct cocci_id@p ;
