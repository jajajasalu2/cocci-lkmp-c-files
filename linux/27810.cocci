...
position p;
@@
 struct ocfs2_blockcheck_stats cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ OCFS2_MAXQUOTAS ] ;
...
position p;
@@
 struct ocfs2_quota_chunk cocci_id@p ;
...
position p;
@@
 struct mount_options {  unsigned long commit_interval ;  unsigned long mount_opt ;  unsigned int atime_quantum ;  signed short slot ;  int localalloc_opt ;  unsigned int resv_level ;  int dir_resv_level ;  char cluster_stack [ OCFS2_STACK_LABEL_LEN + 1 ] ; } cocci_id@p ;
...
position p;
@@
 struct ocfs1_vol_disk_hdr * cocci_id@p ;
...
position p;
@@
 struct mount_options * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ocfs2_super * osb , int unsuspend ) ;
...
position p;
@@
 struct inode * cocci_id@p [ OCFS2_MAXQUOTAS ] ;
...
position p;
@@
 void cocci_id@p ( struct super_block * sb , int mnt_err ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , struct mount_options * options ) ;
...
position p;
@@
 void cocci_id@p ( struct inode * inode ) ;
...
position p;
@@
 int cocci_id@p ( struct seq_file * s , struct dentry * root ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , struct buffer_head * * bh , int block , int sect_size ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , struct buffer_head * bh , int sector_size , struct ocfs2_blockcheck_stats * stats ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct ocfs2_dinode * di , struct buffer_head * bh , u32 sectsize , struct ocfs2_blockcheck_stats * stats ) ;
...
position p;
@@
 int cocci_id@p ( struct super_block * sb , char * options , struct mount_options * mopt , int is_remount ) ;
...
position p;
@@
 struct inode * cocci_id@p ( struct super_block * sb ) ;
