...
position p;
@@
 struct greybus_descriptor_interface cocci_id@p ;
...
position p;
@@
 struct greybus_descriptor_string cocci_id@p ;
...
position p;
@@
 struct manifest_desc {  struct list_head links ;  size_t size ;  void * data ;  enum greybus_descriptor_type type ; } cocci_id@p ;
...
position p;
@@
 struct greybus_manifest_header * cocci_id@p ;
...
position p;
@@
 struct greybus_descriptor_header * cocci_id@p ;
...
position p;
@@
 struct manifest_desc * cocci_id@p ;
...
position p;
@@
 struct greybus_descriptor_bundle cocci_id@p ;
...
position p;
@@
 struct greybus_manifest * cocci_id@p ;
...
position p;
@@
 struct greybus_descriptor * cocci_id@p ;
