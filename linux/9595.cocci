...
position p;
@@
 struct brcmf_pktcnt_le cocci_id@p ;
...
typedef __le32;
@@
 struct {  __le32 len ;  struct brcmf_bss_info_le bss_le ; } * cocci_id@p ;
...
position p;
@@
 struct brcmf_escan_result_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_ext_join_params_le cocci_id@p ;
...
position p;
@@
 const struct cfg80211_pmk_conf * cocci_id@p ;
...
position p;
@@
 struct brcmf_chanspec_list * cocci_id@p ;
...
position p;
@@
 struct brcmf_cfg80211_vif_event * cocci_id@p ;
...
position p;
@@
 struct brcmf_join_params cocci_id@p ;
...
position p;
@@
 struct brcmf_scan_results * cocci_id@p ;
...
position p;
@@
 struct brcmf_join_pref_params cocci_id@p [ 2 ] ;
...
position p;
@@
 struct brcmf_fil_country_le cocci_id@p ;
...
position p;
@@
 struct brcmf_tdls_iovar_le cocci_id@p ;
...
position p;
@@
 struct brcmf_cfg80211_conf * cocci_id@p ;
...
position p;
@@
 struct brcmf_scan_params_le * cocci_id@p ;
...
position p;
@@
 struct cfg80211_ops * cocci_id@p ;
...
position p;
@@
 enum nl80211_chan_width cocci_id@p ;
...
typedef u32;
@@
 struct parsed_vndr_ies {  u32 count ;  struct parsed_vndr_ie_info ie_info [ VNDR_IE_PARSE_LIMIT ] ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_if_event * cocci_id@p ;
...
position p;
@@
 const struct brcmf_vs_tlv * cocci_id@p ;
...
position p;
@@
 struct brcmf_wsec_key_le cocci_id@p ;
...
position p;
@@
 struct brcmf_sta_info_le cocci_id@p ;
...
position p;
@@
 struct brcmf_fil_af_params_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_escan_params_le cocci_id@p ;
...
position p;
@@
 struct brcmf_cfg80211_info cocci_id@p ;
...
position p;
@@
 struct brcmf_cfg80211_profile * cocci_id@p ;
...
position p;
@@
 struct brcmf_pno_scanresults_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_pno_scanresults_v2_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_fil_bwcap_le cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * cookie , struct key_params * params ) ;
...
position p;
@@
 struct brcmf_assoc_params_le cocci_id@p ;
...
position p;
@@
 struct brcmf_pmk_list_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_wsec_sae_pwd_le cocci_id@p ;
...
position p;
@@
 struct brcmf_cfg80211_vif * cocci_id@p ;
...
position p;
@@
 struct brcmfmac_pd_cc * cocci_id@p ;
...
position p;
@@
 struct iface_combination_params cocci_id@p ;
...
position p;
@@
 struct parsed_vndr_ies * cocci_id@p ;
...
position p;
@@
 const struct brcmf_tlv * cocci_id@p ;
...
position p;
@@
 enum ieee80211_vht_mcs_support cocci_id@p ;
...
position p;
@@
 struct brcmf_fil_bss_enable_le cocci_id@p ;
...
position p;
@@
 struct brcmf_scb_val_le cocci_id@p ;
...
typedef u8,u32;
@@
 struct parsed_vndr_ie_info {  u8 * ie_ptr ;  u32 ie_len ;  struct brcmf_vs_tlv vndrie ; } cocci_id@p ;
...
position p;
@@
 struct brcmu_d11inf * cocci_id@p ;
...
position p;
@@
 struct brcmf_cfg80211_connect_info * cocci_id@p ;
...
position p;
@@
 struct brcmf_cfg80211_assoc_ielen_le * cocci_id@p ;
...
position p;
@@
 struct brcmfmac_pd_cc_entry * cocci_id@p ;
...
position p;
@@
 struct brcmf_mp_device * cocci_id@p ;
...
typedef u8;
@@
 struct brcmf_vs_tlv {  u8 id ;  u8 len ;  u8 oui [ 3 ] ;  u8 oui_type ; } cocci_id@p ;
...
position p;
@@
 struct brcmf_mbss_ssid_le cocci_id@p ;
...
position p;
@@
 struct brcmf_cfg80211_security * cocci_id@p ;
...
position p;
@@
 struct brcmf_vs_tlv * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_txrx_stypes cocci_id@p [ NUM_NL80211_IFTYPES ] ;
...
position p;
@@
 struct brcmf_pno_net_info_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_wsec_pmk_le cocci_id@p ;
...
position p;
@@
 struct brcmf_fil_wowl_pattern_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_wsec_key * cocci_id@p ;
...
position p;
@@
 struct brcmf_wowl_wakeind_le cocci_id@p ;
...
position p;
@@
 struct vif_saved_ie * cocci_id@p ;
...
position p;
@@
 struct brcmf_bss_info_le * cocci_id@p ;
...
position p;
@@
 struct brcmf_fil_action_frame_le * cocci_id@p ;
...
position p;
@@
 struct parsed_vndr_ie_info * cocci_id@p ;
...
position p;
@@
 struct brcmf_gtk_keyinfo_le cocci_id@p ;
...
position p;
@@
 struct brcmf_ssid_le cocci_id@p ;
