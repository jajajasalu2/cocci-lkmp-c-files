...
typedef u8;
@@
 u8 cocci_id@p [ AQ_HW_MULTICAST_ADDRESS_MAX ] [ ETH_ALEN ] ;
...
position p;
@@
 struct hw_fw_request_ptp_adj_freq * cocci_id@p ;
...
position p;
@@
 struct hw_atl_txd_s * cocci_id@p ;
...
position p;
@@
 struct hw_atl_rxd_s * cocci_id@p ;
...
position p;
@@
 struct hw_atl_rxd_wb_s * cocci_id@p ;
...
position p;
@@
 struct aq_ring_param_s * cocci_id@p ;
...
position p;
@@
 struct aq_ring_buff_s * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ 1 + ( HW_ATL_B0_RSS_REDIRECTION_MAX * HW_ATL_B0_RSS_REDIRECTION_BITS / 16U ) ] ;
...
position p;
@@
 struct aq_rx_filter_l3l4 * cocci_id@p ;
...
position p;
@@
 struct aq_rx_filter_l2 * cocci_id@p ;
...
position p;
@@
 const struct aq_hw_caps_s cocci_id@p ;
...
position p;
@@
 struct aq_rx_filter_vlan * cocci_id@p ;
...
position p;
@@
 struct aq_rss_parameters * cocci_id@p ;
...
position p;
@@
 struct hw_fw_request_iface cocci_id@p ;
...
position p;
@@
 struct hw_atl_rxd_hwts_wb_s * cocci_id@p ;
