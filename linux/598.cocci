...
position p;
@@
 const struct data_directory * cocci_id@p ;
...
position p;
@@
 const struct section_header * cocci_id@p ;
...
position p;
@@
 const struct pe32plus_opt_hdr * cocci_id@p ;
...
position p;
@@
 enum key_being_used_for cocci_id@p ;
...
position p;
@@
 const struct pe_hdr * cocci_id@p ;
...
position p;
@@
 struct win_certificate cocci_id@p ;
...
position p;
@@
 const struct mz_hdr * cocci_id@p ;
...
position p;
@@
 struct pefile_context cocci_id@p ;
...
position p;
@@
 const struct data_dirent * cocci_id@p ;
...
position p;
@@
 const struct pe32_opt_hdr * cocci_id@p ;
