...
position p;
@@
 struct tstorm_fcoe_task_st_ctx * cocci_id@p ;
...
position p;
@@
 struct e4_ustorm_fcoe_task_ag_ctx * cocci_id@p ;
...
position p;
@@
 struct fcoe_fcp_cmd_payload cocci_id@p ;
...
position p;
@@
 enum fcoe_sqe_request_type cocci_id@p ;
...
position p;
@@
 struct ystorm_fcoe_task_st_ctx * cocci_id@p ;
...
position p;
@@
 struct mstorm_fcoe_task_st_ctx * cocci_id@p ;
