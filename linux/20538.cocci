...
position p;
@@
 struct simd_skcipher_alg * cocci_id@p [ ARRAY_SIZE ( cast5_algs ) ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ CAST5_BLOCK_SIZE ] ;
...
typedef u8,__be64;
@@
 void cocci_id@p ( struct cast5_ctx * ctx , u8 * dst , const u8 * src , __be64 * iv ) ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( struct cast5_ctx * ctx , u8 * dst , const u8 * src ) ;
