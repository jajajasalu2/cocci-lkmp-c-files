...
typedef u_int16_t;
@@
 u_int16_t cocci_id@p [ MAX_PORTS ] ;
...
position p;
@@
 typeof ( nf_nat_ftp_hook ) cocci_id@p ;
...
position p;
@@
 struct nf_ct_ftp_master * cocci_id@p ;
...
position p;
@@
 struct nf_conntrack_man cocci_id@p ;
...
position p;
@@
 const struct nf_ct_ftp_master * cocci_id@p ;
...
position p;
@@
 unsigned int ( * cocci_id@p ) ( struct sk_buff * skb , enum ip_conntrack_info ctinfo , enum nf_ct_ftp_type type , unsigned int protoff , unsigned int matchoff , unsigned int matchlen , struct nf_conntrack_expect * exp ) ;
