...
position p;
@@
 const struct iio_chan_spec cocci_id@p [ 8 ] ;
...
position p;
@@
 struct ep93xx_adc_priv {  struct clk * clk ;  void __iomem * base ;  int lastch ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct ep93xx_adc_priv * cocci_id@p ;
