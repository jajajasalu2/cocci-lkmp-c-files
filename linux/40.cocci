...
position p;
@@
 struct register_pass_info cocci_id@p ;
...
position p;
@@
 struct attribute_spec cocci_id@p ;
...
position p;
@@
 const struct whitelist_entry cocci_id@p [ ] ;
...
position p;
@@
 struct varpool_node * cocci_id@p ;
...
position p;
@@
 gimple_stmt_iterator cocci_id@p ;
...
position p;
@@
 struct partition_group cocci_id@p ;
...
position p;
@@
 const struct plugin_argument * const cocci_id@p ;
...
position p;
@@
 struct plugin_gcc_version * cocci_id@p ;
...
typedef u64;
@@
 struct ranctx {  u64 a ;  u64 b ;  u64 c ;  u64 d ; } cocci_id@p ;
...
position p;
@@
 struct partition_group {  tree tree_start ;  unsigned long start ;  unsigned long length ; } cocci_id@p ;
...
position p;
@@
 struct partition_group cocci_id@p [ length ] ;
...
position p;
@@
 struct whitelist_entry {  const char * pathname ;  const char * lhs ;  const char * rhs ; } cocci_id@p ;
...
position p;
@@
 struct plugin_name_args * cocci_id@p ;
