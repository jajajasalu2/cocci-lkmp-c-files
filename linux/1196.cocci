...
typedef u32;
@@
 union {  struct usb_ctrlrequest r ;  u32 data [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct isp1760_request {  struct usb_request req ;  struct list_head queue ;  struct isp1760_ep * ep ;  unsigned int packet_size ; } cocci_id@p ;
...
position p;
@@
 struct isp1760_request cocci_id@p ;
...
position p;
@@
 struct isp1760_device * cocci_id@p ;
