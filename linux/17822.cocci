...
symbol cocci_id;
position p;
typedef pfm_default_smpl_arg_t;
@@
 pfm_default_smpl_arg_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pfm_default_smpl_entry_t;
@@
 pfm_default_smpl_entry_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pfm_default_smpl_hdr_t;
@@
 pfm_default_smpl_hdr_t * cocci_id@p ;
