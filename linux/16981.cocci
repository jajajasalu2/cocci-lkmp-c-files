...
position p;
@@
 struct surface3_ts_data_finger * cocci_id@p ;
...
position p;
@@
 struct surface3_ts_data_pen * cocci_id@p ;
...
typedef u8;
@@
 struct surface3_ts_data {  struct spi_device * spi ;  struct gpio_desc * gpiod_rst [ 2 ] ;  struct input_dev * input_dev ;  struct input_dev * pen_input_dev ;  int pen_tool ;  u8 rd_buf [ SURFACE3_PACKET_SIZE ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct surface3_ts_data * cocci_id@p ;
