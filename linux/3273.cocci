...
position p;
@@
 struct via_cputemp_data * cocci_id@p ;
...
position p;
@@
 enum { SHOW_TEMP , SHOW_LABEL , SHOW_NAME , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct via_cputemp_data {  struct device * hwmon_dev ;  const char * name ;  u8 vrm ;  u32 id ;  u32 msr_temp ;  u32 msr_vid ; } cocci_id@p ;
...
position p;
@@
 struct pdev_entry {  struct list_head list ;  struct platform_device * pdev ;  unsigned int cpu ; } cocci_id@p ;
