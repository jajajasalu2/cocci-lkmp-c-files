...
position p;
@@
 enum da7213_dmic_data_sel cocci_id@p ;
...
position p;
@@
 const  cocci_id@p ( digital_gain_tlv , 
							   0x0 , 0x07 , 
...
position p;
@@
 const  cocci_id@p ( alc_analog_gain_tlv , 
							   0x0 , 0x0 , 
							   TLV_DB_SCALE_ITEM ( TLV_DB_GAIN_MUTE , 0 , 1 ) , 
...
position p;
@@
 enum da7213_dmic_samplephase cocci_id@p ;
...
position p;
@@
 enum da7213_micbias_voltage cocci_id@p ;
...
position p;
@@
 struct da7213_platform_data * cocci_id@p ;
...
position p;
@@
 enum da7213_dmic_clk_rate cocci_id@p ;
