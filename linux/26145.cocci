...
position p;
@@
 void ( * cocci_id@p ) ( unsigned int insns , int fd ) ;
...
position p;
@@
 const struct sockaddr_alg cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( unsigned int insns , int fd_map ) ;
...
position p;
@@
 struct bpf_insn cocci_id@p [ BPF_MAXINSNS ] ;
