...
position p;
@@
 struct knav_dma_desc * cocci_id@p ;
...
position p;
@@
 struct netcp_tx_cb {  void * ts_context ;  void ( * txtstamp ) ( void * context , struct sk_buff * skb ) ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ KNAV_DMA_FDQ_PER_CHAN ] ;
...
position p;
@@
 struct netcp_hook_list * cocci_id@p ;
...
position p;
@@
 struct netcp_intf_modpriv {  struct netcp_intf * netcp_priv ;  struct netcp_module * netcp_module ;  struct list_head intf_list ;  void * module_priv ; } cocci_id@p ;
...
position p;
@@
 struct knav_dma_cfg cocci_id@p ;
...
position p;
@@
 struct netcp_device {  struct list_head device_list ;  struct list_head interface_head ;  struct list_head modpriv_head ;  struct device * device ; } cocci_id@p ;
...
position p;
@@
 struct netcp_hook_list {  struct list_head list ;  netcp_hook_rtn * hook_rtn ;  void * hook_data ;  int order ; } cocci_id@p ;
...
position p;
@@
 struct netcp_inst_modpriv * cocci_id@p ;
...
position p;
@@
 struct netcp_tx_pipe * cocci_id@p ;
...
position p;
@@
 enum netcp_addr_type cocci_id@p ;
...
position p;
@@
 struct knav_queue_notify_config cocci_id@p ;
...
position p;
@@
 struct netcp_inst_modpriv {  struct netcp_device * netcp_device ;  struct netcp_module * netcp_module ;  struct list_head inst_list ;  void * module_priv ; } cocci_id@p ;
...
position p;
@@
 struct netcp_intf_modpriv * cocci_id@p ;
