...
typedef u32;
@@
 struct pcm20 {  struct v4l2_device v4l2_dev ;  struct video_device vdev ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_ctrl * rds_pty ;  struct v4l2_ctrl * rds_ps_name ;  struct v4l2_ctrl * rds_radio_test ;  struct v4l2_ctrl * rds_ta ;  struct v4l2_ctrl * rds_tp ;  struct v4l2_ctrl * rds_ms ;  struct task_struct * kthread ;  unsigned long freq ;  u32 audmode ;  struct snd_miro_aci * aci ;  struct mutex lock ; } cocci_id@p ;
