...
position p;
@@
 struct ppp_deflate_state * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( void * state , unsigned char * options , int opt_len , int unit , int hdrlen , int mru , int debug ) ;
...
position p;
@@
 int cocci_id@p ( void * state , unsigned char * options , int opt_len , int unit , int hdrlen , int debug ) ;
...
position p;
@@
 struct ppp_deflate_state {  int seqno ;  int w_size ;  int unit ;  int mru ;  int debug ;  z_stream strm ;  struct compstat stats ; } cocci_id@p ;
