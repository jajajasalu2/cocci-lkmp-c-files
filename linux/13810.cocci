...
position p;
@@
 enum s5k4ecgx_gpio_id { STBY , RST , GPIO_NUM , } cocci_id@p ;
...
position p;
@@
 const struct s5k4ecgx_pixfmt * cocci_id@p ;
...
typedef u8;
@@
 struct s5k4ecgx {  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_ctrl_handler handler ;  struct s5k4ecgx_platform_data * pdata ;  const struct s5k4ecgx_pixfmt * curr_pixfmt ;  const struct s5k4ecgx_frmsize * curr_frmsize ;  struct mutex lock ;  u8 streaming ;  u8 set_params ;  struct regulator_bulk_data supplies [ S5K4ECGX_NUM_SUPPLIES ] ;  struct s5k4ecgx_gpio gpio [ GPIO_NUM ] ; } cocci_id@p ;
...
position p;
@@
 const struct s5k4ecgx_frmsize cocci_id@p [ ] ;
...
position p;
@@
 const struct s5k4ecgx_gpio * cocci_id@p ;
...
position p;
@@
 struct s5k4ecgx_platform_data * cocci_id@p ;
...
position p;
@@
 struct s5k4ecgx_frmsize {  struct v4l2_frmsize_discrete size ;  struct v4l2_rect input_window ; } cocci_id@p ;
...
position p;
@@
 const struct s5k4ecgx_platform_data * cocci_id@p ;
...
typedef u32,u16;
@@
 struct regval_list {  u32 addr ;  u16 val ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct s5k4ecgx_pixfmt {  u32 code ;  u32 colorspace ;  u16 reg_p_format ; } cocci_id@p ;
