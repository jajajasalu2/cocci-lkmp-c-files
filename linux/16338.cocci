...
position p;
@@
 struct comp_channel cocci_id@p ;
...
typedef dev_t;
@@
 struct cdev_component {  dev_t devno ;  struct ida minor_id ;  unsigned int major ;  struct class * class ;  struct core_component cc ; } cocci_id@p ;
...
position p;
@@
 struct cdev_component cocci_id@p ;
