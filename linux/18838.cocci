...
position p;
@@
 struct plat_lcd_data * cocci_id@p ;
...
position p;
@@
 struct max1586_subdev_data cocci_id@p ;
...
position p;
@@
 struct asic3_led cocci_id@p [ ASIC3_NUM_LEDS ] ;
...
position p;
@@
 struct pxa2xx_udc_mach_info cocci_id@p ;
...
position p;
@@
 struct pda_power_pdata cocci_id@p ;
...
position p;
@@
 struct gpio_vbus_mach_info cocci_id@p ;
...
position p;
@@
 struct gpio_regulator_state cocci_id@p [ ] ;
...
position p;
@@
 struct ak4641_platform_data cocci_id@p ;
...
position p;
@@
 struct htc_egpio_platform_data cocci_id@p ;
...
position p;
@@
 struct pxa2xx_spi_chip cocci_id@p ;
...
position p;
@@
 struct gpio_regulator_config cocci_id@p ;
...
position p;
@@
 struct asic3_platform_data cocci_id@p ;
...
position p;
@@
 struct pxa2xx_spi_controller cocci_id@p ;
...
position p;
@@
 struct platform_pwm_backlight_data cocci_id@p ;
...
position p;
@@
 const struct ads7846_platform_data cocci_id@p ;
...
position p;
@@
 struct navpoint_platform_data cocci_id@p ;
...
position p;
@@
 struct pxaficp_platform_data cocci_id@p ;
...
position p;
@@
 struct max1586_platform_data cocci_id@p ;
...
position p;
@@
 struct htc_egpio_chip cocci_id@p [ ] ;
