...
position p;
@@
 struct lp55xx_engine * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ LP5523_PROGRAM_LENGTH ] ;
...
position p;
@@
 char cocci_id@p [ LP5523_MAX_LEDS + 1 ] ;
...
position p;
@@
 struct lp55xx_platform_data * cocci_id@p ;
...
position p;
@@
 enum lp5523_chip_id { LP5523 , LP55231 , } cocci_id@p ;
...
position p;
@@
 struct lp55xx_device_config cocci_id@p ;
...
position p;
@@
 enum lp55xx_engine_mode cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct lp55xx_chip * chip ) ;
...
position p;
@@
 enum lp55xx_engine_index cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ ] [ LP5523_PROGRAM_LENGTH ] ;
