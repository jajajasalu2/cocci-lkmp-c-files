...
@@
 struct xusb_ep {  struct usb_ep ep_usb ;  struct list_head queue ;  struct xusb_udc * udc ;  const struct usb_endpoint_descriptor * desc ;  u32 rambase ;  u32 offset ;  char name [ 4 ] ;  u16 epnumber ;  u16 maxpacket ;  u16 buffer0count ;  u16 buffer1count ;  u8 curbufnum ;  bool buffer0ready ;  bool buffer1ready ;  bool is_in ;  bool is_iso ; } cocci_id@p ;
...
position p;
@@
 struct xusb_req {  struct usb_request usb_req ;  struct list_head queue ;  struct xusb_ep * ep ; } cocci_id@p ;
