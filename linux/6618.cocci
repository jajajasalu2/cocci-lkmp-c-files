...
symbol cocci_id;
position p;
typedef bfa_fcxp_get_sgaddr_t;
@@
 bfa_fcxp_get_sgaddr_t * cocci_id@p ;
...
position p;
@@
 struct bfi_lps_cvl_event_s * cocci_id@p ;
...
position p;
@@
 union bfa_fcport_stats_u * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct bfa_lps_s * first_lps , u8 count ) ;
...
position p;
@@
 struct bfa_fcxp_wqe_s * cocci_id@p ;
...
position p;
@@
 struct bfi_uf_buf_post_s * cocci_id@p ;
...
position p;
@@
 struct bfa_fcs_rport_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcport_s * fcport , enum bfa_fcport_sm_event event ) ;
...
position p;
@@
 struct bfa_lps_mod_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_fcxp_alloc_cbfn_t;
@@
 bfa_fcxp_alloc_cbfn_t cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ BFA_PL_INT_LOG_SZ ] ;
...
position p;
@@
 union bfi_fcport_i2h_msg_u cocci_id@p ;
...
position p;
@@
 struct bfi_fcxp_send_rsp_s * cocci_id@p ;
...
position p;
@@
 struct bfi_diag_dport_rsp_s * cocci_id@p ;
...
position p;
@@
 struct bfa_port_attr_s cocci_id@p ;
...
position p;
@@
 struct bfa_mem_dma_s * cocci_id@p ;
...
position p;
@@
 struct bfi_rport_create_req_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_cb_uf_recv_t;
@@
 bfa_cb_uf_recv_t cocci_id@p ;
...
position p;
@@
 struct bfi_uf_frm_rcvd_s * cocci_id@p ;
...
position p;
@@
 struct bfi_lps_logout_req_s * cocci_id@p ;
...
position p;
@@
 union bfi_rport_i2h_msg_u cocci_id@p ;
...
position p;
@@
 struct bfa_fcxp_rsp_info_s * cocci_id@p ;
...
position p;
@@
 struct bfi_fcport_req_s cocci_id@p ;
...
position p;
@@
 struct bfa_uf_buf_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_fcxp_get_sglen_t;
@@
 bfa_fcxp_get_sglen_t cocci_id@p ;
...
position p;
@@
 struct bfa_plog_rec_s cocci_id@p ;
...
position p;
@@
 struct bfa_diag_qtest_result_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcport_ln_s * ln , enum bfa_port_linkstate event ) ;
...
typedef bfa_boolean_t;
@@
 bfa_boolean_t cocci_id@p ( struct bfa_fcport_s * fcport ) ;
...
position p;
@@
 struct bfa_sgpg_mod_s * cocci_id@p ;
...
position p;
@@
 struct bfa_diag_loopback_result_s * cocci_id@p ;
...
position p;
@@
 struct bfa_qos_stats_s * cocci_id@p ;
...
position p;
@@
 enum bfa_port_linkstate cocci_id@p ;
...
position p;
@@
 struct bfi_fcport_enable_req_s * cocci_id@p ;
...
position p;
@@
 struct bfi_lps_logout_rsp_s * cocci_id@p ;
...
position p;
@@
 struct bfa_sgpg_wqe_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_rport_s * rport ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_s * bfa , struct bfi_lps_logout_rsp_s * rsp ) ;
...
position p;
@@
 enum bfa_dport_test_state_e { BFA_DPORT_ST_DISABLED = 0 , BFA_DPORT_ST_INP = 1 , BFA_DPORT_ST_COMP = 2 , BFA_DPORT_ST_NO_SFP = 3 , BFA_DPORT_ST_NOTSTART = 4 , } cocci_id@p ;
...
position p;
@@
 struct bfi_iocfc_cfgrsp_s * cocci_id@p ;
...
position p;
@@
 enum bfa_trunk_state cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcxp_s * fcxp , struct bfi_fcxp_send_req_s * send_req ) ;
...
position p;
@@
 enum bfa_fcport_ln_sm_event cocci_id@p ;
...
position p;
@@
 struct bfa_bbcr_attr_s * cocci_id@p ;
...
position p;
@@
 struct bfa_diag_loopback_s * cocci_id@p ;
...
position p;
@@
 enum bfa_fcport_ln_sm_event { BFA_FCPORT_LN_SM_LINKUP = 1 , BFA_FCPORT_LN_SM_LINKDOWN = 2 , BFA_FCPORT_LN_SM_NOTIFICATION = 3 , } cocci_id@p ;
...
position p;
@@
 struct bfa_fcdiag_s * cocci_id@p ;
...
position p;
@@
 struct bfa_fcport_loop_info_s * cocci_id@p ;
...
position p;
@@
 enum bfa_port_topology cocci_id@p ;
...
position p;
@@
 struct bfi_rport_qos_scn_s * cocci_id@p ;
...
position p;
@@
 struct bfa_rport_speed_req_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_s * bfa , struct bfa_fcxp_s * fcxp , struct bfi_fcxp_send_rsp_s * fcxp_rsp ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_lps_s * lps , enum bfa_lps_event event ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_s * bfa , struct bfi_lps_login_rsp_s * rsp ) ;
...
position p;
@@
 enum bfa_dport_sm_event cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct bfa_s * bfa , u32 reqlen , struct bfa_fcxp_s * fcxp , struct fchs_s * fchs ) ;
...
position p;
@@
 struct bfa_uf_mod_s * cocci_id@p ;
...
position p;
@@
 struct bfi_fcport_trunk_link_s * cocci_id@p ;
...
position p;
@@
 struct bfa_fcport_trunk_s * cocci_id@p ;
...
position p;
@@
 struct bfi_diag_dport_req_s * cocci_id@p ;
...
position p;
@@
 enum bfa_fcport_sm_event cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcport_ln_s * ln , enum bfa_fcport_ln_sm_event event ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_lps_s * lps ) ;
...
position p;
@@
 struct bfi_fcxp_send_req_s * cocci_id@p ;
...
position p;
@@
 struct bfi_diag_lb_req_s * cocci_id@p ;
...
position p;
@@
 struct bfa_fcxp_mod_s * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( void * cbarg , enum bfa_port_linkstate event ) ;
...
position p;
@@
 struct bfa_fcport_ln_s * cocci_id@p ;
...
position p;
@@
 struct bfa_port_cfg_s cocci_id@p ;
...
position p;
@@
 struct bfi_diag_lb_rsp_s * cocci_id@p ;
...
position p;
@@
 struct bfa_diag_dport_result_s cocci_id@p ;
...
position p;
@@
 union bfi_lps_i2h_msg_u cocci_id@p ;
...
position p;
@@
 struct bfa_trunk_link_attr_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfi_diag_qtest_rsp_t;
@@
 bfi_diag_qtest_rsp_t * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_dport_s * dport , struct bfi_diag_dport_scn_s * msg ) ;
...
position p;
@@
 struct bfi_diag_qtest_req_s * cocci_id@p ;
...
position p;
@@
 struct bfa_fcoe_stats_s cocci_id@p ;
...
position p;
@@
 struct bfa_rport_s * cocci_id@p ( struct bfa_rport_mod_s * rp_mod ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_dport_s * dport , enum bfa_dport_sm_event event ) ;
...
position p;
@@
 struct bfi_lps_login_rsp_s * cocci_id@p ;
...
position p;
@@
 struct bfi_lps_login_req_s * cocci_id@p ;
...
position p;
@@
 enum bfa_rport_event cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_dport_s * dport , struct bfi_diag_dport_rsp_s * msg ) ;
...
position p;
@@
 struct bfa_cb_pending_q_s * cocci_id@p ;
...
position p;
@@
 struct bfa_rport_mod_s * cocci_id@p ;
...
position p;
@@
 struct bfi_fcport_trunk_scn_s * cocci_id@p ;
...
position p;
@@
 struct bfa_fcxp_req_info_s * cocci_id@p ;
...
position p;
@@
 enum bfa_port_opmode cocci_id@p ;
...
position p;
@@
 struct bfa_qos_bw_s * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct bfa_fcport_s * fcport ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_rport_s * rp , enum bfa_rport_event event ) ;
...
position p;
@@
 void cocci_id@p ( struct bfa_s * bfa ) ;
...
position p;
@@
 struct bfi_fcport_event_s * cocci_id@p ;
...
position p;
@@
 enum bfa_dport_sm_event { BFA_DPORT_SM_ENABLE = 1 , BFA_DPORT_SM_DISABLE = 2 , BFA_DPORT_SM_FWRSP = 3 , BFA_DPORT_SM_QRESUME = 4 , BFA_DPORT_SM_HWFAIL = 5 , BFA_DPORT_SM_START = 6 , BFA_DPORT_SM_REQFAIL = 7 , BFA_DPORT_SM_SCN = 8 , } cocci_id@p ;
...
typedef bfa_boolean_t;
@@
 bfa_boolean_t cocci_id@p ( struct bfa_rport_s * rp ) ;
...
position p;
@@
 struct bfi_diag_dport_scn_s * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bfa_cb_fcxp_send_t;
@@
 bfa_cb_fcxp_send_t cocci_id@p ;
...
position p;
@@
 struct bfi_rport_delete_req_s * cocci_id@p ;
...
typedef bfa_boolean_t;
@@
 bfa_boolean_t cocci_id@p ( struct bfa_dport_s * dport , enum bfi_dport_req req ) ;
...
position p;
@@
 struct bfi_lps_n2n_pid_req_s * cocci_id@p ;
...
position p;
@@
 struct bfa_rport_info_s * cocci_id@p ;
...
position p;
@@
 struct bfa_fcport_s * cocci_id@p ;
