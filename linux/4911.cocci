...
position p;
@@
 enum { MTHCA_NUM_ASYNC_EQE = 0x80 , MTHCA_NUM_CMD_EQE = 0x80 , MTHCA_NUM_SPARE_EQE = 0x80 , MTHCA_EQ_ENTRY_SIZE = 0x20 , } cocci_id@p ;
...
position p;
@@
 struct mthca_eq_context cocci_id@p ;
