...
position p;
@@
 struct es7241_chip {  const struct es7241_clock_mode * modes ;  unsigned int mode_num ; } cocci_id@p ;
...
position p;
@@
 const struct es7241_clock_mode cocci_id@p [ ] ;
...
typedef bool;
@@
 struct es7241_data {  struct gpio_desc * reset ;  struct gpio_desc * m0 ;  struct gpio_desc * m1 ;  unsigned int fmt ;  unsigned int mclk ;  bool is_slave ;  const struct es7241_chip * chip ; } cocci_id@p ;
...
position p;
@@
 const struct es7241_chip cocci_id@p ;
...
position p;
@@
 struct es7241_clock_mode {  unsigned int rate_min ;  unsigned int rate_max ;  unsigned int * slv_mfs ;  unsigned int slv_mfs_num ;  unsigned int mst_mfs ;  unsigned int mst_m0 : 1 ;  unsigned int mst_m1 : 1 ; } cocci_id@p ;
