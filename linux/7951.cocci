...
position p;
@@
 struct lsi_umts_single cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct param {  int is_present ;  union {  void * ptr ;  u32 dword ;  u16 word ;  u8 byte ; } ; } cocci_id@p ;
...
position p;
@@
 struct lsi_umts_dual cocci_id@p ;
...
position p;
@@
 struct sierra_net_data cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ sizeof ( priv -> shdwn_msg ) ] ;
...
position p;
@@
 struct hip_hdr {  int hdrlen ;  struct param payload_len ;  struct param msgid ;  struct param msgspecific ;  struct param extmsgid ; } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ sizeof ( priv -> sync_msg ) ] ;
