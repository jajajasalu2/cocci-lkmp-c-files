...
position p;
@@
 struct sun4i_irq_chip_data cocci_id@p ;
...
typedef u32;
@@
 struct sun4i_irq_chip_data {  void __iomem * irq_base ;  struct irq_domain * irq_domain ;  u32 enable_reg_offset ;  u32 mask_reg_offset ; } cocci_id@p ;
