...
position p;
@@
 struct mib_counters * cocci_id@p ;
...
typedef u32,u16;
@@
 struct rx_desc {  u32 cmd_sts ;  u16 buf_size ;  u16 byte_cnt ;  u32 buf_ptr ;  u32 next_desc_ptr ; } cocci_id@p ;
...
position p;
@@
 struct mv643xx_eth_private * cocci_id@p ;
...
position p;
@@
 struct mv643xx_eth_platform_data cocci_id@p ;
...
position p;
@@
 const struct mv643xx_eth_stats cocci_id@p [ ] ;
...
position p;
@@
 struct platform_device * cocci_id@p [ 3 ] ;
...
typedef u32,u16;
@@
 struct tx_desc {  u32 cmd_sts ;  u16 l4i_chk ;  u16 byte_cnt ;  u32 buf_ptr ;  u32 next_desc_ptr ; } cocci_id@p ;
...
position p;
@@
 struct mv643xx_eth_shared_private * cocci_id@p ;
...
typedef u32;
@@
 struct mv643xx_eth_shared_private {  void __iomem * base ;  u32 win_protect ;  int extended_rx_coal_limit ;  int tx_bw_control ;  int tx_csum_limit ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 struct mv643xx_eth_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int netdev_off ;  int mp_off ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct rx_queue {  int index ;  int rx_ring_size ;  int rx_desc_count ;  int rx_curr_desc ;  int rx_used_desc ;  struct rx_desc * rx_desc_area ;  dma_addr_t rx_desc_dma ;  int rx_desc_area_size ;  struct sk_buff * * rx_skb ; } cocci_id@p ;
...
typedef u32,u16;
@@
 struct tx_desc {  u16 byte_cnt ;  u16 l4i_chk ;  u32 cmd_sts ;  u32 next_desc_ptr ;  u32 buf_ptr ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ MII_BUS_ID_SIZE + 3 ] ;
...
position p;
@@
 struct mv643xx_eth_shared_platform_data * cocci_id@p ;
...
typedef u32,u16;
@@
 struct rx_desc {  u16 byte_cnt ;  u16 buf_size ;  u32 cmd_sts ;  u32 next_desc_ptr ;  u32 buf_ptr ; } cocci_id@p ;
