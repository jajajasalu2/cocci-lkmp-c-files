...
position p;
@@
 struct titan_agp_aperture * cocci_id@p ;
...
position p;
@@
 struct titan_agp_aperture {  struct pci_iommu_arena * arena ;  long pg_start ;  long pg_count ; } cocci_id@p ;
