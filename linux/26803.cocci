...
position p;
@@
 struct uffdio_register cocci_id@p ;
...
position p;
@@
 struct userfaultfd_fork_ctx {  struct userfaultfd_ctx * orig ;  struct userfaultfd_ctx * new ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct userfaultfd_wake_range * cocci_id@p ;
...
position p;
@@
 struct userfaultfd_ctx cocci_id@p ;
...
position p;
@@
 struct uffdio_zeropage cocci_id@p ;
...
position p;
@@
 struct userfaultfd_unmap_ctx {  struct userfaultfd_ctx * ctx ;  unsigned long start ;  unsigned long end ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct userfaultfd_fork_ctx * cocci_id@p ;
...
position p;
@@
 struct vm_userfaultfd_ctx cocci_id@p ;
...
position p;
@@
 struct uffdio_range cocci_id@p ;
...
position p;
@@
 struct userfaultfd_unmap_ctx * cocci_id@p ;
...
position p;
@@
 enum userfaultfd_state { UFFD_STATE_WAIT_API , UFFD_STATE_RUNNING , } cocci_id@p ;
...
position p;
@@
 struct userfaultfd_wait_queue * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,wait_queue_head_t,refcount_t;
@@
 struct userfaultfd_ctx {  wait_queue_head_t fault_pending_wqh ;  wait_queue_head_t fault_wqh ;  wait_queue_head_t fd_wqh ;  wait_queue_head_t event_wqh ;  struct seqcount refile_seq ;  refcount_t refcount ;  unsigned int flags ;  unsigned int features ;  enum userfaultfd_state state ;  bool released ;  bool mmap_changing ;  struct mm_struct * mm ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,wait_queue_entry_t;
@@
 struct userfaultfd_wait_queue {  struct uffd_msg msg ;  wait_queue_entry_t wq ;  struct userfaultfd_ctx * ctx ;  bool waken ; } cocci_id@p ;
...
position p;
@@
 struct userfaultfd_wake_range {  unsigned long start ;  unsigned long len ; } cocci_id@p ;
