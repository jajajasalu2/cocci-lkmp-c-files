...
position p;
@@
 struct nvbios_vpstate_entry cocci_id@p ;
...
position p;
@@
 struct nvbios_vpstate_header cocci_id@p ;
...
position p;
@@
 struct nvbios_cstepX cocci_id@p ;
...
position p;
@@
 struct nvbios_boostS cocci_id@p ;
...
position p;
@@
 struct nvbios_perfS cocci_id@p ;
...
position p;
@@
 const struct nvkm_subdev_func cocci_id@p ;
...
position p;
@@
 const struct nvkm_domain * cocci_id@p ;
...
position p;
@@
 struct nvbios_cstepE cocci_id@p ;
...
position p;
@@
 struct nvbios_boostE cocci_id@p ;
