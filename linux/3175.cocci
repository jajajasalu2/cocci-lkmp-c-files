...
position p;
@@
 struct w83792d_data cocci_id@p ;
...
position p;
@@
 struct attribute * cocci_id@p [ 4 ] [ 7 ] ;
...
position p;
@@
 struct w83792d_data * cocci_id@p ( struct device * dev ) ;
...
position p;
@@
 void cocci_id@p ( struct w83792d_data * data , struct device * dev ) ;
...
typedef u8,u32,u16;
@@
 struct w83792d_data {  struct device * hwmon_dev ;  struct mutex update_lock ;  char valid ;  unsigned long last_updated ;  struct i2c_client * lm75 [ 2 ] ;  u8 in [ 9 ] ;  u8 in_max [ 9 ] ;  u8 in_min [ 9 ] ;  u16 low_bits ;  u8 fan [ 7 ] ;  u8 fan_min [ 7 ] ;  u8 temp1 [ 3 ] ;  u8 temp_add [ 2 ] [ 6 ] ;  u8 fan_div [ 7 ] ;  u8 pwm [ 7 ] ;  u8 pwmenable [ 3 ] ;  u32 alarms ;  u8 chassis ;  u8 thermal_cruise [ 3 ] ;  u8 tolerance [ 3 ] ;  u8 sf2_points [ 3 ] [ 4 ] ;  u8 sf2_levels [ 3 ] [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct attribute_group cocci_id@p [ 4 ] ;
