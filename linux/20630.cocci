...
position p;
@@
 unsigned long cocci_id@p [ NUM_COUNTERS_NON_HT ] ;
...
position p;
@@
 struct p4_counter_binding {  int virt_counter ;  int counter_address ;  int cccr_address ; } cocci_id@p ;
...
position p;
@@
 struct p4_event_binding * cocci_id@p ;
...
position p;
@@
 struct p4_counter_binding cocci_id@p [ NUM_COUNTERS_NON_HT ] ;
...
position p;
@@
 struct p4_event_binding cocci_id@p [ NUM_EVENTS ] ;
...
position p;
@@
 struct p4_event_binding {  int escr_select ;  int event_select ;  struct {  int virt_counter ;  int escr_address ; } bindings [ 2 ] ; } cocci_id@p ;
