...
position p;
@@
 const struct dc_cursor_mi_param * cocci_id@p ;
...
position p;
@@
 enum dcn10_coef_filter_type_sel { SCL_COEF_LUMA_VERT_FILTER = 0 , SCL_COEF_LUMA_HORZ_FILTER = 1 , SCL_COEF_CHROMA_VERT_FILTER = 2 , SCL_COEF_CHROMA_HORZ_FILTER = 3 , SCL_COEF_ALPHA_VERT_FILTER = 4 , SCL_COEF_ALPHA_HORZ_FILTER = 5 , } cocci_id@p ;
...
position p;
@@
 const struct dc_cursor_position * cocci_id@p ;
...
position p;
@@
 struct dc_csc_transform cocci_id@p ;
...
position p;
@@
 enum pixel_format_description cocci_id@p ;
...
position p;
@@
 enum dc_cursor_color_format cocci_id@p ;
...
position p;
@@
 enum pixel_format_description { PIXEL_FORMAT_FIXED = 0 , PIXEL_FORMAT_FIXED16 , PIXEL_FORMAT_FLOAT , } cocci_id@p ;
...
position p;
@@
 enum dscl_autocal_mode { AUTOCAL_MODE_OFF = 0 , AUTOCAL_MODE_AUTOSCALE = 1 , AUTOCAL_MODE_AUTOCENTER = 2 , AUTOCAL_MODE_AUTOREPLICATE = 3 , } cocci_id@p ;
...
position p;
@@
 enum expansion_mode cocci_id@p ;
...
position p;
@@
 enum dscl_mode_sel { DSCL_MODE_SCALING_444_BYPASS = 0 , DSCL_MODE_SCALING_444_RGB_ENABLE = 1 , DSCL_MODE_SCALING_444_YCBCR_ENABLE = 2 , DSCL_MODE_SCALING_420_YCBCR_ENABLE = 3 , DSCL_MODE_SCALING_420_LUMA_BYPASS = 4 , DSCL_MODE_SCALING_420_CHROMA_BYPASS = 5 , DSCL_MODE_DSCL_BYPASS = 6 , } cocci_id@p ;
...
position p;
@@
 struct cnv_alpha_2bit_lut * cocci_id@p ;
...
position p;
@@
 enum dcn10_input_csc_select cocci_id@p ;
...
position p;
@@
 const struct dpp_funcs cocci_id@p ;
