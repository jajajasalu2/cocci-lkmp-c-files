...
position p;
@@
 struct atto_csmi_get_scsi_addr * cocci_id@p ;
...
position p;
@@
 struct esas2r_request * cocci_id@p ;
...
position p;
@@
 struct esas2r_sas_nvram * cocci_id@p ;
...
position p;
@@
 struct atto_ioctl_smp cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct esas2r_adapter * , struct esas2r_request * , struct esas2r_sg_context * , void * ) ;
...
position p;
@@
 struct atto_csmi_task_mgmt * cocci_id@p ;
...
position p;
@@
 struct atto_ioctl_vda cocci_id@p ;
...
position p;
@@
 struct atto_vda_ioctl_req * cocci_id@p ;
...
position p;
@@
 struct atto_hba_get_adapter_info * cocci_id@p ;
...
position p;
@@
 struct esas2r_ioctl_fs * cocci_id@p ;
...
position p;
@@
 struct atto_express_ioctl cocci_id@p ;
...
position p;
@@
 struct atto_hba_get_adapter_address * cocci_id@p ;
...
position p;
@@
 struct esas2r_flash_img * cocci_id@p ;
...
position p;
@@
 struct esas2r_target * cocci_id@p ;
...
position p;
@@
 union atto_ioctl_csmi * cocci_id@p ;
...
position p;
@@
 struct atto_hba_get_device_address * cocci_id@p ;
...
position p;
@@
 struct esas2r_adapter * cocci_id@p ;
...
position p;
@@
 struct atto_csmi_get_cntlr_cfg * cocci_id@p ;
...
position p;
@@
 struct atto_hba_trace * cocci_id@p ;
...
position p;
@@
 struct esas2r_sg_context cocci_id@p ;
...
typedef u32;
@@
 struct esas2r_buffered_ioctl {  struct esas2r_adapter * a ;  void * ioctl ;  u32 length ;  u32 control_code ;  u32 offset ;  BUFFERED_IOCTL_CALLBACK callback ;  void * context ;  BUFFERED_IOCTL_DONE_CALLBACK done_callback ;  void * done_context ; } cocci_id@p ;
...
position p;
@@
 struct atto_hba_adap_ctrl * cocci_id@p ;
...
position p;
@@
 struct atto_csmi_get_driver_info * cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct esas2r_adapter * , struct esas2r_request * , void * ) ;
...
position p;
@@
 struct atto_hba_scsi_pass_thru cocci_id@p ;
...
position p;
@@
 struct esas2r_buffered_ioctl cocci_id@p ;
...
position p;
@@
 struct atto_csmi_get_dev_addr * cocci_id@p ;
...
position p;
@@
 struct atto_csmi_get_cntlr_sts * cocci_id@p ;
...
position p;
@@
 struct atto_hba_get_device_info * cocci_id@p ;
...
position p;
@@
 struct esas2r_flash_img_v0 cocci_id@p ;
