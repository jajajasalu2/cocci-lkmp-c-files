...
position p;
@@
 struct isst_pkg_ctdp_level_info cocci_id@p ;
...
position p;
@@
 struct isst_pkg_ctdp cocci_id@p ;
...
position p;
@@
 struct process_cmd_help_struct cocci_id@p [ ] ;
...
position p;
@@
 struct isst_if_mbox_cmds cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MAX_PACKAGE_COUNT ] [ MAX_DIE_PER_PACKAGE ] ;
...
position p;
@@
 unsigned short cocci_id@p [ MAX_CPUS_IN_ONE_REQ ] ;
...
position p;
@@
 int cocci_id@p [ MAX_PACKAGE_COUNT * MAX_PACKAGE_COUNT ] ;
...
position p;
@@
 void ( * cocci_id@p ) ( int , void * , void * , void * , void * ) ;
...
position p;
@@
 struct isst_pbf_info cocci_id@p ;
...
position p;
@@
 struct isst_if_msr_cmds cocci_id@p ;
...
position p;
@@
 long long cocci_id@p [ MAX_PACKAGE_COUNT ] [ MAX_DIE_PER_PACKAGE ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( int cpu , void * arg ) ;
...
position p;
@@
 struct process_cmd_help_struct {  char * feature ;  void ( * process_fn ) ( void ) ; } cocci_id@p ;
...
position p;
@@
 struct process_cmd_struct * cocci_id@p ;
...
position p;
@@
 struct isst_clos_config cocci_id@p ;
...
position p;
@@
 struct isst_if_platform_info cocci_id@p ;
...
position p;
@@
 struct process_cmd_struct {  char * feature ;  char * command ;  void ( * process_fn ) ( int arg ) ;  int arg ; } cocci_id@p ;
...
position p;
@@
 struct isst_if_cpu_maps cocci_id@p ;
...
position p;
@@
 struct isst_if_io_regs cocci_id@p ;
...
position p;
@@
 struct _cpu_map {  unsigned short core_id ;  unsigned short pkg_id ;  unsigned short die_id ;  unsigned short punit_cpu ;  unsigned short punit_cpu_core ; } cocci_id@p ;
...
position p;
@@
 struct isst_fact_info cocci_id@p ;
