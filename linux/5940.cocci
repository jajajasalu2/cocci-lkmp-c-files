...
position p;
@@
 struct mrfld_family * cocci_id@p ;
...
position p;
@@
 const struct mrfld_family * cocci_id@p ;
...
position p;
@@
 struct mrfld_pinctrl * cocci_id@p ;
...
typedef bool;
@@
 struct mrfld_family {  unsigned int barno ;  unsigned int pin_base ;  size_t npins ;  bool protected ;  void __iomem * regs ; } cocci_id@p ;
...
@@
 struct mrfld_pinctrl {  struct device * dev ;  raw_spinlock_t lock ;  struct pinctrl_desc pctldesc ;  struct pinctrl_dev * pctldev ;  const struct mrfld_family * families ;  size_t nfamilies ;  const struct intel_function * functions ;  size_t nfunctions ;  const struct intel_pingroup * groups ;  size_t ngroups ;  const struct pinctrl_pin_desc * pins ;  size_t npins ; } cocci_id@p ;
