...
position p;
@@
 struct net_device * cocci_id@p ( int unit ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int ioaddr , struct pnp_dev * idev , int card_number ) ;
...
position p;
@@
 enum Win4_Media_bits { Media_SQE = 0x0008 , Media_10TP = 0x00C0 , Media_Lnk = 0x0080 , Media_LnkBeat = 0x0800 , } cocci_id@p ;
...
typedef u32,s32;
@@
 struct boom_tx_desc {  u32 next ;  s32 status ;  u32 addr ;  s32 length ; } cocci_id@p ;
...
position p;
@@
 struct boom_tx_desc * cocci_id@p ;
...
position p;
@@
 enum rx_desc_status { RxDComplete = 0x00008000 , RxDError = 0x4000 , } cocci_id@p ;
...
typedef u32,s32;
@@
 struct boom_rx_desc {  u32 next ;  s32 status ;  u32 addr ;  s32 length ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( int addr , struct net_device * dev ) ;
...
position p;
@@
 enum xcvr_types { XCVR_10baseT = 0 , XCVR_AUI , XCVR_10baseTOnly , XCVR_10base2 , XCVR_100baseTx , XCVR_100baseFx , XCVR_MII = 6 , XCVR_Default = 8 , } cocci_id@p ;
...
position p;
@@
 enum MasterCtrl { PktStatus = 0x400 , DownListPtr = 0x404 , FragAddr = 0x408 , FragLen = 0x40c , TxFreeThreshold = 0x40f , UpPktStatus = 0x410 , UpListPtr = 0x418 , } cocci_id@p ;
...
position p;
@@
 enum Window1 { TX_FIFO = 0x10 , RX_FIFO = 0x10 , RxErrors = 0x14 , RxStatus = 0x18 , Timer = 0x1A , TxStatus = 0x1B , TxFree = 0x1C , } cocci_id@p ;
...
position p;
@@
 enum wn3_config { Ram_size = 7 , Ram_width = 8 , Ram_speed = 0x30 , Rom_size = 0xc0 , Ram_split_shift = 16 , Ram_split = 3 << Ram_split_shift , Xcvr_shift = 20 , Xcvr = 7 << Xcvr_shift , Autoselect = 0x1000000 , } cocci_id@p ;
...
position p;
@@
 enum corkscrew_status { IntLatch = 0x0001 , AdapterFailure = 0x0002 , TxComplete = 0x0004 , TxAvailable = 0x0008 , RxComplete = 0x0010 , RxEarly = 0x0020 , IntReq = 0x0040 , StatsFull = 0x0080 , DMADone = 1 << 8 , DownComplete = 1 << 9 , UpComplete = 1 << 10 , DMAInProgress = 1 << 11 , CmdInProgress = 1 << 12 , } cocci_id@p ;
...
position p;
@@
 struct isapnp_device_id cocci_id@p [ ] ;
...
position p;
@@
 enum Window4 { Wn4_NetDiag = 6 , Wn4_Media = 10 , } cocci_id@p ;
...
position p;
@@
 enum Window7 { Wn7_MasterAddr = 0 , Wn7_MasterLen = 6 , Wn7_MasterStatus = 12 , } cocci_id@p ;
...
position p;
@@
 struct corkscrew_private * cocci_id@p ;
...
position p;
@@
 enum eeprom_offset { PhysAddr01 = 0 , PhysAddr23 = 1 , PhysAddr45 = 2 , ModelID = 3 , EtherLink3ID = 7 , } cocci_id@p ;
...
position p;
@@
 enum Window3 { Wn3_Config = 0 , Wn3_MAC_Ctrl = 6 , Wn3_Options = 8 , } cocci_id@p ;
...
position p;
@@
 enum RxFilter { RxStation = 1 , RxMulticast = 2 , RxBroadcast = 4 , RxProm = 8 , } cocci_id@p ;
...
position p;
@@
 enum Win0_EEPROM_bits { EEPROM_Read = 0x80 , EEPROM_WRITE = 0x40 , EEPROM_ERASE = 0xC0 , EEPROM_EWENB = 0x30 , EEPROM_EWDIS = 0x00 , } cocci_id@p ;
