...
position p;
@@
 struct smc_local {  struct sk_buff * saved_skb ;  int packets_waiting ; } cocci_id@p ;
...
position p;
@@
 struct devlist {  unsigned int port ;  unsigned int irq ; } cocci_id@p ;
