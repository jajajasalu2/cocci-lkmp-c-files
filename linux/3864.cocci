...
position p;
@@
 const enum sec_cmode cocci_id@p ;
...
position p;
@@
 struct sec_cipher_req * cocci_id@p ;
...
position p;
@@
 const enum sec_calg cocci_id@p ;
...
position p;
@@
 struct sec_cipher_res cocci_id@p ;
...
position p;
@@
 struct sec_cipher_ctx * cocci_id@p ;
