...
typedef u32;
@@
 struct fsl_soc_die_attr {  char * die ;  u32 svr ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 const struct fsl_soc_die_attr cocci_id@p [ ] ;
...
typedef bool;
@@
 struct guts {  struct ccsr_guts __iomem * regs ;  bool little_endian ; } cocci_id@p ;
