...
position p;
@@
 struct incl_3d_state * cocci_id@p ;
...
position p;
@@
 enum incl_3d_channel { CHANNEL_SCAN_INDEX_X , CHANNEL_SCAN_INDEX_Y , CHANNEL_SCAN_INDEX_Z , INCLI_3D_CHANNEL_MAX , } cocci_id@p ;
...
typedef u32;
@@
 struct incl_3d_state {  struct hid_sensor_hub_callbacks callbacks ;  struct hid_sensor_common common_attributes ;  struct hid_sensor_hub_attribute_info incl [ INCLI_3D_CHANNEL_MAX ] ;  u32 incl_val [ INCLI_3D_CHANNEL_MAX ] ;  int scale_pre_decml ;  int scale_post_decml ;  int scale_precision ;  int value_offset ; } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ INCLI_3D_CHANNEL_MAX ] ;
