...
position p;
@@
 const struct dcn_soc_bounding_box cocci_id@p ;
...
position p;
@@
 const struct dcn_bw_internal_vars * cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_rq_params_st cocci_id@p ;
...
position p;
@@
 struct pp_smu_funcs_rv * cocci_id@p ;
...
position p;
@@
 struct dc_debug_options * cocci_id@p ;
...
position p;
@@
 const struct dcn_ip_params cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_pipe_params_st * cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_dlg_sys_params_st cocci_id@p ;
...
position p;
@@
 struct dcn_bw_internal_vars * cocci_id@p ;
...
position p;
@@
 struct _vcs_dpi_display_e2e_pipe_params_st cocci_id@p ;
