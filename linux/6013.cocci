...
position p;
@@
 const struct ns2_pin_group cocci_id@p [ ] ;
...
position p;
@@
 const struct ns2_pin_function cocci_id@p [ ] ;
...
position p;
@@
 struct ns2_pin_group {  const char * name ;  const unsigned int * pins ;  const unsigned int num_pins ;  const struct ns2_mux mux ; } cocci_id@p ;
...
position p;
@@
 struct ns2_pinconf {  unsigned int base ;  unsigned int offset ;  unsigned int src_shift ;  unsigned int input_en ;  unsigned int pull_shift ;  unsigned int drive_shift ; } cocci_id@p ;
...
position p;
@@
 struct ns2_pin {  unsigned int pin ;  char * name ;  struct ns2_pinconf pin_conf ; } cocci_id@p ;
...
typedef bool;
@@
 struct ns2_mux_log {  struct ns2_mux mux ;  bool is_configured ; } cocci_id@p ;
...
position p;
@@
 struct ns2_mux {  unsigned int base ;  unsigned int offset ;  unsigned int shift ;  unsigned int mask ;  unsigned int alt ; } cocci_id@p ;
...
position p;
@@
 const struct ns2_mux * cocci_id@p ;
...
position p;
@@
 struct ns2_pin_function {  const char * name ;  const char * const * groups ;  const unsigned int num_groups ; } cocci_id@p ;
