...
typedef atomic_t;
@@
 struct pt_unit {  struct pi_adapter pia ;  struct pi_adapter * pi ;  int flags ;  int last_sense ;  int drive ;  atomic_t available ;  int bs ;  int capacity ;  int present ;  char * bufptr ;  char name [ PT_NAMELEN ] ; } cocci_id@p ;
...
position p;
@@
 struct pt_unit cocci_id@p [ PT_UNITS ] ;
...
position p;
@@
 int cocci_id@p ( struct pt_unit * tape ) ;
