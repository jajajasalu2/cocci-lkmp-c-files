...
position p;
@@
 struct rds_info_lengths * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rds_conn_path * , void * ) ;
...
position p;
@@
 struct rds_transport * cocci_id@p ;
...
position p;
@@
 struct rds_info_connection * cocci_id@p ;
...
typedef u64;
@@
 u64 cocci_id@p [ ( sizeof ( struct rds_info_connection ) + 7 ) / 8 ] ;
...
typedef u64;
@@
 u64 cocci_id@p [ ( sizeof ( struct rds6_info_connection ) + 7 ) / 8 ] ;
...
position p;
@@
 struct rds6_info_connection * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct rds_connection * , void * ) ;
...
position p;
@@
 struct hlist_head cocci_id@p [ RDS_CONNECTION_HASH_ENTRIES ] ;
