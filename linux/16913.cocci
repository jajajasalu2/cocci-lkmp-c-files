...
position p;
@@
 struct ml_effect_state * cocci_id@p ;
...
position p;
@@
 struct ml_effect_state {  struct ff_effect * effect ;  unsigned long flags ;  int count ;  unsigned long play_at ;  unsigned long stop_at ;  unsigned long adj_at ; } cocci_id@p ;
...
position p;
@@
 const struct ff_effect * cocci_id@p ;
...
position p;
@@
 const struct ff_envelope * cocci_id@p ;
...
position p;
@@
 struct ml_device {  void * private ;  struct ml_effect_state states [ FF_MEMLESS_EFFECTS ] ;  int gain ;  struct timer_list timer ;  struct input_dev * dev ;  int ( * play_effect ) ( struct input_dev * dev , void * data , struct ff_effect * effect ) ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct input_dev * , void * , struct ff_effect * ) ;
