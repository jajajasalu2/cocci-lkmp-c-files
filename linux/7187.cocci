...
position p;
@@
 struct max77843_muic_irq {  unsigned int irq ;  const char * name ;  unsigned int virq ; } cocci_id@p ;
...
position p;
@@
 struct max77843_muic_info cocci_id@p ;
...
position p;
@@
 enum max77843_muic_cable_group { MAX77843_CABLE_GROUP_ADC = 0 , MAX77843_CABLE_GROUP_ADC_GND , MAX77843_CABLE_GROUP_CHG , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct max77843_muic_info {  struct device * dev ;  struct max77693_dev * max77843 ;  struct extcon_dev * edev ;  struct mutex mutex ;  struct work_struct irq_work ;  struct delayed_work wq_detcable ;  u8 status [ MAX77843_MUIC_STATUS_NUM ] ;  int prev_cable_type ;  int prev_chg_type ;  int prev_gnd_type ;  bool irq_adc ;  bool irq_chg ; } cocci_id@p ;
...
position p;
@@
 struct max77843_muic_irq * cocci_id@p ;
...
position p;
@@
 enum max77843_muic_cable_group cocci_id@p ;
...
position p;
@@
 enum max77843_muic_adc_debounce_time { MAX77843_DEBOUNCE_TIME_5MS = 0 , MAX77843_DEBOUNCE_TIME_10MS , MAX77843_DEBOUNCE_TIME_25MS , MAX77843_DEBOUNCE_TIME_38_62MS , } cocci_id@p ;
...
position p;
@@
 enum max77843_muic_charger_type { MAX77843_MUIC_CHG_NONE = 0 , MAX77843_MUIC_CHG_USB , MAX77843_MUIC_CHG_DOWNSTREAM , MAX77843_MUIC_CHG_DEDICATED , MAX77843_MUIC_CHG_SPECIAL_500MA , MAX77843_MUIC_CHG_SPECIAL_1A , MAX77843_MUIC_CHG_SPECIAL_BIAS , MAX77843_MUIC_CHG_RESERVED , MAX77843_MUIC_CHG_GND , MAX77843_MUIC_CHG_DOCK , } cocci_id@p ;
...
position p;
@@
 enum max77843_muic_status { MAX77843_MUIC_STATUS1 = 0 , MAX77843_MUIC_STATUS2 , MAX77843_MUIC_STATUS3 , MAX77843_MUIC_STATUS_NUM , } cocci_id@p ;
...
position p;
@@
 enum max77843_muic_adc_debounce_time cocci_id@p ;
