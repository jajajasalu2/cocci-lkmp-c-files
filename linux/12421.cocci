...
position p;
@@
 const struct omap_drm_pipeline * cocci_id@p ;
...
position p;
@@
 struct drm_omap_gem_new * cocci_id@p ;
...
position p;
@@
 const struct drm_ioctl_desc cocci_id@p [ DRM_COMMAND_END - DRM_COMMAND_BASE ] ;
...
position p;
@@
 struct drm_omap_param * cocci_id@p ;
...
position p;
@@
 struct drm_omap_gem_info * cocci_id@p ;
