...
position p;
@@
 struct pcf8583 {  struct rtc_device * rtc ;  unsigned char ctrl ; } cocci_id@p ;
...
position p;
@@
 struct rtc_mem {  unsigned int loc ;  unsigned int nr ;  unsigned char * data ; } cocci_id@p ;
