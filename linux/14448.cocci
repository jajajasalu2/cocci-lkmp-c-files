...
position p;
@@
 struct wl1273_device cocci_id@p ;
...
@@
 struct wl1273_device {  char * bus_type ;  u8 forbidden ;  unsigned int preemphasis ;  unsigned int spacing ;  unsigned int tx_power ;  unsigned int rx_frequency ;  unsigned int tx_frequency ;  unsigned int rangelow ;  unsigned int rangehigh ;  unsigned int band ;  bool stereo ;  unsigned int rds_on ;  wait_queue_head_t read_queue ;  struct mutex lock ;  struct completion busy ;  unsigned char * buffer ;  unsigned int buf_size ;  unsigned int rd_index ;  unsigned int wr_index ;  u16 irq_flags ;  u16 irq_received ;  struct v4l2_ctrl_handler ctrl_handler ;  struct v4l2_device v4l2dev ;  struct video_device videodev ;  struct device * dev ;  struct wl1273_core * core ;  struct file * owner ;  char * write_buf ;  unsigned int rds_users ; } cocci_id@p ;
...
position p;
@@
 struct v4l2_rds_data cocci_id@p ;
...
position p;
@@
 struct wl1273_fm_platform_data * cocci_id@p ;
