...
position p;
@@
 struct iwl_mcc_update_resp * cocci_id@p ;
...
position p;
@@
 struct iwl_mu_group_mgmt_notif * cocci_id@p ;
...
position p;
@@
 struct iwl_probe_resp_data * cocci_id@p ;
...
position p;
@@
 struct iwl_chan_switch_te_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_trigger_mlme * cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_trigger_tlv * cocci_id@p ;
...
position p;
@@
 enum { BC_FILTER_MAGIC_NONE = 0 , BC_FILTER_MAGIC_IP , BC_FILTER_MAGIC_MAC , } cocci_id@p ;
...
position p;
@@
 struct ieee80211_he_mu_edca_param_ac_rec * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_he_obss_narrow_bw_ru_data * cocci_id@p ;
...
position p;
@@
 struct iwl_he_sta_context_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_ftm_responder_iter_data * cocci_id@p ;
...
position p;
@@
 struct iwl_bcast_iter_data cocci_id@p ;
...
position p;
@@
 struct ieee80211_cipher_scheme * cocci_id@p ;
...
position p;
@@
 enum ieee80211_frame_release_type cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_internal_rxq_notif cocci_id@p ;
...
position p;
@@
 struct iwl_fw_bcast_filter_attr * cocci_id@p ;
...
position p;
@@
 struct iwl_host_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_phy_ctxt * cocci_id@p ;
...
typedef bool;
@@
 struct iwl_mvm_he_obss_narrow_bw_ru_data {  bool tolerated ; } cocci_id@p ;
...
position p;
@@
 const struct iwl_fw_cipher_scheme * cocci_id@p ;
...
position p;
@@
 struct iwl_hs20_roc_req cocci_id@p ;
...
position p;
@@
 struct iwl_mu_group_mgmt_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_notif_wait_data * cocci_id@p ;
...
position p;
@@
 struct iwl_mcast_filter_cmd * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_mc_iter_data cocci_id@p ;
...
position p;
@@
 struct iwl_fw_bcast_filter * cocci_id@p ;
...
position p;
@@
 const struct ieee80211_event * cocci_id@p ;
...
position p;
@@
 struct iwl_rx_cmd_buffer * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ieee80211_hw * hw , enum set_key_cmd cmd , struct ieee80211_vif * vif , struct ieee80211_sta * sta , struct ieee80211_key_conf * key ) ;
...
position p;
@@
 struct iwl_mvm_key_pn * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ IWL_MVM_TM_ATTR_MAX + 1 ] ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IWL_MVM_TM_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct iwl_notification_wait cocci_id@p ;
...
position p;
@@
 union {  struct iwl_dev_tx_power_cmd v5 ;  struct iwl_dev_tx_power_cmd_v4 v4 ; } cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_tid_data * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_tcm_mac * cocci_id@p ;
...
typedef u8;
@@
 struct iwl_bcast_iter_data {  struct iwl_mvm * mvm ;  struct iwl_bcast_filter_cmd * cmd ;  u8 current_filter ; } cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_trigger_ba * cocci_id@p ;
...
position p;
@@
 struct iwl_rx_packet * cocci_id@p ;
...
typedef bool;
@@
 struct iwl_mvm_ftm_responder_iter_data {  bool responder ;  struct ieee80211_chanctx_conf * ctx ; } cocci_id@p ;
...
position p;
@@
 struct iwl_fw_dbg_trigger_tdls * cocci_id@p ;
...
position p;
@@
 struct iwl_he_pkt_ext * cocci_id@p ;
...
position p;
@@
 struct iwl_he_sta_context_cmd_v1 cocci_id@p ;
...
position p;
@@
 const struct iwl_fw_bcast_filter cocci_id@p [ ] ;
...
position p;
@@
 struct iwl_bcast_filter_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_hs20_roc_req_tail * cocci_id@p ;
...
position p;
@@
 struct iwl_hs20_roc_res * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_mc_iter_data {  struct iwl_mvm * mvm ;  int port_id ; } cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_pm_state_notification * cocci_id@p ;
...
position p;
@@
 enum iwl_mcc_source cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_time_event_data * cocci_id@p ;
...
position p;
@@
 enum sta_notify_cmd cocci_id@p ;
...
position p;
@@
 struct iwl_fw_bcast_mac * cocci_id@p ;
...
position p;
@@
 struct cfg80211_pmsr_request * cocci_id@p ;
...
position p;
@@
 struct ieee80211_scan_ies * cocci_id@p ;
...
position p;
@@
 struct ieee80211_channel_switch * cocci_id@p ;
...
position p;
@@
 struct ieee80211_key_seq cocci_id@p ;
