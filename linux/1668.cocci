...
position p;
@@
 enum magn_3d_channel { CHANNEL_SCAN_INDEX_X , CHANNEL_SCAN_INDEX_Y , CHANNEL_SCAN_INDEX_Z , CHANNEL_SCAN_INDEX_NORTH_MAGN_TILT_COMP , CHANNEL_SCAN_INDEX_NORTH_TRUE_TILT_COMP , CHANNEL_SCAN_INDEX_NORTH_MAGN , CHANNEL_SCAN_INDEX_NORTH_TRUE , MAGN_3D_CHANNEL_MAX , } cocci_id@p ;
...
position p;
@@
 struct magn_3d_state * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ MAGN_3D_CHANNEL_MAX ] ;
...
position p;
@@
 struct common_attributes {  int scale_pre_decml ;  int scale_post_decml ;  int scale_precision ;  int value_offset ; } cocci_id@p ;
...
typedef u32;
@@
 struct magn_3d_state {  struct hid_sensor_hub_callbacks callbacks ;  struct hid_sensor_common magn_flux_attributes ;  struct hid_sensor_common rot_attributes ;  struct hid_sensor_hub_attribute_info magn [ MAGN_3D_CHANNEL_MAX ] ;  u32 * iio_vals ;  u32 * magn_val_addr [ MAGN_3D_CHANNEL_MAX ] ;  struct common_attributes magn_flux_attr ;  struct common_attributes rot_attr ; } cocci_id@p ;
