...
@@
 struct debugfs_mount_opts {  kuid_t uid ;  kgid_t gid ;  umode_t mode ; } cocci_id@p ;
...
position p;
@@
 enum { Opt_uid , Opt_gid , Opt_mode , Opt_err , } cocci_id@p ;
...
position p;
@@
 struct debugfs_fs_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef debugfs_automount_t;
@@
 debugfs_automount_t cocci_id@p ;
...
position p;
@@
 struct debugfs_mount_opts * cocci_id@p ;
...
position p;
@@
 struct debugfs_fs_info {  struct debugfs_mount_opts mount_opts ; } cocci_id@p ;
