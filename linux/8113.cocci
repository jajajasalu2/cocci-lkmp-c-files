...
position p;
@@
 struct ti_hecc_priv cocci_id@p ;
...
@@
 struct ti_hecc_priv {  struct can_priv can ;  struct can_rx_offload offload ;  struct net_device * ndev ;  struct clk * clk ;  void __iomem * base ;  void __iomem * hecc_ram ;  void __iomem * mbx ;  bool use_hecc1int ;  spinlock_t mbx_lock ;  u32 tx_head ;  u32 tx_tail ;  struct regulator * reg_xceiver ; } cocci_id@p ;
...
position p;
@@
 const struct ti_hecc_priv * cocci_id@p ;
