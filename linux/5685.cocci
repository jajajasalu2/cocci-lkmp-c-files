...
position p;
@@
 struct hd44780 {  struct gpio_desc * pins [ PIN_NUM ] ; } cocci_id@p ;
...
position p;
@@
 enum hd44780_pin { PIN_DATA0 , PIN_DATA1 , PIN_DATA2 , PIN_DATA3 , PIN_DATA4 , PIN_DATA5 , PIN_DATA6 , PIN_DATA7 , PIN_CTRL_RS , PIN_CTRL_RW , PIN_CTRL_E , PIN_CTRL_BL , PIN_NUM , } cocci_id@p ;
