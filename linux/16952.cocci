...
position p;
@@
 struct sur40_header cocci_id@p ;
...
position p;
@@
 struct sur40_buffer * cocci_id@p ;
...
position p;
@@
 struct sur40_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct sur40_image_header * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct sur40_state * sur40 ) ;
