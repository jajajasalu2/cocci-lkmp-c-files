...
position p;
@@
 struct xfrm6_tunnel_net * cocci_id@p ;
...
typedef u32;
@@
 struct xfrm6_tunnel_net {  struct hlist_head spi_byaddr [ XFRM6_TUNNEL_SPI_BYADDR_HSIZE ] ;  struct hlist_head spi_byspi [ XFRM6_TUNNEL_SPI_BYSPI_HSIZE ] ;  u32 spi ; } cocci_id@p ;
...
position p;
@@
 struct xfrm6_tunnel_spi * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,refcount_t,xfrm_address_t;
@@
 struct xfrm6_tunnel_spi {  struct hlist_node list_byaddr ;  struct hlist_node list_byspi ;  xfrm_address_t addr ;  u32 spi ;  refcount_t refcnt ;  struct rcu_head rcu_head ; } cocci_id@p ;
