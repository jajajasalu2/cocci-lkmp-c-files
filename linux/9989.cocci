...
symbol cocci_id;
position p;
typedef islpci_state_t;
@@
 islpci_state_t cocci_id@p ;
...
position p;
@@
 isl38xx_control_block * cocci_id@p ;
...
position p;
@@
 struct islpci_membuf * cocci_id@p ;
