...
typedef bool;
@@
 struct intel_bts_recording {  struct auxtrace_record itr ;  struct perf_pmu * intel_bts_pmu ;  struct evlist * evlist ;  bool snapshot_mode ;  size_t snapshot_size ;  int snapshot_ref_cnt ;  struct intel_bts_snapshot_ref * snapshot_refs ; } cocci_id@p ;
...
typedef bool;
@@
 struct intel_bts_snapshot_ref {  void * ref_buf ;  size_t ref_offset ;  bool wrapped ; } cocci_id@p ;
...
position p;
@@
 struct intel_bts_snapshot_ref cocci_id@p ;
...
position p;
@@
 struct intel_bts_recording cocci_id@p ;
