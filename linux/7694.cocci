...
position p;
@@
 struct mcf_uart {  struct uart_port port ;  unsigned int sigs ;  unsigned char imr ; } cocci_id@p ;
...
position p;
@@
 struct mcf_platform_uart * cocci_id@p ;
