...
position p;
@@
 const int cocci_id@p [ CFCTRL_SRV_MASK ] ;
...
position p;
@@
 struct cfctrl_link_param * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct cflayer * layer , u8 channel_id , struct cflayer * adapt_layer ) ;
...
position p;
@@
 struct caif_connect_request * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct cflayer * layer , u8 channel_id , enum cfctrl_srv serv , u8 phyid , struct cflayer * adapt_layer ) ;
...
position p;
@@
 enum cfcnfg_phy_preference cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct cflayer * layer , u8 channel_id ) ;
...
position p;
@@
 struct cfcnfg_phyinfo cocci_id@p ;
...
position p;
@@
 struct cfcnfg {  struct cflayer layer ;  struct cflayer * ctrl ;  struct cflayer * mux ;  struct list_head phys ;  struct mutex lock ; } cocci_id@p ;
...
typedef bool;
@@
 struct cfcnfg_phyinfo {  struct list_head node ;  bool up ;  struct cflayer * frm_layer ;  struct cflayer * phy_layer ;  unsigned int id ;  enum cfcnfg_phy_preference pref ;  struct dev_info dev_info ;  int ifindex ;  int head_room ;  bool use_fcs ; } cocci_id@p ;
