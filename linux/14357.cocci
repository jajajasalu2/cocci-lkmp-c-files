...
position p;
@@
 const enum fe_modulation cocci_id@p [ ] ;
...
position p;
@@
 struct tc90522_state cocci_id@p ;
...
position p;
@@
 const enum fe_transmit_mode cocci_id@p [ ] ;
...
typedef u8;
@@
 struct reg_val {  u8 reg ;  u8 val ; } cocci_id@p ;
...
typedef bool;
@@
 struct tc90522_state {  struct tc90522_config cfg ;  struct dvb_frontend fe ;  struct i2c_client * i2c_client ;  struct i2c_adapter tuner_i2c ;  bool lna ; } cocci_id@p ;
...
position p;
@@
 struct dtv_fe_stats * cocci_id@p ;
...
position p;
@@
 const enum fe_code_rate cocci_id@p [ ] ;
