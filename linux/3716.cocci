...
position p;
@@
 struct adf_hw_device_class * cocci_id@p ;
...
typedef bool,u32;
@@
 struct vf_id_map {  u32 bdf ;  u32 id ;  u32 fake_id ;  bool attached ;  struct list_head list ; } cocci_id@p ;
