...
position p;
@@
 enum lpi2c_imx_pincfg { TWO_PIN_OD , TWO_PIN_OO , TWO_PIN_PP , FOUR_PIN_PP , } cocci_id@p ;
...
position p;
@@
 enum lpi2c_imx_pincfg cocci_id@p ;
...
position p;
@@
 enum lpi2c_imx_mode { STANDARD , FAST , FAST_PLUS , HS , ULTRA_FAST , } cocci_id@p ;
...
position p;
@@
 enum lpi2c_imx_mode cocci_id@p ;
...
position p;
@@
 struct lpi2c_imx_struct * cocci_id@p ;
