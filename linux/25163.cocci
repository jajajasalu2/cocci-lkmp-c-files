...
position p;
@@
 const char * cocci_id@p [ MAX_CPUIDLE_STRING_FILES ] ;
...
position p;
@@
 enum cpuidle_string cocci_id@p ;
...
position p;
@@
 enum idlestate_value { IDLESTATE_USAGE , IDLESTATE_POWER , IDLESTATE_LATENCY , IDLESTATE_TIME , IDLESTATE_DISABLE , MAX_IDLESTATE_VALUE_FILES , } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ MAX_IDLESTATE_VALUE_FILES ] ;
...
position p;
@@
 enum idlestate_string { IDLESTATE_DESC , IDLESTATE_NAME , MAX_IDLESTATE_STRING_FILES , } cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ MAX_IDLESTATE_STRING_FILES ] ;
...
position p;
@@
 enum idlestate_value cocci_id@p ;
...
position p;
@@
 enum idlestate_string cocci_id@p ;
...
position p;
@@
 enum cpuidle_string { CPUIDLE_GOVERNOR , CPUIDLE_GOVERNOR_RO , CPUIDLE_DRIVER , MAX_CPUIDLE_STRING_FILES , } cocci_id@p ;
