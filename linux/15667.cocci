...
position p;
@@
 struct gbaudio_codec_dai * cocci_id@p ;
...
position p;
@@
 struct snd_soc_codec_driver cocci_id@p ;
...
position p;
@@
 struct gbaudio_stream_params * cocci_id@p ;
...
position p;
@@
 struct gbaudio_data_connection * cocci_id@p ;
