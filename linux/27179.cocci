...
position p;
@@
 enum { NODE_ATTR_NODEID = 0 , NODE_ATTR_WEIGHT , } cocci_id@p ;
...
position p;
@@
 struct dlm_clusters cocci_id@p ;
...
position p;
@@
 struct dlm_clusters {  struct configfs_subsystem subsys ; } cocci_id@p ;
...
position p;
@@
 struct dlm_space {  struct config_group group ;  struct list_head members ;  struct mutex members_lock ;  int members_count ; } cocci_id@p ;
...
position p;
@@
 struct config_item * cocci_id@p ( struct config_group * , const char * ) ;
...
position p;
@@
 char cocci_id@p [ sizeof ( "AF_INET6	xxxx:xxxx:xxxx:xxxx:xxxx:xxxx:255.255.255.255\n" ) ] ;
...
position p;
@@
 void cocci_id@p ( struct config_item * ) ;
...
position p;
@@
 struct config_group * cocci_id@p ( struct config_group * , const char * ) ;
...
position p;
@@
 struct dlm_nodes {  struct config_group ns_group ; } cocci_id@p ;
...
position p;
@@
 struct dlm_config_node * cocci_id@p ;
...
position p;
@@
 enum { COMM_ATTR_NODEID = 0 , COMM_ATTR_LOCAL , COMM_ATTR_ADDR , COMM_ATTR_ADDR_LIST , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct config_group * , struct config_item * ) ;
...
position p;
@@
 struct dlm_spaces {  struct config_group ss_group ; } cocci_id@p ;
...
position p;
@@
 struct dlm_comms {  struct config_group cs_group ; } cocci_id@p ;
...
position p;
@@
 struct dlm_cluster {  struct config_group group ;  unsigned int cl_tcp_port ;  unsigned int cl_buffer_size ;  unsigned int cl_rsbtbl_size ;  unsigned int cl_recover_timer ;  unsigned int cl_toss_secs ;  unsigned int cl_scan_secs ;  unsigned int cl_log_debug ;  unsigned int cl_log_info ;  unsigned int cl_protocol ;  unsigned int cl_timewarn_cs ;  unsigned int cl_waitwarn_us ;  unsigned int cl_new_rsb_count ;  unsigned int cl_recover_callbacks ;  char cl_cluster_name [ DLM_LOCKSPACE_LEN ] ; } cocci_id@p ;
...
position p;
@@
 struct dlm_config_info cocci_id@p ;
...
position p;
@@
 struct dlm_comm {  struct config_item item ;  int seq ;  int nodeid ;  int local ;  int addr_count ;  struct sockaddr_storage * addr [ DLM_MAX_ADDR_COUNT ] ; } cocci_id@p ;
...
position p;
@@
 struct dlm_node {  struct config_item item ;  struct list_head list ;  int nodeid ;  int weight ;  int new ;  int comm_seq ; } cocci_id@p ;
