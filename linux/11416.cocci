...
position p;
@@
 struct vmwgfx_gmrid_man * cocci_id@p ;
...
@@
 struct vmwgfx_gmrid_man {  spinlock_t lock ;  struct ida gmr_ida ;  uint32_t max_gmr_ids ;  uint32_t max_gmr_pages ;  uint32_t used_gmr_pages ; } cocci_id@p ;
