...
position p;
@@
 const struct raid6_recov_calls * const cocci_id@p [ ] ;
...
position p;
@@
 void * const * cocci_id@p [ ( 65536 / PAGE_SIZE ) + 2 ] ;
...
position p;
@@
 const struct raid6_calls * cocci_id@p ;
...
position p;
@@
 const struct raid6_calls * const * cocci_id@p ;
...
position p;
@@
 void * cocci_id@p [ ( 65536 / PAGE_SIZE ) + 2 ] ;
...
position p;
@@
 const struct raid6_recov_calls * cocci_id@p ;
