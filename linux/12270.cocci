...
position p;
@@
 const unsigned char cocci_id@p [ NUM_GAMMA_STEPS ] [ GAMMA_CMD_CNT ] ;
...
position p;
@@
 struct s6e63j0x03 {  struct device * dev ;  struct drm_panel panel ;  struct backlight_device * bl_dev ;  struct regulator_bulk_data supplies [ 2 ] ;  struct gpio_desc * reset_gpio ; } cocci_id@p ;
