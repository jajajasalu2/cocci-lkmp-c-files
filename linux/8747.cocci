...
position p;
@@
 struct dcbx_local_params * cocci_id@p ;
...
position p;
@@
 struct pf_update_ramrod_data * cocci_id@p ;
...
position p;
@@
 struct qed_dcbx_operational_params * cocci_id@p ;
...
position p;
@@
 enum qed_mib_read_type cocci_id@p ;
...
position p;
@@
 struct qed_dcbx_mib_meta_data * cocci_id@p ;
...
position p;
@@
 struct qed_dcbx_results cocci_id@p ;
...
position p;
@@
 const struct qed_dcbx_app_metadata cocci_id@p [ ] ;
...
position p;
@@
 struct qed_dcbx_set cocci_id@p ;
...
position p;
@@
 struct qed_dcbx_admin_params cocci_id@p ;
...
position p;
@@
 struct lldp_config_params_s * cocci_id@p ;
...
position p;
@@
 struct qed_app_entry * cocci_id@p ;
...
position p;
@@
 struct protocol_dcb_data * cocci_id@p ;
...
position p;
@@
 struct qed_dcbx_params * cocci_id@p ;
...
position p;
@@
 enum dcbx_protocol_type * cocci_id@p ;
...
position p;
@@
 struct lldp_status_params_s * cocci_id@p ;
...
position p;
@@
 struct qed_dcbx_app_prio * cocci_id@p ;
