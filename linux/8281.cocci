...
position p;
@@
 const struct ethtool_fecparam * cocci_id@p ;
...
position p;
@@
 enum efx_stats_action { EFX_STATS_ENABLE , EFX_STATS_DISABLE , EFX_STATS_PULL , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct efx_mcdi_phy_data {  u32 flags ;  u32 type ;  u32 supported_cap ;  u32 channel ;  u32 port ;  u32 stats_mask ;  u8 name [ 20 ] ;  u32 media ;  u32 mmd_mask ;  u8 revision [ 20 ] ;  u32 forced_cap ; } cocci_id@p ;
...
position p;
@@
 enum efx_stats_action cocci_id@p ;
...
position p;
@@
 struct efx_mcdi_phy_data * cocci_id@p ;
