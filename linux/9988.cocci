...
typedef __u32;
@@
 int cocci_id@p ( struct net_device * , struct iw_request_info * , __u32 * , char * ) ;
...
position p;
@@
 struct islpci_bss_wpa_ie cocci_id@p ;
...
position p;
@@
 struct obj_attachment * cocci_id@p ;
...
position p;
@@
 const struct obj_mlme * cocci_id@p ;
...
position p;
@@
 struct islpci_mgmtframe cocci_id@p ;
...
typedef u8;
@@
 size_t cocci_id@p ( islpci_private * priv , u8 * bssid , u8 * wpa_ie ) ;
...
position p;
@@
 struct obj_frequencies * cocci_id@p ;
...
position p;
@@
 struct ieee80211_beacon_phdr * cocci_id@p ;
