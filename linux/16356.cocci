...
position p;
@@
 struct controller_priv * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct controller_priv {  struct device * class_dev ;  bool common_reset ;  struct gpio_desc * reset_gpiod ;  void __iomem * cpld_base ;  struct mutex ctrl_lock ;  u8 control_reg ;  char version [ 3 ] ;  u16 design_no ; } cocci_id@p ;
