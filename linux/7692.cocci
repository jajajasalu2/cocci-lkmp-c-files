...
@@
 struct zs_parms {  resource_size_t scc [ ZS_NUM_SCCS ] ;  int irq [ ZS_NUM_SCCS ] ; } cocci_id@p ;
...
position p;
@@
 struct zs_scc cocci_id@p [ ZS_NUM_SCCS ] ;
...
position p;
@@
 void cocci_id@p ( struct zs_port * ) ;
