...
position p;
@@
 struct report_general_resp * cocci_id@p ;
...
position p;
@@
 struct expander_device * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct domain_device * dev , int phy_id , u8 * sas_addr , int include ) ;
...
position p;
@@
 struct sas_internal * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct domain_device * dev ) ;
...
position p;
@@
 struct discover_resp * cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct domain_device * dev , u8 * sas_addr ) ;
