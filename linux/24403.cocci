...
position p;
@@
 struct lock_class_key cocci_id@p [ BT_MAX_PROTO ] ;
...
position p;
@@
 const char * const cocci_id@p [ BT_MAX_PROTO ] ;
...
position p;
@@
 const struct net_proto_family * cocci_id@p [ BT_MAX_PROTO ] ;
