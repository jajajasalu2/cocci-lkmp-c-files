...
position p;
@@
 const struct tw686x_format * cocci_id@p ;
...
position p;
@@
 const struct tw686x_dma_ops cocci_id@p ;
...
position p;
@@
 struct tw686x_v4l2_buf * cocci_id@p ;
...
position p;
@@
 struct tw686x_video_channel cocci_id@p ;
...
position p;
@@
 const unsigned int cocci_id@p [ 15 ] ;
...
position p;
@@
 struct tw686x_sg_desc * cocci_id@p ;
...
position p;
@@
 struct tw686x_dma_desc * cocci_id@p ;
