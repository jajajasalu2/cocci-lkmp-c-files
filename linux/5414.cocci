...
typedef u32;
@@
 struct stm32_qspi_flash {  struct stm32_qspi * qspi ;  u32 cs ;  u32 presc ; } cocci_id@p ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( u8 * val , void __iomem * addr ) ;
...
position p;
@@
 struct stm32_qspi_flash * cocci_id@p ;
...
@@
 struct stm32_qspi {  struct device * dev ;  struct spi_controller * ctrl ;  phys_addr_t phys_base ;  void __iomem * io_base ;  void __iomem * mm_base ;  resource_size_t mm_size ;  struct clk * clk ;  u32 clk_rate ;  struct stm32_qspi_flash flash [ STM32_QSPI_MAX_NORCHIP ] ;  struct completion data_completion ;  u32 fmode ;  struct dma_chan * dma_chtx ;  struct dma_chan * dma_chrx ;  struct completion dma_completion ;  u32 cr_reg ;  u32 dcr_reg ;  struct mutex lock ; } cocci_id@p ;
