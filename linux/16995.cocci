...
position p;
@@
 struct sun4i_ts_data cocci_id@p ;
...
position p;
@@
 const struct sun4i_ts_data * cocci_id@p ;
...
typedef bool;
@@
 struct sun4i_ts_data {  struct device * dev ;  struct input_dev * input ;  void __iomem * base ;  unsigned int irq ;  bool ignore_fifo_data ;  int temp_data ;  int temp_offset ;  int temp_step ; } cocci_id@p ;
