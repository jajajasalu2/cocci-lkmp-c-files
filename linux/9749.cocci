...
position p;
@@
 struct iwl_tof_range_rsp_ntfy_v6 * cocci_id@p ;
...
position p;
@@
 struct iwl_tof_range_req_cmd_v5 * cocci_id@p ;
...
position p;
@@
 struct iwl_tof_range_req_ap_entry * cocci_id@p ;
...
position p;
@@
 struct iwl_tof_range_req_cmd cocci_id@p ;
...
position p;
@@
 struct cfg80211_pmsr_request_peer * cocci_id@p ;
...
position p;
@@
 struct iwl_mvm_loc_entry * cocci_id@p ;
...
position p;
@@
 struct cfg80211_pmsr_result cocci_id@p ;
...
position p;
@@
 struct iwl_tof_range_rsp_ap_entry_ntfy * cocci_id@p ;
...
position p;
@@
 struct iwl_tof_range_rsp_ntfy_v5 * cocci_id@p ;
...
position p;
@@
 struct iwl_tof_range_rsp_ntfy * cocci_id@p ;
...
position p;
@@
 enum iwl_tof_range_request_status cocci_id@p ;
...
position p;
@@
 struct iwl_tof_range_req_ap_entry_v2 * cocci_id@p ;
...
position p;
@@
 struct iwl_tof_range_abort_cmd cocci_id@p ;
