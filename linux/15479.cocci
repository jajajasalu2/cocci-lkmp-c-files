...
typedef u8;
@@
 struct hw_config {  u8 adr [ 2 ] ;  u8 value ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nfc_hci_gate cocci_id@p [ ] ;
...
position p;
@@
 struct pn544_hci_info * cocci_id@p ;
...
typedef u8;
@@
 struct uicc_gatelist {  u8 head ;  u8 adr [ 2 ] ;  u8 value ; } cocci_id@p [ ] ;
...
position p;
@@
 struct nfc_hci_init_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef data_exchange_cb_t,fw_download_t;
@@
 struct pn544_hci_info {  struct nfc_phy_ops * phy_ops ;  void * phy_id ;  struct nfc_hci_dev * hdev ;  enum pn544_state state ;  struct mutex info_lock ;  int async_cb_type ;  data_exchange_cb_t async_cb ;  void * async_cb_context ;  fw_download_t fw_download ; } cocci_id@p ;
...
position p;
@@
 struct uicc_gatelist * cocci_id@p ;
...
position p;
@@
 enum pn544_state { PN544_ST_COLD , PN544_ST_FW_READY , PN544_ST_READY , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef fw_download_t;
@@
 fw_download_t cocci_id@p ;
