...
@@
 struct vmw_cmdbuf_header {  struct vmw_cmdbuf_man * man ;  SVGACBHeader * cb_header ;  SVGACBContext cb_context ;  struct list_head list ;  struct drm_mm_node node ;  dma_addr_t handle ;  u8 * cmd ;  size_t size ;  size_t reserved ;  bool inline_space ; } cocci_id@p ;
...
position p;
@@
 struct vmw_cmdbuf_context * cocci_id@p ;
...
typedef bool;
@@
 struct vmw_cmdbuf_alloc_info {  size_t page_size ;  struct drm_mm_node * node ;  bool done ; } cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct vmw_cmdbuf_man * man , u32 context ) ;
...
position p;
@@
 struct vmw_cmdbuf_dheader cocci_id@p ;
...
typedef bool,u32;
@@
 int cocci_id@p ( struct vmw_cmdbuf_man * man , u32 context , bool enable ) ;
...
position p;
@@
 struct vmw_cmdbuf_alloc_info cocci_id@p ;
...
typedef bool;
@@
 struct vmw_cmdbuf_context {  struct list_head submitted ;  struct list_head hw_submitted ;  struct list_head preempted ;  unsigned num_hw_submitted ;  bool block_submission ; } cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ SVGA_CB_CONTEXT_MAX ] ;
