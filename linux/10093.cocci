...
position p;
@@
 struct ppp_mppe_state {  struct arc4_ctx arc4 ;  struct shash_desc * sha1 ;  unsigned char * sha1_digest ;  unsigned char master_key [ MPPE_MAX_KEY_LEN ] ;  unsigned char session_key [ MPPE_MAX_KEY_LEN ] ;  unsigned keylen ;  unsigned char bits ;  unsigned ccount ;  unsigned stateful ;  int discard ;  int sanity_errors ;  int unit ;  int debug ;  struct compstat stats ; } cocci_id@p ;
...
position p;
@@
 struct ppp_mppe_state * cocci_id@p ;
...
position p;
@@
 struct sha_pad {  unsigned char sha_pad1 [ SHA1_PAD_SIZE ] ;  unsigned char sha_pad2 [ SHA1_PAD_SIZE ] ; } cocci_id@p ;
