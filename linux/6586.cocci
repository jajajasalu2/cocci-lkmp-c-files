...
position p;
@@
 struct mcontroller cocci_id@p [ MAX_CONTROLLERS ] ;
...
typedef adapter_t;
@@
 adapter_t * cocci_id@p [ MAX_CONTROLLERS ] ;
...
position p;
@@
 struct mega_hbas cocci_id@p [ MAX_CONTROLLERS ] ;
...
typedef u_char;
@@
 u_char cocci_id@p [ sizeof ( struct mbox_out ) ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MAX_FIRMWARE_STATUS ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct mbox_out ) ] ;
...
position p;
@@
 unsigned char cocci_id@p [ sizeof ( struct mbox_out ) ] ;
...
position p;
@@
 struct private_bios_data * cocci_id@p ;
