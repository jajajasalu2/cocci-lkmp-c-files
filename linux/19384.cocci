...
position p;
@@
 struct iss_net_private cocci_id@p ;
...
position p;
@@
 struct tuntap_info {  char dev_name [ IFNAMSIZ ] ;  int fd ; } cocci_id@p ;
...
position p;
@@
 struct iss_net_init * cocci_id@p ;
...
position p;
@@
 struct iss_net_init {  struct list_head list ;  char * init ;  int index ; } cocci_id@p ;
