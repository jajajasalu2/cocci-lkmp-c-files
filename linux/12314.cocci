...
position p;
@@
 const struct atmel_hlcdc_dc_desc cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_layer * cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_dc_commit cocci_id@p ;
...
position p;
@@
 struct atmel_hlcdc_dc_commit {  struct work_struct work ;  struct drm_device * dev ;  struct drm_atomic_state * state ; } cocci_id@p ;
