...
position p;
@@
 struct mad_rmpp_recv cocci_id@p ;
...
position p;
@@
 struct opa_rmpp_mad cocci_id@p ;
...
position p;
@@
 enum rmpp_state { RMPP_STATE_ACTIVE , RMPP_STATE_TIMEOUT , RMPP_STATE_COMPLETE , RMPP_STATE_CANCELING , } cocci_id@p ;
