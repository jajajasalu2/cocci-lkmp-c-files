...
position p;
@@
 struct blk_stat_callback * cocci_id@p ;
...
position p;
@@
 struct mq_inflight {  struct hd_struct * part ;  unsigned int inflight [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct flush_busy_ctx_data {  struct blk_mq_hw_ctx * hctx ;  struct list_head * list ; } cocci_id@p ;
...
position p;
@@
 struct dispatch_rq_data {  struct blk_mq_hw_ctx * hctx ;  struct request * rq ; } cocci_id@p ;
...
position p;
@@
 struct flush_busy_ctx_data cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct blk_stat_callback * cb ) ;
...
position p;
@@
 struct dispatch_rq_data cocci_id@p ;
...
position p;
@@
 struct blk_mq_qe_pair {  struct list_head node ;  struct request_queue * q ;  struct elevator_type * type ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct request_queue * q ) ;
...
position p;
@@
 const struct request * cocci_id@p ;
...
position p;
@@
 struct blk_mq_queue_data cocci_id@p ;
...
position p;
@@
 struct blk_mq_qe_pair * cocci_id@p ;
