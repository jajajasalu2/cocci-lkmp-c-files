...
position p;
@@
 struct ipv6_fl_socklist * cocci_id@p ;
...
position p;
@@
 struct ip6fl_iter_state cocci_id@p ;
...
position p;
@@
 struct ip6fl_iter_state {  struct seq_net_private p ;  struct pid_namespace * pid_ns ;  int bucket ; } cocci_id@p ;
