...
symbol cocci_id;
position p;
typedef srv_cls_param_t;
@@
 srv_cls_param_t * cocci_id@p ;
...
typedef u16;
@@
 struct ia_reg {  u16 reg ;  u16 val ; } cocci_id@p ;
...
position p;
@@
 const struct ia_reg cocci_id@p [ ] ;
...
position p;
@@
 struct k_sonet_stats * cocci_id@p ;
...
position p;
@@
 struct cpcs_trailer cocci_id@p ;
...
position p;
@@
 struct abr_vc_table * cocci_id@p ;
...
position p;
@@
 struct cpcs_trailer_desc * cocci_id@p ;
