...
position p;
@@
 struct b43_lo_calib * cocci_id@p ;
...
position p;
@@
 const struct b43_rfatt * cocci_id@p ;
...
position p;
@@
 struct b43_lo_g_statemachine * cocci_id@p ;
...
position p;
@@
 struct lo_g_saved_values * cocci_id@p ;
...
position p;
@@
 const struct b43_bbatt * cocci_id@p ;
...
position p;
@@
 const struct b43_loctl cocci_id@p [ ] ;
...
typedef u16;
@@
 struct b43_lo_g_statemachine {  int current_state ;  int nr_measured ;  int state_val_multiplier ;  u16 lowest_feedth ;  struct b43_loctl min_loctl ; } cocci_id@p ;
...
position p;
@@
 struct b43_txpower_lo_control * cocci_id@p ;
