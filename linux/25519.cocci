...
symbol cocci_id;
position p;
typedef u64,bool,cpu_set_t;
@@
 struct record {  struct perf_tool tool ;  struct record_opts opts ;  u64 bytes_written ;  struct perf_data data ;  struct auxtrace_record * itr ;  struct evlist * evlist ;  struct perf_session * session ;  int realtime_prio ;  bool no_buildid ;  bool no_buildid_set ;  bool no_buildid_cache ;  bool no_buildid_cache_set ;  bool buildid_all ;  bool timestamp_filename ;  bool timestamp_boundary ;  struct switch_output switch_output ;  unsigned long long samples ;  cpu_set_t affinity_mask ;  unsigned long output_max_size ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct record * rec ) ;
...
position p;
@@
 struct perf_record_compressed cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ CALLCHAIN_MAX ] ;
...
position p;
@@
 struct clockid_map {  const char * name ;  int clockid ; } cocci_id@p ;
...
position p;
@@
 const struct perf_event_mmap_page * cocci_id@p ;
...
position p;
@@
 struct perf_data_file * cocci_id@p ;
...
position p;
@@
 struct record_aio {  struct record * rec ;  void * data ;  size_t size ; } cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct record * rec , bool tail ) ;
...
position p;
@@
 struct auxtrace_record * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ PERF_AFFINITY_MAX ] ;
...
position p;
@@
 const struct clockid_map * cocci_id@p ;
...
typedef bool;
@@
 struct switch_output {  bool enabled ;  bool signal ;  unsigned long size ;  unsigned long time ;  const char * str ;  bool set ;  char * * filenames ;  int num_files ;  int cur_file ; } cocci_id@p ;
...
position p;
@@
 struct switch_output * cocci_id@p ;
