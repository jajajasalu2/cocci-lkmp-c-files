...
position p;
@@
 struct vc4_ctm_state {  struct drm_private_state base ;  struct drm_color_ctm * ctm ;  int fifo ; } cocci_id@p ;
...
position p;
@@
 struct vc4_ctm_state cocci_id@p ;
...
position p;
@@
 struct vc4_load_tracker_state cocci_id@p ;
...
typedef u64;
@@
 struct vc4_load_tracker_state {  struct drm_private_state base ;  u64 hvs_load ;  u64 membus_load ; } cocci_id@p ;
