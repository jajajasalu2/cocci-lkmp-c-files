...
position p;
@@
 efx_mcdi_async_completer cocci_id@p ;
...
position p;
@@
 enum efx_filter_flags cocci_id@p ;
...
typedef u16;
@@
 struct efx_ef10_filter_vlan {  struct list_head list ;  u16 vid ;  u16 uc [ EFX_EF10_FILTER_DEV_UC_MAX ] ;  u16 mc [ EFX_EF10_FILTER_DEV_MC_MAX ] ;  u16 default_filters [ EFX_EF10_NUM_DEFAULT_FILTERS ] ; } cocci_id@p ;
...
typedef u16;
@@
 int cocci_id@p ( struct efx_nic * efx , u16 vid ) ;
...
position p;
@@
 enum { EFX_EF10_TEST = 1 , EFX_EF10_REFILL , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct efx_nic * efx ) ;
...
position p;
@@
 struct efx_msi_context * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct efx_nic * efx , struct efx_ef10_filter_vlan * vlan ) ;
...
position p;
@@
 struct efx_rss_context * cocci_id@p ;
...
position p;
@@
 const struct efx_ef10_nvram_type_info * cocci_id@p ;
...
position p;
@@
 enum efx_encap_type cocci_id@p ;
...
position p;
@@
 enum { EF10_RESET_PORT = ( ( ETH_RESET_MAC | ETH_RESET_PHY ) << ETH_RESET_SHARED_SHIFT ) , EF10_RESET_MC = ( ( ETH_RESET_DMA | ETH_RESET_FILTER | ETH_RESET_OFFLOAD | ETH_RESET_MAC | ETH_RESET_PHY | ETH_RESET_MGMT ) << ETH_RESET_SHARED_SHIFT ) , } cocci_id@p ;
...
position p;
@@
 struct efx_udp_tunnel cocci_id@p ;
...
typedef u16;
@@
 struct efx_ef10_vlan {  struct list_head list ;  u16 vid ; } cocci_id@p ;
...
position p;
@@
 const struct efx_hw_stat_desc cocci_id@p [ EF10_STAT_COUNT ] ;
...
typedef bool;
@@
 int ( * cocci_id@p ) ( struct efx_channel * channel , bool temp ) ;
...
typedef u16;
@@
 void cocci_id@p ( struct efx_nic * efx , u16 vid ) ;
...
position p;
@@
 const struct efx_filter_spec * cocci_id@p ;
...
position p;
@@
 struct efx_mcdi_mtd_partition * cocci_id@p ;
...
position p;
@@
 enum efx_filter_priority cocci_id@p ;
...
position p;
@@
 struct efx_rx_queue * cocci_id@p ;
...
position p;
@@
 struct efx_rx_buffer * cocci_id@p ;
...
typedef u8;
@@
 struct efx_ef10_dev_addr {  u8 addr [ ETH_ALEN ] ; } cocci_id@p ;
...
position p;
@@
 struct efx_self_tests * cocci_id@p ;
...
position p;
@@
 const struct efx_ef10_filter_table * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct efx_nic * efx , bool unloading ) ;
...
position p;
@@
 struct efx_ef10_nic_data * cocci_id@p ;
...
position p;
@@
 struct efx_tx_buffer * cocci_id@p ;
...
position p;
@@
 enum efx_ef10_default_filters cocci_id@p [ ] ;
...
position p;
@@
 struct efx_arfs_rule * cocci_id@p ;
...
position p;
@@
 struct efx_ef10_vlan * cocci_id@p ;
...
position p;
@@
 struct efx_tx_queue * cocci_id@p ;
...
position p;
@@
 struct efx_filter_spec cocci_id@p ;
...
position p;
@@
 struct efx_ef10_filter_table * cocci_id@p ;
...
position p;
@@
 struct efx_ef10_filter_vlan * cocci_id@p ;
...
position p;
@@
 enum efx_filter_match_flags cocci_id@p ;
...
position p;
@@
 struct efx_ef10_dev_addr * cocci_id@p ;
...
position p;
@@
 const struct efx_nic_type cocci_id@p ;
