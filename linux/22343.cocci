...
position p;
@@
 const struct module_signature * cocci_id@p ;
...
typedef u8,u32;
@@
 struct modsig {  struct pkcs7_message * pkcs7_msg ;  enum hash_algo hash_algo ;  const u8 * digest ;  u32 digest_size ;  int raw_pkcs7_len ;  u8 raw_pkcs7 [ ] ; } cocci_id@p ;
