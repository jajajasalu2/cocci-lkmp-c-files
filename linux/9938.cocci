...
position p;
@@
 struct carl9170_sta_info cocci_id@p ;
...
position p;
@@
 struct carl9170_sta_tid cocci_id@p ;
...
position p;
@@
 struct _carl9170_tx_superframe cocci_id@p ;
...
position p;
@@
 struct carl9170_vif_info cocci_id@p ;
...
position p;
@@
 const enum carl9170_restart_reasons cocci_id@p ;
...
position p;
@@
 struct carl9170_tsf_rsp cocci_id@p ;
...
position p;
@@
 struct ar9170_rx_head cocci_id@p ;
