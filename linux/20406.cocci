...
position p;
@@
 struct mpx_fault_info cocci_id@p ;
...
position p;
@@
 struct bad_iret_stack cocci_id@p ;
...
position p;
@@
 const struct mpx_bndcsr * cocci_id@p ;
...
position p;
@@
 struct bad_iret_stack {  void * error_entry_ret ;  struct pt_regs regs ; } cocci_id@p ;
