...
@@
 struct sfax_hw {  struct list_head list ;  struct pci_dev * pdev ;  char name [ MISDN_MAX_IDLEN ] ;  u32 irq ;  u32 irqcnt ;  u32 cfg ;  struct _ioport p_isac ;  struct _ioport p_isar ;  u8 aux_data ;  spinlock_t lock ;  struct isac_hw isac ;  struct isar_hw isar ; } cocci_id@p ;
