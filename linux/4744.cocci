...
position p;
@@
 struct siw_ucontext * cocci_id@p ;
...
position p;
@@
 enum siw_qp_attr_mask cocci_id@p ;
...
position p;
@@
 struct siw_user_mmap_entry * cocci_id@p ;
...
position p;
@@
 struct siw_uresp_reg_mr cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ IB_QPS_ERR + 1 ] [ sizeof ( "RESET" ) ] ;
...
position p;
@@
 struct siw_uresp_alloc_ctx cocci_id@p ;
...
position p;
@@
 struct siw_uresp_create_cq cocci_id@p ;
...
position p;
@@
 struct siw_ureq_reg_mr cocci_id@p ;
...
position p;
@@
 struct siw_qp_attrs cocci_id@p ;
...
position p;
@@
 struct siw_uresp_create_qp cocci_id@p ;
...
position p;
@@
 struct siw_uresp_create_srq cocci_id@p ;
