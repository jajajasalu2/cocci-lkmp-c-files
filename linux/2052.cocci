...
position p;
@@
 enum fxas21002c_channel_index { CHANNEL_SCAN_INDEX_X , CHANNEL_SCAN_INDEX_Y , CHANNEL_SCAN_INDEX_Z , CHANNEL_SCAN_MAX , } cocci_id@p ;
...
position p;
@@
 enum fxas21002c_mode_state cocci_id@p ;
...
typedef u8,s16,s64;
@@
 struct fxas21002c_data {  u8 chip_id ;  enum fxas21002c_mode_state mode ;  enum fxas21002c_mode_state prev_mode ;  struct mutex lock ;  struct regmap * regmap ;  struct regmap_field * regmap_fields [ F_MAX_FIELDS ] ;  struct iio_trigger * dready_trig ;  s64 timestamp ;  int irq ;  struct regulator * vdd ;  struct regulator * vddio ;  s16 buffer [ 8 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 enum fxas21002c_fields cocci_id@p ;
...
position p;
@@
 struct fxas21002c_data * cocci_id@p ;
...
position p;
@@
 enum fxas21002c_mode_state { FXAS21002C_MODE_STANDBY , FXAS21002C_MODE_READY , FXAS21002C_MODE_ACTIVE , } cocci_id@p ;
