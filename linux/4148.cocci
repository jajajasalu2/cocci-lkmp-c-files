...
position p;
@@
 struct phy_meson8b_usb2_priv {  void __iomem * regs ;  enum usb_dr_mode dr_mode ;  struct clk * clk_usb_general ;  struct clk * clk_usb ;  struct reset_control * reset ; } cocci_id@p ;
...
position p;
@@
 struct phy_meson8b_usb2_priv * cocci_id@p ;
