...
position p;
@@
 enum { adp8860 , adp8861 , adp8863 , } cocci_id@p ;
...
position p;
@@
 struct adp8860_led {  struct led_classdev cdev ;  struct work_struct work ;  struct i2c_client * client ;  enum led_brightness new_brightness ;  int id ;  int flags ; } cocci_id@p ;
...
position p;
@@
 struct adp8860_bl {  struct i2c_client * client ;  struct backlight_device * bl ;  struct adp8860_led * led ;  struct adp8860_backlight_platform_data * pdata ;  struct mutex lock ;  unsigned long cached_daylight_max ;  int id ;  int revid ;  int current_brightness ;  unsigned en_ambl_sens : 1 ;  unsigned gdwn_dis : 1 ; } cocci_id@p ;
...
position p;
@@
 struct adp8860_backlight_platform_data * cocci_id@p ;
