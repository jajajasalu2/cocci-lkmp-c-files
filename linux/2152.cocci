...
position p;
@@
 const struct gpio_charger_platform_data * cocci_id@p ;
...
typedef bool;
@@
 struct gpio_charger {  unsigned int irq ;  unsigned int charge_status_irq ;  bool wakeup_enabled ;  struct power_supply * charger ;  struct power_supply_desc charger_desc ;  struct gpio_desc * gpiod ;  struct gpio_desc * charge_status ; } cocci_id@p ;
...
position p;
@@
 struct gpio_charger * cocci_id@p ;
