...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_XFRM_MAX + 1 ] ;
...
position p;
@@
 const struct xfrm_if_parms * cocci_id@p ;
...
position p;
@@
 struct xfrm_if_parms cocci_id@p ;
...
position p;
@@
 struct xfrmi_net {  struct xfrm_if __rcu * xfrmi [ 1 ] ; } cocci_id@p ;
