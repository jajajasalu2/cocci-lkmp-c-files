...
position p;
@@
 struct ice_dcbx_cfg * cocci_id@p ;
...
position p;
@@
 struct ice_netdev_priv * cocci_id@p ;
...
position p;
@@
 const struct ice_priv_flag * cocci_id@p ;
...
typedef u32;
@@
 struct ice_priv_flag {  char name [ ETH_GSTRING_LEN ] ;  u32 bitno ; } cocci_id@p ;
...
position p;
@@
 const struct ice_stats cocci_id@p [ ] ;
...
position p;
@@
 struct ice_ring_container * cocci_id@p ;
...
position p;
@@
 enum ice_container_type { ICE_RX_CONTAINER , ICE_TX_CONTAINER , } cocci_id@p ;
...
position p;
@@
 union ice_32b_rx_flex_desc * cocci_id@p ;
...
position p;
@@
 struct ice_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int sizeof_stat ;  int stat_offset ; } cocci_id@p ;
...
position p;
@@
 enum ice_ethtool_test_id { ICE_ETH_TEST_REG = 0 , ICE_ETH_TEST_EEPROM , ICE_ETH_TEST_INTR , ICE_ETH_TEST_LOOP , ICE_ETH_TEST_LINK , } cocci_id@p ;
...
position p;
@@
 struct ice_q_vector * cocci_id@p ;
...
position p;
@@
 enum ice_container_type cocci_id@p ;
...
typedef u32;
@@
 struct ice_diag_reg_test_info {  u32 address ;  u32 mask ;  u32 elem_num ;  u32 elem_size ; } cocci_id@p [ ] ;
