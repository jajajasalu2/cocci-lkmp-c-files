...
symbol cocci_id;
position p;
typedef drm_savage_cmd_header_t;
@@
 drm_savage_cmd_header_t cocci_id@p ;
...
typedef drm_savage_cmd_header_t;
@@
 const drm_savage_cmd_header_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef drm_savage_cmdbuf_t;
@@
 drm_savage_cmdbuf_t * cocci_id@p ;
...
position p;
@@
 const struct drm_buf * cocci_id@p ;
