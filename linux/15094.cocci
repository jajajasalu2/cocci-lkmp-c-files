...
position p;
@@
 const struct ingenic_cgu_clk_info * cocci_id@p ;
...
position p;
@@
 const struct ingenic_cgu_pll_info * cocci_id@p ;
...
position p;
@@
 const struct ingenic_cgu_gate_info * cocci_id@p ;
