...
position p;
@@
 struct exynos_pcie_mem_res {  void __iomem * elbi_base ; } cocci_id@p ;
...
position p;
@@
 struct exynos_pcie {  struct dw_pcie * pci ;  struct exynos_pcie_mem_res * mem_res ;  struct exynos_pcie_clk_res * clk_res ;  const struct exynos_pcie_ops * ops ;  int reset_gpio ;  struct phy * phy ; } cocci_id@p ;
...
position p;
@@
 struct exynos_pcie_clk_res {  struct clk * clk ;  struct clk * bus_clk ; } cocci_id@p ;
...
position p;
@@
 const struct exynos_pcie_ops * cocci_id@p ;
