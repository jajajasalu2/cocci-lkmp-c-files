...
position p;
@@
 struct hclgevf_rss_input_tuple_cmd * cocci_id@p ;
...
position p;
@@
 struct hclgevf_rss_config_cmd * cocci_id@p ;
...
position p;
@@
 enum hclgevf_evt_cause cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HCLGEVF_TQPS_DEPTH_INFO_LEN ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ HCLGEVF_VLAN_MBX_MSG_LEN ] ;
...
position p;
@@
 struct hclgevf_misc_vector * cocci_id@p ;
...
position p;
@@
 struct hclgevf_desc cocci_id@p ;
...
position p;
@@
 struct hclge_mbx_vf_to_pf_cmd * cocci_id@p ;
...
position p;
@@
 struct hclgevf_cfg_com_tqp_queue_cmd * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ HCLGEVF_RSS_MBX_RESP_LEN ] ;
...
position p;
@@
 struct hclgevf_rss_tc_mode_cmd * cocci_id@p ;
...
position p;
@@
 struct hclgevf_rss_cfg * cocci_id@p ;
...
position p;
@@
 struct hclgevf_cfg_gro_status_cmd * cocci_id@p ;
...
position p;
@@
 struct hclgevf_query_res_cmd * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct hclgevf_dev * hdev ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ HCLGEVF_TQPS_RSS_INFO_LEN ] ;
...
position p;
@@
 struct hclgevf_rss_indirection_table_cmd * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ HCLGEVF_MAX_TC_NUM ] ;
