...
position p;
@@
 const struct koneplus_device * cocci_id@p ;
...
position p;
@@
 enum koneplus_control_requests cocci_id@p ;
...
position p;
@@
 const struct koneplus_mouse_report_button * cocci_id@p ;
...
position p;
@@
 struct koneplus_device * cocci_id@p ;
...
position p;
@@
 struct koneplus_roccat_report cocci_id@p ;
...
position p;
@@
 struct koneplus_info cocci_id@p ;
...
position p;
@@
 struct koneplus_actual_profile cocci_id@p ;
