...
position p;
@@
 struct hl_vm_hash_node * cocci_id@p ;
...
position p;
@@
 struct hl_mmu_properties * cocci_id@p ;
...
position p;
@@
 struct hl_vm_phys_pg_pack * cocci_id@p ;
...
position p;
@@
 struct hl_debugfs_entry * cocci_id@p ;
...
position p;
@@
 const struct hl_info_list cocci_id@p [ ] ;
...
position p;
@@
 struct hl_dbg_device_entry * cocci_id@p ;
