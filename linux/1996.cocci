...
typedef u8;
@@
 struct mcp4922_state {  struct spi_device * spi ;  unsigned int value [ MCP4922_NUM_CHANNELS ] ;  unsigned int vref_mv ;  struct regulator * vref_reg ;  u8 mosi [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 const struct iio_chan_spec cocci_id@p [ 3 ] [ MCP4922_NUM_CHANNELS ] ;
...
position p;
@@
 struct mcp4922_state * cocci_id@p ;
...
position p;
@@
 enum mcp4922_supported_device_ids { ID_MCP4902 , ID_MCP4912 , ID_MCP4922 , } cocci_id@p ;
