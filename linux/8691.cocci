...
position p;
@@
 struct igc_mac_addr cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct igc_adapter * adapter , bool msix ) ;
...
position p;
@@
 const struct igc_info * cocci_id@p [ ] ;
...
position p;
@@
 struct igc_rx_buffer * cocci_id@p ;
...
position p;
@@
 union igc_adv_rx_desc cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct igc_ring * tx_ring ) ;
...
position p;
@@
 void cocci_id@p ( struct igc_adapter * adapter ) ;
...
position p;
@@
 int cocci_id@p ( struct igc_adapter * ) ;
...
position p;
@@
 void cocci_id@p ( struct igc_q_vector * q_vector ) ;
...
position p;
@@
 struct igc_adv_tx_context_desc * cocci_id@p ;
...
position p;
@@
 struct igc_ring_container * cocci_id@p ;
...
position p;
@@
 const struct igc_mac_addr * cocci_id@p ;
...
position p;
@@
 union igc_adv_tx_desc * cocci_id@p ;
...
position p;
@@
 struct igc_phy_info * cocci_id@p ;
...
position p;
@@
 struct igc_nfc_filter * cocci_id@p ;
...
position p;
@@
 struct igc_mac_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct igc_q_vector * q_vector , int msix_vector ) ;
...
position p;
@@
 struct igc_tx_buffer cocci_id@p ;
...
position p;
@@
 struct igc_q_vector cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct igc_ring * rx_ring , struct igc_rx_buffer * bi ) ;
...
position p;
@@
 void cocci_id@p ( struct igc_adapter * adapter , int v_idx ) ;
