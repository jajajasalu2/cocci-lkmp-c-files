...
position p;
@@
 void cocci_id@p ( struct iscsi_cmd * ) ;
...
position p;
@@
 struct iscsit_transport * cocci_id@p ;
...
typedef u8,u32;
@@
 u32 cocci_id@p ( struct ahash_request * , struct iscsi_cmd * , u32 , u32 , u32 , u8 * ) ;
...
position p;
@@
 struct iscsi_datain_req cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct ahash_request * , const void * , u32 , u32 , const void * , void * ) ;
...
position p;
@@
 struct iscsi_tpg_np cocci_id@p ;
...
position p;
@@
 struct iscsi_r2t_rsp * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ ISCSI_IQN_LEN + 12 ] ;
...
position p;
@@
 struct iscsi_tmr_req * cocci_id@p ;
...
position p;
@@
 struct iscsit_global * cocci_id@p ;
...
position p;
@@
 enum iscsit_transport_type cocci_id@p ;
...
position p;
@@
 const struct iscsi_datain * cocci_id@p ;
...
position p;
@@
 struct iscsi_ooo_cmdsn cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct iscsi_cmd * cmd , struct kvec * iov , int nvec , u32 data_offset , u32 data_length ) ;
...
position p;
@@
 struct iscsi_queue_req cocci_id@p ;
...
position p;
@@
 struct iscsi_portal_group * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct iscsi_conn * ) ;
...
position p;
@@
 struct iscsi_datain cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct iscsi_cmd * , struct iscsi_scsi_req * , u32 ) ;
...
position p;
@@
 enum target_prot_op cocci_id@p ;
...
position p;
@@
 struct iscsi_conn_recovery * cocci_id@p ;
...
position p;
@@
 struct iscsi_data_rsp * cocci_id@p ;
