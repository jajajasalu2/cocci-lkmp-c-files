...
position p;
@@
 void cocci_id@p ( unsigned char * read , unsigned char * written , int start , int len ) ;
...
position p;
@@
 void cocci_id@p ( unsigned char * read , unsigned char * written ) ;
...
position p;
@@
 int cocci_id@p ( unsigned char * buf , unsigned char * check_buf , unsigned offset , unsigned len , unsigned * bytesp , unsigned * bitsp ) ;
