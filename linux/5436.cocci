...
@@
 struct stm32_spi {  struct device * dev ;  struct spi_master * master ;  const struct stm32_spi_cfg * cfg ;  void __iomem * base ;  struct clk * clk ;  u32 clk_rate ;  struct reset_control * rst ;  spinlock_t lock ;  int irq ;  unsigned int fifo_size ;  unsigned int cur_midi ;  unsigned int cur_speed ;  unsigned int cur_bpw ;  unsigned int cur_fthlv ;  unsigned int cur_comm ;  unsigned int cur_xferlen ;  bool cur_usedma ;  const void * tx_buf ;  void * rx_buf ;  int tx_len ;  int rx_len ;  struct dma_chan * dma_tx ;  struct dma_chan * dma_rx ;  dma_addr_t phys_addr ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_spi_cfg * cocci_id@p ;
...
position p;
@@
 struct stm32_spi_reg {  int reg ;  int mask ;  int shift ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_spi_regspec cocci_id@p ;
