...
position p;
@@
 struct parport_ip32_dma_data cocci_id@p ;
...
@@
 struct parport_ip32_dma_data {  enum dma_data_direction dir ;  dma_addr_t buf ;  dma_addr_t next ;  size_t len ;  size_t left ;  unsigned int ctx ;  unsigned int irq_on ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct parport_ip32_regs {  void __iomem * data ;  void __iomem * dsr ;  void __iomem * dcr ;  void __iomem * eppAddr ;  void __iomem * eppData0 ;  void __iomem * eppData1 ;  void __iomem * eppData2 ;  void __iomem * eppData3 ;  void __iomem * ecpAFifo ;  void __iomem * fifo ;  void __iomem * cnfgA ;  void __iomem * cnfgB ;  void __iomem * ecr ; } cocci_id@p ;
...
position p;
@@
 enum parport_ip32_irq_mode cocci_id@p ;
...
position p;
@@
 struct parport_ip32_private {  struct parport_ip32_regs regs ;  unsigned int dcr_cache ;  unsigned int dcr_writable ;  unsigned int pword ;  unsigned int fifo_depth ;  unsigned int readIntrThreshold ;  unsigned int writeIntrThreshold ;  enum parport_ip32_irq_mode irq_mode ;  struct completion irq_complete ; } cocci_id@p ;
...
position p;
@@
 const struct parport_operations cocci_id@p ;
...
position p;
@@
 struct parport_ip32_regs cocci_id@p ;
...
position p;
@@
 struct parport_ip32_private * cocci_id@p ;
...
position p;
@@
 enum parport_ip32_irq_mode { PARPORT_IP32_IRQ_FWD , PARPORT_IP32_IRQ_HERE , } cocci_id@p ;
...
position p;
@@
 struct parport_ip32_private * constcocci_id ;
