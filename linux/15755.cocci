...
position p;
@@
 union ion_ioctl_arg * cocci_id@p ;
...
position p;
@@
 union ion_ioctl_arg {  struct ion_allocation_data allocation ;  struct ion_heap_query query ; } cocci_id@p ;
...
position p;
@@
 struct ion_dma_buf_attachment * cocci_id@p ;
...
position p;
@@
 struct ion_heap_query * cocci_id@p ;
...
position p;
@@
 struct ion_heap_data cocci_id@p ;
...
position p;
@@
 struct ion_dma_buf_attachment {  struct device * dev ;  struct sg_table * table ;  struct list_head list ; } cocci_id@p ;
