...
position p;
@@
 const struct uverbs_obj_fd_type * cocci_id@p ;
...
position p;
@@
 const struct uverbs_obj_idr_type * cocci_id@p ;
...
position p;
@@
 enum uverbs_obj_access cocci_id@p ;
...
position p;
@@
 struct uverbs_obj_idr_type cocci_id@p ;
...
position p;
@@
 const struct uverbs_obj_type_class cocci_id@p ;
...
position p;
@@
 enum rdma_lookup_mode cocci_id@p ;
...
position p;
@@
 struct uverbs_obj_fd_type cocci_id@p ;
