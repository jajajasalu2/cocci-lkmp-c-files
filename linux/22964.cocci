...
position p;
@@
 struct seq_midisynth_client * cocci_id@p [ SNDRV_CARDS ] ;
...
position p;
@@
 struct snd_rawmidi_runtime * cocci_id@p ;
...
position p;
@@
 struct snd_rawmidi_params cocci_id@p ;
...
position p;
@@
 struct seq_midisynth * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef snd_seq_dump_func_t;
@@
 snd_seq_dump_func_t cocci_id@p ;
...
position p;
@@
 struct snd_seq_device * cocci_id@p ;
...
position p;
@@
 struct snd_seq_driver cocci_id@p ;
...
position p;
@@
 struct seq_midisynth_client {  int seq_client ;  int num_ports ;  int ports_per_device [ SNDRV_RAWMIDI_DEVICES ] ;  struct seq_midisynth * ports [ SNDRV_RAWMIDI_DEVICES ] ; } cocci_id@p ;
...
position p;
@@
 struct snd_rawmidi_info * cocci_id@p ;
...
position p;
@@
 struct seq_midisynth_client * cocci_id@p ;
...
position p;
@@
 struct seq_midisynth {  struct snd_card * card ;  int device ;  int subdevice ;  struct snd_rawmidi_file input_rfile ;  struct snd_rawmidi_file output_rfile ;  int seq_client ;  int seq_port ;  struct snd_midi_event * parser ; } cocci_id@p ;
