...
position p;
@@
 struct snd_sof_dsp_ops cocci_id@p ;
...
position p;
@@
 struct imx8_priv {  struct device * dev ;  struct snd_sof_dev * sdev ;  struct imx_dsp_ipc * dsp_ipc ;  struct platform_device * ipc_dev ;  struct imx_sc_ipc * sc_ipc ;  int num_domains ;  struct device * * pd_dev ;  struct device_link * * link ; } cocci_id@p ;
