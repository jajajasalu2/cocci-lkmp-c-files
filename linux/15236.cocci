...
position p;
@@
 struct heartbeat_trig_data * cocci_id@p ;
...
position p;
@@
 struct heartbeat_trig_data {  struct led_classdev * led_cdev ;  unsigned int phase ;  unsigned int period ;  struct timer_list timer ;  unsigned int invert ; } cocci_id@p ;
