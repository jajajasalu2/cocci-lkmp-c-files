...
position p;
@@
 struct vx_audio_level * cocci_id@p ;
...
position p;
@@
 union vx_codec_data cocci_id@p ;
...
position p;
@@
 struct vx_audio_level {  unsigned int has_level : 1 ;  unsigned int has_monitor_level : 1 ;  unsigned int has_mute : 1 ;  unsigned int has_monitor_mute : 1 ;  unsigned int mute ;  unsigned int monitor_mute ;  short level ;  short monitor_level ; } cocci_id@p ;
...
position p;
@@
 struct vx_vu_meter {  int saturated ;  int vu_level ;  int peak_level ; } cocci_id@p ;
...
position p;
@@
 struct vx_vu_meter cocci_id@p [ 2 ] ;
