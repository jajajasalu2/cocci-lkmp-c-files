...
position p;
@@
 enum perf_cmd { PERF_CMD_INVAL = - 1 , PERF_CMD_SSIZE = 0 , PERF_CMD_RSIZE = 1 , PERF_CMD_SXLAT = 2 , PERF_CMD_RXLAT = 3 , PERF_CMD_CLEAR = 4 , PERF_STS_DONE = 5 , PERF_STS_LNKUP = 6 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,resource_size_t,dma_addr_t;
@@
 struct perf_peer {  struct perf_ctx * perf ;  int pidx ;  int gidx ;  u64 outbuf_xlat ;  resource_size_t outbuf_size ;  void __iomem * outbuf ;  dma_addr_t inbuf_xlat ;  resource_size_t inbuf_size ;  void * inbuf ;  struct work_struct service ;  unsigned long sts ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,wait_queue_head_t,ktime_t,atomic_t;
@@
 struct perf_thread {  struct perf_ctx * perf ;  int tidx ;  atomic_t dma_sync ;  wait_queue_head_t dma_wait ;  struct dma_chan * dma_chan ;  void * src ;  u64 copied ;  ktime_t duration ;  int status ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct perf_ctx * perf ) ;
