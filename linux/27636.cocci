...
position p;
@@
 struct rubin_state {  unsigned long p ;  unsigned long q ;  unsigned long rec_q ;  long bit_number ;  struct pushpull pp ;  int bit_divider ;  int bits [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct pushpull {  unsigned char * buf ;  unsigned int buflen ;  unsigned int ofs ;  unsigned int reserve ; } cocci_id@p ;
...
position p;
@@
 struct jffs2_compressor cocci_id@p ;
