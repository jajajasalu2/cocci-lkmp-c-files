...
position p;
@@
 struct qrange {  unsigned long start ;  unsigned long end ; } cocci_id@p ;
...
position p;
@@
 struct qin64 {  char qopcode ;  char rsrv1 [ 3 ] ;  char qrcode ;  char rsrv2 [ 3 ] ;  char qname [ 8 ] ;  unsigned int qoutptr ;  short int qoutlen ; } cocci_id@p ;
...
typedef refcount_t;
@@
 struct dcss_segment {  struct list_head list ;  char dcss_name [ 8 ] ;  char res_name [ 16 ] ;  unsigned long start_addr ;  unsigned long end ;  refcount_t ref_count ;  int do_nonshared ;  unsigned int vm_segtype ;  struct qrange range [ 6 ] ;  int segcnt ;  struct resource * res ; } cocci_id@p ;
...
position p;
@@
 struct dcss_segment cocci_id@p ;
...
position p;
@@
 struct qout64 {  unsigned long segstart ;  unsigned long segend ;  int segcnt ;  int segrcnt ;  struct qrange range [ 6 ] ; } cocci_id@p ;
