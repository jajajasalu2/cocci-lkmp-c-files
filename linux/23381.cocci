...
position p;
@@
 struct pll_ {  unsigned int pre_div : 4 ;  unsigned int n : 4 ;  unsigned int k ; } cocci_id@p ;
...
position p;
@@
 struct wm8510_priv {  struct regmap * regmap ; } cocci_id@p ;
