...
typedef bool;
@@
 struct abx500_chargalg_suspension_status {  bool suspended_change ;  bool ac_suspended ;  bool usb_suspended ; } cocci_id@p ;
...
typedef bool;
@@
 struct abx500_chargalg_charger_info {  enum abx500_chargers conn_chg ;  enum abx500_chargers prev_conn_chg ;  enum abx500_chargers online_chg ;  enum abx500_chargers prev_online_chg ;  enum abx500_chargers charger_type ;  bool usb_chg_ok ;  bool ac_chg_ok ;  int usb_volt ;  int usb_curr ;  int ac_volt ;  int ac_curr ;  int usb_vset ;  int usb_iset ;  int ac_vset ;  int ac_iset ; } cocci_id@p ;
...
position p;
@@
 enum abx500_chargers { NO_CHG , AC_CHG , USB_CHG , } cocci_id@p ;
...
position p;
@@
 enum maxim_ret { MAXIM_RET_NOACTION , MAXIM_RET_CHANGE , MAXIM_RET_IBAT_TOO_HIGH , } cocci_id@p ;
...
position p;
@@
 struct abx500_chargalg * cocci_id@p ;
...
position p;
@@
 struct abx500_chargalg_sysfs_entry cocci_id@p ;
...
typedef bool;
@@
 struct abx500_chargalg {  struct device * dev ;  int charge_status ;  int eoc_cnt ;  bool maintenance_chg ;  int t_hyst_norm ;  int t_hyst_lowhigh ;  enum abx500_chargalg_states charge_state ;  struct abx500_charge_curr_maximization ccm ;  struct abx500_chargalg_charger_info chg_info ;  struct abx500_chargalg_battery_data batt_data ;  struct abx500_chargalg_suspension_status susp_status ;  struct ab8500 * parent ;  struct abx500_chargalg_current_step_status curr_status ;  struct abx500_bm_data * bm ;  struct power_supply * chargalg_psy ;  struct ux500_charger * ac_chg ;  struct ux500_charger * usb_chg ;  struct abx500_chargalg_events events ;  struct workqueue_struct * chargalg_wq ;  struct delayed_work chargalg_periodic_work ;  struct delayed_work chargalg_wd_work ;  struct work_struct chargalg_work ;  struct hrtimer safety_timer ;  struct hrtimer maintenance_timer ;  struct kobject chargalg_kobject ; } cocci_id@p ;
...
typedef bool;
@@
 struct abx500_chargalg_current_step_status {  bool curr_step_change ;  int curr_step ; } cocci_id@p ;
...
typedef u8;
@@
 struct abx500_charge_curr_maximization {  int original_iset ;  int current_iset ;  int test_delta_i ;  int condition_cnt ;  int max_current ;  int wait_cnt ;  u8 level ; } cocci_id@p ;
...
position p;
@@
 struct abx500_chargalg_battery_data {  int temp ;  int volt ;  int avg_curr ;  int inst_curr ;  int percent ; } cocci_id@p ;
...
position p;
@@
 enum abx500_chargalg_states cocci_id@p ;
