...
position p;
@@
 struct nl8048_panel {  struct drm_panel panel ;  struct spi_device * spi ;  struct gpio_desc * reset_gpio ; } cocci_id@p ;
...
position p;
@@
 struct nl8048_panel * cocci_id@p ;
...
position p;
@@
 const struct {  unsigned char addr ;  unsigned char data ; } cocci_id@p [ ] ;
