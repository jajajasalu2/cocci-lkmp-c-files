...
position p;
@@
 struct smsc911x_platform_config cocci_id@p ;
...
position p;
@@
 struct wm831x_backlight_pdata cocci_id@p ;
...
position p;
@@
 struct s3c_ide_platdata cocci_id@p ;
...
position p;
@@
 struct {  int regulator ;  struct regulator_init_data * initdata ; } cocci_id@p [ ] ;
...
position p;
@@
 struct samsung_bl_gpio_info cocci_id@p ;
