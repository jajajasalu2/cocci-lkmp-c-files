...
position p;
@@
 struct csc_coeffs {  struct encoding_direction y2r ;  struct encoding_direction r2y ; } cocci_id@p ;
...
position p;
@@
 struct encoding_direction {  struct colorspace r601 ;  struct colorspace r709 ; } cocci_id@p ;
...
position p;
@@
 struct colorspace {  struct quantization limited ;  struct quantization full ; } cocci_id@p ;
...
typedef u16;
@@
 struct quantization {  u16 coeff [ 12 ] ; } cocci_id@p ;
