...
position p;
@@
 const struct max6697_chip_data cocci_id@p [ ] ;
...
typedef u8,u32;
@@
 struct max6697_chip_data {  int channels ;  u32 have_ext ;  u32 have_crit ;  u32 have_fault ;  u8 valid_conf ;  const u8 * alarm_map ; } cocci_id@p ;
...
position p;
@@
 struct max6697_data * cocci_id@p ;
...
position p;
@@
 struct max6697_platform_data cocci_id@p ;
...
position p;
@@
 enum chips { max6581 , max6602 , max6622 , max6636 , max6689 , max6693 , max6694 , max6697 , max6698 , max6699 , } cocci_id@p ;
