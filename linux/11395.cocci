...
position p;
@@
 struct vmw_user_buffer_object cocci_id@p ;
...
position p;
@@
 struct drm_vmw_alloc_dmabuf_req * cocci_id@p ;
...
position p;
@@
 struct vmw_user_buffer_object {  struct ttm_prime_object prime ;  struct vmw_buffer_object vbo ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct ttm_buffer_object * bo ) ;
...
position p;
@@
 const struct ttm_buffer_object * cocci_id@p ;
...
position p;
@@
 struct drm_vmw_dmabuf_rep * cocci_id@p ;
