...
position p;
@@
 struct scif_pollepd * cocci_id@p ;
...
position p;
@@
 enum conn_async_state { ASYNC_CONN_IDLE = 1 , ASYNC_CONN_INPROGRESS , ASYNC_CONN_FLUSH_WORK , } cocci_id@p ;
...
position p;
@@
 struct scif_peer_dev * cocci_id@p ;
...
position p;
@@
 enum scif_epd_state cocci_id@p ;
...
position p;
@@
 struct scif_port_id * cocci_id@p ;
