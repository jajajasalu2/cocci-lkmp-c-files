...
position p;
@@
 struct lm3642_chip_data cocci_id@p ;
...
typedef u8;
@@
 struct lm3642_chip_data {  struct device * dev ;  struct led_classdev cdev_flash ;  struct led_classdev cdev_torch ;  struct led_classdev cdev_indicator ;  u8 br_flash ;  u8 br_torch ;  u8 br_indicator ;  enum lm3642_torch_pin_enable torch_pin ;  enum lm3642_strobe_pin_enable strobe_pin ;  enum lm3642_tx_pin_enable tx_pin ;  struct lm3642_platform_data * pdata ;  struct regmap * regmap ;  struct mutex lock ;  unsigned int last_flag ; } cocci_id@p ;
...
position p;
@@
 enum lm3642_mode { MODES_STASNDBY = 0 , MODES_INDIC , MODES_TORCH , MODES_FLASH , } cocci_id@p ;
...
position p;
@@
 struct lm3642_platform_data * cocci_id@p ;
