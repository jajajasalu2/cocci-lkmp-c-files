...
position p;
@@
 struct cudbg_buffer * cocci_id@p ;
...
position p;
@@
 struct cudbg_tid_info_region_rev1 * cocci_id@p ;
...
position p;
@@
 struct cudbg_hw_sched cocci_id@p ;
...
position p;
@@
 struct cudbg_qdesc_entry cocci_id@p ;
...
position p;
@@
 struct cudbg_tid_data cocci_id@p ;
...
position p;
@@
 struct cudbg_qdesc_info cocci_id@p ;
...
position p;
@@
 struct cudbg_tid_info_region * cocci_id@p ;
...
position p;
@@
 struct cudbg_region_info cocci_id@p [ CTXT_CNM + 1 ] ;
...
position p;
@@
 struct cudbg_clk_info * cocci_id@p ;
...
position p;
@@
 struct cudbg_mem_desc cocci_id@p ;
...
position p;
@@
 struct cudbg_cim_pif_la cocci_id@p ;
...
position p;
@@
 struct cudbg_entity_hdr * cocci_id@p ;
...
position p;
@@
 struct cudbg_pm_stats cocci_id@p ;
...
position p;
@@
 struct cudbg_mps_tcam cocci_id@p ;
...
position p;
@@
 struct cudbg_rss_vf_conf cocci_id@p ;
...
position p;
@@
 struct cudbg_mbox_log cocci_id@p ;
...
position p;
@@
 struct cudbg_ch_cntxt * cocci_id@p ;
...
position p;
@@
 struct cudbg_ulprx_la * cocci_id@p ;
...
position p;
@@
 struct cudbg_pbt_tables cocci_id@p ;
...
position p;
@@
 struct cudbg_cim_qcfg * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ CUDBG_VPD_VER_LEN + 1 ] ;
...
position p;
@@
 const struct cudbg_mem_desc * cocci_id@p ;
...
position p;
@@
 struct cudbg_region_info cocci_id@p [ 2 ] ;
...
position p;
@@
 struct cudbg_ver_hdr * cocci_id@p ;
...
position p;
@@
 struct sge_qbase_reg_field * cocci_id@p ;
...
position p;
@@
 struct cudbg_vpd_data * cocci_id@p ;
...
position p;
@@
 struct cudbg_region_info * cocci_id@p ;
...
position p;
@@
 struct cudbg_ulptx_la cocci_id@p ;
