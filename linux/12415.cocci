...
position p;
@@
 struct omap_framebuffer {  struct drm_framebuffer base ;  int pin_count ;  const struct drm_format_info * format ;  struct plane planes [ 2 ] ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct omap_framebuffer cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct plane {  dma_addr_t dma_addr ; } cocci_id@p ;
