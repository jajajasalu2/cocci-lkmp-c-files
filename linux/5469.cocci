...
position p;
@@
 struct spi_engine_program * cocci_id@p ;
...
typedef uint16_t;
@@
 struct spi_engine_program {  unsigned int length ;  uint16_t instructions [ ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef uint16_t,uint8_t,spinlock_t;
@@
 struct spi_engine {  struct clk * clk ;  struct clk * ref_clk ;  spinlock_t lock ;  void __iomem * base ;  struct spi_message * msg ;  struct spi_engine_program * p ;  unsigned cmd_length ;  const uint16_t * cmd_buf ;  struct spi_transfer * tx_xfer ;  unsigned int tx_length ;  const uint8_t * tx_buf ;  struct spi_transfer * rx_xfer ;  unsigned int rx_length ;  uint8_t * rx_buf ;  unsigned int sync_id ;  unsigned int completed_id ;  unsigned int int_enable ; } cocci_id@p ;
