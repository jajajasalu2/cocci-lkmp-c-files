...
position p;
@@
 struct sun4i_csi_buffer cocci_id@p ;
...
position p;
@@
 struct sun4i_csi_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 const struct vb2_buffer * cocci_id@p ;
