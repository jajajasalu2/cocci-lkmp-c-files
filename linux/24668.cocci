...
typedef ip_set_id_t;
@@
 struct set_adt_elem {  ip_set_id_t id ;  ip_set_id_t refid ;  int before ; } cocci_id@p ;
...
position p;
@@
 struct set_adt_elem * cocci_id@p ;
...
position p;
@@
 const struct list_set * cocci_id@p ;
...
typedef u32;
@@
 struct list_set {  u32 size ;  struct timer_list gc ;  struct ip_set * set ;  struct net * net ;  struct list_head members ; } cocci_id@p ;
...
position p;
@@
 const struct ip_set_type_variant cocci_id@p ;
