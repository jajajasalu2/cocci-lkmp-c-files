...
position p;
@@
 struct nps_host_reg_mtm_cpu_cfg cocci_id@p ;
...
position p;
@@
 struct nps_host_reg_aux_lpc cocci_id@p ;
...
position p;
@@
 struct nps_host_reg_aux_hw_comply cocci_id@p ;
...
typedef u32;
@@
 struct {  union {  struct {  u32 num : 8 , cluster : 8 , core : 8 , thread : 8 ; } ;  u32 value ; } ; } cocci_id@p ;
