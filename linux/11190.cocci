...
position p;
@@
 enum dcn10_coef_filter_type_sel cocci_id@p ;
...
position p;
@@
 enum lb_memory_config cocci_id@p ;
...
position p;
@@
 const struct line_buffer_params * cocci_id@p ;
