...
typedef u32;
@@
 struct compat_hd_geometry {  unsigned char heads ;  unsigned char sectors ;  unsigned short cylinders ;  u32 start ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_uint_t,compat_caddr_t,compat_int_t;
@@
 struct compat_cdrom_generic_command {  unsigned char cmd [ CDROM_PACKET_SIZE ] ;  compat_caddr_t buffer ;  compat_uint_t buflen ;  compat_int_t stat ;  compat_caddr_t sense ;  unsigned char data_direction ;  compat_int_t quiet ;  compat_int_t timeout ;  compat_caddr_t reserved [ 1 ] ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,compat_caddr_t,compat_int_t;
@@
 struct compat_cdrom_read_audio {  union cdrom_addr addr ;  u8 addr_format ;  compat_int_t nframes ;  compat_caddr_t buf ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef compat_caddr_t,compat_int_t;
@@
 struct compat_blkpg_ioctl_arg {  compat_int_t op ;  compat_int_t flags ;  compat_int_t datalen ;  compat_caddr_t data ; } cocci_id@p ;
