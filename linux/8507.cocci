...
position p;
@@
 struct w5100_mmio_priv cocci_id@p ;
...
position p;
@@
 const struct w5100_ops cocci_id@p ;
...
typedef spinlock_t;
@@
 struct w5100_mmio_priv {  void __iomem * base ;  spinlock_t reg_lock ; } cocci_id@p ;
...
position p;
@@
 struct wiznet_platform_data * cocci_id@p ;
...
@@
 struct w5100_priv {  const struct w5100_ops * ops ;  u32 s0_regs ;  u32 s0_tx_buf ;  u16 s0_tx_buf_size ;  u32 s0_rx_buf ;  u16 s0_rx_buf_size ;  int irq ;  int link_irq ;  int link_gpio ;  struct napi_struct napi ;  struct net_device * ndev ;  bool promisc ;  u32 msg_enable ;  struct workqueue_struct * xfer_wq ;  struct work_struct rx_work ;  struct sk_buff * tx_skb ;  struct work_struct tx_work ;  struct work_struct setrx_work ;  struct work_struct restart_work ; } cocci_id@p ;
