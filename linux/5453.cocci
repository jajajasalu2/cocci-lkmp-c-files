...
position p;
@@
 struct s3c64xx_spi_driver_data cocci_id@p ;
...
position p;
@@
 struct s3c64xx_spi_port_config cocci_id@p ;
...
position p;
@@
 struct s3c64xx_spi_dma_data * cocci_id@p ;
...
position p;
@@
 struct s3c64xx_spi_dma_data {  struct dma_chan * ch ;  enum dma_transfer_direction direction ; } cocci_id@p ;
...
typedef bool;
@@
 struct s3c64xx_spi_port_config {  int fifo_lvl_mask [ MAX_SPI_PORTS ] ;  int rx_lvl_offset ;  int tx_st_done ;  int quirks ;  bool high_speed ;  bool clk_from_cmu ;  bool clk_ioclk ; } cocci_id@p ;
