...
position p;
@@
 struct generic_data * cocci_id@p ;
...
position p;
@@
 enum { MODEL_CMEDIA_REF , MODEL_MERIDIAN , MODEL_MERIDIAN_2G , MODEL_CLARO , MODEL_CLARO_HALO , MODEL_FANTASIA , MODEL_SERENADE , MODEL_2CH_OUTPUT , MODEL_HG2PCI , MODEL_XONAR_DG , MODEL_XONAR_DGX , } cocci_id@p ;
...
typedef u8,u16;
@@
 struct generic_data {  unsigned int dacs ;  u8 ak4396_regs [ 4 ] [ 5 ] ;  u16 wm8785_regs [ 3 ] ; } cocci_id@p ;
