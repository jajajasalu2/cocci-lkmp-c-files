...
position p;
@@
 struct getxattr_iter * cocci_id@p ;
...
position p;
@@
 struct listxattr_iter cocci_id@p ;
...
position p;
@@
 struct erofs_inode * const cocci_id@p ;
...
position p;
@@
 struct erofs_xattr_entry cocci_id@p ;
...
position p;
@@
 const struct xattr_iter_handlers * cocci_id@p ;
...
typedef erofs_blk_t;
@@
 struct xattr_iter {  struct super_block * sb ;  struct page * page ;  void * kaddr ;  erofs_blk_t blkaddr ;  unsigned int ofs ; } cocci_id@p ;
...
position p;
@@
 struct erofs_xattr_ibody_header * cocci_id@p ;
...
position p;
@@
 struct super_block * const cocci_id@p ;
