...
position p;
@@
 const struct vivid_vbi_gen_data * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ CC_PREAMBLE_BITS + 2 * 16 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ 29 + 24 + 24 + 24 + 18 + 18 ] ;
...
position p;
@@
 struct vivid_vbi_gen_data * cocci_id@p ;
