...
typedef u8,u32;
@@
 struct dcmi_format {  u32 fourcc ;  u32 mbus_code ;  u8 bpp ; } cocci_id@p ;
...
position p;
@@
 const struct dcmi_format * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct stm32_dcmi * dcmi , struct dcmi_buf * buf ) ;
...
position p;
@@
 enum state { STOPPED = 0 , WAIT_FOR_BUFFER , RUNNING , } cocci_id@p ;
...
position p;
@@
 const struct dcmi_format * cocci_id@p [ ARRAY_SIZE ( dcmi_formats ) ] ;
...
typedef u32;
@@
 struct dcmi_framesize {  u32 width ;  u32 height ; } cocci_id@p ;
...
@@
 struct dcmi_buf {  struct vb2_v4l2_buffer vb ;  bool prepared ;  dma_addr_t paddr ;  size_t size ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct dcmi_graph_entity {  struct v4l2_async_subdev asd ;  struct device_node * remote_node ;  struct v4l2_subdev * source ; } cocci_id@p ;
...
position p;
@@
 struct dcmi_framesize * cocci_id@p ;
