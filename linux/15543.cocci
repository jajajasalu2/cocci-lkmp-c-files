...
typedef u8,u16;
@@
 struct adt7316_chip_info {  struct adt7316_bus bus ;  struct gpio_desc * ldac_pin ;  u16 int_mask ;  u8 config1 ;  u8 config2 ;  u8 config3 ;  u8 dac_config ;  u8 ldac_config ;  u8 dac_bits ;  u8 id ; } cocci_id@p ;
...
typedef u16;
@@
 struct adt7316_limit_regs {  u16 data_high ;  u16 data_low ; } cocci_id@p ;
...
position p;
@@
 struct adt7316_chip_info * cocci_id@p ;
