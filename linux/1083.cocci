...
position p;
@@
 struct plat_ls1x_cpufreq * cocci_id@p ;
...
position p;
@@
 struct ls1x_cpufreq * cocci_id@p ;
...
position p;
@@
 struct ls1x_cpufreq {  struct device * dev ;  struct clk * clk ;  struct clk * mux_clk ;  struct clk * pll_clk ;  struct clk * osc_clk ;  unsigned int max_freq ;  unsigned int min_freq ; } cocci_id@p ;
