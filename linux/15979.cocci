...
position p;
@@
 struct ieee80211_crypto_alg {  struct list_head list ;  struct ieee80211_crypto_ops * ops ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct ieee80211_crypto {  struct list_head algs ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct ieee80211_crypto_alg * cocci_id@p ;
...
position p;
@@
 struct ieee80211_crypto * cocci_id@p ;
