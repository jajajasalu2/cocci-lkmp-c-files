...
symbol cocci_id;
position p;
typedef parse_opt_ctx_t;
@@
 const struct parse_opt_ctx_t * cocci_id@p ;
...
typedef parse_opt_ctx_t;
@@
 int cocci_id@p ( const char * const * , const struct option * , int , struct parse_opt_ctx_t * ) ;
...
typedef parse_opt_ctx_t;
@@
 struct parse_opt_ctx_t * cocci_id@p ;
