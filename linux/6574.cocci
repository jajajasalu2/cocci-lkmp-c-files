...
position p;
@@
 struct qla83xx_minidump_entry_pollrd * cocci_id@p ;
...
position p;
@@
 struct mbx_sys_info * cocci_id@p ;
...
position p;
@@
 struct ql82xx_hw_data * cocci_id@p ;
...
position p;
@@
 struct qla83xx_minidump_entry_pollrdmwr * cocci_id@p ;
...
position p;
@@
 struct crb_128M_2M_block_map cocci_id@p [ 64 ] ;
...
position p;
@@
 unsigned long cocci_id@p [ MAX_CRB_XFORM ] ;
...
position p;
@@
 struct qla8xxx_minidump_entry_crb * cocci_id@p ;
...
position p;
@@
 struct qla_flt_region cocci_id@p ;
...
position p;
@@
 struct qla8xxx_minidump_entry_queue * cocci_id@p ;
...
position p;
@@
 struct qla4_8xxx_minidump_template_hdr * cocci_id@p ;
...
position p;
@@
 struct qla8xxx_minidump_entry_cache * cocci_id@p ;
...
position p;
@@
 struct crb_128M_2M_sub_block_map * cocci_id@p ;
...
position p;
@@
 struct qla_fdt_layout * cocci_id@p ;
...
position p;
@@
 struct qla8xxx_minidump_entry_hdr * cocci_id@p ;
...
position p;
@@
 struct qla8xxx_minidump_entry_mux * cocci_id@p ;
...
position p;
@@
 struct crb_addr_pair * cocci_id@p ;
...
position p;
@@
 struct qla83xx_minidump_entry_rdmux2 * cocci_id@p ;
...
position p;
@@
 struct qla8xxx_minidump_entry_rdmem * cocci_id@p ;
...
position p;
@@
 struct qla8xxx_minidump_entry_rdocm * cocci_id@p ;
...
position p;
@@
 struct crb_addr_pair {  long addr ;  long data ; } cocci_id@p ;
...
position p;
@@
 struct qla4_83xx_pex_dma_descriptor cocci_id@p ;
...
position p;
@@
 struct qla8xxx_minidump_entry_rdrom * cocci_id@p ;
...
position p;
@@
 struct qla4_83xx_minidump_entry_rdmem_pex_dma * cocci_id@p ;
