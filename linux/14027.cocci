...
position p;
@@
 struct rga_addr_offset * cocci_id@p ;
...
position p;
@@
 union rga_dst_vir_info cocci_id@p ;
...
position p;
@@
 union rga_src_x_factor cocci_id@p ;
...
position p;
@@
 union rga_mode_ctrl cocci_id@p ;
...
position p;
@@
 union rga_src_vir_info cocci_id@p ;
...
position p;
@@
 union rga_src_act_info cocci_id@p ;
...
position p;
@@
 enum e_rga_start_pos cocci_id@p [ 4 ] [ 4 ] ;
...
position p;
@@
 enum e_rga_start_pos { LT = 0 , LB = 1 , RT = 2 , RB = 3 , } cocci_id@p ;
...
position p;
@@
 union rga_src_y_factor cocci_id@p ;
...
position p;
@@
 struct rga_corners_addr_offset {  struct rga_addr_offset left_top ;  struct rga_addr_offset right_top ;  struct rga_addr_offset left_bottom ;  struct rga_addr_offset right_bottom ; } cocci_id@p ;
...
position p;
@@
 union rga_dst_act_info cocci_id@p ;
...
position p;
@@
 union rga_alpha_ctrl0 cocci_id@p ;
...
position p;
@@
 struct rga_corners_addr_offset * cocci_id@p ;
...
position p;
@@
 struct rockchip_rga * cocci_id@p ;
...
position p;
@@
 struct rga_addr_offset {  unsigned int y_off ;  unsigned int u_off ;  unsigned int v_off ; } cocci_id@p ;
...
position p;
@@
 union rga_alpha_ctrl1 cocci_id@p ;
