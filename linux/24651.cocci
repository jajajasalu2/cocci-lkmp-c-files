...
position p;
@@
 const struct nla_policy cocci_id@p [ NFTA_CONNLIMIT_MAX + 1 ] ;
...
position p;
@@
 struct nft_connlimit * cocci_id@p ;
...
typedef bool,u32;
@@
 struct nft_connlimit {  struct nf_conncount_list list ;  u32 limit ;  bool invert ; } cocci_id@p ;
