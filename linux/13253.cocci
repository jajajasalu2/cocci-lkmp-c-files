...
position p;
@@
 const struct cx8800_fmt * cocci_id@p ;
...
typedef u32,s32;
@@
 struct cx88_ctrl {  u32 id ;  s32 minimum ;  s32 maximum ;  u32 step ;  s32 default_value ;  u32 off ;  u32 reg ;  u32 sreg ;  u32 mask ;  u32 shift ; } cocci_id@p ;
...
position p;
@@
 const struct cx88_ctrl cocci_id@p [ ] ;
...
position p;
@@
 enum { CX8800_VID_CTLS = ARRAY_SIZE ( cx8800_vid_ctls ) , CX8800_AUD_CTLS = ARRAY_SIZE ( cx8800_aud_ctls ) , } cocci_id@p ;
