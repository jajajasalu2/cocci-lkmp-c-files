...
position p;
@@
 enum gid_op_type { GID_DEL = 0 , GID_ADD , } cocci_id@p ;
...
position p;
@@
 struct netdev_event_work {  struct work_struct work ;  struct netdev_event_work_cmd cmds [ ROCE_NETDEV_CALLBACK_SZ ] ; } cocci_id@p ;
...
position p;
@@
 const struct netdev_event_work_cmd cocci_id@p ;
...
position p;
@@
 struct update_gid_event_work cocci_id@p ;
...
position p;
@@
 enum bonding_slave_state { BONDING_SLAVE_STATE_ACTIVE = 1UL << 0 , BONDING_SLAVE_STATE_INACTIVE = 1UL << 1 , BONDING_SLAVE_STATE_NA = 1UL << 2 , } cocci_id@p ;
...
position p;
@@
 struct sin_list {  struct list_head list ;  struct sockaddr_in ip ; } cocci_id@p ;
...
position p;
@@
 struct netdev_event_work_cmd cocci_id@p [ ROCE_NETDEV_CALLBACK_SZ ] ;
...
typedef u8,bool;
@@
 const struct {  bool ( * is_supported ) ( const struct ib_device * device , u8 port_num ) ;  enum ib_gid_type gid_type ; } cocci_id@p [ ] ;
...
position p;
@@
 struct netdev_event_work_cmd {  roce_netdev_callback cb ;  roce_netdev_filter filter ;  struct net_device * ndev ;  struct net_device * filter_ndev ; } cocci_id@p ;
...
position p;
@@
 struct netdev_event_work_cmd * cocci_id@p ;
...
position p;
@@
 struct update_gid_event_work {  struct work_struct work ;  union ib_gid gid ;  struct ib_gid_attr gid_attr ;  enum gid_op_type gid_op ; } cocci_id@p ;
...
position p;
@@
 struct netdev_event_work cocci_id@p ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( struct ib_device * ib_dev , u8 port , struct net_device * ndev ) ;
...
position p;
@@
 struct upper_list {  struct list_head list ;  struct net_device * upper ; } cocci_id@p ;
...
position p;
@@
 struct sin6_list {  struct list_head list ;  struct sockaddr_in6 sin6 ; } cocci_id@p ;
...
position p;
@@
 enum bonding_slave_state cocci_id@p ;
