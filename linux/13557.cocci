...
position p;
@@
 struct uvc_streaming_control cocci_id@p ;
...
position p;
@@
 struct v4l2_exportbuffer * cocci_id@p ;
...
position p;
@@
 struct uvc_xu_control_mapping32 * cocci_id@p ;
...
position p;
@@
 struct uvc_streaming * cocci_id@p ;
...
position p;
@@
 union {  struct uvc_xu_control_mapping xmap ;  struct uvc_xu_control_query xqry ; } cocci_id@p ;
...
position p;
@@
 struct uvc_xu_control_query32 cocci_id@p ;
...
position p;
@@
 struct uvc_control_mapping * cocci_id@p ;
...
position p;
@@
 struct uvc_xu_control_query cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u32,compat_caddr_t;
@@
 struct uvc_xu_control_mapping32 {  u32 id ;  u8 name [ 32 ] ;  u8 entity [ 16 ] ;  u8 selector ;  u8 size ;  u8 offset ;  u32 v4l2_type ;  u32 data_type ;  compat_caddr_t menu_info ;  u32 menu_count ;  u32 reserved [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct uvc_xu_control_query * cocci_id@p ;
...
position p;
@@
 const struct uvc_frame * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,u16,compat_caddr_t;
@@
 struct uvc_xu_control_query32 {  u8 unit ;  u8 selector ;  u8 query ;  u16 size ;  compat_caddr_t data ; } cocci_id@p ;
...
position p;
@@
 struct uvc_xu_control_mapping * cocci_id@p ;
...
position p;
@@
 struct uvc_video_chain * cocci_id@p ;
...
position p;
@@
 const struct uvc_xu_control_mapping * cocci_id@p ;
...
position p;
@@
 const struct uvc_format * cocci_id@p ;
...
position p;
@@
 const struct uvc_entity * cocci_id@p ;
