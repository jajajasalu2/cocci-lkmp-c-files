...
position p;
@@
 struct vnt_phy_field * cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ CB_VT3253B0_INIT_FOR_AIROHA2230 ] [ 2 ] ;
...
position p;
@@
 const unsigned short cocci_id@p [ MAX_RATE ] ;
...
position p;
@@
 unsigned char cocci_id@p [ CB_VT3253B0_INIT_FOR_UW2451 ] [ 2 ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ CB_VT3253B0_INIT_FOR_RFMD ] [ 2 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ CB_VT3253B0_AGC_FOR_RFMD2959 ] [ 2 ] ;
...
position p;
@@
 const unsigned char cocci_id@p [ CB_VT3253_INIT_FOR_RFMD ] [ 2 ] ;
...
position p;
@@
 unsigned char cocci_id@p [ CB_VT3253B0_AGC ] [ 2 ] ;
