...
position p;
@@
 struct cc10001_adc_device * cocci_id@p ;
...
typedef bool,u16;
@@
 struct cc10001_adc_device {  void __iomem * reg_base ;  struct clk * adc_clk ;  struct regulator * reg ;  u16 * buf ;  bool shared ;  struct mutex lock ;  unsigned int start_delay_ns ;  unsigned int eoc_delay_ns ; } cocci_id@p ;
