...
position p;
@@
 struct stub_entry {  Elf64_Word insns [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 enum elf_stub_type { ELF_STUB_GOT , ELF_STUB_MILLI , ELF_STUB_DIRECT , } cocci_id@p ;
...
position p;
@@
 struct got_entry {  Elf32_Addr addr ; } cocci_id@p ;
...
typedef Elf32_Word;
@@
 struct stub_entry {  Elf32_Word insns [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct got_entry {  Elf64_Addr addr ; } cocci_id@p ;
