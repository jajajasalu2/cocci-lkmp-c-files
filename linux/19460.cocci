...
position p;
@@
 struct rt3883_pci_controller * cocci_id@p ;
...
typedef bool;
@@
 struct rt3883_pci_controller {  void __iomem * base ;  struct device_node * intc_of_node ;  struct irq_domain * irq_domain ;  struct pci_controller pci_controller ;  struct resource io_res ;  struct resource mem_res ;  bool pcie_ready ; } cocci_id@p ;
