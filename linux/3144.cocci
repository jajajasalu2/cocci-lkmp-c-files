...
position p;
@@
 struct tb_drom_header cocci_id@p ;
...
position p;
@@
 enum tb_eeprom_transfer cocci_id@p ;
...
position p;
@@
 struct tb_eeprom_ctl * cocci_id@p ;
...
position p;
@@
 struct tb_drom_entry_port cocci_id@p ;
...
position p;
@@
 const struct tb_drom_entry_generic * cocci_id@p ;
...
position p;
@@
 enum tb_drom_entry_type { TB_DROM_ENTRY_GENERIC = 0U , TB_DROM_ENTRY_PORT , } cocci_id@p ;
...
position p;
@@
 struct tb_drom_entry_header * cocci_id@p ;
...
position p;
@@
 struct tb_cap_plug_events cocci_id@p ;
...
position p;
@@
 enum tb_eeprom_transfer { TB_EEPROM_IN , TB_EEPROM_OUT , } cocci_id@p ;
