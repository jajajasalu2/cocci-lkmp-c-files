...
typedef spinlock_t;
@@
 struct scm_queue {  struct scm_request * scmrq ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct aob_rq_header * cocci_id@p ;
