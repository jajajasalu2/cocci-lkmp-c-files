...
typedef u64;
@@
 u64 cocci_id@p [ NN_RVEC_GATHER_STATS ] ;
...
position p;
@@
 struct nfp_et_stat {  char name [ ETH_GSTRING_LEN ] ;  int off ; } cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ IPV6_FLOW + 1 ] ;
...
position p;
@@
 const struct nfp_et_stat cocci_id@p [ ] ;
