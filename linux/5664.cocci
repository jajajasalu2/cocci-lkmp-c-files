...
position p;
@@
 const struct da9063_compatible_rtc_regmap cocci_id@p ;
...
position p;
@@
 enum { RTC_SEC = 0 , RTC_MIN = 1 , RTC_HOUR = 2 , RTC_DAY = 3 , RTC_MONTH = 4 , RTC_YEAR = 5 , RTC_DATA_LEN , } cocci_id@p ;
...
position p;
@@
 struct da9063_compatible_rtc_regmap {  int rtc_enable_reg ;  int rtc_enable_32k_crystal_reg ;  int rtc_alarm_secs_reg ;  int rtc_alarm_year_reg ;  int rtc_count_secs_reg ;  int rtc_count_year_reg ;  int rtc_event_reg ;  int rtc_enable_mask ;  int rtc_crystal_mask ;  int rtc_event_alarm_mask ;  int rtc_alarm_on_mask ;  int rtc_alarm_status_mask ;  int rtc_tick_on_mask ;  int rtc_ready_to_read_mask ;  int rtc_count_sec_mask ;  int rtc_count_min_mask ;  int rtc_count_hour_mask ;  int rtc_count_day_mask ;  int rtc_count_month_mask ;  int rtc_count_year_mask ;  int rtc_data_start ;  int rtc_alarm_len ; } cocci_id@p ;
...
position p;
@@
 struct da9063_compatible_rtc * cocci_id@p ;
...
typedef bool;
@@
 struct da9063_compatible_rtc {  struct rtc_device * rtc_dev ;  struct rtc_time alarm_time ;  struct regmap * regmap ;  const struct da9063_compatible_rtc_regmap * config ;  bool rtc_sync ; } cocci_id@p ;
