...
position p;
@@
 struct rcar_gen2_channel cocci_id@p ;
...
position p;
@@
 const struct rcar_gen2_phy_data cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ ] [ PHYS_PER_CHANNEL ] ;
...
position p;
@@
 struct rcar_gen2_phy * cocci_id@p ;
...
typedef u32;
@@
 struct rcar_gen2_channel {  struct device_node * of_node ;  struct rcar_gen2_phy_driver * drv ;  struct rcar_gen2_phy phys [ PHYS_PER_CHANNEL ] ;  int selected_phy ;  u32 select_mask ; } cocci_id@p ;
...
typedef u32;
@@
 struct rcar_gen2_phy {  struct phy * phy ;  struct rcar_gen2_channel * channel ;  int number ;  u32 select_value ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct rcar_gen2_phy_driver {  void __iomem * base ;  struct clk * clk ;  spinlock_t lock ;  int num_channels ;  struct rcar_gen2_channel * channels ; } cocci_id@p ;
...
position p;
@@
 struct rcar_gen2_phy_driver * cocci_id@p ;
...
typedef u32;
@@
 struct rcar_gen2_phy_data {  const struct phy_ops * gen2_phy_ops ;  const u32 * select_value [ PHYS_PER_CHANNEL ] ;  const u32 num_channels ; } cocci_id@p ;
