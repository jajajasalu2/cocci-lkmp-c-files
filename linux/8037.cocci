...
position p;
@@
 struct thunder_mdiobus_nexus {  void __iomem * bar0 ;  struct cavium_mdiobus * buses [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct thunder_mdiobus_nexus * cocci_id@p ;
