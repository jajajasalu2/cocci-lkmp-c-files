...
typedef bool,u32;
@@
 struct ipu_di {  void __iomem * base ;  int id ;  u32 module ;  struct clk * clk_di ;  struct clk * clk_ipu ;  struct clk * clk_di_pixel ;  bool inuse ;  struct ipu_soc * ipu ; } cocci_id@p ;
...
position p;
@@
 struct di_sync_config * cocci_id@p ;
...
position p;
@@
 enum di_sync_wave { DI_SYNC_NONE = 0 , DI_SYNC_CLK = 1 , DI_SYNC_INT_HSYNC = 2 , DI_SYNC_HSYNC = 3 , DI_SYNC_VSYNC = 4 , DI_SYNC_DE = 6 , DI_SYNC_CNT1 = 2 , DI_SYNC_CNT4 = 5 , DI_SYNC_CNT5 = 6 , } cocci_id@p ;
...
position p;
@@
 const struct ipu_di_signal_cfg * cocci_id@p ;
...
position p;
@@
 enum di_pins { DI_PIN11 = 0 , DI_PIN12 = 1 , DI_PIN13 = 2 , DI_PIN14 = 3 , DI_PIN15 = 4 , DI_PIN16 = 5 , DI_PIN17 = 6 , DI_PIN_CS = 7 , DI_PIN_SER_CLK = 0 , DI_PIN_SER_RS = 1 , } cocci_id@p ;
...
position p;
@@
 struct di_sync_config {  int run_count ;  int run_src ;  int offset_count ;  int offset_src ;  int repeat_count ;  int cnt_clr_src ;  int cnt_polarity_gen_en ;  int cnt_polarity_clr_src ;  int cnt_polarity_trigger_src ;  int cnt_up ;  int cnt_down ; } cocci_id@p ;
