...
position p;
@@
 struct hdmi_vendor_infoframe cocci_id@p ;
...
position p;
@@
 enum dc_edid_status cocci_id@p ;
...
position p;
@@
 struct dc_plane_cap * cocci_id@p ;
...
position p;
@@
 struct detailed_non_pixel * cocci_id@p ;
...
position p;
@@
 struct amdgpu_mode_info * cocci_id@p ;
...
position p;
@@
 struct mod_freesync_config cocci_id@p ;
...
position p;
@@
 const struct drm_framebuffer * cocci_id@p ;
...
position p;
@@
 const struct dm_connector_state * cocci_id@p ;
...
position p;
@@
 struct dc_surface_update cocci_id@p [ MAX_SURFACES ] ;
...
position p;
@@
 union dc_tiling_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct amdgpu_dm_connector * aconnector ) ;
...
position p;
@@
 struct dm_connector_state * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct amdgpu_display_manager * dm , struct drm_plane * plane , unsigned long possible_crtcs , const struct dc_plane_cap * plane_cap ) ;
...
position p;
@@
 int cocci_id@p ( struct drm_connector * connector ) ;
...
position p;
@@
 struct drm_framebuffer * cocci_id@p ;
...
position p;
@@
 enum dc_color_depth cocci_id@p ;
...
position p;
@@
 const enum dc_rotation_angle cocci_id@p ;
...
position p;
@@
 struct dc_flip_addrs cocci_id@p ;
...
position p;
@@
 struct hdmi_drm_infoframe cocci_id@p ;
...
position p;
@@
 struct dc_cursor_position cocci_id@p ;
...
position p;
@@
 const struct amdgpu_ip_block_version cocci_id@p ;
...
position p;
@@
 const struct drm_encoder_helper_funcs cocci_id@p ;
...
position p;
@@
 struct dm_crtc_state * cocci_id@p ;
...
position p;
@@
 struct drm_connector_list_iter cocci_id@p ;
...
position p;
@@
 const struct dc_link * cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct drm_device * dev , struct drm_atomic_state * state , bool nonblock ) ;
...
position p;
@@
 struct detailed_data_monitor_range * cocci_id@p ;
...
position p;
@@
 const struct amdgpu_display_funcs cocci_id@p ;
...
position p;
@@
 struct drm_crtc_commit cocci_id@p ;
...
position p;
@@
 struct mod_vrr_params cocci_id@p ;
...
position p;
@@
 struct amdgpu_i2c_adapter * cocci_id@p ;
...
position p;
@@
 struct hdcp_workqueue * cocci_id@p ;
...
position p;
@@
 struct dc_scaling_info * cocci_id@p ;
...
position p;
@@
 struct dc_surface_update * cocci_id@p ;
...
position p;
@@
 struct dm_atomic_state * * cocci_id@p ;
...
position p;
@@
 struct drm_atomic_state * cocci_id@p ;
...
position p;
@@
 struct mode_size {  char name [ DRM_DISPLAY_MODE_LEN ] ;  int w ;  int h ; } cocci_id@p [ ] ;
...
position p;
@@
 enum drm_plane_type cocci_id@p ;
...
position p;
@@
 struct amdgpu_framebuffer * cocci_id@p ;
...
position p;
@@
 struct drm_crtc_state * cocci_id@p ;
...
position p;
@@
 struct dc_init_data cocci_id@p ;
...
position p;
@@
 struct dsc_dec_dpcd_caps cocci_id@p ;
...
position p;
@@
 struct amdgpu_dm_backlight_caps cocci_id@p ;
...
position p;
@@
 struct hdmi_avi_infoframe cocci_id@p ;
...
position p;
@@
 const struct dc_link_status * cocci_id@p ;
...
position p;
@@
 const struct drm_connector_funcs cocci_id@p ;
...
position p;
@@
 struct drm_private_state * cocci_id@p ;
...
position p;
@@
 enum dc_aspect_ratio cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct amdgpu_device * adev ) ;
...
position p;
@@
 struct dc_info_packet cocci_id@p ;
...
position p;
@@
 const struct plane_size * cocci_id@p ;
...
position p;
@@
 struct amdgpu_dm_connector * cocci_id@p ;
...
position p;
@@
 const struct drm_display_mode * cocci_id@p ;
...
position p;
@@
 struct dc_surface_dcc_cap cocci_id@p ;
...
position p;
@@
 struct dc_static_screen_events cocci_id@p ;
...
position p;
@@
 enum audio_format_code cocci_id@p ;
...
position p;
@@
 const struct drm_plane_funcs cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_atomic_state * state ) ;
...
position p;
@@
 enum surface_update_type cocci_id@p ;
...
position p;
@@
 const struct dc_sink * cocci_id@p ;
...
position p;
@@
 struct dc_stream_state * cocci_id@p ;
...
position p;
@@
 const struct drm_plane * cocci_id@p ;
...
position p;
@@
 const struct drm_crtc_helper_funcs cocci_id@p ;
...
position p;
@@
 struct dc_stream_status * cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ EDP_PSR_RECEIVER_CAP_SIZE ] ;
...
position p;
@@
 const struct amdgpu_framebuffer * cocci_id@p ;
...
position p;
@@
 enum amdgpu_rmx_type cocci_id@p ;
...
position p;
@@
 struct dc_plane_dcc_param * cocci_id@p ;
...
position p;
@@
 struct drm_gem_object * cocci_id@p ;
...
position p;
@@
 const enum surface_pixel_format cocci_id@p ;
...
position p;
@@
 const struct drm_plane_state * cocci_id@p ;
...
position p;
@@
 enum amdgpu_dm_pipe_crc_source cocci_id@p ;
...
position p;
@@
 struct drm_connector_state * cocci_id@p ;
...
position p;
@@
 const struct drm_encoder_funcs cocci_id@p ;
...
position p;
@@
 struct dc_stream_update cocci_id@p ;
...
position p;
@@
 struct drm_audio_component * cocci_id@p ;
...
position p;
@@
 struct drm_mode_config_helper_funcs cocci_id@p ;
...
position p;
@@
 const union dc_tiling_info * cocci_id@p ;
...
position p;
@@
 enum drm_connector_status cocci_id@p ;
...
position p;
@@
 struct dc_interrupt_params cocci_id@p ;
...
position p;
@@
 struct drm_format_name_buf cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_plane * plane , struct drm_plane_state * old_plane_state ) ;
...
position p;
@@
 struct {  struct dc_surface_update surface_updates [ MAX_SURFACES ] ;  struct dc_plane_info plane_infos [ MAX_SURFACES ] ;  struct dc_scaling_info scaling_infos [ MAX_SURFACES ] ;  struct dc_flip_addrs flip_addrs [ MAX_SURFACES ] ;  struct dc_stream_update stream_update ; } * cocci_id@p ;
...
position p;
@@
 struct drm_plane_state * cocci_id@p ;
...
position p;
@@
 const struct component_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct amdgpu_display_manager * dm ) ;
...
position p;
@@
 const struct dc_plane_cap * cocci_id@p ;
...
position p;
@@
 struct dc_plane_info cocci_id@p ;
...
position p;
@@
 struct amdgpu_device * cocci_id@p ;
...
position p;
@@
 struct amdgpu_encoder * cocci_id@p ;
...
typedef bool;
@@
 bool cocci_id@p ( struct dc_stream_state * stream ) ;
...
position p;
@@
 enum drm_mode_status cocci_id@p ;
...
position p;
@@
 struct ttm_validate_buffer cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_device * dev , struct drm_atomic_state * state ) ;
...
position p;
@@
 struct dc_dcc_surface_param cocci_id@p ;
...
position p;
@@
 const struct dc_stream_status * cocci_id@p ;
...
position p;
@@
 const struct drm_connector * cocci_id@p ;
...
position p;
@@
 struct dm_comressor_info * cocci_id@p ;
...
position p;
@@
 const struct drm_audio_component_ops cocci_id@p ;
...
position p;
@@
 struct dc_sink_init_data cocci_id@p ;
...
position p;
@@
 const struct dc_crtc_timing * cocci_id@p ;
...
position p;
@@
 const struct drm_connector_state * cocci_id@p ;
...
position p;
@@
 struct ww_acquire_ctx cocci_id@p ;
...
position p;
@@
 struct common_irq_params * cocci_id@p ;
...
position p;
@@
 struct dc_cursor_attributes cocci_id@p ;
...
typedef uint8_t;
@@
 uint8_t cocci_id@p [ DP_PSR_ERROR_STATUS - DP_SINK_COUNT_ESI ] ;
...
position p;
@@
 struct drm_private_obj * cocci_id@p ;
...
position p;
@@
 const struct drm_plane_helper_funcs cocci_id@p ;
...
position p;
@@
 enum dc_color_space * cocci_id@p ;
...
position p;
@@
 struct drm_pending_vblank_event * cocci_id@p ;
...
position p;
@@
 const struct dc_edid_caps * cocci_id@p ;
...
position p;
@@
 const struct dc_stream_state * cocci_id@p ;
...
position p;
@@
 enum amd_clockgating_state cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct amdgpu_device * adev ) ;
...
position p;
@@
 const struct amd_ip_funcs cocci_id@p ;
...
position p;
@@
 enum dc_connection_type cocci_id@p ;
...
position p;
@@
 struct drm_property_blob * cocci_id@p ;
...
position p;
@@
 const struct drm_connector_helper_funcs cocci_id@p ;
...
position p;
@@
 struct dc_plane_state * cocci_id@p ;
...
position p;
@@
 struct drm_property * cocci_id@p ;
...
position p;
@@
 struct dm_plane_state * cocci_id@p ;
...
position p;
@@
 struct dc_plane_address * cocci_id@p ;
...
position p;
@@
 struct drm_dp_mst_topology_mgr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct dc_link * link ) ;
...
position p;
@@
 const struct drm_display_info * cocci_id@p ;
...
position p;
@@
 const struct dmcu_firmware_header_v1_0 * cocci_id@p ;
...
position p;
@@
 struct amdgpu_display_manager * cocci_id@p ;
...
position p;
@@
 struct detailed_timing * cocci_id@p ;
...
position p;
@@
 struct dc_callback_init cocci_id@p ;
...
position p;
@@
 const struct drm_mode_config_funcs cocci_id@p ;
...
position p;
@@
 const struct drm_crtc_funcs cocci_id@p ;
...
position p;
@@
 struct drm_private_state_funcs cocci_id@p ;
...
position p;
@@
 const struct i2c_algorithm cocci_id@p ;
...
position p;
@@
 struct dc_crtc_timing * cocci_id@p ;
...
position p;
@@
 struct display_sink_capability cocci_id@p ;
...
position p;
@@
 enum amd_powergating_state cocci_id@p ;
