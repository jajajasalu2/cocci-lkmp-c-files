...
typedef bool;
@@
 int cocci_id@p ( struct idmac * idmac , struct idmac_channel * ichan , bool wait_for_stop ) ;
...
position p;
@@
 union chan_param_mem cocci_id@p ;
...
position p;
@@
 union chan_param_mem {  struct chan_param_mem_planar pp ;  struct chan_param_mem_interleaved ip ; } cocci_id@p ;
...
position p;
@@
 union ipu_channel_param * cocci_id@p ;
