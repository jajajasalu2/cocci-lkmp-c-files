...
position p;
@@
 struct gpio_runtime * cocci_id@p ;
...
position p;
@@
 struct gpio_methods * cocci_id@p ;
...
position p;
@@
 struct gpio_notification * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef notify_func_t;
@@
 notify_func_t cocci_id@p ;
