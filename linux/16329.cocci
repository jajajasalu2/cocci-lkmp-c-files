...
position p;
@@
 struct vnt_rrv_time_cts * cocci_id@p ;
...
position p;
@@
 struct vnt_rts_g_fb cocci_id@p ;
...
position p;
@@
 struct vnt_rrv_time_ab * cocci_id@p ;
...
position p;
@@
 struct vnt_tx_datahead_a_fb cocci_id@p ;
...
position p;
@@
 struct vnt_rrv_time_rts cocci_id@p ;
...
position p;
@@
 const unsigned short cocci_id@p [ 2 ] [ MAX_RATE ] ;
...
position p;
@@
 struct vnt_tx_datahead_g cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct vnt_private * pDevice , unsigned char byPktType , struct vnt_tx_fifo_head * , void * pvRrvTime , void * pvRTS , void * pvCTS , unsigned int cbFrameSize , bool bNeedACK , unsigned int uDMAIdx , void * psEthHeader , unsigned short wCurrentRate ) ;
...
position p;
@@
 struct vnt_tx_fifo_head * cocci_id@p ;
...
position p;
@@
 struct vnt_tx_datahead_g_fb * cocci_id@p ;
...
position p;
@@
 struct vnt_tx_short_buf_head * cocci_id@p ;
...
position p;
@@
 struct vnt_tx_datahead_ab * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p ( struct vnt_private * pDevice , unsigned char byPktType , unsigned char * pbyTxBufferAddr , unsigned int uDMAIdx , struct vnt_tx_desc * pHeadTD , unsigned int uNodeIndex ) ;
...
typedef bool;
@@
 void cocci_id@p ( struct vnt_private * pDevice , unsigned char byPktType , void * pvRTS , unsigned int cbFrameLength , bool bNeedAck , bool bDisCRC , struct ieee80211_hdr * hdr , unsigned short wCurrentRate , unsigned char byFBOption ) ;
...
position p;
@@
 const unsigned short cocci_id@p [ 2 ] [ 5 ] ;
...
position p;
@@
 struct vnt_rts_a_fb cocci_id@p ;
