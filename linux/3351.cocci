...
position p;
@@
 enum stm32_timers_dmas cocci_id@p ;
...
position p;
@@
 const struct stm32_breakinput * cocci_id@p ;
...
typedef u32;
@@
 struct stm32_breakinput {  u32 index ;  u32 level ;  u32 filter ; } cocci_id@p ;
...
typedef bool,u32;
@@
 struct stm32_pwm {  struct pwm_chip chip ;  struct mutex lock ;  struct clk * clk ;  struct regmap * regmap ;  u32 max_arr ;  bool have_complementary_output ;  struct stm32_breakinput breakinputs [ MAX_BREAKINPUT ] ;  unsigned int num_breakinputs ;  u32 capture [ 4 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 struct stm32_breakinput cocci_id@p ;
