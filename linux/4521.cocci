...
position p;
@@
 enum pci_barno { BAR_0 , BAR_1 , BAR_2 , BAR_3 , BAR_4 , BAR_5 , } cocci_id@p ;
...
position p;
@@
 struct pci_endpoint_test {  struct pci_dev * pdev ;  void __iomem * base ;  void __iomem * bar [ PCI_STD_NUM_BARS ] ;  struct completion irq_raised ;  int last_irq ;  int num_irqs ;  struct mutex mutex ;  struct miscdevice miscdev ;  enum pci_barno test_reg_bar ;  size_t alignment ; } cocci_id@p ;
...
position p;
@@
 const struct pci_endpoint_test_data cocci_id@p ;
...
position p;
@@
 struct pci_endpoint_test cocci_id@p ;
...
position p;
@@
 struct pci_endpoint_test_data * cocci_id@p ;
...
position p;
@@
 struct pci_endpoint_test_data {  enum pci_barno test_reg_bar ;  size_t alignment ;  int irq_type ; } cocci_id@p ;
