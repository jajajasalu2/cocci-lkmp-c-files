...
position p;
@@
 struct aat2870_bl_driver_data * cocci_id@p ;
...
position p;
@@
 struct aat2870_bl_platform_data * cocci_id@p ;
...
position p;
@@
 struct aat2870_bl_driver_data {  struct platform_device * pdev ;  struct backlight_device * bd ;  int channels ;  int max_current ;  int brightness ; } cocci_id@p ;
...
position p;
@@
 struct aat2870_data * cocci_id@p ;
