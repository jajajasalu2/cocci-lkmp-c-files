...
position p;
@@
 struct udl_fbdev {  struct drm_fb_helper helper ;  struct udl_framebuffer ufb ;  int fb_count ; } cocci_id@p ;
...
position p;
@@
 struct udl_framebuffer * cocci_id@p ;
...
position p;
@@
 struct udl_gem_object * cocci_id@p ;
