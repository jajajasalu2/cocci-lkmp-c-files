...
position p;
@@
 struct pci_response cocci_id@p ;
...
position p;
@@
 struct hv_dr_work {  struct work_struct wrk ;  struct hv_pcibus_device * bus ; } cocci_id@p ;
...
position p;
@@
 union win_slot_encoding cocci_id@p ;
...
position p;
@@
 struct q_res_req_compl cocci_id@p ;
...
typedef s32;
@@
 struct hv_pci_compl {  struct completion host_event ;  s32 completion_status ; } cocci_id@p ;
...
position p;
@@
 struct pci_bus_d0_entry * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct hv_pcibus_device * hv_pcibus ) ;
...
typedef u32;
@@
 struct hv_pci_dev * cocci_id@p ( struct hv_pcibus_device * hbus , u32 wslot ) ;
...
position p;
@@
 char cocci_id@p [ SLOT_NAME_SIZE ] ;
...
position p;
@@
 struct hv_pci_compl * cocci_id@p ;
...
position p;
@@
 enum hv_pcibus_state { hv_pcibus_init = 0 , hv_pcibus_probed , hv_pcibus_installed , hv_pcibus_removing , hv_pcibus_removed , hv_pcibus_maximum , } cocci_id@p ;
...
position p;
@@
 const struct hv_vmbus_device_id cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef pci_protocol_version_t;
@@
 enum pci_protocol_version_t { PCI_PROTOCOL_VERSION_1_1 = PCI_MAKE_VERSION ( 1 , 1 ) , PCI_PROTOCOL_VERSION_1_2 = PCI_MAKE_VERSION ( 1 , 2 ) , } cocci_id@p ;
...
position p;
@@
 struct pci_write_block cocci_id@p ;
...
position p;
@@
 struct hv_read_config_compl cocci_id@p ;
...
position p;
@@
 struct compose_comp_ctxt {  struct hv_pci_compl comp_pkt ;  struct tran_int_desc int_desc ; } cocci_id@p ;
...
position p;
@@
 struct pci_eject_response * cocci_id@p ;
...
typedef pci_protocol_version_t;
@@
 enum pci_protocol_version_t cocci_id@p [ ] ;
...
position p;
@@
 struct pci_child_message cocci_id@p ;
...
typedef u8;
@@
 struct {  struct pci_packet teardown_packet ;  u8 buffer [ sizeof ( struct pci_message ) ] ; } cocci_id@p ;
...
position p;
@@
 struct pci_bus_relations * cocci_id@p ;
...
typedef u32;
@@
 struct hv_dr_state {  struct list_head list_entry ;  u32 device_count ;  struct pci_function_description func [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct compose_comp_ctxt * cocci_id@p ;
...
position p;
@@
 struct q_res_req_compl {  struct completion host_event ;  struct hv_pci_dev * hpdev ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  struct pci_packet init_packet ;  u8 buffer [ sizeof ( struct pci_child_message ) ] ; } cocci_id@p ;
...
position p;
@@
 struct pci_incoming_message * cocci_id@p ;
...
position p;
@@
 struct pci_function_description * cocci_id@p ;
...
typedef u64;
@@
 void ( * cocci_id@p ) ( void * context , u64 block_mask ) ;
...
position p;
@@
 struct pci_q_res_req_response * cocci_id@p ;
...
position p;
@@
 struct pci_read_block * cocci_id@p ;
...
typedef u64,u32;
@@
 struct hv_device_interrupt_target {  u32 vector ;  u32 flags ;  union {  u64 vp_mask ;  struct hv_vpset vp_set ; } ; } cocci_id@p ;
...
position p;
@@
 struct hv_pcibus_device * cocci_id@p ;
...
position p;
@@
 const struct cpumask * cocci_id@p ;
...
position p;
@@
 struct pci_resources_assigned2 * cocci_id@p ;
...
position p;
@@
 struct vmpacket_descriptor * cocci_id@p ;
...
position p;
@@
 struct pci_dev_incoming * cocci_id@p ;
...
typedef pci_protocol_version_t;
@@
 enum pci_protocol_version_t cocci_id@p [ 1 ] ;
...
position p;
@@
 struct msi_domain_info * cocci_id@p ;
...
position p;
@@
 enum hv_pcichild_state { hv_pcichild_init = 0 , hv_pcichild_requirements , hv_pcichild_resourced , hv_pcichild_ejecting , hv_pcichild_maximum , } cocci_id@p ;
...
position p;
@@
 struct pci_version_request * cocci_id@p ;
...
typedef u8;
@@
 struct {  struct pci_packet pkt ;  u8 buffer [ sizeof ( struct pci_eject_response ) ] ; } cocci_id@p ;
...
position p;
@@
 struct tran_int_desc * cocci_id@p ;
...
position p;
@@
 struct {  struct pci_packet pkt ;  char buf [ sizeof ( struct pci_read_block ) ] ; } cocci_id@p ;
...
position p;
@@
 struct pci_create_int_response * cocci_id@p ;
...
position p;
@@
 struct pci_read_block_response * cocci_id@p ;
...
position p;
@@
 struct pci_delete_interrupt * cocci_id@p ;
...
typedef u32;
@@
 struct {  struct pci_packet pkt ;  char buf [ sizeof ( struct pci_write_block ) ] ;  u32 reserved ; } cocci_id@p ;
...
position p;
@@
 struct pci_dev_inval_block * cocci_id@p ;
...
typedef u32;
@@
 struct hv_interrupt_entry {  u32 source ;  u32 reserved1 ;  u32 address ;  u32 data ; } cocci_id@p ;
...
typedef u8;
@@
 struct {  struct pci_packet pkt ;  u8 buffer [ sizeof ( struct pci_delete_interrupt ) ] ; } cocci_id@p ;
...
position p;
@@
 struct pci_create_interrupt2 * cocci_id@p ;
...
position p;
@@
 struct retarget_msi_interrupt * cocci_id@p ;
...
position p;
@@
 enum hv_pcibus_state cocci_id@p ;
...
position p;
@@
 struct pci_resources_assigned * cocci_id@p ;
...
position p;
@@
 struct pci_create_interrupt * cocci_id@p ;
...
position p;
@@
 struct hv_read_config_compl {  struct hv_pci_compl comp_pkt ;  void * buf ;  unsigned int len ;  unsigned int bytes_returned ; } cocci_id@p ;
...
position p;
@@
 struct msi_domain_ops cocci_id@p ;
