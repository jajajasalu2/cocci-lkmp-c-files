...
position p;
@@
 struct crypto_cts_ctx {  struct crypto_skcipher * child ; } cocci_id@p ;
...
position p;
@@
 struct crypto_cts_ctx cocci_id@p ;
...
position p;
@@
 struct crypto_cts_reqctx {  struct scatterlist sg [ 2 ] ;  unsigned offset ;  struct skcipher_request subreq ; } cocci_id@p ;
...
position p;
@@
 struct crypto_cts_reqctx cocci_id@p ;
