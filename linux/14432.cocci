...
position p;
@@
 struct v4l2_ioctl_ops cocci_id@p ;
...
position p;
@@
 struct radio_si4713_device * cocci_id@p ;
...
position p;
@@
 struct radio_si4713_device {  struct v4l2_device v4l2_dev ;  struct video_device radio_dev ;  struct mutex lock ; } cocci_id@p ;
