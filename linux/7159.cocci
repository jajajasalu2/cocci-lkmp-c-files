...
@@
 struct xenbus_file_priv {  struct mutex msgbuffer_mutex ;  struct list_head transactions ;  struct list_head watches ;  unsigned int len ;  union {  struct xsd_sockmsg msg ;  char buffer [ XENSTORE_PAYLOAD_MAX ] ; } u ;  struct mutex reply_mutex ;  struct list_head read_buffers ;  wait_queue_head_t read_waitq ;  struct kref kref ;  struct work_struct wq ; } cocci_id@p ;
...
position p;
@@
 struct xenbus_file_priv cocci_id@p ;
...
position p;
@@
 struct watch_adapter {  struct list_head list ;  struct xenbus_watch watch ;  struct xenbus_file_priv * dev_data ;  char * token ; } cocci_id@p ;
...
position p;
@@
 struct read_buffer {  struct list_head list ;  unsigned int cons ;  unsigned int len ;  char msg [ ] ; } cocci_id@p ;
...
position p;
@@
 struct watch_adapter cocci_id@p ;
...
position p;
@@
 struct {  struct xsd_sockmsg hdr ;  char body [ ] ; } * cocci_id@p ;
...
position p;
@@
 struct {  struct xsd_sockmsg hdr ;  char body [ 16 ] ; } cocci_id@p ;
...
position p;
@@
 struct xenbus_transaction_holder {  struct list_head list ;  struct xenbus_transaction handle ;  unsigned int generation_id ; } cocci_id@p ;
...
position p;
@@
 struct xenbus_transaction_holder * cocci_id@p ;
