...
typedef __u8;
@@
 struct s3fwrn5_fw_version {  __u8 major ;  __u8 build1 ;  __u8 build2 ;  __u8 target ; } cocci_id@p ;
...
position p;
@@
 struct s3fwrn5_fw_image * cocci_id@p ;
...
position p;
@@
 struct s3fwrn5_fw_info * cocci_id@p ;
...
position p;
@@
 struct s3fwrn5_fw_header cocci_id@p ;
...
position p;
@@
 struct s3fwrn5_fw_cmd_enter_updatemode cocci_id@p ;
...
position p;
@@
 struct s3fwrn5_fw_version * cocci_id@p ;
...
position p;
@@
 struct s3fwrn5_fw_cmd_get_bootinfo_rsp cocci_id@p ;
...
position p;
@@
 struct s3fwrn5_fw_cmd_update_sector cocci_id@p ;
...
typedef u8,u32;
@@
 const struct {  u8 version [ 4 ] ;  u32 base_addr ; } cocci_id@p [ ] ;
...
position p;
@@
 struct s3fwrn5_info cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SHA1_DIGEST_SIZE ] ;
