...
position p;
@@
 struct hvc_opal_priv * cocci_id@p ;
...
position p;
@@
 struct hvc_opal_priv * cocci_id@p [ MAX_NR_HVC_CONSOLES ] ;
...
@@
 struct hvc_opal_priv {  hv_protocol_t proto ;  struct hvsi_priv hvsi ; } cocci_id@p ;
