...
position p;
@@
 struct ice_aqc_add_txqs * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_fw_logging_data * cocci_id@p ;
...
position p;
@@
 enum ice_aq_res_ids cocci_id@p ;
...
position p;
@@
 enum ice_flex_rx_mdid cocci_id@p ;
...
position p;
@@
 struct ice_aqc_req_res * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_elem * cocci_id@p ;
...
position p;
@@
 struct ice_driver_ver * cocci_id@p ;
...
position p;
@@
 struct ice_hw_func_caps * cocci_id@p ;
...
position p;
@@
 struct ice_vsi_list_map_info * cocci_id@p ;
...
position p;
@@
 struct ice_nvm_info * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_set_event_mask * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_q_shutdown * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_driver_ver * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_ver * cocci_id@p ;
...
position p;
@@
 enum ice_aq_res_access_type cocci_id@p ;
...
position p;
@@
 struct ice_aqc_dis_txqs * cocci_id@p ;
...
position p;
@@
 const struct ice_ctx_ele * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_manage_mac_write * cocci_id@p ;
...
position p;
@@
 struct ice_port_info * cocci_id@p ;
...
position p;
@@
 struct ice_phy_info * cocci_id@p ;
...
position p;
@@
 struct ice_switch_info * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_sff_eeprom * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_link_status * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_set_rss_key * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_list_caps * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_set_rss_lut * cocci_id@p ;
...
position p;
@@
 struct ice_rlan_ctx * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_list_caps_elem * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_restart_an * cocci_id@p ;
...
position p;
@@
 struct ice_sw_recipe * cocci_id@p ;
...
position p;
@@
 enum ice_media_type * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_set_phy_cfg_data * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_manage_mac_read_resp * cocci_id@p ;
...
position p;
@@
 enum ice_adminq_opc cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_set_rss_keys * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_add_txqs_perq * cocci_id@p ;
...
position p;
@@
 struct ice_link_status * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_fw_logging * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_set_mac_lb * cocci_id@p ;
...
position p;
@@
 enum ice_disq_rst_src cocci_id@p ;
...
position p;
@@
 struct ice_sched_node * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_dis_txq_item cocci_id@p ;
...
position p;
@@
 struct ice_aqc_set_port_id_led * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_phy_caps * cocci_id@p ;
...
position p;
@@
 struct ice_hw_dev_caps * cocci_id@p ;
...
position p;
@@
 struct ice_fltr_mgmt_list_entry * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_manage_mac_read * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_phy_caps_data * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_add_tx_qgrp * cocci_id@p ;
...
position p;
@@
 struct ice_aqc_get_link_status_data cocci_id@p ;
...
position p;
@@
 struct ice_aqc_txsched_elem_data cocci_id@p ;
...
position p;
@@
 struct ice_hw_common_caps * cocci_id@p ;
