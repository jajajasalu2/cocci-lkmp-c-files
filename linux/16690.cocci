...
position p;
@@
 const struct qt1050_key_regs * cocci_id@p ;
...
typedef u8;
@@
 struct qt1050_priv {  struct i2c_client * client ;  struct input_dev * input ;  struct regmap * regmap ;  struct qt1050_key keys [ QT1050_MAX_KEYS ] ;  unsigned short keycodes [ QT1050_MAX_KEYS ] ;  u8 reg_keys ;  u8 last_keys ; } cocci_id@p ;
...
typedef u32;
@@
 struct qt1050_key {  u32 num ;  u32 charge_delay ;  u32 thr_cnt ;  u32 samples ;  u32 scale ;  u32 keycode ; } cocci_id@p ;
...
position p;
@@
 struct qt1050_key_regs {  unsigned int nthr ;  unsigned int pulse_scale ;  unsigned int di_aks ;  unsigned int csd ; } cocci_id@p ;
