...
position p;
@@
 const struct nfs_inode * cocci_id@p ;
...
position p;
@@
 struct nfs_find_desc {  struct nfs_fh * fh ;  struct nfs_fattr * fattr ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct inode * , struct nfs_fattr * ) ;
...
position p;
@@
 struct nfs_find_desc cocci_id@p ;
...
position p;
@@
 const struct nfs_fattr * cocci_id@p ;
