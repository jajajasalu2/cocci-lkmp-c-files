...
position p;
@@
 struct ati_page_map {  unsigned long * real ;  unsigned long __iomem * remapped ; } cocci_id@p ;
...
position p;
@@
 struct ati_page_map cocci_id@p ;
...
typedef u8;
@@
 struct _ati_generic_private {  volatile u8 __iomem * registers ;  struct ati_page_map * * gatt_pages ;  int num_tables ; } cocci_id@p ;
