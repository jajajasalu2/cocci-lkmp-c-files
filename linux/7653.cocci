...
position p;
@@
 struct r3964_block_header cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct r3964_info * , struct r3964_block_header * ) ;
...
position p;
@@
 int cocci_id@p ( struct tty_struct * tty , struct file * file , unsigned int cmd , unsigned long arg ) ;
...
position p;
@@
 int cocci_id@p ( struct r3964_info * pInfo , struct pid * pid , unsigned char __user * buf ) ;
...
position p;
@@
 struct r3964_client_info cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct r3964_client_info * pClient , int msg_id , int arg , int error_code , struct r3964_block_header * pBlock ) ;
...
position p;
@@
 void cocci_id@p ( struct r3964_info * pInfo , const unsigned char c ) ;
...
position p;
@@
 struct tty_ldisc_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct r3964_info * pInfo , int error_code ) ;
...
position p;
@@
 struct r3964_client_message cocci_id@p ;
...
position p;
@@
 struct r3964_message * cocci_id@p ( struct r3964_info * pInfo , struct r3964_client_info * pClient ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * tty , struct ktermios * old ) ;
...
position p;
@@
 void cocci_id@p ( struct r3964_info * pInfo , struct r3964_client_info * pClient ) ;
...
position p;
@@
 void cocci_id@p ( struct r3964_info * pInfo , const char flag ) ;
...
position p;
@@
 void cocci_id@p ( struct r3964_info * pInfo ) ;
...
position p;
@@
 void cocci_id@p ( struct tty_struct * tty , const unsigned char * cp , char * fp , int count ) ;
...
position p;
@@
 struct r3964_message * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct r3964_info * pInfo , struct pid * pid , int arg ) ;
...
position p;
@@
 void cocci_id@p ( struct r3964_info * pInfo , unsigned char ch ) ;
