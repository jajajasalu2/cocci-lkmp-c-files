...
position p;
@@
 struct gb_cap_get_ims_certificate_response * cocci_id@p ;
...
position p;
@@
 struct gb_cap_get_ims_certificate_request * cocci_id@p ;
...
position p;
@@
 struct cap_ioc_authenticate * cocci_id@p ;
...
position p;
@@
 struct gb_cap_authenticate_request * cocci_id@p ;
...
position p;
@@
 struct gb_cap_get_endpoint_uid_response cocci_id@p ;
...
position p;
@@
 struct gb_cap_authenticate_response * cocci_id@p ;
...
position p;
@@
 struct cap_ioc_get_ims_certificate * cocci_id@p ;
...
typedef bool,dev_t;
@@
 struct gb_cap {  struct device * parent ;  struct gb_connection * connection ;  struct kref kref ;  struct list_head node ;  bool disabled ;  struct mutex mutex ;  struct cdev cdev ;  struct device * class_device ;  dev_t dev_num ; } cocci_id@p ;
...
position p;
@@
 struct cap_ioc_get_endpoint_uid cocci_id@p ;
