...
position p;
@@
 struct stm32_pwr_reg * cocci_id@p ;
...
position p;
@@
 enum { PWR_REG11 , PWR_REG18 , PWR_USB33 , STM32PWR_REG_NUM_REGS , } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_pwr_reg {  void __iomem * base ;  u32 ready_mask ; } cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ STM32PWR_REG_NUM_REGS ] ;
