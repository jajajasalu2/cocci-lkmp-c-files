...
position p;
@@
 enum { STR_ASSOC , STR_IF_CTRL , STR_CLKSRC_IN , STR_CLKSRC_OUT , STR_USB_IT , STR_IO_IT , STR_USB_OT , STR_IO_OT , STR_AS_OUT_ALT0 , STR_AS_OUT_ALT1 , STR_AS_IN_ALT0 , STR_AS_IN_ALT1 , } cocci_id@p ;
...
position p;
@@
 struct uac2_as_header_descriptor cocci_id@p ;
...
position p;
@@
 struct cntrl_cur_lay3 cocci_id@p ;
...
typedef __le32;
@@
 struct cntrl_cur_lay3 {  __le32 dCUR ; } cocci_id@p ;
...
position p;
@@
 struct uac2_iso_endpoint_descriptor cocci_id@p ;
...
position p;
@@
 struct uac2_ac_header_descriptor cocci_id@p ;
...
position p;
@@
 const struct f_uac2_opts * cocci_id@p ;
...
position p;
@@
 struct cntrl_range_lay3 cocci_id@p ;
...
position p;
@@
 struct uac2_format_type_i_descriptor cocci_id@p ;
