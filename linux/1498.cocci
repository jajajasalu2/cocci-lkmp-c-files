...
@@
 struct gadget_info {  struct config_group group ;  struct config_group functions_group ;  struct config_group configs_group ;  struct config_group strings_group ;  struct config_group os_desc_group ;  struct mutex lock ;  struct usb_gadget_strings * gstrings [ MAX_USB_STRING_LANGS + 1 ] ;  struct list_head string_list ;  struct list_head available_func ;  struct usb_composite_driver composite ;  struct usb_composite_dev cdev ;  bool use_os_desc ;  char b_vendor_code ;  char qw_sign [ OS_STRING_QW_SIGN_LEN ] ;  spinlock_t spinlock ;  bool unbind ; } cocci_id@p ;
...
position p;
@@
 struct gadget_config_name cocci_id@p ;
...
position p;
@@
 const struct usb_descriptor_header * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct config_usb_cfg * cocci_id@p ;
...
position p;
@@
 struct gadget_strings * cocci_id@p ;
...
position p;
@@
 struct config_item_type * cocci_id@p ;
...
position p;
@@
 const struct usb_gadget_driver cocci_id@p ;
...
position p;
@@
 struct gadget_strings {  struct usb_gadget_strings stringtab_dev ;  struct usb_string strings [ USB_GADGET_FIRST_AVAIL_IDX ] ;  char * manufacturer ;  char * product ;  char * serialnumber ;  struct config_group group ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_composite_driver * composite , struct usb_composite_dev * dev ) ;
...
position p;
@@
 struct usb_composite_driver * cocci_id@p ;
...
position p;
@@
 struct gadget_config_name {  struct usb_gadget_strings stringtab_dev ;  struct usb_string strings ;  char * configuration ;  struct config_group group ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct configfs_subsystem cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct usb_composite_dev * cdev , struct usb_ep * ep0 ) ;
...
position p;
@@
 struct os_desc {  struct config_group group ; } cocci_id@p ;
...
position p;
@@
 struct config_usb_cfg {  struct config_group group ;  struct config_group strings_group ;  struct list_head string_list ;  struct usb_configuration c ;  struct list_head func_list ;  struct usb_gadget_strings * gstrings [ MAX_USB_STRING_LANGS + 1 ] ; } cocci_id@p ;
