...
position p;
@@
 enum sensors { SENSOR_OM6802 , SENSOR_OTHER , SENSOR_TAS5130A , SENSOR_LT168G , } cocci_id@p ;
...
typedef u8;
@@
 const u8 cocci_id@p [ GAMMA_MAX + 1 ] [ 17 ] ;
...
typedef u8;
@@
 const u8 cocci_id@p [ MAX_EFFECTS ] [ 6 ] ;
...
typedef u8;
@@
 struct sd {  struct gspca_dev gspca_dev ;  struct v4l2_ctrl * freq ;  struct {  struct v4l2_ctrl * awb ;  struct v4l2_ctrl * gain ;  struct v4l2_ctrl * red_balance ;  struct v4l2_ctrl * blue_balance ; } ;  u8 sensor ;  u8 button_pressed ; } cocci_id@p ;
...
position p;
@@
 const struct additional_sensor_data * cocci_id@p ;
