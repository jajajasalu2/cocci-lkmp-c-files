...
typedef u32;
@@
 struct ent {  struct cache_head h ;  int type ;  u32 id ;  char name [ IDMAP_NAMESZ ] ;  char authname [ IDMAP_NAMESZ ] ;  struct rcu_head rcu_head ; } cocci_id@p ;
...
position p;
@@
 struct ent * ( * cocci_id@p ) ( struct cache_detail * , struct ent * ) ;
...
position p;
@@
 struct ent * cocci_id@p ( struct cache_detail * , struct ent * , struct ent * ) ;
...
position p;
@@
 int cocci_id@p ( struct cache_detail * , char * , int ) ;
