...
position p;
@@
 struct set_mib_buffer cocci_id@p ;
...
position p;
@@
 struct mib_mac_addr cocci_id@p ;
...
position p;
@@
 struct at76_req_join cocci_id@p ;
...
position p;
@@
 const struct reg_domain * cocci_id@p ;
...
position p;
@@
 struct mib_fw_version * cocci_id@p ;
...
position p;
@@
 struct at76_rx_buffer cocci_id@p ;
...
position p;
@@
 struct at76_card_config * cocci_id@p ;
...
position p;
@@
 struct at76_fw_header * cocci_id@p ;
...
position p;
@@
 struct at76_command * cocci_id@p ;
...
position p;
@@
 struct mib_mac_mgmt cocci_id@p ;
...
position p;
@@
 struct at76_req_scan cocci_id@p ;
...
position p;
@@
 struct at76_tx_buffer cocci_id@p ;
