...
position p;
@@
 rndis_query_msg_type * cocci_id@p ;
...
position p;
@@
 rndis_keepalive_msg_type * cocci_id@p ;
...
position p;
@@
 rndis_reset_cmplt_type * cocci_id@p ;
...
position p;
@@
 rndis_indicate_status_msg_type * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rndis_resp_t;
@@
 rndis_resp_t * cocci_id@p ;
...
position p;
@@
 rndis_keepalive_cmplt_type cocci_id@p ;
...
position p;
@@
 rndis_init_msg_type * cocci_id@p ;
...
position p;
@@
 rndis_reset_msg_type * cocci_id@p ;
...
position p;
@@
 rndis_set_cmplt_type * cocci_id@p ;
...
position p;
@@
 rndis_query_cmplt_type cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u32,rndis_resp_t;
@@
 rndis_resp_t * cocci_id@p ( struct rndis_params * params , u32 length ) ;
...
position p;
@@
 rndis_init_cmplt_type * cocci_id@p ;
