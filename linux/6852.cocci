...
position p;
@@
 struct fcp_resp_ext * cocci_id@p ;
...
position p;
@@
 struct fcp_resp_rsp_info * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_fcp_pkt * ) ;
...
position p;
@@
 struct fc_remote_port * * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fc_fcp_pkt * , struct fc_frame * ) ;
...
typedef u8;
@@
 void cocci_id@p ( struct fc_fcp_pkt * , u8 code ) ;
...
position p;
@@
 struct fc_fcp_internal * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef mempool_t,spinlock_t;
@@
 struct fc_fcp_internal {  mempool_t * scsi_pkt_pool ;  spinlock_t scsi_queue_lock ;  struct list_head scsi_pkt_queue ;  unsigned long last_can_queue_ramp_down_time ;  unsigned long last_can_queue_ramp_up_time ;  int max_can_queue ; } cocci_id@p ;
...
typedef u32;
@@
 void cocci_id@p ( struct fc_fcp_pkt * , enum fc_rctl , u32 ) ;
