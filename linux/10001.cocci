...
position p;
@@
 struct prism2_download_data * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ NUM_PDA_ADDRS ] ;
...
position p;
@@
 struct prism2_download_data_area cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u16,local_info_t;
@@
 struct prism2_download_aux_dump {  local_info_t * local ;  u16 page [ 0x80 ] ; } cocci_id@p ;
...
position p;
@@
 struct {  __le16 page ;  __le16 offset ;  __le16 len ; } cocci_id@p ;
...
position p;
@@
 struct prism2_download_aux_dump * cocci_id@p ;
