...
position p;
@@
 struct bench_mem_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef memset_t,memcpy_t;
@@
 struct function {  const char * name ;  const char * desc ;  union {  memcpy_t memcpy ;  memset_t memset ; } fn ; } cocci_id@p ;
