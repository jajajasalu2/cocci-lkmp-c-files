...
position p;
@@
 struct tegra_xudc_soc cocci_id@p ;
...
typedef __le32;
@@
 struct tegra_xudc_trb {  __le32 data_lo ;  __le32 data_hi ;  __le32 status ;  __le32 control ; } cocci_id@p ;
...
typedef bool;
@@
 struct tegra_xudc_soc {  const char * const * supply_names ;  unsigned int num_supplies ;  const char * const * clock_names ;  unsigned int num_clks ;  bool u1_enable ;  bool u2_enable ;  bool lpm_enable ;  bool invalid_seq_num ;  bool pls_quirk ;  bool port_reset_quirk ;  bool has_ipfs ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xudc_setup_packet {  struct usb_ctrlrequest ctrl_req ;  unsigned int seq_num ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xudc_request * cocci_id@p ;
...
position p;
@@
 struct usb_gadget_ops cocci_id@p ;
...
position p;
@@
 struct tegra_xudc_trb cocci_id@p ;
...
typedef bool;
@@
 struct tegra_xudc_request {  struct usb_request usb_req ;  size_t buf_queued ;  unsigned int trbs_queued ;  unsigned int trbs_needed ;  bool need_zlp ;  struct tegra_xudc_trb * first_trb ;  struct tegra_xudc_trb * last_trb ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xudc_ep * cocci_id@p ;
...
position p;
@@
 struct usb_role_switch_desc cocci_id@p ;
...
typedef u32;
@@
 struct tegra_xudc_save_regs {  u32 ctrl ;  u32 portpm ; } cocci_id@p ;
...
position p;
@@
 const struct usb_ss_ep_comp_descriptor * cocci_id@p ;
...
typedef __u8;
@@
 struct tegra_xudc_sel_timing {  __u8 u1sel ;  __u8 u1pel ;  __le16 u2sel ;  __le16 u2pel ; } cocci_id@p ;
...
position p;
@@
 enum tegra_xudc_setup_state { WAIT_FOR_SETUP , DATA_STAGE_XFER , DATA_STAGE_RECV , STATUS_STAGE_XFER , STATUS_STAGE_RECV , } cocci_id@p ;
...
typedef __le32;
@@
 struct tegra_xudc_ep_context {  __le32 info0 ;  __le32 info1 ;  __le32 deq_lo ;  __le32 deq_hi ;  __le32 tx_info ;  __le32 rsvd [ 11 ] ; } cocci_id@p ;
...
position p;
@@
 struct tegra_xudc_ep_context * cocci_id@p ;
