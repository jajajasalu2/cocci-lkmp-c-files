...
position p;
@@
 struct berlin_pinctrl * cocci_id@p ;
...
position p;
@@
 struct berlin_pinctrl {  struct regmap * regmap ;  struct device * dev ;  const struct berlin_pinctrl_desc * desc ;  struct berlin_pinctrl_function * functions ;  unsigned nfunctions ;  struct pinctrl_dev * pctrl_dev ; } cocci_id@p ;
...
position p;
@@
 const struct berlin_pinctrl_desc * cocci_id@p ;
...
position p;
@@
 struct berlin_desc_function * cocci_id@p ;
...
position p;
@@
 struct berlin_pinctrl_function * cocci_id@p ;
...
position p;
@@
 const struct berlin_desc_group * cocci_id@p ;
...
position p;
@@
 const struct berlin_desc_function * cocci_id@p ;
