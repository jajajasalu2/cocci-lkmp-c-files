...
position p;
@@
 struct mt9t112_priv cocci_id@p ;
...
typedef bool;
@@
 struct mt9t112_priv {  struct v4l2_subdev subdev ;  struct mt9t112_platform_data * info ;  struct i2c_client * client ;  struct v4l2_rect frame ;  struct clk * clk ;  struct gpio_desc * standby_gpio ;  const struct mt9t112_format * format ;  int num_formats ;  bool init_done ; } cocci_id@p ;
...
position p;
@@
 const struct mt9t112_format cocci_id@p [ ] ;
...
typedef u32,u16;
@@
 struct mt9t112_format {  u32 code ;  enum v4l2_colorspace colorspace ;  u16 fmt ;  u16 order ; } cocci_id@p ;
