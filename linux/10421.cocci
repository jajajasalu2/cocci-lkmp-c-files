...
position p;
@@
 struct rcar_du_of_overlay {  const char * compatible ;  void * begin ;  void * end ; } cocci_id@p ;
...
position p;
@@
 const struct rcar_du_of_overlay * cocci_id@p ;
...
position p;
@@
 struct lvds_of_data * cocci_id@p ;
...
position p;
@@
 struct lvds_of_data {  struct resource res ;  struct of_phandle_args clkspec ;  struct device_node * local ;  struct device_node * remote ; } cocci_id@p ;
...
position p;
@@
 struct lvds_of_data cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct rcar_du_device_info * cocci_id@p ;
