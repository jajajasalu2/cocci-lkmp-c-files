...
position p;
@@
 char cocci_id@p [ NLMSG_ALIGN ( sizeof ( * nh ) ) + NLMSG_ALIGN ( sizeof ( * rt ) ) + NLMSG_ALIGN ( RTA_LENGTH ( sizeof ( addr6 ) ) ) + NLMSG_ALIGN ( RTA_LENGTH ( sizeof ( int ) ) ) + NLMSG_ALIGN ( RTA_LENGTH ( 0 ) + RTA_LENGTH ( sizeof ( int ) ) ) ] ;
...
typedef bool;
@@
 struct testcase {  int tlen ;  bool tfail ;  int gso_len ;  int r_num_mss ;  int r_len_last ; } cocci_id@p ;
...
typedef uint16_t;
@@
 char cocci_id@p [ CMSG_SPACE ( sizeof ( uint16_t ) ) ] ;
