...
position p;
@@
 struct minix_sb_info cocci_id@p ;
...
position p;
@@
 struct minix2_inode * cocci_id@p ;
...
position p;
@@
 struct minix3_super_block * cocci_id@p ;
...
position p;
@@
 struct minix_super_block * cocci_id@p ;
...
position p;
@@
 struct minix_inode_info cocci_id@p ;
