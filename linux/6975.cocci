...
position p;
@@
 struct slimpro_mbox * cocci_id@p ;
...
position p;
@@
 struct slimpro_mbox_chan * cocci_id@p ;
...
position p;
@@
 struct slimpro_mbox {  struct mbox_controller mb_ctrl ;  struct slimpro_mbox_chan mc [ MBOX_CNT ] ;  struct mbox_chan chans [ MBOX_CNT ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct slimpro_mbox_chan {  struct device * dev ;  struct mbox_chan * chan ;  void __iomem * reg ;  int irq ;  u32 rx_msg [ 3 ] ; } cocci_id@p ;
