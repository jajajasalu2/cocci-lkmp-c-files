...
position p;
@@
 struct tps80031_regulator * cocci_id@p ;
...
typedef u8;
@@
 struct tps80031_regulator_info {  u8 trans_reg ;  u8 state_reg ;  u8 force_reg ;  u8 volt_reg ;  u8 volt_id ;  int preq_bit ;  struct regulator_desc desc ; } cocci_id@p ;
...
position p;
@@
 struct tps80031_platform_data * cocci_id@p ;
...
typedef u8;
@@
 struct tps80031_regulator {  struct device * dev ;  struct tps80031_regulator_info * rinfo ;  u8 device_flags ;  unsigned int config_flags ;  unsigned int ext_ctrl_flag ; } cocci_id@p ;
...
position p;
@@
 struct tps80031_regulator_info cocci_id@p [ TPS80031_REGULATOR_MAX ] ;
...
position p;
@@
 struct tps80031_regulator_platform_data * cocci_id@p ;
