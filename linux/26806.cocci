...
typedef u64;
@@
 u64 cocci_id@p ( struct inode * , struct ufs_cg_private_info * , u64 , int * ) ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct inode * , u64 , unsigned , unsigned ) ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct inode * , unsigned , u64 , unsigned , int * ) ;
...
position p;
@@
 void cocci_id@p ( struct super_block * , struct ufs_cg_private_info * , unsigned , int ) ;
...
typedef u64;
@@
 u64 cocci_id@p ( struct super_block * , struct ufs_cg_private_info * , u64 , unsigned ) ;
