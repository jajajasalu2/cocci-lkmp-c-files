...
position p;
@@
 const struct btf_enum * cocci_id@p ;
...
position p;
@@
 struct btf_str_ptrs * cocci_id@p ;
...
position p;
@@
 struct btf_dedup * cocci_id@p ( struct btf * btf , struct btf_ext * btf_ext , const struct btf_dedup_opts * opts ) ;
...
position p;
@@
 const struct btf_str_ptr * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btf_dedup * d ) ;
...
position p;
@@
 struct btf_ext_info * cocci_id@p ;
...
position p;
@@
 const struct btf_param * cocci_id@p ;
...
position p;
@@
 struct btf_ext_header * cocci_id@p ;
...
position p;
@@
 const struct btf_ext_header * cocci_id@p ;
...
typedef __u32;
@@
 struct btf_str_ptrs {  struct btf_str_ptr * ptrs ;  const char * data ;  __u32 cnt ;  __u32 cap ; } cocci_id@p ;
...
position p;
@@
 struct btf_ext_info_sec * cocci_id@p ;
...
typedef __u32;
@@
 struct btf {  union {  struct btf_header * hdr ;  void * data ; } ;  struct btf_type * * types ;  const char * strings ;  void * nohdr_data ;  __u32 nr_types ;  __u32 types_size ;  __u32 data_size ;  int fd ; } cocci_id@p ;
...
typedef __u32;
@@
 int ( * cocci_id@p ) ( __u32 * str_off_ptr , void * ctx ) ;
...
position p;
@@
 const struct btf_dedup_opts * cocci_id@p ;
...
position p;
@@
 struct bpf_line_info_min * cocci_id@p ;
...
position p;
@@
 struct bpf_field_reloc cocci_id@p ;
...
position p;
@@
 struct bpf_func_info_min cocci_id@p ;
...
symbol cocci_id;
position p;
typedef str_off_fn_t;
@@
 str_off_fn_t cocci_id@p ;
...
typedef bool,__u32;
@@
 struct btf_str_ptr {  const char * str ;  __u32 new_off ;  bool used ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btf_dedup * d ) ;
...
typedef __u32;
@@
 struct btf_ext_sec_setup_param {  __u32 off ;  __u32 len ;  __u32 min_rec_size ;  struct btf_ext_info * ext_info ;  const char * desc ; } cocci_id@p ;
...
position p;
@@
 struct btf_ext_sec_setup_param cocci_id@p ;
...
typedef __u32;
@@
 struct btf_dedup {  struct btf * btf ;  struct btf_ext * btf_ext ;  struct hashmap * dedup_table ;  __u32 * map ;  __u32 * hypot_map ;  __u32 * hypot_list ;  size_t hypot_cnt ;  size_t hypot_cap ;  struct btf_dedup_opts opts ; } cocci_id@p ;
...
position p;
@@
 const struct btf_ext * cocci_id@p ;
