...
position p;
@@
 struct lpfc_fdmi_port_entry * cocci_id@p ;
...
position p;
@@
 struct lpfc_fdmi_attr_def * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ ] ) ( struct lpfc_vport * vport , struct lpfc_fdmi_attr_def * ad ) ;
...
position p;
@@
 struct lpfc_fdmi_attr_entry * cocci_id@p ;
...
position p;
@@
 struct lpfc_fdmi_reg_hba * cocci_id@p ;
...
position p;
@@
 struct lpfc_fdmi_attr_block * cocci_id@p ;
...
position p;
@@
 struct lpfc_fdmi_reg_portattr * cocci_id@p ;
