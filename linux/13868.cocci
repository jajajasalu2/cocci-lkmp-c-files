...
position p;
@@
 struct st_rc_device * cocci_id@p ;
...
typedef bool;
@@
 struct st_rc_device {  struct device * dev ;  int irq ;  int irq_wake ;  struct clk * sys_clock ;  void __iomem * base ;  void __iomem * rx_base ;  struct rc_dev * rdev ;  bool overclocking ;  int sample_mult ;  int sample_div ;  bool rxuhfmode ;  struct reset_control * rstc ; } cocci_id@p ;
