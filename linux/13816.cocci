...
typedef u8;
@@
 struct adv748x_reg_value {  u8 page ;  u8 reg ;  u8 value ; } cocci_id@p ;
...
typedef u8;
@@
 struct adv748x_register_map {  const char * name ;  u8 default_addr ; } cocci_id@p ;
...
position p;
@@
 const struct adv748x_reg_value * cocci_id@p ;
...
position p;
@@
 const struct adv748x_register_map cocci_id@p [ ] ;
...
position p;
@@
 struct adv748x_csi2 * cocci_id@p ;
