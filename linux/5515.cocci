...
typedef bool;
@@
 struct omap_rtc_device_type {  bool has_32kclk_en ;  bool has_irqwakeen ;  bool has_pmic_mode ;  bool has_power_up_reset ;  void ( * lock ) ( struct omap_rtc * rtc ) ;  void ( * unlock ) ( struct omap_rtc * rtc ) ; } cocci_id@p ;
...
position p;
@@
 const struct omap_rtc_device_type cocci_id@p ;
...
position p;
@@
 const struct pin_config_item cocci_id@p [ ARRAY_SIZE ( rtc_params ) ] ;
...
typedef u8,bool;
@@
 struct omap_rtc {  struct rtc_device * rtc ;  void __iomem * base ;  struct clk * clk ;  int irq_alarm ;  int irq_timer ;  u8 interrupts_reg ;  bool is_pmic_controller ;  bool has_ext_clk ;  bool is_suspending ;  const struct omap_rtc_device_type * type ;  struct pinctrl_dev * pctldev ; } cocci_id@p ;
