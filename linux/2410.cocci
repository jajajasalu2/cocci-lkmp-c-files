...
position p;
@@
 struct mic_dma_desc * cocci_id@p ;
...
position p;
@@
 struct mbus_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct mic_dma_chan * cocci_id@p ;
...
position p;
@@
 enum mic_dma_chan_owner cocci_id@p ;
...
position p;
@@
 enum mic_dma_desc_format_type { MIC_DMA_MEMCPY = 1 , MIC_DMA_STATUS , } cocci_id@p ;
...
position p;
@@
 struct mic_dma_device * cocci_id@p ;
