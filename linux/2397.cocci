...
@@
 struct cppi41_channel {  struct dma_chan chan ;  struct dma_async_tx_descriptor txd ;  struct cppi41_dd * cdd ;  struct cppi41_desc * desc ;  dma_addr_t desc_phys ;  void __iomem * gcr_reg ;  int is_tx ;  u32 residue ;  unsigned int q_num ;  unsigned int q_comp_num ;  unsigned int port_num ;  unsigned td_retry ;  unsigned td_queued : 1 ;  unsigned td_seen : 1 ;  unsigned td_desc_seen : 1 ;  struct list_head node ; } cocci_id@p ;
...
position p;
@@
 const struct cppi_glue_infos * cocci_id@p ;
...
position p;
@@
 struct cppi41_channel * cocci_id@p ;
...
typedef u16;
@@
 struct cppi_glue_infos {  const struct chan_queues * queues_rx ;  const struct chan_queues * queues_tx ;  struct chan_queues td_queue ;  u16 first_completion_queue ;  u16 qmgr_num_pend ; } cocci_id@p ;
...
typedef u16;
@@
 struct chan_queues {  u16 submit ;  u16 complete ; } cocci_id@p ;
...
position p;
@@
 const struct chan_queues cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef u8,bool,u32,u16,spinlock_t,dma_addr_t;
@@
 struct cppi41_dd {  struct dma_device ddev ;  void * qmgr_scratch ;  dma_addr_t scratch_phys ;  struct cppi41_desc * cd ;  dma_addr_t descs_phys ;  u32 first_td_desc ;  struct cppi41_channel * chan_busy [ ALLOC_DECS_NUM ] ;  void __iomem * ctrl_mem ;  void __iomem * sched_mem ;  void __iomem * qmgr_mem ;  unsigned int irq ;  const struct chan_queues * queues_rx ;  const struct chan_queues * queues_tx ;  struct chan_queues td_queue ;  u16 first_completion_queue ;  u16 qmgr_num_pend ;  u32 n_chans ;  u8 platform ;  struct list_head pending ;  spinlock_t lock ;  unsigned int dma_tdfdq ;  bool is_suspended ; } cocci_id@p ;
