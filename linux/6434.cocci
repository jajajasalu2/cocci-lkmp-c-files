...
position p;
@@
 struct s2mps11_info * cocci_id@p ;
...
position p;
@@
 struct s2mps11_info {  int ramp_delay2 ;  int ramp_delay34 ;  int ramp_delay5 ;  int ramp_delay16 ;  int ramp_delay7810 ;  int ramp_delay9 ;  enum sec_device_type dev_type ; 
	 DECLARE_BITMAP ( suspend_state , S2MPS_REGULATOR_MAX ) 
		 ;  struct gpio_desc * * ext_control_gpiod ; } cocci_id@p ;
