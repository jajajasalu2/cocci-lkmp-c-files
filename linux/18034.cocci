...
typedef bool,u32;
@@
 struct jit_ctx {  struct bpf_prog * prog ;  unsigned int * offset ;  int idx ;  int epilogue_offset ;  bool tmp_1_used ;  bool tmp_2_used ;  bool tmp_3_used ;  bool saw_frame_pointer ;  bool saw_call ;  bool saw_tail_call ;  u32 * image ; } cocci_id@p ;
...
position p;
@@
 struct sparc64_jit_data * cocci_id@p ;
...
typedef u8;
@@
 struct sparc64_jit_data {  struct bpf_binary_header * header ;  u8 * image ;  struct jit_ctx ctx ; } cocci_id@p ;
