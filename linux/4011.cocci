...
position p;
@@
 struct stm32_exti_chip_data cocci_id@p ;
...
typedef u32;
@@
 struct stm32_exti_chip_data {  struct stm32_exti_host_data * host_data ;  const struct stm32_exti_bank * reg_bank ;  struct raw_spinlock rlock ;  u32 wake_active ;  u32 mask_cache ;  u32 rtsr_cache ;  u32 ftsr_cache ; } cocci_id@p ;
...
position p;
@@
 struct stm32_exti_host_data {  void __iomem * base ;  struct stm32_exti_chip_data * chips_data ;  const struct stm32_exti_drv_data * drv_data ;  struct hwspinlock * hwlock ; } cocci_id@p ;
...
typedef u32;
@@
 struct stm32_exti_bank {  u32 imr_ofst ;  u32 emr_ofst ;  u32 rtsr_ofst ;  u32 ftsr_ofst ;  u32 swier_ofst ;  u32 rpr_ofst ;  u32 fpr_ofst ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_desc_irq * cocci_id@p ;
...
position p;
@@
 struct stm32_exti_host_data * cocci_id@p ;
...
typedef u32;
@@
 struct stm32_exti_drv_data {  const struct stm32_exti_bank * * exti_banks ;  const struct stm32_desc_irq * desc_irqs ;  u32 bank_nr ;  u32 irq_nr ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_exti_bank * cocci_id@p [ ] ;
...
typedef u32;
@@
 struct stm32_desc_irq {  u32 exti ;  u32 irq_parent ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_exti_drv_data * cocci_id@p ;
