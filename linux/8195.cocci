...
position p;
@@
 struct mvpp2_dbgfs_flow_tbl_entry {  int id ;  struct mvpp2 * priv ; } cocci_id@p ;
...
position p;
@@
 struct mvpp2_cls_c2_entry cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_c2_entry {  int id ;  struct mvpp2 * priv ; } cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_port_flow_entry {  struct mvpp2_port * port ;  struct mvpp2_dbgfs_flow_entry * dbg_fe ; } cocci_id@p ;
...
position p;
@@
 const struct mvpp2_cls_flow * cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_flow_tbl_entry * cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_flow_entry * cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_prs_entry {  int tid ;  struct mvpp2 * priv ; } cocci_id@p ;
...
position p;
@@
 struct mvpp2_prs_entry cocci_id@p ;
...
position p;
@@
 const struct mvpp2_dbgfs_flow_entry * cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_flow_entry {  int flow ;  struct mvpp2 * priv ; } cocci_id@p ;
...
position p;
@@
 struct mvpp2_cls_flow_entry cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_entries {  struct mvpp2_dbgfs_prs_entry prs_entries [ MVPP2_PRS_TCAM_SRAM_SIZE ] ;  struct mvpp2_dbgfs_c2_entry c2_entries [ MVPP22_CLS_C2_N_ENTRIES ] ;  struct mvpp2_dbgfs_flow_tbl_entry flt_entries [ MVPP2_CLS_FLOWS_TBL_SIZE ] ;  struct mvpp2_dbgfs_flow_entry flow_entries [ MVPP2_N_PRS_FLOWS ] ;  struct mvpp2_dbgfs_port_flow_entry port_flow_entries [ MVPP2_MAX_PORTS ] ; } cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_prs_entry * cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_c2_entry * cocci_id@p ;
...
position p;
@@
 struct mvpp2_dbgfs_port_flow_entry * cocci_id@p ;
