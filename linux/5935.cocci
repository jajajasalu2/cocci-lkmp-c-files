...
position p;
@@
 enum { PAD_UNLOCKED = 0 , PAD_LOCKED = 1 , PAD_LOCKED_TX = 2 , PAD_LOCKED_FULL = PAD_LOCKED | PAD_LOCKED_TX , } cocci_id@p ;
...
position p;
@@
 const struct intel_pingroup * cocci_id@p ;
...
position p;
@@
 struct intel_pinctrl * cocci_id@p ;
...
position p;
@@
 struct intel_community_context * cocci_id@p ;
...
typedef u32;
@@
 struct intel_community_context {  u32 * intmask ;  u32 * hostown ; } cocci_id@p ;
...
position p;
@@
 const struct intel_pinctrl_soc_data * cocci_id@p ;
...
position p;
@@
 const struct intel_padgroup * cocci_id@p ;
...
position p;
@@
 struct intel_pad_context * cocci_id@p ;
...
position p;
@@
 const struct intel_pinctrl * cocci_id@p ;
...
position p;
@@
 struct intel_pinctrl_context {  struct intel_pad_context * pads ;  struct intel_community_context * communities ; } cocci_id@p ;
...
typedef u32;
@@
 struct intel_pad_context {  u32 padcfg0 ;  u32 padcfg1 ;  u32 padcfg2 ; } cocci_id@p ;
...
position p;
@@
 const struct intel_community_context * cocci_id@p ;
...
position p;
@@
 const struct intel_pad_context * cocci_id@p ;
...
position p;
@@
 struct intel_community * cocci_id@p ;
...
position p;
@@
 const struct intel_community * * cocci_id@p ;
...
position p;
@@
 struct intel_padgroup * cocci_id@p ;
...
@@
 struct intel_pinctrl {  struct device * dev ;  raw_spinlock_t lock ;  struct pinctrl_desc pctldesc ;  struct pinctrl_dev * pctldev ;  struct gpio_chip chip ;  struct irq_chip irqchip ;  const struct intel_pinctrl_soc_data * soc ;  struct intel_community * communities ;  size_t ncommunities ;  struct intel_pinctrl_context context ;  int irq ; } cocci_id@p ;
