...
typedef bool;
@@
 struct ftide010 {  struct device * dev ;  void __iomem * base ;  struct clk * pclk ;  struct ata_host * host ;  unsigned int master_cbl ;  unsigned int slave_cbl ;  struct sata_gemini * sg ;  bool master_to_sata0 ;  bool slave_to_sata0 ;  bool master_to_sata1 ;  bool slave_to_sata1 ; } cocci_id@p ;
...
position p;
@@
 enum gemini_muxmode cocci_id@p ;
