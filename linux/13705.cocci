...
typedef u8,u16;
@@
 struct reg_value {  u16 reg ;  u8 val ; } cocci_id@p ;
...
position p;
@@
 const struct ov5645_mode_info * cocci_id@p ;
...
typedef u32;
@@
 struct ov5645_mode_info {  u32 width ;  u32 height ;  const struct reg_value * data ;  u32 data_size ;  u32 pixel_clock ;  u32 link_freq ; } cocci_id@p ;
...
typedef u8;
@@
 struct ov5645 {  struct i2c_client * i2c_client ;  struct device * dev ;  struct v4l2_subdev sd ;  struct media_pad pad ;  struct v4l2_fwnode_endpoint ep ;  struct v4l2_mbus_framefmt fmt ;  struct v4l2_rect crop ;  struct clk * xclk ;  struct regulator_bulk_data supplies [ OV5645_NUM_SUPPLIES ] ;  const struct ov5645_mode_info * current_mode ;  struct v4l2_ctrl_handler ctrls ;  struct v4l2_ctrl * pixel_clock ;  struct v4l2_ctrl * link_freq ;  u8 aec_pk_manual ;  u8 timing_tc_reg20 ;  u8 timing_tc_reg21 ;  struct mutex power_lock ;  int power_count ;  struct gpio_desc * enable_gpio ;  struct gpio_desc * rst_gpio ; } cocci_id@p ;
