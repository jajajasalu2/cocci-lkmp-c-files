...
position p;
@@
 struct acpi_ipmi_device * cocci_id@p ;
...
typedef u8;
@@
 struct acpi_ipmi_msg {  struct list_head head ;  struct ipmi_addr addr ;  long tx_msgid ;  struct completion tx_complete ;  struct kernel_ipmi_msg tx_message ;  int msg_done ;  u8 data [ ACPI_IPMI_MAX_MSG_LENGTH ] ;  u8 rx_len ;  struct acpi_ipmi_device * device ;  struct kref kref ; } cocci_id@p ;
...
position p;
@@
 struct acpi_ipmi_msg cocci_id@p ;
...
typedef u8;
@@
 struct acpi_ipmi_buffer {  u8 status ;  u8 length ;  u8 data [ ACPI_IPMI_MAX_MSG_LENGTH ] ; } cocci_id@p ;
...
position p;
@@
 struct ipmi_driver_data {  struct list_head ipmi_devices ;  struct ipmi_smi_watcher bmc_events ;  const struct ipmi_user_hndl ipmi_hndlrs ;  struct mutex ipmi_lock ;  struct acpi_ipmi_device * selected_smi ; } cocci_id@p ;
...
position p;
@@
 struct acpi_ipmi_buffer * cocci_id@p ;
...
position p;
@@
 struct ipmi_driver_data cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,acpi_handle,spinlock_t;
@@
 struct acpi_ipmi_device {  struct list_head head ;  struct list_head tx_msg_list ;  spinlock_t tx_msg_lock ;  acpi_handle handle ;  struct device * dev ;  struct ipmi_user * user_interface ;  int ipmi_ifnum ;  long curr_msgid ;  bool dead ;  struct kref kref ; } cocci_id@p ;
