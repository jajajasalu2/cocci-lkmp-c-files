...
position p;
@@
 struct amdgpu_gtt_node * cocci_id@p ;
...
position p;
@@
 struct amdgpu_gtt_mgr * cocci_id@p ;
...
@@
 struct amdgpu_gtt_mgr {  struct drm_mm mm ;  spinlock_t lock ;  atomic64_t available ; } cocci_id@p ;
...
position p;
@@
 struct amdgpu_gtt_node {  struct drm_mm_node node ;  struct ttm_buffer_object * tbo ; } cocci_id@p ;
...
position p;
@@
 const struct ttm_mem_type_manager_func cocci_id@p ;
