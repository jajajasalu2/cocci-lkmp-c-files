...
position p;
@@
 struct dell_bios_hotkey_table cocci_id@p ;
...
typedef u16;
@@
 struct dell_bios_keymap_entry {  u16 scancode ;  u16 keycode ; } cocci_id@p ;
...
position p;
@@
 struct dell_bios_hotkey_table {  struct dmi_header header ;  struct dell_bios_keymap_entry keymap [ ] ; } cocci_id@p ;
...
typedef u32;
@@
 struct dell_wmi_priv {  struct input_dev * input_dev ;  u32 interface_version ; } cocci_id@p ;
...
position p;
@@
 const struct dell_bios_keymap_entry * cocci_id@p ;
...
position p;
@@
 struct dell_dmi_results cocci_id@p ;
...
position p;
@@
 struct dell_wmi_priv cocci_id@p ;
...
position p;
@@
 struct dell_bios_keymap_entry cocci_id@p ;
...
position p;
@@
 struct dell_dmi_results {  int err ;  int keymap_size ;  struct key_entry * keymap ; } cocci_id@p ;
