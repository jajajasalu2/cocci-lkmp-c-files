...
position p;
@@
 int cocci_id@p ( struct notifier_block * notify_block , unsigned long mode , void * unused ) ;
...
position p;
@@
 enum wil_platform_event cocci_id@p ;
...
position p;
@@
 const struct wil_platform_rops cocci_id@p ;
