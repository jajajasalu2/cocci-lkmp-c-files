...
position p;
@@
 struct atmel_pcm_dma_params cocci_id@p [ NUM_SSC_DEVICES ] [ 2 ] ;
...
position p;
@@
 struct atmel_ssc_info cocci_id@p [ NUM_SSC_DEVICES ] ;
...
position p;
@@
 struct atmel_ssc_info * cocci_id@p ;
...
position p;
@@
 struct atmel_ssc_mask cocci_id@p ;
...
position p;
@@
 struct atmel_pdc_regs cocci_id@p ;
