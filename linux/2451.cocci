...
position p;
@@
 int cocci_id@p [ SH_DMAE_MAX_CHANNELS ] ;
...
position p;
@@
 unsigned long cocci_id@p [ SH_DMAE_MAX_CHANNELS ] ;
...
position p;
@@
 struct sh_dmae_device * cocci_id@p ;
...
position p;
@@
 const struct sh_dmae_pdata * cocci_id@p ;
...
position p;
@@
 struct sh_dmae_chan * cocci_id@p ;
...
position p;
@@
 struct sh_dmae_desc * cocci_id@p ;
...
position p;
@@
 struct sh_dmae_regs * cocci_id@p ;
