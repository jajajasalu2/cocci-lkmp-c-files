...
typedef u32;
@@
 struct phy_berlin_desc {  struct phy * phy ;  u32 power_bit ;  unsigned index ; } cocci_id@p ;
...
position p;
@@
 struct phy_berlin_priv * cocci_id@p ;
...
position p;
@@
 struct phy_berlin_desc * cocci_id@p ;
...
@@
 struct phy_berlin_priv {  void __iomem * base ;  spinlock_t lock ;  struct clk * clk ;  struct phy_berlin_desc * * phys ;  unsigned nphys ;  u32 phy_base ; } cocci_id@p ;
