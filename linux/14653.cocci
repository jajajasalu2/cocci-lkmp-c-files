...
position p;
@@
 struct lochnagar_clk_priv {  struct device * dev ;  struct regmap * regmap ;  struct lochnagar_clk lclks [ LOCHNAGAR_NUM_CLOCKS ] ; } cocci_id@p ;
...
position p;
@@
 struct lochnagar_config * cocci_id@p ;
...
position p;
@@
 const struct lochnagar_config cocci_id@p ;
...
position p;
@@
 struct lochnagar_config {  const struct clk_parent_data * parents ;  int nparents ;  const struct lochnagar_clk * clks ; } cocci_id@p ;
...
position p;
@@
 struct lochnagar_clk_priv * cocci_id@p ;
...
position p;
@@
 const struct lochnagar_clk cocci_id@p [ LOCHNAGAR_NUM_CLOCKS ] ;
...
position p;
@@
 struct lochnagar_clk cocci_id@p ;
...
typedef u16;
@@
 struct lochnagar_clk {  const char * const name ;  struct clk_hw hw ;  struct lochnagar_clk_priv * priv ;  u16 cfg_reg ;  u16 ena_mask ;  u16 src_reg ;  u16 src_mask ; } cocci_id@p ;
