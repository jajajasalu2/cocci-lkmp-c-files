...
position p;
@@
 enum ad5360_type { ID_AD5360 , ID_AD5361 , ID_AD5362 , ID_AD5363 , ID_AD5370 , ID_AD5371 , ID_AD5372 , ID_AD5373 , } cocci_id@p ;
...
position p;
@@
 struct ad5360_chip_info {  struct iio_chan_spec channel_template ;  unsigned int num_channels ;  unsigned int channels_per_group ;  unsigned int num_vrefs ; } cocci_id@p ;
...
position p;
@@
 struct ad5360_state * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct ad5360_state {  struct spi_device * spi ;  const struct ad5360_chip_info * chip_info ;  struct regulator_bulk_data vref_reg [ 3 ] ;  unsigned int ctrl ;  union {  __be32 d32 ;  u8 d8 [ 4 ] ; } data [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 const struct ad5360_chip_info cocci_id@p [ ] ;
