...
position p;
@@
 struct acpi_irq_parse_one_ctx cocci_id@p ;
...
position p;
@@
 struct acpi_irq_parse_one_ctx {  int rc ;  unsigned int index ;  unsigned long * res_flags ;  struct irq_fwspec * fwspec ; } cocci_id@p ;
...
position p;
@@
 const struct acpi_resource_source * cocci_id@p ;
