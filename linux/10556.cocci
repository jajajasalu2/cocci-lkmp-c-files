...
position p;
@@
 struct intel_runtime_pm_debug cocci_id@p ;
...
typedef depot_stack_handle_t;
@@
 const depot_stack_handle_t * const cocci_id@p ;
...
position p;
@@
 const struct intel_runtime_pm_debug * cocci_id@p ;
...
position p;
@@
 unsigned long cocci_id@p [ STACKDEPTH ] ;
