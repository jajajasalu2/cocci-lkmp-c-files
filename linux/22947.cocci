...
position p;
@@
 struct seq_oss_synth_sysex {  int len ;  int skip ;  unsigned char buf [ MAX_SYSEX_BUFLEN ] ; } cocci_id@p ;
...
position p;
@@
 struct seq_oss_synth * cocci_id@p [ SNDRV_SEQ_OSS_MAX_SYNTH_DEVS ] ;
...
@@
 struct seq_oss_synth {  int seq_device ;  int synth_type ;  int synth_subtype ;  int nr_voices ;  char name [ SNDRV_SEQ_OSS_MAX_SYNTH_NAME ] ;  struct snd_seq_oss_callback oper ;  int opened ;  void * private_data ;  snd_use_lock_t use_lock ; } cocci_id@p ;
...
position p;
@@
 struct seq_oss_synth_sysex * cocci_id@p ;
...
position p;
@@
 struct seq_oss_synth * cocci_id@p ;
...
position p;
@@
 struct seq_oss_synth * cocci_id@p ( struct seq_oss_devinfo * dp , int dev ) ;
...
position p;
@@
 struct seq_oss_synthinfo * cocci_id@p ;
...
position p;
@@
 struct seq_oss_chinfo cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct seq_oss_synthinfo * info ) ;
