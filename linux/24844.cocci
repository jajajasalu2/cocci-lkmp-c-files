...
position p;
@@
 const struct nf_conn_nat * cocci_id@p ;
...
position p;
@@
 struct masq_dev_work {  struct work_struct work ;  struct net * net ;  struct in6_addr addr ;  int ifindex ; } cocci_id@p ;
...
position p;
@@
 struct masq_dev_work cocci_id@p ;
