...
position p;
@@
 struct i2s_stream_instance cocci_id@p ;
...
typedef bool,u32;
@@
 struct i2s_dev_data {  bool tdm_mode ;  unsigned int i2s_irq ;  u32 tdm_fmt ;  void __iomem * acp3x_base ;  struct snd_pcm_substream * play_stream ;  struct snd_pcm_substream * capture_stream ; } cocci_id@p ;
...
position p;
@@
 struct i2s_dev_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u32,u16,dma_addr_t;
@@
 struct i2s_stream_instance {  u16 num_pages ;  u16 channels ;  u32 xfer_resolution ;  u64 bytescount ;  dma_addr_t dma_addr ;  void __iomem * acp3x_base ; } cocci_id@p ;
