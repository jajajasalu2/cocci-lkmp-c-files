...
position p;
@@
 const struct gfs2_statfs_change * cocci_id@p ;
...
position p;
@@
 struct gfs2_statfs_change_host cocci_id@p ;
...
position p;
@@
 struct gfs2_statfs_change cocci_id@p ;
...
position p;
@@
 const struct gfs2_statfs_change_host * cocci_id@p ;
...
position p;
@@
 struct lfcc {  struct list_head list ;  struct gfs2_holder gh ; } cocci_id@p ;
