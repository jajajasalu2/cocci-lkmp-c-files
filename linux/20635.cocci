...
position p;
@@
 enum __force_cpu_type { reserved = 0 , timer , arch_perfmon , } cocci_id@p ;
...
position p;
@@
 struct op_counter_config cocci_id@p [ OP_MAX_COUNTER ] ;
...
position p;
@@
 const struct op_msrs * cocci_id@p ;
