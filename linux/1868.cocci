...
position p;
@@
 enum rcar_gyroadc_model { RCAR_GYROADC_MODEL_DEFAULT , RCAR_GYROADC_MODEL_R8A7792 , } cocci_id@p ;
...
position p;
@@
 enum rcar_gyroadc_model cocci_id@p ;
...
position p;
@@
 struct rcar_gyroadc * cocci_id@p ;
...
position p;
@@
 struct rcar_gyroadc {  struct device * dev ;  void __iomem * regs ;  struct clk * clk ;  struct regulator * vref [ 8 ] ;  unsigned int num_channels ;  enum rcar_gyroadc_model model ;  unsigned int mode ;  unsigned int sample_width ; } cocci_id@p ;
