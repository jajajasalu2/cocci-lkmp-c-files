...
position p;
@@
 const struct min_max_quirk cocci_id@p [ ] ;
...
position p;
@@
 enum { SYNAPTICS_INTERTOUCH_NOT_SET = - 1 , SYNAPTICS_INTERTOUCH_OFF , SYNAPTICS_INTERTOUCH_ON , } cocci_id@p ;
...
position p;
@@
 struct synaptics_hw_state * cocci_id@p ;
...
position p;
@@
 struct synaptics_data * cocci_id@p ;
...
position p;
@@
 struct synaptics_device_info * cocci_id@p ;
...
typedef __be32;
@@
 union {  __be32 be_val ;  char buf [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct synaptics_hw_state * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef psmouse_ret_t;
@@
 psmouse_ret_t cocci_id@p ;
...
position p;
@@
 struct input_mt_pos cocci_id@p [ 2 ] ;
...
position p;
@@
 enum synaptics_pkt_type cocci_id@p ;
...
position p;
@@
 const struct synaptics_hw_state * cocci_id@p [ 2 ] ;
