...
position p;
@@
 struct wl18xx_acx_host_config_bitmap * cocci_id@p ;
...
position p;
@@
 struct acx_ap_sleep_cfg * cocci_id@p ;
...
position p;
@@
 struct acx_time_sync_cfg * cocci_id@p ;
...
position p;
@@
 struct conf_ap_sleep_settings * cocci_id@p ;
...
position p;
@@
 struct acx_dynamic_fw_traces_cfg * cocci_id@p ;
...
position p;
@@
 struct wl18xx_acx_rx_ba_filter * cocci_id@p ;
...
position p;
@@
 struct wl18xx_acx_interrupt_notify * cocci_id@p ;
...
position p;
@@
 struct wl18xx_acx_checksum_state * cocci_id@p ;
...
position p;
@@
 struct wlcore_acx_peer_cap * cocci_id@p ;
...
position p;
@@
 struct wlcore_peer_ht_operation_mode * cocci_id@p ;
...
position p;
@@
 struct wl18xx_acx_clear_statistics * cocci_id@p ;
