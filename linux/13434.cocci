...
position p;
@@
 enum mpeg_frame_type { PFRAME , BFRAME_PRE , BFRAME_POST , BFRAME_BIDIR , BFRAME_EMPTY , } cocci_id@p ;
...
typedef u32;
@@
 struct code_gen {  unsigned char * p ;  u32 a ;  int b ;  int len ; } cocci_id@p ;
...
position p;
@@
 enum mpeg_frame_type cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct go7007 * go , unsigned char * buf , int ext ) ;
