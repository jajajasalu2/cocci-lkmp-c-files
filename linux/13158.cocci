...
position p;
@@
 struct saa7164_user_buffer * cocci_id@p ;
...
position p;
@@
 struct saa7164_buffer cocci_id@p ;
...
position p;
@@
 struct tmHWStreamParameters * cocci_id@p ;
...
position p;
@@
 struct saa7164_encoder_fh * cocci_id@p ;
...
position p;
@@
 struct saa7164_tvnorm cocci_id@p [ ] ;
...
position p;
@@
 struct saa7164_encoder_params * cocci_id@p ;
