...
position p;
@@
 struct dim_channel * const * cocci_id@p ;
...
typedef u8,u16;
@@
 struct async_tx_dbr {  u8 ch_addr ;  u16 rpc ;  u16 wpc ;  u16 rest_size ;  u16 sz_queue [ CDT0_RPC_MASK + 1 ] ; } cocci_id@p ;
...
position p;
@@
 enum { MADR_WNR_BIT = 31 , } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef bool,u32,lld_global_vars_t;
@@
 struct lld_global_vars_t {  bool dim_is_initialized ;  bool mcm_is_initialized ;  struct dim2_regs __iomem * dim2 ;  struct async_tx_dbr atx_dbr ;  u32 fcnt ;  u32 dbr_map [ DBR_MAP_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct int_ch_state * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef lld_global_vars_t;
@@
 struct lld_global_vars_t cocci_id@p ;
...
position p;
@@
 struct async_tx_dbr * cocci_id@p ;
...
position p;
@@
 struct int_ch_state * constcocci_id ;
...
position p;
@@
 enum { MADR_TB_BIT = 30 , MADR_WNR_BIT = 31 , } cocci_id@p ;
