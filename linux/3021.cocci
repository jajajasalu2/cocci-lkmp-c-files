...
position p;
@@
 const struct apd_device_desc * cocci_id@p ;
...
position p;
@@
 struct apd_private_data * cocci_id@p ;
...
position p;
@@
 struct apd_private_data {  struct clk * clk ;  struct acpi_device * adev ;  const struct apd_device_desc * dev_desc ; } cocci_id@p ;
...
position p;
@@
 struct apd_device_desc {  unsigned int flags ;  unsigned int fixed_clk_rate ;  struct property_entry * properties ;  int ( * setup ) ( struct apd_private_data * pdata ) ; } cocci_id@p ;
