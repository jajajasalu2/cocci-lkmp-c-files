...
position p;
@@
 struct trap_per_cpu cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct sun4v_error_entry * cocci_id@p ;
...
position p;
@@
 struct afsr_error_table * cocci_id@p ;
...
position p;
@@
 struct cheetah_err_info cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ SUN4V_ERR_TYPE_NUM ] ;
...
position p;
@@
 struct afsr_error_table {  unsigned long mask ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct sparc_stackf * cocci_id@p ;
...
position p;
@@
 struct tl1_traplog {  struct {  unsigned long tstate ;  unsigned long tpc ;  unsigned long tnpc ;  unsigned long tt ; } trapstack [ 4 ] ;  unsigned long tl ; } cocci_id@p ;
