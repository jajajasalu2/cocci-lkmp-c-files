...
position p;
@@
 struct vega20_od8_single_setting * cocci_id@p ;
...
position p;
@@
 struct vega20_max_sustainable_clocks * cocci_id@p ;
...
position p;
@@
 struct phm_ppt_v3_information * cocci_id@p ;
...
position p;
@@
 struct vega20_hwmgr cocci_id@p ;
