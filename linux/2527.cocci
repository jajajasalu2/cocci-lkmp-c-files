...
position p;
@@
 struct dm_target_spec cocci_id@p ;
...
position p;
@@
 struct dm_target_versions * cocci_id@p ;
...
position p;
@@
 struct list_head cocci_id@p [ NUM_BUCKETS ] ;
...
position p;
@@
 struct dm_file {  volatile unsigned global_event_nr ; } cocci_id@p ;
...
position p;
@@
 struct dm_target_deps * cocci_id@p ;
...
position p;
@@
 struct dm_dev_internal * cocci_id@p ;
...
position p;
@@
 const struct {  int cmd ;  int flags ;  ioctl_fn fn ; } cocci_id@p [ ] ;
...
typedef bool;
@@
 void cocci_id@p ( bool keep_open_devices , bool mark_deferred , bool only_deferred ) ;
...
position p;
@@
 struct dm_name_list cocci_id@p ;
...
position p;
@@
 struct dm_target_msg * cocci_id@p ;
...
position p;
@@
 struct hash_cell {  struct list_head name_list ;  struct list_head uuid_list ;  char * name ;  char * uuid ;  struct mapped_device * md ;  struct dm_table * new_map ; } cocci_id@p ;
