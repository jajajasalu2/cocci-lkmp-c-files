...
position p;
@@
 struct x509_parse_context * cocci_id@p ;
...
typedef u8,u16;
@@
 struct x509_parse_context {  struct x509_certificate * cert ;  unsigned long data ;  const void * cert_start ;  const void * key ;  size_t key_size ;  const void * params ;  size_t params_size ;  enum OID key_algo ;  enum OID last_oid ;  enum OID algo_oid ;  unsigned char nr_mpi ;  u8 o_size ;  u8 cn_size ;  u8 email_size ;  u16 o_offset ;  u16 cn_offset ;  u16 email_offset ;  unsigned raw_akid_size ;  const void * raw_akid ;  const void * akid_raw_issuer ;  unsigned akid_raw_issuer_size ; } cocci_id@p ;
