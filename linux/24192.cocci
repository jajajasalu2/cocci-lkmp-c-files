...
symbol cocci_id;
position p;
typedef ktime_t,spinlock_t;
@@
 struct mip6_report_rate_limiter {  spinlock_t lock ;  ktime_t stamp ;  int iif ;  struct in6_addr src ;  struct in6_addr dst ; } cocci_id@p ;
...
position p;
@@
 struct ipv6_destopt_hdr cocci_id@p ;
...
position p;
@@
 struct mip6_report_rate_limiter cocci_id@p ;
...
position p;
@@
 const struct ip6_mh * cocci_id@p ;
