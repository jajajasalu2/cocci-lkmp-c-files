...
position p;
@@
 struct wusb_cbaf_cc_data cocci_id@p ;
...
position p;
@@
 const struct wusb_cbaf_device_info cocci_id@p ;
...
position p;
@@
 struct wusb_cbaf_device_info * cocci_id@p ;
...
typedef u16;
@@
 struct cbaf {  struct usb_device * usb_dev ;  struct usb_interface * usb_iface ;  void * buffer ;  size_t buffer_size ;  struct wusb_ckhdid chid ;  char host_name [ CBA_NAME_LEN ] ;  u16 host_band_groups ;  struct wusb_ckhdid cdid ;  char device_name [ CBA_NAME_LEN ] ;  u16 device_band_groups ;  struct wusb_ckhdid ck ; } cocci_id@p ;
...
position p;
@@
 const struct wusb_cbaf_cc_data cocci_id@p ;
...
position p;
@@
 struct wusb_cbaf_host_info * cocci_id@p ;
...
position p;
@@
 const struct wusb_cbaf_cc_data_fail cocci_id@p ;
...
position p;
@@
 struct wusb_cbaf_assoc_info * cocci_id@p ;
...
position p;
@@
 struct wusb_cbaf_assoc_request * cocci_id@p ;
...
position p;
@@
 const struct wusb_cbaf_host_info cocci_id@p ;
