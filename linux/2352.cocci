...
position p;
@@
 struct ps3av_audio_mute cocci_id@p ;
...
typedef u32;
@@
 const struct video_fmt {  u32 format ;  u32 order ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ps3av_audio_info_frame * cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_hdmi_mode cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_audio_active cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_video_mode * cocci_id@p ;
...
position p;
@@
 struct ps3av_av_mute cocci_id@p ;
...
position p;
@@
 const struct ps3av_pkt_audio_mode * cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_init cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_video_init cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_tv_mute cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_audio_param * cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_audio_mode * cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_video_mute cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_video_cs * cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_audio_mute cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_audio_init cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_video_disable_sig cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_audio_mute cocci_id@p ;
...
typedef u8,u32;
@@
 const struct {  u32 fs ;  u8 mclk ; } cocci_id@p [ ] ;
...
typedef u32;
@@
 const struct {  int cs ;  u32 av ;  u32 bl ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ps3av_pkt_av_fin cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_event cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_video_format cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_avb_param * cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_get_monitor_info * cocci_id@p ;
...
position p;
@@
 struct ps3av_pkt_av_get_hw_conf * cocci_id@p ;
...
typedef u32;
@@
 const struct {  int vid ;  u32 av ; } cocci_id@p [ ] ;
