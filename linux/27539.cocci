...
position p;
@@
 enum legacy_fs_param { LEGACY_FS_UNSET_PARAMS , LEGACY_FS_MONOLITHIC_PARAMS , LEGACY_FS_INDIVIDUAL_PARAMS , } cocci_id@p ;
...
position p;
@@
 struct legacy_fs_context * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct fs_context * fc ) ;
...
position p;
@@
 const struct constant_table cocci_id@p [ ] ;
...
position p;
@@
 enum fs_context_purpose cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct fs_context * ) ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct fs_context * , void * ) ;
...
position p;
@@
 struct legacy_fs_context {  char * legacy_data ;  size_t data_size ;  enum legacy_fs_param param_type ; } cocci_id@p ;
