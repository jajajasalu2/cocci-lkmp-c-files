...
position p;
@@
 struct fcram_hash_ipv4 cocci_id@p ;
...
position p;
@@
 struct niu_altmac_rdc * cocci_id@p ;
...
position p;
@@
 const struct niu_phy_template cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct niu * , int status ) ;
...
position p;
@@
 struct niu_xmac_stats * cocci_id@p ;
...
position p;
@@
 struct msix_entry cocci_id@p [ NIU_NUM_LDG ] ;
...
position p;
@@
 struct txdma_mailbox cocci_id@p ;
...
position p;
@@
 struct rx_ring_info * cocci_id@p ;
...
position p;
@@
 const struct niu_ops cocci_id@p ;
...
position p;
@@
 struct phy_probe_info * cocci_id@p ;
...
position p;
@@
 struct tx_buff_info * cocci_id@p ;
...
position p;
@@
 struct niu_link_config * cocci_id@p ;
...
position p;
@@
 struct niu_bmac_stats cocci_id@p ;
...
position p;
@@
 const struct niu_phy_ops cocci_id@p ;
...
position p;
@@
 struct tx_ring_info cocci_id@p ;
...
typedef u32;
@@
 struct niu_phy_template {  const struct niu_phy_ops * ops ;  u32 phy_addr_base ; } cocci_id@p ;
...
position p;
@@
 union niu_parent_id * cocci_id@p ;
...
position p;
@@
 struct niu_classifier * cocci_id@p ;
...
position p;
@@
 struct niu_rdc_tables * cocci_id@p ;
...
position p;
@@
 struct rxdma_mailbox * cocci_id@p ;
...
position p;
@@
 struct niu_tcam_entry * cocci_id@p ;
...
position p;
@@
 struct niu_vlan_rdc * cocci_id@p ;
