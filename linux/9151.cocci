...
typedef u8;
@@
 void cocci_id@p ( struct sk_buff * skb , u8 local_port , void * trap_ctx ) ;
...
position p;
@@
 struct mlxsw_listener cocci_id@p [ ] ;
...
position p;
@@
 enum mlxsw_reg_hpkt_action cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct sk_buff * skb , u8 local_port , void * priv ) ;
...
position p;
@@
 struct devlink_trap cocci_id@p [ ] ;
