...
position p;
@@
 struct hci_basic_led_trigger * cocci_id@p ;
...
position p;
@@
 struct hci_basic_led_trigger {  struct led_trigger led_trigger ;  struct hci_dev * hdev ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct led_classdev * led_cdev ) ;
