...
position p;
@@
 const struct u300_clock * cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct clk_syscon {  struct clk_hw hw ;  bool hw_ctrld ;  bool reset ;  void __iomem * res_reg ;  u8 res_bit ;  void __iomem * en_reg ;  u8 en_bit ;  u16 clk_val ; } cocci_id@p ;
...
typedef u8,bool,u16;
@@
 struct u300_clock {  u8 type ;  u8 id ;  bool hw_ctrld ;  u16 clk_val ; } cocci_id@p ;
...
typedef bool;
@@
 struct clk_mclk {  struct clk_hw hw ;  bool is_mspro ; } cocci_id@p ;
