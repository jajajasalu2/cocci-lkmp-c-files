...
position p;
@@
 enum lpc18xx_pwm_res_action { LPC18XX_PWM_RES_NONE , LPC18XX_PWM_RES_SET , LPC18XX_PWM_RES_CLEAR , LPC18XX_PWM_RES_TOGGLE , } cocci_id@p ;
...
position p;
@@
 enum lpc18xx_pwm_res_action cocci_id@p ;
...
position p;
@@
 struct lpc18xx_pwm_data * cocci_id@p ;
...
position p;
@@
 struct lpc18xx_pwm_chip cocci_id@p ;
...
position p;
@@
 struct lpc18xx_pwm_data {  unsigned int duty_event ; } cocci_id@p ;
