...
position p;
@@
 const struct mode_map {  int vmode ;  const struct fb_videomode * mode ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct mode_map * cocci_id@p ;
...
position p;
@@
 const struct monitor_map {  int sense ;  int vmode ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct monitor_map * cocci_id@p ;
