...
position p;
@@
 struct wd719x_host_param cocci_id@p ;
...
position p;
@@
 struct wd719x_eeprom_header cocci_id@p ;
...
position p;
@@
 struct wd719x_sglist cocci_id@p ;
...
position p;
@@
 enum wd719x_card_type cocci_id@p ;
