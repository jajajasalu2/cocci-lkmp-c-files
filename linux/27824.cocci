...
position p;
@@
 struct ocfs2_dir_lookup_result cocci_id@p ;
...
position p;
@@
 const struct ocfs2_dx_entry * cocci_id@p ;
...
position p;
@@
 struct ocfs2_dir_entry * * cocci_id@p ;
...
position p;
@@
 struct ocfs2_empty_dir_priv * cocci_id@p ;
...
position p;
@@
 struct ocfs2_dx_entry_list * cocci_id@p ;
...
position p;
@@
 struct ocfs2_dx_hinfo cocci_id@p ;
...
position p;
@@
 struct ocfs2_dx_entry * cocci_id@p ;
...
position p;
@@
 struct ocfs2_empty_dir_priv {  struct dir_context ctx ;  unsigned seen_dot ;  unsigned seen_dot_dot ;  unsigned seen_other ;  unsigned dx_dir ; } cocci_id@p ;
