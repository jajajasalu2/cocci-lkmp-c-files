...
position p;
@@
 struct cw1200_suspend_state cocci_id@p ;
...
typedef u8,bool;
@@
 struct cw1200_suspend_state {  unsigned long bss_loss_tmo ;  unsigned long join_tmo ;  unsigned long direct_probe ;  unsigned long link_id_gc ;  bool beacon_skipping ;  u8 prev_ps_mode ; } cocci_id@p ;
...
position p;
@@
 struct cw1200_ether_type_filter cocci_id@p ;
...
position p;
@@
 struct wsm_udp_port_filter_hdr cocci_id@p ;
...
position p;
@@
 struct wsm_ether_type_filter_hdr cocci_id@p ;
...
position p;
@@
 struct cw1200_udp_port_filter cocci_id@p ;
...
position p;
@@
 struct cw1200_pm_state * cocci_id@p ;
