...
position p;
@@
 struct vgpu_sched_data cocci_id@p ;
...
position p;
@@
 struct intel_gvt_sched_policy_ops cocci_id@p ;
...
typedef ktime_t;
@@
 struct gvt_sched_data {  struct intel_gvt * gvt ;  struct hrtimer timer ;  unsigned long period ;  struct list_head lru_runq_head ;  ktime_t expire_time ; } cocci_id@p ;
...
position p;
@@
 struct gvt_sched_data * cocci_id@p ;
...
@@
 struct vgpu_sched_data {  struct list_head lru_list ;  struct intel_vgpu * vgpu ;  bool active ;  bool pri_sched ;  ktime_t pri_time ;  ktime_t sched_in_time ;  ktime_t sched_time ;  ktime_t left_ts ;  ktime_t allocated_ts ;  struct vgpu_sched_ctl sched_ctl ; } cocci_id@p ;
