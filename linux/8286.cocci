...
symbol cocci_id;
position p;
typedef efx_vfdi_op_t;
@@
 const efx_vfdi_op_t cocci_id@p [ VFDI_OP_LIMIT ] ;
...
position p;
@@
 struct efx_memcpy_req * cocci_id@p ;
...
typedef u8;
@@
 struct efx_local_addr {  struct list_head link ;  u8 addr [ ETH_ALEN ] ; } cocci_id@p ;
...
position p;
@@
 struct efx_memcpy_req cocci_id@p [ 2 ] ;
...
position p;
@@
 struct efx_local_addr * cocci_id@p ;
...
position p;
@@
 struct vfdi_endpoint * cocci_id@p ;
...
position p;
@@
 struct efx_endpoint_page * cocci_id@p ;
...
typedef u64;
@@
 struct efx_memcpy_req {  unsigned int from_rid ;  void * from_buf ;  u64 from_addr ;  unsigned int to_rid ;  u64 to_addr ;  unsigned length ; } cocci_id@p ;
...
position p;
@@
 enum efx_vf_tx_filter_mode { VF_TX_FILTER_OFF , VF_TX_FILTER_AUTO , VF_TX_FILTER_ON , } cocci_id@p ;
...
position p;
@@
 struct efx_memcpy_req cocci_id@p [ 4 ] ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct siena_vf * vf ) ;
...
position p;
@@
 const struct efx_channel_type cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct efx_endpoint_page {  struct list_head link ;  void * ptr ;  dma_addr_t addr ; } cocci_id@p ;
