...
position p;
@@
 struct vio_dring_register cocci_id@p ;
...
position p;
@@
 struct vio_dring_unregister * cocci_id@p ;
...
position p;
@@
 struct vio_ver_info cocci_id@p ;
...
position p;
@@
 union {  struct vio_dring_register pkt ;  char all [ sizeof ( struct vio_dring_register ) + ( sizeof ( struct ldc_trans_cookie ) * VIO_MAX_RING_COOKIES ) ] ; } cocci_id@p ;
