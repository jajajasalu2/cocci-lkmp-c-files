...
typedef u8,u32;
@@
 struct clk_coeff {  u32 mclk ;  u32 rate ;  u8 pllnl ;  u8 pllnh ;  u8 pllml ;  u8 pllmh ;  u8 plldiv ; } cocci_id@p ;
...
typedef u32;
@@
 struct ml26124_priv {  u32 mclk ;  u32 rate ;  struct regmap * regmap ;  int clk_in ;  struct snd_pcm_substream * substream ; } cocci_id@p ;
...
position p;
@@
 const struct clk_coeff cocci_id@p [ ] ;
...
position p;
@@
 struct ml26124_priv * cocci_id@p ;
