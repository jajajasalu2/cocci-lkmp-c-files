...
typedef u32;
@@
 struct dw_scl_sda_cfg {  u32 ss_hcnt ;  u32 fs_hcnt ;  u32 ss_lcnt ;  u32 fs_lcnt ;  u32 sda_hold ; } cocci_id@p ;
...
position p;
@@
 struct dw_scl_sda_cfg * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef dw_pci_ctl_id_t;
@@
 enum dw_pci_ctl_id_t { medfield , merrifield , baytrail , cherrytrail , haswell , elkhartlake , } cocci_id@p ;
...
position p;
@@
 struct dw_pci_controller * cocci_id@p ;
