...
position p;
@@
 struct cpl_rx_mps_pkt * cocci_id@p ;
...
position p;
@@
 struct sge_eosw_txq * cocci_id@p ;
...
position p;
@@
 struct fw_eth_tx_pkt_vm_wr * cocci_id@p ;
...
position p;
@@
 struct cpl_tx_tnl_lso * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rspq_handler_t;
@@
 rspq_handler_t cocci_id@p ;
...
position p;
@@
 struct cpl_t5_trace_pkt cocci_id@p ;
...
position p;
@@
 const struct cxgb_fcoe * cocci_id@p ;
...
position p;
@@
 struct cpl_sge_egr_update * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rspq_flush_handler_t;
@@
 rspq_flush_handler_t cocci_id@p ;
...
position p;
@@
 const struct rss_header * cocci_id@p ;
...
position p;
@@
 const struct pkt_gl * cocci_id@p ;
...
position p;
@@
 struct ulptx_sge_pair * cocci_id@p ;
...
position p;
@@
 const struct sge_txq * cocci_id@p ;
...
position p;
@@
 const struct rsp_ctrl * cocci_id@p ;
...
position p;
@@
 const struct rx_sw_desc * cocci_id@p ;
...
position p;
@@
 const struct page_frag * cocci_id@p ;
...
position p;
@@
 const struct sge_rspq * cocci_id@p ;
...
position p;
@@
 const struct cpl_fw4_ack * cocci_id@p ;
...
position p;
@@
 struct fw_eth_tx_eo_wr * cocci_id@p ;
...
position p;
@@
 enum cpl_tx_tnl_lso_type cocci_id@p ;
...
position p;
@@
 enum sge_eosw_state cocci_id@p ;
...
position p;
@@
 struct sge_eohw_txq * cocci_id@p ;
...
position p;
@@
 struct sge_ctrl_txq * cocci_id@p ;
...
position p;
@@
 const struct port_info * cocci_id@p ;
...
typedef __be64;
@@
 enum { EQ_UNIT = SGE_EQ_IDXSIZE , FL_PER_EQ_UNIT = EQ_UNIT / sizeof ( __be64 ) , TXD_PER_EQ_UNIT = EQ_UNIT / sizeof ( __be64 ) , T4VF_ETHTXQ_MAX_HDR = ( sizeof ( struct fw_eth_tx_pkt_vm_wr ) + sizeof ( struct cpl_tx_pkt_lso_core ) + sizeof ( struct cpl_tx_pkt_core ) ) / sizeof ( __be64 ) , } cocci_id@p ;
...
position p;
@@
 struct ulptx_sge_pair cocci_id@p [ MAX_SKB_FRAGS / 2 + 1 ] ;
...
position p;
@@
 struct fw_eth_tx_pkt_wr * cocci_id@p ;
...
position p;
@@
 struct cpl_trace_pkt cocci_id@p ;
...
position p;
@@
 struct sge_ofld_rxq * cocci_id@p ;
...
position p;
@@
 struct cpl_tx_pkt_lso_core cocci_id@p ;
...
position p;
@@
 struct fw_flowc_mnemval cocci_id@p ;
...
position p;
@@
 struct cpl_tx_pkt_core cocci_id@p ;
...
position p;
@@
 enum { RX_BUF_FLAGS = 0x1f , RX_BUF_SIZE = 0x0f , RX_UNMAPPED_BUF = 0x10 , RX_SMALL_PG_BUF = 0x0 , RX_LARGE_PG_BUF = 0x1 , RX_SMALL_MTU_BUF = 0x2 , RX_LARGE_MTU_BUF = 0x3 , } cocci_id@p ;
...
position p;
@@
 struct sge_uld_txq_info * cocci_id@p ;
...
position p;
@@
 struct work_request_hdr * cocci_id@p ;
...
position p;
@@
 struct cxgb4_tc_port_mqprio * cocci_id@p ;
...
position p;
@@
 const struct sge_fl * cocci_id@p ;
...
position p;
@@
 const struct cpl_fw4_msg * cocci_id@p ;
...
position p;
@@
 enum { RX_NON_PTP_PKT = 0 , RX_PTP_PKT_SUC = 1 , RX_PTP_PKT_ERR = 2 , } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct rx_sw_desc {  struct page * page ;  dma_addr_t dma_addr ; } cocci_id@p ;
