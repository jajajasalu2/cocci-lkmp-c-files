...
position p;
@@
 enum nfp_flower_cmsg_type_port cocci_id@p ;
...
position p;
@@
 struct nfp_flower_cmsg_portreify * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_cmsg_merge_hint * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_cmsg_portmod * cocci_id@p ;
...
position p;
@@
 struct nfp_fl_payload * cocci_id@p [ 2 ] ;
...
position p;
@@
 struct nfp_flower_cmsg_mac_repr * cocci_id@p ;
...
position p;
@@
 struct nfp_flower_cmsg_hdr * cocci_id@p ;
