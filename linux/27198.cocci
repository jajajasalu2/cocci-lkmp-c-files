...
position p;
@@
 struct ext4_new_flex_group_data * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u16,ext4_group_t;
@@
 struct ext4_new_flex_group_data {  struct ext4_new_group_data * groups ;  __u16 * bg_flags ;  ext4_group_t count ; } cocci_id@p ;
