...
position p;
@@
 struct MR_DRV_RAID_MAP_ALL cocci_id@p ;
...
position p;
@@
 struct megasas_instance * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct megasas_instance * instance ) ;
...
position p;
@@
 struct megasas_evt_log_info * cocci_id@p ;
...
position p;
@@
 struct megasas_init_queue_info * cocci_id@p ;
...
position p;
@@
 struct megasas_pd_list cocci_id@p ;
...
position p;
@@
 struct MR_SNAPDUMP_PROPERTIES cocci_id@p ;
...
position p;
@@
 struct megasas_io_frame * cocci_id@p ;
...
position p;
@@
 struct MR_LD_TARGETID_LIST * cocci_id@p ;
...
position p;
@@
 struct MR_FW_RAID_MAP_EXT cocci_id@p ;
...
position p;
@@
 struct megasas_instance_template cocci_id@p ;
...
position p;
@@
 struct MR_PRIV_DEVICE * cocci_id@p ;
...
position p;
@@
 struct megasas_evt_detail * cocci_id@p ;
...
position p;
@@
 struct MR_PD_CFG_SEQ cocci_id@p ;
...
position p;
@@
 struct megasas_cmd_fusion * cocci_id@p ;
...
typedef u8;
@@
 void cocci_id@p ( struct megasas_instance * instance , struct megasas_cmd * cmd , u8 alt_status ) ;
...
position p;
@@
 void cocci_id@p ( struct megasas_instance * instance , struct scsi_device * sdev ) ;
...
position p;
@@
 struct MR_FW_RAID_MAP cocci_id@p ;
...
position p;
@@
 struct megasas_sge64 * cocci_id@p ;
...
position p;
@@
 struct megasas_ctrl_info * cocci_id@p ;
...
position p;
@@
 struct LD_STREAM_DETECT cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct megasas_instance * instance , u32 seq_num , u32 class_locale_word ) ;
...
position p;
@@
 struct megasas_pthru_frame * cocci_id@p ;
...
position p;
@@
 struct megasas_mgmt_info cocci_id@p ;
...
position p;
@@
 struct megasas_iocpacket cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct megasas_instance * instance ) ;
...
position p;
@@
 struct megasas_aen_event cocci_id@p ;
...
position p;
@@
 struct megasas_dcmd_frame * cocci_id@p ;
...
position p;
@@
 struct MR_LD_VF_AFFILIATION_111 cocci_id@p ;
...
position p;
@@
 struct fusion_context * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct megasas_instance * instance , int initial ) ;
...
position p;
@@
 struct MR_HOST_DEVICE_LIST * cocci_id@p ;
...
position p;
@@
 struct MR_LD_VF_AFFILIATION * cocci_id@p ;
...
position p;
@@
 struct MR_DRV_SYSTEM_INFO cocci_id@p ;
...
position p;
@@
 struct megasas_sge_skinny cocci_id@p ;
...
position p;
@@
 struct MR_TARGET_PROPERTIES cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct megasas_instance * instance , struct megasas_register_set __iomem * reg_set ) ;
...
position p;
@@
 struct megasas_abort_frame * cocci_id@p ;
...
position p;
@@
 union megasas_evt_class_locale cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct megasas_instance * instance , u8 query_type ) ;
...
position p;
@@
 struct MR_PD_ADDRESS * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p ( struct megasas_instance * instance , struct scsi_cmnd * scmd ) ;
...
position p;
@@
 int cocci_id@p ( struct megasas_instance * instance ) ;
...
position p;
@@
 struct MR_LD_SPAN_MAP cocci_id@p ;
...
position p;
@@
 struct megasas_header * cocci_id@p ;
...
position p;
@@
 struct megasas_irq_context * cocci_id@p ;
...
position p;
@@
 struct megasas_init_frame * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long instance_addr ) ;
...
position p;
@@
 union MEGASAS_REQUEST_DESCRIPTOR_UNION * cocci_id@p ;
...
position p;
@@
 struct megasas_sge32 cocci_id@p ;
...
position p;
@@
 struct MR_PD_CFG_SEQ_NUM_SYNC * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct megasas_instance * instance , struct megasas_cmd * cmd , int seconds ) ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * devp ) ;
...
position p;
@@
 struct MR_CTRL_HB_HOST_MEM cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct megasas_instance * instance , int ocr ) ;
...
position p;
@@
 struct MR_HOST_DEVICE_LIST_ENTRY * cocci_id@p ;
...
position p;
@@
 struct MPI2_IOC_INIT_REQUEST cocci_id@p ;
...
position p;
@@
 struct MR_LD_VF_MAP * cocci_id@p ;
