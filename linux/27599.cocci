...
position p;
@@
 enum btrfs_loop_type { LOOP_CACHING_NOWAIT , LOOP_CACHING_WAIT , LOOP_ALLOC_CHUNK , LOOP_NO_EMPTY_SIZE , } cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct btrfs_trans_handle * trans , u64 parent , u64 root_objectid , u64 flags , u64 owner , u64 offset , struct btrfs_key * ins , int ref_mod ) ;
...
position p;
@@
 enum btrfs_inline_ref_type cocci_id@p ;
...
position p;
@@
 struct btrfs_free_space_ctl * cocci_id@p ;
...
position p;
@@
 struct btrfs_delayed_tree_ref * cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct btrfs_trans_handle * trans , struct btrfs_delayed_ref_node * node , u64 parent , u64 root_objectid , u64 owner_objectid , u64 owner_offset , int refs_to_drop , struct btrfs_delayed_extent_op * extra_op ) ;
...
typedef u64,bool;
@@
 struct find_free_extent_ctl {  u64 ram_bytes ;  u64 num_bytes ;  u64 empty_size ;  u64 flags ;  int delalloc ;  u64 search_start ;  u64 empty_cluster ;  bool have_caching_bg ;  bool orig_have_caching_bg ;  int index ;  int loop ;  bool retry_clustered ;  bool retry_unclustered ;  int cached ;  u64 max_extent_size ;  u64 total_free_space ;  u64 found_offset ; } cocci_id@p ;
...
position p;
@@
 struct btrfs_delayed_extent_op * cocci_id@p ;
...
position p;
@@
 struct btrfs_bio_stripe * cocci_id@p ;
...
position p;
@@
 struct walk_control * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_trans_handle * trans , struct btrfs_delayed_ref_node * node , struct btrfs_delayed_extent_op * extent_op ) ;
...
position p;
@@
 struct btrfs_delayed_ref_node * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfs_path * path , int level , struct btrfs_key * key ) ;
...
position p;
@@
 struct btrfs_free_cluster * cocci_id@p ;
...
position p;
@@
 struct btrfs_transaction * cocci_id@p ;
...
position p;
@@
 struct btrfs_delayed_ref_head cocci_id@p ;
...
position p;
@@
 struct btrfs_shared_data_ref * cocci_id@p ;
...
position p;
@@
 const struct btrfs_disk_key * cocci_id@p ;
...
position p;
@@
 struct btrfs_delayed_data_ref * cocci_id@p ;
...
typedef u64;
@@
 struct walk_control {  u64 refs [ BTRFS_MAX_LEVEL ] ;  u64 flags [ BTRFS_MAX_LEVEL ] ;  struct btrfs_key update_progress ;  struct btrfs_key drop_progress ;  int drop_level ;  int stage ;  int level ;  int shared_level ;  int update_ref ;  int keep_locks ;  int reada_slot ;  int reada_count ;  int restarted ; } cocci_id@p ;
...
position p;
@@
 struct find_free_extent_ctl * cocci_id@p ;
...
position p;
@@
 struct btrfs_caching_control * cocci_id@p ;
...
position p;
@@
 struct btrfs_delayed_ref_root * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfs_delayed_extent_op * extent_op , struct extent_buffer * leaf , struct btrfs_extent_item * ei ) ;
...
position p;
@@
 const struct extent_buffer * cocci_id@p ;
