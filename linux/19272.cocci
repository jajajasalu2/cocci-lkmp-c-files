...
symbol cocci_id;
position p;
typedef jump_label_t;
@@
 jump_label_t * cocci_id@p ;
...
@@
 struct arc_gen_branch_testdata {  jump_label_t pc ;  jump_label_t target_address ;  u32 expected_instr ; } cocci_id@p ;
...
position p;
@@
 const struct arc_gen_branch_testdata * cocci_id@p ;
