...
position p;
@@
 struct cfg_error_pkg * cocci_id@p ;
...
typedef bool;
@@
 struct tb_ctl {  struct tb_nhi * nhi ;  struct tb_ring * tx ;  struct tb_ring * rx ;  struct dma_pool * frame_pool ;  struct ctl_pkg * rx_packets [ TB_CTL_RX_PKG_COUNT ] ;  struct mutex request_queue_lock ;  struct list_head request_queue ;  bool running ;  event_cb callback ;  void * callback_data ; } cocci_id@p ;
...
position p;
@@
 struct tb_cfg_header cocci_id@p ;
...
position p;
@@
 const struct cfg_read_pkg * cocci_id@p ;
...
position p;
@@
 struct cfg_reset_pkg cocci_id@p ;
...
position p;
@@
 struct cfg_read_pkg cocci_id@p ;
...
position p;
@@
 const struct tb_cfg_result * cocci_id@p ;
...
position p;
@@
 struct tb_cfg_address cocci_id@p ;
...
position p;
@@
 struct cfg_write_pkg cocci_id@p ;
...
position p;
@@
 const struct cfg_error_pkg * cocci_id@p ;
