...
@@
 cvmx_pip_port_status_t cocci_id@p ;
...
position p;
@@
 struct net_device * cocci_id@p [ TOTAL_NUMBER_OF_PORTS ] ;
...
position p;
@@
 struct octeon_ethernet cocci_id@p ;
...
position p;
@@
 union cvmx_gmxx_rxx_adr_ctl cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cvmx_helper_interface_mode_t;
@@
 cvmx_helper_interface_mode_t cocci_id@p ;
...
position p;
@@
 union cvmx_helper_link_info cocci_id@p ;
...
position p;
@@
 union cvmx_ipd_ctl_status cocci_id@p ;
...
position p;
@@
 union cvmx_pip_frm_len_chkx cocci_id@p ;
...
symbol cocci_id;
position p;
typedef cvmx_pko_port_status_t;
@@
 cvmx_pko_port_status_t cocci_id@p ;
...
position p;
@@
 union cvmx_gmxx_prtx_cfg cocci_id@p ;
...
position p;
@@
 union cvmx_pip_prt_tagx cocci_id@p ;
