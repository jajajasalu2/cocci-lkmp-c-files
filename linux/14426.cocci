...
position p;
@@
 struct amradio_device cocci_id@p ;
...
typedef u8;
@@
 struct amradio_device {  struct usb_device * usbdev ;  struct usb_interface * intf ;  struct video_device vdev ;  struct v4l2_device v4l2_dev ;  struct v4l2_ctrl_handler hdl ;  u8 * buffer ;  struct mutex lock ;  int curfreq ;  int stereo ;  int muted ; } cocci_id@p ;
