...
symbol cocci_id;
position p;
typedef s32,bool,u32,u16;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 offset , u16 * data , bool read , bool page_set ) ;
...
typedef u16;
@@
 const u16 cocci_id@p [ IGP02E1000_PHY_CHANNEL_NUM ] ;
...
position p;
@@
 enum e1000_phy_type cocci_id@p ;
...
typedef s32,bool,u32,u16;
@@
 s32 cocci_id@p ( struct e1000_hw * hw , u32 offset , u16 * data , bool read ) ;
