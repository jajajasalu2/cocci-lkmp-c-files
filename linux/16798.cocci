...
position p;
@@
 struct gpio_vibrator * cocci_id@p ;
...
typedef bool;
@@
 struct gpio_vibrator {  struct input_dev * input ;  struct gpio_desc * gpio ;  struct regulator * vcc ;  struct work_struct play_work ;  bool running ;  bool vcc_on ; } cocci_id@p ;
