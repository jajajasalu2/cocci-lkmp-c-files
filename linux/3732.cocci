...
position p;
@@
 struct cvm_des3_ctx cocci_id@p ;
...
typedef u32;
@@
 struct cpt_device_handle {  void * cdev [ MAX_DEVICES ] ;  u32 dev_count ; } cocci_id@p ;
...
position p;
@@
 struct cpt_device_handle cocci_id@p ;
