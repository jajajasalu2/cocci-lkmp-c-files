...
position p;
@@
 struct ad7476_state cocci_id@p ;
...
typedef s64;
@@
 struct ad7476_state {  struct spi_device * spi ;  const struct ad7476_chip_info * chip_info ;  struct regulator * reg ;  struct spi_transfer xfer ;  struct spi_message msg ;  unsigned char data [ ALIGN ( 2 , sizeof ( s64 ) ) + sizeof ( s64 ) ] 
...
position p;
@@
 enum ad7476_supported_device_ids { ID_AD7091R , ID_AD7276 , ID_AD7277 , ID_AD7278 , ID_AD7466 , ID_AD7467 , ID_AD7468 , ID_AD7495 , ID_AD7940 , ID_ADC081S , ID_ADC101S , ID_ADC121S , ID_ADS7866 , ID_ADS7867 , ID_ADS7868 , } cocci_id@p ;
...
position p;
@@
 struct ad7476_chip_info {  unsigned int int_vref_uv ;  struct iio_chan_spec channel [ 2 ] ;  void ( * reset ) ( struct ad7476_state * ) ; } cocci_id@p ;
...
position p;
@@
 const struct ad7476_chip_info cocci_id@p [ ] ;
