...
position p;
@@
 const struct nvkm_device_func cocci_id@p ;
...
typedef u16;
@@
 struct nvkm_device_pci_vendor {  u16 vendor ;  u16 device ;  const char * name ;  const struct nvkm_device_quirk quirk ; } cocci_id@p ;
...
typedef u16;
@@
 struct nvkm_device_pci_device {  u16 device ;  const char * name ;  const struct nvkm_device_pci_vendor * vendor ; } cocci_id@p ;
...
position p;
@@
 const struct nvkm_device_quirk * cocci_id@p ;
...
position p;
@@
 struct nvkm_device_pci * cocci_id@p ;
...
position p;
@@
 const struct nvkm_device_pci_device cocci_id@p [ ] ;
...
position p;
@@
 const struct nvkm_device_pci_vendor cocci_id@p [ ] ;
