...
position p;
@@
 struct tcg_pcr_event2_head * cocci_id@p ;
...
position p;
@@
 struct efi_tcg2_final_events_table * cocci_id@p ;
...
position p;
@@
 struct linux_efi_tpm_eventlog * cocci_id@p ;
