...
position p;
@@
 struct meson_clk_triphase_data cocci_id@p ;
...
position p;
@@
 struct meson_clk_phase_data cocci_id@p ;
...
position p;
@@
 struct axg_audio_reset_data cocci_id@p ;
...
position p;
@@
 struct axg_audio_reset_data {  struct reset_controller_dev rstc ;  struct regmap * map ;  unsigned int offset ; } cocci_id@p ;
...
position p;
@@
 const struct audioclk_data * cocci_id@p ;
...
position p;
@@
 struct meson_sclk_div_data cocci_id@p ;
...
position p;
@@
 struct audioclk_data {  struct clk_regmap * const * regmap_clks ;  unsigned int regmap_clk_num ;  struct clk_hw_onecell_data * hw_onecell_data ;  unsigned int reset_offset ;  unsigned int reset_num ; } cocci_id@p ;
