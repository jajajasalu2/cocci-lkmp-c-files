...
position p;
@@
 struct powernowk8_target_arg cocci_id@p ;
...
position p;
@@
 struct init_on_cpu {  struct powernow_k8_data * data ;  int rc ; } cocci_id@p ;
...
position p;
@@
 struct powernow_k8_data * cocci_id@p ;
...
position p;
@@
 struct powernowk8_target_arg {  struct cpufreq_policy * pol ;  unsigned newstate ; } cocci_id@p ;
