...
position p;
@@
 struct compat_sioc_sg_req6 cocci_id@p ;
...
position p;
@@
 struct sioc_mif_req6 cocci_id@p ;
...
position p;
@@
 struct ip6mr_result * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mr_table * mrt , struct mfc6_cache * mfc , int cmd ) ;
...
position p;
@@
 struct ip6mr_rule {  struct fib_rule common ; } cocci_id@p ;
...
position p;
@@
 const struct mfc6_cache * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net * net , struct mr_table * mrt , struct net_device * dev , struct sk_buff * skb , struct mfc6_cache * cache ) ;
...
position p;
@@
 struct compat_sioc_mif_req6 cocci_id@p ;
...
position p;
@@
 const struct inet6_protocol cocci_id@p ;
...
position p;
@@
 struct sioc_sg_req6 cocci_id@p ;
...
position p;
@@
 const struct mfc6_cache_cmp_arg * cocci_id@p ;
...
position p;
@@
 struct ip6mr_result {  struct mr_table * mrt ; } cocci_id@p ;
...
position p;
@@
 unsigned char cocci_id@p [ MAXMIFS ] ;
...
symbol cocci_id;
position p;
typedef mifi_t,compat_ulong_t;
@@
 struct compat_sioc_mif_req6 {  mifi_t mifi ;  compat_ulong_t icount ;  compat_ulong_t ocount ;  compat_ulong_t ibytes ;  compat_ulong_t obytes ; } cocci_id@p ;
...
position p;
@@
 struct mfc6_cache_cmp_arg cocci_id@p ;
...
@@
 struct compat_sioc_sg_req6 {  struct sockaddr_in6 src ;  struct sockaddr_in6 grp ;  compat_ulong_t pktcnt ;  compat_ulong_t bytecnt ;  compat_ulong_t wrong_if ; } cocci_id@p ;
