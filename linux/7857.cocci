...
position p;
@@
 void cocci_id@p ( struct net_device * , unsigned ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct net_device * , unsigned , unsigned , unsigned , u32 ) ;
...
typedef u32;
@@
 int cocci_id@p ( unsigned int , unsigned int , u32 ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct net_device * , unsigned , u32 ) ;
...
position p;
@@
 struct net_device * cocci_id@p ( struct net_device * , unsigned long , int ) ;
...
position p;
@@
 struct net_device * cocci_id@p [ SBNI_MAX_NUM_CARDS ] ;
...
position p;
@@
 void cocci_id@p ( struct sk_buff * , struct net_device * ) ;
...
position p;
@@
 struct sk_buff * cocci_id@p ( struct net_device * ) ;
...
typedef u32;
@@
 int cocci_id@p ( u32 , u32 * , u32 * , u32 * , u32 * , u32 * ) ;
...
position p;
@@
 struct sbni_in_stats cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * , struct net_device * ) ;
