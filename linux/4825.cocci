...
position p;
@@
 struct ib_uverbs_cmd_hdr * cocci_id@p ;
...
position p;
@@
 struct rdma_umap_priv * cocci_id@p ;
...
position p;
@@
 const struct uverbs_api_write_method * cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_ex_cmd_hdr cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_event * cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_comp_event_desc cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_event_queue * cocci_id@p ;
...
position p;
@@
 enum { IB_UVERBS_MAJOR = 231 , IB_UVERBS_BASE_MINOR = 192 , IB_UVERBS_MAX_DEVICES = RDMA_MAX_PORTS , IB_UVERBS_NUM_FIXED_MINOR = 32 , IB_UVERBS_NUM_DYNAMIC_MINOR = IB_UVERBS_MAX_DEVICES - IB_UVERBS_NUM_FIXED_MINOR , } cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_async_event_file cocci_id@p ;
...
position p;
@@
 struct ib_uverbs_async_event_desc cocci_id@p ;
