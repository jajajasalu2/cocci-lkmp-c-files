...
typedef u_int;
@@
 void cocci_id@p ( struct ahd_softc * ahd , struct seq_file * m , u_int our_id , char channel , u_int target_id ) ;
...
position p;
@@
 void cocci_id@p ( struct seq_file * m , struct scsi_device * sdev ) ;
