...
typedef u32;
@@
 struct imx_sc_pm_domain {  struct generic_pm_domain pd ;  char name [ IMX_SCU_PD_NAME_SIZE ] ;  u32 rsrc ; } cocci_id@p ;
...
position p;
@@
 const struct imx_sc_pd_soc * cocci_id@p ;
...
position p;
@@
 const struct imx_sc_pd_range cocci_id@p [ ] ;
...
typedef u8,bool,u32;
@@
 struct imx_sc_pd_range {  char * name ;  u32 rsrc ;  u8 num ;  bool postfix ;  u8 start_from ; } cocci_id@p ;
...
position p;
@@
 struct imx_sc_msg_req_set_resource_power_mode cocci_id@p ;
...
typedef u8;
@@
 struct imx_sc_pd_soc {  const struct imx_sc_pd_range * pd_ranges ;  u8 num_ranges ; } cocci_id@p ;
...
position p;
@@
 struct imx_sc_pm_domain * cocci_id@p ;
