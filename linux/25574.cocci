...
position p;
@@
 struct auxtrace_cache {  struct hlist_head * hashtable ;  size_t sz ;  size_t entry_size ;  size_t limit ;  size_t cnt ;  unsigned int bits ; } cocci_id@p ;
...
position p;
@@
 const struct events_stats * cocci_id@p ;
...
position p;
@@
 struct addr_filters cocci_id@p ;
...
typedef bool;
@@
 struct queue_data {  bool samples ;  bool events ; } cocci_id@p ;
...
position p;
@@
 struct perf_record_auxtrace cocci_id@p ;
...
position p;
@@
 struct auxtrace_mmap_params * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ PERF_SAMPLE_MAX_SIZE ] ;
...
position p;
@@
 struct auxtrace_cache_entry * cocci_id@p ;
...
position p;
@@
 struct perf_record_auxtrace_error cocci_id@p ;
...
position p;
@@
 struct auxtrace_index cocci_id@p ;
...
position p;
@@
 struct auxtrace_heap_item cocci_id@p ;
...
symbol cocci_id;
position p;
typedef process_auxtrace_t;
@@
 process_auxtrace_t cocci_id@p ;
...
position p;
@@
 struct auxtrace_mmap * cocci_id@p ;
...
position p;
@@
 struct auxtrace_heap * cocci_id@p ;
...
position p;
@@
 struct auxtrace_index_entry cocci_id@p ;
...
typedef u64,bool;
@@
 struct sym_args {  const char * name ;  u64 start ;  u64 size ;  int idx ;  int cnt ;  bool started ;  bool global ;  bool selected ;  bool duplicate ;  bool near ; } cocci_id@p ;
