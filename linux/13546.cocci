...
position p;
@@
 void cocci_id@p ( struct usb_usbvision * usbvision ) ;
...
position p;
@@
 struct usb_usbvision * cocci_id@p ;
...
position p;
@@
 struct usbvision_frame * cocci_id@p ;
...
position p;
@@
 struct usbvision_v4l2_format_st cocci_id@p [ ] ;
