...
position p;
@@
 struct ltq_wdt_priv cocci_id@p ;
...
position p;
@@
 struct ltq_wdt_hw {  int ( * bootstatus_get ) ( struct device * dev ) ; } cocci_id@p ;
...
position p;
@@
 const struct ltq_wdt_hw cocci_id@p ;
...
position p;
@@
 struct ltq_wdt_priv {  struct watchdog_device wdt ;  void __iomem * membase ;  unsigned long clk_rate ; } cocci_id@p ;
