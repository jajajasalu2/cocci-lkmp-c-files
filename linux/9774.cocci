...
position p;
@@
 struct il3945_rate_scaling_info * cocci_id@p ;
...
position p;
@@
 struct il3945_powertable_cmd cocci_id@p ;
...
position p;
@@
 struct il3945_tx_resp * cocci_id@p ;
...
position p;
@@
 struct il3945_eeprom * cocci_id@p ;
...
position p;
@@
 struct il3945_rate_scaling_cmd cocci_id@p ;
...
position p;
@@
 struct il3945_frame * cocci_id@p ;
...
position p;
@@
 struct sta_id_modify cocci_id@p ;
...
position p;
@@
 struct il3945_tx_cmd * cocci_id@p ;
...
position p;
@@
 struct il3945_tx_power cocci_id@p [ 2 ] [ IL_MAX_GAIN_ENTRIES ] ;
...
position p;
@@
 const struct il3945_eeprom_txpower_sample * cocci_id@p ;
...
position p;
@@
 struct il3945_rx_frame_stats * cocci_id@p ;
...
position p;
@@
 struct il3945_scan_power_info * cocci_id@p ;
...
position p;
@@
 struct il3945_eeprom_txpower_group * cocci_id@p ;
...
position p;
@@
 const struct il3945_eeprom_txpower_group * cocci_id@p ;
...
position p;
@@
 const struct il_addsta_cmd * cocci_id@p ;
...
position p;
@@
 struct il_hw_params cocci_id@p ;
...
position p;
@@
 struct il3945_txpowertable_cmd cocci_id@p ;
...
position p;
@@
 struct il3945_rxon_assoc_cmd cocci_id@p ;
...
position p;
@@
 struct il3945_rx_frame_hdr * cocci_id@p ;
...
position p;
@@
 const struct il_ops cocci_id@p ;
...
position p;
@@
 struct il3945_shared cocci_id@p ;
...
position p;
@@
 struct il3945_rxon_cmd cocci_id@p ;
...
position p;
@@
 struct il3945_notif_stats cocci_id@p ;
...
position p;
@@
 struct il3945_tx_beacon_cmd cocci_id@p ;
...
position p;
@@
 const struct il3945_rate_info cocci_id@p [ RATE_COUNT_3945 ] ;
...
position p;
@@
 const struct il_cfg cocci_id@p ;
...
position p;
@@
 struct il3945_addsta_cmd * cocci_id@p ;
...
position p;
@@
 struct il3945_rx_frame_end * cocci_id@p ;
...
typedef u32;
@@
 const u32 cocci_id@p [ IL_EVT_DISABLE_SIZE ] ;
...
position p;
@@
 struct il3945_channel_power_info * cocci_id@p ;
