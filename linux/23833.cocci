...
position p;
@@
 struct tc_fq_codel_xstats cocci_id@p ;
...
position p;
@@
 struct fq_codel_flow * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef codel_tdiff_t;
@@
 codel_tdiff_t cocci_id@p ;
...
position p;
@@
 const struct fq_codel_sched_data * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_FQ_CODEL_MAX + 1 ] ;
...
position p;
@@
 struct fq_codel_sched_data * cocci_id@p ;
...
position p;
@@
 const struct fq_codel_flow * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_FQ_CODEL_MAX + 1 ] ;
...
position p;
@@
 struct fq_codel_flow {  struct sk_buff * head ;  struct sk_buff * tail ;  struct list_head flowchain ;  int deficit ;  struct codel_vars cvars ; } cocci_id@p ;
