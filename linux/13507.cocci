...
position p;
@@
 const struct dib0070_wbd_gain_cfg cocci_id@p [ ] ;
...
position p;
@@
 struct dvb_usb_adapter * cocci_id@p ;
...
position p;
@@
 struct dib0700_state * cocci_id@p ;
...
position p;
@@
 struct dib0090_config cocci_id@p ;
...
position p;
@@
 struct dibx090p_best_adc cocci_id@p ;
...
position p;
@@
 struct dib7000m_config cocci_id@p ;
...
position p;
@@
 struct dvb_usb_device * cocci_id@p ;
...
position p;
@@
 struct dib9000_config cocci_id@p [ 2 ] ;
...
position p;
@@
 struct dib0090_config cocci_id@p [ 2 ] ;
...
position p;
@@
 struct dib0070_config cocci_id@p [ 2 ] ;
...
position p;
@@
 struct tda18250_config cocci_id@p ;
...
typedef u32;
@@
 struct dibx090p_best_adc {  u32 timf ;  u32 pll_loopdiv ;  u32 pll_prediv ; } cocci_id@p ;
...
typedef u32;
@@
 struct dibx090p_adc {  u32 freq ;  u32 timf ;  u32 pll_loopdiv ;  u32 pll_prediv ; } cocci_id@p ;
...
position p;
@@
 struct dib8000_config cocci_id@p [ 2 ] ;
...
position p;
@@
 struct dib7000p_config cocci_id@p [ 2 ] ;
...
position p;
@@
 struct mxl5007t_config cocci_id@p ;
...
position p;
@@
 struct mt2060_config cocci_id@p ;
...
position p;
@@
 struct dvb_usb_device_properties cocci_id@p [ ] ;
...
position p;
@@
 enum frontend_tune_state cocci_id@p ;
...
position p;
@@
 struct dib3000mc_config cocci_id@p [ 2 ] ;
...
position p;
@@
 struct dib9000_config cocci_id@p ;
...
position p;
@@
 struct dib0090_wbd_slope cocci_id@p [ ] ;
...
position p;
@@
 struct dib8000_config cocci_id@p ;
...
position p;
@@
 struct dib0700_adapter_state * cocci_id@p ;
...
position p;
@@
 struct mt2266_config cocci_id@p [ 2 ] ;
...
position p;
@@
 struct dib0700_adapter_state {  int ( * set_param_save ) ( struct dvb_frontend * ) ;  const struct firmware * frontend_firmware ;  struct dib7000p_ops dib7000p_ops ;  struct dib8000_ops dib8000_ops ; } cocci_id@p ;
...
position p;
@@
 struct mt2060_config cocci_id@p [ 2 ] ;
...
position p;
@@
 struct dibx000_agc_config cocci_id@p [ 2 ] ;
...
position p;
@@
 struct mn88472_config cocci_id@p ;
