...
typedef bool;
@@
 struct sunxi_sram_desc {  struct sunxi_sram_data data ;  bool claimed ; } cocci_id@p ;
...
position p;
@@
 const struct sunxi_sramc_variant * cocci_id@p ;
...
typedef u8;
@@
 struct sunxi_sram_data {  char * name ;  u8 reg ;  u8 offset ;  u8 width ;  struct sunxi_sram_func * func ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 const struct sunxi_sram_data * cocci_id@p ;
...
position p;
@@
 struct sunxi_sram_desc * cocci_id@p ;
...
position p;
@@
 struct sunxi_sram_func cocci_id@p [ ] ;
...
typedef bool;
@@
 struct sunxi_sramc_variant {  bool has_emac_clock ; } cocci_id@p ;
...
typedef u8,u32;
@@
 struct sunxi_sram_func {  char * func ;  u8 val ;  u32 reg_val ; } cocci_id@p ;
