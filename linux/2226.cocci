...
position p;
@@
 struct devices_idr_iter cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct se_device * dev , void * data ) ;
...
@@
 sense_reason_t ( * cocci_id@p ) ( struct se_cmd * cmd ) ;
...
position p;
@@
 struct devices_idr_iter {  struct config_item * prev_item ;  int ( * fn ) ( struct se_device * dev , void * data ) ;  void * data ; } cocci_id@p ;
