...
position p;
@@
 const struct cx88_subid cocci_id@p [ ] ;
...
position p;
@@
 const struct {  int id ;  int fm ;  const char * name ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct cx88_core * cocci_id@p ;
...
position p;
@@
 const struct cx88_board cocci_id@p [ ] ;
...
position p;
@@
 struct tea5767_ctrl cocci_id@p ;
