...
position p;
@@
 struct btmtk_hci_wmt_params cocci_id@p ;
...
position p;
@@
 struct btmtk_tci_sleep cocci_id@p ;
...
position p;
@@
 struct intel_version cocci_id@p ;
...
position p;
@@
 enum { BTMTK_WMT_INVALID , BTMTK_WMT_PATCH_UNDONE , BTMTK_WMT_PATCH_DONE , BTMTK_WMT_ON_UNDONE , BTMTK_WMT_ON_DONE , BTMTK_WMT_ON_PROGRESS , } cocci_id@p ;
...
position p;
@@
 const struct intel_bootup * cocci_id@p ;
...
position p;
@@
 struct btmtk_hci_wmt_cmd cocci_id@p ;
...
position p;
@@
 enum { BTMTK_WMT_PATCH_DWNLD = 0x1 , BTMTK_WMT_FUNC_CTRL = 0x6 , BTMTK_WMT_RST = 0x7 , BTMTK_WMT_SEMAPHORE = 0x17 , } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct btmtk_hci_wmt_params {  u8 op ;  u8 flag ;  u16 dlen ;  const void * data ;  u32 * status ; } cocci_id@p ;
...
position p;
@@
 struct btmtk_hci_wmt_evt_funcc * cocci_id@p ;
...
position p;
@@
 struct intel_boot_params * cocci_id@p ;
...
typedef u8,u32;
@@
 struct qca_device_info {  u32 rom_version ;  u8 rampatch_hdr ;  u8 nvm_hdr ;  u8 ver_offset ; } cocci_id@p ;
...
position p;
@@
 struct btmtk_hci_wmt_evt * cocci_id@p ;
...
position p;
@@
 struct qca_rampatch_version * cocci_id@p ;
...
position p;
@@
 const struct qca_device_info * cocci_id@p ;
...
position p;
@@
 const struct intel_secure_send_result * cocci_id@p ;
...
position p;
@@
 struct btmtk_wmt_hdr * cocci_id@p ;
