...
position p;
@@
 const struct dailink_match_data cocci_id@p [ ] ;
...
position p;
@@
 const struct rockchip_sound_route cocci_id@p [ ] ;
...
position p;
@@
 const struct snd_soc_dai_link cocci_id@p [ ] ;
...
position p;
@@
 struct dailink_match_data {  const char * compatible ;  struct bus_type * bus_type ; } cocci_id@p ;
...
position p;
@@
 struct rockchip_sound_route {  const struct snd_soc_dapm_route * routes ;  int num_routes ; } cocci_id@p ;
...
position p;
@@
 enum { DAILINK_CDNDP , DAILINK_DA7219 , DAILINK_DMIC , DAILINK_MAX98357A , DAILINK_RT5514 , DAILINK_RT5514_DSP , } cocci_id@p ;
