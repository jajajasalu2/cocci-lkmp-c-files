...
position p;
@@
 struct hinic_eq_work cocci_id@p ;
...
position p;
@@
 enum eq_int_mode { EQ_INT_MODE_ARMED , EQ_INT_MODE_ALWAYS , } cocci_id@p ;
...
position p;
@@
 struct hinic_ceq_cb * cocci_id@p ;
...
position p;
@@
 struct hinic_hw_event_cb * cocci_id@p ;
...
position p;
@@
 struct hinic_aeq_elem * cocci_id@p ;
...
position p;
@@
 enum hinic_ceq_type cocci_id@p ;
...
position p;
@@
 enum hinic_aeq_type cocci_id@p ;
...
position p;
@@
 enum eq_arm_state { EQ_NOT_ARMED , EQ_ARMED , } cocci_id@p ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( void * handle , void * data , u8 size ) ;
...
typedef u32;
@@
 void ( * cocci_id@p ) ( void * handle , u32 ceqe_data ) ;
