...
typedef sector_t;
@@
 struct flakey_c {  struct dm_dev * dev ;  unsigned long start_time ;  sector_t start ;  unsigned up_interval ;  unsigned down_interval ;  unsigned long flags ;  unsigned corrupt_bio_byte ;  unsigned corrupt_bio_rw ;  unsigned corrupt_bio_value ;  unsigned corrupt_bio_flags ; } cocci_id@p ;
...
position p;
@@
 enum feature_flag_bits { DROP_WRITES , ERROR_WRITES , } cocci_id@p ;
...
typedef bool;
@@
 struct per_bio_data {  bool bio_submitted ; } cocci_id@p ;
