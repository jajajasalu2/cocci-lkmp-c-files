...
position p;
@@
 const struct i2c_arbitrator_data * cocci_id@p ;
...
position p;
@@
 struct i2c_arbitrator_data {  struct gpio_desc * our_gpio ;  struct gpio_desc * their_gpio ;  unsigned int slew_delay_us ;  unsigned int wait_retry_us ;  unsigned int wait_free_us ; } cocci_id@p ;
...
position p;
@@
 struct i2c_arbitrator_data * cocci_id@p ;
