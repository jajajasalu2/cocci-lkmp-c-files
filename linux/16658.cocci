...
position p;
@@
 char cocci_id@p [ QDIO_DEBUGFS_NAME_LEN ] ;
...
position p;
@@
 struct qdio_dbf_entry * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ QDIO_DBF_NAME_LEN ] ;
...
typedef debug_info_t;
@@
 struct qdio_dbf_entry {  char dbf_name [ QDIO_DBF_NAME_LEN ] ;  debug_info_t * dbf_info ;  struct list_head dbf_list ; } cocci_id@p ;
