...
position p;
@@
 struct nfp_fl_lag_group * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct nfp_flower_cmsg_lag_config {  u8 ctrl_flags ;  u8 reserved [ 2 ] ;  u8 ttl ;  __be32 pkt_number ;  __be32 batch_ver ;  __be32 group_id ;  __be32 group_inst ;  __be32 members [ ] ; } cocci_id@p ;
...
position p;
@@
 enum nfp_fl_lag_batch cocci_id@p ;
...
position p;
@@
 enum nfp_fl_lag_batch { NFP_FL_LAG_BATCH_FIRST , NFP_FL_LAG_BATCH_MEMBER , NFP_FL_LAG_BATCH_FINISHED , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct nfp_fl_lag_group {  unsigned int group_id ;  u8 group_inst ;  struct list_head list ;  struct net_device * master_ndev ;  bool dirty ;  bool offloaded ;  bool to_remove ;  bool to_destroy ;  unsigned int slave_cnt ; } cocci_id@p ;
...
position p;
@@
 struct nfp_flower_cmsg_lag_config * cocci_id@p ;
