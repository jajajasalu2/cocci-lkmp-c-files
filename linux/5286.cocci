...
typedef u32;
@@
 struct pata_macio_timing {  int mode ;  u32 reg1 ;  u32 reg2 ; } cocci_id@p ;
...
position p;
@@
 struct pata_macio_priv cocci_id@p ;
...
position p;
@@
 const struct pata_macio_timing cocci_id@p [ ] ;
...
position p;
@@
 struct pata_macio_timing cocci_id@p ;
...
@@
 struct pata_macio_priv {  int kind ;  int aapl_bus_id ;  int mediabay : 1 ;  struct device_node * node ;  struct macio_dev * mdev ;  struct pci_dev * pdev ;  struct device * dev ;  int irq ;  u32 treg [ 2 ] [ 2 ] ;  void __iomem * tfregs ;  void __iomem * kauai_fcr ;  struct dbdma_cmd * dma_table_cpu ;  dma_addr_t dma_table_dma ;  struct ata_host * host ;  const struct pata_macio_timing * timings ; } cocci_id@p ;
