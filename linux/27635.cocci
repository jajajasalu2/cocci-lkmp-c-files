...
position p;
@@
 union jffs2_node_union * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct jffs2_sb_info * c , struct jffs2_eraseblock * jeb , struct jffs2_inode_info * f , struct jffs2_full_dnode * fd ) ;
...
position p;
@@
 struct jffs2_xattr_datum * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct jffs2_sb_info * c , struct jffs2_eraseblock * jeb , struct jffs2_inode_info * f , struct jffs2_full_dirent * fd ) ;
...
position p;
@@
 struct jffs2_node_frag * cocci_id@p ;
...
position p;
@@
 struct jffs2_xattr_ref * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct jffs2_sb_info * c , struct jffs2_eraseblock * jeb , struct jffs2_raw_node_ref * raw , struct jffs2_inode_info * f ) ;
...
position p;
@@
 struct jffs2_raw_node_ref * cocci_id@p ;
...
position p;
@@
 struct jffs2_eraseblock * cocci_id@p ;
...
position p;
@@
 struct jffs2_raw_dirent cocci_id@p ;
...
position p;
@@
 struct jffs2_inode_cache * cocci_id@p ;
...
position p;
@@
 union jffs2_device_node cocci_id@p ;
...
position p;
@@
 struct jffs2_sb_info * cocci_id@p ;
...
position p;
@@
 struct jffs2_unknown_node cocci_id@p ;
...
position p;
@@
 struct jffs2_full_dirent * * cocci_id@p ;
...
position p;
@@
 struct jffs2_raw_inode cocci_id@p ;
...
position p;
@@
 struct jffs2_inode_info * cocci_id@p ;
...
position p;
@@
 struct jffs2_full_dnode * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct jffs2_sb_info * c , struct jffs2_inode_cache * ic , struct jffs2_raw_node_ref * raw ) ;
