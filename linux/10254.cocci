...
position p;
@@
 const struct tegra_mipi_soc cocci_id@p ;
...
position p;
@@
 struct tegra_mipi {  const struct tegra_mipi_soc * soc ;  struct device * dev ;  void __iomem * regs ;  struct mutex lock ;  struct clk * clk ;  unsigned long usage_count ; } cocci_id@p ;
...
typedef u8,bool;
@@
 struct tegra_mipi_soc {  bool has_clk_lane ;  const struct tegra_mipi_pad * pads ;  unsigned int num_pads ;  bool clock_enable_override ;  bool needs_vclamp_ref ;  u8 pad_drive_down_ref ;  u8 pad_drive_up_ref ;  u8 pad_vclamp_level ;  u8 pad_vauxp_level ;  u8 hspdos ;  u8 hspuos ;  u8 termos ;  u8 hsclkpdos ;  u8 hsclkpuos ; } cocci_id@p ;
...
position p;
@@
 struct tegra_mipi_pad {  unsigned long data ;  unsigned long clk ; } cocci_id@p ;
...
position p;
@@
 struct tegra_mipi_device * cocci_id@p ;
...
position p;
@@
 const struct tegra_mipi_pad cocci_id@p [ ] ;
...
position p;
@@
 struct tegra_mipi_device {  struct platform_device * pdev ;  struct tegra_mipi * mipi ;  struct device * device ;  unsigned long pads ; } cocci_id@p ;
