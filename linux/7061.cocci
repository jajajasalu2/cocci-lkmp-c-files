...
position p;
@@
 struct via82cxxx_dev {  struct via_isa_bridge * via_config ;  unsigned int via_80w ; } cocci_id@p ;
...
position p;
@@
 struct via82cxxx_dev * cocci_id@p ;
...
position p;
@@
 struct via_isa_bridge * cocci_id@p ;
...
typedef u8,u16;
@@
 struct via_isa_bridge {  char * name ;  u16 id ;  u8 rev_min ;  u8 rev_max ;  u8 udma_mask ;  u8 flags ; } cocci_id@p [ ] ;
...
position p;
@@
 enum { VIA_IDFLAG_SINGLE = ( 1 << 1 ) , } cocci_id@p ;
