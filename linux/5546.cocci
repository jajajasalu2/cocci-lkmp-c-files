...
position p;
@@
 void cocci_id@p ( struct device * dev , unsigned char * rtc_control ) ;
...
typedef u8,time64_t;
@@
 struct cmos_rtc {  struct rtc_device * rtc ;  struct device * dev ;  int irq ;  struct resource * iomem ;  time64_t alarm_expires ;  void ( * wake_on ) ( struct device * ) ;  void ( * wake_off ) ( struct device * ) ;  u8 enabled_wake ;  u8 suspend_ctrl ;  u8 day_alrm ;  u8 mon_alrm ;  u8 century ;  struct rtc_wkalrm saved_wkalrm ; } cocci_id@p ;
...
position p;
@@
 struct cmos_rtc_board_info cocci_id@p ;
