...
position p;
@@
 struct ad5791_platform_data * cocci_id@p ;
...
@@
 struct ad5791_state {  struct spi_device * spi ;  struct regulator * reg_vdd ;  struct regulator * reg_vss ;  const struct ad5791_chip_info * chip_info ;  unsigned short vref_mv ;  unsigned int vref_neg_mv ;  unsigned ctrl ;  unsigned pwr_down_mode ;  bool pwr_down ;  union {  __be32 d32 ;  u8 d8 [ 4 ] ; } data [ 3 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 const struct ad5791_chip_info cocci_id@p [ ] ;
...
position p;
@@
 enum ad5791_supported_device_ids { ID_AD5760 , ID_AD5780 , ID_AD5781 , ID_AD5791 , } cocci_id@p ;
...
position p;
@@
 struct ad5791_chip_info {  int ( * get_lin_comp ) ( unsigned int span ) ; } cocci_id@p ;
...
position p;
@@
 struct ad5791_state * cocci_id@p ;
