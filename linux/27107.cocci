...
position p;
@@
 struct ecryptfs_sb_info cocci_id@p ;
...
position p;
@@
 struct ecryptfs_file_info cocci_id@p ;
...
@@
 struct ecryptfs_cache_info {  struct kmem_cache * * cache ;  const char * name ;  size_t size ;  slab_flags_t flags ;  void ( * ctor ) ( void * obj ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ecryptfs_dentry_info cocci_id@p ;
...
position p;
@@
 struct ecryptfs_cache_info * cocci_id@p ;
...
position p;
@@
 struct ecryptfs_inode_info * cocci_id@p ;
