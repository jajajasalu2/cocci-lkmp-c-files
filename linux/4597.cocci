...
position p;
@@
 struct mic_device_ctrl * cocci_id@p ;
...
position p;
@@
 struct vop_device_id cocci_id@p [ ] ;
...
position p;
@@
 struct mic_vqconfig cocci_id@p ;
...
position p;
@@
 struct virtio_config_ops cocci_id@p ;
...
position p;
@@
 struct mic_bootparam cocci_id@p ;
