...
position p;
@@
 struct pxa930_trkball cocci_id@p ;
...
position p;
@@
 struct pxa930_trkball {  struct pxa930_trkball_platform_data * pdata ;  struct resource * mem ;  void __iomem * mmio_base ;  struct input_dev * input ; } cocci_id@p ;
