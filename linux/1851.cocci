...
position p;
@@
 struct ad7124_state {  const struct ad7124_chip_info * chip_info ;  struct ad_sigma_delta sd ;  struct ad7124_channel_config * channel_config ;  struct regulator * vref [ 4 ] ;  struct clk * mclk ;  unsigned int adc_control ;  unsigned int num_channels ; } cocci_id@p ;
...
position p;
@@
 struct ad7124_channel_config * cocci_id@p ;
...
position p;
@@
 const struct ad_sigma_delta_info cocci_id@p ;
...
position p;
@@
 struct ad7124_state cocci_id@p ;
...
position p;
@@
 enum ad7124_ref_sel { AD7124_REFIN1 , AD7124_REFIN2 , AD7124_INT_REF , AD7124_AVDD_REF , } cocci_id@p ;
...
position p;
@@
 enum ad7124_ids { ID_AD7124_4 , ID_AD7124_8 , } cocci_id@p ;
...
typedef bool;
@@
 struct ad7124_channel_config {  enum ad7124_ref_sel refsel ;  bool bipolar ;  bool buf_positive ;  bool buf_negative ;  unsigned int ain ;  unsigned int vref_mv ;  unsigned int pga_bits ;  unsigned int odr ; } cocci_id@p ;
...
position p;
@@
 enum ad_sigma_delta_mode cocci_id@p ;
...
position p;
@@
 struct ad_sigma_delta * cocci_id@p ;
...
position p;
@@
 struct ad7124_chip_info {  unsigned int num_inputs ; } cocci_id@p ;
...
position p;
@@
 struct ad7124_chip_info cocci_id@p [ ] ;
...
position p;
@@
 enum ad7124_power_mode { AD7124_LOW_POWER , AD7124_MID_POWER , AD7124_FULL_POWER , } cocci_id@p ;
