...
position p;
@@
 int cocci_id@p ( struct btrfsic_state * state , struct btrfsic_dev_state * dev_state , struct btrfs_device * device , int superblock_mirror_num , struct btrfsic_dev_state * * selected_dev_state , struct btrfs_super_block * selected_super ) ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_block_link * l ) ;
...
typedef u64,u32;
@@
 struct btrfsic_block_link {  u32 magic_num ;  u32 ref_cnt ;  struct list_head node_ref_to ;  struct list_head node_ref_from ;  struct list_head collision_resolving_node ;  struct btrfsic_block * block_ref_to ;  struct btrfsic_block * block_ref_from ;  u64 parent_generation ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p ( const struct btrfsic_state * state , const struct btrfsic_block * block ) ;
...
position p;
@@
 struct btrfs_super_block * cocci_id@p ;
...
position p;
@@
 struct btrfsic_stack_frame cocci_id@p ;
...
position p;
@@
 struct btrfsic_block_data_ctx * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_block_data_ctx * block_ctx ) ;
...
position p;
@@
 struct btrfsic_state * cocci_id@p ;
...
position p;
@@
 struct btrfsic_block_data_ctx * const cocci_id@p ;
...
position p;
@@
 struct btrfsic_block_link * cocci_id@p ( void ) ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_block_link * l , struct btrfsic_block_link_hashtable * h ) ;
...
position p;
@@
 struct btrfs_header * cocci_id@p ;
...
position p;
@@
 struct btrfs_fs_devices * cocci_id@p ;
...
position p;
@@
 struct btrfsic_block_link_hashtable * cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct btrfsic_state * state , struct btrfsic_block * block , struct btrfsic_block_data_ctx * block_ctx , u64 next_bytenr , int limit_nesting , struct btrfsic_block_data_ctx * next_block_ctx , struct btrfsic_block * * next_blockp , int force_iodone_flag , int * num_copiesp , int * mirror_nump , struct btrfs_disk_key * disk_key , u64 parent_generation ) ;
...
typedef u32;
@@
 struct btrfsic_stack_frame {  u32 magic ;  u32 nr ;  int error ;  int i ;  int limit_nesting ;  int num_copies ;  int mirror_num ;  struct btrfsic_block * block ;  struct btrfsic_block_data_ctx * block_ctx ;  struct btrfsic_block * next_block ;  struct btrfsic_block_data_ctx next_block_ctx ;  struct btrfs_header * hdr ;  struct btrfsic_stack_frame * prev ; } cocci_id@p ;
...
position p;
@@
 const struct btrfsic_block * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_state * state ) ;
...
position p;
@@
 void cocci_id@p ( const struct btrfsic_state * state ) ;
...
position p;
@@
 struct btrfsic_dev_state_hashtable * cocci_id@p ;
...
position p;
@@
 struct btrfs_node * const cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct btrfsic_state * state , u64 bytenr , struct btrfsic_dev_state * dev_state , u64 dev_bytenr ) ;
...
position p;
@@
 struct btrfs_header * const cocci_id@p ;
...
position p;
@@
 struct btrfsic_stack_frame * const cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct btrfsic_state * state , const struct btrfsic_block * block , int indent_level ) ;
...
position p;
@@
 struct btrfsic_dev_state_hashtable {  struct list_head table [ BTRFSIC_DEV2STATE_HASHTABLE_SIZE ] ; } cocci_id@p ;
...
typedef u64;
@@
 struct btrfsic_block * cocci_id@p ( struct block_device * bdev , u64 dev_bytenr , struct btrfsic_block_hashtable * h ) ;
...
position p;
@@
 struct btrfsic_dev_state cocci_id@p ;
...
position p;
@@
 struct btrfsic_block * const cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_dev_state * ds ) ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_dev_state_hashtable * h ) ;
...
position p;
@@
 int cocci_id@p ( struct btrfsic_state * state , struct btrfs_fs_devices * fs_devices ) ;
...
position p;
@@
 struct btrfsic_block_hashtable {  struct list_head table [ BTRFSIC_BLOCK_HASHTABLE_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 const struct btrfsic_state * cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct btrfsic_dev_state * dev_state , u64 dev_bytenr , char * * mapped_datav , unsigned int num_pages , struct bio * bio , int * bio_is_patched , struct buffer_head * bh , int submit_bio_bh_rw ) ;
...
typedef dev_t;
@@
 struct btrfsic_dev_state * cocci_id@p ( dev_t dev ) ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_block_link_hashtable * h ) ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_block * b ) ;
...
typedef u64,u32;
@@
 int cocci_id@p ( struct btrfsic_state * state , u64 bytenr , u32 len , struct btrfsic_block_data_ctx * block_ctx_out , int mirror_num ) ;
...
position p;
@@
 int cocci_id@p ( struct btrfsic_state * state , struct btrfsic_block * block , struct btrfsic_block_data_ctx * block_ctx , int limit_nesting , int force_iodone_flag ) ;
...
position p;
@@
 struct btrfsic_block_link_hashtable {  struct list_head table [ BTRFSIC_BLOCK_LINK_HASHTABLE_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct btrfsic_block * * cocci_id@p ;
...
typedef u64,u32;
@@
 struct btrfsic_dev_state {  u32 magic_num ;  struct block_device * bdev ;  struct btrfsic_state * state ;  struct list_head collision_resolving_node ;  struct btrfsic_block dummy_block_for_bio_bh_flush ;  u64 last_flush_gen ;  char name [ BDEVNAME_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfsic_state * state , struct btrfsic_block * const block , struct btrfs_super_block * const super_hdr ) ;
...
typedef u64;
@@
 struct btrfsic_block_link * cocci_id@p ( struct btrfsic_state * state , struct btrfsic_block_data_ctx * next_block_ctx , struct btrfsic_block * next_block , struct btrfsic_block * from_block , u64 parent_generation ) ;
...
position p;
@@
 struct btrfsic_block * cocci_id@p ( void ) ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_dev_state * ds , struct btrfsic_dev_state_hashtable * h ) ;
...
position p;
@@
 struct btrfs_leaf * const cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,u32,bh_end_io_t,bio_end_io_t;
@@
 struct btrfsic_block {  u32 magic_num ;  unsigned int is_metadata : 1 ;  unsigned int is_superblock : 1 ;  unsigned int is_iodone : 1 ;  unsigned int iodone_w_error : 1 ;  unsigned int never_written : 1 ;  unsigned int mirror_num ;  struct btrfsic_dev_state * dev_state ;  u64 dev_bytenr ;  u64 logical_bytenr ;  u64 generation ;  struct btrfs_disk_key disk_key ;  struct list_head collision_resolving_node ;  struct list_head all_blocks_node ;  struct list_head ref_to_list ;  struct list_head ref_from_list ;  struct btrfsic_block * next_in_same_bio ;  void * orig_bio_bh_private ;  union {  bio_end_io_t * bio ;  bh_end_io_t * bh ; } orig_bio_bh_end_io ;  int submit_bio_bh_rw ;  u64 flush_gen ; } cocci_id@p ;
...
position p;
@@
 struct btrfsic_dev_state * cocci_id@p ( void ) ;
...
typedef u64,u32;
@@
 struct btrfsic_state {  u32 print_mask ;  int include_extent_data ;  int csum_size ;  struct list_head all_blocks_list ;  struct btrfsic_block_hashtable block_hashtable ;  struct btrfsic_block_link_hashtable block_link_hashtable ;  struct btrfs_fs_info * fs_info ;  u64 max_superblock_generation ;  struct btrfsic_block * latest_superblock ;  u32 metablock_size ;  u32 datablock_size ; } cocci_id@p ;
...
position p;
@@
 struct btrfsic_block * cocci_id@p ( struct btrfsic_state * state , struct btrfsic_block_data_ctx * block_ctx , const char * additional_string , int is_metadata , int is_iodone , int never_written , int mirror_num , int * was_created ) ;
...
position p;
@@
 void cocci_id@p ( const struct btrfsic_state * state , const struct btrfsic_block_link * l ) ;
...
typedef u64,u32;
@@
 struct btrfsic_block_data_ctx {  u64 start ;  u64 dev_bytenr ;  u32 len ;  struct btrfsic_dev_state * dev ;  char * * datav ;  struct page * * pagev ;  void * mem_to_free ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_stack_frame * sf ) ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_block_link * n ) ;
...
position p;
@@
 void cocci_id@p ( struct buffer_head * bh , int uptodate ) ;
...
position p;
@@
 int cocci_id@p ( struct btrfsic_state * state , struct btrfsic_block * const block , int recursion_level ) ;
...
position p;
@@
 struct btrfsic_dev_state * const cocci_id@p ;
...
position p;
@@
 struct btrfsic_stack_frame * cocci_id@p ( void ) ;
...
position p;
@@
 struct block_device * const cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_block_hashtable * h ) ;
...
position p;
@@
 struct btrfs_key_ptr cocci_id@p ;
...
position p;
@@
 const struct btrfsic_block_link * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct btrfsic_block * b , struct btrfsic_block_hashtable * h ) ;
...
position p;
@@
 int cocci_id@p ( struct btrfsic_state * state , struct btrfsic_block_data_ctx * block_ctx ) ;
...
typedef dev_t;
@@
 struct btrfsic_dev_state * cocci_id@p ( dev_t dev , struct btrfsic_dev_state_hashtable * h ) ;
...
position p;
@@
 struct btrfsic_block_hashtable * cocci_id@p ;
...
position p;
@@
 struct btrfs_device * cocci_id@p ;
...
typedef u64;
@@
 struct btrfsic_block_link * cocci_id@p ( struct block_device * bdev_ref_to , u64 dev_bytenr_ref_to , struct block_device * bdev_ref_from , u64 dev_bytenr_ref_from , struct btrfsic_block_link_hashtable * h ) ;
...
typedef u32;
@@
 int cocci_id@p ( struct btrfsic_state * state , struct btrfsic_block * block , struct btrfsic_block_data_ctx * block_ctx , u32 item_offset , int force_iodone_flag ) ;
...
position p;
@@
 int cocci_id@p ( const struct btrfsic_state * state , const struct btrfsic_block * block , int recursion_level ) ;
...
position p;
@@
 struct btrfs_super_block * const cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct btrfsic_state * state , char * * datav , unsigned int num_pages ) ;
...
position p;
@@
 struct btrfsic_block_link * cocci_id@p ;
