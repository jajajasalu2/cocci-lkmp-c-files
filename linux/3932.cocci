...
position p;
@@
 const struct imx7_src_signal cocci_id@p [ IMX7_RESET_NUM ] ;
...
position p;
@@
 enum imx7_src_registers { SRC_A7RCR0 = 0x0004 , SRC_M4RCR = 0x000c , SRC_ERCR = 0x0014 , SRC_HSICPHY_RCR = 0x001c , SRC_USBOPHY1_RCR = 0x0020 , SRC_USBOPHY2_RCR = 0x0024 , SRC_MIPIPHY_RCR = 0x0028 , SRC_PCIEPHY_RCR = 0x002c , SRC_DDRC_RCR = 0x1000 , } cocci_id@p ;
...
position p;
@@
 const struct imx7_src_signal * cocci_id@p ;
...
position p;
@@
 const struct imx7_src_variant cocci_id@p ;
...
position p;
@@
 const struct imx7_src_signal cocci_id@p [ IMX8MQ_RESET_NUM ] ;
...
position p;
@@
 struct imx7_src {  struct reset_controller_dev rcdev ;  struct regmap * regmap ;  const struct imx7_src_signal * signals ; } cocci_id@p ;
...
position p;
@@
 struct imx7_src_variant {  const struct imx7_src_signal * signals ;  unsigned int signals_num ;  struct reset_control_ops ops ; } cocci_id@p ;
...
position p;
@@
 enum imx8mq_src_registers { SRC_A53RCR0 = 0x0004 , SRC_HDMI_RCR = 0x0030 , SRC_DISP_RCR = 0x0034 , SRC_GPU_RCR = 0x0040 , SRC_VPU_RCR = 0x0044 , SRC_PCIE2_RCR = 0x0048 , SRC_MIPIPHY1_RCR = 0x004c , SRC_MIPIPHY2_RCR = 0x0050 , SRC_DDRC2_RCR = 0x1004 , } cocci_id@p ;
