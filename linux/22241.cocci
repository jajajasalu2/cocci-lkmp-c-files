...
position p;
@@
 enum { PAGE_KEEP , PAGE_ACTIVATE , PAGE_SUCCESS , PAGE_CLEAN , } cocci_id@p ;
...
position p;
@@
 struct reclaim_stat cocci_id@p ;
...
position p;
@@
 struct reclaim_state * cocci_id@p ;
...
position p;
@@
 enum page_references cocci_id@p ;
...
position p;
@@
 enum page_references { PAGEREF_RECLAIM , PAGEREF_RECLAIM_CLEAN , PAGEREF_KEEP , PAGEREF_ACTIVATE , } cocci_id@p ;
...
position p;
@@
 struct scan_control cocci_id@p ;
...
position p;
@@
 enum scan_balance { SCAN_EQUAL , SCAN_FRACT , SCAN_ANON , SCAN_FILE , } cocci_id@p ;
...
position p;
@@
 unsigned noinline_for_stack cocci_id@p ;
