...
position p;
@@
 enum tpm_atmel_write_status { ATML_STATUS_ABORT = 0x01 , ATML_STATUS_LASTBYTE = 0x04 , } cocci_id@p ;
...
position p;
@@
 struct tpm_atmel_priv * cocci_id@p ;
...
position p;
@@
 enum tpm_atmel_read_status { ATML_STATUS_BUSY = 0x01 , ATML_STATUS_DATA_AVAIL = 0x02 , ATML_STATUS_REWRITE = 0x04 , ATML_STATUS_READY = 0x08 , } cocci_id@p ;
