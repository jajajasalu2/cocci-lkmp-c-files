...
position p;
@@
 struct ncsi_aen_handler {  unsigned char type ;  int payload ;  int ( * handler ) ( struct ncsi_dev_priv * ndp , struct ncsi_aen_pkt_hdr * h ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct ncsi_aen_lsc_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_aen_handler * cocci_id@p ;
...
position p;
@@
 struct ncsi_aen_hncdsc_pkt * cocci_id@p ;
...
position p;
@@
 struct ncsi_aen_pkt_hdr * cocci_id@p ;
