...
position p;
@@
 struct drm_info_list cocci_id@p [ QXL_DEBUGFS_MEM_TYPES ] ;
...
typedef u64;
@@
 struct qxl_ttm_tt {  struct ttm_tt ttm ;  struct qxl_device * qdev ;  u64 offset ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ QXL_DEBUGFS_MEM_TYPES ] [ 32 ] ;
