...
position p;
@@
 struct hi6220_clk_divider cocci_id@p ;
...
@@
 struct hi6220_clk_divider {  struct clk_hw hw ;  void __iomem * reg ;  u8 shift ;  u8 width ;  u32 mask ;  const struct clk_div_table * table ;  spinlock_t * lock ; } cocci_id@p ;
