...
position p;
@@
 struct mmc_pwrseq_simple cocci_id@p ;
...
typedef bool,u32;
@@
 struct mmc_pwrseq_simple {  struct mmc_pwrseq pwrseq ;  bool clk_enabled ;  u32 post_power_on_delay_ms ;  u32 power_off_delay_us ;  struct clk * ext_clk ;  struct gpio_descs * reset_gpios ; } cocci_id@p ;
...
position p;
@@
 const struct mmc_pwrseq_ops cocci_id@p ;
