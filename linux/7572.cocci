...
position p;
@@
 struct options {  char * name ;  void ( * parse ) ( char * opt ) ; } cocci_id@p [ ] ;
...
position p;
@@
 struct fb_monspecs cocci_id@p [ NR_MONTYPES ] ;
