...
position p;
@@
 struct ltc1660_priv * cocci_id@p ;
...
position p;
@@
 const struct iio_chan_spec cocci_id@p [ ] [ LTC1660_NUM_CHANNELS ] ;
...
position p;
@@
 struct ltc1660_priv {  struct spi_device * spi ;  struct regmap * regmap ;  struct regulator * vref_reg ;  unsigned int value [ LTC1660_NUM_CHANNELS ] ;  unsigned int vref_mv ; } cocci_id@p ;
...
position p;
@@
 enum ltc1660_supported_device_ids { ID_LTC1660 , ID_LTC1665 , } cocci_id@p ;
