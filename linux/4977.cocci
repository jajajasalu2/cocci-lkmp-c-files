...
position p;
@@
 struct usnic_ib_qp_grp_flow cocci_id@p ;
...
position p;
@@
 struct usnic_ib_ucontext cocci_id@p ;
...
position p;
@@
 struct usnic_transport_spec * cocci_id@p ;
...
position p;
@@
 struct usnic_vnic_res_spec cocci_id@p ;
...
position p;
@@
 struct vnic_dev_bar * cocci_id@p ;
...
position p;
@@
 struct usnic_vnic_res_chunk * cocci_id@p ;
...
position p;
@@
 const struct usnic_vnic_res_spec cocci_id@p [ USNIC_TRANSPORT_MAX ] ;
...
position p;
@@
 struct usnic_ib_dev * cocci_id@p ;
...
position p;
@@
 struct usnic_ib_qp_grp * cocci_id@p ;
...
position p;
@@
 struct usnic_ib_create_qp_resp cocci_id@p ;
...
position p;
@@
 struct usnic_ib_create_qp_cmd cocci_id@p ;
