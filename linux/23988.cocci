...
position p;
@@
 const struct ipt_replace * cocci_id@p ;
...
@@
 struct compat_ipt_replace {  char name [ XT_TABLE_MAXNAMELEN ] ;  u32 valid_hooks ;  u32 num_entries ;  u32 size ;  u32 hook_entry [ NF_INET_NUMHOOKS ] ;  u32 underflow [ NF_INET_NUMHOOKS ] ;  u32 num_counters ;  compat_uptr_t counters ;  struct compat_ipt_entry entries [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct compat_ipt_replace cocci_id@p ;
...
position p;
@@
 struct compat_ipt_entry cocci_id@p ;
...
position p;
@@
 const struct ipt_entry * cocci_id@p ;
...
position p;
@@
 struct compat_ipt_get_entries cocci_id@p ;
...
position p;
@@
 const struct ipt_icmp * cocci_id@p ;
...
position p;
@@
 struct ipt_get_entries cocci_id@p ;
...
position p;
@@
 const struct compat_ipt_replace * cocci_id@p ;
...
position p;
@@
 const struct icmphdr * cocci_id@p ;
...
position p;
@@
 const struct ipt_ip * cocci_id@p ;
...
typedef compat_uint_t;
@@
 struct compat_ipt_get_entries {  char name [ XT_TABLE_MAXNAMELEN ] ;  compat_uint_t size ;  struct compat_ipt_entry entrytable [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 enum nf_ip_trace_comments { NF_IP_TRACE_COMMENT_RULE , NF_IP_TRACE_COMMENT_RETURN , NF_IP_TRACE_COMMENT_POLICY , } cocci_id@p ;
