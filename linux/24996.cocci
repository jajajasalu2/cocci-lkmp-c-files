...
position p;
@@
 const struct batadv_icmp_tp_packet * cocci_id@p ;
...
position p;
@@
 struct batadv_tp_unacked * cocci_id@p ;
...
position p;
@@
 struct batadv_tp_vars cocci_id@p ;
...
position p;
@@
 enum batadv_tp_meter_reason cocci_id@p ;
