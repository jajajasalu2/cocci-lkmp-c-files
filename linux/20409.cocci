...
position p;
@@
 struct change_member {  struct e820_entry * entry ;  unsigned long long addr ; } cocci_id@p ;
...
position p;
@@
 struct change_member * const * cocci_id@p ;
...
position p;
@@
 const struct change_member * cocci_id@p ;
