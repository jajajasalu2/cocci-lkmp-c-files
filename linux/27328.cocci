...
position p;
@@
 struct smbd_connection cocci_id@p ;
...
position p;
@@
 struct smbd_negotiate_req * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct smbd_connection * info , struct smbd_response * response ) ;
...
position p;
@@
 void cocci_id@p ( struct smbd_connection * info ) ;
...
position p;
@@
 struct smbd_request cocci_id@p ;
...
position p;
@@
 struct smbd_response cocci_id@p ;
...
position p;
@@
 struct smbd_negotiate_resp cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct smbd_connection * info , struct smbd_response * response ) ;
...
position p;
@@
 void cocci_id@p ( struct smbd_connection * info , struct smbd_response * response , int data_length ) ;
...
position p;
@@
 struct scatterlist cocci_id@p [ SMBDIRECT_MAX_SGE ] ;
...
position p;
@@
 struct smbd_data_transfer cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct smbd_connection * info ) ;
...
position p;
@@
 struct smbd_response * cocci_id@p ( struct smbd_connection * info ) ;
...
position p;
@@
 int cocci_id@p ( struct smbd_connection * info , int num_buf ) ;
...
position p;
@@
 int cocci_id@p ( struct smbd_connection * info , struct kvec * iov , int n_vec , int remaining_data_length ) ;
