...
position p;
@@
 struct dpaa_percpu_priv * cocci_id@p ;
...
position p;
@@
 struct dpaa_eth_data * cocci_id@p ;
...
position p;
@@
 struct dpaa_buffer_layout * cocci_id@p ;
...
position p;
@@
 const struct dpaa_fq_cbs * cocci_id@p ;
...
position p;
@@
 struct fman_prs_result cocci_id@p ;
...
position p;
@@
 const struct dpaa_priv * cocci_id@p ;
...
position p;
@@
 struct dpaa_napi_portal cocci_id@p ;
...
position p;
@@
 const struct dpaa_bp * cocci_id@p ;
...
position p;
@@
 struct fm_port_fqs {  struct dpaa_fq * tx_defq ;  struct dpaa_fq * tx_errq ;  struct dpaa_fq * rx_defq ;  struct dpaa_fq * rx_errq ;  struct dpaa_fq * rx_pcdq ; } cocci_id@p ;
...
position p;
@@
 struct bm_buffer cocci_id@p [ DPAA_BUFF_RELEASE_MAX ] ;
...
position p;
@@
 const struct qman_fq * cocci_id@p ;
...
position p;
@@
 const struct qm_sg_entry * cocci_id@p ;
...
position p;
@@
 const enum dma_data_direction cocci_id@p ;
...
position p;
@@
 enum port_type { RX , TX , } cocci_id@p ;
...
position p;
@@
 struct fman_port_rx_params * cocci_id@p ;
...
position p;
@@
 struct dpaa_bp * cocci_id@p [ BM_MAX_NUM_OF_POOLS ] ;
