...
position p;
@@
 void cocci_id@p ( struct fjes_adapter * , int ) ;
...
position p;
@@
 void cocci_id@p ( struct fjes_adapter * ) ;
...
position p;
@@
 union ep_buffer_info * cocci_id@p ;
...
position p;
@@
 struct fjes_device_command_param cocci_id@p ;
...
position p;
@@
 enum ep_partner_status cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fjes_adapter * ) ;
...
position p;
@@
 struct fjes_adapter * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct net_device * , struct rtnl_link_stats64 * ) ;
...
typedef u16,__be16;
@@
 int cocci_id@p ( struct net_device * , __be16 proto , u16 ) ;
...
position p;
@@
 char cocci_id@p [ sizeof ( FJES_ACPI_SYMBOL ) + 1 ] ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_resource * , void * ) ;
...
position p;
@@
 int cocci_id@p ( struct platform_device * ) ;
...
position p;
@@
 struct ep_share_mem_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct acpi_device * ) ;
