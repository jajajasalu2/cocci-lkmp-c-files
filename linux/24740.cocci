...
position p;
@@
 const struct nft_rhash_cmp_arg * cocci_id@p ;
...
typedef u8,u32;
@@
 struct nft_rhash_cmp_arg {  const struct nft_set * set ;  const u32 * key ;  u8 genmask ; } cocci_id@p ;
...
position p;
@@
 struct nft_hash_elem * cocci_id@p ;
...
position p;
@@
 struct nft_rhash_elem cocci_id@p ;
...
position p;
@@
 struct nft_rhash_elem {  struct rhash_head node ;  struct nft_set_ext ext ; } cocci_id@p ;
...
position p;
@@
 void * ( * cocci_id@p ) ( struct nft_set * , const struct nft_expr * , struct nft_regs * regs ) ;
...
position p;
@@
 const struct nft_hash_elem * cocci_id@p ;
...
position p;
@@
 const struct nft_rhash_elem * cocci_id@p ;
...
position p;
@@
 struct nft_rhash_cmp_arg cocci_id@p ;
...
position p;
@@
 struct nft_hash_elem {  struct hlist_node node ;  struct nft_set_ext ext ; } cocci_id@p ;
...
typedef u32;
@@
 struct nft_hash {  u32 seed ;  u32 buckets ;  struct hlist_head table [ ] ; } cocci_id@p ;
...
position p;
@@
 struct nft_rhash {  struct rhashtable ht ;  struct delayed_work gc_work ; } cocci_id@p ;
...
position p;
@@
 const struct nft_hash * cocci_id@p ;
