...
position p;
@@
 char cocci_id@p [ RSND_SRC_NAME_SIZE ] ;
...
position p;
@@
 struct rsnd_src {  struct rsnd_mod mod ;  struct rsnd_mod * dma ;  struct rsnd_kctrl_cfg_s sen ;  struct rsnd_kctrl_cfg_s sync ;  int irq ; } cocci_id@p ;
