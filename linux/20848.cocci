...
position p;
@@
 struct segmented_address cocci_id@p ;
...
position p;
@@
 const struct instr_dual cocci_id@p ;
...
position p;
@@
 const struct group_dual cocci_id@p ;
...
typedef u64;
@@
 struct opcode {  u64 flags : 56 ;  u64 intercept : 8 ;  union {  int ( * execute ) ( struct x86_emulate_ctxt * ctxt ) ;  const struct opcode * group ;  const struct group_dual * gdual ;  const struct gprefix * gprefix ;  const struct escape * esc ;  const struct instr_dual * idual ;  const struct mode_dual * mdual ;  void ( * fastop ) ( struct fastop * fake ) ; } u ;  int ( * check_perm ) ( struct x86_emulate_ctxt * ctxt ) ; } cocci_id@p ;
...
position p;
@@
 const struct opcode cocci_id@p [ ] ;
...
position p;
@@
 enum x86_transfer_type cocci_id@p ;
...
position p;
@@
 struct tss_segment_16 cocci_id@p ;
...
position p;
@@
 struct gprefix {  struct opcode pfx_no ;  struct opcode pfx_66 ;  struct opcode pfx_f2 ;  struct opcode pfx_f3 ; } cocci_id@p ;
...
position p;
@@
 const struct opcode cocci_id@p [ 256 ] ;
...
position p;
@@
 const struct escape cocci_id@p ;
...
position p;
@@
 const struct gprefix cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct x86_emulate_ctxt * ctxt , void ( * fop ) ( struct fastop * ) ) ;
...
position p;
@@
 const struct desc_struct * cocci_id@p ;
...
position p;
@@
 struct instr_dual {  struct opcode mod012 ;  struct opcode mod3 ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct x86_emulate_ctxt * ctxt , struct desc_ptr * ptr ) ;
...
position p;
@@
 struct mode_dual {  struct opcode mode32 ;  struct opcode mode64 ; } cocci_id@p ;
...
position p;
@@
 struct tss_segment_32 * cocci_id@p ;
...
position p;
@@
 struct escape {  struct opcode op [ 8 ] ;  struct opcode high [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 struct group_dual {  struct opcode mod012 [ 8 ] ;  struct opcode mod3 [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 const struct mode_dual cocci_id@p ;
...
position p;
@@
 enum x86_transfer_type { X86_TRANSFER_NONE , X86_TRANSFER_CALL_JMP , X86_TRANSFER_RET , X86_TRANSFER_TASK_SWITCH , } cocci_id@p ;
