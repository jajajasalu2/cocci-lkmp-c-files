...
position p;
@@
 struct ath6kl_dbglog_buf cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ ATH6KL_KEY_SEQ_LEN ] ;
...
position p;
@@
 struct ath6kl_cookie * cocci_id@p ;
...
position p;
@@
 struct tkip_ccmp_stats * cocci_id@p ;
...
position p;
@@
 struct ath6kl_dbglog_hdr cocci_id@p ;
...
position p;
@@
 struct wmi_per_sta_stat cocci_id@p ;
...
position p;
@@
 struct wmi_ap_mode_stat * cocci_id@p ;
...
position p;
@@
 struct ath6kl_req_key * cocci_id@p ;
...
position p;
@@
 struct wmi_target_stats * cocci_id@p ;
