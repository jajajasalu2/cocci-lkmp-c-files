...
position p;
@@
 struct ich_reg_info * cocci_id@p ;
...
position p;
@@
 enum { DEVICE_INTEL , DEVICE_INTEL_ICH4 , DEVICE_SIS , DEVICE_ALI , DEVICE_NFORCE , } cocci_id@p ;
...
position p;
@@
 struct ich_reg_info {  unsigned int int_sta_mask ;  unsigned int offset ; } cocci_id@p ;
...
position p;
@@
 struct ich_reg_info cocci_id@p [ 4 ] ;
...
position p;
@@
 struct ich_pcm_table {  char * suffix ;  const struct snd_pcm_ops * playback_ops ;  const struct snd_pcm_ops * capture_ops ;  size_t prealloc_size ;  size_t prealloc_max_size ;  int ac97_idx ; } cocci_id@p ;
...
position p;
@@
 struct ich_reg_info cocci_id@p [ 6 ] ;
...
position p;
@@
 const struct ac97_quirk cocci_id@p [ ] ;
...
position p;
@@
 enum { ICHD_PCMIN , ICHD_PCMOUT , ICHD_MIC , ICHD_MIC2 , ICHD_PCM2IN , ICHD_SPBAR , ICHD_LAST = ICHD_SPBAR , } cocci_id@p ;
...
typedef __le32;
@@
 struct ichdev {  unsigned int ichd ;  unsigned long reg_offset ;  __le32 * bdbar ;  unsigned int bdbar_addr ;  struct snd_pcm_substream * substream ;  unsigned int physbuf ;  unsigned int size ;  unsigned int fragsize ;  unsigned int fragsize1 ;  unsigned int position ;  unsigned int pos_shift ;  unsigned int last_pos ;  int frags ;  int lvi ;  int lvi_frag ;  int civ ;  int ack ;  int ack_reload ;  unsigned int ack_bit ;  unsigned int roff_sr ;  unsigned int roff_picb ;  unsigned int int_sta_mask ;  unsigned int ali_slot ;  struct ac97_pcm * pcm ;  int pcm_open_flag ;  unsigned int suspended : 1 ; } cocci_id@p ;
...
position p;
@@
 enum { ALID_PCMIN , ALID_PCMOUT , ALID_MIC , ALID_AC97SPDIFOUT , ALID_SPDIFIN , ALID_SPDIFOUT , ALID_LAST = ALID_SPDIFOUT , } cocci_id@p ;
...
position p;
@@
 struct shortname_table * cocci_id@p ;
...
position p;
@@
 enum { ICH_REG_ ## name ## _BDBAR = base + 0x0 , ICH_REG_ ## name ## _CIV = base + 0x04 , ICH_REG_ ## name ## _LVI = base + 0x05 , ICH_REG_ ## name ## _SR = base + 0x06 , ICH_REG_ ## name ## _PICB = base + 0x08 , ICH_REG_ ## name ## _PIV = base + 0x0a , ICH_REG_ ## name ## _CR = base + 0x0b , } cocci_id@p ;
...
position p;
@@
 enum { NVD_PCMIN , NVD_PCMOUT , NVD_MIC , NVD_SPBAR , NVD_LAST = NVD_SPBAR , } cocci_id@p ;
...
position p;
@@
 struct shortname_table {  unsigned int id ;  const char * s ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct ac97_pcm cocci_id@p [ ] ;
...
position p;
@@
 struct ich_pcm_table * cocci_id@p ;
...
position p;
@@
 struct snd_pci_quirk cocci_id@p [ ] ;
