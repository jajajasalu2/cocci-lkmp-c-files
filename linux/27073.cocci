...
position p;
@@
 struct xchk_xattr {  struct xfs_attr_list_context context ;  struct xfs_scrub * sc ; } cocci_id@p ;
...
position p;
@@
 struct xchk_xattr_buf * cocci_id@p ;
...
position p;
@@
 struct xfs_attr3_leafblock * cocci_id@p ;
