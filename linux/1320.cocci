...
typedef u32;
@@
 struct mxs_phy {  struct usb_phy phy ;  struct clk * clk ;  const struct mxs_phy_data * data ;  struct regmap * regmap_anatop ;  int port_id ;  u32 tx_reg_set ;  u32 tx_reg_mask ; } cocci_id@p ;
...
position p;
@@
 enum usb_charger_type cocci_id@p ;
...
position p;
@@
 struct mxs_phy_data {  unsigned int flags ; } cocci_id@p ;
...
position p;
@@
 const struct mxs_phy_data cocci_id@p ;
