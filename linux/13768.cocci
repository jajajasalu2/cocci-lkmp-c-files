...
position p;
@@
 const struct ths7303_platform_data * cocci_id@p ;
...
position p;
@@
 struct ths7303_state {  struct v4l2_subdev sd ;  const struct ths7303_platform_data * pdata ;  struct v4l2_bt_timings bt ;  int std_id ;  int stream_on ; } cocci_id@p ;
...
position p;
@@
 enum ths7303_filter_mode { THS7303_FILTER_MODE_480I_576I , THS7303_FILTER_MODE_480P_576P , THS7303_FILTER_MODE_720P_1080I , THS7303_FILTER_MODE_1080P , THS7303_FILTER_MODE_DISABLE , } cocci_id@p ;
...
position p;
@@
 enum ths7303_filter_mode cocci_id@p ;
...
position p;
@@
 struct ths7303_state * cocci_id@p ;
