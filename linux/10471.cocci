...
position p;
@@
 struct radeon_fence_driver * cocci_id@p ;
...
position p;
@@
 struct radeon_wait_cb cocci_id@p ;
...
typedef uint64_t;
@@
 uint64_t cocci_id@p [ RADEON_NUM_RINGS ] ;
...
position p;
@@
 struct radeon_wait_cb {  struct dma_fence_cb base ;  struct task_struct * task ; } cocci_id@p ;
