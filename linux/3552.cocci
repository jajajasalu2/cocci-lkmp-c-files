...
position p;
@@
 void cocci_id@p ( struct mxcmci_host * host , unsigned int stat ) ;
...
position p;
@@
 void cocci_id@p ( struct mxcmci_host * host , unsigned int clk_ios ) ;
...
position p;
@@
 enum mxcmci_type { IMX21_MMC , IMX31_MMC , MPC512X_MMC , } cocci_id@p ;
