...
position p;
@@
 struct acpi_madt_generic_msi_frame * cocci_id@p ;
...
typedef u32;
@@
 struct v2m_data {  struct list_head entry ;  struct fwnode_handle * fwnode ;  struct resource res ;  void __iomem * base ;  u32 spi_start ;  u32 nr_spis ;  u32 spi_offset ;  unsigned long * bm ;  u32 flags ; } cocci_id@p ;
