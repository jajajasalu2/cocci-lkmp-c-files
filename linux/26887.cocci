...
position p;
@@
 const struct yfs_xdr_YFSFid * cocci_id@p ;
...
position p;
@@
 struct yfs_xdr_YFSVolSync cocci_id@p ;
...
position p;
@@
 const struct afs_call_type cocci_id@p ;
...
position p;
@@
 struct yfs_xdr_YFSCallBack * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef afs_lock_type_t;
@@
 afs_lock_type_t cocci_id@p ;
...
position p;
@@
 const struct yfs_xdr_u64 cocci_id@p ;
...
position p;
@@
 const struct afs_acl * cocci_id@p ;
...
position p;
@@
 struct yfs_xdr_YFSFetchStatus cocci_id@p ;
...
position p;
@@
 struct afs_file_status * cocci_id@p ;
...
position p;
@@
 struct yfs_xdr_YFSStoreStatus cocci_id@p ;
...
position p;
@@
 struct yfs_xdr_YFSFid * cocci_id@p ;
...
position p;
@@
 const struct yfs_xdr_YFSFetchVolumeStatus * cocci_id@p ;
...
position p;
@@
 struct yfs_xdr_RPCFlags cocci_id@p ;
...
position p;
@@
 const struct yfs_xdr_YFSFetchStatus * cocci_id@p ;
...
position p;
@@
 struct afs_callback * cocci_id@p ;
...
position p;
@@
 struct yfs_xdr_YFSFetchVolumeStatus cocci_id@p ;
...
position p;
@@
 struct afs_volume_status * cocci_id@p ;
...
position p;
@@
 const struct afs_fid cocci_id@p ;
