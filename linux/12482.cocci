...
position p;
@@
 struct sun4i_backend * cocci_id@p ;
...
position p;
@@
 const struct sunxi_engine_ops cocci_id@p ;
...
position p;
@@
 struct sunxi_engine * cocci_id@p ;
...
typedef bool;
@@
 struct sun4i_backend_quirks {  bool needs_output_muxing ;  bool supports_lowest_plane_alpha ; } cocci_id@p ;
...
position p;
@@
 struct sun4i_frontend * cocci_id@p ;
...
position p;
@@
 struct sun4i_layer_state * cocci_id@p ;
...
position p;
@@
 const struct sun4i_backend_quirks * cocci_id@p ;
...
position p;
@@
 struct drm_plane_state * cocci_id@p [ SUN4I_BACKEND_NUM_LAYERS ] ;
