...
position p;
@@
 struct tsens_irq_data * cocci_id@p ;
...
typedef u32;
@@
 struct tsens_irq_data {  u32 up_viol ;  int up_thresh ;  u32 up_irq_mask ;  u32 up_irq_clear ;  u32 low_viol ;  int low_thresh ;  u32 low_irq_mask ;  u32 low_irq_clear ; } cocci_id@p ;
...
position p;
@@
 enum tsens_irq_type cocci_id@p ;
...
position p;
@@
 struct tsens_sensor * cocci_id@p ;
...
position p;
@@
 const struct tsens_sensor * cocci_id@p ;
