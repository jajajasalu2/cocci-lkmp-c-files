...
position p;
@@
 struct dpu_rm_hw_blk * * cocci_id@p ;
...
position p;
@@
 enum dpu_hw_blk_type cocci_id@p ;
...
typedef uint32_t;
@@
 struct dpu_rm_hw_blk {  struct list_head list ;  uint32_t id ;  uint32_t enc_id ;  struct dpu_hw_blk * hw ; } cocci_id@p ;
...
position p;
@@
 const struct dpu_hw_ctl * cocci_id@p ;
...
position p;
@@
 const struct dpu_lm_cfg * cocci_id@p ;
...
position p;
@@
 const struct msm_display_topology * cocci_id@p ;
...
position p;
@@
 struct dpu_rm_requirements * cocci_id@p ;
...
position p;
@@
 struct dpu_rm_hw_blk * cocci_id@p [ MAX_BLOCKS ] ;
...
position p;
@@
 struct dpu_rm_requirements {  struct msm_display_topology topology ;  struct dpu_encoder_hw_resources hw_res ; } cocci_id@p ;
