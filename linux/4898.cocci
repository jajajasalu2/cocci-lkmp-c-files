...
position p;
@@
 struct mlx5_frag_buf * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_cq_buf cocci_id@p ;
...
position p;
@@
 enum { MLX5_GRH_IN_BUFFER = 1 , MLX5_GRH_IN_CQE = 2 , } cocci_id@p ;
...
position p;
@@
 enum { MLX5_CQE_RES_FORMAT_HASH = 0 , MLX5_CQE_RES_FORMAT_CSUM = 1 , MLX5_CQE_RES_FORMAT_CSUM_STRIDX = 3 , } cocci_id@p ;
...
position p;
@@
 struct mlx5_sig_err_cqe * cocci_id@p ;
...
position p;
@@
 struct mlx5_err_cqe * cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_create_cq cocci_id@p ;
...
position p;
@@
 struct mlx5_ib_resize_cq cocci_id@p ;
