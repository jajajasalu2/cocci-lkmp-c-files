...
position p;
@@
 struct xenon_emmc_phy_regs * cocci_id@p ;
...
position p;
@@
 struct xenon_emmc_phy_params * cocci_id@p ;
...
typedef u8,bool;
@@
 struct xenon_emmc_phy_params {  bool slow_mode ;  u8 znr ;  u8 zpr ;  u8 nr_tun_times ;  u8 tun_step_divider ;  struct soc_pad_ctrl pad_ctrl ; } cocci_id@p ;
...
position p;
@@
 enum soc_pad_ctrl_type { SOC_PAD_SD , SOC_PAD_FIXED_1_8V , } cocci_id@p ;
...
typedef u32,u16;
@@
 struct xenon_emmc_phy_regs {  u16 timing_adj ;  u16 func_ctrl ;  u16 pad_ctrl ;  u16 pad_ctrl2 ;  u16 dll_ctrl ;  u16 logic_timing_adj ;  u32 dll_update ;  u32 logic_timing_val ; } cocci_id@p ;
...
position p;
@@
 enum xenon_phy_type_enum { EMMC_5_0_PHY , EMMC_5_1_PHY , NR_PHY_TYPES , } cocci_id@p ;
