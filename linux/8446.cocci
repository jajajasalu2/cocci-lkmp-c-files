...
typedef dma_addr_t;
@@
 struct myri10ge_rx_done {  struct mcp_slot * entry ;  dma_addr_t bus ;  int cnt ;  int idx ; } cocci_id@p ;
...
position p;
@@
 struct mcp_gen_header cocci_id@p ;
...
position p;
@@
 const struct myri10ge_slice_netstats * cocci_id@p ;
...
position p;
@@
 struct mcp_kreq_ether_send cocci_id@p ;
...
position p;
@@
 struct mcp_irq_data * cocci_id@p ;
...
position p;
@@
 const struct myri10ge_priv * cocci_id@p ;
...
position p;
@@
 struct myri10ge_slice_state cocci_id@p ;
...
position p;
@@
 struct myri10ge_rx_buffer_state * cocci_id@p ;
...
position p;
@@
 struct myri10ge_rx_done * cocci_id@p ;
...
position p;
@@
 struct myri10ge_priv cocci_id@p ;
...
typedef u32;
@@
 struct myri10ge_cmd {  u32 data0 ;  u32 data1 ;  u32 data2 ; } cocci_id@p ;
...
typedef __be32;
@@
 struct myri10ge_tx_buf {  struct mcp_kreq_ether_send __iomem * lanai ;  __be32 __iomem * send_go ;  __be32 __iomem * send_stop ;  struct mcp_kreq_ether_send * req_list ;  char * req_bytes ;  struct myri10ge_tx_buffer_state * info ;  int mask ;  int req ____cacheline_aligned ;  int pkt_start ;  int stop_queue ;  int linearized ;  int done ____cacheline_aligned ;  int pkt_done ;  int wake_queue ;  int queue_active ; } cocci_id@p ;
...
position p;
@@
 struct mcp_cmd_response * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct myri10ge_rx_buf {  struct mcp_kreq_ether_recv __iomem * lanai ;  struct mcp_kreq_ether_recv * shadow ;  struct myri10ge_rx_buffer_state * info ;  struct page * page ;  dma_addr_t bus ;  int page_offset ;  int cnt ;  int fill_cnt ;  int alloc_fail ;  int mask ;  int watchdog_needed ; } cocci_id@p ;
...
position p;
@@
 struct mcp_kreq_ether_recv * cocci_id@p ;
...
position p;
@@
 struct myri10ge_tx_buf * cocci_id@p ;
...
position p;
@@
 struct myri10ge_cmd * cocci_id@p ;
...
position p;
@@
 struct mcp_dma_addr cocci_id@p ;
...
position p;
@@
 struct myri10ge_slice_netstats {  unsigned long rx_packets ;  unsigned long tx_packets ;  unsigned long rx_bytes ;  unsigned long tx_bytes ;  unsigned long rx_dropped ;  unsigned long tx_dropped ; } cocci_id@p ;
...
position p;
@@
 struct myri10ge_rx_buf * cocci_id@p ;
...
position p;
@@
 struct myri10ge_tx_buffer_state {  struct sk_buff * skb ;  int last ;  DEFINE_DMA_UNMAP_ADDR ( bus ) ;  DEFINE_DMA_UNMAP_LEN ( len ) ; } cocci_id@p ;
...
position p;
@@
 struct myri10ge_rx_buffer_state {  struct page * page ;  int page_offset ;  DEFINE_DMA_UNMAP_ADDR ( bus ) ;  DEFINE_DMA_UNMAP_LEN ( len ) ; } cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ MYRI10GE_MAX_BOARDS ] ;
