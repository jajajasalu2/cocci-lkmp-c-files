...
position p;
@@
 struct sst_platform_info cocci_id@p ;
...
position p;
@@
 const struct sst_res_info cocci_id@p ;
...
position p;
@@
 const struct sst_lib_dnld_info cocci_id@p ;
...
position p;
@@
 const struct sst_info cocci_id@p ;
...
position p;
@@
 const struct sst_ipc_info cocci_id@p ;
