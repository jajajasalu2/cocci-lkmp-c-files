...
@@
 struct fdp1_ctx {  struct v4l2_fh fh ;  struct fdp1_dev * fdp1 ;  struct v4l2_ctrl_handler hdl ;  unsigned int sequence ;  u8 num_processed ;  u32 translen ;  int aborting ;  enum fdp1_deint_mode deint_mode ;  unsigned int smsk_size ;  dma_addr_t smsk_addr [ 2 ] ;  void * smsk_cpu ;  unsigned char alpha ;  struct fdp1_q_data out_q ;  struct fdp1_q_data cap_q ;  struct list_head fields_queue ;  unsigned int buffers_queued ;  struct fdp1_field_buffer * previous ; } cocci_id@p ;
...
position p;
@@
 struct fdp1_field_buffer * cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct fdp1_fmt {  u32 fourcc ;  u8 bpp [ 3 ] ;  u8 num_planes ;  u8 hsub ;  u8 vsub ;  u8 fmt ;  bool swap_yc ;  bool swap_uv ;  u8 swap ;  u8 types ; } cocci_id@p ;
...
typedef spinlock_t;
@@
 struct fdp1_dev {  struct v4l2_device v4l2_dev ;  struct video_device vfd ;  struct mutex dev_mutex ;  spinlock_t irqlock ;  spinlock_t device_process_lock ;  void __iomem * regs ;  unsigned int irq ;  struct device * dev ;  struct fdp1_job jobs [ FDP1_NUMBER_JOBS ] ;  struct list_head free_job_list ;  struct list_head queued_job_list ;  struct list_head hw_job_list ;  unsigned int clk_rate ;  struct rcar_fcp_device * fcp ;  struct v4l2_m2m_dev * m2m_dev ; } cocci_id@p ;
...
position p;
@@
 const struct fdp1_fmt cocci_id@p [ ] ;
...
position p;
@@
 enum v4l2_ycbcr_encoding cocci_id@p ;
...
position p;
@@
 enum fdp1_deint_mode { FDP1_PROGRESSIVE = 0 , FDP1_ADAPT2D3D , FDP1_FIXED2D , FDP1_FIXED3D , FDP1_PREVFIELD , FDP1_NEXTFIELD , } cocci_id@p ;
...
position p;
@@
 struct fdp1_buffer {  struct v4l2_m2m_buffer m2m_buf ;  struct fdp1_field_buffer fields [ 2 ] ;  unsigned int num_fields ; } cocci_id@p ;
...
position p;
@@
 enum v4l2_quantization cocci_id@p ;
...
position p;
@@
 struct fdp1_job {  struct fdp1_field_buffer * previous ;  struct fdp1_field_buffer * active ;  struct fdp1_field_buffer * next ;  struct fdp1_field_buffer * dst ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct v4l2_m2m_ctx * cocci_id@p ;
...
position p;
@@
 struct fdp1_q_data {  const struct fdp1_fmt * fmt ;  struct v4l2_pix_format_mplane format ;  unsigned int vsize ;  unsigned int stride_y ;  unsigned int stride_c ; } cocci_id@p ;
...
@@
 struct fdp1_field_buffer {  struct vb2_v4l2_buffer * vb ;  dma_addr_t addrs [ 3 ] ;  enum v4l2_field field ;  bool last_field ;  struct list_head list ; } cocci_id@p ;
