...
position p;
@@
 struct sh_cmt_channel * cocci_id@p ;
...
position p;
@@
 enum sh_cmt_model { SH_CMT_16BIT , SH_CMT_32BIT , SH_CMT_48BIT , SH_CMT0_RCAR_GEN2 , SH_CMT1_RCAR_GEN2 , } cocci_id@p ;
...
@@
 struct sh_cmt_device {  struct platform_device * pdev ;  const struct sh_cmt_info * info ;  void __iomem * mapbase ;  struct clk * clk ;  unsigned long rate ;  raw_spinlock_t lock ;  struct sh_cmt_channel * channels ;  unsigned int num_channels ;  unsigned int hw_channels ;  bool has_clockevent ;  bool has_clocksource ; } cocci_id@p ;
...
position p;
@@
 const struct sh_cmt_info cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef u64,bool,u32,raw_spinlock_t;
@@
 struct sh_cmt_channel {  struct sh_cmt_device * cmt ;  unsigned int index ;  unsigned int hwidx ;  void __iomem * iostart ;  void __iomem * ioctrl ;  unsigned int timer_bit ;  unsigned long flags ;  u32 match_value ;  u32 next_match_value ;  u32 max_match_value ;  raw_spinlock_t lock ;  struct clock_event_device ced ;  struct clocksource cs ;  u64 total_cycles ;  bool cs_enabled ; } cocci_id@p ;
...
position p;
@@
 struct sh_cmt_device cocci_id@p ;
