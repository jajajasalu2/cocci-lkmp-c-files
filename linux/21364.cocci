...
position p;
@@
 struct expevt_lookup cocci_id@p ;
...
position p;
@@
 struct expevt_lookup {  unsigned short protection_flags [ 8 ] ;  unsigned char is_text_access [ 8 ] ;  unsigned char is_write_access [ 8 ] ; } cocci_id@p ;
