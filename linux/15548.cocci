...
position p;
@@
 enum { AD7192_SYSCALIB_ZERO_SCALE , AD7192_SYSCALIB_FULL_SCALE , } cocci_id@p ;
...
typedef u8,u32,u16;
@@
 struct ad7192_state {  struct regulator * avdd ;  struct regulator * dvdd ;  struct clk * mclk ;  u16 int_vref_mv ;  u32 fclk ;  u32 f_order ;  u32 mode ;  u32 conf ;  u32 scale_avail [ 8 ] [ 2 ] ;  u8 gpocon ;  u8 devid ;  u8 clock_sel ;  struct mutex lock ;  u8 syscalib_mode [ 8 ] ;  struct ad_sigma_delta sd ; } cocci_id@p ;
...
position p;
@@
 const struct ad_sd_calib_data cocci_id@p [ 8 ] ;
...
position p;
@@
 struct ad7192_state * cocci_id@p ;
