...
position p;
@@
 struct fat_cache_id {  unsigned int id ;  int nr_contig ;  int fcluster ;  int dcluster ; } cocci_id@p ;
...
position p;
@@
 struct fat_cache {  struct list_head cache_list ;  int nr_contig ;  int fcluster ;  int dcluster ; } cocci_id@p ;
...
position p;
@@
 struct fat_cache_id cocci_id@p ;
