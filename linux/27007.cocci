...
position p;
@@
 int cocci_id@p ( struct xfs_inode * , struct xfs_buf * ) ;
...
position p;
@@
 struct xfs_icdinode * cocci_id@p ;
...
typedef xfs_agino_t;
@@
 struct xfs_iunlink {  struct rhash_head iu_rhash_head ;  xfs_agino_t iu_agino ;  xfs_agino_t iu_next_unlinked ; } cocci_id@p ;
...
position p;
@@
 struct xfs_trans_res * cocci_id@p ;
...
position p;
@@
 struct xfs_icluster cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct xfs_trans * , struct xfs_inode * ) ;
...
symbol cocci_id;
position p;
typedef xfs_ufsize_t;
@@
 xfs_ufsize_t cocci_id@p ;
...
position p;
@@
 struct xfs_inode * cocci_id@p [ __XFS_SORT_INODES ] ;
...
position p;
@@
 const struct xfs_iunlink * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef xfs_inode_log_item_t;
@@
 xfs_inode_log_item_t * cocci_id@p ;
