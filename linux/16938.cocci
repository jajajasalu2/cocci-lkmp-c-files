...
position p;
@@
 struct mc13783_ts_priv cocci_id@p ;
...
position p;
@@
 struct mc13783_ts_priv {  struct input_dev * idev ;  struct mc13xxx * mc13xxx ;  struct delayed_work work ;  unsigned int sample [ 4 ] ;  struct mc13xxx_ts_platform_data * touch ; } cocci_id@p ;
