...
position p;
@@
 const struct slave_attribute cocci_id@p ;
...
position p;
@@
 struct slave_attribute {  struct attribute attr ;  ssize_t ( * show ) ( struct slave * , char * ) ; } cocci_id@p ;
...
position p;
@@
 struct slave_attribute * cocci_id@p ;
