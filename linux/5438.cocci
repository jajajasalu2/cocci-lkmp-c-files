...
position p;
@@
 const struct spi_ops * cocci_id@p ;
...
position p;
@@
 const struct rspi_plat_data * cocci_id@p ;
...
position p;
@@
 const struct rspi_data * cocci_id@p ;
...
position p;
@@
 const struct spi_transfer * cocci_id@p ;
...
position p;
@@
 const struct spi_message * cocci_id@p ;
