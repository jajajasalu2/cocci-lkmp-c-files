...
position p;
@@
 const struct ac97_id cocci_id@p [ ] ;
...
position p;
@@
 struct wm97xx_priv {  struct regmap * regmap ;  struct snd_ac97 * ac97 ;  struct device * dev ;  struct wm97xx_platform_data codec_pdata ; } cocci_id@p ;
...
position p;
@@
 struct ac97_codec_driver cocci_id@p ;
...
position p;
@@
 struct ac97_codec_device * cocci_id@p ;
