...
position p;
@@
 struct net_dev_context cocci_id@p ;
...
typedef bool;
@@
 struct net_dev_context {  struct most_interface * iface ;  bool is_mamac ;  struct net_device * dev ;  struct net_dev_channel rx ;  struct net_dev_channel tx ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct net_dev_channel * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct most_interface * iface , unsigned char link_stat , unsigned char * mac_addr ) ;
...
typedef bool;
@@
 struct net_dev_channel {  bool linked ;  int ch_id ; } cocci_id@p ;
