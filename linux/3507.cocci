...
position p;
@@
 struct uniphier_sd_priv {  struct tmio_mmc_data tmio_data ;  struct pinctrl * pinctrl ;  struct pinctrl_state * pinstate_default ;  struct pinctrl_state * pinstate_uhs ;  struct clk * clk ;  struct reset_control * rst ;  struct reset_control * rst_br ;  struct reset_control * rst_hw ;  struct dma_chan * chan ;  enum dma_data_direction dma_dir ;  unsigned long clk_rate ;  unsigned long caps ; } cocci_id@p ;
...
position p;
@@
 struct tmio_mmc_host * cocci_id@p ;
...
position p;
@@
 const struct tmio_mmc_dma_ops cocci_id@p ;
...
position p;
@@
 struct uniphier_sd_priv * cocci_id@p ;
