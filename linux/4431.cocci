...
position p;
@@
 struct agp_device_ids cocci_id@p [ ] ;
...
typedef u8;
@@
 struct _amd_irongate_private {  volatile u8 __iomem * registers ;  struct amd_page_map * * gatt_pages ;  int num_tables ; } cocci_id@p ;
...
position p;
@@
 struct amd_page_map * * cocci_id@p ;
...
position p;
@@
 struct amd_page_map {  unsigned long * real ;  unsigned long __iomem * remapped ; } cocci_id@p ;
