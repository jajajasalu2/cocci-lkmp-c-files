...
position p;
@@
 struct ths8200_state * cocci_id@p ;
...
@@
 struct ths8200_state {  struct v4l2_subdev sd ;  uint8_t chip_version ;  bool power_on ;  struct v4l2_dv_timings dv_timings ; } cocci_id@p ;
