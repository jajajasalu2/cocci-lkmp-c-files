...
position p;
@@
 void cocci_id@p ( struct rtc_device * rtc , struct rtc_timer * timer ) ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct rtc_device * r ) ;
...
position p;
@@
 int cocci_id@p ( struct rtc_device * rtc , struct rtc_timer * timer ) ;
...
position p;
@@
 enum { none , day , month , year , } cocci_id@p ;
