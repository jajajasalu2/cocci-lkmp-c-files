...
position p;
@@
 union cvmx_pci_cfg22 cocci_id@p ;
...
position p;
@@
 union cvmx_pci_ctl_status_2 cocci_id@p ;
...
position p;
@@
 union cvmx_pci_cfg56 cocci_id@p ;
...
position p;
@@
 union cvmx_pci_cfg16 cocci_id@p ;
...
position p;
@@
 union cvmx_npi_pci_int_arb_cfg cocci_id@p ;
...
position p;
@@
 union cvmx_pci_cfg19 cocci_id@p ;
...
@@
 union octeon_pci_address {  uint64_t u64 ;  struct {  uint64_t upper : 2 ;  uint64_t reserved : 13 ;  uint64_t io : 1 ;  uint64_t did : 5 ;  uint64_t subdid : 3 ;  uint64_t reserved2 : 4 ;  uint64_t endian_swap : 2 ;  uint64_t reserved3 : 10 ;  uint64_t bus : 8 ;  uint64_t dev : 5 ;  uint64_t func : 3 ;  uint64_t reg : 8 ; } s ; } cocci_id@p ;
...
position p;
@@
 union cvmx_npi_ctl_status cocci_id@p ;
...
typedef u8;
@@
 int ( * cocci_id@p ) ( const struct pci_dev * dev , u8 slot , u8 pin ) ;
...
position p;
@@
 enum octeon_dma_bar_type cocci_id@p ;
...
position p;
@@
 union cvmx_pci_bar1_indexx cocci_id@p ;
...
position p;
@@
 union cvmx_npi_mem_access_subidx cocci_id@p ;
...
position p;
@@
 union octeon_pci_address cocci_id@p ;
...
position p;
@@
 union cvmx_pci_cnt_reg cocci_id@p ;
...
position p;
@@
 union cvmx_pci_cfg01 cocci_id@p ;
