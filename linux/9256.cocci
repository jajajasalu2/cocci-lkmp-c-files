...
position p;
@@
 struct ieee80211_mcs_info cocci_id@p ;
...
position p;
@@
 struct mwifiex_uap_bss_param * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ MWIFIEX_TM_ATTR_MAX + 1 ] ;
...
typedef u8;
@@
 u8 cocci_id@p [ MWIFIEX_COALESCE_MAX_BYTESEQ + 1 ] ;
...
position p;
@@
 struct mwifiex_bss_info cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ MWIFIEX_TM_ATTR_MAX + 1 ] ;
...
position p;
@@
 struct mwifiex_ds_wakeup_reason cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ MWIFIEX_MEF_MAX_BYTESEQ + 1 ] ;
...
position p;
@@
 struct filt_field_param * cocci_id@p ;
...
position p;
@@
 struct mwifiex_txinfo * cocci_id@p ;
...
position p;
@@
 struct mwifiex_wep_key * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ IEEE80211_MAX_SSID_LEN + sizeof ( struct ieee_types_header ) ] ;
...
position p;
@@
 struct mwifiex_roc_cfg cocci_id@p ;
...
position p;
@@
 struct mwifiex_power_cfg cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_hs_cfg cocci_id@p ;
...
position p;
@@
 struct mwifiex_radar_params cocci_id@p ;
...
position p;
@@
 struct mwifiex_802_11d_domain_reg * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ MAX_BITMAP_RATES_SIZE ] ;
...
position p;
@@
 enum mwifiex_tm_attr { __MWIFIEX_TM_ATTR_INVALID = 0 , MWIFIEX_TM_ATTR_CMD = 1 , MWIFIEX_TM_ATTR_DATA = 2 , __MWIFIEX_TM_ATTR_AFTER_LAST , MWIFIEX_TM_ATTR_MAX = __MWIFIEX_TM_ATTR_AFTER_LAST - 1 , } cocci_id@p ;
...
position p;
@@
 enum mwifiex_tm_command { MWIFIEX_TM_CMD_HOSTCMD = 0 , } cocci_id@p ;
...
position p;
@@
 struct mwifiex_ds_misc_cmd * cocci_id@p ;
...
position p;
@@
 struct mwifiex_coalesce_rule * cocci_id@p ;
