...
position p;
@@
 struct acpi_rsconvert_info cocci_id@p [ 14 ] ;
...
position p;
@@
 struct acpi_rsconvert_info cocci_id@p [ 17 ] ;
...
position p;
@@
 struct acpi_rsconvert_info cocci_id@p [ 13 ] ;
...
position p;
@@
 struct acpi_rsconvert_info cocci_id@p [ 21 ] ;
...
position p;
@@
 struct acpi_rsconvert_info cocci_id@p [ 23 ] ;
...
position p;
@@
 struct acpi_rsconvert_info cocci_id@p [ 10 ] ;
...
position p;
@@
 struct acpi_rsconvert_info cocci_id@p [ 18 ] ;
