...
position p;
@@
 struct tx_sync_info cocci_id@p ;
...
position p;
@@
 enum mlx5e_ktls_sync_retval { MLX5E_KTLS_SYNC_DONE , MLX5E_KTLS_SYNC_FAIL , MLX5E_KTLS_SYNC_SKIP_NO_DATA , } cocci_id@p ;
...
position p;
@@
 struct mlx5e_sq_dma * cocci_id@p ;
...
position p;
@@
 struct mlx5e_ktls_offload_context_tx * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u64,s32,skb_frag_t;
@@
 struct tx_sync_info {  u64 rcd_sn ;  s32 sync_len ;  int nr_frags ;  skb_frag_t frags [ MAX_SKB_FRAGS ] ; } cocci_id@p ;
...
position p;
@@
 enum { MLX5E_STATIC_PARAMS_CONTEXT_TLS_1_2 = 0x2 , } cocci_id@p ;
...
position p;
@@
 enum mlx5e_ktls_sync_retval cocci_id@p ;
...
position p;
@@
 struct tls12_crypto_info_aes_gcm_128 * cocci_id@p ;
...
position p;
@@
 struct mlx5e_dump_wqe * cocci_id@p ;
...
position p;
@@
 struct tls_record_info * cocci_id@p ;
...
position p;
@@
 enum { MLX5E_ENCRYPTION_STANDARD_TLS = 0x1 , } cocci_id@p ;
...
position p;
@@
 struct tls_offload_context_tx * cocci_id@p ;
