...
position p;
@@
 struct rcar_sysc_area * cocci_id@p ;
...
position p;
@@
 const struct rcar_sysc_info * cocci_id@p ;
...
typedef u8,u16;
@@
 struct rcar_sysc_ch {  u16 chan_offs ;  u8 chan_bit ;  u8 isr_bit ; } cocci_id@p ;
...
position p;
@@
 struct rcar_sysc_pd {  struct generic_pm_domain genpd ;  struct rcar_sysc_ch ch ;  unsigned int flags ;  char name [ ] ; } cocci_id@p ;
...
position p;
@@
 const struct rcar_sysc_area * cocci_id@p ;
...
position p;
@@
 struct rcar_pm_domains * cocci_id@p ;
...
position p;
@@
 const struct rcar_sysc_ch * cocci_id@p ;
...
position p;
@@
 struct rcar_sysc_pd cocci_id@p ;
...
position p;
@@
 struct rcar_pm_domains {  struct genpd_onecell_data onecell_data ;  struct generic_pm_domain * domains [ RCAR_PD_ALWAYS_ON + 1 ] ; } cocci_id@p ;
