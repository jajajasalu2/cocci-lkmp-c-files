...
typedef u8;
@@
 void cocci_id@p ( u8 out [ ] , const u8 in [ ] , const u8 rk [ ] , int rounds , int blocks , u8 ctr [ ] , u8 final [ ] ) ;
...
typedef u8;
@@
 void ( * cocci_id@p ) ( u8 out [ ] , const u8 in [ ] , const u8 rk [ ] , int rounds , int blocks , u8 iv [ ] , int ) ;
...
position p;
@@
 struct aesbs_cbc_ctx {  struct aesbs_ctx key ;  struct crypto_cipher * enc_tfm ; } cocci_id@p ;
...
position p;
@@
 struct aesbs_xts_ctx {  struct aesbs_ctx key ;  struct crypto_cipher * cts_tfm ;  struct crypto_cipher * tweak_tfm ; } cocci_id@p ;
