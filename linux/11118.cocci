...
position p;
@@
 struct fbc_requested_compressed_size cocci_id@p ;
...
position p;
@@
 const struct compressor_funcs cocci_id@p ;
...
position p;
@@
 struct fbc_input_info cocci_id@p ;
...
position p;
@@
 struct dce110_compressor cocci_id@p ;
...
position p;
@@
 const struct dce110_compressor_reg_offsets cocci_id@p [ ] ;
