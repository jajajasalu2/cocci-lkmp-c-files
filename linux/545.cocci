...
position p;
@@
 struct authenc_request_ctx cocci_id@p ;
...
position p;
@@
 struct authenc_request_ctx {  struct scatterlist src [ 2 ] ;  struct scatterlist dst [ 2 ] ;  char tail [ ] ; } cocci_id@p ;
...
position p;
@@
 struct crypto_authenc_ctx {  struct crypto_ahash * auth ;  struct crypto_skcipher * enc ;  struct crypto_sync_skcipher * null ; } cocci_id@p ;
...
position p;
@@
 struct crypto_authenc_ctx * cocci_id@p ;
...
position p;
@@
 struct authenc_instance_ctx * cocci_id@p ;
...
position p;
@@
 struct authenc_instance_ctx {  struct crypto_ahash_spawn auth ;  struct crypto_skcipher_spawn enc ;  unsigned int reqoff ; } cocci_id@p ;
