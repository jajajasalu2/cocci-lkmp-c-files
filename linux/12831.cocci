...
position p;
@@
 struct devbus {  struct device * dev ;  void __iomem * base ;  unsigned long tick_ps ; } cocci_id@p ;
...
position p;
@@
 struct devbus_write_params * cocci_id@p ;
...
typedef u32;
@@
 struct devbus_read_params {  u32 bus_width ;  u32 badr_skew ;  u32 turn_off ;  u32 acc_first ;  u32 acc_next ;  u32 rd_setup ;  u32 rd_hold ; } cocci_id@p ;
...
typedef u32;
@@
 struct devbus_write_params {  u32 sync_enable ;  u32 wr_high ;  u32 wr_low ;  u32 ale_wr ; } cocci_id@p ;
...
position p;
@@
 struct devbus_read_params * cocci_id@p ;
