...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_CONNMARK_MAX + 1 ] ;
...
position p;
@@
 struct tcf_connmark_info cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_CONNMARK_MAX + 1 ] ;
