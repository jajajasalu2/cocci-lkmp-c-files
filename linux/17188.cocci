...
position p;
@@
 const struct fsl_msi_feature cocci_id@p ;
...
position p;
@@
 struct fsl_msi_cascade_data * cocci_id@p ;
...
typedef u32;
@@
 struct fsl_msi_feature {  u32 fsl_pic_ip ;  u32 msiir_offset ; } cocci_id@p ;
...
position p;
@@
 struct fsl_msi_cascade_data {  struct fsl_msi * msi_data ;  int index ;  int virq ; } cocci_id@p ;
