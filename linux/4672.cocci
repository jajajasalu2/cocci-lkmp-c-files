...
position p;
@@
 struct cxl_irq_ranges cocci_id@p ;
...
position p;
@@
 const struct cxl_backend_ops cocci_id@p ;
...
position p;
@@
 struct cxl_afu_guest * cocci_id@p ;
...
position p;
@@
 struct cxl_irq_info cocci_id@p ;
...
position p;
@@
 struct cxl_process_element_hcall * cocci_id@p ;
