...
position p;
@@
 struct sdhci_pltfm_host * cocci_id@p ;
...
typedef bool;
@@
 struct sdhci_arasan_soc_ctl_map {  struct sdhci_arasan_soc_ctl_field baseclkfreq ;  struct sdhci_arasan_soc_ctl_field clockmultiplier ;  bool hiword_update ; } cocci_id@p ;
...
position p;
@@
 struct sdhci_arasan_clk_data {  struct clk_hw sdcardclk_hw ;  struct clk * sdcardclk ;  struct clk_hw sampleclk_hw ;  struct clk * sampleclk ;  int clk_phase_in [ MMC_TIMING_MMC_HS400 + 1 ] ;  int clk_phase_out [ MMC_TIMING_MMC_HS400 + 1 ] ;  void ( * set_clk_delays ) ( struct sdhci_host * host ) ;  void * clk_of_data ; } cocci_id@p ;
...
position p;
@@
 struct sdhci_arasan_zynqmp_clk_data * cocci_id@p ;
...
typedef s16,u32,u16;
@@
 struct sdhci_arasan_soc_ctl_field {  u32 reg ;  u16 width ;  s16 shift ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ MMC_TIMING_MMC_HS400 + 1 ] ;
...
position p;
@@
 struct sdhci_arasan_clk_data cocci_id@p ;
...
position p;
@@
 const struct sdhci_arasan_soc_ctl_field * cocci_id@p ;
...
position p;
@@
 struct sdhci_arasan_data cocci_id@p ;
...
position p;
@@
 const struct cqhci_host_ops cocci_id@p ;
...
position p;
@@
 const struct sdhci_arasan_of_data * cocci_id@p ;
...
position p;
@@
 struct sdhci_arasan_of_data {  const struct sdhci_arasan_soc_ctl_map * soc_ctl_map ;  const struct sdhci_pltfm_data * pdata ; } cocci_id@p ;
...
position p;
@@
 const struct sdhci_arasan_soc_ctl_map * cocci_id@p ;
...
position p;
@@
 struct sdhci_arasan_of_data cocci_id@p ;
...
position p;
@@
 const struct sdhci_ops cocci_id@p ;
...
position p;
@@
 struct sdhci_arasan_zynqmp_clk_data {  const struct zynqmp_eemi_ops * eemi_ops ; } cocci_id@p ;
...
position p;
@@
 const struct sdhci_pltfm_data cocci_id@p ;
...
position p;
@@
 const struct zynqmp_eemi_ops * cocci_id@p ;
