...
position p;
@@
 const struct efm32_uart_pdata * cocci_id@p ;
...
position p;
@@
 struct efm32_uart_port {  struct uart_port port ;  unsigned int txirq ;  struct clk * clk ;  struct efm32_uart_pdata pdata ; } cocci_id@p ;
...
position p;
@@
 struct efm32_uart_port * cocci_id@p [ 5 ] ;
...
position p;
@@
 struct efm32_uart_port * cocci_id@p ;
