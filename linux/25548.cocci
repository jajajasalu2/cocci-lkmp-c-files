...
position p;
@@
 struct pager_config cocci_id@p ;
...
position p;
@@
 enum libperf_print_level cocci_id@p ;
...
position p;
@@
 struct cmd_struct {  const char * cmd ;  int ( * fn ) ( int , const char * * ) ;  int option ; } cocci_id@p ;
...
position p;
@@
 struct pager_config {  const char * cmd ;  int val ; } cocci_id@p ;
