...
position p;
@@
 const struct tda10023_config * cocci_id@p ;
...
typedef u8,u32;
@@
 struct tda10023_state {  struct i2c_adapter * i2c ;  const struct tda10023_config * config ;  struct dvb_frontend frontend ;  u8 pwm ;  u8 reg0 ;  u32 xtal ;  u8 pll_m ;  u8 pll_p ;  u8 pll_n ;  u32 sysclk ; } cocci_id@p ;
...
position p;
@@
 const struct qam_params cocci_id@p [ ] ;
...
position p;
@@
 struct tda10023_state cocci_id@p ;
