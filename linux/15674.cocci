...
position p;
@@
 struct gb_spi_transfer_request cocci_id@p ;
...
position p;
@@
 struct gb_spi_device_config_response cocci_id@p ;
...
position p;
@@
 struct gb_spi_device_config_request cocci_id@p ;
...
position p;
@@
 struct gb_spi_transfer_response * cocci_id@p ;
...
position p;
@@
 struct gb_spi_master_config_response cocci_id@p ;
...
position p;
@@
 struct gb_spi_transfer * cocci_id@p ;
