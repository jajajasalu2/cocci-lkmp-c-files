...
typedef u8;
@@
 struct ab8500_ext_regulator_info {  struct device * dev ;  struct regulator_desc desc ;  struct ab8500_ext_regulator_cfg * cfg ;  u8 update_bank ;  u8 update_reg ;  u8 update_mask ;  u8 update_val ;  u8 update_val_hp ;  u8 update_val_lp ;  u8 update_val_hw ; } cocci_id@p ;
...
position p;
@@
 struct ab8500_ext_regulator_cfg * cocci_id@p ;
...
position p;
@@
 struct ab8500_ext_regulator_info cocci_id@p [ AB8500_NUM_EXT_REGULATORS ] ;
...
position p;
@@
 struct ab8500_regulator_reg_init cocci_id@p [ ] ;
...
position p;
@@
 struct ab8500_regulator_platform_data cocci_id@p ;
...
position p;
@@
 struct regulator_init_data cocci_id@p [ AB8500_NUM_REGULATORS ] ;
...
position p;
@@
 struct ab8500_ext_regulator_info * cocci_id@p ;
