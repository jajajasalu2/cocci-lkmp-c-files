...
position p;
@@
 struct crat_subtype_computeunit cocci_id@p ;
...
position p;
@@
 struct crat_subtype_memory * cocci_id@p ;
...
position p;
@@
 struct crat_subtype_cache * cocci_id@p ;
...
position p;
@@
 struct crat_subtype_iolink * cocci_id@p ;
...
position p;
@@
 struct crat_subtype_generic cocci_id@p ;
...
position p;
@@
 struct kfd_gpu_cache_info cocci_id@p [ ] ;
...
position p;
@@
 struct kfd_mem_properties * cocci_id@p ;
...
position p;
@@
 struct kfd_topology_device * cocci_id@p ;
...
typedef uint32_t;
@@
 struct kfd_gpu_cache_info {  uint32_t cache_size ;  uint32_t cache_level ;  uint32_t flags ;  uint32_t num_cu_shared ; } cocci_id@p ;
...
position p;
@@
 struct kfd_iolink_properties * cocci_id@p ;
...
position p;
@@
 typeof ( sub_type_hdr ) cocci_id@p ;
...
position p;
@@
 const struct kfd_local_mem_info * cocci_id@p ;
...
position p;
@@
 struct kfd_cache_properties * cocci_id@p ;
