...
position p;
@@
 enum scis_sds_remote_node_context_states cocci_id@p ;
...
position p;
@@
 enum sci_remote_node_suspension_reasons cocci_id@p ;
...
position p;
@@
 struct sci_remote_node_context cocci_id@p ;
...
position p;
@@
 enum sci_remote_node_context_destination_state cocci_id@p ;
...
position p;
@@
 scics_sds_remote_node_context_callback cocci_id@p ;
