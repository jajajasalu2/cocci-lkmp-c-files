...
position p;
@@
 enum wiimod_nunchuk_keys { WIIMOD_NUNCHUK_KEY_C , WIIMOD_NUNCHUK_KEY_Z , WIIMOD_NUNCHUK_KEY_NUM , } cocci_id@p ;
...
position p;
@@
 const struct wiimod_ops * cocci_id@p [ WIIMOD_NUM ] ;
...
position p;
@@
 enum wiimod_guitar_keys { WIIMOD_GUITAR_KEY_G , WIIMOD_GUITAR_KEY_R , WIIMOD_GUITAR_KEY_Y , WIIMOD_GUITAR_KEY_B , WIIMOD_GUITAR_KEY_O , WIIMOD_GUITAR_KEY_UP , WIIMOD_GUITAR_KEY_DOWN , WIIMOD_GUITAR_KEY_PLUS , WIIMOD_GUITAR_KEY_MINUS , WIIMOD_GUITAR_KEY_NUM , } cocci_id@p ;
...
position p;
@@
 struct wiimote_data * cocci_id@p ;
...
position p;
@@
 const struct wiimod_ops cocci_id@p [ 4 ] ;
...
position p;
@@
 const struct wiimod_ops * cocci_id@p [ WIIMOTE_EXT_NUM ] ;
...
position p;
@@
 struct wiimote_state * cocci_id@p ;
...
position p;
@@
 const struct wiimod_ops cocci_id@p ;
