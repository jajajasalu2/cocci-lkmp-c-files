...
position p;
@@
 enum pp_smu_nv_clock_id cocci_id@p ;
...
position p;
@@
 struct dm_pp_power_level_change_request * cocci_id@p ;
...
position p;
@@
 struct dm_pp_clock_range_for_dmif_wm_set_soc15 * cocci_id@p ;
...
position p;
@@
 enum dm_pp_clock_type cocci_id@p ;
...
position p;
@@
 const struct pp_clock_levels_with_latency * cocci_id@p ;
...
position p;
@@
 struct dm_pp_clock_for_voltage_req * cocci_id@p ;
...
position p;
@@
 const struct dc_context * cocci_id@p ;
...
position p;
@@
 const struct dm_pp_display_configuration * cocci_id@p ;
...
position p;
@@
 const struct dm_pp_single_disp_config * cocci_id@p ;
...
position p;
@@
 struct dm_pp_static_clock_info * cocci_id@p ;
...
position p;
@@
 struct dm_pp_clock_levels_with_voltage * cocci_id@p ;
...
position p;
@@
 enum PP_DAL_POWERLEVEL cocci_id@p ;
...
position p;
@@
 struct dm_pp_clock_range_for_mcif_wm_set_soc15 * cocci_id@p ;
...
position p;
@@
 enum dm_pp_clocks_state cocci_id@p ;
...
position p;
@@
 const struct pp_clock_levels_with_voltage * cocci_id@p ;
...
position p;
@@
 const struct amd_pp_clocks * cocci_id@p ;
