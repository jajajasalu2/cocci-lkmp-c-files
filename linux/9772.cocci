...
position p;
@@
 struct il_rx_phy_res cocci_id@p ;
...
position p;
@@
 struct il4965_firmware_pieces * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( const struct firmware * ucode_raw , void * context ) ;
...
position p;
@@
 struct il_cmd_header cocci_id@p ;
...
position p;
@@
 const struct il_sensitivity_ranges cocci_id@p ;
...
position p;
@@
 struct il4965_beacon_notif * cocci_id@p ;
...
position p;
@@
 struct il_station_priv * cocci_id@p ;
...
position p;
@@
 struct il_alive_resp * cocci_id@p ;
...
position p;
@@
 struct il_tx_beacon_cmd * cocci_id@p ;
...
position p;
@@
 struct il_ht_config * cocci_id@p ;
...
position p;
@@
 struct il4965_rx_non_cfg_phy * cocci_id@p ;
...
position p;
@@
 struct il_ucode_header * cocci_id@p ;
...
position p;
@@
 struct il_init_alive_resp cocci_id@p ;
...
position p;
@@
 struct il_notif_stats cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct il_priv * il ) ;
...
position p;
@@
 struct il_compressed_ba_resp * cocci_id@p ;
...
position p;
@@
 struct il_link_quality_cmd * cocci_id@p ;
...
typedef u32;
@@
 int cocci_id@p ( struct il_priv * il , u32 max_probe_length ) ;
...
position p;
@@
 struct il_mod_params cocci_id@p ;
...
position p;
@@
 struct il_rx_mpdu_res_start * cocci_id@p ;
...
position p;
@@
 struct agg_tx_status * cocci_id@p ;
...
position p;
@@
 struct il_addsta_cmd cocci_id@p ;
...
position p;
@@
 struct il_missed_beacon_notif * cocci_id@p ;
...
position p;
@@
 struct stats_rx_non_phy * cocci_id@p ;
...
position p;
@@
 struct il4965_scd_bc_tbl cocci_id@p ;
...
position p;
@@
 struct il4965_keyinfo cocci_id@p ;
...
position p;
@@
 struct il_ct_kill_config cocci_id@p ;
...
typedef u8;
@@
 struct {  char * name ;  u8 num ; } cocci_id@p [ ] ;
...
position p;
@@
 struct il_scan_channel * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ sizeof ( struct il_wep_cmd ) + sizeof ( struct il_wep_key ) * WEP_KEYS_MAX ] ;
...
position p;
@@
 struct il_device_cmd * cocci_id@p ;
...
position p;
@@
 struct stats_general_common * cocci_id@p ;
...
position p;
@@
 struct il4965_tx_resp * cocci_id@p ;
...
position p;
@@
 struct il_rb_status cocci_id@p ;
...
position p;
@@
 const struct il_channel_info * cocci_id@p ;
