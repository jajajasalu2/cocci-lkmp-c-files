...
position p;
@@
 struct loopback_dev cocci_id@p ;
...
typedef bool,u32;
@@
 struct loopback_dev {  struct rc_dev * dev ;  u32 txmask ;  u32 txcarrier ;  u32 txduty ;  bool idle ;  bool learning ;  bool carrierreport ;  u32 rxcarriermin ;  u32 rxcarriermax ; } cocci_id@p ;
