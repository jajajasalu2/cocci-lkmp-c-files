...
position p;
@@
 struct swnode {  int id ;  struct kobject kobj ;  struct fwnode_handle fwnode ;  const struct software_node * node ;  struct ida child_ids ;  struct list_head entry ;  struct list_head children ;  struct swnode * parent ;  unsigned int allocated : 1 ; } cocci_id@p ;
...
position p;
@@
 const struct swnode * cocci_id@p ;
...
position p;
@@
 struct software_node * cocci_id@p ;
...
position p;
@@
 const struct software_node_reference * cocci_id@p ;
