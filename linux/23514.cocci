...
position p;
@@
 struct snd_soc_dpcm * cocci_id@p ;
...
position p;
@@
 struct snd_soc_codec_conf cocci_id@p [ ] ;
...
position p;
@@
 struct kbl_rt5663_private {  struct snd_soc_jack kabylake_headset ;  struct list_head hdmi_pcm_list ;  struct clk * mclk ;  struct clk * sclk ; } cocci_id@p ;
...
position p;
@@
 struct kbl_hdmi_pcm {  struct list_head head ;  struct snd_soc_dai * codec_dai ;  int device ; } cocci_id@p ;
...
position p;
@@
 struct snd_soc_jack cocci_id@p [ 3 ] ;
...
position p;
@@
 struct snd_pcm_hw_constraint_list cocci_id@p ;
...
position p;
@@
 struct kbl_rt5663_private * cocci_id@p ;
...
position p;
@@
 enum { KBL_DPCM_AUDIO_5663_PB = 0 , KBL_DPCM_AUDIO_5663_CP , KBL_DPCM_AUDIO_5663_HDMI1_PB , KBL_DPCM_AUDIO_5663_HDMI2_PB , } cocci_id@p ;
...
position p;
@@
 struct kbl_hdmi_pcm * cocci_id@p ;
...
position p;
@@
 enum { KBL_DPCM_AUDIO_PB = 0 , KBL_DPCM_AUDIO_CP , KBL_DPCM_AUDIO_HS_PB , KBL_DPCM_AUDIO_ECHO_REF_CP , KBL_DPCM_AUDIO_REF_CP , KBL_DPCM_AUDIO_DMIC_CP , KBL_DPCM_AUDIO_HDMI1_PB , KBL_DPCM_AUDIO_HDMI2_PB , KBL_DPCM_AUDIO_HDMI3_PB , } cocci_id@p ;
