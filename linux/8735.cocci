...
position p;
@@
 union init_array_hdr * cocci_id@p ;
...
typedef u32;
@@
 u32 cocci_id@p [ DMAE_MAX_RW_SIZE ] ;
...
position p;
@@
 struct init_callback_op * cocci_id@p ;
...
position p;
@@
 struct init_write_op * cocci_id@p ;
...
position p;
@@
 union init_write_args * cocci_id@p ;
...
position p;
@@
 struct init_if_phase_op * cocci_id@p ;
...
position p;
@@
 struct init_if_mode_op * cocci_id@p ;
...
typedef bool,u32;
@@
 bool ( * cocci_id@p ) ( u32 val , u32 expected_val ) ;
...
position p;
@@
 struct init_read_op * cocci_id@p ;
