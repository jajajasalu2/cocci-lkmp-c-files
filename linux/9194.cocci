...
position p;
@@
 struct transmit_cmd_struct * cocci_id@p ;
...
position p;
@@
 struct nop_cmd_struct cocci_id@p ;
...
position p;
@@
 struct mcsetup_cmd_struct * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , char * where , unsigned size ) ;
...
position p;
@@
 struct tdr_cmd_struct * cocci_id@p ;
...
position p;
@@
 volatile struct iasetup_cmd_struct * cocci_id@p ;
...
position p;
@@
 volatile struct mcsetup_cmd_struct * cocci_id@p ;
...
position p;
@@
 struct configure_cmd_struct * cocci_id@p ;
...
position p;
@@
 volatile struct tdr_cmd_struct * cocci_id@p ;
...
position p;
@@
 void * cocci_id@p ( struct net_device * dev , void * ptr ) ;
...
position p;
@@
 volatile struct configure_cmd_struct * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct net_device * dev , int ioaddr ) ;
...
position p;
@@
 volatile struct rbd_struct * cocci_id@p ;
...
position p;
@@
 volatile struct rfd_struct * cocci_id@p ;
...
position p;
@@
 struct iasetup_cmd_struct * cocci_id@p ;
