...
position p;
@@
 const struct qmp_phy_cfg * cocci_id@p ;
...
typedef bool;
@@
 struct qmp_phy_cfg {  unsigned int type ;  int nlanes ;  const struct qmp_phy_init_tbl * serdes_tbl ;  int serdes_tbl_num ;  const struct qmp_phy_init_tbl * tx_tbl ;  int tx_tbl_num ;  const struct qmp_phy_init_tbl * rx_tbl ;  int rx_tbl_num ;  const struct qmp_phy_init_tbl * pcs_tbl ;  int pcs_tbl_num ;  const char * const * clk_list ;  int num_clks ;  const char * const * reset_list ;  int num_resets ;  const char * const * vreg_list ;  int num_vregs ;  const unsigned int * regs ;  unsigned int start_ctrl ;  unsigned int pwrdn_ctrl ;  unsigned int mask_com_pcs_ready ;  bool has_phy_com_ctrl ;  bool has_lane_rst ;  bool has_pwrdn_delay ;  int pwrdn_delay_min ;  int pwrdn_delay_max ;  bool has_phy_dp_com_ctrl ;  bool is_dual_lane_phy ;  bool no_pcs_sw_reset ; } cocci_id@p ;
...
position p;
@@
 const struct qmp_phy_init_tbl cocci_id@p [ ] ;
...
position p;
@@
 struct qmp_phy {  struct phy * phy ;  void __iomem * tx ;  void __iomem * rx ;  void __iomem * pcs ;  void __iomem * tx2 ;  void __iomem * rx2 ;  void __iomem * pcs_misc ;  struct clk * pipe_clk ;  unsigned int index ;  struct qcom_qmp * qmp ;  struct reset_control * lane_rst ; } cocci_id@p ;
...
position p;
@@
 struct clk_fixed_rate * cocci_id@p ;
...
typedef bool;
@@
 struct qcom_qmp {  struct device * dev ;  void __iomem * serdes ;  void __iomem * dp_com ;  struct clk_bulk_data * clks ;  struct reset_control * * resets ;  struct regulator_bulk_data * vregs ;  const struct qmp_phy_cfg * cfg ;  struct qmp_phy * * phys ;  struct mutex phy_mutex ;  int init_count ;  bool phy_initialized ;  enum phy_mode mode ;  struct reset_control * ufs_reset ; } cocci_id@p ;
...
position p;
@@
 struct qmp_phy_init_tbl {  unsigned int offset ;  unsigned int val ;  int in_layout ; } cocci_id@p ;
