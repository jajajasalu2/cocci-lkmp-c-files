...
position p;
@@
 struct ad2s1210_state * cocci_id@p ;
...
position p;
@@
 enum ad2s1210_mode { MOD_POS = 0 , MOD_VEL , MOD_CONFIG , MOD_RESERVED , } cocci_id@p ;
...
typedef u8,bool;
@@
 struct ad2s1210_state {  struct mutex lock ;  struct spi_device * sdev ;  struct gpio_desc * gpios [ 5 ] ;  unsigned int fclkin ;  unsigned int fexcit ;  bool hysteresis ;  u8 resolution ;  enum ad2s1210_mode mode ;  u8 rx [ 2 ] ____cacheline_aligned ;  u8 tx [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
...
position p;
@@
 const struct ad2s1210_gpio cocci_id@p [ ] ;
...
position p;
@@
 enum ad2s1210_gpios { AD2S1210_SAMPLE , AD2S1210_A0 , AD2S1210_A1 , AD2S1210_RES0 , AD2S1210_RES1 , } cocci_id@p ;
...
position p;
@@
 struct ad2s1210_gpio {  const char * name ;  unsigned long flags ; } cocci_id@p ;
