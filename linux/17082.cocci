...
position p;
@@
 char cocci_id@p [ RTAS_ERROR_LOG_MAX ] ;
...
position p;
@@
 struct rtas_suspend_me_data cocci_id@p ;
...
position p;
@@
 struct pseries_errorlog * cocci_id@p ;
...
position p;
@@
 struct rtas_ext_event_log_v6 cocci_id@p ;
...
position p;
@@
 enum rtas_cpu_state { DOWN , UP , } cocci_id@p ;
...
position p;
@@
 struct indicator_elem cocci_id@p ;
...
typedef __be32;
@@
 const struct indicator_elem {  __be32 token ;  __be32 maxindex ; } * cocci_id@p ;
...
position p;
@@
 enum rtas_cpu_state cocci_id@p ;
...
position p;
@@
 struct rtas_error_log * cocci_id@p ;
