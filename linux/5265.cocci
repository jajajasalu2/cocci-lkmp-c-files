...
position p;
@@
 const struct ata_port_info cocci_id@p [ 4 ] ;
...
position p;
@@
 struct sv_cable_table cocci_id@p [ ] ;
...
position p;
@@
 struct sv_cable_table {  int device ;  int subvendor ;  int ( * cable_detect ) ( struct ata_port * ap ) ; } cocci_id@p ;
