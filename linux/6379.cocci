...
position p;
@@
 struct max8925_regulator_info cocci_id@p [ ] ;
...
position p;
@@
 struct max8925_regulator_info {  struct regulator_desc desc ;  struct i2c_client * i2c ;  int vol_reg ;  int enable_reg ; } cocci_id@p ;
