...
position p;
@@
 struct hisi_thermal_data * cocci_id@p ;
...
position p;
@@
 struct hisi_thermal_sensor * cocci_id@p ;
...
position p;
@@
 struct hisi_thermal_data {  const struct hisi_thermal_ops * ops ;  struct hisi_thermal_sensor * sensor ;  struct platform_device * pdev ;  struct clk * clk ;  void __iomem * regs ;  int nr_sensors ; } cocci_id@p ;
...
position p;
@@
 const struct hisi_thermal_ops cocci_id@p ;
...
typedef uint32_t;
@@
 struct hisi_thermal_sensor {  struct hisi_thermal_data * data ;  struct thermal_zone_device * tzd ;  const char * irq_name ;  uint32_t id ;  uint32_t thres_temp ; } cocci_id@p ;
...
position p;
@@
 struct hisi_thermal_ops {  int ( * get_temp ) ( struct hisi_thermal_sensor * sensor ) ;  int ( * enable_sensor ) ( struct hisi_thermal_sensor * sensor ) ;  int ( * disable_sensor ) ( struct hisi_thermal_sensor * sensor ) ;  int ( * irq_handler ) ( struct hisi_thermal_sensor * sensor ) ;  int ( * probe ) ( struct hisi_thermal_data * data ) ; } cocci_id@p ;
