...
position p;
@@
 struct omap2430_glue cocci_id@p ;
...
position p;
@@
 struct omap2430_glue {  struct device * dev ;  struct platform_device * musb ;  enum musb_vbus_id_status status ;  struct work_struct omap_musb_mailbox_work ;  struct device * control_otghs ; } cocci_id@p ;
...
position p;
@@
 struct omap_musb_board_data * cocci_id@p ;
