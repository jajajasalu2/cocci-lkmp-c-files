...
position p;
@@
 struct nvbios_image cocci_id@p ;
...
typedef u32;
@@
 struct shadow {  u32 skip ;  const struct nvbios_source * func ;  void * data ;  u32 size ;  int score ; } cocci_id@p ;
...
position p;
@@
 const struct nvbios_source cocci_id@p ;
