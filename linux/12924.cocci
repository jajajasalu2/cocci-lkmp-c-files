...
position p;
@@
 unsigned int cocci_id@p [ NUM_RX_POOLS ] ;
...
position p;
@@
 volatile loader_block * cocci_id@p ;
...
position p;
@@
 volatile amb_cq_ptrs * cocci_id@p ;
