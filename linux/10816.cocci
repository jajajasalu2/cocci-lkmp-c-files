...
position p;
@@
 struct amdgpu_pmu_entry cocci_id@p ;
...
position p;
@@
 struct amdgpu_pmu_entry {  struct list_head entry ;  struct amdgpu_device * adev ;  struct pmu pmu ;  unsigned int pmu_perf_type ; } cocci_id@p ;
