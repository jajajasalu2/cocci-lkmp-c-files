...
position p;
@@
 int cocci_id@p [ WM8350_NUM_IRQ_REGS ] ;
...
position p;
@@
 struct wm8350_platform_data * cocci_id@p ;
...
typedef u16;
@@
 u16 cocci_id@p [ WM8350_NUM_IRQ_REGS ] ;
...
position p;
@@
 struct wm8350_irq_data cocci_id@p [ ] ;
...
position p;
@@
 struct wm8350_irq_data {  int primary ;  int reg ;  int mask ;  int primary_only ; } cocci_id@p ;
