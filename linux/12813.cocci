...
position p;
@@
 struct etm_enable_arg {  struct etm_drvdata * drvdata ;  int rc ; } cocci_id@p ;
...
position p;
@@
 struct etm_drvdata * cocci_id@p [ NR_CPUS ] ;
...
position p;
@@
 struct etm_enable_arg cocci_id@p ;
