...
typedef u32;
@@
 struct wm_adsp_compr_buf {  struct list_head list ;  struct wm_adsp * dsp ;  struct wm_adsp_compr * compr ;  struct wm_adsp_buffer_region * regions ;  u32 host_buf_ptr ;  u32 error ;  u32 irq_count ;  int read_index ;  int avail ;  int host_buf_mem_type ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct wm_halo_system_config_xm_hdr cocci_id@p ;
...
typedef __be32;
@@
 struct wm_adsp_host_buf_coeff_v1 {  __be32 host_buf_ptr ;  __be32 versions ;  __be32 name [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 struct snd_soc_dapm_context * cocci_id@p ;
...
position p;
@@
 const struct wm_adsp_region * cocci_id@p ;
...
position p;
@@
 struct reg_sequence cocci_id@p [ ] ;
...
position p;
@@
 const struct wmfw_adsp1_sizes * cocci_id@p ;
...
position p;
@@
 const struct wm_adsp_alg_region * cocci_id@p ;
...
position p;
@@
 const struct wm_adsp_buffer_region_def cocci_id@p [ ] ;
...
position p;
@@
 const struct wmfw_footer * cocci_id@p ;
...
position p;
@@
 const struct wmfw_header * cocci_id@p ;
...
position p;
@@
 struct wm_coeff_ctl {  const char * name ;  const char * fw_name ;  const char * subname ;  unsigned int subname_len ;  struct wm_adsp_alg_region alg_region ;  struct wm_coeff_ctl_ops ops ;  struct wm_adsp * dsp ;  unsigned int enabled : 1 ;  struct list_head list ;  void * cache ;  unsigned int offset ;  size_t len ;  unsigned int set : 1 ;  struct soc_bytes_ext bytes_ext ;  unsigned int flags ;  unsigned int type ; } cocci_id@p ;
...
position p;
@@
 struct wm_coeff_ctl * cocci_id@p ;
...
position p;
@@
 struct soc_mixer_control * cocci_id@p ;
...
typedef __be32;
@@
 struct wm_halo_system_config_xm_hdr {  __be32 halo_heartbeat ;  __be32 build_job_name [ 3 ] ;  __be32 build_job_number ; } cocci_id@p ;
...
position p;
@@
 struct wm_adsp_alg_region cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM_ADSP_NUM_FW ] ;
...
position p;
@@
 struct wm_adsp_compr * cocci_id@p ;
...
position p;
@@
 struct wmfw_adsp2_alg_hdr * cocci_id@p ;
...
typedef u32;
@@
 struct wm_adsp_compr {  struct list_head list ;  struct wm_adsp * dsp ;  struct wm_adsp_compr_buf * buf ;  struct snd_compr_stream * stream ;  struct snd_compressed_buffer size ;  u32 * raw_buf ;  unsigned int copied_total ;  unsigned int sample_rate ;  const char * name ; } cocci_id@p ;
...
position p;
@@
 struct wm_adsp_buf {  struct list_head list ;  void * buf ; } cocci_id@p ;
...
typedef u8;
@@
 struct wm_coeff_parsed_alg {  int id ;  const u8 * name ;  int name_len ;  int ncoeff ; } cocci_id@p ;
...
position p;
@@
 struct wm_adsp_compr_buf * cocci_id@p ;
...
position p;
@@
 const struct wm_adsp_fw_caps cocci_id@p [ ] ;
...
position p;
@@
 const struct soc_enum cocci_id@p [ ] ;
...
position p;
@@
 struct wmfw_ctl_work * cocci_id@p ;
...
position p;
@@
 struct wm_coeff_parsed_coeff * cocci_id@p ;
...
position p;
@@
 struct wm_adsp_buffer_region_def {  unsigned int mem_type ;  unsigned int base_offset ;  unsigned int size_offset ; } cocci_id@p ;
...
position p;
@@
 struct wm_adsp_host_buf_coeff_v1 cocci_id@p ;
...
position p;
@@
 struct soc_bytes_ext * cocci_id@p ;
...
position p;
@@
 const struct wmfw_adsp2_sizes * cocci_id@p ;
...
position p;
@@
 struct wm_adsp_buffer_region {  unsigned int offset ;  unsigned int cumulative_size ;  unsigned int mem_type ;  unsigned int base_addr ; } cocci_id@p ;
...
position p;
@@
 struct wm_adsp_buffer cocci_id@p ;
...
typedef __be32;
@@
 struct wm_adsp_buffer {  __be32 buf1_base ;  __be32 buf1_size ;  __be32 buf2_base ;  __be32 buf1_buf2_size ;  __be32 buf3_base ;  __be32 buf_total_size ;  __be32 high_water_mark ;  __be32 irq_count ;  __be32 irq_ack ;  __be32 next_write_index ;  __be32 next_read_index ;  __be32 error ;  __be32 oldest_block_index ;  __be32 requested_rewind ;  __be32 reserved_space ;  __be32 min_free ;  __be32 blocks_written [ 2 ] ;  __be32 words_written [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct wm_adsp_buffer_region * cocci_id@p ;
...
position p;
@@
 const struct wmfw_adsp_alg_data * cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ SNDRV_CTL_ELEM_ID_NAME_MAXLEN ] ;
...
position p;
@@
 const struct {  const char * name ;  const struct file_operations fops ; } cocci_id@p [ ] ;
...
position p;
@@
 struct snd_soc_dapm_widget * cocci_id@p ;
...
position p;
@@
 struct snd_soc_pcm_runtime * cocci_id@p ;
...
position p;
@@
 const struct wmfw_adsp_coeff_data * cocci_id@p ;
...
position p;
@@
 struct wmfw_adsp1_alg_hdr * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct wm_adsp * dsp ) ;
...
@@
 struct wm_adsp_alg_xm_struct {  __be32 magic ;  __be32 smoothing ;  __be32 threshold ;  __be32 host_buf_ptr ;  __be32 start_seq ;  __be32 high_water_mark ;  __be32 low_water_mark ;  __be64 smoothed_power ; } cocci_id@p ;
...
typedef __be32;
@@
 struct wm_adsp_system_config_xm_hdr {  __be32 sys_enable ;  __be32 fw_id ;  __be32 fw_rev ;  __be32 boot_status ;  __be32 watchdog ;  __be32 dma_buffer_size ;  __be32 rdma [ 6 ] ;  __be32 wdma [ 8 ] ;  __be32 build_job_name [ 3 ] ;  __be32 build_job_number ; } cocci_id@p ;
...
position p;
@@
 const struct snd_codec_desc * cocci_id@p ;
...
position p;
@@
 struct wm_coeff_parsed_alg * cocci_id@p ;
...
position p;
@@
 struct snd_compr_params * cocci_id@p ;
...
position p;
@@
 struct wmfw_v3_id_hdr * cocci_id@p ;
...
position p;
@@
 struct wmfw_adsp2_id_hdr cocci_id@p ;
...
position p;
@@
 struct wmfw_halo_id_hdr cocci_id@p ;
...
position p;
@@
 struct wmfw_ctl_work {  struct wm_adsp * dsp ;  struct wm_coeff_ctl * ctl ;  struct work_struct work ; } cocci_id@p ;
...
position p;
@@
 struct wmfw_halo_alg_hdr * cocci_id@p ;
...
position p;
@@
 struct wmfw_coeff_item * cocci_id@p ;
...
position p;
@@
 struct wmfw_coeff_hdr * cocci_id@p ;
...
typedef u32;
@@
 struct wm_adsp_fw_caps {  u32 id ;  struct snd_codec_desc desc ;  int num_regions ;  const struct wm_adsp_buffer_region_def * region_defs ; } cocci_id@p ;
...
position p;
@@
 struct wmfw_adsp1_id_hdr cocci_id@p ;
...
position p;
@@
 struct wm_adsp_alg_xm_struct cocci_id@p ;
...
position p;
@@
 struct snd_compr_stream * cocci_id@p ;
...
position p;
@@
 const struct wm_coeff_parsed_coeff * cocci_id@p ;
...
position p;
@@
 struct snd_compr_caps * cocci_id@p ;
...
typedef bool;
@@
 const struct {  const char * file ;  int compr_direction ;  int num_caps ;  const struct wm_adsp_fw_caps * caps ;  bool voice_trigger ; } cocci_id@p [ WM_ADSP_NUM_FW ] ;
...
typedef u8;
@@
 struct wm_coeff_parsed_coeff {  int offset ;  int mem_type ;  const u8 * name ;  int name_len ;  int ctl_type ;  int flags ;  int len ; } cocci_id@p ;
...
position p;
@@
 struct wm_adsp_system_config_xm_hdr cocci_id@p ;
...
position p;
@@
 const struct wmfw_region * cocci_id@p ;
...
position p;
@@
 struct snd_compr_tstamp * cocci_id@p ;
