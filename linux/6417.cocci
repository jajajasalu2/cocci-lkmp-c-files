...
typedef u8;
@@
 u8 cocci_id@p ( struct lp3971 * lp3971 , u8 reg ) ;
...
typedef u8,u16;
@@
 int cocci_id@p ( struct lp3971 * lp3971 , u8 reg , u16 mask , u16 val ) ;
...
position p;
@@
 struct lp3971 {  struct device * dev ;  struct mutex io_lock ;  struct i2c_client * i2c ; } cocci_id@p ;
...
position p;
@@
 struct lp3971_regulator_subdev * cocci_id@p ;
...
position p;
@@
 struct lp3971_platform_data * cocci_id@p ;
