...
position p;
@@
 int ( * cocci_id@p ) ( struct i2c_client * i2c , int analogue ) ;
...
position p;
@@
 enum wm2000_anc_mode cocci_id@p ;
...
position p;
@@
 struct wm2000_platform_data * cocci_id@p ;
...
position p;
@@
 const char * cocci_id@p [ WM2000_NUM_SUPPLIES ] ;
...
position p;
@@
 struct {  enum wm2000_anc_mode source ;  enum wm2000_anc_mode dest ;  int analogue ;  wm2000_mode_fn step [ 2 ] ; } cocci_id@p [ ] ;
...
position p;
@@
 struct wm2000_priv {  struct i2c_client * i2c ;  struct regmap * regmap ;  struct clk * mclk ;  struct regulator_bulk_data supplies [ WM2000_NUM_SUPPLIES ] ;  enum wm2000_anc_mode anc_mode ;  unsigned int anc_active : 1 ;  unsigned int anc_eng_ena : 1 ;  unsigned int spk_ena : 1 ;  unsigned int speech_clarity : 1 ;  int anc_download_size ;  char * anc_download ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 enum wm2000_anc_mode { ANC_ACTIVE = 0 , ANC_BYPASS = 1 , ANC_STANDBY = 2 , ANC_OFF = 3 , } cocci_id@p ;
