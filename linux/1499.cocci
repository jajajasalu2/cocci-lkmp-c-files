...
position p;
@@
 struct usb_otg20_descriptor cocci_id@p ;
...
position p;
@@
 struct usb_gadget_string_container * cocci_id@p ;
...
position p;
@@
 struct usb_os_string * cocci_id@p ;
...
position p;
@@
 struct usb_string_descriptor * cocci_id@p ;
...
position p;
@@
 const struct usb_gadget_strings * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct usb_configuration * ) ;
...
position p;
@@
 struct usb_composite_overwrite * cocci_id@p ;
...
position p;
@@
 struct usb_dcd_config_params cocci_id@p ;
...
position p;
@@
 const struct usb_descriptor_header * * cocci_id@p ;
