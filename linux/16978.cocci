...
position p;
@@
 const struct touchscreen_init_data * cocci_id@p ;
...
typedef bool,u16;
@@
 struct tps6507x_ts {  struct device * dev ;  struct input_dev * input ;  struct tps6507x_dev * mfd ;  char phys [ 32 ] ;  struct ts_event tc ;  u16 min_pressure ;  bool pendown ; } cocci_id@p ;
...
typedef u16;
@@
 struct ts_event {  u16 x ;  u16 y ;  u16 pressure ; } cocci_id@p ;
...
position p;
@@
 const struct tps6507x_board * cocci_id@p ;
