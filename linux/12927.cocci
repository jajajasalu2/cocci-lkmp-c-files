...
position p;
@@
 struct midway_eprom cocci_id@p ;
...
position p;
@@
 struct eni_multipliers cocci_id@p ;
...
position p;
@@
 enum enq_res { enq_ok , enq_next , enq_jam , } cocci_id@p ;
