...
position p;
@@
 enum snd_pcm_plugin_action cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct snd_pcm_plugin * plugin , const struct snd_pcm_plugin_channel * src_channels , struct snd_pcm_plugin_channel * dst_channels , int src_frames , int dst_frames ) ;
...
position p;
@@
 struct rate_channel * cocci_id@p ;
...
position p;
@@
 const struct snd_pcm_plugin_channel * cocci_id@p ;
...
position p;
@@
 struct rate_channel {  signed short last_S1 ;  signed short last_S2 ; } cocci_id@p ;
...
position p;
@@
 struct snd_pcm_plugin_format * cocci_id@p ;
