...
position p;
@@
 struct ext4_xattr_search * cocci_id@p ;
...
position p;
@@
 struct ext4_xattr_header * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mb_cache * , struct buffer_head * ) ;
...
position p;
@@
 struct buffer_head * cocci_id@p [ 8 ] ;
...
position p;
@@
 void cocci_id@p ( struct ext4_xattr_header * ) ;
...
position p;
@@
 struct ext4_xattr_block_find {  struct ext4_xattr_search s ;  struct buffer_head * bh ; } cocci_id@p ;
...
position p;
@@
 struct ext4_xattr_ibody_find * cocci_id@p ;
...
position p;
@@
 struct buffer_head * cocci_id@p ( struct inode * , struct ext4_xattr_header * , struct mb_cache_entry * * ) ;
...
position p;
@@
 struct ext4_xattr_info * cocci_id@p ;
...
position p;
@@
 struct ext4_xattr_block_find cocci_id@p ;
...
position p;
@@
 const struct xattr_handler * const cocci_id@p [ ] ;
...
position p;
@@
 struct ext4_xattr_entry * cocci_id@p ;
...
position p;
@@
 struct mb_cache_entry * * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ext4_xattr_inode_array * * ea_inode_array , struct inode * inode ) ;
