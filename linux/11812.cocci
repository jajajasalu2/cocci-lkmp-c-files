...
position p;
@@
 union {  struct nvif_mmu_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_mmu_kind_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_mmu_type_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_mmu_heap_v0 v0 ; } * cocci_id@p ;
