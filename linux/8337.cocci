...
position p;
@@
 struct octeon_core_setup * cocci_id@p ;
...
position p;
@@
 struct octeon_cn23xx_vf cocci_id@p ;
...
position p;
@@
 struct octeon_device * cocci_id@p [ MAX_OCTEON_DEVICES ] ;
...
position p;
@@
 char cocci_id@p [ OCT_DEV_STATES + 1 ] [ 32 ] ;
...
typedef atomic_t;
@@
 atomic_t cocci_id@p [ MAX_OCTEON_DEVICES ] ;
...
position p;
@@
 char cocci_id@p [ CVM_DRV_APP_COUNT + 1 ] [ 32 ] ;
...
position p;
@@
 struct octeon_ioq_vector * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef octeon_dispatch_fn_t;
@@
 octeon_dispatch_fn_t cocci_id@p ;
...
position p;
@@
 struct octeon_core_setup cocci_id@p [ MAX_OCTEON_DEVICES ] ;
...
position p;
@@
 struct octeon_dispatch cocci_id@p ;
...
position p;
@@
 struct octeon_cn23xx_pf cocci_id@p ;
...
typedef u32;
@@
 struct octeon_config_ptr {  u32 conf_type ; } cocci_id@p [ MAX_OCTEON_DEVICES ] ;
