...
position p;
@@
 const struct pin_config_item cocci_id@p [ ] ;
...
position p;
@@
 struct sprd_pinctrl * cocci_id@p ;
...
position p;
@@
 enum pin_sleep_mode { AP_SLEEP = BIT ( 0 ) , PUBCP_SLEEP = BIT ( 1 ) , TGLDSP_SLEEP = BIT ( 2 ) , AGDSP_SLEEP = BIT ( 3 ) , CM4_SLEEP = BIT ( 4 ) , } cocci_id@p ;
...
position p;
@@
 const struct pinconf_generic_params cocci_id@p [ ] ;
...
position p;
@@
 struct sprd_pinctrl {  struct device * dev ;  struct pinctrl_dev * pctl ;  void __iomem * base ;  struct sprd_pinctrl_soc_info * info ; } cocci_id@p ;
...
position p;
@@
 struct sprd_pinctrl_soc_info cocci_id@p ;
...
position p;
@@
 enum pinctrl_map_type cocci_id@p ;
...
position p;
@@
 struct sprd_pin_group {  const char * name ;  unsigned int npins ;  unsigned int * pins ; } cocci_id@p ;
...
position p;
@@
 struct sprd_pins_info * cocci_id@p ;
...
position p;
@@
 struct sprd_pinctrl_soc_info {  struct sprd_pin_group * groups ;  unsigned int ngroups ;  struct sprd_pin * pins ;  unsigned int npins ;  const char * * grp_names ; } cocci_id@p ;
...
position p;
@@
 struct sprd_pin_group cocci_id@p ;
...
position p;
@@
 enum pin_func_sel { PIN_FUNC_1 , PIN_FUNC_2 , PIN_FUNC_3 , PIN_FUNC_4 , PIN_FUNC_MAX , } cocci_id@p ;
...
position p;
@@
 struct sprd_pin {  const char * name ;  unsigned int number ;  enum pin_type type ;  unsigned long reg ;  unsigned long bit_offset ;  unsigned long bit_width ; } cocci_id@p ;
...
position p;
@@
 const struct sprd_pin_group * cocci_id@p ;
