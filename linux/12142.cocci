...
position p;
@@
 union {  struct nvif_client_v0 v0 ; } * cocci_id@p ;
...
position p;
@@
 struct nvkm_client_notify * cocci_id@p ;
...
position p;
@@
 union {  struct nvif_client_devlist_v0 v0 ; } * cocci_id@p ;
...
typedef u8;
@@
 struct nvkm_client_notify {  struct nvkm_client * client ;  struct nvkm_notify n ;  u8 version ;  u8 size ;  union {  struct nvif_notify_rep_v0 v0 ; } rep ; } cocci_id@p ;
...
typedef u32;
@@
 int ( * cocci_id@p ) ( const void * , u32 , const void * , u32 ) ;
