...
position p;
@@
 const struct dce110_link_enc_hpd_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dc_stream_state * const cocci_id@p ;
...
position p;
@@
 struct dce110_stream_encoder cocci_id@p ;
...
position p;
@@
 const struct dce110_link_enc_aux_registers cocci_id@p [ ] ;
...
position p;
@@
 struct dm_pp_clock_levels cocci_id@p ;
...
position p;
@@
 const struct dce110_timing_generator_offsets cocci_id@p [ ] ;
...
position p;
@@
 const struct dce_mem_input_shift cocci_id@p ;
...
position p;
@@
 const struct dce_mem_input_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dce_stream_encoder_mask cocci_id@p ;
...
position p;
@@
 struct dce_transform * cocci_id@p ;
...
position p;
@@
 const struct dce110_link_enc_registers cocci_id@p [ ] ;
...
position p;
@@
 struct dce110_timing_generator * cocci_id@p ;
...
position p;
@@
 struct dce_mem_input cocci_id@p ;
...
position p;
@@
 const struct dce_opp_mask cocci_id@p ;
...
position p;
@@
 const struct dce_transform_registers cocci_id@p [ ] ;
...
position p;
@@
 enum dce112_clk_src_array_id { DCE112_CLK_SRC_PLL0 , DCE112_CLK_SRC_PLL1 , DCE112_CLK_SRC_PLL2 , DCE112_CLK_SRC_PLL3 , DCE112_CLK_SRC_PLL4 , DCE112_CLK_SRC_PLL5 , DCE112_CLK_SRC_TOTAL , } cocci_id@p ;
...
position p;
@@
 const struct dce_opp_registers cocci_id@p [ ] ;
...
position p;
@@
 struct dm_pp_clock_levels_with_latency cocci_id@p ;
...
position p;
@@
 const struct dce_mem_input_mask cocci_id@p ;
...
position p;
@@
 const struct dce_ipp_registers cocci_id@p [ ] ;
...
position p;
@@
 struct dce110_link_encoder cocci_id@p ;
...
position p;
@@
 const struct dce_opp_shift cocci_id@p ;
...
position p;
@@
 const struct dce_transform_shift cocci_id@p ;
...
position p;
@@
 const struct dce_ipp_mask cocci_id@p ;
...
position p;
@@
 const struct dce_ipp_shift cocci_id@p ;
...
position p;
@@
 struct dce110_resource_pool * cocci_id@p ;
...
position p;
@@
 const struct dce110_stream_enc_registers cocci_id@p [ ] ;
...
position p;
@@
 const struct dce_transform_mask cocci_id@p ;
...
position p;
@@
 const struct dce_stream_encoder_shift cocci_id@p ;
...
position p;
@@
 struct dm_pp_wm_sets_with_clock_ranges cocci_id@p ;
