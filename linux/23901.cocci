...
position p;
@@
 const struct xfrm_algo_list * cocci_id@p ;
...
position p;
@@
 struct xfrm_aead_name cocci_id@p ;
...
position p;
@@
 const struct xfrm_aead_name * cocci_id@p ;
...
typedef u32;
@@
 struct xfrm_algo_list {  struct xfrm_algo_desc * algs ;  int entries ;  u32 type ;  u32 mask ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( const struct xfrm_algo_desc * entry , const void * data ) ;
...
position p;
@@
 struct xfrm_aead_name {  const char * name ;  int icvbits ; } cocci_id@p ;
