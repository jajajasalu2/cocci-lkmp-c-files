...
position p;
@@
 enum { DWR_ABPCK_BIT_PER_CLK = 0 , DWR_ABPCK_2_BIT_PER_CLK = 1 , DWR_ABPCK_4_BIT_PER_CLK = 2 , } cocci_id@p ;
...
typedef u32;
@@
 struct npcm_fiu_info {  char * name ;  u32 fiu_id ;  u32 max_map_size ;  u32 max_cs ; } cocci_id@p ;
...
position p;
@@
 struct npcm_fiu_spi cocci_id@p ;
...
position p;
@@
 enum { DWR_DBPCK_BIT_PER_CLK = 0 , DWR_DBPCK_2_BIT_PER_CLK = 1 , DWR_DBPCK_4_BIT_PER_CLK = 2 , } cocci_id@p ;
...
position p;
@@
 const struct fiu_data cocci_id@p ;
...
position p;
@@
 enum { FIU0 = 0 , FIU3 , FIUX , } cocci_id@p ;
...
position p;
@@
 struct fiu_data {  const struct npcm_fiu_info * npcm_fiu_data_info ;  int fiu_max ; } cocci_id@p ;
...
typedef bool;
@@
 struct npcm_fiu_spi {  struct npcm_fiu_chip chip [ NPCM_MAX_CHIP_NUM ] ;  const struct npcm_fiu_info * info ;  struct spi_mem_op drd_op ;  struct resource * res_mem ;  struct regmap * regmap ;  unsigned long clkrate ;  struct device * dev ;  struct clk * clk ;  bool spix_mode ; } cocci_id@p ;
...
position p;
@@
 const struct npcm_fiu_info cocci_id@p [ ] ;
...
position p;
@@
 struct spi_mem_dirmap_desc * cocci_id@p ;
...
typedef u32;
@@
 struct npcm_fiu_chip {  void __iomem * flash_region_mapped_ptr ;  struct npcm_fiu_spi * fiu ;  unsigned long clkrate ;  u32 chipselect ; } cocci_id@p ;
...
position p;
@@
 enum { DRD_SINGLE_WIRE_MODE = 0 , DRD_DUAL_IO_MODE = 1 , DRD_QUAD_IO_MODE = 2 , DRD_SPI_X_MODE = 3 , } cocci_id@p ;
...
position p;
@@
 struct npcm_fiu_chip * cocci_id@p ;
