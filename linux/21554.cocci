...
position p;
@@
 struct nios2_timer {  void __iomem * base ;  unsigned long freq ; } cocci_id@p ;
...
position p;
@@
 struct nios2_clocksource {  struct nios2_timer timer ;  struct clocksource cs ; } cocci_id@p ;
...
position p;
@@
 struct nios2_clocksource * cocci_id@p ;
...
position p;
@@
 struct nios2_clockevent_dev {  struct nios2_timer timer ;  struct clock_event_device ced ; } cocci_id@p ;
...
position p;
@@
 struct nios2_clockevent_dev cocci_id@p ;
