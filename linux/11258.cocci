...
position p;
@@
 struct bdb_lvds_lfp_data_entry * cocci_id@p ;
...
position p;
@@
 struct bdb_lvds_options * cocci_id@p ;
...
position p;
@@
 struct edp_link_params * cocci_id@p ;
...
position p;
@@
 struct bdb_general_definitions * cocci_id@p ;
...
position p;
@@
 struct bdb_lvds_backlight * cocci_id@p ;
...
position p;
@@
 struct bdb_lvds_lfp_data * cocci_id@p ;
...
position p;
@@
 struct bdb_sdvo_lvds_options * cocci_id@p ;
...
position p;
@@
 struct bdb_general_features * cocci_id@p ;
...
position p;
@@
 struct bdb_driver_features * cocci_id@p ;
