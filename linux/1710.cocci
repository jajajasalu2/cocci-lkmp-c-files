...
position p;
@@
 struct mcp41010_data * cocci_id@p ;
...
position p;
@@
 struct mcp41010_cfg {  char name [ 16 ] ;  int wipers ;  int kohms ; } cocci_id@p ;
...
position p;
@@
 const struct mcp41010_cfg cocci_id@p [ ] ;
...
position p;
@@
 enum mcp41010_type { MCP41010 , MCP41050 , MCP41100 , MCP42010 , MCP42050 , MCP42100 , } cocci_id@p ;
...
typedef u8;
@@
 struct mcp41010_data {  struct spi_device * spi ;  const struct mcp41010_cfg * cfg ;  struct mutex lock ;  unsigned int value [ MCP41010_MAX_WIPERS ] ;  u8 buf [ 2 ] ____cacheline_aligned ; } cocci_id@p ;
