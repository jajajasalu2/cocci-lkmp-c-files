...
position p;
@@
 struct ustorm_eth_queue_zone cocci_id@p ;
...
position p;
@@
 struct qed_llh_filter_details * cocci_id@p ;
...
position p;
@@
 struct qed_sb_cnt_info cocci_id@p ;
...
position p;
@@
 struct qed_resc_lock_params cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u16,qed_llh_prot_filter_type_t;
@@
 struct qed_llh_protocol_filter {  enum qed_llh_prot_filter_type_t type ;  u16 source_port_or_eth_type ;  u16 dest_port ; } cocci_id@p ;
...
position p;
@@
 struct init_qm_pq_params * cocci_id@p ;
...
position p;
@@
 struct qed_load_req_params cocci_id@p ;
...
position p;
@@
 enum qed_chain_mode cocci_id@p ;
...
position p;
@@
 enum qed_pci_personality cocci_id@p ;
...
position p;
@@
 struct qed_llh_info * cocci_id@p ;
...
position p;
@@
 union qed_llh_filter * cocci_id@p ;
...
typedef u8;
@@
 struct qed_db_recovery_entry {  struct list_head list_entry ;  void __iomem * db_addr ;  void * db_data ;  enum qed_db_rec_width db_width ;  enum qed_db_rec_space db_space ;  u8 hwfn_idx ; } cocci_id@p ;
...
position p;
@@
 struct qed_db_recovery_entry * cocci_id@p ;
...
position p;
@@
 struct xstorm_eth_queue_zone cocci_id@p ;
...
position p;
@@
 struct coalescing_timeset * cocci_id@p ;
...
position p;
@@
 enum qed_llh_filter_type cocci_id@p ;
...
typedef u8;
@@
 struct qed_llh_mac_filter {  u8 addr [ ETH_ALEN ] ; } cocci_id@p ;
...
position p;
@@
 struct init_qm_port_params * cocci_id@p ;
...
position p;
@@
 union qed_llh_filter {  struct qed_llh_mac_filter mac ;  struct qed_llh_protocol_filter protocol ; } cocci_id@p ;
...
position p;
@@
 enum qed_chain_use_mode cocci_id@p ;
...
position p;
@@
 struct qed_resc_unlock_params cocci_id@p ;
...
position p;
@@
 struct init_qm_vport_params * cocci_id@p ;
...
position p;
@@
 struct qed_qm_common_rt_init_params cocci_id@p ;
...
position p;
@@
 struct nvm_cfg1_port cocci_id@p ;
...
position p;
@@
 struct qed_drv_load_params * cocci_id@p ;
...
position p;
@@
 enum QED_ROCE_EDPM_MODE { QED_ROCE_EDPM_MODE_ENABLE = 0 , QED_ROCE_EDPM_MODE_FORCE_ON = 1 , QED_ROCE_EDPM_MODE_DISABLE = 2 , } cocci_id@p ;
...
typedef u64,u32;
@@
 struct qed_llh_filter_details {  u64 value ;  u32 mode ;  u32 protocol_type ;  u32 hdr_sel ;  u32 enable ; } cocci_id@p ;
...
position p;
@@
 struct qed_llh_filter_info * cocci_id@p ;
...
position p;
@@
 enum qed_chain_cnt_type cocci_id@p ;
...
position p;
@@
 struct qed_mcp_function_info * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef qed_llh_prot_filter_type_t;
@@
 enum qed_llh_prot_filter_type_t cocci_id@p ;
...
position p;
@@
 struct qed_chain_next * cocci_id@p ;
...
typedef bool,u32;
@@
 struct qed_llh_filter_info {  bool b_enabled ;  u32 ref_cnt ;  enum qed_llh_filter_type type ;  union qed_llh_filter filter ; } cocci_id@p ;
...
position p;
@@
 struct qed_hw_init_params * cocci_id@p ;
...
position p;
@@
 enum qed_llh_filter_type { QED_LLH_FILTER_TYPE_MAC , QED_LLH_FILTER_TYPE_PROTOCOL , } cocci_id@p ;
...
position p;
@@
 struct nvm_cfg1_glob cocci_id@p ;
