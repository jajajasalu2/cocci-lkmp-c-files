...
symbol cocci_id;
position p;
typedef slram_mtd_list_t;
@@
 slram_mtd_list_t cocci_id@p ;
...
typedef u_char;
@@
 struct slram_priv {  u_char * start ;  u_char * end ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef slram_priv_t;
@@
 slram_priv_t * cocci_id@p ;
...
position p;
@@
 struct slram_mtd_list {  struct mtd_info * mtdinfo ;  struct slram_mtd_list * next ; } cocci_id@p ;
...
position p;
@@
 char * cocci_id@p [ SLRAM_MAX_DEVICES_PARAMS ] ;
