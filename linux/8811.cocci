...
position p;
@@
 void cocci_id@p ( struct net_device * , struct ethtool_drvinfo * ) ;
...
position p;
@@
 int cocci_id@p [ ACE_MAX_MOD_PARMS ] ;
...
position p;
@@
 int cocci_id@p ( struct net_device * , const struct ethtool_link_ksettings * ) ;
...
position p;
@@
 int cocci_id@p ( struct net_device * , struct ethtool_link_ksettings * ) ;
