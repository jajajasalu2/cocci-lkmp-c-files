...
position p;
@@
 struct lp872x_platform_data * cocci_id@p ;
...
position p;
@@
 enum lp872x_id { LP8720 , LP8725 , } cocci_id@p ;
...
position p;
@@
 enum lp872x_dvs_state cocci_id@p ;
...
position p;
@@
 enum lp872x_dvs_sel cocci_id@p ;
...
position p;
@@
 enum lp872x_regulator_id cocci_id@p ;
...
position p;
@@
 struct lp872x {  struct regmap * regmap ;  struct device * dev ;  enum lp872x_id chipid ;  struct lp872x_platform_data * pdata ;  int num_regulators ;  enum lp872x_dvs_state dvs_pin ; } cocci_id@p ;
