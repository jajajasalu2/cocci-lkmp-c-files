...
position p;
@@
 struct ubi_device_info * cocci_id@p ;
...
position p;
@@
 struct gluebi_device {  struct mtd_info mtd ;  int refcnt ;  struct ubi_volume_desc * desc ;  int ubi_num ;  int vol_id ;  struct list_head list ; } cocci_id@p ;
...
position p;
@@
 struct gluebi_device cocci_id@p ;
