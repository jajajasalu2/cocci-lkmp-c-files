...
position p;
@@
 struct hpre_asym_request * cocci_id@p ;
...
position p;
@@
 struct hpre_asym_request {  char * src ;  char * dst ;  struct hpre_sqe req ;  struct hpre_ctx * ctx ;  union {  struct akcipher_request * rsa ;  struct kpp_request * dh ; } areq ;  int err ;  int req_id ;  hpre_cb cb ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct hpre_ctx * ctx , void * sqe ) ;
...
typedef dma_addr_t;
@@
 struct hpre_rsa_ctx {  char * pubkey ;  dma_addr_t dma_pubkey ;  char * prikey ;  dma_addr_t dma_prikey ;  char * crt_prikey ;  dma_addr_t dma_crt_prikey ;  struct crypto_akcipher * soft_tfm ; } cocci_id@p ;
...
@@
 struct hpre_ctx {  struct hisi_qp * qp ;  struct hpre_asym_request * * req_list ;  spinlock_t req_lock ;  unsigned int key_sz ;  bool crt_g2_mode ;  struct idr req_idr ;  union {  struct hpre_rsa_ctx rsa ;  struct hpre_dh_ctx dh ; } ; } cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct hpre_dh_ctx {  char * xa_p ;  dma_addr_t dma_xa_p ;  char * g ;  dma_addr_t dma_g ; } cocci_id@p ;
