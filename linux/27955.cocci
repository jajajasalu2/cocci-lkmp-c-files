...
position p;
@@
 enum { Opt_debug , Opt_dfltuid , Opt_dfltgid , Opt_afid , Opt_uname , Opt_remotename , Opt_cache , Opt_cachetag , Opt_nodevmap , Opt_cache_loose , Opt_fscache , Opt_mmap , Opt_access , Opt_posixacl , Opt_locktimeout , Opt_err , } cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ nr__p9_cache_modes ] ;
