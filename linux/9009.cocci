...
position p;
@@
 enum { MLX4_RES_QP , MLX4_RES_RDMARC , MLX4_RES_ALTC , MLX4_RES_AUXC , MLX4_RES_SRQ , MLX4_RES_CQ , MLX4_RES_EQ , MLX4_RES_DMPT , MLX4_RES_CMPT , MLX4_RES_MTT , MLX4_RES_MCG , MLX4_RES_NUM , } cocci_id@p ;
...
typedef u64,u32;
@@
 struct mlx4_resource {  u64 size ;  u64 start ;  int type ;  u32 num ;  int log_num ; } cocci_id@p ;
...
position p;
@@
 struct mlx4_resource * cocci_id@p ;
