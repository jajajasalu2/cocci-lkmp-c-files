...
position p;
@@
 struct pblk_w_err_gc cocci_id@p ;
...
position p;
@@
 struct pblk_sec_meta cocci_id@p ;
...
position p;
@@
 struct pblk_line_ws cocci_id@p ;
...
position p;
@@
 struct pblk_global_caches {  struct kmem_cache * ws ;  struct kmem_cache * rec ;  struct kmem_cache * g_rq ;  struct kmem_cache * w_rq ;  struct kref kref ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 struct pblk_rec_ctx cocci_id@p ;
...
position p;
@@
 struct pblk_global_caches cocci_id@p ;
...
position p;
@@
 struct pblk_line_mgmt * cocci_id@p ;
...
position p;
@@
 struct pblk_line_meta * cocci_id@p ;
