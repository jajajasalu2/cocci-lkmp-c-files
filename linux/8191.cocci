...
typedef u64;
@@
 u64 cocci_id@p [ ARRAY_SIZE ( skge_stats ) ] ;
...
position p;
@@
 void cocci_id@p ( struct skge_port * skge ) ;
...
position p;
@@
 struct skge_rx_desc * cocci_id@p ;
...
position p;
@@
 const struct skge_hw * cocci_id@p ;
...
position p;
@@
 const struct skge_port * cocci_id@p ;
...
typedef u16;
@@
 const struct skge_stat {  char name [ ETH_GSTRING_LEN ] ;  u16 xmac_offset ;  u16 gma_offset ; } cocci_id@p [ ] ;
...
position p;
@@
 void cocci_id@p ( struct skge_hw * hw , int port ) ;
...
position p;
@@
 enum led_mode { LED_MODE_OFF , LED_MODE_ON , LED_MODE_TST , } cocci_id@p ;
...
typedef u8;
@@
 const struct {  u8 id ;  const char * name ; } cocci_id@p [ ] ;
...
typedef u16;
@@
 int cocci_id@p ( struct skge_hw * hw , int port , u16 reg , u16 val ) ;
...
position p;
@@
 struct skge_element cocci_id@p ;
...
typedef u16;
@@
 const struct {  u16 reg ;  u16 val ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct skge_rx_desc * cocci_id@p ;
...
position p;
@@
 struct skge_tx_desc cocci_id@p ;
...
typedef u64;
@@
 void cocci_id@p ( struct skge_port * skge , u64 * data ) ;
...
position p;
@@
 const struct skge_ring * cocci_id@p ;
...
position p;
@@
 const struct skge_tx_desc * cocci_id@p ;
...
position p;
@@
 const struct skge_element * cocci_id@p ;
