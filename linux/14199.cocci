...
position p;
@@
 struct sun6i_csi_buffer cocci_id@p ;
...
@@
 struct sun6i_csi_buffer {  struct vb2_v4l2_buffer vb ;  struct list_head list ;  dma_addr_t dma_addr ;  bool queued_to_csi ; } cocci_id@p ;
