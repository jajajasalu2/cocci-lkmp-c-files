...
position p;
@@
 struct drm_vc4_perfmon_create * cocci_id@p ;
...
position p;
@@
 struct drm_vc4_perfmon_get_values * cocci_id@p ;
...
position p;
@@
 struct drm_vc4_perfmon_destroy * cocci_id@p ;
