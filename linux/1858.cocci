...
position p;
@@
 struct lpc32xx_adc_state * cocci_id@p ;
...
typedef u32;
@@
 struct lpc32xx_adc_state {  void __iomem * adc_base ;  struct clk * clk ;  struct completion completion ;  struct regulator * vref ;  u32 value ; } cocci_id@p ;
