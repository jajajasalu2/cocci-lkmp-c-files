...
position p;
@@
 struct loader_xfer_query_response cocci_id@p ;
...
position p;
@@
 struct loader_xfer_query cocci_id@p ;
...
@@
 struct response_info {  void * data ;  size_t max_size ;  size_t size ;  int error ;  bool received ;  wait_queue_head_t wait_queue ; } cocci_id@p ;
...
position p;
@@
 struct ishtp_cl_device * cocci_id@p ;
...
position p;
@@
 struct shim_fw_info * cocci_id@p ;
...
position p;
@@
 struct ishtp_cl_driver cocci_id@p ;
...
typedef bool;
@@
 struct ishtp_cl_data {  struct ishtp_cl * loader_ishtp_cl ;  struct ishtp_cl_device * cl_device ;  struct response_info response ;  struct work_struct work_ishtp_reset ;  struct work_struct work_fw_load ;  bool flag_retry ;  int retry_count ; } cocci_id@p ;
...
position p;
@@
 enum ish_loader_commands { LOADER_CMD_XFER_QUERY = 0 , LOADER_CMD_XFER_FRAGMENT , LOADER_CMD_START , } cocci_id@p ;
...
position p;
@@
 const struct shim_fw_info cocci_id@p ;
...
position p;
@@
 struct loader_xfer_ipc_fragment * cocci_id@p ;
...
position p;
@@
 struct loader_xfer_dma_fragment cocci_id@p ;
...
position p;
@@
 struct loader_msg_hdr * cocci_id@p ;
...
position p;
@@
 struct ishtp_cl_data cocci_id@p ;
...
position p;
@@
 struct loader_start cocci_id@p ;
