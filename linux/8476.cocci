...
position p;
@@
 struct xgbe_ext_stats cocci_id@p ;
...
position p;
@@
 const struct xgbe_stats cocci_id@p [ ] ;
...
position p;
@@
 struct xgbe_stats {  char stat_string [ ETH_GSTRING_LEN ] ;  int stat_size ;  int stat_offset ; } cocci_id@p ;
