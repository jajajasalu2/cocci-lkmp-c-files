...
typedef u8;
@@
 u8 cocci_id@p [ S6SY761_PANEL_ID_SIZE ] ;
...
position p;
@@
 enum s6sy761_regulators { S6SY761_REGULATOR_VDD , S6SY761_REGULATOR_AVDD , } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ S6SY761_EVENT_SIZE ] ;
...
position p;
@@
 struct s6sy761_data * cocci_id@p ;
...
typedef u8,u16;
@@
 struct s6sy761_data {  struct i2c_client * client ;  struct regulator_bulk_data regulators [ 2 ] ;  struct input_dev * input ;  struct touchscreen_properties prop ;  u8 data [ S6SY761_EVENT_SIZE * S6SY761_EVENT_COUNT ] ;  u16 devid ;  u8 tx_channel ; } cocci_id@p ;
