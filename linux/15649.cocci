...
position p;
@@
 struct gb_raw_send_request * cocci_id@p ;
...
typedef u8,u32;
@@
 struct raw_data {  struct list_head entry ;  u32 len ;  u8 data [ 0 ] ; } cocci_id@p ;
...
typedef dev_t;
@@
 struct gb_raw {  struct gb_connection * connection ;  struct list_head list ;  int list_data ;  struct mutex list_lock ;  dev_t dev ;  struct cdev cdev ;  struct device * device ; } cocci_id@p ;
