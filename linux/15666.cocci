...
position p;
@@
 struct gb_bootrom_firmware_size_request * cocci_id@p ;
...
position p;
@@
 struct gb_bootrom_firmware_size_response * cocci_id@p ;
...
typedef u8;
@@
 struct gb_bootrom {  struct gb_connection * connection ;  const struct firmware * fw ;  u8 protocol_major ;  u8 protocol_minor ;  enum next_request_type next_request ;  struct delayed_work dwork ;  struct mutex mutex ; } cocci_id@p ;
...
position p;
@@
 struct gb_bootrom_ready_to_boot_request * cocci_id@p ;
...
position p;
@@
 struct gb_bootrom_get_vid_pid_response cocci_id@p ;
...
position p;
@@
 struct gb_bootrom_version_request cocci_id@p ;
...
position p;
@@
 struct gb_bootrom_get_firmware_request * cocci_id@p ;
...
position p;
@@
 struct gb_bootrom_version_response cocci_id@p ;
...
position p;
@@
 struct gb_bootrom_get_firmware_response * cocci_id@p ;
...
position p;
@@
 enum next_request_type cocci_id@p ;
...
position p;
@@
 enum next_request_type { NEXT_REQ_FIRMWARE_SIZE , NEXT_REQ_GET_FIRMWARE , NEXT_REQ_READY_TO_BOOT , NEXT_REQ_MODE_SWITCH , } cocci_id@p ;
