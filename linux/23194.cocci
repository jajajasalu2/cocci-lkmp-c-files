...
typedef u32;
@@
 struct sirf_usp {  struct regmap * regmap ;  struct clk * clk ;  u32 mode1_reg ;  u32 mode2_reg ;  int daifmt_format ;  struct snd_dmaengine_dai_dma_data playback_dma_data ;  struct snd_dmaengine_dai_dma_data capture_dma_data ; } cocci_id@p ;
