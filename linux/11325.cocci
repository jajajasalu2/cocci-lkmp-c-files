...
position p;
@@
 struct drm_dp_sideband_msg_reply_body cocci_id@p ;
...
position p;
@@
 const struct drm_dp_mst_topology_ref_entry * cocci_id@p ;
...
position p;
@@
 struct drm_dp_mst_topology_ref_entry * cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ DRM_DP_MAX_SDP_STREAMS ] ;
...
position p;
@@
 const struct drm_dp_connection_status_notify * cocci_id@p ;
...
position p;
@@
 const struct drm_private_state_funcs cocci_id@p ;
...
position p;
@@
 struct drm_dp_mst_topology_state * cocci_id@p ;
...
position p;
@@
 enum drm_dp_mst_topology_ref_type cocci_id@p ;
...
position p;
@@
 struct drm_dp_remote_dpcd_write * cocci_id@p ;
...
position p;
@@
 struct drm_dp_remote_i2c_read_tx * cocci_id@p ;
...
position p;
@@
 struct drm_dp_pending_up_req cocci_id@p ;
...
position p;
@@
 struct drm_dp_mst_topology_ref_history * cocci_id@p ;
...
position p;
@@
 struct drm_dp_sideband_msg_hdr * cocci_id@p ;
...
typedef u8,bool;
@@
 bool cocci_id@p ( struct drm_dp_mst_topology_mgr * mgr , u8 * guid ) ;
...
position p;
@@
 struct drm_dp_remote_dpcd_read * cocci_id@p ;
...
position p;
@@
 struct drm_dp_link_addr_reply_port * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_dp_mst_topology_mgr * mgr ) ;
...
position p;
@@
 const struct drm_dp_mst_branch * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_dp_mst_topology_mgr * mgr , struct drm_dp_mst_branch * mstb , struct drm_dp_mst_port * port ) ;
...
position p;
@@
 struct drm_dp_allocate_payload * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_dp_aux * aux ) ;
...
position p;
@@
 struct drm_dp_sideband_msg_tx * cocci_id@p ;
...
position p;
@@
 struct drm_dp_link_address_ack_reply * cocci_id@p ;
...
position p;
@@
 const struct drm_dp_sideband_msg_req_body * cocci_id@p ;
...
position p;
@@
 const struct drm_dp_resource_status_notify * cocci_id@p ;
...
position p;
@@
 struct drm_dp_sideband_msg_req_body * cocci_id@p ;
...
position p;
@@
 struct drm_dp_mst_branch cocci_id@p ;
...
position p;
@@
 struct drm_dp_connection_status_notify * cocci_id@p ;
...
position p;
@@
 struct drm_dp_remote_i2c_write * cocci_id@p ;
...
position p;
@@
 struct drm_dp_enum_path_resources_ack_reply * cocci_id@p ;
...
position p;
@@
 struct drm_dp_remote_i2c_read * cocci_id@p ;
...
position p;
@@
 struct drm_dp_sideband_msg_rx cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_dp_mst_topology_mgr * mgr , struct drm_dp_mst_branch * mstb ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct drm_dp_mst_topology_mgr * mgr , char * buf ) ;
...
symbol cocci_id;
position p;
typedef depot_stack_handle_t;
@@
 depot_stack_handle_t cocci_id@p ;
...
typedef u8;
@@
 int cocci_id@p ( struct drm_dp_mst_topology_mgr * mgr , struct drm_dp_mst_port * port , int offset , int size , u8 * bytes ) ;
...
position p;
@@
 const struct drm_dp_sideband_msg_tx * cocci_id@p ;
...
position p;
@@
 const struct drm_dp_remote_i2c_read_tx * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct drm_dp_mst_port * port ) ;
...
position p;
@@
 const struct i2c_msg cocci_id@p [ ] ;
...
position p;
@@
 struct drm_dp_pending_up_req {  struct drm_dp_sideband_msg_hdr hdr ;  struct drm_dp_sideband_msg_req_body msg ;  struct list_head next ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_dp_aux * aux ) ;
...
typedef u8;
@@
 u8 cocci_id@p [ DP_PAYLOAD_TABLE_SIZE ] ;
...
position p;
@@
 struct drm_dp_vcpi_allocation * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_dp_mst_topology_mgr * mgr , int id , struct drm_dp_payload * payload ) ;
