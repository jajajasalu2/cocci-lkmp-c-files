...
typedef u32;
@@
 union {  struct usb_ctrlrequest r ;  u32 word [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pxa_ep * ep ) ;
...
position p;
@@
 struct pxa27x_request cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct pxa_udc * udc ) ;
