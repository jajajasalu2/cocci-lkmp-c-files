...
typedef u64;
@@
 struct sja1105_cgu_pll_ctrl {  u64 pllclksrc ;  u64 msel ;  u64 autoblock ;  u64 psel ;  u64 direct ;  u64 fbsel ;  u64 bypass ;  u64 pd ; } cocci_id@p ;
...
typedef u8;
@@
 u8 cocci_id@p [ SJA1105_SIZE_CGU_CMD ] ;
...
position p;
@@
 struct sja1105_cfg_pad_mii_tx cocci_id@p ;
...
position p;
@@
 struct sja1105_cgu_pll_ctrl cocci_id@p ;
...
typedef u64;
@@
 struct sja1105_cfg_pad_mii_tx {  u64 d32_os ;  u64 d32_ipud ;  u64 d10_os ;  u64 d10_ipud ;  u64 ctrl_os ;  u64 ctrl_ipud ;  u64 clk_os ;  u64 clk_ih ;  u64 clk_ipud ; } cocci_id@p ;
...
typedef u64;
@@
 struct sja1105_cgu_idiv {  u64 clksrc ;  u64 autoblock ;  u64 idiv ;  u64 pd ; } cocci_id@p ;
...
position p;
@@
 struct sja1105_cgu_mii_ctrl cocci_id@p ;
...
position p;
@@
 enum { CLKSRC_MII0_TX_CLK = 0x00 , CLKSRC_MII0_RX_CLK = 0x01 , CLKSRC_MII1_TX_CLK = 0x02 , CLKSRC_MII1_RX_CLK = 0x03 , CLKSRC_MII2_TX_CLK = 0x04 , CLKSRC_MII2_RX_CLK = 0x05 , CLKSRC_MII3_TX_CLK = 0x06 , CLKSRC_MII3_RX_CLK = 0x07 , CLKSRC_MII4_TX_CLK = 0x08 , CLKSRC_MII4_RX_CLK = 0x09 , CLKSRC_PLL0 = 0x0B , CLKSRC_PLL1 = 0x0E , CLKSRC_IDIV0 = 0x11 , CLKSRC_IDIV1 = 0x12 , CLKSRC_IDIV2 = 0x13 , CLKSRC_IDIV3 = 0x14 , CLKSRC_IDIV4 = 0x15 , } cocci_id@p ;
...
position p;
@@
 struct sja1105_cgu_idiv * cocci_id@p ;
...
typedef u64;
@@
 struct sja1105_cgu_mii_ctrl {  u64 clksrc ;  u64 autoblock ;  u64 pd ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef sja1105_mii_role_t;
@@
 sja1105_mii_role_t cocci_id@p ;
...
position p;
@@
 struct sja1105_cfg_pad_mii_id cocci_id@p ;
...
typedef u64;
@@
 struct sja1105_cfg_pad_mii_id {  u64 rxc_stable_ovr ;  u64 rxc_delay ;  u64 rxc_bypass ;  u64 rxc_pd ;  u64 txc_stable_ovr ;  u64 txc_delay ;  u64 txc_bypass ;  u64 txc_pd ; } cocci_id@p ;
...
position p;
@@
 const struct sja1105_private * cocci_id@p ;
