...
position p;
@@
 struct mvebu_pinctrl_soc_info * cocci_id@p ;
...
position p;
@@
 struct mvebu_pinctrl_function {  const char * name ;  const char * * groups ;  unsigned num_groups ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_mpp_ctrl_data * cocci_id@p ;
...
position p;
@@
 struct mvebu_pinctrl_group {  const char * name ;  const struct mvebu_mpp_ctrl * ctrl ;  struct mvebu_mpp_ctrl_data * data ;  struct mvebu_mpp_ctrl_setting * settings ;  unsigned num_settings ;  unsigned gid ;  unsigned * pins ;  unsigned npins ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_pinctrl_function * cocci_id@p ;
...
typedef u8;
@@
 struct mvebu_pinctrl {  struct device * dev ;  struct pinctrl_dev * pctldev ;  struct pinctrl_desc desc ;  struct mvebu_pinctrl_group * groups ;  unsigned num_groups ;  struct mvebu_pinctrl_function * functions ;  unsigned num_functions ;  u8 variant ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_mpp_ctrl_setting * cocci_id@p ;
...
position p;
@@
 struct mvebu_pinctrl_group * cocci_id@p ;
...
position p;
@@
 const struct mvebu_mpp_ctrl * cocci_id@p ;
...
position p;
@@
 struct mvebu_mpp_mode * cocci_id@p ;
...
position p;
@@
 struct mvebu_pinctrl * cocci_id@p ;
