...
@@
 struct mlx5ehdr {  __be32 version ;  __be64 magic ; } cocci_id@p ;
...
position p;
@@
 struct mlx5e_lbt_priv * cocci_id@p ;
...
position p;
@@
 const char cocci_id@p [ MLX5E_ST_NUM ] [ ETH_GSTRING_LEN ] ;
...
typedef bool;
@@
 struct mlx5e_lbt_priv {  struct packet_type pt ;  struct completion comp ;  bool loopback_ok ;  bool local_lb ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p [ MLX5E_ST_NUM ] ) ( struct mlx5e_priv * ) ;
