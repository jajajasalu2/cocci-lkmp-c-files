...
position p;
@@
 enum stm32_dfsdm_jexten { STM32_DFSDM_JEXTEN_DISABLED , STM32_DFSDM_JEXTEN_RISING_EDGE , STM32_DFSDM_JEXTEN_FALLING_EDGE , STM32_DFSDM_EXTEN_BOTH_EDGES , } cocci_id@p ;
...
position p;
@@
 struct stm32_dfsdm_filter * cocci_id@p ;
...
position p;
@@
 struct stm32_dfsdm_adc * cocci_id@p ;
...
position p;
@@
 const struct stm32_dfsdm_dev_data cocci_id@p ;
...
position p;
@@
 const struct stm32_dfsdm_str2field cocci_id@p [ ] ;
...
position p;
@@
 struct stm32_dfsdm_str2field {  const char * name ;  unsigned int val ; } cocci_id@p ;
...
position p;
@@
 const struct stm32_dfsdm_trig_info cocci_id@p [ ] ;
...
position p;
@@
 struct stm32_dfsdm_trig_info {  const char * name ;  unsigned int jextsel ; } cocci_id@p ;
...
position p;
@@
 enum sd_converter_type { DFSDM_AUDIO , DFSDM_IIO , } cocci_id@p ;
...
position p;
@@
 struct stm32_dfsdm_dev_data {  int type ;  int ( * init ) ( struct iio_dev * indio_dev ) ;  unsigned int num_channels ;  const struct regmap_config * regmap_cfg ; } cocci_id@p ;
...
position p;
@@
 struct stm32_dfsdm_channel * cocci_id@p ;
...
position p;
@@
 struct stm32_dfsdm_filter_osr * cocci_id@p ;
