...
position p;
@@
 int cocci_id@p [ MATRIX_5X3_COEF_SIZE ] ;
...
position p;
@@
 unsigned int cocci_id@p [ OSD_OETF_LUT_SIZE ] ;
...
position p;
@@
 enum viu_lut_sel_e { VIU_LUT_OSD_EOTF = 0 , VIU_LUT_OSD_OETF , } cocci_id@p ;
...
position p;
@@
 enum viu_matrix_sel_e { VIU_MATRIX_OSD_EOTF = 0 , VIU_MATRIX_OSD , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p [ EOTF_COEFF_SIZE ] ;
...
position p;
@@
 unsigned int cocci_id@p [ OSD_EOTF_LUT_SIZE ] ;
...
position p;
@@
 enum viu_matrix_sel_e cocci_id@p ;
