...
position p;
@@
 int cocci_id@p ( struct xenbus_device * dev , struct pvcalls_fedata * fedata , struct sock_mapping * map ) ;
...
position p;
@@
 struct pvcalls_data_intf * cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * sock_map ) ;
...
position p;
@@
 struct xen_pvcalls_request cocci_id@p ;
...
position p;
@@
 struct sockpass_mapping * cocci_id@p ;
...
position p;
@@
 struct sock_mapping * cocci_id@p ;
...
position p;
@@
 struct pvcalls_ioworker {  struct work_struct register_work ;  struct workqueue_struct * wq ; } cocci_id@p ;
...
position p;
@@
 struct request_sock_queue * cocci_id@p ;
...
position p;
@@
 struct xen_pvcalls_response * cocci_id@p ;
...
position p;
@@
 struct pvcalls_ioworker cocci_id@p ;
...
position p;
@@
 struct pvcalls_back_global {  struct list_head frontends ;  struct semaphore frontends_lock ; } cocci_id@p ;
...
@@
 struct sockpass_mapping {  struct list_head list ;  struct pvcalls_fedata * fedata ;  struct socket * sock ;  uint64_t id ;  struct xen_pvcalls_request reqcopy ;  spinlock_t copy_lock ;  struct workqueue_struct * wq ;  struct work_struct register_work ;  void ( * saved_data_ready ) ( struct sock * sk ) ; } cocci_id@p ;
...
position p;
@@
 struct pvcalls_data * cocci_id@p ;
...
position p;
@@
 struct pvcalls_fedata {  struct list_head list ;  struct xenbus_device * dev ;  struct xen_pvcalls_sring * sring ;  struct xen_pvcalls_back_ring ring ;  int irq ;  struct list_head socket_mappings ;  struct radix_tree_root socketpass_mappings ;  struct semaphore socket_lock ; } cocci_id@p ;
...
position p;
@@
 struct pvcalls_fedata cocci_id@p ;
