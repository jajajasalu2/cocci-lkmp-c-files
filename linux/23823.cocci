...
position p;
@@
 struct tbf_sched_data * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ TCA_TBF_MAX + 1 ] ;
...
position p;
@@
 const struct tbf_sched_data * cocci_id@p ;
...
position p;
@@
 struct nlattr * cocci_id@p [ TCA_TBF_MAX + 1 ] ;
...
position p;
@@
 const struct psched_ratecfg * cocci_id@p ;
...
position p;
@@
 struct psched_ratecfg cocci_id@p ;
...
typedef u32,s64;
@@
 struct tbf_sched_data {  u32 limit ;  u32 max_size ;  s64 buffer ;  s64 mtu ;  struct psched_ratecfg rate ;  struct psched_ratecfg peak ;  s64 tokens ;  s64 ptokens ;  s64 t_c ;  struct Qdisc * qdisc ;  struct qdisc_watchdog watchdog ; } cocci_id@p ;
