...
position p;
@@
 struct smc_diag_msg * cocci_id@p ;
...
position p;
@@
 struct smc_diag_fallback cocci_id@p ;
...
position p;
@@
 const struct smc_diag_req * cocci_id@p ;
...
position p;
@@
 struct smcd_diag_dmbinfo cocci_id@p ;
...
position p;
@@
 struct smc_diag_lgrinfo cocci_id@p ;
...
position p;
@@
 struct smc_diag_conninfo cocci_id@p ;
