...
position p;
@@
 struct exynos_video_entity * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct fimc_dev * fimc ) ;
...
position p;
@@
 struct fimc_pipeline * cocci_id@p ;
...
position p;
@@
 enum fimc_color_fmt cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct vb2_buffer * vb ) ;
...
position p;
@@
 struct fimc_source_info * cocci_id@p ;
...
position p;
@@
 struct fimc_vid_buffer cocci_id@p ;
...
position p;
@@
 struct v4l2_mbus_frame_desc cocci_id@p ;
...
position p;
@@
 struct v4l2_plane_pix_format cocci_id@p [ FIMC_MAX_PLANES ] ;
...
position p;
@@
 struct fimc_vid_cap * cocci_id@p ;
...
position p;
@@
 const struct fimc_pix_limit * cocci_id@p ;
...
position p;
@@
 const struct fimc_variant * cocci_id@p ;
