...
position p;
@@
 struct lvname {  char name [ 64 ] ; } cocci_id@p ;
...
position p;
@@
 struct lv_info {  unsigned short pps_per_lv ;  unsigned short pps_found ;  unsigned char lv_is_contiguous ; } * cocci_id@p ;
...
typedef __be32;
@@
 struct vgda {  __be32 secs ;  __be32 usec ;  char reserved8 [ 16 ] ;  __be16 numlvs ;  __be16 maxlvs ;  __be16 pp_size ;  __be16 numpvs ;  __be16 total_vgdas ;  __be16 vgda_size ; } cocci_id@p ;
...
position p;
@@
 struct lvd {  __be16 lv_ix ;  __be16 res2 ;  __be16 res4 ;  __be16 maxsize ;  __be16 lv_state ;  __be16 mirror ;  __be16 mirror_policy ;  __be16 num_lps ;  __be16 res10 [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 struct parsed_partitions * cocci_id@p ;
...
position p;
@@
 struct ppe {  __be16 lv_ix ;  unsigned short res2 ;  unsigned short res4 ;  __be16 lp_ix ;  unsigned short res8 [ 12 ] ; } cocci_id@p ;
...
typedef __be32;
@@
 struct pvd {  char reserved0 [ 16 ] ;  __be16 pp_count ;  char reserved18 [ 2 ] ;  __be32 psn_part1 ;  char reserved24 [ 8 ] ;  struct ppe ppe [ 1016 ] ; } cocci_id@p ;
...
typedef __be32;
@@
 struct lvm_rec {  char lvm_id [ 4 ] ;  char reserved4 [ 16 ] ;  __be32 lvmarea_len ;  __be32 vgda_len ;  __be32 vgda_psn [ 2 ] ;  char reserved36 [ 10 ] ;  __be16 pp_size ;  char reserved46 [ 12 ] ;  __be16 version ; } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ sizeof ( n [ i ] . name ) + 1 ] ;
