...
position p;
@@
 int cocci_id@p ( struct iavf_hw * hw ) ;
...
position p;
@@
 int cocci_id@p ( struct iavf_adapter * adapter ) ;
...
position p;
@@
 struct iavf_virt_mem * cocci_id@p ;
...
position p;
@@
 struct iavf_aqc_get_set_rss_key_data * cocci_id@p ;
...
position p;
@@
 struct iavf_dma_mem * cocci_id@p ;
