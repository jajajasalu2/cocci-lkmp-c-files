...
position p;
@@
 enum src_current_status cocci_id@p ;
...
position p;
@@
 const struct fusb302_chip * cocci_id@p ;
...
position p;
@@
 struct fusb302_chip cocci_id@p ;
...
position p;
@@
 enum src_current_status { SRC_CURRENT_DEFAULT , SRC_CURRENT_MEDIUM , SRC_CURRENT_HIGH , } cocci_id@p ;
...
position p;
@@
 enum toggling_mode { TOGGLING_MODE_OFF , TOGGLING_MODE_DRP , TOGGLING_MODE_SNK , TOGGLING_MODE_SRC , } cocci_id@p ;
...
position p;
@@
 char cocci_id@p [ LOG_BUFFER_ENTRY_SIZE ] ;
...
position p;
@@
 const enum src_current_status cocci_id@p [ ] ;
