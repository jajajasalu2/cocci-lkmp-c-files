...
position p;
@@
 struct tegra_ivc_header cocci_id@p ;
...
position p;
@@
 enum tegra_ivc_state { TEGRA_IVC_STATE_ESTABLISHED = 0 , TEGRA_IVC_STATE_SYNC , TEGRA_IVC_STATE_ACK , } cocci_id@p ;
...
position p;
@@
 enum tegra_ivc_state cocci_id@p ;
...
typedef u8,u32;
@@
 struct tegra_ivc_header {  union {  struct {  u32 count ;  u32 state ; } ;  u8 pad [ TEGRA_IVC_ALIGN ] ; } tx ;  union {  u32 count ;  u8 pad [ TEGRA_IVC_ALIGN ] ; } rx ; } cocci_id@p ;
...
position p;
@@
 void ( * cocci_id@p ) ( struct tegra_ivc * ivc , void * data ) ;
