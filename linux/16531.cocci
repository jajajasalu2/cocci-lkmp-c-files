...
typedef u64;
@@
 struct menu_device {  int needs_update ;  int tick_wakeup ;  u64 next_timer_ns ;  unsigned int bucket ;  unsigned int correction_factor [ BUCKETS ] ;  unsigned int intervals [ INTERVALS ] ;  int interval_ptr ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct cpuidle_driver * drv , struct cpuidle_device * dev ) ;
