...
position p;
@@
 struct mt7601u_rxwi * cocci_id@p ;
...
position p;
@@
 struct mt76_tx_status cocci_id@p ;
...
typedef u64,u32;
@@
 struct {  u32 addr_base ;  u32 span ;  u64 * stat_base ; } cocci_id@p [ ] ;
...
position p;
@@
 enum mt76_cipher_type cocci_id@p ;
