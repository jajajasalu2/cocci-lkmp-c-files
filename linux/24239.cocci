...
position p;
@@
 struct ip6_tnl_parm * cocci_id@p ;
...
position p;
@@
 struct ip6_tnl_net {  struct net_device * fb_tnl_dev ;  struct ip6_tnl __rcu * tnls_r_l [ IP6_TUNNEL_HASH_SIZE ] ;  struct ip6_tnl __rcu * tnls_wc [ 1 ] ;  struct ip6_tnl __rcu * * tnls [ 2 ] ;  struct ip6_tnl __rcu * collect_md_tun ; } cocci_id@p ;
...
position p;
@@
 struct ipv6_tel_txoption cocci_id@p ;
...
position p;
@@
 const struct ip6_tnl_encap_ops * cocci_id@p ;
...
typedef __u8;
@@
 struct ipv6_tel_txoption {  struct ipv6_txoptions ops ;  __u8 dst_opt [ 8 ] ; } cocci_id@p ;
...
position p;
@@
 const struct tnl_ptk_info * cocci_id@p ;
...
position p;
@@
 const struct ip6_tnl_parm * cocci_id@p ;
...
position p;
@@
 struct xfrm6_tunnel cocci_id@p ;
...
position p;
@@
 const struct pcpu_sw_netstats * cocci_id@p ;
...
position p;
@@
 const struct ip6_tnl * cocci_id@p ;
...
position p;
@@
 const struct nla_policy cocci_id@p [ IFLA_IPTUN_MAX + 1 ] ;
...
position p;
@@
 struct ipv6_tlv_tnl_enc_lim * cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( const struct ip6_tnl * t , const struct ipv6hdr * ipv6h , struct sk_buff * skb ) ;
