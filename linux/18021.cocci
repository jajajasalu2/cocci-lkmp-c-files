...
position p;
@@
 struct sparc32_cachetlb_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mm_struct * mm ) ;
...
position p;
@@
 void cocci_id@p ( struct vm_area_struct * vma , unsigned long page ) ;
...
position p;
@@
 void cocci_id@p ( struct vm_area_struct * vma , unsigned long start , unsigned long end ) ;
...
position p;
@@
 void cocci_id@p ( struct mm_struct * mm , unsigned long insn_addr ) ;
...
position p;
@@
 struct ctx_list {  struct ctx_list * next ;  struct ctx_list * prev ;  unsigned int ctx_number ;  struct mm_struct * ctx_mm ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long page ) ;
...
position p;
@@
 const struct sparc32_cachetlb_ops cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( unsigned long start , unsigned long end ) ;
...
position p;
@@
 void cocci_id@p ( struct mm_struct * mm , unsigned long addr ) ;
