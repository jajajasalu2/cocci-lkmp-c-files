...
position p;
@@
 struct qat_crypto_request cocci_id@p ;
...
position p;
@@
 enum icp_qat_hw_auth_algo cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_la_auth_req_params * cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_auth_cd_ctrl_hdr * cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_cipher_cd_ctrl_hdr * cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_la_resp * cocci_id@p ;
...
position p;
@@
 struct qat_alg_skcipher_ctx cocci_id@p ;
...
position p;
@@
 struct icp_qat_hw_cipher_algo_blk cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_comn_req_hdr_cd_pars * cocci_id@p ;
...
typedef dma_addr_t;
@@
 struct qat_alg_aead_ctx {  struct qat_alg_cd * enc_cd ;  struct qat_alg_cd * dec_cd ;  dma_addr_t enc_cd_paddr ;  dma_addr_t dec_cd_paddr ;  struct icp_qat_fw_la_bulk_req enc_fw_req ;  struct icp_qat_fw_la_bulk_req dec_fw_req ;  struct crypto_shash * hash_tfm ;  enum icp_qat_hw_auth_algo qat_hash_alg ;  struct qat_crypto_instance * inst ;  union {  struct sha1_state sha1 ;  struct sha256_state sha256 ;  struct sha512_state sha512 ; } ;  char ipad [ SHA512_BLOCK_SIZE ] ;  char opad [ SHA512_BLOCK_SIZE ] ; } cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_la_bulk_req * cocci_id@p ;
...
position p;
@@
 struct qat_alg_aead_ctx cocci_id@p ;
...
position p;
@@
 struct icp_qat_hw_auth_setup cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_la_cipher_req_params cocci_id@p ;
...
position p;
@@
 struct icp_qat_fw_comn_req_hdr * cocci_id@p ;
...
position p;
@@
 struct qat_alg_buf_list * cocci_id@p ;
...
position p;
@@
 struct icp_qat_hw_auth_algo_blk * cocci_id@p ;
