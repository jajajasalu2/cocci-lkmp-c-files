...
position p;
@@
 const struct aper_size_info_fixed cocci_id@p [ ] ;
...
position p;
@@
 const struct agp_bridge_driver cocci_id@p ;
...
position p;
@@
 const struct intel_gtt_driver_description {  unsigned int gmch_chip_id ;  char * name ;  const struct intel_gtt_driver * gtt_driver ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct intel_gtt_driver cocci_id@p ;
...
symbol cocci_id;
position p;
typedef u8,bool,u32,phys_addr_t,resource_size_t;
@@
 struct _intel_private {  const struct intel_gtt_driver * driver ;  struct pci_dev * pcidev ;  struct pci_dev * bridge_dev ;  u8 __iomem * registers ;  phys_addr_t gtt_phys_addr ;  u32 PGETBL_save ;  u32 __iomem * gtt ;  bool clear_fake_agp ;  int num_dcache_entries ;  void __iomem * i9xx_flush_page ;  char * i81x_gtt_table ;  struct resource ifp_resource ;  int resource_valid ;  struct page * scratch_page ;  phys_addr_t scratch_page_dma ;  int refcount ;  unsigned int needs_dmar : 1 ;  phys_addr_t gma_bus_addr ;  resource_size_t stolen_size ;  unsigned int gtt_total_entries ;  unsigned int gtt_mappable_entries ; } cocci_id@p ;
