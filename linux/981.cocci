...
position p;
@@
 const struct spi_nor_controller_ops cocci_id@p ;
...
typedef u8,bool,u32;
@@
 struct cqspi_flash_pdata {  struct spi_nor nor ;  struct cqspi_st * cqspi ;  u32 clk_rate ;  u32 read_delay ;  u32 tshsl_ns ;  u32 tsd2d_ns ;  u32 tchsh_ns ;  u32 tslch_ns ;  u8 inst_width ;  u8 addr_width ;  u8 data_width ;  u8 cs ;  bool registered ;  bool use_direct_mode ; } cocci_id@p ;
...
position p;
@@
 struct spi_nor_hwcaps cocci_id@p ;
...
position p;
@@
 const struct cqspi_driver_platdata cocci_id@p ;
...
position p;
@@
 struct cqspi_flash_pdata * cocci_id@p ;
...
typedef u8,u32;
@@
 struct cqspi_driver_platdata {  u32 hwcaps_mask ;  u8 quirks ; } cocci_id@p ;
