...
typedef u16;
@@
 struct ksz_chip_data {  u16 chip_id ;  const char * dev_name ;  int num_vlans ;  int num_alus ;  int num_statics ;  int cpu_ports ;  int port_cnt ; } cocci_id@p ;
...
position p;
@@
 const struct {  char string [ ETH_GSTRING_LEN ] ; } cocci_id@p [ TOTAL_SWITCH_COUNTER_NUM ] ;
