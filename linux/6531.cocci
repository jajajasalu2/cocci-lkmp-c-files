...
position p;
@@
 struct powertec_info * cocci_id@p ;
...
position p;
@@
 struct powertec_info {  FAS216_Info info ;  struct expansion_card * ec ;  void __iomem * base ;  unsigned int term_ctl ;  struct scatterlist sg [ NR_SG ] ; } cocci_id@p ;
