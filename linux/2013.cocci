...
position p;
@@
 struct mma7660_data {  struct i2c_client * client ;  struct mutex lock ;  enum mma7660_mode mode ; } cocci_id@p ;
...
position p;
@@
 enum mma7660_mode { MMA7660_MODE_STANDBY , MMA7660_MODE_ACTIVE , } cocci_id@p ;
...
position p;
@@
 struct mma7660_data * cocci_id@p ;
