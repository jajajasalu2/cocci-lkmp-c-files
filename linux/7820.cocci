...
position p;
@@
 int cocci_id@p ( unsigned long arg ) ;
...
position p;
@@
 struct mpt_ioctl_iocinfo cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SCSIIORequest_t;
@@
 SCSIIORequest_t * cocci_id@p ;
...
typedef u8;
@@
 struct buflist {  u8 * kptr ;  int len ; } cocci_id@p ;
...
symbol cocci_id;
position p;
typedef hp_target_info_t;
@@
 hp_target_info_t cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SCSIDevicePage0_t;
@@
 SCSIDevicePage0_t * cocci_id@p ;
...
position p;
@@
 struct mpt_ioctl_eventenable cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long arg , unsigned int cmd ) ;
...
position p;
@@
 long cocci_id@p ( struct file * f , unsigned cmd , unsigned long arg ) ;
...
position p;
@@
 struct mpt_ioctl_command cocci_id@p ;
...
position p;
@@
 struct mpt_ioctl_command32 cocci_id@p ;
...
symbol cocci_id;
position p;
typedef pFWDownloadReply_t;
@@
 pFWDownloadReply_t cocci_id@p ;
...
position p;
@@
 struct mpt_ioctl_eventquery cocci_id@p ;
...
position p;
@@
 struct mpt_ioctl_diag_reset cocci_id@p ;
...
symbol cocci_id;
position p;
typedef FWDownloadTCSGE_t;
@@
 FWDownloadTCSGE_t cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct mpt_ioctl_command karg , void __user * mfPtr ) ;
...
symbol cocci_id;
position p;
typedef ToolboxIstwiReadWriteRequest_t;
@@
 ToolboxIstwiReadWriteRequest_t cocci_id@p ;
...
position p;
@@
 struct mpt_ioctl_eventreport cocci_id@p ;
...
symbol cocci_id;
position p;
typedef SCSIDevicePage3_t;
@@
 SCSIDevicePage3_t * cocci_id@p ;
...
position p;
@@
 struct mpt_ioctl_replace_fw cocci_id@p ;
...
position p;
@@
 struct mpt_fw_xfer32 cocci_id@p ;
...
position p;
@@
 struct mpt_ioctl_targetinfo cocci_id@p ;
...
symbol cocci_id;
position p;
typedef FWDownload_t;
@@
 FWDownload_t * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef hp_host_info_t;
@@
 hp_host_info_t cocci_id@p ;
...
position p;
@@
 struct mpt_ioctl_test cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( MPT_ADAPTER * ioc , int reset_phase ) ;
...
position p;
@@
 struct mpt_ioctl_iocinfo_rev1 cocci_id@p ;
...
position p;
@@
 struct mpt_ioctl_iocinfo_rev0 cocci_id@p ;
