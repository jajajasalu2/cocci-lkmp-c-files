...
position p;
@@
 struct ibmvnic_long_term_buff * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ibmvnic_adapter * adapter ) ;
...
position p;
@@
 unsigned long cocci_id@p [ PLPAR_HCALL_BUFSIZE ] ;
...
position p;
@@
 int cocci_id@p ( struct napi_struct * napi , int data ) ;
...
position p;
@@
 struct ibmvnic_login_buffer cocci_id@p ;
...
position p;
@@
 struct ibmvnic_adapter cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct ibmvnic_adapter * , bool ) ;
...
position p;
@@
 struct ibmvnic_tx_queue_stats cocci_id@p ;
...
position p;
@@
 struct ibmvnic_tx_buff * cocci_id@p ;
...
position p;
@@
 union sub_crq * cocci_id@p ( struct ibmvnic_adapter * , struct ibmvnic_sub_crq_queue * ) ;
...
position p;
@@
 struct ibmvnic_login_rsp_buffer * cocci_id@p ;
...
position p;
@@
 struct ibmvnic_rx_queue_stats cocci_id@p ;
...
position p;
@@
 struct ibmvnic_query_ip_offload_buffer * cocci_id@p ;
...
position p;
@@
 struct ibmvnic_generic_crq * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct ibmvnic_adapter * ) ;
...
position p;
@@
 struct ibmvnic_tx_pool cocci_id@p ;
...
typedef u64;
@@
 int cocci_id@p ( struct ibmvnic_adapter * , u64 , u64 , u64 ) ;
...
typedef u64;
@@
 int cocci_id@p ( struct ibmvnic_adapter * adapter , u64 remote_handle , union sub_crq * sub_crq ) ;
...
position p;
@@
 struct ibmvnic_sub_crq_queue * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ibmvnic_adapter * adapter ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct ibmvnic_adapter * , u8 ) ;
...
typedef u8;
@@
 int cocci_id@p ( struct net_device * , u8 * ) ;
...
position p;
@@
 enum ibmvnic_reset_reason cocci_id@p ;
...
position p;
@@
 struct vnic_login_client_data cocci_id@p ;
...
typedef irqreturn_t;
@@
 irqreturn_t cocci_id@p ( int irq , void * instance ) ;
...
position p;
@@
 int cocci_id@p ( struct ibmvnic_adapter * , union ibmvnic_crq * ) ;
...
position p;
@@
 struct ibmvnic_stat {  char name [ ETH_GSTRING_LEN ] ;  int offset ; } cocci_id@p ;
...
position p;
@@
 struct ibmvnic_statistics cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ibmvnic_adapter * , struct ibmvnic_sub_crq_queue * ) ;
...
position p;
@@
 const struct ibmvnic_stat cocci_id@p [ ] ;
...
position p;
@@
 struct ibmvnic_rx_pool * cocci_id@p ;
...
position p;
@@
 struct ibmvnic_rx_buff * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ibmvnic_adapter * ) ;
...
position p;
@@
 struct ibmvnic_crq_queue * cocci_id@p ;
