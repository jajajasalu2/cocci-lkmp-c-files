...
typedef bool;
@@
 struct pci_epc_group {  struct config_group group ;  struct pci_epc * epc ;  bool start ;  unsigned long function_num_map ; } cocci_id@p ;
...
position p;
@@
 struct pci_epf_group cocci_id@p ;
...
position p;
@@
 struct pci_epc_group cocci_id@p ;
...
position p;
@@
 struct pci_epf_group {  struct config_group group ;  struct pci_epf * epf ;  int index ; } cocci_id@p ;
