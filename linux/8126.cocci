...
position p;
@@
 const struct c_can_driver_data * cocci_id@p ;
...
position p;
@@
 struct c_can_driver_data * cocci_id@p ;
...
position p;
@@
 const struct raminit_bits cocci_id@p [ ] ;
...
position p;
@@
 const struct c_can_raminit * cocci_id@p ;
...
position p;
@@
 struct c_can_raminit * cocci_id@p ;
