...
position p;
@@
 struct max30102_data * cocci_id@p ;
...
typedef u8,__be32;
@@
 struct max30102_data {  struct i2c_client * client ;  struct iio_dev * indio_dev ;  struct mutex lock ;  struct regmap * regmap ;  enum max30102_chip_id chip_id ;  u8 buffer [ 12 ] ;  __be32 processed_buffer [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 enum max3012_led_idx { MAX30102_LED_RED , MAX30102_LED_IR , MAX30105_LED_GREEN , } cocci_id@p ;
...
position p;
@@
 enum max30102_chip_id { max30102 , max30105 , } cocci_id@p ;
