...
position p;
@@
 struct msm_fbdev {  struct drm_fb_helper base ;  struct drm_framebuffer * fb ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_gem_object * obj , struct vm_area_struct * vma ) ;
