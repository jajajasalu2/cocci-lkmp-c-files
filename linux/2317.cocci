...
position p;
@@
 enum clock_cooling_property { GET_LEVEL , GET_FREQ , GET_MAXL , } cocci_id@p ;
...
position p;
@@
 enum clock_cooling_property cocci_id@p ;
...
position p;
@@
 struct clock_cooling_device {  int id ;  struct device * dev ;  struct thermal_cooling_device * cdev ;  struct notifier_block clk_rate_change_nb ;  struct cpufreq_frequency_table * freq_table ;  unsigned long clock_state ;  unsigned long clock_val ;  struct clk * clk ;  struct mutex lock ; } cocci_id@p ;
...
position p;
@@
 struct clock_cooling_device cocci_id@p ;
