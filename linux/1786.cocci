...
position p;
@@
 enum vcnl4035_scan_index_order { VCNL4035_CHAN_INDEX_LIGHT , VCNL4035_CHAN_INDEX_WHITE_LED , } cocci_id@p ;
...
position p;
@@
 struct vcnl4035_data * cocci_id@p ;
...
typedef u8,s64,u16;
@@
 u8 cocci_id@p [ ALIGN ( sizeof ( u16 ) , sizeof ( s64 ) ) + sizeof ( s64 ) ] ;
...
position p;
@@
 struct vcnl4035_data {  struct i2c_client * client ;  struct regmap * regmap ;  unsigned int als_it_val ;  unsigned int als_persistence ;  unsigned int als_thresh_low ;  unsigned int als_thresh_high ;  struct iio_trigger * drdy_trigger0 ; } cocci_id@p ;
