...
position p;
@@
 struct pca9532_data * cocci_id@p ;
...
typedef u8;
@@
 struct pca9532_chip_info {  u8 num_leds ; } cocci_id@p ;
...
position p;
@@
 const struct pca9532_chip_info cocci_id@p [ ] ;
...
position p;
@@
 struct pca9532_platform_data * cocci_id@p ;
...
position p;
@@
 enum { pca9530 , pca9531 , pca9532 , pca9533 , } cocci_id@p ;
