...
position p;
@@
 struct wil_ring_tx_status cocci_id@p ;
...
position p;
@@
 struct wil_ring_rx_data * cocci_id@p ;
...
position p;
@@
 struct wil_rx_status_compressed * cocci_id@p ;
...
position p;
@@
 struct wil_rx_status_extended * cocci_id@p ;
