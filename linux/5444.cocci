...
position p;
@@
 enum chips { sc18is602 , sc18is602b , sc18is603 , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct sc18is602 {  struct spi_master * master ;  struct device * dev ;  u8 ctrl ;  u32 freq ;  u32 speed ;  struct i2c_client * client ;  enum chips id ;  u8 buffer [ SC18IS602_BUFSIZ + 1 ] ;  int tlen ;  int rindex ;  struct gpio_desc * reset ; } cocci_id@p ;
...
position p;
@@
 struct sc18is602_platform_data * cocci_id@p ;
