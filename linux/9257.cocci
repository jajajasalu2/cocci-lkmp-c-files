...
position p;
@@
 struct mwifiex_tx_param cocci_id@p ;
...
position p;
@@
 struct mwifiex_bss_prio_tbl * cocci_id@p ;
...
position p;
@@
 struct mwifiex_wmm_ac_status * cocci_id@p ;
...
position p;
@@
 const struct host_cmd_ds_command * cocci_id@p ;
...
position p;
@@
 struct mwifiex_tid_tbl * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_wmm_queue_status * cocci_id@p ;
...
position p;
@@
 struct mwifiex_wmm_desc * cocci_id@p ;
...
position p;
@@
 struct mwifiex_ie_types_wmm_param_set * cocci_id@p ;
...
position p;
@@
 const struct ieee_types_wmm_ac_parameters * cocci_id@p ;
...
position p;
@@
 enum mwifiex_wmm_ac_e cocci_id@p ;
...
position p;
@@
 const enum mwifiex_wmm_ac_e cocci_id@p [ ] ;
