...
position p;
@@
 struct sddr55_card_info * cocci_id@p ;
...
position p;
@@
 struct sddr55_card_info {  unsigned long capacity ;  int max_log_blks ;  int pageshift ;  int smallpageshift ;  int blocksize ;  int blockshift ;  int blockmask ;  int read_only ;  int force_read_only ;  int * lba_to_pba ;  int * pba_to_lba ;  int fatal_error ;  unsigned long last_access ;  unsigned char sense_data [ 18 ] ; } cocci_id@p ;
