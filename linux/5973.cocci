...
position p;
@@
 enum wmt_func_sel { WMT_FSEL_GPIO_IN = 0 , WMT_FSEL_GPIO_OUT = 1 , WMT_FSEL_ALT = 2 , WMT_FSEL_COUNT = 3 , } cocci_id@p ;
...
position p;
@@
 const char * constcocci_id [ WMT_FSEL_COUNT ] ;
...
position p;
@@
 struct wmt_pinctrl_data * cocci_id@p ;
