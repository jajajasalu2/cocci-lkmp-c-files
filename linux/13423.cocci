...
position p;
@@
 struct tm6000_endpoint * cocci_id@p ;
...
position p;
@@
 struct tm6000_board cocci_id@p [ ] ;
...
position p;
@@
 struct tm6000_board {  char * name ;  char eename [ 16 ] ;  unsigned eename_size ;  unsigned eename_pos ;  struct tm6000_capabilities caps ;  enum tm6000_devtype type ;  int tuner_type ;  int tuner_addr ;  int demod_addr ;  struct tm6000_gpio gpio ;  struct tm6000_input vinput [ 3 ] ;  struct tm6000_input rinput ;  char * ir_codes ; } cocci_id@p ;
