...
typedef phys_addr_t;
@@
 struct irqchip_fwid {  struct fwnode_handle fwnode ;  unsigned int type ;  char * name ;  phys_addr_t * pa ; } cocci_id@p ;
...
position p;
@@
 struct irqchip_fwid cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct irq_domain * domain ) ;
...
position p;
@@
 void cocci_id@p ( struct irq_domain * d ) ;
...
position p;
@@
 const struct irq_affinity_desc * cocci_id@p ;
