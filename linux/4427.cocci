...
position p;
@@
 struct aper_size_info_16 * cocci_id@p ;
...
position p;
@@
 const struct aper_size_info_8 cocci_id@p [ 4 ] ;
...
position p;
@@
 const struct aper_size_info_8 cocci_id@p [ 7 ] ;
...
position p;
@@
 const struct aper_size_info_8 cocci_id@p [ 2 ] ;
...
position p;
@@
 const struct intel_agp_driver_description {  unsigned int chip_id ;  char * name ;  const struct agp_bridge_driver * driver ; } cocci_id@p [ ] ;
...
position p;
@@
 const struct aper_size_info_16 cocci_id@p [ 7 ] ;
...
position p;
@@
 struct aper_size_info_8 * cocci_id@p ;
