...
position p;
@@
 struct hb_mc_drvdata cocci_id@p ;
...
position p;
@@
 struct hb_mc_drvdata {  void __iomem * mc_err_base ;  void __iomem * mc_int_base ; } cocci_id@p ;
...
position p;
@@
 struct hb_mc_settings cocci_id@p ;
...
position p;
@@
 const struct hb_mc_settings * cocci_id@p ;
...
position p;
@@
 struct hb_mc_settings {  int err_offset ;  int int_offset ; } cocci_id@p ;
