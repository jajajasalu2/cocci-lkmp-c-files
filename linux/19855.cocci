...
position p;
@@
 enum { ABI_O32 = ( 1 << 0 ) , ABI_N32 = ( 1 << 1 ) , ABI_N64 = ( 1 << 2 ) , ABI_ALL = ABI_O32 | ABI_N32 | ABI_N64 , } cocci_id@p ;
...
position p;
@@
 struct {  const char * name ;  const char * offset_name ;  unsigned int abis ; } cocci_id@p [ ] ;
