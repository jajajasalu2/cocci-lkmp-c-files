...
position p;
@@
 struct shadow_vmcs_field cocci_id@p [ ] ;
...
position p;
@@
 enum nvmx_vmentry_status cocci_id@p ;
...
position p;
@@
 const struct shadow_vmcs_field * cocci_id@p [ ] ;
...
position p;
@@
 struct vmx_msr_entry * cocci_id@p ;
...
position p;
@@
 enum { VMX_VMREAD_BITMAP , VMX_VMWRITE_BITMAP , VMX_BITMAP_NR , } cocci_id@p ;
...
typedef u64;
@@
 struct {  u64 vpid ;  u64 gla ; } cocci_id@p ;
...
typedef u16;
@@
 struct shadow_vmcs_field {  u16 encoding ;  u16 offset ; } cocci_id@p ;
...
position p;
@@
 struct nested_vmx_msrs * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct kvm_vcpu * vcpu , struct vmcs12 * vmcs12 ) ;
...
typedef bool;
@@
 int cocci_id@p ( struct kvm_vcpu * vcpu , bool launch ) ;
...
typedef bool;
@@
 bool cocci_id@p ( struct kvm_vcpu * vcpu , struct vmcs12 * vmcs12 ) ;
...
position p;
@@
 unsigned long * cocci_id@p [ VMX_BITMAP_NR ] ;
...
typedef u64;
@@
 struct {  u64 eptp , gpa ; } cocci_id@p ;
