...
position p;
@@
 struct touchit213 {  struct input_dev * dev ;  struct serio * serio ;  int idx ;  unsigned char csum ;  unsigned char data [ 5 ] ;  char phys [ 32 ] ; } cocci_id@p ;
