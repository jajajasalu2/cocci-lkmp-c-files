...
symbol cocci_id;
position p;
typedef u16,uint,spinlock_t;
@@
 struct egpio_info {  spinlock_t lock ;  void __iomem * base_addr ;  int bus_shift ;  int reg_shift ;  int reg_mask ;  int ack_register ;  int ack_write ;  u16 irqs_enabled ;  uint irq_start ;  int nirqs ;  uint chained_irq ;  struct egpio_chip * chip ;  int nchips ; } cocci_id@p ;
...
position p;
@@
 struct egpio_chip {  int reg_start ;  int cached_values ;  unsigned long is_out ;  struct device * dev ;  struct gpio_chip chip ; } cocci_id@p ;
