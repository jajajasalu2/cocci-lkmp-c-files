...
position p;
@@
 struct bd70528_rtc {  struct rohm_regmap_dev * mfd ;  struct device * dev ; } cocci_id@p ;
...
position p;
@@
 struct bd70528_rtc_alm cocci_id@p ;
...
position p;
@@
 struct bd70528_rtc_wake cocci_id@p ;
...
position p;
@@
 struct bd70528_rtc_data * cocci_id@p ;
...
position p;
@@
 struct rohm_regmap_dev * cocci_id@p ;
...
position p;
@@
 struct bd70528_rtc_day * cocci_id@p ;
