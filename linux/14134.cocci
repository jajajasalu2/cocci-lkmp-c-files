...
position p;
@@
 struct meson_ao_cec_device * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct meson_ao_cec_device {  struct platform_device * pdev ;  void __iomem * base ;  struct clk * core ;  spinlock_t cec_reg_lock ;  struct cec_notifier * notify ;  struct cec_adapter * adap ;  struct cec_msg rx_msg ; } cocci_id@p ;
