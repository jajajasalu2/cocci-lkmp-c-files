...
position p;
@@
 const struct meson_gpio_irq_params cocci_id@p ;
...
position p;
@@
 struct meson_gpio_irq_controller * cocci_id@p ;
...
@@
 struct meson_gpio_irq_controller {  const struct meson_gpio_irq_params * params ;  void __iomem * base ;  u32 channel_irqs [ NUM_CHANNEL ] ; 
...
typedef bool;
@@
 struct meson_gpio_irq_params {  unsigned int nr_hwirq ;  bool support_edge_both ; } cocci_id@p ;
