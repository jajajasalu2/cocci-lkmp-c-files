...
position p;
@@
 struct fixed_voltage_data {  struct regulator_desc desc ;  struct regulator_dev * dev ;  struct clk * enable_clock ;  unsigned int clk_enable_counter ; } cocci_id@p ;
...
position p;
@@
 struct fixed_voltage_data cocci_id@p ;
...
typedef bool;
@@
 struct fixed_dev_type {  bool has_enable_clock ; } cocci_id@p ;
...
position p;
@@
 const struct fixed_dev_type * cocci_id@p ;
