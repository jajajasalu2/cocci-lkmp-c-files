...
typedef u32;
@@
 struct ecp3_dev {  u32 jedec_id ;  char * name ; } cocci_id@p ;
...
position p;
@@
 struct fpga_data {  struct completion fw_loaded ; } cocci_id@p ;
...
position p;
@@
 const struct ecp3_dev cocci_id@p [ ] ;
