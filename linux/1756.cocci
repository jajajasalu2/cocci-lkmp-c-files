...
position p;
@@
 const void * cocci_id@p [ ] [ MAX_VALIDS ] ;
...
position p;
@@
 const struct stm32_timer_trigger_cfg * cocci_id@p ;
...
position p;
@@
 struct stm32_timer_trigger * cocci_id@p ;
...
typedef bool,u32;
@@
 struct stm32_timer_trigger {  struct device * dev ;  struct regmap * regmap ;  struct clk * clk ;  u32 max_arr ;  const void * triggers ;  const void * valids ;  bool has_trgo2 ; } cocci_id@p ;
...
position p;
@@
 struct stm32_timers * cocci_id@p ;
...
position p;
@@
 struct stm32_timer_trigger_cfg {  const void * * valids_table [ MAX_VALIDS ] ;  const unsigned int num_valids_table ; } cocci_id@p ;
...
position p;
@@
 const void * cocci_id@p [ ] [ MAX_TRIGGERS ] ;
