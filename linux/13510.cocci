...
position p;
@@
 struct af9005_device_state cocci_id@p ;
...
typedef u8,u32;
@@
 int ( * cocci_id@p ) ( struct dvb_usb_device * d , u8 * data , int len , u32 * event , int * state ) ;
...
position p;
@@
 enum af9005_usb_table_entry { AFATECH_AF9005 , TERRATEC_AF9005 , ANSONIC_AF9005 , } cocci_id@p ;
...
typedef u8;
@@
 struct af9005_device_state {  u8 sequence ;  int led_state ;  unsigned char data [ 256 ] ; } cocci_id@p ;
