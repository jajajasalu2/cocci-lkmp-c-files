...
position p;
@@
 struct compat_hidp_connadd_req cocci_id@p ;
...
symbol cocci_id;
position p;
typedef __u16,__u32,__u8,compat_uptr_t;
@@
 struct compat_hidp_connadd_req {  int ctrl_sock ;  int intr_sock ;  __u16 parser ;  __u16 rd_size ;  compat_uptr_t rd_data ;  __u8 country ;  __u8 subclass ;  __u16 vendor ;  __u16 product ;  __u16 version ;  __u32 flags ;  __u32 idle_to ;  char name [ 128 ] ; } cocci_id@p ;
...
position p;
@@
 struct hidp_connadd_req cocci_id@p ;
