...
position p;
@@
 struct apq8016_sbc_data * cocci_id@p ;
...
typedef bool;
@@
 struct apq8016_sbc_data {  void __iomem * mic_iomux ;  void __iomem * spkr_iomux ;  struct snd_soc_jack jack ;  bool jack_setup ;  struct snd_soc_dai_link dai_link [ ] ; } cocci_id@p ;
