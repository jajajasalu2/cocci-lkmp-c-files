...
position p;
@@
 struct pm121_correction cocci_id@p [ N_CONTROLS ] [ PM121_NUM_CONFIGS ] ;
...
position p;
@@
 struct smu_sdbp_fvt * cocci_id@p ;
...
position p;
@@
 struct pm121_sys_state cocci_id@p ;
...
position p;
@@
 struct pm121_cpu_state cocci_id@p ;
...
position p;
@@
 struct pm121_connection {  unsigned int control_id ;  unsigned int ref_id ;  struct pm121_correction correction ; } cocci_id@p ;
...
position p;
@@
 struct smu_sdbp_cpupiddata * cocci_id@p ;
...
position p;
@@
 struct smu_sdbp_sensortree * cocci_id@p ;
...
position p;
@@
 struct pm121_sys_param * cocci_id@p ;
...
position p;
@@
 struct wf_control * cocci_id@p [ N_CONTROLS ] ;
...
position p;
@@
 struct pm121_correction {  int offset ;  int slope ; } cocci_id@p ;
...
position p;
@@
 struct pm121_sys_param cocci_id@p [ N_LOOPS ] [ PM121_NUM_CONFIGS ] ;
...
position p;
@@
 struct wf_pid_param cocci_id@p ;
...
position p;
@@
 struct pm121_connection cocci_id@p [ ] ;
...
position p;
@@
 struct pm121_sys_state * cocci_id@p [ N_LOOPS ] ;
...
position p;
@@
 enum { FAILURE_FAN = 1 << 0 , FAILURE_SENSOR = 1 << 1 , FAILURE_OVERTEMP = 1 << 2 , } cocci_id@p ;
...
position p;
@@
 enum { FAN_CPU , FAN_HD , FAN_OD , CPUFREQ , N_CONTROLS , } cocci_id@p ;
...
position p;
@@
 enum { LOOP_GPU , LOOP_HD , LOOP_KODIAK , LOOP_OD , N_LOOPS , } cocci_id@p ;
...
typedef s32;
@@
 struct pm121_cpu_state {  int ticks ;  s32 setpoint ;  struct wf_cpu_pid_state pid ; } cocci_id@p ;
...
position p;
@@
 struct pm121_correction * cocci_id@p ;
...
position p;
@@
 struct wf_cpu_pid_param cocci_id@p ;
...
typedef s32;
@@
 struct pm121_sys_state {  int ticks ;  s32 setpoint ;  struct wf_pid_state pid ; } cocci_id@p ;
