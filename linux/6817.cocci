...
position p;
@@
 enum sdtr_phase { do_sdtr , sdtr_sent , sdtr_done , } cocci_id@p ;
...
position p;
@@
 enum mesh_phase { idle , arbitrating , selecting , commanding , dataing , statusing , busfreeing , disconnecting , reselecting , sleeping , } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mesh_state * ms , struct scsi_cmnd * cmd ) ;
...
position p;
@@
 void cocci_id@p ( struct mesh_state * ms , int start_next ) ;
...
position p;
@@
 enum msg_phase { msg_none , msg_out , msg_out_xxx , msg_out_last , msg_in , msg_in_bad , } cocci_id@p ;
...
typedef u8,u32;
@@
 struct dbglog {  char * fmt ;  u32 tb ;  u8 phase ;  u8 bs0 ;  u8 bs1 ;  u8 tgt ;  int d ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct mesh_state * ms ) ;
