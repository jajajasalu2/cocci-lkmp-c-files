...
position p;
@@
 struct sm501_initdata * cocci_id@p ;
...
position p;
@@
 struct sm501_reg_init * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct sm501_gpio {  struct sm501_gpio_chip low ;  struct sm501_gpio_chip high ;  spinlock_t lock ;  unsigned int registered : 1 ;  void __iomem * regs ;  struct resource * regs_res ; } cocci_id@p ;
...
position p;
@@
 struct sm501_platdata cocci_id@p ;
...
position p;
@@
 struct i2c_gpio_platform_data * cocci_id@p ;
...
position p;
@@
 struct sm501_platdata_gpio_i2c * cocci_id@p ;
...
position p;
@@
 struct sm501_platdata_fbsub cocci_id@p ;
...
position p;
@@
 struct sm501_gpio_chip * cocci_id@p ;
...
position p;
@@
 struct sm501_device * cocci_id@p ;
...
position p;
@@
 struct sm501_device {  struct list_head list ;  struct platform_device pdev ; } cocci_id@p ;
...
position p;
@@
 struct plat_serial8250_port cocci_id@p ;
...
position p;
@@
 struct sm501_gpio_chip {  struct gpio_chip gpio ;  struct sm501_gpio * ourgpio ;  void __iomem * regbase ;  void __iomem * control ; } cocci_id@p ;
...
position p;
@@
 struct sm501_platdata_fb cocci_id@p ;
...
position p;
@@
 struct sm501_devdata * cocci_id@p ;
