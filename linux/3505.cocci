...
typedef u32;
@@
 struct sdhcreg {  u32 sdcontrol_reg ;  u32 sdcmdarg_reg ;  u32 sdbusmode_reg ;  u32 sdblklen_reg ;  u32 sdresp_reg [ 4 ] ;  u32 sdcurblkcnt_reg ;  u32 sdintmask_reg ;  u32 sdstatus_reg ;  u32 sdrsptmo_reg ;  u32 sdclksel_reg ;  u32 sdextctrl_reg ; } cocci_id@p ;
...
position p;
@@
 struct via_crdr_mmc_host cocci_id@p ;
...
typedef u8;
@@
 struct pcictrlreg {  u8 reserve [ 2 ] ;  u8 pciclkgat_reg ;  u8 pcinfcclk_reg ;  u8 pcimscclk_reg ;  u8 pcisdclk_reg ;  u8 pcicaclk_reg ;  u8 pcidmaclk_reg ;  u8 pciintctrl_reg ;  u8 pciintstatus_reg ;  u8 pcitmoctrl_reg ;  u8 Resv ; } cocci_id@p ;
...
position p;
@@
 enum PCI_HOST_CLK_CONTROL { PCI_CLK_375K = 0x03 , PCI_CLK_8M = 0x04 , PCI_CLK_12M = 0x00 , PCI_CLK_16M = 0x05 , PCI_CLK_24M = 0x01 , PCI_CLK_33M = 0x06 , PCI_CLK_48M = 0x02 , } cocci_id@p ;
