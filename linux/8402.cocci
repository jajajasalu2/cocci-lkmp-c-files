...
position p;
@@
 struct ks8851_mll_platform_data * cocci_id@p ;
...
typedef u16;
@@
 struct type_frame_head {  u16 sts ;  u16 len ; } cocci_id@p ;
...
typedef u8;
@@
 union ks_tx_hdr {  u8 txb [ 4 ] ;  __le16 txw [ 2 ] ; } cocci_id@p ;
...
position p;
@@
 struct type_frame_head * cocci_id@p ;
