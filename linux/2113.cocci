...
position p;
@@
 struct syscon_reboot_context cocci_id@p ;
...
typedef u32;
@@
 struct syscon_reboot_context {  struct regmap * map ;  u32 offset ;  u32 value ;  u32 mask ;  struct notifier_block restart_handler ; } cocci_id@p ;
