...
symbol cocci_id;
position p;
typedef json_writer_t;
@@
 json_writer_t * cocci_id@p ;
...
position p;
@@
 const char * const cocci_id@p [ NR_BTF_KINDS ] ;
...
position p;
@@
 struct btf_attach_table cocci_id@p ;
...
position p;
@@
 struct btf_attach_point * cocci_id@p ;
...
typedef __u32;
@@
 struct btf_attach_point {  __u32 obj_id ;  __u32 btf_id ;  struct hlist_node hash ; } cocci_id@p ;
