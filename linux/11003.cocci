...
position p;
@@
 struct tonga_mc_reg_table * cocci_id@p ;
...
position p;
@@
 struct tonga_smumgr * cocci_id@p ;
...
position p;
@@
 SMU72_Discrete_MCRegisterSet * cocci_id@p ;
...
position p;
@@
 SMU72_Discrete_MemoryLevel * cocci_id@p ;
...
position p;
@@
 SMU72_Discrete_GraphicsLevel * cocci_id@p ;
...
position p;
@@
 const struct tonga_smumgr * cocci_id@p ;
...
position p;
@@
 struct SMU72_Discrete_MemoryLevel * cocci_id@p ;
...
position p;
@@
 struct SMU72_Discrete_DpmTable * cocci_id@p ;
...
position p;
@@
 pp_atomctrl_clock_dividers_vi cocci_id@p ;
...
position p;
@@
 pp_atomctrl_gpio_pin_assignment cocci_id@p ;
...
position p;
@@
 SMU72_Discrete_DpmTable cocci_id@p ;
...
position p;
@@
 pp_atomctrl_internal_ss_info cocci_id@p ;
...
position p;
@@
 SMU72_Discrete_MCArbDramTimingTable cocci_id@p ;
...
typedef uint32_t;
@@
 const uint32_t cocci_id@p [ 2 ] [ 4 ] [ 4 ] ;
...
position p;
@@
 struct SMU72_Discrete_Ulv * cocci_id@p ;
...
position p;
@@
 const struct tonga_pt_defaults * cocci_id@p ;
...
position p;
@@
 SMU72_Discrete_MCRegisters * cocci_id@p ;
...
position p;
@@
 pp_atomctrl_mc_reg_table cocci_id@p ;
...
position p;
@@
 const struct tonga_pt_defaults cocci_id@p [ POWERTUNE_DEFAULT_SET_MAX ] ;
...
position p;
@@
 const struct tonga_mc_reg_entry * cocci_id@p ;
...
position p;
@@
 const struct pp_smumgr_func cocci_id@p ;
...
position p;
@@
 struct pp_atomctrl_clock_dividers_vi cocci_id@p ;
...
position p;
@@
 struct SMU72_Discrete_PmFuses cocci_id@p ;
...
position p;
@@
 struct SMU72_Discrete_MCArbDramTimingTableEntry * cocci_id@p ;
...
position p;
@@
 struct SMU72_Discrete_GraphicsLevel * cocci_id@p ;
...
position p;
@@
 const pp_atomctrl_mc_reg_table * cocci_id@p ;
...
position p;
@@
 pp_atomctrl_memory_clock_param cocci_id@p ;
...
position p;
@@
 SMU72_Discrete_FanTable cocci_id@p ;
