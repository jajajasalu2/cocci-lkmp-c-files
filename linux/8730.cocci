...
position p;
@@
 struct qed_ptt_pool * cocci_id@p ;
...
typedef spinlock_t;
@@
 struct qed_ptt_pool {  struct list_head free_list ;  spinlock_t lock ;  struct qed_ptt ptts [ PXP_EXTERNAL_BAR_PF_WINDOW_NUM ] ; } cocci_id@p ;
...
typedef u8;
@@
 struct qed_ptt {  struct list_head list_entry ;  unsigned int idx ;  struct pxp_ptt_entry pxp ;  u8 hwfn_id ; } cocci_id@p ;
...
position p;
@@
 struct pxp_ptt_entry cocci_id@p ;
