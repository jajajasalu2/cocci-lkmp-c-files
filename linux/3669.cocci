...
position p;
@@
 const struct mafield * cocci_id@p ;
...
position p;
@@
 struct dmi_device_attribute cocci_id@p ;
...
position p;
@@
 const struct mafield {  const char * prefix ;  int field ; } cocci_id@p [ ] ;
...
position p;
@@
 struct dmi_device_attribute {  struct device_attribute dev_attr ;  int field ; } cocci_id@p ;
...
position p;
@@
 struct attribute * cocci_id@p [ DMI_STRING_MAX + 2 ] ;
