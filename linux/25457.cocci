...
position p;
@@
 enum { IOTYPE_READ , IOTYPE_WRITE , IOTYPE_SYNC , IOTYPE_TX , IOTYPE_RX , IOTYPE_POLL , } cocci_id@p ;
...
position p;
@@
 struct process_filter {  char * name ;  int pid ;  struct process_filter * next ; } cocci_id@p ;
...
typedef u64;
@@
 struct sample_wrapper {  struct sample_wrapper * next ;  u64 timestamp ;  unsigned char data [ 0 ] ; } cocci_id@p ;
...
typedef u64;
@@
 struct per_pidcomm {  struct per_pidcomm * next ;  u64 start_time ;  u64 end_time ;  u64 total_time ;  u64 max_bytes ;  u64 total_bytes ;  int Y ;  int display ;  long state ;  u64 state_since ;  char * comm ;  struct cpu_sample * samples ;  struct io_sample * io_samples ; } cocci_id@p ;
...
typedef u64;
@@
 struct io_sample {  struct io_sample * next ;  u64 start_time ;  u64 end_time ;  u64 bytes ;  int type ;  int fd ;  int err ;  int merges ; } cocci_id@p ;
...
typedef u64;
@@
 struct per_pid {  struct per_pid * next ;  int pid ;  int ppid ;  u64 start_time ;  u64 end_time ;  u64 total_time ;  u64 total_bytes ;  int display ;  struct per_pidcomm * all ;  struct per_pidcomm * current ; } cocci_id@p ;
...
position p;
@@
 int ( * cocci_id@p ) ( struct timechart * tchart , struct evsel * evsel , struct perf_sample * sample , const char * backtrace ) ;
...
typedef u64;
@@
 struct wake_event {  struct wake_event * next ;  int waker ;  int wakee ;  u64 time ;  const char * backtrace ; } cocci_id@p ;
...
position p;
@@
 struct process_filter * cocci_id@p ;
...
typedef u64;
@@
 struct cpu_sample {  struct cpu_sample * next ;  u64 start_time ;  u64 end_time ;  int type ;  int cpu ;  const char * backtrace ; } cocci_id@p ;
...
typedef u64;
@@
 struct power_event {  struct power_event * next ;  int type ;  int state ;  u64 start_time ;  u64 end_time ;  int cpu ; } cocci_id@p ;
