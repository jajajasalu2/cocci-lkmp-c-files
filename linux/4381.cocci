...
position p;
@@
 struct tpm1_version * cocci_id@p ;
...
position p;
@@
 const struct tis_vendor_durations_override cocci_id@p [ ] ;
...
typedef u32;
@@
 struct tis_vendor_durations_override {  u32 did_vid ;  struct tpm1_version version ;  unsigned long durations [ 3 ] ; } cocci_id@p ;
...
position p;
@@
 const struct tis_vendor_timeout_override cocci_id@p [ ] ;
...
typedef u32;
@@
 struct tis_vendor_timeout_override {  u32 did_vid ;  unsigned long timeout_us [ 4 ] ; } cocci_id@p ;
...
typedef bool;
@@
 void cocci_id@p ( struct tpm_chip * chip , bool value ) ;
