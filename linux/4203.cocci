...
position p;
@@
 enum phy_speed_mode { SPEED_MODE_GEN1 = 0 , SPEED_MODE_GEN2 = 1 , SPEED_MODE_GEN3 = 2 , } cocci_id@p ;
...
position p;
@@
 struct hix5hd2_priv {  void __iomem * base ;  struct regmap * peri_ctrl ; } cocci_id@p ;
