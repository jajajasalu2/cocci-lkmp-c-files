...
position p;
@@
 struct ubifs_old_idx cocci_id@p ;
...
position p;
@@
 const struct fscrypt_name * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct ubifs_info * c , const union ubifs_key * key , struct ubifs_zbranch * zbr , void * node ) ;
...
position p;
@@
 int cocci_id@p ( const struct ubifs_info * c , void * buf , int type , struct ubifs_zbranch * zbr ) ;
...
position p;
@@
 enum { NAME_LESS = 0 , NAME_MATCHES = 1 , NAME_GREATER = 2 , NOT_ON_MEDIA = 3 , } cocci_id@p ;
