...
position p;
@@
 const struct clk_si544_muldiv * cocci_id@p ;
...
position p;
@@
 struct clk_si544_muldiv * cocci_id@p ;
...
position p;
@@
 const struct clk_si544 * cocci_id@p ;
...
position p;
@@
 struct clk_si544 {  struct clk_hw hw ;  struct regmap * regmap ;  struct i2c_client * i2c_client ;  enum si544_speed_grade speed_grade ; } cocci_id@p ;
...
position p;
@@
 enum si544_speed_grade { si544a , si544b , si544c , } cocci_id@p ;
...
@@
 struct clk_si544_muldiv {  u32 fb_div_frac ;  u16 fb_div_int ;  u16 hs_div ;  u8 ls_div_bits ;  s32 delta_m ; } cocci_id@p ;
