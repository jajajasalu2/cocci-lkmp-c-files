...
position p;
@@
 struct adfs_inode_info cocci_id@p ;
...
position p;
@@
 struct adfs_sb_info cocci_id@p ;
...
position p;
@@
 struct adfs_discmap * cocci_id@p ;
...
position p;
@@
 enum { Opt_uid , Opt_gid , Opt_ownmask , Opt_othmask , Opt_ftsuffix , Opt_err , } cocci_id@p ;
