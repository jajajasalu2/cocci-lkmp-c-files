...
position p;
@@
 const struct meson_audio_arb_match_data cocci_id@p ;
...
typedef spinlock_t;
@@
 struct meson_audio_arb_data {  struct reset_controller_dev rstc ;  void __iomem * regs ;  struct clk * clk ;  const unsigned int * reset_bits ;  spinlock_t lock ; } cocci_id@p ;
...
position p;
@@
 struct meson_audio_arb_data * cocci_id@p ;
...
position p;
@@
 struct meson_audio_arb_match_data {  const unsigned int * reset_bits ;  unsigned int reset_num ; } cocci_id@p ;
