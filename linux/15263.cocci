...
position p;
@@
 struct blinkm_led {  struct i2c_client * i2c_client ;  struct led_classdev led_cdev ;  int id ; } cocci_id@p ;
...
typedef u8;
@@
 const struct {  char cmdchar ;  u8 cmdbyte ;  u8 nr_args ;  u8 nr_ret ;  u8 dir : 2 ; } cocci_id@p [ 17 ] ;
...
position p;
@@
 struct blinkm_led * cocci_id@p [ 3 ] ;
...
typedef s8,u8;
@@
 struct blinkm_data {  struct i2c_client * i2c_client ;  struct mutex update_lock ;  struct blinkm_led blinkm_leds [ 3 ] ;  u8 red ;  u8 green ;  u8 blue ;  u8 next_red ;  u8 next_green ;  u8 next_blue ;  u8 args [ 7 ] ;  u8 i2c_addr ;  u8 fw_ver ;  u8 hue ;  u8 saturation ;  u8 brightness ;  u8 next_hue ;  u8 next_saturation ;  u8 next_brightness ;  u8 fade_speed ;  s8 time_adjust ;  u8 fade : 1 ;  u8 rand : 1 ;  u8 script_id ;  u8 script_repeats ;  u8 script_startline ; } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct i2c_client * client , int cmd ) ;
