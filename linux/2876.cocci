...
position p;
@@
 void ACPI_SYSTEM_XFACE cocci_id@p ( void * context ) ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_db_method_info * info , struct acpi_buffer * return_obj ) ;
...
symbol cocci_id;
position p;
typedef acpi_handle,acpi_status,u32;
@@
...
position p;
@@
 struct acpi_db_method_info cocci_id@p ;
...
position p;
@@
 union acpi_object cocci_id@p [ ACPI_DEBUGGER_MAX_ARGS + 1 ] ;
...
position p;
@@
 void ACPI_SYSTEM_XFACE cocci_id@p ;
...
typedef acpi_status;
@@
 acpi_status cocci_id@p ( struct acpi_db_method_info * info ) ;
