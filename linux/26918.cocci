...
position p;
@@
 const struct nfs_diropargs * cocci_id@p ;
...
position p;
@@
 const struct nfs_symlinkargs * cocci_id@p ;
...
position p;
@@
 unsigned int cocci_id@p [ ARRAY_SIZE ( nfs_procedures ) ] ;
...
position p;
@@
 const struct nfs_sattrargs * cocci_id@p ;
...
position p;
@@
 const struct nfs_linkargs * cocci_id@p ;
...
position p;
@@
 const struct nfs_readdirargs * cocci_id@p ;
...
position p;
@@
 const struct nfs_readlinkargs * cocci_id@p ;
...
position p;
@@
 const struct nfs_createargs * cocci_id@p ;
