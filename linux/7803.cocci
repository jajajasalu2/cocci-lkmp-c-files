...
typedef u8;
@@
 struct gsm_msg {  struct list_head list ;  u8 addr ;  u8 ctrl ;  unsigned int len ;  unsigned char * data ;  unsigned char buffer [ 0 ] ; } cocci_id@p ;
...
position p;
@@
 struct gsm_mux_net {  struct kref ref ;  struct gsm_dlci * dlci ; } cocci_id@p ;
...
position p;
@@
 struct gsm_netconfig * cocci_id@p ;
...
typedef u8;
@@
 struct gsm_control {  u8 cmd ;  u8 * data ;  int len ;  int done ;  int error ; } cocci_id@p ;
...
position p;
@@
 const struct gsm_dlci * cocci_id@p ;
...
position p;
@@
 struct gsm_mux * cocci_id@p [ MAX_MUX ] ;
...
position p;
@@
 void cocci_id@p ( struct gsm_dlci * dlci ) ;
