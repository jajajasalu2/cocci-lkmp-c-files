...
position p;
@@
 int cocci_id@p ( struct pci_dev * dp , const struct pci_device_id * ) ;
...
position p;
@@
 struct chips_init_reg {  unsigned char addr ;  unsigned char data ; } cocci_id@p ;
...
position p;
@@
 struct chips_init_reg cocci_id@p [ ] ;
