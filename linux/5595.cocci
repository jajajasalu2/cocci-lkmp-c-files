...
position p;
@@
 struct xlnx_rtc_dev * cocci_id@p ;
...
position p;
@@
 struct xlnx_rtc_dev {  struct rtc_device * rtc ;  void __iomem * reg_base ;  int alarm_irq ;  int sec_irq ;  unsigned int calibval ; } cocci_id@p ;
