...
position p;
@@
 struct WMM_para_element cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct adapter * padapter , unsigned char rate ) ;
...
position p;
@@
 unsigned char cocci_id@p ( unsigned char rate ) ;
...
position p;
@@
 unsigned int cocci_id@p ( struct adapter * padapter , unsigned char * rateset ) ;
...
position p;
@@
 struct cam_entry_cache cocci_id@p ;
