...
typedef u16;
@@
 struct vesa_mode {  char index [ 6 ] ;  u16 lfb_width ;  u16 lfb_height ;  u16 lfb_depth ; } cocci_id@p ;
...
position p;
@@
 const struct modeinit cocci_id@p [ ] ;
...
symbol cocci_id;
position p;
typedef u8,u32,u16,u_int;
@@
 struct smtcfb_info {  struct pci_dev * pdev ;  struct fb_info * fb ;  u16 chip_id ;  u8 chip_rev_id ;  void __iomem * lfb ;  void __iomem * dp_regs ;  void __iomem * vp_regs ;  void __iomem * cp_regs ;  void __iomem * mmio ;  u_int width ;  u_int height ;  u_int hz ;  u32 colreg [ 17 ] ; } cocci_id@p ;
...
position p;
@@
 const struct vesa_mode cocci_id@p [ ] ;
