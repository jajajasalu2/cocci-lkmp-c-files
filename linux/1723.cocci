...
position p;
@@
 struct adis16480 {  const struct adis16480_chip_info * chip_info ;  struct adis adis ;  struct clk * ext_clk ;  enum adis16480_clock_mode clk_mode ;  unsigned int clk_freq ; } cocci_id@p ;
...
position p;
@@
 enum adis16480_int_pin cocci_id@p ;
...
position p;
@@
 const struct adis_data cocci_id@p ;
...
position p;
@@
 enum adis16480_clock_mode { ADIS16480_CLK_SYNC , ADIS16480_CLK_PPS , ADIS16480_CLK_INT , } cocci_id@p ;
...
position p;
@@
 enum adis16480_int_pin { ADIS16480_PIN_DIO1 , ADIS16480_PIN_DIO2 , ADIS16480_PIN_DIO3 , ADIS16480_PIN_DIO4 , } cocci_id@p ;
...
typedef bool;
@@
 struct adis16480_chip_info {  unsigned int num_channels ;  const struct iio_chan_spec * channels ;  unsigned int gyro_max_val ;  unsigned int gyro_max_scale ;  unsigned int accel_max_val ;  unsigned int accel_max_scale ;  unsigned int temp_scale ;  unsigned int int_clk ;  unsigned int max_dec_rate ;  const unsigned int * filter_freqs ;  bool has_pps_clk_mode ; } cocci_id@p ;
...
position p;
@@
 enum { ADIS16480_SCAN_GYRO_X , ADIS16480_SCAN_GYRO_Y , ADIS16480_SCAN_GYRO_Z , ADIS16480_SCAN_ACCEL_X , ADIS16480_SCAN_ACCEL_Y , ADIS16480_SCAN_ACCEL_Z , ADIS16480_SCAN_MAGN_X , ADIS16480_SCAN_MAGN_Y , ADIS16480_SCAN_MAGN_Z , ADIS16480_SCAN_BARO , ADIS16480_SCAN_TEMP , } cocci_id@p ;
...
position p;
@@
 const struct adis16480_chip_info cocci_id@p [ ] ;
...
position p;
@@
 const unsigned int cocci_id@p [ ] [ 2 ] ;
...
position p;
@@
 enum adis16480_variant { ADIS16375 , ADIS16480 , ADIS16485 , ADIS16488 , ADIS16495_1 , ADIS16495_2 , ADIS16495_3 , ADIS16497_1 , ADIS16497_2 , ADIS16497_3 , } cocci_id@p ;
