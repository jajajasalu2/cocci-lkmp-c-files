...
position p;
@@
 struct balloon_stats cocci_id@p ;
...
position p;
@@
 enum bp_state { BP_DONE , BP_WAIT , BP_EAGAIN , BP_ECANCELED , } cocci_id@p ;
...
typedef xen_pfn_t;
@@
 xen_pfn_t cocci_id@p [ PAGE_SIZE / sizeof ( xen_pfn_t ) ] ;
