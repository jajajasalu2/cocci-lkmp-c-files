...
@@
 struct detached_dev_io_private {  struct bcache_device * d ;  unsigned long start_time ;  bio_end_io_t * bi_end_io ;  void * bi_private ; } cocci_id@p ;
...
position p;
@@
 struct detached_dev_io_private cocci_id@p ;
...
position p;
@@
 struct search {  struct closure cl ;  struct bbio bio ;  struct bio * orig_bio ;  struct bio * cache_miss ;  struct bcache_device * d ;  unsigned int insert_bio_sectors ;  unsigned int recoverable : 1 ;  unsigned int write : 1 ;  unsigned int read_dirty_data : 1 ;  unsigned int cache_missed : 1 ;  unsigned long start_time ;  struct btree_op op ;  struct data_insert_op iop ; } cocci_id@p ;
...
position p;
@@
 struct data_insert_op * cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct closure * cl ) ;
...
position p;
@@
 const struct cache_set * cocci_id@p ;
