...
@@
 struct xiic_i2c {  struct device * dev ;  void __iomem * base ;  wait_queue_head_t wait ;  struct i2c_adapter adap ;  struct i2c_msg * tx_msg ;  struct mutex lock ;  unsigned int tx_pos ;  unsigned int nmsgs ;  enum xilinx_i2c_state state ;  struct i2c_msg * rx_msg ;  int rx_pos ;  enum xiic_endian endianness ;  struct clk * clk ; } cocci_id@p ;
...
position p;
@@
 void cocci_id@p ( struct xiic_i2c * i2c ) ;
...
position p;
@@
 enum xiic_endian { LITTLE , BIG , } cocci_id@p ;
...
position p;
@@
 enum xilinx_i2c_state { STATE_DONE , STATE_ERROR , STATE_START , } cocci_id@p ;
