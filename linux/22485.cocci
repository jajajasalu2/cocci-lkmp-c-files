...
typedef __le32;
@@
 struct ichdev {  unsigned int ichd ;  unsigned long reg_offset ;  __le32 * bdbar ;  unsigned int bdbar_addr ;  struct snd_pcm_substream * substream ;  unsigned int physbuf ;  unsigned int size ;  unsigned int fragsize ;  unsigned int fragsize1 ;  unsigned int position ;  int frags ;  int lvi ;  int lvi_frag ;  int civ ;  int ack ;  int ack_reload ;  unsigned int ack_bit ;  unsigned int roff_sr ;  unsigned int roff_picb ;  unsigned int int_sta_mask ;  unsigned int ali_slot ;  struct snd_ac97 * ac97 ; } cocci_id@p ;
...
position p;
@@
 enum { ALID_MDMIN , ALID_MDMOUT , ALID_MDMLAST = ALID_MDMOUT , } cocci_id@p ;
...
position p;
@@
 enum { DEVICE_INTEL , DEVICE_SIS , DEVICE_ALI , DEVICE_NFORCE , } cocci_id@p ;
...
position p;
@@
 struct ich_reg_info cocci_id@p [ 2 ] ;
...
position p;
@@
 enum { ICHD_MDMIN , ICHD_MDMOUT , ICHD_MDMLAST = ICHD_MDMOUT , } cocci_id@p ;
