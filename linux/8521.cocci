...
position p;
@@
 struct emac_adapter * cocci_id@p ;
...
position p;
@@
 struct emac_tx_queue * cocci_id@p ;
...
position p;
@@
 struct emac_ring_header * cocci_id@p ;
...
position p;
@@
 struct emac_rx_queue * cocci_id@p ;
...
typedef u32;
@@
 struct emac_skb_cb {  u32 tpd_idx ;  unsigned long jiffies ; } cocci_id@p ;
