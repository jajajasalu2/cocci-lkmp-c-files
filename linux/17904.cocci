...
position p;
@@
 enum direction { load , store , both , fpload , fpstore , invalid , } cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( unsigned long * dest_reg , int size , unsigned long * saddr , int is_signed ) ;
...
position p;
@@
 int cocci_id@p ( unsigned long * dst_addr , int size , unsigned long * src_val ) ;
