...
position p;
@@
 const struct ch7006_mode * cocci_id@p ;
...
position p;
@@
 struct ch7006_encoder_params * cocci_id@p ;
...
position p;
@@
 struct ch7006_state * cocci_id@p ;
...
position p;
@@
 const struct ch7006_tv_norm_info * cocci_id@p ;
