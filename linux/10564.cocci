...
position p;
@@
 struct dram_dimm_info cocci_id@p ;
...
typedef u32;
@@
 struct vlv_s0ix_state {  u32 wr_watermark ;  u32 gfx_prio_ctrl ;  u32 arb_mode ;  u32 gfx_pend_tlb0 ;  u32 gfx_pend_tlb1 ;  u32 lra_limits [ GEN7_LRA_LIMITS_REG_NUM ] ;  u32 media_max_req_count ;  u32 gfx_max_req_count ;  u32 render_hwsp ;  u32 ecochk ;  u32 bsd_hwsp ;  u32 blt_hwsp ;  u32 tlb_rd_addr ;  u32 g3dctl ;  u32 gsckgctl ;  u32 mbctl ;  u32 ucgctl1 ;  u32 ucgctl3 ;  u32 rcgctl1 ;  u32 rcgctl2 ;  u32 rstctl ;  u32 misccpctl ;  u32 gfxpause ;  u32 rpdeuhwtc ;  u32 rpdeuc ;  u32 ecobus ;  u32 pwrdwnupctl ;  u32 rp_down_timeout ;  u32 rp_deucsw ;  u32 rcubmabdtmr ;  u32 rcedata ;  u32 spare2gh ;  u32 gt_imr ;  u32 gt_ier ;  u32 pm_imr ;  u32 pm_ier ;  u32 gt_scratch [ GEN7_GT_SCRATCH_REG_NUM ] ;  u32 tilectl ;  u32 gt_fifoctl ;  u32 gtlc_wake_ctrl ;  u32 gtlc_survive ;  u32 pmwgicz ;  u32 gu_ctl0 ;  u32 gu_ctl1 ;  u32 pcbr ;  u32 clock_gate_dis2 ; } cocci_id@p ;
...
position p;
@@
 struct vlv_s0ix_state * cocci_id@p ;
...
position p;
@@
 struct dram_channel_info * cocci_id@p ;
...
position p;
@@
 const struct dram_dimm_info * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct drm_i915_private * dev_priv ) ;
...
position p;
@@
 enum i915_drm_suspend_mode cocci_id@p ;
...
typedef bool;
@@
 int cocci_id@p ( struct drm_i915_private * dev_priv , bool rpm_resume ) ;
...
position p;
@@
 enum intel_dram_type cocci_id@p ;
...
position p;
@@
 struct intel_runtime_pm * cocci_id@p ;
...
position p;
@@
 const struct dram_channel_info * cocci_id@p ;
