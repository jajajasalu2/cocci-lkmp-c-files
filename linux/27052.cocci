...
position p;
@@
 struct xfs_error_init {  char * name ;  int max_retries ;  int retry_timeout ; } cocci_id@p ;
...
position p;
@@
 const struct xfs_error_init cocci_id@p [ XFS_ERR_ERRNO_MAX ] ;
...
position p;
@@
 struct xfs_sysfs_attr cocci_id@p ;
...
position p;
@@
 const struct xfs_error_init cocci_id@p [ ] ;
