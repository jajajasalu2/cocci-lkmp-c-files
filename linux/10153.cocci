...
position p;
@@
 const struct sdw_master_port_ops * cocci_id@p ;
...
position p;
@@
 struct sdw_port_runtime * cocci_id@p ;
...
position p;
@@
 struct sdw_bus_params cocci_id@p ;
...
position p;
@@
 const struct sdw_slave_ops * cocci_id@p ;
...
position p;
@@
 struct sdw_master_runtime * cocci_id@p ;
...
position p;
@@
 struct sdw_dpn_prop * cocci_id@p ;
...
position p;
@@
 struct sdw_stream_config * cocci_id@p ;
...
position p;
@@
 enum sdw_data_direction cocci_id@p ;
...
position p;
@@
 struct sdw_stream_runtime * cocci_id@p ;
...
position p;
@@
 struct sdw_enable_ch cocci_id@p ;
...
position p;
@@
 struct sdw_port_params * cocci_id@p ;
...
position p;
@@
 struct sdw_master_prop * cocci_id@p ;
...
position p;
@@
 struct sdw_prepare_ch cocci_id@p ;
...
position p;
@@
 struct sdw_port_config * cocci_id@p ;
...
position p;
@@
 struct sdw_slave_runtime * cocci_id@p ;
...
position p;
@@
 struct sdw_transport_params * cocci_id@p ;
...
position p;
@@
 struct sdw_slave_prop * cocci_id@p ;
...
position p;
@@
 const struct sdw_master_ops * cocci_id@p ;
...
position p;
@@
 enum sdw_port_prep_ops cocci_id@p ;
