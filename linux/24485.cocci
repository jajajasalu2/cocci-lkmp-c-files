...
position p;
@@
 struct rds_get_mr_args * cocci_id@p ;
...
position p;
@@
 struct rds_free_mr_args cocci_id@p ;
...
position p;
@@
 struct rds_atomic_args * cocci_id@p ;
...
symbol cocci_id;
position p;
typedef rds_rdma_cookie_t;
@@
 rds_rdma_cookie_t cocci_id@p ;
...
position p;
@@
 struct rds_get_mr_for_dest_args cocci_id@p ;
