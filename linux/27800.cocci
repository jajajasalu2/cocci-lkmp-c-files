...
position p;
@@
 struct dlm_proxy_ast * cocci_id@p ;
...
position p;
@@
 int cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock * lock ) ;
...
position p;
@@
 void cocci_id@p ( struct dlm_ctxt * dlm , struct dlm_lock_resource * res , struct dlm_lock * lock ) ;
