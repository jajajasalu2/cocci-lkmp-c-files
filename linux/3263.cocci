...
position p;
@@
 struct attribute * cocci_id@p [ 8 ] [ 5 ] ;
...
position p;
@@
 const struct attribute_group cocci_id@p [ 6 ] ;
...
typedef u8;
@@
 struct pc87427_sio_data {  unsigned short address [ 2 ] ;  u8 has_fanin ;  u8 has_fanout ; } cocci_id@p ;
...
position p;
@@
 struct pc87427_data cocci_id@p ;
...
position p;
@@
 struct pc87427_sio_data * cocci_id@p ;
...
@@
 struct pc87427_data {  struct device * hwmon_dev ;  struct mutex lock ;  int address [ 2 ] ;  const char * name ;  unsigned long last_updated ;  u8 fan_enabled ;  u16 fan [ 8 ] ;  u16 fan_min [ 8 ] ;  u8 fan_status [ 8 ] ;  u8 pwm_enabled ;  u8 pwm_auto_ok ;  u8 pwm_enable [ 4 ] ;  u8 pwm [ 4 ] ;  u8 temp_enabled ;  s16 temp [ 6 ] ;  s8 temp_min [ 6 ] ;  s8 temp_max [ 6 ] ;  s8 temp_crit [ 6 ] ;  u8 temp_status [ 6 ] ;  u8 temp_type [ 6 ] ; } cocci_id@p ;
...
position p;
@@
 struct attribute * cocci_id@p [ 6 ] [ 10 ] ;
...
position p;
@@
 const struct attribute_group cocci_id@p [ 8 ] ;
...
position p;
@@
 struct attribute * cocci_id@p [ 4 ] [ 3 ] ;
...
position p;
@@
 const struct pc87427_sio_data * cocci_id@p ;
