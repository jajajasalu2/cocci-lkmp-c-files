...
symbol cocci_id;
position p;
typedef atmio16_board_t;
@@
 const struct atmio16_board_t cocci_id@p [ ] ;
...
typedef atmio16_board_t;
@@
 struct atmio16_board_t cocci_id@p ;
...
position p;
@@
 struct atmio16d_private * cocci_id@p ;
...
typedef atmio16_board_t;
@@
 struct atmio16_board_t {  const char * name ;  int has_8255 ; } cocci_id@p ;
