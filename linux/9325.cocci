...
position p;
@@
 struct wl1251_filter_params * cocci_id@p ;
...
position p;
@@
 struct wl1251_cmd_set_keys * cocci_id@p ;
...
position p;
@@
 struct tx_double_buffer_desc cocci_id@p ;
...
typedef u8,bool;
@@
 struct wl1251_filter_params {  bool enabled ;  int mc_list_length ;  u8 mc_list [ ACX_MC_ADDRESS_GROUP_MAX ] [ ETH_ALEN ] ; } cocci_id@p ;
