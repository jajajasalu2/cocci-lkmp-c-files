...
position p;
@@
 struct stb0899_state cocci_id@p ;
...
position p;
@@
 const struct stb0899_tab * cocci_id@p ;
...
position p;
@@
 struct stb0899_params * cocci_id@p ;
...
position p;
@@
 struct stb0899_internal * cocci_id@p ;
...
position p;
@@
 const struct stb0899_postproc * cocci_id@p ;
