...
position p;
@@
 const struct mvebu_comphy_conf * cocci_id@p ;
...
position p;
@@
 struct mvebu_comphy_lane {  struct mvebu_comphy_priv * priv ;  unsigned id ;  enum phy_mode mode ;  int submode ;  int port ; } cocci_id@p ;
...
typedef u32;
@@
 struct mvebu_comphy_conf {  enum phy_mode mode ;  int submode ;  unsigned lane ;  unsigned port ;  u32 mux ;  u32 fw_mode ; } cocci_id@p ;
...
position p;
@@
 struct mvebu_comphy_priv * cocci_id@p ;
...
position p;
@@
 struct mvebu_comphy_lane * cocci_id@p ;
...
position p;
@@
 struct mvebu_comphy_priv {  void __iomem * base ;  struct regmap * regmap ;  struct device * dev ;  struct clk * mg_domain_clk ;  struct clk * mg_core_clk ;  struct clk * axi_clk ;  unsigned long cp_phys ; } cocci_id@p ;
