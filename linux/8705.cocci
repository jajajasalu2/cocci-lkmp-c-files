...
position p;
@@
 struct iavf_tx_buffer cocci_id@p ;
...
position p;
@@
 struct iavf_tx_desc * cocci_id@p ;
...
position p;
@@
 struct iavf_rx_buffer cocci_id@p ;
...
position p;
@@
 struct iavf_rx_ptype_decoded cocci_id@p ;
...
position p;
@@
 union iavf_32byte_rx_desc cocci_id@p ;
...
position p;
@@
 struct iavf_tx_context_desc * cocci_id@p ;
...
position p;
@@
 struct iavf_ring_container * cocci_id@p ;
