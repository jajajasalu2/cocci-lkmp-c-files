...
typedef bool,u32;
@@
 struct rotary_encoder {  struct input_dev * input ;  struct mutex access_mutex ;  u32 steps ;  u32 axis ;  bool relative_axis ;  bool rollover ;  enum rotary_encoder_encoding encoding ;  unsigned int pos ;  struct gpio_descs * gpios ;  unsigned int * irq ;  bool armed ;  signed char dir ;  unsigned int last_stable ; } cocci_id@p ;
...
position p;
@@
 struct rotary_encoder * cocci_id@p ;
...
position p;
@@
 enum rotary_encoder_encoding { ROTENC_GRAY , ROTENC_BINARY , } cocci_id@p ;
