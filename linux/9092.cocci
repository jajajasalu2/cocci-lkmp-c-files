...
position p;
@@
 struct mlx5e_swp_spec cocci_id@p ;
...
position p;
@@
 enum { MLX5E_IPSEC_RX_SYNDROME_DECRYPTED = 0x11 , MLX5E_IPSEC_RX_SYNDROME_AUTH_FAILED = 0x12 , MLX5E_IPSEC_RX_SYNDROME_BAD_PROTO = 0x17 , } cocci_id@p ;
...
position p;
@@
 enum { MLX5E_IPSEC_TX_SYNDROME_OFFLOAD = 0x8 , MLX5E_IPSEC_TX_SYNDROME_OFFLOAD_WITH_LSO_TCP = 0x9 , } cocci_id@p ;
...
position p;
@@
 struct mlx5e_ipsec_metadata * cocci_id@p ;
...
position p;
@@
 struct mlx5e_ipsec_sa_entry * cocci_id@p ;
