...
position p;
@@
 struct sensor_device_attribute_2 cocci_id@p [ 3 ] [ 9 ] ;
...
position p;
@@
 struct f71882fg_sio_data cocci_id@p ;
...
position p;
@@
 struct sensor_device_attribute_2 cocci_id@p [ 3 ] [ 14 ] ;
...
typedef s8,u8,u16;
@@
 struct f71882fg_data {  unsigned short addr ;  enum chips type ;  struct device * hwmon_dev ;  struct mutex update_lock ;  int temp_start ;  char valid ;  char auto_point_temp_signed ;  unsigned long last_updated ;  unsigned long last_limits ;  u8 in [ F71882FG_MAX_INS ] ;  u8 in1_max ;  u8 in_status ;  u8 in_beep ;  u16 fan [ 4 ] ;  u16 fan_target [ 4 ] ;  u16 fan_full_speed [ 4 ] ;  u8 fan_status ;  u8 fan_beep ;  u16 temp [ 4 ] ;  u8 temp_ovt [ 4 ] ;  u8 temp_high [ 4 ] ;  u8 temp_hyst [ 2 ] ;  u8 temp_type [ 4 ] ;  u8 temp_status ;  u8 temp_beep ;  u8 temp_diode_open ;  u8 temp_config ;  u8 pwm [ 4 ] ;  u8 pwm_enable ;  u8 pwm_auto_point_hyst [ 2 ] ;  u8 pwm_auto_point_mapping [ 4 ] ;  u8 pwm_auto_point_pwm [ 4 ] [ 5 ] ;  s8 pwm_auto_point_temp [ 4 ] [ 4 ] ; } cocci_id@p ;
...
position p;
@@
 const struct f71882fg_sio_data * cocci_id@p ;
...
position p;
@@
 enum chips { f71808e , f71808a , f71858fg , f71862fg , f71868a , f71869 , f71869a , f71882fg , f71889fg , f71889ed , f71889a , f8000 , f81768d , f81865f , f81866a , } cocci_id@p ;
...
position p;
@@
 ssize_t cocci_id@p ( struct device * dev , struct device_attribute * devattr , char * buf ) ;
...
position p;
@@
 const char cocci_id@p [ ] [ F71882FG_MAX_INS ] ;
...
position p;
@@
 struct sensor_device_attribute_2 * cocci_id@p ;
...
position p;
@@
 struct sensor_device_attribute_2 cocci_id@p [ 3 ] [ 7 ] ;
...
position p;
@@
 int cocci_id@p ( int base , int reg ) ;
...
position p;
@@
 struct sensor_device_attribute_2 cocci_id@p [ 3 ] [ 8 ] ;
...
position p;
@@
 struct sensor_device_attribute_2 cocci_id@p [ 3 ] [ 2 ] ;
...
position p;
@@
 struct f71882fg_data * cocci_id@p ;
...
position p;
@@
 struct sensor_device_attribute_2 cocci_id@p [ 4 ] [ 14 ] ;
...
position p;
@@
 void cocci_id@p ( int base , int ld ) ;
...
position p;
@@
 struct sensor_device_attribute_2 cocci_id@p [ 4 ] [ 6 ] ;
...
position p;
@@
 struct f71882fg_sio_data {  enum chips type ; } cocci_id@p ;
