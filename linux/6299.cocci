...
position p;
@@
 const struct tps80031_pupd_data cocci_id@p [ ] ;
...
position p;
@@
 int cocci_id@p [ TPS80031_NUM_SLAVES ] ;
...
typedef u8;
@@
 struct tps80031_pupd_data {  u8 reg ;  u8 pullup_bit ;  u8 pulldown_bit ; } cocci_id@p ;
...
position p;
@@
 struct tps80031_pupd_init_data * cocci_id@p ;
