...
position p;
@@
 struct hwrm_queue_cos2bw_cfg_input cocci_id@p ;
...
position p;
@@
 struct hwrm_fw_get_structured_data_input cocci_id@p ;
...
position p;
@@
 struct hwrm_queue_dscp_qcaps_input cocci_id@p ;
...
position p;
@@
 struct hwrm_queue_dscp2pri_cfg_input cocci_id@p ;
...
position p;
@@
 struct hwrm_queue_cos2bw_qcfg_input cocci_id@p ;
...
position p;
@@
 struct hwrm_queue_dscp_qcaps_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_queue_pfcenable_qcfg_input cocci_id@p ;
...
position p;
@@
 struct bnxt_cos2bw_cfg cocci_id@p ;
...
position p;
@@
 struct bnxt_dscp2pri_entry * cocci_id@p ;
...
position p;
@@
 struct hwrm_fw_set_structured_data_input cocci_id@p ;
...
position p;
@@
 struct hwrm_queue_pri2cos_cfg_input cocci_id@p ;
...
position p;
@@
 struct hwrm_queue_pfcenable_qcfg_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_queue_pfcenable_cfg_input cocci_id@p ;
...
position p;
@@
 struct hwrm_queue_cos2bw_qcfg_output * cocci_id@p ;
...
position p;
@@
 struct hwrm_struct_hdr * cocci_id@p ;
...
position p;
@@
 struct hwrm_struct_data_dcbx_app * cocci_id@p ;
