...
position p;
@@
 struct st7789v {  struct drm_panel panel ;  struct spi_device * spi ;  struct gpio_desc * reset ;  struct backlight_device * backlight ;  struct regulator * power ; } cocci_id@p ;
...
position p;
@@
 enum st7789v_prefix { ST7789V_COMMAND = 0 , ST7789V_DATA = 1 , } cocci_id@p ;
...
position p;
@@
 enum st7789v_prefix cocci_id@p ;
