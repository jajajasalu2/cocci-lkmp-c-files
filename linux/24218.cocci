...
position p;
@@
 const struct ipv6_opt_hdr * cocci_id@p ;
...
position p;
@@
 const struct ip_auth_hdr * cocci_id@p ;
...
position p;
@@
 const struct frag_hdr * cocci_id@p ;
...
position p;
@@
 const struct ip_esp_hdr * cocci_id@p ;
